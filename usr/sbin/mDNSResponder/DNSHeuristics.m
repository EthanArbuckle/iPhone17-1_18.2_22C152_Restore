...
+ (BOOL)updateHeuristicState:(BOOL)a3 isTimeout:(BOOL)a4
{
  ...
  v18 = (void *)v48;
  unsigned int v19 = +[DNSHeuristics getNetworkFilteredFlag:v48];
  if (!v5)
  {
    BOOL v24 = v4;
    if (v4 && (unint64_t v25 = v11 - (void)v13, v11 > (unint64_t)v13) && (unint64_t)v13 + 30000 > v11)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 134217984;
        v52 = (const char *)v25;
        _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_INFO, "Logging DoH timeout failure after only %llums, not incrementing failure counter", buf, 0xCu);
      }
      v18 = (void *)v48;
    }
    else
    {
      v27 = v15 + 1;
      unint64_t v28 = (unint64_t)v17 + (v11 - (unint64_t)v13) / 0x1D4C0;
      if (v28 >= 0xA) {
        unint64_t v28 = 10;
      }
      BOOL v29 = v28 != 0;
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 136315650;
          ...
          __int16 v55 = 2048;
          unint64_t v56 = v31;
          _os_log_impl((void *)&_mh_execute_header, v32, OS_LOG_TYPE_INFO, "Logging DoH %sfailure %llu (bucket %llu), keeping filtered state", buf, 0x20u);
        }
      }
      else
      {
        unsigned int v37 = +[DNSHeuristics countersExceedThreshold:v15 + 1 burstCounter:v31];
        ...
        if (v37)
        {
          if (os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 136315650;
            ...
            __int16 v55 = 2048;
            unint64_t v56 = v31;
            _os_log_impl((void *)&_mh_execute_header, v32, OS_LOG_TYPE_DEFAULT, "Logging DoH %sfailure %llu (bucket %llu), moving into filtered state", buf, 0x20u);
          }
          uint64_t v33 = 1;
        }
        else
        {
          if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 136315650;
            ...
            __int16 v55 = 2048;
            unint64_t v56 = v31;
            _os_log_impl((void *)&_mh_execute_header, v32, OS_LOG_TYPE_INFO, "Logging DoH %sfailure %llu (bucket %llu), keeping unfiltered state", buf, 0x20u);
          }
          uint64_t v33 = 0;
        }
      }
      ...
      unsigned int v26 = v43 & +[DNSHeuristics setNetworkAsFiltered:v48 filtered:v33];
      v46 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", &off_10014CFB8, &off_10014CFD0, 0);
    ...
    if ((unint64_t)v13 + 86400000 >= v11)
    {
      ...
      if (v11 > (unint64_t)v13)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 134217984;
          v52 = (const char *)v36;
          _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_INFO, "Logging DoH success after %llums, keeping filtered state", buf, 0xCu);
        }
        goto LABEL_47;
      }
...
LABEL_39:
    ...
    unsigned int v41 = +[DNSHeuristics setNetworkSettings:v48 value:v40];

    unsigned int v26 = v41 & +[DNSHeuristics setNetworkAsFiltered:v48 filtered:0];
    v20 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", &off_10014CFB8, &off_10014CFD0, 0);
