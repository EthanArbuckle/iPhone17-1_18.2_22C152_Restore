...
- (SPStackshotProvider)init
{
  ...
  if (v2)
  {
    ...
    v3->_sampleStore = v7;
    sub_10005EB20(v7, (byte_1000EBD0C >> 3) & 1, (byte_1000EBD0C >> 2) & 1, (byte_1000EBD0C & 0x10) == 0);
...
- (void)dealloc
{
  ...
  if (self->_numClientsSampling)
  {
    ...
    sub_10002E41C("-[SPStackshotProvider dealloc]", "SPSampleProvider.m", 499, "%s: Still have %d clients sampling when dealloc'ed", v2, v3, v4, v5, (char)"_numClientsSampling == 0");
    abort();
  }
...
- (void)startSamplingThread
{
  ...
  if (self->_samplingThread)
  {
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        if (qword_1000EBD00) {
          objc_super v21 = (FILE *)qword_1000EBD00;
        }
        else {
  ...
  else
  {
    ...
    uint64_t v25 = pthread_create(&self->_samplingThread, 0, (void *(__cdecl *)(void *))sub_10006F538, self);
    if (v25)
    {
      *(void *)__errnum = v25;
      if (byte_1000EBCF8)
      {
        int v31 = *__error();
        objc_super v32 = sub_10002E548();
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          v33 = strerror(__errnum[0]);
          sub_1000985F8((uint64_t)v33, buf, __errnum[0]);
        }
        *__error() = v31;
      }
      if (byte_1000EBCF9) {
      ...
      if (v26)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_FAULT))
          {
            ...
            sub_1000985A4((uint64_t)v39, v45, __errnum[0]);
          }
          if (qword_1000EBD00) {
            v40 = (FILE *)qword_1000EBD00;
          }
          else {
            v40 = __stderrp;
          }
      ...
      strerror(__errnum[0]);
      sub_10002E41C("-[SPStackshotProvider startSamplingThread]", "SPSampleProvider.m", 517, "%s: Unable to create sampling thread: %d (%s)", v27, v28, v29, v30, (char)"ret == 0");
      abort();
    }
  }
  objc_sync_exit(self);
...
- (void)stopSamplingThread
{
  ...
  if (self->_samplingThread)
  {
    ...
    if (byte_1000EBCF9)
    {
      ...
      else if ((byte_1000EBD0C & 0x18) == 0x10)
      {
        if (byte_1000EBCF8)
        {
          int v18 = *__error();
        ...
        else
        {
          ...
          if (qword_1000EBD00) {
            CFStringRef v36 = (FILE *)qword_1000EBD00;
          }
          else {
      ...
      else
      {
        ...
        {
          CFStringRef v37 = sub_10002E548();
          if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT)) {
            sub_1000989B8();
          }
          if (qword_1000EBD00) {
            v38 = (FILE *)qword_1000EBD00;
          }
          else {
            v38 = __stderrp;
          }
...
+ (id)sharedInstanceLock
{
  if (qword_1000EBCB0 != -1) {
    dispatch_once(&qword_1000EBCB0, &stru_1000DDBB0);
  }
  return (id)qword_1000EBCB8;
}
    ...
    if (a3)
    {
      if (sampleOnlyPids)
      {
        ...
        if ([v8 count])
        {
          ...
          {
            int v9 = *__error();
            unsigned int v10 = sub_10002E548();
            if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
            {
              *(_DWORD *)buf = 136315138;
              id v52 = [[objc_msgSend(v8, "description") UTF8String];
          ...
          if (byte_1000EBCF9 && dword_1000EB4A8 <= 1)
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT)) {
                sub_100098B70([[objc_msgSend(v8, "description") UTF8String], buf, v34);
              }
              if (qword_1000EBD00) {
    ...
    if (sampleOnlyPids)
    {
      ...
      if (byte_1000EBCF9 && dword_1000EB4A8 <= 1)
      {
        ...
        if (v26)
        {
          ...
          if (qword_1000EBD00) {
            CFStringRef v48 = (FILE *)qword_1000EBD00;
          }
          else {
        ...
        {
          CFStringRef v36 = sub_10002E548();
          if (os_log_type_enabled(v36, OS_LOG_TYPE_FAULT)) {
            sub_100098B08();
          }
          if (qword_1000EBD00) {
            CFStringRef v37 = (FILE *)qword_1000EBD00;
          }
          else {
  ...
  else
  {
    ...
    if (byte_1000EBCF8)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR)) {
        sub_100098AAC((uint64_t)[a3 description], v4, buf, v17);
      }
      *__error() = v16;
    }
    if (byte_1000EBCF9) {
    ...
    if (v18)
    {
      ...
      if (v20)
      {
        ...
        if (qword_1000EBD00) {
          objc_super v32 = (FILE *)qword_1000EBD00;
        }
        else {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT)) {
          sub_100098A54((uint64_t)[a3 description], v50, v4, v30);
        }
        if (qword_1000EBD00) {
          ...
          if (byte_1000EBCF9 && dword_1000EB4A8 <= 1)
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v77, OS_LOG_TYPE_FAULT)) {
                sub_100098C20([[objc_msgSend(a5, "description") UTF8String], v121, v77];
              }
              if (qword_1000EBD00) {
