  ...
  if (!((unint64_t)a7 | (unint64_t)a8))
  {
    if (byte_1000EBCF8)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR)) {
        sub_100082BC0(v17, v18, v19, v20, v21, v22, v23, v24);
      }
      *__error() = v16;
    }
    if (byte_1000EBCF9) {
      BOOL v25 = dword_1000EB4A8 <= 3;
    }
    else {
      BOOL v25 = 0;
    }
    if (v25)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT)) {
          sub_100082B48(v28, v29, v30, v31, v32, v33, v34, v35);
        }
        if (qword_1000EBD00) {
    ...
    sub_10002E41C("-[SPWRReport initWithReportReason:reportedSignpostTracker:task:timeRange:thread:dispatchQueue:]", "monitor-WorkflowResponsiveness.m", 95, "%s: No thread nor dispatch queue", (uint64_t)a5, (uint64_t)a6, (uint64_t)a7, (uint64_t)a8, (char)"thread || dispatchQueue");
    abort();
  }
