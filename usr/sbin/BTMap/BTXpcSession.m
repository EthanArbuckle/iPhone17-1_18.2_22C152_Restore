...
- (BTXpcSession)initWithConnection:(id)a3
{
  ...
  if (v6)
  {
    ...
    handler[2] = sub_100002170;
    handler[3] = &unk_100008430;
    v19 = v7;
...
{
  BOOL v5 = a4;
  uint64_t v8 = qword_10000D058;
  id v9 = a5;
  if (v8 != -1) {
    dispatch_once(&qword_10000D058, &stru_100008470);
  }
  v10 = [(BTXpcSession *)self _objectForKey:a3 dict:v9 optional:v5 converters:qword_10000D050];
...
{
  BOOL v5 = a4;
  uint64_t v8 = qword_10000D068;
  id v9 = a5;
  if (v8 != -1) {
    dispatch_once(&qword_10000D068, &stru_100008530);
  }
  v10 = [(BTXpcSession *)self _objectForKey:a3 dict:v9 optional:v5 converters:qword_10000D060];
...
{
  BOOL v5 = a4;
  uint64_t v8 = qword_10000D078;
  id v9 = a5;
  if (v8 != -1) {
    dispatch_once(&qword_10000D078, &stru_100008590);
  }
  v10 = [(BTXpcSession *)self _objectForKey:a3 dict:v9 optional:v5 converters:qword_10000D070];
...
{
  id v6 = a3;
  v7 = (void *)qword_10000D088;
  if (os_log_type_enabled((os_log_t)qword_10000D088, OS_LOG_TYPE_DEBUG)) {
    sub_100004F94(a4, v7);
  }
...
- (void)_handleEvent:(id)a3
{
  ...
  else if (xpc_get_type(v4) == (xpc_type_t)&_xpc_type_error)
  {
    ...
    else if (os_log_type_enabled((os_log_t)qword_10000D088, OS_LOG_TYPE_ERROR))
    {
      sub_100005108(v9);
    }
  }
...
- (id)_objectForKey:(const char *)a3 dict:(id)a4 optional:(BOOL)a5 converters:(id)a6
{
  ...
  if (!a5)
  {
    ...
    [v14 handleFailureInMethod:a2 object:self file:@"BTXpcSession.m" lineNumber:154 description:a3];
    v16 = 0;
LABEL_5:
