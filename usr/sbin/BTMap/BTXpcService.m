...
- (BTXpcService)initWithName:(const char *)a3 sessionClass:(Class)a4
{
  ...
  if (v10)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, 0, (CFNotificationCallback)sub_1000019D8, @"com.apple.language.changed", 0, CFNotificationSuspensionBehaviorDeliverImmediately);
    p_isa = &v16->super.isa;
  }
  else
  {
    v13 = qword_10000D088;
    if (os_log_type_enabled((os_log_t)qword_10000D088, OS_LOG_TYPE_FAULT)) {
      sub_100004DA4(v13);
    }
    v11 = 0;
  }
...
- (void)_handleEvent:(id)a3
{
  ...
  else
  {
    xpc_type_t v6 = type;
    v7 = qword_10000D088;
    BOOL v8 = os_log_type_enabled((os_log_t)qword_10000D088, OS_LOG_TYPE_ERROR);
    if (v6 == (xpc_type_t)&_xpc_type_error)
    {
      if (v8) {
        sub_100004DE8((uint64_t)v4, v7);
      }
    }
    else if (v8)
    {
      sub_100004E60((uint64_t)v4, v7);
    }
  }
}
