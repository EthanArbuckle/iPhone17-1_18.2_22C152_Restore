...
- (BOOL)finalizeObject
{
  id v3 = [(NSMutableArray *)self->_memoryRegions count];
  if (v3 == (id)1)
  {
    uint64_t v5 = [(NSMutableArray *)self->_memoryRegions firstObject];
  ...
  else
  {
    self;
    if (byte_100038A50) {
      BOOL v4 = sub_1000113C4();
    }
    else {
      BOOL v4 = 0;
    }
    sub_100005938((uint64_t)self, v4);
  }
  return v3 != (id)1;
}
...
- (unsigned)totalRegions
{
  ...
  else
  {
    ...
    if (v3 == (id)1)
    {
      BOOL v4 = [(NSMutableArray *)self->_memoryRegions firstObject];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  {
    BOOL v4 = objc_alloc_init(FPMemoryObject);
...
- (id)viewForProcess:(id)a3
{
  ...
  if ([(NSMutableDictionary *)v5->_processMemoryRegions count])
  {
    ...
    if (v12)
    {
      ...
      do
      {
        for (i = 0; i != v13; i = (char *)i + 1)
        {
          ...
          sub_100005698((uint64_t)v9, *(void **)(*((void *)&v18 + 1) + 8 * i), (uint64_t)v10, 0);
        }
    ...
    sub_100005938((uint64_t)v9, (int)[v4 breakDownPhysFootprint:v18]);
  }
  else
  {
    v9 = v5;
...
- (NSString)name
{
  v2 = sub_100005E9C((uint64_t)self);
  id v3 = [v2 name];
...
{
  v2 = [(NSMutableArray *)self->_memoryRegions firstObject];
  unsigned __int8 v3 = [v2 detailedAuxData];
...
{
  v2 = [(NSMutableArray *)self->_memoryRegions firstObject];
  unsigned __int8 v3 = [v2 auxDataName];
...
{
  v2 = [(NSMutableArray *)self->_memoryRegions firstObject];
  unsigned __int8 v3 = [v2 detailedAuxDataName];
