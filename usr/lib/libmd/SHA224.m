...
intptr_t __SHA224_FdChunk_block_invoke(uint64_t a1, int a2)
{
  if (a2) {
...
intptr_t __SHA224_FdChunk_block_invoke_2(intptr_t result, int a2, dispatch_data_t data, int a4)
{
  v7 = (void *)result;
  if (data)
  {
    ...
    applier[2] = __SHA224_FdChunk_block_invoke_3;
    applier[3] = &unk_265099BB0;
...
uint64_t __SHA224_FdChunk_block_invoke_3(uint64_t a1, int a2, int a3, void *data, unint64_t len)
{
  ...
  CC_SHA224_Update((CC_SHA256_CTX *)(*(void *)(*(void *)(a1 + 32) + 8) + 24), data, len);
  return 1;
}
