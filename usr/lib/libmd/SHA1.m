...
uint64_t __SHA1_FdChunk_block_invoke_3(uint64_t a1, int a2, int a3, void *data, unint64_t len)
{
  if (len >> 31) {
    MD4FdChunk_cold_1();
  }
  CC_SHA1_Update((CC_SHA1_CTX *)(*(void *)(*(void *)(a1 + 32) + 8) + 24), data, len);
  return 1;
}
