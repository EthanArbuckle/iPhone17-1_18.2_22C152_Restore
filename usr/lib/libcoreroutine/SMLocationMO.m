...
LABEL_12:
  ...
  if (v9)
  {
    *(void *)buf = 0;
    ...
    v24 = __Block_byref_object_dispose__85;
    id v25 = 0;
...
{
  v2 = *(SMLocationMO **)(a1 + 32);
  v3 = v2;
  if (!v2) {
    v3 = [[SMLocationMO alloc] initWithContext:*(void *)(a1 + 40)];
  }
...
+ (id)fetchRequest
{
  return (id)[MEMORY[0x1E4F1C0D0] fetchRequestWithEntityName:@"SMLocationMO"];
}
