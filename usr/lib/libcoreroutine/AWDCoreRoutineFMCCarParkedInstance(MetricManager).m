...
{
  v6.receiver = a1;
  v6.super_class = (Class)&off_1F34C0918;
  v1 = (char *)[super init];
  v2 = v1;
  if (v1)
  {
    uint64_t v3 = (int)*MEMORY[0x1E4FB8D30];
    v4 = *(void **)&v1[v3];
    *(void *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E4FB8D20]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8D38]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8D40]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8D28]] = -1;
  }
  return v2;
}
...
- (id)description
{
  ...
  v5 = [v2 stringWithFormat:@"%@, triggerTypes %d, horizontalAccuracy %d, qualityIndicator %d, triggerType %d, userSetLocation %d, locationType %d", v4, [a1 triggerTypes], [a1 horizontalAccuracy], [a1 qualityIndicator], [a1 triggerTypes], [a1 userAssistanceRequired], [a1 locationType]];
