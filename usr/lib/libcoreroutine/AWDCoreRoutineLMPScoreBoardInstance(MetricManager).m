...
{
  v6.receiver = a1;
  v6.super_class = (Class)&off_1F34C1F48;
  v1 = (char *)[super init];
  v2 = v1;
  if (v1)
  {
    uint64_t v3 = (int)*MEMORY[0x1E4FB8E50];
    v4 = *(void **)&v1[v3];
    *(void *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E4FB8E40]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8E48]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8E58]] = 0;
  }
  return v2;
}
...
- (id)description
{
  ...
  v5 = [a1 keyword];
  objc_super v6 = [v2 stringWithFormat:@"%@, keyword %@, corrects %d, incorrects %d, unknowns %d", v4, v5, [a1 corrects], [a1 incorrects], [a1 unknowns]];
