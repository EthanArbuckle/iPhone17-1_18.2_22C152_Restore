...
@implementation AWDCoreRoutineModelAlgorithmInstance(MetricManager)
...
{
  v2.receiver = a1;
  v2.super_class = (Class)&off_1F34C03C8;
  result = (char *)[super init];
  if (result)
  {
    *(_DWORD *)&result[*MEMORY[0x1E4FB8F90]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E4FB8F88]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E4FB8F80]] = 50000;
  }
  return result;
}
