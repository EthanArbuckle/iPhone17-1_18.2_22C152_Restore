...
- (NSNumber)limit;
- (RTAuthorizedLocationVisitLogFetchOptions)init;
- (RTAuthorizedLocationVisitLogFetchOptions)initWithAscending:(BOOL)a3 dateInterval:(id)a4 limit:(id)a5;
- (RTAuthorizedLocationVisitLogFetchOptions)initWithCoder:(id)a3;
...
- (RTAuthorizedLocationVisitLogFetchOptions)initWithAscending:(BOOL)a3 dateInterval:(id)a4 limit:(id)a5
{
  ...
  if (v10 && ![v10 unsignedIntegerValue])
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D9BFA000, v15, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: !limit || (limit && limit.unsignedIntegerValue > 0)", buf, 2u);
    }
  ...
  {
    v17.receiver = self;
    v17.super_class = (Class)RTAuthorizedLocationVisitLogFetchOptions;
...
- (BOOL)isEqual:(id)a3
{
  v4 = (RTAuthorizedLocationVisitLogFetchOptions *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(RTAuthorizedLocationVisitLogFetchOptions *)self isEqualToFetchOptions:v5];
