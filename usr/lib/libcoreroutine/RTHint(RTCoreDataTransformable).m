...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    v3 = +[RTHintMO managedObjectWithHint:a1 inManagedObjectContext:a3];
  }
  else
  {
...
+ (id)createWithManagedObject:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    ...
    {
      v4 = [(id)objc_opt_class() createWithHintMO:v3];
      goto LABEL_8;
    }
...
+ (id)createWithHintMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D9BFA000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: hintMO", buf, 2u);
    }
