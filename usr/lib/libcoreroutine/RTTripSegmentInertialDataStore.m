...
{
  return [*(id *)(a1 + 32) _storeTripSegmentInertialData:*(void *)(a1 + 40) handler:*(void *)(a1 + 48)];
}
...
LABEL_3:
      ...
      v23[1] = 3221225472;
      v23[2] = __89__RTTripSegmentInertialDataStore__fetchStoredTripSegmentInertialDataWithContext_handler___block_invoke;
      v23[3] = &unk_1E6B910D8;
      id v24 = v6;
      id v9 = v8;
      id v25 = v9;
...
void __89__RTTripSegmentInertialDataStore__fetchStoredTripSegmentInertialDataWithContext_handler___block_invoke(uint64_t a1, void *a2)
{
  ...
  v4 = (void *)[objc_alloc(MEMORY[0x1E4F29008]) initWithKey:@"timestamp" ascending:1];
  v45[0] = v4;
    ...
    if (v26)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v32 = [MEMORY[0x1E4F1E660] createWithManagedObject:v30];
          if (v32) {
            [v23 addObject:v32];
          }
...
{
  return [*(id *)(a1 + 32) _fetchStoredTripSegmentInertialDataWithContext:*(void *)(a1 + 40) handler:*(void *)(a1 + 48)];
}
...
- (void)_fetchStoredTripSegmentInertialDataWithOptions:(id)a3 handler:(id)a4
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x1E4F5CF88]) initWithEnumerationOptions:v6];
...
{
  return [*(id *)(a1 + 32) _fetchStoredTripSegmentInertialDataWithOptions:*(void *)(a1 + 40) handler:*(void *)(a1 + 48)];
}
...
{
  return [*(id *)(a1 + 32) _purgeTripSegmentInertialDataPredating:*(void *)(a1 + 40) handler:*(void *)(a1 + 48)];
}
...
LABEL_8:
    ...
    __int16 v21 = [(RTTripSegmentInertialDataStore *)self fetchRequestFromStoredTripSegmentInertialDataOptions:v9];
...
- (id)fetchRequestFromStoredTripSegmentInertialDataOptions:(id)a3
{
  ...
  if (v3)
  {
    id v4 = +[RTTripSegmentInertialDataMO fetchRequest];
    [v4 setReturnsObjectsAsFaults:0];
    v5 = (void *)[objc_alloc(MEMORY[0x1E4F29008]) initWithKey:@"timestamp" ascending:1];
    v27[0] = v5;
    ...
    id v19 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"%@ <= %K", v11, @"timestamp"];
    v26[0] = v19;
    v20 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"%K <= %@", @"timestamp", v16];
    v26[1] = v20;
