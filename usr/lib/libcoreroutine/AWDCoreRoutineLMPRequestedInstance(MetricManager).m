...
{
  v6.receiver = a1;
  v6.super_class = (Class)&off_1F34C1290;
  v1 = (char *)[super init];
  v2 = v1;
  if (v1)
  {
    uint64_t v3 = (int)*MEMORY[0x1E4FB8E10];
    v4 = *(void **)&v1[v3];
    *(void *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E4FB8E08]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8E18]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8E20]] = 0;
    v2[*MEMORY[0x1E4FB8E28]] = 0;
  }
  return v2;
}
...
- (id)description
{
  ...
  v5 = [v2 stringWithFormat:@"%@, confidence %d, occurrences %d, reason %d, suggested %d", v4, [a1 confidence], [a1 occurrences], [a1 reason], [a1 suggested]];
