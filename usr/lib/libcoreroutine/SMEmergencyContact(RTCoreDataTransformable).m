...
LABEL_12:
  ...
  {
    v4 = [(id)objc_opt_class() createWithEmergenecyContact:v3];
    goto LABEL_8;
  }
  v5 = _rt_log_facility_get_os_log(RTLogFacilityGeneral);
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
...
+ (id)createWithEmergenecyContact:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    *(void *)buf = 0;
    ...
    int v15 = __Block_byref_object_copy__100;
    uint64_t v16 = __Block_byref_object_dispose__100;
    id v17 = 0;
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D9BFA000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: emergencyContactMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    id v3 = +[SMEmergencyContactMO managedObjectWithEmergencyContact:a1 inManagedObjectContext:a3];
  }
  else
  {
