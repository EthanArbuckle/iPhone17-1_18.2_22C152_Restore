...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1D9BFA000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not load RTPlaceTypeClassifierModelMultiClass.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(RTPlaceTypeClassifierModelMultiClass *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(RTPlaceTypeClassifierModelMultiClass *)self model];
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  id v11 = [(RTPlaceTypeClassifierModelMultiClass *)self model];
