...
{
  v2.receiver = a1;
  v2.super_class = (Class)&off_1F34C2150;
  result = (char *)[super init];
  if (result)
  {
    *(_DWORD *)&result[*MEMORY[0x1E4FB8DA8]] = 0;
    *(_DWORD *)&result[*MEMORY[0x1E4FB8DB0]] = 0;
  }
  return result;
}
...
- (id)description
{
  ...
  v5 = [v2 stringWithFormat:@"%@, event type %d, value %d", v4, [a1 eventType], [a1 value]];
