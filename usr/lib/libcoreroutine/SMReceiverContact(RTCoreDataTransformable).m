...
LABEL_12:
  ...
  {
    v4 = [(id)objc_opt_class() createWithReceiverContactMO:v3];
    goto LABEL_8;
  }
  v5 = _rt_log_facility_get_os_log(RTLogFacilityGeneral);
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
...
+ (id)createWithReceiverContactMO:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    *(void *)buf = 0;
    ...
    int v15 = __Block_byref_object_copy__174;
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D9BFA000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: receiverContactMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    id v3 = +[SMReceiverContactMO managedObjectWithReceiverContact:a1 inManagedObjectContext:a3];
  }
  else
  {
...
- (void)updateManagedObject:()RTCoreDataTransformable
{
  ...
  id v5 = +[SMReceiverContactMO managedObjectWithReceiverContact:a1 managedObject:v6 inManagedObjectContext:v4];
}
