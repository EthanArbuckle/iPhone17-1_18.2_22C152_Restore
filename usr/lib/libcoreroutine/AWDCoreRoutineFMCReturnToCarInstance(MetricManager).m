...
{
  v6.receiver = a1;
  v6.super_class = (Class)&off_1F34C0FC8;
  v1 = (char *)[super init];
  v2 = v1;
  if (v1)
  {
    uint64_t v3 = (int)*MEMORY[0x1E4FB8DA0];
    v4 = *(void **)&v1[v3];
    *(void *)&v1[v3] = 0;

    *(_DWORD *)&v2[*MEMORY[0x1E4FB8D90]] = 0;
    *(_DWORD *)&v2[*MEMORY[0x1E4FB8D98]] = 0;
  }
  return v2;
}
...
- (id)description
{
  ...
  v5 = [v2 stringWithFormat:@"%@, horizontalAccuracy %d, horizontalDistance %d", v4, [a1 horizontalAccuracy], [a1 horizontalDistance]];
