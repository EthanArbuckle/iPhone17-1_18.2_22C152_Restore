...
+ (id)createWithManagedObject:()RTCoreDataTransformable
{
  ...
  if (v4)
  {
    ...
    {
      id v5 = v4;
      v6 = [(id)objc_opt_class() createWithProximityEventMO:v5];
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 1024;
      int v17 = 35;
      _os_log_error_impl(&dword_1D9BFA000, v7, OS_LOG_TYPE_ERROR, "%@, managedObject, %@, is not supported by RTProximityEvent+CoreDataReadable (in %s:%d)", (uint8_t *)&v10, 0x26u);
    }
  }
  v6 = 0;
LABEL_8:
...
+ (id)createWithProximityEventMO:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    *(void *)buf = 0;
    ...
    __int16 v16 = __Block_byref_object_dispose__29;
    id v17 = 0;
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    id v3 = +[RTProximityEventMO managedObjectWithProximityEvent:a1 inManagedObjectContext:a3];
  }
  else
  {
