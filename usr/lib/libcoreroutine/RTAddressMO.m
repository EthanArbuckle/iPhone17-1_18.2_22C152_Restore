...
+ (id)fetchRequest
{
  return (id)[MEMORY[0x1E4F1C0D0] fetchRequestWithEntityName:@"RTAddressMO"];
}

+ (id)managedObjectWithAddress:(id)a3 inManagedObjectContext:(id)a4
{
  return (id)[a1 managedObjectWithAddress:a3 managedObject:0 inManagedObjectContext:a4];
}
...
+ (id)managedObjectWithAddress:(id)a3 managedObject:(id)a4 inManagedObjectContext:(id)a5
{
  ...
  if (!v7)
  {
    ...
    v16 = (uint8_t *)&v41;
LABEL_19:
    _os_log_error_impl(&dword_1D9BFA000, v13, OS_LOG_TYPE_ERROR, v15, v16, 2u);
    goto LABEL_12;
  }
  if (!v9)
  {
...
LABEL_7:
    ...
    v34 = [NSNumber numberWithBool:[v7 isIsland]];
...
- (id)description
{
  ...
  v13 = [(RTAddressMO *)self inlandWater];
  v12 = [(RTAddressMO *)self ocean];
  v17 = [(RTAddressMO *)self areasOfInterest];
  uint64_t v11 = [v17 count];
  v4 = [(RTAddressMO *)self island];
  v15 = [(RTAddressMO *)self creationDate];
  v5 = [v15 stringFromDate];
  v6 = [(RTAddressMO *)self expirationDate];
  id v7 = [v6 stringFromDate];
  id v8 = [(RTAddressMO *)self iso3166CountryCode];
  id v9 = [(RTAddressMO *)self iso3166SubdivisionCode];
  objc_msgSend(v21, "stringWithFormat:", @"identifier, %@, geoAddressData.length, %lu, subPremises, %@, subThoroughfare, %@, thoroughfare, %@, subLocality, %@, locality, %@, subAdministrativeArea, %@, administrativeArea, %@, administrativeAreaCode, %@, postalCode, %@, country, %@, countryCode, %@, inlandWater, %@, ocean, %@, areasOfInterest.count, %lu, island, %@, creationDate, %@, expirationDate, %@, iso3166CountryCode, %@, iso3166SubdivisionCode, %@", v30, v20, v26, v29, v19, v28, v18, v27, v25, v16, v24, v14, v3, v13, v12, v11,
    v4,
    v5,
    v7,
    v8,
