...
+ (id)createWithManagedObject:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 1024;
      int v12 = 27;
      _os_log_error_impl(&dword_1D9BFA000, v5, OS_LOG_TYPE_ERROR, "managedObject, %@, is not supported by SMInitiatorLocationMO+CoreDataTransformable (in %s:%d)", (uint8_t *)&v7, 0x1Cu);
    }
  }
  v4 = 0;
LABEL_8:
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    id v3 = +[SMInitiatorLocationMO managedObjectWithLocation:a1 inManagedObjectContext:a3];
  }
  else
  {
