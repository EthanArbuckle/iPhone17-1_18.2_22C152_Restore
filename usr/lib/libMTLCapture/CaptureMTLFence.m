...
- (void)dealloc
{
  ...
  *(unsigned char *)(v3 + 13) = v4;
  v8 = [(CaptureMTLFence *)self traceStream];
  if (v8) {
  ...
  *(unsigned char *)(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLFence;
  [(CaptureMTLFence *)&v12 dealloc];
}
...
- (void)setLabel:(id)a3
{
  ...
  [(MTLFence *)self->_baseObject setLabel:v4];
  uint64_t v5 = v20;
  *(_DWORD *)(v20 + 8) = -16136;
  char v6 = BYTE9(v21);
  ...
  *(unsigned char *)(v5 + 13) = v6;
  uint64_t v10 = [(CaptureMTLFence *)self traceStream];
  if (v10) {
...
- (NSString)label
{
  return (NSString *)[(MTLFence *)self->_baseObject label];
}
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  unsigned __int8 v5 = [(MTLFence *)baseObject conformsToProtocol:v4];
...
{
  v7.receiver = self;
  v7.super_class = (Class)CaptureMTLFence;
  uint64_t v3 = [(CaptureMTLFence *)&v7 description];
  id v4 = [(MTLFence *)self->_baseObject description];
...
- (CaptureMTLFence)initWithBaseObject:(id)a3 captureDevice:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)CaptureMTLFence;
  uint64_t v9 = [(CaptureMTLFence *)&v14 init];
  uint64_t v10 = v9;
  if (v9)
  {
