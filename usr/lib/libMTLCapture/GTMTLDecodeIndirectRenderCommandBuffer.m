...
void __GTMTLDecodeIndirectRenderCommandBuffer_block_invoke_45(id a1)
{
  if (s_logUsingOsLog)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&def_CFBEC, v1, OS_LOG_TYPE_ERROR, "warning: Cannot decode ICB mesh buffer binding, missing SPI", buf, 2u);
    }
  }
  else
  {
...
void __GTMTLDecodeIndirectRenderCommandBuffer_block_invoke(id a1)
{
  if (s_logUsingOsLog)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&def_CFBEC, v1, OS_LOG_TYPE_ERROR, "warning: Cannot decode ICB object buffer binding, missing SPI", buf, 2u);
    }
  }
  else
  {
