...
- (GTIntKeyedDictionary_capture)init;
...
{
  v3 = self->_private;
  id v4 = std::__hash_table<std::__hash_value_type<long long,objc_object  {objcproto8NSObject}*>,std::__unordered_map_hasher<long long,objc_object  {objcproto8NSObject}*,std::hash<long long>,std::equal_to<long long>,true>,std::__unordered_map_equal<long long,objc_object  {objcproto8NSObject}*,std::equal_to,std::hash,true>,std::allocator<objc_object  {objcproto8NSObject}*>>::find<long long>(v3, a3);
  if (v4)
  {
    id v5 = v4;
...
- (id)objectForIntKey:(int64_t)a3
{
  id result = std::__hash_table<std::__hash_value_type<long long,objc_object  {objcproto8NSObject}*>,std::__unordered_map_hasher<long long,objc_object  {objcproto8NSObject}*,std::hash<long long>,std::equal_to<long long>,true>,std::__unordered_map_equal<long long,objc_object  {objcproto8NSObject}*,std::equal_to,std::hash,true>,std::allocator<objc_object  {objcproto8NSObject}*>>::find<long long>((void *)self->_private, a3);
  if (result) {
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)GTIntKeyedDictionary_capture;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [a3 encodeObject:-[GTIntKeyedDictionary_capture allKeys](self, "allKeys") forKey:@"keys"];
...
- (GTIntKeyedDictionary_capture)initWithCoder:(id)a3
{
  ...
  id v6 = [a3 decodeObjectOfClasses:+[NSSet setWithObjects:](NSSet, "setWithObjects:", v5, objc_opt_class(), 0) forKey:@"keys"];
  if (!v6)
  {
    unint64_t v11 = "keys";
LABEL_8:
  ...
  unint64_t v7 = v6;
  unint64_t v8 = -[GTIntKeyedDictionary_capture initWithCapacity:](self, "initWithCapacity:", [v6 count]);
  uint8x8_t v9 = v8;
  if (v8)
  {
...
- (GTIntKeyedDictionary_capture)initWithIntKeyedDictionary:(id)a3
{
  objc_super v4 = -[GTIntKeyedDictionary_capture initWithCapacity:](self, "initWithCapacity:", [a3 count]);
  uint64_t v5 = v4;
  if (v4)
  {
...
- (GTIntKeyedDictionary_capture)initWithCapacity:(unint64_t)a3
{
  v4.receiver = self;
  v4.super_class = (Class)GTIntKeyedDictionary_capture;
  if ([(GTIntKeyedDictionary_capture *)&v4 init]) {
    operator new();
  }
  return 0;
}
...
- (GTIntKeyedDictionary_capture)init
{
  return [(GTIntKeyedDictionary_capture *)self initWithCapacity:0];
}
