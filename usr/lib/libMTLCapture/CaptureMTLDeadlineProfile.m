...
- (void)dealloc
{
  ...
  *(unsigned char *)(v3 + 13) = v4;
  v8 = [(CaptureMTLDeadlineProfile *)self traceStream];
  if (v8) {
  ...
  *(unsigned char *)(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLDeadlineProfile;
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  unsigned __int8 v5 = [(MTLDeadlineProfile *)baseObject conformsToProtocol:v4];
...
{
  v7.receiver = self;
  v7.super_class = (Class)CaptureMTLDeadlineProfile;
  uint64_t v3 = [(CaptureMTLDeadlineProfile *)&v7 description];
  char v4 = [(MTLDeadlineProfile *)self->_baseObject description];
