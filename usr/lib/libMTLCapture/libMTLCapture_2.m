...
id MTLHeap_newBuffer(void *a1, uint64_t a2, uint64_t a3, void *a4)
{
  ...
  if ([v7 type])
  {
    ...
    {
      id v9 = [v7 newBufferWithLength:a2 options:[v7 resourceOptions] offset:a3];
      goto LABEL_7;
    }
LABEL_5:
    id v10 = 0;
  ...
  id v9 = [v7 newBufferWithLength:a2 options:[v7 resourceOptions]];
LABEL_7:
  id v10 = v9;
  if (v9) {
    [v9 setLabel:v8];
...
id MTLHeap_newTexture(void *a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5, uint64_t a6, void *a7)
{
  ...
  [v15 setDepth:a5[2]];
  [v15 setUsage:a4];
  [v15 setResourceOptions:[v13 resourceOptions]];
    ...
    if (a3 >= 1)
    {
      ...
      do
      {
        ...
        if (v10 == *(char **)(v12 - 8))
        {
          ...
          long long v20 = v16;
          uint64_t v21 = [v14[23] stringWithUTF8String:];
