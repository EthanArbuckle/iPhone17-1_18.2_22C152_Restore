...
LABEL_16:
    ...
    return [*(id *)(a1 + 40) setResult:+[NSNumber numberWithBool:](NSNumber, "numberWithBool:", v11)];
  }
  [*(id *)(a1 + 40) setError:+[GTError_capture errorWithDomain:code:userInfo:](GTError_capture, "errorWithDomain:code:userInfo:", @"DYErrorDomain", 32, 0)];
  uint64_t v3 = 0;
LABEL_3:
  ...
  *(unsigned char *)(*(void *)(a1 + 32) + 304) = 0;
  ...
  if (result)
  {
    ...
    do
    {
      ...
      v13.receiver = v6;
      v13.super_class = (Class)GTSharedMemoryTransport_capture;
...
void *__34__GTSharedMemoryTransport_setUrl___block_invoke(void *result)
{
  ...
  if ((void *)result[4] != v1)
  {
    ...
    *(void *)(v2[5] + 8) = (id)v2[4];
    id result = [objc_msgSend(*(id *)(v2[5] + 8), "scheme") isEqualToString:@"dysmtdeferred"];
    uint64_t v3 = v2[5];
    if (result) {
