...
- (void)_invalidate
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)GTUNIXDomainSocketTransport_capture;
...
- (void)_connectServer:(id)a3 future:(id)a4
{
  ...
  if (v9 >= 0x69)
  {
    CFStringRef v10 = GTError_capture;
...
LABEL_11:
    ...
    else
    {
      ...
      -[[NSString stringWithFormat:](NSString, @"fail: unix domain socket url must be a file url: %s", objc_msgSend(objc_msgSend(a3, "absoluteString"), "UTF8String")) UTF8String];
      fprintf(v12, "%s\n");
    }
    goto LABEL_14;
  }
...
{
  v5.receiver = self;
  v5.super_class = (Class)GTUNIXDomainSocketTransport_capture;
