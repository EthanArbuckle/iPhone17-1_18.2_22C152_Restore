...
- (void)dealloc
{
  ...
  *(unsigned char *)(v3 + 13) = v4;
  v8 = [(CaptureMTLIOFileHandle *)self traceStream];
  if (v8) {
  ...
  *(unsigned char *)(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLIOFileHandle;
...
- (void)setLabel:(id)a3
{
  ...
  *(unsigned char *)(v5 + 13) = v6;
  uint64_t v10 = [(CaptureMTLIOFileHandle *)self traceStream];
  if (v10) {
...
- (NSString)label
{
  return (NSString *)[(MTLIOFileHandle *)self->_baseObject label];
}
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  unsigned __int8 v5 = [(MTLIOFileHandle *)baseObject conformsToProtocol:v4];
...
{
  v7.receiver = self;
  v7.super_class = (Class)CaptureMTLIOFileHandle;
  uint64_t v3 = [(CaptureMTLIOFileHandle *)&v7 description];
  id v4 = [(MTLIOFileHandle *)self->_baseObject description];
...
- (CaptureMTLIOFileHandle)initWithBaseObject:(id)a3 captureContext:(GTTraceContext *)a4
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLIOFileHandle;
  uint64_t v8 = [(CaptureMTLIOFileHandle *)&v12 init];
  uint64_t v9 = v8;
  if (v8)
  {
