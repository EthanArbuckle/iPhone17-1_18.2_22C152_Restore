...
+ (id)sharedInstance
{
  if (qword_1EBBDD580 != -1) {
    dispatch_once(&qword_1EBBDD580, &__block_literal_global_2);
  }
...
void __21__ABMTapToRadar_init__block_invoke(uint64_t a1)
{
  ...
  *(_DWORD *)(*(void *)(a1 + 32) + 8) = 0;
  ...
  v2 = (const void *)*MEMORY[0x1E4F4C198];
  size_t v3 = strlen((const char *)*MEMORY[0x1E4F4C198]);
...
- (BOOL)checkAudioTraces_sync
{
  ...
  size_t v3 = (const char **)MEMORY[0x1E4F4CEA8];
  if (!v2) {
    size_t v3 = (const char **)MEMORY[0x1E4F4CCC8];
  }
  uint64_t v4 = *v3;
  size_t v5 = strlen(*v3);
...
- (BOOL)checkTraces_sync:(int)a3
{
  ...
  if (((1 << a3) & 0x26) == 0)
  {
    ...
    uint64_t v7 = (const void *)*MEMORY[0x1E4F4C0E0];
    size_t v8 = strlen((const char *)*MEMORY[0x1E4F4C0E0]);
...
LABEL_22:
  ...
  size_t v3 = (const void *)*MEMORY[0x1E4F4C0E0];
  size_t v4 = strlen((const char *)*MEMORY[0x1E4F4C0E0]);
...
- (BOOL)checkNotificationCriteria:(int *)a3 :(const void *)a4 :(BOOL)a5
{
  ...
  *((void *)v12 + 1) = v10;
  ...
  uint64_t v78 = v11 + 1;
  operator delete(v9);
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_1EBBDD588, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_1EBBDD588))
  {
    qword_1EBBDD590 = (uint64_t)"mav_bedf_component_config_reset: Reset Requested by Component Cfg";
    qword_1EBBDD598 = (uint64_t)"AutoBugCapture";
    qword_1EBBDD5A0 = *MEMORY[0x1E4F4F970];
    __cxa_guard_release(&qword_1EBBDD588);
  }
  int v13 = *((char *)a4 + 23);
  if (v13 < 0)
  {
...
LABEL_37:
        ...
        v28 = (const void *)qword_1EBBDD590;
        int64_t v29 = strlen((const char *)qword_1EBBDD590);
        if (v29)
        {
          int64_t v30 = v29;
          v31 = &v27[v26];
          ...
          long long v32 = (const void *)qword_1EBBDD598;
          int64_t v33 = strlen((const char *)qword_1EBBDD598);
          if (v33)
          {
            int64_t v34 = v33;
            if (v26 >= v33)
            {
              int v59 = *(char *)qword_1EBBDD598;
              int64_t v60 = v26;
              v61 = v27;
              do
              {
            ...
            v35 = (const void *)qword_1EBBDD5A0;
            int64_t v36 = strlen((const char *)qword_1EBBDD5A0);
            if (v36)
            {
              int64_t v37 = v36;
              if (v26 >= v36)
              {
                int v65 = *(char *)qword_1EBBDD5A0;
                v66 = v27;
                while (v26 - v37 != -1)
                {
...
- (void)showUserNotification:(int)a3 dumpReason:()basic_string<char
{
  ...
  *(_WORD *)&buf[8] = 2080;
  *(void *)&buf[10] = v9;
  _os_log_impl(&dword_1C5767000, v7, OS_LOG_TYPE_DEFAULT, "#I Show user notification for radarType: %d with header: %s", buf, 0x12u);
LABEL_14:
...
void __38__ABMTapToRadar_showNotification___::__block_invoke(uint64_t a1)
{
  ...
  if (v5 >= 0x17)
  {
    ...
    uint64_t v7 = (void **)operator new(v8 + 1);
    __dst[1] = v6;
    unint64_t v71 = v9 | 0x8000000000000000;
    __dst[0] = v7;
    goto LABEL_12;
  }
  HIBYTE(v71) = v5;
...
LABEL_35:
  ...
  uint64_t v21 = MEMORY[0x1E4F14590];
  if (v19)
  {
    xpc_object_t xdict = v19;
  }
  else
  {
    xpc_object_t v20 = xpc_null_create();
    xpc_object_t xdict = v20;
    if (!v20)
    {
...
LABEL_46:
  xpc_release(v20);
  xpc_object_t v23 = xpc_int64_create(*(unsigned int *)(a1 + 136));
  if (!v23) {
    xpc_object_t v23 = xpc_null_create();
  }
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E4F470B0], v23);
  xpc_object_t v24 = xpc_null_create();
  xpc_release(v23);
  xpc_release(v24);
  int v25 = (const char *)(a1 + 64);
  if (*(char *)(a1 + 87) < 0) {
    int v25 = *(const char **)v25;
  }
  xpc_object_t v26 = xpc_string_create(v25);
  if (!v26) {
    xpc_object_t v26 = xpc_null_create();
  }
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E4F470C0], v26);
  ...
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E4F47100], v29);
  xpc_object_t v30 = xpc_null_create();
  xpc_release(v29);
  xpc_release(v30);
  v31 = (const char *)(a1 + 112);
  if (*(char *)(a1 + 135) < 0) {
    v31 = *(const char **)v31;
  }
  ...
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E4F47170], v32);
  xpc_object_t v33 = xpc_null_create();
  xpc_release(v32);
  xpc_release(v33);
  xpc_object_t v34 = xpc_int64_create(0);
  if (!v34) {
    xpc_object_t v34 = xpc_null_create();
  }
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E4F470E8], v34);
  ...
  {
    if (MEMORY[0x1C8792D30](v36) == MEMORY[0x1E4F14568])
    {
      xpc_retain(v36);
  ...
  v60[1] = 3321888768;
  v61 = __38__ABMTapToRadar_showNotification___::__block_invoke_2;
  int64_t v62 = &__block_descriptor_40_e8_32c16_ZTSN3xpc5arrayE_e10_v16__0r_v8l;
  xpc_object_t v63 = v37;
  if (v37) {
    xpc_retain(v37);
  }
  else {
  ...
  while (v38 != v39)
  {
    v61((uint64_t)v60, v38);
    v38 += 24;
  }
  if (v37)
  {
    xpc_retain(v37);
    xpc_object_t v40 = v37;
  }
  else
  {
    xpc_object_t v40 = xpc_null_create();
  }
  xpc_dictionary_set_value(xdict, (const char *)*MEMORY[0x1E4F47198], v40);
  ...
  if (v42)
  {
    xpc_object_t v59 = v42;
  }
  else
  {
    xpc_object_t v43 = xpc_null_create();
    xpc_object_t v59 = v43;
    if (!v43)
    {
...
LABEL_84:
  ...
  *(_OWORD *)v57 = v45;
  ...
  {
    GetABMLogServer(&v54);
    int64_t v46 = *((void *)GetGlobalLogger(&v54) + 4);
    int v47 = v55;
    ...
    {
      xpc::dict::to_debug_string((xpc::dict *)&xdict, v52);
      long long v51 = v53 >= 0 ? v52 : (void **)v52[0];
      *(_DWORD *)buf = 136315138;
      uint64_t v74 = v51;
      _os_log_error_impl(&dword_1C5767000, v46, OS_LOG_TYPE_ERROR, "Failed to file the radar: %s", buf, 0xCu);
      if (v53 < 0) {
