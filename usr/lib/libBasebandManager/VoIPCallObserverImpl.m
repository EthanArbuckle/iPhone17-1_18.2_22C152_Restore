...
LABEL_19:
  ...
  if (!v17)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1C5767000, v20, OS_LOG_TYPE_ERROR, "Failed to create Call observer from CallKit", buf, 2u);
    }
    goto LABEL_25;
  }
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1C5767000, v18, OS_LOG_TYPE_DEFAULT, "Call observer created", buf, 2u);
  }
  v19 = v8;
LABEL_26:
...
- (void)callObserver:(id)a3 callChanged:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&buf[4] = v16;
    _os_log_debug_impl(&dword_1C5767000, v8, OS_LOG_TYPE_DEBUG, "Provider ID: %@", buf, 0xCu);
  }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)&buf[10] = v18;
    ...
    _os_log_debug_impl(&dword_1C5767000, v9, OS_LOG_TYPE_DEBUG, "(1) call connected: %{BOOL}d, call ended: %{BOOL}d, fVoIPCallStarting: %{BOOL}d, fVoIPCallActive: %{BOOL}d", buf, 0x1Au);
  }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)&buf[10] = v22;
    ...
    __int16 v30 = 1024;
    BOOL v31 = v24;
    _os_log_debug_impl(&dword_1C5767000, v11, OS_LOG_TYPE_DEBUG, "(2) call connected: %{BOOL}d, call ended: %{BOOL}d, fVoIPCallStarting: %{BOOL}d, fVoIPCallActive: %{BOOL}d", buf, 0x1Au);
    if (!v10) {
      goto LABEL_21;
    }
  }
