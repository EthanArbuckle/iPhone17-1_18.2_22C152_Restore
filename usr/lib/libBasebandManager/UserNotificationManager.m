...
+ (id)sharedInstance:()basic_string<char
{
  ...
  if (*((char *)&a3->var0.var0.var0.var1 + 23) < 0)
  {
    ...
    if (qword_1EBBDD498 == -1)
    {
LABEL_3:
      id v3 = (id)qword_1EBBDD490;
  ...
  dispatch_once(&qword_1EBBDD498, block);
  id v3 = (id)qword_1EBBDD490;
  if ((*((char *)&__p.var0.var1 + 23) & 0x80000000) == 0)
  {
LABEL_4:
  ...
  if (!self->fUserNotificationCenter)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v13 = v5;
      _os_log_impl(&dword_1C5767000, v8, OS_LOG_TYPE_DEFAULT, "#I UserNotificationCenter created with bundleID %@", buf, 0xCu);
    }
  }
}
...
- (BOOL)setActionForHeader:(UserNotificationManager *)self notificationContent:(SEL)a2 callbackData:(NotificationInfo *)a3
{
  ...
  v104 = v7;
  v102 = self;
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_1EBBDD4A0, memory_order_acquire) & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_1EBBDD4A0);
    if (v7)
    {
      _MergedGlobals = TelephonyUtilIsInternalBuild();
      __cxa_guard_release(&qword_1EBBDD4A0);
    }
  }
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_1EBBDD4B0, memory_order_acquire) & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_1EBBDD4B0);
    if (v7)
    {
      if (_MergedGlobals) {
      ...
      qword_1EBBDD4A8 = v100;
      __cxa_guard_release(&qword_1EBBDD4B0);
    }
  }
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_1EBBDD4C0, memory_order_acquire) & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_1EBBDD4C0);
    if (v7)
    {
      if (_MergedGlobals) {
      ...
      qword_1EBBDD4B8 = v101;
      __cxa_guard_release(&qword_1EBBDD4C0);
    }
  }
  ...
  if (memcmp(v80, "Telephony_Dump_Started", v81) || v10 != 22)
  {
    ...
    if (os_log_type_enabled(v82, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_error_impl(&dword_1C5767000, v82, OS_LOG_TYPE_ERROR, "Not supported header - %s", buf, 0xCu);
    }
    BOOL v84 = 0;
    goto LABEL_215;
  }
LABEL_39:
  ...
  {
    v29 = [MEMORY[0x1E4F1CB10] URLWithString:qword_1EBBDD4A8];
  ...
  else
  {
    ...
    {
      v29 = [MEMORY[0x1E4F1CB10] URLWithString:qword_1EBBDD4B8];
      [v104 setDefaultActionURL:v29];
    }
    else
    {
...
LABEL_211:
      ...
      *(_DWORD *)buf = 136315138;
      v110 = a3;
      _os_log_impl(&dword_1C5767000, v93, OS_LOG_TYPE_DEFAULT, "#I Add callback for id: %s", buf, 0xCu);
    }
  }
...
LABEL_27:
  ...
  unint64_t v14 = [v11 localizedStringForKey:v13 value:&stru_1F20FFDB0 table:@"Localizable"];
  [v3 setHeader:v14];
  ...
  if (!memcmp(v17, "Telephony_Dump_Insufficient", v18) && v16 == 27)
  {
    ...
    v21 = [v20 localizedStringForKey:@"Telephony_Dump_Insufficient_Details_%@" value:&stru_1F20FFDB0 table:@"Localizable"];
    if (*(char *)(a1 + 111) < 0) {
      v7 = *(_OWORD **)v7;
    }
...
LABEL_49:
  ...
  if (!memcmp(v25, "Telephony_Dump_Started", v26) && v24 == 22)
  {
    ...
    size_t v22 = [v20 localizedStringForKey:v21 value:&stru_1F20FFDB0 table:@"Localizable"];
  ...
  {
    unint64_t v20 = [MEMORY[0x1E4F28B50] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
    v21 = [v20 localizedStringForKey:@"Check_Settings_Cellular_Diagnostics" value:&stru_1F20FFDB0 table:@"Localizable"];
    [v3 setBody:v21];
    goto LABEL_51;
  }
  unint64_t v20 = [MEMORY[0x1E4F28B50] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
...
LABEL_51:
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315138;
    uint64_t v46 = v35;
    _os_log_impl(&dword_1C5767000, v33, OS_LOG_TYPE_DEFAULT, "#I Add notification request with id: %s", buf, 0xCu);
  }
...
LABEL_32:
  ...
  *(_DWORD *)buf = 136315394;
  ...
  __int16 v41 = 2080;
  std::string v42 = v29;
  _os_log_impl(&dword_1C5767000, v27, OS_LOG_TYPE_DEFAULT, "#I Submitting CoreAnalytics event[%s] - %s", buf, 0x16u);
  if (v34 < 0) {
...
LABEL_9:
  ...
  *(void *)((char *)&buf + 4) = v14;
  _os_log_impl(&dword_1C5767000, v12, OS_LOG_TYPE_DEFAULT, "#I Received notification response with id: %s", (uint8_t *)&buf, 0xCu);
LABEL_15:
...
LABEL_102:
            ...
            *(_DWORD *)unint64_t v66 = 136315138;
            size_t v67 = v47;
            _os_log_impl(&dword_1C5767000, v45, OS_LOG_TYPE_DEFAULT, "#I Remove callback for id: %s", v66, 0xCu);
            if ((v63[23] & 0x80000000) != 0) {
              goto LABEL_105;
            }
LABEL_109:
