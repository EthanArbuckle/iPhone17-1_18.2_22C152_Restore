...
LABEL_11:
  ...
  if (([v4 isEqualToString:@"A0000006800100010101"] & 1) != 0
    || [v4 isEqualToString:@"A00000068001FF010101"])
  {
    v8 = SlalomDecoder;
LABEL_6:
    id v7 = [(__objc2_class *)v8 sharedInstance];
    goto LABEL_11;
  }
  if (([v4 isEqualToString:@"D1560000101000001201"] & 1) != 0
    || [v4 isEqualToString:@"9156000014020001"])
  {
    v9 = MercuryDecoder;
LABEL_10:
    id v7 = objc_alloc_init(v9);
    goto LABEL_11;
  }
...
LABEL_21:
    id v7 = [(__objc2_class *)v12 getInstance];
    goto LABEL_11;
  }
