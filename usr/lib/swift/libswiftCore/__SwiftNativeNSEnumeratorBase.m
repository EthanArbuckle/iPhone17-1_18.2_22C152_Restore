...
- (__SwiftNativeNSEnumeratorBase)autorelease;
- (__SwiftNativeNSEnumeratorBase)initWithCoder:(id)a3;
- (__SwiftNativeNSEnumeratorBase)retain;
...
{
  v4.receiver = self;
  v4.super_class = (Class)__SwiftNativeNSEnumeratorBase;
  return [(__SwiftNativeNSEnumeratorBase *)&v4 init];
}
...
- (__SwiftNativeNSEnumeratorBase)autorelease
{
  return (__SwiftNativeNSEnumeratorBase *)MEMORY[0x1F4181450](self, a2);
}
