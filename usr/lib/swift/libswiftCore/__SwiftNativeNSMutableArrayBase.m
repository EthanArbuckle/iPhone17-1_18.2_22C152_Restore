...
- (__SwiftNativeNSMutableArrayBase)autorelease;
- (__SwiftNativeNSMutableArrayBase)initWithCoder:(id)a3;
- (__SwiftNativeNSMutableArrayBase)retain;
...
{
  v4.receiver = self;
  v4.super_class = (Class)__SwiftNativeNSMutableArrayBase;
  return [(__SwiftNativeNSMutableArrayBase *)&v4 init];
}
...
- (__SwiftNativeNSMutableArrayBase)autorelease
{
  return (__SwiftNativeNSMutableArrayBase *)MEMORY[0x1F4181450](self, a2);
}
