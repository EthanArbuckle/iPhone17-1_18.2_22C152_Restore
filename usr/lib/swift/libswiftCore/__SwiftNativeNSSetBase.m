...
- (__SwiftNativeNSSetBase)autorelease;
- (__SwiftNativeNSSetBase)initWithCoder:(id)a3;
- (__SwiftNativeNSSetBase)retain;
...
{
  v4.receiver = self;
  v4.super_class = (Class)__SwiftNativeNSSetBase;
...
- (__SwiftNativeNSSetBase)autorelease
{
  return (__SwiftNativeNSSetBase *)MEMORY[0x1F4181450](self, a2);
}
