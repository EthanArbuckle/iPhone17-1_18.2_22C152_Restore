...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"enableSetNeedsDisplay");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"drawableColorFormat");
  CFDictionaryAddValue(v3, @"propertyRuntimeType", @"GLKViewDrawableColorFormat");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"drawableDepthFormat");
  CFDictionaryAddValue(v4, @"propertyRuntimeType", @"GLKViewDrawableDepthFormat");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"drawableMultisample");
  CFDictionaryAddValue(v5, @"propertyRuntimeType", @"GLKViewDrawableMultisample");
  ...
  CFDictionaryAddValue(v6, @"propertyName", @"drawableStencilFormat");
  CFDictionaryAddValue(v6, @"propertyRuntimeType", @"GLKViewDrawableStencilFormat");
