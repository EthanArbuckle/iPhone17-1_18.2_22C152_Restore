...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"allowsInlineMediaPlayback");
  ...
  CFDictionaryAddValue(v13, @"propertyName", @"gapBetweenPages");
  ...
  CFDictionaryAddValue(v12, @"propertyName", @"keyboardDisplayRequiresUserAction");
  ...
  CFDictionaryAddValue(v11, @"propertyName", @"mediaPlaybackAllowsAirPlay");
  ...
  CFDictionaryAddValue(v10, @"propertyName", @"mediaPlaybackRequiresUserAction");
  ...
  CFDictionaryAddValue(v2, @"propertyName", @"pageLength");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"scalesPageToFit");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"suppressesIncrementalRendering");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"dataDetectorTypes");
  CFDictionaryAddValue(v5, @"propertyRuntimeType", @"UIDataDetectorTypes");
  ...
  CFDictionaryAddValue(v6, @"propertyName", @"paginationBreakingMode");
  CFDictionaryAddValue(v6, @"propertyRuntimeType", @"UIWebPaginationBreakingMode");
  ...
  CFDictionaryAddValue(v7, @"propertyName", @"paginationMode");
  CFDictionaryAddValue(v7, @"propertyRuntimeType", @"UIWebPaginationMode");
  ...
  v16[11] = v7;
  v8 = +[NSArray arrayWithObjects:v16 count:12];
