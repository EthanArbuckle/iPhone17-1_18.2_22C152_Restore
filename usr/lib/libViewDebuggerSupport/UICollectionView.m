...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"numberOfSections");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"dataSource");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"delegate");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"collectionViewLayout");
