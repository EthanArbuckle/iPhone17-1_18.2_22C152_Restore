...
LABEL_7:
  ...
  if ([v8 isEqualToString:@"largeTitleTextShadowOffset"])
  {
    ...
    CFNumberRef v14 = CFArrayCreate(0, v26, 2, &kCFTypeArrayCallBacks);
    CFRelease(*v26);
    CFRelease(v26[1]);
    free(v26);
    goto LABEL_7;
...
LABEL_19:
  ...
  if ((v15 & 1) == 0)
  {
    ...
    NSSelectorFromString((NSString *)v32);
