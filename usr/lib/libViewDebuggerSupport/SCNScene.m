...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  uint64_t v13 = 8;
  CFNumberRef v5 = CFNumberCreate(0, kCFNumberCFIndexType, &v13);
  CFDictionaryAddValue(Mutable, @"visibility", v5);
  CFRelease(v5);
  uint64_t v13 = 1;
  CFNumberRef v6 = CFNumberCreate(0, kCFNumberCFIndexType, &v13);
  ...
  uint64_t v13 = 1;
  CFNumberRef v10 = CFNumberCreate(0, kCFNumberCFIndexType, &v13);
...
LABEL_26:
  ...
  Class v10 = NSClassFromString(&cfstr_Scnkeyedarchiv.isa);
  ...
  v30[2] = v12;
  id v13 = +[NSDictionary dictionaryWithObjects:v30 forKeys:v29 count:3];
