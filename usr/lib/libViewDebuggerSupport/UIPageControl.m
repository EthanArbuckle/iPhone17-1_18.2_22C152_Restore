...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"currentPage");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"currentPageIndicatorTintColor");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"defersCurrentPageDisplay");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"hidesForSinglePage");
  ...
  CFDictionaryAddValue(v6, @"propertyName", @"numberOfPages");
  CFDictionaryAddValue(v6, @"propertyRuntimeType", @"NSInteger");
  ...
  CFDictionaryAddValue(v7, @"propertyName", @"pageIndicatorTintColor");
  CFDictionaryAddValue(v7, @"propertyRuntimeType", @"UIColor");
