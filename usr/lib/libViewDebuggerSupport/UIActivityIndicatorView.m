...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"activityIndicatorViewStyle");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"color");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"hidesWhenStopped");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"animating");
  ...
  CFDictionaryAddValue(v6, @"propertyName", @"activityIndicatorViewStyle");
  CFDictionaryAddValue(v6, @"propertyRuntimeType", @"UIActivityIndicatorViewStyle");
