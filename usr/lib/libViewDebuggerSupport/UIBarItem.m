...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"imageInsets");
  CFDictionaryAddValue(v3, @"propertyRuntimeType", @"UIEdgeInsets");
  CFDictionaryAddValue(v3, @"propertyLogicalType", @"DebugHierarchyLogicalPropertyTypeInsets");
  CFDictionaryAddValue(v3, @"propertyFormat", @"CGf, CGf, CGf, CGf");
  v11[1] = v3;
  v4 = CFDictionaryCreateMutable(0, 7, &kCFCopyStringDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  CFDictionaryAddValue(v4, @"propertyName", @"title");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"tag");
