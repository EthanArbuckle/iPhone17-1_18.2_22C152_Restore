...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"barTintColor");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"translucent");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"barStyle");
  CFDictionaryAddValue(v5, @"propertyRuntimeType", @"UIBarStyle");
