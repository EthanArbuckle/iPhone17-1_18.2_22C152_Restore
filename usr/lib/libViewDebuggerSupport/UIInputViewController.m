...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"inputView");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"textDocumentProxy");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"primaryLanguage");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"hasFullAccess");
  ...
  CFDictionaryAddValue(v6, @"propertyName", @"needsInputModeSwitchKey");
