...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(Mutable, @"propertyName", @"session");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"delegate");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"activationState");
  CFDictionaryAddValue(v5, @"propertyRuntimeType", @"UISceneActivationState");
