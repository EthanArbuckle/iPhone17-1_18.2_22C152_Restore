...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  CFDictionaryAddValue(v13, @"propertyName", @"showsCompass");
  ...
  CFDictionaryAddValue(v12, @"propertyName", @"showsPointsOfInterest");
  ...
  CFDictionaryAddValue(v11, @"propertyName", @"showsScale");
  ...
  CFDictionaryAddValue(v2, @"propertyName", @"showsTraffic");
  ...
  CFDictionaryAddValue(v3, @"propertyName", @"showsUserLocation");
  ...
  CFDictionaryAddValue(v4, @"propertyName", @"pitchEnabled");
  ...
  CFDictionaryAddValue(v5, @"propertyName", @"rotateEnabled");
  ...
  CFDictionaryAddValue(v6, @"propertyName", @"scrollEnabled");
  ...
  CFDictionaryAddValue(v7, @"propertyName", @"zoomEnabled");
  ...
  CFDictionaryAddValue(v8, @"propertyName", @"mapType");
  CFDictionaryAddValue(v8, @"propertyRuntimeType", @"MKMapType");
  ...
  v15[10] = v8;
  v9 = +[NSArray arrayWithObjects:v15 count:11];
