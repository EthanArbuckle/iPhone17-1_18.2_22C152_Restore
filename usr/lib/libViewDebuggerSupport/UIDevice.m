...
+ (id)fallback_debugHierarchyObjectsInGroupWithID:(id)a3 outOptions:(id *)a4
{
  if (objc_msgSend(a3, "isEqualToString:", @"com.apple.UIKit.UIDevice", a4))
  {
...
+ (id)fallback_debugHierarchyPropertyDescriptions
{
  ...
  v16[6] = v3;
  uint64_t v4 = CFDictionaryCreateMutable(0, 7, &kCFCopyStringDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
  ...
  v16[9] = v7;
  uint64_t v8 = +[NSArray arrayWithObjects:v16 count:10];
...
LABEL_25:
    ...
    if (a6)
    {
      ...
      *(void *)v27.sysname = v21;
      *(void *)&v27.sysname[8] = v20;
      v28[2] = @"errorDescription";
      *(void *)&v27.sysname[16] = &stru_3C770;
      v22 = v21;
