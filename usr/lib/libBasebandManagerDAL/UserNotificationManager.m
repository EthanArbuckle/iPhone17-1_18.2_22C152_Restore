...
+ (id)sharedInstance:()basic_string<char
{
  ...
  if (*((char *)&a3->var0.var0.var0.var1 + 23) < 0)
  {
    ...
    if (qword_26A99F678 == -1)
    {
LABEL_3:
      id v3 = (id)qword_26A99F670;
  ...
  dispatch_once(&qword_26A99F678, block);
  id v3 = (id)qword_26A99F670;
  if ((*((char *)&__p.var0.var1 + 23) & 0x80000000) == 0)
  {
LABEL_4:
...
- (void)setUpNotificationCenter:(id)a3
{
  ...
  if (!self->fUserNotificationCenter)
  {
    ...
    v6 = (UNUserNotificationCenter *)[objc_alloc(MEMORY[0x263F1DFB0]) initWithBundleIdentifier:v5];
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v13 = v5;
      _os_log_impl(&dword_26368A000, v8, OS_LOG_TYPE_DEFAULT, "#I UserNotificationCenter created with bundleID %@", buf, 0xCu);
    }
  }
}
...
- (BOOL)setActionForHeader:(UserNotificationManager *)self notificationContent:(SEL)a2 callbackData:(NotificationInfo *)a3
{
  ...
  v104 = v7;
  v102 = self;
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_26A99F680, memory_order_acquire) & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_26A99F680);
    if (v7)
    {
      _MergedGlobals_0 = TelephonyUtilIsInternalBuild();
      __cxa_guard_release(&qword_26A99F680);
    }
  }
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_26A99F690, memory_order_acquire) & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_26A99F690);
    if (v7)
    {
      if (_MergedGlobals_0) {
      ...
      qword_26A99F688 = v100;
      __cxa_guard_release(&qword_26A99F690);
    }
  }
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_26A99F6A0, memory_order_acquire) & 1) == 0)
  {
    v7 = (config::hw *)__cxa_guard_acquire(&qword_26A99F6A0);
    if (v7)
    {
      if (_MergedGlobals_0) {
      ...
      qword_26A99F698 = v101;
      __cxa_guard_release(&qword_26A99F6A0);
    }
  }
  if (config::hw::watch(v7)) {
    [MEMORY[0x263F1DF40] iconForApplicationIdentifier:@"com.apple.Preferences"];
  }
  else {
  uint64_t v9 = [MEMORY[0x263F1DF40] iconForSystemImageNamed:@"antenna.radiowaves.left.and.right"];
  }
  [v104 setIcon:v9];
  ...
  if (!memcmp(v12, "Telephony_Dump_Ready", v13) && v11 == 20)
  {
    ...
    uint64_t v9 = [MEMORY[0x263F1DF40] iconForApplicationIdentifier:@"com.apple.TapToRadar"];
    [v104 setIcon:v9];
    goto LABEL_38;
  }
  unint64_t v14 = v10;
  ...
  {
LABEL_37:
    uint64_t v9 = [MEMORY[0x263F1DF40] iconForApplicationIdentifier:@"com.apple.Preferences"];
    [v104 setIcon:v9];
LABEL_38:
  ...
  if (memcmp(v80, "Telephony_Dump_Started", v81) || v10 != 22)
  {
    ...
    if (os_log_type_enabled(v82, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_error_impl(&dword_26368A000, v82, OS_LOG_TYPE_ERROR, "Not supported header - %s", buf, 0xCu);
    }
    BOOL v84 = 0;
    goto LABEL_215;
  }
LABEL_39:
  ...
  {
    v29 = [NSURL URLWithString:qword_26A99F688];
  ...
  else
  {
    ...
    {
      v29 = [NSURL URLWithString:qword_26A99F698];
      [v104 setDefaultActionURL:v29];
    }
    else
    {
      ...
      {
        v29 = [NSURL URLWithString:@"prefs:root=MOBILE_DATA_SETTINGS_ID&path=CELLULAR_DIAGNOSTICS_ID"];
        [v104 setDefaultActionURL:v29];
      }
      else
      {
        ...
        v29 = [NSURL URLWithString:@"prefs:root=General&path=ManagedConfigurationList"];
        [v104 setDefaultActionURL:v29];
      }
    }
  }
...
LABEL_211:
      ...
      *(_DWORD *)buf = 136315138;
      v110 = a3;
      _os_log_impl(&dword_26368A000, v93, OS_LOG_TYPE_DEFAULT, "#I Add callback for id: %s", buf, 0xCu);
    }
  }
...
LABEL_27:
  unint64_t v11 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
  uint64_t v12 = a1 + 64;
  if (*(char *)(a1 + 87) < 0) {
    uint64_t v12 = *(void *)v6;
  }
  id v13 = [NSString stringWithUTF8String:v12];
  unint64_t v14 = [v11 localizedStringForKey:v13 value:&stru_270EADD90 table:@"Localizable"];
  [v3 setHeader:v14];
  ...
  {
    size_t v19 = NSString;
    unint64_t v20 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
    v21 = [v20 localizedStringForKey:@"Telephony_Dump_Insufficient_Details_%@" value:&stru_270EADD90 table:@"Localizable"];
    if (*(char *)(a1 + 111) < 0) {
      v7 = *(_OWORD **)v7;
    }
...
LABEL_49:
  ...
  if (!memcmp(v25, "Telephony_Dump_Started", v26) && v24 == 22)
  {
    ...
    size_t v22 = [v20 localizedStringForKey:v21 value:&stru_270EADD90 table:@"Localizable"];
  ...
  {
    unint64_t v20 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
    v21 = [v20 localizedStringForKey:@"Check_Settings_Cellular_Diagnostics" value:&stru_270EADD90 table:@"Localizable"];
    [v3 setBody:v21];
    goto LABEL_51;
  }
  unint64_t v20 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
...
LABEL_51:
  size_t v28 = [MEMORY[0x263F1DF68] defaultSound];
  [v3 setSound:v28];
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315138;
    uint64_t v46 = v35;
    _os_log_impl(&dword_26368A000, v33, OS_LOG_TYPE_DEFAULT, "#I Add notification request with id: %s", buf, 0xCu);
  }
...
LABEL_9:
  ...
  xpc_dictionary_set_value(v38, (const char *)*MEMORY[0x263F265E0], v10);
  ...
  xpc_dictionary_set_value(v38, (const char *)*MEMORY[0x263F265E8], v16);
  ...
  xpc_dictionary_set_value(v38, (const char *)*MEMORY[0x263F265D8], v19);
  xpc_object_t v20 = xpc_null_create();
  xpc_release(v19);
  xpc_release(v20);
  memset(&__dst, 170, sizeof(__dst));
  v21 = (const void *)*MEMORY[0x263F26530];
  size_t v22 = strlen((const char *)*MEMORY[0x263F26530]);
...
LABEL_32:
  ...
  *(_DWORD *)buf = 136315394;
  ...
  __int16 v41 = 2080;
  std::string v42 = v29;
  _os_log_impl(&dword_26368A000, v27, OS_LOG_TYPE_DEFAULT, "#I Submitting CoreAnalytics event[%s] - %s", buf, 0x16u);
  if (v34 < 0) {
...
LABEL_9:
  ...
  *(void *)((char *)&buf + 4) = v14;
  _os_log_impl(&dword_26368A000, v12, OS_LOG_TYPE_DEFAULT, "#I Received notification response with id: %s", (uint8_t *)&buf, 0xCu);
LABEL_15:
...
LABEL_102:
            ...
            *(_DWORD *)unint64_t v66 = 136315138;
            size_t v67 = v47;
            _os_log_impl(&dword_26368A000, v45, OS_LOG_TYPE_DEFAULT, "#I Remove callback for id: %s", v66, 0xCu);
            if ((v63[23] & 0x80000000) != 0) {
              goto LABEL_105;
            }
LABEL_109:
