...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationPayloadTagOS metaDataTableEntry];
  id v4 = NSString;
...
- (id)generateTLV
{
  ...
  int v8 = uarpHtonl(+[UARPTLVPersonalizationPayloadTagOS tlvType]);
  [v3 appendBytes:&v8 length:4];
  int v7 = uarpHtonl(4u);
  [v3 appendBytes:&v7 length:4];
  id v4 = [(UARPTLVPersonalizationPayloadTagOS *)self tlvValue];
  [v3 appendData:v4];
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationPayloadTagOS tlvType](UARPTLVPersonalizationPayloadTagOS, "tlvType")];
  v6[1] = v2;
