...
- (UARPSuperBinaryPayloadOS)initWithData:(id)a3 metaData:(id)a4 tag:(id)a5 version:(id)a6;
...
- (UARPSuperBinaryPayloadOS)initWithData:(id)a3 metaData:(id)a4 tag:(id)a5 version:(id)a6
{
  ...
  id v13 = a6;
  v36.receiver = self;
  v36.super_class = (Class)UARPSuperBinaryPayloadOS;
  v14 = [(UARPSuperBinaryPayloadOS *)&v36 init];
  if (v14)
  {
    uint64_t v15 = [v12 copy];
    tag = v14->_tag;
    v14->_tag = (UARPAssetTagOS *)v15;

    uint64_t v17 = [v13 copy];
    version = v14->_version;
    v14->_version = (UARPAssetVersionOS *)v17;
...
- (id)personalizedData
{
  if (self->_ftab)
  {
    ...
    if (self->_manifest) {
      -[FTABFileOS setManifest:](self->_ftab, "setManifest:");
    }
    v3 = (NSData *)[(FTABFileOS *)self->_ftab writeToData];
  }
  else
  {
...
- (id)composeTSSRequest:(unint64_t)a3
{
  return [(UARPSuperBinaryPayloadOS *)self composeTSSRequest:a3 asMeasurement:0];
}
...
- (id)composeTSSRequest:(unint64_t)a3 asMeasurement:(BOOL)a4
{
  ...
  if (!v4)
  {
    ...
    id v32 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"BoardID" unitNumber:a3];
    id v12 = [NSNumber numberWithUnsignedInt:-[UARPSuperBinaryPayloadOS boardID](self, "boardID")];
    [(NSMutableDictionary *)self->_tssRequest setObject:v12 forKeyedSubscript:v32];

    id v30 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"ChipID" unitNumber:a3];
    id v13 = [NSNumber numberWithUnsignedInt:-[UARPSuperBinaryPayloadOS chipID](self, "chipID")];
    [(NSMutableDictionary *)self->_tssRequest setObject:v13 forKeyedSubscript:v30];

    id v14 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"ECID" unitNumber:a3];
    id v15 = [NSNumber numberWithUnsignedLongLong:-[UARPSuperBinaryPayloadOS ecID](self, "ecID")];
    [(NSMutableDictionary *)self->_tssRequest setObject:v15 forKeyedSubscript:v14];

    id v16 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"Nonce" unitNumber:a3];
    long long v17 = [(UARPSuperBinaryPayloadOS *)self nonce];
    [(NSMutableDictionary *)self->_tssRequest setObject:v17 forKeyedSubscript:v16];

    id v18 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"ProductionMode" unitNumber:a3];
    int v19 = [(UARPSuperBinaryPayloadOS *)self productionMode];
    ...
    id v23 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"SecurityDomain" unitNumber:a3];
    id v24 = [NSNumber numberWithUnsignedChar:-[UARPSuperBinaryPayloadOS securityDomain](self, "securityDomain")];
    [(NSMutableDictionary *)self->_tssRequest setObject:v24 forKeyedSubscript:v23];

    id v25 = [(UARPSuperBinaryPayloadOS *)self tssKeyName:@"SecurityMode" unitNumber:a3];
  ...
  [(UARPSuperBinaryPayloadOS *)self processMeasurementsForTSSOptions:self->_tssRequest unitNumber:a3 asMeasurement:v4];
        ...
        do
        {
          for (uint64_t i = 0; i != v11; ++i)
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              if ([(UARPSuperBinaryPayloadOS *)v30 securityMode]) {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              if ([(UARPSuperBinaryPayloadOS *)v30 productionMode]) {
                uint64_t v19 = MEMORY[0x263EFFA88];
              }
              else {
                uint64_t v19 = MEMORY[0x263EFFA80];
...
- (id)description
{
  ...
  id v4 = (id)[NSString stringWithString:v3];
...
- (id)tatsuMeasurements:(unint64_t)a3
{
  ...
  if (v5) {
    id v5 = [(UARPSuperBinaryPayloadOS *)self composeTSSRequest:a3 asMeasurement:1];
  }
...
- (UARPAssetTagOS)tag
{
  return (UARPAssetTagOS *)objc_getProperty(self, a2, 120, 1);
}

- (UARPAssetVersionOS)version
{
  return (UARPAssetVersionOS *)objc_getProperty(self, a2, 128, 1);
}
...
- (void)addSubfile:(id)a3 tag:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [[FTABSubfileOS alloc] initWithTag:v6 data:v7];
