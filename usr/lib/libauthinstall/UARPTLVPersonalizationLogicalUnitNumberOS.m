...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationLogicalUnitNumberOS;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationLogicalUnitNumberOS metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationLogicalUnitNumberOS tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationLogicalUnitNumberOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationLogicalUnitNumberOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [(id)[NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationLogicalUnitNumberOS tlvType](UARPTLVPersonalizationLogicalUnitNumberOS, "tlvType")];
  v6[1] = v2;
