...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationFTABSubfileEPROOS;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationFTABSubfileEPROOS metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationFTABSubfileEPROOS tlvType];
  uint64_t v4 = *((unsigned __int16 *)&self->super.super._tlvLength + 2);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationFTABSubfileEPROOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationFTABSubfileEPROOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationFTABSubfileEPROOS tlvType](UARPTLVPersonalizationFTABSubfileEPROOS, "tlvType")];
  v6[1] = v2;
