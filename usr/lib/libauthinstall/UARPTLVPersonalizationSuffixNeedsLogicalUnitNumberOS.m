...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS tlvType];
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [(id)[NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS tlvType](UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberOS, "tlvType")];
  v6[1] = v2;
