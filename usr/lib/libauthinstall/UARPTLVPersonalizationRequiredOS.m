...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationRequiredOS;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationRequiredOS metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationRequiredOS tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationRequiredOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationRequiredOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationRequiredOS tlvType](UARPTLVPersonalizationRequiredOS, "tlvType")];
  v6[1] = v2;
