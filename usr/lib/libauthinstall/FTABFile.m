...
- (NSString)dumpString
{
  ...
  v9 = (void *)[v7 initWithData:v8 encoding:4];
...
- (FTABFile)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v8 = [MEMORY[0x263EFF8F8] dataWithBytes:&kFTABMagicLowercase_0 length:8];
    magic = v2->_magic;
    v2->_magic = (NSData *)v8;
  }
  return v2;
...
- (BOOL)parseFileData
{
  if (self->_fileLength > 0x2F)
  {
    ...
    if (*((void *)filePointer + 4) == 0x42415446534F4B52 || *v12 == 0x62617466736F6B72)
    {
      ...
      uint64_t v15 = [MEMORY[0x263EFF8F8] dataWithBytes:filePointer + 8 length:8];
...
- (NSString)bverString
{
  ...
  if (v2 && (int v4 = [v2 dataLength]) != 0)
  {
    ...
    id v6 = [[NSString alloc] initWithBytes:[v3 dataPointer] length:v5 encoding:4];
  }
  else
  {
    id v6 = 0;
...
- (void)writeToDestination
{
  os_log_t v1 = [a1 tag];
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_0_1(&dword_217A74000, v2, v3, "Failed to write '%@' header", v4, v5, v6, v7, v8);
}
