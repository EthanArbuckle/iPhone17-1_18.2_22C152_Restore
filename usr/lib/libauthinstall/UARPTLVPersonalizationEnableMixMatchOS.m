...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationEnableMixMatchOS;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationEnableMixMatchOS metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationEnableMixMatchOS tlvType];
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationEnableMixMatchOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationEnableMixMatchOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationEnableMixMatchOS tlvType](UARPTLVPersonalizationEnableMixMatchOS, "tlvType")];
  v6[1] = v2;
