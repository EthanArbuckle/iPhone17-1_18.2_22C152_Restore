...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVRequiredPersonalizationOptionOS;
...
- (id)description
{
  id v3 = +[UARPTLVRequiredPersonalizationOptionOS metaDataTableEntry];
  v4 = NSString;
  id v5 = (id)[v3 objectForKeyedSubscript:@"Name"];
  id v6 = +[UARPMetaDataTLVOS tlvTypeName:*(&self->super.super._tlvLength + 1)];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVRequiredPersonalizationOptionOS tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVRequiredPersonalizationOptionOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVRequiredPersonalizationOptionOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [(id)[NSNumber numberWithUnsignedInt:+[UARPTLVRequiredPersonalizationOptionOS tlvType](UARPTLVRequiredPersonalizationOptionOS, "tlvType")];
  v6[1] = v2;
