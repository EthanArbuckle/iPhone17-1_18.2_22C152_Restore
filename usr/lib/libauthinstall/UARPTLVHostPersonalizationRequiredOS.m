...
- (id)description
{
  id v3 = +[UARPTLVHostPersonalizationRequiredOS metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVHostPersonalizationRequiredOS tlvType];
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVHostPersonalizationRequiredOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVHostPersonalizationRequiredOS;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = [NSNumber numberWithUnsignedInt:+[UARPTLVHostPersonalizationRequiredOS tlvType](UARPTLVHostPersonalizationRequiredOS, "tlvType")];
  v6[1] = v2;
