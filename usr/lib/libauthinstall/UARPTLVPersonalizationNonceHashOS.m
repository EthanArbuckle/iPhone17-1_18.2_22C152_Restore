...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationNonceHashOS metaDataTableEntry];
  id v4 = NSString;
  id v5 = (id)[v3 objectForKeyedSubscript:@"Name"];
  id v6 = (id)[v4 stringWithFormat:@"<%@: %@>", v5, self->_nonceHash];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationNonceHashOS tlvType];
  nonceHash = self->_nonceHash;
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationNonceHashOS;
  id v5 = [(UARPMetaDataTLVDataOS *)&v7 generateTLV:v3 tlvValue:nonceHash];
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = (id)[NSNumber numberWithUnsignedInt:+[UARPTLVPersonalizationNonceHashOS tlvType](UARPTLVPersonalizationNonceHashOS, "tlvType")];
  v6[1] = v2;
