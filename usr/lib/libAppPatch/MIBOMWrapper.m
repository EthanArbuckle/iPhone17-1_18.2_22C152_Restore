...
+ (BOOL)_countFilesAndBytesInArchiveAtURL:(id)a3 withBOMCopier:(_BOMCopier *)a4 totalFiles:(unint64_t *)a5 totalUncompressedBytes:(unint64_t *)a6 error:(id *)a7
{
  ...
  _CreateError((uint64_t)"+[MIBOMWrapper _countFilesAndBytesInArchiveAtURL:withBOMCopier:totalFiles:totalUncompressedBytes:error:]", 149, @"MIInstallerErrorDomain", 4, 0, 0, @"Failed to count the files and bytes in archive : %d (%s)", v9, v10);
...
+ (BOOL)extractZipArchiveAtURL:(id)a3 toURL:(id)a4 withError:(id *)a5 extractionProgressBlock:(id)a6
{
  ...
  [v12 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"extractPKZip"];
  uint64_t v42 = 0;
  BomSys_init();
  BomSys_set_open();
  ...
  if (v15)
  {
    ...
    if (v11)
    {
      ...
      if (v19)
      {
        ...
        v20 = (void *)MEMORY[0x230FCACD0](v11);
        *((void *)&v43 + 1) = v18;
        *(void *)&long long v44 = 0;
        uint64_t v21 = MEMORY[0x230FCACD0]();
        v22 = (void *)*((void *)&v44 + 1);
        *((void *)&v44 + 1) = v21;
    ...
    if (v32)
    {
      v33 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F08438] code:(int)v43 userInfo:0];
      v23 = _CreateAndLogError((uint64_t)"+[MIBOMWrapper extractZipArchiveAtURL:toURL:withError:extractionProgressBlock:]", 223, @"MIInstallerErrorDomain", 5, v33, &unk_26E5A33E0, @"Could not extract archive", v34, (uint64_t)v38);
    }
    else
    {
      v23 = 0;
  ...
  {
    v23 = _CreateAndLogError((uint64_t)"+[MIBOMWrapper extractZipArchiveAtURL:toURL:withError:extractionProgressBlock:]", 189, @"MIInstallerErrorDomain", 5, 0, 0, @"Failed to create copier", v14, (uint64_t)v38);
    v24 = (void *)*((void *)&v44 + 1);
    *((void *)&v44 + 1) = 0;
