...
- (ACMLocale_Dutch)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Wachtwoordveld is leeg", @"Annuleer", @"Log in", @"Stuur", @"OK", @"Ongeldig beroep op de methode. AppleConnect SignIn dialoogvenster kan niet worden verborgen.", @"Ongeldige parameters. Bepaalde invoerparameters zijn onjuist ingesteld.", @"Apple ID-wachtwoord", @"U lijkt offline te zijn. Maak verbinding met het internet en probeer het opnieuw.", @"Uw Apple ID of wachtwoord is onjuist ingevoerd.", @"Twee-staps-verificatie vereist, maar gebruikersinteractie is niet toegestaan.", @"BETROUWBARE APPARATEN", @"Om uw betrouwbare apparaten te beheren, gaat u naar %@ vanaf een Mac of pc.", @"Aanmaken geldig serviceticket mislukt", @"Twee-staps-verificatie antwoord is leeg.", @"Sms naar telefoonnummer", @"Er wordt een tijdelijke code gestuurd naar het apparaat dat u hieronder kiest, waarmee u uw identiteit kunt verifiëren.",
           ...
           @"john.appleseed",
           @"Stuur code naar %@",
           @"Onverwachte inroeping methode",
           @"U bent er te vaak niet in geslaagd om de code te verifiëren. Stuur een nieuwe code naar een ander apparaat of probeer het later opnieuw.",
           @"Ongeldig data-teken. Data-teken voor verifiëren is niet geldig.",
           @"Identiteitscontrole werd door programma geannuleerd",
           @"Ongeldige toegangscode-lengte",
           @"Verificatiecode",
           @"Deze Apple ID is om veiligheidsredenen buiten werking gesteld. U kunt uw wachtwoord opnieuw instellen op %@.",
           @"Niet in staat om berichten op uw apparaten te ontvangen?",
           @"Stuur een nieuwe code",
           @"Er is een fout opgetreden. Dank u voor uw geduld. Probeer het later opnieuw.",
           @"Vereist",
           @"Kan deze persoon niet vinden.",
           @"Voer verificatiecode in",
           @"Apparaat is niet gevonden.",
           @"Apple ID",
           @"Tweestapsverificatie is ingeschakeld voor deze Apple ID.",
           @"Kan teken niet verifiëren.",
           @"Wachtwoord",
           @"Om uw veiligheid te waarborgen, is het tijd om uw wachtwoord opnieuw in te stellen. U doet dit gewoon op %@.",
           @"De huidige tijd op dit apparaat lijkt onjuist te zijn. U kunt dit corrigeren via 'Instellingen > Algemeen > Datum en tijd', probeer daarna opnieuw.",
           @"Aanmaken geldig SSO-teken mislukt",
           @"De verificatiecode die u hebt ingevoerd is ongeldig.",
           @"Ga verder",
           @"Verifieer identiteit",
           @"Identiteitscontrole werd door systeem geannuleerd",
           @"Genereer code met %@",
           @"Apparaatlijst is leeg.",
           @"Ongeldige sessie.",
