...
- (ACMLocale_ms)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Medan kata laluan kosong", @"Batal", @"Daftar masuk", @"Hantar", @"OK", @"Panggilan tidak wajar untuk kaedah tersebut. Dialog AppleConnect SignIn tidak boleh disembunyikan.", @"Parameter Tidak Sah. Sesetengah parameter input disetkan dengan cara yang salah.", @"Kata laluan Apple ID", @"Anda mungkin berada di luar talian. Sila sambung ke Internet dan cuba lagi.", @"Apple ID atau kata laluan anda adalah salah.", @"Memerlukan pengesahan dua langkah, namun interaksi pengguna tidak dibenarkan.", @"PERANTI YANG DIPERCAYAI", @"Untuk mengurus peranti yang dipercayai, lawati %@ dari Mac atau PC.", @"Gagal mencipta tiket perkhidmatan yang sah", @"Respons pengesahan dua langkah tidak diisi.", @"SMS ke Nombor Telefon", @"Kod sementara akan dihantar ke peranti yang dipilih di bawah yang boleh digunakan untuk mengesahkan identiti anda.",
           ...
           @"johan.johari",
           @"Hantarkan kod ke %@",
           @"Kaedah panggilan yang tidak dijangka",
           @"Anda telah banyak kali gagal untuk mengesahkan kod. Sila hantar kod baru ke peranti yang berbeza atau cuba sebentar lagi.",
           @"Token Data Tidak Sah. Token Data untuk pengesahan tidak sah.",
           @"Pengesahan dibatalkan oleh aplikasi",
           @"Panjang kod laluan tidak sah",
           @"Kod Pengesahan",
           @"Nama akaun ini telah dilumpuhkan atas sebab keselamatan. Kata laluan anda boleh direset di %@.",
           @"Tidak dapat menerima mesej di mana-mana peranti anda?",
           @"Hantar kod baru",
           @"Ralat telah berlaku. Terima kasih atas kesabaran anda, sila cuba sebentar lagi.",
           @"Diperlukan",
           @"Tidak dapat mencari individu ini.",
           @"Masukkan kod pengesahan",
           @"Peranti tidak dijumpai.",
           @"Apple ID",
           @"Pengesahan dua langkah telah diaktifkan untuk Apple ID ini.",
           @"Tidak dapat mengesahkan token.",
           @"Kata Laluan",
           @"Untuk melindungi keselamatan, kata laluan anda perlu direset. Caranya mudah, hanya pergi ke %@.",
           @"Waktu semasa pada peranti ini adalah salah. Anda boleh mengesetkannya dengan pergi ke Seting > Umum > Tarikh & Masa, kemudian cuba lagi.",
           @"Gagal mencipta token SSO yang sah",
           @"Kod pengesahan yang anda masukkan tidak sah.",
           @"Teruskan",
           @"Sahkan Identiti",
           @"Pengesahan dibatalkan oleh sistem",
           @"Janakan kod dengan %@",
           @"Senarai peranti kosong.",
           @"Sesi Tidak Sah.",
