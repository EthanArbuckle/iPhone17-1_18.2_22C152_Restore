...
- (ACMLocale_Japanese)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"パスワードフィールドが空です", @"キャンセル", @"サインイン", @"送信", @"OK", @"無効な呼び出しメソッドです。AppleConnect サインインダイアログは非表示にできません。", @"無効なパラメータです。入力パラメータの設定が正しくない箇所があります。", @"Apple ID パスワード", @"接続がオフラインのようです。インターネットに接続してからもう一度試してください。", @"入力された Apple ID またはパスワードが正しくありません。", @"2ステップ確認が必要ですが、ユーザ入力が許可されていません。", @"信頼できるデバイス", @"信頼できるデバイスを管理するには、Mac または Windows PC から %@ にアクセスしてください。", @"有効なサービスチケットを作成できませんでした", @"2ステップ確認の応答が無効です。", @"電話番号へSMSを送信", @"以下で選択したデバイスに一時コードが送信されます。一時コードを使って本人確認を行ってください。",
           ...
           @"デバイスが見つかりません。",
           @"Apple ID",
           @"この Apple ID では2ステップ確認が有効になっています。",
           @"トークンを確認できません。",
           @"パスワード",
           @"セキュリティ保護のためにパスワードの変更をおすすめします。%@ から簡単に変更できます。",
           @"このデバイスの現在時刻が正しく設定されていないようです。「設定」＞「一般」＞「日付と時刻」で時刻を修正してから、もう一度試してください。",
           @"有効な SSO トークンを作成できませんでした",
           @"入力された確認コードは有効ではありません。",
           @"続ける",
           @"本人確認",
           @"システムによって認証がキャンセルされました",
           @"%@でコードを生成",
           @"デバイスリストが空です。",
           @"無効なセッションです。",
           @"不正なサーバ応答です",
