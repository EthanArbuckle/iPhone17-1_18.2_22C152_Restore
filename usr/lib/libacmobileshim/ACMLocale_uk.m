...
- (ACMLocale_uk)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Поле пароля порожнє", @"Скасувати", @"Увійдіть", @"Надіслати", @"ОК", @"Неправильний виклик методу. Неможливо приховати вікно входу до AppleConnect.", @"Недійсні параметри. Деякі вхідні параметри встановлено неправильно.", @"Пароль Apple ID", @"Ви офлайн. Під’єднайтеся до Інтернету та повторіть спробу.", @"Ваш Apple ID або пароль було введено неправильно.", @"Потрібне двоетапне підтвердження без взаємодії з користувачем.", @"ДОВІРЕНІ ПРИСТРОЇ", @"Для управління довіреними пристроями відвідайте %@ з Mac або ПК.", @"Не вдалося створити дійсну сервісну заявку", @"Відповідь двоетапного підтвердження порожня.", @"Надіслати SMS на номер телефону", @"На пристрій обраний нижче буде надіслано тимчасовий код, потрібний для підтвердження особистості.",
           @"Недостатньо пам’яті",
           @"stepan.yabluchko",
           @"Надіслати код на %@",
           @"Неочікуваний виклик методу",
           @"Забагато спроб підтвердити код. Надішліть новий код на інший пристрій або повторіть спробу пізніше.",
           @"Недійсний токен даних. Токен даних для перевірки недійсний.",
           @"Автентифікацію скасовано програмою",
           @"Неприпустима довжина паролю",
           @"Код перевірки",
           @"Обліковий запис заблоковано з міркувань безпеки. Ви можете скинути пароль на %@.",
           @"Не маєте доступу до пристроїв?",
           @"Надіслати новий код",
           @"Сталася помилка. Будь ласка, повторіть спробу пізніше.",
           @"Обов'язково",
           @"Не вдалося знайти користувача.",
           @"Введіть код перевірки",
           @"Пристрій не знайдено.",
           @"Apple ID",
           @"Для Apple ID увімкнено двоетапне підтвердження. ",
           @"Не вдалося перевірити токен.",
           @"Пароль",
           @"З міркувань безпеки слід скинути пароль. Це дуже легко: просто перейдіть на %@.",
           @"Схоже, поточний час на цьому пристрої неправильний. Щоб виправити це, перейдіть у Параметри > Загальні > Дата і час і повторіть спробу.",
           @"Не вдалося створити дійсний SSO-токен",
           @"Вказано невірний код перевірки.",
           @"Продовжити",
           @"Підтвердити особистість",
           @"Автентифікацію скасовано системою",
           @"Створити код за допомогою %@",
