...
- (ACMLocale_da)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Feltet Adgangskode er tomt", @"Annuller", @"Log ind", @"Send", @"OK", @"Ugyldig metode. Log ind-dialogen for AppleConnect kan ikke skjules.", @"Ugyldige parametre. Nogle af inputparametrene er ikke indstillet korrekt.", @"Adgangskode til Apple-id", @"Du lader til at være offline. Opret forbindelse til internettet og prøv igen.", @"Du har skrevet et forkert Apple-id eller adgangskode.", @"Totrinsbekræftelse kræves, men brugerhandling er ikke tilladt.", @"PÅLIDELIGE ENHEDER", @"Gå til %@ på en Mac eller pc for at administrere dine pålidelige enheder.", @"Kunne ikke oprette en gyldig serviceanmodning", @"Svaret til totrinsbekræftelse mangler.", @"Sms til telefonnummer", @"Der sendes en midlertidig kode til den valgte enhed nedenfor. Du kan bruge koden til at bekræfte din identitet.",
           @"Ikke mere hukommelse",
           @"jens.nielsen",
           @"Send kode til %@",
           @"Uventet aktivering af metode",
           @"Der har været for mange mislykkede forsøg på at bekræfte koden. Send en ny kode til en anden enhed eller prøv igen senere.",
           @"Ugyldigt datatoken. Datatokenet til bekræftelse er ikke gyldigt.",
           @"Godkendelsen blev annulleret af appen",
           @"Ugyldig længde på adgangskode",
           @"Bekræftelseskode",
           @"Dette Apple-id er blevet slået fra af hensyn til din sikkerhed. Du kan nulstille din adgangskode på %@",
           @"Kan du ikke modtage meddelelser på nogen af dine enheder?",
           @"Send en ny kode",
           @"Der opstod en fejl. Undskyld ulejligheden. Prøv venligst igen senere.",
           @"Påkrævet",
           @"Kan ikke finde denne person.",
           @"Angiv bekræftelseskoden",
           @"Kan ikke finde enheden.",
           @"Apple-id",
           @"Totrinsbekræftelse er aktiveret for dette Apple‑id. ",
           @"Kan ikke bekræfte tokenet.",
           @"Adgangskode",
           @"Nulstille din adgangskode for at beskytte din sikkerhed. Det er nemt – bare gå til %@",
           @"Nuværende tid på denne enhed er tilsyneladende forkert. Du kan rette det ved at gå til Indstillinger > Generelt > Dato & tid. Prøv derefter igen.",
           @"Kunne ikke oprette et gyldigt SSO-token",
           @"Den angivne bekræftelseskode er ikke gyldig.",
           @"Fortsæt",
           @"Bekræft identitet",
           @"Godkendelsen blev annulleret af systemet",
           @"Generer kode med %@",
           @"Listen med enheder er tom.",
           @"Ugyldig session.",
