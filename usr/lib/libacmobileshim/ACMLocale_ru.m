...
- (ACMLocale_ru)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Поле пароля не заполнено", @"Отменить", @"Войти", @"Отправить", @"ОК", @"Неверный вызов метода. Окно входа в Apple Connect невозможно скрыть.", @"Неверные параметры. Некоторые из входных параметров заданы неверно.", @"Пароль для Apple ID", @"Вы не в сети. Подключитесь к Интернету и повторите попытку.", @"Введен неверный Apple ID или пароль.", @"Требуется двухэтапная проверка без участия пользователя.", @"ПРОВЕРЕННЫЕ УСТРОЙСТВА", @"Для управления проверенными устройствами зайдите на %@ с Mac или PC.", @"Не удалось создать действительную сервисную заявку", @"Пустой отклик двухэтажной проверки.", @"SMS-сообщение на номер телефона", @"Временный код для подтверждения личности будет выслан на устройство, выбранное из списка ниже.",
           ...
           @"Не удается получить сообщения ни на одно устройство?",
           @"Отправить новый код",
           @"Произошла ошибка. Повторите попытку позже. Благодарим Вас за понимание.",
           @"Обязательно",
           @"Не удается найти пользователя.",
           @"Введите код проверки",
           @"Устройство не найдено.",
           @"Apple ID",
           @"Для этого Apple ID активирована двухэтапная проверка.",
           @"Не удается подтвердить токен.",
           @"Пароль",
           @"В целях безопасности необходимо сборосить пароль. Для этого просто перейдите на %@.",
           @"Текущее время на устройстве задано неверно. Измените время в меню «Настройки» > «Основные» > «Дата и время» и повторите попытку.",
           @"Не удалось создать действительный SSO-токен",
           @"Введен неверный код проверки.",
           @"Продолжить",
           @"Подтверждение личности",
           @"Система отменила аутентификацию",
           @"Генерировать код с помощью %@",
