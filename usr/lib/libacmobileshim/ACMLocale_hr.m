...
- (ACMLocale_hr)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Polje lozinke je prazno.", @"Odustani", @"Prijavite se", @"Pošalji", @"U redu", @"Nepravilno pozivanje metode. Nije moguće sakriti dijalog za AppleConnect SignIn.", @"Nevažeći parametri. Neki ulazni parametri nisu pravilno postavljeni.", @"Lozinka za Apple ID", @"Izgleda da niste na mreži. Povežite se s internetom i pokušajte poslije ponovno.", @"Netočno je unesen Apple ID ili lozinka.", @"Potrebna je provjera valjanosti u dva koraka, ali interakcija korisnika nije dopuštena.", @"POUZDANI UREĐAJI", @"Da biste upravljali svojim pouzdanim uređajima, posjetite %@ korištenjem Mac ili PC računala.", @"Izrada valjane uslužne karte nije uspjela", @"Odgovor na provjeru valjanosti u dva koraka je prazan.", @"SMS na telefonski broj", @"Na uređaj koji odaberete u nastavku bit će poslan privremeni kod pomoću kojeg možete potvrditi svoj identitet.",
           @"Nema memorije",
           @"ivan.novak",
           @"Pošalji kôd na %@",
           @"Neočekivani poziv metode",
           @"Previše ste puta neuspješno pokušali provjeriti valjanost koda. Pošalji novi kod na drugi uređaj pa pokušajte poslije ponovno.",
           @"Nevažeći podatkovni token. Podatkovni token za provjeru nije valjan.",
           @"Aplikacija je prekinula provjeru autentičnosti",
           @"Dužina lozinke nije valjana",
           @"Kod za provjeru valjanosti",
           @"Ovaj Apple ID onemogućen je iz sigurnosnih razloga. Svoju lozinku možete poništiti na adresi %@.",
           @"Nemate mogućnost primanja poruka ni na jedan uređaj?",
           @"Pošaljite novi kod",
           @"Dogodila se pogreška. Hvala vam na strpljenju, pokušajte poslije ponovno.",
           @"Potrebno",
           @"Nije moguće pronaći ovu osobu.",
           @"Unesite kod za provjeru valjanosti",
           @"Uređaj nije pronađen.",
           @"Apple ID",
           @"Provjera valjanosti u dva koraka omogućena je za ovaj Apple ID.",
           @"Nije moguće provjeriti token.",
           @"Lozinka",
           @"Kako bi zaštitili svoju sigurnost, vrijeme je da poništite svoju lozinku. To je jednostavno, samo odite na adresu %@.",
           @"Trenutno vrijeme na ovom uređaju izgleda nepravilnim. Možete ispraviti ako odete na Postavke > Opće > Datum i vrijeme, a zatim pokušajte poslije ponovno.",
           @"Izrada valjanog SSO tokena nije uspjela",
           @"Uneseni kod za provjeru valjanosti je nevažeći.",
           @"Nastavi",
           @"Provjeri valjanost identiteta",
           @"Sustav je prekinuo provjeru autentičnosti",
           @"Generiraj novi kôd s %@",
           @"Lista uređaja je prazna.",
           @"Nevažeća sesija.",
