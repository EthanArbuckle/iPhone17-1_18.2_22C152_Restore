...
- (ACMLocale_ar)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"حقل كلمة السر فارغ", @"إلغاء", @"تسجيل الدخول", @"إرسال", @"موافق", @"عملية الإتصال بالوسيلة غير مناسبة. لا يمكن إخفاء مربع حوار تسجيل الدخول إلى AppleConnect.", @"معلمات غير صالحة. تم تعيين بعض معلمات الإدخال بشكل غير صحيح.", @"كلمة سر Apple ID", @"يبدو أنك غير متصل. يُرجى الاتصال بالإنترنت والمحاولة مرة أخرى.", @"تم إدخال Apple ID أو كلمة السر بشكل غير صحيح.", @"إن عملية التحقق المكونة من خطوتين مطلوبة، ولكن تفاعل المستخدم غير مسموح به.", @"أجهزة موثوق بها", @"لإدارة أجهزتك الموثوق بها يرجى زيارة %@ من جهاز Mac أو كمبيوتر شخصي.", @"فشل إنشاء تذكرة خدمة صالحة", @"استجابة عملية التحقق المكونة من خطوتين فارغة.", @"رسالة SMS إلى رقم الهاتف", @"سيتم إرسال رمز مؤقت إلى الجهاز الذي قمت بتحديده أدناه حتى يمكنك استخدامه لتأكيد هويتك.",
           @"نفدت الذاكرة",
           @"سالم.سليم",
           @"إرسال رمز إلى %@",
           @"استدعاء أسلوب غير متوقع",
           @"فشلت في التحقق من الرمز لعدد كبير جدًا من المرات. يرجى إرسال رمزًا جديدًا إلى جهاز مختلف أو إعادة المحاولة في وقت لاحق.",
           @"رمز بيانات غير صالح. رمز البيانات للتحقق غير صالح.",
           @"تم إلغاء المصادقة بواسطة التطبيق",
           @"طول رمز الدخول غير صالح",
           @"رمز التحقق",
           @"تم تعطيل اسم الحساب هذا لأسباب أمنية. يُمكنك إعادة تعيين كلمة السر الخاصة بك على %@.",
           @"هل تعذر عليك استلام رسائل على أي من أجهزتك؟",
           @"أرسل رمزًا جديدًا",
           @"عذرًا، حدث خطأ. شُكرًا لصبرك. يرجى المحاولة مرة أخرى لاحقًا.",
           @"مطلوب",
           @"تعذر العثور على هذا الشخص.",
           @"إدخال رمز التحقق",
           @"لم يتم العثور على الجهاز.",
           @"Apple ID",
           @"تم تمكين عملية التحقق المكونة من خطوتين للـ Apple ID هذا.",
           @"تعذر التحقق من الرمز.",
           @"كلمة السر",
           @"لحماية أمانك، فقد حان الوقت لإعادة تعيين كلمة السر الخاصة بك. الأمر سهل، فقط انتقل إلى %@.",
           @"يبدو أن الوقت الحالي على هذا الجهاز غير صحيح. يمكنك إصلاح الأمر عن طريق الإعدادات > عام > التاريخ والوقت، ثم حاول مرة أخرى.",
           @"فشل إنشاء رمز SSO صالح",
           @"رمز التحقق الذي أدخلته غير صالح.",
           @"متابعة",
           @"التحقق من الهوية",
           @"تم إلغاء المصادقة بواسطة النظام",
           @"إنشاء رمز بواسطة %@",
           @"قائمة الأجهزة فارغة.",
           @"جلسة غير صالحة.",
