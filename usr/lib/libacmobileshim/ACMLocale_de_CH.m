...
{
  v6.receiver = self;
  v6.super_class = (Class)ACMLocale_de_CH;
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Passwortfeld ist leer", @"Abbrechen", @"Anmelden", @"Senden", @"OK", @"Methode wurde unsachgemäss aufgerufen. AppleConnect-Anmeldedialog kann nicht ausgeblendet werden.", @"Ungültige Parameter. Einige der Eingabeparameter sind falsch eingestellt.", @"Passwort für die Apple-ID", @"Sie scheinen offline zu sein. Verbinden Sie sich mit dem Internet und versuchen Sie es erneut.", @"Ihre Apple-ID oder Ihr Passwort wurde falsch eingegeben.", @"Zweistufige Bestätigung erforderlich. Es ist jedoch keine Benutzerinteraktion zulässig.", @"VERTRAUENSWÜRDIGE GERÄTE", @"Gehen Sie von einem Mac oder PC aus zu %@, um Ihre vertrauenswürdigen Geräte zu verwalten.", @"Erstellen eines gültigen Service-Tickets ist fehlgeschlagen", @"Antwort auf zweistufige Bestätigung ist leer.", @"SMS an Telefonnummer", @"An das von Ihnen unten ausgewählte Gerät wird ein temporärer Code gesendet, den Sie verwenden können, um Ihre Identität zu bestätigen.",
           @"Nicht genügend Arbeitsspeicher",
           @"max.mustermann",
           @"Code an %@ senden",
           @"Unerwarteter Methodenaufruf",
           @"Die Bestätigung des Codes ist zu oft fehlgeschlagen. Senden Sie einen neuen Code an ein anderes Gerät oder versuchen Sie es später erneut.",
           @"Ungültiger Daten-Token. Der Daten-Token zum Bestätigen ist ungültig.",
           @"Authentifizierung wurde vom Programm abgebrochen",
           @"Ungültige Codelänge",
           @"Bestätigungscode",
           @"Dieses Konto wurde aus Sicherheitsgründen deaktiviert. Sie können Ihr Passwort unter %@ zurücksetzen.",
           @"Sie können auf keinem Ihrer Geräte Nachrichten empfangen?",
           @"Einen neuen Code senden",
           @"Es ist ein Fehler aufgetreten, versuchen Sie es später erneut.",
           @"Erforderlich",
           @"Diese Person konnte nicht gefunden werden.",
           @"Bestätigungscode eingeben",
           @"Das Gerät wurde nicht gefunden.",
           @"Apple-ID",
           @"Für diese Apple-ID ist die zweistufige Bestätigung aktiviert.",
           @"Token kann nicht bestätigt werden.",
           @"Passwort",
           @"Sie sollten Ihr Passwort zurücksetzen, um Ihre Sicherheit zu schützen. Gehen Sie dazu einfach zu %@.",
           @"Die aktuelle Zeit scheint auf diesem Gerät falsch zu sein. Gehen Sie „Einstellungen“ > „Allgemein“ > „Datum & Uhrzeit“, um dies zu korrigieren, und versuchen Sie es erneut.",
           @"Erstellen eines gültigen SSO-Token ist fehlgeschlagen",
           @"Der eingegebene Bestätigungscode ist ungültig.",
           @"Identität bestätigen",
           @"Authentifizierung wurde vom System abgebrochen",
           @"Code mit %@ erstellen",
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)ACMLocale_de_CH;
