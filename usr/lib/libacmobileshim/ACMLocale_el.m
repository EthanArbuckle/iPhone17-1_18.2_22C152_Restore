...
- (ACMLocale_el)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Το πεδίο συνθηματικού είναι κενό", @"Ακύρωση", @"Σύνδεση", @"Αποστολή", @"ΟΚ", @"Λανθασμένη κλήση της μεθόδου. Δεν είναι δυνατή η απόκρυψη του παραθύρου διαλόγου σύνδεσης AppleConnect.", @"Μη έγκυρες παράμετροι. Μερικές παράμετροι εισαγωγής έχουν ρυθμιστεί λανθασμένα.", @"Συνθηματικό Apple ID", @"Φαίνεται ότι είστε εκτός σύνδεσης. Συνδεθείτε στο Internet και δοκιμάστε ξανά.", @"Εσφαλμένη εισαγωγή Apple ID ή συνθηματικού.", @"Απαιτείται επαλήθευση δύο βημάτων, αλλά η αλληλεπίδραση χρήστη δεν επιτρέπεται.", @"ΑΞΙΟΠΙΣΤΕΣ ΣΥΣΚΕΥΕΣ", @"Για διαχείριση των αξιόπιστων συσκευών σας, επισκεφτείτε τη διεύθυνση %@ από Mac ή PC.", @"Απέτυχε η δημιουργία έγκυρου εισιτηρίου υπηρεσίας", @"Η απόκριση της επαλήθευσης δύο βημάτων είναι κενή.", @"SMS σε τηλεφωνικό αριθμό", @"Στη συσκευή που θα επιλέξετε παρακάτω θα αποσταλεί ένας προσωρινός κωδικός, τον οποίον μπορείτε να χρησιμοποιήσετε για να επαληθεύσετε την ταυτότητά σας.",
           @"Εξαντλήθηκε η μνήμη",
           @"maria.milosporou",
           @"Αποστολή κωδικού σε %@",
           @"Απρόσμενη επίκληση μεθόδου",
           @"Δεν καταφέρατε να επαληθεύσετε τον κωδικό πάρα πολλές φορές. Αποστείλτε ένα νέο κωδικό σε διαφορετική συσκευή ή δοκιμάστε ξανά αργότερα.",
           @"Μη έγκυρο διαπιστευτήριο δεδομένων. Το διαπιστευτήριο δεδομένων για επαλήθευση δεν είναι έγκυρο.",
           @"Ο έλεγχος ταυτότητας ακυρώθηκε από την εφαρμογή",
           @"Μη έγκυρο μήκος συνθηματικού",
           @"Κωδικός επαλήθευσης",
           @"Αυτό το Apple ID έχει απενεργοποιηθεί για λόγους ασφαλείας. Μπορείτε να επαναφέρετε το συνθηματικό σας στο %@.",
           @"Είναι αδύνατη η λήψη μηνυμάτων σε οποιαδήποτε από τις συσκευές σας;",
