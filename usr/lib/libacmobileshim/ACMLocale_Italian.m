...
- (ACMLocale_Italian)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Il campo della password è vuoto", @"Annulla", @"Accedi", @"Invia", @"OK", @"Richiamo del metodo non corretto. Impossibile nascondere la finestra di dialogo AppleConnect SignIn.", @"Parametri non validi. Alcuni dei parametri di input non sono impostati correttamente.", @"Password dell'ID Apple", @"Il tuo stato è offline. Connettiti a internet e riprova.", @"ID Apple o password non inseriti correttamente.", @"È richiesta la verifica in due passaggi, ma l'interazione dell'utente non è consentita.", @"DISPOSITIVI REGISTRATI", @"Per gestire i tuoi dispositivi registrati visita %@ da un Mac o da un PC.", @"Impossibile creare un ticket di assistenza valido", @"La risposta della verifica in due passaggi è vuota.", @"SMS al numero di telefono", @"Sul dispositivo che hai scelto ti verrà inviato un codice temporaneo per la verifica dell'identità.",
           @"Memoria esaurita",
           @"mario.rossi",
           @"Invia codice a %@",
           @"Chiamata metodo non attesa",
           @"Hai eseguito troppi tentativi falliti di verificare il codice. Invia un nuovo codice a un dispositivo diverso o riprova più tardi.",
           @"Token dati non valido. Il token dati per la verifica non è valido.",
           @"L'autenticazione è stata annullata dall'applicazione",
           @"Lunghezza codice non valida",
           @"Codice di verifica",
           @"Questo nome account è stato disattivato per motivi di sicurezza. Puoi reimpostare la password su %@.",
           @"Non riesci a ricevere messaggi su nessuno dei tuoi dispositivi?",
           @"Invia un nuovo codice",
           @"Spiacenti, si è verificato un errore. Grazie per la pazienza, riprova più tardi.",
           @"Obbligatorio",
           @"Impossibile trovare questa persona.",
           @"Inserisci codice di verifica",
           @"Il dispositivo non è stato trovato.",
           @"ID Apple",
           @"La verifica in due passaggi è attiva per questo ID Apple. ",
           @"Impossibile verificare il token.",
           @"Password",
           @"Per proteggere la tua sicurezza, ti consigliamo di reimpostare la tua password. È semplice, basta accedere a %@.",
           @"L'orario attualmente visualizzato sul dispositivo non sembra essere corretto. Puoi correggerlo accedendo a Impostazioni > Generale > Data e ora e quindi riprovare.",
           @"Impossibile creare un token SSO valido",
           @"Il codice di verifica inserito non è valido.",
           @"Continua",
           @"Verifica identità",
           @"L'autenticazione è stata annullata dal sistema",
           @"Genera codice con %@",
           @"L'elenco dispositivi è vuoto.",
           @"Sessione non valida.",
