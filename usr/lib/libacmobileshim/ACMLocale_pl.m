...
- (ACMLocale_pl)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Pole hasła jest puste.", @"Anuluj", @"Zaloguj się", @"Wyślij", @"OK", @"Nieprawidłowe wywołanie metody. Nie można ukryć okna dialogowego logowania AppleConnect.", @"Błędne parametry. Niektóre parametry wejściowe ustawiono nieprawidłowo.", @"Hasło Apple ID", @"Prawdopodobnie jesteś w trybie offline. Połącz się z Internetem i spróbuj ponownie.", @"Wprowadzono nieprawidłowy Apple ID lub błędne hasło.", @"Wymagana jest dwustopniowa weryfikacja, ale interakcje z użytkownikiem nie są dozwolone.", @"ZAUFANE URZĄDZENIA", @"Aby zarządzać zaufanymi urządzeniami, odwiedź stronę %@ na komputerze Mac lub PC.", @"Nie udało się utworzyć prawidłowego biletu na usługę.", @"Pole odpowiedzi dotyczącej dwustopniowej weryfikacji jest puste.", @"Wyślij wiadomość SMS na numer telefonu", @"Na wybrane przez Ciebie urządzenie zostanie wysłany tymczasowy kod, którego możesz użyć, aby potwierdzić swoją tożsamość.",
           @"Brak pamięci",
           @"jan.kowalski",
           @"Wyślij kod na %@",
           @"Nieoczekiwane wywołanie metody",
           @"Podjęto zbyt wiele nieudanych prób weryfikacji kodu. Wyślij nowy kod na inne urządzenie lub spróbuj ponownie później.",
           @"Błędny token danych. Token danych do weryfikacji jest nieprawidłowy.",
           @"Uwierzytelnienie zostało anulowane przez aplikację.",
           @"Nieprawidłowa długość kodu",
           @"Kod weryfikacyjny",
           @"To konto zostało wyłączone ze względów bezpieczeństwa. Możesz wyzerować hasło na stronie %@.",
           @"Nie otrzymujesz wiadomości na żadne ze swoich urządzeń?",
           @"Wyślij nowy kod",
           @"A survenit o eroare. Vă mulțumim pentru răbdare și vă rugăm să încercați mai târziu.",
           @"Wymagane",
           @"Nie można znaleźć tej osoby.",
           @"Wprowadź kod weryfikacyjny",
           @"Nie znaleziono urządzenia.",
           @"Apple ID",
           @"Dla tego Apple ID włączono dwustopniową weryfikację.",
           @"Nie można zweryfikować tokenu.",
           @"Hasło",
           @"Aby chronić bezpieczeństwo, pora wyzerować hasło. To proste,  wystarczy odwiedzić stronę %@.",
           @"Aktualna godzina na tym urządzeniu prawdopodobnie jest nieprawidłowa. Możesz ją poprawić, przechodząc do Ustawienia > Ogólne > Data i czas, a następnie spróbować ponownie.",
           @"Nie udało się utworzyć prawidłowego tokenu SSO.",
           @"Podany kod weryfikacyjny jest nieprawidłowy.",
           @"Kontynuuj",
           @"Potwierdź tożsamość",
           @"Uwierzytelnienie zostało anulowane przez system.",
           @"Wygeneruj kod przy użyciu %@",
