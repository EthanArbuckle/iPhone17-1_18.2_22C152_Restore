...
- (ACMLocale_sv)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Lösenordsfältet är tomt", @"Avbryt", @"Logga in", @"Skicka", @"OK", @"Ogiltig användning av metoden. AppleConnect SignIn-dialogen kan inte döljas.", @"Ogiltiga parametrar. Vissa indataparametrar har ställts in felaktigt.", @"Lösenord för Apple-ID", @"Du verkar vara offline. Anslut till Internet och försök igen.", @"Du har skrivit in fel Apple-ID eller lösenord.", @"Tvåstegsverifiering krävs, men användaråtgärder är inte tillåtna.", @"TILLFÖRLITLIGA ENHETER", @"Om du vill hantera dina tillförlitliga enheter kan du besöka %@ från en Mac eller PC.", @"Kunde inte skapa en giltig serviceanmälan", @"Svaret för tvåstegsverifiering är tomt.", @"Skicka sms till telefonnummer", @"En tillfällig kod kommer att skickas till enheten som du väljer nedan. Du kan använda koden till att verifiera din identitet.",
           @"Minnet räcker inte till",
           @"lars.svensson",
           @"Skicka kod till %@",
           @"Oväntat metodanrop",
           @"Du har misslyckats med att verifiera koden för många gånger. Skicka en ny kod till en annan enhet eller försök igen senare.",
           @"Ogiltigt datatoken. Detta datatoken för verifiering är inte giltigt.",
           @"Programmet avbröt autentiseringen",
           @"Ogiltig längd på lösenkod",
           @"Verifieringskod",
           @"Detta konto har avaktiverats av säkerhetsskäl. Du kan nollställa ditt lösenord på %@.",
           @"Går det inte att ta emot meddelanden på någon av dina enheter?",
           @"Skicka en ny kod",
           @"Ett fel har uppstått. Försök igen senare. Tack för ditt tålamod.",
           @"Krävs",
           @"Kunde inte hitta personen.",
           @"Ange verifieringskod",
           @"Enheten hittades inte.",
           @"Apple-ID",
           @"Tvåstegsverifiering är aktiverat för detta Apple-ID.",
           @"Kunde inte verifiera token.",
           @"Lösenord",
           @"Av säkerhetsskäl bör du nollställa ditt lösenord. Det är enkelt, gå bara till %@.",
           @"Tiden verkar vara fel inställd på den här enheten. Du kan fixa det genom att gå till Inställningar > Allmänt > Datum och tid, och sedan försöka igen.",
           @"Kunde inte skapa ett giltigt SSO-token",
           @"Verifieringskoden som du har angett är ogiltig.",
           @"Fortsätt",
           @"Verifiera identitet",
           @"Systemet avbröt autentiseringen",
           @"Generera kod med %@",
           @"Enhetslistan är tom.",
           @"Ogiltig session.",
