...
- (ACMLocale_th)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"ช่องรหัสผ่านว่างอยู่", @"ยกเลิก", @"เข้าสู่ระบบ", @"ส่ง", @"ตกลง", @"มีการเรียกใช้วิธีดำเนินการอย่างไม่ถูกต้อง ไม่สามารถซ่อนกล่องโต้ตอบการลงชื่อเข้าใช้ AppleConnect ได้", @"พารามิเตอร์ไม่ถูกต้อง มีการตั้งค่าพารามิเตอร์อินพุทบางรายการไม่ถูกต้อง", @"รหัสผ่าน Apple ID", @"คุณมีสถานะออฟไลน์อยู่ โปรดเชื่อมต่อเข้าอินเทอร์เน็ต และลองอีกครั้ง", @"Apple ID หรือรหัสผ่านของคุณที่คุณป้อนไม่ถูกต้อง", @"ต้องใช้การตรวจสอบยืนยันสองขั้นตอน แต่ไม่อนุญาตให้ผู้ใช้มีการโต้ตอบ", @"อุปกรณ์ที่เชื่อถือได้", @"ในการจัดการอุปกรณ์ที่เชื่อถือได้ โปรดไปที่ %@ จากเครื่อง Mac หรือ PC", @"ล้มเหลวในการสร้างบัตรผ่านของการบริการที่ถูกต้อง", @"ผลการตอบสนองต่อการตรวจสอบยืนยันสองขั้นตอนว่างเปล่า", @"ส่ง SMS ถึงหมายเลขโทรศัพท์", @"จะมีการส่งรหัสชั่วคราวไปยังอุปกรณ์ที่คุณเลือกด้านล่าง ซึ่งคุณสามารถใช้ยืนยันตัวตนของคุณ",
           @"หน่วยความจำไม่เพียงพอ",
           @"john.appleseed",
           @"ส่งรหัสไปยัง \"%@\"",
           @"การเรียกวิธีการ (Method Invocation) ที่ไม่คาดคิดเกิดขึ้น",
           @"คุณยืนยันรหัสไม่สำเร็จหลายครั้ง โปรดส่งรหัสใหม่ไปยังอุปกรณ์อื่นหรือลองอีกครั้งในภายหลัง",
           @"โทเค็นข้อมูลไม่ถูกต้อง โทเค็นข้อมูลสำหรับตรวจสอบยืนยันไม่ถูกต้อง",
           @"การรับรองความถูกต้องถูกยกเลิกโดยแอปพลิเคชัน",
           @"ความยาวของรหัสผ่านไม่ถูกต้อง",
           @"รหัสการตรวจสอบยืนยัน",
           @"บัญชีนี้ถูกปิดใช้งานด้วยเหตุผลด้านความปลอดภัย คุณสามารถรีเซ็ตรหัสผ่านของคุณได้ที่ %@",
           @"ไม่สามารถรับข้อความบนอุปกรณ์ใดๆ ของคุณเลยใช่หรือไม่?",
           @"ส่งรหัสใหม่",
           @"ขออภัยสำหรับข้อผิดพลาดที่เกิดขึ้น ขอบคุณสำหรับความอดทนของคุณ โปรดลองอีกครั้งในภายหลัง",
           @"ต้องระบุ",
           @"ค้นหาไม่พบบุคคลนี้",
           @"ป้อนรหัสการตรวจสอบยืนยัน",
           @"ไม่พบอุปกรณ์",
           @"Apple ID",
           @"การตรวจสอบยืนยันสองขั้นตอนได้ถูกเปิดใช้งานแล้วสำหรับ Apple ID นี้",
           @"ไม่สามารถตรวจสอบยืนยันโทเค็น",
           @"รหัสผ่าน",
           @"เพื่อรักษาความปลอดภัยของคุณ ถึงเวลาแล้วสำหรับการรีเซ็ตรหัสผ่านของคุณ ซึ่งทำได้ง่ายมาก เพียงไปที่ %@",
           @"เวลาปัจจุบันบนอุปกรณ์นี้ไม่ถูกต้อง คุณสามารถแก้ไขได้โดยไปที่ การตั้งค่า > ทั่วไป > วันที่และเวลา จากนั้นลองอีกครั้ง",
           @"ล้มเหลวในการสร้างโทเค็น SSO ที่ถูกต้อง",
           @"รหัสการตรวจสอบยืนยันที่คุณป้อนไม่ถูกต้อง",
           @"ดำเนินการต่อ",
           @"ยืนยันตัวตนของคุณ",
           @"การรับรองความถูกต้องถูกยกเลิกโดยระบบ",
           @"สร้างรหัสด้วย \"%@\"",
           @"รายการอุปกรณ์ว่างเปล่า",
           @"เซสชันไม่ถูกต้อง",
