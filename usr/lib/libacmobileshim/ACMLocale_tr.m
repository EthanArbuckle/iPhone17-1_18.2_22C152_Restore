...
- (ACMLocale_tr)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Parola alanı boş", @"İptal", @"Giriş yap", @"Gönder", @"Tamam", @"Yanlış yöntem talebi. AppleConnect SignIn iletişim kutusu gizlenemiyor.", @"Geçersiz Parametreler. Bazı giriş parametreleri yanlış ayarlanmış.", @"Apple Kimliği parolası", @"Çevrimdışı görünüyorsunuz. Lütfen internete bağlanın ve tekrar deneyin.", @"Apple Kimliğiniz veya parolanız doğru girilmedi.", @"İki aşamalı doğrulama gerekiyor, ancak kullanıcı etkileşimine izin verilmiyor.", @"GÜVENİLİR AYGITLAR", @"Güvenilir aygıtlarınızı yönetmek için Mac veya bilgisayardan %@ sayfasını ziyaret edin.", @"Geçerli hizmet talep formu oluşturulamadı", @"İki aşamalı doğrulama yanıt alanı boş.", @"Telefon Numarasına SMS Gönder", @"Aşağıda seçtiğiniz aygıta kimliğinizi doğrulamak için kullanabileceğiniz geçici bir kod gönderilecek.",
           @"Yetersiz Hafıza",
           @"ad.soyad",
           @"Şuraya kod gönder: %@",
           @"Beklenmedik yöntem çağırma",
           @"Kodu doğrulamada birçok kez başarısız oldunuz. Lütfen başka bir aygıta yeni bir kod gönderin veya daha sonra tekrar deneyin.",
           @"Geçersiz Veri Belirteci. Doğrulanacak Veri Belirteci geçerli değil.",
           @"Kimlik doğrulama uygulama tarafından iptal edildi",
           @"Geçersiz parola uzunluğu",
           @"Doğrulama Kodu",
           @"Bu hesap adı güvenlik nedenlerinden dolayı devre dışı bırakıldı. Parolanızı %@ adresinde sıfırlayabilirsiniz.",
           @"Aygıtlarınızda mesaj alamıyor musunuz?",
           @"Yeni bir kod gönder",
           ...
           @"Aygıt bulunamadı.",
           @"Apple Kimliği",
           @"Bu Apple Kimliği için iki aşamalı doğrulama etkin.",
           @"Belirteç doğrulanamıyor.",
           @"Parola",
           @"Güvenliğinizi korumak için parolanızı sıfırlamanın zamanı geldi. Tek yapmanız gereken %@ adresini ziyaret etmek.",
           @"Bu aygıttaki geçerli saat yanlış görünüyor. Ayarlar > Genel > Tarih ve Saat'e giderek düzeltebilir ve tekrar deneyebilirsiniz.",
           @"Geçerli SSO belirteci oluşturulamadı",
           @"Girdiğiniz doğrulama kodu geçerli değil.",
           @"Devam",
           @"Kimliğinizi Doğrulayın",
           @"Kimlik doğrulama sistem tarafından iptal edildi",
           @"%@ ile kod oluştur",
           @"Aygıt listesi boş.",
           @"Geçersiz Oturum",
