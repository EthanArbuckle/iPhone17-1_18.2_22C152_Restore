...
- (ACMLocale_ro)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Câmpul Parolă este necompletat", @"Anulați", @"Autentificaţi-vă", @"Trimiteți", @"OK", @"Utilizare incorectă a metodei. Caseta de dialog pentru autentificare AppleConnect nu poate fi ascunsă.", @"Parametri nevalizi. Unii dintre parametrii de intrare sunt configurați incorect.", @"Parolă ID Apple", @"Se pare că sunteți offline. Conectați-vă la Internet și încercați din nou.", @"ID-ul Apple sau parola a fost introdusă incorect.", @"Este necesară confirmarea în doi pași, dar nu este permisă interacțiunea cu utilizatorul.", @"DISPOZITIVE AUTORIZATE", @"Pentru a vă gestiona dispozitivele autorizate, vizitați %@ pe un Mac sau PC.", @"Crearea unei cereri de asistență a eșuat", @"Niciun răspuns pentru confirmarea în doi pași.", @"SMS la un număr de telefon", @"Dispozitivul pe care îl selectați mai jos va primi un cod temporar pe care îl veți putea utiliza la confirmarea identității.",
           @"Memorie insuficientă",
           @"ion.merisor",
           @"Trimiteți codul la %@",
           @"Metodă invocată neașteptată",
           @"Nu ați reușit să confirmați codul de prea multe ori. Trimiteți un cod nou pe un alt dispozitiv sau încercați mai târziu.",
           @"Token de date nevalid. Tokenul de date pentru verificare nu este valid.",
           @"Autentificarea a fost anulată de aplicație",
           @"Lungimea codului de acces este nevalidă.",
           @"Cod de confirmare",
           @"Acest cont a fost dezactivat din motive de securitate. Vă puteți reseta parola la %@.",
           @"Nu puteți primi mesaje pe niciunul dintre dispozitivele dvs.?",
           @"Trimiteți un nou cod",
           @"Vyskytla sa chyba. Ďakujeme za vašu trpezlivosť, skúste to znova neskôr.",
           @"Obligatoriu",
           @"Această persoană nu poate fi găsită.",
           @"Introduceți codul de verificare",
           @"Dispozitivul nu poate fi găsit.",
           @"ID Apple",
           @"Confirmarea în doi pași este activată pentru acest ID Apple.",
           @"Tokenul nu poate fi verificat.",
           @"Parolă",
           @"Pentru a vă proteja securitatea, resetați-vă parola accesând %@.",
           @"Ora actuală de pe acest dispozitiv pare a fi incorectă. O puteți corecta, accesând Configurări > General > Data și ora, apoi încercați din nou.",
           @"Crearea unui token SSO valid a eșuat",
           @"Codul de confirmare pe care l-ați introdus nu este valid.",
           @"Continuați",
           @"Confirmați identitatea",
           @"Autentificarea a fost anulată de sistem",
           @"Generați codul cu %@",
           @"Nu aveți nimic în lista de dispozitive.",
           @"Sesiune nevalidă.",
