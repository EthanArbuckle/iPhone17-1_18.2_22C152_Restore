...
- (ACMLocale_fi)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Salasanakenttä on tyhjä", @"Kumoa", @"Kirjaudu sisään", @"Lähetä", @"OK", @"Virheellinen metodikutsu. AppleConnect-kirjautumisvalintaikkunan kätkeminen ei onnistu.", @"Epäkelpoja parametreja. Jotkut syöttöparametrit on asetettu väärin.", @"Apple ID -salasana", @"Et näytä olevan verkkoyhteydessä. Yhdistä Internetiin ja yritä uudelleen.", @"Apple ID:si tai salasanasi syötettiin väärin.", @"Kaksivaiheinen vahvistus vaaditaan, mutta käyttäjän vuorovaikutusta ei sallita.", @"LUOTETUT LAITTEET", @"Voit hallita luotettuja laitteitasi käymällä osoitteessa %@ Mac- tai Windows-tietokoneella.", @"Kelvollisen palvelulipun luominen ei onnistunut", @"Kaksivaiheisen vahvistuksen vaste on tyhjä.", @"Tekstiviesti puhelinnumeroon", @"Alla luetelluista laitteista valitsemaasi lähetetään tilapäinen koodi, jota voit käyttää henkilöllisyytesi vahvistamiseen.",
           @"Muisti ei riitä",
           @"jussi.kuokka",
           @"Lähetä koodi tähän kohteeseen: %@",
           @"Odottamaton metodikutsu",
           @"Koodin vahvistaminen epäonnistui liian monta kertaa. Lähetä uusi koodi eri laitteeseen tai yritä myöhemmin uudelleen.",
           @"Epäkelpo datatunnus. Vahvistuksen datatunnus ei kelpaa.",
           @"Ohjelma peruutti todennuksen",
           @"Virheellinen pääsykoodin pituus",
           @"Vahvistuskoodi",
           @"Tämä tili on turvallisuussyistä poistettu käytöstä. Voit nollata salasanasi osoitteessa %@.",
           @"Etkö pysty vastaanottamaan viestejä mihinkään laitteeseesi?",
           @"Lähetä uusi koodi",
           @"Tapahtui virhe. Kiitos kärsivällisyydestäsi, yritä myöhemmin uudelleen.",
           @"Vaaditaan",
           @"Tätä henkilöä ei löydetä.",
           @"Syötä vahvistuskoodi",
           @"Laitetta ei löydy.",
           @"Apple ID",
           @"Kaksivaiheinen vahvistus on otettu käyttöön tälle Apple ID:lle.",
           @"Tunnuksen vahvistaminen ei onnistu.",
           @"Salasana",
           @"Tietoturvasi takaamiseksi on aika nollata salasanasi. Se käy helposti osoitteessa %@.",
           @"Tämän laitteen aika näyttää olevan virheellinen. Voit korjata sen avaamalla Asetukset > Yleiset > Päivä ja aika. Yritä sitten uudelleen.",
           @"Kelvollisen SSO-tunnuksen luominen ei onnistunut",
           @"Syöttämäsi vahvistuskoodi ei kelpaa.",
           @"Jatka",
           @"Vahvista henkilöllisyys",
           @"Järjestelmä peruutti todennuksen",
           @"Luo koodi laitteella %@",
           @"Laiteluettelo on tyhjä.",
           @"Epäkelpo istunto.",
