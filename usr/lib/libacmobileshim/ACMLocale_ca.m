...
- (ACMLocale_ca)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"El camp de la contrasenya està buit", @"Cancel·lar", @"Iniciar sessió", @"Enviar", @"Acceptar", @"Error de trucada al mètode. El diàleg d’inici de sessió de l’AppleConnect no es pot ocultar.", @"Paràmetres no vàlids. Alguns paràmetres d’entrada no s’han establert correctament.", @"Contrasenya de l’ID d’Apple", @"Sembla que no tens connexió. Connecta’t a Internet i torna-ho a provar.", @"L’ID d’Apple o la contrasenya que has escrit són incorrectes.", @"La verificació en dos passos és obligatòria, però no es permet la interacció de l’usuari.", @"DISPOSITIUS DE CONFIANÇA", @"Per a gestionar els dispositius de confiança, vés a %@ des d’un Mac o un PC.", @"No s’ha pogut crear un tiquet de servei vàlid", @"La resposta de la verificació en dos passos està en blanc.", @"Enviar un SMS al número de telèfon", @"Rebràs un codi temporal al dispositiu que seleccionis a continuació que podràs fer servir per a verificar la teva identitat.",
           @"Sense memòria",
           @"joan.pomes",
           @"Enviar codi a %@",
           @"Invocació de mètode inesperada",
           @"Has superat el límit d’intents de verificació del codi. Envia un codi nou a un dispositiu diferent o torna-ho a provar més tard.",
           @"L’identificador de les dades no és vàlid. L’identificador de les dades per verificar no és vàlid.",
           @"L’aplicació ha cancel·lat l’autenticació",
           @"Longitud del codi no vàlida",
           @"Codi de verificació",
           @"Aquest compte s’ha desactivat per motius de seguretat. Pots restablir la contrasenya a %@.",
           @"No pots rebre missatges en cap dels teus dispositius?",
           @"Enviar un codi nou",
           @"S’ha produït un error. Torna-ho a provar més tard.",
           @"Obligatori",
           @"No es troba aquesta persona.",
           @"Escriu el codi de verificació",
           @"No es troba el dispositiu.",
           @"ID d’Apple",
           @"Aquest ID d’Apple té activada la verificació en dos passos.",
           @"No es pot verificar l’identificador.",
           @"Contrasenya",
           @"Restableix la contrasenya per protegir la teva seguretat. És senzill: només cal que vagis a %@.",
           @"Sembla que l’hora actual del dispositiu és incorrecta. Pots modificar-la a Configuració > General > Data i hora, i tornar-ho a provar.",
           @"No s’ha pogut crear un identificador d’SSO vàlid",
           @"El codi de verificació que has escrit no és vàlid.",
           @"Continuar",
           @"Verificar la identitat",
           @"El sistema ha cancel·lat l’autenticació",
           @"Generar el codi amb %@",
           @"La llista de dispositius és buida.",
           @"Sessió no vàlida.",
