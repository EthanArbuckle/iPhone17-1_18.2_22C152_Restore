...
- (ACMLocale_sk)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Pole Heslo je prázdne", @"Zrušiť", @"Prihláste sa", @"Odoslať", @"OK", @"Neplatné volanie metódy. Dialógové okno prihlásenia AppleConnect nie je možné skryť.", @"Neplatné parametre. Niektoré vstupné parametre sú nastavené nesprávne.", @"Heslo Apple ID", @"Vyzerá to, že ste offline. Pripojte sa k internetu a skúste to znova.", @"Vaše Apple ID alebo heslo bolo nesprávne zadané.", @"Vyžaduje sa dvojfázové overenie, ale nie je povolená interakcia používateľa.", @"DÔVERYHODNÉ ZARIADENIA", @"Dôveryhodné zariadenia môžete spravovať na stránke %@ z počítača Mac alebo PC.", @"Vytvorenie platného lístka služby zlyhalo", @"Odpoveď na dvojfázové overenie je prázdna.", @"Odoslať SMS na telefónne číslo", @"Do nižšie vybraného zariadenia bude odoslaný dočasný kód, ktorý môžete použiť na overenie svojej identity.",
           @"Nedostatok pamäte",
           @"janko.hrasko",
           @"Odoslať kód na %@",
           @"Neočakávané volanie metódy",
           @"Príliš veľa neúspešných pokusov o overenie kódu. Pošlite nový kód na iné zariadenie alebo to skúste znovu neskôr.",
           @"Neplatný token údajov. Token údajov na overenie je neplatný.",
           @"Overenie bolo zrušené aplikáciou.",
           @"Nesprávna dĺžka hesla",
           @"Overovací kód",
           @"Toto Apple ID bolo z bezpečnostných dôvodov deaktivované. Svoje heslo môžete obnoviť na adrese %@.",
           @"Nemôžete prijímať správy na žiadne svoje zariadenia?",
           @"Odoslať nový kód",
           @"Vyskytla sa chyba. Ďakujeme za vašu trpezlivosť, skúste to znova neskôr.",
           @"Povinné",
           @"Nie je možné nájsť túto osobu.",
           @"Zadajte overovací kód",
           @"Zariadenie sa nenašlo.",
           @"Apple ID",
           @"Pre tento účet Apple ID je aktivované dvojfázové overenie.",
           @"Nie je možné overiť token.",
           @"Heslo",
           @"Z dôvodu ochrany bezpečnosti je čas obnoviť vaše heslo. Je to jednoduché - stačí prejsť na adresu %@.",
           @"Aktuálny čas tohto zariadenia vyzerá byť nesprávny. Môžete to napraviť v ponuke Nastavenia > Všeobecné > Dátum a čas. Potom to skúste znova.",
           @"Vytvorenie platného SSO tokenu zlyhalo",
           @"Overovací kód, ktorý ste zadali, nie je platný.",
           @"Pokračovať",
           @"Overiť identitu",
           @"Overenie bolo zrušené systémom.",
           @"Kód vygenerujete pomocou %@",
           @"Zoznam zariadení je prázdny.",
           @"Neplatná relácia.",
