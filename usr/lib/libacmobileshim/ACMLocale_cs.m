...
- (ACMLocale_cs)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Pole Heslo je prázdné.", @"Zrušit", @"Přihlásit se", @"Odeslat", @"OK", @"Neplatné volání metody. Přihlašovací okno AppleConnect nelze skrýt.", @"Neplatné parametry. Některé vstupní parametry nejsou správně nastaveny.", @"Heslo k účtu Apple ID", @"Zdá se, že jste offline. Připojte se k internetu a zkuste to znovu.", @"Nezadali jste správně své Apple ID nebo heslo.", @"Je požadováno dvoufázové ověření, ale není povolena interakce uživatele.", @"DŮVĚRYHODNÁ ZAŘÍZENÍ", @"Důvěryhodná zařízení můžete spravovat na stránce %@ z počítače Mac nebo PC.", @"Nepodařilo se vytvořit platný lístek pro službu.", @"Nebyla zadána odpověď na dvoufázové ověření.", @"SMS na telefonní číslo", @"Do níže vybraného zařízení bude odeslán dočasný kód, který můžete použít k ověření své identity.",
           @"Nedostatek paměti",
           @"jan.novak",
           @"Odeslat kód do: %@",
           @"Neočekávané volání metody",
           @"Bylo provedeno příliš mnoho neúspěšných pokusů o ověření kódu. Odešlete prosím kód na jiné zařízení nebo to zkuste znovu později.",
           @"Neplatný datový token. Datový token k ověření není platný.",
           @"Ověření bylo zrušeno aplikací.",
           @"Neplatná délka přístupového kódu",
           @"Ověřovací kód",
           @"Toto Apple ID bylo z bezpečnostních důvodů deaktivováno. Heslo můžete obnovit na adrese %@.",
           @"Nemůžete přijímat zprávy na žádné z vašich zařízení?",
           @"Odeslat nový kód",
           @"Vyskytla se chyba. Děkujeme za vaši trpělivost. Zkuste to znovu později.",
           @"Povinné",
           @"Tuto osobu nelze nalézt.",
           @"Zadat ověřovací kód",
           @"Zařízení nebylo nalezeno.",
           @"Apple ID",
           @"Pro toto Apple ID je aktivováno dvoufázové ověření.",
           @"Nelze ověřit token.",
           @"Heslo",
           @"Z důvodu ochrany zabezpečení je nyní vhodné změnit heslo. Postup je snadný – stačí přejít na adresu %@.",
           @"Aktuální čas na tomto zařízení pravděpodobně není správný. Opravu můžete provést v nabídce Nastavení > Obecné > Datum a čas. Poté to zkuste znovu.",
           @"Nepodařilo se vytvořit platný SSO token.",
           @"Zadaný ověřovací kód není platný.",
           @"Pokračovat",
           @"Ověřit identitu",
           @"Ověření bylo zrušeno systémem.",
           @"Generovat kód s %@",
