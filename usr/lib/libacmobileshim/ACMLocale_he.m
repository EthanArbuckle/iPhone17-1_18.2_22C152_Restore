...
- (ACMLocale_he)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"שדה הסיסמה ריק", @"ביטול", @"התחבר", @"שליחה", @"אישור", @"קריאת שיטה שגויה. לא ניתן להסתיר את תיבת ההתחברות של AppleConnect.", @"פרמטרים לא חוקיים. כמה מפרמטרי הקלט הוגדרו בצורה שגויה.", @"סיסמת Apple ID", @"נראה כי את/ה לא מחובר/ת לאינטרנט. התחבר/י לאינטרנט ונסה/י שוב.", @"ה-Apple ID או הסיסמה שהזנת שגויים.", @"יש צורך באימות בשני צעדים, אך אינטאראקציית המשתמש אסורה.", @"מכשירים מהימנים", @"כדי לנהל את המכשירים המהימנים שלך, בקר/י ב-%@ מה-Mac או ה-PC.", @"יצירת כרטיס שירות תקף נכשלה", @"התגובה לאימות בשני צעדים ריקה.", @"SMS למספר טלפון", @"אל המכשיר שתבחר/י להלן יישלח קוד זמני, בו ניתן להשתמש על מנת לאמת את זהותך.",
           @"הזיכרון אזל",
           @"israel.israeli",
           @"שלח קוד אל %@",
           @"שיטת קריאה בלתי צפויה",
           @"לא הצלחת לאשר את הקוד יותר מדי פעמים. נא לשלוח קוד חדש למכשיר אחר או לנסות שוב מאוחר יותר.",
           @"אסימון נתונים לא תקף. אסימון הנתונים לאימות אינו תקף.",
           @"האימות בוטל על ידי יישום",
           @"אורך קוד גישה אינו תקף",
           @"קוד אימות",
           @"חשבון זה הושבת מטעמי אבטחה. באפשרותך לאפס את סיסמתך בכתובת %@.",
           @"אין באפשרותך לקבל הודעות באף אחד מהמכשירים שלך?",
           @"שליחת קוד חדש",
           @"מצטערים, אירעה שגיאה. נסה/י שוב מאוחר יותר. תודה על סבלנותך. ",
           @"חובה",
           @"לא ניתן למצוא אדם זה.",
           @"הזן/י קוד אימות",
           @"מכשיר לא נמצא.",
           @"Apple ID",
           @"אימות בשני צעדים הופעל עבור Apple ID זה.",
           @"לא ניתן לאמת את האסימון.",
           @"סיסמה",
           @"מטעמי אבטחה, הגיע הזמן לאפס את סיסמתך. פשוט בקר/י בכתובת %@.",
           @"נראה כי השעה הנוכחית במכשיר זה לא מדויקת. כדי לתקן זאת, עבור/י אל ״הגדרות״ > ״כללי״ > ״תאריך ושעה״ ולאחר מכן נסה/י שוב.",
           @"יצירת אסימון SSO תקף נכשלה",
           @"קוד האימות שהזנת אינו תקף.",
           @"המשך/י",
           @"אמת/י את זהותך",
           @"האימות בוטל על ידי מערכת",
           @"צור סיסמה באמצעות %@",
           @"רשימת המכשירים ריקה.",
           @"התקשרות לא תקפה.",
           @"תגובת השרת פגומה",
