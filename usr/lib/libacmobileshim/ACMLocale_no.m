...
- (ACMLocale_no)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Passordfeltet er tomt", @"Avbryt", @"Logg på", @"Send", @"OK", @"Ugyldig bruk av metoden. AppleConnect-påloggingsdialogen kan ikke skjules.", @"Ugyldige parametre. Enkelte av inndataparametrene er satt opp feil.", @"Passord til Apple-ID", @"Det ser ut til at du er offline. Koble til Internett og prøv på nytt.", @"Apple-ID-en eller passordet ble ikke skrevet riktig.", @"Totrinns-verifisering kreves, men brukerhandlinger er ikke tillatt.", @"PÅLITELIGE ENHETER", @"For å administrere de pålitelige enhetene går du til %@ på en Mac eller PC.", @"Kunne ikke opprette en gyldig serviceforespørsel", @"Svar på totrinns-verifisering mangler.", @"SMS til telefonnummer", @"Enheten du velger vil bli sendt en midlertidig kode du kan bruke til å verifisere identiteten din.",
           ...
           @"Send kode til %@",
           @"Uventet metodekall",
           @"Du mislyktes for mange ganger med å verifisere koden. Send en ny kode til en annen enhet eller prøv igjen senere.",
           @"Ugyldig datatoken. Datatokenet for verifiseringen er ugyldig.",
           @"Bekreftelsen ble avbrutt av appen",
           @"Ugyldig kodelengde",
           @"Verifiseringskode",
           @"Apple-ID-en er deaktivert av sikkerhetsgrunner. Du kan endre passordet ditt på %@.",
           @"Mottar du ikke meldinger på noen av enhetene dine?",
           @"Send en ny kode",
           @"En feil har oppstått. Takk for at du viser forståelse. Prøv igjen senere.",
           @"Påkrevd",
           @"Kan ikke finne personen.",
           @"Skriv inn verifiseringskode",
           @"Enheten ble ikke funnet.",
           @"Apple-ID",
           @"Totrinns-verifisering er aktivert for denne Apple-ID-en.",
           @"Kan ikke verifisere tokenet.",
           @"Passord",
           @"Av sikkerhetsgrunner er det på tide å endre passordet ditt. Dette kan du enkelt gjøre på %@.",
           @"Klokkeslettet på enheten ser ut til å være feil. Du kan fikse det ved å gå til Innstillinger > Generelt > Dato og tid. Prøv så på nytt.",
           @"Kunne ikke opprette et gyldig SSO-token",
           @"Verifiseringskoden du oppga er ikke gyldig.",
           @"Fortsett",
           @"Verifiser identitet",
           @"Bekreftelsen ble avbrutt av systemet",
           @"Generer kode med %@",
           @"Enhetslisten er tom.",
           @"Ugyldig økt.",
