...
- (ACMLocale_French)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Le champ du mot de passe est vide", @"Annuler", @"Connexion", @"Envoyer", @"OK", @"Appel incorrect de la méthode. Le dialogue de connexion AppleConnect ne peut pas être masqué.", @"Paramètres non valides. Certains paramètres de saisie sont incorrects.", @"mot de passe de l’identifiant Apple", @"Vous semblez être hors ligne. Veuillez vous connecter à Internet et réessayer.", @"Votre identifiant Apple ou votre mot de passe n’a pas été saisi correctement.", @"La validation en deux étapes est nécessaire, mais l’interaction des utilisateurs n’est pas autorisée.", @"APPAREILS DE CONFIANCE", @"Pour gérer vos appareils sécurisés, rendez-vous sur %@ à l’aide d’un Mac ou d’un PC.", @"Échec de la création d’un ticket de service valide", @"La réponse à la validation en deux étapes est vide.", @"Envoyer un SMS vers un numéro de téléphone", @"Un code temporaire qui vous servira à vérifier votre identité, sera envoyé à l’appareil que vous aurez sélectionné ci-dessous.",
           @"Mémoire insuffisante",
           @"Jean Martin",
           @"Envoyer le code à %@",
           @"Invocation de la méthode inattendue",
           @"Vous avez dépassé le nombre maximal de tentatives de validation du code. Envoyez un nouveau code à un appareil différent ou réessayez ultérieurement.",
           @"Jeton de données non valide. Le jeton de données de validation n’est pas valide.",
           @"Authentification annulée par l’application",
           @"Longueur incorrecte du mot de passe",
           @"Code de validation",
           @"Ce compte a été désactivé pour des raisons de sécurité. Vous pouvez réinitialiser votre mot de passe sur %@.",
           @"Vous ne recevez aucun message sur vos appareils ?",
           @"Envoyer un nouveau code",
           @"Une erreur est survenue. Nous vous remercions de votre patience. Veuillez réessayer ultérieurement.",
           @"Obligatoire",
           @"Personne introuvable.",
           @"Saisir le code de validation",
           @"Appareil introuvable.",
           @"Identifiant Apple",
           @"La validation en deux étapes est activée pour cet identifiant Apple.",
           @"Impossible de vérifier le jeton.",
           @"Mot de passe",
           @"Il est temps de réinitialiser votre mot de passe afin de renforcer votre sécurité. C’est simple, il suffit d’aller à %@.",
           @"L’heure affichée par cet appareil semble être incorrecte. Pour la changer, rendez-vous dans Réglages > Général > Date et heure, puis réessayez.",
           @"Échec de la création d’un jeton d’identification SSO valide",
           @"Le code de validation que vous avez saisi n’est pas valide.",
           @"Continuer",
           @"Valider l’identité",
           @"Authentification annulée par le système",
           @"Générer le code avec %@",
           @"La liste d’appareils est vide.",
           @"Session non valide.",
