...
- (ACMLocale_vi)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Ô mật khẩu đang trống", @"Hủy bỏ", @"Đăng nhập", @"Gửi", @"OK", @"Phương thức gọi không hợp lệ. Không thể ẩn cuộc đối thoại AppleConnect SignIn.", @"Thông số Không hợp lệ. Vài thông số đã nhập không được cài đặt chính xác.", @"Mật khẩu của ID Apple", @"Bạn đang ngoại tuyến. Vui lòng kết nối Internet và thử lại.", @"Bạn đã nhập ID Apple hoặc mật khẩu không chính xác. ", @"Yêu cầu xác minh hai bước nhưng không cho phép người dùng tương tác.", @"THIẾT BỊ TIN CẬY", @"Để quản lý thiết bị tin cậy của bạn, hãy truy cập %@ từ máy Mac hoặc máy vi tính.", @"Không tạo được phiếu dịch vụ hợp lệ", @"Phản hồi xác minh hai bước đang trống.", @"Gửi tin nhắn SMS đến Số Điện Thoại", @"Mã tạm thời sẽ được gửi đến thiết bị được chọn dưới đây, bạn có thể sử dụng mã để xác minh nhận dạng của mình.",
           @"Hết bộ nhớ",
           @"trần.thủy",
           @"Gửi mã đến %@",
           @"Phương pháp yêu cầu hỗ trợ ngoài dự kiến",
           @"Bạn đã xác minh mã quá nhiều lần không thành công. Vui lòng gửi mã mới đến một thiết bị khác hoặc thử lại sau.",
           @"Mã thông báo Dữ liệu Không hợp lệ. Mã thông báo Dữ Liệu để xác minh không hợp lệ.",
           @"Xác thực đã bị hủy bởi ứng dụng",
           @"Độ dài mật khẩu không hợp lệ",
           @"Mã Xác Minh",
           @"ID Apple này đã bị tắt vì lý do bảo mật. Bạn có thể cài đặt lại mật khẩu tại %@.",
           @"Bạn không nhận được thông điệp trên mọi thiết bị của mình?",
           @"Gửi mã mới",
           @"Đã xảy ra lỗi. Cám ơn bạn đã kiên nhẫn chờ đợi, vui lòng thử lại sau.",
           @"Yêu cầu",
           @"Không thể tìm người này.",
           @"Nhập mã xác minh",
           @"Không tìm thấy thiết bị.",
           @"ID Apple",
           @"Xác minh hai bước đã được kích hoạt cho ID Apple này.",
           @"Không thể xác minh mã thông báo.",
           @"Mật khẩu",
           @"Để tăng cường bảo mật, bạn nên đặt lại mật khẩu. Hãy vào %@.",
           @"Giờ hiện tại trên thiết bị này có thể không đúng. Bạn có thể đổi giờ bằng cách vào Cài Đặt > Cài đặt Chung > Ngày & Giờ, sau đó thử lại.",
           @"Không tạo được mã thông báo SSO hợp lệ",
           @"Mã xác minh bạn đã nhập không hợp lệ.",
           @"Tiếp tục",
           @"Xác Minh Nhận Dạng",
           @"Xác thực đã bị hủy bởi hệ thống",
           @"Tạo mã với %@",
