...
- (ACMLocale_id)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Kolom kata sandi kosong", @"Batalkan", @"Masuk", @"Kirim", @"OKE", @"Metode dipanggil dengan cara yang tidak tepat. Dialog AppleConnect SignIn tidak dapat disembunyikan.", @"Parameter Tidak Valid. Beberapa parameter input diatur dengan cara yang salah.", @"Kata sandi ID Apple", @"Tampaknya Anda sedang offline. Silakan sambung ke Internet dan coba lagi.", @"ID Apple atau kata sandi Anda Salah.", @"Diperlukan verifikasi dua langkah, tetapi interaksi pengguna tidak diizinkan.", @"PERANGKAT TEPERCAYA", @"Untuk mengelola perangkat tepercaya Anda, kunjungi %@ melalui Mac atau PC.", @"Gagal membuat tiket layanan yang valid", @"Respons verifikasi dua langkah kosong.", @"SMS ke Nomor Telepon", @"Perangkat yang Anda pilih di bawah akan dikirimi kode sementara yang dapat Anda gunakan untuk memverifikasi identitas Anda.",
           ...
           @"johan.ramli",
           @"Kirimkan kode ke %@",
           @"Pemanggilan metode tidak benar",
           @"Anda telah terlalu banyak gagal untuk memverifikasi kode. Harap kirimkan kode baru ke perangkat yang berbeda atau coba lagi nanti.",
           @"Token Data Tidak Valid. Token Data untuk verifikasi tidak valid.",
           @"Autentikasi dibatalkan oleh aplikasi",
           @"Panjang kode sandi tidak valid",
           @"Kode Verifikasi",
           @"ID Apple ini telah dinonaktifkan karena alasan keamanan. Anda dapat mengatur ulang kata sandi Anda di %@.",
           @"Tidak dapat menerima pesan pada semua perangkat Anda?",
           @"Kirim kode baru",
           @"Ups, telah terjadi kesalahan. Terima kasih atas kesabaran Anda. Harap coba lagi nanti.",
           @"Diperlukan",
           @"Tidak dapat menemukan orang ini.",
           @"Masukkan kode verifikasi",
           @"Perangkat tidak ditemukan.",
           @"ID Apple",
           @"Verifikasi dua langkah telah diaktifkan untuk ID Apple ini.",
           @"Tidak dapat memverifikasi token.",
           @"Kata Sandi",
           @"Untuk melindungi keamanan akun Anda, sekarang adalah waktunya untuk mengatur ulang kata sandi Anda. Mudah, cukup masuk ke %@.",
           @"Waktu saat ini pada perangkat tampaknya salah. Anda dapat memperbaikinya dengan masuk ke Pengaturan > Umum > Tanggal & Waktu, lalu coba lagi.",
           @"Gagal membuat token SSO yang valid",
           @"Kode verifikasi yang Anda masukkan tidak valid.",
           @"Lanjutkan",
           @"Verifikasi Identitas",
           @"Autentikasi dibatalkan oleh sistem",
           @"Hasilkan kode dengan %@",
