...
- (ACMLocale_pt)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"O campo palavra-passe está vazio", @"Cancelar", @"Iniciar sessão", @"Enviar", @"OK", @"Chamada incorreta do método. Diálogo AppleConnect SignIn não pode ser ocultado.", @"Parâmetros inválidos. Alguns dos parâmetros de entrada não estão definidos corretamente.", @"Palavra-passe do ID Apple", @"Parece estar offline. Estabeleça ligação à Internet e tente novamente.", @"A palavra-passe ou o ID Apple foram introduzidos incorretamente.", @"A confirmação em dois passos é necessária, mas a intervenção do utilizador não é permitida.", @"DISPOSITIVOS FIDEDIGNOS", @"Para gerir os seus dispositivos fidedignos, visite %@ a partir de um Mac ou PC.", @"Falha ao criar um ticket de serviço válido", @"A resposta da Confirmação em dois passos está vazia.", @"SMS para número de telefone", @"Será enviado, para o dispositivo que selecionar, um código temporário que pode utilizar para confirmar a sua identidade.",
           @"Sem memória",
           @"joão.silva",
           @"Enviar código para %@",
           @"Invocação de método inesperada",
           @"Falhou a confirmação do código demasiadas vezes. Envie um código novo para outro dispositivo ou tente mais tarde.",
           @"Token de dados inválido. O token de dados para confirmação não é válido.",
           @"A autenticação foi cancelada pela aplicação",
           @"Comprimento do código inválido",
           @"Código de confirmação",
           @"Por motivos de segurança, esta conta foi desativada. Pode repor a palavra-passe em %@.",
           @"Não consegue receber mensagens em qualquer dos seus dispositivos?",
           @"Enviar um código novo",
           @"Ups, ocorreu um erro. Obrigado por aguardar, tente novamente mais tarde.",
           @"Obrigatória",
           @"Não é possível encontrar esta pessoa.",
           @"Introduzir código de confirmação",
           @"Dispositivo não encontrado.",
           @"ID Apple",
           @"A confirmação em dois passos está ativada para este ID Apple. ",
           @"Não é possível confirmar o token.",
           @"Palavra-passe",
           @"Reponha a palavra-passe para proteger a sua segurança. Basta aceder a %@.",
           @"A hora atual neste dispositivo parece estar incorreta. Pode corrigi-la em Definições > Geral > Data e hora e, em seguida, tente novamente.",
           @"Falha ao criar um token SSO válido",
           @"O código de confirmação que introduziu não é válido.",
           @"Continuar",
