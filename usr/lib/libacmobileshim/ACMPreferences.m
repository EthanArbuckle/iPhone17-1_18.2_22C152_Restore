...
- (id)preferencesValueForKey:(id)a3 withOptions:(int64_t)a4
{
  ...
  return (id)[(ACMPreferencesStore *)v6 preferencesValueForKey:a3 withOptions:a4];
}
...
- (id)multiplePreferencesValuesForKeys:(id)a3 withOptions:(int64_t)a4
{
  ...
  return (id)[(ACMPreferencesStore *)v6 multiplePreferencesValuesForKeys:a3 withOptions:a4];
}
...
- (id)preferencesValueForKey:(id)a3
{
  ...
  return (id)[(ACMPreferencesStore *)v4 preferencesValueForKey:a3];
}
...
- (id)multiplePreferencesValuesForKeys:(id)a3
{
  ...
  return (id)[(ACMPreferencesStore *)v4 multiplePreferencesValuesForKeys:a3];
}
