...
- (ACMLocale_hu)init
{
  ...
  if (v2)
  {
    uint64_t v3 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"Password field is empty", @"Cancel", @"Sign In", @"Send", @"OK", @"Improper call of the method. AppleConnect SignIn dialog cannot be hidden.", @"Invalid Parameters. Some of input parameters are set incorrectly.", @"Apple ID password", @"You appear to be offline. Please connect to the Internet and try again.", @"Your Apple ID or password was entered incorrectly.", @"Two-step verification required, but user interaction is not allowed.", @"TRUSTED DEVICES", @"To manage your trusted devices visit %@ from a Mac or PC.", @"Failed to create valid service ticket", @"Two-step verification response is empty.", @"SMS to Phone Number", @"The device you select below will be sent a temporary code that you can use to verify your identity.",
           ...
           @"Number ending in %@");
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"A jelszómező üres", @"Mégsem", @"Bejelentkezés", @"Küldés", @"OK", @"Érvénytelen metódushívás. Az AppleConnect Bejelentkezés párbeszédablak nem rejthető el.", @"Érvénytelen paraméterek. Egyes bemeneti paraméterek hibásan lettek megadva.", @"Apple ID jelszó", @"Úgy tűnik, Ön offline állapotban van. Kapcsolódjon az internethez, és próbálja újra.", @"Az Apple ID vagy jelszó hibásan lett megadva.", @"Kétlépcsős ellenőrzés szükséges, de felhasználói közreműködés nem engedélyezett.", @"MEGBÍZHATÓ KÉSZÜLÉKEK", @"A megbízható készülékek kezeléséhez egy Mac vagy PC számítógépről látogasson el a következő címre: %@.", @"Érvényes szolgáltatásjegy létrehozása sikertelen", @"A kétlépcsős ellenőrzésre adott válasz üres.", @"SMS telefonszámra", @"Az alább kiválasztott készülékre küldjük el a személyazonossága ellenőrzésére szolgáló ideiglenes kód.",
           @"Kevés a memória",
           @"kovacs.janos",
           @"Kód küldése a következőre: %@",
           @"Nem várt metódushívás",
           @"Túl sokszor próbálta meg ellenőrizni a kódot. Küldjön egy új kódot egy másik készülékre, vagy próbálja újra később.",
           @"Érvénytelen adattoken. Az adattoken az ellenőrzéshez érvénytelen.",
           @"A hitelesítést az alkalmazás megszakította",
           @"Érvénytelen a jelkód hossza",
           @"Ellenőrző kód",
           @"Ez a fiók biztonsági okokból le lett tiltva. A jelszót visszaállíthatja a(z) %@ webhelyen.",
           @"Nem tud üzeneteket fogadni egyik készülékén sem?",
           @"Új kód küldése",
           @"Hiba történt. Köszönjük türelmét, kérjük, próbálja újra később.",
           @"Kötelező",
           @"Ez a személy nem található.",
           @"Ellenőrző kód megadása",
           @"A készülék nem található.",
           @"Apple ID",
           @"Ehhez az Apple ID-hoz be van kapcsolva a kétlépcsős ellenőrzés.",
           @"A token nem ellenőrizhető.",
           @"Jelszó",
           @"Adatai védelme érdekében ideje megváltoztatnia jelszavát. Ezt egyszerűen megteheti a(z) %@ webhelyen.",
           @"Az eszközön megjelenő pontos idő hibásnak tűnik. Kijavíthatja a Beállítások > Általános > Dátum és idő menüpont alatt, majd próbálja újra.",
           @"Érvényes SSO-token létrehozása sikertelen",
           @"A megadott ellenőrző kód érvénytelen.",
           @"Folytatás",
           @"Azonosítás",
           @"A hitelesítést a rendszer megszakította",
           @"Generáljon kódot a következővel: %@",
           @"A készüléklista üres.",
