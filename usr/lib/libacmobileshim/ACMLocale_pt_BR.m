...
- (ACMLocale_pt_BR)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", @"O campo Senha está em branco", @"Cancelar", @"Iniciar sessão", @"Enviar", @"OK", @"Chamada incorreta do método. Não é possível ocultar a caixa de diálogo para iniciar sessão do AppleConnect.", @"Parâmetros inválidos. Alguns parâmetros de entrada foram definidos incorretamente.", @"Senha do ID Apple", @"Você parece estar offline. Conecte-se à Internet e tente novamente.", @"Sua senha ou ID Apple foram inseridos incorretamente.", @"A verificação em dois passos é necessária, mas a interação do usuário não é permitida.", @"DISPOSITIVOS DE CONFIANÇA", @"Para gerenciar seus dispositivos confiáveis, visite %@ de um Mac ou PC.", @"Falha na criação de um tíquete de serviço válido", @"A resposta da verificação em dois passos está vazia.", @"SMS para número de telefone", @"Para verificar sua identidade, enviaremos um código temporário para o dispositivo selecionado a seguir.",
           @"Sem Memória",
           @"joão.silva",
           @"Enviar código para %@",
           @"Invocação de método não esperada",
           @"Você não conseguiu verificar o código por muitas vezes. Envie um novo código para um dispositivo diferente e tente novamente.",
           @"Token de Dados inválido. O Token de Dados para confirmação não é válido.",
           @"A autenticação foi cancelada pelo aplicativo",
           @"Tamanho do código inválido",
           @"Código de verificação",
           @"Este ID Apple foi desativado por motivos de segurança. Você pode redefinir sua senha no site %@.",
           @"Não consegue receber mensagens em nenhum de seus dispositivos?",
           @"Enviar um novo código",
           @"Opa! Aconteceu em erro. Obrigado por sua paciência. Tente novamente mais tarde.",
           @"Obrigatória",
           @"Não é possível encontrar essa pessoa.",
           @"Inserir código de verificação",
           @"Dispositivo não encontrado.",
           @"ID Apple",
           @"A verificação em dois passos está ativada para este ID Apple.",
           @"Não é possível confirmar o token.",
           @"Senha",
           @"Para proteger sua segurança, chegou a hora de redefinir a senha. É fácil, basta acessar %@.",
           @"A hora atual deste dispositivo parece estar incorreta. Você pode corrigi-la acessando Ajustes > Geral > Data e Hora. Em seguida, tente novamente.",
           @"Falha na criação de um token SSO válido",
           @"O código de verificação inserido não é válido.",
           @"Verificar identidade",
           @"A autenticação foi cancelada pelo sistema",
           @"Gerar código com %@",
