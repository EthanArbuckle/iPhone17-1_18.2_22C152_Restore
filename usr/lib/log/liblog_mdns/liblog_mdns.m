...
LABEL_651:
  ...
  unint64_t v9 = (const char *)&unk_23FEECA83;
...
LABEL_632:
        ...
        uint64_t CUSymAddr_DataBuffer_AppendF_sAddr = _GetCUSymAddr_DataBuffer_Append_sAddr(v112, &unk_23FEECA83, 1);
        if (!CUSymAddr_DataBuffer_AppendF_sAddr)
        {
  ...
  if (v105)
  {
    ...
    while (1)
    {
      ...
      else
      {
        ...
        if ((v106 & 1) == 0) {
          int v28 = (const char *)&unk_23FEECA83;
        }
...
LABEL_285:
      if ((unsigned __int16)v118 == 41)
      {
        ...
        unsigned int v45 = (const char *)&unk_23FEECA83;
        if (v41) {
          unsigned int v45 = " CF";
        }
      ...
      else
      {
        ...
        int64_t v46 = (const char *)&unk_23FEECA83;
        if (v41) {
          int64_t v46 = "CF";
        }
...
LABEL_625:
  ...
  if ((v106 >> 2)) {
    long long v54 = (const char *)&unk_23FEECA83;
  }
  else {
    long long v54 = "\n\t";
  }
...
uint64_t DNSRecordDataToStringEx(unsigned __int16 *a1, unint64_t a2, int a3, unint64_t a4, uint64_t a5, int a6, uint64_t a7)
{
  ...
  switch(a3)
  {
    case ')':
      ...
      uint64_t v16 = (const char *)&unk_23FEECA83;
      while (2)
      {
        if ((unint64_t)a1 >= v13) {
          goto LABEL_411;
                  ...
                  if (v13 - (unint64_t)(v26 + 1) >= v31)
                  {
                    switch((int)v27)
                    {
                      ...
                      case 6:
                        ...
                        unsigned int v48 = (const char *)&unk_23FEECA83;
                        while (2)
                        {
...
LABEL_411:
        ...
        if (_GetCUSymAddr_DataBuffer_Append_sAddr)
        {
          uint64_t appended = _GetCUSymAddr_DataBuffer_Append_sAddr(v84, &unk_23FEECA83, 1);
          if (appended)
          {
LABEL_419:
...
uint64_t OSLogCopyFormattedString(const char *a1, void *a2)
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      uint64_t v5 = 0;
      BOOL v6 = (const char **)&off_26F3E86C8;
      ...
      uint64_t v14 = ((void (*)(id))(&off_26F3E86C8)[2 * v5 + 1])(v4);
      goto LABEL_18;
    }
...
LABEL_16:
  ...
  uint64_t v7 = 0;
  unsigned int v8 = (const char **)&off_26F3E8718;
  ...
  uint64_t v15 = ((void (*)(id))(&off_26F3E8718)[2 * v7 + 1])(v3);
LABEL_20:
...
{
  id v3 = _log_mdns_create_record_data_string(a1, a2, a3);
  id v4 = v3;
  if (v3)
  {
    uint64_t v5 = _log_mdns_create_attributed_string(v3);
  }
  else
  {
    uint64_t v5 = 0;
...
{
  id v1 = a1;
  uint64_t v2 = (void *)[objc_alloc((Class)&off_26F3E9EA0) initWithString:v1];

  return v2;
}

uint64_t _log_mdns_format_time_duration(uint64_t a1)
{
  return MEMORY[0x270F244D8]("dur", a1, 0);
}
...
id _log_mdns_format_termination_reason(void *a1)
{
  ...
  if (v1 == (int)v1 && v1 <= 5)
  {
    uint64_t v2 = _log_mdns_create_attributed_string(off_2650997F0[(int)v1]);
  }
...
id _log_mdns_format_session_event(void *a1)
{
  ...
  if (v1 == (int)v1 && (v1 - 1) <= 3)
  {
    uint64_t v2 = _log_mdns_create_attributed_string(off_2650997D0[(v1 - 1)]);
  }
  else
  {
    uint64_t v2 = 0;
...
id _log_mdns_format_protocol(void *a1)
{
  ...
  if (v1 == (int)v1 && v1 <= 4)
  {
    uint64_t v2 = _log_mdns_create_attributed_string(off_2650997A8[(int)v1]);
  }
...
id _log_mdns_format_powerlog_event_subtype(void *a1)
{
  ...
  if (v1 <= 0xFF && v1 <= 0x12u)
  {
    id v3 = +[NSString stringWithUTF8String:off_2650996E0[(char)v1]];
    id v4 = v3;
    if (v3)
    {
      uint64_t v2 = _log_mdns_create_attributed_string(v3);
    }
    else
    {
      uint64_t v2 = 0;
...
{
  if ([a1 BOOLValue]) {
    unint64_t v1 = @"positive";
  }
  else {
    unint64_t v1 = @"negative";
  }
...
id _log_mdns_format_negative_reason(void *a1)
{
  ...
  if (v1 == (int)v1 && v1 <= 5)
  {
    uint64_t v2 = _log_mdns_create_attributed_string(off_265099778[(int)v1]);
  }
...
id _log_mdns_format_mortality(void *a1)
{
  ...
  {
    uint64_t v2 = _log_mdns_create_attributed_string(*((void **)&off_2650996C8 + v1));
  }
...
{
  id v1 = a1;
  uint64_t v2 = (void *)[objc_alloc((Class)&off_26F3EA430) initWithCapacity:0];
  if (v2)
  {
    uint64_t v3 = [v1 unsignedLongLongValue];
    [v2 appendFormat:@"0x%llX {", v3];
    uint64_t v4 = 0;
    uint64_t v5 = (const char *)&unk_23FEECA83;
    do
    {
      if ((v3 & byte_265099678[v4]) != 0)
      {
        [v2 appendFormat:@"%s%s", v5, *(void *)&byte_265099678[v4 + 8]];
        uint64_t v5 = ", ";
      }
      v4 += 16;
    }
    while (v4 != 80);
    [v2 appendString:@"}"];
    BOOL v6 = _log_mdns_create_attributed_string(v2);
  }
  else
  {
    BOOL v6 = 0;
...
uint64_t _log_mdns_format_err(uint64_t a1)
{
  return MEMORY[0x270F244D8]("err", a1, 0);
}
...
id _log_mdns_format_dnssec_result(void *a1)
{
  ...
  if (v1 <= 3)
  {
    uint64_t v3 = +[NSString stringWithUTF8String:off_265099638[v1]];
    uint64_t v4 = v3;
    if (v3)
    {
      uint64_t v2 = _log_mdns_create_attributed_string(v3);
...
id _log_mdns_format_dnssec_insecure_validation_state(void *a1)
{
  ...
  if (v1 <= 3)
  {
    uint64_t v3 = +[NSString stringWithUTF8String:off_265099658[v1]];
    uint64_t v4 = v3;
    if (v3)
    {
      uint64_t v2 = _log_mdns_create_attributed_string(v3);
...
id _log_mdns_format_dns_service_type(void *a1)
{
  ...
  if (v1 <= 0xFF && v1 <= 5u)
  {
    uint64_t v3 = +[NSString stringWithUTF8String:off_265098C88[v1]];
    uint64_t v4 = v3;
    if (v3)
    {
      uint64_t v2 = _log_mdns_create_attributed_string(v3);
...
id _log_mdns_format_dns_id_and_flags(void *a1)
{
  ...
  else
  {
    ...
    char v5 = BYTE1(v1);
    char v6 = v1;
    uint64_t v2 = _log_mdns_format_dns_message_ex(&v4, 0xCuLL, 64);
  }
...
id _log_mdns_format_dns_message_ex(unsigned __int16 *a1, unint64_t a2, int a3)
{
  ...
  if (__s)
  {
    id v3 = objc_alloc((Class)&off_26F3EA340);
    unsigned __int16 v4 = (void *)[v3 initWithBytesNoCopy:__s length:strlen(__s) encoding:4 freeWhenDone:1];
    if (v4)
    {
      char v5 = (void *)[objc_alloc((Class)&off_26F3E9EA0) initWithString:v4];
    }
    else if (__s)
    {
      free(__s);
...
id _log_mdns_format_dns_record_type(void *a1)
{
  ...
  {
    uint64_t v2 = _log_mdns_create_dns_record_type_string((unsigned __int16)v1);
    id v3 = v2;
    if (v2)
    {
      unsigned __int16 v4 = _log_mdns_create_attributed_string(v2);
    }
    else
    {
      unsigned __int16 v4 = 0;
...
id _log_mdns_create_dns_record_type_string(uint64_t a1)
{
  ...
  id v3 = objc_alloc((Class)&off_26F3EA340);
  if (v2) {
    unsigned __int16 v4 = [v3 initWithFormat:@"%s", v2];
  }
  else {
    unsigned __int16 v4 = [v3 initWithFormat:[[NSString alloc] initWithFormat:@"TYPE%u", a1]];
  }
...
{
  unint64_t v1 = [a1 unsignedLongLongValue];
  uint64_t v2 = [objc_alloc((Class)&off_26F3EA340) initWithFormat:@"%u/%u/%u/%u", HIWORD(v1), WORD2(v1), WORD1(v1), (unsigned __int16)v1];
  id v3 = v2;
  if (v2)
  {
    unsigned __int16 v4 = _log_mdns_create_attributed_string(v2);
...
{
  if ([a1 BOOLValue]) {
    unint64_t v1 = @"acceptable";
  }
  else {
    unint64_t v1 = @"unacceptable";
  }
...
unsigned __int16 *_log_mdns_format_record_type_data(void *a1)
{
  ...
  unint64_t v7 = 0;
  unint64_t v1 = _log_mdns_extract_record_type_and_rdata(a1, &v8, (uint64_t *)&v7);
  if (v1)
  {
    uint64_t v2 = _log_mdns_create_dns_record_type_string(v8);
    if (v2
      && ((_log_mdns_create_record_data_string(v1, v7, v8), (id v3 = objc_claimAutoreleasedReturnValue()) != 0)
       || (NSPrintF(), (id v3 = objc_claimAutoreleasedReturnValue()) != 0)))
    {
      unsigned __int16 v4 = (void *)[objc_alloc((Class)&off_26F3EA340) initWithFormat:@"%@ %@", v2, v3];
      char v5 = v4;
      if (v4)
      {
        _log_mdns_create_attributed_string(v4);
        unint64_t v1 = (unsigned __int16 *)objc_claimAutoreleasedReturnValue();
      }
      else
      {
        unint64_t v1 = 0;
...
id _log_mdns_create_record_data_string(unsigned __int16 *a1, unint64_t a2, int a3)
{
  ...
  if (__s)
  {
    ...
    id v4 = objc_alloc((Class)&off_26F3EA340);
...
unsigned __int16 *_log_mdns_format_record_data(void *a1)
{
  unsigned __int16 v4 = 0;
  unint64_t v3 = 0;
  unint64_t v1 = _log_mdns_extract_record_type_and_rdata(a1, &v4, (uint64_t *)&v3);
  if (v1)
  {
