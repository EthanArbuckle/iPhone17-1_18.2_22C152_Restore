@interface ChipAuthenticationInfo
- (id)description;
- (void)setOptionalKeyId:(id)a3;
- (void)setProtocol:(int64_t)a3;
- (void)setVersion:(int64_t)a3;
@end

@implementation ChipAuthenticationInfo
...
- (id)description
{
  if (self)
  {
    ...
    {
      v5 = v3;
      [NSString stringWithFormat:@", keyId=%@", objc_getProperty(self, v4, 32, 1)];
    ...
    v7 = off_1E65ABD40[self->_protocol];
