...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallRelayInitiateSent description](&v3, sel_description), -[AWDFaceTimeCallRelayInitiateSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallRelayInitiateSentReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 3)) {
    -[AWDFaceTimeCallRelayInitiateSent setGuid:](self, "setGuid:");
  }
