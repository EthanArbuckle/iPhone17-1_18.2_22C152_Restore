...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestStart;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDITesterCertHomeKitTestStart description](&v3, sel_description), -[AWDITesterCertHomeKitTestStart dictionaryRepresentation](self, "dictionaryRepresentation")];
}
