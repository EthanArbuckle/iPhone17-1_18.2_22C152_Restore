...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineSettingsClusterLocationVisitView;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineSettingsClusterLocationVisitView;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDCoreRoutineSettingsClusterLocationVisitView description](&v3, sel_description), -[AWDCoreRoutineSettingsClusterLocationVisitView dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDCoreRoutineSettingsClusterLocationVisitViewReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    *((_DWORD *)a3 + 4) = self->_deletionCount;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v6 + 24) = [(NSString *)self->_sessionId copyWithZone:a3];
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    *(_DWORD *)(v6 + 16) = self->_deletionCount;
...
LABEL_14:
    ...
    if ((has & 2) != 0)
    {
      if ((*((unsigned char *)a3 + 32) & 2) == 0 || self->_deletionCount != *((_DWORD *)a3 + 4)) {
        goto LABEL_14;
      }
      LOBYTE(v5) = 1;
    }
...
- (unint64_t)hash
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0) {
    uint64_t v5 = 2654435761 * self->_deletionCount;
  }
  else {
    uint64_t v5 = 0;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 3)) {
    -[AWDCoreRoutineSettingsClusterLocationVisitView setSessionId:](self, "setSessionId:");
  }
  if ((*((unsigned char *)a3 + 32) & 2) != 0)
  {
    self->_deletionCount = *((_DWORD *)a3 + 4);
    *(unsigned char *)&self->_has |= 2u;
  }
}
