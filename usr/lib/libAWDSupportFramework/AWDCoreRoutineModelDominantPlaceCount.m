...
@implementation AWDCoreRoutineModelDominantPlaceCount
...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineModelDominantPlaceCount;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelDominantPlaceCount description](&v3, sel_description), -[AWDCoreRoutineModelDominantPlaceCount dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDCoreRoutineModelDominantPlaceCountReadFrom((uint64_t)self, (uint64_t)a3);
}
