...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSSocketPairConnectionTCPInfo description](&v3, sel_description), -[AWDIDSSocketPairConnectionTCPInfo dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_5:
    ...
    [v3 setObject:[NSNumber numberWithUnsignedLongLong:self->_bandwidth] forKey:@"bandwidth"];
  return v3;
}
...
LABEL_9:
    *((void *)a3 + 1) = self->_bandwidth;
    *((unsigned char *)a3 + 36) |= 1u;
    return;
  }
LABEL_8:
  *((void *)a3 + 2) = self->_currentRTT;
...
LABEL_9:
  *((void *)result + 2) = self->_currentRTT;
  *((unsigned char *)result + 36) |= 2u;
  if ((*(unsigned char *)&self->_has & 1) == 0) {
    return result;
  }
LABEL_5:
  *((void *)result + 1) = self->_bandwidth;
...
LABEL_21:
    ...
    {
      if ((*((unsigned char *)a3 + 36) & 8) == 0 || self->_linkType != *((_DWORD *)a3 + 8)) {
        goto LABEL_21;
      }
    }
    ...
    {
      if ((*((unsigned char *)a3 + 36) & 2) == 0 || self->_currentRTT != *((void *)a3 + 2)) {
        goto LABEL_21;
      }
    }
    ...
    if (*(unsigned char *)&self->_has)
    {
      if ((*((unsigned char *)a3 + 36) & 1) == 0 || self->_bandwidth != *((void *)a3 + 1)) {
        goto LABEL_21;
      }
      LOBYTE(v5) = 1;
    }
...
LABEL_4:
  unint64_t v4 = 2654435761u * self->_currentRTT;
  if ((*(unsigned char *)&self->_has & 1) == 0) {
    goto LABEL_9;
  }
LABEL_5:
  unint64_t v5 = 2654435761u * self->_bandwidth;
  return v3 ^ v2 ^ v4 ^ v5;
}
...
LABEL_9:
    self->_bandwidth = *((void *)a3 + 1);
    *(unsigned char *)&self->_has |= 1u;
    return;
  }
LABEL_8:
  self->_currentRTT = *((void *)a3 + 2);
  *(unsigned char *)&self->_has |= 2u;
