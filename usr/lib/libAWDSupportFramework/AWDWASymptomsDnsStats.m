...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWASymptomsDnsStats description](&v3, sel_description), -[AWDWASymptomsDnsStats dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (id)dictionaryRepresentation
{
  ...
  {
    [v3 setObject:[NSNumber numberWithUnsignedInt:self->_totalDnsServers] forKey:@"totalDnsServers"];
    $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
...
LABEL_3:
  ...
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_numIpv4DnsServers] forKey:@"numIpv4DnsServers"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x800) == 0)
  {
LABEL_4:
...
LABEL_33:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_numIpv6DnsServers] forKey:@"numIpv6DnsServers"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x1000) == 0)
  {
LABEL_5:
...
LABEL_34:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_numLocalDnsServers] forKey:@"numLocalDnsServers"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x2000) == 0)
  {
LABEL_6:
...
LABEL_35:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_numRemoteDnsServers] forKey:@"numRemoteDnsServers"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(unsigned char *)&has & 2) == 0)
  {
LABEL_7:
...
LABEL_36:
  ...
  if (configType >= 3) {
    v7 = (__CFString *)[NSString stringWithFormat:@"(unknown: %i)", self->_configType];
  }
  else {
    v7 = off_2641BA228[configType];
  }
...
LABEL_40:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_netscoreAtStudyStart] forKey:@"netscoreAtStudyStart"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x8000) == 0)
  {
LABEL_9:
...
LABEL_41:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_stallscoreAtStudyStart] forKey:@"stallscoreAtStudyStart"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(unsigned char *)&has & 8) == 0)
  {
LABEL_10:
...
LABEL_42:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_impactedServersAtStudyStart] forKey:@"impactedServersAtStudyStart"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x200) == 0)
  {
LABEL_11:
...
LABEL_43:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_netscoreHealthBeforeDecision] forKey:@"netscoreHealthBeforeDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x20000) == 0)
  {
LABEL_12:
...
LABEL_44:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_stallscoreHealthBeforeDecision] forKey:@"stallscoreHealthBeforeDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(unsigned char *)&has & 0x20) == 0)
  {
LABEL_13:
...
LABEL_45:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_lanHealthBeforeDecision] forKey:@"lanHealthBeforeDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x400000) == 0)
  {
LABEL_14:
...
LABEL_46:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_wanHealthBeforeDecision] forKey:@"wanHealthBeforeDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x1000000) == 0)
  {
LABEL_15:
...
LABEL_47:
  [v3 setObject:[NSNumber numberWithBool:self->_isCaptiveServerIPResolved] forKey:@"isCaptiveServerIPResolved"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x8000000) == 0)
  {
LABEL_16:
...
LABEL_48:
  [v3 setObject:[NSNumber numberWithBool:self->_symptomsDnsscreenStateOn] forKey:@"symptomsDnsscreenStateOn"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x80000) == 0)
  {
LABEL_17:
...
LABEL_49:
  ...
  if (symptomsDnsRecommendation >= 3) {
    v9 = (__CFString *)[NSString stringWithFormat:@"(unknown: %i)", self->_symptomsDnsRecommendation];
  }
  else {
    v9 = off_2641BA240[symptomsDnsRecommendation];
  }
...
LABEL_53:
  ...
  if (suppressedReason >= 0xB) {
    v11 = (__CFString *)[NSString stringWithFormat:@"(unknown: %i)", self->_suppressedReason];
  }
  else {
    v11 = off_2641BA258[suppressedReason];
  }
...
LABEL_57:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_netscoreAtStudyEnd] forKey:@"netscoreAtStudyEnd"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x4000) == 0)
  {
LABEL_20:
...
LABEL_58:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_stallscoreAtStudyEnd] forKey:@"stallscoreAtStudyEnd"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(unsigned char *)&has & 4) == 0)
  {
LABEL_21:
...
LABEL_59:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_impactedServersAtStudyEnd] forKey:@"impactedServersAtStudyEnd"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_WORD *)&has & 0x100) == 0)
  {
LABEL_22:
...
LABEL_60:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_netscoreHealthAfterDecision] forKey:@"netscoreHealthAfterDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x10000) == 0)
  {
LABEL_23:
...
LABEL_61:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_stallscoreHealthAfterDecision] forKey:@"stallscoreHealthAfterDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(unsigned char *)&has & 0x10) == 0)
  {
LABEL_24:
...
LABEL_62:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_lanHealthAfterDecision] forKey:@"lanHealthAfterDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x200000) == 0)
  {
LABEL_25:
...
LABEL_63:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_wanHealthAfterDecision] forKey:@"wanHealthAfterDecision"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(unsigned char *)&has & 1) == 0)
  {
LABEL_26:
...
LABEL_64:
  [v3 setObject:[NSNumber numberWithUnsignedLongLong:self->_symptomsDnsTimeSincePreviousTriggerMinutes] forKey:@"symptomsDnsTimeSincePreviousTriggerMinutes"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x800000) == 0)
  {
LABEL_27:
...
LABEL_66:
    [v3 setObject:[NSNumber numberWithBool:self->_slowWiFiNotificationReceivedDuringStudy] forKey:@"slowWiFiNotificationReceivedDuringStudy"];
...
LABEL_65:
  [v3 setObject:[NSNumber numberWithBool:self->_dpsNotificationReceivedDuringStudy] forKey:@"dpsNotificationReceivedDuringStudy"];
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x4000000) != 0) {
    goto LABEL_66;
  }
...
LABEL_29:
    ...
    [v3 setObject:[NSNumber numberWithBool:self->_isPingEnqueueFailing] forKey:@"isPingEnqueueFailing"];
  return v3;
}
...
LABEL_43:
  *((unsigned char *)a3 + 105) = self->_isCaptiveServerIPResolved;
...
LABEL_44:
  *((unsigned char *)a3 + 108) = self->_symptomsDnsscreenStateOn;
...
LABEL_54:
  *((void *)a3 + 1) = self->_symptomsDnsTimeSincePreviousTriggerMinutes;
  *((_DWORD *)a3 + 28) |= 1u;
  $F3D7C730B717C29F2620BA54A0CAA3FF has = self->_has;
  if ((*(_DWORD *)&has & 0x800000) == 0)
  {
...
LABEL_55:
  *((unsigned char *)a3 + 104) = self->_dpsNotificationReceivedDuringStudy;
...
LABEL_57:
    *((unsigned char *)a3 + 106) = self->_isPingEnqueueFailing;
    *((_DWORD *)a3 + 28) |= 0x2000000u;
    return;
  }
LABEL_56:
  *((unsigned char *)a3 + 107) = self->_slowWiFiNotificationReceivedDuringStudy;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((v7 & 1) == 0 || self->_symptomsDnsTimeSincePreviousTriggerMinutes != *((void *)a3 + 1)) {
      goto LABEL_151;
    }
  }
  else if (v7)
...
LABEL_35:
  self->_uint64_t configType = *((_DWORD *)a3 + 4);
  *(_DWORD *)&self->_has |= 2u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x80) == 0)
  {
...
LABEL_43:
  self->_isCaptiveServerIPResolved = *((unsigned char *)a3 + 105);
  *(_DWORD *)&self->_has |= 0x1000000u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x8000000) == 0)
  {
...
LABEL_44:
  self->_symptomsDnsscreenStateOn = *((unsigned char *)a3 + 108);
  *(_DWORD *)&self->_has |= 0x8000000u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x80000) == 0)
  {
...
LABEL_45:
  self->_uint64_t symptomsDnsRecommendation = *((_DWORD *)a3 + 22);
  *(_DWORD *)&self->_has |= 0x80000u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x40000) == 0)
  {
...
LABEL_46:
  self->_uint64_t suppressedReason = *((_DWORD *)a3 + 21);
  *(_DWORD *)&self->_has |= 0x40000u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x40) == 0)
  {
...
LABEL_54:
  self->_symptomsDnsTimeSincePreviousTriggerMinutes = *((void *)a3 + 1);
  *(_DWORD *)&self->_has |= 1u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x800000) == 0)
  {
...
LABEL_55:
  self->_dpsNotificationReceivedDuringStudy = *((unsigned char *)a3 + 104);
  *(_DWORD *)&self->_has |= 0x800000u;
  int v3 = *((_DWORD *)a3 + 28);
  if ((v3 & 0x4000000) == 0)
  {
...
LABEL_57:
    self->_isPingEnqueueFailing = *((unsigned char *)a3 + 106);
    *(_DWORD *)&self->_has |= 0x2000000u;
    return;
  }
LABEL_56:
  self->_slowWiFiNotificationReceivedDuringStudy = *((unsigned char *)a3 + 107);
  *(_DWORD *)&self->_has |= 0x4000000u;
