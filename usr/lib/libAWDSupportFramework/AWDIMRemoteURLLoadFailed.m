...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIMRemoteURLLoadFailed;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIMRemoteURLLoadFailed description](&v3, sel_description), -[AWDIMRemoteURLLoadFailed dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDIMRemoteURLLoadFailedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  ...
  *((void *)a3 + 8) = self->_navigationStartToRedirectStartMillis;
  *((_WORD *)a3 + 60) |= 0x80u;
  __int16 has = (__int16)self->_has;
  if ((has & 0x200) == 0)
  {
...
LABEL_18:
  *((void *)a3 + 10) = self->_redirectStartToRedirectEndMillis;
  *((_WORD *)a3 + 60) |= 0x200u;
  __int16 has = (__int16)self->_has;
  if ((has & 0x100) == 0)
  {
...
LABEL_19:
  *((void *)a3 + 9) = self->_redirectEndToFetchStartMillis;
  *((_WORD *)a3 + 60) |= 0x100u;
  __int16 has = (__int16)self->_has;
  if ((has & 0x40) == 0)
  {
...
LABEL_20:
  *((void *)a3 + 7) = self->_fetchStartToDomainLookupStartMillis;
  *((_WORD *)a3 + 60) |= 0x40u;
  __int16 has = (__int16)self->_has;
  if ((has & 0x10) == 0)
  {
...
LABEL_25:
  *((void *)a3 + 13) = self->_secureConnectionStartToConnectEndMillis;
  *((_WORD *)a3 + 60) |= 0x1000u;
  __int16 has = (__int16)self->_has;
  if ((has & 1) == 0)
  {
...
LABEL_27:
  *((void *)a3 + 11) = self->_requestStartToResponseStartMillis;
  *((_WORD *)a3 + 60) |= 0x400u;
  __int16 has = (__int16)self->_has;
  if ((has & 0x800) == 0)
  {
...
LABEL_29:
    *((void *)a3 + 6) = self->_errorCode;
    *((_WORD *)a3 + 60) |= 0x20u;
    return;
  }
LABEL_28:
  *((void *)a3 + 12) = self->_responseStartToResponseEndMillis;
  *((_WORD *)a3 + 60) |= 0x800u;
  if ((*(_WORD *)&self->_has & 0x20) != 0) {
    goto LABEL_29;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 0x2000) != 0)
  {
    *((void *)result + 14) = self->_timestamp;
...
LABEL_3:
  ...
  *((void *)result + 8) = self->_navigationStartToRedirectStartMillis;
...
LABEL_19:
  *((void *)result + 10) = self->_redirectStartToRedirectEndMillis;
...
LABEL_20:
  *((void *)result + 9) = self->_redirectEndToFetchStartMillis;
...
LABEL_21:
  *((void *)result + 7) = self->_fetchStartToDomainLookupStartMillis;
...
LABEL_26:
  *((void *)result + 13) = self->_secureConnectionStartToConnectEndMillis;
...
LABEL_28:
  *((void *)result + 11) = self->_requestStartToResponseStartMillis;
...
LABEL_29:
  *((void *)result + 12) = self->_responseStartToResponseEndMillis;
  *((_WORD *)result + 60) |= 0x800u;
  if ((*(_WORD *)&self->_has & 0x20) == 0) {
    return result;
  }
LABEL_15:
  *((void *)result + 6) = self->_errorCode;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((has & 0x2000) != 0)
    {
      if ((*((_WORD *)a3 + 60) & 0x2000) == 0 || self->_timestamp != *((void *)a3 + 14)) {
        goto LABEL_71;
      }
    }
...
LABEL_71:
    ...
    if ((has & 0x80) != 0)
    {
      if ((v7 & 0x80) == 0 || self->_navigationStartToRedirectStartMillis != *((void *)a3 + 8)) {
        goto LABEL_71;
      }
    }
    else if ((v7 & 0x80) != 0)
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x200) == 0 || self->_redirectStartToRedirectEndMillis != *((void *)a3 + 10)) {
        goto LABEL_71;
      }
    }
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x100) == 0 || self->_redirectEndToFetchStartMillis != *((void *)a3 + 9)) {
        goto LABEL_71;
      }
    }
    ...
    if ((has & 0x40) != 0)
    {
      if ((v7 & 0x40) == 0 || self->_fetchStartToDomainLookupStartMillis != *((void *)a3 + 7)) {
        goto LABEL_71;
      }
    }
    else if ((v7 & 0x40) != 0)
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x1000) == 0 || self->_secureConnectionStartToConnectEndMillis != *((void *)a3 + 13)) {
        goto LABEL_71;
      }
    }
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x400) == 0 || self->_requestStartToResponseStartMillis != *((void *)a3 + 11)) {
        goto LABEL_71;
      }
    }
    ...
    {
      if ((*((_WORD *)a3 + 60) & 0x800) == 0 || self->_responseStartToResponseEndMillis != *((void *)a3 + 12)) {
        goto LABEL_71;
      }
    }
    ...
    if ((has & 0x20) != 0)
    {
      if ((v7 & 0x20) == 0 || self->_errorCode != *((void *)a3 + 6)) {
        goto LABEL_71;
      }
      LOBYTE(v5) = 1;
    }
...
LABEL_15:
  uint64_t v16 = 2654435761 * self->_errorCode;
  return v4 ^ v3 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10 ^ v11 ^ v12 ^ v13 ^ v14 ^ v15 ^ v16;
}
...
LABEL_3:
  ...
  self->_navigationStartToRedirectStartMillis = *((void *)a3 + 8);
  *(_WORD *)&self->_has |= 0x80u;
  __int16 v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x200) == 0)
  {
...
LABEL_18:
  self->_redirectStartToRedirectEndMillis = *((void *)a3 + 10);
  *(_WORD *)&self->_has |= 0x200u;
  __int16 v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x100) == 0)
  {
...
LABEL_19:
  self->_redirectEndToFetchStartMillis = *((void *)a3 + 9);
  *(_WORD *)&self->_has |= 0x100u;
  __int16 v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x40) == 0)
  {
...
LABEL_20:
  self->_fetchStartToDomainLookupStartMillis = *((void *)a3 + 7);
  *(_WORD *)&self->_has |= 0x40u;
  __int16 v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x10) == 0)
  {
...
LABEL_25:
  self->_secureConnectionStartToConnectEndMillis = *((void *)a3 + 13);
  *(_WORD *)&self->_has |= 0x1000u;
  __int16 v3 = *((_WORD *)a3 + 60);
  if ((v3 & 1) == 0)
  {
...
LABEL_27:
  self->_requestStartToResponseStartMillis = *((void *)a3 + 11);
  *(_WORD *)&self->_has |= 0x400u;
  __int16 v3 = *((_WORD *)a3 + 60);
  if ((v3 & 0x800) == 0)
  {
...
LABEL_29:
    self->_errorCode = *((void *)a3 + 6);
    *(_WORD *)&self->_has |= 0x20u;
    return;
  }
LABEL_28:
  self->_responseStartToResponseEndMillis = *((void *)a3 + 12);
  *(_WORD *)&self->_has |= 0x800u;
  if ((*((_WORD *)a3 + 60) & 0x20) != 0) {
    goto LABEL_29;
  }
}
