...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDEventKitSyncCompletedNightlySync description](&v3, sel_description), -[AWDEventKitSyncCompletedNightlySync dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_4:
    ...
    [v3 setObject:[NSNumber numberWithUnsignedInt:self->_eventsSynced] forKey:@"eventsSynced"];
  return v3;
}
...
LABEL_7:
  ...
  *((unsigned char *)a3 + 20) = self->_success;
...
LABEL_3:
  ...
  *((unsigned char *)result + 20) = self->_success;
...
LABEL_15:
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)a3 + 24) & 2) == 0 || self->_eventsSynced != *((_DWORD *)a3 + 4)) {
      goto LABEL_19;
    }
    LOBYTE(v5) = 1;
  }
...
LABEL_4:
  uint64_t v4 = 2654435761 * self->_eventsSynced;
  return v3 ^ v2 ^ v4;
}
...
LABEL_7:
  ...
  self->_success = *((unsigned char *)a3 + 20);
  *(unsigned char *)&self->_has |= 4u;
