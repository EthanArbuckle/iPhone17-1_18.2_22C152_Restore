...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageDelivered;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSLocalDeliveryMessageDelivered description](&v3, sel_description), -[AWDIDSLocalDeliveryMessageDelivered dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_15:
  [v3 setObject:[NSNumber numberWithUnsignedLongLong:self->_deliveryError] forKey:@"deliveryError"];
  char has = (char)self->_has;
  if ((has & 0x20) == 0)
  {
LABEL_9:
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((void *)a3 + 2) = self->_isToDefaultPairedDevice;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v6 + 64) = [(NSString *)self->_service copyWithZone:a3];
  char has = (char)self->_has;
  if ((has & 2) != 0)
  {
    *(void *)(v6 + 16) = self->_isToDefaultPairedDevice;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((has & 0x40) != 0)
    {
      if ((*((unsigned char *)a3 + 72) & 0x40) == 0 || self->_timestamp != *((void *)a3 + 7)) {
        goto LABEL_39;
      }
    }
...
LABEL_39:
    ...
    service = self->_service;
    if ((unint64_t)service | *((void *)a3 + 8))
    {
    ...
    if ((has & 2) != 0)
    {
      if ((*((unsigned char *)a3 + 72) & 2) == 0 || self->_isToDefaultPairedDevice != *((void *)a3 + 2)) {
        goto LABEL_39;
      }
    }
    ...
    if ((has & 8) != 0)
    {
      if ((*((unsigned char *)a3 + 72) & 8) == 0 || self->_messageSize != *((void *)a3 + 4)) {
        goto LABEL_39;
      }
    }
    ...
    if (has)
    {
      if ((*((unsigned char *)a3 + 72) & 1) == 0 || self->_deliveryError != *((void *)a3 + 1)) {
        goto LABEL_39;
      }
    }
    ...
    if ((has & 0x20) != 0)
    {
      if ((*((unsigned char *)a3 + 72) & 0x20) == 0 || self->_rTT != *((void *)a3 + 6)) {
        goto LABEL_39;
      }
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((unsigned char *)a3 + 72) & 4) == 0 || self->_linkType != *((void *)a3 + 3)) {
        goto LABEL_39;
      }
    }
    ...
    if ((has & 0x10) != 0)
    {
      if ((*((unsigned char *)a3 + 72) & 0x10) == 0 || self->_priority != *((void *)a3 + 5)) {
        goto LABEL_39;
      }
      LOBYTE(v5) = 1;
    }
...
LABEL_6:
  ...
  {
LABEL_7:
    unint64_t v7 = 2654435761u * self->_deliveryError;
...
LABEL_13:
  ...
  {
LABEL_8:
    unint64_t v8 = 2654435761u * self->_rTT;
...
LABEL_9:
  unint64_t v9 = 2654435761u * self->_linkType;
  if ((*(unsigned char *)&self->_has & 0x10) == 0) {
    goto LABEL_16;
  }
LABEL_10:
  unint64_t v10 = 2654435761u * self->_priority;
  return v4 ^ v3 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_isToDefaultPairedDevice = *((void *)a3 + 2);
    *(unsigned char *)&self->_has |= 2u;
    char v5 = *((unsigned char *)a3 + 72);
    if ((v5 & 8) == 0)
    {
