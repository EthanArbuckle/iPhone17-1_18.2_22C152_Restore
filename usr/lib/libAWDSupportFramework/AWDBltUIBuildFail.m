...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltUIBuildFail;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDBltUIBuildFail;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDBltUIBuildFail description](&v3, sel_description), -[AWDBltUIBuildFail dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDBltUIBuildFailReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 2)) {
    -[AWDBltUIBuildFail setSectionid:](self, "setSectionid:");
  }
}
