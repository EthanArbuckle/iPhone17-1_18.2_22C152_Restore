...
- (unint64_t)hash;
- (unint64_t)isFromDefaultPairedDevice;
- (unint64_t)linkType;
...
- (void)setHasIsFromDefaultPairedDevice:(BOOL)a3;
- (void)setHasLinkType:(BOOL)a3;
- (void)setHasMessageSize:(BOOL)a3;
- (void)setHasPriority:(BOOL)a3;
- (void)setHasTimestamp:(BOOL)a3;
- (void)setIsFromDefaultPairedDevice:(unint64_t)a3;
...
@implementation AWDIDSLocalDeliveryMessageReceived

- (void)dealloc
{
  [(AWDIDSLocalDeliveryMessageReceived *)self setService:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageReceived;
  [(AWDIDSLocalDeliveryMessageReceived *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageReceived;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSLocalDeliveryMessageReceived description](&v3, sel_description), -[AWDIDSLocalDeliveryMessageReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    [v3 setObject:[NSNumber numberWithUnsignedLongLong:self->_isFromDefaultPairedDevice] forKey:@"isFromDefaultPairedDevice"];
    char has = (char)self->_has;
    if ((has & 4) == 0)
    {
LABEL_7:
...
- (BOOL)readFrom:(id)a3
{
  return AWDIDSLocalDeliveryMessageReceivedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (has)
  {
    *((void *)a3 + 1) = self->_isFromDefaultPairedDevice;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v6 + 48) = [(NSString *)self->_service copyWithZone:a3];
  ...
  if (has)
  {
    *(void *)(v6 + 8) = self->_isFromDefaultPairedDevice;
...
LABEL_29:
    ...
    if (has)
    {
      if ((*((unsigned char *)a3 + 56) & 1) == 0 || self->_isFromDefaultPairedDevice != *((void *)a3 + 1)) {
        goto LABEL_29;
      }
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*((unsigned char *)a3 + 56) & 4) == 0 || self->_messageSize != *((void *)a3 + 3)) {
        goto LABEL_29;
      }
    }
    ...
    if ((has & 2) != 0)
    {
      if ((*((unsigned char *)a3 + 56) & 2) == 0 || self->_linkType != *((void *)a3 + 2)) {
        goto LABEL_29;
      }
    }
    ...
    LOBYTE(v5) = (*((unsigned char *)a3 + 56) & 8) == 0;
    if ((has & 8) != 0)
    {
      if ((*((unsigned char *)a3 + 56) & 8) == 0 || self->_priority != *((void *)a3 + 4)) {
        goto LABEL_29;
      }
      LOBYTE(v5) = 1;
    }
...
- (unint64_t)hash
{
  ...
  {
    unint64_t v5 = 2654435761u * self->_isFromDefaultPairedDevice;
...
LABEL_7:
  unint64_t v7 = 2654435761u * self->_linkType;
  if ((*(unsigned char *)&self->_has & 8) == 0) {
    goto LABEL_12;
  }
LABEL_8:
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 6)) {
    -[AWDIDSLocalDeliveryMessageReceived setService:](self, "setService:");
  }
  char v5 = *((unsigned char *)a3 + 56);
  if (v5)
  {
    self->_isFromDefaultPairedDevice = *((void *)a3 + 1);
    *(unsigned char *)&self->_has |= 1u;
    char v5 = *((unsigned char *)a3 + 56);
    if ((v5 & 4) == 0)
    {
