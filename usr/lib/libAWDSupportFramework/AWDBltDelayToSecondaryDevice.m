@interface AWDBltDelayToSecondaryDevice
...
@implementation AWDBltDelayToSecondaryDevice

- (void)dealloc
{
  [(AWDBltDelayToSecondaryDevice *)self setUniqueid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayToSecondaryDevice;
  [(AWDBltDelayToSecondaryDevice *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayToSecondaryDevice;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDBltDelayToSecondaryDevice description](&v3, sel_description), -[AWDBltDelayToSecondaryDevice dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDBltDelayToSecondaryDeviceReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 3)) {
    -[AWDBltDelayToSecondaryDevice setUniqueid:](self, "setUniqueid:");
  }
