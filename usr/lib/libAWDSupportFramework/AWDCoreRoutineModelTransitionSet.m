...
@implementation AWDCoreRoutineModelTransitionSet

- (void)dealloc
{
  [(AWDCoreRoutineModelTransitionSet *)self setInstances:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineModelTransitionSet;
  [(AWDCoreRoutineModelTransitionSet *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineModelTransitionSet;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelTransitionSet description](&v3, sel_description), -[AWDCoreRoutineModelTransitionSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDCoreRoutineModelTransitionSetReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(AWDCoreRoutineModelTransitionSet *)self instancesCount])
  {
    [a3 clearInstances];
    unint64_t v5 = [(AWDCoreRoutineModelTransitionSet *)self instancesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
        [a3 addInstance:-[AWDCoreRoutineModelTransitionSet instanceAtIndex:](self, "instanceAtIndex:", i)];
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineModelTransitionSet *)self addInstance:*(void *)(*((void *)&v9 + 1) + 8 * v8++)];
      }
      while (v6 != v8);
