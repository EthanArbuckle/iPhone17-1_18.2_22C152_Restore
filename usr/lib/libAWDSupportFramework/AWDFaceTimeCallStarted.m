...
@implementation AWDFaceTimeCallStarted

- (void)dealloc
{
  [(AWDFaceTimeCallStarted *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallStarted;
  [(AWDFaceTimeCallStarted *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallStarted;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallStarted description](&v3, sel_description), -[AWDFaceTimeCallStarted dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallStartedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_5:
  ...
  *((_DWORD *)a3 + 8) = self->_isToPhoneNumber;
...
LABEL_14:
  *((_DWORD *)a3 + 6) = self->_isCallUpgrade;
...
LABEL_3:
  ...
  *(_DWORD *)(v5 + 32) = self->_isToPhoneNumber;
...
LABEL_12:
  *(_DWORD *)(v5 + 24) = self->_isCallUpgrade;
...
LABEL_33:
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 8) == 0 || self->_isToPhoneNumber != *((_DWORD *)a3 + 8)) {
          goto LABEL_33;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 4) == 0 || self->_isToEmail != *((_DWORD *)a3 + 7)) {
          goto LABEL_33;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 2) == 0 || self->_isCallUpgrade != *((_DWORD *)a3 + 6)) {
          goto LABEL_33;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 0x10) == 0 || self->_isVideo != *((_DWORD *)a3 + 9)) {
          goto LABEL_33;
        }
      }
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
LABEL_3:
      uint64_t v5 = 2654435761 * self->_isToPhoneNumber;
      if ((*(unsigned char *)&self->_has & 4) != 0) {
        goto LABEL_4;
      }
      goto LABEL_10;
  ...
  {
LABEL_4:
    uint64_t v6 = 2654435761 * self->_isToEmail;
    if ((*(unsigned char *)&self->_has & 2) != 0) {
      goto LABEL_5;
    }
    goto LABEL_11;
...
LABEL_10:
  ...
  {
LABEL_5:
    uint64_t v7 = 2654435761 * self->_isCallUpgrade;
    if ((*(unsigned char *)&self->_has & 0x10) != 0) {
      goto LABEL_6;
    }
LABEL_12:
...
{
  if (*((void *)a3 + 2)) {
    -[AWDFaceTimeCallStarted setGuid:](self, "setGuid:");
  }
...
LABEL_5:
  ...
  self->_isToPhoneNumber = *((_DWORD *)a3 + 8);
  *(unsigned char *)&self->_has |= 8u;
  char v5 = *((unsigned char *)a3 + 44);
  if ((v5 & 4) == 0)
  {
...
LABEL_14:
  self->_isCallUpgrade = *((_DWORD *)a3 + 6);
  *(unsigned char *)&self->_has |= 2u;
  char v5 = *((unsigned char *)a3 + 44);
  if ((v5 & 0x10) == 0)
  {
