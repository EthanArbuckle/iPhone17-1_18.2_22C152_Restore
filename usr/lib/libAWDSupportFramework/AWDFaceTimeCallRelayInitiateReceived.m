...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateReceived;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayInitiateReceived;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallRelayInitiateReceived description](&v3, sel_description), -[AWDFaceTimeCallRelayInitiateReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallRelayInitiateReceivedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 2)) {
    -[AWDFaceTimeCallRelayInitiateReceived setGuid:](self, "setGuid:");
  }
