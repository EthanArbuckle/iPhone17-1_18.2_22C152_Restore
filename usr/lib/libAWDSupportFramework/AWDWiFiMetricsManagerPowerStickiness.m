...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWiFiMetricsManagerPowerStickiness description](&v3, sel_description), -[AWDWiFiMetricsManagerPowerStickiness dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_7:
    [v3 setObject:[NSNumber numberWithUnsignedInt:self->_enabled] forKey:@"enabled"];
...
LABEL_4:
    ...
    [v3 setObject:[NSNumber numberWithUnsignedInt:self->_stickiness] forKey:@"stickiness"];
  return v3;
}
...
LABEL_16:
    ...
    if ((*(unsigned char *)&self->_has & 2) != 0)
    {
      if ((*((unsigned char *)a3 + 24) & 2) == 0 || self->_enabled != *((_DWORD *)a3 + 4)) {
        goto LABEL_16;
      }
    }
    ...
    if ((*(unsigned char *)&self->_has & 4) != 0)
    {
      if ((*((unsigned char *)a3 + 24) & 4) == 0 || self->_stickiness != *((_DWORD *)a3 + 5)) {
        goto LABEL_16;
      }
      LOBYTE(v5) = 1;
    }
...
LABEL_4:
  uint64_t v4 = 2654435761 * self->_stickiness;
  return v3 ^ v2 ^ v4;
}
