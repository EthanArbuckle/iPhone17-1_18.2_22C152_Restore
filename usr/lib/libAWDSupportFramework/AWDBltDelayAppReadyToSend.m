...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayAppReadyToSend;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayAppReadyToSend;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDBltDelayAppReadyToSend description](&v3, sel_description), -[AWDBltDelayAppReadyToSend dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDBltDelayAppReadyToSendReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 3)) {
    -[AWDBltDelayAppReadyToSend setUniqueid:](self, "setUniqueid:");
  }
