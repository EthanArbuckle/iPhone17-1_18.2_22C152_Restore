...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallAcceptSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallAcceptSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallAcceptSent description](&v3, sel_description), -[AWDFaceTimeCallAcceptSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallAcceptSentReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 3)) {
    -[AWDFaceTimeCallAcceptSent setGuid:](self, "setGuid:");
  }
