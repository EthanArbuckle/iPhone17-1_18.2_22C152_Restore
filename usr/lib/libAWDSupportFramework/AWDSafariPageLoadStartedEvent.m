...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDSafariPageLoadStartedEvent description](&v3, sel_description), -[AWDSafariPageLoadStartedEvent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_16:
    ...
    {
      if ((*((unsigned char *)a3 + 32) & 1) == 0 || self->_configurationID != *((void *)a3 + 1)) {
        goto LABEL_16;
      }
    }
    ...
    if ((*(unsigned char *)&self->_has & 2) != 0)
    {
      if ((*((unsigned char *)a3 + 32) & 2) == 0 || self->_pageID != *((void *)a3 + 2)) {
        goto LABEL_16;
      }
      LOBYTE(v5) = 1;
    }
