...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDWifiAwdlHistogramBin;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWifiAwdlHistogramBin description](&v3, sel_description), -[AWDWifiAwdlHistogramBin dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDWifiAwdlHistogramBinReadFrom((uint64_t)self, (uint64_t)a3);
}
