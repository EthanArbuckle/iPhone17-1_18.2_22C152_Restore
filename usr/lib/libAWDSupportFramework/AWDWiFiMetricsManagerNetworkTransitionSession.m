...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiMetricsManagerNetworkTransitionSession;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiMetricsManagerNetworkTransitionSession;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWiFiMetricsManagerNetworkTransitionSession description](&v3, sel_description), -[AWDWiFiMetricsManagerNetworkTransitionSession dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDWiFiMetricsManagerNetworkTransitionSessionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [a3 clearRecords];
    unint64_t v5 = [(AWDWiFiMetricsManagerNetworkTransitionSession *)self recordsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
        [a3 addRecords:-[AWDWiFiMetricsManagerNetworkTransitionSession recordsAtIndex:](self, "recordsAtIndex:", i)];
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDWiFiMetricsManagerNetworkTransitionSession *)self addRecords:*(void *)(*((void *)&v9 + 1) + 8 * v8++)];
      }
      while (v6 != v8);
