...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDCoreRoutinePersistenceMirroringDelegate description](&v3, sel_description), -[AWDCoreRoutinePersistenceMirroringDelegate dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_7:
    [v3 setObject:[NSNumber numberWithBool:self->_mirroringDelegatePresent] forKey:@"mirroringDelegatePresent"];
...
LABEL_4:
    ...
    [v3 setObject:[NSNumber numberWithInt:self->_creationFailureReason] forKey:@"creationFailureReason"];
  return v3;
}
...
LABEL_7:
  ...
  *((unsigned char *)a3 + 20) = self->_mirroringDelegatePresent;
...
LABEL_3:
  ...
  *((unsigned char *)result + 20) = self->_mirroringDelegatePresent;
...
LABEL_15:
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)a3 + 24) & 2) == 0 || self->_creationFailureReason != *((_DWORD *)a3 + 4)) {
      goto LABEL_19;
    }
    LOBYTE(v5) = 1;
  }
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_mirroringDelegatePresent;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
    goto LABEL_7;
  }
LABEL_4:
  uint64_t v4 = 2654435761 * self->_creationFailureReason;
  return v3 ^ v2 ^ v4;
}
...
LABEL_7:
  ...
  self->_mirroringDelegatePresent = *((unsigned char *)a3 + 20);
  *(unsigned char *)&self->_has |= 4u;
