...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDNwExclusionCount description](&v3, sel_description), -[AWDNwExclusionCount dictionaryRepresentation](self, "dictionaryRepresentation")];
}
