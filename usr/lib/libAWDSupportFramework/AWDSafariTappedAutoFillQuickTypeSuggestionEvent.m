...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDSafariTappedAutoFillQuickTypeSuggestionEvent description](&v3, sel_description), -[AWDSafariTappedAutoFillQuickTypeSuggestionEvent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
