...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDLibnetcoreTCPTFOStatsReport description](&v3, sel_description), -[AWDLibnetcoreTCPTFOStatsReport dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_51:
    ...
    {
      if ((*((_WORD *)a3 + 44) & 0x200) == 0 || self->_numTfoSynDataSent != *((void *)a3 + 10)) {
        goto LABEL_51;
      }
    }
    ...
    {
      if ((*((_WORD *)a3 + 44) & 0x100) == 0 || self->_numTfoSynDataRcv != *((void *)a3 + 9)) {
        goto LABEL_51;
      }
    }
...
- (unint64_t)hash
{
  ...
  if ((has & 8) != 0)
  {
    unint64_t v3 = 2654435761u * self->_numTfoCookieReq;
    if ((has & 4) != 0)
    {
LABEL_3:
      unint64_t v4 = 2654435761u * self->_numTfoCookieRcv;
      if ((has & 0x40) != 0) {
        goto LABEL_4;
      }
      goto LABEL_14;
  ...
  {
LABEL_4:
    unint64_t v5 = 2654435761u * self->_numTfoFallback;
    if ((*(_WORD *)&self->_has & 0x200) != 0) {
      goto LABEL_5;
    }
    goto LABEL_15;
...
LABEL_14:
  ...
  {
LABEL_5:
    unint64_t v6 = 2654435761u * self->_numTfoSynDataSent;
    if ((has & 0x80) != 0) {
      goto LABEL_6;
    }
    goto LABEL_16;
...
LABEL_15:
  ...
  {
LABEL_6:
    unint64_t v7 = 2654435761u * self->_numTfoSynDataAcked;
    if ((*(_WORD *)&self->_has & 0x100) != 0) {
      goto LABEL_7;
    }
    goto LABEL_17;
...
LABEL_16:
  ...
  {
LABEL_7:
    unint64_t v8 = 2654435761u * self->_numTfoSynDataRcv;
    if ((has & 0x10) != 0) {
      goto LABEL_8;
    }
    goto LABEL_18;
...
LABEL_17:
  ...
  {
LABEL_8:
    unint64_t v9 = 2654435761u * self->_numTfoCookieReqRcv;
    if ((has & 0x20) != 0) {
      goto LABEL_9;
    }
    goto LABEL_19;
...
LABEL_18:
  ...
  {
LABEL_9:
    unint64_t v10 = 2654435761u * self->_numTfoCookieSent;
    if ((has & 2) != 0) {
      goto LABEL_10;
    }
LABEL_20:
...
LABEL_10:
  unint64_t v11 = 2654435761u * self->_numTfoCookieInvalid;
  if ((has & 1) == 0) {
    goto LABEL_21;
  }
LABEL_11:
  unint64_t v12 = 2654435761u * self->_numTfoBlackholed;
  return v4 ^ v3 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10 ^ v11 ^ v12;
}
