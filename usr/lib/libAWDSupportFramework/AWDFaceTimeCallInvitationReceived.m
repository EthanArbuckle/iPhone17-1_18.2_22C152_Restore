...
- (void)dealloc
{
  [(AWDFaceTimeCallInvitationReceived *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationReceived;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationReceived;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallInvitationReceived description](&v3, sel_description), -[AWDFaceTimeCallInvitationReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallInvitationReceivedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 2)) {
    -[AWDFaceTimeCallInvitationReceived setGuid:](self, "setGuid:");
  }
