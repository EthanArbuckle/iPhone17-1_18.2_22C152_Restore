...
- (void)dealloc
{
  [(AWDFaceTimeCallInvitationSent *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallInvitationSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallInvitationSent description](&v3, sel_description), -[AWDFaceTimeCallInvitationSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallInvitationSentReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 3)) {
    -[AWDFaceTimeCallInvitationSent setGuid:](self, "setGuid:");
  }
