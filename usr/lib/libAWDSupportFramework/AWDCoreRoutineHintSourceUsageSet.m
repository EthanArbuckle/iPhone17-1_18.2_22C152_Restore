...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineHintSourceUsageSet;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineHintSourceUsageSet;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDCoreRoutineHintSourceUsageSet description](&v3, sel_description), -[AWDCoreRoutineHintSourceUsageSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDCoreRoutineHintSourceUsageSetReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [a3 clearInstances];
    unint64_t v5 = [(AWDCoreRoutineHintSourceUsageSet *)self instancesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
        [a3 addInstance:-[AWDCoreRoutineHintSourceUsageSet instanceAtIndex:](self, "instanceAtIndex:", i)];
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineHintSourceUsageSet *)self addInstance:*(void *)(*((void *)&v9 + 1) + 8 * v8++)];
      }
      while (v6 != v8);
