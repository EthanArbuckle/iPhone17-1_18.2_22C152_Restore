...
- (int)StringAsWakeStatus:(id)a3
{
  ...
  if ([a3 isEqualToString:@"Wake"]) {
    return 1;
  }
  if ([a3 isEqualToString:@"NoWake"]) {
    return 2;
  }
  return 0;
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDPushReceived;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDPushReceived description](&v3, sel_description), -[AWDPushReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_11:
  ...
  if ((*(unsigned char *)&self->_has & 0x80000000) != 0)
  {
    uint64_t wakeStatus = self->_wakeStatus;
    if (wakeStatus >= 3) {
      v9 = (__CFString *)[NSString stringWithFormat:@"(unknown: %i)", self->_wakeStatus];
    }
    else {
      v9 = off_2641B9C80[wakeStatus];
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!((unint64_t)guid | *((void *)a3 + 3)) || (int v5 = -[NSString isEqual:](guid, "isEqual:")) != 0)
    {
      ...
      if (has)
      {
        if ((*((unsigned char *)a3 + 60) & 1) == 0 || self->_timestamp != *((void *)a3 + 1)) {
          goto LABEL_47;
        }
      }
...
LABEL_47:
      ...
      {
        if ((*((unsigned char *)a3 + 60) & 2) == 0 || self->_connectionType != *((_DWORD *)a3 + 4)) {
          goto LABEL_47;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 60) & 0x10) == 0 || self->_linkQuality != *((_DWORD *)a3 + 9)) {
          goto LABEL_47;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 60) & 0x40) == 0 || self->_receiveOffset != *((_DWORD *)a3 + 11)) {
          goto LABEL_47;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 60) & 0x20) == 0 || self->_payloadSize != *((_DWORD *)a3 + 10)) {
          goto LABEL_47;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 60) & 8) == 0 || self->_isFromStorage != *((_DWORD *)a3 + 8)) {
          goto LABEL_47;
        }
      }
      ...
      if ((*(unsigned char *)&self->_has & 4) != 0)
      {
        if ((*((unsigned char *)a3 + 60) & 4) == 0 || self->_dualChannelState != *((_DWORD *)a3 + 5)) {
          goto LABEL_47;
        }
      }
...
LABEL_3:
  ...
  {
LABEL_4:
    uint64_t v5 = 2654435761 * self->_linkQuality;
    if ((*(unsigned char *)&self->_has & 0x40) != 0) {
      goto LABEL_5;
    }
    goto LABEL_11;
...
LABEL_10:
  ...
  {
LABEL_5:
    uint64_t v6 = 2654435761 * self->_receiveOffset;
    if ((*(unsigned char *)&self->_has & 0x20) != 0) {
      goto LABEL_6;
    }
LABEL_12:
...
LABEL_6:
  ...
  {
LABEL_7:
    uint64_t v8 = 2654435761 * self->_isFromStorage;
    goto LABEL_14;
  }
LABEL_13:
  uint64_t v8 = 0;
LABEL_14:
  ...
  NSUInteger v11 = [(NSString *)self->_topic hash];
  if ((*(unsigned char *)&self->_has & 0x80000000) != 0) {
    uint64_t v12 = 2654435761 * self->_wakeStatus;
  }
  else {
    uint64_t v12 = 0;
  }
...
LABEL_11:
  ...
  if (*((char *)a3 + 60) < 0)
  {
    self->_uint64_t wakeStatus = *((_DWORD *)a3 + 14);
    *(unsigned char *)&self->_has |= 0x80u;
  }
}
