...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDEventKitSyncSyncedEventCreatedOnWatch;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDEventKitSyncSyncedEventCreatedOnWatch description](&v3, sel_description), -[AWDEventKitSyncSyncedEventCreatedOnWatch dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDEventKitSyncSyncedEventCreatedOnWatchReadFrom((uint64_t)self, (uint64_t)a3);
}
