...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDNanoPhoneIncomingCallPresented;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDNanoPhoneIncomingCallPresented description](&v3, sel_description), -[AWDNanoPhoneIncomingCallPresented dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (id)dictionaryRepresentation
{
  ...
  if (has) {
    [v3 setObject:[NSNumber numberWithUnsignedLongLong:self->_clientDisplayLatencyMs] forKey:@"clientDisplayLatencyMs"];
  }
...
- (void)copyTo:(id)a3
{
  ...
  if (has)
  {
    *((void *)a3 + 1) = self->_clientDisplayLatencyMs;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (has)
  {
    *(void *)(v5 + 8) = self->_clientDisplayLatencyMs;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)a3 + 36) & 1) == 0 || self->_clientDisplayLatencyMs != *((void *)a3 + 1)) {
      goto LABEL_25;
    }
  }
...
- (unint64_t)hash
{
  ...
  else
  {
    ...
    {
LABEL_3:
      unint64_t v4 = 2654435761u * self->_clientDisplayLatencyMs;
      goto LABEL_6;
    }
  }
  unint64_t v4 = 0;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    self->_clientDisplayLatencyMs = *((void *)a3 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
  if (*((void *)a3 + 3)) {
