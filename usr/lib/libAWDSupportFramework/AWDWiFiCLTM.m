...
@implementation AWDWiFiCLTM

- (void)dealloc
{
  [(AWDWiFiCLTM *)self setSliceStats:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiCLTM;
  [(AWDWiFiCLTM *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiCLTM;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWiFiCLTM description](&v3, sel_description), -[AWDWiFiCLTM dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDWiFiCLTMReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(AWDWiFiCLTM *)self sliceStatsCount])
  {
    [a3 clearSliceStats];
    unint64_t v5 = [(AWDWiFiCLTM *)self sliceStatsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
        [a3 addSliceStats:-[AWDWiFiCLTM sliceStatsAtIndex:](self, "sliceStatsAtIndex:", i)];
    }
  }
}
...
LABEL_9:
    ...
    sliceStats = self->_sliceStats;
    if ((unint64_t)sliceStats | *((void *)a3 + 2))
    {
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_sliceStats hash] ^ v2;
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDWiFiCLTM *)self addSliceStats:*(void *)(*((void *)&v9 + 1) + 8 * v8++)];
      }
      while (v6 != v8);
