...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDWiFiUsageSnapshot;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWiFiUsageSnapshot description](&v3, sel_description), -[AWDWiFiUsageSnapshot dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDWiFiUsageSnapshotReadFrom((uint64_t)self, (uint64_t)a3);
}
