...
- (void)setDeclineCode:(unsigned int)a3;
- (void)setErrorCode:(int)a3;
- (void)setGuid:(id)a3;
- (void)setHasDeclineCode:(BOOL)a3;
...
@implementation AWDFaceTimeCallDeclineSent

- (void)dealloc
{
  [(AWDFaceTimeCallDeclineSent *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallDeclineSent;
  [(AWDFaceTimeCallDeclineSent *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallDeclineSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallDeclineSent description](&v3, sel_description), -[AWDFaceTimeCallDeclineSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_13:
  [v4 setObject:[NSNumber numberWithUnsignedInt:self->_declineCode] forKey:@"declineCode"];
  char has = (char)self->_has;
  if ((has & 0x20) == 0)
  {
LABEL_7:
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallDeclineSentReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_11:
  *(_DWORD *)(v5 + 16) = self->_declineCode;
...
LABEL_33:
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 2) == 0 || self->_declineCode != *((_DWORD *)a3 + 4)) {
          goto LABEL_33;
        }
      }
...
LABEL_3:
  ...
  {
LABEL_4:
    uint64_t v6 = 2654435761 * self->_declineCode;
    if ((*(unsigned char *)&self->_has & 0x20) != 0) {
      goto LABEL_5;
    }
    goto LABEL_11;
...
{
  if (*((void *)a3 + 3)) {
    -[AWDFaceTimeCallDeclineSent setGuid:](self, "setGuid:");
  }
