@interface AWDIDSSessionReinitiateRequested
- (BOOL)hasGuid;
- (BOOL)hasTimestamp;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (void)dealloc
{
  [(AWDIDSSessionReinitiateRequested *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionReinitiateRequested;
  [(AWDIDSSessionReinitiateRequested *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionReinitiateRequested;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSSessionReinitiateRequested description](&v3, sel_description), -[AWDIDSSessionReinitiateRequested dictionaryRepresentation](self, "dictionaryRepresentation")];
}
