...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSWiProxDidDisconnectFromPeer;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSWiProxDidDisconnectFromPeer description](&v3, sel_description), -[AWDIDSWiProxDidDisconnectFromPeer dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDIDSWiProxDidDisconnectFromPeerReadFrom((uint64_t)self, (uint64_t)a3);
}
