...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSLocalDeliveryMessageSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSLocalDeliveryMessageSent description](&v3, sel_description), -[AWDIDSLocalDeliveryMessageSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDIDSLocalDeliveryMessageSentReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 6)) {
    -[AWDIDSLocalDeliveryMessageSent setService:](self, "setService:");
  }
