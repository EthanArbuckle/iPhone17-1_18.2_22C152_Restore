...
@implementation AWDSafariContactAutoFillDidFillCustomContactSetEvent
...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDSafariContactAutoFillDidFillCustomContactSetEvent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDSafariContactAutoFillDidFillCustomContactSetEvent description](&v3, sel_description), -[AWDSafariContactAutoFillDidFillCustomContactSetEvent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDSafariContactAutoFillDidFillCustomContactSetEventReadFrom((uint64_t)self, (uint64_t)a3);
}
