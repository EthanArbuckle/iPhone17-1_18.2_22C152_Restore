...
- (void)dealloc
{
  [(AWDFaceTimeCallAcceptReceived *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallAcceptReceived;
  [(AWDFaceTimeCallAcceptReceived *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallAcceptReceived;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallAcceptReceived description](&v3, sel_description), -[AWDFaceTimeCallAcceptReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
