...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDPushReceivedSlow;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDPushReceivedSlow description](&v3, sel_description), -[AWDPushReceivedSlow dictionaryRepresentation](self, "dictionaryRepresentation")];
}
