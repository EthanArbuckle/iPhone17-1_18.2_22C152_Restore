...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSSessionEnded;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSSessionEnded description](&v3, sel_description), -[AWDIDSSessionEnded dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (id)dictionaryRepresentation
{
  ...
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
...
LABEL_31:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_gameKitError] forKey:@"gameKitError"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(unsigned char *)&has & 4) == 0)
  {
LABEL_9:
...
LABEL_32:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_conferenceMiscError] forKey:@"conferenceMiscError"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(unsigned char *)&has & 2) == 0)
  {
LABEL_10:
...
LABEL_37:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_networkCheckResult] forKey:@"networkCheckResult"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(unsigned char *)&has & 0x40) == 0)
  {
LABEL_15:
...
LABEL_38:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_dataRate] forKey:@"dataRate"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(_WORD *)&has & 0x400) == 0)
  {
LABEL_16:
...
LABEL_39:
  [v3 setObject:[NSNumber numberWithInt:self->_gksError] forKey:@"gksError"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(unsigned char *)&has & 8) == 0)
  {
LABEL_17:
...
LABEL_40:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_connectDuration] forKey:@"connectDuration"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(_DWORD *)&has & 0x200000) == 0)
  {
LABEL_18:
...
LABEL_41:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_remoteNetworkConnection] forKey:@"remoteNetworkConnection"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(_DWORD *)&has & 0x20000) == 0)
  {
LABEL_19:
...
LABEL_42:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_localNetworkConnection] forKey:@"localNetworkConnection"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(unsigned char *)&has & 0x10) == 0)
  {
LABEL_20:
...
LABEL_44:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_usesRelay] forKey:@"usesRelay"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(unsigned char *)&has & 0x20) == 0)
  {
LABEL_22:
...
LABEL_45:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_currentNatType] forKey:@"currentNatType"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(_DWORD *)&has & 0x100000) == 0)
  {
LABEL_23:
...
LABEL_46:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_remoteNatType] forKey:@"remoteNatType"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(_DWORD *)&has & 0x80000) == 0)
  {
LABEL_24:
...
LABEL_47:
  [v3 setObject:[NSNumber numberWithUnsignedInt:self->_relayConnectDuration] forKey:@"relayConnectDuration"];
  $6D1A0C2979084AACDB0C3EE8EF011343 has = self->_has;
  if ((*(_WORD *)&has & 0x1000) == 0)
  {
LABEL_25:
...
LABEL_27:
    ...
    [v3 setObject:[NSNumber numberWithInt:self->_gksReturnCode] forKey:@"gksReturnCode"];
  return v3;
}
...
- (unint64_t)hash
{
  ...
  if ((*(unsigned char *)&has & 0x80) != 0)
  {
    uint64_t v6 = 2654435761 * self->_endedReason;
    if ((*(_WORD *)&has & 0x200) != 0)
    {
LABEL_6:
      uint64_t v7 = 2654435761 * self->_genericError;
      if ((*(_WORD *)&has & 0x100) != 0) {
        goto LABEL_7;
      }
      goto LABEL_29;
  ...
  {
LABEL_7:
    uint64_t v8 = 2654435761 * self->_gameKitError;
    if ((*(unsigned char *)&has & 4) != 0) {
      goto LABEL_8;
    }
    goto LABEL_30;
...
LABEL_29:
  ...
  {
LABEL_8:
    uint64_t v9 = 2654435761 * self->_conferenceMiscError;
    if ((*(unsigned char *)&has & 2) != 0) {
      goto LABEL_9;
    }
    goto LABEL_31;
...
LABEL_30:
  ...
  {
LABEL_9:
    uint64_t v10 = 2654435761 * self->_callDuration;
    if ((*(_WORD *)&has & 0x4000) != 0) {
      goto LABEL_10;
    }
    goto LABEL_32;
...
LABEL_31:
  ...
  {
LABEL_10:
    uint64_t v11 = 2654435761 * self->_isNetworkEnabled;
    if ((*(_WORD *)&has & 0x2000) != 0) {
      goto LABEL_11;
    }
    goto LABEL_33;
...
LABEL_32:
  ...
  {
LABEL_11:
    uint64_t v12 = 2654435761 * self->_isNetworkActive;
    if ((*(_WORD *)&has & 0x8000) != 0) {
      goto LABEL_12;
    }
    goto LABEL_34;
...
LABEL_33:
  ...
  {
LABEL_12:
    uint64_t v13 = 2654435761 * self->_isNetworkReachable;
    if ((*(_DWORD *)&has & 0x40000) != 0) {
      goto LABEL_13;
    }
    goto LABEL_35;
...
LABEL_34:
  ...
  {
LABEL_13:
    uint64_t v14 = 2654435761 * self->_networkCheckResult;
    if ((*(unsigned char *)&has & 0x40) != 0) {
      goto LABEL_14;
    }
    goto LABEL_36;
...
LABEL_35:
  ...
  {
LABEL_14:
    uint64_t v15 = 2654435761 * self->_dataRate;
    if ((*(_WORD *)&has & 0x400) != 0) {
      goto LABEL_15;
    }
    goto LABEL_37;
...
LABEL_36:
  ...
  {
LABEL_15:
    uint64_t v16 = 2654435761 * self->_gksError;
    if ((*(unsigned char *)&has & 8) != 0) {
      goto LABEL_16;
    }
    goto LABEL_38;
...
LABEL_37:
  ...
  {
LABEL_16:
    uint64_t v17 = 2654435761 * self->_connectDuration;
    if ((*(_DWORD *)&has & 0x200000) != 0) {
      goto LABEL_17;
    }
    goto LABEL_39;
...
LABEL_38:
  ...
  {
LABEL_17:
    uint64_t v18 = 2654435761 * self->_remoteNetworkConnection;
    if ((*(_DWORD *)&has & 0x20000) != 0) {
      goto LABEL_18;
    }
    goto LABEL_40;
...
LABEL_39:
  ...
  {
LABEL_18:
    uint64_t v19 = 2654435761 * self->_localNetworkConnection;
    if ((*(unsigned char *)&has & 0x10) != 0) {
      goto LABEL_19;
    }
    goto LABEL_41;
...
LABEL_40:
  ...
  {
LABEL_19:
    uint64_t v20 = 2654435761 * self->_connectionType;
    if ((*(_DWORD *)&has & 0x400000) != 0) {
      goto LABEL_20;
    }
    goto LABEL_42;
...
LABEL_41:
  ...
  {
LABEL_20:
    uint64_t v21 = 2654435761 * self->_usesRelay;
    if ((*(unsigned char *)&has & 0x20) != 0) {
      goto LABEL_21;
    }
    goto LABEL_43;
...
LABEL_42:
  ...
  {
LABEL_21:
    uint64_t v22 = 2654435761 * self->_currentNatType;
    if ((*(_DWORD *)&has & 0x100000) != 0) {
      goto LABEL_22;
    }
    goto LABEL_44;
...
LABEL_43:
  ...
  {
LABEL_22:
    uint64_t v23 = 2654435761 * self->_remoteNatType;
    if ((*(_DWORD *)&has & 0x80000) != 0) {
      goto LABEL_23;
    }
    goto LABEL_45;
...
LABEL_44:
  ...
  {
LABEL_23:
    uint64_t v24 = 2654435761 * self->_relayConnectDuration;
    if ((*(_WORD *)&has & 0x1000) != 0) {
      goto LABEL_24;
    }
    goto LABEL_46;
...
LABEL_45:
  ...
  {
LABEL_24:
    uint64_t v25 = 2654435761 * self->_isInitiator;
    if ((*(_DWORD *)&has & 0x10000) != 0) {
      goto LABEL_25;
    }
LABEL_47:
