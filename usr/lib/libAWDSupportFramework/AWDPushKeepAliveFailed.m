...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDPushKeepAliveFailed;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDPushKeepAliveFailed description](&v3, sel_description), -[AWDPushKeepAliveFailed dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_18:
  [v4 setObject:[NSNumber numberWithInt:self->_error] forKey:@"error"];
  __int16 has = (__int16)self->_has;
  if ((has & 8) == 0)
  {
LABEL_8:
...
LABEL_15:
  ...
  {
LABEL_6:
    uint64_t v9 = 2654435761 * self->_dualChannelState;
    if ((has & 0x20) != 0) {
      goto LABEL_7;
    }
    goto LABEL_17;
...
LABEL_16:
  ...
  {
LABEL_7:
    uint64_t v10 = 2654435761 * self->_keepAliveVersion;
    if ((*(_WORD *)&self->_has & 0x200) != 0) {
      goto LABEL_8;
    }
    goto LABEL_18;
...
LABEL_17:
  ...
  {
LABEL_8:
    uint64_t v11 = 2654435761 * self->_timeSinceLastSuccessfulKeepAlive;
    if ((has & 0x40) != 0) {
      goto LABEL_9;
    }
    goto LABEL_19;
...
LABEL_18:
  ...
  {
LABEL_9:
    uint64_t v12 = 2654435761 * self->_lastKeepAliveInterval;
    if ((*(_WORD *)&self->_has & 0x100) != 0) {
      goto LABEL_10;
    }
LABEL_20:
...
LABEL_10:
  uint64_t v13 = 2654435761 * self->_timeSinceConnected;
  if ((has & 4) == 0) {
    goto LABEL_21;
  }
LABEL_11:
  uint64_t v14 = 2654435761 * self->_currentGrowthStage;
  return v5 ^ v3 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10 ^ v11 ^ v12 ^ v13 ^ v14;
}
