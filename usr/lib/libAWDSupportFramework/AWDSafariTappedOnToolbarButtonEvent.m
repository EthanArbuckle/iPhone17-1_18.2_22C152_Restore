...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDSafariTappedOnToolbarButtonEvent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDSafariTappedOnToolbarButtonEvent description](&v3, sel_description), -[AWDSafariTappedOnToolbarButtonEvent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDSafariTappedOnToolbarButtonEventReadFrom((uint64_t)self, (uint64_t)a3);
}
