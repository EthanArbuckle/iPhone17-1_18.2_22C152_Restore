...
@implementation AWDCoreRoutineModelClusterStandardDeviationSet

- (void)dealloc
{
  [(AWDCoreRoutineModelClusterStandardDeviationSet *)self setInstances:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineModelClusterStandardDeviationSet;
  [(AWDCoreRoutineModelClusterStandardDeviationSet *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDCoreRoutineModelClusterStandardDeviationSet;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelClusterStandardDeviationSet description](&v3, sel_description), -[AWDCoreRoutineModelClusterStandardDeviationSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDCoreRoutineModelClusterStandardDeviationSetReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(AWDCoreRoutineModelClusterStandardDeviationSet *)self instancesCount])
  {
    [a3 clearInstances];
    unint64_t v5 = [(AWDCoreRoutineModelClusterStandardDeviationSet *)self instancesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
        [a3 addInstance:-[AWDCoreRoutineModelClusterStandardDeviationSet instanceAtIndex:](self, "instanceAtIndex:", i)];
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineModelClusterStandardDeviationSet *)self addInstance:*(void *)(*((void *)&v9 + 1) + 8 * v8++)];
      }
      while (v6 != v8);
