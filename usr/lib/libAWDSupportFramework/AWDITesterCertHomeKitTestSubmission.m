...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestSubmission;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertHomeKitTestSubmission;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDITesterCertHomeKitTestSubmission description](&v3, sel_description), -[AWDITesterCertHomeKitTestSubmission dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDITesterCertHomeKitTestSubmissionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v6 + 40) = [(NSString *)self->_testUUID copyWithZone:a3];
...
LABEL_15:
      ...
      || (int v5 = -[NSString isEqual:](accessoryManufacturer, "isEqual:")) != 0)
    {
      ...
      {
        testUUID = self->_testUUID;
        if (!((unint64_t)testUUID | *((void *)a3 + 5))
          || (int v5 = -[NSString isEqual:](testUUID, "isEqual:")) != 0)
        {
          testName = self->_testName;
          if ((unint64_t)testName | *((void *)a3 + 4))
          {
...
- (unint64_t)hash
{
  ...
  NSUInteger v4 = [(NSString *)self->_accessoryManufacturer hash] ^ v3;
  NSUInteger v5 = [(NSString *)self->_accessoryName hash];
  NSUInteger v6 = v4 ^ v5 ^ [(NSString *)self->_testUUID hash];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 2)) {
    -[AWDITesterCertHomeKitTestSubmission setAccessoryManufacturer:](self, "setAccessoryManufacturer:");
  }
  if (*((void *)a3 + 3)) {
    -[AWDITesterCertHomeKitTestSubmission setAccessoryName:](self, "setAccessoryName:");
  }
  if (*((void *)a3 + 5)) {
    -[AWDITesterCertHomeKitTestSubmission setTestUUID:](self, "setTestUUID:");
  }
  if (*((void *)a3 + 4))
  {
    -[AWDITesterCertHomeKitTestSubmission setTestName:](self, "setTestName:");
  }
}
