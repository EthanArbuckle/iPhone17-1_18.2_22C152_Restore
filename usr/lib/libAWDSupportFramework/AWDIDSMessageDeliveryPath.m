...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSMessageDeliveryPath;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSMessageDeliveryPath description](&v3, sel_description), -[AWDIDSMessageDeliveryPath dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0) {
    [v3 setObject:[NSNumber numberWithUnsignedInt:self->_deliveryPathType] forKey:@"deliveryPathType"];
  }
  return v3;
}
...
LABEL_14:
    ...
    if ((has & 2) != 0)
    {
      if ((*((unsigned char *)a3 + 32) & 2) == 0 || self->_deliveryPathType != *((_DWORD *)a3 + 4)) {
        goto LABEL_14;
      }
      LOBYTE(v5) = 1;
    }
...
- (unint64_t)hash
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0) {
    uint64_t v5 = 2654435761 * self->_deliveryPathType;
  }
  else {
    uint64_t v5 = 0;
  }
