...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDPushProxyManagerSend;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDPushProxyManagerSend description](&v3, sel_description), -[AWDPushProxyManagerSend dictionaryRepresentation](self, "dictionaryRepresentation")];
}
