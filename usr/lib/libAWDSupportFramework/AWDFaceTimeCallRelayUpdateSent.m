...
@implementation AWDFaceTimeCallRelayUpdateSent

- (void)dealloc
{
  [(AWDFaceTimeCallRelayUpdateSent *)self setGuid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayUpdateSent;
  [(AWDFaceTimeCallRelayUpdateSent *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallRelayUpdateSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallRelayUpdateSent description](&v3, sel_description), -[AWDFaceTimeCallRelayUpdateSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDFaceTimeCallRelayUpdateSentReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_28:
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 2) == 0 || self->_errorCode != *((_DWORD *)a3 + 4)) {
          goto LABEL_28;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 0x10) == 0 || self->_sendDuration != *((_DWORD *)a3 + 10)) {
          goto LABEL_28;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 44) & 4) == 0 || self->_isVideo != *((_DWORD *)a3 + 8)) {
          goto LABEL_28;
        }
      }
      ...
      if ((*(unsigned char *)&self->_has & 8) != 0)
      {
        if ((*((unsigned char *)a3 + 44) & 8) == 0 || self->_onLockScreen != *((_DWORD *)a3 + 9)) {
          goto LABEL_28;
        }
        LOBYTE(v5) = 1;
      }
...
LABEL_3:
  ...
  {
LABEL_4:
    uint64_t v6 = 2654435761 * self->_sendDuration;
    if ((*(unsigned char *)&self->_has & 4) != 0) {
      goto LABEL_5;
    }
LABEL_10:
...
LABEL_5:
  uint64_t v7 = 2654435761 * self->_isVideo;
  if ((*(unsigned char *)&self->_has & 8) == 0) {
    goto LABEL_11;
  }
LABEL_6:
  uint64_t v8 = 2654435761 * self->_onLockScreen;
  return v4 ^ v3 ^ v5 ^ v6 ^ v7 ^ v8;
}
...
{
  if (*((void *)a3 + 3)) {
    -[AWDFaceTimeCallRelayUpdateSent setGuid:](self, "setGuid:");
  }
