@interface AWDBltDelayUIFromFactory
- (BOOL)hasDelayMs;
- (BOOL)hasTimestamp;
- (BOOL)hasUniqueid;
- (BOOL)isEqual:(id)a3;
...
@implementation AWDBltDelayUIFromFactory

- (void)dealloc
{
  [(AWDBltDelayUIFromFactory *)self setUniqueid:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayUIFromFactory;
  [(AWDBltDelayUIFromFactory *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayUIFromFactory;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDBltDelayUIFromFactory description](&v3, sel_description), -[AWDBltDelayUIFromFactory dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDBltDelayUIFromFactoryReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 3)) {
    -[AWDBltDelayUIFromFactory setUniqueid:](self, "setUniqueid:");
  }
