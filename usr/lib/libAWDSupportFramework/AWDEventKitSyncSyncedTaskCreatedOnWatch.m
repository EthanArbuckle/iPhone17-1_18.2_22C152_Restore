@interface AWDEventKitSyncSyncedTaskCreatedOnWatch
...
@implementation AWDEventKitSyncSyncedTaskCreatedOnWatch
...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDEventKitSyncSyncedTaskCreatedOnWatch;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDEventKitSyncSyncedTaskCreatedOnWatch description](&v3, sel_description), -[AWDEventKitSyncSyncedTaskCreatedOnWatch dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDEventKitSyncSyncedTaskCreatedOnWatchReadFrom((uint64_t)self, (uint64_t)a3);
}
