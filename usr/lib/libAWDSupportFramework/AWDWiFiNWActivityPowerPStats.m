...
- (id)description
{
  ...
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDWiFiNWActivityPowerPStats description](&v3, sel_description), -[AWDWiFiNWActivityPowerPStats dictionaryRepresentation](self, "dictionaryRepresentation")];
}
