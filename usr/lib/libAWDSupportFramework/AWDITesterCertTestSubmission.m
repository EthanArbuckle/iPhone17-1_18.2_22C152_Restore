@interface AWDITesterCertTestSubmission
...
- (void)dealloc
{
  [(AWDITesterCertTestSubmission *)self setTestName:0];
  [(AWDITesterCertTestSubmission *)self setAccessoryName:0];
  [(AWDITesterCertTestSubmission *)self setAccessoryType:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertTestSubmission;
  [(AWDITesterCertTestSubmission *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDITesterCertTestSubmission;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDITesterCertTestSubmission description](&v3, sel_description), -[AWDITesterCertTestSubmission dictionaryRepresentation](self, "dictionaryRepresentation")];
}
