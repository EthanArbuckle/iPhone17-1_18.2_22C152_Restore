...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDBltDelayToPrimaryDevice;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDBltDelayToPrimaryDevice description](&v3, sel_description), -[AWDBltDelayToPrimaryDevice dictionaryRepresentation](self, "dictionaryRepresentation")];
}
