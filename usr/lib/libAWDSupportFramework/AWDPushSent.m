...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDPushSent;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDPushSent description](&v3, sel_description), -[AWDPushSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_18:
  [v4 setObject:[NSNumber numberWithUnsignedInt:self->_flushes] forKey:@"flushes"];
  char has = (char)self->_has;
  if ((has & 0x80) == 0)
  {
LABEL_8:
...
LABEL_10:
  ...
  *(void *)(v5 + 56) = [(NSString *)self->_topic copyWithZone:a3];
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!((unint64_t)guid | *((void *)a3 + 4)) || (int v5 = -[NSString isEqual:](guid, "isEqual:")) != 0)
    {
      ...
      {
        if ((*((unsigned char *)a3 + 64) & 2) == 0 || self->_connectionType != *((_DWORD *)a3 + 4)) {
          goto LABEL_46;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 64) & 0x20) == 0 || self->_linkQuality != *((_DWORD *)a3 + 10)) {
          goto LABEL_46;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 64) & 0x10) == 0 || self->_flushes != *((_DWORD *)a3 + 7)) {
          goto LABEL_46;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 64) & 0x80) == 0 || self->_sendDuration != *((_DWORD *)a3 + 12)) {
          goto LABEL_46;
        }
      }
...
LABEL_46:
      ...
      {
        if ((*((unsigned char *)a3 + 64) & 0x40) == 0 || self->_payloadSize != *((_DWORD *)a3 + 11)) {
          goto LABEL_46;
        }
      }
      ...
      {
        if ((*((unsigned char *)a3 + 64) & 8) == 0 || self->_error != *((_DWORD *)a3 + 6)) {
          goto LABEL_46;
        }
      }
      ...
      if ((*(unsigned char *)&self->_has & 4) != 0)
      {
        if ((*((unsigned char *)a3 + 64) & 4) == 0 || self->_dualChannelState != *((_DWORD *)a3 + 5)) {
          goto LABEL_46;
        }
      }
...
LABEL_12:
  ...
  {
LABEL_5:
    uint64_t v7 = 2654435761 * self->_flushes;
    if ((*(unsigned char *)&self->_has & 0x80) != 0) {
      goto LABEL_6;
    }
    goto LABEL_14;
...
LABEL_13:
  ...
  {
LABEL_6:
    uint64_t v8 = 2654435761 * self->_sendDuration;
    if ((*(unsigned char *)&self->_has & 0x40) != 0) {
      goto LABEL_7;
    }
    goto LABEL_15;
...
LABEL_14:
  ...
  {
LABEL_7:
    uint64_t v9 = 2654435761 * self->_payloadSize;
    if ((*(unsigned char *)&self->_has & 8) != 0) {
      goto LABEL_8;
    }
LABEL_16:
...
LABEL_8:
  uint64_t v10 = 2654435761 * self->_error;
  if ((*(unsigned char *)&self->_has & 4) == 0) {
    goto LABEL_17;
  }
LABEL_9:
