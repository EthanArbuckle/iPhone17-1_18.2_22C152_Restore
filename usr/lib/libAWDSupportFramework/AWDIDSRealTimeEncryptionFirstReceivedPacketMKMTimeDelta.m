...
@implementation AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta

- (void)dealloc
{
  [(AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta *)self setServiceName:0];
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta;
  [(AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta description](&v3, sel_description), -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDeltaReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 4)) {
    -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta setServiceName:](self, "setServiceName:");
  }
