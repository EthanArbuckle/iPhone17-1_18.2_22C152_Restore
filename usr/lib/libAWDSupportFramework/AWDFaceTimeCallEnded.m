...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)AWDFaceTimeCallEnded;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDFaceTimeCallEnded description](&v3, sel_description), -[AWDFaceTimeCallEnded dictionaryRepresentation](self, "dictionaryRepresentation")];
}
