...
@implementation AWDSiriVoiceRecordingEnd
...
{
  v3.receiver = self;
  v3.super_class = (Class)AWDSiriVoiceRecordingEnd;
  return (id)[NSString stringWithFormat:@"%@ %@", -[AWDSiriVoiceRecordingEnd description](&v3, sel_description), -[AWDSiriVoiceRecordingEnd dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (BOOL)readFrom:(id)a3
{
  return AWDSiriVoiceRecordingEndReadFrom((uint64_t)self, (uint64_t)a3);
}
