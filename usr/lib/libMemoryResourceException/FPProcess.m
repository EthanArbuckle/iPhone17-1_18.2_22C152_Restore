...
- (FPProcess)initWithBsdInfo:(proc_bsdinfo *)a3
{
  ...
  if (v4)
  {
    ...
    v7 = NSString;
    uint64_t v8 = [(FPProcess *)v5 name];
    uint64_t v9 = [v7 stringWithFormat:@"%@ [%d]", v8, -[FPProcess pid](v5, "pid")];
...
- (id)errors
{
  return (id)[MEMORY[0x263EFF8C0] arrayWithArray:self->_errors];
}
...
+ (id)_nameForBsdInfo:(proc_bsdinfo *)a3
{
  ...
  *(void *)v18 = 0x800000001;
    ...
    if (v4)
    {
      ...
      if (!sysctl(v18, 3u, v4, &size, 0, 0))
      {
        ...
        if (size > v7)
        {
          ...
          if (size > v10)
          {
            v13 = (void *)[[NSString alloc] initWithUTF8String:&v5[v6 - 2]];
  ...
  v14 = sub_21E85D91C((uint64_t)FPProcess, (uint64_t)a3);
LABEL_18:
...
- (id)asNumber
{
  return (id)[NSNumber numberWithLong:self->_pid];
}
...
+ (id)allProcessesExcludingPids:(id)a3
{
  id v3 = a3;
  unint64_t v18 = 0;
  int v4 = (unsigned int *)sub_21E85DCA8(&v18);
  if (v4)
  {
    v5 = v4;
    size_t v17 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
    unint64_t v6 = v18;
    if (v18)
    {
      uint64_t v7 = 0;
      ...
      do
      {
        ...
        size_t v10 = [NSNumber numberWithInt:v9 v17];
...
+ (id)pidsForStringDescriptions:(id)a3 errors:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v53 = 0;
  v35 = (unsigned int *)sub_21E85DCA8(&v53);
  if (v35)
  {
    ...
    id v32 = v6;
    obuint64_t j = v6;
    uint64_t v39 = [obj countByEnumeratingWithState:&v49 objects:v55 count:16];
    if (v39)
    {
      uint64_t v8 = v53;
      uint64_t v37 = v53;
      ...
      do
      {
        for (uint64_t i = 0; i != v39; ++i)
        {
          ...
          char v11 = (void *)[objc_alloc(MEMORY[0x263F08B08]) initWithString:v10];
          int v48 = -1;
          int v12 = [v11 scanInt:&v48];
...
LABEL_23:
              ...
              if (!--v8)
              {
                if (!((v36 == 0) | v14 & 1))
                {
                  uint64_t v20 = (void *)[[NSString alloc] initWithFormat:@"Unable to find pid for process matching '%@'", v10];
                  [v33 addObject:v20];
                }
                uint64_t i = v40;
                if (v13) {
          ...
          if (v36)
          {
            v21 = (void *)[[NSString alloc] initWithFormat:@"Unable to find pid for process matching '%@'", v10];
            [v33 addObject:v21];
          }
LABEL_30:
          long long v46 = 0u;
          ...
          long long v45 = 0u;
          id v17 = v43;
          uint64_t v22 = [v17 countByEnumeratingWithState:&v44 objects:v54 count:16];
          if (v22)
          {
            uint64_t v23 = v22;
            ...
            do
            {
              ...
              uint64_t v23 = [v17 countByEnumeratingWithState:&v44 objects:v54 count:16];
            }
            while (v23);
          }
LABEL_41:
            ...
            if (v12)
            {
              ...
              while (2)
              {
                for (uint64_t j = 0; j != v13; ++j)
                {
                  ...
                  if (v9 == [*(id *)(*((void *)&v21 + 1) + 8 * j) longValue])
                  {
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        {
          id v11 = [NSNumber numberWithInt:[v10 pid]];
...
- (BOOL)breakDownPhysFootprint
{
  return +[FPFootprint breakDownPhysFootprint];
}

- (id)description
{
  id v3 = NSString;
  uint64_t v4 = [(FPProcess *)self pid];
  id v5 = [(FPProcess *)self name];
  uint64_t v6 = [v3 stringWithFormat:@"FPProcess[%d] %@", v4, v5];
