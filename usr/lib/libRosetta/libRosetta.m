...
{
  if (qword_26B431B80 != -1) {
    dispatch_once(&qword_26B431B80, &unk_270EB0D40);
  }
  return byte_26A9A0280;
}
...
char *rosetta_create_exit_payload_string(const char *a1, size_t a2, char *__s1)
{
  ...
  v7 = byte_26A99FA80;
  memcpy(byte_26A99FA80, __s1, v6);
  strlcpy(&byte_26A99FA80[v6], a1, a2);
  return v7;
}
...
std::string *sub_263811B24(std::string *this, std::string *a2, std::string *a3)
{
  BOOL v4 = a2;
                          ...
                          do
                          {
                            if (!v57)
                            {
                              if (strncmp(v56, "__stubs_sh", 0x10uLL))
                              {
                                ...
                                {
                                  if (v134) {
                                    sub_263812B50(v73, 518, v74, v75, v76, v77, v78, v79, v118);
                                  }
                                  int v134 = 1;
                                }
                              }
                            ...
                            if (!strncmp(v0, "__DATA_DIRTY", 0x10uLL))
                            {
                              ...
                              {
                                if (v134) {
                                  sub_263812B50(v59, 528, v60, v61, v62, v63, v64, v65, v118);
                                }
                                int v134 = 1;
                              }
                            }
...
void sub_263812B50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  uint64_t v9 = vsnprintf(__str, 0x400uLL, "encountered multiple dyld __all_image_info", &a9);
  sub_263812BB8(v9, v10, v11, v12, v13, v14, v15, v16, (char)"!dyld_all_image_infos_addr.has_value()");
}

void sub_263812BB8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
}

void sub_263812C04()
{
  dprintf(2, "%s %s", byte_26A9A0288, &byte_26A9A0288[1024]);
  __crashreporter_info__ = (uint64_t)byte_26A9A0288;
