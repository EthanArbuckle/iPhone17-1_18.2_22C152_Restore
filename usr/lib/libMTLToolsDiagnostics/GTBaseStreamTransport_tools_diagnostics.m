...
LABEL_5:
  ...
  id v10 = +[NSPropertyListSerialization propertyListWithData:options:format:error:](NSPropertyListSerialization, "propertyListWithData:options:format:error:", [self->_messageBuffer subdataWithRange:v7 - [self->_messageBuffer mutableBytes]], 0, 0, 0);
  if (v10)
  {
    id v8 = v10;
    uint64_t v9 = (v4 + 24);
