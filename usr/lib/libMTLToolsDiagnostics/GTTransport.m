...
void __63__GTTransport_send_inReplyTo_error_replyQueue_timeout_handler___block_invoke_3(uint64_t a1)
{
  ...
  if (*(unsigned char *)(*(void *)(a1 + 32) + 52))
  {
    [*(id *)(a1 + 40) dispatchError:+[GTError_tools_diagnostics errorWithDomain:code:userInfo:](GTError_tools_diagnostics, "errorWithDomain:code:userInfo:", @"DYErrorDomain", 32, 0)];
...
void *__34__GTTransport_newSourceWithQueue___block_invoke(void *result)
{
  ...
  {
    uint64_t v1 = result;
    result = [[GTTransportSource_tools_diagnostics alloc] _initWithQueue:v1[5] transport:v1[4]];
