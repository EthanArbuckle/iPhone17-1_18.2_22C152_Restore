...
- (void)_cancel
{
  [(GTTransport_tools_diagnostics *)self->_transport _cancelSource:self];
...
- (void)_register
{
  ...
  if ((v2 & 1) == 0)
  {
    if ([(GTTransport_tools_diagnostics *)self->_transport _activateSource:self])
    {
    ...
    {
      [(GTTransportSource_tools_diagnostics *)self cancel];
    }
  }
}
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)GTTransportSource_tools_diagnostics;
  [(GTTransportSource_tools_diagnostics *)&v5 dealloc];
}
...
LABEL_12:
  ...
  v18.receiver = self;
  v18.super_class = (Class)GTTransportSource_tools_diagnostics;
  v6 = [(GTTransportSource_tools_diagnostics *)&v18 init];
  if (v6)
  {
