...
LABEL_117:
            ...
            else
            {
              ...
              for (unint64_t m = 0; m < (unint64_t)[v186 count]; ++m)
              {
                ...
                [v70 setLine:[v73 unsignedLongValue]];

                v74 = [v4 objectAtIndexedSubscript:m];
                [v70 setColumn:[v74 unsignedLongValue]];
              ...
              [v76 setCpuCallstackFramesNum:[v172 unsignedLongValue]];
...
LABEL_197:
    ...
    else
    {
      ...
      for (unint64_t jj = 0; jj < (unint64_t)[v181 count]; ++jj)
      {
        ...
        [v127 setCpuCallstackFramesNum:[v129 integerValue]];
      ...
      [v125 setCommandBufferCommitCallstackFramesNum:[v161 integerValue]];
    ...
    if (a3 >= 1)
    {
      ...
      do
      {
        ...
        if (v10 == *(char **)(v12 - 8))
        {
          ...
          id v20 = v16;
          uint64_t v21 = [v14[208] stringWithUTF8String:];
