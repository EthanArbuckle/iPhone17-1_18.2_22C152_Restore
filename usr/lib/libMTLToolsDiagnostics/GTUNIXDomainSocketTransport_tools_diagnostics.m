...
- (void)_invalidate
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)GTUNIXDomainSocketTransport_tools_diagnostics;
  [(GTBaseSocketTransport_tools_diagnostics *)&v4 _invalidate];
}
  ...
  if (a3)
  {
    ...
    if (v7 != -1)
    {
      ...
      if (strlen(v18) - 103 > 0xFFFFFFFFFFFFFF97)
      {
        ...
        {
          [(GTBaseSocketTransport_tools_diagnostics *)self runWithSocket:v8];
          uint64_t v17 = 1;
LABEL_14:
...
- (void)_connectServer:(id)a3 future:(id)a4
{
  ...
  if (v9 >= 0x69)
  {
    CFStringRef v10 = GTError_tools_diagnostics;
    CFStringRef v11 = @"DYErrorDomain";
    uint64_t v12 = 39;
LABEL_20:
    [a4 setError:-[__objc2_class errorWithDomain:code:userInfo:](v10, "errorWithDomain:code:userInfo:", v11, v12, 0)];
...
- (void)setUrl:(id)a3
{
  if ([(GTBaseSocketTransport_tools_diagnostics *)self connected])
  {
    if (s_logUsingOsLog)
    {
      v6 = gt_default_log();
    ...
    if (s_logUsingOsLog)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 136315138;
        id v15 = [[objc_msgSend(a3, "absoluteString") UTF8String];
...
LABEL_11:
    ...
    else
    {
      ...
      -[[NSString stringWithFormat:](NSString, @"fail: unix domain socket url must be a file url: %s", [objc_msgSend(objc_msgSend(a3, "absoluteString"), "UTF8String") UTF8String]) UTF8String];
      fprintf(v12, "%s\n");
    }
    goto LABEL_14;
  }
...
{
  v5.receiver = self;
  v5.super_class = (Class)GTUNIXDomainSocketTransport_tools_diagnostics;
  result = [(GTBaseSocketTransport_tools_diagnostics *)&v5 init];
  if (result) {
