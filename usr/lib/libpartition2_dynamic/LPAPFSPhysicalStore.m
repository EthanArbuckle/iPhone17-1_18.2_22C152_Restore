...
+ (id)supportedContentTypes
{
  ...
  if ((id)objc_opt_class() == a1)
  {
    ...
    id v3 = (id)[MEMORY[0x263EFF8C0] arrayWithObjects:v6 count:3];
  }
  else
  {
    v5.receiver = a1;
...
- (id)parent
{
  ...
  io_iterator_t v22 = 0;
  if (MEMORY[0x210570C50]([(LPMedia *)self ioMedia], "IOService", 3, &v22))
  {
    _os_log_pack_size();
...
LABEL_3:
  ...
  uint64_t v5 = IOIteratorNext(v22);
  if (!v5) {
    goto LABEL_3;
  }
  uint64_t v6 = v5;
  ...
  do
  {
    ...
    uint64_t v17 = IOIteratorNext(v22);
    if (!v17) {
      break;
    }
    uint64_t v6 = v17;
...
- (id)container
{
  ...
  io_iterator_t v13 = 0;
  if (MEMORY[0x210570C50]([(LPMedia *)self ioMedia], "IOService", 1, &v13))
  {
    _os_log_pack_size();
    uint64_t v2 = _os_log_pack_fill();
    *(_DWORD *)uint64_t v2 = 136315138;
  ...
  {
    uint64_t v4 = IOIteratorNext(v13);
    if (v4)
    {
      uint64_t v5 = v4;
      id v3 = 0;
      do
      {
        ...
        IOObjectRelease(v5);
        uint64_t v5 = IOIteratorNext(v13);
        if (v5) {
          BOOL v11 = v10 == 0;
        }
        else {
