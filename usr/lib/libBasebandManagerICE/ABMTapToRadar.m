...
+ (id)sharedInstance
{
  if (qword_1EBBDCE00 != -1) {
    dispatch_once(&qword_1EBBDCE00, &__block_literal_global_4);
  }
...
- (BOOL)checkNotificationCriteria:(int *)a3 :(const void *)a4 :(BOOL)a5
{
  ...
  *((void *)v12 + 1) = v10;
  ...
  uint64_t v78 = v11 + 1;
  operator delete(v9);
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_1EBBDCE08, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_1EBBDCE08))
  {
    qword_1EBBDCE10 = (uint64_t)"mav_bedf_component_config_reset: Reset Requested by Component Cfg";
    qword_1EBBDCE18 = (uint64_t)"AutoBugCapture";
    qword_1EBBDCE20 = *MEMORY[0x1E4F4F970];
    __cxa_guard_release(&qword_1EBBDCE08);
  }
  int v13 = *((char *)a4 + 23);
  if (v13 < 0)
  {
...
LABEL_37:
        ...
        v28 = (const void *)qword_1EBBDCE10;
        int64_t v29 = strlen((const char *)qword_1EBBDCE10);
        if (v29)
        {
          int64_t v30 = v29;
          v31 = &v27[v26];
          ...
          long long v32 = (const void *)qword_1EBBDCE18;
          int64_t v33 = strlen((const char *)qword_1EBBDCE18);
          if (v33)
          {
            int64_t v34 = v33;
            if (v26 >= v33)
            {
              int v59 = *(char *)qword_1EBBDCE18;
              int64_t v60 = v26;
              v61 = v27;
              do
              {
            ...
            v35 = (const void *)qword_1EBBDCE20;
            int64_t v36 = strlen((const char *)qword_1EBBDCE20);
            if (v36)
            {
              int64_t v37 = v36;
              if (v26 >= v36)
              {
                int v65 = *(char *)qword_1EBBDCE20;
                v66 = v27;
                while (v26 - v37 != -1)
                {
...
- (void)showUserNotification:(int)a3 dumpReason:()basic_string<char
{
  ...
  *(_WORD *)&buf[8] = 2080;
  *(void *)&buf[10] = v9;
  _os_log_impl(&dword_1C59C6000, v7, OS_LOG_TYPE_DEFAULT, "#I Show user notification for radarType: %d with header: %s", buf, 0x12u);
LABEL_14:
...
LABEL_46:
  ...
  {
    if (MEMORY[0x1C8795EB0](v36) == MEMORY[0x1E4F14568])
    {
      xpc_retain(v36);
  ...
  if (LODWORD(v57[0]))
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 136315138;
      uint64_t v74 = v51;
      _os_log_error_impl(&dword_1C59C6000, v46, OS_LOG_TYPE_ERROR, "Failed to file the radar: %s", buf, 0xCu);
      if (v53 < 0) {
