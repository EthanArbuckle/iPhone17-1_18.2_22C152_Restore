...
{
  id v6 = a3;
  v7 = [(CEMPolicyWebSiteDeclaration *)self payloadMode];
  if (DMDDeclarationModeIsValid(v7))
  {
    ...
    v10 = [(CEMPolicyWebSiteDeclaration *)self declarationIdentifier];
    [v8 setDeclarationIdentifier:v10];

    [v8 setType:DMFEffectivePolicyTypeWeb];
    [v8 setPolicy:DMDPolicyFromDeclarationMode(v7)];
    v11 = [(CEMPolicyWebSiteDeclaration *)self payloadHostnames];
...
- (id)dmf_removeRequestWithContext:(id)a3 error:(id *)a4
{
  ...
  v9 = [(CEMPolicyWebSiteDeclaration *)self declarationIdentifier];
