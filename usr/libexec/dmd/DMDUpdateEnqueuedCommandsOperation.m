...
- (void)runWithRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7[3] = &unk_1000CADD0;
    v7[4] = self;
    [v6 handleUpdateCommandsRequest:v4 completionHandler:v7];
  }
  else
  {
    v6 = DMFErrorWithCodeAndUserInfo();
    [(DMDUpdateEnqueuedCommandsOperation *)self endOperationWithError:v6];
  }
}
...
+ (BOOL)validateRequest:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v10.receiver = a1;
  v10.super_class = (Class)&OBJC_METACLASS___DMDUpdateEnqueuedCommandsOperation;
