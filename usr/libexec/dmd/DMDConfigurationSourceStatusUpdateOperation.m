...
- (void)main
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    v6[3] = &unk_1000CABC0;
    v6[4] = self;
    [v4 configurationSourceController:v3 fetchStatusUpdatesWithCompletionHandler:v6];
  }
  else
  {
    ...
    [(DMDConfigurationSourceStatusUpdateOperation *)self endOperationWithResultObject:0];
  }
}
