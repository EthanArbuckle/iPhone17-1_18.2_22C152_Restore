...
+ (BOOL)validateRequest:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v10.receiver = a1;
  v10.super_class = (Class)&OBJC_METACLASS___DMDDeactivateConfigurationOrganizationOperation;
  ...
  if (!v7)
  {
    ...
    CFStringRef v12 = @"request.organizationIdentifier";
