...
- (id)dmf_installRequestWithContext:(id)a3 error:(id *)a4
{
  ...
  v7 = [(CEMSystemFontDeclaration *)self dmf_installSynthesizedProfileRequestWithAssetProviders:v6 error:a4];
...
- (id)dmf_removeRequestWithContext:(id)a3 error:(id *)a4
{
  return [(CEMSystemFontDeclaration *)self dmf_removeSynthesizedProfileRequestWithError:a4];
}
