...
+ (id)fetchRequestForConfigurationsPendingInstallFromOrganizationWithIdentifier:(id)a3
{
  id v4 = a3;
  v5 = [a1 fetchRequest];
  id v6 = +[NSPredicate predicateWithFormat:@"%K = %@", @"organization.identifier", v4];

  v13[0] = v6;
  id v7 = +[NSPredicate predicateWithFormat:@"%K = %@", @"installed", &__kCFBooleanFalse];
  v13[1] = v7;
...
+ (id)fetchRequestForConfigurationsPendingRemoveFromOrganizationWithIdentifier:(id)a3
{
  ...
  v13[0] = v6;
  id v7 = +[NSPredicate predicateWithFormat:@"%K = %@", @"installed", &__kCFBooleanTrue];
  v13[1] = v7;
  v8 = +[NSPredicate predicateWithFormat:@"%K = %@", @"failed", &__kCFBooleanFalse];
  v13[2] = v8;
...
+ (id)fetchRequestForConfigurationsPendingInactiveFromOrganizationWithIdentifier:(id)a3
{
  ...
  id v7 = +[NSPredicate predicateWithFormat:@"%K = %@", @"available", &__kCFBooleanTrue, v6];
  v14[1] = v7;
