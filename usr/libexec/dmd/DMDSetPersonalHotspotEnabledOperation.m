...
- (void)runWithRequest:(id)a3
{
  ...
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "Setting Personal Hotspot enabled: %{public}@", (uint8_t *)&v7, 0xCu);
  }
