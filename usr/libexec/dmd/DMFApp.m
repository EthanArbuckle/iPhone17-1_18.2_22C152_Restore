...
- (DMFApp)initWithJob:(id)a3 hasUpdateAvailable:(BOOL)a4 propertyKeys:(id)a5
{
  ...
  if (v11)
  {
    ...
    {
      v12 = +[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", [v8 storeItemID]);
    ...
    if ([v9 containsObject:@"hasUpdateAvailable"]) {
      [(DMFApp *)v11 setHasUpdateAvailable:v6];
    }
  }
...
LABEL_34:
  unsigned int v32 = [v9 containsObject:@"isPlaceholder"];
  unsigned int v33 = [v9 containsObject:@"isRestricted"];
  ...
  unsigned int v37 = [v9 containsObject:@"isUserBasedVPP"];
  unsigned int v38 = [v9 containsObject:@"isLicenseExpired"];
  unsigned int v39 = [v9 containsObject:@"isLicenseRevoked"];
  unsigned int v40 = v39;
  if ((v37 & 1) == 0 && (v38 & 1) == 0 && !v39) {
    goto LABEL_48;
  }
  unsigned int v41 = +[SSPurchaseReceipt vppStateFlagsWithProxy:v12];
...
- (BOOL)_proxyIsValidated:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v5 = MISAppApprovalState();
    if (v5) {
      BOOL v6 = v5 == 3;
    }
    else {
