...
- (id)dmf_installRequestWithContext:(id)a3 error:(id *)a4
{
  ...
  v7 = [(CEMSystemAirdropDeclaration *)self dmf_installSynthesizedProfileRequestWithAssetProviders:v6 error:a4];
...
- (id)dmf_removeRequestWithContext:(id)a3 error:(id *)a4
{
  return [(CEMSystemAirdropDeclaration *)self dmf_removeSynthesizedProfileRequestWithError:a4];
}
