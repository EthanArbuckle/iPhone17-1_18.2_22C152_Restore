...
- (id)preparingRestoreWithPolicy:(id)a3 engine:(id)a4
{
  v4 = +[MBPersona personalPersonaWithError:](MBPersona, "personalPersonaWithError:", 0, a4);
...
- (id)endedRestoreWithPolicy:(id)a3 engine:(id)a4 error:(id)a5
{
  v5 = +[MBPersona personalPersonaWithError:](MBPersona, "personalPersonaWithError:", 0, a4, a5);
