    ...
    if (!v6)
    {
      if (v9)
      {
        *(_DWORD *)buf = 138543362;
        v13 = v5;
        _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "Failed to fetch the persona attributes for persona %{public}@", buf, 0xCu);
        goto LABEL_15;
      }
LABEL_16:
    ...
    if (v9)
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2112;
      v15 = v6;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "Fetched the attributes for persona %{public}@: %@", buf, 0x16u);
      _MBLog();
    }
    ...
    if ([v6 isEnterprisePersona])
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v14 = 2112;
        v15 = v4;
        _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "Found an enterprise persona (%@) for account %@", buf, 0x16u);
LABEL_15:
        _MBLog();
        goto LABEL_16;
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      v13 = v4;
      _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEBUG, "Found nil personaIdentifier for %@", buf, 0xCu);
      _MBLog();
    }
  }
  BOOL v7 = 0;
...
- (BOOL)addAccountWithDSID:(id)a3
{
  id v4 = a3;
  uint64_t v5 = v4;
  if (v4 && ([v4 isEqualToNumber:&off_1000FDDB0] & 1) == 0)
  {
    v8 = self;
    objc_sync_enter(v8);
    ...
    if ((v9 & 1) == 0)
    {
      ...
      v11 = [v5 stringValue];
      objc_super v12 = [v10 aa_appleAccountWithPersonID:v11];
      ...
      if (v12)
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 136315650;
          ...
          __int16 v26 = 2112;
          v27 = v5;
          _os_log_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_DEBUG, "%s account: %@/%@", buf, 0x20u);
          v20 = v13;
          v21 = v5;
          v19 = v16;
          _MBLog();
...
LABEL_24:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 138412290;
          v23 = (const char *)v5;
          _os_log_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_INFO, "No account found for %@", buf, 0xCu);
          v19 = (const char *)v5;
          _MBLog();
        }
