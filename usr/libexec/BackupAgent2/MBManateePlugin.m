      ...
      do
      {
        ...
        do
        {
          ...
          if (v11)
          {
            ...
            {
              if (qword_100113010 != -1) {
                dispatch_once(&qword_100113010, &stru_1000F22E0);
              }
              v25 = &AnalyticsSendEventLazy_ptr;
              id v26 = (id)qword_100113008;
              long long v76 = 0u;
              long long v77 = 0u;
              long long v78 = 0u;
              long long v79 = 0u;
              ...
              if (v65)
              {
                ...
                do
                {
                  ...
                  do
                  {
                    ...
                    v30 = [v10 rootPath:v54];
                    unsigned int v31 = [v29 hasPrefix:v30];

                    if (v31)
                    {
                      v32 = [v25[472] defaultManager];
                        ...
                        if (v36)
                        {
                          ...
                          do
                          {
                            for (j = 0; j != v37; j = (char *)j + 1)
                            {
                              ...
                              unsigned __int8 v41 = [v17 containsObject:v40, v54];
                              v42 = MBGetDefaultLog();
                              v43 = v42;
                              if (v41)
                              {
            ...
            [v10 setRelativePathsToBackupAndRestore:v16, v55];
