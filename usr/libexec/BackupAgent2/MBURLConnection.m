...
- (MBURLConnection)initWithRequest:(id)a3 properties:(id)a4
{
  ...
  if (v6)
  {
    ...
    v11 = (NSURLConnection *)[objc_alloc((Class)NSURLConnection) _initWithRequest:[a3 NSURLRequest] delegate:v6 usesCache:1 maxContentLength:0 startImmediately:0 connectionProperties:a4];
    v6->_connection = v11;
...
- (void)connection:(id)a3 willSendRequestForAuthenticationChallenge:(id)a4
{
  id v5 = [[objc_msgSend(a4, "protectionSpace", a3) authenticationMethod];
  id v6 = [a4 sender];
