...
- (void)_enumerateAppsWithEnumerationOptions:(unint64_t)a3 to:(id)a4 persona:(id)a5 dataSeparatedBundleIDs:(id)a6
{
  ...
  if (v16 == 1)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_FAULT, "Could not fetch system persona for primary user", buf, 2u);
      _MBLog();
    }
  }
  v18 = MBGetDefaultLog();
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 134218242;
    ...
    __int16 v66 = 2112;
    v67 = v53;
    _os_log_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_DEFAULT, "Starting app enumeration (options = %llu) for %@", buf, 0x16u);
    unint64_t v47 = a3;
    v48 = v53;
    _MBLog();
  }
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          *(_DWORD *)buf = 138412290;
          ...
          _os_log_impl((void *)&_mh_execute_header, v28, OS_LOG_TYPE_DEFAULT, "Skipping isKindOfClass for %@", buf, 0xCu);
        ...
        if (objc_msgSend(v26, "mb_isContainerized"))
        {
          ...
          if (!v30)
          {
                ...
                if ((v35 & 1) == 0)
                {
                  ...
                  if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
                  {
                    *(_DWORD *)buf = 138412290;
                    ...
                    _os_log_impl((void *)&_mh_execute_header, v41, OS_LOG_TYPE_DEFAULT, "Skipping placeholder for %@", buf, 0xCu);
            ...
            v31 = [v26 managedPersonas:v47, v48, v49];
            if (![v31 count])
            {
              if ((v54 & 1) == 0) {
                goto LABEL_40;
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v66 = 2114;
              v67 = v31;
              _os_log_impl((void *)&_mh_execute_header, v36, OS_LOG_TYPE_DEFAULT, "Found app %@ with managed personae: %{public}@", buf, 0x16u);
              unint64_t v47 = (unint64_t)v28;
              v48 = v31;
              _MBLog();
            }
              ...
              if ((v37 & 1) == 0 && ([v31 containsObject:v52] & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT))
                {
                  *(_DWORD *)buf = 138543874;
                  ...
                  _os_log_impl((void *)&_mh_execute_header, v38, OS_LOG_TYPE_DEFAULT, "Skipping %{public}@ since it's not managed by the personal:%@ persona nor system:%@ persona", buf, 0x20u);
                  v48 = v58;
                  v49 = v52;
                  id v21 = v59;
                  unint64_t v47 = (unint64_t)v28;
...
LABEL_51:
              uint64_t v39 = sub_10004F664(v26);
              if (v39 == 2)
              {
                v38 = MBGetDefaultLog();
                if (!os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT)) {
                ...
                *(_DWORD *)buf = 138412290;
                unint64_t v65 = (unint64_t)v28;
                _os_log_impl((void *)&_mh_execute_header, v38, OS_LOG_TYPE_DEFAULT, "Skipping %@ (Swift Playgrounds app)", buf, 0xCu);
                unint64_t v47 = (unint64_t)v28;
              }
              else
              {
...
LABEL_64:
                ...
                *(_DWORD *)buf = 138412290;
                unint64_t v65 = (unint64_t)v28;
                _os_log_impl((void *)&_mh_execute_header, v38, OS_LOG_TYPE_DEFAULT, "Skipping %@ (app clip)", buf, 0xCu);
                unint64_t v47 = (unint64_t)v28;
              }
            }
            else if (v55)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v66 = 2114;
              v67 = v58;
              _os_log_impl((void *)&_mh_execute_header, v38, OS_LOG_TYPE_DEFAULT, "Skipping %{public}@ for data-separated persona %{public}@ since it's not in the list of managed personae", buf, 0x16u);
              unint64_t v47 = (unint64_t)v28;
              v48 = v58;
              id v21 = v59;
            }
            else
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v66 = 2114;
              v67 = v58;
              _os_log_impl((void *)&_mh_execute_header, v38, OS_LOG_TYPE_DEFAULT, "Skipping %{public}@ for persona %{public}@ since it's not in the list of managed personae", buf, 0x16u);
              unint64_t v47 = (unint64_t)v28;
              v48 = v58;
              id v21 = v59;
            }
LABEL_63:
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = 138412290;
            unint64_t v65 = (unint64_t)v28;
            _os_log_impl((void *)&_mh_execute_header, v31, OS_LOG_TYPE_INFO, "Skipping %@ as of Hidden type", buf, 0xCu);
            unint64_t v47 = (unint64_t)v28;
LABEL_27:
            _MBLog();
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            unint64_t v65 = (unint64_t)v28;
            _os_log_impl((void *)&_mh_execute_header, v31, OS_LOG_TYPE_DEBUG, "Skipping isContainerized for %@", buf, 0xCu);
            unint64_t v47 = (unint64_t)v28;
            goto LABEL_27;
          }
        }
...
LABEL_29:
  ...
  if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v70 = 2048;
    id v71 = v46;
    _os_log_impl((void *)&_mh_execute_header, v45, OS_LOG_TYPE_DEFAULT, "Finished app enumeration (options = %llu) for %@ in %0.3fs: %lu apps", buf, 0x2Au);
    id v21 = v59;
    [v57 count];
    _MBLog();
  }
...
- (id)userAppWithBundleID:(id)a3 placeholder:(BOOL)a4 persona:(id)a5 error:(id *)a6
{
  ...
  unsigned int v13 = sub_1000501B0(v11, v12);
          ...
          if (!v13)
          {
            ...
            if (v16)
            {
              ...
              if (v17)
              {
                ...
                if (v18)
                {
                  double v19 = [v15 mb_entitlements];
                  if (!v19)
                  {
                    double v20 = MBGetDefaultLog();
                    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
                    {
                      id v21 = [v15 mb_pluginIdentifier];
                      *(_DWORD *)buf = 138412290;
                      id v88 = v21;
                      _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_DEBUG, "Plugin %@ found without entitlements.", buf, 0xCu);

                      id v57 = [v15 mb_pluginIdentifier];
                      _MBLog();
                    }
                  ...
                  if (v23)
                  {
                    ...
                    do
                    {
                      ...
                      do
                      {
                        ...
                        v29 = [v15 groupContainerURLs:v57];
                        unsigned int v30 = [v29 objectForKeyedSubscript:v28];

                        if (v30)
                        {
                          v31 = sub_100053318(v30);
...
LABEL_28:
                          ...
                          {
                            unsigned __int8 v35 = [v15 mb_pluginIdentifier];
                            ...
                            *(_WORD *)&v82[22] = 2112;
                            ...
                            LOWORD(v84) = 2112;
                            *(void *)((char *)&v84 + 2) = v70;
                            _os_log_impl((void *)&_mh_execute_header, v33, OS_LOG_TYPE_DEFAULT, "Plugin %@ groupContainer %@ at %@ does not reside on the user data volume %@ - will not be backed up", v82, 0x2Au);
...
LABEL_27:
                        ...
                        if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
                        {
                          ...
                          *(_WORD *)&v82[12] = 2112;
                          *(void *)&v82[14] = v28;
                          _os_log_impl((void *)&_mh_execute_header, v31, OS_LOG_TYPE_DEFAULT, "Plugin %@ groupContainer %@ found without a container - will not be backed up", v82, 0x16u);
...
LABEL_29:
                  ...
                  unsigned __int8 v37 = [v15 mb_pluginIdentifier];
                  *(void *)v82 = v37;
                  v81[1] = @"ContainerContentClass";
                  v38 = sub_10003F500(2);
                  *(void *)&v82[8] = v38;
                  v81[2] = @"Path";
                  uint64_t v39 = [v15 mb_bundleURL];
                  v40 = sub_100053318(v39);
                  *(void *)&v82[16] = v40;
                  v81[3] = @"Container";
                  v41 = [v15 dataContainerURL];
                  id v42 = sub_100053318(v41);
                  v83 = v42;
                  double v43 = v66;
...
LABEL_43:
                ...
                {
                  id v46 = v4;
                  id v51 = [v15 mb_pluginIdentifier];
                  v52 = [v15 mb_pluginIdentifier];
                  *(_DWORD *)buf = 138412546;
                  id v88 = v51;
                  __int16 v89 = 2112;
                  v90 = v52;
                  _os_log_impl((void *)&_mh_execute_header, v43, OS_LOG_TYPE_DEFAULT, "Plugin %@ found without a pluginIdentifier (%@) - will not be backed up.", buf, 0x16u);

                  double v44 = [v15 mb_pluginIdentifier];
                  unsigned __int8 v37 = [v15 mb_pluginIdentifier];
                  id v57 = v44;
                  v58 = v37;
                  goto LABEL_40;
...
LABEL_42:
              ...
              unint64_t v50 = [v15 mb_bundleURL];
              *(_DWORD *)buf = 138412546;
              id v88 = v49;
              __int16 v89 = 2112;
              v90 = v50;
              _os_log_impl((void *)&_mh_execute_header, v43, OS_LOG_TYPE_DEFAULT, "Plugin %@ found without a bundle URL (%@) - will not be backed up.", buf, 0x16u);

              double v44 = [v15 mb_pluginIdentifier];
              unsigned __int8 v37 = [v15 mb_bundleURL];
              id v57 = v44;
              v58 = v37;
            }
            else
            {
              ...
              id v46 = v4;
              unint64_t v47 = [v15 mb_pluginIdentifier];
              v48 = [v15 dataContainerURL];
              *(_DWORD *)buf = 138412546;
              id v88 = v47;
              __int16 v89 = 2112;
              v90 = v48;
              _os_log_impl((void *)&_mh_execute_header, v43, OS_LOG_TYPE_DEFAULT, "Plugin %@ found without a data container (%@) - will not be backed up.", buf, 0x16u);
...
LABEL_44:
  ...
  if (os_log_type_enabled(v54, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 134217984;
    id v88 = v55;
    _os_log_impl((void *)&_mh_execute_header, v54, OS_LOG_TYPE_DEFAULT, "Finished app enumeration PLUGINS: %lu apps", buf, 0xCu);
    [v5 count];
    _MBLog();
  }
...
- (id)systemContainersWithError:(id *)a3
{
  ...
  else
  {
    ...
    id v7 = v12;
    uint64_t v9 = (void *)qword_100112FA8;
    qword_100112FA8 = v8;
  }
  if (a3) {
    *a3 = v7;
  }
  id v10 = (id)qword_100112FA8;
...
- (id)systemSharedContainersWithError:(id *)a3
{
  ...
  else
  {
    ...
    id v7 = v12;
    uint64_t v9 = (void *)qword_100112FB0;
    qword_100112FB0 = v8;
  }
  if (a3) {
    *a3 = v7;
  }
  id v10 = (id)qword_100112FB0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v12 = 2048;
      uint64_t v13 = 1;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_ERROR, "Failed to get subdirectory names for container class %llu : %llu", buf, 0x16u);
      _MBLog();
    }
...
+ (id)defaultSubdirectoriesForMBContainerType:(int)a3 withNestedSubdirectories:(BOOL)a4
{
  ...
  if (!qword_100112FB8)
  {
    ...
    uint64_t v8 = (void *)qword_100112FB8;
    qword_100112FB8 = v7;
  }
  id v9 = [v6 _containerClassForMBContainerType:v5];
  if (v9 == (id)15)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 134218240;
      ...
      __int16 v27 = 1024;
      int v28 = v5;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_ERROR, "Unknown MCM container type %llu for MB container type %u", buf, 0x12u);
      _MBLog();
    }
    uint64_t v11 = 0;
  }
  else
  {
    ...
    __int16 v12 = [(id)qword_100112FB8 objectForKeyedSubscript:v10];
    if (!v12)
    {
      __int16 v12 = [v6 _defaultSubdirectoriesForMCMContainerType:v9 withError:0];
      [(id)qword_100112FB8 setObject:v12 forKeyedSubscript:v10];
    }
    if (v4)
    {
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v15 = 2112;
      id v16 = v9;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_ERROR, "Error uninstalling app with bundleID:%@{public} options:%@ error:%@", buf, 0x20u);
      _MBLog();
    }
  }
  return v7;
...
- (BOOL)registerSafeHarborWithIdentifier:(id)a3 path:(id)a4 type:(int)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v22 = 1024;
    int v23 = v12;
    _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_DEBUG, "MobileInstallationRegisterSafeHarborForContainerType(\"%@\", \"%@\", %d, NULL): %d", buf, 0x22u);
    _MBLog();
  }
...
- (BOOL)removeSafeHarborWithIdentifier:(id)a3 type:(int)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v17 = 1024;
    int v18 = v9;
    _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_DEBUG, "MobileInstallationRemoveSafeHarborForContainerType(\"%@\", %d, NULL): %d", buf, 0x18u);
    _MBLog();
  }
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2114;
      id v19 = v5;
      _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_ERROR, "Failed to find the app record for %{public}@: %{public}@", buf, 0x16u);
LABEL_9:
      _MBLog();
    }
LABEL_10:
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138543362;
      id v17 = v3;
      _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "Found an app record for %{public}@ but it's not installed", buf, 0xCu);
      goto LABEL_9;
    }
    goto LABEL_10;
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2114;
    id v19 = v13;
    _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEBUG, "Mapped %{public}@ to %{public}@", buf, 0x16u);
    _MBLog();
  }
LABEL_11:
...
+ (id)displayNameForDomain:(id)a3 isSystemDomain:(BOOL)a4
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      int v8 = [&off_1000FDF00 objectForKeyedSubscript:v7];
      int v9 = v8;
      if (v8)
      {
        id v10 = v8;
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        int v16 = +[MBMobileInstallation displayNameForDomain:isSystemDomain:](MBMobileInstallation, "displayNameForDomain:isSystemDomain:", v14, [v7 isSystemDomainName:v14]);
        if (v16) {
          [v8 addObject:v16];
        }
      }
