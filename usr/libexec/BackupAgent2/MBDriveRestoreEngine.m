...
- (id)_temporaryPathForFile:(id)a3
{
  ...
  id v7 = &OBJC_IVAR___MBDriveRestoreEngine__userTemporaryDirectory;
  if (v6) {
    id v7 = &OBJC_IVAR___MBDriveRestoreEngine__sharedTemporaryDirectory;
  }
...
- (id)_prepareProgress
{
  ...
  *(void *)buf = 0;
  ...
  __int16 v38 = sub_1000391D8;
  id v39 = sub_1000391E8;
  id v40 = 0;
  uint64_t v31 = 0;
  CFStringRef v32 = &v31;
...
- (id)_restoreContent
{
  ...
  *(void *)&uint8_t buf[16] = 0x3032000000;
  id v51 = sub_1000391D8;
  uint64_t v52 = sub_1000391E8;
  ...
  uint64_t v29 = sub_1000391D8;
  double v30 = sub_1000391E8;
  id v31 = 0;
  manifest = self->_manifest;
      ...
      if (v80)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            do
            {
              v59 = [v56 subarrayWithRange:0, v58];
    ...
    if (v57)
    {
      ...
      do
      {
        for (j = 0; j != v58; j = (char *)j + 1)
        {
          ...
          id v63 = [v56 objectForKeyedSubscript:v62, v104, v105];
    ...
    if (v31)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          unsigned __int8 v36 = [v35 domain:v104, v105, v106, v107];
...
- (id)_restoreDirectoryModificationTimes
{
  ...
  id v19 = sub_1000391D8;
  uint64_t v20 = sub_1000391E8;
  id v21 = 0;
  unsigned int v4 = MBGetDefaultLog();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
