...
LABEL_24:
        ...
        id v30 = 0;
        v21 = +[NSPropertyListSerialization dataWithPropertyList:format:options:error:](NSPropertyListSerialization, "dataWithPropertyList:format:options:error:", v18, 200, 0, &v30, v26, v28);
        v22 = (__CFString *)v30;
...
LABEL_19:
          id v11 = v13;
LABEL_20:
          v7 = -[NSObject objectForKeyedSubscript:](v12, "objectForKeyedSubscript:", v6, v17, v18);
  ...
  v7 = (void *)CFPreferencesCopyValue(v6, @"com.apple.MobileBackup", @"mobile", kCFPreferencesCurrentHost);
  if (!v7) {
    goto LABEL_25;
  }
LABEL_21:
...
+ (id)allPersonae
{
  ...
  if (v5)
  {
    id v7 = [v5 personaLayoutPathURL];
    unsigned __int8 v8 = [v7 path];
  ...
  if (v2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        long long v16 = 0u;
        long long v17 = 0u;
        unsigned __int8 v8 = [v6 volumesToBackUp];
...
- (id)restorePathForDriveRestorable:(id)a3
{
  ...
  uint64_t v7 = [(MBPersona *)self userIncompleteRestoreDirectory];
  }
...
- (BOOL)shouldRestoreFilesSparse
{
  ...
  if (qword_100113048 != -1) {
    dispatch_once(&qword_100113048, &stru_1000F25C0);
  }
  os_unfair_lock_lock((os_unfair_lock_t)&dword_100113050);
  id v7 = [(id)qword_100113040 objectForKeyedSubscript:v6];
  if (!v7)
  {
    char v19 = 0;
    ...
    [(id)qword_100113040 setObject:v12 forKeyedSubscript:v6];
    id v7 = v12;
  ...
  os_unfair_lock_unlock((os_unfair_lock_t)&dword_100113050);
...
- (BOOL)_fileSystemSupportsSparseFiles:(id)a3
{
  ...
  else
  {
    int v5 = v4;
    uint64_t v13 = 0;
    long long v12 = xmmword_1000B0F30;
    int v17 = 0;
...
- (BOOL)createRestoreDirectoriesWithError:(id *)a3
{
  ...
  id v28 = 0;
  char v11 = sub_100093490(v10, 2, (uint64_t)&v28);
  id v12 = v28;
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      id v27 = v12;
      BOOL v18 = 1;
      char v19 = sub_100093490(v17, 1, (uint64_t)&v27);
      id v20 = v27;
...
- (BOOL)cleanupRestoreDirectoriesWithError:(id *)a3
{
  ...
  unsigned int v10 = [v8 mb_moveToTmpDirThenRemoveItemAtPath:v9 error:a3];
  ...
  if (v10)
  {
    if ([(MBPersona *)self shouldRestoreToSharedVolume])
    {
      ...
      unsigned __int8 v12 = [v8 mb_moveToTmpDirThenRemoveItemAtPath:v11 error:a3];
    }
    else
    {
...
- (unint64_t)_removeRestorePrefetchCacheAtPath:(id)a3 earliestDate:(id)a4
{
  ...
  if (v38)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        uint64_t v12 = [v5 stringByAppendingPathComponent:v11, v34, v35];
        id v40 = 0;
...
LABEL_33:
  ...
  if (!v23)
  {
    ...
    id v42 = v24;
    unsigned __int8 v30 = [v37 removeItemAtPath:v5 error:&v42];
    int v8 = v42;
...
- (BOOL)_moveRestoreDirectoryFrom:(id)a3 toFinalLocation:(id)a4 error:(id *)a5
{
  ...
  if ([v10 fileExistsAtPath:v7 isDirectory:0])
  {
    ...
    {
      id v21 = 0;
      unsigned __int8 v11 = [v10 mb_moveToTmpDirThenRemoveItemAtPath:v9 error:&v21];
      id v12 = v21;
      if ((v11 & 1) == 0)
      {
    ...
    id v20 = 0;
    unsigned __int8 v14 = [v10 moveItemAtPath:v7 toPath:v9 error:&v20];
    BOOL v15 = v20;
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)stat buf = 138543874;
        ...
        __int16 v26 = 2114;
        id v27 = v15;
        _os_log_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_ERROR, "Failed to move restore sandbox from %{public}@ into place %{public}@: %{public}@", buf, 0x20u);
        _MBLog();
      }
...
- (BOOL)copyPlaceholderIPAsForAppInstallationExcluding:(id)a3 error:(id *)a4
{
  ...
  {
    uint64_t v8 = [v7 substringFromIndex:[@"/private" length]];
        ...
        while (2)
        {
          for (i = 0; i != v13; i = (char *)i + 1)
          {
            ...
            if ([v18 BOOLValue])
            {
              ...
              {
                unint64_t v22 = [v20 stringByDeletingPathExtension];
                ...
                else
                {
                  ...
                  __int16 v24 = MBMobileFileAttributes();
                  ...
                  __int16 v26 = [v23 stringByAppendingPathComponent:v20];
