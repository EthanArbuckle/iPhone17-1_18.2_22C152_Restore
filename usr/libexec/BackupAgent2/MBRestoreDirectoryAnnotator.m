...
- (id)_annotateDomain:(id)a3 atDomainRoot:(id)a4
{
  ...
  if (![v6 isUninstalledAppDomain])
  {
    ...
    long long v15 = [v6 relativePathsNotToBackup:v48, v49];
    [v8 unionSet:v15];
...
LABEL_23:
          v22 = [v8 allObjects];
          v23 = [v22 sortedArrayUsingComparator:&stru_1000F2650];
          ...
          [v29 mb_minusPathSet:v8];
          v39 = [v29 allObjects];
          v40 = [v39 sortedArrayUsingComparator:&stru_1000F2670];
...
- (id)_annotateRestoredDomain:(id)a3 domainRoot:(id)a4 relativePath:(id)a5
{
  ...
  if (!v12)
  {
    if (+[MBError codeForNSError:v13] == 4)
    {
      ...
      unsigned int v18 = [v9 mb_pathComponentExistsInSet:v17];
