...
+ (id)sharedPool
{
  if (qword_100112EB0 != -1) {
    dispatch_once(&qword_100112EB0, &stru_1000F1238);
  }
  return (id)qword_100112EA8;
}
...
- (id)_openCache
{
  v2 = -[MBServiceCache initWithPath:domainManager:]([MBServiceCache alloc], "initWithPath:domainManager:", +[MBServiceCache systemPath](MBServiceCache, "systemPath"), [objc_alloc((Class)MBDomainManager) initWithPersona:+[MBPersona personalPersonaWithError:](MBPersona, "personalPersonaWithError:", 0)]);
