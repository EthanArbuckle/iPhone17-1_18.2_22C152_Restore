...
- (id)backingUpSQLiteFileCopyAtPath:(id)a3 temporaryPath:(id)a4
{
  if ([a3 isEqualToString:@"/var/mobile/Library/com.apple.itunesstored/kvs.sqlitedb"])
  {
    ...
    *(void *)buf = 0;
    [a4 fileSystemRepresentation:v9];
...
- (id)endingRestoreWithPolicy:(id)a3 engine:(id)a4
{
  ...
  CFStringRef v21 = 0;
  unsigned __int8 v6 = [a4 settingsContext].shouldRestoreSystemFiles;
  v7 = MBGetDefaultLog();
  ...
  if (v6)
  {
    ...
    id v12 = [[[objc_msgSend(v10, "userIncompleteRestoreDirectory")] stringByAppendingPathComponent:@"/var/mobile/Library/com.apple.itunesstored"];
    id v13 = [[[objc_msgSend(v10, "userIncompleteRestoreDirectory")] stringByAppendingPathComponent:@"/var/mobile/Library/com.apple.itunesstored/kvs.sqlitedb"];
...
LABEL_12:
    ...
    id v16 = [[[objc_msgSend(objc_msgSend(a4, "properties"), "lockdownKeys") objectForKeyedSubscript:@"com.apple.itunesstored"]
    if ([v16 count])
    {
    ...
    [v11 setKnownAccounts:[+[MBiTunesStoreKVS mergeKnownAccountsByDSID:into:](MBiTunesStoreKVS, "mergeKnownAccountsByDSID:into:", v14, objc_msgSend(v11, "knownAccountsByDSID", v20)) allValues]];
