...
LABEL_27:
    [v29 setObject:v27 forKeyedSubscript:@"AutomaticDowngrades" withObject:v79 withObject:v80 withObject:v81];
    goto LABEL_28;
  }
  if ([v27 count]) {
    goto LABEL_27;
...
LABEL_50:
  ...
  v56 = copyfile((const char *)[@"/var/installd/Library/MobileInstallation/BackedUpState/SystemAppInstallState.plist" fileSystemRepresentation], (const char *)[@"/var/installd/Library/MobileInstallation/BackedUpState/BackupSystemAppInstallState.plist" fileSystemRepresentation], v55, 0xEu);
  if (v56)
  {
    v57 = v56;
    v58 = MBGetDefaultLog();
