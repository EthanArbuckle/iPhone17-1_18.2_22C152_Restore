...
- (id)domain
{
  ...
  if (qword_100112F18 != -1) {
    dispatch_once(&qword_100112F18, &stru_1000F1808);
  }
  [v7 setRelativePathsToBackupAndRestore:qword_100112F10];
  if (qword_100112F28 != -1) {
    dispatch_once(&qword_100112F28, &stru_1000F1828);
  }
  [v7 setRelativePathsNotToBackup:qword_100112F20];
  if (qword_100112F38 != -1) {
    dispatch_once(&qword_100112F38, &stru_1000F1848);
  }
  [v7 setRelativePathsNotToRestore:qword_100112F30];
