...
LABEL_3:
  ...
  [v3 setObject:[+[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", self->_quotaReserved)] forKey:@"quotaReserved"];
  if ((*(unsigned char *)&self->_has & 2) != 0) {
LABEL_4:
  }
    [v3 setObject:[+[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", self->_lastModified)] forKey:@"lastModified"];
LABEL_5:
  attributes = self->_attributes;
  if (attributes) {
    [v3 setObject:[[-[MBSSnapshotAttributes dictionaryRepresentation](attributes, "dictionaryRepresentation")] dictionaryRepresentation] forKey:@"attributes"];
  }
  if (*(unsigned char *)&self->_has) {
    [v3 setObject:[+[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", self->_committed)] forKey:@"committed"];
  }
  return v3;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_10000E74C((uint64_t)self, (uint64_t)a3);
}
...
LABEL_24:
    ...
    if (has)
    {
      if ((*((unsigned char *)a3 + 44) & 1) == 0 || self->_committed != *((void *)a3 + 1)) {
        goto LABEL_24;
      }
      LOBYTE(v5) = 1;
    }
