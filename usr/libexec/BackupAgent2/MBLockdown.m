...
- (MBLockdown)init
{
  ...
  if (v2)
  {
    if (qword_100112FE8 != -1) {
      dispatch_once(&qword_100112FE8, &stru_1000F21C8);
    }
...
- (BOOL)connect
{
  ...
  v4[4] = self;
  v4[5] = &v5;
  dispatch_sync((dispatch_queue_t)qword_100112FF0, v4);
...
- (void)disconnect
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10006EF5C;
  block[3] = &unk_1000F12B0;
  block[4] = self;
  dispatch_sync((dispatch_queue_t)qword_100112FF0, block);
}
...
- (id)objectForDomain:(id)a3 andKey:(id)a4
{
  ...
  v6[6] = a4;
  v6[7] = &v7;
  dispatch_sync((dispatch_queue_t)qword_100112FF0, v6);
...
- (BOOL)setObject:(id)a3 forDomain:(id)a4 andKey:(id)a5 withError:(id *)a6
{
  ...
  v8[8] = &v9;
  v8[9] = a6;
  dispatch_sync((dispatch_queue_t)qword_100112FF0, v8);
...
- (BOOL)removeObjectWithDomain:(id)a3 andKey:(id)a4 withError:(id *)a5
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10006F374;
  block[3] = &unk_1000F2240;
  block[4] = a3;
  void block[5] = a4;
  block[7] = &v8;
  block[8] = a5;
  ...
  if (v4 != CFNumberGetTypeID())
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412546;
      ...
      _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_ERROR, "Invalid type for \"%@\": %ld", buf, 0x16u);
      CFGetTypeID(v3);
      _MBLog();
    }
    CFRelease(v3);
  ...
  if (v4 != CFStringGetTypeID())
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412802;
      ...
      _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_ERROR, "Invalid type for %@/\"%@\": %ld", buf, 0x20u);
      CFGetTypeID(v3);
      _MBLog();
    }
    CFRelease(v3);
  ...
  if (a3)
  {
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        *(_DWORD *)buf = 138412290;
        id v13 = a3;
        _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_DEFAULT, "Updated the device name to \"%@\"", buf, 0xCu);
      }
      else
      {
        ...
        *(_DWORD *)buf = 138412290;
        id v13 = v11;
        _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_ERROR, "Failed to update the device name: %@", buf, 0xCu);
      }
    }
    else
    {
      ...
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_ERROR, "Failed to connect to lockdown to update the device name", buf, 2u);
    }
    _MBLog();
  }
}
