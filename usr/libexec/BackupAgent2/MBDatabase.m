...
LABEL_11:
    ...
    if (v8 < 5.0 || v8 >= 6.0)
    {
      id v11 = [objc_alloc((Class)MBException) initWithCode:203 format:@"Unsupported database version: %0.1f", *(void *)&v7->_version];
      goto LABEL_11;
    }
...
- (MBDatabase)initWithDrive:(id)a3 path:(id)a4 domainManager:(id)a5 error:(id *)a6
{
  id v9 = [a3 dataAtPath:a4 options:&off_1000FDF28 error:a6];
  if (v9)
  {
...
- (id)indexFromDatabaseIgnoringTruncation:(BOOL)a3
{
  ...
  if (v6 < (id)[(NSData *)[(MBDecoder *)v5 data] length])
  {
    do
    {
      ...
      [v4 setOffset:&v8[-offsetBase] flags:[+[MBDatabaseIndex flagsForMode:](MBDatabaseIndex, "flagsForMode:", -[MBFile mode](v10, "mode"))] forFileID:-[MBFile fileID](v10, "fileID")];
