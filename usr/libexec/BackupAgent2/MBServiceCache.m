...
+ (id)cacheWithPath:(id)a3
{
  v3 = [[MBServiceCache alloc] initWithPath:a3 domainManager:[MBDomainManager alloc] initWithPersona:+[MBPersona personalPersonaWithError:](MBPersona, "personalPersonaWithError:", 0)];
...
- (MBServiceCache)initWithPath:(id)a3 domainManager:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (qword_100112ED8 != -1) {
      dispatch_once(&qword_100112ED8, &stru_1000F1468);
    }
    v8 = (void *)qword_100112EE0;
    objc_sync_enter((id)qword_100112EE0);
    v9 = (NSMutableSet *)[(id)qword_100112EE0 objectForKeyedSubscript:a3];
    v6->_upToDateBackupUDIDs = v9;
    if (!v9)
    {
      v10 = (NSMutableSet *)objc_alloc_init((Class)NSMutableSet);
      v6->_upToDateBackupUDIDs = v10;
      [(id)qword_100112EE0 setObject:v10 forKeyedSubscript:a3];
    }
    objc_sync_exit(v8);
...
- (void)_raise:(id)a3
{
  ...
  if (db)
  {
    ...
    id v4 = [v4 stringByAppendingFormat:@" (%d(%d)/%s)", v6, sqlite3_extended_errcode(self->_db), v7];
...
- (void)_profile:(id)a3 time:(double)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    {
      uint64_t v9 = v8;
      [v8 setObject:[+[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", (char *)objc_msgSend(objc_msgSend(v8, "objectAtIndexedSubscript:", 0), "integerValue") + 1)] atIndexedSubscript:0];
      [v9[1] doubleValue];
    ...
    if (v7)
    {
      ...
      do
      {
        for (i = 0; i != v8; i = (char *)i + 1)
        {
          ...
          id v13 = [[v12 objectAtIndexedSubscript:0] integerValue];
          [v12[1] doubleValue];
          uint64_t v15 = v14;
          v16 = MBGetSQLLog();
          if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
          {
            id v17 = sub_100015278(v11);
...
LABEL_21:
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
      sqlite3_trace_v2(*p_db, 1u, (int (__cdecl *)(unsigned int, void *, void *, void *))sub_10001584C, 0);
    }
...
- (id)creationDate
{
  [self propertyForKey:@"Created"].floatValue;
  double v3 = v2;
...
LABEL_7:
  [v9 setAttributes:[[MBSBackupAttributes alloc] initWithData:[v8 blobColumn:1]]];
  [v9 setSnapshots:[[-[MBServiceCache snapshotsForBackupUDID:](self, "snapshotsForBackupUDID:", a3) mutableCopy];
LABEL_9:
  [v8 reset];
  return v9;
}
...
- (void)keybagUUID:(id *)a3 keybagID:(unsigned int *)a4 forBackupUDID:(id)a5
{
  id v7 = [[objc_msgSend(-[MBServiceCache backupForUDID:lastModified:](self, "backupForUDID:lastModified:", a5, 0), "snapshots") lastObject];
  id v8 = v7;
  if (a3) {
    *a3 = [objc_msgSend(v7, "attributes") keybagUUID];
  }
  if (a4) {
    *a4 = [objc_msgSend(v8, "attributes") keybagID];
  }
}
...
LABEL_5:
  ...
  [v8 bindBlob:[objc_msgSend(objc_msgSend(a3, "attributes"), "data")] atIndex:3];
  [v8 step];
...
- (id)_snapshotWithStmt:(id)a3
{
  ...
  [v4 setSnapshotID:[a3 intColumn:1]];
  [v4 setLastModified:[a3 int64Column:2]];
  [v4 setCommitted:[a3 int64Column:3]];
  [v4 setAttributes:-[MBSSnapshotAttributes initWithData:]([MBSSnapshotAttributes alloc], "initWithData:", [a3 blobColumn:6])];
  return v4;
}
...
- (id)snapshotsForBackupUDID:(id)a3
{
  ...
  [v6 reset];
  [v5 sortUsingComparator:&stru_1000F14D0];
  return v5;
}
...
LABEL_3:
  ...
  [v8 bindInteger:[a3 snapshotID] atIndex:2];
  [v8 bindInt64:[a3 lastModified] atIndex:3];
  [v8 bindInt64:[a3 committed] atIndex:4];
  [v8 bindInt64:[a3 committed] atIndex:5];
  [v8 bindInt:0 atIndex:6];
  [v8 bindBlob:[objc_msgSend(objc_msgSend(a3, "attributes"), "data")] atIndex:7];
  [v8 step];
...
- (void)removeSnapshotForID:(unint64_t)a3 backupUDID:(id)a4 lastModified:(int64_t)a5
{
  ...
  if ([v9 count])
  {
    ...
    if ([v11 committed])
    {
      ...
      {
        unint64_t v12 = [[v9 objectAtIndexedSubscript:v10 + 1] snapshotID];
...
LABEL_8:
  ...
  unint64_t v14 = [[v10 objectAtIndexedSubscript:v11 - 1] snapshotID];
  ...
  [v20 bindInt64:[v12 committed] atIndex:2];
  [v20 bindInt64:v13 atIndex:3];
  [v20 bindBlob:[objc_msgSend(objc_msgSend(v12, "attributes"), "data")] atIndex:4];
...
LABEL_3:
  ...
  [v9 bindText:[a3 string] atIndex:2];
  if ([v9 step])
  {
    do
      [v8 addObject:[[self _fileWithStmt:v9]];
    while (([v9 step] & 1) != 0);
  }
  [v9 reset];
  [v8 sortUsingComparator:&stru_1000F14F0];
...
LABEL_3:
  ...
  [v10 bindText:[a3 string] atIndex:3];
  if ([v10 step]) {
...
- (void)addFile:(id)a3 snapshotID:(unint64_t)a4 backupUDID:(id)a5 committed:(BOOL)a6
{
  ...
  {
    -[[NSAssertionHandler currentHandler] handleFailureInMethod:object:file:lineNumber:description:](NSAssertionHandler, "currentHandler", self, @"MBServiceCache.m", 1155, @"Self-referencing duplicate file: %@:%@ (%@)", [a3 domain], objc_msgSend(a3, "relativePath"), objc_msgSend(a3, "fileID"));
    if (a5) {
      goto LABEL_8;
    }
  }
...
LABEL_8:
  ...
  [v12 bindText:[a3 domain] atIndex:4];
  ...
  [v12 bindBlob:[a3 signature] atIndex:6];
  [v12 bindInt64:[a3 size] atIndex:7];
  [v12 bindInt64:[a3 added] atIndex:8];
  [v12 bindInt:v6 atIndex:9];
  [v12 bindInt:[a3 hasAttributes] ^ 1 atIndex:10];
  [v12 bindBlob:[objc_msgSend(objc_msgSend(a3, "duplicateFile"), "fileID")] atIndex:11];
  [v12 bindInt:[objc_msgSend(objc_msgSend(a3, "duplicateFile"), "snapshotID")] atIndex:12];
  if ([a3 hasAttributes])
  {
    id v15 = [a3 attributes];
    [v12 bindText:[v15 target] atIndex:13];
    [v12 bindInteger:[v15 keybagID] atIndex:14];
    [v12 bindBlob:[v15 encryptionKey] atIndex:15];
    [v12 bindInt:[v15 encryptionKeyVersion] atIndex:16];
    [v12 bindInt64:[v15 decryptedSize] atIndex:17];
    [v12 bindInt:[v15 mode] atIndex:18];
    [v12 bindInt64:[v15 inodeNumber] atIndex:19];
    [v12 bindInt:[v15 userID] atIndex:20];
    [v12 bindInt:[v15 groupID] atIndex:21];
    [v12 bindInt64:[v15 lastModified] atIndex:22];
    [v12 bindInt64:[v15 lastStatusChange] atIndex:23];
    [v12 bindInt64:[v15 birth] atIndex:24];
    [v12 bindInt:[v15 protectionClass] atIndex:25];
    [v12 bindInteger:[v15 extendedAttributesCount] atIndex:26];
  }
  [v12 step];
  [v12 reset];
  if (objc_msgSend(objc_msgSend(a3, "attributes"), "extendedAttributesCount"))
  {
    ...
    long long v26 = 0u;
    long long v27 = 0u;
    id v18 = [objc_msgSend(a3, "attributes") extendedAttributes];
    ...
    if (v19)
    {
      ...
      do
      {
        for (i = 0; i != v20; i = (char *)i + 1)
        {
          ...
          [v17 bindText:[v23 name] atIndex:2];
          [v17 bindBlob:[v23 value] atIndex:3];
          [v17 step];
          [v17 reset];
        }
...
- (void)removeFileID:(id)a3 forSnapshotID:(unint64_t)a4 backupUDID:(id)a5
{
  ...
  [v8 bindText:[a3 string] atIndex:3];
  [v8 step];
...
- (void)setCommitted:(BOOL)a3 forFileID:(id)a4 snapshotID:(unint64_t)a5 backupUDID:(id)a6
{
  ...
  [v10 bindText:[a4 string] atIndex:2];
...
- (id)encryptionKeyForFileWithID:(id)a3 backupUDID:(id)a4
{
  ...
  [v6 bindText:a4 atIndex:1];
  [v6 bindText:[a3 string] atIndex:2];
  if ([v6 step]) {
...
- (BOOL)isDomainNameEnabled:(id)a3
{
  return [[-[MBServiceCache _disabledDomainNames](self, "_disabledDomainNames") containsObject:a3]];
}
...
- (void)setDisabledDomainNames:(id)a3 restrictedDomainNames:(id)a4
{
  ...
  -[MBServiceCache addDisabledDomainNames:restricted:](self, "addDisabledDomainNames:restricted:", [-[MBServiceCache configuration](self, "configuration") domainNamesNotToBackUp], 1);
...
- (BOOL)_rebuildSnapshot:(id)a3 backupUDID:(id)a4 service:(id)a5 error:(id *)a6
{
  id v7 = a5;
  long long v11 = 0;
  long long v12 = &AnalyticsSendEventLazy_ptr;
  while (1)
  {
    id v13 = objc_alloc_init((Class)v12[461]);
    id v14 = [v7 listFilesForBackupUDID:a4 snapshotID:[a3 snapshotID] offset:v11 limit:[-[MBServiceCache configuration](self, "configuration") listFilesCount] error:a6];
    if (!v14) {
      break;
    }
    long long v15 = v14;
    ...
    id v27 = [obj count];
    BOOL v28 = v27 >= [v27 configuration][v27 configuration listFilesCount];
    id v13 = v38;
    id v7 = a5;
    long long v12 = &AnalyticsSendEventLazy_ptr;
    if (!v28)
...
LABEL_34:
      ...
      BOOL v33 = 1;
      [v35 bindInteger:[a3 snapshotID] atIndex:1];
      [v35 step];
      [v35 reset];
      return v33;
    }
...
LABEL_3:
  ...
  if ([(MBServiceCache *)self isRefreshNeededForBackupUDID:a3])
  {
    ...
    if (!self->_configurationUpToDate)
    {
      ...
      long long v15 = +[MBServiceConfiguration configurationWithURL:sub_10000B644() error:a6];
      if (!v15)
      {
        if (a6)
        {
    ...
    uint64_t v106 = 0;
    id v18 = [a4 backupForUDID:a3 lastModified:&v106 error:&v107];
    if (v18
      ...
      if (v31)
      {
        ...
        do
        {
          for (i = 0; i != v31; i = (char *)i + 1)
          {
            ...
            [v28 setObject:*((void *)&v101 + 1) + 8 * i forKey:[NSNumber numberWithInteger:objc_msgSend(*(id *)(*((void *)&v101 + 1) + 8 * i), "snapshotID")]];
          }
          id v31 = [v30 countByEnumeratingWithState:&v101 objects:v117 count:16];
        }
        while (v31);
        ...
        if (v35)
        {
          ...
          do
          {
            for (j = 0; j != v35; j = (char *)j + 1)
            {
              ...
              [v29 setObject:*((void *)&v97 + 1) + 8 * j forKey:[NSNumber numberWithInteger:objc_msgSend(*((id *)&v97 + 1) + 8 * j, "snapshotID")]];
            }
            id v35 = [v34 countByEnumeratingWithState:&v97 objects:v116 count:16];
          }
          while (v35);
...
LABEL_51:
      ...
      while (1)
      {
        ...
        if (v52 != [v41 committed])
        {
          ...
          -[MBServiceCache setCommitted:forSnapshotID:backupUDID:](v87, "setCommitted:forSnapshotID:backupUDID:", [v41 committed], v42, a3);
        }
...
- (void)verifyBackupUDID:(id)a3 service:(id)a4
{
  ...
  [v15 verifyEqualToStmt:v16 exceptColumnNumbers:[NSSet setWithObjects:+[NSNumber numberWithInt:](NSNumber, "numberWithInt:", 4), +[NSNumber numberWithInt:](NSNumber, "numberWithInt:", 5)]];
  ...
  [v17 verifyEqualToStmt:v18 exceptColumnNumbers:[NSSet setWithObjects:NSSet, "setWithObjects:", [NSNumber numberWithInt:NSNumber, "numberWithInt:", 0], [NSNumber numberWithInt:NSNumber, "numberWithInt:", 8], [NSNumber numberWithInt:NSNumber, "numberWithInt:", 9], 0]];
...
- (id)_fileChangeFromStmt:(id)a3
{
  ...
  [v11 setFileID:v6];
  [v11 setType:[a3 intColumn:1]];
  [v11 setDomainName:[a3 textColumn:2]];
  [v11 setRelativePath:[a3 textColumn:3]];
  [v11 setDuplicateFileReference:v10];
  [v11 setSize:[a3 int64Column:6]];
  [v11 setResult:[a3 intColumn:7]];
  return v11;
}
...
- (id)fileChangeIDsWithResult:(int)a3 offset:(unint64_t)a4 limit:(unint64_t)a5
{
  ...
  {
    do
      [v9 addObject:[+[MBFileID fileIDWithString:](MBFileID, "fileIDWithString:", objc_msgSend(v10, "textColumn:", 0))]];
    while (([v10 step] & 1) != 0);
  }
  [v10 reset];
  return v9;
...
- (void)addFileChange:(id)a3
{
  ...
  [v6 bindText:[objc_msgSend(objc_msgSend(a3, "fileID"), "string")] atIndex:1];
  [v6 bindInt:[a3 type] atIndex:2];
  [v6 bindText:[a3 domainName] atIndex:3];
  [v6 bindText:[a3 relativePath] atIndex:4];
  [v6 bindBlob:[objc_msgSend(objc_msgSend(a3, "duplicateFileReference"), "fileID")] atIndex:5];
  [v6 bindInt:[objc_msgSend(objc_msgSend(a3, "duplicateFileReference"), "snapshotID")] atIndex:6];
  [v6 bindInt64:[a3 size] atIndex:7];
  [v6 bindInt:[a3 result] atIndex:8];
  [v6 step];
...
- (void)setResult:(int)a3 forFileChangeID:(id)a4
{
  ...
  [v7 bindText:[a4 string] atIndex:2];
  [v7 step];
...
- (unint64_t)restoreIDForMode:(id)a3
{
  ...
  [v6 bindInt:[a3 type] atIndex:1];
  if ([a3 value]) {
    [v6 bindText:[a3 value] atIndex:2];
  }
  if ([v6 step])
  {
  ...
  [v10 bindInt:[a3 type] atIndex:2];
  [v10 bindText:[a3 value] atIndex:3];
  [v10 step];
  [v10 reset];
  return v8;
}
...
- (id)_restoreFileWithStmt:(id)a3
{
  ...
  [v4 setRestoreID:(int)[a3 intColumn:0]];
  [v4 setFileID:[MBFileID fileIDWithString:](MBFileID, "fileIDWithString:", [a3 textColumn:1])];
  [v4 setSnapshotID:(int)[a3 intColumn:2]];
  [v4 setItemID:([a3 intColumn:3])];
  [v4 setState:[a3 intColumn:4]];
  [v4 setPriority:[a3 intColumn:5]];
  return v4;
}
...
- (id)_restoreFilesWithStmt:(id)a3
{
  ...
  {
    do
      [v5 addObject: -[MBServiceCache _restoreFileWithStmt:](self, "_restoreFileWithStmt:", a3)];
    while (([a3 step] & 1) != 0);
  }
  return v5;
}
...
- (id)restoreFilesForSnapshotID:(unint64_t)a3 backupUDID:(id)a4 restoreID:(unint64_t)a5 pendingOnly:(BOOL)a6 offset:(unint64_t)a7 limit:(unint64_t)a8
{
  ...
  id v16 = -[[MBServiceCache _prepare:](self, "_prepare:", [@"select RestoreFiles.* from RestoreFiles, Files where RestoreFiles.restoreID = ? and RestoreFiles.snapshotID = ? and Files.backupUDID = ? and Files.snapshotID = ? and Files.fileID = RestoreFiles.fileID ", "stringByAppendingString:", v15]);
...
- (id)restoreFileForFileID:(id)a3
{
  ...
  [v5 bindText:[a3 string] atIndex:1];
  if ([v5 step]) {
...
- (void)addRestoreFile:(id)a3
{
  ...
  [v6 bindInteger:[a3 restoreID] atIndex:1];
  [v6 bindText:[objc_msgSend(objc_msgSend(a3, "fileID"), "string")] atIndex:2];
  [v6 bindInteger:[a3 snapshotID] atIndex:3];
  [v6 bindInt64:[a3 itemID] atIndex:4];
  [v6 bindInt:[a3 state] atIndex:5];
  [v6 step];
...
- (void)setRestoreID:(unint64_t)a3 forRestoreFile:(id)a4
{
  ...
  [v6 bindInteger:[a4 restoreID] atIndex:2];
  [v6 bindText:[objc_msgSend(objc_msgSend(a4, "fileID"), "string")] atIndex:3];
  [v6 step];
...
- (void)setState:(int)a3 forFileID:(id)a4 restoreID:(unint64_t)a5
{
  ...
  [v8 bindText:[a4 string] atIndex:3];
  [v8 step];
...
- (void)prioritizeRestoreFileWithFileID:(id)a3
{
  ...
  [v4 bindText:[a3 string] atIndex:1];
  [v4 step];
...
- (id)pathsToRestoreForDomain:(id)a3 absolutePath:(id)a4 pendingOnly:(BOOL)a5 backupUDID:(id)a6 range:(_NSRange)a7
{
  ...
  {
    do
      [v14 addObject:[v17 textColumn:0]];
    while (([v17 step] & 1) != 0);
  }
  [v17 reset];
  return v14;
  ...
  if ([v8 step])
  {
    do
    {
      ...
      if (v12)
      {
        ...
        {
          [v7 setObject:+[NSNumber numberWithUnsignedChar:](NSNumber, "numberWithUnsignedChar:", v11) forKeyedSubscript:[objc_msgSend(objc_msgSend(v13, "rootPath"), "stringByAppendingPathComponent:", v10)];
          continue;
        }
        id v14 = MBGetDefaultLog();
...
LABEL_8:
    ...
    while ([v8 step:v17 with:v18] & 1) != 0);
  }
  [v8 reset];
  return v7;
}
...
- (void)addRestoreFailure:(id)a3
{
  ...
  [v4 bindText:[a3 identifier] atIndex:1];
  [v4 bindText:[a3 dataclass] atIndex:2];
  [v4 bindText:[a3 assetType] atIndex:3];
  [v4 bindText:[a3 displayName] atIndex:4];
  [v4 bindBlob:[a3 icon] atIndex:5];
  if ([a3 error]) {
    [v4 bindBlob:[+[NSKeyedArchiver archivedDataWithRootObject:requiringSecureCoding:error:](NSKeyedArchiver, "archivedDataWithRootObject:requiringSecureCoding:error:", objc_msgSend(a3, "error"), 1, 0)] atIndex:6];
  }
  [v4 step];
...
- (unint64_t)countOfRestoreFailuresForDataclass:(id)a3 assetType:(id)a4
{
  ...
  CFStringRef v7 = &stru_1000F43B0;
  if (!a3) {
    CFStringRef v6 = &stru_1000F43B0;
  }
  if (a4) {
...
- (id)restoreFailuresForDataClass:(id)a3 assetType:(id)a4 range:(_NSRange)a5
{
  ...
  CFStringRef v12 = &stru_1000F43B0;
  if (!a3) {
    CFStringRef v11 = &stru_1000F43B0;
  }
  if (a4) {
...
LABEL_8:
  uint64_t v17 = (v15 + 1);
  [v14 bindInteger:length atIndex:0];
  ...
  if ([v14 step])
  {
    do
    {
      ...
      [v18 setIdentifier:[v14 textColumn:0]];
      [v18 setDataclass:[v14 textColumn:1]];
      [v18 setAssetType:[v14 textColumn:2]];
      [v18 setDisplayName:[v14 textColumn:3]];
      [v18 setIcon:[v14 blobColumn:4]];
      id v19 = [v14 blobColumn:5];
      if (v19) {
        [v18 setError:+[NSKeyedUnarchiver unarchivedObjectOfClass:fromData:error:](NSKeyedUnarchiver, "unarchivedObjectOfClass:fromData:error:", objc_opt_class(), v19, 0)];
      }
      [v10 addObject:v18];
    }
    while (([v14 step] & 1) != 0);
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [v8 bindText:a4 atIndex:1];
        [v8 bindInt:[v13 bagID] atIndex:2];
        [v8 bindBlob:[+[NSData dataWithBytesNoCopy:length:freeWhenDone:](NSData, "dataWithBytesNoCopy:length:freeWhenDone:", objc_msgSend(v13, "uuid"), 16, 0)], atIndex:3];
        [v8 step];
        [v8 reset];
        id v12 = (char *)v12 + 1;
      }
...
- (void)addKeyBagInfo:(id)a3 forBackupUDID:(id)a4
{
  ...
  [v6 bindText:a4 atIndex:1];
  [v6 bindInt:[a3 bagID] atIndex:2];
  [v6 bindBlob:[+[NSData dataWithBytesNoCopy:length:freeWhenDone:](NSData, "dataWithBytesNoCopy:length:freeWhenDone:", objc_msgSend(a3, "uuid"), 16, 0)] atIndex:3];
  [v6 step];
...
- (id)keyBagInfoForBackupUDID:(id)a3
{
  ...
  if ([v6 step])
  {
    while (1)
    {
      ...
      [v5 addObject:[+[MBKeyBagInfo infoWithID:uuid:](MBKeyBagInfo, "infoWithID:uuid:", objc_msgSend(v6, "intColumn:", 0), objc_msgSend(v7, "bytes"))]];
      if (([v6 step] & 1) == 0) {
        goto LABEL_4;
      }
    }
