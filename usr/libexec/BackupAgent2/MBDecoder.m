...
- (double)decodeVersion
{
  ...
  if (v3 <= 0)
  {
    id v6 = [objc_alloc((Class)MBException) initWithCode:11 format:@"Invalid major version: %d", v3];
    goto LABEL_6;
  }
  if (v4 >= 0xA)
  {
    id v6 = [objc_alloc((Class)MBException) initWithCode:11 format:@"Invalid minor version: %d", v4];
LABEL_6:
