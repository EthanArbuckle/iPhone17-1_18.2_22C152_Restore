...
- (id)fileWithID:(id)a3
{
  ...
  if ((objc_msgSend(objc_msgSend(v7, "fileID"), "isEqualToFileID:", a3) & 1) == 0) {
    objc_exception_throw([objc_alloc((Class)MBException) initWithCode:11, @"File ID doesn't match index: %@-%@ (%@ vs %@)", [objc_msgSend(objc_msgSend(v7, "domain"), "name") stringByAppendingPathComponent:[v7 relativePath]], [v7 fileID], a3 format]);
  }
  return v7;
}
