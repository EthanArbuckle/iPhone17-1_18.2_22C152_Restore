...
- (id)preparingBackupWithEngine:(id)a3
{
  ...
  if (v59)
  {
    ...
    if (v7)
    {
      ...
      do
      {
        for (i = 0; i != v7; i = (char *)i + 1)
        {
          ...
          [(NSDictionary *)sub_1000475E8() objectForKeyedSubscript:v10];
    ...
    if (objc_msgSend(a3, "backsUpPrimaryAccount", v44, v48))
    {
      ...
      if (v14)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            id v18 = [v59 objectForDomain:v16 andKey:0, v46];
            v19 = v18;
            if (v18)
            {
              v54 = v16;
              ...
              if (v20)
              {
                ...
                do
                {
                  for (j = 0; j != v20; j = (char *)j + 1)
                  {
                    ...
                    id v24 = [v19 objectForKeyedSubscript:v23, v46, v49];
                    v25 = MBGetDefaultLog();
            ...
            else
            {
              if (sub_100092304())
              {
                if (!dword_100112FA4 && !atomic_fetch_add_explicit(&dword_100112FA4, 1u, memory_order_relaxed))
                {
                  v26 = MBGetDefaultLog();
      ...
      long long v64 = 0u;
      long long v65 = 0u;
      id v28 = [&off_1000FDED8 countByEnumeratingWithState:&v64 objects:v81 count:16];
      if (v28)
      {
        ...
        do
        {
          ...
          {
            if (*(void *)v65 != v53) {
              objc_enumerationMutation(&off_1000FDED8);
            }
            ...
            long long v60 = 0u;
            long long v61 = 0u;
            id v33 = [&off_1000FDED8 objectForKeyedSubscript:v30];
            ...
            if (v34)
            {
              ...
              do
              {
                for (k = 0; k != v34; k = (char *)k + 1)
                {
                  ...
                  id v38 = [v59 objectForDomain:v30 andKey:v37, v47, v49];
                  v39 = MBGetDefaultLog();
    ...
    [objc_msgSend(a3, "properties", v45) setLockdownKeys:v58];
    return 0;
  }
  else
  {
    if (sub_100092304())
    {
      if (!dword_100112FA0 && !atomic_fetch_add_explicit(&dword_100112FA0, 1u, memory_order_relaxed))
      {
        v40 = MBGetDefaultLog();
...
- (id)endedBackupWithEngine:(id)a3 error:(id)a4
{
  ...
  *(void *)buf = 0;
  ...
  if ([a3 isCloudKitEngine])
  {
    ...
    v27[3] = &unk_1000F1A28;
    v27[4] = buf;
    [objc_msgSend(a3, "cache") enumerateSnapshots:v27];
LABEL_20:
...
- (id)_savePurpleBuddyRestoreState:(id)a3 persona:(id)a4
{
  id v5 = [[objc_msgSend(a4, "userIncompleteRestoreDirectory") stringByAppendingPathComponent:@"/var/mobile/Library/Preferences/com.apple.purplebuddy.plist"];
  v6 = MBGetDefaultLog();
...
- (id)_restoreLockdownKeysWithEngine:(id)a3
{
  ...
  id v4 = [[objc_msgSend(a3, "properties") lockdownKeys];
  if (v4)
  {
    id v5 = v4;
    ...
    if (v11)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          id v17 = [v8 objectForDomain:v14 andKey:0, v51];
          uint64_t v18 = v17;
          if (!v17)
          {
...
LABEL_73:
          ...
          id v25 = [v60 objectForKeyedSubscript:v14, v52];
          long long v73 = 0u;
          long long v74 = 0u;
          long long v71 = 0u;
          long long v72 = 0u;
...
LABEL_34:
    ...
    long long v67 = 0u;
    long long v68 = 0u;
    id v33 = [&off_1000FDED8 countByEnumeratingWithState:&v67 objects:v84 count:16];
    if (v33)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          uint64_t v61 = v35;
          id v38 = [v5 objectForKeyedSubscript:v36, v51];
          long long v65 = 0u;
          long long v66 = 0u;
          long long v63 = 0u;
          long long v64 = 0u;
          id v39 = [&off_1000FDED8 objectForKeyedSubscript:v36];
