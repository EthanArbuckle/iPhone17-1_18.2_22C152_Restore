...
+ (id)containerWithPropertyList:(id)a3 volumeMountPoint:(id)a4
{
  ...
  int v8 = sub_10003F524(v7);

  id v9 = [objc_alloc(*off_1000F1950[v8]) initWithPropertyList:v5 volumeMountPoint:v6];
    ...
    do
    {
      ...
      do
      {
        ...
        if (qword_100112F08 != -1) {
          dispatch_once(&qword_100112F08, &stru_1000F17E8);
        }
        if ([(id)qword_100112F00 containsObject:v9]) {
