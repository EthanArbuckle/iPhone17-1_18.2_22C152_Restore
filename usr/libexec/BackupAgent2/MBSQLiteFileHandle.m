...
+ (BOOL)isSQLiteFileHandle:(id)a3 result:(BOOL *)a4 error:(id *)a5
{
  id v7 = a3;
  *a4 = 0;
  long long v28 = xmmword_1000B0EF0;
  uint64_t v29 = 0;
  uint64_t v27 = 0;
  int v8 = [v7 fd];
...
+ (BOOL)compactSQLiteDatabaseAtPath:(id)a3 toPath:(id)a4 error:(id *)a5
{
  ...
  uint64_t v31 = (void **)&AnalyticsSendEventLazy_ptr;
  ...
  *(double *)&uint64_t v42 = COERCE_DOUBLE(_sqlite3_db_copy_compact());
  if (v42)
  {
    ...
    while (1)
    {
      ...
      uint64_t v31 = v44;
      [v44[466] timeIntervalSinceReferenceDate];
      if (v48 - v41 >= 1.0)
      {
      ...
      [v45 + 478 removeAllSQLiteFilesAtPath:*(void *)&v12];
...
LABEL_10:
  ...
  id v67 = v19;
  unsigned __int8 v24 = [p_cache + 478 removeJournalsForSQLiteFileAtPath:v12 error:&v67 v62 v63 v64];
  id v25 = v67;
  ...
  {
    id v66 = v25;
    unsigned __int8 v27 = [p_cache + 478 removeSQLiteFileAtPath:*(void *)&v12 error:&v66];
    id v28 = v66;
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        double v13 = [v5 stringByAppendingString:*(void *)(*((void *)&v22 + 1) + 8 * i) v19];
