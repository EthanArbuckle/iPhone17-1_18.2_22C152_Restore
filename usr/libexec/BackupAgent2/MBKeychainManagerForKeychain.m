...
+ (BOOL)removeLocalBackupPassword:(id *)a3
{
  return [a1 removeValueWithServiceName:@"BackupAgent" accountName:@"BackupPassword" error:a3];
}

+ (BOOL)removeKeybagSecretsWithError:(id *)a3
{
  return [a1 removeValueWithServiceName:@"BackupKeybagSecret" error:a3];
}

+ (BOOL)removeKeybagSecretForUUID:(id)a3 error:(id *)a4
{
  return [a1 removeValueWithServiceName:@"BackupKeybagSecret" accountName:a3 error:a4];
}
