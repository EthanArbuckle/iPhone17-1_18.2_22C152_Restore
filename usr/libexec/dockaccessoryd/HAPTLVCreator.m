...
- (id)serialize
{
  ...
  {
    v2 = +[NSData dataWithBytes:self->_tlv.ptr length:self->_tlv.len];
  }
...
- (BOOL)addTLV:(unint64_t)a3 length:(unint64_t)a4 number:(id)a5
{
  ...
  id v11 = [a5 unsignedIntegerValue];
  BOOL v8 = +[NSData dataWithBytes:&v11 length:a4];
...
- (BOOL)addTLV:(unint64_t)a3 length:(unint64_t)a4 floatNumber:(id)a5
{
  ...
  [a5 floatValue];
  int v12 = v8;
  BOOL v9 = +[NSData dataWithBytes:&v12 length:a4];
