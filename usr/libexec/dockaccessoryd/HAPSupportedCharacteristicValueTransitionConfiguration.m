...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    id v10 = 0;
    [(HAPSupportedCharacteristicValueTransitionConfiguration *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPSupportedCharacteristicValueTransitionConfiguration;
...
- (HAPSupportedCharacteristicValueTransitionConfiguration)initWithTransitions:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HAPSupportedCharacteristicValueTransitionConfiguration;
  id v5 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)&v9 init];
  if (v5)
  {
  ...
  if (v8 >= 1)
  {
    ...
    while (1)
    {
      ...
      if (v24 == 1)
      {
        ...
        {
          id v20 = 0;
          v15 = +[HAPSupportedCharacteristicValueTransition parsedFromData:v13 error:&v20];
          id v14 = v20;
          if (!v14) {
            [v9 addObject:v15];
          }
...
LABEL_19:
  [(HAPSupportedCharacteristicValueTransitionConfiguration *)self setTransitions:v9];
  id v10 = 0;
  BOOL v17 = 1;
LABEL_21:
...
- (id)serializeWithError:(id *)a3
{
  ...
  long long v28 = 0u;
  long long v29 = 0u;
  id v5 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)self transitions];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[HAPSupportedCharacteristicValueTransitionConfiguration allocWithZone:a3];
  id v5 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)self transitions];
  id v6 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)v4 initWithTransitions:v5];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (HAPSupportedCharacteristicValueTransitionConfiguration *)a3;
  if (self == v4)
  {
  ...
  else
  {
    ...
    {
      id v5 = v4;
      id v6 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)self transitions];
      id v7 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)v5 transitions];
      if (v6 == v7)
      {
        unsigned __int8 v10 = 1;
      }
      ...
      {
        uint64_t v8 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)self transitions];
        char v9 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)v5 transitions];
...
- (NSString)description
{
  ...
  objc_super v3 = +[NSString stringWithFormat:@"<HAPSupportedCharacteristicValueTransitionConfiguration transitions=%@>", v2];
