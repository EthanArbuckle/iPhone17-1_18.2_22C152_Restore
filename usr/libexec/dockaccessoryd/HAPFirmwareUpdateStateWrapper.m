...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (!v12)
  {
    [(HAPFirmwareUpdateStateWrapper *)self setValue:v8];
    goto LABEL_10;
  }
  if (a4)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      int64_t v7 = [(HAPFirmwareUpdateStateWrapper *)v5 value];
...
- (NSString)description
{
  ...
  unint64_t v3 = +[NSString stringWithFormat:@"<HAPFirmwareUpdateStateWrapper value=%@>", v2];
