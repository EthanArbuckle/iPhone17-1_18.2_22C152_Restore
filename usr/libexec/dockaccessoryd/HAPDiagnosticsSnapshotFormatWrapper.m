...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    id v10 = 0;
    [(HAPDiagnosticsSnapshotFormatWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (!v12)
  {
    [(HAPDiagnosticsSnapshotFormatWrapper *)self setValue:v8];
    goto LABEL_10;
  }
  if (a4)
  {
...
- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPDiagnosticsSnapshotFormatWrapper *)self value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HAPDiagnosticsSnapshotFormatWrapper *)self value];
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPDiagnosticsSnapshotFormatWrapper *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      int64_t v5 = v4;
      int64_t v6 = [(HAPDiagnosticsSnapshotFormatWrapper *)self value];
      int64_t v7 = [(HAPDiagnosticsSnapshotFormatWrapper *)v5 value];
...
- (NSString)description
{
  ...
  unint64_t v3 = +[NSString stringWithFormat:@"<HAPDiagnosticsSnapshotFormatWrapper value=%@>", v2];
