...
LABEL_5:
    id v10 = [(HAPDataStreamTransportConfiguration *)self maximumControllerTransportMTU];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v7 = [(HAPDataStreamTransportConfiguration *)v4 initWithTransport:v5 maximumControllerTransportMTU:v6];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      id v6 = v5;
      id v7 = [(HAPDataStreamTransportConfiguration *)self transport];
      id v8 = [(HAPDataStreamTransportConfiguration *)v6 transport];
      if (v7 != v8)
      {
        uint64_t v9 = [(HAPDataStreamTransportConfiguration *)self transport];
...
LABEL_14:
      ...
      v11 = [(HAPDataStreamTransportConfiguration *)self maximumControllerTransportMTU];
      uint64_t v12 = [(HAPDataStreamTransportConfiguration *)v6 maximumControllerTransportMTU];
      if (v11 == v12)
      {
        unsigned __int8 v10 = 1;
      }
      ...
      {
        id v13 = [(HAPDataStreamTransportConfiguration *)self maximumControllerTransportMTU];
...
- (NSString)description
{
  objc_super v3 = [(HAPDataStreamTransportConfiguration *)self transport];
  v4 = [(HAPDataStreamTransportConfiguration *)self maximumControllerTransportMTU];
  id v5 = +[NSString stringWithFormat:@"<HAPDataStreamTransportConfiguration transport=%@, maximumControllerTransportMTU=%@>", v3, v4];
