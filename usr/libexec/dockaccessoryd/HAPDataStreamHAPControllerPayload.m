...
- (id)serializeWithError:(id *)a3
{
  ...
  long long v27 = 0u;
  TLV8BufferInit();
  id v5 = [(HAPDataStreamHAPControllerPayload *)self payload];

  if (v5)
  {
    id v6 = [(HAPDataStreamHAPControllerPayload *)self payload];
    id v26 = 0;
...
LABEL_11:
  ...
  objc_super v15 = [(HAPDataStreamHAPControllerPayload *)self sessionIdentifier];
  id v25 = 0;
...
LABEL_15:
    ...
    uint64_t v19 = [(HAPDataStreamHAPControllerPayload *)self forceClose];
    id v24 = 0;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = [(HAPDataStreamHAPControllerPayload *)self payload];
  id v6 = [(HAPDataStreamHAPControllerPayload *)self sessionIdentifier];
  id v7 = [(HAPDataStreamHAPControllerPayload *)self forceClose];
  id v8 = [(HAPDataStreamHAPControllerPayload *)v4 initWithPayload:v5 sessionIdentifier:v6 forceClose:v7];
...
- (BOOL)isEqual:(id)a3
{
  id v6 = (HAPDataStreamHAPControllerPayload *)a3;
  if (self == v6)
  {
  ...
  else
  {
    ...
    {
      id v7 = v6;
      id v8 = [(HAPDataStreamHAPControllerPayload *)self payload];
      id v9 = [(HAPDataStreamHAPControllerPayload *)v7 payload];
      if (v8 != v9)
      {
        objc_super v3 = [(HAPDataStreamHAPControllerPayload *)self payload];
      ...
      id v11 = [(HAPDataStreamHAPControllerPayload *)self sessionIdentifier];
      uint64_t v12 = [(HAPDataStreamHAPControllerPayload *)v7 sessionIdentifier];
      if (v11 == v12)
      {
        id v25 = v11;
      }
      ...
      {
        uint64_t v13 = [(HAPDataStreamHAPControllerPayload *)self sessionIdentifier];
        id v26 = [(HAPDataStreamHAPControllerPayload *)v7 sessionIdentifier];
...
- (NSString)description
{
  ...
  id v5 = [(HAPDataStreamHAPControllerPayload *)self forceClose];
  id v6 = +[NSString stringWithFormat:@"<HAPDataStreamHAPControllerPayload payload=%@, sessionIdentifier=%@, forceClose=%@>", v3, v4, v5];
