...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    id v10 = 0;
    [(HAPCharacteristicValueTransitionPoint *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
...
- (id)serializeWithError:(id *)a3
{
  ...
  long long v27 = 0u;
  TLV8BufferInit();
  id v5 = [(HAPCharacteristicValueTransitionPoint *)self targetValue];

  if (v5)
  {
    id v6 = [(HAPCharacteristicValueTransitionPoint *)self targetValue];
    id v26 = 0;
...
LABEL_11:
  ...
  objc_super v15 = [(HAPCharacteristicValueTransitionPoint *)self targetCompletionDuration];
  id v25 = 0;
...
LABEL_15:
    ...
    uint64_t v19 = [(HAPCharacteristicValueTransitionPoint *)self startDelayDuration];
    id v24 = 0;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = [(HAPCharacteristicValueTransitionPoint *)self targetValue];
  id v6 = [(HAPCharacteristicValueTransitionPoint *)self targetCompletionDuration];
  id v7 = [(HAPCharacteristicValueTransitionPoint *)self startDelayDuration];
  id v8 = [(HAPCharacteristicValueTransitionPoint *)v4 initWithTargetValue:v5 targetCompletionDuration:v6 startDelayDuration:v7];
...
- (BOOL)isEqual:(id)a3
{
  id v6 = (HAPCharacteristicValueTransitionPoint *)a3;
  if (self == v6)
  {
  ...
  else
  {
    ...
    {
      id v7 = v6;
      id v8 = [(HAPCharacteristicValueTransitionPoint *)self targetValue];
      id v9 = [(HAPCharacteristicValueTransitionPoint *)v7 targetValue];
      if (v8 != v9)
      {
        objc_super v3 = [(HAPCharacteristicValueTransitionPoint *)self targetValue];
      ...
      id v11 = [(HAPCharacteristicValueTransitionPoint *)self targetCompletionDuration];
      uint64_t v12 = [(HAPCharacteristicValueTransitionPoint *)v7 targetCompletionDuration];
      if (v11 == v12)
      {
        id v25 = v11;
      }
      ...
      {
        uint64_t v13 = [(HAPCharacteristicValueTransitionPoint *)self targetCompletionDuration];
        id v26 = [(HAPCharacteristicValueTransitionPoint *)v7 targetCompletionDuration];
      ...
      v14 = [(HAPCharacteristicValueTransitionPoint *)self startDelayDuration];
      uint64_t v15 = [(HAPCharacteristicValueTransitionPoint *)v7 startDelayDuration];
      if (v14 == (void *)v15)
      {
...
- (NSString)description
{
  ...
  id v5 = [(HAPCharacteristicValueTransitionPoint *)self startDelayDuration];
  id v6 = +[NSString stringWithFormat:@"<HAPCharacteristicValueTransitionPoint targetValue=%@, targetCompletionDuration=%@, startDelayDuration=%@>", v3, v4, v5];
