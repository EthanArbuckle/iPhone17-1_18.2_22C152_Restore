...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    id v10 = 0;
    [(HAPFirmwareUpdateReadiness *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
...
LABEL_18:
    ...
    if (v29 == 2)
    {
      ...
      v24 = v11;
      v15 = &v24;
      +[HAPUpdateNotReadyReasonsWrapper parsedFromData:v14 error:&v24];
      v9 = v16 = v9;
      goto LABEL_9;
    }
    if (v29 == 1)
    {
      ...
      v25 = v11;
      v15 = &v25;
      +[HAPStagingNotReadyReasonsWrapper parsedFromData:v14 error:&v25];
      id v10 = v16 = v10;
LABEL_9:
      id v17 = *v15;
...
- (id)serializeWithError:(id *)a3
{
  ...
  long long v18 = 0u;
  TLV8BufferInit();
  id v5 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];

  if (!v5) {
    goto LABEL_5;
  }
  id v6 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];
  id v17 = 0;
...
LABEL_5:
    id v10 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];
  id v6 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
  id v7 = [(HAPFirmwareUpdateReadiness *)v4 initWithStagingNotReadyReasons:v5 updateNotReadyReasons:v6];
...
- (BOOL)isEqual:(id)a3
{
  id v5 = (HAPFirmwareUpdateReadiness *)a3;
  if (self == v5)
  {
  ...
  else
  {
    ...
    {
      id v6 = v5;
      id v7 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];
      id v8 = [(HAPFirmwareUpdateReadiness *)v6 stagingNotReadyReasons];
      if (v7 != v8)
      {
        uint64_t v9 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];
        objc_super v3 = [(HAPFirmwareUpdateReadiness *)v6 stagingNotReadyReasons];
        if (![v9 isEqual:v3])
        {
...
LABEL_14:
      ...
      v11 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
      uint64_t v12 = [(HAPFirmwareUpdateReadiness *)v6 updateNotReadyReasons];
      if (v11 == v12)
      {
        unsigned __int8 v10 = 1;
      }
      ...
      {
        id v13 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
...
- (NSString)description
{
  objc_super v3 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];
  v4 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
  id v5 = +[NSString stringWithFormat:@"<HAPFirmwareUpdateReadiness stagingNotReadyReasons=%@, updateNotReadyReasons=%@>", v3, v4];
