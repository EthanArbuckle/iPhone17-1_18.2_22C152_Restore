...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    id v10 = 0;
    [(HAPDataStreamTransportCommandStatusWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPDataStreamTransportCommandStatusWrapper;
...
{
  v5.receiver = self;
  v5.super_class = (Class)HAPDataStreamTransportCommandStatusWrapper;
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (!v12)
  {
    [(HAPDataStreamTransportCommandStatusWrapper *)self setValue:v8];
    goto LABEL_10;
  }
  if (a4)
  {
...
- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPDataStreamTransportCommandStatusWrapper *)self value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HAPDataStreamTransportCommandStatusWrapper *)self value];
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPDataStreamTransportCommandStatusWrapper *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      int64_t v5 = v4;
      int64_t v6 = [(HAPDataStreamTransportCommandStatusWrapper *)self value];
      int64_t v7 = [(HAPDataStreamTransportCommandStatusWrapper *)v5 value];
...
- (NSString)description
{
  ...
  unint64_t v3 = +[NSString stringWithFormat:@"<HAPDataStreamTransportCommandStatusWrapper value=%@>", v2];
