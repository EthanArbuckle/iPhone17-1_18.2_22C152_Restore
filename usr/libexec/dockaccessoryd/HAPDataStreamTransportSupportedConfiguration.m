...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    id v10 = 0;
    [(HAPDataStreamTransportSupportedConfiguration *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
...
- (HAPDataStreamTransportSupportedConfiguration)initWithConfigurations:(id)a3
{
  ...
  id v5 = [(HAPDataStreamTransportSupportedConfiguration *)&v9 init];
  if (v5)
  {
...
- (id)serializeWithError:(id *)a3
{
  ...
  long long v28 = 0u;
  long long v29 = 0u;
  id v5 = [(HAPDataStreamTransportSupportedConfiguration *)self configurations];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[HAPDataStreamTransportSupportedConfiguration allocWithZone:a3];
  id v5 = [(HAPDataStreamTransportSupportedConfiguration *)self configurations];
  id v6 = [(HAPDataStreamTransportSupportedConfiguration *)v4 initWithConfigurations:v5];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (HAPDataStreamTransportSupportedConfiguration *)a3;
  if (self == v4)
  {
  ...
  else
  {
    ...
    {
      id v5 = v4;
      id v6 = [(HAPDataStreamTransportSupportedConfiguration *)self configurations];
      id v7 = [(HAPDataStreamTransportSupportedConfiguration *)v5 configurations];
      if (v6 == v7)
      {
        unsigned __int8 v10 = 1;
      }
      ...
      {
        uint64_t v8 = [(HAPDataStreamTransportSupportedConfiguration *)self configurations];
        char v9 = [(HAPDataStreamTransportSupportedConfiguration *)v5 configurations];
...
- (NSString)description
{
  ...
  objc_super v3 = +[NSString stringWithFormat:@"<HAPDataStreamTransportSupportedConfiguration configurations=%@>", v2];
