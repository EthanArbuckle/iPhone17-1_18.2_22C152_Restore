...
+ (void)fetchProcessRecords
{
  if (qword_1000639C0 != -1) {
    dispatch_once(&qword_1000639C0, &stru_100050F10);
  }
  ...
  else
  {
    ...
    for (unint64_t i = 0; i < (unint64_t)[(id)qword_1000639C8 count]; ++i)
    {
      id v7 = [(id)qword_1000639C8 objectAtIndex:i];
      id v8 = [v7 exitTimestamp];

      id v9 = +[HTPrefs sharedPrefs];
      unint64_t v10 = v5 - (void)v8;
      LODWORD(v8) = sub_10002AA40((unint64_t)[v9 runloopHangTimeoutDurationMSec] + 30000) < (double)(v5 - (unint64_t)v8);

      if (v8)
      {
        unsigned __int16 v11 = sub_100027DEC();
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
        {
          double v12 = sub_10002A984(v10);
          v13 = +[HTPrefs sharedPrefs];
          uint64_t v14 = (char *)[v13 runloopHangTimeoutDurationMSec];
          v15 = [(id)qword_1000639C8 getDescription:i];
...
+ (id)getProcessExitsAndLaunchesDuringHang:(unint64_t)a3 endTime:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218240;
    double v48 = sub_10002A984(a3);
    __int16 v49 = 2048;
    double v50 = sub_10002A984(a4);
  ...
  if ([(id)qword_1000639C8 count])
  {
    uint64_t v5 = 0;
    unsigned int v6 = 1;
    do
    {
      id v7 = [(id)qword_1000639C8 objectAtIndex:v5];
      v45[0] = @"processName";
      v42 = [v7 processName];
      v46[0] = v42;
      v45[1] = @"processID";
      ...
      v40 = [(id)qword_1000639C8 dateFormatter];
      v39 = sub_10001C860((uint64_t)[v7 spawnTimestamp], v33, v31);
      v38 = [v40 stringFromDate:v39];
      v46[2] = v38;
      v45[3] = @"exitTimestamp";
      v37 = [(id)qword_1000639C8 dateFormatter];
      v36 = sub_10001C860((uint64_t)[v7 exitTimestamp], v33, v31);
      ...
      double v12 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v11, sub_10002A9DC(v10));
      v46[4] = v12;
      ...
      v17 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v16, sub_10002A9DC(v15));
      v46[5] = v17;
      v45[6] = @"processUptime";
      dispatch_time_t v18 = +[NSString stringWithFormat:](NSString, @"%.3lfs", sub_10002A9DC((unsigned char *)[v7 exitTimestamp] - (unsigned char *)objc_msgSend(v7, "spawnTimestamp")));
      v46[6] = v18;
      v45[7] = @"exitReasonCode";
      v19 = sub_10002A548([v7 exitReasonNamespace], [v7 exitReasonCode]);
      v46[7] = v19;
      v45[8] = @"exitReasonNamespace";
      objc_super v20 = sub_1000292F8([v7 exitReasonNamespace]);
      v46[8] = v20;
    ...
    while ((unint64_t)[(id)qword_1000639C8 count] > v6++);
  }
...
- (BOOL)isCurrent:(unint64_t)a3 withHUDUpdateInterval:(double)a4
{
  return sub_10002A984(a3 - self->_requestedToRenderTimestamp) < 200.0;
}
