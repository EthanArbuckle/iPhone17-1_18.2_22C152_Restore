...
+ (id)sharedAnimator
{
  if (qword_1000643E0 != -1) {
    dispatch_once(&qword_1000643E0, &stru_100051F60);
  }
  v2 = (void *)qword_1000643D8;
...
- (void)displayLinkFired:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100028B18;
  block[3] = &unk_100052060;
  void block[4] = self;
  void block[5] = v18;
