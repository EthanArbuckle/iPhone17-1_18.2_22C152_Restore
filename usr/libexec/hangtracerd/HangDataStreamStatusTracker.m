...
+ (id)sharedInstance
{
  ...
  block[4] = a1;
  if (qword_100064360 != -1) {
    dispatch_once(&qword_100064360, block);
  }
  v2 = (void *)qword_100064358;
...
- (BOOL)isHangEndedWithDuration:(double)a3 updateInterval:(double)a4 hangID:(id)a5
{
  ...
  {
    [v12 setCountsOfMeetingEndingConditions:[v12 countsOfMeetingEndingConditions] + 1];
  ...
  {
    if (v18) {
      sub_100032624((uint64_t)v8, v17);
    }
  }
  else
  {
    if (v18) {
      sub_1000325AC((uint64_t)v8, v17);
    }
