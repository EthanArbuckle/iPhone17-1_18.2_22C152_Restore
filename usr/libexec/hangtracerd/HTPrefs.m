...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_100064368 != -1) {
    dispatch_once(&qword_100064368, &stru_100051D60);
  }
  v2 = (void *)qword_100064370;
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = [(__CFString *)v14 isEqualToString:&stru_100053108];
        if (v15)
        {
          v16 = v26;
        }
  ...
  if (os_log_type_enabled(obj, OS_LOG_TYPE_DEBUG)) {
    sub_10003269C((uint64_t)v26, (uint64_t)a4, obj);
  }
  v19 = 0;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (![(NSString *)v9 isEqualToString:v8])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
      sub_100032724((uint64_t)v9, &self->_enablementPrefix, v10);
    }
  }
...
- (void)initPropertyForceQuitDetectionEnabled:(HTPrefInit *)a3
{
  ...
  id v14 = 0;
  unsigned int v6 = [(HTPrefs *)self BOOLProperty:a3 contextPrefixOut:&v14];
  id v7 = v14;
  BOOL v8 = v7;
  if (self->_isInternal) {
    int v9 = v6;
  ...
  {
    if (self->_isCarryDevice && ([v7 isEqualToString:&stru_100053108] & 1) == 0)
    {
      int v10 = sub_100027DEC();
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138412290;
        __int16 v16 = var0;
        _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_INFO, "HTPrefs: %@ force-enabled by isCarryDevice", buf, 0xCu);
      }
  ...
  {
    *(unsigned char *)a3->var1 = v9;
    __int16 v12 = sub_100027DEC();
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      __int16 v16 = v13;
      __int16 v17 = 1024;
      int v18 = forceQuitDetectionEnabled;
      __int16 v19 = 1024;
      int v20 = v9;
      _os_log_debug_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEBUG, "HTPrefs: %@: %{BOOL}d -> %{BOOL}d", buf, 0x18u);
    }
...
- (void)initPropertyIsCarryDevice:(HTPrefInit *)a3
{
  ...
  v13[0] = @"carry";
  v13[1] = @"walkabout";
  BOOL v8 = +[NSArray arrayWithObjects:v13 count:2];
  int v9 = v8;
  if (self->_isInternal
    && !self->_automationGroup
    && [v8 containsObject:self->_experimentGroup])
  {
    int v10 = sub_100027DEC();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
      sub_100032980();
  ...
  if (v5 != v11)
  {
    *(unsigned char *)a3->var1 = v11;
    __int16 v12 = sub_100027DEC();
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG)) {
      sub_1000328E8(v5, v11, v12);
    }
...
- (void)initPropertyReportPeriod:(HTPrefInit *)a3
{
  ...
  double v7 = v6 * 1000.0 / sub_10002A8F0();
...
- (void)initPropertyProcessTerminationSubReasonsMonitored:(HTPrefInit *)a3
{
  uint64_t v4 = sub_1000162A8();
  __int16 v17 = +[NSMutableDictionary dictionary];
  __int16 v19 = [@"HangTracerEnableTerminationsTrackedReasons" stringByAppendingString:@"."];
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        [v19 stringByAppendingFormat:@"%llu", [v9 unsignedLongLongValue]];
        int v10 = (__CFString *)objc_claimAutoreleasedReturnValue();
        int v11 = (void *)CFPreferencesCopyValue(v10, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
        if (v11)
        {
          objc_opt_class();
  ...
  __int16 v12 = self->_processTerminationSubReasonsMonitored;
  __int16 v13 = v12;
  if ((v17 != 0) == (v12 == 0)
    || v17 && v12 && ([(NSDictionary *)v12 isEqual:v17] & 1) == 0)
  {
    __int16 v14 = sub_100027DEC();
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      var0 = a3->var0;
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v28 = 2112;
      long long v29 = v17;
      _os_log_debug_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEBUG, "HTPrefs: %@: %@ -> %@", buf, 0x20u);
    }

    objc_storeStrong((id *)&self->_processTerminationSubReasonsMonitored, v17);
    [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
  }
}
...
+ (id)sharedPrefs
{
  if (qword_100064380 != -1) {
    dispatch_once(&qword_100064380, &stru_100051D80);
  }
  v2 = (void *)qword_100064378;
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    objc_super v4 = sub_100027DEC();
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG)) {
      sub_100032C20(v4);
    }

    int v18 = +[NSDate distantFuture];
    [v18 timeIntervalSinceReferenceDate];
    HTPrefDefaultVal v6 = v5;
    __int16 v17 = +[NSDate distantFuture];
    ...
    result[77].var0 = @"PDSEPrefWorkflowResponsivenessPeriodDays";
    ...
    HIDWORD(result[5].var2.var3) = *(_DWORD *)&v94[3];
    *(_DWORD *)(&result[5].var2.var0 + 1) = *(_DWORD *)v94;
    *(_DWORD *)(&result[5].var3.var0 + 1) = *(_DWORD *)v93;
    HIDWORD(result[6].var2.var3) = *(_DWORD *)&v92[3];
    *(_DWORD *)(&result[6].var2.var0 + 1) = *(_DWORD *)v92;
    HIDWORD(result[6].var3.var3) = *(_DWORD *)&v91[3];
    *(_DWORD *)(&result[6].var3.var0 + 1) = *(_DWORD *)v91;
    HIDWORD(result[7].var2.var3) = *(_DWORD *)&v90[3];
    *(_DWORD *)(&result[7].var2.var0 + 1) = *(_DWORD *)v90;
    HIDWORD(result[7].var3.var3) = *(_DWORD *)&v89[3];
    *(_DWORD *)(&result[7].var3.var0 + 1) = *(_DWORD *)v89;
    HIDWORD(result[9].var2.var3) = *(_DWORD *)&v88[3];
    *(_DWORD *)(&result[9].var2.var0 + 1) = *(_DWORD *)v88;
    HIDWORD(result[9].var3.var3) = *(_DWORD *)&v87[3];
    *(_DWORD *)(&result[9].var3.var0 + 1) = *(_DWORD *)v87;
    HIDWORD(result[11].var2.var3) = *(_DWORD *)&v86[3];
    *(_DWORD *)(&result[11].var2.var0 + 1) = *(_DWORD *)v86;
    HIDWORD(result[11].var3.var3) = *(_DWORD *)&v85[3];
    *(_DWORD *)(&result[11].var3.var0 + 1) = *(_DWORD *)v85;
    HIDWORD(result[12].var2.var3) = *(_DWORD *)&v84[3];
    *(_DWORD *)(&result[12].var2.var0 + 1) = *(_DWORD *)v84;
    HIDWORD(result[12].var3.var3) = *(_DWORD *)&v83[3];
    *(_DWORD *)(&result[12].var3.var0 + 1) = *(_DWORD *)v83;
    HIDWORD(result[13].var2.var3) = *(_DWORD *)&v82[3];
    *(_DWORD *)(&result[13].var2.var0 + 1) = *(_DWORD *)v82;
    HIDWORD(result[13].var3.var3) = *(_DWORD *)&v81[3];
    *(_DWORD *)(&result[13].var3.var0 + 1) = *(_DWORD *)v81;
    HIDWORD(result[14].var2.var3) = *(_DWORD *)&v80[3];
    *(_DWORD *)(&result[14].var2.var0 + 1) = *(_DWORD *)v80;
    HIDWORD(result[14].var3.var3) = *(_DWORD *)&v79[3];
    *(_DWORD *)(&result[14].var3.var0 + 1) = *(_DWORD *)v79;
    HIDWORD(result[15].var2.var3) = *(_DWORD *)&v78[3];
    *(_DWORD *)(&result[15].var2.var0 + 1) = *(_DWORD *)v78;
    HIDWORD(result[15].var3.var3) = *(_DWORD *)&v77[3];
    *(_DWORD *)(&result[15].var3.var0 + 1) = *(_DWORD *)v77;
    *(_DWORD *)(&result[29].var2.var0 + 1) = *(_DWORD *)v76;
    *(_DWORD *)(&result[29].var3.var0 + 1) = *(_DWORD *)v75;
    *(_DWORD *)(&result[32].var2.var0 + 1) = *(_DWORD *)v74;
    *(_DWORD *)(&result[32].var3.var0 + 1) = *(_DWORD *)v73;
    HIDWORD(result[34].var2.var3) = *(_DWORD *)&v72[3];
    *(_DWORD *)(&result[34].var2.var0 + 1) = *(_DWORD *)v72;
    HIDWORD(result[34].var3.var3) = *(_DWORD *)&v71[3];
    *(_DWORD *)(&result[34].var3.var0 + 1) = *(_DWORD *)v71;
    *(_DWORD *)(&result[37].var2.var0 + 1) = *(_DWORD *)v70;
    *(_DWORD *)(&result[37].var3.var0 + 1) = *(_DWORD *)v69;
    HIDWORD(result[38].var2.var3) = *(_DWORD *)&v68[3];
    *(_DWORD *)(&result[38].var2.var0 + 1) = *(_DWORD *)v68;
    HIDWORD(result[38].var3.var3) = *(_DWORD *)&v67[3];
    *(_DWORD *)(&result[38].var3.var0 + 1) = *(_DWORD *)v67;
    *(_DWORD *)(&result[41].var2.var0 + 1) = *(_DWORD *)v66;
    *(_DWORD *)(&result[41].var3.var0 + 1) = *(_DWORD *)v65;
    HIDWORD(result[43].var2.var3) = *(_DWORD *)&v64[3];
    *(_DWORD *)(&result[43].var2.var0 + 1) = *(_DWORD *)v64;
    HIDWORD(result[43].var3.var3) = *(_DWORD *)&v63[3];
    *(_DWORD *)(&result[43].var3.var0 + 1) = *(_DWORD *)v63;
    *(_DWORD *)(&result[44].var2.var0 + 1) = *(_DWORD *)v62;
    HIDWORD(result[44].var3.var3) = *(_DWORD *)&v61[3];
    *(_DWORD *)(&result[44].var3.var0 + 1) = *(_DWORD *)v61;
    HIDWORD(result[47].var2.var3) = *(_DWORD *)&v60[3];
    *(_DWORD *)(&result[47].var2.var0 + 1) = *(_DWORD *)v60;
    HIDWORD(result[47].var3.var3) = *(_DWORD *)&v59[3];
    *(_DWORD *)(&result[47].var3.var0 + 1) = *(_DWORD *)v59;
    *(_DWORD *)(&result[50].var2.var0 + 1) = *(_DWORD *)v58;
    *(_DWORD *)(&result[50].var3.var0 + 1) = *(_DWORD *)v57;
    HIDWORD(result[51].var2.var3) = *(_DWORD *)&v56[3];
    *(_DWORD *)(&result[51].var2.var0 + 1) = *(_DWORD *)v56;
    HIDWORD(result[51].var3.var3) = *(_DWORD *)&v55[3];
    *(_DWORD *)(&result[51].var3.var0 + 1) = *(_DWORD *)v55;
    HIDWORD(result[52].var2.var3) = *(_DWORD *)&v54[3];
    *(_DWORD *)(&result[52].var2.var0 + 1) = *(_DWORD *)v54;
    *(_DWORD *)(&result[52].var3.var0 + 1) = *(_DWORD *)v53;
    HIDWORD(result[55].var2.var3) = *(_DWORD *)&v52[3];
    *(_DWORD *)(&result[55].var2.var0 + 1) = *(_DWORD *)v52;
    HIDWORD(result[55].var3.var3) = *(_DWORD *)&v51[3];
    *(_DWORD *)(&result[55].var3.var0 + 1) = *(_DWORD *)v51;
    HIDWORD(result[56].var2.var3) = *(_DWORD *)&v50[3];
    *(_DWORD *)(&result[56].var2.var0 + 1) = *(_DWORD *)v50;
    HIDWORD(result[56].var3.var3) = *(_DWORD *)&v49[3];
    *(_DWORD *)(&result[56].var3.var0 + 1) = *(_DWORD *)v49;
    HIDWORD(result[60].var2.var3) = *(_DWORD *)&v48[3];
    *(_DWORD *)(&result[60].var2.var0 + 1) = *(_DWORD *)v48;
    HIDWORD(result[60].var3.var3) = *(_DWORD *)&v47[3];
    *(_DWORD *)(&result[60].var3.var0 + 1) = *(_DWORD *)v47;
    HIDWORD(result[61].var2.var3) = *(_DWORD *)&v46[3];
    *(_DWORD *)(&result[61].var2.var0 + 1) = *(_DWORD *)v46;
    HIDWORD(result[61].var3.var3) = *(_DWORD *)&v45[3];
    *(_DWORD *)(&result[61].var3.var0 + 1) = *(_DWORD *)v45;
    HIDWORD(result[62].var2.var3) = *(_DWORD *)&v44[3];
    *(_DWORD *)(&result[62].var2.var0 + 1) = *(_DWORD *)v44;
    HIDWORD(result[62].var3.var3) = *(_DWORD *)&v43[3];
    *(_DWORD *)(&result[62].var3.var0 + 1) = *(_DWORD *)v43;
    HIDWORD(result[63].var2.var3) = *(_DWORD *)&v42[3];
    *(_DWORD *)(&result[63].var2.var0 + 1) = *(_DWORD *)v42;
    HIDWORD(result[63].var3.var3) = *(_DWORD *)&v41[3];
    *(_DWORD *)(&result[63].var3.var0 + 1) = *(_DWORD *)v41;
    HIDWORD(result[64].var2.var3) = *(_DWORD *)&v40[3];
    *(_DWORD *)(&result[64].var2.var0 + 1) = *(_DWORD *)v40;
    HIDWORD(result[64].var3.var3) = *(_DWORD *)&v39[3];
    *(_DWORD *)(&result[64].var3.var0 + 1) = *(_DWORD *)v39;
    HIDWORD(result[65].var2.var3) = *(_DWORD *)&v38[3];
    *(_DWORD *)(&result[65].var2.var0 + 1) = *(_DWORD *)v38;
    HIDWORD(result[65].var3.var3) = *(_DWORD *)&v37[3];
    *(_DWORD *)(&result[65].var3.var0 + 1) = *(_DWORD *)v37;
    HIDWORD(result[66].var2.var3) = *(_DWORD *)&v36[3];
    *(_DWORD *)(&result[66].var2.var0 + 1) = *(_DWORD *)v36;
    HIDWORD(result[66].var3.var3) = *(_DWORD *)&v35[3];
    *(_DWORD *)(&result[66].var3.var0 + 1) = *(_DWORD *)v35;
    HIDWORD(result[67].var2.var3) = *(_DWORD *)&v34[3];
    *(_DWORD *)(&result[67].var2.var0 + 1) = *(_DWORD *)v34;
    HIDWORD(result[67].var3.var3) = *(_DWORD *)&v33[3];
    *(_DWORD *)(&result[67].var3.var0 + 1) = *(_DWORD *)v33;
    HIDWORD(result[68].var2.var3) = *(_DWORD *)&v32[3];
    *(_DWORD *)(&result[68].var2.var0 + 1) = *(_DWORD *)v32;
    HIDWORD(result[68].var3.var3) = *(_DWORD *)&v31[3];
    *(_DWORD *)(&result[68].var3.var0 + 1) = *(_DWORD *)v31;
    *(_DWORD *)(&result[1].var2.var0 + 1) = *(_DWORD *)v98;
    HIDWORD(result[1].var2.var3) = *(_DWORD *)&v98[3];
    *(_DWORD *)(&result[1].var3.var0 + 1) = *(_DWORD *)v97;
    HIDWORD(result[1].var3.var3) = *(_DWORD *)&v97[3];
    *(_DWORD *)(&result[4].var2.var0 + 1) = *(_DWORD *)v96;
    HIDWORD(result[4].var2.var3) = *(_DWORD *)&v96[3];
    HIDWORD(result[4].var3.var3) = *(_DWORD *)&v95[3];
    *(_DWORD *)(&result[4].var3.var0 + 1) = *(_DWORD *)v95;
    HIDWORD(result[5].var3.var3) = *(_DWORD *)&v93[3];
    ...
    result[7].var0 = @"HangTracerCollectOSSignpostsDeferred";
    result[7].var1 = &self->_shouldCollectOSSignpostsDeferred;
    result[8].var0 = @"HangTracerSavedTailspinsMaxMB";
    result[8].var1 = &self->_savedTailspinMaxMB;
    result[8].var2.var1 = 50;
    result[9].var0 = @"HangTracerKeepTailspins";
    result[9].var1 = &self->_keepTailspinsLegacy;
    result[10].var0 = @"HangTracerKeepTailspinsWithFormat";
    result[10].var1 = &self->_tailspinSaveFormat;
    result[10].var2.var3 = (unint64_t)@"compressed";
    result[10].var3.var3 = (unint64_t)@"none";
    result[11].var1 = &self->_shouldSaveTailspins;
    result[11].var5 = "initPropertyShouldSaveAndCompressTailspins:";
    result[12].var0 = @"HangTracerIncludeDiskInfo";
    result[12].var1 = &self->_shouldIncludeDiskInfo;
    result[13].var0 = @"HangTracerEnableDisplayData";
    result[13].var1 = &self->_shouldIncludeDisplayData;
    result[14].var0 = @"HangTracerIncludeNetworkState";
    result[14].var1 = &self->_shouldIncludeNetworkState;
    result[15].var0 = @"HangTracerThirdPartyRunloopLogsEnabled";
    result[15].var1 = &self->_thirdPartyRunLoopHangLogsEnabled;
    result[16].var0 = @"HangTracerSamplingPercentForMicroHangs";
    result[16].var1 = &self->_samplingPercentForMicroHangs;
    result[17].var0 = @"HangTracerPercentFullSpinReports";
    result[17].var1 = &self->_runloopHangPercentHeavyLogs;
    result[18].var0 = @"HangTracerDailyMicroHangLogLimit";
    result[18].var1 = &self->_runLoopMicroHangDailyLogLimit;
    result[19].var0 = @"HangTracerDailyLogLimit";
    result[19].var1 = &self->_runLoopHangDailyLogLimit;
    result[20].var0 = @"HangTracerPerPeriodLogLimit";
    result[20].var1 = &self->_runLoopHangPerPeriodLogLimit;
    result[21].var0 = @"HangTracerDailyLongLogLimit";
    result[21].var1 = &self->_runLoopLongHangDailyLogLimit;
    result[22].var0 = @"HangTracerDailyThirdPartyLogLimit";
    result[22].var1 = &self->_runloopHangThirdPartyDailyLogLimit;
    result[23].var0 = @"HangTracerFenceHangLogLimit";
    result[23].var1 = &self->_fenceHangDailyLogLimit;
    result[24].var0 = @"HangTracerHangTimeoutDuration";
    result[24].var1 = &self->_runloopHangTimeoutDurationMSec;
    int64x2_t v9 = vdupq_n_s64(0x2328uLL);
    result[25].var0 = @"HangTracerDuration";
    result[25].var1 = &self->_runloopHangDurationThresholdMSec;
    result[26].var0 = @"HangTracerLongHangDurationThreshold";
    result[26].var1 = &self->_runloopLongHangDurationThresholdMSec;
    int64x2_t v10 = vdupq_n_s64(0x7D0uLL);
    result[27].var0 = @"HangTracerThirdPartyHangThreshold";
    result[27].var1 = &self->_runloopHangThirdPartyDurationThresholdMSec;
    result[28].var0 = @"HangTracerSpringBoardHangIORegGPUDumpTimeout";
    result[28].var1 = &self->_springBoardHangIORegGPUDumpTimeoutMSec;
    result[29].var0 = @"HangTracerFenceTrackingEnabled";
    result[29].var1 = &self->_fenceTrackingEnabled;
    HIDWORD(result[29].var2.var3) = *(_DWORD *)&v76[3];
    HIDWORD(result[29].var3.var3) = *(_DWORD *)&v75[3];
    result[30].var0 = @"HangTracerSlowActPerAppMax";
    result[30].var1 = &self->_slowAppActivationPerAppMaxLogLimit;
    result[31].var0 = @"HangTracerSlowActDailyLogLimit";
    result[31].var1 = &self->_slowAppActivationDailyLogLimit;
    result[32].var0 = @"HangTracerSlowActTailspinsEnabled";
    result[32].var1 = &self->_slowAppActivationTailspinEnabled;
    HIDWORD(result[32].var2.var3) = *(_DWORD *)&v74[3];
    HIDWORD(result[32].var3.var3) = *(_DWORD *)&v73[3];
    result[33].var0 = @"HangTracerSlowActLaunchTailspinThreshold";
    result[33].var1 = &self->_slowAppActivationThresholdMSec;
    int64x2_t v11 = vdupq_n_s64(0x1388uLL);
    result[34].var0 = @"HangTracerEnableSignpostMonitoring";
    result[34].var1 = &self->_signpostMonitoringEnabled;
    result[35].var0 = @"HangTracerSignpostMonitoringDailyLogLimit";
    result[35].var1 = &self->_signpostMonitoringDailyLogLimit;
    result[36].var0 = @"HangTracerSignpostMonitoringPerPeriodLogLimit";
    result[36].var1 = &self->_signpostMonitoringPerPeriodLogLimit;
    result[37].var0 = @"HangTracerEnableAppLaunchMonitoring";
    result[37].var1 = &self->_appLaunchMonitoringEnabled;
    HIDWORD(result[37].var2.var3) = *(_DWORD *)&v70[3];
    HIDWORD(result[37].var3.var3) = *(_DWORD *)&v69[3];
    result[38].var0 = @"HangTracerEnableWorkflowResponsiveness";
    result[38].var1 = &self->_workflowResponsivenessEnabled;
    result[39].var0 = @"HangTracerWorkflowResponsivenessDailyLogLimit";
    result[39].var1 = &self->_workflowResponsivenessDailyLogLimit;
    result[40].var0 = @"HangTracerWorkflowResponsivenessPerPeriodLogLimit";
    ...
    result[41].var0 = @"HangTracerEnableMemoryLogging";
    result[41].var1 = &self->_memoryLoggingEnabled;
    HIDWORD(result[41].var2.var3) = *(_DWORD *)&v66[3];
    HIDWORD(result[41].var3.var3) = *(_DWORD *)&v65[3];
    result[42].var0 = @"HangTracerMemoryLoggingInterval";
    ...
    result[60].var0 = @"enableLoggingForPoster";
    result[60].var1 = &self->_enableLoggingForPoster;
    result[61].var0 = @"enableLoggingForWidgetRenderer";
    result[61].var1 = &self->_enableLoggingForWidgetRenderer;
    result[62].var0 = @"PDSEPrefHangTracerKillSwitch";
    result[62].var1 = &self->_pdseHangTracerKillSwitch;
    result[63].var0 = @"PDSEPrefHTRateOnlyKillSwitch";
    result[63].var1 = &self->_pdseHTRateOnlyKillSwitch;
    result[64].var0 = @"PDSEPrefHTThirdPartyKillSwitch";
    result[64].var1 = &self->_pdseHTThirdPartyKillSwitch;
    result[65].var0 = @"PDSEPrefAppLaunchKillSwitch";
    ...
    *(int64x2_t *)&result[46].var2.var0 = vdupq_n_s64(0x40AC200000000000uLL);
    ...
    result[66].var0 = @"HangTracerShouldUploadToDiagPipe";
    result->var2.var0 = 1;
    result->var3.var0 = 0;
    ...
    *(_OWORD *)&result[17].var2.var0 = xmmword_10003B120;
    ...
    result[21].unint64_t var4 = 0;
    result[38].var3.var0 = 0;
    result[38].unint64_t var4 = 0;
    ...
    *(int64x2_t *)&result[33].var2.var0 = v11;
    result[33].unint64_t var4 = 1;
    result[34].var2.var0 = 1;
    result[29].unint64_t var4 = 0;
    ...
    *(int64x2_t *)&result[59].var2.var0 = v11;
    ...
    result[69].var0 = @"PDSEPrefCATailspinKillSwitch";
    result[69].var1 = &self->_pdseCATailspinKillSwitch;
    result[69].var2.var0 = 0;
    HIDWORD(result[69].var2.var3) = *(_DWORD *)&v30[3];
    *(_DWORD *)(&result[69].var2.var0 + 1) = *(_DWORD *)v30;
    result[69].var3.var0 = 1;
    HIDWORD(result[69].var3.var3) = *(_DWORD *)&v29[3];
    *(_DWORD *)(&result[69].var3.var0 + 1) = *(_DWORD *)v29;
    result[69].unint64_t var4 = 0;
    result[69].var5 = "initBoolProperty:";
    result[70].var0 = @"HTSEEnablementPeriodDays";
    ...
    result[71].var0 = @"PDSEPrefHTRateOnlyPeriodDays";
    ...
    result[72].var0 = @"PDSEPrefHTThirdPartyPeriodDays";
    ...
    result[73].var0 = @"PDSEPrefHTThirdPartyNoLogUploadPeriodDays";
    ...
    result[76].var0 = @"PDSEPrefSentryPeriodDays";
    ...
    *(_DWORD *)(&result[78].var2.var0 + 1) = *(_DWORD *)v28;
    HIDWORD(result[78].var2.var3) = *(_DWORD *)&v28[3];
    result[78].var3.var0 = 1;
    *(_DWORD *)(&result[78].var3.var0 + 1) = *(_DWORD *)v27;
    HIDWORD(result[78].var3.var3) = *(_DWORD *)&v27[3];
    result[78].unint64_t var4 = 0;
    result[78].var5 = "initBoolProperty:";
    result[79].var2.var0 = 1;
    HIDWORD(result[79].var2.var3) = *(_DWORD *)&v26[3];
    *(_DWORD *)(&result[79].var2.var0 + 1) = *(_DWORD *)v26;
    result[79].var3.var0 = 1;
    HIDWORD(result[79].var3.var3) = *(_DWORD *)&v25[3];
    *(_DWORD *)(&result[79].var3.var0 + 1) = *(_DWORD *)v25;
    result[79].unint64_t var4 = 0;
    result[79].var5 = "initBoolProperty:";
    *(_OWORD *)&result[80].var2.var0 = 0u;
    result[80].unint64_t var4 = 0;
    result[80].var5 = "initDoubleProperty:";
    result[81].var2.var1 = 14;
    result[81].var3.var1 = 14;
    result[81].unint64_t var4 = 0;
    result[81].var5 = "initUnsignedIntProperty:";
    result[82].var2.var1 = 2;
    result[82].var3.var1 = 2;
    result[82].unint64_t var4 = 0;
    result[82].var5 = "initUnsignedIntProperty:";
    *(int64x2_t *)&result[83].var2.var0 = v10;
    result[83].unint64_t var4 = 0;
    result[83].var5 = "initUnsignedIntProperty:";
    result[84].var2.var1 = 8;
    result[84].var3.var1 = 8;
    result[84].unint64_t var4 = 0;
    result[84].var5 = "initUnsignedIntProperty:";
    result[85].var2.var1 = 1;
    result[85].var3.var1 = 1;
    result[85].unint64_t var4 = 1;
    result[85].var5 = "initUnsignedIntProperty:";
    result[86].var2.var0 = 0;
    *(_DWORD *)(&result[86].var2.var0 + 1) = *(_DWORD *)v24;
    HIDWORD(result[86].var2.var3) = *(_DWORD *)&v24[3];
    result[86].var3.var0 = 0;
    *(_DWORD *)(&result[86].var3.var0 + 1) = *(_DWORD *)v23;
    HIDWORD(result[86].var3.var3) = *(_DWORD *)&v23[3];
    result[86].unint64_t var4 = 0;
    result[86].var5 = "initBoolProperty:";
    *(_DWORD *)(&result[87].var2.var0 + 1) = *(_DWORD *)v22;
    result[87].var2.var0 = 0;
    HIDWORD(result[87].var2.var3) = *(_DWORD *)&v22[3];
    *(_DWORD *)(&result[87].var3.var0 + 1) = *(_DWORD *)v21;
    result[87].var3.var0 = 0;
    HIDWORD(result[87].var3.var3) = *(_DWORD *)&v21[3];
    result[87].unint64_t var4 = 0;
    result[87].var5 = "initBoolProperty:";
    result[88].var2.var1 = 0;
    result[88].var3.var1 = 0;
    result[88].unint64_t var4 = 0;
    result[88].var5 = "initIntProperty:";
    result[89].var2.var0 = 0;
    *(_DWORD *)(&result[89].var2.var0 + 1) = *(_DWORD *)v20;
    HIDWORD(result[89].var2.var3) = *(_DWORD *)&v20[3];
    result[89].var3.var0 = 0;
    *(_DWORD *)(&result[89].var3.var0 + 1) = *(_DWORD *)v19;
    HIDWORD(result[89].var3.var3) = *(_DWORD *)&v19[3];
    result[89].unint64_t var4 = 0;
    ...
    *(_OWORD *)(&result[90].var3.var0 + 1) = v99;
    result[90].var5 = 0;
...
- (BOOL)shouldDisplayFenceHangToHUD
{
  ...
  {
    BOOL v3 = [(HTPrefs *)self thirdPartyDevHangHUDEnabled];
    if (v3)
    {
...
- (id)getBootSessionUUID
{
  if (qword_100064388 != -1) {
    dispatch_once(&qword_100064388, &stru_100051DA0);
  }
  v2 = (void *)qword_100064390;
...
- (void)savePreferencesForRestoration:(id)a3 withDomain:(id)a4 prefix:(id)a5
{
  ...
  {
    int64x2_t v10 = sub_100017D5C(v9);
    if ([v10 count])
    {
      int64x2_t v11 = +[NSMutableSet set];
      long long v32 = 0u;
      long long v33 = 0u;
      long long v34 = 0u;
      long long v35 = 0u;
      ...
      if (v13)
      {
        ...
        do
        {
          for (i = 0; i != v14; i = (char *)i + 1)
          {
            ...
            __int16 v17 = +[NSString stringWithFormat:@"%@.%@", v9, *(void *)(*((void *)&v32 + 1) + 8 * i)];
            [v11 addObject:v17];
          }
      ...
      long long v29 = 0u;
      id obj = v7;
      id v18 = [obj countByEnumeratingWithState:&v28 objects:v40 count:16];
      if (v18)
      {
        id v19 = v18;
        ...
        do
        {
          for (j = 0; j != v19; j = (char *)j + 1)
          {
            ...
            CFStringRef v22 = *(const __CFString **)(*((void *)&v28 + 1) + 8 * (void)j);
            if ([v11 containsObject:v22])
            {
              long long v23 = sub_100027DEC();
              if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
              {
                *(_DWORD *)buf = 138412546;
                ...
                __int16 v38 = 2112;
                id v39 = v9;
                _os_log_impl((void *)&_mh_execute_header, v23, OS_LOG_TYPE_DEFAULT, "Saving Setting Key for restoration: %@ that matches prefix: %@", buf, 0x16u);
              }

              CFPropertyListRef v24 = CFPreferencesCopyValue(v22, v26, @"mobile", kCFPreferencesAnyHost);
              CFPreferencesSetValue((CFStringRef)+[NSString stringWithFormat:@"%@.%@", @"HTSavedForRestoration", v22], v24, v26, @"mobile", kCFPreferencesAnyHost);
              if (v24) {
                CFRelease(v24);
              }
            }
          }
          id v19 = [obj countByEnumeratingWithState:&v28 objects:v40 count:16];
        }
        while (v19);
      }
...
- (BOOL)compareBootSessionUUIDAndClearPreferencesWithDomain:(id)a3 prefix:(id)a4
{
  ...
  id v30 = a4;
  id v7 = sub_10002CEE4(v6, @"mobile", (uint64_t)v30);
  if ([v7 count])
  {
    long long v37 = 0u;
    long long v38 = 0u;
...
LABEL_4:
      ...
      while (1)
      {
        ...
        if (v10 == (id)++v12)
        {
          id v10 = [v8 countByEnumeratingWithState:&v35 objects:v44 count:16];
          if (v10) {
            goto LABEL_4;
          }
          goto LABEL_10;
      ...
      if (v15)
      {
        id v14 = (void *)CFPreferencesCopyValue(v15, v6, @"mobile", kCFPreferencesAnyHost);
        if (v14 && (objc_opt_respondsToSelector() & 1) != 0)
        {
          __int16 v16 = [(HTPrefs *)self getBootSessionUUID];
          ...
          if (v19)
          {
            ...
            do
            {
              for (i = 0; i != v20; i = (char *)i + 1)
              {
                ...
                CFStringRef v23 = *(const __CFString **)(*((void *)&v31 + 1) + 8 * i);
                CFPropertyListRef v24 = sub_100027DEC();
                if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
                {
                  *(_DWORD *)buf = 138412546;
                  ...
                  __int16 v41 = 2112;
                  id v42 = v30;
                  _os_log_impl((void *)&_mh_execute_header, v24, OS_LOG_TYPE_DEFAULT, "Removing Setting Key: %@ that matches prefix: %@", buf, 0x16u);
                }
...
- (void)refreshHTPrefs
{
  ...
  {
    LOWORD(v12[0]) = 0;
    _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_INFO, "HTPrefs: Refreshing preferences", (uint8_t *)v12, 2u);
  }
  ...
  if (!self->_isInternal)
  {
    ...
    {
      HTPrefDefaultVal v6 = sub_100027DEC();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        LOWORD(v12[0]) = 0;
        _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "Skipping boot session UUID comparison because the device is in developer mode.", (uint8_t *)v12, 2u);
      }
    }
  ...
  id v7 = [(HTPrefs *)self prefInitList];
  v12[2] = 1;
  v12[3] = 0;
  ...
  [(HTPrefs *)self initPropertyProcessTerminationSubReasonsMonitored:v7];
  if ([(HTPrefs *)self shouldPostHTPrefsChangedNotification])
  {
    ...
    {
      *(_DWORD *)buf = 138412290;
      CFStringRef v14 = @"com.apple.hangtracer.htprefs.refreshed";
...
- (void)__createInternalSettings
{
  ...
  BOOL v3 = (void *)CFPreferencesCopyValue(@"HangTracerInternalSettingCreated", self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
  objc_super v4 = v3;
  if (!v3 || ([v3 BOOLValue] & 1) == 0)
  {
    HTPrefDefaultVal v5 = sub_100027DEC();
  ...
  CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_100059568, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0;
  ...
  v28[4] = self;
  long long v18 = objc_retainBlock(v28);
  ...
  notify_register_dispatch(off_1000637D0, v35 + 6, (dispatch_queue_t)self->__prefsQueue, v20);
  notify_register_dispatch(off_1000637A8[0], v43 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_100063790[0], (int *)v55 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_100063798[0], v51 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_1000637A0[0], v47 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_1000637B8[0], v39 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_1000637B0[0], v31 + 6, (dispatch_queue_t)self->__prefsQueue, v19);
  v24[4] = self;
  *(void *)out_token = 0;
  ...
  v23[3] = &unk_100051E40;
  v23[4] = self;
  CFStringRef v22 = objc_retainBlock(v23);
  notify_register_dispatch(off_1000637C0[0], &out_token[1], (dispatch_queue_t)self->__prefsQueue, v21);
  notify_register_dispatch(off_1000637C8[0], out_token, (dispatch_queue_t)self->__prefsQueue, v22);
  [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
...
- (void)_removeAllPrefs
{
  ...
  unsigned char v37[7] = @"HangTracerEnableForceQuitDetection";
  ...
  v37[39] = @"HangTracerEnableMemoryLogging";
  v37[40] = @"HangTracerMemoryLoggingInterval";
  v37[41] = @"HangTracerEnableTerminationsInHUD";
  v37[42] = @"HangTracerEnableTerminationsAllProcessesTracked";
  v37[43] = @"HangTracerEnableTerminationsCriticalProcessesTracked";
  v37[44] = @"HangTracerEnableTerminationsTrackedProcessesList";
  v37[45] = @"HangTracerEnableTerminationsTrackedReasons";
  v37[46] = @"EPLEnabled";
  v37[47] = @"EPLTimeoutTimestampSec";
  v37[48] = @"HangTracerHUDThresholdMSec";
  v37[49] = @"HangTracerForceQuitDetectionThresholdMSec";
  v37[50] = @"AutomatedDeviceGroup";
  v37[51] = @"ExperimentGroup";
  v37[52] = @"HangTracerHangWaitTimeoutDuration";
  uint64_t v21 = +[NSArray arrayWithObjects:v37 count:53];
  BOOL v3 = sub_1000162A8();
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@.%llu", @"HangTracerEnableTerminationsTrackedReasons", [*(id *)(*((void *)&v30 + 1) + 8 * (void)v9) unsignedLongLongValue]);
        [v4 addObject:v10];
  ...
  uint64_t v11 = [v21 arrayByAddingObjectsFromArray:v4];
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        CFPreferencesSetValue(*(CFStringRef *)(*((void *)&v26 + 1) + 8 * (void)v16), 0, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
  ...
  long long v22 = 0u;
  long long v23 = 0u;
  id v17 = [&__NSArray0__struct countByEnumeratingWithState:&v22 objects:v34 count:16];
  if (v17)
  {
    id v18 = v17;
    ...
    do
    {
      ...
      do
      {
        ...
        CFPreferencesSetValue(*(CFStringRef *)(*((void *)&v22 + 1) + 8 * (void)v20), 0, self->__htDomain, @"mobile", kCFPreferencesAnyHost);
        id v20 = (char *)v20 + 1;
      }
      while (v18 != v20);
      id v18 = [&__NSArray0__struct countByEnumeratingWithState:&v22 objects:v34 count:16];
    }
    while (v18);
  }
