...
+ (id)sharedInstance
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10001531C;
  block[3] = &unk_100051450;
  block[4] = a1;
  if (qword_100063C98 != -1) {
    dispatch_once(&qword_100063C98, block);
  }
  v2 = (void *)qword_100063C90;
...
- (void)sendHangHUDInfo:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    sub_100031C20(v8, v9, v10, v11, v12, v13, v14, v15);
  }
...
- (void)sendProcExitRecord:(id)a3 completion:(id)a4
{
  ...
  uint64_t v8 = sub_100027DEC();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    sub_100031C98(v8, v9, v10, v11, v12, v13, v14, v15);
  }
...
- (void)sendHudConfiguration:(id)a3 completion:(id)a4
{
  ...
  uint64_t v8 = sub_100027DEC();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    sub_100031D10(v8, v9, v10, v11, v12, v13, v14, v15);
  }
...
- (void)sendMonitoredStates:(id)a3 completion:(id)a4
{
  ...
  uint64_t v8 = sub_100027DEC();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    sub_100031D88(v8, v9, v10, v11, v12, v13, v14, v15);
  }
...
- (void)clearHUDWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG)) {
    sub_100031E00(v5, v6, v7, v8, v9, v10, v11, v12);
  }
