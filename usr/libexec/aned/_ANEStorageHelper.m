...
+ (void)initialize
{
  if (qword_100032BD0 != -1) {
    dispatch_once(&qword_100032BD0, &stru_10002C7F0);
  }
}
...
+ (BOOL)removeDirectoryAtPath:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    v8 = (void *)qword_100032BE0;
    if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_INFO))
    {
      v9 = v8;
...
{
  id v8 = a3;
  v9 = (void *)qword_100032BE0;
  if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_DEBUG)) {
    sub_10001BD3C(v9, a2);
  }
  id v10 = v8;
...
LABEL_22:
  ...
  if (v14)
  {
    ...
    *a5 = (id)ANECCreateModelDictionary();
    ...
    {
      id v17 = (id)qword_100032BE0;
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        char v18 = NSStringFromSelector(a2);
        sub_10001BCD4(v18, (uint64_t)v10, buf, v17);
      }
    }
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10000B3C8;
    block[3] = &unk_10002C838;
    block[4] = &v41;
    dispatch_async((dispatch_queue_t)qword_100032BD8, block);
    id v19 = v16;
  }
  else
  {
    v26 = (id)qword_100032BE0;
...
+ (BOOL)setAccessTime:(id)a3 forModelFilePath:(id)a4
{
  ...
  uint64_t value = v8;
  id v9 = v7;
  int v10 = setxattr((const char *)[v9 UTF8String], (const char *)[@"kANEAccessSeconds" UTF8String], &value, 8uLL, 0, 1);
  if (v10 < 0)
  {
    id v11 = (void *)qword_100032BE0;
...
LABEL_12:
  ...
  else if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_ERROR))
  {
    uint64_t v8 = v7;
    id v9 = NSStringFromSelector(a2);
    int v12 = *__error();
...
+ (BOOL)updateAccessTimeForFilePath:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v11 - v10 <= 86400.0)
    {
      dev_t v14 = (void *)qword_100032BE0;
      if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_DEBUG)) {
        sub_10001BF3C(v14, a2);
      }
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  int v12 = (void *)qword_100032BE0;
  if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_ERROR)) {
    sub_10001BE94(v12, a2);
  }
  BOOL v13 = 0;
LABEL_12:
...
+ (void)removeFilePath:(id)a3 ifDate:(id)a4 olderThanSecond:(id)a5
{
  ...
  if (v10 == (id)-1 || !v11)
  {
    ...
    if ((v13 & 1) == 0)
    {
      int v15 = qword_100032BE0;
      if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_ERROR)) {
        sub_10001C08C((uint64_t)v7, (uint64_t)v14, v15);
      }
    }
  }
}
...
{
  id v4 = a3;
  v5 = &selRef_tokenWithAuditToken_modelIdentifier_processIdentifier_;
  int v6 = (void *)qword_100032BE0;
  if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_INFO))
  {
    id v7 = v6;
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        id v11 = [*(id *)(*((void *)&v15 + 1) + 8 * i) pathComponents:v15];
...
+ (id)sizeOfDirectoryAtPath:(id)a3 recursionLevel:(unint64_t)a4
{
  ...
  if (v10)
  {
    ...
    [v8 setObject:v13 forKeyedSubscript:off_1000329F0];

    id v14 = [v8 objectForKeyedSubscript:off_1000329F8];
    ...
    if (a4)
    {
      ...
      if (v17)
      {
        ...
        unsigned int v21 = &selRef_tokenWithAuditToken_modelIdentifier_processIdentifier_;
        __int16 v22 = &selRef_tokenWithAuditToken_modelIdentifier_processIdentifier_;
        if (v20)
        {
          id v23 = v20;
          unint64_t v55 = a4 - 1;
          ...
          do
          {
            for (i = 0; i != v23; i = (char *)i + 1)
            {
              ...
              int v28 = [v27 objectForKeyedSubscript:v21[318]];
              id v29 = (char *)[v28 unsignedIntegerValue];

              if (v29)
              {
                int v30 = [aSelectora objectForKeyedSubscript:v21[318]];
                v31 = v21;
                id v32 = [v30 unsignedIntegerValue];

                uint64_t v33 = +[NSNumber numberWithUnsignedInteger:&v29[(void)v32]];
                __int16 v22 = &selRef_tokenWithAuditToken_modelIdentifier_processIdentifier_;
                [aSelectora setObject:v33 forKeyedSubscript:v31[318]];

                v34 = [v27 objectForKeyedSubscript:off_1000329F8];
                if (v34) {
        ...
        id v35 = [v50 copy];
        id v8 = aSelectora;
        [aSelectora setObject:v35 forKeyedSubscript:v22[319]];
...
+ (id)sizeOfModelCacheAtPath:(id)a3 purgeSubdirectories:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    [v7 setObject:v11 forKeyedSubscript:off_1000329F0];
      ...
      if (v15)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            __int16 v22 = [v21 objectForKeyedSubscript:off_1000329F0];
            id v23 = (char *)[v22 unsignedIntegerValue];

            if (!v16) {
              goto LABEL_12;
            }
            uint64_t v24 = (void *)qword_100032BE0;
            if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_DEBUG))
            {
              int v30 = v24;
...
LABEL_12:
              if (v23)
              {
                int v25 = [v50 objectForKeyedSubscript:off_1000329F0];
                ...
                BOOL v16 = v51;
                [v50 setObject:v28 forKeyedSubscript:off_1000329F0];
      ...
      id v34 = [v49 copy];
      id v7 = v50;
      [v50 setObject:v34 forKeyedSubscript:off_1000329F8];
...
+ (id)mergeModelCacheStorageInformation:(id)a3 with:(id)a4
{
  ...
  id v6 = a4;
  id v7 = [(id)objc_opt_class() createModelCacheDictionary];
  id v8 = [v5 objectForKeyedSubscript:off_1000329F0];
  uint64_t v9 = (char *)[v8 unsignedLongLongValue];

  id v10 = [v6 objectForKeyedSubscript:off_1000329F0];
  id v11 = &v9[(void)[v10 unsignedLongLongValue]];

  id v12 = +[NSNumber numberWithUnsignedLongLong:v11];
  id v35 = v7;
  [v7 setObject:v12 forKeyedSubscript:off_1000329F0];

  v37 = v5;
  id v13 = [v5 objectForKeyedSubscript:off_1000329F8];
  id v36 = v6;
  id v14 = [v6 objectForKeyedSubscript:off_1000329F8];
  id v15 = [v13 allKeys];
  ...
  id v31 = [v19 copy];
  [v35 setObject:v31 forKeyedSubscript:off_1000329F8];
...
+ (BOOL)_markPurgeablePath:(id)a3 error:(id *)a4
{
  ...
  if (v7 < 0)
  {
    BOOL v16 = (void *)qword_100032BE0;
    if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_ERROR)) {
      sub_10001C114((uint64_t)v6, v16);
    }
  ...
  else
  {
    ...
    {
      if (os_log_type_enabled((os_log_t)qword_100032BE0, OS_LOG_TYPE_DEBUG)) {
        sub_10001C1BC((uint64_t)v6, &v22, v11);
      }
      id v15 = 0;
    }
    close(v8);
