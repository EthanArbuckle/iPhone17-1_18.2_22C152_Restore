...
+ (void)initialize
{
  if (qword_100032BE8 != -1) {
    dispatch_once(&qword_100032BE8, &stru_10002C878);
  }
}
...
+ (BOOL)createModelCacheRetain:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    id v7 = (void *)qword_100032BF8;
    if (os_log_type_enabled((os_log_t)qword_100032BF8, OS_LOG_TYPE_ERROR)) {
      sub_10001C2EC(v7, a2, (uint64_t)v4);
    }
  }
...
LABEL_18:
    ...
    __int16 v25 = (void *)qword_100032BF8;
    if (os_log_type_enabled((os_log_t)qword_100032BF8, OS_LOG_TYPE_ERROR))
    {
      __int16 v27 = v25;
...
- (BOOL)scanAllPartitionsForModel:(id)a3 csIdentity:(id)a4 expunge:(BOOL)a5
{
  ...
  if (v14)
  {
    ...
    CFStringRef v68 = 0;
    uint64_t v17 = 1;
    id v18 = &ANECCreateModelDictionary_ptr;
    ...
    *(void *)&long long v15 = 138413314;
    ...
    do
    {
      ...
      do
      {
        ...
        id v22 = [v21 lastPathComponent:v62];
        int v23 = [v18[161] modelBinaryName];
        ...
        if (v24)
        {
          ...
          BOOL v26 = [v18[161] modelSourceStoreName];
          ...
          if (v28)
          {
            ...
            id v32 = (void *)qword_100032BF8;
            if (os_log_type_enabled((os_log_t)qword_100032BF8, OS_LOG_TYPE_DEBUG))
            {
              v54 = v32;
            ...
            {
              uint64_t v45 = (void *)qword_100032BF8;
              if (os_log_type_enabled((os_log_t)qword_100032BF8, OS_LOG_TYPE_INFO))
              {
                v46 = v45;
