...
+ (id)validFileSubstrings
{
  if (qword_1000BD778 != -1) {
    dispatch_once(&qword_1000BD778, &stru_10009D340);
  }
  v2 = (void *)qword_1000BD770;
...
+ (id)sysdiagnoseEnumerator:(id)a3 WithVolume:(id)a4 WithFlags:(unint64_t)a5
{
  ...
  if (v13)
  {
    ...
    v19 = [v17 enumeratorAtURL:v13 includingPropertiesForKeys:v18 options:a5 errorHandler:&stru_10009D360];
  }
  else
  {
    v19 = 0;
