            ...
            else
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR)) {
                  sub_1000D73C4((uint64_t)v9, (uint64_t)v10, v20);
                }
                goto LABEL_31;
              }
...
+ (id)dictionaryFromJsonData:(id)a3
{
  ...
  if (!v3)
  {
    NSUInteger v5 = sub_100068600();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      sub_1000D7468(v5, v8, v9, v10, v11, v12, v13, v14);
    }
    goto LABEL_13;
  }
  id v17 = 0;
