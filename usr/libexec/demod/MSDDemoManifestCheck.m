...
+ (MSDDemoManifestCheck)sharedInstance
{
  if (qword_100189C18 != -1) {
    dispatch_once(&qword_100189C18, &stru_1001537D8);
  }
  v2 = (void *)qword_100189C10;
  ...
  while (2)
  {
    ...
    do
    {
      ...
      if (!v28 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
      {
        v61 = sub_100068600();
        if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR)) {
          sub_1000D7978(v61, v62, v63, v64, v65, v66, v67, v68);
        }
LABEL_95:
        v10 = v117;
        id v15 = v115;
LABEL_96:
      ...
      if (![v28 count])
      {
        v61 = sub_100068600();
        if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR)) {
          sub_1000D79F0(v61, v82, v83, v84, v85, v86, v87, v88);
        }
        goto LABEL_95;
      }
...
LABEL_93:
          v61 = sub_100068600();
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR)) {
            sub_1000D7A68(v61, v89, v90, v91, v92, v93, v94, v95);
          }
          goto LABEL_95;
        }
        goto LABEL_26;
...
LABEL_101:
            ...
            if ((v122 & [v47 isEqualToString:@"UAT"]) == 1)
            {
              v79 = sub_100068600();
              if (os_log_type_enabled(v79, OS_LOG_TYPE_ERROR)) {
                sub_1000D7824(v79, v96, v97, v98, v99, v100, v101, v102);
              }
              goto LABEL_99;
            }
...
LABEL_99:
            ...
            v50 = v34;
            v37 = (__CFString *)v48;
            v51 = sub_100059A30((uint64_t)kCFAllocatorDefault, v42, v48);
...
- (__SecKey)createPublicKeyForStrongSigning:(id)a3
{
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR)) {
      sub_1000D7CC0(v7, v10, v11, v12, v13, v14, v15, v16);
    }
...
- (__SecKey)createPublicKeyAppleISTSigning:(id)a3
{
  ...
  if (!DemoDigitalCatalogSigning)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR)) {
      sub_1000D7D38(v24, v30, v31, v32, v33, v34, v35, v36);
    }
    goto LABEL_24;
  }
...
LABEL_21:
  ...
  if (([v24 isEqualToString:@"DemoUnit CA"] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR)) {
      sub_1000D7F08((uint64_t)&commonName, v37, v38, v39, v40, v41, v42, v43);
    }
    goto LABEL_35;
  }
  CFDataRef v25 = CFDataCreate(kCFAllocatorDefault, byte_100188FC0, dword_100189348);
  if (!v25)
  {
    v37 = sub_100068600();
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR)) {
      sub_1000D7E18(v37, v44, v45, v46, v47, v48, v49, v50);
    }
    goto LABEL_35;
  }
  ...
  if (!v26)
  {
    v37 = sub_100068600();
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR)) {
      sub_1000D7E90(v37, v51, v52, v53, v54, v55, v56, v57);
    }
LABEL_35:
...
- (__SecKey)createPublicKeyForDevelopmentSigningStandard:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR)) {
      sub_1000D8014(v8, v9, v10, v11, v12, v13, v14, v15);
    }
...
- (__SecKey)createPublicKey:(id)a3 usingPolicy:(__SecPolicy *)a4 anchors:(id)a5
{
  ...
  SecCertificateRef v26 = sub_100092D3C;
  BOOL v27 = sub_100092D4C;
  id v28 = 0;
...
LABEL_14:
  ...
  if (!v12)
  {
    uint64_t v13 = sub_100068600();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR)) {
      sub_1000D8104(v13, v15, v16, v17, v18, v19, v20, v21);
    }
LABEL_13:
...
- (BOOL)isManualSigning:(id)a3
{
  ...
  if (!v3 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000D8428(v9, v10, v11, v12, v13, v14, v15, v16);
    }
    goto LABEL_12;
  }
  ...
  if (!v4)
  {
    uint64_t v9 = sub_100068600();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000D84A0(v9, v17, v18, v19, v20, v21, v22, v23);
    }
LABEL_12:
...
- (BOOL)secureManifestCheckForSegmentedManifest:(id)a3 options:(id)a4
{
  ...
  if (!v6)
  {
    uint64_t v13 = sub_100068600();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR)) {
      sub_1000D854C(v13, v14, v15, v16, v17, v18, v19, v20);
    }
    goto LABEL_11;
  }
  ...
  if (![(MSDDemoManifestCheck *)self runSecurityCheck:v7])
  {
    uint64_t v13 = sub_100068600();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR)) {
      sub_1000D85C4(v13, v21, v22, v23, v24, v25, v26, v27);
    }
LABEL_11:
...
- (BOOL)runSecurityCheck:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR)) {
      sub_1000D863C(v14, v17, v18, v19, v20, v21, v22, v23);
    }
  }
...
LABEL_65:
  ...
  BOOL v17 = +[NSSet setWithArray:&off_100162E78];
...
LABEL_7:
  ...
  [v5 addObject:&off_100162300];
  [v5 addObject:&off_100162318];
  [v6 addObject:@"mobile"];
  [v6 addObject:@"wheel"];
    ...
    do
    {
      ...
      do
      {
        ...
        if (v23)
        {
          objc_opt_class();
          if ((objc_opt_isKindOfClass() & 1) == 0
            || ([v23 isEqualToString:&stru_100155450] & 1) == 0)
          {
            uint64_t v53 = sub_100068600();
...
- (id)getAllowedSymLinks
{
  ...
  unint64_t v6 = +[NSSet setWithArray:&off_100162F20];
  ...
  unsigned int v8 = +[NSSet setWithArray:&off_100162F38];
...
- (id)getSettingsComponentNames
{
  return +[NSSet setWithArray:&off_100162F50];
}
