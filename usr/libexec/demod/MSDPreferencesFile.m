...
+ (id)sharedInstance
{
  if (qword_1001898D8 != -1) {
    dispatch_once(&qword_1001898D8, &stru_1001520D0);
  }
  v2 = (void *)qword_1001898D0;
...
- (id)objectForKey:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000CA4B0(v9, v10, v11, v12, v13, v14, v15, v16);
    }
...
LABEL_13:
      _os_log_impl((void *)&_mh_execute_header, &v10->super, OS_LOG_TYPE_DEFAULT, v14, (uint8_t *)&v16, 0xCu);
    }
LABEL_14:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG)) {
    sub_1000CA528((uint64_t)v8, (uint64_t)v6, v9);
  }
...
- (BOOL)removeObjectForKey:(id)a3
{
  ...
  else
  {
    v9 = sub_100068600();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000CA5B0(v9, v10, v11, v12, v13, v14, v15, v16);
    }
...
- (BOOL)removeObjectsForKeys:(id)a3
{
  ...
  else
  {
    v9 = sub_100068600();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000CA628(v9, v10, v11, v12, v13, v14, v15, v16);
    }
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136446722;
      ...
      __int16 v14 = 2114;
      id v15 = v5;
      _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "%{public}s - Failed to read preferences file:  %{public}@ - Error:  %{public}@", buf, 0x20u);
    }
    goto LABEL_7;
  }
  ...
  if ((v4 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136446722;
      ...
      __int16 v14 = 2114;
      id v15 = v5;
      _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "%{public}s - Failed to save preferences file:  %{public}@ - Error:  %{public}@", buf, 0x20u);
    }
  }
...
- (void)raiseInvalidPropertyListObjectExceptionForObject:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136446466;
    ...
    __int16 v9 = 2114;
    uint64_t v10 = v5;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "%{public}s - Exception:  %{public}@", buf, 0x16u);
  }
...
+ (id)preferencesFileUrl
{
  if (qword_1001898E8 != -1) {
    dispatch_once(&qword_1001898E8, &stru_1001520F0);
  }
  v2 = (void *)qword_1001898E0;
