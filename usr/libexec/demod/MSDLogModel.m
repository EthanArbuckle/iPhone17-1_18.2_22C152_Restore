...
+ (id)sharedInstance
{
  if (qword_100189AD0 != -1) {
    dispatch_once(&qword_100189AD0, &stru_1001530F8);
  }
  v2 = (void *)qword_100189AC8;
...
- (id)fileNameForTodayUnder:(id)a3 prefix:(id)a4
{
  ...
  v11 = +[NSString stringWithFormat:](NSString, @"%@/%@-%4ld%02ld%02ld.log", v6, v5, [v10 year], objc_msgSend(v10, "month"), objc_msgSend(v10, "day"));
