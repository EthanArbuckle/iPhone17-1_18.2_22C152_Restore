...
+ (id)sharedInstance
{
  if (qword_100189C38 != -1) {
    dispatch_once(&qword_100189C38, &stru_100153AD8);
  }
  v2 = (void *)qword_100189C30;
...
- (id)listAllTestScripts
{
  ...
  if (v28)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR)) {
      sub_1000DA6DC((uint64_t)v32, v29, v33);
    }
      ...
      if (v37)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (v20)
            {
              ...
              do
              {
                for (i = 0; i != v21; i = (char *)i + 1)
                {
                  ...
                  unsigned int v28 = sub_100068600();
            ...
            id v29 = [objc_alloc((Class)MSDKPeerDemoTestScript) initWithName:v38 andMethods:v18];
            [v36 addObject:v29];
