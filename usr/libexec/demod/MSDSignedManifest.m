...
+ (MSDSignedManifest)signedManifest
{
  return (MSDSignedManifest *)(id)qword_100189A70;
}
...
- (MSDSignedManifest)initWithManifestData:(id)a3
{
  ...
  if (!v8 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1000D0DD8(v9, v36, v37, v38, v39, v40, v41, v42);
    }
    goto LABEL_63;
  }
  if (+[MSDPlatform iOSHub])
  {
    ...
    if (!v9 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR)) {
        sub_1000D0E50(v51, v52, v53, v54, v55, v56, v57, v58);
      }
...
LABEL_75:
  ...
  if (v14)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      v9 = sub_100068600();
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
        sub_1000D1100(v9, v59, v60, v61, v62, v63, v64, v65);
      }
      goto LABEL_75;
    }
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR)) {
            sub_1000D1088(v66, v74, v75, v76, v77, v78, v79, v80);
          }
LABEL_74:
      ...
      if (!v22 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR)) {
          sub_1000D0F64(v43, v44, v45, v46, v47, v48, v49, v50);
        }
      ...
      if (v23)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR)) {
            sub_1000D1010(v33, v67, v68, v69, v70, v71, v72, v73);
          }
          goto LABEL_78;
        }
        v25 = (char *)[v23 count];
...
- (id)getDataSectionKeys
{
  return +[NSSet setWithArray:&off_100162DA0];
}
...
- (BOOL)parseBundleID:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR)) {
      sub_1000D11AC(v10, v11, v12, v13, v14, v15, v16, v17);
    }
    goto LABEL_9;
  }
  if (!v6)
  {
    char v10 = sub_100068600();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR)) {
      sub_1000D1224(v10, v18, v19, v20, v21, v22, v23, v24);
    }
LABEL_9:
