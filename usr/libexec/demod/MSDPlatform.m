...
+ (id)sharedInstance
{
  if (qword_100189C68 != -1) {
    dispatch_once(&qword_100189C68, &stru_100153C20);
  }
  v2 = (void *)qword_100189C60;
...
+ (BOOL)iOSHub
{
  if (qword_100189C78 != -1) {
    dispatch_once(&qword_100189C78, &stru_100153C40);
  }
  return byte_100189C70;
}
