void sub_100000F6C(const __CFDictionary *a1, __CFDictionary *a2)
{
  CFBooleanRef Value;
  CFBooleanRef v5;
  CFTypeID v6;
...
uint64_t sub_100001490(const __CFData *a1, CFTypeRef *a2)
{
...
uint64_t sub_100001664(const __CFDictionary *a1, const __CFDictionary *a2, CFDictionaryRef theDict, uint64_t a4, CFTypeRef *a5)
{
  ...
  v12 = CFDictionaryGetValue(a2, @"Yonkers,BoardID");
  if (!v12) {
    goto LABEL_77;
  }
  v13 = v12;
  ...
  v18 = CFDictionaryGetValue(a1, @"Yonkers,ChipID");
  if (!v18) {
    goto LABEL_77;
  }
  v19 = v18;
  ...
  v36 = CFDictionaryGetValue(a1, @"Yonkers,ECID");
  if (!v36) {
    goto LABEL_77;
  }
  v37 = v36;
  ...
  v39 = CFDictionaryGetValue(a1, @"Yonkers,Nonce");
  if (!v39) {
    goto LABEL_77;
  }
  v40 = v39;
  ...
  int v42 = sub_10000213C(a1, (CFTypeRef *)&key, &v69);
  v43 = key;
  uint64_t v6 = 17;
  if (!v42 && key)
  {
    v44 = CFDictionaryGetValue(theDict, @"MeasurementDictPatch");
    v45 = (__CFDictionary *)sub_100001CD4(v44);
    if (!v45)
    {
LABEL_66:
      v43 = key;
    ...
    if (v47 == CFDictionaryGetTypeID())
    {
      ...
      if (!(v28 | v35))
      {
        ...
        if (valuePtr == 1300)
        {
          ...
          while (1)
          {
            int v57 = dword_100007E20[v55];
            if (sub_100002228(v57, v66, (CFTypeRef *)&key, 0) || key == 0) {
              goto LABEL_74;
            }
...
LABEL_75:
            ...
            sub_100001CE0(v46, @"FabRevision", v57);
        ...
        if (valuePtr == 1044)
        {
          ...
          while (1)
          {
            int v51 = dword_100007E08[v49];
            if (sub_100002228(v51, v66, (CFTypeRef *)&key, 0) || key == 0) {
              break;
            }
            ...
            CFDictionarySetValue(v46, @"EPRO", v24);
            sub_100001CE0(v46, @"FabRevision", v51);
            CFDictionarySetValue(v10, key, v46);
            CFRelease(v46);
            if (++v49 >= v50) {
              goto LABEL_64;
...
LABEL_64:
      sub_100000F6C(a1, v10);
      uint64_t v6 = 0;
      CFTypeRef *v63 = sub_100001CD4(v10);
LABEL_65:
      CFMutableDictionaryRef Mutable = v64;
      goto LABEL_66;
    }
...
CFTypeRef sub_100001CD4(CFTypeRef cf)
{
  if (cf) {
    return CFRetain(cf);
  }
...
void sub_100001CE0(__CFDictionary *a1, const void *a2, int a3)
{
  int valuePtr = a3;
...
void sub_100001D54(__CFDictionary *a1, const void *a2, int a3)
{
...
void sub_100001D74(__CFDictionary *a1, const void *a2, UInt8 *bytes, CFIndex length)
{
...
uint64_t sub_100001DE0(const __CFString *a1, _DWORD *a2, int a3)
{
...
CFErrorRef sub_100001E78(uint64_t a1, unsigned int a2, uint64_t a3, const __CFString *a4)
{
...
uint64_t sub_100001F84(CFDictionaryRef theDict, void *a2, void *a3)
{
  uint64_t result = 2;
  if (theDict && a2 && a3)
  {
...
LABEL_26:
      ...
      if (v16 == 4)
      {
        ...
        v18 = (uint64_t *)&kSavageTagMeasurementBEDevPatch;
LABEL_19:
        if (!v10) {
          CFTypeID v17 = v18;
        }
...
LABEL_29:
      ...
      if (v15 >= 0xF0)
      {
        ...
        v18 = (uint64_t *)&kSavageTagMeasurementBFDevPatch;
        goto LABEL_19;
      }
    }
...
uint64_t sub_10000213C(CFDictionaryRef theDict, CFTypeRef *a2, CFTypeRef *a3)
{
  int valuePtr = 0;
  uint64_t result = 2;
  if (theDict && a2)
  {
      ...
      && (CFNumberRef v12 = v11, v13 = CFGetTypeID(v11), v13 == CFNumberGetTypeID()))
    {
      ...
      return sub_100002228(valuePtr, v10, a2, a3);
    }
    else
    {
      return 17;
...
uint64_t sub_100002228(int a1, int a2, CFTypeRef *a3, CFTypeRef *a4)
{
  int v8 = 0;
  uint64_t v9 = 0;
  while (dword_100007E40[v9] != a1)
  {
    ++v9;
    v8 -= 2;
    if (v9 == 6)
...
uint64_t sub_1000023E8(unsigned char *a1, uint64_t *a2, unsigned __int8 *a3, unint64_t a4)
{
  uint64_t v4 = 2;
...
void *sub_1000024DC()
{
  ...
  sub_100002564((uint64_t)v0);
  qword_10000C080 = (uint64_t)v0;
  return v0;
}
...
void sub_10000252C()
{
  if (qword_10000C080)
  {
    v0 = (void *)sub_100002BAC(qword_10000C080);
    operator delete(v0);
    qword_10000C080 = 0;
  }
}
...
uint64_t sub_1000025C8(uint64_t a1)
{
  ...
  uint64_t v3 = 0;
  uint64_t v4 = (io_iterator_t *)(a1 + 116);
  while (1)
  {
    CFDictionaryRef v5 = IOServiceMatching(off_100008438[v3]);
    uint64_t MatchingServices = IOServiceGetMatchingServices(kIOMainPortDefault, v5, (io_iterator_t *)(a1 + 116));
    if (!MatchingServices)
    {
      if (*v4) {
        break;
  ...
  if (v2)
  {
    ...
    if (CFProperty)
    {
      ...
      if (v9 == CFDataGetTypeID()) {
        *(unsigned char *)(a1 + 70) = *CFDataGetBytePtr(v8) == 0;
      }
      CFRelease(v8);
    }
  }
      ...
      if (!MatchingServices)
      {
        ...
        else
        {
          *(_DWORD *)(a1 + 120) = v11;
          ...
          uint64_t MatchingServices = sub_100002F0C(a1);
          if (!MatchingServices)
          {
LABEL_23:
            if (properties) {
...
uint64_t sub_100002794(uint64_t a1)
{
  ...
  *(_OWORD *)int v35 = 0u;
  long long v36 = 0u;
  *(_OWORD *)CFBooleanRef v33 = 0u;
  long long v34 = 0u;
  v32[0] = 0;
  v32[1] = 0;
  CFDataRef CFProperty = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageUID", kCFAllocatorDefault, 0);
  if (CFProperty)
  {
    ...
    v39.location = 0;
    v39.length = 16;
    CFDataGetBytes(v4, v39, buffer);
    CFRelease(v4);
    *(void *)(a1 + 56) = bswap64(*(unint64_t *)buffer);
    CFDataRef v6 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageMNS", kCFAllocatorDefault, 0);
    if (v6)
    {
      CFDataRef v4 = v6;
      ...
      CFRelease(v4);
      CFDataRef v11 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageChipID", kCFAllocatorDefault, 0);
      if (v11)
      {
        CFDataRef v4 = v11;
        ...
        v40.location = 0;
        v40.length = 4;
        CFDataGetBytes(v4, v40, (UInt8 *)(a1 + 112));
        *(_DWORD *)(a1 + 112) = bswap32(*(_DWORD *)(a1 + 112));
        CFRelease(v4);
        CFDataRef v13 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageKCV", kCFAllocatorDefault, 0);
        if (v13)
        {
          CFDataRef v4 = v13;
          ...
          v41.location = 0;
          v41.length = 3;
          CFDataGetBytes(v4, v41, (UInt8 *)(a1 + 64));
          CFRelease(v4);
          CFDataRef v15 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageWrapOutputKey", kCFAllocatorDefault, 0);
          if (v15)
          {
            CFDataRef v16 = v15;
            CFTypeID v17 = CFGetTypeID(v15);
            if (v17 == CFDataGetTypeID())
            {
              v42.location = 0;
              v42.length = 32;
              CFDataGetBytes(v16, v42, v33);
            }
            CFRelease(v16);
            unint64_t v18 = bswap64(*(unint64_t *)v33);
          }
          else
          {
            unint64_t v18 = 0;
          ...
          *(void *)(a1 + 96) = v18;
          CFDataRef v19 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavagePubKeyHmac", kCFAllocatorDefault, 0);
          if (v19)
          {
            CFDataRef v20 = v19;
            ...
            if (v21 == CFDataGetTypeID())
            {
              v43.location = 0;
              v43.length = 32;
              CFDataGetBytes(v20, v43, v35);
            }
            CFRelease(v20);
            unint64_t v22 = bswap64(*(unint64_t *)v35);
          }
          else
          {
            unint64_t v22 = 0;
          ...
          *(void *)(a1 + 72) = v22;
          CFDataRef v23 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageAuthPubKey", kCFAllocatorDefault, 0);
          if (v23)
          {
            CFDataRef v4 = v23;
            ...
            *(void *)a1 = sub_100001CD4(v4);
            CFRelease(v4);
            CFDataRef v25 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageAuthSalt", kCFAllocatorDefault, 0);
            if (v25)
            {
              CFDataRef v4 = v25;
              ...
              v44.location = 0;
              v44.length = 16;
              CFDataGetBytes(v4, v44, (UInt8 *)v32);
              CFRelease(v4);
              *(void *)(a1 + 88) = bswap64(v32[0]);
              CFDataRef v27 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageAuthResponse", kCFAllocatorDefault, 0);
              if (v27)
              {
                CFDataRef v4 = v27;
                ...
                *(void *)(a1 + 8) = sub_100001CD4(v4);
                CFRelease(v4);
                CFDataRef v29 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageAuthPubKeyHmac", kCFAllocatorDefault, 0);
                if (v29)
                {
                  CFDataRef v4 = v29;
                  ...
                  if (v30 == CFDataGetTypeID())
                  {
                    v45.location = 0;
                    v45.length = 32;
                    CFDataGetBytes(v4, v45, v35);
                    CFRelease(v4);
                    uint64_t v2 = 0;
                    *(void *)(a1 + 80) = bswap64(*(unint64_t *)v35);
                    return v2;
                  }
LABEL_36:
                  CFRelease(v4);
...
{
  io_object_t v2 = *(_DWORD *)(a1 + 116);
  if (v2) {
    IOObjectRelease(v2);
  }
  io_object_t v3 = *(_DWORD *)(a1 + 120);
  if (v3) {
    IOObjectRelease(v3);
  }
  sub_100002C08(a1);
...
uint64_t sub_100002C08(uint64_t a1)
{
  ...
  {
    mach_port_t v3 = *(_DWORD *)(a1 + 124);
    if (v3)
    {
      uint64_t v4 = IOConnectCallScalarMethod(v3, 4u, 0, 0, 0, 0);
      IOServiceClose(*(_DWORD *)(a1 + 124));
      *(_DWORD *)(a1 + 124) = 0;
      return v4;
    }
    else
...
{
  io_registry_entry_t v2 = IORegistryEntryFromPath(kIOMainPortDefault, "IODeviceTree:/");
  CFDataRef CFProperty = (const __CFData *)IORegistryEntryCreateCFProperty(v2, @"target-type", kCFAllocatorDefault, 0);
  __int16 v16 = 0;
  *(void *)buffer = 0;
  __int16 v14 = 0;
  *(void *)__s2 = 0x3132313355;
  ...
  {
    int v9 = 136315394;
    io_object_t v10 = buffer;
    __int16 v11 = 2080;
    CFTypeID v12 = __s2;
    _os_log_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "SavageDeviceLog: target-type = %s; unallowedTarget = %s \n",
      (uint8_t *)&v9,
      0x16u);
  }
...
{
  CFTypeRef v2 = IORegistryEntrySearchCFProperty(*(_DWORD *)(a1 + 120), "IOService", @"sensor-type", kCFAllocatorDefault, 3u);
  *(_DWORD *)buffer = 0;
  if (v2)
  {
    mach_port_t v3 = v2;
...
uint64_t sub_100002F0C(uint64_t a1)
{
  ...
  {
    uint64_t v9 = 0;
    CFTypeRef v2 = (void *)(a1 + 128);
    uint64_t SensorInfo = SavageCamInterfaceOpen();
    if (SensorInfo) {
      return SensorInfo;
    }
    if (!*v2) {
    ...
    uint64_t SensorInfo = SavageCamInterfaceGetSensorInfo();
    if (SensorInfo) {
      return SensorInfo;
    }
    *(_DWORD *)(a1 + 108) = v9;
    int v4 = BYTE4(v9);
    *(unsigned char *)(a1 + 105) = BYTE4(v9);
    *(unsigned char *)(a1 + 16) = BYTE5(v9);
    if (!v4) {
      sub_100002C08(a1);
    }
  }
  ...
  else
  {
    ...
    unsigned int v7 = IOServiceOpen(*(_DWORD *)(a1 + 120), mach_task_self_, 0x2Au, (io_connect_t *)(a1 + 124));
    mach_port_t v8 = *(_DWORD *)(a1 + 124);
    if (v8) {
      uint64_t v5 = v7;
    }
    else {
...
uint64_t sub_100003058(uint64_t a1, UInt8 *a2)
{
  ...
  if (CFProperty)
  {
    ...
    v13.location = 0;
    v13.length = 16;
    CFDataGetBytes(v6, v13, a2);
    CFRelease(v6);
    CFDataRef v8 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavagePubKey", kCFAllocatorDefault, 0);
    if (!v8) {
      return v4;
    }
    CFDataRef v6 = v8;
...
LABEL_8:
    ...
    v14.location = 0;
    v14.length = 56;
    CFDataGetBytes(v6, v14, a2 + 16);
    CFRelease(v6);
    CFDataRef v10 = (const __CFData *)IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageKCV", kCFAllocatorDefault, 0);
    if (v10)
    {
      CFDataRef v6 = v10;
...
uint64_t sub_100003198(uint64_t a1, __CFDictionary *a2)
{
  uint64_t v4 = 3758097136;
  CFTypeRef CFProperty = IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageUID", kCFAllocatorDefault, 0);
  if (CFProperty)
  {
    CFDataRef v6 = CFProperty;
    CFTypeID v7 = CFGetTypeID(CFProperty);
    ...
    CFDictionaryAddValue(a2, @"Savage,UID", v6);
    CFRelease(v6);
    CFTypeRef v8 = IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageNonce", kCFAllocatorDefault, 0);
    if (v8)
    {
      CFDataRef v6 = v8;
      CFTypeID v9 = CFGetTypeID(v8);
      ...
      CFDictionaryAddValue(a2, @"Savage,Nonce", v6);
      CFRelease(v6);
      CFTypeRef v10 = IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageChipID", kCFAllocatorDefault, 0);
      if (v10)
      {
        CFDataRef v6 = v10;
        CFTypeID v11 = CFGetTypeID(v10);
        ...
        CFDictionaryAddValue(a2, @"Savage,ChipID", v6);
        CFRelease(v6);
        CFTypeRef v12 = IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageDeviceRev", kCFAllocatorDefault, 0);
        if (v12)
        {
          CFDataRef v6 = v12;
          ...
          CFDictionaryAddValue(a2, @"Savage,Revision", v6);
          BytePtr = CFDataGetBytePtr((CFDataRef)v6);
          if (BytePtr) {
            *(unsigned char *)(a1 + 68) = (*BytePtr & 0xF0) == 160;
          }
          CFRelease(v6);
          CFTypeRef v15 = IORegistryEntryCreateCFProperty(*(_DWORD *)(a1 + 120), @"SavageMNS", kCFAllocatorDefault, 0);
          if (v15)
          {
            CFDataRef v6 = v15;
            ...
            CFRange v17 = CFDataGetBytePtr((CFDataRef)v6);
            if (v17)
            {
              int v18 = *v17;
              if (v18 == 6)
            ...
            CFRelease(v6);
            CFDictionaryRef v19 = IOServiceNameMatching("ApplePearlSEPDriver");
            uint64_t MatchingService = IOServiceGetMatchingService(kIOMasterPortDefault, v19);
            uint64_t v4 = MatchingService;
            if (MatchingService)
            {
              CFTypeRef v21 = IORegistryEntryCreateCFProperty(MatchingService, @"FDRDataEncryptionKey", kCFAllocatorDefault, 0);
              if (!v21)
              {
LABEL_22:
                IOObjectRelease(v4);
              ...
              if (v22 == CFDataGetTypeID())
              {
                v24.location = 0;
                v24.length = 32;
                CFDataGetBytes((CFDataRef)v6, v24, (UInt8 *)(a1 + 19));
...
uint64_t sub_100003468(uint64_t a1, unsigned int a2)
{
  if (*(unsigned char *)(a1 + 105))
  {
    uint64_t v2 = *(void *)(a1 + 128);
    return _SavageCamInterfaceSensorPrePersonalize(v2, 0);
  }
  else
  {
    mach_port_t v3 = *(_DWORD *)(a1 + 124);
...
uint64_t sub_100003528(uint64_t a1, unsigned int a2)
{
  if (*(unsigned char *)(a1 + 105))
  {
    uint64_t v2 = *(void *)(a1 + 128);
    return _SavageCamInterfaceSensorPreFusing(v2, 0);
  }
  else
  {
    mach_port_t v3 = *(_DWORD *)(a1 + 124);
...
uint64_t sub_1000035E8(uint64_t a1, unsigned int a2, uint64_t a3, unsigned int a4)
{
  if (*(unsigned char *)(a1 + 105))
  {
...
{
  uint64_t v2 = SavageCamInterfaceSensorAuth();
  sub_100002794(a1);
  return v2;
}
...
{
  return _SavageCamInterfacePublishToRegistry(*(void *)(a1 + 128));
}
...
__CFDictionary *SavageUpdaterGetTags(const __CFDictionary *a1, CFTypeRef *a2)
{
  ...
  *(_DWORD *)buffer = 0;
  ...
  if (!Mutable)
  {
    CFErrorRef v55 = sub_100001E78((uint64_t)"SavageUpdaterGetTags: Cannot allocate memory for outputDict", 3u, 0, @"SavageErrorDomain");
    CFTypeRef v28 = 0;
    uint64_t v5 = 0;
    goto LABEL_45;
  }
  if (a1)
  {
    ...
    if (v5)
    {
      ...
      if (v6)
      {
        CFTypeID v7 = CFDictionaryGetValue(a1, @"DeviceInfo");
        if (v7)
        {
          mach_port_t v8 = v7;
          ...
          if (v9 == CFDictionaryGetTypeID())
          {
            ...
            int v18 = "SavageUpdaterGetTags";
            if (v10)
            {
              CFStringRef v19 = v10;
              CFStringGetCString(v10, byte_10000C088, 4096, 0);
              sub_100005510((uint64_t)"%s [input]: DeviceInfo %s \n", v20, v21, v22, v23, v24, v25, v26, (char)"SavageUpdaterGetTags");
              CFRelease(v19);
            }
            else
            {
            ...
            a1 = (const __CFDictionary *)sub_100001CD4(v8);
            CFDataRef v27 = CFDictionaryGetValue(a1, @"YonkersDeviceInfo");
            CFTypeRef v28 = v27;
            if (v27)
            {
              ...
              {
                CFTypeRef v28 = sub_100001CD4(v28);
                unsigned int v30 = sub_10000213C((CFDictionaryRef)v28, (CFTypeRef *)&value, (CFTypeRef *)&v76);
                if (v30 || !value)
                {
...
LABEL_52:
                  CFErrorRef v55 = sub_100001E78((uint64_t)v57, v30, v58, v56);
                  goto LABEL_53;
                }
...
LABEL_28:
                  ...
                  {
                    CFStringRef v43 = v35;
                    CFStringGetCString(v35, byte_10000C088, 4096, 0);
                    sub_100005510((uint64_t)"%s [output]: %s \n", v44, v45, v46, v47, v48, v49, v50, (char)v18);
                    CFRelease(v43);
                  }
                  else
                  {
            ...
            unsigned int v30 = sub_100001F84(a1, &v79, &v78);
            if (v79)
            {
              if (v78)
              {
                ...
                {
                  CFDataRef v32 = v31;
                  int v18 = (const char *)CFGetTypeID(v31);
      ...
      CFErrorRef v55 = sub_100001E78((uint64_t)v52, v53, v54, @"SavageErrorDomain");
      CFTypeRef v28 = 0;
      goto LABEL_48;
    }
    CFErrorRef v55 = sub_100001E78((uint64_t)"SavageUpdaterGetTags: Cannot allocate memory for tagsInBI", 3u, 0, @"SavageErrorDomain");
    CFTypeRef v28 = 0;
LABEL_45:
    uint64_t v6 = 0;
LABEL_48:
  ...
  CFErrorRef v55 = sub_100001E78((uint64_t)"SavageUpdaterGetTags: options is NULL", 2u, 0, @"SavageErrorDomain");
  CFTypeRef v28 = 0;
  uint64_t v5 = 0;
  uint64_t v6 = 0;
LABEL_53:
  if (a2 && v55)
  {
    *a2 = sub_100001CD4(v55);
    CFStringRef v59 = CFErrorCopyDescription(v55);
    if (v59)
    {
      CFStringRef v67 = v59;
      CFStringGetCString(v59, byte_10000C088, 4096, 0);
      sub_100005510((uint64_t)"%s [error]: %s \n", v68, v69, v70, v71, v72, v73, v74, (char)"SavageUpdaterGetTags");
      CFRelease(v67);
    }
    else
    {
...
LABEL_69:
    v93 = sub_100001E78((uint64_t)v91, 2u, v92, @"SavageErrorDomain");
    CFDataRef v32 = 0;
    CFDataRef v24 = 0;
    CFDataRef v30 = 0;
  ...
  {
    CFStringRef v14 = v6;
    CFStringGetCString(v6, byte_10000C088, 4096, 0);
  ...
  CFDictionaryRef v22 = (const __CFDictionary *)sub_100001CD4(v4);
...
LABEL_22:
  ...
  CFDictionaryRef v26 = (const __CFDictionary *)sub_100001CD4(v24);
  unsigned int v27 = sub_10000213C(v26, &cf, &v103);
  if (v27)
  {
    v93 = sub_100001E78((uint64_t)"SavageUpdaterCopyFirmware: Didn't get yonkers patch measurement tags", v27, (uint64_t)v26, @"YonkersErrorDomain");
    CFDataRef v32 = 0;
    CFDataRef v24 = 0;
    goto LABEL_77;
  }
  CFDataRef v28 = (const __CFData *)sub_1000055B8(a1, (const __CFString *)cf, (CFTypeRef *)&err);
  CFDataRef v24 = v28;
  if (err)
  {
    CFDataRef v32 = 0;
...
LABEL_80:
  ...
  {
    v93 = sub_100001E78((uint64_t)"SavageUpdaterCopyFirmware: Empty Yonkers firmware file?", 4u, (uint64_t)a1, @"YonkersErrorDomain");
    CFDataRef v32 = 0;
LABEL_77:
    CFDataRef v30 = 0;
    goto LABEL_84;
  }
  CFDataRef v29 = (const __CFData *)sub_1000055B8(a1, (const __CFString *)v103, (CFTypeRef *)&err);
  CFDataRef v30 = v29;
  if (err)
  {
    CFDataRef v32 = 0;
  ...
  {
    v93 = sub_100001E78((uint64_t)"SavageUpdaterCopyFirmware: Empty Yonkers alt firmware file?", 4u, (uint64_t)a1, @"YonkersErrorDomain");
    CFDataRef v32 = 0;
LABEL_84:
    CFStringRef v33 = 0;
    CFDataRef v34 = 0;
...
LABEL_83:
    v93 = sub_100001E78((uint64_t)v95, v94, v96, @"SavageErrorDomain");
    goto LABEL_84;
  }
  ...
  {
LABEL_23:
    unsigned int v36 = sub_100001F84(v22, &v102, &v101);
    if (!v36)
    {
      CFDataRef v37 = (const __CFData *)sub_1000055B8(a1, v102, (CFTypeRef *)&err);
      CFDataRef v34 = v37;
      if (!err)
      {
        if (v37 && CFDataGetLength(v37))
        {
          CFDataRef v35 = (const __CFData *)sub_1000055B8(a1, v101, (CFTypeRef *)&err);
          ...
          v93 = sub_100001E78((uint64_t)"SavageUpdaterCopyFirmware: Cannot allocate memory for savageFirmwareData", 3u, (uint64_t)a1, @"SavageErrorDomain");
LABEL_86:
          CFErrorRef err = v93;
          goto LABEL_40;
        }
        v93 = sub_100001E78((uint64_t)"SavageUpdaterCopyFirmware: Empty Savage firmware file", 4u, (uint64_t)a1, @"SavageErrorDomain");
        CFStringRef v33 = 0;
LABEL_85:
        CFDataRef v35 = 0;
        goto LABEL_86;
...
LABEL_34:
  ...
  {
    CFStringRef v50 = v42;
    CFStringGetCString(v42, byte_10000C088, 4096, 0);
  ...
  {
    CFStringRef v66 = v58;
    CFStringGetCString(v58, byte_10000C088, 4096, 0);
...
LABEL_40:
  if (a2 && err)
  {
    *a2 = sub_100001CD4(err);
    CFStringRef v74 = CFErrorCopyDescription(err);
    if (v74)
    {
      CFStringRef v82 = v74;
      CFStringGetCString(v74, byte_10000C088, 4096, 0);
...
LABEL_5:
          if (CFDictionaryContainsKey(a1, @"DeviceInfo"))
          {
            ...
            CFTypeRef v23 = sub_100001CD4(v22);
            CFStringRef v24 = CFCopyDescription(v23);
            if (v24)
            {
              CFStringRef v32 = v24;
              CFStringGetCString(v24, byte_10000C088, 4096, 0);
...
LABEL_8:
                ...
                {
                  CFStringRef v49 = v41;
                  CFStringGetCString(v41, byte_10000C088, 4096, 0);
                  sub_100005510((uint64_t)"%s [input]: FirmwareData %s \n", v50, v51, v52, v53, v54, v55, v56, (char)"SavageUpdaterCreateRequest");
                  CFRelease(v49);
                  if (v40)
                  {
LABEL_11:
                    ...
                    if (v57 == CFDictionaryGetTypeID())
                    {
                      ...
                      CFDataRef v59 = (const __CFData *)sub_100001CD4(v58);
                      if (v59)
                      {
                        CFDataRef v60 = v59;
                        unsigned int v61 = sub_100005B4C(v59, &cf);
                        CFRelease(v60);
                        if (v61)
                        {
                      ...
                      CFDataRef v63 = (const __CFData *)sub_100001CD4(v62);
                      if (v63)
                      {
                        CFDataRef v64 = v63;
                        unsigned int v61 = sub_100001490(v63, &v272);
                        CFRelease(v64);
                        if (v61)
                        {
...
LABEL_233:
                    ...
                    else
                    {
                      ...
                      {
                        CFDataRef v72 = (const __CFData *)sub_100001CD4(v40);
                        unsigned int v61 = sub_100005B4C(v72, &cf);
                        if (v72) {
                          CFRelease(v72);
                        }
                        if (v61)
                    ...
                    {
                      CFStringRef v81 = v73;
                      CFStringGetCString(v73, byte_10000C088, 4096, 0);
                      sub_100005510((uint64_t)"%s [input]: SavageMeasurementDict - %s \n", v82, v83, v84, v85, v86, v87, v88, (char)"SavageUpdaterCreateRequest");
                      CFRelease(v81);
                    }
                    else
                    {
                    ...
                    {
                      CFStringRef v97 = v89;
                      CFStringGetCString(v89, byte_10000C088, 4096, 0);
                      sub_100005510((uint64_t)"%s [input]: YonkersMeasurementDict - %s \n", v98, v99, v100, v101, v102, v103, v104, (char)"SavageUpdaterCreateRequest");
                      CFRelease(v97);
                    }
                    else
                    {
...
LABEL_34:
                    ...
                    uint64_t v40 = sub_100001CD4(v105);
                    ...
                    if (v106)
                    {
                      ...
                      if (v108 == CFDictionaryGetTypeID())
                      {
                        ...
                        if (v110)
                        {
                          ...
                          CFStringGetCString(v110, byte_10000C088, 4096, 0);
                          sub_100005510((uint64_t)"%s [input]: SEP Digest from ReceiptManifest - %s \n", v119, v120, v121, v122, v123, v124, v125, (char)"SavageUpdaterCreateRequest");
                          CFRelease(v118);
                        }
                        else
                        {
...
LABEL_48:
                      CFErrorRef v69 = sub_100001E78((uint64_t)v66, v129, v130, v65);
                      uint64_t v40 = 0;
                      goto LABEL_49;
                    }
                    if (CFDictionaryContainsKey((CFDictionaryRef)v23, @"YonkersDeviceInfo"))
                    {
                      ...
                      CFDictionaryRef v70 = (const __CFDictionary *)sub_100001CD4(v126);
                      unsigned int v127 = sub_100001664(v70, (const __CFDictionary *)v5, (CFDictionaryRef)v272, (uint64_t)v40, (CFTypeRef *)&allocator);
                      if (v127 || !allocator)
                      {
                        CFErrorRef v69 = sub_100001E78((uint64_t)"SavageUpdaterCreateRequest: CreateYonkersRequestDictForTATSU fails.", v127, (uint64_t)a1, @"YonkersErrorDomain");
                        goto LABEL_50;
                      }
                    ...
                    *(_DWORD *)buffer = 0;
                    ...
                    if (allocator)
                    {
                      v150 = (__CFDictionary *)sub_100001CD4(allocator);
                    }
                    else
                    {
...
LABEL_222:
                    ...
                    if (!sub_100001DE0(v152, buffer, 0)) {
                      goto LABEL_223;
                    }
                    sub_100001CE0(v150, @"Savage,ChipID", *(int *)buffer);
                    ...
                    if (!sub_100001DE0(v155, buffer, 0))
                    {
LABEL_223:
                      unsigned int v190 = 11;
                      goto LABEL_195;
                    }
                    sub_100001CE0(v150, @"Savage,PatchEpoch", *(int *)buffer);
...
LABEL_195:
                      ...
                      unsigned int v174 = sub_100001F84((CFDictionaryRef)v23, &key, &v274);
                      ...
                      if (key && v274)
                      {
                        ...
                        if (v176)
                        {
                          ...
                          if (v178 == CFDictionaryGetTypeID())
                          {
                            ...
                            if (!allocator) {
                              CFAllocatorRef allocator = (CFAllocatorRef)sub_100001CD4(v150);
                            }
                            goto LABEL_194;
                          }
                        }
...
LABEL_196:
                      ...
                      {
                        CFErrorRef v69 = sub_100001E78((uint64_t)"SavageUpdaterCreateRequest: CreateRequestDictForTATSU fails.", v190, (uint64_t)a1, @"SavageErrorDomain");
                        a2 = v267;
                        goto LABEL_50;
                      }
LABEL_204:
                      ...
                      if (v250)
                      {
                        ...
                        CFStringGetCString(v250, byte_10000C088, 4096, 0);
                ...
                CFErrorRef v69 = sub_100001E78((uint64_t)"SavageUpdaterCreateRequest: kSavageOptionFirmwareData is NULL in input options", 2u, (uint64_t)a1, @"SavageErrorDomain");
LABEL_49:
                CFDictionaryRef v70 = 0;
                goto LABEL_50;
              }
          ...
          CFErrorRef v69 = sub_100001E78((uint64_t)"SavageUpdaterCreateRequest: Cannot get DeviceInfo", 2u, (uint64_t)a1, @"SavageErrorDomain");
          uint64_t v40 = 0;
          CFTypeRef v23 = 0;
          goto LABEL_49;
        }
  ...
  CFErrorRef v69 = sub_100001E78((uint64_t)v67, 2u, v68, @"SavageErrorDomain");
  uint64_t v40 = 0;
  CFTypeRef v23 = 0;
  CFDictionaryRef v70 = 0;
  CFTypeRef v5 = 0;
LABEL_50:
  if (a2 && v69)
  {
    *a2 = sub_100001CD4(v69);
    CFStringRef v131 = CFErrorCopyDescription(v69);
    if (v131)
    {
      CFStringRef v139 = v131;
      CFStringGetCString(v131, byte_10000C088, 4096, 0);
...
const char *sub_100005510(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  uint64_t result = (const char *)__chkstk_darwin();
  if (off_10000D090)
  {
    vsnprintf(__str, 0x1000uLL, result, &a9);
    return (const char *)off_10000D090(qword_10000D098, __str);
  }
  return result;
}

CFTypeRef sub_1000055B8(const void *a1, const __CFString *a2, CFTypeRef *a3)
{
  CFTypeRef cf = 0;
  ...
  if (Value)
  {
    ...
    CFErrorRef v60 = sub_100001E78((uint64_t)"CreateFileData: bundleDataDict missing expected tag", 0x13u, (uint64_t)a1, @"SavageErrorDomain");
    CFDictionaryRef v28 = 0;
    goto LABEL_30;
  }
  sub_100005510((uint64_t)"%s: Host side restoreInfo path \n", v19, v20, v21, v22, v23, v24, v25, (char)"CreateFileData");
  uint64_t v33 = CFDictionaryGetValue((CFDictionaryRef)a1, @"BuildIdentity");
  CFDictionaryRef v34 = (const __CFDictionary *)sub_100001CD4(v33);
  CFDictionaryRef v28 = v34;
  if (!v34)
  {
    CFErrorRef v60 = sub_100001E78((uint64_t)"CreateFileData: Missing kSavageOptionBuildIdentity", 0xAu, (uint64_t)a1, @"SavageErrorDomain");
LABEL_30:
    CFDictionaryRef v29 = 0;
    CFDictionaryRef v30 = 0;
LABEL_33:
  ...
  CFDictionaryRef v36 = (const __CFDictionary *)sub_100001CD4(v35);
  CFDictionaryRef v30 = v36;
  if (!v36)
  {
    CStringPtr = CFStringGetCStringPtr(a2, 0x600u);
    CFErrorRef v60 = sub_100001E78((uint64_t)CStringPtr, 0xAu, (uint64_t)a1, @"SavageErrorDomain");
    CFDictionaryRef v29 = 0;
    goto LABEL_33;
  }
  uint64_t v37 = CFDictionaryGetValue(v36, @"Info");
  CFDictionaryRef v38 = (const __CFDictionary *)sub_100001CD4(v37);
  CFDictionaryRef v29 = v38;
  if (!v38)
  {
    CFErrorRef v60 = sub_100001E78((uint64_t)"CreateFileData: Missing kSavageBuildIdentityInfoKey", 0xCu, (uint64_t)a1, @"SavageErrorDomain");
    goto LABEL_33;
  }
  uint64_t v39 = CFDictionaryGetValue(v38, @"Path");
  CFTypeRef v32 = sub_100001CD4(v39);
  if (v32)
  {
    uint64_t v40 = CFDictionaryGetValue((CFDictionaryRef)a1, @"BundlePath");
    CFTypeRef v31 = sub_100001CD4(v40);
    if (v31)
    {
    ...
    CFErrorRef v60 = sub_100001E78((uint64_t)v62, v41, (uint64_t)a1, @"SavageErrorDomain");
  }
  else
  {
    CFErrorRef v60 = sub_100001E78((uint64_t)"CreateFileData: Missing kSavageBuildIdentityPathKey", 0xCu, (uint64_t)a1, @"SavageErrorDomain");
    CFTypeRef v31 = 0;
  }
LABEL_37:
  if (a3 && v60)
  {
    *a3 = sub_100001CD4(v60);
    CFStringRef v63 = CFErrorCopyDescription(v60);
    if (v63)
    {
      CFStringRef v71 = v63;
      CFStringGetCString(v63, byte_10000C088, 4096, 0);
...
uint64_t sub_100005B4C(const __CFData *a1, CFTypeRef *a2)
{
  *(void *)buffer = 0;
  uint64_t v14 = 0;
...
{
  v0 = (const char *)qword_10000D0A0;
  if (!qword_10000D0A0)
  {
    v0 = "SavageUtil";
    qword_10000D0A0 = (uint64_t)"SavageUtil";
  }
...
uint64_t sub_100005DD0(uint64_t a1, int a2)
{
  uint64_t v4 = 3758097136;
  *(_DWORD *)buffer = 0;
  CFDataRef CFProperty = (const __CFData *)IORegistryEntryCreateCFProperty(dword_10000D088, @"SavageMNS", kCFAllocatorDefault, 0);
  if (!CFProperty) {
    return v4;
  }
  CFDataRef v6 = CFProperty;
  ...
  CFRelease(v6);
  CFDataRef v10 = (const __CFData *)IORegistryEntryCreateCFProperty(dword_10000D088, @"SavageChipID", kCFAllocatorDefault, 0);
  if (!v10) {
    return v4;
  }
  CFDataRef v6 = v10;
  ...
  v24.location = 0;
  v24.length = 4;
  CFDataGetBytes(v6, v24, buffer);
  CFRelease(v6);
  *(_DWORD *)(a1 + 4) = bswap32(*(unsigned int *)buffer);
  CFDataRef v12 = (const __CFData *)IORegistryEntryCreateCFProperty(dword_10000D088, @"SavageUID", kCFAllocatorDefault, 0);
  if (!v12) {
    return v4;
  }
  CFDataRef v6 = v12;
  ...
  v25.location = 0;
  v25.length = 16;
  CFDataGetBytes(v6, v25, (UInt8 *)(a1 + 8));
  CFRelease(v6);
  if (a2 != 2)
  {
    if (a2 != 1) {
    ...
    CFDataRef v14 = (const __CFData *)IORegistryEntryCreateCFProperty(dword_10000D088, @"SavagePubKey", kCFAllocatorDefault, 0);
    if (!v14) {
      return v4;
    }
    CFDataRef v6 = v14;
    ...
    if (v15 == CFDataGetTypeID())
    {
      v26.location = 0;
      v26.length = 56;
      CFDataGetBytes(v6, v26, (UInt8 *)(a1 + 24));
      CFRelease(v6);
      io_registry_entry_t v16 = dword_10000D088;
      CFStringRef v17 = @"SavagePubKeyHmac";
      goto LABEL_20;
    }
LABEL_23:
    CFRelease(v6);
  ...
  CFDataRef v18 = (const __CFData *)IORegistryEntryCreateCFProperty(dword_10000D088, @"SavageAuthPubKey", kCFAllocatorDefault, 0);
  if (!v18) {
    return v4;
  }
  CFDataRef v6 = v18;
  ...
  v27.location = 0;
  v27.length = 56;
  CFDataGetBytes(v6, v27, (UInt8 *)(a1 + 24));
  CFRelease(v6);
  io_registry_entry_t v16 = dword_10000D088;
  CFStringRef v17 = @"SavageAuthPubKeyHmac";
LABEL_20:
  CFDataRef v20 = (const __CFData *)IORegistryEntryCreateCFProperty(v16, v17, kCFAllocatorDefault, 0);
  if (v20)
  {
    CFDataRef v6 = v20;
    ...
    if (v21 == CFDataGetTypeID())
    {
      v28.location = 0;
      v28.length = 32;
      CFDataGetBytes(v6, v28, (UInt8 *)(a1 + 80));
      uint64_t v4 = 0;
    }
    goto LABEL_23;
  }
...
uint64_t start(int a1, char **a2)
{
  ...
  do
  {
    CFDictionaryRef v5 = IOServiceNameMatching((&off_1000086E0)[v4]);
    dword_10000D088 = IOServiceGetMatchingService(kIOMasterPortDefault, v5);
    if (dword_10000D088) {
      BOOL v6 = 1;
    }
    else {
  ...
  while (!v6);
  CFTypeID v7 = basename(*a2);
  qword_10000D0A0 = (uint64_t)v7;
  if (a1 >= 2)
  {
    int v8 = 0;
    while (1)
    ...
    sub_100005DD0((uint64_t)__buf, v8);
    write(1, __buf, 0x70uLL);
  }
  else
  {
  ...
  if (dword_10000D088) {
    IOObjectRelease(dword_10000D088);
  }
  return 0;
}
...
{
  return _SavageCamInterfaceSensorAuth();
}
