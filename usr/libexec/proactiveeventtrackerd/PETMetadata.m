...
- (void)setMetadataWithConfigVersion:(unint64_t)a3
{
  ...
  [(PETMetadata *)self setUploadTime:(unint64_t)v6];
  ...
  unsigned __int8 v9 = [(PETMetadata *)self isInternal];
  uint64_t v10 = 0;
  if ((v9 & 1) == 0) {
    uint64_t v10 = [(PETMetadata *)self isSeed] ^ 1;
  }
  ...
  v16 = (void *)CFPreferencesCopyAppValue(@"ExperimentGroup", @"com.apple.da");
  id v17 = [v16 isEqualToString:@"carry"];
