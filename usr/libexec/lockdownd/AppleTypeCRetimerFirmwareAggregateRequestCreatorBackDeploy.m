...
- (id)generateHashForData:(id)a3
{
  ...
  CC_SHA384_Init(&v9);
  id v4 = v3;
  id v5 = [v4 bytes:v9.count hash:v9.hash wbuf:v9.wbuf];
...
LABEL_6:
    ...
    while (1)
    {
      ...
      [v6 setObject:&__kCFBooleanTrue forKeyedSubscript:];
      id v12 = v6;
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            [v12 setObject:v16 forKeyedSubscript:v16];
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                ...
                if (objc_opt_isKindOfClass())
                {
                  ...
                  [v12 setObject:v21 forKeyedSubscript:v21];
