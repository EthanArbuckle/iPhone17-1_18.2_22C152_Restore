...
- (UARPAssetVersionBackDeploy)initWithCoder:(id)a3
{
  ...
  unint64_t v9 = -[UARPAssetVersionBackDeploy initWithMajorVersion:minorVersion:releaseVersion:buildVersion:](self, "initWithMajorVersion:minorVersion:releaseVersion:buildVersion:", [v5 unsignedIntegerValue], [v6 unsignedIntegerValue], [v7 unsignedIntegerValue], [v8 unsignedIntegerValue]);
  return v9;
}
