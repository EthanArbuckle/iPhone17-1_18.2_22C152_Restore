    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (![v5 caseInsensitiveCompare:v13])
        {
          ...
          {
            id v16 = [(__objc2_class *)*off_10018F240[v15] tlvFromPropertyListValue:v19];
            v17 = v9;
            id v9 = v16;
          }
        }
...
+ (id)metaDataTable
{
  if (qword_1001B82B0 != -1) {
    dispatch_once(&qword_1001B82B0, &stru_10018F220);
  }
  v2 = (void *)qword_1001B82A8;
