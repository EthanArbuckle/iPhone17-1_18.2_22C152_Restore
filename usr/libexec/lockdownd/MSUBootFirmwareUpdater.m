...
+ (BOOL)supportsAFUH
{
  return sub_10009E384("IODeviceTree:/product", @"atomic-firmware-update-support");
}

+ (BOOL)supportsPCIeNANDBoot
{
  return sub_10009E384("IODeviceTree:/defaults", @"pcie-nand-boot-supported");
}

+ (BOOL)supportsDualiBoot
{
  int v3 = sub_10009E384("IODeviceTree:/product", @"dual-iboot-support");
  if (v3) {
...
+ (BOOL)supportsDualSPINAND
{
  return sub_10009E4D4(@"dual-spi-nand");
}

+ (BOOL)requiresSEPInFW
{
  return sub_10009E4D4(@"sep-is-firmware-payload");
}

+ (BOOL)isSingleStageBoot
{
  return sub_10009E384("IODeviceTree:/product", @"single-stage-boot");
}
...
- (id)_restoreInfoDictionary
{
  ...
  else
  {
    ...
    if (!v5)
    {
      CFTypeRef v6 = sub_10009EC74("IODeviceTree:/chosen", @"boot-nonce");
...
- (id)_encodeFirmware:(id)a3 withRestoreInfo:(id)a4
{
  ...
  if (result)
  {
    uint64_t v7 = AMAuthInstallApImg4EncodeRestoreInfo((const __CFData *)a3, (CFDictionaryRef)a4, &v21);
    if (v7)
    {
    ...
    else
    {
      id v14 = [a3 length];
      [(__CFData *)v21 length];
      iBU_LOG_real(@"original data length: %lu. img4_restore_data length: %lu", "-[MSUBootFirmwareUpdater _encodeFirmware:withRestoreInfo:]", v15, v16, v17, v18, v19, v20, (uint64_t)v14);
    }
    return v21;
  }
  return result;
