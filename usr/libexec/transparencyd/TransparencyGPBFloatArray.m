...
- (TransparencyGPBFloatArray)initWithValueArray:(id)a3
{
  return [(TransparencyGPBFloatArray *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}
...
- (TransparencyGPBFloatArray)initWithCapacity:(unint64_t)a3
{
  float v4 = [(TransparencyGPBFloatArray *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(TransparencyGPBFloatArray *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  float v4 = +[TransparencyGPBFloatArray allocWithZone:a3];
  values = self->_values;
...
{
  float v3 = a3;
  [(TransparencyGPBFloatArray *)self addValues:&v3 count:1];
}
