...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBDoubleArray;
  return [(TransparencyGPBDoubleArray *)&v3 init];
}

- (TransparencyGPBDoubleArray)initWithValueArray:(id)a3
{
  return [(TransparencyGPBDoubleArray *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}
...
- (TransparencyGPBDoubleArray)initWithCapacity:(unint64_t)a3
{
  double v4 = [(TransparencyGPBDoubleArray *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(TransparencyGPBDoubleArray *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  double v4 = +[TransparencyGPBDoubleArray allocWithZone:a3];
  values = self->_values;
...
{
  double v3 = a3;
  [(TransparencyGPBDoubleArray *)self addValues:&v3 count:1];
}
