...
- (TransparencyGPBInt64ObjectDictionary)init
{
  return [(TransparencyGPBInt64ObjectDictionary *)self initWithObjects:0 forKeys:0 count:0];
}
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  uint64_t v5 = objc_alloc_init(TransparencyGPBInt64ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      int v16 = sub_1001405DC((unint64_t)v15, 1, v8);
