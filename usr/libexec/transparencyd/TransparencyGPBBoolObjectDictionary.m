...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (v11)
    {
      ...
      unsigned int v13 = sub_10013DFEC(v11, v7);
      v5 += (uint64_t)&v13[v12 + sub_100139664((int)v13 + (int)v12)];
    }
    char v9 = 0;
    uint64_t v3 = 1;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (values[v10])
    {
      ...
      uint64_t v14 = v9 & 1;
      int v15 = sub_10013B310(1);
      [a3 writeInt32NoTag:sub_10013DFEC(values[v10], v7) + v15];
      [a3 writeBool:1 value:v14];
      sub_10013E120(a3, (const char *)values[v10], v7);
    }
    char v12 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
