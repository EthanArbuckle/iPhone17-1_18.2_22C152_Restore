...
- (TransparencyGPBInt32FloatDictionary)init
{
  return [(TransparencyGPBInt32FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}

- (TransparencyGPBInt32FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)TransparencyGPBInt32FloatDictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBInt32FloatDictionary;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      [v13 floatValue];
      int v16 = v15;
      LODWORD(v13) = sub_10013F3DC(v14, 1, v7);
