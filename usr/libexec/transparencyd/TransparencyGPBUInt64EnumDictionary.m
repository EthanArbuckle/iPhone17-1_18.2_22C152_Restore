...
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBUInt64EnumDictionary)init;
- (TransparencyGPBUInt64EnumDictionary)initWithDictionary:(id)a3;
- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3;
- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 capacity:(unint64_t)a4;
- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unint64_t *)a5 count:(unint64_t)a6;
...
- (TransparencyGPBUInt64EnumDictionary)init
{
  return [(TransparencyGPBUInt64EnumDictionary *)self initWithValidationFunction:0 rawValues:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return [(TransparencyGPBUInt64EnumDictionary *)self initWithValidationFunction:a3 rawValues:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unint64_t *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)TransparencyGPBUInt64EnumDictionary;
...
- (TransparencyGPBUInt64EnumDictionary)initWithDictionary:(id)a3
{
  v4 = -[TransparencyGPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", [a3 validationFunc], 0, 0, 0);
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt64EnumDictionary;
  [(TransparencyGPBUInt64EnumDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt64EnumDictionary allocWithZone:a3];
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        uint64_t v13 = sub_10013FCF0((unint64_t)[v10 unsignedLongLongValue], 1, v7);
        uint64_t v14 = sub_10013B270(2, [v12 intValue]) + v13;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      id v15 = [v13 intValue];
      LODWORD(v13) = sub_10013FCF0((unint64_t)v14, 1, v7);
      [a3 writeInt32NoTag:sub_10013B270(2, v15) + v13];
      if (v7 == 4)
      {
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = sub_10013FCF0(a4->var2, 1, a5);
  id v9 = +[NSMutableData dataWithLength:sub_10013B270(2, v7) + v8];
...
- (void)setEnum:(int)a3 forKey:(unint64_t)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:NSInvalidArgumentException, @"TransparencyGPBUInt64EnumDictionary: Attempt to set an unknown enum value (%d)", v5 format];
  }
