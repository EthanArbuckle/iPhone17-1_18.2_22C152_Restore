...
- (id)configBagURL
{
  ...
  if (v4 == 2)
  {
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8090);
    }
    unint64_t v7 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)v15 = 0;
  ...
  else
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8070);
    }
    id v5 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)v15 = 0;
...
- (id)configBagFileName
{
  ...
  {
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C80D0);
    }
    id v5 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
    {
  ...
  {
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C80B0);
    }
    id v3 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)buf = 0;
...
- (id)configBagRequest
{
  ...
  if (v4)
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C80F0);
    }
    unint64_t v7 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEBUG))
    {
...
LABEL_11:
  ...
  else if ([(TransparencyConfigBag *)self shouldSetInternalHeader])
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8110);
    }
    unint64_t v7 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEBUG))
    {
  ...
  [v5 setValue:v11 forHTTPHeaderField:off_100326510];

  v12 = [(TransparencyConfigBag *)self settings];
  v13 = [v12 automatedDeviceGroup];

  if (v13) {
    [v5 setValue:v13 forHTTPHeaderField:off_100326508];
  }
    ...
    && ![(TransparencyConfigBag *)self currentEnvironment])
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8130);
    }
    v14 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_INFO))
    {
      *(_WORD *)v16 = 0;
...
- (void)getSettings
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ((unint64_t)v4 <= 0x64)
    {
      id v5 = v4;
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8150);
      }
      BOOL v6 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
      {
        int v7 = 134217984;
        id v8 = v5;
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; i = (char *)i + 1)
      {
        ...
        id v14 = [v5 objectForKeyedSubscript:v13, v17];
...
- (BOOL)validateConfigEntries:(id)a3 error:(id *)a4
{
  ...
  if ([v8 count])
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8170);
    }
    id v9 = (void *)qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
    {
      id v10 = v9;
  ...
  else
  {
    ...
    if (v15)
    {
      ...
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8190);
      }
      long long v16 = (void *)qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
      {
        long long v17 = v16;
...
- (BOOL)validateConfigBagCertificates:(id)a3 error:(id *)a4
{
  ...
  if ([v6 count])
  {
    ...
    if (!v10)
    {
      ...
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C81D0);
      }
      id v14 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
      {
        if (a4) {
          id v15 = *a4;
  ...
  else
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C81B0);
    }
    long long v16 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
    {
      LOWORD(v18) = 0;
...
- (BOOL)validateConfigBagSignature:(id)a3 error:(id *)a4
{
  ...
  if (v15)
  {
    ...
    if (v16)
    {
      ...
      if (v17)
      {
        ...
        {
          if (qword_10032F1F8 != -1) {
            dispatch_once(&qword_10032F1F8, &stru_1002C8250);
          }
          int v18 = qword_10032F200;
          if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
          {
            if (a4) {
              id v19 = *a4;
      ...
      else
      {
        ...
        if (qword_10032F1F8 != -1) {
          dispatch_once(&qword_10032F1F8, &stru_1002C8230);
        }
        v22 = qword_10032F200;
        if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
        {
    ...
    else
    {
      ...
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8210);
      }
      objc_super v21 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
      {
        LOWORD(v24) = 0;
  ...
  {
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C81F0);
    }
    int v20 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
    {
      LOWORD(v24) = 0;
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0 && [v8 count])
    {
        ...
        while (2)
        {
          for (i = 0; i != v11; i = (char *)i + 1)
          {
            ...
            if ((objc_opt_isKindOfClass() & 1) == 0)
            {
              ...
              id v8 = v30;
              if (qword_10032F1F8 != -1) {
                dispatch_once(&qword_10032F1F8, &stru_1002C82B0);
              }
              v23 = (void *)qword_10032F200;
              if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
              {
                int v24 = v23;
      ...
      else
      {
        ...
        if (qword_10032F1F8 != -1) {
          dispatch_once(&qword_10032F1F8, &stru_1002C82D0);
        }
        id v8 = v30;
        v27 = (void *)qword_10032F200;
        if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
        {
          v28 = v27;
    ...
    else
    {
      ...
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8290);
      }
      objc_super v21 = (void *)qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
      {
        v22 = v21;
        *(_DWORD *)buf = 136315138;
...
LABEL_35:
  ...
  else
  {
    ...
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8270);
    }
    id v19 = (void *)qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
    {
      int v20 = v19;
      *(_DWORD *)buf = 136315138;
...
- (BOOL)configureFromNetworkBagData:(id)a3 error:(id *)a4
{
  ...
  if (v7 && [(TransparencyConfigBag *)v8 validateConfigBagEntries:v7 error:a4])
  {
    ...
    if (v10)
    {
      ...
      {
        if (qword_10032F1F8 != -1) {
          dispatch_once(&qword_10032F1F8, &stru_1002C82F0);
        }
        uint64_t v13 = qword_10032F200;
        if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
        {
...
- (BOOL)configurationExpired
{
  ...
  {
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C8310);
    }
    BOOL v7 = (void *)qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
    {
      id v8 = v7;
      [(TransparencyConfigBag *)self expirationTime];
...
- (void)configureWithFetcher:(id)a3 completionHandler:(id)a4
{
    ...
    && (v6 || ![(TransparencyConfigBag *)self configurationExpired]))
  {
    ...
    {
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8330);
      }
      id v14 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
      {
  ...
  else
  {
    ...
    {
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8350);
      }
      id v12 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
    ...
    {
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8370);
      }
      id v15 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
...
LABEL_13:
      ...
      objc_sync_exit(v9);
      if (qword_10032F1F8 != -1) {
        dispatch_once(&qword_10032F1F8, &stru_1002C8390);
      }
      uint64_t v13 = qword_10032F200;
      if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_DEFAULT))
      {
...
- (void)clearState:(id *)a3
{
  ...
  {
    if (qword_10032F1F8 != -1) {
      dispatch_once(&qword_10032F1F8, &stru_1002C83B0);
    }
    id v8 = qword_10032F200;
    if (os_log_type_enabled((os_log_t)qword_10032F200, OS_LOG_TYPE_ERROR))
    {
      if (a3) {
        id v9 = *a3;
