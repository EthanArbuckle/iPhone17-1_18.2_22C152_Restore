...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBBoolArray;
  return [(TransparencyGPBBoolArray *)&v3 init];
}

- (TransparencyGPBBoolArray)initWithValueArray:(id)a3
{
  return [(TransparencyGPBBoolArray *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}
...
- (TransparencyGPBBoolArray)initWithCapacity:(unint64_t)a3
{
  BOOL v4 = [(TransparencyGPBBoolArray *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  BOOL v4 = +[TransparencyGPBBoolArray allocWithZone:a3];
  values = self->_values;
  unint64_t count = self->_count;

  return [(TransparencyGPBBoolArray *)v4 initWithValues:values count:count];
}
...
{
  BOOL v3 = a3;
  [(TransparencyGPBBoolArray *)self addValues:&v3 count:1];
}
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  {
    [(TransparencyGPBBoolArray *)self internalResizeToCapacity:(v6 & 0xFFFFFFFFFFFFFFF0) + 16];
  }
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21) {
    [(TransparencyGPBBoolArray *)self internalResizeToCapacity:16];
  }
}
