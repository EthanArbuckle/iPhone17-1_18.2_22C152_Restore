...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  fields = self->fields_;
  if (fields) {
    CFDictionaryApplyFunction(fields, (CFDictionaryApplierFunction)sub_100167090, v4);
  }
  return v4;
}
...
- (id)sortedFields
{
  ...
  if (fields)
  {
    ...
    if (Count)
    {
      ...
      while (Count != v7);
      qsort_b(&v15 - 2 * Count, Count, 0x10uLL, &stru_1002C2F00);
      v10 = v6 + 1;
    ...
    {
      qsort_b(v6, 0, 0x10uLL, &stru_1002C2F00);
    }
...
- (void)writeToCodedOutputStream:(id)a3
{
  ...
  if (fields)
  {
    ...
    else
    {
      ...
      while (Count != v9);
      qsort_b(&v14 - 2 * Count, Count, 0x10uLL, &stru_1002C2F20);
...
- (id)description
{
  ...
  [(NSMutableString *)v3 appendString:sub_10016A064(self, @"  ")];
...
- (unint64_t)serializedSize
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction((CFDictionaryRef)result, (CFDictionaryApplierFunction)sub_100167614, &context);
    return context;
  }
  return result;
}
...
- (void)writeAsMessageSetTo:(id)a3
{
  fields = self->fields_;
  if (fields) {
    CFDictionaryApplyFunction(fields, (CFDictionaryApplierFunction)sub_100167668, a3);
  }
}
...
- (unint64_t)serializedSizeAsMessageSet
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction((CFDictionaryRef)result, (CFDictionaryApplierFunction)sub_1001676B4, &context);
    return context;
  }
  return result;
}
...
- (void)mergeUnknownFields:(id)a3
{
  if (a3)
  {
    ...
    if (v4) {
      CFDictionaryApplyFunction(v4, (CFDictionaryApplierFunction)sub_1001678CC, self);
    }
  }
}
...
{
  char v5 = a3;
  uint64_t v7 = sub_10016B9EC(a3);
  int v8 = sub_10016B9E4(v5);
  BOOL v9 = 0;
  ...
  switch(v8)
  {
    case 0:
      BOOL v9 = 1;
      [self mutableFieldForNumber:v7 create:1]->addVarint(sub_100136C04(v10));
      break;
    case 1:
      BOOL v9 = 1;
      [self mutableFieldForNumber:v7 create:1].addFixed64:sub_100136CA8(v10);
      break;
    case 2:
      id v11 = (TransparencyGPBUnknownFieldSet *)sub_10013703C(v10);
      BOOL v9 = 1;
...
LABEL_6:
    ...
    case 5:
      BOOL v9 = 1;
      [self mutableFieldForNumber:v7 create:1].addFixed32:sub_100136CE4(v10);
      break;
    default:
      return v9;
  }
...
{
  do
    uint64_t v5 = sub_100136D88((uint64_t)a3 + 8);
