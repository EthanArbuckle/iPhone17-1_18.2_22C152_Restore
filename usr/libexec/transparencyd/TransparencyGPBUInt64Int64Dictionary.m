...
- (TransparencyGPBUInt64Int64Dictionary)init
{
  return [(TransparencyGPBUInt64Int64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBUInt64Int64Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt64Int64Dictionary;
  [(TransparencyGPBUInt64Int64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt64Int64Dictionary allocWithZone:a3];
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 unsignedLongLongValue], [(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6)) longLongValue], &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v14 = sub_10013FCF0((unint64_t)[v11 unsignedLongLongValue], 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_10013FCF0((unint64_t)v15, 1, v8);
      [a3 writeInt32NoTag:sub_1001405DC((unint64_t)v16, 2, v7) + v14];
      if (v8 == 4)
      {
