  ...
  if (result)
  {
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        v12 = sub_10013B360(1, v9);
        v13 = &v12[sub_10013B270(2, [v11 intValue])];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_10013B270(2, v13) + v14];
...
{
  uint64_t v6 = *(void *)&a3;
  uint64_t v7 = sub_10013B360(1, a4->var7);
  id v8 = +[NSMutableData dataWithLength:&v7[sub_10013B270(2, v6)]];
