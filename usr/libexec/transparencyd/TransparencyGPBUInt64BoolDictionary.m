...
- (TransparencyGPBUInt64BoolDictionary)init
{
  return [(TransparencyGPBUInt64BoolDictionary *)self initWithBools:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt64BoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBUInt64BoolDictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt64BoolDictionary;
  [(TransparencyGPBUInt64BoolDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt64BoolDictionary allocWithZone:a3];
...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    [dictionary objectForKeyedSubscript:v6] ?: [v6 unsignedLongLongValue] ?: [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "BOOLValue") ?: &v7];
  }
  while (!v7);
}
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_10013B310(2) + v13];
      if (v7 == 4)
      {
