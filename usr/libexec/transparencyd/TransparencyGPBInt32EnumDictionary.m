...
- (TransparencyGPBInt32EnumDictionary)init
{
  return [(TransparencyGPBInt32EnumDictionary *)self initWithValidationFunction:0 rawValues:0 forKeys:0 count:0];
}

- (TransparencyGPBInt32EnumDictionary)initWithValidationFunction:(void *)a3
{
  return [(TransparencyGPBInt32EnumDictionary *)self initWithValidationFunction:a3 rawValues:0 forKeys:0 count:0];
}

- (TransparencyGPBInt32EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const int *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)TransparencyGPBInt32EnumDictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBInt32EnumDictionary;
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        uint64_t v13 = sub_10013F3DC([v10 intValue], 1, v7);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      id v14 = [v12 intValue];
      id v15 = [v13 intValue];
      int v16 = sub_10013F3DC(v14, 1, v7);
      [a3 writeInt32NoTag:sub_10013B270(2, v15) + v16];
      sub_10013F57C(a3, (uint64_t)v14, 1, v7);
...
- (void)setEnum:(int)a3 forKey:(int)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:NSInvalidArgumentException, @"TransparencyGPBInt32EnumDictionary: Attempt to set an unknown enum value (%d)", v5 format];
  }
