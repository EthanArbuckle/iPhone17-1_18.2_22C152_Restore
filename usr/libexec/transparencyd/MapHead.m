...
+ (id)descriptor
{
  id v2 = (id)qword_10032EDB8;
  if (!qword_10032EDB8)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:MapHead messageName:@"MapHead" fileDescription:&unk_100324E10 fields:&off_1003250C8 fieldCount:9 storageSize:64 flags:v4];
    [v2 setupExtraTextInfo:&unk_10028B372];
    qword_10032EDB8 = (uint64_t)v2;
  }
  return v2;
}
