...
+ (BOOL)isFollowupEnabled
{
  if (qword_1003266F0 != -1) {
    dispatch_once(&qword_1003266F0, &stru_1002B7FF0);
  }
  return byte_1003266E8;
}

+ (id)instance
{
  if (qword_100326708 != -1) {
    dispatch_once(&qword_100326708, &stru_1002B8030);
  }
  v2 = (void *)qword_1003266E0;
  ...
  if (v5)
  {
    ...
    if (!v9 && v10)
    {
      if (qword_1003266F8 != -1) {
        dispatch_once(&qword_1003266F8, &stru_1002B8050);
      }
      v11 = qword_100326700;
      if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
      {
...
- (id)detailsAction:(unint64_t)a3 eventId:(id)a4 infoLink:(id)a5
{
  ...
  [v13 setObject:&off_1002D9BB8 forKeyedSubscript:@"action"];
  if (v8) {
...
- (id)settingsAction:(unint64_t)a3 eventId:(id)a4
{
  ...
  [v10 setObject:&off_1002D9BD0 forKeyedSubscript:@"action"];
  [v9 setUserInfo:v10];
...
- (BOOL)postFollowup:(id)a3 type:(unint64_t)a4 eventId:(id)a5 errorCode:(int64_t)a6 optInState:(id)a7 infoLink:(id)a8 additionalInfo:(id)a9 error:(id *)a10
{
  ...
  id v17 = a9;
  if (qword_1003266F8 != -1) {
    dispatch_once(&qword_1003266F8, &stru_1002B8070);
  }
  v18 = qword_100326700;
  if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_DEFAULT))
  {
  ...
  if (v16)
  {
    if ([v16 state] && objc_msgSend(v16, "state") != (id)2)
    {
      if (v15)
      {
        ...
        {
          if (qword_1003266F8 != -1) {
            dispatch_once(&qword_1003266F8, &stru_1002B80F0);
          }
          long long v27 = qword_100326700;
        ...
        {
          if (qword_1003266F8 != -1) {
            dispatch_once(&qword_1003266F8, &stru_1002B8110);
          }
          v33 = qword_100326700;
          if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_DEFAULT))
          {
          ...
          {
            if (qword_1003266F8 != -1) {
              dispatch_once(&qword_1003266F8, &stru_1002B8130);
            }
            v37 = qword_100326700;
            if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
            {
      ...
      {
        if (qword_1003266F8 != -1) {
          dispatch_once(&qword_1003266F8, &stru_1002B80D0);
        }
        long long v29 = qword_100326700;
        if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
        {
          *(_WORD *)buf = 0;
    ...
    {
      if (qword_1003266F8 != -1) {
        dispatch_once(&qword_1003266F8, &stru_1002B80B0);
      }
      v19 = qword_100326700;
      if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
      {
  ...
  {
    if (qword_1003266F8 != -1) {
      dispatch_once(&qword_1003266F8, &stru_1002B8090);
    }
    id v20 = qword_100326700;
    if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
...
{
  if (qword_1003266F8 != -1) {
    dispatch_once(&qword_1003266F8, &stru_1002B8150);
  }
  v5 = qword_100326700;
  if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_INFO))
  {
  ...
  {
    if (qword_1003266F8 != -1) {
      dispatch_once(&qword_1003266F8, &stru_1002B8170);
    }
    id v10 = qword_100326700;
    if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
    {
      if (a3) {
        id v11 = *a3;
        ...
        if (v11)
        {
          ...
          if (!v13)
          {
            ...
            if (v17 == (id)a4 && [v15 isEqualToString:v29])
            {
              ...
              {
                if (qword_1003266F8 != -1) {
                  dispatch_once(&qword_1003266F8, &stru_1002B8190);
                }
                v23 = qword_100326700;
                if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
                {
        ...
        do
        {
          ...
          do
          {
            ...
            if (v11)
            {
              ...
              {
                if (qword_1003266F8 != -1) {
                  dispatch_once(&qword_1003266F8, &stru_1002B81B0);
                }
                id v17 = qword_100326700;
                if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
                {
                  v18 = a4;
                  if (a4) {
...
- (id)_localizedKTStringForKey:(id)a3
{
  ...
  id v5 = v4;
  id v6 = &OBJC_PROTOCOL___KTIDSAccountTracker;
  uint64_t v7 = &OBJC_PROTOCOL___KTIDSAccountTracker;
  if (v4)
  {
            ...
            while (2)
            {
              for (i = 0; i != v13; i = (char *)i + 1)
              {
                ...
                if (v17)
                {
                  ...
                  id v6 = &OBJC_PROTOCOL___KTIDSAccountTracker;
                  if (qword_1003266F8 != -1) {
                    dispatch_once(&qword_1003266F8, &stru_1002B81F0);
                  }
                  id v8 = v27;
                  uint64_t v7 = &OBJC_PROTOCOL___KTIDSAccountTracker;
                  char v22 = qword_100326700;
                  if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_DEBUG))
                  {
...
LABEL_46:
        ...
        if (qword_1003266F8 != -1) {
          dispatch_once(&qword_1003266F8, &stru_1002B8210);
        }
        id v23 = qword_100326700;
        if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
        {
          *(_WORD *)buf = 0;
      ...
      {
        if (qword_1003266F8 != -1) {
          dispatch_once(&qword_1003266F8, &stru_1002B8230);
        }
        id v21 = qword_100326700;
        if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
        {
          *(_WORD *)buf = 0;
    ...
    {
      if (qword_1003266F8 != -1) {
        dispatch_once(&qword_1003266F8, &stru_1002B8250);
      }
      id v20 = qword_100326700;
      if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
      {
...
LABEL_37:
    if (v6[24].inst_props != (__objc2_prop_list *)-1) {
      dispatch_once(&qword_1003266F8, &stru_1002B8270);
    }
    v24 = *(NSObject **)&v7[24].cb;
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v24, OS_LOG_TYPE_ERROR, "failed to get localized string for the current user localization", buf, 2u);
    }
    v18 = [v5 localizedStringForKey:v3 value:v3 table:@"Localizable-NARWHAL"];
    if (v6[24].inst_props != (__objc2_prop_list *)-1) {
      dispatch_once(&qword_1003266F8, &stru_1002B8290);
    }
    long long v25 = *(NSObject **)&v7[24].cb;
...
LABEL_47:
  ...
  if (qword_1003266F8 != -1) {
    dispatch_once(&qword_1003266F8, &stru_1002B81D0);
  }
  v19 = qword_100326700;
  if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_ERROR))
  {
...
- (id)ktFollowupStatus
{
  ...
  if (+[TransparencyFollowup isFollowupEnabled])
  {
    ...
    objc_sync_exit(obj);
    if (qword_1003266F8 != -1) {
      dispatch_once(&qword_1003266F8, &stru_1002B82B0);
    }
    id v23 = qword_100326700;
    if (os_log_type_enabled((os_log_t)qword_100326700, OS_LOG_TYPE_DEBUG))
    {
