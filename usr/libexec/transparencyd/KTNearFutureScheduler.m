...
- (void)changeDelays:(unint64_t)a3 continuingDelay:(unint64_t)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10020B2F0;
  block[3] = &unk_1002C94C8;
  block[4] = self;
  block[5] = a3;
  block[6] = a4;
...
- (id)makeOperationDependency
{
  ...
  v5 = +[KTResultOperation named:v4 withBlock:&stru_1002CA0A8];
...
- (void)triggerAt:(unint64_t)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10020B728;
  block[3] = &unk_1002CA0D0;
...
- (void)_onqueueTrigger:(unint64_t)a3 maximumDelay:(unint64_t)a4
{
        ...
        v24))
  {
    ...
    handler[2] = sub_10020BF1C;
    handler[3] = &unk_1002B72D8;
