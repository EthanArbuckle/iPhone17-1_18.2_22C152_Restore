...
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBUInt32UInt32Dictionary)init;
- (TransparencyGPBUInt32UInt32Dictionary)initWithCapacity:(unint64_t)a3;
- (TransparencyGPBUInt32UInt32Dictionary)initWithDictionary:(id)a3;
- (TransparencyGPBUInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5;
...
- (TransparencyGPBUInt32UInt32Dictionary)init
{
  return [(TransparencyGPBUInt32UInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBUInt32UInt32Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt32UInt32Dictionary;
  [(TransparencyGPBUInt32UInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt32UInt32Dictionary allocWithZone:a3];
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v15 = sub_10013EAE8([v13 unsignedIntValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_10013EAE8(v16, 2, v7) + v14];
      if (v8 == 1)
      {
