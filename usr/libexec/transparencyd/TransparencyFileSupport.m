...
+ (BOOL)setProtectionToClassDForURL:(id)a3 error:(id *)a4
{
  ...
  if (v6)
  {
    if (fcntl(v6, 64, 4) < 0)
    {
      ...
      if (qword_10032F398 != -1) {
        dispatch_once(&qword_10032F398, &stru_1002C9D98);
      }
      v11 = (void *)qword_10032F3A0;
      if (os_log_type_enabled((os_log_t)qword_10032F3A0, OS_LOG_TYPE_ERROR))
      {
        v12 = v11;
        v13 = __error();
        v14 = strerror(*v13);
  ...
  else
  {
    ...
    if (qword_10032F398 != -1) {
      dispatch_once(&qword_10032F398, &stru_1002C9DB8);
    }
    v19 = (void *)qword_10032F3A0;
    if (os_log_type_enabled((os_log_t)qword_10032F3A0, OS_LOG_TYPE_ERROR))
    {
      v20 = v19;
      v21 = __error();
...
+ (id)applicationSupportPath:(id *)a3
{
  ...
  else
  {
    ...
    if (qword_10032F398 != -1) {
      dispatch_once(&qword_10032F398, &stru_1002C9DD8);
    }
    v12 = qword_10032F3A0;
    if (os_log_type_enabled((os_log_t)qword_10032F3A0, OS_LOG_TYPE_ERROR))
    {
