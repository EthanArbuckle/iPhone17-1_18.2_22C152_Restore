...
- (unint64_t)verifyPerApplicationTreeEntry:(id)a3 mapHead:(id)a4 topLevelTreeEntry:(id)a5 error:(id *)a6
{
    ...
    if (v17 == 1)
    {
      ...
      else
      {
        if (qword_10032EF60 != -1) {
          dispatch_once(&qword_10032EF60, &stru_1002C5668);
        }
        v21 = qword_10032EF68;
        unint64_t v17 = 1;
        if (os_log_type_enabled((os_log_t)qword_10032EF68, OS_LOG_TYPE_INFO))
        {
          *(_WORD *)buf = 0;
          unint64_t v17 = 1;
  ...
  {
    if (qword_10032EF60 != -1) {
      dispatch_once(&qword_10032EF60, &stru_1002C55C0);
    }
    v20 = qword_10032EF68;
    if (os_log_type_enabled((os_log_t)qword_10032EF68, OS_LOG_TYPE_INFO))
    {
...
- (unint64_t)verifyInclusionProofWithMapEntry:(id)a3 perAppLogEntry:(id)a4 topLevelTreeEntry:(id)a5 error:(id *)a6
{
  ...
  else
  {
    ...
    {
      if (qword_10032EF60 != -1) {
        dispatch_once(&qword_10032EF60, &stru_1002C56B0);
      }
      id v12 = v26;
      id v24 = qword_10032EF68;
...
- (TransparencyMapInclusionProofVerifier)initWithKeyStore:(id)a3 application:(id)a4
{
  id v6 = a4;
  id v7 = [a3 keyBag];
  id v8 = [(TransparencyMapInclusionProofVerifier *)self initWithKeyBag:v7 application:v6];
