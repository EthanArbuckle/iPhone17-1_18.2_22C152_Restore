...
+ (id)descriptor
{
  id v2 = (id)qword_10032EDA8;
  if (!qword_10032EDA8)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:LogHead messageName:@"LogHead" fileDescription:&unk_100324E10 fields:&off_100324F08 fieldCount:8 storageSize:64 flags:v4];
    [v2 setupExtraTextInfo:&unk_10028B334];
    qword_10032EDA8 = (uint64_t)v2;
  }
  return v2;
}
