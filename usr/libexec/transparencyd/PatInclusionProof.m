...
+ (id)descriptor
{
  id v2 = (id)qword_10032EDD0;
  if (!qword_10032EDD0)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:PatInclusionProof messageName:@"PatInclusionProof" fileDescription:&unk_100324E10 fields:&off_1003252C8 fieldCount:2 storageSize:24 flags:v4];
    [v2 setupExtraTextInfo:&unk_10028B3C8];
    qword_10032EDD0 = (uint64_t)v2;
  }
  return v2;
}
...
LABEL_32:
        ...
        if (qword_10032F008 != -1) {
          dispatch_once(&qword_10032F008, &stru_1002C5B78);
        }
        uint64_t v20 = qword_10032F010;
        if (!os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
        {
LABEL_31:
          v18 = 0;
          goto LABEL_32;
      ...
      else
      {
        ...
        if (qword_10032F008 != -1) {
          dispatch_once(&qword_10032F008, &stru_1002C5B58);
        }
        uint64_t v24 = qword_10032F010;
        if (!os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR)) {
          goto LABEL_31;
        }
        if (a3) {
  ...
  if (qword_10032F008 != -1) {
    dispatch_once(&qword_10032F008, &stru_1002C5B38);
  }
  v19 = qword_10032F010;
  if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
  {
...
LABEL_27:
      ...
      else
      {
        ...
        if (qword_10032F008 != -1) {
          dispatch_once(&qword_10032F008, &stru_1002C5BB8);
        }
        id v17 = qword_10032F010;
        if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
        {
          if (a3) {
            id v18 = *a3;
  ...
  if (qword_10032F008 != -1) {
    dispatch_once(&qword_10032F008, &stru_1002C5B98);
  }
  v16 = qword_10032F010;
  if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
  {
...
- (int)earliestNextTreeVersionWithError:(id *)a3
{
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (qword_10032F008 != -1) {
          dispatch_once(&qword_10032F008, &stru_1002C5BF8);
        }
        v16 = qword_10032F010;
        if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
        {
  ...
  if (qword_10032F008 != -1) {
    dispatch_once(&qword_10032F008, &stru_1002C5BD8);
  }
  v15 = qword_10032F010;
  if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
  {
...
- (unint64_t)shutdownTimeStamp:(id *)a3
{
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (qword_10032F008 != -1) {
          dispatch_once(&qword_10032F008, &stru_1002C5C38);
        }
        v16 = qword_10032F010;
        if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
        {
  ...
  if (qword_10032F008 != -1) {
    dispatch_once(&qword_10032F008, &stru_1002C5C18);
  }
  v15 = qword_10032F010;
  if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
  {
...
- (int)earliestCurrentTreeVersionWithError:(id *)a3
{
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (qword_10032F008 != -1) {
          dispatch_once(&qword_10032F008, &stru_1002C5C78);
        }
        int v15 = 999999999;
        id v17 = qword_10032F010;
        if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
  ...
  if (qword_10032F008 != -1) {
    dispatch_once(&qword_10032F008, &stru_1002C5C58);
  }
  int v15 = 999999999;
  v16 = qword_10032F010;
  if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
...
- (unint64_t)patLogBeginningMs
{
  id v2 = [(PatInclusionProof *)self perApplicationTreeEntry];
  v3 = [v2 slh];
  uint64_t v4 = +[SignedLogHead signedTypeWithObject:v3];
...
- (unint64_t)tltLogBeginningMs
{
  id v2 = [(PatInclusionProof *)self topLevelTreeEntry];
  v3 = [v2 slh];
  uint64_t v4 = +[SignedLogHead signedTypeWithObject:v3];
...
LABEL_8:
  if (qword_10032F008 != -1) {
    dispatch_once(&qword_10032F008, &stru_1002C5C98);
  }
  v35 = qword_10032F010;
  if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
  {
...
- (unint64_t)verifyConfigProof:(id *)a3
{
  ...
  if (result == 1)
  {
    ...
    if (v7)
    {
      ...
      if (qword_10032F008 != -1) {
        dispatch_once(&qword_10032F008, &stru_1002C5CB8);
      }
      v19 = (void *)qword_10032F010;
      if (os_log_type_enabled((os_log_t)qword_10032F010, OS_LOG_TYPE_ERROR))
      {
        id v20 = v19;
