...
- (TransparencyPublicKeyBag)initWithPublicKeysResponse:(id)a3 application:(id)a4 settings:(id)a5 allowOldKeys:(BOOL)a6 error:(id *)a7
{
  ...
  else
  {
    ...
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3A30);
    }
    v21 = (void *)qword_10032EE50;
    a7 = v15;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      v22 = v21;
    ...
    && ([v12 patConfigProof], v24 = objc_claimAutoreleasedReturnValue(), v24, v24))
  {
      ...
      && ([v12 tltConfigProof], v25 = objc_claimAutoreleasedReturnValue(), v25, v25))
    {
      ...
      if (v26 && (v27 = (void *)v26, id v28 = objc_msgSend(v12, "appLeafsArray_Count"), v27, v28))
      {
        ...
        if (qword_10032EE48 != -1) {
          dispatch_once(&qword_10032EE48, &stru_1002C3AB0);
        }
        v37 = qword_10032EE50;
        if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
        {
...
LABEL_40:
      ...
      {
        if (qword_10032EE48 != -1) {
          dispatch_once(&qword_10032EE48, &stru_1002C3A90);
        }
        v36 = qword_10032EE50;
        if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
        {
    ...
    {
      if (v13[457] != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3A70);
      }
      v35 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
  ...
  {
    if (v13[457] != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3A50);
    }
    v34 = qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
...
LABEL_46:
  if ((v33 & 1) == 0)
  {
    ...
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3AD0);
    }
    v62 = (void *)qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      v63 = v62;
      v64 = v81;
...
LABEL_19:
  ...
  if (v25)
  {
    ...
    if (!v27)
    {
      ...
      id v14 = v53;
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3B10);
      }
      v39 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        if (!v32)
        {
          ...
          id v14 = v53;
          if (qword_10032EE48 != -1) {
            dispatch_once(&qword_10032EE48, &stru_1002C3B50);
          }
          char v33 = qword_10032EE50;
          if (!os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR)) {
            goto LABEL_57;
          }
          if (a7) {
...
LABEL_59:
    ...
    id v14 = v53;
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3B30);
    }
    char v33 = qword_10032EE50;
    if (!os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR)) {
      goto LABEL_57;
...
LABEL_22:
  ...
  if (qword_10032EE48 != -1) {
    dispatch_once(&qword_10032EE48, &stru_1002C3AF0);
  }
  v35 = qword_10032EE50;
  if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
  {
...
LABEL_38:
            ...
            if (qword_10032EE48 != -1) {
              dispatch_once(&qword_10032EE48, &stru_1002C3B70);
            }
            v48 = qword_10032EE50;
            if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_INFO))
            {
              *(_WORD *)buf = 0;
            ...
            {
              if (qword_10032EE48 != -1) {
                dispatch_once(&qword_10032EE48, &stru_1002C3B90);
              }
              id v31 = v74;
              v42 = v75;
              id v21 = v72;
            ...
            if (v54)
            {
              ...
              if (qword_10032EE48 != -1) {
                dispatch_once(&qword_10032EE48, &stru_1002C3BD0);
              }
              id v21 = v72;
              unsigned int v57 = (void *)qword_10032EE50;
              if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_INFO))
              {
                v58 = v57;
            ...
            v42 = v75;
            if (qword_10032EE48 != -1) {
              dispatch_once(&qword_10032EE48, &stru_1002C3BB0);
            }
            id v31 = v74;
            id v21 = v72;
            v64 = qword_10032EE50;
...
- (id)createTrustedSthKeyStoreFromProofSPKI:(id)a3 signingKeysMap:(id)a4 error:(id *)a5
{
  ...
  else
  {
    ...
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3BF0);
    }
    uint64_t v15 = qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
...
- (BOOL)verifyCertificates:(id)a3 intermediates:(id)a4 application:(id)a5 error:(id *)a6
{
  ...
  if ([v13 allowsInternalSecurityPolicies])
  {
    ...
    {
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3C10);
      }
      uint64_t v16 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
  ...
  if (AppleKeyTransparency)
  {
    ...
    if (a6 && (v20 & 1) == 0)
    {
      *a6 = +[TransparencyError errorWithDomain:@"TransparencyErrorVerify" code:-29 underlyingError:v12 description:*a6];
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3C50);
      }
      id v21 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
        id v22 = *a6;
        *(_DWORD *)buf = 138412546;
  ...
  else
  {
    ...
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3C30);
    }
    id v23 = qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v26 = v12;
...
- (BOOL)processTltConfigProof:(id)a3 error:(id *)a4
{
  ...
  if (![v6 verifyWithError:a4])
  {
    ...
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3C70);
    }
    uint64_t v17 = qword_10032EE50;
    if (!os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR)) {
      goto LABEL_37;
    }
    if (a4) {
  ...
  if (![v6 nodePosition])
  {
    ...
    {
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3CB0);
      }
      id v28 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
        if (a4) {
          id v29 = *a4;
    ...
    if (v23)
    {
      ...
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3CF0);
      }
      id v26 = (void *)qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
        __int16 v27 = v26;
        *(_DWORD *)buf = 67109376;
...
LABEL_53:
    ...
    {
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3CD0);
      }
      id v31 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)buf = 0;
  ...
  if (qword_10032EE48 != -1) {
    dispatch_once(&qword_10032EE48, &stru_1002C3C90);
  }
  uint64_t v13 = qword_10032EE50;
  if (!os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR)) {
    goto LABEL_37;
  }
  *(_WORD *)buf = 0;
...
- (id)processPamHeadInPatProof:(id)a3 tltEntry:(id)a4 error:(id *)a5
{
  ...
  if (v11 && ([v11 hasObjectMapHead] ? (BOOL v13 = v12 == 0) : (BOOL v13 = 0), v13))
  {
    ...
    if (v23)
    {
      ...
      if (v26 == (id)1)
      {
        ...
        {
          if (qword_10032EE48 != -1) {
            dispatch_once(&qword_10032EE48, &stru_1002C3D70);
          }
          id v21 = v36;
          uint64_t v32 = qword_10032EE50;
          if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138412290;
            id v42 = v12;
      ...
      {
        if (qword_10032EE48 != -1) {
          dispatch_once(&qword_10032EE48, &stru_1002C3D50);
        }
        uint64_t v34 = qword_10032EE50;
        if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138412290;
          id v42 = v27;
    ...
    {
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3D30);
      }
      char v33 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
  ...
  {
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3D10);
    }
    id v14 = qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v42 = v12;
...
- (id)copyVRFKeyFromConfigProof:(id)a3 error:(id *)a4
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3DB0);
      }
      id v14 = (void *)qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
        id v15 = v14;
  ...
  {
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3D90);
    }
    id v18 = (void *)qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      id v19 = v18;
...
- (BOOL)processPatConfigProof:(id)a3 error:(id *)a4
{
  ...
  if (qword_10032EE48 != -1) {
    dispatch_once(&qword_10032EE48, &stru_1002C3DD0);
  }
  id v7 = (void *)qword_10032EE50;
  if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_DEFAULT))
  {
    id v8 = v7;
  ...
  {
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3DF0);
    }
    uint64_t v11 = (void *)qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      id v12 = v11;
  ...
  if (v15)
  {
    ...
    if (v17)
    {
      ...
      if (v22)
      {
        ...
        if (qword_10032EE48 != -1) {
          dispatch_once(&qword_10032EE48, &stru_1002C3E30);
        }
        __int16 v24 = v28;
        id v26 = qword_10032EE50;
        if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
        {
          *(_WORD *)buf = 0;
    ...
    {
      if (qword_10032EE48 != -1) {
        dispatch_once(&qword_10032EE48, &stru_1002C3E10);
      }
      unsigned int v25 = qword_10032EE50;
      if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)buf = 0;
...
- (BOOL)processPatClosedProof:(id)a3 error:(id *)a4
{
  ...
  if (v10)
  {
    ...
    if (qword_10032EE48 != -1) {
      dispatch_once(&qword_10032EE48, &stru_1002C3E50);
    }
    BOOL v14 = qword_10032EE50;
    if (os_log_type_enabled((os_log_t)qword_10032EE50, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 67109376;
      BOOL v17 = v11;
