...
- (KTLockStateTracker)initWithProvider:(id)a3
{
  id v5 = a3;
  v23.receiver = self;
  v23.super_class = (Class)KTLockStateTracker;
...
- (NSDate)lastUnlockTime
{
  ...
  v11 = sub_1001B17F0;
  id v12 = 0;
  char v3 = [(KTLockStateTracker *)self queue];
...
- (id)description
{
  unsigned int v3 = [(KTLockStateTracker *)self isLocked];
  unsigned int v4 = [(KTLockStateTracker *)self hasBeenUnlocked];
  if (v3) {
  ...
  if (v3)
  {
    uint64_t v6 = [(KTLockStateTracker *)self lastUnlockedTime];
  }
  else
  {
    uint64_t v6 = @"now";
  }
  CFStringRef v7 = @" stillLocked";
  if (v4) {
    CFStringRef v7 = &stru_1002CE4C0;
  }
  uint64_t v8 = +[NSString stringWithFormat:@"<KTLockStateTracker: %@ last:%@%@>", v5, v6, v7];
  if (v3) {
...
- (void)resetUnlockDependency
{
  uint64_t v3 = [(KTLockStateTracker *)self unlockDependency];
  if (!v3
    || (unsigned int v4 = (void *)v3,
        [(KTLockStateTracker *)self unlockDependency],
        ...
        (v6 & 1) == 0))
  {
    id v7 = +[KTResultOperation named:@"keybag-unlocked-dependency" withBlock:&stru_1002C58F0];
...
- (void)_onqueueRecheck
{
  uint64_t v3 = [(KTLockStateTracker *)self queue];
  dispatch_assert_queue_V2(v3);

  unsigned int v4 = [(KTLockStateTracker *)self queueIsLocked];
  CFStringRef v5 = [(KTLockStateTracker *)self lockStateProvider];
  -[KTLockStateTracker setQueueIsLocked:](self, "setQueueIsLocked:", [v5 queryAKSLocked]);

  if (v4 == [(KTLockStateTracker *)self queueIsLocked] && (byte_10032EFA0 & 1) != 0) {
    return;
  }
  byte_10032EFA0 = 1;
  ...
  {
    unsigned __int8 v6 = [(KTLockStateTracker *)self operationQueue];
    id v7 = [(KTLockStateTracker *)self unlockDependency];
    [v6 addOperation:v7];
...
LABEL_8:
  unsigned __int8 v9 = [(KTLockStateTracker *)self queueIsLocked];
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
  long long v24 = 0u;
...
- (BOOL)checkErrorChainForLockState:(id)a3
{
  ...
  do
  {
    BOOL v6 = [(KTLockStateTracker *)self lockedError:v5];
    if (v6) {
      break;
    }
    id v7 = [v5 userInfo];
...
- (BOOL)isLockedError:(id)a3
{
  BOOL v4 = [(KTLockStateTracker *)self checkErrorChainForLockState:a3];
  if (v4)
  {
    unsigned __int8 v5 = [(KTLockStateTracker *)self queue];
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_1001B1FCC;
    block[3] = &unk_1002B6CF8;
    void block[4] = self;
...
+ (id)globalTracker
{
  if (qword_10032EFB0 != -1) {
    dispatch_once(&qword_10032EFB0, &stru_1002C5938);
  }
