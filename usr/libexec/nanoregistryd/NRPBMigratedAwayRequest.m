...
{
  v7.receiver = self;
  v7.super_class = (Class)NRPBMigratedAwayRequest;
...
- (BOOL)readFrom:(id)a3
{
  return sub_100061D74((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)advertisedName | v4[1]) {
      unsigned __int8 v6 = -[NSString isEqual:](advertisedName, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return [(NSString *)self->_advertisedName hash];
}
