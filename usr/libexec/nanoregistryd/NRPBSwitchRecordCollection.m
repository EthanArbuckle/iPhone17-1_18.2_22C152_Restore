...
{
  v7.receiver = self;
  v7.super_class = (Class)NRPBSwitchRecordCollection;
  v3 = [(NRPBSwitchRecordCollection *)&v7 description];
  v4 = [(NRPBSwitchRecordCollection *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [objc_alloc((Class)NSMutableArray) initWithCapacity:-[NSMutableArray count](self->_records, "count")];
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return sub_100086A94((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)records | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](records, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_records hash];
}
