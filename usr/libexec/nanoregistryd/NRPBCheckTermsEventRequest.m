...
{
  v7.receiver = self;
  v7.super_class = (Class)NRPBCheckTermsEventRequest;
  v3 = [(NRPBCheckTermsEventRequest *)&v7 description];
  v4 = [(NRPBCheckTermsEventRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100020250((uint64_t)self, (uint64_t)a3);
}
