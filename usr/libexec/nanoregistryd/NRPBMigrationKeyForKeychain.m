...
{
  v7.receiver = self;
  v7.super_class = (Class)NRPBMigrationKeyForKeychain;
  v3 = [(NRPBMigrationKeyForKeychain *)&v7 description];
  v4 = [(NRPBMigrationKeyForKeychain *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10001D088((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 20) & 1) != 0 && self->_keyVersion == *((_DWORD *)v4 + 4))
    {
      BOOL v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has) {
    uint64_t v4 = 2654435761 * self->_keyVersion;
  }
  else {
    uint64_t v4 = 0;
  }
