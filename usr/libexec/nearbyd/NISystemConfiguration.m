...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      unsigned int v7 = [(NISystemConfiguration *)v5 prewarmUWB];
      int prewarmUWB = self->_prewarmUWB;
      unsigned int v9 = [(NISystemConfiguration *)v6 prewarmSecureElementChannel];
...
- (id)description
{
  ...
  unsigned __int8 v6 = [(NISystemConfiguration *)self descriptionInternal];
...
- (id)descriptionInternal
{
  return +[NSString stringWithFormat:@"<prewarm [UWB: %d, secureElementChannel: %d]>", self->_prewarmUWB, self->_prewarmSecureElementChannel];
}
