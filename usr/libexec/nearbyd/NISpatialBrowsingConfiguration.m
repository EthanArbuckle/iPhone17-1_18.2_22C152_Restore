...
- (NISpatialBrowsingConfiguration)initWithCoder:(id)a3
{
  ...
  if (v5 && (id v6 = [v4 decodeIntegerForKey:@"updatesPolicy"], (unint64_t)v6 < 2))
  {
    uint64_t v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"deviceIdentifier"];
    unsigned __int8 v8 = [v4 decodeBoolForKey:@"responder"];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      unsigned int v7 = [(NISpatialBrowsingConfiguration *)v5 isResponder];
      int responder = self->_responder;
      id v9 = [(NISpatialBrowsingConfiguration *)v6 updatesPolicy];
      ...
      unsigned __int8 v15 = [v14 isEqualToString:self->_deviceIdentifier];

      [(NISpatialBrowsingConfiguration *)v6 maxNearbyObjectAge];
      char v13 = 0;
      if (responder == v7 && v9 == (id)updatesPolicy)
      {
...
- (unint64_t)hash
{
  ...
  int64_t updatesPolicy = self->_updatesPolicy;
  id v6 = +[NSNumber numberWithDouble:self->_maxNearbyObjectAge];
...
- (id)description
{
  ...
  id v6 = [(NISpatialBrowsingConfiguration *)self descriptionInternal];
...
- (id)descriptionInternal
{
  ...
  if (self->_updatesPolicy == 1) {
    CFStringRef v3 = @"SignificantChanges";
  }
  else {
    CFStringRef v3 = @"Stream";
  }
