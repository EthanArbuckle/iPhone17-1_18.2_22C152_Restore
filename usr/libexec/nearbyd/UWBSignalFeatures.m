...
- (id)description
{
  ...
  id v4 = [(BiasEstimatorOutputs *)self->_outputs description];
...
- (id)orderedBiasEstimatorFeatutes
{
  unint64_t v3 = [(BiasEstimatorFeatures *)self->_inputFeatures populateOrderedInputFeature];
  id v4 = [(BiasEstimatorOutputs *)self->_outputs populateOrderedBiasEstimatorOutputs];
  id v5 = +[NSString stringWithFormat:@"%@, %@", v3, v4];
