...
+ (id)fromStruct:(AcwgM2MsgStruct)a3
{
  BYTE1(v5) = a3.var7;
  LOBYTE(v5) = a3.var6;
  id v3 = [objc_alloc((Class)a1) initWithSelectedUwbConfigId:a3.var0 selectedPulseShapeCombo:a3.var1 selectedChannelBitmask:a3.var2 supportedSyncCodeIndexBitmask:a3.var3 minRanMultiplier:a3.var4 supportedSlotBitmask:a3.var5 supportedHoppingConfigBitmask:a3.var6 selectedFinalData2Bitmask:v5];
...
- (NIAcwgM2Msg)initWithCoder:(id)a3
{
  ...
  if (self)
  {
    self->_selectedUwbConfigId = (unsigned __int16)[v4 decodeIntForKey:@"selectedUwbConfigId"];
