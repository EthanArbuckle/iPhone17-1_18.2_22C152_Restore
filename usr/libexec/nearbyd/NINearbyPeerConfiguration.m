...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *((void *)v5 + 5) = v6;
  ...
  {
    v8 = [+[NSDictionary allocWithZone:a3] initWithDictionary:self->_debugParameters copyItems:1];
...
- (NINearbyPeerConfiguration)initWithCoder:(id)a3
{
  ...
  unsigned __int8 v5 = [v4 decodeBoolForKey:@"longRangeEnabled"];
  unsigned __int8 v6 = [v4 decodeBoolForKey:@"cameraAssistanceEnabled"];
  id v7 = [v4 decodeIntegerForKey:@"backgroundMode"];
  uint64_t v21 = objc_opt_class();
  v8 = +[NSArray arrayWithObjects:&v21 count:1];
  v9 = +[NSSet setWithArray:v8];

  uint64_t v20 = objc_opt_class();
  objc_super v10 = +[NSArray arrayWithObjects:&v20 count:1];
  v11 = +[NSSet setWithArray:v10];

  objc_super v12 = [v4 decodeDictionaryWithKeysOfClasses:v9 objectsOfClasses:v11 forKey:@"debugParameters"];
  unsigned __int8 v13 = [v4 decodeBoolForKey:@"extendedDistanceMeasurementEnabled"];
  v19.receiver = self;
  v19.super_class = (Class)NINearbyPeerConfiguration;
  v14 = [(NIConfiguration *)&v19 initWithCoder:v4];
  v15 = v14;
  if (v14)
  {
    objc_storeStrong((id *)&v14->_peerDiscoveryToken, obj);
    v15->_longRangeEnabled = v5;
    v15->_cameraAssistanceEnabled = v6;
    objc_storeStrong((id *)&v15->_debugParameters, v12);
    if ((unint64_t)v7 >= 3) {
      int64_t v16 = 0;
    }
    else {
    ...
    v15->_backgroundMode = v16;
    v15->_extendedDistanceMeasurementEnabled = v13;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    unsigned __int8 v5 = (NINearbyPeerConfiguration *)v4;
...
LABEL_16:
    ...
    unsigned int v9 = [(NIDiscoveryToken *)peerDiscoveryToken isEqual:v8];

    int longRangeEnabled = self->_longRangeEnabled;
    unsigned int v11 = [(NINearbyPeerConfiguration *)v6 isLongRangeEnabled];
    int cameraAssistanceEnabled = self->_cameraAssistanceEnabled;
    unsigned int v13 = [(NINearbyPeerConfiguration *)v6 isCameraAssistanceEnabled];
    int64_t backgroundMode = self->_backgroundMode;
    id v22 = [(NINearbyPeerConfiguration *)v6 backgroundMode];
    debugParameters = self->_debugParameters;
    if (!debugParameters)
    {
      v15 = [(NINearbyPeerConfiguration *)v6 debugParameters];
    ...
    int64_t v16 = [(NINearbyPeerConfiguration *)v6 debugParameters];
    unsigned __int8 v17 = [(NSDictionary *)debugParameters isEqual:v16];

LABEL_7:
    int extendedDistanceMeasurementEnabled = self->_extendedDistanceMeasurementEnabled;
    unsigned int v19 = [(NINearbyPeerConfiguration *)v6 isExtendedDistanceMeasurementEnabled];
    BOOL v20 = 0;
...
- (unint64_t)hash
{
  ...
  int64_t backgroundMode = self->_backgroundMode;
  return v3 ^ longRangeEnabled ^ cameraAssistanceEnabled ^ backgroundMode ^ (unint64_t)[(NSDictionary *)self->_debugParameters hash] ^ self->_extendedDistanceMeasurementEnabled ^ 0x1F;
}
...
- (id)description
{
  ...
  unsigned __int8 v6 = [(NINearbyPeerConfiguration *)self descriptionInternal];
...
- (id)descriptionInternal
{
  ...
  {
    unsigned __int8 v5 = [(NIDiscoveryToken *)peerDiscoveryToken descriptionInternal];
  ...
  id v7 = [(NSDictionary *)self->_debugParameters description];
