...
- (NIConfiguration)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(_OWORD *)v6 = xmmword_1004B86F0;
    v6[2] = 1;
    v7 = operator new(0x10uLL);
    _OWORD *v7 = xmmword_1004B86E0;
    unint64_t v8 = (unint64_t)[v4 decodeIntegerForKey:@"suspensionPolicy"];
    unint64_t v9 = (unint64_t)[v4 decodeIntegerForKey:@"enabledGestures"];
    unsigned __int8 v10 = [v4 decodeBoolForKey:@"supportsCameraAssistance"];
    uint64_t v11 = 0;
    unint64_t v12 = 0;
