...
- (NIBluetoothSample)initWithRSSI:(double)a3 identifier:(id)a4 model:(id)a5 channel:(int)a6 machContinuousTimeSeconds:(double)a7
{
  return [(NIBluetoothSample *)self initWithRSSI:a4 identifier:a5 model:*(void *)&a6 channel:&stru_100869B68 machContinuousTimeSeconds:0 partIdentifier:0 name:a3 presenceConfigData:a7];
}
...
- (NIBluetoothSample)initWithCoder:(id)a3
{
    ...
    && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    double v8 = v7;
    unsigned int v9 = [v4 decodeIntForKey:@"channel"];
...
LABEL_11:
            ...
            unsigned int v39 = [(NIBluetoothSample *)v6 channel];
...
LABEL_19:
                    ...
                    unsigned __int8 v35 = [(NSData *)presenceConfigData isEqualToData:v34];
...
LABEL_23:
                ...
                unsigned __int8 v29 = v10;
                unsigned __int8 v30 = [(NSString *)name isEqualToString:v28];
            ...
            unsigned __int8 v25 = [(NSString *)partIdentifier isEqualToString:v24];
        ...
        unsigned __int8 v14 = [(NSString *)model isEqualToString:v13];

        goto LABEL_11;
      }
      identifier = self->_identifier;
    }
    unsigned int v9 = [(NIBluetoothSample *)v6 identifier];
    unsigned __int8 v10 = [(NSString *)identifier isEqualToString:v9];
...
- (unint64_t)hash
{
  unsigned __int8 v14 = +[NSNumber numberWithDouble:self->_rssi];
  ...
  unint64_t v12 = v4 ^ v3 ^ v5 ^ v7 ^ v9 ^ v10 ^ v11 ^ (unint64_t)[(NSData *)self->_presenceConfigData hash];
...
- (id)description
{
  ...
  unint64_t v7 = [(NIBluetoothSample *)self descriptionInternal];
  [v6 appendString:v7];
...
- (id)descriptionInternal
{
  return +[NSString stringWithFormat:@", partIdentifier: %@", self->_partIdentifier];
}
