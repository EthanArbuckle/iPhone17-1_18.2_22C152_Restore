...
- (NINearbyAccessoryConfiguration)initWithData:(NSData *)data error:(NSError *)error
{
  ...
  v9 = v7;
  id v10 = [(NSData *)v9 bytes];
  int64_t v11 = [(NSData *)v9 length];
  __p = 0;
  v34 = 0;
  uint64_t v35 = 0;
  sub_10003AD14(&__p, v10, (uint64_t)v10 + v11, v11);
  ...
  do
  {
    if (__PAIR64__(v19, v18) == __PAIR64__((unsigned __int16)word_1004B8708[v14 + 1], (unsigned __int16)word_1004B8708[v14]))
    {
      int v22 = 1;
      goto LABEL_25;
    }
...
- (NINearbyAccessoryConfiguration)initWithDataExchangeDisabledAndUsingParameterOverrides:(id)a3
{
  ...
  if (v6)
  {
    ...
    id v10 = [(NSDictionary *)v6->_debugParameters objectForKeyedSubscript:@"LocalAddressOverride"];
    ...
    unsigned int v18 = -[NIDiscoveryToken initWithDeviceAddress:](v16, "initWithDeviceAddress:", [v17 unsignedShortValue]);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(NSData *)self->_rawData copyWithZone:a3];
  v7 = (void *)v5[4];
  v5[4] = v6;
  ...
  {
    id v10 = [+[NSDictionary allocWithZone:a3] initWithDictionary:self->_debugParameters copyItems:1];
    id v11 = (void *)v5[8];
    v5[8] = v10;
  }
  return v5;
...
- (NINearbyAccessoryConfiguration)initWithCoder:(id)a3
{
  ...
  id v17 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"rawData"];
  ...
  id v8 = +[NSArray arrayWithObjects:v20 count:3];
  id v9 = +[NSSet setWithArray:v8];

  id v10 = [v4 decodeDictionaryWithKeysOfClasses:v7 objectsOfClasses:v9 forKey:@"debugParameters"];
  unsigned __int8 v11 = [v4 decodeBoolForKey:@"cameraAssistanceEnabled"];
  id v12 = [v4 decodeIntegerForKey:@"backgroundMode"];
  v19.receiver = self;
  v19.super_class = (Class)NINearbyAccessoryConfiguration;
  objc_super v13 = [(NIConfiguration *)&v19 initWithCoder:v4];
  uint64_t v14 = v13;
  if (v13)
  {
    objc_storeStrong((id *)&v13->_accessoryDiscoveryToken, obj);
    objc_storeStrong((id *)&v14->_debugParameters, v10);
    objc_storeStrong((id *)&v14->_rawData, v17);
    objc_storeStrong((id *)&v14->_bluetoothDeviceIdentifier, v5);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    else
    {
      ...
      unsigned int v9 = [(NSData *)rawData isEqualToData:v8];

      id v10 = [(NINearbyAccessoryConfiguration *)v6 bluetoothDeviceIdentifier];
      if (v10) {
        BOOL v11 = 0;
      }
      else {
      ...
      objc_super v13 = [(NINearbyAccessoryConfiguration *)v6 bluetoothDeviceIdentifier];
      unsigned int v14 = [v13 isEqual:self->_bluetoothDeviceIdentifier];

      int cameraAssistanceEnabled = self->_cameraAssistanceEnabled;
      unsigned int v16 = [(NINearbyAccessoryConfiguration *)v6 isCameraAssistanceEnabled];
      int64_t backgroundMode = self->_backgroundMode;
      id v24 = [(NINearbyAccessoryConfiguration *)v6 backgroundMode];
      id v25 = (id)backgroundMode;
      unsigned int v18 = [(NINearbyAccessoryConfiguration *)v6 debugParameters];
      unsigned int v19 = v9;
      if (v18) {
        BOOL v23 = 0;
      }
      ...
      unsigned __int8 v21 = [v20 isEqualToDictionary:self->_debugParameters];
...
- (unint64_t)hash
{
  unint64_t v3 = (unint64_t)[(NSData *)self->_rawData hash];
  unint64_t v4 = [(NIDiscoveryToken *)self->_accessoryDiscoveryToken hash];
  return v3 ^ v4 ^ (unint64_t)[(NSUUID *)self->_bluetoothDeviceIdentifier hash] ^ self->_cameraAssistanceEnabled ^ self->_backgroundMode ^ 0x1F;
}
...
- (id)description
{
  ...
  id v6 = [(NINearbyAccessoryConfiguration *)self descriptionInternal];
...
- (id)descriptionInternal
{
  ...
  {
    id v7 = [(NSUUID *)bluetoothDeviceIdentifier UUIDString];
