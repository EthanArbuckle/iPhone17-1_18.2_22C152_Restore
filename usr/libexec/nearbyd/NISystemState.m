...
{
  id v4 = a3;
  v5 = -[NISystemState initWithUWBPreciseDistanceAvailability:uwbExtendedDistanceAvailability:]([NISystemState alloc], "initWithUWBPreciseDistanceAvailability:uwbExtendedDistanceAvailability:", [v4 decodeIntegerForKey:@"uwbPreciseDistanceAvailability"], [v4 decodeIntegerForKey:@"uwbExtendedDistanceAvailability"]);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      id v7 = [(NISystemState *)v5 uwbPreciseDistanceAvailability];
      unint64_t uwbPreciseDistanceAvailability = self->_uwbPreciseDistanceAvailability;
      id v9 = [(NISystemState *)v6 uwbExtendedDistanceAvailability];
      BOOL v11 = v7 == (id)uwbPreciseDistanceAvailability && v9 == self->_uwbExtendedDistanceAvailability;
    }
  }
  else
  {
...
- (id)descriptionInternal
{
  id v3 = +[NIInternalUtils NISystemResourceAvailabilityToString:self->_uwbPreciseDistanceAvailability];
  id v4 = +[NIInternalUtils NISystemResourceAvailabilityToString:self->_uwbExtendedDistanceAvailability];
