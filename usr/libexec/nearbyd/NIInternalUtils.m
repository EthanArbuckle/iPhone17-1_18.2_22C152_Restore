...
+ (id)NISystemResourceAvailabilityToString:(unint64_t)a3
{
  if (a3)
  {
    BOOL v5 = +[NSMutableString stringWithString:@"Unavailable:"];
    BOOL v6 = v5;
    if (a3) {
    ...
    [v6 substringToIndex:[v6 length] - 1];
...
+ (id)NISystemPassiveAccessIntentToString:(unsigned int)a3
{
  if (a3)
  {
    BOOL v5 = +[NSMutableString stringWithString:@"Intent:"];
    BOOL v6 = v5;
    if (a3) {
