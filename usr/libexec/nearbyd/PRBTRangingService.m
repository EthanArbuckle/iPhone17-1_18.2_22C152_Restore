...
- (PRBTRangingService)initWithQueue:(id)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)PRBTRangingService;
...
{
  id v3 = a3;
  v4 = [[PRBTRangingService alloc] initWithQueue:v3];
...
- (BOOL)shouldAcceptNewConnection:(id)a3
{
  ...
  BOOL v7 = [(PRBTRangingService *)self validateClientEntitlements:v4];
  v8 = qword_1008ABDE0;
  if (v7)
  {
    if (os_log_type_enabled((os_log_t)qword_1008ABDE0, OS_LOG_TYPE_DEBUG)) {
    ...
    v9 = [[PRBTRangingClientProxy alloc] initWithConnection:v4 queue:self->_queue];
