...
- (void)updateAllThermalLoad:(BOOL)a3
{
  ...
  *(float *)&double v10 = v9;
  ...
  sub_100031714(52, (int)((double)v5 * 1.06 + 67.0 + (double)v7 * -0.08));
  sub_100031714(51, (int)((double)v4 * 0.88 + -22.0 + (double)v6 * 0.13));
  float v12 = (float)SHIDWORD(qword_1000AAD94);
