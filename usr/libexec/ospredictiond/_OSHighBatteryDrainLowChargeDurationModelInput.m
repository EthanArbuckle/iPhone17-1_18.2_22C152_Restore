...
@implementation _OSHighBatteryDrainLowChargeDurationModelInput

- (_OSHighBatteryDrainLowChargeDurationModelInput)initWithActivity:(double)a3 n_events_prior:(double)a4 batt_weekday_percentile_prior:(double)a5 dist_from_total_mean:(double)a6 drain_since_last_plugin:(double)a7 max_batt_12:(double)a8 mean_activity:(double)a9 mean_daily_plugins:(double)a10 net_drain_since_max:(double)a11 recent_drain_1:(double)a12 recent_drain_15min:(double)a13 recent_drain_3:(double)a14 start_time_secs:(double)a15 user_mean_drain:(double)a16 value:(double)a17
{
  v26.receiver = self;
  v26.super_class = (Class)_OSHighBatteryDrainLowChargeDurationModelInput;
  result = [(_OSHighBatteryDrainLowChargeDurationModelInput *)&v26 init];
  if (result)
  {
    result->_activity = a3;
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:&off_1000699B8];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self activity];
LABEL_30:
  ...
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self n_events_prior];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"batt_weekday_percentile_prior"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self batt_weekday_percentile_prior];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"dist_from_total_mean"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self dist_from_total_mean];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"drain_since_last_plugin"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self drain_since_last_plugin];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"max_batt_12"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self max_batt];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"mean_activity"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self mean_activity];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"mean_daily_plugins"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self mean_daily_plugins];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"net_drain_since_max"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self net_drain_since_max];
    goto LABEL_30;
  }
  ...
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self recent_drain_15min];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"recent_drain_3"])
  {
LABEL_20:
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self recent_drain];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"start_time_secs"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self start_time_secs];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"user_mean_drain"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self user_mean_drain];
    goto LABEL_30;
  }
  if ([v4 isEqualToString:@"value"])
  {
    [(_OSHighBatteryDrainLowChargeDurationModelInput *)self value];
    goto LABEL_30;
  }
  v5 = 0;
LABEL_31:
