...
- (longDurationModel)init;
- (longDurationModel)initWithConfiguration:(id)a3 error:(id *)a4;
- (longDurationModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (longDurationModel)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (longDurationModel)initWithMLModel:(id)a3;
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4;
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5;
@end

@implementation longDurationModel

+ (id)URLOfModelInThisBundle
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 pathForResource:@"longDurationModel" ofType:@"mlmodelc"];
...
- (longDurationModel)initWithMLModel:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)longDurationModel;
    v6 = [(longDurationModel *)&v10 init];
    v7 = v6;
    if (v6) {
...
- (longDurationModel)init
{
  ...
  v4 = [(longDurationModel *)self initWithContentsOfURL:v3 error:0];
...
- (longDurationModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(longDurationModel *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (longDurationModel)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = [(longDurationModel *)self initWithMLModel:v5];
    id v6 = self;
  }
  else
  {
...
- (longDurationModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = [(longDurationModel *)self initWithMLModel:v6];
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v8 = [(longDurationModel *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(longDurationModel *)self model];
  v11 = [v10 predictionFromFeatures:v9 options:v8 error:a5];

  if (v11)
  {
    v12 = [longDurationModelOutput alloc];
    v13 = [v11 featureValueForName:@"duration_pred"];
    [v13 doubleValue];
    v14 = -[longDurationModelOutput initWithDuration_pred:](v12, "initWithDuration_pred:");
  }
  else
  {
    v14 = 0;
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(longDurationModel *)self model];
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(longDurationModel *)self model];
...
- (id)predictionFromPlugin_battery_level:(double)a3 time_from_plugin:(double)a4 med_dur_1:(double)a5 med_dur_2:(double)a6 med_dur_4:(double)a7 med_dur_8:(double)a8 med_dur_16:(double)a9 med_dur_24:(double)a10 cnt_dur_1:(double)a11 cnt_dur_2:(double)a12 cnt_dur_4:(double)a13 cnt_dur_8:(double)a14 cnt_dur_16:(double)a15 cnt_dur_24:(double)a16 std_dur_1:(double)a17 std_dur_2:(double)a18 std_dur_4:(double)a19 std_dur_8:(double)a20 std_dur_16:(double)a21 std_dur_24:(double)a22 weekday_med_dur_1:(double)a23 weekday_med_dur_2:(double)a24 weekday_med_dur_4:(double)a25 weekday_med_dur_8:(double)a26 weekday_med_dur_24:(double)a27 weekday_std_dur_4:(double)a28 error:(id *)a29
{
  v31 = -[longDurationModelInput initWithPlugin_battery_level:time_from_plugin:med_dur_1:med_dur_2:med_dur_4:med_dur_8:med_dur_16:med_dur_24:cnt_dur_1:cnt_dur_2:cnt_dur_4:cnt_dur_8:cnt_dur_16:cnt_dur_24:std_dur_1:std_dur_2:std_dur_4:std_dur_8:std_dur_16:std_dur_24:weekday_med_dur_1:weekday_med_dur_2:weekday_med_dur_4:weekday_med_dur_8:weekday_med_dur_24:weekday_std_dur_4:]([longDurationModelInput alloc], "initWithPlugin_battery_level:time_from_plugin:med_dur_1:med_dur_2:med_dur_4:med_dur_8:med_dur_16:med_dur_24:cnt_dur_1:cnt_dur_2:cnt_dur_4:cnt_dur_8:cnt_dur_16:cnt_dur_24:std_dur_1:std_dur_2:std_dur_4:std_dur_8:std_dur_16:std_dur_24:weekday_med_dur_1:weekday_med_dur_2:weekday_med_dur_4:weekday_med_dur_8:weekday_med_dur_24:weekday_std_dur_4:", a3, a4, a5, a6, a7, a8, a9, a10, *(void *)&a11, *(void *)&a12, *(void *)&a13, *(void *)&a14, *(void *)&a15, *(void *)&a16, *(void *)&a17,
          *(void *)&a18,
          *(void *)&a19,
          *(void *)&a20,
          *(void *)&a21,
          ...
          *(void *)&a27,
          *(void *)&a28);
  v32 = [(longDurationModel *)self predictionFromFeatures:v31 error:a29];
  ...
  if (v12)
  {
    ...
    if ((uint64_t)[v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v16 = [longDurationModelOutput alloc];
        v17 = [v15 featureValueForName:@"duration_pred"];
        [v17 doubleValue];
        v18 = -[longDurationModelOutput initWithDuration_pred:](v16, "initWithDuration_pred:");
