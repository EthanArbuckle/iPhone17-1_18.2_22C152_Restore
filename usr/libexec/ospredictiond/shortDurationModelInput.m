@interface shortDurationModelInput
- (NSSet)featureNames;
- (double)cnt_dur_1;
- (double)cnt_dur_16;
- (double)cnt_dur_2;
...
@implementation shortDurationModelInput

- (shortDurationModelInput)initWithPlugin_battery_level:(double)a3 time_from_plugin:(double)a4 med_dur_1:(double)a5 med_dur_2:(double)a6 med_dur_4:(double)a7 med_dur_8:(double)a8 med_dur_16:(double)a9 med_dur_24:(double)a10 cnt_dur_1:(double)a11 cnt_dur_2:(double)a12 cnt_dur_4:(double)a13 cnt_dur_8:(double)a14 cnt_dur_16:(double)a15 cnt_dur_24:(double)a16 std_dur_1:(double)a17 std_dur_2:(double)a18 std_dur_4:(double)a19 std_dur_8:(double)a20 std_dur_16:(double)a21 std_dur_24:(double)a22 weekday_med_dur_1:(double)a23 weekday_med_dur_2:(double)a24 weekday_med_dur_4:(double)a25 weekday_med_dur_8:(double)a26 weekday_med_dur_24:(double)a27 weekday_std_dur_4:(double)a28
{
  v37.receiver = self;
  v37.super_class = (Class)shortDurationModelInput;
  result = [(shortDurationModelInput *)&v37 init];
  if (result)
  {
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:&off_100069B38];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    [(shortDurationModelInput *)self plugin_battery_level];
LABEL_42:
  ...
  {
    [(shortDurationModelInput *)self time_from_plugin];
    goto LABEL_42;
  }
  ...
  {
    [(shortDurationModelInput *)self med_dur];
    goto LABEL_42;
  }
  ...
  {
    [(shortDurationModelInput *)self cnt_dur];
    goto LABEL_42;
  }
  ...
  {
    [(shortDurationModelInput *)self std_dur];
    goto LABEL_42;
  }
  ...
  {
    [(shortDurationModelInput *)self weekday_med_dur];
    goto LABEL_42;
  }
  if ([v4 isEqualToString:@"weekday_std_dur_4"])
  {
    [(shortDurationModelInput *)self weekday_std_dur];
    goto LABEL_42;
  }
  v5 = 0;
LABEL_43:
