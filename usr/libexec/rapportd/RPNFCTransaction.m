...
{
  id v12 = a3;
  BOOL v5 = (id)[(RPNFCTransaction *)self state] == (id)2;
  v6 = v12;
  if (!v5)
  {
    error = self->_error;
    ...
    else
    {
      ...
      if ((v8 == 0) != (v9 != 0))
      {
        unsigned __int8 v11 = [(NSError *)v8 isEqual:v9];
...
LABEL_12:
  ...
  unsigned __int8 v9 = [(RPNearFieldTapEvent *)v13 isEqual:v8];
...
LABEL_7:
    if (!v10)
    {
      unsigned __int8 v11 = +[NSAssertionHandler currentHandler];
...
LABEL_12:
  ...
  unsigned __int8 v8 = [(RPTransportServiceHandoverMessage *)v14 isEqual:v7];
...
LABEL_12:
  ...
  unsigned __int8 v8 = [(RPIdentity *)v14 isEqual:v7];
...
- (RPNFCTransaction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ([v6 containsValueForKey:@"state"]) {
      v5->_state = (int64_t)[v6 decodeIntegerForKey:@"state"];
    }
    ...
    if ([v7 containsValueForKey:@"role"]) {
      v5->_role = (int64_t)[v7 decodeIntegerForKey:@"role"];
    }
...
- (NSString)description
{
  ...
  v23 = RPNearFieldTransactionStateDescription();
  NSAppendPrintF();
  id v7 = v4;
