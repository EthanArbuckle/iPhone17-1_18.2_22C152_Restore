...
+ (id)nullEndpoint
{
  if (qword_100142C88 != -1) {
    dispatch_once(&qword_100142C88, &stru_100122930);
  }
  v2 = (void *)qword_100142C80;
...
- (RPEndpoint)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ([v19 containsValueForKey:@"osma"]) {
      v5->_operatingSystemVersion.majorVersion = (int64_t)[v19 decodeIntegerForKey:@"osma"];
    }

    id v20 = v19;
    if ([v20 containsValueForKey:@"osmi"]) {
      v5->_operatingSystemVersion.minorVersion = (int64_t)[v20 decodeIntegerForKey:@"osmi"];
    }

    id v21 = v20;
    if ([v21 containsValueForKey:@"osp"]) {
      v5->_operatingSystemVersion.patchVersion = (int64_t)[v21 decodeIntegerForKey:@"osp"];
    }
    ...
    if ([v24 containsValueForKey:@"sf"]) {
      v5->_statusFlags = (unint64_t)[v24 decodeInt64ForKey:@"sf"];
    }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  {
    objc_super v29 = [(RPEndpoint *)self bleTargetData];
    if (v29) {
...
- (id)descriptionWithLevel:(int)a3
{
  ...
  if (sub_10000EACC())
  {
    ...
    if (self->_operatingSystemVersion.majorVersion)
    {
      ...
      int64_t patchVersion = self->_operatingSystemVersion.patchVersion;
      v45 = sub_10000E8DC((uint64_t *)&v57);
      NSAppendPrintF();
      id v29 = v59;
...
LABEL_3:
  ...
  if (!v11)
  {
    id v11 = [(IDSDevice *)v9 modelIdentifier];
    if (!v11) {
      goto LABEL_3;
    }
  }
...
LABEL_7:
  ...
  if (v13)
  {
    ...
    else
    {
      ...
      if (v17)
      {
        unsigned __int8 v19 = [(NSString *)v16 isEqual:v17];
...
LABEL_15:
  ...
  int64_t patchVersion = self->_operatingSystemVersion.patchVersion;
  id v20 = sub_10000E8DC((uint64_t *)&v40);
  if (v9)
  {
...
LABEL_24:
  ...
  unint64_t statusFlags = self->_statusFlags;
  unsigned int v31 = [(IDSDevice *)v9 supportsApplePay];
  uint64_t v32 = 4;
  if (v31) {
    uint64_t v32 = 8388612;
  }
  uint64x2_t v33 = (uint64x2_t)vdupq_n_s64(Int64);
  int8x16_t v34 = vorrq_s8(vandq_s8((int8x16_t)vshlq_u64(v33, (uint64x2_t)xmmword_100119FF0), (int8x16_t)xmmword_10011A020), vandq_s8((int8x16_t)vshlq_u64(v33, (uint64x2_t)xmmword_10011A000), (int8x16_t)xmmword_10011A010));
...
LABEL_18:
  ...
  int64_t patchVersion = self->_operatingSystemVersion.patchVersion;
  id v20 = sub_10000E8DC((uint64_t *)&v39);
...
LABEL_26:
  ...
  sub_10000E9E0(v29, v38);
  id v30 = sub_10000E0C8();
  ...
  if (v30)
  {
    ...
    else
    {
      ...
      if (v34)
      {
        unsigned __int8 v36 = [(NSString *)v33 isEqual:v34];
...
LABEL_10:
  ...
  unsigned __int8 v21 = [(NSString *)v18 isEqual:v19];
...
LABEL_18:
  ...
  unsigned __int8 v28 = [(NSString *)v25 isEqual:v26];
...
LABEL_26:
  ...
  int64_t patchVersion = self->_operatingSystemVersion.patchVersion;
  id v29 = sub_10000E8DC((uint64_t *)&v47);
  if (!v5)
  {
    uint64_t v44 = 0;
    uint64_t v45 = 0;
...
LABEL_43:
  unint64_t statusFlags = self->_statusFlags;
  unsigned int v39 = [v5 supportsApplePay];
...
LABEL_14:
  ...
  if (v17)
  {
    ...
    else
    {
      ...
      if (v21)
      {
        unsigned __int8 v23 = [(NSString *)v20 isEqual:v21];
...
LABEL_22:
  ...
  unsigned __int8 v27 = [v5 bleDevice];
  unsigned __int8 v28 = [v27 advertisementData];
  id v29 = [(SFDevice *)v6 bleDevice];
  id v30 = [v29 advertisementData];
  id v31 = v28;
  id v32 = v30;
  uint64x2_t v33 = v32;
  if (v31 == v32)
  ...
  {
    unsigned int v34 = [v31 isEqual:v32];
  }
  ...
  char v37 = [v5 bleDevice];
  id v38 = [v37 advertisementFields];
  id v39 = [v38 mutableCopy];

  uint64_t v40 = [(SFDevice *)v6 bleDevice];
  unint64_t v41 = [v40 advertisementFields];
  ...
  unsigned int v46 = [v43 isEqual:v44];
...
LABEL_40:
  ...
  if (v51)
  {
    ...
    if (v55)
    {
      unsigned __int8 v57 = [(NSString *)v54 isEqual:v55];
...
LABEL_52:
  ...
  unsigned int v58 = [v5 inDiscoverySession];
  if (self->_inDiscoverySession != v58)
  {
    self->_inDiscoverySession = v58;
    v35 |= 0x400u;
  }
  id v59 = [v5 contactIdentifier];
  v60 = v59;
  if (v59)
  {
    contactID = self->_contactID;
    ...
    if (v63)
    {
      unsigned __int8 v65 = [(NSString *)v62 isEqual:v63];
...
LABEL_62:
  ...
  id v71 = [(IDSDevice *)v66 modelIdentifier];
  if (v71) {
    goto LABEL_81;
  }
  if ([v5 deviceClassCode] == 4)
  {
    ...
    {
      id v71 = @"AudioAccessory5,1";
    }
    else if ([v5 deviceModelCode] == 6)
    {
      id v71 = @"AudioAccessory6,1";
    }
    else
    {
      id v71 = @"AudioAccessory1,1";
    }
LABEL_81:
...
LABEL_82:
  ...
  unsigned __int8 v78 = [(NSString *)v75 isEqual:v76];
...
LABEL_90:
  ...
  int64_t patchVersion = self->_operatingSystemVersion.patchVersion;
  uint64_t v79 = sub_10000E8DC((uint64_t *)&v131);
  v127 = v6;
  v123 = (void *)v79;
  if (!v66) {
    goto LABEL_102;
  ...
  if (v130[3] >= 1)
  {
    ...
    {
      unsigned __int8 v85 = [v82 isEqual:v83];
...
LABEL_102:
  unint64_t statusFlags = self->_statusFlags;
  unsigned int v89 = [v5 deviceActionType];
  unsigned int v90 = [(IDSDevice *)v66 supportsApplePay];
  uint64_t v91 = 2;
  if (v90) {
  ...
  v102 = v71;
  unsigned int v103 = [(__CFString *)v102 hasPrefix:@"AppleTV"];
  ...
  uint64_t v113 = (uint64_t)[v5 distance];
  if (v113 >= 21) {
    int v114 = 30;
  }
  else {
...
- (unsigned)updateTrustStatusFlagsWithIdentity:(id)a3
{
  ...
  unint64_t v6 = statusFlags | qword_10011A1F0[v5];
  if (v6 == statusFlags) {
    return 0;
  }
...
LABEL_36:
  ...
  unsigned int v16 = [(NSString *)self->_model hasPrefix:@"AppleTV"];
  ...
  if (!self->_mediaRemoteIdentifier)
  {
    unsigned __int8 v19 = [v5 mediaRemoteID];
    if (v19)
    {
...
- (unsigned)updateWithCBDevice:(id)a3
{
  ...
  int v8 = [(CBDevice *)v6 bleAdvertisementData];
  id v9 = v7;
  id v10 = v8;
...
LABEL_9:
  ...
  int v12 = 2;
LABEL_10:
  unsigned int v13 = [v4 identifier];
  uint64_t v14 = v13;
  int v48 = v12;
  if (!v13) {
    goto LABEL_18;
...
LABEL_18:
  ...
  unsigned __int8 v26 = [(NSString *)v23 isEqual:v24];
...
LABEL_26:
  ...
  unsigned __int8 v35 = [(NSString *)v32 isEqual:v33];
...
LABEL_40:
  ...
  if (v41)
  {
    unsigned __int8 v43 = [(NSString *)v40 isEqual:v41];
  ...
  uint64_t v14 = v47;
LABEL_43:
  id v45 = [v4 statusFlags:v47];
  if (v45 != self->_statusFlags)
  {
    self->_unint64_t statusFlags = (unint64_t)v45;
    v44 |= 2u;
  }
  if (v4)
  {
...
LABEL_24:
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    unsigned __int8 v9 = [(NSString *)v6 isEqual:v7];
  ...
  if ((v6 == 0) != (v13 != 0))
  {
    unsigned __int8 v15 = [(NSString *)v11 isEqual:v13];
...
LABEL_16:
  ...
  unsigned __int8 v19 = [(NSString *)v11 isEqual:v17];
...
LABEL_18:
    ...
    {
      unsigned __int8 v10 = [(NSString *)v21 isEqual:v22];
    }
