...
{
  uint64_t v9 = *(void *)&a3;
  if (qword_1000EFCB0 != -1) {
    dispatch_once(&qword_1000EFCB0, &stru_1000E1900);
  }
  ...
  BOOL v16 = a4;
  v13[6] = a6;
  dispatch_sync((dispatch_queue_t)qword_1000EFCC0, v13);
...
+ (id)allSampledProcesses
{
  return [(id)qword_1000EFCB8 allValues];
}
...
- (void)removeSelfFromPidCache
{
  if (self->super.super._isSelfInPidCache)
  {
    ...
    v3[4] = self;
    dispatch_async((dispatch_queue_t)qword_1000EFCC0, v3);
  }
}
...
- (void)createHIDExitSource
{
  ...
  if (v6)
  {
    ...
    handler[2] = sub_10006405C;
    handler[3] = &unk_1000E1620;
    handler[4] = self;
  ...
  if ((*p_targetProcessId & 0x80000000) == 0)
  {
    ...
    int v10 = *__error();
    v11 = sub_10002FC10(*p_targetProcessId);
...
LABEL_24:
      ...
      int v11 = *__error();
      uint64_t v12 = sub_10002FC10(*p_targetProcessId);
      ...
      if (v13)
      {
        ...
        if (qword_1000EFD40) {
          CFStringRef v27 = (FILE *)qword_1000EFD40;
        }
        else {
...
- (void)setSamplingIntervalUs:(unsigned int)a3
{
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v5 = *__error();
      char v6 = sub_10002FC70();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        v32 = sub_10002FC10(self->super.super._targetProcessId);
    ...
    int v8 = *__error();
    int v9 = sub_10002FC10(self->super.super._targetProcessId);
...
LABEL_51:
    ...
    {
      v24 = sub_10002FC10(self->super.super._targetProcessId);
  ...
  if (self->super.super._timeoutTime <= a3)
  {
    ...
    if (targetProcessId < 0)
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_FAULT)) {
        sub_10009760C(v55, v56, v57, v58, v59, v60, v61, v62);
      }
    }
    else
    {
      if (byte_1000EFD38)
      {
        ...
        {
          v67 = sub_10002FC10(*p_targetProcessId);
      ...
      int v24 = *__error();
      unsigned int v25 = sub_10002FC10(*p_targetProcessId);
...
LABEL_103:
        ...
        block[1] = 3221225472;
        block[2] = sub_10006864C;
        block[3] = &unk_1000E1150;
        block[4] = self;
        *(double *)&block[5] = v18;
        *(double *)&block[6] = v17;
      ...
      BOOL v48 = sub_10002FC70();
      if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT)) {
        sub_100097570(&self->super.super._targetProcessId);
      }
    }
    if (qword_1000EFD40) {
      v63 = (FILE *)qword_1000EFD40;
    }
    else {
      v63 = __stderrp;
    }
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    int v9 = *__error();
    CFStringRef v10 = sub_10002FC10(*v5);
...
- (void)setSamplingCompletionHandlerQueue:(id)a3 andBlock:(id)a4
{
  if (!a3 || !a4)
  {
    ...
    if (self->super.super._targetProcessId < 0)
    {
      ...
      {
        int v22 = *__error();
        BOOL v23 = sub_10002FC70();
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR)) {
          sub_100097C04(v23, v24, v25, v26, v27, v28, v29, v30);
        }
        *__error() = v22;
      }
      if (byte_1000EFD39) {
      ...
      if (v31)
      {
        ...
        if (v33)
        {
          ...
          if (qword_1000EFD40) {
            uint64_t v57 = (FILE *)qword_1000EFD40;
          }
          else {
        ...
        {
          CFStringRef v34 = sub_10002FC70();
          if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT)) {
            sub_100097B8C(v34, v35, v36, v37, v38, v39, v40, v41);
          }
          if (qword_1000EFD40) {
            CFStringRef v42 = (FILE *)qword_1000EFD40;
          }
          else {
      ...
      sub_10002FB44("-[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1121, "%s: Must provide both queue and block", v4, v5, v6, v7, (char)"queue && block");
    }
    else
    {
      if (byte_1000EFD38)
      ...
      {
        int v17 = *__error();
        double v18 = sub_10002FC10(*p_targetProcessId);
        ...
        {
          BOOL v20 = sub_10002FC70();
          if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT)) {
            sub_100097A84();
          }
          if (qword_1000EFD40) {
            int v21 = (FILE *)qword_1000EFD40;
          }
          else {
            int v21 = __stderrp;
          }
      ...
      char v52 = sub_10002FC10(*p_targetProcessId);
      sub_10002FB44("-[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1121, "%s [%d]: %s: Must provide both queue and block", v53, v54, v55, v56, v52);
    }
    abort();
  }
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100069444;
  block[3] = &unk_1000E19F0;
  block[4] = self;
  block[5] = a3;
  block[6] = v11;
  dispatch_async(processingQueue, block);
...
- (void)stopSamplingWithReason:(unsigned __int8)a3
{
  ...
  if (self->super.super._isSampling)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10006A3C0;
    block[3] = &unk_1000E19A0;
    block[4] = self;
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v7 = *__error();
      BOOL v8 = sub_10002FC70();
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
        sub_10009802C(p_targetProcessId, v3, v8);
      }
      *__error() = v7;
    }
    if (byte_1000EFD39) {
      BOOL v9 = dword_1000EF4E8 <= 0;
    }
    else {
      BOOL v9 = 0;
    }
    ...
    int v10 = *__error();
    CFStringRef v11 = sub_10002FC10(*p_targetProcessId);
    ...
    if (v12)
    {
      ...
      if (qword_1000EFD40) {
        uint64_t v26 = (FILE *)qword_1000EFD40;
      }
      else {
...
LABEL_51:
    ...
    uint64_t v25 = sub_10002FC70();
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT)) {
      sub_100097F94(p_targetProcessId);
    }
    goto LABEL_39;
  }
  if (byte_1000EFD38)
  {
    int v17 = *__error();
    double v18 = sub_10002FC70();
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG)) {
      sub_100098158(v3, v18);
    }
    *__error() = v17;
  }
  if (byte_1000EFD39) {
    BOOL v19 = dword_1000EF4E8 <= 0;
  }
  else {
    BOOL v19 = 0;
  }
  if (v19)
  {
    ...
    if (v20)
    {
      ...
      if (qword_1000EFD40) {
        uint64_t v30 = (FILE *)qword_1000EFD40;
      }
      else {
    ...
    uint64_t v28 = sub_10002FC70();
    if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT)) {
      sub_1000980E0(v3, v28);
    }
LABEL_39:
    if (qword_1000EFD40) {
      uint64_t v29 = (FILE *)qword_1000EFD40;
    }
    else {
...
LABEL_88:
        ...
        v124[1] = 3221225472;
        v124[2] = sub_10006B9F4;
        v124[3] = &unk_1000E1A68;
        char v125 = v4;
        v124[4] = self;
        v124[5] = a3;
      ...
      if (v32)
      {
        ...
        if (qword_1000EFD40) {
          CFStringRef v50 = (FILE *)qword_1000EFD40;
        }
        else {
    ...
    else
    {
      ...
      int v22 = *__error();
      BOOL v23 = sub_10002FC10(*p_targetProcessId);
...
LABEL_86:
  ...
  if ((self->super.super._targetProcessId & 0x80000000) == 0)
  {
    ...
    {
      int v9 = *__error();
      int v10 = sub_10002FC70();
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        CFStringRef v11 = sub_10002FC10(*v8);
        int v12 = *v8;
...
LABEL_127:
  ...
  {
    int v56 = *__error();
    uint64_t v57 = sub_10002FC70();
    if (os_log_type_enabled(v57, OS_LOG_TYPE_DEFAULT))
    {
      uint64_t v58 = sub_10002FC10(*v8);
      int v59 = *v8;
      *(_DWORD *)buf = 136446466;
      v130 = v58;
      __int16 v131 = 1024;
...
LABEL_181:
  ...
  v128[1] = 3221225472;
  v128[2] = sub_10006B6BC;
  v128[3] = &unk_1000E1950;
  v128[4] = self;
  sub_1000643D0((uint64_t)v128);
LABEL_208:
  LOBYTE(v4) = 8;
LABEL_209:
...
- (void)_saveReportToStream:(__sFILE *)a3
{
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_10002FB44("-[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1417, "%s: save report fail %d %d %d", v3, v4, v5, v6, (char)"stream && !_isSampling && _hasSampled");
    }
    else
    {
      if (byte_1000EFD38)
      {
        ...
        {
          BOOL v39 = (const char *)sub_10002FC10(self->super.super._targetProcessId);
          int targetProcessId = self->super.super._targetProcessId;
      ...
      if (v43)
      {
        BOOL v47 = a3 != 0;
        int v48 = *__error();
        CFStringRef v49 = sub_10002FC10(self->super.super._targetProcessId);
        ...
        if (v50)
        {
          ...
          if (qword_1000EFD40) {
            __int16 v72 = (FILE *)qword_1000EFD40;
          }
          else {
        ...
        else
        {
          ...
          {
            char v52 = (const char *)sub_10002FC10(self->super.super._targetProcessId);
      ...
      char v73 = sub_10002FC10(self->super.super._targetProcessId);
      sub_10002FB44("-[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1417, "%s [%d]: %s: save report fail %d %d %d", v74, v75, v76, v77, v73);
    }
    abort();
  }
  if (!self->super.super._isUrgent)
  {
    ...
    if (self->super.super._targetProcessId < 0)
    {
      ...
      if (v25)
      {
        ...
        if (qword_1000EFD40) {
          uint64_t v35 = (FILE *)qword_1000EFD40;
        }
        else {
    ...
    else
    {
      ...
      {
        int v10 = *__error();
        CFStringRef v11 = sub_10002FC70();
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          int v12 = (const char *)sub_10002FC10(*p_targetProcessId);
      ...
      int v15 = *__error();
      CFStringRef v16 = sub_10002FC10(*p_targetProcessId);
...
LABEL_54:
    ...
    if (qword_1000EFD40) {
      CFStringRef v34 = (FILE *)qword_1000EFD40;
    }
    else {
...
- (void)_performSamplePrinterWork:(id)a3
{
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_10002FB44("-[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1433, "%s: save report fail %d %d %d", v3, v4, v5, v6, (char)"callback && !_isSampling && _hasSampled");
    }
    else
    {
      if (byte_1000EFD38)
      ...
      char v73 = sub_10002FC10(self->super.super._targetProcessId);
      sub_10002FB44("-[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1433, "%s [%d]: %s: save report fail %d %d %d", v74, v75, v76, v77, v73);
    }
    abort();
  }
  if (!self->super.super._isUrgent)
