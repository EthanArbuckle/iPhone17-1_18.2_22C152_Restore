...
LABEL_40:
  ...
  v680 = &v682;
  v681 = &v686;
  sub_10007DCBC((uint64_t)v677, v7, v8, v9, v10, v11, v12, v13);
  uint64_t v15 = v687[3];
  do
  {
...
LABEL_788:
  ...
  if (!v67)
  {
    ...
    [(__CFString *)v66 UTF8String];
    [objc_msgSend(v690, "debugDescription") UTF8String];
    sub_10002FB44("CallTreeFrameLineRegex", "SPTextualReportParser.m", 1858, "%s: Unable to compile regex %s: %s", v563, v564, v565, v566, (char)"regex");
LABEL_1043:
    abort();
  }
  id v636 = v67;
  ...
  if (!v69)
  {
    if (byte_1000EFD38)
    {
      ...
      if (os_log_type_enabled(v452, OS_LOG_TYPE_ERROR)) {
        sub_10009B3C8((uint64_t)[(__CFString *)v68 UTF8String], buf);
      }
      *__error() = v451;
    }
    if (byte_1000EFD39 && dword_1000EF4E8 <= 3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v408, OS_LOG_TYPE_FAULT)) {
          sub_10009B384((uint64_t)[(__CFString *)v68 UTF8String], v695);
        }
        if (qword_1000EFD40) {
          v409 = (FILE *)qword_1000EFD40;
        }
        else {
          v409 = __stderrp;
        }
  ...
  if (!v71)
  {
    if (byte_1000EFD38)
    {
      ...
      if (os_log_type_enabled(v454, OS_LOG_TYPE_ERROR)) {
        sub_10009B3C8((uint64_t)[(__CFString *)v70 UTF8String], buf);
      }
      *__error() = v453;
    }
    if (byte_1000EFD39 && dword_1000EF4E8 <= 3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v413, OS_LOG_TYPE_FAULT)) {
          sub_10009B384((uint64_t)[(__CFString *)v70 UTF8String], v695);
        }
        if (qword_1000EFD40) {
          v414 = (FILE *)qword_1000EFD40;
        }
        else {
          v414 = __stderrp;
        }
  ...
  if (!v72)
  {
    if (byte_1000EFD38)
    {
      ...
      if (os_log_type_enabled(v456, OS_LOG_TYPE_ERROR)) {
        sub_10009B3C8((uint64_t)[@"^UUID:(?<whitespace>\\s*)(?:<?(?<binaryUuid>[\\dabcdef\\-]{32,36})>?|(?<binaryIndex>\\d+))$" UTF8String], buf);
      }
      *__error() = v455;
    }
    if (byte_1000EFD39 && dword_1000EF4E8 <= 3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v418, OS_LOG_TYPE_FAULT)) {
          sub_10009B384((uint64_t)[@"^UUID:(?<whitespace>\\s*)(?:<?(?<binaryUuid>[\\dabcdef\\-]{32,36})>?|(?<binaryIndex>\\d+))$" UTF8String], v695);
        }
        if (qword_1000EFD40) {
          v419 = (FILE *)qword_1000EFD40;
        }
        else {
          v419 = __stderrp;
        }
    ...
    v545 = "UUIDLineRegex";
LABEL_1042:
    sub_10002FB44(v545, "SPTextualReportParser.m", v544, "%s: Unable to compile regex %s", v540, v541, v542, v543, (char)"regex");
    goto LABEL_1043;
  }
  id v605 = v72;
  ...
  else
  {
    ...
    *(void *)&buf[16] = sub_100083C18;
    *(void *)&buf[24] = &unk_1000E1E88;
    *(void *)&buf[32] = v636;
    *(void *)&buf[40] = &v676;
    *(void *)&buf[48] = &v674;
    v697 = &v675;
    sub_100080BBC(v14, 0, (uint64_t)buf);
    if (v674 <= 0)
    {
      if (byte_1000EFD38)
      {
...
LABEL_268:
  if (self->_symbolicate)
  {
    ...
    sub_10007E114(v14, (uint64_t)v636, (uint64_t)v611, v647, self->_useDsymForUUIDForEverything, (uint64_t)self->_findDsymsForIDs);
  }
  id v650 = sub_10007E334(v14, 0, (uint64_t)v611, v647);
  if (!v650)
  {
    if (byte_1000EFD38)
    {
    ...
    while (1)
    {
      ...
      if (!v155)
      {
        ...
        if (v192)
        {
          ...
          unint64_t v283 = sub_10007FFBC(-[NSString substringWithRange:](v147, "substringWithRange:", v195, v194));
...
LABEL_303:
        ...
        if (self->_isHeavy != v676 && obj)
        {
          ...
          [obj sortUsingComparator:&stru_1000E1D28];
          [v304 addObject:obj];
          v621 = v304;
...
LABEL_1088:
            if (byte_1000EFD38)
            {
              ...
              if (os_log_type_enabled(v579, OS_LOG_TYPE_ERROR)) {
                sub_10009B4B8((uint64_t)[objc_msgSend(objc_msgSend(v310, "debugDescription"), "UTF8String") UTF8String], buf);
              }
              *__error() = v578;
            }
            if (byte_1000EFD39) {
              BOOL v568 = dword_1000EF4E8 <= 3;
            }
            else {
              BOOL v568 = 0;
            }
            if (v568)
            {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v583, OS_LOG_TYPE_FAULT)) {
                  sub_10009B474([[objc_msgSend(v310, "debugDescription") UTF8String], v695);
                }
                if (qword_1000EFD40) {
                  v584 = (FILE *)qword_1000EFD40;
                }
                else {
                  v584 = __stderrp;
                }
            ...
            sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 839, "%s: No angle bracket contents nor state info for non-frame (%s)", v569, v570, v571, v572, (char)"heaviestNode.angleBracketContents || heaviestNode.stateInfo");
            abort();
          }
          ...
          if (v321)
          {
            ...
            while (1)
            {
              ...
              sub_10008002C(v638, v674 + v675 * (v640 + v322++), *((unsigned char *)v310 + 8) & 1, *((_DWORD *)v310 + 3), v645, (const char *)[v325 UTF8String], *((void *)v310 + 4), (const char *)[*((id *)v310 + 5) UTF8String], 0, 0);
              v321 = (void *)*((void *)v310 + 2);
            }
...
LABEL_617:
              ...
              {
                [v329 sortUsingComparator:&stru_1000E1D28];
                [v621 addObject:v329];
              }
              goto LABEL_591;
            }
          ...
          else
          {
            ...
            sub_100080954(v638, v674 + v675 * (v320 + v613), *((unsigned char *)v310 + 8) & 1, *((_DWORD *)v310 + 3), v645, (const char *)[v328 UTF8String], (uint64_t)[*((id *)v310 + 5) UTF8String], 0, 0);
          }
          uint64_t v615 = v618;
          goto LABEL_617;
        }
        ...
        if ([(NSString *)v147 containsString:@"Binary Images:"])
        {
          ...
          if (v641)
          {
            ...
            while (1)
            {
              ...
              v626 = (const char *)[sub_1000774A0(v366) UTF8String];
              if (v366) {
                v372 = *(void **)(v366 + 40);
              }
              else {
              ...
              if ((int)v385 > (int)v350)
              {
                ...
                sub_10002FB44("PrintLoadInfoLine", "SPTextualReportParser.m", 2436, "%s: Printed %d characters when max is %d: %s, %s, %s", v381, v382, v383, v384, (char)"numChars < nameAndVersionWidth + 1");
                abort();
              }
          ...
          if ((v647 & 1) == 0)
          {
            ...
            id v650 = sub_10007E334(v14, v635, (uint64_t)v611, 0);
          }
          Weak = 0;
          char v603 = 0;
          int v612 = 0;
...
LABEL_550:
      ...
      id v664 = 0;
      uint64_t v663 = 0;
      sub_10008014C(v147, v635, v155, v647, v674, v675, &v669, &v668, &v667, &v666, &v665, &v690, &v664, (int *)&v663 + 1, &v663);
      id v156 = v690;
      id v157 = v690;
      id v158 = v664;
      id v159 = v664;
...
LABEL_953:
            ...
            [(NSString *)v490 UTF8String];
            sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 659, "%s: Non-frame line has count but no indent level (%d: %s)", v574, v575, v576, v577, (char)"rawIndentLevel >= 0");
            abort();
          }
        }
      }
...
LABEL_482:
        ...
        sub_100080954(v638, v256 + (v253 + v165) * v255, v257, v160, v628, v258, (uint64_t)v259, SHIDWORD(v663), v663);
        uint64_t v251 = v615;
        v6 = v610;
        int v164 = v644;
        goto LABEL_580;
      ...
      if (!v165)
      {
        ...
        while (1)
        {
          for (i = 0; i != v287; i = (char *)i + 1)
          {
            ...
            if (sub_10007702C((uint64_t)Weak, v667, 0, -1, (uint64_t)v664, (uint64_t)v690))
            {
              int v164 = v644;
              if (Weak) {
                goto LABEL_579;
...
LABEL_577:
              Weak = sub_1000769CC((uint64_t)SPTreeNode, 0, v667, 0, (void *)0xFFFFFFFFFFFFFFFFLL, v664, v690);
              [obj addObject:Weak];
              goto LABEL_578;
            }
          }
...
LABEL_546:
      ...
      if (!Weak)
      {
        ...
        sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 716, "%s: no previousNode for indent of %d (%d: %s)", v531, v532, v533, v534, (char)"previousNode");
LABEL_942:
        abort();
      }
      ...
      do
      {
        ...
        if (!Weak)
        {
          ...
          [(NSString *)v249 UTF8String];
          sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 721, "%s: no previousNode for indent %d, previousIndentLevel %d (%d: %s)", v481, v482, v483, v484, (char)"previousNode");
          goto LABEL_942;
        }
        int v254 = v633 - 1;
      ...
      LODWORD(v633) = v254;
LABEL_479:
      Weak = sub_100076EA0((uint64_t)Weak, v667, 0, (void *)0xFFFFFFFFFFFFFFFFLL, v158, v156);
      int v164 = v644;
LABEL_578:
      if (Weak) {
LABEL_579:
...
LABEL_584:
    ...
    LOBYTE(v664) = 0;
    LOBYTE(v669) = 0;
    unint64_t v149 = sub_10007E44C(v147, v148, v647, v674, v675);
    id v627 = [v148 rangeWithName:@"kernelDot"];
    id v690 = (id)-1;
    id v150 = sub_10007E4E4(v147, v635, v148, v650, v647, (unint64_t *)&v690);
...
LABEL_319:
    ...
    if (v170 == (id)0x7FFFFFFFFFFFFFFFLL) {
      ...
      uint64_t v171 = (int)sub_10007FFBC(-[NSString substringWithRange:](v623, "substringWithRange:", v170, v169));
    }
    id v172 = v690;
    LOBYTE(v664) = 0;
    *(void *)buf = _NSConcreteStackBlock;
    *(void *)&buf[8] = 3221225472;
    *(void *)&buf[16] = sub_100083A18;
    *(void *)&buf[24] = &unk_1000E1E60;
    *(void *)&buf[32] = v636;
    *(void *)&buf[40] = v614;
    char v706 = v647;
    int v703 = v674;
    ...
    *(void *)&buf[48] = v151;
    ...
    v699 = &v664;
    uint64_t v702 = v171;
    sub_100080BBC(v14, v635, (uint64_t)buf);
    int v173 = v669;
    if ((_BYTE)v669) {
    ...
    {
      int v632 = sub_10007FFBC(-[NSString substringWithRange:](v623, "substringWithRange:", v179, v178));
      if (v647)
      {
        id v642 = sub_100083254(v623, v148, v151, (uint64_t)v172, v176 != 0, v173 != 0);
        int v180 = 0;
        v181 = 0;
        LODWORD(v151) = 0;
        unint64_t v182 = 0;
...
LABEL_484:
                  ...
                  while (v260 < (unint64_t)[v642 count])
                  {
                    ...
                    unint64_t v182 = v262;
                    sub_10008002C(v638, v268, v627 != (id)0x7FFFFFFFFFFFFFFFLL, v632, v612, v266, v617, v267, v606, v262);
                    ++v260;
                    v6 = v610;
                  }
...
LABEL_549:
              ...
              if (v620)
              {
                if (!Weak)
                {
                  ...
                  [(NSString *)v623 UTF8String];
                  sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 578, "%s: no previousNode for indent of %d (%d: %s)", v511, v512, v513, v514, (char)"previousNode");
                  goto LABEL_888;
                }
                if ((int)v633 >= (int)v620)
                {
                  ...
                  [(NSString *)v623 UTF8String];
                  sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 583, "%s: no previousNode for indent %d, previousIndentLevel %d (%d: %s)", v445, v446, v447, v448, (char)"previousNode");
LABEL_888:
                  abort();
                }
LABEL_424:
                Weak = sub_100076EA0((uint64_t)Weak, v627 != (id)0x7FFFFFFFFFFFFFFFLL, v642, (void *)v617, v181, 0);
              }
              else
              {
                if (obj)
...
LABEL_449:
                    ...
                    while (1)
                    {
                      ...
                      if (sub_10007702C((uint64_t)Weak, v627 != (id)0x7FFFFFFFFFFFFFFFLL, v642, v617, (uint64_t)v181, 0))break; {
                      if (v244 == (id)++v246)
                      }
                      {
                        id v244 = [obj countByEnumeratingWithState:&v670 objects:v694 count:16];
...
LABEL_526:
                Weak = sub_1000769CC((uint64_t)SPTreeNode, 0, v627 != (id)0x7FFFFFFFFFFFFFFFLL, v642, (void *)v617, v181, 0);
                [obj addObject:Weak];
              }
              if (Weak) {
LABEL_528:
        ...
        [(NSString *)v623 UTF8String];
        sub_10002FB44("-[SPTextualReportParser parseSpindumpFile:andReportToStream:]", "SPTextualReportParser.m", 484, "%s: No frame bodies in %s (%d: %s)", v431, v432, v433, v434, (char)"frameBodies.firstObject.length > 0");
LABEL_1087:
        abort();
      }
      if ([v148 rangeWithName:@"countAndWhitespace"] != (id)0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        {
          unint64_t v617 = sub_10007FFBC(-[NSString substringWithRange:](v623, "substringWithRange:", v185, v184));
        }
        id v642 = sub_100083254(v623, v148, v151, (uint64_t)v172, v176 != 0, v173 != 0);
        ...
        {
          unint64_t v151 = sub_10007FFBC(-[NSString substringWithRange:](v623, "substringWithRange:", v189, v188));
          id v191 = [v148 rangeWithName:@"endIndex"];
          if (v191 == (id)0x7FFFFFFFFFFFFFFFLL) {
            unint64_t v182 = v151;
          }
          else {
            unint64_t v182 = sub_10007FFBC(-[NSString substringWithRange:](v623, "substringWithRange:", v191, v190));
          }
        }
        goto LABEL_364;
      }
    ...
    sub_10002FB44("ParseFrameLine", "SPTextualReportParser.m", v560, v559, v555, v556, v557, v558, (char)"range.location != NSNotFound");
    goto LABEL_1087;
  }
  v22 = 0;
  id obj = 0;
