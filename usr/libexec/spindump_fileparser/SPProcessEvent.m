...
- (void)takeTransaction
{
  ...
  {
    v3 = (void *)sub_10002FAB8("Process Event [%d]", self->_targetProcessId);
    uint64_t v4 = 0;
...
- (SPProcessEvent)init
{
  ...
  if (v2)
  {
    *(_WORD *)&v2->_useDsymForUUIDForEverything = 0;
    ...
    unsigned int v4 = byte_1000EFD4C;
    v3->_shouldSymbolicate = (byte_1000EFD4C & 8) != 0;
  ...
  if ((self->_targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000EFD38)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG)) {
        sub_10009548C(p_targetProcessId);
      }
      *__error() = v4;
    }
    if (byte_1000EFD39) {
      BOOL v6 = dword_1000EF4E8 <= 0;
    }
    else {
      BOOL v6 = 0;
    }
    ...
    int v7 = *__error();
    v8 = sub_10002FC10(self->_targetProcessId);
...
LABEL_49:
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT)) {
      sub_1000953F8(p_targetProcessId);
    }
    goto LABEL_37;
  }
  if (byte_1000EFD38)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
      sub_100095590((uint64_t)self, v15);
    }
    *__error() = v14;
  }
  if (byte_1000EFD39) {
    BOOL v16 = dword_1000EF4E8 <= 0;
  }
  else {
    BOOL v16 = 0;
  }
  if (v16)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT)) {
      sub_100095520((uint64_t)&self->_transaction, v25, v26, v27, v28, v29, v30, v31);
    }
LABEL_37:
    if (qword_1000EFD40) {
      v32 = (FILE *)qword_1000EFD40;
    }
    else {
      v32 = __stderrp;
    }
...
- (void)_setupSampleStore:(id)a3
{
    ...
    if (targetProcessId < 0)
    {
      if (byte_1000EFD38)
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR)) {
          sub_10009578C(v62, v63, v64, v65, v66, v67, v68, v69);
        }
        *__error() = v61;
      }
      if (byte_1000EFD39) {
        BOOL v70 = dword_1000EF4E8 <= 3;
      }
      else {
        BOOL v70 = 0;
      }
      if (v70)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v73, OS_LOG_TYPE_FAULT)) {
            sub_100095714(v73, v74, v75, v76, v77, v78, v79, v80);
          }
          if (qword_1000EFD40) {
      ...
      sub_10002FB44("-[SPProcessEvent _setupSampleStore:]", "SPProcessEvent.m", 267, "%s: nil sampleStore", v3, v4, v5, v6, (char)"sampleStore");
    }
    else
    {
      if (byte_1000EFD38)
      ...
      {
        int v56 = *__error();
        v57 = sub_10002FC10(*p_targetProcessId);
      ...
      char v91 = sub_10002FC10(*p_targetProcessId);
      sub_10002FB44("-[SPProcessEvent _setupSampleStore:]", "SPProcessEvent.m", 267, "%s [%d]: %s: nil sampleStore", v92, v93, v94, v95, v91);
    }
    abort();
  }
  if ((targetProcessId & 0x80000000) == 0)
  {
    if (byte_1000EFD38)
    {
      ...
      {
        v13 = sub_10002FC10(*p_targetProcessId);
    ...
    int v16 = *__error();
    CFStringRef v17 = sub_10002FC10(*p_targetProcessId);
...
LABEL_48:
  ...
  sub_100059EA8(a3, self->_shouldSymbolicate, self->_useDsymForUUIDForEverything, self->_shouldUseBulkSymbolication);
  ...
  CFStringRef v49 = (const __CFString *)[objc_msgSend(objc_msgSend(a3, "targetProcess"), "bundleVersion")];
  if (v49) {
    CFStringRef v47 = v49;
  }
...
- (id)_samplePrinterForSampleStore:(id)a3
{
  ...
  if (!v5)
  {
    ...
    else
    {
      ...
      int v13 = *__error();
      int v14 = sub_10002FC10(*p_targetProcessId);
...
LABEL_3:
  ...
  [v6 setHeaderNote:sub_10004F02C((int)-[SASamplePrintOptions printHeavyStacks](self->_printOptions, "printHeavyStacks"), v7)];
LABEL_19:
...
- (void)_saveReportToStream:(__sFILE *)a3 withSampleStore:(id)a4
{
  ...
  if (self->_includeTextualFormatInReport) {
    [self _samplePrinterForSampleStore:a4] printToStream:a3;
  }
  if (self->_includeBinaryFormatInReport)
  {
    if (self->_includeTextualFormatInReport)
...
LABEL_38:
          if (qword_1000EFD40) {
            CFStringRef v31 = (FILE *)qword_1000EFD40;
          }
          else {
      ...
      else
      {
        ...
        if (byte_1000EFD39 && dword_1000EF4E8 <= 3)
        {
          ...
          if (v15)
          {
            ...
            if (qword_1000EFD40) {
              uint64_t v28 = (FILE *)qword_1000EFD40;
            }
            else {
...
- (BOOL)targetProcessIsThirdParty
{
  ...
  do
  {
    unsigned __int8 v6 = [(NSString *)self->_targetProcessAbsolutePath hasPrefix:*(__CFString **)((char *)&off_1000E18D0 + v5)];
    if (v6) {
      break;
    }
    BOOL v7 = v5 == 40;
