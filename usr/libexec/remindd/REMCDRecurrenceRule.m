...
{
  id v4 = a3;
  v5 = [(REMCDRecurrenceRule *)self reminder];
...
- (int64_t)parentEffectiveMinimumSupportedVersion
{
  v3 = [(REMCDRecurrenceRule *)self reminder];
  if (v3)
  {
    id v4 = [(REMCDRecurrenceRule *)self reminder];
...
+ (id)fetchRequest
{
  return +[NSFetchRequest fetchRequestWithEntityName:@"REMCDRecurrenceRule"];
}
...
+ (id)cdEntityName
{
  return +[REMRecurrenceRule cdEntityName];
}
...
+ (id)existingCloudObjectForRecordID:(id)a3 accountID:(id)a4 context:(id)a5
{
  ...
  id v10 = a3;
  id v11 = a5;
  v12 = (void *)static REMCDRecurrenceRule.existingCloudObject(for:accountID:managedObjectContext:)(v10, v7, v9, v11);
...
+ (id)newCloudObjectForRecord:(id)a3 account:(id)a4 context:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  id v11 = static REMCDRecurrenceRule.newCloudObject(for:account:managedObjectContext:)(v8, v9, (uint64_t)v10);
...
{
  NSString v2 = self;
  id v3 = [(REMCDRecurrenceRule *)v2 reminder];
...
- (id)existingLocalObjectToMergeWithPredicate:(id)a3
{
  id v4 = a3;
  id v5 = self;
  uint64_t v6 = (void *)_sSo19REMCDRecurrenceRuleC7reminddE26existingLocalObjectToMerge4withSo11REMCDObjectCSgSo11NSPredicateCSg_tF_0();
