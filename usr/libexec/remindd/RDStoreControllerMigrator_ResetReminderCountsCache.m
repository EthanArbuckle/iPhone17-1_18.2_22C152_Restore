...
- (void)migrateStoreIfNeeded:(id)a3 metadata:(id)a4
{
  ...
  id v7 = a4;
  v8 = self;
  RDStoreControllerMigrator_ResetReminderCountsCache.migrateStoreIfNeeded(_:metadata:)((NSPersistentStore)v6, (NSMutableDictionary)v7);
}

- (_TtC7remindd50RDStoreControllerMigrator_ResetReminderCountsCache)init
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for RDStoreControllerMigrator_ResetReminderCountsCache();
