...
{
  v2 = self;
  id v3 = [(REMCDSmartListSection *)v2 smartList];
...
{
  id v2 = self;
  NSString v3 = (REMCDSmartListSection *)[(REMCDSmartListSection *)v2 smartList];
  if (v3)
  {
    v4 = v3;
...
+ (id)keyPathsForValuesAffectingEffectiveMinimumSupportedVersion
{
  sub_10012674C((uint64_t)&off_1008B5E90);
  swift_arrayDestroy();
...
+ (id)existingCloudObjectForRecordID:(id)a3 accountID:(id)a4 context:(id)a5
{
  ...
  id v10 = a3;
  id v11 = a5;
  v12 = (void *)static REMCDSmartListSection.existingCloudObject(for:accountID:managedObjectContext:)(v10, v7, v9, v11);
...
+ (id)newCloudObjectForRecord:(id)a3 account:(id)a4 context:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  id v11 = static REMCDSmartListSection.newCloudObject(for:account:managedObjectContext:)(v8, v9, (uint64_t)v10);
...
{
  NSString v2 = self;
  NSString v3 = (void *)REMCDSmartListSection.newlyCreatedRecord()();
...
- (id)existingLocalObjectToMergeWithPredicate:(id)a3
{
  id v4 = a3;
  int64_t v5 = self;
  uint64_t v6 = (void *)_s7remindd21REMCDSmartListSectionC26existingLocalObjectToMerge4withSo11REMCDObjectCSgSo11NSPredicateCSg_tF_0();
