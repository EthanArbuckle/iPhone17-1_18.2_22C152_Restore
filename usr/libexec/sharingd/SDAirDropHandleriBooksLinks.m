...
{
  v4.receiver = self;
  v4.super_class = (Class)SDAirDropHandleriBooksLinks;
...
{
  v3.receiver = self;
  v3.super_class = (Class)SDAirDropHandleriBooksLinks;
...
- (id)suitableContentsDescription
{
  ...
  objc_super v4 = [(SDAirDropHandler *)self alertMessageLocalizedKeyForTypeDicts:&off_100907358];
