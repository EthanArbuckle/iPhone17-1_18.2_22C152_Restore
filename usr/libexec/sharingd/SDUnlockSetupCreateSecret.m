@interface SDUnlockSetupCreateSecret
- (BOOL)hasSessionID;
- (BOOL)hasToken;
- (BOOL)hasVersion;
- (BOOL)isEqual:(id)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)SDUnlockSetupCreateSecret;
  char v3 = [(SDUnlockSetupCreateSecret *)&v7 description];
  v4 = [(SDUnlockSetupCreateSecret *)self dictionaryRepresentation];
...
LABEL_14:
  ...
  if ((unint64_t)token | *((void *)v4 + 2)) {
    unsigned __int8 v6 = -[NSData isEqual:](token, "isEqual:");
  }
  else {
...
LABEL_5:
    uint64_t v3 = 0;
    return v3 ^ v2 ^ (unint64_t)[(NSData *)self->_token hash];
  }
  uint64_t v2 = 0;
