...
{
  v7.receiver = self;
  v7.super_class = (Class)SDAuthenticationConfirmation;
  char v3 = [(SDAuthenticationConfirmation *)&v7 description];
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((unsigned char *)v4 + 28) = self->_success;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((unsigned char *)v6 + 28) = self->_success;
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 4) != 0)
  {
    self->_success = *((unsigned char *)v4 + 28);
    *(unsigned char *)&self->_has |= 4u;
    char v5 = *((unsigned char *)v4 + 32);
  }
  if (v5)
