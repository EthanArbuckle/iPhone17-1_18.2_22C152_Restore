...
{
  v7.receiver = self;
  v7.super_class = (Class)SDUnlockClassALongTermKeyResponse;
  char v3 = [(SDUnlockClassALongTermKeyResponse *)&v7 description];
  v4 = [(SDUnlockClassALongTermKeyResponse *)self dictionaryRepresentation];
