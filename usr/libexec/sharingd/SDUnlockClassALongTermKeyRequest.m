...
{
  v7.receiver = self;
  v7.super_class = (Class)SDUnlockClassALongTermKeyRequest;
  char v3 = [(SDUnlockClassALongTermKeyRequest *)&v7 description];
...
LABEL_14:
  ...
  if ((unint64_t)longTermKey | *((void *)v4 + 1)) {
    unsigned __int8 v6 = -[NSData isEqual:](longTermKey, "isEqual:");
  }
  else {
...
LABEL_5:
    uint64_t v3 = 0;
    return v3 ^ v2 ^ (unint64_t)[(NSData *)self->_longTermKey hash];
  }
  uint64_t v2 = 0;
