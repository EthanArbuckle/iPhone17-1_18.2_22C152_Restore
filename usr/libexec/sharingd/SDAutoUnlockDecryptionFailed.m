...
{
  v7.receiver = self;
  v7.super_class = (Class)SDAutoUnlockDecryptionFailed;
  char v3 = [(SDAutoUnlockDecryptionFailed *)&v7 description];
  v4 = [(SDAutoUnlockDecryptionFailed *)self dictionaryRepresentation];
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 16) & 1) == 0 || self->_errorCode != *((_DWORD *)v4 + 2)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
