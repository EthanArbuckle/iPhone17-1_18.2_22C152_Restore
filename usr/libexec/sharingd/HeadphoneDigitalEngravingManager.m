...
- (id)fetchEngravingDataHandler
{
  ...
  {
    uint64_t v2 = *(void *)&self->localStorage[OBJC_IVAR____TtC16DaemoniOSLibrary32HeadphoneDigitalEngravingManager_fetchEngravingDataHandler];
...
- (_TtC16DaemoniOSLibrary32HeadphoneDigitalEngravingManager)init
{
  return (_TtC16DaemoniOSLibrary32HeadphoneDigitalEngravingManager *)sub_1004196E8();
}
