@interface SDAutoUnlockDeviceRegistrationRequest
- (BOOL)hasVersion;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)SDAutoUnlockDeviceRegistrationRequest;
  v3 = [(SDAutoUnlockDeviceRegistrationRequest *)&v7 description];
  v4 = [(SDAutoUnlockDeviceRegistrationRequest *)self dictionaryRepresentation];
