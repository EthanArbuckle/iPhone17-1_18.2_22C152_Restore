...
- (SDAirDropHandlerPodcastsLinks)initWithTransfer:(id)a3
{
  ...
  return [(SDAirDropHandler *)&v4 initWithTransfer:a3 bundleIdentifier:@"com.apple.podcasts"];
}
...
- (BOOL)canHandleTransfer
{
  ...
  v3 = [(SDAirDropHandlerPodcastsLinks *)self candidateIdentifiers];
  long long v13 = 0u;
  long long v14 = 0u;
  long long v15 = 0u;
  long long v16 = 0u;
...
- (int64_t)transferTypes
{
  ...
  return [(SDAirDropHandlerGenericLinks *)&v3 transferTypes] | 0x4000000000;
}

- (id)suitableContentsDescription
{
  objc_super v3 = [(SDAirDropHandler *)self senderName];
  objc_super v4 = [(SDAirDropHandler *)self alertMessageLocalizedKeyForTypeDicts:&off_100906DE8];
