...
{
  v7.receiver = self;
  v7.super_class = (Class)SDAuthenticationPrePairingRequest;
  char v3 = [(SDAuthenticationPrePairingRequest *)&v7 description];
  v4 = [(SDAuthenticationPrePairingRequest *)self dictionaryRepresentation];
