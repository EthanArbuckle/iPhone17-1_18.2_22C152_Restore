@interface SDUnlockStartLTKTransfer
- (BOOL)hasVersion;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)SDUnlockStartLTKTransfer;
  v3 = [(SDUnlockStartLTKTransfer *)&v7 description];
  v4 = [(SDUnlockStartLTKTransfer *)self dictionaryRepresentation];
