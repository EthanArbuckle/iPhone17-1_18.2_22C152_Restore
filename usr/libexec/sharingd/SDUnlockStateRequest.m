...
{
  v7.receiver = self;
  v7.super_class = (Class)SDUnlockStateRequest;
  v3 = [(SDUnlockStateRequest *)&v7 description];
  v4 = [(SDUnlockStateRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return SDUnlockStateRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
