...
- (BOOL)hasStashToken
{
  return self->_stashToken != 0;
}

- (id)description
{
  v7.receiver = self;
  v7.super_class = (Class)SDUnlockStashToken;
  char v3 = [(SDUnlockStashToken *)&v7 description];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v8 = [(NSData *)self->_stashToken copyWithZone:a3];
  v9 = (void *)v6[2];
  v6[2] = v8;
...
LABEL_14:
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_sessionID != *((_DWORD *)v4 + 2)) {
      goto LABEL_14;
    }
  }
  ...
  stashToken = self->_stashToken;
  if ((unint64_t)stashToken | *((void *)v4 + 2)) {
    unsigned __int8 v6 = -[NSData isEqual:](stashToken, "isEqual:");
  }
  else {
...
LABEL_5:
    uint64_t v3 = 0;
    return v3 ^ v2 ^ (unint64_t)[(NSData *)self->_stashToken hash];
  }
  uint64_t v2 = 0;
