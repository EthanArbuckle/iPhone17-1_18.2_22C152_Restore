...
+ (id)newWithActivityConfiguration:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v8 = [v7 activityCategory];
  }
  else
  {
    id v8 = [v4 activityCategory];
  }
  id v9 = [objc_alloc((Class)objc_msgSend(a1, "activityProxyClassForActivityCategory:", v8)) initWithAttributesFromActivityConfiguration:v4];
...
- (SUIHostActivityProxy)initWithAttributesFromActivityConfiguration:(id)a3
{
  ...
  id v6 = [(SUIHostActivityProxy *)&v47 init];
  id v7 = v6;
  if (v6)
  {
    ...
    if (v15) {
      id v16 = [(UIActivity *)v15 _defaultSortGroup];
    }
    else {
      id v16 = [(UIActivity *)v5 defaultSortGroup];
    }
    v7->_defaultSortGroup = (int64_t)v16;
    v17 = v7->_activity;
    if (v17) {
    ...
    v22 = v7->_activity;
    if (v22) {
      unsigned __int8 v23 = [(UIActivity *)v22 _activitySupportsPromiseURLs];
    }
    else {
      unsigned __int8 v23 = [(UIActivity *)v5 activitySupportsPromiseURLs];
    }
...
- (id)_activityFooterText
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      id v6 = self->_activityFooterText;
    }
    else
    {
      id v7 = [(SUIHostActivityProxy *)self activity];
      id v6 = [v7 _activityFooterText];
    }
  }
  else
  {
...
- (BOOL)_wantsOriginalImageColor
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      unsigned int wantsOriginalImageColor = self->_wantsOriginalImageColor;
    }
    else
    {
      id v7 = [(SUIHostActivityProxy *)self activity];
      unsigned int wantsOriginalImageColor = [v7 _wantsOriginalImageColor];
    }
  }
  else
  {
...
- (BOOL)_isBuiltinDerived
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      unsigned int isBuiltinDerived = self->_isBuiltinDerived;
    }
    else
    {
      id v7 = [(SUIHostActivityProxy *)self activity];
      unsigned int isBuiltinDerived = [v7 _isBuiltinDerived];
    }
  }
  else
  {
...
- (BOOL)_showsInSystemActionGroup
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      unsigned int showsInSystemActionGroup = self->_showsInSystemActionGroup;
    }
    else
    {
      id v7 = [(SUIHostActivityProxy *)self activity];
      unsigned int showsInSystemActionGroup = [v7 _showsInSystemActionGroup];
    }
  }
  else
  {
...
- (id)_activityStatusTintColor
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      id v6 = self->_activityStatusTintColor;
    }
    else
    {
      id v7 = [(SUIHostActivityProxy *)self activity];
      id v6 = [v7 _activityStatusTintColor];
    }
  }
  else
  {
...
{
  v8.receiver = self;
  v8.super_class = (Class)SUIHostActivityProxy;
  id v3 = [(SUIHostActivityProxy *)&v8 description];
  id v4 = [(SUIHostActivityProxy *)self _activityTypeUsingFallbackActivityTypeIfNecessary];
  id v5 = [(SUIHostActivityProxy *)self activityTitle];
  id v6 = +[NSString stringWithFormat:@"%@ {type = %@, title = %@}", v3, v4, v5];
...
- (void)setWantsOriginalImageColor:(BOOL)a3
{
  self->_unsigned int wantsOriginalImageColor = a3;
}
...
- (void)setIsBuiltinDerived:(BOOL)a3
{
  self->_unsigned int isBuiltinDerived = a3;
}
...
- (void)setShowsInSystemActionGroup:(BOOL)a3
{
  self->_unsigned int showsInSystemActionGroup = a3;
}
