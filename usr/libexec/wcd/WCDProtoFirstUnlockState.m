...
- (void)setFirstUnlocked:(BOOL)a3;
- (void)setHasFirstUnlocked:(BOOL)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)WCDProtoFirstUnlockState;
  char v3 = [(WCDProtoFirstUnlockState *)&v7 description];
  v4 = [(WCDProtoFirstUnlockState *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return WCDProtoFirstUnlockStateReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((unsigned char *)v4 + 12) = self->_firstUnlocked;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((unsigned char *)result + 12) = self->_firstUnlocked;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_firstUnlocked;
  return v3 ^ v2;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_firstUnlocked = *((unsigned char *)v4 + 12);
    *(unsigned char *)&self->_has |= 2u;
  }
}
