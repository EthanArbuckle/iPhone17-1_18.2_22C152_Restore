@interface WCDProtoPairedSyncComplicationsStartedAck
- (BOOL)hasSuccess;
- (BOOL)hasVersion;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation WCDProtoPairedSyncComplicationsStartedAck
...
{
  v7.receiver = self;
  v7.super_class = (Class)WCDProtoPairedSyncComplicationsStartedAck;
  char v3 = [(WCDProtoPairedSyncComplicationsStartedAck *)&v7 description];
  v4 = [(WCDProtoPairedSyncComplicationsStartedAck *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return WCDProtoPairedSyncComplicationsStartedAckReadFrom((uint64_t)self, (uint64_t)a3);
}
