...
- (id)_deviceDetails
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v13 = 0;
      _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_ERROR, "Unknown device type. Using actual model number, which is unlikely to work once the request is approved", v13, 2u);
    }
