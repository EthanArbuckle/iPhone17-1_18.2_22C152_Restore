...
- (NSXPCInterface)driverInterface
{
  if (qword_1000D7BE0 != -1) {
    dispatch_once(&qword_1000D7BE0, &stru_1000C5458);
  }
  id v2 = (void *)qword_1000D7BD8;
...
- (NSXPCInterface)managerInterface
{
  if (qword_1000D7BD0 != -1) {
    dispatch_once(&qword_1000D7BD0, &stru_1000C5438);
  }
  id v2 = (void *)qword_1000D7BC8;
