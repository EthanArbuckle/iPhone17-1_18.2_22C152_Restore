...
- (GTCaptureDescriptor)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v5->_sessionID = (unint64_t)[v4 decodeInt64ForKey:@"sessionID"];
    v5->_triggerHitsToStart = (unint64_t)[v4 decodeInt64ForKey:@"triggerHitsToStart"];
    v5->_triggerHitsToEnd = (unint64_t)[v4 decodeInt64ForKey:@"triggerHitsToEnd"];
