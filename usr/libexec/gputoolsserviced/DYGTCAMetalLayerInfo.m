...
- (DYGTCAMetalLayerInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_layerAddress = (unint64_t)[v4 decodeInt64ForKey:@"layerAddress"];
    v5->_layerStreamRef = (unint64_t)[v4 decodeInt64ForKey:@"layerStreamRef"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v5 encodeRect:self->_frame.origin.x, self->_frame.origin.y, self->_frame.size.width, self->_frame.size.height forKey:@"frame"];
