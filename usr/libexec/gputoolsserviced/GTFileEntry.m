...
- (id)description
{
  ...
  id v5 = [(GTFileEntry *)self path];
  uint64_t v6 = [(GTFileEntry *)self destination];
  id v7 = +[NSString stringWithFormat:@"<%@: %p, Path: %@, Destination: %@, Size: %lu>", v4, self, v5, v6, [(GTFileEntry *)self fileSize]];
