...
- (id)deviceProperties:(id)a3 error:(id *)a4
{
  ...
  v12 = [(GTServiceConnection *)self->_connection sendMessageWithReplySync:empty error:a4];
  if (v12)
  {
...
- (BOOL)isSimulatorDevice:(id)a3
{
  ...
  id v10 = [(GTServiceConnection *)self->_connection sendMessageWithReplySync:empty error:0];
  v11 = v10;
  if (v10) {
...
- (GTSimulatorDeviceBrowserXPCProxy)initWithConnection:(id)a3 remoteProperties:(id)a4
{
  ...
  id v8 = [(GTSimulatorDeviceBrowserXPCProxy *)&v23 init];
  if (v8)
  {
    objc_super v9 = &OBJC_PROTOCOL___GTSimulatorDeviceBrowser;
    id v10 = [v7 protocolName];
    ...
    uint64_t v13 = [GTServiceConnection alloc];
    v14 = [v7 deviceUDID];
