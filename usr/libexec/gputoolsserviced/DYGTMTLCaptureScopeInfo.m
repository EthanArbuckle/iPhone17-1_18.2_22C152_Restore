...
- (DYGTMTLCaptureScopeInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_commandQueueStreamRef = (unint64_t)[v4 decodeInt64ForKey:@"commandQueueStreamRef"];
    v5->_scopeAddress = (unint64_t)[v4 decodeInt64ForKey:@"scopeAddress"];
    v5->_scopeStreamRef = (unint64_t)[v4 decodeInt64ForKey:@"scopeStreamRef"];
