  ...
  if (v5)
  {
    ...
    if (v22)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        uint64_t v23 = +[NSNumber numberWithBool:[(NSError *)v5->_error code] == 0];
        didSucceed = v5->_didSucceed;
        v5->_didSucceed = (NSNumber *)v23;
      }
    }
...
- (id)description
{
  ...
  if (v3 > 7) {
    ...
    CFStringRef v4 = off_100304128[v3];
  }
  CFStringRef v12 = v4;
  uint64_t v5 = (int)self->_result;
  if (v5 > 4) {
    CFStringRef v6 = @"Unknown Error";
  }
  else {
    CFStringRef v6 = off_100304168[v5];
  }
  CFStringRef v11 = v6;
  ...
  id v9 = [v7 initWithFormat:@"%@ { merchantID=\"%@\" signupURL=%@ terminalAppVersion=%@ terminalModeDescription=%@ terminalMode=%@ filter=%@ filterType=%@ didSucceed=%@ passData=%@ token=%@ errorCode=0x%04x error=%@ result=0x%04x resultDescription=%@ }", v8, self->_merchantId, self->_signupUrl, self->_terminalAppVersion, v12, self->_terminalMode, self->_filter, self->_filterType, self->_didSucceed, self->_passData, self->_token, -[NSError code](self->_error, "code"), self->_error, self->_result, v11];
...
- (id)asDictionary
{
  ...
  if (self->_error)
  {
    id v18 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", -[NSError code](self->_error, "code")];
