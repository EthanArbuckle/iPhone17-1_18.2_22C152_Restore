...
+ (id)infoWithDictionary:(id)a3 applet:(id)a4
{
  ...
  else
  {
    ...
    if (Logger)
    {
      ...
      v19(3, "%c[%{public}s %{public}s]:%i AID does not match", v23, ClassName, Name, 668);
    }
    dispatch_get_specific(kNFLOG_DISPATCH_SPECIFIC_KEY);
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 67109890;
      ...
      __int16 v35 = 1024;
      int v36 = 668;
      _os_log_impl((void *)&_mh_execute_header, v24, OS_LOG_TYPE_ERROR, "%c[%{public}s %{public}s]:%i AID does not match", buf, 0x22u);
    }
