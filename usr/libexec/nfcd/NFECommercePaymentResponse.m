...
- (NFECommercePaymentResponse)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_confirmationBlobVersion = (int64_t)[v14 integerValue];
  }
  return v5;
}
...
- (NFECommercePaymentResponse)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v10 = +[NFNSCheckedDecoder coder:v4 decodeDictOfClass:objc_opt_class() forKey:@"certs"];
    certs = v5->_certs;
    ...
    v5->_confirmationBlobVersion = (int64_t)[v16 integerValue];

    uint64_t v17 = +[NFNSCheckedDecoder coder:v4 decodeArrayOfClass:objc_opt_class() forKey:@"sepCerts"];
