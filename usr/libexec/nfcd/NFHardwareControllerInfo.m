...
- (void)encodeWithCoder:(id)a3
{
  unint64_t siliconVersion = self->_siliconVersion;
  id v5 = a3;
...
- (NFHardwareControllerInfo)initWithDictionary:(id)a3
{
  ...
  id v5 = [(NFHardwareControllerInfo *)&v20 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"siliconVersion"];
    v5->_unint64_t siliconVersion = (unint64_t)[v6 unsignedIntegerValue];

    v7 = [v4 objectForKeyedSubscript:@"siliconName"];
    v5->_siliconName = (unint64_t)[v7 unsignedIntegerValue];

    v8 = [v4 objectForKeyedSubscript:@"ROMVersion"];
    v5->_ROMVersion = (unint64_t)[v8 unsignedIntegerValue];

    v9 = [v4 objectForKeyedSubscript:@"firmwareVersion"];
    v5->_firmwareVersion = (unint64_t)[v9 unsignedIntegerValue];

    v10 = [v4 objectForKeyedSubscript:@"firmwareRevision"];
    v5->_firmwareRevision = (unint64_t)[v10 unsignedIntegerValue];

    v11 = [v4 objectForKeyedSubscript:@"middlewareVersion"];
    v5->_middlewareVersion = (unint64_t)[v11 unsignedIntegerValue];
...
- (NFHardwareControllerInfo)initWithCoder:(id)a3
{
  ...
  id v5 = [(NFHardwareControllerInfo *)&v7 init];
  if (v5)
  {
    v5->_unint64_t siliconVersion = (unint64_t)[v4 decodeIntegerForKey:@"siliconVersion"];
    v5->_siliconName = (unint64_t)[v4 decodeIntegerForKey:@"siliconName"];
    v5->_ROMVersion = (unint64_t)[v4 decodeIntegerForKey:@"ROMVersion"];
    v5->_firmwareVersion = (unint64_t)[v4 decodeIntegerForKey:@"firmwareVersion"];
    v5->_firmwareRevision = (unint64_t)[v4 decodeIntegerForKey:@"firmwareRevision"];
    v5->_middlewareVersion = (unint64_t)[v4 decodeIntegerForKey:@"middlewareVersion"];
...
{
  v3 = objc_opt_new();
  id v4 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", self->_siliconVersion];
  [v3 setObject:v4 forKeyedSubscript:@"siliconVersion"];

  id v5 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", self->_siliconName];
  [v3 setObject:v5 forKeyedSubscript:@"siliconName"];

  id v6 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", self->_ROMVersion];
  [v3 setObject:v6 forKeyedSubscript:@"ROMVersion"];

  id v7 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", self->_firmwareVersion];
  [v3 setObject:v7 forKeyedSubscript:@"firmwareVersion"];

  id v8 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", self->_firmwareRevision];
  [v3 setObject:v8 forKeyedSubscript:@"firmwareRevision"];

  id v9 = [objc_alloc((Class)NSString) initWithFormat:@"0x%04x", self->_middlewareVersion];
