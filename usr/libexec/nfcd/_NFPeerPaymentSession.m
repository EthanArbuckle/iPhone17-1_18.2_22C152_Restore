  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 67109890;
      ...
      __int16 v31 = 1024;
      int v32 = 24;
      _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_ERROR, "%c[%{public}s %{public}s]:%i Invalid entitlements, requiring surf access", buf, 0x22u);
    }
    ...
    id v19 = [objc_alloc((Class)NSString) initWithFormat:@"%s:%d", sel_getName(a2), 25];
    v24[3] = v19;
...
- (BOOL)willStartSession
{
  sub_1002535C4();
  v4.receiver = self;
  v4.super_class = (Class)_NFPeerPaymentSession;
...
{
  v9.receiver = self;
  v9.super_class = (Class)_NFPeerPaymentSession;
  id v4 = a3;
...
- (void)deleteKeyWithCompletion:(id)a3
{
  id v5 = a3;
  v11.receiver = self;
  v11.super_class = (Class)_NFPeerPaymentSession;
  v6 = [(_NFSession *)&v11 workQueue];
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1001A9654;
...
- (void)performPeerPayment:(id)a3 request:(id)a4 completion:(id)a5
{
  ...
  id v11 = a5;
  v21.receiver = self;
  v21.super_class = (Class)_NFPeerPaymentSession;
  v12 = [(_NFSession *)&v21 workQueue];
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1001A9A8C;
