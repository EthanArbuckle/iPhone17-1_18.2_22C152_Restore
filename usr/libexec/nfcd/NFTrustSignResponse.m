...
+ (id)signResponseWithRawData:(id)a3 counterValueData:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (v9)
    {
      ...
      if (v8)
      {
        v11 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", bswap32(*(_DWORD *)[v8 bytes]));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 67109890;
      ...
      __int16 v29 = 1024;
      int v30 = 407;
      _os_log_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_ERROR, "%c[%{public}s %{public}s]:%i Could not create SignResponse with nil data", buf, 0x22u);
    }
