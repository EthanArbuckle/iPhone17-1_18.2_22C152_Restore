...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_100080198 != -1) {
    dispatch_once(&qword_100080198, &stru_100075B80);
  }
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = [(__CFString *)v14 isEqualToString:&stru_100075D68];
        if (v15)
        {
          v16 = v26;
        }
  ...
  if (os_log_type_enabled(obj, OS_LOG_TYPE_DEBUG)) {
    sub_10003938C((uint64_t)v26, (uint64_t)a4, obj);
  }
  v19 = 0;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (![(NSString *)v9 isEqualToString:v8])
  {
    ...
    int v10 = sub_10001B6E0();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
      sub_100039414((uint64_t)v9, &self->_enablementPrefix, v10);
    }
  }
  if (hangtracerDaemonEnabled != v6)
  {
    self->_int hangtracerDaemonEnabled = v6;
    id v11 = sub_10001B6E0();
...
- (void)initPropertyReportPeriod:(HTPrefInit *)a3
{
  ...
  double v7 = v6 * 1000.0 / sub_100003B48();
...
+ (id)sharedPrefs
{
  if (qword_1000801B0 != -1) {
    dispatch_once(&qword_1000801B0, &stru_100075BA0);
  }
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *(_OWORD *)&result[13].var2.var0 = xmmword_10003DF40;
...
- (void)refreshHTPrefs
{
  ...
  if ([(HTPrefs *)self shouldPostHTPrefsChangedNotification])
  {
    ...
    HTPrefDefaultVal v8 = sub_10001B6E0();
...
- (void)__createInternalSettings
{
  ...
  {
    HTPrefDefaultVal v5 = sub_10001B6E0();
  ...
  CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_10007A6A0, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0;
  ...
  notify_register_dispatch(off_10007FB10[0], v30 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10007FAF8[0], (int *)v42 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10007FB00[0], v38 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10007FB08[0], v34 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10007FB18, v24 + 6, (dispatch_queue_t)self->__prefsQueue, v19);
  [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
