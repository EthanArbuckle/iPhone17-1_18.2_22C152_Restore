@interface PDURLSessionProxyAuthChallenge
- (BOOL)hasArchiveList;
- (BOOL)hasVersion;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSData)archiveList;
- (id)_actualAuthChallenge;
- (id)_initWithActualAuthChallenge:(id)a3;
...
@implementation PDURLSessionProxyAuthChallenge

- (id)_actualAuthChallenge
{
  uint64_t v3 = objc_opt_class();
  v4 = [(PDURLSessionProxyAuthChallenge *)self archiveList];
...
{
  id v4 = a3;
  v5 = [(PDURLSessionProxyAuthChallenge *)self init];
  if (v5)
  {
    v6 = +[NSKeyedArchiver _nsurlsessionproxy_secureArchivedDataWithRootObject:v4];
    [(PDURLSessionProxyAuthChallenge *)v5 setArchiveList:v6];
  }
  return v5;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v5 = v4;
    -[PDURLSessionProxyAuthChallenge setArchiveList:](self, "setArchiveList:");
    id v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_100066158((uint64_t)self, (uint64_t)a3);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyAuthChallenge;
  uint64_t v3 = [(PDURLSessionProxyAuthChallenge *)&v7 description];
  id v4 = [(PDURLSessionProxyAuthChallenge *)self dictionaryRepresentation];
