@interface PDURLSessionProxyCancelTask
- (BOOL)hasTask;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyCancelTask;
  v3 = [(PDURLSessionProxyCancelTask *)&v7 description];
  v4 = [(PDURLSessionProxyCancelTask *)self dictionaryRepresentation];
