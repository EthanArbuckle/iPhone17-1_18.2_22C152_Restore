@interface PDURLSessionProxySocketDisconnected
- (BOOL)hasSocketUUID;
- (BOOL)hasTask;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation PDURLSessionProxySocketDisconnected
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[PDURLSessionProxySocketDisconnected setTask:](self, "setTask:");
  }
  v4 = v7;
LABEL_7:
  if (v4[1])
  {
    -[PDURLSessionProxySocketDisconnected setSocketUUID:](self, "setSocketUUID:");
    v4 = v7;
  }
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxySocketDisconnected;
  unint64_t v3 = [(PDURLSessionProxySocketDisconnected *)&v7 description];
  id v4 = [(PDURLSessionProxySocketDisconnected *)self dictionaryRepresentation];
