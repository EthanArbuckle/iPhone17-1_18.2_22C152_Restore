...
- (unint64_t)hash
{
  ...
  return (unint64_t)[(NSData *)self->_taskInfo hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[PDURLSessionProxyTaskMessage isEqual:](task, "isEqual:")))
  {
    ...
    if ((unint64_t)taskInfo | v4[2]) {
      unsigned __int8 v7 = -[NSData isEqual:](taskInfo, "isEqual:");
    }
    else {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v8 = [(NSData *)self->_taskInfo copyWithZone:a3];
  v9 = (void *)v5[2];
  v5[2] = v8;
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyDataTaskWithRequestReply;
  unint64_t v3 = [(PDURLSessionProxyDataTaskWithRequestReply *)&v7 description];
  id v4 = [(PDURLSessionProxyDataTaskWithRequestReply *)self dictionaryRepresentation];
...
- (__NSCFURLSessionTaskInfo)_actualTaskInfo
{
  ...
  id v4 = [(PDURLSessionProxyDataTaskWithRequestReply *)self taskInfo];
