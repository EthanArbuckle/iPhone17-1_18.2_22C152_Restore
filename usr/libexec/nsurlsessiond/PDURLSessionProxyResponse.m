...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v5 = v4;
    -[PDURLSessionProxyResponse setArchiveList:](self, "setArchiveList:");
    id v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_100046710((uint64_t)self, (uint64_t)a3);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyResponse;
  uint64_t v3 = [(PDURLSessionProxyResponse *)&v7 description];
  id v4 = [(PDURLSessionProxyResponse *)self dictionaryRepresentation];
