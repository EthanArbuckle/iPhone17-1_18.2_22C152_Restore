...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[PDURLSessionProxyDidReceiveResponse setTask:](self, "setTask:");
  }
  v4 = v9;
LABEL_7:
  ...
  else
  {
    ...
    -[PDURLSessionProxyDidReceiveResponse setResponse:](self, "setResponse:");
  }
  v4 = v9;
LABEL_13:
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyDidReceiveResponse;
  unint64_t v3 = [(PDURLSessionProxyDidReceiveResponse *)&v7 description];
  id v4 = [(PDURLSessionProxyDidReceiveResponse *)self dictionaryRepresentation];
