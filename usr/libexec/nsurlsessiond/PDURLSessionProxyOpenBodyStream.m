@interface PDURLSessionProxyOpenBodyStream
- (BOOL)hasTask;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation PDURLSessionProxyOpenBodyStream
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    v7 = v4;
    -[PDURLSessionProxyOpenBodyStream setTask:](self, "setTask:");
  }
  v4 = v7;
LABEL_7:
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyOpenBodyStream;
  v3 = [(PDURLSessionProxyOpenBodyStream *)&v7 description];
  v4 = [(PDURLSessionProxyOpenBodyStream *)self dictionaryRepresentation];
