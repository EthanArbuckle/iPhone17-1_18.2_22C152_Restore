@interface PDURLSessionProxyRequest
- (BOOL)hasArchiveList;
- (BOOL)hasVersion;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (id)_actualRequest
{
  ...
  v4 = [(PDURLSessionProxyRequest *)self archiveList];
...
{
  id v4 = a3;
  v5 = [(PDURLSessionProxyRequest *)self init];
  if (v5)
  {
    v6 = +[NSKeyedArchiver _nsurlsessionproxy_secureArchivedDataWithRootObject:v4];
    [(PDURLSessionProxyRequest *)v5 setArchiveList:v6];
  }
  return v5;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_10004C0E4((uint64_t)self, (uint64_t)a3);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyRequest;
  uint64_t v3 = [(PDURLSessionProxyRequest *)&v7 description];
  id v4 = [(PDURLSessionProxyRequest *)self dictionaryRepresentation];
