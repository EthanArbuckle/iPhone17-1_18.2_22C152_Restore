...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[PDURLSessionProxyDidReceiveData setTask:](self, "setTask:");
  }
  v4 = v7;
LABEL_7:
  if (v4[1])
  {
    -[PDURLSessionProxyDidReceiveData setReceivedData:](self, "setReceivedData:");
    v4 = v7;
  }
}
...
- (unint64_t)hash
{
  ...
  return (unint64_t)[(NSData *)self->_receivedData hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[PDURLSessionProxyTaskMessage isEqual:](task, "isEqual:")))
  {
    ...
    if ((unint64_t)receivedData | v4[1]) {
      unsigned __int8 v7 = -[NSData isEqual:](receivedData, "isEqual:");
    }
    else {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v8 = [(NSData *)self->_receivedData copyWithZone:a3];
  v9 = (void *)v5[1];
  v5[1] = v8;
...
LABEL_13:
      ...
      if ((v7 >> 3) == 1)
      {
        ...
        objc_storeStrong((id *)&self->_task, receivedData);
        if (!PBReaderPlaceMark() || (sub_10005AB80((uint64_t)receivedData, (uint64_t)a3) & 1) == 0)
        {
...
LABEL_25:
    ...
    receivedData = (PDURLSessionProxyTaskMessage *)self->_receivedData;
    self->_receivedData = v14;
LABEL_23:
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyDidReceiveData;
  unint64_t v3 = [(PDURLSessionProxyDidReceiveData *)&v7 description];
  id v4 = [(PDURLSessionProxyDidReceiveData *)self dictionaryRepresentation];
