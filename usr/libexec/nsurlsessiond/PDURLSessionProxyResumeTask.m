...
- (unint64_t)hash
{
  ...
  return (unint64_t)[(NSData *)self->_additionalProperties hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[PDURLSessionProxyTaskMessage isEqual:](task, "isEqual:")))
  {
    ...
    if ((unint64_t)additionalProperties | v4[1]) {
      unsigned __int8 v7 = -[NSData isEqual:](additionalProperties, "isEqual:");
    }
    else {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v8 = [(NSData *)self->_additionalProperties copyWithZone:a3];
  v9 = (void *)v5[1];
  v5[1] = v8;
...
LABEL_13:
      ...
      if ((v7 >> 3) == 1)
      {
        ...
        if (!PBReaderPlaceMark() || (sub_10005AB80((uint64_t)additionalProperties, (uint64_t)a3) & 1) == 0)
        {
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDURLSessionProxyResumeTask;
  unint64_t v3 = [(PDURLSessionProxyResumeTask *)&v7 description];
  id v4 = [(PDURLSessionProxyResumeTask *)self dictionaryRepresentation];
...
- (NSDictionary)_actualAdditionalProperties
{
  ...
  id v4 = [(PDURLSessionProxyResumeTask *)self additionalProperties];
  char v5 = +[NSKeyedUnarchiver _nsurlsessionproxy_secureUnarchiveObjectOfClass:v3 withData:v4];
