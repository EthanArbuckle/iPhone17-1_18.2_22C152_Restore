...
- (GPBBoolUInt32Dictionary)init
{
  return [(GPBBoolUInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 10093, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolUInt32Dictionary;
  [(GPBBoolUInt32Dictionary *)&v3 dealloc];
}
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v4])
    {
      ...
      uint64_t v13 = sub_1002EBB94(values[v4], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      [a3 writeInt32NoTag:sub_1002EBB94(values[v10], 2, v7) + v16];
      [a3 writeBool:1 value:v15];
      sub_1002EBDA8(a3, values[v10], 2, v7);
    }
    char v13 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
