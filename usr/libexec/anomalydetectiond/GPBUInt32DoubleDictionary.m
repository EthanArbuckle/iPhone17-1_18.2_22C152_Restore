...
- (BOOL)isEqual:(id)a3;
- (GPBUInt32DoubleDictionary)init;
- (GPBUInt32DoubleDictionary)initWithCapacity:(unint64_t)a3;
- (GPBUInt32DoubleDictionary)initWithDictionary:(id)a3;
- (GPBUInt32DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5;
...
- (GPBUInt32DoubleDictionary)init
{
  return [(GPBUInt32DoubleDictionary *)self initWithDoubles:0 forKeys:0 count:0];
}

- (GPBUInt32DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)GPBUInt32DoubleDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 2576, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32DoubleDictionary;
  [(GPBUInt32DoubleDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt32DoubleDictionary allocWithZone:a3];
