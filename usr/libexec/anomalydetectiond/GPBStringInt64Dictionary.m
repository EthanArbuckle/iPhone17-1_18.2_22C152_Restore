...
- (GPBStringInt64Dictionary)init
{
  return [(GPBStringInt64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}
...
- (GPBStringInt64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  ...
  v8 = [(GPBStringInt64Dictionary *)&v14 init];
  if (v8)
  {
...
- (GPBStringInt64Dictionary)initWithDictionary:(id)a3
{
  v4 = [(GPBStringInt64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 9055, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBStringInt64Dictionary;
  [(GPBStringInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBStringInt64Dictionary allocWithZone:a3];

  return [(GPBStringInt64Dictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, v6, [dictionary objectForKeyedSubscript:v6].longLongValue, &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_1002EDB6C((unint64_t)[v13 longLongValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002EDB6C((unint64_t)v15, 2, v7) + v16];
      sub_10030195C(a3, (uint64_t)v13, v8);
      sub_1002EDDB0(a3, (uint64_t)v15, 2, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003BAB10;
  v3[4] = a3;
  [(GPBStringInt64Dictionary *)self enumerateKeysAndInt64sUsingBlock:v3];
}
...
- (void)setInt64:(int64_t)a3 forKey:(id)a4
{
  ...
  [(NSMutableDictionary *)self->_dictionary setObject:+[NSNumber numberWithLongLong:a3] forKey:a4];
  autocreator = self->_autocreator;
  if (autocreator)
  {
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
