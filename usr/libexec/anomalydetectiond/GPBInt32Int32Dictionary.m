...
- (BOOL)isEqual:(id)a3;
- (GPBInt32Int32Dictionary)init;
- (GPBInt32Int32Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBInt32Int32Dictionary)initWithDictionary:(id)a3;
- (GPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5;
...
- (GPBInt32Int32Dictionary)init
{
  return [(GPBInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}

- (GPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBInt32Int32Dictionary;
  v8 = [(GPBInt32Int32Dictionary *)&v14 init];
  if (v8)
  {
...
- (GPBInt32Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = [(GPBInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 3411, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32Int32Dictionary;
  [(GPBInt32Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBInt32Int32Dictionary allocWithZone:a3];

  return [(GPBInt32Int32Dictionary *)v4 initWithDictionary:self];
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v15 = sub_1002EC618([v13 intValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002EC618(v16, 2, v7) + v17];
      sub_1002EC85C(a3, (uint64_t)v15, 1, v8);
      sub_1002EC85C(a3, (uint64_t)v16, 2, v7);
