...
- (BOOL)isEqual:(id)a3;
- (GPBInt64Int64Dictionary)init;
- (GPBInt64Int64Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBInt64Int64Dictionary)initWithDictionary:(id)a3;
- (GPBInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5;
...
- (GPBInt64Int64Dictionary)init
{
  return [(GPBInt64Int64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}

- (GPBInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBInt64Int64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 7277, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt64Int64Dictionary;
  [(GPBInt64Int64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBInt64Int64Dictionary allocWithZone:a3];
