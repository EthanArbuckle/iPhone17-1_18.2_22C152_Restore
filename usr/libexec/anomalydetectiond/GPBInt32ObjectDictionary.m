...
- (BOOL)isEqual:(id)a3;
- (BOOL)isInitialized;
- (GPBInt32ObjectDictionary)init;
- (GPBInt32ObjectDictionary)initWithCapacity:(unint64_t)a3;
- (GPBInt32ObjectDictionary)initWithDictionary:(id)a3;
- (GPBInt32ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int *)a4 count:(unint64_t)a5;
...
- (GPBInt32ObjectDictionary)init
{
  return [(GPBInt32ObjectDictionary *)self initWithObjects:0 forKeys:0 count:0];
}

- (GPBInt32ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v12.receiver = self;
  v12.super_class = (Class)GPBInt32ObjectDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 4765, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32ObjectDictionary;
  [(GPBInt32ObjectDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBInt32ObjectDictionary allocWithZone:a3];
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  uint64_t v5 = objc_alloc_init(GPBInt32ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      id v15 = [v13 intValue];
      int v16 = sub_1002EC618(v15, 1, v8);
