...
- (GPBBoolFloatDictionary)init
{
  return [(GPBBoolFloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 11148, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolFloatDictionary;
  [(GPBBoolFloatDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBBoolFloatDictionary allocWithZone:a3];
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v4])
    {
      ...
      uint64_t v12 = sub_1002EF05C(v7) + v11;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      [a3 writeInt32NoTag:sub_1002EF05C(v7) + v16];
      [a3 writeBool:1 value:v15];
      *(float *)&double v17 = values[v10];
