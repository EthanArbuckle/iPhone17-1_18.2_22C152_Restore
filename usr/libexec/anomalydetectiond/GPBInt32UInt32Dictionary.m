...
- (BOOL)isEqual:(id)a3;
- (GPBInt32UInt32Dictionary)init;
- (GPBInt32UInt32Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBInt32UInt32Dictionary)initWithDictionary:(id)a3;
- (GPBInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5;
...
- (GPBInt32UInt32Dictionary)init
{
  return [(GPBInt32UInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}

- (GPBInt32UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBInt32UInt32Dictionary;
  v8 = [(GPBInt32UInt32Dictionary *)&v14 init];
  if (v8)
  {
...
- (GPBInt32UInt32Dictionary)initWithDictionary:(id)a3
{
  v4 = [(GPBInt32UInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 3228, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32UInt32Dictionary;
  [(GPBInt32UInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBInt32UInt32Dictionary allocWithZone:a3];

  return [(GPBInt32UInt32Dictionary *)v4 initWithDictionary:self];
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v14 = sub_1002EC618([v11 intValue], 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      int v17 = sub_1002EC618(v15, 1, v8);
      [a3 writeInt32NoTag:sub_1002EBB94(v16, 2, v7) + v17];
      sub_1002EC85C(a3, (uint64_t)v15, 1, v8);
...
- (void)setGPBGenericValue:(id *)a3 forGPBGenericValueKey:(id *)a4
{
  ...
  unsigned int v7 = +[NSNumber numberWithInt:a4->var3];
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003BA6D8;
  v3[4] = a3;
  [(GPBInt32UInt32Dictionary *)self enumerateKeysAndUInt32sUsingBlock:v3];
}
...
- (void)setUInt32:(unsigned int)a3 forKey:(int)a4
{
  [(NSMutableDictionary *)self->_dictionary setObject:+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", *(void *)&a3) forKey:+[NSNumber numberWithInt:*(void *)&a4]];
  autocreator = self->_autocreator;
  if (autocreator)
  {
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
