...
- (BOOL)isEqual:(id)a3;
- (GPBUInt64DoubleDictionary)init;
- (GPBUInt64DoubleDictionary)initWithCapacity:(unint64_t)a3;
- (GPBUInt64DoubleDictionary)initWithDictionary:(id)a3;
- (GPBUInt64DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5;
...
- (GPBUInt64DoubleDictionary)init
{
  return [(GPBUInt64DoubleDictionary *)self initWithDoubles:0 forKeys:0 count:0];
}

- (GPBUInt64DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBUInt64DoubleDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 6076, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64DoubleDictionary;
  [(GPBUInt64DoubleDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt64DoubleDictionary allocWithZone:a3];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [v14 doubleValue];
      double v17 = v16;
      LODWORD(v14) = sub_1002ED0F0((unint64_t)v15, 1, v8);
