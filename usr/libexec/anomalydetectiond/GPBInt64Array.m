...
- (BOOL)isEqual:(id)a3;
- (GPBInt64Array)init;
- (GPBInt64Array)initWithCapacity:(unint64_t)a3;
- (GPBInt64Array)initWithValueArray:(id)a3;
- (GPBInt64Array)initWithValues:(const int64_t *)a3 count:(unint64_t)a4;
...
{
  v3.receiver = self;
  v3.super_class = (Class)GPBInt64Array;
  return [(GPBInt64Array *)&v3 init];
}

- (GPBInt64Array)initWithValueArray:(id)a3
{
  return [(GPBInt64Array *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}
...
- (GPBInt64Array)initWithCapacity:(unint64_t)a3
{
  int64_t v4 = [(GPBInt64Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(GPBInt64Array *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  int64_t v4 = +[GPBInt64Array allocWithZone:a3];
  values = self->_values;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBArray.m", 874, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBInt64Array;
...
{
  int64_t v3 = a3;
  [(GPBInt64Array *)self addValues:&v3 count:1];
}
