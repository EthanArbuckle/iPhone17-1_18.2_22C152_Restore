...
- (GPBUInt32Int32Dictionary)init
{
  return [(GPBUInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}
...
- (GPBUInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  ...
  v8 = [(GPBUInt32Int32Dictionary *)&v14 init];
  if (v8)
  {
...
- (GPBUInt32Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = [(GPBUInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 1661, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32Int32Dictionary;
  [(GPBUInt32Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt32Int32Dictionary allocWithZone:a3];

  return [(GPBUInt32Int32Dictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003BA5C0;
  v3[4] = a3;
  [(GPBUInt32Int32Dictionary *)self enumerateKeysAndInt32sUsingBlock:v3];
}
