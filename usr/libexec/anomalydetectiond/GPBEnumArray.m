...
- (GPBEnumArray)initWithValueArray:(id)a3;
...
- (GPBEnumArray)init
{
  return [(GPBEnumArray *)self initWithValidationFunction:0];
}

- (GPBEnumArray)initWithValueArray:(id)a3
{
  return [(GPBEnumArray *)self initWithValidationFunction:*((void *)a3 + 2) rawValues:*((void *)a3 + 3) count:*((void *)a3 + 4)];
}

- (GPBEnumArray)initWithValidationFunction:(void *)a3
{
  v6.receiver = self;
  v6.super_class = (Class)GPBEnumArray;
...
- (GPBEnumArray)initWithValidationFunction:(void *)a3 capacity:(unint64_t)a4
{
  int v5 = [(GPBEnumArray *)self initWithValidationFunction:a3];
  objc_super v6 = v5;
  if (a4 && v5) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[GPBEnumArray allocWithZone:a3];
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBArray.m", 2148, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBEnumArray;
...
{
  int v3 = a3;
  [(GPBEnumArray *)self addRawValues:&v3 count:1];
}
...
{
  int v3 = a3;
  [(GPBEnumArray *)self addValues:&v3 count:1];
}
