...
- (BOOL)isEqual:(id)a3;
- (GPBUInt32EnumDictionary)init;
- (GPBUInt32EnumDictionary)initWithDictionary:(id)a3;
- (GPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3;
- (GPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3 capacity:(unint64_t)a4;
- (GPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unsigned int *)a5 count:(unint64_t)a6;
...
- (GPBUInt32EnumDictionary)init
{
  return [(GPBUInt32EnumDictionary *)self initWithValidationFunction:0 rawValues:0 forKeys:0 count:0];
}

- (GPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3
{
  return [(GPBUInt32EnumDictionary *)self initWithValidationFunction:a3 rawValues:0 forKeys:0 count:0];
}

- (GPBUInt32EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unsigned int *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)GPBUInt32EnumDictionary;
...
- (GPBUInt32EnumDictionary)initWithDictionary:(id)a3
{
  v4 = -[GPBUInt32EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", [a3 validationFunc], 0, 0, 0);
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 2772, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32EnumDictionary;
  [(GPBUInt32EnumDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt32EnumDictionary allocWithZone:a3];
...
- (void)setEnum:(int)a3 forKey:(unsigned int)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:NSInvalidArgumentException, @"GPBUInt32EnumDictionary: Attempt to set an unknown enum value (%d)", v5 format];
  }
