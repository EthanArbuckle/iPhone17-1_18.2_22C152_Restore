...
- (BOOL)isEqual:(id)a3;
- (GPBUInt64Int64Dictionary)init;
- (GPBUInt64Int64Dictionary)initWithCapacity:(unint64_t)a3;
...
- (GPBUInt64Int64Dictionary)init
{
  return [(GPBUInt64Int64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}

- (GPBUInt64Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBUInt64Int64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 5527, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64Int64Dictionary;
...
- (void)setInt64:(int64_t)a3 forKey:(unint64_t)a4
{
  [(NSMutableDictionary *)self->_dictionary setObject:+[NSNumber numberWithLongLong:](NSNumber, "numberWithLongLong:", a3) forKey:+[NSNumber numberWithUnsignedLongLong:a4]];
  autocreator = self->_autocreator;
  if (autocreator)
  {
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
