...
{
  v5.receiver = self;
  v5.super_class = (Class)GPBUnknownField;
...
{
  v3.receiver = self;
  v3.super_class = (Class)GPBUnknownField;
  [(GPBUnknownField *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  objc_super v5 = [+[GPBUnknownField allocWithZone:](GPBUnknownField, "allocWithZone:") initWithNumber:self->number_];
  v5->mutableFixed32List_ = (GPBUInt32Array *)[(GPBUInt32Array *)self->mutableFixed32List_ copyWithZone:a3];
  v5->mutableFixed64List_ = (GPBUInt64Array *)[(GPBUInt64Array *)self->mutableFixed64List_ copyWithZone:a3];
  v5->mutableLengthDelimitedList_ = (NSMutableArray *)[(NSMutableArray *)self->mutableLengthDelimitedList_ mutableCopyWithZone:a3];
  v5->mutableVarintList_ = (GPBUInt64Array *)[(GPBUInt64Array *)self->mutableVarintList_ copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((!-[GPBUInt64Array count](self->mutableVarintList_, "count") && ![*((id *)a3 + 2) count]
     || (unsigned int v5 = [(GPBUInt64Array *)self->mutableVarintList_ isEqual:*((void *)a3 + 2)]) != 0)
    && (!-[GPBUInt32Array count](self->mutableFixed32List_, "count") && ![*((id *)a3 + 3) count]
     || (unsigned int v5 = [(GPBUInt32Array *)self->mutableFixed32List_ isEqual:*((void *)a3 + 3)]) != 0)
    && (!-[GPBUInt64Array count](self->mutableFixed64List_, "count") && ![*((id *)a3 + 4) count]
     || (unsigned int v5 = [(GPBUInt64Array *)self->mutableFixed64List_ isEqual:*((void *)a3 + 4)]) != 0)
...
- (unint64_t)hash
{
  unint64_t v3 = [(GPBUInt64Array *)self->mutableVarintList_ hash];
  v4 = (char *)[(GPBUInt32Array *)self->mutableFixed32List_ hash] + 32 * v3 - v3;
  int64_t v5 = (unsigned char *)[(GPBUInt64Array *)self->mutableFixed64List_ hash] - v4 + 32 * (void)v4;
...
- (unint64_t)serializedSize
{
  ...
  v31[4] = &v33;
  int v32 = number;
  [(GPBUInt64Array *)mutableVarintList enumerateValuesWithBlock:v31];
  ...
  v29[4] = &v33;
  int v30 = number;
  [(GPBUInt32Array *)mutableFixed32List enumerateValuesWithBlock:v29];
  ...
  v27[4] = &v33;
  int v28 = number;
  [(GPBUInt64Array *)mutableFixed64List enumerateValuesWithBlock:v27];
  long long v25 = 0u;
  long long v26 = 0u;
  long long v23 = 0u;
  long long v24 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        id v11 = GPBComputeBytesSize(number, *(void **)(*((void *)&v23 + 1) + 8 * i));
        v34[3] += (uint64_t)v11;
      }
      id v8 = [(NSMutableArray *)mutableLengthDelimitedList countByEnumeratingWithState:&v23 objects:v38 count:16];
    }
  ...
  if (v13)
  {
    ...
    do
    {
      for (j = 0; j != v13; j = (char *)j + 1)
      {
        ...
        long long v16 = GPBComputeUnknownGroupSize(number, *(void **)(*((void *)&v19 + 1) + 8 * (void)j));
        v34[3] += (uint64_t)v16;
      }
      id v13 = [(NSMutableArray *)mutableGroupList countByEnumeratingWithState:&v19 objects:v37 count:16];
    }
...
- (unint64_t)serializedSizeAsMessageSetExtension
{
  ...
  do
  {
    for (i = 0; i != v5; i = (char *)i + 1)
    {
      ...
      v6 += (unint64_t)GPBComputeRawMessageSetExtensionSize(self->number_, *(void **)(*((void *)&v10 + 1) + 8 * i));
    }
...
- (id)description
{
  ...
  v28[3] = &unk_1003BA338;
  v28[4] = v3;
  [(GPBUInt64Array *)mutableVarintList enumerateValuesWithBlock:v28];
  mutableFixed32List = self->mutableFixed32List_;
  v27[0] = _NSConcreteStackBlock;
  v27[1] = 3221225472;
  v27[2] = sub_1002E5B70;
  v27[3] = &unk_1003BA360;
  v27[4] = v3;
  [(GPBUInt32Array *)mutableFixed32List enumerateValuesWithBlock:v27];
  mutableFixed64List = self->mutableFixed64List_;
  ...
  v26[3] = &unk_1003BA338;
  v26[4] = v3;
  [(GPBUInt64Array *)mutableFixed64List enumerateValuesWithBlock:v26];
  long long v24 = 0u;
  long long v25 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
...
- (void)mergeFromField:(id)a3
{
  ...
  if ([v5 count])
  {
    ...
    if (mutableVarintList) {
      ...
      self->mutableVarintList_ = (GPBUInt64Array *)[v5 copy];
    }
  }
  ...
  if ([v7 count])
  {
    ...
    if (mutableFixed32List) {
      ...
      self->mutableFixed32List_ = (GPBUInt32Array *)[v7 copy];
    }
  }
  ...
  if ([v9 count])
  {
    ...
    if (mutableFixed64List) {
      ...
      self->mutableFixed64List_ = (GPBUInt64Array *)[v9 copy];
    }
  }
...
- (void)addVarint:(unint64_t)a3
{
  ...
  if (mutableVarintList)
  {
    -[GPBUInt64Array addValue:](mutableVarintList, "addValue:");
  }
  else
  {
...
- (void)addFixed32:(unsigned int)a3
{
  ...
  if (mutableFixed32List)
  {
    -[GPBUInt32Array addValue:](mutableFixed32List, "addValue:");
  }
  else
  {
...
- (void)addFixed64:(unint64_t)a3
{
  ...
  if (mutableFixed64List)
  {
    -[GPBUInt64Array addValue:](mutableFixed64List, "addValue:");
  }
  else
  {
