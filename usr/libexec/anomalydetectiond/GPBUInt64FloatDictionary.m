...
- (BOOL)isEqual:(id)a3;
- (GPBUInt64FloatDictionary)init;
- (GPBUInt64FloatDictionary)initWithCapacity:(unint64_t)a3;
...
- (GPBUInt64FloatDictionary)init
{
  return [(GPBUInt64FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}

- (GPBUInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)GPBUInt64FloatDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 5893, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64FloatDictionary;
...
- (void)setGPBGenericValue:(id *)a3 forGPBGenericValueKey:(id *)a4
{
  ...
  unsigned int v8 = +[NSNumber numberWithUnsignedLongLong:a4->var2];
