...
- (BOOL)isEqual:(id)a3;
- (GPBBoolUInt64Dictionary)init;
- (GPBBoolUInt64Dictionary)initWithCapacity:(unint64_t)a3;
...
- (GPBBoolUInt64Dictionary)init
{
  return [(GPBBoolUInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (GPBBoolUInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)GPBBoolUInt64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 10515, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolUInt64Dictionary;
  [(GPBBoolUInt64Dictionary *)&v3 dealloc];
}
...
{
  if (self->_valueSet[0]) {
    (*((void (**)(id, const __CFString *, NSString *))a3 + 2))(a3, @"false", +[NSString stringWithFormat:@"%llu", self->_values[0]]);
  }
  if (self->_valueSet[1])
  {
    uint64_t v5 = +[NSString stringWithFormat:@"%llu", self->_values[1]];
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v4])
    {
      ...
      uint64_t v13 = sub_1002ED0F0(values[v4], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      [a3 writeInt32NoTag:sub_1002ED0F0(values[v10], 2, v7) + v16];
      [a3 writeBool:1 value:v15];
      sub_1002ED304(a3, values[v10], 2, v7);
    }
    char v13 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
