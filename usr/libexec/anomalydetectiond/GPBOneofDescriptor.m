...
- (GPBOneofDescriptor)initWithName:(const char *)a3 fields:(id)a4;
- (NSArray)fields;
- (NSString)name;
...
{
  v19.receiver = self;
  v19.super_class = (Class)GPBOneofDescriptor;
  ...
  if (v6)
  {
    ...
    SEL v12 = sub_1002DAFA4(0, (char *)a3, "OneOfCase", 0);
    if (v12) {
      v13 = v12;
    }
    else {
...
{
  v3.receiver = self;
  v3.super_class = (Class)GPBOneofDescriptor;
