...
- (BOOL)isEqual:(id)a3;
- (GPBDoubleArray)init;
- (GPBDoubleArray)initWithCapacity:(unint64_t)a3;
- (GPBDoubleArray)initWithValueArray:(id)a3;
- (GPBDoubleArray)initWithValues:(const double *)a3 count:(unint64_t)a4;
...
{
  v3.receiver = self;
  v3.super_class = (Class)GPBDoubleArray;
  return [(GPBDoubleArray *)&v3 init];
}

- (GPBDoubleArray)initWithValueArray:(id)a3
{
  return [(GPBDoubleArray *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}

- (GPBDoubleArray)initWithValues:(const double *)a3 count:(unint64_t)a4
{
  v6 = [(GPBDoubleArray *)self init];
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (GPBDoubleArray)initWithCapacity:(unint64_t)a3
{
  double v4 = [(GPBDoubleArray *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(GPBDoubleArray *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  double v4 = +[GPBDoubleArray allocWithZone:a3];
  values = self->_values;
  unint64_t count = self->_count;

  return [(GPBDoubleArray *)v4 initWithValues:values count:count];
}

- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBArray.m", 1624, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBDoubleArray;
  [(GPBDoubleArray *)&v3 dealloc];
}
...
{
  unint64_t v5 = 8 * a3;
  CFStringRef v6 = (double *)reallocf(self->_values, 8 * a3);
  self->_values = v6;
  if (!v6)
  {
...
{
  double v3 = a3;
  [(GPBDoubleArray *)self addValues:&v3 count:1];
}
...
- (void)addValues:(const double *)a3 count:(unint64_t)a4
{
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity) {
      [(GPBDoubleArray *)self internalResizeToCapacity:(v8 & 0xFFFFFFFFFFFFFFF0) + 16];
    }
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  {
    [(GPBDoubleArray *)self internalResizeToCapacity:(v6 & 0xFFFFFFFFFFFFFFF0) + 16];
  }
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21) {
    [(GPBDoubleArray *)self internalResizeToCapacity:16];
  }
}
