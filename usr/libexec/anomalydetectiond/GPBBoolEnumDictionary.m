...
- (GPBBoolEnumDictionary)init
{
  return [(GPBBoolEnumDictionary *)self initWithValidationFunction:0 rawValues:0 forKeys:0 count:0];
}

- (GPBBoolEnumDictionary)initWithValidationFunction:(void *)a3
{
  return [(GPBBoolEnumDictionary *)self initWithValidationFunction:a3 rawValues:0 forKeys:0 count:0];
}
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 11813, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolEnumDictionary;
  [(GPBBoolEnumDictionary *)&v3 dealloc];
}
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  unsigned int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = sub_1002EE644(a4->var0, 1, a5);
  uint64_t v9 = +[NSMutableData dataWithLength:GPBComputeEnumSize(2, v7) + v8];
  char v10 = [[GPBCodedOutputStream alloc] initWithData:v9];
  sub_1002EE820(v10, a4->var0, 1, v5);
...
- (void)setEnum:(int)a3 forKey:(BOOL)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    +[NSException raise:NSInvalidArgumentException, @"GPBBoolEnumDictionary: Attempt to set an unknown enum value (%d)", v5 format];
  }
  self->_values[v4] = v5;
  self->_valueSet[v4] = 1;
  autocreator = self->_autocreator;
