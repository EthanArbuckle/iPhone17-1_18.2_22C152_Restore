...
- (GPBInt32Array)init
{
  ...
  return [(GPBInt32Array *)&v3 init];
}

- (GPBInt32Array)initWithValueArray:(id)a3
{
  return [(GPBInt32Array *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}

- (GPBInt32Array)initWithValues:(const int *)a3 count:(unint64_t)a4
{
  v6 = [(GPBInt32Array *)self init];
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (GPBInt32Array)initWithCapacity:(unint64_t)a3
{
  int v4 = [(GPBInt32Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(GPBInt32Array *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v4 = +[GPBInt32Array allocWithZone:a3];
  values = self->_values;
  unint64_t count = self->_count;

  return [(GPBInt32Array *)v4 initWithValues:values count:count];
}

- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBArray.m", 374, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBInt32Array;
  [(GPBInt32Array *)&v3 dealloc];
}
...
{
  int v3 = a3;
  [(GPBInt32Array *)self addValues:&v3 count:1];
}
...
- (void)addValues:(const int *)a3 count:(unint64_t)a4
{
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity) {
      [(GPBInt32Array *)self internalResizeToCapacity:(v8 & 0xFFFFFFFFFFFFFFF0) + 16];
    }
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  {
    [(GPBInt32Array *)self internalResizeToCapacity:(v6 & 0xFFFFFFFFFFFFFFF0) + 16];
  }
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21) {
    [(GPBInt32Array *)self internalResizeToCapacity:16];
  }
}
