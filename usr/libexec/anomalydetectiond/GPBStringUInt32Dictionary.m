...
- (BOOL)isEqual:(id)a3;
- (GPBStringUInt32Dictionary)init;
- (GPBStringUInt32Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBStringUInt32Dictionary)initWithDictionary:(id)a3;
- (GPBStringUInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(id *)a4 count:(unint64_t)a5;
...
- (GPBStringUInt32Dictionary)init
{
  return [(GPBStringUInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}

- (GPBStringUInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBStringUInt32Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 8482, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBStringUInt32Dictionary;
  [(GPBStringUInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBStringUInt32Dictionary allocWithZone:a3];
...
- (void)enumerateKeysAndUInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, v6, [[dictionary objectForKeyedSubscript:v6] unsignedIntValue], &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_1002EBB94([v13 unsignedIntValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002EBB94(v15, 2, v7) + v16];
      sub_10030195C(a3, (uint64_t)v13, v8);
      sub_1002EBDA8(a3, (uint64_t)v15, 2, v7);
