...
- (GPBStringEnumDictionary)init
{
  return [(GPBStringEnumDictionary *)self initWithValidationFunction:0 rawValues:0 forKeys:0 count:0];
}

- (GPBStringEnumDictionary)initWithValidationFunction:(void *)a3
{
  return [(GPBStringEnumDictionary *)self initWithValidationFunction:a3 rawValues:0 forKeys:0 count:0];
}
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 9832, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        unsigned int v14 = sub_100301794(v11, v8);
        v15 = &v14[sub_1002F0510([v13 intValue], v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002F0510(v15, v7) + v16];
      sub_10030195C(a3, (uint64_t)v13, v8);
      sub_1002F06E4(a3, (uint64_t)v15, v7);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  unsigned int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  unsigned int v8 = sub_100301794(a4->var7, a5);
  id v9 = +[NSMutableData dataWithLength:&v8[GPBComputeEnumSize(2, v7)]];
  id v10 = [[GPBCodedOutputStream alloc] initWithData:v9];
  sub_10030195C(v10, a4->var2, v5);
...
- (void)setEnum:(int)a3 forKey:(id)a4
{
  ...
  if ((((uint64_t (*)(uint64_t, SEL))self->_validationFunc)(v5, a2) & 1) == 0) {
    +[NSException raise:NSInvalidArgumentException, @"GPBStringEnumDictionary: Attempt to set an unknown enum value (%d)", v5 format];
  }
  [(NSMutableDictionary *)self->_dictionary setObject:+[NSNumber numberWithInt:v5] forKey:a4];
  autocreator = self->_autocreator;
  if (autocreator)
