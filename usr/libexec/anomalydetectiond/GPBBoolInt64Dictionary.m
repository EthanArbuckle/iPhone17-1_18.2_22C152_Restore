...
- (BOOL)isEqual:(id)a3;
- (GPBBoolInt64Dictionary)init;
- (GPBBoolInt64Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBBoolInt64Dictionary)initWithDictionary:(id)a3;
- (GPBBoolInt64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5;
...
- (GPBBoolInt64Dictionary)init
{
  return [(GPBBoolInt64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}

- (GPBBoolInt64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)GPBBoolInt64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 10726, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  v3.receiver = self;
  v3.super_class = (Class)GPBBoolInt64Dictionary;
  [(GPBBoolInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBBoolInt64Dictionary allocWithZone:a3];
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v4])
    {
      ...
      uint64_t v13 = sub_1002EDB6C(values[v4], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      [a3 writeInt32NoTag:sub_1002EDB6C(values[v10], 2, v7) + v16];
      [a3 writeBool:1 value:v15];
      sub_1002EDDB0(a3, values[v10], 2, v7);
    }
    char v13 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
