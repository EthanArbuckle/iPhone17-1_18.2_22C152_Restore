...
+ (GPBUInt32Array)arrayWithCapacity:(unint64_t)a3;
+ (GPBUInt32Array)arrayWithValue:(unsigned int)a3;
+ (GPBUInt32Array)arrayWithValueArray:(id)a3;
+ (id)array;
- (BOOL)isEqual:(id)a3;
- (GPBUInt32Array)init;
- (GPBUInt32Array)initWithCapacity:(unint64_t)a3;
- (GPBUInt32Array)initWithValueArray:(id)a3;
- (GPBUInt32Array)initWithValues:(const unsigned int *)a3 count:(unint64_t)a4;
...
{
  unsigned int v4 = a3;
  return (GPBUInt32Array *)[objc_alloc((Class)a1) initWithValues:&v4 count:1];
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32Array;
  return [(GPBUInt32Array *)&v3 init];
}

- (GPBUInt32Array)initWithValueArray:(id)a3
{
  return [(GPBUInt32Array *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}

- (GPBUInt32Array)initWithValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  v6 = [(GPBUInt32Array *)self init];
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (GPBUInt32Array)initWithCapacity:(unint64_t)a3
{
  unsigned int v4 = [(GPBUInt32Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(GPBUInt32Array *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  unsigned int v4 = +[GPBUInt32Array allocWithZone:a3];
  values = self->_values;
  unint64_t count = self->_count;

  return [(GPBUInt32Array *)v4 initWithValues:values count:count];
}

- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBArray.m", 624, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32Array;
  [(GPBUInt32Array *)&v3 dealloc];
}
...
{
  unint64_t v5 = 4 * a3;
  CFStringRef v6 = (unsigned int *)reallocf(self->_values, 4 * a3);
  self->_values = v6;
  if (!v6)
  {
...
{
  unsigned int v3 = a3;
  [(GPBUInt32Array *)self addValues:&v3 count:1];
}
...
- (void)addValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity) {
      [(GPBUInt32Array *)self internalResizeToCapacity:(v8 & 0xFFFFFFFFFFFFFFF0) + 16];
    }
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  {
    [(GPBUInt32Array *)self internalResizeToCapacity:(v6 & 0xFFFFFFFFFFFFFFF0) + 16];
  }
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21) {
    [(GPBUInt32Array *)self internalResizeToCapacity:16];
  }
}
