...
- (BOOL)isEqual:(id)a3;
- (GPBUInt32Int64Dictionary)init;
- (GPBUInt32Int64Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBUInt32Int64Dictionary)initWithDictionary:(id)a3;
- (GPBUInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5;
...
- (GPBUInt32Int64Dictionary)init
{
  return [(GPBUInt32Int64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}

- (GPBUInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)GPBUInt32Int64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 2027, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt32Int64Dictionary;
  [(GPBUInt32Int64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt32Int64Dictionary allocWithZone:a3];
