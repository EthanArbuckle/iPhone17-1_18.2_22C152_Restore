...
- (BOOL)isEqual:(id)a3;
- (GPBUInt64Int32Dictionary)init;
- (GPBUInt64Int32Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBUInt64Int32Dictionary)initWithDictionary:(id)a3;
- (GPBUInt64Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5;
...
- (GPBUInt64Int32Dictionary)init
{
  return [(GPBUInt64Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}

- (GPBUInt64Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBUInt64Int32Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 5161, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64Int32Dictionary;
  [(GPBUInt64Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt64Int32Dictionary allocWithZone:a3];
