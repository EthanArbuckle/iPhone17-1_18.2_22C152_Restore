...
- (BOOL)isEqual:(id)a3;
- (GPBInt64UInt64Dictionary)init;
- (GPBInt64UInt64Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBInt64UInt64Dictionary)initWithDictionary:(id)a3;
- (GPBInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5;
...
- (GPBInt64UInt64Dictionary)init
{
  return [(GPBInt64UInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (GPBInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBInt64UInt64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 7094, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt64UInt64Dictionary;
  [(GPBInt64UInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBInt64UInt64Dictionary allocWithZone:a3];
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 longLongValue], [v6 objectForKeyedSubscript:@"objectForKeyedSubscript:" unsignedLongLongValue], &v7);
  }
  while (!v7);
}
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      int v17 = sub_1002EDB6C((unint64_t)v15, 1, v8);
