...
- (BOOL)isEqual:(id)a3;
- (GPBUInt64UInt64Dictionary)init;
- (GPBUInt64UInt64Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBUInt64UInt64Dictionary)initWithDictionary:(id)a3;
- (GPBUInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5;
...
- (GPBUInt64UInt64Dictionary)init
{
  return [(GPBUInt64UInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (GPBUInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBUInt64UInt64Dictionary;
  v8 = [(GPBUInt64UInt64Dictionary *)&v14 init];
  if (v8)
  {
...
- (GPBUInt64UInt64Dictionary)initWithDictionary:(id)a3
{
  v4 = [(GPBUInt64UInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 5344, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64UInt64Dictionary;
  [(GPBUInt64UInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt64UInt64Dictionary allocWithZone:a3];

  return [(GPBUInt64UInt64Dictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 unsignedLongLongValue], [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6) unsignedLongLongValue], &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v15 = sub_1002ED0F0((unint64_t)[v13 unsignedLongLongValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002ED0F0((unint64_t)v16, 2, v7) + v17];
      sub_1002ED304(a3, (uint64_t)v15, 1, v8);
      sub_1002ED304(a3, (uint64_t)v16, 2, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1003BA868;
  v3[4] = a3;
  [(GPBUInt64UInt64Dictionary *)self enumerateKeysAndUInt64sUsingBlock:v3];
}
...
- (void)setUInt64:(unint64_t)a3 forKey:(unint64_t)a4
{
  [(NSMutableDictionary *)self->_dictionary setObject:+[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:", a3) forKey:+[NSNumber numberWithUnsignedLongLong:a4]];
  autocreator = self->_autocreator;
  if (autocreator)
  {
    GPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
