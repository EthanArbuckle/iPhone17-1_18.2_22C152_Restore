...
- (BOOL)isEqual:(id)a3;
- (BOOL)isInitialized;
- (GPBUInt64ObjectDictionary)init;
- (GPBUInt64ObjectDictionary)initWithCapacity:(unint64_t)a3;
- (GPBUInt64ObjectDictionary)initWithDictionary:(id)a3;
- (GPBUInt64ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5;
...
- (GPBUInt64ObjectDictionary)init
{
  return [(GPBUInt64ObjectDictionary *)self initWithObjects:0 forKeys:0 count:0];
}

- (GPBUInt64ObjectDictionary)initWithObjects:(const void *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v12.receiver = self;
  v12.super_class = (Class)GPBUInt64ObjectDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 6515, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBUInt64ObjectDictionary;
  [(GPBUInt64ObjectDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBUInt64ObjectDictionary allocWithZone:a3];
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  uint64_t v5 = objc_alloc_init(GPBUInt64ObjectDictionary);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      int v16 = sub_1002ED0F0((unint64_t)v15, 1, v8);
