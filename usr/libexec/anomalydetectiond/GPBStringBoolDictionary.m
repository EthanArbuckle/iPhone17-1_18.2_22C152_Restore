...
- (GPBStringBoolDictionary)init
{
  return [(GPBStringBoolDictionary *)self initWithBools:0 forKeys:0 count:0];
}

- (GPBStringBoolDictionary)initWithBools:(const BOOL *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)GPBStringBoolDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 9246, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBStringBoolDictionary;
...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, v6, [dictionary objectForKeyedSubscript:v6].BOOLValue, &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_1002EE644((uint64_t)[v13 BOOLValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002EE644((uint64_t)v15, 2, v7) + v16];
      sub_10030195C(a3, (uint64_t)v13, v8);
      sub_1002EE820(a3, (uint64_t)v15, 2, v7);
