...
- (BOOL)isEqual:(id)a3;
- (GPBInt32Int64Dictionary)init;
- (GPBInt32Int64Dictionary)initWithCapacity:(unint64_t)a3;
- (GPBInt32Int64Dictionary)initWithDictionary:(id)a3;
- (GPBInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5;
...
- (GPBInt32Int64Dictionary)init
{
  return [(GPBInt32Int64Dictionary *)self initWithInt64s:0 forKeys:0 count:0];
}

- (GPBInt32Int64Dictionary)initWithInt64s:(const int64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)GPBInt32Int64Dictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 3777, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt32Int64Dictionary;
  [(GPBInt32Int64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[GPBInt32Int64Dictionary allocWithZone:a3];
...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 intValue], [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6) stringByAppendingPathComponent:@"DBCShutdownCookie"], &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v15 = sub_1002EDB6C((unint64_t)[v13 longLongValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1002EDB6C((unint64_t)v16, 2, v7) + v17];
      sub_1002EC85C(a3, (uint64_t)v15, 1, v8);
      sub_1002EDDB0(a3, (uint64_t)v16, 2, v7);
