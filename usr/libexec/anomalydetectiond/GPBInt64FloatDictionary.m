...
- (BOOL)isEqual:(id)a3;
- (GPBInt64FloatDictionary)init;
- (GPBInt64FloatDictionary)initWithCapacity:(unint64_t)a3;
...
- (GPBInt64FloatDictionary)init
{
  return [(GPBInt64FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}

- (GPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)GPBInt64FloatDictionary;
...
- (void)dealloc
{
  if (self->_autocreator) {
    [+[NSAssertionHandler currentHandler] handleFailureInMethod:a2, self, @"GPBDictionary.m", 7643, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator object file lineNumber description];
  }

  v3.receiver = self;
  v3.super_class = (Class)GPBInt64FloatDictionary;
...
- (void)setGPBGenericValue:(id *)a3 forGPBGenericValueKey:(id *)a4
{
  ...
  unsigned int v8 = +[NSNumber numberWithLongLong:a4->var2];
