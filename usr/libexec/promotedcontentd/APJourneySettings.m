...
LABEL_8:
  ...
  if (!+[APSystemInternal isAppleInternalInstall](APSystemInternal, "isAppleInternalInstall")|| ([v2 serverEnvironment], (v18 = (__CFString *)objc_claimAutoreleasedReturnValue()) != 0))
  {
  ...
  uint64_t v20 = +[NSString stringWithFormat:@"%@://%@.%@%@", v6, v5, v4, v3];
