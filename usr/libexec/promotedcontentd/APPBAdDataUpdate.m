...
+ (id)options
{
  if (qword_100289808 != -1) {
    dispatch_once(&qword_100289808, &stru_100235000);
  }
  v2 = (void *)qword_100289800;
...
{
  v7.receiver = self;
  v7.super_class = (Class)APPBAdDataUpdate;
  char v3 = [(APPBAdDataUpdate *)&v7 description];
...
LABEL_5:
  ...
  {
LABEL_6:
    objc_super v7 = +[NSNumber numberWithInt:self->_impressionCountAdjustment];
...
- (void)copyTo:(id)a3
{
  ...
  if (has)
  {
    *((void *)v5 + 1) = *(void *)&self->_expirationDate;
...
LABEL_18:
  ...
  if ((*(unsigned char *)&self->_has & 4) != 0)
  {
    if ((*((unsigned char *)v4 + 40) & 4) == 0 || self->_impressionCountAdjustment != *((_DWORD *)v4 + 6)) {
      goto LABEL_18;
    }
    BOOL v6 = 1;
  }
...
LABEL_11:
  uint64_t v11 = 2654435761 * self->_impressionCountAdjustment;
  return v5 ^ v3 ^ v10 ^ v11;
}
