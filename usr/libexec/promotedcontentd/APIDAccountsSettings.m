...
+ (id)defaultValues
{
  ...
  v6 = +[NSUUID UUID];
  v7 = [v6 UUIDString];
  v8 = [v7 stringByReplacingCharactersInRange:0 withString:@"BAAAAAAD"];

  v9 = +[NSUUID UUID];
  v10 = [v9 UUIDString];
  v11 = [v10 stringByReplacingCharactersInRange:0 withString:@"BAAAAAAD"];

  v12 = +[NSUUID UUID];
  v13 = [v12 UUIDString];
  v14 = [v13 stringByReplacingCharactersInRange:0 withString:@"BAAAAAAD"];

  v15 = +[NSUUID UUID];
  v16 = [v15 UUIDString];
  v17 = [v16 stringByReplacingCharactersInRange:0 withString:@"BAAAAAAD"];
  ...
  v25[8] = @"DPID";
  v25[9] = @"segmentData";
  v26[8] = &stru_1002392C0;
  v26[9] = &stru_1002392C0;
  ...
  v18 = +[NSDictionary dictionaryWithObjects:v26 forKeys:v25 count:16];
