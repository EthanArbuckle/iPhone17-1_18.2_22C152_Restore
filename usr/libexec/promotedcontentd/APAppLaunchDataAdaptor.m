...
- (void)eventReceived:(id)a3
{
  ...
  {
    id v7 = v4;
    uint64_t v8 = [(APAppLaunchDataAdaptor *)self bundleIDs];
    v9 = [v7 eventBody];
    int v10 = [v9 bundleID];
    ...
    {
      v12 = [v7 eventBody];
      unsigned int v13 = [v12 starting];

      if (v13)
      {
        long long v14 = [v7 eventBody];
  ...
  else
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_1000590B0;
    block[3] = &unk_100233D50;
    id v17 = v4;
    if (qword_100288888 != -1) {
      dispatch_once(&qword_100288888, block);
    }
  }
}
