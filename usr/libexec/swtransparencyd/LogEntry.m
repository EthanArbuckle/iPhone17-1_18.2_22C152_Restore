...
+ (id)descriptor
{
  id v2 = (id)qword_10015B218;
  if (!qword_10015B218)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:LogEntry messageName:@"LogEntry" fileDescription:&unk_1001560A0 fields:&off_100156298 fieldCount:6 storageSize:48 flags:v4];
    [v2 setupExtraTextInfo:&unk_10010A204];
    qword_10015B218 = (uint64_t)v2;
  }
  return v2;
}
...
LABEL_12:
      if (qword_10015B338 != -1) {
        dispatch_once(&qword_10015B338, &stru_100136388);
      }
      id v14 = qword_10015B340;
...
- (unint64_t)verifyTLTEntryForPerApplicationLogHead:(id)a3 error:(id *)a4
{
  ...
  id v11 = sub_10000D654;
  id v12 = &unk_100136498;
  unint64_t v13 = self;
  id v14 = a3;
  id v5 = v14;
