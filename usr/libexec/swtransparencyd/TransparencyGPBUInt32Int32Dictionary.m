...
- (void)enumerateKeysAndInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    [dictionary objectForKeyedSubscript:[v6 unsignedIntValue]] = [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "intValue")];
  }
  while (!v7);
}
