...
+ (__SecCertificate)certificateFromData:(id)a3 error:(id *)a4
{
  ...
  if (!v6)
  {
    ...
    if (!v6)
    {
      ...
      if (qword_10015B3E0 != -1) {
        dispatch_once(&qword_10015B3E0, &stru_1001370E0);
      }
      v7 = qword_10015B3E8;
      if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
      {
        *(_WORD *)v9 = 0;
...
+ (BOOL)addTrustedCertificate:(id)a3 trustedKeys:(id)a4 error:(id *)a5
{
  ...
  {
    if (qword_10015B3E0 != -1) {
      dispatch_once(&qword_10015B3E0, &stru_100137100);
    }
    v15 = qword_10015B3E8;
    if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
    {
  ...
  if (!v10)
  {
    ...
    if (qword_10015B3E0 != -1) {
      dispatch_once(&qword_10015B3E0, &stru_100137120);
    }
    v16 = qword_10015B3E8;
    if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
    {
  ...
  if (!v12)
  {
    ...
    if (qword_10015B3E0 != -1) {
      dispatch_once(&qword_10015B3E0, &stru_100137140);
    }
    v18 = qword_10015B3E8;
    if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
    {
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        {
          if (qword_10015B3E0 != -1) {
            dispatch_once(&qword_10015B3E0, &stru_100137160);
          }
          long long v14 = qword_10015B3E8;
          if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
          {
...
+ (BOOL)verifyLeaf:(id)a3 intermediates:(id)a4 policy:(__SecPolicy *)a5 error:(id *)a6
{
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      if (qword_10015B3E0 != -1) {
        dispatch_once(&qword_10015B3E0, &stru_1001371A0);
      }
      long long v14 = qword_10015B3E8;
      if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
      {
  ...
  {
    if (qword_10015B3E0 != -1) {
      dispatch_once(&qword_10015B3E0, &stru_100137180);
    }
    long long v16 = qword_10015B3E8;
    if (os_log_type_enabled((os_log_t)qword_10015B3E8, OS_LOG_TYPE_ERROR))
    {
      LOWORD(trust[0]) = 0;
