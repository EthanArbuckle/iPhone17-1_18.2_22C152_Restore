...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 longLongValue], [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6) stringByAppendingPathComponent:@"DBCShutdownCookie"), "longLongValue"], &v7);
  }
  while (!v7);
}
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1000CF304((unint64_t)v16, 2, v7) + v17];
