...
+ (TransparencyGPBUInt64Array)arrayWithCapacity:(unint64_t)a3;
+ (TransparencyGPBUInt64Array)arrayWithValue:(unint64_t)a3;
+ (TransparencyGPBUInt64Array)arrayWithValueArray:(id)a3;
+ (id)array;
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBUInt64Array)init;
- (TransparencyGPBUInt64Array)initWithCapacity:(unint64_t)a3;
- (TransparencyGPBUInt64Array)initWithValueArray:(id)a3;
- (TransparencyGPBUInt64Array)initWithValues:(const unint64_t *)a3 count:(unint64_t)a4;
...
{
  unint64_t v4 = a3;
  return (TransparencyGPBUInt64Array *)[objc_alloc((Class)a1) initWithValues:&v4 count:1];
}
...
+ (TransparencyGPBUInt64Array)arrayWithValueArray:(id)a3
{
  ...
  return (TransparencyGPBUInt64Array *)v3;
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt64Array;
  return [(TransparencyGPBUInt64Array *)&v3 init];
}

- (TransparencyGPBUInt64Array)initWithValueArray:(id)a3
{
  return [(TransparencyGPBUInt64Array *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}
...
- (TransparencyGPBUInt64Array)initWithCapacity:(unint64_t)a3
{
  unint64_t v4 = [(TransparencyGPBUInt64Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(TransparencyGPBUInt64Array *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  unint64_t v4 = +[TransparencyGPBUInt64Array allocWithZone:a3];
  values = self->_values;
...
{
  unint64_t v3 = a3;
  [(TransparencyGPBUInt64Array *)self addValues:&v3 count:1];
}
