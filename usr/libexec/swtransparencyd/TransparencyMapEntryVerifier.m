...
- (BOOL)verifyInclusionOfMapLeaf:(id)a3 position:(id)a4 treeHead:(id)a5 treeId:(unint64_t)a6 hashPath:(id)a7 error:(id *)a8
{
  ...
  if (v18 != (id)(8 * (void)[v14 length]))
  {
    ...
    if (qword_10015B3F0 != -1) {
      dispatch_once(&qword_10015B3F0, &stru_1001371F0);
    }
    v35 = qword_10015B3F8;
  ...
  if ((v33 & 1) == 0)
  {
    ...
    v17 = v45;
    if (qword_10015B3F0 != -1) {
      dispatch_once(&qword_10015B3F0, &stru_100137210);
    }
    v38 = (void *)qword_10015B3F8;
    if (os_log_type_enabled((os_log_t)qword_10015B3F8, OS_LOG_TYPE_ERROR))
    {
      v39 = v38;
...
- (unint64_t)verifyMapEntryWithMapLeaf:(id)a3 hashesToRoot:(id)a4 signedMapHead:(id)a5 error:(id *)a6
{
  ...
  if (v13 == 1)
  {
    ...
    else
    {
      ...
      if (qword_10015B3F0 != -1) {
        dispatch_once(&qword_10015B3F0, &stru_100137270);
      }
      uint64_t v20 = qword_10015B3F8;
      if (os_log_type_enabled((os_log_t)qword_10015B3F8, OS_LOG_TYPE_ERROR))
      {
