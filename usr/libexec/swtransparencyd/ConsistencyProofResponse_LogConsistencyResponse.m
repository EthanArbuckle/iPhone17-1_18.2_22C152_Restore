...
+ (id)descriptor
{
  id v2 = (id)qword_10015B288;
  if (!qword_10015B288)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:ConsistencyProofResponse_LogConsistencyResponse messageName:@"LogConsistencyResponse" fileDescription:&unk_100156778 fields:&off_100156850 fieldCount:3 storageSize:32 flags:v4];
    [v2 setupExtraTextInfo:&unk_10010A2B5];
    [v2 setupContainingMessageClass:ConsistencyProofResponse];
    qword_10015B288 = (uint64_t)v2;
  }
  return v2;
}
...
- (void)setResult:(unint64_t)a3 treeHead:(id)a4 error:(id)a5
{
  ...
  else
  {
    ...
    if (qword_10015B358 != -1) {
      dispatch_once(&qword_10015B358, &stru_1001368F8);
    }
    v26 = (void *)qword_10015B360;
    if (os_log_type_enabled((os_log_t)qword_10015B360, OS_LOG_TYPE_DEFAULT))
    {
      v27 = v26;
      v28 = [v23 eventId];
          ...
          if ([v12 verifyWithError:0] == (id)1)
          {
            ...
            if ([v20 isEqual:v22])
            {
                ...
                && (id v25 = [v19 getUnsigned:"revision"], v25 == objc_msgSend(v18, "revision")))
              {
                ...
                self = v43;
                if (qword_10015B358 != -1) {
                  dispatch_once(&qword_10015B358, &stru_100136918);
                }
                v29 = (void *)qword_10015B360;
