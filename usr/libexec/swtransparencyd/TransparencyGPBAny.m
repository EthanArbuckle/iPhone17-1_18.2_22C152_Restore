...
- (BOOL)packWithMessage:(id)a3 typeURLPrefix:(id)a4 error:(id *)a5
{
  v9 = (NSString *)[objc_msgSend(a3, "descriptor") fullName];
...
+ (id)descriptor
{
  id v2 = (id)qword_100162208;
  if (!qword_100162208)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBAny messageName:@"Any" fileDescription:off_10015AF60 fields:&off_10015AF20 fieldCount:2 storageSize:24 flags:v4];
    [v2 setupExtraTextInfo:&unk_10010E778];
    qword_100162208 = (uint64_t)v2;
  }
  return v2;
}
