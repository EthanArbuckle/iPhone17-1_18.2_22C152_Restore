...
- ($DA51BD281D7B79E0E3DF913ED47B85E0)defaultValue;
...
- (TransparencyGPBFieldDescriptor)initWithFieldDescription:(void *)a3 descriptorFlags:(unsigned int)a4
{
  ...
  v7->getSel_ = v10;
  SEL v11 = sub_1000CB728("set", *((char **)a3 + (v4 & 1)), 0, 1);
  if (v11) {
    v12 = v11;
  }
  else {
  ...
  else
  {
    ...
    SEL v22 = sub_1000CB728("has", *((char **)a3 + (v4 & 1)), 0, 0);
    if (v22) {
      v23 = v22;
    }
    else {
  ...
  SEL v20 = sub_1000CB728(v18, v16, v17, v19);
  if (v20) {
    SEL v21 = v20;
  }
  else {
...
- ($DA51BD281D7B79E0E3DF913ED47B85E0)defaultValue
{
  ...
  if ((description->var5 & 2) == 0)
  {
    ...
    {
      return ($DA51BD281D7B79E0E3DF913ED47B85E0)sub_1000F6AE0();
    }
    else
    {
      if (valueInt64) {
      ...
      if (v7) {
        return ($DA51BD281D7B79E0E3DF913ED47B85E0)&stru_10013DAE0;
      }
    }
  }
  return ($DA51BD281D7B79E0E3DF913ED47B85E0)valueInt64;
}
...
- (id)textFormatName
{
  ...
  id AssociatedObject = objc_getAssociatedObject(self, &unk_10010E51D);
  if (!AssociatedObject) {
    return 0;
  }
  ...
  return sub_1000F93F0(v8, var2, v10);
}
