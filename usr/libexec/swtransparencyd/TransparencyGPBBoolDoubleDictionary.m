...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    {
      ++v4;
      uint64_t v10 = sub_1000CA038(1);
      uint64_t v11 = sub_1000C9E40(2) + v10;
      v5 += v11 + sub_1000C838C(v11);
    }
    char v8 = 0;
    uint64_t v3 = 1;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  uint64_t v6 = sub_1000FA704(*(_DWORD *)(*((void *)a4 + 1) + 16), 2);
  char v7 = 0;
  uint64_t v8 = 0;
  valueSet = self->_valueSet;
  values = self->_values;
  ...
  do
  {
    ...
    if (valueSet[v8])
    {
      ...
      uint64_t v13 = v7 & 1;
      int v14 = sub_1000CA038(1);
      [a3 writeInt32NoTag:sub_1000C9E40(2) + v14];
