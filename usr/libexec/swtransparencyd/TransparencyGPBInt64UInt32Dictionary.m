...
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBInt64UInt32Dictionary)init;
- (TransparencyGPBInt64UInt32Dictionary)initWithCapacity:(unint64_t)a3;
- (TransparencyGPBInt64UInt32Dictionary)initWithDictionary:(id)a3;
- (TransparencyGPBInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5;
...
- (TransparencyGPBInt64UInt32Dictionary)init
{
  return [(TransparencyGPBInt64UInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}

- (TransparencyGPBInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBInt64UInt32Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBInt64UInt32Dictionary;
  [(TransparencyGPBInt64UInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBInt64UInt32Dictionary allocWithZone:a3];
...
- (void)enumerateKeysAndUInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    [dictionary objectForKeyedSubscript:v6][(unsigned int)[v6 longLongValue]][&v7];
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v14 = sub_1000CF304((unint64_t)[v11 longLongValue], 1, v8);
        uint64_t v15 = sub_1000CD810([v13 unsignedIntValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_1000CF304((unint64_t)v15, 1, v8);
      [a3 writeInt32NoTag:sub_1000CD810(v16, 2, v7) + v14];
      sub_1000CF4A4(a3, (uint64_t)v15, 1, v8);
      if (v7 == 1)
      {
...
- (void)setUInt32:(unsigned int)a3 forKey:(int64_t)a4
{
  [(NSMutableDictionary *)self->_dictionary setObject:+[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", *(void *)&a3) forKey:+[NSNumber numberWithLongLong:a4]];
  autocreator = self->_autocreator;
  if (autocreator)
  {
    sub_1000EB648(autocreator, (uint64_t)self);
