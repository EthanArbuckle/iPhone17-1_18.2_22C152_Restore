...
+ (id)descriptor
{
  id result = (id)qword_100162168;
  if (!qword_100162168)
  {
    LODWORD(v3) = 28;
    id result = +[TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBTimestamp messageName:@"Timestamp" fileDescription:off_10015AA78 fields:&off_10015AA38 fieldCount:2 storageSize:16 flags:v3];
    qword_100162168 = (uint64_t)result;
  }
  return result;
}
