...
+ (id)descriptor
{
  id result = (id)qword_100162100;
  if (!qword_100162100)
  {
    LODWORD(v3) = 28;
    id result = +[TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBDuration messageName:@"Duration" fileDescription:off_10015A6F8 fields:&off_10015A6B8 fieldCount:2 storageSize:16 flags:v3];
    qword_100162100 = (uint64_t)result;
  }
  return result;
}
