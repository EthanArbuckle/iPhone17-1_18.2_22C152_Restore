...
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBUInt64UInt64Dictionary)init;
- (TransparencyGPBUInt64UInt64Dictionary)initWithCapacity:(unint64_t)a3;
...
- (TransparencyGPBUInt64UInt64Dictionary)init
{
  return [(TransparencyGPBUInt64UInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBUInt64UInt64Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt64UInt64Dictionary;
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v15 = sub_1000CEA18((unint64_t)[v13 unsignedLongLongValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_1000CEA18((unint64_t)v15, 1, v8);
      [a3 writeInt32NoTag:sub_1000CEA18((unint64_t)v16, 2, v7) + v14];
      if (v8 == 4)
      {
