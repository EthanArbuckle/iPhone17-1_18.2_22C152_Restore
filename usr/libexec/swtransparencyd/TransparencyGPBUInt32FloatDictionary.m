...
- (TransparencyGPBUInt32FloatDictionary)init
{
  return [(TransparencyGPBUInt32FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt32FloatDictionary allocWithZone:a3];
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        uint64_t v13 = sub_1000CD810([v10 unsignedIntValue], 1, v7);
        [v12 floatValue];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      [v13 floatValue];
      int v16 = v15;
      LODWORD(v13) = sub_1000CD810(v14, 1, v7);
