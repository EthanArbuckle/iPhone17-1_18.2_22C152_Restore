...
- (TransparencyGPBUInt32UInt64Dictionary)init
{
  return [(TransparencyGPBUInt32UInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt32UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)TransparencyGPBUInt32UInt64Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt32UInt64Dictionary;
  [(TransparencyGPBUInt32UInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt32UInt64Dictionary allocWithZone:a3];
