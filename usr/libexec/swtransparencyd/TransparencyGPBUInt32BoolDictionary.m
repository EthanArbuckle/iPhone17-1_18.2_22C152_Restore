...
- (TransparencyGPBUInt32BoolDictionary)init
{
  return [(TransparencyGPBUInt32BoolDictionary *)self initWithBools:0 forKeys:0 count:0];
}
...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    [dictionary objectForKeyedSubscript:v6] ? [dictionary objectForKeyedSubscript:v6] : [dictionary objectForKeyedSubscript:v6];
  }
  while (!v7);
}
