...
+ (id)descriptor
{
  id v2 = (id)qword_10015B228;
  if (!qword_10015B228)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:MapEntry messageName:@"MapEntry" fileDescription:&unk_1001560A0 fields:&off_100156478 fieldCount:3 storageSize:32 flags:v4];
    [v2 setupExtraTextInfo:&unk_10010A242];
    qword_10015B228 = (uint64_t)v2;
  }
  return v2;
}
...
LABEL_12:
  if (qword_10015B3D0 != -1) {
    dispatch_once(&qword_10015B3D0, &stru_1001370C0);
  }
  v27 = qword_10015B3D8;
  if (os_log_type_enabled((os_log_t)qword_10015B3D8, OS_LOG_TYPE_ERROR))
  {
    int v28 = 134217984;
    uint64_t v29 = v26;
