...
- (void)enumerateKeysAndRawValuesUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    [dictionary objectForKeyedSubscript:v6] = [v6 unsignedLongLongValue];
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        uint64_t v14 = sub_1000C9F98(2, [v12 intValue]) + v13;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_1000C9F98(2, v15) + v13];
      if (v7 == 4)
      {
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = sub_1000CEA18(a4->var2, 1, a5);
  id v9 = +[NSMutableData dataWithLength:sub_1000C9F98(2, v7) + v8];
