...
- (id)createManagedObjectWithError:(id *)a3
{
  ...
  v16 = [v7 createMapHead:v8 application:v22 logBeginTime:v20 logHeadHash:v10 logType:v12 revision:v14 populating:v18];
...
- (MapHead)parsedMapHead
{
        ...
        v6))
  {
    ...
    if (v9)
    {
      if (qword_10015B390 != -1) {
        dispatch_once(&qword_10015B390, &stru_100136AF0);
      }
      v10 = qword_10015B398;
  ...
  {
    if (qword_10015B390 != -1) {
      dispatch_once(&qword_10015B390, &stru_100136AD0);
    }
    unint64_t v11 = qword_10015B398;
    if (os_log_type_enabled((os_log_t)qword_10015B398, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
