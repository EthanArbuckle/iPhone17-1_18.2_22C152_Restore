...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (v11)
    {
      ...
      unsigned int v13 = sub_1000CCD14(v11, v7);
      v5 += (uint64_t)&v13[v12 + sub_1000C838C((int)v13 + (int)v12)];
    }
    char v9 = 0;
    uint64_t v3 = 1;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (values[v10])
    {
      ...
      uint64_t v14 = v9 & 1;
      int v15 = sub_1000CA038(1);
      [a3 writeInt32NoTag:sub_1000CCD14(values[v10], v7) + v15];
      [a3 writeBool:1 value:v14];
      sub_1000CCE48(a3, (const char *)values[v10], v7);
    }
    char v12 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
