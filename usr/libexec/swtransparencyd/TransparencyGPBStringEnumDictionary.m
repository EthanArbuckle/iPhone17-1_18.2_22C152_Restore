  ...
  if (result)
  {
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        v13 = &v12[sub_1000C9F98(2, [v11 intValue])];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      id v13 = [v12 intValue];
      unsigned int v14 = sub_1000CA088(1, v11);
      [a3 writeInt32NoTag:sub_1000C9F98(2, v13) + v14];
...
{
  uint64_t v6 = *(void *)&a3;
  uint64_t v7 = sub_1000CA088(1, a4->var7);
  id v8 = +[NSMutableData dataWithLength:&v7[sub_1000C9F98(2, v6)]];
