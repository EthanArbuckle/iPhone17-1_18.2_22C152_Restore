...
- (double)cpuTimeMs
{
  ...
  if (qword_100069D40 != -1) {
    dispatch_once(&qword_100069D40, &stru_100055860);
  }
  return *(double *)&qword_1000699F8 * (double)v2 / 1000000.0;
}
...
+ (int64_t)wallTime
{
  if (qword_100069D38 != -1) {
    dispatch_once(&qword_100069D38, &stru_100055840);
  }
  return (qword_100069D30 * mach_absolute_time()) >> 8;
}
