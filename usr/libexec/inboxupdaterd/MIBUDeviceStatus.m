...
- (BOOL)isEqual:(id)a3
{
  ...
  id v5 = [v4 state];
  if (v5 != (id)[(MIBUDeviceStatus *)self state]) {
    goto LABEL_10;
  }
  id v6 = [v4 operation];
  if (v6 != (id)[(MIBUDeviceStatus *)self operation]) {
    goto LABEL_10;
  }
  ...
  unsigned int v21 = [v19 isEqualToDictionary:v20];
  ...
  unsigned int v24 = [v22 isEqualToDictionary:v23];
