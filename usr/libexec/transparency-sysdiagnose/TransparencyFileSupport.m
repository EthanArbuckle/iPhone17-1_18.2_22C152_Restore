...
+ (BOOL)setProtectionToClassDForURL:(id)a3 error:(id *)a4
{
  ...
  if (v6)
  {
    if (fcntl(v6, 64, 4) < 0)
    {
      ...
      if (qword_100008678 != -1) {
        dispatch_once(&qword_100008678, &stru_100004248);
      }
      v11 = (void *)qword_100008680;
      if (os_log_type_enabled((os_log_t)qword_100008680, OS_LOG_TYPE_ERROR))
      {
        v12 = v11;
        v13 = __error();
        v14 = strerror(*v13);
  ...
  else
  {
    ...
    if (qword_100008678 != -1) {
      dispatch_once(&qword_100008678, &stru_100004268);
    }
    v19 = (void *)qword_100008680;
    if (os_log_type_enabled((os_log_t)qword_100008680, OS_LOG_TYPE_ERROR))
    {
      v20 = v19;
      v21 = __error();
...
+ (id)applicationSupportPath:(id *)a3
{
  ...
  else
  {
    ...
    if (qword_100008678 != -1) {
      dispatch_once(&qword_100008678, &stru_100004288);
    }
    v12 = qword_100008680;
    if (os_log_type_enabled((os_log_t)qword_100008680, OS_LOG_TYPE_ERROR))
    {
...
+ (id)transparencyFilesPath:(id *)a3
{
  return [a1 applicationSupportPath:a3];
}
      ...
      if (v9)
      {
        ...
        while (2)
        {
          for (i = 0; i != v10; i = (char *)i + 1)
          {
            ...
            id v20 = 0;
            [v14 getResourceValue:&v20 forKey:NSURLFileSizeKey error:a3];
            id v15 = v20;
            if (!v15)
            {
              int64_t v17 = -1;
