      ...
      else
      {
        ...
        if (v20)
        {
          ...
          if ([v21 count] == (id)1)
          {
            ...
            unsigned int v24 = [v23 isEqualToString:SKAPFSVolumeRoleRecovery];
...
LABEL_19:
      if (v5->_recoveryPart)
      {
        uint64_t v25 = [v7 objectAtIndexedSubscript:((char *)[v7 count]) - 2];
        v26 = *p_resizablePart;
  ...
  id v15 = [(SKDisk *)v5->_resizablePart startLocation];
  v16 = objc_opt_class();
  v17 = [v4 type];
  ...
  if (v18) {
    v5->_nonResizableSize += (unint64_t)[(SKDisk *)v18 unformattedSize];
  }
...
+ (unint64_t)hfsMinimalSizeForDisk:(id)a3 currentSize:(unint64_t *)a4
{
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      unsigned int v11 = sub_10000DD48();
...
LABEL_9:
    ...
    unint64_t v15 = (unint64_t)[v5 totalSpace];
LABEL_14:
