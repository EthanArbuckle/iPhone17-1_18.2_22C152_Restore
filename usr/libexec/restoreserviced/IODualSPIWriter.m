...
- (id)_getSFRManifestHashForPayload:(id)a3
{
  ...
  [v5 appendData:-[IODualSPIWriter readDataAtOffset:ofLength:](self, "readDataAtOffset:ofLength:", objc_msgSend(a3, "imageAddress"), -[IODualSPIWriter _maxImageSize](self, "_maxImageSize"))];
...
- (BOOL)verifyFirmwareAtIndex:(unint64_t)a3 againstData:(id)a4
{
  ...
  if ((unint64_t)[v7 count] >= a3 + 1)
  {
    ...
    unsigned __int8 v15 = [[-[IODualSPIWriter readDataAtOffset:ofLength:](self, "readDataAtOffset:ofLength:", [v16 imageAddress], [a4 length]) isEqual:a4];
    if ((v15 & 1) == 0) {
