...
- (BOOL)installWithInstaller:(id)a3 options:(id)a4 interactionClient:(id)a5 outError:(id *)a6
{
  ...
  uint64_t v11 = MCSharedDeviceConfigurationErrorDomain;
  v12 = MCErrorArray();
  uint64_t v13 = MCErrorTypeFatal;
  v14 = +[NSError MCErrorWithDomain:code:descriptionArray:errorType:](NSError, "MCErrorWithDomain:code:descriptionArray:errorType:", v11, 46000, v12, MCErrorTypeFatal, 0);
