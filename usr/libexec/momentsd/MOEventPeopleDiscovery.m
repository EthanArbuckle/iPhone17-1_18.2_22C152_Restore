...
- (MOEventPeopleDiscovery)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_gaPR = (int64_t)[v4 decodeIntegerForKey:@"gPRelationship"];
...
- (id)description
{
  id v2 = [objc_alloc((Class)NSString) initWithFormat:@"isGComplete, %d, pr, %lu, social context count, %@, density score, %@, scan duration, %@", self->_isGComplete, self->_gaPR, self->_pCount, self->_densityScore, self->_densityScanDuration];
