...
+ (BOOL)isIpad
{
  if (isIpad_onceToken != -1) {
    dispatch_once(&isIpad_onceToken, &__block_literal_global_6);
  }
...
+ (void)getHWModel
{
  ...
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Could not get hardware version string", v2, v3, v4, v5, v6);
}

+ (void)getProductType
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Could not get product type", v2, v3, v4, v5, v6);
}

+ (void)getBuildVersion
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Could not get build version", v2, v3, v4, v5, v6);
}

+ (void)getProductVersion
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Could not get product version", v2, v3, v4, v5, v6);
}

void __52__MOPlatformInfo_generativeModelsAvailabilityStatus__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Could not get GMS Availability", v2, v3, v4, v5, v6);
}
