...
- (id)timeZoneObject
{
  ...
  if (v3)
  {
    ...
    id v5 = +[NSTimeZone timeZoneWithName:v4];
  }
  else
  {
    id v5 = 0;
...
- (id)localTime
{
  ...
  else
  {
    ...
    id v5 = [(MOTime *)self timeZoneObject];
    double v6 = +[MOTime localTimeOfDate:v4 timeZone:v5];
  }
...
LABEL_9:
      ...
      while (1)
      {
        ...
        [v15 overlapsScoreForStartDate:v5 endDate:v6];
        double v17 = v16;
        if (v16 > 0.0)
        {
...
+ (void)timeFromStartDate:endDate:timeZoneManager:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_6((void *)&_mh_execute_header, v0, v1, "timeZone, date, %@, timeZone, %@, source, system");
}

+ (void)timetagFromStartDate:endDate:.cold.1()
{
  OUTLINED_FUNCTION_0_8();
  OUTLINED_FUNCTION_3_6((void *)&_mh_execute_header, v0, v1, "timeOfDay, startDate, %@, endDate, %@, skip");
}

+ (void)dayOfWeekFromStartDate:endDate:timeZoneManager:.cold.1()
{
  OUTLINED_FUNCTION_0_8();
  OUTLINED_FUNCTION_3_6((void *)&_mh_execute_header, v0, v1, "timeZone, startDate, %@, timeZone, %@, source, system");
}

+ (void)dayOfWeekFromStartDate:endDate:timeZoneManager:.cold.2()
{
  OUTLINED_FUNCTION_0_8();
  OUTLINED_FUNCTION_3_6((void *)&_mh_execute_header, v0, v1, "timeZone crossing, timeZone, %@, endTimeZone, %@");
}

+ (void)dayOfWeekFromStartDate:endDate:timeZoneManager:.cold.3()
{
  OUTLINED_FUNCTION_0_8();
  OUTLINED_FUNCTION_3_6((void *)&_mh_execute_header, v0, v1, "timeZone, endDate, %@, timeZone, %@, source, system");
}
