...
- (MOEventBundle)initWithBundleIdentifier:(id)a3 suggestionID:(id)a4 startDate:(id)a5 endDate:(id)a6 creationDate:(id)a7
{
  ...
  if (!v14)
  {
    ...
    v24 = v23;
    CFStringRef v25 = @"Invalid parameter not satisfying: bundleIdentifier";
    SEL v26 = a2;
    v27 = self;
    uint64_t v28 = 197;
    goto LABEL_21;
  ...
  if (!v15)
  {
    ...
    v23 = +[NSAssertionHandler currentHandler];
    v24 = v23;
    CFStringRef v25 = @"Invalid parameter not satisfying: suggestionID";
    SEL v26 = a2;
    v27 = self;
    uint64_t v28 = 198;
    goto LABEL_21;
  ...
  if (!v16)
  {
    ...
    v23 = +[NSAssertionHandler currentHandler];
    v24 = v23;
    CFStringRef v25 = @"Invalid parameter not satisfying: startDate";
    SEL v26 = a2;
    v27 = self;
    uint64_t v28 = 199;
    goto LABEL_21;
  ...
  if (!v36)
  {
    ...
    v23 = +[NSAssertionHandler currentHandler];
    v24 = v23;
    CFStringRef v25 = @"Invalid parameter not satisfying: endDate";
    SEL v26 = a2;
    v27 = self;
    uint64_t v28 = 200;
LABEL_21:
...
- (id)description
{
  ...
  SEL v26 = [(MOEventBundle *)self actions];
  CFStringRef v25 = [(MOEventBundle *)self persons];
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        CFStringRef v25 = self->_expirationDate;
        ...
        if (v30 <= 0xA) {
          self->_source |= qword_1002BAF58[v30];
        }
      }
...
LABEL_85:
  ...
  if (v54)
  {
    id v55 = objc_alloc((Class)(p_cache + 398));
...
LABEL_14:
  ...
  id v9 = [(MOEventBundle *)self startDate];
  id v10 = [(MOEventBundle *)self endDate];
  unsigned __int8 v11 = [v9 isOnOrBefore:v10];
  ...
  unsigned __int8 v16 = [v14 isBeforeDate:v15];
...
LABEL_15:
  ...
  id v19 = [(MOEventBundle *)self startDate];
  uint64_t v20 = [(MOEventBundle *)self endDate];
  id v17 = [v18 initWithStartDate:v19 endDate:v20];
...
LABEL_88:
      id v82 = [objc_opt_class() castEvergreenSubType:-[MOEventBundle bundleSubType](v4, "bundleSubType")];
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        unsigned __int8 v11 = *(void **)(*((void *)&v23 + 1) + 8 * i);
        long long v19 = 0u;
        long long v20 = 0u;
        long long v21 = 0u;
        long long v22 = 0u;
        uint64_t v12 = [v5 subBundleIDs];
...
- (id)getCustomLabelsForMetaData:(id)a3 templateFilePath:(id)a4
{
  ...
  id v7 = a3;
  if (v6) {
    id v8 = [[MOEventBundleLabelFormatter alloc] initWithTemplatePath:v6];
  }
  else {
    id v8 = (MOEventBundleLabelFormatter *)objc_opt_new();
  }
  id v9 = v8;
...
- (MOEventBundle)initWithEventBundleMO:(id)a3
{
  ...
  if (v4)
  {
    ...
    self = [(MOEventBundle *)self initWithBundleIdentifier:v6 creationDate:v7];

    id v8 = [v5 suggestionID];
    [(MOEventBundle *)self setSuggestionID:v8];

    id v9 = [v5 endDate];
    [(MOEventBundle *)self setEndDate:v9];

    uint64_t v10 = [v5 startDate];
    [(MOEventBundle *)self setStartDate:v10];

    unsigned __int8 v11 = [v5 firstCreationDate];
    [(MOEventBundle *)self setFirstCreationDate:v11];

    uint64_t v12 = [v5 expirationDate];

    if (v12)
    {
      uint64_t v13 = [v5 expirationDate];
      [(MOEventBundle *)self setExpirationDate:v13];
    }
    else
    {
      uint64_t v13 = [v5 endDate];
      id v15 = [v13 dateByAddingTimeInterval:2419200.0];
      [(MOEventBundle *)self setExpirationDate:v15];
    }
    id v16 = [v5 source];
    -[MOEventBundle setSource:](self, "setSource:", [v16 unsignedIntegerValue]);

    id v17 = [v5 interfaceType];
    -[MOEventBundle setInterfaceType:](self, "setInterfaceType:", [v17 unsignedIntValue]);

    -[MOEventBundle setFiltered:](self, "setFiltered:", [v5 filtered]);
    id v18 = [v5 promptLanguage];
    [(MOEventBundle *)self setPromptLanguage:v18];

    id v19 = [v5 metaDataForRank];
    [(MOEventBundle *)self setMetaDataForRank:v19];

    id v20 = [v5 photoSource];
    -[MOEventBundle setPhotoSource:](self, "setPhotoSource:", [v20 unsignedIntValue]);

    -[MOEventBundle setIsAggregatedAndSuppressed:](self, "setIsAggregatedAndSuppressed:", [v5 isAggregatedAndSuppressed]);
    id v21 = [v5 summarizationGranularity];
    -[MOEventBundle setSummarizationGranularity:](self, "setSummarizationGranularity:", [v21 unsignedIntValue]);

    uint64_t v22 = [v5 subBundleIDs];
    [(MOEventBundle *)self setSubBundleIDs:v22];

    uint64_t v23 = [v5 subSuggestionIDs];
    [(MOEventBundle *)self setSubSuggestionIDs:v23];

    double v24 = [v5 timeAtHomeSubType];
    -[MOEventBundle setTimeAtHomeSubType:](self, "setTimeAtHomeSubType:", [v24 unsignedIntValue]);

    -[MOEventBundle setIncludedInSummaryBundleOnly:](self, "setIncludedInSummaryBundleOnly:", [v5 includedInSummaryBundleOnly]);
    unsigned __int8 v25 = [v5 visitEventsRejectedByWatchLocation];
    [(MOEventBundle *)self setVisitEventsRejectedByWatchLocation:v25];

    id v26 = [v5 bundleSubType];
    -[MOEventBundle setBundleSubType:](self, "setBundleSubType:", [v26 unsignedIntValue]);

    id v27 = [v5 bundleSuperType];
    -[MOEventBundle setBundleSuperType:](self, "setBundleSuperType:", [v27 unsignedIntValue]);
    ...
    long long v127 = 0u;
    long long v128 = 0u;
    long long v29 = [v5 events];
    id v30 = [v29 countByEnumeratingWithState:&v125 objects:v134 count:16];
    if (v30)
    {
      id v31 = v30;
      ...
      do
      {
        for (i = 0; i != v31; i = (char *)i + 1)
        {
          ...
          uint64_t v34 = [[MOEvent alloc] initWithEventMO:*(void *)(*((void *)&v125 + 1) + 8 * i)];
          [v28 addObject:v34];
        }
        id v31 = [v29 countByEnumeratingWithState:&v125 objects:v134 count:16];
      }
      while (v31);
    }
    ...
    {
      long long v36 = [v5 action];

      if (v36)
      {
        long long v37 = [MOAction alloc];
        long long v38 = [v5 action];
        long long v39 = [(MOAction *)v37 initWithActionMO:v38];
    ...
    if (objc_opt_respondsToSelector())
    {
      long long v40 = [v5 concurrentMediaAction];

      if (v40)
      {
        long long v41 = [MOAction alloc];
        long long v42 = [v5 concurrentMediaAction];
        long long v43 = [(MOAction *)v41 initWithActionMO:v42];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      long long v123 = 0u;
      long long v124 = 0u;
      long long v45 = [v5 actions];
      id v46 = [v45 countByEnumeratingWithState:&v121 objects:v133 count:16];
      if (v46)
      {
        id v47 = v46;
        uint64_t v48 = *(void *)v122;
        do
        {
          for (j = 0; j != v47; j = (char *)j + 1)
          {
            ...
            uint64_t v50 = [[MOAction alloc] initWithActionMO:*(void *)(*((void *)&v121 + 1) + 8 * (void)j)];
            [v44 addObject:v50];
          }
          id v47 = [v45 countByEnumeratingWithState:&v121 objects:v133 count:16];
        }
        while (v47);
      }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      long long v119 = 0u;
      long long v120 = 0u;
      uint64_t v53 = [v5 persons];
      id v54 = [v53 countByEnumeratingWithState:&v117 objects:v132 count:16];
      if (v54)
      {
        id v55 = v54;
        ...
        do
        {
          for (k = 0; k != v55; k = (char *)k + 1)
          {
            ...
            long long v58 = [[MOPerson alloc] initWithPersonMO:*(void *)(*((void *)&v117 + 1) + 8 * (void)k)];
            [v52 addObject:v58];
          }
          id v55 = [v53 countByEnumeratingWithState:&v117 objects:v132 count:16];
        }
        while (v55);
      }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      if (v60)
      {
        uint64_t v61 = [MOPlace alloc];
        id v62 = [v5 place];
        uint64_t v63 = [(MOPlace *)v61 initWithPlaceMO:v62];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      long long v115 = 0u;
      long long v116 = 0u;
      uint64_t v65 = [v5 places];
      id v66 = [v65 countByEnumeratingWithState:&v113 objects:v131 count:16];
      if (v66)
      {
        id v67 = v66;
        ...
        do
        {
          for (m = 0; m != v67; m = (char *)m + 1)
          {
            ...
            id v70 = [[MOPlace alloc] initWithPlaceMO:*(void *)(*((void *)&v113 + 1) + 8 * (void)m)];
            [v64 addObject:v70];
          }
          id v67 = [v65 countByEnumeratingWithState:&v113 objects:v131 count:16];
        }
        while (v67);
      }
    ...
    if (objc_opt_respondsToSelector())
    {
      long long v72 = [v5 time];

      if (v72)
      {
        uint64_t v73 = [MOTime alloc];
        id v74 = [v5 time];
        id v75 = [(MOTime *)v73 initWithTimeMO:v74];
    ...
    if (objc_opt_respondsToSelector())
    {
      uint64_t v76 = [v5 predominantWeather];

      if (v76)
      {
        long long v77 = [MOWeather alloc];
        id v78 = [v5 predominantWeather];
        long long v79 = [(MOWeather *)v77 initWithWeatherMO:v78];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      long long v111 = 0u;
      long long v112 = 0u;
      long long v81 = [v5 resources];
      id v82 = [v81 countByEnumeratingWithState:&v109 objects:v130 count:16];
      if (v82)
      {
        id v83 = v82;
        ...
        do
        {
          for (n = 0; n != v83; n = (char *)n + 1)
          {
            ...
            uint64_t v86 = [[MOResource alloc] initWithResourceMO:*(void *)(*((void *)&v109 + 1) + 8 * (void)n)];
            [v80 addObject:v86];
          }
          id v83 = [v81 countByEnumeratingWithState:&v109 objects:v130 count:16];
        }
        while (v83);
      }
    ...
    if (objc_opt_respondsToSelector())
    {
      id v88 = [v5 clusterMetadata];

      if (v88)
      {
        uint64_t v89 = [MOClusterMetadata alloc];
        v90 = [v5 clusterMetadata];
        uint64_t v91 = [(MOClusterMetadata *)v89 initWithClusterMetadataMO:v90];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      long long v107 = 0u;
      long long v108 = 0u;
      uint64_t v93 = [v5 photoTraits];
      id v94 = [v93 countByEnumeratingWithState:&v105 objects:v129 count:16];
      if (v94)
      {
        id v95 = v94;
        ...
        do
        {
          for (ii = 0; ii != v95; ii = (char *)ii + 1)
          {
            ...
            long long v98 = [[MOPhotoTrait alloc] initWithPhotoTraitMO:*(void *)(*((void *)&v105 + 1) + 8 * (void)ii)];
            [v92 addObject:v98];
          }
          id v95 = [v93 countByEnumeratingWithState:&v105 objects:v129 count:16];
        }
        while (v95);
      }
    ...
    if (objc_opt_respondsToSelector())
    {
      long long v100 = [v5 outlierMetadata];

      if (v100)
      {
        long long v101 = [MOOutlierMetadata alloc];
        long long v102 = [v5 outlierMetadata];
        long long v103 = [(MOOutlierMetadata *)v101 initWithOutlierMetadataMO:v102];
...
- (id)primarySourceTypes
{
  ...
  {
    case 1uLL:
      unsigned __int8 v25 = MOEventBundleSourceTypeActivity;
      double v5 = &v25;
      goto LABEL_30;
    case 2uLL:
    case 0xDuLL:
      double v24 = MOEventBundleSourceTypeVisitLocation[0];
      double v5 = &v24;
      goto LABEL_30;
    case 3uLL:
    case 0xAuLL:
      uint64_t v22 = MOEventBundleSourceTypePhoto[0];
      double v5 = &v22;
      goto LABEL_30;
    case 4uLL:
      id v21 = MOEventBundleSourceTypeContact[0];
      double v5 = &v21;
      goto LABEL_30;
    case 5uLL:
      id v20 = MOEventBundleSourceTypeMedia[0];
      double v5 = &v20;
      goto LABEL_30;
    case 7uLL:
      v23[0] = MOEventBundleSourceTypeVisitLocation[0];
      v23[1] = MOEventBundleSourceTypePhoto[0];
      double v5 = (__CFString **)v23;
      goto LABEL_8;
    case 9uLL:
      unint64_t v7 = [(MOEventBundle *)self bundleSubType];
      switch(v7)
      {
        case 0x268uLL:
          id v15 = MOEventBundleSourceTypePhoto[0];
          double v5 = &v15;
          goto LABEL_30;
        case 0x12FuLL:
          id v16 = MOEventBundleSourceTypeContact[0];
          double v5 = &v16;
          goto LABEL_30;
        case 0xCBuLL:
          id v17 = MOEventBundleSourceTypeActivity;
          double v5 = &v17;
          goto LABEL_30;
      }
      id v4 = &__NSArray0__struct;
      goto LABEL_32;
    case 0xBuLL:
      id v19 = MOEventBundleSourceTypeReflectionPrompt[0];
      double v5 = &v19;
      goto LABEL_30;
    case 0xCuLL:
      uint64_t v8 = [(MOEventBundle *)self bundleSubType];
      id v4 = &__NSArray0__struct;
      if (v8 <= 204)
      {
        if ((unint64_t)(v8 - 101) >= 5)
        {
          ...
          uint64_t v13 = MOEventBundleSourceTypeActivity;
          double v5 = &v13;
        }
        else
        {
          id v14 = MOEventBundleSourceTypeVisitLocation[0];
          double v5 = &v14;
        }
        goto LABEL_30;
      }
      ...
      {
        uint64_t v10 = MOEventBundleSourceTypeMedia[0];
        double v5 = &v10;
LABEL_30:
        uint64_t v6 = 1;
        goto LABEL_31;
      ...
      if ((unint64_t)(v8 - 205) >= 2)
      {
        ...
        unsigned __int8 v11 = MOEventBundleSourceTypeContact[0];
        double v5 = &v11;
        goto LABEL_30;
      }
      v12[0] = MOEventBundleSourceTypeActivity;
      v12[1] = MOEventBundleSourceTypeVisitLocation[0];
      double v5 = (__CFString **)v12;
LABEL_8:
      uint64_t v6 = 2;
LABEL_31:
      id v4 = +[NSArray arrayWithObjects:v5 count:v6];
LABEL_32:
      return v4;
    case 0xEuLL:
      id v18 = MOEventBundleSourceTypeStateOfMind[0];
      double v5 = &v18;
      goto LABEL_30;
    default:
      goto LABEL_32;
...
- (void)initWithBundleIdentifier:suggestionID:startDate:endDate:creationDate:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: bundleIdentifier", v2, v3, v4, v5, v6);
}

- (void)initWithBundleIdentifier:suggestionID:startDate:endDate:creationDate:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: suggestionID", v2, v3, v4, v5, v6);
}

- (void)initWithBundleIdentifier:suggestionID:startDate:endDate:creationDate:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: startDate", v2, v3, v4, v5, v6);
}

- (void)initWithBundleIdentifier:suggestionID:startDate:endDate:creationDate:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: endDate", v2, v3, v4, v5, v6);
}

- (void)initWithBundleIdentifier:suggestionID:startDate:endDate:creationDate:.cold.5()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: creationDate", v2, v3, v4, v5, v6);
}
