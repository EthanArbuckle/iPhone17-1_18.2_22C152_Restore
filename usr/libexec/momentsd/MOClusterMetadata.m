...
- (MOClusterMetadata)initWithClusterMetadataMO:(id)a3
{
  if (a3)
  {
    id v3 = a3;
    v25 = [v3 identifier];
    unsigned int v19 = [v3 isFiltered];
    v18 = [v3 phenotype];
    v17 = [v3 topLevelActivityHistogram];
    v16 = [v3 secondLevelActivityHistogram];
    v15 = [v3 activityTypeFromPhotoTraitsHistogram];
    v24 = [v3 timeTagHistogram];
    v23 = [v3 dayOfWeekHistogram];
    v22 = [v3 weekOfYearHistogram];
    v21 = [v3 timeContextFromPhotoTraitsHistogram];
    v20 = [v3 placeNameHistogram];
    v14 = [v3 combinedPlaceTypeHistogram];
    v13 = [v3 enclosingPlaceNameHistogram];
    v12 = [v3 placeTypeFromPhotoTraitsHistogram];
    v4 = [v3 contactNamesHistogram];
    v5 = [v3 personRelationshipHistogram];
    v6 = [v3 socialEventFromPhotoTraitsHistogram];
    v7 = [v3 otherSubjectFromPhotoTraitsHistogram];
    v8 = [v3 subBundleGoodnessScores];
    v9 = [v3 subSuggestionIDsBeforePruning];

    self = objc_retain(-[MOClusterMetadata initWithIdentifier:isFiltered:phenoType:topLevelActivityHistogram:secondLevelActivityHistogram:activityTypeFromPhotoTraitsHistogram:timeTagHistogram:dayOfWeekHistogram:weekOfYearHistogram:timeContextFromPhotoTraitsHistogram:placeNameHistogram:combinedPlaceTypeHistogram:enclosingPlaceNameHistogram:placeTypeFromPhotoTraitsHistogram:contactNamesHistogram:personRelationshipHistogram:socialEventFromPhotoTraitsHistogram:otherSubjectFromPhotoTraitsHistogram:subBundleGoodnessScores:subSuggestionIDsBeforePruning:](self, "initWithIdentifier:isFiltered:phenoType:topLevelActivityHistogram:secondLevelActivityHistogram:activityTypeFromPhotoTraitsHistogram:timeTagHistogram:dayOfWeekHistogram:weekOfYearHistogram:timeContextFromPhotoTraitsHistogram:placeNameHistogram:combinedPlaceTypeHistogram:enclosingPlaceNameHistogram:placeTypeFromPhotoTraitsHistogram:contactNamesHistogram:personRelationshipHistogram:socialEventFromPhotoTraitsHistogram:otherSubjectFromPhotoTraitsHistogram:subBundleGoodnessScores:subSuggestionIDsBeforePruning:", v25, v19, v18, v17, v16, v15, v24, v23, v22, v21, v20, v14,
               v13,
               v12,
               v4,
               v5,
...
- (void)encodeWithCoder:(id)a3
{
  ...
  unsigned int v19 = +[MODictionaryEncoder encodeDictionary:self->_socialEventFromPhotoTraitsHistogram];
...
- (MOClusterMetadata)initWithCoder:(id)a3
{
  ...
  unsigned int v19 = [v3 decodeObjectOfClass:objc_opt_class() forKey:@"socialEventFromPhotoTraitsHistogram"];
  ...
  id v29 = +[MODictionaryEncoder decodeToDictionary:v21];

  uint64_t v22 = objc_opt_class();
  v23 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v22, objc_opt_class(), 0);
  v24 = [v3 decodeObjectOfClasses:v23 forKey:@"subBundleGoodnessScores"];

  uint64_t v25 = objc_opt_class();
  id v26 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v25, objc_opt_class(), 0);
  id v27 = [v3 decodeObjectOfClasses:v26 forKey:@"subSuggestionIDsBeforePruning"];

  id v39 = -[MOClusterMetadata initWithIdentifier:isFiltered:phenoType:topLevelActivityHistogram:secondLevelActivityHistogram:activityTypeFromPhotoTraitsHistogram:timeTagHistogram:dayOfWeekHistogram:weekOfYearHistogram:timeContextFromPhotoTraitsHistogram:placeNameHistogram:combinedPlaceTypeHistogram:enclosingPlaceNameHistogram:placeTypeFromPhotoTraitsHistogram:contactNamesHistogram:personRelationshipHistogram:socialEventFromPhotoTraitsHistogram:otherSubjectFromPhotoTraitsHistogram:subBundleGoodnessScores:subSuggestionIDsBeforePruning:](self, "initWithIdentifier:isFiltered:phenoType:topLevelActivityHistogram:secondLevelActivityHistogram:activityTypeFromPhotoTraitsHistogram:timeTagHistogram:dayOfWeekHistogram:weekOfYearHistogram:timeContextFromPhotoTraitsHistogram:placeNameHistogram:combinedPlaceTypeHistogram:enclosingPlaceNameHistogram:placeTypeFromPhotoTraitsHistogram:contactNamesHistogram:personRelationshipHistogram:socialEventFromPhotoTraitsHistogram:otherSubjectFromPhotoTraitsHistogram:subBundleGoodnessScores:subSuggestionIDsBeforePruning:", v46, v37, v45, v44, v43, v42, v41, v40, v36, v35, v34, v33, v30,
          v32,
          v31,
          v18,
          v20,
