...
- (id)description
{
  ...
  v5 = [(MOPhotoTrait *)self relevantAssetUUIDs];
  v6 = +[NSString stringWithFormat:@"<MOPhotoTrait localIdentifier, %@, name, %@, relevantAssetUUIDs, %@,>", v3, v4, v5];
...
- (MOPhotoTrait)initWithCoder:(id)a3
{
  ...
  id v9 = [v4 decodeObjectOfClasses:v8 forKey:@"relevantAssetUUIDs"];

  id v10 = [(MOPhotoTrait *)self initWithIdentifier:v5 name:v6 relevantAssetUUIDs:v9];
  return v10;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [v5 copy];
  uint64_t v7 = [(MOPhotoTrait *)self name];
  id v8 = [v7 copy];
...
- (MOPhotoTrait)initWithPhotoTraitMO:(id)a3
{
  if (a3)
  {
    ...
    id v5 = [v4 identifier];
    id v6 = [v4 name];
    uint64_t v7 = [v4 relevantAssetUUIDs];

    self = [(MOPhotoTrait *)self initWithIdentifier:v5 name:v6 relevantAssetUUIDs:v7];
    id v8 = self;
  }
  else
  {
