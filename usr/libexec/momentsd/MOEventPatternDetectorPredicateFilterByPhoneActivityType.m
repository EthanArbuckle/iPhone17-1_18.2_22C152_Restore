...
{
  v6.receiver = self;
  v6.super_class = (Class)MOEventPatternDetectorPredicateFilterByPhoneActivityType;
  v2 = [(MOEventPatternDetectorPredicateFilterByPhoneActivityType *)&v6 init];
  v3 = v2;
  if (v2) {
    v4 = v2;
  }
...
- (id)filterEvents:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134217984;
    id v30 = [v6 count];
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "Found %lu phone activity events", buf, 0xCu);
  }
