...
{
  OUTLINED_FUNCTION_1();
  _os_log_error_impl((void *)&_mh_execute_header, v0, OS_LOG_TYPE_ERROR, "loadLabelTemplates from dir, %@", v1, 0xCu);
}
...
- (void)loadLabelTemplatesFromDirectory:(id)a3
{
  ...
  if (v8 && [v8 count])
  {
    ...
    id obj = v8;
    id v70 = v3;
    id v73 = [obj countByEnumeratingWithState:&v116 objects:v130 count:16];
    if (v73)
    {
        ...
        do
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            uint64_t v123 = v11;
            _os_log_debug_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEBUG, "Template file, %@", buf, 0xCu);
          }
          ...
          if (v13 && [v13 count])
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v124 = 2112;
              v125 = v76;
              _os_log_debug_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEBUG, "Template file, %@, dict, %@", buf, 0x16u);
            }
            ...
            long long v115 = 0u;
            id v77 = v15;
            id v81 = [v77 countByEnumeratingWithState:&v112 objects:v129 count:16];
            if (v81)
            {
              v92 = 0;
              v93 = 0;
                ...
                do
                {
                  ...
                  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
                  {
                    *(_DWORD *)buf = 138412546;
                    ...
                    __int16 v124 = 2112;
                    v125 = v17;
                    _os_log_debug_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_DEBUG, "Template file, %@, subdict, %@", buf, 0x16u);
                  }
                  ...
                  v94 = v20;
                  v83 = (void *)v19;
                  v23 = [v17 objectForKeyedSubscript:@"templates" v66];
                  long long v108 = 0u;
                  long long v109 = 0u;
                  long long v110 = 0u;
                  long long v111 = 0u;
                  id v91 = v23;
                  id v96 = [v91 countByEnumeratingWithState:&v108 objects:v128 count:16];
                  if (v96)
                  {
                        ...
                        if (v30 && [v30 count])
                        {
                          ...
                          if (os_log_type_enabled(v45, OS_LOG_TYPE_DEBUG))
                          {
                            *(_DWORD *)buf = 138412802;
                            ...
                            __int16 v126 = 2112;
                            id v127 = v40;
                            _os_log_debug_impl((void *)&_mh_execute_header, v45, OS_LOG_TYPE_DEBUG, "template parsing, labels, %@, conditionStrings, %@, conditions, %@", buf, 0x20u);
                          }
                        ...
                        if (v32 && [v32 count])
                        {
                          ...
                          if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
                          {
                            *(_DWORD *)buf = 138412802;
                            ...
                            __int16 v126 = 2112;
                            id v127 = v40;
                            _os_log_debug_impl((void *)&_mh_execute_header, v47, OS_LOG_TYPE_DEBUG, "template parsing, prompts, %@, conditionStrings, %@, conditions, %@", buf, 0x20u);
                          }
                  ...
                  if (os_log_type_enabled(v51, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_DWORD *)buf = 138412802;
                    ...
                    __int16 v126 = 2048;
                    id v127 = v60;
                    _os_log_debug_impl((void *)&_mh_execute_header, v51, OS_LOG_TYPE_DEBUG, "Template file, %@, key, %@, templates.count, %lu", buf, 0x20u);
                  }
                  ...
                  if (os_log_type_enabled(v52, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_DWORD *)buf = 138412802;
                    ...
                    __int16 v126 = 2048;
                    id v127 = v61;
                    _os_log_debug_impl((void *)&_mh_execute_header, v52, OS_LOG_TYPE_DEBUG, "Template file, %@, key, %@, templates.count, %lu", buf, 0x20u);
                  }
                  ...
                  long long v105 = 0u;
                  id v53 = v89;
                  id v54 = [v53 countByEnumeratingWithState:&v104 objects:v121 count:16];
                  if (v54)
                  {
                    id v55 = v54;
                      ...
                      for (j = 0; j != v55; j = (char *)j + 1)
                      {
                        ...
                        if (os_log_type_enabled(v59, OS_LOG_TYPE_DEBUG))
                        {
                          *(_DWORD *)buf = 138412802;
                          ...
                          __int16 v126 = 2112;
                          id v127 = v58;
                          _os_log_debug_impl((void *)&_mh_execute_header, v59, OS_LOG_TYPE_DEBUG, "Template file, %@, key, %@, flattened template, %@", buf, 0x20u);
                        }
                      }
                      id v55 = [v53 countByEnumeratingWithState:&v104 objects:v121 count:16];
                    }
                    while (v55);
                  }
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412802;
            ...
            __int16 v126 = 2048;
            id v127 = v93;
            _os_log_debug_impl((void *)&_mh_execute_header, v62, OS_LOG_TYPE_DEBUG, "Template file, %@, label.count, %lu, prompts.count, %lu", buf, 0x20u);
          }
...
- (id)loadDictionaryFromPath:(id)a3
{
  ...
  id v13 = 0;
  objc_super v8 = +[NSJSONSerialization JSONObjectWithData:v4 options:0 error:&v13];
  id v9 = v13;
...
LABEL_13:
  ...
  {
    *(_WORD *)v12 = 0;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "The json file was successfully read.", v12, 2u);
  }
LABEL_14:
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v26 = v13;
          _os_log_debug_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_DEBUG, "template, %@", buf, 0xCu);
        }
...
- (id)shuffleStrings:(id)a3 shuffleMode:(unint64_t)a4
{
  ...
  if (v5 && [v5 count])
  {
    if (a4 == 1)
    {
      ...
      unint64_t v10 = v9 % (unint64_t)[v6 count];
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v22 = 2112;
        long long v23 = v7;
        _os_log_debug_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_DEBUG, "Shuffle Labels: count, %lu, seed, %lu, start_index, %lu, nowDate, %@", (uint8_t *)&v16, 0x2Au);
      }

      if (v10)
      {
        id v12 = (id)objc_opt_new();
        id v13 = [v6 subarrayWithRange:v10, (char *)[v6 count] - v10];
        [v12 addObjectsFromArray:v13];

        id v14 = [v6 subarrayWithRange:0, v10];
...
- (id)formattedStringsForMetaData:(id)a3 templateType:(id)a4 bundleType:(id)a5
{
  ...
  else
  {
    if ([v9 isEqualToString:@"prompts"]) {
      CFStringRef v15 = @"default_prompt";
    }
    else {
      CFStringRef v15 = @"default_label";
    }
    ...
    {
      uint64_t v29 = v16;
      id v14 = +[NSArray arrayWithObjects:&v29 count:1];
    }
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v27 = 2112;
        uint64_t v28 = v22;
        _os_log_error_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_ERROR, "The label template is not found for the keyword, %@, meta, %@, all keywords, %@", (uint8_t *)&v23, 0x20u);
      }
      id v14 = 0;
    }
  }
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "The template directory is empty.", v2, v3, v4, v5, v6);
}

- (void)loadLabelTemplatesFromDirectory:.cold.2()
{
  OUTLINED_FUNCTION_1();
  _os_log_debug_impl((void *)&_mh_execute_header, v0, OS_LOG_TYPE_DEBUG, "load templates from %@", v1, 0xCu);
}

- (void)loadDictionaryFromPath:.cold.1()
{
  OUTLINED_FUNCTION_1();
  _os_log_error_impl((void *)&_mh_execute_header, v0, OS_LOG_TYPE_ERROR, "Could not read to the JSON file, error: %@", v1, 0xCu);
}
...
{
  OUTLINED_FUNCTION_1();
  _os_log_debug_impl((void *)&_mh_execute_header, v0, OS_LOG_TYPE_DEBUG, "keyword, %@", v1, 0xCu);
}
