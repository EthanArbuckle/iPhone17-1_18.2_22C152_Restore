...
- (MOEventSharedWithYou)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_itemSyndicationStatus = (unint64_t)[v4 decodeIntegerForKey:@"itemSyndicationStatus"];
...
- (id)description
{
  ...
  id v8 = [v3 initWithFormat:@"itemURL, %@, itemIsPinned, %@, itemShareDirection, %lu, itemAttributionsCount, %@", v5, v7, self->_itemShareDirection, self->_itemAttributionsCount];
