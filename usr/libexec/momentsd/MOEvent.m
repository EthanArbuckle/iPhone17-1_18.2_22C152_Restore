...
- (MOEvent)initWithEventIdentifier:(id)a3 startDate:(id)a4 endDate:(id)a5 creationDate:(id)a6 provider:(unint64_t)a7 category:(unint64_t)a8
{
  ...
  if (!v16)
  {
    ...
    v32 = v31;
    CFStringRef v33 = @"Invalid parameter not satisfying: eventIdentifier";
    SEL v34 = a2;
    v35 = self;
    uint64_t v36 = 31;
    goto LABEL_20;
  ...
  if (!v17)
  {
    ...
    v31 = +[NSAssertionHandler currentHandler];
    v32 = v31;
    CFStringRef v33 = @"Invalid parameter not satisfying: startDate";
    SEL v34 = a2;
    v35 = self;
    uint64_t v36 = 32;
    goto LABEL_20;
  ...
  if (!v18)
  {
    ...
    v31 = +[NSAssertionHandler currentHandler];
    v32 = v31;
    CFStringRef v33 = @"Invalid parameter not satisfying: endDate";
    SEL v34 = a2;
    v35 = self;
    uint64_t v36 = 33;
    goto LABEL_20;
  ...
  if (!v19)
  {
    ...
    v31 = +[NSAssertionHandler currentHandler];
    v32 = v31;
    CFStringRef v33 = @"Invalid parameter not satisfying: creationDate";
    SEL v34 = a2;
    v35 = self;
    uint64_t v36 = 34;
LABEL_20:
...
{
  if (a3 >= 0xC) {
    v3 = (__CFString *)[objc_alloc((Class)NSString) initWithFormat:@"Unknown (%lu)", a3];
  }
  else {
    v3 = off_1002C9DC8[a3];
  }
...
- (unint64_t)photoMomentSource
{
  ...
  if (result) {
    return (unint64_t)[(id)result photoMomentSource];
  }
  return result;
}
...
- (unint64_t)photoMemoryCategory
{
  unint64_t result = (unint64_t)self->_photoEvent;
  if (result) {
    return (unint64_t)[(id)result photoMemoryCategory];
  }
  return result;
}
...
- (unint64_t)timeAtHomeSubType
{
  ...
  if (result) {
    return (unint64_t)[(id)result timeAtHomeSubType];
  }
  return result;
}
...
- (unint64_t)placeType
{
  ...
  if (result) {
    return (unint64_t)[(id)result placeType];
  }
  return result;
}
...
- (unint64_t)placeUserType
{
  unint64_t result = (unint64_t)self->_routineEvent;
  if (result) {
    return (unint64_t)[(id)result placeUserType];
  }
  return result;
}
...
- (unint64_t)placeDiscovery
{
  unint64_t result = (unint64_t)self->_routineEvent;
  if (result) {
    return (unint64_t)[(id)result placeDiscovery];
  }
  return result;
}
...
- (unint64_t)mode
{
  unint64_t result = (unint64_t)self->_routineEvent;
  if (result) {
    return (unint64_t)[(id)result mode];
  }
  return result;
}
...
- (unint64_t)placeSource
{
  unint64_t result = (unint64_t)self->_routineEvent;
  if (result) {
    return (unint64_t)[(id)result placeSource];
  }
  return result;
}
...
- (unint64_t)suggestedEventCategory
{
  ...
  if (result) {
    return (unint64_t)[(id)result suggestedEventCategory];
  }
  return result;
}
...
- (unint64_t)itemShareDirection
{
  ...
  if (result) {
    return (unint64_t)[(id)result itemShareDirection];
  }
  return result;
}
...
- (unint64_t)motionType
{
  ...
  if (result) {
    return (unint64_t)[(id)result motionType];
  }
  return result;
}
...
- (unint64_t)lifeEventCategory
{
  ...
  if (result) {
    return (unint64_t)[(id)result lifeEventCategory];
  }
  return result;
}
...
- (id)description
{
  if ((id)[(MOEvent *)self provider] == (id)5)
  {
...
LABEL_3:
  ...
  {
    v13 = (char *)[(MOEvent *)self category] - 1;
    analyticsEvent = 0;
...
- (MOEvent)initWithCoder:(id)a3
{
  ...
  else
  {
    ...
    if (v14)
    {
      ...
      v15->_rehydrationFailCount = (unint64_t)[v4 decodeIntegerForKey:@"rehydrationFailCount"];
...
- (id)copy
{
  ...
  v9 = (MOEventPhoto *)[(MOEventPhoto *)self->_photoEvent copy];
  photoEvent = v8->_photoEvent;
  v8->_photoEvent = v9;

  v11 = (MOEventRoutine *)[(MOEventRoutine *)self->_routineEvent copy];
  routineEvent = v8->_routineEvent;
  v8->_routineEvent = v11;

  v13 = (MOEventWorkout *)[(MOEventWorkout *)self->_workoutEvent copy];
  workoutEvent = v8->_workoutEvent;
  v8->_workoutEvent = v13;

  v15 = (MOEventProactiveSuggested *)[(MOEventProactiveSuggested *)self->_proactiveSuggestedEvent copy];
  proactiveSuggestedEvent = v8->_proactiveSuggestedEvent;
  v8->_proactiveSuggestedEvent = v15;

  id v17 = (MOEventTravel *)[(MOEventTravel *)self->_travelEvent copy];
  travelEvent = v8->_travelEvent;
  v8->_travelEvent = v17;

  id v19 = (MOEventMedia *)[(MOEventMedia *)self->_mediaEvent copy];
  mediaEvent = v8->_mediaEvent;
  v8->_mediaEvent = v19;

  v21 = (MOEventSharedWithYou *)[(MOEventSharedWithYou *)self->_sharedWithYouEvent copy];
  sharedWithYouEvent = v8->_sharedWithYouEvent;
  v8->_sharedWithYouEvent = v21;

  v23 = (MOEventSignificantContact *)[(MOEventSignificantContact *)self->_significantContactEvent copy];
  significantContactEvent = v8->_significantContactEvent;
  v8->_significantContactEvent = v23;

  v25 = (MOEventPeopleDiscovery *)[(MOEventPeopleDiscovery *)self->_peopleDiscoveryEvent copy];
  peopleDiscoveryEvent = v8->_peopleDiscoveryEvent;
  v8->_peopleDiscoveryEvent = v25;

  v27 = (MOEventPortrait *)[(MOEventPortrait *)self->_portraitEvent copy];
  portraitEvent = v8->_portraitEvent;
  v8->_portraitEvent = v27;

  v29 = (MOEventMotionActivity *)[(MOEventMotionActivity *)self->_motionActivityEvent copy];
  motionActivityEvent = v8->_motionActivityEvent;
  v8->_motionActivityEvent = v29;

  v31 = (MOEventAnalytics *)[(MOEventAnalytics *)self->_analyticsEvent copy];
  analyticsEvent = v8->_analyticsEvent;
  v8->_analyticsEvent = v31;

  CFStringRef v33 = (MOEventLifeEvents *)[(MOEventLifeEvents *)self->_lifeEventsEvent copy];
  lifeEventsEvent = v8->_lifeEventsEvent;
  v8->_lifeEventsEvent = v33;

  v35 = (MOEventStateOfMind *)[(MOEventStateOfMind *)self->_stateOfMindEvent copy];
...
- (BOOL)isHomeWorkVisit
{
  ...
  if (v3 != 1)
  {
    if ((id)[(MOEvent *)self placeUserType] == (id)2)
    {
      LOBYTE(v3) = 1;
      return v3;
    }
...
- (id)formatAddressWithFormatOption:(id)a3
{
  ...
  else
  {
    ...
    [v8 handleFailureInMethod:a2 object:self file:@"MOEvent.m" lineNumber:1736 description:@"request formatAddressWithFormatOption on non routine event instance (in %s:%d)", "-[MOEvent formatAddressWithFormatOption:]", 1736];
...
- (id)formatLocalityWithFormatOption:(id)a3
{
  ...
  else
  {
    ...
    uint64_t v8 = +[NSAssertionHandler currentHandler];
    [v8 handleFailureInMethod:a2 object:self file:@"MOEvent.m" lineNumber:1745 description:@"request formatLocalityWithFormatOption on non routine event instance (in %s:%d)", "-[MOEvent formatLocalityWithFormatOption:]", 1745];
...
- (id)formatAdministrativeAreaWithFormatOption:(id)a3
{
  ...
  else
  {
    ...
    uint64_t v8 = +[NSAssertionHandler currentHandler];
    [v8 handleFailureInMethod:a2 object:self file:@"MOEvent.m" lineNumber:1754 description:@"request formatLocalityWithFormatOption on non routine event instance (in %s:%d)", "-[MOEvent formatAdministrativeAreaWithFormatOption:]", 1754];
...
- (id)formatCountryWithFormatOption:(id)a3
{
  ...
  else
  {
    ...
    uint64_t v8 = +[NSAssertionHandler currentHandler];
    [v8 handleFailureInMethod:a2 object:self file:@"MOEvent.m" lineNumber:1763 description:@"request formatCountryWithFormatOption on non routine event instance (in %s:%d)", "-[MOEvent formatCountryWithFormatOption:]", 1763];
...
- (double)weightedDurationWithTimeZone:(id)a3
{
  [(MOEvent *)self weightedDurationWithTimeZone:a3 overnightStartDateHour:0.0 overnightDurationHours:6.0 overnightDurationWeight:0.1];
  return result;
}
...
{
  id v10 = a3;
  unsigned __int8 v11 = [(MOEvent *)self endDate];

  double v12 = 0.0;
  if (v11)
  {
    v13 = [(MOEvent *)self startDate];
    v14 = [(MOEvent *)self endDate];
    unsigned __int8 v15 = [v13 isAfterDate:v14];

    if ((v15 & 1) == 0)
    {
      uint64_t v16 = [(MOEvent *)self startDate];
      id v17 = +[MOTime localTimeOfDate:v16 timeZone:v10];

      uint64_t v18 = [(MOEvent *)self endDate];
      id v19 = +[MOTime localTimeOfDate:v18 timeZone:v10];

      id v20 = [objc_alloc((Class)NSDateInterval) initWithStartDate:v17 endDate:v19];
      v21 = [v17 startOfDayWithBoundaryOfADay:10800.0];
      uint64_t v22 = [v21 dateByAddingTimeInterval:86400.0];

      if ([v20 containsDate:v22])
      {
        v23 = +[MOTime dateFromDate:v17 hour:(uint64_t)a4];
        if ([v23 isBeforeDate:v17])
        {
          uint64_t v24 = [v23 dateByAddingTimeInterval:86400.0];
        ...
        {
          double v28 = a5 * 3600.0;
          v29 = v25;
          do
          {
            id v30 = [objc_alloc((Class)NSDateInterval) initWithStartDate:v29 duration:v28];
...
- (MOEvent)initWithEventMO:(id)a3
{
  ...
  {
    id v4 = a3;
    double v5 = [v4 eventIdentifier];
    double v6 = [v4 startDate];
    v7 = [v4 endDate];
    uint64_t v8 = [v4 creationDate];
    v9 = [v4 provider];
    id v10 = [v9 unsignedIntegerValue];
    unsigned __int8 v11 = [v4 category];
    self = -[MOEvent initWithEventIdentifier:startDate:endDate:creationDate:provider:category:](self, "initWithEventIdentifier:startDate:endDate:creationDate:provider:category:", v5, v6, v7, v8, v10, [v11 unsignedIntegerValue]);

    double v12 = [v4 sourceCreationDate];
    [(MOEvent *)self setSourceCreationDate:v12];

    v13 = [v4 expirationDate];
    [(MOEvent *)self setExpirationDate:v13];

    v14 = [v4 mode];
    -[MOEvent setMode:](self, "setMode:", [v14 unsignedIntValue]);

    -[MOEvent setIsInvalid:](self, "setIsInvalid:", [v4 isInvalid]);
    -[MOEvent setIsHighConfidence:](self, "setIsHighConfidence:", [v4 isHighConfidence]);
    unsigned __int8 v15 = [v4 identifierFromProvider];
    [(MOEvent *)self setIdentifierFromProvider:v15];

    uint64_t v16 = [v4 trends];
    [(MOEvent *)self setTrends:v16];

    id v17 = [v4 patterns];
    [(MOEvent *)self setPatterns:v17];

    -[MOEvent setIsGComplete:](self, "setIsGComplete:", [v4 isGatheringComplete]);
    uint64_t v18 = [v4 timeAtHomeSubType];
    -[MOEvent setTimeAtHomeSubType:](self, "setTimeAtHomeSubType:", [v18 unsignedIntegerValue]);

    id v19 = [v4 rehydrationFailCount];

    -[MOEvent setRehydrationFailCount:](self, "setRehydrationFailCount:", [v19 unsignedIntegerValue]);
    id v20 = self;
  }
  else
  {
...
- (void)initWithEventIdentifier:startDate:endDate:creationDate:provider:category:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: eventIdentifier", v2, v3, v4, v5, v6);
}
...
- (void)formatAddressWithFormatOption:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2_0((void *)&_mh_execute_header, v0, v1, "request formatAddressWithFormatOption on non routine event instance (in %s:%d)", v2, v3, v4, v5, v6);
}

- (void)formatLocalityWithFormatOption:.cold.1()
{
  OUTLINED_FUNCTION_0_5();
  OUTLINED_FUNCTION_2_0((void *)&_mh_execute_header, v0, v1, "request formatLocalityWithFormatOption on non routine event instance (in %s:%d)", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_0_5();
  OUTLINED_FUNCTION_2_0((void *)&_mh_execute_header, v0, v1, "request formatCountryWithFormatOption on non routine event instance (in %s:%d)", v2, v3, v4, v5, v6);
}
