  ...
  if ([v2 count])
  {
    ...
    if ((v6 & 1) != 0
      || (+[NSFileManager defaultManager],
          ...
          id v14 = 0,
          unsigned int v8 = [v7 createDirectoryAtPath:v4 withIntermediateDirectories:1 attributes:0 error:&v14], v9 = v14, v7, v8)&& !v9)
    {
...
+ (id)userDataDumpDirectoryPathWithSuffix:(id)a3
{
  ...
  {
    v5 = [v4 firstObject];
    unsigned __int8 v6 = [v5 stringByAppendingPathComponent:@"com.apple.momentsd"];
    v7 = [v6 stringByAppendingPathComponent:@"Temp"];
    unsigned int v8 = [v7 stringByAppendingPathComponent:v3];
    ...
    id v17 = 0;
    unsigned int v12 = [v11 createDirectoryAtPath:v8 withIntermediateDirectories:1 attributes:0 error:&v17];
    id v13 = v17;
