...
- (MOOutlierMetadata)initWithOutlierMetadataMO:(id)a3
{
  if (a3)
  {
    ...
    id v5 = [v4 identifier];
    v6 = [v4 updatedDate];
    id v7 = [v4 isSignificant];
    [v4 outlierScore];
    double v9 = v8;
    [v4 outlierScoreThreshold];
    double v11 = v10;
    [v4 bundleGoodnessScore];
    double v13 = v12;
    [v4 bundleGoodnessScoreThreshold];
    double v15 = v14;

    self = [(MOOutlierMetadata *)self initWithIdentifier:v5 updateDate:v6 isSignificant:v7 outlierScore:v9 outlierScoreThreshold:v11 bundleGoodnessScore:v13 bundleGoodnessScoreThreshold:v15];
    v16 = self;
  }
  else
  {
