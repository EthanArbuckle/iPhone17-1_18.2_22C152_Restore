...
LABEL_25:
  ...
  if ([v4 count])
  {
    v22 = [v4 keysOfEntriesPassingTest:&__block_literal_global_12];
    if (![v22 count]) {
      goto LABEL_41;
    }
    if ([v22 containsObject:&off_1002F4E20]) {
      goto LABEL_44;
    }
    if ([v22 containsObject:&off_1002F4E38]) {
      goto LABEL_29;
    }
    if ([v22 containsObject:&off_1002F4E50])
    {
LABEL_37:
      unint64_t v23 = 21;
      goto LABEL_45;
    }
    if ([v22 containsObject:&off_1002F4E68])
    {
      unint64_t v23 = 22;
      goto LABEL_45;
    }
    if ([v22 containsObject:&off_1002F4E08])
    {
LABEL_42:
      unint64_t v23 = 4;
      goto LABEL_45;
...
LABEL_41:
    v24 = [v4 objectForKey:&off_1002F4E08];

    if (v24) {
      goto LABEL_42;
    }
    v25 = [v4 objectForKey:&off_1002F4E20];
...
LABEL_44:
    ...
    v27 = [v4 objectForKey:&off_1002F4E38];
...
LABEL_29:
    ...
    {
      v28 = [v4 objectForKey:&off_1002F4E50];

      if (v28) {
        goto LABEL_37;
      }
      v29 = [v4 objectForKey:&off_1002F4E68];
...
+ (void)getTheBestPersonRelationtshipTagFor:(void *)a1 .cold.1(void *a1)
{
  v1 = [a1 name];
  v2 = [v1 mask];
  OUTLINED_FUNCTION_0_11((void *)&_mh_execute_header, v3, v4, "No personalRelationship is available for person %@", v5, v6, v7, v8, 2u);
}
...
+ (void)getTheBestPersonRelationtshipTagFor:(void *)a1 .cold.2(void *a1)
{
  v1 = [a1 name];
  v2 = [v1 mask];
  OUTLINED_FUNCTION_0_11((void *)&_mh_execute_header, v3, v4, "None of personalRelationships are confident enough to generate the best relationship tag for person %@", v5, v6, v7, v8, 2u);
}
