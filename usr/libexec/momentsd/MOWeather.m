...
- (MOWeather)initWithWeatherMO:(id)a3
{
  ...
  if (v4)
  {
    v6 = [v4 weatherIdentifier];
    v7 = [v5 startDate];
    v8 = [v5 endDate];
    v9 = [v5 weatherSummary];
    v10 = [v5 weatherSymbolName];
    v11 = [v5 temperature];
    v12 = [v5 windSpeed];
    self = [(MOWeather *)self initWithWeatherIdentifier:v6 startDate:v7 endDate:v8 weatherSummary:v9 weatherSymbolName:v10 temperature:v11 windSpeed:v12];
    ...
    if (v13)
    {
      ...
      [(MOWeather *)self setSourceEventIdentifier:v14];
    }
...
- (id)description
{
  ...
  id v4 = [(MOWeather *)self startDate];
