...
+ (id)onboardingDateKey:(id)a3
{
  ...
  id v4 = a3;
  if (v3 != -1) {
    dispatch_once(&onboardingDateKey__onceToken, &__block_literal_global_4);
  }
...
void __64__MODefaultsManager_MOEventBundleSourceType__onboardingDateKey___block_invoke(id a1)
{
  v3[0] = MOEventBundleSourceTypeMedia[0];
  v3[1] = MOEventBundleSourceTypePhoto[0];
  v4[0] = @"OnboardingEarliestCollectDateMedia";
  v4[1] = @"OnboardingEarliestCollectDatePhoto";
  v3[2] = MOEventBundleSourceTypeContact[0];
  ...
  v3[4] = MOEventBundleSourceTypeVisitLocation[0];
  v3[5] = MOEventBundleSourceTypeThirdPartyMedia[0];
  v4[4] = @"OnboardingEarliestCollectDateLocation";
  v4[5] = @"OnboardingEarliestCollectDateMedia";
  v3[6] = MOEventBundleSourceTypePeopleContext[0];
  v3[7] = MOEventBundleSourceTypeStateOfMind[0];
  ...
  v2 = (void *)onboardingDateKey__mapping;
...
- (void)objectForKey:.cold.2()
{
  ...
  OUTLINED_FUNCTION_2_0((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: key (in %s:%d)", v2, v3, v4, v5, v6);
}
