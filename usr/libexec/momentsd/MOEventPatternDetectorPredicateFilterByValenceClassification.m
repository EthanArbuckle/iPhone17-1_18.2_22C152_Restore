...
{
  v6.receiver = self;
  v6.super_class = (Class)MOEventPatternDetectorPredicateFilterByValenceClassification;
...
- (id)filterEvents:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134217984;
    id v30 = [v6 count];
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "Found %lu state of mind events", buf, 0xCu);
  }
    ...
    if (v8)
    {
      ...
      do
      {
        for (i = 0; i != v9; i = (char *)i + 1)
        {
          ...
          v13 = +[NSPredicate predicateWithFormat:@"stateOfMindEvent.valenceClassification == %@", *(void *)(*((void *)&v23 + 1) + 8 * i)];
