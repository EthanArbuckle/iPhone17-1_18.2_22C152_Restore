...
- (MOPerson)initWithPersonMO:(id)a3
{
  ...
  if (v4)
  {
      ...
      if (v7)
      {
        ...
        do
        {
          for (i = 0; i != v8; i = (char *)i + 1)
          {
            ...
            v11 = [[MOPersonRelationship alloc] initWithPersonRelationshipMO:*(void *)(*((void *)&v27 + 1) + 8 * i)];
            [v5 addObject:v11];
          }
    ...
    v12 = [v4 identifier];
    v13 = [v4 name];
    v14 = [v4 contactIdentifier];
    id v15 = [v4 isPHPersonTypeImportant];
    id v16 = [v4 isMePerson];
    unsigned __int8 v17 = [v4 mePersonIdentified];
    id v18 = [v5 copy];
    [v4 priorityScore];
    double v20 = v19;
    [v4 significanceScore];
    LOBYTE(v26) = v17;
    self = [(MOPerson *)self initWithLocalIdentifier:v12 name:v13 contactIdentifier:v14 family:&stru_1002D2AC8 isPHPersonTypeImportant:v15 isMePerson:v16 mePersonIdentified:v20 personRelationships:v21 priorityScore:v26 significanceScore:v18];

    v22 = [v4 sourceEventIdentifier];

    if (v22)
    {
      v23 = [v4 sourceEventIdentifier];
      [(MOPerson *)self setSourceEventIdentifier:v23];
    }
    if ([v4 sourceEventAccessType]) {
      -[MOPerson setSourceEventAccessType:](self, "setSourceEventAccessType:", [v4 sourceEventAccessType]);
    }
...
- (MOPerson)initWithLocalIdentifier:(id)a3 name:(id)a4 contactIdentifier:(id)a5 family:(id)a6 isPHPersonTypeImportant:(BOOL)a7 isMePerson:(BOOL)a8 mePersonIdentified:(BOOL)a9 personRelationships:(id)a10 priorityScore:(double)a11 significanceScore:(double)a12
{
  ...
  if (v25)
  {
    uint64_t v26 = (NSString *)[v20 copy];
    localIdentifier = v25->_localIdentifier;
    v25->_localIdentifier = v26;

    long long v28 = (NSString *)[v21 copy];
    name = v25->_name;
    v25->_name = v28;

    long long v30 = (NSString *)[v22 copy];
...
- (MOPerson)initWithPersonDictionary:(id)a3
{
  ...
  id v7 = [v4 objectForKey:@"contactIdentifier"];
  id v8 = [v4 objectForKey:@"family"];
  ...
  id v15 = [v4 objectForKey:@"isPHPersonTypeImportant"];
  id v16 = [v15 BOOLValue];

  unsigned __int8 v17 = [v4 objectForKey:@"isMePerson"];
  id v18 = [v17 BOOLValue];

  double v19 = [v4 objectForKey:@"mePersonIdentified"];
...
- (id)description
{
  ...
  id v15 = +[NSString stringWithFormat:@"<MOPerson localIdentifier, %@, name, %@, contactIdentifier, %@, isPHPersonTypeImportant, %d, isMePerson, %d, mePersonIdentified, %d, peopleClassification, %@, family, %@, significanceScore, %.1f, priorityScore, %.1f>", v3, v5, v6, v7, v8, v9, v10, v11, v13, v14];
...
- (MOPerson)initWithCoder:(id)a3
{
  ...
  LOBYTE(v20) = v10;
  unsigned __int8 v17 = [(MOPerson *)self initWithLocalIdentifier:v4 name:v5 contactIdentifier:v6 family:v7 isPHPersonTypeImportant:v8 isMePerson:v9 mePersonIdentified:v15 personRelationships:v16 priorityScore:v20 significanceScore:v13];
  if (v17)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    unsigned __int8 v17 = [(MOPerson *)self name];
    if (v17)
    {
