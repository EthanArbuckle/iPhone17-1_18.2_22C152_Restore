...
+ (void)initialize
{
  if (qword_10247AB08 != -1) {
    dispatch_once(&qword_10247AB08, &stru_1022B3340);
  }
}

+ (id)knownHosts
{
  return [(id)qword_10247AB10 allKeys];
}

+ (int)URLSession:(id)a3 didReceiveChallenge:(id)a4 completionHandler:(id)a5
{
  if (![[[a4 protectionSpace] authenticationMethod] isEqualToString:NSURLAuthenticationMethodServerTrust])goto LABEL_18; {
  id v7 = [[objc_msgSend(a4, "protectionSpace") host];
  }
  v8 = (__SecTrust *)[objc_msgSend(a4, "protectionSpace") serverTrust];
  v9 = (NSNull *)[(id)qword_10247AB10 objectForKeyedSubscript:v7];
  if (v9)
  {
    v10 = v9;
    if (v9 == +[NSNull null])
    {
      if (qword_102419600 != -1) {
        dispatch_once(&qword_102419600, &stru_1022B3360);
      }
      v20 = qword_102419608;
...
LABEL_21:
  ...
  {
    [objc_msgSend(objc_msgSend(a4, "protectionSpace"), "serverTrust") credentialForTrust:];
  }
  else
  {
