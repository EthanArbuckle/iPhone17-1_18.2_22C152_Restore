...
- (void)dealloc
{
  [(ALSScdmaCellTower *)self setLocation:0];
  v3.receiver = self;
  v3.super_class = (Class)ALSScdmaCellTower;
  [(ALSScdmaCellTower *)&v3 dealloc];
}
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)ALSScdmaCellTower;
  return +[NSString stringWithFormat:@"%@ %@", [(ALSScdmaCellTower *)&v3 description], [(ALSScdmaCellTower *)self dictionaryRepresentation]];
}
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    [v3 setObject:[NSNumber numberWithInt:self->_arfcn] forKey:@"arfcn"];
    char has = (char)self->_has;
  }
  if ((has & 2) != 0) {
...
- (BOOL)readFrom:(id)a3
{
  return sub_1013D6054((uint64_t)self, (uint64_t)a3);
}
