...
+ (id)getSilo
{
  if (qword_102487018 != -1) {
    dispatch_once(&qword_102487018, &stru_10231FEC0);
  }
  return (id)qword_102487010;
}
...
- (CLBatchedDeviceMotionService)init
{
  ...
  v2 = [(CLBatchedSensorService *)&v10 initWithClientProtocol:&OBJC_PROTOCOL___CLBatchedDeviceMotionServiceClientProtocol];
  v3 = v2;
  if (v2)
  {
    ...
    if (byte_102487007 < 0)
    {
      sub_1000DC48C(__p, (void *)xmmword_102486FF0, *((unint64_t *)&xmmword_102486FF0 + 1));
    }
    else
    {
      *(_OWORD *)__p = xmmword_102486FF0;
      uint64_t v8 = unk_102487000;
    }
    int v9 = dword_102487008;
    v6.receiver = v3;
...
- (void)registerForData:(id)a3
{
  if (!self->super._info.name.var0)
  {
    ...
    if (qword_102419310 != -1) {
      dispatch_once(&qword_102419310, &stru_10231FEE0);
    }
    ...
    if (sub_10013D1A0(115, 2))
    {
      ...
      v9.receiver = self;
      v9.super_class = (Class)CLBatchedDeviceMotionService;
      ...
      sub_1004BA5E4("Generic", 1, 0, 2, "-[CLBatchedDeviceMotionService registerForData:]", "%s\n", v7);
      if (v7 != (char *)__p) {
        free(v7);
      }
    }
...
- (void)onBatchedData:(void *)a3 N:(int)a4
{
  ...
  {
    v22.receiver = self;
    v22.super_class = (Class)CLBatchedDeviceMotionService;
  ...
  if (sub_10013D1A0(115, 2))
  {
    ...
    v21.receiver = self;
    v21.super_class = (Class)CLBatchedDeviceMotionService;
    ...
    sub_1004BA5E4("Generic", 1, 0, 2, "-[CLBatchedDeviceMotionService onBatchedData:N:]", "%s\n", v15);
    if (v15 != (char *)__p) {
      free(v15);
    }
  }
  objc_super v9 = [[CLBatchedDeviceMotionBufferWrapper alloc] initWithMovedBuffer:a3];
  long long v19 = 0u;
  long long v20 = 0u;
  long long v17 = 0u;
  long long v18 = 0u;
  v16.receiver = self;
  v16.super_class = (Class)CLBatchedDeviceMotionService;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        [*(id *)(*((void *)&v17 + 1) + 8 * i) onBatchedDeviceMotionData:v9];
      }
      id v11 = [(NSMutableSet *)v10 countByEnumeratingWithState:&v17 objects:v23 count:16];
    }
    while (v11);
