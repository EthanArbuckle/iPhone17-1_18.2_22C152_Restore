...
- (CLBatchedSensorSubscriptionAdapter)initWithBatchedSensorSubscription:(void *)a3
{
  ...
  result = [(CLBatchedSensorSubscriptionAdapter *)&v5 init];
  if (result) {
...
- (void)onBatchedAccelerometerData:(id)a3
{
  v4 = [(CLBatchedSensorSubscriptionAdapter *)self subscription];
  id v5 = [a3 buffer];

  sub_1012C9C18((uint64_t)v4, (uint64_t)v5);
}
...
- (void)onBatchedDeviceMotionData:(id)a3
{
  ...
  sub_1012CA180((uint64_t)v4, (uint64_t)v5);
}

- (void)onWorkoutSessionUpdate:(WorkoutEvent *)a3 withOverview:(id)a4 andPriors:(id)a5
{
  v7 = [(CLBatchedSensorSubscriptionAdapter *)self subscription];
  ...
  sub_1012CA7B4((uint64_t)v7, (uint64_t)v21, (uint64_t)v18);
  sub_100663B8C(v20);
  if (v19 < 0) {
