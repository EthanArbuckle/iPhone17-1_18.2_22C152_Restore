...
- (CLWMSpectatorALS)initWithDelegate:(id)a3 universeCopy:(id)a4 settings:(SettingStructure *)a5;
- (id).cxx_construct;
- (int)getSampleCount;
- (void)onSpectatorALSData:(const void *)a3;
- (void)setWriter:(shared_ptr<CMMsl::WriterManager>)a3;
- (void)setupListener;
- (void)teardownListeners;
@end

@implementation CLWMSpectatorALS

- (CLWMSpectatorALS)initWithDelegate:(id)a3 universeCopy:(id)a4 settings:(SettingStructure *)a5
{
  v8.receiver = self;
  v8.super_class = (Class)CLWMSpectatorALS;
...
- (void)teardownListeners
{
  ...
  sub_1009D26C4(v3, 32, (uint64_t)self->_spectatorALSDispatcher.__ptr_.__value_);
  value = self->_spectatorALSDispatcher.__ptr_.__value_;
  self->_spectatorALSDispatcher.__ptr_.__value_ = 0;
  if (value)
  {
