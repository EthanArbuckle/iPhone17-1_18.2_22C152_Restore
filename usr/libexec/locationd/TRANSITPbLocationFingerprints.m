...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)TRANSITPbLocationFingerprints;
...
- (BOOL)readFrom:(id)a3
{
  return sub_1008164BC(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  if ([(TRANSITPbLocationFingerprints *)self locationFingerprintsCount])
  {
    ...
    unint64_t v5 = [(TRANSITPbLocationFingerprints *)self locationFingerprintsCount];
    if (v5)
    {
      unint64_t v6 = v5;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(TRANSITPbLocationFingerprints *)self addLocationFingerprint:*(void *)(*((void *)&v9 + 1) + 8 * (void)v8)];
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
