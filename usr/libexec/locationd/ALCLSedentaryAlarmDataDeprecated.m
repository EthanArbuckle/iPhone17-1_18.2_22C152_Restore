...
- (id)description
{
  ...
  return +[NSString stringWithFormat:@"%@ %@", [(ALCLSedentaryAlarmDataDeprecated *)&v3 description], [(ALCLSedentaryAlarmDataDeprecated *)self dictionaryRepresentation]];
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_100F70A2C((uint64_t)self, (uint64_t)a3);
}
