...
+ (id)getSilo
{
  if (qword_10247D318 != -1) {
    dispatch_once(&qword_10247D318, &stru_1022C61E0);
  }
  return (id)qword_10247D310;
}
...
- (void)doAsync:(id)a3 withReply:(id)a4
{
  (*((void (**)(id, void *))a3 + 2))(a3, [(CLFilteredLocationControllerAdapter *)self adaptee]);
