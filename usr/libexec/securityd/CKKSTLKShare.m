...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInt64:-[CKKSTLKShare curve](self, "curve") forKey:@"curve"];
  [v4 encodeInt64:-[CKKSTLKShare version](self, "version") forKey:@"version"];
  ...
  [v4 encodeInt64:-[CKKSTLKShare epoch](self, "epoch") forKey:@"epoch"];
  [v4 encodeInt64:-[CKKSTLKShare poisoned](self, "poisoned") forKey:@"poisoned"];
      ...
      do
      {
        ...
        if (v18)
        {
          ...
          if (v21)
          {
            ...
            v25 = [v24 zoneName];
            v26 = sub_1000CD884(@"ckksshare", v25);
...
- (BOOL)verifySignature:(id)a3 verifyingPeer:(id)a4 ckrecord:(id)a5 error:(id *)a6
{
  ...
  if (v13)
  {
    ...
    id v15 = [objc_alloc((Class)_SFECKeySpecifier) initWithCurve:-[CKKSTLKShare curve](self, "curve")];
  ...
  else
  {
    ...
    v24 = [v23 zoneName];
    v25 = sub_1000CD884(@"ckksshare", v24);
...
- (id)signRecord:(id)a3 ckrecord:(id)a4 error:(id *)a5
{
  ...
  id v11 = [objc_alloc((Class)_SFECKeySpecifier) initWithCurve:-[CKKSTLKShare curve](self, "curve")];
...
- (id)dataForSigning:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      id v23 = v22;
      v24 = NSMutableString_ptr;
      v25 = &SecPolicyXPCArrayCopyArray_ptr;
...
- (id)unwrapUsing:(id)a3 error:(id *)a4
{
  ...
  [v9 finishDecoding];
  id v11 = [objc_alloc((Class)_SFIESOperation) initWithCurve:-[CKKSTLKShare curve](self, "curve")];
...
- (id)wrap:(id)a3 publicKey:(id)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    id v13 = [objc_alloc((Class)_SFIESOperation) initWithCurve:-[CKKSTLKShare curve](self, "curve")];
...
+ (id)share:(id)a3 as:(id)a4 to:(id)a5 epoch:(int64_t)a6 poisoned:(int64_t)a7 error:(id *)a8
{
  ...
  if (v21)
  {
    ...
    id v23 = [v22 zoneName];
    uint64_t v24 = sub_1000CD884(@"ckksshare", v23);
  ...
  uint64_t v24 = sub_1000CD884(@"ckksshare", v29);
