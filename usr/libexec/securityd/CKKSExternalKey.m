...
- (id)makeCKKSKey:(id)a3 contextID:(id)a4 error:(id *)a5
{
  ...
  id v8 = a4;
  id v9 = [CKKSKey alloc];
  id v10 = [(CKKSExternalKey *)self keyData];
  id v11 = [(CKKSExternalKey *)self uuid];
...
- (id)initWithViewName:(id)a3 tlk:(id)a4
{
  ...
  id v7 = a3;
  id v8 = [v6 uuid];
  id v9 = [v6 parentKeyUUID];
  id v10 = [v6 wrappedKeyData];

  id v11 = [(CKKSExternalKey *)self initWithView:v7 uuid:v8 parentTLKUUID:v9 keyData:v10];
  return v11;
}
