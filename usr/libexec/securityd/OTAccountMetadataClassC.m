...
- (BOOL)readFrom:(id)a3
{
  ...
  {
    unint64_t v5 = &selRef_hasKeyclass;
    __int16 v6 = &selRef_hasKeyclass;
    unint64_t v7 = &selRef_hasKeyclass;
    do
    {
...
LABEL_14:
      ...
      switch((v10 >> 3))
      {
        case 1u:
          ...
          uint64_t v17 = *((int *)v5 + 831);
          goto LABEL_101;
        case 2u:
          char v18 = 0;
          unsigned int v19 = 0;
          uint64_t v20 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 0x10u;
          while (2)
          {
...
LABEL_105:
          uint64_t v69 = *((int *)v7 + 833);
          goto LABEL_144;
        case 3u:
          char v23 = 0;
          unsigned int v24 = 0;
          uint64_t v25 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 1u;
          while (2)
          {
...
LABEL_109:
        ...
        case 5u:
          ...
          unsigned int v29 = 0;
          uint64_t v20 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 0x40u;
          while (2)
          {
...
LABEL_113:
        ...
        case 6u:
          ...
          unsigned int v33 = 0;
          uint64_t v25 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 2u;
          while (2)
          {
...
LABEL_118:
        ...
        case 7u:
          ...
          unsigned int v37 = 0;
          uint64_t v20 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 4u;
          while (2)
          {
...
LABEL_122:
        ...
        case 8u:
          ...
          unsigned int v41 = 0;
          uint64_t v20 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 8u;
          while (2)
          {
...
LABEL_126:
        ...
        case 0x12u:
          ...
          unsigned int v50 = 0;
          uint64_t v51 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 0x80u;
          while (2)
          {
...
LABEL_130:
        ...
        case 0x13u:
          ...
          unsigned int v55 = 0;
          uint64_t v56 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 0x100u;
          while (2)
          {
...
LABEL_134:
        ...
        case 0x14u:
          ...
          unsigned int v60 = 0;
          uint64_t v61 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 0x200u;
          while (2)
          {
...
LABEL_139:
        ...
        case 0x16u:
          ...
          unsigned int v65 = 0;
          uint64_t v20 = 0;
          *(_WORD *)&self->PBCodable_opaque[*((int *)v6 + 832)] |= 0x20u;
          break;
        case 0x17u:
          uint64_t v16 = PBReaderReadString();
          uint64_t v17 = 48;
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      char v8 = *(&off_1002F7DC0 + icloudAccountState);
    }
  ...
  if ((v11 & 0x40) != 0)
  {
    ...
    {
      BOOL v13 = *(&off_1002F7DE0 + trustState);
    }
...
LABEL_22:
  ...
  {
    uint64_t v16 = *(&off_1002F7DF8 + attemptedJoin);
  }
...
LABEL_26:
    ...
    {
      char v18 = *(&off_1002F7E10 + cdpState);
    }
...
LABEL_48:
  ...
  {
    unsigned int v29 = *(&off_1002F7E28 + sendingMetricsPermitted);
  }
...
- (id)parsedSecureElementIdentity
{
  ...
  __int16 v3 = v2;
  if (v2 && [v2 length]) {
    id v4 = [objc_alloc((Class)TPPBSecureElementIdentity) initWithData:v3];
  }
  else {
    id v4 = 0;
  }
...
{
  id v4 = a3;
  id v8 = objc_alloc_init((Class)TPPBSecureElementIdentity);
  unint64_t v5 = [v4 peerIdentifier];
  [v8 setPeerIdentifier:v5];

  __int16 v6 = [v4 peerData];

  [v8 setPeerData:v6];
  objc_super v7 = [v8 data];
  [(OTAccountMetadataClassC *)self setSecureElementIdentity:v7];
}

- (id)getTLKSharesPairedWithVoucher
{
  __int16 v3 = +[NSMutableArray array];
  long long v12 = 0u;
  long long v13 = 0u;
  long long v14 = 0u;
  long long v15 = 0u;
  id v4 = [(OTAccountMetadataClassC *)self tlkSharesForVouchedIdentitys];
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; uint64_t i = (char *)i + 1)
      {
        ...
        id v9 = [objc_alloc((Class)NSKeyedUnarchiver) initForReadingFromData:*(void *)(*((void *)&v12 + 1) + 8 * i) error:0];
        unint64_t v10 = [[CKKSTLKShare alloc] initWithCoder:v9];
        [v9 finishDecoding];
        [v3 addObject:v10];
      }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        __int16 v11 = *(void **)(*((void *)&v15 + 1) + 8 * (void)v10);
        id v12 = objc_alloc((Class)NSKeyedArchiver);
        id v13 = [v12 initRequiringSecureCoding:1, v15];
        [v11 encodeWithCoder:v13];
        long long v14 = [v13 encodedData];
        [v5 addObject:v14];
...
- (id)getTPSyncingPolicy
{
  id v3 = objc_alloc((Class)NSKeyedUnarchiver);
  id v4 = [(OTAccountMetadataClassC *)self syncingPolicy];
  id v5 = [v3 initForReadingFromData:v4 error:0];

  id v6 = [objc_alloc((Class)TPSyncingPolicy) initWithCoder:v5];
  [v5 finishDecoding];
...
- (BOOL)saveToKeychainForContainer:(id)a3 contextID:(id)a4 personaAdapter:(id)a5 personaUniqueString:(id)a6 error:(id *)a7
{
  ...
  char v28 = sub_10009F0A0;
  unsigned int v29 = sub_10009F0B0;
  id v30 = 0;
...
+ (id)loadFromKeychainForContainer:(id)a3 contextID:(id)a4 personaAdapter:(id)a5 personaUniqueString:(id)a6 error:(id *)a7
{
  ...
  unint64_t v38 = sub_10009F0A0;
  char v39 = sub_10009F0B0;
  id v40 = 0;
  uint64_t v29 = 0;
  id v30 = &v29;
  uint64_t v31 = 0x3032000000;
  char v32 = sub_10009F0A0;
  unsigned int v33 = sub_10009F0B0;
  id v34 = 0;
...
+ (BOOL)deleteFromKeychainForContainer:(id)a3 contextID:(id)a4 personaAdapter:(id)a5 personaUniqueString:(id)a6 error:(id *)a7
{
  ...
  if (a7 && v17)
  {
    ...
    unsigned int v19 = +[NSString stringWithFormat:@"SecItemDelete: %d", v17];
    uint64_t v31 = v19;
