...
- (void)mergeFrom:(id)a3
{
  v4 = a3;
  if (v4[1]) {
    -[SecDbKeychainSerializedSecretData setCiphertext:](self, "setCiphertext:");
  }
  if (v4[3]) {
    -[SecDbKeychainSerializedSecretData setWrappedKey:](self, "setWrappedKey:");
  }
  if (v4[2]) {
    -[SecDbKeychainSerializedSecretData setTamperCheck:](self, "setTamperCheck:");
  }
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)SecDbKeychainSerializedSecretData;
  id v3 = [(SecDbKeychainSerializedSecretData *)&v7 description];
  unint64_t v4 = [(SecDbKeychainSerializedSecretData *)self dictionaryRepresentation];
