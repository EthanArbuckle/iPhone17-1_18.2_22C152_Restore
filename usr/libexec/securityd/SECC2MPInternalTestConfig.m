@interface SECC2MPInternalTestConfig
- (BOOL)hasKey;
- (BOOL)hasValue;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[SECC2MPInternalTestConfig setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[2])
  {
    -[SECC2MPInternalTestConfig setValue:](self, "setValue:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000F800C((uint64_t)self, (uint64_t)a3);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)SECC2MPInternalTestConfig;
  NSUInteger v3 = [(SECC2MPInternalTestConfig *)&v7 description];
  id v4 = [(SECC2MPInternalTestConfig *)self dictionaryRepresentation];
