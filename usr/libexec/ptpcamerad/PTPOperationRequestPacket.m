...
- (PTPOperationRequestPacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 39) >= 0xFFFFFFEB && *((_DWORD *)a3 + 1) == 6)
  {
    ...
    {
      v10 = (char *)a3 + 8;
      v7->_dataPhaseInfo = sub_10002A650(&v10);
      v7->_operationCode = sub_10002A5D4(&v10);
...
- (PTPOperationRequestPacket)initWithUSBBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 33) >= 0xFFFFFFEB && *((_WORD *)a3 + 2) == 1)
  {
    ...
    if (v7)
    {
      ...
      v7->_dataPhaseInfo = 0;
      v7->_operationCode = sub_10002A5D4(&v11);
      v8->_transactionID = sub_10002A650(&v11);
      v8->_numParameters = (v3 - 12) >> 2;
      if ((v3 - 12) >= 4)
      {
        uint64_t v9 = 0;
        do
          v8->_parameters[v9++] = sub_10002A650(&v11);
...
- (id)contentForTCP
{
  ...
  sub_10002A638((_DWORD **)&v7, 6);
  sub_10002A638((_DWORD **)&v7, self->_dataPhaseInfo);
  sub_10002A5BC(&v7, self->_operationCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  if (v4 <= a4)
  {
    ...
    sub_10002A5BC(&v9, 1);
    sub_10002A5BC(&v9, self->_operationCode);
...
- (id)description
{
  ...
  uint64_t v3 = sub_10002AC48(self->_operationCode);
