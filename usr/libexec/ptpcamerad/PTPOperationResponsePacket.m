...
- (PTPOperationResponsePacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 35) >= 0xFFFFFFEB && *((_DWORD *)a3 + 1) == 7)
  {
    ...
    if (v7)
    {
      ...
      v7->_responseCode = sub_10002A5D4(&v10);
...
- (id)contentForTCP
{
  ...
  sub_10002A638((_DWORD **)&v7, 7);
  sub_10002A5BC(&v7, self->_responseCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  if (v4 <= a4)
  {
    ...
    sub_10002A5BC(&v9, 3);
    sub_10002A5BC(&v9, self->_responseCode);
...
- (id)description
{
  ...
  uint64_t v3 = sub_10002BE44(self->_responseCode);
