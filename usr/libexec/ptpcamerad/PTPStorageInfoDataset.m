...
- (void)setContent:(id)a3
{
  ...
  v12 = v6;
  self->_storageType = sub_10002A5E8((unint64_t *)&v12, (unint64_t)v7);
  self->_filesystemType = sub_10002A5E8((unint64_t *)&v12, (unint64_t)v7);
  self->_accessCapability = sub_10002A5E8((unint64_t *)&v12, (unint64_t)v7);
  self->_maxCapacity = sub_10002A664((unint64_t *)&v12, (unint64_t)v7);
  self->_freeSpaceInBytes = sub_10002A664((unint64_t *)&v12, (unint64_t)v7);
  self->_freeSpaceInImages = sub_10002A610((unint64_t *)&v12, (unint64_t)v7);
  sub_10002A778(&v12, (unint64_t)v7);
...
- (void)updateContent
{
  ...
  if (self->_dirty && !self->_readOnlyObject)
  {
    ...
    sub_10002A5BC(&v7, self->_storageType);
    sub_10002A5BC(&v7, self->_filesystemType);
    sub_10002A5BC(&v7, self->_accessCapability);
    sub_10002A68C((void **)&v7, self->_maxCapacity);
    sub_10002A68C((void **)&v7, self->_freeSpaceInBytes);
    sub_10002A638((_DWORD **)&v7, self->_freeSpaceInImages);
    sub_10002A7C0((unsigned char **)&v7, self->_storageDescription);
    sub_10002A7C0((unsigned char **)&v7, self->_volumeLabel);
  }
}
...
- (id)description
{
  ...
  NSUInteger v4 = sub_10002C1D0(self->_storageType);
  [v3 appendFormat:@"%@\n  _filesystemType:     ", v4];

  uint64_t v5 = sub_10002C23C(self->_filesystemType);
  [v3 appendFormat:@"%@\n  _accessCapability:   ", v5];

  uint64_t v6 = sub_10002C2E4(self->_accessCapability);
