...
{
  BOOL v5 = a5;
  uint64_t v7 = qword_1000634E0;
  v8 = (NSString *)a4;
  id v11 = a3;
  if (v7 != -1) {
    dispatch_once(&qword_1000634E0, &stru_10004D028);
  }
  uint64_t v9 = qword_1000634D8;
  ...
  if (v14)
  {
    ...
    do
    {
      for (i = 0; i != v15; i = (char *)i + 1)
      {
        ...
        id v19 = [v18 remoteObjectProxyWithErrorHandler:&stru_10004D068];
        __ICOSLogCreate();
