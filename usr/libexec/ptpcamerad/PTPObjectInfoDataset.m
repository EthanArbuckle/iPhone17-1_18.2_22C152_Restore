...
- (PTPObjectInfoDataset)initWithBytes:(char *)a3 length:(unsigned int)a4 contentType:(int)a5
{
  ...
  if ([(PTPObjectInfoDataset *)v8 contentLengthValid:v6 forContentType:v5])
  {
    ...
    if (v5)
    {
      v9->_objectHandle = sub_10002A650(&v36);
      if (v5 > 2) {
        uint64_t v6 = 0;
      }
      else {
        uint64_t v6 = sub_10002A650(&v36);
      }
    }
    v9->_storageID = sub_10002A650(&v36);
    v9->_objectFormat = sub_10002A5D4(&v36);
    v9->_protectionStatus = sub_10002A5D4(&v36);
    if (v5 > 1)
    {
      if ((v5 & 0xFFFFFFFE) == 2) {
        v9->_objectCompressedSize = sub_10002A6A4((void **)&v36);
      }
      BOOL v18 = v5 == 3;
      if ((v5 - 5) > 0xFFFFFFFD) {
        goto LABEL_18;
    ...
    {
      BOOL v18 = 0;
      v9->_objectCompressedSize = sub_10002A650(&v36);
    }
    v9->_thumbFormat = sub_10002A5D4(&v36);
    v9->_thumbCompressedSize = sub_10002A650(&v36);
    v9->_thumbPixWidth = sub_10002A650(&v36);
    v9->_thumbPixHeight = sub_10002A650(&v36);
    v9->_imagePixWidth = sub_10002A650(&v36);
    v9->_imagePixHeight = sub_10002A650(&v36);
    v9->_imageBitDepth = sub_10002A650(&v36);
LABEL_18:
    v9->_parentObject = sub_10002A650(&v36);
    v9->_associationType = sub_10002A5D4(&v36);
    v9->_associationDesc = sub_10002A650(&v36);
    v9->_sequenceNumber = sub_10002A650(&v36);
    uint64_t v19 = sub_10002A778((const void **)&v36, (unint64_t)v10);
    filename = v9->_filename;
    v9->_filename = (NSString *)v19;

    uint64_t v21 = sub_10002A778((const void **)&v36, (unint64_t)v10);
    if (v18)
    {
    ...
    else
    {
      ...
      uint64_t v24 = sub_10002A778((const void **)&v36, (unint64_t)v10);
      v25 = v9->_modificationDate;
      v9->_modificationDate = (NSString *)v24;

      modificationDate = sub_10002A778((const void **)&v36, (unint64_t)v10);
...
- (id)content:(int)a3
{
  ...
  if (a3)
  {
    sub_10002A638((_DWORD **)&v16, self->_objectHandle);
    if (a3 <= 2) {
      sub_10002A638((_DWORD **)&v16, SHIDWORD(v15));
    }
  }
  sub_10002A638((_DWORD **)&v16, self->_storageID);
  sub_10002A5BC(&v16, self->_objectFormat);
  sub_10002A5BC(&v16, self->_protectionStatus);
  if (a3 <= 1)
  {
    ...
    sub_10002A638((_DWORD **)&v16, objectCompressedSize);
  }
  if ((a3 & 0xFFFFFFFE) == 2) {
    sub_10002A68C((void **)&v16, self->_objectCompressedSize);
  }
  if ((a3 - 5) <= 0xFFFFFFFD)
  {
    sub_10002A5BC(&v16, self->_thumbFormat);
    sub_10002A638((_DWORD **)&v16, self->_thumbCompressedSize);
    sub_10002A638((_DWORD **)&v16, self->_thumbPixWidth);
    sub_10002A638((_DWORD **)&v16, self->_thumbPixHeight);
    sub_10002A638((_DWORD **)&v16, self->_imagePixWidth);
    sub_10002A638((_DWORD **)&v16, self->_imagePixHeight);
    sub_10002A638((_DWORD **)&v16, self->_imageBitDepth);
  }
  sub_10002A638((_DWORD **)&v16, self->_parentObject);
  sub_10002A5BC(&v16, self->_associationType);
  sub_10002A638((_DWORD **)&v16, self->_associationDesc);
  sub_10002A638((_DWORD **)&v16, self->_sequenceNumber);
  sub_10002A7C0((unsigned char **)&v16, self->_filename);
  if (a3 == 3)
  {
  ...
  {
    sub_10002A7C0((unsigned char **)&v16, self->_captureDate);
    sub_10002A7C0((unsigned char **)&v16, self->_modificationDate);
    ...
    if ((unint64_t)[(NSMutableString *)self->_keywords length] >= 0x100)
    {
      ...
      if (os_log_type_enabled((os_log_t)_gICOSLog, OS_LOG_TYPE_ERROR)) {
        sub_100033E74(v9, v13);
      }
    }
  }
  sub_10002A7C0((unsigned char **)&v16, *p_modificationDate);
...
- (id)description
{
  ...
  int v16 = sub_10002C3DC(self->_objectFormat);
  objc_super v3 = sub_10002C350(self->_protectionStatus);
  unint64_t objectCompressedSize = self->_objectCompressedSize;
  uint64_t v4 = sub_10002C3DC(self->_thumbFormat);
  ...
  uint64_t v11 = sub_10002C6C4(self->_associationType);
...
- (void)addCustomKeyword:(id)a3 withIdentifier:(id)a4
{
  ...
  if (v6 && v7)
  {
    ...
    else
    {
      ...
      CFStringRef v15 = @"&";
      if (!v14) {
        CFStringRef v15 = &stru_10004E2B0;
      }
...
- (int64_t)intervalSince1970
{
  ...
  if (!result)
  {
    int64_t result = sub_100032B70(self->_captureDate);
