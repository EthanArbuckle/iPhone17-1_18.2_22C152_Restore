...
- (BOOL)removeRemoteCameraDevice:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      uint64_t v8 = [v7 substringWithRange:0, 18];
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (v16)
          {
            id v17 = [v14 remoteObjectProxyWithErrorHandler:&stru_10004D088];
    ...
    if (v5)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (v12)
          {
            v13 = [v10 remoteObjectProxyWithErrorHandler:&stru_10004D0A8];
...
{
  BOOL v5 = a5;
  uint64_t v7 = qword_1000634F0;
  id v8 = (NSString *)a4;
  id v11 = a3;
  if (v7 != -1) {
    dispatch_once(&qword_1000634F0, &stru_10004D0C8);
  }
  uint64_t v9 = qword_1000634E8;
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  {
    uint64_t v7 = [[@"remoteManager" substringWithRange:0, 18];
...
- (void)addRemoteManagerConnection:(id)a3
{
  ...
  {
    id v12 = [v11 substringWithRange:0, 18];
...
- (void)removeRemoteManagerConnectionWithProcessIdentifier:(int)a3
{
    ...
    do
    {
      ...
      do
      {
        ...
        if (a3 == -1 || v14 == a3)
        {
          ...
          {
            __int16 v17 = [v16 substringWithRange:0, 18];
  ...
  if (v4->_systemDaemon && ![(NSMutableDictionary *)v4->_remoteManagerConnections count])
  {
    ...
    {
      v39 = [v37 substringWithRange:0, 18];
