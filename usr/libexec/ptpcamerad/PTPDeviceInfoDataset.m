...
- (void)setContent:(id)a3
{
  ...
  v28 = v6;
  self->_standardVersion = sub_10002A5E8((unint64_t *)&v28, (unint64_t)v7);
  self->_vendorExtensionID = sub_10002A610((unint64_t *)&v28, (unint64_t)v7);
  self->_vendorExtensionVersion = sub_10002A5E8((unint64_t *)&v28, (unint64_t)v7);
  sub_10002A778((const void **)&v28, (unint64_t)v7);
  v8 = (NSString *)objc_claimAutoreleasedReturnValue();
  vendorExtensionDescription = self->_vendorExtensionDescription;
  self->_vendorExtensionDescription = v8;

  self->_functionalMode = sub_10002A5E8((unint64_t *)&v28, (unint64_t)v7);
  sub_10002AA38(&v28, (unint64_t)v7);
...
- (void)updateContent
{
  if (self->_dirty && !self->_readOnlyObject)
  {
    ...
    v15.i64[0] = v10;
    v15.i64[1] = v11;
    [(NSMutableData *)self->_content setLength:vaddvq_s64(vaddq_s64((int64x2_t)vbslq_s8((int8x16_t)vceqzq_s64(v14), (int8x16_t)xmmword_10003BEC0, (int8x16_t)vaddq_s64(vaddq_s64(v14, v14), (int64x2_t)xmmword_10003BEB0)), (int64x2_t)vbicq_s8((int8x16_t)vaddq_s64(vaddq_s64(v15, v15), vdupq_n_s64(2uLL)), (int8x16_t)vceqzq_s64(v15))))+ v13+ 2 * (v5 + v4 + v6 + v7 + v8)];
    v16 = [(NSMutableData *)self->_content mutableBytes];
    sub_10002A5BC(&v16, self->_standardVersion);
    sub_10002A638((_DWORD **)&v16, self->_vendorExtensionID);
    sub_10002A5BC(&v16, self->_vendorExtensionVersion);
    sub_10002A7C0((unsigned char **)&v16, self->_vendorExtensionDescription);
    sub_10002A5BC(&v16, self->_functionalMode);
    sub_10002AA88(&v16, self->_operationsSupported);
    sub_10002AA88(&v16, self->_eventsSupported);
    sub_10002AA88(&v16, self->_devicePropertiesSupported);
    sub_10002AA88(&v16, self->_captureFormats);
    sub_10002AA88(&v16, self->_imageFormats);
    sub_10002A7C0((unsigned char **)&v16, self->_manufacturer);
    sub_10002A7C0((unsigned char **)&v16, self->_model);
    sub_10002A7C0((unsigned char **)&v16, self->_deviceVersion);
    sub_10002A7C0((unsigned char **)&v16, self->_serialNumber);
    self->_dirty = 0;
  }
}
...
- (id)description
{
  ...
  if (v5)
  {
    ...
    do
    {
      NSUInteger v7 = sub_10002AC48((uint64_t)[v6 unsignedShortValue]);
      [v3 appendFormat:@"      %@\n", v7];
  ...
  if (v10)
  {
    ...
    do
    {
      NSUInteger v12 = sub_10002BEF4((int)[v11 unsignedShortValue]);
      [v3 appendFormat:@"      %@\n", v12];
  ...
  if (v15)
  {
    ...
    do
    {
      v17 = sub_10002C11C((uint64_t)[v16 unsignedShortValue]);
      [v3 appendFormat:@"      %@\n", v17];
  ...
  if (v20)
  {
    ...
    do
    {
      v22 = sub_10002C3DC((int)[v21 unsignedShortValue]);
      [v3 appendFormat:@"      %@\n", v22];
  ...
  if (v25)
  {
    ...
    do
    {
      v27 = sub_10002C3DC((int)[v26 unsignedShortValue]);
      [v3 appendFormat:@"      %@\n", v27];
