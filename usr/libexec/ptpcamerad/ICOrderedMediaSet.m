...
- (void)addMediaItemToIndex:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!v9)
    {
      ...
      if (v11)
      {
        id v13 = [v11 indexOfObject:v4 inSortedRange:0 options:1024 usingComparator:&stru_10004CC48];
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (i = 0; i != v10; i = (char *)i + 1)
      {
        ...
        id v16 = [v13 indexOfObject:v15 inSortedRange:0 options:v14 usingComparator:&stru_10004CC88];
