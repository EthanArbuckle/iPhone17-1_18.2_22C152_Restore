...
- (void)updateWithServerRepresentation:(id)a3
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%s not invoked on managed object context queue at %@", "-[GKRecentGameListEntryCacheObject updateWithServerRepresentation:]", v6);
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKRecentGameListEntryCacheObject updateWithServerRepresentation:]", [v9 UTF8String], 3469);

    +[NSException raise:@"GameKit Exception", @"%@", v10 format];
  }

  v14.receiver = self;
  v14.super_class = (Class)GKRecentGameListEntryCacheObject;
