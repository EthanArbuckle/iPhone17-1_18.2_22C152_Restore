...
- (void)updateWithCacheObject:(id)a3
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%s not invoked on managed object context queue at %@", "-[GKTurnBasedMatchInternal(Cache) updateWithCacheObject:]", v6);
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKTurnBasedMatchInternal(Cache) updateWithCacheObject:]", [v9 UTF8String], 308);
  ...
  v27 = [v4 participants];
  id v28 = [objc_alloc((Class)NSMutableSet) initWithCapacity:0];
  ...
  v45 = [v4 exchanges];
  v46 = [v45 array];
  v47 = [v46 _gkMapWithBlock:&stru_1002DB688];
