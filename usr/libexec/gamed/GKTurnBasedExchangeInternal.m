...
- (void)updateWithCacheObject:(id)a3
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%s not invoked on managed object context queue at %@", "-[GKTurnBasedExchangeInternal(Cache) updateWithCacheObject:]", v6);
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKTurnBasedExchangeInternal(Cache) updateWithCacheObject:]", [v9 UTF8String], 406);
  ...
  v25 = [v4 replies];
  v26 = [v25 array];
  v27 = [v26 _gkMapWithBlock:&stru_1002DB6F0];
