...
- (void)updateWithServerRepresentation:(id)a3
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%s not invoked on managed object context queue at %@", "-[GKTurnBasedExchangeReplyCacheObject updateWithServerRepresentation:]", v6);
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKTurnBasedExchangeReplyCacheObject updateWithServerRepresentation:]", [v9 UTF8String], 4193);

    +[NSException raise:@"GameKit Exception", @"%@", v10 format];
  }

  v18.receiver = self;
  v18.super_class = (Class)GKTurnBasedExchangeReplyCacheObject;
