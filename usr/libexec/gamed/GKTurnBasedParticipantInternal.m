...
- (void)updateWithCacheObject:(id)a3
{
  ...
  if (dispatch_queue_get_specific(v4, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v6 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%s not invoked on managed object context queue at %@", "-[GKTurnBasedParticipantInternal(Cache) updateWithCacheObject:]", v5);
