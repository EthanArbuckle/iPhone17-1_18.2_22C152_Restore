...
{
  v7.receiver = self;
  v7.super_class = (Class)NEKPBDuplicateSource;
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000169F8((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[NEKPBDuplicateSource setName:](self, "setName:");
    id v4 = v5;
  }
  if (v4[1])
  {
    -[NEKPBDuplicateSource setExternalId:](self, "setExternalId:");
    id v4 = v5;
  }
}
