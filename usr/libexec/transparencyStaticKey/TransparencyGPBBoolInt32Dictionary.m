...
- (TransparencyGPBBoolInt32Dictionary)init
{
  return [(TransparencyGPBBoolInt32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}
...
- (TransparencyGPBBoolInt32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  ...
  result = [(TransparencyGPBBoolInt32Dictionary *)&v13 init];
  if (result) {
    BOOL v9 = a5 == 0;
  }
  else {
...
- (TransparencyGPBBoolInt32Dictionary)initWithDictionary:(id)a3
{
  result = [(TransparencyGPBBoolInt32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  if (a3 && result)
  {
    uint64_t v5 = 0;
    char v6 = 1;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBBoolInt32Dictionary allocWithZone:a3];

  return [(TransparencyGPBBoolInt32Dictionary *)v4 initWithDictionary:self];
}
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v3])
    {
      ...
      uint64_t v13 = sub_10003D044(values[v3], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      [a3 writeInt32NoTag:sub_10003D044(values[v10], 2, v7) + v16];
      [a3 writeBool:1 value:v15];
      sub_10003D1E4(a3, values[v10], 2, v7);
    }
    char v13 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
