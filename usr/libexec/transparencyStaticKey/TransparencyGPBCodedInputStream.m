...
- (int)readTag
{
  return sub_10003AE5C((uint64_t)&self->state_);
}

- (void)checkLastTagWas:(int)a3
{
  if (self->state_.lastTag != a3) {
    sub_10003AF14(-103, @"Unexpected tag read");
  }
}

- (BOOL)skipField:(int)a3
{
  int v5 = sub_100027C04(a3);
  BOOL result = 0;
  switch(v5)
  {
    case 0:
      sub_10003ACDC((uint64_t *)&self->state_);
      goto LABEL_9;
    case 1:
      sub_10003B0A0(&self->state_.bytes, 8);
      unint64_t v7 = self->state_.bufferPos + 8;
      goto LABEL_8;
    case 2:
      int v8 = sub_10003ACDC((uint64_t *)&self->state_);
      sub_10003B0A0(&self->state_.bytes, v8);
      unint64_t v7 = self->state_.bufferPos + v8;
      goto LABEL_8;
    case 3:
      [(TransparencyGPBCodedInputStream *)self skipMessage];
      int v9 = sub_100027C0C(a3);
      if (self->state_.lastTag != sub_100027BFC(v9, 4)) {
        sub_10003AF14(-103, @"Unexpected tag read");
      }
      goto LABEL_9;
    case 5:
      sub_10003B0A0(&self->state_.bytes, 4);
...
- (void)skipMessage
{
  p_state = &self->state_;
  do
    uint64_t v4 = sub_10003AE5C((uint64_t)p_state);
...
- (unint64_t)readUInt64
{
  return sub_10003ACDC((uint64_t *)&self->state_);
}
...
- (BOOL)readBool
{
  return sub_10003ACDC((uint64_t *)&self->state_) != 0;
}

- (id)readString
{
  v2 = (__CFString *)sub_10003B00C((uint64_t *)&self->state_);
...
- (void)readGroup:(int)a3 message:(id)a4 extensionRegistry:(id)a5
{
  ...
  if (self->state_.lastTag != sub_100027BFC(a3, 4)) {
    sub_10003AF14(-103, @"Unexpected tag read");
  }
...
- (void)readMapEntry:(id)a3 extensionRegistry:(id)a4 field:(id)a5 parentMessage:(id)a6
{
  ...
  ++self->state_.recursionDepth;
  sub_10003BE10(a3, (uint64_t *)self, (uint64_t)a4, a5, a6);
  if (self->state_.lastTag) {
    sub_10003AF14(-103, @"Unexpected tag read");
  }
  --self->state_.recursionDepth;
...
- (id)readBytes
{
  id v2 = sub_10003B110((uint64_t *)&self->state_);
...
- (int)readSInt32
{
  unsigned int v2 = sub_10003ACDC((uint64_t *)&self->state_);
  return -(v2 & 1) ^ (v2 >> 1);
}

- (int64_t)readSInt64
{
  unint64_t v2 = sub_10003ACDC((uint64_t *)&self->state_);
