...
- (TransparencyGPBUInt64Int32Dictionary)init
{
  return [(TransparencyGPBUInt64Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}
...
- (void)enumerateKeysAndInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 unsignedLongLongValue], [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "intValue") intValue], &v7);
  }
  while (!v7);
}
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_10003D044(v16, 2, v7) + v14];
      if (v8 == 4)
      {
