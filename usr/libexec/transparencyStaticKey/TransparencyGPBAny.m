...
+ (id)descriptor
{
  id v2 = (id)qword_1000A75B8;
  if (!qword_1000A75B8)
  {
    LODWORD(v4) = 28;
    id v2 = +[TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBAny messageName:@"Any" fileDescription:off_1000A65E0 fields:&off_1000A65A0 fieldCount:2 storageSize:24 flags:v4];
    [v2 setupExtraTextInfo:&unk_100085648];
    qword_1000A75B8 = (uint64_t)v2;
  }
  return v2;
}
