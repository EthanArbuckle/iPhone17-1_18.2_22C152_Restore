...
+ (id)descriptor
{
  id result = (id)qword_1000A7638;
  if (!qword_1000A7638)
  {
    LODWORD(v3) = 28;
    id result = +[TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBTimestamp messageName:@"Timestamp" fileDescription:off_1000A6B68 fields:&off_1000A6B28 fieldCount:2 storageSize:16 flags:v3];
    qword_1000A7638 = (uint64_t)result;
  }
  return result;
}
