...
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBInt32UInt64Dictionary)init;
- (TransparencyGPBInt32UInt64Dictionary)initWithCapacity:(unint64_t)a3;
...
- (TransparencyGPBInt32UInt64Dictionary)init
{
  return [(TransparencyGPBInt32UInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (TransparencyGPBInt32UInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)TransparencyGPBInt32UInt64Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBInt32UInt64Dictionary;
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    [dictionary objectForKeyedSubscript:v6][(unsigned long long)[v6 intValue]][&v7];
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v14 = sub_10003D044([v11 intValue], 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_10003D044(v15, 1, v8);
      [a3 writeInt32NoTag:sub_10003D958((unint64_t)v16, 2, v7) + v14];
      sub_10003D1E4(a3, (uint64_t)v15, 1, v8);
      if (v7 == 4)
      {
