...
+ (id)allocDescriptorForClass:(Class)a3 file:(id)a4 fields:(void *)a5 fieldCount:(unsigned int)a6 storageSize:(unsigned int)a7 flags:(unsigned int)a8
{
  ...
  objc_setAssociatedObject(v22, &unk_100085638, v12, (void *)1);
  return v22;
}
      ...
      do
      {
        ...
        do
        {
          ...
          if ((*(_WORD *)(v10[1] + 28) & 0x40) != 0) {
            objc_setAssociatedObject(v10, &unk_100085639, v4, (void *)1);
          }
...
- (void)setupMessageClassNameSuffix:(id)a3
{
  if ([a3 length])
  {
    objc_setAssociatedObject(self, &unk_10008563B, a3, (void *)1);
  }
}
...
- (TransparencyGPBFileDescriptor)file
{
  ...
  AssociatedObject = (TransparencyGPBFileDescriptor *)objc_getAssociatedObject(self, &unk_100085638);
  if (!AssociatedObject)
  {
    ...
    AssociatedObject = v6;
    objc_setAssociatedObject(v6, &unk_100085638, v6, (void *)1);
  }
  objc_sync_exit(self);
...
- (TransparencyGPBDescriptor)containingType
{
  id AssociatedObject = objc_getAssociatedObject(self, &unk_10008563A);
...
- (NSString)fullName
{
  ...
  if (v4)
  {
    ...
    id AssociatedObject = objc_getAssociatedObject(v4, &unk_10008563B);
    if (AssociatedObject)
    {
  ...
  id v13 = objc_getAssociatedObject(self, &unk_10008563B);
  if (!v13) {
    goto LABEL_14;
  }
  long long v14 = v13;
