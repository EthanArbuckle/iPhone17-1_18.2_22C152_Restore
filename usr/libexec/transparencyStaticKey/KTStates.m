...
+ (id)KTStateMap
{
  ...
  block[3] = &unk_10008D2D8;
  block[4] = a1;
  if (qword_1000A7488 != -1) {
    dispatch_once(&qword_1000A7488, block);
  }
  v2 = (void *)qword_1000A7480;
...
+ (id)KTStateInverseMap
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1000139A4;
  block[3] = &unk_10008D2D8;
  block[4] = a1;
  if (qword_1000A7498 != -1) {
    dispatch_once(&qword_1000A7498, block);
  }
  v2 = (void *)qword_1000A7490;
...
+ (id)AllKTFlags
{
  if (qword_1000A74A8 != -1) {
    dispatch_once(&qword_1000A74A8, &stru_10008D2F8);
  }
  v2 = (void *)qword_1000A74A0;
