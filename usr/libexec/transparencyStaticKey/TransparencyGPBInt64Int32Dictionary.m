...
- (TransparencyGPBInt64Int32Dictionary)init
{
  return [(TransparencyGPBInt64Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}

- (TransparencyGPBInt64Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBInt64Int32Dictionary;
  v8 = [(TransparencyGPBInt64Int32Dictionary *)&v14 init];
  if (v8)
  {
...
- (TransparencyGPBInt64Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = [(TransparencyGPBInt64Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBInt64Int32Dictionary;
  [(TransparencyGPBInt64Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBInt64Int32Dictionary allocWithZone:a3];

  return [(TransparencyGPBInt64Int32Dictionary *)v4 initWithDictionary:self];
}
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        uint64_t v15 = sub_10003D044([v13 intValue], 2, v7) + v14;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      [a3 writeInt32NoTag:sub_10003D044(v16, 2, v7) + v17];
      sub_10003E3E4(a3, (uint64_t)v15, 1, v8);
      sub_10003D1E4(a3, (uint64_t)v16, 2, v7);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_10008E510;
  v3[4] = a3;
  [(TransparencyGPBInt64Int32Dictionary *)self enumerateKeysAndInt32sUsingBlock:v3];
}
