...
- (TransparencyGPBBoolObjectDictionary)init
{
  return [(TransparencyGPBBoolObjectDictionary *)self initWithObjects:0 forKeys:0 count:0];
}
...
- (id)deepCopyWithZone:(_NSZone *)a3
{
  id v5 = objc_alloc_init(TransparencyGPBBoolObjectDictionary);
  uint64_t v6 = 0;
  values = self->_values;
  char v8 = 1;
  do
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (v11)
    {
      ...
      unsigned int v13 = sub_10003BC54(v11, v7);
      v5 += (uint64_t)&v13[v12 + sub_10001BE44((int)v13 + (int)v12)];
    }
    char v9 = 0;
    uint64_t v3 = 1;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (values[v10])
    {
      ...
      uint64_t v14 = v9 & 1;
      int v15 = sub_10001DAF8(1);
      [a3 writeInt32NoTag:sub_10003BC54(values[v10], v7) + v15];
      [a3 writeBool:1 value:v14];
      sub_10003BD88(a3, (const char *)values[v10], v7);
    }
    char v12 = 0;
    char v9 = 1;
    uint64_t v10 = 1;
