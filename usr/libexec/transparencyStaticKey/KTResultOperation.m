...
- (KTResultOperation)init
{
  ...
  if (v2)
  {
    ...
    -[KTResultOperation setCompletionBlock:](v2, "setCompletionBlock:", &stru_10008D038, v14, v15, v16, v17);
...
- (id)dependenciesDescriptionError
{
  ...
  objc_super v4 = [v3 indexesOfObjectsPassingTest:&stru_10008D078];
...
- (id)_onqueueTimeoutError
{
  ...
  id v6 = [(KTResultOperation *)self pendingDependenciesString:&stru_10008F418];
