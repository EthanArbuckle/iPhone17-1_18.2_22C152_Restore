...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  fields = self->fields_;
  if (fields) {
    CFDictionaryApplyFunction(fields, (CFDictionaryApplierFunction)sub_100017A9C, v4);
  }
  return v4;
}
...
- (id)sortedFields
{
  ...
  if (fields)
  {
    ...
    if (Count)
    {
      ...
      while (Count != v7);
      qsort_b(&v15 - 2 * Count, Count, 0x10uLL, &stru_10008D4E8);
      v10 = v6 + 1;
    ...
    {
      qsort_b(v6, 0, 0x10uLL, &stru_10008D4E8);
    }
...
- (void)writeToCodedOutputStream:(id)a3
{
  ...
  if (fields)
  {
    ...
    else
    {
      ...
      while (Count != v9);
      qsort_b(&v14 - 2 * Count, Count, 0x10uLL, &stru_10008D508);
...
- (id)description
{
  ...
  [(NSMutableString *)v3 appendString:sub_100015FD4(self, @"  ")];
...
- (unint64_t)serializedSize
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction((CFDictionaryRef)result, (CFDictionaryApplierFunction)sub_100018020, &context);
    return context;
  }
  return result;
}
...
- (void)writeAsMessageSetTo:(id)a3
{
  fields = self->fields_;
  if (fields) {
    CFDictionaryApplyFunction(fields, (CFDictionaryApplierFunction)sub_100018074, a3);
  }
}
...
- (unint64_t)serializedSizeAsMessageSet
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction((CFDictionaryRef)result, (CFDictionaryApplierFunction)sub_1000180C0, &context);
    return context;
  }
  return result;
}
...
- (void)mergeUnknownFields:(id)a3
{
  if (a3)
  {
    ...
    if (v4) {
      CFDictionaryApplyFunction(v4, (CFDictionaryApplierFunction)sub_1000182D8, self);
    }
  }
}
...
{
  char v5 = a3;
  uint64_t v7 = sub_100027C0C(a3);
  int v8 = sub_100027C04(v5);
  BOOL v9 = 0;
  ...
  switch(v8)
  {
    case 0:
      BOOL v9 = 1;
      [self mutableFieldForNumber:v7 create:1]->addVarint(sub_10003ACD8(v10));
      break;
    case 1:
      BOOL v9 = 1;
      [self mutableFieldForNumber:v7 create:1].addFixed64:sub_10003AD7C(v10);
      break;
    case 2:
      id v11 = (TransparencyGPBUnknownFieldSet *)sub_10003B110(v10);
      BOOL v9 = 1;
...
LABEL_6:
    ...
    case 5:
      BOOL v9 = 1;
      [self mutableFieldForNumber:v7 create:1]->addFixed32(sub_10003ADB8(v10));
      break;
    default:
      return v9;
  }
...
{
  do
    uint64_t v5 = sub_10003AE5C((uint64_t)a3 + 8);
