...
+ (id)descriptor
{
  id result = (id)qword_1000A75D0;
  if (!qword_1000A75D0)
  {
    LODWORD(v3) = 28;
    id result = +[TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBDuration messageName:@"Duration" fileDescription:off_1000A66F8 fields:&off_1000A66B8 fieldCount:2 storageSize:16 flags:v3];
    qword_1000A75D0 = (uint64_t)result;
  }
  return result;
}
