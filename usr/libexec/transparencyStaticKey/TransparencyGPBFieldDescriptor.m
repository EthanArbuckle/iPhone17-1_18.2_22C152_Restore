...
- (TransparencyGPBFieldDescriptor)initWithFieldDescription:(void *)a3 descriptorFlags:(unsigned int)a4
{
  ...
  v7->getSel_ = v10;
  SEL v11 = sub_1000204F8("set", *((char **)a3 + (v4 & 1)), 0, 1);
  if (v11) {
    v12 = v11;
  }
  else {
  ...
  else
  {
    ...
    SEL v22 = sub_1000204F8("has", *((char **)a3 + (v4 & 1)), 0, 0);
    if (v22) {
      v23 = v22;
    }
    else {
  ...
  SEL v20 = sub_1000204F8(v18, v16, v17, v19);
  if (v20) {
    SEL v21 = v20;
  }
  else {
...
- ($592374059145371CE175D116F6F4BC44)defaultValue
{
  ...
  if ((description->var5 & 2) == 0)
  {
    ...
    {
      return ($592374059145371CE175D116F6F4BC44)sub_100013D28();
    }
    else
    {
      if (valueInt64) {
      ...
      if (v7) {
        return ($592374059145371CE175D116F6F4BC44)&stru_10008F418;
      }
    }
  }
...
- (id)textFormatName
{
  ...
  id AssociatedObject = objc_getAssociatedObject(self, &unk_100085639);
  if (!AssociatedObject) {
    return 0;
  }
  ...
  return sub_100016638(v8, var2, v10);
}
