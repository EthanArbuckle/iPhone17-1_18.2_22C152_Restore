...
- (BOOL)isEqual:(id)a3;
- (TransparencyGPBBoolUInt64Dictionary)init;
- (TransparencyGPBBoolUInt64Dictionary)initWithCapacity:(unint64_t)a3;
...
- (TransparencyGPBBoolUInt64Dictionary)init
{
  return [(TransparencyGPBBoolUInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}

- (TransparencyGPBBoolUInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  v13.receiver = self;
  v13.super_class = (Class)TransparencyGPBBoolUInt64Dictionary;
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    {
      ++v4;
      uint64_t v12 = sub_10001DAF8(1);
      uint64_t v13 = sub_10003D958(values[v3], 2, v7) + v12;
      v5 += v13 + sub_10001BE44(v13);
    }
    char v10 = 0;
    uint64_t v3 = 1;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  int v7 = *(unsigned __int8 *)(v6 + 30);
  uint64_t v8 = sub_100027BFC(*(_DWORD *)(v6 + 16), 2);
  char v9 = 0;
  uint64_t v10 = 0;
  valueSet = self->_valueSet;
  values = self->_values;
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      uint64_t v15 = v9 & 1;
      int v16 = sub_10001DAF8(1);
      [a3 writeInt32NoTag:sub_10003D958(values[v10], 2, v7) + v16];
      [a3 writeBool:1 value:v15];
      unint64_t v17 = values[v10];
      if (v7 == 4)
      {
        [a3 writeFixed64:2 value:v17];
      }
      else if (v7 == 12)
      {
        [a3 writeUInt64:2 value:v17];
      }
    }
    char v13 = 0;
    char v9 = 1;
