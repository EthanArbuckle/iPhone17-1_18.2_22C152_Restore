...
- (TransparencyGPBInt32UInt32Dictionary)init
{
  return [(TransparencyGPBInt32UInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}
...
- (void)enumerateKeysAndUInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, id, id, char *))a3 + 2))(a3, [v6 intValue], [objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6) unsignedIntValue], &v7);
  }
  while (!v7);
}
