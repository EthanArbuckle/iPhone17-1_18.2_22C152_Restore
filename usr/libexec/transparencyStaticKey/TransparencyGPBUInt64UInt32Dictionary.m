...
- (TransparencyGPBUInt64UInt32Dictionary)init
{
  return [(TransparencyGPBUInt64UInt32Dictionary *)self initWithUInt32s:0 forKeys:0 count:0];
}

- (TransparencyGPBUInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TransparencyGPBUInt64UInt32Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = (Class)TransparencyGPBUInt64UInt32Dictionary;
  [(TransparencyGPBUInt64UInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TransparencyGPBUInt64UInt32Dictionary allocWithZone:a3];
