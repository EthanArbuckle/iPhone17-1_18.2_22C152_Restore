  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v17.receiver = self;
        v17.super_class = (Class)SulfurDomain;
        v7 = [super v11];
...
{
  v6.receiver = self;
  v6.super_class = (Class)SulfurDomain;
  v3 = [(EligibilityDomain *)&v6 initWithCoder:a3];
  id v4 = v3;
  if (v3) {
    [(SulfurDomain *)v3 _internal_doInit];
  }
  return v4;
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)SulfurDomain;
  v2 = [(EligibilityDomain *)&v5 init];
  v3 = v2;
  if (v2) {
    [(SulfurDomain *)v2 _internal_doInit];
  }
  return v3;
}
