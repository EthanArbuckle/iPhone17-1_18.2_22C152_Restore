...
- (KryptonDomain)init;
- (KryptonDomain)initWithCoder:(id)a3;
- (id)domainChangeNotificationName;
- (id)status;
- (unint64_t)domain;
@end

@implementation KryptonDomain
  ...
  if (v5)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v17.receiver = self;
        v17.super_class = (Class)KryptonDomain;
        v7 = [super v11];
...
{
  v6.receiver = self;
  v6.super_class = (Class)KryptonDomain;
  v3 = [(EligibilityDomain *)&v6 initWithCoder:a3];
  id v4 = v3;
  if (v3) {
    [(KryptonDomain *)v3 _internal_doInit];
  }
  return v4;
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)KryptonDomain;
  v2 = [(EligibilityDomain *)&v5 init];
  v3 = v2;
  if (v2) {
    [(KryptonDomain *)v2 _internal_doInit];
  }
  return v3;
}
...
- (id)domainChangeNotificationName
{
  return @"com.apple.os-eligibility-domain.change.krypton";
}
