...
- (BromineDomain)init;
- (BromineDomain)initWithCoder:(id)a3;
...
{
  v6.receiver = self;
  v6.super_class = (Class)BromineDomain;
  v3 = [(EligibilityDomain *)&v6 initWithCoder:a3];
  v4 = v3;
  if (v3) {
    [(BromineDomain *)v3 _internal_doInit];
  }
  return v4;
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)BromineDomain;
  v2 = [(EligibilityDomain *)&v5 init];
  v3 = v2;
  if (v2) {
    [(BromineDomain *)v2 _internal_doInit];
  }
  return v3;
}
...
- (void)_internal_doInit
{
  [(BromineDomain *)self updateParameters];
...
- (id)domainChangeNotificationName
{
  return @"com.apple.os-eligibility-domain.change.bromine";
}
