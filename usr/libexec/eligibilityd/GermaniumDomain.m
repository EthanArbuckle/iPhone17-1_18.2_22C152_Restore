...
{
  v6.receiver = self;
  v6.super_class = (Class)GermaniumDomain;
  v3 = [(EligibilityDomain *)&v6 initWithCoder:a3];
  v4 = v3;
  if (v3) {
    [(GermaniumDomain *)v3 _internal_doInit];
  }
  return v4;
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)GermaniumDomain;
  v2 = [(EligibilityDomain *)&v5 init];
  v3 = v2;
  if (v2) {
    [(GermaniumDomain *)v2 _internal_doInit];
  }
  return v3;
}
...
- (void)_internal_doInit
{
  [(GermaniumDomain *)self updateParameters];
