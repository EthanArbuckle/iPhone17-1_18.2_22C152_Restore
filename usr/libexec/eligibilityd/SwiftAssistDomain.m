...
- (SwiftAssistDomain)init;
- (SwiftAssistDomain)initWithCoder:(id)a3;
...
@implementation SwiftAssistDomain

- (unint64_t)computeInputStatusForDeviceRegionCodesInput:(id)a3
{
  id v3 = a3;
  v4 = +[MobileAssetManager sharedInstance];
  v5 = [v4 swiftAssistAsset];
  v6 = [v5 countryCodes];
...
{
  v6.receiver = self;
  v6.super_class = (Class)SwiftAssistDomain;
  id v3 = [(EligibilityDomain *)&v6 initWithCoder:a3];
  v4 = v3;
  if (v3) {
    [(SwiftAssistDomain *)v3 _internal_doInit];
  }
  return v4;
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)SwiftAssistDomain;
  v2 = [(EligibilityDomain *)&v5 init];
  id v3 = v2;
  if (v2) {
    [(SwiftAssistDomain *)v2 _internal_doInit];
  }
  return v3;
}
...
- (id)domainChangeNotificationName
{
  return @"com.apple.os-eligibility-domain.change.swift-assist";
}
