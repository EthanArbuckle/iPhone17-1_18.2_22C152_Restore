...
{
  id v8 = a3;
  [v8 encodeBool:sub_1000D29B8() forKey:@"debugLogsEnabled"];
  [v8 encodeBool:sub_1000D29A0() forKey:@"forwardLogs"];
  ...
  [v8 encodeInteger:-[DIBaseParams readPassphraseFlags](self, "readPassphraseFlags") forKey:@"readPassphraseFlags"];
...
- (NSUUID)encryptionUUID
{
  if (*(void *)[(DIBaseParams *)self cryptoHeader]) {
    id v3 = [objc_alloc((Class)NSUUID) initWithUUIDBytes:*(void *)-[DIBaseParams cryptoHeader](self, "cryptoHeader") + 36];
  }
  else {
    id v3 = 0;
  }
...
- (BOOL)requiresRootDaemon
{
  ...
  sub_100141990((uint64_t)&v10, &lpsrc);
  if (v11) {
    sub_100010A48(v11);
  }
  v2 = lpsrc;
  ...
  if (!v3)
  {
    if (v7)
    {
      ...
      char v6 = sub_10004CC34((uint64_t)v7 + 24);
      goto LABEL_13;
    }
LABEL_15:
    BOOL v8 = 0;
  ...
  char v6 = (*(uint64_t (**)(void *))(*v4 + 48))(v4);
LABEL_13:
  BOOL v8 = v6;
  if (v5) {
LABEL_17:
