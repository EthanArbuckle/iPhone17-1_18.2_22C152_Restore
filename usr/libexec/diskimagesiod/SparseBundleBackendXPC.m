...
- (SparseBundleBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    sub_1000CD2B0(v4, (uint64_t *)[(BackendXPC *)v5 cryptoHeader], &v12);
    sub_1000D0F38((unsigned int *)&v15, &v14, &v10);
    long long v11 = v10;
    long long v10 = 0uLL;
    -[BackendXPC setBackend:](v5, "setBackend:", &v11, 0);
    if (*((void *)&v11 + 1)) {
      sub_100010A48(*((std::__shared_weak_count **)&v11 + 1));
    }
    if (*((void *)&v10 + 1)) {
      sub_100010A48(*((std::__shared_weak_count **)&v10 + 1));
    }
    if (*((void *)&v12 + 1)) {
      sub_100010A48(*((std::__shared_weak_count **)&v12 + 1));
    }
    if (*((void *)&v13 + 1)) {
