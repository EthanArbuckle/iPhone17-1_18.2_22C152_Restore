...
- (unique_ptr<DiskImage,)createSinkDiskImage
{
  ...
  sub_100141990((uint64_t)&v9, &v11);
  sub_1000A0190(&v11, (void **)&v13);
  if (v12) {
    sub_100010A48(v12);
  }
  if (v10) {
  ...
  if (v13)
  {
    sub_10011CB60((uint64_t)v13);
    sub_100107FDC((AEAContext_impl **)(v13[7] + 8));
    operator new();
  }
  if (v14) {
    sub_100010A48(v14);
