...
- (BOOL)shouldPerformInplaceSquash
{
  ...
  id v5 = v4;
  sub_100003BA4(&__p, (char *)[v5 fileSystemRepresentation]);
  uint64_t v6 = sub_10011EDAC((uint64_t)&__p, 0);
  sub_10004C904((uint64_t)v21, v6, 0, 0);
  if (v20 < 0) {
    operator delete(__p);
  }
  ...
  sub_100141990((uint64_t)&v14, &v16);
  sub_10004A784(&v16, &__p);
  if (v17) {
    sub_100010A48(v17);
  }
  if (v15) {
  ...
  if (__p && sub_1001230D0((uint64_t)__p, (uint64_t)v21))
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInteger:-[DIConvertParams conversionMethod](self, "conversionMethod") forKey:@"conversionMethod"];
  [v4 encodeInteger:-[DIConvertParams outputFormat](self, "outputFormat") forKey:@"outputFormat"];
  [v4 encodeInteger:-[DIConvertParams maxRawUDIFRunSize](self, "maxRawUDIFRunSize") forKey:@"maxRawUDIFRunSize"];
  int v5 = [(DIConvertParams *)self outputParams];
  [v4 encodeObject:v5 forKey:@"outputParams"];

  [v4 encodeBool:-[DIConvertParams useFormatMappingInfo](self, "useFormatMappingInfo") forKey:@"useFormatMappingInfo"];
}
...
LABEL_18:
  ...
  sub_100003BA4(__p, (char *)[v7 fileSystemRepresentation]);
  uint64_t v8 = sub_10011EDAC((uint64_t)__p, 0);
  sub_10004C904((uint64_t)&v24, v8, 0, 0);
  if (v23 < 0) {
  ...
  *(_OWORD *)__p = *(_OWORD *)(v28 + 32);
  ...
  v24 = off_1001B1DB0;
  BOOL v26 = off_1001B1E90;
  int v27 = off_1001B1EC8;
  sub_10004CD98((uint64_t)&v30);
  if (v29) {
    sub_100010A48(v29);
  }
  if (v25) {
