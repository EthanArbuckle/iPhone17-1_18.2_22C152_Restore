...
+ (unint64_t)numBlocksWithSizeStr:(id)a3 blockSize:(unint64_t)a4
{
  ...
  id v7 = [v6 characterAtIndex:[v5 length] - 1];
...
LABEL_12:
        uint64_t v9 = [v5 substringToIndex:[v5 length] - 1];
...
+ (id)copyDevicePathWithStatfs:(statfs *)a3
{
  ...
  id v4 = [[objc_alloc((Class)NSString) initWithFormat:@"/dev/%s", v7];
