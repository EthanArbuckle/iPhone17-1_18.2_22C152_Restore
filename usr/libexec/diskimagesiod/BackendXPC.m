...
- (int)lock
{
  ...
  sub_100141990((uint64_t)&v4, &v6);
  sub_100057C7C(&v6, (void **)&v8);
  if (v7) {
    sub_100010A48(v7);
  }
  if (v5) {
...
- (void)replaceWithBackendXPC:(id)a3
{
  ...
  self->_backend = v5;
  if (cntrl) {
    sub_100010A48((std::__shared_weak_count *)cntrl);
  }
}
...
- (keys)generateNewImageKeysWithPassphrase:(SEL)a3 privateKey:(const char *)a4 pubKeyHeader:(__SecKey *)a5 header_backend:(public_key_header *)a6
{
  ...
  if (a4)
  {
    return (keys *)sub_1001382EC(retstr, v11, v12, a4);
  }
  else
  {
    ...
    return (keys *)sub_100137F28(retstr, v11, v12, a5, &var0);
  }
}
...
LABEL_25:
  ...
  else
  {
    ...
    if (a4)
    {
      sub_1001382EC(&v25, v34, [(BackendXPC *)self cryptoHeader], a4);
      sub_10006373C(&v32);
      long long v24 = v32;
      long long v32 = 0uLL;
      if (__p)
    ...
    if ([(BackendXPC *)self getPrivateKeyWithHeader:v42 privateKey:&v33 error:a6])
    {
      ...
      sub_100137F28(&v25, v15, v17, v33, &v37);
      sub_10006373C(&v32);
      long long v24 = v32;
      long long v32 = 0uLL;
      if (__p)
  ...
  else
  {
    ...
    *__error() = v9;
    if ((v16.st_mode & 0xF000) == 0x4000) {
      uint64_t v13 = &off_100191208;
    }
    else {
      uint64_t v13 = &off_1001910B0;
    }
