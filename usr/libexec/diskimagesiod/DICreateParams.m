...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInt64:-[DICreateParams numBlocks](self, "numBlocks") forKey:@"numBlocks"];
  [v4 encodeInteger:-[DICreateParams encryptionMethod](self, "encryptionMethod") forKey:@"encryptionMethod"];
  [v4 encodeBool:-[DICreateParams passphrase](self, "passphrase") forKey:@"passphrase"];
...
- (BOOL)createEncryptionWithXPCHandler:(id)a3 error:(id *)a4
{
  ...
  {
    if ((id)[(DICreateParams *)self encryptionMethod] == (id)2) {
      int v6 = 256;
    }
    else {
      int v6 = 128;
...
- (void)createDiskImageParamsXPC
{
  ...
  v3 = (void *)sub_100003670((uint64_t)exception, (uint64_t)"Invalid argument, please use one of the DICreateParams derived classes instead", 0x16u);
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 68158211;
        ...
        __int16 v20 = 2113;
        id v21 = v12;
        _os_log_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_DEFAULT, "%.*s: entry with %{private}@", buf, 0x1Cu);
      }
    }
    *__error() = v7;
...
- (BOOL)setPassphrase:(const char *)a3 error:(id *)a4
{
  ...
  id v15 = 0;
  unsigned __int8 v8 = [(DICreateParams *)self getCertificateWithEncryptionCreator:v7 outCertificate:&v15 error:a4];
  id v9 = v15;
  if (v8)
  {
    unsigned int v10 = [(DICreateParams *)self passphrase];
    if (v9) {
      int v11 = v10;
    }
    else {
    ...
    {
      unsigned __int8 v13 = +[DIError failWithPOSIXCode:22 description:@"Passphrase cannot be empty" error:a4];
    }
  }
  else
  {
...
- (BOOL)resizeWithNumBlocks:(unint64_t)a3 error:(id *)a4
{
  ...
  unsigned __int8 v8 = [(DIBaseParams *)self shadowChain];
  ...
  *(void *)buf = 0;
  ...
  v12 = [(DIBaseParams *)self diskImageParamsXPC];
  id v13 = [v12 setSizeWithDiskImage:&v26 newSize:v11 * a3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)&uint8_t buf[4] = 44;
      ...
      __int16 v30 = 2048;
      unint64_t v31 = v18;
      _os_log_impl((void *)&_mh_execute_header, v21, OS_LOG_TYPE_DEFAULT, "%.*s: Disk image resized to %llu bytes", buf, 0x1Cu);
    }
  }
  *__error() = v17;
  v22 = (void *)(*(uint64_t (**)(uint64_t))(*(void *)v26 + 136))(v26);
  uint64_t v23 = sub_100011BD0(v22);
  if (!v23)
  {
    BOOL v14 = 1;
    if (!v22) {
...
+ (BOOL)eraseIfExistingWithURL:(id)a3 error:(id *)a4
{
  ...
  int v7 = [v5 path];
  unsigned int v8 = [v6 fileExistsAtPath:v7 isDirectory:&v21];

  if (v8)
  {
    id v9 = +[NSFileManager defaultManager];
    uint64_t v10 = [v5 path];
    unsigned __int8 v11 = [v9 isWritableFileAtPath:v10];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 68158211;
            ...
            __int16 v26 = 2113;
            v27 = v18;
            _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_DEFAULT, "%.*s: Erasing %{private}@", buf, 0x1Cu);
          }
        }
        *__error() = v12;
        v19 = +[NSFileManager defaultManager];
        unsigned __int8 v16 = [v19 removeItemAtURL:v5 error:a4];
      }
      else
      {
    ...
    {
      unsigned __int8 v16 = +[DIError failWithPOSIXCode:13 verboseInfo:@"Image does not have write permissions" error:a4];
    }
  }
  else
  {
...
- (BOOL)onErrorCleanup
{
  ...
  else
  {
    ...
    {
      unsigned int v8 = [(DIBaseParams *)self inputURL];
      id v9 = [v8 path];
      *(_DWORD *)buf = 68158211;
      int v15 = 32;
      __int16 v16 = 2080;
      ...
      __int16 v18 = 2113;
      id v19 = v9;
      _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "%.*s: Creation failed, erasing %{private}@", buf, 0x1Cu);
    }
  }
  *__error() = v3;
  uint64_t v10 = +[NSFileManager defaultManager];
  unsigned __int8 v11 = [(DIBaseParams *)self inputURL];
  unsigned __int8 v12 = [v10 removeItemAtURL:v11 error:0];
