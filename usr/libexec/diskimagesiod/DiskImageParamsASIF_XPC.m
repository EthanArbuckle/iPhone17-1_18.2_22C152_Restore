  ...
  while (1)
  {
    ...
    if (v7)
    {
      ...
      *(void *)&long long v26 = 0x200000001;
      sub_1000A28EC((uint64_t)"header_ignore_fields_t", 2, (int *)&v26, 2);
      v12[48] = 2;
      if (v8) {
        sub_100010A48(v8);
      }
LABEL_25:
      if (self->_header.__ptr_.__value_)
      {
        ...
        sub_100141990((uint64_t)&v23, &v27);
        sub_10004A784(&v27, (void **)&v26);
        if (v28) {
          sub_100010A48(v28);
        }
        if (v24) {
...
LABEL_10:
    ...
    sub_100141C20((uint64_t)lpsrc, &v26);
    long long v9 = v26;
    long long v26 = 0uLL;
...
- (DiskImageParamsASIF_XPC)initWithCoder:(id)a3
{
  ...
  if (v5 && [v4 containsValueForKey:@"sparseHeader"])
  {
    ...
    sub_100003DF0(v8, (uint64_t)"Unexpected ASIF header length (", 31);
    std::ostream::operator<<();
    sub_100003DF0(v8, (uint64_t)")", 1);
    sub_100010C3C((uint64_t)exception, (uint64_t)v8, 0x9Au);
  }
