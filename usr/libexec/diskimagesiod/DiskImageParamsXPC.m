...
LABEL_3:
  ...
  *__error() = v15;
  ...
  sub_10004A784(&v27, (void **)buf);
  if (v28) {
    sub_100010A48(v28);
  }
  if (*(void *)buf && sub_1001200EC(*(void *)(*(void *)buf + 40)))
  {
  ...
  if (*(void *)v30) {
    sub_100010A48(*(std::__shared_weak_count **)v30);
  }
  if (v24)
  {
...
+ (BOOL)getAEAKeyWithHelper:(void *)a3 keyBuffer:(char *)a4 bufferSize:(unint64_t)a5 error:(id *)a6
{
  ...
  v13 = v8;
  return ((uint64_t (*)(void **, char *))off_1001A4398[v6])(&v13, (char *)a3 + 8);
}
...
+ (id)tryCreateAEABackendWithBackendXPC:(id)a3 error:(id *)a4
{
  ...
  sub_100107E5C(&v13, &v17);
  if (sub_100107E90((AAByteStream *)&v13, &v17, 4uLL, 0) < 0)
  {
  ...
  int v8 = (int)v17;
  sub_100107E60((AAByteStream *)&v13);
  if (v8 == 826361153)
  {
...
- (shared_ptr<DiskImage>)createShadowDiskImageWithBackend:(shared_ptr<Backend>)a3 numBlocks:(unint64_t)a4 sinkDiskImage:(const void *)a5 cache_only:(BOOL)a6 stack_size:(unint64_t)a7
{
  ...
  {
    exception = __cxa_allocate_exception(0x40uLL);
    sub_100003C58((uint64_t)v35);
    sub_100003DF0(v35, (uint64_t)"Shadow file cannot be used with a ", 34);
    (*(void (**)(unint64_t))(*(void *)a4 + 24))(a4);
    std::ostream::operator<<();
    sub_100003DF0(v35, (uint64_t)"-bytes block size", 17);
    sub_100010C3C((uint64_t)exception, (uint64_t)v35, 0x13u);
  }
  char v30 = 0;
  *(_DWORD *)&v31[7] = 0;
  *(void *)__int16 v31 = 256;
  int v14 = *((_DWORD *)sub_10003C118() + 8);
  *(_DWORD *)&v31[3] = (v14 - (v8 > 3)) & ~((v14 - (v8 > 3)) >> 31);
  ...
  if (!(*(uint64_t (**)(void))(**(void **)ptr + 40))())
  {
    ...
    if ((unint64_t)cntrl <= v18)
    {
      v35[0] = sub_100143B3C();
      v35[1] = v19;
      uint64_t v33 = sub_100063E00((uint64_t (***)(void))a4);
      uint64_t v34 = v20;
      ...
      sub_1000A3A68((uint64_t)&v32, (unsigned __int16 *)&v27, &dword_1001677C8, (unint64_t *)&v28, &v29, ptr, (uint64_t *)&v30, v21);
    }
    v25 = __cxa_allocate_exception(0x40uLL);
    void *v25 = &off_1001B6CA0;
  ...
  sub_1000E7F78(v35, *(void *)ptr);
  int v15 = (DiskImage *)sub_1000A38C4((uint64_t *)ptr, (uint64_t)v35, (uint64_t)&v30, &v33);
  if (((((*(unsigned char *)(v33 + 44) & 1) == 0) ^ v9) & 1) == 0)
  {
    v23 = __cxa_allocate_exception(0x40uLL);
    void *v23 = &off_1001B6CA0;
...
LABEL_6:
      ...
      do
      {
        for (i = 0; i != v11; i = (char *)i + 1)
        {
          ...
          *(void *)&uint8_t buf[8] = 0;
          int v75 = v24;
          sub_10009EAC8(&v66, v66, &v74);
          if (v74.n128_u64[1]) {
            sub_100010A48((std::__shared_weak_count *)v74.n128_u64[1]);
          }
          if (*(void *)&buf[8]) {
            sub_100010A48(*(std::__shared_weak_count **)&buf[8]);
          }
        }
        id v11 = [obj countByEnumeratingWithState:&v62 objects:v76 count:16];
      }
    ...
    if (v51)
    {
      ...
      *(_OWORD *)buf = v57;
      long long v57 = 0uLL;
      *(_DWORD *)&buf[16] = 2;
      sub_10009EC44(&v66, (uint64_t)buf);
      if (*(void *)&buf[8]) {
        sub_100010A48(*(std::__shared_weak_count **)&buf[8]);
      }
      if (*((void *)&v57 + 1)) {
        sub_100010A48(*((std::__shared_weak_count **)&v57 + 1));
      }
      if (v59) {
        sub_100010A48(v59);
      }
    ...
    int v75 = v44;
    sub_10009EC44(&v66, (uint64_t)&v74);
    if (v74.n128_u64[1]) {
      sub_100010A48((std::__shared_weak_count *)v74.n128_u64[1]);
    }
    operator new();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v7 encodeInteger:-[DiskImageParamsXPC blockSize](self, "blockSize") forKey:@"blockSize"];
...
- (NSUUID)instanceID
{
  ...
  if (v7)
  {
    ...
    if (v9 && [v9 count])
    {
      ...
      v25[0] = sub_100143A20((char *)&v25[-1] - v10, v10);
      v25[1] = v20;
...
- (BOOL)mountedOnAPFS
{
  ...
  sub_100141990((uint64_t)&v6, &v8);
  sub_10004A784(&v8, (void **)&v10);
  if (v9) {
    sub_100010A48(v9);
  }
  if (v7) {
