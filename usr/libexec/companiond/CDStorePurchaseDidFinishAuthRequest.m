...
- (CDStorePurchaseDidFinishAuthRequest)initWithRapportDictionary:(id)a3
{
  id v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)CDStorePurchaseDidFinishAuthRequest;
  v5 = [(CDStorePurchaseDidFinishAuthRequest *)&v18 init];
  if (v5)
  {
    v6 = self;
    uint64_t v7 = sub_10001CD14(v4, @"purchaseResult", (uint64_t)v6);
    purchaseResult = v5->_purchaseResult;
    v5->_purchaseResult = (AMSDelegatePurchaseResult *)v7;
...
- (id)makeRapportDictionary
{
  ...
  id v4 = sub_10001D014((uint64_t)self->_purchaseResult);
