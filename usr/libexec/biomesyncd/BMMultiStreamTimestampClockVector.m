...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    id v6 = [(BMMultiStreamTimestampClockVector *)self allKeys];
      ...
      if (v12)
      {
        ...
        while (2)
        {
          for (i = 0; i != v13; i = (char *)i + 1)
          {
            ...
            long long v17 = [(BMMultiStreamTimestampClockVector *)self timestampClockVectorForStreamIdentifier:v16];
            long long v18 = [v4 timestampClockVectorForStreamIdentifier:v16];
            id v19 = [v17 compareToVector:v18];
...
- (BMMultiStreamTimestampClockVector)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)BMMultiStreamTimestampClockVector;
  id v5 = [(BMMultiStreamTimestampClockVector *)&v12 init];
  if (v5)
  {
