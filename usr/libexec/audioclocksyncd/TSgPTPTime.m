...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = [(TSgPTPTime *)self nanosecondsSinceEpoch];
...
- (id)description
{
  unint64_t v3 = [(TSgPTPTime *)self seconds];
  uint64_t v4 = [(TSgPTPTime *)self nanoseconds];
  unint64_t v5 = [(TSgPTPTime *)self grandmasterIdentity];
  unsigned int v6 = [(TSgPTPTime *)self localPortNumber];
