...
{
  v9.receiver = self;
  v9.super_class = (Class)TSDgPTPUnicastLinkLayerEtEPort;
  v4 = [(TSDgPTPFDEtEPort *)&v9 initWithService:a3 pid:*(void *)&a4];
  v5 = v4;
  if (v4)
  {
    uint64_t v6 = [(TSDgPTPUnicastLinkLayerEtEPort *)v4 _destinationMACAddress];
...
+ (id)diagnosticInfoForService:(id)a3
{
  id v4 = a3;
  v15.receiver = a1;
  v15.super_class = (Class)&OBJC_METACLASS___TSDgPTPUnicastLinkLayerEtEPort;
