...
+ (id)iokitMatchingDictionaryForInterfaceName:(id)a3 andIPv6Address:(char *)a4
{
  ...
  CFStringRef v12 = @"DestinationIPAddress";
...
- (TSDgPTPUnicastUDPv6PtPPort)initWithService:(id)a3 pid:(int)a4
{
  ...
  if (v4)
  {
    uint64_t v6 = [(TSDgPTPUnicastUDPv6PtPPort *)v4 _destinationIPv6Address];
...
- (id)_sourceAddressString
{
  ...
  id v5 = [v4 iodPropertyForKey:@"SourceIPAddress"];

  if (v5)
  {
    uint64_t v6 = (unsigned __int8 *)[v5 bytes];
    uint64_t v7 = +[NSString stringWithFormat:@"%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x", *v6, v6[1], v6[2], v6[3], v6[4], v6[5], v6[6], v6[7], v6[8], v6[9], v6[10], v6[11], v6[12], v6[13], v6[14], v6[15]];
...
- (id)_destinationAddressString
{
  ...
  v4 = [(TSDgPTPPort *)self service];
  id v5 = [v4 iodPropertyForKey:@"DestinationIPAddress"];
...
- (id)propertiesForXPC
{
  ...
  uint64_t v6 = [(TSDgPTPPort *)self service];
...
+ (id)diagnosticInfoForService:(id)a3
{
  id v4 = a3;
  v15.receiver = a1;
  v15.super_class = (Class)&OBJC_METACLASS___TSDgPTPUnicastUDPv6PtPPort;
  id v5 = [[super diagnosticInfoForService:v4];
  uint64_t v6 = +[NSNumber numberWithInt:4];
  ...
  if (v11)
  {
    CFStringRef v12 = (unsigned __int8 *)[v11 bytes];
