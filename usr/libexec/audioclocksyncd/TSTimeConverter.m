  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = [[TSTAIUTCValue alloc] initWithDictionary:*(void *)(*((void *)&v14 + 1) + 8 * (void)v10)];
        if (v11) {
          [v5 addObject:v11];
        }
...
- (id)taiDateFromUTCDate:(id)a3
{
  ...
  v5 = [v4 dateByAddingTimeInterval:x0];
...
- (double)leapSecondForUTCDate:(id)a3
{
  ...
  if (v5)
  {
    ...
    while (1)
    {
      id v8 = [(NSArray *)self->_taiutc objectAtIndexedSubscript:v7];
