...
- (PTPDataPacket)initWithUSBBuffer:(void *)a3
{
  ...
  if (*(_DWORD *)a3 >= 0xCu && *((_WORD *)a3 + 2) == 2)
  {
    ...
    {
      id v12 = (char *)a3 + 6;
      v7->_operationCode = sub_10001F0CC(&v12);
      v7->_transactionID = sub_10001F148(&v12);
...
- (id)contentForUSB
{
  ...
  sub_10001F0B4((_WORD **)&__buf, 2);
  sub_10001F0B4((_WORD **)&__buf, self->_operationCode);
  sub_10001F130((_DWORD **)&__buf, self->_transactionID);
...
LABEL_11:
  ...
  ssize_t v7 = (ssize_t)[dataSource read:__buf length:__buf length:__buf offset:__buf];
LABEL_9:
  if (v7 != -1)
  {
    v3 += v7;
...
LABEL_15:
  ...
  int v12 = -2;
LABEL_16:
  sub_10001F130((_DWORD **)&__buf, v12);
...
- (id)description
{
  unint64_t v3 = sub_10001F5EC(self->_operationCode);
...
- (int64_t)copyToWrappedBytes:(id)a3 forTransport:(unsigned __int16)a4
{
  ...
  if ((v4 - 1) >= 2)
  {
    if (v4 == 3)
    {
      ...
      if (v7 == (char *)12)
      {
        sub_10001F130((_DWORD **)&v28, 12);
        sub_10001F130((_DWORD **)&v28, 10);
        goto LABEL_8;
      }
      ...
      if (!v18)
      {
        ...
        sub_10001F130((_DWORD **)&v28, v22);
        v27 = v28;
        sub_10001F130((_DWORD **)&v28, 10);
        sub_10001F130((_DWORD **)&v28, self->_transactionID);
...
LABEL_31:
  ...
  if (v7 != (char *)12)
  {
    if (self->_offsetInBuffer == self->_range.location)
    {
      ...
      sub_10001F130((_DWORD **)&v28, v17);
      sub_10001F0B4(&v28, 2);
      sub_10001F0B4(&v28, self->_operationCode);
      sub_10001F130((_DWORD **)&v28, self->_transactionID);
...
- (int64_t)copyHeaderToWrappedBytes:(id)a3 forTransport:(unsigned __int16)a4
{
  ...
  if ((v4 - 1) >= 2)
  {
    if (v4 == 3)
    {
      ...
      sub_10001F130((_DWORD **)&v19, v16);
      sub_10001F130((_DWORD **)&v19, 10);
      goto LABEL_15;
    }
LABEL_16:
    int64_t v17 = 0;
  ...
  sub_10001F130((_DWORD **)&v19, v12);
  sub_10001F0B4(&v19, 2);
  sub_10001F0B4(&v19, self->_operationCode);
LABEL_15:
  sub_10001F130((_DWORD **)&v19, self->_transactionID);
  int64_t v17 = 12;
  [v6 setLength:12];
LABEL_17:
