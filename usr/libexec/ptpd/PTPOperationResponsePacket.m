...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v11 = [v4 initWithResponseCode:v5 transactionID:v6 parameter1:v7 parameter2:v8 parameter3:v9 parameter4:v10 parameter5:v13];
...
- (PTPOperationResponsePacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 35) >= 0xFFFFFFEB && *((_DWORD *)a3 + 1) == 7)
  {
    ...
    if (v7)
    {
      ...
      v7->_responseCode = sub_10001F0CC(&v10);
...
- (id)contentForTCP
{
  ...
  uint64_t v7 = [v4 mutableBytes];
  sub_10001F130((_DWORD **)&v7, v3);
  sub_10001F130((_DWORD **)&v7, 7);
  sub_10001F0B4(&v7, self->_responseCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  if (v4 <= a4)
  {
    ...
    sub_10001F0B4(&v9, 3);
    sub_10001F0B4(&v9, self->_responseCode);
...
- (id)description
{
  ...
  uint64_t v3 = sub_1000207E8(self->_responseCode);
  uint64_t v4 = +[NSMutableString stringWithFormat:](NSMutableString, "stringWithFormat:", @" <-[%lu] %@\n", transactionID, v3);
