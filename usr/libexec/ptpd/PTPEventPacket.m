...
- (PTPEventPacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 27) >= 0xFFFFFFF3 && *((_DWORD *)a3 + 1) == 8)
  {
    ...
    {
      v10 = (char *)a3 + 8;
      v7->_eventCode = sub_10001F0CC(&v10);
...
- (id)contentForTCP
{
  ...
  sub_10001F130((_DWORD **)&v7, 8);
  sub_10001F0B4(&v7, self->_eventCode);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  if (v4 <= a4)
  {
    ...
    sub_10001F0B4(&v9, 4);
    sub_10001F0B4(&v9, self->_eventCode);
...
- (id)description
{
  uint64_t v3 = sub_100020898(self->_eventCode);
