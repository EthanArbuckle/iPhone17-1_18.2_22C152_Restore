...
- (PTPOperationRequestPacket)initWithTCPBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 39) >= 0xFFFFFFEB && *((_DWORD *)a3 + 1) == 6)
  {
    ...
    {
      v10 = (char *)a3 + 8;
      v7->_dataPhaseInfo = sub_10001F148(&v10);
      v7->_operationCode = sub_10001F0CC(&v10);
      v7->_transactionID = sub_10001F148(&v10);
      v7->_numParameters = (v3 - 18) >> 2;
      if ((v3 - 18) >= 4)
      {
        uint64_t v8 = 0;
        do
          v7->_parameters[v8++] = sub_10001F148(&v10);
...
- (PTPOperationRequestPacket)initWithUSBBuffer:(void *)a3
{
  ...
  if ((*(_DWORD *)a3 - 33) >= 0xFFFFFFEB && *((_WORD *)a3 + 2) == 1)
  {
    ...
    if (v7)
    {
      ...
      v7->_dataPhaseInfo = 0;
      v7->_operationCode = sub_10001F0CC(&v11);
      v8->_transactionID = sub_10001F148(&v11);
      v8->_numParameters = (v3 - 12) >> 2;
      if ((v3 - 12) >= 4)
      {
        uint64_t v9 = 0;
        do
          v8->_parameters[v9++] = sub_10001F148(&v11);
...
- (id)contentForTCP
{
  ...
  v7 = [v4 mutableBytes];
  sub_10001F130((_DWORD **)&v7, v3);
  sub_10001F130((_DWORD **)&v7, 6);
  sub_10001F130((_DWORD **)&v7, self->_dataPhaseInfo);
  sub_10001F0B4(&v7, self->_operationCode);
  sub_10001F130((_DWORD **)&v7, self->_transactionID);
  if (self->_numParameters >= 1)
  {
    uint64_t v5 = 0;
    do
      sub_10001F130((_DWORD **)&v7, self->_parameters[v5++]);
...
- (id)contentForUSBUsingBuffer:(void *)a3 capacity:(unsigned int)a4
{
  ...
  if (v4 <= a4)
  {
    ...
    sub_10001F130((_DWORD **)&v9, v4);
    sub_10001F0B4(&v9, 1);
    sub_10001F0B4(&v9, self->_operationCode);
    sub_10001F130((_DWORD **)&v9, self->_transactionID);
    if (self->_numParameters >= 1)
    {
      uint64_t v7 = 0;
      do
        sub_10001F130((_DWORD **)&v9, self->_parameters[v7++]);
...
- (id)description
{
  ...
  uint64_t v3 = sub_10001F5EC(self->_operationCode);
  uint64_t v4 = +[NSMutableString stringWithFormat:@" ->[%lu] %@\n", transactionID, v3];
