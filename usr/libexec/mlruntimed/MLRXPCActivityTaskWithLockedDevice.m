...
- (id)criteria
{
  ...
  {
    v3 = objc_opt_new();
    id v4 = [v3 wakeUpPeriodInSeconds];
  }
  else
  {
    id v4 = (id)XPC_ACTIVITY_INTERVAL_1_DAY;
  }
  xpc_dictionary_set_int64(v2, XPC_ACTIVITY_INTERVAL, (int64_t)v4);
...
- (void)startTaskWithCompletion:(id)a3
{
  ...
  v6 = [v5 allNonFedStatsUnrestrictedBundleIds];

  v7 = [(MLRXPCActivityTaskWithLockedDevice *)self createTaskScheduler];
