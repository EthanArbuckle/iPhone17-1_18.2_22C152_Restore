...
- (FLSpring)initWithValue:(double)a3
{
  ...
  if (v4)
  {
    ...
    *(_OWORD *)(v4 + 600) = xmmword_10028D3E8;
    *(_OWORD *)(v4 + 616) = unk_10028D3F8;
    *(_OWORD *)(v4 + 632) = xmmword_10028D408;
    *(_OWORD *)(v4 + 648) = unk_10028D418;
    *(_OWORD *)(v4 + 664) = xmmword_10028D3E8;
    *(_OWORD *)(v4 + 680) = unk_10028D3F8;
...
- (void)setTarget:(double)a3
{
  ...
  if (rubberbandRange != 1.79769313e308)
  {
    ...
    double v4 = sub_100006390(v4, minimumTarget, rubberbandRange, self->_rubberbandFactor);
  }
  ...
  {
    sub_100005E90((uint64_t)&self->_s, v4);
  }
}
...
- (BOOL)isStable
{
  ...
  if (v3)
  {
    ...
    v8[3] = v6;
    LOBYTE(v3) = sub_100006F58((double *)v8);
  }
  return v3;
}
...
- (double)_projectedTargetForVelocity:(double)a3
{
  ...
  return sub_10000636C(v5, a3, projectionDeceleration);
}
...
- (void)resetImmediatelyToValue:(double)a3
{
  ...
  sub_100005D70((uint64_t)v11, a3, 0.0, v6, v7);
  memcpy(&self->_s, v11, 0x160uLL);
  *(_OWORD *)p_stablePositionThreshold = *(_OWORD *)&self->_stableValueThreshold;
  sub_100006F8C((uint64_t)v11, 0.0, 0.0, 0.0, self->_offsetParameters.dampingRatio, self->_offsetParameters.response);
  long long v8 = v11[5];
...
- (void)setTracking:(BOOL)a3
{
  ...
  if (tracking != a3)
  {
    ...
    if (!a3)
    {
      ...
      sub_100005F0C((uint64_t)&self->_s, self->_s.anchor.anchor, v8, v7);
    }
    [(FLSpring *)self _updateForEffectiveParameters];
  }
}
...
- (void)step:(double)a3
{
  ...
  if (self->_retargetImpulse > 0.0)
  {
    *(void *)&__src[0] = 0;
    [(FLSpring *)self _effectiveParameters];
    sub_100005CF4((double *)__src, 0, v8, v9);
  ...
  sub_100006050(v18, (double *)__src, v10);
  ...
  v18[3] = v14;
  sub_100007054((uint64_t)v18, (uint64_t)__src, v11);
...
- (void)_updateForEffectiveParameters
{
  ...
  double v6 = v5;
  p_s = &self->_s;
  sub_100005F70((uint64_t)p_s, v8, v9);

  sub_100005FE8((uint64_t)p_s, v4, v6);
}
