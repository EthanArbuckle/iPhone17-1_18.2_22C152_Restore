...
{
  id v5 = a3;
  CTFontRef v4 = CTFontCreateWithName(@"Helvetica", 0.0, 0);
  if (v4) {
    [v5 setFont:v4];
  }
  CFRelease(v4);
...
+ (id)colorVariationWithIndex:(int64_t)a3
{
  v3 = (double *)((char *)&unk_1000BF7E0 + 24 * (a3 % 6));
  id v4 = [[BKDisplayAnnotationColorVariationStyle alloc] initWithRed:*v3 green:v3[1] blue:v3[2]];
