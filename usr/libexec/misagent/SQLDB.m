...
- (SQLDB)initWithDatabaseURL:(id)a3 asReadOnly:(BOOL)a4
{
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      BOOL v13 = sub_10000A608(v9->_db, 0);
      db = v9->_db;
    }
    v9->_readonly = v13;
...
- (void)setupPermissions
{
  ...
  sub_10000A628((const char *)[v2 UTF8String]);
}
...
- (id)readSetting:(id)a3
{
  ...
  id v13 = sub_1000077FC;
  int v14 = sub_10000780C;
  id v15 = 0;
...
- (unint64_t)tableRowCount:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      sub_10000B57C((uint64_t)v4, v6, v7);
    }
  }
  int v8 = (void *)v13[5];
  if (v8) {
