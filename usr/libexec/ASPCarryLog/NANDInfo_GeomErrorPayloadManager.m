...
- (void)populateOtherStats:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v15 = 0u;
    long long v16 = 0u;
    id v6 = [&off_1000C19A8 countByEnumeratingWithState:&v15 objects:v19 count:16];
    if (v6)
    {
      id v7 = v6;
      id v8 = 0;
      ...
      do
      {
        ...
        {
          if (*(void *)v16 != v9) {
            objc_enumerationMutation(&off_1000C19A8);
          }
        ...
        while (v7 != v10);
        id v7 = [&off_1000C19A8 countByEnumeratingWithState:&v15 objects:v19 count:16];
      }
      while (v7);
    }
  }
...
LABEL_25:
        ...
        {
          [v14 setObject:&off_1000B1510 forKeyedSubscript:@"ESR_page_i"];
          [v14 setObject:&off_1000B1510 forKeyedSubscript:@"ESR_page_i_status"];
