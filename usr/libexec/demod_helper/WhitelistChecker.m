...
- (BOOL)load
{
  ...
  else
  {
    v19 = sub_100027250();
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR)) {
      sub_1000334B8((uint64_t)v11, v19);
    }
  }
...
- (id)checkManifest:(id)a3
{
  ...
  p_cache = &OBJC_METACLASS___MSDHSnapshottedDataSaver.cache;
...
LABEL_14:
      id v6 = v23;
      p_cache = (void **)(&OBJC_METACLASS___MSDHSnapshottedDataSaver + 16);
      if (v18) {
        goto LABEL_18;
      }
LABEL_15:
    ...
    || [v7 isEqualToString:@"NSFileTypeDirectory"])
  {
    ...
    if (([v5 isEqualToString:v8] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG)) {
        sub_1000335B8((uint64_t)v5, (uint64_t)v8, v9);
      }
    }
  }
  else
...
- (BOOL)handleSystemContainerFiles:(id)a3 withMetadata:(id)a4
{
  ...
  BOOL v9 = v8 == 0;
  if (v8) {
    BOOL v10 = &off_1000521D8;
  }
  else {
    BOOL v10 = &off_100052208;
  }
  if (v8) {
    unsigned int v11 = &off_1000521F0;
  }
  else {
    unsigned int v11 = &off_100052220;
  }
  long long v42 = 0u;
  long long v43 = 0u;
  long long v40 = 0u;
  ...
  id v13 = [v10 countByEnumeratingWithState:&v40 objects:v45 count:16];
  id v35 = (id)v12;
  if (v13)
  {
    id v14 = v13;
    ...
    while (2)
    {
      for (i = 0; i != v14; i = (char *)i + 1)
      {
        ...
        if ([v5 rangeOfString:v17] != (id)0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          BOOL v19 = [v5 stringByReplacingOccurrencesOfString:v17 withString:&stru_10004D8B8];
          int v20 = 1;
          goto LABEL_20;
        }
      }
  ...
  if (v21)
  {
    ...
    while (2)
    {
      for (j = 0; j != v22; j = (char *)j + 1)
      {
        ...
        {
          uint64_t v28 = [v5 stringByReplacingOccurrencesOfString:v25 withString:&stru_10004D8B8];
