...
- (BOOL)enumerateAndCollectMetaData:(id)a3 relativeTo:(id)a4 skip:(id)a5 superSet:(id)a6 handler:(id)a7
{
  ...
  unsigned int v22 = [v19 enumeratorAtURL:v20 includingPropertiesForKeys:v21 options:0 errorHandler:&stru_10004CE30];
...
LABEL_38:
    ...
    if (v43)
    {
      ...
      v45 = [v47 stringByReplacingOccurrencesOfString:*p_rootPath withString:&stru_10004D8B8];
    ...
    {
      v46 = [v17 path];
      v45 = [v46 stringByReplacingOccurrencesOfString:*p_rootPath withString:&stru_10004D8B8];
    }
