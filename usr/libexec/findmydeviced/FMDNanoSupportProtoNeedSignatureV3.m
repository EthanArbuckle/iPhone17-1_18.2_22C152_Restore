...
{
  v7.receiver = self;
  v7.super_class = (Class)FMDNanoSupportProtoNeedSignatureV3;
  v3 = [(FMDNanoSupportProtoNeedSignatureV3 *)&v7 description];
  v4 = [(FMDNanoSupportProtoNeedSignatureV3 *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return FMDNanoSupportProtoNeedSignatureV3ReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[FMDNanoSupportProtoNeedSignatureV3 setRequestJsonData:](self, "setRequestJsonData:");
    id v4 = v5;
  }
  if (v4[1])
  {
    -[FMDNanoSupportProtoNeedSignatureV3 setActivationLockRequestUUIDString:](self, "setActivationLockRequestUUIDString:");
    id v4 = v5;
  }
}
