...
- (BOOL)isValid
{
  ...
  if (v4)
  {
    v2 = [(FMDMagSafeAccessory *)self name];
    if (!v2)
    {
      BOOL v10 = 1;
      goto LABEL_11;
  ...
  uint64_t v5 = [(FMDMagSafeAccessory *)self serialNumbers];
  if (!v5)
  {
    BOOL v10 = 1;
    if (!v4) {
  ...
  v6 = (void *)v5;
  uint64_t v7 = [(FMDMagSafeAccessory *)self accessoryIdentifier];
  if (v7)
  {
    v8 = (void *)v7;
...
- (FMDMagSafeAccessory)initWithPhysicalAccessory:(id)a3 fmEnabled:(BOOL)a4
{
  ...
  if (v7)
  {
    ...
    [(FMDMagSafeAccessory *)v7 setFirmwareVersion:v12];
    ...
    {
      v14 = [v6 accessoryType];
      [(FMDMagSafeAccessory *)v7 setAccessoryType:v14];
    }

    v17 = [v6 serialNumber];
    [(FMDMagSafeAccessory *)v7 setDeviceDiscoveryId:v17];

    if (v4)
    {
      v18 = [v6 name];
      [(FMDMagSafeAccessory *)v7 setName:v18];
    }
...
- (id)description
{
  ...
  BOOL v4 = [(FMDMagSafeAccessory *)self serialNumbers];
  uint64_t v5 = [(FMDMagSafeAccessory *)self firmwareVersion];
...
{
  id v4 = a3;
  uint64_t v5 = [(FMDMagSafeAccessory *)self accessoryIdentifier];
  [v4 encodeObject:v5 forKey:@"accessoryIdentifier"];

  id v6 = [(FMDMagSafeAccessory *)self accessoryType];
  [v4 encodeObject:v6 forKey:@"accessoryType"];

  uint64_t v7 = [(FMDMagSafeAccessory *)self serialNumbers];
  ...
  [v4 encodeBool:-[FMDMagSafeAccessory findMyEnabled](self, "findMyEnabled") forKey:@"findMyEnabled"];
