...
- (BOOL)start
{
  ...
  else
  {
    ...
    handler[2] = sub_100099E04;
    handler[3] = &unk_1002DC678;
    handler[4] = self;
  ...
  if (v3)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR)) {
        sub_100242108(self, (uint64_t)v7, v8);
      }
    ...
    else
    {
      ...
      dispatch_source_t v11 = sub_100004238();
