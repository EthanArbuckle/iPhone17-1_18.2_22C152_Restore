...
{
  id v4 = a3;
  signed int v5 = [(FMDCommandHandler *)self commandParams];
  ...
  else
  {
    ...
    {
      *(_WORD *)v13 = 0;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "Not acking the track command because there is no ack URL", v13, 2u);
    }
  }
}
