...
- (void)submit
{
  if (self)
  {
    ...
    {
      v6 = +[NSNumber numberWithUnsignedLongLong:](NSNumber, "numberWithUnsignedLongLong:");
      [(NSMutableDictionary *)self->super._eventDictionary setObject:v6 forKeyedSubscript:@"pipeDisconnectedDuration"];
    }
  }

  sub_10012D730((uint64_t)self, @"com.apple.networkrelay.analytics.lnkMgrbluetooth");
}
