...
- (CLIndoorAvailabilityTileParams)initWithAvailabilityTile:(void *)a3
{
  ...
  *((double *)v4 + 50) = sub_10009C44C((uint64_t)a3);
  *((float *)v4 + 84) = sub_10009C418((uint64_t)a3);
  *((_DWORD *)v4 + 85) = sub_10009C430((uint64_t)a3);
  *((_DWORD *)v4 + 86) = sub_10009C50C((uint64_t)a3);
  *((_DWORD *)v4 + 87) = sub_10000D688((uint64_t)a3);
  *((_DWORD *)v4 + 88) = sub_10009C518((uint64_t)a3);
  int v5 = sub_10009C43C((uint64_t)a3);
  v4[328] = v5;
  if (v5)
  {
    sub_1001E0EB4((uint64_t)a3, (uint64_t)v9);
    char v6 = v15;
    v4[329] = v15 & 1;
    if (v6)
    {
...
LABEL_19:
  ...
  *(_DWORD *)(v4 + 329) = 0;
LABEL_10:
  *((_DWORD *)v4 + 93) = sub_10009C424((uint64_t)a3);
  v4[333] = sub_10009C4FC((uint64_t)a3);
  *((float *)v4 + 94) = sub_10009C40C((uint64_t)a3);
  *((_DWORD *)v4 + 95) = sub_10000984C((uint64_t)a3);
  *((_DWORD *)v4 + 96) = sub_10000BC74((uint64_t)a3);
  *((_DWORD *)v4 + 97) = sub_10000BAA0((uint64_t)a3);
  *((_DWORD *)v4 + 98) = sub_100004860((uint64_t)a3);
  sub_10003E040((uint64_t)a3, v9);
  if (v4[8])
  {
    if (v9[0])
    {
      sub_10003DA28((uint64_t)(v4 + 16), (uint64_t)&v10);
      if (!v9[0]) {
        return (CLIndoorAvailabilityTileParams *)v4;
      }
      goto LABEL_22;
    }
    sub_10006E2E4((void *)v4 + 2);
    v4[8] = 0;
    if (v9[0]) {
LABEL_22:
    }
  ...
  {
    sub_10003E0AC((uint64_t)(v4 + 16), (uint64_t)&v10);
    v4[8] = 1;
    if (v9[0]) {
      goto LABEL_22;
    }
...
- (optional<proto::params::LocalizerParameters>)localizerParams
{
  ...
  {
    self = (CLIndoorAvailabilityTileParams *)sub_10003E0AC((uint64_t)(v2 + 8), (uint64_t)&self->_optionalParams.m_storage.dummy_.aligner_ + 7);
    *objc_super v3 = 1;
  }
...
- (void).cxx_destruct
{
  if (self->_optionalParams.m_initialized)
  {
    sub_10006E2E4((a8 *)((char *)&self->_optionalParams.m_storage.dummy_.aligner_ + 7));
