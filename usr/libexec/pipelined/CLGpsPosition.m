...
- (CLGpsPosition)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    *((_OWORD *)v5 + 1) = v15[0];
    *((_OWORD *)v5 + 2) = v12;
    sub_100034350(v4, (char *)v15);
    memcpy(v5 + 176, v15, 0x230uLL);
    *((void *)v5 + 1) = sub_1000343E4(v4);
    v13 = v5;
  }
...
{
  id v4 = a3;
  sub_1001E184C(v4, (uint64_t)&self->_gpsLocation);
  sub_1001E1860(v4, (uint64_t)&self->_gpsLocation.ellipsoidalAltitude);
  sub_1001E191C(v4, (const char *)&self->_expiry);
}
...
- (id)description
{
  ...
  [(CLGpsPosition *)self gpsLocation];
  $F24F406B2B787EFB06265DBA3D28CBD5 v3 = +[NSString stringWithFormat:@"lat/lon=[%lf, %lf]", v6, v5];
