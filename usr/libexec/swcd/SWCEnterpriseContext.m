...
- (NSData)state
{
  if ([(NSDictionary *)self->_associatedDomains count] || [(NSSet *)self->_managedModeAppIDs count])
  {
    ...
    if (v6)
    {
      ...
      id v8 = v6;
      CC_SHA256([v8 bytes], (CC_LONG)[v8 length], (unsigned __int8 *)v11);
...
- (void)_loadEnterpriseData
{
  if (qword_10003B1D0 != -1) {
    dispatch_once(&qword_10003B1D0, &stru_100034B00);
  }
  if (qword_10003B1D8)
  {
    v33 = [(id)qword_10003B1D8 sharedConnection];
  ...
  {
    id v14 = (id)qword_10003B1C8;
  }
  if (qword_10003B1E8 != -1) {
    dispatch_once(&qword_10003B1E8, &stru_100034B20);
  }
  v19 = qword_10003B1E0;
  if (os_log_type_enabled((os_log_t)qword_10003B1E0, OS_LOG_TYPE_ERROR))
  {
