...
+ (void)initialize
{
  if ((id)objc_opt_class() == a1) {
    qword_10006EB38 = (uint64_t)os_log_create("com.apple.SensorKit", "SensorsCache");
  }
}

+ (void)setDefaultCache:(id)a3
{
  if ((id)qword_10006EB40 != a3)
  {

    qword_10006EB40 = (uint64_t)a3;
  }
}
...
- (SRSensorsCache)init
{
    ...
    || (v4 = [+[NSBundle bundleForClass:v3] bundleURL]) == 0)
  {
    ...
    v4 = +[NSURL fileURLWithPath:isDirectory:relativeToURL:](NSURL, "fileURLWithPath:isDirectory:relativeToURL:", +[NSString pathWithComponents:&off_100061468], 1, v5);
  }
