...
+ (void)initialize
{
  if ((id)objc_opt_class() == a1) {
    qword_10006EC30 = (uint64_t)os_log_create("com.apple.SensorKit", "TCCStore");
  }
}
...
- (BOOL)isOverriddenForService:(id)a3
{
  ...
  {
    v4 = qword_10006EC30;
    if (os_log_type_enabled((os_log_t)qword_10006EC30, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543362;
      id v7 = a3;
      _os_log_error_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_ERROR, "Could not retrieve authorization override information for TCC service %{public}@", buf, 0xCu);
    }
  }
  return 0;
}
