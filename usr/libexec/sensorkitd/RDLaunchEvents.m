...
+ (void)initialize
{
  if ((id)objc_opt_class() == a1) {
    qword_10006EBE8 = (uint64_t)os_log_create("com.apple.SensorKit", "RDLaunchEvents");
  }
}
    ...
    *(void *)&long long v5 = 138543362;
    ...
    do
    {
      for (i = 0; i != v4; i = (char *)i + 1)
      {
        ...
        v9 = sub_100026D24((uint64_t)self, v8);
        v10 = qword_10006EBE8;
        if (v9)
        {
          ...
          handler[2] = sub_10002738C;
          handler[3] = &unk_10005D368;
          objc_copyWeak(&v15, &location);
          handler[4] = v8;
          xpc_activity_register(v11, XPC_ACTIVITY_CHECK_IN, handler);
          objc_destroyWeak(&v15);
        }
        else if (os_log_type_enabled((os_log_t)qword_10006EBE8, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = v12;
          v22 = v8;
