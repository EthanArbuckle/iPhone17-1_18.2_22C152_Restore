...
- (SRReaderRecordingRequest)initWithCoder:(id)a3
{
  ...
  if (v4)
  {
    ...
    v4->_sensorConfiguration = (NSDictionary *)[a3 decodeObjectOfClasses:+[NSSet setWithObjects:](NSSet, "setWithObjects:", v5, v6, v7, v8, v9, objc_opt_class(), 0) forKey:@"SensorConfiguration"];
  }
  return v4;
}
