...
- (state_estimation_model)init
{
  ...
  v4 = [(state_estimation_model *)self initWithContentsOfURL:v3 error:0];
...
- (state_estimation_model)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(state_estimation_model *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v8 = [(state_estimation_model *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(state_estimation_model *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(state_estimation_modelOutput *)v12 initWithHealth_state_estimation:v14];
  }
  else
  {
    v15 = 0;
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(state_estimation_model *)self model];
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(state_estimation_model *)self model];
...
- (id)predictionFromDaily_history_input:(id)a3 usage_history_input:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  id v10 = [[state_estimation_modelInput alloc] initWithDaily_history_input:v9 usage_history_input:v8];

  id v11 = [(state_estimation_model *)self predictionFromFeatures:v10 error:a5];
  ...
  if (v12)
  {
    ...
    if ((uint64_t)[v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(state_estimation_modelOutput *)v16 initWithHealth_state_estimation:v18];
