...
LABEL_16:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
    sub_100038F94(v11, a2);
  }
  if ((unint64_t)[v5 length] <= 4)
  {
    v12 = v6->_log;
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR)) {
      sub_100038E3C(v12, v5);
    }
    goto LABEL_16;
  }
  id v13 = v5;
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 67109376;
    ...
    __int16 v31 = 1024;
    int v32 = v17;
    _os_log_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_DEFAULT, "Crashlog info report header extracted: version %d, # of crashlogs %d", buf, 0xEu);
  }
