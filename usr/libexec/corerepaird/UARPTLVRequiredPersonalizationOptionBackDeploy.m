...
- (id)description
{
  id v3 = +[UARPTLVRequiredPersonalizationOptionBackDeploy metaDataTableEntry];
  id v4 = [v3 objectForKeyedSubscript:@"Name"];
  id v5 = +[UARPMetaDataTLVBackDeploy tlvTypeName:*(&self->super.super._tlvLength + 1)];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVRequiredPersonalizationOptionBackDeploy tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVRequiredPersonalizationOptionBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVRequiredPersonalizationOptionBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  uint64_t v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVRequiredPersonalizationOptionBackDeploy tlvType]);
  v6[1] = v2;
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    objc_super v5 = objc_opt_new();
    [v5 setTssOption:uarpNtohl(*(_DWORD *)a4)];
  }
  else
  {
    objc_super v5 = 0;
