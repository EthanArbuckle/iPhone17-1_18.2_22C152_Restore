...
- (FTABFileBackDeploy)init
{
  ...
  if (v2)
  {
    ...
    id v8 = +[NSData dataWithBytes:"rkosftabrkosftab" length:8];
    magic = v2->_magic;
    v2->_magic = v8;
  }
  return v2;
...
- (BOOL)parseFileData
{
    ...
    if (*((void *)filePointer + 4) == 0x42415446534F4B52 || *v12 == 0x62617466736F6B72)
    {
      ...
      if (v17)
      {
        ...
        if (![(FTABFileBackDeploy *)self fileValidForOffset:v18 length:*((unsigned int *)filePointer + 5)])
        {
          ...
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_10002FA9C(v2, v29, v30, v31, v32, v33, v34, v35);
          }
          goto LABEL_26;
        }
            ...
            i += 16)
      {
        ...
        if (!v25)
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_10002F8D4((unsigned __int8 *)&filePointer[i + 48], v2);
          }
          goto LABEL_26;
        }
        v26 = v25;
  ...
  else
  {
    v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
    if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
      sub_10002F85C(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
LABEL_26:
...
- (BOOL)writeSubfileToURL:(id)a3 tag:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (v9) {
      unsigned __int8 v10 = [v9 writeBytes:objc_msgSend(v8, "dataPointer") length:objc_msgSend(v8, "dataLength")];
    }
    else {
