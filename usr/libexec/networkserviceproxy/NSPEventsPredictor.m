...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "Could not load NSPEventsPredictor.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v8 = [(NSPEventsPredictor *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(NSPEventsPredictor *)self model];
...
{
  id v6 = a3;
  id v7 = [[NSPEventsPredictorInput alloc] initWithLstm_input:v6];

  id v8 = [(NSPEventsPredictor *)self predictionFromFeatures:v7 error:a4];
