...
- (NSPEventsNormalizer)initWithConfiguration:(id)a3 error:(id *)a4;
- (NSPEventsNormalizer)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (NSPEventsNormalizer)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (NSPEventsNormalizer)initWithMLModel:(id)a3;
- (id)predictionFromFeatures:(id)a3 error:(id *)a4;
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5;
- (id)predictionFromNormalizer_input:(id)a3 error:(id *)a4;
...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "Could not load NSPEventsNormalizer.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (NSPEventsNormalizer)initWithMLModel:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NSPEventsNormalizer;
...
- (NSPEventsNormalizer)init
{
  ...
  v4 = [(NSPEventsNormalizer *)self initWithContentsOfURL:v3 error:0];
...
- (NSPEventsNormalizer)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(NSPEventsNormalizer *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v8 = [(NSPEventsNormalizer *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(NSPEventsNormalizer *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(NSPEventsNormalizerOutput *)v12 initWithIdentity:v14];
  }
  else
  {
    v15 = 0;
...
{
  id v6 = a3;
  id v7 = [[NSPEventsNormalizerInput alloc] initWithNormalizer_input:v6];

  id v8 = [(NSPEventsNormalizer *)self predictionFromFeatures:v7 error:a4];
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  v11 = [(NSPEventsNormalizer *)self model];
  ...
  if (v12)
  {
    ...
    if ((uint64_t)[v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(NSPEventsNormalizerOutput *)v16 initWithIdentity:v18];
