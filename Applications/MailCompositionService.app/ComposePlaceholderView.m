...
- (void)_createSubviews
{
  ...
  v14 = [v13 localizedStringForKey:@"TO" value:&stru_100018898 table:@"Main"];
  ...
  v18 = [v17 localizedStringForKey:@"CC/BCC" value:&stru_100018898 table:@"Main"];
  ...
  v22 = [v21 localizedStringForKey:@"CC" value:&stru_100018898 table:@"Main"];
  ...
  v26 = [v25 localizedStringForKey:@"BCC" value:&stru_100018898 table:@"Main"];
...
- (void)_updateMultiFieldWithModel:(id)a3
{
  ...
  v5 = [v4 localizedStringForKey:@"CC/BCC" value:&stru_100018898 table:@"Main"];
  ...
  if ([v12 showSenderAddress])
  {
    ...
    if (v6)
    {
      ...
      uint64_t v8 = [v7 localizedStringForKey:@"CC/BCC/FROM" value:&stru_100018898 table:@"Main"];
...
- (void)_setSubject:(id)a3
{
  ...
  else
  {
    ...
    if (v7) {
      ...
      [v3 localizedStringForKey:@"NEW_MESSAGE_LONG" value:&stru_100018898 table:@"Main"];
    }
    else {
      id v4 = {;
    }
      [v4 localizedStringForKey:@"NEW_MESSAGE" value:&stru_100018898 table:@"Main"];
    double v9 = };
    int v8 = v7 ^ 1;
  }
