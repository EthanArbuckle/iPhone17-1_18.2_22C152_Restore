...
- (void).cxx_destruct
{
  ...
  swift_release();
  sub_100008648((uint64_t)self + OBJC_IVAR____TtC22PeopleMessagesAskToBuy28RequestMessageViewController_eventNotifier, &qword_100039778);
  sub_100011E7C((uint64_t)self + OBJC_IVAR____TtC22PeopleMessagesAskToBuy28RequestMessageViewController_bubbleDelegate);
...
- (CGSize)contentSizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  double v6 = sub_1000091E0(width, height);
  double v8 = v7;
...
- (_TtC22PeopleMessagesAskToBuy28RequestMessageViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC22PeopleMessagesAskToBuy28RequestMessageViewController *)sub_10000D55C(v5, v7, a4);
}

- (_TtC22PeopleMessagesAskToBuy28RequestMessageViewController)initWithCoder:(id)a3
{
  return (_TtC22PeopleMessagesAskToBuy28RequestMessageViewController *)sub_10000D870(a3);
}

- (_TtC22PeopleMessagesAskToBuy28RequestMessageViewController)initWithShouldBeSheetPresentationControllerDelegate:(BOOL)a3
{
  return (_TtC22PeopleMessagesAskToBuy28RequestMessageViewController *)sub_10000DB10(a3);
}
