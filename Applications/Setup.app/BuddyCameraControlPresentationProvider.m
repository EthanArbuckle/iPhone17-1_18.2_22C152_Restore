...
- (_TtC5Setup38BuddyCameraControlPresentationProvider)initWithIsIntelligenceEnabled:(BOOL)a3 preferenceController:(id)a4
{
  *((unsigned char *)&self->super.isa + OBJC_IVAR____TtC5Setup38BuddyCameraControlPresentationProvider_isIntelligenceEnabled) = a3;
  *(Class *)((char *)&self->super.isa
           + OBJC_IVAR____TtC5Setup38BuddyCameraControlPresentationProvider_preferenceController) = (Class)a4;
  v7.receiver = self;
...
- (BOOL)shouldPresentVisualIntelligencePane
{
  if (*((unsigned char *)&self->super.isa + OBJC_IVAR____TtC5Setup38BuddyCameraControlPresentationProvider_isIntelligenceEnabled) != 1) {
    return 0;
  }
  v2 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC5Setup38BuddyCameraControlPresentationProvider_preferenceController);
  Swift::Bool v3 = self;
...
- (_TtC5Setup38BuddyCameraControlPresentationProvider)init
{
  result = (_TtC5Setup38BuddyCameraControlPresentationProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
