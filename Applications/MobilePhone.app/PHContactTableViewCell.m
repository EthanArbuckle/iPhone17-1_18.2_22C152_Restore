...
- (void)setActionButtonTappedHandler:(id)a3
{
  ...
  id actionButtonTappedHandler = self->_actionButtonTappedHandler;
  self->_id actionButtonTappedHandler = v4;

  _objc_release_x1(v4, actionButtonTappedHandler);
}
...
- (void)_updateLayout
{
  ...
  id v4 = [(PHContactTableViewCell *)self featureFlags];
...
- (void)setActionType:(id)a3
{
  ...
  if (v4)
  {
    actionType = (NSString *)[(NSString *)actionType isEqualToString:v4];
    id v4 = v15;
    if (actionType) {
      goto LABEL_7;
    }
  ...
  double v6 = (NSString *)[v4 copy];
  double v7 = self->_actionType;
  self->_actionType = v6;

  double v8 = [(id)objc_opt_class() imageForActionType:v15];
  double v9 = [(PHContactTableViewCell *)self subtitleImageView];
  [v9 setImage:v8];

  actionType = (NSString *)[(PHContactTableViewCell *)self tapTargets];
  id v4 = v15;
  if (actionType)
  {
    double v10 = [(id)objc_opt_class() actionButtonImageForActionType:v15];
    [(PHContactTableViewCell *)self setActionButtonImage:v10];

    id v11 = [(PHContactTableViewCell *)self actionButton];
    unsigned int v12 = [(PHContactTableViewCell *)self actionButtonImage];
    [v11 configureForImage:v12];

    double v13 = [(PHContactTableViewCell *)self actionButton];
    [v13 sizeToFit];

    double v14 = [(PHContactTableViewCell *)self actionButton];
    [(PHContactTableViewCell *)self setAccessoryView:v14];

    id v4 = v15;
  }
LABEL_7:

  _objc_release_x1(actionType, v4);
}
...
- (void)setEditing:(BOOL)a3 animated:(BOOL)a4
{
  ...
  double v6 = [(PHContactTableViewCell *)self avatarViewController];
