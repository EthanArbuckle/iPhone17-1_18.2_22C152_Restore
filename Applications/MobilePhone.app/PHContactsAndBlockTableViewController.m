    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (!v24)
        {
          ...
          id v24 = [v35 localizedStringForKey:@"UNKNOWN_CALLER" value:&stru_100285990 table:@"PHRecents"];
        }
      }
      v36 = [v14 titleLabel];
      [v36 setText:v24];
...
- (void)showBlockAllAlert
{
  ...
  id v4 = [v3 localizedStringForKey:@"REPORT_BLOCK_FACETIME_ALERT_REPORT_BLOCK_ALERT_TITLE" value:&stru_100285990 table:@"PHRecents"];
  uint64_t v5 = +[UIAlertController alertControllerWithTitle:0 message:v4 preferredStyle:0];

  int v6 = +[NSBundle mainBundle];
  id v7 = [v6 localizedStringForKey:@"REPORT_FACETIME_ALERT_CANCEL" value:&stru_100285990 table:@"PHRecents"];
  v8 = +[UIAlertAction actionWithTitle:v7 style:1 handler:0];

  long long v9 = +[NSBundle mainBundle];
  long long v10 = [v9 localizedStringForKey:@"REPORT_BLOCK_FACETIME_ALERT_BLOCK_ALL" value:&stru_100285990 table:@"PHRecents"];
...
- (void)showBlockUnknownAlert
{
  ...
  long long v9 = +[NSBundle mainBundle];
  long long v10 = [v9 localizedStringForKey:@"REPORT_BLOCK_FACETIME_ALERT_BLOCK_UNKNOWN" value:&stru_100285990 table:@"PHRecents"];
  v12[0] = _NSConcreteStackBlock;
  v12[1] = 3221225472;
...
{
  id v3 = +[NSBundle mainBundle];
  id v4 = [v3 localizedStringForKey:@"RECENTS_REPORT_SINGLE_PARTICIPANT_AlERT_MESSAGE" value:&stru_100285990 table:@"PHRecents"];
  ...
  long long v9 = +[NSBundle mainBundle];
  long long v10 = [v9 localizedStringForKey:@"REPORT_FACETIME_ALERT_CANCEL" value:&stru_100285990 table:@"PHRecents"];
  long long v11 = +[UIAlertAction actionWithTitle:v10 style:1 handler:0];

  long long v12 = +[NSBundle mainBundle];
  double v13 = [v12 localizedStringForKey:@"REPORT_SINGLE_PARTICIPANT_AlERT_REPORT_TITLE" value:&stru_100285990 table:@"PHRecents"];
