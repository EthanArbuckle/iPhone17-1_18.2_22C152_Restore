...
- (NSUUID)messageUUID
{
  ...
  uint64_t v6 = sub_100016F7C(&qword_1000688F8);
  __chkstk_darwin(v6 - 8);
  v8 = (char *)&v15 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  sub_10001A9F0((uint64_t)self + OBJC_IVAR___MPMessageID_value, (uint64_t)v5);
  int EnumCaseMultiPayload = swift_getEnumCaseMultiPayload();
  uint64_t v10 = sub_100041340();
...
- (BOOL)isEqual:(id)a3
{
  ...
  char v6 = sub_1000197D0((uint64_t)v8);

  sub_10001AA54((uint64_t)v8, &qword_1000688F0);
  return v6 & 1;
}
