...
- (NSString)senderDestinationID
{
  return (NSString *)sub_100017B18((char *)self, (uint64_t)a2, (SEL *)&selRef_senderDestinationID);
}

- (NSString)senderISOCountryCode
{
  return (NSString *)sub_100017B18((char *)self, (uint64_t)a2, (SEL *)&selRef_senderISOCountryCode);
}

- (NSString)receiverDestinationID
{
  return (NSString *)sub_100017B18((char *)self, (uint64_t)a2, (SEL *)&selRef_receiverDestinationID);
}

- (NSString)receiverISOCountryCode
{
  return (NSString *)sub_100017B18((char *)self, (uint64_t)a2, (SEL *)&selRef_receiverISOCountryCode);
}

- (NSString)callbackDestinationID
{
  return (NSString *)sub_100017B18((char *)self, (uint64_t)a2, (SEL *)&selRef_callbackDestinationID);
}
...
- (NSDate)date
{
  ...
  v10.super.isa = sub_1000412B0().super.isa;
...
- (NSURL)dataURL
{
  ...
  uint64_t v5 = *(Class *)((char *)&self->super.isa + OBJC_IVAR___MPVisualMessage_vmMessage);
  unsigned int v6 = self;
  id v7 = [v5 dataURL];
  sub_100041270();

  uint64_t v8 = sub_100041290();
...
- (MPVisualMessage)initWithVMVoicemail:(id)a3
{
  return (MPVisualMessage *)sub_1000180C0((char *)self, (uint64_t)a2, a3, &OBJC_IVAR___MPVisualMessage_vmMessage, type metadata accessor for VisualMessage);
}
