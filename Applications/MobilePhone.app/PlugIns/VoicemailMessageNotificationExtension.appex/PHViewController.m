...
- (void)commonInit
{
  ...
  {
    objc_super v5 = self;
    id v9 = [objc_alloc((Class)UITabBarItem) initWithTabBarSystemItem:[v5 tabBarSystemItem] tag:[v5 tabBarSystemItemTag]];
...
- (int64_t)preferredWhitePointAdaptivityStyle
{
  return [(PHViewController *)self whitePointAdaptivityStyle];
}
