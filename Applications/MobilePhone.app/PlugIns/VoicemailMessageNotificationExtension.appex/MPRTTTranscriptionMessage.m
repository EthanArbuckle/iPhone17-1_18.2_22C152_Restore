...
- (void)fetchRTTConversationForCallUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_100011D08;
    block[3] = &unk_10005D4F0;
      ...
      do
      {
        for (i = 0; i != v6; i = (char *)i + 1)
        {
          ...
          if (([v9 isMe] & 1) == 0)
          {
            ...
            {
              id v11 = ttyLocString();
              v12 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v11, &stru_10005E8B0);

              uint64_t v13 = [v10 stringByReplacingOccurrencesOfString:v12 withString:&stru_10005E8B0];
