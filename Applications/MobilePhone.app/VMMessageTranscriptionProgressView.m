...
- (NSLayoutConstraint)progressViewBottomLayoutConstraint;
- (NSLayoutConstraint)progressViewCenterXLayoutConstraint;
- (NSLayoutConstraint)progressViewLeadingLayoutConstraint;
- (NSLayoutConstraint)progressViewTrailingLayoutConstraint;
- (NSLayoutConstraint)titleLabelCenterXLayoutConstraint;
...
- (void)setForegroundViewBottomAnchorLayoutConstraint:(id)a3;
- (void)setForegroundViewLeadingAnchorLayoutConstraint:(id)a3;
- (void)setForegroundViewTopAnchorLayoutConstraint:(id)a3;
- (void)setForegroundViewTrailingAnchorLayoutConstraint:(id)a3;
- (void)setProgressView:(id)a3;
- (void)setProgressViewBottomLayoutConstraint:(id)a3;
- (void)setProgressViewCenterXLayoutConstraint:(id)a3;
- (void)setProgressViewLeadingLayoutConstraint:(id)a3;
- (void)setProgressViewTrailingLayoutConstraint:(id)a3;
- (void)setTitleLabel:(id)a3;
- (void)setTitleLabelCenterXLayoutConstraint:(id)a3;
...
{
  v20.receiver = self;
  v20.super_class = (Class)VMMessageTranscriptionProgressView;
  ...
  v8 = [objc_alloc((Class)UILabel) initWithFrame:CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height];
  ...
  v13 = [v12 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_MESSAGE_TRANSCRIBING" value:&stru_100285990 table:@"VoicemailUI"];
  ...
  v14 = (UIProgressView *)[objc_alloc((Class)UIProgressView) initWithProgressViewStyle:1];
...
- (void)loadConstraints
{
  ...
  objc_super v20 = [(VMMessageTranscriptionProgressView *)self bottomAnchor];
  ...
  v71.receiver = self;
  v71.super_class = (Class)VMMessageTranscriptionProgressView;
...
{
  v15.receiver = self;
  v15.super_class = (Class)VMMessageTranscriptionProgressView;
  ...
  id v4 = [(VMMessageTranscriptionProgressView *)self titleLabelTrailingLayoutConstraint];
  [v4 setActive:0];
...
{
  v7.receiver = self;
  v7.super_class = (Class)VMMessageTranscriptionProgressView;
...
- (NSLayoutConstraint)titleLabelCenterXLayoutConstraint
{
  return self->_titleLabelCenterXLayoutConstraint;
}
...
- (NSLayoutConstraint)progressViewCenterXLayoutConstraint
{
  return self->_progressViewCenterXLayoutConstraint;
}
...
- (NSLayoutConstraint)progressViewLeadingLayoutConstraint
{
  return self->_progressViewLeadingLayoutConstraint;
}
...
- (NSLayoutConstraint)progressViewTrailingLayoutConstraint
{
  return self->_progressViewTrailingLayoutConstraint;
}
...
- (NSLayoutConstraint)progressViewBottomLayoutConstraint
{
  return self->_progressViewBottomLayoutConstraint;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_progressViewBottomLayoutConstraint, 0);
  objc_storeStrong((id *)&self->_progressViewTrailingLayoutConstraint, 0);
  objc_storeStrong((id *)&self->_progressViewLeadingLayoutConstraint, 0);
  objc_storeStrong((id *)&self->_progressViewCenterXLayoutConstraint, 0);
  objc_storeStrong((id *)&self->_titleLabelLeadingLayoutConstraint, 0);
  objc_storeStrong((id *)&self->_titleLabelCenterXLayoutConstraint, 0);
