...
- (void)commonInit
{
  ...
  if ([(PHTableViewController *)self conformsToProtocol:&OBJC_PROTOCOL___PHTabBarItemProtocol])
  {
    ...
    v7 = [(PHTableViewController *)v5 tabBarItemTitle];
...
- (void)setContentUnavailable:(BOOL)a3 animated:(BOOL)a4
{
  if (self->_contentUnavailable != a3)
  {
          ...
          v8))
    {
      ...
      v14[1] = 3221225472;
      v14[2] = __56__PHTableViewController_setContentUnavailable_animated___block_invoke;
      v14[3] = &unk_10027CC10;
      BOOL v15 = a3;
      v14[4] = self;
      ...
      v12[1] = 3221225472;
      v12[2] = __56__PHTableViewController_setContentUnavailable_animated___block_invoke_2;
      v12[3] = &unk_10027C838;
      BOOL v13 = a3;
      v12[4] = self;
...
- (void)updateTitleDisplayModeIfNeeded:(BOOL)a3
{
  ...
  if ([(PHTableViewController *)self isViewLoaded])
  {
    ...
    uint64_t v6 = v5 ? 1 : 2;
    id v7 = [(PHTableViewController *)self navigationItem];
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        id v7 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [*(id *)(*((void *)&v25 + 1) + 8 * i) hash]);
...
- (void)tableView:(id)a3 performReloadRowsAtIndexPaths:(id)a4 withRowAnimation:(int64_t)a5 completion:(id)a6
{
  ...
  if ([(PHTableViewController *)self tableViewCanPerformReloadData:v10])
  {
    ...
    BOOL v15 = __93__PHTableViewController_tableView_performReloadRowsAtIndexPaths_withRowAnimation_completion___block_invoke;
    v16 = &unk_10027CC38;
