...
- (double)progress;
- (void)layoutSubviews;
- (void)setElapsedLabel:(id)a3;
- (void)setProgress:(double)a3;
- (void)setRemainingLabel:(id)a3;
@end
...
{
  v61.receiver = self;
  v61.super_class = (Class)PHCarPlayProgressView;
  v3 = -[PHCarPlayProgressView initWithFrame:](&v61, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
...
{
  v8.receiver = self;
  v8.super_class = (Class)PHCarPlayProgressView;
