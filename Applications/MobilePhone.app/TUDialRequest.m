...
+ (id)dialRequestForCallProvider:(id)a3 handle:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      +[TUDialRequest(PhoneKit) dialRequestForCallProvider:handle:](v5, (uint64_t)v7, v9);
    }
...
+ (id)dialRequestForUserActivity:(id)a3 callProviderManager:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR)) {
          +[TUDialRequest(PhoneKit) dialRequestForUserActivity:callProviderManager:]((uint64_t)v10, v14);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR)) {
        +[TUDialRequest(PhoneKit) dialRequestForUserActivity:callProviderManager:](v11);
      }
      v13 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR)) {
      +[TUDialRequest(PhoneKit) dialRequestForUserActivity:callProviderManager:](v10);
    }
    v13 = 0;
  }
...
id __83__TUDialRequest_PhoneKit__dialRequestByResolvingDialTypeUsingSenderIdentityClient___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  CFStringRef v7 = [v5 handle];
  id v8 = [v7 value];

  if ([v8 length])
  {
    int v9 = *(void **)(a1 + 32);
    CFStringRef v10 = [v6 UUID];
