...
- (void)commonInit
{
  ...
  v12 = [v11 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_TITLE" value:&stru_100285990 table:@"VoicemailUI"];
...
- (void)handleFeedbackTextViewTapGesture:(id)a3
{
  ...
  if (isKindOfClass)
  {
    ...
    if ([v6 state] == (id)3)
    {
      ...
      double v12 = [(VMMessageTranscriptView *)self feedbackTextView];
      double v13 = [v12 closestPositionToPoint:v9, v11];

      v14 = [(VMMessageTranscriptView *)self feedbackTextView];
      double v15 = [v14 textStylingAtPosition:v13 inDirection:0];
      double v16 = [v15 objectForKey:NSLinkAttributeName];

      if (v16) {
        [(VMMessageTranscriptView *)self openFeedbackURL:v16];
      }
    }
    id v5 = v17;
  }
...
- (void)handleTextViewTapGesture:(id)a3
{
  ...
  if (isKindOfClass)
  {
    ...
    if (v8)
    {
      double v9 = [(VMMessageTranscriptView *)self delegate];
      [v9 messageTranscriptView:self didReceiveTapGesture:v6];
    }
    id v5 = v10;
  }
...
- (void)openFeedbackURL:(id)a3
{
  ...
  double v4 = +[VMMessageTranscriptViewModel neutralFeedbackURL];
  ...
  {
    char v8 = +[VMMessageTranscriptViewModel negativeFeedbackURL];
  ...
  id v17 = [(VMMessageTranscriptView *)self feedbackTextView];
  v18 = [v17 attributedText];
  id v19 = [v18 mutableCopy];

  id v20 = [v19 length];
  double v21 = +[NSBundle mainBundle];
  double v22 = [v21 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_REPORTED" value:&stru_100285990 table:@"VoicemailUI"];
...
- (double)titleLabelFirstBaselineLayoutConstraintConstant
{
  ...
  if (v4)
  {
    id v5 = +[UIFontMetrics metricsForTextStyle:v4];
...
- (void)_refreshAttributedText
{
  ...
  id v5 = [(VMMessageTranscriptView *)self feedbackTextView];
  [v5 setAttributedText:v4];

  double v6 = [(VMMessageTranscriptView *)self viewModel];
  double v7 = [v6 localizedAttributedText];
  char v8 = [(VMMessageTranscriptView *)self textView];
