  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      ...
      id v9 = v12;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "[WARN] +[AVSystemController sharedAVSystemController] returned something that isn't an AVSystemController class: %@", buf, 0xCu);
    }
  }
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "[WARN] +[AVSystemController sharedAVSystemController] returned nil value", buf, 2u);
    }
  }

LABEL_11:

  return (AVSystemController *)v7;
}

+ (PHAudioDeviceController)sharedAudioDeviceController
{
  if (sharedAudioDeviceController_onceToken != -1) {
    dispatch_once(&sharedAudioDeviceController_onceToken, &__block_literal_global_24);
  }
  v2 = (void *)sharedAudioDeviceController_sharedAudioDeviceController;
...
void __54__PHAudioDeviceController_sharedAudioDeviceController__block_invoke(id a1)
{
  ...
  uint64_t v2 = sharedAudioDeviceController_sharedAudioDeviceController;
  sharedAudioDeviceController_sharedAudioDeviceController = (uint64_t)v1;
...
- (PHAudioDeviceController)init
{
  ...
  uint64_t v2 = [(PHAudioDeviceController *)&v13 init];
  if (v2)
  {
...
void __60__PHAudioDeviceController_fetchRoutesWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  id v4 = [v2 routesForUnformattedPickableRoutes:v3];
...
uint64_t __60__PHAudioDeviceController_fetchRoutesWithCompletionHandler___block_invoke_2(uint64_t a1)
{
...
uint64_t __66__PHAudioDeviceController_fetchCurrentRouteWithCompletionHandler___block_invoke_2(uint64_t a1)
{
  return (*(uint64_t (**)(void, void))(*(void *)(a1 + 40) + 16))(*(void *)(a1 + 40), *(void *)(a1 + 32));
}
...
- (id)_pickableRoutesUsingAttribute
{
  if (!_pickableRoutesUsingAttribute__AVSystemController_PickableRoutesAttribute)
  {
    ...
    id v5 = v4 ? (void *)*v4 : 0;
    objc_storeStrong((id *)&_pickableRoutesUsingAttribute__AVSystemController_PickableRoutesAttribute, v5);
    if (!_pickableRoutesUsingAttribute__AVSystemController_PickableRoutesAttribute)
    {
      BOOL v6 = +[NSString stringWithFormat:@"Failed to weak link AVSystemController_PickableRoutesAttribute"];
      ...
      if (_TUAssertShouldCrashApplication())
      {
        if (!_pickableRoutesUsingAttribute__AVSystemController_PickableRoutesAttribute)
        {
          long long v10 = +[NSAssertionHandler currentHandler];
          [v10 handleFailureInMethod:a2 object:self file:@"PHAudioDeviceController.m" lineNumber:265 description:@"Failed to weak link AVSystemController_PickableRoutesAttribute"];
        }
      }
    }
  }
  id v7 = +[PHAudioDeviceController sharedSystemController];
  id v8 = [v7 attributeForKey:_pickableRoutesUsingAttribute__AVSystemController_PickableRoutesAttribute];
...
- (void)_pickRoute:(id)a3
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      -[PHAudioDeviceController _pickRoute:]((uint64_t)v8, v9);
    }
  }
  pickedRoute = self->_pickedRoute;
  ...
  dispatch_async((dispatch_queue_t)&_dispatch_main_q, &__block_literal_global_84);
}
...
- (void)_acquireLock
{
  id v2 = [(PHAudioDeviceController *)self modifyingStateLock];
...
- (void)_audioRouteInformationChanged
{
  ...
  dispatch_async((dispatch_queue_t)&_dispatch_main_q, &__block_literal_global_95);
}
