...
- (void)loadView
{
  ...
  double v8 = [v7 localizedStringForKey:@"UNKNOWN_DURATION" value:&stru_100285990 table:@"Voicemail"];
  ...
  v12 = [v11 localizedStringForKey:@"UNKNOWN_DURATION" value:&stru_100285990 table:@"Voicemail"];
