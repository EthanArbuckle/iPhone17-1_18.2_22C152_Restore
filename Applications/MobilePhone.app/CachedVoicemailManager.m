...
- (void)fetchMessagesWithCompletion:(id)a3
{
  ...
  *(void *)(v8 + 24) = self;
  ...
  v10[2] = 0;
  v10[3] = 0;
  v10[4] = &async function pointer to partial apply for @objc closure #1 in CachedVoicemailManager.fetchMessages();
  v10[5] = v8;
  v11 = (void *)swift_allocObject();
  v11[2] = 0;
  v11[3] = 0;
  v11[4] = &_sIeghH_IeAgH_TRTA_64Tu;
  v11[5] = v10;
  swift_retain();
  _sScTss5NeverORs_rlE8priority9operationScTyxABGScPSg_xyYaYAcntcfCyt_Tgmq5((uint64_t)v6, (uint64_t)&_sIeAgH_ytIeAgHr_TRTA_69Tu, (uint64_t)v11);
  swift_release();
}
