...
- (id)contactsForHandles:(id)a3 keyDescriptors:(id)a4 alwaysUnifyLabeledValues:(BOOL)a5
{
  ...
  v11 = +[CNContact predicateForContactsMatchingHandleStrings:v8];
...
LABEL_19:
  ...
  if (v18 && [v18 code] != (id)200)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR)) {
      -[CNContactStore(PhoneKit) contactsForHandles:keyDescriptors:alwaysUnifyLabeledValues:]((uint64_t)v19, v20, v22, v23, v24, v25, v26, v27);
    }
    v16 = 0;
    goto LABEL_19;
  }
...
+ (id)suggestedContactStore
{
  if (objc_msgSend(a1, "phoneKit_isAuthorized"))
  {
    ...
    v4 = [a1 storeWithOptions:v3];
  }
  else
  {
    BOOL v5 = PHDefaultLog();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      +[CNContactStore(PhoneKit) contactStore];
    }
