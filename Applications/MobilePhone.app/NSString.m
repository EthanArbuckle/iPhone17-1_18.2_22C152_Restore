  ...
  *(_OWORD *)buffer = 0u;
  ...
  if (Length >= 1)
  {
    ...
    do
    {
      ...
      LOWORD(v25) = _LetterNumberMap[v25] + 48;
LABEL_41:
      UniChar chars = v25;
LABEL_42:
      if (!v3
...
- (id)attributedStringToHighlightText:(id)a3 primaryColour:(id)a4 secondaryColour:(id)a5 style:(unint64_t)a6
{
  ...
  if ([(NSString *)self length])
  {
    ...
    else if (v17 < 2 || [v16 isNumeric] && -[NSString isNumeric](v15, "isNumeric"))
    {
      ...
      v34[1] = 3221225472;
      v34[2] = __102__NSString_MobilePhoneAdditions__attributedStringToHighlightText_primaryColour_secondaryColour_style___block_invoke;
      v34[3] = &unk_10027E4F8;
      id v35 = v13;
      id v36 = v12;
...
id __102__NSString_MobilePhoneAdditions__attributedStringToHighlightText_primaryColour_secondaryColour_style___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
