...
{
  return _swift_getOpaqueTypeConformance2(a1, &unk_100003E1C, 1);
}
...
{
  return SleepStageWidget.init()();
}

uint64_t sub_100003C98()
{
  return type metadata accessor for SleepStageWidget();
}

uint64_t sub_100003CA8()
{
  return SleepWidget.init()();
}

uint64_t sub_100003CB8()
{
  return type metadata accessor for SleepWidget();
}
