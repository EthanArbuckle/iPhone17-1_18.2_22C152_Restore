...
- (DADeviceObserverAirpods)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v11 = +[NSSet setWithArray:&off_1001574E8];
    ...
    if (qword_1001868A0 != -1) {
      dispatch_once(&qword_1001868A0, &stru_10014B0B0);
    }
    v20 = qword_1001868A8;
