...
- (void)checkAvailabilityWithReply:(id)a3
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10000EACC;
  block[3] = &unk_10014B4E0;
...
- (void)checkAvailabilityWithTicketNumber:(id)a3 timeout:(double)a4 exitWhenDone:(BOOL)a5 completion:(id)a6
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10000EFB0;
  block[3] = &unk_10014B558;
  block[4] = self;
  id v16 = v10;
  double v18 = a4;
  id v17 = v11;
...
- (BOOL)isInternalInstall
{
  if (qword_1001868C8 != -1) {
    dispatch_once(&qword_1001868C8, &stru_10014B5A0);
  }
  return byte_1001868C0;
}
