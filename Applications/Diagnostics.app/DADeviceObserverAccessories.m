...
- (id)_fetchDevices
{
  ...
  id v5 = +[DSIOHIDDevice deviceMatchingAccessories:&off_100157500];
  id v6 = v5;
  if (!v5) {
    goto LABEL_13;
  }
...
- (id)_accessoryIdentifiersToPromote
{
  if (qword_1001868B8 != -1) {
    dispatch_once(&qword_1001868B8, &stru_10014B288);
  }
  v2 = (void *)qword_1001868B0;
