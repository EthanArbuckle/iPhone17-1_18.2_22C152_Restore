...
- (NSString)landscapeOverlayMessage
{
  ...
  uint64_t v3 = [v2 localizedStringForKey:@"StickersLandscapeTrapMessage" value:&stru_100035088 table:@"Localizable"];
...
+ (UIViewController)pendingChildViewController
{
  return (UIViewController *)(id)qword_10003EB88;
}
