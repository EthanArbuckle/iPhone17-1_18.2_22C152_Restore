...
+ (id)_countryCodes
{
  if (qword_10001FC18 != -1) {
    dispatch_once(&qword_10001FC18, &stru_1000186D8);
  }
  v2 = (void *)qword_10001FC20;
...
+ (id)_stringWithKey:(id)a3 localeIdentifier:(id)a4
{
  ...
  if (!v12 || [v12 isEqualToString:v5])
  {
    ...
    uint64_t v18 = [v17 localizedStringForKey:v5 value:&stru_1000190C0 table:@"Localizable"];
LABEL_14:
