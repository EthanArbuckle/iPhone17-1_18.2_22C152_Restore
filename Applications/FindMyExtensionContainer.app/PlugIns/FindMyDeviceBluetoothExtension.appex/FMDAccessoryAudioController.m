  ...
  if ([(FMDAccessoryAudioController *)self wasSoundPlayed])
  {
    ...
    if (v4)
    {
      ...
      if (qword_10002D810)
      {
        ...
        dispatch_source_cancel((dispatch_source_t)qword_10002D810);
        id v19 = (void *)qword_10002D810;
        qword_10002D810 = 0;
      }
...
LABEL_7:
  ...
  {
    uint64_t v10 = v9;
    unsigned int v11 = sub_100006668();
  ...
  if (v7)
  {
    unsigned __int8 v5 = sub_100006668();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v21 = v7;
  ...
  if (v3)
  {
    ...
    if (v5 < v10)
    {
      ...
      *(float *)&double v23 = v19 + *(float *)&v23;
      ...
      long long v24 = sub_100006668();
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG)) {
        sub_100012E9C(self, v24, v5);
      }
    }
    else
    {
    ...
    else
    {
      ...
      *(float *)&double v48 = v46 + flt_1000176A0[v43];
      [v47 setPan:v48];
    ...
    uint64_t v54 = qword_10002D810;
    if (v11 && qword_10002D810 == 0)
    {
      v56 = sub_100006668();
      ...
      v58 = (void *)qword_10002D810;
      qword_10002D810 = (uint64_t)v57;
      ...
      handler[2] = sub_10000BAA4;
      handler[3] = &unk_100021598;
      objc_copyWeak(&v66, location);
      dispatch_source_set_event_handler(v61, handler);
      dispatch_resume((dispatch_object_t)qword_10002D810);
