...
+ (id)defaultStorageLocation
{
  ...
  id v3 = [v2 initWithIdentifier:off_100031108];
  v4 = [v3 url];
...
+ (id)sharedInstance
{
  if (qword_1000312E8 != -1) {
    dispatch_once(&qword_1000312E8, &stru_100024888);
  }
  id v2 = (void *)qword_1000312E0;
