...
- (BOOL)authPassed
{
  ...
  unsigned __int8 v4 = [v3 isEqualToNumber:&off_100028B58];
...
- (NSString)name
{
  if (!self->_name && [(FMDMagSafeRawInfo *)self authPassed])
  {
    ...
    if ([(FMDMagSafeRawInfo *)self enableCAAPI:@"enableGetAccessoryUserName"])
    {
      ...
      uint64_t v22 = sub_1000125F0;
      uint64_t v23 = sub_100012600;
      id v24 = 0;
      BOOL v5 = sub_100006910();
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)buf = 0;
...
- (void)getPairingStatus
{
    ...
    && [(FMDMagSafeRawInfo *)self authPassed])
  {
    ...
    *(void *)buf = 0;
    ...
    int v18 = sub_100012A2C;
    uint64_t v19 = &unk_100025778;
    uint64_t v21 = buf;
    ...
    if (v11 >= 4) {
      ...
      CFStringRef v12 = *(&off_1000258B0 + v11);
    }
    uint64_t v13 = sub_100006910();
...
- (void)setPairingData:(id)a3 withCompletion:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  dispatch_time_t v8 = sub_100006910();
...
- (void)getPairingDataWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    v11[2] = sub_1000131B0;
    v11[3] = &unk_1000257C8;
    int v12 = &off_100028C78;
    uint64_t v13 = self;
    id v14 = v4;
    [v9 getPublicNVMKeyValues:&off_100028C78 forEndpoint:v10 withReply:v11];
  }
}
...
- (void)setName:(id)a3 withCompletion:(id)a4
{
  ...
  {
    dispatch_time_t v9 = sub_100006910();
...
- (void)setupKeysWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if ([(FMDMagSafeRawInfo *)self enableCAAPI:@"enableProvisionAccessoryForFindMy"])
    {
      ...
      block[1] = 3221225472;
      block[2] = sub_100013A40;
      block[3] = &unk_100025840;
      block[4] = self;
