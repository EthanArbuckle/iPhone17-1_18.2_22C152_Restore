void sub_100001504(id a1)
{
  ...
  qword_100008910 = objc_alloc_init(DAHIDEventMonitor);

  _objc_release_x1();
}

void sub_100001A5C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
...
void sub_100001EEC(_Unwind_Exception *a1)
{
  objc_sync_exit(v1);
  _Unwind_Resume(a1);
}
...
void sub_1000020F0(_Unwind_Exception *a1)
{
  objc_sync_exit(v1);
  _Unwind_Resume(a1);
}

id sub_10000210C(uint64_t a1)
{
  return [*(id *)(a1 + 32) cleanUpSystemClient];
}

void sub_10000229C(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
{
  sub_1000022B8();
  sub_10000229C((void *)&_mh_execute_header, v0, v1, "[ERROR] - Invalid HID Event", v2, v3, v4, v5, v6);
}

void sub_10000280C()
{
  sub_1000022B8();
  sub_10000229C((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client could not be found.", v2, v3, v4, v5, v6);
}

void sub_100002840()
{
  sub_1000022B8();
  sub_10000229C((void *)&_mh_execute_header, v0, v1, "[ERROR] - Service client does not exist.", v2, v3, v4, v5, v6);
}

void sub_100002874()
{
  sub_1000022B8();
  sub_10000229C((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not open HID system.", v2, v3, v4, v5, v6);
}
...
{
  sub_1000022B8();
  sub_10000229C((void *)&_mh_execute_header, v0, v1, "[ERROR] - Could not set up system client.", v2, v3, v4, v5, v6);
}

void sub_10000295C(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "Gyroscope NOT found. (0)", v1, 2u);
}
...
id objc_msgSend_gyroDataCount(void *a1, const char *a2, ...)
{
  return [a1 gyroDataCount];
}
