...
- (BOOL)validateAndInitializeParameters:(id)a3
{
  ...
  [v4 dk_arrayFromRequiredKey:@"sources" types:v6 maxLength:80 failed:&v54 validator:&stru_100010390];
  ...
  dword_1000168E8 = [(NSArray *)self->_sources count] - 1;
  ...
  if ([v10 count])
  {
    ...
    do
    {
      ...
      v16 = v5;
      v17 = [v5[102] setWithObject:objc_opt_class()];
  ...
  {
    [v29 dk_numberFromRequiredKey:@"threshold" lowerBound:&off_100011018 upperBound:&off_100011028 failed:&v54];
  ...
  {
    v34 = [v5[102] setWithObject:objc_opt_class()];
    [v33 dk_arrayFromRequiredKey:@"modelNumbers" types:v34 maxLength:50 failed:&v54 validator:&stru_1000103B0];
  ...
  {
    [v37 dk_numberFromRequiredKey:@"xThreshold" lowerBound:&off_100011038 upperBound:&off_100011048 failed:&v54];
    ...
    [v37 dk_numberFromRequiredKey:@"zThreshold" lowerBound:&off_100011038 upperBound:&off_100011048 failed:&v54];
  ...
  [v48 dk_numberFromRequiredKey:@"fileDownloadTimeout" lowerBound:&off_100010F28 upperBound:&off_100010F40 failed:&v54];
  v42 = (NSNumber *)objc_claimAutoreleasedReturnValue();
  fileDownloadTimeout = self->_fileDownloadTimeout;
  self->_fileDownloadTimeout = v42;

  [v48 dk_numberFromRequiredKey:@"sequenceTimeout" lowerBound:&off_100010F28 upperBound:&off_100010F40 failed:&v54];
...
- (id)makeOutputFromDictionary:(id)a3 validationFailed:(BOOL *)a4
{
  ...
  v10 = +[NSNumber numberWithInt:dword_1000168E8];
  v11 = [v6 dk_numberFromRequiredKey:@"source" lowerBound:&off_100010F58 upperBound:v10 failed:a4];
  [v7 setSource:v11];

  v12 = [v6 dk_numberFromRequiredKey:@"volume" lowerBound:&off_100011058 upperBound:&off_100011068 failed:a4];
