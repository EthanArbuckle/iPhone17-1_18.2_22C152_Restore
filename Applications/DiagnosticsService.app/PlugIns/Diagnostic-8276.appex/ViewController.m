...
- (void)prepareNewIteration
{
  sub_10001DF00(__p, "prepareNewIteration");
  [(ViewController *)self log:__p];
  if (v4 < 0) {
    operator delete(__p[0]);
  }
...
- (void)startUI
{
  sub_10001DF00(&v33, "start UI");
  [(ViewController *)self log:&v33];
  if (SHIBYTE(v34) < 0) {
    operator delete((void *)v33);
  }
  sub_10001DF00(&v30, "_sessionMaxTimeOut ");
  ...
  *(_OWORD *)&v31.__r_.__value_.__l.__data_ = v6;
  ...
  sub_10001DF00(v27, " _consecutiveSceneErrorLimit ");
  if ((v28 & 0x80u) == 0) {
    v7 = v27;
  }
  else {
...
- (int)getJasperSensorId:(void *)a3
{
  ...
  if (DeviceCMInterface::getJasperModuleInfo(self->_diagnosticCMInterface, &theDict))
  {
    ...
    [(ViewController *)self error:@"unable to get JasperModuleInfo" details:&stru_10002D068];
  }
  else
  {
...
- (int)startStreaming
{
  sub_10001DF00(__p, "startStreaming started");
  [(ViewController *)self log:__p];
  if (v6 < 0) {
    operator delete(__p[0]);
  }
...
- (int)initStreaming
{
  sub_10001DF00(__p, "initStreaming");
  [(ViewController *)self log:__p];
  if (v6 < 0) {
    operator delete(__p[0]);
  }
  *(_DWORD *)&v7.var0 = 65537;
  ...
  self->_diagnosticFinalResult = 2;
  [(ViewController *)self error:@"no JasperDevice" details:&stru_10002D068];
  return 2;
}
...
- (void)initFlow
{
  ...
  *(_DWORD *)&self->_avgRotAngles[8] = 0;
  sub_10001DF00(__p, "init flow started");
  [(ViewController *)self log:__p];
  if (v11 < 0) {
    operator delete(__p[0]);
  }
  ...
  if (self->_iterationsLimit >= 1)
  {
    ...
    {
      __p[0] = &v9;
      char v6 = sub_10001DFCC((uint64_t **)&self->_rgbjCalibrationResults, &v9, (uint64_t)&unk_100024847, (_DWORD **)__p);
      v6[6] = v6[5];
      ++v9;
    }
...
- (void)showPausedDialog
{
  ...
  id v6 = [v3 localizedStringForKey:@"Device_Is_Motionless" value:&stru_10002D068 table:0];

  objc_super v4 = +[NSBundle mainBundle];
  id v5 = [v4 localizedStringForKey:@"Device_Is_Motionless_Subtitle" value:&stru_10002D068 table:0];
...
- (int)initDiagnosticRgbjFlow
{
  sub_10001DF00(__p, "set rgbj configuration to frameSelect(1)  featureVector(5)  dilutionRate(500)");
  [(ViewController *)self log:__p];
  if (v7 < 0) {
    operator delete(__p[0]);
  }
  ...
  else
  {
    ...
    sub_10001DF00(__p, "set wide jasper extrinsics to 0");
    [(ViewController *)self log:__p];
    if (v7 < 0) {
      operator delete(__p[0]);
    }
  ...
  int v4 = 2;
  self->_diagnosticFinalResult = 2;
  [(ViewController *)self error:v3 details:&stru_10002D068];
  return v4;
}
...
- (int)getCalibResults:(ViewController *)self focalPoint:(SEL)a2
{
  uint64_t v4 = v3;
  id v5 = v2;
  sub_10001DF00(&__p, "getCalibResults");
  [(ViewController *)self log:&__p];
  if (SHIBYTE(v21) < 0) {
    operator delete(__p);
  }
  ...
  if (DeviceCMInterface::getJasperCalib(self->_diagnosticCMInterface, &v27))
  {
    int v7 = 2;
    self->_diagnosticFinalResult = 2;
    [(ViewController *)self error:@"unable to get JasperCalib" details:&stru_10002D068];
  }
  else
  {
...
- (void)loadNormalAppWindow
{
  sub_10001DF00(__p, "loadNormalAppWindow");
  [(ViewController *)self log:__p];
  if (v150 < 0) {
    operator delete(__p[0]);
  }
  ...
  [v147 setLocations:&off_100030040];
...
- (void)compareResults:(float *)a3
{
  sub_10001DF00(&v48, "compareResults started");
  ...
  v48 = 0;
  long long v49 = 0uLL;
  sub_10001E284((uint64_t)&v43, 0x10uLL);
...
- (void)dogWatch:(id)a3
{
  ...
  {
    sub_10001DF00(__p, "Driver reported disk is full with RgbjReport_FailedToSave");
    [(ViewController *)self log:__p];
  ...
  *(void *)std::string __p = &self->_iterationNumber;
  uint64_t v7 = sub_10001DFCC((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100024847, (_DWORD **)__p);
  uint64_t v8 = v7[6];
  unint64_t v9 = v7[7];
  if (v8 >= v9)
  {
    ...
    if (v16) {
      float32x2_t v17 = (char *)sub_10001E30C((uint64_t)(v7 + 7), v16);
    }
    else {
      float32x2_t v17 = 0;
    }
  ...
  v7[6] = v11;
  *(void *)std::string __p = &self->_iterationNumber;
  int v24 = sub_10001DFCC((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100024847, (_DWORD **)__p);
  if ((char *)v24[6] - (char *)v24[5] == 24)
  {
    [(ViewController *)self hideInProgressView];
    [(ViewController *)self hideWarningWindow];
    long long v25 = +[NSBundle mainBundle];
    float v26 = [v25 localizedStringForKey:@"Pan_Slowly" value:&stru_10002D068 table:0];
  ...
  *(void *)std::string __p = &self->_iterationNumber;
  v69 = sub_10001DFCC((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100024847, (_DWORD **)__p);
  *(void *)std::string __p = &self->_iterationNumber;
  id v70 = sub_10001DFCC((uint64_t **)&self->_rgbjCalibrationResults, &self->_iterationNumber, (uint64_t)&unk_100024847, (_DWORD **)__p);
  v72 = v70[5];
  v71 = v70[6];
  v73 = v69[5];
  ...
  *(_OWORD *)std::string __p = v118;
  ...
  v122 = [v121 localizedStringForKey:@"Pan_Slowly" value:&stru_10002D068 table:0];
  ...
  if (v325[0] > *v102)
  {
    ...
    v134 = [v133 localizedStringForKey:@"Bad_Scene" value:&stru_10002D068 table:0];
    id v135 = +[NSBundle mainBundle];
    v136 = [v135 localizedStringForKey:@"Bad_Scene_Subtitle" value:&stru_10002D068 table:0];
    [(ViewController *)self showWarningWindow:v134 subMessage:v136];

    v137 = +[NSBundle mainBundle];
    v138 = [v137 localizedStringForKey:@"Pan_Slowly" value:&stru_10002D068 table:0];
  ...
  if (SDWORD1(__val) <= *v80)
  {
    ...
    v137 = +[NSBundle mainBundle];
    v138 = [v137 localizedStringForKey:@"No_Objects_Found" value:&stru_10002D068 table:0];
    v140 = +[NSBundle mainBundle];
    v141 = [v140 localizedStringForKey:@"No_Objects_Found_Subtitle" value:&stru_10002D068 table:0];
...
LABEL_199:
  if (SHIDWORD(__val) < self->_calibUpdateEachIsfEntiresLimit)
  {
      ...
      || self->_consecutiveSceneError > (signed int)self->_topTextHeight)
    {
      ...
      *(_OWORD *)std::string __p = v162;
      ...
      v164 = [v163 localizedStringForKey:@"Timed_Out" value:&stru_10002D068 table:0];
      [(ViewController *)self showWarningWindow:v164 subMessage:&stru_10002D068];
      ...
      v289[1] = 3221225472;
      v289[2] = sub_10001A250;
      v289[3] = &unk_10002CE30;
      v289[4] = self;
      dispatch_async(v166, v289);
    }
    goto LABEL_168;
  }
  sub_10001DF00(__p, "dogWatch finishing sub iteration");
  [(ViewController *)self log:__p];
  if ((__p[23] & 0x80000000) != 0) {
    operator delete(*(void **)__p);
  }
  ...
  v303[1] = 3221225472;
  v303[2] = sub_100019F74;
  v303[3] = &unk_10002CE30;
  v303[4] = self;
  ...
  {
    [(ViewController *)self error:@"failed to forceSaveWideJasperCalib" details:&stru_10002D068];
    goto LABEL_168;
  }
  DWORD2(v302) = 0;
  *(void *)&long long v302 = 0;
  ...
  if (![(ViewController *)self getCalibResults:&v302 focalPoint:&v300])
  {
    ...
    sub_100016FB8("iteration ", (const void **)&v321.__r_.__value_.__l.__data_, (void **)&v306.__r_.__value_.__l.__data_);
    ...
    *((unsigned char *)&v321.__r_.__value_.__s + 23) = v222;
    ...
    sub_10001DF00(__p, "dogWatch finishing iteration");
    [(ViewController *)self log:__p];
    if ((__p[23] & 0x80000000) != 0) {
      operator delete(*(void **)__p);
    }
    anon_b8 = self->_anon_b8;
    sub_100019FD4((void **)self->_anon_b8, &v302);
    ...
    *(_OWORD *)&v320.__r_.__value_.__l.__data_ = v245;
    ...
    if (self->_diagnosticFinalResult == -3)
    {
      ...
      v292[1] = 3221225472;
      v292[2] = sub_10001A0B4;
      v292[3] = &unk_10002CE30;
      v292[4] = self;
      v254 = v292;
    }
    else
...
LABEL_359:
        ...
        v290[1] = 3221225472;
        v290[2] = sub_10001A114;
        v290[3] = &unk_10002CE30;
        v290[4] = self;
...
LABEL_448:
      ...
      *(_OWORD *)&self->_prclResult.swideFocalPoint[2] = v287;
      sub_10001DF00(&v319, "dogWatch finishing all iterations");
      ...
      v291[1] = 3221225472;
      v291[2] = sub_10001A10C;
      v291[3] = &unk_10002CE30;
      v291[4] = self;
      v254 = v291;
    }
...
{
  id v5 = a3;
  sub_10001DF00(__p, (char *)[v5 UTF8String]);
  [(ViewController *)self log:__p];
  if (v7 < 0) {
    operator delete(__p[0]);
  }
...
- (void)handleResume
{
  ...
  {
    self->_inResume = 1;
    sub_10001DF00(__p, "handleResume");
    [(ViewController *)self log:__p];
    if (v7 < 0) {
      operator delete(__p[0]);
    }
...
- (void)handleSuspend
{
  ...
  objc_sync_enter(v4);
  sub_10001DF00(__p, "handleSuspend");
...
- (void)endTest
{
  ...
  *(_OWORD *)std::string __p = v5;
  ...
  {
    sub_10001DF00(__p, "_skipSummaryScreen is true");
    [(ViewController *)self log:__p];
    if (SHIBYTE(v9) < 0) {
      operator delete(__p[0]);
    }
  ...
  sub_10001DF00(__p, "_skipSummaryScreen is false");
  [(ViewController *)self log:__p];
  if (SHIBYTE(v9) < 0) {
    operator delete(__p[0]);
  }
...
- (void)buttonClicked:(id)a3
{
  sub_10001DF00(__p, "button clicked");
  [(ViewController *)self log:__p];
  if (v5 < 0) {
    operator delete(__p[0]);
  }
...
{
  id v4 = a3;
  sub_10001DF00(&v10, (char *)[v4 UTF8String]);
  std::operator+<char>();
  [(ViewController *)self log:&__p];
  if (v9 < 0) {
    operator delete(__p);
...
- (void)quitButtonTapped
{
  sub_10001DF00(__p, "Quit button tapped!");
  [(ViewController *)self log:__p];
  if (v4 < 0) {
    operator delete(__p[0]);
  }
...
- (void).cxx_destruct
{
  ...
  sub_10001E38C((uint64_t)&self->_rgbjCalibrationResults, (void *)self->_rgbjCalibrationResults.__tree_.__pair1_.__value_.__left_);
