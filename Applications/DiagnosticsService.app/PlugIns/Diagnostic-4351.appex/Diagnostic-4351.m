...
void sub_100002A50(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        id v49 = v6;
        _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "AWD result: %@", buf, 0xCu);
      }
...
LABEL_24:
      ...
      uint64_t v10 = archiveFiles(v8, @"com.apple.Diagnostics.4351.XXXXXXXX", 0);
      v11 = (void *)v10;
      if (!v10) {
        goto LABEL_24;
      }
      ...
      if (v17)
      {
        ...
        if ((v23 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR)) {
            sub_100003360((uint64_t)v24, v25, v26, v27, v28, v29, v30, v31);
          }
        }
      }
      else
      {
        v21 = DiagnosticLogHandleForCategory();
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR)) {
          sub_1000033CC((uint64_t)v18, v21, v39, v40, v41, v42, v43, v44);
        }
        v24 = v18;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR)) {
        sub_1000032F4((uint64_t)v5, v24, v33, v34, v35, v36, v37, v38);
      }
      v11 = 0;
      v9 = 0;
    }
...
void sub_100003158(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 0xCu);
}

void sub_100003174(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 2u);
}

void sub_100003204(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_10000327C(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_1000032F4(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100003360(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000033CC(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100003438(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100003470(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000034A8(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

uint64_t AWDServerConsolidateDeviceDiagnostics()
{
  return _AWDServerConsolidateDeviceDiagnostics();
}
