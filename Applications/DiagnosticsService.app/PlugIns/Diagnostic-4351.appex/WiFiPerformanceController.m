...
- (void)setupWithInputs:(id)a3 responder:(id)a4
{
  ...
  {
    unsigned int v6 = [(WiFiPerformanceController *)self copyForSyncing];
    *(_DWORD *)buf = 67109376;
    unsigned int v9 = v6;
    __int16 v10 = 1024;
...
- (id)_extractFilePaths:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      sub_100003438(v16, v17, v18, v19, v20, v21, v22, v23);
    }
    goto LABEL_24;
  }
  objc_opt_class();
  ...
  {
    v24 = [(WiFiPerformanceController *)self result];
    [v24 setStatusCode:&off_1000042A0];

    v16 = DiagnosticLogHandleForCategory();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      sub_1000034A8(v16, v25, v26, v27, v28, v29, v30, v31);
    }
    goto LABEL_24;
  }
  if (![v5 count])
  {
    v32 = [(WiFiPerformanceController *)self result];
    [v32 setStatusCode:&off_1000042B8];

    v16 = DiagnosticLogHandleForCategory();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      sub_100003470(v16, v33, v34, v35, v36, v37, v38, v39);
    }
LABEL_24:
