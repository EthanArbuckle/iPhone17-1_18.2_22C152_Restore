...
- (void)populateAttributes:(id)a3
{
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)ComponentHostSystem;
  ...
  v8 = +[NSNumber numberWithBool:[(ComponentHostSystem *)self isInDiagnosticsMode]];
  ...
  v10 = +[NSNumber numberWithBool:[(ComponentHostSystem *)self isServicePart]];
  [v4 setObject:v10 forKeyedSubscript:@"isServicePart"];

  v11 = [(ComponentHostSystem *)self localeCode];
  [v4 setObject:v11 forKeyedSubscript:@"regionCode"];

  v12 = [(ComponentHostSystem *)self languageCode];
  [v4 setObject:v12 forKeyedSubscript:@"languageCode"];

  v13 = +[NSNumber numberWithBool:[(ComponentHostSystem *)self supportsInductiveCharging]];
  [v4 setObject:v13 forKeyedSubscript:@"supportsInductiveCharging"];

  v14 = [(ComponentHostSystem *)self supplementalBuildVersion];
  [v4 setObject:v14 forKeyedSubscript:@"supplementalBuildVersion"];

  v15 = [(ComponentHostSystem *)self productVersionExtra];
  [v4 setObject:v15 forKeyedSubscript:@"productVersionExtra"];

  v16 = +[NSNumber numberWithBool:[(ComponentHostSystem *)self isInBoxUpdateEligibleMode]];
  [v4 setObject:v16 forKeyedSubscript:@"isInBoxUpdateEligibleMode"];

  if (![(ComponentHostSystem *)self isInDiagnosticsMode])
  {
    v17 = [(ComponentHostSystem *)self currentStandbyTime];
    v18 = [v17 stringValue];
    [v4 setObject:v18 forKeyedSubscript:@"currentStandbyTime"];

    v19 = [(ComponentHostSystem *)self currentUsageTime];
    v20 = [v19 stringValue];
    [v4 setObject:v20 forKeyedSubscript:@"currentUsageTime"];

    v21 = +[NSNumber numberWithBool:[(ComponentHostSystem *)self isPasscodeLocked]];
    [v4 setObject:v21 forKeyedSubscript:@"isPasscodeLocked"];

    v22 = +[NSNumber numberWithBool:[(ComponentHostSystem *)self isPasscodeSet]];
...
- (id)carrierBundleVersion
{
  ...
  uint64_t v4 = [(ComponentHostSystem *)self telephonyClient];
  if (v4
    && (v5 = (void *)v4,
        [(ComponentHostSystem *)self subscriptionInfo],
...
- (BOOL)isInDiagnosticsMode
{
  ...
  {
    int v4 = 136315138;
    v5 = "-[ComponentHostSystem isInDiagnosticsMode]";
...
- (id)carrierNameForSimCard:(int64_t)a3
{
  ...
  uint64_t v5 = [(ComponentHostSystem *)self telephonyClient];
  if (!v5
    || (v6 = (void *)v5,
        [(ComponentHostSystem *)self subscriptionInfo],
...
- (BOOL)isPasscodeLocked
{
  ...
  {
    int v4 = 136315138;
    uint64_t v5 = "-[ComponentHostSystem isPasscodeLocked]";
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "%s", (uint8_t *)&v4, 0xCu);
  }
...
- (BOOL)isPasscodeSet
{
  ...
  {
    int v4 = 136315138;
    uint64_t v5 = "-[ComponentHostSystem isPasscodeSet]";
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "%s", (uint8_t *)&v4, 0xCu);
  }
...
- (BOOL)isServicePart
{
  ...
  {
    *(_DWORD *)buf = 136315138;
    id v12 = "-[ComponentHostSystem isServicePart]";
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "%s", buf, 0xCu);
  }
...
- (BOOL)supportsInductiveCharging
{
  ...
  {
    int v4 = 136315138;
    uint64_t v5 = "-[ComponentHostSystem supportsInductiveCharging]";
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "%s", (uint8_t *)&v4, 0xCu);
  }
...
- (void)_setupTelephonyClient
{
  ...
  int v4 = [(ComponentHostSystem *)self telephonyClient];
...
- (id)supplementalBuildVersion
{
  ...
  {
    int v6 = 136315138;
    unsigned __int8 v7 = "-[ComponentHostSystem supplementalBuildVersion]";
...
- (id)productVersionExtra
{
  ...
  {
    int v6 = 136315138;
    unsigned __int8 v7 = "-[ComponentHostSystem productVersionExtra]";
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "%s", (uint8_t *)&v6, 0xCu);
  }
...
- (BOOL)isInBoxUpdateEligibleMode
{
  ...
  {
    *(_DWORD *)buf = 136315138;
    long long v11 = "-[ComponentHostSystem isInBoxUpdateEligibleMode]";
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "%s", buf, 0xCu);
  }
