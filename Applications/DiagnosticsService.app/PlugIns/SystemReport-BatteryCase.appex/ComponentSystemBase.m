...
- (BOOL)isBetaBuild
{
  if (qword_100011180 != -1) {
    dispatch_once(&qword_100011180, &stru_10000C410);
  }
  return byte_100011178;
}

- (BOOL)isInternalInstall
{
  if (qword_100011188 != -1) {
    dispatch_once(&qword_100011188, &stru_10000C430);
  }
  return byte_100011179;
}
...
LABEL_13:
    unsigned int v8 = &stru_10000CC90;
    goto LABEL_18;
  }
  int v5 = v4;
