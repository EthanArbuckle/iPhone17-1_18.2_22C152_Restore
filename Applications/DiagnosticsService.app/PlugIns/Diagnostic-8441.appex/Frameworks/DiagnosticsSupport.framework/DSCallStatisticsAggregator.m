  ...
  if (+[DSEntitlementUtilities currentProcessHasEntitlement:@"com.apple.DiagnosticsSupport.CallStatsAccess"])
  {
    ...
    if (v3)
    {
      *(_WORD *)&v3->_futureDateDetected = 0;
      ...
      uint64_t v9 = +[NSMutableArray arrayWithCapacity:14];
      callLog = v4->_callLog;
...
- (void)beginAggregation
{
  ...
  id v22 = 0;
  uint64_t v5 = [[DSGeneralLogCollector alloc] initWithLogIDs:&off_1EF98];
...
id __46__DSCallStatisticsAggregator_beginAggregation__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (v5)
    {
      unint64_t v13 = (unint64_t)[*(id *)(a1 + 32) _getDaysBetween:*(void *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) and:v5];
      ...
      else
      {
        ...
        if (v18)
        {
          if (v17)
          {
            int v35 = 134217984;
            unint64_t v36 = v14;
            _os_log_impl(&dword_0, v16, OS_LOG_TYPE_DEFAULT, "date change, flushing new log entry; daysElapsed=%ld",
              (uint8_t *)&v35,
              0xCu);
          }
        ...
        else
        {
          ...
          {
            LOWORD(v35) = 0;
            _os_log_impl(&dword_0, v16, OS_LOG_TYPE_DEFAULT, "new log line contains the same date as a previous one, accumulating", (uint8_t *)&v35, 2u);
          }
        }
...
- (id)getSynchronousResult
{
  ...
  if (![(DSCallStatisticsAggregator *)self generationComplete])
  {
    do
    {
      id v4 = [(DSCallStatisticsAggregator *)self generationLock];
      [v4 wait];
    }
  ...
  else
  {
    ...
    uint64_t v7 = +[NSNumber numberWithBool:[(DSCallStatisticsAggregator *)self futureDateDetected]];
    v17[0] = v7;
    v16[1] = @"outOfOrderDateDetected";
    uint64_t v8 = +[NSNumber numberWithBool:[(DSCallStatisticsAggregator *)self outOfOrderDateDetected]];
    v17[1] = v8;
    v16[2] = @"totalLoggedDayCount";
    uint64_t v9 = [(DSCallStatisticsAggregator *)self callLog];
    uint64_t v10 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v9 count]);
    v17[2] = v10;
    v16[3] = @"totalPlacedCallCount";
    uint64_t v11 = +[NSNumber numberWithInt:self->_totals.placedCallCount];
    v17[3] = v11;
    v16[4] = @"totalDroppedCallCount";
    uint64_t v12 = +[NSNumber numberWithInt:self->_totals.droppedCallCount];
    v17[4] = v12;
    v16[5] = @"totalDeviceDroppedCallCount";
    unint64_t v13 = +[NSNumber numberWithInt:self->_totals.deviceDroppedCallCount];
    v17[5] = v13;
    v16[6] = @"callLog";
    unint64_t v14 = [(DSCallStatisticsAggregator *)self callLog];
    v17[6] = v14;
    uint64_t v6 = +[NSDictionary dictionaryWithObjects:v17 forKeys:v16 count:7];
  }
...
- (BOOL)_isDateInRange:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    int v10 = 134217984;
    double v11 = v7;
    _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "interval since now: %f", (uint8_t *)&v10, 0xCu);
  }
...
- (void)_fillCallLogWithMissingDays:(int64_t)a3 fromDate:(id)a4
{
  ...
  if (v8 >= 1)
  {
    ...
    do
    {
      ...
      unint64_t v13 = [v12 formatterWithType:4];
      unint64_t v14 = [v13 stringFromDate:v11];
  ...
  [(DSCallStatisticsAggregator *)self setMissingDaysRemaining:(char *)[(DSCallStatisticsAggregator *)self missingDaysRemaining] - v8];
}
...
- (int64_t)_getDaysBetween:(id)a3 and:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 2048;
    int64_t v17 = v8;
    _os_log_impl(&dword_0, v10, OS_LOG_TYPE_DEFAULT, "days between [%@] and [%@]: %ld", (uint8_t *)&v12, 0x20u);
  }
