...
- (BOOL)openAppleSMC:(int)a3
{
  *(void *)mainPort = 0;
  ...
  {
    unsigned int v5 = [(DSAppleSMCDevice *)self closeAppleSMC];
...
LABEL_16:
  ...
  io_service_t v12 = IOIteratorNext(mainPort[0]);
...
- (double)readValueFor:(id)a3
{
  ...
  {
    unsigned int v5 = DiagnosticLogHandleForCategory(6);
...
LABEL_18:
      _os_log_error_impl(&dword_0, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v16, 0x18u);
      goto LABEL_12;
    }
    goto LABEL_12;
  }
...
LABEL_18:
      _os_log_error_impl(&dword_0, v15, OS_LOG_TYPE_ERROR, v17, (uint8_t *)&v18, 0x18u);
      goto LABEL_13;
    }
    goto LABEL_13;
  }
...
LABEL_20:
      _os_log_error_impl(&dword_0, v16, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v19, 0x18u);
      goto LABEL_13;
    }
    goto LABEL_13;
  }
...
- (BOOL)writeDataFor:(id)a3 value:(void *)a4 size:(unint64_t)a5
{
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 1024;
      int v24 = BYTE8(v26);
      _os_log_error_impl(&dword_0, v17, OS_LOG_TYPE_ERROR, "Failed to write AppleSMC data for key: %s (0x%X, 0x%X)", (uint8_t *)&v19, 0x18u);
    }
  }
  return v15;
}
...
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_0, v0, v1, "Error opening AppleSMC service: %d", v2, v3, v4, v5, v6);
}

- (void)openAppleSMC:.cold.3()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_0, v0, v1, "Error finding AppleSMC service: %d", v2, v3, v4, v5, v6);
}

- (void)openAppleSMC:.cold.4()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_0, v0, v1, "Error obtaining main IO port error: %d", v2, v3, v4, v5, v6);
}

- (void)openAppleSMC:.cold.5()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_0, v0, v1, "Failed to closed an existing SMC connection. Aborting Open. %d", v2, v3, v4, v5, v6);
}

- (void)closeAppleSMC
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_0_0(&dword_0, v0, v1, "Could not close AppleSMC dataPort: %d", v2, v3, v4, v5, v6);
}
