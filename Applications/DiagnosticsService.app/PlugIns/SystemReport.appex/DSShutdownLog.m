...
- (void)addShutdownLogToArray:(id)a3 usingFormatter:(id)a4
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      int v17 = 138412290;
      v18 = v8;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_DEFAULT, "BatteryQueryForShutdownData: %@", (uint8_t *)&v17, 0xCu);
    }
    ...
    else
    {
      ...
      {
        LOWORD(v17) = 0;
        _os_log_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_DEFAULT, "BatteryShutdownData is empty", (uint8_t *)&v17, 2u);
      }
  ...
  {
    LOWORD(v17) = 0;
    _os_log_error_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_ERROR, "[ERROR] BatteryQueryForShutdownData returned nil", (uint8_t *)&v17, 2u);
  }
}
...
- (id)processedBatteryShutdownDataEntry:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      id v6 = +[DSDateFormatter sharedFormatter];
      ...
      if (v8)
      {
        ...
        v130[11] = v11;
        unint64_t v12 = [v4 objectForKeyedSubscript:@"RaTable_13"];
