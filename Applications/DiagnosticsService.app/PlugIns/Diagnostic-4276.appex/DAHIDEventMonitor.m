...
+ (DAHIDEventMonitor)sharedInstance
{
  if (qword_100011CA8 != -1) {
    dispatch_once(&qword_100011CA8, &stru_10000C578);
  }
  v2 = (void *)qword_100011CA0;

  return (DAHIDEventMonitor *)v2;
}
    ...
    if (v7)
    {
      ...
      while (2)
      {
        for (i = 0; i != v8; i = (char *)i + 1)
        {
          ...
          id v16 = objc_msgSend(v15, "objectAtIndexedSubscript:", objc_msgSend(v11, "unsignedIntegerValue"));
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      do
      {
        ...
        v11 = objc_msgSend(v10, "objectAtIndexedSubscript:", objc_msgSend(v4, "unsignedIntegerValue"));
...
- (void)stopMonitoring
{
  ...
  if (v3)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100006DA8;
    block[3] = &unk_10000C480;
    block[4] = v2;
