...
- (id)stringForInEarStatus:(int)a3
{
  if (a3 > 4) {
    ...
    return (id)*((void *)&off_100010518 + a3);
  }
}
...
- (id)stringForListeningMode:(unsigned int)a3
{
  if (a3 - 1 > 3) {
    ...
    return (id)*((void *)&off_100010540 + (int)(a3 - 1));
  }
}
...
- (id)generationStringForProductId:(unsigned int)a3
{
  if (a3 - 8194 > 0x11) {
    ...
    return (id)*((void *)&off_100010560 + (int)(a3 - 8194));
  }
}
...
{
  id v3 = a3;
  if (qword_100015420 != -1) {
    dispatch_once(&qword_100015420, &stru_1000104A8);
  }
  id v4 = objc_alloc_init((Class)NSMutableDictionary);
  long long v35 = 0u;
  long long v36 = 0u;
  long long v37 = 0u;
  long long v38 = 0u;
  id obj = [(id)qword_100015418 connectedDevices];
...
- (id)microphoneCalibrationResultForDevice:(id)a3
{
  ...
  long long v25 = sub_100009AF4;
  long long v26 = sub_100009B04;
