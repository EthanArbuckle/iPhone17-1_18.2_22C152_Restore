...
- (BOOL)isBetaBuild
{
  if (qword_100015408 != -1) {
    dispatch_once(&qword_100015408, &stru_100010440);
  }
  return byte_100015400;
}

- (BOOL)isInternalInstall
{
  if (qword_100015410 != -1) {
    dispatch_once(&qword_100015410, &stru_100010460);
  }
  return byte_100015401;
}
...
LABEL_13:
    unsigned int v8 = &stru_1000110D0;
    goto LABEL_18;
  }
  int v5 = v4;
