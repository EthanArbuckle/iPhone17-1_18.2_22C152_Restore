...
+ (id)runTouchIDDiagnostic:(int)a3 options:(id)a4
{
  ...
  else
  {
    ...
    [v6 setObject:&off_1000042D8 forKeyedSubscript:@"testStatus"];
  }
...
+ (id)convertKey:(id)a3 toJSON:(BOOL)a4
{
  ...
  if (v4)
  {
    if (v7 == 107)
    {
      ...
      [v6 replaceCharactersInRange:0, 1 withString:v9];
    }
  }
  else if (v7 != 107)
  {
    ...
    [v6 replaceCharactersInRange:0, 1, v11];
