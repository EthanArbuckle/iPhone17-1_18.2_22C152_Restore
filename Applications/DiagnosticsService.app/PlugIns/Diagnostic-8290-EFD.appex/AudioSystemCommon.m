...
- (id)writeCurrentResultsToJson
{
  ...
  [v3 setObject:&off_10001DA10 forKeyedSubscript:@"d"];
  id v9 = [(AudioSystemCommon *)self testID];
  [v3 setObject:v9 forKeyedSubscript:@"k"];

  [v3 setObject:&off_10001D748 forKeyedSubscript:@"e"];
  id v10 = +[NSDate date];
...
- (void)parseTestResults:(id)a3 fromOutput:(id)a4 withFile:(id)a5 parsedResults:(id)a6 sequenceIndex:(id)a7 error:(id)a8
{
  ...
  id v19 = &AudioServicesPlaySystemSoundWithOptions_ptr;
  v59 = self;
  id v51 = v15;
  while (2)
  {
    for (i = 0; i != v54; i = (char *)i + 1)
    {
        ...
        if (v25)
        {
          if ([v25 code] == (id)-70)
          {
            ...
            if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR)) {
              sub_1000105FC((uint64_t)v57, v15, v47);
            }
          }
        }
        else
      ...
      id v28 = [v19[149] numberWithInteger:[v21 inputID]];
...
- (void)performAnalysisOnAVResult:(id)a3 fromOutput:(id)a4 withSourceSignalData:(id)a5 intoDKResult:(id)a6 error:(id)a7
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_FAULT)) {
    sub_100010728(v7, v8, v9, v10, v11, v12, v13, v14);
  }
}
...
- (id)archiveNameTemplate
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_FAULT)) {
    sub_100010760(v2, v3, v4, v5, v6, v7, v8, v9);
  }
...
- (id)testID
{
  id v2 = DiagnosticLogHandleForCategory();
  if (os_log_type_enabled(v2, OS_LOG_TYPE_FAULT)) {
    sub_100010798(v2, v3, v4, v5, v6, v7, v8, v9);
  }

  return &off_10001D730;
}
