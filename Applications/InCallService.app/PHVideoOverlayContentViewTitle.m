...
- (void)setupViewWithTitle:(id)a3
{
  ...
  id v15 = [(PHVideoOverlayContentViewTitle *)self titleLabel];
...
- (void)updateConstraints
{
  ...
  id v4 = +[NSLayoutConstraint constraintWithItem:v3 attribute:9 relatedBy:0 toItem:self attribute:9 multiplier:1.0 constant:0.0];
  [(PHVideoOverlayContentViewTitle *)self addConstraint:v4];

  id v5 = [(PHVideoOverlayContentViewTitle *)self titleLabel];
  ...
  v7 = [(PHVideoOverlayContentViewTitle *)self titleLabel];
  objc_super v8 = +[NSLayoutConstraint constraintWithItem:v7 attribute:7 relatedBy:0 toItem:self attribute:7 multiplier:1.0 constant:0.0];
