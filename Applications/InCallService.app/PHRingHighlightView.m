...
+ (CGSize)ringSize
{
  ...
  *(double *)&uint64_t v8 = 75.0;
  if (v4 <= v7)
  {
    ...
    uint64_t v8 = *((uint64_t *)&unk_100284510 + ((v10 & 0xFFFFFFFFFFFFFFFBLL) == 1));
  }
...
+ (id)ringImageForLuminance
{
  double v3 = (void *)qword_100325DE8;
  if (!qword_100325DE8)
  {
    [a1 ringSize];
    double v5 = v4;
    ...
    double v12 = (void *)qword_100325DE8;
    qword_100325DE8 = v11;
...
+ (id)ringImageForDodge
{
  double v3 = (void *)qword_100325DF0;
  if (!qword_100325DF0)
  {
    [a1 ringSize];
    double v5 = v4;
    ...
    uint64_t v11 = [a1 createRingImageWithSize:v10 strokeWidth:v5 color:v7];
    double v12 = (void *)qword_100325DF0;
    qword_100325DF0 = v11;
...
- (void)setUserInteractionEnabled:(BOOL)a3
{
  ...
  if (!a3)
  {
    ...
    float v8 = flt_100284500[[v9 _graphicsQuality] == (id)10];
  }
  *(float *)&double v7 = v8;
