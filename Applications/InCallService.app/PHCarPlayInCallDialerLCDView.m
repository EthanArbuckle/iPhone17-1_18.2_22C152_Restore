...
{
  id v5 = a3;
  id v6 = [(PHCarPlayInCallDialerLCDView *)self mainNumberLabel];
  [v6 setText:v5];
}
...
- (void)insertStringAtCurrentPosition:(id)a3 deletingPreviousCharacter:(BOOL)a4
{
  ...
  if (([v7 isEqualToString:@","] & 1) == 0
    ...
    && ([v7 isEqualToString:@"+"] & 1) == 0)
  {
    id v5 = [(PHCarPlayInCallDialerLCDView *)self text];
    id v6 = [v5 stringByAppendingString:v7];
...
- (void)deleteCharacter
{
  id v4 = [(PHCarPlayInCallDialerLCDView *)self text];
