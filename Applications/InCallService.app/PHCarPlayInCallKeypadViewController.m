...
- (void)loadView
{
  ...
  *(AVExternalDevice **)((char *)&self->super._carPlayExternalDevice + 1) = (AVExternalDevice *)v18;
  ...
  [v112 setAllowedPressTypes:&off_1002DF578];
...
- (void)postMessageOverlayIfNeeded
{
        ...
        !v3))
  {
    ...
    double v14 = [v13 localizedStringForKey:@"KEYPAD_ACCESS_IS_LIMITED" value:&stru_1002D6110 table:@"PHCarPlay"];
  ...
  {
    BOOL v4 = [(PHCarPlayGenericDialerViewController *)self noContentBannerView];
