...
+ (id)sharedPreferences
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100025CD4;
  block[3] = &unk_1002CD5C8;
  block[4] = a1;
  if (qword_100325DC0 != -1) {
    dispatch_once(&qword_100325DC0, block);
  }
  v2 = (void *)qword_100325DB8;
...
- (NSString)pptOutgoingCallHandleValue
{
  int v3 = NSStringFromSelector("pptOutgoingCallHandleValue");
  int64_t v4 = [(PHPreferences *)self stringForKey:v3 defaultValue:@"+14089619342"];
...
- (NSString)pptOutgoingFaceTimeCallHandleValue
{
  int v3 = NSStringFromSelector("pptOutgoingFaceTimeCallHandleValue");
  int64_t v4 = [(PHPreferences *)self stringForKey:v3 defaultValue:@"+14089619342"];
