...
- (PHCarPlayPhoneCallViewCell)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    [(UILabel *)v4->_mainLabel setText:&stru_1002D6110];
    ...
    [(UILabel *)v4->_subtitleLabel setText:&stru_1002D6110];
...
- (void)setTitle:(id)a3 subtitle:(id)a4 subtitleColor:(id)a5 localizedSenderIdentityTitle:(id)a6 animated:(BOOL)a7
{
  ...
  if (!v7)
  {
    ...
    v22 = [v21 localizedStringForKey:@"ALERT_ERROR_LABEL" value:&stru_1002D6110 table:@"Localizable-Stewie"];
    if ([v13 isEqualToString:v22])
    {
      ...
      v21 = +[NSBundle mainBundle];
      v22 = [v21 localizedStringForKey:@"ALERT_ERROR_LABEL_NO_LINE_BREAK" value:&stru_1002D6110 table:@"Localizable-Stewie"];
...
- (void)_updateBadgeViewForLocalizedSenderIdentityTitle:(id)a3
{
  ...
  if (v9 && [v9 length])
  {
    BOOL v4 = [(PHCarPlayPhoneCallViewCell *)self badgeView];
  ...
  {
    double v6 = [(PHCarPlayPhoneCallViewCell *)self badgeView];
