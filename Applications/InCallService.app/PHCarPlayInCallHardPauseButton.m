...
- (PHCarPlayInCallHardPauseButton)init
{
  ...
  if (v2)
  {
    ...
    v7 = [v6 localizedStringForKey:@"CARPLAY_HARD_PAUSE_DEFAULT_TITLE" value:&stru_1002D6110 table:@"PHCarPlay"];
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)PHCarPlayInCallHardPauseButton;
  [(PHCarPlayInCallHardPauseButton *)&v6 setHighlighted:v3];
}

- (void)hardPausePressed
{
  id v3 = [(PHCarPlayInCallHardPauseButton *)self delegate];
