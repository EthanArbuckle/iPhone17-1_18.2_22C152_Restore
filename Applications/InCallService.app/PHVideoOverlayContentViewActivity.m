...
- (void)setupViewWithTitle:(id)a3 indicatorStyle:(int64_t)a4
{
  ...
  v12 = +[UIFont systemFontOfSize:](UIFont, "systemFontOfSize:");
  [v11 setFont:v12];
  ...
  id v18 = [objc_alloc((Class)UIActivityIndicatorView) initWithActivityIndicatorStyle:a4];
  ...
  id v24 = [(PHVideoOverlayContentViewActivity *)self activityIndicator];
...
- (void)updateConstraints
{
  ...
  id v6 = +[NSLayoutConstraint constraintWithItem:v5 attribute:2 relatedBy:0 toItem:self attribute:2 multiplier:1.0 constant:0.0];
  [(PHVideoOverlayContentViewActivity *)self addConstraint:v6];

  id v7 = [(PHVideoOverlayContentViewActivity *)self activityIndicator];
  v8 = [(PHVideoOverlayContentViewActivity *)self titleLabel];
  ...
  {
    v16 = [v14 leftAnchor];
    double v17 = [(PHVideoOverlayContentViewActivity *)self leftAnchor];
