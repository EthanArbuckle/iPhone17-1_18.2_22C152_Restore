...
+ (id)currentDevice
{
  if (qword_1003261A8 != -1) {
    dispatch_once(&qword_1003261A8, &stru_1002CF808);
  }
  v2 = (void *)qword_1003261A0;
...
+ (BOOL)isGeminiCapable
{
  if (qword_1003261B8 != -1) {
    dispatch_once(&qword_1003261B8, &stru_1002CF828);
  }
  return byte_1003261B0;
}
