...
+ (id)sharedInstance
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100084740;
  block[3] = &unk_1002CD5C8;
  block[4] = a1;
  if (qword_100326138 != -1) {
    dispatch_once(&qword_100326138, block);
  }
  v2 = (void *)qword_100326130;
...
{
  v10.receiver = self;
  v10.super_class = (Class)PHInCallUIUtilities;
  ...
  if (v2)
  {
    ...
    else
    {
      ...
      v7 = (unsigned int (*)(void))off_100326170;
      v15 = off_100326170;
      if (!off_100326170)
      {
        ...
        v11[3] = &unk_1002CE2D8;
        v11[4] = &v12;
        sub_1000856A0((uint64_t)v11);
        v7 = (unsigned int (*)(void))v13[3];
      }
      _Block_object_dispose(&v12, 8);
      if (!v7)
      {
        v9 = (_Unwind_Exception *)sub_1001E99E4();
        _Block_object_dispose(&v12, 8);
        _Unwind_Resume(v9);
      }
      BOOL v6 = v7(0) != 0;
...
+ (id)telephonyClient
{
  if (qword_100326148 != -1) {
    dispatch_once(&qword_100326148, &stru_1002CF410);
  }
  v2 = (void *)qword_100326140;
  ...
  if (v4)
  {
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        v9 = [*(id *)(*((void *)&v13 + 1) + 8 * i) identifier];
...
+ (BOOL)hasMultipleSenderIdentities
{
  if (qword_100326150 != -1) {
    dispatch_once(&qword_100326150, &stru_1002CF430);
  }
  v2 = [(id)qword_100326158 prioritizedSenderIdentities];
...
+ (id)fbsOrientationObserver
{
  if (qword_100326168 != -1) {
    dispatch_once(&qword_100326168, &stru_1002CF450);
  }
  v2 = (void *)qword_100326160;
    ...
    for (i = 0; i != v15; i = (char *)i + 1)
    {
      ...
      if (([v19 isSimHidden] & 1) == 0)
      {
        ...
        if (v22)
        {
          ...
          id v33 = v16;
          id v25 = [v24 copyCarrierBundleValue:v19 keyHierarchy:&off_1002DF770 bundleType:v23 error:&v33];
          id v7 = v33;
...
+ (int64_t)frontboardOrientation
{
  ...
  if ((unint64_t)(v3 - 1) > 3) {
    ...
    int64_t v4 = qword_100284E00[(void)(v3 - 1)];
  }
