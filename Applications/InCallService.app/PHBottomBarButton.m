...
+ (UIFont)defaultFont
{
  if (qword_100325E10 != -1) {
    dispatch_once(&qword_100325E10, &stru_1002CE030);
  }
  double v2 = *(double *)&qword_10031EAB8;
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  id v4 = self;
  v11.receiver = self;
  v11.super_class = (Class)PHBottomBarButton;
  -[PHBottomBarButton hitTest:withEvent:](&v11, "hitTest:withEvent:", a4, a3.x, a3.y);
  objc_super v5 = (PHBottomBarButton *)objc_claimAutoreleasedReturnValue();
  if (!v5
    || ([(PHBottomBarButton *)v4 effectView], (uint64_t v6 = objc_claimAutoreleasedReturnValue()) == 0)
    || (v7 = (void *)v6,
        [(PHBottomBarButton *)v4 effectView],
        v8 = (PHBottomBarButton *)objc_claimAutoreleasedReturnValue(),
        v8,
        v7,
        v5 != v8))
  {
...
- (void)setOrientation:(int64_t)a3
{
  if (self->_orientation != a3)
  {
    ...
    *(_OWORD *)&v9.tx = *(_OWORD *)&CGAffineTransformIdentity.tx;
    if ((unint64_t)(a3 - 2) <= 2) {
      CGAffineTransformMakeRotation(&v9, dbl_100284650[a3 - 2]);
    }
...
- (CGRect)titleRectForContentRect:(CGRect)a3
{
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      [v23 boundingRectWithSize:1 options:v22 attributes:0 context:3.40282347e38];
      double v25 = v24;
      double v27 = v26;
      ...
      if (v8 == v17)
      {
        ...
        [v29 boundingRectWithSize:1 options:v22 attributes:0 context:v17];
        double v31 = v30;
...
- (double)titleRectYOffset
{
  ...
  {
    if (qword_100325E20 != -1) {
      dispatch_once(&qword_100325E20, &stru_1002CE050);
    }
    return *(double *)&qword_100325E18;
  }
  return result;
}
