...
{
  id v6 = a3;
  if (qword_100325DE0 != -1) {
    dispatch_once(&qword_100325DE0, &stru_1002CDEC8);
  }
  v14.receiver = self;
  ...
  if (v7)
  {
    if ([(id)qword_100325DD8 length])
    {
      unint64_t v8 = 0;
      do
      {
        v9 = [qword_100325DD8 substringWithRange:v8];
        v10 = +[UIKeyCommand keyCommandWithInput:v9 modifierFlags:0 action:a4];
        [v6 addKeyCommand:v10];

        ++v8;
      }
      while (v8 < (unint64_t)[(id)qword_100325DD8 length]);
    }
...
{
  id v3 = a3;
  id v4 = [objc_alloc((Class)NSMutableDictionary) initWithDictionary:&off_1002DF538];
  for (uint64_t i = 0; i != 12; ++i)
  {
    uint64_t v6 = qword_100284478[i];
