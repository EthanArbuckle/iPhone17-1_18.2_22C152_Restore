...
- (id)localizedAttributedTextForMessage
{
  ...
  id v12 = [v8 localizedStringForKey:v10 value:&stru_10008F308 table:@"VoicemailUI"];
...
- (id)localizedAttributedFeedbackTextForConfidence:(unint64_t)a3 locale:(id)a4
{
  ...
  if (a3 - 2 < 2)
  {
    ...
    [v14 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_OPTION_NEGATIVE" value:&stru_10008F308 table:@"VoicemailUI"];
    uint64_t v15 = v42 = v9;

    uint64_t v16 = +[NSBundle mainBundle];
    v17 = [v16 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_OPTION_POSITIVE" value:&stru_10008F308 table:@"VoicemailUI"];

    +[NSBundle mainBundle];
    v18 = id v41 = v10;
    objc_super v19 = [v18 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_WITH_OPTIONS_%_OR_%" value:&stru_10008F308 table:@"VoicemailUI"];
...
LABEL_11:
  ...
  if (a3 == 1)
  {
    ...
    v20 = [v34 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_CONFIDENCE_NONE" value:&stru_10008F308 table:@"VoicemailUI"];

    id v26 = [objc_alloc((Class)NSMutableAttributedString) initWithString:&stru_10008F308 attributes:v9];
    if (v8 == (id)1)
    {
...
LABEL_5:
  ...
  if (a3 == 1)
  {
    ...
    id v8 = [v15 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_MESSAGE_CONFIDENCE_NONE" value:&stru_10008F308 table:@"VoicemailUI"];
...
LABEL_5:
    v13 = [v10 localizedStringForKey:v12 value:&stru_10008F308 table:@"VoicemailUI"];
