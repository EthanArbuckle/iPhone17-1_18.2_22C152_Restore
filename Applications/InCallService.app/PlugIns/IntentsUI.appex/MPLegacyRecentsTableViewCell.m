...
- (id)loadRootViewAndContentViews
{
  ...
  objc_super v4 = [(PHTableViewCell *)self titleLabel];
  [v4 setLineBreakMode:4];

  double v5 = [(PHTableViewCell *)self subtitleLabel];
  [v5 setLineBreakMode:4];

  double v6 = [(MPLegacyRecentsTableViewCell *)self featureFlags];
  ...
  double v12 = [(UIImageView *)[v8 initWithFrame:CGRectZero.origin.x, y, width, height]];
  if (v7)
  {
    ...
    double v14 = [(MPLegacyRecentsTableViewCell *)self outgoingIndicator];
    double v15 = +[UIColor dynamicTertiaryLabelColor];
  ...
  else
  {
    ...
    double v17 = +[UIColor dynamicTertiaryLabelColor];
...
- (void)updateFontsAndLayoutMetrics
{
  ...
  id v3 = [(PHTableViewCell *)self subtitleLabel];
  objc_super v4 = [v3 font];
  double v5 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
  [v5 setFont:v4];

  [(id)objc_opt_class() largestCallTypeIconWidth];
  double v7 = v6;
  id v8 = [(MPLegacyRecentsTableViewCell *)self callTypeIconSizingView];
...
- (void)updateDateLabelAlignment
{
  ...
  objc_super v4 = [(MPLegacyRecentsTableViewCell *)self gridView];
  double v5 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
  if (v3) {
    uint64_t v6 = 4;
  }
...
- (NSDirectionalEdgeInsets)rootViewLayoutMargins
{
  ...
  double v6 = v5;
  double v8 = v7;
  double v9 = [(MPLegacyRecentsTableViewCell *)self featureFlags];
  ...
  if (v10)
  {
    ...
    double v8 = v11;
    double v12 = [(MPLegacyRecentsTableViewCell *)self contentView];
...
- (void)setItem:(id)a3
{
  ...
  if (self->_item != v113)
  {
    ...
    double v5 = [(PHRecentsItem *)v113 localizedCount];
    double v6 = [(MPLegacyRecentsTableViewCell *)self callerCountLabel];
    [v6 setText:v5];

    double v7 = [(PHRecentsItem *)v113 date];
    double v8 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
    [v8 setDate:v7];

    double v9 = [(PHRecentsItem *)v113 localizedSubtitle];
    unsigned int v10 = [(PHTableViewCell *)self subtitleLabel];
    [v10 setText:v9];

    double v11 = [(PHRecentsItem *)v113 localizedValidHandlesTitle];
    ...
    if (![(MPLegacyRecentsTableViewCell *)self isAccessibilityConstraintsEnabled])
    {
      ...
      if (v14)
      {
        ...
        if ((v15 & 1) == 0)
        {
          objc_super v21 = [(PHTableViewCell *)self titleLabel];
          [v21 setLineBreakMode:5];
        }
      }
    }
    callTypeIconView = self->_callTypeIconView;
    v23 = [(PHRecentsItem *)v113 image];
...
LABEL_16:
  ...
  if (v73)
  {
    ...
    if ((v90 & 1) == 0)
    {
      ...
      v95 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
      v96 = [(MPLegacyRecentsTableViewCell *)self badgeView];
      if (v94)
      {
        v97 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
        v98 = [v97 arrangedSubviews];
        v99 = [(MPLegacyRecentsTableViewCell *)self outgoingIndicator];
      ...
      v101 = [(MPLegacyRecentsTableViewCell *)self badgeView];
  ...
  else
  {
    ...
    v79 = [(MPLegacyRecentsTableViewCell *)self badgeView];
...
- (void)configureWithRecentsItem:(id)a3 recentCall:(id)a4
{
  ...
  if (v6 == kCHCallStatusMissed)
  {
    ...
    double v9 = [(MPLegacyRecentsTableViewCell *)self _accessibilityHigherContrastTintColorForColor:v8];
  }
  else
  {
    double v9 = +[UIColor dynamicLabelColor];
  }
  ...
  double v11 = [(PHTableViewCell *)self titleLabel];
  }
...
- (void)setTapTargets:(BOOL)a3
{
  if (self->_tapTargets != a3)
  {
    ...
    if (a3)
    {
      ...
      if (!v4)
      {
        double v5 = (TPAccessoryButton *)objc_alloc_init((Class)TPAccessoryButton);
        callButton = self->_callButton;
        self->_callButton = v5;

        int v7 = self->_callButton;
...
- (void)configureGridViewArrangedSubviews
{
  ...
  v109[1] = 3221225472;
  v109[2] = sub_100011DF4;
  v109[3] = &unk_10008D758;
  v109[4] = self;
  BOOL v3 = objc_retainBlock(v109);
  if ([(MPLegacyRecentsTableViewCell *)self isAccessibilityConstraintsEnabled])
  {
    ...
    {
      unsigned int v6 = [(MPLegacyRecentsTableViewCell *)self gridView];
    ...
    id v14 = [(PHTableViewCell *)self titleLabel];
    v127 = v14;
    CFStringRef v15 = +[NSArray arrayWithObjects:&v127 count:1];
    ...
    v126[1] = v20;
    double v21 = +[NSArray arrayWithObjects:v126 count:2];
    v22 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
    [v22 setArrangedSubviews:v21];

    double v23 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
    [v23 setAxis:0];
    ...
    {
      v124[0] = v26;
      double v105 = [(MPLegacyRecentsTableViewCell *)self titleStackView];
      v124[1] = v105;
      ...
      v123[1] = v29;
      uint64_t v30 = +[NSArray arrayWithObjects:v123 count:2];
      v125[1] = v30;
      ...
      v122[1] = v32;
      id v33 = +[NSArray arrayWithObjects:v122 count:2];
      v125[2] = v33;
      ...
      unsigned __int8 v37 = [(MPLegacyRecentsTableViewCell *)self callTypeIconView];
      [v36 setAlignment:4 forView:v37 inAxis:0];

      id v27 = [(MPLegacyRecentsTableViewCell *)self gridView];
    ...
    else
    {
      ...
      v120[1] = v38;
      double v107 = +[NSArray arrayWithObjects:v120 count:2];
      v121[0] = v107;
      ...
      v118[1] = v72;
      id v73 = +[NSArray arrayWithObjects:v118 count:2];
      v121[2] = v73;
...
LABEL_12:
    ...
    id v42 = [(PHTableViewCell *)self subtitleLabel];
    ...
    unsigned __int8 v48 = [(MPLegacyRecentsTableViewCell *)self titleStackView];
    [v48 setAlignment:5];
    ...
    if (self->_callTypeIconView)
    {
      ...
      v114[1] = v56;
      double v57 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
      v114[2] = v57;
      v58 = +[NSArray arrayWithObjects:v114 count:3];
      v115[0] = v58;
      double v59 = [(MPLegacyRecentsTableViewCell *)self callTypeIconSizingView];
      v113[0] = v59;
      v60 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
      v113[1] = v60;
      double v61 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
      v113[2] = v61;
      v62 = +[NSArray arrayWithObjects:v113 count:3];
      v115[1] = v62;
      double v63 = +[NSArray arrayWithObjects:v115 count:2];
      v64 = [(MPLegacyRecentsTableViewCell *)self gridView];
      ...
      unsigned int v68 = [(MPLegacyRecentsTableViewCell *)self callTypeIconView];
    ...
    else
    {
      ...
      v111[0] = v67;
      unsigned int v68 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
      v111[1] = v68;
      unsigned int v80 = +[NSArray arrayWithObjects:v111 count:2];
      v112[0] = v80;
      v81 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
      v110[0] = v81;
      ...
      v112[1] = v83;
      id v84 = +[NSArray arrayWithObjects:v112 count:2];
...
LABEL_21:
    ...
    id v86 = [(MPLegacyRecentsTableViewCell *)self gridView];
...
LABEL_22:
  if (self->_outgoingIndicator)
  {
    ...
    unsigned __int8 v90 = [(MPLegacyRecentsTableViewCell *)self subtitleStackView];
    ...
    unsigned int v94 = [(MPLegacyRecentsTableViewCell *)self outgoingIndicator];
...
- (void)updateRootView
{
  BOOL v3 = [(MPLegacyRecentsTableViewCell *)self avatarViewController];
  ...
  if (v3)
  {
    ...
    double v8 = [(MPLegacyRecentsTableViewCell *)self avatarViewController];
    id v9 = [v8 view];
    ...
    double v19 = v9;
    CFStringRef v15 = +[NSArray arrayWithObjects:&v19 count:1];
    id v16 = [v14 insertColumnAtIndex:0 withArrangedSubviews:v15];

    double v17 = [(MPLegacyRecentsTableViewCell *)self gridView];
    [v17 setAlignment:1 forView:v9 inAxis:0];

    double v18 = [(MPLegacyRecentsTableViewCell *)self gridView];
...
- (void)callButtonTapped:(id)a3
{
  ...
  if (v4)
  {
    id v5 = [(MPLegacyRecentsTableViewCell *)self callButtonTappedHandler];
    v5[2]();
  }
}
...
- (void)updateFonts
{
  BOOL v3 = +[UIFont telephonyUIBodyShortEmphasizedFont];
  ...
  CFStringRef v15 = [(PHTableViewCell *)self titleLabel];
  }
  id v16 = [v15 font];
...
- (void)updateTextColor
{
  BOOL v3 = +[UIColor dynamicSecondaryLabelColor];
  id v4 = [(MPLegacyRecentsTableViewCell *)self _accessibilityHigherContrastTintColorForColor:v3];
  ...
  id v7 = [(MPLegacyRecentsTableViewCell *)self callerDateLabel];
  [v7 setTextColor:v6];
}
