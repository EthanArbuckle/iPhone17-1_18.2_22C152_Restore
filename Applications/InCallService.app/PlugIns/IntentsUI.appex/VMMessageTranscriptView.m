...
- (void)commonInit
{
  ...
  v12 = [v11 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_TITLE" value:&stru_10008F308 table:@"VoicemailUI"];
...
- (void)loadConstraints
{
  ...
  [(VMMessageTranscriptView *)self textViewFirstBaselineLayoutConstraintConstant];
  v68 = [v65 constraintEqualToAnchor:v67 constant:];
...
- (void)openFeedbackURL:(id)a3
{
  ...
  double v22 = [v21 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_REPORTED" value:&stru_10008F308 table:@"VoicemailUI"];
