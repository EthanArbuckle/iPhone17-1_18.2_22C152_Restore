...
- (NSUUID)callUUID
{
  uint64_t v2 = sub_100035DD8(&qword_1000A1958);
...
- (NSString)senderDestinationID
{
  return (NSString *)sub_100057BE4((uint64_t)self, (uint64_t)a2, (uint64_t)&selRef_normalizedValue, (void (*)(uint64_t))sub_100057C70);
}

- (NSString)senderISOCountryCode
{
  return (NSString *)sub_100057BE4((uint64_t)self, (uint64_t)a2, (uint64_t)&selRef_isoCountryCode, (void (*)(uint64_t))sub_100057C70);
}

- (NSString)receiverDestinationID
{
  return (NSString *)sub_100057BE4((uint64_t)self, (uint64_t)a2, (uint64_t)&selRef_normalizedValue, (void (*)(uint64_t))sub_100057D90);
}

- (NSString)receiverISOCountryCode
{
  return (NSString *)sub_100057BE4((uint64_t)self, (uint64_t)a2, (uint64_t)&selRef_isoCountryCode, (void (*)(uint64_t))sub_100057D90);
}
...
- (NSDate)date
{
  ...
  sub_100061F80();
  swift_release();
  v6.super.Class isa = sub_100061CF0().super.isa;
...
- (BOOL)isTranscriptionAvailable
{
  return sub_1000596B0((uint64_t)self, (uint64_t)a2, (uint64_t (*)(uint64_t))sub_1000581F0);
}
...
- (BOOL)transcriptionAttempted
{
  swift_retain();
  sub_100061FD0();
  int v2 = (unsigned __int16)sub_1000621C0();
  unsigned __int16 v3 = sub_1000621C0();
  swift_release();
  return v2 != v3;
}
...
- (BOOL)isSensitive
{
  return sub_10005964C((uint64_t)self, (uint64_t)a2, (uint64_t (*)(uint64_t))&dispatch thunk of Message.isSensitive.getter);
}
...
- (NSURL)dataURL
{
  ...
  swift_retain();
  sub_100058B1C((uint64_t)v4);
  swift_release();
  uint64_t v5 = sub_100061CD0();
  uint64_t v6 = *(void *)(v5 - 8);
  uint64_t v8 = 0;
  if ((*(unsigned int (**)(char *, uint64_t, uint64_t))(v6 + 48))(v4, 1, v5) != 1)
  {
...
- (NSURL)thumbnailURL
{
  ...
  uint64_t v4 = (char *)&v11 - ((v3 + 15) & 0xFFFFFFFFFFFFFFF0);
  swift_retain();
  sub_10005903C(&OBJC_IVAR____TtC9IntentsUI9FTMessage____lazy_storage___thumbnailURL, (uint64_t (*)(uint64_t))&dispatch thunk of Message.sandboxThumbnailFile.getter, (uint64_t)v4);
  swift_release();
  uint64_t v5 = sub_100061CD0();
  uint64_t v6 = *(void *)(v5 - 8);
  uint64_t v8 = 0;
...
- (BOOL)isRTT
{
  return sub_10005964C((uint64_t)self, (uint64_t)a2, (uint64_t (*)(uint64_t))&dispatch thunk of Message.isRTT.getter);
}

- (BOOL)isDataAvailable
{
  return sub_1000596B0((uint64_t)self, (uint64_t)a2, (uint64_t (*)(uint64_t))sub_1000596F0);
}

- (MPTranscriptMessage)transcript
{
  swift_retain();
  uint64_t v2 = (void *)sub_100058688();
  swift_release();
...
- (void)setTranscript:(id)a3
{
  uint64_t v3 = *(void *)&self->_TtCs12_SwiftObject_opaque[OBJC_IVAR____TtC9IntentsUI9FTMessage____lazy_storage___transcript];
  *(void *)&self->_TtCs12_SwiftObject_opaque[OBJC_IVAR____TtC9IntentsUI9FTMessage____lazy_storage___transcript] = a3;
