...
- (void)fetchRTTConversationForCallUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_1000ABC68;
    block[3] = &unk_1002CFD40;
      ...
      do
      {
        for (i = 0; i != v6; i = (char *)i + 1)
        {
          ...
          if (([v9 isMe] & 1) == 0)
          {
            ...
            {
              id v11 = ttyLocString();
              v12 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v11, &stru_1002D6110);

              uint64_t v13 = [v10 stringByReplacingOccurrencesOfString:v12 withString:&stru_1002D6110];
...
- (NSString)text
{
  return (NSString *)sub_10017EDE8(self, (uint64_t)a2, (void (*)(void))sub_10017EE54);
}
