...
- (void)addSccList:(id)a3
{
  ...
  [(NSMutableArray *)sccLists addObject:v4];
}

- (unint64_t)sccListsCount
{
  return (unint64_t)[(NSMutableArray *)self->_sccLists count];
}

- (id)sccListAtIndex:(unint64_t)a3
{
  return [(NSMutableArray *)self->_sccLists objectAtIndex:a3];
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)KCellularLteCarrierAggregationStatus;
  char v3 = [(KCellularLteCarrierAggregationStatus *)&v7 description];
  id v4 = [(KCellularLteCarrierAggregationStatus *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v5 = [objc_alloc((Class)NSMutableArray) initWithCapacity:-[NSMutableArray count](self->_sccLists, "count")];
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000503F4((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearSccLists];
    unint64_t v5 = [(KCellularLteCarrierAggregationStatus *)self sccListsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(KCellularLteCarrierAggregationStatus *)self sccListAtIndex:i];
        [v9 addSccList:v8];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  sccLists = self->_sccLists;
  if ((unint64_t)sccLists | *((void *)v4 + 2))
  {
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = (unint64_t)[(NSMutableArray *)self->_sccLists hash];
  if ((*(unsigned char *)&self->_has & 2) != 0) {
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[KCellularLteCarrierAggregationStatus addSccList:](self, "addSccList:", *(void *)(*((void *)&v11 + 1) + 8 * (void)v10), (void)v11);
