...
- (void)setEutraBand:(unsigned int)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)LteCellMeasResult;
  char v3 = [(LteCellMeasResult *)&v7 description];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    objc_super v7 = +[NSNumber numberWithUnsignedInt:self->_earfcn];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10010A9A8((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  ...
  *((_DWORD *)result + 4) = self->_phyCellId;
...
LABEL_10:
  *((_DWORD *)result + 3) = self->_eutraBand;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_earfcn != *((_DWORD *)v4 + 2)) {
      goto LABEL_26;
    }
  }
...
LABEL_26:
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 4) == 0 || self->_phyCellId != *((_DWORD *)v4 + 4)) {
      goto LABEL_26;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 2) == 0 || self->_eutraBand != *((_DWORD *)v4 + 3)) {
      goto LABEL_26;
    }
  }
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
LABEL_3:
      uint64_t v3 = 2654435761 * self->_phyCellId;
      if ((*(unsigned char *)&self->_has & 2) != 0) {
        goto LABEL_4;
      }
      goto LABEL_9;
  ...
  {
LABEL_4:
    uint64_t v4 = 2654435761 * self->_eutraBand;
    if ((*(unsigned char *)&self->_has & 8) != 0) {
      goto LABEL_5;
    }
LABEL_10:
...
LABEL_5:
  uint64_t v5 = 2654435761 * self->_rsrp;
  if ((*(unsigned char *)&self->_has & 0x10) == 0) {
    goto LABEL_11;
  }
LABEL_6:
