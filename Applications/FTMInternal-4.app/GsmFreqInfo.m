...
{
  v7.receiver = self;
  v7.super_class = (Class)GsmFreqInfo;
  char v3 = [(GsmFreqInfo *)&v7 description];
  v4 = [(GsmFreqInfo *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100010058((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 16) & 1) == 0 || self->_arfcn != *((_DWORD *)v4 + 2)) {
      goto LABEL_11;
    }
  }
