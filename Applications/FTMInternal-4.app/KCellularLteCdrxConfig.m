...
{
  v7.receiver = self;
  v7.super_class = (Class)KCellularLteCdrxConfig;
  __int16 v3 = [(KCellularLteCdrxConfig *)&v7 description];
  int v4 = [(KCellularLteCdrxConfig *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100015294((uint64_t)self, (uint64_t)a3);
}
