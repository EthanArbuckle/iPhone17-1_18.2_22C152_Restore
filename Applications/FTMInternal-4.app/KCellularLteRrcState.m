...
{
  v7.receiver = self;
  v7.super_class = (Class)KCellularLteRrcState;
  char v3 = [(KCellularLteRrcState *)&v7 description];
  int v4 = [(KCellularLteRrcState *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10013FE30((uint64_t)self, (uint64_t)a3);
}
