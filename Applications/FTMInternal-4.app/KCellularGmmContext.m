...
- (void)setHasT3312DurS:(BOOL)a3;
- (void)setHasTimestamp:(BOOL)a3;
- (void)setHasUpdateStatus:(BOOL)a3;
- (void)setPTmsi:(unsigned int)a3;
...
- (void)setT3312DurS:(unsigned int)a3;
...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"GPRS_STATUS_UPDATED"])
  {
    int v4 = 0;
  }
  else if ([v3 isEqualToString:@"GPRS_STATUS_NOT_UPDATED"])
  {
    int v4 = 1;
  }
  else if ([v3 isEqualToString:@"GPRS_STATUS_ROAMING_NOT_ALLOWED"])
  {
    int v4 = 2;
  }
  else
...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_LOCATION_AREA_UPDATE"])
  {
    int v4 = 0;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_ATTACH"])
  {
    int v4 = 1;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_ROUTING_AREA_UPDATE"])
  {
    int v4 = 2;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_COMBINED_RAU"])
  {
    int v4 = 3;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_COMBINED_ATTACH"])
  {
    int v4 = 4;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_NW_DETACH"])
  {
    int v4 = 5;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_SERVICE_REQ"])
  {
    int v4 = 6;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_NW_ABORT"])
  {
    int v4 = 7;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_TRACKING_AREA_UPDATE"])
  {
    int v4 = 8;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_COMBINED_TAU"])
  {
    int v4 = 9;
  }
  else if ([v3 isEqualToString:@"KNAS_MM_REG_PROC_PROC_NONE"])
  {
    int v4 = 10;
  }
  else
...
{
  v7.receiver = self;
  v7.super_class = (Class)KCellularGmmContext;
  __int16 v3 = [(KCellularGmmContext *)&v7 description];
  int v4 = [(KCellularGmmContext *)self dictionaryRepresentation];
...
LABEL_27:
  ...
  if (rai)
  {
    v11 = [(RoutingAreaId *)rai dictionaryRepresentation];
    [v3 setObject:v11 forKey:@"rai"];
  }
...
LABEL_41:
  ...
  {
    v18 = *(&off_1002875C0 + procFailureCause);
  }
...
- (BOOL)readFrom:(id)a3
{
  return sub_100084324((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  ...
  *((_DWORD *)v4 + 9) = self->_regStatus;
  *((_WORD *)v4 + 28) |= 0x10u;
  if ((*(_WORD *)&self->_has & 0x100) != 0)
  {
LABEL_4:
    *((_DWORD *)v4 + 13) = self->_updateStatus;
    *((_WORD *)v4 + 28) |= 0x100u;
  }
LABEL_5:
  if (self->_rai)
...
LABEL_22:
  *((_DWORD *)v4 + 5) = self->_procFailureCause;
  *((_WORD *)v4 + 28) |= 4u;
  __int16 v6 = (__int16)self->_has;
  if ((v6 & 0x20) == 0)
  {
...
LABEL_23:
  *((_DWORD *)v4 + 10) = self->_rejectCause;
  *((_WORD *)v4 + 28) |= 0x20u;
  __int16 v6 = (__int16)self->_has;
  if ((v6 & 8) == 0)
  {
...
LABEL_3:
  ...
  *((_DWORD *)v5 + 9) = self->_regStatus;
  *((_WORD *)v5 + 28) |= 0x10u;
  if ((*(_WORD *)&self->_has & 0x100) != 0)
  {
LABEL_4:
    *((_DWORD *)v5 + 13) = self->_updateStatus;
    *((_WORD *)v5 + 28) |= 0x100u;
  }
LABEL_5:
  id v8 = [(RoutingAreaId *)self->_rai copyWithZone:a3];
  v9 = (void *)v6[3];
  v6[3] = v8;
...
LABEL_18:
  *((_DWORD *)v6 + 5) = self->_procFailureCause;
  *((_WORD *)v6 + 28) |= 4u;
  __int16 v10 = (__int16)self->_has;
  if ((v10 & 0x20) == 0)
  {
...
LABEL_19:
  *((_DWORD *)v6 + 10) = self->_rejectCause;
  *((_WORD *)v6 + 28) |= 0x20u;
  __int16 v10 = (__int16)self->_has;
  if ((v10 & 8) != 0) {
    goto LABEL_20;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x10) != 0)
  {
    if ((v6 & 0x10) == 0 || self->_regStatus != *((_DWORD *)v4 + 9)) {
      goto LABEL_50;
    }
  }
  else if ((v6 & 0x10) != 0)
  ...
  if ((*(_WORD *)&self->_has & 0x100) != 0)
  {
    if ((*((_WORD *)v4 + 28) & 0x100) == 0 || self->_updateStatus != *((_DWORD *)v4 + 13)) {
      goto LABEL_50;
    }
  }
  ...
  rai = self->_rai;
  if ((unint64_t)rai | *((void *)v4 + 3))
  {
    if (!-[RoutingAreaId isEqual:](rai, "isEqual:"))
    {
LABEL_50:
      BOOL v9 = 0;
      goto LABEL_51;
  ...
  if ((has & 2) != 0)
  {
    if ((v8 & 2) == 0 || self->_pTmsi != *((_DWORD *)v4 + 4)) {
      goto LABEL_50;
    }
  }
  else if ((v8 & 2) != 0)
  ...
  if ((has & 0x80) != 0)
  {
    if ((v8 & 0x80) == 0 || self->_t3312DurS != *((_DWORD *)v4 + 12)) {
      goto LABEL_50;
    }
  }
  else if ((v8 & 0x80) != 0)
  ...
  if ((has & 4) != 0)
  {
    if ((v8 & 4) == 0 || self->_procFailureCause != *((_DWORD *)v4 + 5)) {
      goto LABEL_50;
    }
  }
  else if ((v8 & 4) != 0)
  ...
  if ((has & 0x20) != 0)
  {
    if ((v8 & 0x20) == 0 || self->_rejectCause != *((_DWORD *)v4 + 10)) {
      goto LABEL_50;
    }
  }
  else if ((v8 & 0x20) != 0)
  ...
  if ((has & 8) != 0)
  {
    if ((v8 & 8) == 0 || self->_regProc != *((_DWORD *)v4 + 8)) {
      goto LABEL_50;
    }
  }
  else if ((v8 & 8) != 0)
...
LABEL_7:
  uint64_t v6 = 0;
LABEL_8:
  unint64_t v7 = [(RoutingAreaId *)self->_rai hash];
  __int16 v8 = (__int16)self->_has;
  if ((v8 & 2) != 0)
  {
    uint64_t v9 = 2654435761 * self->_pTmsi;
    if ((v8 & 0x80) != 0)
    {
LABEL_10:
      uint64_t v10 = 2654435761 * self->_t3312DurS;
      if ((v8 & 4) != 0) {
        goto LABEL_11;
      }
      goto LABEL_17;
...
LABEL_13:
  uint64_t v13 = 2654435761 * self->_regProc;
  if ((v8 & 0x40) == 0) {
    goto LABEL_20;
  }
LABEL_14:
...
LABEL_3:
  ...
  self->_int regStatus = *((_DWORD *)v4 + 9);
  *(_WORD *)&self->_has |= 0x10u;
  if ((*((_WORD *)v4 + 28) & 0x100) != 0)
  {
LABEL_4:
    self->_uint64_t updateStatus = *((_DWORD *)v4 + 13);
    *(_WORD *)&self->_has |= 0x100u;
  }
LABEL_5:
  rai = self->_rai;
  ...
  if (rai)
  {
    ...
    id v10 = v5;
    -[RoutingAreaId mergeFrom:](rai, "mergeFrom:");
  }
  else
  {
    if (!v8) {
    ...
    id v10 = v5;
    -[KCellularGmmContext setRai:](self, "setRai:");
  }
  id v5 = v10;
LABEL_14:
...
LABEL_26:
  self->_uint64_t procFailureCause = *((_DWORD *)v5 + 5);
  *(_WORD *)&self->_has |= 4u;
  __int16 v9 = *((_WORD *)v5 + 28);
  if ((v9 & 0x20) == 0)
  {
...
LABEL_27:
  self->_int rejectCause = *((_DWORD *)v5 + 10);
  *(_WORD *)&self->_has |= 0x20u;
  __int16 v9 = *((_WORD *)v5 + 28);
  if ((v9 & 8) == 0)
  {
...
LABEL_28:
  self->_uint64_t regProc = *((_DWORD *)v5 + 8);
  *(_WORD *)&self->_has |= 8u;
