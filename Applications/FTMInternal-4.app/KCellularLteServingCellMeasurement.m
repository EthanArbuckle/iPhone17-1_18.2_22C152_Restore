...
- (void)setIsConnectedMode:(BOOL)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)KCellularLteServingCellMeasurement;
  char v3 = [(KCellularLteServingCellMeasurement *)&v7 description];
  id v4 = [(KCellularLteServingCellMeasurement *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10004C984((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((unsigned char *)v4 + 28) = self->_isConnectedMode;
  ...
  {
    [v10 clearRxInfos];
    unint64_t v6 = [(KCellularLteServingCellMeasurement *)self rxInfosCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(KCellularLteServingCellMeasurement *)self rxInfoAtIndex:i];
        [v10 addRxInfo:v9];
      }
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((unsigned char *)v5 + 28) = self->_isConnectedMode;
...
- (unint64_t)hash
{
  ...
  else
  {
    ...
    {
LABEL_3:
      uint64_t v4 = 2654435761 * self->_isConnectedMode;
      goto LABEL_6;
    }
  }
  uint64_t v4 = 0;
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v6 & 4) != 0)
  {
    self->_isConnectedMode = *((unsigned char *)v4 + 28);
    *(unsigned char *)&self->_has |= 4u;
  }
  long long v14 = 0u;
  long long v15 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; uint64_t i = (char *)i + 1)
      {
        ...
        -[KCellularLteServingCellMeasurement addRxInfo:](self, "addRxInfo:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
