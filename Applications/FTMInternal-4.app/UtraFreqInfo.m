...
{
  v7.receiver = self;
  v7.super_class = (Class)UtraFreqInfo;
  char v3 = [(UtraFreqInfo *)&v7 description];
  v4 = [(UtraFreqInfo *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10010C874((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((_DWORD *)result + 3) = self->_uarfcn;
    *((unsigned char *)result + 16) |= 2u;
    char has = (char)self->_has;
  }
  if (has)
  {
    *((_DWORD *)result + 2) = self->_prio;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 16) & 2) == 0 || self->_uarfcn != *((_DWORD *)v4 + 3)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 16) & 1) == 0 || self->_prio != *((_DWORD *)v4 + 2)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_uarfcn = *((_DWORD *)v4 + 3);
    *(unsigned char *)&self->_has |= 2u;
    char v5 = *((unsigned char *)v4 + 16);
  }
  if (v5)
  {
    self->_prio = *((_DWORD *)v4 + 2);
    *(unsigned char *)&self->_has |= 1u;
  }
}
