...
{
  v7.receiver = self;
  v7.super_class = (Class)KCellularWcdmaRrcConfiguration;
  char v3 = [(KCellularWcdmaRrcConfiguration *)&v7 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100132BA8((uint64_t)self, (uint64_t)a3);
}
