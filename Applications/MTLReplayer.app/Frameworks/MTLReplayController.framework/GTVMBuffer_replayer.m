...
- (id)subdataWithRange:(_NSRange)a3
{
  ...
  v7 = -[GTVMBufferSubRegion_replayer initWithGTVMBuffer:range:]([GTVMBufferSubRegion_replayer alloc], "initWithGTVMBuffer:range:", self, location, length);
...
- (void)dealloc
{
  ...
  [(GTVMBuffer_replayer *)&v2 dealloc];
}
