...
{
  v3 = self->_private;
  id v4 = std::__hash_table<unsigned long long,std::hash<unsigned long long>,std::equal_to<unsigned long long>,std::allocator<unsigned long long>>::find<unsigned long long>(v3, a3);
  if (v4)
  {
    id v5 = v4;
...
- (void)dealloc
{
  ...
  [(GTIntKeyedDictionary_replayer *)&v4 dealloc];
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [a3 encodeObject:[self allKeys] forKey:@"keys"];
...
- (GTIntKeyedDictionary_replayer)initWithCoder:(id)a3
{
  ...
  id v6 = [a3 decodeObjectOfClasses:+[NSSet setWithObjects:v5, objc_opt_class(), 0] forKey:@"keys"];
  if (!v6)
  {
    unint64_t v11 = "keys";
LABEL_8:
  ...
  unint64_t v7 = v6;
  unint64_t v8 = -[GTIntKeyedDictionary_replayer initWithCapacity:](self, "initWithCapacity:", [v6 count]);
  uint8x8_t v9 = v8;
  if (v8)
  {
...
- (GTIntKeyedDictionary_replayer)initWithIntKeyedDictionary:(id)a3
{
  objc_super v4 = -[GTIntKeyedDictionary_replayer initWithCapacity:](self, "initWithCapacity:", [a3 count]);
  uint64_t v5 = v4;
  if (v4)
  {
...
- (GTIntKeyedDictionary_replayer)init
{
  return [(GTIntKeyedDictionary_replayer *)self initWithCapacity:0];
}
