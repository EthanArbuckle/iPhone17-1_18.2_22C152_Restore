...
- (id)objectPayload
{
  ...
  if (!result)
  {
    ...
    v7[8] = objc_opt_class();
    v7[9] = objc_opt_class();
    [v6 addObjectsFromArray:[NSArray arrayWithObjects:count:v7, 10]];
...
LABEL_7:
    ...
    if ((char *)[(NSData *)payload length] == (char *)&def_1C1270 + 1)
    {
      payload = self->_payload;
      goto LABEL_7;
    }
    ...
    if (!v5)
    {
      id decodedPayload = [(GTTransportMessage_replayer *)self objectPayload];
      if (decodedPayload) {
...
- (BOOL)BOOLForKey:(id)a3
{
  id v3 = [(NSDictionary *)[(GTTransportMessage_replayer *)self attributes] objectForKey:a3];
...
- (BOOL)hasBeenSent
{
  return [(GTTransportMessage_replayer *)self serial] != -1;
}
...
- (id)description
{
  ...
  return +[NSString stringWithFormat:@"%@ kind=0x%x serial=%u, reply serial=%u", [(GTTransportMessage_replayer *)&v3 description], self->_kind, self->_serial, self->_replySerial];
}
...
- (GTTransportMessage_replayer)initWithKind:(int)a3 attributes:(id)a4 objectPayload:(id)a5
{
  ...
  v11 = [(GTTransportMessage_replayer *)self initWithKind:v7 attributes:a4 payload:v5];
...
- (GTTransportMessage_replayer)initWithKind:(int)a3 attributes:(id)a4 stringPayload:(id)a5
{
  ...
  {
LABEL_5:
    id v9 = [(GTTransportMessage_replayer *)self initWithKind:v6 attributes:a4 payload:ExternalRepresentation];
...
- (GTTransportMessage_replayer)initWithKind:(int)a3 attributes:(id)a4 plistPayload:(id)a5
{
  ...
  id v10 = [(GTTransportMessage_replayer *)self initWithKind:v6 attributes:a4 payload:v9];
...
- (GTTransportMessage_replayer)initWithKind:(int)a3 attributes:(id)a4 BOOLPayload:(BOOL)a5
{
  ...
  {
    CFDataRef v9 = v8;
    id v10 = [(GTTransportMessage_replayer *)self initWithKind:v6 attributes:a4 payload:v8];
  }
  else
  {
...
- (GTTransportMessage_replayer)initWithKind:(int)a3 attributes:(id)a4 payload:(id)a5
{
  ...
  id v8 = [(GTTransportMessage_replayer *)&v11 init];
  CFDataRef v9 = v8;
  if (v8)
  {
