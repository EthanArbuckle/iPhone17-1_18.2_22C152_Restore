...
+ (id)keys
{
  if (qword_100042E40 != -1) {
    dispatch_once(&qword_100042E40, &stru_100035BE8);
  }
...
- (id)data
{
  ...
  uint64_t v17 = sub_100003338();
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG)) {
    sub_10001FBEC((uint64_t)v3, v17);
  }
