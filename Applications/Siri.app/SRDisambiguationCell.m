...
{
  v33.receiver = self;
  v33.super_class = (Class)SRDisambiguationCell;
  v3 = -[SRDisambiguationCell initWithFrame:](&v33, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v9 = [(SRDisambiguationCell *)v3 contentView];
    ...
    v13 = [(SRDisambiguationCell *)v3 contentView];
    ...
    v18 = [(SRDisambiguationCell *)v3 contentView];
    ...
    v23 = [(SRDisambiguationCell *)v3 contentView];
    ...
    v31 = [(SRDisambiguationCell *)v3 contentView];
...
- (void)layoutSubviews
{
  ...
  if ([(SRDisambiguationCell *)self isLastRow])
  {
    ...
    uint64_t v4 = 0;
LABEL_7:
    [(SRDisambiguationCell *)v3 setKeylineType:v4];
    return;
  }
  ...
  v5 = [(SRDisambiguationCell *)self keyline];
  [v5 setKeylineType:4];

  id v6 = [(SRDisambiguationCell *)self semanticContentAttribute];
  v7 = [(SRDisambiguationCell *)self keyline];
  double v8 = v7;
  if (v6 == (id)4)
  {
    [v7 setCustomRightPadding:35.0];

    v9 = [(SRDisambiguationCell *)self keyline];
...
{
  v30.receiver = self;
  v30.super_class = (Class)SRDisambiguationCell;
  ...
  if (!self->_constraintsCreated)
  {
    ...
    uint64_t v4 = [(SRDisambiguationCell *)self contentView];
    v5 = +[NSLayoutConstraint constraintsWithVisualFormat:options:metrics:views:](NSLayoutConstraint, "constraintsWithVisualFormat:options:metrics:views:", @"V:|-starTop-[_starView(==starHeight)]-(>=0)-|", 0, &off_100149D18, v3);
    [v4 addConstraints:v5];

    id v6 = (void *)v3;
    v7 = +[NSLayoutConstraint constraintsWithVisualFormat:options:metrics:views:](NSLayoutConstraint, "constraintsWithVisualFormat:options:metrics:views:", @"H:|-starLeft-[_starView(==starWidth)]-(>=0)-|", 0, &off_100149D18, v3);
    [v4 addConstraints:v7];

    double v8 = [(SRDisambiguationCell *)self keyline];
    v9 = +[NSLayoutConstraint constraintWithItem:v8 attribute:4 relatedBy:0 toItem:v4 attribute:4 multiplier:1.0 constant:0.0];
    [v4 addConstraint:v9];

    objc_super v10 = [(SRDisambiguationCell *)self keyline];
    ...
    double v12 = [(SRDisambiguationCell *)self keyline];
    ...
    v18 = v6;
    uint64_t v19 = +[NSLayoutConstraint constraintsWithVisualFormat:options:metrics:views:](NSLayoutConstraint, "constraintsWithVisualFormat:options:metrics:views:", @"H:[_titleLabel]-[_extraDisambiguationLabel]-edgePadding-|", 0, &off_100149D18, v6);
...
- (void)updateConstraintConstants
{
  ...
  v9 = [(SRDisambiguationCell *)self item];
  ...
  {
    v13 = [(SRDisambiguationCell *)self item];
  ...
  double v16 = [(SRDisambiguationCell *)self item];
...
- (void)setItem:(id)a3
{
  ...
  [(SRDisambiguationCell *)self setImageView:v19];
...
- (void)setImageView:(id)a3
{
  ...
  if (self->_imageView)
  {
    uint64_t v7 = [(SRDisambiguationCell *)self contentView];
    [v7 addSubview:*p_imageView];

    [(UIImageView *)*p_imageView setTranslatesAutoresizingMaskIntoConstraints:0];
    id v8 = [(SRDisambiguationCell *)self contentView];
    uint64_t v9 = _NSDictionaryOfVariableBindings(@"_imageView", *p_imageView, 0);
    id v10 = +[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_imageView(==imageWidth)]" options:0 metrics:&off_100149D40 views:v9];
    [v8 addConstraints:v10];

    id v11 = _NSDictionaryOfVariableBindings(@"_imageView, _titleLabel", *p_imageView, self->_titleLabel, 0);
    double v12 = +[NSLayoutConstraint constraintsWithVisualFormat:options:metrics:views:](NSLayoutConstraint, "constraintsWithVisualFormat:options:metrics:views:", @"V:|-imageTop-[_imageView(==imageHeight)]", 0, &off_100149D40, v11);
...
- (void)setSemanticContentAttribute:(int64_t)a3
{
  double v5 = [(SRDisambiguationCell *)self contentView];
  ...
  [(SRDisambiguationCell *)&v9 setSemanticContentAttribute:a3];
  id v8 = [(SRDisambiguationCell *)self contentView];
