...
- (void)showStatusBarWithPid:(int)a3
{
  ...
  if (self->_assertion)
  {
    ...
    [(SBSStatusBarStyleOverridesCoordinator *)self->_coordinator setRegisteredStyleOverrides:0x100000 reply:&stru_10003D0B8];
...
- (void)invalidateStatusBar
{
  if (self->_assertion)
  {
    ...
    [(SBSStatusBarStyleOverridesCoordinator *)self->_coordinator setRegisteredStyleOverrides:0 reply:&stru_10003D0D8];
    coordinator = self->_coordinator;
    self->_coordinator = 0;
