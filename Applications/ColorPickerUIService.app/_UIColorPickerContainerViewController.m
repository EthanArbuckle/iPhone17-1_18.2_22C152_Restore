...
- (void)buildMenuWithBuilder:(id)a3
{
  ...
  if (v3 == v4)
  {
    uint64_t v5 = +[UIMenu menuWithTitle:&stru_1000683D8 image:0 identifier:UIMenuRoot options:0 children:&__NSArray0__struct];
  ...
  if (self->_contentViewController == a3)
  {
    ...
    if (v4 > 0.0)
    {
      ...
      if (v5 > 0.0)
      {
        ...
        [v8 setFrame:0.0, 0.0, v7, 10000.0];
