...
+ (id)colorAtLocation:(CGPoint)a3
{
  ...
  *(float *)v9.i32 = fmaxf(fmaxf(*(float *)v6.i32, *(float *)&v6.i32[1]), *(float *)&v6.i32[2]);
  ...
  if (v16 >= 0.0)
  {
    float v14 = (float)(1.0 - sub_10004A1F0(flt_100053960, v7)) / *(float *)v9.i32;
  ...
  {
    float v10 = sub_10004A1F0(flt_100053960, 1.0 - v7);
...
+ (CGPoint)positionForColor:(id)a1
{
  ...
  if (v5 >= 1.0)
  {
    *(float *)&long long v2 = fminf(*(float *)&v2, fminf(*((float *)&v2 + 1), *((float *)&v2 + 2))) + -1.0;
    ...
    float v8 = -*(float *)&v2;
    *(float *)&unsigned int v21 = sub_10004A348(flt_100053960, -*(float *)&v2) + -1.0;
    ...
    *(float *)&unsigned int v15 = ((float)(v4 - *(float *)v19.i32) + 1.0) / v8;
    ...
    float32x2_t v7 = (float32x2_t)__PAIR64__(COERCE_UNSIGNED_INT(sub_10004A70C(v14)), v21);
  }
  else
  {
    ...
    float v20 = sub_10004A70C(v6);
    v7.f32[0] = sub_10004A348(flt_100053960, 1.0 - v5);
    v7.f32[1] = v20;
  }
...
- (void)initializeVertexBuffer
{
  v5[0] = xmmword_100053970;
  v5[1] = unk_100053980;
  v5[2] = xmmword_100053990;
