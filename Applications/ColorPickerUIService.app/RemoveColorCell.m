...
- (_TtC20ColorPickerUIService15RemoveColorCell)initWithFrame:(CGRect)a3
{
  return (_TtC20ColorPickerUIService15RemoveColorCell *)sub_100038BA0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC20ColorPickerUIService15RemoveColorCell)initWithCoder:(id)a3
{
  return (_TtC20ColorPickerUIService15RemoveColorCell *)sub_100038CCC(a3);
}
