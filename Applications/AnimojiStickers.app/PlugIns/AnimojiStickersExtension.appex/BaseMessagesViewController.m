...
- (NSString)landscapeOverlayMessage
{
  ...
  uint64_t v3 = [v2 localizedStringForKey:@"StickersLandscapeTrapMessage" value:&stru_10000C578 table:@"Localizable"];
...
+ (UIViewController)pendingChildViewController
{
  return (UIViewController *)(id)qword_100011D10;
}
