...
- (STSelectUserIntentResponse)initWithCoder:(id)a3
{
  return (STSelectUserIntentResponse *)sub_100053A00((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (STSelectUserIntentResponse)initWithBackingStore:(id)a3
{
  return (STSelectUserIntentResponse *)sub_100053A00((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}

- (STSelectUserIntentResponse)initWithPropertiesByName:(id)a3
{
  if (a3) {
    uint64_t v3 = sub_100055990();
  }
  else {
    uint64_t v3 = 0;
  }
