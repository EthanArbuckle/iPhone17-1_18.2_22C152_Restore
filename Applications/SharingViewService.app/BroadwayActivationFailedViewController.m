...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v18.receiver = self;
  v18.super_class = (Class)BroadwayActivationFailedViewController;
  ...
  int64_t v13 = [(BroadwayActivationFailedViewController *)self failureResult];
  CFStringRef v14 = @"BROADWAY_ERROR_SERVICES_UNAVAILABLE";
  if (v13 == 7) {
    CFStringRef v14 = @"BROADWAY_ERROR_INCORRECT_ACTIVATION_CODE";
  }
  if (v13 == 5) {
    CFStringRef v15 = @"BROADWAY_ERROR_NOT_YET_SHIPPED";
  }
  else {
    CFStringRef v15 = v14;
  }
  v16 = +[NSBundle mainBundle];
  v17 = [v16 localizedStringForKey:v15 value:&stru_1001A1DC0 table:@"Localizable"];
  [*(id *)((char *)&self->_titleLabel + 1) setText:v17];
}
