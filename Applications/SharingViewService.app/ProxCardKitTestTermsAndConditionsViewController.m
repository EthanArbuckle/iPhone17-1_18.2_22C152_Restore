...
- (ProxCardKitTestTermsAndConditionsViewController)init
{
  ...
  if (v2)
  {
    ...
    v4 = +[PRXAction actionWithTitle:@"View Terms and Conditions" style:0 handler:&stru_1001A1440];
    ...
    id v6 = [(ProxCardKitTestTermsAndConditionsViewController *)v3 addAction:v5];
    ...
    id v8 = [(ProxCardKitTestTermsAndConditionsViewController *)v3 addAction:v7];
