...
{
  v43.receiver = self;
  v43.super_class = (Class)TVLatencyColorimeterSetupPreparingViewController;
  ...
  id v5 = [(TVLatencyColorimeterSetupPreparingViewController *)self addAction:v37];
  v6 = +[NSBundle mainBundle];
  v7 = sub_100138304(v6, @"Localizable-TVLatency", @"TLV_PREPARING_TITLE");
  [(TVLatencyColorimeterSetupPreparingViewController *)self setTitle:v7];

  v8 = +[NSBundle mainBundle];
  v9 = sub_100138304(v8, @"Localizable-TVLatencyColorimeter", @"TLV_SETTING_UP_COLOR_CALIBRATION");
  ...
  id v39 = [objc_alloc((Class)UIActivityIndicatorView) initWithActivityIndicatorStyle:101];
