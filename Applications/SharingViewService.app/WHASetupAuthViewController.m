...
- (void)showWithFlags:(unsigned int)a3 throttleSeconds:(int)a4
{
  [*(id *)(&self->super._didReactivateContainerViewAfterLayingOut + 1) setHidden:1 *(void *)&a4];
  ...
  if ((a3 & 0x10000) != 0)
  {
    ...
    [self->super._mainController setBadPINCount:[self->super._mainController badPINCount] + 1];
  }
  else
  {
...
- (void)_handlePINEntered:(id)a3
{
  ...
  {
    [self->super._mainController _pairSetupTryPIN:v4];
  }
}
...
- (void)_handleKeyboardWillShow:(id)a3
{
  ...
  v15 = [(WHASetupAuthViewController *)self view];
  ...
  v26 = [(WHASetupAuthViewController *)self view];
  [v26 bounds];
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)WHASetupAuthViewController;
  [(WHASetupAuthViewController *)&v6 viewDidDisappear:v3];
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)WHASetupAuthViewController;
