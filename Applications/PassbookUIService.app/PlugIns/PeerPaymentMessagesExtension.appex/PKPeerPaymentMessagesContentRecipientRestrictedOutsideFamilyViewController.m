...
{
  v8.receiver = self;
  v8.super_class = (Class)PKPeerPaymentMessagesContentRecipientRestrictedOutsideFamilyViewController;
  [(PKPeerPaymentMessagesContentRecipientRestrictedOutsideFamilyViewController *)&v8 viewDidLoad];
...
- (void)reloadContent
{
  ...
  v2 = [v4 label];
  v3 = PKLocalizedPeerPaymentLexingtonString(@"PEER_PAYMENT_MESSAGES_RECIPIENT_FAMILY_RESTRICTED_MESSAGE");
  [v2 setText:v3];
}
