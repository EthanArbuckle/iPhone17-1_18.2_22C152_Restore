...
- (PKPeerPaymentMessagesContentNavigationController)initWithMessagesAppController:(id)a3
{
  ...
  v5 = [(PKPeerPaymentMessagesContentNavigationController *)&v10 initWithNibName:0 bundle:0];
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v13 = 2048;
      v14 = v5;
      _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "<%{public}@ %p>: Initialized.", buf, 0x16u);
    }
