...
+ (BOOL)_isSecure;
- (_TtC10CoreAuthUI12SecureWindow)initWithCoder:(id)a3;
- (_TtC10CoreAuthUI12SecureWindow)initWithContentRect:(CGRect)a3;
- (_TtC10CoreAuthUI12SecureWindow)initWithFrame:(CGRect)a3;
- (_TtC10CoreAuthUI12SecureWindow)initWithWindowScene:(id)a3;
@end
