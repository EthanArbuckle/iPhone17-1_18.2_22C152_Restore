...
- (void)_setup
{
  ...
  objc_super v5 = +[UIFont preferredFontForTextStyle:UIFontTextStyleTitle3];
  [(UILabel *)self->_titleLabel setFont:v5];

  [(UILabel *)self->_titleLabel setTextAlignment:1];
  [(PasscodeBackOffView *)self addSubview:self->_titleLabel];
  [(UILabel *)self->_titleLabel setTranslatesAutoresizingMaskIntoConstraints:0];
  objc_super v6 = [(UILabel *)self->_titleLabel topAnchor];
  ...
  v31 = [v30 localizedStringForKey:@"CANCEL" value:&stru_100088CF0 table:@"MobileUI"];
...
- (void)_updateColors
{
  ...
  button = self->_button;
  id v6 = [(PasscodeBackOffView *)self _textColor];
...
- (PasscodeBackOffViewDelegate)delegate
{
  ...
  return (PasscodeBackOffViewDelegate *)WeakRetained;
}
