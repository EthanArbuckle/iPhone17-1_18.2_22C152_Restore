@interface HPdetector_SceneClassifier_B238Output
...
- (HPdetector_SceneClassifier_B238Output)initWithHomePodDetected:(id)a3
{
  ...
  v6 = [(HPdetector_SceneClassifier_B238Output *)&v9 init];
  v7 = v6;
  if (v6) {
...
- (NSSet)featureNames
{
  return +[NSSet setWithArray:&off_1000DF0B8];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v4 = [(HPdetector_SceneClassifier_B238Output *)self HomePodDetected];
