...
{
  v4.receiver = self;
  v4.super_class = (Class)ConfirmViewController;
  [(ConfirmViewController *)&v4 viewDidAppear:a3];
  sub_100003F48(self);
}
...
{
  self->_cancelled = 1;
  [(ConfirmViewController *)self dismissViewControllerAnimated:1 completion:0];
}
...
- (void)proxCardFlowDidDismiss
{
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 67109120;
    BOOL v12 = confirmed;
    _os_log_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "Confirm prox card flow dismissed: %{BOOL}d", buf, 8u);
  }
