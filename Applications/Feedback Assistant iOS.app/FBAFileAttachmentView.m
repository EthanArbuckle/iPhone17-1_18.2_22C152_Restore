...
- (void)initializeWithFileName:(id)a3 requirement:(id)a4 font:(id)a5 textColor:(id)a6
{
  ...
  if (v10)
  {
    uint64_t v15 = +[FBKFileMatcher iconForFileName:v10];
  }
  else
  {
    if (!v11)
    ...
    uint64_t v15 = [v11 iconForRequirement];
  }
  v16 = (void *)v15;
LABEL_6:
  id v17 = [objc_alloc((Class)UIImageView) initWithImage:v16];
  ...
  double v25 = v23 / v24;
  [v12 pointSize];
  double v27 = v26 * 1.1 * v25;
  CFStringRef v37 = @"height";
