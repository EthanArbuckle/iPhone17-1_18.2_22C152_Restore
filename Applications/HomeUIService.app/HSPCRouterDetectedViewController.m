...
{
  v12.receiver = self;
  v12.super_class = (Class)HSPCRouterDetectedViewController;
  ...
  {
    v6 = sub_100060C64(@"HSSetupConfirmationNetworkRouterResidentRequiredViewControllerTitle");
...
- (BOOL)canContinue
{
  ...
  BOOL v4 = !v3
    ...
    || ((unint64_t)[v3 networkRouterSupportDisableReason] & 1) == 0;
...
- (id)prominentButtonLocalizedTitle
{
  ...
  {
    v5.receiver = self;
    v5.super_class = (Class)HSPCRouterDetectedViewController;
