...
- (HSPCAssociatedServiceRow)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    id v5 = [objc_alloc((Class)HUIconView) initWithFrame:CGRectZero contentMode:1];
    [v5 setIconSize:2];
...
- (void)updateConstraints
{
  if (![(HSPCRow *)self constraintsSet])
  {
    ...
    id v5 = [v29 constraintEqualToAnchor:v4];
    v47[1] = v5;
    ...
    v47[2] = v9;
    objc_super v10 = [(HSPCRow *)self leftView];
    v11 = [v10 widthAnchor];
    +[HSPCRow leftImageSize];
...
{
  id v4 = a3;
  id v10 = +[HFServiceIconFactory defaultIconDescriptorForServiceType:v4 serviceSubtype:0];
  objc_opt_class();
  id v5 = [(HSPCRow *)self leftView];
  ...
  double v8 = +[HMService hf_userFriendlyLocalizedCapitalizedDescription:v4];
...
- (void)updateUIWithTuple:(id)a3
{
  id v4 = a3;
  id v5 = [v4 accessory];
  id v11 = +[HFServiceIconFactory iconDescriptorForAccessory:v5];
