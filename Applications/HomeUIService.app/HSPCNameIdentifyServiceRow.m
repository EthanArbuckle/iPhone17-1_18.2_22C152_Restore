...
+ (id)_reuseIdentifier
{
  return @"HSPCNameIdentifyServiceRow";
}

- (HSPCNameIdentifyServiceRow)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  v16.receiver = self;
  v16.super_class = (Class)HSPCNameIdentifyServiceRow;
  ...
  if (v4)
  {
    ...
    v12 = (UIActivityIndicatorView *)[objc_alloc((Class)UIActivityIndicatorView) initWithActivityIndicatorStyle:100];
...
- (void)updateConstraints
{
  if (![(HSPCRow *)self constraintsSet])
  {
    ...
    v72 = [v80 constraintEqualToAnchor:v76];
    v96[0] = v72;
    ...
    +[HSPCRow horizontalSpacing];
    v75 = [v83 constraintEqualToAnchor:v79];
    v93[0] = v75;
...
- (void)identify
{
  ...
  objc_super v6 = [(HSPCNameServiceRow *)self service];
  v7 = [v6 accessory];
