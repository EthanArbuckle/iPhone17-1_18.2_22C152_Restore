...
{
  v144.receiver = self;
  v144.super_class = (Class)SBEChamoisContentViewController;
  ...
  v37 = [v36 localizedStringForKey:@"STAGE_MANAGER_OPT_OUT_BUTTON" value:&stru_10000C328 table:0];
  [v34 setTitle:v37 forState:0];

  v38 = [v34 titleLabel];
  +[UIFont buttonFontSize];
  v39 = +[UIFont systemFontOfSize:weight:](UIFont, "systemFontOfSize:weight:");
  [v38 setFont:v39];
  ...
  id v52 = objc_alloc((Class)NSAttributedString);
  v53 = +[NSBundle bundleForClass:objc_opt_class()];
  v54 = [v53 localizedStringForKey:@"STAGE_MANAGER_OPT_IN_BUTTON" value:&stru_10000C328 table:0];
  NSAttributedStringKey v145 = NSFontAttributeName;
  +[UIFont buttonFontSize];
  v55 = +[UIFont systemFontOfSize:weight:](UIFont, "systemFontOfSize:weight:");
  v146 = v55;
  v56 = +[NSDictionary dictionaryWithObjects:&v146 forKeys:&v145 count:1];
  id v57 = [v52 initWithString:v54 attributes:v56];
  ...
  v75 = [(SBCAAutoPlayingPackageView *)v73 initWithURL:v74 startingState:@"start" endingState:@"return"];
  ...
  v81 = [v80 view];
  id v82 = [v81 effectiveUserInterfaceLayoutDirection];
  ...
  id v106 = objc_alloc_init((Class)UILabel);
  ...
  v110 = [v109 localizedStringForKey:@"STAGE_MANAGER_FIRST_TIME_ONBOARDING_TITLE" value:&stru_10000C328 table:0];
  [v106 setText:v110];
  ...
  id v122 = objc_alloc_init((Class)UILabel);
  ...
  v126 = [v125 localizedStringForKey:@"STAGE_MANAGER_FIRST_TIME_ONBOARDING_BODY" value:&stru_10000C328 table:0];
  [v122 setText:v126];
