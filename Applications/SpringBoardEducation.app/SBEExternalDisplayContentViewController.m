...
{
  v152.receiver = self;
  v152.super_class = (Class)SBEExternalDisplayContentViewController;
  ...
  id v23 = objc_alloc_init((Class)UIScrollView);
  ...
  id v49 = objc_alloc((Class)NSAttributedString);
  v50 = +[NSBundle bundleForClass:objc_opt_class()];
  v51 = [v50 localizedStringForKey:@"EXTERNAL_DISPLAY_OPT_IN_BUTTON" value:&stru_10000C328 table:0];
  NSAttributedStringKey v153 = NSFontAttributeName;
  +[UIFont buttonFontSize];
  v52 = +[UIFont systemFontOfSize:weight:](UIFont, "systemFontOfSize:weight:");
  v154 = v52;
  v53 = +[NSDictionary dictionaryWithObjects:&v154 forKeys:&v153 count:1];
  id v54 = [v49 initWithString:v51 attributes:v53];
  [v48 setAttributedTitle:v54];

  [v48 setContentInsets:17.0, 0.0, 17.0, 0.0];
  [v48 setCornerStyle:3];
  v55 = (UIImageView *)objc_alloc_init((Class)UIImageView);
  ...
  v63 = [v62 localizedStringForKey:@"EXTERNAL_DISPLAY_KEYBOARD_MOUSE_RECOMMENDATION" value:&stru_10000C328 table:0];
  ...
  v75 = [v74 localizedStringForKey:@"EXTERNAL_DISPLAY_OPT_OUT_BUTTON" value:&stru_10000C328 table:0];
  [v72 setTitle:v75 forState:0];

  v76 = [v72 titleLabel];
  +[UIFont buttonFontSize];
  v77 = +[UIFont systemFontOfSize:weight:](UIFont, "systemFontOfSize:weight:");
  [v76 setFont:v77];
  ...
  v82 = [(SBCAAutoPlayingPackageView *)v80 initWithURL:v81 startingState:@"start" endingState:@"return"];
  ...
  v88 = [v87 view];
  id v89 = [v88 effectiveUserInterfaceLayoutDirection];
  ...
  id v113 = objc_alloc_init((Class)UILabel);
  ...
  v117 = [v116 localizedStringForKey:@"EXTERNAL_DISPLAY_FIRST_TIME_ONBOARDING_TITLE" value:&stru_10000C328 table:0];
  [v113 setText:v117];
  ...
  id v129 = objc_alloc_init((Class)UILabel);
  ...
  v133 = [v132 localizedStringForKey:@"EXTERNAL_DISPLAY_FIRST_TIME_ONBOARDING_BODY" value:&stru_10000C328 table:0];
  [v129 setText:v133];
...
- (id)_tutorialVideoURL
{
  ...
  id v5 = v4;
  if (v3 == (id)2) {
    CFStringRef v6 = @"ChamoisTutorial_DK";
  }
  else {
    CFStringRef v6 = @"ChamoisTutorial";
  }
...
- (void)dismissAnimated:(BOOL)a3
{
  ...
  v3[3] = &unk_10000C2D8;
  v3[4] = self;
  [(SBEExternalDisplayContentViewController *)self dismissViewControllerAnimated:a3 completion:v3];
}
