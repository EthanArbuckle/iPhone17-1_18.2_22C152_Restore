...
- (ContinuityCaptureShieldUIContentView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v157[1] = 3221225472;
    v157[2] = sub_10000D38C;
    v157[3] = &unk_10001C830;
    ...
    v155[1] = 3221225472;
    v155[2] = sub_10000D470;
    v155[3] = &unk_10001C830;
    ...
    v153[1] = 3221225472;
    v153[2] = sub_10000D710;
    v153[3] = &unk_10001C830;
    ...
    v151[1] = 3221225472;
    v151[2] = sub_10000D824;
    v151[3] = &unk_10001C830;
    ...
    v149[1] = 3221225472;
    v149[2] = sub_10000D908;
    v149[3] = &unk_10001C830;
...
- (void)setPauseButtonState:(unint64_t)a3
{
  switch(a3)
  {
    case 2uLL:
      ...
      double v8 = [v7 localizedStringForKey:@"BUTTON_TITLE_RESUME" value:&stru_10001CA18 table:0];
    ...
    case 1uLL:
      ...
      id v6 = objc_alloc((Class)NSAttributedString);
      double v7 = +[NSBundle mainBundle];
      double v8 = [v7 localizedStringForKey:@"BUTTON_TITLE_PAUSE" value:&stru_10001CA18 table:0];
...
- (id)_pauseButtonConfiguration
{
  ...
  double v6 = [v5 localizedStringForKey:@"BUTTON_TITLE_PAUSE" value:&stru_10001CA18 table:0];
...
- (id)_facetimeButtonConfiguration
{
  ...
  v9 = [v8 localizedStringForKey:@"BUTTON_TITLE_SWITCH_%@" value:&stru_10001CA18 table:0];
...
- (id)_favoritesButtonConfiguration
{
  ...
  id v7 = [v6 localizedStringForKey:@"BUTTON_TITLE_FAVORITES" value:&stru_10001CA18 table:0];
...
- (id)_disconnectButtonConfiguration
{
  ...
  if (self->_inPlacementStep)
  {
    ...
    double v5 = +[NSBundle mainBundle];
    id v6 = [v5 localizedStringForKey:@"BUTTON_TITLE_DISCONNECT" value:&stru_10001CA18 table:0];
  ...
  else
  {
    ...
    id v6 = [v10 localizedStringForKey:v12 value:&stru_10001CA18 table:0];
...
- (id)_skipButtonConfiguration
{
  ...
  double v5 = [v4 localizedStringForKey:@"BUTTON_TITLE_SKIP_THIS_STEP" value:&stru_10001CA18 table:0];
  [v2 setTitle:v5];
