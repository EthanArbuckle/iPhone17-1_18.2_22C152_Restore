    ...
    if (v25)
    {
      ...
      do
      {
        for (i = 0; i != v26; i = (char *)i + 1)
        {
          ...
          {
            if (!v27) {
              id v27 = [objc_alloc((Class)NSMutableDictionary) initWithCapacity:[v24 count]];
            }
...
- (BOOL)setState:(id)a3 animated:(BOOL)a4
{
  return [(ContinuityCaptureShieldUICAPackageView *)self setState:a3 animated:a4 transitionSpeed:&stru_10001C548 completion:1.0];
}
