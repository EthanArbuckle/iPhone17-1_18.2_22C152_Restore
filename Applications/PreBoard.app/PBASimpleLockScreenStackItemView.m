...
- (BOOL)showSeparator;
- (PBASimpleLockScreenStackItem)item;
...
{
  v58.receiver = self;
  v58.super_class = (Class)PBASimpleLockScreenStackItemView;
  v3 = -[PBASimpleLockScreenStackItemView initWithFrame:](&v58, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v3->_separatorHeightConstraint = (NSLayoutConstraint *)v10;
...
{
  id v10 = a3;
  if (!-[PBASimpleLockScreenStackItem isEqual:](self->_item, "isEqual:"))
  {
...
- (void)setShowSeparator:(BOOL)a3
{
  if (self->_showSeparator != a3)
  {
    ...
    [(NSLayoutConstraint *)self->_separatorHeightConstraint setConstant:(double)a3];
  }
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_separatorHeightConstraint, 0);
