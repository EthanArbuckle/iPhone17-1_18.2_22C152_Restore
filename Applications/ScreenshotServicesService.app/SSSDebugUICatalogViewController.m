...
- (void)viewDidLoad
{
  ...
  objc_super v8 = (UIToolbar *)objc_alloc_init((Class)UIToolbar);
  ...
  id v11 = [objc_alloc((Class)UIBarButtonItem) initWithBarButtonSystemItem:0 target:self action:"_donePushed"];
  [v11 setTitle:@"Done"];
  v12 = self->_toolbar;
  v45[0] = v10;
  v45[1] = v11;
...
- (id)_viewControllerAtIndex:(int64_t)a3
{
  ...
  {
    if ((unint64_t)[(NSMutableArray *)self->_allViewControllers count] <= a3)
    {
      v6 = 0;
    }
    else
...
- (id)pageViewController:(id)a3 viewControllerAfterViewController:(id)a4
{
  v5 = (char *)[(NSMutableArray *)self->_allViewControllers indexOfObject:a4] + 1;
