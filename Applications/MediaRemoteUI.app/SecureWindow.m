...
+ (BOOL)_isSecure;
- (_TtC13MediaRemoteUI12SecureWindow)initWithCoder:(id)a3;
- (_TtC13MediaRemoteUI12SecureWindow)initWithContentRect:(CGRect)a3;
- (_TtC13MediaRemoteUI12SecureWindow)initWithFrame:(CGRect)a3;
- (_TtC13MediaRemoteUI12SecureWindow)initWithWindowScene:(id)a3;
@end
