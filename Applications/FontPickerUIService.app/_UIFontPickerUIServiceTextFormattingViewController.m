...
- (void)loadView
{
  ...
  id v6 = objc_alloc_init(NSClassFromString(@"_UITextFormattingServiceViewController"));
...
- (void)setPreferredContentSize:(CGSize)a3
{
  ...
  id v6 = [(_UIFontPickerUIServiceTextFormattingViewController *)self _hostedWindowScene];
...
- (void)_textFormattingDidChangeValue:(id)a3 textAttributesData:(id)a4
{
  id v6 = +[_UITextFormattingActionClientToHost actionForChangeValue:a3 textAttributesData:a4];
...
- (void)_textFormattingDidFinish
{
  id v3 = [(_UIFontPickerUIServiceTextFormattingViewController *)self _hostedWindowScene];
...
- (void)_presentColorPicker:(CGRect)a3 selectedColor:(id)a4
{
  +[_UITextFormattingActionClientToHost actionForPresentColorPickerWithRect:selectedColor:](_UITextFormattingActionClientToHost, "actionForPresentColorPickerWithRect:selectedColor:", a4, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
...
- (void)_presentFontPickerWithConfiguration:(id)a3 selectedFonts:(id)a4
{
  id v6 = +[_UITextFormattingActionClientToHost actionForPresentFontPickerWithConfiguration:a3 selectedFonts:a4];
  v5 = [(_UIFontPickerUIServiceTextFormattingViewController *)self _hostedWindowScene];
  [v5 sendAction:v6];
}
...
- (void)_presentTypographySettingsForFont:(id)a3
{
  id v5 = +[_UITextFormattingActionClientToHost actionForPresentTypographySettingsForFont:a3];
