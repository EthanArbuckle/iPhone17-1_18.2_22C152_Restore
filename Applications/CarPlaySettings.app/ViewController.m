...
- (UIButton)launchOnCarPlayButton;
- (void)_launchOnCarPlay;
- (void)setLaunchOnCarPlayButton:(id)a3;
- (void)viewDidLoad;
@end
...
{
  v29.receiver = self;
  v29.super_class = (Class)ViewController;
...
- (void)_launchOnCarPlay
{
  id v4 = +[FBSOpenApplicationService dashboardService];
  v2 = +[NSBundle mainBundle];
  v3 = [v2 bundleIdentifier];

  [v4 openApplication:v3 withOptions:0 completion:&stru_100091F78];
}

- (UIButton)launchOnCarPlayButton
{
  return self->_launchOnCarPlayButton;
}
