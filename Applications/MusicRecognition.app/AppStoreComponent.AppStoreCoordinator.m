...
- (_TtCV16MusicRecognition17AppStoreComponent19AppStoreCoordinator)init
{
  result = (_TtCV16MusicRecognition17AppStoreComponent19AppStoreCoordinator *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_100077228(*(uint64_t *)((char *)&self->super.isa
                           + OBJC_IVAR____TtCV16MusicRecognition17AppStoreComponent19AppStoreCoordinator_onOpen));
