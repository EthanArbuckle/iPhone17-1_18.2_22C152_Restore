...
- (void)configureWithContext:(id)a3 completion:(id)a4
{
  ...
  [v8 setLaunchingInterfaceOrientation:[ServiceReviewRemoteAlertViewController convertInterfaceOrientation:v10]];
  v11 = objc_alloc_init(ServiceReviewViewController);
  v26[0] = SKUIServiceReviewSandboxMode;
  v12 = [v7 userInfo];
  uint64_t v13 = [v12 objectForKeyedSubscript:@"sandboxed"];
  v14 = (void *)v13;
  if (v13) {
    v15 = (void *)v13;
  }
