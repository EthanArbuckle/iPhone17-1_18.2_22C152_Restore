...
{
  BOOL v3 = a3;
  v5 = [(ServiceSUNavigationController *)self embeddedParent];
  [v5 dismissHostViewController];

  v6.receiver = self;
  v6.super_class = (Class)ServiceSUNavigationController;
  [(ServiceSUNavigationController *)&v6 dismissAnimated:v3];
}
...
- (void)dismissViewControllerAnimated:(BOOL)a3 completion:(id)a4
{
  BOOL v4 = a3;
  id v6 = a4;
  v7 = [(ServiceSUNavigationController *)self embeddedParent];
  [v7 dismissHostViewController];

  v8.receiver = self;
  v8.super_class = (Class)ServiceSUNavigationController;
  [(ServiceSUNavigationController *)&v8 dismissViewControllerAnimated:v4 completion:v6];
}
