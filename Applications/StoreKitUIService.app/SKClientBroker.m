...
+ (id)defaultBroker
{
  if (qword_100067300 != -1) {
    dispatch_once(&qword_100067300, &stru_10004CCE0);
  }
  v2 = (void *)qword_1000672F8;
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v16 = [*(id *)(*((void *)&v26 + 1) + 8 * (void)v15) objectForKeyedSubscript:off_100065D80];
        if ([v16 length]) {
          [v11 addObject:v16];
        }
...
- (id)_unfinishedTransactionsNotificationName
{
  ...
  if (v3)
  {
    id v4 = sub_10000AB14((uint64_t)v3);
  }
  else
  {
    id v4 = 0;
