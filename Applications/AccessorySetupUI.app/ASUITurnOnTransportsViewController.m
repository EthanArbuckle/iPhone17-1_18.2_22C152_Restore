...
- (_TtC16AccessorySetupUI34ASUITurnOnTransportsViewController)initWithContentView:(id)a3
{
  ...
  *(void *)&self->type[OBJC_IVAR____TtC16AccessorySetupUI34ASUITurnOnTransportsViewController_router] = 0;
  ...
  *(_OWORD *)(v6 + 40) = 0u;
  *(_OWORD *)(v6 + 56) = 0u;
  *(void *)&self->PRXCardContentViewController_opaque[OBJC_IVAR____TtC16AccessorySetupUI34ASUITurnOnTransportsViewController_capabilities] = 0;
  v8.receiver = self;
