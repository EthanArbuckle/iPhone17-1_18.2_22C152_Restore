...
id sub_10000192C(uint64_t a1)
{
  return [*(id *)(a1 + 32) _dismiss];
}

void sub_100001CFC(id a1)
{
}
...
uint64_t ax_remote_general_log()
{
  return _ax_remote_general_log();
}
...
{
  return [a1 _nearbyDevicesNavigationControllerDidDismiss];
}
