...
- (void)setProgress:(id)a3
{
  ...
  if (progress != v5)
  {
    ...
    if (v5)
    {
      [(NSProgress *)v5 addObserver:self forKeyPath:@"fractionCompleted" options:0 context:off_100043990];
...
- (void)viewWillLayoutSubviews
{
  ...
  if (v3 == 4)
  {
    ...
    [v17 setFrame:CGRectMake(17.0, v16, 50.0, 50.0)];
...
- (void)dealloc
{
  [(NSProgress *)self->_progress removeObserver:self forKeyPath:@"fractionCompleted" context:off_100043990];
  v3.receiver = self;
