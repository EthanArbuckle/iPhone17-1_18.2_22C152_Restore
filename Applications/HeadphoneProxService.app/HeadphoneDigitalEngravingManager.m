...
- (id)fetchEngravingDataHandler
{
  ...
  {
    uint64_t v2 = *(void *)&self->localStorage[OBJC_IVAR____TtC20HeadphoneProxService32HeadphoneDigitalEngravingManager_fetchEngravingDataHandler];
...
- (_TtC20HeadphoneProxService32HeadphoneDigitalEngravingManager)init
{
  return (_TtC20HeadphoneProxService32HeadphoneDigitalEngravingManager *)sub_100074174();
}
