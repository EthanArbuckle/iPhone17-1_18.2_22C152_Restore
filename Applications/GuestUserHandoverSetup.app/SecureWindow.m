...
+ (BOOL)_isSecure;
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithCoder:(id)a3;
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithContentRect:(CGRect)a3;
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithFrame:(CGRect)a3;
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithWindowScene:(id)a3;
@end
