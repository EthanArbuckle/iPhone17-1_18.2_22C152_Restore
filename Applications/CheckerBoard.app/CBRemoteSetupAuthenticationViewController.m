...
- (CBRemoteSetupAuthenticationViewController)initWithTitle:(id)a3 detailText:(id)a4 icon:(id)a5
{
  ...
  if (v5)
  {
    uint64_t v6 = +[CBRemoteSetupManager sharedInstance];
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if ([(CBRemoteSetupAuthenticationViewController *)self passwordType] != 2
    && [(CBRemoteSetupAuthenticationViewController *)self passwordType] != 8)
  {
...
- (void)setupView
{
  ...
  objc_super v3 = [(CBRemoteSetupAuthenticationViewController *)self view];
  ...
  if ([(CBRemoteSetupAuthenticationViewController *)self passwordType] == 2)
  {
    ...
    objc_super v8 = +[UIFont preferredFontForTextStyle:UIFontTextStyleTitle0];
    objc_super v9 = [(CBRemoteSetupAuthenticationViewController *)self pinCodeLabel];
    [v9 setFont:v8];
  ...
  {
    id v16 = [objc_alloc((Class)OBButtonTray) initWithFrame:CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height];
    ...
    v24 = [v23 localizedStringForKey:@"REMOTE_SETUP_AUTH_FALLBACK_PIN" value:&stru_10007A9F8 table:0];
    ...
    id v34 = [objc_alloc((Class)UIImage) initWithCIImage:v33];
    id v35 = [objc_alloc((Class)UIImageView) initWithImage:v34];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR)) {
      sub_100048F48(self, v40);
    }
  }
  objc_initWeak((id *)&v119, self);
  v41 = [(CBRemoteSetupAuthenticationViewController *)self containerView];
  v116[0] = _NSConcreteStackBlock;
  v116[1] = 3221225472;
  v116[2] = sub_10001C610;
  v116[3] = &unk_100079C88;
  objc_copyWeak(&v117, (id *)&v119);
  v116[4] = self;
...
LABEL_14:
  ...
  objc_destroyWeak((id *)&v119);
}

- (void)didTapFallbackButton
{
  [(CBRemoteSetupAuthenticationViewController *)self dismissViewControllerAnimated:1 completion:0];
  id v3 = [(CBRemoteSetupAuthenticationViewController *)self remoteSetupManager];
