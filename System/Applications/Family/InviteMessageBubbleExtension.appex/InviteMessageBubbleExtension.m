    ...
    if (v39)
    {
      ...
      if ((*(unsigned int (**)(char *, uint64_t, uint64_t))(v41 + 48))(v30, 1, v42) != 1)
      {
        ...
        else
        {
          ...
          uint64_t v89 = v114;
          id v90 = objc_msgSend(v74, *(SEL *)&v77[13].flags, v106);
...
LABEL_8:
        ...
        else
        {
          ...
          v42.receiver = v39;
          v42.super_class = v35;
          objc_msgSendSuper2(&v42, "updateSnapshotWithCompletionBlock:", v34);
          _Block_release(v34);
        }
...
uint64_t sub_100010A10()
{
  ...
  v0[13] = &unk_1000398A8;
  v0[14] = v5;
  objc_msgSend(v7, "family_presentAlertSheetWithTitle:message:buttonTitles:styles:completion:", v1, v2, isa, v4, v0 + 10);
...
LABEL_72:
        ...
        id v54 = objc_msgSend(v46, "contact", v217);
        if (v54)
        {
          uint64_t v55 = v54;
...
LABEL_119:
    ...
    id v164 = objc_msgSend(v153, "invites", v217);
    if (v164)
    {
      long long v165 = v164;
      sub_1000076B4(0, &qword_10003CFC8);
...
uint64_t sub_1000251C0()
{
  ...
  if (v6)
  {
    uint64_t v8 = v0[33];
    uint64_t v7 = v0[34];
    id v9 = objc_msgSend(v6, "fa_queryItemsDictionary");
...
LABEL_6:
      ...
      *(void *)(v0 + 1592) = v33;
      if (v33)
      {
        ...
        *(void *)(v0 + 272) = v35;
        objc_msgSend(v34, "aa_primaryAppleAccountWithCompletion:", v0 + 240);
        return _swift_continuation_await(v0 + 16);
      }
...
uint64_t sub_10002B90C()
{
  ...
  *(void *)(v0 + 1592) = v22;
  if (v22)
  {
    ...
    *(void *)(v0 + 264) = &unk_100039CE0;
    *(void *)(v0 + 272) = v24;
    objc_msgSend(v23, "aa_primaryAppleAccountWithCompletion:", v0 + 240);
    return _swift_continuation_await(v0 + 16);
  }
