  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        double v9 = [(NSMutableDictionary *)self->debugValues objectForKey:*(void *)(*((void *)&v12 + 1) + 8 * i)];
        [v9 sweepValue];
...
- (void)advanceSweep
{
  ...
  long long v19 = 0u;
  v3 = self->debugValues;
  id v4 = [(NSMutableDictionary *)v3 countByEnumeratingWithState:&v16 objects:v20 count:16];
  if (v4)
  {
    id v5 = v4;
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        double v8 = -[NSMutableDictionary objectForKey:](self->debugValues, "objectForKey:", *(void *)(*((void *)&v16 + 1) + 8 * i), (void)v16);
        [v8 sweepMax];
        float v10 = v9;
        [v8 sweepValue];
      ...
      id v5 = [(NSMutableDictionary *)v3 countByEnumeratingWithState:&v16 objects:v20 count:16];
      if (v5) {
        continue;
      }
      break;
  ...
  if (v4)
  {
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        double v8 = -[NSMutableDictionary objectForKey:](self->debugValues, "objectForKey:", *(void *)(*((void *)&v15 + 1) + 8 * i), (void)v15);
        [v8 sweepMax];
        float v10 = v9;
        [v8 sweepValue];
        float v12 = v10 - v11;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        float v11 = -[NSMutableDictionary objectForKey:](self->debugValues, "objectForKey:", *(void *)(*((void *)&v16 + 1) + 8 * (void)v10), (void)v16);
        [v11 sweepMax];
        float v13 = v12;
        [v11 sweepMin];
