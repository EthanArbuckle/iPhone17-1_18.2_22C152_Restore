...
- (id)eventsWithName:(id)a3
{
  ...
  {
    id v6 = objc_opt_new();
    id v7 = [(TIAnalyticsServiceProviderMock *)self allEvents];
...
- (int64_t)countEvent:(id)a3
{
  uint64_t v3 = [(TIAnalyticsServiceProviderMock *)self eventsWithName:a3];
  id v4 = [v3 count];
...
{
  id v6 = a3;
  id v7 = [(TIAnalyticsServiceProviderMock *)self eventsWithName:a4];
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        int64_t v12 = [*(id *)(*((void *)&v14 + 1) + 8 * i) objectForKey:v5];
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        double v12 = [*(id *)(*((void *)&v15 + 1) + 8 * i) objectForKey:v5];
        [v12 floatValue];
        double v10 = v10 + v13;
      }
