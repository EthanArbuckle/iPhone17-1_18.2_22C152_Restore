...
- (id)description
{
  ...
  v5 = [(ACTDoubleKeyTap *)self firstTap];
  v6 = [(ACTDoubleKeyTap *)self secondTap];
...
- (void)applyWithTyper:(id)a3 log:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(ACTDoubleKeyTap *)self firstTap];
...
- (id)shortDescription
{
  ...
  v3 = +[NSString stringWithFormat:@"DoubleTap first/second: %@", v2];
