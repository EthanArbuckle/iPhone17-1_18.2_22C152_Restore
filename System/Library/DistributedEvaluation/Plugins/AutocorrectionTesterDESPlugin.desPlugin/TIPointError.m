...
+ (TIPointError)errorWithErrorVector:(CGPoint)a3
{
  v3 = -[TIPointError initWithErrorVector:]([TIPointError alloc], "initWithErrorVector:", a3.x, a3.y);
...
- (id)description
{
  return +[NSString stringWithFormat:@"TIPointError:<%f,%f>", *(void *)&self->_errorVector.x, *(void *)&self->_errorVector.y];
}
