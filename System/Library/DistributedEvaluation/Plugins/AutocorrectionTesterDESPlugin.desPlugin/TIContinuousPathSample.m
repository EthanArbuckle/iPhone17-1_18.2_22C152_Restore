...
- (void)encodeWithCoder:(id)a3
{
  p_point = &self->_point;
  id v5 = a3;
  +[NSValue value:p_point withObjCType:"{CGPoint=dd}"];
...
- (TIContinuousPathSample)initWithCoder:(id)a3
{
  ...
  id v5 = [(TIContinuousPathSample *)&v11 init];
  if (v5)
  {
    id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"point"];
...
- (TIContinuousPathSample)initWithJsonDictionary:(id)a3
{
  ...
  id v5 = [(TIContinuousPathSample *)&v26 init];
  if (v5)
  {
    id v6 = [v4 objectForKey:@"x"];
    [v6 floatValue];
    float v8 = v7;

    double v9 = [v4 objectForKey:@"y"];
    [v9 floatValue];
    float v11 = v10;
    ...
    objc_super v16 = [v4 objectForKey:@"stage"];
    v17 = v16;
    if (v16) {
...
- (id)toJsonDictionary
{
  ...
  *(float *)&double radius = radius;
  ...
  float v15 = +[NSNumber numberWithInt:LODWORD(self->_pathIndex)];
...
- (id)description
{
  ...
  objc_msgSend(v3, "appendFormat:", @"; double timeStamp = %f", v7);
  [(TIContinuousPathSample *)self radius];
  objc_msgSend(v3, "appendFormat:", @"; double radius = %f", v8);
  [(TIContinuousPathSample *)self force];
  objc_msgSend(v3, "appendFormat:", @"; double force = %f", v9);
  objc_msgSend(v3, "appendFormat:", @"; stage = %u", -[TIContinuousPathSample stage](self, "stage"));
  objc_msgSend(v3, "appendFormat:", @"; pathIndeCGFloat x = %ld", -[TIContinuousPathSample pathIndex](self, "pathIndex"));
  [v3 appendString:@">"];
