...
- (id)_title
{
  ...
  BOOL v3 = [v2 localizedStringForKey:@"ALBUM_SPECIFIER_TITLE" value:&stru_C498 table:@"NanoPhotosBridgeSettings"];
...
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  BOOL v3 = [v2 localizedStringForKey:@"ALBUM_NONE" value:&stru_C498 table:@"NanoPhotosBridgeSettings"];
...
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  BOOL v3 = [v2 localizedStringForKey:@"ALBUM_ALBUMS_SECTION_TITLE" value:&stru_C498 table:@"NanoPhotosBridgeSettings"];
