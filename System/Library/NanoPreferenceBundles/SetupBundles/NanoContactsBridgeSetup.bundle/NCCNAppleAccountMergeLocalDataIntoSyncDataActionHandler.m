  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v19 = 2112;
        v20 = v14;
        _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "Merged AB local data to the AB source for iCloud account %@ (%@) and now disabling the AB local source", (uint8_t *)&v17, 0x16u);
      }
