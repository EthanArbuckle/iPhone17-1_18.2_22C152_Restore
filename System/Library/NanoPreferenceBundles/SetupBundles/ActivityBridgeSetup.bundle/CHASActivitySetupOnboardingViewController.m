...
- (id)titleString
{
  ...
  v3 = [v2 localizedStringForKey:@"HEALTH_TITLE" value:&stru_35EF0 table:@"ActivitySetup"];
...
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 localizedStringForKey:@"HEALTH_CHOICE_OK" value:&stru_35EF0 table:@"ActivitySetup"];
...
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 localizedStringForKey:@"SKIP_THIS_STEP" value:&stru_35EF0 table:@"ActivitySetup"];
...
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 localizedStringForKey:@"WHAT_IS_HEALTH" value:&stru_35EF0 table:@"ActivitySetup"];
...
{
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 localizedStringForKey:@"HEALTH_DETAIL_FYI" value:&stru_35EF0 table:@"ActivitySetup"];
