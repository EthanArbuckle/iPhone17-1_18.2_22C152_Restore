...
- (CHASActivitySetupMetricsCollectionViewController)initWithPresentationContext:(int64_t)a3
{
  ...
  result = [(CHASActivitySetupMetricsCollectionViewController *)&v5 initWithTitle:&stru_35EF0 detailText:0 icon:0 adoptTableViewScrollView:1];
  if (result) {
...
- (CHASActivitySetupMetricsCollectionViewController)initWithPresentationContext:(int64_t)a3 pregnancyStateProvider:(id)a4
{
  ...
  v8 = [(CHASActivitySetupMetricsCollectionViewController *)&v11 initWithTitle:&stru_35EF0 detailText:0 icon:0 adoptTableViewScrollView:1];
  v9 = v8;
  if (v8)
  {
...
- (void)viewDidLoad
{
  ...
  if ((v9 & 1) != 0 || [v7 wheelchairUse] != (char *)&dword_0 + 2)
  {
  ...
  v14 = (FIUIHealthSettingsDataSource *)objc_msgSend(objc_alloc((Class)FIUIHealthSettingsDataSource), "initWithActivitySettingsController:showWheelchair:pregnancyStateProvider:showPregnancy:", v7, *p_showWheelchair, self->_pregnancyStateProvider, -[CHASActivitySetupMetricsCollectionViewController showPregnancy](self, "showPregnancy"));
  ...
  v19 = [v18 localizedStringForKey:@"SET_UP_ACTIVITY" value:&stru_35EF0 table:@"ActivitySetup"];
  [v17 setTitle:v19];

  v20 = [(CHASActivitySetupMetricsCollectionViewController *)self headerView];
  v21 = +[NSBundle bundleForClass:objc_opt_class()];
  v22 = [v21 localizedStringForKey:@"SET_UP_ACTIVITY_DETAIL" value:&stru_35EF0 table:@"ActivitySetup"];
...
LABEL_3:
    v2 = [v4 localizedStringForKey:v6 value:&stru_35EF0 table:@"ActivitySetup"];
  ...
  switch(self->_presentationContext)
  {
    case 0:
      ...
      if (os_log_type_enabled(HKLogActivity, OS_LOG_TYPE_FAULT)) {
        sub_245D0(&self->_presentationContext, v7);
      }
      goto LABEL_6;
    case 1:
      goto LABEL_9;
    case 2:
      ...
      if (os_log_type_enabled(HKLogActivity, OS_LOG_TYPE_FAULT)) {
        sub_245D0(&self->_presentationContext, v9);
      }
LABEL_9:
...
- (id)_makeFooterView
{
  ...
  id v8 = objc_msgSend(objc_alloc((Class)UILabel), "initWithFrame:", CGRectZero.origin.x, y, width, height);
...
- (id)_footerString
{
  ...
  unsigned int v5 = (char *)[v4 fitnessMode];
  ...
  if (v3) {
    ...
    BOOL v8 = v5 == (unsigned char *)&dword_0 + 2;
  }
  if (v8) {
  ...
  id v10 = [v6 localizedStringForKey:v9 value:&stru_35EF0 table:@"ActivitySetup"];
...
- (BOOL)holdBeforeDisplaying
{
  ...
  if (os_log_type_enabled(HKLogActivity, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 67109376;
    ...
    __int16 v15 = 1024;
    unsigned int v16 = v8;
    _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "CHASActivitySetupMetricsCollectionViewController - controllerNeedsToRun: isTinkerPairing %d isTinkerHealthSharingEnabled %d", buf, 0xEu);
  }
  char v10 = v6 ^ 1 | v8;
  if ((v10 & 1) == 0)
  {
...
- (void)_startEdit
{
  ...
  id v5 = FIUIBundle();
  id v6 = [v5 localizedStringForKey:@"DONE_BUTTON" value:&stru_35EF0 table:@"Localizable"];
  ...
  double v10 = [v9 localizedStringForKey:@"CANCEL_BUTTON" value:&stru_35EF0 table:@"Localizable"];
...
- (void)_requestWheelchairDiagnosticsSubmissionIfNecessary
{
  ...
  if (v4)
  {
    ...
    if ((v6 & 1) == 0)
    {
      ...
      id v8 = [v7 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_TITLE" value:&stru_35EF0 table:@"ActivitySetup"];
      double v9 = +[NSBundle bundleForClass:objc_opt_class()];
      double v10 = [v9 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_DESCRIPTION" value:&stru_35EF0 table:@"ActivitySetup"];
      ...
      id v13 = [v12 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_ALLOW" value:&stru_35EF0 table:@"ActivitySetup"];
      unsigned int v14 = +[UIAlertAction actionWithTitle:v13 style:0 handler:&stru_354F8];
      [v11 addAction:v14];

      double v15 = +[NSBundle bundleForClass:objc_opt_class()];
      double v16 = [v15 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_MORE_INFO" value:&stru_35EF0 table:@"ActivitySetup"];
      ...
      double v19 = [v18 localizedStringForKey:@"FEEDBACK_WHEELCHAIR_DENY" value:&stru_35EF0 table:@"ActivitySetup"];
      double v20 = +[UIAlertAction actionWithTitle:v19 style:0 handler:&stru_35568];
      [v11 addAction:v20];
...
- (void)didTapEditPregnancy
{
  ...
  [v3 openURL:v2 options:&__NSDictionary0__struct completionHandler:&stru_355A8];
}
