...
- (CHASActivitySetupViewController)initWithPresentationContext:(int64_t)a3
{
  ...
  result = [(CHASActivitySetupViewController *)&v5 initWithTitle:&stru_35EF0 detailText:0 icon:0];
  if (result)
  {
    result->_goalType = -1;
...
- (CHASActivitySetupViewController)initWithPresentationContext:(int64_t)a3 goalType:(int64_t)a4 editTodayOnly:(BOOL)a5
{
  ...
  result = [(CHASActivitySetupViewController *)&v9 initWithTitle:&stru_35EF0 detailText:0 icon:0];
  if (result)
  {
    result->_goalType = a4;
...
- (id)advanceGoalHeaderTitle
{
  ...
  v2 = [v6 localizedStringForKey:v8 value:&stru_35EF0 table:@"ActivitySetup"];
...
- (void)generateHeaders
{
  ...
  if (self->_recommendedMoveGoal)
  {
    ...
    uint64_t v8 = [v7 localizedStringForKey:@"RECOMMENDED_MOVE_GOAL" value:&stru_35EF0 table:@"ActivitySetup"];

    objc_super v9 = +[NSBundle bundleForClass:objc_opt_class()];
    uint64_t v10 = [v9 localizedStringForKey:@"RECOMMENDED_MOVE_GOAL_DESCRIPTION" value:&stru_35EF0 table:@"ActivitySetup"];
  }
  else if (self->_isTinkerPaired)
  {
    ...
    if (v14)
    {
      ...
      v47 = (void *)v15;
      [v16 localizedStringForKey:v15 value:&stru_35EF0 table:@"ActivitySetup"];
      v18 = v17 = v4;
    ...
    else
    {
      ...
      v16 = +[NSBundle bundleForClass:objc_opt_class()];
      v47 = (void *)v24;
      uint64_t v10 = [v16 localizedStringForKey:v24 value:&stru_35EF0 table:@"ActivitySetup"];
    }

    v25 = +[NSBundle bundleForClass:objc_opt_class()];
    uint64_t v8 = [v25 localizedStringForKey:v45 value:&stru_35EF0 table:@"ActivitySetup"];
  }
  else
  {
    ...
    uint64_t v21 = [v20 localizedStringForKey:v9 value:&stru_35EF0 table:@"ActivitySetup"];

    v22 = +[NSBundle bundleForClass:objc_opt_class()];
    uint64_t v23 = [v22 localizedStringForKey:v19 value:&stru_35EF0 table:@"ActivitySetup"];
  ...
  v28 = [v27 localizedStringForKey:v44 value:&stru_35EF0 table:@"ActivitySetup"];
  [(NSArray *)v49 setObject:v28 atIndexedSubscript:1];

  v29 = +[NSBundle bundleForClass:objc_opt_class()];
  v30 = [v29 localizedStringForKey:v43 value:&stru_35EF0 table:@"ActivitySetup"];
  ...
  v36 = [v35 localizedStringForKey:v33 value:&stru_35EF0 table:@"ActivitySetup"];
  [(NSArray *)v49 setObject:v36 atIndexedSubscript:2];

  v37 = +[NSBundle bundleForClass:objc_opt_class()];
  v38 = [v37 localizedStringForKey:v34 value:&stru_35EF0 table:@"ActivitySetup"];
...
- (void)viewDidLoad
{
  ...
  if (self->_presentationContext == 6)
  {
    ...
    objc_super v5 = [v4 localizedStringForKey:@"CANCEL_BUTTON" value:&stru_35EF0 table:@"Localizable"];
  ...
  self->_BOOL isWheelchairUser = [v10 wheelchairUse] == (char *)&dword_0 + 2;
...
LABEL_8:
  ...
  v20 = (id *)qword_3D800;
  uint64_t v135 = qword_3D800;
  if (!qword_3D800)
  {
    location[0] = _NSConcreteStackBlock;
    location[1] = (id)3221225472;
    *(void *)&long long v119 = sub_1062C;
    *((void *)&v119 + 1) = &unk_35408;
    *(void *)&long long v120 = &v132;
    sub_1062C((uint64_t)location);
    v20 = (id *)v133[3];
  }
  ...
  if (v44)
  {
    ...
    v52 = [v51 localizedStringForKey:@"SCHEDULE" value:&stru_35EF0 table:@"ActivitySetup"];
    [v48 setTitle:v52];

    objc_msgSend(v48, "setContentInsets:", NSDirectionalEdgeInsetsZero.top, NSDirectionalEdgeInsetsZero.leading, NSDirectionalEdgeInsetsZero.bottom, NSDirectionalEdgeInsetsZero.trailing);
  ...
  *(_OWORD *)location = 0u;
  ...
  v71 = objc_msgSend(v63, "constraintEqualToAnchor:constant:", v65);
  [v71 setActive:1];
  ...
  v93 = (UILabel *)objc_msgSend(objc_alloc((Class)UILabel), "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  ...
  v98 = [v97 localizedStringForKey:@"CHANGE_GOAL_FOOTER" value:&stru_35EF0 table:@"ActivitySetup"];
  ...
  if (self->_recommendedMoveGoal)
  {
    ...
    v101 = [v100 localizedStringForKey:@"CHANGE_MOVE_GOAL" value:&stru_35EF0 table:@"ActivitySetup"];
    ...
    v106 = [v105 localizedStringForKey:@"SKIP_LABEL" value:&stru_35EF0 table:@"ActivitySetup"];
...
- (void)_updateAdvanceViewButton:(id)a3
{
  ...
  v12 = [v8 localizedStringForKey:v10 value:&stru_35EF0 table:@"ActivitySetup"];
  [v14 setTitle:v12];
...
LABEL_41:
    ...
    v2 = [v14 localizedStringForKey:v6 value:&stru_35EF0 table:@"ActivitySetup"];
  ...
  v2 = [(__CFString *)v6 localizedStringForKey:v7 value:&stru_35EF0 table:@"ActivitySetup"];
LABEL_42:
...
- (void)_storeGoals
{
  ...
  BOOL hasMoveGoalSchedule = self->_hasMoveGoalSchedule;
  double v8 = &selRef_initWithPresentationContext_pregnancyStateProvider_;
  ...
  if (!self->_hasExerciseGoalSchedule || self->_editTodayOnly)
  {
    ...
    if (!hasExerciseGoalSchedule
      && self->OBTableWelcomeController_opaque[*((int *)v8 + 142)]
  ...
  if (!self->_hasStandGoalSchedule || self->OBTableWelcomeController_opaque[*((int *)v8 + 142)])
  {
    if (self->_newDailyStandGoal)
    {
      double v20 = &_s10Foundation12NotificationV36_unconditionallyBridgeFromObjectiveCyACSo14NSNotificationCSgFZ_ptr;
      double v21 = +[HKObjectType standGoal];
      newDailyStandGoal = self->_newDailyStandGoal;
      if (self->OBTableWelcomeController_opaque[*((int *)v8 + 142)])
      {
  ...
  else if (os_log_type_enabled(HKLogActivity, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    _os_log_impl(&dword_0, v41, OS_LOG_TYPE_DEFAULT, "Successfully saved first daily goals: %@, %@, and %@ with activity move mode: %ld.", buf, 0x2Au);
  }
...
- (void)_saveGoalsAndDismiss
{
  ...
  if (self->_isTinkerPaired)
  {
    ...
    [v3 performEndToEndCloudSyncWithNRDeviceUUID:v6 syncParticipantFirst:1 completion:&stru_35728];
  }
  else
  {
    id v3 = [objc_alloc((Class)HKNanoSyncControl) initWithHealthStore:self->_healthStore];
    [v3 forceNanoSyncWithOptions:1 completion:&stru_35748];
  }
...
- (void)tappedContinue:(id)a3
{
  ...
  if (a3 && v6 && !self->_editTodayOnly)
  {
    ...
    double v8 = [v7 localizedStringForKey:@"REMOVE_SCHEDULE_TITLE" value:&stru_35EF0 table:@"ActivitySetup"];
    id v9 = +[NSBundle bundleForClass:objc_opt_class()];
    double v10 = [v9 localizedStringForKey:@"REMOVE_SCHEDULE_MESSAGE" value:&stru_35EF0 table:@"ActivitySetup"];
    ...
    double v13 = [v12 localizedStringForKey:@"CANCEL" value:&stru_35EF0 table:@"ActivitySetup"];
    double v14 = +[UIAlertAction actionWithTitle:v13 style:0 handler:&stru_35768];
    ...
    double v17 = [v16 localizedStringForKey:@"REMOVE" value:&stru_35EF0 table:@"ActivitySetup"];
    double v20 = _NSConcreteStackBlock;
    uint64_t v21 = 3221225472;
    double v22 = sub_D4D4;
    uint64_t v23 = &unk_357D8;
    double v24 = self;
    id v25 = v15;
    CFStringRef v26 = v5;
    id v18 = v15;
    ...
    objc_msgSend(v11, "addAction:", v14, v20, v21, v22, v23, v24);
    [v11 addAction:v19];
...
- (BOOL)_currentPageHasGoalSchedule
{
  ...
  return v3 <= 3 && self->OBTableWelcomeController_opaque[*off_35968[v3]] != 0;
}
...
LABEL_10:
  ...
  id v9 = [[_TtC19ActivityBridgeSetup13GoalDaysModel alloc] initWithGoalSchedule:v35];
...
- (id)_moveQuantityForToday
{
  v2 = [(NSArray *)self->_goalSchedules hk_filter:&stru_35860];
...
- (id)_exerciseQuantityForToday
{
  v2 = [(NSArray *)self->_goalSchedules hk_filter:&stru_35880];
  unint64_t v3 = [v2 firstObject];
...
- (id)_standQuantityForToday
{
  v2 = [(NSArray *)self->_goalSchedules hk_filter:&stru_358A0];
  unint64_t v3 = [v2 firstObject];
...
- (void)_updateGoalSchedule
{
  ...
  {
    [(HKHealthStore *)self->_healthStore deleteObject:v7 withCompletion:&stru_35910];
LABEL_5:
    [(HKHealthStore *)self->_healthStore saveObject:v6 withCompletion:&stru_35930];
  }
  unint64_t v8 = (unint64_t)[v6 goalType];
  if (v8 <= 3) {
    self->OBTableWelcomeController_opaque[*off_35968[v8]] = 1;
  }
