...
- (CHASActivitySetupLevelView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v6 = [v5 localizedStringForKey:@"ACTIVITY_LEVEL_LIGHTLY" value:&stru_35EF0 table:@"ActivitySetup"];
    v22[0] = v6;
    v7 = +[NSBundle bundleForClass:objc_opt_class()];
    v8 = [v7 localizedStringForKey:@"ACTIVITY_LEVEL_MODERATELY" value:&stru_35EF0 table:@"ActivitySetup"];
    v22[1] = v8;
    v9 = +[NSBundle bundleForClass:objc_opt_class()];
    v10 = [v9 localizedStringForKey:@"ACTIVITY_LEVEL_HIGHLY" value:&stru_35EF0 table:@"ActivitySetup"];
    v22[2] = v10;
