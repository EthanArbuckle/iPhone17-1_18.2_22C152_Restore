...
- (void)applyConfirmedOptin:(BOOL)a3
{
  VTUITinkerSetSiriEnabled(a3);
  id v4 = [(VTUITinkerSiriVoiceSelectionViewController *)self delegate];
...
- (void)dealloc
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)VTUITinkerSiriVoiceSelectionViewController;
  [(VTUITinkerSiriVoiceSelectionViewController *)&v7 dealloc];
}

- (id)languageCode
{
  v2 = [sub_585C() sharedPreferences];
  v3 = [v2 languageCode];

  if (!v3)
  {
    id v4 = [sub_585C() sharedPreferences];
...
- (void)voiceSelectionController:(id)a3 didSelectVoice:(id)a4
{
  ...
  id v9 = [v6 activeDevice];

  objc_super v7 = [sub_585C() sharedPreferences];
