...
- (CSLUIFieldOfIconsView)initWithFrame:(CGRect)a3 iconGraph:(id)a4 viewFactory:(id)a5 options:(unint64_t)a6
{
  ...
  if (v15)
  {
    ...
    *(void *)(v17 + 16) = v39;
    ...
    objc_msgSend((id)v17, "addSubview:", *(void *)(v17 + 16), sub_1FAB8(v17));
...
- (void)setTargetBundleIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    v16 = v10;
    _os_log_impl(&def_1AB14, v6, OS_LOG_TYPE_INFO, "changing locked target %@ to %@", (uint8_t *)&v13, 0x16u);
  }
...
- (Hex)centeredHex
{
  return (Hex)sub_200CC(self, CGPointZero.x, CGPointZero.y);
}
...
- (void)setLayout:(id)a3 percentComplete:(double)a4 animated:(BOOL)a5 options:(unint64_t)a6
{
  ...
  unsigned __int8 v36 = sub_20138((uint64_t)self);
  ...
  else
  {
    ...
    [(CSLHexLayout *)*p_layout setTargetHex:sub_21994((uint64_t)self, (unint64_t)[(CSLUIFieldOfIconsView *)self targetHex])];
    id v30 = *p_layout;
    [(CSLUIFieldOfIconsView *)self bounds];
...
- (void)layoutSubviews
{
  ...
  -[CSLUIFieldOfIconsView layoutIconsForcedApply:forcedSubview:](self, "layoutIconsForcedApply:forcedSubview:", 0, 0, sub_1FAB8((uint64_t)self));
}
...
LABEL_6:
  ...
  uint32x2_t v14 = (uint32x2_t)vcgt_f32(vabs_f32(*(float32x2_t *)v18.i8), vadd_f32((float32x2_t)vdup_laneq_s32(v18, 2), (float32x2_t)qword_46D98));
...
LABEL_11:
  ...
  if (!v16)
  {
    ...
    if (v13 != (v17 != 0))
    {
      if (!v13)
      {
        sub_22214((uint64_t)self, v8);
        goto LABEL_18;
      }
LABEL_17:
      sub_202B0((uint64_t)self, v8);
      goto LABEL_18;
    }
    if (v5 && !v17) {
      goto LABEL_17;
...
- (void)enableGestureRecognizers:(BOOL)a3
{
  ...
  sub_222F0((id *)&self->super.super.super.isa);
}
...
- (void)handlePanGesture:(id)a3
{
  id v4 = a3;
  if ([(CSLUIFieldOfIconsView *)self isDragging]) {
    sub_224D8((uint64_t)self, v4);
  }
  else {
    sub_22778((uint64_t)self, v4);
  }
}
  ...
  switch((unint64_t)[v4 state])
  {
    case 1uLL:
      ...
      *(_OWORD *)buf = 0u;
      ...
      if (0.0 >= 0.2)
      {
        uint32x2_t v26 = (uint32x2_t)vcgt_f32(vabs_f32(*(float32x2_t *)buf), vadd_f32((float32x2_t)vdup_laneq_s32(*(int32x4_t *)buf, 2), (float32x2_t)qword_46D98));
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v33 = 1024;
        BOOL v34 = v8;
        _os_log_impl(&def_1AB14, v27, OS_LOG_TYPE_DEFAULT, "handleIconTap:stateBegan isEditing:%{BOOL}u isOnScreen:%{BOOL}u", (uint8_t *)v32, 0xEu);
      }
    ...
    case 2uLL:
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[14] = 1024;
        ...
        WORD2(v36) = 2114;
        *(void *)((char *)&v36 + 6) = v10;
        _os_log_impl(&def_1AB14, v11, OS_LOG_TYPE_DEFAULT, "handleIconTap:stateChanged isEditing:%{BOOL}u isLongPress:%{BOOL}u _dragView nil:%{BOOL}u, node:%{public}@", buf, 0x1Eu);
      }
      if (v9)
      {
        ...
        if (v15)
        {
          sub_22B84((uint64_t)self, @"long press");
          id v16 = objc_loadWeakRetained((id *)&self->_actionDelegate);
          [v16 handleLongPress];

          [v4 locationInView:self];
          sub_2345C(self, v10, v17, v18);
        }
      }
      goto LABEL_37;
    case 3uLL:
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&long long v36 = v10;
        _os_log_impl(&def_1AB14, v20, OS_LOG_TYPE_DEFAULT, "handleIconTap:stateEnded isEditing:%{BOOL}u isLongPress:%{BOOL}u node:%{public}@", buf, 0x18u);
      }

      sub_22B84((uint64_t)self, @"touch up");
      if ([v4 isLongPress])
      {
    ...
    case 4uLL:
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[14] = 1024;
        ...
        _os_log_impl(&def_1AB14, v22, OS_LOG_TYPE_DEFAULT, "handleIconTap:stateCancelled isEditing:%{BOOL}u isDragging:%{BOOL}u didPanDrag:%{BOOL}u", buf, 0x14u);
      }
      ...
      sub_22B84((uint64_t)self, @"gesture cancelled");
      goto LABEL_38;
    default:
      goto LABEL_38;
  }
...
- (void)handlePinch:(id)a3
{
  ...
  if ((unint64_t)(v5 - 3) >= 3)
  {
    if (v5 == (unsigned char *)&def_1AB14 + 1)
    {
      sub_21548(self);
    }
    else if (v5 != (unsigned char *)&def_1AB14 + 2)
    {
      goto LABEL_8;
    }
    [v4 scale];
...
- (CGPoint)inertialUpdater:(id)a3 willDecelerateWithTarget:(CGPoint)a4
{
  ...
  else
  {
    CGFloat y = a4.y;
    CGFloat x = a4.x;
    unint64_t v24 = sub_239D8(self, a4.x, a4.y);
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134220546;
      ...
      __int16 v45 = 2048;
      CGFloat v46 = v21;
      _os_log_debug_impl(&def_1AB14, v13, OS_LOG_TYPE_DEBUG, "inertial updater: willDecelerateWithTarget:{%.4f, %.4f} to bestTargetPoint:{%.4f, %.4f} for hex:%{public}s resulting in clientTarget delta:{%.4f, %.4f} for current rawContentOffset:{%.4f, %.4f} contentOffset:{%.4f, %.4f}", buf, 0x70u);
...
- (id)scrolledCenterBundleIdentifier
{
  v2 = sub_243F8((id *)&self->super.super.super.isa, (uint64_t)[(CSLUIFieldOfIconsView *)self centeredHex]);
...
- (void)setTargetHexToScrolledCenterForReason:(id)a3
{
  ...
  double v6 = sub_243F8((id *)&self->super.super.super.isa, *(void *)&v5);
  if (v6)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v15 = 2114;
      double v16 = v6;
      _os_log_impl(&def_1AB14, v7, OS_LOG_TYPE_DEFAULT, "Setting target hex to scrolled center reason:%{public}@ centeredHex:{%d,%d} node:%{public}@", (uint8_t *)&v9, 0x22u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2114;
      double v16 = 0;
      _os_log_error_impl(&def_1AB14, v8, OS_LOG_TYPE_ERROR, "Cannot set target hex to scrolled center reason:%{public}@ centeredHex:{%d,%d} node:%{public}@", (uint8_t *)&v9, 0x22u);
    }
  }
}
...
- (void)autoScroll
{
  ...
  if ((autoScrollDirection & 2) == 0 || !sub_249E8((uint64_t)self, 2)) {
    return;
  }
  double v5 = 4.0;
LABEL_8:
...
- (Hex)closestIconHexToHex:(Hex)a3
{
  ...
  unint64_t v11 = sub_239D8(self, v13, v10);
...
- (void)updatePPT:(id)a3
{
  ...
  else
  {
    ...
    unsigned int v13 = sub_20138((uint64_t)self);
    double v14 = x + v9.__sinval * pptPanDistance;
    double v15 = y + v9.__cosval * pptPanDistance;
    if (v13) {
      sub_23C20((uint64_t)self, COERCE_FLOAT32X2_T(v14 - self->_rawTouchContentOffset.x), COERCE_FLOAT32X2_T(v15 - self->_rawTouchContentOffset.y));
    }
    else {
