...
LABEL_14:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v30 = 2048;
    CGFloat v31 = v15;
    _os_log_debug_impl(&def_1AB14, v9, OS_LOG_TYPE_DEBUG, "inertial updater: did constrain offset:{%.4f, %.4f} to offset:{%.4f, %.4f} target:{%.4f, %.4f} clientTarget:{%.4f, %.4f}", (uint8_t *)&v16, 0x52u);
  }
...
- (void)_decelerate:(double)a3
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v31 = 2048;
    CGFloat v32 = v19;
    _os_log_debug_impl(&def_1AB14, v17, OS_LOG_TYPE_DEBUG, "inertial updater: did decelerate with delta:{%.4f, %.4f} offset:{%.4f, %.4f} target:{%.4f, %.4f}", (uint8_t *)&v21, 0x3Eu);
  }
...
- (void)_finalizeOffset
{
  ...
  {
    float64x2_t v13 = v3;
    dispatch_once(&qword_46D60, &stru_3CAA0);
    float64x2_t v3 = v13;
  }
  *(void *)&v4.f64[0] = qword_46D58;
  *(void *)&v4.f64[1] = qword_46D58;
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(float64_t *)((unint64_t)buf | 0xE) = v12.f64[1];
    ...
    __int16 v27 = 2048;
    CGFloat v28 = v11;
    _os_log_debug_impl(&def_1AB14, v5, OS_LOG_TYPE_DEBUG, "inertial updater: did finalize delta:{%.4f, %.4f} with offset:{%.4f, %.4f} target:{%.4f, %.4f} clientTarget:{%.4f, %.4f}", buf, 0x52u);
  }
...
- (void)_computeDecelerationTarget
{
  float64x2_t v3 = vmulq_f64((float64x2_t)self->_velocity, (float64x2_t)xmmword_2DFC0);
  if (qword_46D60 != -1)
  {
    float64x2_t v30 = v3;
    dispatch_once(&qword_46D60, &stru_3CAA0);
  ...
  else if (!v17)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134219264;
      ...
      uint32_t v26 = 62;
LABEL_21:
      _os_log_debug_impl(&def_1AB14, v25, OS_LOG_TYPE_DEBUG, v24, buf, v26);
      goto LABEL_16;
    }
    goto LABEL_16;
  }
