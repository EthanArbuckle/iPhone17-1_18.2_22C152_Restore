...
- (CSLHexAppGraph)init
{
  ...
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v19 = 2114;
    v20 = v4;
    _os_log_error_impl(&def_1AB14, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "failure in %{public}@ of <%{public}@:%p> (%{public}@:%i) : %{public}@", (uint8_t *)&v9, 0x3Au);
  }
  [v4 UTF8String];
...
{
  id v4 = a3;
  sub_19968((uint64_t)v27, (uint64_t)v4 + 32);
...
- (BOOL)addNode:(id)a3
{
  id v4 = a3;
  id v20 = [v4 hex];
  if (sub_5D44(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v20))
  {
        ...
        if (v20 != v13)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v24 = 2080;
            v25 = v17;
            _os_log_error_impl(&def_1AB14, v14, OS_LOG_TYPE_ERROR, "%@ is dirty, saved hex: %s", buf, 0x16u);
...
- (Hex)firstGoodEmptyHex
{
  ...
  *(_DWORD *)&v12[28] = 0;
  ...
  do
  {
    ...
    {
      unint64_t v3 = sub_112E4((unsigned int *)&v8);
    }
    else
    {
      ...
      unint64_t v3 = sub_11348((uint64_t)&v9);
    }
...
- (void)removeNode:(id)a3
{
  id v4 = a3;
  id v5 = [v4 hex];
  [(CSLHexAppGraph *)self removeNodeUsingIterator:sub_5D44(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v5)];
}

- (id)removeNodeAtHex:(Hex)a3
{
  Hex v6 = a3;
  id v4 = sub_5D44(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v6);
  if (v4) {
...
- (void)removeNodeWithoutReflow:(id)a3
{
  id v4 = a3;
  id v6 = [v4 hex];
  id v5 = sub_5D44(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v6);
  if (v5) {
...
- (void)removeNodeWithoutReflowUsingIterator:()__hash_map_const_iterator<std:(CSLHexAppNode *)__unsafe_unretained> :(void *> *>>)a3 __hash_const_iterator<std::__hash_node<std::__hash_value_type<CSL::Hex
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG)) {
    sub_26A14((uint64_t)a3.var0.var0, v5, v6);
  }

  sub_5E00(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (uint64_t *)a3.var0.var0);
...
LABEL_6:
    uint64_t v24 = v8;
    int v25 = 0;
    int v26 = sub_18FB4(v8, -(int)v8 - HIDWORD(v8), SHIDWORD(v8));
    while (1)
    {
      *(void *)v27 = sub_11EF8(&v24);
      *(_DWORD *)&v27[8] = v9;
      if (!v27[0]) {
        break;
      }
      ...
      if (v10)
      {
        ...
        {
          sub_10F6C((int *)&v28, (std::string *)__p);
          ...
          *(std::string::size_type *)((char *)&buf.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v12;
          _os_log_debug_impl(&def_1AB14, v11, OS_LOG_TYPE_DEBUG, "[collapse] move %@ -> %s", (uint8_t *)&buf, 0x16u);
          if (SBYTE7(v22) < 0) {
    ...
    *(_OWORD *)std::string __p = 0u;
    ...
    while (1)
    {
      ...
      *(_DWORD *)&v27[8] = v15;
      ...
      if (v16)
      {
        sub_19094((uint64_t)__p, (int *)&v27[4], &v27[4]);
        if ([(CSLHexAppGraph *)self isLonelyHex:*(void *)&v27[4]])
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)v31 = 138412290;
            v32 = v16;
            _os_log_debug_impl(&def_1AB14, v17, OS_LOG_TYPE_DEBUG, "[lonely] add %@", v31, 0xCu);
          }
...
- (BOOL)checkNode:(id)a3 connectedNodes:(id)a4 disconnectedNodes:(id)a5
{
  ...
  *id v13 = v11;
  ...
  while (1)
  {
    ...
    v32[5] = v20;
    sub_1901C((uint64_t)v27, (int *)v32, 6);
    if (v28)
    {
      uint64_t v23 = 0;
      uint64_t v24 = v28;
    ...
    sub_19C98((uint64_t)&__p, (char *)__src, v28, 0, v23);
    sub_60D0((uint64_t)v27);
LABEL_15:
...
- (void)collapseLonelyNodes:(id)a3 connectedNodes:(id)a4 disconnectedNodes:(id)a5
{
  ...
  while (objc_msgSend(v77, "count", v75))
  {
    ...
    *(void *)std::string buf = [v9 hex];
    ...
    sub_19508((uint64_t)v87, (unint64_t *)buf, (uint64_t *)&v95);
    v86[0] = 0;
    *(void *)&v86[4] = 0;
    char v30 = 1;
    do
    {
      *(void *)v86 = sub_13440((uint64_t)v87);
      *(_DWORD *)&v86[8] = v31;
      if (!v86[0]) {
        break;
      }
      ...
      else
      {
        ...
        if (v33)
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(void *)&uint8_t buf[4] = v33;
            _os_log_debug_impl(&def_1AB14, v34, OS_LOG_TYPE_DEBUG, "[less lonely] %@ fall complete", buf, 0xCu);
          }
          int v32 = 7;
        }
        else
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
          {
            sub_10F6C((int *)&v86[4], (std::string *)buf);
            v35 = buf;
            if (buf[23] < 0) {
            ...
            *(std::string::size_type *)((char *)v95.__r_.__value_.__r.__words + 4) = (std::string::size_type)v35;
            _os_log_debug_impl(&def_1AB14, v34, OS_LOG_TYPE_DEBUG, "[less lonely] %s unoccupied", (uint8_t *)&v95, 0xCu);
    ...
    if (v88)
    {
      ...
      {
        sub_10F6C((int *)&v89, (std::string *)buf);
        v71 = buf;
        if (buf[23] < 0) {
        ...
        *(std::string::size_type *)((char *)&v95.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v71;
        _os_log_debug_impl(&def_1AB14, v36, OS_LOG_TYPE_DEBUG, "[less lonely] move %@ -> %s", (uint8_t *)&v95, 0x16u);
        if ((buf[23] & 0x80000000) != 0) {
          operator delete(*(void **)buf);
        }
      }
...
LABEL_129:
      ...
      if (v84)
      {
        ...
        if (os_log_type_enabled(v65, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_WORD *)&buf[22] = 2080;
          *(void *)&buf[24] = v73;
          _os_log_debug_impl(&def_1AB14, v65, OS_LOG_TYPE_DEBUG, "[lonely %s] move %@ -> %s", buf, 0x20u);
      ...
      else
      {
        ...
        {
          sub_10F6C((int *)&v94, (std::string *)buf);
          v74 = buf;
          if (buf[23] < 0) {
          ...
          *(std::string::size_type *)((char *)&v95.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v74;
          _os_log_debug_impl(&def_1AB14, v66, OS_LOG_TYPE_DEBUG, "[should not happen - searched from center] move %@ -> %s", (uint8_t *)&v95, 0x16u);
          if ((buf[23] & 0x80000000) != 0) {
            operator delete(*(void **)buf);
          }
        }
    ...
    while (1)
    {
      *(void *)v86 = sub_12108((uint64_t *)&v82);
      *(_DWORD *)&v86[8] = v47;
      if (!v86[0]) {
        break;
      }
      ...
      if (v48)
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(std::string::size_type *)((char *)&v95.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v60;
          _os_log_debug_impl(&def_1AB14, v49, OS_LOG_TYPE_DEBUG, "[less lonely] %@ occupied (neighbors of %s)", (uint8_t *)&v95, 0x16u);
          if ((buf[23] & 0x80000000) != 0) {
            operator delete(*(void **)buf);
          }
        }
        ...
        *(void *)&buf[24] = ((*(void *)&v86[4] & 0xFFFFFFFF00000000) - 0x100000000) & 0xFFFFFFFF00000000 | *(unsigned int *)&v86[4];
        ...
        if (v53)
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&buf[18] = 2080;
            *(void *)&buf[20] = v64;
            _os_log_debug_impl(&def_1AB14, v55, OS_LOG_TYPE_DEBUG, "[less lonely] %s has %d neighbors (neighbors of %s)", buf, 0x1Cu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(std::string::size_type *)((char *)&v94.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v62;
            _os_log_debug_impl(&def_1AB14, v56, OS_LOG_TYPE_DEBUG, "[less lonely] %s not connected (neighbors of %s)", (uint8_t *)&v94, 0x16u);
            if (SHIBYTE(v95.__r_.__value_.__r.__words[2]) < 0) {
              operator delete(v95.__r_.__value_.__l.__data_);
            }
            if ((buf[23] & 0x80000000) != 0) {
...
LABEL_138:
    ...
    *(_DWORD *)&buf[8] = 0;
    while (1)
    {
      *(void *)v86 = sub_12108((uint64_t *)buf);
      *(_DWORD *)&v86[8] = v67;
      if (!v86[0]) {
        break;
      }
...
- (void)move343Node:(id)a3 toHex:(Hex)a4 final:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(std::string::size_type *)((char *)&__p.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)p_buf;
    ...
    _os_log_debug_impl(&def_1AB14, v9, OS_LOG_TYPE_DEBUG, "[343 move] consider move %@ -> %s %@", (uint8_t *)&__p, 0x20u);
  ...
  if (*(id *)&v52 != v10 && v52.r >= -2 && (v52.r + 2 * v52.q + 3) <= 6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(std::string::size_type *)((char *)&__p.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v41;
      ...
      _os_log_debug_impl(&def_1AB14, v12, OS_LOG_TYPE_DEBUG, "[343 move] WILL move %@ -> %s %@", (uint8_t *)&__p, 0x20u);
      if (SHIBYTE(buf.__r_.__value_.__r.__words[2]) < 0) {
        operator delete(buf.__r_.__value_.__l.__data_);
      }
    }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(std::string::size_type *)((char *)&buf.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v20;
            _os_log_debug_impl(&def_1AB14, v23, OS_LOG_TYPE_DEBUG, "[343 move] reverse enumerator ended after:%s unplacedNode:%@", (uint8_t *)&buf, 0x16u);
            if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
              operator delete(__p.__r_.__value_.__l.__data_);
            }
          }
          ...
          if (v20 && v20 != v19)
          {
            ...
            if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
            {
              ...
              *(std::string::size_type *)((char *)&__p.__r_.__value_.__r.__words[1] + 6) = (std::string::size_type)v47;
              ...
              __int16 v59 = 2114;
              v60 = v43;
              _os_log_error_impl(&def_1AB14, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "failure in %{public}@ of <%{public}@:%p> (%{public}@:%i) : %{public}@", (uint8_t *)&__p, 0x3Au);
            }
            [v43 UTF8String];
...
- (void)moveNode:(id)a3 toHex:(Hex)a4 final:(BOOL)a5
{
  ...
  if (!self->_isVerticalOnly)
  {
    if (!*(void *)&a4 || ![v8 hex])
    {
      ...
      {
        sub_10F6C((int *)&v51, (std::string *)v53);
        sub_26B98();
      }
      goto LABEL_56;
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        sub_10F6C((int *)&v51, (std::string *)&v59);
        if (v60[7] >= 0) {
          v43 = &v59;
        }
        else {
        ...
        *(_WORD *)&v54[10] = 2112;
        *(void *)&v54[12] = v44;
        _os_log_debug_impl(&def_1AB14, v12, OS_LOG_TYPE_DEBUG, "WILL move %@ -> %s %@", v53, 0x20u);
      ...
      id v13 = [v9 hex];
      sub_195C0((uint64_t *)&v59, (uint64_t)v51, (uint64_t)v13);
      v50[0] = 0;
      *(void *)&v50[4] = 0;
      do
      {
        unint64_t v14 = sub_146C8(&v59);
      ...
      if (v16)
      {
        ...
        else
        {
          ...
          *(void *)&v54[16] = v51;
          ...
          while (1)
          {
            *(void *)uint64_t v50 = sub_14760((uint64_t)v53);
            *(_DWORD *)&v50[8] = v21;
            if (!v50[0]) {
              break;
            }
          ...
          sub_195C0((uint64_t *)buf, (uint64_t)v51, v49);
          ...
          *(void *)&long long v26 = 138412290;
          ...
          while (1)
          {
            *(void *)uint64_t v50 = sub_146C8(&v59);
            *(_DWORD *)&v50[8] = v27;
            if (!v50[0]) {
              break;
            }
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_WORD *)&buf[22] = 2080;
              *(void *)&buf[24] = p_p;
              _os_log_debug_impl(&def_1AB14, v29, OS_LOG_TYPE_DEBUG, "[push up] removed %@; move %@ -> %s", buf, 0x20u);
              if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
                operator delete(__p.__r_.__value_.__l.__data_);
              }
            }
            ...
            if (!v28)
            {
              ...
              if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(void *)&uint8_t buf[4] = v25;
                _os_log_debug_impl(&def_1AB14, v30, OS_LOG_TYPE_DEBUG, "[lonely?] add %@", buf, 0xCu);
              }
      ...
      *(void *)v60 = v59;
      while (1)
      {
        ...
        *(_DWORD *)&v50[8] = v33;
        ...
        {
          sub_10F6C((int *)&v50[4], (std::string *)buf);
          v36 = buf;
          if (buf[23] < 0) {
          ...
          *(_WORD *)&v54[10] = 2080;
          *(void *)&v54[12] = v36;
          _os_log_debug_impl(&def_1AB14, v35, OS_LOG_TYPE_DEBUG, "[simple shift] removed %@; move %@ -> %s", v53, 0x20u);
          if ((buf[23] & 0x80000000) != 0) {
            operator delete(*(void **)buf);
          }
        }
      ...
      do
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)std::string buf = 138412546;
          ...
          __int16 v30 = 2080;
          uint64_t v31 = p_p;
          _os_log_debug_impl(&def_1AB14, v14, OS_LOG_TYPE_DEBUG, "reverted %@ -> %s", buf, 0x16u);
          if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
            operator delete(__p.__r_.__value_.__l.__data_);
          }
        }
...
{
  Hex v4 = a3;
  return sub_5D44(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v4) != 0;
}

- (id)nodeAtHex:(Hex)a3
{
  Hex v5 = a3;
  unint64_t v3 = (id *)sub_5D44(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v5);
  if (v3) {
...
- (void)calculateNeighborCounts
{
  sub_19FC4(&self->_neighborCounts.__table_.__bucket_list_.__ptr_.__value_);
...
- (void)incrementNeighborCountsForHex:(Hex)a3
{
  Hex v11 = a3;
  int v12 = 0;
  uint64_t v9 = sub_12108((uint64_t *)&v11);
  int v10 = v4;
  if ((_BYTE)v9)
  {
    ...
    do
    {
      id v6 = sub_5D44(p_neighborCounts, (int *)&v9 + 1);
      if (v6)
      {
        ++*((_DWORD *)v6 + 6);
      }
      ...
      {
        int v8 = 1;
        sub_1A02C((uint64_t)p_neighborCounts, (int *)&v9 + 1, (uint64_t *)((char *)&v9 + 4), &v8);
      }
      uint64_t v9 = sub_12108((uint64_t *)&v11);
      int v10 = v7;
    }
...
- (void)decrementNeighborCountsForHex:(Hex)a3
{
  Hex v10 = a3;
  int v11 = 0;
  uint64_t v8 = sub_12108((uint64_t *)&v10);
  int v9 = v4;
  if ((_BYTE)v8)
  {
    p_neighborCounts = &self->_neighborCounts;
    do
    {
      id v6 = sub_5D44(p_neighborCounts, (int *)&v8 + 1);
      if (v6) {
        --*((_DWORD *)v6 + 6);
      }
      uint64_t v8 = sub_12108((uint64_t *)&v10);
...
- (int64_t)neighborCountOfHex:(Hex)a3 upToMinimumNeighbors:(int64_t)a4 withinRange:(unint64_t)a5
{
  ...
  {
    float v7 = sub_5D44(&self->_neighborCounts.__table_.__bucket_list_.__ptr_.__value_, (int *)&v21);
    if (v7) {
      return *((int *)v7 + 6);
    }
    return 0;
...
- (void)setNodeObject:(id)a3 forKey:(Hex)a4
{
  ...
  id v5 = a3;
  float v7 = &v6;
  sub_1A268((uint64_t)&self->_nodes, (int *)&v6, (uint64_t)&unk_2E088, (void **)&v7)[3] = v5;
  *(_WORD *)&self->_BOOL neighborCountValid = 256;
}
...
{
  Hex v4 = a3;
  sub_1A494(&self->_nodes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v4);
  *(_WORD *)&self->_BOOL neighborCountValid = 256;
}
...
LABEL_57:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)((char *)v59 + 2) = v45;
        _os_log_error_impl(&def_1AB14, v34, OS_LOG_TYPE_ERROR, "nodes count:%d != nodesByBundleCount:%d", buf, 0xEu);
      }
    }
    BOOL v30 = 0;
    goto LABEL_57;
  ...
  while (1)
  {
    ...
    if ((id)v56 != v11)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        sub_10F6C((int *)&v56, (std::string *)v57);
        sub_26FEC();
      }
      goto LABEL_60;
    }
      ...
      if (self->_isVerticalOnly)
      {
        ...
        *(void *)long long v54 = 0xFFFFFFFE00000000;
        if (v15)
        {
          while (1)
          {
            uint64_t v16 = sub_112E4((unsigned int *)v54);
          ...
          {
            sub_10F6C((int *)&v55, (std::string *)v57);
            sub_26F04();
          }
      ...
      else
      {
          ...
          && ![(CSLHexAppGraph *)self hex:(void)v56 hasAtLeastNNearbyNodes:2 withinRange:1])
        {
          ...
          *(void *)std::string buf = v56;
          ...
          while (1)
          {
            *(void *)long long v54 = sub_12108((uint64_t *)buf);
            *(_DWORD *)&v54[8] = v38;
            if (!v54[0]) {
              break;
            }
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&v57[18] = 2114;
            *(void *)&v57[20] = v47;
            _os_log_error_impl(&def_1AB14, v42, OS_LOG_TYPE_ERROR, "neighbor check failed %{public}@ has only %d neighbors: %{public}@", v57, 0x1Cu);
          }
          goto LABEL_44;
        }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v4)
  {
    ...
    for (i = (id *)self->_nodes.__table_.__p1_.__value_.__next_; i; i = (id *)*i)
    {
      ...
      id v11 = [v12 hex];
      sub_1A4CC((uint64_t)(v5 + 4), (int *)&v11, &v11, (uint64_t *)&v12);
    }
...
{
  id v7 = a3;
  [v7 encodeObject:&off_3E118 forKey:@"Version"];
  if (self->_isVerticalOnly) {
...
- (id)description
{
  ...
  id v4 = [v3 sortedArrayUsingComparator:&stru_3CC78];
      ...
      *((unsigned char *)v32 + 24) = v9 == v10;
      if (v9 != v10)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR)) {
          sub_27320((uint64_t)v51, *((void *)v7 + 7), (uint64_t)[*((id *)v7 + 17) count], v12);
        }
      ...
      if (*((unsigned char *)v36 + 24))
      {
        ...
        *((unsigned char *)v11 + 24) = v13;
        if (!v13)
        {
          id v14 = cslprf_icon_field_log();
          if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR)) {
            sub_27294((uint64_t *)v7 + 7, (uint64_t)v44, v14);
          }
        ...
        if ((id)(v15 + v16) != v17)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)std::string buf = 134218496;
            ...
            __int16 v49 = 2048;
            id v50 = v24;
            _os_log_error_impl(&def_1AB14, v18, OS_LOG_TYPE_ERROR, "invalid count (%ld + %d != %ld)", buf, 0x1Cu);
          }
...
- (id)_emplaceNodeAtHex:(Hex)a3 withBundleIdentifier:(id)a4
{
  ...
  sub_1A4CC((uint64_t)&self->_nodes, (int *)&v10, &v10, (uint64_t *)&v9);
  id v7 = v9;
...
- (id)migrateToVerticalOnly
{
  ...
  sub_19968((uint64_t)v66, (uint64_t)&self->_nodes);
  v64 = 0;
  ...
  while (1)
  {
    unint64_t v4 = sub_112E4((unsigned int *)&v65);
    if ((int)v5 > 2) {
      break;
    }
    *((void *)&v7 + 1) = v5;
    *(void *)&long long v7 = v4;
    ...
    if (!v5 && !self->_isVerticalOnly && !HIDWORD(v4))
    {
      ...
      if (!sub_5D44(v66, (int *)&__p)) {
        std::string __p = &def_1AB14 + 2;
      }
    }
    id v8 = sub_5D44(v66, (int *)&__p);
    id v9 = v8;
    if (v8)
    {
    ...
    else
    {
      ...
      if (v63 >= v64)
      {
        ...
        if (v16) {
          id v17 = (char *)sub_57A4((uint64_t)&v64, v16);
        }
        else {
          id v17 = 0;
        }
  ...
  if (self->_isVerticalOnly && v67 != 0)
  {
    do
    {
      ...
      uint64_t v22 = sub_5E00(v66, (uint64_t *)v22);
    }
    while (v22);
  }
LABEL_34:
  ...
  if (v67)
  {
    ...
    do
    {
      ...
      if (v25 >= v61)
      {
        ...
        if (v29) {
          BOOL v30 = (char *)sub_57A4((uint64_t)&v61, v29);
        }
        else {
          BOOL v30 = 0;
        }
  ...
  sub_1A704((uint64_t)__p, (uint64_t *)v25, v40, 1);
  uint64_t v41 = (char *)__p;
  char v42 = v60;
  while (v41 != v42)
  {
    uint64_t v58 = *(void *)v41;
    uint64_t v43 = sub_5D44(v66, (int *)&v58);
    if (v43)
    {
      ...
      if (v62 == v63)
      {
        unint64_t v48 = sub_112E4((unsigned int *)&v65);
        uint64_t v47 = v49;
    ...
    *(void *)&long long v8 = 138412546;
    ...
    do
    {
      for (i = 0; i != v7; i = (char *)i + 1)
      {
        ...
        if (v12)
        {
          LODWORD(v25) = (unint64_t)sub_112E4((unsigned int *)&v30) >> 32;
          HIDWORD(v25) = v13;
          uint64_t v14 = cslprf_icon_field_log();
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
          {
            sub_10F6C((int *)&v25, &__p);
            ...
            *(_DWORD *)std::string buf = 138543874;
            ...
            __int16 v35 = 2114;
            uint64_t v36 = v17;
            _os_log_impl(&def_1AB14, v14, OS_LOG_TYPE_DEFAULT, "moving node:%{public}@ to hex:%{public}s for reason:%{public}@", buf, 0x20u);
            if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
              operator delete(__p.__r_.__value_.__l.__data_);
            }
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)std::string buf = v22;
            ...
            __int16 v33 = 2114;
            uint64_t v34 = v21;
            _os_log_impl(&def_1AB14, v20, OS_LOG_TYPE_DEFAULT, "node not found : %@ cannot move to top for reason:%{public}@", buf, 0x16u);
          }
        }
      }
      id v7 = [obj countByEnumeratingWithState:&v26 objects:v37 count:16];
...
- (void)collapseAll343Holes
{
  if (!self->_isVerticalOnly)
  {
    ...
    if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)std::string buf = 138544642;
      ...
      __int16 v40 = 2114;
      uint64_t v41 = v21;
      _os_log_error_impl(&def_1AB14, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "failure in %{public}@ of <%{public}@:%p> (%{public}@:%i) : %{public}@", buf, 0x3Au);
    }
    [v21 UTF8String];
  ...
  if (value >= 1)
  {
    ...
    do
    {
      uint64_t v5 = sub_112E4((unsigned int *)&v29);
      *((void *)&v7 + 1) = v6;
      *(void *)&long long v7 = v5;
      long long v8 = [(CSLHexAppGraph *)self nodeAtHex:(unint64_t)(v7 >> 32)];
      if (v8)
      {
        LODWORD(v27) = (unint64_t)sub_112E4((unsigned int *)&v28) >> 32;
        HIDWORD(v27) = v9;
        id v10 = [v8 hex];
        if (v27 != v10 || HIDWORD(v27) != HIDWORD(v10))
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)std::string buf = 138412802;
            ...
            _os_log_debug_impl(&def_1AB14, v12, OS_LOG_TYPE_DEBUG, "[343 collapse] move %@ -> %s; displaced:%@; ",
              buf,
              0x20u);
            if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
              operator delete(__p.__r_.__value_.__l.__data_);
...
- (void).cxx_destruct
{
  ...
  sub_60D0((uint64_t)&self->_neighborCounts);

  sub_60D0((uint64_t)&self->_nodes);
}
