...
- (CSLIconPositionsStore)init
{
  ...
  if (v2)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, v2, (CFNotificationCallback)sub_C5AC, @"CSLIconPositionsChangedNotification", 0, (CFNotificationSuspensionBehavior)0);
    v2->_initialSyncComplete = 0;
    v6 = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(v6, v2, (CFNotificationCallback)sub_C5B4, kNPSInitialSyncCompletionDarwinNotification, 0, (CFNotificationSuspensionBehavior)0);
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138413058;
      ...
      _os_log_impl(&def_1AB14, v16, OS_LOG_TYPE_DEFAULT, "override set, using '%@.%@' instead of '%@.%@'", buf, 0x2Au);
    }
...
LABEL_35:
  ...
  if (os_log_type_enabled(v24, v25))
  {
    *(_DWORD *)buf = 138412290;
    uint64_t v35 = v13;
    _os_log_impl(&def_1AB14, v24, v25, "successfully loaded default icon plist (%@)", buf, 0xCu);
  }
...
- (void)saveTargetPositions:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    int v8 = 136315138;
    CFStringRef v9 = v7;
    _os_log_impl(&def_1AB14, v5, v6, "%s target icon positions", (uint8_t *)&v8, 0xCu);
  }
...
- (id)orderedBundleIdentifiers
{
  ...
  id v4 = [v3 sortedArrayUsingComparator:&stru_3CB50];
  id v5 = objc_msgSend(v4, "bs_map:", &stru_3CB90);
...
LABEL_19:
    ...
    if (os_variant_has_internal_diagnostics())
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v18 = 2114;
        uint64_t v19 = v13;
        _os_log_impl(&def_1AB14, v12, OS_LOG_TYPE_DEFAULT, "Successfully loaded local icon position data (%@): %{public}@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 138412290;
        id v17 = v6;
        _os_log_impl(&def_1AB14, v12, OS_LOG_TYPE_INFO, "Successfully loaded local icon position data (%@)", buf, 0xCu);
      }
    }
    goto LABEL_19;
  }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412290;
    id v17 = v6;
    _os_log_impl(&def_1AB14, v9, OS_LOG_TYPE_INFO, "Successfully loaded icon positions from dictionary with key:(%@)", buf, 0xCu);
  }
LABEL_20:
...
- (void)positionsChanged
{
  ...
  if (os_log_type_enabled(v4, v5))
  {
    ...
    int v8 = 138543362;
    id v9 = v6;
    _os_log_impl(&def_1AB14, v4, v5, "icon positions changed: %{public}@", (uint8_t *)&v8, 0xCu);
  }
                ...
                if (v18)
                {
                  ...
                  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
                  {
                    ...
                    *(_DWORD *)buf = 138412290;
                    ...
                    _os_log_impl(&def_1AB14, v19, OS_LOG_TYPE_DEFAULT, "renamed old icon positions to: %@", buf, 0xCu);
                  }
                }
                else
                {
          ...
          if (v21)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138412290;
              ...
              _os_log_impl(&def_1AB14, v22, OS_LOG_TYPE_DEFAULT, "wrote icon poitions to file:%@", buf, 0xCu);
            }
          }
          else
          {
