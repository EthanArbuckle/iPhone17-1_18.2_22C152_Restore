  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 136446210;
      v19 = v14;
      _os_log_impl(&def_1A578, v13, OS_LOG_TYPE_INFO, "initial icon positions %{public}sloaded", buf, 0xCu);
    }

    v15 = sub_1EE90(@"CSL_LAYOUT_NAV_TITLE");
...
- (void)viewDidLoad
{
  ...
  if (MGGetBoolAnswer())
  {
    ...
    v4 = sub_1EE90(@"CSL_LAYOUT_INTERNAL_RESET_BUTTON");
...
- (void)updatedIconGraph:(id)a3
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v13 = 0;
      _os_log_impl(&def_1A578, v10, OS_LOG_TYPE_INFO, "spinner started", v13, 2u);
    }
...
- (void)showConfirmationAlert
{
  uint64_t v3 = sub_1EE90(@"RESET_GRID_VIEW_ARRANGEMENT_ALERT_TITLE");
  double v4 = sub_1EE90(@"RESET_GRID_VIEW_ARRANGEMENT_ALERT_MESSAGE");
  double v5 = +[UIAlertController alertControllerWithTitle:v3 message:v4 preferredStyle:1];

  double v6 = sub_1EE90(@"RESET_GRID_VIEW_ARRANGEMENT_ALERT_PRIMARY_ACTION");
  ...
  id v8 = sub_1EE90(@"RESET_GRID_VIEW_ARRANGEMENT_ALERT_CANCEL");
