void sub_50D8(_Unwind_Exception *a1)
{
  void *v1;
  void *v2;
...
void sub_5260(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_532C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
void sub_547C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_54FC(uint64_t a1)
{
  if (a1)
  {
    [*(id *)(a1 + 32) invalidate];
...
double sub_5820(void *a1, void *a2)
{
  id v3 = a2;
  if (a1)
  {
...
void sub_5888(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_5918(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_5E2C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

uint64_t sub_5E78(uint64_t result)
{
  if (result)
  {
...
double sub_5E98(uint64_t a1)
{
  if (a1)
  {
    ...
    double x = width * 0.5;
    if (sub_652C(a1) && (*(unsigned char *)(a1 + 8) & 0x80) != 0)
    {
      double v14 = 0.0;
    ...
    v20.f32[1] = v21;
    qword_45E40 = (uint64_t)vadd_f32(v20, (float32x2_t)0x4100000041000000);
    ...
    if (v3)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          id v6 = sub_65A4(a1, *(void **)(*((void *)&v7 + 1) + 8 * (void)v5));
          double v5 = (char *)v5 + 1;
        }
        while (v3 != v5);
        id v3 = [WeakRetained countByEnumeratingWithState:&v7 objects:v11 count:16];
...
void sub_6198(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_6220(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, objc_super a9)
{
  long long v10 = v9;
  a9.receiver = v10;
...
void sub_6250(void *a1)
{
}

void sub_63EC(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_6494(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_64C0(void *a1, double a2, double a3)
{
  if (!a1) {
    return 0;
  }
...
void sub_651C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
id sub_65A4(uint64_t a1, void *a2)
{
  id v3 = a2;
  uint64_t v4 = v3;
  if (a1)
...
void sub_6678(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_66A4(uint64_t a1, void *a2)
{
  id v3 = a2;
  if (a1)
  {
...
void sub_6718(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

id sub_6764(id *a1, uint64_t a2)
{
  id v2 = a1;
  if (a1)
  {
...
void sub_68E0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14)
{
  _Unwind_Resume(a1);
}
...
uint64_t sub_6E70(uint64_t result, uint64_t a2)
{
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v6; i = (char *)i + 1)
        {
          ...
          long long v9 = sub_65A4((uint64_t)a1, *(void **)(*((void *)&v13 + 1) + 8 * i));
...
void sub_7044(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_7090(uint64_t a1)
{
  sub_70FC(*(void **)(a1 + 32), *(void **)(*(void *)(*(void *)(a1 + 56) + 8) + 40));
  uint64_t v2 = sub_7240(*(void *)(a1 + 32), *(void **)(a1 + 40));
...
void sub_721C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_7240(uint64_t a1, void *a2)
{
  id v16 = a2;
  if (a1)
  {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138412290;
            CGRect v25 = v8;
            _os_log_error_impl(&def_1A578, v14, OS_LOG_TYPE_ERROR, "ERROR: no view for '%@'", buf, 0xCu);
          }
        }
        v5 |= v9;
      }
...
void sub_7508(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14)
{
  _Unwind_Resume(a1);
}

void sub_7588(id *a1, void *a2)
{
  id v3 = a2;
  id v4 = v3;
  if (a1)
...
void sub_783C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_7860(void *a1, uint64_t a2, void *a3)
{
  id v4 = a3;
  if (a1)
  {
...
void sub_791C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14)
{
  _Unwind_Resume(a1);
}

id sub_793C(id result)
{
  if (result)
  {
...
void sub_79B0(uint64_t a1)
{
}

void sub_7D28(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id *sub_7D58(id *result)
{
  if (result) {
...
uint64_t sub_7D70(uint64_t result)
{
  if (result) {
...
unint64_t sub_7D88(uint64_t a1, unint64_t a2)
{
  if (a1)
  {
    unint64_t v2 = a2;
...
void sub_7E28(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_7E38(uint64_t a1, void *a2)
{
  id v5 = a2;
...
void sub_7EC8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_7FE4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

id sub_80BC(uint64_t a1)
{
...
BOOL _isIconWithAttributesOnScreen(float32x2_t *a1)
{
  ...
  uint32x2_t v2 = (uint32x2_t)vcgt_f32(vabs_f32(*a1), vadd_f32((float32x2_t)vdup_laneq_s32(*(int32x4_t *)a1->f32, 2), (float32x2_t)qword_45E40));
  return vpmax_u32(v2, v2).i32[0] >= 0;
}

void sub_85D0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_8608(uint64_t a1, void *a2)
{
  id v3 = a2;
  if (a1) {
...
void sub_8658(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

id *sub_866C(id *result)
{
  if (result)
  {
    v1 = result;
...
void sub_88B8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_88CC(uint64_t a1, void *a2)
{
  id v25 = a2;
  if (a1)
  {
    switch((unint64_t)[v25 state])
    {
      case 1uLL:
        ...
        [*(id *)(a1 + 192) reset];
        *(double *)(a1 + 232) = sub_5820(v25, *(void **)(a1 + 16));
...
LABEL_7:
        sub_B5E0(a1, v16, v18 + -50.0, v19, v20);
        break;
      case 3uLL:
        sub_B028(a1);
        [v25 locationInView:a1];
...
void sub_8B18(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_8B6C(uint64_t a1, void *a2)
{
  id v4 = a2;
  if (a1)
  {
    ...
    if ((unint64_t)(v3 - 3) >= 3)
    {
      if (v3 == (unsigned char *)&def_1A578 + 1)
      {
        [*(id *)(a1 + 192) setState:4];
        [*(id *)(a1 + 192) reset];
        *(CGPoint *)(a1 + 128) = CGPointZero;
      }
      else if (v3 == (unsigned char *)&def_1A578 + 2)
      {
        sub_9B00(a1, v4);
      }
    }
...
void sub_8C44(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_8C5C(uint64_t a1, void *a2)
{
  id v4 = a2;
  double v5 = v4;
  if (a1)
...
void sub_8E28(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, void *a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, void *a20)
{
  _Unwind_Resume(a1);
}

id sub_8E68(uint64_t a1)
{
  return [*(id *)(a1 + 32) setAlpha:0.5];
}

void sub_8E74(uint64_t a1)
{
...
void sub_8F58(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14)
{
  _Unwind_Resume(a1);
}

id sub_8F6C(uint64_t a1)
{
  return [*(id *)(a1 + 32) setAlpha:1.0];
}

void sub_8F78(uint64_t a1, void *a2)
{
  id v3 = a2;
  if (a1)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v19 = 1024;
      int v20 = v8;
      _os_log_impl(&def_1A578, v4, OS_LOG_TYPE_DEFAULT, "Ending press state for reason:%{public}@ pressedIconNode:%{public}@ animating:%{BOOL}u isEditing:%{BOOL}u jiggling:%{BOOL}u", buf, 0x28u);
    }
...
void sub_9144(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_917C(uint64_t a1)
{
  return [*(id *)(*(void *)(a1 + 32) + 208) setAlpha:1.0];
}

void sub_9768(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_9850(void *a1, void *a2, double a3, double a4)
{
  id v9 = a2;
  if (a1 && ([v9 hex] || sub_652C((uint64_t)a1)))
  {
    unsigned int v7 = [v9 bundleIdentifier];
    int v8 = [a1 iconViewForBundleIdentifier:v7];

    if (v8) {
      sub_B760((uint64_t)a1, v8, v9, a3, a4 + -50.0);
    }
  }
}

void sub_9918(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_9A64(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_9A88(uint64_t a1)
{
  v1 = [*(id *)(a1 + 32) layer];
...
void sub_9AF0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_9B00(uint64_t a1, void *a2)
{
  id v11 = a2;
  if (a1)
  {
...
void sub_9BBC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_9DB4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

unint64_t sub_9DCC(void *a1, double a2, double a3)
{
  if (a1)
  {
    double v6 = [a1 layout];
    unint64_t v7 = sub_7D88((uint64_t)a1, (unint64_t)objc_msgSend(v6, "hexAtPoint:", a2, a3));
    unsigned __int8 v8 = sub_6764((id *)a1, v7);
    double v9 = v8;
    if (v8)
    {
      [v8 center];
...
LABEL_7:
      ...
      while (1)
      {
        ...
        long long v14 = sub_6764((id *)a1, __SPAIR64__(v18, HIDWORD(v17)));
...
void sub_9FD8(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_A010(int *a1@<X0>, std::string *a2@<X8>)
{
  sub_C3F4(&v25, "hex {");
  ...
  if ((v24.__r_.__value_.__r.__words[2] & 0x8000000000000000) == 0) {
    ...
    double v4 = (std::string *)v24.__r_.__value_.__r.__words[0];
  }
  if ((v24.__r_.__value_.__r.__words[2] & 0x8000000000000000) == 0) {
  ...
  double v6 = std::string::append(&v25, (const std::string::value_type *)v4, size);
  ...
  *(_OWORD *)&v26.__r_.__value_.__l.__data_ = v7;
  ...
  unint64_t v10 = std::string::append(&v26, (const std::string::value_type *)v8, v9);
  ...
  *(_OWORD *)&v27.__r_.__value_.__l.__data_ = v11;
  ...
  if ((v21.__r_.__value_.__r.__words[2] & 0x8000000000000000) == 0) {
    ...
    id v12 = (std::string *)v21.__r_.__value_.__r.__words[0];
  }
  if ((v21.__r_.__value_.__r.__words[2] & 0x8000000000000000) == 0) {
  ...
  long long v14 = std::string::append(&v27, (const std::string::value_type *)v12, v13);
  ...
  *(_OWORD *)&v28.__r_.__value_.__l.__data_ = v15;
  ...
  unsigned int v18 = std::string::append(&v28, (const std::string::value_type *)v16, v17);
  *a2 = *v18;
...
void sub_A2C8(uint64_t a1, float32x2_t a2, float32x2_t a3)
{
  if (a1)
  {
    ...
    if (sub_652C(a1))
    {
      std::string::size_type v9 = *(void **)(a1 + 376);
      if (v9)
      {
        [v9 configuration];
      }
        ...
        *(float32x2_t *)v10.f32 = vdiv_f32(vmul_f32(buf[1], vmul_f32(v32, vmaxnm_f32(vsub_f32(v22, buf[7]), 0))), (float32x2_t)vdup_lane_s32((int32x2_t)buf[6], 0));
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(float32x2_t *)((char *)&buf[6] + 6) = a3;
          ...
          _os_log_debug_impl(&def_1A578, v24, OS_LOG_TYPE_DEBUG, "inertial updater: setContentOffset:{%.4f, %.4f} rubberbanded from rawOffset:{%.4f, %.4f} from delta:{%.4f, %.4f} to originalOffset:{%.4f, %.4f} rubberBandVector:{%.4f, %.4f}", (uint8_t *)buf, 0x66u);
        }
        goto LABEL_17;
      }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(float32x2_t *)((char *)&buf[6] + 6) = *(float32x2_t *)&v5;
      _os_log_debug_impl(&def_1A578, v24, OS_LOG_TYPE_DEBUG, "inertial updater: setContentOffset:{%.4f, %.4f} from delta:{%.4f, %.4f} to originalOffset:{%.4f, %.4f}", (uint8_t *)buf, 0x3Eu);
    }
    double v25 = v8;
    double v26 = v7;
LABEL_17:

    sub_A6C4(a1, 0, v26, v25, v7, v8);
  }
}

void sub_A68C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_A6C4(uint64_t a1, int a2, double a3, double a4, double a5, double a6)
{
  if (a1)
  {
    if (a2)
    ...
    else
    {
      ...
      *(double *)(a1 + 120) = a6;
      ...
      if (!*(void *)(a1 + 320))
      {
        BOOL v7 = [*(id *)(a1 + 80) state] == (char *)&def_1A578 + 2;
...
void sub_A7C4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_A7F8(uint64_t a1, double a2, double a3)
{
  if (a1)
  {
    ...
    std::string::size_type v9 = *(void **)(a1 + 184);
    *(void *)(a1 + 184) = v8;
  }
}

id sub_A9D0(float32x2_t *a1, float a2)
{
  if (a2 >= 1.0) {
    float32x2_t v2 = a1[6];
  }
...
uint64_t sub_AA04(uint64_t a1, __n128 a2, __n128 a3)
{
  return sub_A6C4(*(void *)(a1 + 32), 0, a2, a3, a2.n128_f64[0], a3.n128_f64[0]);
}
...
void sub_AA90(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_AAA0(id *a1, uint64_t a2)
{
  if (a1)
  {
    id WeakRetained = objc_loadWeakRetained(a1 + 5);
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v15 = 1024;
        int v16 = HIDWORD(v6);
        _os_log_error_impl(&def_1A578, v7, OS_LOG_TYPE_ERROR, "ERROR: no icon at {%d,%d} (scrolling did not settle with icon centered) will use {%d,%d}", (uint8_t *)v10, 0x1Au);
      }
...
void sub_ADC0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_ADFC(uint64_t a1, CGFloat a2, CGFloat a3)
{
  if (!a1) {
    return;
  }
...
void sub_B018(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_B028(uint64_t a1)
{
  if (a1)
  {
    if (*(unsigned char *)(a1 + 168))
...
uint64_t sub_B090(uint64_t result, uint64_t a2)
{
  if (result)
  {
    uint64_t v3 = result;
      ...
      if (v11)
      {
        ...
        while (2)
        {
          for (i = 0; i != v11; i = (char *)i + 1)
          {
            ...
            std::string::size_type v17 = [v16 node];
            BOOL v18 = v15 == v17;
...
void sub_B404(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
void sub_B5E0(uint64_t a1, double a2, double a3, double a4, double a5)
{
  if (a1)
  {
    *(unsigned char *)(a1 + 256) = 1;
    ...
    if (!*(unsigned char *)(a1 + 168))
    {
      unint64_t v10 = (unint64_t)sub_64C0((void *)a1, a4 + *(double *)(a1 + 232), a5 + *(double *)(a1 + 240));
      if (v10 | HIDWORD(v10) || sub_652C(a1))
      {
...
void sub_B734(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_B760(uint64_t a1, void *a2, void *a3, double a4, double a5)
{
  id obj = a2;
  id v9 = a3;
  if (a1)
...
void sub_B854(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_BA0C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_BB14(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

double sub_BB28(uint64_t a1, void *a2)
{
  id v3 = a2;
  double v4 = v3;
  if (a1)
...
void sub_BB90(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_BC68(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

uint64_t sub_BC88(_DWORD *a1)
{
  if (a1[3] >= a1[2])
  {
    v7[0] = 0;
...
void sub_BF4C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_C0A4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void *sub_C3F4(void *a1, char *__s)
{
...
void sub_C4C0(const char *a1)
{
  exception = (std::logic_error *)__cxa_allocate_exception(0x10uLL);
  sub_C51C(exception, a1);
}

void sub_C508(_Unwind_Exception *a1)
{
  __cxa_free_exception(v1);
  _Unwind_Resume(a1);
}

std::logic_error *sub_C51C(std::logic_error *a1, const char *a2)
{
  double result = std::logic_error::logic_error(a1, a2);
  return result;
}

_DWORD *sub_C550(_DWORD *result, int a2, int a3)
{
  switch(a2)
  {
    case 0:
...
void sub_C6F8(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_CE50(uint64_t a1, void *a2)
{
...
uint64_t sub_CF7C(uint64_t result, uint64_t a2)
{
  if (a2) {
...
void sub_CF94(uint64_t a1, void *a2)
{
  id v3 = a2;
  if (v3)
  {
...
id CSLDiagnosticFilenameWithSuffix(void *a1, void *a2)
{
  id v3 = a2;
  id v4 = a1;
  id v5 = +[CSLDateLabelStringFormatCache sharedInstance];
  id v6 = +[NSDate date];
  id v7 = [v5 formatDateAsLongYMDHMSNoSpacesWithDate:v6];

  id v8 = [(__CFString *)v3 length];
  CFStringRef v9 = @".";
  CFStringRef v10 = &stru_3CFC8;
  if (!v8) {
    CFStringRef v9 = &stru_3CFC8;
  }
  if (v3) {
    CFStringRef v10 = v3;
  }
  double v11 = +[NSString stringWithFormat:@"%@-%@%@%@", v4, v7, v9, v10];
...
{
  return sub_D1CC(a1, 1);
}

id sub_D1CC(void *a1, int a2)
{
  id v3 = a1;
  id v4 = 0;
  if (os_variant_has_internal_diagnostics())
  {
    id v5 = +[NSString stringWithFormat:@"%@/Library/Logs/CrashReporter/DiagnosticLogs/Carousel", CPSharedResourcesDirectory()];
    ...
    id v10 = v9;
    double v11 = +[NSFileManager defaultManager];
    ...
    {
      double v14 = cslprf_diagnostics_log();
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR)) {
        sub_27458(v10, v14);
      }
...
CFStringRef NSStringFromCSLHexAppPlacementReason(uint64_t a1)
{
  if ((unint64_t)(a1 - 1) > 6) {
    ...
    return *(&off_3CB30 + a1 - 1);
  }
}

void sub_D460(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_D4E0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_D5A0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_D6EC(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_D760(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_DA14(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, void *a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,void *a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,void *a27,uint64_t a28,uint64_t a29,uint64_t a30,uint64_t a31,uint64_t a32,void *a33)
{
  _Unwind_Resume(a1);
}

id sub_DA78(uint64_t a1)
{
  return [*(id *)(a1 + 32) bundleIdentifier];
}

BOOL sub_DA80(uint64_t a1)
{
  uint64_t v1 = *(void *)(a1 + 32);
  id v2 = [*(id *)(a1 + 40) hex];
...
id sub_DB10(uint64_t a1)
{
  return [*(id *)(a1 + 32) directPlacementReason];
}

id sub_DB18(uint64_t a1)
{
  return [*(id *)(a1 + 32) placementReason];
}

void sub_DBA0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_DCD0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_DD3C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_DEAC(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_DFB0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}
...
void sub_E22C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_E4CC(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
void sub_E860(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_E8F0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_E924(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
void sub_E9A0(id a1)
{
  qword_45E48 = objc_alloc_init(CSLUICalendarIconSource);

  _objc_release_x1();
}

id sub_EBF4(uint64_t a1)
{
  return [*(id *)(a1 + 32) _updateCalendarIcon:1];
}

void sub_ECC4(uint64_t a1, void *a2)
{
  id v3 = a2;
...
void sub_EE50(id a1)
{
  ...
  id v2 = [v1 objectForKey:@"calendarIconOverrideDate"];

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    objc_storeStrong((id *)&qword_45E58, v2);
    id v3 = cslprf_icon_field_log();
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      int v4 = 138543618;
      uint64_t v5 = qword_45E58;
      __int16 v6 = 2114;
      CFStringRef v7 = @"calendarIconOverrideDate";
      _os_log_impl(&def_1A578, v3, OS_LOG_TYPE_DEFAULT, "_calendarOverrideDate: using override date %{public}@ from com.apple.Carousel:%{public}@", (uint8_t *)&v4, 0x16u);
    }
  }
}
...
{
  long long v21 = [a1 sortedArrayUsingComparator:&stru_3CD20];
  uint32x2_t v23 = +[NSMutableArray arrayWithCapacity:](NSMutableArray, "arrayWithCapacity:", [v21 count]);
  long long v26 = 0u;
  long long v27 = 0u;
  long long v24 = 0u;
  long long v25 = 0u;
  ...
  if (v1)
  {
    ...
    do
    {
      for (i = 0; i != v1; i = (char *)i + 1)
      {
        ...
        int v4 = *(void **)(*((void *)&v24 + 1) + 8 * i);
        uint64_t v5 = [v4 bundleIdentifier];
        BOOL v6 = [v5 componentsSeparatedByString:@"."];
        ...
        {
          unint64_t v7 = (char *)[v6 count];
          id v8 = [v6 objectAtIndexedSubscript:v7 - 1];
          ...
          if (v13)
          {
            double v14 = [v6 objectAtIndexedSubscript:v10];
          }
          else
          {
            uint64_t v15 = [v6 objectAtIndexedSubscript:v10 - 1];
            NSFileAttributeKey v16 = [v6 objectAtIndexedSubscript:v10];
            double v14 = +[NSString stringWithFormat:@"%@.%@", v15, v16];

            uint64_t v5 = (void *)v15;
          }
        }
        NSFileProtectionType v17 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@:%d,%d", v14, [v4 hex], (unint64_t)objc_msgSend(v4, "hex") >> 32);
        [v23 addObject:v17];
      }
      id v1 = [obj countByEnumeratingWithState:&v24 objects:v28 count:16];
    }
  ...
  BOOL v18 = [v23 componentsJoinedByString:@";"];
  id v19 = +[NSString stringWithFormat:@"{ %@ }", v18];

  return v19;
}

void sub_101CC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, void *a12, uint64_t a13, void *a14)
{
  _Unwind_Resume(a1);
}

void sub_104F4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, void *a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,void *a25,char a26)
{
  sub_18C64((uint64_t)&a26);
  _Unwind_Resume(a1);
}

id sub_10564(uint64_t a1)
{
  return [*(id *)(a1 + 32) isVerticalOnly];
}

id sub_1056C(uint64_t a1)
{
  return [*(id *)(a1 + 32) lastReorderReason];
}

id sub_10574(uint64_t a1)
{
  return [*(id *)(a1 + 32) isExactlyEqual:*(void *)(a1 + 40)];
}

void sub_10628(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_106D0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_10A10(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

uint64_t sub_10B68(unsigned int *a1)
{
  uint64_t v2 = *a1;
  int v1 = a1[1];
  if (v1 < -2 || (v1 + 3 + 2 * v2) >= 7)
...
uint64_t sub_10BCC(uint64_t a1)
{
  int v1 = *(_DWORD *)(a1 + 52);
  if (v1 >= *(_DWORD *)(a1 + 48))
  {
...
void sub_10FB4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_111B8(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_11274(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
uint64_t sub_1177C(uint64_t *a1)
{
  switch(*((_DWORD *)a1 + 3))
  {
    case 0:
...
LABEL_32:
        LOBYTE(v9[0]) = 1;
        uint64_t v8 = *a1;
        *(void *)((char *)v9 + 4) = *(void *)sub_C550(&v8, v1, 1);
      }
      else
      {
LABEL_29:
...
uint64_t sub_1198C(uint64_t *a1)
{
  int v1 = *((_DWORD *)a1 + 2);
  if (v1 < 6)
  {
    ...
    uint64_t v3 = *a1;
    *((_DWORD *)a1 + 2) = v1 + 1;
    *(void *)((char *)v4 + 4) = *(void *)sub_C550(&v3, v1, 1);
  }
  else
  {
    LOBYTE(v4[0]) = 0;
...
void sub_11AA8(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_11B74(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_11DD8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, void *__p, uint64_t a16)
{
  if (__p) {
    operator delete(__p);
  }
...
void sub_11F48(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_12B40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,void *a25,void *a26,void *a27)
{
  _Unwind_Resume(a1);
}

uint64_t sub_12CC4(uint64_t a1)
{
  int v1 = *(_DWORD *)(a1 + 16);
  if (v1 <= *(_DWORD *)(a1 + 20))
  {
    *(_DWORD *)(a1 + 16) = v1 + 1;
    ...
    uint64_t v7 = 0;
    *(void *)((char *)v8 + 4) = *(void *)sub_18D68(&v7, v3, v4, v5);
    char v2 = 1;
  }
  else
  {
...
void sub_13354(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, void *a15)
{
  _Unwind_Resume(a1);
}

uint64_t sub_13440(signed int *a1)
{
  int v1 = a1[1];
  if (v1 >= -2 && (v1 + 3 + 2 * *a1) < 7) {
    goto LABEL_12;
...
void sub_134CC(id *a1, void *a2, uint64_t a3, void *a4)
{
  uint64_t v11 = a3;
  id v6 = a2;
  id v7 = a4;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v16 = 2112;
    id v17 = v7;
    _os_log_debug_impl(&def_1A578, v8, OS_LOG_TYPE_DEBUG, "[343 move] move %@ -> %s; next:%@; ", buf, 0x20u);
...
void sub_13DF4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

uint64_t sub_13F4C(_DWORD *a1)
{
  int v2 = a1[6];
  if (!v2) {
    goto LABEL_8;
...
uint64_t sub_13FE4(uint64_t a1)
{
  v7[0] = 1;
  do
  {
...
void sub_14164(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_14430(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *a10)
{
  _Unwind_Resume(a1);
}
...
void sub_14988(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
void sub_15458(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_154D8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_15554(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_15C08(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void *a9, void *a10)
{
  _Unwind_Resume(a1);
}

void sub_15D80(uint64_t a1, uint64_t a2, void *a3)
{
  id v4 = a3;
...
void sub_15E14(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_15F08(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_16280(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
void sub_16304(uint64_t a1, void *a2)
{
  ...
  uint64_t v4 = *(void *)(a1 + 32);
  id v8 = [v3 hex];
  sub_19F30(v4 + 32, (int *)&v8, &v8, (uint64_t *)&v9);
...
void sub_163B0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *a10)
{
  id v13 = v12;
...
void sub_164B8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_16588(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_16640(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

int64_t sub_1665C(id a1, CSLHexAppNode *a2, CSLHexAppNode *a3)
{
  uint64_t v4 = a2;
  int v5 = a3;
...
void sub_16708(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_16778(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_168E0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_16CB0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, char a19, uint64_t a20,uint64_t a21,uint64_t a22,char a23,uint64_t a24,uint64_t a25,uint64_t a26,char a27,uint64_t a28,uint64_t a29,uint64_t a30,char a31)
{
...
void sub_16D44(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
  id v7 = a2;
  id v8 = a3;
  objc_opt_class();
      ...
      while (2)
      {
        for (i = 0; i != v10; i = (char *)i + 1)
        {
          ...
          *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = objc_opt_isKindOfClass() & 1;
          if (!*(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24))
          {
            long long v26 = cslprf_icon_field_log();
          ...
          *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = v14 == 0;
          ...
          if (!*(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24))
          {
            long long v27 = cslprf_icon_field_log();
          ...
          sub_19F30(*(void *)(a1 + 32) + 32, (int *)&v42, &v42, (uint64_t *)&__p);
          uint64_t v15 = *(void **)(*(void *)(a1 + 32) + 136);
...
LABEL_51:
  ...
  else
  {
    ...
    *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = objc_opt_isKindOfClass() & 1;
    ...
    id v18 = v7;
    id v19 = v8;
    *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = [v19 count] == (char *)&def_1A578 + 2;
    if (*(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24))
    {
      ...
      *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = objc_opt_respondsToSelector() & 1;
      if (*(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24))
      {
        ...
        *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = objc_opt_respondsToSelector() & 1;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
            {
              ...
              *(void *)&uint8_t buf[4] = v18;
              ...
              __int16 v50 = 2112;
              uint64_t v51 = v34;
              _os_log_error_impl(&def_1A578, log, OS_LOG_TYPE_ERROR, "invalid defaults (%@ %s repeated location from %@)", buf, 0x20u);
              if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
                operator delete(__p.__r_.__value_.__l.__data_);
              }
        ...
        {
          double v30 = cslprf_icon_field_log();
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            unsigned int v31 = objc_opt_class();
            sub_28530((uint64_t)v21, v31, (uint64_t)buf);
          }
      ...
      {
        CGFloat v28 = cslprf_icon_field_log();
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          CGFloat v29 = objc_opt_class();
          sub_28530((uint64_t)v20, v29, (uint64_t)buf);
        }
    ...
    {
      long long v25 = cslprf_icon_field_log();
...
void sub_17560(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, void *__p, uint64_t a14, int a15, __int16 a16, char a17, char a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,uint64_t a28)
{
  _Unwind_Resume(a1);
}

void sub_17700(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_177B8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void *a9)
{
  _Unwind_Resume(a1);
}

void sub_17D0C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13, void *a14, uint64_t a15, uint64_t a16, uint64_t a17, char a18)
{
  if (__p) {
    operator delete(__p);
  }
  ...
  sub_18C64((uint64_t)&a18);

  _Unwind_Resume(a1);
}

void sub_17DC8(void **a1, unint64_t a2)
{
  uint64_t v4 = a1[2];
...
void sub_18110(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, void *a14, void *__p, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  _Unwind_Resume(a1);
}

void sub_18498(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, void *__p, uint64_t a14, int a15, __int16 a16, char a17, char a18)
{
  _Unwind_Resume(a1);
}

int64_t sub_185F8(id a1, CSLHexAppNode *a2, CSLHexAppNode *a3)
{
  uint64_t v4 = a2;
  int64_t v5 = a3;
  Hex v6 = [(CSLHexAppNode *)v4 hex];
...
void sub_186A4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
uint64_t sub_18710(int a1, int a2, int a3)
{
  if (a2 < a1) {
    unsigned int v3 = 4;
  }
...
uint64_t sub_18778(uint64_t a1, int *a2, uint64_t a3)
{
  *(_OWORD *)a1 = 0u;
  *(_OWORD *)(a1 + 16) = 0u;
...
void sub_187DC(_Unwind_Exception *a1)
{
  sub_18C64(v1);
  _Unwind_Resume(a1);
}

void *sub_187F0(uint64_t a1, int *a2, void *a3)
{
  int v6 = *a2;
...
void sub_18A04(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

void sub_18A18(uint64_t a1, size_t __n)
{
  if (__n == 1)
  {
    size_t prime = 2;
...
void sub_18B08(uint64_t a1, unint64_t a2)
{
  if (a2)
  {
    if (a2 >> 61) {
...
uint64_t sub_18C64(uint64_t a1)
{
  int v2 = *(void **)(a1 + 16);
  if (v2)
  {
...
float sub_18CB0(uint64_t a1, unint64_t *a2, uint64_t *a3)
{
  unint64_t v3 = *a2;
  *(void *)a1 = *a2;
  uint64_t v9 = *a3;
...
_DWORD *sub_18D68(_DWORD *result, float a2, float a3, float a4)
{
  float v4 = roundf(a2);
  float v5 = roundf(a3);
  float v6 = roundf(a4);
...
uint64_t *sub_18DB8(uint64_t *a1, uint64_t a2, uint64_t a3)
{
  *a1 = a2;
  a1[1] = a3;
  a1[2] = a2;
  ...
  *((_DWORD *)a1 + 8) = 0;
  ...
  uint64_t v9 = sub_18F88((int)a3 - (int)a2, v7, HIDWORD(a3) - HIDWORD(a2));
  *((_DWORD *)a1 + 7) = v9;
  ...
  if ((HIDWORD(v9) - 6) < 6)
  {
    ...
    uint64_t v25 = *a1;
    uint64_t v16 = *(void *)sub_C550(&v25, v10, v14);
    uint64_t v25 = *a1;
    uint64_t v17 = *(void *)sub_C550(&v25, v11, v15);
    int v18 = sub_19028(a2, v16, 0);
    int v19 = sub_19028(v16, a3, 0);
    if (v19 >= v18) {
      int v20 = v18;
    }
    else {
    ...
    int v21 = sub_19028(a2, v17, 0);
    int v22 = sub_19028(v17, a3, 0);
    if (v22 >= v21) {
      int v23 = v21;
    }
    else {
...
uint64_t sub_18F88(int a1, int a2, int a3)
{
  if (a1 >= 0) {
    LODWORD(v3) = a1;
  }
...
uint64_t sub_19028(uint64_t a1, uint64_t a2, unint64_t a3)
{
  int v3 = a3;
  unint64_t v4 = HIDWORD(a3);
  uint64_t v5 = sub_19090(a1, a2, a3);
...
uint64_t sub_19090(uint64_t a1, uint64_t a2, uint64_t a3)
{
  uint64_t v11 = a1;
  ...
  else
  {
    ...
    if (v6 <= v5) {
      ...
      unsigned int v7 = (uint64_t *)sub_18D68(&v9, (float)(int)a1 + (float)((float)((float)v5 / (float)v6) * (float)(a2 - a1)), (float)(-(int)a1 - HIDWORD(a1)) + (float)((float)((float)v5 / (float)v6) * (float)-v3), (float)SHIDWORD(a1)+ (float)((float)((float)v5 / (float)v6) * (float)(HIDWORD(a2) - HIDWORD(a1))));
    }
  }
  return *v7;
}

uint64_t sub_19160(uint64_t a1, uint64_t a2)
{
  *(_OWORD *)a1 = 0u;
  *(_OWORD *)(a1 + 16) = 0u;
  *(_DWORD *)(a1 + 32) = *(_DWORD *)(a2 + 32);
  sub_18A18(a1, *(void *)(a2 + 8));
  for (i = *(int **)(a2 + 16); i; i = *(int **)i)
    sub_191D8(a1, i + 4, (_OWORD *)i + 1);
  return a1;
}

void sub_191C0(_Unwind_Exception *a1)
{
  sub_18C64(v1);
  _Unwind_Resume(a1);
}

void *sub_191D8(uint64_t a1, int *a2, _OWORD *a3)
{
  int v6 = *a2;
  unsigned int v7 = a2[1];
  unint64_t v8 = v7 | (*a2 << 16);
...
void sub_193EC(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

uint64_t *sub_19400(void *a1, int *a2)
{
  ...
  for (float result = *v8; result; float result = (uint64_t *)*result)
  {
...
uint64_t sub_194BC(void *a1, uint64_t *a2)
{
  uint64_t v2 = *a2;
  sub_19500(a1, a2, (uint64_t)&__p);
  int v3 = __p;
  std::string __p = 0;
  if (v3) {
    operator delete(v3);
...
void *sub_19500@<X0>(void *result@<X0>, void *a2@<X1>, uint64_t a3@<X8>)
{
...
uint64_t sub_19634(uint64_t a1, uint64_t a2)
{
  *(_OWORD *)a1 = 0u;
  *(_OWORD *)(a1 + 16) = 0u;
  *(_DWORD *)(a1 + 32) = *(_DWORD *)(a2 + 32);
  sub_18A18(a1, *(void *)(a2 + 8));
  for (i = *(int **)(a2 + 16); i; i = *(int **)i)
    sub_187F0(a1, i + 4, (void *)i + 2);
  return a1;
}

void sub_19694(_Unwind_Exception *a1)
{
  sub_18C64(v1);
  _Unwind_Resume(a1);
}
...
void *sub_196C4(uint64_t a1, unint64_t a2)
{
  if (a2 >> 61) {
    sub_186C4();
  }
...
char *sub_196FC(uint64_t a1, char *__src, void *a3, void *a4, uint64_t a5)
{
  uint8x8_t v5 = __src;
  if (a5 >= 1)
  {
    ...
    else
    {
      ...
      uint64_t v39 = v9;
      if (v17) {
        unint64_t v18 = (char *)sub_196C4(v9, v17);
      }
      else {
        unint64_t v18 = 0;
      }
      long long v24 = &v18[8 * v15];
      std::string __p = v18;
      long long v36 = v24;
      long long v38 = &v18[8 * v17];
      uint64_t v25 = 8 * a5;
      long long v26 = &v24[8 * a5];
      do
      {
        *(void *)long long v24 = v7[2];
        v24 += 8;
        unint64_t v7 = (void *)*v7;
        v25 -= 8;
      }
      while (v25);
      int v37 = v26;
      uint8x8_t v5 = sub_19960((void **)a1, (uint64_t)&__p, v5);
      if (v37 != v36) {
...
void sub_19928(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, uint64_t a12)
{
  if (__p) {
    operator delete(__p);
  }
...
char *sub_19960(void **a1, uint64_t a2, char *__src)
{
  uint8x8_t v5 = *(char **)(a2 + 8);
  uint8x8_t v6 = (char *)*a1;
  unint64_t v7 = v5;
  if (*a1 != __src)
  {
    unint64_t v8 = __src;
...
void *sub_19A90(uint64_t a1, int *a2, void *a3, _DWORD *a4)
{
  int v8 = *a2;
...
void sub_19CB8(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

void *sub_19CCC(uint64_t a1, int *a2, uint64_t a3, void **a4)
{
  int v7 = *a2;
...
void sub_19EE4(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

uint64_t *sub_19EF8(void *a1, int *a2)
{
  float result = sub_19400(a1, a2);
  if (result)
  {
    sub_194BC(a1, result);
    return (void *)(&def_1A578 + 1);
  }
  return result;
}

void *sub_19F30(uint64_t a1, int *a2, void *a3, uint64_t *a4)
{
  int v8 = *a2;
  unsigned int v9 = a2[1];
  unint64_t v10 = v9 | (*a2 << 16);
...
void sub_1A154(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

uint64_t sub_1A168(uint64_t result, uint64_t *a2, uint64_t a3, char a4)
{
          ...
          if (v5 || !v4)
          {
            switch(v13)
            {
              ...
              case 2:
                ...
                uint64_t v119 = *v9;
                uint64_t v120 = v53;
                int v54 = sub_1AE70((int *)&v120);
                float result = sub_1AE70((int *)&v119);
                if (v54 < (int)result)
                {
                  uint64_t v55 = *v9;
                  *unsigned int v9 = *(a2 - 1);
                ...
                break;
              case 3:
                float result = sub_1AB38(v9, v9 + 1, v10);
                break;
              case 4:
                float result = sub_1B040(v9, v9 + 1, v9 + 2, v10);
                break;
              case 5:
                float result = sub_1AA0C(v9, v9 + 1, v9 + 2, v9 + 3, v10);
                break;
              default:
                JUMPOUT(0);
            }
...
LABEL_75:
              ...
              do
              {
                ...
                if (v117 >= v68)
                {
                  ...
                  if (2 * v68 + 2 < v13)
                  {
                    ...
                    uint64_t v119 = v71[1];
                    uint64_t v120 = v72;
                    int v73 = sub_1AE70((int *)&v120);
                    int v74 = sub_1AE70((int *)&v119);
                    if (v73 < v74) {
                      ++v71;
                    }
                    a2 = v115;
                  ...
                  if (v77 >= (int)result)
                  {
                    ...
                    do
                    {
                      ...
                      if (2 * v70 + 2 < v13)
                      {
                        ...
                        uint64_t v119 = v71[1];
                        uint64_t v120 = v81;
                        int v82 = sub_1AE70((int *)&v120);
                        if (v82 < (int)sub_1AE70((int *)&v119))
                        {
                          ++v71;
          ...
          {
            sub_1AB38(v15, v9, v10);
          }
          else
          {
            sub_1AB38(v9, v15, v10);
            sub_1AB38(v9 + 1, v15 - 1, v116);
            sub_1AB38(v9 + 2, &v9[v14 + 1], v113);
            sub_1AB38(v15 - 1, v15, &v9[v14 + 1]);
            uint64_t v16 = *v9;
            *unsigned int v9 = *v15;
            *unint64_t v15 = v16;
          }
          ...
          uint64_t v119 = *v9;
          uint64_t v120 = v17;
          int v18 = sub_1AE70((int *)&v120);
          if (v18 < (int)sub_1AE70((int *)&v119)) {
            break;
          }
          uint64_t v38 = *v9;
          uint64_t v119 = *v10;
          uint64_t v120 = v38;
          int v39 = sub_1AE70((int *)&v120);
          float result = sub_1AE70((int *)&v119);
          if (v39 >= (int)result)
          {
            id v42 = v9 + 1;
          ...
          while (v11 < v44)
          {
            ...
            *long long v44 = v47;
            do
            {
              ...
              uint64_t v119 = v48;
              uint64_t v120 = v38;
              int v49 = sub_1AE70((int *)&v120);
            }
            while (v49 >= (int)sub_1AE70((int *)&v119));
            do
            {
              uint64_t v50 = *--v44;
              uint64_t v119 = v50;
              uint64_t v120 = v38;
              int v51 = sub_1AE70((int *)&v120);
              float result = sub_1AE70((int *)&v119);
            }
        ...
        do
        {
          ...
          uint64_t v119 = v20;
          uint64_t v120 = v21;
          int v22 = sub_1AE70((int *)&v120);
          ++v19;
        }
        while (v22 < (int)sub_1AE70((int *)&v119));
        size_t v23 = &v9[v19];
        uint64_t v24 = v115;
        BOOL v5 = v19 == 1;
        a2 = v115;
        if (v5)
        {
          ...
          do
          {
            ...
            uint64_t v119 = v20;
            uint64_t v120 = v27;
            int v28 = sub_1AE70((int *)&v120);
          }
          while (v28 >= (int)sub_1AE70((int *)&v119));
        }
        else
        {
          do
          {
            ...
            uint64_t v119 = v20;
            uint64_t v120 = v25;
            int v26 = sub_1AE70((int *)&v120);
          }
          while (v26 >= (int)sub_1AE70((int *)&v119));
        }
        if (v23 >= v24)
        {
          long long v36 = v23 - 1;
          ...
          do
          {
            ...
            *double v30 = v31;
            do
            {
              ...
              uint64_t v119 = v20;
              uint64_t v120 = v32;
              int v33 = sub_1AE70((int *)&v120);
            }
            while (v33 < (int)sub_1AE70((int *)&v119));
            do
            {
              uint64_t v34 = *--v30;
              uint64_t v119 = v20;
              uint64_t v120 = v34;
              int v35 = sub_1AE70((int *)&v120);
            }
            while (v35 >= (int)sub_1AE70((int *)&v119));
          }
          while (v29 < v30);
          long long v36 = v29 - 1;
          a2 = v115;
...
LABEL_33:
        float result = sub_1A168(v9, v36, a3, a4 & 1);
        a4 = 0;
        unint64_t v11 = v36 + 1;
      }
      BOOL v37 = sub_1AC7C(v9, v36);
      unint64_t v11 = v36 + 1;
      float result = sub_1AC7C(v36 + 1, a2);
      if (result) {
        break;
      }
      if (!v37) {
...
uint64_t sub_1AA0C(uint64_t *a1, uint64_t *a2, uint64_t *a3, uint64_t *a4, uint64_t *a5)
{
  sub_1B040(a1, a2, a3, a4);
  uint64_t v10 = *a5;
  uint64_t v23 = *a4;
  uint64_t v24 = v10;
  int v11 = sub_1AE70((int *)&v24);
  uint64_t result = sub_1AE70((int *)&v23);
  if (v11 < (int)result)
  {
    uint64_t v13 = *a4;
    *a4 = *a5;
...
uint64_t sub_1AB38(uint64_t *a1, uint64_t *a2, uint64_t *a3)
{
  uint64_t v6 = *a2;
  uint64_t v20 = *a1;
  uint64_t v21 = v6;
  int v7 = sub_1AE70((int *)&v21);
  int v8 = sub_1AE70((int *)&v20);
  uint64_t v9 = *a3;
  if (v7 >= v8)
  {
    uint64_t v20 = *a2;
    uint64_t v21 = v9;
    int v13 = sub_1AE70((int *)&v21);
    uint64_t result = sub_1AE70((int *)&v20);
    if (v13 < (int)result)
    {
      uint64_t v14 = *a2;
      *a2 = *a3;
...
BOOL sub_1AC7C(uint64_t *a1, uint64_t *a2)
{
  uint64_t v4 = a2 - a1;
  BOOL result = 1;
  switch(v4)
  {
    ...
    case 2:
      ...
      uint64_t v19 = *a1;
      uint64_t v20 = v6;
      int v7 = sub_1AE70((int *)&v20);
      if (v7 < (int)sub_1AE70((int *)&v19))
      {
        uint64_t v8 = *a1;
        *a1 = *(a2 - 1);
        *(a2 - 1) = v8;
      ...
      return 1;
    case 3:
      sub_1AB38(a1, a1 + 1, a2 - 1);
      return 1;
    case 4:
      sub_1B040(a1, a1 + 1, a1 + 2, a2 - 1);
      return 1;
    case 5:
      sub_1AA0C(a1, a1 + 1, a1 + 2, a1 + 3, a2 - 1);
      return 1;
    default:
      uint64_t v9 = a1 + 2;
      sub_1AB38(a1, a1 + 1, a1 + 2);
      int v10 = a1 + 3;
      if (a1 + 3 == a2) {
        return 1;
      }
  ...
  while (1)
  {
    ...
    uint64_t v19 = *v9;
    uint64_t v20 = v13;
    int v14 = sub_1AE70((int *)&v20);
    if (v14 < (int)sub_1AE70((int *)&v19))
    {
      uint64_t v15 = *v10;
      uint64_t v16 = v11;
      while (1)
      {
        *(uint64_t *)((char *)a1 + v16 + 24) = *(uint64_t *)((char *)a1 + v16 + 16);
        ...
        uint64_t v20 = v15;
        int v17 = sub_1AE70((int *)&v20);
        v16 -= 8;
        if (v17 >= (int)sub_1AE70((int *)&v19))
        {
...
uint64_t sub_1AE70(int *a1)
{
  ...
  switch(*a1)
  {
    case -3:
      ...
      return dword_2E970[v2];
    case -2:
      uint64_t v4 = a1[1];
      if (v4 < 4) {
        return dword_2E960[v4];
      }
      if (v4 != -1) {
        goto LABEL_27;
      }
...
uint64_t sub_1B040(uint64_t *a1, uint64_t *a2, uint64_t *a3, uint64_t *a4)
{
  sub_1AB38(a1, a2, a3);
  uint64_t v8 = *a4;
  uint64_t v18 = *a3;
  uint64_t v19 = v8;
  int v9 = sub_1AE70((int *)&v19);
  uint64_t result = sub_1AE70((int *)&v18);
  if (v9 < (int)result)
  {
    uint64_t v11 = *a3;
    *a3 = *a4;
...
void *sub_1B130(void *result, uint64_t a2, uint64_t a3, float a4)
{
  if (v4 >= 0) {
    int v5 = result;
  }
...
void sub_1B154(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint8_t *a5)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, a5, 0x16u);
}

void sub_1B1BC(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint8_t *a5)
{
  _os_log_debug_impl(a1, a2, OS_LOG_TYPE_DEBUG, a4, a5, 0xCu);
}

uint64_t sub_1B1D4(uint64_t result, uint64_t a2, uint64_t a3, float a4)
{
  *(float *)a3 = a4;
  *(_DWORD *)(a3 + 4) = result;
  *(_WORD *)(a3 + 8) = 2112;
...
id sub_1B1EC(uint64_t a1, void *a2, uint64_t a3, float a4)
{
  *(float *)a3 = a4;
  *(void *)(a3 + 4) = a1;
  *(_WORD *)(a3 + 12) = 2112;
...
void sub_1B228(void *a1, int a2, os_log_t log, const char *a4, uint8_t *a5)
{
  _os_log_error_impl(a1, log, OS_LOG_TYPE_ERROR, a4, a5, 0xCu);
}

void sub_1B250(void *a1, uint64_t a2, uint64_t a3, const char *a4)
{
  _os_log_error_impl(a1, v4, OS_LOG_TYPE_ERROR, a4, v5, 0x16u);
}

void sub_1B368(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_1B378(uint64_t a1, void *a2)
{
  return [a2 positionsChanged];
}

id sub_1B380(uint64_t a1, void *a2)
{
  return [a2 initialSyncComplete];
}

void sub_1B410(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1B49C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, objc_super a9)
{
...
void sub_1B534(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1D1B4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1D3A8(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1D8EC(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1DB18(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1DBC0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1DCB4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1DD7C(_Unwind_Exception *a1)
{
  uint64_t v4 = v3;
...
int64_t sub_1DDA8(id a1, CSLHexAppNode *a2, CSLHexAppNode *a3)
{
  uint64_t v4 = a2;
  uint64_t v5 = a3;
  Hex v6 = [(CSLHexAppNode *)v4 hex];
...
void sub_1DE54(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_1DE74(id a1, CSLHexAppNode *a2)
{
  int v2 = [(CSLHexAppNode *)a2 bundleIdentifier];

  return v2;
}

void sub_1DF30(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}
...
void sub_1E290(_Unwind_Exception *a1)
{
  int64_t v8 = v7;
...
void sub_1E418(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1E4F8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1E5A8(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1E6C4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1EB08(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, _Unwind_Exception *exception_object, void *a12, void *a13, void *a14)
{
  _Unwind_Resume(a1);
}

void sub_1EC90(void *a1, uint64_t a2, os_log_t log, const char *a4, ...)
{
  va_start(va, a4);
  _os_log_error_impl(a1, log, OS_LOG_TYPE_ERROR, a4, (uint8_t *)va, 0x16u);
}

void sub_1EE54(_Unwind_Exception *a1)
{
  uint64_t v5 = v4;
...
id sub_1EE90(void *a1)
{
  id v1 = a1;
  int v2 = +[NSBundle bundleForClass:objc_opt_class()];
  uint64_t v3 = [v2 localizedStringForKey:v1 value:&stru_3CFC8 table:@"CarouselLayoutSettings"];

  return v3;
}

void sub_1EF20(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1F2A0(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1F414(_Unwind_Exception *a1)
{
  uint64_t v4 = v3;
...
void sub_1F598(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1F7FC(_Unwind_Exception *a1)
{
  uint64_t v5 = v4;
...
void sub_1F92C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_1FADC(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

id sub_1FB34(uint64_t a1)
{
  return [*(id *)(a1 + 32) resetIconPositions];
}

void sub_1FC64(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_1FE90(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_2024C(_Unwind_Exception *a1)
{
  Hex v7 = v5;
...
void sub_20388(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_20430(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_20508(id a1)
{
  id v1 = objc_alloc_init(CSLDateLabelStringFormatCache);
  int v2 = (void *)qword_45E68;
  qword_45E68 = (uint64_t)v1;
...
void sub_2074C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
...
uint64_t sub_20764(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_20774(uint64_t a1)
{
}

void sub_2077C(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"cccc" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_20984(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2099C(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"EEEjmm" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_20BA4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_20BBC(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"yMd" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_20DC4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_20DDC(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"Md" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_20FE4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_20FFC(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"Mdjmm" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_21204(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2121C(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"MMMd" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_21424(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2143C(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"MMMdjmm" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_21644(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2165C(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setLocale:v10];
    int64_t v8 = *(void **)(*(void *)(*(void *)(a1 + 40) + 8) + 40);
    Hex v9 = +[NSDateFormatter dateFormatFromTemplate:@"EEEEMMMMd" options:0 locale:v10];
    [v8 setDateFormat:v9];
...
void sub_21864(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2187C(uint64_t a1)
{
        ...
        (v4 & 1) == 0))
  {
    ...
    *(void *)(v6 + 40) = v5;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setAMSymbol:&stru_3CFC8];
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setPMSymbol:&stru_3CFC8];
    [*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) setTimeStyle:1];
    objc_storeStrong((id *)(*(void *)(a1 + 32) + 160), *(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40));
  }
}

void sub_21A8C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_21C98(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_21EB8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_220D8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_222D0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_22504(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_22738(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2296C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_22BA0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_22D9C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_25384(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_255F4(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

__n128 sub_25604(void *a1, uint64_t a2)
{
  uint64_t v4 = a1[2];
  uint64_t v5 = a1[1];
...
void sub_25844(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_25B9C(_Unwind_Exception *a1)
{
  _Unwind_Resume(a1);
}

void sub_25DB8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_25E14(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  _Unwind_Resume(a1);
}

void sub_25EE0(void *a1)
{
  unint64_t v2 = a1[4];
  BOOL v3 = v2 >= 0x40;
  unint64_t v4 = v2 - 64;
...
LABEL_33:
    ...
    if ((unint64_t)v9 <= *a1)
    {
      ...
      uint64_t v34 = (char *)sub_196C4(v5, v33);
      int v35 = &v34[8 * (v33 >> 2)];
      BOOL v37 = &v34[8 * v36];
  ...
  if (v22 < v24 >> 3)
  {
    ...
    *(void *)&long long v54 = operator new(0x1000uLL);
    ...
    if ((unint64_t)v9 <= *a1)
    {
      ...
      uint64_t v34 = (char *)sub_196C4((uint64_t)(a1 + 3), v46);
      int v35 = &v34[8 * (v46 >> 2)];
      BOOL v37 = &v34[8 * v47];
...
LABEL_30:
  ...
  v56 = a1 + 3;
  *(void *)&long long v54 = sub_196C4((uint64_t)(a1 + 3), v25);
...
void sub_261AC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13)
{
  operator delete(v13);
  if (__p) {
    operator delete(__p);
...
void sub_261F8(void *a1, void *a2)
{
  ...
  if (v6 == v5)
  {
    ...
    if ((unint64_t)v7 <= *a1)
    {
      ...
      uint64_t v19 = (char *)sub_196C4(v4, v18);
...
void sub_26310(uint64_t a1, void *a2)
{
  ...
  if (v4 == *(char **)a1)
  {
    ...
    if (v8 >= v7)
    {
      ...
      uint64_t v13 = 2 * v12;
      uint64_t v14 = (char *)sub_196C4(v6, v12);
...
void sub_26430(void *a1, void *a2)
{
  ...
  if (v4 == (char *)a1[3])
  {
    ...
    if ((unint64_t)v5 <= *a1)
    {
      ...
      uint64_t v17 = (char *)sub_196C4(a1[4], v16);
...
void sub_26548(uint64_t a1, void *a2)
{
  uint64_t v4 = *(char **)(a1 + 8);
  if (v4 == *(char **)a1)
  {
    ...
    if (v6 >= v7)
    {
      ...
      uint64_t v12 = 2 * v11;
      uint64_t v13 = (char *)sub_196C4(*(void *)(a1 + 32), v11);
...
uint64_t sub_26664(void *a1, unint64_t *a2)
{
  ...
  *uint64_t v4 = 0;
  ...
  return sub_266D0(a1, (uint64_t)v4);
}
...
uint64_t sub_266D0(void *a1, uint64_t a2)
{
  uint64_t v4 = (_DWORD *)(a2 + 16);
  unint64_t v5 = (*(_DWORD *)(a2 + 20) | (*(_DWORD *)(a2 + 16) << 16));
  *(void *)(a2 + 8) = v5;
  uint64_t v6 = (void *)sub_26720((uint64_t)a1, v5, v4);
  sub_2687C(a1, (void *)a2, v6);
  return a2;
}

uint64_t sub_26720(uint64_t a1, unint64_t a2, _DWORD *a3)
{
...
void *sub_2687C(void *result, void *a2, void *a3)
{
  int8x8_t v3 = (int8x8_t)result[1];
  unint64_t v4 = a2[1];
  uint8x8_t v5 = (uint8x8_t)vcnt_s8(v3);
...
void sub_26964(uint64_t a1, size_t __n)
{
  if (__n == 1)
  {
    size_t prime = 2;
...
void sub_26A54(uint64_t a1, unint64_t a2)
{
  if (a2)
  {
    if (a2 >> 61) {
...
uint64_t sub_26BCC(uint64_t a1, int a2)
{
  unint64_t v2 = *(void *)(a1 + 32);
  if (v2 < 0x40) {
    a2 = 1;
...
LABEL_9:
  ...
  return sub_26CD4((uint64_t)a1);
}

uint64_t sub_26CD4(uint64_t a1)
{
...
void sub_272BC(char a1, NSObject *a2)
{
  v2[0] = 67109120;
  v2[1] = a1 & 1;
  _os_log_debug_impl(&def_1A578, a2, OS_LOG_TYPE_DEBUG, "CSLUIFieldOfIconsView gesture recognizers enabled: %{BOOL}u", (uint8_t *)v2, 8u);
}

void sub_27338(uint64_t a1)
{
  uint64_t v1 = *(void *)(*(void *)(a1 + 48) + 64);
  int v2 = 138412290;
  uint64_t v3 = v1;
  _os_log_error_impl(&def_1A578, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "ERROR: failed to find icon for %@", (uint8_t *)&v2, 0xCu);
}

void sub_273C8(uint64_t a1)
{
...
void sub_27458(void *a1, NSObject *a2)
{
  uint64_t v3 = [a1 path];
  int v4 = 138412290;
  unint64_t v5 = v3;
  _os_log_error_impl(&def_1A578, a2, OS_LOG_TYPE_ERROR, "Failed to create diagnostic log, could not create directory: \"%@\"", (uint8_t *)&v4, 0xCu);
}

void sub_274F0()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "%@ not dictionary", v2, v3, v4, v5, v6);
}

void sub_27558()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "could not find bundle in %@", v2, v3, v4, v5, v6);
}

void sub_275C0()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "could not find hex coordinates in %@", v2, v3, v4, v5, v6);
}

void sub_27628()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "could not find hex in %@", v2, v3, v4, v5, v6);
}
...
void sub_27690()
{
  ...
  *(void *)(v1 + 4) = v2;
  sub_1B228(&def_1A578, v1, v3, "invalid nodes: %@", v4);
}

void sub_276D8()
{
  sub_1B210();
  sub_1B154(&def_1A578, v0, (uint64_t)v0, "cannot add %@ already have node with same bundle: %@", v1);
}
...
void sub_27748()
{
  ...
  __int16 v3 = 2112;
  uint64_t v4 = v0;
  sub_1B154(&def_1A578, v1, (uint64_t)v1, "cannot add %@ already have node at that location: %@", v2);
}

void sub_277C8(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&def_1A578, log, OS_LOG_TYPE_ERROR, "node not found - cannot remove", v1, 2u);
}

void sub_2780C()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "%@ is at zero", v2, v3, v4, v5, v6);
}

void sub_27874(uint64_t a1, NSObject *a2, uint64_t a3)
{
  uint64_t v3 = *(void *)(a1 + 24);
  int v4 = 138412290;
  uint64_t v5 = v3;
  sub_1B1BC(&def_1A578, a2, a3, "removed %@", (uint8_t *)&v4);
}
...
void sub_278E8()
{
  ...
  *(void *)(v2 + 4) = v8;
  sub_1B1BC(&def_1A578, v3, (uint64_t)v3, "[collapse] %s has no further occupied hexes", v4);
  if (*(char *)(v0 + 23) < 0) {
...
void sub_27944()
{
  ...
  *(_DWORD *)uint64_t v2 = 136315138;
  *(void *)(v2 + 4) = v8;
  sub_1B1BC(&def_1A578, v3, (uint64_t)v3, "[collapse] %s start", v4);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
{
  sub_1B184();
  sub_1B1D4(v1, v2, v3, 1.5047e-36);
  _os_log_debug_impl(&def_1A578, v5, OS_LOG_TYPE_DEBUG, "changed count:%d (delegate=%@)", v4, 0x12u);
}

void sub_279F8()
{
  sub_1B194();
  sub_1B130(v1, v2, v3, 4.8151e-34);
  sub_1B154(&def_1A578, v6, v4, "%s or %@ is zero", v5);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
void sub_27A4C()
{
  sub_1B184();
  sub_1B1D4(v1, v2, v3, 1.5047e-36);
  _os_log_debug_impl(&def_1A578, v5, OS_LOG_TYPE_DEBUG, "[_changedNodes count] %d (delegate=%@)", v4, 0x12u);
}

void sub_27A9C()
{
  sub_E940();
  sub_1B1BC(&def_1A578, v0, v1, "[lonely?] add %@ (final)", v2);
}

void sub_27B08()
{
  sub_E940();
  sub_1B1BC(&def_1A578, v0, v1, "[lonely?] add %@", v2);
}
...
void sub_27B74()
{
  ...
  *(_WORD *)(v3 + 12) = 2080;
  *(void *)(v3 + 14) = v6;
  _os_log_debug_impl(&def_1A578, v5, OS_LOG_TYPE_DEBUG, "[unoccupied] move %@ -> %s", v4, 0x16u);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
void sub_27BF0()
{
  ...
  *(_DWORD *)uint64_t v2 = 136315138;
  *(void *)(v2 + 4) = v8;
  sub_1B1BC(&def_1A578, v3, (uint64_t)v3, "[push up] found empty: %s", v4);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
void sub_27C4C()
{
  ...
  *(_DWORD *)uint64_t v1 = 138412290;
  *(void *)(v1 + 4) = v2;
  sub_1B228(&def_1A578, v1, v3, "failed integrity check: %@ will not change", v4);
}

void sub_27C94()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "duplicate %@", v2, v3, v4, v5, v6);
}

void sub_27CFC()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "disconnected %@", v2, v3, v4, v5, v6);
}
...
void sub_27D64()
{
  ...
  *(_WORD *)(v2 + 12) = 2048;
  *(void *)(v2 + 14) = v3;
  sub_1B154(&def_1A578, v5, v3, "no node at hex:%s remainingNodes:%ld", v4);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
{
  sub_1B210();
  sub_1B154(&def_1A578, v0, (uint64_t)v0, "nodes do not match %@ or %@", v1);
}
...
void sub_27E4C()
{
  sub_1B194();
  sub_1B130(v1, v2, v3, 4.8151e-34);
  sub_1B154(&def_1A578, v6, v4, "hexes do not match %s or %@", v5);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
void sub_27EA0()
{
  sub_1B194();
  sub_1B130(v1, v2, v3, 4.8151e-34);
  sub_1B154(&def_1A578, v6, v4, "hex not valid for vertical only:%s node:%@", v5);
  if (*(char *)(v0 + 23) < 0) {
    operator delete(*(void **)v0);
  }
}
...
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "extra (bundle index) %@", v2, v3, v4, v5, v6);
}
...
void sub_27F5C()
{
  ...
  *(_WORD *)(v1 + 8) = 2112;
  *(void *)(v1 + 10) = v3;
  _os_log_error_impl(&def_1A578, v5, OS_LOG_TYPE_ERROR, "invalid icon positions (%d), intialization failed: %@", v4, 0x12u);
}

void sub_27FC0()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "invalid icon position (%@)", v2, v3, v4, v5, v6);
}

void sub_28028(int a1, NSObject *a2)
{
  v2[0] = 67109376;
  v2[1] = a1;
  __int16 v3 = 1024;
  int v4 = 1;
  _os_log_error_impl(&def_1A578, a2, OS_LOG_TYPE_ERROR, "invalid version (%d > %d)", (uint8_t *)v2, 0xEu);
}

void sub_280B0(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&def_1A578, log, OS_LOG_TYPE_ERROR, "invalid icon plist, resetting to default", v1, 2u);
}

void sub_280F4(uint64_t *a1, uint64_t a2, NSObject *a3)
{
  uint64_t v3 = *a1;
  ...
  __int16 v7 = 2048;
  uint64_t v8 = v4;
  sub_1B154(&def_1A578, a3, (uint64_t)a3, "invalid nodes count (%ld != %ld)", (uint8_t *)&v5);
}

void sub_28180(uint64_t a1, uint64_t a2, uint64_t a3, NSObject *a4)
{
  *(_DWORD *)a1 = 134218240;
  *(void *)(a1 + 4) = a2;
  *(_WORD *)(a1 + 12) = 2048;
  *(void *)(a1 + 14) = a3;
  sub_1B154(&def_1A578, a4, a3, "invalid count (%ld != %ld)", (uint8_t *)a1);
}

void sub_281D0()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "invalid defaults (key %@ not string)", v2, v3, v4, v5, v6);
}
...
void sub_28238()
{
  v2[0] = 138412546;
  sub_1B1A8();
  sub_1B154(&def_1A578, v0, v1, "invalid defaults (%@:%@ not BOOLean)", (uint8_t *)v2);
}
...
void sub_282B0()
{
  v2[0] = 138412546;
  sub_1B1A8();
  sub_1B154(&def_1A578, v0, v1, "invalid defaults (%@:%@ not integer)", (uint8_t *)v2);
}
...
void sub_28328()
{
  v2[0] = 138412546;
  sub_1B1A8();
  sub_1B154(&def_1A578, v0, v1, "invalid defaults (%@:%@ not array)", (uint8_t *)v2);
}

void sub_283A0()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "invalid defaults (%@ not dictionary)", v2, v3, v4, v5, v6);
}
...
void sub_28408()
{
  ...
  *(_WORD *)(v1 + 12) = 2112;
  *(void *)(v1 + 14) = v3;
  sub_1B154(&def_1A578, v5, v1, "invalid defaults (node %@ repeated location from %@)", v4);
}

void sub_28460()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "invalid defaults (%@ not array)", v2, v3, v4, v5, v6);
}

void sub_284C8()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "invalid defaults (%@ count not 2)", v2, v3, v4, v5, v6);
}

void sub_28530(uint64_t a1, void *a2, uint64_t a3)
{
  id v3 = sub_1B1EC(a1, a2, a3, 5.778e-34);
  sub_1B250(&def_1A578, v4, v5, "invalid defaults (%@:%@ not have intValue)");
}
...
void sub_28584()
{
  ...
  *(_DWORD *)uint64_t v1 = 138412290;
  *(void *)(v1 + 4) = v2;
  sub_1B228(&def_1A578, v1, v3, "[343 collapse] failed to find all nodes (likely non-valid nodes) exist: %@", v4);
}

void sub_285CC(uint64_t a1, NSObject *a2)
{
  int v2 = 138412546;
  uint64_t v3 = a1;
  __int16 v4 = 2112;
  CFStringRef v5 = @"plist";
  _os_log_error_impl(&def_1A578, a2, OS_LOG_TYPE_ERROR, "failed to find default icon position plist: %@.%@", (uint8_t *)&v2, 0x16u);
}

void sub_28658()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "failed to read default icon position plist: %@", v2, v3, v4, v5, v6);
}

void sub_286C0()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "failed to parse default icon position plist: %@", v2, v3, v4, v5, v6);
}

void sub_28728(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&def_1A578, log, OS_LOG_TYPE_ERROR, "failed to unarchive default icon position plist", v1, 2u);
}

void sub_2876C()
{
  sub_1B210();
  sub_1EC90(&def_1A578, v0, v1, "Failed to load local icon position data for key %@ with error %@");
}

void sub_287D4()
{
  sub_1B210();
  sub_1EC90(&def_1A578, v0, v1, "Failed to create icon graph for key %@ with dictionary %@");
}

void sub_2883C()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "could not write icon positions plist: %@", v2, v3, v4, v5, v6);
}

void sub_288A4()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "could not rename old icon positions file %@", v2, v3, v4, v5, v6);
}

void sub_2890C()
{
  sub_E940();
  sub_E924(&def_1A578, v0, v1, "could not get file attributes %@", v2, v3, v4, v5, v6);
}

void sub_28974(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_debug_impl(&def_1A578, log, OS_LOG_TYPE_DEBUG, "Created CSLDateLabelStringFormatCache", v1, 2u);
}

void sub_289B8(os_log_t log, double a2, double a3)
{
  int v3 = 134218240;
  double v4 = a2;
  __int16 v5 = 2048;
  double v6 = a3;
  _os_log_debug_impl(&def_1A578, log, OS_LOG_TYPE_DEBUG, "inertial updater: scrolledWithDelta:{%.4f, %.4f}", (uint8_t *)&v3, 0x16u);
}
