...
- (void)setPressedHex:(Hex)a3
{
  ...
  *(CFTimeInterval *)v14 = v5;
  ...
  sub_25604(&self->_pressStates.__map_.__first_, (uint64_t)v14);
  sub_26664(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, (unint64_t *)&v18);
  *(Hex *)&v12[0] = v18;
  *(_OWORD *)((char *)v12 + 8) = xmmword_2EA20;
  *((Hex *)&v12[1] + 1) = v18;
  int v13 = 0;
  uint64_t v10 = sub_BC88(v12);
  for (LODWORD(v11) = v8; (_BYTE)v10; LODWORD(v11) = v9)
  {
    sub_26664(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, (unint64_t *)((char *)&v10 + 4));
    uint64_t v10 = sub_BC88(v12);
  }
  [(CSLPressStateApplier *)self _updateDisplayLink];
}
...
{
  Hex v4 = a3;
  return sub_19400(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v4) != 0;
}
...
- ($153C3A5BC4E016D58A1B9CA554FFC462)_interpolateBetweenSourceAttributes:(id)a3 targetAttributes:(id)a4 pressState:(id *)a5
{
  ...
  else
  {
    ...
    else
    {
      ...
      long long v29 = v18;
      int v8 = ($69C478705102945B5DF5F86862DF402F *)v5;
    }
...
- (void)cleanupAfterLayout
{
  if (self->_pressStates.__size_.__value_)
  {
    ...
    do
    {
      ...
      uint64_t v6 = v3 + (v4 << 6);
      unint64_t v7 = sub_19400(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, (int *)(v6 + 8));
      sub_194BC(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, v7);
      uint64_t v12 = *(void *)(v6 + 8);
      long long v13 = xmmword_2EA20;
      uint64_t v14 = v12;
      int v15 = 0;
      *(void *)&v11[4] = 0;
      while (1)
      {
        *(void *)int v11 = sub_BC88(&v12);
        *(_DWORD *)&v11[8] = v8;
        if (!v11[0]) {
          break;
        }
        int v9 = sub_19400(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, (int *)&v11[4]);
        sub_194BC(&self->_pressedHexes.__table_.__bucket_list_.__ptr_.__value_, v9);
      }
      *(int64x2_t *)&self->_pressStates.__start_ = vaddq_s64(*(int64x2_t *)&self->_pressStates.__start_, (int64x2_t)xmmword_2EA30);
      sub_26BCC((uint64_t)&self->_pressStates, 1);
    }
...
- (void).cxx_destruct
{
  ...
  sub_18C64((uint64_t)&self->_pressedHexes);
  sub_26C2C(&self->_pressStates.__map_.__first_);
