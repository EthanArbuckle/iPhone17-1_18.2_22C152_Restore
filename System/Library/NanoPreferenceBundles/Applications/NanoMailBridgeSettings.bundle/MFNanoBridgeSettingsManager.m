...
{
  if (qword_34768 != -1) {
    dispatch_once(&qword_34768, &stru_2C9D8);
  }
  v2 = (void *)qword_34760;

  return (MFNanoBridgeSettingsManager *)v2;
}
...
- (MFNanoBridgeSettingsManager)init
{
  if (MFDeviceSupportsNanoCompanion())
  {
    ...
    if (v3)
    {
      ...
      v10 = (NPSManager *)objc_alloc_init(off_345E0());
...
- (id)_signature
{
  ...
  else
  {
    ...
    id v7 = off_34650();
    id v5 = [v6 localizedStringForKey:v7 value:&stru_2CC10 table:@"NanoMailKit"];
  }
...
- (id)domainAccessor
{
  ...
  if (!domainAccessor)
  {
    id v4 = (NPSDomainAccessor *)[objc_alloc(off_34688()) initWithDomain:@"com.apple.NanoMail"];
