...
+ (id)nano_bridgeSettingsInboxesFromAccounts:(id)a3
{
  id v3 = objc_msgSend(a3, "ef_map:", &stru_2C738);
  v4 = objc_msgSend(v3, "ef_filter:", &stru_2C778);
...
+ (id)accountImageForAccounts:(id)a3
{
  ...
  if ((unint64_t)[v3 count] <= 1)
  {
    ...
    if (!qword_34708)
    {
      ...
      uint64_t v7 = (void *)qword_34708;
      qword_34708 = (uint64_t)v6;
    }
    v8 = [v5 iconString];
    v4 = [(id)qword_34708 objectForKey:v8];
    if (!v4)
    {
      if (!qword_34710)
      {
        uint64_t v9 = +[NSBundle bundleForClass:objc_opt_class()];
        v10 = (void *)qword_34710;
        qword_34710 = v9;
      }
      ...
      [(id)qword_34708 setObject:v4 forKey:v8];
    }
