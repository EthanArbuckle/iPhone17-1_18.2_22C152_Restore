...
- (id)foundInDescriptionIncludingAccount:(BOOL)a3
{
  ...
  uint64_t v7 = [v6 localizedStringForKey:@"MAILBOX_SUFFIX" value:&stru_2CC10 table:@"Main"];
  if ([v5 hasSuffix:v7])
  {
    int v8 = 1;
  }
  else
  {
    ...
    v10 = [v9 localizedStringForKey:@"BOX_SUFFIX" value:&stru_2CC10 table:@"Main"];
    if ([v5 hasSuffix:v10])
    {
      int v8 = 1;
    }
    else
    {
      ...
      v12 = [v11 localizedStringForKey:@"FOLDER_SUFFIX" value:&stru_2CC10 table:@"Main"];
