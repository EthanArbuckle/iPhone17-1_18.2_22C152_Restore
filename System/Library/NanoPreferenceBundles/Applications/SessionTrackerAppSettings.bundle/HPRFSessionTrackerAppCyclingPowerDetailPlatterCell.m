...
- (HPRFSessionTrackerAppCyclingPowerDetailPlatterCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  id v8 = a5;
  v110.receiver = self;
  v110.super_class = (Class)HPRFSessionTrackerAppCyclingPowerDetailPlatterCell;
  ...
  if (v9)
  {
    ...
    id v36 = objc_alloc_init((Class)UILabel);
    ...
    v104 = [v105 layoutMarginsGuide];
    v102 = [v104 topAnchor];
    v101 = [v103 constraintEqualToAnchor:v102 constant:16.0];
    v111[0] = v101;
