...
{
  v12.receiver = self;
  v12.super_class = (Class)EnvironmentTableCell;
...
{
  v9.receiver = self;
  v9.super_class = (Class)EnvironmentTableCell;
  id v4 = a3;
  [(EnvironmentTableCell *)&v9 refreshCellContentsWithSpecifier:v4];
  v5 = objc_msgSend(v4, "propertyForKey:", @"EDSpecifierTitleKey", v9.receiver, v9.super_class);
