...
- (MPArtworkCatalog)artworkCatalog
{
  ...
  id v4 = objc_alloc((Class)NMTPodcastsArtworkToken);
  v5 = [(MTPodcast *)self uuid];
  id v6 = [v4 initWithKey:v5 backgroundColorString:v3];

  if (os_feature_enabled_image_provider_on_watch()) {
    +[PUIObjCArtworkProvider uiShared];
  }
  else {
  v7 = +[NMTPodcastsArtworkDataSource uuidSharedDataSource];
  }
  id v8 = [objc_alloc((Class)MPArtworkCatalog) initWithToken:v6 dataSource:v7];

  return (MPArtworkCatalog *)v8;
}
...
- (void)setModifiedDate:(double)a3
{
  double v5 = +[_TtC18PodcastsFoundation17FutureDateChecker lenientSharedInstance];
  ...
  if ([(MTPodcast *)self showTypeSetting] != (id)a3)
  {
    ...
    if (v5)
    {
      if (v7)
      {
        ...
        __int16 v22 = 2114;
        v23 = v11;
        _os_log_impl(&dword_0, v6, OS_LOG_TYPE_DEFAULT, "Switching show type setting to %{public}lld, show \"%{private}@\", %{private}@, %{private}lld, %{public}@", (uint8_t *)&v14, 0x34u);
      }
    ...
    else
    {
      ...
      {
        LOWORD(v14) = 0;
        _os_log_impl(&dword_0, v6, OS_LOG_TYPE_DEFAULT, "WARNING: Ignoring attempt to set an invalid show type", (uint8_t *)&v14, 2u);
      }
    }
  }
}
...
- (void)setSortAscending:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v22 = 2114;
    v23 = v10;
    _os_log_impl(&dword_0, v5, OS_LOG_TYPE_DEFAULT, "Switching SortAscendingFlag to %{public}@, show \"%{private}@\", %{private}@, %{private}lld, %{public}@", (uint8_t *)&v14, 0x34u);
  }
  ...
  if (((((v11 & 2) == 0) ^ v3) & 1) == 0)
  {
    ...
    objc_msgSend(v13, "markSubscriptionSyncDirty:for:", 1, -[MTPodcast syncType](self, "syncType"));
  }
}
...
+ (id)allPossibleEpisodeListSortOrderProperties
{
  ...
  CFStringRef v15 = objc_msgSend(v20, "mt_compactMap:", &stru_1C920);
...
- (void)setPlaybackNewestToOldest:(BOOL)a3
{
  ...
  if (((((v6 & 8) == 0) ^ v3) & 1) == 0)
  {
    ...
    [(MTPodcast *)self markPlaylistsForUpdate];
    uint64_t v8 = +[_TtC18PodcastsFoundation18SyncKeysRepository shared];
...
- (id)seasonTrailerInSeason:(int64_t)a3
{
  ...
  uint64_t v21 = sub_A3E8;
  __int16 v22 = sub_A3F8;
  id v23 = 0;
  id v6 = [(MTPodcast *)self managedObjectContext];
...
+ (id)sortDescriptorsForSortType:(int64_t)a3
{
  ...
  {
    case 0:
      uint64_t v3 = +[MTPodcast sortDescriptorsForManualOrder];
      break;
    case 1:
      uint64_t v4 = 0;
      goto LABEL_5;
    case 2:
      uint64_t v4 = 1;
LABEL_5:
      uint64_t v3 = +[MTPodcast sortDescriptorsForDateAddedAscending:v4];
      break;
    case 4:
      uint64_t v5 = 0;
      goto LABEL_8;
    ...
    case 6:
      uint64_t v6 = 1;
LABEL_12:
      uint64_t v3 = +[MTPodcast sortDescriptorsForFirstTimeAvailableAscending:v6];
      break;
    case 7:
      uint64_t v3 = +[MTPodcast sortDescriptorsForRecentlyUnfollowed];
      break;
    default:
      uint64_t v5 = 1;
LABEL_8:
      uint64_t v3 = +[MTPodcast sortDescriptorsForTitle:v5];
      break;
  }
...
+ (id)sortDescriptorsForAllPodcasts
{
  id v2 = +[MTShowsPreferencesDataStore sharedInstance];
...
+ (id)sortDescriptorsForLastDatePlayed
{
  id v2 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastLastDatePlayed ascending:0];
  uint64_t v5 = v2;
...
+ (id)sortDescriptorsForFirstTimeAvailableAscending:(BOOL)a3
{
  uint64_t v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastLatestEpisodeAvailabilityTime ascending:a3];
  v7[0] = v3;
  uint64_t v4 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:0 selector:"localizedStandardCompare:"];
  v7[1] = v4;
  uint64_t v5 = +[NSArray arrayWithObjects:v7 count:2];
...
+ (id)sortDescriptorsForDateAddedAscending:(BOOL)a3
{
  uint64_t v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastAddedDate ascending:a3];
  v7[0] = v3;
  uint64_t v4 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:0 selector:"localizedStandardCompare:"];
  v7[1] = v4;
  uint64_t v5 = +[NSArray arrayWithObjects:v7 count:2];
...
+ (id)sortDescriptorsForTitle:(BOOL)a3
{
  ...
  v7[0] = v3;
  uint64_t v4 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastUpdatedDate ascending:0];
  v7[1] = v4;
  uint64_t v5 = +[NSArray arrayWithObjects:v7 count:2];
