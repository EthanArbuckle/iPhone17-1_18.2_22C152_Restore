...
{
  v2 = +[NSBundle podcastsFoundationBundle];
  v3 = [v2 localizedStringForKey:@"SYNC_SETTINGS_OUT_OF_SPACE_HEADER_MESSAGE", @"The storage space dedicated to media on your Apple Watch is full. To make space available, you can remove some podcasts, music, or audiobooks.", 0 value table];
...
+ (id)localizedStringForEpisodeCount:(int64_t)a3
{
  ...
  v5 = [v4 localizedStringForKey:@"SYNC_SETTINGS_CONTENT_SUMMARY_HEADER_EPISODE_COUNT" value:&stru_1CC00 table:0];

  v6 = +[NSString localizedStringWithValidatedFormat:v5, @"%ld", 0, a3 validFormatSpecifiers error];
...
{
  v2 = +[NSBundle podcastsFoundationBundle];
  v3 = [v2 localizedStringForKey:@"SYNC_PODCASTS_FOOTER_STRING", @"To listen to podcasts on your Apple Watch, turn on Sync Podcasts in Settings.", 0 value table];
