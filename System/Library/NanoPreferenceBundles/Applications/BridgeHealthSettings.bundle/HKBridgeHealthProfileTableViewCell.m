...
{
  v13.receiver = self;
  v13.super_class = (Class)HKBridgeHealthProfileTableViewCell;
...
{
  v10.receiver = self;
  v10.super_class = (Class)HKBridgeHealthProfileTableViewCell;
  [(HKBridgeHealthProfileTableViewCell *)&v10 becomeFirstResponder];
  v3 = [(HKBridgeHealthProfileTableViewCell *)self textLabel];
  v4 = [v3 text];
  v5 = +[NSBundle bundleForClass:objc_opt_class()];
  v6 = [v5 localizedStringForKey:@"CARDIO_FITNESS_RELATED_MEDICATIONS" value:&stru_18860 table:@"Localizable"];
...
{
  v6.receiver = self;
  v6.super_class = (Class)HKBridgeHealthProfileTableViewCell;
