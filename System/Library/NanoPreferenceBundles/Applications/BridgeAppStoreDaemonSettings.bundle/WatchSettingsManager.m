...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v15 = 2114;
    id v16 = v7;
    _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "[%{public}@]: Preference value for %{public}@ changed", (uint8_t *)&v13, 0x16u);
  }
  ...
  if (self)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v10;
      _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "[%{public}@]: Synchronizing shared defaults to watch.", (uint8_t *)&v13, 0xCu);
    }
