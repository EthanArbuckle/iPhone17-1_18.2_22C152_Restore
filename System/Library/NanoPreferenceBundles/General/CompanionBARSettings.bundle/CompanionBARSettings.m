id sub_2320(uint64_t a1, void *a2)
{
  return [a2 backgroundAppRefreshSwitchStateDidChange];
}

void sub_2464(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
...
void sub_2480(uint64_t a1, void *a2)
{
...
int64_t sub_2574(id a1, CSLPRFApp *a2, CSLPRFApp *a3)
{
  return (int64_t)[(CSLPRFApp *)a2 compare:a3];
}

void sub_2BFC(uint64_t a1)
{
...
id objc_msgSend_backgroundAppRefreshDomainAccessor(void *a1, const char *a2, ...)
{
  return [a1 backgroundAppRefreshDomainAccessor];
}
