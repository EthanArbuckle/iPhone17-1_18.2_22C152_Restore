...
- (CSLPRFReturnToAppSettingsModel)returnToAppSettingsModel
{
  ...
  if (!WeakRetained)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)sub_432C, @"CSLSessionsSettingsChangedNotification", 0, CFNotificationSuspensionBehaviorDeliverImmediately);
  }
...
- (id)specifiers
{
  ...
  if (v6)
  {
    returnToClockSettingGroup = &stru_8440;
  }
  else
  {
  ...
  if (v6)
  {
    ...
    v16 = [(CSLPRFReturnToClockSettingGroup *)v14 initWithDelegate:self returnToClockSetting:(uint64_t)v15 header:&stru_8440 appSpecific:1];
  ...
  if ([v3 sessionCapable])
  {
    ...
    v19 = [v18 localizedStringForKey:@"RETURN_TO_APP_IN_SESSION_LABEL" value:&stru_8440 table:@"CompanionWakeSettings"];
    v20 = +[PSSpecifier groupSpecifierWithID:@"RETURN_TO_APP_IN_SESSION_SECTION_ID" name:v19];

    v21 = +[NSBundle bundleForClass:objc_opt_class()];
    v22 = [v21 localizedStringForKey:@"RETURN_TO_APP_IN_SESSION_FOOTER" value:&stru_8440 table:@"CompanionWakeSettings"];
    [v20 setProperty:v22 forKey:PSFooterTextGroupKey];

    [v7 addObject:v20];
    v23 = +[NSBundle bundleForClass:objc_opt_class()];
    v24 = [v23 localizedStringForKey:@"RETURN_TO_APP_IN_SESSION_TITLE" value:&stru_8440 table:@"CompanionWakeSettings"];
