...
+ (void)performBlockAtIdle:(id)a3
{
  ...
  block[4] = a1;
  if (qword_22FB0 != -1) {
    dispatch_once(&qword_22FB0, block);
  }
  v6 = (void *)qword_22FB8;
  id v7 = [v4 copy];
...
+ (void)_NPHIdleTimeNotification:(id)a3
{
  ...
  if (v5)
  {
    ...
    [(id)qword_22FB8 removeObjectAtIndex:0];
    if ([(id)qword_22FB8 count]) {
      [a1 NPHRequestIdleTimeNotification];
    }
  }
}
