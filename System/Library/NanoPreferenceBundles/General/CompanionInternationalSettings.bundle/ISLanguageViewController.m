...
- (id)systemLanguages
{
  ...
  v3 = [WeakRetained parentController];
  objc_super v4 = [v3 systemLanguages];
...
- (void)updateNavigationItem
{
  ...
  v3 = [v2 localizedStringForKey:@"SELECT_LANGUAGE" value:&stru_2D040 table:@"InternationalSettings"];
...
- (id)_mainContentView
{
  ...
  v30 = [v29 localizedStringForKey:@"SEARCH" value:&stru_2D040 table:@"InternationalSettings"];
  v31 = [(ISLanguageViewController *)self searchBar];
  [v31 setPlaceholder:v30];

  v32 = [(ISLanguageViewController *)self navigationItem];
  v33 = [v32 navigationBar];
  [v33 setBarStyle:1];

  v34 = [(ISLanguageViewController *)self navigationItem];
  v35 = [v34 navigationBar];
  [v35 setTranslucent:1];

  v36 = BPSBridgeTintColor();
  v37 = [(ISLanguageViewController *)self searchBar];
  [v37 setTintColor:v36];

  v38 = [(ISLanguageViewController *)self searchBar];
  [v38 setKeyboardAppearance:1];

  v39 = +[NSArray array];
  [(ISLanguageViewController *)self setFilteredLanguageSections:v39];
...
- (void)loadData
{
  id v3 = objc_alloc((Class)IPLanguageListManager);
  uint64_t v4 = +[COSInternationalController preferredLanguages];
  double v5 = +[COSInternationalController currentLocale];
  unsigned int v6 = [(ISLanguageViewController *)self systemLanguages];
  id v7 = [v3 initWithPreferredLanguages:v4 preferredLocale:v5 systemLanguages:v6];

  id v8 = +[NSMutableArray arrayWithCapacity:3];
  v28[0] = @"kLanguageSectionKeyTitle";
  id v9 = +[NSBundle bundleForClass:objc_opt_class()];
  uint64_t v10 = +[ISInternationalViewController modelSpecificLocalizedStringKeyForKey:@"DEVICE_LANGUAGES"];
  uint64_t v11 = [v9 localizedStringForKey:v10 value:&stru_2D040 table:@"InternationalSettings"];
  v28[1] = @"kLanguageSectionKeyLanguages";
  v29[0] = v11;
  id v12 = [v7 deviceLanguagesForChangingDeviceLanguage:0];
  v29[1] = v12;
  id v13 = +[NSDictionary dictionaryWithObjects:v29 forKeys:v28 count:2];

  [v8 addObject:v13];
  long long v14 = [v7 languageVariants];
  if ([v14 count])
  {
    v26[0] = @"kLanguageSectionKeyTitle";
    long long v15 = +[NSBundle bundleForClass:objc_opt_class()];
    long long v16 = [v15 localizedStringForKey:@"LANGUAGE_VARIANTS" value:&stru_2D040 table:@"InternationalSettings"];
    v26[1] = @"kLanguageSectionKeyLanguages";
    v27[0] = v16;
    v27[1] = v14;
  ...
  v18 = [v7 otherLanguages];
  id v19 = [v18 mutableCopy];

  [v19 removeObjectsInArray:v14];
  v24[0] = @"kLanguageSectionKeyTitle";
  v20 = +[NSBundle bundleForClass:objc_opt_class()];
  v21 = [v20 localizedStringForKey:@"OTHER_LANGUAGES" value:&stru_2D040 table:@"InternationalSettings"];
  ...
  [v8 addObject:v22];
  [(ISLanguageViewController *)self setUnfilteredLanguageSections:v8];
  v23 = [v7 systemDisplayLanguage];
  [(ISLanguageViewController *)self setCheckedLanguageCode:v23];
}
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  id v7 = [v6 objectForKeyedSubscript:@"kLanguageSectionKeyLanguages"];
  id v8 = [v7 count];
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  double v5 = [(ISLanguageViewController *)self languageSections];
  unsigned int v6 = [v5 objectAtIndexedSubscript:a4];
  id v7 = [v6 objectForKeyedSubscript:@"kLanguageSectionKeyTitle"];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  if (!v7) {
    id v7 = [[ISLanguageTableViewCell alloc] initWithStyle:3 reuseIdentifier:@"Cell"];
  }
  id v8 = [v6 row];
  id v9 = [v6 section];
  ...
  id v19 = [(ISLanguageTableViewCell *)v7 textLabel];
