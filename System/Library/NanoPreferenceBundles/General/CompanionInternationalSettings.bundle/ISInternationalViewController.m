...
- (ISInternationalViewController)init
{
  ...
  dispatch_async((dispatch_queue_t)&_dispatch_main_q, &stru_2CB88);
  return v2;
}
        ...
        if (([v24 isEqualToString:v15] & 1) == 0)
        {
          ...
          if ([v24 isEqualToString:v34])
          {
            ...
            if (v37)
            {
              ...
              v39 = [v58 localizedStringForKey:v56 value:&stru_2D040 table:@"InternationalSettings"];
...
LABEL_32:
    ...
    if (deviceLanguageIndex >= a4)
    {
      ...
      if (v29)
      {
        ...
        [v57 localizedStringForKey:v30 value:&stru_2D040 table:@"InternationalSettings"];
        v32 = v31 = v24;
...
- (void)tableView:(id)a3 moveRowAtIndexPath:(id)a4 toIndexPath:(id)a5
{
    ...
    && ([v8 isEqual:v7] & 1) == 0)
  {
    ...
    unsigned int v13 = [v12 localizedStringForKey:@"CANCEL_CHANGE_LANGUAGE" value:&stru_2D040 table:@"InternationalSettings"];
    ...
    uint64_t v16 = [v15 localizedStringForKey:@"CONTINUE_CHANGE_LANGUAGE" value:&stru_2D040 table:@"InternationalSettings"];
...
- (id)tableView:(id)a3 trailingSwipeActionsConfigurationForRowAtIndexPath:(id)a4
{
  ...
  id v7 = [v6 localizedStringForKey:@"DELETE" value:&stru_2D040 table:@"InternationalSettings"];
  unsigned int v13 = _NSConcreteStackBlock;
  uint64_t v14 = 3221225472;
  v15 = sub_850C;
  uint64_t v16 = &unk_2CC50;
  id v17 = self;
  id v18 = v5;
  id v8 = v5;
...
LABEL_8:
  ...
  else
  {
    ...
    else
    {
      ...
      v34 = [v32 localizedStringForKey:v33 value:&stru_2D040 table:@"InternationalSettings"];
    ...
    BOOL v37 = [v36 localizedStringForKey:@"CANCEL_CHANGE_LANGUAGE" value:&stru_2D040 table:@"InternationalSettings"];
    v56 = v37;
    ...
    if (!v31 || (v41 & 1) != 0)
    {
      ...
      v47 = [v45 localizedStringForKey:v46 value:&stru_2D040 table:@"InternationalSettings"];
      ...
      if (v51)
      {
        ...
        unsigned __int8 v49 = [v48 localizedStringForKey:@"ASK_CHANGE_LANGUAGE_PREFERENCE_TITLE" value:&stru_2D040 table:@"InternationalSettings"];
      ...
      v50 = [v43 localizedStringForKey:@"CONTINUE_CHANGE_LANGUAGE" value:&stru_2D040 table:@"InternationalSettings"];
    ...
    else
    {
      ...
      uint64_t v43 = [v42 localizedStringForKey:@"CONTINUE_CHANGE_LANGUAGE" value:&stru_2D040 table:@"InternationalSettings"];
...
+ (id)modelSpecificLocalizedStringKeyForKey:(id)a3
{
  return +[NSString stringWithFormat:@"%@_WATCH", a3];
}
...
+ (id)localizedRestartStringForCurrentDevice
{
  ...
  id v4 = [v2 localizedStringForKey:v3 value:&stru_2D040 table:@"InternationalSettings"];

  if (COSActivePairingIsTinker()
    && (+[BPSTinkerSupport sharedInstance],
        id v5 = objc_claimAutoreleasedReturnValue(),
        [v5 cachedTinkerFamilyMemeber],
        objc_super v6 = objc_claimAutoreleasedReturnValue(),
        v5,
        v6))
  {
    id v7 = objc_alloc_init((Class)NSPersonNameComponents);
    objc_super v8 = [v6 firstName];
    [v7 setGivenName:v8];

    id v9 = [v6 lastName];
    [v7 setFamilyName:v9];

    unsigned __int8 v10 = +[NSPersonNameComponentsFormatter localizedStringFromPersonNameComponents:v7 style:1 options:0];
    uint64_t v11 = +[NSBundle bundleForClass:objc_opt_class()];
    uint64_t v12 = [v11 localizedStringForKey:@"APPLYING_WILL_RESTART_%@_S_WATCH" value:&stru_2D040 table:@"InternationalSettings"];
    +[NSString stringWithFormat:](NSString, "stringWithFormat:", v12, v10);
...
- (void)setNumberingSystem:(id)a3 specifier:(id)a4
{
  ...
  id v13 = +[NSLocale localeIdentifierFromComponents:v12];
  ...
  id v16 = (void *)qword_345F0;
  uint64_t v23 = qword_345F0;
  if (!qword_345F0)
  {
    v19[0] = _NSConcreteStackBlock;
    v19[1] = 3221225472;
    ...
    v19[3] = &unk_2CC78;
    v19[4] = &v20;
    sub_A51C((uint64_t)v19);
    id v16 = (void *)v21[3];
  }
  id v17 = v16;
  _Block_object_dispose(&v20, 8);
  uint64_t v18 = [v17 sharedCloudSettingsManager];
  [v18 writeToCloudSettings:&off_2DCE0 forStore:@"com.apple.cloudsettings.international"];
}
