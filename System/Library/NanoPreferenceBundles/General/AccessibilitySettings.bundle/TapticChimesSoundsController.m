...
{
  v5.receiver = self;
  v5.super_class = (Class)TapticChimesSoundsController;
  ...
  [(TapticChimesSoundsController *)self setTitle:v4];
}
    ...
    if (v8)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v9; ++i)
        {
          ...
          v16 = [v4 localizedStringForTapticChimesSoundType:v14];
...
{
  v18.receiver = self;
  v18.super_class = (Class)TapticChimesSoundsController;
  id v6 = a4;
  [(TapticChimesSoundsController *)&v18 tableView:a3 didSelectRowAtIndexPath:v6];
  uint64_t v7 = -[TapticChimesSoundsController indexForIndexPath:](self, "indexForIndexPath:", v6, v18.receiver, v18.super_class);
  uint64_t v8 = [(TapticChimesSoundsController *)self specifiers];
  uint64_t v9 = [v8 objectAtIndex:v7];

  uint64_t v10 = [v6 section];
  uint64_t v11 = [(TapticChimesSoundsController *)self specifierAtIndex:[(TapticChimesSoundsController *)self indexOfGroup:v10]];
