...
{
  v7.receiver = self;
  v7.super_class = (Class)ZoomHandGesturesActivationController;
...
- (id)specifiers
{
  ...
  if (!v3)
  {
    ...
    v29 = v5;
    [v4 addObject:v5];
    v33 = [(ZoomHandGesturesActivationController *)self greyActivationGesture];
    long long v34 = 0u;
    long long v35 = 0u;
    long long v36 = 0u;
    long long v37 = 0u;
    objc_super v7 = [MEMORY[0x263F85B10] sharedInstance];
    ...
    *(Class *)((char *)&v31->super.super.super.super.super.super.isa + v30) = (Class)v6;
    ...
    id v3 = *(Class *)((char *)&v31->super.super.super.super.super.super.isa + v30);
  }
...
- (id)greyActivationGesture
{
  ...
  uint64_t v4 = objc_msgSend(v2, "numberWithInteger:", objc_msgSend(v3, "greyActivationGesture"));
...
{
  v16.receiver = self;
  v16.super_class = (Class)ZoomHandGesturesActivationController;
  id v6 = a4;
  [(ZoomHandGesturesActivationController *)&v16 tableView:a3 didSelectRowAtIndexPath:v6];
  uint64_t v7 = -[ZoomHandGesturesActivationController indexForIndexPath:](self, "indexForIndexPath:", v6, v16.receiver, v16.super_class);
  v8 = [(ZoomHandGesturesActivationController *)self specifiers];
  uint64_t v9 = [v8 objectAtIndex:v7];

  uint64_t v10 = [v6 section];
  v11 = [(ZoomHandGesturesActivationController *)self specifierAtIndex:[(ZoomHandGesturesActivationController *)self indexOfGroup:v10]];
...
- (id)greyVisualIndicator
{
  v2 = NSNumber;
  id v3 = [MEMORY[0x263F85B10] sharedInstance];
  uint64_t v4 = objc_msgSend(v2, "numberWithBool:", objc_msgSend(v3, "showGestureRecognizerIndicator"));
