...
- (void)viewDidLoad
{
  ...
  id v3 = objc_alloc_init(MEMORY[0x263F82BA0]);
  ...
  v13 = (void *)[objc_alloc(MEMORY[0x263F824A8]) initWithBarButtonSystemItem:1 target:self action:sel__dismiss];
...
- (id)specifiers
{
  ...
  if (!v3)
  {
    uint64_t v75 = (int)*MEMORY[0x263F5FDB8];
    ...
    id v102 = v74;
    BOOL v105 = v17;
    v84 = (void (**)(void, void, void))MEMORY[0x24C53FB60](v100);
    v86 = v18;
    ...
    long long v99 = 0u;
    id v20 = v19;
    uint64_t v21 = [v20 countByEnumeratingWithState:&v96 objects:v108 count:16];
    if (v21)
    {
      uint64_t v22 = v21;
      ...
      do
      {
        for (uint64_t i = 0; i != v22; ++i)
        {
          ...
          int v27 = [v85 containsObject:v26];

          if (v27)
          {
            v28 = [MEMORY[0x263F228D0] sharedInstance];
            v29 = [v28 userLocale];
        ...
        uint64_t v22 = [v20 countByEnumeratingWithState:&v96 objects:v108 count:16];
      }
      while (v22);
    }
    v83 = self;
    ...
    if ([v77 count])
    {
      [v77 sortUsingComparator:&__block_literal_global_1];
      v36 = [MEMORY[0x263F5FC40] groupSpecifierWithID:@"PreferredLanguageTables"];
      [v76 addObject:v36];
    ...
    long long v95 = 0u;
    obuint64_t j = v20;
    uint64_t v38 = [obj countByEnumeratingWithState:&v92 objects:v107 count:16];
    if (v38)
    {
      uint64_t v39 = v38;
      ...
      do
      {
        for (uint64_t j = 0; j != v39; ++j)
        {
          ...
          v42 = *(void **)(*((void *)&v92 + 1) + 8 * j);
          v43 = [v42 languageCode];
          char v44 = [v85 containsObject:v43];

          if ((v44 & 1) == 0)
          {
            v45 = [MEMORY[0x263F228D0] sharedInstance];
            v46 = [v45 userLocale];
        ...
        uint64_t v39 = [obj countByEnumeratingWithState:&v92 objects:v107 count:16];
      }
      while (v39);
    }
    ...
    if ([v37 count])
    {
      ...
      v55 = [MEMORY[0x263F5FC40] groupSpecifierWithID:@"OtherLanguageTables"];
      [v76 addObject:v55];
    ...
    uint64_t v57 = [v78 countByEnumeratingWithState:&v88 objects:v106 count:16];
    if (v57)
    {
      uint64_t v58 = v57;
      ...
      do
      {
        for (uint64_t k = 0; k != v58; ++k)
        {
          ...
          uint64_t v61 = *(void *)(*((void *)&v88 + 1) + 8 * k);
          v62 = [(id)objc_opt_class() localizedNameForLanguageAgnosticTableIdentifier:v61];
          if (![v87 length]
            || [v62 localizedCaseInsensitiveContainsString:v87])
          {
            v63 = v56;
            v64 = [MEMORY[0x263F5FC40] preferenceSpecifierNamed:v62 target:v83 set:0 get:0 detail:objc_opt_class() cell:2 edit:0];
            ...
            v66 = (void *)MEMORY[0x24C53FB60](v82);
            [v64 setProperty:v66 forKey:@"DismissBlock"];

            [v64 setProperty:MEMORY[0x263EFFA88] forKey:@"IsLanguageAgnostic"];
        ...
        uint64_t v58 = [v78 countByEnumeratingWithState:&v88 objects:v106 count:16];
      }
      while (v58);
    }
    ...
    if ([v56 count])
    {
      ...
      v68 = [MEMORY[0x263F5FC40] groupSpecifierWithID:@"LanguageAgnosticTables"];
      [v76 addObject:v68];

      [v76 addObjectsFromArray:v56];
    }
    v69 = v56;
    v70 = *(Class *)((char *)&v83->super.super.super.super.super.super.isa + v75);
    *(Class *)((char *)&v83->super.super.super.super.super.super.isa + v75) = (Class)v76;
    id v71 = v76;

    id v3 = *(Class *)((char *)&v83->super.super.super.super.super.super.isa + v75);
  }
...
id __52__VoiceOverBrailleAllLanguagesController_specifiers__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  [v9 setProperty:*(void *)(a1 + 40) forKey:@"TableEnumerator"];
  unsigned int v10 = [NSNumber numberWithBool:*(unsigned __int8 *)(a1 + 64)];
  [v9 setProperty:v10 forKey:@"IsAddingNewLanguage"];

  v11 = (void *)MEMORY[0x24C53FB60](*(void *)(a1 + 56));
  [v9 setProperty:v11 forKey:@"DismissBlock"];

  [v9 setProperty:*(void *)(a1 + 48) forKey:@"TableSelectionBlockKey"];
  v12 = [NSNumber numberWithBool:*(unsigned __int8 *)(a1 + 65)];
...
- (id)keyboardLanguageCodes
{
  ...
  id v2 = [MEMORY[0x263F228D0] sharedInstance];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        unsigned int v10 = objc_msgSend(MEMORY[0x263EFF960], "localeWithLocaleIdentifier:", *(void *)(*((void *)&v14 + 1) + 8 * i), (void)v14);
        v11 = v10;
        if (v10)
        {
