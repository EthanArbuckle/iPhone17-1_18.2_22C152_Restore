...
- (CSLPRFWakeScreenSettingsViewController)init
{
  ...
  if (v2)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, v2, (CFNotificationCallback)sub_34C8, @"com.apple.Carousel.gizmoAutoScreenOffSecondsDidChange", 0, (CFNotificationSuspensionBehavior)0);
    v6 = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(v6, v2, (CFNotificationCallback)sub_34C8, @"CSLOnWakeTimeoutPreferenceChangedNotification", 0, (CFNotificationSuspensionBehavior)0);
    v7 = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(v7, v2, (CFNotificationCallback)sub_34C8, @"com.apple.Carousel.EnableRotateToWakeChangedNotification", 0, (CFNotificationSuspensionBehavior)0);
    v8 = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(v8, v2, (CFNotificationCallback)sub_34C8, @"com.apple.Carousel.kDisallowWakeGestureSetting", 0, (CFNotificationSuspensionBehavior)0);
...
- (id)_onTapGroup
{
  ...
  v4 = [v3 localizedStringForKey:@"ON_TAP_HEADER" value:&stru_C5F0 table:@"CompanionWakeSettings"];
  CFStringRef v5 = +[PSSpecifier groupSpecifierWithID:@"ON_TAP_GROUP_ID" name:v4];

  char v6 = +[NSBundle bundleForClass:objc_opt_class()];
  id v7 = [v6 localizedStringForKey:@"ON_TAP_FOOTER" value:&stru_C5F0 table:@"CompanionWakeSettings"];
  [v5 setProperty:v7 forKey:PSFooterTextGroupKey];

  id v8 = +[NSBundle bundleForClass:objc_opt_class()];
  id v9 = [v8 localizedStringForKey:@"WAKE_SHORT_INTERVAL" value:&stru_C5F0 table:@"CompanionWakeSettings"];
  ...
  id v13 = [v12 localizedStringForKey:@"WAKE_LONG_INTERVAL" value:&stru_C5F0 table:@"CompanionWakeSettings"];
