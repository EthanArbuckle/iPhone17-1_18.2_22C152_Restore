...
- (NSArray)specifiers
{
  ...
  if (!specifiers)
  {
    ...
    v12 = [v11 localizedStringForKey:self->_footer value:&stru_C5F0 table:@"CompanionWakeSettings"];
...
- (void)setSelectedSpecifier:(id)a3
{
  ...
  else
  {
    ...
    v6 = [v5 localizedStringForKey:self->_footer value:&stru_C5F0 table:@"CompanionWakeSettings"];
