...
- (NSArray)specifiers
{
  ...
  block[4] = self;
  if (qword_11A48 != -1) {
    dispatch_once(&qword_11A48, block);
  }
  specifiers = self->_specifiers;
  if (!specifiers)
  {
    +[NSMutableArray arrayWithCapacity:](NSMutableArray, "arrayWithCapacity:", [(id)qword_11A38 count]);
    v4 = (NSMutableArray *)objc_claimAutoreleasedReturnValue();
    v5 = self->_specifiers;
    self->_specifiers = v4;

    v6 = +[NSBundle bundleForClass:objc_opt_class()];
    v7 = [v6 localizedStringForKey:self->_header value:&stru_C5F0 table:@"CompanionWakeSettings"];
    ...
    v12[3] = &unk_C468;
    v12[4] = self;
    [(id)qword_11A38 enumerateObjectsUsingBlock:v12];
    specifiers = self->_specifiers;
  }
...
- (void)setSelectedSpecifier:(id)a3
{
  ...
  v13 = [v12 localizedStringForKey:v9 value:&stru_C5F0 table:@"CompanionWakeSettings"];
