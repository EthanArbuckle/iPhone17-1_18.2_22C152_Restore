...
- (_TtC20ProductPageExtension17SearchHeadingView)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension17SearchHeadingView *)sub_100664488(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension17SearchHeadingView)initWithCoder:(id)a3
{
  ...
  result = (_TtC20ProductPageExtension17SearchHeadingView *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_100666F68((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension17SearchHeadingView_metrics);
