...
- (_TtC20ProductPageExtension31EditorsChoiceCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension31EditorsChoiceCollectionViewCell *)sub_1005E8220(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC20ProductPageExtension31EditorsChoiceCollectionViewCell)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC20ProductPageExtension31EditorsChoiceCollectionViewCell_editorsChoiceReviewView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)[v6 init];
  v8 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension31EditorsChoiceCollectionViewCell_itemLayoutContext;
  uint64_t v9 = sub_10076FC20();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v9 - 8) + 56))(v8, 1, 1, v9);

  result = (_TtC20ProductPageExtension31EditorsChoiceCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (_TtC19AppStoreKitInternal16DynamicTypeLabel)accessibilityTitleLabel
{
  return (_TtC19AppStoreKitInternal16DynamicTypeLabel *)objc_retainAutoreleaseReturnValue(*(id *)(*(char **)((char *)&self->super.super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension31EditorsChoiceCollectionViewCell_editorsChoiceReviewView)
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension31EditorsChoiceCollectionViewCell_editorsChoiceReviewView));
  objc_super v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension31EditorsChoiceCollectionViewCell_itemLayoutContext;
