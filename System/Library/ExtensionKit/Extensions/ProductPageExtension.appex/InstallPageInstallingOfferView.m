...
- (_TtC20ProductPageExtension30InstallPageInstallingOfferView)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension30InstallPageInstallingOfferView *)sub_100235C0C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension30InstallPageInstallingOfferView)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension30InstallPageInstallingOfferView *)sub_10077D120();
  __break(1u);
  return result;
}
