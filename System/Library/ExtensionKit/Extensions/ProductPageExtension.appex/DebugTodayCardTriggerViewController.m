...
- (_TtC20ProductPageExtension35DebugTodayCardTriggerViewController)initWithCoder:(id)a3
{
  result = (_TtC20ProductPageExtension35DebugTodayCardTriggerViewController *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (int64_t)numberOfSectionsInTableView:(id)a3
{
  return (*(void **)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension35DebugTodayCardTriggerViewController_sections))[2];
}
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (*(void *)(*(void *)((char *)self
                             + OBJC_IVAR____TtC20ProductPageExtension35DebugTodayCardTriggerViewController_sections)
                 + 16) <= (unint64_t)a4)
  {
LABEL_7:
    __break(1u);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  {
    uint64_t v4 = *(void *)(self + OBJC_IVAR____TtC20ProductPageExtension35DebugTodayCardTriggerViewController_sections);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  sub_10076A530();
  v10 = (_TtC20ProductPageExtension35DebugTodayCardTriggerViewController *)a3;
  v11 = self;
  ...
  if (!v13)
  {
    ...
    v15 = (_TtC20ProductPageExtension35DebugTodayCardTriggerViewController *)sub_10077BC80();
...
- (_TtC20ProductPageExtension35DebugTodayCardTriggerViewController)initWithStyle:(int64_t)a3
{
  id result = (_TtC20ProductPageExtension35DebugTodayCardTriggerViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
