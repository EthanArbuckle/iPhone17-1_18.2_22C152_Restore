...
- (void)dismissalTransitionDidEnd:(BOOL)a3
{
  if (a3)
  {
    ...
    [*(id *)((char *)&v4->super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension33ArticlePagePresentationController_overlayBlurView) removeFromSuperview];
  }
}

- (void)dismissTapDidChange:(id)a3
{
  double v4 = (_TtC20ProductPageExtension33ArticlePagePresentationController *)a3;
  id v6 = self;
  if ([(ArticlePagePresentationController *)v4 state] == (id)3)
  {
    double v5 = (_TtC20ProductPageExtension33ArticlePagePresentationController *)[(ArticlePagePresentationController *)v6 presentedViewController];
...
- (_TtC20ProductPageExtension33ArticlePagePresentationController)initWithPresentedViewController:(id)a3 presentingViewController:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  CGRect result = (_TtC20ProductPageExtension33ArticlePagePresentationController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10000F76C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension33ArticlePagePresentationController_transitioningViewProvider);
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension33ArticlePagePresentationController_interactiveDismissal, (uint64_t *)&unk_10094BF30);
