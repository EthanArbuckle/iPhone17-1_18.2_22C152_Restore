...
- (_TtC20ProductPageExtension32EditorialQuoteCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension32EditorialQuoteCollectionViewCell *)sub_1004A2AC0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension32EditorialQuoteCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC20ProductPageExtension32EditorialQuoteCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension32EditorialQuoteCollectionViewCell_itemLayoutContext;
