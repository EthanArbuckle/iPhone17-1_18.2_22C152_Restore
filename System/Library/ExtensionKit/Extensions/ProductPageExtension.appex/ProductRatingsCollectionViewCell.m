...
- (_TtC20ProductPageExtension32ProductRatingsCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension32ProductRatingsCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  double v6 = sub_100466B70(width, height);
  double v8 = v7;
...
- (void).cxx_destruct
{
  sub_1000105B0((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension32ProductRatingsCollectionViewCell_itemLayoutContext);
