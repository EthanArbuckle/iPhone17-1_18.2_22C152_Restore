...
- (_TtC20ProductPageExtension21GalleryViewController)initWithCoder:(id)a3;
- (_TtC20ProductPageExtension21GalleryViewController)initWithCollectionViewLayout:(id)a3;
- (_TtC20ProductPageExtension21GalleryViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (_TtC20ProductPageExtension21GalleryViewController)initWithCoder:(id)a3
{
  result = (_TtC20ProductPageExtension21GalleryViewController *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (int64_t)collectionView:(id)a3 numberOfItemsInSection:(int64_t)a4
{
  unint64_t v4 = *(unint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC20ProductPageExtension21GalleryViewController_artwork);
  if (!(v4 >> 62)) {
...
{
  id v3 = a3;
  CGSize result = (_TtC20ProductPageExtension21GalleryViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
