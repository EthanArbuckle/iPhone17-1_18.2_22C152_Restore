...
- (_TtC20ProductPageExtension35DebugStorefrontPickerViewController)initWithCoder:(id)a3
{
  result = (_TtC20ProductPageExtension35DebugStorefrontPickerViewController *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void)setStorefrontToUS
{
  ...
  sub_1007761D0();
  [*(id *)((char *)&v3->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension35DebugStorefrontPickerViewController_languagePicker) selectRow:0 inComponent:0 animated:1];
  sub_1007761E0();
}
...
{
  id v4 = a4;
  double result = (_TtC20ProductPageExtension35DebugStorefrontPickerViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
