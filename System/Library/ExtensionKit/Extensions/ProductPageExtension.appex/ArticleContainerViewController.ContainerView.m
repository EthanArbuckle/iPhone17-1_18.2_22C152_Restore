...
- (void)setFrame:(CGRect)a3
{
  ...
  if (!CGRectEqualToRect(v26, v27))
  {
    v22 = *(void (**)(uint64_t))((char *)&v9->super.super.super.isa
                                         + OBJC_IVAR____TtCC20ProductPageExtension30ArticleContainerViewControllerP33_DBD3BDFA863817F76B447E10483B1F7213ContainerView_frameUpdatedCallback);
    if (v22)
    {
      uint64_t v23 = swift_retain();
      v22(v23);
      sub_1000194B0((uint64_t)v22);
    }
  }
}
