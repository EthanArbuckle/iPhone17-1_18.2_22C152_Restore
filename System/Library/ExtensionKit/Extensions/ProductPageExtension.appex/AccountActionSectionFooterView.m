...
- (_TtC20ProductPageExtension30AccountActionSectionFooterView)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension30AccountActionSectionFooterView *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  uint64_t v5 = *(uint64_t *)((char *)&self->super.super.super.super.isa
                  + OBJC_IVAR____TtC20ProductPageExtension30AccountActionSectionFooterView_text);
  uint64_t v6 = *(void *)&self->titleLabel[OBJC_IVAR____TtC20ProductPageExtension30AccountActionSectionFooterView_text];
  swift_bridgeObjectRetain();
  v7 = self;
  [(AccountActionSectionFooterView *)v7 layoutMargins];
  double v8 = sub_1007074AC(width, v5, v6);
  double v10 = v9;
