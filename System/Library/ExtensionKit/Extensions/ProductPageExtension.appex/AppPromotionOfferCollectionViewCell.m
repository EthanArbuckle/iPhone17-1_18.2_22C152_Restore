...
- (_TtC20ProductPageExtension35AppPromotionOfferCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension35AppPromotionOfferCollectionViewCell *)sub_1000A7730();
}
...
- (_TtC20ProductPageExtension35AppPromotionOfferCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC20ProductPageExtension35AppPromotionOfferCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension35AppPromotionOfferCollectionViewCell_itemLayoutContext, (uint64_t *)&unk_1009559B0);
