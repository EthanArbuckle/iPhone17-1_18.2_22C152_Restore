...
- (void)didTapContinue
{
  v2 = *(void (**)(void))&self->OBWelcomeController_opaque[OBJC_IVAR____TtC20ProductPageExtension31OnboardingWelcomeViewController_primaryButtonCallback];
  id v3 = self;
  v2();
}
...
- (_TtC20ProductPageExtension31OnboardingWelcomeViewController)initWithTitle:(id)a3 detailText:(id)a4 symbolName:(id)a5 contentLayout:(int64_t)a6
{
  result = (_TtC20ProductPageExtension31OnboardingWelcomeViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
