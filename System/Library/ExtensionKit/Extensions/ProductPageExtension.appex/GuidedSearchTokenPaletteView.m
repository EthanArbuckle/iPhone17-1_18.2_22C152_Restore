...
- (_TtC20ProductPageExtension28GuidedSearchTokenPaletteView)initWithFrame:(CGRect)a3
{
  sub_100254DDC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_release();
  swift_release();
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension28GuidedSearchTokenPaletteView_containerImpressionMetrics, (uint64_t *)&unk_100956270);
}
...
- (CGSize)collectionView:(id)a3 layout:(id)a4 sizeForItemAtIndexPath:(id)a5
{
  ...
  id v13 = a4;
  uint64_t v14 = self;
  sub_100256DDC((uint64_t)v34);
  sub_100028B64((uint64_t)v34, (uint64_t)v35, &qword_1009581C0);
  uint64_t v15 = v36;
  if (v36)
  {
    uint64_t v16 = v35[0];
    ...
    double v22 = v21;
    double v24 = v23;
    v25 = (void *)sub_10066375C(v16, v17, v18, v15, v12);
    uint64_t v26 = v20 & 1;
    uint64_t v8 = v19;
    double v27 = sub_100663A68(v25, v26, v12, v22, v24);
    double v29 = v28;
...
- (UIEdgeInsets)collectionView:(id)a3 layout:(id)a4 insetForSectionAtIndex:(int64_t)a5
{
  ...
  uint64_t v11 = sub_10000D280((uint64_t *)&unk_100956E10);
  sub_10000D2C4(v11, (uint64_t)qword_1009580B0);
  sub_10076C810();
