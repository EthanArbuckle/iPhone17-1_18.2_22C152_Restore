...
- (_TtC20ProductPageExtension20PlayerViewController)initWithCoder:(id)a3;
- (_TtC20ProductPageExtension20PlayerViewController)initWithNibName:(id)a3 bundle:(id)a4;
- (_TtC20ProductPageExtension20PlayerViewController)initWithPlayerLayerView:(id)a3;
- (void)dealloc;
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  if (*((unsigned char *)v4 + OBJC_IVAR____TtC20ProductPageExtension20PlayerViewController_autoplay) == 1)
  {
...
- (void)playerItemDidPlayToEndWithNotification:(id)a3
{
  ...
  if (*((unsigned char *)&self->super.super.super.super.isa
       + OBJC_IVAR____TtC20ProductPageExtension20PlayerViewController_shouldDismissWhenPlaysToEnd) == 1)
...
{
  if (*((unsigned char *)&self->super.super.super.super.isa
       + OBJC_IVAR____TtC20ProductPageExtension20PlayerViewController_alwaysShowDoneButton) == 1)
  {
...
- (_TtC20ProductPageExtension20PlayerViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  {
    sub_10077BCB0();
    *((unsigned char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension20PlayerViewController_autoplay) = 0;
    *((unsigned char *)&self->super.super.super.super.isa
    + OBJC_IVAR____TtC20ProductPageExtension20PlayerViewController_shouldDismissWhenPlaysToEnd) = 1;
    *((unsigned char *)&self->super.super.super.super.isa
    + OBJC_IVAR____TtC20ProductPageExtension20PlayerViewController_alwaysShowDoneButton) = 0;
    id v6 = a4;
