...
- (_TtC20ProductPageExtension22UberCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension22UberCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void)applyLayoutAttributes:(id)a3
{
  id v4 = a3;
  v5 = self;
  sub_100503180((uint64_t)v4);
}

- (void).cxx_destruct
{
  sub_1000105B0((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension22UberCollectionViewCell_itemLayoutContext);
