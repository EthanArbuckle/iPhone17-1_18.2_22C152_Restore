...
- (_TtC20ProductPageExtension24ArcadeWelcomeContentView)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension24ArcadeWelcomeContentView *)sub_1001393A4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC20ProductPageExtension24ArcadeWelcomeContentView)initWithCoder:(id)a3
{
  result = (_TtC20ProductPageExtension24ArcadeWelcomeContentView *)sub_10077D120();
  __break(1u);
  return result;
}
