...
- (_TtC20ProductPageExtension35CarouselItemCollectionLockupOverlay)initWithFrame:(CGRect)a3
{
  sub_1003D1958(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  id v3 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension35CarouselItemCollectionLockupOverlay_materialBackground];
  sub_100770A80();
...
- (void).cxx_destruct
{
  id v3 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension35CarouselItemCollectionLockupOverlay_displayOptions;
