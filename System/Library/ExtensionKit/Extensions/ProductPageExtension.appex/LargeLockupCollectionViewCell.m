...
- (_TtC20ProductPageExtension29LargeLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension29LargeLockupCollectionViewCell *)sub_1002E3F80(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension29LargeLockupCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension29LargeLockupCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_1000105B0((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension29LargeLockupCollectionViewCell_itemLayoutContext);
