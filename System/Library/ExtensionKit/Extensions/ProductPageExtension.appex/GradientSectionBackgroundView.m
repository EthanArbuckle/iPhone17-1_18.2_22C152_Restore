...
- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithFrame:(CGRect)a3
{
  ...
  uint64_t v8 = OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView;
  ...
  *(Class *)((char *)&self->super.super.super.super.isa + v8) = (Class)[v9 init];
  ...
  [(GradientSectionBackgroundView *)v11 addSubview:*(Class *)((char *)&v11->super.super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView)];
  return v11;
}

- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView;
  ...
  *(Class *)((char *)&self->super.super.super.super.isa + v5) = (Class)[v6 init];
  ...
  result = (_TtC20ProductPageExtension29GradientSectionBackgroundView *)sub_10077D120();
  __break(1u);
  return result;
}
