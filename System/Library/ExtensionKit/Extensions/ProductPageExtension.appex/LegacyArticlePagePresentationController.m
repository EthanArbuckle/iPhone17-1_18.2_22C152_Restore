...
- (_TtC20ProductPageExtension39LegacyArticlePagePresentationController)initWithPresentedViewController:(id)a3 presentingViewController:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  sub_100734AF0((uint64_t)v5, (uint64_t)a4);
  v8 = v7;
...
{
  if (a3) {
    [*(id *)((char *)&self->super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension39LegacyArticlePagePresentationController_overlayView) removeFromSuperview];
  }
}

- (void)dismissTapDidChange:(id)a3
{
  double v4 = (_TtC20ProductPageExtension39LegacyArticlePagePresentationController *)a3;
  id v6 = self;
  if ([(LegacyArticlePagePresentationController *)v4 state] == (id)3)
  {
    double v5 = (_TtC20ProductPageExtension39LegacyArticlePagePresentationController *)[(LegacyArticlePagePresentationController *)v6 presentedViewController];
...
- (void).cxx_destruct
{
  ...
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension39LegacyArticlePagePresentationController_interactiveDismissal, (uint64_t *)&unk_10094BF30);
