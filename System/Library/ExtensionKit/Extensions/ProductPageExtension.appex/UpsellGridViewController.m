...
- (_TtC20ProductPageExtension24UpsellGridViewController)initWithCoder:(id)a3
{
  result = (_TtC20ProductPageExtension24UpsellGridViewController *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void)loadView
{
  ...
  if (([(UpsellGridViewController *)v2 isViewLoaded] & 1) == 0) {
    [(UpsellGridViewController *)v2 setView:*(Class *)((char *)&v2->super.super.super.isa+ OBJC_IVAR____TtC20ProductPageExtension24UpsellGridViewController_gridView)];
  }
}
...
{
  id v4 = a4;
  result = (_TtC20ProductPageExtension24UpsellGridViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
