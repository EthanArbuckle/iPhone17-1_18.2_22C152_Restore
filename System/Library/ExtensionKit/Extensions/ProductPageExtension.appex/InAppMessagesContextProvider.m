...
- (id)contextPropertyWithName:(id)a3
{
  ...
  uint64_t v6 = v5;
  v7 = self;
  sub_10028C26C(v4, v6, (uint64_t)v16);

  swift_bridgeObjectRelease();
  uint64_t v8 = v17;
  if (v17)
  {
    v9 = sub_10000FA3C(v16, v17);
    uint64_t v10 = *(void *)(v8 - 8);
    __n128 v11 = __chkstk_darwin(v9);
    v13 = (char *)v16 - ((v12 + 15) & 0xFFFFFFFFFFFFFFF0);
    (*(void (**)(char *, __n128))(v10 + 16))(v13, v11);
    v14 = (void *)sub_10077D210();
    (*(void (**)(char *, uint64_t))(v10 + 8))(v13, v8);
    _s20ProductPageExtension22AutoAdjustingPlaceableVwxx_0((uint64_t)v16);
  }
  else
  {
    v14 = 0;
...
- (_TtC20ProductPageExtension28InAppMessagesContextProvider)init
{
  result = (_TtC20ProductPageExtension28InAppMessagesContextProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
