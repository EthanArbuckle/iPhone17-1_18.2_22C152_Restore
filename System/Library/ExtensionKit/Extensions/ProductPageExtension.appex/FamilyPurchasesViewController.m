...
- (id)collectionView:(id)a3 viewForSupplementaryElementOfKind:(id)a4 atIndexPath:(id)a5
{
  uint64_t v7 = sub_10076A5F0();
  uint64_t v8 = *(void *)(v7 - 8);
  __chkstk_darwin(v7);
  id v10 = (char *)&v18 - ((v9 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v11 = sub_10077BCB0();
  uint64_t v13 = v12;
  sub_10076A530();
  id v14 = a3;
  v15 = self;
  id v16 = sub_10003E7A8(v14, v11, v13);
...
- (UIEdgeInsets)collectionView:(id)a3 layout:(id)a4 insetForSectionAtIndex:(int64_t)a5
{
  ...
  {
    if (qword_1009479A0 != -1) {
      swift_once();
    }
    CGFloat top = *(double *)&qword_10094C380;
    CGFloat right = 0.0;
    CGFloat bottom = 27.5;
    CGFloat left = 0.0;
  }
