...
- (_TtC20ProductPageExtension15TitleHeaderView)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension15TitleHeaderView *)sub_10017ED64(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  double v6 = sub_100180C9C(width, height);
  double v8 = v7;
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  double v6 = *(void **)&v5[OBJC_IVAR____TtC20ProductPageExtension15TitleHeaderView_titleLabel];
  double v7 = *(uint64_t (**)(char *))&v5[OBJC_IVAR____TtC20ProductPageExtension15TitleHeaderView_titleLabelNumberOfLines];
  swift_retain();
  uint64_t v8 = v7(v5);
  swift_release();
...
- (void).cxx_destruct
{
  ...
  sub_10018C5E4((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension15TitleHeaderView_style, type metadata accessor for TitleHeaderView.Style);
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC20ProductPageExtension15TitleHeaderView_accessoryView));
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension15TitleHeaderView_accessory, (uint64_t *)&unk_100959390);
