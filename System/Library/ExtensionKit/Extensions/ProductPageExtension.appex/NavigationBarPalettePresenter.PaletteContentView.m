...
{
  v5.receiver = self;
  v5.super_class = (Class)_s14descr1008810E1V18PaletteContentViewCMa();
  v2 = (char *)v5.receiver;
  [(NavigationBarPalettePresenter.PaletteContentView *)&v5 layoutSubviews];
  v3 = *(void (**)(uint64_t))&v2[OBJC_IVAR____TtCC20ProductPageExtension29NavigationBarPalettePresenter18PaletteContentView_didLayoutSubviews];
  if (v3)
  {
...
- (_TtCC20ProductPageExtension29NavigationBarPalettePresenter18PaletteContentView)initWithFrame:(CGRect)a3
{
  ...
  v8 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtCC20ProductPageExtension29NavigationBarPalettePresenter18PaletteContentView_didLayoutSubviews);
  v9 = (objc_class *)_s14descr1008810E1V18PaletteContentViewCMa();
  void *v8 = 0;
  v8[1] = 0;
  v11.receiver = self;
  v11.super_class = v9;
...
- (_TtCC20ProductPageExtension29NavigationBarPalettePresenter18PaletteContentView)initWithCoder:(id)a3
{
  objc_super v5 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtCC20ProductPageExtension29NavigationBarPalettePresenter18PaletteContentView_didLayoutSubviews);
  v6 = (objc_class *)_s14descr1008810E1V18PaletteContentViewCMa();
  *objc_super v5 = 0;
  v5[1] = 0;
  v8.receiver = self;
  v8.super_class = v6;
