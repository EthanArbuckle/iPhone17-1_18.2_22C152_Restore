...
{
  v2 = self;
  sub_1000D06BC((SEL *)&selRef_as_viewWillBecomeFullyVisible, (unsigned int *)&enum case for StoreViewControllerLifecycleEvent.willAppear(_:));
}
...
{
  v2 = self;
  sub_1000D06BC((SEL *)&selRef_as_viewDidBecomeFullyVisible, (unsigned int *)&enum case for StoreViewControllerLifecycleEvent.didAppear(_:));
}
...
{
  v2 = self;
  sub_1000D06BC((SEL *)&selRef_as_viewDidBecomePartiallyVisible, (unsigned int *)&enum case for StoreViewControllerLifecycleEvent.didDisappear(_:));
}
...
{
  id v4 = a4;
  result = (_TtC20ProductPageExtension38InAppPurchaseInstallPageViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10000F76C((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension38InAppPurchaseInstallPageViewController_delegate);
  swift_release();
  swift_release();
  swift_release();
  ...
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension38InAppPurchaseInstallPageViewController_appAdamId, &qword_10094B850);
  swift_release();
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension38InAppPurchaseInstallPageViewController_lifecycleObserver, &qword_10094E350);
