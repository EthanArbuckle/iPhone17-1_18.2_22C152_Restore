...
+ (void)as_activatePresentationHack
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100006E3C;
  block[3] = &unk_100887630;
  block[4] = a1;
  if (qword_100973B90 != -1) {
    dispatch_once(&qword_100973B90, block);
  }
}
...
- (_TtP20ProductPageExtension20PageTraitEnvironment_)snapshotPageTraitEnvironment
{
  ...
  double v10 = &v9[OBJC_IVAR____TtC20ProductPageExtension28SnapshotPageTraitEnvironment_pageContainerSize];
  *(void *)double v10 = v4;
  *((void *)v10 + 1) = v6;
  *(void *)&v9[OBJC_IVAR____TtC20ProductPageExtension28SnapshotPageTraitEnvironment_traitCollection] = v7;
  v13.receiver = v9;
  v13.super_class = v8;
