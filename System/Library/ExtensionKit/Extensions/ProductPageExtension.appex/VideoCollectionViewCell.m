...
- (_TtC20ProductPageExtension23VideoCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC20ProductPageExtension23VideoCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  id v2 = (char *)self + OBJC_IVAR____TtC20ProductPageExtension23VideoCollectionViewCell_configuration;
  uint64_t v3 = sub_100771050();
