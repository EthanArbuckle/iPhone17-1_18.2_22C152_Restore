...
- (_TtC20ProductPageExtension25StoreNavigationController)initWithCoder:(id)a3
{
  result = (_TtC20ProductPageExtension25StoreNavigationController *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (_TtC20ProductPageExtension25StoreNavigationController)initWithNavigationBarClass:(Class)a3 toolbarClass:(Class)a4
{
  result = (_TtC20ProductPageExtension25StoreNavigationController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
