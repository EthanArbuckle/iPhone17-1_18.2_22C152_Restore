...
- (void)engagement:(id)a3 didUpdateEngagementRequest:(id)a4 placement:(id)a5 serviceType:(id)a6 completion:(id)a7
{
  ...
  uint64_t v13 = v12;
  uint64_t v14 = sub_10077BCB0();
  uint64_t v16 = v15;
  id v17 = a3;
  id v18 = a4;
  v19 = self;
  sub_1005D95FC(v17, a4, v11, v13, v14, v16);
  _Block_release(v10);
...
- (void)engagement:(id)a3 didUpdateRequest:(id)a4 placement:(id)a5 serviceType:(id)a6
{
  ...
  uint64_t v11 = v10;
  uint64_t v12 = sub_10077BCB0();
  uint64_t v14 = v13;
  id v15 = a3;
  id v16 = a4;
  id v17 = self;
  sub_1005D8B00(v15, a4, v9, v11, v12, v14);
...
- (_TtC20ProductPageExtension27JourneyDrivenOnboardingStep)init
{
  result = (_TtC20ProductPageExtension27JourneyDrivenOnboardingStep *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
