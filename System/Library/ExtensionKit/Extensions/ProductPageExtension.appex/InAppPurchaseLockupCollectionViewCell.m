...
- (_TtC20ProductPageExtension37InAppPurchaseLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension37InAppPurchaseLockupCollectionViewCell *)sub_100082338(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC20ProductPageExtension37InAppPurchaseLockupCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension37InAppPurchaseLockupCollectionViewCell *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10000FA80((uint64_t)self + OBJC_IVAR____TtC20ProductPageExtension37InAppPurchaseLockupCollectionViewCell_separator, (uint64_t *)&unk_10094E4E0);
}
