...
- (_TtC20ProductPageExtension25CarouselItemLockupOverlay)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension25CarouselItemLockupOverlay *)sub_100286534(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  double v6 = sub_100287594(width, height);
  double v8 = v7;
