...
- (_TtC20ProductPageExtension42SearchResultsCollectionCompositionalLayout)initWithSectionProvider:(id)a3 configuration:(id)a4
{
  ...
  *(void *)(v6 + 16) = v5;
  return (_TtC20ProductPageExtension42SearchResultsCollectionCompositionalLayout *)sub_1000D7970((uint64_t)sub_1000D9878, v6, a4);
}

- (CGSize)collectionViewContentSize
{
  v2 = self;
  double v3 = sub_1000D7B6C();
  double v5 = v4;
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  v14.receiver = v8;
  v14.super_class = v10;
  v11 = (_TtC20ProductPageExtension42SearchResultsCollectionCompositionalLayout *)[(BaseCollectionCompositionalLayout *)&v14 layoutAttributesForItemAtIndexPath:isa];

  if (v11)
  {
    id v12 = sub_1000D8A78(v11);
...
- (id)layoutAttributesForDecorationViewOfKind:(id)a3 atIndexPath:(id)a4
{
  ...
  sub_10076A530();
  id v12 = self;
  id v13 = sub_1000D8E58(v9, v11, (uint64_t)v8);
