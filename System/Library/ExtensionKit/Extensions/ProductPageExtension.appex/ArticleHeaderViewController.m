...
- (_TtC20ProductPageExtension27ArticleHeaderViewController)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension27ArticleHeaderViewController *)sub_10077D120();
  __break(1u);
  return result;
}
...
{
  id v4 = a4;
  result = (_TtC20ProductPageExtension27ArticleHeaderViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
