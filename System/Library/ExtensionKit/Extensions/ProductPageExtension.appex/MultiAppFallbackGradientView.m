...
- (_TtC20ProductPageExtension28MultiAppFallbackGradientView)initWithFrame:(CGRect)a3
{
  ...
  uint64_t v9 = OBJC_IVAR____TtC20ProductPageExtension28MultiAppFallbackGradientView_overlayGradientView;
...
- (void)layoutSubviews
{
  ...
  id v3 = *(id *)&v2[OBJC_IVAR____TtC20ProductPageExtension28MultiAppFallbackGradientView_overlayGradientView];
