...
- (_TtC20ProductPageExtension16FooterLockupView)init
{
  return (_TtC20ProductPageExtension16FooterLockupView *)sub_100490680();
}
...
- (_TtC20ProductPageExtension16FooterLockupView)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension16FooterLockupView *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  id v5 = self;
  double v6 = sub_10048F400(width, height);
  double v8 = v7;
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  double v6 = *(void **)&v4[OBJC_IVAR____TtC20ProductPageExtension16FooterLockupView_lockupView];
  if (v6)
  {
    id v7 = v6;
...
{
  id v3 = a3;
  CGSize result = (_TtC20ProductPageExtension16FooterLockupView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
