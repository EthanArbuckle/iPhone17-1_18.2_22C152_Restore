...
- (_TtC20ProductPageExtension17StarRatingControl)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
  ...
  _OWORD *v4 = xmmword_10079F000;
  v4[1] = xmmword_10079F000;
  id v5 = a3;

  result = (_TtC20ProductPageExtension17StarRatingControl *)sub_10077D120();
  __break(1u);
  return result;
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  double v7 = self;
  sub_10067FD80(x, y, width, height);
}
...
- (uint64_t)beginTrackingWithTouch:(void *)a3 withEvent:(void *)a4
{
  ...
  sub_1006808C8(v9);
  uint64_t v10 = *(void *)&v8[OBJC_IVAR____TtC20ProductPageExtension17StarRatingControl_rating];
  *(void *)&v8[OBJC_IVAR____TtC20ProductPageExtension17StarRatingControl_rating] = v11;
  if (v10 != v11) {
    [v8 setNeedsDisplay];
  }
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  double v8 = *(double *)&self->rating[OBJC_IVAR____TtC20ProductPageExtension17StarRatingControl_touchOutsideMargin];
  double v9 = *(double *)&self->lastSentRating[OBJC_IVAR____TtC20ProductPageExtension17StarRatingControl_touchOutsideMargin];
  double v10 = *(double *)&self->touchOutsideMargin[OBJC_IVAR____TtC20ProductPageExtension17StarRatingControl_touchOutsideMargin];
  id v11 = a4;
  v12 = self;
...
- (NSString)accessibilityLabel
{
  return (NSString *)sub_100680B48(self, (uint64_t)a2, 0xD00000000000001FLL, (void *)0x80000001007F9220);
}
...
- (NSString)accessibilityHint
{
  return (NSString *)sub_100680B48(self, (uint64_t)a2, 0xD00000000000001ELL, (void *)0x80000001007F9200);
}
...
- (NSString)accessibilityValue
{
  Swift::Int v2 = *(Swift::Int *)((char *)self + OBJC_IVAR____TtC20ProductPageExtension17StarRatingControl_rating);
  if (v2 < 0)
  {
    __break(1u);
  }
  ...
  {
    BOOL v3 = self;
    v6._object = (void *)0x80000001007F91E0;
    v6._countAndFlagsBits = 0xD00000000000001ALL;
    v7._countAndFlagsBits = 0;
    v7._object = (void *)0xE000000000000000;
    sub_1007743F0(v6, v2, v7);
...
{
  Swift::Int v2 = self;
  unint64_t v3 = sub_100680D90();

  if (v3)
  {
    sub_100019840(0, &qword_10096DBC0);
...
- (_TtC20ProductPageExtension17StarRatingControl)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC20ProductPageExtension17StarRatingControl *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
