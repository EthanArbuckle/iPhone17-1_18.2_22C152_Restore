...
- (_TtC20ProductPageExtension41ScreenshotGalleryCollectionViewFlowLayout)initWithCoder:(id)a3;
- (void)dealloc;
...
- (_TtC20ProductPageExtension41ScreenshotGalleryCollectionViewFlowLayout)initWithCoder:(id)a3
{
  ...
  result = (_TtC20ProductPageExtension41ScreenshotGalleryCollectionViewFlowLayout *)sub_10077D120();
  __break(1u);
  return result;
}
