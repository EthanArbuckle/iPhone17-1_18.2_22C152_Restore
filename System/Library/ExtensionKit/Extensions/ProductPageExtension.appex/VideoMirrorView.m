...
- (void)setBackgroundColor:(id)a3
{
  ...
  v6 = *(void **)&v4[OBJC_IVAR____TtC20ProductPageExtension15VideoMirrorView_videoLayer];
...
- (void)layoutSubviews
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension15VideoMirrorView_videoLayer];
  objc_super v4 = *(void **)&v2[OBJC_IVAR____TtC20ProductPageExtension10MirrorView_artworkLayer];
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC20ProductPageExtension15VideoMirrorView_videoLayer);
}
