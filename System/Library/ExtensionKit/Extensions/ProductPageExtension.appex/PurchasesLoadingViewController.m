...
- (_TtC20ProductPageExtension30PurchasesLoadingViewController)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  result = (_TtC20ProductPageExtension30PurchasesLoadingViewController *)sub_10077D120();
  __break(1u);
  return result;
}
...
{
  id v4 = a4;
  result = (_TtC20ProductPageExtension30PurchasesLoadingViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
