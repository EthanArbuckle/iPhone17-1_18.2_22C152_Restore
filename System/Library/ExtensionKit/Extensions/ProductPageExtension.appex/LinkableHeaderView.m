...
- (_TtC20ProductPageExtension18LinkableHeaderView)initWithFrame:(CGRect)a3
{
  return (_TtC20ProductPageExtension18LinkableHeaderView *)sub_10020AC64(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  v7 = self;
  double v8 = sub_10020B300((uint64_t)a4, width);
  double v10 = v9;
  double v12 = v11;
  double v14 = v13;
