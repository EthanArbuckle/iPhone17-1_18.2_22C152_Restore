...
- (_TtCC11MusicCoreUI15NoticePresenterP33_D8FBFBA4851A241D976DAD2E389878C120UIRootViewController)initWithCoder:(id)a3
{
  result = (_TtCC11MusicCoreUI15NoticePresenterP33_D8FBFBA4851A241D976DAD2E389878C120UIRootViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
{
  v2 = self;
  NoticePresenter.UIRootViewController.viewDidLoad()();
}

- (void)viewDidLayoutSubviews
{
  v2 = self;
  NoticePresenter.UIRootViewController.viewDidLayoutSubviews()();
}
...
- (void).cxx_destruct
{
  ...
  outlined destroy of CloudLibrary.StatusObserver.InternalObserver((uint64_t)v3);
}
