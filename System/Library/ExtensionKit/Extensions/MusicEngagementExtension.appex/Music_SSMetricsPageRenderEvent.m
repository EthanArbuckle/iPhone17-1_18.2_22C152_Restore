...
- (void)setStandardPropertiesWith:(id)a3 completionHandler:(id)a4
{
  ...
  *(void *)(v7 + 16) = v6;
  v8 = self;
  id v9 = a3;
  specialized Music_SSMetricsPageRenderEvent.setSamplingProperties(with:_:)(a3, v8, v8, (uint64_t)a3, (uint64_t)partial apply for thunk for @escaping @callee_unowned @convention(block) () -> (), v7);
