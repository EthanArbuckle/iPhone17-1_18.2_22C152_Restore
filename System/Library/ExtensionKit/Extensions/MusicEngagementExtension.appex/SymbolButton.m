...
{
  id v3 = a3;
  specialized SymbolButton.init(coder:)();
}
...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess();
  outlined init with copy of SymbolButton.Configuration(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  SymbolButton.apply(_:)((uint64_t)v4);
...
- (BOOL)isHighlighted
{
  return @objc SymbolButton.isHighlighted.getter(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  SymbolButton.isHighlighted.didset(v7);
}

- (BOOL)isSelected
{
  return @objc SymbolButton.isHighlighted.getter(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return @objc SymbolButton.isHighlighted.getter(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
- (id)contextMenuInteraction:(id)a3 configurationForMenuAtLocation:(CGPoint)a4
{
  id v5 = a3;
  double v6 = self;
  id v7 = specialized SymbolButton.contextMenuInteraction(_:configurationForMenuAtLocation:)();
...
{
  v2 = self;
  id v3 = SymbolButton.imageView.getter();
...
{
  v2 = self;
  id v3 = SymbolButton.titleLabel.getter();
...
- (void).cxx_destruct
{
  ...
  outlined consume of (@escaping @callee_guaranteed () -> ())?(*(uint64_t *)((char *)&self->super.super.super.super.isa
                                                                          + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler));
  outlined destroy of SymbolButton.Configuration((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  outlined consume of (@escaping @callee_guaranteed () -> ())?(*(uint64_t *)((char *)&self->super.super.super.super.isa
  ...
  outlined destroy of TaskPriority?((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &demangling cache variable for type metadata for SymbolButton.Metrics?);
}
...
- (id)pointerInteraction:(id)a3 styleForRegion:(id)a4
{
  ...
  id v7 = a4;
  objc_super v8 = self;
  objc_super v9 = (void *)specialized SymbolButton.pointerInteraction(_:styleFor:)(v6);
