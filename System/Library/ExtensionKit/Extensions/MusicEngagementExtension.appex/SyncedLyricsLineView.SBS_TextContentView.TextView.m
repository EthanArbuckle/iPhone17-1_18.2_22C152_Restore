...
{
  id v3 = a3;
  specialized SyncedLyricsLineView.SBS_TextContentView.TextView.init(coder:)();
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (a3.height != 0.0)
  {
    ...
    v6 = self;
    double v7 = SyncedLyricsLineView.SBS_TextContentView.TextView.frameAndSizeThatFits(_:)(width);
    v9 = v8;
    double v3 = v7;
    double v4 = v10;
  }
