...
- (_TtCE14MusicUtilitiesCSo14NSUserDefaultsP33_0EE8F48931DDE162065F15584D7CE3A39_Observer)init
{
  ...
  *(Class *)((char *)&v4->super.isa + v5) = (Class)v6;
  ...
  v9.receiver = v4;
  v9.super_class = (Class)type metadata accessor for NSUserDefaults._Observer();
...
LABEL_8:
  NSUserDefaults._Observer.observeValue(forKeyPath:of:change:context:)(v10, v12, (uint64_t)v18, v15, (uint64_t)a6);

  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  _sypSgWOh_0((uint64_t)v18);
}
