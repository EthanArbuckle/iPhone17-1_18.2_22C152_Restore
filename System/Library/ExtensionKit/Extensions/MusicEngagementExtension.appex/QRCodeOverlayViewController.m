...
{
  id v3 = a3;
  specialized QRCodeOverlayViewController.init(coder:)();
}
...
- (void).cxx_destruct
{
  ...
  outlined consume of Data._Representation(*(void *)&self->backgroundView[OBJC_IVAR____TtC11MusicCoreUI27QRCodeOverlayViewController_qrCode], *(void *)&self->qrCodeView[OBJC_IVAR____TtC11MusicCoreUI27QRCodeOverlayViewController_qrCode]);
