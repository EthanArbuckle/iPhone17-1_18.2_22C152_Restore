...
- (_TtC22SubscribePageExtension28SearchHintCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension28SearchHintCollectionViewCell *)sub_100661248(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC22SubscribePageExtension28SearchHintCollectionViewCell)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension28SearchHintCollectionViewCell_hintView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)[v6 init];
  ...
  result = (_TtC22SubscribePageExtension28SearchHintCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  BOOL v3 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension28SearchHintCollectionViewCell_hintView];
