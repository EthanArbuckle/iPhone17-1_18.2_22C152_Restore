...
- (_TtC22SubscribePageExtension24UpsellGridViewController)initWithCoder:(id)a3
{
  result = (_TtC22SubscribePageExtension24UpsellGridViewController *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void)loadView
{
  ...
  if (([(UpsellGridViewController *)v2 isViewLoaded] & 1) == 0) {
    [(UpsellGridViewController *)v2 setView:*(Class *)((char *)&v2->super.super.super.isa+ OBJC_IVAR____TtC22SubscribePageExtension24UpsellGridViewController_gridView)];
  }
}
...
{
  id v4 = a4;
  result = (_TtC22SubscribePageExtension24UpsellGridViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
