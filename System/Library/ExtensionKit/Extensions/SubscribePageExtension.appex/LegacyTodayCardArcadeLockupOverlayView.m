...
- (_TtC22SubscribePageExtension38LegacyTodayCardArcadeLockupOverlayView)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension38LegacyTodayCardArcadeLockupOverlayView *)sub_100537AEC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)_setContinuousCornerRadius:(double)a3
{
  ...
  id v5 = [*(id *)&v4[OBJC_IVAR____TtC22SubscribePageExtension38LegacyTodayCardArcadeLockupOverlayView_arcadeLockupView] layer];
...
- (void).cxx_destruct
{
  ...
  uint64_t v3 = *(uint64_t *)((char *)&self->super.super.super.isa
                  + OBJC_IVAR____TtC22SubscribePageExtension38LegacyTodayCardArcadeLockupOverlayView_impressionsUpdateBlock);
