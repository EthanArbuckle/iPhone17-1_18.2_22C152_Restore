...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  CGFloat v6 = sub_10064746C(width, height);
  double v8 = v7;
...
- (_TtC22SubscribePageExtension33AppPromotionDetailPageContentView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC22SubscribePageExtension33AppPromotionDetailPageContentView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC22SubscribePageExtension33AppPromotionDetailPageContentView_mediaOverlayStyle;
