...
- (_TtC22SubscribePageExtension31ListTodayCardCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension31ListTodayCardCollectionViewCell *)sub_100146538(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)_setContinuousCornerRadius:(double)a3
{
  ...
  v11 = self;
  [(ListTodayCardCollectionViewCell *)&v15 _setContinuousCornerRadius:a3];
  v14.receiver = v11;
  v14.super_class = ObjectType;
  [(ListTodayCardCollectionViewCell *)&v14 _continuousCornerRadius];
  double v13 = v12;
  (*(void (**)(char *, void, uint64_t))(v7 + 104))(v10, enum case for CornerStyle.continuous(_:), v6);
  sub_10014DC08((uint64_t)v10, 3, v13);
...
- (void).cxx_destruct
{
  ...
  sub_10000FED8((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension31ListTodayCardCollectionViewCell_cardStyle, &qword_100934A38);
