...
- (_TtC22SubscribePageExtension22UberCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtension22UberCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void)applyLayoutAttributes:(id)a3
{
  id v4 = a3;
  v5 = self;
  sub_1002A1E08((uint64_t)v4);
}

- (void).cxx_destruct
{
  sub_10002D20C((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension22UberCollectionViewCell_itemLayoutContext);
