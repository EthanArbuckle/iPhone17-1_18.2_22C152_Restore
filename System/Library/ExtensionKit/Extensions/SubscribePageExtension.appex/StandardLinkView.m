...
- (_TtC22SubscribePageExtension16StandardLinkView)initWithFrame:(CGRect)a3
{
  sub_10020FF9C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}

- (_TtC22SubscribePageExtension16StandardLinkView)initWithCoder:(id)a3
{
  result = (_TtC22SubscribePageExtension16StandardLinkView *)sub_100768A40();
  __break(1u);
  return result;
}
