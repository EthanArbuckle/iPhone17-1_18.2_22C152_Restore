...
- (_TtC22SubscribePageExtension35TopChartsDiffablePageViewController)initWithCoder:(id)a3;
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension35TopChartsDiffablePageViewController_isPresenterLoaded;
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v10 = (objc_class *)type metadata accessor for TopChartsDiffablePageViewController();
  v12.receiver = self;
  v12.super_class = v10;
  v11 = self;
  [(TopChartsDiffablePageViewController *)&v12 viewWillDisappear:v3];
  sub_1007670C0();
  sub_100761DC0();
...
{
  id v4 = a4;
  result = (_TtC22SubscribePageExtension35TopChartsDiffablePageViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC22SubscribePageExtension35TopChartsDiffablePageViewController_paletteContents));
  swift_bridgeObjectRelease();
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC22SubscribePageExtension35TopChartsDiffablePageViewController_categoriesBarButton));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC22SubscribePageExtension35TopChartsDiffablePageViewController_overlayViewController));
  id v3 = *(Class *)((char *)&self->super.super.super.isa
                + OBJC_IVAR____TtC22SubscribePageExtension35TopChartsDiffablePageViewController_selectCategoryViewController);
}
