...
- (_TtC22SubscribePageExtension26AppEventCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension26AppEventCollectionViewCell *)sub_1003AED18();
}
...
- (_TtC22SubscribePageExtension26AppEventCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC22SubscribePageExtension26AppEventCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10000FED8((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension26AppEventCollectionViewCell_itemLayoutContext, (uint64_t *)&unk_100934630);
}
