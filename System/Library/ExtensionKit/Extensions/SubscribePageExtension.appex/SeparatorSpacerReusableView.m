...
- (_TtC22SubscribePageExtension27SeparatorSpacerReusableView)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension27SeparatorSpacerReusableView *)sub_10024D0E0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension27SeparatorSpacerReusableView)initWithCoder:(id)a3
{
  ...
  v5[1] = v6;
  uint64_t v7 = OBJC_IVAR____TtC22SubscribePageExtension27SeparatorSpacerReusableView_lineView;
  ...
  *(Class *)((char *)&self->super.super.super.super.isa + v7) = (Class)objc_msgSend(v8, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC22SubscribePageExtension27SeparatorSpacerReusableView *)sub_100768A40();
  __break(1u);
  return result;
}
