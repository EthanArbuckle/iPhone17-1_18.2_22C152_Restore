...
- (_TtC22SubscribePageExtension27ArcadeHeaderButtonContainer)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension27ArcadeHeaderButtonContainer_stackView;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC22SubscribePageExtension27ArcadeHeaderButtonContainer *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (_TtC22SubscribePageExtension27ArcadeHeaderButtonContainer)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC22SubscribePageExtension27ArcadeHeaderButtonContainer *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
