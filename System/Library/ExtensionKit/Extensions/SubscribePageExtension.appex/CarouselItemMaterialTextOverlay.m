...
- (_TtC22SubscribePageExtension31CarouselItemMaterialTextOverlay)initWithFrame:(CGRect)a3
{
  sub_100547518(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  id v3 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension31CarouselItemMaterialTextOverlay_materialBackground];
  sub_10075C580();
...
- (void).cxx_destruct
{
  id v3 = (char *)self + OBJC_IVAR____TtC22SubscribePageExtension31CarouselItemMaterialTextOverlay_displayOptions;
