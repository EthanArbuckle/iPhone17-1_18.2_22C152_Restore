...
- (_TtC22SubscribePageExtension19PrivacyCategoryView)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension19PrivacyCategoryView *)sub_10030E8B4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension19PrivacyCategoryView)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtension19PrivacyCategoryView *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  v6 = self;
  double v7 = sub_100310064((uint64_t)a4);
  double v9 = v8;
  double v11 = v10;
  double v13 = v12;
