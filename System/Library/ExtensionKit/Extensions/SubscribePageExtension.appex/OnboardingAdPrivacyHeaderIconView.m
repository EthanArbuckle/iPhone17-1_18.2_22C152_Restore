...
- (_TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView)init
{
  return (_TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView *)sub_10038391C();
}

- (_TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView_label;
  id v6 = objc_allocWithZone((Class)UILabel);
  id v7 = a3;
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)[v6 init];
  uint64_t v8 = OBJC_IVAR____TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView_backgroundView;
  *(Class *)((char *)&self->super.super.super.isa + v8) = (Class)[objc_allocWithZone((Class)UIView) init];

  result = (_TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (_TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC22SubscribePageExtension33OnboardingAdPrivacyHeaderIconView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
