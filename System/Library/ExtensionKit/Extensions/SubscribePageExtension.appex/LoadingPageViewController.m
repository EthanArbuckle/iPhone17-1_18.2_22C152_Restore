...
- (_TtC22SubscribePageExtension25LoadingPageViewController)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtension25LoadingPageViewController *)sub_100768A40();
  __break(1u);
  return result;
}
...
{
  id v4 = a4;
  result = (_TtC22SubscribePageExtension25LoadingPageViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
