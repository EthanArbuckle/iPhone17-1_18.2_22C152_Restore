...
- (_TtC22SubscribePageExtension23CollectionTableViewCell)initWithCoder:(id)a3;
...
- (void)layoutSubviews
{
  ...
  objc_super v3 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension23CollectionTableViewCell_collectionView];
  if (v3)
  {
    v4 = v3;
...
- (_TtC22SubscribePageExtension23CollectionTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  return (_TtC22SubscribePageExtension23CollectionTableViewCell *)sub_10023B36C(a3, (uint64_t)a4, v6);
}

- (_TtC22SubscribePageExtension23CollectionTableViewCell)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC22SubscribePageExtension23CollectionTableViewCell_dataSource) = 0;
  swift_unknownObjectWeakInit();
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC22SubscribePageExtension23CollectionTableViewCell_collectionView) = 0;
  v6.receiver = self;
...
- (void).cxx_destruct
{
  ...
  sub_10000FB1C((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension23CollectionTableViewCell_delegate);
  objc_super v3 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC22SubscribePageExtension23CollectionTableViewCell_collectionView);
}
