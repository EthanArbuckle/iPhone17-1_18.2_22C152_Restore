...
- (_TtC22SubscribePageExtension29BundleSearchResultContentView)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension29BundleSearchResultContentView *)sub_10071B860(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC22SubscribePageExtension29BundleSearchResultContentView)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension29BundleSearchResultContentView_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  uint64_t v8 = OBJC_IVAR____TtC22SubscribePageExtension29BundleSearchResultContentView_bundleView;
  *(Class *)((char *)&self->super.super.super.isa + v8) = (Class)objc_msgSend(objc_allocWithZone((Class)type metadata accessor for BundleView()), "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC22SubscribePageExtension29BundleSearchResultContentView *)sub_100768A40();
  __break(1u);
  return result;
}
