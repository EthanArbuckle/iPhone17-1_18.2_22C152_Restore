...
- (id)activityViewController:(id)a3 itemForActivityType:(id)a4
{
  ...
  id v7 = a4;
  v8 = self;
  sub_10054557C((uint64_t)a4, (uint64_t)v17);
...
- (_TtC22SubscribePageExtension33NotesMetadataActivityItemProvider)initWithPlaceholderItem:(id)a3
{
  ...
  result = (_TtC22SubscribePageExtension33NotesMetadataActivityItemProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  uint64_t v3 = *(uint64_t *)((char *)&self->super.super.super.isa
                  + OBJC_IVAR____TtC22SubscribePageExtension33NotesMetadataActivityItemProvider____lazy_storage___notesMetadata);
  unint64_t v4 = *(void *)&self->metadata[OBJC_IVAR____TtC22SubscribePageExtension33NotesMetadataActivityItemProvider____lazy_storage___notesMetadata];
