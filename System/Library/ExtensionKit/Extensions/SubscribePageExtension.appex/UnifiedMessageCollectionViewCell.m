...
- (_TtC22SubscribePageExtension32UnifiedMessageCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension32UnifiedMessageCollectionViewCell *)sub_100517928(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension32UnifiedMessageCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtension32UnifiedMessageCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void)prepareForReuse
{
  ...
  objc_msgSend(*(id *)&v2[OBJC_IVAR____TtC22SubscribePageExtension32UnifiedMessageCollectionViewCell_inlineUnifiedMessageView], "removeFromSuperview", v3.receiver, v3.super_class);
  sub_100518668(0);
}

- (void).cxx_destruct
{
  sub_10002D20C((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension32UnifiedMessageCollectionViewCell_itemLayoutContext);
