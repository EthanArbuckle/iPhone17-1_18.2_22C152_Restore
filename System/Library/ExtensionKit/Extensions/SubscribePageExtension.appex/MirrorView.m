...
- (_TtC22SubscribePageExtension10MirrorView)initWithCoder:(id)a3
{
  ...
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension10MirrorView_artworkLayer;
  ...
  *((unsigned char *)&self->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension10MirrorView_imageObserversAdded) = 0;

  result = (_TtC22SubscribePageExtension10MirrorView *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void)setBackgroundColor:(id)a3
{
  ...
  objc_super v6 = *(void **)&v4[OBJC_IVAR____TtC22SubscribePageExtension10MirrorView_artworkLayer];
...
LABEL_8:
  sub_10023F268(v10, v12, (uint64_t)v18, v15, (uint64_t)a6);
...
- (_TtC22SubscribePageExtension10MirrorView)initWithFrame:(CGRect)a3
{
  result = (_TtC22SubscribePageExtension10MirrorView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
