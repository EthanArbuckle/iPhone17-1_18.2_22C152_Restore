...
- (_TtC22SubscribePageExtension42SearchResultsContextCardCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension42SearchResultsContextCardCollectionViewCell *)sub_1000C15C0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension42SearchResultsContextCardCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC22SubscribePageExtension42SearchResultsContextCardCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10002D20C((uint64_t)self+ OBJC_IVAR____TtC22SubscribePageExtension42SearchResultsContextCardCollectionViewCell_itemLayoutContext);
