...
- (void)_searchBarWillLayoutSubviews:(id)a3 inSearchFieldContainer:(id)a4 searchTextFieldFrame:(CGRect)a5 cancelButtonFrame:(CGRect)a6
{
  ...
  id v17 = a4;
  v18 = self;
  sub_1000D35FC(a4, v13, v12, v11, v10, x, y, width, height);
}

- (NSArray)keyCommands
{
  objc_super v2 = self;
  unint64_t v3 = sub_1000D29A0();
...
{
  id v4 = a3;
  id v5 = (_TtC22SubscribePageExtension16SearchController *)sub_1000D3BBC((uint64_t)a3);
...
- (_TtC22SubscribePageExtension16SearchController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC22SubscribePageExtension16SearchController *)sub_1000D2BEC(v5, v7, a4);
}

- (_TtC22SubscribePageExtension16SearchController)initWithCoder:(id)a3
{
  return (_TtC22SubscribePageExtension16SearchController *)sub_1000D2D74(a3);
}
...
- (void).cxx_destruct
{
  ...
  sub_10001A4D0(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC22SubscribePageExtension16SearchController_filterButtonHandler));
