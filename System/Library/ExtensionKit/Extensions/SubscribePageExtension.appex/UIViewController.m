...
+ (void)as_activatePresentationHack
{
  ...
  block[3] = &unk_10086E870;
  block[4] = a1;
  if (qword_10095BBC0 != -1) {
    dispatch_once(&qword_10095BBC0, block);
  }
}
...
- (_TtP22SubscribePageExtension20PageTraitEnvironment_)snapshotPageTraitEnvironment
{
  ...
  double v10 = &v9[OBJC_IVAR____TtC22SubscribePageExtension28SnapshotPageTraitEnvironment_pageContainerSize];
  *(void *)double v10 = v4;
  *((void *)v10 + 1) = v6;
  *(void *)&v9[OBJC_IVAR____TtC22SubscribePageExtension28SnapshotPageTraitEnvironment_traitCollection] = v7;
  v13.receiver = v9;
  v13.super_class = v8;
  uint64_t v11 = [(UIViewController *)&v13 init];

  return (_TtP22SubscribePageExtension20PageTraitEnvironment_ *)v11;
}
