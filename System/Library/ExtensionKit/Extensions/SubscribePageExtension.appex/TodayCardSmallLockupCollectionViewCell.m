...
- (_TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell *)sub_1001A8054(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  double v3 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell_lockupView];
...
- (void)prepareForReuse
{
  ...
  id v3 = objc_retain(*(id *)(*(void *)&v2[OBJC_IVAR____TtC22SubscribePageExtension38TodayCardSmallLockupCollectionViewCell_lockupView]
