...
- (_TtC22SubscribePageExtension24InfiniteScrollFooterView)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension24InfiniteScrollFooterView *)sub_1003AAD54(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC22SubscribePageExtension24InfiniteScrollFooterView)initWithCoder:(id)a3
{
  result = (_TtC22SubscribePageExtension24InfiniteScrollFooterView *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (qword_100931DD0 != -1) {
    swift_once();
  }
  uint64_t v6 = sub_100765180();
  sub_10001076C(v6, (uint64_t)qword_100994F08);
  sub_1007656F0();
  sub_10000FB44(&qword_100934A70);
  uint64_t v7 = swift_allocObject();
  *(_OWORD *)(v7 + 16) = xmmword_1007B8800;
  *(void *)(v7 + 32) = v5;
  id v8 = v5;
  v9 = (void *)sub_100765700();
  sub_100764BE0();
  double v11 = v10;
...
- (CGSize)intrinsicContentSize
{
  ...
  sub_10001076C(v4, (uint64_t)qword_100994F08);
  sub_1007656F0();
  sub_10000FB44(&qword_100934A70);
  uint64_t v5 = swift_allocObject();
  *(_OWORD *)(v5 + 16) = xmmword_1007B8800;
  *(void *)(v5 + 32) = v3;
  id v6 = v3;
  uint64_t v7 = (void *)sub_100765700();
  sub_100764BE0();
  double v9 = v8;
...
- (void)layoutSubviews
{
  ...
  CGFloat v8 = v7;
  CGFloat v10 = v9;
  double v11 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension24InfiniteScrollFooterView_activityIndicator];
