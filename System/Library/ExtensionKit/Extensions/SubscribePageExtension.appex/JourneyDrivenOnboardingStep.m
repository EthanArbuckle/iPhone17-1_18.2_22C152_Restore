...
- (void)engagement:(id)a3 didUpdateEngagementRequest:(id)a4 placement:(id)a5 serviceType:(id)a6 completion:(id)a7
{
  ...
  id v18 = a4;
  v19 = self;
  sub_100470DD8(v17, a4, v11, v13, v14, v16);
  _Block_release(v10);
...
- (void)engagement:(id)a3 didUpdateRequest:(id)a4 placement:(id)a5 serviceType:(id)a6
{
  ...
  id v16 = a4;
  id v17 = self;
  sub_1004702DC(v15, a4, v9, v11, v12, v14);
...
- (_TtC22SubscribePageExtension27JourneyDrivenOnboardingStep)init
{
  result = (_TtC22SubscribePageExtension27JourneyDrivenOnboardingStep *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC22SubscribePageExtension27JourneyDrivenOnboardingStep_onboardingEngagement));
  v3 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC22SubscribePageExtension27JourneyDrivenOnboardingStep_engagementViewController);
}
