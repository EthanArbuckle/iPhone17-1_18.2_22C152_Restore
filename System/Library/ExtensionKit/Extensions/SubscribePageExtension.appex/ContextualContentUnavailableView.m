...
- (void)layoutSubviews
{
  ...
  id v3 = *(void **)&v2[OBJC_IVAR____TtC22SubscribePageExtension32ContextualContentUnavailableView_emptyReason];
...
- (_TtC22SubscribePageExtension32ContextualContentUnavailableView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC22SubscribePageExtension32ContextualContentUnavailableView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
