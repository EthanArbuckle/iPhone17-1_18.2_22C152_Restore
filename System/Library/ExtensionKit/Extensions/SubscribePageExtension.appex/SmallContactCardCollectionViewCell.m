...
- (_TtC22SubscribePageExtension34SmallContactCardCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension34SmallContactCardCollectionViewCell *)sub_100749F58(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC22SubscribePageExtension34SmallContactCardCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC22SubscribePageExtension34SmallContactCardCollectionViewCell *)sub_100768A40();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10000FED8((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension34SmallContactCardCollectionViewCell_itemLayoutContext, (uint64_t *)&unk_100934630);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
