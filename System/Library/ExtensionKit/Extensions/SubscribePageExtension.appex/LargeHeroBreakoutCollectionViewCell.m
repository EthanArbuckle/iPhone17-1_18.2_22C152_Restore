...
- (_TtC22SubscribePageExtension35LargeHeroBreakoutCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension35LargeHeroBreakoutCollectionViewCell *)sub_1006D0300(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)applyLayoutAttributes:(id)a3
{
  id v4 = a3;
  id v5 = self;
  sub_1006D12E4((uint64_t)v4);
}

- (void).cxx_destruct
{
  sub_10000FED8((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension35LargeHeroBreakoutCollectionViewCell_itemLayoutContext, (uint64_t *)&unk_100934630);
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC22SubscribePageExtension35LargeHeroBreakoutCollectionViewCell_detailsView));
  uint64_t v3 = (char *)self + OBJC_IVAR____TtC22SubscribePageExtension35LargeHeroBreakoutCollectionViewCell_detailPosition;
  uint64_t v4 = sub_100762270();
