...
- (_TtC22SubscribePageExtension22HeroCarouselScrollView)initWithFrame:(CGRect)a3
{
  return (_TtC22SubscribePageExtension22HeroCarouselScrollView *)sub_100554E10(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void).cxx_destruct
{
  sub_10000FB1C((uint64_t)self + OBJC_IVAR____TtC22SubscribePageExtension22HeroCarouselScrollView_pagingDelegate);
