int64_t sub_1000143D4(id a1, NSArray *a2, NSArray *a3)
{
  id v5;
  id v6;
  id v7;
...
uint64_t sub_100023DC8()
{
  ...
  if (!*(void *)(v0 + 16) || (unint64_t v1 = sub_100023308(0xD000000000000010, 0x800000010002AFA0), (v2 & 1) == 0))
  {
    long long v9 = 0u;
    long long v10 = 0u;
    swift_bridgeObjectRelease();
  ...
  if (*(void *)(v8 + 16) && (unint64_t v4 = sub_100023308(0xD000000000000015, 0x800000010002AFC0), (v5 & 1) != 0))
  {
...
ValueMetadata *type metadata accessor for PFLASLAppEmbedding()
{
  return &type metadata for PFLASLAppEmbedding;
}
...
uint64_t sub_100024DA4()
{
  ...
  if (v2)
  {
    ...
    v0[7] = &type metadata for PFLASLAppEmbedding;
    sub_100024004(&qword_1000326D0);
    sub_1000255D0();
    sub_100024004(&qword_1000326D8);
    uint64_t v8 = swift_allocObject();
    *(_OWORD *)(v8 + 16) = xmmword_1000283D0;
    swift_bridgeObjectRetain();
    sub_100025500();
    sub_1000254F0();
    v0[8] = v8;
    ...
    sub_1000252D0();
    sub_100025650();
    (*(void (**)(uint64_t, void, uint64_t))(v4 + 104))(v3, enum case for PFLTaskSource.CKProd(_:), v18);
    sub_100025560();
    swift_allocObject();
    v0[16] = sub_100025550();
