uint64_t sub_100002E10(uint64_t a1, uint64_t a2, uint64_t a3)
{
  uint64_t v3;
  void *v7;
  uint64_t v9;
...
uint64_t sub_100003064(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
...
uint64_t sub_1000033F8(uint64_t a1)
{
  ...
  return _swift_task_switch(sub_100003514, 0, 0);
}
...
uint64_t sub_100003514()
{
  ...
  uint64_t v2 = v0[9];
  uint64_t v3 = v0[10];
  sub_10000393C(&qword_100008030);
  uint64_t v4 = swift_allocObject();
  *(_OWORD *)(v4 + 16) = xmmword_100003CA0;
  sub_100003B40();
  sub_100003B30();
  v0[7] = v4;
  sub_100003A24(&qword_100008038, (void (*)(uint64_t))&type metadata accessor for PFLPluginConsent);
  sub_10000393C(&qword_100008040);
  sub_100003980();
  sub_100003B80();
  (*(void (**)(uint64_t, void, uint64_t))(v3 + 104))(v1, enum case for PFLTaskSource.DodMLProd(_:), v2);
  sub_100003B70();
  swift_allocObject();
  v0[15] = sub_100003B60();
  uint64_t v5 = sub_100003AD0();
  swift_allocObject();
  uint64_t v6 = sub_100003AC0();
  v0[16] = v6;
  v0[5] = v5;
  uint64_t v7 = sub_100003A24((unint64_t *)&unk_100008050, (void (*)(uint64_t))&type metadata accessor for SiriMASPFLPluginRunner);
  v0[2] = v6;
  v0[6] = v7;
...
uint64_t sub_100003A24(unint64_t *a1, void (*a2)(uint64_t))
{
  uint64_t result = *a1;
  if (!result)
  {
