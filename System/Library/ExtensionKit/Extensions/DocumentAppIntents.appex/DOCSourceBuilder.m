...
- (id)buildSourcesFromLegacyPickerExtensions:(id)a3 legacyProviders:(id)a4
{
  ...
  if (v7)
  {
    ...
    v11 = &_s26DocumentManagerExecutables20DOCUSBEraseOperationC5StateON_ptr;
    *(void *)&long long v8 = 136315650;
    ...
    do
    {
      ...
      do
      {
        ...
        unsigned int v14 = objc_msgSend(v11[468], "defaultPermission", v29);
...
- (id)filterNonObsoleteLegacyPickersFromPickers:(id)a3 modernProviders:(id)a4
{
  ...
  long long v21 = sub_100004F7C;
  long long v22 = &unk_1005E4508;
  long long v23 = self;
  id v24 = v8;
  id v15 = v8;
