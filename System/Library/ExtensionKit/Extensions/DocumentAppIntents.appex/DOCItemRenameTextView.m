...
- (_TtC18DocumentAppIntents21DOCItemRenameTextView)initWithCoder:(id)a3;
- (_TtC18DocumentAppIntents21DOCItemRenameTextView)initWithFrame:(CGRect)a3 textContainer:(id)a4;
...
- (UIColor)backgroundColor
{
  return (UIColor *)sub_1003B2160(self, (uint64_t)a2, (SEL *)&selRef_backgroundColor);
}
...
- (void)didMoveToSuperview
{
  ...
  if (v2[OBJC_IVAR____TtC18DocumentAppIntents21DOCItemRenameTextView_backgroundStyle] == 1) {
    sub_1003AFD44();
  }
  if (v2[OBJC_IVAR____TtC18DocumentAppIntents21DOCItemRenameTextView_showsClearButton] == 1) {
    sub_1003B06D8();
  }
}
...
- (BOOL)textView:(id)a3 shouldChangeTextInRange:(_NSRange)a4 replacementText:(id)a5
{
  ...
  if (!v12 && (v7 == 10 && v9 == 0xE100000000000000 || (sub_1004F62F0() & 1) != 0))
  {
    sub_1003AF480(1);
    BOOL v13 = 0;
  }
...
- (id)textView:(id)a3 editMenuForTextInRange:(_NSRange)a4 suggestedActions:(id)a5
{
  sub_100032070(0, (unint64_t *)&qword_10065E840);
  UIMenuElementSize v7 = sub_1004F47F0();
  id v8 = a3;
  uint64_t v9 = self;
  Class v10 = sub_1003B2C28(v7);
...
{
  id v4 = a4;
  result = (_TtC18DocumentAppIntents21DOCItemRenameTextView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_100037E24((uint64_t)self + OBJC_IVAR____TtC18DocumentAppIntents21DOCItemRenameTextView_itemRenameDelegate);
  swift_release();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents21DOCItemRenameTextView____lazy_storage___backgroundView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents21DOCItemRenameTextView_contentSizeObserver));
  id v3 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents21DOCItemRenameTextView____lazy_storage___clearButton);
}

- (UITextViewDelegate)delegate
{
  return (UITextViewDelegate *)sub_1003B2160(self, (uint64_t)a2, (SEL *)&selRef_delegate);
}
