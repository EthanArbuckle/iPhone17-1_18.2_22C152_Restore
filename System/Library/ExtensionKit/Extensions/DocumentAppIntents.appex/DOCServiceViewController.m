...
- (_TtC18DocumentAppIntents24DOCServiceViewController)initWithCoder:(id)a3;
- (_TtC18DocumentAppIntents24DOCServiceViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (DOCConfiguration)configuration
{
  result = *(Class *)((char *)&self->super.super.super.isa
                    + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController__configuration);
  if (result) {
    return result;
  }
  __break(1u);
...
- (BOOL)isBrowserViewController
{
  return *((unsigned char *)&self->super.super.super.isa
         + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController_isBrowserViewController);
}

- (void)setIsBrowserViewController:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.isa
  + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController_isBrowserViewController) = a3;
}

- (BOOL)shouldOverrideWindowAppearance
{
  return *((unsigned char *)&self->super.super.super.isa
         + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController_shouldOverrideWindowAppearance);
}

- (void)setShouldOverrideWindowAppearance:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.isa
  + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController_shouldOverrideWindowAppearance) = a3;
}
...
- (_TtC18DocumentAppIntents24DOCServiceViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC18DocumentAppIntents24DOCServiceViewController *)sub_1000C62EC(v5, v7, a4);
}

- (_TtC18DocumentAppIntents24DOCServiceViewController)initWithCoder:(id)a3
{
  return (_TtC18DocumentAppIntents24DOCServiceViewController *)sub_1000C6498(a3);
}
...
- (void)viewDidMoveToWindow:(id)a3 shouldAppearOrDisappear:(BOOL)a4
{
  ...
  if (a3)
  {
    if ((*((unsigned char *)&self->super.super.super.isa
          + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController_shouldOverrideWindowAppearance) & 1) != 0)
    {
      uint64_t v7 = *(uint64_t *)((char *)&self->super.super.super.isa
                      + OBJC_IVAR____TtC18DocumentAppIntents24DOCServiceViewController_lastAppearance);
      id v8 = self;
      [a3 setAppearance:v7];
    }
    else
...
- (void)updateAppearance:(id)a3 completionBlock:(id)a4
{
  ...
  *(unsigned char *)(v8 + 48) = 0;
  ...
  id v11 = self;
  id v12 = v10;
  sub_100037DC4((uint64_t)v6);
  swift_release();
  DOCRunInMainThread();
  _Block_release(v9);
  sub_100037540((uint64_t)v6);
}
...
- (NSArray)preferredFocusEnvironments
{
  ...
  if (Strong)
  {
    ...
    *(_OWORD *)(v5 + 16) = xmmword_10050BF60;
    *(void *)(v5 + 32) = v4;
    sub_1004F4810();
  }
  else
  ...
  sub_1000305BC((uint64_t *)&unk_10065A7E0);
  v8.super.isa = sub_1004F47D0().super.isa;
