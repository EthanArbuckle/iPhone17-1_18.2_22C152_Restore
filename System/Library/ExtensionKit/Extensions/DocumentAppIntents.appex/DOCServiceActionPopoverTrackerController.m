...
- (_TtC18DocumentAppIntents40DOCServiceActionPopoverTrackerController)init;
...
- (_TtC18DocumentAppIntents40DOCServiceActionPopoverTrackerController)init
{
  result = (_TtC18DocumentAppIntents40DOCServiceActionPopoverTrackerController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents40DOCServiceActionPopoverTrackerController_action);
}
