...
- (_TtC18DocumentAppIntents16DOCActionManager)sourcesActionManager;
...
- (DOCSourceObserver)initWithUserAction:(unint64_t)a3 hostIdentifier:(id)a4
{
  ...
  if (v7)
  {
    ...
    v16 = objc_alloc_init(_TtC18DocumentAppIntents16DOCActionManager);
...
- (id)_addSubscriberForConfiguration:(id)a3 usingBlock:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100019A6C;
  block[3] = &unk_1005E4C58;
...
- (void)removeSubscriberForToken:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100019D1C;
  block[3] = &unk_1005E4CA8;
...
- (int)startObservingDefaultSaveLocation
{
  ...
  handler[2] = sub_10001B5D4;
  handler[3] = &unk_1005E4848;
  objc_copyWeak(&v6, &location);
