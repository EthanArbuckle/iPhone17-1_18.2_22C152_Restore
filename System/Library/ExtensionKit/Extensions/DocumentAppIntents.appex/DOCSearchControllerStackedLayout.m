...
- (_TtC18DocumentAppIntents32DOCSearchControllerStackedLayout)init;
...
- (void)_searchBarWillLayoutSubviews:(id)a3 inSearchFieldContainer:(id)a4 searchTextFieldFrame:(CGRect)a5 cancelButtonFrame:(CGRect)a6
{
  ...
  id v18 = a4;
  v19 = self;
  sub_10031DE3C(a3, a4, v13, v12, v11, v10, x, y, width, height);
}

- (_TtC18DocumentAppIntents32DOCSearchControllerStackedLayout)init
{
  result = (_TtC18DocumentAppIntents32DOCSearchControllerStackedLayout *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents32DOCSearchControllerStackedLayout_appMenuButton);
}
