...
- (_TtC18DocumentAppIntents16DOCNavigationBar)initWithCoder:(id)a3;
- (_TtC18DocumentAppIntents16DOCNavigationBar)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
...
- (_TtC18DocumentAppIntents16DOCNavigationBar)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC18DocumentAppIntents16DOCNavigationBar_titlePositionAdjustment) = 0;
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC18DocumentAppIntents16DOCNavigationBar_chromelessAppearanceDisabled) = 0;
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC18DocumentAppIntents16DOCNavigationBar_overrideScrollEdgeAppearance) = 0;
  id v4 = a3;

  result = (_TtC18DocumentAppIntents16DOCNavigationBar *)sub_1004F6110();
  __break(1u);
  return result;
}
...
- (UINavigationBarAppearance)scrollEdgeAppearance
{
  id v3 = *(UINavigationBarAppearance **)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC18DocumentAppIntents16DOCNavigationBar_overrideScrollEdgeAppearance);
  if (v3)
  {
    objc_super v4 = self;
    v5 = v3;
