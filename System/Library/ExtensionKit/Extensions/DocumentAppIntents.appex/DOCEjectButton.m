...
- (CGRect)frame;
- (_TtC18DocumentAppIntents14DOCEjectButton)initWithCoder:(id)a3;
- (_TtC18DocumentAppIntents14DOCEjectButton)initWithFrame:(CGRect)a3;
...
- (void)didMoveToWindow
{
  ...
  if (*((unsigned char *)v2 + OBJC_IVAR____TtC18DocumentAppIntents14DOCEjectButton_iconUpdateNeeded) == 1)
  {
...
- (_TtC18DocumentAppIntents14DOCEjectButton)initWithFrame:(CGRect)a3
{
  CGRect result = (_TtC18DocumentAppIntents14DOCEjectButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_super v3 = (char *)self + OBJC_IVAR____TtC18DocumentAppIntents14DOCEjectButton_buttonSize;
  uint64_t v4 = sub_1004F5AE0();
  (*(void (**)(char *, uint64_t))(*(void *)(v4 - 8) + 8))(v3, v4);
  id v5 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents14DOCEjectButton_color);
}
