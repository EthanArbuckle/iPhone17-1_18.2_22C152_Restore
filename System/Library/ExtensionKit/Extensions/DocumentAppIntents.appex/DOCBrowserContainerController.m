...
- (_TtC18DocumentAppIntents29DOCBrowserContainerController)init;
- (_TtC18DocumentAppIntents33DOCBrowserContainedViewController)contentViewController;
...
- (_TtC18DocumentAppIntents33DOCBrowserContainedViewController)contentViewController
{
  v2 = (id *)((char *)&self->super.super.super.super.isa
            + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_contentViewController);
  swift_beginAccess();
  return (_TtC18DocumentAppIntents33DOCBrowserContainedViewController *)*v2;
}
...
- (BOOL)allowsPickingMultipleItems
{
  return *((unsigned char *)&self->super.super.super.super.isa
         + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_allowsPickingMultipleItems);
}
...
{
  return *((unsigned char *)&self->super.super.super.super.isa
         + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_preventAppearanceForwarding);
}
...
- (void)setPreventAppearanceForwarding:(BOOL)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_preventAppearanceForwarding) = a3;
  if (v3 == 1 && !a3)
  {
    id v5 = self;
    sub_100398E48();
...
- (void)activateContentViewController
{
  uint64_t v3 = *(void *)&self->super.appearStateTracker[OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_dataSource];
...
- (void)viewDidLoad
{
  ...
  uint64_t v3 = *(void *)&v2[OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_dataSource + 8];
  uint64_t ObjectType = swift_getObjectType();
  if (((*(uint64_t (**)(uint64_t, uint64_t))(v3 + 40))(ObjectType, v3) & 1) == 0)
  {
    sub_100396B94();
    if (*(void *)&v2[OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_state] == 5) {
      sub_100396D04(0, 0, 0);
    }
  }
}
...
- (void)setEditing:(BOOL)a3 animated:(BOOL)a4
{
  ...
  v7 = (id *)&v6[OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_contentViewController];
  swift_beginAccess();
...
- (_TtC18DocumentAppIntents29DOCBrowserContainerController)init
{
  result = (_TtC18DocumentAppIntents29DOCBrowserContainerController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_unknownObjectWeakDestroy();
  sub_10039C488(*(unint64_t *)((char *)&self->super.super.super.super.isa
                                    + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_state));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_queue));
  sub_100037540(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_stateReporting));
  sub_100037E24((uint64_t)self + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_actionReporting);
  sub_100037E24((uint64_t)self + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController_overlayDelegate);
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  uint64_t v3 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents29DOCBrowserContainerController__containerNavigationItem);
}
...
- (void)revealWithItems:(id)a3 selectEvenIfVisible:(BOOL)a4 completionBlock:(id)a5
{
  ...
  *(void *)(v9 + 16) = v7;
  id v10 = self;
  DOCBrowserContainerController.reveal(items:selectEvenIfVisible:completionBlock:)(v8, a4, (uint64_t)sub_10039D1A4, v9);
