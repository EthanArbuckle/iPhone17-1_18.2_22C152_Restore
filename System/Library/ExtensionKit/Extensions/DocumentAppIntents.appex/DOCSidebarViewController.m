...
- (_TtC18DocumentAppIntents19DOCSearchController)searchController;
- (_TtC18DocumentAppIntents24DOCSidebarViewController)initWithCollectionViewLayout:(id)a3;
- (_TtC18DocumentAppIntents24DOCSidebarViewController)initWithConfiguration:(id)a3 sourceObserver:(id)a4;
- (_TtP18DocumentAppIntents32DOCSidebarViewControllerDelegate_)sidebarDelegate;
...
- (id)_newCollectionViewWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  ...
  id v10 = a4;
  v11 = self;
  id v12 = _s18DocumentAppIntents24DOCSidebarViewControllerC014_newCollectionE09withFrame010collectionE6LayoutSo012UICollectionE0CSgSo6CGRectV_So0meL0CSgtF_0(a4, x, y, width, height);
...
- (void)collectionView:(id)a3 didUpdateFocusInContext:(id)a4 withAnimationCoordinator:(id)a5
{
  ...
  id v10 = a5;
  uint64_t v11 = self;
  _s18DocumentAppIntents24DOCSidebarViewControllerC010collectionE0_16didUpdateFocusIn4withySo012UICollectionE0C_So0mejI7ContextCSo27UIFocusAnimationCoordinatorCtF_0(v8, v9);
}
...
- (id)collectionView:(id)a3 contextMenuConfigurationForItemAtIndexPath:(id)a4 point:(CGPoint)a5
{
  ...
  id v11 = a3;
  id v12 = self;
  Class v13 = sub_10028B01C((uint64_t)v10);
...
- (BOOL)isEditing
{
  uint64_t v2 = *(uint64_t *)((char *)&self->super.super.super.super.super.isa
                  + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_editingSession);
...
- (void)getTransitionControllerForURL:(id)a3 completionBlock:(id)a4
{
  ...
  *(void *)(v11 + 16) = v10;
  id v12 = self;
  id v13 = sub_10039B484();
  sub_1004F1460(v14);
  v16 = v15;
  aBlock[4] = sub_10039D250;
  aBlock[5] = v11;
  aBlock[0] = _NSConcreteStackBlock;
  aBlock[1] = 1107296256;
  aBlock[2] = sub_100135F98;
  aBlock[3] = &unk_100602718;
...
- (BOOL)sidebarHasActiveFocus
{
  return *((unsigned char *)&self->super.super.super.super.super.isa
         + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_sidebarHasActiveFocus);
}

- (void)setSidebarHasActiveFocus:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.super.super.isa
  + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_sidebarHasActiveFocus) = a3;
}
...
- (_TtP18DocumentAppIntents32DOCSidebarViewControllerDelegate_)sidebarDelegate
{
  ...
  return (_TtP18DocumentAppIntents32DOCSidebarViewControllerDelegate_ *)Strong;
}
...
- (_TtC18DocumentAppIntents16DOCPickerContext)pickerContext
{
  return (_TtC18DocumentAppIntents16DOCPickerContext *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.super.super.isa
                                                                                               + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_pickerContext));
}
...
- (DOCConcreteLocation)selectedLocation
{
  return (DOCConcreteLocation *)objc_retainAutoreleaseReturnValue((*(id **)((char *)&self->super.super.super.super.super.isa
                                                                          + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_locationSelection))[2]);
}

- (_TtC18DocumentAppIntents19DOCSearchController)searchController
{
  return (_TtC18DocumentAppIntents19DOCSearchController *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.super.super.isa
                                                                                                  + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_searchController));
}
...
- (void)setSearchController:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_searchController) = (Class)a3;
  id v3 = a3;
}

- (NSArray)additionalTrailingNavigationBarButtonItems
{
  return (NSArray *)sub_10049A33C((uint64_t)self, (uint64_t)a2, (uint64_t)&OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_additionalTrailingNavigationBarButtonItems, (unint64_t *)&qword_1006572E0);
}

- (void)setAdditionalTrailingNavigationBarButtonItems:(id)a3
{
  sub_100032070(0, (unint64_t *)&qword_1006572E0);
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_additionalTrailingNavigationBarButtonItems) = (Class)sub_1004F47F0();
  id v4 = self;
  swift_bridgeObjectRelease();
  sub_100498E4C();
}
...
- (NSArray)customActions
{
  return (NSArray *)sub_10049A33C((uint64_t)self, (uint64_t)a2, (uint64_t)&OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_customActions, (unint64_t *)&unk_1006593A0);
}
...
- (void)setCustomActions:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_customActions) = (Class)sub_1004F47F0();
  id v6 = self;
  swift_bridgeObjectRelease();
  id v4 = *(void (**)(uint64_t))((swift_isaMask & **(void **)((char *)&v6->super.super.super.super.super.isa
                                                                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_actionManager))
                                      + 0xB8);
...
- (_TtC18DocumentAppIntents24DOCSidebarViewController)initWithConfiguration:(id)a3 sourceObserver:(id)a4
{
  return (_TtC18DocumentAppIntents24DOCSidebarViewController *)sub_10049A5DC(a3, a4);
}
...
- (void).cxx_destruct
{
  sub_100037E24((uint64_t)self + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_sidebarDelegate);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_pickerContext));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_configuration));
  swift_release();
  swift_release();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_sourceObserver));
  swift_release();
  swift_bridgeObjectRelease();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_favoritesSubscriber));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_recentlyUsedFavoritesSubscriber));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_trashObserver));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_trashSubscriber));
  sub_10004B8B4((uint64_t)self + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController__diffableDataSource, &qword_10065B250);
  swift_bridgeObjectRelease();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_dropPointIndicatorView));
  swift_release();
  swift_release();
  swift_release();
  swift_release();
  sub_10004B8B4((uint64_t)self + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_preferredFocusIndexPath, &qword_100657B80);
  sub_1000AEAFC(*(id *)((char *)&self->super.super.super.super.super.isa+ OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_currentlySelectedSidebarItem), *(void *)&self->sidebarHasActiveFocus[OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_currentlySelectedSidebarItem], *(void *)&self->sidebarDelegate[OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_currentlySelectedSidebarItem+ 7], self->pickerContext[OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_currentlySelectedSidebarItem + 7]);
  swift_bridgeObjectRelease();
  swift_release();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_searchController));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_sourcesOrderObserver));
  swift_release();
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  swift_release();
  ...
  swift_bridgeObjectRelease();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_contextMenuInteraction));
  id v3 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_debugOptionsMenu);
}

- (_TtC18DocumentAppIntents24DOCSidebarViewController)initWithCollectionViewLayout:(id)a3
{
  id v3 = a3;
  result = (_TtC18DocumentAppIntents24DOCSidebarViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void)viewIsAppearing:(BOOL)a3
{
  ...
  if (v4[OBJC_IVAR____TtC18DocumentAppIntents24DOCSidebarViewController_diffableNeedsReload] == 1) {
    sub_1000A745C(v3, 1);
  }
  sub_100497434(0, 1);
  if (sub_100497FD8() == 2)
  {
    sub_1002062B4(v3, objc_msgSend(v4, "transitionCoordinator", v5.receiver, v5.super_class));
...
- (void)performFind:(id)a3
{
  ...
  {
    [v6 setActive:1];
    uint64_t v7 = (_TtC18DocumentAppIntents24DOCSidebarViewController *)[v6 searchBar];
...
- (BOOL)collectionView:(id)a3 shouldSelectItemAtIndexPath:(id)a4
{
  ...
  sub_1004F17F0();
  id v10 = (_TtC18DocumentAppIntents24DOCSidebarViewController *)a3;
  __n128 v11 = self;
  if (sub_100201FA8())
  {
  ...
  else
  {
    ...
    id v10 = v11;
    __n128 v11 = (_TtC18DocumentAppIntents24DOCSidebarViewController *)isa;
  }
...
- (BOOL)collectionView:(id)a3 shouldHighlightItemAtIndexPath:(id)a4
{
  ...
  id v10 = a3;
  __n128 v11 = self;
  LOBYTE(self) = sub_1004A620C((uint64_t)v9);
...
- (BOOL)collectionView:(id)a3 shouldSpringLoadItemAtIndexPath:(id)a4 withContext:(id)a5
{
  ...
  LOBYTE(self) = sub_1004D2BC4((uint64_t)v10);
...
- (id)collectionView:(id)a3 targetIndexPathForMoveFromItemAtIndexPath:(id)a4 toProposedIndexPath:(id)a5
{
  ...
  v19(v10, v7);
  v19(v13, v7);
  v20.super.Class isa = sub_1004F17B0().super.isa;
  v19(v16, v7);
...
- (id)collectionView:(id)a3 dropSessionDidUpdate:(id)a4 withDestinationIndexPath:(id)a5
{
  ...
  swift_unknownObjectRetain();
  uint64_t v15 = self;
  v16 = sub_1004D3CF4(a4, (uint64_t)v11);
...
- (int64_t)_collectionView:(id)a3 dataOwnerForDropSession:(id)a4 withDestinationIndexPath:(id)a5
{
  ...
  sub_1000321E8((uint64_t)v14, (uint64_t)v11, &qword_100657B80);
  ...
  if (result != 1)
  {
    ...
    swift_unknownObjectRetain();
    uint64_t v22 = self;
    int64_t v18 = sub_1004D4324((uint64_t)v11);
    (*(void (**)(char *, uint64_t))(v16 + 8))(v11, v15);

    swift_unknownObjectRelease();
LABEL_9:
    sub_10004B8B4((uint64_t)v14, &qword_100657B80);
    return v18;
  }
  __break(1u);
  return result;
