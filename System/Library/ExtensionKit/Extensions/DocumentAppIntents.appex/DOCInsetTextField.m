...
- (_TtC18DocumentAppIntentsP33_4B4B60590F5E6428796A006052D5B07C17DOCInsetTextField)initWithCoder:(id)a3;
- (_TtC18DocumentAppIntentsP33_4B4B60590F5E6428796A006052D5B07C17DOCInsetTextField)initWithFrame:(CGRect)a3;
@end
...
- (CGRect)textRectForBounds:(CGRect)a3
{
  ...
  v7 = self;
  double v8 = sub_1004278AC(x, y, width, height);
  double v10 = v9;
  double v12 = v11;
  double v14 = v13;
