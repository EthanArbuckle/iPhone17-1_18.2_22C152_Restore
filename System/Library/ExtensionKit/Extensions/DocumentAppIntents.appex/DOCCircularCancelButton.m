...
- (_TtC18DocumentAppIntents23DOCCircularCancelButton)initWithFrame:(CGRect)a3;
...
- (_TtC18DocumentAppIntents23DOCCircularCancelButton)initWithFrame:(CGRect)a3
{
  result = (_TtC18DocumentAppIntents23DOCCircularCancelButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
