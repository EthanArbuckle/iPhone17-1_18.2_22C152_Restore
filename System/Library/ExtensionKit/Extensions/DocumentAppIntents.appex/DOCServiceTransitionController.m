...
- (_TtC18DocumentAppIntents30DOCServiceTransitionController)init;
- (void)endTransition;
...
- (_TtC18DocumentAppIntents30DOCServiceTransitionController)init
{
  result = (_TtC18DocumentAppIntents30DOCServiceTransitionController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
