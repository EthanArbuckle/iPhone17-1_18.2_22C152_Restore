...
- (_TtC18DocumentAppIntents27DOCProgressCollectionViewer)init;
- (_TtC18DocumentAppIntents27DOCProgressCollectionViewer)initWithRootViewController:(id)a3;
...
- (void)traitCollectionDidChange:(id)a3
{
  id v5 = a3;
  v6 = self;
  sub_100473C98((uint64_t)a3);
}

- (BOOL)isEditing
{
  return [*(id *)((char *)&self->super.super.super.super.super.isa+ OBJC_IVAR____TtC18DocumentAppIntents27DOCProgressCollectionViewer_listViewController) isEditing];
}
...
- (void)setEditing:(BOOL)a3
{
  ...
  id v5 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents27DOCProgressCollectionViewer_listViewController);
  v6 = self;
  v7 = self;
...
- (_TtC18DocumentAppIntents27DOCProgressCollectionViewer)init
{
  CGSize result = (_TtC18DocumentAppIntents27DOCProgressCollectionViewer *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents27DOCProgressCollectionViewer_listViewController));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents27DOCProgressCollectionViewer_adaptablePresenter));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18DocumentAppIntents27DOCProgressCollectionViewer____lazy_storage___dismissButtonItem));
  id v3 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC18DocumentAppIntents27DOCProgressCollectionViewer_listFittingHeightKVO);
}
