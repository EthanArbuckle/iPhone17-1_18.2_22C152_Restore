...
{
  v68.receiver = self;
  v68.super_class = (Class)TVUsageTableViewCell;
  v4 = [(TVUsageTableViewCell *)&v68 initWithStyle:a3 reuseIdentifier:a4];
  if (v4)
  {
    v5 = (UIImageView *)[objc_alloc((Class)UIImageView) initForAutolayout];
    ...
    v8 = (UILabel *)[objc_alloc((Class)UILabel) initForAutolayout];
    ...
    v14 = (UILabel *)[objc_alloc((Class)UILabel) initForAutolayout];
    ...
    v20 = (UILabel *)[objc_alloc((Class)UILabel) initForAutolayout];
    ...
    uint64_t v40 = +[NSLayoutConstraint constraintWithItem:v4->_textLabel attribute:5 relatedBy:0 toItem:v4->_imageView attribute:6 multiplier:1.0 constant:16.0];
    textLeadingConstraint = v4->_textLeadingConstraint;
    v4->_textLeadingConstraint = (NSLayoutConstraint *)v40;
...
- (void)updateConstraints
{
  ...
  if (textLeadingConstraint)
  {
    ...
    double v12 = self->_textLeadingConstraint;
  ...
  else
  {
    ...
    double v17 = +[NSLayoutConstraint constraintWithItem:v14 attribute:5 relatedBy:0 toItem:v16 attribute:5 multiplier:1.0 constant:16.0];
    double v18 = self->_textLeadingConstraint;
    self->_textLeadingConstraint = v17;
  }
  [(NSLayoutConstraint *)self->_textLeadingConstraint setActive:1];
  v19.receiver = self;
  v19.super_class = (Class)TVUsageTableViewCell;
...
{
  id v4 = a3;
  objc_storeWeak((id *)&self->_item, v4);
  v5 = [v4 title];
  ...
  if (v9)
  {
    ...
    if (v12 == 0.0)
    {
      ...
      [v13 scale];
      objc_msgSend(v9, "setDestinationScale:");
    }
    else
    {
    ...
    objc_msgSend(v9, "setFittingSize:", 44.0, 44.0);
...
{
  v3.receiver = self;
  v3.super_class = (Class)TVUsageTableViewCell;
  [(TVUsageTableViewCell *)&v3 prepareForReuse];
  objc_storeWeak((id *)&self->_item, 0);
...
- (TVUsageEntityItem)item
{
  ...
  return (TVUsageEntityItem *)WeakRetained;
}
