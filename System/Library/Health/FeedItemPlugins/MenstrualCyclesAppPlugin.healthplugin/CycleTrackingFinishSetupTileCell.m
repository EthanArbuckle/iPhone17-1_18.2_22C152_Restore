...
- (_TtC24MenstrualCyclesAppPlugin32CycleTrackingFinishSetupTileCell)initWithFrame:(CGRect)a3
{
  return (_TtC24MenstrualCyclesAppPlugin32CycleTrackingFinishSetupTileCell *)sub_24136FBD8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC24MenstrualCyclesAppPlugin32CycleTrackingFinishSetupTileCell)initWithCoder:(id)a3
{
  ...
  *((void *)v4 + 4) = 0;
  ...
  result = (_TtC24MenstrualCyclesAppPlugin32CycleTrackingFinishSetupTileCell *)sub_241633038();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC24MenstrualCyclesAppPlugin32CycleTrackingFinishSetupTileCell_item;
