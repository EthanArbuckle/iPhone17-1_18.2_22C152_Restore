...
- (void).cxx_destruct
{
  ...
  sub_2411CD138((uint64_t)self+ OBJC_IVAR____TtC24MenstrualCyclesAppPlugin56MenstrualCyclesOnboardingFertilityTrackingViewController_delegate);
...
- (void)cancelButtonTapped:(id)a3
{
  ...
  swift_retain();
  id v6 = sub_2411D33C8((uint64_t)sub_241475790, v5);
  swift_release_n();
  [(MenstrualCyclesOnboardingFertilityTrackingViewController *)v4 presentViewController:v6 animated:1 completion:0];
