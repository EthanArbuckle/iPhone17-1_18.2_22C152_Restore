...
- (HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry)initWithExtractionResult:(id)a3 accountIdentifier:(id)a4
{
  ...
  id v7 = a4;
  v14.receiver = self;
  v14.super_class = (Class)HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry;
...
- (BOOL)isEqual:(id)a3
{
  id v5 = (HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry *)a3;
  id v6 = v5;
  if (self != v5)
  {
    id v7 = v5;
...
LABEL_18:
    ...
    uint64_t v11 = [(HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry *)v7 extractionResult];
    if (!v11)
    {
      unsigned __int8 v13 = 0;
LABEL_17:
    ...
    id v8 = [(HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry *)v7 extractionResult];
    if ([(HDExtractionResult *)v12 isEqual:v8])
    {
LABEL_9:
      accountIdentifier = self->_accountIdentifier;
      uint64_t v15 = [(HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry *)v7 accountIdentifier];
      ...
      {
        v16 = (void *)v15;
        uint64_t v17 = [(HDMedicalDownloadableAttachmentsInExtractionResultJournalEntry *)v7 accountIdentifier];
        if (v17)
        {
          v18 = (void *)v17;
