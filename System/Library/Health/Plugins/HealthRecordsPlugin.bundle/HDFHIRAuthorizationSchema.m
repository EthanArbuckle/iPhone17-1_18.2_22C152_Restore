...
- (id)queryParameters
{
  ...
  if (sub_2E0AC((uint64_t)v3) == (char *)&dword_0 + 2)
  {
...
- (id)bodyParameters
{
  ...
  if (sub_2E0AC((uint64_t)v4) != (char *)&dword_0 + 1) {
    goto LABEL_17;
  }
