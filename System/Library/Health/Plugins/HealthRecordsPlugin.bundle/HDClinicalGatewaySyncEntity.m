...
+ (HDSyncEntityIdentifier)syncEntityIdentifier
{
  return +[HDSyncEntityIdentifier identifierWithSchema:@"com.apple.healthd.healthrecords.sync-schema" entity:3];
}
...
+ (BOOL)generateSyncObjectsForSession:(id)a3 syncAnchorRange:(HDSyncAnchorRange)a4 profile:(id)a5 messageHandler:(id)a6 error:(id *)a7
{
  ...
  id v19 = v15;
  id v30 = v19;
  unsigned int v20 = +[HDClinicalGatewayEntity performReadTransactionWithHealthDatabase:v16 error:a7 block:v27];
...
+ (int64_t)nextSyncAnchorWithSession:(id)a3 startSyncAnchor:(int64_t)a4 profile:(id)a5 error:(id *)a6
{
  ...
  id v14 = +[HDClinicalGatewayEntity nextSyncAnchorWithStartAnchor:a4 predicate:v12 session:v11 healthDatabase:v13 error:a6];
  return (int64_t)v14;
}
...
{
  id v3 = a3;
  id v4 = [objc_alloc((Class)HDCodableClinicalGateway) initWithData:v3];
...
+ (int64_t)receiveSyncObjects:(id)a3 version:(id)a4 syncStore:(id)a5 profile:(id)a6 error:(id *)a7
{
  ...
  unsigned int v17 = +[HDClinicalGatewayEntity _insertCodableGateways:syncProvenance:profile:error:](HDClinicalGatewayEntity, "_insertCodableGateways:syncProvenance:profile:error:", v15, [v13 syncProvenance], v14, a7);
