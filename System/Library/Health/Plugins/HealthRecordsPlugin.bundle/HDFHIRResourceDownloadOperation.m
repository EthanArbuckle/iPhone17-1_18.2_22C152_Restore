...
- (void)main
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v16 = 2114;
      id v17 = v3;
      _os_log_impl(&dword_0, v5, OS_LOG_TYPE_DEFAULT, "%{public}@ will skip download for %{public}@: %{public}@", (uint8_t *)&v12, 0x20u);
    }
  ...
  if ((v10 & 2) != 0)
  {
    ...
    if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v20;
      _os_log_impl(&dword_0, v19, OS_LOG_TYPE_DEFAULT, "%{public}@ BYPASSING FHIR REQUEST, this FHIR resource download request has the \"skip web request\" option set.", buf, 0xCu);
    }
    ...
    if (v7)
    {
      if (v12)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v46 = 2048;
        int64_t v47 = a4;
        _os_log_debug_impl(&dword_0, v33, OS_LOG_TYPE_DEBUG, "%{public}@ fetching %{public}@ resources with %zd retry(ies) remaining", buf, 0x20u);
      }
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v27 = 2048;
        int64_t v28 = a4;
        _os_log_impl(&dword_0, v15, OS_LOG_TYPE_DEFAULT, "%{public}@ fetching encountered error: %{public}@. %zd retry(ies) remaining", buf, 0x20u);
      }
...
+ (id)FHIRDateStringFromDate:(id)a3
{
  uint64_t v3 = qword_1371A0;
  id v4 = a3;
  if (v3 != -1) {
    dispatch_once(&qword_1371A0, &stru_114A70);
  }
  id v5 = [(id)qword_137198 stringFromDate:v4];
...
+ (id)FHIRDateTimeStringFromDate:(id)a3
{
  uint64_t v3 = qword_1371B0;
  id v4 = a3;
  if (v3 != -1) {
    dispatch_once(&qword_1371B0, &stru_114A90);
  }
  id v5 = [(id)qword_1371A8 stringFromDate:v4];
