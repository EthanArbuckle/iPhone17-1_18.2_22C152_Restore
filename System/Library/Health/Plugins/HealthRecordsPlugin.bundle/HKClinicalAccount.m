...
- (HKClinicalAccount)initWithDaemonClinicalAccount:(id)a3
{
  ...
  id v8 = +[HKClinicalSharingStatus clinicalSharingFeatureStatusWithAccountState:v4 gatewayFeatureStatus:v7];
  ...
  if (v12)
  {
    ...
    unsigned __int8 v16 = [v15 hasClinicalSharingScopes];
  }
  else
  {
