...
- (HDFHIRSpecification)initWithConnectionInformation:(id)a3
{
  ...
  v8 = [(HDFHIRSpecification *)&v13 init];
  if (v8)
  {
        ...
        else
        {
          ...
          if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            id v41 = v12;
            _os_log_fault_impl(&dword_0, v13, OS_LOG_TYPE_FAULT, "Error instantiating resource schema: %@", buf, 0xCu);
          }
        }
      ...
      do
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            id v41 = v21;
            _os_log_fault_impl(&dword_0, v23, OS_LOG_TYPE_FAULT, "Error instantiating resource schema: %@", buf, 0xCu);
          }
        }
