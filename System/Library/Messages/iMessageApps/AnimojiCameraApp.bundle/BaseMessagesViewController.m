...
- (BOOL)isLandscapeMode
{
  return (char *)[(BaseMessagesViewController *)self currentOrientation] - 3 < (unsigned char *)&dword_0 + 2;
}
...
- (NSString)landscapeOverlayMessage
{
  ...
  uint64_t v3 = [v2 localizedStringForKey:@"StickersLandscapeTrapMessage" value:&stru_C498 table:@"Localizable"];
  ...
  if (v8)
  {
    if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v16 = v8;
      _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "[BaseAnimoji] updating snapshottingEnabled applying currentValue: %@", buf, 0xCu);
    }
...
+ (UIViewController)pendingChildViewController
{
  return (UIViewController *)(id)qword_12048;
}
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      if (v7)
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "[BaseAnimoji] updateSnapshotWithCompletionBlock snapshots enabled", buf, 2u);
        }
      ...
      else
      {
        if (v8)
        {
          *(_WORD *)dispatch_time_t v11 = 0;
          _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "[BaseAnimoji] updateSnapshotWithCompletionBlock snapshots disabled, returning 1x1 empty snapshot", v11, 2u);
        }
    ...
    else
    {
      ...
      {
        v10[0] = 0;
        _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "[BaseAnimoji] updateSnapshotWithCompletionBlock snapshots disabled", (uint8_t *)v10, 2u);
      }
      v4[2](v4, 0);
    }
  }
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        CGSize v12 = objc_msgSend(v11, "identifier", v19);
