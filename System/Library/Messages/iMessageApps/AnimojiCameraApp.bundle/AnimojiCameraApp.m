id sub_36F8(uint64_t a1, uint64_t a2)
{
  id result;
...
void sub_3724(uint64_t a1)
{
}

void sub_372C(uint64_t a1)
{
...
void sub_450C(uint64_t a1)
{
  if ([*(id *)(a1 + 32) needsLandscapeOverlayUpdate])
  {
    if ([*(id *)(a1 + 32) isLandscapeMode])
    {
      ...
      dispatch_time_t v2 = [*(id *)(a1 + 32) landscapeTrapOverlay];
...
void sub_4BE8(id *a1)
{
  ...
  if ([WeakRetained snapshottingEnabledUpdateIdentifier] == a1[6])
  {
    if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v4 = 138412290;
      id v5 = v3;
      _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, "[BaseAnimoji] updating snapshottingEnabled applying futureValue: %@", (uint8_t *)&v4, 0xCu);
    }
    objc_msgSend(WeakRetained, "setSnapshottingEnabled:", objc_msgSend(a1[4], "BOOLValue"));
  }
}

void sub_5D10(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
...
void sub_5D30(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  id v5 = (id *)(a1 + 32);
  id v6 = a4;
  id v7 = a3;
...
{
  int v2 = [*(id *)(a1 + 32) splashViewController];
  id v3 = [v2 view];
  [v3 setAlpha:0.0];

  id v5 = [*(id *)(a1 + 32) pickerController];
  int v4 = [v5 view];
  [v4 setAlpha:1.0];
}

id sub_70A8(uint64_t a1)
{
  int v2 = [*(id *)(a1 + 32) splashViewController];
  id v3 = [v2 view];
...
{
  return _AVTUIHasDisplayedCameraEffectsSplashScreen();
}
...
uint64_t AVTUISetHasDisplayedCameraEffectsCameraDisclosureSplashScreen()
{
  return _AVTUISetHasDisplayedCameraEffectsCameraDisclosureSplashScreen();
}

uint64_t AVTUISetHasDisplayedCameraEffectsSplashScreen()
{
  return _AVTUISetHasDisplayedCameraEffectsSplashScreen();
}
...
id objc_msgSend_avatarPickerDelegate(void *a1, const char *a2, ...)
{
  return [a1 avatarPickerDelegate];
}
...
id objc_msgSend_defaultLayoutStyle(void *a1, const char *a2, ...)
{
  return [a1 defaultLayoutStyle];
}
...
id objc_msgSend_dismissLaunchScreenIfNecessary(void *a1, const char *a2, ...)
{
  return [a1 dismissLaunchScreenIfNecessary];
}
...
id objc_msgSend_forwardingPicker(void *a1, const char *a2, ...)
{
  return [a1 forwardingPicker];
}
...
id objc_msgSend_pickerController(void *a1, const char *a2, ...)
{
  return [a1 pickerController];
}
...
id objc_msgSend_requestExpandedPresentation(void *a1, const char *a2, ...)
{
  return [a1 requestExpandedPresentation];
}
...
id objc_msgSend_showsSplashScreen(void *a1, const char *a2, ...)
{
  return [a1 showsSplashScreen];
}
...
id objc_msgSend_splashViewController(void *a1, const char *a2, ...)
{
  return [a1 splashViewController];
}
