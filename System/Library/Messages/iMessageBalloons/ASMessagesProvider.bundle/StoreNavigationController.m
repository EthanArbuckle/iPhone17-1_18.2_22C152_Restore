...
- (_TtC18ASMessagesProvider25StoreNavigationController)initWithCoder:(id)a3;
- (_TtC18ASMessagesProvider25StoreNavigationController)initWithNavigationBarClass:(Class)a3 toolbarClass:(Class)a4;
- (_TtC18ASMessagesProvider25StoreNavigationController)initWithNibName:(id)a3 bundle:(id)a4;
- (_TtC18ASMessagesProvider25StoreNavigationController)initWithRootViewController:(id)a3;
...
- (_TtC18ASMessagesProvider25StoreNavigationController)initWithCoder:(id)a3
{
  result = (_TtC18ASMessagesProvider25StoreNavigationController *)sub_77EB20();
  __break(1u);
  return result;
}
...
- (_TtC18ASMessagesProvider25StoreNavigationController)initWithNavigationBarClass:(Class)a3 toolbarClass:(Class)a4
{
  result = (_TtC18ASMessagesProvider25StoreNavigationController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
