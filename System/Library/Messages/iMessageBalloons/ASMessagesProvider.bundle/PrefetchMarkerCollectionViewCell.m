...
- (_TtC18ASMessagesProvider32PrefetchMarkerCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  v9 = (char *)self + OBJC_IVAR____TtC18ASMessagesProvider32PrefetchMarkerCollectionViewCell_itemLayoutContext;
...
- (_TtC18ASMessagesProvider32PrefetchMarkerCollectionViewCell)initWithCoder:(id)a3
{
  v5 = (char *)self + OBJC_IVAR____TtC18ASMessagesProvider32PrefetchMarkerCollectionViewCell_itemLayoutContext;
  uint64_t v6 = sub_771720();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v6 - 8) + 56))(v5, 1, 1, v6);
  id v7 = a3;

  result = (_TtC18ASMessagesProvider32PrefetchMarkerCollectionViewCell *)sub_77EB20();
  __break(1u);
  return result;
}
