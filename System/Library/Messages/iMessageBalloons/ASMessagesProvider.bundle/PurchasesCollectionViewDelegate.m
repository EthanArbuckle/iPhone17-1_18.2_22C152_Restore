...
- (void)scrollViewDidScroll:(id)a3
{
  v3 = *(void (**)(id))((char *)&self->super.isa
                                 + OBJC_IVAR____TtC18ASMessagesProvider31PurchasesCollectionViewDelegate_didScrollHandler);
  if (v3)
  {
    id v5 = a3;
    v6 = self;
...
- (void)collectionView:(id)a3 willDisplayCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  v13 = (char *)a4;
  v14 = self;
  sub_5CD8A4(v12, v13, (uint64_t)v11);
...
- (void)collectionView:(id)a3 didEndDisplayingCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  uint64_t v12 = *(uint64_t *)((char *)&self->super.isa
                   + OBJC_IVAR____TtC18ASMessagesProvider31PurchasesCollectionViewDelegate_artworkLoader);
  uint64_t v13 = *(uint64_t *)((char *)&self->super.isa
                   + OBJC_IVAR____TtC18ASMessagesProvider31PurchasesCollectionViewDelegate_objectGraph);
  id v14 = a3;
  id v15 = a4;
  v16 = self;
  sub_664AD4(v15, (uint64_t)v11, v12, v13);
...
- (BOOL)collectionView:(id)a3 shouldSelectItemAtIndexPath:(id)a4
{
  ...
  sub_76C120();
  uint64_t v10 = (_TtC18ASMessagesProvider31PurchasesCollectionViewDelegate *)a3;
  v11 = self;
  Class isa = sub_76C0E0().super.isa;
  uint64_t v13 = (_TtC18ASMessagesProvider31PurchasesCollectionViewDelegate *)[(PurchasesCollectionViewDelegate *)v10 cellForItemAtIndexPath:isa];
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  id v11 = a3;
  uint64_t v12 = self;
  sub_5CD33C(v9, (uint64_t)v9, v10, v11);
...
- (_TtC18ASMessagesProvider31PurchasesCollectionViewDelegate)init
{
  result = (_TtC18ASMessagesProvider31PurchasesCollectionViewDelegate *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (double)collectionView:(id)a3 tableLayout:(id)a4 heightForHeaderInSection:(int64_t)a5
{
  uint64_t v8 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC18ASMessagesProvider31PurchasesCollectionViewDelegate_pageTraits);
  id v9 = a3;
  id v10 = a4;
  id v11 = self;
...
- (double)collectionView:(id)a3 tableLayout:(id)a4 heightForRowAtIndexPath:(id)a5
{
  ...
  v16 = self;
  swift_unknownObjectRetain();
  sub_65935C((uint64_t)v11, v12, v13, v14);
  double v18 = v17;
...
- (id)collectionView:(id)a3 tableLayout:(id)a4 trailingSwipeActionsConfigurationForRowAtIndexPath:(id)a5
{
  ...
  id v13 = a4;
  id v14 = self;
  id v15 = sub_5CE73C((uint64_t)v11);
