...
- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithSectionProvider:(id)a3 configuration:(id)a4
{
  ...
  *(void *)(v6 + 16) = v5;
  return (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout *)sub_3C5EEC((uint64_t)sub_3C7E10, v6, a4);
}

- (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.super.isa
           + OBJC_IVAR____TtC18ASMessagesProvider33BaseCollectionCompositionalLayout_indexPathsRequiringRubberbanding) = (Class)&_swiftEmptySetSingleton;
  v4 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtC18ASMessagesProvider33BaseCollectionCompositionalLayout_pendingPrepareObserver);
  void *v4 = 0;
  v4[1] = 0;
  id v5 = a3;

  result = (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout *)sub_77EB20();
  __break(1u);
  return result;
}
...
- (id)layoutAttributesForElementsInRect:(CGRect)a3
{
  ...
  if (v8)
  {
    v9 = v8;
    sub_F76C0();
    unint64_t v10 = sub_77D890();

    id v11 = v7;
    sub_3C7754(v10);

    swift_bridgeObjectRelease();
    v12.super.isa = sub_77D880().super.isa;
    swift_bridgeObjectRelease();
  }
  else
  {
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  {
    NSArray v12 = v11;
    id v11 = sub_3C5794(v12);

    id v8 = (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout *)v12;
  }
...
- (id)layoutAttributesForSupplementaryViewOfKind:(id)a3 atIndexPath:(id)a4
{
  return sub_3C6784(self, (uint64_t)a2, (uint64_t)a3, (uint64_t)a4, (SEL *)&selRef_layoutAttributesForSupplementaryViewOfKind_atIndexPath_);
}

- (id)layoutAttributesForDecorationViewOfKind:(id)a3 atIndexPath:(id)a4
{
  return sub_3C6784(self, (uint64_t)a2, (uint64_t)a3, (uint64_t)a4, (SEL *)&selRef_layoutAttributesForDecorationViewOfKind_atIndexPath_);
}
...
- (void)prepareLayout
{
  ...
  v3 = (uint64_t *)&v2[OBJC_IVAR____TtC18ASMessagesProvider33BaseCollectionCompositionalLayout_pendingPrepareObserver];
  uint64_t v4 = *(void (**)(char *))&v2[OBJC_IVAR____TtC18ASMessagesProvider33BaseCollectionCompositionalLayout_pendingPrepareObserver];
  if (v4)
  {
    swift_retain();
    v4(v2);
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)a3
{
  ...
  double x = a3.origin.x;
  id v7 = self;
  unsigned __int8 v8 = sub_3C69D0(x, y, width, height);
...
- (id)invalidationContextForBoundsChange:(CGRect)a3
{
  ...
  double x = a3.origin.x;
  id v7 = self;
  id v8 = sub_3C6C80(x, y, width, height);
...
{
  id v3 = a3;
  result = (_TtC18ASMessagesProvider33BaseCollectionCompositionalLayout *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
