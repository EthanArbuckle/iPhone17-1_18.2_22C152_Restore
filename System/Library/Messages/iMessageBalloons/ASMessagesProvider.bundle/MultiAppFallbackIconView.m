...
- (_TtC18ASMessagesProvider24MultiAppFallbackIconView)initWithFrame:(CGRect)a3
{
  return (_TtC18ASMessagesProvider24MultiAppFallbackIconView *)sub_334BFC(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  double v7 = sub_3351A4(width, height);
  double v9 = v8;
...
- (void).cxx_destruct
{
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC18ASMessagesProvider24MultiAppFallbackIconView_iconReusePool;
