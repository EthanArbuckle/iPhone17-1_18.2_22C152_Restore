...
- (_TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
...
- (_TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell *)sub_49903C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell_lockupView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell *)sub_77EB20();
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  v3 = *(void **)&v2[OBJC_IVAR____TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell_lockupView];
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider35SmallSearchLockupCollectionViewCell_lockupView));
}
