...
- (CGRect)frame;
- (_TtCC18ASMessagesProvider30ArticleContainerViewControllerP33_F28B2BC817961B9098740FBAC1DC899A13ContainerView)initWithCoder:(id)a3;
- (_TtCC18ASMessagesProvider30ArticleContainerViewControllerP33_F28B2BC817961B9098740FBAC1DC899A13ContainerView)initWithFrame:(CGRect)a3;
...
- (void)setFrame:(CGRect)a3
{
  ...
  if (!CGRectEqualToRect(v26, v27))
  {
    v22 = *(void (**)(uint64_t))((char *)&v9->super.super.super.isa
                                         + OBJC_IVAR____TtCC18ASMessagesProvider30ArticleContainerViewControllerP33_F28B2BC817961B9098740FBAC1DC899A13ContainerView_frameUpdatedCallback);
    if (v22)
    {
      uint64_t v23 = swift_retain();
      v22(v23);
      sub_13308((uint64_t)v22);
    }
  }
}
