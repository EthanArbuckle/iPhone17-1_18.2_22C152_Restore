...
- (int64_t)collectionView:(id)a3 numberOfItemsInSection:(int64_t)a4
{
  unint64_t v4 = *(unint64_t *)((char *)&self->super.super.super.super.super.isa
                           + OBJC_IVAR____TtC18ASMessagesProvider32ScreenshotsGalleryViewController_artworks);
  if (!(v4 >> 62)) {
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  id v10 = a3;
  v11 = self;
  uint64_t v12 = sub_76C160();
  uint64_t v13 = OBJC_IVAR____TtC18ASMessagesProvider32ScreenshotsGalleryViewController_selectedIndex;
  if ((Class)v12 != *(Class *)((char *)&v11->super.super.super.super.super.isa
                              + OBJC_IVAR____TtC18ASMessagesProvider32ScreenshotsGalleryViewController_selectedIndex))
  {
    Class isa = sub_76C0E0().super.isa;
    [v10 scrollToItemAtIndexPath:isa atScrollPosition:16 animated:1];

    *(Class *)((char *)&v11->super.super.super.super.super.isa + v13) = (Class)sub_76C160();
  }
...
- (double)collectionView:(id)a3 layout:(id)a4 minimumInteritemSpacingForSectionAtIndex:(int64_t)a5
{
  return sub_615EE4(self, (uint64_t)a2, a3, a4, a5, (SEL *)&selRef_setMinimumInteritemSpacing_);
}

- (double)collectionView:(id)a3 layout:(id)a4 minimumLineSpacingForSectionAtIndex:(int64_t)a5
{
  return sub_615EE4(self, (uint64_t)a2, a3, a4, a5, (SEL *)&selRef_setMinimumLineSpacing_);
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC18ASMessagesProvider32ScreenshotsGalleryViewController_galleryLayout);
}
