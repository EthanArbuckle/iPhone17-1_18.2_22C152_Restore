...
- (_TtCC18ASMessagesProvider29NavigationBarPalettePresenter18PaletteContentView)initWithCoder:(id)a3;
- (_TtCC18ASMessagesProvider29NavigationBarPalettePresenter18PaletteContentView)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
...
- (void)layoutSubviews
{
  ...
  v3 = *(void (**)(uint64_t))&v2[OBJC_IVAR____TtCC18ASMessagesProvider29NavigationBarPalettePresenter18PaletteContentView_didLayoutSubviews];
  if (v3)
  {
...
- (_TtCC18ASMessagesProvider29NavigationBarPalettePresenter18PaletteContentView)initWithFrame:(CGRect)a3
{
  ...
  v8 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtCC18ASMessagesProvider29NavigationBarPalettePresenter18PaletteContentView_didLayoutSubviews);
