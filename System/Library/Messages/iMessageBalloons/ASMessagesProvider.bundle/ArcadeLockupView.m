...
- (_TtC18ASMessagesProvider16ArcadeLockupView)initWithFrame:(CGRect)a3
{
  uint64_t v4 = OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerButton;
  *(Class *)((char *)&self->super.super.super.isa + v4) = (Class)objc_msgSend(objc_allocWithZone((Class)type metadata accessor for OfferButton()), "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  v5 = (_OWORD *)((char *)self + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerLabelPresenter);
  _OWORD *v5 = 0u;
  v5[1] = 0u;
  v6 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerButtonTapHandler);
  void *v6 = 0;
  v6[1] = 0;

  result = (_TtC18ASMessagesProvider16ArcadeLockupView *)sub_77EB20();
  __break(1u);
  return result;
}
...
- (_TtC18ASMessagesProvider16ArcadeLockupView)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerButton;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  v8 = (_OWORD *)((char *)self + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerLabelPresenter);
  _OWORD *v8 = 0u;
  v8[1] = 0u;
...
- (void)offerButtonWasTapped
{
  ...
  if (v2)
  {
    uint64_t v3 = *(uint64_t *)((char *)&self->super.super.super.isa
                    + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerButton);
    double v4 = self;
    sub_13318((uint64_t)v2);
    v2(v3);
...
- (_TtC19AppStoreKitInternal16DynamicTypeLabel)accessibilitySubtitleLabel
{
  return (_TtC19AppStoreKitInternal16DynamicTypeLabel *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.isa
                                                                                                + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_subtitleLabel));
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_wordmarkView));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_subtitleLabel));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerButton));
  sub_FD94((uint64_t)self + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_offerLabelPresenter);
  uint64_t v3 = (char *)self + OBJC_IVAR____TtC18ASMessagesProvider16ArcadeLockupView_metrics;
  uint64_t v4 = sub_7721E0();
