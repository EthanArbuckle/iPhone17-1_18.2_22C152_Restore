...
- (void)scrollViewDidScroll:(id)a3
{
  if (*(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC18ASMessagesProvider33SearchHintsCollectionViewDelegate_impressionsCalculator))
  {
    id v4 = a3;
    v5 = self;
    swift_retain();
...
- (_TtC18ASMessagesProvider33SearchHintsCollectionViewDelegate)init
{
  CGSize result = (_TtC18ASMessagesProvider33SearchHintsCollectionViewDelegate *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
