...
- (_TtC18ASMessagesProvider18ExpandableTextView)initWithCoder:(id)a3;
- (_TtC18ASMessagesProvider18ExpandableTextView)initWithFrame:(CGRect)a3;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  objc_super v6 = *(void **)&v5[OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_textLabel];
  id v7 = objc_msgSend(v5, "backgroundColor", v10.receiver, v10.super_class);
  [v6 setBackgroundColor:v7];

  v8 = *(void **)&v5[OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_moreButton];
...
- (void)tintColorDidChange
{
  ...
  double v3 = *(void **)&v2[OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_moreButton];
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  objc_msgSend(*(id *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_textLabel), "measurementsWithFitting:in:", a4, a3.width, a3.height);
  double v8 = width;
  result.var3 = v7;
  result.var2 = v6;
  result.var1 = v5;
...
- (void)moreFrom:(id)a3
{
  double v3 = *(void (**)(uint64_t))((char *)&self->super.super.super.isa
                                      + OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_moreTapHandler);
  if (v3)
  {
    id v5 = a3;
    double v7 = self;
...
- (_TtC19AppStoreKitInternal16DynamicTypeLabel)accessibilityTextLabel
{
  return (_TtC19AppStoreKitInternal16DynamicTypeLabel *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.isa
                                                                                                + OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_textLabel));
}

- (_TtC18ASMessagesProvider18ExpandableTextView)initWithFrame:(CGRect)a3
{
  JUMeasurements result = (_TtC18ASMessagesProvider18ExpandableTextView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_textLabel));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_moreButton));
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_languageAwareString));
...
- (BOOL)hasContent
{
  return [*(id *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC18ASMessagesProvider18ExpandableTextView_textLabel) hasContent];
}
