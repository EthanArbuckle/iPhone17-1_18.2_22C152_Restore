...
- (_TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout)init
{
  return (_TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout *)sub_1FBB50();
}

- (_TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout)initWithCoder:(id)a3
{
  *(void *)&self->pinningEnabled[OBJC_IVAR____TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout_layoutDelegate] = 0;
  swift_unknownObjectWeakInit();
  id v5 = a3;

  result = (_TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout *)sub_77EB20();
  __break(1u);
  return result;
}
...
- (void)prepareForCollectionViewUpdates:(id)a3
{
  sub_FE2C(0, (unint64_t *)&unk_95C620);
  unint64_t v4 = sub_77D890();
  id v5 = self;
  sub_1FBD18(v4);
...
- (void)finalizeCollectionViewUpdates
{
  ...
  v3 = &v2[OBJC_IVAR____TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout_indexPathsToSlideInAppearAnimate];
  swift_beginAccess();
  *(void *)v3 = _swiftEmptyArrayStorage;
  swift_bridgeObjectRelease();
  unint64_t v4 = &v2[OBJC_IVAR____TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout_indexPathsToFadeDisappearAnimate];
  swift_beginAccess();
...
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)a3
{
  return sub_1FC86C(self, (uint64_t)a2, (uint64_t)a3, (uint64_t (*)(char *))sub_1FC558);
}

- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)a3
{
  return sub_1FC86C(self, (uint64_t)a2, (uint64_t)a3, (uint64_t (*)(char *))sub_1FC6EC);
}
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  v14.receiver = v8;
  v14.super_class = v10;
  v11 = (_TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout *)[(GuidedSearchTokenPaletteCollectionViewLayout *)&v14 layoutAttributesForItemAtIndexPath:isa];

  if (v11)
  {
    id v12 = sub_1FCFBC(v11);
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)a3
{
  ...
  {
    char v8 = v7[OBJC_IVAR____TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout_pinningEnabled];
  }
...
- (void).cxx_destruct
{
  sub_174B8((uint64_t)self + OBJC_IVAR____TtC18ASMessagesProvider44GuidedSearchTokenPaletteCollectionViewLayout_layoutDelegate);
  swift_bridgeObjectRelease();
