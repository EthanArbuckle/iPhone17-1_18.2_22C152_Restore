...
- (_TtC18ASMessagesProvider41ScreenshotGalleryCollectionViewFlowLayout)initWithCoder:(id)a3;
- (void)dealloc;
...
{
  v3 = (char *)self
     + OBJC_IVAR____TtC18ASMessagesProvider41ScreenshotGalleryCollectionViewFlowLayout_indexPathAtInitialScroll;
...
- (_TtC18ASMessagesProvider41ScreenshotGalleryCollectionViewFlowLayout)initWithCoder:(id)a3
{
  ...
  result = (_TtC18ASMessagesProvider41ScreenshotGalleryCollectionViewFlowLayout *)sub_77EB20();
  __break(1u);
  return result;
}
