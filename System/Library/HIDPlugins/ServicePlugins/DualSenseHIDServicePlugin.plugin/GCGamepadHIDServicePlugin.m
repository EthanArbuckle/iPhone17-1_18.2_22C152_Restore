...
LABEL_17:
  ...
  if (v19)
  {
    ...
    {
      float v20 = +[NSPredicate predicateWithBlock:&stru_185E8];
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_4D20())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG)) {
      sub_FC08((uint64_t)v7, (uint64_t)v8, v13);
    }
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v4 setObject:&off_19618 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_1F6C0 != -1) {
    dispatch_once(&qword_1F6C0, &stru_18630);
  }
  float v5 = (float)(v4 * dword_1F6C8 / *(unsigned int *)algn_1F6CC) / 1000000000.0;
  float idleTimeoutDuration = self->_idleTimeoutDuration;
  int v7 = sub_50C4();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    CFStringRef v8 = &stru_18A00;
