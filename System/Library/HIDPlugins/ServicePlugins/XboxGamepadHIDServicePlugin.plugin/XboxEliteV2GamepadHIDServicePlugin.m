...
- (void)dispatchPowerOnMessageCompletion:(id)a3
{
  ...
  __int16 v15 = 8197;
  unsigned __int8 sequence = self->super._sequence;
  do
  {
  ...
  while (!v8);
  self->super._unsigned __int8 sequence = v8 + 1;
  unsigned __int8 v16 = v8;
  __int16 v17 = 1;
  sub_3794(self, (unsigned __int8 *)&v15, 5, v6, 0);
  __int16 v12 = 8197;
  unsigned __int8 v10 = self->super._sequence;
  do
  {
  ...
  while (!v11);
  self->super._unsigned __int8 sequence = v11 + 1;
  unsigned __int8 v13 = v11;
  __int16 v14 = 1551;
  sub_3794(self, (unsigned __int8 *)&v12, 5, v9, v4);
}

- (void)handleInputPayload:(int64_t)a3 withData:(id)a4 timestamp:(unint64_t)a5
{
  id v7 = a4;
  unsigned __int8 v8 = [v7 bytes];
  id v9 = [v7 length];
