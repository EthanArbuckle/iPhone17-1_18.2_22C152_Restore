...
LABEL_17:
  ...
  if (v19)
  {
    ...
    {
      float v20 = +[NSPredicate predicateWithBlock:&stru_24668];
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_311C())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG)) {
      sub_173A0((uint64_t)v7, (uint64_t)v8, v13);
    }
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v4 setObject:&off_25F30 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_2B4D0 != -1) {
    dispatch_once(&qword_2B4D0, &stru_246B0);
  }
  float v5 = (float)(v4 * dword_2B4D8 / *(unsigned int *)algn_2B4DC) / 1000000000.0;
  float idleTimeoutDuration = self->_idleTimeoutDuration;
  int v7 = sub_34C0();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    CFStringRef v8 = &stru_24F38;
