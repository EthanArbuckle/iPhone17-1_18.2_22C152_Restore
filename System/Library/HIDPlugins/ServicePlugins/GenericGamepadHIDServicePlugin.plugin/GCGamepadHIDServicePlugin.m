...
LABEL_17:
  ...
  if (v19)
  {
    ...
    {
      float v20 = +[NSPredicate predicateWithBlock:&stru_18728];
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_3174())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG)) {
      sub_FD28((uint64_t)v7, (uint64_t)v8, v13);
    }
  }
...
- (void)setupRawReportHandling
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"GCGamepadHIDServicePlugin.m" lineNumber:510 description:@"Subclasses must override this method."];
}
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v4 setObject:&off_19998 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_1F360 != -1) {
    dispatch_once(&qword_1F360, &stru_18770);
  }
  float v5 = (float)(v4 * dword_1F368 / *(unsigned int *)algn_1F36C) / 1000000000.0;
  float idleTimeoutDuration = self->_idleTimeoutDuration;
  int v7 = sub_3518();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    CFStringRef v8 = &stru_191D8;
...
- (void)enableHaptics
{
  ...
  dispatch_async((dispatch_queue_t)internalQueue, v4);
  objc_destroyWeak(&v5);
  objc_destroyWeak(&location);
}
