...
LABEL_17:
  ...
  if (v19)
  {
    ...
    {
      float v20 = +[NSPredicate predicateWithBlock:&stru_146C0];
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_388C())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG)) {
      sub_CBF0((uint64_t)v7, (uint64_t)v8, v13);
    }
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v4 setObject:&off_15408 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_1B460 != -1) {
    dispatch_once(&qword_1B460, &stru_14708);
  }
