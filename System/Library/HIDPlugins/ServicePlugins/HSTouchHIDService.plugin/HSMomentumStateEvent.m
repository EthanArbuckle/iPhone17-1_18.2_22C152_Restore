...
{
  v6.receiver = self;
  v6.super_class = (Class)HSMomentumStateEvent;
...
- (NSString)description
{
  CFStringRef v2 = @"kHSMomentumStateEnd";
  if (!self->state) {
    CFStringRef v2 = @"kHSMomentumStateStart";
  }
...
- (void)encodeToMap:(void *)a3
{
  HSUtil::Encoder::encodeUInt((HSUtil::Encoder *)a3, (const CoderKey *)HSUtil::CoderKey::Literal<(char)115,(char)116,(char)97,(char)116,(char)101>::Key, self->state);
  v5 = (const CoderKey *)HSUtil::CoderKey::Literal<(char)115,(char)117,(char)98,(char)116,(char)121,(char)112,(char)101>::Key;
  unint64_t subtype = self->subtype;

  HSUtil::Encoder::encodeUInt((HSUtil::Encoder *)a3, v5, subtype);
}

- (BOOL)decodeFromMap:(void *)a3
{
  self->state = HSUtil::Decoder::decodeUInt((HSUtil::Decoder *)a3, (const CoderKey *)HSUtil::CoderKey::Literal<(char)115,(char)116,(char)97,(char)116,(char)101>::Key);
  if (*(_DWORD *)a3)
  {
  ...
  self->unint64_t subtype = HSUtil::Decoder::decodeUInt((HSUtil::Decoder *)a3, (const CoderKey *)HSUtil::CoderKey::Literal<(char)115,(char)117,(char)98,(char)116,(char)121,(char)112,(char)101>::Key);
  if (*(_DWORD *)a3)
  {
    memset(__b, 170, sizeof(__b));
    basename_r("/Library/Caches/com.apple.xbs/Sources/Multitouch/MT2TPHIDService/HSTrackpad/HSTrackpadDefs.mm", __b);
...
+ (const)hsClassName
{
  return (const CoderKey *)HSUtil::CoderKey::Literal<(char)72,(char)83,(char)77,(char)111,(char)109,(char)101,(char)110,(char)116,(char)117,(char)109,(char)83,(char)116,(char)97,(char)116,(char)101,(char)69,(char)118,(char)101,(char)110,(char)116>::Key;
}
...
- (BOOL)hsDecode:(void *)a3
{
  ...
  *((void *)&v5 + 1) = 0xAAAAAAAAAAAAAAAALL;
  ...
  {
    BOOL v6 = [(HSMomentumStateEvent *)self decodeFromMap:&v9];
  }
  if ((void)v11) {
