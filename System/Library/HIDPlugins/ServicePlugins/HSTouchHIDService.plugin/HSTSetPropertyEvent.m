...
@implementation HSTSetPropertyEvent
...
+ (const)hsClassName
{
  return (const CoderKey *)HSUtil::CoderKey::Literal<(char)72,(char)83,(char)84,(char)83,(char)101,(char)116,(char)80,(char)114,(char)111,(char)112,(char)101,(char)114,(char)116,(char)121,(char)69,(char)118,(char)101,(char)110,(char)116>::Key;
}

- (void)encodeToMap:(void *)a3
{
  v6.receiver = self;
  v6.super_class = (Class)HSTSetPropertyEvent;
...
{
  v8.receiver = self;
  v8.super_class = (Class)HSTSetPropertyEvent;
  if (-[HSTEvent decodeFromMap:](&v8, "decodeFromMap:"))
  {
    ...
    if (*(_DWORD *)a3)
    {
      ...
      if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR)) {
        -[HSTSetPropertyEvent decodeFromMap:]();
      }
    }
    else
    {
...
- (BOOL)hsEncode:(void *)a3
{
  ...
  [(HSTSetPropertyEvent *)self encodeToMap:a3];
  if (!*(_DWORD *)a3) {
...
- (BOOL)hsDecode:(void *)a3
{
  ...
  *((void *)&v5 + 1) = 0xAAAAAAAAAAAAAAAALL;
  ...
  if (*(_DWORD *)a3)
  {
    ...
    if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR)) {
      -[HSTSetPropertyEvent hsDecode:]();
    }
    BOOL v6 = 0;
  }
  else
  {
    BOOL v6 = [(HSTSetPropertyEvent *)self decodeFromMap:&v9];
  }
  if ((void)v11) {
