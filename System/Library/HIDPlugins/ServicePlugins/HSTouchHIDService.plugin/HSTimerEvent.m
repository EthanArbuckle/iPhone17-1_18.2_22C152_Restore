...
{
  v6.receiver = self;
  v6.super_class = (Class)HSTimerEvent;
...
- (void)encodeToMap:(void *)a3
{
  ...
  v5 = (const CoderKey *)HSUtil::CoderKey::Literal<(char)107,(char)101,(char)121>::Key;
  key = self->key;

  HSUtil::Encoder::encodeNSString((HSUtil::Encoder *)a3, v5, key);
}
...
- (BOOL)decodeFromMap:(void *)a3
{
  ...
  HSUtil::Decoder::decodeNSString((HSUtil::Decoder *)a3, (const CoderKey *)HSUtil::CoderKey::Literal<(char)107,(char)101,(char)121>::Key);
...
+ (const)hsClassName
{
  return (const CoderKey *)HSUtil::CoderKey::Literal<(char)72,(char)83,(char)84,(char)105,(char)109,(char)101,(char)114,(char)69,(char)118,(char)101,(char)110,(char)116>::Key;
}
...
- (BOOL)hsDecode:(void *)a3
{
  ...
  *((void *)&v5 + 1) = 0xAAAAAAAAAAAAAAAALL;
  ...
  {
    BOOL v6 = [(HSTimerEvent *)self decodeFromMap:&v9];
  }
  if ((void)v11) {
