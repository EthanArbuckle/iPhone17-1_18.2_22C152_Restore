...
LABEL_17:
  ...
  if (v19)
  {
    ...
    {
      float v20 = +[NSPredicate predicateWithBlock:&stru_105E8];
...
- (BOOL)setProperty:(id)a3 forKey:(id)a4 client:(id)a5
{
  ...
  if (sub_3128())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG)) {
      sub_9E10((uint64_t)v7, (uint64_t)v8, v13);
    }
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v4 setObject:&off_10FA0 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  if (qword_17028 != -1) {
    dispatch_once(&qword_17028, &stru_10630);
  }
  float v5 = (float)(v4 * dword_17030 / *(unsigned int *)algn_17034) / 1000000000.0;
  float idleTimeoutDuration = self->_idleTimeoutDuration;
  int v7 = sub_34CC();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    CFStringRef v8 = &stru_10A18;
