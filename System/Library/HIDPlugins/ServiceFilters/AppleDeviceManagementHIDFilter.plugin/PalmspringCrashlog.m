...
{
  if (qword_11330 != -1) {
    dispatch_once(&qword_11330, &stru_C3E0);
  }
  v2 = (void *)qword_11328;
  ...
  if (v9)
  {
    ...
    if ((unint64_t)[v8 length] > 7)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
        sub_8544(v7, (unsigned __int8 *)v14, v15);
      }
      ...
      {
        objc_msgSend(v13, "subdataWithRange:", 8, v16);
...
LABEL_17:
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&v33[6] = v29;
          __int16 v34 = 1024;
          LODWORD(v35) = v30;
          _os_log_error_impl(&dword_0, v25, OS_LOG_TYPE_ERROR, "CRC (0x%04x) of crashlog %@ did not match CRC in header (0x%04x)", buf, 0x18u);
        }
      }
      else
      {
...
+ (BOOL)writeToDirectory:(id)a3 crashlogData:(id)a4 name:(id)a5 options:(unint64_t)a6 error:(id *)a7
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v43 = 2048;
    unint64_t v44 = a6;
    _os_log_debug_impl(&dword_0, v16, OS_LOG_TYPE_DEBUG, "%@, directory %@, options %lu", buf, 0x20u);
  }
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v45 = 2112;
      id v46 = v32;
      _os_log_impl(&dword_0, v30, OS_LOG_TYPE_DEFAULT, "Writing crashlog %@ to %@ %@, error %@", buf, 0x2Au);
    }
