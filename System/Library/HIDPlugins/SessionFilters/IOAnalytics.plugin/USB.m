...
void __get_kCAEvent_USB_Device_Daily_block_invoke(id a1)
{
  ...
  v2 = get_USBFields(v1);
  uint64_t v3 = +[CAEvent eventWithName:@"com.apple.peripheral.usb.IOUSBHostDevice.Daily" fields:v2];
  v4 = (void *)get_kCAEvent_USB_Device_Daily_event;
...
void __get_kCAEvent_USB_Interface_Daily_block_invoke(id a1)
{
  ...
  uint64_t v6 = +[CAEvent eventWithName:@"com.apple.peripheral.usb.IOUSBHostInterface.Daily" fields:v3];
  v7 = (void *)get_kCAEvent_USB_Interface_Daily_event;
