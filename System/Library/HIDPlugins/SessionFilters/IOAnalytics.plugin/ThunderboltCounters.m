...
void __get_kCAEvent_ThunderboltCounters_block_invoke(id a1)
{
  ...
  id v1 = +[NSArray arrayWithObjects:v10 count:31];
  if (get_ThunderboltCountersFields_onceToken != -1) {
    dispatch_once(&get_ThunderboltCountersFields_onceToken, &__block_literal_global_97);
  }
  id v2 = (id)get_ThunderboltCountersFields_thunderboltCountersFields;
  if (v1)
  {
    v3 = (void *)get_ThunderboltCountersFields_thunderboltCountersFields;
    ...
    uint64_t v5 = [(id)get_ThunderboltCountersFields_thunderboltCountersFields objectsAtIndexes:v4];

    id v2 = (id)v5;
  }

  uint64_t v6 = +[CAEvent eventWithName:@"com.apple.peripheral.thunderbolt.counters" fields:v2];
  v7 = (void *)get_kCAEvent_ThunderboltCounters_event;
