...
+ (id)typeForEncoding:(const char *)a3
{
  ...
  if (typeForEncoding__once != -1) {
    dispatch_once(&typeForEncoding__once, &__block_literal_global_1);
  }
  int v5 = *a3;
  if (v5 > 90)
  {
...
LABEL_45:
        ...
        uint64_t v10 = 0;
LABEL_46:
        uint64_t v16 = [(ACCObjCType *)v6 initWithCode:v8 encoding:v9 name:v7 className:0 size:v10 flags:0];
        goto LABEL_49;
      case '*':
        v11 = (void *)_ACCObjCTypesByCode;
        uint64_t v12 = 14;
...
void __31__ACCObjCType_typeForEncoding___block_invoke()
{
  ...
  v19[1] = v17;
  uint64_t v16 = [[ACCObjCType alloc] initWithCode:2 encoding:@"i" name:@"int" className:0 size:4 flags:1];
  v19[2] = v16;
  ...
  v19[5] = v13;
  uint64_t v12 = [[ACCObjCType alloc] initWithCode:6 encoding:@"S" name:@"unsigned short" className:0 size:2 flags:1];
  v19[6] = v12;
  ...
  v19[11] = v4;
  int v5 = [[ACCObjCType alloc] initWithCode:12 encoding:@"B" name:@"BOOL" className:0 size:1 flags:1];
  v19[12] = v5;
  ...
  v19[14] = v7;
  uint64_t v8 = [[ACCObjCType alloc] initWithCode:15 encoding:@"@" name:@"id" className:0 size:8 flags:0];
  v19[15] = v8;
  v9 = [[ACCObjCType alloc] initWithCode:16 encoding:@"#" name:@"Class" className:0 size:8 flags:0];
  v19[16] = v9;
  uint64_t v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:17];
  v11 = (void *)_ACCObjCTypesByCode;
...
- (id)objectWithBytes:(const void *)a3
{
  switch(self->_code)
  {
    ...
    case 0xFLL:
      ...
      break;
    default:
      [MEMORY[0x263EFF940] raise:*MEMORY[0x263EFF498], @"For class %@, Unsupported boxing type: %@", self->_className, self->_name format];
      id v4 = 0;
      break;
  }
  return v4;
...
- (void)getBytes:(void *)a3 forObject:(id)a4
{
  ...
  if (objc_opt_isKindOfClass()) {
    ...
    [MEMORY[0x263EFF940] raise:*MEMORY[0x263EFF498], @"Unsupported unboxing type: %@", self->_name format];
  }
}
