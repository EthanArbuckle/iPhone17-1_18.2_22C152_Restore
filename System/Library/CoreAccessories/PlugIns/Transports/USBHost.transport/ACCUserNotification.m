...
- (void)createBackingUserNotification
{
  ...
  if (v3) {
    ...
    uint64_t v5 = &stru_26D5972C8;
  }
  v29[0] = v5;
  v28[1] = *MEMORY[0x263EFFFD8];
  ...
  v29[1] = v8;
  v28[2] = *MEMORY[0x263EFFFE0];
  v9 = [NSNumber numberWithBool:1];
  v29[2] = v9;
  v28[3] = *MEMORY[0x263F79610];
  v10 = [NSNumber numberWithBool:0];
  v29[3] = v10;
  v28[4] = *MEMORY[0x263F79628];
  v11 = objc_msgSend(NSNumber, "numberWithBool:", -[ACCUserNotification dismissOnUnlock](self, "dismissOnUnlock") ^ 1);
  v29[4] = v11;
  v28[5] = *MEMORY[0x263F79658];
  v12 = objc_msgSend(NSNumber, "numberWithBool:", -[ACCUserNotification ignoreQuietMode](self, "ignoreQuietMode"));
  v29[5] = v12;
  ...
  if (v15)
  {
    ...
    if (v18)
    {
      ...
      [v14 setObject:v19 forKey:*MEMORY[0x263F00000]];
    }
  }
  ...
  if (v20)
  {
    ...
    if (v23)
    {
      ...
      [v14 setObject:v24 forKey:*MEMORY[0x263EFFFE8]];
    }
  }
  ...
  if (v25)
  {
    ...
    [v14 setObject:v26 forKey:*MEMORY[0x263F79688]];
  }
  if ([(ACCUserNotification *)self presentViaSystemAperture]) {
    [v14 setObject:MEMORY[0x263EFFA88] forKey:*MEMORY[0x263F79680]];
  }
  v27 = (void *)[v14 copy];
