...
- (ACCUserNotificationManager)init
{
  ...
  if (v2)
  {
    ...
    v11 = (NSRecursiveLock *)objc_alloc_init(MEMORY[0x263F08AE0]);
    lock = v2->_lock;
    v2->_lock = v11;
  }
  return v2;
...
- (void)presentNotification:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      v13 = (void *)MEMORY[0x223CA5B10](v7);
    ...
    if (v16)
    {
      ...
      if (v17 > 2) {
        ...
        CFOptionFlags v18 = qword_222C92250[v17];
      }
      SInt32 error = 0;
      uint64_t v36 = 0;
      v37 = &v36;
      ...
      CFDictionaryRef v20 = [v6 userNotificationCFDict];
      CFUserNotificationRef v21 = CFUserNotificationCreate(v19, 0.0, v18, &error, v20);
...
- (void)dismissNotificationWithIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v16)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v17; ++j)
        {
          ...
          -[ACCUserNotificationManager dismissNotification:](self, "dismissNotification:", *(void *)(*((void *)&v21 + 1) + 8 * j), (void)v21);
        }
    ...
    CFDictionaryRef v20 = [(ACCUserNotificationManager *)self lock];
    [v20 unlock];
  }
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[ACCUserNotificationManager dismissNotification:](self, "dismissNotification:", *(void *)(*((void *)&v12 + 1) + 8 * v10++), (void)v12);
      }
      while (v8 != v10);
...
+ (id)sharedManager
{
  ...
  CFOptionFlags v2 = (void *)sharedManager_sharedInstance_0;
  return v2;
}

uint64_t __43__ACCUserNotificationManager_sharedManager__block_invoke(uint64_t a1)
{
  sharedManager_sharedInstance_0 = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
