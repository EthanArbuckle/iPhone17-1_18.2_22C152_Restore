@interface RETimerSampleDataSource
+ (id)bundleIdentifier;
- (id)supportedSections;
- (void)getElementsInSection:(id)a3 withHandler:(id)a4;
@end

@implementation RETimerSampleDataSource
...
- (void)getElementsInSection:(id)a3 withHandler:(id)a4
{
  ...
  v6 = RETimerContent(0, 899.0);
  id v7 = objc_alloc((Class)REElement);
  v12 = v5;
  v8 = +[NSArray arrayWithObjects:&v12 count:1];
  id v9 = [v7 initWithIdentifier:@"com.apple.private.NanoTimer.timer" content:v6 action:0 relevanceProviders:v8];
