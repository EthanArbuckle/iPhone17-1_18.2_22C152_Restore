...
{
  unsigned int v9 = *a4;
  long long v21 = off_227C8;
  long long v22 = unk_227D8;
  uint64_t v23 = 0;
  if (v9)
  {
    DWORD2(v21) = 0;
...
{
  unsigned int v9 = *a4;
  long long v21 = off_22840;
  long long v22 = *(_OWORD *)algn_22850;
  uint64_t v23 = 0;
  if ((v9 & 2) != 0)
  {
    DWORD2(v21) = 0;
...
{
  long long v19 = off_227F0;
  long long v20 = unk_22800;
  uint64_t v21 = 0;
  if (!a3)
  {
    if ((*a4 & 0x1004) != 0)
...
{
  long long v19 = off_22818;
  long long v20 = unk_22828;
  uint64_t v21 = 0;
  if (!a3)
  {
    if ((*a4 & 0x2008) != 0)
...
OSMetaClass *AppleH15PlatformErrorHandler::MetaClass::MetaClass(OSMetaClass *this)
{
  ...
  result->__vftable = (OSMetaClass_vtbl *)off_22340;
  return result;
}
...
void AppleH15PlatformErrorHandler::AppleH15PlatformErrorHandler(AppleH15PlatformErrorHandler *this, const OSMetaClass *a2)
{
  ...
  v2->__vftable = (IOService_vtbl *)off_21DE8;
...
void AppleH15PlatformErrorHandler::AppleH15PlatformErrorHandler(AppleH15PlatformErrorHandler *this)
{
  ...
  v1->__vftable = (IOService_vtbl *)off_21DE8;
  ...
  if (*((_DWORD *)this + 135))
  {
    ...
    do
    {
      ...
      do
      {
        uint64_t v10 = 0;
        char v11 = v8;
        unsigned int v12 = v9 + 24576;
        do
        {
          uint64_t Register32 = AppleH15PlatformErrorHandler::_readRegister32(v7, (uint64_t)v5, v4, v12 - 4096);
          int v14 = AppleH15PlatformErrorHandler::_amccPlaneDecoders[v10];
          int v15 = v14 | Register32;
          int v16 = Register32 & ~v14;
          if (a2) {
            int v16 = v15;
          }
          AppleH15PlatformErrorHandler::_writeRegister32(Register32, v5, v4, v12 - 4096, v16 & ~AppleH15PlatformErrorHandler::_amccPlaneDecoders[v10 + 1]);
          AppleH15PlatformErrorHandler::_writeRegister32(v17, v5, v4, v12, 0);
          v10 += 6;
          v12 += 8;
        }
        while (v10 != 18);
  ...
  if (*((_DWORD *)this + 135))
  {
    ...
    do
    {
      for (int i = 0; i != 4; ++i)
      {
        ...
        {
          char v8 = (char *)&AppleH15PlatformErrorHandler::_dcsDecoders + j;
...
void AppleH15PlatformErrorHandler::_amccPostHibernateClean(AppleH15PlatformErrorHandler *this)
{
  ...
  if (v1 && *v1 == 2 && *((void *)this + 1757) && *((_DWORD *)this + 135))
  {
    ...
    do
    {
      AppleH15PlatformErrorHandler::_writeRegister32((uint64_t)this, (void *)this + 1029, v3, 8 * **((_DWORD **)this + 1757) + 135172, *(_DWORD *)(*((void *)this + 1757) + 4));
      AppleH15PlatformErrorHandler::_writeRegister32(v4, (void *)this + 1029, v3++, 8 * **((_DWORD **)this + 1757) + 397316, *(_DWORD *)(*((void *)this + 1757) + 4));
    }
    ...
    if (this)
    {
      ...
      if (v14)
      {
        if ((*(_DWORD *)v13 & this) == 0)
        {
          ...
          do
          {
            int v16 = *(const char **)(v13 + 16 * v15 + 8);
            if (!v16) {
              goto LABEL_19;
            }
...
LABEL_19:
      int v18 = (char *)&a3[10 * v10];
      uint64_t Register32 = AppleH15PlatformErrorHandler::_readRegister32(this, (uint64_t)v5, v8, *((_DWORD *)v18 + 2));
      unsigned int v20 = Register32;
      uint64_t v21 = AppleH15PlatformErrorHandler::_readRegister32(Register32, (uint64_t)v5, v8, *((_DWORD *)v18 + 2) + 4);
      unsigned int v22 = v21;
      uint64_t v23 = AppleH15PlatformErrorHandler::_readRegister32(v21, (uint64_t)v5, v8, *((_DWORD *)v18 + 2) + 8);
      int v24 = v23;
      AppleH15PlatformErrorHandler::_readRegister32(v23, (uint64_t)v5, v8, *((_DWORD *)v18 + 2) + 12);
      unint64_t v25 = AppleH15PlatformErrorHandler::_fabricCommands[(v22 >> 11) & 0x3F];
      if (!v25) {
        unint64_t v25 = "???";
      }
      snprintf(AppleH15PlatformErrorHandler::_afxNiDecodeInterrupts(int,void *)::msg, 0x100uLL, "%s NI%d %s %d %s error (0x%08x) cmd/st:0x%x(%s)/0x%x src/dst/tid:%x/%x/%x vc/sc/tz/crh:0x%x/0x%x/0x%x/0x%x user:0x%x", *((const char **)v18 + 2), v26, *((const char **)v18 + 3), v8, v14, v27, (v22 >> 11) & 0x3F, v25, (v22 >> 22) & 7, 0, (v20 >> 7) & 0xFFFFF, v22 & 0x7FF, v20 & 0xF, (v20 >> 4) & 7, (v22 >> 17) & 0x1F, v20 >> 30,
        v24 & 0xFFFFF);
...
LABEL_2:
  ...
  if (Register32)
  {
    ...
    int v25 = a3;
    unsigned int v16 = 0;
    unsigned int v15 = (const char **)a7;
  }
  else
  {
    unsigned int v14 = 1;
    do
    {
      unsigned int v15 = (const char **)(a7 + 24 * v14);
      if (!*v15) {
        goto LABEL_2;
      }
...
uint64_t AppleH15PlatformErrorHandler::_afxNsDecodeInterrupts(AppleH15PlatformErrorHandler *this, int a2, _DWORD *a3)
{
  ...
  unsigned int v15 = AppleH15PlatformErrorHandler::_afxNsDecodeStatus;
  if (v10) {
    unsigned int v15 = *(void (**)(uint64_t, unsigned int, int, const char **, uint64_t, uint64_t, uint64_t))(*v14 + AppleH15PlatformErrorHandler::_afxNsDecodeStatus);
  }
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeDirectoryParity(uint64_t a1, unsigned int a2, int a3, int a4, _DWORD *a5, uint64_t a6)
{
  ...
  panic("\"AMCC%u PLANE%u %s error: INTSTS%u 0x%08x FLAG/STATE %#x/%#x INFO %#x/%#x/%#x ADDR %#llx CMD/AID/TID %#x(%s)/%#x/%#x WAY/TAG/PARITY %#x/%#x/%#x\" @%s:%d", a2, a3, *(const char **)(a6 + 8), a4, *a5, Register32, (v12 >> 5), v12, v13, v14, v16, v14 & 0x3F, v17, v14 & 0xFFFFF, (v14 >> 6) & 0x7FF, v12 & 0x1F, (unsigned __int16)v13,
    v13 >> 31,
    "AppleH15PlatformErrorHandler.cpp",
    2355);
}
...
void AppleH15PlatformErrorHandler::_amccPlaneDecodeDirectoryMultiHit(uint64_t a1, unsigned int a2, int a3, int a4, _DWORD *a5, uint64_t a6)
{
  ...
  panic("\"AMCC%u PLANE%u %s error: INTSTS%u 0x%08x FLAG/STATE %#x/%#x INFO %#x/%#x/%#x ADDR %#llx CMD/AID/TID %#x(%s)/%#x/%#x WAYS %#x\" @%s:%d", a2, a3, *(const char **)(a6 + 8), a4, *a5, Register32, (unsigned __int16)v12, v12, v13, v14, v17 & 0x3FF | v16, v14 & 0x3F, v18, v14 & 0xFFFFF, (v14 >> 6) & 0x7FF, v13, "AppleH15PlatformErrorHandler.cpp",
    2323);
}
...
void AppleH15PlatformErrorHandler::_amccDumpRegs(AppleH15PlatformErrorHandler *this, unsigned int a2)
{
  ...
  unsigned int v8 = &v6[(int)v7];
  uint64_t v9 = (char *)this + 8232;
  char v10 = 1;
  int v11 = 114688;
  do
  {
    uint64_t v12 = 0;
    char v13 = v10;
    unsigned int v14 = v11 + 20484;
    do
    {
      uint64_t Register32 = AppleH15PlatformErrorHandler::_readRegister32(v7, (uint64_t)v9, a2, v14 - 4);
      int v16 = AppleH15PlatformErrorHandler::_readRegister32(Register32, (uint64_t)v9, a2, v14);
      uint64_t v7 = snprintf(v8, &v18 - v8, "intsts: %x\tinten: %x\tblock enable: %x\n", v16, Register32, AppleH15PlatformErrorHandler::_amccPlaneDecoders[v12]);
      v8 += (int)v7;
      v12 += 6;
      v14 += 8;
    }
...
void AppleH15PlatformErrorHandler::_amccDecodeInterrupts(AppleH15PlatformErrorHandler *this, int a2, void *a3)
{
  ...
  for (uint64_t i = 0; i != 128; i += 32)
    AppleH15PlatformErrorHandler::_amccDecodeInterruptsForInputTable((uint64_t)this, (int *)((char *)&AppleH15PlatformErrorHandler::_amccNonPlaneDecoders + i), v3, &v30);
  AppleH15PlatformErrorHandler::_amccDecodeInterruptsForInputTable((uint64_t)this, AppleH15PlatformErrorHandler::_amccNonPlaneDecoders_EFL, v3, &v30);
  uint64_t Register32 = AppleH15PlatformErrorHandler::_amccDecodeInterruptsForInputTable((uint64_t)this, dword_181C0, v3, &v30);
  uint64_t v7 = 0;
  unsigned int v8 = (char *)this + 8232;
  int v9 = v30;
  char v10 = 1;
  do
  {
    ...
    {
      unsigned int v29 = 0;
      uint64_t Register32 = AppleH15PlatformErrorHandler::_readRegister32(Register32, (uint64_t)v8, v3, ((v7 << 18) | 0x21004) + 8 * v11);
      unsigned int v29 = Register32;
      uint64_t v12 = &AppleH15PlatformErrorHandler::_amccPlaneDecoders[6 * v11];
      int v13 = *v12;
      if ((*v12 & Register32) != 0)
      {
        unsigned int v14 = &AppleH15PlatformErrorHandler::_amccPlaneDecoders[6 * v11];
        unsigned int v17 = v14[2];
        int v16 = (unsigned int *)(v14 + 2);
        unint64_t v15 = v17;
        if (v17)
        {
          unint64_t v18 = 0;
          ...
          do
          {
            ...
            if ((*v12 & v21) != 0 && (v29 & v21) != 0)
            {
              unint64_t v22 = *(void *)(v20 + 16);
              uint64_t v23 = *(void *)(v20 + 24);
              BOOL v24 = !v23 || (*(void *)(v20 + 24) & 1 | v22) == 0;
              BOOL v25 = !v24;
              if (v22 || v25)
              {
                int v27 = (void *)((char *)this + (v23 >> 1));
                if (v23) {
                  unint64_t v22 = *(void *)(*v27 + v22);
                }
                ((void (*)(void *, uint64_t, uint64_t, uint64_t, unsigned int *, uint64_t))v22)(v27, v3, v7, v11, &v29, v20);
                v19 |= *(_DWORD *)(v20 + 4);
                unint64_t v15 = *v16;
                int v9 = 1;
              }
...
uint64_t AppleH15PlatformErrorHandler::_amccDecodeInterruptsForInputTable(uint64_t a1, int *a2, uint64_t a3, unsigned char *a4)
{
  ...
  if ((*a2 & result) != 0)
  {
    ...
    if (v10)
    {
      unint64_t v11 = 0;
      int v12 = 0;
      int v13 = (unsigned int *)*((void *)a2 + 3);
      do
      {
        if ((v13[1] & v20) != 0)
        {
...
uint64_t AppleH15PlatformErrorHandler::_dcsDecodeInterrupts(uint64_t this, int a2, void *a3)
{
  ...
  do
  {
    int v12 = (_DWORD *)((char *)&AppleH15PlatformErrorHandler::_dcsDecoders + 24 * v8);
    uint64_t v13 = v12 + 2;
    if (v12[2])
    {
      uint64_t v14 = (char *)&AppleH15PlatformErrorHandler::_dcsDecoders + 24 * v8;
      uint64_t v16 = *((void *)v14 + 2);
      int v15 = (uint64_t *)(v14 + 16);
      int v17 = *(_DWORD *)(v16 + 8) + v11;
      int v18 = *(_DWORD *)(v16 + 16);
      *(_DWORD *)long long v37 = 0;
      this = AppleH15PlatformErrorHandler::_readRegister32(this, v36, v7, v17 + v18);
      *(_DWORD *)long long v37 = this;
      ...
      if (v19)
      {
        ...
        if (v20)
        {
          ...
          do
          {
            if ((*(_DWORD *)(v22 + 4) & *(_DWORD *)v37) != 0)
            {
              ...
              if (v23 || v26)
              {
                ...
                this = ((uint64_t (*)(void *, uint64_t, uint64_t, void, char *, uint64_t))v23)(v28, v7, v10, 0, v37, v22);
                *((_DWORD *)v38 + v8) |= *(_DWORD *)(v22 + 4);
                unint64_t v20 = *v13;
                char v9 = 1;
              }
            }
          ...
          while (v21 < v20);
          int v19 = *(_DWORD *)v37 & *v12;
          int v11 = v10 << 21;
        }
        if ((v19 & ~*((_DWORD *)v38 + v8)) != 0) {
          AppleH15PlatformErrorHandler::_dcsDecodeInterrupts();
        }
      }
    }
  ...
  if ((v9 & 1) == 0)
  {
    ...
    uint64_t v32 = 0;
    unsigned int v33 = 0;
    long long v34 = &off_184E8;
    while (1)
    {
      if (*((_DWORD *)v34 - 2))
      {
        int Register32 = AppleH15PlatformErrorHandler::_readRegister32(v30, v36, v7, *((_DWORD *)*v34 + 2) + v29 + *((_DWORD *)*v34 + 4));
      ...
      panic("\"Unhandled DCS interrupt: AMCC%u DCS Group %u Channel %u: %s\" @%s:%d", v7, v10, 0, v37, "AppleH15PlatformErrorHandler.cpp", 3277);
    }
  }
  return this;
}
...
void AppleH15PlatformErrorHandler::_sepDecodeMonInterrupts(AppleH15PlatformErrorHandler *this, int a2, void *a3)
{
  ...
  uint64_t v12 = AppleH15PlatformErrorHandler::_readRegister32(v10, (uint64_t)this + 12872, 0, 0x58000u);
  int v13 = AppleH15PlatformErrorHandler::_readRegister32(v12, (uint64_t)v11, 1u, 0x30u);
  if (!Register32)
  {
    unsigned int v14 = (const char *)&unk_3FD9;
    if (!v6) {
      goto LABEL_10;
    }
    goto LABEL_12;
...
LABEL_10:
  unsigned int v16 = (const char *)&unk_3FD9;
  goto LABEL_17;
}
...
OSMetaClass *AppleH15MemCacheController::MetaClass::MetaClass(OSMetaClass *this)
{
  ...
  result->__vftable  = (OSMetaClass_vtbl *)off_23F28;
  return result;
}
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            switch(*(_DWORD *)(v15 + 4))
            {
              ...
              case 9:
              case 0xA:
                __asm { BTI             j; jumptable 00000000000106A0 cases 0-7,9,10 }
              ...
              case 8:
              case 0xB:
                __asm { BTI             j; jumptable 00000000000106A0 cases 8,11 }
                int v21 = (IOReporter *)*((void *)this + 256);
                goto LABEL_15;
              case 0xC:
                __asm { BTI             j; jumptable 00000000000106A0 case 12 }
...
LABEL_16:
              ...
              case 0x13:
                break;
              default:
                __asm { BTI             j; jumptable 00000000000106A0 default case, case 16 }
                AppleH15MemCacheController::_mccInitPerfCounters((_DWORD *)(v14 + v12 + 4));
            }
            __asm { BTI             j; jumptable 00000000000106A0 cases 13-15,17-19 }
...
{
  Reg32  = AppleH15MemCacheController::_mccReadReg32((uint64_t)this, (uint64_t)this + 920, 0, 0x100020u);
...
uint64_t AppleH15MemCacheController::setWayMask(AppleH15MemCacheController *this)
{
  ...
  if (v3)
  {
    ...
    int8x16_t v5 = (int8x16_t)xmmword_64B0;
    int32x4_t v6 = (int32x4_t)xmmword_64C0;
  ...
  if (*((_DWORD *)this + 493))
  {
    ...
    do
    {
      AppleH15MemCacheController::_mccProtectedWriteReg32((uint64_t)this, (uint64_t)this + 920, v17++, 0x1C071Cu, 0);
    ...
    if (v18)
    {
      ...
      if (v20)
      {
        ...
        {
          AppleH15MemCacheController::_mccProtectedWriteReg32((uint64_t)this, (uint64_t)this + 920, j, 0x1C071Cu, 1u);
          unsigned int v14 = *((_DWORD *)this + 493);
        }
LABEL_10:
        if (v14)
...
_DWORD *AppleH15MemCacheController::_setCntrCtrlParmeters(_DWORD *a1, uint64_t a2, unsigned int a3)
{
  ...
  *(void *)(v4 + 120)  = ++AppleH15MemCacheController::_setCntrCtrlParmeters(AppleH15MemCacheController::AMCCCounterConfig *,unsigned int)::channelId;
  ...
  {
    case 0:
      __asm { BTI             j; jumptable 00000000000130D0 case 0 }
    ...
    case 5:
    case 6:
      __asm { BTI             j; jumptable 00000000000130D0 cases 1-6 }
      *(unsigned char *)uint64_t v4 = *(unsigned char *)v4 & 0xF9 | 2;
      ...
      *(int32x2_t *)(a2 + 160 * a3 + 44)  = vadd_s32((int32x2_t)vshl_u32((uint32x2_t)vdup_n_s32(v18), (uint32x2_t)0x300000004), (int32x2_t)0x900000008008);
      switch(v6)
      {
        case 1:
          goto LABEL_28;
        case 2:
          __asm { BTI             j; jumptable 00000000000131B8 case 2 }
          uint64_t v21 = v20 | 0x20000000000000;
          goto LABEL_13;
        case 3:
          __asm { BTI             j; jumptable 00000000000131B8 case 3 }
          uint64_t v21 = v20 | 0x30000000000000;
          goto LABEL_13;
        case 5:
        case 6:
          __asm { BTI             j; jumptable 00000000000131B8 cases 5,6 }
          uint64_t v21 = v20 | 0x10000000000000;
LABEL_13:
          *unint64_t v19 = v21;
          break;
        default:
          __asm { BTI             j; jumptable 00000000000131B8 default case, case 4 }
          panic("\"Unsupported amcx type %d on counter index %d\\n\" @%s:%d", *result, a3, "AppleH15MemCacheController.cpp", 1660);
      }
      return result;
    case 7:
      __asm { BTI             j; jumptable 00000000000130D0 case 7 }
      *(unsigned char *)uint64_t v4 = *(unsigned char *)v4 & 0xF9 | 2;
      int v39 = 32 * a1[490];
      ...
      *(_DWORD *)(v40 + 48)  = 8 * v41;
      break;
    case 8:
      __asm { BTI             j; jumptable 00000000000130D0 case 8 }
    ...
    case 9:
    case 10:
      __asm { BTI             j; jumptable 00000000000130D0 cases 9,10 }
      *(unsigned char *)uint64_t v4 = *(unsigned char *)v4 & 0xF9 | 2;
      *(_DWORD *)(a2 + 160 * a3 + 52)  = 1;
      break;
    case 11:
      __asm { BTI             j; jumptable 00000000000130D0 case 11 }
      *(unsigned char *)uint64_t v4 = *(unsigned char *)v4 & 0xF9 | 4;
      uint64_t v42 = a2 + 160 * a3;
      *(_DWORD *)(v42 + 52)  = 1;
      *(_DWORD *)(v42 + 64)  = 1;
...
LABEL_24:
      ...
      *(_DWORD *)(v42 + 48)  = v45;
      break;
    case 12:
      __asm { BTI             j; jumptable 00000000000130D0 case 12 }
      *(unsigned char *)uint64_t v4 = *(unsigned char *)v4 & 0xF9 | 2;
    ...
    case 17:
    case 18:
      __asm { BTI             j; jumptable 00000000000130D0 cases 13-18 }
      ...
      *(void *)(v28 + 80)  = v27;
      ...
      switch(v6)
      {
        case 13:
          break;
        case 14:
          __asm { BTI             j; jumptable 000000000001324C case 14 }
          v27 |= 0x20000000000000uLL;
          break;
        case 15:
          __asm { BTI             j; jumptable 000000000001324C case 15 }
          v27 |= 0x30000000000000uLL;
          break;
        case 17:
        case 18:
          __asm { BTI             j; jumptable 000000000001324C cases 17,18 }
          v27 |= 0x10000000000000uLL;
          break;
        default:
          __asm { BTI             j; jumptable 000000000001324C default case, case 16 }
          AppleH15MemCacheController::_setCntrCtrlParmeters(result);
      }
      __asm { BTI             j; jumptable 000000000001324C case 13 }
      ...
      *(_DWORD *)(v30 + 44)  = 16 * v26 + 34904;
      break;
    case 19:
      __asm { BTI             j; jumptable 00000000000130D0 case 19 }
      *(unsigned char *)v4 &= 0xF9u;
      ...
      *(_DWORD *)(v52 + 44)  = 16 * v51 + 34904;
      break;
    default:
      break;
  }
LABEL_28:
  __asm { BTI             j; jumptable 00000000000130D0 default case }
  return result;
}
...
void AppleH15MemCacheController::_writePerfCtrl(uint64_t a1, uint64_t a2, unsigned int a3, int a4)
{
  ...
  {
    case 0:
      __asm { BTI             j; jumptable 00000000000136C4 case 0 }
    ...
    case 5:
    case 6:
      __asm { BTI             j; jumptable 00000000000136C4 cases 1-6 }
      int v10 = (_DWORD *)(a2 + 160 * a3);
...
LABEL_3:
    ...
    case 7:
    case 8:
      __asm { BTI             j; jumptable 00000000000136C4 cases 7,8 }
      ...
      goto LABEL_9;
    case 0xB:
      __asm { BTI             j; jumptable 00000000000136C4 case 11 }
...
LABEL_9:
    ...
    case 0xF:
    case 0x11:
      __asm { BTI             j; jumptable 00000000000136C4 cases 13-15,17 }
      ...
      goto LABEL_15;
    case 0x13:
      __asm { BTI             j; jumptable 00000000000136C4 case 19 }
...
LABEL_16:
    ...
    default:
LABEL_13:
      __asm { BTI             j; jumptable 00000000000136C4 default case, cases 9,10,12,16,18 }
      break;
  }
}
...
void AppleH15MemCacheController::_enablePerfCtrl(uint64_t a1, uint64_t a2, unsigned int a3, int a4)
{
  ...
  switch(*(_DWORD *)(a2 + 160 * v8 + 4))
  {
    case 0:
    case 0x13:
      __asm { BTI             j; jumptable 0000000000013A30 cases 0,19 }
    ...
    case 5:
    case 6:
      __asm { BTI             j; jumptable 0000000000013A30 cases 1-6 }
    ...
    case 7:
    case 8:
      __asm { BTI             j; jumptable 0000000000013A30 cases 7,8 }
    ...
    case 9:
    case 0xA:
      __asm { BTI             j; jumptable 0000000000013A30 cases 9,10 }
      ...
      goto LABEL_18;
    case 0xB:
      __asm { BTI             j; jumptable 0000000000013A30 case 11 }
      v55  = v5;
    ...
    case 0xF:
    case 0x11:
      __asm { BTI             j; jumptable 0000000000013A30 cases 13-15,17 }
...
LABEL_17:
  ...
  unsigned int v5 = v55;
LABEL_18:
  __asm { BTI             j; jumptable 0000000000013A30 default case, cases 12,16,18 }
  if ((a4 & 1) == 0) {
...
unint64_t AppleH15MemCacheController::_readPerfValue(uint64_t a1, uint64_t a2, unsigned int a3)
{
  switch(*(_DWORD *)(a2 + 160 * a3 + 4))
  {
    case 0:
    case 0xC:
      __asm { BTI             j; jumptable 0000000000013EA0 cases 0,12 }
    ...
    case 5:
    case 6:
      __asm { BTI             j; jumptable 0000000000013EA0 cases 1-6 }
    ...
    case 7:
    case 8:
      __asm { BTI             j; jumptable 0000000000013EA0 cases 7,8 }
...
LABEL_6:
    ...
    case 9:
    case 0xA:
      __asm { BTI             j; jumptable 0000000000013EA0 cases 9,10 }
      uint64_t v17 = 0;
      Reg64  = 0;
      do
      {
      ...
      break;
    case 0xB:
      __asm { BTI             j; jumptable 0000000000013EA0 case 11 }
...
OSMetaClass *AppleMemCacheModeFunction::MetaClass::MetaClass(OSMetaClass *this)
{
  ...
  result->__vftable  = (OSMetaClass_vtbl *)off_24080;
  return result;
}
...
uint64_t AppleMemCacheModeFunction::callFunction(AppleMemCacheModeFunction *this, _DWORD *a2, unsigned int *a3, void *a4)
{
  ...
  switch(v4)
  {
    case 0:
      goto LABEL_5;
    case 1:
      __asm { BTI             j; jumptable 00000000000155CC case 2 }
      return (*(uint64_t (**)(void, uint64_t))(**((void **)this + 5) + 1536))(*((void *)this + 5), v5);
    case 2:
      __asm { BTI             j; jumptable 00000000000155CC case 3 }
      uint64_t v6 = 0;
      goto LABEL_5;
    case 4:
      __asm { BTI             j; jumptable 00000000000155CC case 5 }
      return (*(uint64_t (**)(void, uint64_t))(**((void **)this + 5) + 1552))(*((void *)this + 5), v5);
    case 5:
      __asm { BTI             j; jumptable 00000000000155CC case 6 }
      return (*(uint64_t (**)(void, uint64_t))(**((void **)this + 5) + 1544))(*((void *)this + 5), v5);
    case 6:
      __asm { BTI             j; jumptable 00000000000155CC case 7 }
      return (*(uint64_t (**)(void, uint64_t))(**((void **)this + 5) + 1560))(*((void *)this + 5), v5);
    case 7:
      __asm { BTI             j; jumptable 00000000000155CC case 8 }
      return (*(uint64_t (**)(void, uint64_t))(**((void **)this + 5) + 1568))(*((void *)this + 5), v5);
    default:
      __asm { BTI             j; jumptable 00000000000155CC default case, case 4 }
      uint64_t v6 = 3758097090;
LABEL_5:
      __asm { BTI             j; jumptable 00000000000155CC case 1 }
      return v6;
  }
}
...
OSMetaClass *AppleMemCachePanicFunction::MetaClass::MetaClass(OSMetaClass *this)
{
  ...
  result->__vftable  = (OSMetaClass_vtbl *)off_241B8;
  return result;
}
...
OSMetaClass *AppleMemCacheFlushFunction::MetaClass::MetaClass(OSMetaClass *this)
{
  ...
  result->__vftable  = (OSMetaClass_vtbl *)off_242F0;
  return result;
}
...
{
  OSMetaClass::OSMetaClass(&AppleH15MemCacheController::gMetaClass, "AppleH15MemCacheController", &AppleMemCacheController::gMetaClass, 0x850u)->__vftable  = (OSMetaClass_vtbl *)off_23F28;
  OSMetaClass::OSMetaClass(&AppleMemCacheModeFunction::gMetaClass, "AppleMemCacheModeFunction", &AppleARMFunction::gMetaClass, 0x30u)->__vftable  = (OSMetaClass_vtbl *)off_24080;
  OSMetaClass::OSMetaClass(&AppleMemCachePanicFunction::gMetaClass, "AppleMemCachePanicFunction", &AppleARMFunction::gMetaClass, 0x30u)->__vftable  = (OSMetaClass_vtbl *)off_241B8;
