            ...
            if (v13)
            {
              ...
              while (2)
              {
                for (uint64_t j = 0; j != v14; ++j)
                {
                  ...
                  if ([v17 length]
                    && [(INStartCallIntentAccessibility *)self _axIsContactSelectedInClarity:v17])
                  {
...
LABEL_19:
  ...
  v22.receiver = self;
  v22.super_class = (Class)INStartCallIntentAccessibility;
  -[INStartCallIntentAccessibility setContacts:](&v22, sel_setContacts_, v19, v18);
}
