...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCItemRenameTextView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"SaveToFiles.DOCItemRenameTextView" isKindOfClass:@"UIView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemRenameTextView", @"accessibilityClearButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemRenameTextView", @"installClearButton", "v", 0);
}
