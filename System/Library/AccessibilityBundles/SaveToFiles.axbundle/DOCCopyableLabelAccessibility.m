...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCCopyableLabel";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCCopyableLabel", @"copyDetail", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCCopyableLabel", @"handleTapWithSender:", "v", "@", 0);
  [v3 validateClass:@"SaveToFiles.DOCCopyableLabel" hasSwiftField:@"supportsCopy" withSwiftType:"Bool"];
  [v3 validateClass:@"SaveToFiles.DOCCopyableLabel" hasSwiftField:@"behaveAsLink" withSwiftType:"Bool"];
}
