...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCItemCollectionView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"SaveToFiles.DOCItemCollectionView" isKindOfClass:@"UIView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionViewController", @"displayMode", "q", 0);
}
