...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCSidebarHeaderCell";
}
...
- (CGPoint)accessibilityActivationPoint
{
  objc_super v3 = [(DOCSidebarHeaderCellAccessibility *)self _accessibilityFindSubviewDescendant:&__block_literal_global];
  v4 = v3;
  if (v3)
  {
