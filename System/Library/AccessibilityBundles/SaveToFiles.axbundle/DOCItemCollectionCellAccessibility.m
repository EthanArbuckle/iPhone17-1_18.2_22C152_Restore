...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCItemCollectionCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"SaveToFiles.DOCItemCollectionCell" isKindOfClass:@"UICollectionViewCell"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionCell", @"accessibilityCellManager", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionCell", @"accessibilityIsRenaming", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionCellContent", @"accessibilityItem", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionCellContent", @"accessibilityShouldDim", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionViewController", @"accessibilityIsRenamingInline", "B", 0);
  [v3 validateClass:@"SaveToFiles.DOCItemCollectionViewController" conformsToProtocol:@"UIContextMenuInteractionDelegate"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionViewController", @"contextMenuForItemsAt:", "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionViewController", @"contextMenuForFolder", "@", 0);
}
...
uint64_t __80__DOCItemCollectionCellAccessibility__accessibilityItemCollectionViewController__block_invoke(uint64_t a1, void *a2)
{
  ...
  NSClassFromString(&cfstr_SavetofilesDoc_10.isa);
