...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCFilenameViewController";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"SaveToFiles.DOCFilenameViewController" isKindOfClass:@"UIViewController"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCFilenameViewController", @"filenameView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCFilenameViewController", @"item", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCFilenameView", @"textField", "@", 0);
}
