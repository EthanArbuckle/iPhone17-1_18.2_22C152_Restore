...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCItemCollectionGridCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionGridCell", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionGridCell", @"accessibilitySecondSubtitleLabel", "@", 0);
  ...
  [v3 validateClass:@"SaveToFiles.DOCItemCollectionListCell" isKindOfClass:@"com_apple_DocumentManager_Service.DOCItemCollectionCell"];
  [v3 validateClass:@"SaveToFiles.DOCItemCollectionGridCell" isKindOfClass:@"com_apple_DocumentManager_Service.DOCItemCollectionCell"];
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionCell", @"accessibilityThumbnailView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCItemCollectionCellContent", @"accessibilityItem", "@", 0);
