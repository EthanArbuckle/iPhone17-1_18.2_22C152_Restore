...
+ (id)safeCategoryTargetClassName
{
  return @"SaveToFiles.DOCMetadataKeyValueRow";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCMetadataKeyValueRow", @"accessibilityElementWithLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SaveToFiles.DOCMetadataKeyValueRow", @"accessibilityElementWithValue", "@", 0);
}
