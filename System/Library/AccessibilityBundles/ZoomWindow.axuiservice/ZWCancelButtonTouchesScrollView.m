...
{
  v4.receiver = self;
  v4.super_class = (Class)ZWCancelButtonTouchesScrollView;
...
- (BOOL)touchesShouldCancelInContentView:(id)a3
{
  ...
  {
    v7.receiver = self;
    v7.super_class = (Class)ZWCancelButtonTouchesScrollView;
    BOOL v5 = [(ZWCancelButtonTouchesScrollView *)&v7 touchesShouldCancelInContentView:v4];
  }
