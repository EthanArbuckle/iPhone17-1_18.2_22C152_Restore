...
{
  v5.receiver = self;
  v5.super_class = (Class)ZWMenuZoomModeChooserViewController;
...
{
  v11.receiver = self;
  v11.super_class = (Class)ZWMenuZoomModeChooserViewController;
  id v6 = a4;
  [(ZWMenuChooserTableViewController *)&v11 tableView:a3 didSelectRowAtIndexPath:v6];
  v7 = [(ZWMenuZoomModeChooserViewController *)self delegate];
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v4 = [(ZWMenuZoomModeChooserViewController *)self zoomModeIdentifiers];
  id v5 = [v4 count];
...
{
  v18.receiver = self;
  v18.super_class = (Class)ZWMenuZoomModeChooserViewController;
  id v6 = a4;
  ...
  objc_super v11 = AXUILocalizedTitleForZoomLensMode();
  v12 = [v7 textLabel];
  [v12 setText:v11];
  ...
  v15 = [v14 zoomPreferredCurrentLensMode];
...
- (ZWMenuZoomModeChooserViewControllerDelegate)delegate
{
  ...
  return (ZWMenuZoomModeChooserViewControllerDelegate *)WeakRetained;
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_zoomModeIdentifiers, 0);
