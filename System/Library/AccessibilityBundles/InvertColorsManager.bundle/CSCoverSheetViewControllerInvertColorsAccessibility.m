...
{
  v3.receiver = self;
  v3.super_class = (Class)CSCoverSheetViewControllerInvertColorsAccessibility;
...
- (void)_accessibilityLoadInvertColors
{
  ...
  BOOL v12 = [v11 backgroundStyle] == (char *)&dword_4 + 2
     || [v11 backgroundStyle] == (char *)&dword_4 + 3;
  ...
  if (!v13 || v12 != [v13 BOOLValue])
  {
    ...
    BOOL v16 = v12 && IsInvertColorsEnabled;
    v17 = [v11 window];
    if (v16) {
