id accessibilityLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F811778 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
...
void sub_242668E8C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, id location, id a16)
{
...
void sub_24266A0A8(_Unwind_Exception *a1)
{
}
...
void sub_24266B3DC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
...
void sub_24266B67C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_24266B8BC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
Class __getSpeakTypingServicesClass_block_invoke(uint64_t a1)
{
  ...
  if (!SpeakTypingServicesLibraryCore_frameworkLibrary)
  {
    ...
    v3[5] = v3;
    long long v4 = xmmword_26515FB40;
    uint64_t v5 = 0;
...
void __getSpeakTypingServicesClass_block_invoke_cold_1(void *a1)
{
  ...
  v3 = [NSString stringWithUTF8String:"void *SpeakTypingServicesLibrary(void)"];
  objc_msgSend(v2, "handleFailureInFunction:file:lineNumber:description:", v3, @"TUIPredictionViewCellAccessibility.m", 18, @"%s", *a1);
...
void __getSpeakTypingServicesClass_block_invoke_cold_2()
{
  ...
  v1 = [NSString stringWithUTF8String:"Class getSpeakTypingServicesClass(void)_block_invoke"];
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", v1, @"TUIPredictionViewCellAccessibility.m", 19, @"Unable to find class %s", "SpeakTypingServices");
...
uint64_t UIAccessibilityLanguageForCurrentInputMode()
{
  return MEMORY[0x270F809C0]();
}
