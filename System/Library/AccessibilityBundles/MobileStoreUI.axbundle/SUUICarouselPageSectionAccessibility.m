...
+ (id)safeCategoryTargetClassName
{
  return @"SUUICarouselPageSection";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUICarouselPageSection", @"_carouselCollectionView", "@", 0);
  [v3 validateClass:@"SUUICarouselPageSection" hasInstanceVariable:@"_modelObjects" withType:"NSArray"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUICarouselPageSection", @"willAppearInContext:", "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUICarouselPageSection", @"willTransitionToSize: withTransitionCoordinator:", "v", "{CGSize=dd}", "@", 0);
}
...
- (void)_fireCycleTimer
{
  ...
  {
    v3.receiver = self;
    v3.super_class = (Class)SUUICarouselPageSectionAccessibility;
...
{
  v4.receiver = self;
  v4.super_class = (Class)SUUICarouselPageSectionAccessibility;
...
{
  v5.receiver = self;
  v5.super_class = (Class)SUUICarouselPageSectionAccessibility;
  -[SUUICarouselPageSectionAccessibility willTransitionToSize:withTransitionCoordinator:](&v5, sel_willTransitionToSize_withTransitionCoordinator_, a4, a3.width, a3.height);
  [(SUUICarouselPageSectionAccessibility *)self _accessibilityUpdateValidIndices];
}
...
- (void)_accessibilityUpdateValidIndices
{
  if (UIAccessibilityIsVoiceOverRunning())
  {
    id v9 = [(SUUICarouselPageSectionAccessibility *)self safeValueForKey:@"_carouselCollectionView"];
    [v9 bounds];
...
{
  id v4 = a3;
  objc_super v5 = [(SUUICarouselPageSectionAccessibility *)self _accessibilityValueForKey:@"kAXStartingIndexPath"];
  v6 = v5;
  if (v5 && (uint64_t v7 = [v5 section], v7 == objc_msgSend(v4, "section")))
  {
    ...
    uint64_t v11 = objc_msgSend(v4, "item", v15, 3221225472, __90__SUUICarouselPageSectionAccessibility__accessibilityDescendantElementAtIndexPathIsValid___block_invoke, &unk_265138300);
    BOOL v13 = 0;
