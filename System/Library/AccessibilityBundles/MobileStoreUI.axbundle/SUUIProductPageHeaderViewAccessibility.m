...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIProductPageHeaderView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIProductPageHeaderView", @"title", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIProductPageHeaderView", @"initWithClientContext:", "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIProductPageHeaderView", @"setUserRating:", "v", "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIProductPageHeaderView", @"setIconImage:", "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIProductPageHeaderView", @"setNumberOfUserRatings:", "v", "q", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIProductPageHeaderView", @"inAppPurchasesString", "@", 0);
}
...
- (SUUIProductPageHeaderViewAccessibility)initWithClientContext:(id)a3
{
  ...
  id v3 = [(SUUIProductPageHeaderViewAccessibility *)&v7 initWithClientContext:a3];
...
- (void)setIconImage:(id)a3
{
  ...
  v6 = NSString;
  objc_super v7 = accessibilityLocalizedString(@"icon.image.with.title");
...
- (void)setNumberOfUserRatings:(int64_t)a3
{
  ...
  if (a3 >= 1)
  {
    ...
    v6 = NSString;
    objc_super v7 = accessibilityLocalizedString(@"USER_RATING_COUNT");
...
- (CGRect)accessibilityFrame:(id)a3
{
  ...
  objc_super v5 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_userRatingLabel"];
...
{
  v4 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_titleLabel"];
  objc_super v5 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_userRatingStarsView"];
  double v6 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_userRatingLabel"];
  CGFloat v7 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"inAppPurchasesString"];
  double v8 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_ageBandLabel"];
  CGFloat v9 = [(SUUIProductPageHeaderViewAccessibility *)self _accessibilityValueForKey:@"facebookCount"];
  ...
  else
  {
    ...
    double v12 = accessibilityLocalizedString(@"FACEBOOK_FRIEND_LIKE_COUNT");
...
- (id)accessibilityElements
{
  ...
  v4 = [(SUUIProductPageHeaderViewAccessibility *)self _accessibilityValueForKey:*MEMORY[0x263F81490]];
  if (!v4)
  {
  ...
  CGFloat v7 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_artistButton"];
  double v8 = v7;
  if (v7 && [v7 _accessibilityViewIsVisible]) {
    [v6 axSafelyAddObject:v8];
  }
  CGFloat v9 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_shareButton"];
  uint64_t v10 = v9;
  if (v9 && [v9 _accessibilityViewIsVisible]) {
    [v6 axSafelyAddObject:v10];
  }
  CGFloat v11 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_iconImageView"];
  double v12 = v11;
  if (v11 && [v11 _accessibilityViewIsVisible]) {
    [v6 insertObject:v12 atIndex:0];
  }
  CGFloat v13 = [(SUUIProductPageHeaderViewAccessibility *)self safeValueForKey:@"_itemOfferButton"];
  CGFloat v14 = v13;
