...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIOverlayContainerView";
}
...
- (id)_accessibilityObscuredScreenAllowedViews
{
  ...
  v18.receiver = self;
  v18.super_class = (Class)SUUIOverlayContainerViewAccessibility;
  v8 = [(SUUIOverlayContainerViewAccessibility *)&v18 _accessibilityObscuredScreenAllowedViews];
LABEL_15:
