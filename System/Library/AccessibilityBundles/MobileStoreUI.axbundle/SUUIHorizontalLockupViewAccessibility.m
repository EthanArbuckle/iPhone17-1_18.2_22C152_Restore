...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIHorizontalLockupView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalLockupLayout", @"columns", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalLockupColumn", @"childViewElements", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalLockupView", @"_previewMediaURL", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalLockupView", @"_resolvePreviewStateAfterTransitionForFlipView:", "v", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalLockupView", @"_previewFrontView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUILockupViewElement", @"isSelectable", "B", 0);
}
...
- (id)accessibilityLabel
{
  ...
  HIBYTE(v64) = 0;
  BOOL v6 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_viewElementViews"];
...
LABEL_23:
              ...
              if (objc_opt_isKindOfClass())
              {
                ...
                id v20 = [v19 _accessibilityFindSubviewDescendantsPassingTest:&__block_literal_global_1];
              ...
              {
                v21 = v17;
                v22 = &__block_literal_global_354;
                goto LABEL_22;
              }
              ...
              else
              {
                ...
                {
                  v21 = v17;
                  v22 = &__block_literal_global_361;
LABEL_22:
                ...
                {
                  v21 = v17;
                  v22 = &__block_literal_global_366;
                  goto LABEL_22;
                }
                id v20 = 0;
              }
LABEL_24:
              ...
              int v8 = [(SUUIHorizontalLockupViewAccessibility *)self isAdvertisementView:v47] | v49;
              uint64_t v16 = v48 + 1;
            }
            while (v48 + 1 != v46);
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  id v7 = a4;
  int v8 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilitySupplementaryHeaderViews];
  ...
  v17 = -[SUUIHorizontalLockupViewAccessibility _accessibilityHitTest:withEvent:](&v19, sel__accessibilityHitTest_withEvent_, v7, x, y);
LABEL_13:
...
- (id)_accessibilitySupplementaryHeaderViews
{
  ...
  __int16 v46 = 0;
  id v3 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_layout"];
  v4 = __UIAccessibilitySafeClass();

  char v5 = [v4 safeValueForKey:@"columns"];
  BOOL v6 = __UIAccessibilitySafeClass();

  HIBYTE(v46) = 0;
  id v7 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_viewElementViews"];
        ...
        if (v16)
        {
          ...
          do
          {
            for (uint64_t i = 0; i != v17; ++i)
            {
              ...
              long long v21 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:v9];
              ...
              if ((objc_opt_isKindOfClass() & 1) != 0 && v21)
              {
                ...
                uint64_t v25 = accessibilityLocalizedString(@"preview.button");
...
- (CGRect)accessibilityFrame
{
  ...
  long long v17 = 0u;
  long long v18 = 0u;
  char v5 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilitySupplementaryFooterViews];
...
- (id)_accessibilitySupplementaryFooterViewsIncludePlayButton:(BOOL)a3 includeStyledImageButton:(BOOL)a4
{
  ...
  __int16 v44 = 0;
  uint64_t v7 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_layout"];
  uint64_t v8 = __UIAccessibilitySafeClass();

  uint64_t v9 = [v8 safeValueForKey:@"columns"];
  double v10 = __UIAccessibilitySafeClass();

  double v11 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_viewElementViews"];
          ...
          do
          {
            for (uint64_t i = 0; i != v19; ++i)
            {
              ...
              if ([v22 isAccessibilityElement]
                && (NSClassFromString(&cfstr_Suuistyledimag.isa), (objc_opt_isKindOfClass() & 1) != 0))
              {
                if ([v22 _accessibilityViewIsVisible])
                {
                  if (![(SUUIHorizontalLockupViewAccessibility *)self isAdvertisementView:v22]
...
LABEL_27:
              ...
              else
              {
                ...
                if ((objc_opt_isKindOfClass() & 1) != 0 && ([v22 isAccessibilityElement] & 1) != 0
                  || (NSClassFromString(&cfstr_Suuiofferview.isa), (objc_opt_isKindOfClass() & 1) != 0))
                {
                  [v6 addObject:v22];
                }
                else
...
- (id)accessibilityElements
{
  ...
  {
    double v3 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilitySupplementaryFooterViewsIncludePlayButton:0 includeStyledImageButton:1];
  }
...
- (BOOL)_toggleButtonAction:(id)a3
{
  uint64_t v3 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindToggleButton];
  uint64_t v4 = v3;
  if (v3)
  {
    ...
    uint64_t v7 = accessibilityLocalizedString(@"activated.toggle");
    id v8 = objc_msgSend(v6, "stringWithFormat:", v7, v5, v10, 3221225472, __61__SUUIHorizontalLockupViewAccessibility__toggleButtonAction___block_invoke, &unk_265138350);
...
- (BOOL)_styledImageButtonAction:(id)a3
{
  uint64_t v3 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindStyledImageButton];
  uint64_t v4 = v3;
  if (v3) {
...
- (BOOL)_playAction:(id)a3
{
  uint64_t v3 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindPlayButton];
  uint64_t v4 = v3;
  if (v3) {
    char v5 = [v3 accessibilityActivate];
  }
...
- (id)accessibilityCustomActions
{
  ...
  uint64_t v4 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindPlayButton];
  char v5 = v4;
  if (v4)
  {
    ...
    if (!v6)
    {
      uint64_t v6 = accessibilityLocalizedString(@"play.button");
    }
    uint64_t v7 = (void *)[objc_alloc(MEMORY[0x263F1C390]) initWithName:v6 target:self selector:sel__playAction_];
    [v3 axSafelyAddObject:v7];
  }
  id v8 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindStyledImageButton];
  char v9 = v8;
  if (v8)
  {
    ...
    if (!v10)
    {
      uint64_t v10 = accessibilityLocalizedString(@"more.button");
    }
    if ([(SUUIHorizontalLockupViewAccessibility *)self isAdvertisementView:v9])
    {
      uint64_t v11 = accessibilityLocalizedString(@"about.Ad");
  ...
  long long v13 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindToggleButton];
  long long v14 = v13;
  if (v13)
  {
...
{
  if ([(SUUIHorizontalLockupViewAccessibility *)self isAccessibilityElement]
    && ([(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindPlayButton],
        uint64_t v3 = objc_claimAutoreleasedReturnValue(),
        v3,
        !v3))
  {
    uint64_t v4 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilitySupplementaryFooterViewsIncludePlayButton:0 includeStyledImageButton:_AXSAutomationEnabled() != 0];
  }
  else
  {
    uint64_t v4 = 0;
...
- (id)automationElements
{
  return [(SUUIHorizontalLockupViewAccessibility *)self _accessibilitySupplementaryFooterViewsIncludePlayButton:1 includeStyledImageButton:1];
}
...
- (unint64_t)accessibilityTraits
{
  ...
  id v14 = [(SUUIHorizontalLockupViewAccessibility *)&v10 accessibilityTraits];
  uint64_t v3 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_lockupElement"];
  int v4 = [v3 safeBoolForKey:@"isSelectable"];

  if (v4)
  {
    char v5 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindStyledImageButton];
  ...
  v9[3] = &unk_265138558;
  v9[4] = &v11;
  id v6 = (id)[(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindSubviewDescendant:v9];
  unint64_t v7 = v12[3];
...
- (id)accessibilityValue
{
  id v2 = [(SUUIHorizontalLockupViewAccessibility *)self _accessibilityFindPlayButton];
  id v3 = [v2 safeValueForKey:@"_indeterminate"];
  int v4 = [v3 BOOLValue];

  if (v4)
  {
    int v5 = accessibilityLocalizedString(@"indeterminate.playback");
  }
  else
  {
    int v5 = 0;
...
- (void)_resolvePreviewStateAfterTransitionForFlipView:(id)a3
{
  ...
  uint64_t v4 = [(SUUIHorizontalLockupViewAccessibility *)self safeIntegerForKey:@"_previewState"];
  if (v4)
  {
    if (v4 == 2)
    {
      uint64_t v5 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_previewProgressIndicator"];
  ...
  else
  {
    ...
    {
      unint64_t v7 = [(SUUIHorizontalLockupViewAccessibility *)self safeValueForKey:@"_previewFrontView"];
