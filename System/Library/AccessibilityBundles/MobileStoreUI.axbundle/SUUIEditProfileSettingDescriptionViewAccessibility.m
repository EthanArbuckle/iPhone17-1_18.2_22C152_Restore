...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIEditProfileSettingDescriptionView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIEditProfileSettingDescriptionView", @"reloadWithSettingDescription: width: context:", "v", "@", "d", "@", 0);
}

- (void)_accessibilityLoadAccessibilityInformation
{
  v13.receiver = self;
  v13.super_class = (Class)SUUIEditProfileSettingDescriptionViewAccessibility;
  [(SUUIEditProfileSettingDescriptionViewAccessibility *)&v13 _accessibilityLoadAccessibilityInformation];
  id v3 = [(SUUIEditProfileSettingDescriptionViewAccessibility *)self safeValueForKey:@"_imageView"];
...
{
  v6.receiver = self;
  v6.super_class = (Class)SUUIEditProfileSettingDescriptionViewAccessibility;
