...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIToggleButton", @"element", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIToggleButton", @"toggledTitle", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIToggleButton", @"nonToggledTitle", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIToggleButton", @"isToggled", "B", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIToggleButton", @"toggleItemIdentifier", "@", 0);
  [v3 validateClass:@"SUUIToggleButton" hasInstanceVariable:@"_autoIncrementCount" withType:"q"];
}

- (id)accessibilityLabel
{
  id v3 = [(SUUIToggleButtonAccessibility *)self safeValueForKey:@"element"];
  v4 = [v3 accessibilityLabel];

  if ([v4 length]
    || ([(SUUIToggleButtonAccessibility *)self _accessibilityFindAttributedStringView], (v6 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    id v5 = v4;
  }
  else
...
- (id)accessibilityValue
{
  ...
  id v5 = [(SUUIToggleButtonAccessibility *)self safeValueForKey:v4];
  if ([v5 length])
  {
    id v5 = v5;
...
- (unint64_t)accessibilityTraits
{
  ...
  unint64_t v3 = *MEMORY[0x263F1CEE8] | [(SUUIToggleButtonAccessibility *)&v7 accessibilityTraits];
  int v4 = [(SUUIToggleButtonAccessibility *)self safeBoolForKey:@"isToggled"];
...
- (BOOL)accessibilityActivate
{
  ...
  BOOL v3 = [(SUUIToggleButtonAccessibility *)&v5 accessibilityActivate];
...
void __54__SUUIToggleButtonAccessibility_accessibilityActivate__block_invoke(uint64_t a1)
{
  ...
  if (v9)
  {
    id v2 = [NSClassFromString(&cfstr_Suuitogglestat.isa) defaultCenter];
    ...
    [v4 setToggled:*(unsigned char *)(a1 + 41) == 0];
    [v2 updateItem:v4];
  }
  else
  {
