...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIVerticalLockupCollectionViewCell";
}
...
- (BOOL)isAccessibilityElement
{
  return ![(SUUIVerticalLockupCollectionViewCellAccessibility *)self hasOnlyStringViews];
}
...
- (id)accessibilityCustomActions
{
  ...
  id v3 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityFindPlayButton];
  v4 = v3;
...
- (BOOL)_playAction:(id)a3
{
  uint64_t v3 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityFindPlayButton];
  uint64_t v4 = v3;
  if (v3) {
...
- (id)accessibilityLabel
{
  ...
  id v2 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self safeValueForKey:@"_lockupView"];
...
- (id)accessibilityValue
{
  id v2 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityFindPlayButton];
  uint64_t v3 = [v2 safeValueForKey:@"_indeterminate"];
  int v4 = [v3 BOOLValue];

  if (v4)
  {
    char v5 = accessibilityLocalizedString(@"indeterminate.playback");
  }
  else
  {
    char v5 = 0;
...
- (id)_accessibilitySupplementaryFooterViewsForThisCell:(BOOL)a3 includeText:(BOOL)a4
{
  ...
  uint64_t v7 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityValueForKey:*MEMORY[0x263F81490]];
  if (!v7)
  {
    uint64_t v7 = [MEMORY[0x263EFF980] array];
    uint64_t v8 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self safeValueForKey:@"_lockupView"];
    ...
    if (v13)
    {
      ...
      uint64_t v16 = @"SUUIAttributedStringView";
    ...
    [(SUUIVerticalLockupCollectionViewCellAccessibility *)v30 _accessibilitySetRetainedValue:v7 forKey:*MEMORY[0x263F81490]];
  }
...
- (id)accessibilityElements
{
  ...
  {
    uint64_t v3 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilitySupplementaryFooterViewsForThisCell:0 includeText:1];
  }
...
{
  if ([(SUUIVerticalLockupCollectionViewCellAccessibility *)self isAccessibilityElement]
    && ([(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityFindPlayButton], uint64_t v3 = objc_claimAutoreleasedReturnValue(), v3, !v3))
  {
    BOOL v4 = [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilitySupplementaryFooterViewsForThisCell:0 includeText:0];
  }
  else
  {
    BOOL v4 = 0;
...
- (id)automationElements
{
  return [(SUUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilitySupplementaryFooterViewsForThisCell:1 includeText:1];
}
...
- (CGPoint)accessibilityActivationPoint
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)SUUIVerticalLockupCollectionViewCellAccessibility;
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
    ...
    if (v9)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          -[SUUIVerticalLockupCollectionViewCellAccessibility convertPoint:toView:](self, "convertPoint:toView:", v13, x, y);
  ...
  v19.receiver = self;
  v19.super_class = (Class)SUUIVerticalLockupCollectionViewCellAccessibility;
  uint64_t v14 = -[SUUIVerticalLockupCollectionViewCellAccessibility _accessibilityHitTest:withEvent:](&v19, sel__accessibilityHitTest_withEvent_, v7, x, y);
LABEL_14:
