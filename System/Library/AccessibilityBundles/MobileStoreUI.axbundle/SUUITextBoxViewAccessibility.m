...
- (id)accessibilityElements
{
  ...
  v4 = [(SUUITextBoxViewAccessibility *)self _accessibilityValueForKey:*MEMORY[0x263F81490]];
  if (!v4)
  {
...
- (id)accessibilityLabel:(id)a3
{
  ...
  else
  {
    ...
    {
      v19.receiver = self;
      v19.super_class = (Class)SUUITextBoxViewAccessibility;
      v8 = [(SUUITextBoxViewAccessibility *)&v19 accessibilityLabel];
      goto LABEL_10;
    }
...
- (CGRect)accessibilityFrame:(id)a3
{
  ...
  else
  {
    ...
    {
      v26.receiver = self;
      v26.super_class = (Class)SUUITextBoxViewAccessibility;
...
- (unint64_t)accessibilityTraits:(id)a3
{
  ...
  else
  {
    ...
    {
      v13.receiver = self;
      v13.super_class = (Class)SUUITextBoxViewAccessibility;
      return (unint64_t)[(SUUITextBoxViewAccessibility *)&v13 accessibilityTraits];
    }
