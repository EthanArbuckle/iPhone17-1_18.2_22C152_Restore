...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalListView", @"setImage: forArtworkRequest: context:", "B", "@", "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIHorizontalListView", @"reloadWithViewElement: width: context:", "v", "@", "d", "@", 0);
...
- (BOOL)setImage:(id)a3 forArtworkRequest:(id)a4 context:(id)a5
{
  ...
  BOOL v6 = [(SUUIHorizontalListViewAccessibility *)&v8 setImage:a3 forArtworkRequest:a4 context:a5];
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  char v21 = 0;
  objc_opt_class();
  id v3 = [(SUUIHorizontalListViewAccessibility *)self safeValueForKey:@"_imageViewToImageResourceCacheKey"];
