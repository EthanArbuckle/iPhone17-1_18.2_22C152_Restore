...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIReviewsHistogramView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIReviewsHistogramView", @"initWithClientContext:", "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIReviewsHistogramView", @"setHistogramValues:", "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SUUIReviewsHistogramView", @"setUserRating:", "v", "d", 0);
  [v3 validateClass:@"SUUIReviewsHistogramView" hasInstanceVariable:@"_histogramImageView" withType:"UIImageView"];
  [v3 validateClass:@"SUUIReviewsHistogramView" hasInstanceVariable:@"_userRatingStarsView" withType:"UIImageView"];
  [v3 validateClass:@"SUUIReviewsHistogramView" hasInstanceVariable:@"_histogramValues" withType:"NSArray"];
}
...
- (void)setTitle:(id)a3
{
  ...
  [(SUUIReviewsHistogramViewAccessibility *)&v5 setTitle:a3];
...
- (void)setUserRating:(double)a3
{
  ...
  [(SUUIReviewsHistogramViewAccessibility *)&v8 setUserRating:a3];
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  id v3 = [(SUUIReviewsHistogramViewAccessibility *)self safeValueForKey:@"_histogramImageView"];
  [v3 setIsAccessibilityElement:1];
  v4 = accessibilityLocalizedString(@"histogram.star.rating");
  [v3 setAccessibilityLabel:v4];

  objc_super v5 = [(SUUIReviewsHistogramViewAccessibility *)self safeValueForKey:@"_userRatingStarsView"];
...
- (void)setHistogramValues:(id)a3
{
  ...
  [(SUUIReviewsHistogramViewAccessibility *)&v20 setHistogramValues:a3];
...
- (SUUIReviewsHistogramViewAccessibility)initWithClientContext:(id)a3
{
  v5.receiver = self;
  v5.super_class = (Class)SUUIReviewsHistogramViewAccessibility;
  id v3 = [(SUUIReviewsHistogramViewAccessibility *)&v5 initWithClientContext:a3];
