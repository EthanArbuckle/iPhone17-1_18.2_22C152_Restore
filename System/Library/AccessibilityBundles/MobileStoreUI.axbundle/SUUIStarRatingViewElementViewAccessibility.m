...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIStarRatingViewElementView";
}
...
- (id)accessibilityLabel
{
  ...
  if (v7 == 1)
  {
    v8 = objc_msgSend(v5, "stringByReplacingOccurrencesOfString:withString:options:range:", @"[^0-9]", &stru_26F7296D0, 1024, 0, objc_msgSend(v5, "length"));
