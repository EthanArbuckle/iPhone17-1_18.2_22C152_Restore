...
+ (id)safeCategoryTargetClassName
{
  return @"SUUICardViewElementCollectionViewCell";
}
...
- (id)accessibilityLabel
{
  ...
  if (![v6 length])
  {
    ...
    uint64_t v12 = MEMORY[0x245656BA0]();

    uint64_t v6 = (void *)v12;
  }
  if (![v6 length])
  {
    long long v13 = [(SUUICardViewElementCollectionViewCellAccessibility *)self _axAdornedImageElement];

    if (v13)
    {
      uint64_t v14 = accessibilityLocalizedString(@"play");
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (-[SUUICardViewElementCollectionViewCellAccessibility pointInside:withEvent:](self, "pointInside:withEvent:", v7, x, y))
  {
    ...
    long long v17 = 0u;
    long long v18 = 0u;
    uint64_t v8 = [(SUUICardViewElementCollectionViewCellAccessibility *)self _accessibilitySupplementaryFooterViews];
    ...
    uint64_t v14 = -[SUUICardViewElementCollectionViewCellAccessibility _accessibilityHitTest:withEvent:](&v16, sel__accessibilityHitTest_withEvent_, v7, x, y);
  }
  else
  {
    uint64_t v14 = 0;
...
- (BOOL)accessibilityActivate
{
  ...
  uint64_t v4 = [(SUUICardViewElementCollectionViewCellAccessibility *)self _accessibilityFindPlayButton];
...
- (id)_accessibilitySupplementaryFooterViews
{
  ...
  long long v27 = 0u;
  long long v28 = 0u;
  id obj = [(SUUICardViewElementCollectionViewCellAccessibility *)self _axLockupElements];
...
- (CGPoint)accessibilityActivationPoint
{
  uint64_t v3 = [(SUUICardViewElementCollectionViewCellAccessibility *)self _axAdornedImageElement];
...
- (unint64_t)accessibilityTraits
{
  ...
  return *MEMORY[0x263F1CEE8] | [(SUUICardViewElementCollectionViewCellAccessibility *)&v3 accessibilityTraits];
}
