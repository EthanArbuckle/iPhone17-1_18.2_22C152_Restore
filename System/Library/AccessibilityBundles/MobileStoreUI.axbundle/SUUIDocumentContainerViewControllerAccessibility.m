...
+ (id)safeCategoryTargetClassName
{
  return @"SUUIDocumentContainerViewController";
}
...
- (void)documentDidUpdate:(id)a3
{
  ...
  int v6 = [(SUUIDocumentContainerViewControllerAccessibility *)self _rightBarButtonIsEnabled];
  v20.receiver = self;
  v20.super_class = (Class)SUUIDocumentContainerViewControllerAccessibility;
  [(SUUIDocumentContainerViewControllerAccessibility *)&v20 documentDidUpdate:v4];

  v7 = [(SUUIDocumentContainerViewControllerAccessibility *)self _rightBarButtonAccessibilityLabel];
  int v8 = [(SUUIDocumentContainerViewControllerAccessibility *)self _rightBarButtonIsEnabled];
  if ([v5 isEqualToString:v7] && v6 != v8)
  {
    ...
    {
      v15 = accessibilityLocalizedString(@"button.disabled");
