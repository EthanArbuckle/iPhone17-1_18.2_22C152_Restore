id accessibilityLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F651FA0 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
...
void sub_241FF0FD4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, ...)
{
  va_start(va, a15);
...
void sub_241FF1218(_Unwind_Exception *a1)
{
