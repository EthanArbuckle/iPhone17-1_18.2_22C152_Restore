...
+ (id)safeCategoryTargetClassName
{
  return @"MRUAmbientNowPlayingVolumeControlsView";
}
...
- (void)_accessibilityIncreaseVolume:(BOOL)a3
{
  id v3 = [(MRUAmbientNowPlayingVolumeControlsViewAccessibility *)self volumeController];
...
- (id)volumeController
{
  return (id)[(MRUAmbientNowPlayingVolumeControlsViewAccessibility *)self safeValueForKey:@"_volumeController"];
}
