...
- (NSArray)histogram
{
  ...
  swift_release();
  swift_release();
  v4.super.isa = sub_A72A0().super.isa;
...
- (_TtC19LiveSpeechUIService31AXLTAudioHistogramViewGenerator)init
{
  ...
  *(Class *)((char *)&self->super.isa + v3) = v4;
  swift_retain();
  sub_91F20((uint64_t *)v11);
  v6 = (_OWORD *)((char *)v5 + OBJC_IVAR____TtC19LiveSpeechUIService31AXLTAudioHistogramViewGenerator_audioHistogramView);
  long long v7 = v11[3];
  v6[2] = v11[2];
  v6[3] = v7;
  v6[4] = v11[4];
...
- (id)viewController
{
  objc_allocWithZone((Class)sub_7AF4(&qword_DAB30));
  swift_retain();
  swift_retain();
