void sub_24237D4A0(_Unwind_Exception *a1)
{
  id *v1;
  uint64_t v2;
...
id accessibilityMusicLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F7488C8 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
...
id accessibilityOasisMusicLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F7488C8 table:@"Accessibility-AQ"];
  }
  else
  {
    v5 = 0;
...
void sub_242387CD0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
void sub_2423888AC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, id *location, id *a13)
{
...
void sub_24238B3F4(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
