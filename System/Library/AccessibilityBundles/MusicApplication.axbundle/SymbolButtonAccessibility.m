...
- (BOOL)_axIsCircularProgressView
{
  ...
  if (v2 && (MEMORY[0x2456584B0](@"MusicApplication.CircularProgressView"), (objc_opt_isKindOfClass() & 1) != 0)) {
  ...
  if (![v5 length])
  {
    ...
    else
    {
      if (![v9 isEqualToString:@"person.fill.badge.plus"])
      {
        ...
        uint64_t v11 = accessibilityOasisMusicLocalizedString(v19);
LABEL_14:
        v12 = (void *)v11;
...
{
  id v2 = a2;
  MEMORY[0x2456584B0](@"MusicCoreUI.CoreAnimationPackageView");
...
- (unint64_t)accessibilityTraits
{
  ...
  id v5 = [(SymbolButtonAccessibility *)self _accessibilityFindSubviewDescendant:&__block_literal_global_431];
