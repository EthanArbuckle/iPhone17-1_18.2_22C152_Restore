...
- (BOOL)isAccessibilityElement
{
  id v3 = [(UIButtonAccessibility__MusicApplication__UIKit *)self accessibilityIdentifier];
...
- (id)accessibilityLabel
{
  id v3 = [(UIButtonAccessibility__MusicApplication__UIKit *)self safeValueForKey:@"currentImage"];
...
LABEL_5:
  ...
  uint64_t v6 = [(UIButtonAccessibility__MusicApplication__UIKit *)&v9 accessibilityLabel];
LABEL_7:
  v7 = (void *)v6;
