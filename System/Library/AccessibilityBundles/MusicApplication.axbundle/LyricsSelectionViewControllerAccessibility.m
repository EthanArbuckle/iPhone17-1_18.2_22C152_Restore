...
+ (id)safeCategoryTargetClassName
{
  return @"MusicApplication.LyricsSelectionViewController";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MusicApplication.LyricsSelectionViewController", @"accessibilityCharacterCount", "q", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MusicApplication.LyricsSelectionViewController", @"accessibilityDidSelectItem", "v", 0);
}
