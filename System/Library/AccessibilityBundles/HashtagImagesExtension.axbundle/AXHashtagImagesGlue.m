...
uint64_t __52__AXHashtagImagesGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
...
uint64_t __52__AXHashtagImagesGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  return [a2 installSafeCategory:@"STSImageCellAccessibility" canInteractWithTargetClass:1];
}
