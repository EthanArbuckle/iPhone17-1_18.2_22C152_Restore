...
- (void)turnTorchOn
{
  ...
  if (-[AVCaptureDevice isTorchModeSupported:](self->_captureDevice, "isTorchModeSupported:", 1, captureDevice))
  {
...
- (void)turnTorchOff
{
  ...
  if (-[AVCaptureDevice isTorchModeSupported:](self->_captureDevice, "isTorchModeSupported:", 0, captureDevice))
  {
