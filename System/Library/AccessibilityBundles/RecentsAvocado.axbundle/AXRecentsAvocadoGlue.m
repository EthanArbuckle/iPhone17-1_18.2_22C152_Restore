@interface AXRecentsAvocadoGlue
...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXRecentsAvocadoGlue) init];
    MEMORY[0x270F9A758]();
  }
}
...
{
  id v2 = a2;
  [v2 setValidationTargetName:@"RecentsAvocado AX"];
  [v2 setOverrideProcessName:@"RecentsAvocado"];
  [v2 setDebugBuild:0];
...
{
  id v2 = a2;
  [v2 installSafeCategory:@"RecentItemCellAccessibility" canInteractWithTargetClass:1];
