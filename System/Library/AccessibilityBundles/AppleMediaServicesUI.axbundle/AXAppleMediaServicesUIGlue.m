...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXAppleMediaServicesUIGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __59__AXAppleMediaServicesUIGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
