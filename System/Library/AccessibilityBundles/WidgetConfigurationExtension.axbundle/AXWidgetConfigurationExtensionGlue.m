@interface AXWidgetConfigurationExtensionGlue
...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXWidgetConfigurationExtensionGlue) init];
    MEMORY[0x270F9A758]();
  }
}
...
{
  id v2 = a2;
  [v2 setValidationTargetName:@"WidgetConfigurationExtension AX"];
  [v2 setOverrideProcessName:@"WidgetConfigurationExtension"];
  [v2 setDebugBuild:0];
...
{
  return [a2 installSafeCategory:@"WFWidgetConfigurationAttributionYahooFinanceLogoAttachmentAccessibility" canInteractWithTargetClass:1];
}
