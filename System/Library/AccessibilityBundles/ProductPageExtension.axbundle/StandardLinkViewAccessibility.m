...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.StandardLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.StandardLinkView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.StandardLinkView", @"accessibilitySummaryLabel", "@", 0);
}
