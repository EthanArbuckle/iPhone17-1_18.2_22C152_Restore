...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.DeveloperLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.DeveloperLinkView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.DeveloperLinkView", @"accessibilityTitleLabel", "@", 0);
}
