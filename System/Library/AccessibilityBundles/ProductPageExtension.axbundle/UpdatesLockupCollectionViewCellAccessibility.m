...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.UpdatesLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.UpdatesLockupCollectionViewCell", @"accessibilitytLockupView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.UpdatesLockupCollectionViewCell", @"accessibilityExpandableTextView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.UpdatesLockupCollectionViewCell", @"accessibilityVersionMetadata", "@", 0);
}
...
- (id)accessibilityCustomContent
{
  ...
  if ([v4 length])
  {
    v5 = [MEMORY[0x263EFABD0] customContentWithLabel:&stru_26F78E4E8 value:v4];
