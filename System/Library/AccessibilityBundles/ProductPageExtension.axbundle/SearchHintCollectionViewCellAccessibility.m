...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.SearchHintCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.SearchHintCollectionViewCell", @"accessibilityHintView", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  id v3 = [v2 _accessibilityDescendantOfType:MEMORY[0x24565D250](@"AppStoreKitInternal.DynamicTypeLabel")];
