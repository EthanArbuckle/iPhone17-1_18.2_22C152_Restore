...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.PlatformSelectorView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.PlatformSelectorView", @"accessibilityDescriptionLabel", "@", 0);
