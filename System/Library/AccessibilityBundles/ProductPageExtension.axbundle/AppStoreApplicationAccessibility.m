...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.AppStoreApplication";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ProductPageExtension.ActivityViewController"];
  [v3 validateClass:@"ProductPageExtension.ActivityViewController" isKindOfClass:@"UIViewController"];
  [v3 validateClass:@"ProductPageExtension.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<FlowTabBarController>"];
  [v3 validateClass:@"ProductPageExtension.FlowTabBarController" isKindOfClass:@"UITabBarController"];
}
