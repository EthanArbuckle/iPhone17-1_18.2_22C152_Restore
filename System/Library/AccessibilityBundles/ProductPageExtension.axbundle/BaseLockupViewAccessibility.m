...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.BaseLockupView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ProductPageExtension.SearchAdTransparencyLabel"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BaseLockupView", @"accessibilityHeadingLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BaseLockupView", @"accessibilityTertiaryTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BaseLockupView", @"accessibilityOfferLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BaseLockupView", @"accessibilityOrdinalLabel", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BaseLockupView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BaseLockupView", @"accessibilityOfferButton", "@", 0);
}
...
{
  id v2 = a2;
  MEMORY[0x24565D250](@"ProductPageExtension.SearchAdTransparencyLabel");
