...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.ListTodayCardCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ProductPageExtension.ListTodayCardCollectionViewCell" hasSwiftField:@"labelsView" withSwiftType:"TodayCardLabelsView"];
  [v3 validateClass:@"ProductPageExtension.ListTodayCardCollectionViewCell" hasSwiftField:@"lockupContainer" withSwiftType:"TodayListCardLockupContainer"];
}
