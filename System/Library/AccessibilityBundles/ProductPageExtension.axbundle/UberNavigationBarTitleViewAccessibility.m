...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.UberNavigationBarTitleView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.UberNavigationBarTitleView", @"accessibilityNonStandardDismissButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.UberNavigationBarTitleView", @"layoutSubviews", "v", 0);
}
