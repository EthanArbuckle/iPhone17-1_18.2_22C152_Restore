...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.AchievementSummaryCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ProductPageExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"achievementGroupView" withSwiftType:"Optional<AchievementGroupView>"];
  [v3 validateClass:@"ProductPageExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"numberCompletedLabel" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"ProductPageExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"outOfTotalLabel" withSwiftType:"DynamicTypeLabel"];
...
- (id)accessibilityLabel
{
  ...
  v10 = [v9 stringByReplacingOccurrencesOfString:@"\u202A/ " withString:&stru_26F78E4E8];
