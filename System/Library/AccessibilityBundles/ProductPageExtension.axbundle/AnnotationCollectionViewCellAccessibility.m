...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.AnnotationCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilitySummaryLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilityDetailItems", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilityCellIsExpanded", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilityLinkLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilityLinkLabelTapped", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AnnotationCollectionViewCell", @"accessibilityIsSummaryExpandable", "B", 0);
}
