...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.InAppPurchaseLockupCollectionViewCell";
}
...
- (id)_axLockupView
{
  return (id)[(InAppPurchaseLockupCollectionViewCellAccessibility *)self safeValueForKey:@"accessibilityLockupView"];
}
