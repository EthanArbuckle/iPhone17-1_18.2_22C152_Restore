...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.AccountActionSectionFooterView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AccountActionSectionFooterView", @"accessibilityTextLabel", "@", 0);
