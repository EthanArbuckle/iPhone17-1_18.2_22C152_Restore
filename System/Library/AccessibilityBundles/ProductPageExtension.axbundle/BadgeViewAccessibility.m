...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.BadgeView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BadgeView", @"accessibilityValueLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BadgeView", @"accessibilityCaptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BadgeView", @"accessibilityHeadingLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BadgeView", @"accessibilityValueView", "@", 0);
  [v3 validateClass:@"ProductPageExtension.BadgeView" hasSwiftField:@"valueView" withSwiftType:"Optional<UIView>"];
