...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.BreakoutDetailsView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BreakoutDetailsView", @"accessibilityBadgeLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BreakoutDetailsView", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BreakoutDetailsView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.BreakoutDetailsView", @"accessibilityCallToActionButton", "@", 0);
}
