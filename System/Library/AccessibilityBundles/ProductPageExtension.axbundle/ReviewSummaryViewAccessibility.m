...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.ReviewSummaryView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"ProductPageExtension.ReviewSummaryView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
}
