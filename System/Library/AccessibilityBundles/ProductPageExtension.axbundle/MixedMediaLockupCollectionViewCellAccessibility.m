...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.MixedMediaLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.MixedMediaLockupCollectionViewCell", @"accessibilityLockupView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.MixedMediaLockupCollectionViewCell", @"accessibilityTaglineLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.MixedMediaLockupCollectionViewCell", @"accessibilityVideoView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.MixedMediaLockupCollectionViewCell", @"accessibilityMediaView", "@", 0);
}
