...
- (unint64_t)accessibilityTraits
{
  v2 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x24565D250](@"ProductPageExtension.CarouselItemLockupCollectionView", a2)];
...
- (id)accessibilityLabel
{
  ...
  {
    v4 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x24565D250](@"ProductPageExtension.CarouselItemLockupCollectionView")];
