...
+ (id)safeCategoryTargetClassName
{
  return @"ProductPageExtension.AccountDetailCollectionViewCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AccountDetailCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ProductPageExtension.AccountDetailCollectionViewCell", @"accessibilitySubtitleLabel", "@", 0);
  [v3 validateClass:@"ProductPageExtension.AccountDetailCollectionViewCell" hasSwiftField:@"detailLabel" withSwiftType:"DynamicTypeLabel"];
}
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x24565D250](@"AppStore.CountBadgeView");
  ...
  {
    MEMORY[0x24565D250](@"AppStoreKitInternal.DynamicTypeLabel");
