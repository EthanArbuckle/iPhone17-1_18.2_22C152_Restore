id accessibilityLocalizedString(void *a1)
{
  ...
  if (accessibilityLocalizedString_axBundle
    || ([MEMORY[0x263F086E0] bundleWithIdentifier:@"com.apple.Pegasus.axbundle"],
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F76C970 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
