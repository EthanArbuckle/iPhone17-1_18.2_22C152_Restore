...
- (id)_accessibilityLabelHelper
{
  ...
  if (![v3 length])
  {
    BOOL v4 = [(AudioTraitButtonAccessibility *)self _accessibilityFindViewAncestor:&__block_literal_global_8 startWithSelf:0];
    v5 = [v4 _accessibilityViewController];
    v6 = [v5 safeSwiftValueForKey:@"_playingItemAudioTrait"];
...
uint64_t __58__AudioTraitButtonAccessibility__accessibilityLabelHelper__block_invoke(uint64_t a1, void *a2)
{
  ...
  MEMORY[0x245658030](@"MusicNowPlayingControlsViewController");
