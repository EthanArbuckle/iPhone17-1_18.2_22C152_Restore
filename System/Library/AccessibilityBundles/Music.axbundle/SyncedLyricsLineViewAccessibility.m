...
- (id)accessibilityLabel
{
  ...
  v5 = [v4 _accessibilityDescendantOfType:MEMORY[0x245658030](@"MusicSBS_TextContentView")];
  v6 = v5;
  if (v5)
  {
  ...
  id v8 = [v4 _accessibilityDescendantOfType:MEMORY[0x245658030](@"MusicTextContentView")];
  if (!v8) {
    goto LABEL_6;
  }
  objc_opt_class();
  ...
  {
LABEL_6:
    v12 = [v4 _accessibilityDescendantOfType:MEMORY[0x245658030](@"MusicInstrumentalContentView")];
    if (!v12)
    {
      v9 = 0;
      goto LABEL_10;
