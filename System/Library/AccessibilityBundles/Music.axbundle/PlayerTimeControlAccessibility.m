...
+ (id)safeCategoryTargetClassName
{
  return @"Music.PlayerTimeControl";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Music.PlayerTimeControl", @"accessibilityTotalDuration", "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Music.PlayerTimeControl", @"accessibilityElapsedDuration", "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Music.PlayerTimeControl", @"accessibilityUpdateWithElapsedDuration:", "v", "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Music.PlayerTimeControl", @"accessibilityIsLiveContent", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Music.PlayerTimeControl", @"liveLabel", "@", 0);
}
