...
+ (id)safeCategoryTargetClassName
{
  return @"Music.NowPlayingContentView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Music.NowPlayingContentView", @"accessibilityPlayerVideoLayer", "@", 0);
