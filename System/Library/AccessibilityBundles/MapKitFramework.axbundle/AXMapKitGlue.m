...
void __45__AXMapKitGlue_accessibilityInitializeBundle__block_invoke()
{
  ...
  [v0 performValidations:&__block_literal_global_271 withPreValidationHandler:&__block_literal_global_296 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_305];
}
...
uint64_t __45__AXMapKitGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v2, "validateClass:hasInstanceMethod:withFullSignature:", @"MKAnnotationView", @"annotation", "@", 0);
