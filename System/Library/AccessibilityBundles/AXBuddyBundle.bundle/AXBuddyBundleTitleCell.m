...
- (void)setSeparatorStyle:(int64_t)a3
{
  ...
  {
    v3.receiver = self;
    v3.super_class = (Class)AXBuddyBundleTitleCell;
...
{
  v7.receiver = self;
  v7.super_class = (Class)AXBuddyBundleTitleCell;
  id v4 = [(AXBuddyBundleTitleCell *)&v7 initWithStyle:a3 reuseIdentifier:a4];
...
{
  v6.receiver = self;
  v6.super_class = (Class)AXBuddyBundleTitleCell;
  objc_super v3 = [(AXBuddyBundleTitleCell *)&v6 initWithCoder:a3];
  id v4 = [(AXBuddyBundleTitleCell *)v3 _commonInit];
