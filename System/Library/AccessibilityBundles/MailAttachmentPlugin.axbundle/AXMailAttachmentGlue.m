...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXMailAttachmentGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __53__AXMailAttachmentGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
...
uint64_t __53__AXMailAttachmentGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  return [a2 installSafeCategory:@"MFAttachmentViewAccessibility" canInteractWithTargetClass:1];
}
