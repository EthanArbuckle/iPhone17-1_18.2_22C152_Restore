...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.UpdatesLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.UpdatesLockupCollectionViewCell", @"accessibilitytLockupView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.UpdatesLockupCollectionViewCell", @"accessibilityExpandableTextView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.UpdatesLockupCollectionViewCell", @"accessibilityVersionMetadata", "@", 0);
}
...
- (id)accessibilityCustomContent
{
  ...
  if ([v4 length])
  {
    v5 = [MEMORY[0x263EFABD0] customContentWithLabel:&stru_26F6043D0 value:v4];
