...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.CondensedAppEventCardView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.CondensedAppEventCardView", @"accessibilityTitleLabel", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x245640BA0](@"AppStore.AppPromotionFormattedDateView");
