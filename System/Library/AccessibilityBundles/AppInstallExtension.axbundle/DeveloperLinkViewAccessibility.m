...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.DeveloperLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.DeveloperLinkView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.DeveloperLinkView", @"accessibilityTitleLabel", "@", 0);
}
