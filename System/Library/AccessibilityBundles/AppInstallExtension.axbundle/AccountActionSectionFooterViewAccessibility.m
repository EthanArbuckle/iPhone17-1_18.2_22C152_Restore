...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.AccountActionSectionFooterView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.AccountActionSectionFooterView", @"accessibilityTextLabel", "@", 0);
