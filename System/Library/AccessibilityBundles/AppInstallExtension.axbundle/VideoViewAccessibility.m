...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.VideoView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppInstallExtension.ProductLockupCollectionViewCell"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.VideoView", @"accessibilityUpdatePlayerControllerControls", "v", 0);
}
...
- (void)accessibilityUpdatePlayerControllerControls
{
  ...
  v5[3] = &unk_265104A88;
  v6 = @"AppInstallExtension.ProductLockupCollectionViewCell";
