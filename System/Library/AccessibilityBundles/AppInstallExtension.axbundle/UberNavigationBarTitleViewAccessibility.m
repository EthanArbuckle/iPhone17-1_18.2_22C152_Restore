...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.UberNavigationBarTitleView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.UberNavigationBarTitleView", @"accessibilityNonStandardDismissButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.UberNavigationBarTitleView", @"layoutSubviews", "v", 0);
}
