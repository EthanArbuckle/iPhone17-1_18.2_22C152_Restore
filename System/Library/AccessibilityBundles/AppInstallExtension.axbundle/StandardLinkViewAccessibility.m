...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.StandardLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.StandardLinkView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.StandardLinkView", @"accessibilitySummaryLabel", "@", 0);
}
