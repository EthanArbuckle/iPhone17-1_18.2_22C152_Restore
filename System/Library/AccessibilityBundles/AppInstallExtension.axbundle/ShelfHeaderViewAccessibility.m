...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.ShelfHeaderView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"eyebrowButton" withSwiftType:"DynamicTypeButton"];
  [v3 validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"titleButton" withSwiftType:"DynamicTypeButton"];
  [v3 validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"accessoryButton" withSwiftType:"DynamicTypeButton"];
}
...
- (id)accessibilityLabel
{
  ...
  v9 = [v8 stringByReplacingOccurrencesOfString:@"\uFFFC" withString:&stru_26F6043D0];
