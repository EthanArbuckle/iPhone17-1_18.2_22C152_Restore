...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.PlatformSelectorView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.PlatformSelectorView", @"accessibilityDescriptionLabel", "@", 0);
