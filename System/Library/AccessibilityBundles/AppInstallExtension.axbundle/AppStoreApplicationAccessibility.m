...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.AppStoreApplication";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"AppInstallExtension.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<FlowTabBarController>"];
  [v3 validateClass:@"AppInstallExtension.FlowTabBarController" isKindOfClass:@"UITabBarController"];
}
