...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.AnnotationCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.AnnotationCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.AnnotationCollectionViewCell", @"accessibilitySummaryLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.AnnotationCollectionViewCell", @"accessibilityDetailItems", "@", 0);
}
