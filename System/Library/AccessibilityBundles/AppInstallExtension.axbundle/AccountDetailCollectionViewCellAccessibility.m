...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.AccountDetailCollectionViewCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.AccountDetailCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.AccountDetailCollectionViewCell", @"accessibilitySubtitleLabel", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x245640BA0](@"AppStore.CountBadgeView");
  ...
  {
    MEMORY[0x245640BA0](@"AppStoreKitInternal.DynamicTypeLabel");
