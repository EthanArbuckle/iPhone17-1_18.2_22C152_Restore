...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.CondensedEditorialSearchResultContentView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.CondensedEditorialSearchResultContentView", @"accessibilityHeaderLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.CondensedEditorialSearchResultContentView", @"accessibilityTitleLabel", "@", 0);
}
