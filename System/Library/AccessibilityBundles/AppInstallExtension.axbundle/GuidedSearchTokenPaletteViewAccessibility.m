...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.GuidedSearchTokenPaletteView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppInstallExtension.GuidedSearchTokenPaletteView" hasSwiftField:@"tokens" withSwiftType:"Array<Token>"];
  [v3 validateClass:@"AppInstallExtension.GuidedSearchTokenPaletteView" hasSwiftField:@"collectionView" withSwiftType:"Optional<UICollectionView>"];
}
