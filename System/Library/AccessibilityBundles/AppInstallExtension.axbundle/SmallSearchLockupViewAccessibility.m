...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.SmallSearchLockupView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SmallSearchLockupView", @"accessibilitytUserRatingView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SmallSearchLockupView", @"accessibilityRatingCountLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SmallSearchLockupView", @"accessibilityIsAd", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SmallSearchLockupView", @"accessibilityAdButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SmallSearchLockupView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SmallSearchLockupView", @"accessibilitySearchTagsRibbonView", "@", 0);
  [v3 validateClass:@"AppInstallExtension.SmallSearchLockupView" isKindOfClass:@"AppInstallExtension.BaseLockupView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilityTitleLabel", "@", 0);
}
...
{
  id v6 = a2;
  MEMORY[0x245640BA0](@"AppStore.EditorsChoiceView");
