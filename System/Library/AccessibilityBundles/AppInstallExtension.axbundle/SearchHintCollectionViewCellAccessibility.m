...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.SearchHintCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.SearchHintCollectionViewCell", @"accessibilityHintView", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  id v3 = [v2 _accessibilityDescendantOfType:MEMORY[0x245640BA0](@"AppStoreKitInternal.DynamicTypeLabel")];
