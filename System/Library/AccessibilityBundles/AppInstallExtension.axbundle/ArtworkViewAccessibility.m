...
- (unint64_t)accessibilityTraits
{
  v2 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x245640BA0](@"AppInstallExtension.CarouselItemLockupCollectionView", a2)];
...
- (id)accessibilityLabel
{
  ...
  {
    v4 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x245640BA0](@"AppInstallExtension.CarouselItemLockupCollectionView")];
