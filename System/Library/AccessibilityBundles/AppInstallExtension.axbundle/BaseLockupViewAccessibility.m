...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.BaseLockupView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppInstallExtension.SearchAdTransparencyLabel"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilityHeadingLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilityTertiaryTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilityOfferLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilityOrdinalLabel", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppInstallExtension.BaseLockupView", @"accessibilityOfferButton", "@", 0);
}
...
{
  id v2 = a2;
  MEMORY[0x245640BA0](@"AppInstallExtension.SearchAdTransparencyLabel");
