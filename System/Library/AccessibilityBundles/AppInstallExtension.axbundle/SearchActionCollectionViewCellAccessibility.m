...
+ (id)safeCategoryTargetClassName
{
  return @"AppInstallExtension.SearchActionCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppInstallExtension.SearchActionCollectionViewCell" hasSwiftField:@"actionContentView" withSwiftType:"SearchActionContentView"];
  [v3 validateClass:@"AppInstallExtension.SearchActionContentView" hasSwiftField:@"linkLabel" withSwiftType:"DynamicLabel"];
}
