id AXGameCenterLocString(void *a1)
{
  ...
  {
    v2 = [(id)AXGameCenterLocString_bundle localizedStringForKey:v1 value:&stru_26F6ADA70 table:@"GameCenter"];
  }
  else
  {
    v2 = 0;
...
id AXGameCenterUIFrameworkLocString(void *a1)
{
  ...
  {
    v2 = [(id)AXGameCenterUIFrameworkLocString_bundle localizedStringForKey:v1 value:&stru_26F6ADA70 table:@"GameCenterUIFrameworkAccessibility"];
  }
  else
  {
    v2 = 0;
