...
+ (id)safeCategoryTargetClassName
{
  return @"MainWindowRootViewController";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MainWindowRootViewController", @"viewDidLoad", "v", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MainWindowRootViewController", @"setupSearchControlForTraitCollection:", "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MainWindowRootViewController", @"searchBegan", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MainWindowRootViewController", @"searchEnded", "v", 0);
...
{
  id v7 = a3;
  objc_super v4 = [(MainWindowRootViewControllerAccessibility *)self safeValueForKey:@"_rootNavigationController"];
...
- (BOOL)_accessibilityAddSearchToAccessibilityViews:(id)a3
{
  ...
  if ([v4 count])
  {
    ...
    else
    {
      ...
      uint64_t v12 = [v4 indexOfObject:v10];
      ...
      if ((v15 == v14
         || ([v11 superview],
             ...
             v17 = v10,
             v18 == v14))
        && (id v19 = v16, [v4 removeObject:v17], v19))
      {
      ...
      else
      {
        ...
        [v4 removeObject:v11];
        id v19 = 0;
        BOOL v8 = v12 != 0x7FFFFFFFFFFFFFFFLL || v13 != 0x7FFFFFFFFFFFFFFFLL;
      }
    }
  }
  else
...
- (void)_accessibilityRefreshSearchElementIfNeeded
{
  id v5 = [(MainWindowRootViewControllerAccessibility *)self safeUIViewForKey:@"view"];
  objc_super v3 = [v5 accessibilityElements];
