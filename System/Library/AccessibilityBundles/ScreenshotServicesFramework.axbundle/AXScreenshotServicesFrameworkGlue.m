...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXScreenshotServicesFrameworkGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __66__AXScreenshotServicesFrameworkGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
