...
{
  v40.receiver = self;
  v40.super_class = (Class)VOTEnabledBannerView;
  v3 = -[VOTEnabledBannerView initWithFrame:](&v40, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    ...
    v10 = [v9 localizedStringForKey:@"voiceover.instructions.text" value:&stru_3F588 table:@"VoiceOverUIServiceATV~appletv"];
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_bannerLabelView, 0);
