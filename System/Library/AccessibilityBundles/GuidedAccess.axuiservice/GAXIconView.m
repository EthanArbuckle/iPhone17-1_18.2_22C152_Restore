...
- (GAXIconView)initWithIcon:(id)a3 styleProvider:(id)a4
{
  ...
  id v7 = a4;
  v43.receiver = self;
  v43.super_class = (Class)GAXIconView;
  v8 = -[GAXIconView initWithFrame:](&v43, "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  if (v8)
  {
    ...
    id v12 = [v9 initWithEffect:v11];

    v13 = v12;
    [v12 setTranslatesAutoresizingMaskIntoConstraints:0];
    [(GAXIconView *)v8 addSubview:v12];
    id v14 = [objc_alloc((Class)UIImageView) initWithImage:v6];
