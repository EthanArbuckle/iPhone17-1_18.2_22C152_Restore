...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"CNContactHeaderStaticDisplayView", @"copy:", "v", "@", 0);
}
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CNContactHeaderStaticDisplayViewAccessibility;
  [(CNContactHeaderStaticDisplayViewAccessibility *)&v8 _accessibilityLoadAccessibilityInformation];
  id v3 = [(CNContactHeaderStaticDisplayViewAccessibility *)self safeValueForKey:@"nameLabel"];
...
uint64_t __81__CNContactHeaderStaticDisplayViewAccessibility__accessibilityPerformCopyAction___block_invoke(uint64_t a1)
{
