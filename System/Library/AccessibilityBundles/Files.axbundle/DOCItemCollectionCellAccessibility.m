...
+ (id)safeCategoryTargetClassName
{
  return @"Files.DOCItemCollectionCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCell", @"accessibilityCellManager", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCellContent", @"accessibilityItem", "@", 0);
  [v3 validateClass:@"Files.DOCItemCollectionCell" isKindOfClass:@"UICollectionViewCell"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCell", @"accessibilityCellManager", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCell", @"accessibilityIsRenaming", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCellContent", @"accessibilityItem", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCellContent", @"accessibilityShouldDim", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionViewController", @"accessibilityIsRenamingInline", "B", 0);
  [v3 validateClass:@"Files.DOCItemCollectionViewController" conformsToProtocol:@"UIContextMenuInteractionDelegate"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionViewController", @"contextMenuForItemsAt:", "@", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionViewController", @"contextMenuForFolder", "@", 0);
}
...
uint64_t __80__DOCItemCollectionCellAccessibility__accessibilityItemCollectionViewController__block_invoke(uint64_t a1, void *a2)
{
  ...
  NSClassFromString(&cfstr_FilesDocitemco.isa);
