...
+ (id)safeCategoryTargetClassName
{
  return @"Files.DOCItemCollectionGridCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionGridCell", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionGridCell", @"accessibilitySecondSubtitleLabel", "@", 0);
  ...
  [v3 validateClass:@"Files.DOCItemCollectionGridCell" isKindOfClass:@"Files.DOCItemCollectionCell"];
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCell", @"accessibilityThumbnailView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCellContent", @"accessibilityItem", "@", 0);
