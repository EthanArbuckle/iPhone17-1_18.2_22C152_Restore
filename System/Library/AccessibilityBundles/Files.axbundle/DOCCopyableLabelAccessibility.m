...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCCopyableLabel", @"copyDetail", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCCopyableLabel", @"handleTapWithSender:", "v", "@", 0);
  [v3 validateClass:@"Files.DOCCopyableLabel" hasSwiftField:@"supportsCopy" withSwiftType:"Bool"];
  [v3 validateClass:@"Files.DOCCopyableLabel" hasSwiftField:@"behaveAsLink" withSwiftType:"Bool"];
}
