...
+ (id)safeCategoryTargetClassName
{
  return @"Files.DOCFilenameViewController";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"Files.DOCFilenameViewController" isKindOfClass:@"UIViewController"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCFilenameViewController", @"filenameView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCFilenameViewController", @"item", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCFilenameView", @"textField", "@", 0);
}
