...
+ (id)safeCategoryTargetClassName
{
  return @"Files.DOCItemCollectionListCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionListCell", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionListCell", @"accessibilityDateLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionListCell", @"accessibilitySizeLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionListCell", @"accessibilityTagView", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCellContent", @"accessibilityIsFolder", "B", 0);
  [v3 validateClass:@"Files.DOCItemCollectionListCell" isKindOfClass:@"Files.DOCItemCollectionCell"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCItemCollectionCellContent", @"accessibilityItem", "@", 0);
}
