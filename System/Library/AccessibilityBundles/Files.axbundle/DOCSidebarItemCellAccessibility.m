...
+ (id)safeCategoryTargetClassName
{
  return @"Files.DOCSidebarItemCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"Files.DOCEjectButton"];
  [v3 validateClass:@"Files.DOCEjectButton" isKindOfClass:@"UIButton"];
  [v3 validateClass:@"Files.DOCSidebarItemCell" isKindOfClass:@"UICollectionViewListCell"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCSidebarItemCell", @"accessibilityShowFolder", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCSidebarItemCell", @"accessibilityTitle", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCSidebarItemCell", @"accessibilitySubtitle", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCSidebarItemCell", @"accessibilityIsEjectable", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Files.DOCSidebarItemCell", @"accessibilityTitleTextField", "@", 0);
}
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        NSClassFromString(&cfstr_FilesDocejectb.isa);
