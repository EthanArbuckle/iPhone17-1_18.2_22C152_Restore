...
+ (id)safeCategoryTargetClassName
{
  return @"PXCuratedLibraryViewProvider";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"PXCuratedLibraryViewProvider", @"axGroup:didChange:userInfo:", "v", "@", "Q", "@", 0);
}
...
- (void)axGroup:(id)a3 didChange:(unint64_t)a4 userInfo:(id)a5
{
  ...
  id v9 = a5;
  if (a4 != 2
    || ([(PXCuratedLibraryViewProviderAccessibility *)self safeValueForKey:@"gridView"],
