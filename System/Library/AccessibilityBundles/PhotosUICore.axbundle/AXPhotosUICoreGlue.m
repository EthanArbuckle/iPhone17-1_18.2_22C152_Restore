...
void __51__AXPhotosUICoreGlue_accessibilityInitializeBundle__block_invoke()
{
  ...
  [v0 performValidations:&__block_literal_global_492 withPreValidationHandler:&__block_literal_global_501 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_510];
}
...
void __51__AXPhotosUICoreGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  [v2 installSafeCategory:@"PXPeopleStripCollectionViewCellAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"PXCapsuleButtonAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"PXPeoplePickerCollectionViewCellAccessibility" canInteractWithTargetClass:1];
