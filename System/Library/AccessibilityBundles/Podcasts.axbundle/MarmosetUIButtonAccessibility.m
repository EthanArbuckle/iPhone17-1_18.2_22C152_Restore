...
- (id)accessibilityLabel
{
  ...
  if (([v5 hasPrefix:@"settingsglyph"] & 1) != 0
    || [v6 hasPrefix:@"settingsglyph"])
  {
    v7 = @"settings.button";
LABEL_9:
  ...
  if (([v5 hasPrefix:@"shareGlyph"] & 1) != 0
    || ([v5 hasPrefix:@"barShareGlyph"] & 1) != 0
    || ([v6 hasPrefix:@"shareGlyph"] & 1) != 0
    || [v6 hasPrefix:@"barShareGlyph"])
  {
    v7 = @"share.button";
    goto LABEL_9;
  }
  ...
  uint64_t v8 = [(MarmosetUIButtonAccessibility *)&v11 accessibilityLabel];
LABEL_10:
  v9 = (void *)v8;
...
- (id)accessibilityValue
{
  ...
  int v4 = [v3 isEqualToString:@"SpeedButton"];
...
{
  v3 = [(MarmosetUIButtonAccessibility *)self accessibilityIdentifier];
  int v4 = [v3 isEqualToString:@"NowPlayingBackButton"];
