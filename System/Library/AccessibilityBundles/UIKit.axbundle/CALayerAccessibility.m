@interface CALayerAccessibility
@end
...
BOOL __75__CALayerAccessibility__UIKit__QuartzCore__accessibilityHitTest_withEvent___block_invoke(uint64_t a1)
{
  ...
  id location = 0;
  objc_storeStrong(&location, &__block_literal_global_455);
  if (*v18 != -1) {
...
void __75__CALayerAccessibility__UIKit__QuartzCore__accessibilityHitTest_withEvent___block_invoke_2(uint64_t a1)
{
  ...
  if (InstanceMethod)
  {
    MACancelDownloadErrorDomain_block_invoke_BaseIMP Implementation = (uint64_t)method_getImplementation(InstanceMethod);
  }
  else
  {
