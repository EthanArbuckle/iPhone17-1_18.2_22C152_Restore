...
BOOL __71__AXPingMyWatchControlCenterUIModuleGlue_accessibilityInitializeBundle__block_invoke_2(id a1, AXValidationManager *a2)
{
  return 1;
}
...
void __71__AXPingMyWatchControlCenterUIModuleGlue_accessibilityInitializeBundle__block_invoke_4(id a1, AXValidationManager *a2)
{
  ...
  id v2 = +[UIAccessibilityInformationLoader sharedInstance];
