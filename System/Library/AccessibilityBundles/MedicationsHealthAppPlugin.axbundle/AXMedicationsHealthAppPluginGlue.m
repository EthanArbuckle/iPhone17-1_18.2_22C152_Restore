...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXMedicationsHealthAppPluginGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __65__AXMedicationsHealthAppPluginGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
