...
void __45__AXHomeUIGlue_accessibilityInitializeBundle__block_invoke()
{
  ...
  [v0 performValidations:&__block_literal_global_287 withPreValidationHandler:&__block_literal_global_305 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_311];
}
...
uint64_t __45__AXHomeUIGlue_accessibilityInitializeBundle__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  objc_msgSend(v2, "validateClass:hasInstanceMethod:withFullSignature:", @"HMAccessory", @"category", "@", 0);
  objc_msgSend(v2, "validateClass:hasInstanceMethod:withFullSignature:", @"HMAccessoryCategory", @"localizedDescription", "@", 0);
...
{
  [*(id *)(a1 + 32) installSafeCategory:@"HUViewControllerTableViewCellAccessibility" canInteractWithTargetClass:1];
  id v2 = *(void **)(a1 + 32);
