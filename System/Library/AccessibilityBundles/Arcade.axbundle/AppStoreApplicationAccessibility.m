...
+ (id)safeCategoryTargetClassName
{
  return @"Arcade.AppStoreApplication";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"Arcade.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<FlowTabBarController>"];
  [v3 validateClass:@"Arcade.FlowTabBarController" isKindOfClass:@"UITabBarController"];
}
