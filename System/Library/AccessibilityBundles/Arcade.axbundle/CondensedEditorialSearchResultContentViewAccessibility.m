...
+ (id)safeCategoryTargetClassName
{
  return @"Arcade.CondensedEditorialSearchResultContentView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Arcade.CondensedEditorialSearchResultContentView", @"accessibilityHeaderLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Arcade.CondensedEditorialSearchResultContentView", @"accessibilityTitleLabel", "@", 0);
}
