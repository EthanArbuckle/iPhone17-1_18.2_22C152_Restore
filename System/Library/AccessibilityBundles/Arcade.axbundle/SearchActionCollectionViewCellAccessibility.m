...
+ (id)safeCategoryTargetClassName
{
  return @"Arcade.SearchActionCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"Arcade.SearchActionCollectionViewCell" hasSwiftField:@"actionContentView" withSwiftType:"SearchActionContentView"];
  [v3 validateClass:@"Arcade.SearchActionContentView" hasSwiftField:@"linkLabel" withSwiftType:"DynamicLabel"];
}
