...
+ (id)safeCategoryTargetClassName
{
  return @"Arcade.AnnotationCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Arcade.AnnotationCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Arcade.AnnotationCollectionViewCell", @"accessibilitySummaryLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Arcade.AnnotationCollectionViewCell", @"accessibilityDetailItems", "@", 0);
}
