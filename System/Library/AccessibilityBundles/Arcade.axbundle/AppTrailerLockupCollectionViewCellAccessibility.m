...
+ (id)safeCategoryTargetClassName
{
  return @"Arcade.AppTrailerLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"Arcade.SmallLockupView", @"accessibilityAdLabel", "@", 0);
