...
+ (id)safeCategoryTargetClassName
{
  return @"Arcade.ListTodayCardCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"Arcade.ListTodayCardCollectionViewCell" hasSwiftField:@"labelsView" withSwiftType:"TodayCardLabelsView"];
  [v3 validateClass:@"Arcade.ListTodayCardCollectionViewCell" hasSwiftField:@"lockupContainer" withSwiftType:"TodayListCardLockupContainer"];
}
