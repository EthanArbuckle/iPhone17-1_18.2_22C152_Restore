id accessibilityLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F757930 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
...
void sub_2423B7CC8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
