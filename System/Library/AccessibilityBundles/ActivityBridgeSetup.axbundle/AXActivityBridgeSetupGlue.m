...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = (uint64_t)[objc_allocWithZone((Class)AXActivityBridgeSetupGlue) init];
    _objc_release_x1();
  }
}

BOOL __58__AXActivityBridgeSetupGlue_accessibilityInitializeBundle__block_invoke(id a1, AXValidationManager *a2)
{
  return 1;
}
