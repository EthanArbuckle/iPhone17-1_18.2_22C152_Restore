...
+ (id)safeCategoryTargetClassName
{
  return @"MFEmailSnippetComposeView";
}
...
- (id)accessibilityLabel
{
  ...
  if ([v5 length] && objc_msgSend(v7, "length"))
  {
    ...
    objc_msgSend(v3, "addObject:", v8, v7, @"__AXStringForVariablesSentinel");
  }
  ...
  if ([v10 length] && objc_msgSend(v12, "length"))
  {
    ...
    objc_msgSend(v3, "addObject:", v13, v12, @"__AXStringForVariablesSentinel");
  }
  v28 = v7;
  ...
  if ([v15 length] && objc_msgSend(v17, "length"))
  {
    ...
    objc_msgSend(v3, "addObject:", v18, v17, @"__AXStringForVariablesSentinel");
  }
  ...
  if ([v20 length] && objc_msgSend(v22, "length"))
  {
    ...
    objc_msgSend(v3, "addObject:", v23, v22, @"__AXStringForVariablesSentinel");
  }
