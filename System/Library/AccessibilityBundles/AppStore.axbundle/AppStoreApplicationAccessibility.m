...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.AppStoreApplication";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppStore.ActivityViewController"];
  [v3 validateClass:@"AppStore.ActivityViewController" isKindOfClass:@"UIViewController"];
  [v3 validateClass:@"AppStore.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<FlowTabBarController>"];
  [v3 validateClass:@"AppStore.FlowTabBarController" isKindOfClass:@"UITabBarController"];
}
