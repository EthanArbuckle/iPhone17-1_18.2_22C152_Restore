...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.BaseLockupView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppStore.SearchAdTransparencyLabel"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityHeadingLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityTertiaryTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityOfferLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityOrdinalLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityOfferButton", "@", 0);
}
...
{
  id v2 = a2;
  MEMORY[0x245641130](@"AppStore.SearchAdTransparencyLabel");
