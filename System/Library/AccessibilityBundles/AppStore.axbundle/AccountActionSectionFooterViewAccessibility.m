...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.AccountActionSectionFooterView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.AccountActionSectionFooterView", @"accessibilityTextLabel", "@", 0);
