...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"accessibilityShowRedownload", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"accessibilityShowLoading", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"accessibilityShowProgress:", "v", "d", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"accessibilityShowText:", "v", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"layoutSubviews", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"initWithFrame:", "@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0);
  [v3 validateClass:@"AppStore.OfferButton" hasSwiftField:@"label" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"AppStore.OfferButton" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.OfferButton", @"accessibilityOfferLabel", "@", 0);
  [v3 validateClass:@"AppStore.OfferButton" isKindOfClass:@"UIControl"];
}
...
- (id)accessibilityUserInputLabels
{
  ...
  objc_super v6 = MEMORY[0x245641140](v5);
