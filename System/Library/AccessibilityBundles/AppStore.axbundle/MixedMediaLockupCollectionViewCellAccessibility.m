...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.MixedMediaLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.MixedMediaLockupCollectionViewCell", @"accessibilityLockupView", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.MixedMediaLockupCollectionViewCell", @"accessibilityVideoView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.MixedMediaLockupCollectionViewCell", @"accessibilityMediaView", "@", 0);
}
