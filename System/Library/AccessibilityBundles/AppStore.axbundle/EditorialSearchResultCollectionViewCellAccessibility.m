...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.EditorialSearchResultCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialSearchResultCollectionViewCell", @"accessibilityEditorialTypeLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialSearchResultCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialSearchResultCollectionViewCell", @"accessibilitySummaryLabel", "@", 0);
}
