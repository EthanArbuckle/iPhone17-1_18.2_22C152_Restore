...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.SmallSearchLockupView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilitytUserRatingView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilityRatingCountLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilityIsAd", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilityAdButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilityMetadataRibbonView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallSearchLockupView", @"accessibilitySearchTagsRibbonView", "@", 0);
  [v3 validateClass:@"AppStore.SmallSearchLockupView" isKindOfClass:@"AppStore.BaseLockupView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.BaseLockupView", @"accessibilityTitleLabel", "@", 0);
  [v3 validateClass:@"AppStore.EditorsChoiceView"];
}
...
{
  id v6 = a2;
  MEMORY[0x245641130](@"AppStore.EditorsChoiceView");
