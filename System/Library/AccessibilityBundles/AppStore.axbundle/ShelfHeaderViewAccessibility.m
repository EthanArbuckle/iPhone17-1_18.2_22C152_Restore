...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.ShelfHeaderView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"eyebrowButton" withSwiftType:"DynamicTypeButton"];
  [v3 validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"titleButton" withSwiftType:"DynamicTypeButton"];
  [v3 validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"accessoryButton" withSwiftType:"DynamicTypeButton"];
}
...
- (id)accessibilityLabel
{
  ...
  v9 = [v8 stringByReplacingOccurrencesOfString:@"\uFFFC" withString:&stru_26F60FFA8];
