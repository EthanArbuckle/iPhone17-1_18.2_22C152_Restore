...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.UpdatesLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.UpdatesLockupCollectionViewCell", @"accessibilitytLockupView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.UpdatesLockupCollectionViewCell", @"accessibilityExpandableTextView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.UpdatesLockupCollectionViewCell", @"accessibilityVersionMetadata", "@", 0);
}
...
- (id)accessibilityCustomContent
{
  ...
  if ([v4 length])
  {
    v5 = [MEMORY[0x263EFABD0] customContentWithLabel:&stru_26F60FFA8 value:v4];
