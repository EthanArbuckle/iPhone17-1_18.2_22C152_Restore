...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.ProductReviewCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityDateLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityRatingView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityAuthorLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityBodyLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityResponseTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityResponseDateLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.ProductReviewCollectionViewCell", @"accessibilityResponseBodyLabel", "@", 0);
}
