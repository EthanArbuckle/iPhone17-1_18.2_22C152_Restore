...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.SmallLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SmallLockupCollectionViewCell", @"accessibilityLockupView", "@", 0);
  [v3 validateClass:@"AppStore.SmallLockupView" isKindOfClass:@"BaseLockupView"];
