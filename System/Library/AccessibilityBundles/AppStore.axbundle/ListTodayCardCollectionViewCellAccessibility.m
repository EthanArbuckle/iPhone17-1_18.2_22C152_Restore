...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.ListTodayCardCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppStore.ListTodayCardCollectionViewCell" hasSwiftField:@"labelsView" withSwiftType:"TodayCardLabelsView"];
  [v3 validateClass:@"AppStore.ListTodayCardCollectionViewCell" hasSwiftField:@"lockupContainer" withSwiftType:"TodayListCardLockupContainer"];
}
