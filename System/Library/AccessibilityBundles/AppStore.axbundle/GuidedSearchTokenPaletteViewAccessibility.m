...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.GuidedSearchTokenPaletteView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"AppStore.GuidedSearchTokenPaletteView" hasSwiftField:@"tokens" withSwiftType:"Array<Token>"];
  [v3 validateClass:@"AppStore.GuidedSearchTokenPaletteView" hasSwiftField:@"collectionView" withSwiftType:"Optional<UICollectionView>"];
}
