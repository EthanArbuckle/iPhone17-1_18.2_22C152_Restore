...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.CondensedEditorialSearchResultContentView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.CondensedEditorialSearchResultContentView", @"accessibilityHeaderLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.CondensedEditorialSearchResultContentView", @"accessibilityTitleLabel", "@", 0);
}
