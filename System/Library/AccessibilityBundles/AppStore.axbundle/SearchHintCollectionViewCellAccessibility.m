...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.SearchHintCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.SearchHintCollectionViewCell", @"accessibilityHintView", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  id v3 = [v2 _accessibilityDescendantOfType:MEMORY[0x245641130](@"AppStoreKitInternal.DynamicTypeLabel")];
