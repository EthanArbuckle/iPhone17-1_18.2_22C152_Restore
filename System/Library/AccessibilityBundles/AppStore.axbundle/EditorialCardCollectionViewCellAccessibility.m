...
+ (id)safeCategoryTargetClassName
{
  return @"AppStore.EditorialCardCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialCardCollectionViewCell", @"accessibilityCaptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialCardCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialCardCollectionViewCell", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"AppStore.EditorialCardCollectionViewCell", @"accessibilityLockupView", "@", 0);
}
...
- (id)accessibilityCustomActions
{
  ...
  if ([v4 _accessibilityViewIsVisible])
  {
    ...
    v7 = (void *)[v5 initWithName:v6 actionHandler:&__block_literal_global_3];
