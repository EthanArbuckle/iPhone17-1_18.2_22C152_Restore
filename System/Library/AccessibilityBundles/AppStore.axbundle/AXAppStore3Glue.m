...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    [v2 performValidations:&__block_literal_global withPreValidationHandler:&__block_literal_global_278 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_284];

    _Failover = [objc_allocWithZone((Class)AXAppStore3Glue) init];
    MEMORY[0x270F9A758]();
  }
}
...
{
  id v2 = a2;
  [v2 setValidationTargetName:@"AppStore AX Bundle"];
  [v2 setOverrideProcessName:@"AppStore"];
  [v2 setDebugBuild:0];
...
void __48__AXAppStore3Glue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  [v2 installSafeCategory:@"EditorsChoiceCollectionViewCellAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"StackViewAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"SearchTextFieldAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"BannerCollectionViewCellAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"ReviewsContainerCellAccessibility" canInteractWithTargetClass:1];
  ...
  [v2 installSafeCategory:@"AppStoreUIVisualEffectViewAccessibility" canInteractWithTargetClass:1];
