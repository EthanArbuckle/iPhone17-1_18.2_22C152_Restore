...
{
  id v2 = a2;
  [v2 setValidationTargetName:@"CompanionAppViewSetup AX"];
  [v2 setOverrideProcessName:@"CompanionAppViewSetup"];
  [v2 setDebugBuild:0];

  return MEMORY[0x270F0A270]();
}

uint64_t __60__AXCarouselAppViewSharedGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  return [a2 installSafeCategory:@"CSLPRFWatchChoiceViewAccessibility" canInteractWithTargetClass:1];
}
