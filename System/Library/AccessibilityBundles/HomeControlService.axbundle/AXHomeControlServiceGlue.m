...
uint64_t __57__AXHomeControlServiceGlue_accessibilityInitializeBundle__block_invoke_2()
{
  return 1;
}
...
uint64_t __57__AXHomeControlServiceGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  return [a2 installSafeCategory:@"HCSRemoteViewControllerAccessibility" canInteractWithTargetClass:1];
}
