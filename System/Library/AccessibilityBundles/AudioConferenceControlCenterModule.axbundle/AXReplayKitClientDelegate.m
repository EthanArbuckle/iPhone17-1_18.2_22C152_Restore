...
- (void)didStopRecordingOrBroadcast
{
  ...
  {
    *(_WORD *)v3 = 0;
    _os_log_impl(&dword_241F3F000, v2, OS_LOG_TYPE_DEFAULT, "Notifying VO that recording is stopping", v3, 2u);
  }
...
- (void)didStartRecordingOrBroadcast
{
  ...
  {
    *(_WORD *)v3 = 0;
    _os_log_impl(&dword_241F3F000, v2, OS_LOG_TYPE_DEFAULT, "Notifying VO that recording is starting", v3, 2u);
  }
