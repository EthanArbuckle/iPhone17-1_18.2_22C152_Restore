...
+ (id)safeCategoryTargetClassName
{
  return @"NonSelectableCollectionViewListCell";
}
...
{
  v2 = NSString;
  v3 = [(NonSelectableCollectionViewListCellAccessibility *)self _axCellSwitch];
...
- (unint64_t)accessibilityTraits
{
  ...
  return *MEMORY[0x263F1CF60] | [(NonSelectableCollectionViewListCellAccessibility *)&v3 accessibilityTraits];
}

- (BOOL)accessibilityActivate
{
  v2 = [(NonSelectableCollectionViewListCellAccessibility *)self _axCellSwitch];
...
void __65__NonSelectableCollectionViewListCellAccessibility__axCellSwitch__block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v6 = a2;
  objc_opt_class();
  ...
  if (isKindOfClass)
  {
    ...
    *(void *)(v11 + 40) = v10;
    ...
    [*(id *)(*(void *)(*(void *)(a1 + 32) + 8) + 40) setIsAccessibilityElement:0];
    *a4 = 1;
  }
}
