...
{
  id v3 = a3;
  [v3 validateClass:@"CKLinkSearchController" isKindOfClass:@"CKSearchController"];
...
- (id)cellForItemInCollectionView:(id)a3 atIndexPath:(id)a4 withIdentifier:(id)a5
{
  ...
  v11 = [(CKLinkSearchControllerAccessibility *)&v26 cellForItemInCollectionView:v8 atIndexPath:v9 withIdentifier:v10];
  LOBYTE(v20) = 0;
  objc_opt_class();
  ...
  if (v12)
  {
    ...
    if (v14 < [v13 count])
    {
      ...
      objc_msgSend(v12, "_axSetContact:", v16, v18, 3221225472, __94__CKLinkSearchControllerAccessibility_cellForItemInCollectionView_atIndexPath_withIdentifier___block_invoke, &unk_265112D10);
    }
  }
