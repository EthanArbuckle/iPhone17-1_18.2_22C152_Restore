...
+ (id)safeCategoryTargetClassName
{
  return @"CKLocationSearchController";
}
...
- (id)cellForItemInCollectionView:(id)a3 atIndexPath:(id)a4 withIdentifier:(id)a5
{
  ...
  id v10 = a5;
  v26.receiver = self;
  v26.super_class = (Class)CKLocationSearchControllerAccessibility;
  ...
  if (v12)
  {
    ...
    if (v14 < [v13 count])
    {
      ...
      objc_msgSend(v12, "_axSetContact:", v16, v18, 3221225472, __98__CKLocationSearchControllerAccessibility_cellForItemInCollectionView_atIndexPath_withIdentifier___block_invoke, &unk_265112D10);
    }
  }
