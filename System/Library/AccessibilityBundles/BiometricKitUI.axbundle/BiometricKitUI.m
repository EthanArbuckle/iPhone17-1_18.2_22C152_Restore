id accessibilityLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_26F63B560 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
...
void sub_241FA3FEC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
...
void sub_241FA5430(_Unwind_Exception *a1)
{
