...
- (unint64_t)accessibilityTraits
{
  ...
  unint64_t v3 = *MEMORY[0x263F1CEE8] | [(CNAutocompleteDisambiguatingTableViewCellAccessibility *)&v7 accessibilityTraits];
  int v4 = [(CNAutocompleteDisambiguatingTableViewCellAccessibility *)self safeBoolForKey:@"isCheckmarkVisible"];
