...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXStoreDynamicUIPluginGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __59__AXStoreDynamicUIPluginGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
