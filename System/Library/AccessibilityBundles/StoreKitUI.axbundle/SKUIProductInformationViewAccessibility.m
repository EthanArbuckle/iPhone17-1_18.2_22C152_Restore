...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIProductInformationView";
}
...
- (id)accessibilityElements
{
  id v3 = [(SKUIProductInformationViewAccessibility *)self _accessibilityValueForKey:*MEMORY[0x263F81490]];
  if (!v3)
  {
    ...
    [(SKUIProductInformationViewAccessibility *)self _accessibilitySetRetainedValue:v3 forKey:*MEMORY[0x263F81490]];
  }
