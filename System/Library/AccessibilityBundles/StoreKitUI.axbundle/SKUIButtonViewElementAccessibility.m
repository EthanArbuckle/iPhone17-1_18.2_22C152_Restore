...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIButtonViewElement", @"buttonImage", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIButtonViewElement", @"buttonText", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIImageViewElement", @"resourceName", "@", 0);
}

- (id)accessibilityLabel
{
  id v3 = [(SKUIButtonViewElementAccessibility *)self safeValueForKey:@"buttonText"];
...
{
  objc_opt_class();
  id v3 = [(SKUIButtonViewElementAccessibility *)self safeValueForKey:@"buttonImage"];
...
- (id)accessibilityText
{
  ...
  id v3 = [(SKUIButtonViewElementAccessibility *)&v7 accessibilityText];
