...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIProductPageFeaturesView";
}
...
- (id)accessibilityElements
{
  ...
  id v3 = [(SKUIProductPageFeaturesViewAccessibility *)self _accessibilityValueForKey:*MEMORY[0x263F81490]];
  if (!v3)
  {
    ...
    [(SKUIProductPageFeaturesViewAccessibility *)v15 _accessibilitySetRetainedValue:v3 forKey:*MEMORY[0x263F81490]];
  }
