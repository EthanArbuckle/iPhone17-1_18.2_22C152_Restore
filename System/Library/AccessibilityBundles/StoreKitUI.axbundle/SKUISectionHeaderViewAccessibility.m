@interface SKUISectionHeaderViewAccessibility
...
@implementation SKUISectionHeaderViewAccessibility

+ (id)safeCategoryTargetClassName
{
  return @"SKUISectionHeaderView";
}
...
- (void)layoutSubviews
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)SKUISectionHeaderViewAccessibility;
  [(SKUISectionHeaderViewAccessibility *)&v15 layoutSubviews];
  long long v13 = 0u;
  long long v14 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
...
- (unint64_t)accessibilityTraits
{
  ...
  if (![(SKUISectionHeaderViewAccessibility *)self _axHasOnlyStringViews]) {
    return *MEMORY[0x263F1CF18];
  }
  [(SKUISectionHeaderViewAccessibility *)self subviews];
  long long v11 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
  long long v14 = 0u;
