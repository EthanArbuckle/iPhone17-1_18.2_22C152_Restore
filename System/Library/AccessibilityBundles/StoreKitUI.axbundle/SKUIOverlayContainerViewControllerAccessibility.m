...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIOverlayContainerViewController";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOverlayContainerViewController", @"dismissWithFlipTransition: completionBlock:", "v", "@", "@?", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOverlayContainerViewController", @"dismissWithFadeTransitionCompletionBlock:", "v", "@?", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOverlayContainerViewController", @"showViewController: withFlipTransition: completionBlock:", "v", "@", "@", "@?", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOverlayContainerViewController", @"showViewController: withCompletionBlock:", "v", "@", "@?", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOverlayContainerViewController", @"showViewControllers:", "v", "@", 0);
}
...
- (void)dismissWithFlipTransition:(id)a3 completionBlock:(id)a4
{
  ...
  id v7 = v6;
  id v8 = a3;
  v9 = (void *)MEMORY[0x2455E5B30](v11);
  v10.receiver = self;
...
- (void)dismissWithFadeTransitionCompletionBlock:(id)a3
{
  ...
  id v9 = v4;
  id v5 = v4;
  id v6 = (void *)MEMORY[0x2455E5B30](v8);
  v7.receiver = self;
...
- (void)showViewController:(id)a3 withCompletionBlock:(id)a4
{
  ...
  id v7 = v6;
  id v8 = a3;
  id v9 = (void *)MEMORY[0x2455E5B30](v11);
  v10.receiver = self;
  v10.super_class = (Class)SKUIOverlayContainerViewControllerAccessibility;
...
- (void)showViewController:(id)a3 withFlipTransition:(id)a4 completionBlock:(id)a5
{
  ...
  id v10 = a4;
  id v11 = a3;
  id v12 = (void *)MEMORY[0x2455E5B30](v14);
  v13.receiver = self;
