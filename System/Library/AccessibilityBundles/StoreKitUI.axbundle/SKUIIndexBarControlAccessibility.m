...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIIndexBarControl", @"_visibleBounds", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIIndexBarControl", @"_entryAtIndexPath:", "@", 0);
...
- (id)accessibilityLabel
{
  return accessibilitySKUILocalizedString(@"index.bar.control");
}
...
- (void)_accessibilityBumpValue:(BOOL)a3
{
  ...
  BOOL v10 = [(SKUIIndexBarControlAccessibility *)self _accessibilityMoveToIndexPath:v9];
...
- (BOOL)_accessibilityMoveToIndexPath:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v16 = @"recently.added";
LABEL_13:
    uint64_t v15 = accessibilitySKUILocalizedString(v16);
LABEL_14:
...
LABEL_15:
  ...
  v18 = (id *)[(SKUIIndexBarControlAccessibility *)self safeIvarForKey:@"_lastSelectedIndexPath"];
  if (v18) {
...
- (void)_sendSelectionForTouch:(id)a3 withEvent:(id)a4
{
  ...
  id v7 = a4;
  v39.receiver = self;
  v39.super_class = (Class)SKUIIndexBarControlAccessibility;
  [(SKUIIndexBarControlAccessibility *)&v39 _sendSelectionForTouch:v6 withEvent:v7];
  if (UIAccessibilityIsVoiceOverRunning())
  {
    BOOL v8 = [(SKUIIndexBarControlAccessibility *)self _accessibilityValueForKey:@"AXLastIndexPath"];
    ...
    char v20 = [(SKUIIndexBarControlAccessibility *)self safeValueForKey:@"_totalEntryCount"];
...
void __69__SKUIIndexBarControlAccessibility__sendSelectionForTouch_withEvent___block_invoke(void *a1, void *a2, unsigned char *a3)
{
  id v6 = a2;
...
{
  v18.receiver = self;
  v18.super_class = (Class)SKUIIndexBarControlAccessibility;
  [(SKUIIndexBarControlAccessibility *)&v18 accessibilityFrame];
  double v4 = v3;
  double v6 = v5;
  uint64_t v7 = [(SKUIIndexBarControlAccessibility *)self safeValueForKey:@"_visibleBounds"];
  [v7 rectValue];
  double v9 = v8;
  double v11 = v10;
  double v13 = v12;
...
- (id)accessibilityFlowToElements
{
  return (id)[(SKUIIndexBarControlAccessibility *)self _accessibilityValueForKey:@"kAXSKUIToElements"];
}
