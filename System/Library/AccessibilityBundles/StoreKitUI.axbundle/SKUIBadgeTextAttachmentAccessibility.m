@interface SKUIBadgeTextAttachmentAccessibility
...
@implementation SKUIBadgeTextAttachmentAccessibility

+ (id)safeCategoryTargetClassName
{
  return @"SKUIBadgeTextAttachment";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"SKUIBadgeTextAttachment" isKindOfClass:@"NSTextAttachment"];
}
...
- (id)accessibilityLabel
{
  char v11 = 0;
  objc_opt_class();
  id v3 = [(SKUIBadgeTextAttachmentAccessibility *)self safeValueForKey:@"image"];
  ...
  if ([v5 isEqualToString:@"Badge_CC"])
  {
    v6 = @"video.cc";
LABEL_11:
    uint64_t v7 = accessibilitySKUILocalizedString(v6);
    goto LABEL_12;
  }
  ...
  v10.receiver = self;
  v10.super_class = (Class)SKUIBadgeTextAttachmentAccessibility;
  uint64_t v7 = [(SKUIBadgeTextAttachmentAccessibility *)&v10 accessibilityLabel];
LABEL_12:
  v8 = (void *)v7;
