...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIImageCollectionViewCell";
}
...
- (unint64_t)accessibilityTraits
{
  char v13 = 0;
  objc_opt_class();
  id v3 = [(SKUIImageCollectionViewCellAccessibility *)self superview];
...
- (id)accessibilityLabel
{
  ...
  v36[3] = &unk_2650AB788;
  v36[4] = self;
  id v3 = [(SKUIImageCollectionViewCellAccessibility *)self _accessibilityFindDescendant:v36];
  ...
  if (!v4)
  {
    char v35 = 0;
    objc_opt_class();
    uint64_t v5 = [(SKUIImageCollectionViewCellAccessibility *)self superview];
      ...
      if (v17)
      {
        ...
        while (2)
        {
          for (uint64_t j = 0; j != v18; ++j)
          {
            ...
            {
              v24 = NSString;
              v25 = accessibilitySKUILocalizedString(@"cover.photo.of.artist");
