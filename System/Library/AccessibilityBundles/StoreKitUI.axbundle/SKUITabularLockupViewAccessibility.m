...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUITabularLockupLayout", @"columns", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUITabularLockupColumn", @"childViewElements", "@", 0);
}
...
- (id)accessibilityLabel
{
  ...
  __int16 v49 = 0;
  id v3 = [(SKUITabularLockupViewAccessibility *)self safeValueForKey:@"_layout"];
