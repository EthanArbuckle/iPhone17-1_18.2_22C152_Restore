...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIGiftTextTableViewCell";
}
...
- (id)accessibilityLabel
{
  return (id)[(SKUIGiftTextTableViewCellAccessibility *)self safeValueForKey:@"label"];
}

- (id)accessibilityValue
{
  id v3 = [(SKUIGiftTextTableViewCellAccessibility *)self safeValueForKey:@"_placeholderLabel"];
  char v4 = [v3 isHidden];
...
- (void)_accessibilitySetSelectedTextRange:(_NSRange)a3
{
  ...
  id v5 = [(SKUIGiftTextTableViewCellAccessibility *)self _accessibilityTextViewTextOperationResponder];
...
{
  id v4 = a3;
  NSUInteger v5 = [(SKUIGiftTextTableViewCellAccessibility *)self _accessibilityTextViewTextOperationResponder];
...
- (id)_accessibilityTextViewTextOperationResponder
{
  return (id)[(SKUIGiftTextTableViewCellAccessibility *)self safeValueForKey:@"_textView"];
}

- (unint64_t)accessibilityTraits
{
  uint64_t v3 = [(SKUIGiftTextTableViewCellAccessibility *)self safeValueForKey:@"_placeholderLabel"];
  int v4 = [v3 isHidden];
