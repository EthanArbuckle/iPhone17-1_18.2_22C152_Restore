...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIChartColumnHeaderView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIChartColumnHeaderView", @"layoutSubviews", "v", 0);
}
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)SKUIChartColumnHeaderViewAccessibility;
  [(SKUIChartColumnHeaderViewAccessibility *)&v13 _accessibilityLoadAccessibilityInformation];
  long long v11 = 0u;
  long long v12 = 0u;
  long long v9 = 0u;
  long long v10 = 0u;
  id v3 = [(SKUIChartColumnHeaderViewAccessibility *)self safeValueForKey:@"_buttons", 0];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SKUIChartColumnHeaderViewAccessibility;
