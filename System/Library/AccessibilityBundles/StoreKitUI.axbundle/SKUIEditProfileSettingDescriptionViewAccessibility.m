...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIEditProfileSettingDescriptionView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIEditProfileSettingDescriptionView", @"reloadWithSettingDescription: width: context:", "v", "@", "d", "@", 0);
}
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  id v3 = [(SKUIEditProfileSettingDescriptionViewAccessibility *)self safeValueForKey:@"_imageView"];
