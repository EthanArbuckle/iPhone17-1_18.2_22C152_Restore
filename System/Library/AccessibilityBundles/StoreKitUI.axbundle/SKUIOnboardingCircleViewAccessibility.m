...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIOnboardingCircleView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOnboardingCircleView", @"titleLabel", "@", 0);
...
{
  char v17 = 0;
  id v3 = [(SKUIOnboardingCircleViewAccessibility *)self superview];
...
uint64_t __70__SKUIOnboardingCircleViewAccessibility__accessibilityScrollToVisible__block_invoke_2(uint64_t a1)
{
  return objc_msgSend(*(id *)(a1 + 32), "applyForce:", dbl_2402AF290[*(double *)(a1 + 40) < 0.0], *(double *)(MEMORY[0x263F00148] + 8));
}

- (id)accessibilityLabel
{
  id v2 = [(SKUIOnboardingCircleViewAccessibility *)self safeValueForKey:@"titleLabel"];
...
- (id)accessibilityValue
{
  id v3 = [(SKUIOnboardingCircleViewAccessibility *)self _accessibilityPhysicalCirclesViewSuperview];
...
- (id)accessibilityHint
{
  return accessibilitySKUILocalizedString(@"circle.hint");
}
