...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIOnboardingAffiliationCirclesViewController";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOnboardingAffiliationCirclesViewController", @"instructionsView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOnboardingInstructionsView", @"explanationLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIOnboardingInstructionsView", @"titleLabel", "@", 0);
}
...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  id v3 = [(SKUIOnboardingAffiliationCirclesViewControllerAccessibility *)self safeValueForKey:@"instructionsView"];
...
- (void)viewDidAppear:(BOOL)a3
{
  v5.receiver = self;
  v5.super_class = (Class)SKUIOnboardingAffiliationCirclesViewControllerAccessibility;
  [(SKUIOnboardingAffiliationCirclesViewControllerAccessibility *)&v5 viewDidAppear:a3];
...
{
  BOOL v3 = a3;
  objc_super v5 = [(SKUIOnboardingAffiliationCirclesViewControllerAccessibility *)self _accessibilityValueForKey:@"AXLayoutChangedTimerKey"];
  [v5 invalidate];
  ...
  [(SKUIOnboardingAffiliationCirclesViewControllerAccessibility *)&v6 viewWillDisappear:v3];
}
