...
+ (id)safeCategoryTargetClassName
{
  return @"SKUIAttributedStringView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIAttributedStringLayout", @"attributedString", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIAttributedStringView", @"requiredBadges", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"SKUIAttributedStringView", @"_setupTapLocatorContainer", "v", 0);
...
- (id)accessibilityLabel
{
  ...
  id v3 = [(SKUIAttributedStringViewAccessibility *)self accessibilityUserDefinedLabel];
...
- (unint64_t)accessibilityTraits
{
  ...
  id v18 = 0;
  v14.receiver = self;
  v14.super_class = (Class)SKUIAttributedStringViewAccessibility;
  id v18 = [(SKUIAttributedStringViewAccessibility *)&v14 accessibilityTraits];
  objc_opt_class();
  char v13 = 0;
  id v3 = [(SKUIAttributedStringViewAccessibility *)self safeValueForKey:@"_layout"];
...
- (id)_accessibilityLinks
{
  ...
  if (v5)
  {
    ...
    if (v8 >= 1)
    {
      ...
      uint64_t v27 = &unk_2650AB650;
      v28 = self;
      AXPerformSafeBlock();
      v10 = [(SKUIAttributedStringViewAccessibility *)self safeValueForKey:@"_layoutManager"];
      id v11 = [(SKUIAttributedStringViewAccessibility *)self safeValueForKey:@"_textContainer"];
      uint64_t v15 = MEMORY[0x263EF8330];
      uint64_t v16 = 3221225472;
      uint64_t v17 = __60__SKUIAttributedStringViewAccessibility__accessibilityLinks__block_invoke_2;
      id v18 = &unk_2650AB678;
      id v19 = v10;
      id v20 = v11;
      long long v21 = self;
      id v22 = v7;
      ...
      id v12 = v11;
      id v13 = v10;
      objc_msgSend(v22, "enumerateAttribute:inRange:options:usingBlock:", @"SKUILinkAttributeName", 0, v9, 0, &v15);
    }
    [(SKUIAttributedStringViewAccessibility *)self _accessibilitySetRetainedValue:v3, @"kAXLinks", v15, v16, v17, v18 forKey];
  }

  return v3;
}

uint64_t __60__SKUIAttributedStringViewAccessibility__accessibilityLinks__block_invoke(uint64_t a1)
{
...
- (id)accessibilityCustomRotors
{
  ...
  double v3 = [(SKUIAttributedStringViewAccessibility *)self _accessibilityLinks];
  uint64_t v4 = [v3 count];

  if (v4)
  {
    int v5 = [(SKUIAttributedStringViewAccessibility *)self _accessibilityValueForKey:@"AXCustomRotor"];
    if (!v5)
    {
      ...
      id v11 = __66__SKUIAttributedStringViewAccessibility_accessibilityCustomRotors__block_invoke;
      id v12 = &unk_2650AB6A0;
      objc_copyWeak(&v13, &location);
      int v5 = (void *)[v6 initWithSystemType:1 itemSearchBlock:&v9];
      [(SKUIAttributedStringViewAccessibility *)self _accessibilitySetRetainedValue:v5, @"AXCustomRotor", v9, v10, v11, v12 forKey];
...
- (id)accessibilityCustomRotorItemsAtIndex:(int64_t)a3
{
  ...
  {
    int v5 = [(SKUIAttributedStringViewAccessibility *)self _accessibilityLinks];
  }
  return v5;
}
