...
- (id)accessibilityLabel
{
  ...
  if ([v3 isEqualToString:@"Badge_CC"])
  {
    v4 = @"video.cc";
LABEL_11:
    uint64_t v5 = accessibilitySKUILocalizedString(v4);
    goto LABEL_12;
  }
  ...
  uint64_t v5 = [(SKUIImageViewAccessibility *)&v8 accessibilityLabel];
LABEL_12:
  v6 = (void *)v5;
...
LABEL_25:
  ...
  v8.receiver = self;
  v8.super_class = (Class)SKUIImageViewAccessibility;
  uint64_t v5 = [(SKUIImageViewAccessibility *)&v8 accessibilityValue];
LABEL_26:
  v6 = (void *)v5;
