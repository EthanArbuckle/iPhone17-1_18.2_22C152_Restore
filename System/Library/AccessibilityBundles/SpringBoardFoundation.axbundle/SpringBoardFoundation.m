...
LABEL_4:
    v8 = [v2 localizedStringForKey:v1 value:&stru_26F7E6160 table:@"Accessibility"];
    goto LABEL_5;
  }
  v3 = (void *)MEMORY[0x263F086E0];
  v4 = MEMORY[0x245663800]();
...
void sub_2425BC828(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
...
id accessibilityLocalizedString(void *a1)
{
  ...
  {
    id v2 = (id)accessibilityBundle_axBundle_0;
LABEL_4:
    id v8 = [v2 localizedStringForKey:v1 value:&stru_26F7E6160 table:@"Accessibility"];

    goto LABEL_5;
  }
  uint64_t v3 = (void *)MEMORY[0x263F086E0];
  uint64_t v4 = MEMORY[0x2456637A0]();
  uint64_t v5 = [v4 stringByAppendingPathComponent:@"SpringBoard.axbundle"];
  uint64_t v6 = [v3 bundleWithPath:v5];
  v7 = (void *)accessibilityBundle_axBundle_0;
...
void sub_2425BD198(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_2425BD34C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void *__getAXRequestingClientSymbolLoc_block_invoke(uint64_t a1)
{
  ...
  if (!AXRuntimeLibraryCore_frameworkLibrary)
  {
    ...
    v4[5] = v4;
    long long v5 = xmmword_2651576C0;
    uint64_t v6 = 0;
...
void soft_AXRequestingClient_cold_1()
{
  ...
  id v1 = [NSString stringWithUTF8String:"AXRequestingClientType soft_AXRequestingClient(void)"];
...
void __getAXRequestingClientSymbolLoc_block_invoke_cold_1(void *a1)
{
  ...
  id v3 = [NSString stringWithUTF8String:"void *AXRuntimeLibrary(void)"];
