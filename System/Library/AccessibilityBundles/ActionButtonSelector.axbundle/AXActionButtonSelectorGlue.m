...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXActionButtonSelectorGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __59__AXActionButtonSelectorGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
