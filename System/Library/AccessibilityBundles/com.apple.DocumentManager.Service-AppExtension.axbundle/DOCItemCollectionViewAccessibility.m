...
+ (id)safeCategoryTargetClassName
{
  return @"com_apple_DocumentManager_Service.DOCItemCollectionView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"com_apple_DocumentManager_Service.DOCItemCollectionView" isKindOfClass:@"UIView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCItemCollectionViewController", @"displayMode", "q", 0);
}
