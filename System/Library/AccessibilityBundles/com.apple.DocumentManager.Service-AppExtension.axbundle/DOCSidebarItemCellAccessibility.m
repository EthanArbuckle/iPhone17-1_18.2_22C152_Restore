...
+ (id)safeCategoryTargetClassName
{
  return @"com_apple_DocumentManager_Service.DOCSidebarItemCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"com_apple_DocumentManager_Service.DOCEjectButton"];
  [v3 validateClass:@"com_apple_DocumentManager_Service.DOCEjectButton" isKindOfClass:@"UIButton"];
  [v3 validateClass:@"com_apple_DocumentManager_Service.DOCSidebarItemCell" isKindOfClass:@"UICollectionViewListCell"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCSidebarItemCell", @"accessibilityShowFolder", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCSidebarItemCell", @"accessibilityTitle", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCSidebarItemCell", @"accessibilityIsEjectable", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCSidebarItemCell", @"accessibilityTitleTextField", "@", 0);
}
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        NSClassFromString(&cfstr_ComAppleDocume_5.isa);
...
- (id)_accessibilitySupplementaryFooterViews
{
  ...
  objc_msgSend(v3, "ax_removeObjectsFromArrayUsingBlock:", &__block_literal_global_1);
