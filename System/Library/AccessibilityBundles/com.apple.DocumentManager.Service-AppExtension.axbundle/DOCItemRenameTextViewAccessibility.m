...
+ (id)safeCategoryTargetClassName
{
  return @"com_apple_DocumentManager_Service.DOCItemRenameTextView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"com_apple_DocumentManager_Service.DOCItemRenameTextView" isKindOfClass:@"UIView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCItemRenameTextView", @"accessibilityClearButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCItemRenameTextView", @"installClearButton", "v", 0);
}
