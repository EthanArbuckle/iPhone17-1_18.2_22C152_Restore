...
+ (id)safeCategoryTargetClassName
{
  return @"com_apple_DocumentManager_Service.DOCSidebarHeaderCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCSidebarHeaderCell", @"accessibilityTitle", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"com_apple_DocumentManager_Service.DOCSidebarHeaderCell", @"accessibilityExpanded", "B", 0);
}
