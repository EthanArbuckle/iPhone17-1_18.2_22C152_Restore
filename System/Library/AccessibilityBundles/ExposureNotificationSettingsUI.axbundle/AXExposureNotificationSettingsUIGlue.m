...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    _Failover = [objc_allocWithZone((Class)AXExposureNotificationSettingsUIGlue) init];
    MEMORY[0x270F9A758]();
  }
}

uint64_t __69__AXExposureNotificationSettingsUIGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
