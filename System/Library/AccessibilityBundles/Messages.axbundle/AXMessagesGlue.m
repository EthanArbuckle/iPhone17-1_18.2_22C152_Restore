...
uint64_t __47__AXMessagesGlue_accessibilityInitializeBundle__block_invoke_2()
{
  return 1;
}
...
uint64_t __47__AXMessagesGlue_accessibilityInitializeBundle__block_invoke_4(uint64_t a1, void *a2)
{
  return [a2 installSafeCategory:@"MSStickerViewAccessibility" canInteractWithTargetClass:1];
}
