...
{
  id v2 = a2;
  [v2 installSafeCategory:@"RGBLivenessCaptureSelfieVCAccessibility" canInteractWithTargetClass:1];
  [v2 installSafeCategory:@"RGBLivenessCoachingViewAccessibility" canInteractWithTargetClass:1];
  [v2 installSafeCategory:@"CaptureSelfieViewAccessibility" canInteractWithTargetClass:1];
}
