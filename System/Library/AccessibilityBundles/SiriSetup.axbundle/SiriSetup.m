id accessibilityLocalizedString(void *a1)
{
  ...
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_41A8 table:@"Accessibility"];
  }
  else
  {
    v5 = 0;
...
id objc_msgSend__accessibilityHideVideoPlayer(void *a1, const char *a2, ...)
{
  return [a1 _accessibilityHideVideoPlayer];
}
