...
+ (id)safeCategoryTargetClassName
{
  return @"SeymourUI.ActionBrickItemCell";
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)ActionBrickItemCellAccessibility;
  return *MEMORY[0x263F1CEE8] | [(ActionBrickItemCellAccessibility *)&v3 accessibilityTraits];
}

- (id)_accessibilityCustomActions
{
  v10[1] = *MEMORY[0x263EF8340];
  v2 = [(ActionBrickItemCellAccessibility *)self _accessibilityDescendantOfType:MEMORY[0x245660210](@"SeymourUI.DownloadButton", a2)];
...
uint64_t __63__ActionBrickItemCellAccessibility__accessibilityCustomActions__block_invoke(uint64_t a1)
{
  return 1;
}
