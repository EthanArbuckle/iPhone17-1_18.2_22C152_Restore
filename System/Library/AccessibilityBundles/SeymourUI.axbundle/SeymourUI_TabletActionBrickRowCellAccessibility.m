@interface SeymourUI_TabletActionBrickRowCellAccessibility
...
+ (id)safeCategoryTargetClassName
{
  return @"SeymourUI.TabletActionBrickRowCell";
}
...
- (id)accessibilityLabel
{
  ...
  v4 = [(SeymourUI_TabletActionBrickRowCellAccessibility *)self _accessibilityTextForSubhierarchyIncludingHeaders:0 focusableItems:1 exclusions:0 classExclusions:v3];
...
- (unint64_t)accessibilityTraits
{
  ...
  return *MEMORY[0x263F1CEE8] | [(SeymourUI_TabletActionBrickRowCellAccessibility *)&v3 accessibilityTraits];
}

- (id)_accessibilityCustomActions
{
  v10[1] = *MEMORY[0x263EF8340];
  v2 = [(SeymourUI_TabletActionBrickRowCellAccessibility *)self _accessibilityDescendantOfType:MEMORY[0x245660210](@"SeymourUI.DownloadButton", a2)];
