...
+ (id)safeCategoryTargetClassName
{
  return @"MFComposeStyleSelectorButton";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"MFComposeStyleSelectorButton", @"styleType", "q", 0);
  [v3 validateClass:@"MFComposeFontSelectorButton"];
}

- (int64_t)_accessibilityScannerActivateBehavior
{
  unint64_t v3 = [(MFComposeStyleSelectorButtonAccessibility *)self safeIntegerForKey:@"styleType"];
...
- (id)accessibilityLabel
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v6.receiver = self;
    v6.super_class = (Class)MFComposeStyleSelectorButtonAccessibility;
    unint64_t v3 = [(MFComposeStyleSelectorButtonAccessibility *)&v6 accessibilityLabel];
  }
  else
  {
...
LABEL_20:
        unint64_t v3 = accessibilityLocalizedString(v4);
        break;
      default:
        unint64_t v3 = 0;
        break;
