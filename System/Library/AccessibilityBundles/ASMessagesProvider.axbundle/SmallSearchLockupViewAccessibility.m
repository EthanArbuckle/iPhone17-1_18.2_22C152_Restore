...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.SmallSearchLockupView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SmallSearchLockupView", @"accessibilitytUserRatingView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SmallSearchLockupView", @"accessibilityRatingCountLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SmallSearchLockupView", @"accessibilityIsAd", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SmallSearchLockupView", @"accessibilityAdButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SmallSearchLockupView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SmallSearchLockupView", @"accessibilitySearchTagsRibbonView", "@", 0);
  [v3 validateClass:@"ASMessagesProvider.SmallSearchLockupView" isKindOfClass:@"ASMessagesProvider.BaseLockupView"];
...
{
  id v6 = a2;
  MEMORY[0x24563EC60](@"AppStore.EditorsChoiceView");
