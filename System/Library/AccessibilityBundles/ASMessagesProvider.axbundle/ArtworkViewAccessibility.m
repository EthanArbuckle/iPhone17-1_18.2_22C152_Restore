...
- (unint64_t)accessibilityTraits
{
  v2 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x24563EC60](@"ASMessagesProvider.CarouselItemLockupCollectionView", a2)];
...
- (id)accessibilityLabel
{
  ...
  {
    v4 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x24563EC60](@"ASMessagesProvider.CarouselItemLockupCollectionView")];
