...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.AppStoreApplication";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.ActivityViewController"];
  [v3 validateClass:@"ASMessagesProvider.ActivityViewController" isKindOfClass:@"UIViewController"];
  [v3 validateClass:@"ASMessagesProvider.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<FlowTabBarController>"];
  [v3 validateClass:@"ASMessagesProvider.FlowTabBarController" isKindOfClass:@"UITabBarController"];
}
