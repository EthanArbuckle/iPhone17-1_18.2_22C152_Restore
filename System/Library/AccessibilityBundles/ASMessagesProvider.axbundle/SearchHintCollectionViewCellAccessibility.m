...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.SearchHintCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.SearchHintCollectionViewCell", @"accessibilityHintView", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  id v3 = [v2 _accessibilityDescendantOfType:MEMORY[0x24563EC60](@"AppStoreKitInternal.DynamicTypeLabel")];
