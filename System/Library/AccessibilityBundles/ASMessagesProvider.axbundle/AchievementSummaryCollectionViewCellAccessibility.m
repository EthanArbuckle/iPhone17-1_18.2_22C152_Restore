...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.AchievementSummaryCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.AchievementSummaryCollectionViewCell" hasSwiftField:@"achievementGroupView" withSwiftType:"Optional<AchievementGroupView>"];
  [v3 validateClass:@"ASMessagesProvider.AchievementSummaryCollectionViewCell" hasSwiftField:@"numberCompletedLabel" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"ASMessagesProvider.AchievementSummaryCollectionViewCell" hasSwiftField:@"outOfTotalLabel" withSwiftType:"DynamicTypeLabel"];
...
- (id)accessibilityLabel
{
  ...
  v10 = [v9 stringByReplacingOccurrencesOfString:@"\u202A/ " withString:&stru_26F5E9A18];
