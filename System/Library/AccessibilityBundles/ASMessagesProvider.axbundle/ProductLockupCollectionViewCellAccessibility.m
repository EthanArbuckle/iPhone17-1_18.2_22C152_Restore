...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.ProductLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"initWithFrame:", "@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"layoutSubviews", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityArtworkView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityDeveloperLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityTaglineLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityOfferButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityOfferSubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityDownloadProgressLabel", "@", 0);
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferTitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferSubtitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityShareButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.ProductLockupCollectionViewCell", @"accessibilityVideoView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.VideoView", @"accessibilityPlayButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.VideoView", @"accessibilityPlayerViewController", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.VideoView", @"accessibilityIsPlaying", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.VideoView", @"accessibilityShouldBePlaying", "B", 0);
}
