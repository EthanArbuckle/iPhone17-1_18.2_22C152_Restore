...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.MixedMediaLockupCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.MixedMediaLockupCollectionViewCell", @"accessibilityLockupView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.MixedMediaLockupCollectionViewCell", @"accessibilityTaglineLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.MixedMediaLockupCollectionViewCell", @"accessibilityVideoView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.MixedMediaLockupCollectionViewCell", @"accessibilityMediaView", "@", 0);
}
