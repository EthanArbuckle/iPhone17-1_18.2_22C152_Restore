...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.DeveloperLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.DeveloperLinkView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.DeveloperLinkView", @"accessibilityTitleLabel", "@", 0);
}
