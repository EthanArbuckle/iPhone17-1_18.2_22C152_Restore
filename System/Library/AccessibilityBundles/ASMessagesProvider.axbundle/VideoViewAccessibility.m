...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.VideoView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.VideoView", @"accessibilityUpdatePlayerControllerControls", "v", 0);
}
