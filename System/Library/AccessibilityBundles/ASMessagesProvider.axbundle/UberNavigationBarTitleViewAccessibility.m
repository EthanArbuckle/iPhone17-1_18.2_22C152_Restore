...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.UberNavigationBarTitleView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.UberNavigationBarTitleView", @"accessibilityNonStandardDismissButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.UberNavigationBarTitleView", @"layoutSubviews", "v", 0);
}
