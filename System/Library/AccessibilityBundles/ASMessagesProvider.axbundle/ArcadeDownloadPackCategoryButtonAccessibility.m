...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.ArcadeDownloadPackCategoryButton";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.ArcadeDownloadPackCategoryButton" hasSwiftField:@"titleLabel" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"ASMessagesProvider.ArcadeDownloadPackCategoryButton" isKindOfClass:@"UIControl"];
}
