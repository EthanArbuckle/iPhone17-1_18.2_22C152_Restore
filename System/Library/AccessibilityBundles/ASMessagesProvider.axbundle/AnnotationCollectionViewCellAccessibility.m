...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.AnnotationCollectionViewCell";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilitySummaryLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilityDetailItems", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilityCellIsExpanded", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilityLinkLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilityLinkLabelTapped", "v", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AnnotationCollectionViewCell", @"accessibilityIsSummaryExpandable", "B", 0);
}
