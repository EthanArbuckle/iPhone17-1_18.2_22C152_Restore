...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.CondensedEditorialSearchResultContentView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.CondensedEditorialSearchResultContentView", @"accessibilityHeaderLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.CondensedEditorialSearchResultContentView", @"accessibilityTitleLabel", "@", 0);
}
