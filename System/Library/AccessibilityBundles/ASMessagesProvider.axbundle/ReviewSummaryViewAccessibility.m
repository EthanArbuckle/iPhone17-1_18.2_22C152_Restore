...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.ReviewSummaryView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"ASMessagesProvider.ReviewSummaryView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
}
