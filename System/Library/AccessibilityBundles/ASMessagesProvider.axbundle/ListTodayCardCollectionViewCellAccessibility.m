...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.ListTodayCardCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.ListTodayCardCollectionViewCell" hasSwiftField:@"labelsView" withSwiftType:"TodayCardLabelsView"];
  [v3 validateClass:@"ASMessagesProvider.ListTodayCardCollectionViewCell" hasSwiftField:@"lockupContainer" withSwiftType:"TodayListCardLockupContainer"];
}
