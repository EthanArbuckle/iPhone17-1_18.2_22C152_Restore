...
+ (id)safeCategoryTargetClassName
{
  return @"ASMessagesProvider.AccountActionSectionFooterView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"ASMessagesProvider.AccountActionSectionFooterView", @"accessibilityTextLabel", "@", 0);
