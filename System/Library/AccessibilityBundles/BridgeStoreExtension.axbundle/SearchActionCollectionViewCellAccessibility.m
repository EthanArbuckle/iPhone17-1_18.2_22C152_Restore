...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.SearchActionCollectionViewCell";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.SearchActionCollectionViewCell" hasSwiftField:@"actionContentView" withSwiftType:"SearchActionContentView"];
  [v3 validateClass:@"BridgeStoreExtension.SearchActionContentView" hasSwiftField:@"linkLabel" withSwiftType:"DynamicLabel"];
}
