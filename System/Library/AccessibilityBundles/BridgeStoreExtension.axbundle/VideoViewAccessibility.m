...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.VideoView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.VideoView", @"accessibilityUpdatePlayerControllerControls", "v", 0);
}
