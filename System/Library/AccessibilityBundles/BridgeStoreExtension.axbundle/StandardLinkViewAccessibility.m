...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.StandardLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.StandardLinkView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.StandardLinkView", @"accessibilitySummaryLabel", "@", 0);
}
