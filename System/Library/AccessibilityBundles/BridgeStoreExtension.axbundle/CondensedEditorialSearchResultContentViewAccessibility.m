...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.CondensedEditorialSearchResultContentView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.CondensedEditorialSearchResultContentView", @"accessibilityHeaderLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.CondensedEditorialSearchResultContentView", @"accessibilityTitleLabel", "@", 0);
}
