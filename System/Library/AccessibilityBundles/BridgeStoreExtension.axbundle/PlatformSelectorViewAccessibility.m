...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.PlatformSelectorView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.PlatformSelectorView", @"accessibilityDescriptionLabel", "@", 0);
