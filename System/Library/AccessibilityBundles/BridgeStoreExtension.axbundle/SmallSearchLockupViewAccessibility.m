...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.SmallSearchLockupView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.SmallSearchLockupView", @"accessibilitytUserRatingView", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.SmallSearchLockupView", @"accessibilityRatingCountLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.SmallSearchLockupView", @"accessibilityIsAd", "B", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.SmallSearchLockupView", @"accessibilityAdButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.SmallSearchLockupView", @"accessibilityDescriptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.SmallSearchLockupView", @"accessibilitySearchTagsRibbonView", "@", 0);
  [v3 validateClass:@"BridgeStoreExtension.SmallSearchLockupView" isKindOfClass:@"BridgeStoreExtension.BaseLockupView"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilityTitleLabel", "@", 0);
}
...
{
  id v6 = a2;
  MEMORY[0x2456457F0](@"AppStore.EditorsChoiceView");
