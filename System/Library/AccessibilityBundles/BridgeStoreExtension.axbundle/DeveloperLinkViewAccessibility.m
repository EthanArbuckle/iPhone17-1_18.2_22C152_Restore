...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.DeveloperLinkView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.DeveloperLinkView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.DeveloperLinkView", @"accessibilityTitleLabel", "@", 0);
}
