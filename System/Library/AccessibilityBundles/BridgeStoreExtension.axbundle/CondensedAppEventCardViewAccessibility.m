...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.CondensedAppEventCardView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.CondensedAppEventCardView", @"accessibilityTitleLabel", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x2456457F0](@"AppStore.AppPromotionFormattedDateView");
