...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.BaseLockupView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.SearchAdTransparencyLabel"];
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilityHeadingLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilityTertiaryTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilityOfferLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilityOrdinalLabel", "@", 0);
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilitySubtitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BaseLockupView", @"accessibilityOfferButton", "@", 0);
}
...
{
  id v2 = a2;
  MEMORY[0x2456457F0](@"BridgeStoreExtension.SearchAdTransparencyLabel");
