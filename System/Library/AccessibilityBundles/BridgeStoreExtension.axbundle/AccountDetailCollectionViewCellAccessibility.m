...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.AccountDetailCollectionViewCell";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.AccountDetailCollectionViewCell", @"accessibilityTitleLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.AccountDetailCollectionViewCell", @"accessibilitySubtitleLabel", "@", 0);
...
- (id)accessibilityLabel
{
  ...
  MEMORY[0x2456457F0](@"AppStore.CountBadgeView");
  ...
  {
    MEMORY[0x2456457F0](@"AppStoreKitInternal.DynamicTypeLabel");
