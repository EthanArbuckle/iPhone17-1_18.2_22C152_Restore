...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.BadgeView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BadgeView", @"accessibilityValueLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BadgeView", @"accessibilityCaptionLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BadgeView", @"accessibilityHeadingLabel", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.BadgeView", @"accessibilityValueView", "@", 0);
  [v3 validateClass:@"BridgeStoreExtension.BadgeView" hasSwiftField:@"valueView" withSwiftType:"Optional<UIView>"];
