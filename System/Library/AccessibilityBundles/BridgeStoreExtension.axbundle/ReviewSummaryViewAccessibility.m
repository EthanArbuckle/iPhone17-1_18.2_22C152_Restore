...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.ReviewSummaryView";
}
...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"BridgeStoreExtension.ReviewSummaryView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
}
