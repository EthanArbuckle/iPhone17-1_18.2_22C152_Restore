...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.GuidedSearchTokenPaletteView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.GuidedSearchTokenPaletteView" hasSwiftField:@"tokens" withSwiftType:"Array<Token>"];
  [v3 validateClass:@"BridgeStoreExtension.GuidedSearchTokenPaletteView" hasSwiftField:@"collectionView" withSwiftType:"Optional<UICollectionView>"];
}
