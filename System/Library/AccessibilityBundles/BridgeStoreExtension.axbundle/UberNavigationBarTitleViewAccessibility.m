...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.UberNavigationBarTitleView";
}
...
{
  id v3 = a3;
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.UberNavigationBarTitleView", @"accessibilityNonStandardDismissButton", "@", 0);
  objc_msgSend(v3, "validateClass:hasInstanceMethod:withFullSignature:", @"BridgeStoreExtension.UberNavigationBarTitleView", @"layoutSubviews", "v", 0);
}
