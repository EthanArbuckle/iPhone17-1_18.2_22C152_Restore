...
+ (id)safeCategoryTargetClassName
{
  return @"BridgeStoreExtension.ShelfHeaderView";
}
...
{
  id v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.ShelfHeaderView" hasSwiftField:@"eyebrowButton" withSwiftType:"DynamicTypeButton"];
  [v3 validateClass:@"BridgeStoreExtension.ShelfHeaderView" hasSwiftField:@"titleButton" withSwiftType:"DynamicTypeButton"];
  [v3 validateClass:@"BridgeStoreExtension.ShelfHeaderView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  [v3 validateClass:@"BridgeStoreExtension.ShelfHeaderView" hasSwiftField:@"accessoryButton" withSwiftType:"DynamicTypeButton"];
}
...
- (id)accessibilityLabel
{
  ...
  v9 = [v8 stringByReplacingOccurrencesOfString:@"\uFFFC" withString:&stru_26F6416E0];
