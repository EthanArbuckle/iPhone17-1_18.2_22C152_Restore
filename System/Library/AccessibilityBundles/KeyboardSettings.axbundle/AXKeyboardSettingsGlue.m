...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    uint64_t v2 = [objc_allocWithZone((Class)AXKeyboardSettingsGlue) init];
    v3 = (void *)_Failover;
    _Failover = v2;
...
uint64_t __55__AXKeyboardSettingsGlue_accessibilityInitializeBundle__block_invoke()
{
  return 1;
}
...
uint64_t __55__AXKeyboardSettingsGlue_accessibilityInitializeBundle__block_invoke_3(uint64_t a1, void *a2)
{
  return [a2 installSafeCategory:@"KeyboardControllerAccessibility" canInteractWithTargetClass:1];
}
