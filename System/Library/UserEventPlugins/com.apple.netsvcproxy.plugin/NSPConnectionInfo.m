...
- (NSPConnectionInfo)initWithCoder:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)NSPConnectionInfo;
  ...
  if (v5)
  {
    ...
    uint64_t v12 = [v4 decodeObjectOfClasses:v11 forKey:@"multipathSubflowSwitchCounts"];
    multipathSubflowSwitchCounts = v5->_multipathSubflowSwitchCounts;
    v5->_multipathSubflowSwitchCounts = (NSDictionary *)v12;

    uint64_t v14 = objc_opt_class();
    uint64_t v15 = objc_opt_class();
    v16 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v14, v15, objc_opt_class(), 0);
    uint64_t v17 = [v4 decodeObjectOfClasses:v16 forKey:@"TCPInfo"];
    TCPInfo = v5->_TCPInfo;
    v5->_TCPInfo = (NSDictionary *)v17;

    uint64_t v19 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"firstTxByteTimeStamp"];
    firstTxByteTimeStamp = v5->_firstTxByteTimeStamp;
    v5->_firstTxByteTimeStamp = (NSDate *)v19;
...
- (id)copyDictionary
{
  ...
  id v4 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo pathType](self, "pathType"));
  [v3 setObject:v4 forKeyedSubscript:@"pathType"];

  id v5 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo fallbackReason](self, "fallbackReason"));
  [v3 setObject:v5 forKeyedSubscript:@"fallbackReason"];

  id v6 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo fallbackReasonCategory](self, "fallbackReasonCategory"));
  ...
  uint64_t v9 = [(NSPConnectionInfo *)self edgeAddress];

  if (v9)
  {
    id v10 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo edgeType](self, "edgeType"));
  ...
  {
    id v12 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithBool:", -[NSPConnectionInfo isMultipath](self, "isMultipath"));
    [v3 setObject:v12 forKeyedSubscript:@"isMultipath"];

    id v13 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithUnsignedInteger:", -[NSPConnectionInfo multipathSubflowCount](self, "multipathSubflowCount"));
    [v3 setObject:v13 forKeyedSubscript:@"multipathSubflowCountKey"];

    id v14 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithUnsignedInteger:", -[NSPConnectionInfo multipathConnectedSubflowCount](self, "multipathConnectedSubflowCount"));
    [v3 setObject:v14 forKeyedSubscript:@"multipathConnectedSubflowCountKey"];

    id v15 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithUnsignedInteger:", -[NSPConnectionInfo multipathPrimarySubflowInterfaceIndex](self, "multipathPrimarySubflowInterfaceIndex"));
  ...
  if (v20)
  {
    v57 = self;
    v58 = v3;
    double v21 = [(NSPConnectionInfo *)self TCPInfo];
      ...
      do
      {
        for (i = 0; i != v25; i = (char *)i + 1)
        {
          ...
          if ([v29 length] == &stru_158.flags)
          {
            ...
            id v32 = [objc_alloc((Class)NSNumber) initWithUnsignedLongLong:*(void *)(v30 + 100)];
            [v31 setObject:v32 forKeyedSubscript:@"rxPackets"];

            id v33 = [objc_alloc((Class)NSNumber) initWithUnsignedLongLong:*(void *)(v30 + 108)];
            [v31 setObject:v33 forKeyedSubscript:@"rxBytes"];

            id v34 = [objc_alloc((Class)NSNumber) initWithUnsignedLongLong:*(void *)(v30 + 68)];
            [v31 setObject:v34 forKeyedSubscript:@"txPackets"];

            id v35 = [objc_alloc((Class)NSNumber) initWithUnsignedLongLong:*(void *)(v30 + 76)];
            [v31 setObject:v35 forKeyedSubscript:@"txBytes"];

            id v36 = [objc_alloc((Class)NSNumber) initWithUnsignedLongLong:*(void *)(v30 + 84)];
            [v31 setObject:v36 forKeyedSubscript:@"retransmitBytes"];

            id v37 = [objc_alloc((Class)NSNumber) initWithUnsignedLongLong:*(void *)(v30 + 284)];
            [v31 setObject:v37 forKeyedSubscript:@"retransmitPackets"];

            id v38 = [objc_alloc((Class)NSDictionary) initWithDictionary:v31];
    ...
    id v39 = [objc_alloc((Class)NSDictionary) initWithDictionary:v23];
    id v3 = v58;
    [v58 setObject:v39 forKeyedSubscript:@"TCPInfo"];

    self = v57;
  }
  id v40 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo interfaceType](self, "interfaceType"));
  [v3 setObject:v40 forKeyedSubscript:@"interfaceType"];

  id v41 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithBool:", -[NSPConnectionInfo isTFOProbeSucceeded](self, "isTFOProbeSucceeded"));
  [v3 setObject:v41 forKeyedSubscript:@"isTFOProbeSucceeded"];

  id v42 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo tunnelConnectionError](self, "tunnelConnectionError"));
  [v3 setObject:v42 forKeyedSubscript:@"tunnelConnectionError"];

  if ((char *)[(NSPConnectionInfo *)self pathType] == (char *)&dword_0 + 1)
  {
    id v43 = objc_alloc((Class)NSNumber);
    [(NSPConnectionInfo *)self firstTxByteDelay];
    id v44 = objc_msgSend(v43, "initWithDouble:");
    [v3 setObject:v44 forKeyedSubscript:@"firstTxByteDelay"];

    id v45 = objc_alloc((Class)NSNumber);
    [(NSPConnectionInfo *)self connectionDelay];
    id v46 = objc_msgSend(v45, "initWithDouble:");
    [v3 setObject:v46 forKeyedSubscript:@"connectionDelay"];

    id v47 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithBool:", -[NSPConnectionInfo TFOSucceeded](self, "TFOSucceeded"));
    [v3 setObject:v47 forKeyedSubscript:@"TFOSucceeded"];

    id v48 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithInteger:", -[NSPConnectionInfo IPType](self, "IPType"));
    [v3 setObject:v48 forKeyedSubscript:@"IPType"];

    id v49 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithUnsignedInteger:", -[NSPConnectionInfo minimumRTT](self, "minimumRTT"));
    [v3 setObject:v49 forKeyedSubscript:@"minimumRTT"];

    id v50 = objc_alloc((Class)NSNumber);
    [(NSPConnectionInfo *)self timeIntervalSinceLastUsage];
    id v51 = objc_msgSend(v50, "initWithDouble:");
    [v3 setObject:v51 forKeyedSubscript:@"timeIntervalSinceLastUsage"];

    id v52 = objc_alloc((Class)NSNumber);
    [(NSPConnectionInfo *)self timeToFirstByte];
    id v53 = objc_msgSend(v52, "initWithDouble:");
    [v3 setObject:v53 forKeyedSubscript:@"timeToFirstByte"];

    id v54 = objc_msgSend(objc_alloc((Class)NSNumber), "initWithUnsignedInteger:", -[NSPConnectionInfo initialBytesLeftOver](self, "initialBytesLeftOver"));
    [v3 setObject:v54 forKeyedSubscript:@"initialBytesLeftOver"];
  }
  id v55 = [objc_alloc((Class)NSDictionary) initWithDictionary:v3];
...
- (void)setFallbackReason:(int64_t)a3
{
  ...
  if ((unint64_t)(a3 - 1) <= 0x2C) {
    self->_fallbackReasonCategory = qword_12E40[a3 - 1];
  }
}
...
- (id)timingIntervalAtIndex:(unint64_t)a3 forKey:(id)a4
{
  ...
  {
    uint64_t v9 = [(NSPConnectionInfo *)self timingIntervals];
