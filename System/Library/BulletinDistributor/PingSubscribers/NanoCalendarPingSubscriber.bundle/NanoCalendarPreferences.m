...
{
  if (qword_10C00 != -1) {
    dispatch_once(&qword_10C00, &stru_C2D8);
  }
  v2 = (void *)qword_10BF8;
...
- (BOOL)overlayCalendarIsEnabled
{
  ...
  unsigned int v3 = [v2 isEqualToString:&stru_C810] ^ 1;
  if (v2) {
    BOOL v4 = v3;
  }
  else {
...
- (void)_reportOverlayCalendarID:(id)a3 mirroringCompanion:(BOOL)a4
{
  ...
  id v11 = v10;
  if ([(__CFString *)v7 isEqualToString:&stru_C810]) {
    long long v12 = @"off";
  }
  else {
    long long v12 = v7;
  ...
  if ([(__CFString *)v11 isEqualToString:&stru_C810]) {
    long long v14 = @"off";
  }
  else {
    long long v14 = v11;
...
{
  if (qword_10C10 != -1) {
    dispatch_once(&qword_10C10, &stru_C320);
  }
  v2 = (void *)qword_10C08;
...
{
  if (qword_10C20 != -1) {
    dispatch_once(&qword_10C20, &stru_C340);
  }
  v2 = (void *)qword_10C18;
