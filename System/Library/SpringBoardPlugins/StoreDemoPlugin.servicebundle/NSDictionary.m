  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          xpc_dictionary_set_string(v3, (const char *)[v9 UTF8String], (const char *)objc_msgSend(objc_retainAutorelease(v10), "UTF8String"));
        }
        else
        {
          objc_opt_class();
          if (objc_opt_isKindOfClass())
          {
            ...
            id v12 = v10;
            xpc_dictionary_set_data(v3, v11, [v12 bytes], (size_t)objc_msgSend(v12, "length"));
          }
          else
          {
            objc_opt_class();
            if (objc_opt_isKindOfClass())
            {
              ...
              {
                xpc_dictionary_set_int64(v3, (const char *)[v9 UTF8String], (int64_t)objc_msgSend(v13, "longLongValue"));
              }
              else
              {
                id v17 = v16;
...
LABEL_31:
                  ...
                  xpc_dictionary_set_BOOL(v3, (const char *)[v9 UTF8String], (BOOL)objc_msgSend(v19, "BOOLValue"));
                }
              }
            }
            else
            {
              ...
              if ((objc_opt_isKindOfClass() & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR)) {
                  sub_E3F8((uint64_t)v9, (uint64_t)v10, v20);
                }
                goto LABEL_31;
              }
...
+ (id)dictionaryFromJsonData:(id)a3
{
  ...
  if (!v3)
  {
    NSUInteger v5 = sub_7CA4();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      sub_E49C(v5, v8, v9, v10, v11, v12, v13, v14);
    }
    goto LABEL_13;
  }
  id v17 = 0;
