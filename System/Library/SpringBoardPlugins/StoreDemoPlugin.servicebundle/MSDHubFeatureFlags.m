...
+ (id)supportedFeatureFlags
{
  return +[NSSet setWithObjects:@"DisableStudioDisplayUpdate", @"DisableNightlySnapshotRevert", @"DisableUserHomeDeepClean", @"DisableNightlyLowPowerMode", @"DisableScreenDarkHours", 102400, @"EnableAIModelAutoUpdate", 0];
}
