...
{
  if (qword_1E690 != -1) {
    dispatch_once(&qword_1E690, &stru_18680);
  }
  v2 = (void *)qword_1E688;
...
- (BOOL)evaluateStoreStatusAgainstPointInTime:(id)a3
{
  ...
  unsigned int v9 = sub_7CA4();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    v10 = [v4 toString];
    int v29 = 138543362;
    v30 = v10;
    _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "Evaluating store status against time: %{public}@", (uint8_t *)&v29, 0xCu);
  }
...
LABEL_14:
  ...
  if (v14)
  {
    uint64_t v15 = sub_7CA4();
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      LOWORD(v29) = 0;
      _os_log_impl(&dword_0, v15, OS_LOG_TYPE_DEFAULT, "No change in store open-closed status.", (uint8_t *)&v29, 2u);
    }
    BOOL v16 = 0;
    goto LABEL_26;
  }
LABEL_15:
  ...
  {
    LOWORD(v29) = 0;
    _os_log_impl(&dword_0, v17, OS_LOG_TYPE_DEFAULT, "New store open-closed status:", (uint8_t *)&v29, 2u);
  }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v29 = 67109120;
    LODWORD(v30) = v19;
    _os_log_impl(&dword_0, v18, OS_LOG_TYPE_DEFAULT, "    Is store open now: %{BOOL}d", (uint8_t *)&v29, 8u);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v29 = 138543362;
    v30 = v22;
    _os_log_impl(&dword_0, v20, OS_LOG_TYPE_DEFAULT, "    Next store open date: %{public}@", (uint8_t *)&v29, 0xCu);
  }
  v23 = sub_7CA4();
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v29 = 138543362;
    v30 = v25;
    _os_log_impl(&dword_0, v23, OS_LOG_TYPE_DEFAULT, "    Next store close date: %{public}@", (uint8_t *)&v29, 0xCu);
  }
  uint64_t v15 = sub_7CA4();
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v29 = 138543362;
    v30 = v27;
    _os_log_impl(&dword_0, v15, OS_LOG_TYPE_DEFAULT, "    Next content revert date: %{public}@", (uint8_t *)&v29, 0xCu);
  }
  BOOL v16 = 1;
LABEL_26:
...
LABEL_7:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    int v19 = 138543362;
    v20 = v7;
    _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Screen saver idle delay: %{public}@ (seconds)", (uint8_t *)&v19, 0xCu);
  }
  ...
  if ([(MSDStoreHoursManager *)self isStoreOpenNow])
  {
    ...
    {
      LOWORD(v19) = 0;
      _os_log_impl(&dword_0, v11, OS_LOG_TYPE_DEFAULT, "Store will be closing soon!", (uint8_t *)&v19, 2u);
    }
  ...
  else
  {
    ...
    if ([v9 compare:v3] == (char *)&dword_0 + 1)
    {
      objc_super v13 = sub_7CA4();
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        LOWORD(v19) = 0;
        _os_log_impl(&dword_0, v13, OS_LOG_TYPE_DEFAULT, "Store will be opening soon!", (uint8_t *)&v19, 2u);
      }
...
LABEL_21:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v19 = 138543362;
    v20 = v17;
    _os_log_impl(&dword_0, v16, OS_LOG_TYPE_DEFAULT, "Screen saver should run until: %{public}@", (uint8_t *)&v19, 0xCu);
  }
  ...
  if (v6)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) == 0 || [v11 count] != (char *)&dword_0 + 3)
        {
          id v14 = sub_7CA4();
