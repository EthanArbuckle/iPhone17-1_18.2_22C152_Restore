void sub_4250(int a1, void *a2, MIDIDeviceRef device, void *a4, uint64_t a5, char **a6)
{
...
void sub_47D0(const char *a1)
{
  exception = (std::logic_error *)__cxa_allocate_exception(0x10uLL);
  sub_482C(exception, a1);
}

void sub_4818(_Unwind_Exception *a1)
{
  __cxa_free_exception(v1);
  _Unwind_Resume(a1);
}

std::logic_error *sub_482C(std::logic_error *a1, const char *a2)
{
  result = std::logic_error::logic_error(a1, a2);
  return result;
}

void *sub_4860(uint64_t a1, unint64_t a2)
{
  if (a2 >> 62) {
    sub_4898();
  }
...
void *sub_48CC(uint64_t a1, unint64_t a2)
{
...
void sub_4918(std::exception *a1)
{
...
void *sub_495C()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30118, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30118))
  {
    sub_4C98((uint64_t)&unk_300B0);
    __cxa_guard_release(&qword_30118);
  }
  return &unk_300B0;
}

void sub_49BC(_Unwind_Exception *a1)
{
}

uint64_t sub_49D4(const __CFString *a1, unsigned char *a2)
{
  int valuePtr = 0;
  *a2 = 0;
  if (a1)
...
BOOL sub_4AD0(const __CFBoolean *a1, unsigned char *a2)
{
  int valuePtr = 0;
  *a2 = 0;
  if (a1)
...
void sub_4D88(_Unwind_Exception *a1)
{
  std::mutex::~mutex(v1);
  _Unwind_Resume(a1);
}

void sub_4D9C(uint64_t a1)
{
}
...
void sub_4DA4(uint64_t a1)
{
  ...
  CFSetApplyFunction(*(CFSetRef *)(a1 + 64), (CFSetApplierFunction)sub_5038, 0);
...
void sub_4E1C(_Unwind_Exception *a1)
{
  std::mutex::unlock(v1);
  _Unwind_Resume(a1);
}

uint64_t sub_4E34(uint64_t a1, CFTypeRef cf1, const void *a3)
{
...
void sub_4EA4(uint64_t a1, const void *a2, void *a3, uint64_t a4)
{
  value = a3;
  v11 = a2;
  std::mutex::lock((std::mutex *)a1);
  if ((sub_4E34(a1, a2, a3) & 1) == 0)
  {
    CFRetain(a2);
    CFRetain(a3);
    ...
    if (v8 >= *(void *)(a1 + 88))
    {
      uint64_t v9 = sub_5068((uint64_t *)(a1 + 72), (uint64_t *)&v11, (uint64_t *)&value, a4);
    }
    else
    {
      sub_5188(*(void **)(a1 + 80), (uint64_t *)&v11, (uint64_t *)&value, a4);
      uint64_t v9 = v8 + 48;
      *(void *)(a1 + 80) = v8 + 48;
    }
    *(void *)(a1 + 80) = v9;
    CFSetAddValue(*(CFMutableSetRef *)(a1 + 64), value);
    sub_4F90((CFStringRef *)(*(void *)(a1 + 80) - 48));
  }
  std::mutex::unlock((std::mutex *)a1);
}

void sub_4F70(_Unwind_Exception *a1)
{
  *(void *)(v1 + 80) = v2;
...
CFPropertyListRef sub_4F90(CFStringRef *a1)
{
  CFPropertyListRef result = CFPreferencesCopyAppValue(*a1, a1[1]);
  if (result)
  {
    return (CFPropertyListRef)sub_4FE4((uint64_t)(a1 + 2), (uint64_t)result);
  }
  return result;
}

uint64_t sub_4FE4(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = a2;
...
uint64_t sub_5038(const __CFString *a1)
{
  return CFPreferencesSynchronize(a1, kCFPreferencesCurrentUser, kCFPreferencesCurrentHost);
}

void sub_5054(void *a1)
{
}

uint64_t sub_5068(uint64_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4)
{
  uint64_t v5 = *a1;
  ...
  v18 = &v14[48 * v6];
  v20 = &v14[48 * v13];
  sub_5188(v18, a2, a3, a4);
  v19 = v18 + 48;
  sub_534C(a1, &v17);
  uint64_t v15 = a1[1];
  sub_54C4((uint64_t)&v17);
  return v15;
}

void sub_5174(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_54C4((uint64_t)va);
  _Unwind_Resume(a1);
}

void *sub_5188(void *a1, uint64_t *a2, uint64_t *a3, uint64_t a4)
{
  uint64_t v5 = *a2;
  uint64_t v6 = *a3;
  sub_5230((uint64_t)v8, a4);
  *a1 = v5;
  a1[1] = v6;
  sub_5230((uint64_t)(a1 + 2), (uint64_t)v8);
  sub_52C8(v8);
  return a1;
}

void sub_5214(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_52C8((uint64_t *)va);
  _Unwind_Resume(a1);
}

uint64_t sub_5230(uint64_t a1, uint64_t a2)
{
...
uint64_t *sub_534C(uint64_t *result, void *a2)
{
  uint64_t v3 = result;
  uint64_t v5 = *result;
  ...
  else
  {
    do
    {
      ...
      *(_OWORD *)(v6 - 48) = *(_OWORD *)(v4 - 48);
      CFPropertyListRef result = (uint64_t *)sub_5444(v6 - 32, v4 - 32);
      uint64_t v4 = v8;
      uint64_t v6 = v7;
    }
    while (v8 != v5);
...
void *sub_53FC(uint64_t a1, unint64_t a2)
{
...
uint64_t sub_5444(uint64_t a1, uint64_t a2)
{
  uint64_t v3 = (void *)(a2 + 24);
...
void sub_5518()
{
  ...
  void *exception = &off_2C608;
}

void sub_5568(std::exception *a1)
{
  std::exception::~exception(a1);
...
uint64_t sub_55A0(uint64_t a1, uint64_t a2)
{
  *(void *)a1 = off_2C630;
  *(void *)(a1 + 8) = a2;
  *(void *)(a1 + 16) = 0;
  ...
  if (v3)
  {
    ...
    if (v6) {
      sub_24D34(v6, v7, v8, v9, v10, v11, v12, v13);
    }
    exception = __cxa_allocate_exception(0x10uLL);
    *(void *)exception = &off_2C5A8;
    exception[2] = v5;
  }
  return a1;
}

uint64_t sub_5658(uint64_t a1)
{
  *(void *)a1 = off_2C630;
...
BOOL sub_56DC(uint64_t a1)
{
  ...
  if (!v3)
  {
    ...
    if (v4)
    {
      ...
      if (v7) {
        sub_24D70(v7, v8, v9, v10, v11, v12, v13, v14);
      }
      exception = __cxa_allocate_exception(0x10uLL);
      *(void *)exception = &off_2C5A8;
      exception[2] = v6;
...
void sub_579C(uint64_t a1)
{
  ...
  if (pthread_equal(v2, (pthread_t)atomic_load_explicit((atomic_ullong *volatile)(a1 + 16), memory_order_acquire)))
  {
    ...
    if (v3)
    {
      ...
      if (v5) {
        sub_24DAC(v5, v6, v7, v8, v9, v10, v11, v12);
      }
      exception = __cxa_allocate_exception(0x10uLL);
      *(void *)exception = &off_2C5A8;
      exception[2] = v4;
  ...
  else if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    *(_WORD *)uint64_t v14 = 0;
    _os_log_impl(&def_21CC0, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, " CAMutex::Unlock: A thread is attempting to unlock a Mutex it doesn't own", v14, 2u);
  }
}

uint64_t sub_5888(uint64_t a1, char *a2)
{
  *a2 = 0;
  int v4 = pthread_self();
...
BOOL sub_599C(uint64_t a1)
{
  return atomic_load_explicit((atomic_ullong *volatile)(a1 + 16), memory_order_acquire) == 0;
}

BOOL sub_59B0(uint64_t a1)
{
  uint64_t v2 = pthread_self();
  return pthread_equal(v2, (pthread_t)atomic_load_explicit((atomic_ullong *volatile)(a1 + 16), memory_order_acquire)) != 0;
}

void sub_59E8(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 2u);
}

uint64_t sub_5A04(uint64_t a1, uint64_t a2, uint64_t a3)
{
  *(void *)a1 = off_2C6A0;
  *(void *)(a1 + 8) = a2;
  *(_DWORD *)(a1 + 24) = 0;
  ...
  *(void *)(a1 + 56) = a3;
  sub_5EA0();
  uint64_t v9 = qword_30120;
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    int v26 = 136316162;
    ...
    __int16 v34 = 2048;
    uint64_t v35 = a3;
    _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] IOServiceClient(%p)::IOServiceClient(notifyRunLoop %p, matchingDict %p", (uint8_t *)&v26, 0x30u);
  }
  if (IOMainPort(0, v6)) {
    goto LABEL_21;
  }
  ...
  *(void *)(a1 + 16) = RunLoopSource;
  ...
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v32 = 2048;
    uint64_t v33 = v15;
    _os_log_impl(&def_21CC0, v13, OS_LOG_TYPE_DEBUG, "%25s:%-5d      added runloop source %p to runloop %p", (uint8_t *)&v26, 0x26u);
  }
  ...
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v17;
    _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_DEBUG, "%25s:%-5d      mMatchingDict: %@", (uint8_t *)&v26, 0x1Cu);
  }
  if (IOServiceAddMatchingNotification(*(IONotificationPortRef *)(a1 + 32), "IOServiceMatched", *(CFDictionaryRef *)(a1 + 56), (IOServiceMatchingCallback)sub_5F10, (void *)a1, v8))
  {
    goto LABEL_21;
  }
  sub_5EA0();
  ...
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v28 = 1024;
    int v29 = 55;
    _os_log_impl(&def_21CC0, v18, OS_LOG_TYPE_DEBUG, "%25s:%-5d      signed up for matched notifications", (uint8_t *)&v26, 0x12u);
  }
  CFRetain(*(CFTypeRef *)(a1 + 56));
  if (IOServiceAddMatchingNotification(*(IONotificationPortRef *)(a1 + 32), "IOServiceTerminate", *(CFDictionaryRef *)(a1 + 56), (IOServiceMatchingCallback)sub_5FF8, (void *)a1, (io_iterator_t *)(a1 + 44)))
  {
LABEL_21:
    sub_5EA0();
    uint64_t v25 = qword_30120;
    if (!os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_ERROR)) {
      return a1;
    }
    int v26 = 136315650;
    v27 = "IOServiceClient.cpp";
  ...
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v28 = 1024;
    int v29 = 59;
    _os_log_impl(&def_21CC0, v19, OS_LOG_TYPE_DEBUG, "%25s:%-5d      signed up for terminated notifications", (uint8_t *)&v26, 0x12u);
  }
  *(unsigned char *)(a1 + 48) = 1;
  sub_5EA0();
  uint64_t v20 = qword_30120;
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    int v26 = 136315650;
    v27 = "IOServiceClient.cpp";
...
LABEL_19:
    _os_log_impl(&def_21CC0, v22, v23, v21, (uint8_t *)&v26, 0x1Cu);
  }
  return a1;
}
...
void sub_5EA0()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30128, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30128))
  {
    qword_30120 = (uint64_t)os_log_create("com.apple.coremidi", "ioserv");
    __cxa_guard_release(&qword_30128);
  }
}

uint64_t sub_5F10(uint64_t a1, io_iterator_t a2)
{
  sub_5EA0();
  int v4 = qword_30120;
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] IOServiceClient::ServicePublishCallback(refcon %p, it %u)", (uint8_t *)&v6, 0x22u);
  }
  return sub_624C(a1, a2);
}

uint64_t sub_5FF8(uint64_t a1, io_iterator_t a2)
{
  sub_5EA0();
  int v4 = qword_30120;
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v12 = 1024;
    io_iterator_t v13 = a2;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] IOServiceClient::ServiceTerminateCallback(refcon %p, it %u)", (uint8_t *)&v6, 0x22u);
  }
  return sub_62CC(a1, a2);
}

uint64_t sub_60E0(uint64_t a1)
{
  *(void *)a1 = off_2C6A0;
  sub_5EA0();
  uint64_t v2 = qword_30120;
  if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
  {
    int v11 = 136315650;
    ...
    __int16 v15 = 2048;
    uint64_t v16 = a1;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] IOServiceClient(%p)::~IOServiceClient()", (uint8_t *)&v11, 0x1Cu);
  }
...
void sub_6238(_Unwind_Exception *a1, int a2)
{
  if (!a2) {
    _Unwind_Resume(a1);
  }
...
uint64_t sub_624C(uint64_t a1, io_iterator_t iterator)
{
...
uint64_t sub_62CC(uint64_t a1, io_iterator_t iterator)
{
  uint64_t result = IOIteratorNext(iterator);
  if (result)
  {
    ...
    if (*(unsigned char *)(a1 + 48))
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v11 = 2048;
        uint64_t v12 = a1;
        _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] IOServiceClient(%p)ScanServices() - emptying iterators ...", buf, 0x1Cu);
      }
      *(unsigned char *)(a1 + 48) = 0;
      sub_624C(a1, *(_DWORD *)(a1 + 40));
      sub_62CC(a1, *(_DWORD *)(a1 + 44));
    }
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 136315906;
        ...
        __int16 v13 = 2112;
        uint64_t v14 = v5;
        _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] IOServiceClient(%p)ScanServices() - getting matching services for dictionary: %@", buf, 0x26u);
      }
      if (!IOServiceGetMatchingServices(*(_DWORD *)(a1 + 24), *(CFDictionaryRef *)(a1 + 56), &existing)) {
        sub_624C(a1, existing);
      }
      if (existing) {
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30120, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v11 = 2048;
      uint64_t v12 = a1;
      _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] IOServiceClient(%p)::ScanServices() - mMainDevicePort == 0", buf, 0x1Cu);
    }
  }
}

void sub_6578(uint64_t a1, CFUUIDRef factoryID)
{
  *(_OWORD *)(a1 + 48) = 0u;
  *(void *)(a1 + 72) = 0;
  *(_OWORD *)(a1 + 32) = 0u;
...
void sub_67B8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18)
{
  if (!a2) {
    _Unwind_Resume(exception_object);
  }
  sub_5054(exception_object);
}

void *sub_68AC(void *a1, uint64_t *a2)
{
  sub_828C((uint64_t *)&v6, a2);
...
uint64_t sub_699C(void *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  uint64_t v5 = a1[6];
  if (!v5) {
    return 7;
...
uint64_t sub_69F0(uint64_t a1, int a2, uint64_t a3)
{
...
uint64_t sub_6A88(_DWORD *a1, CFUUIDBytes a2, void *a3)
{
...
uint64_t sub_6D38(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 - 8) + 48))();
}

uint64_t sub_6D5C(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 - 8) + 56))();
}

uint64_t sub_6D80(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 - 8) + 64))();
}

uint64_t sub_6DA4(uint64_t a1)
{
...
void *sub_6E10(void *a1, uint64_t *a2)
{
  uint64_t v3 = *a2;
  *a2 = (uint64_t)&off_2C760;
  *a1 = off_2C740;
  a1[1] = v3;
...
uint64_t sub_6F40(uint64_t *a1, _DWORD *a2)
{
  uint64_t v7 = a1[1];
  ...
  if (*a2 == 2)
  {
    ...
    v5[1] = &v7;
    CFUUIDRef v6 = v5;
    sub_78B4((uint64_t)a2, (uint64_t **)&v6);
  }
  else
  {
    if (*a2 != 1) {
    ...
    v5[0] = (uint64_t *)&v6;
    sub_70D0((uint64_t)a2, v5);
  }
  return sub_8158((uint64_t)&v7);
}

void sub_7024(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_8158((uint64_t)va);
  _Unwind_Resume(a1);
}
...
uint64_t sub_70D0(uint64_t result, uint64_t **a2)
{
  if (*(_DWORD *)(result + 4))
  {
    uint64_t v3 = result;
    ...
    do
    {
      ...
      uint64_t v10 = 0;
      uint64_t v8 = 0;
      uint64_t result = sub_71A8(v11, &v10, &v8);
      if (result)
      {
        do
        {
          ...
          v12[0] = *v7;
          v12[1] = (uint64_t)&v13;
          sub_7274((unsigned __int16 *)&v8, v12);
          uint64_t v9 = 0;
          uint64_t v10 = 0;
          uint64_t v8 = 0;
          uint64_t result = sub_71A8(v11, &v10, &v8);
...
uint64_t sub_71A8(uint64_t *a1, void *a2, _DWORD *a3)
{
  unint64_t v3 = a1[1];
  unint64_t v4 = a1[3];
  if (v4 >= v3) {
  ...
  unint64_t v7 = *v6;
  unint64_t v8 = v4 + byte_270E8[v7 >> 28];
  if (v8 > v3) {
    return 0;
  }
  *a2 = a1[2];
...
unsigned __int16 *sub_7274(unsigned __int16 *result, uint64_t *a2)
{
...
LABEL_52:
        uint64_t result = (unsigned __int16 *)sub_76EC(v7, v25, (char *)&__src, v6);
LABEL_58:
...
LABEL_33:
    uint64_t result = (unsigned __int16 *)sub_76EC(*a2, v19, (char *)&__src, v17);
LABEL_49:
    *(void *)(v18 + 56) = result;
    return result;
  }
...
LABEL_57:
            uint64_t result = (unsigned __int16 *)sub_76EC(v7, v8, (char *)&__src, v6);
            goto LABEL_58;
          }
...
uint64_t sub_76EC(uint64_t a1, uint64_t a2, char *a3, size_t a4)
{
  if (*(_DWORD *)(a1 + 64)
    && (uint64_t v16 = a1 + 64,
...
void sub_785C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
}

uint64_t *sub_7888(uint64_t *result, uint64_t a2)
{
  uint64_t v3 = *result;
...
uint64_t sub_78B4(uint64_t result, uint64_t **a2)
{
  if (*(_DWORD *)(result + 4))
  {
    uint64_t v3 = result;
    ...
    do
    {
      ...
      uint64_t v11 = 0;
      uint64_t v9 = 0;
      uint64_t result = sub_71A8(v12, &v11, &v9);
      if (result)
      {
        do
        {
          ...
          *((void *)&v13 + 1) = &v14;
          sub_7990((unsigned __int16 *)(v8 + 64), (unsigned __int16 *)&v9, &v13);
          uint64_t v10 = 0;
          uint64_t v11 = 0;
          uint64_t v9 = 0;
          uint64_t result = sub_71A8(v12, &v11, &v9);
...
unsigned __int16 *sub_7990(unsigned __int16 *result, unsigned __int16 *a2, long long *a3)
{
  ...
  if (((1 << (v3 >> 28)) & 0xA02F) != 0)
  {
    long long v29 = *a3;
    uint64_t v5 = a2;
    return sub_7CE0(v5, (uint64_t *)&v29);
  }
  else if (v3 >> 28 == 4)
  {
    ...
    switch(BYTE2(v3) >> 4)
    {
      ...
      case 3:
        ...
        *(void *)int v27 = v18 | v19 | v13;
        long long v29 = *a3;
        sub_7CE0((unsigned __int16 *)v27, (uint64_t *)&v29);
        int v28 = 0;
        *(_DWORD *)&v27[8] = 0;
...
LABEL_22:
        ...
        *(void *)int v27 = v18 | (v7 >> 25) | 0x600;
        long long v29 = *a3;
        uint64_t result = sub_7CE0((unsigned __int16 *)v27, (uint64_t *)&v29);
        if (v15)
        {
          int v28 = 0;
          *(void *)&v27[4] = 0;
...
unsigned __int16 *sub_7CE0(unsigned __int16 *result, uint64_t *a2)
{
  unint64_t v3 = *(unsigned int *)result;
  unsigned int v4 = v3 >> 28;
  if (v3 >> 28 == 3)
...
void sub_81CC(std::__shared_weak_count *a1)
{
...
uint64_t sub_8240(void *a1, void *a2)
{
  return (*(uint64_t (**)(void, void, void))(*(void *)*a1 + 72))(*a1, *(unsigned int *)(*a1 + 64), *a2);
}

void *sub_8270(void *result, void *a2)
{
  std::logic_error *result = *a2;
  return result;
}

void *sub_827C(void *result, void *a2)
{
  std::logic_error *result = *a2;
  return result;
}

uint64_t *sub_828C(uint64_t *result, uint64_t *a2)
{
  uint64_t v2 = *a2;
  std::logic_error *result = *a2;
  if (v2) {
...
void sub_8310(std::__shared_weak_count *a1)
{
...
uint64_t sub_837C(void *a1, void *a2)
{
  return (*(uint64_t (**)(void, void, void, void))(*(void *)*a1 + 48))(*a1, *a2, *(void *)(*a1 + 32), *(void *)(*a1 + 40));
}

void *sub_83AC(void *result, void *a2)
{
  std::logic_error *result = *a2;
  return result;
}

void *sub_83B8(void *result, void *a2)
{
  std::logic_error *result = *a2;
  return result;
}

double sub_83C8(uint64_t a1, int a2)
{
  *(void *)a1 = off_2C820;
  *(_DWORD *)(a1 + 8) = a2;
  double result = 0.0;
  ...
  *(_OWORD *)(a1 + 28) = 0u;
  *(_OWORD *)(a1 + 44) = 0u;
  *(_DWORD *)(a1 + 6sub_7888(&a9, 0) = 0;
  return result;
}

void *sub_8400(void *a1)
{
  *a1 = off_2C820;
...
void sub_8468(uint64_t a1, int a2)
{
  int NumberOfEntities = MIDIDeviceGetNumberOfEntities(*(_DWORD *)(a1 + 8));
  *(_DWORD *)(a1 + 12) = NumberOfEntities;
  int v5 = (void **)(a1 + 16);
  sub_870C((void **)(a1 + 16), NumberOfEntities);
  size_t v6 = (void *)(a1 + 40);
  sub_87B4((char **)(a1 + 40), *(int *)(a1 + 12));
  if (*(_DWORD *)(a1 + 12))
  {
    for (uint64_t i = 0; (unint64_t)i < *(int *)(a1 + 12); ++i)
    {
...
LABEL_7:
          ...
          if ((unint64_t)v12 >= v11)
          {
            ...
            if (v18)
            {
              uint64_t v19 = (char *)sub_4860(a1 + 32, v18);
          ...
          *(void *)(a1 + 24) = v13;
          ...
          if (v23 >= v22)
          {
            ...
            if (v28) {
              long long v29 = (char *)sub_48CC(a1 + 56, v28);
            }
            else {
              long long v29 = 0;
            }
...
void sub_870C(void **a1, unint64_t a2)
{
...
void sub_87B4(char **a1, unint64_t a2)
{
  unsigned int v4 = a1[2];
  uint64_t v3 = (uint64_t)(a1 + 2);
...
uint64_t sub_8898(uint64_t result)
{
  if (*(void *)(result + 16)) {
    operator delete[]();
  }
...
void sub_88D8(void *a1, uint64_t a2)
{
  *a1 = a2;
  operator new[]();
}

uint64_t sub_8920(uint64_t a1, io_object_t object)
{
  *(_DWORD *)a1 = object;
  *(void *)(a1 + 8) = 0;
  *(void *)(a1 + 14) = 0;
  ...
  if (!result)
  {
          ...
          !IOCreatePlugInInterfaceForService(v7, v8, v9, &theInterface, &theScore)))
    {
      ...
      if (v14)
      {
        ...
        {
          sub_8D18();
          MIDIEndpointRef v21 = qword_30130;
          if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 136315394;
            unint64_t v25 = "USBDevice.cpp";
            __int16 v26 = 1024;
            int v27 = 123;
            _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_DEBUG, "%25s:%-5d QueryInterface failed", buf, 0x12u);
          }
          *(void *)uint64_t v3 = 0;
          return *(void *)v3;
        }
...
void sub_8D18()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30138, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30138))
  {
    qword_30130 = (uint64_t)os_log_create("com.apple.coremidi", "usbdev");
    __cxa_guard_release(&qword_30138);
  }
}

uint64_t sub_8D88(uint64_t result)
{
  if (!*(unsigned char *)(result + 21))
  {
    uint64_t v1 = result;
    *(unsigned char *)(result + 21) = 1;
    uint64_t result = sub_8E74(result, 3, 0, 0, v2, 256);
    if ((int)result >= 3)
    {
...
uint64_t sub_8E74(uint64_t a1, int a2, __int16 a3, __int16 a4, unsigned char *a5, __int16 a6)
{
  uint64_t v12 = sub_89E0(a1);
  if (v12)
  {
    uint64_t v13 = v12;
    __int16 v24 = 1664;
...
LABEL_12:
    ...
    if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v34 = 1024;
      int v35 = v18;
      _os_log_impl(&def_21CC0, v19, OS_LOG_TYPE_DEBUG, "%25s:%-5d USBDevice::LoadDescriptor - Could not open device due to error 0x%x", buf, 0x18u);
    }
  }
  return 0xFFFFFFFFLL;
}

BOOL sub_9060(uint64_t a1, uint64_t a2)
{
  sub_8D18();
  io_service_t v4 = qword_30130;
  if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315394;
    *(void *)&uint8_t buf[4] = "USBDevice.cpp";
    __int16 v11 = 1024;
    int v12 = 166;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d -> USBDevice::OpenAndConfigure", buf, 0x12u);
  }
  if (!sub_89E0(a1) {
    || !*(unsigned char *)(a1 + 20)
  }
    && ((uint64_t v5 = sub_89E0(a1), (*(unsigned int (**)(void))(*(void *)v5 + 64))(*(void *)(a1 + 8)))
     || (*(unsigned char *)(a1 + 2sub_7888(&a9, 0) = 1,
         char v9 = 0,
  ...
  {
    sub_8D18();
    CFUUIDRef v8 = qword_30130;
    BOOL result = os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG);
    if (result)
    {
      *(_DWORD *)buf = 136315394;
      *(void *)&uint8_t buf[4] = "USBDevice.cpp";
      __int16 v11 = 1024;
      int v12 = 193;
      _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_DEBUG, "%25s:%-5d <- USBDevice::OpenAndConfigure returning false", buf, 0x12u);
      return 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&uint8_t buf[4] = "USBDevice.cpp";
      __int16 v11 = 1024;
      int v12 = 190;
      _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_DEBUG, "%25s:%-5d <- USBDevice::OpenAndConfigure returning true", buf, 0x12u);
    }
    return 1;
  }
  return result;
...
CFStringRef sub_9294(uint64_t a1, int a2)
{
  if (!a2) {
    return 0;
  }
  __int16 v2 = a2;
  sub_8D88(a1);
  int v4 = sub_8E74(a1, 3, v2, *(_WORD *)(a1 + 22), v6, 256);
  if (v4 >= 3) {
...
uint64_t sub_9320(uint64_t a1, int a2, int a3, uint64_t a4, int a5, _DWORD *a6)
{
  sub_8D18();
  int v12 = qword_30130;
  if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&v51[6] = a3;
    ...
    __int16 v54 = 1024;
    int v55 = a5;
    _os_log_impl(&def_21CC0, v12, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBDevice::LoadGroupTerminalDescriptors(interface: %d, altSettingNumber: %d, buf:%p, len:%d)", buf, 0x2Eu);
  }
  *a6 = 0;
  uint64_t v13 = sub_89E0(a1);
  if (v13)
  {
    uint64_t v14 = v13;
    ...
    if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v50 = 1024;
      *(_DWORD *)v51 = v16;
      _os_log_impl(&def_21CC0, v17, OS_LOG_TYPE_INFO, "%25s:%-5d      USBDeviceOpen failed with error 0x%x. Will retrying ...", buf, 0x18u);
    }
    unsigned int v18 = 0;
    do
    {
    ...
    {
      sub_8D18();
      uint64_t v21 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        __int16 v48 = 1024;
        ...
        *(_DWORD *)v51 = v20;
        ...
        uint32_t v25 = 24;
LABEL_44:
        _os_log_impl(&def_21CC0, v23, v24, v22, buf, v25);
      }
    }
    else
    {
LABEL_13:
      ...
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v48 = 1024;
        int v49 = 23;
        _os_log_impl(&def_21CC0, v26, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] LogDeviceRequest()", buf, 0x12u);
      }
      sub_8D18();
      __int16 v27 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        ...
        __int16 v50 = 1024;
        *(_DWORD *)v51 = v40;
        _os_log_impl(&def_21CC0, v27, OS_LOG_TYPE_DEBUG, "%25s:%-5d      bmRequestType: 0x%00x", buf, 0x18u);
      }
      sub_8D18();
      unint64_t v28 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        ...
        *(_DWORD *)v51 = HIBYTE(v40);
        _os_log_impl(&def_21CC0, v28, OS_LOG_TYPE_DEBUG, "%25s:%-5d      bRequest:      0x%00x", buf, 0x18u);
      }
      sub_8D18();
      unsigned int v29 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        ...
        __int16 v50 = 1024;
        *(_DWORD *)v51 = v41;
        _os_log_impl(&def_21CC0, v29, OS_LOG_TYPE_DEBUG, "%25s:%-5d      wValue:        0x%0000x", buf, 0x18u);
      }
      sub_8D18();
      char v30 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        ...
        __int16 v50 = 1024;
        *(_DWORD *)v51 = v42;
        _os_log_impl(&def_21CC0, v30, OS_LOG_TYPE_DEBUG, "%25s:%-5d      wIndex:        0x%0000x", buf, 0x18u);
      }
      sub_8D18();
      char v31 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        ...
        __int16 v50 = 1024;
        *(_DWORD *)v51 = v43;
        _os_log_impl(&def_21CC0, v31, OS_LOG_TYPE_DEBUG, "%25s:%-5d      wLength:       %u", buf, 0x18u);
      }
      sub_8D18();
      __int16 v32 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        v47 = "USBDevice.cpp";
        ...
        __int16 v50 = 2048;
        *(void *)v51 = v44;
        _os_log_impl(&def_21CC0, v32, OS_LOG_TYPE_DEBUG, "%25s:%-5d      pData:         %p", buf, 0x1Cu);
      }
      sub_8D18();
      int v33 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v50 = 1024;
        *(_DWORD *)v51 = v45;
        _os_log_impl(&def_21CC0, v33, OS_LOG_TYPE_DEBUG, "%25s:%-5d      wLenDone:      %u", buf, 0x18u);
      }
      sub_8D18();
      __int16 v34 = qword_30130;
      if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315394;
        v47 = "USBDevice.cpp";
        __int16 v48 = 1024;
        int v49 = 31;
        _os_log_impl(&def_21CC0, v34, OS_LOG_TYPE_DEBUG, "%25s:%-5d [-] LogDeviceRequest()", buf, 0x12u);
      }
      if (v20 == -536854449)
      {
        sub_8D18();
        ...
        if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 136315394;
          ...
          __int16 v48 = 1024;
          int v49 = 342;
          _os_log_impl(&def_21CC0, v35, OS_LOG_TYPE_INFO, "%25s:%-5d      Pipe stall on DeviceRequest(). Will retry once only.", buf, 0x12u);
        }
        uint64_t v20 = (*(uint64_t (**)(uint64_t, __int16 *))(*(void *)v14 + 208))(v14, &v40);
      }
      if (v20)
      {
        ...
        if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 136315650;
          ...
          __int16 v50 = 1024;
          *(_DWORD *)v51 = v20;
          _os_log_impl(&def_21CC0, v36, OS_LOG_TYPE_ERROR, "%25s:%-5d      DeviceRequest() returned error 0x%x", buf, 0x18u);
        }
      }
      else
      {
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v48 = 1024;
      int v49 = 313;
      _os_log_impl(&def_21CC0, v37, OS_LOG_TYPE_ERROR, "%25s:%-5d [-] USBDevice::LoadGroupTerminalDescriptors() - Could not get plugin interface!", buf, 0x12u);
    }
    return 4294956451;
  }
  return v20;
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 136315394;
            ...
            __int16 v23 = 1024;
            int v24 = 513;
            _os_log_impl(&def_21CC0, v18, OS_LOG_TYPE_DEBUG, "%25s:%-5d QueryInterface failed", buf, 0x12u);
          }
          *(void *)uint64_t v3 = 0;
        }
      }
...
uint64_t sub_9E00(uint64_t a1, uint64_t a2, io_object_t object)
{
  *(void *)a1 = 0;
  *(_DWORD *)(a1 + 8) = object;
  *(void *)(a1 + 16) = 0;
  *(_WORD *)(a1 + 24) = 0;
  IOObjectRetain(object);
  uint64_t v5 = sub_9B74(a1);
  if (v5 || (usleep(0x186A0u), (uint64_t v5 = sub_9B74(a1)) != 0))
  {
    if (a2)
    {
      *(void *)a1 = a2;
...
uint64_t sub_9F78(uint64_t a1)
{
  if (*(unsigned char *)(a1 + 25)) {
    return 1;
  }
  uint64_t v4 = sub_9B74(a1);
  if (!v4) {
    return 0;
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 1024;
      LODWORD(v14) = v7;
      _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBInterface::Open() - err = 0x%x", (uint8_t *)&v9, 0x18u);
    }
    return 0;
  }
  uint64_t v1 = 1;
  *(unsigned char *)(a1 + 25) = 1;
  ...
  if (os_log_type_enabled((os_log_t)qword_30130, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v13 = 2048;
    uint64_t v14 = a1;
    _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_DEBUG, "%25s:%-5d [?] USBInterface(%p)::Open() - success", (uint8_t *)&v9, 0x1Cu);
  }
  return v1;
}

uint64_t sub_A0F8(uint64_t a1, unsigned __int8 a2, uint64_t a3)
{
...
void *sub_A124(void *a1, uint64_t a2)
{
  CFMutableDictionaryRef v4 = IOServiceMatching("IOUSBDevice");
  sub_5A04((uint64_t)a1, a2, (uint64_t)v4);
  *a1 = off_2C850;
  sub_A23C();
  int v5 = qword_30140;
  if (os_log_type_enabled((os_log_t)qword_30140, OS_LOG_TYPE_DEBUG))
  {
    int v7 = 136315906;
    CFUUIDRef v8 = "USBDeviceManager.cpp";
    __int16 v9 = 1024;
    int v10 = 23;
    __int16 v11 = 2048;
    int v12 = a1;
    __int16 v13 = 2048;
    uint64_t v14 = a2;
    _os_log_impl(&def_21CC0, v5, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] USBDeviceManager(%p)::USBDeviceManager(notifyRunloop %p)", (uint8_t *)&v7, 0x26u);
  }
  return a1;
}
...
void sub_A23C()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30148, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30148))
  {
    qword_30140 = (uint64_t)os_log_create("com.apple.coremidi", "usbdvm");
    __cxa_guard_release(&qword_30148);
  }
}
...
uint64_t sub_A4E0(void *a1, uint64_t a2)
{
  CFMutableDictionaryRef v4 = IOServiceMatching("IOUSBInterface");
  uint64_t result = sub_5A04((uint64_t)a1, a2, (uint64_t)v4);
  *a1 = off_2C890;
  return result;
}
...
void sub_A53C()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30158, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30158))
  {
    qword_30150 = (uint64_t)os_log_create("com.apple.coremidi", "intmgr");
    __cxa_guard_release(&qword_30158);
  }
}
...
void sub_A828(_Unwind_Exception *exception_object)
{
}

double sub_A854(uint64_t a1)
{
...
uint64_t sub_A870(uint64_t a1, int a2, unsigned int a3, unsigned int a4, unsigned int a5, char *a6, uint64_t a7)
{
  ...
  if (*(void *)(a1 + 16) == *(void *)(a1 + 8))
  {
    ...
    *(unsigned char *)(a1 + 184) = a5;
    ...
    if (!(a3 >> 28))
    {
      int16x8_t v19 = (int16x8_t)vshlq_u32((uint32x4_t)vdupq_n_s32(a3), (uint32x4_t)xmmword_26F60);
    ...
    if (!(v13 >> 28))
    {
      int16x8_t v20 = (int16x8_t)vshlq_u32((uint32x4_t)vdupq_n_s32(v13), (uint32x4_t)xmmword_26F60);
    ...
    sub_AE3C();
    uint64_t v21 = qword_30160;
    if (os_log_type_enabled((os_log_t)qword_30160, OS_LOG_TYPE_DEBUG))
    {
      sub_B5E8(__p, 0x2AuLL, 0);
      uint64_t v22 = 0;
      if (v34 >= 0) {
        __int16 v23 = __p;
      }
      ...
      do
      {
        ...
        *(unsigned char *)__int16 v23 = a0123456789abcd[v24 >> 4];
      ...
      *(void *)__int16 v40 = v25;
      _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_DEBUG, "%25s:%-5d      new message hdr: %s ...", buf, 0x1Cu);
      if (v34 < 0) {
        operator delete(__p[0]);
      }
    }
    sub_B694(a1 + 8, *(char **)(a1 + 16), (char *)&__src, (char *)&v59, 14);
  }
  else
  {
    sub_AE3C();
    uint64_t v14 = qword_30160;
    if (os_log_type_enabled((os_log_t)qword_30160, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)__int16 v40 = v15;
      _os_log_impl(&def_21CC0, v14, OS_LOG_TYPE_DEBUG, "%25s:%-5d      Message already has %lu bytes. Checking continuation ...", buf, 0x1Cu);
    }
    if (*(_DWORD *)(a1 + 176) != a3 || *(_DWORD *)(a1 + 180) != a4 || *(unsigned __int8 *)(a1 + 184) != a5)
    {
      sub_AE3C();
      CFUUIDBytes v16 = qword_30160;
      if (os_log_type_enabled((os_log_t)qword_30160, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        v36 = "MIDICIMessageEmitter.cpp";
        __int16 v37 = 1024;
        int v38 = 52;
        _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] MIDICIMessageEmitter::CreateCIMessage() can't continue message (kMIDINotPermitted)", buf, 0x12u);
      }
...
LABEL_47:
  ...
  {
    case 1u:
      uint64_t v26 = sub_AEAC(a1, a6, a7);
      goto LABEL_41;
    case 2u:
      uint64_t v26 = sub_B004(a1, a6, a7);
      goto LABEL_41;
    case 3u:
      uint64_t v26 = sub_B19C(a1, a6, a7);
      goto LABEL_41;
    case 7u:
      uint64_t v26 = sub_B29C(a1, (uint64_t)a6, a7);
LABEL_41:
      uint64_t v17 = v26;
      break;
    default:
      sub_AE3C();
      __int16 v27 = qword_30160;
      if (os_log_type_enabled((os_log_t)qword_30160, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        v36 = "MIDICIMessageEmitter.cpp";
        ...
        *(_DWORD *)__int16 v40 = a5 >> 4;
        _os_log_impl(&def_21CC0, v27, OS_LOG_TYPE_ERROR, "%25s:%-5d      Unhandled message type: 0x%x", buf, 0x18u);
      }
      uint64_t v17 = 4294956452;
      break;
  }
  sub_AE3C();
  unint64_t v28 = qword_30160;
  if (os_log_type_enabled((os_log_t)qword_30160, OS_LOG_TYPE_DEBUG))
  {
    unsigned int v29 = sub_1B620(a5);
    ...
    *(_DWORD *)&v40[6] = a3;
    ...
    __int16 v51 = 1024;
    int v52 = v17;
    _os_log_impl(&def_21CC0, v28, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] MIDICIMessageEmitter::CreateCIMessage(channel:0x%x, sourceMUID:0x%08x, destMUID:0x%08x, msgIndex:0x%x (%s), data:%p, length:%lu) = %d", buf, 0x4Eu);
  }
  if (v17)
  {
    sub_AE3C();
    char v30 = qword_30160;
    if (os_log_type_enabled((os_log_t)qword_30160, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315650;
      v36 = "MIDICIMessageEmitter.cpp";
      ...
      *(_DWORD *)__int16 v40 = v17;
      _os_log_impl(&def_21CC0, v30, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] MIDICIMessageEmitter::CreateCIMessage() failed with error %d (message will not be sent)", buf, 0x18u);
    }
    goto LABEL_47;
  }
  return v17;
...
void sub_AE3C()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30168, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30168))
  {
    qword_30160 = (uint64_t)os_log_create("com.apple.coremidi", "ciemit");
    __cxa_guard_release(&qword_30168);
  }
}

uint64_t sub_AEAC(uint64_t a1, char *a2, unsigned int a3)
{
  char __src = 99;
  char v15 = 0;
  uint64_t v6 = a1 + 8;
  sub_B694(a1 + 8, *(char **)(a1 + 16), &__src, &v17, 1);
  ...
  if ((v7 - 16) < 2)
  {
    ...
    char v15 = a3 / 5;
    sub_B694(v6, *(char **)(a1 + 16), &v15, &__src, 1);
    uint64_t v8 = 0;
    if (a2)
    {
...
LABEL_15:
  char v17 = -9;
  sub_B694(v6, *(char **)(a1 + 16), &v17, (char *)&v18, 1);
  return v8;
}

uint64_t sub_B004(uint64_t a1, char *__src, unsigned int a3)
{
  ...
  switch(*(unsigned char *)(a1 + 184))
  {
    case ' ':
      break;
    case '!':
      uint64_t v6 = sub_B4B4(a1, (unsigned __int16 *)__src, a3);
      break;
    case '""':
    case '#':
    case '$':
    ...
    case '&':
      ...
      if (__src) {
        sub_B694(a1 + 8, *(char **)(a1 + 16), __src, __src + 5, 5);
      }
      unsigned int v13 = a3 - 5;
      if (!(v13 >> 28))
      {
        int16x8_t v14 = (int16x8_t)vshlq_u32((uint32x4_t)vdupq_n_s32(v13), (uint32x4_t)xmmword_26F60);
      ...
      sub_B694(a1 + 8, *(char **)(a1 + 16), (char *)&v15, v16, 4);
...
LABEL_10:
  ...
  char __srca = -9;
  sub_B694(a1 + 8, *(char **)(a1 + 16), &__srca, (char *)&v18, 1);
  return v6;
}

uint64_t sub_B19C(uint64_t a1, char *__src, unsigned __int16 a3)
{
  ...
  if ((v4 - 50) >= 8)
  {
    ...
    {
      if (__src) {
        sub_B694(a1 + 8, *(char **)(a1 + 16), __src, __src + 1, 1);
      }
      char v10 = -9;
      uint64_t v5 = a1 + 8;
    ...
    {
      char v12 = -9;
      sub_B694(a1 + 8, *(char **)(a1 + 16), &v12, (char *)&v13, 1);
      return 4294956452;
    }
  }
  if (__src)
  {
    if (a3) {
      sub_B694(a1 + 8, *(char **)(a1 + 16), __src, &__src[a3], a3);
    }
  }
  char __srca = -9;
  uint64_t v5 = a1 + 8;
  ...
  uint64_t v8 = &__srca;
LABEL_6:
  sub_B694(v5, v6, v8, p_srca, 1);
  return 0;
}

uint64_t sub_B29C(uint64_t a1, uint64_t a2, int a3)
{
  if (a3) {
    BOOL v6 = a2 == 0;
  }
  ...
  if ((v7 - 112) < 2)
  {
    ...
    uint64_t v10 = a1 + 8;
    sub_B694(a1 + 8, *(char **)(a1 + 16), (char *)(a1 + 161), (char *)(a1 + 172), 11);
    if (a3 != 5) {
      return 4294956452;
    }
    ...
    if (!(v11 >> 28))
    {
      int16x8_t v12 = (int16x8_t)vshlq_u32((uint32x4_t)vdupq_n_s32(v11), (uint32x4_t)xmmword_26F60);
  ...
  if (v7 == 126)
  {
    ...
    int64_t v9 = (char **)(a1 + 16);
LABEL_19:
    sub_B694(v10, *v9, (char *)&v15, v16, 4);
    goto LABEL_20;
  }
  if (v7 != 127) {
    return 4294956452;
...
LABEL_20:
  char v18 = -9;
  sub_B694(a1 + 8, *(char **)(a1 + 16), &v18, (char *)&v19, 1);
  return 0;
}

char *sub_B42C(uint64_t a1)
{
  v2[0] = xmmword_26F70;
  v2[1] = xmmword_26F80;
  v2[2] = xmmword_26F90;
  return sub_B694(a1 + 8, *(char **)(a1 + 16), (char *)v2, v3, 48);
}

uint64_t sub_B4B4(uint64_t a1, unsigned __int16 *a2, uint64_t a3)
{
  ...
  if (a2 && a3)
  {
    ...
    __src[0] = v6 & 0x7F;
    __src[1] = (v6 >> 7) & 0x7F;
    sub_B694(a1 + 8, *(char **)(a1 + 16), __src, (char *)&v15, 2);
    if (v6)
    {
      int v7 = (char *)a2 + 7;
      uint64_t v8 = v6;
      do
      {
        sub_B694(a1 + 8, *(char **)(a1 + 16), v7 - 5, v7, 5);
        v7 += 5;
        --v8;
      }
      while (v8);
    ...
    v13[0] = v10 & 0x7F;
    v13[1] = (v10 >> 7) & 0x7F;
    sub_B694(a1 + 8, *(char **)(a1 + 16), v13, __src, 2);
    if (v10)
    {
      ...
      {
        int16x8_t v12 = v11 + 5;
        sub_B694(a1 + 8, *(char **)(a1 + 16), v11, v11 + 5, 5);
...
void *sub_B5E8(void *__b, size_t __len, int __c)
{
...
char *sub_B694(uint64_t a1, char *__dst, char *__src, char *a4, int64_t a5)
{
  uint64_t v5 = __dst;
  if (a5 < 1) {
    return v5;
...
void sub_B880(uint64_t a1, void *a2, unsigned __int8 *a3, uint64_t *a4)
{
  *(void *)a1 = 0;
  *(void *)(a1 + 8) = 0;
  *(void *)(a1 + 16) = 0;
  ...
  *(void *)(a1 + 4sub_7888(&a9, 0) = *(void *)a3;
  uint64_t v9 = *a4;
  *(_OWORD *)(a1 + 136) = 0u;
  *(void *)(a1 + 48) = v9;
  ...
  *(_OWORD *)(a1 + 88) = 0u;
  *(_OWORD *)(a1 + 104) = 0u;
  *(_OWORD *)(a1 + 12sub_7888(&a9, 0) = 0u;
  *(void *)(a1 + 152) = 0;
  *(unsigned char *)(a1 + 208) = 0;
  *(_OWORD *)(a1 + 24sub_7888(&a9, 0) = 0u;
  *(_OWORD *)(a1 + 256) = 0u;
  *(_OWORD *)(a1 + 272) = 0u;
  *(_OWORD *)(a1 + 288) = 0u;
  *(_OWORD *)(a1 + 304) = 0u;
  *(void *)(a1 + 32sub_7888(&a9, 0) = 0;
  *(_DWORD *)(a1 + 328) = -1;
  *(unsigned char *)(a1 + 332) = 0;
  *(void *)(a1 + 192) = 0;
  *(void *)(a1 + 20sub_7888(&a9, 0) = 0;
  *(void *)(a1 + 224) = 0;
  *(void *)(a1 + 232) = 0;
  *(_DWORD *)(a1 + 32sub_7888(&a9, 0) = MIDICapabilityGetDiscoveryMUID();
  sub_BCA0();
  uint64_t v10 = qword_30170;
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
  {
    if (a3[1]) {
    ...
    *(void *)&buf[1] = "MIDIProtocolNegotiator.cpp";
    ...
    __int16 v34 = 1024;
    int v35 = v17;
    _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_INFO, "%25s:%-5d [*] MIDIProtocolNegotiatior(inEP: 0x%x (pipeIndex %u, mps %u), outEP: 0x%x (pipeIndex %u, mps %u) - Negotiating with MUID 0x%x", (uint8_t *)buf, 0x3Cu);
  }
  uint64_t v36 = a1;
  sub_E3E0((uint64_t)v18, &v36, a2);
}

void sub_BBA8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19)
{
  if (a2) {
    sub_5054(exception_object);
  }
...
void sub_BCA0()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30178, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30178))
  {
    qword_30170 = (uint64_t)os_log_create("com.apple.coremidi", "proton");
    __cxa_guard_release(&qword_30178);
  }
}

void **sub_BD10(uint64_t *a1, long long *a2)
{
  unint64_t v6 = a1[2];
  ...
  if ((unint64_t)v7 >= v6)
  {
    ...
    v18[4] = result;
    unsigned __int8 v14 = (char *)sub_DF24((uint64_t)result, v13);
    int v15 = &v14[16 * v10];
    v18[0] = v14;
    v18[1] = v15;
    v18[3] = &v14[16 * v16];
...
void sub_BE18(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_E06C((void **)va);
  _Unwind_Resume(a1);
...
void *sub_BE2C(void *a1, uint64_t *a2)
{
  uint64_t v4 = *a2;
  uint64_t v3 = a2[1];
  if (v3) {
...
uint64_t sub_BE78(uint64_t a1)
{
  sub_BCA0();
  uint64_t v2 = qword_30170;
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)uint64_t v10 = 136315394;
    *(void *)&v10[4] = "MIDIProtocolNegotiator.cpp";
    __int16 v11 = 1024;
    int v12 = 193;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] ~MIDIProtocolNegotiatior()", v10, 0x12u);
  }
  if (*(void *)(a1 + 128))
  {
  ...
  *(unsigned char *)(a1 + 332) = 1;
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&v10[4] = "MIDIProtocolNegotiator.cpp";
    __int16 v11 = 1024;
    int v12 = 196;
    _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_DEBUG, "%25s:%-5d [-] ~MIDIProtocolNegotiatior()", v10, 0x12u);
  }
  uint64_t v4 = *(std::__shared_weak_count **)(a1 + 232);
  if (v4) {
    sub_81CC(v4);
  }
  unint64_t v5 = *(std::__shared_weak_count **)(a1 + 200);
  if (v5) {
    sub_81CC(v5);
  }
  *(void *)uint64_t v10 = a1 + 136;
  sub_E0F4((void ***)v10);
...
void sub_C034(_Unwind_Exception *a1, int a2)
{
  if (!a2) {
    _Unwind_Resume(a1);
  }
...
void sub_C044(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v9 = 1024;
    int v10 = 201;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] MIDIProtocolNegotiatior::negotiateProtocol()", buf, 0x12u);
  }
  char v5 = 2;
  int v6 = 512;
  sub_A870(*(void *)(a1 + 16), 127, *(_DWORD *)(a1 + 320), 0xFFFFFFFu, 0x70u, &v5, 5);
  sub_BCA0();
  uint64_t v3 = qword_30170;
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v9 = 1024;
    int v10 = 209;
    _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_DEBUG, "%25s:%-5d [Negotiating] Send Discovery message", buf, 0x12u);
  }
  *(_DWORD *)(a1 + 328) = 1;
  if ((*(unsigned int (**)(void))(**(void **)(a1 + 16) + 24))(*(void *)(a1 + 16))) {
    sub_DD2C(a1, dbl_26FC0[*(_DWORD *)(a1 + 328) == 1]);
  }
  else {
    sub_C250(a1);
  }
  sub_BCA0();
  uint64_t v4 = qword_30170;
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v8 = "MIDIProtocolNegotiator.cpp";
    __int16 v9 = 1024;
    int v10 = 220;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [-] MIDIProtocolNegotiatior::negotiateProtocol()", buf, 0x12u);
  }
}

void sub_C250(uint64_t a1)
{
  if (!*(unsigned char *)(a1 + 332))
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v5 = 1024;
      int v6 = 460;
      _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_INFO, "%25s:%-5d [timeout]", (uint8_t *)&v3, 0x12u);
    }
    if (*(void *)(a1 + 128))
    {
      MIDITimerTaskDispose();
...
uint64_t sub_C338(uint64_t a1, unsigned int a2, int a3)
{
...
LABEL_28:
          _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_DEBUG, v22, buf, 0x18u);
          return v3;
        }
        int v8 = 1;
      }
      ...
      *(unsigned char *)(a1 + 208) = 1;
      ...
      if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
      {
        ...
        do
        {
          ...
          *(unsigned char *)int v12 = a0123456789abcd_0[(unint64_t)v14 >> 4];
        ...
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v30 = 2080;
        int v31 = v15;
        _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] writeAsyncWithBuffer: %s", buf, 0x1Cu);
        if (v25 < 0) {
          operator delete(__p[0]);
        }
      }
      ...
      int v17 = (*((uint64_t (**)(void **, void, void, uint64_t, void (*)(void *, int), uint64_t))*v16
             + 34))(v16, *(unsigned __int8 *)(v7 + 64), *(void *)(v7 + 24), v6, sub_D994, a1);
      if (v17)
      {
        sub_BCA0();
        uint64_t v18 = qword_30170;
        if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 136316674;
          ...
          __int16 v38 = 1024;
          int v39 = v17;
          _os_log_impl(&def_21CC0, v18, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] writePipeAsync(%p, %u, %p, %lu, ...) = 0x%x", buf, 0x3Cu);
        }
...
void sub_C6F8(uint64_t a1, uint64_t a2, unint64_t a3)
{
  if (!*(unsigned char *)(a1 + 332))
  {
        ...
        else
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)&v22[14] = 261;
            __int16 v23 = 1024;
            int v24 = a3;
            _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] MIDIProtocolNegotiatior::handleCIInput() - %u bytes received", v22, 0x18u);
          }
          *(void *)__int16 v22 = *(void *)(a2 + 24);
          *(void *)&v22[8] = a3 >> 2;
          uint64_t v9 = a1 + 248;
          uint64_t v10 = sub_C99C((uint64_t *)v22, a1 + 248 + *(void *)(a1 + 312), a1 + 312);
          int v11 = v10;
...
LABEL_23:
        ...
        *(_DWORD *)&v22[14] = 269;
        ...
        __int16 v25 = 1024;
        int v26 = v21;
        uint64_t v16 = "%25s:%-5d [Negotiating] Read %u bytes (%u total), reading more ...";
        int v17 = v20;
        os_log_type_t v18 = OS_LOG_TYPE_INFO;
        uint32_t v19 = 30;
LABEL_22:
        _os_log_impl(&def_21CC0, v17, v18, v16, v22, v19);
        goto LABEL_23;
      }
    }
    else
    ...
    *(_WORD *)&v22[12] = 1024;
    *(_DWORD *)&v22[14] = 255;
    uint64_t v16 = "%25s:%-5d [readCallback: owning USBMIDIDevice destroyed]";
    int v17 = v15;
...
void sub_C984(_Unwind_Exception *a1)
{
  sub_81CC(v1);
  _Unwind_Resume(a1);
}

uint64_t sub_C99C(uint64_t *a1, unint64_t a2, unint64_t a3)
{
  if (a2 >= a3) {
    return 0;
  }
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315906;
    ...
    _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] appendSysExToBuffer() - wordCount %u, %u bytes available", buf, 0x1Eu);
  }
  if (v6)
  {
    unint64_t v8 = 0;
...
LABEL_19:
          _os_log_impl(&def_21CC0, v21, v22, v23, buf, 0x18u);
        }
      }
      else
      {
        if (v13 == 3)
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 136316418;
            ...
            __int16 v52 = 2080;
            uint64_t v53 = v36;
            _os_log_impl(&def_21CC0, v33, OS_LOG_TYPE_DEBUG, "%25s:%-5d      sysex 0x%08x 0x%08x (%u bytes converted) %s", buf, 0x2Eu);
          }
      ...
      BOOL v16 = 0;
LABEL_44:
      unint64_t v8 = v8 + byte_270E8[(unint64_t)*v11 >> 28];
      if (v8 >= v6 || v16) {
        goto LABEL_51;
      }
    }
...
LABEL_51:
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315650;
    ...
    __int16 v46 = 1024;
    int v47 = v9;
    _os_log_impl(&def_21CC0, v38, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] appendSysExToBuffer() - %u total bytes copied", buf, 0x18u);
  }
  return v9;
}

void sub_CE40(uint64_t a1)
{
  sub_BCA0();
  uint64_t v2 = qword_30170;
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    ...
    if (v3)
    {
      ...
      {
        unsigned int v6 = *v4++;
        *(unsigned char *)uint64_t v5 = a0123456789abcd_0[(unint64_t)v6 >> 4];
        *((unsigned char *)v5 + 1) = a0123456789abcd_0[v6 & 0xF];
    ...
    *(void *)unsigned int v51 = v7;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [handleMessage] RCV: %s", buf, 0x1Cu);
    if (v46 < 0) {
      operator delete(__p[0]);
    }
  }
  ...
  if (v8 == 1)
  {
    if (sub_E248(a1 + 248, *(void *)(a1 + 312), 113, 31))
    {
      if (*(void *)(a1 + 128))
      {
        MIDITimerTaskDispose();
      ...
      *(_DWORD *)(a1 + 324) = *(unsigned char *)(a1 + 254) & 0x7F | ((*(unsigned char *)(a1 + 255) & 0x7F) << 7) & 0x3FFF | ((*(unsigned char *)(a1 + 256) & 0x7F) << 14) & 0xF01FFFFF | ((*(unsigned char *)(a1 + 257) & 0x7F) << 21);
      ...
      if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&v51[4] = 1024;
        *(_DWORD *)&v51[6] = v10;
        _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_INFO, "%25s:%-5d [handleMessage: Discovery Reply] Discovered MUID 0x%x (%u)", buf, 0x1Eu);
      }
      *(_WORD *)&buf[8] = 0;
      *(void *)buf = 0x20000000001;
      sub_A870(*(void *)(a1 + 16), 127, *(_DWORD *)(a1 + 320), *(_DWORD *)(a1 + 324), 0x10u, buf, 10);
      *(_DWORD *)(a1 + 328) = 2;
...
LABEL_86:
  ...
  {
LABEL_43:
    if (v8 == 4 && sub_E248(a1 + 248, *(void *)(a1 + 312), 20, 64))
    {
      uint64_t v24 = 0;
        ...
        if (++v24 == 48)
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
          {
            ...
            *(void *)&uint8_t buf[4] = "MIDIProtocolNegotiator.cpp";
            __int16 v48 = 1024;
            int v49 = 343;
            _os_log_impl(&def_21CC0, v25, OS_LOG_TYPE_INFO, "%25s:%-5d [Negotiating] Protocol Test: confirming new protocol established...", buf, 0x12u);
          }
          sub_A870(*(void *)(a1 + 16), 127, *(_DWORD *)(a1 + 320), *(_DWORD *)(a1 + 324), 0x15u, 0, 0);
          if (!(*(unsigned int (**)(void))(**(void **)(a1 + 16) + 24))())
          {
            int v41 = -536870163;
            goto LABEL_83;
          ...
          if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
          {
            ...
            *(void *)&uint8_t buf[4] = "MIDIProtocolNegotiator.cpp";
            __int16 v48 = 1024;
            int v49 = 349;
            _os_log_impl(&def_21CC0, v26, OS_LOG_TYPE_INFO, "%25s:%-5d [Negotiating] Done with negotiation.", buf, 0x12u);
          }
          sub_D864(a1, 8);
          goto LABEL_86;
        }
...
LABEL_85:
    _os_log_impl(&def_21CC0, v29, OS_LOG_TYPE_ERROR, v28, buf, v30);
    goto LABEL_86;
  }
  unint64_t v11 = *(void *)(a1 + 312);
  BOOL v12 = sub_E248(a1 + 248, v11, 17, v11);
  if (v11 <= 0x11 || !v12)
  {
    int v8 = *(_DWORD *)(a1 + 328);
    goto LABEL_43;
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&uint8_t buf[4] = "MIDIProtocolNegotiator.cpp";
    __int16 v48 = 1024;
    int v49 = 296;
    _os_log_impl(&def_21CC0, v14, OS_LOG_TYPE_DEBUG, "%25s:%-5d [Negotiating: Protocol Discovery] Examining protocols ...", buf, 0x12u);
  }
  ...
  if (*(unsigned char *)(a1 + 263))
  {
    ...
    do
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v51[4] = 1024;
        *(_DWORD *)&v51[6] = v21;
        _os_log_impl(&def_21CC0, v22, OS_LOG_TYPE_DEBUG, "%25s:%-5d [Negotiating: Protocol Discovery] Found protocol: 0x%x, extension bitmap 0x%x", buf, 0x1Eu);
      }
      int v23 = ((v21 & 3) == 0) | v18;
      if (v20 != 1) {
        int v23 = v18;
  ...
  if (v18 & 1) != 0 || (v17)
  {
    if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)unsigned int v51 = v38;
      _os_log_impl(&def_21CC0, v37, OS_LOG_TYPE_INFO, "%25s:%-5d [Negotiating: Protocol Discovery] Setting %s protocol...", buf, 0x1Cu);
    }
    if (v17) {
      char v39 = 2;
    }
    ...
    *(_DWORD *)((char *)__p + 1) = 0;
    sub_A870(v40, 127, *(_DWORD *)(a1 + 320), *(_DWORD *)(a1 + 324), 0x12u, (char *)__p, 5);
    *(_DWORD *)(a1 + 328) = 3;
    int v41 = -536870163;
    if ((*(unsigned int (**)(void))(**(void **)(a1 + 16) + 24))())
    {
      sub_BCA0();
      unsigned int v42 = qword_30170;
      if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 136315394;
        *(void *)&uint8_t buf[4] = "MIDIProtocolNegotiator.cpp";
        __int16 v48 = 1024;
        int v49 = 332;
        _os_log_impl(&def_21CC0, v42, OS_LOG_TYPE_INFO, "%25s:%-5d [Negotiating: Test Protocol] Sending protocol test data ...", buf, 0x12u);
      }
      uint64_t v43 = *(void *)(a1 + 16);
      *(_DWORD *)(a1 + 328) = 4;
      sub_A870(v43, 127, *(_DWORD *)(a1 + 320), *(_DWORD *)(a1 + 324), 0x13u, 0, 0);
      if ((*(unsigned int (**)(void))(**(void **)(a1 + 16) + 24))())
      {
        sub_DD2C(a1, dbl_26FC0[*(_DWORD *)(a1 + 328) == 1]);
        int v41 = 0;
...
LABEL_83:
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&uint8_t buf[4] = "MIDIProtocolNegotiator.cpp";
    __int16 v48 = 1024;
    int v49 = 317;
    _os_log_impl(&def_21CC0, v37, OS_LOG_TYPE_ERROR, "%25s:%-5d [Negotiation Failure] No usable protocols discovered", buf, 0x12u);
  }
  sub_C250(a1);
}
...
void sub_D864(uint64_t a1, int a2)
{
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2080;
    unsigned int v13 = v5;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_INFO, "%25s:%-5d [*] MIDIProtocolNegotiator::finished(%s)", (uint8_t *)&v8, 0x1Cu);
  }
  *(unsigned char *)(a1 + 332) = 1;
  *(_DWORD *)(a1 + 328) = a2;
...
void sub_D994(void *a1, int a2)
{
  if (a2 == -536870165)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)&buf[14] = 367;
      _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [write aborted]", buf, 0x12u);
    }
  }
  else if (a1)
  {
        ...
        *(_DWORD *)(v4 + 216) = v7 + 1;
        ...
        if (*(void *)(*(void *)buf + 24))
        {
          if (*(void *)(*(void *)buf + 224)) {
            sub_C338(*(void *)buf, *(unsigned int *)(*(void *)buf + 216), 1);
          }
          else {
    ...
    if (*(void *)&buf[8]) {
      sub_81CC(*(std::__shared_weak_count **)&buf[8]);
    }
  }
}

void sub_DB38(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, atomic_uint **a9, uint64_t a10, uint64_t a11, std::__shared_weak_count *a12)
{
  sub_DB70(&a9);
...
atomic_uint ***sub_DB70(atomic_uint ***a1)
{
  uint64_t v2 = **a1;
...
void sub_DBDC(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v17 = 1024;
    int v18 = v5;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] MIDIProtocolNegotiator::completeNegotiation(selectedProtocol:%x) - inEP: 0x%x, outEP: 0x%x", (uint8_t *)&v9, 0x24u);
  }
  uint64_t v6 = *(void *)(a1 + 24);
  if (v6 && !*(unsigned char *)(v6 + 184))
  {
    ...
    sub_110F8(v6, v7, v8, *(unsigned __int8 *)(a1 + 56));
  }
}

void sub_DD2C(uint64_t a1, double a2)
{
  if (!*(void *)(a1 + 128)) {
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v8 = 2048;
    double v9 = a2;
    _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_DEBUG, "%25s:%-5d [Negotiating] Timeout %f ms from now", (uint8_t *)&v4, 0x1Cu);
  }
}

void sub_DE64(uint64_t a1)
{
...
uint64_t sub_DEAC(uint64_t *a1, void *a2)
{
  uint64_t result = sub_DF5C((uint64_t)(a1 + 2), a1[1], (void *)a1[1], *a1, (void *)*a1, a2[1], a2[1]);
  a2[1] = v5;
  uint64_t v6 = *a1;
  *a1 = v5;
  a2[1] = v6;
...
void *sub_DF24(uint64_t a1, unint64_t a2)
{
  if (a2 >> 60) {
    sub_4898();
  }
...
uint64_t sub_DF5C(uint64_t a1, uint64_t a2, void *a3, uint64_t a4, void *a5, uint64_t a6, uint64_t a7)
{
  uint64_t v7 = a7;
  ...
  *((void *)&v15 + 1) = a7;
  ...
  char v13 = 1;
  sub_DFF0((uint64_t)v12);
  return v10;
}

uint64_t sub_DFF0(uint64_t a1)
{
...
void sub_E0F4(void ***a1)
{
  uint64_t v2 = *a1;
  if (*v2)
  {
    sub_E148((uint64_t *)v2);
    uint64_t v3 = **a1;
    operator delete(v3);
  }
}
...
void *sub_E194(void *a1, char *__s)
{
...
BOOL sub_E248(uint64_t a1, unint64_t a2, int a3, uint64_t a4)
{
  if (a2 < 5) {
    return 0;
  }
  ...
  if (a2 != a4)
  {
    ...
    {
      int v14 = 136315906;
      long long v15 = "MIDIProtocolNegotiator.cpp";
      __int16 v16 = 1024;
      int v17 = 75;
      __int16 v18 = 1024;
      int v19 = a2;
      __int16 v20 = 1024;
      int v21 = a4;
      _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] spanMatchesTypeAndLength() - msgSize %u does not match supplied length %u", (uint8_t *)&v14, 0x1Eu);
    }
  }
  if (v9 != a3)
  {
    sub_BCA0();
    __int16 v11 = qword_30170;
    if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v20 = 1024;
      int v21 = a3;
      _os_log_impl(&def_21CC0, v11, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] spanMatchesTypeAndLength() - subID2 %u does not match supplied type %u", (uint8_t *)&v14, 0x1Eu);
    }
  }
  return a2 == a4 && v9 == a3;
}

void sub_E3E0(uint64_t a1, uint64_t *a2, void *a3)
{
  size_t v5 = operator new(0x60uLL);
  sub_E454(v5, a2, a3);
}

void sub_E440(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

void sub_E454(void *a1, uint64_t *a2, void *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2C8E8;
  sub_E54C((uint64_t)(a1 + 3), a2, a3);
}

void sub_E49C(_Unwind_Exception *a1)
{
  std::__shared_weak_count::~__shared_weak_count(v1);
  _Unwind_Resume(a1);
}

void sub_E4B0(std::__shared_weak_count *this)
{
  this->__vftable = (std::__shared_weak_count_vtbl *)off_2C8E8;
  std::__shared_weak_count::~__shared_weak_count(this);
}

void sub_E4D0(std::__shared_weak_count *a1)
{
  a1->__vftable = (std::__shared_weak_count_vtbl *)off_2C8E8;
  std::__shared_weak_count::~__shared_weak_count(a1);
...
void sub_E54C(uint64_t a1, uint64_t *a2, void *a3)
{
  uint64_t v3 = *a2;
  uint64_t v4 = a3[1];
  v5[0] = *a3;
...
void sub_E5B0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10) {
...
void sub_E5C8(uint64_t a1, uint64_t a2, void *a3)
{
...
void sub_E660(_Unwind_Exception *a1)
{
...
void *sub_E680(void *a1)
{
  *a1 = off_2C920;
  ...
  sub_8898((uint64_t)(a1 + 2));
  return a1;
}

void sub_E6D4(void *a1)
{
  *a1 = off_2C920;
  uint64_t v2 = (std::__shared_weak_count *)a1[7];
  if (v2) {
...
uint64_t sub_E748(uint64_t result)
{
  if (result) {
    return (*(uint64_t (**)(void))(*(void *)result + 8))();
  }
...
void sub_E774(uint64_t *a1, unsigned __int8 **a2)
{
  uint64_t v3 = *a1;
  v60 = (std::mutex *)(*a1 + 64);
  std::mutex::lock(v60);
  ...
  if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_DEBUG))
  {
    ...
    else
    {
      ...
      {
        unsigned int v10 = *v6++;
        *(unsigned char *)uint64_t v8 = a0123456789abcd_0[(unint64_t)v10 >> 4];
        *((unsigned char *)v8 + 1) = a0123456789abcd_0[v10 & 0xF];
    ...
    *(_DWORD *)buf = 136315906;
    v66 = "MIDIProtocolNegotiator.cpp";
    __int16 v67 = 1024;
    int v68 = 154;
    __int16 v69 = 1024;
    int v70 = v7;
    __int16 v71 = 2080;
    v72 = v11;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] MIDICIMessageEmitter %u bytes: %s", buf, 0x22u);
    if (v64 < 0) {
      operator delete(__p[0]);
    }
  }
    ...
    if (v61 != v16)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v69 = 1024;
        int v70 = v16;
        _os_log_impl(&def_21CC0, v52, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] MIDICIMessageEmitter did not copy %u bytes", buf, 0x18u);
      }
    }
    goto LABEL_103;
  }
...
LABEL_62:
        if ((unint64_t)v23 + v25 + 8 <= v26)
        {
          *(void **)((char *)v23 + v25) = (void *)((v35 << 20) | (v37 << 16) | ((unint64_t)(v38 & 0x7F) << 8) | v41 & 0x7F | ((unint64_t)(((v40 & 0x7F) << 24) | ((v42 & 0x7F) << 16) | ((v39 & 0x7F) << 8) | v43 & 0x7Fu) << 32) | 0x30000000);
          ...
          if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30188, memory_order_acquire) & 1) == 0
            && __cxa_guard_acquire(&qword_30188))
          {
            qword_30180 = (uint64_t)os_log_create("com.apple.coremidi", "umptrs");
            __cxa_guard_release(&qword_30188);
          }
          ++v23;
          uint64_t v22 = (v44 + v22);
          int v45 = qword_30180;
          if (os_log_type_enabled((os_log_t)qword_30180, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 136316162;
            v66 = "USBMIDIUMPTranslation.h";
            __int16 v67 = 1024;
            int v68 = 450;
            __int16 v69 = 1024;
            int v70 = v22;
            ...
            __int16 v73 = 1024;
            int v74 = v12 - v22;
            _os_log_impl(&def_21CC0, v45, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] MIDI1SysExToUMPSysEx() - @ index %u: %lu UMP bytes written so far, %u legacy MIDI bytes remain", buf, 0x28u);
          }
          if (v35 != 3)
          {
            uint64_t v21 = v22;
...
LABEL_84:
    ...
    *(void *)(v3 + 8 * v46 + 16sub_7888(&a9, 0) = v23;
    if (!v23) {
      break;
    }
    int v47 = a2[1];
    int v48 = sub_C338(v3, v46, 0);
    if (v48)
    {
      sub_BCA0();
      uint64_t v57 = qword_30170;
      if (os_log_type_enabled((os_log_t)qword_30170, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        v66 = "MIDIProtocolNegotiator.cpp";
        ...
        uint32_t v56 = 24;
LABEL_101:
        _os_log_impl(&def_21CC0, v55, OS_LOG_TYPE_ERROR, v54, buf, v56);
      }
      goto LABEL_102;
    }
    if (!*(void *)(v3 + 224))
...
void sub_EE40(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, std::mutex *a11)
{
}

void *sub_EE5C(void *result, void *a2)
{
  std::logic_error *result = *a2;
  return result;
}

void *sub_EE68(void *result, void *a2)
{
  std::logic_error *result = *a2;
  return result;
}

uint64_t sub_EE78(uint64_t a1, uint64_t *a2, uint64_t *a3)
{
  uint64_t v6 = sub_F13C((void *)a1, 0x200uLL);
  *uint64_t v6 = off_2C970;
  *((_DWORD *)v6 + 18) = 0;
  uint64_t v7 = *a2;
  v6[10] = *a2;
  (*(void (**)(void *, uint64_t *))(v7 + 8))(v6 + 11, a2 + 1);
  uint64_t v8 = *a3;
  *(void *)(a1 + 12sub_7888(&a9, 0) = *a3;
  (*(void (**)(uint64_t, uint64_t *))(v8 + 8))(a1 + 128, a3 + 1);
  *(void *)(a1 + 165) = 0;
  *(void *)(a1 + 16sub_7888(&a9, 0) = 0;
  *(void *)(a1 + 176) = 0;
...
void sub_EF24(_Unwind_Exception *a1)
{
...
void *sub_EF70(void *a1)
{
  *a1 = off_2C9A0;
  sub_F2D0((uint64_t)a1);
...
uint64_t sub_F018(void *a1, uint64_t a2)
{
  uint64_t v3 = a1 + 1;
  if (a1[2] == a1[1]) {
    return 0;
...
uint64_t sub_F098(uint64_t a1)
{
  ...
  {
    *(unsigned char *)(a1 + 16sub_7888(&a9, 0) = 0;
  }
  else
  {
    *(void *)(a1 + 16) = *(void *)(a1 + 8);
...
void *sub_F13C(void *a1, size_t __sz)
{
  *a1 = off_2C9A0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_F1A8(_Unwind_Exception *a1)
{
...
void sub_F1D8(unint64_t *a1, size_t __sz)
{
  unint64_t v2 = *a1;
  if (a1[2] - *a1 < __sz)
  {
...
{
  uint64_t v3 = &off_2C9C0;
  uint64_t v1 = (*(uint64_t (**)(uint64_t, void (***)()))(*(void *)a1 + 16))(a1, &v3);
  ((void (*)(uint64_t *))v3[3])(&v4);
  return v1;
}

void sub_F370(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9)
{
  if (!a2) {
    _Unwind_Resume(exception_object);
  }
...
void *sub_F3FC(void *a1)
{
  *a1 = off_2C970;
  sub_F098((uint64_t)a1);
...
void sub_F50C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  sub_83C8(a1, a5);
  *(void *)(v10 + 64) = 0;
  *(void *)(v10 + 72) = 0;
  *(void *)uint64_t v10 = off_2CA10;
  *(void *)(v10 + 8sub_7888(&a9, 0) = a2;
  *(void *)(v10 + 88) = a3;
  *(void *)(v10 + 96) = a4;
  *(_OWORD *)(v10 + 104) = 0u;
  *(_OWORD *)(v10 + 12sub_7888(&a9, 0) = 0u;
  *(_OWORD *)(v10 + 136) = 0u;
  *(_OWORD *)(v10 + 152) = 0u;
  *(_OWORD *)(v10 + 168) = 0u;
  *(_DWORD *)(v10 + 183) = 0;
  ...
  *(void *)(v10 + 192) = 0;
  *(_OWORD *)(v10 + 24sub_7888(&a9, 0) = 0u;
  *(void *)(v10 + 20sub_7888(&a9, 0) = 0;
  *(void *)(v10 + 208) = 0;
  *(_DWORD *)(v10 + 216) = 1;
  *(_OWORD *)(v10 + 224) = 0u;
  *(_OWORD *)(v10 + 256) = 0u;
  ...
  *(_OWORD *)(v10 + 288) = 0u;
  *(_OWORD *)(v10 + 304) = 0u;
  *(_OWORD *)(v10 + 32sub_7888(&a9, 0) = 0u;
  *(void *)(v10 + 336) = 0;
  sub_5654(v10 + 344, (uint64_t)"USBMIDIDevice.mWriteQueueMutex");
  *(void *)(a1 + 432) = a1 + 432;
  *(void *)(a1 + 44sub_7888(&a9, 0) = a1 + 432;
  *(_OWORD *)(a1 + 448) = 0u;
  *(_OWORD *)(a1 + 464) = 0u;
  *(_OWORD *)(a1 + 478) = 0u;
  v36[0] = off_2CC18;
  v36[3] = v36;
  sub_FCF0(@"usbioresults", @"com.apple.coremidi", (uint64_t)sub_49D4, (uint64_t)v36);
  sub_17B20(v36);
  v35[0] = off_2CC60;
  v35[1] = a1;
  v35[3] = v35;
  sub_FE0C(@"usbmidi2", @"com.apple.coremidi", (uint64_t)sub_4AD0, (uint64_t)v35);
  sub_17F04(v35);
  v34[0] = off_2CCA8;
  v34[1] = a1;
  v34[3] = v34;
  sub_FE0C(@"umpoutput", @"com.apple.coremidi", (uint64_t)sub_4AD0, (uint64_t)v34);
  sub_17F04(v34);
  v33[0] = off_2CCF0;
  v33[1] = a1;
  v33[3] = v33;
  sub_FE0C(@"umpinput", @"com.apple.coremidi", (uint64_t)sub_4AD0, (uint64_t)v33);
  sub_17F04(v33);
  sub_FF28();
  __int16 v11 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    int64_t v12 = "(MIDI 2.0 enabled)";
    int v13 = *(unsigned __int8 *)(a1 + 490);
    int v14 = *(unsigned __int8 *)(a1 + 489);
    BOOL v15 = *(unsigned char *)(a1 + 187) == 0;
    buf[0] = 136316674;
    if (v15) {
      int64_t v12 = "(Legacy MIDI 1.0 re-enabled by defaults)";
    }
    *(void *)&buf[1] = "USBMIDIDevice.cpp";
    unsigned int v16 = "UMP for Legacy Input";
    int v22 = 119;
    __int16 v23 = 2048;
    __int16 v21 = 1024;
    if (!v13) {
      unsigned int v16 = "Legacy Input Passthrough";
    }
    uint64_t v24 = a1;
    __int16 v25 = 1024;
    unsigned int v17 = "Legacy Output Passthrough";
    int v26 = a5;
    __int16 v27 = 2080;
    if (v14) {
      unsigned int v17 = "UMP for Legacy Output";
    }
    ...
    __int16 v31 = 2080;
    uint64_t v32 = v17;
    _os_log_impl(&def_21CC0, v11, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIDevice(%p)::USBMIDIDevice() with MIDIDeviceRef %u %s (%s / %s)", (uint8_t *)buf, 0x40u);
  }
  uint64_t v18 = off_2CD28;
  uint64_t v19 = a1;
  operator new();
}

void sub_FAB8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24)
{
  if (!a2) {
    _Unwind_Resume(exception_object);
  }
...
void *sub_FCF0(const void *a1, void *a2, uint64_t a3, uint64_t a4)
{
  uint64_t v8 = sub_495C();
  sub_177C0((uint64_t)v11, a4);
  int v13 = 0;
  int64_t v9 = operator new(0x30uLL);
  *int64_t v9 = off_2CB88;
  v9[1] = a3;
  sub_179E8((uint64_t)(v9 + 2), (uint64_t)v11);
  int v13 = v9;
  sub_4EA4((uint64_t)v8, a1, a2, (uint64_t)v12);
  sub_52C8(v12);
  return sub_17B20(v11);
}

void sub_FDE0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_52C8((uint64_t *)va);
  sub_17B20(v6);
...
void *sub_FE0C(const void *a1, void *a2, uint64_t a3, uint64_t a4)
{
  uint64_t v8 = sub_495C();
  sub_17BA4((uint64_t)v11, a4);
  int v13 = 0;
  int64_t v9 = operator new(0x30uLL);
  *int64_t v9 = off_2CBD0;
  v9[1] = a3;
  sub_17DCC((uint64_t)(v9 + 2), (uint64_t)v11);
  int v13 = v9;
  sub_4EA4((uint64_t)v8, a1, a2, (uint64_t)v12);
  sub_52C8(v12);
  return sub_17F04(v11);
}

void sub_FEFC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_52C8((uint64_t *)va);
  sub_17F04(v6);
...
void sub_FF28()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_30198, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_30198))
  {
    qword_30190 = (uint64_t)os_log_create("com.apple.coremidi", "usbmio");
    __cxa_guard_release(&qword_30198);
  }
}

uint64_t sub_FF9C(void *a1)
{
  sub_FF28();
  unint64_t v2 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    ...
    *(void *)&buf[20] = a1;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDevice(%p)::Initialize()", buf, 0x1Cu);
  }
  uint64_t v3 = (*(uint64_t (**)(void, void *))(*(void *)a1[10] + 144))(a1[10], a1);
  a1[12] = v3;
  if (!v3 || (sub_9F78(v3) & 1) == 0)
  {
    sub_FF28();
    uint64_t v25 = qword_30190;
    if (!os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR)) {
      return 0;
    }
    uint64_t v26 = a1[12];
    *(void *)&uint8_t buf[4] = "USBMIDIDevice.cpp";
    ...
    *(_WORD *)&buf[28] = 2080;
    v76 = v27;
    unsigned int v28 = "%25s:%-5d [-] USBMIDIDevice(%p)::Initialize() - Failed: %s";
    __int16 v29 = v25;
    uint32_t v30 = 38;
LABEL_49:
    _os_log_impl(&def_21CC0, v29, OS_LOG_TYPE_ERROR, v28, buf, v30);
  ...
  uint64_t v4 = sub_9B74(a1[12]);
  a1[13] = v4;
  if (!v4)
  {
    sub_FF28();
    uint64_t v33 = qword_30190;
    if (!os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR)) {
      return 0;
    }
    *(_DWORD *)buf = 136315650;
    ...
    *(_WORD *)&unsigned char buf[18] = 2048;
    *(void *)&buf[20] = a1;
    unsigned int v28 = "%25s:%-5d [-] USBMIDIDevice(%p)::Initialize() - Failed: GetPluginInterface() failed";
    goto LABEL_54;
  }
  *(_WORD *)((char *)a1 + 185) = 0;
  int v5 = sub_10F5C((uint64_t)a1);
  *((unsigned char *)a1 + 189) = v5;
  if (v5)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 1024;
      *(_DWORD *)&buf[14] = 152;
      _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_INFO, "%25s:%-5d      phantom entity detected and will be excluded from portmap list", buf, 0x12u);
    }
  }
    ...
    && !(*(unsigned int (**)(void *))(*a1 + 104))(a1))
  {
    ...
    *(_WORD *)&unsigned char buf[18] = 2048;
    *(void *)&buf[20] = a1;
    unsigned int v28 = "%25s:%-5d [-] USBMIDIDevice(%p)::Initialize() encountered an error and is exiting prematurely.";
LABEL_54:
    __int16 v29 = v33;
    uint32_t v30 = 28;
    goto LABEL_49;
  ...
  if (*(_DWORD *)(a1[10] + 28) == 3)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 1024;
      *(_DWORD *)&buf[14] = 159;
      _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_INFO, "%25s:%-5d      Using USB MIDI Driver v3.", buf, 0x12u);
    }
  }
  (*(void (**)(void *))(*a1 + 32))(a1);
  if (a1[17] != a1[18])
  {
    ...
    *(void *)buf = a1;
    sub_18338((uint64_t)&v69, (uint64_t *)buf, v72);
  }
  if (a1[20] != a1[21])
  {
    sub_F47C(buf, a1 + 8);
    int64_t v9 = *(std::__shared_weak_count **)&buf[8];
    *(void *)v72 = *(void *)buf;
    *(void *)&v72[8] = *(void *)&buf[8];
    if (*(void *)&buf[8])
    {
  ...
  for (uint64_t i = (unsigned __int8 *)a1[18]; v10 != i; v10 += 8)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[24] = 1024;
      *(_DWORD *)&buf[26] = v14;
      _os_log_impl(&def_21CC0, v12, OS_LOG_TYPE_INFO, "%25s:%-5d      Configuring USB In Endpoint: 0x%0x, pipeIndex:%d", buf, 0x1Eu);
    }
  }
  ...
  for (j = (unsigned __int8 *)a1[21]; v15 != j; v15 += 8)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[24] = 1024;
      *(_DWORD *)&buf[26] = v19;
      _os_log_impl(&def_21CC0, v17, OS_LOG_TYPE_INFO, "%25s:%-5d      Configuring USB Out Endpoint: 0x%0x, pipeIndex:%d", buf, 0x1Eu);
    }
  }
  uint64_t v20 = a1[17];
  uint64_t v21 = a1[18];
...
LABEL_61:
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&unsigned char buf[12] = 1024;
    *(_DWORD *)&buf[14] = 191;
    _os_log_impl(&def_21CC0, v35, OS_LOG_TYPE_INFO, "%25s:%-5d      MIDI-CI negotiation is necessary to determine initial protocol(s).", buf, 0x12u);
  }
  *((unsigned char *)a1 + 188) = 1;
  memset(buf, 0, 24);
  sub_16C2C(buf, (uint64_t *)a1[20], (uint64_t *)a1[21], (uint64_t)(a1[21] - a1[20]) >> 3);
  uint64_t v36 = *(unsigned __int8 **)buf;
  ...
  if (v36 != *(unsigned __int8 **)&buf[8])
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v72[12] = 1024;
      *(_DWORD *)&v72[14] = 197;
      _os_log_impl(&def_21CC0, v37, OS_LOG_TYPE_INFO, "%25s:%-5d      Culling endpoints with known protocols.", v72, 0x12u);
    }
    if (v36 + 8 != *(unsigned __int8 **)&buf[8])
    {
      uint64_t v38 = *(void *)buf;
      char v39 = &v36[-*(void *)buf];
      unint64_t v40 = (*(void *)&buf[8] - (void)v36) & 0xFFFFFFFFFFFFFFF8;
      memmove(v36, v36 + 8, v40 - 8);
      uint64_t v36 = &v39[v38 - 8 + v40];
    }
    *(void *)&buf[8] = v36;
  }
LABEL_73:
  sub_FF28();
  char v41 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&v72[14] = 202;
    ...
    _os_log_impl(&def_21CC0, v41, OS_LOG_TYPE_INFO, "%25s:%-5d      Negotiating protocol for %u endpoint(s)...", v72, 0x18u);
  }
  char v42 = *(unsigned __int8 **)buf;
  if (*(void *)buf != *(void *)&buf[8])
  {
    do
    {
      ...
      {
        if (v42[1]) {
          unsigned __int8 v45 = *v42 | 0x80;
        }
        else {
          unsigned __int8 v45 = *v42;
        }
        while (*(unsigned __int8 *)(v43 + 3) != v45)
        {
          v43 += 8;
          if (v43 == v44) {
            goto LABEL_85;
...
LABEL_85:
        ...
        int v46 = *(unsigned __int8 *)(v43 + 2);
      }
      int v47 = (unsigned char *)a1[17];
      int v48 = (unsigned char *)a1[18];
      if (v47 != v48)
      {
        while (1)
        {
          unsigned __int8 v49 = v47[1] ? *v47 | 0x80 : *v47;
          if (v46 == v49) {
            break;
          }
          v47 += 8;
      ...
      if (v47 != v48)
      {
        ...
        {
          sub_F47C(&v70, a1 + 8);
          sub_18484((uint64_t)&v71, &v70, (unsigned __int8 *)&v69, (uint64_t *)v42);
        }
      }
LABEL_96:
      v42 += 8;
    }
    while (v42 != *(unsigned __int8 **)&buf[8]);
    char v42 = *(unsigned __int8 **)buf;
  }
  if (v42)
  {
...
LABEL_100:
  sub_FF28();
  uint64_t v50 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    uint64_t v51 = (a1[18] - a1[17]) >> 3;
    *(_DWORD *)buf = 136315650;
    *(void *)&uint8_t buf[4] = "USBMIDIDevice.cpp";
    *(_WORD *)&unsigned char buf[12] = 1024;
    *(_DWORD *)&buf[14] = 213;
    *(_WORD *)&unsigned char buf[18] = 1024;
    *(_DWORD *)&buf[20] = v51;
    _os_log_impl(&def_21CC0, v50, OS_LOG_TYPE_INFO, "%25s:%-5d      Priming %d input pipe(s)", buf, 0x18u);
  }
  if (a1[18] != a1[17])
  {
    unint64_t v52 = 0;
    do
    {
      ...
      do
      {
        ...
        *(unsigned char *)(*(void *)(v57 + 16 * v56) + 64) = *(unsigned char *)(v58 + 8 * v52 + 6);
        (*(void (**)(void *))(*a1 + 64))(a1);
        char v54 = 0;
        uint64_t v53 = 1;
      }
    ...
    while (v52 < (uint64_t)(a1[18] - a1[17]) >> 3);
  }
  (*(void (**)(void, void *))(*(void *)a1[10] + 152))(a1[10], a1);
  uint64_t v59 = (uint64_t *)a1[14];
  v60 = (uint64_t *)a1[15];
  if (v59 == v60) {
    goto LABEL_127;
  }
  do
  {
    ...
    {
      sub_FF28();
      unsigned int v61 = qword_30190;
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
      {
        unsigned int v62 = "forcemidi1fallback";
        if (!*((unsigned char *)a1 + 492)) {
          unsigned int v62 = "forcemidi1upfallback";
        }
        *(_DWORD *)buf = 136315650;
        *(void *)&uint8_t buf[4] = "USBMIDIDevice.cpp";
        *(_WORD *)&unsigned char buf[12] = 1024;
        ...
        *(void *)&buf[20] = v62;
        _os_log_impl(&def_21CC0, v61, OS_LOG_TYPE_INFO, "%25s:%-5d [AQAMIDI] %s is set in defaults, so negotiation will be skipped.", buf, 0x1Cu);
      }
      uint64_t v63 = *v59;
      if (*(unsigned char *)(*v59 + 41)) {
        unsigned __int8 v64 = *(unsigned char *)(*v59 + 40) | 0x80;
      }
      else {
        unsigned __int8 v64 = *(unsigned char *)(*v59 + 40);
      }
      int v65 = *(unsigned __int8 *)(v63 + 49);
      unsigned __int8 v66 = *(unsigned char *)(v63 + 48);
      if (v65) {
        v66 |= 0x80u;
      }
      sub_110F8((uint64_t)a1, v64, v66, 255);
    }
    else
    {
      sub_C044(*v59);
...
LABEL_127:
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[28] = 2080;
    v76 = v68;
    _os_log_impl(&def_21CC0, v67, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDevice(%p)::Initialize() = %s", buf, 0x26u);
  }
  return v31;
}

void sub_10EC8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, std::__shared_weak_count *a20,uint64_t a21,uint64_t a22,void *__p,uint64_t a24)
{
  if (a20) {
    sub_81CC(a20);
  }
...
ItemCount sub_10F5C(uint64_t a1)
{
...
void **sub_10FDC(uint64_t *a1, long long *a2)
{
  unint64_t v6 = a1[2];
  ...
  if ((unint64_t)v7 >= v6)
  {
    ...
    v18[4] = result;
    int v14 = (char *)sub_DF24((uint64_t)result, v13);
    BOOL v15 = &v14[16 * v10];
    v18[0] = v14;
    v18[1] = v15;
    v18[3] = &v14[16 * v16];
...
void sub_110E4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_E06C((void **)va);
  _Unwind_Resume(a1);
...
void sub_110F8(uint64_t a1, int a2, int a3, int a4)
{
  if (*(unsigned char *)(a1 + 492))
  {
    *(unsigned char *)(a1 + 188) = 0;
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&v42[6] = a3;
      __int16 v43 = 2080;
      uint64_t v44 = v8;
      _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBMIDIDevice::NegotiationCompleteForEndpoint(inEP: 0x%x, outEP: 0x%x) failed %s", (uint8_t *)&v37, 0x28u);
    }
    int v10 = sub_11710(a1);
    sub_FF28();
    uint64_t v11 = qword_30190;
    BOOL v12 = os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO);
    if (v10)
    {
      if (!v12) {
        return;
  ...
  if (a4 == 255)
  {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v39 = 1024;
        int v40 = 999;
        _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_INFO, "%25s:%-5d * * * [AQAMIDI] Protocol negotiation skipped because of defaults. Forcing MIDI-1UP as default protocol. * * *", (uint8_t *)&v37, 0x12u);
      }
    }
    else
    {
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v39 = 1024;
        int v40 = 1001;
        _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_ERROR, "%25s:%-5d * * * [AQAMIDI] Protocol negotiation timed out. Using MIDI-1UP as default protocol. * * *", (uint8_t *)&v37, 0x12u);
      }
      int v14 = 1;
    }
  }
  sub_FF28();
  uint64_t v20 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    int v37 = 136315906;
    uint64_t v38 = "USBMIDIDevice.cpp";
    ...
    *(_WORD *)&v42[4] = 1024;
    *(_DWORD *)&v42[6] = a3;
    _os_log_impl(&def_21CC0, v20, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIDevice::NegotiationCompleteForEndpoints(inEP: 0x%x, outEP: 0x%x)", (uint8_t *)&v37, 0x1Eu);
  }
...
LABEL_54:
  if (!*(unsigned char *)(a1 + 188))
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v39 = 1024;
      int v40 = 1019;
      _os_log_impl(&def_21CC0, v32, OS_LOG_TYPE_INFO, "%25s:%-5d ============================================", (uint8_t *)&v37, 0x12u);
    }
    sub_FF28();
    uint64_t v33 = qword_30190;
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v41 = 2080;
      *(void *)char v42 = v34;
      _os_log_impl(&def_21CC0, v33, OS_LOG_TYPE_INFO, "%25s:%-5d == [AQAMIDI] Protocol changed to %s ==", (uint8_t *)&v37, 0x1Cu);
    }
    sub_FF28();
    int v35 = qword_30190;
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v39 = 1024;
      int v40 = 1021;
      _os_log_impl(&def_21CC0, v35, OS_LOG_TYPE_INFO, "%25s:%-5d ============================================", (uint8_t *)&v37, 0x12u);
    }
    if (((*(uint64_t (**)(uint64_t))(*(void *)a1 + 48))(a1) & 1) == 0)
    {
      sub_FF28();
      uint64_t v36 = qword_30190;
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
      {
        int v37 = 136315394;
        uint64_t v38 = "USBMIDIDevice.cpp";
        ...
        uint32_t v19 = 18;
LABEL_16:
        _os_log_impl(&def_21CC0, v17, v18, v13, (uint8_t *)&v37, v19);
      }
    }
  }
}
  ...
  *(unsigned char *)(a1 + 491) = 0;
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = "USBMIDIDevice.cpp";
    __int16 v38 = 1024;
    int v39 = 248;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_INFO, "%25s:%-5d * * * [AQAMIDI] MIDI protocol negotiation failed. Falling back to USB MIDI 1.0 configuration * * *", buf, 0x12u);
  }
  int NumberOfEntities = MIDIDeviceGetNumberOfEntities(*(_DWORD *)(a1 + 8));
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = "USBMIDIDevice.cpp";
    __int16 v38 = 1024;
    int v39 = 256;
    _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDevice::InitializeFallback() - probing device", buf, 0x12u);
  }
  sub_1FC38(*(void *)(a1 + 88), *(void *)(a1 + 96), (uint64_t)buf);
  if (*(void *)buf)
  {
    sub_FF28();
    uint64_t v7 = qword_30190;
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v36[12] = 1024;
      *(_DWORD *)&v36[14] = 260;
      _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_INFO, "%25s:%-5d      Creating fallback port map list", v36, 0x12u);
    }
    sub_1FF90(1, (uint64_t)buf, (uint64_t *)v36);
    sub_FF28();
    uint64_t v8 = qword_30190;
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)BOOL v30 = 136315394;
      ...
      __int16 v32 = 1024;
      int v33 = 264;
      _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_INFO, "%25s:%-5d      Setting alternate interface to 0", v30, 0x12u);
    }
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)BOOL v30 = 136315650;
      ...
      __int16 v34 = 1024;
      int v35 = v12;
      _os_log_impl(&def_21CC0, v11, OS_LOG_TYPE_INFO, "%25s:%-5d      Priming %d input pipe(s)", v30, 0x18u);
    }
    ...
    LODWORD(v23) = sub_1FE6C(v23, v22, v24, v25, v26, *(_DWORD *)(a1 + 8), (uint64_t *)v36, (uint64_t *)v40, v41, v42);
    sub_FF28();
    __int16 v27 = qword_30190;
    if (v23)
    {
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)BOOL v30 = 136315394;
        ...
        __int16 v32 = 1024;
        int v33 = 287;
        _os_log_impl(&def_21CC0, v27, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDevice::InitializeFallback() - device configured. Starting I/O.", v30, 0x12u);
      }
    ...
    else
    {
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)BOOL v30 = 136315394;
        ...
        __int16 v32 = 1024;
        int v33 = 290;
        _os_log_impl(&def_21CC0, v27, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBMIDIDevice::InitializeFallback() - could not configure device", v30, 0x12u);
      }
      uint64_t v28 = 0;
    }
    if (*(void *)v36)
...
void sub_11CF0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, void *__p, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19)
{
  if (__p) {
    operator delete(__p);
  }
...
void sub_11D98(uint64_t a1)
{
  ...
  if (!v4)
  {
    ...
    if (!v6)
    {
      sub_FF28();
      uint64_t v7 = qword_30190;
      BOOL v8 = os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_DEBUG);
      ItemCount v4 = source;
      if (v8)
      {
        *(_DWORD *)buf = 136315906;
        ...
        _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] USBMIDIDevice(%p)::RegisterAsyncSource() created CFRunLoopSource %p", buf, 0x26u);
        ItemCount v4 = source;
      }
      goto LABEL_9;
    }
...
LABEL_12:
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315906;
    ...
    _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIDevice(%p)::RegisterAsyncSource() = %s", buf, 0x26u);
  }
}

void sub_11FA0(uint64_t a1)
{
  CFRunLoopRef v2 = MIDIGetDriverIORunLoop();
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2048;
    uint64_t v13 = a1;
    _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIDevice(%p)::UnregisterAsyncSource()", (uint8_t *)&v8, 0x1Cu);
  }
}

uint64_t sub_120CC(uint64_t a1)
{
  sub_FF28();
  CFRunLoopRef v2 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)v7.packet[0].words = a1;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDevice(%p)::StartIO()", (uint8_t *)&v7, 0x1Cu);
  }
  *(void *)(a1 + 48sub_7888(&a9, 0) = MIDITimerTaskCreate();
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)((char *)&v7.packet[0].timeStamp + 6) = 357;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_INFO, "%25s:%-5d      bringing initialized device online...", (uint8_t *)&v7, 0x12u);
  }
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)((char *)&v7.packet[0].timeStamp + 6) = 360;
    HIWORD(v7.packet[0].wordCount) = 2048;
    *(void *)v7.packet[0].words = a1;
    _os_log_impl(&def_21CC0, v5, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDevice(%p)::StartIO() = true", (uint8_t *)&v7, 0x1Cu);
  }
  return 1;
}

unsigned char *sub_12370(uint64_t a1)
{
  uint64_t v3 = a1 + 344;
...
void sub_12404(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
}

void *sub_12418(void *a1)
{
  *a1 = off_2CA10;
  if (!*((unsigned char *)a1 + 184))
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
    {
      ...
      char v4 = "Input";
      *(void *)&void v35[4] = "USBMIDIDevice.cpp";
      ...
      *(_DWORD *)int v35 = 136316162;
      ...
      __int16 v42 = 2080;
      __int16 v43 = v6;
      _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDevice(%p)::~USBMIDIDevice() - Halting I/O chain for: %s and %s", v35, 0x30u);
    }
    ...
    *((unsigned char *)a1 + 184) = 1;
    ...
    while (v7 != v8)
    {
      (*(void (**)(void, void))(*(void *)a1[13] + 224))(a1[13], *(unsigned __int8 *)(v7 + 6));
      v7 += 8;
    }
    uint64_t v9 = a1[17];
    uint64_t v10 = a1[18];
    ...
    do
    {
      ...
      else
      {
        ...
        do
        {
          BOOL v15 = *(unsigned char *)(*(void *)(v14 - 16) + 44) != 0;
          if (*(unsigned char *)(*(void *)(v14 - 16) + 44)) {
            BOOL v16 = 1;
          }
          else {
            BOOL v16 = v14 == v12;
...
LABEL_34:
    ...
    if ((v18 & 1) != 0 || v19)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)int v35 = 136316162;
        ...
        __int16 v42 = 2080;
        __int16 v43 = v22;
        _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBMIDIDevice(%p)::~USBMIDIDevice() Input:%s Output:%s", v35, 0x30u);
      }
    }
    sub_E148(a1 + 34);
    sub_E148(a1 + 37);
  ...
  sub_FF28();
  CFStringRef v26 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)int v35 = 136315650;
    *(void *)&void v35[4] = "USBMIDIDevice.cpp";
    __int16 v36 = 1024;
    int v37 = 431;
    __int16 v38 = 2048;
    int v39 = a1;
    _os_log_impl(&def_21CC0, v26, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDevice(%p)::~USBMIDIDevice()", v35, 0x1Cu);
  }
  *(void *)int v35 = a1 + 57;
  sub_16A80((void ***)v35);
  sub_16B78(a1 + 54);
  sub_56A0((uint64_t)(a1 + 43));
  *(void *)int v35 = a1 + 40;
  sub_E0F4((void ***)v35);
  *(void *)int v35 = a1 + 37;
  sub_E0F4((void ***)v35);
  *(void *)int v35 = a1 + 34;
  sub_E0F4((void ***)v35);
  __int16 v27 = (std::__shared_weak_count *)a1[33];
  if (v27) {
    sub_81CC(v27);
  }
  uint64_t v28 = (std::__shared_weak_count *)a1[31];
  if (v28) {
    sub_81CC(v28);
  }
  __int16 v29 = (std::__shared_weak_count *)a1[29];
  if (v29) {
    sub_81CC(v29);
  }
  BOOL v30 = (void *)a1[24];
  ...
  *(void *)int v35 = a1 + 14;
  sub_E0F4((void ***)v35);
  int v33 = (std::__shared_weak_count *)a1[9];
  if (v33) {
...
void sub_1296C(_Unwind_Exception *a1, int a2)
{
  if (!a2) {
    _Unwind_Resume(a1);
  }
...
void sub_129C8(uint64_t a1, int a2)
{
  if (*(unsigned char *)(a1 + 491))
  {
    *(_DWORD *)(a1 + 12) = MIDIDeviceGetNumberOfEntities(*(_DWORD *)(a1 + 8));
    MIDIDeviceRef v4 = *(_DWORD *)(a1 + 8);
    sub_4250(a2, (void *)a1, v4, (void *)(a1 + 192), a1 + 16, (char **)(a1 + 40));
  }
  else
  {
    sub_8468(a1, a2);
...
void sub_12A4C(uint64_t a1)
{
}

void sub_12A64(uint64_t a1, uint64_t a2, unsigned __int8 **a3, void **a4, void **a5)
{
    ...
    if (v9)
    {
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v62 = 1024;
        int v63 = v9;
        _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBMIDIDevice::FindPipes: failed (0x%x)", buf, 0x18u);
      }
    }
    else
    {
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v62 = 1024;
        int v63 = v57;
        _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIDevice::FindPipes() -- interface has %d endpoints", buf, 0x18u);
      }
      if (v57)
      {
        int v11 = 1;
        ...
        while (1)
        {
          WORD2(v56) = 0;
          BYTE6(v56) = -1;
          int v13 = sub_A0F8(a1, v11, (uint64_t)&v56);
          sub_FF28();
          uint64_t v14 = qword_30190;
          BOOL v15 = os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_INFO);
          if (v13) {
            break;
          }
          if (v15)
          {
            *(_DWORD *)buf = 136315906;
            ...
            __int16 v64 = 1024;
            int v65 = BYTE1(v56);
            _os_log_impl(&def_21CC0, v14, OS_LOG_TYPE_INFO, "%25s:%-5d      Got pipe 0x%x direction %d", buf, 0x1Eu);
          }
...
LABEL_24:
                _os_log_impl(&def_21CC0, v20, OS_LOG_TYPE_INFO, v21, buf, 0x24u);
                goto LABEL_25;
              }
              goto LABEL_25;
            }
...
LABEL_25:
          if (BYTE1(v56) == 1)
          {
            ...
            if ((unint64_t)v26 >= v25)
            {
              ...
              if (v42) {
                __int16 v43 = (char *)sub_16CE4((uint64_t)(a4 + 2), v42);
              }
              else {
                __int16 v43 = 0;
              }
          ...
          if (!BYTE1(v56))
          {
            ...
            if ((unint64_t)v23 >= v22)
            {
              ...
              if (v37) {
                __int16 v38 = (char *)sub_16CE4((uint64_t)(a5 + 2), v37);
              }
              else {
                __int16 v38 = 0;
              }
...
LABEL_33:
            _os_log_impl(&def_21CC0, v29, OS_LOG_TYPE_INFO, v30, buf, 0x1Eu);
          }
LABEL_83:
          int v11 = ++v12;
          if (v12 > v57) {
...
unsigned char *sub_132AC(void *a1, int *a2, int a3)
{
  ...
  if (result)
  {
    ...
    else
    {
      ...
      do
      {
        ...
        *(_OWORD *)(v15 + 72) = v16;
        long long v17 = v32;
        *(_OWORD *)(v15 + 4sub_7888(&a9, 0) = __dst;
        *((void *)v15 + 1) = a1 + 54;
        *((void *)v15 + 2) = v11;
        *((_DWORD *)v15 + 6) = v12;
        *((_DWORD *)v15 + 7) = 0;
    ...
    uint64_t v24 = (unsigned __int8 *)(v20 + 6);
    while (1)
    {
      int v25 = *v24;
      v24 += 8;
...
LABEL_18:
    ...
    return sub_16F08(&v29);
  }
  return result;
}

void sub_1357C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_16F08(va);
  _Unwind_Resume(a1);
...
unsigned __int8 *sub_13598(void *a1, int a2)
{
  uint64_t v2 = a1[24];
...
unsigned __int8 *sub_13610(uint64_t a1, int *a2, int a3)
{
  ItemCount result = (unsigned __int8 *)(*(uint64_t (**)(uint64_t))(*(void *)a1 + 112))(a1);
  if (!result) {
    return result;
  }
  ItemCount result = sub_13598((void *)a1, a3);
  int v7 = result[7];
  if (!result[7])
  {
    if (a3 == 255) {
...
LABEL_48:
  ...
  if (v24)
  {
    ...
    do
    {
      ...
      sub_16F60((uint64_t)buf, v25, a3, v22, v23);
      unint64_t v26 = *(void *)(a1 + 464);
      if (v26 >= *(void *)(a1 + 472))
      {
        uint64_t v29 = sub_171D8((uint64_t *)(a1 + 456), (uint64_t)buf);
      }
      else
      {
        uint64_t v27 = sub_1730C(v26, (unsigned int *)buf);
        uint64_t v28 = v47[0];
        *(void *)(v27 + 285) = *(void *)((char *)v47 + 5);
        *(void *)(v27 + 28sub_7888(&a9, 0) = v28;
        uint64_t v29 = v27 + 296;
      }
      *(void *)(a1 + 464) = v29;
      sub_17558(v29 - 296);
      sub_16B04((uint64_t)buf);
      v25 += v25[2] + 3;
      --v24;
    }
    while (v24);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v45 = 1024;
      int v46 = 629;
      _os_log_impl(&def_21CC0, v40, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBMIDIDevice::SendPackets() - buffer not found", buf, 0x12u);
    }
  }
  return sub_16F08(&v41);
}

void sub_13A20(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
}

uint64_t sub_13A48(uint64_t a1, uint64_t a2)
{
  atomic_fetch_add((atomic_uint *volatile)(a2 + 8), 1u);
  *(unsigned char *)(a2 + 44) = 1;
  uint64_t result = (*(uint64_t (**)(void, void, void, void, void (*)(uint64_t, int, unint64_t), uint64_t))(**(void **)(a1 + 104) + 264))(*(void *)(a1 + 104), *(unsigned __int8 *)(a2 + 64), *(void *)(a2 + 24), *(unsigned int *)(a2 + 40), sub_13B20, a2);
...
void sub_13B20(uint64_t a1, int a2, unint64_t a3)
{
...
LABEL_21:
        ...
        if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 136315650;
          ...
          __int16 v20 = 1024;
          int v21 = v11;
          _os_log_impl(&def_21CC0, v14, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] No negotiator for pipeIndex %d", buf, 0x18u);
        }
      }
      else
      {
...
void sub_13D80(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_13DA0((atomic_uint **)va);
  sub_81CC(v2);
  _Unwind_Resume(a1);
}

atomic_uint **sub_13DA0(atomic_uint **a1)
{
  uint64_t v2 = *a1;
  if (atomic_fetch_add(v2 + 2, 0xFFFFFFFF) == 1) {
    (*(void (**)(atomic_uint *))(*(void *)v2 + 16))(v2);
...
void sub_13E04(uint64_t a1)
{
  ...
  uint64_t v5 = *v3;
  unsigned __int8 v6 = sub_1324C((void *)a1, *v3);
...
LABEL_12:
  ...
  if (!v15)
  {
    ...
    uint32_t v24 = 24;
LABEL_37:
    _os_log_impl(&def_21CC0, v23, OS_LOG_TYPE_ERROR, v22, (uint8_t *)&v31, v24);
    return;
  }
...
LABEL_35:
  ...
  *(unsigned char *)(v15 + 44) = 1;
  int v27 = (*(uint64_t (**)(void, uint64_t, void, uint64_t, void (*)(uint64_t, int), uint64_t))(**(void **)(a1 + 104) + 272))(*(void *)(a1 + 104), v5, *(void *)(v15 + 24), v20, sub_1415C, v15);
...
void sub_1415C(uint64_t a1, int a2)
{
...
void sub_142D0(_Unwind_Exception *a1)
{
  sub_81CC(v1);
  _Unwind_Resume(a1);
}

void sub_14300(uint64_t a1, int a2)
{
  sub_FF28();
  uint64_t v3 = qword_30190;
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_DEBUG))
  {
    int v4 = "false";
    *(_DWORD *)buf = 136315650;
    ...
    *(void *)uint64_t v28 = v4;
    _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] USBMIDIDevice::ReconstructPortMapList(forUMP = %s)", buf, 0x1Cu);
  }
  *(void *)(a1 + 20sub_7888(&a9, 0) = *(void *)(a1 + 192);
    ...
    do
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)&v28[6] = v8;
        ...
        __int16 v37 = 1024;
        int v38 = v14;
        _os_log_impl(&def_21CC0, v15, OS_LOG_TYPE_DEBUG, "%25s:%-5d      MIDIPortMap(entity %d, cable %d, inEP 0x%x, outEP 0x%x, protocol %d, gtbID %d, numGroups %d => mMapList", buf, 0x3Cu);
      }
      buf[0] = v6;
      buf[1] = v8;
      buf[2] = v9;
      ...
      {
        uint64_t v17 = sub_17604((uint64_t *)(a1 + 192), buf);
      }
      else
      {
  ...
  if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)uint64_t v28 = v19;
    _os_log_impl(&def_21CC0, v18, OS_LOG_TYPE_DEBUG, "%25s:%-5d [-] USBMIDIDevice::ReconstructPortMapList() - %lu port map(s) created", buf, 0x1Cu);
  }
}

BOOL sub_146F0(uint64_t a1)
{
  return *(void *)(a1 + 136) != *(void *)(a1 + 144);
}

BOOL sub_14700(uint64_t a1)
{
  return *(void *)(a1 + 160) != *(void *)(a1 + 168);
}

void *sub_14710(void *a1, uint64_t *a2)
{
  uint64_t v3 = *a2;
  *a2 = (uint64_t)&off_2CAC0;
  *a1 = off_2CAA0;
  a1[1] = v3;
  (*(void (**)(void *, uint64_t *))(v3 + 16))(a1 + 2, a2 + 1);
  bzero(a1 + 8, 0x300uLL);
...
uint64_t sub_14840(uint64_t a1, _DWORD *a2)
{
  if (*a2 == 2)
  {
    ...
    v5[1] = &v7;
    ItemCount v6 = v5;
    sub_14AB4((uint64_t)a2, &v6);
    return sub_152AC((uint64_t)&v7);
  }
  else
  {
    if (*a2 != 1) {
...
void sub_14924(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_152AC((uint64_t)va);
  _Unwind_Resume(a1);
}

uint64_t sub_14940(uint64_t a1, uint64_t a2)
{
  ...
  sub_15320(a2, &v4);
  sub_152AC((uint64_t)&v7);
  return (*(uint64_t (**)(unsigned char *))(v5 + 24))(v6);
}

void sub_14A14(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, char a18)
{
  if (a2) {
    sub_5054(exception_object);
  }
...
uint64_t sub_14AB4(uint64_t result, uint64_t **a2)
{
  if (*(_DWORD *)(result + 4))
  {
    uint64_t v3 = result;
    ...
    do
    {
      ...
      if (result)
      {
        do
        {
          ...
          v13[0] = v7[1];
          v13[1] = &v14;
          sub_14B90((unsigned int *)(v8 + 64), (int *)&v9, (uint64_t)v13);
          uint64_t v10 = 0;
          uint64_t v11 = 0;
          uint64_t v9 = 0;
          uint64_t result = sub_71A8(v12, &v11, &v9);
...
unsigned int *sub_14B90(unsigned int *result, int *__src, uint64_t a3)
{
  unint64_t v3 = *__src;
  if (((1 << (v3 >> 28)) & 0xA02F) != 0)
  {
    ...
    switch(BYTE2(v3) >> 4)
    {
      ...
      case 3:
        ...
        *(void *)char __srca = v20 | v21 | v15;
        sub_14EF0(*(unsigned int **)a3, **(void **)(a3 + 8), (int *)__srca);
        int v29 = 0;
        *(_DWORD *)&__srca[8] = 0;
...
LABEL_22:
        ...
        *(void *)char __srca = v20 | (v9 >> 25) | 0x600;
        uint64_t result = sub_14EF0(*(unsigned int **)a3, **(void **)(a3 + 8), (int *)__srca);
        if (v17)
        {
          int v29 = 0;
          *(void *)&__srca[4] = 0;
...
LABEL_30:
        *(_DWORD *)char __srca = v11;
        return sub_14EF0(*(unsigned int **)a3, **(void **)(a3 + 8), (int *)__srca);
      default:
        return result;
    }
  }
...
unsigned int *sub_14EF0(unsigned int *result, uint64_t a2, int *__src)
{
  unint64_t v3 = result;
  unint64_t v4 = *__src;
  uint64_t v5 = byte_270E8[v4 >> 28];
...
LABEL_38:
          uint64_t result = (unsigned int *)sub_150DC((uint64_t)result, a2, __src, v5);
          uint64_t v6 = result;
          goto LABEL_47;
        }
      }
...
uint64_t sub_150DC(uint64_t a1, uint64_t a2, int *a3, uint64_t a4)
{
  if (!*(_DWORD *)(a1 + 68)) {
    goto LABEL_4;
  }
...
LABEL_12:
    ...
    *(_DWORD *)(a1 + 8sub_7888(&a9, 0) = v12 + a4;
  }
  else
  {
LABEL_4:
...
void sub_15274(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void (*a11)(void))
{
  if (a10) {
    a11();
  }
...
uint64_t sub_152AC(uint64_t a1)
{
  if (*(_DWORD *)(a1 + 68))
  {
    uint64_t v3 = a1 + 64;
...
uint64_t sub_15320(uint64_t result, unsigned int **a2)
{
  if (*(_DWORD *)result)
  {
    ...
    do
    {
      ...
      *(void *)uint64_t v9 = 0;
      uint64_t __src = 0;
      uint64_t result = sub_153E0(v10, v9, &__src);
      if (result)
      {
        do
        {
          sub_14EF0(*a2, *(uint64_t *)v9, (int *)&__src);
          uint64_t v8 = 0;
          *(void *)uint64_t v9 = 0;
          uint64_t __src = 0;
          uint64_t result = sub_153E0(v10, v9, &__src);
...
uint64_t sub_153E0(uint64_t *a1, void *a2, _DWORD *a3)
{
  unint64_t v3 = a1[1];
  unint64_t v4 = a1[3];
  if (v4 >= v3) {
...
LABEL_42:
  ...
  uint64_t v14 = byte_30070[v6 - 240];
  if (!byte_30070[v6 - 240])
  {
    unint64_t v15 = v4;
    while (1)
    {
...
void *sub_15644(void *a1, uint64_t *a2)
{
  uint64_t v3 = *a2;
  *a2 = (uint64_t)&off_2CAC0;
  *a1 = off_2CAF8;
...
uint64_t sub_15774(uint64_t a1, _DWORD *a2)
{
  if (*a2 == 2)
  {
    BOOL v10 = a2;
  ...
  else
  {
    ...
    uint64_t v7 = &v10;
    BOOL v9 = &v5;
    sub_15AEC((uint64_t)a2, &v9);
    uint64_t v5 = (uint64_t *)&v10;
    unsigned int v6 = &v8;
    sub_1596C((unsigned int *)(a1 + 64), (uint64_t)&v5);
    return sub_152AC((uint64_t)&v10);
  }
}

void sub_15880(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_152AC((uint64_t)va);
  _Unwind_Resume(a1);
...
uint64_t sub_158A0(uint64_t a1, uint64_t a2)
{
...
void sub_15950(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_152AC((uint64_t)va);
  _Unwind_Resume(a1);
...
unsigned int *sub_1596C(unsigned int *result, uint64_t a2)
{
  uint64_t v3 = result;
  unint64_t v4 = *result;
  ...
  {
    LODWORD(v2sub_7888(&a9, 0) = BYTE3(v4) & 0xF;
    if (v5 == 15) {
      uint64_t v20 = 255;
    }
    else {
  ...
  if (BYTE2(v4))
  {
    ...
    uint64_t result = sub_14EF0(*(unsigned int **)a2, **(void **)(a2 + 8), &v21);
    *uint64_t v3 = 0;
  }
...
uint64_t sub_15AEC(uint64_t result, void **a2)
{
  if (*(_DWORD *)(result + 4))
  {
    uint64_t v3 = result;
    ...
    do
    {
      ...
      uint64_t v12 = 0;
      uint64_t __src = 0;
      uint64_t result = sub_71A8(v13, &v12, &__src);
      if (result)
      {
        do
        {
          ...
          *int v9 = v12;
          v14[0] = v7[2];
          v14[1] = v9;
          sub_15BC0(v8 + 64, (unsigned int *)&__src, (uint64_t)v14);
          uint64_t v11 = 0;
          uint64_t v12 = 0;
          uint64_t __src = 0;
          uint64_t result = sub_71A8(v13, &v12, &__src);
...
void sub_15BC0(uint64_t a1, unsigned int *__src, uint64_t a3)
{
...
LABEL_40:
        ...
        *(void *)(a1 + 24) = 0;
LABEL_75:
        sub_14EF0(*(unsigned int **)a3, **(void **)(a3 + 8), (int *)&v56 + 1);
        break;
      case 0xCu:
  ...
  else
  {
    ...
    sub_14EF0(v23, v24, (int *)__src);
  }
}

__n128 sub_160DC(unsigned int **a1)
{
  uint64_t v1 = *a1;
  if (!*((unsigned char *)*a1 + 32))
  {
...
uint64_t sub_162B0(uint64_t result, uint64_t **a2)
{
  if (*(_DWORD *)result)
  {
    ...
    do
    {
      ...
      uint64_t v11 = 0;
      uint64_t v9 = 0;
      __n128 result = sub_153E0(v12, &v11, &v9);
      if (result)
      {
        do
        {
          ...
          v13[0] = v7[1];
          v13[1] = &v14;
          sub_16390(v8 + 64, (unsigned int *)&v9, (uint64_t)v13);
          uint64_t v10 = 0;
          uint64_t v11 = 0;
          uint64_t v9 = 0;
          __n128 result = sub_153E0(v12, &v11, &v9);
...
void sub_16390(uint64_t a1, unsigned int *__src, uint64_t a3)
{
  unsigned int v5 = *__src;
  if (*__src >> 28 == 2)
  {
...
__n128 sub_168AC(unsigned int **a1)
{
  uint64_t v1 = *a1;
  if (!*((unsigned char *)*a1 + 32))
  {
...
uint64_t sub_16B04(uint64_t a1)
{
  uint64_t v2 = *(unsigned int *)(a1 + 272);
  if (v2 != -1) {
    ((void (*)(char *, uint64_t))off_2CB18[v2])(&v4, a1);
  }
  *(_DWORD *)(a1 + 272) = -1;
  return a1;
}

void sub_16B64(uint64_t a1, uint64_t a2)
{
  uint64_t v2 = *(void **)a2;
  if (*(void *)a2)
  {
...
char *sub_16C2C(char *result, uint64_t *a2, uint64_t *a3, unint64_t a4)
{
  if (a4)
  {
    int v6 = result;
    __n128 result = sub_16CA0(result, a4);
...
void sub_16C84(_Unwind_Exception *exception_object)
{
  uint64_t v3 = *(void **)v1;
  if (*(void *)v1)
  {
...
char *sub_16CA0(void *a1, unint64_t a2)
{
  if (a2 >> 61) {
    sub_47B8();
  }
  __n128 result = (char *)sub_16CE4((uint64_t)(a1 + 2), a2);
  *a1 = result;
  a1[1] = result;
  a1[2] = &result[8 * v4];
  return result;
...
void *sub_16CE4(uint64_t a1, unint64_t a2)
{
  if (a2 >> 61) {
    sub_4898();
  }
...
uint64_t sub_16D1C(uint64_t *a1, void *a2)
{
  uint64_t result = sub_16D94((uint64_t)(a1 + 2), a1[1], (void *)a1[1], *a1, (void *)*a1, a2[1], a2[1]);
  a2[1] = v5;
  uint64_t v6 = *a1;
  *a1 = v5;
  a2[1] = v6;
...
uint64_t sub_16D94(uint64_t a1, uint64_t a2, void *a3, uint64_t a4, void *a5, uint64_t a6, uint64_t a7)
{
  uint64_t v7 = a7;
  *(void *)&long long v15 = a6;
  *((void *)&v15 + 1) = a7;
  ...
  char v13 = 1;
  sub_16E28((uint64_t)v12);
  return v10;
}

uint64_t sub_16E28(uint64_t a1)
{
  if (!*(unsigned char *)(a1 + 24)) {
    sub_E028(a1);
  }
...
void sub_16E78(const char *a1)
{
  exception = (std::logic_error *)__cxa_allocate_exception(0x10uLL);
  sub_16ED4(exception, a1);
}
...
std::logic_error *sub_16ED4(std::logic_error *a1, const char *a2)
{
  uint64_t result = std::logic_error::logic_error(a1, a2);
  return result;
}

unsigned char *sub_16F08(unsigned char *a1)
{
  if (a1[8]) {
...
uint64_t sub_16F60(uint64_t a1, unsigned int *a2, int a3, int a4, char a5)
{
  *(_OWORD *)(a1 + 252) = 0u;
  *(_OWORD *)(a1 + 224) = 0u;
  *(_OWORD *)(a1 + 24sub_7888(&a9, 0) = 0u;
  ...
  *(_OWORD *)(a1 + 112) = 0u;
  *(_OWORD *)(a1 + 64) = 0u;
  *(_OWORD *)(a1 + 8sub_7888(&a9, 0) = 0u;
  *(_OWORD *)(a1 + 32) = 0u;
  *(_OWORD *)(a1 + 48) = 0u;
  *(_OWORD *)a1 = 0u;
  *(_OWORD *)(a1 + 16) = 0u;
  *(_DWORD *)(a1 + 272) = 0;
  *(_DWORD *)(a1 + 28sub_7888(&a9, 0) = a3;
  *(_DWORD *)(a1 + 284) = a4;
  *(_DWORD *)(a1 + 288) = 0;
  *(unsigned char *)(a1 + 292) = a5;
  ...
  if (v7 <= 0x40)
  {
    long long v9 = (void *)sub_17030(a1);
LABEL_5:
    memmove(v9, a2, v8);
    return a1;
  }
  uint64_t v10 = (void **)sub_170B0(a1, &v12);
  size_t v8 = v12;
  if (v12)
  {
    long long v9 = *v10;
...
void sub_1701C(_Unwind_Exception *a1)
{
  sub_16B04(v1);
  _Unwind_Resume(a1);
}
...
void *sub_170B0(uint64_t a1, size_t *a2)
{
  uint64_t v4 = *(unsigned int *)(a1 + 272);
  if (v4 != -1) {
    ((void (*)(char *, uint64_t))off_2CB18[v4])(&v6, a1);
  }
  *(_DWORD *)(a1 + 272) = -1;
  uint64_t result = sub_17120((void *)a1, *a2);
  *(_DWORD *)(a1 + 272) = 1;
  return result;
}

void *sub_17120(void *a1, size_t a2)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
void sub_17178(_Unwind_Exception *exception_object)
{
  uint64_t v3 = *(void **)v1;
  if (*(void *)v1)
  {
...
char *sub_17194(void *a1, size_t __sz)
{
  if ((__sz & 0x8000000000000000) != 0) {
    sub_47B8();
  }
...
uint64_t sub_171D8(uint64_t *a1, uint64_t a2)
{
  uint64_t v3 = *a1;
  ...
  v15[4] = a1 + 2;
  if (v9) {
    uint64_t v10 = (char *)sub_174BC(v7, v9);
  }
  else {
    uint64_t v10 = 0;
  }
  ...
  v15[1] = v11;
  v15[3] = &v10[296 * v9];
  sub_1730C(v11, (unsigned int *)a2);
  uint64_t v12 = *(void *)(a2 + 280);
  *(void *)(v11 + 285) = *(void *)(a2 + 285);
  *(void *)(v11 + 28sub_7888(&a9, 0) = v12;
  v15[2] = v11 + 296;
  sub_17408(a1, v15);
  uint64_t v13 = a1[1];
  sub_17508((uint64_t)v15);
  return v13;
}

void sub_172F8(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_17508((uint64_t)va);
  _Unwind_Resume(a1);
}

uint64_t sub_1730C(uint64_t a1, unsigned int *a2)
{
  *(unsigned char *)a1 = 0;
  *(_DWORD *)(a1 + 272) = -1;
  sub_17344(a1, a2);
...
uint64_t sub_17344(uint64_t result, unsigned int *a2)
{
  uint64_t v3 = (_DWORD *)result;
  uint64_t v4 = *(unsigned int *)(result + 272);
  if (v4 != -1) {
    uint64_t result = ((uint64_t (*)(char *, uint64_t))off_2CB18[v4])(&v7, result);
  }
  v3[68] = -1;
  uint64_t v5 = a2[68];
  if (v5 != -1)
  {
    uint64_t result = (*(&off_2CB40 + v5))((int)&v6, v3, a2);
    v3[68] = v5;
  }
  return result;
}

void *sub_173D4(int a1, void *__dst, void *__src)
{
  return memcpy(__dst, __src, 0x10CuLL);
}

__n128 sub_173E4(uint64_t a1, __n128 *a2, __n128 *a3)
{
  a2->n128_u64[0] = 0;
  a2->n128_u64[1] = 0;
  a2[1].n128_u64[0] = 0;
...
uint64_t sub_17408(uint64_t *a1, void *a2)
{
  uint64_t v4 = *a1;
  uint64_t v5 = a1[1];
  uint64_t v6 = a2[1];
  ...
  else
  {
    do
    {
      uint64_t result = sub_1730C(v6 - 296, (unsigned int *)(v5 - 296));
...
void *sub_174BC(uint64_t a1, unint64_t a2)
{
...
uint64_t sub_17508(uint64_t a1)
{
  uint64_t v3 = *(void *)(a1 + 8);
  for (uint64_t i = *(void *)(a1 + 16); i != v3; uint64_t i = *(void *)(a1 + 16))
  {
...
uint64_t sub_17558(uint64_t a1)
{
  ...
  uint64_t v4 = &v3;
  return ((uint64_t (*)(char **, uint64_t))off_2CB68[v1])(&v4, a1);
}
...
uint64_t sub_175F4(uint64_t a1, uint64_t a2)
{
  return a2;
}

uint64_t sub_175FC(uint64_t a1, uint64_t a2)
{
  return *(void *)a2;
}

uint64_t sub_17604(uint64_t *a1, void *a2)
{
  uint64_t v3 = *a1;
  ...
  BOOL v19 = a1 + 2;
  uint64_t v10 = (char *)sub_16CE4(v7, v9);
...
void sub_176E4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, uint64_t a12)
{
  if (__p) {
    operator delete(__p);
  }
...
void sub_1771C(uint64_t *a1, void *a2)
{
  sub_17794((uint64_t)(a1 + 2), a1[1], a1[1], *a1, *a1, a2[1], a2[1]);
  a2[1] = v4;
  uint64_t v5 = *a1;
  *a1 = v4;
  a2[1] = v5;
...
double sub_17794(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  uint64_t v7 = a7;
  if (a3 != a5)
  {
...
uint64_t sub_177C0(uint64_t a1, uint64_t a2)
{
  uint64_t v3 = *(void *)(a2 + 24);
  if (v3)
  {
...
void *sub_17900(uint64_t a1)
{
  uint64_t v2 = operator new(0x30uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *v2 = off_2CB88;
  v2[1] = v3;
  sub_177C0((uint64_t)(v2 + 2), a1 + 16);
  return v2;
}

void sub_17958(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

uint64_t sub_1796C(uint64_t a1, void *a2)
{
  uint64_t v2 = *(void *)(a1 + 8);
  *a2 = off_2CB88;
  a2[1] = v2;
  return sub_177C0((uint64_t)(a2 + 2), a1 + 16);
}

void *sub_1799C(uint64_t a1)
{
  return sub_17B20((void *)(a1 + 16));
}

void sub_179A4(void *a1)
{
  sub_17B20(a1 + 2);
...
BOOL sub_179E0(uint64_t a1, uint64_t *a2)
{
  return sub_17A68((uint64_t (**)(uint64_t, char *))(a1 + 8), a2);
}

uint64_t sub_179E8(uint64_t a1, uint64_t a2)
{
  uint64_t v3 = (void *)(a2 + 24);
  uint64_t v4 = *(void *)(a2 + 24);
  if (v4)
...
BOOL sub_17A68(uint64_t (**a1)(uint64_t, char *), uint64_t *a2)
{
  uint64_t v3 = *a2;
  char v6 = 0;
  ...
  sub_17ACC((uint64_t)(a1 + 1), v4);
  return v6 != 0;
}

uint64_t sub_17ACC(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = a2;
  uint64_t v2 = *(void *)(a1 + 24);
  if (!v2) {
...
uint64_t sub_17BA4(uint64_t a1, uint64_t a2)
{
  uint64_t v3 = *(void *)(a2 + 24);
  if (v3)
  {
...
void *sub_17CE4(uint64_t a1)
{
  uint64_t v2 = operator new(0x30uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *v2 = off_2CBD0;
  v2[1] = v3;
  sub_17BA4((uint64_t)(v2 + 2), a1 + 16);
  return v2;
}

void sub_17D3C(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

uint64_t sub_17D50(uint64_t a1, void *a2)
{
  uint64_t v2 = *(void *)(a1 + 8);
  *a2 = off_2CBD0;
  a2[1] = v2;
  return sub_17BA4((uint64_t)(a2 + 2), a1 + 16);
}

void *sub_17D80(uint64_t a1)
{
  return sub_17F04((void *)(a1 + 16));
}

void sub_17D88(void *a1)
{
  sub_17F04(a1 + 2);
...
BOOL sub_17DC4(uint64_t a1, uint64_t *a2)
{
  return sub_17E4C((uint64_t (**)(uint64_t, char *))(a1 + 8), a2);
}

uint64_t sub_17DCC(uint64_t a1, uint64_t a2)
{
  uint64_t v3 = (void *)(a2 + 24);
  uint64_t v4 = *(void *)(a2 + 24);
  if (v4)
...
BOOL sub_17E4C(uint64_t (**a1)(uint64_t, char *), uint64_t *a2)
{
  uint64_t v3 = *a2;
  char v6 = 0;
  char v4 = (*a1)(v3, &v6);
  ...
  sub_17EB0((uint64_t)(a1 + 1), v4);
  return v6 != 0;
}

uint64_t sub_17EB0(uint64_t a1, char a2)
{
  char v4 = a2;
  uint64_t v2 = *(void *)(a1 + 24);
  if (!v2) {
...
void *sub_17FA0()
{
  ...
  void *result = off_2CC18;
  return result;
}

void sub_17FD8(uint64_t a1, void *a2)
{
  *a2 = off_2CC18;
}

void sub_18000(uint64_t a1, uint64_t *a2)
{
  uint64_t v2 = *a2;
  sub_FF28();
  if (v2)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_30190, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v8 = 1024;
      int v9 = v2;
      _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_DEBUG, "%25s:%-5d =====> NOTICE: USB I/O destructive tracing at level %d <=====", (uint8_t *)&v4, 0x18u);
    }
  }
}
...
void *sub_180E4(uint64_t a1)
{
  double result = operator new(0x10uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *result = off_2CC60;
  result[1] = v3;
  return result;
}

uint64_t sub_1812C(uint64_t result, void *a2)
{
...
uint64_t sub_18158(uint64_t result, unsigned char *a2)
{
...
void *sub_18180(uint64_t a1)
{
  double result = operator new(0x10uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *result = off_2CCA8;
  result[1] = v3;
  return result;
}

uint64_t sub_181C8(uint64_t result, void *a2)
{
  uint64_t v2 = *(void *)(result + 8);
  *a2 = off_2CCA8;
  a2[1] = v2;
...
uint64_t sub_181F4(uint64_t result, unsigned char *a2)
{
...
void *sub_1821C(uint64_t a1)
{
  double result = operator new(0x10uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *result = off_2CCF0;
  result[1] = v3;
  return result;
}

uint64_t sub_18264(uint64_t result, void *a2)
{
  uint64_t v2 = *(void *)(result + 8);
  *a2 = off_2CCF0;
  a2[1] = v2;
...
uint64_t sub_18290(uint64_t result, unsigned char *a2)
{
  *(unsigned char *)(*(void *)(result + 8) + 49sub_7888(&a9, 0) = *a2;
  return result;
}

uint64_t sub_182A0(void *a1, void *a2)
{
  return (*(uint64_t (**)(void, void, void))(*(void *)*a1 + 88))(*a1, *a2, *(unsigned int *)(*a1 + 220));
}

void *sub_182D0(void *result, void *a2)
{
  void *result = *a2;
  return result;
}

void *sub_182DC(void *result, void *a2)
{
  void *result = *a2;
  return result;
}

uint64_t sub_182EC(void *a1, void *a2)
{
  return (*(uint64_t (**)(void, void, void))(*(void *)*a1 + 96))(*a1, *a2, *(unsigned int *)(*a1 + 220));
}

void *sub_1831C(void *result, void *a2)
{
  void *result = *a2;
  return result;
}

void *sub_18328(void *result, void *a2)
{
  void *result = *a2;
  return result;
}

void sub_18338(uint64_t a1, uint64_t *a2, void *a3)
{
  uint64_t v5 = operator new(0x60uLL);
  sub_183AC(v5, a2, a3);
}

void sub_18398(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

void sub_183AC(void *a1, uint64_t *a2, void *a3)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2C8E8;
  sub_18408((uint64_t)(a1 + 3), a2, a3);
}

void sub_183F4(_Unwind_Exception *a1)
{
  std::__shared_weak_count::~__shared_weak_count(v1);
  _Unwind_Resume(a1);
}

void sub_18408(uint64_t a1, uint64_t *a2, void *a3)
{
  uint64_t v3 = *a2;
  uint64_t v4 = a3[1];
  v5[0] = *a3;
...
void sub_1846C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10) {
    std::__shared_weak_count::__release_weak(a10);
  }
...
void sub_18484(uint64_t a1, long long *a2, unsigned __int8 *a3, uint64_t *a4)
{
  int v7 = operator new(0x168uLL);
  sub_18510(v7, a2, a3, a4);
}

void sub_184FC(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

void sub_18510(void *a1, long long *a2, unsigned __int8 *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2CD88;
  sub_185EC((uint64_t)(a1 + 3), a2, a3, a4);
}

void sub_18558(_Unwind_Exception *a1)
{
  std::__shared_weak_count::~__shared_weak_count(v1);
  _Unwind_Resume(a1);
}

void sub_1856C(std::__shared_weak_count *this)
{
  this->__vftable = (std::__shared_weak_count_vtbl *)off_2CD88;
  std::__shared_weak_count::~__shared_weak_count(this);
}

void sub_1858C(std::__shared_weak_count *a1)
{
  a1->__vftable = (std::__shared_weak_count_vtbl *)off_2CD88;
  std::__shared_weak_count::~__shared_weak_count(a1);
...
{
  return sub_C040(a1 + 24);
}

void sub_185EC(uint64_t a1, long long *a2, unsigned __int8 *a3, uint64_t *a4)
{
  long long v4 = *a2;
  *(void *)a2 = 0;
  *((void *)a2 + 1) = 0;
  sub_BE74(a1, &v4, a3, a4);
}

void sub_18638(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10) {
    sub_81CC(a10);
  }
...
void sub_18650(uint64_t a1, void *a2, uint64_t a3)
{
  if (a2)
  {
...
uint64_t sub_186D8(uint64_t a1, uint64_t a2, MIDIDeviceListRef a3, uint64_t a4)
{
  int v7 = sub_A124((void *)a1, a4);
  void *v7 = off_2CDC0;
  v7[8] = a2;
  v7[9] = 0;
  v7[10] = 0;
  ...
  *((_WORD *)v7 + 48) = 0;
  ...
  v32[1] = v7;
  v32[3] = v32;
  sub_FE0C(@"forcemidi1fallback", @"com.apple.coremidi", (uint64_t)sub_4AD0, (uint64_t)v32);
  sub_17F04(v32);
  v31[0] = off_2CE48;
  v31[1] = a1;
  v31[3] = v31;
  sub_FE0C(@"forcemidi1upfallback", @"com.apple.coremidi", (uint64_t)sub_4AD0, (uint64_t)v31);
  sub_17F04(v31);
  sub_1898C();
  __int16 v8 = qword_301A0;
  if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
  {
    int v9 = "";
    ...
    __int16 v29 = 2080;
    unsigned int v30 = v9;
    _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIDeviceManager(%p)::USBMIDIDeviceManager(driver %p, devList %u) %s %s", (uint8_t *)&v17, 0x40u);
  }
...
void sub_1894C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18)
{
  sub_17F04(&a18);
  sub_E0F4(&a9);
  sub_60E0(v18);
...
void sub_1898C()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_301A8, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_301A8))
  {
    qword_301A0 = (uint64_t)os_log_create("com.apple.coremidi", "usbmdm");
    __cxa_guard_release(&qword_301A8);
  }
}

void *sub_18A00(void *a1)
{
  *a1 = off_2CDC0;
  sub_1898C();
  uint64_t v2 = qword_301A0;
  if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&v4[4] = "USBMIDIDeviceManager.cpp";
    ...
    __int16 v7 = 2048;
    __int16 v8 = a1;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] USBMIDIDeviceManager(%p)::~USBMIDIDeviceManager()", v4, 0x1Cu);
  }
  *(void *)long long v4 = a1 + 9;
  sub_E0F4((void ***)v4);
  sub_60E0((uint64_t)a1);
  return a1;
}

void sub_18B04(void *a1)
{
  sub_18A00(a1);
...
uint64_t sub_18B3C(uint64_t a1, uint64_t a2)
{
  sub_1898C();
  long long v4 = qword_301A0;
  if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
  {
    int v6 = 136315906;
    ...
    __int16 v12 = 2048;
    uint64_t v13 = a2;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] USBMIDIDeviceManager(%p)::MatchDevice(%p)", (uint8_t *)&v6, 0x26u);
  }
  return (*(uint64_t (**)(void, uint64_t))(**(void **)(a1 + 64) + 120))(*(void *)(a1 + 64), a2);
}

uint64_t sub_18C44(uint64_t a1, uint64_t a2)
{
  sub_1898C();
  long long v4 = qword_301A0;
  if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v12 = 2048;
    uint64_t v13 = a2;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d [*] USBMIDIDeviceManager(%p)::UseDevice(%p)", (uint8_t *)&v6, 0x26u);
  }
  return sub_18D30(a1, a2, 0);
}

uint64_t sub_18D30(uint64_t a1, uint64_t a2, uint64_t a3)
{
  uint64_t v4 = sub_89E0(a2);
  uint64_t v69 = a3;
  if (a3)
  {
    uint64_t v5 = sub_9B74(a3);
    ...
    if (v5)
    {
        ...
        && !(*(unsigned int (**)(uint64_t, uint64_t))(*(void *)v6 + 176))(v6, 1))
      {
        ...
        if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 152;
          int v66 = 1;
          _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_INFO, "%25s:%-5d      Using MIDI 2.0 alt setting...", buf, 0x12u);
        }
        else
        {
          int v66 = 1;
  ...
  if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
  {
    ...
    *(__int32 *)((char *)&v92.i32[1] + 2) = (unsigned __int16)v83;
    _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDeviceManager::UseDeviceAndInterface() vendor/product %d %d / 0x%04x 0x%04x", buf, 0x2Au);
  }
  int v10 = HIWORD(v83);
  ...
  if ((*(unsigned int (**)(uint64_t, unsigned __int8 *))(*(void *)v4 + 288))(v4, &v84)) {
    ...
    CFStringRef cf2 = sub_9294(a2, v84);
  }
...
LABEL_56:
  ...
  if (!MIDIObjectGetIntegerProperty(Device, @"pluralSerial", &v80) && v80)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 1024;
      *(_DWORD *)&buf[14] = 202;
      _os_log_impl(&def_21CC0, v19, OS_LOG_TYPE_INFO, "%25s:%-5d Device is known to have a plural serial number.", buf, 0x12u);
    }
    goto LABEL_55;
  }
  ...
  if (!(IntegerProperty | value))
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 1024;
      *(_DWORD *)&buf[14] = 211;
      _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_INFO, "%25s:%-5d WARNING - device has a plural serial number.", buf, 0x12u);
    }
  ...
  *(_DWORD *)buf = 0;
  if ((v66 ^ (MIDIObjectGetIntegerProperty(Entity, kMIDIPropertyUMPActiveGroupBitmap, (SInt32 *)buf) != 0)))
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 1024;
      *(_DWORD *)&buf[14] = 343;
      _os_log_impl(&def_21CC0, v62, OS_LOG_TYPE_INFO, "%25s:%-5d      existing device found", buf, 0x12u);
    }
    if (v65 & 1) != 0 || (sub_9F78(v69))
    {
    ...
    if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 345;
      ...
      uint32_t v59 = 18;
LABEL_144:
      _os_log_impl(&def_21CC0, v58, OS_LOG_TYPE_INFO, v57, buf, v59);
    }
    return v8;
  }
...
LABEL_65:
  ...
  if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&unsigned char buf[12] = 1024;
    *(_DWORD *)&buf[14] = 282;
    _os_log_impl(&def_21CC0, v25, OS_LOG_TYPE_INFO, "%25s:%-5d      creating new device", buf, 0x12u);
  }
...
LABEL_84:
    sub_1898C();
    unsigned int v39 = qword_301A0;
    if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
    {
      SInt32 outValue = 136315394;
      v86 = "USBMIDIDeviceManager.cpp";
      __int16 v87 = 1024;
      int v88 = 319;
      _os_log_impl(&def_21CC0, v39, OS_LOG_TYPE_INFO, "%25s:%-5d      purging stale USB MIDI cache for device...", (uint8_t *)&outValue, 0x12u);
    }
    ...
    if (value)
    {
      ...
      for (ItemCount k = 0; MIDIDeviceGetNumberOfEntities(Device) > k; ++k)
      {
        ...
        int64x2_t v92 = vaddq_s64(v92, (int64x2_t)xmmword_27010);
        ...
        for (ItemCount m = 0; MIDIEntityGetNumberOfSources(v41) > m; ++m)
        {
          ...
          int64x2_t v79 = vaddq_s64(v79, (int64x2_t)xmmword_27010);
        ...
        for (ItemCount n = 0; MIDIEntityGetNumberOfDestinations(v41) > n; ++n)
        {
          ...
          int64x2_t v76 = vaddq_s64(v76, (int64x2_t)xmmword_27010);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v89 = 2048;
      uint64_t v90 = Device;
      _os_log_impl(&def_21CC0, v46, OS_LOG_TYPE_INFO, "%25s:%-5d      device 0x%lx added to setup", (uint8_t *)&outValue, 0x1Cu);
    }
    sub_1ADA4(v74);
    sub_1ADA4(str);
    sub_1ADA4(buf);
LABEL_106:
    ...
    if (v67)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&unsigned char buf[12] = 1024;
        *(_DWORD *)&buf[14] = 358;
        _os_log_impl(&def_21CC0, v47, OS_LOG_TYPE_INFO, "%25s:%-5d      setting kMIDIPropertyPluralSerialNumber property on new device", buf, 0x12u);
      }
      MIDIObjectSetIntegerProperty(Device, @"pluralSerial", 1);
    }
    v74[0] = 0;
...
LABEL_126:
        _os_log_impl(&def_21CC0, v51, OS_LOG_TYPE_INFO, v52, buf, 0x12u);
LABEL_127:
        uint64_t v8 = 0;
        goto LABEL_128;
      }
      sub_1898C();
      unsigned int v48 = qword_301A0;
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 136315394;
        *(void *)&uint8_t buf[4] = "USBMIDIDeviceManager.cpp";
        *(_WORD *)&unsigned char buf[12] = 1024;
        *(_DWORD *)&buf[14] = 370;
        _os_log_impl(&def_21CC0, v48, OS_LOG_TYPE_INFO, "%25s:%-5d      UMP is selected on this midiDevice; default pipe protocol will be UMP.",
          buf,
          0x12u);
      }
      ...
      if (*(unsigned char *)(a1 + 96))
      {
        ...
        if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&unsigned char buf[12] = 1024;
          *(_DWORD *)&buf[14] = 383;
          _os_log_impl(&def_21CC0, v50, OS_LOG_TYPE_INFO, "%25s:%-5d      [AQAMIDI] forcemidi1fallback defaults is set. Not changing alt setting.", buf, 0x12u);
        }
        uint64_t v8 = 0;
        BYTE4(str[0][15].info) = 1;
        goto LABEL_128;
      }
      uint64_t v61 = sub_9B74(v69);
      if (v61)
      {
      ...
      sub_1898C();
      int v63 = qword_301A0;
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        *(void *)&uint8_t buf[4] = "USBMIDIDeviceManager.cpp";
        *(_WORD *)&unsigned char buf[12] = 1024;
        *(_DWORD *)&buf[14] = 380;
        _os_log_impl(&def_21CC0, v63, OS_LOG_TYPE_ERROR, "%25s:%-5d      Unable to set MIDI 2.0 alt setting!", buf, 0x12u);
      }
LABEL_128:
      sub_1898C();
      unsigned int v53 = qword_301A0;
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 136315650;
        *(void *)&uint8_t buf[4] = "USBMIDIDeviceManager.cpp";
        ...
        *(CFStringRef *)&buf[20] = str[0];
        _os_log_impl(&def_21CC0, v53, OS_LOG_TYPE_INFO, "%25s:%-5d      initializing USB MIDI device %p", buf, 0x1Cu);
      }
      if ((*((uint64_t (**)(CFStringRef))str[0]->isa + 2))(str[0]))
      {
        if (*(void *)(a1 + 80) == *(void *)(a1 + 72)) {
          sub_1A320((uint64_t *)(a1 + 72), 4uLL);
        }
        sub_1A3B4((uint64_t *)(a1 + 72), (long long *)str);
      }
      else
      {
        char v54 = (std::__shared_weak_count *)str[1];
        str[0] = 0;
        str[1] = 0;
        if (v54) {
          sub_81CC(v54);
        ...
        if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&unsigned char buf[12] = 1024;
          *(_DWORD *)&buf[14] = 393;
          _os_log_impl(&def_21CC0, v55, OS_LOG_TYPE_ERROR, "%25s:%-5d      [AQAMIDI] USB MIDI device initialization failed.", buf, 0x12u);
        }
      }
    }
    else
    ...
    if (str[1]) {
      sub_81CC((std::__shared_weak_count *)str[1]);
    }
  }
LABEL_140:
  if (cf2) {
...
ItemCount sub_19F90(MIDIDeviceRef a1)
{
        ...
        if (i != outValue)
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = 136315906;
            ...
            __int16 v14 = 1024;
            int v15 = i;
            _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_INFO, "%25s:%-5d replacing bad cable number %d with entity (cable) number %d", buf, 0x1Eu);
          }
...
unint64_t sub_1A110(MIDIDeviceRef a1)
{
  unint64_t result = sub_1AA08(a1);
  if (v3)
  {
    unint64_t v4 = result;
    SInt32 value = 0;
    ...
    if (result)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v11 = 1024;
        int v12 = 117;
        _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_INFO, "%25s:%-5d      updating cached UMP Endpoint properties", (uint8_t *)&value, 0x12u);
      }
      SInt32 value = 0;
...
void sub_1A298(void *a1, _DWORD *a2)
{
  uint64_t v4 = a1[2];
  uint64_t v5 = a1[1];
  if (v4 == v5) {
...
void **sub_1A320(uint64_t *a1, unint64_t a2)
{
  uint64_t v4 = a1[2];
  ...
  if (a2 > (v4 - *a1) >> 4)
  {
    ...
    uint64_t v5 = a1[1] - *a1;
    v7[4] = result;
    v7[0] = sub_DF24((uint64_t)result, a2);
    v7[1] = (char *)v7[0] + v5;
    v7[2] = (char *)v7[0] + v5;
...
void sub_1A3A0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_E06C((void **)va);
  _Unwind_Resume(a1);
...
void **sub_1A3B4(uint64_t *a1, long long *a2)
{
  unint64_t v6 = a1[2];
  unint64_t result = (void **)(a1 + 2);
  unint64_t v5 = v6;
  ...
  if ((unint64_t)v7 >= v6)
  {
    ...
    v18[4] = result;
    __int16 v14 = (char *)sub_DF24((uint64_t)result, v13);
    int v15 = &v14[16 * v10];
    v18[0] = v14;
    v18[1] = v15;
    v18[3] = &v14[16 * v16];
...
void sub_1A4BC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_E06C((void **)va);
  _Unwind_Resume(a1);
...
void sub_1A4D0(uint64_t a1, io_registry_entry_t entry)
{
    ...
    if (v6 == CFNumberGetTypeID())
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        ...
        _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_DEBUG, "%25s:%-5d [+] USBMIDIDeviceManager::ServiceTerminated(0x%x)", buf, 0x18u);
      }
      uint64_t v26 = a1;
        ...
        if (v15 == v12)
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 136315650;
            ...
            __int16 v32 = 1024;
            io_registry_entry_t v33 = entry;
            _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_DEBUG, "%25s:%-5d      shutting down removed device 0x%X\n", buf, 0x18u);
          }
          ...
          if (v20 == v12)
          {
            ...
            if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 136315650;
              ...
              __int16 v32 = 1024;
              io_registry_entry_t v33 = entry;
              _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_DEBUG, "%25s:%-5d      shutting down removed device 0x%X\n", buf, 0x18u);
            }
...
LABEL_40:
      sub_1A908(v25, v11, *(long long **)(v26 + 80));
      sub_1898C();
      MIDIObjectRef v24 = qword_301A0;
      if (os_log_type_enabled((os_log_t)qword_301A0, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315650;
        MIDIEntityRef v29 = "USBMIDIDeviceManager.cpp";
        ...
        __int16 v32 = 1024;
        io_registry_entry_t v33 = entry;
        _os_log_impl(&def_21CC0, v24, OS_LOG_TYPE_DEBUG, "%25s:%-5d [-] USBMIDIDeviceManager::ServiceTerminated(0x%x)", buf, 0x18u);
      }
      return;
    }
    CFRelease(v5);
...
void sub_1A8E4(_Unwind_Exception *exception_object)
{
  if (v1) {
    sub_81CC(v1);
  }
...
uint64_t sub_1A908(uint64_t a1, uint64_t a2, long long *a3)
{
  if ((long long *)a2 != a3)
  {
    sub_1AC00((uint64_t)&v10, a3, *(long long **)(a1 + 8), a2);
    uint64_t v6 = v5;
    uint64_t v7 = *(void *)(a1 + 8);
    if (v7 != v5)
    {
...
BOOL sub_1A98C(uint64_t a1, uint64_t a2)
{
  ...
  do
  {
    int v6 = *(_DWORD *)(*(void *)(*(void *)(v5 - 16) + 88) + 16);
    BOOL result = v6 == v4;
    BOOL v8 = v6 == v4 || v5 == v2;
    v5 += 16;
  }
...
BOOL sub_1A9CC(uint64_t a1, int a2)
{
  uint64_t v3 = *(void *)(a1 + 72);
  uint64_t v2 = *(void *)(a1 + 80);
  if (v3 == v2) {
  ...
  do
  {
    int v5 = *(_DWORD *)(*(void *)(*(void *)(v4 - 16) + 96) + 8);
    BOOL result = v5 == a2;
    BOOL v7 = v5 == a2 || v4 == v2;
    v4 += 16;
  }
...
unint64_t sub_1AA08(MIDIDeviceRef a1)
{
...
uint64_t sub_1AABC(uint64_t *a1, void *a2)
{
  uint64_t result = sub_1AB34((uint64_t)(a1 + 2), a1[1], (void *)a1[1], *a1, (void *)*a1, a2[1], a2[1]);
  a2[1] = v5;
  uint64_t v6 = *a1;
  *a1 = v5;
  a2[1] = v6;
...
uint64_t sub_1AB34(uint64_t a1, uint64_t a2, void *a3, uint64_t a4, void *a5, uint64_t a6, uint64_t a7)
{
  uint64_t v7 = a7;
  *(void *)&long long v15 = a6;
  *((void *)&v15 + 1) = a7;
  ...
  char v13 = 1;
  sub_1ABC8((uint64_t)v12);
  return v10;
}

uint64_t sub_1ABC8(uint64_t a1)
{
  if (!*(unsigned char *)(a1 + 24)) {
    sub_E028(a1);
  }
...
long long *sub_1AC00(uint64_t a1, long long *a2, long long *a3, uint64_t a4)
{
  uint64_t v5 = a2;
  if (a2 != a3)
  {
...
void *sub_1AC84(uint64_t a1)
{
  uint64_t result = operator new(0x10uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *result = off_2CE00;
  result[1] = v3;
  return result;
}

uint64_t sub_1ACCC(uint64_t result, void *a2)
{
  uint64_t v2 = *(void *)(result + 8);
  *a2 = off_2CE00;
  a2[1] = v2;
...
uint64_t sub_1ACF8(uint64_t result, unsigned char *a2)
{
...
void *sub_1AD20(uint64_t a1)
{
  uint64_t result = operator new(0x10uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *result = off_2CE48;
  result[1] = v3;
  return result;
}

uint64_t sub_1AD68(uint64_t result, void *a2)
{
  uint64_t v2 = *(void *)(result + 8);
  *a2 = off_2CE48;
  a2[1] = v2;
...
uint64_t sub_1AD94(uint64_t result, unsigned char *a2)
{
  *(unsigned char *)(*(void *)(result + 8) + 97) = *a2;
  return result;
}

uint64_t sub_1ADA4(void *a1)
{
  uint64_t v2 = (void **)a1[1];
  uint64_t v3 = (void **)a1[2];
  a1[5] = 0;
...
LABEL_9:
  ...
  return sub_1AE4C((uint64_t)a1);
}

uint64_t sub_1AE4C(uint64_t a1)
{
  uint64_t v3 = *(void *)(a1 + 8);
  uint64_t v2 = *(void *)(a1 + 16);
  if (v2 != v3) {
  ...
  if (v22 < v24 >> 3)
  {
    ...
    *(void *)&long long v54 = operator new(0x1000uLL);
    ...
    if ((unint64_t)v9 <= *a1)
    {
      ...
      int v34 = (char *)sub_16CE4((uint64_t)(a1 + 3), v46);
...
LABEL_30:
  ...
  uint64_t v56 = a1 + 3;
  *(void *)&long long v54 = sub_16CE4((uint64_t)(a1 + 3), v25);
...
void sub_1B168(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13)
{
  operator delete(v13);
  if (__p) {
    operator delete(__p);
...
void sub_1B1B4(void *a1, void *a2)
{
  ...
  if (v6 == v5)
  {
    ...
    if ((unint64_t)v7 <= *a1)
    {
      ...
      __int16 v19 = (char *)sub_16CE4(v4, v18);
...
void sub_1B2CC(uint64_t a1, void *a2)
{
  ...
  if (v4 == *(char **)a1)
  {
    ...
    if (v8 >= v7)
    {
      ...
      uint64_t v13 = 2 * v12;
      uint64_t v14 = (char *)sub_16CE4(v6, v12);
...
void sub_1B3EC(void *a1, void *a2)
{
  ...
  if (v4 == (char *)a1[3])
  {
    ...
    if ((unint64_t)v5 <= *a1)
    {
      ...
      uint64_t v17 = (char *)sub_16CE4(a1[4], v16);
...
void sub_1B504(uint64_t a1, void *a2)
{
  uint64_t v4 = *(char **)(a1 + 8);
  if (v4 == *(char **)a1)
  {
    ...
    if (v6 >= v7)
    {
      ...
      uint64_t v12 = 2 * v11;
      uint64_t v13 = (char *)sub_16CE4(*(void *)(a1 + 32), v11);
...
{
  uint64_t v3 = sub_89E0(a1);
  sub_9B74(a2);
  return v3;
}

CFStringRef sub_1B8CC(uint64_t a1, const __CFString *a2)
{
  uint64_t v4 = sub_89E0(a1);
  CFStringRef v5 = a2;
  if (v4)
  {
    unsigned __int8 v14 = 0;
    ...
    if (v6)
    {
      int v7 = v6;
      sub_1BAB8();
      uint64_t v8 = qword_301B0;
      CFStringRef v5 = a2;
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v19 = 1024;
        int v20 = v7;
        _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_ERROR, "%25s:%-5d [!]  USBGetManufacturerStringIndex() returned error 0x%x", buf, 0x18u);
        CFStringRef v5 = a2;
      }
    }
    else
    {
      CFStringRef v5 = sub_9294(a1, v14);
    }
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v19 = 1024;
        int v20 = v10;
        _os_log_impl(&def_21CC0, v11, OS_LOG_TYPE_ERROR, "%25s:%-5d [!]  USBGetProductStringIndex() returned error 0x%x", buf, 0x18u);
      }
    }
    else
    {
...
void sub_1BAB8()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_301B8, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_301B8))
  {
    qword_301B0 = (uint64_t)os_log_create("com.apple.coremidi", "usbmba");
    __cxa_guard_release(&qword_301B8);
  }
}

double sub_1BB28@<D0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v11[12] = 1024;
      *(_DWORD *)&v11[14] = 99;
      _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] findDescriptors() - no interface descriptor found", v11, 0x12u);
    }
    double result = 0.0;
    *(_OWORD *)a2 = 0u;
    *(_OWORD *)(a2 + 16) = 0u;
...
__n128 sub_1BCA8(uint64_t a1, unsigned __int8 *a2, void *a3, char **a4, char **a5, unsigned __int8 **a6)
{
  if (!a1) {
    return result;
  }
  ...
  sub_1BAB8();
  int v10 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    v173 = "USBMIDIDriverBase.cpp";
    __int16 v174 = 1024;
    int v175 = 108;
    _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDriverBase::ParseDescriptors()", buf, 0x12u);
  }
  int v171 = 0;
  ...
  do
  {
    ...
    if (*v6)
    {
      ...
      do
      {
        ...
        *(unsigned char *)uint64_t v12 = a0123456789abcd_1[(unint64_t)v14 >> 4];
    ...
    int v16 = v6[2];
    sub_1BAB8();
    __int16 v17 = qword_301B0;
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
    {
      int v18 = __p;
      if (v168 < 0) {
        int v18 = (void **)__p[0];
      ...
      *(void *)&long long v177 = v18;
      _os_log_impl(&def_21CC0, v17, OS_LOG_TYPE_DEBUG, "%25s:%-5d      Now @: %s", buf, 0x1Cu);
    }
    char v19 = 0;
    if (v15 > 35)
    {
        ...
        if (v16 == 1 && (v165 & 0x80000000) == 0)
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = 136315394;
            ...
            __int16 v174 = 1024;
            int v175 = 197;
            _os_log_impl(&def_21CC0, v27, OS_LOG_TYPE_INFO, "%25s:%-5d      USB MIDI 1.0 CS endpoint descriptor", buf, 0x12u);
          }
          uint64_t v28 = v6[3];
          sub_1BAB8();
          MIDIEntityRef v29 = qword_301B0;
          if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
          {
            ...
            *(void *)((char *)&v177 + 6) = v30;
            _os_log_impl(&def_21CC0, v29, OS_LOG_TYPE_INFO, "%25s:%-5d      %d embedded MIDI jack(s), searching %lu jack(s) for a match", buf, 0x22u);
          }
          if (v28)
          {
...
LABEL_45:
                ...
                if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
                {
                  *(_DWORD *)buf = 136315650;
                  ...
                  __int16 v176 = 1024;
                  LODWORD(v177) = v164;
                  _os_log_impl(&def_21CC0, v35, OS_LOG_TYPE_INFO, "%25s:%-5d      Jack not found for endpoint 0x%x", buf, 0x18u);
                }
              }
              else
              {
                sub_1BAB8();
                uint64_t v36 = qword_301B0;
                if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
                {
                  int v38 = v33[2];
                  *(_DWORD *)buf = 136315906;
                  ...
                  *(_DWORD *)((char *)&v177 + 6) = v164;
                  _os_log_impl(&def_21CC0, v36, OS_LOG_TYPE_INFO, "%25s:%-5d      Found jack %d for endpoint 0x%x", buf, 0x1Eu);
                }
                v33[5] = v164;
                if (v165)
                {
                  ...
                  if (v39 >= v40)
                  {
                    ...
                    if (v49) {
                      uint64_t v50 = (char *)sub_48CC((uint64_t)(a4 + 2), v49);
                    }
                    else {
                      uint64_t v50 = 0;
                    }
...
LABEL_221:
                    ...
                    if (v54) {
                      long long v55 = (char *)sub_48CC((uint64_t)(a5 + 2), v54);
                    }
                    else {
                      long long v55 = 0;
                    }
        ...
        if (v16 == 2)
        {
          if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = 136315394;
            ...
            __int16 v174 = 1024;
            int v175 = 216;
            _os_log_impl(&def_21CC0, v81, OS_LOG_TYPE_INFO, "%25s:%-5d             (USB MIDI 2.0 CS endpoint descriptor)", buf, 0x12u);
          }
          uint64_t v82 = v6[3];
          if (v6[3])
          {
            ...
            do
            {
                ...
                if (*j == v86)
                {
                  ...
                  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 136315906;
                    ...
                    WORD2(v177) = 1024;
                    *(_DWORD *)((char *)&v177 + 6) = v164;
                    _os_log_impl(&def_21CC0, v97, OS_LOG_TYPE_INFO, "%25s:%-5d      Reusing group terminal blockID %d for endpoint 0x%x", buf, 0x1Eu);
                  }
                  if (v165) {
                    j[6] = v164;
                  }
              ...
              if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
              {
                *(_DWORD *)buf = 136315906;
                ...
                WORD2(v177) = 1024;
                *(_DWORD *)((char *)&v177 + 6) = v164;
                _os_log_impl(&def_21CC0, v88, OS_LOG_TYPE_INFO, "%25s:%-5d      New group terminal blockID %d for endpoint 0x%x", buf, 0x1Eu);
              }
              __int16 v89 = a6[1];
              uint64_t v90 = a6[2];
              if (v89 >= v90)
              {
                ...
                if (v95) {
                  v96 = (char *)sub_21880((uint64_t)(a6 + 2), v95);
                }
                else {
                  v96 = 0;
                }
...
LABEL_143:
      ...
      if (v16 == 3)
      {
        ...
        *(void *)&long long v177 = v145;
        WORD4(v177) = 1024;
        *(_DWORD *)((char *)&v177 + 1sub_7888(&a9, 0) = v113;
        HIWORD(v177) = 1024;
        *(_DWORD *)v178 = v111;
        *(_WORD *)&v178[4] = 1024;
        int v179 = v144;
      ...
      if (v16 == 2)
      {
        ...
        *(void *)&long long v177 = v147;
        WORD4(v177) = 1024;
        *(_DWORD *)((char *)&v177 + 1sub_7888(&a9, 0) = v106;
        uint64_t v23 = v146;
        os_log_type_t v24 = OS_LOG_TYPE_INFO;
...
LABEL_24:
        uint32_t v26 = 34;
LABEL_25:
        _os_log_impl(&def_21CC0, v23, v24, v25, buf, v26);
        goto LABEL_197;
      }
      if (v16 != 1)
      {
        sub_1BAB8();
        uint64_t v118 = qword_301B0;
        if (!os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO)) {
          goto LABEL_197;
        }
        *(_DWORD *)buf = 136315650;
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(void *)&long long v177 = v75;
        _os_log_impl(&def_21CC0, v74, OS_LOG_TYPE_DEBUG, "%25s:%-5d      Found CS descriptor: %s", buf, 0x1Cu);
      }
      int v76 = *(unsigned __int16 *)(v6 + 3);
      sub_1BAB8();
      v77 = qword_301B0;
      BOOL v78 = os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO);
      if (v76 != 512)
      {
        if (v78)
        {
...
LABEL_197:
      ...
      if (v78)
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v174 = 1024;
        int v175 = 155;
        _os_log_impl(&def_21CC0, v77, OS_LOG_TYPE_INFO, "%25s:%-5d      Found a USB MIDI 2.0 alternate setting", buf, 0x12u);
      }
      int v79 = (*(uint64_t (**)(uint64_t, uint64_t))(*(void *)v9 + 176))(v9, 1);
      sub_1BAB8();
      SInt32 v80 = qword_301B0;
      if (!v79)
      {
        if (!os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO)) {
          goto LABEL_197;
...
LABEL_189:
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v174 = 1024;
        int v175 = 157;
        _os_log_impl(&def_21CC0, v80, OS_LOG_TYPE_ERROR, "%25s:%-5d      Unable to set MIDI 2.0 alt setting!", buf, 0x12u);
      }
      char v19 = 1;
    }
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v176 = 1024;
        LODWORD(v177) = v71;
        _os_log_impl(&def_21CC0, v72, OS_LOG_TYPE_INFO, "%25s:%-5d      Examining alt setting %d...", buf, 0x18u);
      }
      if (v71 < 2) {
        goto LABEL_197;
      }
      sub_1BAB8();
      __int16 v73 = qword_301B0;
      char v19 = 1;
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v174 = 1024;
        int v175 = 146;
        _os_log_impl(&def_21CC0, v73, OS_LOG_TYPE_INFO, "%25s:%-5d      Done examining descriptors; halting",
          buf,
          0x12u);
      }
    }
LABEL_198:
    ...
    if (!v148)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v174 = 1024;
        int v175 = 248;
        _os_log_impl(&def_21CC0, v149, OS_LOG_TYPE_DEBUG, "%25s:%-5d      FindNextAssociatedDescriptor() returned nullptr for kUSBAnyDesc", buf, 0x12u);
      }
      ...
      if (!v148)
      {
        ...
        if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 136315394;
          ...
          __int16 v174 = 1024;
          int v175 = 252;
          _os_log_impl(&def_21CC0, v150, OS_LOG_TYPE_DEBUG, "%25s:%-5d      FindNextAssociatedDescriptor() returned nullptr for kUSBInterfaceDesc; done",
            buf,
            0x12u);
        }
        uint64_t v148 = 0;
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v174 = 1024;
    int v175 = 118;
    _os_log_impl(&def_21CC0, v152, OS_LOG_TYPE_DEBUG, "%25s:%-5d      Bailing out of loop...", buf, 0x12u);
  }
  LOBYTE(__p[0]) = 0;
  __int16 v170 = 0;
  __int16 v169 = 0;
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&v178[2] = (unsigned __int16)v171;
    _os_log_impl(&def_21CC0, v153, OS_LOG_TYPE_INFO, "%25s:%-5d      Interface class %d, subclass %d, for device 0x%04x /0x%04x", buf, 0x2Au);
  }
  sub_1BAB8();
  v154 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)((char *)&v177 + 6) = HIBYTE(v169);
    WORD5(v177) = 1024;
    HIDWORD(v177) = v169;
    _os_log_impl(&def_21CC0, v154, OS_LOG_TYPE_INFO, "%25s:%-5d      Interface %d alternate setting %d : %d endpoints", buf, 0x24u);
  }
  sub_1BAB8();
  v155 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v174 = 1024;
    int v175 = 255;
    _os_log_impl(&def_21CC0, v155, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDriverBase::ParseDescriptors()", buf, 0x12u);
  }
  return result;
}

void sub_1D2B0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,uint64_t a28,uint64_t a29,uint64_t a30,void *__p,uint64_t a32,int a33,__int16 a34,char a35,char a36)
{
  if (a36 < 0) {
    operator delete(__p);
  }
...
void sub_1D2F8(uint64_t a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, uint64_t *a4@<X8>)
{
  sub_1BAB8();
  int v7 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[34] = 2048;
    *(void *)&buf[36] = v8;
    _os_log_impl(&def_21CC0, v7, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDriverBase::CreatePortMapList(inUSBDevice:%p, interfaceNum:%d) - Constructing a USB MIDI 2.0 port map list for %lu group terminal block(s)", buf, 0x2Cu);
  }
  *a4 = 0;
  a4[1] = 0;
  a4[2] = 0;
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&__b[12] = 1024;
    *(_DWORD *)&__b[14] = 265;
    _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_INFO, "%25s:%-5d      Issuing device request to load group terminal block descriptors...", __b, 0x12u);
  }
  int v87 = 0;
  sub_9320(a1, a2, 1, (uint64_t)buf, 5, &v87);
  if (v87 != 5)
  {
    sub_1BAB8();
    unsigned int v14 = qword_301B0;
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&v89[2] = v87;
      _os_log_impl(&def_21CC0, v14, OS_LOG_TYPE_ERROR, "%25s:%-5d [!]  FATAL: Could not retrieve Group Terminal Descriptors for USB MIDI interface %d alternate setting %d. Expected header length %u but got %u", __b, 0x2Au);
    }
    goto LABEL_99;
  }
  uint64_t v10 = buf[0];
  if (buf[0])
  {
    ...
    do
    {
      ...
      *(unsigned char *)uint64_t v11 = a0123456789abcd_1[(unint64_t)v13 >> 4];
      *((unsigned char *)v11 + 1) = a0123456789abcd_1[v13 & 0xF];
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&__b[24] = 2080;
    *(void *)&__b[26] = v17;
    _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_INFO, "%25s:%-5d      Got group terminal block descriptor header (totalLength = %d): %s", __b, 0x22u);
  }
  sub_9320(a1, a2, 1, (uint64_t)buf, v15, &v84);
  unsigned int v18 = v84;
  if (-991146299 * (v84 - v87) >= 0x13B13B14)
  {
    sub_1BAB8();
    char v19 = qword_301B0;
    BOOL v20 = os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR);
    unsigned int v18 = v84;
    if (v20)
    {
      ...
      *(_WORD *)&__b[18] = 1024;
      *(_DWORD *)&__b[20] = v84;
      _os_log_impl(&def_21CC0, v19, OS_LOG_TYPE_ERROR, "%25s:%-5d      Unexpected group terminal descriptor length: %u", __b, 0x18u);
      unsigned int v18 = v84;
    }
  }
  ...
  if ((v18 - v87) % 0xD)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&__b[20] = v84;
      ...
      uint32_t v27 = 24;
LABEL_33:
      _os_log_impl(&def_21CC0, v25, v26, v24, __b, v27);
    }
  }
  else
  {
    ...
    else if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
    {
    ...
    do
    {
      ...
      if (*v34)
      {
        ...
        do
        {
          ...
          unsigned char *v36 = a0123456789abcd_1[(unint64_t)v37 >> 4];
      ...
      *(_OWORD *)__p = *(_OWORD *)__b;
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&__b[24] = 2080;
        *(void *)&__b[26] = v39;
        _os_log_impl(&def_21CC0, v38, OS_LOG_TYPE_INFO, "%25s:%-5d      %00d: %s ", __b, 0x22u);
      }
      int v32 = ++v33;
    }
    while (v22 > v33);
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&__b[18] = 2080;
    *(void *)&__b[20] = v43;
    _os_log_impl(&def_21CC0, v40, OS_LOG_TYPE_INFO, "%25s:%-5d      Parsing group terminal block descriptor%s ...", __b, 0x1Cu);
  }
  sub_1DFE4((unsigned __int8 **)a3, (unint64_t)&buf[5], v84, v41, v42);
    ...
    do
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v89[2] = v55;
        ...
        __int16 v94 = 1024;
        int v95 = v58;
        _os_log_impl(&def_21CC0, v51, OS_LOG_TYPE_INFO, "%25s:%-5d      blockID 0x%x blockType 0x%x first gt %u (%u total) inEP 0x%x outEP 0x%x gtb.midiProtocol 0x%x", __b, 0x3Cu);
      }
      if (!v48[4])
      {
        int v61 = v48[6];
        ...
        if (!v61 || !v62)
        {
          if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&__b[18] = 1024;
            *(_DWORD *)&__b[20] = v78;
            _os_log_impl(&def_21CC0, v63, OS_LOG_TYPE_ERROR, "%25s:%-5d      blockID 0x%x cannot use MIDI-CI without both a valid input and output endpoint. Skipping ...", __b, 0x18u);
          }
          goto LABEL_91;
        }
        if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&__b[12] = 1024;
          *(_DWORD *)&__b[14] = 315;
          _os_log_impl(&def_21CC0, v63, OS_LOG_TYPE_INFO, "%25s:%-5d           (MIDI-CI protocol negotiation will occur before going online)", __b, 0x12u);
        }
      }
      ...
      if (v60 || v64)
      {
        ...
        __b[6] = v69;
        __b[7] = v70;
        sub_1E05C(a4, v65, (double *)__b);
        sub_1BAB8();
        unsigned int v71 = qword_301B0;
        if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
        {
          int v72 = *v48;
          ...
          *(_DWORD *)&v89[2] = v64;
          ...
          __int16 v94 = 1024;
          int v95 = v77;
          _os_log_impl(&def_21CC0, v71, OS_LOG_TYPE_INFO, "%25s:%-5d      blockID 0x%x cable 0x%x, inEP 0x%x, outEP 0x%x, usbpipeprotocol 0x%00x, firstGroupTerminal %d, numGroups %d -> maplist", __b, 0x3Cu);
        }
        ++v50;
        v49 += v48[3];
      }
LABEL_91:
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&__b[18] = 2048;
    *(void *)&__b[20] = v80;
    _os_log_impl(&def_21CC0, v79, OS_LOG_TYPE_INFO, "%25s:%-5d      Maplist constructed with %lu group terminal block(s).", __b, 0x1Cu);
  }
  if (SHIBYTE(v86) < 0) {
    operator delete(__p[0]);
  }
LABEL_99:
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&__b[12] = 1024;
    *(_DWORD *)&__b[14] = 343;
    _os_log_impl(&def_21CC0, v81, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDriverBase::CreatePortMapList()", __b, 0x12u);
  }
}

void sub_1DF9C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, void *__p, uint64_t a18, int a19, __int16 a20,char a21,char a22)
{
  if (a22 < 0) {
    operator delete(__p);
  }
...
unsigned __int8 **sub_1DFE4(unsigned __int8 **result, unint64_t a2, unsigned int a3, uint8x8_t a4, int16x8_t a5)
{
  if (a3)
  {
    unint64_t v5 = a2 + a3;
...
uint64_t *sub_1E05C(uint64_t *a1, uint64_t a2, double *a3)
{
  ...
  if (v6 >= v9)
  {
    ...
    sub_227AC((uint64_t)&__p, a3);
    uint64_t v4 = (uint64_t *)sub_22920((uint64_t)a1, &__p, v4);
    if (v20 != v19) {
  ...
  {
    sub_22758((uint64_t)a1, a2, v6, (char *)(a2 + 8));
    *uint64_t v4 = *(void *)a3;
  }
  return v4;
}

void sub_1E198(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, uint64_t a12)
{
  if (__p) {
    operator delete(__p);
  }
...
void sub_1E1D0(uint64_t a1@<X0>, int a2@<W1>, uint64_t *a3@<X2>, uint64_t *a4@<X3>, uint64_t *a5@<X8>)
{
  *a5 = 0;
  a5[1] = 0;
  a5[2] = 0;
  sub_1BAB8();
  uint64_t v10 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&v41[4] = "USBMIDIDriverBase.cpp";
    ...
    __int16 v50 = 2048;
    unint64_t v51 = v12;
    _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIDriverBase::CreatePortMapList(inUSBDevice:%p, interfaceNum:%d) - Constructing a USB MIDI 1.0 port map list for %lu inputs and %lu outputs...", v41, 0x36u);
  }
  uint64_t v14 = *a3;
  uint64_t v13 = a3[1];
  if (v13 == *a3)
  ...
  else
  {
    ...
    do
    {
      ...
      *(_DWORD *)&v41[3] = 0;
      ...
      if (v16 >= a5[2])
      {
        unint64_t v16 = sub_17604(a5, v41);
        uint64_t v14 = *a3;
        uint64_t v13 = a3[1];
      }
      else
...
LABEL_51:
  ...
  if (v25 > v34 >> 3)
  {
    ...
    do
    {
      ...
      *(_DWORD *)&v41[4] = 1;
      if (v28 >= a5[2])
      {
        unint64_t v28 = sub_17604(a5, v41);
        uint64_t v24 = *a4;
        uint64_t v23 = a4[1];
      }
      else
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&v41[4] = "USBMIDIDriverBase.cpp";
    __int16 v42 = 1024;
    int v43 = 398;
    _os_log_impl(&def_21CC0, v40, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIDriverBase::CreatePortMapList()", v41, 0x12u);
  }
}

void sub_1E61C(_Unwind_Exception *exception_object)
{
  uint64_t v3 = *(void **)v1;
  if (*(void *)v1)
  {
...
CFStringRef sub_1E640(uint64_t a1, int a2, const __CFString *a3)
{
  CFStringRef v4 = sub_9294(a1, a2);
  if (!v4) {
    return v4;
  }
...
BOOL sub_1E72C(uint64_t a1, MIDIDeviceRef a2, void *a3, uint64_t *a4, const __CFString *a5, const __CFString *a6, const __CFString *a7)
{
  unint64_t v8 = a3[1] - *a3;
  newMIDIEntityRef Entity = 0;
  sub_1BAB8();
  unint64_t v9 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    *(void *)long long v106 = "USBMIDIDriverBase.cpp";
    *(_WORD *)&v106[8] = 1024;
    *(_DWORD *)&v106[10] = 435;
    _os_log_impl(&def_21CC0, v9, OS_LOG_TYPE_INFO, "%25s:%-5d [+] configureDeviceUsingPortMap(using groupTerminalBlocks)", buf, 0x12u);
  }
  sub_1BAB8();
  CFStringRef v10 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    *(void *)long long v106 = "USBMIDIDriverBase.cpp";
    ...
    *(_DWORD *)&v106[10] = 436;
    __int16 v107 = 1024;
    *(_DWORD *)long long v108 = v8 >> 3;
    _os_log_impl(&def_21CC0, v10, OS_LOG_TYPE_INFO, "%25s:%-5d      Constructing %d + 1 (phantom) UMP entities...", buf, 0x18u);
  }
  if ((int)(v8 >> 3) < 1)
  {
    uint64_t v95 = 0;
    ...
    uint64_t v13 = a3;
LABEL_87:
    unsigned int v71 = (unsigned char *)*v13;
    unsigned __int8 v70 = (unsigned char *)v13[1];
    if ((unsigned char *)*v13 == v70)
    {
      MIDIDeviceNewEntity(a2, a6, protocol, 0, 0, 0, &newEntity);
    }
    else
    {
      int v72 = v71 + 8;
...
LABEL_124:
    ...
    sub_1BAB8();
    unsigned __int8 v85 = qword_301B0;
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315394;
      *(void *)long long v106 = "USBMIDIDriverBase.cpp";
      *(_WORD *)&v106[8] = 1024;
      *(_DWORD *)&v106[10] = 549;
      _os_log_impl(&def_21CC0, v85, OS_LOG_TYPE_INFO, "%25s:%-5d      setting UMP enabled on device", buf, 0x12u);
    }
    MIDIObjectSetIntegerProperty(a2, @"UMP Enabled", 1);
    sub_1BAB8();
    uint64_t v86 = qword_301B0;
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 136315394;
      *(void *)long long v106 = "USBMIDIDriverBase.cpp";
      *(_WORD *)&v106[8] = 1024;
      *(_DWORD *)&v106[10] = 551;
      _os_log_impl(&def_21CC0, v86, OS_LOG_TYPE_INFO, "%25s:%-5d [-] configureDeviceUsingPortMap(using groupTerminalBlocks)", buf, 0x12u);
    }
    return v12;
  }
  uint64_t v11 = 0;
  ...
  while (1)
  {
    ...
    int v17 = (unsigned char *)*v13;
    unint64_t v16 = (unsigned char *)v13[1];
    ...
    ItemCount v100 = v25;
    if (v21 && CFStringCompare(&stru_2D460, v21, 0))
    {
      sub_1BAB8();
      uint64_t v26 = qword_301B0;
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
      {
        int v27 = *v19;
        *(_DWORD *)buf = 136315906;
        ...
        *(_DWORD *)&v106[10] = 454;
        __int16 v107 = 1024;
        *(_DWORD *)long long v108 = v27;
        *(_WORD *)&v108[4] = 2112;
        *(void *)&v108[6] = cf;
        _os_log_impl(&def_21CC0, v26, OS_LOG_TYPE_DEBUG, "%25s:%-5d      Using GTB name string at string index %d: %@", buf, 0x22u);
      }
    }
    else
    {
      unint64_t v28 = sub_2301C(buf, a5, *v15);
      CFTypeRef v29 = cf;
    ...
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)&v108[10] = v11;
      ...
      __int16 v113 = 1024;
      LODWORD(v114) = v33;
      _os_log_impl(&def_21CC0, v30, OS_LOG_TYPE_DEBUG, "%25s:%-5d      Found port map for GTB %@ (index:%d blockType:%d): firstGroup %d numGroups %d", buf, 0x34u);
    }
    uint64_t v98 = v11;
    ...
    int v39 = !v38;
    if ((v35 - 17) < 2) {
      MIDIProtocolID v23 = kMIDIProtocol_2_0;
    }
    ...
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&v108[10] = v24;
      ...
      int v112 = v41;
      __int16 v113 = 2080;
      unsigned __int8 v114 = v43;
      _os_log_impl(&def_21CC0, v40, OS_LOG_TYPE_INFO, "%25s:%-5d      Created a %s entity with %d inputs and %d outputs, midiProtocol = %d%s", buf, 0x38u);
    }
    ...
    if (v58 >= 2)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v106[10] = 480;
        __int16 v107 = 1024;
        *(_DWORD *)long long v108 = v59;
        _os_log_impl(&def_21CC0, v60, OS_LOG_TYPE_INFO, "%25s:%-5d      setting maxOutputBandwidth to %u", buf, 0x18u);
      }
      if (v24)
      {
        for (ItemCount i = 0; i != v24; ++i)
        {
    ...
    if (v64 >= 2)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v106[10] = 493;
        __int16 v107 = 1024;
        *(_DWORD *)long long v108 = v65;
        _os_log_impl(&def_21CC0, v66, OS_LOG_TYPE_INFO, "%25s:%-5d      setting maxInputBandwidth to %u", buf, 0x18u);
      }
      if (v100)
      {
        for (ItemCount j = 0; j != v100; ++j)
        {
...
void sub_1F244(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,uint64_t a28,uint64_t a29,uint64_t a30,uint64_t a31,uint64_t a32)
{
}

BOOL sub_1F294(uint64_t a1, const __CFString *a2, MIDIDeviceRef a3, uint64_t *a4, uint64_t *a5, void *a6, void *a7, const __CFString *a8, char a9)
{
  newMIDIEntityRef Entity = 0;
  uint64_t v13 = a4[1];
  uint64_t v49 = *a4;
  sub_1BAB8();
  uint64_t v14 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    ...
    *(_WORD *)&v60[8] = 1024;
    *(_DWORD *)&v60[10] = 559;
    _os_log_impl(&def_21CC0, v14, OS_LOG_TYPE_INFO, "%25s:%-5d [+] configureDeviceUsingPortMap(using JackLists)", buf, 0x12u);
  }
  sub_1BAB8();
  unint64_t v15 = qword_301B0;
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    *(void *)int v60 = "USBMIDIDriverBase.cpp";
    *(_WORD *)&v60[8] = 1024;
    *(_DWORD *)&v60[10] = 560;
    _os_log_impl(&def_21CC0, v15, OS_LOG_TYPE_INFO, "%25s:%-5d      Constructing USB MIDI 1.0 entities...", buf, 0x12u);
  }
  uint64_t v48 = v13;
  if (v13 != v49)
  {
    ...
    do
    {
      ...
      {
        CFStringRef v21 = sub_1E640(a1, *(unsigned __int8 *)(*a6 + 6 * v16 + 4), a8);
        uint64_t v22 = *a6;
        uint64_t v23 = *a5;
        uint64_t v24 = a5[1];
        if (*a5 != v24)
            ...
            if (v25 == 1)
            {
              ...
              if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)&v60[10] = 576;
                __int16 v61 = 1024;
                LODWORD(v62) = v27;
                _os_log_impl(&def_21CC0, v26, OS_LOG_TYPE_INFO, "%25s:%-5d      Found an embedded input at jack ID %d.", buf, 0x18u);
              }
            }
          }
        }
...
LABEL_21:
      if (v20)
      {
        CFStringRef v28 = sub_1E640(a1, *(unsigned __int8 *)(*a7 + 6 * v16 + 4), a8);
        uint64_t v29 = *a7;
        uint64_t v30 = *a5;
        uint64_t v31 = a5[1];
        if (*a5 != v31)
            ...
            if (v32 == 1)
            {
              ...
              if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)&v60[10] = 586;
                __int16 v61 = 1024;
                LODWORD(v62) = v34;
                _os_log_impl(&def_21CC0, v33, OS_LOG_TYPE_INFO, "%25s:%-5d      Found an embedded output at jack ID %d.", buf, 0x18u);
              }
            }
          }
        }
LABEL_31:
      ...
      {
        unint64_t v36 = sub_23084(buf, a2, (v16 + 1));
        CFTypeRef v37 = cf;
          ...
          && (int v38 = *(unsigned __int8 *)(*a6 + 6 * v16 + 1), v38 == *(unsigned __int8 *)(*a7 + 6 * v16 + 1)))
        {
          if (v38 == 1)
          {
            ...
            if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&v60[8] = 1024;
              *(_DWORD *)&v60[10] = 611;
              _os_log_impl(&def_21CC0, v39, OS_LOG_TYPE_INFO, "%25s:%-5d      Creating an embedded entity.", buf, 0x12u);
            }
            goto LABEL_56;
          }
        }
...
LABEL_56:
  ...
  if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&v60[10] = 637;
    __int16 v61 = 2080;
    MIDIObjectRef v62 = v46;
    _os_log_impl(&def_21CC0, v45, OS_LOG_TYPE_INFO, "%25s:%-5d [+] configureDeviceUsingPortMap(using JackLists) = %s", buf, 0x1Cu);
  }
  return v48 != v49;
}
...
void sub_1FA64(uint64_t a1, const __CFUUID *a2)
{
}

void sub_1FB30(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_17B20((uint64_t *)va);
  sub_68F8(v2);
  _Unwind_Resume(a1);
}

void sub_1FB4C(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, unsigned int a4@<W3>, void *a5@<X8>)
{
  uint64_t v8 = a2;
  uint64_t v7 = a3;
  unsigned int v6 = a4;
  uint64_t v5 = a1;
  sub_232F0(&v5, &v8, &v7, &v6, a5);
}

uint64_t sub_1FB90(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (!a3) {
    return 4294956462;
  }
...
uint64_t sub_1FBE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (!a3) {
    return 4294956462;
  }
...
void sub_1FC38(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X8>)
{
  ...
  *(void *)a3 = 0;
  *(void *)(a3 + 8) = 0;
  *(_OWORD *)(a3 + 4sub_7888(&a9, 0) = 0u;
  *(_OWORD *)(a3 + 56) = 0u;
  *(_OWORD *)(a3 + 88) = 0u;
  *(_OWORD *)(a3 + 104) = 0u;
  uint64_t v7 = sub_89E0(a1);
  uint64_t v8 = sub_9B74(a2);
  if (!v7) {
    return;
  }
  uint64_t v9 = v8;
  if (!v8 || (sub_9F78(a2) & 1) == 0) {
    return;
  }
  int v10 = (*(uint64_t (**)(uint64_t, uint64_t))(*(void *)v9 + 136))(v9, a3 + 16);
  sub_1BAB8();
  uint64_t v11 = qword_301B0;
  if (v10)
  {
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
    {
...
LABEL_9:
      _os_log_impl(&def_21CC0, v13, v14, v12, v16, 0x18u);
    }
  }
  else if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_INFO))
  {
    int v15 = *v6;
    *(_DWORD *)unint64_t v16 = 136315650;
    *(void *)&v16[4] = "USBMIDIDriverBase.cpp";
  ...
  sub_1BB28(v9, (uint64_t)v16);
  if (*(void *)v16)
  {
    sub_1BCA8(v9, *(unsigned __int8 **)v16, (void *)(a3 + 24), (char **)(a3 + 48), (char **)(a3 + 72), (unsigned __int8 **)(a3 + 96));
    *(void *)a3 = a1;
    *(void *)(a3 + 8) = a2;
  }
  if (v19 < 0) {
...
void sub_1FE38(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0) {
    operator delete(__p);
  }
...
BOOL sub_1FE6C(uint64_t a1, uint64_t a2, const __CFString *a3, const __CFString *a4, const __CFString *a5, MIDIDeviceRef a6, uint64_t *a7, uint64_t *a8, void *a9, void *a10)
{
  sub_89E0(a1);
  uint64_t v16 = sub_9B74(a2);
  CFStringRef v17 = sub_1B8CC(a1, a4);
  CFStringRef v19 = v18;
  __int16 v24 = 0;
  (*(void (**)(uint64_t, __int16 *))(*(void *)v16 + 104))(v16, &v24);
  BOOL v20 = sub_1F294(a1, a3, a6, a7, a8, a9, a10, v19, v24 == 1452);
...
void sub_1FF90(int a1@<W0>, uint64_t a2@<X1>, uint64_t *a3@<X8>)
{
  uint64_t v5 = *(void *)a2;
  int v6 = *(unsigned __int8 *)(a2 + 16);
  if (a1) {
    sub_1E1D0(v5, v6, (uint64_t *)(a2 + 48), (uint64_t *)(a2 + 72), a3);
  }
  else {
    sub_1D2F8(v5, v6, a2 + 96, a3);
  }
}

void sub_1FFB8(uint64_t a1, MIDITimeStamp a2, char *a3, int64_t a4, uint64_t a5, MIDIProtocolID a6)
{
  uint64_t v7 = a3;
  if (a6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)&evtlist[14] = 766;
        _os_log_impl(&def_21CC0, v71, OS_LOG_TYPE_ERROR, "%25s:%-5d [!] USBMIDIDriverBase::USBMIDIHandleInput() - protocols newer than USB MIDI 1.0 need USB MIDI 2.0 driver support, which is disabled", evtlist, 0x12u);
      }
    }
    return;
  }
...
LABEL_83:
      ...
      if (v23 - 6 < 2)
      {
        uint64_t v25 = qword_27068[(v21 >> 24) & 0xF];
        if (BYTE2(v21) == 240)
        {
...
LABEL_44:
          unint64_t v40 = qword_27068[(v21 >> 24) & 0xF] - 1;
...
LABEL_50:
      ...
      if ((~v21 & 0xF000000) == 0 && ((~v21 & 0xF80000) != 0 || (v21 & 0xFB0000) == 0xF90000))
      {
        ...
        *((unsigned char *)v18 + v57) = v24;
        if (!sub_22B5C((unsigned __int8 *)v18)) {
          goto LABEL_83;
        }
        int v58 = sub_22AE0((unsigned __int8 *)v18);
        if (!v58) {
          goto LABEL_83;
        }
        if (v58 == 4)
...
LABEL_96:
          *(void *)words = v64;
          uint64_t v93 = 0;
          ByteCount v61 = byte_270E8[v64 >> 28];
          SInt32 v59 = v17;
          MIDITimeStamp v60 = a2;
LABEL_97:
      ...
      do
      {
        ...
        if (v78 >= 2)
        {
          ...
          if (v75 && v81 != v91)
          {
            ...
            BOOL v73 = MIDIPacketListInit((MIDIPacketList *)evtlist);
            uint64_t v74 = 0;
          }
          if ((v81 & 0x80000000) == 0)
          {
          ...
          switch(v78)
          {
            ...
            case 4u:
              ...
              if (v74)
              {
                unsigned int v83 = 3;
LABEL_147:
                unint64_t v84 = &v73->data[v73->length];
...
uint64_t sub_20990(uint64_t result, MIDITimeStamp a2, char *a3, unint64_t a4, int a5, MIDIProtocolID a6)
{
  if (a6 <= kMIDIProtocol_2_0)
  {
    ...
    if ((a4 >> 2))
    {
      ...
      do
      {
        ...
        __n128 result = sub_22BD8(a6, a2, v10, (v13 - v10) >> 2, (MIDIEventList *)v21, (unint64_t)v22);
        if (!result) {
          break;
        }
...
unsigned char *sub_20AFC(uint64_t a1, uint64_t *a2, unsigned char *a3, uint64_t a4)
{
  if (a2[2]) {
...
unsigned char *sub_20E64(uint64_t a1, uint64_t *a2, unsigned char *a3, uint64_t a4, int a5)
{
  int v5 = a5;
  int v6 = a3;
  unint64_t v7 = a2;
  ...
  do
  {
    while (1)
    {
      ...
      uint64_t v11 = sub_17558(v8);
      uint64_t v12 = *(int *)(v8 + 288);
      int v13 = *(_DWORD *)(sub_17558(v8) + 8);
...
LABEL_73:
                ...
                if (v43 <= (v87 - (unint64_t)v6) >> 2)
                {
                  ...
                  while (v27 != 1)
                  {
                    if (!v27)
                    {
                      uint64_t v64 = byte_270E8[(unint64_t)*v19 >> 28];
                      uint64_t v29 = v86;
                      goto LABEL_128;
                    }
                    BOOL v45 = v32 != 1;
...
LABEL_142:
        ...
        if (v10 - (unint64_t)v6 < 4
                                        * (unint64_t)byte_270E8[(unint64_t)*v68 >> 28])
          goto LABEL_9;
LABEL_144:
        if (v16 >= v15) {
          goto LABEL_9;
      ...
      else
      {
        ...
        char v21 = v6;
        for (ItemCount i = (unsigned int *)(v17 + 4 * v16); (int)v20 >= 1; v20 = (v18 - (unint64_t)i) >> 2)
        {
          unint64_t v23 = byte_270E8[(unint64_t)*i >> 28];
          if (v23 > (uint64_t)(v10 - (void)v21) >> 2) {
            break;
          }
          if (byte_270E8[(unint64_t)*i >> 28])
          {
            char v24 = &i[v23];
            do
            {
      ...
      {
        v16 += v65;
        if (byte_270E8[(unint64_t)*v66 >> 28] > (unint64_t)((uint64_t)(v10 - (void)v6) >> 2)) {
          goto LABEL_9;
        }
        goto LABEL_144;
      }
LABEL_147:
      sub_22D78((uint64_t)&v88, v8 + 296, v7[1], v8);
      uint64_t v71 = v70;
      for (uint64_t j = v7[1]; j != v71; uint64_t j = sub_16B04(j - 296))
        ;
      v7[1] = v71;
    }
    unsigned int v16 = 0;
...
uint64_t sub_21604(int a1, MIDIObjectRef obj)
{
  CFStringRef v6 = 0;
  CFStringRef str = 0;
  CFStringRef v5 = 0;
...
BOOL sub_2170C(int a1, MIDIDeviceRef device)
{
  CFStringRef str = 0;
...
uint64_t sub_217E8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  int v8 = sub_21604(a1, a2);
  if ((v8 & 1) != 0 || (uint64_t result = sub_2170C(v8, a2), result))
  {
...
void *sub_21880(uint64_t a1, unint64_t a2)
{
...
uint64_t sub_218C8(uint64_t result, unint64_t a2, uint64_t a3, char a4)
{
  unint64_t v9 = result;
  while (2)
  {
          ...
          if (v5 || !v4)
          {
            switch(v12)
            {
              ...
              case 2uLL:
                ...
                break;
              case 3uLL:
                uint64_t result = (uint64_t)sub_222B8((uint64_t *)v10, (uint64_t *)(v10 + 12), (uint64_t *)(a2 - 12));
                break;
              case 4uLL:
                uint64_t result = (uint64_t)sub_22688(v10, v10 + 12, v10 + 24, a2 - 12);
                break;
              case 5uLL:
                BOOL v48 = (uint64_t *)(v10 + 12);
                int v49 = (uint64_t *)(v10 + 24);
                uint64_t v50 = (uint64_t *)(v10 + 36);
                uint64_t result = (uint64_t)sub_22688(v10, v10 + 12, v10 + 24, v10 + 36);
                  ...
                  if (*(unsigned __int8 *)(v10 + 38) < *(unsigned __int8 *)(v10 + 26))
                  {
                    ...
                    *(_DWORD *)(v10 + 44) = v54;
                    if (*(unsigned __int8 *)(v10 + 26) < *(unsigned __int8 *)(v10 + 14))
                    {
                      ...
                      uint64_t v57 = *v48;
                      *BOOL v48 = *v49;
                      *(_DWORD *)(v10 + 2sub_7888(&a9, 0) = *(_DWORD *)(v10 + 32);
                      *int v49 = v57;
                      *(_DWORD *)(v10 + 32) = v56;
                      if (*(unsigned __int8 *)(v10 + 14) < *(unsigned __int8 *)(v10 + 2))
                      {
                        ...
                        *BOOL v48 = v117;
                        *(_DWORD *)(v10 + 2sub_7888(&a9, 0) = v126;
                      }
                    }
                  }
                }
                ...
                do
                {
                  ...
                  if (v64 < *((unsigned __int8 *)v62 + 2))
                  {
                    ...
                    while (1)
                    {
                      ...
                      *(_DWORD *)(v67 + 2sub_7888(&a9, 0) = *(_DWORD *)(v10 + v66 + 8);
                      if (!v66) {
                        break;
                      }
                      v66 -= 12;
...
LABEL_84:
          ...
          {
            sub_222B8((uint64_t *)v9, (uint64_t *)(v9 + 12 * (v12 >> 1)), (uint64_t *)(a2 - 12));
            uint64_t v15 = 3 * v13;
            unsigned int v16 = (uint64_t *)(v9 + 12 * v13 - 12);
            sub_222B8((uint64_t *)(v9 + 12), v16, (uint64_t *)(a2 - 24));
            uint64_t v17 = (uint64_t *)(v9 + 12 + 4 * v15);
            sub_222B8((uint64_t *)(v9 + 24), v17, (uint64_t *)(a2 - 36));
            uint64_t result = (uint64_t)sub_222B8(v16, (uint64_t *)v14, v17);
          ...
          {
            uint64_t result = (uint64_t)sub_222B8((uint64_t *)(v9 + 12 * (v12 >> 1)), (uint64_t *)v9, (uint64_t *)(a2 - 12));
          }
          --a3;
          if (a4) {
            break;
          ...
          a4 = 0;
          *(_WORD *)(v10 - 12) = v35;
          *(unsigned char *)(v10 - 1sub_7888(&a9, 0) = v19;
...
LABEL_34:
        uint64_t result = sub_218C8(v9, v10 - 12, a3, a4 & 1);
        a4 = 0;
      }
      BOOL v34 = sub_223A8(v9, v10 - 12);
      uint64_t result = sub_223A8(v10, a2);
      if (result) {
        break;
      }
      if (!v34) {
...
uint64_t *sub_222B8(uint64_t *result, uint64_t *a2, uint64_t *a3)
{
...
BOOL sub_223A8(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = (a2 - a1) >> 2;
  BOOL result = 1;
  switch(0xAAAAAAAAAAAAAAABLL * v4)
  {
    ...
    case 2uLL:
      ...
      return result;
    case 3uLL:
      sub_222B8((uint64_t *)a1, (uint64_t *)(a1 + 12), (uint64_t *)(a2 - 12));
      return 1;
    case 4uLL:
      sub_22688(a1, a1 + 12, a1 + 24, a2 - 12);
      return 1;
    case 5uLL:
      int v18 = (uint64_t *)(a1 + 12);
      unsigned int v19 = (uint64_t *)(a1 + 24);
      uint64_t v20 = (uint64_t *)(a1 + 36);
      sub_22688(a1, a1 + 12, a1 + 24, a1 + 36);
        ...
        if (*(unsigned __int8 *)(a1 + 38) < *(unsigned __int8 *)(a1 + 26))
        {
          ...
          *(_DWORD *)(a1 + 44) = v24;
          if (*(unsigned __int8 *)(a1 + 26) < *(unsigned __int8 *)(a1 + 14))
          {
            ...
            uint64_t v27 = *v18;
            uint64_t *v18 = *v19;
            *(_DWORD *)(a1 + 2sub_7888(&a9, 0) = *(_DWORD *)(a1 + 32);
            uint64_t *v19 = v27;
            *(_DWORD *)(a1 + 32) = v26;
    ...
    default:
      uint64_t v9 = a1 + 24;
      sub_222B8((uint64_t *)a1, (uint64_t *)(a1 + 12), (uint64_t *)(a1 + 24));
      uint64_t v10 = a1 + 36;
      if (a1 + 36 == a2) {
        return 1;
      }
...
uint64_t *sub_22688(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  BOOL result = sub_222B8((uint64_t *)a1, (uint64_t *)a2, (uint64_t *)a3);
...
uint64_t sub_22758(uint64_t result, uint64_t a2, unint64_t a3, char *a4)
{
...
double sub_227AC(uint64_t a1, double *a2)
{
  ...
  if (v4 == *(void **)(a1 + 24))
  {
    ...
    if ((unint64_t)v5 <= *(void *)a1)
    {
      ...
      *(void *)&long long v23 = sub_16CE4(v15, v14);
      *((void *)&v23 + 1) = v23 + 8 * (v14 >> 2);
      *(void *)&long long v24 = *((void *)&v23 + 1);
      *((void *)&v24 + 1) = v23 + 8 * v16;
      sub_229D4((uint64_t)&v23, *(uint64_t **)(a1 + 8), (uint64_t)(*(void *)(a1 + 16) - *(void *)(a1 + 8)) >> 3);
      int v17 = *(void **)a1;
...
void sub_228E8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, uint64_t a11)
{
  if (__p) {
    operator delete(__p);
  }
...
uint64_t sub_22920(uint64_t a1, void *a2, uint64_t *a3)
{
  uint64_t v6 = a2[1];
  uint64_t v7 = a1 + 16;
  sub_17794(a1 + 16, (uint64_t)a3, (uint64_t)a3, *(void *)a1, *(void *)a1, v6, v6);
  a2[1] = v8;
  a2[2] = sub_22A00(v7, a3, *(uint64_t **)(a1 + 8), (void *)a2[2]);
  uint64_t v9 = *(void *)a1;
  *(void *)a1 = a2[1];
  a2[1] = v9;
...
uint64_t sub_229D4(uint64_t result, uint64_t *a2, uint64_t a3)
{
...
void *sub_22A00(uint64_t a1, uint64_t *a2, uint64_t *a3, void *a4)
{
  double result = a4;
  while (a2 != a3)
  {
...
uint64_t sub_22AE0(unsigned __int8 *a1)
{
  uint64_t result = sub_22B5C(a1);
  if (result)
  {
    unsigned int v3 = *a1;
    if (v3 >= 0x10)
...
uint64_t sub_22B5C(unsigned __int8 *a1)
{
...
uint64_t sub_22BD8(MIDIProtocolID a1, MIDITimeStamp a2, char *a3, uint64_t a4, MIDIEventList *a5, unint64_t a6)
{
  uint64_t result = 0;
  ...
  int64_t v15 = byte_270E8[(unint64_t)*(unsigned int *)a3 >> 28];
  uint64_t v16 = a3;
  if (a4 < v15) {
    return (unint64_t)(v16 - a3) >> 2;
  }
  ...
  while (1)
  {
    ...
    {
      int v17 = v27;
      int64_t v15 = byte_270E8[(unint64_t)*(unsigned int *)v16 >> 28];
...
uint64_t sub_22D78(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  uint64_t v5 = a2;
  if (a2 == a3) {
    return a2;
  ...
  do
  {
    sub_22DF8((unsigned int *)a4, (unsigned int *)v5);
    uint64_t v7 = *(void *)(v5 + 280);
    *(void *)(a4 + 285) = *(void *)(v5 + 285);
    *(void *)(a4 + 28sub_7888(&a9, 0) = v7;
    a4 += 296;
    v5 += 296;
  }
  while (v5 != v6);
...
unsigned int *sub_22DF8(unsigned int *result, unsigned int *a2)
{
  unint64_t v2 = result;
  ...
  {
    uint64_t result = (unsigned int *)((uint64_t (*)(char *, unsigned int *, unsigned int *))off_2CFA0[v3])(&v6, result, a2);
    v2[68] = -1;
    return result;
  }
  uint64_t v5 = result;
  return (unsigned int *)(*(&off_2CFB0 + v4))((int)&v5, result, a2);
}

_DWORD *sub_22E88(_DWORD **a1, void *__dst, void *__src)
{
  uint64_t v3 = *a1;
  if (v3[68]) {
    return sub_22EB4(v3, __src);
  }
  else {
    return memcpy(__dst, __src, 0x10CuLL);
  }
...
void sub_22EAC(uint64_t *a1, uint64_t a2, __n128 *a3)
{
}

_DWORD *sub_22EB4(_DWORD *__dst, void *__src)
{
  uint64_t v4 = __dst[68];
  if (v4 != -1) {
    ((void (*)(char *, _DWORD *))off_2CFA0[v4])(&v6, __dst);
  }
  __dst[68] = -1;
...
void sub_22F28(uint64_t a1, uint64_t a2, __n128 *a3)
{
  if (*(_DWORD *)(a1 + 272) == 1) {
    sub_22F48(a2, a3);
  }
  else {
    sub_22F9C(a1, (uint64_t)a3);
  }
}

__n128 sub_22F48(uint64_t a1, __n128 *a2)
{
  uint64_t v4 = *(void **)a1;
  if (v4)
  {
...
uint64_t sub_22F9C(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = *(unsigned int *)(a1 + 272);
  if (v4 != -1) {
    ((void (*)(char *, uint64_t))off_2CFA0[v4])(&v6, a1);
  }
  *(void *)a1 = 0;
  *(void *)(a1 + 8) = 0;
  *(void *)(a1 + 16) = 0;
...
void *sub_2301C(void *a1, CFStringRef format, unsigned int a3)
{
...
void *sub_23084(void *a1, CFStringRef format, uint64_t a3)
{
  CFStringRef v4 = CFStringCreateWithFormat(0, 0, format, a3);
  *a1 = &off_2CF90;
  a1[1] = v4;
...
void *sub_23100()
{
  ...
  void *result = off_2CFD0;
  return result;
}

void sub_23138(uint64_t a1, void *a2)
{
  *a2 = off_2CFD0;
}

void sub_23160(uint64_t a1, uint64_t *a2)
{
  uint64_t v2 = *a2;
  sub_1BAB8();
  if (v2)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v8 = 1024;
      int v9 = 654;
      _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_DEBUG, "%25s:%-5d ==========================================================================================================", (uint8_t *)&v6, 0x12u);
    }
    sub_1BAB8();
    CFStringRef v4 = qword_301B0;
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
    {
      int v6 = 136315650;
      uint64_t v7 = "USBMIDIDriverBase.cpp";
      ...
      __int16 v10 = 1024;
      int v11 = v2;
      _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_DEBUG, "%25s:%-5d NOTICE: USB MIDI Driver destructive tracing at level %d", (uint8_t *)&v6, 0x18u);
    }
    sub_1BAB8();
    uint64_t v5 = qword_301B0;
    if (os_log_type_enabled((os_log_t)qword_301B0, OS_LOG_TYPE_DEBUG))
    {
      int v6 = 136315394;
      uint64_t v7 = "USBMIDIDriverBase.cpp";
      __int16 v8 = 1024;
      int v9 = 656;
      _os_log_impl(&def_21CC0, v5, OS_LOG_TYPE_DEBUG, "%25s:%-5d ==========================================================================================================", (uint8_t *)&v6, 0x12u);
    }
  }
}

void sub_232F0(void *a1@<X1>, void *a2@<X2>, void *a3@<X3>, unsigned int *a4@<X4>, void *a5@<X8>)
{
  __int16 v10 = operator new(0x208uLL);
  sub_23384(v10, a1, a2, a3, a4);
  *a5 = v10 + 3;
  a5[1] = v10;

  sub_18650((uint64_t)a5, v10 + 11, (uint64_t)(v10 + 3));
}

void sub_23370(_Unwind_Exception *a1)
{
  operator delete(v1);
  _Unwind_Resume(a1);
}

void *sub_23384(void *a1, void *a2, void *a3, void *a4, unsigned int *a5)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2D018;
  sub_FF98(a1 + 3, *a2, *a3, *a4, *a5);
  return a1;
}

void sub_233DC(_Unwind_Exception *a1)
{
  std::__shared_weak_count::~__shared_weak_count(v1);
  _Unwind_Resume(a1);
}

void sub_233F0(std::__shared_weak_count *this)
{
  this->__vftable = (std::__shared_weak_count_vtbl *)off_2D018;
  std::__shared_weak_count::~__shared_weak_count(this);
}

void sub_23410(std::__shared_weak_count *a1)
{
  a1->__vftable = (std::__shared_weak_count_vtbl *)off_2D018;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_23464(uint64_t a1)
{
  return (**(uint64_t (***)(void))(a1 + 24))();
}
...
void sub_23554(uint64_t a1)
{
  CFUUIDRef v2 = CFUUIDGetConstantUUIDWithBytes(0, 0, 3u, 0xB0u, 0xFAu, 0xBAu, 0xD9u, 0x11u, 0xD5u, 0xB1u, 0x3Au, 0, 3u, 0x93u, 1u, 0xA6u, 0xE6u);
  sub_1FA64(a1, v2);
}
...
void sub_236A8()
{
  if ((byte_301C0 & 1) == 0)
  {
    ...
    if (BundleWithIdentifier)
    {
      ...
      off_30080 = (__CFString *)CFBundleCopyLocalizedString(v1, off_30080, off_30080, @"USBMIDILocalizable");
      off_30088 = (__CFString *)CFBundleCopyLocalizedString(v1, off_30088, off_30088, @"USBMIDILocalizable");
      off_30090 = (__CFString *)CFBundleCopyLocalizedString(v1, off_30090, off_30090, @"USBMIDILocalizable");
      off_30098 = (__CFString *)CFBundleCopyLocalizedString(v1, off_30098, off_30098, @"USBMIDILocalizable");
      off_300A8 = (__CFString *)CFBundleCopyLocalizedString(v1, off_300A8, off_300A8, @"USBMIDILocalizable");
      off_300A0 = (__CFString *)CFBundleCopyLocalizedString(v1, off_300A0, off_300A0, @"USBMIDILocalizable");
      CFRelease(v1);
      byte_301C0 = 1;
    }
  }
...
void sub_239D4()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_301D0, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_301D0))
  {
    qword_301C8 = (uint64_t)os_log_create("com.apple.coremidi", "usbdrv");
    __cxa_guard_release(&qword_301D0);
  }
}

uint64_t sub_23A44(uint64_t a1)
{
  sub_239D4();
  CFUUIDRef v2 = qword_301C8;
  if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_INFO))
  {
    int v6 = 136315394;
    uint64_t v7 = "USBMIDIClassDriver.cpp";
    __int16 v8 = 1024;
    int v9 = 122;
    _os_log_impl(&def_21CC0, v2, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIClassDriver::Stop()", (uint8_t *)&v6, 0x12u);
  }
  uint64_t v3 = *(void *)(a1 + 104);
  if (v3) {
...
__CFString *sub_23B64()
{
  return off_30080;
}

__CFString *sub_23B70()
{
  return off_30088;
}

__CFString *sub_23B7C()
{
  return off_30090;
}
...
uint64_t sub_23B90(uint64_t a1, uint64_t a2, uint64_t a3)
{
  sub_239D4();
  int v6 = qword_301C8;
  if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&v33[8] = 2048;
    *(void *)&v33[10] = a3;
    _os_log_impl(&def_21CC0, v6, OS_LOG_TYPE_INFO, "%25s:%-5d [+] USBMIDIClassDriver::CreateDevice(%p, %p)", buf, 0x26u);
  }
  outuint64_t Device = 0;
  sub_1FC38(a2, a3, (uint64_t)buf);
  if (!*(void *)buf)
  {
    uint64_t v17 = 0;
    goto LABEL_39;
  ...
  __p = 0;
  long long v24 = 0uLL;
  if (!*(unsigned char *)(a1 + 112) || v36 == v37)
  {
    sub_1E1D0(a2, BYTE2(v31), (uint64_t *)v34, (uint64_t *)v35, (uint64_t *)v28);
    *(_OWORD *)int v25 = *(_OWORD *)v28;
    uint64_t v26 = *(void *)&v28[16];
  }
  else
  {
    sub_1D2F8(a2, BYTE2(v31), (uint64_t)&v36, (uint64_t *)v28);
    int v9 = *(void **)v28;
    __p = *(void **)v28;
    ...
    sub_239D4();
    long long v21 = qword_301C8;
    if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)int v28 = 136315394;
      *(void *)&v28[4] = "USBMIDIClassDriver.cpp";
      *(_WORD *)&v28[12] = 1024;
      *(_DWORD *)&v28[14] = 236;
      _os_log_impl(&def_21CC0, v21, OS_LOG_TYPE_ERROR, "%25s:%-5d      Unable to create USB MIDI 2.0 maplist. Falling back to USB MIDI 1.0.", v28, 0x12u);
    }
  }
  int v11 = 0;
  int v9 = v25[0];
...
LABEL_10:
  if (v9 == v10)
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v28[12] = 1024;
      *(_DWORD *)&v28[14] = 245;
      _os_log_impl(&def_21CC0, v18, OS_LOG_TYPE_ERROR, "%25s:%-5d [-] USBMIDIClassDriver::CreateDevice() - Fatal error: mapList is empty, so entities cannot be constructed.", v28, 0x12u);
    }
  }
  else
  {
    CFStringRef v12 = sub_1B8CC(a2, off_30080);
    CFStringRef v14 = v13;
    MIDIDeviceCreate((MIDIDriverRef)(a1 + 8), v13, v12, v13, &outDevice);
    if (v12 && off_30080 && CFStringCompare(v12, off_30080, 0)) {
      CFRelease(v12);
    }
    unsigned __int16 v22 = 0;
    (*(void (**)(uint64_t, unsigned __int16 *))(*(void *)v8 + 104))(v8, &v22);
    int v15 = v22;
    if (v11 && sub_1E72C(a2, outDevice, &__p, (uint64_t *)&v36, off_30098, off_300A0, v14)
      || sub_1F294(a2, off_30090, outDevice, (uint64_t *)v25, (uint64_t *)&v33[4], v34, v35, v14, v15 == 1452))
    {
      if (v14 && off_30088 && CFStringCompare(v14, off_30088, 0)) {
        CFRelease(v14);
      }
      sub_239D4();
      uint64_t v16 = qword_301C8;
      if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v28[20] = outDevice;
        _os_log_impl(&def_21CC0, v16, OS_LOG_TYPE_INFO, "%25s:%-5d [-] USBMIDIClassDriver::CreateDevice() returning 0x%x", v28, 0x18u);
      }
    ...
    if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v28[12] = 1024;
      *(_DWORD *)&v28[14] = 265;
      _os_log_impl(&def_21CC0, v19, OS_LOG_TYPE_ERROR, "%25s:%-5d [-] USBMIDIClassDriver::CreateDevice() - Fatal error: unable to construct entities with the suppplied port map. The device will not be added to the setup.", v28, 0x12u);
    }
    uint64_t v17 = 0;
    if (!v14 || !off_30088) {
      goto LABEL_35;
    }
    if (CFStringCompare(v14, off_30088, 0)) {
      CFRelease(v14);
    }
  }
  uint64_t v17 = 0;
...
void sub_240C0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, uint64_t a12, void *a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21)
{
  if (__p) {
    operator delete(__p);
  }
...
uint64_t sub_24118(uint64_t a1, uint64_t a2)
{
  return *(void *)(a2 + 96);
}

void sub_24128(int a1, uint64_t a2, MIDITimeStamp a3, char *a4, int64_t a5, uint64_t a6, MIDIProtocolID a7)
{
}

unsigned char *sub_24144(uint64_t a1, uint64_t a2, uint64_t *a3, unsigned char *a4, uint64_t a5)
{
  return sub_20AFC(a2, a3, a4, a5);
}

unsigned char *sub_2415C(uint64_t a1, uint64_t a2, uint64_t *a3, unsigned char *a4, uint64_t a5, int a6)
{
  return sub_20E64(a2, a3, a4, a5, a6);
}

void sub_24174(int a1, uint64_t a2, uint64_t a3, MIDIObjectRef a4)
{
  uint64_t v7 = sub_1B894(a2, a3);
  if (a4)
  {
    if (v7)
    {
      ...
      if (v8)
      {
        CFStringRef str = sub_1B8CC(a2, off_30080);
        ...
        if (sub_21604(a1, a4))
        {
          ...
          if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&unsigned char buf[12] = 1024;
            *(_DWORD *)&buf[14] = 342;
            _os_log_impl(&def_21CC0, v11, OS_LOG_TYPE_INFO, "%25s:%-5d Manufacturer, model, or name is generic.", buf, 0x12u);
          }
          *(void *)buf = 0;
          CFStringRef v47 = 0;
          CFStringRef v44 = 0;
          ...
          {
            if (CFEqual(*(CFTypeRef *)buf, off_30080) && str)
            {
          ...
          {
            if (CFEqual(v47, off_30088) && theString1)
            {
          ...
          {
            if (CFEqual(v44, off_30088) && theString1)
            {
              MIDIObjectSetStringProperty(a4, kMIDIPropertyModel, theString1);
              MIDIObjectSetStringProperty(a4, kMIDIPropertyName, theString1);
              int v12 = 1;
          ...
          CFStringRef v13 = str;
          if (str && off_30080 && CFStringCompare(str, off_30080, 0)) {
            CFRelease(v13);
          }
          CFStringRef str = 0;
          CFStringRef v14 = theString1;
          if (theString1 && off_30088 && CFStringCompare(theString1, off_30088, 0)) {
            CFRelease(v14);
          }
...
LABEL_86:
          if (sub_2170C(a1, a4))
          {
            ...
            if (os_log_type_enabled((os_log_t)qword_301C8, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&unsigned char buf[12] = 1024;
              *(_DWORD *)&buf[14] = 400;
              _os_log_impl(&def_21CC0, v15, OS_LOG_TYPE_INFO, "%25s:%-5d Entity name is generic.", buf, 0x12u);
            }
          }
          CFStringRef v47 = 0;
          CFStringRef v48 = 0;
          ...
          unsigned int v39 = 0;
          uint64_t v40 = 0;
          sub_1BB28(v9, (uint64_t)buf);
          sub_9F78(a3);
          sub_1BCA8(v9, *(unsigned __int8 **)buf, &v47, (char **)&v44, (char **)&v41, (unsigned __int8 **)&__p);
          unint64_t v16 = 0xAAAAAAAAAAAAAAABLL * (((char *)v45 - (char *)v44) >> 1);
          int v17 = -1431655765 * ((v42 - (unsigned char *)v41) >> 1);
          if ((int)v16 <= v17) {
            uint64_t v18 = v17;
          }
          else {
          ...
          if (v18 == MIDIDeviceGetNumberOfEntities(a4)
            && !MIDIObjectGetStringProperty(a4, kMIDIPropertyModel, &theString1))
          {
            if ((int)v18 >= 1)
            {
              ...
              while (1)
              {
                ...
                CFStringRef v22 = v19 >= v32 ? 0 : sub_1E640(a2, *((unsigned __int8 *)&v44->isa + v20), theString1);
                if (v19 >= v31) {
                  break;
                }
                CFStringRef v23 = sub_1E640(a2, *((unsigned __int8 *)v41 + v20), theString1);
                CFStringRef v24 = v23;
...
void *sub_24870(uint64_t a1)
{
  __n128 result = operator new(0x10uLL);
  uint64_t v3 = *(void *)(a1 + 8);
  void *result = off_2D130;
  result[1] = v3;
  return result;
}

uint64_t sub_248B8(uint64_t result, void *a2)
{
  uint64_t v2 = *(void *)(result + 8);
  *a2 = off_2D130;
  a2[1] = v2;
...
uint64_t sub_248E4(uint64_t result, unsigned char *a2)
{
  if (*a2) {
    *(unsigned char *)(*(void *)(result + 8) + 112) = 1;
  }
  return result;
}

void *sub_248FC(void *a1, uint64_t a2)
{
  uint64_t v4 = (void *)sub_A4E0(a1, *(void *)(a2 + 8));
  *uint64_t v4 = &off_2D178;
  v4[8] = a2;
  sub_634C((uint64_t)v4);
  return a1;
}

void sub_24950(_Unwind_Exception *a1)
{
  sub_60E0(v1);
  _Unwind_Resume(a1);
}

BOOL sub_2496C(uint64_t a1, uint64_t a2)
{
  if ((*(unsigned int (**)(uint64_t))(*(void *)a1 + 56))(a1))
  {
    sub_24B5C();
    uint64_t v3 = qword_301D8;
    BOOL result = os_log_type_enabled((os_log_t)qword_301D8, OS_LOG_TYPE_INFO);
    if (!result) {
      return result;
    }
    *(_DWORD *)buf = 136315650;
    ...
    __int16 v15 = 2048;
    uint64_t v16 = a2;
    _os_log_impl(&def_21CC0, v3, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIInterfaceManager::MatchInterface(%p) - already using interface; failing match",
      buf,
      0x1Cu);
    return 0;
  }
  uint64_t v5 = sub_9B74(a2);
  __int16 v10 = 0;
  int v6 = (*(uint64_t (**)(uint64_t, char *))(*(void *)v5 + 80))(v5, (char *)&v10 + 1);
  BOOL result = 0;
  if (v6) {
    BOOL v7 = 0;
  }
  else {
    BOOL v7 = HIBYTE(v10) == 1;
  }
  if (v7)
  {
    if ((*(unsigned int (**)(uint64_t, __int16 *))(*(void *)v5 + 88))(v5, &v10)) {
      return 0;
    }
    sub_24B5C();
    uint64_t v8 = qword_301D8;
    if (os_log_type_enabled((os_log_t)qword_301D8, OS_LOG_TYPE_INFO))
    {
      int v12 = "USBMIDIInterfaceManager.cpp";
      *(_DWORD *)buf = 136315906;
      __int16 v13 = 1024;
      ...
      __int16 v17 = 2080;
      uint64_t v18 = v9;
      _os_log_impl(&def_21CC0, v8, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIInterfaceManager::MatchInterface(%p) - returning %s", buf, 0x26u);
    }
    return v10 == 3;
  }
  return result;
...
void sub_24B5C()
{
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_301E0, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_301E0))
  {
    qword_301D8 = (uint64_t)os_log_create("com.apple.coremidi", "usbinf");
    __cxa_guard_release(&qword_301E0);
  }
}

uint64_t sub_24BCC(uint64_t a1, uint64_t *a2)
{
  return sub_18D30(*(void *)(a1 + 64), *a2, (uint64_t)a2);
}

BOOL sub_24BDC(uint64_t a1, int a2)
{
  return sub_1A9CC(*(void *)(a1 + 64), a2);
}

BOOL sub_24BE4(uint64_t a1, uint64_t *a2)
{
  return a2 && sub_1A98C(*(void *)(a1 + 64), *a2);
}

uint64_t sub_24BFC(uint64_t a1, uint64_t a2)
{
  sub_24B5C();
  uint64_t v4 = qword_301D8;
  if (os_log_type_enabled((os_log_t)qword_301D8, OS_LOG_TYPE_INFO))
  {
    int v6 = 136315650;
    BOOL v7 = "USBMIDIInterfaceManager.cpp";
    __int16 v8 = 1024;
    int v9 = 70;
    __int16 v10 = 1024;
    int v11 = a2;
    _os_log_impl(&def_21CC0, v4, OS_LOG_TYPE_INFO, "%25s:%-5d [*] USBMIDIInterfaceMangaer::RequestTerminateService(%u) -- The interface will now be closed to allow other drivers to match in response to an interface seize attempt.", (uint8_t *)&v6, 0x18u);
  }
  return (*(uint64_t (**)(void, uint64_t))(**(void **)(a1 + 64) + 24))(*(void *)(a1 + 64), a2);
}

void sub_24CFC(uint64_t a1)
{
  sub_60E0(a1);
...
void sub_24D34(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_24D70(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_24DAC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_24DE8(uint64_t a1, int a2)
{
  v2[0] = 67109378;
  v2[1] = a2;
  __int16 v3 = 2080;
  uint64_t v4 = a1;
  _os_log_error_impl(&def_21CC0, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, " CAMutex::Try: call to pthread_mutex_trylock failed, Error: %d (%s)", (uint8_t *)v2, 0x12u);
}

uint64_t sub_24E74(uint64_t a1)
{
