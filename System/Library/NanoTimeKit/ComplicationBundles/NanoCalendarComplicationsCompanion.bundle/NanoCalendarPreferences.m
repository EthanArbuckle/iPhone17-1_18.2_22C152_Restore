...
{
  if (qword_281C0 != -1) {
    dispatch_once(&qword_281C0, &stru_206F0);
  }
  v2 = (void *)qword_281B8;
...
- (BOOL)overlayCalendarIsEnabled
{
  ...
  unsigned int v3 = [v2 isEqualToString:&stru_20EE0] ^ 1;
  if (v2) {
    BOOL v4 = v3;
  }
  else {
...
- (void)_reportOverlayCalendarID:(id)a3 mirroringCompanion:(BOOL)a4
{
  ...
  id v11 = v10;
  if ([(__CFString *)v7 isEqualToString:&stru_20EE0]) {
    long long v12 = @"off";
  }
  else {
    long long v12 = v7;
  ...
  if ([(__CFString *)v11 isEqualToString:&stru_20EE0]) {
    long long v14 = @"off";
  }
  else {
    long long v14 = v11;
...
+ (id)currentSelectedCalendarsForEventStore:(id)a3
{
  return _[a1 currentSelectedCalendarsForEventStore:a3 filteredForFocus:0];
}
...
{
  if (qword_281D0 != -1) {
    dispatch_once(&qword_281D0, &stru_20738);
  }
  v2 = (void *)qword_281C8;
...
{
  if (qword_281E0 != -1) {
    dispatch_once(&qword_281E0, &stru_20758);
  }
  v2 = (void *)qword_281D8;
