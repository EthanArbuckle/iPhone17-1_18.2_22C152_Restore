...
- (void)fetchWidgetMigrationForDescriptor:(CLKComplicationDescriptor *)a3 family:(int64_t)a4 completion:(id)a5
{
  ...
  v16 = a3;
  v17 = self;
  sub_5720((uint64_t)v10, (uint64_t)&unk_C3E8, (uint64_t)v15);
  swift_release();
}
...
+ (NSString)localizedAppName
{
  ...
  sub_6FC0(v9, v10, v4, v11, v7);

  NSString v5 = sub_7020();
...
{
  NSString v2 = self;
  id v3 = sub_6658((uint64_t)[(ComplicationsDataSource *)v2 family]);
...
- (void)getCurrentTimelineEntryWithHandler:(id)a3
{
  ...
  id v11 = sub_6658((uint64_t)[(ComplicationsDataSource *)v10 family]);
  sub_6FE0();
  id v12 = v11;
  Class isa = sub_6FD0().super.isa;
