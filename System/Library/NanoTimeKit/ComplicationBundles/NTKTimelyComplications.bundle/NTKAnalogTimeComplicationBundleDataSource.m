...
+ (id)bundleIdentifier
{
  return @"com.apple.NanoTimeKit.AnalogTime";
}
...
+ (id)localizedComplicationName
{
  ...
  v3 = [v2 localizedStringForKey:@"COMPLICATION_TITLE" value:&stru_10610 table:@"AnalogTime"];
...
- (id)currentSwitcherTemplate
{
  return [(NTKAnalogTimeComplicationBundleDataSource *)self sampleTemplate];
}
...
- (void)getCurrentTimelineEntryWithHandler:(id)a3
{
  ...
  id v10 = (id)v6;
  unsigned int v7 = [(NTKAnalogTimeComplicationBundleDataSource *)self _graphicTemplateWithOverrideDate:v6];
  v8 = +[NSDate date];
...
{
  id v4 = a3;
  id v5 = (int *)[(NTKAnalogTimeComplicationBundleDataSource *)self family];
