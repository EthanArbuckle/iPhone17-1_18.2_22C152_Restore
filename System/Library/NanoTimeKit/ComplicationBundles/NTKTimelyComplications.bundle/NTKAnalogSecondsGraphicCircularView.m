...
{
  v9.receiver = self;
  v9.super_class = (Class)NTKAnalogSecondsGraphicCircularView;
  [(NTKAnalogSecondsGraphicCircularView *)&v9 layoutSubviews];
  v3 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
- (id)initFullColorImageViewWithDevice:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)NTKAnalogSecondsGraphicCircularView;
  v5 = -[NTKAnalogSecondsGraphicCircularView initWithFrame:](&v9, "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  if (v5)
  {
...
- (void)pauseLiveFullColorImageView
{
  id v2 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
{
  id v6 = a3;
  id v7 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
{
  id v4 = a3;
  id v5 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
  [v5 setFilterProvider:v4];
}

- (void)transitionToMonochromeWithFraction:(double)a3
{
  id v4 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
{
  id v3 = a3;
  id v4 = [[NTKWorldClockGraphicCircularViewSecondsOnly alloc] initWithDevice:v3 smallTickCount:5];
