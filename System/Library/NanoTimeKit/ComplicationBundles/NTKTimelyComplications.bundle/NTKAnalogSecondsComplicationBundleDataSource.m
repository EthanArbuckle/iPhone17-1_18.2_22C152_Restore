@interface NTKAnalogSecondsComplicationBundleDataSource
...
@implementation NTKAnalogSecondsComplicationBundleDataSource

+ (id)bundleIdentifier
{
  return @"com.apple.NanoTimeKit.AnalogSeconds";
}
...
+ (id)localizedComplicationName
{
  ...
  v3 = [v2 localizedStringForKey:@"COMPLICATION_TITLE" value:&stru_10610 table:@"AnalogSeconds"];
...
- (id)currentSwitcherTemplate
{
  return [(NTKAnalogSecondsComplicationBundleDataSource *)self sampleTemplate];
}
...
{
  v3 = NTKIdealizedDate();
  v4 = [(NTKAnalogSecondsComplicationBundleDataSource *)self _graphicTemplateWithOverrideDate:v3];
...
- (void)getCurrentTimelineEntryWithHandler:(id)a3
{
  ...
  id v10 = (id)v6;
  unsigned int v7 = [(NTKAnalogSecondsComplicationBundleDataSource *)self _graphicTemplateWithOverrideDate:v6];
  v8 = +[NSDate date];
...
{
  id v4 = a3;
  id v5 = (int *)[(NTKAnalogSecondsComplicationBundleDataSource *)self family];
  uint64_t v6 = +[CLKFullColorImageProvider fullColorImageProviderWithImageViewClass:objc_opt_class()];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    uint64_t v11 = NTKWorldClockGraphicCircularViewOverrideDateKey;
    id v12 = v4;
