...
+ (id)localizedStringForKey:(id)a3 comment:(id)a4
{
  return [a1 localizedStringForKey:a3 table:@"NTKTroutLocalizable" comment:a4];
}
...
- (id)galleryFacesForDevice:(id)a3
{
  ...
  {
    v9.receiver = self;
    v9.super_class = (Class)NTKTroutFaceBundle;
    uint64_t v6 = [(NTKTroutFaceBundle *)&v9 galleryFacesForDevice:v4];
  }
  else
  {
    uint64_t v6 = [(NTKTroutFaceBundle *)self _legacyGalleryFacesForDevice:v4];
  }
  v7 = (void *)v6;
...
- (id)_legacyGalleryFacesForDevice:(id)a3
{
  ...
  long long v18 = 0u;
  long long v19 = 0u;
  id v5 = [&off_3AC20 countByEnumeratingWithState:&v16 objects:v20 count:16];
  if (v5)
  {
    id v6 = v5;
    ...
    do
    {
      ...
      {
        if (*(void *)v17 != v7) {
          objc_enumerationMutation(&off_3AC20);
        }
      ...
      id v6 = [&off_3AC20 countByEnumeratingWithState:&v16 objects:v20 count:16];
    }
    while (v6);
  }
  id v14 = [v4 copy];
...
- (id)heroFacesForDevice:(id)a3
{
  ...
  {
    v8 = [(NTKTroutFaceBundle *)self defaultFaceForDevice:v4];
