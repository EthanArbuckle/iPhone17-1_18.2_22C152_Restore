...
- (id)dateComplicationSlotForDevice:(id)a3;
- (id)orderedComplicationSlots;
- (id)richComplicationSlotsForDevice:(id)a3;
- (unint64_t)dateComplicationSlotSupportedStylesForDevice:(id)a3;
@end
...
{
  v3.receiver = self;
  v3.super_class = (Class)NTKAlaskanComplicationsConfiguration;
...
{
  v7.receiver = self;
  v7.super_class = (Class)NTKAlaskanComplicationsConfiguration;
