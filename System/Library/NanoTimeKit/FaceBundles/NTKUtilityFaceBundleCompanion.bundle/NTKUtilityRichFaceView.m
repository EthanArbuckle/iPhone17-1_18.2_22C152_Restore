...
{
  v9.receiver = self;
  v9.super_class = (Class)NTKUtilityRichFaceView;
...
- (void)_configureComplicationView:(id)a3 forSlot:(id)a4
{
  ...
  id v7 = a4;
  v12.receiver = self;
  v12.super_class = (Class)NTKUtilityRichFaceView;
  ...
  if ([v6 conformsToProtocol:&OBJC_PROTOCOL___NTKUtilityComplicationView])
  {
    ...
    if ([v7 isEqualToString:NTKComplicationSlotBottomCenter])
    {
      ...
      id v9 = +[UIColor colorWithRed:0.701960784 green:0.701960784 blue:0.701960784 alpha:1.0];
