...
- (id)_defaultOptionForCustomEditMode:(int64_t)a3 slot:(id)a4
{
  ...
  if (a3 == 10)
  {
    v9 = [(NTKAnalogMetallicFace *)self device];
    uint64_t v10 = +[NTKMetallicColorEditOption optionWithColor:0 forDevice:v9];
    goto LABEL_5;
  }
  if (a3 == 15)
  {
    v7 = [(NTKAnalogMetallicFace *)self device];
...
- (BOOL)_hasOptionsForCustomEditMode:(int64_t)a3
{
  ...
  v3 = [(NTKAnalogMetallicFace *)self device];
...
{
  id v7 = a3;
  BOOL v8 = [(NTKAnalogMetallicFace *)self _optionClassForCustomEditMode:a4];
  v9 = [(NTKAnalogMetallicFace *)self device];
...
- (unint64_t)_numberOfOptionsForCustomEditMode:(int64_t)a3 slot:(id)a4
{
  v5 = -[NTKAnalogMetallicFace _optionClassForCustomEditMode:](self, "_optionClassForCustomEditMode:", a3, a4);
  id v6 = [(NTKAnalogMetallicFace *)self device];
...
- (id)_optionAtIndex:(unint64_t)a3 forCustomEditMode:(int64_t)a4 slot:(id)a5
{
  id v7 = [(NTKAnalogMetallicFace *)self _optionClassForCustomEditMode:a4];
  BOOL v8 = [(NTKAnalogMetallicFace *)self device];
...
- (id)faceSharingName
{
  return +[NTKLiquidMetalFaceBundle localizedStringForKey:@"LIQUID_METAL_IN_TITLE_CASE" table:@"LiquidMetal" comment:@"Liquid Metal"];
}

- (id)editOptionThatHidesAllComplications
{
  uint64_t v3 = [(NTKAnalogMetallicFace *)self device];
...
- (id)faceDescription
{
  return +[NTKLiquidMetalFaceBundle localizedStringForKey:@"LIQUID_METAL_DESCRIPTION" table:@"LiquidMetal" comment:@"Liquid Metal description"];
}
