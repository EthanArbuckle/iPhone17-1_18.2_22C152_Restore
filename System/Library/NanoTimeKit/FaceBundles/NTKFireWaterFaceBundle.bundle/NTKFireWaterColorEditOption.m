...
- (unint64_t)color
{
  return (unint64_t)[(NTKFireWaterColorEditOption *)self _value];
}
...
+ (id)_localizedNameForValue:(unint64_t)a3 forDevice:(id)a4
{
  ...
  {
    v12.receiver = a1;
    v12.super_class = (Class)&OBJC_METACLASS___NTKFireWaterColorEditOption;
    v10 = objc_msgSendSuper2(&v12, "_localizedNameForValue:forDevice:", a3, v6);
    uint64_t v8 = @"FireWater";
  }
  else
  {
    id v7 = *(&off_8258 + a3);
    uint64_t v8 = [@"FireWater" stringByAppendingString:@"-Companion"];
...
{
  if (qword_CB08 != -1) {
    dispatch_once(&qword_CB08, &stru_8220);
  }
  v2 = (void *)qword_CB00;
