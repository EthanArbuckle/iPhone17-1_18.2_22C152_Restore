...
- (NTKPoodleStopwatchComplicationView)initWithBackgroundView:(id)a3;
@end
...
{
  v4.receiver = self;
  v4.super_class = (Class)NTKPoodleStopwatchComplicationView;
  return [(NTKZeusStopwatchComplicationView *)&v4 initWithBackgroundView:a3];
}
