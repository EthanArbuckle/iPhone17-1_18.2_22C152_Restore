...
- (id)_defaultOptionForCustomEditMode:(int64_t)a3 slot:(id)a4
{
  ...
  if (a3 == 10)
  {
    ...
    uint64_t v10 = +[NTKSmokeColorEditOption optionWithColor:0 forDevice:v9];
    goto LABEL_5;
  }
  if (a3 == 15)
  {
...
- (id)faceSharingName
{
  return +[NTKVaporFaceBundle localizedStringForKey:@"VAPOR_IN_TITLE_CASE" table:@"Vapor" comment:@"Vapor"];
}

- (unint64_t)_indexOfOption:(id)a3 forCustomEditMode:(int64_t)a4 slot:(id)a5
{
  id v7 = a3;
  BOOL v8 = [(NTKAnalogSmokeFace *)self _optionClassForCustomEditMode:a4];
  v9 = [(NTKAnalogSmokeFace *)self device];
...
- (unint64_t)_numberOfOptionsForCustomEditMode:(int64_t)a3 slot:(id)a4
{
  v5 = -[NTKAnalogSmokeFace _optionClassForCustomEditMode:](self, "_optionClassForCustomEditMode:", a3, a4);
  id v6 = [(NTKAnalogSmokeFace *)self device];
...
- (id)_optionAtIndex:(unint64_t)a3 forCustomEditMode:(int64_t)a4 slot:(id)a5
{
  id v7 = [(NTKAnalogSmokeFace *)self _optionClassForCustomEditMode:a4];
  BOOL v8 = [(NTKAnalogSmokeFace *)self device];
...
- (id)editOptionThatHidesAllComplications
{
  uint64_t v3 = [(NTKAnalogSmokeFace *)self device];
...
- (id)faceDescription
{
  return +[NTKVaporFaceBundle localizedStringForKey:@"VAPOR_DESCRIPTION" table:@"Vapor" comment:@"Vapor description"];
}
