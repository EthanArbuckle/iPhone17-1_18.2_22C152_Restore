...
- (id)initForDevice:(id)a3
{
  ...
  v22.receiver = self;
  v22.super_class = (Class)NTKGalleonHandsView;
  v3 = [(NTKAnalogHandsView *)&v22 initForDevice:a3];
  v7 = v3;
  if (v3)
  {
    v3[77] = 0x3FF0000000000000;
    ...
    v21.receiver = v7;
    v21.super_class = (Class)NTKGalleonHandsView;
...
- (void)setPalette:(id)a3
{
  ...
  MEMORY[0x270F9A6D0](self, sel__applyPalette, v4, v5);
}

- (void)_applyPalette
{
  uint64_t v5 = objc_msgSend_palette(self, a2, v2, v3);
  v9 = objc_msgSend_timeHourHandInlayColor(v5, v6, v7, v8);
  v13 = objc_msgSend_hourHandView(self, v10, v11, v12);
  objc_msgSend_setInlayColor_(v13, v14, (uint64_t)v9, v15);

  uint64_t v19 = objc_msgSend_palette(self, v16, v17, v18);
  v23 = objc_msgSend_timeHourHandInlayColor(v19, v20, v21, v22);
  v27 = objc_msgSend_minuteHandView(self, v24, v25, v26);
  objc_msgSend_setInlayColor_(v27, v28, (uint64_t)v23, v29);
  ...
  objc_msgSend_setColor_(v41, v42, (uint64_t)v37, v43);
  ...
  objc_msgSend_setColor_(v55, v56, (uint64_t)v51, v57);

  v61 = objc_msgSend_palette(self, v58, v59, v60);
  v65 = objc_msgSend_secondHand(v61, v62, v63, v64);
  v69 = objc_msgSend_secondHandView(self, v66, v67, v68);
  objc_msgSend_setColor_(v69, v70, (uint64_t)v65, v71);
  ...
  objc_msgSend_setInlayColor_(v83, v84, (uint64_t)v79, v85);
  ...
  objc_msgSend_setInlayColor_(v97, v98, (uint64_t)v93, v99);
  ...
  objc_msgSend_setColor_(v111, v112, (uint64_t)v107, v113);
  ...
  objc_msgSend_setColor_(v125, v126, (uint64_t)v121, v127);

  objc_msgSend_palette(self, v128, v129, v130);
  id v141 = (id)objc_claimAutoreleasedReturnValue();
  v134 = objc_msgSend_secondHand(v141, v131, v132, v133);
  v138 = objc_msgSend_secondHandViewAlt(self, v135, v136, v137);
  objc_msgSend_setColor_(v138, v139, (uint64_t)v134, v140);
}

- (id)hourHandConfiguration
{
  uint64_t v5 = objc_msgSend_device(self, a2, v2, v3, 0, 0, 0, 0, 0, 0);
  sub_246B34CEC(v5, &v18);

  uint64_t v6 = (void *)MEMORY[0x263F57920];
  uint64_t v10 = objc_msgSend_device(self, v7, v8, v9);
  v13 = objc_msgSend_defaultHourConfigurationForDevice_(v6, v11, (uint64_t)v10, v12);
...
- (id)minuteHandConfiguration
{
  ...
  uint64_t v6 = (void *)MEMORY[0x263F57920];
  uint64_t v10 = objc_msgSend_device(self, v7, v8, v9);
  v13 = objc_msgSend_defaultMinuteConfigurationForDevice_(v6, v11, (uint64_t)v10, v12);
...
- (id)secondHandConfiguration
{
  ...
  uint64_t v6 = (void *)MEMORY[0x263F57920];
  uint64_t v10 = objc_msgSend_device(self, v7, v8, v9);
  v13 = objc_msgSend_defaultSecondConfigurationForDevice_(v6, v11, (uint64_t)v10, v12);
