...
{
  v9.receiver = self;
  v9.super_class = (Class)NTKCharacterRichFaceView;
...
- (void)_configureComplicationView:(id)a3 forSlot:(id)a4
{
  id v6 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NTKCharacterRichFaceView;
  ...
  {
    id v8 = v6;
    objc_super v9 = +[UIColor colorWithRed:0.701960784 green:0.701960784 blue:0.701960784 alpha:1.0];
...
{
  v5.receiver = self;
  v5.super_class = (Class)NTKCharacterRichFaceView;
  id v2 = [(NTKCharacterFaceView *)&v5 _newScaleView];
