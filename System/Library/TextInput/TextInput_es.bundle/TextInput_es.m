...
void std::__shared_ptr_emplace<KB::InputManagerSpecialization_es>::~__shared_ptr_emplace(std::__shared_weak_count *this)
{
  this->__vftable = (std::__shared_weak_count_vtbl *)&unk_26F5DC130;
  std::__shared_weak_count::~__shared_weak_count(this);
}

void std::__shared_ptr_emplace<KB::InputManagerSpecialization_es>::~__shared_ptr_emplace(std::__shared_weak_count *a1)
{
  a1->__vftable = (std::__shared_weak_count_vtbl *)&unk_26F5DC130;
  std::__shared_weak_count::~__shared_weak_count(a1);
  JUMPOUT(0x24563B8B0);
}

uint64_t std::__shared_ptr_emplace<KB::InputManagerSpecialization_es>::__on_zero_shared(uint64_t a1)
{
  return (**(uint64_t (***)(void))(a1 + 24))();
}

void KB::InputManagerSpecialization_es::~InputManagerSpecialization_es(KB::InputManagerSpecialization_es *this)
{
...
{
  {
    __cxa_atexit((void (*)(void *))WTF::RefPtr<KB::InputSegmentFilter>::~RefPtr, &KB::InputManagerSpecialization::create_input_segment_filter(WTF::PassRefPtr<TI::Favonius::KeyboardLayout>)const::filter, &dword_241DF0000);
  }
  ...
  v2 = (atomic_uint *)KB::InputManagerSpecialization::create_input_segment_filter(WTF::PassRefPtr<TI::Favonius::KeyboardLayout>)const::filter;
...
unsigned int *WTF::RefCounted<TI::Favonius::KeyboardLayout>::deref(unsigned int *result)
{
  ...
  if (v2 == 1)
  {
    ...
    return (unsigned int *)MEMORY[0x24563B8B0](v1, 0x10B0C409EA53459);
  }
  else
  {
...
uint64_t WTF::RefCounted<TI::Favonius::Key>::deref(uint64_t result)
{
  ...
  if (v2 == 1)
  {
    if (*(unsigned __int16 *)(result + 40) >= 0xFu)
    {
      ...
      if (v3) {
        MEMORY[0x24563B890](v3, 0x1000C8077774924);
      }
    }
...
void _GLOBAL__sub_I_TIKeyboardFeatureSpecialization_es_mm()
{
  v0 = (void *)MEMORY[0x24563B930]();
  __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_241DF0000);
}
