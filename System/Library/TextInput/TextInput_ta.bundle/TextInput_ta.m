...
unsigned int *WTF::RefCounted<TI::Favonius::KeyboardLayout>::deref(unsigned int *result)
{
  ...
  if (v2 == 1)
  {
    ...
    return (unsigned int *)MEMORY[0x24563D6F0](v1, 0x10B0C409EA53459);
  }
  else
  {
...
uint64_t WTF::RefCounted<TI::Favonius::Key>::deref(uint64_t result)
{
  ...
  if (v2 == 1)
  {
    if (*(unsigned __int16 *)(result + 40) >= 0xFu)
    {
      ...
      if (v3) {
        MEMORY[0x24563D6D0](v3, 0x1000C8077774924);
      }
    }
...
unsigned int *InputManagerSpecialization_ta::create_input_segment_filter@<X0>(uint64_t a1@<X0>, unsigned int **a2@<X1>, void *a3@<X8>)
{
...
{
  {
    __cxa_atexit((void (*)(void *))WTF::RefPtr<KB::InputSegmentFilter>::~RefPtr, &KB::InputManagerSpecialization::create_input_segment_filter(WTF::PassRefPtr<TI::Favonius::KeyboardLayout>)const::filter, &dword_241E45000);
  }
...
{
  v0 = (void *)MEMORY[0x24563D7B0]();
  __cxa_atexit((void (*)(void *))KB::LikelihoodInfo::~LikelihoodInfo, &KB::k_invalid_likelihood_value, &dword_241E45000);
}
...
id Transliterate(NSString *a1, void **a2)
{
  ...
  if (a2)
  {
    int v9 = [(NSString *)v3 length];
    v6 = malloc_type_malloc(8 * v9, 0x1000040BDFB0063uLL);
    v5 = v4;
    if (v6)
    {
      unsigned int v7 = v6;
      -[NSString getCharacters:range:](v4, "getCharacters:range:", v6, 0, [(NSString *)v4 length]);
      utrans_transUChars();
      v5 = [NSString stringWithCharacters:v7 length:v9];
