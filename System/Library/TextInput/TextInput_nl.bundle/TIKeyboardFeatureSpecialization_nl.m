...
{
  v12.receiver = self;
  v12.super_class = (Class)TIKeyboardFeatureSpecialization_nl;
  ...
  v7->__vftable = (std::__shared_weak_count_vtbl *)&unk_270E0EF40;
  uint64_t v8 = KB::InputManagerSpecialization::InputManagerSpecialization((KB::InputManagerSpecialization *)&v7[1], v6);
  v7[1].__vftable = (std::__shared_weak_count_vtbl *)&unk_270E0EE60;
  uint64_t v10 = v8;
  v11 = v7;
