...
{
  if (qword_CFC8 != -1) {
    dispatch_once(&qword_CFC8, &stru_8360);
  }
  v2 = (void *)qword_CFC0;
  return v2;
}
...
{
  if (qword_CFD8 != -1) {
    dispatch_once(&qword_CFD8, &stru_8380);
  }
  v2 = (void *)qword_CFD0;
  return v2;
}
...
- (NNArticleIdentifierSyncManager)init
{
  return [(NNArticleIdentifierSyncManager *)self initWithReadonlyResetKey:&stru_85E8 readwriteResetKey:&stru_85E8 readonlyKey:&stru_85E8 readwriteKey:&stru_85E8];
}
