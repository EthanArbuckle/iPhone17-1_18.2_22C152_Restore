...
+ (id)performBlockIgnoringAssertions:(id)a3
{
  v3 = objc_msgSend(a1, "p_performBlockIgnoringAssertions:onlyFatal:", a3, 0);
  v4 = [v3 lastObject];
...
+ (id)performBlockIgnoringFatalAssertions:(id)a3
{
  v3 = objc_msgSend(a1, "p_performBlockIgnoringAssertions:onlyFatal:", a3, 1);
  v4 = [v3 lastObject];
...
{
  id v4 = a3;
  v5 = objc_msgSend(a1, "p_performBlockIgnoringAssertions:onlyFatal:", v4, objc_msgSend(a1, "isQAFatalAssertionsEnabled"));
...
+ (id)p_performBlockIgnoringAssertions:(id)a3 onlyFatal:(BOOL)a4
{
  ...
  id v7 = objc_retainBlock((id)_ignoreAssertionsCallback);
  v14[0] = _NSConcreteStackBlock;
  v14[1] = 3221225472;
  v14[2] = __66__CRLAssertionHandler_p_performBlockIgnoringAssertions_onlyFatal___block_invoke;
  v14[3] = &unk_29548;
  BOOL v16 = a4;
  id v8 = v6;
  id v15 = v8;
  v9 = objc_retainBlock(v14);
  v10 = (void *)_ignoreAssertionsCallback;
  _ignoreAssertionsCallback = (uint64_t)v9;

  v5[2](v5);
  id v11 = objc_retainBlock(v7);
  v12 = (void *)_ignoreAssertionsCallback;
  _ignoreAssertionsCallback = (uint64_t)v11;
...
void __66__CRLAssertionHandler_p_performBlockIgnoringAssertions_onlyFatal___block_invoke(uint64_t a1, void *a2, char a3)
{
  ...
  {
    __66__CRLAssertionHandler_p_performBlockIgnoringAssertions_onlyFatal___block_invoke_cold_1(v6);
    if (a3) {
      goto LABEL_5;
    }
  }
...
+ (void)logFullBacktrace
{
  ...
  int v3 = 138543362;
  id v4 = v2;
  _os_log_error_impl(&dword_0, v1, OS_LOG_TYPE_ERROR, "#Assert Assertion backtrace: >>%{public}@<<", (uint8_t *)&v3, 0xCu);
}
...
+ (void)_logBacktraceWithCallStackSymbols:(id)a3
{
  id v4 = a3;
  if (CRLAssertCat_init_token != -1) {
    dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_36);
  }
  id v5 = CRLAssertCat_log_t;
  if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
    +[CRLAssertionHandler _logBacktraceWithCallStackSymbols:](v5, (uint64_t)v4);
  }
...
+ (id)packedBacktraceString
{
  int v3 = +[NSThread callStackReturnAddresses];
...
+ (id)packedBacktraceStringWithReturnAddresses:(id)a3
{
  ...
  if (packedBacktraceStringWithReturnAddresses__onceToken != -1) {
    dispatch_once(&packedBacktraceStringWithReturnAddresses__onceToken, &__block_literal_global_41);
  }
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (dladdr(v11, &v79))
        {
          ...
          {
            [v5 addObject:v12];
            os_unfair_lock_lock((os_unfair_lock_t)&packedBacktraceStringWithReturnAddresses__knownImageInfosLock);
            v13 = [(id)packedBacktraceStringWithReturnAddresses__knownImageInfos objectForKeyedSubscript:v12];
            os_unfair_lock_unlock((os_unfair_lock_t)&packedBacktraceStringWithReturnAddresses__knownImageInfosLock);
            if (v13)
            {
              v14 = v55;
              id v15 = v13;
...
LABEL_30:
        ...
        if (ncmds)
        {
          ...
          {
            v31 = v30;
            v32 = +[NSMutableDictionary dictionaryWithSharedKeySet:packedBacktraceStringWithReturnAddresses__keySet];
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&packedBacktraceStringWithReturnAddresses__knownImageInfosLock);
            [(id)packedBacktraceStringWithReturnAddresses__knownImageInfos setObject:v32 forKeyedSubscript:v21];
            os_unfair_lock_unlock((os_unfair_lock_t)&packedBacktraceStringWithReturnAddresses__knownImageInfosLock);
            [v55 addObject:v32];
...
LABEL_44:
  ...
  v51 = objc_msgSend(v4, "crl_compressWithAlgorithm:operation:", 774, 0);
...
{
  uint64_t v1 = +[NSDictionary sharedKeySetForKeys:&off_2B838];
  v2 = (void *)packedBacktraceStringWithReturnAddresses__keySet;
  packedBacktraceStringWithReturnAddresses__keySet = v1;

  id v3 = objc_alloc_init((Class)NSMutableDictionary);
  id v4 = (void *)packedBacktraceStringWithReturnAddresses__knownImageInfos;
  packedBacktraceStringWithReturnAddresses__knownImageInfos = (uint64_t)v3;
...
+ (void)simulateCrashWithMessage:(id)a3
{
  ...
  {
    id v7 = v3;
    dispatch_once(&simulateCrashWithMessage__once, &__block_literal_global_80_0);
    id v3 = v7;
  }
  id v4 = (void (*)(uint64_t, void, id))simulateCrashWithMessage____SimulateCrash;
...
+ (void)handleFailureInFunction:(id)a3 file:(id)a4 lineNumber:(int64_t)a5 isFatal:(BOOL)a6 format:(id)a7 args:(char *)a8
{
  ...
  id v15 = a4;
  id v16 = a7;
  id v17 = objc_msgSend(objc_alloc((Class)NSString), "crl_initUnRedactedWithFormat:arguments:", v16, a8);

  if (_ignoreAssertionsCallback)
  {
    (*(void (**)(void))(_ignoreAssertionsCallback + 16))();
  }
  else
  {
    ...
    uint64_t v19 = atomic_load((unsigned int *)sAssertionCount);
...
void __66__CRLAssertionHandler_p_performBlockIgnoringAssertions_onlyFatal___block_invoke_cold_1(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&dword_0, log, OS_LOG_TYPE_ERROR, "#Assert *** Ignored previous assertion failure ***", v1, 2u);
}

+ (void)_logBacktraceWithCallStackSymbols:(void *)a1 .cold.1(void *a1, uint64_t a2)
{
  id v3 = a1;
  int v4 = 134218242;
