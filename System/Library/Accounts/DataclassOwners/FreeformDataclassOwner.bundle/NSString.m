...
- (id)crl_filenameFromDisplayNameWithExtension:(id)a3 characterLimit:(unint64_t)a4
{
  ...
  v8 = objc_msgSend(v7, "crl_tolerantStringByAppendingPathExtension:", v6);

  v9 = objc_msgSend(v8, "crl_filenameTruncatedToCharacterLimit:", a4);
...
- (id)crl_filenameTruncatedToCharacterLimit:(unint64_t)a3
{
  ...
  if (strlen([(NSString *)v4 fileSystemRepresentation]) > a3)
  {
    ...
    do
    {
      id v9 = objc_msgSend(v5, "rangeOfComposedCharacterSequencesForRange:", 0, v8);
...
- (id)crl_initialsWithLimit:(unint64_t)a3
{
  if ([(NSString *)self canBeConvertedToEncoding:5])
  {
    ...
    v12[1] = 3221225472;
    v12[2] = __59__NSString_CRLApplicationAdditions__crl_initialsWithLimit___block_invoke;
    v12[3] = &unk_28EC8;
    id v9 = v5;
    id v13 = v9;
    uint64_t v14 = v16;
...
void __59__NSString_CRLApplicationAdditions__crl_initialsWithLimit___block_invoke(void *a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, unsigned char *a7)
{
  id v9 = (void *)a1[4];
...
- (id)crl_nameByConvertingFirstNameToInitials
{
  if ([(NSString *)self canBeConvertedToEncoding:5])
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __76__NSString_CRLApplicationAdditions__crl_nameByConvertingFirstNameToInitials__block_invoke;
    v8[3] = &unk_28EF0;
    id v5 = v3;
    id v9 = v5;
    uint64_t v10 = self;
...
void __76__NSString_CRLApplicationAdditions__crl_nameByConvertingFirstNameToInitials__block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, unsigned char *a7)
{
  id v14 = a2;
  if ((unint64_t)[v14 length] >= 2)
  {
    ...
    id v13 = objc_msgSend(*(id *)(a1 + 40), "substringFromIndex:", objc_msgSend(v14, "length"));
...
+ (id)crl_stringByIndentingString:(id)a3
{
  return objc_msgSend(a1, "crl_stringByIndentingString:times:", a3, 1);
}
...
- (id)crl_stringByUniquingPathInsideDirectory:(id)a3 withFormat:(id)a4
{
  ...
  if (!v6)
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_3);
    }
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_80);
    }
    uint64_t v8 = CRLAssertCat_log_t;
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      -[NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:withFormat:](v8);
    }
...
void __77__NSString_CRLAdditions__crl_stringByUniquingPathInsideDirectory_withFormat___block_invoke(id a1)
{
...
void __77__NSString_CRLAdditions__crl_stringByUniquingPathInsideDirectory_withFormat___block_invoke_78(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
- (id)crl_stringByRemovingCharactersInSet:(id)a3 options:(unsigned int)a4
{
  ...
  else
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_84);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      -[NSString(CRLAdditions) crl_stringByRemovingCharactersInSet:options:]();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_88);
    }
    int64_t v9 = CRLAssertCat_log_t;
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      -[NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:withFormat:](v9);
    }
...
void __70__NSString_CRLAdditions__crl_stringByRemovingCharactersInSet_options___block_invoke(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
void __70__NSString_CRLAdditions__crl_stringByRemovingCharactersInSet_options___block_invoke_86(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
- (id)crl_escapeForIcuRegex
{
  if (crl_escapeForIcuRegex_icuRegexCharSetToken != -1) {
    dispatch_once(&crl_escapeForIcuRegex_icuRegexCharSetToken, &__block_literal_global_91);
  }
  id v3 = self;
  NSUInteger v4 = [(NSString *)v3 length];
  *(void *)&long long v13 = [(NSString *)v3 rangeOfCharacterFromSet:crl_escapeForIcuRegex_icuRegexCharSet];
    ...
    if (v4 != (char *)v13)
    {
      do
      {
        ...
        *((void *)&v13 + 1) = &v4[-v13];
        ...
        if (v4 != (char *)v13)
        {
          *(void *)&long long v12 = [(NSString *)v3 rangeOfCharacterFromSet:crl_escapeForIcuRegex_icuRegexCharSet options:0 range:(void)v13];
          *((void *)&v12 + 1) = v9;
          long long v13 = v12;
...
void __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke(id a1)
{
  v1 = +[NSCharacterSet characterSetWithCharactersInString:](NSCharacterSet, "characterSetWithCharactersInString:", @"*?+[(){}^$|\\./");
  objc_storeStrong((id *)&crl_escapeForIcuRegex_icuRegexCharSet, v1);
  if (!crl_escapeForIcuRegex_icuRegexCharSet)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_96);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_cold_2();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_100);
    }
    CFUUIDRef v2 = CRLAssertCat_log_t;
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      -[NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:withFormat:](v2);
    }
    id v3 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[NSString(CRLAdditions) crl_escapeForIcuRegex]_block_invoke");
    NSUInteger v4 = +[NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/Freeform/Source/CRLUtility/NSString_CRLAdditions.m"];
...
void __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_2(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
void __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_98(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
- (id)crl_stringWithPathRelativeTo:(id)a3 allowBacktracking:(BOOL)a4
{
  ...
  if (a4)
  {
    ...
    if (v13 <= v16)
    {
      long long v23 = &stru_29E20;
    }
    else
    {
      long long v22 = &stru_29E20;
      do
      {
...
+ (id)crl_stringByBase64EncodingBytes:(const char *)a3 length:(unint64_t)a4 breakLines:(BOOL)a5
{
  ...
  else
  {
    ...
    do
    {
      objc_msgSend(v8, "appendFormat:", @"%c%c%c%c", Base64Alphabet[*(v10 - 2) >> 2], Base64Alphabet[((unint64_t)((*((unsigned __int8 *)v10 - 1) << 8) | (*((unsigned __int8 *)v10 - 2) << 16)) >> 12) & 0x3F], Base64Alphabet[((unint64_t)(*(unsigned __int8 *)v10 | (*((unsigned __int8 *)v10 - 1) << 8)) >> 6) & 0x3F], Base64Alphabet[*v10 & 0x3F]);
  ...
  if (v6 == 1)
  {
    objc_msgSend(v8, "appendFormat:", @"%c%c==", Base64Alphabet[(unint64_t)a3[v13] >> 2], Base64Alphabet[16 * (a3[v13] & 3)], v16);
  }
  else if (v6 == 2)
  {
    unint64_t v14 = &a3[v13];
    objc_msgSend(v8, "appendFormat:", @"%c%c%c=", Base64Alphabet[*v14 >> 2], Base64Alphabet[((unint64_t)((*(unsigned __int8 *)v14 << 16) | (*((unsigned __int8 *)v14 + 1) << 8)) >> 12) & 0x3F], Base64Alphabet[4 * (v14[1] & 0xF)]);
  }
  return v8;
}
...
{
  id v4 = a3;
  if ([(NSString *)self isEqualToString:&stru_29E20]
    || [v4 isEqualToString:&stru_29E20])
  {
    id v5 = self;
LABEL_4:
...
- (id)crl_setOfContainedWordsIncludingPunctuationAndSymbols:(BOOL)a3
{
  ...
  v37[1] = 3221225472;
  v37[2] = __80__NSString_CRLAdditions__crl_setOfContainedWordsIncludingPunctuationAndSymbols___block_invoke;
  v37[3] = &__block_descriptor_33_e30_Q16__0____CFStringTokenizer__8l;
  BOOL v35 = v3;
  BOOL v38 = v3;
...
CFStringTokenizerTokenType __80__NSString_CRLAdditions__crl_setOfContainedWordsIncludingPunctuationAndSymbols___block_invoke(uint64_t a1, CFStringTokenizerRef tokenizer)
{
  do
  {
    while (1)
...
- (id)crl_stringWithoutAttachmentCharacters
{
  if (crl_stringWithoutAttachmentCharacters_onceToken != -1) {
    dispatch_once(&crl_stringWithoutAttachmentCharacters_onceToken, &__block_literal_global_151);
  }
  uint64_t v3 = crl_stringWithoutAttachmentCharacters_sAttachmentCharacter;
  return [(NSString *)self stringByReplacingOccurrencesOfString:v3 withString:&stru_29E20];
}

void __63__NSString_CRLAdditions__crl_stringWithoutAttachmentCharacters__block_invoke(id a1)
{
  __int16 v3 = -4;
  id v1 = [objc_alloc((Class)NSString) initWithCharacters:&v3 length:1];
  NSUInteger v2 = (void *)crl_stringWithoutAttachmentCharacters_sAttachmentCharacter;
  crl_stringWithoutAttachmentCharacters_sAttachmentCharacter = (uint64_t)v1;
}
...
- (id)crl_middleTruncateToLength:(unint64_t)a3
{
  ...
  {
    CFStringTokenizerTokenType v5 = v4;
  }
  else
  {
    CFStringTokenizerTokenType v5 = (NSString *)[(NSString *)v4 mutableCopy];
    do
...
- (id)crl_stringWithNormalizedHyphensAndQuotationMarks
{
  ...
  __int16 v3 = objc_msgSend(v2, "crl_stringWithNormalizedQuotationMarks");
...
- (id)crl_stringWithNormalizedHyphens
{
  if (crl_stringWithNormalizedHyphens_onceToken != -1) {
    dispatch_once(&crl_stringWithNormalizedHyphens_onceToken, &__block_literal_global_156);
  }
  uint64_t v3 = crl_stringWithNormalizedHyphens_hyphenSet;
  return [(NSString *)self crl_stringByReplacingInstancesOfCharactersInSet:v3 withString:@"-"];
}

void __57__NSString_CRLAdditions__crl_stringWithNormalizedHyphens__block_invoke(id a1)
{
  crl_stringWithNormalizedHyphens_hyphenSet = +[NSCharacterSet characterSetWithCharactersInString:@"ـ‑-‐–—"];
  _objc_release_x1();
}

- (id)crl_stringWithNormalizedQuotationMarks
{
  if (crl_stringWithNormalizedQuotationMarks_onceToken != -1) {
    dispatch_once(&crl_stringWithNormalizedQuotationMarks_onceToken, &__block_literal_global_164);
  }
  uint64_t v3 = crl_stringWithNormalizedQuotationMarks_quotationSet;
  return [(NSString *)self crl_stringByReplacingInstancesOfCharactersInSet:v3 withString:@"'"];
}

void __64__NSString_CRLAdditions__crl_stringWithNormalizedQuotationMarks__block_invoke(id a1)
{
  crl_stringWithNormalizedQuotationMarks_quotationSet = +[NSCharacterSet characterSetWithCharactersInString:@"'\"’‘‚“”„«»‹›」「』『"];
  _objc_release_x1();
}
...
- (id)crl_stringWithoutBidiControls
{
  ...
  id v4 = [(NSString *)self crl_stringByReplacingInstancesOfCharactersInSet:v3 withString:&stru_29E20];
...
{
  id v4 = a3;
  CFStringTokenizerTokenType v5 = +[NSBundle mainBundle];
  BOOL v6 = [v5 localizedStringForKey:@"copy" value:0 table:0];
...
- (id)crl_stringByIncrementingCounterAfterDuplicateTitleModifierWithLocalizedCopyString:(id)a3 firstCopyFormatString:(id)a4 generalCopyFormatString:(id)a5 numberFormatter:(id)a6 uniquenessTest:(id)a7
{
  ...
  if (v17)
  {
          ...
          id i = (id)v28)
    {
      ...
      uint64_t v28 = objc_msgSend(v25, "crl_stringByApplyingSubstitutions:", v20);
    }
    CFRange v18 = v30;
    id v12 = v31;
  }
...
- (id)crl_regexForTitleParsingWithLocalizedCopyString:(id)a3 isFirstCopyFormatString:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  if ((char *)[(NSString *)self crl_countInstancesOfString:@"%1$@" options:0] == (char *)&dword_0 + 1&& (char *)[(NSString *)self crl_countInstancesOfString:@"%2$@" options:0] == (char *)&dword_0 + 1&& (v4|| (char *)[(NSString *)self crl_countInstancesOfString:@"%3$@" options:0] == (char *)&dword_0 + 1))
  {
    ...
    id v12 = objc_msgSend(v7, "crl_stringByApplyingSubstitutions:", v11);
  ...
  else
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_187);
    }
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_190);
    }
    CFIndex v16 = CRLAssertCat_log_t;
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      -[NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:withFormat:](v16);
    }
...
void __98__NSString_CRLAdditions__crl_regexForTitleParsingWithLocalizedCopyString_isFirstCopyFormatString___block_invoke_188(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
- (id)crl_parseBaseTitleWithLocalizedCopyString:(id)a3 firstCopyFormatString:(id)a4 generalCopyFormatString:(id)a5 outNumber:(unint64_t *)a6
{
  ...
  id v11 = a4;
  id v12 = a5;
  id v13 = objc_msgSend(v12, "crl_regexForTitleParsingWithLocalizedCopyString:isFirstCopyFormatString:", v10, 0);
  if (!v13)
  {
    unsigned int v21 = self;
    goto LABEL_23;
  }
  unsigned int v14 = objc_msgSend(v13, "firstMatchInString:options:range:", self, 0, 0, -[NSString length](self, "length"));
  if (v14)
  {
  ...
  __int16 v26 = objc_msgSend(v11, "crl_regexForTitleParsingWithLocalizedCopyString:isFirstCopyFormatString:", v10, 1);
  if (v26)
  {
    __int16 v24 = v26;
...
- (id)crl_stringByApplyingSubstitutions:(id)a3
{
  ...
  v25[1] = 3221225472;
  v25[2] = __60__NSString_CRLAdditions__crl_stringByApplyingSubstitutions___block_invoke;
  v25[3] = &unk_290B8;
  v25[4] = v5;
  v25[5] = v6;
  [v4 enumerateKeysAndObjectsUsingBlock:v25];
  CFLocaleRef v7 = [v6 allKeys];
  id v8 = [v7 sortedArrayUsingComparator:&__block_literal_global_204];
...
void __60__NSString_CRLAdditions__crl_stringByApplyingSubstitutions___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  id v9 = a3;
  id v5 = [*(id *)(a1 + 32) rangeOfString:a2];
  if (v5 != (id)0x7FFFFFFFFFFFFFFFLL)
  {
    CFLocaleRef v7 = *(void **)(a1 + 40);
    id v8 = +[NSValue valueWithRange:](NSValue, "valueWithRange:", v5, v6);
    [v7 setObject:v9 forKeyedSubscript:v8];
  }
}

int64_t __60__NSString_CRLAdditions__crl_stringByApplyingSubstitutions___block_invoke_2(id a1, NSValue *a2, NSValue *a3)
{
  id v4 = a3;
...
{
  id v4 = a3;
  if (crl_appendJSONStringToString__onceToken != -1) {
    dispatch_once(&crl_appendJSONStringToString__onceToken, &__block_literal_global_209);
  }
  [v4 appendString:@"\""];
  if ([(NSString *)self rangeOfCharacterFromSet:crl_appendJSONStringToString__escapeCharacters] != (id)0x7FFFFFFFFFFFFFFFLL)
  {
    NSUInteger v5 = [(NSString *)self length];
...
void __55__NSString_CRLAdditions__crl_appendJSONStringToString___block_invoke(id a1)
{
  uint64_t v1 = +[NSMutableCharacterSet characterSetWithRange:](NSMutableCharacterSet, "characterSetWithRange:", 0, 32);
  NSUInteger v2 = (void *)crl_appendJSONStringToString__escapeCharacters;
  crl_appendJSONStringToString__escapeCharacters = v1;

  [(id)crl_appendJSONStringToString__escapeCharacters addCharactersInString:@"\"\\""];
  int v4 = 539566120;
  id v3 = [objc_alloc((Class)NSString) initWithCharacters:&v4 length:2];
  [(id)crl_appendJSONStringToString__escapeCharacters addCharactersInString:v3];
}
...
+ (id)crl_stringWithItemProviderData:(id)a3 typeIdentifier:(id)a4 error:(id *)a5
{
  ...
  if (!v8)
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_242);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      +[NSString(CRLAdditions) crl_stringWithItemProviderData:typeIdentifier:error:]((uint64_t)v7, v9);
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &__block_literal_global_245);
    }
...
void __78__NSString_CRLAdditions__crl_stringWithItemProviderData_typeIdentifier_error___block_invoke(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
void __78__NSString_CRLAdditions__crl_stringWithItemProviderData_typeIdentifier_error___block_invoke_243(id a1)
{
  CRLLogCreateCategory("CRLAssertCat");
  CRLAssertCat_log_t = (_UNKNOWN *)objc_claimAutoreleasedReturnValue();
  _objc_release_x1();
...
- (id)crl_uncommentedAddress
{
  ...
  int v4 = (char *)NSZoneMalloc(0, 2 * v3 + 2);
  NSUInteger v5 = v4;
  id v6 = v4;
  if (v3)
  {
...
- (BOOL)crl_isCJKString
{
  ...
  for (i = 0; (id)i != v6; BOOL v9 = i >= (unint64_t)v6)
  {
    ...
    char v14 = vmaxv_u8((uint8x8_t)vmovn_s16((int16x8_t)vcgtq_u16((uint16x8_t)xmmword_1FFD0, (uint16x8_t)vaddq_s16(v12, (int16x8_t)xmmword_1FFC0)))) | vmaxv_u16((uint16x4_t)vceq_s16(v13, (int16x4_t)0x3190300011002E80));
...
+ (id)crl_localizedDisplayNameWithPersonNameComponents:(id)a3
{
  ...
  if (CRLDefaultCat_init_token != -1) {
    dispatch_once(&CRLDefaultCat_init_token, &__block_literal_global_335);
  }
  id v5 = CRLDefaultCat_log_t;
  if (os_log_type_enabled((os_log_t)CRLDefaultCat_log_t, OS_LOG_TYPE_ERROR)) {
    +[NSString(CRLPersonNameComponents) crl_localizedDisplayNameWithPersonNameComponents:](v5);
  }
  id v6 = [v3 givenName];
  id v7 = [v6 length];
...
void __86__NSString_CRLPersonNameComponents__crl_localizedDisplayNameWithPersonNameComponents___block_invoke(id a1)
{
...
- (id)crl_initRedactedWithFormat:(id)a3 arguments:(char *)a4
{
  ...
  id v6 = [objc_alloc((Class)NSString) initWithFormat:v5 arguments:a4];
  if (crl_initRedactedWithFormat_arguments__onceToken != -1) {
    dispatch_once(&crl_initRedactedWithFormat_arguments__onceToken, &__block_literal_global_370);
  }
  id v7 = objc_msgSend((id)crl_initRedactedWithFormat_arguments__redactRegex, "stringByReplacingMatchesInString:options:range:withTemplate:", v6, 0, 0, objc_msgSend(v6, "length"), @"<redacted>");

  return v7;
}

void __66__NSString_CRLLogAdditions__crl_initRedactedWithFormat_arguments___block_invoke(id a1)
{
  id v4 = 0;
  id v1 = [objc_alloc((Class)NSRegularExpression) initWithPattern:@"<REDACT .*? REDACT>" options:8 error:&v4];
  id v2 = v4;
  NSUInteger v3 = (void *)crl_initRedactedWithFormat_arguments__redactRegex;
  crl_initRedactedWithFormat_arguments__redactRegex = (uint64_t)v1;
}
...
{
  id v5 = a3;
  id v6 = objc_msgSend(objc_alloc((Class)NSString), "crl_initRedactedWithFormat:arguments:", v5, a4);
...
{
  id v5 = a3;
  id v6 = objc_msgSend(objc_alloc((Class)NSString), "crl_initUnRedactedWithFormat:arguments:", v5, a4);

  return v6;
}

void __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_3();
