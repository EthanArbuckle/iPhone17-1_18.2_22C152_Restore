...
- (BOOL)perform
{
  ...
  unsigned int v7 = v4 & [(CNDataclassActionHandler *)self createContactsAccountForACAccount:v5 withChildren:v6];
  ...
  if (v7 == 1)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v18 = 2112;
      v19 = v13;
      _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Created a Contacts container for account %@ (%@) and now disabling the Contacts local container.", (uint8_t *)&v16, 0x16u);
    }
