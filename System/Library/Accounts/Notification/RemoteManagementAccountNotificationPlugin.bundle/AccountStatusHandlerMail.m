...
- (id)getStatusKeyPathFromAccount:(id)a3
{
  ...
  v4 = (id *)&RMModelStatusItemAccountListMailIncoming;
  if (v3) {
    v4 = (id *)&RMModelStatusItemAccountListMailOutgoing;
  }
  id v5 = *v4;
...
{
  id v4 = a3;
  id v5 = [v4 objectForKeyedSubscript:@"RemoteManagementPrimaryAccountIdentifier"];
  if (v5) {
    [(AccountStatusHandlerMail *)self _getStatusInfoFromOutgoingAccount:v4];
  }
  else {
  v6 = [(AccountStatusHandlerMail *)self _getStatusInfoFromIncomingAccount:v4];
  }
...
- (id)_getStatusInfoFromIncomingAccount:(id)a3
{
  id v3 = a3;
  id v4 = [v3 identifier];
  id v5 = +[RMModelStatusAccountListMailIncoming buildRequiredOnlyWithIdentifier:v4];
...
- (id)_getStatusInfoFromOutgoingAccount:(id)a3
{
  id v3 = a3;
  id v4 = [v3 identifier];
  id v5 = +[RMModelStatusAccountListMailOutgoing buildRequiredOnlyWithIdentifier:v4];
