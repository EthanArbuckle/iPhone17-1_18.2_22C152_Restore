...
- (void)saveF32Buffer:(__CVBuffer *)a3 AsPPMFile:(const char *)a4
{
  ...
  id v17 = v16;
  sub_18C0C(Width, Height, 4 * Width, v10, (const char *)[v17 UTF8String]);
  free(v10);
}
...
- (void)saveU8Buffer:(__CVBuffer *)a3 AsPPMFile:(const char *)a4
{
  ...
  id v20 = v19;
  sub_18C0C(Width, Height, 4 * Width, v11, (const char *)[v20 UTF8String]);
  free(v11);
}
...
- (void)saveVUYA4444PixelBuffer:(__CVBuffer *)a3 out_width:(unsigned int)a4 out_height:(unsigned int)a5 AsPPMFile:(const char *)a6
{
  ...
  sub_18C0C(v15, v16, 4 * Width, v14, a6);
...
- (void)saveRGBATexture:(id)a3 AsPPMFile:(const char *)a4
{
  ...
  id v11 = v10;
  sub_18C0C(v7, v8, 4 * v7, v9, (const char *)[v11 UTF8String]);
  free(v9);
}
...
- (void)saveF16DisparityBufferAsTurbo:(__CVBuffer *)a3 AsPPMFile:(const char *)a4 WithMin:(float)a5 WithMax:(float)a6
{
  ...
  if (v14)
  {
    ...
    CVPixelBufferUnlockBaseAddress(a3, 1uLL);
    sub_18C0C(Width, Height, 4 * Width, v15, a4);
    free(v15);
  }
}
...
- (void)saveF16DisparityBuffer:(__CVBuffer *)a3 AsGrayScalePPMFile:(const char *)a4 range:
{
  ...
  sub_18C0C(Width, Height, v34, v28, a4);
  free(v29);
...
- (void)ApplyColorWheelAndWrite:(unsigned int)a3 height:(unsigned int)a4 data:(float *)a5 fileFullPath:(const char *)a6
{
  float v15 = (void **)sub_1CF90(80, 30, 20, 20, 30, 0, 0, 1, 0.0);
  uint64_t v10 = malloc_type_malloc(4 * a3 * a4, 0xA525D3AAuLL);
  sub_1D6E8((uint64_t)v15, a3, a4, a5, 4 * a3, 4, (uint64_t)v10, 4 * a3, v11, v12, v13, v14, 4);
  sub_18C0C(a3, a4, 4 * a3, v10, a6);
  free(v10);
  sub_1D5C0(&v15);
}
...
- (void)saveRGF16Texture:(id)a3 AsF32BinaryFile0:(id)a4 AsF32BinaryFile1:(id)a5
{
  ...
  id v10 = a5;
  id v11 = v9;
  double v12 = sub_18680((const char *)[v11 UTF8String]);
  id v13 = v10;
  uint64_t v14 = sub_18680((const char *)[v13 UTF8String]);
  __stream = v12;
  if (v12)
  {
    int v15 = v14;
...
- (void)saveNCCOutputFrom:(id)a3 asBinaryFiles:(const char *)a4
{
  ...
  id v48 = v15;
  int v19 = sub_18680((const char *)[v48 UTF8String]);
  id v20 = v16;
  float v21 = sub_18680((const char *)[v20 UTF8String]);
  id v22 = v17;
  v59 = sub_18680((const char *)[v22 UTF8String]);
  id v23 = v18;
  int v24 = sub_18680((const char *)[v23 UTF8String]);
  int v25 = 0;
  v57 = v24;
  __stream = v19;
  id v50 = 0;
...
LABEL_23:
          if ((v12 & 1) == 0) {
            sub_18C0C(v55, (int)v54, 4 * v55, v25, (const char *)[v50 UTF8String]);
          }
          if (v31) {
            free(v31);
          }
...
- (void)saveAccumulationFrom:(id)a3 asBinaryFiles:(const char *)a4 forSize:(CGSize)a5 costLineSize:(unsigned __int16)a6
{
  ...
  id v36 = v16;
  int v19 = sub_18680((const char *)[v36 UTF8String]);
  id v20 = v17;
  float v21 = sub_18680((const char *)[v20 UTF8String]);
  id v22 = v18;
  id v44 = sub_18680((const char *)[v22 UTF8String]);
  id v23 = v45;
  int v24 = sub_18680((const char *)[v23 UTF8String]);
  int v25 = v19;
  unint64_t v26 = 0;
...
LABEL_12:
  ...
  if (v44 && v24)
  {
    ...
    sub_18C0C(v29, v40, 4 * v29, v26, (const char *)[v38 UTF8String]);
    id v23 = v35;
    int v25 = __stream;
    goto LABEL_12;
  }
