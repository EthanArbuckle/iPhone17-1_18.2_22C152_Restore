...
- (id)getShaders:(id)a3
{
  ...
  if (!v7)
  {
    v7 = [[RegPyrFusionShaders alloc] initWithMetal:v4];
    if (v7)
    {
...
+ (id)sharedInstance
{
  return +[RegPyrFusionShared getSharedInstanceOrRelease:0];
}
...
LABEL_6:
  id v7 = (id)getSharedInstanceOrRelease__singleton_0;
  objc_sync_exit(v4);
...
+ (void)releaseSharedInstance
{
  id v2 = +[RegPyrFusionShared getSharedInstanceOrRelease:1];
}
