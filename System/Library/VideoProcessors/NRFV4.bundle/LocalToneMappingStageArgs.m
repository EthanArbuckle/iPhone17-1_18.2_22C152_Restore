@interface LocalToneMappingStageArgs
- (LocalToneMappingStageArgs)initWithConfig:(id)a3 bounds:(id)a4 inputFrame:(id)a5 outputFrame:(id)a6;
...
@implementation LocalToneMappingStageArgs
...
- (LocalToneMappingStageArgs)initWithConfig:(id)a3 bounds:(id)a4 inputFrame:(id)a5 outputFrame:(id)a6
{
  ...
  id v14 = a6;
  v24.receiver = self;
  v24.super_class = (Class)LocalToneMappingStageArgs;
  v15 = [(LocalToneMappingStageArgs *)&v24 init];
  if (!v15)
  {
    FigDebugAssert3();
LABEL_13:
...
- (void)dealloc
{
  ...
  FigMetalDecRef();
  v3.receiver = self;
  v3.super_class = (Class)LocalToneMappingStageArgs;
  [(LocalToneMappingStageArgs *)&v3 dealloc];
}
