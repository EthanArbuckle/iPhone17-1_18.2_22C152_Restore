@interface H13FastDemosaicStageArgs
- (H13FastDemosaicStageArgs)initWithConfig:(id)a3 bounds:(id)a4 inputFrame:(id)a5 outputFrame:(id)a6;
- (MTLTexture)inputTex;
...
@implementation H13FastDemosaicStageArgs
...
- (H13FastDemosaicStageArgs)initWithConfig:(id)a3 bounds:(id)a4 inputFrame:(id)a5 outputFrame:(id)a6
{
  ...
  id v14 = a6;
  v24.receiver = self;
  v24.super_class = (Class)H13FastDemosaicStageArgs;
  v15 = [(H13FastDemosaicStageArgs *)&v24 init];
  if (!v15)
  {
    FigDebugAssert3();
LABEL_13:
...
- (void)dealloc
{
  ...
  FigMetalDecRef();
  v3.receiver = self;
  v3.super_class = (Class)H13FastDemosaicStageArgs;
  [(H13FastDemosaicStageArgs *)&v3 dealloc];
}
