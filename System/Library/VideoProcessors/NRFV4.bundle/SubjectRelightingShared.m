...
- (id)getShaders:(id)a3
{
  ...
  if (!v7)
  {
    v7 = [[SubjectRelightingShaders alloc] initWithMetalContext:v4];
    if (v7)
    {
...
+ (id)sharedInstance
{
  return +[SubjectRelightingShared getSharedInstanceOrRelease:0];
}
...
LABEL_6:
  id v7 = (id)getSharedInstanceOrRelease__singleton;
  objc_sync_exit(v4);
...
+ (void)releaseSharedInstance
{
  id v2 = +[SubjectRelightingShared getSharedInstanceOrRelease:1];
}
