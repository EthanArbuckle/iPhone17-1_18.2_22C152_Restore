...
uint64_t SCRDBrailleNoteCreateDescriptionPacketFromBuffer()
{
  return _SCRDBrailleNoteCreateDescriptionPacketFromBuffer();
}

uint64_t SCRDBrailleNoteCreateDisplayRequest()
{
  return _SCRDBrailleNoteCreateDisplayRequest();
}

uint64_t SCRDBrailleNoteGetDisplayInfoFromDescriptionPacket()
{
  return _SCRDBrailleNoteGetDisplayInfoFromDescriptionPacket();
}
