...
uint64_t SCRDPapenmeierCreateBrailleBufferB()
{
  return _SCRDPapenmeierCreateBrailleBufferB();
}

uint64_t SCRDPapenmeierCreateIdentityRequestBuffer()
{
  return _SCRDPapenmeierCreateIdentityRequestBuffer();
}

uint64_t SCRDPapenmeierCreateKeyBuffer()
{
  return _SCRDPapenmeierCreateKeyBuffer();
}

uint64_t SCRDPapenmeierCreatePacketFromBuffer()
{
  return _SCRDPapenmeierCreatePacketFromBuffer();
}

uint64_t SCRDPapenmeierReleasePacket()
{
  return _SCRDPapenmeierReleasePacket();
}
