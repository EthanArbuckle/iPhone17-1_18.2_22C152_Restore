...
uint64_t SCRDEurobrailleExtractEventsFromBuffer()
{
  return _SCRDEurobrailleExtractEventsFromBuffer();
}

uint64_t SCRDEurobrailleGetModelInfoFromBuffer()
{
  return _SCRDEurobrailleGetModelInfoFromBuffer();
}
