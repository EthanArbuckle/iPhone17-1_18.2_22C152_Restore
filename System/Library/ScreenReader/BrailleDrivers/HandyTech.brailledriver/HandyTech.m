...
uint64_t SCRDAdvanceBufferToPacketStart()
{
  return _SCRDAdvanceBufferToPacketStart();
}

uint64_t SCRDHandyTechCreateExtendedProtocolRequestPacket()
{
  return _SCRDHandyTechCreateExtendedProtocolRequestPacket();
}

uint64_t SCRDHandyTechDisplayUsesExtendedProtocol()
{
  return _SCRDHandyTechDisplayUsesExtendedProtocol();
}

uint64_t SCRDHandyTechExtractEventsFromBuffer()
{
  return _SCRDHandyTechExtractEventsFromBuffer();
}
