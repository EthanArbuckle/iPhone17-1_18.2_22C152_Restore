...
uint64_t SCRDHumanwareCreateInitializationPacketFromBuffer()
{
  return _SCRDHumanwareCreateInitializationPacketFromBuffer();
}

uint64_t SCRDHumanwareCreateInitializationRequestPacket()
{
  return _SCRDHumanwareCreateInitializationRequestPacket();
}

uint64_t SCRDHumanwareCreateWriteRequestPacket()
{
  return _SCRDHumanwareCreateWriteRequestPacket();
}

uint64_t SCRDHumanwareDeviceIDForInitializationPacket()
{
  return _SCRDHumanwareDeviceIDForInitializationPacket();
}

uint64_t SCRDHumanwareDisplaySizeForDeviceID()
{
  return _SCRDHumanwareDisplaySizeForDeviceID();
}

uint64_t SCRDHumanwareIsDeviceIDValid()
{
  return _SCRDHumanwareIsDeviceIDValid();
}
