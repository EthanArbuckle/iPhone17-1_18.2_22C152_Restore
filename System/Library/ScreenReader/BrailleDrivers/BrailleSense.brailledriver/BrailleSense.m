...
uint64_t SCRDHIMSCreateRequest()
{
  return _SCRDHIMSCreateRequest();
}

uint64_t SCRDHIMSFillPacket()
{
  return _SCRDHIMSFillPacket();
}

uint64_t SCRDHIMSIsPacketValid()
{
  return _SCRDHIMSIsPacketValid();
}
...
id objc_msgSend__himsDeviceId(void *a1, const char *a2, ...)
{
  return [a1 _himsDeviceId];
}
