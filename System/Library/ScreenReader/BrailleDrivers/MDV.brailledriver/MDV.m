...
uint64_t SCRDMDVConvertStandardCellToMDVCell()
{
  return _SCRDMDVConvertStandardCellToMDVCell();
}

uint64_t SCRDMDVSerialCreatePacketsFromBuffer()
{
  return _SCRDMDVSerialCreatePacketsFromBuffer();
}

uint64_t SCRDMDVSerialCreateRequest()
{
  return _SCRDMDVSerialCreateRequest();
}
...
id objc_msgSend__flushWriteBuffer(void *a1, const char *a2, ...)
{
  return [a1 _flushWriteBuffer];
}
