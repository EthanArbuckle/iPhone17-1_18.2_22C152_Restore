...
uint64_t SCRDBaumAppendEventsFromBrailleAndFrontPanelPacket()
{
  return _SCRDBaumAppendEventsFromBrailleAndFrontPanelPacket();
}

uint64_t SCRDBaumAppendEventsFromDirectionalPadPacket()
{
  return _SCRDBaumAppendEventsFromDirectionalPadPacket();
}

uint64_t SCRDBaumAppendEventsFromRoutingKeyGroupPacket()
{
  return _SCRDBaumAppendEventsFromRoutingKeyGroupPacket();
}

uint64_t SCRDBaumAppendEventsFromRoutingKeyPacket()
{
  return _SCRDBaumAppendEventsFromRoutingKeyPacket();
}

uint64_t SCRDBaumAppendEventsFromTopPanelPacket()
{
  return _SCRDBaumAppendEventsFromTopPanelPacket();
}

uint64_t SCRDBaumCreateDisplayRequest()
{
  return _SCRDBaumCreateDisplayRequest();
}

uint64_t SCRDBaumCreatePacketFromBuffer()
{
  return _SCRDBaumCreatePacketFromBuffer();
}

uint64_t SCRDBaumGetSizeFromDisplaySizePacket()
{
  return _SCRDBaumGetSizeFromDisplaySizePacket();
}

uint64_t SCRDPostSleepNotification()
{
  return _SCRDPostSleepNotification();
}
