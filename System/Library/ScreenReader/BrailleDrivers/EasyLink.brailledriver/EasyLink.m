...
uint64_t SCRDEasyLinkCreatePacketFromBuffer()
{
  return _SCRDEasyLinkCreatePacketFromBuffer();
}

uint64_t SCRDEasyLinkExtractEventsFromBuffer()
{
  return _SCRDEasyLinkExtractEventsFromBuffer();
}

uint64_t SCRDEasyLinkExtractKeyboardEventsFromBuffer()
{
  return _SCRDEasyLinkExtractKeyboardEventsFromBuffer();
}
