...
uint64_t SCRDSeikaCreateIdentityPacketFromBuffer()
{
  return _SCRDSeikaCreateIdentityPacketFromBuffer();
}

uint64_t SCRDSeikaCreateWriteRequestPacket()
{
  return _SCRDSeikaCreateWriteRequestPacket();
}

uint64_t SCRDSeikaNotetakerCreatePacketFromBuffer()
{
  return _SCRDSeikaNotetakerCreatePacketFromBuffer();
}
...
{
  return [a1 expressionForEvaluatedObject];
}
