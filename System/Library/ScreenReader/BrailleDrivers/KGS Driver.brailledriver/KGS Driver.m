...
uint64_t SCRDKGSConvertBrailleCellsToKGSOrder()
{
  return _SCRDKGSConvertBrailleCellsToKGSOrder();
}

uint64_t SCRDKGSCreateCommandPacket()
{
  return _SCRDKGSCreateCommandPacket();
}

uint64_t SCRDKGSExtractEventsFromBuffer()
{
  return _SCRDKGSExtractEventsFromBuffer();
}
