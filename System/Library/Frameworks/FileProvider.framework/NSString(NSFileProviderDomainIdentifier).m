  ...
  if (v6 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v14 = 2112;
      v15 = @"/:";
      _os_log_impl(&dword_1A33AE000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] Domain identifier '%@' may not contain any of the characters '%@'", buf, 0x16u);
    }

    if (a3)
    {
      objc_msgSend(MEMORY[0x1E4F28C58], "fp_invalidArgumentError:", @"Domain identifier '%@' may not contain any of the characters '%@'", a1, @"/:");
      goto LABEL_12;
    }
    return 0;
  }
