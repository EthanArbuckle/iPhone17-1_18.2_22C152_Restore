...
+ (id)makeProvider
{
  ...
  uint64_t v2 = *((void *)off_26B0C7F60 + 2);
  v3 = (objc_class *)type metadata accessor for BankConnectSpotlightTransactionsProvider();
  v4 = (char *)objc_allocWithZone(v3);
  *(void *)&v4[OBJC_IVAR____TtC10FinanceKit40BankConnectSpotlightTransactionsProvider_store] = v2;
  v7.receiver = v4;
  v7.super_class = v3;
  swift_retain();
...
- (_TtC10FinanceKit40BankConnectSpotlightTransactionsProvider)init
{
  result = (_TtC10FinanceKit40BankConnectSpotlightTransactionsProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
