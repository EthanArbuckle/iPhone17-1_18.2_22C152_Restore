...
{
  v2 = [a2 releaseDate];
  id v3 = _MPMRDateComponentsFromDate(v2);
...
{
  v2 = NSNumber;
  id v3 = [a2 deviceSpecificUserInfo];
  id v4 = [v3 objectForKeyedSubscript:@"colLibAdded"];
  id v5 = objc_msgSend(v2, "numberWithBool:", objc_msgSend(v4, "BOOLValue"));
...
void ___MPMRInitPropertyAlbumMap_block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  id v5 = [v2 deviceSpecificUserInfo];
  id v4 = [v5 objectForKeyedSubscript:@"claid"];
