...
- (id)_mediaRemoteCommandInfoOptions
{
  ...
  int64_t currentRepeatType = self->_currentRepeatType;
  ...
  uint64_t v25 = *MEMORY[0x1E4F772D8];
  ...
  if (self->_supportedRepeatTypes)
  {
    ...
    [v8 setObject:v9 forKeyedSubscript:*MEMORY[0x1E4F77340]];
  }
...
- (void)setCurrentRepeatType:(MPRepeatType)currentRepeatType
{
  ...
  {
    self->_int64_t currentRepeatType = currentRepeatType;
...
- (id)newCommandEventWithType:(int64_t)a3
{
  return [(MPChangeRepeatModeCommand *)self newCommandEventWithType:a3 preservesRepeatMode:0];
}
