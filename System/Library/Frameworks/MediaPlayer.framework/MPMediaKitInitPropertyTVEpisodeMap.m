...
{
  id v5 = a4;
  id v6 = [a2 objectForKeyedSubscript:@"artistName"];
...
{
  id v2 = a2;
  v3 = _MPKeyPathValueTransformHasNonnullValue(&unk_1EE6EDD90, v2);
...
{
  id v4 = a3;
  uint64_t v5 = [a2 valueForKeyPath:@"attributes.previews"];
  id v6 = [v5 firstObject];
  v7 = MPMediaKitEntityTranslatorTransformArtwork(&unk_1EE6EDD60, v6);
...
id ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  id v6 = [v5 firstObject];
  v7 = MPTranslatorUtilitiesTransformMillisecondsToSeconds(&unk_1EE6EDD00, v6);
...
void ___MPMediaKitInitPropertyTVEpisodeMap_block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  [v10 setPersonalStoreIdentifiersWithPersonID:v11 block:&__block_literal_global_637];
}
