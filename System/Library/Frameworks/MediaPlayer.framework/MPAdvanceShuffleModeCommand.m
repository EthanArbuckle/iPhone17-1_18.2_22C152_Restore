@interface MPAdvanceShuffleModeCommand
- (id)newCommandEventWithPreservesShuffleMode:(BOOL)a3;
@end

@implementation MPAdvanceShuffleModeCommand
...
- (id)newCommandEventWithPreservesShuffleMode:(BOOL)a3
{
  ...
  uint64_t v10 = *MEMORY[0x1E4F772C8];
