...
- (id)humanDescription
{
  ...
  id v4 = [v2 stringWithFormat:@"composers with %@", v3];
...
{
  id v4 = a3;
  objc_super v5 = objc_msgSend(NSString, "stringWithFormat:", @"Composer:a%p", v4);
...
{
  unint64_t v3 = v2;
  id v8 = [(MPModelComposerKind *)self albumKind];
  id v4 = [v8 songKind];
  objc_super v5 = v4;
  if (v4)
  {
...
- (void)applyToView:(shared_ptr<mlcore:(id)a4 :LibraryView>)a3 withContext:
{
  var0 = a3.var0;
  uint64_t v6 = a3.var1;
  id v7 = [(MPModelComposerKind *)self albumKind];
  id v8 = v7;
