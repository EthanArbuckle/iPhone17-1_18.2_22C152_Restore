...
- (AVMobileSliderMark)initWithStartValue:(float)a3 endValue:(float)a4 filledColor:(id)a5 unfilledColor:(id)a6 markWithType:(unint64_t)a7
{
  ...
  v15 = [(AVMobileSliderMark *)&v18 init];
  v16 = v15;
  if (v15)
  {
    v15->_startValue = a3;
...
+ (id)liveEdgeMarkAtValue:(float)a3
{
  ...
  *(float *)&double v7 = a3;
  *(float *)&double v8 = a3;
  v9 = [(AVMobileSliderMark *)v4 initWithStartValue:v5 endValue:v6 filledColor:1 unfilledColor:v7 markWithType:v8];
...
+ (id)interstitialMarkAtValue:(float)a3
{
  ...
  *(float *)&double v7 = a3;
  *(float *)&double v8 = a3;
  v9 = [(AVMobileSliderMark *)v4 initWithStartValue:v5 endValue:v6 filledColor:0 unfilledColor:v7 markWithType:v8];
