...
- (void)addSystemClientMatching:(id)a3
{
  v5 = objc_msgSend_matching(self, a2, (uint64_t)a3);
  objc_msgSend_addObject_(v5, v6, (uint64_t)a3);
  v9 = objc_msgSend_manager(self, v7, v8);
  uint64_t v13 = objc_msgSend_matching(self, v10, v11);
...
{
  v5 = objc_msgSend_matching(self, a2, (uint64_t)a3);
  objc_msgSend_removeObject_(v5, v6, (uint64_t)a3);
  v9 = objc_msgSend_manager(self, v7, v8);
  uint64_t v13 = objc_msgSend_matching(self, v10, v11);
