  ...
  if (objc_msgSend_length(a3, a2, (uint64_t)a3, a4, a5))
  {
    ...
    if (objc_msgSend_dataSize(v9, v29, v30))
    {
      ...
      do
      {
        ...
        v46[1] = 0;
        int v47 = 0;
        sub_1905BFF68((int *)&v49, &v48, (uint64_t)v46);
        v31 += v48;
        v32 = [CMRecordedAccelerometerData alloc];
    ...
    return (CMAccelerometerDataArray *)objc_msgSend_initWithArray_(v43, v44, (uint64_t)v28);
  }
  else
  {
