...
- (CMGyroData)initWithRotationRate:(id)a3 andTimestamp:(double)a4
{
  ...
  float var0 = a3.var0;
  v15.receiver = self;
  v15.super_class = (Class)CMGyroData;
...
{
  v21.receiver = self;
  v21.super_class = (Class)CMGyroData;
...
{
  v11.receiver = self;
  v11.super_class = (Class)CMGyroData;
  ...
  objc_msgSend_encodeDouble_forKey_(a3, v8, @"kCMRotationRateCodingKeyX", (float)(internal[2] * 0.017453));
...
{
  v3.receiver = self;
  v3.super_class = (Class)CMGyroData;
...
{
  v8.receiver = self;
  v8.super_class = (Class)CMGyroData;
...
- (id)description
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)CMGyroData;
