...
{
  id v4 = a3;
  id v5 = [(MTSDeviceSetupRoom *)self name];
...
- (MTSDeviceSetupRoom)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"MTSDSR.ck.name"];
  if (v5)
  {
...
- (MTSDeviceSetupRoom)initWithName:(id)a3
{
  ...
  if (v4)
  {
    id v5 = v4;
    v12.receiver = self;
    v12.super_class = (Class)MTSDeviceSetupRoom;
    id v6 = [(MTSDeviceSetupRoom *)&v12 init];
    if (v6)
    {
      uint64_t v7 = [v5 copy];
      name = v6->_name;
  ...
  else
  {
    ...
    return (MTSDeviceSetupRoom *)+[MTSDeviceSetupRoom supportsSecureCoding];
  }
}
