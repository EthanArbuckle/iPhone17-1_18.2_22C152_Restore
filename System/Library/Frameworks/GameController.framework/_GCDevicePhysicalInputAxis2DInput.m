...
- (uint64_t)update:(float)a3 withValue:(float)a4 timestamp:(double)a5;
...
- (_GCDevicePhysicalInputAxis2DInput)initWithParameters:(id)a3
{
  v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_GCDevicePhysicalInputAxis2DInput;
  v5 = [(_GCDevicePhysicalInputView *)&v10 initWithParameters:v4];
  v6 = v5;
  if (v4)
  {
    -[_GCDevicePhysicalInputAxis2DInput _setSources:]((uint64_t)v5, v4[2]);
  ...
  -[_GCDevicePhysicalInputAxis2DInput _setSources:]((uint64_t)v5, 0);
  uint64_t v7 = 0;
  if (v6) {
LABEL_3:
  }
...
- (uint64_t)_setSources:(uint64_t)result
{
  if (result)
  {
    ...
    if (!a2)
    {
      ...
      objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", sel__setSources_, v3, @"_GCDevicePhysicalInputAxis2DInput.m", 181, @"Invalid parameter not satisfying: %s", "newValue != nil");
    }
...
{
  v3.receiver = a1;
  v3.super_class = (Class)&OBJC_METACLASS____GCDevicePhysicalInputAxis2DInput;
...
- (BOOL)update:(void *)a3 forUsages:(unint64_t)a4 with:(id)a5
{
  char v6 = a4;
  v32.receiver = self;
  v32.super_class = (Class)_GCDevicePhysicalInputAxis2DInput;
  unsigned __int8 v9 = -[_GCDevicePhysicalInputView update:forUsages:with:](&v32, sel_update_forUsages_with_);
  unsigned int v10 = MyUpdateContext_Offset_5;
  ...
  v12 = (void *)-[_GCDevicePhysicalInputAxis2DInput _sources]((uint64_t)a5);
  char v13 = -[_GCDevicePhysicalInputAxis2DInput _setSources:]((uint64_t)self, (uint64_t)v12);
...
LABEL_22:
    if (a5)
    {
      uint64_t v23 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)a5, (uint64_t)a5 + 56);
    ...
    else
    {
      ...
      {
LABEL_24:
        int v26 = -[_GCDevicePhysicalInputView _testAndSetPrimitiveValue:forSlot:]((uint64_t)self, v25 | v24, (uint64_t)&self->_valueSlot);
        if (v26) {
          char v27 = 16;
        }
        else {
...
LABEL_27:
        *((unsigned char *)a3 + v11) = *((unsigned char *)a3 + v11) & 0xEF | v27;
        if (a5)
        {
          uint64_t v28 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)a5, (uint64_t)a5 + 64);
          if (self) {
            goto LABEL_29;
          }
        }
        else
        {
          ...
          {
LABEL_29:
            int v29 = -[_GCDevicePhysicalInputView _testAndSetPrimitiveValue:forSlot:]((uint64_t)self, v28, (uint64_t)&self->_valueTimestampSlot);
            if (v29) {
              char v30 = 32;
            }
            else {
...
LABEL_18:
  v20 = (void *)-[_GCDevicePhysicalInputAxis2DInput _valueDidChangeHandler]((uint64_t)a5);
  int v21 = -[_GCDevicePhysicalInputAxis2DInput _setValueDidChangeHandler:]((uint64_t)self, (uint64_t)v20);
  if (v21) {
    char v22 = 8;
  }
  else {
...
- (double)_value
{
  ...
  LODWORD(result) = -[_GCDevicePhysicalInputView _primitiveValueForSlot:](a1, a1 + 56);
  return result;
}
...
{
  if (result) {
    return -[_GCDevicePhysicalInputView _testAndSetPrimitiveValue:forSlot:](result, LODWORD(a2) | ((unint64_t)LODWORD(a3) << 32), result + 56);
  }
  return result;
}
...
{
  v9.receiver = self;
  v9.super_class = (Class)_GCDevicePhysicalInputAxis2DInput;
  [(_GCDevicePhysicalInputView *)&v9 preCommit:a3 sender:a4];
  unsigned int v6 = MyUpdateContext_Offset_5;
  if (MyUpdateContext_Offset_5 == -1)
  {
...
{
  v14.receiver = self;
  v14.super_class = (Class)_GCDevicePhysicalInputAxis2DInput;
  -[_GCDevicePhysicalInputView preCommit:sender:](&v14, sel_preCommit_sender_);
  unsigned int v7 = MyUpdateContext_Offset_5;
  if (MyUpdateContext_Offset_5 == -1)
  {
...
LABEL_17:
  unsigned int v10 = (void (**)(void, void, void, __n128, __n128))-[_GCDevicePhysicalInputAxis2DInput _valueDidChangeHandler]((uint64_t)self);
  if (v10)
  {
    if (self)
    {
      uint64_t v13 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)self, (uint64_t)&self->_valueSlot);
      v12.n128_u32[0] = HIDWORD(v13);
      v11.n128_u32[0] = v13;
    }
    else
    {
    ...
    ((void (**)(void, id, _GCDevicePhysicalInputAxis2DInput *, __n128, __n128))v10)[2](v10, a4, self, v11, v12);
  }
}
...
- (uint64_t)isEqualToInput:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      objc_msgSend(v5, "handleFailureInMethod:object:file:lineNumber:description:", sel_isEqualToInput_, v2, @"_GCDevicePhysicalInputAxis2DInput.m", 168, @"Invalid parameter not satisfying: %s", "[otherElement isKindOfClass:_GCDevicePhysicalInputAxis2DInput.class]");
      uint64_t v2 = 0;
      goto LABEL_12;
    }
...
{
  if (result) {
    return -[_GCDevicePhysicalInputView _setPrimitiveValue:forSlot:](result, LODWORD(a2) | ((unint64_t)LODWORD(a3) << 32), result + 56);
  }
  return result;
}
...
- (id)valueDidChangeHandler
{
  uint64_t v2 = (void *)-[_GCDevicePhysicalInputAxis2DInput _valueDidChangeHandler]((uint64_t)self);
...
- (GCPoint2)value
{
  if (self)
  {
    uint64_t v4 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:]((uint64_t)self, (uint64_t)&self->_valueSlot);
    float v3 = *((float *)&v4 + 1);
    float v2 = *(float *)&v4;
  }
  else
...
- (double)lastValueLatency
{
  if (!dword_267F28E4C)
  {
    mach_timebase_info((mach_timebase_info_t)&lastValueLatency_sTimebaseInfo_1);
    if (self) {
      goto LABEL_3;
    }
LABEL_6:
    double v3 = 0.0;
    return (double)(mach_absolute_time() * lastValueLatency_sTimebaseInfo_1 / dword_267F28E4C)
         / 1000000000.0
         - v3;
  }
  if (!self) {
...
- (NSSet)sources
{
  float v2 = (void *)-[_GCDevicePhysicalInputAxis2DInput _sources]((uint64_t)self);
...
- (uint64_t)update:(float)a3 withValue:(float)a4 timestamp:(double)a5
{
  if (result)
  {
    ...
    uint64_t v11 = -[_GCDevicePhysicalInputView _primitiveValueForSlot:](v9, v9 + 56);
    if (a3 == *(float *)&v11 && a4 == *((float *)&v11 + 1))
    {
      return 0;
    }
    else
    {
      -[_GCDevicePhysicalInputView _setPrimitiveValue:forSlot:](v9, LODWORD(a3) | ((unint64_t)LODWORD(a4) << 32), v9 + 56);
      -[_GCDevicePhysicalInputView _setPrimitiveValue:forSlot:](v9, *(uint64_t *)&a5, v9 + 64);
      *(unsigned char *)(a2 + v10) |= 0x30u;
      return 1;
    }
  }
  return result;
