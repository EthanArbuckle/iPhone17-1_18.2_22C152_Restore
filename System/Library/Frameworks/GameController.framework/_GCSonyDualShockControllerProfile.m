...
+ (_GCPhysicalDeviceManager)deviceManager
{
  ...
  v2 = (void *)deviceManager_deviceManager_3;
...
+ (id)logicalDevice:(id)a3 makeControllerPhysicalInputProfileWithIdentifier:(id)a4
{
  ...
  char v21 = 0;
  char v22 = 0;
  v8 = [(GCExtendedGamepad *)[GCDualShockGamepad alloc] initWithIdentifier:v6 info:v11];
...
+ (id)logicalDevice:(id)a3 makeControllerInputDescriptionWithIdentifier:(id)a4 bindings:(id)a5
{
  ...
  [v122 setLocalizedName:GCFLOC_DS4_BUTTON_MENU];
  v9 = unk_26D2ABAD4(&off_26D2ABD28, "symbolWithSFSymbolsName:", @"capsule.portrait");
  [v122 setSymbol:v9];

  [v122 setEventPressedValueField:23];
  v121 = +[GCDevicePhysicalInputButtonElementDescription descriptionWithIdentifier:@"button.share"];
  v10 = +[NSSet setWithObject:@"Button Options"];
  [v121 setAliases:v10];

  [v121 setLocalizedName:GCFLOC_DS4_BUTTON_OPTIONS];
  ...
  v23 = unk_26D2ABAD4(&off_26D2ABD28, "symbolWithSFSymbolsName:", @"r1.rectangle.roundedbottom");
  [v113 setSymbol:v23];
