...
{
  v3.receiver = self;
  v3.super_class = (Class)_GCDevicePhysicalInputAxis2DInputParameters;
...
{
  v6.receiver = self;
  v6.super_class = (Class)_GCDevicePhysicalInputAxis2DInputParameters;
...
- (BOOL)isEqual:(id)a3
{
  v4 = (NSSet **)a3;
  v8.receiver = self;
  v8.super_class = (Class)_GCDevicePhysicalInputAxis2DInputParameters;
