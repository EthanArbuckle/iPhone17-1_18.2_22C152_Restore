...
- (_GCMotionEventHIDAdapter)initWithSource:(id)a3 service:(id)a4
{
  ...
  id v8 = a4;
  v19.receiver = self;
  v19.super_class = (Class)_GCMotionEventHIDAdapter;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)_GCMotionEventHIDAdapter;
...
{
  v4 = (void *)[a3 copy];
  objc_super v5 = [(_GCMotionEventHIDAdapter *)self observers];
  ...
  if ((v7 & 1) == 0)
  {
    do
    {
      id v8 = [(_GCMotionEventHIDAdapter *)self observers];
      ...
      uint64_t v11 = [(_GCMotionEventHIDAdapter *)self observers];
