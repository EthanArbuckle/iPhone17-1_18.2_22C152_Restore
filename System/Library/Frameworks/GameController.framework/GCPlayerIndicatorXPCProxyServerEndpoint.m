...
{
  v5 = +[NSUUID UUID];
  id v6 = [(GCPlayerIndicatorXPCProxyServerEndpoint *)self initWithIdentifier:v5 initialValue:a3];
...
- (void)invalidateClient
{
  ...
  OUTLINED_FUNCTION_0_28(&dword_220998000, v0, v1, "Dropping remote endpoint for %@", v2, v3, v4, v5, v6);
}
    ...
    if (v4)
    {
      ...
      if (v5 <= 6)
      {
        ...
        if (v5 == 6)
        {
          ...
          [(GCPlayerIndicatorXPCProxyRemoteClientEndpointInterface *)v4 refreshPlayerIndex];
        }
        else
        {
          if (isInternalBuild)
          ...
          [(GCPlayerIndicatorXPCProxyRemoteClientEndpointInterface *)v4 newPlayerIndex:self->_playerIndex];
...
- (void)newPlayerIndex:(int64_t)a3
{
  ...
  v3[4] = self;
  v3[5] = a3;
  _os_activity_initiate(&dword_220998000, "(Player Indicator XPC Proxy Server Endpoint) New Player Index", OS_ACTIVITY_FLAG_DEFAULT, v3);
}
...
void __58__GCPlayerIndicatorXPCProxyServerEndpoint_newPlayerIndex___block_invoke(uint64_t a1)
{
  ...
  if (v1 != *(void *)(v2 + 56))
  {
    *(void *)(v2 + 56) = v1;
    ...
    [WeakRetained playerIndicatorXPCProxyServerEndpoint:*(void *)(a1 + 32) didReceivePlayerIndexChange:*(void *)(a1 + 40)];
  }
}
...
- (void)fetchPlayerIndexWithReply:(id)a3
{
  ...
  v4[1] = 3221225472;
  v4[2] = __69__GCPlayerIndicatorXPCProxyServerEndpoint_fetchPlayerIndexWithReply___block_invoke;
  v4[3] = &unk_26D22AA20;
  v4[4] = self;
  id v5 = a3;
  id v3 = v5;
  _os_activity_initiate(&dword_220998000, "(Player Indicator XPC Proxy Server Endpoint) Fetch Player Index", OS_ACTIVITY_FLAG_DEFAULT, v4);
}
...
- (void)invalidateConnection
{
  ...
  _os_activity_initiate(&dword_220998000, "(Player Indicator XPC Proxy Server Endpoint) Invalidate Connection", OS_ACTIVITY_FLAG_DEFAULT, activity_block);
}
...
{
  id v5 = a3;
  id v6 = [(GCPlayerIndicatorXPCProxyServerEndpoint *)self identifier];
...
- (GCPlayerIndicatorXPCProxyServerEndpointDelegate)delegate
{
  ...
  return (GCPlayerIndicatorXPCProxyServerEndpointDelegate *)WeakRetained;
}
...
{
  OUTLINED_FUNCTION_1_24();
  OUTLINED_FUNCTION_0_28(&dword_220998000, v0, v1, "Client has arrived for %@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_1_24();
  OUTLINED_FUNCTION_0_28(&dword_220998000, v0, v1, "Sending player index refresh request to remote endpoint: %@", v2, v3, v4, v5, v6);
}

- (void)setPlayerIndex:.cold.2()
{
  OUTLINED_FUNCTION_1_24();
  OUTLINED_FUNCTION_0_28(&dword_220998000, v0, v1, "Sending new player index to remote endpoint: %@", v2, v3, v4, v5, v6);
}
