...
- (CTXPCSendResponseForSuggestedReplyRequest)initWithContext:(id)a3 destination:(id)a4 messageID:(id)a5 response:(id)a6;
...
- (CTXPCSendResponseForSuggestedReplyRequest)initWithContext:(id)a3 destination:(id)a4 messageID:(id)a5 response:(id)a6
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)CTXPCSendResponseForSuggestedReplyRequest;
...
- (CTLazuliChatBotResponseForSuggestedReply)response
{
  ...
  return (CTLazuliChatBotResponseForSuggestedReply *)v4;
}
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = [(CTXPCSendResponseForSuggestedReplyRequest *)self destination];
  id v10 = [(CTXPCSendResponseForSuggestedReplyRequest *)self messageID];
  id v11 = [(CTXPCSendResponseForSuggestedReplyRequest *)self response];
  ...
  id v12 = v7;
  id v14 = v12;
  [v6 sendResponseForSuggestedReply:v8 to:v9 withMessageID:v10 response:v11 completion:v13];
}

uint64_t __89__CTXPCSendResponseForSuggestedReplyRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCSendResponseForSuggestedReplyRequest;
