...
- (CTXPCGetRemoteDevicesResponse)initWithList:(id)a3;
@end
...
- (CTXPCGetRemoteDevicesResponse)initWithList:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9.receiver = self;
    v9.super_class = (Class)CTXPCGetRemoteDevicesResponse;
    v7 = [(CTXPCMessage *)&v9 initWithNamedArguments:v6];
  }
  else
  {
    v10.receiver = self;
    v10.super_class = (Class)CTXPCGetRemoteDevicesResponse;
...
- (CTRemoteDeviceList)remoteDeviceList
{
  ...
  id v3 = [v2 objectForKey:@"remoteDeviceList"];
  objc_opt_class();
...
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___CTXPCGetRemoteDevicesResponse;
