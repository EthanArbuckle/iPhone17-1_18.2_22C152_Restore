@interface CTSweetgumDataPlanMetrics
+ (BOOL)supportsSecureCoding;
- (BOOL)isEqual:(id)a3;
- (CTSweetgumDataPlanMetrics)init;
- (CTSweetgumDataPlanMetrics)initWithCoder:(id)a3;
...
@implementation CTSweetgumDataPlanMetrics

- (CTSweetgumDataPlanMetrics)init
{
  v8.receiver = self;
  v8.super_class = (Class)CTSweetgumDataPlanMetrics;
  v2 = [(CTSweetgumDataPlanMetrics *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  v4 = [(CTSweetgumDataPlanMetrics *)self billingCycleEndDate];
  [v3 appendFormat:@", billingCycleEndDate=%@", v4];

  [v3 appendFormat:@", regStatus=%s", CTSweetgumRegistrationStatusAsString(-[CTSweetgumDataPlanMetrics regStatus](self, "regStatus"))];
  v5 = [(CTSweetgumDataPlanMetrics *)self domesticCapacity];
  [v3 appendFormat:@", domesticCapacity=%@", v5];

  v6 = [(CTSweetgumDataPlanMetrics *)self domestic];
...
- (BOOL)isEqual:(id)a3
{
  v6 = (CTSweetgumDataPlanMetrics *)a3;
  if (v6 == self)
  {
    char v9 = 1;
  }
  else
  {
    ...
    {
      v7 = [(CTSweetgumDataPlanMetrics *)self billingCycleEndDate];
      objc_super v8 = [(CTSweetgumDataPlanMetrics *)v6 billingCycleEndDate];
      if (v7 == v8
        || ([(CTSweetgumDataPlanMetrics *)self billingCycleEndDate],
            v3 = objc_claimAutoreleasedReturnValue(),
            [(CTSweetgumDataPlanMetrics *)v6 billingCycleEndDate],
            v4 = objc_claimAutoreleasedReturnValue(),
            [v3 isEqualToDate:v4]))
      {
        int64_t v10 = [(CTSweetgumDataPlanMetrics *)self regStatus];
        if (v10 == [(CTSweetgumDataPlanMetrics *)v6 regStatus])
        {
          v11 = [(CTSweetgumDataPlanMetrics *)self domesticCapacity];
          uint64_t v12 = [(CTSweetgumDataPlanMetrics *)v6 domesticCapacity];
          if (v11 == (void *)v12)
          {
          ...
          {
            v13 = (void *)v12;
            v14 = [(CTSweetgumDataPlanMetrics *)self domesticCapacity];
            v15 = [(CTSweetgumDataPlanMetrics *)v6 domesticCapacity];
...
- (CTSweetgumDataPlanMetricsItem)domestic
{
  ...
  {
    v2 = objc_alloc_init(CTSweetgumDataPlanMetricsItem);
    [(CTSweetgumDataPlanMetricsItem *)v2 setCapacityBytes:self->_domesticCapacity];
  }
...
- (CTSweetgumDataPlanMetrics)initWithCoder:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)CTSweetgumDataPlanMetrics;
  id v5 = [(CTSweetgumDataPlanMetrics *)&v11 init];
  if (v5)
  {
