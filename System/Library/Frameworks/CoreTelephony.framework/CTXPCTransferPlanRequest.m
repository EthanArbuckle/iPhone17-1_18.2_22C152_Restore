...
- (CTXPCTransferPlanRequest)initWithPlan:(id)a3 fromDevice:(id)a4;
- (id)deviceIdentifier;
- (id)plan;
...
- (CTXPCTransferPlanRequest)initWithPlan:(id)a3 fromDevice:(id)a4
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)CTXPCTransferPlanRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  v8 = [(CTXPCTransferPlanRequest *)self plan];
  v9 = [(CTXPCTransferPlanRequest *)self deviceIdentifier];
  ...
  id v10 = v7;
  id v12 = v10;
  [v6 transferCellularPlan:v8 fromDevice:v9 completionHandler:v11];
}

uint64_t __72__CTXPCTransferPlanRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCTransferPlanRequest;
