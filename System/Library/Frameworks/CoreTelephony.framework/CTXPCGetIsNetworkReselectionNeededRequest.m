@interface CTXPCGetIsNetworkReselectionNeededRequest
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v9 = v7;
  id v11 = v9;
  [v6 isNetworkReselectionNeeded:v8 completion:v10];
}
...
void __89__CTXPCGetIsNetworkReselectionNeededRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (v6) {
    ...
    v5 = [[CTXPCGetIsNetworkReselectionNeededResponse alloc] initWithNeedsReselection:a2];
  }
