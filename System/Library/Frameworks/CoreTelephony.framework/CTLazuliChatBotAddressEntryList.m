...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotAddressEntryList *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotAddressEntryList *)self isEqualToCTLazuliChatBotAddressEntryList:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotAddressEntryList allocWithZone:a3];
  [(CTLazuliChatBotAddressEntryList *)v4 setList:self->_list];
  return v4;
}
...
- (CTLazuliChatBotAddressEntryList)initWithReflection:(const void *)a3
{
  ...
  id v4 = [(CTLazuliChatBotAddressEntryList *)&v11 init];
  if (v4)
  {
