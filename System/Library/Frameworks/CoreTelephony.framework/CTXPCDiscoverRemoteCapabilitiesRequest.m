...
- (CTXPCDiscoverRemoteCapabilitiesRequest)initWithContext:(id)a3 destination:(id)a4 operationID:(id)a5;
...
- (CTXPCDiscoverRemoteCapabilitiesRequest)initWithContext:(id)a3 destination:(id)a4 operationID:(id)a5
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)CTXPCDiscoverRemoteCapabilitiesRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v9 = [(CTXPCDiscoverRemoteCapabilitiesRequest *)self destination];
  id v10 = [(CTXPCDiscoverRemoteCapabilitiesRequest *)self operationID];
  ...
  id v11 = v7;
  id v13 = v11;
  [v6 discoverRemoteCapabilities:v8 forDestination:v9 withOperationID:v10 completion:v12];
}

uint64_t __86__CTXPCDiscoverRemoteCapabilitiesRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCDiscoverRemoteCapabilitiesRequest;
