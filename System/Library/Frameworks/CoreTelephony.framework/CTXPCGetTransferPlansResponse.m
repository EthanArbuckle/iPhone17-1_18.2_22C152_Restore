...
- (CTXPCGetTransferPlansResponse)initWithRemtoeDevices:(id)a3;
@end
...
- (CTXPCGetTransferPlansResponse)initWithRemtoeDevices:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9.receiver = self;
    v9.super_class = (Class)CTXPCGetTransferPlansResponse;
    v7 = [(CTXPCMessage *)&v9 initWithNamedArguments:v6];
  }
  else
  {
    v10.receiver = self;
    v10.super_class = (Class)CTXPCGetTransferPlansResponse;
...
- (CTRemoteDeviceList)devices
{
  ...
  return (CTRemoteDeviceList *)v4;
}

+ (id)allowedClassesForArguments
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___CTXPCGetTransferPlansResponse;
