...
- (id)description
{
  ...
  v4 = [(CTLazuliChatBotMenuL2 *)self displayText];
  [v3 appendFormat:@", displayText = %@", v4];

  v5 = [(CTLazuliChatBotMenuL2 *)self list];
...
{
  id v4 = a3;
  v5 = [(CTLazuliChatBotMenuL2 *)self displayText];
  v6 = [v4 displayText];
  if ([v5 isEqualToString:v6])
  {
    v7 = [(CTLazuliChatBotMenuL2 *)self list];
    v8 = [v4 list];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotMenuL2 *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotMenuL2 *)self isEqualToCTLazuliChatBotMenuL2:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotMenuL2 allocWithZone:a3];
  [(CTLazuliChatBotMenuL2 *)v4 setDisplayText:self->_displayText];
  [(CTLazuliChatBotMenuL2 *)v4 setList:self->_list];
  return v4;
}
...
- (CTLazuliChatBotMenuL2)initWithReflection:(const void *)a3
{
  v14.receiver = self;
  v14.super_class = (Class)CTLazuliChatBotMenuL2;
  id v4 = [(CTLazuliChatBotMenuL2 *)&v14 init];
  if (v4)
  {
    if (*((char *)a3 + 23) >= 0) {
      v5 = a3;
    ...
    for (uint64_t i = *((void *)a3 + 4); v9 != i; v9 += 232)
    {
      uint64_t v11 = [[CTLazuliChatBotMenuL2Content alloc] initWithReflection:v9];
