...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotMenuItem *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotMenuItem *)self isEqualToCTLazuliChatBotMenuItem:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotMenuItem allocWithZone:a3];
  [(CTLazuliChatBotMenuItem *)v4 setList:self->_list];
  return v4;
}
...
- (CTLazuliChatBotMenuItem)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CTLazuliChatBotMenuItem;
...
{
  v11.receiver = self;
  v11.super_class = (Class)CTLazuliChatBotMenuItem;
  id v4 = [(CTLazuliChatBotMenuItem *)&v11 init];
  if (v4)
  {
