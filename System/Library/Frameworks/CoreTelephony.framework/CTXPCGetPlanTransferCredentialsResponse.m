...
- (CTXPCGetPlanTransferCredentialsResponse)initWithInfo:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9.receiver = self;
    v9.super_class = (Class)CTXPCGetPlanTransferCredentialsResponse;
    v7 = [(CTXPCMessage *)&v9 initWithNamedArguments:v6];
  }
  else
  {
    v10.receiver = self;
    v10.super_class = (Class)CTXPCGetPlanTransferCredentialsResponse;
...
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___CTXPCGetPlanTransferCredentialsResponse;
