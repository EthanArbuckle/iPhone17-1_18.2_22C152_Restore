...
- (CTXPCChangeSubjectRequest)initWithContext:(id)a3 groupChatURI:(id)a4 subject:(id)a5 operationID:(id)a6;
...
- (CTXPCChangeSubjectRequest)initWithContext:(id)a3 groupChatURI:(id)a4 subject:(id)a5 operationID:(id)a6
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)CTXPCChangeSubjectRequest;
...
- (CTLazuliGroupChatSubject)subject
{
  ...
  v4 = CTThrowingCastIfClass<CTLazuliGroupChatSubject>(v3);

  return (CTLazuliGroupChatSubject *)v4;
}
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v10 = [(CTXPCChangeSubjectRequest *)self subject];
  id v11 = [(CTXPCChangeSubjectRequest *)self operationID];
  v13[0] = MEMORY[0x1E4F143A8];
  v13[1] = 3221225472;
  v13[2] = __73__CTXPCChangeSubjectRequest_performRequestWithHandler_completionHandler___block_invoke;
  v13[3] = &unk_1E5260CB8;
  id v12 = v7;
  id v14 = v12;
  [v6 changeSubject:v8 forGroupChat:v9 withNewSubject:v10 withOperationID:v11 completion:v13];
}

uint64_t __73__CTXPCChangeSubjectRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCChangeSubjectRequest;
