...
- (CTXPCReadCachedChatBotRenderInfoRequest)initWithContext:(id)a3 destination:(id)a4
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)CTXPCReadCachedChatBotRenderInfoRequest;
...
void __87__CTXPCReadCachedChatBotRenderInfoRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  id v5 = a3;
  if (v7) {
    id v6 = [[CTXPCReadCachedChatBotRenderInfoResponse alloc] initWithInfo:v7];
  }
  else {
    id v6 = 0;
  }
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCReadCachedChatBotRenderInfoRequest;
