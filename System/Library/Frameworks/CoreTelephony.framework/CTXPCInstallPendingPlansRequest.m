...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  objc_super v8 = [(CTXPCInstallPendingPlansRequest *)self planList];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  void v10[2] = __79__CTXPCInstallPendingPlansRequest_performRequestWithHandler_completionHandler___block_invoke;
  v10[3] = &unk_1E5260CB8;
  id v9 = v7;
  id v11 = v9;
...
- (id)planList
{
  ...
  id v4 = CTThrowingCastIfClass<CTPlanList>(v3);
