...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotCategoryList *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotCategoryList *)self isEqualToCTLazuliChatBotCategoryList:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotCategoryList allocWithZone:a3];
  [(CTLazuliChatBotCategoryList *)v4 setCategoryList:self->_categoryList];
  return v4;
}
...
- (CTLazuliChatBotCategoryList)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v9 = [v4 decodeObjectOfClasses:v8 forKey:@"kCategoryListKey"];
...
- (CTLazuliChatBotCategoryList)initWithReflection:(const void *)a3
{
  ...
  id v4 = [(CTLazuliChatBotCategoryList *)&v13 init];
  if (v4)
  {
