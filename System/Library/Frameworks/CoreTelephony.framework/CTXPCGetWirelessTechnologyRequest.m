@interface CTXPCGetWirelessTechnologyRequest
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v9 = v7;
  id v11 = v9;
  [v6 copyWirelessTechnology:v8 completion:v10];
}
...
void __81__CTXPCGetWirelessTechnologyRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  id v6 = 0;
  if (v7 && !v5) {
    id v6 = [[CTXPCGetWirelessTechnologyResponse alloc] initWithTechnology:v7];
  }
