...
{
  v8.receiver = self;
  v8.super_class = (Class)NRSlicingNotificationManagerImpl;
  v4 = [(NRSlicingNotificationManagerImpl *)&v8 init];
  if (v4)
  {
    v5 = (UNUserNotificationCenter *)[objc_alloc((Class)UNUserNotificationCenter) initWithBundleIdentifier:@"com.apple.SIMSetupUIService" queue:a3];
...
- (void)sendNotification:(id)a3 body:(id)a4 identifier:(id)a5
{
  ...
  [(UNUserNotificationCenter *)self->fUserNotificationCenter addNotificationRequest:v13 withCompletionHandler:&stru_1019C5520];
}
