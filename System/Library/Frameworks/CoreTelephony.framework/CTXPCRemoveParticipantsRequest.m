...
- (CTXPCRemoveParticipantsRequest)initWithContext:(id)a3 groupChatURI:(id)a4 participants:(id)a5 operationID:(id)a6;
...
- (CTXPCRemoveParticipantsRequest)initWithContext:(id)a3 groupChatURI:(id)a4 participants:(id)a5 operationID:(id)a6
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)CTXPCRemoveParticipantsRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v10 = [(CTXPCRemoveParticipantsRequest *)self participants];
  id v11 = [(CTXPCRemoveParticipantsRequest *)self operationID];
  v13[0] = MEMORY[0x1E4F143A8];
  v13[1] = 3221225472;
  v13[2] = __78__CTXPCRemoveParticipantsRequest_performRequestWithHandler_completionHandler___block_invoke;
  v13[3] = &unk_1E5260CB8;
  id v12 = v7;
  id v14 = v12;
  [v6 removeParticipants:v8 fromGroupChat:v9 withParticipantsToRemove:v10 withOperationID:v11 completion:v13];
}

uint64_t __78__CTXPCRemoveParticipantsRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCRemoveParticipantsRequest;
