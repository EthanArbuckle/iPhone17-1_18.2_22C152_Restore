...
- (CTXPCReportChatBotSpamRequest)initWithContext:(id)a3 destination:(id)a4 spamReportInfo:(id)a5 operationID:(id)a6
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)CTXPCReportChatBotSpamRequest;
...
- (CTLazuliChatBotSpamReportInformation)spamReportInfo
{
  ...
  return (CTLazuliChatBotSpamReportInformation *)v4;
}
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v10 = [(CTXPCReportChatBotSpamRequest *)self spamReportInfo];
  id v11 = [(CTXPCReportChatBotSpamRequest *)self operationID];
...
uint64_t __77__CTXPCReportChatBotSpamRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCReportChatBotSpamRequest;
