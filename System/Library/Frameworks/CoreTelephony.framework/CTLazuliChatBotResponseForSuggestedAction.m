...
- (id)description
{
  ...
  v4 = [(CTLazuliChatBotResponseForSuggestedAction *)self displayText];
  [v3 appendFormat:@", displayText = %@", v4];

  v5 = [(CTLazuliChatBotResponseForSuggestedAction *)self postBackData];
  [v3 appendFormat:@", postBackData = %@", v5];

  v6 = [(CTLazuliChatBotResponseForSuggestedAction *)self inReplyToID];
...
{
  id v4 = a3;
  v5 = [(CTLazuliChatBotResponseForSuggestedAction *)self displayText];
  v6 = [v4 displayText];
  if ([v5 isEqualToString:v6])
  {
    v7 = [(CTLazuliChatBotResponseForSuggestedAction *)self postBackData];
    v8 = [v4 postBackData];
    if ([v7 isEqualToCTLazuliChatBotPostbackData:v8])
    {
      v9 = [(CTLazuliChatBotResponseForSuggestedAction *)self inReplyToID];
      v10 = [v4 inReplyToID];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotResponseForSuggestedAction *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotResponseForSuggestedAction *)self isEqualToCTLazuliChatBotResponseForSuggestedAction:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotResponseForSuggestedAction allocWithZone:a3];
  [(CTLazuliChatBotResponseForSuggestedAction *)v4 setDisplayText:self->_displayText];
  [(CTLazuliChatBotResponseForSuggestedAction *)v4 setPostBackData:self->_postBackData];
  [(CTLazuliChatBotResponseForSuggestedAction *)v4 setInReplyToID:self->_inReplyToID];
  return v4;
}
...
- (CTLazuliChatBotResponseForSuggestedAction)initWithReflection:(const void *)a3
{
  v13.receiver = self;
  v13.super_class = (Class)CTLazuliChatBotResponseForSuggestedAction;
  id v4 = [(CTLazuliChatBotResponseForSuggestedAction *)&v13 init];
  if (v4)
  {
    if (*((char *)a3 + 23) >= 0) {
      v5 = a3;
