...
- (CTXPCSendResponseForSuggestedActionRequest)initWithContext:(id)a3 destination:(id)a4 messageID:(id)a5 response:(id)a6
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)CTXPCSendResponseForSuggestedActionRequest;
...
- (CTLazuliChatBotResponseForSuggestedAction)response
{
  ...
  return (CTLazuliChatBotResponseForSuggestedAction *)v4;
}
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v10 = [(CTXPCSendResponseForSuggestedActionRequest *)self messageID];
  id v11 = [(CTXPCSendResponseForSuggestedActionRequest *)self response];
...
uint64_t __90__CTXPCSendResponseForSuggestedActionRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCSendResponseForSuggestedActionRequest;
