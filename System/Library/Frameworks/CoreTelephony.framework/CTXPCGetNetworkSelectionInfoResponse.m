...
- (CTXPCGetNetworkSelectionInfoResponse)initWithNetworkSelectionInfo:(id)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CTXPCGetNetworkSelectionInfoResponse;
...
- (CTNetworkSelectionInfo)info
{
  ...
  id v4 = CTThrowingCastIfClass<CTNetworkSelectionInfo>(v3);

  return (CTNetworkSelectionInfo *)v4;
}

+ (id)allowedClassesForArguments
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___CTXPCGetNetworkSelectionInfoResponse;
