...
- (CTXPCSendOneToManyTextMessageRequest)initWithContext:(id)a3 to:(id)a4 withMessageID:(id)a5 withMessage:(id)a6
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)CTXPCSendOneToManyTextMessageRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v10 = [(CTXPCSendOneToManyTextMessageRequest *)self message];
  id v11 = [(CTXPCSendOneToManyTextMessageRequest *)self destinationList];
  if (v11)
  {
...
uint64_t __84__CTXPCSendOneToManyTextMessageRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1)
{
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCSendOneToManyTextMessageRequest;
