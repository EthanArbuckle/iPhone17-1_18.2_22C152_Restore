@interface CTXPCGetEnhancedVoiceLinkQualityMetricRequest
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  id v9 = v7;
  id v11 = v9;
  [v6 getEnhancedVoiceLinkQualityMetric:v8 completion:v10];
}
...
void __93__CTXPCGetEnhancedVoiceLinkQualityMetricRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  id v6 = 0;
  if (v7 && !v5) {
    id v6 = [[CTXPCGetEnhancedVoiceLinkQualityMetricResponse alloc] initWithEnhancedLinkQualityMetric:v7];
  }
