...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = [(CTXPCSendFileTransferMessageRequest *)self messageID];
  id v10 = [(CTXPCSendFileTransferMessageRequest *)self lazuliDescriptor];
  id v11 = [(CTXPCSendFileTransferMessageRequest *)self destination];
  if (v11)
  {
    ...
    v16[3] = &unk_1E5260CB8;
    id v17 = v7;
    [v6 sendFileTransferMessage:v8 to:v11 withMessageID:v9 withFileInformation:v10 completion:v16];
    id v12 = v17;
  }
  else
  {
    id v12 = [(CTXPCSendFileTransferMessageRequest *)self groupChatURI];
    if (v12)
    {
      ...
      v14[3] = &unk_1E5260CB8;
      id v15 = v7;
      [v6 sendFileTransferMessage:v8 toGroupDestination:v12 withMessageID:v9 withFileInformation:v10 completion:v14];
    }
    else
    {
