...
- (CTXPCUnhideTransferPlanRequest)initWithPlan:(id)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CTXPCUnhideTransferPlanRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  objc_super v8 = [(CTXPCUnhideTransferPlanRequest *)self plan];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  void v10[2] = __78__CTXPCUnhideTransferPlanRequest_performRequestWithHandler_completionHandler___block_invoke;
  v10[3] = &unk_1E5262E68;
  id v9 = v7;
  id v11 = v9;
...
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___CTXPCUnhideTransferPlanRequest;
