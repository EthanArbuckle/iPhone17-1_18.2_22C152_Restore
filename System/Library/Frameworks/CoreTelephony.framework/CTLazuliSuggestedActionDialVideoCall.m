...
{
  id v5 = a3;
  v6 = [(CTLazuliSuggestedActionDialVideoCall *)self phoneNumber];
  v7 = [v5 phoneNumber];
  if ([v6 isEqualToString:v7])
  {
    v8 = [(CTLazuliSuggestedActionDialVideoCall *)self fallbackUrl];
    if (v8 || ([v5 fallbackUrl], (v3 = objc_claimAutoreleasedReturnValue()) != 0))
    {
      v9 = [(CTLazuliSuggestedActionDialVideoCall *)self fallbackUrl];
      v10 = [v5 fallbackUrl];
...
- (BOOL)isEqual:(id)a3
{
  v4 = (CTLazuliSuggestedActionDialVideoCall *)a3;
  id v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliSuggestedActionDialVideoCall *)self isEqualToCTLazuliSuggestedActionDialVideoCall:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[CTLazuliSuggestedActionDialVideoCall allocWithZone:a3];
  [(CTLazuliSuggestedActionDialVideoCall *)v4 setPhoneNumber:self->_phoneNumber];
  [(CTLazuliSuggestedActionDialVideoCall *)v4 setFallbackUrl:self->_fallbackUrl];
  return v4;
}
...
- (CTLazuliSuggestedActionDialVideoCall)initWithCoder:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)CTLazuliSuggestedActionDialVideoCall;
  id v5 = [(CTLazuliSuggestedActionDialVideoCall *)&v11 init];
  if (v5)
  {
...
{
  v15.receiver = self;
  v15.super_class = (Class)CTLazuliSuggestedActionDialVideoCall;
  id v4 = [(CTLazuliSuggestedActionDialVideoCall *)&v15 init];
  if (v4)
  {
    if (*((char *)a3 + 23) >= 0) {
      id v5 = a3;
