...
- (CTXPCGetRemoteDevicesForTransferResponse)initWithDevices:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9.receiver = self;
    v9.super_class = (Class)CTXPCGetRemoteDevicesForTransferResponse;
    v7 = [(CTXPCMessage *)&v9 initWithNamedArguments:v6];
  }
  else
  {
    v10.receiver = self;
    v10.super_class = (Class)CTXPCGetRemoteDevicesForTransferResponse;
...
- (CTRemoteDeviceList)devices
{
  ...
  id v3 = [v2 objectForKeyedSubscript:@"devices"];
  objc_opt_class();
...
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___CTXPCGetRemoteDevicesForTransferResponse;
