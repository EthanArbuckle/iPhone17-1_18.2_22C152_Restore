...
- (CTXPCAddQRCodePlanRequest)initWithRequest:(id)a3 appName:(id)a4 appType:(unint64_t)a5
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)CTXPCAddQRCodePlanRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = [(CTXPCAddQRCodePlanRequest *)self request];
  id v9 = [(CTXPCAddQRCodePlanRequest *)self appName];
  unint64_t v10 = [(CTXPCAddQRCodePlanRequest *)self appType];
...
+ (id)allowedClassesForArguments
{
  ...
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___CTXPCAddQRCodePlanRequest;
