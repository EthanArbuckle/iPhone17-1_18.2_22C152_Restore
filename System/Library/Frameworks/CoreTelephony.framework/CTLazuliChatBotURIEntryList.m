...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotURIEntryList *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotURIEntryList *)self isEqualToCTLazuliChatBotURIEntryList:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotURIEntryList allocWithZone:a3];
  [(CTLazuliChatBotURIEntryList *)v4 setList:self->_list];
  return v4;
}
...
- (CTLazuliChatBotURIEntryList)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CTLazuliChatBotURIEntryList;
...
{
  v11.receiver = self;
  v11.super_class = (Class)CTLazuliChatBotURIEntryList;
  id v4 = [(CTLazuliChatBotURIEntryList *)&v11 init];
  if (v4)
  {
