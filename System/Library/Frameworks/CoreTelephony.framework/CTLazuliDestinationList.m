...
- (id)description
{
  ...
  v4 = [(CTLazuliDestinationList *)self list];
...
{
  id v4 = a3;
  v5 = [(CTLazuliDestinationList *)self list];
  v6 = [v4 list];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliDestinationList *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliDestinationList *)self isEqualToCTLazuliDestinationList:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliDestinationList allocWithZone:a3];
  [(CTLazuliDestinationList *)v4 setList:self->_list];
  return v4;
}
...
- (CTLazuliDestinationList)initWithCoder:(id)a3
{
  ...
  v5 = [(CTLazuliDestinationList *)&v12 init];
  if (v5)
  {
...
- (CTLazuliDestinationList)initWithReflection:(const void *)a3
{
  ...
  id v4 = [(CTLazuliDestinationList *)&v11 init];
  if (v4)
  {
    ...
    if (*(void *)a3 != v7)
    {
      do
      {
        v8 = [[CTLazuliDestination alloc] initWithReflection:v6];
