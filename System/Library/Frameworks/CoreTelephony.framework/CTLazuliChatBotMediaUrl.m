...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotMediaUrl *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotMediaUrl *)self isEqualToCTLazuliChatBotMediaUrl:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotMediaUrl allocWithZone:a3];
  [(CTLazuliChatBotMediaUrl *)v4 setUrl:self->_url];
  return v4;
}
...
- (CTLazuliChatBotMediaUrl)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CTLazuliChatBotMediaUrl;
...
{
  v15.receiver = self;
  v15.super_class = (Class)CTLazuliChatBotMediaUrl;
  id v4 = [(CTLazuliChatBotMediaUrl *)&v15 init];
  if (v4)
  {
