...
- (id)description
{
  ...
  int64_t v4 = [(CTLazuliChatBotMenuL0Content *)self type];
  int64_t v6 = [(CTLazuliChatBotMenuL0Content *)self type];
  [v3 appendFormat:@", type = [%ld - %s]", v4, print_CTLazuliMenuL0ContentType(&v6)];
...
{
  id v4 = a3;
  int64_t v5 = [(CTLazuliChatBotMenuL0Content *)self type];
  if (v5 == [v4 type])
  {
    int64_t v6 = [(CTLazuliChatBotMenuL0Content *)self type];
    if (v6 == 1)
    {
      ...
      char v9 = [v7 isEqualToCTLazuliChatBotMenuL1:v8];
    }
    else
    {
      if (v6)
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (CTLazuliChatBotMenuL0Content *)a3;
  int64_t v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(CTLazuliChatBotMenuL0Content *)self isEqualToCTLazuliChatBotMenuL0Content:v5];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[CTLazuliChatBotMenuL0Content allocWithZone:a3];
  [(CTLazuliChatBotMenuL0Content *)v4 setType:self->_type];
  [(CTLazuliChatBotMenuL0Content *)v4 setItem:self->_item];
  return v4;
}
...
- (CTLazuliChatBotMenuL0Content)initWithCoder:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)CTLazuliChatBotMenuL0Content;
  id v5 = [(CTLazuliChatBotMenuL0Content *)&v14 init];
  if (v5)
  {
...
- (CTLazuliChatBotMenuL0Content)initWithReflection:(const void *)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)CTLazuliChatBotMenuL0Content;
  id v4 = [(CTLazuliChatBotMenuL0Content *)&v12 init];
  if (v4)
  {
    ...
    if (v5 == 1)
    {
      ...
      *(void *)&v14[24] = 0;
      long long v15 = 0uLL;
      std::vector<Lazuli::ChatBotMenuL1Content>::__init_with_size[abi:nn180100]<Lazuli::ChatBotMenuL1Content*,Lazuli::ChatBotMenuL1Content*>(&v14[24], *((void *)a3 + 4), *((void *)a3 + 5), 0xEF7BDEF7BDEF7BDFLL * ((uint64_t)(*((void *)a3 + 5) - *((void *)a3 + 4)) >> 3));
      uint64_t v9 = [[CTLazuliChatBotMenuL1 alloc] initWithReflection:v14];
      id item = v4->_item;
      v4->_id item = v9;

      v13 = (void **)&v14[24];
      std::vector<Lazuli::ChatBotMenuL1Content>::__destroy_vector::operator()[abi:nn180100](&v13);
