...
@implementation CIBlendWithAlphaMask
...
- (id)_kernel
{
  return +[CIKernel kernelWithInternalRepresentation:&CI::_blendWithAlphaMask];
}

- (id)_kernelB0
{
  return +[CIKernel kernelWithInternalRepresentation:&CI::_blendWithAlphaMaskB0];
}
