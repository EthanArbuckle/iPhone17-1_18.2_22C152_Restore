...
- (id)outputImage
{
  ...
  if (inputImage)
  {
    ...
    {
      NSInteger v4 = [(NSNumber *)self->super.inputNumIterations integerValue];
      inputImage = self->super.inputImage;
      if (v4)
      {
        ...
        return -[CIImage imageByApplyingFilter:withInputParameters:](inputImage, "imageByApplyingFilter:withInputParameters:", @"CIMattingSolverInternal", [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v17 forKeys:v16 count:10]);
      }
    }
    return inputImage;
  }
