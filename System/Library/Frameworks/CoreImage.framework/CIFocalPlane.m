...
- (id)outputImage
{
  ...
  if (inputImage)
  {
    ...
    if (inputMatteImage)
    {
      ...
      return -[CIImage imageByApplyingFilter:withInputParameters:](inputImage, "imageByApplyingFilter:withInputParameters:", @"CIFocalPlanePreprocessorInternal", [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v13 forKeys:v12 count:9]);
    }
    return inputImage;
  }
  else
