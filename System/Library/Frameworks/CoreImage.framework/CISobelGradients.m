...
- (id)outputImage
{
  ...
  v11[0] = v4;
  v9 = -[CIKernel applyWithExtent:roiCallback:arguments:](v3, "applyWithExtent:roiCallback:arguments:", &__block_literal_global_48, [MEMORY[0x1E4F1C978] arrayWithObjects:v11 count:1], v5, v6, v7, v8);
  [(CIImage *)self->inputImage extent];
  return -[CIImage imageByCroppingToRect:](v9, "imageByCroppingToRect:");
}

double __31__CISobelGradients_outputImage__block_invoke(double a1, double a2, double a3, double a4)
{
