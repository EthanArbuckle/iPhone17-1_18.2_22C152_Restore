...
- (id)outputImage
{
  v29[20] = *(double *)MEMORY[0x1E4F143B8];
  ...
  v29[19] = v24;
  int is_identity = CI::ColorMatrixImage::is_identity((CI::ColorMatrixImage *)v29, v25);
  v27 = self->inputImage;
  if (!is_identity)
  {
...
+ (id)customAttributes
{
  ...
  v15[0] = [MEMORY[0x1E4F1C978] arrayWithObjects:v13 count:7];
  v15[1] = @"5";
  ...
  v4[0] = +[CIVector vectorWithX:0.0, 0.0, 0.0, 0.0, @"CIAttributeDefault" Y Z W];
