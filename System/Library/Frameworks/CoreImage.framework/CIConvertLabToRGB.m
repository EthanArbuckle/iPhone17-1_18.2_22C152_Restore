...
- (id)outputImage
{
  ...
  v3 = +[CIKernel kernelWithInternalRepresentation:&CI::_LAB_denormalize];
  inputImage = self->inputImage;
  if ([(NSNumber *)self->inputNormalize BOOLValue])
  {
    [(CIImage *)self->inputImage extent];
    v10[0] = inputImage;
    inputImage = -[CIColorKernel applyWithExtent:arguments:](v3, "applyWithExtent:arguments:", [MEMORY[0x1E4F1C978] arrayWithObjects:v10 count:1], v5, v6, v7, v8);
  }
