...
- (id)outputImage
{
  ...
  return [(CIImage *)v5 filteredImage:@"CIPerspectiveTransformWithExtent", @"inputExtent", v6, @"inputTopLeft", inputTopLeft, @"inputTopRight", inputTopRight, @"inputBottomRight", inputBottomRight, @"inputBottomLeft", inputBottomLeft, 0 keysAndValues];
}
