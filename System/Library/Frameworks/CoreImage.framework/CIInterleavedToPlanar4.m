@interface CIInterleavedToPlanar4
- (id)outputImage;
@end

@implementation CIInterleavedToPlanar4
...
- (id)outputImage
{
  ...
  CGFloat v12 = v11;
  CGFloat v14 = v13;
  CGAffineTransformMakeScale(&v21, 1.0, 4.0);
  ...
  v24[0] = v2;
  v24[1] = objc_msgSend(NSNumber, "numberWithDouble:", v6, MEMORY[0x1E4F143A8], 3221225472, __37__CIInterleavedToPlanar4_outputImage__block_invoke, &__block_descriptor_40_e73__CGRect__CGPoint_dd__CGSize_dd__44__0i8_CGRect__CGPoint_dd__CGSize_dd__12l, *(void *)&v6);
