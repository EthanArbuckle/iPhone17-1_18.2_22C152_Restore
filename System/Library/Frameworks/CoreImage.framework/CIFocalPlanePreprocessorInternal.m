...
+ (id)customAttributes
{
  ...
  v18[2] = +[CIVector vectorWithCGRect:](CIVector, "vectorWithCGRect:", *MEMORY[0x1E4F1DB10], *(double *)(MEMORY[0x1E4F1DB10] + 8), *(double *)(MEMORY[0x1E4F1DB10] + 16), *(double *)(MEMORY[0x1E4F1DB10] + 24));
  v21[3] = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v18 forKeys:v17 count:3];
...
- (id)outputImage
{
  ...
  if (inputImage)
  {
    if (self->inputMatteImage)
    {
      ...
      v15 = (void *)[MEMORY[0x1E4F1C978] arrayWithObjects:v39 count:2];
      ...
      uint64_t v25 = [MEMORY[0x1E4F1C978] arrayWithObjects:v37 count:2];
      ...
      v35[8] = @"imageExtents";
      v36[8] = v16;
      inputImage = +[CIImageProcessorKernel applyWithExtent:inputs:arguments:error:](CIFocalPlaneProcessor, "applyWithExtent:inputs:arguments:error:", v25, [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v36 forKeys:v35 count:9], &v34, v18, v20, v22, v24);
      if (v34) {
