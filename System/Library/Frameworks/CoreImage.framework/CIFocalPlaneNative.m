...
+ (id)customAttributes
{
  ...
  v17[3] = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v14 forKeys:v13 count:6];
...
- (id)_focalPlanePreProcessorKernel
{
  return +[CIKernel kernelWithInternalRepresentation:&CI::_disparityRefinementPreprocessing];
}

- (id)_focalPlanePreProcessorKernelPow2
{
  return +[CIKernel kernelWithInternalRepresentation:&CI::_disparityRefinementPreprocessingPow2];
}
  ...
  if (result && self->inputLensModelCalculatorImage)
  {
    if (self->inputMatteImage)
    {
      ...
      if (vabdd_f64(2.0, v39) >= 0.00100000005) {
        id v40 = [(CIFocalPlaneNative *)self _focalPlanePreProcessorKernel];
      }
      else {
        id v40 = [(CIFocalPlaneNative *)self _focalPlanePreProcessorKernelPow2];
      }
      v41 = v40;
      [(CIImage *)self->inputImage extent];
      ...
      v47[3] = v11;
      v47[4] = v15;
      return (id)objc_msgSend(v41, "applyWithExtent:arguments:", objc_msgSend(MEMORY[0x1E4F1C978], "arrayWithObjects:count:", v47, 5), v42, v43, v44, v45);
    }
  }
  else
  {
