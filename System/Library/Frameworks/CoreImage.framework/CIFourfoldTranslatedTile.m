...
- (id)_kernel
{
  return +[CIKernel kernelWithInternalRepresentation:&CI::_fourfoldTranslatedTile];
}
...
- (id)outputImage
{
  ...
  *((float *)&v20 + 1) = v21;
  ...
  v36 = +[CIVector vectorWithX:v47[0] Y:v47[2] Z:v47[1] W:v47[3]];
  v37 = +[CIVector vectorWithX:v48 Y:v50 Z:v49 W:v51];
  id v38 = [(CIFourfoldTranslatedTile *)self _kernel];
