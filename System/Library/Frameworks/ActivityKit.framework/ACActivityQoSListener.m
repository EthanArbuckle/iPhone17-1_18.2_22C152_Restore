...
- (_TtC11ActivityKit28ActivityQoSObservationClient)client;
...
{
  v6.receiver = self;
  v6.super_class = (Class)ACActivityQoSListener;
...
- (id)listenForActivityQoS:(id)a3 withHandler:(id)a4
{
  ...
  id v16 = v10;
  id v12 = v10;
  v13 = (void *)[v11 initWithIdentifier:@"ACActivityQoSListener" forReason:v9 invalidationBlock:v15];
...
uint64_t __58__ACActivityQoSListener_listenForActivityQoS_withHandler___block_invoke_2(uint64_t a1)
{
