...
- (id)dictionaryRepresentation
{
  ...
  if (cacheMessage)
  {
    objc_super v8 = [(SPProtoCacheMessage *)cacheMessage dictionaryRepresentation];
...
LABEL_10:
  uint64_t v14 = [(NSData *)self->_object copyWithZone:a3];
  v15 = *(void **)(v6 + 64);
  *(void *)(v6 + 64) = v14;
...
LABEL_46:
  ...
  if ((unint64_t)object | *((void *)v4 + 8)) {
    char v9 = -[NSData isEqual:](object, "isEqual:");
  }
  else {
    char v9 = 1;
  }
...
LABEL_30:
    uint64_t v23 = 0;
    return v3 ^ v5 ^ v6 ^ v7 ^ v9 ^ (2654435761 * type) ^ v14 ^ v19 ^ v20 ^ v21 ^ v22 ^ v23 ^ [(NSData *)self->_object hash];
  }
LABEL_28:
  unint64_t v21 = 0;
  if ((has & 0x20) == 0) {
