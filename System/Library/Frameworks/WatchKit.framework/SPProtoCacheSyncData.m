...
- (id)description
{
  ...
  v5 = [(SPProtoCacheSyncData *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSString *)self->_cacheIdentifier copyWithZone:a3];
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[SPProtoCacheAssets isEqual:](permanentCache, "isEqual:")))
  {
    ...
    if ((unint64_t)transientCache | v4[3]) {
      char v8 = -[SPProtoCacheAssets isEqual:](transientCache, "isEqual:");
    }
    else {
      char v8 = 1;
    }
