...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [NSNumber numberWithDouble:self->_currentTime];
...
- (void)copyTo:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *((void *)v4 + 1) = *(void *)&self->_currentTime;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 24) & 1) != 0 && self->_currentTime == *((double *)v4 + 1))
    {
      BOOL v6 = 1;
      goto LABEL_9;
    }
