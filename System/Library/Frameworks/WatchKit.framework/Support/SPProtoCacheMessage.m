...
{
  v7.receiver = self;
  v7.super_class = (Class)SPProtoCacheMessage;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(NSString *)self->_assetKey copyWithZone:a3];
  objc_super v7 = (void *)*((void *)v5 + 2);
  *((void *)v5 + 2) = v6;

  id v8 = [(NSString *)self->_gizmoCacheIdentifier copyWithZone:a3];
  v9 = (void *)*((void *)v5 + 4);
  *((void *)v5 + 4) = v8;

  id v10 = [(NSData *)self->_assetData copyWithZone:a3];
  v11 = (void *)*((void *)v5 + 1);
  *((void *)v5 + 1) = v10;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSData isEqual:](assetData, "isEqual:")))
  {
    ...
    if ((unint64_t)syncData | v4[6]) {
      unsigned __int8 v9 = -[SPProtoCacheSyncData isEqual:](syncData, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  ...
  unint64_t v5 = v4 ^ [(NSString *)self->_gizmoCacheIdentifier hash];
  unint64_t v6 = v5 ^ (unint64_t)[(NSData *)self->_assetData hash];
