...
{
  v7.receiver = self;
  v7.super_class = (Class)SPProtoCacheAssets;
  v3 = [(SPProtoCacheAssets *)&v7 description];
  id v4 = [(SPProtoCacheAssets *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_assets, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(SPProtoCacheAssets *)self assetsCount])
  {
    ...
    if (v4)
    {
      ...
      {
        id v7 = [(SPProtoCacheAssets *)self assetsAtIndex:i];
        [v8 addAssets:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)assets | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](assets, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_assets hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SPProtoCacheAssets addAssets:](self, "addAssets:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
