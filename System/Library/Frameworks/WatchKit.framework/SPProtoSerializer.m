...
LABEL_17:
  ...
  if (!strcmp(v9, "s"))
  {
    ...
    uint64_t v12 = [v8 shortValue];
    goto LABEL_17;
  }
  if (!strcmp(v9, "i"))
  {
    [(SPProtoSockPuppetObject *)v7 setSubtype:11];
    uint64_t v11 = (int)[v8 intValue];
    goto LABEL_13;
  }
  if (!strcmp(v9, "f"))
  {
...
+ (id)numberWithSPProtoSockPuppetObject:(id)a3
{
  ...
  {
    case 6u:
      uint64_t v4 = objc_msgSend(NSNumber, "numberWithBool:", objc_msgSend(v3, "nBOOL"));
      break;
    case 8u:
      uint64_t v4 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", objc_msgSend(v3, "nuint64"));
      break;
    case 9u:
      uint64_t v4 = objc_msgSend(NSNumber, "numberWithChar:", (char)objc_msgSend(v3, "nint32"));
      break;
    case 0xAu:
      uint64_t v4 = objc_msgSend(NSNumber, "numberWithShort:", (__int16)objc_msgSend(v3, "nint32"));
      break;
    case 0xDu:
      id v8 = NSNumber;
      [v3 nfloat];
      uint64_t v4 = objc_msgSend(v8, "numberWithFloat:");
      break;
    case 0xEu:
      v7 = NSNumber;
      [v3 ndouble];
      ...
      break;
    default:
      uint64_t v4 = objc_msgSend(NSNumber, "numberWithLongLong:", objc_msgSend(v3, "nint64"));
      break;
  }
  id v5 = (void *)v4;
...
LABEL_16:
        ...
        id v14 = (id)__allowedClasses___allowedClasses;
        uint64_t v15 = [v14 countByEnumeratingWithState:&v28 objects:v42 count:16];
        if (v15)
        {
          uint64_t v16 = v15;
          int v17 = 0;
          ...
          do
          {
            ...
            uint64_t v16 = [v14 countByEnumeratingWithState:&v28 objects:v42 count:16];
          }
          while (v16);
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = v26;
          ...
          v41 = v22;
          id v23 = v22;
          _os_log_error_impl(&dword_2211F3000, v20, OS_LOG_TYPE_ERROR, "%{public}s:%d: obj is of class %{public}@ which is not an allowed class", buf, 0x1Cu);
        }
LABEL_34:
...
LABEL_17:
      ...
      while (v10 != v8);
      uint64_t v24 = [v5 countByEnumeratingWithState:&v32 objects:v43 count:16];
      uint64_t v8 = v24;
    }
    while (v24);
  }
...
LABEL_16:
        ...
        id v15 = (id)__allowedClasses___allowedClasses;
        ...
        if (v16)
        {
          ...
          do
          {
            ...
            uint64_t v17 = [v15 countByEnumeratingWithState:&v30 objects:v44 count:16];
          }
          while (v17);
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = v27;
          ...
          v43 = v23;
          id v24 = v23;
          _os_log_error_impl(&dword_2211F3000, v21, OS_LOG_TYPE_ERROR, "%{public}s:%d: obj is of class %{public}@ which is not an allowed class", buf, 0x1Cu);
        }
LABEL_34:
...
LABEL_17:
      ...
      while (v10 != v8);
      uint64_t v25 = [v5 countByEnumeratingWithState:&v34 objects:v45 count:16];
      uint64_t v8 = v25;
    }
    while (v25);
  }
...
+ (id)dictionaryWithSPPlist:(id)a3
{
  ...
  if ([v3 objectsCount])
  {
    ...
    *(void *)&long long v5 = 136446466;
    ...
    while (1)
    {
      long long v7 = objc_msgSend(v3, "objectAtIndex:", v6, v26, *(_OWORD *)buf, *(void *)&buf[16], v28);
      if ([v7 type] == 2) {
        break;
      }
      if ([v7 type] == 5)
      ...
      if ([v7 type] == 17)
      {
        ...
        if (v15)
        {
          uint64_t v16 = [SPProtoSockPuppetPlist alloc];
          uint64_t v17 = [v7 object];
...
LABEL_34:
      ...
      if ([v7 type] == 3)
      {
        ...
        if (v22)
        {
          ...
          uint64_t v18 = spUtils_deserializeObject(v11, (void *)__allowedClasses___allowedClasses);
LABEL_28:
          id v23 = (void *)v18;
          id v24 = [v7 key];
...
LABEL_14:
        _os_log_error_impl(&dword_2211F3000, v13, OS_LOG_TYPE_ERROR, v14, buf, 0x12u);
        goto LABEL_34;
      }
LABEL_35:
...
+ (id)arrayWithSPPlist:(id)a3
{
  ...
  if ([v3 objectsCount])
  {
    ...
    *(void *)&long long v5 = 136446466;
    ...
    do
    {
      long long v7 = objc_msgSend(v3, "objectAtIndex:", v6, v25, *(_OWORD *)buf, *(void *)&buf[16], v27);
      if ([v7 type] == 2)
      {
        uint64_t v8 = [v7 text];
...
LABEL_35:
            _os_log_error_impl(&dword_2211F3000, v20, OS_LOG_TYPE_ERROR, v21, buf, 0x12u);
          }
        }
        else if ([v7 type] == 17)
        {
        ...
        else
        {
          if ([v7 type] != 16)
          {
            ...
            uint64_t v19 = spUtils_deserializeObject(v11, (void *)__allowedClasses___allowedClasses);
            goto LABEL_29;
          }
          uint64_t v16 = [v7 object];

          if (v16)
          {
            uint64_t v17 = [SPProtoSockPuppetPlist alloc];
