...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SPProtoSockPuppetPlist;
  id v4 = [(SPProtoSockPuppetPlist *)&v8 description];
  v5 = [(SPProtoSockPuppetPlist *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_objects, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(SPProtoSockPuppetPlist *)self objectsCount])
  {
    ...
    if (v4)
    {
      ...
      {
        uint64_t v7 = [(SPProtoSockPuppetPlist *)self objectAtIndex:i];
        [v8 addObject:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)objects | v4[1]) {
      char v6 = -[NSMutableArray isEqual:](objects, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSMutableArray *)self->_objects hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SPProtoSockPuppetPlist addObject:](self, "addObject:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
