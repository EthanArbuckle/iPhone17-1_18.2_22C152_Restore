...
- (id)unarchiver:(id)a3 didDecodeObject:(id)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0
    || (v5 = (objc_class *)objc_opt_class(),
        ...
        int v7 = [v6 isEqualToString:@"SPFont"],
        v6,
        v7))
  {
    id v8 = [a4 font];
...
- (SPFont)initWithCoder:(id)a3
{
  ...
  int v7 = (void *)getUIFontClass_softClass;
  uint64_t v23 = getUIFontClass_softClass;
  ...
  uint64_t v23 = getUIFontDescriptorClass_softClass;
