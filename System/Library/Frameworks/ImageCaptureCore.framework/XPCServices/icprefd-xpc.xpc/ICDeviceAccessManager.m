...
+ (id)sharedAccessManager
{
  if (qword_100014748 != -1) {
    dispatch_once(&qword_100014748, &stru_10000C418);
  }
  v2 = (void *)qword_100014740;
...
- (id)bundleIdentifiersWithAccessType:(id)a3
{
  ...
  dispatch_semaphore_t v20 = sub_100003EE4;
  unint64_t v21 = sub_100003EF4;
