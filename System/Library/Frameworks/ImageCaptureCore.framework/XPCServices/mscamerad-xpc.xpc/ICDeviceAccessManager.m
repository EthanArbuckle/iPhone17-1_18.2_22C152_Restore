...
- (void)dealloc
{
  if (sqlite3_close(self->_externalMediaAccessDB))
  {
    ...
    {
      v4 = objc_msgSend(@"icaccess", "substringWithRange:", 0, 18);
...
+ (id)sharedAccessManager
{
  if (qword_1000447C8 != -1) {
    dispatch_once(&qword_1000447C8, &stru_1000347E0);
  }
  v2 = (void *)qword_1000447C0;
...
LABEL_10:
        ...
        if ((unint64_t)[@"PrivacySettings" length] >= 0x15)
        {
          v22 = objc_msgSend(@"PrivacySettings", "substringWithRange:", 0, 18);
...
LABEL_30:
        ...
        if ((unint64_t)[@"PrivacySettings" length] >= 0x15)
        {
          v37 = objc_msgSend(@"PrivacySettings", "substringWithRange:", 0, 18);
      ...
      if ((unint64_t)[@"PrivacySettings" length] >= 0x15)
      {
        v44 = objc_msgSend(@"PrivacySettings", "substringWithRange:", 0, 18);
...
LABEL_41:
  ...
  if ((unint64_t)[@"DEPRECATED" length] >= 0x15)
  {
    v49 = objc_msgSend(@"DEPRECATED", "substringWithRange:", 0, 18);
...
- (void)addBundleIdentifier:(id)a3
{
  ...
  else
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_1000083CC;
    block[3] = &unk_100034808;
    id v13 = v4;
    long long v14 = self;
...
- (void)updateBundleIdentifier:(id)a3 accessType:(id)a4 withState:(unint64_t)a5
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1000085C0;
  block[3] = &unk_100034830;
...
- (id)bundleIdentifiersWithAccessType:(id)a3
{
  ...
  dispatch_semaphore_t v20 = sub_100007ED0;
  unint64_t v21 = sub_100007EE0;
...
- (BOOL)validateBundleIdentifierInstalled:(id)a3
{
  ...
  if (v9 && !v10)
  {
    ...
    long long v27 = 0u;
    id v11 = (id)v37[5];
    id v12 = objc_msgSend(v11, "countByEnumeratingWithState:objects:count:", &v26, v46, 16, v24);
    if (v12)
    {
