...
- (PTPObjectInfoDataset)initWithBytes:(char *)a3 length:(unsigned int)a4 contentType:(int)a5
{
  ...
  uint64_t v8 = [(PTPObjectInfoDataset *)&v37 init];
  v9 = v8;
  if (!v8) {
    return v9;
  }
  if ([(PTPObjectInfoDataset *)v8 contentLengthValid:v6 forContentType:v5])
  {
    ...
    {
      if ((v5 & 0xFFFFFFFE) == 2) {
        v9->_objectCompressedSize = ReadUInt64((void **)&v36);
      }
      BOOL v18 = v5 == 3;
      if ((v5 - 5) > 0xFFFFFFFD) {
        goto LABEL_18;
...
LABEL_18:
    ...
    uint64_t v19 = CopyUnicodeStringWithLengthByteFromBufferMaxSize((const void **)&v36, (unint64_t)v10);
    filename = v9->_filename;
    v9->_filename = (NSString *)v19;

    uint64_t v21 = CopyUnicodeStringWithLengthByteFromBufferMaxSize((const void **)&v36, (unint64_t)v10);
    if (v18)
    {
    ...
    else
    {
      ...
      uint64_t v24 = CopyUnicodeStringWithLengthByteFromBufferMaxSize((const void **)&v36, (unint64_t)v10);
      v25 = v9->_modificationDate;
      v9->_modificationDate = (NSString *)v24;

      modificationDate = CopyUnicodeStringWithLengthByteFromBufferMaxSize((const void **)&v36, (unint64_t)v10);
    ...
    if (HIDWORD(v35) != v6)
    {
      ...
      v29 = objc_msgSend(NSString, "stringWithFormat:", @"Output Content Length Mismatch: contentLength: %d  datasetLength: %d\n", HIDWORD(v35), v6);
      v30 = (void *)_gICOSLog;
  ...
  {
    v12 = objc_msgSend(@"PTPObjInfo", "substringWithRange:", 0, 18);
    v11 = [v12 stringByAppendingString:@".."];
  }
  v13 = objc_msgSend(NSString, "stringWithFormat:", @"Input Content Length Mismatch: contentLength: %d", v6);
  v14 = (void *)_gICOSLog;
  if (os_log_type_enabled((os_log_t)_gICOSLog, OS_LOG_TYPE_DEFAULT))
  {
    v15 = v11;
...
- (void)contentLength:(unsigned int *)a3 bufferLength:(unsigned int *)a4 contentType:(int)a5
{
  ...
  uint64_t v15 = [(NSMutableString *)self->_keywords length];
  if (v15) {
    int v16 = v15 + 1;
  }
  else {
...
- (id)content:(int)a3
{
  ...
  id v6 = (id) [v5 initWithLength:v15];
  int v16 = (_WORD *)[v6 mutableBytes];
  if (a3)
  {
  ...
  if ((a3 & 0xFFFFFFFE) == 2) {
    WriteUInt64((void **)&v16, self->_objectCompressedSize);
  }
  if ((a3 - 5) <= 0xFFFFFFFD)
  {
  ...
  WriteUnicodeStringWithLengthByteToBuffer((unsigned char **)&v16, self->_filename);
  if (a3 == 3)
  {
  ...
  {
    WriteUnicodeStringWithLengthByteToBuffer((unsigned char **)&v16, self->_captureDate);
    WriteUnicodeStringWithLengthByteToBuffer((unsigned char **)&v16, self->_modificationDate);
    ...
    if ((unint64_t)[(NSMutableString *)self->_keywords length] >= 0x100)
    {
      ...
      {
        int v10 = objc_msgSend(v9, "substringWithRange:", 0, 18);
        uint64_t v11 = [v10 stringByAppendingString:@".."];

        NSUInteger v9 = (void *)v11;
      }
      int v12 = objc_msgSend(NSString, "stringWithFormat:", @"Keywords length of: %lu is larger than a uint8 and cannot be written.", objc_msgSend(*p_modificationDate, "length"));
      NSUInteger v13 = (void *)_gICOSLog;
      if (os_log_type_enabled((os_log_t)_gICOSLog, OS_LOG_TYPE_ERROR)) {
        -[PTPObjectInfoDataset content:](v9, v13);
      }
    }
  }
  WriteUnicodeStringWithLengthByteToBuffer((unsigned char **)&v16, *p_modificationDate);
...
- (id)description
{
  ...
  int v19 = (void *)MEMORY[0x1E4F28E78];
  uint64_t storageID = self->_storageID;
  int v16 = stringForObjectFormatCode(self->_objectFormat);
  objc_super v3 = stringForProtectionStatus(self->_protectionStatus);
  unint64_t objectCompressedSize = self->_objectCompressedSize;
  uint64_t v4 = stringForObjectFormatCode(self->_thumbFormat);
...
- (id)keywords
{
  v2 = (void *)[(NSMutableString *)self->_keywords copy];
...
- (void)addCustomKeyword:(id)a3 withIdentifier:(id)a4
{
  ...
  if (v6 && v7)
  {
    if (!self->_keywords)
    {
      NSUInteger v9 = (NSMutableString *)objc_alloc_init(MEMORY[0x1E4F28E78]);
      keywords = self->_keywords;
      self->_keywords = v9;
    }
    uint64_t v11 = [v6 length];
    uint64_t v12 = [v8 length];
    unint64_t v13 = v11 + v12 + [(NSMutableString *)self->_keywords length] + 3;
    if (v13 > 0xFF)
    {
      __ICOSLogCreate();
      ...
      {
        unsigned int v17 = objc_msgSend(v16, "substringWithRange:", 0, 18);
      ...
      v20 = (void *)_gICOSLog;
      if (os_log_type_enabled((os_log_t)_gICOSLog, OS_LOG_TYPE_ERROR)) {
        -[PTPObjectInfoDataset content:](v16, v20);
      }
    }
    else
    {
      uint64_t v14 = [(NSMutableString *)self->_keywords length];
      uint64_t v15 = @"&";
      if (!v14) {
        uint64_t v15 = &stru_1F1A1D6A8;
      }
...
- (id)relatedUUID
{
  ...
  if (!self->_relatedUUID)
  {
    ...
    {
      NSUInteger v9 = [MEMORY[0x1E4F29128] UUID];
      int v10 = (NSUUID *)[v9 copy];
      uint64_t v11 = self->_relatedUUID;
      self->_relatedUUID = v10;
    }
  }
  uint64_t v12 = self->_relatedUUID;
...
- (int64_t)intervalSince1970
{
  ...
  if (!result)
  {
    int64_t result = ICTimeIntervalSince1970FromPTPString(self->_captureDate);
...
- (void)content:(void *)a1 .cold.1(void *a1, void *a2)
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_1BEEFF000, v5, v6, "%{public}20s ! %{public}@", v7, v8, v9, v10, v11);
}
