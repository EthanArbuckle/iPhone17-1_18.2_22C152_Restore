      ...
      if (v9)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v14 = objc_msgSend(MEMORY[0x1E4F1CA70], "orderedSet", (void)v16);
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        uint64_t v10 = [(NSMutableDictionary *)self->_mediaItems objectForKeyedSubscript:*(void *)(*((void *)&v12 + 1) + 8 * i)];
        v7 += [v10 count];
      }
...
- (void)addMediaItemToIndex:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v9 = [(ICOrderedMediaSet *)self mediaItemWithHandle:v6 inTypes:v8];
    ...
    if (!v9)
    {
      ...
      if (v11)
      {
        uint64_t v13 = objc_msgSend(v11, "indexOfObject:inSortedRange:options:usingComparator:", v4, 0, objc_msgSend(v11, "count"), 1024, &__block_literal_global_3);
...
{
  id v4 = a3;
  unint64_t v5 = [v4 mediaItemType];
  if (v5)
  {
    p_mediaLock = &self->_mediaLock;
    os_unfair_lock_lock(&self->_mediaLock);
    uint64_t v7 = [(NSMutableDictionary *)self->_mediaItems objectForKeyedSubscript:v5];
    uint64_t v8 = v7;
    BOOL v9 = v7 != 0;
    if (v7) {
      [v7 removeObject:v4];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(ICOrderedMediaSet *)self removeMediaItemFromIndex:*(void *)(*((void *)&v11 + 1) + 8 * v9++)];
      }
      while (v8 != v9);
      uint64_t v8 = [v4 countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
    while (v8);
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v9 = [(NSMutableDictionary *)self->_mediaItems objectForKeyedSubscript:*(void *)(*((void *)&v10 + 1) + 8 * v8)];
        [v9 removeAllObjects];
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        uint64_t v16 = objc_msgSend(v13, "indexOfObject:inSortedRange:options:usingComparator:", v15, 0, v14, 256, &__block_literal_global_5);

        if (v16 != 0x7FFFFFFFFFFFFFFFLL)
        {
          uint64_t v17 = [v13 objectAtIndexedSubscript:v16];
...
- (id)orderedSetForType:(id)a3
{
  if (a3)
  {
    ...
    unint64_t v6 = [(NSMutableDictionary *)self->_mediaItems objectForKeyedSubscript:v5];
        ...
        if (v14)
        {
          ...
          do
          {
            for (uint64_t j = 0; j != v15; ++j)
            {
              ...
              long long v18 = *(void **)(*((void *)&v21 + 1) + 8 * j);
