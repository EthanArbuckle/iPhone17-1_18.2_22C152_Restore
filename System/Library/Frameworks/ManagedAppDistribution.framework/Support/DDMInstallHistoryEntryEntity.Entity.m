...
{
  v7.receiver = self;
  v7.super_class = (Class)type metadata accessor for DDMInstallHistoryEntryEntity.Entity();
...
- (_TtCV28ManagedAppDistributionDaemon28DDMInstallHistoryEntryEntity6Entity)initWithPropertyValues:(id)a3 onConnection:(id)a4
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)type metadata accessor for DDMInstallHistoryEntryEntity.Entity();
...
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for DDMInstallHistoryEntryEntity.Entity();
