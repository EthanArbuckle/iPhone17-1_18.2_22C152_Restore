...
- (id)description
{
  ...
  id v6 = sub_100167908((__CFString *)self);
  id v7 = +[NSString stringWithFormat:@"<%@: %p> %@ %@ '%@'", v4, self, property, v6, self->_value];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(ASUSQLitePropertyPredicate *)&v12 isEqual:v4]
    && (id v5 = [(ASUSQLiteComparisonPredicate *)self comparisonType],
        v5 == [v4 comparisonType]))
  {
    id v6 = [(ASUSQLiteComparisonPredicate *)self value];
    id v7 = [v4 value];
    if (v6 == v7)
    {
...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  id v7 = sub_100167908((__CFString *)self);
