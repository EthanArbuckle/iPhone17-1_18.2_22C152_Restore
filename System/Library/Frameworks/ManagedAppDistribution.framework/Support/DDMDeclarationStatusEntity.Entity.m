...
{
  v7.receiver = self;
  v7.super_class = (Class)type metadata accessor for DDMDeclarationStatusEntity.Entity();
...
- (_TtCV28ManagedAppDistributionDaemon26DDMDeclarationStatusEntity6Entity)initWithPropertyValues:(id)a3 onConnection:(id)a4
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)type metadata accessor for DDMDeclarationStatusEntity.Entity();
...
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for DDMDeclarationStatusEntity.Entity();
