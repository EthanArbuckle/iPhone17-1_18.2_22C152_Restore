...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    unsigned int v5 = [(ASUSQLiteNullPredicate *)self matchesNull];
...
- (id)SQLForEntityClass:(Class)a3
{
  unsigned int v5 = [(ASUSQLitePropertyPredicate *)self property];
  unsigned int v6 = [(objc_class *)a3 disambiguatedSQLForProperty:v5];

  unsigned int v7 = [(ASUSQLiteNullPredicate *)self matchesNull];
