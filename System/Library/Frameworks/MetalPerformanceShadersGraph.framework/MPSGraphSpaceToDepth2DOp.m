...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  v17 = [v15 stringWithFormat:@"%@/%@/spaceToDepth2DGradient", v8, v16];
  v18 = [WeakRetained depthToSpace2DTensor:v20 widthAxisTensor:v10 heightAxisTensor:v11 depthAxisTensor:v12 blockSize:blockSize usePixelShuffleOrder:pixelShuffleOrder name:v17];
...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v14 = mlir::FileLineColLoc::get(StringAttr, 0x428u, 0);
  if (!v14) {
  ...
  {
    __dst[23] = 21;
    qmemcpy(__dst, "mps.space_to_depth_2d", 21);
    v19 = &__dst[21];
    goto LABEL_13;
  }
...
LABEL_20:
  ...
  uint64_t v28 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.space_to_depth_2d", (const unsigned __int8 *)0x15, Context);
  if (!v29)
  {
    __int16 v46 = 1283;
    v44.__r_.__value_.__r.__words[2] = (std::string::size_type)"mps.space_to_depth_2d";
    uint64_t v45 = 21;
  ...
  mlir::mps::SpaceToDepth2DOp::build((mlir::Builder *)a3, (uint64_t)v48, *v26, v26[1], v26[2], v26[3], self->_blockSize, self->_pixelShuffleOrder);
  ...
  uint64_t v31 = llvm::DefaultDoCastIfPossible<mlir::mps::SpaceToDepth2DOp,mlir::Operation *,llvm::CastInfo<mlir::mps::SpaceToDepth2DOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v30);
  if (!v31)
  {
