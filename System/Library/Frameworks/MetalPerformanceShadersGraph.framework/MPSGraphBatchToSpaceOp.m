...
- (MPSGraphBatchToSpaceOp)initWithGraph:(id)a3 inputTensors:(id)a4 controlDependencies:(id)a5 usePixelShuffleOrder:(BOOL)a6 name:(id)a7;
...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v14 = mlir::FileLineColLoc::get(StringAttr, 0x45Cu, 0);
  if (!v14) {
  ...
  {
    __dst[23] = 18;
    strcpy(__dst, "mps.batch_to_space");
    goto LABEL_13;
  }
...
LABEL_20:
  ...
  uint64_t v27 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.batch_to_space", (const unsigned __int8 *)0x12, Context);
  if (!v28)
  {
    __int16 v45 = 1283;
    v43.__r_.__value_.__r.__words[2] = (std::string::size_type)"mps.batch_to_space";
    uint64_t v44 = 18;
  ...
  mlir::mps::BatchToSpaceOp::build((mlir::UnitAttr **)a3, (uint64_t)v47, *v25, v25[1], v25[2], v25[3], self->_pixelShuffleOrder);
  ...
  uint64_t v30 = llvm::DefaultDoCastIfPossible<mlir::mps::BatchToSpaceOp,mlir::Operation *,llvm::CastInfo<mlir::mps::BatchToSpaceOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v29);
  if (!v30)
  {
