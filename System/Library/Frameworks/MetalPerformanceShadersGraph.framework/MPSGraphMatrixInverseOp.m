...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  {
    __dst[23] = 18;
    strcpy(__dst, "mps.matrix_inverse");
    goto LABEL_13;
  }
...
LABEL_20:
  ...
  uint64_t v26 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.matrix_inverse", (const unsigned __int8 *)0x12, Context);
  if (!v27)
  {
    __int16 v48 = 1283;
    v46.__r_.__value_.__r.__words[2] = (std::string::size_type)"mps.matrix_inverse";
    uint64_t v47 = 18;
  ...
  mlir::mps::MatrixInverseOp::build((uint64_t)a3, (uint64_t)v50, *v24);
  ...
  if (v31 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    *(void *)__dst = *(void *)(v30 + 8);
    ...
    if (v38 == 18
      && *(void *)AttrData == 0x7274616D2E73706DLL
      && *(void *)(AttrData + 8) == 0x7265766E695F7869
      && *(_WORD *)(AttrData + 16) == 25971)
    {
      __int16 v48 = 1283;
  ...
  if (v31 != &mlir::detail::TypeIDResolver<mlir::mps::MatrixInverseOp,void>::id)
  {
LABEL_45:
