...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v14 = mlir::FileLineColLoc::get(StringAttr, 0x4Du, 0);
  if (!v14) {
...
LABEL_20:
  ...
  uint64_t v29 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.cumulative_product", (const unsigned __int8 *)0x16, Context);
  if (!v30)
  {
    __int16 v53 = 1283;
  ...
  if (v34 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    *(void *)__dst = *(void *)(v33 + 8);
    ...
    if (v42 == 22)
    {
      BOOL v43 = *AttrData == 0x756D75632E73706DLL && AttrData[1] == 0x705F65766974616CLL;
      if (v43 && *(void *)((char *)AttrData + 14) == 0x746375646F72705FLL)
      {
        __int16 v53 = 1283;
