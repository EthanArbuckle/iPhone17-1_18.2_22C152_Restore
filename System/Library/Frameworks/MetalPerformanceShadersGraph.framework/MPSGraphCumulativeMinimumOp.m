@interface MPSGraphCumulativeMinimumOp
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7;
@end

@implementation MPSGraphCumulativeMinimumOp

- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  uint64_t v57 = *MEMORY[0x1E4F143B8];
  id v11 = a7;
  mpsFileLoc("-[MPSGraphCumulativeMinimumOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphCumulativeOps.mm", __p);
  id v12 = v11;
  __int16 v56 = 260;
  v55[0] = __p;
  uint64_t StringAttr = mlir::Builder::getStringAttr((mlir::StringAttr **)a3, (mlir::MLIRContext *)v55);
  uint64_t v14 = mlir::FileLineColLoc::get(StringAttr, 0x4Fu, 0);
  if (!v14) {
    __assert_rtn("Location", "Location.h", 66, "loc && \"location should never be null.\"");
  }
  if (!v12)
  {
    strcpy(__dst, "mps.cumulative_minimum");
    __dst[23] = 22;
    goto LABEL_13;
  }
...
LABEL_20:
  ...
  uint64_t v29 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.cumulative_minimum", (const unsigned __int8 *)0x16, Context);
  if (!v30)
  {
    __int16 v53 = 1283;
    v51.__r_.__value_.__r.__words[2] = (std::string::size_type)"mps.cumulative_minimum";
    uint64_t v52 = 22;
  ...
  mlir::mps::CumulativeMinimumOp::build((mlir::UnitAttr **)a3, (uint64_t)v55, *v25, v25[1], exclusive, reverse);
  ...
  if (v34 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    *(void *)__dst = *(void *)(v33 + 8);
    ...
    if (v42 == 22)
    {
      ...
      if (v43 && *(void *)((char *)AttrData + 14) == 0x6D756D696E696D5FLL)
      {
        __int16 v53 = 1283;
  ...
  if (v34 != &mlir::detail::TypeIDResolver<mlir::mps::CumulativeMinimumOp,void>::id)
  {
LABEL_50:
