...
LABEL_20:
  ...
  uint64_t v27 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.elu", (const unsigned __int8 *)7, Context);
  if (!v28)
  {
    __int16 v45 = 1283;
  ...
  uint64_t v30 = llvm::DefaultDoCastIfPossible<mlir::mps::EluOp,mlir::Operation *,llvm::CastInfo<mlir::mps::EluOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v29);
  if (!v30)
  {
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  uint64_t v16 = objc_msgSend(WeakRetained, "constantWithScalar:shape:dataType:", &unk_1EC9F1B38, objc_msgSend(v9, "dataType"), 0.0);

  id v17 = objc_loadWeakRetained((id *)&self->super._graph);
  uint64_t v37 = (void *)v16;
  uint64_t v18 = objc_msgSend(v17, "constantWithScalar:shape:dataType:", &unk_1EC9F1B50, objc_msgSend(v9, "dataType"), 1.0);

  id v19 = objc_loadWeakRetained((id *)&self->super._graph);
  v38 = (void *)v18;
  if (v10)
  {
    uint64_t v20 = [v10 stringByAppendingString:@"/lessThanOrEqualTo"];
  }
  else
  {
    uint64_t v20 = @"eluGrad/lessThanOrEqualTo";
  }
  uint64_t v40 = [v19 greaterThanWithPrimaryTensor:v9 secondaryTensor:v16 name:v20];
  if (v10) {

  }
  id v21 = objc_loadWeakRetained((id *)&self->super._graph);
  char v22 = [(MPSGraphOperation *)self outputTensors];
  uint64_t v23 = [v22 objectAtIndexedSubscript:0];
  uint64_t v24 = [(MPSGraphOperation *)self inputTensors];
  v25 = [v24 objectAtIndexedSubscript:1];
  if (v10)
  {
    v26 = [v10 stringByAppendingString:@"/negativeRegionGradient"];
  }
  else
  {
    v26 = @"eluGrad/negativeRegionGradient";
  }
  uint64_t v27 = [v21 additionWithPrimaryTensor:v23 secondaryTensor:v25 name:v26];
  if (v10) {

  }
  id v28 = objc_loadWeakRetained((id *)p_graph);
  if (v10)
  {
    uint64_t v30 = v38;
    v29 = v39;
    v31 = [v10 stringByAppendingString:@"/localGradient"];
  }
  else
  {
  ...
  v32 = [v28 selectWithPredicateTensor:v40 truePredicateTensor:v30 falsePredicateTensor:v27 name:v31];
  if (v10)
  {

    id v33 = objc_loadWeakRetained((id *)p_graph);
    int v34 = [v10 stringByAppendingString:@"/select"];
  }
  else
  {

    id v33 = objc_loadWeakRetained((id *)p_graph);
    int v34 = @"eluGrad/multiplication";
  }
  v35 = [v33 multiplicationWithPrimaryTensor:v29 secondaryTensor:v32 name:v34];
  if (v10) {
