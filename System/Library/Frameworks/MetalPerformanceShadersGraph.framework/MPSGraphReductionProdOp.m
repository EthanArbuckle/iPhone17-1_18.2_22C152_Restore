...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v11 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::ReductionProdOp>((uint64_t)a4, (mlir::StringAttr **)a3, (uint64_t)__p, 0xCBu, v10);
  if (v22 < 0)
  {
...
LABEL_6:
  ...
  v15 = mlir::OpBuilder::create<mlir::mps::ReductionProdOp,mlir::Value &,mlir::Value &,BOOL>((mlir::UnitAttr **)a3, v11, v12, &v20, &v18);
  if (!*((_DWORD *)v15 + 9)) {
