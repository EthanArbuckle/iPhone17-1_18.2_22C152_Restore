...
{
  id v10 = a7;
  mpsFileLoc("-[MPSGraphFlatten2DOp makeMLIROpWithBuilder:symbolTable:inputValues:opInitialization:name:]", "/Library/Caches/com.apple.xbs/Sources/MetalPerformanceShadersGraph/mpsgraph/MetalPerformanceShadersGraph/Core/Files/Operations/MPSGraphTensorShapeOps.mm", v29);
  id v11 = v10;
  __int16 v35 = 260;
  v34[0] = v29;
  uint64_t StringAttr = mlir::Builder::getStringAttr((mlir::StringAttr **)a3, (mlir::MLIRContext *)v34);
  uint64_t v13 = mlir::FileLineColLoc::get(StringAttr, 0xC3Fu, 0);
  if (!v13) {
  ...
  {
    HIBYTE(v33) = 14;
    strcpy(__dst.i8, "mps.flatten_2d");
    goto LABEL_13;
  }
...
LABEL_26:
  ...
  v26 = mlir::OpBuilder::create<mlir::mps::Flatten2DOp,mlir::Value &,mlir::Value &>((mlir::OpBuilder *)a3, v23, v24, v24 + 1);
  if (!*((_DWORD *)v26 + 9)) {
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  size_t v15 = [v13 stringWithFormat:@"%@/%@/flatten2d/shapeOp", v11, v14];
  ...
  char v21 = [v17 reshapeTensor:v10 withShapeTensor:v16 name:v20];
