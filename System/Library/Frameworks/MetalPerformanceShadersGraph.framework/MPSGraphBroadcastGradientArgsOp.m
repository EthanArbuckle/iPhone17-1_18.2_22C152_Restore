...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v13 = mlir::FileLineColLoc::get(StringAttr, 0x5ABu, 0);
  if (!v13) {
  ...
  if (!v11)
  {
    ...
    __dst = (void **)v18;
    long long v55 = xmmword_181129D60;
  ...
  if (v15 >= 0x17)
  {
    ...
    *((void *)&v55 + 1) = v21 | 0x8000000000000000;
    __dst = p_dst;
  }
  else
  {
...
LABEL_13:
  ...
  LOBYTE(v57) = v23;
  uint64_t v24 = mlir::Builder::getStringAttr((mlir::StringAttr **)a3, (mlir::MLIRContext *)v56);
...
LABEL_20:
  ...
  uint64_t v28 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.broadcast_gradient_args", (const unsigned __int8 *)0x1B, Context);
  if (!v29)
  {
    __int16 v53 = 1283;
  ...
  if (v33 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v41 == 27)
    {
      BOOL v42 = *AttrData == 0x616F72622E73706DLL && AttrData[1] == 0x72675F7473616364;
      BOOL v43 = v42 && AttrData[2] == 0x615F746E65696461;
      if (v43 && *(void *)((char *)AttrData + 19) == 0x736772615F746E65)
      {
        __int16 v53 = 1283;
