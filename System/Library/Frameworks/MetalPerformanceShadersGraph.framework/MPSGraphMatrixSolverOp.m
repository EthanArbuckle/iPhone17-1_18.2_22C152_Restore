...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  {
    __dst[23] = 20;
    strcpy(__dst, "mps.matrix_solver_lu");
    goto LABEL_13;
  }
...
LABEL_20:
  ...
  uint64_t v26 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.matrix_solver_lu", (const unsigned __int8 *)0x14, Context);
  if (!v27)
  {
    __int16 v48 = 1283;
    v46.__r_.__value_.__r.__words[2] = (std::string::size_type)"mps.matrix_solver_lu";
    uint64_t v47 = 20;
  ...
  mlir::mps::MatrixSolverLUOp::build((uint64_t)a3, (uint64_t)v50, *v24, v24[1], v24[2]);
  ...
  if (v31 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    *(void *)__dst = *(void *)(v30 + 8);
    ...
    if (v38 == 20
      ...
      && *(void *)(AttrData + 8) == 0x65766C6F735F7869
      && *(_DWORD *)(AttrData + 16) == 1970036594)
    {
      __int16 v48 = 1283;
