...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v12 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::LocalConvolutionOp>((uint64_t)a4, (mlir::StringAttr **)a3, (uint64_t)__p, 0xBFu, v11);
  if (v39 < 0) {
  ...
  uint64_t v19 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.local_convolution_data_gradient", (const unsigned __int8 *)0x23, Context);
  if (!v20)
  {
    __int16 v46 = 1283;
  ...
  if (v24 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v32 == 35)
    {
      ...
      BOOL v34 = v33 && AttrData[2] == 0x61645F6E6F697475;
      BOOL v35 = v34 && AttrData[3] == 0x69646172675F6174;
      if (v35 && *(void *)((char *)AttrData + 27) == 0x746E656964617267)
      {
        __int16 v46 = 1283;
