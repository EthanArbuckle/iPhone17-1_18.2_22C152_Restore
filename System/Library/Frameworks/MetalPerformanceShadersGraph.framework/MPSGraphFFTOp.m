...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  if (!v12)
  {
    ...
    __dst = (void **)v19;
    long long v57 = xmmword_181130460;
...
LABEL_20:
  ...
  uint64_t v32 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.fast_fourier_transform", (const unsigned __int8 *)0x1A, Context);
  if (!v33)
  {
    __int16 v55 = 1283;
  ...
  if (v37 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v44 == 26
      && *(void *)AttrData == 0x747361662E73706DLL
      && *(void *)(AttrData + 8) == 0x72656972756F665FLL
      && *(void *)(AttrData + 16) == 0x6F66736E6172745FLL
