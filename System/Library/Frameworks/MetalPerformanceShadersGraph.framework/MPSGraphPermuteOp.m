...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v13 = mlir::FileLineColLoc::get(StringAttr, 0x103u, 0);
  if (!v13) {
...
LABEL_26:
  ...
  uint64_t v27 = mlir::OpBuilder::create<mlir::mps::PermuteOp,mlir::Value &,mlir::Value &>((mlir::OpBuilder *)a3, v24, v25, v25 + 1);
  if (!*(_DWORD *)(v27 + 36)) {
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  {
    size_t v12 = [(NSArray *)self->_permute count];
    uint64_t v13 = (uint64_t *)malloc_type_calloc(v12, 8uLL, 0x100004000313F17uLL);
    if (v12)
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        size_t v15 = [(NSArray *)self->_permute objectAtIndexedSubscript:i];
        uint64_t v16 = [v15 integerValue];

        v13[(v12 & (v16 >> 63)) + v16] = i;
      }
    }
    v17 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:v12];
    if (v12)
    {
      v18 = v13;
      do
    ...
    char v22 = NSString;
    uint64_t v23 = [(MPSGraphOperation *)self name];
    uint64_t v24 = [v22 stringWithFormat:@"%@/%@/transposePermute", v10, v23];
    id v11 = [WeakRetained transposeTensor:v9 permute:v17 name:v24];
  }
