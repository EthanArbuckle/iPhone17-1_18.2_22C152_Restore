...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v13 = mlir::FileLineColLoc::get(StringAttr, 0xEBu, 0);
  if (!v13) {
  ...
  if (!v11)
  {
    ...
    __dst = (void **)v19;
    long long v77 = xmmword_181129DE0;
...
LABEL_20:
  ...
  uint64_t v41 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.depthwise_conv_2d_data_gradient", (const unsigned __int8 *)0x23, Context);
  if (!v42)
  {
    __int16 v75 = 1283;
  ...
  if (v46 == &mlir::detail::TypeIDResolver<void,void>::id)
  {
    ...
    if (v55 == 35)
    {
      ...
      BOOL v57 = v56 && AttrData[2] == 0x61645F64325F766ELL;
      BOOL v58 = v57 && AttrData[3] == 0x69646172675F6174;
      if (v58 && *(void *)((char *)AttrData + 27) == 0x746E656964617267)
      {
        __int16 v75 = 1283;
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  if (v13 == v9) {
    ...
    char v24 = [v28 stringWithFormat:@"%@/%@/depthwiseConvolution2DDataGradient", v11, v21];
    uint64_t v26 = [WeakRetained depthwiseConvolution2DWithSourceTensor:v10 weightsTensor:v20 descriptor:desc name:v24];
  }
  else {
    v15 = {;
  }
    ...
    uint64_t v25 = [v23 stringWithFormat:@"%@/%@/depthwiseConvolution2DWeightsGradient", v11, v24];
    uint64_t v26 = [v20 depthwiseConvolution2DWeightsGradientWithIncomingGradientTensor:v21 sourceTensor:v10 outputShapeTensor:v19 descriptor:v22 name:v25];
