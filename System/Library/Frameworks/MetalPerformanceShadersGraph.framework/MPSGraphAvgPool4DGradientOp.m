...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v35 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::PoolAvgGradientOp>((uint64_t)a4, (mlir::StringAttr **)a3, (uint64_t)__p, 0x2B8u, v30);
  if (v38 < 0) {
  ...
  uint64_t v20 = mlir::RegisteredOperationName::lookup((int8x16_t *)"mps.pooling_average_gradient", (const unsigned __int8 *)0x1C, Context);
  if (!v21)
  {
    __int16 v43 = 1283;
  ...
  uint64_t v23 = llvm::DefaultDoCastIfPossible<mlir::mps::PoolAvgGradientOp,mlir::Operation *,llvm::CastInfo<mlir::mps::PoolAvgGradientOp,mlir::Operation *,void>>::doCastIfPossible((uint64_t)v22);
  if (!v23)
  {
