...
- (MPSGraphArgSortOp)initWithGraph:(id)a3 inputTensors:(id)a4 controlDependencies:(id)a5 descending:(BOOL)a6 name:(id)a7;
...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  uint64_t v12 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::SortOp>((uint64_t)a4, (mlir::StringAttr **)a3, (uint64_t)__p, 0x58u, v11);
  if (v18 < 0) {
