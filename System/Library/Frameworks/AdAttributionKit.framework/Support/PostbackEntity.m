...
- (_TtC20AttributionKitDaemon14PostbackEntity)initWithPropertyValues:(id)a3 onConnection:(id)a4
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)type metadata accessor for PostbackEntity();
...
{
  v7.receiver = self;
  v7.super_class = (Class)type metadata accessor for PostbackEntity();
...
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for PostbackEntity();
