...
- (SQLiteEntity)initWithPropertyValues:(id)a3 onConnection:(id)a4
{
  ...
  v18 = sub_100003D0C;
  v19 = &unk_1001BEF78;
  id v12 = sub_100003C10(self, v6);
  id v20 = v12;
  id v23 = v10;
  id v13 = v7;
  id v21 = v13;
  v22 = &v24;
  sub_1000099D0((uint64_t)v13, &v16);
...
- (BOOL)deleteFromDatabase
{
  ...
  v9[4] = self;
  v9[5] = &v10;
  sub_1000099D0((uint64_t)connection, v9);
  if (*((unsigned char *)v11 + 24))
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_100004680;
    block[3] = &unk_1001BEFC0;
    block[4] = v4;
...
- (BOOL)existsInDatabase
{
  ...
  v8[4] = self;
  v8[5] = &v9;
  sub_1000091D4((uint64_t)connection, v5, v8);
...
- (id)getValuesForProperties:(id)a3
{
  ...
  else
  {
    ...
    id v22 = v20;
    id v27 = v22;
    sub_1000091D4((uint64_t)connection, v12, v25);
    id v23 = v27;
    id v8 = v22;
  }
...
- (BOOL)setValuesWithDictionary:(id)a3
{
  ...
  id v13 = v9;
  id v14 = &v16;
  sub_1000099D0((uint64_t)connection, v11);
