...
{
  v21.receiver = self;
  v21.super_class = (Class)_CLRangingPeerDistanceInternal;
  ...
  if (v14)
  {
    ...
    if (peer != a3)
    {
      ...
      v15->_peer = (_CLRangingPeer *)[a3 copy];
    }
    date = v15->_date;
    if (date != a4)
    {

      v15->_date = (NSDate *)[a4 copy];
    }
    distanceMeters = v15->_distanceMeters;
    if (distanceMeters != a5)
    {

      v15->_distanceMeters = (NSNumber *)[a5 copy];
    }
    accuracyMeters = v15->_accuracyMeters;
    if (accuracyMeters != a6)
    {

      v15->_accuracyMeters = (NSNumber *)[a6 copy];
    }
    v15->_initiator = a7;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)[v4 initWithPeer:peer date:date distanceMeters:distanceMeters accuracyMeters:accuracyMeters initiator:initiator shouldUnlock:shouldUnlock];
}
