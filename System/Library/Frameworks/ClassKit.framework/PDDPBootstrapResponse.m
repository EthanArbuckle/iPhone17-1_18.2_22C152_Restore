...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPBootstrapResponse;
  v3 = [(PDDPBootstrapResponse *)&v7 description];
  id v4 = [(PDDPBootstrapResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (userInfo)
  {
    objc_super v7 = [(PDDPUserInfo *)userInfo dictionaryRepresentation];
...
LABEL_13:
    ...
    switch((v7 >> 3))
    {
      case 1u:
        ...
        goto LABEL_34;
      case 2u:
        id v13 = objc_alloc_init(PDDPUserInfo);
        objc_storeStrong((id *)&self->_userInfo, v13);
        if (!PBReaderPlaceMark() || !sub_10009A660((id *)v13, (uint64_t)a3)) {
          goto LABEL_34;
        }
        goto LABEL_31;
      case 3u:
        id v13 = objc_alloc_init(PDDPClientConfig);
        objc_storeStrong((id *)&self->_clientConfig, v13);
        if (!PBReaderPlaceMark() || (sub_100028470((uint64_t)v13, (uint64_t)a3) & 1) == 0) {
          goto LABEL_34;
        }
        goto LABEL_31;
      case 4u:
        id v13 = objc_alloc_init(PDDPEndpointConfig);
        [(PDDPBootstrapResponse *)self addEndpoints:v13];
...
- (void)copyTo:(id)a3
{
  ...
  if (self->_clientConfig) {
    objc_msgSend(v8, "setClientConfig:");
  }
  if ([(PDDPBootstrapResponse *)self endpointsCount])
  {
    [v8 clearEndpoints];
    unint64_t v4 = [(PDDPBootstrapResponse *)self endpointsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPBootstrapResponse *)self endpointsAtIndex:i];
        [v8 addEndpoints:v7];
      }
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v8 = [(PDDPUserInfo *)self->_userInfo copyWithZone:a3];
  char v9 = (void *)v5[4];
  v5[4] = v8;

  id v10 = [(PDDPClientConfig *)self->_clientConfig copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    ...
    && ((userInfo = self->_userInfo, !((unint64_t)userInfo | v4[4]))
     || -[PDDPUserInfo isEqual:](userInfo, "isEqual:"))
    && ((clientConfig = self->_clientConfig, !((unint64_t)clientConfig | v4[1]))
     || -[PDDPClientConfig isEqual:](clientConfig, "isEqual:")))
  {
    endpoints = self->_endpoints;
    if ((unint64_t)endpoints | v4[2]) {
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(PDDPUserInfo *)self->_userInfo hash] ^ v3;
  unint64_t v5 = [(PDDPClientConfig *)self->_clientConfig hash];
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[PDDPBootstrapResponse setStatus:](self, "setStatus:");
  }
  userInfo = self->_userInfo;
  ...
  {
    -[PDDPBootstrapResponse setUserInfo:](self, "setUserInfo:");
  }
  clientConfig = self->_clientConfig;
  ...
  {
    if (v10) {
      -[PDDPClientConfig mergeFrom:](clientConfig, "mergeFrom:");
    }
  }
  else if (v10)
  {
    -[PDDPBootstrapResponse setClientConfig:](self, "setClientConfig:");
  }
  long long v18 = 0u;
  long long v19 = 0u;
  long long v16 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; uint64_t i = (char *)i + 1)
      {
        ...
        -[PDDPBootstrapResponse addEndpoints:](self, "addEndpoints:", *(void *)(*((void *)&v16 + 1) + 8 * i), (void)v16);
      }
