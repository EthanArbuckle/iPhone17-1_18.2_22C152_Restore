...
+ (id)entityName
{
  return @"CLSArchivedQuestionStep";
}

- (id)initWithDatabaseRow:(id)a3
{
  v4 = (uint64_t *)a3;
  id v5 = [(CLSArchivedQuestionStep *)self _init];
  v6 = v5;
  if (v5)
  {
...
{
  v12.receiver = self;
  v12.super_class = (Class)CLSArchivedQuestionStep;
  id v4 = a3;
...
+ (BOOL)migrateFromVersion:(unint64_t)a3 finalVersion:(unint64_t *)a4 inDatabase:(id)a5
{
  ...
  if (sub_100007540(v7, @"create table CLSArchivedQuestionStep(   objectID          text not null,\n    parentObjectID    text not null,\n    dateCreated       real not null,\n    dateLastModified  real not null,\n    questionText      text,\n    version           integer,\n    displayOrder      integer,\n    type              integer,\n    questionType      integer,\n    foreign key (parentObjectID) references CLSArchivedSurvey(objectID) on delete cascade on update cascade\n)", 0, 0, 0))
  {
    LOBYTE(a3) = 0;
    if (sub_100007540(v8, @"create unique index CLSArchivedQuestionStep_objectID on CLSArchivedQuestionStep (objectID)", 0, 0, 0))
    {
      LOBYTE(a3) = 0;
      if (sub_100007540(v8, @"create index CLSArchivedQuestionStep_parentObjectID on CLSArchivedQuestionStep (parentObjectID)", 0, 0, 0))
      {
        a3 = 1;
LABEL_2:
        *a4 = a3;
...
{
  id v4 = a3;
  id v5 = [(CLSArchivedQuestionStep *)self objectID];
  id v7 = v5;
