@interface PDDPUploadEventsRequest
+ (Class)eventsType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation PDDPUploadEventsRequest
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPUploadEventsRequest;
  v3 = [(PDDPUploadEventsRequest *)&v7 description];
  id v4 = [(PDDPUploadEventsRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_events, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      long long v13 = objc_alloc_init(PDDPEvent);
      [(PDDPUploadEventsRequest *)self addEvents:v13];
      if (!PBReaderPlaceMark() || (sub_100148A80((uint64_t)v13, (uint64_t)a3) & 1) == 0)
      {
...
{
  id v8 = a3;
  if ([(PDDPUploadEventsRequest *)self eventsCount])
  {
    [v8 clearEvents];
    unint64_t v4 = [(PDDPUploadEventsRequest *)self eventsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPUploadEventsRequest *)self eventsAtIndex:i];
        [v8 addEvents:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)events | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](events, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_events hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPUploadEventsRequest addEvents:](self, "addEvents:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
