...
- (unint64_t)zonesCount
{
  return (unint64_t)[(NSMutableArray *)self->_zones count];
}

- (id)zonesAtIndex:(unint64_t)a3
{
  return [(NSMutableArray *)self->_zones objectAtIndex:a3];
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPGetChangesRequest;
  v3 = [(PDDPGetChangesRequest *)&v7 description];
  id v4 = [(PDDPGetChangesRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_zones, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      long long v13 = objc_alloc_init(PDDPClassZone);
      [(PDDPGetChangesRequest *)self addZones:v13];
      if (!PBReaderPlaceMark() || (sub_10010CA84((uint64_t)v13, (uint64_t)a3) & 1) == 0)
      {
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearZones];
    unint64_t v4 = [(PDDPGetChangesRequest *)self zonesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPGetChangesRequest *)self zonesAtIndex:i];
        [v8 addZones:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    zones = self->_zones;
    if ((unint64_t)zones | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](zones, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_zones hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPGetChangesRequest addZones:](self, "addZones:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
