...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPStateChangesIOS134MACOS10154HandoutDomainState;
  id v3 = [(PDDPStateChangesIOS134MACOS10154HandoutDomainState *)&v7 description];
  int v4 = [(PDDPStateChangesIOS134MACOS10154HandoutDomainState *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000854C4((uint64_t)self, (uint64_t)a3);
}
