...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPStateChangesIOS134MACOS10154PersonalDomainState;
  id v3 = [(PDDPStateChangesIOS134MACOS10154PersonalDomainState *)&v7 description];
  int v4 = [(PDDPStateChangesIOS134MACOS10154PersonalDomainState *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100168520((uint64_t)self, (uint64_t)a3);
}
