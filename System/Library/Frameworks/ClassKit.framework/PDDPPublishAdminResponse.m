@interface PDDPPublishAdminResponse
+ (Class)payloadType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation PDDPPublishAdminResponse
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPPublishAdminResponse;
  v3 = [(PDDPPublishAdminResponse *)&v7 description];
  id v4 = [(PDDPPublishAdminResponse *)self dictionaryRepresentation];
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      long long v13 = objc_alloc_init(PDDPEEPayload);
      [(PDDPPublishAdminResponse *)self addPayload:v13];
      if (!PBReaderPlaceMark() || (sub_10015BA14((uint64_t)v13, (uint64_t)a3) & 1) == 0)
      {
...
{
  id v8 = a3;
  if ([(PDDPPublishAdminResponse *)self payloadsCount])
  {
    [v8 clearPayloads];
    unint64_t v4 = [(PDDPPublishAdminResponse *)self payloadsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPPublishAdminResponse *)self payloadAtIndex:i];
        [v8 addPayload:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPPublishAdminResponse addPayload:](self, "addPayload:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
