@interface PDDPPublishCollectionResponse
+ (Class)payloadType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation PDDPPublishCollectionResponse
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPPublishCollectionResponse;
  v3 = [(PDDPPublishCollectionResponse *)&v7 description];
  id v4 = [(PDDPPublishCollectionResponse *)self dictionaryRepresentation];
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      ...
      [(PDDPPublishCollectionResponse *)self addPayload:v13];
...
{
  id v8 = a3;
  if ([(PDDPPublishCollectionResponse *)self payloadsCount])
  {
    [v8 clearPayloads];
    unint64_t v4 = [(PDDPPublishCollectionResponse *)self payloadsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPPublishCollectionResponse *)self payloadAtIndex:i];
        [v8 addPayload:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPPublishCollectionResponse addPayload:](self, "addPayload:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
