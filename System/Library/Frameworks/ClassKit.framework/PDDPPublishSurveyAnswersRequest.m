@interface PDDPPublishSurveyAnswersRequest
+ (Class)payloadType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (Class)responseClass;
...
@implementation PDDPPublishSurveyAnswersRequest
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPPublishSurveyAnswersRequest;
  v3 = [(PDDPPublishSurveyAnswersRequest *)&v7 description];
  id v4 = [(PDDPPublishSurveyAnswersRequest *)self dictionaryRepresentation];
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      ...
      [(PDDPPublishSurveyAnswersRequest *)self addPayload:v13];
...
{
  id v8 = a3;
  if ([(PDDPPublishSurveyAnswersRequest *)self payloadsCount])
  {
    [v8 clearPayloads];
    unint64_t v4 = [(PDDPPublishSurveyAnswersRequest *)self payloadsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPPublishSurveyAnswersRequest *)self payloadAtIndex:i];
        [v8 addPayload:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPPublishSurveyAnswersRequest addPayload:](self, "addPayload:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
