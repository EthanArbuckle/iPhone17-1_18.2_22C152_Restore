...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPSearchQuery;
  id v3 = [(PDDPSearchQuery *)&v7 description];
  id v4 = [(PDDPSearchQuery *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10010441C((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearContents];
    unint64_t v5 = [(PDDPSearchQuery *)self contentsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(PDDPSearchQuery *)self contentsAtIndex:i];
        [v9 addContents:v8];
      }
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v13 = [(PDDPSearchCriteria *)self->_criteria copyWithZone:a3];
  v14 = (void *)v6[2];
  v6[2] = v13;
...
LABEL_11:
  ...
  if ((unint64_t)criteria | *((void *)v4 + 2)) {
    unsigned __int8 v7 = -[PDDPSearchCriteria isEqual:](criteria, "isEqual:");
  }
  else {
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; uint64_t i = (char *)i + 1)
      {
        ...
        -[PDDPSearchQuery addContents:](self, "addContents:", *(void *)(*((void *)&v13 + 1) + 8 * i), (void)v13);
      }
  ...
  {
    if (v12) {
      -[PDDPSearchCriteria mergeFrom:](criteria, "mergeFrom:");
    }
  }
  else if (v12)
  {
    -[PDDPSearchQuery setCriteria:](self, "setCriteria:");
  }
}
