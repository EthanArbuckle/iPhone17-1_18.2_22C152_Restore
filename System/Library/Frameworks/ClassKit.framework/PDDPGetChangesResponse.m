@interface PDDPGetChangesResponse
+ (Class)payloadType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation PDDPGetChangesResponse
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPGetChangesResponse;
  v3 = [(PDDPGetChangesResponse *)&v7 description];
  id v4 = [(PDDPGetChangesResponse *)self dictionaryRepresentation];
...
LABEL_13:
    ...
    if ((v7 >> 3) == 2)
    {
      ...
      [(PDDPGetChangesResponse *)self addPayload:v13];
...
{
  id v8 = a3;
  if ([(PDDPGetChangesResponse *)self payloadsCount])
  {
    [v8 clearPayloads];
    unint64_t v4 = [(PDDPGetChangesResponse *)self payloadsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPGetChangesResponse *)self payloadAtIndex:i];
        [v8 addPayload:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPGetChangesResponse addPayload:](self, "addPayload:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
