...
@implementation PDDPIngestRequest
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPIngestRequest;
  v3 = [(PDDPIngestRequest *)&v7 description];
  id v4 = [(PDDPIngestRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_items, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      long long v13 = objc_alloc_init(PDDPIngestItem);
      [(PDDPIngestRequest *)self addItems:v13];
      if (!PBReaderPlaceMark() || (sub_10006F714((uint64_t)v13, (uint64_t)a3) & 1) == 0)
      {
...
{
  id v8 = a3;
  if ([(PDDPIngestRequest *)self itemsCount])
  {
    [v8 clearItems];
    unint64_t v4 = [(PDDPIngestRequest *)self itemsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPIngestRequest *)self itemsAtIndex:i];
        [v8 addItems:v7];
      }
    }
  }
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_items hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPIngestRequest addItems:](self, "addItems:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
