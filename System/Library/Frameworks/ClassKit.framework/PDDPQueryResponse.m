...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSMutableArray)queryPayloads;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (id)dictionaryRepresentation;
- (id)queryPayloadAtIndex:(unint64_t)a3;
- (unint64_t)hash;
- (unint64_t)queryPayloadsCount;
- (void)addQueryPayload:(id)a3;
- (void)clearQueryPayloads;
- (void)copyTo:(id)a3;
- (void)mergeFrom:(id)a3;
- (void)setQueryPayloads:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (unint64_t)queryPayloadsCount
{
  return (unint64_t)[(NSMutableArray *)self->_queryPayloads count];
}

- (id)queryPayloadAtIndex:(unint64_t)a3
{
  return [(NSMutableArray *)self->_queryPayloads objectAtIndex:a3];
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)PDDPQueryResponse;
  v3 = [(PDDPQueryResponse *)&v7 description];
  id v4 = [(PDDPQueryResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_queryPayloads count])
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_queryPayloads, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    v5 = self->_queryPayloads;
    ...
    [v3 setObject:v4 forKey:@"query_payload"];
  }
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      ...
      [(PDDPQueryResponse *)self addQueryPayload:v13];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(PDDPQueryResponse *)self queryPayloadsCount])
  {
    ...
    unint64_t v4 = [(PDDPQueryResponse *)self queryPayloadsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PDDPQueryResponse *)self queryPayloadAtIndex:i];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  unsigned int v6 = self->_queryPayloads;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    queryPayloads = self->_queryPayloads;
    if ((unint64_t)queryPayloads | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](queryPayloads, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_queryPayloads hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PDDPQueryResponse addQueryPayload:](self, "addQueryPayload:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
