...
- (void)viewDidLoad
{
  ...
  [v6 startAnimating];
  v8 = +[QLDetailItemViewControllerState detailItemViewControllerStateWithActionButtonTitle:&stru_100024EC8 actionButtonView:v6 informationVisible:1];
  unzippingState = self->_unzippingState;
  self->_unzippingState = v8;

  v10 = +[QLDetailItemViewControllerState detailItemViewControllerStateWithActionButtonTitle:&stru_100024EC8 actionButtonView:0 informationVisible:1];
  ...
  [(QLZipItemViewController *)self _updateZipInformationWithZipSize:&off_100025B00];
}
...
- (void)_showInvalidPasswordAlert
{
  ...
  [v4 setText:&stru_100024EC8];

  id v5 = QLLocalizedStringFromTable();
  id v6 = +[UIAlertController alertControllerWithTitle:v5 message:&stru_100024EC8 preferredStyle:1];
