...
- (void)_startObservingCurrentPDFPageIndex
{
  ...
  else
  {
    ...
    [v8 addObserver:v2 forKeyPath:@"currentPDFPageIndex" options:1 context:&off_1000246B8];
  }
  objc_sync_exit(v2);
}
...
- (void)_stopObservingCurrentPDFPageIndex
{
  ...
  if (obj->_isObservingCurrentPDFPageIndex)
  {
    ...
    [v3 removeObserver:obj forKeyPath:@"currentPDFPageIndex" context:&off_1000246B8];
...
- (void)transitionWillFinish:(BOOL)a3 didComplete:(BOOL)a4
{
  ...
  else
  {
    ...
    id v16 = sub_1000079CC;
    id v17 = &unk_100024670;
    id v18 = self;
    objc_super v13 = &v14;
  }
