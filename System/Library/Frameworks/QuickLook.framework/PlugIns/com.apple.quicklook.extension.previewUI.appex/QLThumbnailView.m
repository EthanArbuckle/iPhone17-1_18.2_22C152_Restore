...
- (QLThumbnailView)initWithFrame:(CGRect)a3
{
  ...
  v3 = -[QLThumbnailView initWithFrame:](&v6, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
...
- (void)setFrame:(CGRect)a3
{
  ...
  -[QLThumbnailView setFrame:](&v4, "setFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
