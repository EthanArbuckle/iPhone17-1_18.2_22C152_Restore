...
+ (int)dayFromNumber:(int64_t)a3
{
  if ((unint64_t)(a3 - 1) > 6) {
    ...
    return dword_1B413AAE0[a3 - 1];
  }
}

- (id)startDateComponents:(unint64_t)a3
{
  id v4 = [(EKRecurrenceChooserController *)self date];
  if (v4)
  {
...
- (void)notifyDelegate
{
  id v3 = [(EKRecurrenceChooserController *)self delegate];
...
- (EKRecurrenceChooserControllerDelegate)delegate
{
  ...
  return (EKRecurrenceChooserControllerDelegate *)WeakRetained;
}
...
- (id)cellForRow:(int64_t)a3
{
  ...
  id v3 = [[EKUITableViewCell alloc] initWithStyle:0 reuseIdentifier:0];
