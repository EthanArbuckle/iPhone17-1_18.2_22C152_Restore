...
- (MLAddBroadcastableBrick)initWithParameters:(id)a3;
- (NSArray)inputRanks;
- (NSArray)inputShapes;
- (NSArray)outputRanks;
...
@implementation MLAddBroadcastableBrick
...
- (void)computeOnCPUWithInputTensors:(id)a3 outputTensors:(id)a4
{
  ...
  if (v27 || v30)
  {
    ...
    v34 = v38;
    v33 = v39;
    vDSP_vsadd(v31, 1, v32, v12, 1, v22);
    goto LABEL_55;
  }
  ...
  if (v26 == v41 - (unsigned char *)v40)
  {
    ...
    if (v29 == v26 && !v36)
    {
      if (!memcmp(v28, v21, v26))
      {
        v34 = v38;
        v33 = v39;
        vDSP_vadd(v8, 1, v10, 1, v12, 1, v22);
        goto LABEL_55;
      }
      goto LABEL_30;
    }
  ...
  if (v29 == v35 && !memcmp(v28, v21, v29))
  {
    ...
    vDSP_vadd((const float *)v59[0], 1, v10, 1, v12, 1, v22);
    goto LABEL_53;
  }
  if (v26 != v35) {
    goto LABEL_31;
...
LABEL_31:
    ...
    vDSP_vadd(v37, 1, __B[0], 1, v12, 1, v22);
    if (__B[0])
    {
      __B[1] = __B[0];
  ...
  vDSP_vadd(v8, 1, (const float *)v59[0], 1, v12, 1, v22);
LABEL_53:
  if (v59[0])
  {
    v59[1] = v59[0];
...
- (MLAddBroadcastableBrick)initWithParameters:(id)a3
{
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)MLAddBroadcastableBrick;
  v5 = [(MLAddBroadcastableBrick *)&v21 init];
  if (v5)
  {
