...
- (MLDivideBroadcastableBrick)initWithParameters:(id)a3;
- (NSArray)inputRanks;
- (NSArray)inputShapes;
- (NSArray)outputRanks;
...
@implementation MLDivideBroadcastableBrick
...
- (void)computeOnCPUWithInputTensors:(id)a3 outputTensors:(id)a4
{
  ...
  if (v27 || v30)
  {
    ...
    v31 = v38;
    if (v27) {
      vDSP_svdiv(v8, v10, 1, v12, 1, v22);
    }
    else {
      vDSP_vsdiv(v8, 1, v10, v12, 1, v22);
    }
    goto LABEL_51;
  }
  ...
  if (v26 == v40 - (unsigned char *)v39)
  {
    ...
    if (v29 == v26 && !v34)
    {
      if (!memcmp(v28, v21, v26))
      {
        v32 = v37;
        v31 = v38;
        vDSP_vdiv(v10, 1, v8, 1, v12, 1, v22);
        goto LABEL_51;
      }
      goto LABEL_26;
    }
  ...
  if (v29 == v33 && !memcmp(v28, v21, v29))
  {
    v32 = v37;
    v31 = v38;
    std::vector<float>::vector(v58, v22);
    v55 = 0;
    v56 = 0;
    uint64_t v57 = 0;
    ...
    BrickLayers::BroadcastTo((uint64_t *)&v55, (uint64_t)v8, (uint64_t *)&__p, (uint64_t)v58[0]);
    if (__p)
    {
      v53 = __p;
      operator delete(__p);
    ...
    vDSP_vdiv(v10, 1, (const float *)v58[0], 1, v12, 1, v22);
    goto LABEL_49;
  }
  if (v26 != v33) {
    goto LABEL_27;
...
LABEL_27:
    ...
    BrickLayers::BroadcastTo((uint64_t *)&v48, v35, (uint64_t *)&v45, (uint64_t)__B[0]);
    if (v45)
    {
      v46 = v45;
      operator delete(v45);
    ...
    vDSP_vdiv(__B[0], 1, v36, 1, v12, 1, v22);
    if (__B[0])
    {
      __B[1] = __B[0];
  ...
  BrickLayers::BroadcastTo((uint64_t *)&v55, (uint64_t)v10, (uint64_t *)&__p, (uint64_t)v58[0]);
  if (__p)
  {
    v53 = __p;
    operator delete(__p);
  ...
  vDSP_vdiv((const float *)v58[0], 1, v8, 1, v12, 1, v22);
LABEL_49:
  if (v58[0])
  {
    v58[1] = v58[0];
...
- (MLDivideBroadcastableBrick)initWithParameters:(id)a3
{
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)MLDivideBroadcastableBrick;
  v5 = [(MLDivideBroadcastableBrick *)&v21 init];
  if (v5)
  {
