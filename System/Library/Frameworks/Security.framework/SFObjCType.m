...
+ (id)typeForEncoding:(const char *)a3
{
  ...
  if (typeForEncoding__once != -1) {
    dispatch_once(&typeForEncoding__once, &__block_literal_global_3951);
  }
  int v5 = *a3;
  if (v5 > 90)
  {
    ...
    if (v5 > 57)
    {
      switch(*a3)
      {
        ...
        case '@':
          ...
          {
            v13 = objc_msgSend(v4, "substringWithRange:", 2, objc_msgSend(v4, "length") - 3);
            v14 = [v13 stringByAppendingString:@"*"];
            v15 = [[SFObjCType alloc] initWithCode:15 encoding:v4 name:v14 className:v13 size:8 flags:0];
...
LABEL_45:
        ...
        uint64_t v10 = 0;
LABEL_46:
        uint64_t v16 = [(SFObjCType *)v6 initWithCode:v8 encoding:v9 name:v7 className:0 size:v10 flags:0];
        goto LABEL_49;
      case '*':
        v11 = (void *)_SFObjCTypesByCode;
        uint64_t v12 = 14;
...
- (void)getBytes:(void *)a3 forObject:(id)a4
{
  ...
  if (objc_opt_isKindOfClass()) {
    ...
    [MEMORY[0x1E4F1CA00] raise:*MEMORY[0x1E4F1C3B8], @"Unsupported unboxing type: %@", self->_name format];
  }
}
...
- (id)objectWithBytes:(const void *)a3
{
  switch(self->_code)
  {
    ...
    case 0xFLL:
      ...
      break;
    default:
      [MEMORY[0x1E4F1CA00] raise:*MEMORY[0x1E4F1C3B8], @"For class %@, Unsupported boxing type: %@", self->_className, self->_name format];
      id v4 = 0;
      break;
  }
...
void __30__SFObjCType_typeForEncoding___block_invoke()
{
  ...
  v18 = [[SFObjCType alloc] initWithCode:0 encoding:@"c" name:@"char" className:0 size:1 flags:1];
  v19[0] = v18;
  id v17 = [[SFObjCType alloc] initWithCode:1 encoding:@"s" name:@"short" className:0 size:2 flags:1];
  v19[1] = v17;
  id v16 = [[SFObjCType alloc] initWithCode:2 encoding:@"i" name:@"int" className:0 size:4 flags:1];
  v19[2] = v16;
  id v15 = [[SFObjCType alloc] initWithCode:3 encoding:@"l" name:@"long" className:0 size:8 flags:1];
  v19[3] = v15;
  v14 = [[SFObjCType alloc] initWithCode:4 encoding:@"q" name:@"long long" className:0 size:8 flags:1];
  v19[4] = v14;
  v13 = [[SFObjCType alloc] initWithCode:5 encoding:@"C" name:@"unsigned char" className:0 size:1 flags:1];
  v19[5] = v13;
  uint64_t v12 = [[SFObjCType alloc] initWithCode:6 encoding:@"S" name:@"unsigned short" className:0 size:2 flags:1];
  v19[6] = v12;
  ...
  v19[9] = v2;
  double v3 = [[SFObjCType alloc] initWithCode:10 encoding:@"f" name:@"float" className:0 size:4 flags:2];
  v19[10] = v3;
  id v4 = [[SFObjCType alloc] initWithCode:11 encoding:@"d" name:@"double" className:0 size:8 flags:2];
  v19[11] = v4;
  int v5 = [[SFObjCType alloc] initWithCode:12 encoding:@"B" name:@"BOOL" className:0 size:1 flags:1];
  v19[12] = v5;
  id v6 = [[SFObjCType alloc] initWithCode:13 encoding:@"v" name:@"void" className:0 size:1 flags:0];
  v19[13] = v6;
  v7 = [[SFObjCType alloc] initWithCode:14 encoding:@"*" name:@"char*" className:0 size:8 flags:0];
  v19[14] = v7;
  uint64_t v8 = [[SFObjCType alloc] initWithCode:15 encoding:@"@" name:@"id" className:0 size:8 flags:0];
  v19[15] = v8;
  v9 = [[SFObjCType alloc] initWithCode:16 encoding:@"#" name:@"Class" className:0 size:8 flags:0];
  v19[16] = v9;
  uint64_t v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v19 count:17];
  v11 = (void *)_SFObjCTypesByCode;
