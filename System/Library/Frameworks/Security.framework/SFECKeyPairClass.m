...
Class __get_SFECKeyPairClass_block_invoke(uint64_t a1)
{
  ...
  if (!SecurityFoundationLibraryCore_frameworkLibrary)
  {
    ...
    v6[5] = v6;
    long long v7 = xmmword_1E547BA78;
    uint64_t v8 = 0;
  ...
  if (!SecurityFoundationLibraryCore_frameworkLibrary)
  {
    ...
    v4 = [NSString stringWithUTF8String:"void *SecurityFoundationLibrary(void)"];
    objc_msgSend(v3, "handleFailureInFunction:file:lineNumber:description:", v4, @"SOSFullPeerInfo.m", 68, @"%s", v6[0]);
  ...
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  ...
  {
    v3 = [MEMORY[0x1E4F28B00] currentHandler];
    v5 = [NSString stringWithUTF8String:"Class get_SFECKeyPairClass(void)_block_invoke"];
...
LABEL_10:
  ...
  get_SFECKeyPairClass_softClass = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  return result;
}
