...
- (id)decryptData:(id)a3 authenticatedData:(id)a4 error:(id *)a5
{
  ...
  if ((unint64_t)[v8 length] > 0x10)
  {
    ...
    id v17 = v8;
    id v13 = objc_msgSend(v16, "initWithBytesNoCopy:length:freeWhenDone:", objc_msgSend(v17, "bytes"), 16, 0);
    id v14 = objc_msgSend(objc_alloc((Class)NSData), "initWithBytesNoCopy:length:freeWhenDone:", (char *)objc_msgSend(v17, "bytes") + 16, v15, 0);
...
- (id)encryptData:(id)a3 authenticatedData:(id)a4 error:(id *)a5
{
  ...
  CCRNGStatus Bytes = CCRandomGenerateBytes([v11 mutableBytes], (size_t)objc_msgSend(v11, "length"));
  if (!Bytes)
  {
    [v8 length];
