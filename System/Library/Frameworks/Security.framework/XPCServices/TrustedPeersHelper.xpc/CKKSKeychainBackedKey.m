...
- (BOOL)loadKeyMaterialFromKeychain:(id *)a3
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      id v10 = v8;
      v11 = -[CKKSAESSIVKey initWithBytes:len:](v9, "initWithBytes:len:", [v10 bytes], objc_msgSend(v10, "length"));
      id v12 = v10;
      memset_s([v12 mutableBytes], (rsize_t)objc_msgSend(v12, "length"), 0, (rsize_t)objc_msgSend(v12, "length"));
      [(CKKSKeychainBackedKey *)self setAessivkey:v11];
      if (v21)
      {
        int v13 = sub_1002194F8(@"ckkskey", 0);
...
- (BOOL)wrapUnder:(id)a3 error:(id *)a4
{
  ...
  {
    id v11 = sub_1002194F8(@"ckkskey", 0);
...
LABEL_5:
  ...
  if (!v18 || [v18 code] == (id)-25300)
  {
    ...
    if (v27)
    {
      ...
      if (!v33)
      {
        id v47 = sub_1002194F8(@"ckkskey", 0);
...
+ (id)key:(id)a3 wrappedByKey:(id)a4 uuid:(id)a5 parentKeyUUID:(id)a6 keyclass:(id)a7 zoneID:(id)a8 error:(id *)a9
{
  ...
  {
    id v22 = sub_1002194F8(@"ckkskey", 0);
