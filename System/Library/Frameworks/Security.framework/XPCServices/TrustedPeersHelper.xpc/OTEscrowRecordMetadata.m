...
- (unint64_t)hash
{
  unint64_t v3 = (unint64_t)[(NSData *)self->_backupKeybagDigest hash];
  ...
  unint64_t v9 = v7 ^ (unint64_t)[(NSData *)self->_escrowedSpki hash];
  unint64_t v10 = v8 ^ v9 ^ (unint64_t)[(NSData *)self->_peerInfo hash];
  NSUInteger v11 = [(NSString *)self->_bottleValidity hash];
  unint64_t v12 = v11 ^ [(NSString *)self->_serial hash];
  unint64_t v13 = v12 ^ [(NSString *)self->_build hash];
  return v10 ^ v13 ^ (unint64_t)[(OTEscrowRecordMetadataPasscodeGeneration *)self->_passcodeGeneration hash];
}
...
LABEL_31:
  ...
  if ((unint64_t)passcodeGeneration | *((void *)v4 + 9)) {
    unsigned __int8 v16 = -[OTEscrowRecordMetadataPasscodeGeneration isEqual:](passcodeGeneration, "isEqual:");
  }
  else {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(NSData *)self->_backupKeybagDigest copyWithZone:a3];
  ...
  id v10 = [(NSString *)self->_bottleId copyWithZone:a3];
  NSUInteger v11 = (void *)v5[4];
  v5[4] = v10;
  ...
  id v12 = [(NSData *)self->_escrowedSpki copyWithZone:a3];
  unint64_t v13 = (void *)v5[8];
  v5[8] = v12;

  id v14 = [(NSData *)self->_peerInfo copyWithZone:a3];
  v15 = (void *)v5[10];
  v5[10] = v14;

  id v16 = [(NSString *)self->_bottleValidity copyWithZone:a3];
  v17 = (void *)v5[5];
  v5[5] = v16;

  id v18 = [(NSString *)self->_serial copyWithZone:a3];
  v19 = (void *)v5[11];
  v5[11] = v18;

  id v20 = [(NSString *)self->_build copyWithZone:a3];
  v21 = (void *)v5[6];
  v5[6] = v20;
...
- (BOOL)readFrom:(id)a3
{
  return sub_10020C3B8((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    id v8 = +[NSNumber numberWithUnsignedLongLong:self->_secureBackupUsesMultipleIcscs];
  ...
  if (*(unsigned char *)&self->_has)
  {
    id v10 = +[NSNumber numberWithUnsignedLongLong:self->_secureBackupTimestamp];
...
{
  v7.receiver = self;
  v7.super_class = (Class)OTEscrowRecordMetadata;
  unint64_t v3 = [(OTEscrowRecordMetadata *)&v7 description];
  id v4 = [(OTEscrowRecordMetadata *)self dictionaryRepresentation];
