...
- (unint64_t)hash
{
  ...
  {
    uint64_t v2 = 2654435761 * self->_excludeEvent;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_excludeCount;
  return v3 ^ v2;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((unsigned char *)result + 9) = self->_excludeEvent;
    *((unsigned char *)result + 12) |= 2u;
    char has = (char)self->_has;
  }
  if (has)
  {
    *((unsigned char *)result + 8) = self->_excludeCount;
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    BOOL v5 = [NSNumber numberWithBool:self->_excludeEvent];
  ...
  if (has)
  {
    id v6 = [NSNumber numberWithBool:self->_excludeCount];
...
- (id)description
{
  ...
  id v4 = [(SECSFAActionDropEvent *)&v8 description];
  BOOL v5 = [(SECSFAActionDropEvent *)self dictionaryRepresentation];
