...
- (_TtC31com_apple_CallKit_CallDirectory21CoreAnalyticsReporter)analyticsReporter;
- (_TtC31com_apple_CallKit_CallDirectory21SecureImageTranscoder)imageTranscoder;
...
- (void)fetchLiveIdentityInfoFor:(id)a3 cacheOnly:(BOOL)a4 completionHandler:(id)a5
{
  ...
  uint64_t v8 = [(CDXManager *)self liveLookupGroup];
  v9 = [(CDXManager *)self serverBag];
  ...
  v15 = [(CDXManager *)self liveLookupStore];
  v52 = [v15 activeExtensions];
      ...
      *(void *)&long long v19 = 138412290;
      ...
      while (2)
      {
        for (i = 0; i != v18; i = (char *)i + 1)
        {
          ...
          v26 = [v25 fetchIdentityInfoFor:v59 from:v22];
          ...
          if (v26)
          {
            ...
            {
              v42 = [(CDXManager *)self analyticsReporter];
      ...
      if (v43)
      {
        ...
        while (2)
        {
          for (j = 0; j != v43; j = (char *)j + 1)
          {
            ...
            v46 = *(void **)(*((void *)&v60 + 1) + 8 * (void)j);
            if (v46)
            {
              v47 = [*(id *)(*((void *)&v60 + 1) + 8 * (void)j) localizedLabel];
              BOOL v48 = v47 == 0;
...
- (void)callDirectoryHost:(id)a3 requestedFirstIdentificationEntriesForEnabledExtensionsWithPhoneNumbers:(id)a4 cacheOnly:(BOOL)a5 completionHandler:(id)a6
{
  ...
  if (v12)
  {
    id v14 = [[CDXRetrieveFirstIdentificationEntriesOperation alloc] initWithPhoneNumbers:v9 store:v12];
  ...
  else
  {
    ...
    id v14 = +[NSError cx_callDirectoryManagerErrorWithCode:0];
...
- (CDXManager)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v8 = objc_alloc_init(_TtC31com_apple_CallKit_CallDirectory21SecureImageTranscoder);
    ...
    id v12 = objc_alloc_init(_TtC31com_apple_CallKit_CallDirectory21CoreAnalyticsReporter);
    analyticsReporter = v3->_analyticsReporter;
    v3->_analyticsReporter = v12;

    id v14 = (CXCallDirectoryHost *)objc_alloc_init((Class)CXCallDirectoryHost);
    host = v3->_host;
    v3->_host = v14;
...
- (void)callDirectoryHost:(id)a3 requestedReloadForExtension:(id)a4 completionHandler:(id)a5
{
  ...
  if (v10)
  {
    id v12 = [(CDXManager *)self _loadExtensionDataOperationWithStore:v10 extension:v7];
  ...
  else
  {
    ...
    id v12 = +[NSError cx_callDirectoryManagerErrorWithCode:0];
...
- (void)callDirectoryHost:(id)a3 requestedEnabledStatusForExtension:(id)a4 completionHandler:(id)a5
{
  ...
  if (v9)
  {
    ...
    id v13 = [(CDXRetrieveExtensionEnabledStatusOperation *)v11 initWithExtensionIdentifier:v12 store:v9];
...
- (void)callDirectoryHost:(id)a3 requestedToSetEnabled:(BOOL)a4 forExtension:(id)a5 completionHandler:(id)a6
{
  ...
  if (v12)
  {
    id v14 = [(CDXManager *)self _loadExtensionDataOperationWithStore:v12 extension:v9];
...
- (void)fetchLiveInfoFor:(id)a3 with:(id)a4 blockingCompletion:(id)a5 identityCompletion:(id)a6
{
  ...
  id v14 = [v13 extensionIdentifierFor:v11];
  ...
  id v19 = +[NSDate date];
  id v20 = [(CDXManager *)self liveLookupGroup];
  ...
  v31 = +[NSDate date];
  id v32 = [(CDXManager *)self liveLookupGroup];
...
- (void)callDirectoryHost:(id)a3 requestedLiveBlockingInfoFor:(id)a4 completionHandler:(id)a5
{
  ...
  id v44 = [v9 activeExtensions];

  id v10 = [(CDXManager *)self liveLookupStore];
  id v48 = [v10 getBlockingInfoFor:v46];
    ...
    if (v16)
    {
      ...
      do
      {
        for (i = 0; i != v16; i = (char *)i + 1)
        {
          ...
          id v20 = [(CDXManager *)self analyticsReporter];
          id v21 = [(CDXManager *)self liveLookupStore];
          id v22 = [v21 extensionIdentifierFrom:v19];
...
- (void)callDirectoryHost:(id)a3 requestedFirstEnabledLiveBlockingExtensionIdentifierForPhoneNumber:(id)a4 completionHandler:(id)a5
{
  ...
  id v10 = [(CDXManager *)self liveLookupStore];
  id v11 = [v10 getBlockingInfoFor:v7];
...
- (void)callDirectoryHost:(id)a3 requestedToSynchronizeExtensionsWithCompletionHandler:(id)a4
{
  ...
  if (v7)
  {
    ...
    id v10 = [(CDXManager *)self systemMonitor];
    id v11 = -[CDXSynchronizeExtensionsOperation initWithStore:firstUnlockStatus:](v9, "initWithStore:firstUnlockStatus:", v7, [v10 firstUnlocked]);
...
- (void)callDirectoryHost:(id)a3 requestedToSetPrioritizedExtensionIdentifiers:(id)a4 completionHandler:(id)a5
{
  ...
  unsigned __int8 v8 = sub_10000492C();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    id v19 = v6;
