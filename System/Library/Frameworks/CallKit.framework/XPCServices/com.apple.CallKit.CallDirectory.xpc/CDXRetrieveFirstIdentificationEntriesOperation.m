    ...
    *(void *)&long long v6 = 138412546;
    ...
    do
    {
      ...
      do
      {
        ...
        v10 = objc_msgSend(v4, "objectForKeyedSubscript:", v9, v24);
...
{
  id v4 = a3;
  id v5 = [(CDXRetrieveFirstIdentificationEntriesOperation *)self queue];
...
- (CDXRetrieveFirstIdentificationEntriesOperation)initWithPhoneNumbers:(id)a3 extensionsDataSource:(id)a4 store:(id)a5
{
  ...
  if (v11)
  {
    ...
    id v16 = (CXCallDirectorySanitizer *)objc_alloc_init((Class)CXCallDirectorySanitizer);
