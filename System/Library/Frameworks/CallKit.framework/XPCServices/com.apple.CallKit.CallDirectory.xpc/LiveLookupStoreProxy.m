...
- (id)activeExtensions
{
  ...
  sub_100025900();
  v3.super.isa = sub_100025C10().super.isa;
...
- (_TtC31com_apple_CallKit_CallDirectory20LiveLookupStoreProxy)init
{
  ...
  sub_1000259F0();
  uint64_t v4 = sub_1000259E0();
  v5 = (_TtC31com_apple_CallKit_CallDirectory20LiveLookupStoreProxy *)sub_1000224AC((uint64_t)v3, v4, (char *)objc_allocWithZone(ObjectType));
...
- (void)setImagePath:(id)a3
{
  uint64_t v4 = sub_100025BA0();
  uint64_t v6 = v5;
  v7 = (uint64_t *)((char *)self + OBJC_IVAR____TtC31com_apple_CallKit_CallDirectory20LiveLookupStoreProxy_imagePath);
  swift_beginAccess();
  uint64_t *v7 = v4;
  v7[1] = v6;
  swift_bridgeObjectRelease();
...
{
  sub_100025BA0();
  sub_1000196CC((Class *)((char *)&self->super.isa+ OBJC_IVAR____TtC31com_apple_CallKit_CallDirectory20LiveLookupStoreProxy_liveLookupStore), *(void *)&self->keyRotationBeforeExpirationMinutes[OBJC_IVAR____TtC31com_apple_CallKit_CallDirectory20LiveLookupStoreProxy_liveLookupStore]);
  id v4 = self;
  sub_100025960();

  swift_bridgeObjectRelease();
  sub_100025A10();
  v5.super.isa = sub_100025C10().super.isa;
  swift_bridgeObjectRelease();
...
{
  sub_100025A10();
  unint64_t v6 = sub_100025C20();
  id v7 = a3;
  NSString v8 = self;
  NSString v9 = sub_100022660(v6, v7);
...
- (void)setEnabled:(BOOL)a3 forExtensionWith:(NSString *)a4 completionHandler:(id)a5
{
  ...
  *(void *)(v12 + 40) = self;
  ...
  v16 = a4;
  v17 = self;
  sub_1000221A4((uint64_t)v10, (uint64_t)&unk_10003CF48, (uint64_t)v15);
  swift_release();
}
...
- (BOOL)shouldBlockWith:(id)a3
{
  ...
  unint64_t v4 = sub_100025C20();
  NSArray v5 = self;
  unsigned __int8 v6 = _s018com_apple_CallKit_C9Directory20LiveLookupStoreProxyC11shouldBlock4withSbSay08IdentityG012BlockingInfoCG_tF_0(v4);
...
- (void)updateIdentityInfoFor:(id)a3 with:(id)a4 name:(id)a5 iconURL:(id)a6 type:(int64_t)a7 ttlMinutes:(unsigned int)a8
{
  uint64_t v14 = sub_100004B80(&qword_10003CEF0);
  __chkstk_darwin(v14 - 8);
  v16 = (char *)&v26 - ((v15 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v17 = sub_100025BA0();
  uint64_t v19 = v18;
  if (!a5)
  {
    uint64_t v20 = 0;
...
LABEL_6:
  ...
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  sub_10001A738((uint64_t)v16, &qword_10003CEF0);
}
...
- (id)iconURLFor:(id)a3
{
  uint64_t v5 = sub_100004B80(&qword_10003CEF0);
...
{
  sub_100025BA0();
  id v4 = objc_allocWithZone((Class)sub_100025A30());
  uint64_t v5 = (void *)sub_100025A20();
...
- (void).cxx_destruct
{
  ...
  sub_10001A210((uint64_t)self + OBJC_IVAR____TtC31com_apple_CallKit_CallDirectory20LiveLookupStoreProxy_liveLookupStore);
