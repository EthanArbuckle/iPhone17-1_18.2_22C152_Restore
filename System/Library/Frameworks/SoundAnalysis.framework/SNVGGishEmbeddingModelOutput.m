...
- (SNVGGishEmbeddingModelOutput)initWithOutput1:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SNVGGishEmbeddingModelOutput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x1E4F1CAD0] setWithArray:&unk_1F3818FD8];
}
...
- (id)featureValueForName:(id)a3
{
  if ([a3 isEqualToString:@"output1"])
  {
    ...
    id v5 = [(SNVGGishEmbeddingModelOutput *)self output1];
