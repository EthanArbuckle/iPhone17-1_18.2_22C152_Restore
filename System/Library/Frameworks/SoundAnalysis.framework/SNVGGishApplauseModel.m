...
- (SNVGGishApplauseModel)initWithConfiguration:(id)a3 error:(id *)a4;
- (SNVGGishApplauseModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (SNVGGishApplauseModel)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (SNVGGishApplauseModel)initWithMLModel:(id)a3;
...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1DC873000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not load SNVGGishApplauseModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (SNVGGishApplauseModel)initWithMLModel:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)SNVGGishApplauseModel;
...
- (SNVGGishApplauseModel)init
{
  ...
  v4 = [(SNVGGishApplauseModel *)self initWithContentsOfURL:v3 error:0];
...
- (SNVGGishApplauseModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(SNVGGishApplauseModel *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(SNVGGishApplauseModel *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(SNVGGishApplauseModel *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(SNVGGishApplauseModelOutput *)v12 initWithOutput1:v14];
  }
  else
  {
    v15 = 0;
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(SNVGGishApplauseModel *)self model];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  v10[2] = sub_1DCB76A8C;
  v10[3] = &unk_1E6CA82B8;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(SNVGGishApplauseModel *)self model];
...
{
  id v6 = a3;
  id v7 = [[SNVGGishApplauseModelInput alloc] initWithInput1:v6];

  id v8 = [(SNVGGishApplauseModel *)self predictionFromFeatures:v7 error:a4];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(SNVGGishApplauseModelOutput *)v16 initWithOutput1:v18];
