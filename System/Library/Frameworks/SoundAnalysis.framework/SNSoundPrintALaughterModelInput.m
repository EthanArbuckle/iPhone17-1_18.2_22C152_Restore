...
- (SNSoundPrintALaughterModelInput)initWithInput1:(id)a3
{
  return [(SNSoundPrintALaughterModelInput *)self initWithInput1:a3 stateIn:0 detectedHistoryIn:0];
}
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x1E4F1CAD0] setWithArray:&unk_1F38191A0];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"input1"])
  {
    ...
    v6 = [(SNSoundPrintALaughterModelInput *)self input1];
...
LABEL_11:
  ...
  {
    v6 = [(SNSoundPrintALaughterModelInput *)self stateIn];
    if (v6)
    {
      v8 = (void *)MEMORY[0x1E4F1E950];
      uint64_t v9 = [(SNSoundPrintALaughterModelInput *)self stateIn];
LABEL_9:
      id v10 = (void *)v9;
  ...
  {
    v6 = [(SNSoundPrintALaughterModelInput *)self detectedHistoryIn];
    if (v6)
    {
      v8 = (void *)MEMORY[0x1E4F1E950];
      uint64_t v9 = [(SNSoundPrintALaughterModelInput *)self detectedHistoryIn];
      goto LABEL_9;
    }
LABEL_10:
    v7 = 0;
