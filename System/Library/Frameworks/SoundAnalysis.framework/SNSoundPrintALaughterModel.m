...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1DC873000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not load SNSoundPrintALaughterModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (SNSoundPrintALaughterModel)initWithMLModel:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)SNSoundPrintALaughterModel;
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(SNSoundPrintALaughterModel *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(SNSoundPrintALaughterModel *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(SNSoundPrintALaughterModel *)self model];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  v10[2] = sub_1DCB8228C;
  v10[3] = &unk_1E6CA82B8;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(SNSoundPrintALaughterModel *)self model];
...
- (id)predictionFromInput1:(id)a3 stateIn:(id)a4 detectedHistoryIn:(id)a5 error:(id *)a6
{
  ...
  id v14 = [(SNSoundPrintALaughterModel *)self predictionFromFeatures:v13 error:a6];
