...
- (NSSet)featureNames;
- (SNSoundPrintAShoutingModelOutput)initWithInput_1:(id)a3 Confidence:(id)a4 Detected:(id)a5 detectedHistoryOut:(id)a6;
...
- (SNSoundPrintAShoutingModelOutput)initWithInput_1:(id)a3 Confidence:(id)a4 Detected:(id)a5 detectedHistoryOut:(id)a6
{
  ...
  id v14 = a6;
  v18.receiver = self;
  v18.super_class = (Class)SNSoundPrintAShoutingModelOutput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x1E4F1CAD0] setWithArray:&unk_1F38190F8];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"input_1"])
  {
    ...
    uint64_t v6 = [(SNSoundPrintAShoutingModelOutput *)self input];
LABEL_9:
    v7 = (void *)v6;
  ...
  {
    v5 = (void *)MEMORY[0x1E4F1E950];
    uint64_t v6 = [(SNSoundPrintAShoutingModelOutput *)self Confidence];
    goto LABEL_9;
  }
  if ([v4 isEqualToString:@"Detected"])
  {
    v5 = (void *)MEMORY[0x1E4F1E950];
    uint64_t v6 = [(SNSoundPrintAShoutingModelOutput *)self Detected];
    goto LABEL_9;
  }
  if ([v4 isEqualToString:@"detectedHistoryOut"])
  {
    v5 = (void *)MEMORY[0x1E4F1E950];
    uint64_t v6 = [(SNSoundPrintAShoutingModelOutput *)self detectedHistoryOut];
    goto LABEL_9;
  }
  v8 = 0;
LABEL_10:
