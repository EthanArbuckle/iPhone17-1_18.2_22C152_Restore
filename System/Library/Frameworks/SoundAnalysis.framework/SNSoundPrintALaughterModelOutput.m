...
- (SNSoundPrintALaughterModelOutput)initWithInput_1:(id)a3 Confidence:(id)a4 Detected:(id)a5 detectedHistoryOut:(id)a6
{
  ...
  id v14 = a6;
  v18.receiver = self;
  v18.super_class = (Class)SNSoundPrintALaughterModelOutput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x1E4F1CAD0] setWithArray:&unk_1F38191B8];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"input_1"])
  {
    ...
    uint64_t v6 = [(SNSoundPrintALaughterModelOutput *)self input];
LABEL_9:
    v7 = (void *)v6;
  ...
  {
    v5 = (void *)MEMORY[0x1E4F1E950];
    uint64_t v6 = [(SNSoundPrintALaughterModelOutput *)self Confidence];
    goto LABEL_9;
  }
  if ([v4 isEqualToString:@"Detected"])
  {
    v5 = (void *)MEMORY[0x1E4F1E950];
    uint64_t v6 = [(SNSoundPrintALaughterModelOutput *)self Detected];
    goto LABEL_9;
  }
  if ([v4 isEqualToString:@"detectedHistoryOut"])
  {
    v5 = (void *)MEMORY[0x1E4F1E950];
    uint64_t v6 = [(SNSoundPrintALaughterModelOutput *)self detectedHistoryOut];
    goto LABEL_9;
  }
  v8 = 0;
LABEL_10:
