...
- (MLMultiArray)input1;
- (NSSet)featureNames;
- (SNVGGishCheeringModelInput)initWithInput1:(id)a3;
...
- (SNVGGishCheeringModelInput)initWithInput1:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SNVGGishCheeringModelInput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x1E4F1CAD0] setWithArray:&unk_1F3819230];
}
...
- (id)featureValueForName:(id)a3
{
  if ([a3 isEqualToString:@"input1"])
  {
    ...
    id v5 = [(SNVGGishCheeringModelInput *)self input1];
