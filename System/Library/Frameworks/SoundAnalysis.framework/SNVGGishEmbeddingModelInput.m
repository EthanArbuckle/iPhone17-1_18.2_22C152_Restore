...
- (SNVGGishEmbeddingModelInput)initWithInput1:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SNVGGishEmbeddingModelInput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x1E4F1CAD0] setWithArray:&unk_1F3818FC0];
}
...
- (id)featureValueForName:(id)a3
{
  if ([a3 isEqualToString:@"input1"])
  {
    ...
    id v5 = [(SNVGGishEmbeddingModelInput *)self input1];
