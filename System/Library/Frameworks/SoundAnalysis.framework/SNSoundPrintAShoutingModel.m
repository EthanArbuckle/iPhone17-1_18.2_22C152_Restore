@interface SNSoundPrintAShoutingModel
...
+ (id)URLOfModelInThisBundle
{
  ...
  v3 = [v2 pathForResource:@"SNSoundPrintAShoutingModel" ofType:@"mlmodelc"];
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_1DC873000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not load SNSoundPrintAShoutingModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (SNSoundPrintAShoutingModel)initWithMLModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = [(SNSoundPrintAShoutingModel *)&v10 init];
    v7 = v6;
    if (v6) {
...
- (SNSoundPrintAShoutingModel)init
{
  ...
  v4 = [(SNSoundPrintAShoutingModel *)self initWithContentsOfURL:v3 error:0];
...
- (SNSoundPrintAShoutingModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(SNSoundPrintAShoutingModel *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (SNSoundPrintAShoutingModel)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  if (v5)
  {
    self = [(SNSoundPrintAShoutingModel *)self initWithMLModel:v5];
    id v6 = self;
  }
  else
  {
...
- (SNSoundPrintAShoutingModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  if (v6)
  {
    self = [(SNSoundPrintAShoutingModel *)self initWithMLModel:v6];
    v7 = self;
  }
  else
  {
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(SNSoundPrintAShoutingModel *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(SNSoundPrintAShoutingModel *)self model];
  ...
  if (v11)
  {
    ...
    v21 = [(SNSoundPrintAShoutingModelOutput *)v12 initWithInput_1:v14 Confidence:v16 Detected:v18 detectedHistoryOut:v20];
  }
  else
  {
    v21 = 0;
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(SNSoundPrintAShoutingModel *)self model];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  v10[2] = sub_1DCB7DCA0;
  v10[3] = &unk_1E6CA82B8;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(SNSoundPrintAShoutingModel *)self model];
...
- (id)predictionFromInput1:(id)a3 stateIn:(id)a4 detectedHistoryIn:(id)a5 error:(id *)a6
{
  ...
  id v11 = a4;
  id v12 = a3;
  v13 = [[SNSoundPrintAShoutingModelInput alloc] initWithInput1:v12 stateIn:v11 detectedHistoryIn:v10];

  id v14 = [(SNSoundPrintAShoutingModel *)self predictionFromFeatures:v13 error:a6];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v24 = [(SNSoundPrintAShoutingModelOutput *)v16 initWithInput_1:v17 Confidence:v19 Detected:v21 detectedHistoryOut:v23];
