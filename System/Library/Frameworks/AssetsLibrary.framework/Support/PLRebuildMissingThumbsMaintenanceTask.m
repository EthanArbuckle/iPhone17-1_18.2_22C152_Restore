...
- (BOOL)runTaskWithTransaction:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (+[PLThumbnailManager requiredThumbnailResetTypeWithPathManager:v7 comparedToConfigPhase:2] == (id)1)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        int v32 = 138412290;
        v33 = v12;
        _os_log_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_ERROR, "Unsuppressing target thumbnail config for library: %@", (uint8_t *)&v32, 0xCu);
      }
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        int v32 = 138412290;
        v33 = v14;
        _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_ERROR, "Marking assets as needing table thumb migration for library: %@", (uint8_t *)&v32, 0xCu);
      }
    ...
    else
    {
      ...
      if (([v15 wantsTableOnlyRebuild] & 1) == 0)
      {
        ...
        id v21 = +[PLTableThumbnailMigrator countOfAssetsPendingTableThumbRebuildInLibrary:v20];
    ...
    unsigned int v25 = [v24 wantsTableOnlyRebuild];
    ...
    if (v25)
    {
      ...
      if (v26)
      {
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          int v32 = 138412290;
          v33 = v26;
          _os_log_impl((void *)&_mh_execute_header, v28, OS_LOG_TYPE_ERROR, "Queueing request to continue table thumb migration for library: %@", (uint8_t *)&v32, 0xCu);
        }
      ...
      else
      {
        ...
        {
          LOWORD(v32) = 0;
          _os_log_impl((void *)&_mh_execute_header, v28, OS_LOG_TYPE_DEFAULT, "Cannot continue with rebuild thumbs task because there is no library", (uint8_t *)&v32, 2u);
        }

        v26 = 0;
      }
    }
    else if ([v24 hasMissingThumbnailsInLibrary:v26] {
           && ([v24 isRebuildingThumbnails] & 1) == 0)
    }
    {
      unsigned __int8 v29 = [v24 hasExceededRebuildThumbnailRequestLimit];
...
LABEL_29:
      ...
      {
        LOWORD(v32) = 0;
        _os_log_impl((void *)&_mh_execute_header, v30, OS_LOG_TYPE_ERROR, "Found missing thumbnails in library, attempting repair", (uint8_t *)&v32, 2u);
      }
  ...
  {
    LOWORD(v32) = 0;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_ERROR, "Rebuild missing thumbnails maintenance task is not supported for syndication library", (uint8_t *)&v32, 2u);
  }
LABEL_30:
