...
- (MDLTransformRotateXOp)initWithName:(id)a3 inverse:(BOOL)a4 data:(id)a5
{
  ...
  id v10 = a5;
  v15.receiver = self;
  v15.super_class = (Class)MDLTransformRotateXOp;
...
- (double)float4x4AtTime:(uint64_t)a3
{
  ...
  v5.f64[0] = 0.0;
  sub_20B0D3E20((uint64_t)v18, v4 * 0.0174532925, (float64x2_t)COERCE_UNSIGNED_INT64(1.0), 0.0, v5);
  uint64_t v6 = 0;
...
- (double)double4x4AtTime:(uint64_t)a3@<X2>
{
  ...
  long long v11 = 0u;
  v7.f64[0] = 0.0;
  sub_20B0D3E20((uint64_t)&v10, v6 * 0.0174532925, (float64x2_t)COERCE_UNSIGNED_INT64(1.0), 0.0, v7);
  if (*(unsigned char *)(a1 + 8))
  {
    __invert_d4();
  }
