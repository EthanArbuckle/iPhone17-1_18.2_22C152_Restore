...
- (id)newBufferWithData:(id)a3 type:(unint64_t)a4
{
  ...
  uint64_t v12 = objc_msgSend_initWithLength_data_allocator_zone_(v7, v11, v10, v6, self, 0);
  v12[6] = a4;
...
- (id)newBufferFromZone:(id)a3 data:(id)a4 type:(unint64_t)a5
{
  ...
  uint64_t v15 = objc_msgSend_initWithLength_data_allocator_zone_(v10, v14, v13, v9, self, v8);
  v15[6] = a5;
