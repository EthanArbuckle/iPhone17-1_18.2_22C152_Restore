...
- (NSDictionary)messagePayload
{
  ...
  v4 = [(HMEraseAnisetteDataRequest *)self messageName];
  v7 = v4;
  v8[0] = v3;
...
- (NSString)messageName
{
  return (NSString *)@"kHMEraseAnisetteDataRequest";
}
...
+ (id)objWithMessage:(id)a3
{
  ...
  objc_super v6 = objc_msgSend(v5, "hmf_dataForKey:", @"kHMEraseAnisetteDataRequest");
...
+ (id)objWithDict:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "hmf_dataForKey:", @"kHMEraseAnisetteDataRequest");
  id v13 = 0;
