...
- (HMSyncAnisetteDataRequest)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HMSyncAnisetteDataRequest;
...
{
  v6.receiver = self;
  v6.super_class = (Class)HMSyncAnisetteDataRequest;
  id v4 = a3;
...
- (NSString)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HMSyncAnisetteDataRequest;
  id v4 = [(HMRemoteLoginMessage *)&v8 description];
  v5 = [(HMSyncAnisetteDataRequest *)self simData];
  objc_super v6 = [v3 stringWithFormat:@"[HMSyncAnisetteDataRequest: %@, sim-data %@]", v4, v5];
...
- (NSDictionary)messagePayload
{
  ...
  id v4 = [(HMSyncAnisetteDataRequest *)self messageName];
  v7 = v4;
  v8[0] = v3;
...
- (NSString)messageName
{
  return (NSString *)@"kHMSyncAnisetteDataRequest";
}
...
+ (id)objWithMessage:(id)a3
{
  ...
  objc_super v6 = objc_msgSend(v5, "hmf_dataForKey:", @"kHMSyncAnisetteDataRequest");
...
+ (id)objWithDict:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "hmf_dataForKey:", @"kHMSyncAnisetteDataRequest");
  id v13 = 0;
