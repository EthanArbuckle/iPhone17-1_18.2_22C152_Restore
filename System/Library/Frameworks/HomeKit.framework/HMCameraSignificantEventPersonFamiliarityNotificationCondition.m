...
- (NSArray)attributeDescriptions
{
  ...
  unint64_t v8 = [(HMCameraSignificantEventPersonFamiliarityNotificationCondition *)self personFamiliarityOptions];
  v4 = NSPrintF();
  v5 = objc_msgSend(v3, "initWithName:value:", @"Person Familiarity", v4, v8, &unk_19D47BADE);
  v9[0] = v5;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v6)
  {
    unint64_t v7 = [(HMCameraSignificantEventPersonFamiliarityNotificationCondition *)self personFamiliarityOptions];
    BOOL v8 = v7 == [v6 personFamiliarityOptions];
  }
  else
  {
    BOOL v8 = 0;
...
- (NSPredicate)predicate
{
  unint64_t v2 = [(HMCameraSignificantEventPersonFamiliarityNotificationCondition *)self personFamiliarityOptions];

  return (NSPredicate *)+[HMCameraBulletinBoardSmartNotification predicateForPersonFamiliarityOptions:v2];
}
...
- (HMCameraSignificantEventPersonFamiliarityNotificationCondition)initWithPredicate:(id)a3
{
  ...
  else
  {
    ...
    return (HMCameraSignificantEventPersonFamiliarityNotificationCondition *)+[HMCameraSignificantEventPersonFamiliarityNotificationCondition shortDescription];
  }
}
