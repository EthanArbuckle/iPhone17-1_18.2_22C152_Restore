...
- (HMFetchAnisetteDataResponse)initWithCoder:(id)a3;
...
@implementation HMFetchAnisetteDataResponse
...
- (HMFetchAnisetteDataResponse)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HMFetchAnisetteDataResponse;
...
{
  v6.receiver = self;
  v6.super_class = (Class)HMFetchAnisetteDataResponse;
  id v4 = a3;
  [(HMRemoteLoginMessage *)&v6 encodeWithCoder:v4];
  v5 = [(HMFetchAnisetteDataResponse *)self anisetteData];
...
- (NSString)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HMFetchAnisetteDataResponse;
  id v4 = [(HMRemoteLoginMessage *)&v8 description];
  v5 = [(HMFetchAnisetteDataResponse *)self anisetteData];
  objc_super v6 = [v3 stringWithFormat:@"[HMFetchAnisetteDataResponse: %@, anisette-data %@]", v4, v5];
...
- (NSDictionary)messagePayload
{
  ...
  id v4 = [(HMFetchAnisetteDataResponse *)self messageName];
  v7 = v4;
  v8[0] = v3;
...
- (NSString)messageName
{
  return (NSString *)@"kHMFetchAnisetteDataResponse";
}
...
+ (id)objWithMessage:(id)a3
{
  ...
  objc_super v6 = objc_msgSend(v5, "hmf_dataForKey:", @"kHMFetchAnisetteDataResponse");
...
+ (id)objWithDict:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "hmf_dataForKey:", @"kHMFetchAnisetteDataResponse");
  id v13 = 0;
