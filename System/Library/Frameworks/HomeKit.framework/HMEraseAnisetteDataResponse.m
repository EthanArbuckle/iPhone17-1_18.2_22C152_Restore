...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[HMEraseAnisetteDataResponse didSucceed](self, "didSucceed", v5.receiver, v5.super_class), @"TRAnisetteDataMessages_dS");
}
...
- (NSDictionary)messagePayload
{
  ...
  id v4 = [(HMEraseAnisetteDataResponse *)self messageName];
  objc_super v7 = v4;
  v8[0] = v3;
...
- (NSString)messageName
{
  return (NSString *)@"kHMEraseAnisetteDataResponse";
}
...
+ (id)objWithMessage:(id)a3
{
  ...
  v6 = objc_msgSend(v5, "hmf_dataForKey:", @"kHMEraseAnisetteDataResponse");
...
+ (id)objWithDict:(id)a3
{
  ...
  id v4 = a3;
  objc_super v5 = objc_msgSend(v4, "hmf_dataForKey:", @"kHMEraseAnisetteDataResponse");
  id v13 = 0;
