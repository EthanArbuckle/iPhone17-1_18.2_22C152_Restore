...
- (unint64_t)hash
{
  return [(HMSettingBooleanValue *)self BOOLValue];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (v6)
    {
      BOOL v7 = [(HMSettingBooleanValue *)self BOOLValue];
      BOOL v8 = v7 ^ [(HMSettingBooleanValue *)v6 BOOLValue] ^ 1;
    }
    else
    {
      LOBYTE(v8) = 0;
...
- (HMSettingBooleanValue)initWithProtoPayload:(id)a3
{
  ...
  id v4 = a3;
  if ([v4 hasBoolValueEvent])
  {
    v5 = [v4 BOOLValueEvent];
    if ([v5 hasValue])
    {
      v6 = -[HMSettingBooleanValue initWithBoolValue:](self, "initWithBoolValue:", [v5 value]);
      BOOL v7 = v6;
    }
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v17 = 2112;
        id v18 = v4;
        _os_log_impl(&dword_19D1A8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode setting value due to no BOOL value in BOOL value event in proto payload: %@", (uint8_t *)&v15, 0x16u);
      }
      BOOL v7 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_19D1A8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode setting value due to no BOOL value event type in proto payload: %@", (uint8_t *)&v15, 0x16u);
    }
    BOOL v7 = 0;
  }
...
- (id)protoPayload
{
  ...
  id v4 = objc_alloc_init(HMImmutableSettingsProtoBoolValueEvent);
...
- (HMSettingBooleanValue)initWithPayload:(id)a3
{
  ...
  id v4 = a3;
  id v13 = 0;
  uint64_t v5 = objc_msgSend(v4, "hmf_BOOLForKey:error:", @"HMImmutableSettingValuePayloadKey", &v13);
  id v6 = v13;
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      id v17 = v4;
      _os_log_impl(&dword_19D1A8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode setting BOOLean value due to no BOOL value in payload: %@", buf, 0x16u);
    }
    v11 = 0;
  }
  else
  {
    BOOL v8 = [(HMSettingBooleanValue *)self initWithBoolValue:v5];
    v11 = v8;
  }
...
- (id)payloadCopy
{
  ...
  v11[0] = &unk_1EEF07A58;
  uint64_t v5 = objc_msgSend(NSNumber, "numberWithBool:", -[HMSettingBooleanValue BOOLValue](self, "BOOLValue"));
  v11[1] = v5;
