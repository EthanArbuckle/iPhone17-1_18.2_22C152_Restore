...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [+[HMHomeManagerConfiguration allocWithZone:a3] initWithOptions:[(HMHomeManagerConfiguration *)self options] cachePolicy:[(HMHomeManagerConfiguration *)self cachePolicy]];
