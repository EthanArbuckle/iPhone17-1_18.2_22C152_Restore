  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      v18 = v14;
      __int16 v19 = 2112;
      CFStringRef v20 = @"HM.token";
      _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_ERROR, "%{public}@Missing required object for key '%@'", buf, 0x16u);
    }
    v11 = 0;
  }
...
- (id)destination
{
  ...
  v5 = [v4 URI];
  v6 = [v5 prefixedURI];
  objc_super v7 = (void *)IDSCopyIDForTokenWithID();
...
- (_HMDGlobalDeviceHandle)initWithDestination:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v26 = 0;
    id v27 = 0;
    char v6 = sub_100008E98(v4, &v29, &v28, &v27, &v26);
    id v7 = v29;
    id v8 = v28;
    id v9 = v27;
    id v10 = v26;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        id v35 = v10;
        _os_log_impl((void *)&_mh_execute_header, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to parse destination, %@, with error: %@", buf, 0x20u);
      }
      v17 = 0;
    }
  }
  else
  {
    ...
    {
      CFStringRef v20 = HMFGetLogIdentifier();
      *(_DWORD *)buf = 138543362;
      v31 = v20;
      _os_log_impl((void *)&_mh_execute_header, v19, OS_LOG_TYPE_ERROR, "%{public}@Missing destination parameter", buf, 0xCu);
    }
    v17 = 0;
  }
...
- (_HMDGlobalDeviceHandle)initWithPushToken:(id)a3 accountHandle:(id)a4
{
  ...
  if (v6)
  {
    ...
    v11 = (void *)IDSCopyIDForTokenWithID();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      __int16 v19 = v16;
      _os_log_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_ERROR, "%{public}@Missing push token parameter", (uint8_t *)&v18, 0xCu);
    }
    v13 = 0;
  }
...
+ (BOOL)isValidDestination:(id)a3
{
  return sub_100008E98(a3, 0, 0, 0, 0);
}
