...
- (NSString)shortDescription
{
  id v3 = [(HMDAccountIdentifier *)self internal];
  id v4 = [v3 kind];
  id v5 = [(HMDAccountIdentifier *)self identifier];
  id v6 = [v5 UUIDString];
...
- (HMDAccountIdentifier)initWithInternal:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v6 = [(HMDAccountIdentifier *)&v10 init];
    id v7 = v6;
    if (v6) {
...
+ (id)accountIdentifierForAppleAccountContext:(id)a3
{
  ...
  id v6 = [(_HMDAppleAccountIdentifier *)v4 initWithIdentifierString:v5];
