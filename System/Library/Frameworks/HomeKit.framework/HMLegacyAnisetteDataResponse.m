...
- (HMLegacyAnisetteDataResponse)initWithCoder:(id)a3;
...
@implementation HMLegacyAnisetteDataResponse
...
- (HMLegacyAnisetteDataResponse)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HMLegacyAnisetteDataResponse;
...
{
  v6.receiver = self;
  v6.super_class = (Class)HMLegacyAnisetteDataResponse;
  id v4 = a3;
  [(HMRemoteLoginMessage *)&v6 encodeWithCoder:v4];
  v5 = [(HMLegacyAnisetteDataResponse *)self anisetteData];
  [v4 encodeObject:v5 forKey:@"TRAnisetteDataMessages_aD"];
}
...
- (NSString)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HMLegacyAnisetteDataResponse;
  id v4 = [(HMRemoteLoginMessage *)&v8 description];
  v5 = [(HMLegacyAnisetteDataResponse *)self anisetteData];
  objc_super v6 = [v3 stringWithFormat:@"[HMLegacyAnisetteDataResponse: %@, anisette-data %@]", v4, v5];
...
- (NSDictionary)messagePayload
{
  ...
  id v4 = [(HMLegacyAnisetteDataResponse *)self messageName];
  v7 = v4;
  v8[0] = v3;
...
- (NSString)messageName
{
  return (NSString *)@"kHMLegacyAnisetteDataResponse";
}
...
+ (id)objWithMessage:(id)a3
{
  ...
  objc_super v6 = objc_msgSend(v5, "hmf_dataForKey:", @"kHMLegacyAnisetteDataResponse");
...
+ (id)objWithDict:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "hmf_dataForKey:", @"kHMLegacyAnisetteDataResponse");
  id v13 = 0;
