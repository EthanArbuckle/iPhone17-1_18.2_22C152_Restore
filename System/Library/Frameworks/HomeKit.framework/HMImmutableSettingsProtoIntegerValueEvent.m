...
- (BOOL)readFrom:(id)a3
{
  return HMImmutableSettingsProtoIntegerValueEventReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HMImmutableSettingsProtoIntegerValueEvent;
  id v4 = [(HMImmutableSettingsProtoIntegerValueEvent *)&v8 description];
  BOOL v5 = [(HMImmutableSettingsProtoIntegerValueEvent *)self dictionaryRepresentation];
