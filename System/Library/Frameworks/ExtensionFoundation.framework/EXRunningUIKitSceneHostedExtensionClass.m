@interface EXRunningUIKitSceneHostedExtensionClass
@end
...
{
  ExtensionKitLibrary();
  Class result = objc_getClass("_EXRunningUIKitSceneHostedExtension");
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  if (*(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24))
  {
    get_EXRunningUIKitSceneHostedExtensionClass_softClass = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  }
  else
  {
    uint64_t v3 = __get_EXRunningUIKitSceneHostedExtensionClass_block_invoke_cold_1();
