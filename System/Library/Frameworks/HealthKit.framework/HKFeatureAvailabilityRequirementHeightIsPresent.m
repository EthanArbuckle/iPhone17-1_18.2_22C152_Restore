...
@implementation HKFeatureAvailabilityRequirementHeightIsPresent

+ (NSString)requirementIdentifier
{
  return (NSString *)@"HeightIsPresent";
}

- (NSString)requirementDescription
{
  return (NSString *)@"A height sample must be added in either Health Details or Health App > Browse > Body Measurements > Height > Add Data";
}

- (id)isSatisfiedWithDataSource:(id)a3 error:(id *)a4
{
  id v5 = a3;
  v6 = +[HKObjectType characteristicTypeForIdentifier:@"HKCharacteristicTypeIdentifierHeight"];
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR)) {
      -[HKFeatureAvailabilityRequirementHeightIsPresent isSatisfiedWithDataSource:error:]();
    }
...
- (void)registerObserver:(id)a3 forDataSource:(id)a4
{
  ...
  aBlock[1] = 3221225472;
  aBlock[2] = __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke;
  ...
  v12[1] = 3221225472;
  v12[2] = __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke_10;
  v12[3] = &unk_1E58C0CA8;
  id v11 = v9;
  id v13 = v11;
...
void __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
...
uint64_t __82__HKFeatureAvailabilityRequirementHeightIsPresent_registerObserver_forDataSource___block_invoke_10(uint64_t a1)
{
...
- (void)isSatisfiedWithDataSource:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_2(&dword_19C023000, v2, v3, "[%{public}@] Error while pulling height characteristic: %{public}@", v4, v5, v6, v7, v8);
}
