...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HKCodableQuantitySeries;
  id v4 = [(HKCodableQuantitySeries *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return HKCodableQuantitySeriesReadFrom(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearValues];
    unint64_t v4 = [(HKCodableQuantitySeries *)self valuesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HKCodableQuantitySeries *)self valuesAtIndex:i];
        [v8 addValues:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HKCodableQuantitySeries addValues:](self, "addValues:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
