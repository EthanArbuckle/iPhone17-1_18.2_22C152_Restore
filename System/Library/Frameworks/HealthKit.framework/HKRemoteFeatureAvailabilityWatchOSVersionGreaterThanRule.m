...
@implementation HKRemoteFeatureAvailabilityWatchOSVersionGreaterThanRule

+ (id)ruleIdentifier
{
  return @"WatchOSVersionGreaterThan";
}
...
- (void)processUserInfo:(id)a3
{
  ...
  -[HKRemoteFeatureAvailabilityWatchOSVersionGreaterThanRule setTargetVersion:](self, "setTargetVersion:", v5, v6, v7);
}
