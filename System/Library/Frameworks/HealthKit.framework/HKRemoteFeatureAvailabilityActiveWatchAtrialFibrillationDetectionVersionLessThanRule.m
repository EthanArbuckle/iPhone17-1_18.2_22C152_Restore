...
@implementation HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionLessThanRule

+ (id)ruleIdentifier
{
  return @"WatchAtrialFibrillationDetectionVersionLessThan";
}
...
- (void)processUserInfo:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v5 = v7;
    uint64_t v6 = v8;
    [(HKRemoteFeatureAvailabilityActiveWatchAtrialFibrillationDetectionVersionLessThanRule *)self setTargetVersion:&v5];
  }
}
...
LABEL_15:
  ...
  if (!v8)
  {
    ...
    BOOL v5 = HKSemanticVersionCompare(&v13, &v11) == 1;
    goto LABEL_15;
  }
  return 0;
}
