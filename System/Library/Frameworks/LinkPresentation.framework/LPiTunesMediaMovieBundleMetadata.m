...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[LPiTunesMediaMovieBundleMetadata allocWithZone:a3];
  if (v4)
  {
    ...
    uint64_t v6 = [(LPiTunesMediaMovieBundleMetadata *)self storeIdentifier];
    ...
    uint64_t v8 = [(LPiTunesMediaMovieBundleMetadata *)self genre];
    ...
    uint64_t v10 = [(LPiTunesMediaMovieBundleMetadata *)self artworkMetadata];
...
- (id)presentationPropertiesForTransformer:(id)a3
{
  ...
  v7 = [(LPiTunesMediaMovieBundleMetadata *)self name];
  objc_super v8 = [(LPiTunesMediaMovieBundleMetadata *)self genre];
  v9 = LPLocalizedString(@" iTunes");
  populateCaptionBar(v5, v7, v8, v9, 0, v4);

  uint64_t v10 = [(LPiTunesMediaMovieBundleMetadata *)self artwork];
...
{
  id v4 = NSString;
  char v5 = LPLocalizedString(@"Movie Bundle: %@");
  uint64_t v6 = [(LPiTunesMediaMovieBundleMetadata *)self name];
...
{
  id v6 = a3;
  id v4 = [(LPiTunesMediaMovieBundleMetadata *)self name];
  [v6 setTitle:v4];

  char v5 = [(LPiTunesMediaMovieBundleMetadata *)self artwork];
  [v6 setImage:v5];
}
