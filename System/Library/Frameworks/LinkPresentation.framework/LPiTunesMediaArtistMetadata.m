...
- (LPImage)artwork;
- (LPiTunesMediaArtistMetadata)initWithCoder:(id)a3;
- (NSString)genre;
- (NSString)name;
...
- (LPiTunesMediaArtistMetadata)initWithCoder:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)LPiTunesMediaArtistMetadata;
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[LPiTunesMediaArtistMetadata allocWithZone:a3];
  if (v4)
  {
    v5 = [(LPiTunesMediaArtistMetadata *)self storeFrontIdentifier];
    [(LPiTunesMediaArtistMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(LPiTunesMediaArtistMetadata *)self storeIdentifier];
    [(LPiTunesMediaArtistMetadata *)v4 setStoreIdentifier:v6];

    v7 = [(LPiTunesMediaArtistMetadata *)self name];
    [(LPiTunesMediaArtistMetadata *)v4 setName:v7];

    uint64_t v8 = [(LPiTunesMediaArtistMetadata *)self genre];
    [(LPiTunesMediaArtistMetadata *)v4 setGenre:v8];

    v9 = [(LPiTunesMediaArtistMetadata *)self artwork];
    [(LPiTunesMediaArtistMetadata *)v4 setArtwork:v9];

    uint64_t v10 = [(LPiTunesMediaArtistMetadata *)self artworkMetadata];
    [(LPiTunesMediaArtistMetadata *)v4 setArtworkMetadata:v10];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)LPiTunesMediaArtistMetadata;
  if ([(LPiTunesMediaArtistMetadata *)&v8 isEqual:v4])
  {
    char v5 = 1;
  }
  else
...
{
  id v4 = a3;
  char v5 = [v4 commonPresentationPropertiesForStyle:7];
  ...
  {
    v7 = [(LPiTunesMediaArtistMetadata *)self name];
    objc_super v8 = LPLocalizedString(@"Artist");
  ...
  uint64_t v10 = [(LPiTunesMediaArtistMetadata *)self artwork];
...
{
  id v4 = NSString;
  char v5 = LPLocalizedString(@"Artist: %@");
  uint64_t v6 = [(LPiTunesMediaArtistMetadata *)self name];
...
{
  id v6 = a3;
  id v4 = [(LPiTunesMediaArtistMetadata *)self name];
  [v6 setTitle:v4];

  char v5 = [(LPiTunesMediaArtistMetadata *)self artwork];
  [v6 setImage:v5];
}

- (id)storeIdentifierForTransformer:(id)a3
{
  v3 = [(LPiTunesMediaArtistMetadata *)self storeIdentifier];
