...
- (LPEmailCompatibleHTMLCaptionBarComponent)initWithStyle:(id)a3 presentationProperties:(id)a4 themePath:(id)a5 generator:(id)a6
{
  ...
  if (v14)
  {
    ...
    v18 = objc_msgSend(v17, "_lp_CSSText");
    [v16 setAttribute:@"bgcolor" value:v18];

    v19 = [v13 backgroundColor];
    v20 = objc_msgSend(v19, "_lp_CSSTextForcingUserInterfaceStyle:", 0);
    v21 = [v13 cssResolver];
    v22 = [v21 localVariables];
    v23 = [NSString stringWithFormat:@"local-%@-backgroundColor", v12, v39];
    ...
    if (v24)
    {
      ...
      v27 = [NSString stringWithFormat:@"local-%@-colorFilter", v12];
    ...
    v31 = [v13 rootWidth];
    v32 = objc_msgSend(v31, "_lp_HTMLAttributeText");
...
- (void)buildComponents
{
  ...
  if (v6)
  {
    ...
    id v11 = [(LPHTMLComponent *)self generator];
    id v12 = [(LPEmailCompatibleHTMLCaptionBarItemComponent *)v8 initWithStyle:v9 themePath:v10 generator:v11];

    id v13 = [(LPHTMLComponent *)v12 element];
    v14 = [(LPCaptionBarStyle *)self->_style leftIcon];
    v15 = [v14 fixedSize];
    v16 = [v15 width];
    v17 = objc_msgSend(v16, "_lp_HTMLAttributeText");
    ...
    v27 = [v26 fixedSize];
    v28 = [v27 width];
    v29 = objc_msgSend(v28, "_lp_HTMLAttributeText");
    ...
    v32 = [v31 fixedSize];
    v33 = [v32 height];
    v34 = objc_msgSend(v33, "_lp_HTMLAttributeText");
    ...
    unint64_t v7 = 0x1E95CE000uLL;
  }
  id v39 = [LPEmailCompatibleHTMLCaptionBarItemComponent alloc];
  uint64_t v82 = *(int *)(v7 + 2848);
  objc_super v40 = [*(id *)((char *)&self->super.super.isa + v82) textStack];
  ...
  v45 = [*(id *)((char *)&self->super.super.isa + v82) textStack];
  ...
  if (v50)
  {
    ...
    v52 = [*(id *)((char *)&self->super.super.isa + v82) rightIcon];
    ...
    v57 = [*(id *)((char *)&self->super.super.isa + v82) rightIcon];
    v58 = [v57 fixedSize];
    v59 = [v58 width];
    v60 = objc_msgSend(v59, "_lp_HTMLAttributeText");
    ...
    v63 = [*(id *)((char *)&self->super.super.isa + v82) rightIcon];
    ...
    v69 = [*(id *)((char *)&self->super.super.isa + v82) rightIcon];
    v70 = [v69 fixedSize];
    v71 = [v70 width];
    v72 = objc_msgSend(v71, "_lp_HTMLAttributeText");
    [v68 setAttribute:@"width" value:v72];

    v73 = [(LPHTMLComponent *)v67 element];
    v74 = [*(id *)((char *)&self->super.super.isa + v82) rightIcon];
    v75 = [v74 fixedSize];
    v76 = [v75 height];
    v77 = objc_msgSend(v76, "_lp_HTMLAttributeText");
