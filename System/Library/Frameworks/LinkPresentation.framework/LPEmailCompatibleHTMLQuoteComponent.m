...
- (LPEmailCompatibleHTMLQuoteComponent)initWithText:(id)a3 style:(id)a4 themePath:(id)a5 generator:(id)a6
{
  ...
  if (v13)
  {
    ...
    v17 = [v10 font];
    [v17 pointSize];
    v19 = objc_msgSend(v16, "stringWithFormat:", @"%gpt", v18);
    v20 = [v12 cssResolver];
    v21 = [v20 localVariables];
    v22 = [NSString stringWithFormat:@"local-%@-font-size", v11];
    [v21 setObject:v19 forKeyedSubscript:v22];

    v23 = CSSAlignmentFromLPTextAlignment([v10 textAlignment]);
    v24 = [v12 cssResolver];
    v25 = [v24 localVariables];
    v26 = [NSString stringWithFormat:@"local-%@-text-alignment", v11];
    [v25 setObject:v23 forKeyedSubscript:v26];

    v27 = [v10 color];
    v28 = objc_msgSend(v27, "_lp_CSSText");
    v29 = [v12 cssResolver];
    v30 = [v29 localVariables];
    v31 = [NSString stringWithFormat:@"local-%@-color", v11];
    ...
    v40 = [v39 trailing];
    [v40 value];
    double v42 = v34 - v38 - v41;

    v43 = objc_msgSend(NSString, "stringWithFormat:", @"%gpx", *(void *)&v42);
    v44 = [v12 cssResolver];
    v45 = [v44 localVariables];
    v46 = [NSString stringWithFormat:@"local-%@-width", v11];
...
+ (id)baseRules
{
  ...
  v10[7] = v6;
  v7 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v10 forKeys:v9 count:8];
