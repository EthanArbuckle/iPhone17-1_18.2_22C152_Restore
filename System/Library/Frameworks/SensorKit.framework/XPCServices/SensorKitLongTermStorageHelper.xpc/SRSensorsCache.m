...
+ (void)initialize
{
  if ((id)objc_opt_class() == a1) {
    qword_100017028 = (uint64_t)os_log_create("com.apple.SensorKit", "SensorsCache");
  }
}

+ (void)setDefaultCache:(id)a3
{
  if ((id)qword_100017030 != a3)
  {

    qword_100017030 = (uint64_t)a3;
  }
}
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled((os_log_t)qword_100017028, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138543362;
        uint64_t v17 = v13;
        _os_log_fault_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_FAULT, "Failed to locate the /System/Library directory because %{public}@", buf, 0xCu);
      }
      v5 = +[NSURL fileURLWithPath:@"/System/Library"];
    }
    v4 = +[NSURL fileURLWithPath:isDirectory:relativeToURL:](NSURL, "fileURLWithPath:isDirectory:relativeToURL:", +[NSString pathWithComponents:&off_100011ED0], 1, v5);
  }
