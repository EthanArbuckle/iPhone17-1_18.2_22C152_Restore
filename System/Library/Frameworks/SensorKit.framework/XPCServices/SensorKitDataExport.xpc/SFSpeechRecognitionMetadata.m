...
- (id)sr_dictionaryRepresentation
{
  id v3 = sub_1000086B4([(SFAcousticFeature *)[(SFVoiceAnalytics *)[(SFSpeechRecognitionMetadata *)self voiceAnalytics] jitter] acousticFeatureValuePerFrame]);
  id v4 = sub_1000086B4([(SFAcousticFeature *)[(SFVoiceAnalytics *)[(SFSpeechRecognitionMetadata *)self voiceAnalytics] pitch] acousticFeatureValuePerFrame]);
  id v5 = sub_1000086B4([(SFAcousticFeature *)[(SFVoiceAnalytics *)[(SFSpeechRecognitionMetadata *)self voiceAnalytics] voicing] acousticFeatureValuePerFrame]);
  id v6 = sub_1000086B4([(SFAcousticFeature *)[(SFVoiceAnalytics *)[(SFSpeechRecognitionMetadata *)self voiceAnalytics] shimmer] acousticFeatureValuePerFrame]);
  v18[0] = @"speakingRate";
  [(SFSpeechRecognitionMetadata *)self speakingRate];
  v19[0] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
  v18[1] = @"averagePauseDuration";
  [(SFSpeechRecognitionMetadata *)self averagePauseDuration];
  v19[1] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
  v18[2] = @"speechStartTimestamp";
  [(SFSpeechRecognitionMetadata *)self speechStartTimestamp];
  v19[2] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
  v18[3] = @"speechDuration";
  [(SFSpeechRecognitionMetadata *)self speechDuration];
  v19[3] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
  ...
  v15[1] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
  ...
  v11[1] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
  ...
  v9[1] = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
