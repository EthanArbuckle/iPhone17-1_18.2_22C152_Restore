...
- (id)sr_dictionaryRepresentation
{
  ...
  {
    if ((int)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] vertexCount] < 1)
    {
      v5 = &stru_1000106F8;
    }
    else
    {
      ...
      do
      {
        v5 = (__CFString *)[(__CFString *)v5 stringByAppendingFormat:@"%f %f %f ", *(float *)((char *)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] vertices]+ v3), *(float *)((char *)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] vertices]+ v3+ 4), *(float *)((char *)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] vertices]+ v3+ 8)];
        ++v4;
        v3 += 16;
      }
      while (v4 < (int)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] vertexCount]);
    }
    if ((int)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] textureCoordinateCount] < 1)
    {
      v8 = &stru_1000106F8;
    }
    else
    {
      ...
      do
      {
        v8 = (__CFString *)[(__CFString *)v8 stringByAppendingFormat:@"%f %f ", COERCE_FLOAT(*((void *)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] textureCoordinates]+ v7)), *((float *)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] textureCoordinates]+ 2 * v7+ 1)];
        ++v7;
      }
      while (v7 < (int)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] textureCoordinateCount]);
    }
    if ((int)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] triangleCount] < 1)
    {
      v10 = &stru_1000106F8;
    }
    else
    {
      ...
      v10 = &stru_1000106F8;
      do
        v10 = (__CFString *)[(__CFString *)v10 stringByAppendingFormat:@"%i ", *((__int16 *)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] triangleIndices]+ v9++)];
      while (v9 < (int)[(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] triangleCount]);
    }
    CFStringRef v6 = +[NSString stringWithFormat:@"{ vertexCount:%lu, vertices:%@, textureCoordinateCount:%lu, textureCoordinates:%@, triangleCount:%lu, triangleIndices:%@}", [(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] vertexCount], v5, [(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] textureCoordinateCount], v8, [(ARFaceGeometry *)[(ARFaceAnchor *)self geometry] triangleCount], v10];
  }
  else
  {
  ...
  v117[0] = +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:");
  [(ARFaceAnchor *)self transform];
  ...
  v112[0] = +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:");
  [(ARFaceAnchor *)self leftEyeTransform];
  ...
  v107[0] = +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:");
  [(ARFaceAnchor *)self rightEyeTransform];
  ...
  v103[0] = +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:");
  [(ARFaceAnchor *)self lookAtPoint];
  ...
  if ([(ARFaceAnchor *)self identifier]) {
    CFStringRef v96 = (const __CFString *)objc_msgSend(-[ARFaceAnchor identifier](self, "identifier"), "UUIDString");
  }
  else {
    CFStringRef v96 = &stru_1000106F8;
  }
  v102[0] = v96;
  v101[1] = @"sessionIdentifier";
  if ([(ARFaceAnchor *)self sessionIdentifier]) {
    CFStringRef v97 = (const __CFString *)objc_msgSend(-[ARFaceAnchor sessionIdentifier](self, "sessionIdentifier"), "UUIDString");
  }
  else {
    CFStringRef v97 = &stru_1000106F8;
  }
  v102[1] = v97;
  v102[2] = v6;
  v101[2] = @"geometry";
  ...
  if (v98) {
    CFStringRef v99 = (const __CFString *)v98;
  }
  else {
    CFStringRef v99 = &stru_1000106F8;
  }
  v102[7] = v99;
