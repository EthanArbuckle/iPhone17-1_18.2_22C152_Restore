    ...
    if ((unint64_t)mappedAddress + 1 >= 2)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogMemoryMapping, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 134349056;
        v11 = mappedAddress;
        _os_log_impl(&dword_21FCA3000, v4, OS_LOG_TYPE_INFO, "Unmapping %{public}p", buf, 0xCu);
      }
      ...
      if (munmap(mappedAddress, pageAlignedSize))
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogMemoryMapping, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 134349568;
          ...
          __int16 v14 = 1026;
          int v15 = v7;
          _os_log_impl(&dword_21FCA3000, v6, OS_LOG_TYPE_INFO, "Unable to unmap %{public}p size %zu because %{public, darwin.errno}d", buf, 0x1Cu);
          v6 = SRLogMemoryMapping;
        }
        if (os_log_type_enabled(v6, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 134349568;
          ...
          __int16 v14 = 1026;
          int v15 = v8;
          _os_log_fault_impl(&dword_21FCA3000, v6, OS_LOG_TYPE_FAULT, "Unable to unmap %{public}p size %zu because %{public, darwin.errno}d", buf, 0x1Cu);
        }
        abort();
      }
  ...
  if (result)
  {
    ...
    if (v8 == (char *)-1)
    {
      ...
      if (result)
      {
        ...
        __int16 v17 = 1026;
        int v18 = v13;
        _os_log_fault_impl(&dword_21FCA3000, v12, OS_LOG_TYPE_FAULT, "Unable to mmap storage file %{public}@ because %{public, darwin.errno}d", (uint8_t *)&v15, 0x12u);
        return 0;
      }
    }
    else
      ...
      *(void *)(v3 + 24) = v9;
      if (madvise(v8, v7, v10) < 0)
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogMemoryMapping, OS_LOG_TYPE_FAULT))
        {
          ...
          int v15 = 67240192;
          LODWORD(v16) = v14;
          _os_log_fault_impl(&dword_21FCA3000, v11, OS_LOG_TYPE_FAULT, "Failed to madvise() because %{public, darwin.errno}d", (uint8_t *)&v15, 8u);
        }
      }
      return 1;
    }
      ...
      if (v4 != v3)
      {
        if (msync(v2, v4 - v3, 16))
        {
          ...
          if (os_log_type_enabled((os_log_t)SRLogMemoryMapping, OS_LOG_TYPE_ERROR))
          {
            ...
            v8[0] = 67240192;
            v8[1] = v7;
            _os_log_error_impl(&dword_21FCA3000, v6, OS_LOG_TYPE_ERROR, "Failed to msync because %{public, darwin.errno}d", (uint8_t *)v8, 8u);
          }
        }
      }
    }
      ...
      if ((*(_DWORD *)(v4 + 8) & 2) != 0)
      {
        ...
        if (__CFADD__(v6, a3))
        {
          ...
          if (result)
          {
            int v10 = 134349056;
            uint64_t v11 = a3;
            _os_log_error_impl(&dword_21FCA3000, v7, OS_LOG_TYPE_ERROR, "%{public}zu is too large to write", (uint8_t *)&v10, 0xCu);
            return 0;
          }
        }
        else
    ...
    if (-[SRMemoryMapping isValidWriteToDestinationAddress:withLength:bytes:]((BOOL)a1, (unint64_t)v6, a3, (uint64_t)a2))
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogMemoryMapping, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v11 = 2050;
          size_t v12 = v7;
          _os_log_impl(&dword_21FCA3000, v8, OS_LOG_TYPE_INFO, "More bytes requested %{public}zu than the capacity %{public}zu. Client should call -freeSpace: to avoid this", (uint8_t *)&v9, 0x16u);
        }
      }
    }
  }
