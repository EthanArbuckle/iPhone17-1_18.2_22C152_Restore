  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)v58 = v15;
      ...
      uint32_t v20 = 12;
LABEL_20:
      _os_log_impl(&dword_21FCA3000, v18, v19, v17, buf, v20);
    }
  }
LABEL_21:
  ...
  if (*(void *)((char *)v54 + 4) > v27)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)v59 = a3;
      ...
      uint32_t v35 = 32;
LABEL_43:
      _os_log_impl(&dword_21FCA3000, v33, v34, v32, buf, v35);
      goto LABEL_44;
    }
    goto LABEL_44;
  }
...
LABEL_44:
  ...
  if (DWORD1(v54[1]) != v37)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)v59 = 2080;
      *(void *)&v59[2] = v39;
      _os_log_impl(&dword_21FCA3000, v38, OS_LOG_TYPE_DEFAULT, "Segment versions of %{public}@ don't match. Received %{public}d, expected %{public}d.%s", buf, 0x22u);
    }
    unint64_t v30 = 0;
    *(void *)((char *)v54 + 4) = 0;
  }
  ...
  *(void *)(v10 + 56) = a2;
  if (a4 == 1 && (-[SRFrameStore resizeBackingFileTo:](v10, v41) & 1) == 0)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_21FCA3000, v51, OS_LOG_TYPE_ERROR, "Failed to resize backing file", buf, 2u);
    }
    goto LABEL_44;
  }
...
- (uint64_t)resizeBackingFileTo:(uint64_t)result
{
  ...
  if (result)
  {
    ...
    else
    {
      ...
      {
        *(_WORD *)v3 = 0;
        _os_log_error_impl(&dword_21FCA3000, v2, OS_LOG_TYPE_ERROR, "Attempting to resize a non-writable file", v3, 2u);
        return 0;
      }
    }
  }
...
LABEL_9:
      *(_DWORD *)buf = 138543362;
      ...
      _os_log_impl(&dword_21FCA3000, v7, OS_LOG_TYPE_INFO, "Tearing down frame store for %{public}@", buf, 0xCu);
    }
  }
  else
  {
  ...
  if (self->_permission == 1)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2050;
      uint64_t v19 = v5;
      _os_log_impl(&dword_21FCA3000, v11, OS_LOG_TYPE_INFO, "Finalizing %{public}@ to %{public}llu bytes", buf, 0x16u);
    }
  ...
  if (result)
  {
    ...
    if (v7 != v8 && v8 != 0)
    {
      ...
      if (result)
      {
        ...
        __int16 v13 = 2050;
        uLong v14 = v7;
        _os_log_impl(&dword_21FCA3000, v10, OS_LOG_TYPE_INFO, "Checksums don't match. Header: %llu, Generated checksum: %{public}lu. Skipping frame.", (uint8_t *)&v11, 0x16u);
        return 0;
      }
    }
  }
...
- (uint64_t)writeFrameForBytes:(z_size_t)a3 length:(SRError *)a4 timestamp:(double)a5 error:
{
  ...
  if (result)
  {
    ...
    if (!v7 || (uint64_t v8 = *(void *)(v7 + 16)) == 0)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_21FCA3000, v15, OS_LOG_TYPE_ERROR, "Failed to find a segment header while writing. Dropping incoming data", buf, 2u);
        if (!a4) {
          return 0;
        }
      }
    ...
    if ((unint64_t)v12 < a3 + 20)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_21FCA3000, v13, OS_LOG_TYPE_ERROR, "No space left to write to the mapped region", buf, 2u);
        if (a4) {
          goto LABEL_11;
        }
      }
...
LABEL_27:
    ...
    if (v16 >= a5)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2048;
        *(double *)&buf[14] = v16;
        _os_log_error_impl(&dword_21FCA3000, v20, OS_LOG_TYPE_ERROR, "Frame should come in chronological order. Input %f < last %f", buf, 0x16u);
        if (!a4) {
          return 0;
        }
      }
    ...
    if (v18 + 10.0 < a5)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2048;
        *(double *)&buf[14] = v18;
        _os_log_error_impl(&dword_21FCA3000, v19, OS_LOG_TYPE_ERROR, "Timestamp is from the future. Input %f, Current: %f", buf, 0x16u);
        if (a4) {
          goto LABEL_19;
        }
      }
...
LABEL_19:
    ...
    if (HIDWORD(a3))
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 1024;
        *(_DWORD *)&buf[14] = -1;
        _os_log_error_impl(&dword_21FCA3000, v21, OS_LOG_TYPE_ERROR, "Sample too large %{public}zu but only %u supported", buf, 0x12u);
        if (!a4) {
          return 0;
        }
      }
...
- (void)markFrameAsRemoved:(uint64_t)a1
{
  ...
  if (a1)
  {
    *(void *)(a2 + 8) = 0;
    ...
    {
      errno_t v3 = v2;
      z_size_t v4 = SRLogFrameStore;
      if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_FAULT))
      {
        v5[0] = 67240192;
        v5[1] = v3;
        _os_log_fault_impl(&dword_21FCA3000, v4, OS_LOG_TYPE_FAULT, "Failed to zero out memory. %{public, darwin.errno}d", (uint8_t *)v5, 8u);
      }
    }
  }
}
...
- (void)sync
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogFrameStore, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_21FCA3000, v2, OS_LOG_TYPE_DEFAULT, "Syncing %{public}zu bytes from segment %{public}@ to disk", (uint8_t *)&v7, 0x16u);
    }
