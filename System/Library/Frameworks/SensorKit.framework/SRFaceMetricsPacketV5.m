...
LABEL_26:
  ...
  id v4 = (id)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDBytes:a3->var1];
  if (!v4)
  {
    v12 = _MergedGlobals_4;
    if (!os_log_type_enabled((os_log_t)_MergedGlobals_4, OS_LOG_TYPE_FAULT)) {
  ...
  if (!qword_26AB1A0E0)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_21FCA3000, v15, OS_LOG_TYPE_ERROR, "Failed to generate V5 face metrics, because of empty neutral face geometry", buf, 2u);
    }
    return 0;
  }
  uint64_t v6 = objc_msgSend(NSString, "stringWithFormat:", @"%llu", a3->var3);
  if (!v6)
  {
    v12 = _MergedGlobals_4;
    if (!os_log_type_enabled((os_log_t)_MergedGlobals_4, OS_LOG_TYPE_FAULT)) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)SRFaceMetricsPacketV5;
...
- (NSArray)wholeFaceExpressions
{
  ...
  v4[1] = +[SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:value:](SRFaceMetricsExpression, "wholeFaceMetricsExpressionWithIdentifier:value:", @"1F26EABE-8350-48C5-97F0-06EFD6FEC6C4", self->_packet->var18.var0.var1, +[SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"E24480FE-8ECF-412C-8A02-3E924971A840" value:self->_packet->var18.var0.var0]);
...
- (NSArray)rotation
{
  ...
  *(float *)&double v2 = self->_packet->var9.var0[0][0];
  v15[0] = [NSNumber numberWithFloat:v2];
  *(float *)&double v4 = self->_packet->var9.var0[0][1];
  v15[1] = [NSNumber numberWithFloat:v4];
  *(float *)&double v5 = self->_packet->var9.var0[0][2];
  v15[2] = [NSNumber numberWithFloat:v5];
  v16[0] = [MEMORY[0x263EFF8C0] arrayWithObjects:v15 count:3];
  *(float *)&double v6 = self->_packet->var9.var0[1][0];
  v14[0] = [NSNumber numberWithFloat:v6];
  *(float *)&double v7 = self->_packet->var9.var0[1][1];
  v14[1] = [NSNumber numberWithFloat:v7];
  *(float *)&double v8 = self->_packet->var9.var0[1][2];
  v14[2] = [NSNumber numberWithFloat:v8];
  v16[1] = [MEMORY[0x263EFF8C0] arrayWithObjects:v14 count:3];
  *(float *)&double v9 = self->_packet->var9.var0[2][0];
  v13[0] = [NSNumber numberWithFloat:v9];
  *(float *)&double v10 = self->_packet->var9.var0[2][1];
  v13[1] = [NSNumber numberWithFloat:v10];
  *(float *)&double v11 = self->_packet->var9.var0[2][2];
...
- (NSArray)translation
{
  ...
  *(float *)&double v2 = self->_packet->var9.var1[0];
  v7[0] = [NSNumber numberWithFloat:v2];
  *(float *)&double v4 = self->_packet->var9.var1[1];
  v7[1] = objc_msgSend(NSNumber, "numberWithFloat:", v4, v7[0]);
  *(float *)&double v5 = self->_packet->var9.var1[2];
...
{
  v7[3] = *MEMORY[0x263EF8340];
  *(float *)&double v2 = self->_packet->var16[0];
  v7[0] = [NSNumber numberWithFloat:v2];
  *(float *)&double v4 = self->_packet->var16[1];
  v7[1] = objc_msgSend(NSNumber, "numberWithFloat:", v4, v7[0]);
  *(float *)&double v5 = self->_packet->var16[2];
  v7[2] = [NSNumber numberWithFloat:v5];
  return (NSArray *)[MEMORY[0x263EFF8C0] arrayWithObjects:v7 count:3];
}
...
- (NSData)blendshapes
{
  return (NSData *)[MEMORY[0x263EFF8F8] dataWithBytes:&self->_packet->var17 length:204];
}

- (NSArray)geometryLeftEye
{
  v7[3] = *MEMORY[0x263EF8340];
  *(float *)&double v2 = self->_packet->var10[0];
  v7[0] = [NSNumber numberWithFloat:v2];
  *(float *)&double v4 = self->_packet->var10[1];
  v7[1] = objc_msgSend(NSNumber, "numberWithFloat:", v4, v7[0]);
  *(float *)&double v5 = self->_packet->var10[2];
  v7[2] = [NSNumber numberWithFloat:v5];
  return (NSArray *)[MEMORY[0x263EFF8C0] arrayWithObjects:v7 count:3];
}
...
{
  v7[3] = *MEMORY[0x263EF8340];
  *(float *)&double v2 = self->_packet->var11[0];
  v7[0] = [NSNumber numberWithFloat:v2];
  *(float *)&double v4 = self->_packet->var11[1];
  v7[1] = objc_msgSend(NSNumber, "numberWithFloat:", v4, v7[0]);
  *(float *)&double v5 = self->_packet->var11[2];
  v7[2] = [NSNumber numberWithFloat:v5];
  return (NSArray *)[MEMORY[0x263EFF8C0] arrayWithObjects:v7 count:3];
}
