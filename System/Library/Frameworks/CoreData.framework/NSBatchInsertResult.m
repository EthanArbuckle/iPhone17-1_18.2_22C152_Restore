...
{
  v9.receiver = self;
  v9.super_class = (Class)NSBatchInsertResult;
  v6 = [(NSBatchInsertResult *)&v9 init];
  v7 = v6;
  if (v6)
  {
    v6->_resultType = a3;
...
- (NSBatchInsertResult)initWithSubresults:(id)a3
{
  ...
  v49.receiver = self;
  v49.super_class = (Class)NSBatchInsertResult;
  v4 = [(NSBatchInsertResult *)&v49 init];
  if (!v4) {
    return v4;
  }
  if ([a3 count])
    ...
    while (1)
    {
      for (uint64_t j = 0; j != v24; ++j)
      {
        ...
        if (v28 != [v27 resultType])
        {
          ...
          v35 = &v50;
LABEL_49:
          objc_exception_throw((id)objc_msgSend(v31, "exceptionWithName:reason:userInfo:", v32, @"Mismatched result types during aggregation of batch insert results", objc_msgSend(v33, "dictionaryWithObjects:forKeys:count:", v34, v35, 1)));
        }
        v29 = (void *)[v27 result];
        if ([v29 count]) {
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)NSBatchInsertResult;
  [(NSBatchInsertResult *)&v3 dealloc];
}
