...
- (unint64_t)hash
{
  unint64_t v3 = [(NWPBBrowseDescriptor *)self->_descriptor hash];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(NWPBBrowseDescriptor *)self->_descriptor copyWithZone:a3];
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (descriptor)
  {
    uint64_t v5 = [(NWPBBrowseDescriptor *)descriptor dictionaryRepresentation];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)NWPBStartBrowse;
  id v4 = [(NWPBStartBrowse *)&v8 description];
  uint64_t v5 = [(NWPBStartBrowse *)self dictionaryRepresentation];
