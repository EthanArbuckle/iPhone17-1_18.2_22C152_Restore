...
{
  v2 = " idempotent";
  if ((*((unsigned char *)self + 128) & 4) == 0) {
    v2 = "";
  }
  if ((*((unsigned char *)self + 128) & 2) != 0) {
    v3 = " reported";
  }
  else {
    v3 = "";
  }
  objc_super v4 = (__CFString *)CFStringCreateWithFormat((CFAllocatorRef)*MEMORY[0x1E4F1CF80], 0, @"<nw_write_request%s%s>", v2, v3);
