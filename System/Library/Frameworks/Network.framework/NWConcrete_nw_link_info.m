...
- (NWConcrete_nw_link_info)init;
- (void)dealloc;
@end

@implementation NWConcrete_nw_link_info

- (NWConcrete_nw_link_info)init
{
  uint64_t v21 = *MEMORY[0x1E4F143B8];
  v16.receiver = self;
  v16.super_class = (Class)NWConcrete_nw_link_info;
  v2 = [(NWConcrete_nw_link_info *)&v16 init];
  v3 = v2;
  if (v2)
  {
    v4 = v2;
  ...
  *(_DWORD *)buf = 136446210;
  v18 = "-[NWConcrete_nw_link_info init]";
...
{
  v2.receiver = self;
  v2.super_class = (Class)NWConcrete_nw_link_info;
  [(NWConcrete_nw_link_info *)&v2 dealloc];
}
