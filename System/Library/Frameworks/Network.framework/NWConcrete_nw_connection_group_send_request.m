...
- (NSString)description
{
  v2 = (__CFString *)CFStringCreateWithFormat((CFAllocatorRef)*MEMORY[0x1E4F1CF80], 0, @"<nw_connection_group_send_request>");
...
- (void)dealloc
{
  ...
  [(NWConcrete_nw_connection_group_send_request *)&v2 dealloc];
}
...
- (NWConcrete_nw_connection_group_send_request)init
{
  ...
  objc_super v2 = [(NWConcrete_nw_connection_group_send_request *)&v16 init];
  v3 = v2;
  if (v2)
  {
    v4 = v2;
