...
- (unint64_t)hash
{
  ...
  return [(NSString *)self->_domain hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
    ...
    && ((type = self->_type, !((unint64_t)type | v4[2])) || -[NSString isEqual:](type, "isEqual:")))
  {
    ...
    if ((unint64_t)domain | v4[1]) {
      char v7 = -[NSString isEqual:](domain, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (id)description
{
  ...
  id v4 = [(NWPBServiceBrowse *)&v8 description];
  id v5 = [(NWPBServiceBrowse *)self dictionaryRepresentation];
