...
uint64_t __55__CNPropertyInstantMessageEditingCell_pickerDidCancel___block_invoke(uint64_t a1)
{
...
uint64_t __58__CNPropertyInstantMessageEditingCell_picker_didPickItem___block_invoke(uint64_t a1)
{
  return [*(id *)(a1 + 32) regainFocus];
}
...
- (void)labelButtonClicked:(id)a3
{
  ...
  if (v7 >= 2)
  {
    v8 = [[CNInstantMessagePickerController alloc] initWithStyle:1];
...
- (CNInstantMessageAddress)imAddress
{
  ...
  return (CNInstantMessageAddress *)v10;
}
