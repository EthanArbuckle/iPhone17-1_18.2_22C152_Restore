...
{
  id v4 = a3;
  id v7 = [(CNUINavigationListStyleApplier *)self navigationListStyle];
...
- (void)applyNavigationListStyleToDetailCell:(id)a3
{
  ...
  id v23 = [(CNUINavigationListStyleApplier *)self navigationListStyle];
...
{
  id v39 = a3;
  id v4 = [(CNUINavigationListStyleApplier *)self navigationListStyle];
  v5 = [v4 cellTitleFont];
  v6 = [v39 titleLabel];
  [v6 setFont:v5];
  ...
  id v23 = [v22 actionIconFillColor];
...
- (CNUINavigationListStyleApplier)initWithNavigationListStyle:(id)a3
{
  ...
  if (v5
    && (v9.receiver = self,
        ...
        v6 = [(CNUINavigationListStyleApplier *)&v9 init],
        (self = v6) != 0))
  {
