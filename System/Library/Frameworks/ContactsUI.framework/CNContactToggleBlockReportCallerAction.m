...
{
  BOOL v3 = a3;
  v5 = [(CNContactToggleBlockReportCallerAction *)self allNumbersAndEmails];
  v7[0] = MEMORY[0x1E4F143A8];
  v7[1] = 3221225472;
  v7[2] = __60__CNContactToggleBlockReportCallerAction_setContactBlocked___block_invoke;
  v7[3] = &__block_descriptor_33_e18_v16__0__NSString_8l;
  BOOL v8 = v3;
  objc_msgSend(v5, "_cn_each:", v7);
  v6 = [NSNumber numberWithBool:v3];
  [(CNContactToggleBlockReportCallerAction *)self setIsBlockedCachedValue:v6];
}

void __60__CNContactToggleBlockReportCallerAction_setContactBlocked___block_invoke(uint64_t a1)
{
...
- (id)allNumbersAndEmails
{
  ...
  v17[1] = 3221225472;
  v17[2] = __61__CNContactToggleBlockReportCallerAction_allNumbersAndEmails__block_invoke;
  v17[3] = &unk_1E5499680;
  id v6 = v3;
  id v18 = v6;
  ...
  v14 = __61__CNContactToggleBlockReportCallerAction_allNumbersAndEmails__block_invoke_2;
  v15 = &unk_1E5499680;
  id v16 = v6;
  id v9 = v6;
...
void __61__CNContactToggleBlockReportCallerAction_allNumbersAndEmails__block_invoke(uint64_t a1, void *a2)
{
  id v4 = [a2 value];
...
void __61__CNContactToggleBlockReportCallerAction_allNumbersAndEmails__block_invoke_2(uint64_t a1, void *a2)
{
  BOOL v3 = [a2 value];
  if (v3)
  {
...
- (void)performActionWithSender:(id)a3
{
  ...
  else
  {
    ...
    BOOL v8 = [v7 localizedStringForKey:@"CARD_ACTION_BLOCK_REPORT_CONTACT_INFO_TEXT" value:&stru_1ED8AC728 table:@"Localized"];
    v5 = [v6 alertControllerWithTitle:v8 message:0 preferredStyle:0];

    [v5 setPreferredStyle:0];
    id v9 = (void *)MEMORY[0x1E4FB1410];
    v10 = CNContactsUIBundle();
    v11 = [v10 localizedStringForKey:@"CARD_ACTION_BLOCK" value:&stru_1ED8AC728 table:@"Localized"];
    v24[0] = MEMORY[0x1E4F143A8];
    v24[1] = 3221225472;
    v24[2] = __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke;
    v24[3] = &unk_1E549B590;
    v24[4] = self;
    uint64_t v12 = [v9 actionWithTitle:v11 style:2 handler:v24];
    [v5 addAction:v12];

    uint64_t v13 = (void *)MEMORY[0x1E4FB1410];
    v14 = CNContactsUIBundle();
    v15 = [v14 localizedStringForKey:@"CARD_ACTION_BLOCK_REPORT" value:&stru_1ED8AC728 table:@"Localized"];
    v23[0] = MEMORY[0x1E4F143A8];
    v23[1] = 3221225472;
    v23[2] = __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke_2;
    v23[3] = &unk_1E549B590;
    v23[4] = self;
    id v16 = [v13 actionWithTitle:v15 style:2 handler:v23];
    [v5 addAction:v16];

    v17 = (void *)MEMORY[0x1E4FB1410];
    id v18 = CNContactsUIBundle();
    v19 = [v18 localizedStringForKey:@"CANCEL" value:&stru_1ED8AC728 table:@"Localized"];
    v22[0] = MEMORY[0x1E4F143A8];
    v22[1] = 3221225472;
    v22[2] = __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke_3;
    v22[3] = &unk_1E549B590;
    v22[4] = self;
    ...
    [v21 action:self presentViewController:v5 sender:v4];
  }
}
...
void __66__CNContactToggleBlockReportCallerAction_performActionWithSender___block_invoke_2(uint64_t a1)
{
  [*(id *)(a1 + 32) setContactBlocked:1];
  id v2 = [*(id *)(a1 + 32) delegate];
  [v2 actionDidFinishFromSecondaryAction:*(void *)(a1 + 32)];
}
...
- (id)checkIsContactBlocked
{
  id v2 = [(CNContactToggleBlockReportCallerAction *)self allNumbersAndEmails];
  uint64_t v3 = objc_msgSend(v2, "_cn_any:", &__block_literal_global_39964);
...
BOOL __63__CNContactToggleBlockReportCallerAction_checkIsContactBlocked__block_invoke()
{
  uint64_t CMFItemFromString = CreateCMFItemFromString();
  if (!CMFItemFromString) {
    return 0;
...
- (BOOL)isContactBlockedPreservingChanges:(BOOL)a3
{
  ...
  char v5 = objc_msgSend(v4, "BOOLValue", v7, 3221225472, __76__CNContactToggleBlockReportCallerAction_isContactBlockedPreservingChanges___block_invoke_2, &unk_1E549B7B0, v8);
