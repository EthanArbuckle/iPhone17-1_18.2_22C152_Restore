...
LABEL_9:
    ...
    if (v14)
    {
      ...
      {
        v18 = objc_msgSend(MEMORY[0x1E4F1CB10], "_cnui_ttyRelayURLWithHandle:contact:channelIdentifier:", v12, v11, v17);
...
LABEL_8:
    ...
    v18 = objc_msgSend(MEMORY[0x1E4F1CB10], "_cnui_ttyRelayURLWithHandle:contact:", v12, v11);
    goto LABEL_8;
  }
LABEL_10:
}
