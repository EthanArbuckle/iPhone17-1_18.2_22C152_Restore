...
- (void)filterUsingPredicate:()NSPredicateSupport
{
  ...
  if (v9)
  {
    ...
    uint64_t v14 = [objc_alloc(MEMORY[0x1E4F1C978]) _initByAdoptingBuffer:v9 count:v10 size:v10];
  }
  else
  {
    uint64_t v14 = [objc_alloc(MEMORY[0x1E4F1C978]) initWithObjects:v7 count:v19[0]];
  }
  v15 = (void *)v14;
  [a1 setArray:v14];
}
