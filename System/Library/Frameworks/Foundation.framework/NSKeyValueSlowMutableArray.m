...
- (void)getObjects:(id *)a3 range:(_NSRange)a4
{
  ...
  id v7 = [(NSKeyValueSlowMutableArray *)self _nonNilArrayValueWithSelector:a2];
...
- (id)objectAtIndex:(unint64_t)a3
{
  id v4 = [(NSKeyValueSlowMutableArray *)self _nonNilArrayValueWithSelector:a2];
...
- (void)addObject:(id)a3
{
  ...
  id v8 = a3;
  v6 = (void *)_NSGetUsingKeyValueGetter((uint64_t)self->super._container, &self->_valueGetter->super.super.isa);
  if (v6)
  {
    id v7 = objc_msgSend(v6, "mutableCopy", v8, v9);
    [v7 addObject:a3];
  }
  else
  {
    ...
    id v7 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithObjects:&v8 count:1];
  }
...
- (void)insertObject:(id)a3 atIndex:(unint64_t)a4
{
  ...
  id v10 = a3;
  id v8 = (void *)_NSGetUsingKeyValueGetter((uint64_t)self->super._container, &self->_valueGetter->super.super.isa);
  if (v8)
  {
    uint64_t v9 = objc_msgSend(v8, "mutableCopy", v10, v11);
  ...
  else
  {
    ...
    uint64_t v9 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithObjects:&v10 count:1];
  }
...
LABEL_18:
  ...
  if (v9 != v10)
  {
    v14 = +[NSString stringWithFormat:@"%@: the counts of the passed-in array (%lu) and index set (%lu) must be identical.", _NSMethodExceptionProem((objc_class *)self, a2), v9, v10];
    goto LABEL_18;
  }
...
- (void)removeLastObject
{
  id v3 = [(NSKeyValueSlowMutableArray *)self _createNonNilMutableArrayValueWithSelector:a2];
  [v3 removeLastObject];
...
- (void)removeObjectAtIndex:(unint64_t)a3
{
  id v5 = [(NSKeyValueSlowMutableArray *)self _createNonNilMutableArrayValueWithSelector:a2];
...
- (void)replaceObjectAtIndex:(unint64_t)a3 withObject:(id)a4
{
  id v7 = [(NSKeyValueSlowMutableArray *)self _createNonNilMutableArrayValueWithSelector:a2];
