...
- (NSKeyValueUndefinedGetter)initWithContainerClassID:(id)a3 key:(id)a4 containerIsa:(Class)a5
{
  ...
  v12[0] = a4;
  return [(NSKeyValueAccessor *)&v11 initWithContainerClassID:a3 key:a4 implementation:Implementation selector:sel_valueForUndefinedKey_ extraArguments:v12 count:1];
}
