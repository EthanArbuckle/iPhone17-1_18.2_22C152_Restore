...
- (void)filterUsingPredicate:()NSPredicateSupport
{
  ...
  _filterObjectsUsingPredicate(objc_msgSend(a1, "array", v6), a3, (uint64_t)v8, v16);
  id v11 = objc_alloc(MEMORY[0x1E4F1CA70]);
  v12 = (void *)[v11 initWithObjects:v8 count:v16[0]];
  [a1 setOrderedSet:v12];
