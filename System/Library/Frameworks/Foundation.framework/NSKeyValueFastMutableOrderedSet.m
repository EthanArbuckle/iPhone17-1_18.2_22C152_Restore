...
- (id)_proxyInitWithContainer:(id)a3 getter:(id)a4
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)NSKeyValueFastMutableOrderedSet;
...
- (void)_proxyNonGCFinalize
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)NSKeyValueFastMutableOrderedSet;
...
- (void)insertObject:(id)a3 atIndex:(unint64_t)a4
{
  ...
  {
    v5 = (void *)[objc_alloc(MEMORY[0x1E4F1C978]) initWithObjects:&v8 count:1];
    v6 = [NSIndexSet alloc];
...
- (void)insertObjects:(id)a3 atIndexes:(id)a4
{
  ...
  {
    v4.receiver = self;
    v4.super_class = (Class)NSKeyValueFastMutableOrderedSet;
...
- (void)removeObjectAtIndex:(unint64_t)a3
{
  ...
  {
    objc_super v3 = [[NSIndexSet alloc] initWithIndex:a3];
    method_invoke();
  }
}
...
- (void)replaceObjectAtIndex:(unint64_t)a3 withObject:(id)a4
{
  ...
  {
    -[NSKeyValueFastMutableOrderedSet removeObjectAtIndex:](self, "removeObjectAtIndex:", a3, v10[0]);
