...
- (NSTransitInformationCheckingResult)initWithRange:(_NSRange)a3 components:(id)a4 underlyingResult:(void *)a5
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)NSTransitInformationCheckingResult;
...
- (NSTransitInformationCheckingResult)initWithRange:(_NSRange)a3 components:(id)a4
{
  return -[NSTransitInformationCheckingResult initWithRange:components:underlyingResult:](self, "initWithRange:components:underlyingResult:", a3.location, a3.length, a4, 0);
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)NSTransitInformationCheckingResult;
  [(NSTransitInformationCheckingResult *)&v3 dealloc];
}

- (void)encodeWithCoder:(id)a3
{
  id v5 = [(NSTransitInformationCheckingResult *)self components];
...
- (id)resultByAdjustingRangesWithOffset:(int64_t)a3
{
  unint64_t v6 = [(NSTransitInformationCheckingResult *)self range];
  NSUInteger v8 = v7;
  ...
  uint64_t v10 = objc_msgSend(objc_alloc((Class)objc_opt_class()), "initWithRange:components:underlyingResult:", v9, v7, -[NSTransitInformationCheckingResult components](self, "components"), -[NSTransitInformationCheckingResult underlyingResult](self, "underlyingResult"));
