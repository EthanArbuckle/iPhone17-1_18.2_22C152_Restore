...
+ (id)_proxyShare
{
  id result = (id)_proxyShare_proxyShare_1;
  if (!_proxyShare_proxyShare_1)
  {
    id result = _NSKeyValueProxyShareCreate();
    _proxyShare_proxyShare_1 = (uint64_t)result;
  }
  return result;
}
...
- (id)_proxyInitWithContainer:(id)a3 getter:(id)a4
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)NSKeyValueMutableSet;
...
- (void)dealloc
{
  ...
  {
    v3.receiver = self;
    v3.super_class = (Class)NSKeyValueMutableSet;
