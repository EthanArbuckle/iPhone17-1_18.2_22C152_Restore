...
{
  v0 = (__n128 *)C3DTextureSamplerCreate();
  C3DTextureSamplerTrilinearRepeatNoAnisotropy_states = (uint64_t)v0;
  ...
  v0[5].n128_u64[0] = ((unint64_t)v0[4].n128_u8[4] << 16) | 0x1000A925;
  return result;
}
