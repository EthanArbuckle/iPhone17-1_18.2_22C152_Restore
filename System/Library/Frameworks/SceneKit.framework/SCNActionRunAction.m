...
+ (id)runAction:(id)a3 onFirstChildWithName:(id)a4
{
  ...
  v6->_action = (SCNAction *)[a3 copy];
  v6->_subSpriteKey = (NSString *)[a4 copy];
...
+ (id)runAction:(id)a3 afterActionWithKey:(id)a4
{
  v6 = objc_alloc_init(SCNActionRunAction);
  v6->_action = (SCNAction *)[a3 copy];
  v6->_actionKey = (NSString *)[a4 copy];
...
- (void)updateWithTarget:(id)a3 forTime:(double)a4
{
  if (!self->_fired)
  {
    ...
    {
      v6 = objc_msgSend(a3, "childNodeWithName:recursively:", self->_subSpriteKey, 1, a4);
      if (v6) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4->_action = (SCNAction *)[(SCNAction *)self->_action copy];
  v4->_actionKey = (NSString *)[(NSString *)self->_actionKey copy];
  v4->_subSpriteKey = (NSString *)[(NSString *)self->_subSpriteKey copy];
...
- (id)reversedAction
{
  objc_super v3 = objc_alloc_init(SCNActionRunAction);
  v3->_action = [(SCNAction *)self->_action reversedAction];
  v3->_actionKey = (NSString *)[(NSString *)self->_actionKey copy];
  v3->_subSpriteKey = (NSString *)[(NSString *)self->_subSpriteKey copy];
