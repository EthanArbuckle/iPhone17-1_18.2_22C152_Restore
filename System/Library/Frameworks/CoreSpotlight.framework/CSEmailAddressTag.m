@interface CSEmailAddressTag
- (CSEmailAddressTag)initWithEmailAddress:(id)a3 synonyms:(id)a4 confidence:(double)a5;
- (void)encodeWithCSCoder:(id)a3;
@end

@implementation CSEmailAddressTag

- (void)encodeWithCSCoder:(id)a3
{
  id v8 = a3;
  [v8 beginType:"CSEmailAddressTag"];
...
{
  v6.receiver = self;
  v6.super_class = (Class)CSEmailAddressTag;
