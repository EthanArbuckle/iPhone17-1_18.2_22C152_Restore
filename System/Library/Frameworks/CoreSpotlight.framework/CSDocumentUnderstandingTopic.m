@interface CSDocumentUnderstandingTopic
- (CSDocumentUnderstandingTopic)initWithLabel:(id)a3 synonyms:(id)a4 confidence:(double)a5;
- (void)encodeWithCSCoder:(id)a3;
@end

@implementation CSDocumentUnderstandingTopic

- (void)encodeWithCSCoder:(id)a3
{
  id v8 = a3;
  [v8 beginType:"CSDocumentUnderstandingTopic"];
...
{
  v6.receiver = self;
  v6.super_class = (Class)CSDocumentUnderstandingTopic;
