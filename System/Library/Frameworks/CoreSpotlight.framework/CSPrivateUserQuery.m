@interface CSPrivateUserQuery
+ (void)preheat:(id)a3 path:(id)a4;
+ (void)prepareProtectionClasses:(id)a3 path:(id)a4;
- (id)initialConnection;
@end

@implementation CSPrivateUserQuery

+ (void)prepareProtectionClasses:(id)a3 path:(id)a4
{
  +[CSPrivateSearchQuery preheat:a3 path:a4];
...
+ (void)preheat:(id)a3 path:(id)a4
{
  ...
  {
    id v6 = a4;
    +[CSPrivateSearchQuery preheat:a3 path:v6];
  }
  else
  {
    ...
    +[CSPrivateSearchQuery preheat:path:](CSPrivateSearchQuery, "preheat:path:", v6, v8, v9, v10);
  }
  [a1 prepareLocalResources];
}
