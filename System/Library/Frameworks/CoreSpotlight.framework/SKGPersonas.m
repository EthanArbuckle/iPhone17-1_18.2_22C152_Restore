...
+ (id)labels
{
  ...
  if ((atomic_load_explicit((atomic_uchar *volatile)&qword_1000F88F8, memory_order_acquire) & 1) == 0
    && __cxa_guard_acquire(&qword_1000F88F8))
  {
    v6 = off_1000F83A8[0];
    v5 = +[NSArray arrayWithObjects:&v6 count:1];
    qword_1000F88F0 = +[NSSet setWithArray:v5];

    __cxa_guard_release(&qword_1000F88F8);
...
- (SKGPersonas)initWithPersonaNode:(id)a3 inGraph:(id)a4
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)SKGPersonas;
  v12 = [(SKGPersonas *)&v14 initWithGraph:v8 elementIdentifiers:v11];
...
- (void)enumeratePersonasInGraph:(id)a3 usingBlock:(id)a4
{
  ...
  id v10 = v7;
  id v13 = v10;
  [(SKGPersonas *)self enumerateNodesUsingBlock:v11];
}
