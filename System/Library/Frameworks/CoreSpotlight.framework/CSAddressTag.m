@interface CSAddressTag
- (CSAddressTag)initWithAddress:(id)a3 synonyms:(id)a4 confidence:(double)a5;
- (void)encodeWithCSCoder:(id)a3;
@end

@implementation CSAddressTag

- (void)encodeWithCSCoder:(id)a3
{
  id v8 = a3;
  [v8 beginType:"CSAddressTag"];
...
{
  v6.receiver = self;
  v6.super_class = (Class)CSAddressTag;
