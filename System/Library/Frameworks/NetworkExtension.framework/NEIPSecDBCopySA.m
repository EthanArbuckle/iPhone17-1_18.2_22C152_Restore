...
{
  CFDictionaryRef result = *(const __CFDictionary **)(*(void *)(a1 + 48) + 80);
  if (result)
  {
    ...
    *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = v3;
    CFDictionaryRef result = (const __CFDictionary *)NEIPSecDBCreateQueuedRequest(*(void *)(a1 + 48), 5, *(_DWORD *)(a1 + 56));
