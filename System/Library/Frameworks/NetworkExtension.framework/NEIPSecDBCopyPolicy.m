...
CFDictionaryRef __NEIPSecDBCopyPolicy_block_invoke(uint64_t a1)
{
  ...
  if (result)
  {
    ...
    *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = v3;
    CFDictionaryRef result = (const __CFDictionary *)NEIPSecDBCreateQueuedRequest(*(void *)(a1 + 48), 16, *(_DWORD *)(a1 + 56));
