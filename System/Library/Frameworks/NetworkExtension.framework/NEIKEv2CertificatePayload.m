...
LABEL_11:
  ...
  if (objc_msgSend(objc_getProperty(self, v3, 16, 1), "length"))
  {
    ...
    return [(NEIKEv2CertificatePayload *)self hasRequiredFields];
  }
  v12 = ne_log_obj();
  if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
  {
...
- (BOOL)generatePayloadData
{
  if (self)
  {
    ...
    if ([(NEIKEv2CertificatePayload *)self hasRequiredFields])
    {
...
LABEL_7:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_19DDAF000, v12, OS_LOG_TYPE_ERROR, "Certificate payload missing required fields", buf, 2u);
  }
...
- (id)description
{
  return [(NEIKEv2CertificatePayload *)self descriptionWithIndent:0 options:14];
}
