...
- (BOOL)parsePayloadData
{
  ...
  if (self && objc_getProperty(self, a2, 16, 1))
  {
    ...
    return [(NEIKEv2NoncePayload *)self hasRequiredFields];
  }
  else
  {
    v7 = ne_log_obj();
...
LABEL_5:
    ...
    if ([(NEIKEv2NoncePayload *)self hasRequiredFields])
    {
  ...
  {
    *(_WORD *)v11 = 0;
    _os_log_error_impl(&dword_19DDAF000, v10, OS_LOG_TYPE_ERROR, "NONCE payload missing required fields", v11, 2u);
  }
...
- (id)description
{
  return [(NEIKEv2NoncePayload *)self descriptionWithIndent:0 options:14];
}
...
- (id)descriptionWithIndent:(int)a3 options:(unint64_t)a4
{
  ...
  [v7 appendPrettyObject:Property withName:@"Nonce" andIndent:v5 options:a4];
