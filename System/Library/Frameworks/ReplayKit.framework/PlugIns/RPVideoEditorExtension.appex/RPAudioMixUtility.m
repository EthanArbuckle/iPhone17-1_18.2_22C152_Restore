...
LABEL_14:
  ...
  id v7 = +[NSString stringWithUTF8String:RPStringUtility_FourccToCStr()];
  if (__RPLogLevel <= 1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    int v10 = 136446722;
    id v11 = "+[RPAudioMixUtility videoCodecTypeForAVAsset:]";
    __int16 v12 = 1024;
    int v13 = 111;
    __int16 v14 = 2112;
    v15 = v7;
    _os_log_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d videoCodecType=%@", (uint8_t *)&v10, 0x1Cu);
  }
LABEL_6:
  id v8 = v7;
...
+ (id)exportPresetForAVAsset:(id)a3
{
  ...
  if (v5)
  {
    if (![v5 isEqualToString:AVVideoCodecTypeHEVC])
    {
      if ([v6 isEqualToString:AVVideoCodecTypeH264])
      {
        ...
        int v11 = 136446466;
        __int16 v12 = "+[RPAudioMixUtility exportPresetForAVAsset:]";
        __int16 v13 = 1024;
        int v14 = 124;
  ...
  else if (__RPLogLevel <= 2 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
  {
    sub_10000F2FC();
  }
LABEL_7:
