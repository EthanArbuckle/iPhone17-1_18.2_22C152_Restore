...
- (id)description
{
  ...
  uint64_t v6 = [(ILMessageFilterReportRequest *)self sender];
...
- (BOOL)isEqual:(id)a3
{
  ...
  BOOL v5 = (objc_opt_isKindOfClass() & 1) != 0
    && [(ILMessageFilterReportRequest *)self isEqualToRequest:v4];
...
{
  id v4 = a3;
  BOOL v5 = [(ILMessageFilterReportRequest *)self extensionIdentifier];
  ...
  if ([v5 isEqualToString:v6])
  {
    ...
    {
LABEL_4:
      objc_super v9 = [(ILMessageFilterReportRequest *)self messageBody];
      v10 = [v4 messageBody];
      if (v10)
      {
...
LABEL_6:
        ...
        if (v12)
        {
          ...
          {
LABEL_8:
            int64_t v13 = [(ILMessageFilterReportRequest *)self suggestedAction];
            BOOL v14 = v13 == [v4 suggestedAction];
LABEL_16:
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [v3 hash];
  BOOL v5 = [(ILMessageFilterReportRequest *)self sender];
  uint64_t v6 = [v5 hash] ^ v4;
  v7 = [(ILMessageFilterReportRequest *)self messageBody];
  uint64_t v8 = [v7 hash];
  objc_super v9 = [(ILMessageFilterReportRequest *)self receiverISOCountryCode];
  uint64_t v10 = v6 ^ v8 ^ [v9 hash];
  unint64_t v11 = v10 ^ [(ILMessageFilterReportRequest *)self suggestedAction];
...
- (ILMessageFilterReportRequest)initWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(ILMessageFilterReportRequest *)self initWithExtensionIdentifier:v7];
  if (v8)
  {
    uint64_t v9 = objc_opt_class();
    uint64_t v10 = NSStringFromSelector(sel_sender);
    uint64_t v11 = [v4 decodeObjectOfClass:v9 forKey:v10];
    sender = v8->_sender;
    v8->_sender = (NSString *)v11;

    uint64_t v13 = objc_opt_class();
    BOOL v14 = NSStringFromSelector(sel_messageBody);
...
{
  id v4 = a3;
  uint64_t v5 = [(ILMessageFilterReportRequest *)self extensionIdentifier];
  uint64_t v6 = NSStringFromSelector(sel_extensionIdentifier);
  ...
  uint64_t v9 = [(ILMessageFilterReportRequest *)self messageBody];
  uint64_t v10 = NSStringFromSelector(sel_messageBody);
  [v4 encodeObject:v9 forKey:v10];

  uint64_t v11 = [(ILMessageFilterReportRequest *)self receiverISOCountryCode];
