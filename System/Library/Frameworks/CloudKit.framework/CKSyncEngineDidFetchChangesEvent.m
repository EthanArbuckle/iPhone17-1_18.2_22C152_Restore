...
- (CKSyncEngineDidFetchChangesEvent)initWithContext:(id)a3;
...
- (CKSyncEngineDidFetchChangesEvent)initWithContext:(id)a3
{
  ...
  v23.receiver = self;
  v23.super_class = (Class)CKSyncEngineDidFetchChangesEvent;
  v8 = [(CKSyncEngineEvent *)&v23 initInternal];
  v9 = (CKSyncEngineDidFetchChangesEvent *)v8;
  if (v8) {
...
{
  v10.receiver = self;
  v10.super_class = (Class)CKSyncEngineDidFetchChangesEvent;
  id v4 = a3;
