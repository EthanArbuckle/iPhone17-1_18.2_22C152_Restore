...
- (void)setFetchRegisteredBundleIDsCompletionBlock:(id)a3;
@end
...
- (void)setFetchRegisteredBundleIDsCompletionBlock:(id)a3
{
    ...
    && !dispatch_get_specific(kCKOperationCallbackQueueName))
  {
    ...
    id fetchRegisteredBundleIDsCompletionBlock = v15;
    goto LABEL_9;
  }
  if (self->_fetchRegisteredBundleIDsCompletionBlock != v7)
  {
    v11 = objc_msgSend_copy(v7, v8, v9, v10);
    id fetchRegisteredBundleIDsCompletionBlock = self->_fetchRegisteredBundleIDsCompletionBlock;
    self->_id fetchRegisteredBundleIDsCompletionBlock = v11;
LABEL_9:
  }
}
...
- (id)fetchRegisteredBundleIDsCompletionBlock
{
  ...
  {
    v8 = _Block_copy(self->_fetchRegisteredBundleIDsCompletionBlock);
  }
...
{
  v9.receiver = self;
  v9.super_class = (Class)CKFetchRegisteredBundleIDsOperation;
  if ([(CKOperation *)&v9 hasCKOperationCallbacksSet]) {
    return 1;
  }
  uint64_t v7 = objc_msgSend_fetchRegisteredBundleIDsCompletionBlock(self, v3, v4, v5);
  BOOL v6 = v7 != 0;
...
+ (SEL)daemonInvocationSelector
{
  return sel_performFetchRegisteredBundleIDsOperation_withBlock_;
}
...
- (void)handleOperationDidCompleteWithBundleIDs:(id)a3 metrics:(id)a4 error:(id)a5
{
  ...
  v22.receiver = self;
  v22.super_class = (Class)CKFetchRegisteredBundleIDsOperation;
...
- (void)_finishOnCallbackQueueWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_18AF10000, v15, OS_SIGNPOST_EVENT, v21, "CKFetchRegisteredBundleIDsOperation", "Finishing", buf, 2u);
    }
  }
  objc_super v22 = objc_msgSend_fetchRegisteredBundleIDsCompletionBlock(self, v7, v8, v9);

  if (v22)
  {
    objc_msgSend_fetchRegisteredBundleIDsCompletionBlock(self, v23, v24, v25);
    ...
    objc_msgSend_setFetchRegisteredBundleIDsCompletionBlock_(self, v35, 0, v36);
  }
  v37.receiver = self;
  v37.super_class = (Class)CKFetchRegisteredBundleIDsOperation;
...
- (void)ckSignpostBegin
{
  ...
  if (v4)
  {
    ...
    if (v16 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v10))
    {
      ...
      __int16 v64 = 2114;
      v65 = v53;
      _os_signpost_emit_with_name_impl(&dword_18AF10000, v10, OS_SIGNPOST_INTERVAL_BEGIN, v16, "CKFetchRegisteredBundleIDsOperation", "ID=%{signpost.description:attribute}@ Container=%{signpost.description:attribute}@ GroupID=%{signpost.description:attribute}@ GroupName=%{signpost.description:attribute,public}@ Behavior=%{signpost.description:attribute,public}@ QoS=%{signpost.description:attribute,public}@ ", (uint8_t *)&v54, 0x3Eu);
    }
  }
}
...
- (void)ckSignpostEndWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v18 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v12))
    {
      int v19 = 138412290;
      id v20 = v4;
      _os_signpost_emit_with_name_impl(&dword_18AF10000, v12, OS_SIGNPOST_INTERVAL_END, v18, "CKFetchRegisteredBundleIDsOperation", "Error=%{signpost.description:attribute}@ ", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
+ (void)applyDaemonCallbackInterfaceTweaks:(id)a3
{
  ...
  v7.receiver = a1;
  v7.super_class = (Class)&OBJC_METACLASS___CKFetchRegisteredBundleIDsOperation;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong(&self->_fetchRegisteredBundleIDsCompletionBlock, 0);
}
