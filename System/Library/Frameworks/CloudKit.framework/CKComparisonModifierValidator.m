...
{
  v8.receiver = self;
  v8.super_class = (Class)CKComparisonModifierValidator;
  v4 = [(CKComparisonModifierValidator *)&v8 init];
  objc_msgSend_setModifier_(v4, v5, a3, v6);
  return v4;
}
...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  uint64_t v18 = objc_msgSend_comparisonPredicateModifier(v6, v8, v9, v10);
  uint64_t v22 = objc_msgSend_modifier(self, v19, v20, v21);
  BOOL v26 = v18 == v22;
  if (a4 && v18 != v22)
  {
    ...
    v28 = NSString;
    unint64_t v29 = objc_msgSend_comparisonPredicateModifier(v6, v23, v24, v25);
    v33 = sub_18B15C2E8(v29, v30, v31, v32);
    v36 = objc_msgSend_stringWithFormat_(v28, v34, @"Unsupported predicate modifier: %@", v35, v33);
...
{
  v4 = NSString;
  unint64_t v5 = objc_msgSend_modifier(self, a2, v2, v3);
  uint64_t v9 = sub_18B15C2E8(v5, v6, v7, v8);
  id v12 = objc_msgSend_stringWithFormat_(v4, v10, @"modifier=%@", v11, v9);
