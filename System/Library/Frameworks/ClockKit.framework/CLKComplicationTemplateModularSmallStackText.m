...
- (CLKComplicationTemplateModularSmallStackText)initWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)CLKComplicationTemplateModularSmallStackText;
...
+ (CLKComplicationTemplateModularSmallStackText)templateWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  ...
  return (CLKComplicationTemplateModularSmallStackText *)v8;
}
...
{
  char v3 = 0;
  (*((void (**)(id, __CFString *, void, void *, char *))a3 + 2))(a3, @"highlightMode", 0, &__block_literal_global_398, &v3);
}

BOOL __79__CLKComplicationTemplateModularSmallStackText__enumerateIntegerKeysWithBlock___block_invoke(uint64_t a1, unint64_t a2)
{
...
- (BOOL)highlightLine2
{
  return [(CLKComplicationTemplateModularSmallStackText *)self highlightMode] != 0;
}
...
- (id)initPrivateWithJSONObjectRepresentation:(id)a3 bundle:(id)a4
{
  id v6 = a3;
  v10.receiver = self;
  v10.super_class = (Class)CLKComplicationTemplateModularSmallStackText;
...
- (id)JSONObjectRepresentationWritingResourcesToBundlePath:(id)a3
{
  char v4 = [(CLKComplicationTemplate *)self JSONObjectRepresentationWritingResourcesToBundlePath:a3 purpose:0];
  v5 = objc_msgSend(NSNumber, "numberWithBool:", -[CLKComplicationTemplateModularSmallStackText highlightLine2](self, "highlightLine2"));
