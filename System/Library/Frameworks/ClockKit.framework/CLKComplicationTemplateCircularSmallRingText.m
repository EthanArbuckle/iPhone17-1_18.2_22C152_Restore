...
- (CLKComplicationTemplateCircularSmallRingText)initWithTextProvider:(CLKTextProvider *)textProvider fillFraction:(float)fillFraction ringStyle:(CLKComplicationRingStyle)ringStyle
{
  v8 = textProvider;
  v13.receiver = self;
  v13.super_class = (Class)CLKComplicationTemplateCircularSmallRingText;
  v9 = [(CLKComplicationTemplate *)&v13 initPrivate];
  v10 = v9;
  if (v9)
  {
    [(CLKComplicationTemplateCircularSmallRingText *)v9 setTextProvider:v8];
...
+ (CLKComplicationTemplateCircularSmallRingText)templateWithTextProvider:(CLKTextProvider *)textProvider fillFraction:(float)fillFraction ringStyle:(CLKComplicationRingStyle)ringStyle
{
  ...
  *(float *)&double v10 = fillFraction;
  ...
  return (CLKComplicationTemplateCircularSmallRingText *)v11;
}
...
{
  char v3 = 0;
  (*((void (**)(id, __CFString *, uint64_t, void *, char *))a3 + 2))(a3, @"ringStyle", 1, &__block_literal_global_844, &v3);
}

BOOL __79__CLKComplicationTemplateCircularSmallRingText__enumerateIntegerKeysWithBlock___block_invoke(uint64_t a1, unint64_t a2)
{
