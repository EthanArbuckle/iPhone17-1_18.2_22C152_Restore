...
- (CLKComplicationTemplateModularSmallSimpleText)init;
...
- (CLKComplicationTemplateModularSmallSimpleText)init
{
  return [(CLKComplicationTemplateModularSmallSimpleText *)self initWithTextProvider:0];
}
...
- (CLKComplicationTemplateModularSmallSimpleText)initWithTextProvider:(CLKTextProvider *)textProvider
{
  v4 = textProvider;
  v8.receiver = self;
  v8.super_class = (Class)CLKComplicationTemplateModularSmallSimpleText;
...
+ (CLKComplicationTemplateModularSmallSimpleText)templateWithTextProvider:(CLKTextProvider *)textProvider
{
  ...
  return (CLKComplicationTemplateModularSmallSimpleText *)v5;
}
...
{
  char v3 = 0;
  (*((void (**)(id, __CFString *, void, void *, char *))a3 + 2))(a3, @"maxDynamicFontSize", 0, &__block_literal_global_307, &v3);
}

BOOL __80__CLKComplicationTemplateModularSmallSimpleText__enumerateIntegerKeysWithBlock___block_invoke(uint64_t a1, unint64_t a2)
{
