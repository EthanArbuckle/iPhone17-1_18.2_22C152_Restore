...
- (CLKComplicationTemplateExtraLargeStackText)initWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)CLKComplicationTemplateExtraLargeStackText;
  v8 = [(CLKComplicationTemplate *)&v11 initPrivate];
  v9 = v8;
  if (v8)
  {
    [(CLKComplicationTemplateExtraLargeStackText *)v8 setLine1TextProvider:v6];
...
+ (CLKComplicationTemplateExtraLargeStackText)templateWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  ...
  return (CLKComplicationTemplateExtraLargeStackText *)v8;
}
...
{
  char v3 = 0;
  (*((void (**)(id, __CFString *, void, void *, char *))a3 + 2))(a3, @"highlightMode", 0, &__block_literal_global_966, &v3);
}

BOOL __77__CLKComplicationTemplateExtraLargeStackText__enumerateIntegerKeysWithBlock___block_invoke(uint64_t a1, unint64_t a2)
{
...
- (BOOL)highlightLine2
{
  return [(CLKComplicationTemplateExtraLargeStackText *)self highlightMode] != 0;
}
...
- (id)initPrivateWithJSONObjectRepresentation:(id)a3 bundle:(id)a4
{
  id v6 = a3;
  v10.receiver = self;
  v10.super_class = (Class)CLKComplicationTemplateExtraLargeStackText;
...
{
  v7.receiver = self;
  v7.super_class = (Class)CLKComplicationTemplateExtraLargeStackText;
  char v4 = [(CLKComplicationTemplate *)&v7 JSONObjectRepresentationWritingResourcesToBundlePath:a3 purpose:0];
  v5 = objc_msgSend(NSNumber, "numberWithBool:", -[CLKComplicationTemplateExtraLargeStackText highlightLine2](self, "highlightLine2"));
