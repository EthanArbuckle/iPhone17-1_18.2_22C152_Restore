  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v32 = v30;
      _os_log_impl(&dword_21C599000, v29, OS_LOG_TYPE_DEFAULT, "Didn't find requested localization bundle at path %@", buf, 0xCu);
    }
    id v6 = 0;
    v21 = 0;
LABEL_24:
  ...
  {
    v9 = [v6 bundlePath];
    v10 = [NSString stringWithFormat:@"%@.lproj", v8];
    v11 = [v9 stringByAppendingPathComponent:v10];

    v12 = [MEMORY[0x263F086E0] bundleWithPath:v11];
    v13 = v12;
    if (v12)
    {
      id v14 = v12;
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v33 = 2112;
        v34 = v20;
        _os_log_impl(&dword_21C599000, v18, OS_LOG_TYPE_DEFAULT, "Didn't find entry for '%@' in %@", buf, 0x16u);
      }
      v15 = 0;
    }
  }
    ...
    if (!v21)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v33 = 2112;
        v34 = v26;
        _os_log_impl(&dword_21C599000, v24, OS_LOG_TYPE_DEFAULT, "Didn't find entry for '%@' in %@", buf, 0x16u);
      }
      v21 = 0;
    }
  }
