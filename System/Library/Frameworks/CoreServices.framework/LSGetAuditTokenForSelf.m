...
void ___LSGetAuditTokenForSelf_block_invoke()
{
  ...
  task_info_outCnt = 8;
  v0 = task_info(*MEMORY[0x1E4F14960], 0xFu, _LSGetAuditTokenForSelf::sOurAuditToken, &task_info_outCnt);
  if (v0)
  {
    v1 = v0;
    v2 = _LSDefaultLog();
...
void ___LSGetAuditTokenForSelf_block_invoke_cold_1(int a1, NSObject *a2)
{
  ...
  int v2 = 134217984;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_182959000, a2, OS_LOG_TYPE_ERROR, "failed to get audit token for current process: %llx", (uint8_t *)&v2, 0xCu);
}
