...
+ (const)importantClasses
{
  if (+[VNShotflowNetworkANSTv1 importantClasses]::onceToken != -1) {
    dispatch_once(&+[VNShotflowNetworkANSTv1 importantClasses]::onceToken, &__block_literal_global_240_34355);
  }
  return (const void *)+[VNShotflowNetworkANSTv1 importantClasses]::importantClasses;
}

void __43__VNShotflowNetworkANSTv1_importantClasses__block_invoke()
{
}
