...
{
  v6.receiver = self;
  v6.super_class = (Class)VNGenerateHumanAttributesSegmentationRequestConfiguration;
...
{
  v4.receiver = self;
  v4.super_class = (Class)VNGenerateHumanAttributesSegmentationRequestConfiguration;
