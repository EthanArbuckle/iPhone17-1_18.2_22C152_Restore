...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  ...
  else
  {
    ...
    uint64_t v9 = v4;
    v7.receiver = a1;
    v7.super_class = (Class)&OBJC_METACLASS___VNRecognizeSportBallsRequest;
...
+ (id)privateRevisionsSet
{
  if (+[VNRecognizeSportBallsRequest privateRevisionsSet]::onceToken != -1) {
    dispatch_once(&+[VNRecognizeSportBallsRequest privateRevisionsSet]::onceToken, &__block_literal_global_10949);
  }
  v2 = (void *)+[VNRecognizeSportBallsRequest privateRevisionsSet]::ourPrivateRevisions;
...
void __51__VNRecognizeSportBallsRequest_privateRevisionsSet__block_invoke()
{
  ...
  uint64_t v0 = [v2 copy];
  v1 = (void *)+[VNRecognizeSportBallsRequest privateRevisionsSet]::ourPrivateRevisions;
...
+ (const)revisionAvailability
{
  return (const $1305BF644A263E76A656B24897EDB60D *)&+[VNRecognizeSportBallsRequest(Revisioning) revisionAvailability]::ourRevisionAvailability;
}
