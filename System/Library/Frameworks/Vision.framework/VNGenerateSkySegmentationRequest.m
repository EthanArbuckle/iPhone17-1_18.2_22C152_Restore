...
- (id)configuredCopyOfSelfWithBalancedQualityLevel
{
  int64_t v3 = objc_alloc_init(VNGenerateSkySegmentationRequest);
...
- (BOOL)internalPerformRevision:(unint64_t)a3 inContext:(id)a4 error:(id *)a5
{
  ...
  {
    v10 = [v8 session];
    id v11 = [(VNGenerateSkySegmentationRequest *)self newDefaultDetectorOptionsForRequestRevision:a3 session:v10];
    v21[0] = v9;
    ...
    int64_t v13 = [(VNGenerateSkySegmentationRequest *)self qualityLevel];
    if (v13)
    {
      if (v13 == 1)
      {
...
LABEL_12:
      ...
      {
        v18 = objc_msgSend(NSNumber, "numberWithInteger:", -[VNGenerateSkySegmentationRequest qualityLevel](self, "qualityLevel"));
...
{
  id v4 = a3;
  int64_t v5 = [(VNGenerateSkySegmentationRequest *)self qualityLevel];
...
- (id)newDefaultDetectorOptionsForRequestRevision:(unint64_t)a3 session:(id)a4
{
  ...
  BOOL v6 = objc_msgSend(NSNumber, "numberWithInteger:", -[VNGenerateSkySegmentationRequest qualityLevel](self, "qualityLevel"));
...
- (id)applicableDetectorTypeForRevision:(unint64_t)a3 error:(id *)a4
{
  if (a3 != 3737841664)
  {
    ...
    int64_t v6 = [(VNGenerateSkySegmentationRequest *)self qualityLevel];
    if (v6 == 1)
    {
  ...
  int64_t v7 = [(VNGenerateSkySegmentationRequest *)self qualityLevel];
  if (v7 == 1)
  {
...
LABEL_14:
  ...
  {
LABEL_16:
    v10 = objc_msgSend(NSNumber, "numberWithInteger:", -[VNGenerateSkySegmentationRequest qualityLevel](self, "qualityLevel"));
...
- (void)applyConfigurationOfRequest:(id)a3
{
  id v4 = (VNGenerateSkySegmentationRequest *)a3;
  if (self != v4)
  {
    v6.receiver = self;
...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  if (a3 == 3737841664)
  {
    id v5 = @"VNGenerateSkySegmentationRequestPrivateRevisionSemanticV6";
  }
  else
  {
    uint64_t v8 = v3;
...
+ (id)privateRevisionsSet
{
  if (+[VNGenerateSkySegmentationRequest privateRevisionsSet]::onceToken != -1) {
    dispatch_once(&+[VNGenerateSkySegmentationRequest privateRevisionsSet]::onceToken, &__block_literal_global_35598);
  }
  v2 = (void *)+[VNGenerateSkySegmentationRequest privateRevisionsSet]::privateRevisions;
...
+ (const)revisionAvailability
{
  return (const $1305BF644A263E76A656B24897EDB60D *)&+[VNGenerateSkySegmentationRequest revisionAvailability]::revisionAvailability;
}
