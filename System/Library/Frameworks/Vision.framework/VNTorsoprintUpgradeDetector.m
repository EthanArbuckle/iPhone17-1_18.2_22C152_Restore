...
+ (BOOL)isSupportedUpgradeFromPreviousEspressoprint:(id)a3 toNewLowResolutionEspressoprint:(id)a4
{
  ...
  if (+[VNTorsoprintUpgradeDetector isSupportedUpgradeFromPreviousEspressoprint:toNewLowResolutionEspressoprint:]::onceToken != -1) {
    dispatch_once(&+[VNTorsoprintUpgradeDetector isSupportedUpgradeFromPreviousEspressoprint:toNewLowResolutionEspressoprint:]::onceToken, &__block_literal_global_25562);
  }
  ...
  v8 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v5, "requestRevision"));
...
+ (id)espressoModelFileNameForConfigurationOptions:(id)a3
{
  return @"fc_md1_from_torso_v3_md2_to_v5_md2.espresso";
}
