...
- (VNClassifyCityNatureImageRequestConfiguration)initWithRequestClass:(Class)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)VNClassifyCityNatureImageRequestConfiguration;
...
{
  v4.receiver = self;
  v4.super_class = (Class)VNClassifyCityNatureImageRequestConfiguration;
