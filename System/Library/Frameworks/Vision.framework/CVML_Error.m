...
+ (id)createNSExceptionWithStatus:(int64_t)a3 andMessage:(id)a4
{
  ...
  else
  {
    ...
    v11 = [v10 localizedStringForKey:v9 value:&stru_1EF75C0C0 table:0];
    v19[0] = v11;
    ...
    v16 = [v14 localizedStringForKey:v15 value:&stru_1EF75C0C0 table:0];
...
+ (id)createNSErrorWithStatus:(int64_t)a3 andMessage:(id)a4
{
  ...
  else
  {
    ...
    v10 = [MEMORY[0x1E4F28B50] mainBundle];
    v11 = [v10 localizedStringForKey:v7 value:&stru_1EF75C0C0 table:0];

    v18[0] = v11;
    v17[1] = *MEMORY[0x1E4F28588];
    v12 = [MEMORY[0x1E4F28B50] mainBundle];
    v13 = [NSString stringWithUTF8String:CVML_getStatusDescription(a3)];
    v14 = [v12 localizedStringForKey:v13 value:&stru_1EF75C0C0 table:0];
    v18[1] = v14;
