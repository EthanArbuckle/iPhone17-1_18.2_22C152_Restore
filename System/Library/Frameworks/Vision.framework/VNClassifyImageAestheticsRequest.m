...
+ (BOOL)revision:(unint64_t)a3 mayAcceptResultsProducedByRevision:(unint64_t)a4
{
  ...
  v9.super_class = (Class)&OBJC_METACLASS___VNClassifyImageAestheticsRequest;
...
+ (id)descriptionForPrivateRevision:(unint64_t)a3
{
  ...
  {
    v5.receiver = a1;
    v5.super_class = (Class)&OBJC_METACLASS___VNClassifyImageAestheticsRequest;
    objc_msgSendSuper2(&v5, sel_descriptionForPrivateRevision_);
    v3 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v3 = off_1E5B1CA88[a3 - 3737841664u];
  }
...
+ (id)privateRevisionsSet
{
  if (+[VNClassifyImageAestheticsRequest privateRevisionsSet]::onceToken != -1) {
    dispatch_once(&+[VNClassifyImageAestheticsRequest privateRevisionsSet]::onceToken, &__block_literal_global_7391);
  }
  v2 = (void *)+[VNClassifyImageAestheticsRequest privateRevisionsSet]::ourPrivateRevisions;
...
+ (const)revisionAvailability
{
  return (const $1305BF644A263E76A656B24897EDB60D *)&+[VNClassifyImageAestheticsRequest revisionAvailability]::ourRevisionAvailability;
}
...
- (id)newDefaultDetectorOptionsForRequestRevision:(unint64_t)a3 session:(id)a4
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)VNClassifyImageAestheticsRequest;
