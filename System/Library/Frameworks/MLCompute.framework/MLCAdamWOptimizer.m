...
- (BOOL)compileForDevice:(id)a3
{
  ...
  double v7 = [(MLCAdamWOptimizer *)self optimizerDescriptor];
  ...
  int v13 = v12;
  BOOL v14 = [(MLCAdamWOptimizer *)self usesAMSGrad];
  NSUInteger v15 = [(MLCAdamWOptimizer *)self timeStep];
  LODWORD(v16) = v9;
  LODWORD(v17) = v11;
  LODWORD(v18) = v13;
...
- (NSString)description
{
  ...
  [(MLCAdamWOptimizer *)self epsilon];
  double v11 = v10;
  BOOL v12 = [(MLCAdamWOptimizer *)self usesAMSGrad];
  NSUInteger v13 = [(MLCAdamWOptimizer *)self timeStep];
  BOOL v14 = [(MLCAdamWOptimizer *)self optimizerDescriptor];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = [(MLCAdamWOptimizer *)self optimizerDescriptor];
  [(MLCAdamWOptimizer *)self beta1];
  int v7 = v6;
  [(MLCAdamWOptimizer *)self beta2];
  int v9 = v8;
