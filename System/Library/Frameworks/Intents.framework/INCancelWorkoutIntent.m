...
- (INCancelWorkoutIntent)initWithWorkoutName:(INSpeakableString *)workoutName;
...
@implementation INCancelWorkoutIntent
...
- (id)localizeValueOfSlotDescription:(id)a3 withLocalizer:(id)a4
{
  ...
  if (v9)
  {
    v10 = [(INCancelWorkoutIntent *)self workoutName];
  ...
  v15.receiver = self;
  v15.super_class = (Class)INCancelWorkoutIntent;
...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  id v6 = [(INCancelWorkoutIntent *)self _typedBackingStore];
  v5 = (void *)[v6 copy];
...
- (id)_dictionaryRepresentation
{
  ...
  id v6 = @"workoutName";
  v2 = [(INCancelWorkoutIntent *)self workoutName];
  v3 = v2;
  if (!v2)
  {
...
- (INSpeakableString)workoutName
{
  v2 = [(INCancelWorkoutIntent *)self _typedBackingStore];
  v3 = [v2 workoutName];
...
- (INCancelWorkoutIntent)initWithWorkoutName:(INSpeakableString *)workoutName
{
  id v4 = workoutName;
  v8.receiver = self;
  v8.super_class = (Class)INCancelWorkoutIntent;
  v5 = [(INIntent *)&v8 init];
  id v6 = v5;
  if (v5) {
    [(INCancelWorkoutIntent *)v5 setWorkoutName:v4];
  }
...
{
  id v4 = a3;
  id v5 = [(INCancelWorkoutIntent *)self _typedBackingStore];
