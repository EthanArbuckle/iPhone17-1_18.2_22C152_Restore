...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INStartWorkoutIntentResponseCode v2 = [(INStartWorkoutIntentResponse *)self code];
  unint64_t v3 = v2;
...
- (BOOL)_shouldForwardIntentToApp
{
  return [(INStartWorkoutIntentResponse *)self code] == INStartWorkoutIntentResponseCodeHandleInApp;
}
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INStartWorkoutIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INStartWorkoutIntentResponseCodeFailureRequiringAppLaunch"])uint64_t v4 = 4; {
  if ([v3 isEqualToString:@"INStartWorkoutIntentResponseCodeFailureOngoingWorkout"])int64_t v5 = 5;
  }
  else {
    int64_t v5 = v4;
  }
  int v6 = [v3 isEqualToString:@"INStartWorkoutIntentResponseCodeFailureNoMatchingWorkout"];
...
- (INStartWorkoutIntentResponse)initWithCode:(INStartWorkoutIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INStartWorkoutIntentResponseCodeSuccess) {
      ...
      v8 = off_1E5516748[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INStartWorkoutIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INStartWorkoutIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
...
- (id)init
{
  return [(INStartWorkoutIntentResponse *)self initWithCode:0 userActivity:0];
}
