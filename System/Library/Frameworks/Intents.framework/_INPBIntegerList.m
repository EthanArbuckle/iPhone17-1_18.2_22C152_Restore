...
- (_INPBIntegerList)initWithCoder:(id)a3;
...
@implementation _INPBIntegerList
...
- (id)dictionaryRepresentation
{
  ...
  v4 = [(_INPBIntegerList *)self conditionType];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_INPBIntegerList *)self conditionType];
  v6 = [v4 conditionType];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(_INPBIntegerList *)self conditionType];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBIntegerList *)self conditionType];
  ...
  v5 = [(_INPBIntegerList *)self dataStrings];
  v6 = [v4 dataStrings];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBIntegerList *)self dataStrings];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBIntegerList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBIntegerList allocWithZone:](_INPBIntegerList, "allocWithZone:") init];
  id v6 = [(_INPBCondition *)self->_conditionType copyWithZone:a3];
  [(_INPBIntegerList *)v5 setConditionType:v6];

  uint64_t v7 = (void *)[(NSArray *)self->_dataStrings copyWithZone:a3];
  [(_INPBIntegerList *)v5 setDataStrings:v7];
...
{
  id v4 = a3;
  id v6 = [(_INPBIntegerList *)self data];
...
- (_INPBIntegerList)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBIntegerList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBIntegerList *)self initWithData:v6];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBIntegerList *)self conditionType];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBIntegerListReadFrom(self, (uint64_t)a3);
}
...
- (void)setDataStrings:(id)a3
{
  self->_dataStrings = (NSArray *)[a3 mutableCopy];
