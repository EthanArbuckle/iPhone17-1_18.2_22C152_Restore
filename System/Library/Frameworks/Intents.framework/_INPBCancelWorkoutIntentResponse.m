...
- (id)copyWithZone:(_NSZone *)a3
{
  id v3 = +[_INPBCancelWorkoutIntentResponse allocWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBCancelWorkoutIntentResponse *)self data];
...
- (_INPBCancelWorkoutIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBCancelWorkoutIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)readFrom:(id)a3
{
  return _INPBCancelWorkoutIntentResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
