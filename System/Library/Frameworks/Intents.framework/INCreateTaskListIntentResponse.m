...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = @"code";
  INCreateTaskListIntentResponseCode v3 = [(INCreateTaskListIntentResponse *)self code];
  unint64_t v4 = v3;
  ...
  v10[1] = @"createdTaskList";
  v11[0] = v5;
  v6 = [(INCreateTaskListIntentResponse *)self createdTaskList];
  v7 = v6;
  if (!v6)
  {
...
- (INTaskList)createdTaskList
{
  ...
  INCreateTaskListIntentResponseCode v3 = [v2 createdTaskList];
  unint64_t v4 = INIntentSlotValueTransformFromTaskList(v3);
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INCreateTaskListIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INCreateTaskListIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  INCreateTaskListIntentResponseCode v2 = [(INCreateTaskListIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
- (INCreateTaskListIntentResponse)initWithCode:(INCreateTaskListIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INCreateTaskListIntentResponseCodeFailureRequiringAppLaunch) {
      ...
      id v8 = off_1E551E198[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INCreateTaskListIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INCreateTaskListIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
...
- (id)init
{
  return [(INCreateTaskListIntentResponse *)self initWithCode:0 userActivity:0];
}
