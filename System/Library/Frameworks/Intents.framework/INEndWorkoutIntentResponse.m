...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INEndWorkoutIntentResponseCode v2 = [(INEndWorkoutIntentResponse *)self code];
  unint64_t v3 = v2;
  if ((unint64_t)v2 <= INEndWorkoutIntentResponseCodeSuccess)
  {
    v4 = off_1E55174F0[v2];
  }
  else
...
- (BOOL)_shouldForwardIntentToApp
{
  return [(INEndWorkoutIntentResponse *)self code] == INEndWorkoutIntentResponseCodeHandleInApp;
}
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INEndWorkoutIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INEndWorkoutIntentResponseCodeFailureRequiringAppLaunch"])int64_t v5 = 4; {
  else
  }
    int64_t v5 = v4;
  int v6 = [v3 isEqualToString:@"INEndWorkoutIntentResponseCodeFailureNoMatchingWorkout"];
...
{
  v4.receiver = self;
  v4.super_class = (Class)INEndWorkoutIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INEndWorkoutIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INEndWorkoutIntentResponse;
...
- (INEndWorkoutIntentResponse)initWithCode:(INEndWorkoutIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  {
    if ((unint64_t)code > INEndWorkoutIntentResponseCodeSuccess) {
      v8 = 0;
    }
    else {
      v8 = off_1E55174F0[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INEndWorkoutIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INEndWorkoutIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INEndWorkoutIntentResponse;
...
- (id)init
{
  return [(INEndWorkoutIntentResponse *)self initWithCode:0 userActivity:0];
}
