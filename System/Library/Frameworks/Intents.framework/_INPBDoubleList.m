...
- (id)dictionaryRepresentation
{
  ...
  id v4 = [(_INPBDoubleList *)self conditionType];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_INPBDoubleList *)self conditionType];
  v6 = [v4 conditionType];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(_INPBDoubleList *)self conditionType];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBDoubleList *)self conditionType];
  ...
  v5 = [(_INPBDoubleList *)self dataStrings];
  v6 = [v4 dataStrings];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBDoubleList *)self dataStrings];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBDoubleList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBDoubleList allocWithZone:](_INPBDoubleList, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBDoubleList *)self data];
...
- (_INPBDoubleList)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBDoubleList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBDoubleList *)self initWithData:v6];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBDoubleList *)self conditionType];
