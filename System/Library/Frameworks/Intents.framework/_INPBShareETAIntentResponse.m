...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", -[_INPBShareETAIntentResponse mediumsCount](self, "mediumsCount"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    unint64_t v5 = [(_INPBShareETAIntentResponse *)self recipients];
    uint64_t v6 = [v4 recipients];
    v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBShareETAIntentResponse *)self recipients];
      if (!v8)
      {
...
LABEL_11:
      ...
      v9 = (void *)v8;
      uint64_t v10 = [(_INPBShareETAIntentResponse *)self recipients];
...
- (id)copyWithZone:(_NSZone *)a3
{
  unint64_t v5 = [+[_INPBShareETAIntentResponse allocWithZone:](_INPBShareETAIntentResponse, "allocWithZone:") init];
  PBRepeatedInt32Copy();
...
{
  id v4 = a3;
  id v6 = [(_INPBShareETAIntentResponse *)self data];
...
- (_INPBShareETAIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBShareETAIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)_INPBShareETAIntentResponse;
...
- (BOOL)readFrom:(id)a3
{
  return _INPBShareETAIntentResponseReadFrom(self, (uint64_t)a3);
}
