...
- (unint64_t)hash
{
  return [(_INPBDictionary *)self->_nowPlayingInfo hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBPlayMediaIntentResponse *)self nowPlayingInfo];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBPlayMediaIntentResponse allocWithZone:](_INPBPlayMediaIntentResponse, "allocWithZone:") init];
  id v6 = [(_INPBDictionary *)self->_nowPlayingInfo copyWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBPlayMediaIntentResponse *)self data];
...
- (_INPBPlayMediaIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBPlayMediaIntentResponse *)objc_claimAutoreleasedReturnValue();
...
{
  id v6 = a3;
  id v4 = [(_INPBPlayMediaIntentResponse *)self nowPlayingInfo];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBPlayMediaIntentResponseReadFrom(self, (uint64_t)a3);
}
