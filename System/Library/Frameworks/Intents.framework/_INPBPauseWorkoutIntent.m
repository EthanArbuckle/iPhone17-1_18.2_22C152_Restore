...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBPauseWorkoutIntent *)self intentMetadata];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBPauseWorkoutIntent *)self workoutName];
    if (!v12)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBPauseWorkoutIntent allocWithZone:](_INPBPauseWorkoutIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBPauseWorkoutIntent *)self data];
...
- (_INPBPauseWorkoutIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBPauseWorkoutIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v8 = a3;
  id v4 = [(_INPBPauseWorkoutIntent *)self intentMetadata];
  ...
  id v6 = [(_INPBPauseWorkoutIntent *)self workoutName];

  if (v6)
  {
    uint64_t v7 = [(_INPBPauseWorkoutIntent *)self workoutName];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _INPBPauseWorkoutIntentReadFrom(self, (uint64_t)a3);
}
