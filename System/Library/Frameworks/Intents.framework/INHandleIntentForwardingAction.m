...
- (void)executeLocallyWithIntentDeliverer:(id)a3 completionHandler:(id)a4
{
  ...
  id v8 = [(INHandleIntentForwardingAction *)self _completionHandlerWithActionCompletionHandler:v6];
...
- (BOOL)executeRemotelyWithVendorRemote:(id)a3 completionHandler:(id)a4
{
  ...
  id v7 = a4;
  v12.receiver = self;
  v12.super_class = (Class)INHandleIntentForwardingAction;
  if (![(INIntentForwardingAction *)&v12 executeRemotelyWithVendorRemote:v6 completionHandler:v7])
  {
    ...
    id v10 = [(INHandleIntentForwardingAction *)self _completionHandlerWithActionCompletionHandler:v7];
