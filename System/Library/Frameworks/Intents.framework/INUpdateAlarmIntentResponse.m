...
- (INUpdateAlarmIntentResponse)init;
...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  unint64_t v3 = [(INUpdateAlarmIntentResponse *)self code];
  unint64_t v4 = v3;
  if (v3 <= 5)
  {
    v5 = off_1E5520868[v3];
  ...
  v13[0] = v5;
  v12[1] = @"updatedAlarm";
  v6 = [(INUpdateAlarmIntentResponse *)self updatedAlarm];
  v7 = v6;
  if (!v6)
  {
  ...
  v13[1] = v7;
  v12[2] = @"conflictAlarms";
  v8 = [(INUpdateAlarmIntentResponse *)self conflictAlarms];
  v9 = v8;
  if (!v8)
  {
...
- (NSArray)conflictAlarms
{
  ...
  unint64_t v3 = [v2 conflictAlarms];
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INUpdateAlarmIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INUpdateAlarmIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  int64_t v2 = [(INUpdateAlarmIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
{
  v4.receiver = self;
  v4.super_class = (Class)INUpdateAlarmIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INUpdateAlarmIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INUpdateAlarmIntentResponse;
...
- (INUpdateAlarmIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)a3 > 5) {
      ...
      id v8 = off_1E5520868[a3];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INUpdateAlarmIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    int64_t v16 = a3;
    __int16 v17 = 2112;
    v18 = v8;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INUpdateAlarmIntentResponse;
...
- (INUpdateAlarmIntentResponse)init
{
  return [(INUpdateAlarmIntentResponse *)self initWithCode:0 userActivity:0];
}
