...
- (BOOL)readFrom:(id)a3;
- (NSArray)values;
- (_INPBCurrencyAmount)initWithCoder:(id)a3;
...
@implementation _INPBCurrencyAmount
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_INPBCurrencyAmount *)self values];
    uint64_t v6 = [v4 values];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBCurrencyAmount *)self values];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      v10 = [(_INPBCurrencyAmount *)self values];
      v11 = [v4 values];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBCurrencyAmount allocWithZone:](_INPBCurrencyAmount, "allocWithZone:") init];
  uint64_t v6 = (void *)[(NSArray *)self->_values copyWithZone:a3];
  [(_INPBCurrencyAmount *)v5 setValues:v6];
...
{
  id v4 = a3;
  id v6 = [(_INPBCurrencyAmount *)self data];
...
- (_INPBCurrencyAmount)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBCurrencyAmount *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBCurrencyAmount *)self initWithData:v6];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBCurrencyAmountReadFrom(self, (uint64_t)a3);
}
