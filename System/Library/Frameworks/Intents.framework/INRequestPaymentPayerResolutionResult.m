...
{
  v10.receiver = self;
  v10.super_class = (Class)INRequestPaymentPayerResolutionResult;
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INRequestPaymentPayerResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasRequestPaymentIntentPayerUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      uint64_t v11 = [v10 requestPaymentIntentPayerUnsupportedReason] - 1;
      if (v11 < 3) {
        uint64_t v12 = v11 + 1;
      }
      else {
...
+ (INRequestPaymentPayerResolutionResult)unsupportedForReason:(INRequestPaymentPayerUnsupportedReason)reason
{
  ...
  return (INRequestPaymentPayerResolutionResult *)v4;
}
