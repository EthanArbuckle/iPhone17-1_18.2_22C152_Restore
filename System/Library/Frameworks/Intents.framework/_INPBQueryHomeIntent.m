...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBQueryHomeIntent *)self entities];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBQueryHomeIntent *)self intentMetadata];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBQueryHomeIntent *)self intentMetadata];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBQueryHomeIntent allocWithZone:](_INPBQueryHomeIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBQueryHomeIntent *)self data];
...
- (_INPBQueryHomeIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBQueryHomeIntent *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  v10 = [(_INPBQueryHomeIntent *)self intentMetadata];

  if (v10)
  {
    int v11 = [(_INPBQueryHomeIntent *)self intentMetadata];
    PBDataWriterWriteSubmessage();
  }
}
