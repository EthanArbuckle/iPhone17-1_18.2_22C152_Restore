...
@implementation INSaveHealthSampleRecordDateResolutionResult

- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
  v10.receiver = self;
  v10.super_class = (Class)INSaveHealthSampleRecordDateResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setSaveHealthSampleIntentRecordDateUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INSaveHealthSampleRecordDateResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasSaveHealthSampleIntentRecordDateUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      uint64_t v11 = [v10 saveHealthSampleIntentRecordDateUnsupportedReason] - 1;
      if (v11 < 3) {
        uint64_t v12 = v11 + 1;
      }
      else {
