...
- (BOOL)readFrom:(id)a3;
- (NSArray)values;
- (_INPBMediaItemGroup)initWithCoder:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_INPBMediaItemGroup *)self values];
    uint64_t v6 = [v4 values];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBMediaItemGroup *)self values];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      v10 = [(_INPBMediaItemGroup *)self values];
      v11 = [v4 values];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBMediaItemGroup allocWithZone:](_INPBMediaItemGroup, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBMediaItemGroup *)self data];
...
- (_INPBMediaItemGroup)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBMediaItemGroup *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBMediaItemGroup *)self initWithData:v6];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBMediaItemGroupReadFrom(self, (uint64_t)a3);
}
