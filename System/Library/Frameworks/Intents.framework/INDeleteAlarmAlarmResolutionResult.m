...
{
  v11.receiver = self;
  v11.super_class = (Class)INDeleteAlarmAlarmResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setDeleteAlarmIntentAlarmsUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INDeleteAlarmAlarmResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasDeleteAlarmIntentAlarmsUnsupportedReason];

    if (v9)
    {
      v10 = [v6 payloadUnsupported];
      int v11 = [v10 deleteAlarmIntentAlarmsUnsupportedReason];
      if (v11) {
