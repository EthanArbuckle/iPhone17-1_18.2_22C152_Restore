...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBDataStringList *)self conditionType];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBDataStringList *)self conditionType];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBDataStringList *)self dataStrings];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBDataStringList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBDataStringList allocWithZone:](_INPBDataStringList, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBDataStringList *)self data];
...
- (_INPBDataStringList)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBDataStringList *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBDataStringList *)self conditionType];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBDataStringListReadFrom(self, (uint64_t)a3);
}
