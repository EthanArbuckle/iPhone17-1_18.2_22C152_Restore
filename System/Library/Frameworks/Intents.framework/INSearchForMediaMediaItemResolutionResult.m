...
+ (INSearchForMediaMediaItemResolutionResult)unsupportedForReason:(INSearchForMediaMediaItemUnsupportedReason)reason
{
  ...
  return (INSearchForMediaMediaItemResolutionResult *)v4;
}

+ (NSArray)successesWithResolvedMediaItems:(NSArray *)resolvedMediaItems
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___INSearchForMediaMediaItemResolutionResult;
...
{
  v10.receiver = self;
  v10.super_class = (Class)INSearchForMediaMediaItemResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setSearchForMediaIntentMediaItemsUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INSearchForMediaMediaItemResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasSearchForMediaIntentMediaItemsUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      int v11 = [v10 searchForMediaIntentMediaItemsUnsupportedReason];
      switch(v11)
      {
        case 1:
          uint64_t v12 = 1;
