...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INSetProfileInCarIntentResponseCode v2 = [(INSetProfileInCarIntentResponse *)self code];
  unint64_t v3 = v2;
...
{
  id v3 = a3;
  [v3 isEqualToString:@"INSetProfileInCarIntentResponseCodeUnspecified"];
  uint64_t v4 = [v3 isEqualToString:@"INSetProfileInCarIntentResponseCodeReady"];
  if ([v3 isEqualToString:@"INSetProfileInCarIntentResponseCodeInProgress"]) {
    uint64_t v4 = 2;
  }
  if ([v3 isEqualToString:@"INSetProfileInCarIntentResponseCodeSuccess"]) {
    uint64_t v4 = 3;
  }
  if ([v3 isEqualToString:@"INSetProfileInCarIntentResponseCodeFailure"]) {
    int64_t v5 = 4;
  }
  else {
    int64_t v5 = v4;
  }
  int v6 = [v3 isEqualToString:@"INSetProfileInCarIntentResponseCodeFailureRequiringAppLaunch"];
...
- (INSetProfileInCarIntentResponse)initWithCode:(INSetProfileInCarIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INSetProfileInCarIntentResponseCodeFailureRequiringAppLaunch) {
      ...
      v8 = off_1E5517FD0[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INSetProfileInCarIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INSetProfileInCarIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
...
- (id)init
{
  return [(INSetProfileInCarIntentResponse *)self initWithCode:0 userActivity:0];
}
