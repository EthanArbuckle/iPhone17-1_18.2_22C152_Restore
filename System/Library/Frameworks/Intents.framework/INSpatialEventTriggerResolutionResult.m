...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if ([v6 valueType] == 138)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToSpatialEventTrigger(*(void **)(*((void *)&v17 + 1) + 8 * i));
            [(_INPBIntentSlotValue *)v7 addPayloadSpatialEventTrigger:v15];
          }
    ...
    else
    {
      ...
      INIntentSlotValueTransformToSpatialEventTrigger(v5);
      id v10 = (id)objc_claimAutoreleasedReturnValue();
      if (v10) {
        [(_INPBIntentSlotValue *)v7 addPayloadSpatialEventTrigger:v10];
      }
    }
  }
LABEL_17:
