...
- (id)dictionaryRepresentation
{
  ...
  v4 = [(_INPBEndWorkoutIntent *)self intentMetadata];
  v5 = [v4 dictionaryRepresentation];
  [v3 setObject:v5 forKeyedSubscript:@"intentMetadata"];

  v6 = [(_INPBEndWorkoutIntent *)self workoutName];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_INPBEndWorkoutIntent *)self intentMetadata];
  v6 = [v4 intentMetadata];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(_INPBEndWorkoutIntent *)self intentMetadata];
  if (v7)
  {
    v8 = (void *)v7;
    v9 = [(_INPBEndWorkoutIntent *)self intentMetadata];
  ...
  v5 = [(_INPBEndWorkoutIntent *)self workoutName];
  v6 = [v4 workoutName];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBEndWorkoutIntent *)self workoutName];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    v14 = [(_INPBEndWorkoutIntent *)self workoutName];
    v15 = [v4 workoutName];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBEndWorkoutIntent allocWithZone:](_INPBEndWorkoutIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBEndWorkoutIntent *)self data];
...
- (_INPBEndWorkoutIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBEndWorkoutIntent *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBEndWorkoutIntent *)self initWithData:v6];
...
{
  id v8 = a3;
  id v4 = [(_INPBEndWorkoutIntent *)self intentMetadata];
  ...
  id v6 = [(_INPBEndWorkoutIntent *)self workoutName];

  if (v6)
  {
    uint64_t v7 = [(_INPBEndWorkoutIntent *)self workoutName];
    PBDataWriterWriteSubmessage();
  }
}
