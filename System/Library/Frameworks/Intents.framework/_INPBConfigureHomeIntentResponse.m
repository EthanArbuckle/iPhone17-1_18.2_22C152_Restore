...
- (_INPBConfigureHomeIntentResponse)initWithCoder:(id)a3
{
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBConfigureHomeIntentResponse *)self initWithData:v6];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v3 = +[_INPBConfigureHomeIntentResponse allocWithZone:a3];

  return [(_INPBConfigureHomeIntentResponse *)v3 init];
}

- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  id v6 = [(_INPBConfigureHomeIntentResponse *)self data];
  v5 = NSStringFromSelector(sel_bytes);
