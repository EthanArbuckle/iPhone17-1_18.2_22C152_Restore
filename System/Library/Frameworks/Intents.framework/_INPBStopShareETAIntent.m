...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBStopShareETAIntent *)self intentMetadata];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBStopShareETAIntent *)self intentMetadata];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBStopShareETAIntent *)self recipients];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBStopShareETAIntent *)self recipients];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBStopShareETAIntent allocWithZone:](_INPBStopShareETAIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBStopShareETAIntent *)self data];
...
- (_INPBStopShareETAIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBStopShareETAIntent *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBStopShareETAIntent *)self intentMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBStopShareETAIntentReadFrom(self, (uint64_t)a3);
}
