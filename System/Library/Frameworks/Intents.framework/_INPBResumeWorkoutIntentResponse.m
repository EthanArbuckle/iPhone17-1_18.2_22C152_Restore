...
- (id)copyWithZone:(_NSZone *)a3
{
  id v3 = +[_INPBResumeWorkoutIntentResponse allocWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBResumeWorkoutIntentResponse *)self data];
...
- (_INPBResumeWorkoutIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBResumeWorkoutIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)readFrom:(id)a3
{
  return _INPBResumeWorkoutIntentResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
