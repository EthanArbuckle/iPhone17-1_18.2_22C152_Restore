...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INStartAudioCallIntentResponseCode v2 = [(INStartAudioCallIntentResponse *)self code];
  unint64_t v3 = v2;
...
- (double)timeToEstablishCall
{
  INStartAudioCallIntentResponseCode v2 = [(INIntentResponse *)self _responseMessagePBRepresentation];
...
{
  id v3 = a3;
  [v3 isEqualToString:@"INStartAudioCallIntentResponseCodeUnspecified"];
  uint64_t v4 = [v3 isEqualToString:@"INStartAudioCallIntentResponseCodeReady"];
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeContinueInApp"]) {
    uint64_t v4 = 2;
  }
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailure"]) {
    uint64_t v4 = 3;
  }
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureRequiringAppLaunch"])uint64_t v4 = 4; {
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureAppConfigurationRequired"])uint64_t v4 = 5;
  }
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureCallingServiceNotAvailable"])uint64_t v4 = 6; {
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureContactNotSupportedByApp"])int64_t v5 = 7;
  }
  else {
    int64_t v5 = v4;
  }
  int v6 = [v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureNoValidNumber"];
...
- (INStartAudioCallIntentResponse)initWithCode:(INStartAudioCallIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INStartAudioCallIntentResponseCodeFailureNoValidNumber) {
      ...
      v8 = off_1E5518B20[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INStartAudioCallIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INStartAudioCallIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
...
- (id)init
{
  return [(INStartAudioCallIntentResponse *)self initWithCode:0 userActivity:0];
}
