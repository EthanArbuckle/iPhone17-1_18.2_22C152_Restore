...
- (BOOL)readFrom:(id)a3;
- (NSArray)values;
- (_INPBContact)initWithCoder:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_INPBContact *)self values];
    uint64_t v6 = [v4 values];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBContact *)self values];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBContact allocWithZone:](_INPBContact, "allocWithZone:") init];
  uint64_t v6 = (void *)[(NSArray *)self->_values copyWithZone:a3];
  [(_INPBContact *)v5 setValues:v6];
...
- (_INPBContact)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBContact *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBContact *)self initWithData:v6];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBContactReadFrom(self, (uint64_t)a3);
}
