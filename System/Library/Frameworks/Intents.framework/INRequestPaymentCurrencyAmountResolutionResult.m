...
- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setRequestPaymentIntentCurrencyAmountUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasRequestPaymentIntentCurrencyAmountUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      uint64_t v11 = [v10 requestPaymentIntentCurrencyAmountUnsupportedReason] - 1;
      if (v11 < 3) {
        uint64_t v12 = v11 + 1;
      }
      else {
