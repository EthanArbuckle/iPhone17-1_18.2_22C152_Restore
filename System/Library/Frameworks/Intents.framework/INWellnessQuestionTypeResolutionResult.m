...
+ (id)confirmationRequiredWithWellnessQuestionTypeToConfirm:(int64_t)a3;
+ (id)successWithResolvedWellnessQuestionType:(int64_t)a3;
...
@implementation INWellnessQuestionTypeResolutionResult
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INWellnessQuestionTypeResolutionResult *))a6;
...
+ (id)successWithResolvedWellnessQuestionType:(int64_t)a3
{
  ...
  {
    NSLog((NSString *)@"Success resolution with INWellnessQuestionTypeUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
...
+ (id)confirmationRequiredWithWellnessQuestionTypeToConfirm:(int64_t)a3
{
  if (!a3)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INWellnessQuestionTypeUnknown is not supported." userInfo:0];
  ...
  if ([v6 valueType] == 177)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadWellnessQuestionType:v9];
      }
    }
  }
