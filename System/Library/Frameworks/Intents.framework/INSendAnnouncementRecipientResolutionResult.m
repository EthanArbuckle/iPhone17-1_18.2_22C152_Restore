...
@implementation INSendAnnouncementRecipientResolutionResult

- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
  v10.receiver = self;
  v10.super_class = (Class)INSendAnnouncementRecipientResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setSendAnnouncementIntentRecipientsUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INSendAnnouncementRecipientResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasSendAnnouncementIntentRecipientsUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      uint64_t v11 = [v10 sendAnnouncementIntentRecipientsUnsupportedReason] - 1;
      if (v11 < 4) {
        uint64_t v12 = v11 + 1;
      }
      else {
