...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v6 = [(_INPBCompressFileIntent *)self entityType];
    if (v6 >= 4)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBCompressFileIntent *)self entityName];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  int v12 = [(_INPBCompressFileIntent *)self hasEntityType];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v14 = [(_INPBCompressFileIntent *)self intentMetadata];
    if (!v14)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBCompressFileIntent allocWithZone:](_INPBCompressFileIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBCompressFileIntent *)self data];
...
- (_INPBCompressFileIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBCompressFileIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v9 = a3;
  id v4 = [(_INPBCompressFileIntent *)self entityName];
  ...
  id v6 = [(_INPBCompressFileIntent *)self intentMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBCompressFileIntentReadFrom(self, (uint64_t)a3);
}
