...
@implementation INStopShareETARecipientResolutionResult

- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
  v10.receiver = self;
  v10.super_class = (Class)INStopShareETARecipientResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setStopShareETAIntentRecipientUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INStopShareETARecipientResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasStopShareETAIntentRecipientUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      unsigned int v11 = [v10 stopShareETAIntentRecipientUnsupportedReason];
      if (v11 < 5) {
        uint64_t v12 = v11 + 1;
      }
      else {
