...
- (_INPBStringList)initWithCoder:(id)a3;
...
@implementation _INPBStringList
...
- (id)dictionaryRepresentation
{
  ...
  v4 = [(_INPBStringList *)self conditionType];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_INPBStringList *)self conditionType];
  v6 = [v4 conditionType];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(_INPBStringList *)self conditionType];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBStringList *)self conditionType];
  ...
  v5 = [(_INPBStringList *)self dataStrings];
  v6 = [v4 dataStrings];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBStringList *)self dataStrings];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBStringList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBStringList allocWithZone:](_INPBStringList, "allocWithZone:") init];
  id v6 = [(_INPBCondition *)self->_conditionType copyWithZone:a3];
  [(_INPBStringList *)v5 setConditionType:v6];
...
{
  id v4 = a3;
  id v6 = [(_INPBStringList *)self data];
...
- (_INPBStringList)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBStringList *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBStringList *)self initWithData:v6];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBStringList *)self conditionType];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBStringListReadFrom(self, (uint64_t)a3);
}
