...
- (INSearchForTimersIntentResponse)init;
...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  unint64_t v3 = [(INSearchForTimersIntentResponse *)self code];
  unint64_t v4 = v3;
  if (v3 <= 5)
  {
    v5 = *(&off_1E551E7A8 + v3);
  ...
  v13[0] = v5;
  v12[1] = @"matchedTimers";
  v6 = [(INSearchForTimersIntentResponse *)self matchedTimers];
  v7 = v6;
  if (!v6)
  {
  ...
  v13[1] = v7;
  v12[2] = @"unmatchedTimers";
  v8 = [(INSearchForTimersIntentResponse *)self unmatchedTimers];
  v9 = v8;
  if (!v8)
  {
...
- (NSArray)unmatchedTimers
{
  ...
  unint64_t v3 = [v2 unmatchedTimers];
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INSearchForTimersIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INSearchForTimersIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  int64_t v2 = [(INSearchForTimersIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
{
  v4.receiver = self;
  v4.super_class = (Class)INSearchForTimersIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INSearchForTimersIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INSearchForTimersIntentResponse;
...
- (INSearchForTimersIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)a3 > 5) {
      ...
      uint64_t v8 = (uint64_t)*(&off_1E551E7A8 + a3);
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INSearchForTimersIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    int64_t v16 = a3;
    __int16 v17 = 2112;
    uint64_t v18 = v8;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INSearchForTimersIntentResponse;
...
- (INSearchForTimersIntentResponse)init
{
  return [(INSearchForTimersIntentResponse *)self initWithCode:0 userActivity:0];
}
