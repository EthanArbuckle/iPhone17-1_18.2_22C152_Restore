...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBGetCarLockStatusIntent *)self carName];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBGetCarLockStatusIntent *)self intentMetadata];
    if (!v12)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBGetCarLockStatusIntent allocWithZone:](_INPBGetCarLockStatusIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBGetCarLockStatusIntent *)self data];
...
- (_INPBGetCarLockStatusIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBGetCarLockStatusIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v8 = a3;
  id v4 = [(_INPBGetCarLockStatusIntent *)self carName];
  ...
  id v6 = [(_INPBGetCarLockStatusIntent *)self intentMetadata];

  if (v6)
  {
    uint64_t v7 = [(_INPBGetCarLockStatusIntent *)self intentMetadata];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _INPBGetCarLockStatusIntentReadFrom(self, (uint64_t)a3);
}
