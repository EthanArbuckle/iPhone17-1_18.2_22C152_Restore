...
- (unint64_t)hash
{
  return [(NSArray *)self->_events hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_INPBFindEventsIntentResponse *)self events];
    uint64_t v6 = [v4 events];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBFindEventsIntentResponse *)self events];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      v10 = [(_INPBFindEventsIntentResponse *)self events];
      v11 = [v4 events];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBFindEventsIntentResponse allocWithZone:](_INPBFindEventsIntentResponse, "allocWithZone:") init];
  uint64_t v6 = (void *)[(NSArray *)self->_events copyWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBFindEventsIntentResponse *)self data];
...
- (_INPBFindEventsIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBFindEventsIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBFindEventsIntentResponse *)self initWithData:v6];
