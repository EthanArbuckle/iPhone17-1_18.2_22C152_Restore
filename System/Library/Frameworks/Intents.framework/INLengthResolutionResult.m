...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if ([v6 valueType] == 19)
  {
        ...
        if (v9)
        {
          ...
          do
          {
            for (uint64_t i = 0; i != v10; ++i)
            {
              ...
              v13 = INIntentSlotValueTransformToDistanceValue(*(void **)(*((void *)&v31 + 1) + 8 * i));
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
LABEL_25:
        INIntentSlotValueTransformToDistanceValue(v5);
        ...
        if (v17)
        {
          ...
          do
          {
            for (uint64_t j = 0; j != v18; ++j)
            {
              ...
              uint64_t v21 = INIntentSlotValueTransformToDistance(*(void **)(*((void *)&v27 + 1) + 8 * j));
              -[_INPBDistanceList addDistance:](v15, "addDistance:", v21, (void)v27);
            }
