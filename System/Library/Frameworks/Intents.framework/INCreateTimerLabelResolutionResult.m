...
{
  v9.receiver = self;
  v9.super_class = (Class)INCreateTimerLabelResolutionResult;
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v12.receiver = self;
  v12.super_class = (Class)INCreateTimerLabelResolutionResult;
  id v7 = [(INIntentResolutionResult *)&v12 _initWithIntentSlotResolutionResult:v6 slotDescription:a4];
  if (v7)
  {
    v8 = [v6 payloadUnsupported];
    int v9 = [v8 hasCreateTimerIntentLabelUnsupportedReason];

    if (v9)
    {
      v10 = [v6 payloadUnsupported];
      objc_msgSend(v7, "setUnsupportedReason:", objc_msgSend(v10, "createTimerIntentLabelUnsupportedReason") == 0);
    }
  }
