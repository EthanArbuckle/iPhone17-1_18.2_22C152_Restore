...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = @"code";
  INSnoozeTasksIntentResponseCode v3 = [(INSnoozeTasksIntentResponse *)self code];
  unint64_t v4 = v3;
  ...
  v10[1] = @"snoozedTasks";
  v11[0] = v5;
  v6 = [(INSnoozeTasksIntentResponse *)self snoozedTasks];
  v7 = v6;
  if (!v6)
  {
...
- (NSArray)snoozedTasks
{
  ...
  INSnoozeTasksIntentResponseCode v3 = [v2 snoozedTasks];
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INSnoozeTasksIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INSnoozeTasksIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  INSnoozeTasksIntentResponseCode v2 = [(INSnoozeTasksIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
- (INSnoozeTasksIntentResponse)initWithCode:(INSnoozeTasksIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INSnoozeTasksIntentResponseCodeFailureRequiringAppLaunch) {
      ...
      id v8 = off_1E551F7F0[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INSnoozeTasksIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INSnoozeTasksIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
...
- (id)init
{
  return [(INSnoozeTasksIntentResponse *)self initWithCode:0 userActivity:0];
}
