...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INResumeWorkoutIntentResponseCode v2 = [(INResumeWorkoutIntentResponse *)self code];
  unint64_t v3 = v2;
...
- (BOOL)_shouldForwardIntentToApp
{
  return [(INResumeWorkoutIntentResponse *)self code] == INResumeWorkoutIntentResponseCodeHandleInApp;
}
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INResumeWorkoutIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INResumeWorkoutIntentResponseCodeFailureRequiringAppLaunch"])int64_t v5 = 4; {
  else
  }
    int64_t v5 = v4;
  int v6 = [v3 isEqualToString:@"INResumeWorkoutIntentResponseCodeFailureNoMatchingWorkout"];
...
- (INResumeWorkoutIntentResponse)initWithCode:(INResumeWorkoutIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)code > INResumeWorkoutIntentResponseCodeSuccess) {
      ...
      v8 = off_1E5517690[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INResumeWorkoutIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INResumeWorkoutIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
...
- (id)init
{
  return [(INResumeWorkoutIntentResponse *)self initWithCode:0 userActivity:0];
}
