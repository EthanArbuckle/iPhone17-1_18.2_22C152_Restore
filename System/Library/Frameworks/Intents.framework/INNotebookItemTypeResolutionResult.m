...
+ (INNotebookItemTypeResolutionResult)confirmationRequiredWithNotebookItemTypeToConfirm:(INNotebookItemType)notebookItemTypeToConfirm;
+ (INNotebookItemTypeResolutionResult)successWithResolvedNotebookItemType:(INNotebookItemType)resolvedNotebookItemType;
  ...
  if ([v6 valueType] == 129)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadNotebookItemType:v9];
      }
    }
  }
...
+ (INNotebookItemTypeResolutionResult)confirmationRequiredWithNotebookItemTypeToConfirm:(INNotebookItemType)notebookItemTypeToConfirm
{
  if (notebookItemTypeToConfirm == INNotebookItemTypeUnknown)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INNotebookItemTypeUnknown is not supported." userInfo:0];
    objc_exception_throw(v7);
  }
  v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  id v5 = [a1 resolutionResultConfirmationRequiredWithItemToConfirm:v4];

  return (INNotebookItemTypeResolutionResult *)v5;
}

+ (INNotebookItemTypeResolutionResult)successWithResolvedNotebookItemType:(INNotebookItemType)resolvedNotebookItemType
{
  if (resolvedNotebookItemType)
  {
    v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  ...
  {
    NSLog((NSString *)@"Success resolution with INNotebookItemTypeUnknown will be reformed to notRequired.", a2);
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INNotebookItemTypeResolutionResult *))a6;
