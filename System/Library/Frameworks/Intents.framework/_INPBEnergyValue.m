...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v6 = [(_INPBEnergyValue *)self unit];
    if (v6 >= 6)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v5 = [(_INPBEnergyValue *)self hasMagnitude];
    if (v5 == [v4 hasMagnitude])
    {
      ...
      {
        int v8 = [(_INPBEnergyValue *)self hasUnit];
        if (v8 == [v4 hasUnit])
        {
          if (![(_INPBEnergyValue *)self hasUnit]
            || ![v4 hasUnit]
            || (int unit = self->_unit, unit == [v4 unit]))
          {
            ...
            if ((v10 == 0) != (v11 != 0))
            {
              uint64_t v13 = [(_INPBEnergyValue *)self valueMetadata];
              if (!v13)
              {
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v5 = [+[_INPBEnergyValue allocWithZone:](_INPBEnergyValue, "allocWithZone:") init];
  if ([(_INPBEnergyValue *)self hasMagnitude])
  {
    [(_INPBEnergyValue *)self magnitude];
    -[_INPBEnergyValue setMagnitude:](v5, "setMagnitude:");
  }
  if ([(_INPBEnergyValue *)self hasUnit]) {
...
{
  id v4 = a3;
  id v6 = [(_INPBEnergyValue *)self data];
...
- (_INPBEnergyValue)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBEnergyValue *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(_INPBEnergyValue *)self valueMetadata];

  int v5 = v7;
  if (v4)
  {
    id v6 = [(_INPBEnergyValue *)self valueMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBEnergyValueReadFrom(self, (uint64_t)a3);
}
