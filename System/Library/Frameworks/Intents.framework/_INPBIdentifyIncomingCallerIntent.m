...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBIdentifyIncomingCallerIntent *)self intentMetadata];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBIdentifyIncomingCallerIntent allocWithZone:](_INPBIdentifyIncomingCallerIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBIdentifyIncomingCallerIntent *)self data];
...
- (_INPBIdentifyIncomingCallerIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBIdentifyIncomingCallerIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v6 = a3;
  id v4 = [(_INPBIdentifyIncomingCallerIntent *)self intentMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBIdentifyIncomingCallerIntentReadFrom(self, (uint64_t)a3);
}
