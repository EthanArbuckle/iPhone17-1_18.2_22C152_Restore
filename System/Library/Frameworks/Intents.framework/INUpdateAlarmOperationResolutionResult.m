...
@implementation INUpdateAlarmOperationResolutionResult

+ (id)confirmationRequiredWithUpdateAlarmOperationToConfirm:(int64_t)a3
{
  if (!a3)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INUpdateAlarmOperationUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedUpdateAlarmOperation:(int64_t)a3
{
  ...
  {
    NSLog((NSString *)@"Success resolution with INUpdateAlarmOperationUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INUpdateAlarmOperationResolutionResult *))a6;
  ...
  if ([v6 valueType] == 183)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadUpdateAlarmOperation:v10];
      }
    }
  }
