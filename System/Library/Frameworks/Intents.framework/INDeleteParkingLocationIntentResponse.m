...
- (INDeleteParkingLocationIntentResponse)init;
...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  unint64_t v3 = [(INDeleteParkingLocationIntentResponse *)self code];
  unint64_t v4 = v3;
  if (v3 <= 5)
  {
    v5 = off_1E5520490[v3];
  ...
  v6 = [(INDeleteParkingLocationIntentResponse *)self parkingLocation];
  v7 = v6;
  if (!v6)
  {
  ...
  v13[1] = v7;
  v12[2] = @"parkingNote";
  v8 = [(INDeleteParkingLocationIntentResponse *)self parkingNote];
  v9 = v8;
  if (!v8)
  {
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INDeleteParkingLocationIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INDeleteParkingLocationIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  int64_t v2 = [(INDeleteParkingLocationIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
{
  v4.receiver = self;
  v4.super_class = (Class)INDeleteParkingLocationIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INDeleteParkingLocationIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INDeleteParkingLocationIntentResponse;
...
- (INDeleteParkingLocationIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)a3 > 5) {
      ...
      id v8 = off_1E5520490[a3];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INDeleteParkingLocationIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    int64_t v16 = a3;
    __int16 v17 = 2112;
    v18 = v8;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INDeleteParkingLocationIntentResponse;
...
- (INDeleteParkingLocationIntentResponse)init
{
  return [(INDeleteParkingLocationIntentResponse *)self initWithCode:0 userActivity:0];
}
