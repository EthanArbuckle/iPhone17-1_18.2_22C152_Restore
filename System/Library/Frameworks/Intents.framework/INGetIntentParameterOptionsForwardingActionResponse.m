...
- (NSData)archivedObjectCollection
{
  return self->_archivedObjectCollection;
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)INGetIntentParameterOptionsForwardingActionResponse;
  id v4 = a3;
  [(INIntentForwardingActionResponse *)&v5 encodeWithCoder:v4];
  objc_msgSend(v4, "encodeObject:forKey:", self->_archivedObjectCollection, @"archivedObjectCollection", v5.receiver, v5.super_class);
}
...
- (INGetIntentParameterOptionsForwardingActionResponse)initWithArchivedObjectCollection:(id)a3 error:(id)a4
{
  id v7 = a3;
  v11.receiver = self;
  v11.super_class = (Class)INGetIntentParameterOptionsForwardingActionResponse;
  uint64_t v8 = [(INIntentForwardingActionResponse *)&v11 initWithError:a4];
  uint64_t v9 = v8;
  if (v8) {
    objc_storeStrong((id *)&v8->_archivedObjectCollection, a3);
  }
