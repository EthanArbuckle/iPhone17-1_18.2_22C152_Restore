...
@implementation INSnoozeAlarmAlarmResolutionResult

- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
  v11.receiver = self;
  v11.super_class = (Class)INSnoozeAlarmAlarmResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setSnoozeAlarmIntentAlarmsUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INSnoozeAlarmAlarmResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasSnoozeAlarmIntentAlarmsUnsupportedReason];

    if (v9)
    {
      v10 = [v6 payloadUnsupported];
      int v11 = [v10 snoozeAlarmIntentAlarmsUnsupportedReason];
      if (v11) {
