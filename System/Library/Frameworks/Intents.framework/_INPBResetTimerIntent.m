...
- (void)setHasResetMultiple:(BOOL)a3;
- (void)setIntentMetadata:(id)a3;
- (void)setResetMultiple:(BOOL)a3;
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = objc_msgSend(NSNumber, "numberWithBool:", -[_INPBResetTimerIntent resetMultiple](self, "resetMultiple"));
...
- (unint64_t)hash
{
  ...
  if ([(_INPBResetTimerIntent *)self hasResetMultiple]) {
    uint64_t v4 = 2654435761 * self->_resetMultiple;
  }
  else {
    uint64_t v4 = 0;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBResetTimerIntent *)self intentMetadata];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  int v12 = [(_INPBResetTimerIntent *)self hasResetMultiple];
  ...
  if ([(_INPBResetTimerIntent *)self hasResetMultiple])
  {
    ...
    {
      int resetMultiple = self->_resetMultiple;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v14 = [(_INPBResetTimerIntent *)self targetTimer];
    if (!v14)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBResetTimerIntent allocWithZone:](_INPBResetTimerIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBResetTimerIntent *)self data];
...
- (_INPBResetTimerIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBResetTimerIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v9 = a3;
  id v4 = [(_INPBResetTimerIntent *)self intentMetadata];
  ...
  id v6 = [(_INPBResetTimerIntent *)self targetTimer];

  uint64_t v7 = v9;
  if (v6)
  {
    v8 = [(_INPBResetTimerIntent *)self targetTimer];
    PBDataWriterWriteSubmessage();
...
- (BOOL)readFrom:(id)a3
{
  return _INPBResetTimerIntentReadFrom(self, (uint64_t)a3);
}
