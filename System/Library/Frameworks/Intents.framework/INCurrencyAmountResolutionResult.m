...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  id v6 = a4;
  v7 = [v5 description];
  if ([v6 valueType] == 53 && objc_msgSend(v6, "valueStyle") != 3)
  {
    objc_opt_class();
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if ([v6 valueType] == 53)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToCurrencyAmount(*(void **)(*((void *)&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      INIntentSlotValueTransformToCurrencyAmount(v5);
