...
- (INFindEventsIntentResponse)init;
...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = @"code";
  unint64_t v3 = [(INFindEventsIntentResponse *)self code];
  unint64_t v4 = v3;
  if (v3 <= 5)
  {
    v5 = *(&off_1E551FC18 + v3);
  ...
  v10[1] = @"events";
  v11[0] = v5;
  v6 = [(INFindEventsIntentResponse *)self events];
  v7 = v6;
  if (!v6)
  {
...
- (NSArray)events
{
  ...
  unint64_t v3 = [v2 events];
  id v4 = INIntentSlotValueTransformFromCalendarEvents(v3);
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INFindEventsIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INFindEventsIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  int64_t v2 = [(INFindEventsIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
{
  v4.receiver = self;
  v4.super_class = (Class)INFindEventsIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INFindEventsIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INFindEventsIntentResponse;
...
- (INFindEventsIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)a3 > 5) {
      ...
      uint64_t v8 = (uint64_t)*(&off_1E551FC18 + a3);
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INFindEventsIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    int64_t v16 = a3;
    __int16 v17 = 2112;
    uint64_t v18 = v8;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INFindEventsIntentResponse;
...
- (INFindEventsIntentResponse)init
{
  return [(INFindEventsIntentResponse *)self initWithCode:0 userActivity:0];
}
