...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INSaveProfileInCarIntentResponseCode v2 = [(INSaveProfileInCarIntentResponse *)self code];
  unint64_t v3 = v2;
  if ((unint64_t)v2 <= INSaveProfileInCarIntentResponseCodeFailureRequiringAppLaunch)
  {
    v4 = off_1E551C0E8[v2];
  }
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INSaveProfileInCarIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INSaveProfileInCarIntentResponseCodeFailureRequiringAppLaunch"];
...
{
  v4.receiver = self;
  v4.super_class = (Class)INSaveProfileInCarIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INSaveProfileInCarIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INSaveProfileInCarIntentResponse;
...
- (INSaveProfileInCarIntentResponse)initWithCode:(INSaveProfileInCarIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  {
    if ((unint64_t)code > INSaveProfileInCarIntentResponseCodeFailureRequiringAppLaunch) {
      v8 = 0;
    }
    else {
      v8 = off_1E551C0E8[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INSaveProfileInCarIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INSaveProfileInCarIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INSaveProfileInCarIntentResponse;
...
- (id)init
{
  return [(INSaveProfileInCarIntentResponse *)self initWithCode:0 userActivity:0];
}
