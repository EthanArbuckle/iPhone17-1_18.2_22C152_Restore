...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v6 = [(_INPBMassValue *)self unit];
    if (v6 >= 0x11)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v5 = [(_INPBMassValue *)self hasMagnitude];
    if (v5 == [v4 hasMagnitude])
    {
      ...
      {
        int v8 = [(_INPBMassValue *)self hasUnit];
        if (v8 == [v4 hasUnit])
        {
          if (![(_INPBMassValue *)self hasUnit]
            || ![v4 hasUnit]
            || (int unit = self->_unit, unit == [v4 unit]))
          {
            ...
            if ((v10 == 0) != (v11 != 0))
            {
              uint64_t v13 = [(_INPBMassValue *)self valueMetadata];
              if (!v13)
              {
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v5 = [+[_INPBMassValue allocWithZone:](_INPBMassValue, "allocWithZone:") init];
  if ([(_INPBMassValue *)self hasMagnitude])
  {
    [(_INPBMassValue *)self magnitude];
    -[_INPBMassValue setMagnitude:](v5, "setMagnitude:");
  }
  if ([(_INPBMassValue *)self hasUnit]) {
...
{
  id v4 = a3;
  id v6 = [(_INPBMassValue *)self data];
...
- (_INPBMassValue)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBMassValue *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(_INPBMassValue *)self valueMetadata];

  int v5 = v7;
  if (v4)
  {
    id v6 = [(_INPBMassValue *)self valueMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBMassValueReadFrom(self, (uint64_t)a3);
}
