...
@implementation INContactEventTriggerResolutionResult
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if ([v6 valueType] == 139)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToContactEventTrigger(*(void **)(*((void *)&v17 + 1) + 8 * i));
    ...
    else
    {
      ...
      INIntentSlotValueTransformToContactEventTrigger(v5);
      id v10 = (id)objc_claimAutoreleasedReturnValue();
      if (v10) {
        [(_INPBIntentSlotValue *)v7 addPayloadContactEventTrigger:v10];
      }
    }
  }
LABEL_17:
