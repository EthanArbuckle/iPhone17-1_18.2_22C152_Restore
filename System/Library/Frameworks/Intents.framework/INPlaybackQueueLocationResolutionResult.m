...
+ (INPlaybackQueueLocationResolutionResult)confirmationRequiredWithPlaybackQueueLocationToConfirm:(INPlaybackQueueLocation)playbackQueueLocationToConfirm;
+ (INPlaybackQueueLocationResolutionResult)successWithResolvedPlaybackQueueLocation:(INPlaybackQueueLocation)resolvedPlaybackQueueLocation;
  ...
  if ([v6 valueType] == 156)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadPlaybackQueueLocation:v9];
      }
    }
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INPlaybackQueueLocationResolutionResult *))a6;
...
+ (INPlaybackQueueLocationResolutionResult)confirmationRequiredWithPlaybackQueueLocationToConfirm:(INPlaybackQueueLocation)playbackQueueLocationToConfirm
{
  if (playbackQueueLocationToConfirm == INPlaybackQueueLocationUnknown)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INPlaybackQueueLocationUnknown is not supported." userInfo:0];
    objc_exception_throw(v7);
  }
  v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  id v5 = [a1 resolutionResultConfirmationRequiredWithItemToConfirm:v4];

  return (INPlaybackQueueLocationResolutionResult *)v5;
}

+ (INPlaybackQueueLocationResolutionResult)successWithResolvedPlaybackQueueLocation:(INPlaybackQueueLocation)resolvedPlaybackQueueLocation
{
  if (resolvedPlaybackQueueLocation)
  {
    v4 = objc_msgSend(NSNumber, "numberWithInteger:");
    id v5 = [a1 resolutionResultSuccessWithResolvedValue:v4];
  }
  else
  {
    NSLog((NSString *)@"Success resolution with INPlaybackQueueLocationUnknown will be reformed to notRequired.", a2);
    id v5 = [a1 notRequired];
  }
