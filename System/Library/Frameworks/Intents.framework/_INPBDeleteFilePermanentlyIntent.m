...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBDeleteFilePermanentlyIntent *)self intentMetadata];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBDeleteFilePermanentlyIntent allocWithZone:](_INPBDeleteFilePermanentlyIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBDeleteFilePermanentlyIntent *)self data];
...
- (_INPBDeleteFilePermanentlyIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBDeleteFilePermanentlyIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v6 = a3;
  id v4 = [(_INPBDeleteFilePermanentlyIntent *)self intentMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBDeleteFilePermanentlyIntentReadFrom(self, (uint64_t)a3);
}
