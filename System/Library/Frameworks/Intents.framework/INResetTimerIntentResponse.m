...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = @"code";
  unint64_t v3 = [(INResetTimerIntentResponse *)self code];
  unint64_t v4 = v3;
  if (v3 <= 7)
  {
    v5 = *(&off_1E551E640 + v3);
  ...
  v10[1] = @"resetTimers";
  v11[0] = v5;
  v6 = [(INResetTimerIntentResponse *)self resetTimers];
  v7 = v6;
  if (!v6)
  {
...
{
  id v3 = a3;
  [v3 isEqualToString:@"INResetTimerIntentResponseCodeUnspecified"];
  uint64_t v4 = [v3 isEqualToString:@"INResetTimerIntentResponseCodeReady"];
  if ([v3 isEqualToString:@"INResetTimerIntentResponseCodeInProgress"]) {
    uint64_t v4 = 2;
  }
  if ([v3 isEqualToString:@"INResetTimerIntentResponseCodeSuccess"]) {
    uint64_t v4 = 3;
  }
  if ([v3 isEqualToString:@"INResetTimerIntentResponseCodeFailure"]) {
    uint64_t v4 = 4;
  }
  if ([v3 isEqualToString:@"INResetTimerIntentResponseCodeFailureRequiringAppLaunch"])uint64_t v4 = 5; {
  if ([v3 isEqualToString:@"INResetTimerIntentResponseCodeFailureNotFound"])
  }
    int64_t v5 = 6;
  else {
    int64_t v5 = v4;
  }
  int v6 = [v3 isEqualToString:@"INResetTimerIntentResponseCodeFailureNoTimers"];
...
- (int64_t)_intentResponseCode
{
  int64_t v2 = [(INResetTimerIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 6) {
    return 0;
  }
  else {
...
- (INResetTimerIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  if (os_log_type_enabled((os_log_t)INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    if ((unint64_t)a3 > 7) {
      ...
      uint64_t v8 = (uint64_t)*(&off_1E551E640 + a3);
    }
...
- (INResetTimerIntentResponse)init
{
  return [(INResetTimerIntentResponse *)self initWithCode:0 userActivity:0];
}
