...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBAirport *)self iataCode];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v12 = [(_INPBAirport *)self icaoCode];
  if (v12)
  {
    v13 = (void *)v12;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(_INPBAirport *)self name];
    if (!v17)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBAirport allocWithZone:](_INPBAirport, "allocWithZone:") init];
...
- (_INPBAirport)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBAirport *)objc_claimAutoreleasedReturnValue();
...
{
  id v8 = a3;
  id v4 = [(_INPBAirport *)self iataCode];
