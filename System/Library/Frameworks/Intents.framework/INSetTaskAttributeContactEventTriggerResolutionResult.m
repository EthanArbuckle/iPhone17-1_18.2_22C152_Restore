...
@implementation INSetTaskAttributeContactEventTriggerResolutionResult

- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)a3
{
  v11.receiver = self;
  v11.super_class = (Class)INSetTaskAttributeContactEventTriggerResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [v6 setSetTaskAttributeIntentContactEventTriggerUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INSetTaskAttributeContactEventTriggerResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasSetTaskAttributeIntentContactEventTriggerUnsupportedReason];

    if (v9)
    {
      v10 = [v6 payloadUnsupported];
      int v11 = [v10 setTaskAttributeIntentContactEventTriggerUnsupportedReason];
      if (v11 == 1) {
        uint64_t v12 = 1;
      }
      else {
