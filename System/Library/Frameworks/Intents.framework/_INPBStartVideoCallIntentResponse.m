...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v4 = [(_INPBStartVideoCallIntentResponse *)self audioRoute];
    if ((v4 - 2) >= 3)
    {
    ...
    {
      v5 = off_1E55187A0[(v4 - 2)];
    }
    [v3 setObject:v5 forKeyedSubscript:@"audioRoute"];
  }
  v6 = [(_INPBStartVideoCallIntentResponse *)self metrics];
  v7 = [v6 dictionaryRepresentation];
  [v3 setObject:v7 forKeyedSubscript:@"metrics"];

  if (self->_status)
  {
    v8 = [(_INPBStartVideoCallIntentResponse *)self status];
    v9 = (void *)[v8 copy];
    [v3 setObject:v9 forKeyedSubscript:@"status"];
  }
  if (self->_targetContacts)
  {
    v10 = [(_INPBStartVideoCallIntentResponse *)self targetContacts];
    v11 = (void *)[v10 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  int v5 = [(_INPBStartVideoCallIntentResponse *)self hasAudioRoute];
  ...
  v7 = [(_INPBStartVideoCallIntentResponse *)self metrics];
  v8 = [v4 metrics];
  if ((v7 == 0) == (v8 != 0)) {
    goto LABEL_20;
  }
  uint64_t v9 = [(_INPBStartVideoCallIntentResponse *)self metrics];
  if (v9)
  {
    v10 = (void *)v9;
    v11 = [(_INPBStartVideoCallIntentResponse *)self metrics];
    v12 = [v4 metrics];
  ...
  v7 = [(_INPBStartVideoCallIntentResponse *)self status];
  v8 = [v4 status];
  if ((v7 == 0) == (v8 != 0)) {
    goto LABEL_20;
  }
  uint64_t v14 = [(_INPBStartVideoCallIntentResponse *)self status];
  if (v14)
  {
    v15 = (void *)v14;
    v16 = [(_INPBStartVideoCallIntentResponse *)self status];
    v17 = [v4 status];
  ...
  v7 = [(_INPBStartVideoCallIntentResponse *)self targetContacts];
  v8 = [v4 targetContacts];
  if ((v7 == 0) != (v8 != 0))
  {
    uint64_t v19 = [(_INPBStartVideoCallIntentResponse *)self targetContacts];
    if (!v19)
    {
...
LABEL_24:
    ...
    v20 = (void *)v19;
    v21 = [(_INPBStartVideoCallIntentResponse *)self targetContacts];
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v5 = [+[_INPBStartVideoCallIntentResponse allocWithZone:](_INPBStartVideoCallIntentResponse, "allocWithZone:") init];
  if ([(_INPBStartVideoCallIntentResponse *)self hasAudioRoute]) {
...
{
  id v4 = a3;
  id v6 = [(_INPBStartVideoCallIntentResponse *)self data];
...
- (_INPBStartVideoCallIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBStartVideoCallIntentResponse *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBStartVideoCallIntentResponse *)self initWithData:v6];
...
- (void)writeTo:(id)a3
{
  ...
  int v5 = [(_INPBStartVideoCallIntentResponse *)self metrics];

  if (v5)
  {
    id v6 = [(_INPBStartVideoCallIntentResponse *)self metrics];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v7 = [(_INPBStartVideoCallIntentResponse *)self status];
