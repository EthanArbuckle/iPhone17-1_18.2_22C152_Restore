...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBRequestRideIntentResponse *)self rideStatus];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBRequestRideIntentResponse allocWithZone:](_INPBRequestRideIntentResponse, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBRequestRideIntentResponse *)self data];
...
- (_INPBRequestRideIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBRequestRideIntentResponse *)objc_claimAutoreleasedReturnValue();
...
{
  id v6 = a3;
  id v4 = [(_INPBRequestRideIntentResponse *)self rideStatus];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBRequestRideIntentResponseReadFrom(self, (uint64_t)a3);
}
