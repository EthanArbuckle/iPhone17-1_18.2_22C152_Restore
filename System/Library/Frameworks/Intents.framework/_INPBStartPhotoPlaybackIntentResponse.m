...
- (id)dictionaryRepresentation
{
  ...
  {
    v8 = objc_msgSend(NSNumber, "numberWithInt:", -[_INPBStartPhotoPlaybackIntentResponse searchResultsCount](self, "searchResultsCount"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(_INPBStartPhotoPlaybackIntentResponse *)self albumName];
  v6 = [v4 albumName];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(_INPBStartPhotoPlaybackIntentResponse *)self albumName];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v5 = [(_INPBStartPhotoPlaybackIntentResponse *)self locationCreated];
...
LABEL_11:
  ...
  uint64_t v12 = [(_INPBStartPhotoPlaybackIntentResponse *)self locationCreated];
  if (v12)
  {
    v13 = (void *)v12;
  ...
  int v19 = [(_INPBStartPhotoPlaybackIntentResponse *)self hasSearchResultsCount];
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v5 = [+[_INPBStartPhotoPlaybackIntentResponse allocWithZone:](_INPBStartPhotoPlaybackIntentResponse, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBStartPhotoPlaybackIntentResponse *)self data];
...
- (_INPBStartPhotoPlaybackIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBStartPhotoPlaybackIntentResponse *)objc_claimAutoreleasedReturnValue();
...
{
  id v7 = a3;
  id v4 = [(_INPBStartPhotoPlaybackIntentResponse *)self albumName];
  ...
  if (v5)
  {
    id v6 = [(_INPBStartPhotoPlaybackIntentResponse *)self locationCreated];
