...
{
  v10.receiver = self;
  v10.super_class = (Class)INUpdateAlarmAlarmResolutionResult;
    ...
    && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    if (v7 > 2) {
      ...
      uint64_t v8 = dword_18CFC5698[v7];
    }
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INUpdateAlarmAlarmResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasUpdateAlarmIntentAlarmUnsupportedReason];

    if (v9)
    {
      objc_super v10 = [v6 payloadUnsupported];
      unsigned int v11 = [v10 updateAlarmIntentAlarmUnsupportedReason];
      if (v11 > 3) {
        uint64_t v12 = 0;
      }
      else {
        uint64_t v12 = qword_18CFC5678[v11];
      }
