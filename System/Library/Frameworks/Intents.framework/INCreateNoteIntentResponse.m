...
- (id)_dictionaryRepresentation
{
  ...
  v10[0] = @"code";
  INCreateNoteIntentResponseCode v3 = [(INCreateNoteIntentResponse *)self code];
  unint64_t v4 = v3;
  if ((unint64_t)v3 <= INCreateNoteIntentResponseCodeFailureRequiringAppLaunch)
  {
    v5 = off_1E55197D0[v3];
  }
  else
  ...
  v10[1] = @"createdNote";
  v11[0] = v5;
  v6 = [(INCreateNoteIntentResponse *)self createdNote];
  v7 = v6;
  if (!v6)
  {
...
- (INNote)createdNote
{
  ...
  INCreateNoteIntentResponseCode v3 = [v2 createdNote];
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INCreateNoteIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INCreateNoteIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  INCreateNoteIntentResponseCode v2 = [(INCreateNoteIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
{
  v4.receiver = self;
  v4.super_class = (Class)INCreateNoteIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INCreateNoteIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INCreateNoteIntentResponse;
...
- (INCreateNoteIntentResponse)initWithCode:(INCreateNoteIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  {
    if ((unint64_t)code > INCreateNoteIntentResponseCodeFailureRequiringAppLaunch) {
      id v8 = 0;
    }
    else {
      id v8 = off_1E55197D0[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INCreateNoteIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INCreateNoteIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INCreateNoteIntentResponse;
...
- (id)init
{
  return [(INCreateNoteIntentResponse *)self initWithCode:0 userActivity:0];
}
