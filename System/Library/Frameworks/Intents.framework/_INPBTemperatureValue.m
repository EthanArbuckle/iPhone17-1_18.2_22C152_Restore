...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v6 = [(_INPBTemperatureValue *)self unit];
    if ((v6 - 1) >= 3)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v5 = [(_INPBTemperatureValue *)self hasMagnitude];
    if (v5 == [v4 hasMagnitude])
    {
      ...
      {
        int v8 = [(_INPBTemperatureValue *)self hasUnit];
        if (v8 == [v4 hasUnit])
        {
          if (![(_INPBTemperatureValue *)self hasUnit]
            || ![v4 hasUnit]
            || (int unit = self->_unit, unit == [v4 unit]))
          {
            ...
            if ((v10 == 0) != (v11 != 0))
            {
              uint64_t v13 = [(_INPBTemperatureValue *)self valueMetadata];
              if (!v13)
              {
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v5 = [+[_INPBTemperatureValue allocWithZone:](_INPBTemperatureValue, "allocWithZone:") init];
  if ([(_INPBTemperatureValue *)self hasMagnitude])
  {
    [(_INPBTemperatureValue *)self magnitude];
...
{
  id v4 = a3;
  id v6 = [(_INPBTemperatureValue *)self data];
...
- (_INPBTemperatureValue)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBTemperatureValue *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(_INPBTemperatureValue *)self valueMetadata];

  int v5 = v7;
  if (v4)
  {
    id v6 = [(_INPBTemperatureValue *)self valueMetadata];
