...
- (id)_dictionaryRepresentation
{
  ...
  v11[0] = @"code";
  unint64_t v3 = [(INDeleteEventIntentResponse *)self code];
  unint64_t v4 = v3;
  if (v3 <= 5)
  {
    v5 = off_1E551A5D0[v3];
  ...
  v11[1] = @"confirmationReason";
  v12[0] = v5;
  int64_t v6 = [(INDeleteEventIntentResponse *)self confirmationReason];
  v7 = @"unknown";
  if (v6 == 1) {
    v7 = @"deleteAllRecurrences";
  }
  v8 = v7;
  v12[1] = v8;
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INDeleteEventIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INDeleteEventIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  int64_t v2 = [(INDeleteEventIntentResponse *)self code];
  if ((unint64_t)(v2 - 1) > 4) {
    return 0;
  }
  else {
...
- (INDeleteEventIntentResponse)init
{
  return [(INDeleteEventIntentResponse *)self initWithCode:0 userActivity:0];
}
