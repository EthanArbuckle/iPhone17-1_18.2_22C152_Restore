...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBSetRelationshipIntentResponse *)self meCard];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBSetRelationshipIntentResponse allocWithZone:](_INPBSetRelationshipIntentResponse, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBSetRelationshipIntentResponse *)self data];
...
- (_INPBSetRelationshipIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBSetRelationshipIntentResponse *)objc_claimAutoreleasedReturnValue();
...
{
  id v6 = a3;
  id v4 = [(_INPBSetRelationshipIntentResponse *)self meCard];
