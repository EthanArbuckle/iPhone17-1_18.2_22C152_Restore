...
+ (INOutgoingMessageTypeResolutionResult)confirmationRequiredWithOutgoingMessageTypeToConfirm:(INOutgoingMessageType)outgoingMessageTypeToConfirm;
+ (INOutgoingMessageTypeResolutionResult)successWithResolvedOutgoingMessageType:(INOutgoingMessageType)resolvedOutgoingMessageType;
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INOutgoingMessageTypeResolutionResult *))a6;
...
+ (INOutgoingMessageTypeResolutionResult)confirmationRequiredWithOutgoingMessageTypeToConfirm:(INOutgoingMessageType)outgoingMessageTypeToConfirm
{
  if (outgoingMessageTypeToConfirm == INOutgoingMessageTypeUnknown)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INOutgoingMessageTypeUnknown is not supported." userInfo:0];
    objc_exception_throw(v7);
  }
  v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  v5 = [a1 resolutionResultConfirmationRequiredWithItemToConfirm:v4];

  return (INOutgoingMessageTypeResolutionResult *)v5;
}

+ (INOutgoingMessageTypeResolutionResult)successWithResolvedOutgoingMessageType:(INOutgoingMessageType)resolvedOutgoingMessageType
{
  if (resolvedOutgoingMessageType)
  {
    v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  ...
  {
    NSLog((NSString *)@"Success resolution with INOutgoingMessageTypeUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v8 == 90)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      id v10 = @"unknown";
      if (v9 == 2) {
        id v10 = @"outgoingMessageAudio";
      }
      if (v9 == 1) {
        id v10 = @"outgoingMessageText";
      }
      v11 = v10;
  ...
  if ([v6 valueType] == 90)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadOutgoingMessageType:v10];
      }
    }
  }
