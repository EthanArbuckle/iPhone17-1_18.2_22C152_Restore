...
{
  v11.receiver = self;
  v11.super_class = (Class)INSearchAlarmAlarmResolutionResult;
...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  id v6 = a3;
  v14.receiver = self;
  v14.super_class = (Class)INSearchAlarmAlarmResolutionResult;
  ...
  if (v7)
  {
    ...
    int v9 = [v8 hasSearchAlarmIntentAlarmsUnsupportedReason];

    if (v9)
    {
      v10 = [v6 payloadUnsupported];
      int v11 = [v10 searchAlarmIntentAlarmsUnsupportedReason];
      if (v11) {
