...
+ (INCarAirCirculationModeResolutionResult)confirmationRequiredWithCarAirCirculationModeToConfirm:(INCarAirCirculationMode)carAirCirculationModeToConfirm
{
  if (carAirCirculationModeToConfirm == INCarAirCirculationModeUnknown)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INCarAirCirculationModeUnknown is not supported." userInfo:0];
    objc_exception_throw(v7);
  }
  v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  v5 = [a1 resolutionResultConfirmationRequiredWithItemToConfirm:v4];

  return (INCarAirCirculationModeResolutionResult *)v5;
}

+ (INCarAirCirculationModeResolutionResult)successWithResolvedCarAirCirculationMode:(INCarAirCirculationMode)resolvedCarAirCirculationMode
{
  if (resolvedCarAirCirculationMode)
  {
    v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  ...
  {
    NSLog((NSString *)@"Success resolution with INCarAirCirculationModeUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INCarAirCirculationModeResolutionResult *))a6;
  ...
  if ([v6 valueType] == 120)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadCarAirCirculationMode:v10];
      }
    }
  }
