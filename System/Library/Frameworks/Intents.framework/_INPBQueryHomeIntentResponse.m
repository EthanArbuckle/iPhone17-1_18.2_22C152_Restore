...
- (id)copyWithZone:(_NSZone *)a3
{
  id v3 = +[_INPBQueryHomeIntentResponse allocWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBQueryHomeIntentResponse *)self data];
...
- (_INPBQueryHomeIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBQueryHomeIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (BOOL)readFrom:(id)a3
{
  return _INPBQueryHomeIntentResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
