...
+ (INBillTypeResolutionResult)confirmationRequiredWithBillTypeToConfirm:(INBillType)billTypeToConfirm
{
  if (billTypeToConfirm == INBillTypeUnknown)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INBillTypeUnknown is not supported." userInfo:0];
    objc_exception_throw(v7);
  }
  v4 = objc_msgSend(NSNumber, "numberWithInteger:");
  v5 = [a1 resolutionResultConfirmationRequiredWithItemToConfirm:v4];

  return (INBillTypeResolutionResult *)v5;
}
...
+ (INBillTypeResolutionResult)successWithResolvedBillType:(INBillType)resolvedBillType
{
  ...
  {
    NSLog((NSString *)@"Success resolution with INBillTypeUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INBillTypeResolutionResult *))a6;
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v8 == 57)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if ((unint64_t)(v9 - 1) > 0x15) {
        id v10 = @"unknown";
      }
      else {
        id v10 = off_1E5519408[v9 - 1];
      }
      v11 = v10;
  ...
  if ([v6 valueType] == 57)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadBillType:v9];
      }
    }
  }
