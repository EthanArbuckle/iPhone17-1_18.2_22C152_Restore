...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  id v6 = [(INEndWorkoutIntent *)self _typedBackingStore];
  v5 = (void *)[v6 copy];
...
- (INEndWorkoutIntent)initWithWorkoutName:(INSpeakableString *)workoutName
{
  id v4 = workoutName;
  v8.receiver = self;
  v8.super_class = (Class)INEndWorkoutIntent;
  v5 = [(INIntent *)&v8 init];
  id v6 = v5;
  if (v5) {
...
{
  id v4 = a3;
  id v5 = [(INEndWorkoutIntent *)self _typedBackingStore];
...
- (id)localizeValueOfSlotDescription:(id)a3 withLocalizer:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  objc_super v8 = [v6 facadePropertyName];
  ...
  v15.receiver = self;
  v15.super_class = (Class)INEndWorkoutIntent;
