...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v4 = [(_INPBHomeUserTask *)self attribute];
    if (v4 >= 0x42)
    {
  ...
  {
    uint64_t v6 = [(_INPBHomeUserTask *)self taskType];
    if ((v6 - 1) >= 6)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v5 = [(_INPBHomeUserTask *)self hasAttribute];
    if (v5 == [v4 hasAttribute])
    {
      if (![(_INPBHomeUserTask *)self hasAttribute]
        || ![v4 hasAttribute]
        || (int attribute = self->_attribute, attribute == [v4 attribute]))
      {
        int v7 = [(_INPBHomeUserTask *)self hasTaskType];
        if (v7 == [v4 hasTaskType])
        {
            ...
            || (int taskType = self->_taskType, taskType == [v4 taskType]))
          {
            ...
            if ((v9 == 0) != (v10 != 0))
            {
              uint64_t v12 = [(_INPBHomeUserTask *)self value];
              if (!v12)
              {
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v5 = [+[_INPBHomeUserTask allocWithZone:](_INPBHomeUserTask, "allocWithZone:") init];
  if ([(_INPBHomeUserTask *)self hasAttribute]) {
  ...
  id v6 = [(_INPBHomeAttributeValue *)self->_value copyWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBHomeUserTask *)self data];
...
- (_INPBHomeUserTask)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBHomeUserTask *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(_INPBHomeUserTask *)self value];

  int v5 = v7;
  if (v4)
  {
    id v6 = [(_INPBHomeUserTask *)self value];
