...
- (id)dictionaryRepresentation
{
  ...
  {
    v15 = objc_msgSend(NSNumber, "numberWithBool:", -[_INPBOpenFileIntentResponse success](self, "success"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(_INPBOpenFileIntentResponse *)self entities];
  uint64_t v6 = [v4 entities];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v7 = [(_INPBOpenFileIntentResponse *)self entities];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
  ...
  unint64_t v5 = [(_INPBOpenFileIntentResponse *)self numResults];
  uint64_t v6 = [v4 numResults];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v12 = [(_INPBOpenFileIntentResponse *)self numResults];
  if (v12)
  {
    v13 = (void *)v12;
  ...
  unint64_t v5 = [(_INPBOpenFileIntentResponse *)self query];
...
LABEL_16:
  ...
  uint64_t v17 = [(_INPBOpenFileIntentResponse *)self query];
  if (v17)
  {
    long long v18 = (void *)v17;
    long long v19 = [(_INPBOpenFileIntentResponse *)self query];
  ...
  int v24 = [(_INPBOpenFileIntentResponse *)self hasSuccess];
...
- (id)copyWithZone:(_NSZone *)a3
{
  unint64_t v5 = [+[_INPBOpenFileIntentResponse allocWithZone:](_INPBOpenFileIntentResponse, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBOpenFileIntentResponse *)self data];
...
- (_INPBOpenFileIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBOpenFileIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  v10 = [(_INPBOpenFileIntentResponse *)self numResults];

  if (v10)
  {
    int v11 = [(_INPBOpenFileIntentResponse *)self numResults];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v12 = [(_INPBOpenFileIntentResponse *)self query];
