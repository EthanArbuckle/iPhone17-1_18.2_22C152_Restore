...
+ (id)confirmationRequiredWithWellnessObjectTypeToConfirm:(int64_t)a3;
+ (id)successWithResolvedWellnessObjectType:(int64_t)a3;
...
@implementation INWellnessObjectTypeResolutionResult

+ (id)confirmationRequiredWithWellnessObjectTypeToConfirm:(int64_t)a3
{
  if (!a3)
  {
    id v7 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Confirmation of INWellnessObjectTypeUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedWellnessObjectType:(int64_t)a3
{
  ...
  {
    NSLog((NSString *)@"Success resolution with INWellnessObjectTypeUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
...
- (void)transformResolutionResultForIntent:(id)a3 intentSlotDescription:(id)a4 withOptionsProvider:(id)a5 completion:(id)a6
{
  ...
  id v9 = a3;
  id v10 = a4;
  v11 = (void (**)(id, INWellnessObjectTypeResolutionResult *))a6;
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v8 == 172)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if ((unint64_t)(v9 - 1) > 0x49) {
        id v10 = @"unknown";
      }
      else {
        id v10 = off_1E55180E0[v9 - 1];
      }
      v11 = v10;
  ...
  if ([v6 valueType] == 172)
  {
    ...
    if ([v6 valueStyle] != 3)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [(_INPBIntentSlotValue *)v7 addPayloadWellnessObjectType:v9];
      }
    }
  }
