...
+ (INMessageAttributeOptionsResolutionResult)confirmationRequiredWithMessageAttributeOptionsToConfirm:(INMessageAttributeOptions)messageAttributeOptionsToConfirm
{
  v4 = [NSNumber numberWithUnsignedInteger:messageAttributeOptionsToConfirm];
  v5 = [a1 resolutionResultConfirmationRequiredWithItemToConfirm:v4];

  return (INMessageAttributeOptionsResolutionResult *)v5;
}

+ (INMessageAttributeOptionsResolutionResult)successWithResolvedMessageAttributeOptions:(INMessageAttributeOptions)resolvedMessageAttributeOptions
{
  v4 = [NSNumber numberWithUnsignedInteger:resolvedMessageAttributeOptions];
...
- (id)_vocabularyValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v10 == 85)
  {
    ...
    {
      v11 = INMessageAttributeOptionsGetNames([v5 unsignedIntegerValue]);
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if (v8 == 85)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      v11[3] = &unk_1E5520C28;
      uint64_t v12 = v7;
      INMessageAttributeOptionsEnumerateBackingTypes(v9, v11);
    }
  }
...
uint64_t __87__INMessageAttributeOptionsResolutionResult__intentSlotValueForObject_slotDescription___block_invoke(uint64_t a1, uint64_t a2)
{
  return [*(id *)(a1 + 32) addPayloadMessageAttribute:a2];
}
