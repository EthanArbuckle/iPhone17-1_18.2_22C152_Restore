...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v15 = [(_INPBChangeAlarmStatusIntent *)self operation];
    if ((v15 - 1) >= 3)
    {
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [(NSArray *)self->_alarms hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(_INPBChangeAlarmStatusIntent *)self alarmSearch];
  uint64_t v6 = [v4 alarmSearch];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v7 = [(_INPBChangeAlarmStatusIntent *)self alarmSearch];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBChangeAlarmStatusIntent *)self alarmSearch];
  ...
  unint64_t v5 = [(_INPBChangeAlarmStatusIntent *)self alarms];
  uint64_t v6 = [v4 alarms];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v12 = [(_INPBChangeAlarmStatusIntent *)self alarms];
  if (v12)
  {
    v13 = (void *)v12;
    v14 = [(_INPBChangeAlarmStatusIntent *)self alarms];
    uint64_t v15 = [v4 alarms];
  ...
  unint64_t v5 = [(_INPBChangeAlarmStatusIntent *)self intentMetadata];
...
LABEL_16:
  ...
  uint64_t v17 = [(_INPBChangeAlarmStatusIntent *)self intentMetadata];
  if (v17)
  {
    long long v18 = (void *)v17;
    long long v19 = [(_INPBChangeAlarmStatusIntent *)self intentMetadata];
    long long v20 = [v4 intentMetadata];
  ...
  int v24 = [(_INPBChangeAlarmStatusIntent *)self hasOperation];
  if (v24 == [v4 hasOperation])
  {
    if (![(_INPBChangeAlarmStatusIntent *)self hasOperation]
      || ![v4 hasOperation]
      || (int operation = self->_operation, operation == [v4 operation]))
    {
      BOOL v22 = 1;
      goto LABEL_18;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  unint64_t v5 = [+[_INPBChangeAlarmStatusIntent allocWithZone:](_INPBChangeAlarmStatusIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBChangeAlarmStatusIntent *)self data];
...
- (_INPBChangeAlarmStatusIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBChangeAlarmStatusIntent *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBChangeAlarmStatusIntent *)self alarmSearch];
  ...
  uint64_t v12 = [(_INPBChangeAlarmStatusIntent *)self intentMetadata];
