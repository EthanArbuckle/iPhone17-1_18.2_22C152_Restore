...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_INPBSpeed *)self values];
    uint64_t v6 = [v4 values];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBSpeed *)self values];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBSpeed allocWithZone:](_INPBSpeed, "allocWithZone:") init];
  uint64_t v6 = (void *)[(NSArray *)self->_values copyWithZone:a3];
  [(_INPBSpeed *)v5 setValues:v6];
...
- (_INPBSpeed)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBSpeed *)objc_claimAutoreleasedReturnValue();
  ...
  if (v6
    || (uint64_t v7 = objc_opt_class(),
        ...
        v6))
  {
    self = [(_INPBSpeed *)self initWithData:v6];
