...
@implementation INAppIdentifierResolutionResult
...
- (id)_intentSlotValueForObject:(id)a3 slotDescription:(id)a4
{
  ...
  if ([v6 valueType] == 202)
  {
      ...
      if (v11)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v12; ++i)
          {
            ...
            v15 = INIntentSlotValueTransformToAppIdentifier(*(void **)(*((void *)&v17 + 1) + 8 * i));
            [(_INPBIntentSlotValue *)v7 addPayloadAppIdentifier:v15];
          }
    ...
    else
    {
      ...
      if (v10) {
        [(_INPBIntentSlotValue *)v7 addPayloadAppIdentifier:v10];
      }
    }
  }
LABEL_17:
