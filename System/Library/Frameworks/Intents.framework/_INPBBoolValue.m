...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = objc_msgSend(NSNumber, "numberWithBool:", -[_INPBBoolValue value](self, "value"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v5 = [(_INPBBoolValue *)self hasValue];
    if (v5 == [v4 hasValue])
    {
      if (![(_INPBBoolValue *)self hasValue]
        || ![v4 hasValue]
        || (int value = self->_value, value == [v4 value]))
      {
        ...
        if ((v7 == 0) != (v8 != 0))
        {
          uint64_t v10 = [(_INPBBoolValue *)self valueMetadata];
          if (!v10)
          {
...
- (id)copyWithZone:(_NSZone *)a3
{
  int v5 = [+[_INPBBoolValue allocWithZone:](_INPBBoolValue, "allocWithZone:") init];
  if ([(_INPBBoolValue *)self hasValue]) {
...
{
  id v4 = a3;
  id v6 = [(_INPBBoolValue *)self data];
...
- (_INPBBoolValue)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBBoolValue *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(_INPBBoolValue *)self valueMetadata];

  int v5 = v7;
  if (v4)
  {
    id v6 = [(_INPBBoolValue *)self valueMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBBoolValueReadFrom(self, (uint64_t)a3);
}
