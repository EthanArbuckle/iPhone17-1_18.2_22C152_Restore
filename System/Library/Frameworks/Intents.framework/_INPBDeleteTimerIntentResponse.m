...
- (unint64_t)hash
{
  return [(NSArray *)self->_deletedTimers hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    uint64_t v6 = [v4 deletedTimers];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBDeleteTimerIntentResponse *)self deletedTimers];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBDeleteTimerIntentResponse allocWithZone:](_INPBDeleteTimerIntentResponse, "allocWithZone:") init];
  uint64_t v6 = (void *)[(NSArray *)self->_deletedTimers copyWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBDeleteTimerIntentResponse *)self data];
...
- (_INPBDeleteTimerIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBDeleteTimerIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (id)deletedTimersAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_deletedTimers objectAtIndexedSubscript:a3];
}

- (unint64_t)deletedTimersCount
{
  return [(NSArray *)self->_deletedTimers count];
}
...
- (void)addDeletedTimers:(id)a3
{
  ...
  if (!deletedTimers)
  {
    ...
    uint64_t v7 = self->_deletedTimers;
...
- (void)setDeletedTimers:(id)a3
{
  self->_deletedTimers = (NSArray *)[a3 mutableCopy];
