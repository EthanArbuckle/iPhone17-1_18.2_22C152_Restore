...
void ___INRRaaSDomainLoadIntentDescriptionIfNeeded_block_invoke()
{
  ...
  v3 = [[INIntentSlotDescription alloc] initWithName:@"reference", 2, @"reference", @"reference", 0, 0, 2, 1, &unk_1EDBAA020, &unk_1EDBAA038, objc_opt_class(), sel_resolveReferenceForResolveObjectReference_withCompletion_, sel_resolveReferenceForResolveObjectReference_completion_, 0 tag facadePropertyName dataPropertyName isExtended isPrivate valueType valueStyle defaultValueSelectorStrings provideOptionsSelectorStrings resolutionResultClass resolveSelectors];
  v28 = v3;
