...
- (unint64_t)hash
{
  unint64_t v3 = [(_INPBIntentMetadata *)self->_metadata hash];
  return [(NSArray *)self->_properties hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_INPBGenericIntentResponse *)self metadata];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(_INPBGenericIntentResponse *)self metadata];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_INPBGenericIntentResponse *)self properties];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    long long v14 = [(_INPBGenericIntentResponse *)self properties];
    long long v15 = [v4 properties];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBGenericIntentResponse allocWithZone:](_INPBGenericIntentResponse, "allocWithZone:") init];
  id v6 = [(_INPBIntentMetadata *)self->_metadata copyWithZone:a3];
  [(_INPBGenericIntentResponse *)v5 setMetadata:v6];

  uint64_t v7 = (void *)[(NSArray *)self->_properties copyWithZone:a3];
...
{
  id v4 = a3;
  id v6 = [(_INPBGenericIntentResponse *)self data];
...
- (_INPBGenericIntentResponse)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBGenericIntentResponse *)objc_claimAutoreleasedReturnValue();
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [(_INPBGenericIntentResponse *)self metadata];
