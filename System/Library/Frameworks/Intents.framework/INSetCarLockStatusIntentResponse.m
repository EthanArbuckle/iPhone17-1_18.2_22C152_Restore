...
- (id)_dictionaryRepresentation
{
  ...
  v7 = @"code";
  INSetCarLockStatusIntentResponseCode v2 = [(INSetCarLockStatusIntentResponse *)self code];
  unint64_t v3 = v2;
  if ((unint64_t)v2 <= INSetCarLockStatusIntentResponseCodeFailureRequiringAppLaunch)
  {
    v4 = off_1E5519818[v2];
  }
  else
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  uint64_t v4 = [v3 isEqualToString:@"INSetCarLockStatusIntentResponseCodeReady"];
  ...
  int v6 = [v3 isEqualToString:@"INSetCarLockStatusIntentResponseCodeFailureRequiringAppLaunch"];
...
{
  v4.receiver = self;
  v4.super_class = (Class)INSetCarLockStatusIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = (Class)INSetCarLockStatusIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = (Class)INSetCarLockStatusIntentResponse;
...
- (INSetCarLockStatusIntentResponse)initWithCode:(INSetCarLockStatusIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  {
    if ((unint64_t)code > INSetCarLockStatusIntentResponseCodeFailureRequiringAppLaunch) {
      v8 = 0;
    }
    else {
      v8 = off_1E5519818[code];
    }
    *(_DWORD *)buf = 136315906;
    v14 = "-[INSetCarLockStatusIntentResponse initWithCode:userActivity:]";
    __int16 v15 = 2048;
    INSetCarLockStatusIntentResponseCode v16 = code;
    __int16 v17 = 2112;
    v18 = v8;
    __int16 v19 = 2112;
    v20 = v6;
  ...
  v12.receiver = self;
  v12.super_class = (Class)INSetCarLockStatusIntentResponse;
...
- (id)init
{
  return [(INSetCarLockStatusIntentResponse *)self initWithCode:0 userActivity:0];
}
