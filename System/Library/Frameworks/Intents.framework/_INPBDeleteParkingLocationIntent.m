...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_INPBDeleteParkingLocationIntent *)self intentMetadata];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBDeleteParkingLocationIntent allocWithZone:](_INPBDeleteParkingLocationIntent, "allocWithZone:") init];
...
{
  id v4 = a3;
  id v6 = [(_INPBDeleteParkingLocationIntent *)self data];
...
- (_INPBDeleteParkingLocationIntent)initWithCoder:(id)a3
{
  ...
  id v6 = (_INPBDeleteParkingLocationIntent *)objc_claimAutoreleasedReturnValue();
...
{
  id v6 = a3;
  id v4 = [(_INPBDeleteParkingLocationIntent *)self intentMetadata];
...
- (BOOL)readFrom:(id)a3
{
  return _INPBDeleteParkingLocationIntentReadFrom(self, (uint64_t)a3);
}
