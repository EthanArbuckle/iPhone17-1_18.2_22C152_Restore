...
- (id)reverseTransformedValue:(id)a3
{
  v3 = (INPrivateMediaItemValueData *)a3;
  [(id)objc_opt_class() reverseTransformedValueClass];
  if (objc_opt_isKindOfClass())
  {
    v4 = INIntentSlotValueTransformFromPrivateMediaItemValueData(v3);
  }
  else
  {
    v4 = 0;
...
- (id)transformedValue:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v4 = INIntentSlotValueTransformToPrivateMediaItemValueData(v3);
  }
  else
  {
    v4 = 0;
