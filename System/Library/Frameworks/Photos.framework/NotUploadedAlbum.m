@interface NotUploadedAlbum
@end

@implementation NotUploadedAlbum

id PHQueryForAssetInAlbumKind_NotUploadedAlbum_DEPRECATED_block_invoke_66(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_NotUploadedAlbum_DEPRECATED_block_invoke_66";
