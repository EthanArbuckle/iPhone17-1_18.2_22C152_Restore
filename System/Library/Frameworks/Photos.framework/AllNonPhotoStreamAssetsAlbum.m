@interface AllNonPhotoStreamAssetsAlbum
@end

@implementation AllNonPhotoStreamAssetsAlbum

id PHQueryForAssetInAlbumKind_AllNonPhotoStreamAssetsAlbum_block_invoke_41(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllNonPhotoStreamAssetsAlbum_block_invoke_41";
