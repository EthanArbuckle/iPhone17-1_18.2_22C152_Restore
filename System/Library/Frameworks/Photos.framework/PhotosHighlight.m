@interface PhotosHighlight
@end

@implementation PhotosHighlight

id PHQueryForAssetCollectionType_PhotosHighlight_block_invoke_106(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetCollectionType_PhotosHighlight_block_invoke_106";
