@interface FacesStandIn
@end

@implementation FacesStandIn

id PHQueryForAssetInAlbumKind_FacesStandIn_block_invoke_77(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_FacesStandIn_block_invoke_77";
