@interface SortKeyOther
@end

@implementation SortKeyOther

id PHQueryForAssetsAlbum_SortKeyOther_block_invoke_92(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsAlbum_SortKeyOther_block_invoke_92";
