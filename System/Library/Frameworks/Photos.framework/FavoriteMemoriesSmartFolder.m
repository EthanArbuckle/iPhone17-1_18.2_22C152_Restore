@interface FavoriteMemoriesSmartFolder
@end

@implementation FavoriteMemoriesSmartFolder

id PHQueryForAssetInAlbumKind_FavoriteMemoriesSmartFolder_block_invoke_82(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_FavoriteMemoriesSmartFolder_block_invoke_82";
