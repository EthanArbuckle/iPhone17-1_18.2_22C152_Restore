@interface RecentsAlbum
@end

@implementation RecentsAlbum

id PHQueryForAssetInAlbumKind_RecentsAlbum_DEPRECATED_block_invoke_67(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_RecentsAlbum_DEPRECATED_block_invoke_67";
