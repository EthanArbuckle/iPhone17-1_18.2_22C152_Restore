@interface OTARestoreProgressAlbum
@end

@implementation OTARestoreProgressAlbum

id PHQueryForAssetInAlbumKind_OTARestoreProgressAlbum_block_invoke_72(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_OTARestoreProgressAlbum_block_invoke_72";
