@interface LegacyFaces
@end

@implementation LegacyFaces

id PHQueryForAssetInAlbumKind_LegacyFaces_block_invoke_22(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_LegacyFaces_block_invoke_22";
