@interface ImportStandIn
@end

@implementation ImportStandIn

id PHQueryForAssetInAlbumKind_ImportStandIn_block_invoke_79(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_ImportStandIn_block_invoke_79";
