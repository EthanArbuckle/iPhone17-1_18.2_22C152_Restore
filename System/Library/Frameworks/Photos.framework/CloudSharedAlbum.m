@interface CloudSharedAlbum
@end

@implementation CloudSharedAlbum

id PHQueryForAssetInAlbumKind_CloudSharedAlbum_block_invoke_30(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_CloudSharedAlbum_block_invoke_30";
