@interface DepthEffectAlbum
@end

@implementation DepthEffectAlbum

id PHQueryForAssetInAlbumKind_DepthEffectAlbum_block_invoke_61(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_DepthEffectAlbum_block_invoke_61";
