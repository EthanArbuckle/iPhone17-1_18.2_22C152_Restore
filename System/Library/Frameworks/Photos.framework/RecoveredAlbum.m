@interface RecoveredAlbum
@end

@implementation RecoveredAlbum

id PHQueryForAssetInAlbumKind_RecoveredAlbum_block_invoke_88(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_RecoveredAlbum_block_invoke_88";
