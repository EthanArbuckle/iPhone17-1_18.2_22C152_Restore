@interface SortKeyLastModifiedDate
@end

@implementation SortKeyLastModifiedDate

id PHQueryForAssetsInAlbum_SortKeyLastModifiedDate_block_invoke_95(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyLastModifiedDate_block_invoke_95";
