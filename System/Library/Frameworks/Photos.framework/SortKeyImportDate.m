@interface SortKeyImportDate
@end

@implementation SortKeyImportDate

id PHQueryForAssetsInAlbum_SortKeyImportDate_block_invoke_96(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyImportDate_block_invoke_96";
