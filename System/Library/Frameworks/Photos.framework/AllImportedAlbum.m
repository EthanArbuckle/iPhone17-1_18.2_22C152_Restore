@interface AllImportedAlbum
@end

@implementation AllImportedAlbum

id PHQueryForAssetInAlbumKind_AllImportedAlbum_block_invoke_44(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllImportedAlbum_block_invoke_44";
