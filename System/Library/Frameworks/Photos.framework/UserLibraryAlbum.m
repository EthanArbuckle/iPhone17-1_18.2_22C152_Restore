@interface UserLibraryAlbum
@end

@implementation UserLibraryAlbum

id PHQueryForAssetInAlbumKind_UserLibraryAlbum_block_invoke_54(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_UserLibraryAlbum_block_invoke_54";
