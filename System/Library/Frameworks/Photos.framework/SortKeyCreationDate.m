@interface SortKeyCreationDate
@end

@implementation SortKeyCreationDate

id PHQueryForAssetsInAlbum_SortKeyCreationDate_block_invoke_94(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyCreationDate_block_invoke_94";
