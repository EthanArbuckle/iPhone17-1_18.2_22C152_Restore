@interface AnimatedAlbum
@end

@implementation AnimatedAlbum

id PHQueryForAssetInAlbumKind_AnimatedAlbum_block_invoke_63(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AnimatedAlbum_block_invoke_63";
