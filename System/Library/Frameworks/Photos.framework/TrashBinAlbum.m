@interface TrashBinAlbum
@end

@implementation TrashBinAlbum

id PHQueryForAssetInAlbumKind_TrashBinAlbum_block_invoke_53(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_TrashBinAlbum_block_invoke_53";
