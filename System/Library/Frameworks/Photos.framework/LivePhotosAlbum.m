@interface LivePhotosAlbum
@end

@implementation LivePhotosAlbum

id PHQueryForAssetInAlbumKind_LivePhotosAlbum_block_invoke_62(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_LivePhotosAlbum_block_invoke_62";
