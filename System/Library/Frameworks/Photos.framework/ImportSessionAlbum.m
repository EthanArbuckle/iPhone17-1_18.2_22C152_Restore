@interface ImportSessionAlbum
@end

@implementation ImportSessionAlbum

id PHQueryForAssetInAlbumKind_ImportSessionAlbum_block_invoke_31(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_ImportSessionAlbum_block_invoke_31";
