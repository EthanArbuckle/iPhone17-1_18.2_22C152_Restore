@interface RecentlyEditedAlbum
@end

@implementation RecentlyEditedAlbum

id PHQueryForAssetInAlbumKind_RecentlyEditedAlbum_block_invoke_68(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_RecentlyEditedAlbum_block_invoke_68";
