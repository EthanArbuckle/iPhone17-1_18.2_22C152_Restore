@interface AllPhotosAlbum
@end

@implementation AllPhotosAlbum

id PHQueryForAssetInAlbumKind_AllPhotosAlbum_block_invoke_70(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllPhotosAlbum_block_invoke_70";
