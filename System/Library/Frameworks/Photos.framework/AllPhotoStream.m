@interface AllPhotoStream
@end

@implementation AllPhotoStream

id PHQueryForAssetInAlbumKind_AllPhotoStream_block_invoke_42(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllPhotoStream_block_invoke_42";
