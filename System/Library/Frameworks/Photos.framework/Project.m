...
id PHQueryForAssetCollectionType_Project_block_invoke_110(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetCollectionType_Project_block_invoke_110";
...
id PHQueryForAssetInAlbumKind_Project_block_invoke_33(uint64_t a1, void *a2)
{
  uint64_t v13 = *MEMORY[0x1E4F143B8];
  v2 = a2;
  PLPhotoKitGetLog();
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_Project_block_invoke_33";
    _os_signpost_emit_with_name_impl(&dword_19B043000, v6, OS_SIGNPOST_INTERVAL_BEGIN, v4, "QueryIdentificationBlock", "%s", (uint8_t *)&v11, 0xCu);
  }
