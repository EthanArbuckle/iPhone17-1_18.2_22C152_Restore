@interface BurstsAlbum
@end

@implementation BurstsAlbum

id PHQueryForAssetInAlbumKind_BurstsAlbum_block_invoke_55(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_BurstsAlbum_block_invoke_55";
