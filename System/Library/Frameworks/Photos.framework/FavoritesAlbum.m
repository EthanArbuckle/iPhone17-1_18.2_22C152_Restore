@interface FavoritesAlbum
@end

@implementation FavoritesAlbum

id PHQueryForAssetInAlbumKind_FavoritesAlbum_block_invoke_50(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_FavoritesAlbum_block_invoke_50";
