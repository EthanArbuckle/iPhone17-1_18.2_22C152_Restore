@interface MomentShare
@end

@implementation MomentShare

id PHQueryForAssetCollectionType_MomentShare_block_invoke_107(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetCollectionType_MomentShare_block_invoke_107";
