@interface ProjectAlbumRootFolder
@end

@implementation ProjectAlbumRootFolder

id PHQueryForAssetInAlbumKind_ProjectAlbumRootFolder_block_invoke_74(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_ProjectAlbumRootFolder_block_invoke_74";
