@interface PanoramasAlbum
@end

@implementation PanoramasAlbum

id PHQueryForAssetInAlbumKind_PanoramasAlbum_block_invoke_45(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_PanoramasAlbum_block_invoke_45";
