@interface EventsSmartFolder
@end

@implementation EventsSmartFolder

id PHQueryForAssetInAlbumKind_EventsSmartFolder_block_invoke_80(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_EventsSmartFolder_block_invoke_80";
