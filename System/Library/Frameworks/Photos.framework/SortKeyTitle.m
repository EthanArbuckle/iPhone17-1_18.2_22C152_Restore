@interface SortKeyTitle
@end

@implementation SortKeyTitle

id PHQueryForAssetsInAlbum_SortKeyTitle_block_invoke_98(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyTitle_block_invoke_98";
