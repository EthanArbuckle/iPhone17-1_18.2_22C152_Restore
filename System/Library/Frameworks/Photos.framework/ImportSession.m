...
@implementation ImportSession

id PHQueryForAssetCollectionType_ImportSession_block_invoke_109(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetCollectionType_ImportSession_block_invoke_109";
