@interface ScreenshotsAlbum
@end

@implementation ScreenshotsAlbum

id PHQueryForAssetInAlbumKind_ScreenshotsAlbum_block_invoke_59(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_ScreenshotsAlbum_block_invoke_59";
