@interface SortKeyManual
@end

@implementation SortKeyManual

id PHQueryForAssetsInAlbum_SortKeyManual_block_invoke_93(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyManual_block_invoke_93";
