@interface ActionCamVideoAlbum
@end

@implementation ActionCamVideoAlbum

id PHQueryForAssetInAlbumKind_ActionCamVideoAlbum_block_invoke_91(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_ActionCamVideoAlbum_block_invoke_91";
