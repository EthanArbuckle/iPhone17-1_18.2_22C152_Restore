@interface AllLibraryDuplicatesAlbum
@end

@implementation AllLibraryDuplicatesAlbum

id PHQueryForAssetInAlbumKind_AllLibraryDuplicatesAlbum_block_invoke_84(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllLibraryDuplicatesAlbum_block_invoke_84";
