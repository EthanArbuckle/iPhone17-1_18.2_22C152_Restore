@interface TimelapsesAlbum
@end

@implementation TimelapsesAlbum

id PHQueryForAssetInAlbumKind_TimelapsesAlbum_block_invoke_51(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_TimelapsesAlbum_block_invoke_51";
