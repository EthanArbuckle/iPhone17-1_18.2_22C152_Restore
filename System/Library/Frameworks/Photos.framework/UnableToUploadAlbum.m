@interface UnableToUploadAlbum
@end

@implementation UnableToUploadAlbum

id PHQueryForAssetInAlbumKind_UnableToUploadAlbum_block_invoke_65(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_UnableToUploadAlbum_block_invoke_65";
