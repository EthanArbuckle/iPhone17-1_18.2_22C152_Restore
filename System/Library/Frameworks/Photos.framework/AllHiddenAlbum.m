@interface AllHiddenAlbum
@end

@implementation AllHiddenAlbum

id PHQueryForAssetInAlbumKind_AllHiddenAlbum_block_invoke_52(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllHiddenAlbum_block_invoke_52";
