@interface SlomoVideosAlbum
@end

@implementation SlomoVideosAlbum

id PHQueryForAssetInAlbumKind_SlomoVideosAlbum_block_invoke_56(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_SlomoVideosAlbum_block_invoke_56";
