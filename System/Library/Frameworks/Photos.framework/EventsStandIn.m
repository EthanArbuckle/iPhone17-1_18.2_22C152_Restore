@interface EventsStandIn
@end

@implementation EventsStandIn

id PHQueryForAssetInAlbumKind_EventsStandIn_block_invoke_78(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_EventsStandIn_block_invoke_78";
