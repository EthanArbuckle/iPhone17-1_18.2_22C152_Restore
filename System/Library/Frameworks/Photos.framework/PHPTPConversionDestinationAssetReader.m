...
- (id)path
{
  ...
  if (v5)
  {
    ...
    [v10 handleFailureInMethod:a2, self, @"PHPTPFormatConversionManager.m", 78, @"Call to method %@ is incompatible with a wrapped single pass video conversion destination", v11 object file lineNumber description];
  }
  ...
  *(void *)&v27[13] = *MEMORY[0x1E4F143B8];
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)v27 = location + length;
    _os_log_impl(&dword_19B043000, v10, OS_LOG_TYPE_DEBUG, "Begin wait for data availability of range %@ (= file size %lu)", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(double *)&v27[3] = (double)(v16 - v12) / 1000000000.0;
    _os_log_impl(&dword_19B043000, v17, OS_LOG_TYPE_DEBUG, "End wait for data availability of range %@: %d (%.3fs)", buf, 0x1Cu);
  }
  if (v14)
  {

LABEL_8:
    id v15 = [(PHPTPConversionDestinationAssetReader *)self destination];
    v19 = [v15 fileURL];
    v20 = [v19 path];
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 138412290;
    id v25 = v15;
    _os_log_impl(&dword_19B043000, v22, OS_LOG_TYPE_ERROR, "Wait for data availability failed %@", buf, 0xCu);
  }
...
- (PHPTPConversionDestinationAssetReader)initWithDestination:(id)a3
{
  ...
  {
    v10 = [MEMORY[0x1E4F28B00] currentHandler];
    [v10 handleFailureInMethod:a2, self, @"PHPTPFormatConversionManager.m", 48, @"Invalid parameter not satisfying: %@", @"path" object file lineNumber description];
