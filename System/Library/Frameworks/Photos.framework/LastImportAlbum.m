@interface LastImportAlbum
@end

@implementation LastImportAlbum

id PHQueryForAssetInAlbumKind_LastImportAlbum_block_invoke_43(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_LastImportAlbum_block_invoke_43";
