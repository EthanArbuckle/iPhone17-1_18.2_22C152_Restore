@interface SortKeyContentTitle
@end

@implementation SortKeyContentTitle

id PHQueryForAssetsInAlbum_SortKeyContentTitle_block_invoke_99(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyContentTitle_block_invoke_99";
