@interface RecentlySavedAlbum
@end

@implementation RecentlySavedAlbum

id PHQueryForAssetInAlbumKind_RecentlySavedAlbum_block_invoke_87(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_RecentlySavedAlbum_block_invoke_87";
