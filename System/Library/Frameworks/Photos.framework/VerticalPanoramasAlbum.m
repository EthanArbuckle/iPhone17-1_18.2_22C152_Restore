@interface VerticalPanoramasAlbum
@end

@implementation VerticalPanoramasAlbum

id PHQueryForAssetInAlbumKind_VerticalPanoramasAlbum_block_invoke_48(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_VerticalPanoramasAlbum_block_invoke_48";
