@interface PlacesSmartAlbum
@end

@implementation PlacesSmartAlbum

id PHQueryForAssetInAlbumKind_PlacesSmartAlbum_block_invoke_60(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_PlacesSmartAlbum_block_invoke_60";
