    ...
    if (v28)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412290;
        ...
        uint32_t v14 = 12;
LABEL_8:
        _os_log_impl(&dword_19B043000, v13, OS_LOG_TYPE_ERROR, v12, buf, v14);
        goto LABEL_16;
      }
      goto LABEL_16;
    }
    ...
    if (v16)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412290;
        ...
        uint32_t v23 = 12;
LABEL_14:
        _os_log_impl(&dword_19B043000, v21, v22, v20, buf, v23);
      }
    }
...
LABEL_17:
  v25.receiver = self;
  v25.super_class = (Class)PHPTPAssetReader;
...
- (PHPTPAssetReader)initWithPath:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PHPTPAssetReader;
