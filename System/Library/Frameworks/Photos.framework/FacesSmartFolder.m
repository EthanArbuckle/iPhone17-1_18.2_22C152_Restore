@interface FacesSmartFolder
@end

@implementation FacesSmartFolder

id PHQueryForAssetInAlbumKind_FacesSmartFolder_block_invoke_81(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_FacesSmartFolder_block_invoke_81";
