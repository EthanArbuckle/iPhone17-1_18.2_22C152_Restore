@interface SelfPortraitsAlbum
@end

@implementation SelfPortraitsAlbum

id PHQueryForAssetInAlbumKind_SelfPortraitsAlbum_block_invoke_58(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_SelfPortraitsAlbum_block_invoke_58";
