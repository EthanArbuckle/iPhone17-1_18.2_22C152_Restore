@interface VideosAlbum
@end

@implementation VideosAlbum

id PHQueryForAssetInAlbumKind_VideosAlbum_block_invoke_47(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_VideosAlbum_block_invoke_47";
