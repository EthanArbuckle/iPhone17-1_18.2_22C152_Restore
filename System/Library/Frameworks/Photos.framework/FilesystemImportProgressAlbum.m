@interface FilesystemImportProgressAlbum
@end

@implementation FilesystemImportProgressAlbum

id PHQueryForAssetInAlbumKind_FilesystemImportProgressAlbum_block_invoke_73(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_FilesystemImportProgressAlbum_block_invoke_73";
