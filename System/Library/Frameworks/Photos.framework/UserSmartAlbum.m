@interface UserSmartAlbum
@end

@implementation UserSmartAlbum

id PHQueryForAssetInAlbumKind_UserSmartAlbum_block_invoke_32(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_UserSmartAlbum_block_invoke_32";
