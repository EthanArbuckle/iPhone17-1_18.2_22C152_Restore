@interface HorizontalPanoramasAlbum
@end

@implementation HorizontalPanoramasAlbum

id PHQueryForAssetInAlbumKind_HorizontalPanoramasAlbum_block_invoke_49(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_HorizontalPanoramasAlbum_block_invoke_49";
