@interface SpatialAlbum
@end

@implementation SpatialAlbum

id PHQueryForAssetInAlbumKind_SpatialAlbum_block_invoke_46(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_SpatialAlbum_block_invoke_46";
