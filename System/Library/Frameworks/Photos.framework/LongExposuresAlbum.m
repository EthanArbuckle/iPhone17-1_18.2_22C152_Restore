@interface LongExposuresAlbum
@end

@implementation LongExposuresAlbum

id PHQueryForAssetInAlbumKind_LongExposuresAlbum_block_invoke_64(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_LongExposuresAlbum_block_invoke_64";
