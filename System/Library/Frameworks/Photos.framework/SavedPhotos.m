...
@implementation SavedPhotos

id PHQueryForAssetInAlbumKind_SavedPhotos_block_invoke_39(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_SavedPhotos_block_invoke_39";
