@interface NoFetchType
@end

@implementation NoFetchType

id PHQueryForAssetCollectionType_NoFetchType_block_invoke_113(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetCollectionType_NoFetchType_block_invoke_113";
