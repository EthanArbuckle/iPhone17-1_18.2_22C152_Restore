@interface ScreenRecordingsAlbum
@end

@implementation ScreenRecordingsAlbum

id PHQueryForAssetInAlbumKind_ScreenRecordingsAlbum_block_invoke_69(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_ScreenRecordingsAlbum_block_invoke_69";
