@interface AllAssetsAlbum
@end

@implementation AllAssetsAlbum

id PHQueryForAssetInAlbumKind_AllAssetsAlbum_block_invoke_40(uint64_t a1, void *a2)
{
  ...
  {
    int v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_AllAssetsAlbum_block_invoke_40";
