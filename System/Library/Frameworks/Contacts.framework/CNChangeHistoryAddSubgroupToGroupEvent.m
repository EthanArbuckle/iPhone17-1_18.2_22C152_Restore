...
LABEL_6:
  ...
  {
    -[CNChangeHistoryAddSubgroupToGroupEvent initWithSubgroup:group:](v9);
    if (v8)
    {
LABEL_7:
      objc_opt_class();
...
- (CNChangeHistoryAddSubgroupToGroupEvent)initWithCoder:(id)a3
{
  ...
  id v7 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self initWithSubgroup:v5 group:v6];
  return v7;
}
...
{
  v2 = [*(id *)(a1 + 32) subgroup];
  id v3 = [*(id *)(a1 + 40) subgroup];
...
- (id)description
{
  ...
  unint64_t v4 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self subgroup];
  id v5 = (id)[v3 appendName:@"subgroup" object:v4];

  id v6 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self group];
...
{
  id v4 = a3;
  id v5 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self group];
  id v6 = [v5 identifier];
  id v7 = [v4 group];
  id v8 = [v7 identifier];
  ...
  if (!v9)
  {
    uint64_t v10 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self subgroup];
    v11 = [v10 identifier];
    v12 = [v4 subgroup];
    v13 = [v12 identifier];
...
- (void)initWithSubgroup:(void *)a1 group:.cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0_1(&dword_1909E3000, v3, v4, "parameter ‘subgroup’ must be nonnull and of type %{public}@", v5, v6, v7, v8, v9);
}
