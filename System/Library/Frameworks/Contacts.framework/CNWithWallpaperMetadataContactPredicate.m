...
- (id)description
{
  ...
  id v3 = (id)[v2 appendName:@"kind" object:@"-[CNContact predicateForContactsWithWallpaperMetadata]"];
  v4 = [v2 build];
...
- (id)shortDebugDescription
{
  return @"WithWallpaperMetadataPredicate";
}

- (BOOL)isEqual:(id)a3
{
  return objc_msgSend(MEMORY[0x1E4F5A3E0], "isObject:equalToOther:withBlocks:", self, a3, &__block_literal_global_71, 0);
}
