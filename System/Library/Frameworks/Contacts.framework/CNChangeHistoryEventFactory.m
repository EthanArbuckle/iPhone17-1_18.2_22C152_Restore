...
- (id)updateContactEventWithContact:(id)a3 imagesChanged:(BOOL)a4
{
  BOOL v4 = a4;
  id v5 = a3;
  id v6 = [[CNChangeHistoryUpdateContactEvent alloc] initWithContact:v5 imagesChanged:v4];
...
- (id)updateContactEventWithContactIdentifier:(id)a3 imagesChanged:(BOOL)a4
{
  BOOL v4 = a4;
  id v5 = a3;
  id v6 = [[CNChangeHistoryUpdateContactEvent alloc] initWithContactIdentifier:v5 imagesChanged:v4];
...
{
  id v3 = a3;
  BOOL v4 = [[CNChangeHistoryDeleteContactEvent alloc] initWithContactIdentifier:v3];
...
- (id)addGroupEventWithGroup:(id)a3 containerIdentifier:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryAddGroupEvent alloc] initWithGroup:v6 containerIdentifier:v5];
...
{
  id v3 = a3;
  BOOL v4 = [[CNChangeHistoryUpdateGroupEvent alloc] initWithGroup:v3];
...
{
  id v3 = a3;
  BOOL v4 = [[CNChangeHistoryDeleteGroupEvent alloc] initWithGroupIdentifier:v3];
...
- (id)addMemberToGroupEventWithMember:(id)a3 group:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryAddMemberToGroupEvent alloc] initWithMember:v6 group:v5];
...
- (id)removeMemberFromGroupEventWithMember:(id)a3 group:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryRemoveMemberFromGroupEvent alloc] initWithMember:v6 group:v5];
...
- (id)addSubgroupToGroupEventWithSubgroup:(id)a3 group:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryAddSubgroupToGroupEvent alloc] initWithSubgroup:v6 group:v5];
...
- (id)removeSubgroupFromGroupEventWithSubgroup:(id)a3 group:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryRemoveSubgroupFromGroupEvent alloc] initWithSubgroup:v6 group:v5];
...
{
  id v3 = a3;
  BOOL v4 = [[CNChangeHistoryUnlinkContactEvent alloc] initWithContact:v3];
...
- (id)preferredContactForNameEventWithPreferredContact:(id)a3 unifiedContact:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryPreferredContactForNameEvent alloc] initWithPreferredContact:v6 unifiedContact:v5];
...
- (id)preferredContactForImageEventWithPreferredContact:(id)a3 unifiedContact:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CNChangeHistoryPreferredContactForImageEvent alloc] initWithPreferredContact:v6 unifiedContact:v5];
...
{
  id v3 = a3;
  BOOL v4 = [[CNChangeHistoryDifferentMeCardEvent alloc] initWithContactIdentifier:v3];
