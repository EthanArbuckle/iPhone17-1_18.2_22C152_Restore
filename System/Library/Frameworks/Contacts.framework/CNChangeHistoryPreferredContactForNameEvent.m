...
- (CNChangeHistoryPreferredContactForNameEvent)initWithCoder:(id)a3
{
  ...
  id v7 = [(CNChangeHistoryPreferredContactForNameEvent *)self initWithPreferredContact:v5 unifiedContact:v6];
  return v7;
}
...
- (id)description
{
  ...
  uint64_t v4 = [(CNChangeHistoryPreferredContactForNameEvent *)self preferredContact];
  id v5 = (id)[v3 appendName:@"preferredContact" object:v4];

  id v6 = [(CNChangeHistoryPreferredContactForNameEvent *)self unifiedContact];
...
{
  id v4 = a3;
  id v5 = [(CNChangeHistoryPreferredContactForNameEvent *)self unifiedContact];
  id v6 = [v5 identifier];
  ...
  if (!v9)
  {
    uint64_t v10 = [(CNChangeHistoryPreferredContactForNameEvent *)self preferredContact];
    v11 = [v10 identifier];
...
- (void)initWithPreferredContact:(void *)a1 unifiedContact:.cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0_1(&dword_1909E3000, v3, v4, "parameter ‘preferredContact’ must be nonnull and of type %{public}@", v5, v6, v7, v8, v9);
}
