...
- (id)CNValueForContact:(id)a3
{
  return (id)[a3 fullscreenImageData];
}

- (BOOL)abPropertyID:(int *)a3
{
  if (a3) {
    *a3 = *MEMORY[0x1E4F498D8];
  }
  return a3 != 0;
}
...
- (CNFullscreenImageDataDescription)init
{
  return [(CNPropertyDescription *)self initWithKey:@"fullscreenImageData" readSelector:sel_fullscreenImageData writeSelector:sel__setFullscreenImageData_];
}
...
- (void)decodeUsingCoder:(id)a3 contact:(id)a4
{
  v5 = a4;
  id v6 = a3;
  id v9 = [v6 decodeObjectOfClass:objc_opt_class() forKey:@"_fullscreenImageData"];
