...
LABEL_12:
  v15.receiver = self;
  v15.super_class = (Class)CNChangeHistoryRemoveSubgroupFromGroupEvent;
...
- (CNChangeHistoryRemoveSubgroupFromGroupEvent)initWithCoder:(id)a3
{
  ...
  id v7 = [(CNChangeHistoryRemoveSubgroupFromGroupEvent *)self initWithSubgroup:v5 group:v6];
  return v7;
}
...
- (id)description
{
  ...
  unint64_t v4 = [(CNChangeHistoryRemoveSubgroupFromGroupEvent *)self subgroup];
  id v5 = (id)[v3 appendName:@"subgroup" object:v4];

  id v6 = [(CNChangeHistoryRemoveSubgroupFromGroupEvent *)self group];
...
{
  id v4 = a3;
  id v5 = [(CNChangeHistoryRemoveSubgroupFromGroupEvent *)self group];
  id v6 = [v5 identifier];
  id v7 = [v4 group];
  id v8 = [v7 identifier];
  ...
  if (!v9)
  {
    uint64_t v10 = [(CNChangeHistoryRemoveSubgroupFromGroupEvent *)self subgroup];
    v11 = [v10 identifier];
    v12 = [v4 subgroup];
    v13 = [v12 identifier];
