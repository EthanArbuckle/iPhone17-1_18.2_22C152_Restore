...
+ (void)webContentProcessWithBundleID:(id)a3 interruptionHandler:(id)a4 completion:(id)a5
{
  ...
  *(void *)(v15 + 16) = v11;
  ...
  swift_retain();
  swift_retain();
  sub_24323B154((uint64_t)v9, (uint64_t)&unk_268D8F770, (uint64_t)v17);
...
- (id)grantCapability:(id)a3 error:(id *)a4 invalidationHandler:(id)a5
{
  ...
  *(void *)(v8 + 16) = v7;
  id v9 = a3;
  v10 = self;
  v11 = (void *)sub_24323EBD8((uint64_t)v9, (uint64_t)sub_24323E434, v8, &OBJC_IVAR___BEWebContentProcess_inner, _s15_ProcessAdaptorVMa_2, (uint64_t)&off_26F88F4A8, type metadata accessor for WebContentProcess);
  swift_release();
...
+ (void)webContentProcessWithInterruptionHandler:(id)a3 completion:(id)a4
{
  ...
  *(void *)(v12 + 16) = v10;
  ...
  swift_retain();
  swift_retain();
  sub_24323B154((uint64_t)v8, (uint64_t)&unk_268D8F778, (uint64_t)v14);
  swift_release();
  swift_release();
  swift_release();
}
...
- (BEWebContentProcess)init
{
  result = (BEWebContentProcess *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (id)grantCapability:(id)a3 error:(id *)a4
{
  return sub_2432565EC(self, (uint64_t)a2, a3, (uint64_t)a4, &OBJC_IVAR___BEWebContentProcess_inner, _s15_ProcessAdaptorVMa_2, (uint64_t)&off_26F88F4A8, type metadata accessor for WebContentProcess);
}
