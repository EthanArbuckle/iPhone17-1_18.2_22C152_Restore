...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRUnitTestingClusterTestBatchHelperResponseParams;
  v4 = [(MTRUnitTestingClusterTestBatchHelperResponseParams *)&v8 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_data(MEMORY[0x263EFF8F8], v2, v3);
    buffer = v4->_buffer;
    v4->_buffer = (NSData *)v5;
  }
  return v4;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_buffer(self, v5, v6);
  objc_msgSend_setBuffer_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_base64EncodedStringWithOptions_(self->_buffer, v6, 0);
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: buffer:%@ >", v5, v7);;
...
- (MTRUnitTestingClusterTestBatchHelperResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRUnitTestingClusterTestBatchHelperResponseParams;
  objc_super v8 = [(MTRUnitTestingClusterTestBatchHelperResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4294048773, 12, a4);
  if (v36)
  {
    ...
    {
      long long v32 = 0uLL;
      sub_244847318(&v32, (uint64_t)v35, (uint64_t)buf);
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setBuffer_(self, v7, (uint64_t)v6);
