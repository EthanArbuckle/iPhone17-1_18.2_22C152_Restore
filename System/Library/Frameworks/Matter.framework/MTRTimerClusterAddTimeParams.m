@interface MTRTimerClusterAddTimeParams
...
- (MTRTimerClusterAddTimeParams)init
{
  ...
  v2 = [(MTRTimerClusterAddTimeParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    additionalTime = v2->_additionalTime;
    v2->_additionalTime = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_additionalTime(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: additionalTime:%@ >", v5, self->_additionalTime);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_additionalTime(self, a3, (uint64_t)a4);
