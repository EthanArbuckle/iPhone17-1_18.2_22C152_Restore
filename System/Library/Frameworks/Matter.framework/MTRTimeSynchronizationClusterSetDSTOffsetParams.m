...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRTimeSynchronizationClusterSetDSTOffsetParams;
  v4 = [(MTRTimeSynchronizationClusterSetDSTOffsetParams *)&v10 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_array(MEMORY[0x263EFF8C0], v2, v3);
    dstOffset = v4->_dstOffset;
    v4->_dstOffset = (NSArray *)v5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_dstOffset(self, v5, v6);
  objc_msgSend_setDstOffset_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: dstOffset:%@ >", v5, self->_dstOffset);;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_dstOffset, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v18[1] = 0;
  v17 = v18;
  uint64_t v5 = objc_msgSend_dstOffset(self, a3, (uint64_t)a4);
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244805C0C((uint64_t *)&v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
