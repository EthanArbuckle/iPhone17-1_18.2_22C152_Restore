...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRUnitTestingClusterTestListInt8UReverseRequestParams;
  v4 = [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)&v10 init];
  if (v4)
  {
  ...
  *(_OWORD *)v19 = 0uLL;
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2448453C4(v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
