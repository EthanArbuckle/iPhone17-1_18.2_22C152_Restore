...
- (void)setIsForUpdateNOC:(NSNumber *)isForUpdateNOC;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTROperationalCredentialsClusterCSRRequestParams;
  v4 = [(MTROperationalCredentialsClusterCSRRequestParams *)&v11 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_data(MEMORY[0x263EFF8F8], v2, v3);
    csrNonce = v4->_csrNonce;
    v4->_csrNonce = (NSData *)v5;

    isForUpdateNOC = v4->_isForUpdateNOC;
    v4->_isForUpdateNOC = 0;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_csrNonce(self, v5, v6);
  objc_msgSend_setCsrNonce_(v4, v8, (uint64_t)v7);

  objc_super v11 = objc_msgSend_isForUpdateNOC(self, v9, v10);
  objc_msgSend_setIsForUpdateNOC_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  v7 = objc_msgSend_base64EncodedStringWithOptions_(self->_csrNonce, v6, 0);
  objc_msgSend_stringWithFormat_(v3, v8, @"<%@: csrNonce:%@; isForUpdateNOC:%@; >",
    v5,
    v7,
  v9 = self->_isForUpdateNOC);
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_isForUpdateNOC, 0);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v30[1] = 0;
  v29 = v30;
  objc_msgSend_csrNonce(self, a3, (uint64_t)a4);
  ...
  v16 = objc_msgSend_isForUpdateNOC(self, v14, v15);

  if (v16)
  {
    __int16 v32 = 1;
    v19 = objc_msgSend_isForUpdateNOC(self, v17, v18);
    HIBYTE(v32) = objc_msgSend_BOOLValue(v19, v20, v21);
  }
  ...
  if (v28)
  {
    ...
    sub_244CB6318((uint64_t)v23, (uint64_t)&v24, 0xFFFFFFFF, (uint64_t)v33);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2448089C8((uint64_t)&v31, v23, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
