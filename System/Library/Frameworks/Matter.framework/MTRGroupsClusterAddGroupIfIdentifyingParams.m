...
- (MTRGroupsClusterAddGroupIfIdentifyingParams)init;
- (NSNumber)groupID;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRGroupsClusterAddGroupIfIdentifyingParams;
  v2 = [(MTRGroupsClusterAddGroupIfIdentifyingParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRGroupsClusterAddGroupIfIdentifyingParams);
  v7 = objc_msgSend_groupID(self, v5, v6);
  objc_msgSend_setGroupID_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_groupName(self, v9, v10);
  objc_msgSend_setGroupName_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: groupID:%@; groupName:%@; >",
    v5,
    self->_groupID,
  v7 = self->_groupName);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  objc_msgSend_groupName(self, v10, v11);
