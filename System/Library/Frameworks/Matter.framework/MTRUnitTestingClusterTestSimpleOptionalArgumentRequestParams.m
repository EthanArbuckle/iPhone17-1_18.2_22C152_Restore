@interface MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams)init;
- (NSNumber)arg1;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams;
  v2 = [(MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRUnitTestingClusterTestSimpleOptionalArgumentRequestParams);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  {
    __int16 v22 = 1;
    uint64_t v10 = objc_msgSend_arg1(self, v8, v9);
