...
- (MTRRVCOperationalStateClusterErrorStateStruct)commandResponseState;
- (MTRRVCOperationalStateClusterOperationalCommandResponseParams)init;
- (MTRRVCOperationalStateClusterOperationalCommandResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRRVCOperationalStateClusterOperationalCommandResponseParams;
  ...
  if (v2)
  {
    ...
    v2->_commandResponseState = (MTRRVCOperationalStateClusterErrorStateStruct *)v3;
  }
  return v2;
}
...
- (MTRRVCOperationalStateClusterOperationalCommandResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v38.receiver = self;
  v38.super_class = (Class)MTRRVCOperationalStateClusterOperationalCommandResponseParams;
  v8 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 97, 4, a4);
  if (v37)
  {
    ...
    if (!v34)
    {
      ...
      BYTE8(buf) = 0;
      char v43 = 0;
      sub_24480FF48((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
