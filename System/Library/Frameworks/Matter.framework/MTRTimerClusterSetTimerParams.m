@interface MTRTimerClusterSetTimerParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRTimerClusterSetTimerParams)init;
- (NSNumber)getNewTime;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRTimerClusterSetTimerParams;
  v2 = [(MTRTimerClusterSetTimerParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    newTime = v2->_newTime;
    v2->_newTime = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRTimerClusterSetTimerParams);
  v7 = objc_msgSend_getNewTime(self, v5, v6);
  objc_msgSend_setNewTime_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: newTime:%@ >", v5, self->_newTime);;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_newTime, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_getNewTime(self, a3, (uint64_t)a4);
