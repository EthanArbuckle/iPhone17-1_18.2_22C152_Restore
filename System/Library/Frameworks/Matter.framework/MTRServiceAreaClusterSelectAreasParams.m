@interface MTRServiceAreaClusterSelectAreasParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRServiceAreaClusterSelectAreasParams)init;
- (NSArray)getNewAreas;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRServiceAreaClusterSelectAreasParams;
  v4 = [(MTRServiceAreaClusterSelectAreasParams *)&v10 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_array(MEMORY[0x263EFF8C0], v2, v3);
    newAreas = v4->_newAreas;
    v4->_newAreas = (NSArray *)v5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRServiceAreaClusterSelectAreasParams);
  v7 = objc_msgSend_getNewAreas(self, v5, v6);
  objc_msgSend_setNewAreas_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: newAreas:%@ >", v5, self->_newAreas);;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_newAreas, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  *(_OWORD *)v19 = 0uLL;
  ...
  v18[1] = 0;
  v17 = v18;
  uint64_t v6 = objc_msgSend_getNewAreas(self, a3, (uint64_t)a4);
  ...
  *(_OWORD *)v19 = 0uLL;
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244826448(v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
