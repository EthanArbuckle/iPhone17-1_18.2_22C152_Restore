@interface MTRUnitTestingClusterTestSpecificResponseParams
...
- (MTRUnitTestingClusterTestSpecificResponseParams)init
{
  ...
  v2 = [(MTRUnitTestingClusterTestSpecificResponseParams *)&v7 init];
  v3 = v2;
  if (v2)
  {
...
- (MTRUnitTestingClusterTestSpecificResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v8 = [(MTRUnitTestingClusterTestSpecificResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      char v32 = 0;
      sub_244844C5C(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
