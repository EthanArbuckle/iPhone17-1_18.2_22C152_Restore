...
{
  v7.receiver = self;
  v7.super_class = (Class)MTRUnitTestingClusterBooleanResponseParams;
  v2 = [(MTRUnitTestingClusterBooleanResponseParams *)&v7 init];
  v3 = v2;
  if (v2)
  {
    value = v2->_value;
...
- (MTRUnitTestingClusterBooleanResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v37.receiver = self;
  v37.super_class = (Class)MTRUnitTestingClusterBooleanResponseParams;
  v8 = [(MTRUnitTestingClusterBooleanResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4294048773, 8, error);
  if (v36)
  {
    ...
    {
      char v32 = 0;
      sub_244846AAC(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  uint64_t v6 = objc_msgSend_numberWithBool_(NSNumber, a3, a4->var0);
