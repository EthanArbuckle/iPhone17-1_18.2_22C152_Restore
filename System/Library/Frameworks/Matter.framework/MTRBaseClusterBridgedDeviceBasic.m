...
- (MTRBaseClusterBridgedDeviceBasic)initWithDevice:(MTRBaseDevice *)device endpoint:(uint16_t)endpoint queue:(dispatch_queue_t)queue;
...
- (MTRBaseClusterBridgedDeviceBasic)initWithDevice:(MTRBaseDevice *)device endpoint:(uint16_t)endpoint queue:(dispatch_queue_t)queue
{
  ...
  v13 = (MTRBaseClusterBridgedDeviceBasic *)objc_msgSend_initWithDevice_endpointID_queue_(self, v12, (uint64_t)v8, v11, v9);
