@interface MTRNetworkCommissioningClusterConnectNetworkParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRNetworkCommissioningClusterConnectNetworkParams)init;
- (NSData)networkID;
- (NSNumber)breadcrumb;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTRNetworkCommissioningClusterConnectNetworkParams;
  v4 = [(MTRNetworkCommissioningClusterConnectNetworkParams *)&v11 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRNetworkCommissioningClusterConnectNetworkParams);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v8, @"<%@: networkID:%@; breadcrumb:%@; >",
    v5,
    v7,
  v9 = self->_breadcrumb);
