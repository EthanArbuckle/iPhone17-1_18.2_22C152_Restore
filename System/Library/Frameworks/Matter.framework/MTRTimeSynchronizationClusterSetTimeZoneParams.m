...
- (MTRTimeSynchronizationClusterSetTimeZoneParams)init
{
  ...
  v4 = [(MTRTimeSynchronizationClusterSetTimeZoneParams *)&v10 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_timeZone(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: timeZone:%@ >", v5, self->_timeZone);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v18[1] = 0;
  v17 = v18;
  uint64_t v5 = objc_msgSend_timeZone(self, a3, (uint64_t)a4);
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2448057C0((uint64_t *)&v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
