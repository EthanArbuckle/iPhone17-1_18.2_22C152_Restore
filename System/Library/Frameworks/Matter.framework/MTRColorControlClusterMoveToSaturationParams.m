...
- (MTRColorControlClusterMoveToSaturationParams)init
{
  ...
  v2 = [(MTRColorControlClusterMoveToSaturationParams *)&v11 init];
  v3 = v2;
  if (v2)
  {
    saturation = v2->_saturation;
    v2->_saturation = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_saturation(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: saturation:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_saturation,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v33[1] = 0;
  v32 = v33;
  v7 = objc_msgSend_saturation(self, a3, (uint64_t)a4);
  char v34 = objc_msgSend_unsignedCharValue(v7, v8, v9);
  ...
  if (v31)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482A618(v26, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
