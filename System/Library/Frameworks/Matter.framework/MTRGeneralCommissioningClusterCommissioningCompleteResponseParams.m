...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRGeneralCommissioningClusterCommissioningCompleteResponseParams;
  v2 = [(MTRGeneralCommissioningClusterCommissioningCompleteResponseParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (MTRGeneralCommissioningClusterCommissioningCompleteResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v38.receiver = self;
  v38.super_class = (Class)MTRGeneralCommissioningClusterCommissioningCompleteResponseParams;
  objc_super v8 = [(MTRGeneralCommissioningClusterCommissioningCompleteResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 48, 5, error);
  if (v37)
  {
    ...
    if (!v34)
    {
      ...
      *((void *)&buf + 1) = 0;
      uint64_t v42 = 0;
      sub_2447FD19C((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  {
    *(_OWORD *)&retstr->mError = xmmword_265193FA8;
    *(void *)&retstr->mLine = 5557;
  }
  return result;
}
