...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams;
  v4 = [(MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams *)&v8 init];
  if (v4)
  {
...
- (id)description
{
  ...
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: operationalDataset:%@ >", v5, v7);;
...
- (MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams;
  objc_super v8 = [(MTRThreadNetworkDirectoryClusterOperationalDatasetResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1107, 3, a4);
  if (v36)
  {
    ...
    {
      long long v32 = 0uLL;
      sub_2448301D8(&v32, (uint64_t)v35, (uint64_t)buf);
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setOperationalDataset_(self, v7, (uint64_t)v6);
