@interface MTRUnitTestingClusterTestAddArgumentsParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRUnitTestingClusterTestAddArgumentsParams)init;
- (NSNumber)arg1;
- (NSNumber)arg2;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRUnitTestingClusterTestAddArgumentsParams;
  v2 = [(MTRUnitTestingClusterTestAddArgumentsParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRUnitTestingClusterTestAddArgumentsParams);
