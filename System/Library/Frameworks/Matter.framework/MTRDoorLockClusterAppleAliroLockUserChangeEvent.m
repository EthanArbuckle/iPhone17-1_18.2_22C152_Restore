...
- (id)description;
- (void)setDataIndex:(id)a3;
- (void)setDataOperationType:(id)a3;
- (void)setFabricIndex:(id)a3;
- (void)setLockDataType:(id)a3;
- (void)setOperationSource:(id)a3;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRDoorLockClusterAppleAliroLockUserChangeEvent;
