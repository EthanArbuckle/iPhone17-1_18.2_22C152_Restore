@interface MTRGroupsClusterViewGroupParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRGroupsClusterViewGroupParams)init;
- (NSNumber)groupID;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRGroupsClusterViewGroupParams;
  v2 = [(MTRGroupsClusterViewGroupParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRGroupsClusterViewGroupParams);
