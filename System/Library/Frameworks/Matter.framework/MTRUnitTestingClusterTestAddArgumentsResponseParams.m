...
- (MTRUnitTestingClusterTestAddArgumentsResponseParams)init
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)MTRUnitTestingClusterTestAddArgumentsResponseParams;
...
- (MTRUnitTestingClusterTestAddArgumentsResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v37.receiver = self;
  v37.super_class = (Class)MTRUnitTestingClusterTestAddArgumentsResponseParams;
  v8 = [(MTRUnitTestingClusterTestAddArgumentsResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4294048773, 1, error);
  if (v36)
  {
    ...
    {
      char v32 = 0;
      sub_244844D34(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
