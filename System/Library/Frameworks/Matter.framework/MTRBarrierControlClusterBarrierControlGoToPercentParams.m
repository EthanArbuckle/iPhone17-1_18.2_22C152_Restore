...
- (NSNumber)percentOpen;
- (NSNumber)serverSideProcessingTimeout;
- (NSNumber)timedInvokeTimeoutMs;
- (id)_encodeAsDataValue:(id *)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (void)setPercentOpen:(NSNumber *)percentOpen;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRBarrierControlClusterBarrierControlGoToPercentParams;
  v2 = [(MTRBarrierControlClusterBarrierControlGoToPercentParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    percentOpen = v2->_percentOpen;
    v2->_percentOpen = (NSNumber *)&unk_26F9CA828;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_percentOpen(self, v5, v6);
  objc_msgSend_setPercentOpen_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: percentOpen:%@ >", v5, self->_percentOpen);;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_percentOpen, 0);
}
