@interface MTRThreadBorderRouterManagementClusterDatasetResponseParams
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3;
- (MTRThreadBorderRouterManagementClusterDatasetResponseParams)init;
- (MTRThreadBorderRouterManagementClusterDatasetResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
- (NSData)dataset;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRThreadBorderRouterManagementClusterDatasetResponseParams;
  v4 = [(MTRThreadBorderRouterManagementClusterDatasetResponseParams *)&v8 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_data(MEMORY[0x263EFF8F8], v2, v3);
    dataset = v4->_dataset;
    v4->_dataset = (NSData *)v5;
  }
  return v4;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRThreadBorderRouterManagementClusterDatasetResponseParams);
  v7 = objc_msgSend_dataset(self, v5, v6);
  objc_msgSend_setDataset_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_base64EncodedStringWithOptions_(self->_dataset, v6, 0);
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: dataset:%@ >", v5, v7);;
...
- (MTRThreadBorderRouterManagementClusterDatasetResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRThreadBorderRouterManagementClusterDatasetResponseParams;
  objc_super v8 = [(MTRThreadBorderRouterManagementClusterDatasetResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1106, 2, a4);
  if (v36)
  {
    ...
    {
      long long v32 = 0uLL;
      sub_24482F544(&v32, (uint64_t)v35, (uint64_t)buf);
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setDataset_(self, v7, (uint64_t)v6);
