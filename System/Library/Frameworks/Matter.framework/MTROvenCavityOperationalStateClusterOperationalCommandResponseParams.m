...
- (MTROvenCavityOperationalStateClusterOperationalCommandResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  v8 = [(MTROvenCavityOperationalStateClusterOperationalCommandResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!v34)
    {
      ...
      BYTE8(buf) = 0;
      char v43 = 0;
      sub_24480C1DC((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
