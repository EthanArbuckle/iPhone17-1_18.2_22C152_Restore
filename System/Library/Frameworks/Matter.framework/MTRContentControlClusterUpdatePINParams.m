@interface MTRContentControlClusterUpdatePINParams
...
- (MTRContentControlClusterUpdatePINParams)init
{
  ...
  v2 = [(MTRContentControlClusterUpdatePINParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    oldPIN = v2->_oldPIN;
    ...
    newPIN = v3->_newPIN;
    v3->_newPIN = (NSString *)&stru_26F969DC8;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_oldPIN(self, v5, v6);
  objc_msgSend_setOldPIN_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_getNewPIN(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: oldPIN:%@; newPIN:%@; >",
    v5,
    self->_oldPIN,
  v7 = self->_newPIN);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v30[1] = 0;
  v29 = v30;
  v7 = objc_msgSend_oldPIN(self, a3, (uint64_t)a4);
