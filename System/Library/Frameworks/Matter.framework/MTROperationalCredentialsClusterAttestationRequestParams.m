...
{
  v10.receiver = self;
  v10.super_class = (Class)MTROperationalCredentialsClusterAttestationRequestParams;
  v4 = [(MTROperationalCredentialsClusterAttestationRequestParams *)&v10 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_data(MEMORY[0x263EFF8F8], v2, v3);
    attestationNonce = v4->_attestationNonce;
    v4->_attestationNonce = (NSData *)v5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_attestationNonce(self, v5, v6);
  objc_msgSend_setAttestationNonce_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_base64EncodedStringWithOptions_(self->_attestationNonce, v6, 0);
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: attestationNonce:%@ >", v5, v7);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v21[1] = 0;
  v20 = v21;
  objc_msgSend_attestationNonce(self, a3, (uint64_t)a4);
