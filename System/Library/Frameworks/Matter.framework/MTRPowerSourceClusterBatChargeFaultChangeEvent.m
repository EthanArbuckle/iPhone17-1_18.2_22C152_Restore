@interface MTRPowerSourceClusterBatChargeFaultChangeEvent
- (MTRPowerSourceClusterBatChargeFaultChangeEvent)init;
- (NSArray)current;
- (NSArray)previous;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRPowerSourceClusterBatChargeFaultChangeEvent;
  v4 = [(MTRPowerSourceClusterBatChargeFaultChangeEvent *)&v12 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRPowerSourceClusterBatChargeFaultChangeEvent);
