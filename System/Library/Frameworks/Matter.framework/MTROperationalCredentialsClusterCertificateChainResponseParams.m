...
- (MTROperationalCredentialsClusterCertificateChainResponseParams)init
{
  ...
  v4 = [(MTROperationalCredentialsClusterCertificateChainResponseParams *)&v9 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_certificate(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_base64EncodedStringWithOptions_(self->_certificate, v6, 0);
  objc_super v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: certificate:%@ >", v5, v7);;
...
- (MTROperationalCredentialsClusterCertificateChainResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v8 = [(MTROperationalCredentialsClusterCertificateChainResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v36)
  {
    ...
    {
      long long v32 = 0uLL;
      sub_2448088A0(&v32, (uint64_t)v35, (uint64_t)buf);
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  uint64_t v6 = objc_msgSend_dataWithBytes_length_(MEMORY[0x263EFF8F8], a3, *(void *)a4, *((void *)a4 + 1));
