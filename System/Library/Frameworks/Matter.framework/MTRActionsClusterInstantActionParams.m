@interface MTRActionsClusterInstantActionParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRActionsClusterInstantActionParams)init;
- (NSNumber)actionID;
- (NSNumber)invokeID;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRActionsClusterInstantActionParams;
  v2 = [(MTRActionsClusterInstantActionParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRActionsClusterInstantActionParams);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: actionID:%@; invokeID:%@; >",
    v5,
    self->_actionID,
  v7 = self->_invokeID);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v12)
  {
    ...
    int v29 = objc_msgSend_unsignedIntValue(v15, v16, v17);
  }
  ...
  if (v24)
  {
    ...
    sub_244CB6318((uint64_t)v19, (uint64_t)&v20, 0xFFFFFFFF, (uint64_t)v30);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447F6DDC((uint64_t)&v27, v19, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
