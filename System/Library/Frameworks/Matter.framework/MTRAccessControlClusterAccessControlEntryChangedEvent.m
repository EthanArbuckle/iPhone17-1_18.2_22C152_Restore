...
- (MTRAccessControlClusterAccessControlEntryStruct)latestValue;
...
- (void)setLatestValue:(MTRAccessControlClusterAccessControlEntryStruct *)latestValue;
@end
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRAccessControlClusterAccessControlEntryChangedEvent;
