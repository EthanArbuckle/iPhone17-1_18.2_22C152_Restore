...
- (void)setEnhancedHue:(NSNumber *)enhancedHue;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRColorControlClusterEnhancedMoveToHueParams;
  v2 = [(MTRColorControlClusterEnhancedMoveToHueParams *)&v12 init];
  v3 = v2;
  if (v2)
  {
    enhancedHue = v2->_enhancedHue;
    v2->_enhancedHue = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_enhancedHue(self, v5, v6);
  objc_msgSend_setEnhancedHue_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_direction(self, v9, v10);
  objc_msgSend_setDirection_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: enhancedHue:%@; direction:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_enhancedHue,
    self->_direction,
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_enhancedHue, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  v7 = objc_msgSend_enhancedHue(self, a3, (uint64_t)a4);
  __int16 v39 = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_super v12 = objc_msgSend_direction(self, v10, v11);
  char v40 = objc_msgSend_unsignedCharValue(v12, v13, v14);

  v17 = objc_msgSend_transitionTime(self, v15, v16);
  LOWORD(v41) = objc_msgSend_unsignedShortValue(v17, v18, v19);

  uint64_t v22 = objc_msgSend_optionsMask(self, v20, v21);
  BYTE2(v41) = objc_msgSend_unsignedCharValue(v22, v23, v24);

  v27 = objc_msgSend_optionsOverride(self, v25, v26);
  HIBYTE(v41) = objc_msgSend_unsignedCharValue(v27, v28, v29);
  ...
  if (v36)
  {
    ...
    sub_244CB6318((uint64_t)v31, (uint64_t)&v32, 0xFFFFFFFF, (uint64_t)v42);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482BAF4((uint64_t)&v39, v31, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
