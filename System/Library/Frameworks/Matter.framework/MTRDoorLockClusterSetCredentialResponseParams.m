...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRDoorLockClusterSetCredentialResponseParams;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v15 = objc_msgSend_nextCredentialIndex(self, v13, v14);
  objc_msgSend_setNextCredentialIndex_(v4, v16, (uint64_t)v15);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: status:%@; userIndex:%@; nextCredentialIndex:%@; >",
    v5,
    self->_status,
    self->_userIndex,
  v7 = self->_nextCredentialIndex);
...
- (MTRDoorLockClusterSetCredentialResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v37.receiver = self;
  v37.super_class = (Class)MTRDoorLockClusterSetCredentialResponseParams;
  v8 = [(MTRDoorLockClusterSetCredentialResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 257, 35, error);
  if (v36)
  {
    ...
    if (!v33)
    {
      ...
      v32[6] = 0;
      v32[8] = 0;
      sub_244821DA0(v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  {
    v13 = objc_msgSend_numberWithUnsignedShort_(NSNumber, v12, *((unsigned __int16 *)a4 + 3));
    objc_msgSend_setNextCredentialIndex_(self, v14, (uint64_t)v13);
  }
  else
  {
    result = (ChipError *)objc_msgSend_setNextCredentialIndex_(self, v12, 0);
  }
  retstr->mError = 0;
