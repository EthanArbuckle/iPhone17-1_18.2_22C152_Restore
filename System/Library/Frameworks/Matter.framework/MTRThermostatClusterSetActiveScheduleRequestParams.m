@interface MTRThermostatClusterSetActiveScheduleRequestParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRThermostatClusterSetActiveScheduleRequestParams)init;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRThermostatClusterSetActiveScheduleRequestParams;
  v4 = [(MTRThermostatClusterSetActiveScheduleRequestParams *)&v10 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_data(MEMORY[0x263EFF8F8], v2, v3);
    scheduleHandle = v4->_scheduleHandle;
    v4->_scheduleHandle = (NSData *)v5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRThermostatClusterSetActiveScheduleRequestParams);
...
- (id)description
{
  ...
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: scheduleHandle:%@ >", v5, v7);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v21[1] = 0;
  v20 = v21;
  objc_msgSend_scheduleHandle(self, a3, (uint64_t)a4);
