@interface MTRThreadNetworkDirectoryClusterRemoveNetworkParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRThreadNetworkDirectoryClusterRemoveNetworkParams)init;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRThreadNetworkDirectoryClusterRemoveNetworkParams;
  v4 = [(MTRThreadNetworkDirectoryClusterRemoveNetworkParams *)&v10 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRThreadNetworkDirectoryClusterRemoveNetworkParams);
