...
- (MTRMediaInputClusterRenameInputParams)init;
- (NSNumber)index;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRMediaInputClusterRenameInputParams;
  v2 = [(MTRMediaInputClusterRenameInputParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRMediaInputClusterRenameInputParams);
