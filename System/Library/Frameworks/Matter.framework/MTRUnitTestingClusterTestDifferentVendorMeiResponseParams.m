...
- (MTRUnitTestingClusterTestDifferentVendorMeiResponseParams)init
{
  ...
  if (v2)
  {
    ...
    v3->_eventNumber = (NSNumber *)&unk_26F9C8548;
  }
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = objc_msgSend_eventNumber(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: arg1:%@; eventNumber:%@; >",
    v5,
    self->_arg1,
  objc_super v7 = self->_eventNumber);
...
- (MTRUnitTestingClusterTestDifferentVendorMeiResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  v8 = [(MTRUnitTestingClusterTestDifferentVendorMeiResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!v34)
    {
      v32[0] = 0;
      uint64_t v33 = 0;
      sub_244848AA0((uint64_t)v32, (uint64_t)v36, (uint64_t)buf);
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  uint64_t v10 = objc_msgSend_numberWithUnsignedLongLong_(NSNumber, v9, *(void *)&a4[8].var0);
