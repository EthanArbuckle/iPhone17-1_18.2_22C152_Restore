@interface MTREnergyEVSEClusterSetTargetsParams
...
- (MTREnergyEVSEClusterSetTargetsParams)init
{
  ...
  v4 = [(MTREnergyEVSEClusterSetTargetsParams *)&v10 init];
  if (v4)
  {
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v18[1] = 0;
  v17 = v18;
  v4 = objc_msgSend_chargingTargetSchedules(self, a3, (uint64_t)a4);
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24481C63C((uint64_t *)&v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
