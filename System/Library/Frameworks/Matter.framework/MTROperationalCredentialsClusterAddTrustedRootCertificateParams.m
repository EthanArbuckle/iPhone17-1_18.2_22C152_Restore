...
- (id)description;
- (void)setRootCACertificate:(NSData *)rootCACertificate;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTROperationalCredentialsClusterAddTrustedRootCertificateParams;
  v4 = [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)&v10 init];
  if (v4)
  {
    uint64_t v5 = objc_msgSend_data(MEMORY[0x263EFF8F8], v2, v3);
    rootCACertificate = v4->_rootCACertificate;
    v4->_rootCACertificate = (NSData *)v5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_rootCACertificate(self, v5, v6);
  objc_msgSend_setRootCACertificate_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_base64EncodedStringWithOptions_(self->_rootCACertificate, v6, 0);
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: rootCACertificate:%@ >", v5, v7);;
...
- (NSData)rootCACertificate
{
  return self->_rootCACertificate;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_rootCACertificate, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v21[1] = 0;
  v20 = v21;
  objc_msgSend_rootCACertificate(self, a3, (uint64_t)a4);
