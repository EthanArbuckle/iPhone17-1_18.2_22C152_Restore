...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRUnitTestingClusterStringEchoResponseParams;
  v4 = [(MTRUnitTestingClusterStringEchoResponseParams *)&v8 init];
  if (v4)
  {
...
- (MTRUnitTestingClusterStringEchoResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRUnitTestingClusterStringEchoResponseParams;
  objc_super v8 = [(MTRUnitTestingClusterStringEchoResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4294048773, 13, a4);
  if (v36)
  {
    ...
    {
      long long v32 = 0uLL;
      sub_244847518(&v32, (uint64_t)v35, (uint64_t)buf);
