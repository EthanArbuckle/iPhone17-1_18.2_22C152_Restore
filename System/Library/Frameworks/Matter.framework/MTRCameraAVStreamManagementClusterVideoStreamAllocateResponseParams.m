@interface MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3;
- (MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams)init;
- (MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams;
  v2 = [(MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: videoStreamID:%@ >", v5, self->_videoStreamID);;
...
- (MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams;
  v8 = [(MTRCameraAVStreamManagementClusterVideoStreamAllocateResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1361, 4, a4);
  if (v36)
  {
    ...
    {
      __int16 v32 = 0;
      sub_24483DE0C(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setVideoStreamID_(self, v7, (uint64_t)v6);
