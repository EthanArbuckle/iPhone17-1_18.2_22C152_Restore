...
- (MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  objc_super v8 = [(MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v37)
  {
    ...
    if (!v34)
    {
      ...
      *((void *)&buf + 1) = 0;
      uint64_t v42 = 0;
      sub_2447FD08C((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  {
    *(_OWORD *)&retstr->mError = xmmword_265193F90;
    *(void *)&retstr->mLine = 5393;
  }
  return result;
}
