@interface MTRDoorLockClusterClearUserParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDoorLockClusterClearUserParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRDoorLockClusterClearUserParams;
  v2 = [(MTRDoorLockClusterClearUserParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDoorLockClusterClearUserParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: userIndex:%@ >", v5, self->_userIndex);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_userIndex(self, a3, (uint64_t)a4);
