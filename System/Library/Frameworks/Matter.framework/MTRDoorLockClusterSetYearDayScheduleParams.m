...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: yearDayIndex:%@; userIndex:%@; localStartTime:%@; localEndTime:%@; >",
    v5,
    self->_yearDayIndex,
    self->_userIndex,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  __int16 v35 = objc_msgSend_unsignedShortValue(v12, v13, v14);

  v17 = objc_msgSend_localStartTime(self, v15, v16);
  LODWORD(v36) = objc_msgSend_unsignedIntValue(v17, v18, v19);

  uint64_t v22 = objc_msgSend_localEndTime(self, v20, v21);
  ...
  if (v31)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24481FE90(v26, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
