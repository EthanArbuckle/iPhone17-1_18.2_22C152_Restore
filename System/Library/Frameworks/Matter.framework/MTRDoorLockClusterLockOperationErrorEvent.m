...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = objc_msgSend_operationSource(self, v9, v10);
  objc_msgSend_setOperationSource_(v4, v12, (uint64_t)v11);

  v15 = objc_msgSend_operationError(self, v13, v14);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: lockOperationType:%@; operationSource:%@; operationError:%@; userIndex:%@; fabricIndex:%@; sourceNode:%@; credentials:%@; >",
    v5,
