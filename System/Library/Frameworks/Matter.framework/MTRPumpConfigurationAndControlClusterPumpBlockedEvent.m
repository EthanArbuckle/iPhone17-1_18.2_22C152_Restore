...
{
  v3.receiver = self;
  v3.super_class = (Class)MTRPumpConfigurationAndControlClusterPumpBlockedEvent;
  return [(MTRPumpConfigurationAndControlClusterPumpBlockedEvent *)&v3 init];
}

- (id)copyWithZone:(_NSZone *)a3
{
  return objc_alloc_init(MTRPumpConfigurationAndControlClusterPumpBlockedEvent);
}
