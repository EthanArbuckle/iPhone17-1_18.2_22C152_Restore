@interface MTROperationalCredentialsClusterUpdateFabricLabelParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTROperationalCredentialsClusterUpdateFabricLabelParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTROperationalCredentialsClusterUpdateFabricLabelParams;
  v2 = [(MTROperationalCredentialsClusterUpdateFabricLabelParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    label = v2->_label;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTROperationalCredentialsClusterUpdateFabricLabelParams);
  v7 = objc_msgSend_label(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: label:%@ >", v5, self->_label);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v20[1] = 0;
  v19 = v20;
  objc_msgSend_label(self, a3, (uint64_t)a4);
