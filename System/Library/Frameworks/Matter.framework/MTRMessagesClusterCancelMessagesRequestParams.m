@interface MTRMessagesClusterCancelMessagesRequestParams
...
- (MTRMessagesClusterCancelMessagesRequestParams)init
{
  ...
  v4 = [(MTRMessagesClusterCancelMessagesRequestParams *)&v10 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_messageIDs(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: messageIDs:%@ >", v5, self->_messageIDs);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  *(_OWORD *)v19 = 0uLL;
  ...
  v18[1] = 0;
  v17 = v18;
  uint64_t v6 = objc_msgSend_messageIDs(self, a3, (uint64_t)a4);
  ...
  *(_OWORD *)v19 = 0uLL;
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244818B3C(v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
