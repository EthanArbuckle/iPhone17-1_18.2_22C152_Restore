@interface MTRUnitTestingClusterTestBatchHelperRequestParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRUnitTestingClusterTestBatchHelperRequestParams)init;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRUnitTestingClusterTestBatchHelperRequestParams;
  v2 = [(MTRUnitTestingClusterTestBatchHelperRequestParams *)&v10 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRUnitTestingClusterTestBatchHelperRequestParams);
