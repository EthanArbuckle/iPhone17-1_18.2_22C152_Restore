@interface MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams;
  v2 = [(MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams);
  v7 = objc_msgSend_commissioningTimeout(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: commissioningTimeout:%@; >",
    v5,
  v7 = self->_commissioningTimeout);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_commissioningTimeout(self, a3, (uint64_t)a4);
