...
- (id)description;
- (void)setAttributeRequests:(id)a3;
...
{
  v13.receiver = self;
  v13.super_class = (Class)MTRThermostatClusterAtomicRequestParams;
  v2 = [(MTRThermostatClusterAtomicRequestParams *)&v13 init];
  v3 = v2;
  if (v2)
  {
    requestType = v2->_requestType;
    v2->_requestType = (NSNumber *)&unk_26F9C8548;

    uint64_t v7 = objc_msgSend_array(MEMORY[0x263EFF8C0], v5, v6);
    attributeRequests = v3->_attributeRequests;
    v3->_attributeRequests = (NSArray *)v7;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_msgSend_setRequestType_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_attributeRequests(self, v9, v10);
  objc_msgSend_setAttributeRequests_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: requestType:%@; attributeRequests:%@; timeout:%@; >",
    v5,
    self->_requestType,
    self->_attributeRequests,
...
- (NSArray)attributeRequests
{
  return self->_attributeRequests;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_attributeRequests, 0);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v32[1] = 0;
  v31 = v32;
  uint64_t v7 = objc_msgSend_requestType(self, a3, (uint64_t)a4);
  v33[0] = objc_msgSend_unsignedCharValue(v7, v8, v9);

  v12 = objc_msgSend_attributeRequests(self, v10, v11);
  ...
  uint64_t v34 = 0;
  uint64_t v35 = 0;
  uint64_t v18 = objc_msgSend_timeout(self, v16, v17);

  if (v18)
  {
    char v36 = 1;
    __int16 v37 = 0;
    v21 = objc_msgSend_timeout(self, v19, v20);
    __int16 v37 = objc_msgSend_unsignedShortValue(v21, v22, v23);
  }
  ...
  if (v30)
  {
    ...
    sub_244CB6318((uint64_t)v25, (uint64_t)&v26, 0xFFFFFFFF, (uint64_t)v38);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244829020((uint64_t)v33, v25, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
