@interface MTRScenesManagementClusterGetSceneMembershipParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRScenesManagementClusterGetSceneMembershipParams)init;
- (NSNumber)groupID;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRScenesManagementClusterGetSceneMembershipParams;
  v2 = [(MTRScenesManagementClusterGetSceneMembershipParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    groupID = v2->_groupID;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRScenesManagementClusterGetSceneMembershipParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: groupID:%@ >", v5, self->_groupID);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_groupID(self, a3, (uint64_t)a4);
