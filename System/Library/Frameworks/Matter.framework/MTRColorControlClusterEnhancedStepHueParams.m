@interface MTRColorControlClusterEnhancedStepHueParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRColorControlClusterEnhancedStepHueParams)init;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRColorControlClusterEnhancedStepHueParams;
  v2 = [(MTRColorControlClusterEnhancedStepHueParams *)&v12 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRColorControlClusterEnhancedStepHueParams);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v39[0] = objc_msgSend_unsignedCharValue(v7, v8, v9);

  objc_super v12 = objc_msgSend_stepSize(self, v10, v11);
  LOWORD(v40) = objc_msgSend_unsignedShortValue(v12, v13, v14);

  v17 = objc_msgSend_transitionTime(self, v15, v16);
  HIWORD(v40) = objc_msgSend_unsignedShortValue(v17, v18, v19);

  uint64_t v22 = objc_msgSend_optionsMask(self, v20, v21);
  LOBYTE(v41) = objc_msgSend_unsignedCharValue(v22, v23, v24);
  ...
  if (v36)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482C0B4(v39, v31, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
