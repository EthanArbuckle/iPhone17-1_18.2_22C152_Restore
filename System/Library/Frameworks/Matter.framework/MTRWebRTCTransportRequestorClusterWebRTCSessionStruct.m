@interface MTRWebRTCTransportRequestorClusterWebRTCSessionStruct
- (MTRWebRTCTransportRequestorClusterWebRTCSessionStruct)init;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRWebRTCTransportRequestorClusterWebRTCSessionStruct;
  v2 = [(MTRWebRTCTransportRequestorClusterWebRTCSessionStruct *)&v12 init];
  v3 = v2;
  if (v2)
  {
    id = v2->_id;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRWebRTCTransportRequestorClusterWebRTCSessionStruct);
