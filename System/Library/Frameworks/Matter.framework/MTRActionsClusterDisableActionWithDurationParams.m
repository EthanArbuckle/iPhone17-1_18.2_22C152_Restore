@interface MTRActionsClusterDisableActionWithDurationParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRActionsClusterDisableActionWithDurationParams)init;
- (NSNumber)actionID;
- (NSNumber)duration;
- (NSNumber)invokeID;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRActionsClusterDisableActionWithDurationParams;
  v2 = [(MTRActionsClusterDisableActionWithDurationParams *)&v10 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRActionsClusterDisableActionWithDurationParams);
