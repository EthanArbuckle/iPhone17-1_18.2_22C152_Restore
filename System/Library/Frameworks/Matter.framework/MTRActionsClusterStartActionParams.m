@interface MTRActionsClusterStartActionParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRActionsClusterStartActionParams)init;
- (NSNumber)actionID;
- (NSNumber)invokeID;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRActionsClusterStartActionParams;
  v2 = [(MTRActionsClusterStartActionParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRActionsClusterStartActionParams);
