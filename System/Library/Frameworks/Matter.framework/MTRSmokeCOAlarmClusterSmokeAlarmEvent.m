@interface MTRSmokeCOAlarmClusterSmokeAlarmEvent
- (MTRSmokeCOAlarmClusterSmokeAlarmEvent)init;
...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRSmokeCOAlarmClusterSmokeAlarmEvent;
  v2 = [(MTRSmokeCOAlarmClusterSmokeAlarmEvent *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRSmokeCOAlarmClusterSmokeAlarmEvent);
