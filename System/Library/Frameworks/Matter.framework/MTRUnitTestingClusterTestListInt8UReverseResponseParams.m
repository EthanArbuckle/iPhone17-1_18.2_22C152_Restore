...
- (MTRUnitTestingClusterTestListInt8UReverseResponseParams)init
{
  ...
  v4 = [(MTRUnitTestingClusterTestListInt8UReverseResponseParams *)&v9 init];
  if (v4)
  {
...
- (MTRUnitTestingClusterTestListInt8UReverseResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v8 = [(MTRUnitTestingClusterTestListInt8UReverseResponseParams *)&v39 init];
  if (!v8)
  {
    v31 = 0;
    goto LABEL_16;
  ...
  if (v38)
  {
    ...
    if (!v35)
    {
      ...
      sub_24484548C((uint64_t)&buf, (uint64_t)v37, (uint64_t)&v33);
      long long v35 = v33;
      uint64_t v36 = v34;
      if (!v33)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  while (sub_2447959C0((uint64_t)v12))
  {
    uint64_t v9 = objc_msgSend_numberWithUnsignedChar_(NSNumber, v8, v12[0]);
