...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRDoorLockClusterUnlockWithTimeoutParams;
  v2 = [(MTRDoorLockClusterUnlockWithTimeoutParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    timeout = v2->_timeout;
    v2->_timeout = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_timeout(self, v5, v6);
  objc_msgSend_setTimeout_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_pinCode(self, v9, v10);
  objc_msgSend_setPinCode_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  v8 = objc_msgSend_base64EncodedStringWithOptions_(self->_pinCode, v7, 0);
  uint64_t v10 = objc_msgSend_stringWithFormat_(v3, v9, @"<%@: timeout:%@ pinCode:%@; >", v5, timeout, v8);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v30[1] = 0;
  v29 = v30;
  v7 = objc_msgSend_timeout(self, a3, (uint64_t)a4);
  __int16 v31 = objc_msgSend_unsignedShortValue(v7, v8, v9);

  v12 = objc_msgSend_pinCode(self, v10, v11);

  if (v12)
  {
    char v32 = 1;
    long long v33 = 0uLL;
    objc_msgSend_pinCode(self, v13, v14);
  ...
  if (v28)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24481F224((uint64_t)&v31, v23, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
