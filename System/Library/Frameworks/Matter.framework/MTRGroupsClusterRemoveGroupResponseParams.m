...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRGroupsClusterRemoveGroupResponseParams;
...
- (MTRGroupsClusterRemoveGroupResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v38.receiver = self;
  v38.super_class = (Class)MTRGroupsClusterRemoveGroupResponseParams;
  objc_super v8 = [(MTRGroupsClusterRemoveGroupResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4, 3, error);
  if (v37)
  {
    ...
    if (!v34)
    {
      v32[0] = 0;
      __int16 v33 = 0;
      sub_2447F176C((uint64_t)v32, (uint64_t)v36, (uint64_t)&buf);
      long long v34 = buf;
      uint64_t v35 = v42;
      if (!buf)
      {
