...
- (MTRICDManagementClusterRegisterClientResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
- (NSNumber)icdCounter;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (void)setIcdCounter:(id)a3;
@end
...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRICDManagementClusterRegisterClientResponseParams;
  v2 = [(MTRICDManagementClusterRegisterClientResponseParams *)&v6 init];
  v3 = v2;
  if (v2)
  {
    icdCounter = v2->_icdCounter;
    v2->_icdCounter = (NSNumber *)&unk_26F9C8548;
  }
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_icdCounter(self, v5, v6);
  objc_msgSend_setIcdCounter_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: icdCounter:%@ >", v5, self->_icdCounter);;
...
- (MTRICDManagementClusterRegisterClientResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRICDManagementClusterRegisterClientResponseParams;
  v8 = [(MTRICDManagementClusterRegisterClientResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 70, 1, a4);
  if (v36)
  {
    ...
    {
      int v32 = 0;
      sub_24480B788(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  id v6 = objc_msgSend_numberWithUnsignedInt_(NSNumber, a3, *(unsigned int *)&a4->var0);
  objc_msgSend_setIcdCounter_(self, v7, (uint64_t)v6);
