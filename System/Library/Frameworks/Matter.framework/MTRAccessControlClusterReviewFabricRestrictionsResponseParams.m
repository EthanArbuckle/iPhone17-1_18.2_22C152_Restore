...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRAccessControlClusterReviewFabricRestrictionsResponseParams;
  v2 = [(MTRAccessControlClusterReviewFabricRestrictionsResponseParams *)&v6 init];
  v3 = v2;
  if (v2)
  {
    token = v2->_token;
    v2->_token = (NSNumber *)&unk_26F9C8548;
  }
  return v3;
}
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: token:%@ >", v5, self->_token);;
...
- (MTRAccessControlClusterReviewFabricRestrictionsResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRAccessControlClusterReviewFabricRestrictionsResponseParams;
  v8 = [(MTRAccessControlClusterReviewFabricRestrictionsResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 31, 1, a4);
  if (v36)
  {
    ...
    {
      uint64_t v32 = 0;
      sub_2447F587C(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  id v6 = objc_msgSend_numberWithUnsignedLongLong_(NSNumber, a3, *(void *)&a4->var0);
  objc_msgSend_setToken_(self, v7, (uint64_t)v6);
