...
- (id)description
{
  ...
  objc_super v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: ssid:%@ breadcrumb:%@; >", v5, v7, self->_breadcrumb);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v32[1] = 0;
  v31 = v32;
  v7 = objc_msgSend_ssid(self, a3, (uint64_t)a4);
  ...
  if (v7)
  {
    ...
    uint64_t v35 = 0;
    long long v34 = 0uLL;
    uint64_t v10 = objc_msgSend_ssid(self, v8, v9);
    ...
    if (v10)
    {
      ...
      sub_2446C1098(v25, v14, v17);

      long long v34 = *(_OWORD *)v25;
    }
  }
  uint64_t v18 = objc_msgSend_breadcrumb(self, v8, v9);
  ...
  if (v18)
  {
    ...
    uint64_t v37 = objc_msgSend_unsignedLongLongValue(v21, v22, v23);
  }
  ...
  if (v30)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447FE1B4(v33, v25, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
