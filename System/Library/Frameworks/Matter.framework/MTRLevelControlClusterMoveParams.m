@interface MTRLevelControlClusterMoveParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRLevelControlClusterMoveParams)init;
- (NSNumber)moveMode;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTRLevelControlClusterMoveParams;
  v2 = [(MTRLevelControlClusterMoveParams *)&v11 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRLevelControlClusterMoveParams);
