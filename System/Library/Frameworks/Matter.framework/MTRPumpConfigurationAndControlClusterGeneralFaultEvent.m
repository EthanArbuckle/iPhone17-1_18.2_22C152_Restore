...
{
  v3.receiver = self;
  v3.super_class = (Class)MTRPumpConfigurationAndControlClusterGeneralFaultEvent;
  return [(MTRPumpConfigurationAndControlClusterGeneralFaultEvent *)&v3 init];
}

- (id)copyWithZone:(_NSZone *)a3
{
  return objc_alloc_init(MTRPumpConfigurationAndControlClusterGeneralFaultEvent);
}
