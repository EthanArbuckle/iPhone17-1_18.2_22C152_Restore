@interface MTRDemandResponseLoadControlClusterRemoveLoadControlEventRequestParams
...
- (MTRDemandResponseLoadControlClusterRemoveLoadControlEventRequestParams)init
{
  ...
  v4 = [(MTRDemandResponseLoadControlClusterRemoveLoadControlEventRequestParams *)&v11 init];
  if (v4)
  {
    ...
    v4->_cancelControl = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_super v11 = objc_msgSend_cancelControl(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v8, @"<%@: eventID:%@; cancelControl:%@; >",
    v5,
    v7,
  v9 = self->_cancelControl);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v16 = objc_msgSend_cancelControl(self, v14, v15);
  __int16 v29 = objc_msgSend_unsignedShortValue(v16, v17, v18);
  ...
  if (v25)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2448178E4((uint64_t)&v28, v20, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
