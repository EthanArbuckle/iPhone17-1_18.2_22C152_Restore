@interface MTRZoneManagementClusterRemoveZoneParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRZoneManagementClusterRemoveZoneParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRZoneManagementClusterRemoveZoneParams;
  v2 = [(MTRZoneManagementClusterRemoveZoneParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    zoneID = v2->_zoneID;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRZoneManagementClusterRemoveZoneParams);
