@interface MTRMediaPlaybackClusterSeekParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRMediaPlaybackClusterSeekParams)init;
- (NSNumber)position;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRMediaPlaybackClusterSeekParams;
  v2 = [(MTRMediaPlaybackClusterSeekParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    position = v2->_position;
    v2->_position = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRMediaPlaybackClusterSeekParams);
  v7 = objc_msgSend_position(self, v5, v6);
  objc_msgSend_setPosition_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: position:%@ >", v5, self->_position);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_position(self, a3, (uint64_t)a4);
