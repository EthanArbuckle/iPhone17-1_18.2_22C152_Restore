...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRICDManagementClusterStayActiveResponseParams;
  v2 = [(MTRICDManagementClusterStayActiveResponseParams *)&v6 init];
  v3 = v2;
  if (v2)
  {
    promisedActiveDuration = v2->_promisedActiveDuration;
    v2->_promisedActiveDuration = (NSNumber *)&unk_26F9C8548;
  }
  return v3;
}
...
- (MTRICDManagementClusterStayActiveResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRICDManagementClusterStayActiveResponseParams;
  v8 = [(MTRICDManagementClusterStayActiveResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 70, 4, a4);
  if (v36)
  {
    ...
    {
      int v32 = 0;
      sub_24480BB58(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setPromisedActiveDuration_(self, v7, (uint64_t)v6);
