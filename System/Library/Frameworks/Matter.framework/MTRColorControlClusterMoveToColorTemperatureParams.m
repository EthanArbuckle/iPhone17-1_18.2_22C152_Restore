...
- (id)description;
- (void)setColorTemperatureMireds:(NSNumber *)colorTemperatureMireds;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTRColorControlClusterMoveToColorTemperatureParams;
  v2 = [(MTRColorControlClusterMoveToColorTemperatureParams *)&v11 init];
  v3 = v2;
  if (v2)
  {
    colorTemperatureMireds = v2->_colorTemperatureMireds;
    v2->_colorTemperatureMireds = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_colorTemperatureMireds(self, v5, v6);
  objc_msgSend_setColorTemperatureMireds_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: colorTemperatureMireds:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_colorTemperatureMireds,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v33[1] = 0;
  v32 = v33;
  v7 = objc_msgSend_colorTemperatureMireds(self, a3, (uint64_t)a4);
  LOWORD(v34) = objc_msgSend_unsignedShortValue(v7, v8, v9);

  v12 = objc_msgSend_transitionTime(self, v10, v11);
  HIWORD(v34) = objc_msgSend_unsignedShortValue(v12, v13, v14);
  ...
  if (v31)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482B81C(v26, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
