...
- (MTRGroupKeyManagementClusterKeySetReadAllIndicesParams)init;
...
{
  v7.receiver = self;
  v7.super_class = (Class)MTRGroupKeyManagementClusterKeySetReadAllIndicesParams;
  v2 = [(MTRGroupKeyManagementClusterKeySetReadAllIndicesParams *)&v7 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRGroupKeyManagementClusterKeySetReadAllIndicesParams);
