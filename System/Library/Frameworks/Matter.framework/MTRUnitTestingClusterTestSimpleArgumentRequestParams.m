@interface MTRUnitTestingClusterTestSimpleArgumentRequestParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRUnitTestingClusterTestSimpleArgumentRequestParams)init;
- (NSNumber)arg1;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRUnitTestingClusterTestSimpleArgumentRequestParams;
  v2 = [(MTRUnitTestingClusterTestSimpleArgumentRequestParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRUnitTestingClusterTestSimpleArgumentRequestParams);
