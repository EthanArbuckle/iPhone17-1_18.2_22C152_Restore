...
- (id)description;
- (void)setColorX:(NSNumber *)colorX;
- (void)setColorY:(NSNumber *)colorY;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRColorControlClusterMoveToColorParams;
  v2 = [(MTRColorControlClusterMoveToColorParams *)&v12 init];
  v3 = v2;
  if (v2)
  {
    colorX = v2->_colorX;
    v2->_colorX = (NSNumber *)&unk_26F9C8548;

    colorY = v3->_colorY;
    v3->_colorY = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_colorX(self, v5, v6);
  objc_msgSend_setColorX_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_colorY(self, v9, v10);
  objc_msgSend_setColorY_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: colorX:%@; colorY:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_colorX,
    self->_colorY,
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_colorY, 0);

  objc_storeStrong((id *)&self->_colorX, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  v7 = objc_msgSend_colorX(self, a3, (uint64_t)a4);
  LOWORD(v39) = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_super v12 = objc_msgSend_colorY(self, v10, v11);
  WORD1(v39) = objc_msgSend_unsignedShortValue(v12, v13, v14);

  v17 = objc_msgSend_transitionTime(self, v15, v16);
  WORD2(v39) = objc_msgSend_unsignedShortValue(v17, v18, v19);

  uint64_t v22 = objc_msgSend_optionsMask(self, v20, v21);
  BYTE6(v39) = objc_msgSend_unsignedCharValue(v22, v23, v24);

  v27 = objc_msgSend_optionsOverride(self, v25, v26);
  HIBYTE(v39) = objc_msgSend_unsignedCharValue(v27, v28, v29);
  ...
  if (v36)
  {
    ...
    sub_244CB6318((uint64_t)v31, (uint64_t)&v32, 0xFFFFFFFF, (uint64_t)v40);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482AF08(v31, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
