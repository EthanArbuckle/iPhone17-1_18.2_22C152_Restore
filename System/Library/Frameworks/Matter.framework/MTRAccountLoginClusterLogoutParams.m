...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRAccountLoginClusterLogoutParams;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v21[1] = 0;
  v20 = v21;
  v7 = objc_msgSend_node(self, a3, (uint64_t)a4);

  if (v7)
  {
    v22[0] = 1;
    uint64_t v23 = 0;
    uint64_t v10 = objc_msgSend_node(self, v8, v9);
    uint64_t v23 = objc_msgSend_unsignedLongLongValue(v10, v11, v12);
  }
  ...
  if (v19)
  {
    ...
    sub_244CB6318((uint64_t)v14, (uint64_t)&v15, 0xFFFFFFFF, (uint64_t)v24);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244838E68(v22, v14, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
