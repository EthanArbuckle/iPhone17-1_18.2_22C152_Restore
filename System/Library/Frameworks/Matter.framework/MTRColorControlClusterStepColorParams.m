...
- (void)setStepX:(NSNumber *)stepX;
- (void)setStepY:(NSNumber *)stepY;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRColorControlClusterStepColorParams;
  v2 = [(MTRColorControlClusterStepColorParams *)&v12 init];
  v3 = v2;
  if (v2)
  {
    stepX = v2->_stepX;
    v2->_stepX = (NSNumber *)&unk_26F9C8548;

    stepY = v3->_stepY;
    v3->_stepY = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_stepX(self, v5, v6);
  objc_msgSend_setStepX_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_stepY(self, v9, v10);
  objc_msgSend_setStepY_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: stepX:%@; stepY:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_stepX,
    self->_stepY,
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_stepY, 0);

  objc_storeStrong((id *)&self->_stepX, 0);
}
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  v7 = objc_msgSend_stepX(self, a3, (uint64_t)a4);
  LOWORD(v39) = objc_msgSend_shortValue(v7, v8, v9);

  objc_super v12 = objc_msgSend_stepY(self, v10, v11);
  WORD1(v39) = objc_msgSend_shortValue(v12, v13, v14);
  ...
  if (v36)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482B4FC(v31, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
