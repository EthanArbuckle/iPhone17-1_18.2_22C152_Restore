...
{
  v7.receiver = self;
  v7.super_class = (Class)MTRServiceAreaClusterSelectAreasResponseParams;
  v2 = [(MTRServiceAreaClusterSelectAreasResponseParams *)&v7 init];
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
- (MTRServiceAreaClusterSelectAreasResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v38.receiver = self;
  v38.super_class = (Class)MTRServiceAreaClusterSelectAreasResponseParams;
  v8 = [(MTRServiceAreaClusterSelectAreasResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 336, 1, a4);
  if (v37)
  {
    ...
    if (!v34)
    {
      ...
      *((void *)&buf + 1) = 0;
      uint64_t v42 = 0;
      sub_2448267C8((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  {
    *(_OWORD *)&retstr->mError = xmmword_2651941D0;
    *(void *)&retstr->mLine = 22246;
  }
  return result;
}
