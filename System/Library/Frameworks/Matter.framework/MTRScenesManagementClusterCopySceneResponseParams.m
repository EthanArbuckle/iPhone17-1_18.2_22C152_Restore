...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: status:%@; groupIdentifierFrom:%@; sceneIdentifierFrom:%@; >",
    v5,
    self->_status,
    self->_groupIdentifierFrom,
  v7 = self->_sceneIdentifierFrom);
...
- (MTRScenesManagementClusterCopySceneResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  objc_super v8 = [(MTRScenesManagementClusterCopySceneResponseParams *)&v39 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  ...
  if (v38)
  {
    ...
    if (!v35)
    {
      ...
      __int16 v33 = 0;
      char v34 = 0;
      sub_244812B54((uint64_t)v32, (uint64_t)v37, (uint64_t)&buf);
      long long v35 = buf;
      uint64_t v36 = v43;
      if (!buf)
      {
