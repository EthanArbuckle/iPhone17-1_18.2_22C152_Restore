@interface MTRChannelClusterSkipChannelParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRChannelClusterSkipChannelParams)init;
- (NSNumber)getCount;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRChannelClusterSkipChannelParams;
  v2 = [(MTRChannelClusterSkipChannelParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    count = v2->_count;
    v2->_count = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRChannelClusterSkipChannelParams);
  v7 = objc_msgSend_getCount(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: count:%@ >", v5, self->_count);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_getCount(self, a3, (uint64_t)a4);
  __int16 v18 = objc_msgSend_shortValue(v6, v7, v8);
  ...
  if (v15)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2448321E0(v10, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
