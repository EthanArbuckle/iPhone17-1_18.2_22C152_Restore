...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRApplicationLauncherClusterLauncherResponseParams;
...
- (id)description
{
  ...
  status = self->_status;
  objc_super v8 = objc_msgSend_base64EncodedStringWithOptions_(self->_data, v7, 0);
  uint64_t v10 = objc_msgSend_stringWithFormat_(v3, v9, @"<%@: status:%@ data:%@; >", v5, status, v8);;
...
- (MTRApplicationLauncherClusterLauncherResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v38.receiver = self;
  v38.super_class = (Class)MTRApplicationLauncherClusterLauncherResponseParams;
  objc_super v8 = [(MTRApplicationLauncherClusterLauncherResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1292, 3, error);
  if (v37)
  {
    ...
    if (!v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_244838578(&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    uint64_t v14 = objc_msgSend_dataWithBytes_length_(MEMORY[0x263EFF8F8], v13, *v12, v12[1]);
    objc_msgSend_setData_(self, v15, (uint64_t)v14);
  }
  else
  {
