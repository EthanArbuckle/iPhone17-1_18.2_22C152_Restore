@interface MTROvenModeClusterChangeToModeParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTROvenModeClusterChangeToModeParams)init;
- (NSNumber)getNewMode;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTROvenModeClusterChangeToModeParams;
  v2 = [(MTROvenModeClusterChangeToModeParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    newMode = v2->_newMode;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTROvenModeClusterChangeToModeParams);
