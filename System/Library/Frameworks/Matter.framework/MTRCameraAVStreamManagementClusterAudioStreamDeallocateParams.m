@interface MTRCameraAVStreamManagementClusterAudioStreamDeallocateParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRCameraAVStreamManagementClusterAudioStreamDeallocateParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRCameraAVStreamManagementClusterAudioStreamDeallocateParams;
  v2 = [(MTRCameraAVStreamManagementClusterAudioStreamDeallocateParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    audioStreamID = v2->_audioStreamID;
    v2->_audioStreamID = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRCameraAVStreamManagementClusterAudioStreamDeallocateParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: audioStreamID:%@ >", v5, self->_audioStreamID);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_audioStreamID(self, a3, (uint64_t)a4);
