...
- (MTRBasicInformationClusterCapabilityMinimaStruct)init
{
  ...
  if (v2)
  {
    ...
    v2->_caseSessionsPerFabric = (NSNumber *)&unk_26F9C8620;

    subscriptionsPerFabric = v3->_subscriptionsPerFabric;
    v3->_subscriptionsPerFabric = (NSNumber *)&unk_26F9C8620;
  }
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_super v7 = objc_msgSend_caseSessionsPerFabric(self, v5, v6);
  objc_msgSend_setCaseSessionsPerFabric_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_subscriptionsPerFabric(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: caseSessionsPerFabric:%@; subscriptionsPerFabric:%@; >",
    v5,
    self->_caseSessionsPerFabric,
  objc_super v7 = self->_subscriptionsPerFabric);
