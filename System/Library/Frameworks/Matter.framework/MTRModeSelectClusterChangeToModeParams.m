@interface MTRModeSelectClusterChangeToModeParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRModeSelectClusterChangeToModeParams)init;
- (NSNumber)getNewMode;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRModeSelectClusterChangeToModeParams;
  v2 = [(MTRModeSelectClusterChangeToModeParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    newMode = v2->_newMode;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRModeSelectClusterChangeToModeParams);
