@interface MTRActionsClusterInstantActionWithTransitionParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRActionsClusterInstantActionWithTransitionParams)init;
- (NSNumber)actionID;
- (NSNumber)invokeID;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRActionsClusterInstantActionWithTransitionParams;
  v2 = [(MTRActionsClusterInstantActionWithTransitionParams *)&v10 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRActionsClusterInstantActionWithTransitionParams);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: actionID:%@; invokeID:%@; transitionTime:%@; >",
    v5,
    self->_actionID,
    self->_invokeID,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  uint64_t v18 = objc_msgSend_transitionTime(self, v13, v14);
  __int16 v33 = objc_msgSend_unsignedShortValue(v18, v19, v20);
  ...
  if (v27)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447F7008((uint64_t)v30, v22, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
