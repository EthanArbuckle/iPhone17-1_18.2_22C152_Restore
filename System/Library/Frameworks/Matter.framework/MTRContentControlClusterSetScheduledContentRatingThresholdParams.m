@interface MTRContentControlClusterSetScheduledContentRatingThresholdParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRContentControlClusterSetScheduledContentRatingThresholdParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRContentControlClusterSetScheduledContentRatingThresholdParams;
  v2 = [(MTRContentControlClusterSetScheduledContentRatingThresholdParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    rating = v2->_rating;
    v2->_rating = (NSString *)&stru_26F969DC8;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRContentControlClusterSetScheduledContentRatingThresholdParams);
  v7 = objc_msgSend_rating(self, v5, v6);
  objc_msgSend_setRating_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: rating:%@ >", v5, self->_rating);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v20[1] = 0;
  v19 = v20;
  objc_msgSend_rating(self, a3, (uint64_t)a4);
