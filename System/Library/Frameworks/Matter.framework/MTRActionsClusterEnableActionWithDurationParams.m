@interface MTRActionsClusterEnableActionWithDurationParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRActionsClusterEnableActionWithDurationParams)init;
- (NSNumber)actionID;
- (NSNumber)duration;
- (NSNumber)invokeID;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRActionsClusterEnableActionWithDurationParams;
  v2 = [(MTRActionsClusterEnableActionWithDurationParams *)&v10 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRActionsClusterEnableActionWithDurationParams);
