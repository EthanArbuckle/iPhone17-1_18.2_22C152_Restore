@interface MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams)init;
- (NSNumber)arg1;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams;
  v2 = [(MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRUnitTestingClusterTestEmitTestFabricScopedEventRequestParams);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_arg1(self, a3, (uint64_t)a4);
