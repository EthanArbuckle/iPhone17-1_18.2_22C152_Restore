@interface MTRWebRTCTransportProviderClusterProvideAnswerParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRWebRTCTransportProviderClusterProvideAnswerParams)init;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRWebRTCTransportProviderClusterProvideAnswerParams;
  v2 = [(MTRWebRTCTransportProviderClusterProvideAnswerParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRWebRTCTransportProviderClusterProvideAnswerParams);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: webRTCSessionID:%@; sdp:%@; >",
    v5,
