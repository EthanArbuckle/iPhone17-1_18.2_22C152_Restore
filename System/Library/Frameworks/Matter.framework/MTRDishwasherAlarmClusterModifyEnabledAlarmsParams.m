@interface MTRDishwasherAlarmClusterModifyEnabledAlarmsParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDishwasherAlarmClusterModifyEnabledAlarmsParams)init;
- (NSNumber)mask;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRDishwasherAlarmClusterModifyEnabledAlarmsParams;
  v2 = [(MTRDishwasherAlarmClusterModifyEnabledAlarmsParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    mask = v2->_mask;
    v2->_mask = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDishwasherAlarmClusterModifyEnabledAlarmsParams);
  v7 = objc_msgSend_mask(self, v5, v6);
  objc_msgSend_setMask_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: mask:%@ >", v5, self->_mask);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_mask(self, a3, (uint64_t)a4);
