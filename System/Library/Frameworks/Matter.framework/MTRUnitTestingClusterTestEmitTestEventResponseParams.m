...
{
  v7.receiver = self;
  v7.super_class = (Class)MTRUnitTestingClusterTestEmitTestEventResponseParams;
  v2 = [(MTRUnitTestingClusterTestEmitTestEventResponseParams *)&v7 init];
  v3 = v2;
  if (v2)
  {
    value = v2->_value;
...
- (MTRUnitTestingClusterTestEmitTestEventResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v37.receiver = self;
  v37.super_class = (Class)MTRUnitTestingClusterTestEmitTestEventResponseParams;
  v8 = [(MTRUnitTestingClusterTestEmitTestEventResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4294048773, 10, error);
  if (v36)
  {
    ...
    {
      uint64_t v32 = 0;
      sub_244846ED4(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
