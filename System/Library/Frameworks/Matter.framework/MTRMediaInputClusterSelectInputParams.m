@interface MTRMediaInputClusterSelectInputParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRMediaInputClusterSelectInputParams)init;
- (NSNumber)index;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRMediaInputClusterSelectInputParams;
  v2 = [(MTRMediaInputClusterSelectInputParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRMediaInputClusterSelectInputParams);
