@interface MTRMediaPlaybackClusterActivateTextTrackParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRMediaPlaybackClusterActivateTextTrackParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRMediaPlaybackClusterActivateTextTrackParams;
  v2 = [(MTRMediaPlaybackClusterActivateTextTrackParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    trackID = v2->_trackID;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRMediaPlaybackClusterActivateTextTrackParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: trackID:%@ >", v5, self->_trackID);;
