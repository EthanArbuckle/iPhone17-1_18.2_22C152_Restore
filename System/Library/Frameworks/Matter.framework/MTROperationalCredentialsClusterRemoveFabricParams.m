...
{
  v8.receiver = self;
  v8.super_class = (Class)MTROperationalCredentialsClusterRemoveFabricParams;
  v2 = [(MTROperationalCredentialsClusterRemoveFabricParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    fabricIndex = v2->_fabricIndex;
    v2->_fabricIndex = (NSNumber *)&unk_26F9C8548;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_fabricIndex(self, a3, (uint64_t)a4);
