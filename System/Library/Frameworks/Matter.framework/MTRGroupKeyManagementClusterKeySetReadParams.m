@interface MTRGroupKeyManagementClusterKeySetReadParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRGroupKeyManagementClusterKeySetReadParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRGroupKeyManagementClusterKeySetReadParams;
  v2 = [(MTRGroupKeyManagementClusterKeySetReadParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRGroupKeyManagementClusterKeySetReadParams);
