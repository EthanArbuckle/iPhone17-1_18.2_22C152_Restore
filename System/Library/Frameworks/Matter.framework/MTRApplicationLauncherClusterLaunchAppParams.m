...
- (MTRApplicationLauncherClusterLaunchAppParams)init
{
  ...
  v2 = [(MTRApplicationLauncherClusterLaunchAppParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  v8 = objc_msgSend_base64EncodedStringWithOptions_(self->_data, v7, 0);
  uint64_t v10 = objc_msgSend_stringWithFormat_(v3, v9, @"<%@: application:%@ data:%@; >", v5, application, v8);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v7)
  {
    ...
    uint64_t v18 = objc_msgSend_application(self, v16, v17);
    ...
    sub_24479476C(v38, v24, v26);

    long long v48 = *(_OWORD *)v38;
  }
  v27 = objc_msgSend_data(self, v8, v9);
  ...
  if (v27)
  {
    ...
    sub_2446C1098(v38, v33, v36);

    long long v50 = *(_OWORD *)v38;
  }
  ...
  if (v43)
  {
    ...
    sub_244CB6318((uint64_t)v38, (uint64_t)&v39, 0xFFFFFFFF, (uint64_t)v51);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244837F8C(v46, v38, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
