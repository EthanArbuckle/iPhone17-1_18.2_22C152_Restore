...
- (MTRScenesManagementClusterAddSceneResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
- (NSNumber)groupID;
- (NSNumber)sceneID;
- (NSNumber)status;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRScenesManagementClusterAddSceneResponseParams;
...
- (MTRScenesManagementClusterAddSceneResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v39.receiver = self;
  v39.super_class = (Class)MTRScenesManagementClusterAddSceneResponseParams;
  objc_super v8 = [(MTRScenesManagementClusterAddSceneResponseParams *)&v39 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 98, 0, a4);
  if (v38)
  {
    ...
    if (!v35)
    {
      ...
      __int16 v33 = 0;
      char v34 = 0;
      sub_2448114C4((uint64_t)v32, (uint64_t)v37, (uint64_t)&buf);
      long long v35 = buf;
      uint64_t v36 = v43;
      if (!buf)
      {
