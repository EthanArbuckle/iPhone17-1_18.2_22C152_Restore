...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRNetworkCommissioningClusterReorderNetworkParams;
  v4 = [(MTRNetworkCommissioningClusterReorderNetworkParams *)&v12 init];
  if (v4)
  {
    ...
    networkIndex = v4->_networkIndex;
    v4->_networkIndex = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = objc_msgSend_networkIndex(self, v9, v10);
  objc_msgSend_setNetworkIndex_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v8, @"<%@: networkID:%@; networkIndex:%@; breadcrumb:%@; >",
    v5,
    v7,
    self->_networkIndex,
  v9 = self->_breadcrumb);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  sub_2446C1098(v28, v10, v13);

  long long v36 = *(_OWORD *)v28;
  v16 = objc_msgSend_networkIndex(self, v14, v15);
  char v37 = objc_msgSend_unsignedCharValue(v16, v17, v18);

  v21 = objc_msgSend_breadcrumb(self, v19, v20);

  if (v21)
  {
    char v38 = 1;
    uint64_t v39 = 0;
    v24 = objc_msgSend_breadcrumb(self, v22, v23);
    uint64_t v39 = objc_msgSend_unsignedLongLongValue(v24, v25, v26);
  }
  ...
  if (v33)
  {
    ...
    v29 = &unk_26F9536C8;
    char v32 = 0;
    sub_2447945A0((uint64_t)&v29, &v33, 0);
    sub_244CB6318((uint64_t)v28, (uint64_t)&v29, 0xFFFFFFFF, (uint64_t)v40);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447FF74C((uint64_t)&v36, v28, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
      *(void *)&retstr->mLine = 0;
      sub_2446DE160((uint64_t)v28, &v33, retstr);
      if (!retstr->mError)
      {
        sub_2446DE1E4((uint64_t)a4, &v33);
  ...
  sub_244794634(&v33);
  return (ChipError *)sub_24479466C((uint64_t)&v34);
}
