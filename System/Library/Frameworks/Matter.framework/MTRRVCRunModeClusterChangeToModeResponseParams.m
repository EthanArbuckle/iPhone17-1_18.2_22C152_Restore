@interface MTRRVCRunModeClusterChangeToModeResponseParams
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3;
- (MTRRVCRunModeClusterChangeToModeResponseParams)init;
- (MTRRVCRunModeClusterChangeToModeResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
- (NSNumber)status;
- (NSString)statusText;
...
{
  v7.receiver = self;
  v7.super_class = (Class)MTRRVCRunModeClusterChangeToModeResponseParams;
  v2 = [(MTRRVCRunModeClusterChangeToModeResponseParams *)&v7 init];
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRRVCRunModeClusterChangeToModeResponseParams);
...
- (MTRRVCRunModeClusterChangeToModeResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v38.receiver = self;
  v38.super_class = (Class)MTRRVCRunModeClusterChangeToModeResponseParams;
  v8 = [(MTRRVCRunModeClusterChangeToModeResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 84, 1, a4);
  if (v37)
  {
    ...
    if (!v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_24480DB24((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    if (!v21)
    {
      *(_OWORD *)&retstr->mError = xmmword_2651940B0;
      *(void *)&retstr->mLine = 12294;
      return result;
    }
  }
  else
