...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRColorControlClusterMoveToHueParams;
  v2 = [(MTRColorControlClusterMoveToHueParams *)&v12 init];
  v3 = v2;
  if (v2)
  {
    hue = v2->_hue;
    v2->_hue = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_hue(self, v5, v6);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: hue:%@; direction:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_hue,
    self->_direction,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v38[1] = 0;
  v37 = v38;
  v7 = objc_msgSend_hue(self, a3, (uint64_t)a4);
  ...
  if (v36)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244829C8C((uint64_t)&v39, v31, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
