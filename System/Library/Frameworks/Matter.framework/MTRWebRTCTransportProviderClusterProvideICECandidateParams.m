@interface MTRWebRTCTransportProviderClusterProvideICECandidateParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRWebRTCTransportProviderClusterProvideICECandidateParams)init;
- (NSNumber)serverSideProcessingTimeout;
- (NSNumber)timedInvokeTimeoutMs;
- (NSNumber)webRTCSessionID;
- (NSString)iceCandidate;
- (id)_encodeAsDataValue:(id *)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (void)setIceCandidate:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRWebRTCTransportProviderClusterProvideICECandidateParams;
  v2 = [(MTRWebRTCTransportProviderClusterProvideICECandidateParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    ...
    iceCandidate = v3->_iceCandidate;
    v3->_iceCandidate = (NSString *)&stru_26F969DC8;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRWebRTCTransportProviderClusterProvideICECandidateParams);
  v7 = objc_msgSend_webRTCSessionID(self, v5, v6);
  objc_msgSend_setWebRTCSessionID_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_iceCandidate(self, v9, v10);
  objc_msgSend_setIceCandidate_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: webRTCSessionID:%@; iceCandidate:%@; >",
    v5,
    self->_webRTCSessionID,
  v7 = self->_iceCandidate);
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_iceCandidate, 0);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v26[1] = 0;
  v25 = v26;
  v7 = objc_msgSend_webRTCSessionID(self, a3, (uint64_t)a4);
  __int16 v27 = objc_msgSend_unsignedShortValue(v7, v8, v9);

  objc_msgSend_iceCandidate(self, v10, v11);
  id v12 = objc_claimAutoreleasedReturnValue();
  uint64_t v15 = objc_msgSend_UTF8String(v12, v13, v14);
  uint64_t v17 = objc_msgSend_lengthOfBytesUsingEncoding_(v12, v16, 4);
  sub_24479476C(v19, v15, v17);
  ...
  if (v24)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447EE638((uint64_t)&v27, v19, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
