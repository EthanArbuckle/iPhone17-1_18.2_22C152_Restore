@interface MTRDoorLockClusterClearYearDayScheduleParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDoorLockClusterClearYearDayScheduleParams)init;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRDoorLockClusterClearYearDayScheduleParams;
  v2 = [(MTRDoorLockClusterClearYearDayScheduleParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDoorLockClusterClearYearDayScheduleParams);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: yearDayIndex:%@; userIndex:%@; >",
    v5,
    self->_yearDayIndex,
  v7 = self->_userIndex);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v23[1] = 0;
  v22 = v23;
  v7 = objc_msgSend_yearDayIndex(self, a3, (uint64_t)a4);
  char v24 = objc_msgSend_unsignedCharValue(v7, v8, v9);
  ...
  if (v21)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447F0BC8(v16, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
