@interface MTRTargetNavigatorClusterNavigateTargetResponseParams
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3;
- (MTRTargetNavigatorClusterNavigateTargetResponseParams)init;
- (MTRTargetNavigatorClusterNavigateTargetResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error;
- (NSNumber)status;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRTargetNavigatorClusterNavigateTargetResponseParams;
  v2 = [(MTRTargetNavigatorClusterNavigateTargetResponseParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    status = v2->_status;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRTargetNavigatorClusterNavigateTargetResponseParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: status:%@ data:%@; >", v5, self->_status, self->_data);;
...
- (MTRTargetNavigatorClusterNavigateTargetResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v38.receiver = self;
  v38.super_class = (Class)MTRTargetNavigatorClusterNavigateTargetResponseParams;
  objc_super v8 = [(MTRTargetNavigatorClusterNavigateTargetResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1285, 1, error);
  if (v37)
  {
    ...
    if (!v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_244833570((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    id v21 = objc_msgSend_data(self, v19, v20);

    if (!v21)
    {
      *(_OWORD *)&retstr->mError = xmmword_2651944A0;
      *(void *)&retstr->mLine = 27612;
      return result;
    }
  }
  else
