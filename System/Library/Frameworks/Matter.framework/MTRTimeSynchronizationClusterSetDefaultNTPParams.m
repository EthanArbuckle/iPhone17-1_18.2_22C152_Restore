@interface MTRTimeSynchronizationClusterSetDefaultNTPParams
...
- (MTRTimeSynchronizationClusterSetDefaultNTPParams)init
{
  ...
  v2 = [(MTRTimeSynchronizationClusterSetDefaultNTPParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_defaultNTP(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: defaultNTP:%@ >", v5, self->_defaultNTP);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v24[1] = 0;
  v23 = v24;
  v7 = objc_msgSend_defaultNTP(self, a3, (uint64_t)a4);
  ...
  if (v22)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244805E98((uint64_t)&v25, v17, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
