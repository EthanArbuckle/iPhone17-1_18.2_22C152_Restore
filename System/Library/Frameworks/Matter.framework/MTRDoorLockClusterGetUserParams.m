@interface MTRDoorLockClusterGetUserParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDoorLockClusterGetUserParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRDoorLockClusterGetUserParams;
  v2 = [(MTRDoorLockClusterGetUserParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDoorLockClusterGetUserParams);
