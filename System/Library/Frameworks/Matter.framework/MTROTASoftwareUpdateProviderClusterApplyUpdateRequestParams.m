...
- (NSData)updateToken;
- (NSNumber)getNewVersion;
- (NSNumber)serverSideProcessingTimeout;
- (NSNumber)timedInvokeTimeoutMs;
- (id)_encodeAsDataValue:(id *)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (void)setNewVersion:(NSNumber *)newVersion;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTROTASoftwareUpdateProviderClusterApplyUpdateRequestParams;
  v4 = [(MTROTASoftwareUpdateProviderClusterApplyUpdateRequestParams *)&v11 init];
  if (v4)
  {
    ...
    newVersion = v4->_newVersion;
    v4->_newVersion = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  objc_super v11 = objc_msgSend_getNewVersion(self, v9, v10);
  objc_msgSend_setNewVersion_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v8, @"<%@: updateToken:%@; newVersion:%@; >",
    v5,
    v7,
  v9 = self->_newVersion);
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_newVersion, 0);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v16 = objc_msgSend_getNewVersion(self, v14, v15);
