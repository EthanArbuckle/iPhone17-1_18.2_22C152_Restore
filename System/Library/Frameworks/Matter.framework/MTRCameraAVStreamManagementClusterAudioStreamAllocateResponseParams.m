...
{
  v6.receiver = self;
  v6.super_class = (Class)MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams;
...
- (MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams;
  v8 = [(MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1361, 1, a4);
  if (v36)
  {
    ...
    {
      __int16 v32 = 0;
      sub_24483D770(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setAudioStreamID_(self, v7, (uint64_t)v6);
