@interface MTRUnitTestingClusterTestEnumsRequestParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRUnitTestingClusterTestEnumsRequestParams)init;
- (NSNumber)arg1;
- (NSNumber)arg2;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRUnitTestingClusterTestEnumsRequestParams;
  v2 = [(MTRUnitTestingClusterTestEnumsRequestParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRUnitTestingClusterTestEnumsRequestParams);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v12 = objc_msgSend_arg2(self, v10, v11);
  ...
  if (v21)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24484563C((uint64_t)&v24, v16, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
