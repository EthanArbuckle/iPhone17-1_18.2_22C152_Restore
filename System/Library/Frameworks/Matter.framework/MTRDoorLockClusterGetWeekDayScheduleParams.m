@interface MTRDoorLockClusterGetWeekDayScheduleParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDoorLockClusterGetWeekDayScheduleParams)init;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRDoorLockClusterGetWeekDayScheduleParams;
  v2 = [(MTRDoorLockClusterGetWeekDayScheduleParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDoorLockClusterGetWeekDayScheduleParams);
