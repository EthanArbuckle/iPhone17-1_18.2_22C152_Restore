...
- (void)pingWithParams:(id)a3 expectedValues:(id)a4 expectedValueInterval:(id)a5 completion:(id)a6
{
  ...
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v21, v31, (uint64_t)v24, &unk_26F9CD5D0, &unk_26F9CB500, v10, v11, v12, v18, v27, 0, v30, v15);
}
...
- (void)addArgumentsWithParams:(id)a3 expectedValues:(id)a4 expectedValueInterval:(id)a5 completion:(id)a6
{
  ...
  v30 = objc_msgSend_callbackQueue(self, v28, v29);
  objc_msgSend__invokeKnownCommandWithEndpointID_clusterID_commandID_commandPayload_expectedValues_expectedValueInterval_timedInvokeTimeout_serverSideProcessingTimeout_responseClass_queue_completion_(v20, v31, (uint64_t)v23, &unk_26F9CD5D0, &unk_26F9CB5A8, v10, v33, v11, v17, v26, v27, v30, v14, v32);
}
...
- (id)readAttributeFlipFlopWithParams:(id)a3
{
  ...
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB440, v4);
...
- (void)writeAttributeFlipFlopWithValue:(id)a3 expectedValueInterval:(id)a4 params:(id)a5
{
  ...
  objc_msgSend_writeAttributeWithEndpointID_clusterID_attributeID_value_expectedValueInterval_timedWriteTimeout_(v14, v18, (uint64_t)v17, &unk_26F9CD5E8, &unk_26F9CB440, v19, v8, v11);
}
...
- (id)readAttributeGeneratedCommandListWithParams:(id)a3
{
  ...
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB458, v4);
...
- (id)readAttributeAcceptedCommandListWithParams:(id)a3
{
  ...
  v7 = objc_msgSend_device(self, v5, v6);
  uint64_t v10 = objc_msgSend_endpointID(self, v8, v9);
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB470, v4);
...
- (id)readAttributeEventListWithParams:(id)a3
{
  ...
  v7 = objc_msgSend_device(self, v5, v6);
  uint64_t v10 = objc_msgSend_endpointID(self, v8, v9);
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB560, v4);
...
- (id)readAttributeAttributeListWithParams:(id)a3
{
  ...
  v7 = objc_msgSend_device(self, v5, v6);
  uint64_t v10 = objc_msgSend_endpointID(self, v8, v9);
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB488, v4);
...
- (id)readAttributeFeatureMapWithParams:(id)a3
{
  ...
  v7 = objc_msgSend_device(self, v5, v6);
  uint64_t v10 = objc_msgSend_endpointID(self, v8, v9);
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB4A0, v4);
...
- (id)readAttributeClusterRevisionWithParams:(id)a3
{
  ...
  v7 = objc_msgSend_device(self, v5, v6);
  uint64_t v10 = objc_msgSend_endpointID(self, v8, v9);
  id v12 = objc_msgSend_readAttributeWithEndpointID_clusterID_attributeID_params_(v7, v11, (uint64_t)v10, &unk_26F9CD5E8, &unk_26F9CB4B8, v4);
