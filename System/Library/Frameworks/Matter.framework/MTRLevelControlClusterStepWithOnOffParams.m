...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRLevelControlClusterStepWithOnOffParams;
  v2 = [(MTRLevelControlClusterStepWithOnOffParams *)&v12 init];
  v3 = v2;
  if (v2)
  {
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  LOBYTE(v40) = objc_msgSend_unsignedCharValue(v7, v8, v9);

  objc_super v12 = objc_msgSend_stepSize(self, v10, v11);
  HIBYTE(v40) = objc_msgSend_unsignedCharValue(v12, v13, v14);
  ...
  if (v17)
  {
    ...
    __int16 v41 = objc_msgSend_unsignedShortValue(v20, v21, v22);
  }
  v23 = objc_msgSend_optionsMask(self, v18, v19);
  LOBYTE(v43) = objc_msgSend_unsignedCharValue(v23, v24, v25);

  v28 = objc_msgSend_optionsOverride(self, v26, v27);
  HIBYTE(v43) = objc_msgSend_unsignedCharValue(v28, v29, v30);
  ...
  if (v37)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_2447F2824((uint64_t)&v40, v32, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
