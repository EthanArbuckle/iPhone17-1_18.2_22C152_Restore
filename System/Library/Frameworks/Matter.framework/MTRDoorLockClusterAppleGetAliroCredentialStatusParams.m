...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRDoorLockClusterAppleGetAliroCredentialStatusParams;
  v2 = [(MTRDoorLockClusterAppleGetAliroCredentialStatusParams *)&v8 init];
  if (v2)
  {
    uint64_t v3 = objc_opt_new();
    credential = v2->_credential;
    v2->_credential = (MTRDoorLockClusterAppleAliroCredentialStruct *)v3;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v27)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244822D50(v30, v22, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
