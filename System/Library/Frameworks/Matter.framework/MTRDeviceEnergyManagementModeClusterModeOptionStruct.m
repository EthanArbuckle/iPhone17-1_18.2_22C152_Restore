@interface MTRDeviceEnergyManagementModeClusterModeOptionStruct
- (MTRDeviceEnergyManagementModeClusterModeOptionStruct)init;
- (NSArray)modeTags;
- (NSNumber)mode;
- (NSString)label;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTRDeviceEnergyManagementModeClusterModeOptionStruct;
  v2 = [(MTRDeviceEnergyManagementModeClusterModeOptionStruct *)&v11 init];
  v3 = v2;
  if (v2)
  {
    label = v2->_label;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDeviceEnergyManagementModeClusterModeOptionStruct);
