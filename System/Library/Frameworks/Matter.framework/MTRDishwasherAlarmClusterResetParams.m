@interface MTRDishwasherAlarmClusterResetParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDishwasherAlarmClusterResetParams)init;
- (NSNumber)alarms;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRDishwasherAlarmClusterResetParams;
  v2 = [(MTRDishwasherAlarmClusterResetParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    alarms = v2->_alarms;
    v2->_alarms = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDishwasherAlarmClusterResetParams);
  v7 = objc_msgSend_alarms(self, v5, v6);
  objc_msgSend_setAlarms_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: alarms:%@ >", v5, self->_alarms);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_alarms(self, a3, (uint64_t)a4);
