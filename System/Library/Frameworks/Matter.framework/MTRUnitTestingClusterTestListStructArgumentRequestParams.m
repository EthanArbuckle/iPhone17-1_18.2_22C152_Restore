@interface MTRUnitTestingClusterTestListStructArgumentRequestParams
...
- (MTRUnitTestingClusterTestListStructArgumentRequestParams)init
{
  ...
  v4 = [(MTRUnitTestingClusterTestListStructArgumentRequestParams *)&v10 init];
  if (v4)
  {
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  if (v16)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244846B84((uint64_t *)&v19, v11, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
