...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_openDuration(self, v5, v6);
  objc_msgSend_setOpenDuration_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_targetLevel(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: openDuration:%@; targetLevel:%@; >",
    v5,
    self->_openDuration,
  v7 = self->_targetLevel);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v28[1] = 0;
  v27 = v28;
  v7 = objc_msgSend_openDuration(self, a3, (uint64_t)a4);

  if (v7)
  {
    v29[0] = 1;
    uint64_t v30 = 0;
    uint64_t v10 = objc_msgSend_openDuration(self, v8, v9);

    if (v10)
    {
      LODWORD(v30) = 0;
      BYTE4(v30) = 1;
      v11 = objc_msgSend_openDuration(self, v8, v9);
      LODWORD(v30) = objc_msgSend_unsignedIntValue(v11, v12, v13);
    }
  }
  uint64_t v14 = objc_msgSend_targetLevel(self, v8, v9);

  if (v14)
  {
    __int16 v31 = 1;
    v17 = objc_msgSend_targetLevel(self, v15, v16);
  ...
  if (v26)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244813924(v29, v21, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
