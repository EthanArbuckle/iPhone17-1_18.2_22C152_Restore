@interface MTRDoorLockClusterClearWeekDayScheduleParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDoorLockClusterClearWeekDayScheduleParams)init;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRDoorLockClusterClearWeekDayScheduleParams;
  v2 = [(MTRDoorLockClusterClearWeekDayScheduleParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDoorLockClusterClearWeekDayScheduleParams);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: weekDayIndex:%@; userIndex:%@; >",
    v5,
    self->_weekDayIndex,
  v7 = self->_userIndex);
