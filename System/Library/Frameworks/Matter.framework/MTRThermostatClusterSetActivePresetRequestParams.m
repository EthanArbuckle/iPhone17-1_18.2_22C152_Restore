...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRThermostatClusterSetActivePresetRequestParams;
  v2 = [(MTRThermostatClusterSetActivePresetRequestParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: presetHandle:%@ >", v5, v7);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v25[1] = 0;
  v24 = v25;
  v7 = objc_msgSend_presetHandle(self, a3, (uint64_t)a4);

  if (v7)
  {
    long long v26 = 0uLL;
    char v27 = 1;
    objc_msgSend_presetHandle(self, v8, v9);
  ...
  if (v23)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244828B14((uint64_t)&v26, v18, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
