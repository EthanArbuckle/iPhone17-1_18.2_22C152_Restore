@interface MTRGroupKeyManagementClusterKeySetRemoveParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRGroupKeyManagementClusterKeySetRemoveParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRGroupKeyManagementClusterKeySetRemoveParams;
  v2 = [(MTRGroupKeyManagementClusterKeySetRemoveParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    groupKeySetID = v2->_groupKeySetID;
    v2->_groupKeySetID = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRGroupKeyManagementClusterKeySetRemoveParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: groupKeySetID:%@ >", v5, self->_groupKeySetID);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_groupKeySetID(self, a3, (uint64_t)a4);
