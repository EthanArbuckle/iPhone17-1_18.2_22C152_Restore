@interface MTRChannelClusterChangeChannelParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRChannelClusterChangeChannelParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRChannelClusterChangeChannelParams;
  v2 = [(MTRChannelClusterChangeChannelParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    match = v2->_match;
    v2->_match = (NSString *)&stru_26F969DC8;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRChannelClusterChangeChannelParams);
  v7 = objc_msgSend_match(self, v5, v6);
  objc_msgSend_setMatch_(v4, v8, (uint64_t)v7);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: match:%@ >", v5, self->_match);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v20[1] = 0;
  v19 = v20;
  objc_msgSend_match(self, a3, (uint64_t)a4);
