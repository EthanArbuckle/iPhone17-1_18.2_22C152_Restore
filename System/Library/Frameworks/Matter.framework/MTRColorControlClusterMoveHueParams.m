...
- (MTRColorControlClusterMoveHueParams)init;
- (NSNumber)moveMode;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTRColorControlClusterMoveHueParams;
  v2 = [(MTRColorControlClusterMoveHueParams *)&v11 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRColorControlClusterMoveHueParams);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  LOBYTE(v34) = objc_msgSend_unsignedCharValue(v7, v8, v9);

  v12 = objc_msgSend_rate(self, v10, v11);
  BYTE1(v34) = objc_msgSend_unsignedCharValue(v12, v13, v14);

  v17 = objc_msgSend_optionsMask(self, v15, v16);
  BYTE2(v34) = objc_msgSend_unsignedCharValue(v17, v18, v19);

  uint64_t v22 = objc_msgSend_optionsOverride(self, v20, v21);
  HIBYTE(v34) = objc_msgSend_unsignedCharValue(v22, v23, v24);
  ...
  if (v31)
  {
    ...
    sub_244CB6318((uint64_t)v26, (uint64_t)&v27, 0xFFFFFFFF, (uint64_t)v35);
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244829F90(&v34, v26, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
