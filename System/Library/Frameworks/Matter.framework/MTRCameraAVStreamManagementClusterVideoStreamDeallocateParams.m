@interface MTRCameraAVStreamManagementClusterVideoStreamDeallocateParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRCameraAVStreamManagementClusterVideoStreamDeallocateParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRCameraAVStreamManagementClusterVideoStreamDeallocateParams;
  v2 = [(MTRCameraAVStreamManagementClusterVideoStreamDeallocateParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRCameraAVStreamManagementClusterVideoStreamDeallocateParams);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_videoStreamID(self, a3, (uint64_t)a4);
