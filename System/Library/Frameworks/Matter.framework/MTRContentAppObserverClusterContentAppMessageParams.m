@interface MTRContentAppObserverClusterContentAppMessageParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRContentAppObserverClusterContentAppMessageParams)init;
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTRContentAppObserverClusterContentAppMessageParams;
  v2 = [(MTRContentAppObserverClusterContentAppMessageParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    data = v2->_data;
    ...
    v3->_encodingHint = (NSString *)&stru_26F969DC8;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRContentAppObserverClusterContentAppMessageParams);
  v7 = objc_msgSend_data(self, v5, v6);
  objc_msgSend_setData_(v4, v8, (uint64_t)v7);

  v11 = objc_msgSend_encodingHint(self, v9, v10);
  objc_msgSend_setEncodingHint_(v4, v12, (uint64_t)v11);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: data:%@; encodingHint:%@; >",
    v5,
    self->_data,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v30[1] = 0;
  v29 = v30;
  v7 = objc_msgSend_data(self, a3, (uint64_t)a4);
  ...
  if (v7)
  {
    ...
    sub_24479476C(v23, v13, v15);

    long long v32 = *(_OWORD *)v23;
  }
  objc_msgSend_encodingHint(self, v8, v9);
  id v16 = objc_claimAutoreleasedReturnValue();
  uint64_t v19 = objc_msgSend_UTF8String(v16, v17, v18);
  uint64_t v21 = objc_msgSend_lengthOfBytesUsingEncoding_(v16, v20, 4);
  sub_24479476C(v23, v19, v21);
  ...
  if (v28)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244839408((uint64_t)v31, v23, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
