@interface MTRAudioOutputClusterSelectOutputParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRAudioOutputClusterSelectOutputParams)init;
- (NSNumber)index;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRAudioOutputClusterSelectOutputParams;
  v2 = [(MTRAudioOutputClusterSelectOutputParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
    index = v2->_index;
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRAudioOutputClusterSelectOutputParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: index:%@ >", v5, self->_index);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_index(self, a3, (uint64_t)a4);
