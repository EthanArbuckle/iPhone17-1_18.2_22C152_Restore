@interface MTRDoorLockClusterClearHolidayScheduleParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRDoorLockClusterClearHolidayScheduleParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRDoorLockClusterClearHolidayScheduleParams;
  v2 = [(MTRDoorLockClusterClearHolidayScheduleParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRDoorLockClusterClearHolidayScheduleParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: holidayIndex:%@ >", v5, self->_holidayIndex);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_holidayIndex(self, a3, (uint64_t)a4);
