...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRMediaPlaybackClusterPlaybackResponseParams;
...
- (MTRMediaPlaybackClusterPlaybackResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  ...
  v38.receiver = self;
  v38.super_class = (Class)MTRMediaPlaybackClusterPlaybackResponseParams;
  objc_super v8 = [(MTRMediaPlaybackClusterPlaybackResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 1286, 10, error);
  if (v37)
  {
    ...
    if (!v34)
    {
      LOBYTE(buf) = 0;
      BYTE8(buf) = 0;
      sub_24483456C((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  if (v11)
  {
    ...
    if (!v21)
    {
      *(_OWORD *)&retstr->mError = xmmword_2651944B8;
      *(void *)&retstr->mLine = 28472;
      return result;
    }
  }
  else
