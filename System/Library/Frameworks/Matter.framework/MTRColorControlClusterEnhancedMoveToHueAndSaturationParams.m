...
{
  v12.receiver = self;
  v12.super_class = (Class)MTRColorControlClusterEnhancedMoveToHueAndSaturationParams;
  ...
  if (v2)
  {
    ...
    v3->_saturation = (NSNumber *)&unk_26F9C8548;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = objc_msgSend_saturation(self, v9, v10);
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: enhancedHue:%@; saturation:%@; transitionTime:%@; optionsMask:%@; optionsOverride:%@; >",
    v5,
    self->_enhancedHue,
    self->_saturation,
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  objc_super v12 = objc_msgSend_saturation(self, v10, v11);
  ...
  if (v36)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_24482C3B4(v31, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
