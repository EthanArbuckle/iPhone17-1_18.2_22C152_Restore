...
- (MTRServiceAreaClusterSkipAreaResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
- (NSNumber)status;
- (NSString)statusText;
...
{
  v7.receiver = self;
  v7.super_class = (Class)MTRServiceAreaClusterSkipAreaResponseParams;
  ...
  if (v2)
  {
    ...
    v3->_statusText = (NSString *)&stru_26F969DC8;
  }
  return v3;
}
...
- (MTRServiceAreaClusterSkipAreaResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v38.receiver = self;
  v38.super_class = (Class)MTRServiceAreaClusterSkipAreaResponseParams;
  v8 = [(MTRServiceAreaClusterSkipAreaResponseParams *)&v38 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 336, 3, a4);
  if (v37)
  {
    ...
    if (!v34)
    {
      ...
      *((void *)&buf + 1) = 0;
      uint64_t v42 = 0;
      sub_2448269B0((uint64_t)&buf, (uint64_t)v36, (uint64_t)&v32);
      long long v34 = v32;
      uint64_t v35 = v33;
      if (!v32)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  ...
  objc_msgSend_setStatusText_(self, v14, (uint64_t)v13);

  uint64_t v17 = objc_msgSend_statusText(self, v15, v16);
  ...
  {
    *(_OWORD *)&retstr->mError = xmmword_2651941E8;
    *(void *)&retstr->mLine = 22414;
  }
  return result;
}
