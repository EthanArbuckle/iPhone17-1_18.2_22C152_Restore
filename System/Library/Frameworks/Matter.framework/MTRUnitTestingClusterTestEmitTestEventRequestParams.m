@interface MTRUnitTestingClusterTestEmitTestEventRequestParams
...
- (MTRUnitTestingClusterTestEmitTestEventRequestParams)init
{
  ...
  v2 = [(MTRUnitTestingClusterTestEmitTestEventRequestParams *)&v10 init];
  v3 = v2;
  if (v2)
  {
    arg1 = v2->_arg1;
    ...
    arg3 = v3->_arg3;
    v3->_arg3 = (NSNumber *)&unk_26F9C8548;
...
- (id)description
{
  ...
  objc_msgSend_stringWithFormat_(v3, v6, @"<%@: arg1:%@; arg2:%@; arg3:%@; >",
    v5,
    self->_arg1,
    self->_arg2,
  v7 = self->_arg3);
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17 = objc_msgSend_arg3(self, v15, v16);
  char v30 = objc_msgSend_BOOLValue(v17, v18, v19);
  ...
  if (v26)
  {
    ...
    *(void *)&retstr->mError = 0;
    retstr->mFile = 0;
    *(void *)&retstr->mLine = 0;
    sub_244847FCC((uint64_t)&v29, v21, 256, (uint64_t)retstr);
    if (!retstr->mError)
    {
      *(void *)&retstr->mError = 0;
      retstr->mFile = 0;
