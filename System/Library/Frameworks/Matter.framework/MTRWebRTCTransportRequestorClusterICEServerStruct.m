@interface MTRWebRTCTransportRequestorClusterICEServerStruct
- (MTRWebRTCTransportRequestorClusterICEServerStruct)init;
- (NSArray)urls;
- (NSNumber)caid;
- (NSString)credential;
- (NSString)username;
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTRWebRTCTransportRequestorClusterICEServerStruct;
  v4 = [(MTRWebRTCTransportRequestorClusterICEServerStruct *)&v11 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRWebRTCTransportRequestorClusterICEServerStruct);
