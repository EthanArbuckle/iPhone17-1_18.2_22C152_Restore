@interface MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams)init;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams;
  v4 = [(MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams *)&v10 init];
  if (v4)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams);
...
- (id)description
{
  ...
  v9 = objc_msgSend_stringWithFormat_(v3, v8, @"<%@: extendedPanID:%@ >", v5, v7);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v21[1] = 0;
  v20 = v21;
  objc_msgSend_extendedPanID(self, a3, (uint64_t)a4);
