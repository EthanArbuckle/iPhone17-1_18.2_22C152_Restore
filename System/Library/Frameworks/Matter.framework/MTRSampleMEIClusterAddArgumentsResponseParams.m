...
- (MTRSampleMEIClusterAddArgumentsResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
...
- (MTRSampleMEIClusterAddArgumentsResponseParams)init
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)MTRSampleMEIClusterAddArgumentsResponseParams;
  v2 = [(MTRSampleMEIClusterAddArgumentsResponseParams *)&v6 init];
  v3 = v2;
  if (v2)
  {
    returnValue = v2->_returnValue;
    v2->_returnValue = (NSNumber *)&unk_26F9C8548;
  }
  return v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = objc_msgSend_returnValue(self, v5, v6);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: returnValue:%@ >", v5, self->_returnValue);;
...
- (MTRSampleMEIClusterAddArgumentsResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  v37.receiver = self;
  v37.super_class = (Class)MTRSampleMEIClusterAddArgumentsResponseParams;
  v8 = [(MTRSampleMEIClusterAddArgumentsResponseParams *)&v37 init];
  if (!v8)
  {
    v30 = 0;
    goto LABEL_16;
  }
  objc_msgSend__responseDataForCommand_clusterID_commandID_error_(MTRBaseDevice, v7, (uint64_t)v6, 4294048800, 1, a4);
  if (v36)
  {
    ...
    {
      char v32 = 0;
      sub_24484A9C0(&v32, (uint64_t)v35, (uint64_t)&buf);
      long long v33 = buf;
      uint64_t v34 = v41;
      if (!buf)
      {
...
- (ChipError)_setFieldsFromDecodableStruct:(SEL)a3
{
  id v6 = objc_msgSend_numberWithUnsignedChar_(NSNumber, a3, a4->var0);
