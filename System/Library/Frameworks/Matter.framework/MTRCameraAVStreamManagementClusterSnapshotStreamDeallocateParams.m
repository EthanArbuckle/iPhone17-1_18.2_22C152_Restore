@interface MTRCameraAVStreamManagementClusterSnapshotStreamDeallocateParams
- (ChipError)_encodeToTLVReader:(SEL)a3;
- (MTRCameraAVStreamManagementClusterSnapshotStreamDeallocateParams)init;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTRCameraAVStreamManagementClusterSnapshotStreamDeallocateParams;
  v2 = [(MTRCameraAVStreamManagementClusterSnapshotStreamDeallocateParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(MTRCameraAVStreamManagementClusterSnapshotStreamDeallocateParams);
...
- (id)description
{
  ...
  v7 = objc_msgSend_stringWithFormat_(v3, v6, @"<%@: snapshotStreamID:%@ >", v5, self->_snapshotStreamID);;
...
- (ChipError)_encodeToTLVReader:(SEL)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  uint64_t v6 = objc_msgSend_snapshotStreamID(self, a3, (uint64_t)a4);
