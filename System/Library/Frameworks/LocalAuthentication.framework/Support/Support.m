...
void sub_1000040A4(uint64_t a1, void *a2)
{
  id v3 = a2;
  if (v3)
  {
    v4 = [[Context alloc] initWithPlugin:v3 processId:*(unsigned int *)(a1 + 48) userId:*(unsigned int *)(a1 + 52) auditSessionId:*(unsigned int *)(a1 + 56) externalizedContext:*(void *)(a1 + 32)];
    id v5 = [*(id *)(a1 + 32) hash];
    ...
    id v10 = v6;
    v7 = v4;
    [(Context *)v7 _registerAcmHashInDaemon:v5 completion:v8];
  }
  else
  {
    (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
...
{
  v2 = [*(id *)(a1 + 32) valueForEntitlement:a2];
  id v3 = [v2 BOOLValue];

  return v3;
}

void sub_1000045D4(uint64_t a1, void *a2)
{
  id v3 = a2;
  ...
  long long v12 = *(_OWORD *)(a1 + 100);
  v18[0] = *(_OWORD *)(a1 + 84);
  v18[1] = v12;
  v13 = -[ContextProxy initWithContext:processId:userId:auditSessionId:auditToken:cApiOrigin:checkEntitlementBlock:invalidationBlock:callback:clientId:](v4, "initWithContext:processId:userId:auditSessionId:auditToken:cApiOrigin:checkEntitlementBlock:invalidationBlock:callback:clientId:", v3, v5, v6, v7, v18, v8, v9, v10, v11);
  ...
  (*(void (**)(uint64_t, ContextProxy *, void *, void *, void))(v15 + 16))(v15, v13, v16, v17, 0);
}
...
void sub_100004AE8(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  id v9 = a2;
  id v10 = a5;
  id v11 = a4;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 1024;
    int v19 = v15;
    _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_INFO, "returning %{public}@ on connection: %x", (uint8_t *)&v16, 0x12u);
    if (v9) {
  }
    }
  (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
...
void sub_100004C34(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    id v6 = WeakRetained;
    __int16 v7 = 1024;
    unsigned int v8 = [v4 hash];
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_INFO, "MainServiceListner connection invalidated: %{public}@ hash: %x", (uint8_t *)&v5, 0x12u);
  }
}

void sub_100004E3C(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  id v6 = v5;
  if (v10)
  {
    __int16 v7 = +[LACEvaluationResult resultWithSuccess:v10];
  }
  else
  {
    if (v5)
    ...
    {
      id v9 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"Missing either result or error for request rid: %i", [*(id *)(a1 + 32) identifier]);
      id v8 = +[LAErrorHelper errorWithCode:-1000 message:v9];
    }
    __int16 v7 = +[LACEvaluationResult resultWithFailure:v8];
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100005140(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, id location)
{
...
void sub_1000056C0(id *a1, void *a2)
{
  id v3 = a2;
  ...
  if (WeakRetained)
  {
    if ([v3 rawValue] == (id)1)
    {
      uint64_t v5 = LACErrorCodeInternal;
      id v6 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"No result for request rid: %i", [a1[4] identifier]);
      __int16 v7 = +[LACError errorWithCode:v5 debugDescription:v6];
    ...
    else
    {
      ...
      id v11 = a1[6];
      id v12 = a1[5];
      [v8 postProcessRequest:v9 result:v3 completion:v10];
...
void sub_100005A9C(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2114;
    id v13 = v9;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "evaluatePolicy rid:%u returned %{public}@", (uint8_t *)v11, 0x12u);
  }

  if (v6 && *(void *)(a1 + 40))
  {
    id v10 = +[PreflightCache sharedInstance];
    [v10 addPreflightResult:v6 forKey:*(void *)(a1 + 40)];
  }
  (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
}

void sub_100005BCC(uint64_t a1, void *a2, void *a3)
{
  id v5 = *(void **)(a1 + 32);
  id v6 = a3;
  id v11 = a2;
  id v7 = [v5 analytics];
  objc_msgSend(v7, "evaluationResult:", objc_msgSend(v6, "code"));

  unsigned int v8 = [*(id *)(a1 + 32) analytics];
  [v8 collectIfNeeded];

  id v9 = [*(id *)(a1 + 32) dtoAnalytics];
  [v9 evaluationResult:v11 error:v6];

  id v10 = [*(id *)(a1 + 32) dtoAnalytics];
  [v10 collectIfNeeded];

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_1000066A4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, id location)
{
...
void sub_10000671C(void *a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v3;
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_INFO, "%{public}@ interrupted", (uint8_t *)&v10, 0xCu);
  }

  uint64_t v4 = +[LAErrorHelper errorWithCode:-9 message:@"Invalidated by client."];
  id v5 = +[AuthenticationManager sharedInstance];
  [v5 cancelWithError:v4 originatorId:a1[7] reply:a1[6]];

  id v6 = +[DaemonServiceLocator sharedInstance];
  id v7 = [v6 uiController];
  [v7 terminateUserInterfaceWithUUID:a1[5] reason:@"Invalidated by client"];

  if (a1[5])
  {
    unsigned int v8 = +[DaemonServiceLocator sharedInstance];
    id v9 = [v8 oneness];
    [v9 cancelRequestsForContextID:a1[5]];
  }
}
...
id sub_100007298()
{
  if (qword_100046E18 != -1) {
    dispatch_once(&qword_100046E18, &stru_1000389A0);
  }
  v0 = (void *)qword_100046E20;
...
id sub_1000072EC()
{
  if (qword_100046E60 != -1) {
    dispatch_once(&qword_100046E60, &stru_100039168);
  }
  v0 = (void *)qword_100046E68;
...
id sub_100007340()
{
  if (qword_100046E98 != -1) {
    dispatch_once(&qword_100046E98, &stru_100039268);
  }
  v0 = (void *)qword_100046EA0;
...
id sub_100007ABC()
{
  if (qword_100046DE8 != -1) {
    dispatch_once(&qword_100046DE8, &stru_100038830);
  }
  v0 = (void *)qword_100046DF0;

  return v0;
}

id sub_100007D88(uint64_t a1)
{
...
{
  qword_100046DF0 = (uint64_t)os_log_create("com.apple.LocalAuthentication", "CoachingFeedbackFilter");
...
void sub_1000082EC(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint8_t *a5)
{
...
{
  qword_100046DF8 = objc_alloc_init(SecureStorageProvider);

  _objc_release_x1();
}

id sub_100008734(uint64_t a1)
{
  id v1 = [objc_alloc((Class)LACDTOMutableKVStoreReadRequest) initWithKey:*(void *)(a1 + 32)];
...
{
  id v2 = [objc_alloc((Class)LACDTOMutableKVStoreReadRequest) initWithKey:*(void *)(a1 + 40)];
  [v2 setConnection:*(void *)(a1 + 32)];

  return v2;
}

id sub_100008A4C(uint64_t a1)
{
  id v1 = [objc_alloc((Class)LACDTOMutableKVStoreWriteRequest) initWithKey:*(void *)(a1 + 40) value:*(void *)(a1 + 32)];

  return v1;
}

id sub_100008B90(void *a1)
{
  id v2 = [objc_alloc((Class)LACDTOMutableKVStoreWriteRequest) initWithKey:a1[6] value:a1[4]];
  [v2 setConnection:a1[5]];

  return v2;
}

id sub_100008CE8(void *a1)
{
  id v2 = [objc_alloc((Class)LACDTOMutableKVStoreWriteRequest) initWithKey:a1[6] value:a1[4]];
...
id sub_100008E60(void *a1)
{
  id v2 = [objc_alloc((Class)LACDTOMutableKVStoreWriteRequest) initWithKey:a1[7] value:a1[4]];
  [v2 setContextUUID:a1[5]];
...
void sub_1000090F8(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, id location)
{
...
void sub_100009114(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = LACLogDTOStorage();
  unsigned int v8 = v7;
  if (v6) {
  ...
  if (os_log_type_enabled(v7, v9))
  {
    ...
    *(_DWORD *)buf = 67109634;
    ...
    __int16 v27 = 2112;
    id v28 = v6;
    _os_log_impl((void *)&_mh_execute_header, v8, v9, "Finished KVS query: { key: %d, result: %@, error: %@ }", buf, 0x1Cu);
  }
  ...
  if (WeakRetained)
  {
    ...
    else if (v5)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        id v14 = objc_msgSend(objc_alloc((Class)LACDTOKVStoreValue), "initWithIntegerValue:", objc_msgSend(v5, "integerValue"));
      ...
      else
      {
        ...
        if (isKindOfClass)
        {
          id v21 = [objc_alloc((Class)LACDTOKVStoreValue) initWithData:v5];
          (*(void (**)(uint64_t, id, void))(v20 + 16))(v20, v21, 0);
        }
        else
        {
          id v21 = +[NSString stringWithFormat:@"Unexpected value type for KVS key: %d", *(void *)(a1 + 56)];
          v22 = +[LAErrorHelper internalErrorWithMessage:v21];
    ...
    else
    {
      ...
      id v16 = objc_alloc((Class)LACDTOKVStoreValue);
      id v17 = objc_alloc_init((Class)NSData);
      id v18 = [v16 initWithData:v17];
      (*(void (**)(uint64_t, id, void))(v15 + 16))(v15, v18, 0);
    }
  }
}

void sub_10000953C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
...
void sub_100009560(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = LACLogDTOStorage();
  ...
  if (os_log_type_enabled(v7, v9))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl((void *)&_mh_execute_header, v8, v9, "Finished KVS update: { key: %d, result: %@, error: %@ }", (uint8_t *)v13, 0x1Cu);
  }
...
{
  qword_100046E08 = objc_opt_new();

  _objc_release_x1();
}

void sub_100009FC4(id a1)
{
  qword_100046E20 = LALogForCategory();

  _objc_release_x1();
}

void sub_10000A054(id a1)
{
  qword_100046E28 = objc_opt_new();

  _objc_release_x1();
}

id sub_10000AB2C(uint64_t a1)
{
  id v2 = [objc_alloc((Class)LACDTOFeatureRequirementsDataSource) initWithDevice:*(void *)(*(void *)(a1 + 32) + 104) replyQueue:*(void *)(a1 + 40)];
  id v3 = objc_alloc((Class)LACDTOFeatureController);
  uint64_t v4 = *(void *)(*(void *)(a1 + 32) + 40);
  id v5 = +[LACFlags sharedInstance];
  id v6 = [v3 initWithKVStore:v4 requirementsDataSource:v2 featureFlags:v5 workQueue:*(void *)(a1 + 40)];

  [v6 setEventBus:*(void *)(*(void *)(a1 + 32) + 128)];

  return v6;
}

id sub_10000ABEC(uint64_t a1)
{
  id v6 = _NSConcreteStackBlock;
  uint64_t v7 = 3221225472;
  unsigned int v8 = sub_10000ACCC;
  os_log_type_t v9 = &unk_100038A10;
  id v10 = *(id *)(a1 + 32);
  id v11 = *(id *)(a1 + 40);
  id v2 = sub_10000ACCC((uint64_t)&v6);
  id v3 = objc_alloc((Class)LACDTOLostModeController);
  id v4 = objc_msgSend(v3, "initWithLostModeProvider:store:workQueue:", v2, *(void *)(*(void *)(a1 + 40) + 40), *(void *)(a1 + 32), v6, v7);

  return v4;
}

id sub_10000ACCC(uint64_t a1)
{
  if (_os_feature_enabled_impl()) {
    id v2 = [objc_alloc((Class)LACDTOLostModeProviderAKAdapter) initWithWorkQueue:*(void *)(a1 + 32) deviceInfo:*(void *)(*(void *)(a1 + 40) + 104)];
  }
  else {
    id v2 = [objc_alloc((Class)LACDTOLostModeProviderKVSAdapter) initWithKVStore:*(void *)(*(void *)(a1 + 40) + 40)];
  }

  return v2;
}

id sub_10000AD48(void *a1)
{
  id v2 = [objc_alloc((Class)LACDTORatchetStateMonitor) initWithRatchetStateProvider:a1[4] workQueue:a1[5]];
  [v2 setEventBus:*(void *)(a1[6] + 128)];
  [*(id *)(a1[6] + 128) addEventHandler:v2];

  return v2;
}

id sub_10000ADB0(void *a1)
{
  id v2 = [objc_alloc((Class)LACDTOPendingPolicyEvaluationController) initWithRatchetStateProvider:*(void *)(a1[4] + 80) ratchetHandler:a1[5] device:*(void *)(a1[4] + 104) evaluationIdentifierFactory:a1[6] persistentStore:*(void *)(a1[4] + 56) workQueue:a1[7]];
  [*(id *)(a1[4] + 128) addEventHandler:v2];

  return v2;
}

id sub_10000AE1C(uint64_t a1)
{
  id v2 = [objc_alloc((Class)LACDTODarwinNotificationsController) initWithNotificationCenter:*(void *)(a1 + 32)];
  [*(id *)(*(void *)(a1 + 40) + 128) addEventHandler:v2];

  return v2;
}

id sub_10000AE78(uint64_t a1)
{
  id v2 = objc_alloc_init(CredentialStore);
  id v3 = [objc_alloc((Class)LACDTOPolicyProcessorEmptyPasscode) initWithCredentialStore:v2 device:*(void *)(*(void *)(a1 + 32) + 104)];

  return v3;
}

id sub_10000AEE0(uint64_t a1)
{
  id v2 = +[LACKeyBagProvider sharedInstance];
  id v3 = [v2 keybagForUserId:geteuid()];

  id v4 = objc_alloc((Class)LACDTOLocationPrewarmStrategy);
  uint64_t v5 = *(void *)(a1 + 32);
  uint64_t v6 = *(void *)(v5 + 32);
  uint64_t v7 = [*(id *)(v5 + 24) trustStateProvider];
  id v8 = [v4 initWithFeatureStateProvider:v6 trustStateProvider:v7 device:*(void *)(*(void *)(a1 + 32) + 104) keybag:v3];
...
id sub_10000B308(uint64_t a1)
{
  id v2 = +[RemoteUIManager sharedInstance];
  id v3 = [objc_alloc((Class)LAWeakBox) initWithReceiver:*(void *)(a1 + 32)];
  [v2 setEndpointProvider:v3];

  return v2;
}

void sub_10000B5E4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location, id a17)
{
  objc_destroyWeak(v18);
...
void sub_10000B618(uint64_t a1)
{
  ...
  id v3 = +[RemoteUIManager sharedInstance];
  [v3 connectionToViewServiceInvalidated:&stru_100038B70];
}

uint64_t start()
{
  LALogSetProcessCategory();
  id v1 = +[DaemonServiceLocator sharedInstance];
  [v1 startServices];

  id v2 = [(ListenerWithDelegate *)[MainServiceListener alloc] initWithMachServiceName:@"com.apple.CoreAuthentication.daemon"];
  [(MainServiceListener *)v2 resume];
  id v3 = [(ListenerWithDelegate *)[MainServiceListener alloc] initWithMachServiceName:@"com.apple.CoreAuthentication.daemon.libxpc"];
  [(MainServiceListener *)v3 resume];
  id v4 = [[RemoteUIListener alloc] initWithMachServiceName:@"com.apple.LocalAuthentication.RemoteUIHost"];
  [(RemoteUIListener *)v4 resume];
  uint64_t v5 = dispatch_source_create((dispatch_source_type_t)&_dispatch_source_type_signal, 0xFuLL, 0, (dispatch_queue_t)&_dispatch_main_q);
  handler[0] = _NSConcreteStackBlock;
  handler[1] = 3221225472;
  handler[2] = sub_10000B8AC;
  handler[3] = &unk_100038BC0;
  uint64_t v6 = v2;
  __int16 v12 = v6;
  uint64_t v7 = v3;
  uint64_t v13 = v7;
  ...
  os_log_type_t v9 = +[NSRunLoop currentRunLoop];
  [v9 run];

  return 0;
}

void sub_10000B8AC(id *a1)
{
  id v2 = LALogForCategory();
...
id sub_10000BA10()
{
  if (qword_100046E38 != -1) {
    dispatch_once(&qword_100046E38, &stru_100038C78);
  }
  v0 = (void *)qword_100046E40;

  return v0;
}

void sub_10000BC44(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
...
uint64_t sub_10000BC60(uint64_t result, uint64_t a2)
{
...
void sub_10000BC78(id a1, NSError *a2)
{
  id v2 = a2;
  id v3 = sub_10000BA10();
  if (os_log_type_enabled(v3, OS_LOG_TYPE_ERROR)) {
    sub_10002768C((uint64_t)v2, v3);
  }
}

void sub_10000BCCC(uint64_t a1, void *a2)
{
}

void sub_10000BDC4(id a1)
{
  qword_100046E40 = (uint64_t)os_log_create("com.apple.LocalAuthentication", "EndpointProvider");

  _objc_release_x1();
}

void sub_10000C608(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
uint64_t sub_10000C620(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_10000C630(uint64_t a1)
{
}

uint64_t sub_10000C638(uint64_t a1, uint64_t a2, uint64_t a3)
{
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 40) = [objc_alloc((Class)NSData) initWithBytes:a2 length:a3];
...
void sub_10000D2D8(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v19 = v6;
    id v8 = +[NSNumber numberWithInteger:LACPolicyOptionAuthenticationIdentifier];
    v22[0] = v8;
    v23[0] = *(void *)(a1 + 32);
    os_log_type_t v9 = +[NSNumber numberWithInteger:LACPolicyOptionAuthenticationReason];
    v22[1] = v9;
    v23[1] = &stru_100039678;
    id v10 = +[NSNumber numberWithInteger:LACPolicyOptionAuthenticationCallbackURL];
    v22[2] = v10;
    id v11 = objc_opt_new();
    v23[2] = v11;
    __int16 v12 = +[NSNumber numberWithInteger:LACPolicyOptionAuthenticationCallbackReason];
    v22[3] = v12;
    v23[3] = &stru_100039678;
    uint64_t v13 = +[NSNumber numberWithInteger:LACPolicyOptionBeginSecurityDelayImmediately];
    v22[4] = v13;
    v23[4] = &__kCFBooleanTrue;
    __int16 v14 = +[NSNumber numberWithInteger:LACPolicyOptionCallerAuditTokenUsage];
    v22[5] = v14;
    id v15 = +[NSNumber numberWithInteger:LACAuditTokenUsageNone];
    v23[5] = v15;
    __int16 v16 = +[NSDictionary dictionaryWithObjects:v23 forKeys:v22 count:6];

    uint64_t v17 = LACPolicyLocationBasedDeviceOwnerAuthenticationWithBiometricRatchet;
    ...
    uint64_t v18 = v17;
    uint64_t v7 = v19;
    [v21 evaluatePolicy:v18 options:v16 uiDelegate:0 reply:v20];
  }
  else
  {
    __int16 v16 = LACLogDTO();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      sub_100027704((uint64_t)v7, v16);
    }
  }
}

void sub_10000D574(uint64_t a1, void *a2, void *a3)
{
  id v4 = a2;
  id v5 = a3;
  id v6 = LACLogDTO();
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v8 = 138543362;
    id v9 = v7;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "Did finish security delay restart with result: %{public}@", (uint8_t *)&v8, 0xCu);
  }
}

void sub_10000D70C(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
...
void sub_10000D728(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  ...
  if (WeakRetained)
  {
    ...
    {
      id v7 = objc_alloc_init(DTORatchetStateParser);
      uint64_t v8 = *(void *)(a1 + 32);
      id v9 = [(DTORatchetStateParser *)v7 ratchetStateFromState:v10];
      (*(void (**)(uint64_t, void *, void))(v8 + 16))(v8, v9, 0);
    }
  }
}

void sub_10000D8D0(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
  objc_destroyWeak((id *)(v2 - 40));
  _Unwind_Resume(a1);
...
void sub_10000D8EC(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      id v12 = *(id *)(a1 + 32);
      id v11 = v5;
      [v9 valueForKey:0 completion:v10];
...
void sub_10000DA14(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
  _Unwind_Resume(a1);
}

void sub_10000DA28(id *a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      id v11 = a1[4];
      id v12 = v5;
      [v9 valueForKey:4 completion:v10];
...
void sub_10000DB64(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
  _Unwind_Resume(a1);
}

void sub_10000DB78(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 56));
  if (WeakRetained)
  {
    ...
    {
      uint64_t v8 = objc_alloc_init(DTORatchetStateParser);
      id v9 = [(DTORatchetStateParser *)v8 watchdogPackFromState:*(void *)(a1 + 32)];
      id v10 = [(DTORatchetStateParser *)v8 ratchetStateFromState:*(void *)(a1 + 32)];
      __int16 v16 = _NSConcreteStackBlock;
      uint64_t v17 = 3221225472;
      uint64_t v18 = sub_10000DD34;
      id v19 = &unk_100038D60;
      id v20 = *(id *)(a1 + 40);
      id v21 = v5;
      v22 = v8;
      id v23 = *(id *)(a1 + 32);
      id v11 = v8;
      id v12 = sub_10000DD34((uint64_t)&v16);
      uint64_t v13 = *(void *)(a1 + 48);
      id v14 = objc_alloc((Class)LACDTORatchetStateComposite);
      id v15 = objc_msgSend(v14, "initWithRatchetState:gracePeriodState:watchdogs:", v10, v12, v9, v16, v17);
      (*(void (**)(uint64_t, id, void))(v13 + 16))(v13, v15, 0);
    }
  }
}

id sub_10000DD34(uint64_t a1)
{
  id v2 = objc_alloc_init((Class)LACDTOFeatureEnablementModeCoder);
  id v3 = [v2 decode:*(void *)(a1 + 32)];

  if ([v3 rawValue] == (id)2 && (objc_msgSend(*(id *)(a1 + 40), "BOOLValue") & 1) == 0)
  {
    uint64_t v4 = [*(id *)(a1 + 48) gracePeriodStateFromState:*(void *)(a1 + 56)];
  }
  else
  {
    uint64_t v4 = +[LACDTOGracePeriodState nullInstance];
  }
  id v5 = (void *)v4;
...
void sub_10000E1CC(void *a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = a1[4];
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    uint64_t v13 = v9;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "Requesting domain state finished with result: %@ uuid: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  (*(void (**)(void))(a1[7] + 16))();
}

void sub_10000E614(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2114;
    id v15 = v9;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "evaluateACL rid:%u returned %{public}@", (uint8_t *)v13, 0x12u);
  }

  int v10 = [*(id *)(a1 + 32) analytics];
  objc_msgSend(v10, "evaluationResult:", objc_msgSend(v6, "code"));

  id v11 = [*(id *)(a1 + 32) analytics];
  [v11 collectIfNeeded];

  if (v6 && *(void *)(a1 + 40))
  {
    __int16 v12 = +[PreflightCache sharedInstance];
    [v12 addPreflightResult:v6 forKey:*(void *)(a1 + 40)];
  }
  (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
}

void sub_10000E960(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    unsigned int v7 = [*(id *)(a1 + 32) identifier];
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "failProcessedEvent rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000EC20(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "retryProcessedEvent rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000EEE0(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "resetProcessedEvent rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000F1A4(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "pauseProcessedEvent rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000F474(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "setShowingCoachingHint rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000F760(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "setCredential rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000F9D8(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "isCredentialSet rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10000FCEC(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "setCredential rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }
...
uint64_t sub_10000FF40(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    unsigned int v3 = [*(id *)(a1 + 32) identifier];
    v5[0] = 67109120;
    v5[1] = v3;
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_INFO, "invalidateWithReply rid:%u returned success", (uint8_t *)v5, 8u);
  }

  return (*(uint64_t (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100010184(uint64_t a1, void *a2, void *a3)
{
  id v5 = a3;
  id v6 = *(void **)(a1 + 32);
  id v7 = a2;
  CFStringRef v8 = [v6 log];
  id v9 = v8;
  if (a2)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v11[0] = 67109120;
      v11[1] = v10;
      _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_INFO, "credentialOfType rid:%u returned", (uint8_t *)v11, 8u);
    }
  }
  else if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    sub_10002777C((id *)(a1 + 32));
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100010424(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v5)
    {
      id v9 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v5 hash]);
    }
    else
    {
      id v9 = v6;
    ...
    __int16 v11 = 2114;
    __int16 v12 = v9;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "optionsForInternalOperation rid:%u returned %{public}@", (uint8_t *)v10, 0x12u);
    if (v5) {
  }
    }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
...
void sub_10001070C(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "setOptions rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100010980(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    unsigned int v8 = [*(id *)(a1 + 32) identifier];
    if (v5) {
    ...
    __int16 v11 = 2114;
    id v12 = v9;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "serverPropertyForOption rid:%u returned %{public}@", (uint8_t *)v10, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100010C14(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "setServerPropertyForOption rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100010E6C(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = [*(id *)(a1 + 32) log];
  ...
  if (v5)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      unsigned int v9 = [*(id *)(a1 + 32) identifier];
      v10[0] = 67109376;
      v10[1] = v9;
      __int16 v11 = 1024;
      unsigned int v12 = [v5 hash];
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_INFO, "externalizedContextWithReply rid:%u returned %x", (uint8_t *)v10, 0xEu);
    }
  }
  else if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    sub_1000277FC((id *)(a1 + 32));
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100011100(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v5)
    {
      unsigned int v9 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v5 hash]);
    }
    else
    {
      unsigned int v9 = v6;
    ...
    __int16 v11 = 2114;
    unsigned int v12 = v9;
    _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "authMethodWithReply rid:%u returned %{public}@", (uint8_t *)v10, 0x12u);
    if (v5) {
  }
    }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
...
void sub_1000113F4(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "verifyFileVaultUser rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_1000116AC(uint64_t a1, int a2, void *a3)
{
  id v5 = a3;
  id v6 = [*(id *)(a1 + 32) log];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2114;
    CFStringRef v11 = v8;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_INFO, "allowTransferToProcess rid:%u returned %{public}@", (uint8_t *)v9, 0x12u);
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_10001191C(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  unsigned int v7 = [*(id *)(a1 + 32) log];
  ...
  if (v5)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 1024;
      unsigned int v12 = [v5 hash];
      _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_INFO, "tokenForTransferToUnknownProcess rid:%u returned %x", (uint8_t *)v10, 0xEu);
    }
  }
  else if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    sub_10002787C((id *)(a1 + 32));
  }

  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100011B00(void *a1, uint64_t a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
void sub_100011EE8(uint64_t a1)
{
  ...
  {
    id v2 = WeakRetained;
    [WeakRetained[4] startMonitoring];
    id WeakRetained = v2;
  }
}
...
{
  qword_100046E50 = objc_opt_new();

  _objc_release_x1();
}

BOOL sub_100012188(id a1, NSString *a2)
{
  return 1;
}
...
void sub_1000121A4(uint64_t a1)
{
  id v2 = sub_1000072EC();
  if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
    sub_1000278FC(a1, v2);
  ...
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  uint64_t v4 = +[LAErrorHelper errorWithCode:-10 subcode:20 message:@"Invalidated due to exceeded number of allocated contexts."];
  [WeakRetained invalidatedWithError:v4];
}

void sub_100012420(uint64_t a1, char a2)
{
  if (a2)
  {
    id v6 = [*(id *)(a1 + 32) _proxyWithContext:*(void *)(a1 + 40) callback:*(void *)(a1 + 48) clientId:*(void *)(a1 + 80) request:*(void *)(a1 + 56)];
    [*(id *)(a1 + 64) addContextProxy:v6];
    uint64_t v3 = *(void *)(a1 + 72);
    uint64_t v4 = [v6 proxyId];
    (*(void (**)(uint64_t, id, void *, void))(v3 + 16))(v3, v6, v4, 0);
  }
  else
  {
...
id sub_1000126FC(uint64_t a1, uint64_t a2)
{
  return [*(id *)(a1 + 32) hasEntitlement:a2];
}
...
void sub_100012708(uint64_t a1)
{
  ...
  uint64_t v4 = +[LAErrorHelper errorWithCode:-10 subcode:20 message:@"Invalidated due to exceeded number of allocated contexts."];
  [v3 invalidatedWithError:v4];
}

id sub_100012CBC()
{
  if (qword_100046E70 != -1) {
    dispatch_once(&qword_100046E70, &stru_100039188);
  }
  v0 = (void *)qword_100046E78;

  return v0;
}

void sub_1000131BC(_Unwind_Exception *a1)
{
  objc_destroyWeak((id *)(v1 - 160));
  _Unwind_Resume(a1);
}

uint64_t sub_1000131F4(void *a1)
{
  id v2 = sub_100012CBC();
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v11 = 2114;
    uint64_t v12 = v5;
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "Posted notification %{public}@, newValue: %{public}@, oldValue: %{public}@", (uint8_t *)&v7, 0x20u);
  }

  return (*(uint64_t (**)(void))(a1[7] + 16))();
}

BOOL sub_1000132C4(id a1, Notification *a2, NSDictionary *a3)
{
  return ![(Notification *)a2 suspended];
}

void sub_1000132E4(uint64_t a1)
{
  id v2 = +[DaemonUtils queue];
...
void sub_1000133C0(uint64_t a1)
{
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 56));
  [WeakRetained _clearNotification:*(void *)(a1 + 32) fromPendingNotifications:*(void *)(a1 + 40) finally:*(void *)(a1 + 48)];
}
...
void sub_100013830(id a1)
{
  qword_100046E68 = LALogForCategory();

  _objc_release_x1();
}

void sub_10001386C(id a1)
{
  qword_100046E78 = LALogForCategory();

  _objc_release_x1();
}

void sub_1000138A8(id a1)
{
  qword_100046E80 = objc_alloc_init(DaemonServiceLocator);

  _objc_release_x1();
}

void sub_1000144EC(uint64_t a1, int a2, void *a3)
{
  ...
  {
    id v6 = a3;
    id v7 = +[LAErrorHelper errorWithCode:-1 message:@"Password authentication timed out."];
    [v4 failAuthenticationWithError:v7];
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}

void sub_100014684(uint64_t a1, void *a2)
{
  id v6 = a2;
  ...
  if (!v3)
  {
    ...
    id v5 = [*(id *)(*(void *)(a1 + 48) + 8) objectForKeyedSubscript:v6];
...
void sub_1000155FC(id a1)
{
  qword_100046EA0 = LALogForCategory();

  _objc_release_x1();
}

void sub_100015638(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
{
  return qword_100046EB8;
}

void *acm_mem_alloc_data(size_t size)
{
  id result = malloc_type_calloc(1uLL, size, 0xCB62F0E9uLL);
  if (result) {
    qword_100046EC0 += size;
  }
  return result;
}
...
void acm_mem_free_data(void *a1, rsize_t __n)
{
  if (a1)
  {
    ...
    free(a1);
    uint64_t v4 = qword_100046EC0 - __n;
    if (qword_100046EC0 < __n) {
      uint64_t v4 = 0;
    }
    qword_100046EC0 = v4;
  }
...
{
  id result = malloc_type_calloc(1uLL, size, 0xDB9956F0uLL);
  if (result) {
    qword_100046EC8 += size;
  }
  return result;
}
...
void acm_mem_free(void *a1, rsize_t __n)
{
  if (a1)
  {
    memset_s(a1, __n, 0, __n);
    free(a1);
    uint64_t v4 = qword_100046EC8 - __n;
    if (qword_100046EC8 < __n) {
      uint64_t v4 = 0;
    }
    qword_100046EC8 = v4;
  }
...
const char *acm_mem_alloc_info(const char *result, const void *a2, uint64_t a3, const char *a4, int a5, const char *a6)
{
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_alloc_info", v7, a2, a3, qword_100046EB8, 0, qword_100046EC0, qword_100046EC8, v8, a5, v6);
  }
  return result;
}
...
const char *acm_mem_free_info(const char *result, const void *a2, unint64_t a3, const char *a4, int a5, const char *a6)
{
  if (a2)
  {
    uint64_t v6 = qword_100046EB8 - a3;
    if (qword_100046EB8 < a3) {
      uint64_t v6 = 0;
    }
    qword_100046EB8 = v6;
  }
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_free_info", v8, a2, a3, qword_100046EB8, 0, qword_100046EC0, qword_100046EC8, v9, a5, v7);
  }
  return result;
}
...
uint64_t GetSerializedVerifyPolicySize(uint64_t a1, char *__s1, uint64_t a3, uint64_t a4, _DWORD *a5, unsigned int a6, void *a7)
{
  ...
  if (a1 && __s1 && a7)
  {
    ...
    {
      size_t v13 = v12;
      uint64_t result = sub_1000169D8(a5, a6, &v14);
      if (!result) {
        *a7 = v13 + v14 + 26;
      }
    }
...
uint64_t sub_1000169D8(_DWORD *a1, unsigned int a2, _DWORD *a3)
{
            ...
            if (!result)
            {
              ...
              *a7 = *a1;
              ...
              else
              {
                ...
                *(_DWORD *)(v19 + 18) = v15;
                size_t v20 = v18 + 22;
                uint64_t result = sub_100016C08((uint64_t)a5, a6, (uint64_t)a7, (uint64_t *)&v20);
                if (!result) {
                  *a8 = v20;
                }
              }
...
uint64_t sub_100016C08(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  LODWORD(v6) = a2;
  if (gACMLoggingLevel <= 0xAu) {
    ...
    if (v6)
    {
      ...
      while (1)
      {
        *(_OWORD *)__src = *(_OWORD *)a1;
        ...
        uint64_t v12 = sub_1000199BC(__src);
        if (v12) {
          break;
        }
...
uint64_t DeserializeVerifyPolicy(uint64_t a1, unint64_t a2, _OWORD *a3, void *a4, BOOL *a5, _DWORD *a6, void *a7, _DWORD *a8)
{
  ...
  if (a2 >= 0x10 && a1 && a3 && a4 && a5 && a6 && a7 && a8)
  {
    *a3 = *(_OWORD *)a1;
    ...
    id v26 = a4;
    unint64_t v18 = v17 + 1;
    id v19 = acm_mem_alloc_data(v17 + 1);
    ...
    else
    {
      ...
      uint64_t v8 = sub_100016F48(a1, a2, &v29, &v28, &v27);
      if (!v8)
      {
        *id v26 = v19;
        BOOL *v20 = v21;
...
uint64_t sub_100016F48(uint64_t a1, unint64_t a2, unint64_t *a3, void *a4, _DWORD *a5)
{
  uint64_t v10 = &OBJC_PROTOCOL___NSXPCListenerDelegate;
  if (gACMLoggingLevel <= 0xAu) {
...
LABEL_24:
  ...
  int v27 = v14;
  uint64_t v15 = 24 * v14;
  __int16 v16 = (char *)acm_mem_alloc(24 * v14);
  ...
  while (1)
  {
    ...
    *(void *)&v16[v17 + 8] = 0;
    ...
    uint64_t v21 = sub_1000199BC(&v16[v17]);
    if (v21)
    {
      uint64_t v12 = v21;
      unsigned int v11 = 70;
...
LABEL_31:
  uint64_t v10 = &OBJC_PROTOCOL___NSXPCListenerDelegate;
LABEL_25:
  if (v11 >= LOBYTE(v10[49].inst_meths)) {
...
uint64_t GetSerializedVerifyAclConstraintSize(int a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, unsigned int a6, uint64_t a7, uint64_t a8, _DWORD *a9, unsigned int a10, void *a11)
{
  ...
  if (a3)
  {
    if (a11)
    {
      ...
      {
        uint64_t result = sub_1000169D8(a9, a10, &v18);
        if (!result)
        {
          uint64_t v15 = 29;
          if (a1 == 32) {
...
uint64_t SerializeVerifyAclConstraint(int a1, _OWORD *a2, const void *a3, unsigned int a4, const void *a5, unsigned int a6, char a7, int a8, _DWORD *a9, unsigned int a10, uint64_t a11, void *a12)
{
  ...
  {
    unsigned int v31 = 0;
    uint64_t result = sub_1000169D8(a9, a10, &v31);
    if (!result)
    {
      uint64_t v21 = 29;
      if (a1 == 32) {
      ...
      else
      {
        ...
        *(_DWORD *)(v26 + 1) = v28;
        uint64_t v30 = v24 + 5;
        uint64_t result = sub_100016C08((uint64_t)a9, a10, a11, &v30);
        if (!result) {
          *a12 = v30;
        }
      }
...
LABEL_19:
            if (v22 != v16)
            {
              ...
              if (v16 - (v22 + 1) >= 4)
              {
                ...
                unint64_t v34 = v22 + 5;
                uint64_t v12 = sub_100016F48(a2, v16, &v34, &v33, &v32);
                if (!v12)
                {
...
uint64_t GetSerializedProcessAclSize(uint64_t a1, uint64_t a2, unsigned int a3, uint64_t a4, unsigned int a5, uint64_t a6, _DWORD *a7, unsigned int a8, void *a9)
{
  ...
  {
    uint64_t result = sub_1000169D8(a7, a8, &v12);
    if (!result) {
    ...
    if (!v15 && a8 <= 0xA && (a7 != 0) == (a8 != 0))
    {
      ...
      if (!result)
      {
        ...
        else
        {
          ...
          *(_DWORD *)(a9 + v21) = v17;
          unint64_t v22 = v21 + 4;
          uint64_t result = sub_100016C08((uint64_t)a7, a8, a9, (uint64_t *)&v22);
          if (!result) {
            *a10 = v22;
          }
        }
...
LABEL_20:
                            ...
                            else
                            {
                              ...
                              unint64_t v40 = v21 + 4;
                              uint64_t v10 = sub_100016F48(a1, v17, &v40, &v39, &v38);
                              if (!v10)
                              {
          ...
          if (v7 == *((_DWORD *)__s2 + 7))
          {
            ...
            switch(*(_DWORD *)__s1)
            {
              ...
              case 7:
                ...
                BOOL v9 = sub_1000187DC((unint64_t)(__s1 + 4), 0x20uLL, (unint64_t)(__s2 + 4), 32);
                if (!v9) {
                  goto LABEL_100;
                }
              ...
              case 0xA:
                ...
                BOOL v9 = sub_1000187DC((unint64_t)__s1 + 36, 0x10uLL, (unint64_t)__s2 + 36, 16);
                if (!v9) {
                  goto LABEL_100;
                }
...
LABEL_8:
              ...
              case 0x15:
                ...
                uint64_t v22 = 128;
LABEL_103:
                LOBYTE(v9) = sub_1000187DC((unint64_t)v13, v21, (unint64_t)v14, v22);
                goto LABEL_100;
              default:
                return v3;
            }
...
BOOL sub_1000187DC(unint64_t __s1, size_t __n, unint64_t __s2, uint64_t a4)
{
  if (__n != a4) {
    return 0;
  }
...
uint64_t LibSer_StorageSetData_GetSize(uint64_t a1, _DWORD *a2, unsigned int a3, void *a4)
{
  ...
  uint64_t result = sub_1000169D8(a2, a3, &v7);
  if (!result) {
    *a4 = a1 + v7 + 28;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a7)
      {
        ...
        {
          unsigned int v18 = 0;
          uint64_t result = sub_1000169D8(a5, a6, &v18);
          if (!result)
          {
            if (*a8 < a4 + v18 + 28)
            {
            ...
            else
            {
              ...
              *(_DWORD *)(a7 + 20) = a4;
              ...
              size_t v17 = a4 + 24;
              uint64_t result = sub_100016C08((uint64_t)a5, a6, a7, (uint64_t *)&v17);
              if (!result) {
                *a8 = v17;
              }
            }
...
uint64_t LibSer_StorageSetData_Deserialize(uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, void *a5, void *a6, void *a7, _DWORD *a8)
{
  ...
  if (a1 && a2 >= 0x18 && a6 && a3 && a4 && a5 && a7 && a8)
  {
    ...
    *a6 = v11;
    ...
    return sub_100016F48(a1, a2, v14, a7, a8);
  }
  return v10;
}
...
uint64_t LibSer_StorageGetData_GetSize(_DWORD *a1, unsigned int a2, void *a3)
{
  ...
  uint64_t result = sub_1000169D8(a1, a2, &v5);
  if (!result) {
    *a3 = v5 + 25;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a6)
      {
        ...
        {
          unsigned int v16 = 0;
          uint64_t result = sub_1000169D8(a4, a5, &v16);
          if (!result)
          {
            ...
            else
            {
              ...
              *(unsigned char *)(a6 + 20) = a3;
              uint64_t v15 = 21;
              uint64_t result = sub_100016C08((uint64_t)a4, a5, a6, &v15);
              if (!result) {
                *a7 = v15;
              }
            }
...
uint64_t LibSer_StorageGetData_Deserialize(uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, BOOL *a5, void *a6, _DWORD *a7)
{
  ...
  if (a1 && a2 >= 0x15 && a3 && a4 && a5)
  {
    ...
    *a5 = *(unsigned char *)(a1 + 20) != 0;
    v11[0] = 21;
    return sub_100016F48(a1, a2, v11, a6, a7);
  }
  return v9;
}
...
uint64_t LibSer_GetUnlockSecret_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, _OWORD *a4, void *a5)
{
  ...
  if (a1)
  {
    if (a4)
    {
      ...
      {
        unsigned int v12 = 0;
        uint64_t result = sub_1000169D8(a2, a3, &v12);
        if (!result)
        {
          ...
          else
          {
            *a4 = *a1;
            uint64_t v11 = 16;
            uint64_t result = sub_100016C08((uint64_t)a2, a3, (uint64_t)a4, &v11);
            if (!result) {
              *a5 = v11;
            }
          }
...
uint64_t LibSer_GetUnlockSecret_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5)
{
  ...
  if (a2 >= 0x10 && a3 && a4)
  {
    if (a5)
    {
      ...
      *a3 = *a1;
      v9[0] = 16;
      return sub_100016F48((uint64_t)a1, a2, v9, a4, a5);
    }
  }
  return result;
}
...
uint64_t LibSer_SEPControl_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6, void *a7)
{
  ...
  if (a6)
  {
    ...
    {
      unsigned int v18 = 0;
      uint64_t result = sub_1000169D8(a2, a3, &v18);
      if (!result)
      {
        if (*a7 < a5 + v18 + 24)
        {
        ...
        else
        {
          ...
          uint64_t v17 = 16;
          uint64_t result = sub_100016C08((uint64_t)a2, a3, a6, &v17);
          if (!result)
          {
            uint64_t v15 = v17;
            *(_DWORD *)(a6 + v17) = a5;
...
uint64_t LibSer_SEPControl_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5, unint64_t *a6, void *a7)
{
  ...
  if (a2 >= 0x18 && a7 && a3 && a4 && a5 && a6)
  {
    *a3 = *a1;
    unint64_t v12 = 16;
    uint64_t result = sub_100016F48((uint64_t)a1, a2, &v12, a4, a5);
    if (!result)
    {
...
uint64_t sub_1000199BC(_DWORD *a1)
{
  if (!a1) {
    return 4294967293;
  }
...
{
  return sub_10001A958(a1, a2, 0xBu, a3, a4, a5, 0, 0, a6, a7, a8, a9, a10);
}

uint64_t sub_10001A958(uint64_t result, uint64_t a2, unsigned __int8 a3, _OWORD *a4, const void *a5, uint64_t a6, const void *a7, unsigned int a8, unsigned __int8 a9, _DWORD *a10, unsigned int a11, unsigned int a12, uint64_t a13)
{
...
{
  return sub_10001A958(a1, a2, 0x20u, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);
}
...
{
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
  ...
  uint64_t v6 = 0;
  uint64_t v2 = LibCall_ACMContextCreate((uint64_t (*)(uint64_t, uint64_t, void, void, void, unsigned char *, uint64_t *))sub_10001C684, (uint64_t)&v6, a1, &byte_100046DE1, 1);
  if (v2)
  {
    sub_100021780();
    unsigned int v3 = 70;
  ...
  if (v3 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    unsigned int v8 = "ACMLib";
    __int16 v9 = 2080;
...
uint64_t sub_10001C684(uint64_t *a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315394;
  ...
  if (a1)
  {
    ...
    {
      uint64_t v16 = sub_10001D060(*a1, a2, a3, a4, a5, a6, a7);
      if (v16) {
        unsigned int v15 = 70;
      }
      else {
  ...
  if (v15 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315650;
    uint64_t v19 = "ACMLib";
    __int16 v20 = 2080;
...
_DWORD *ACMContextCreateWithExternalForm(_OWORD *a1, uint64_t a2)
{
  ...
  uint64_t v8 = 0;
  uint64_t v4 = LibCall_ACMContextCreateWithExternalForm((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, uint64_t, void *, uint64_t *))sub_10001C684, (uint64_t)&v8, a1, a2, &byte_100046DE1, 1);
  if (v4)
  {
    if (byte_100046DE1 <= 0x28u && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
    {
      int v5 = v4[4];
      *(_DWORD *)buf = 136315650;
      rsize_t v10 = "ACMLib";
  ...
  if (v6 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    rsize_t v10 = "ACMLib";
    __int16 v11 = 2080;
...
{
  unsigned int v4 = byte_100046DE1;
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v12 = "ACMLib";
  ...
  rsize_t v10 = a1;
  uint64_t v7 = LibCall_ACMContextDelete((void (*)(uint64_t, uint64_t, void, void *, uint64_t, void, void))sub_10001C684, (uint64_t)&v10, a1, a2);
  if (v7) {
    unsigned int v8 = 70;
  }
  else {
  ...
  if (v8 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
...
void ACMContextGetExternalForm(const void *a1, uint64_t a2)
{
  ...
  if (!a1
    || !a2
    || sub_10001CE7C()
    || sub_10001D060((uint64_t)a1, 19, 0, a1, 0x10uLL, 0, 0))
  {
...
uint64_t sub_10001CE7C()
{
  ...
  else
  {
    ...
    uint64_t v0 = IOServiceOpen(MatchingService, mach_task_self_, 0, (io_connect_t *)&dword_100046ED0);
    if (v0)
    {
      unsigned int v4 = 70;
      goto LABEL_10;
  ...
  unsigned int v4 = 10;
LABEL_10:
  if (v4 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v6 = 136315650;
    uint64_t v7 = "ACMLib";
    __int16 v8 = 2080;
...
uint64_t sub_10001D060(uint64_t a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
  ...
  if (v14)
  {
    ...
    else
    {
      ...
      size_t v22 = v16;
      uint64_t v17 = IOConnectCallStructMethod(dword_100046ED0, 0, v14, inputStructCnt, a6, &v22);
      uint64_t v18 = v17;
      if (a1) {
  ...
  if (v20 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    size_t v25 = "ACMLib";
    __int16 v26 = 2080;
...
uint64_t ACMContextAddCredentialWithScope(_OWORD *a1, unsigned int *a2, int a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedAddCredentialSize = sub_10001CE7C();
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!v13) {
          uint64_t v13 = sub_10001D060((uint64_t)a1, 5, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        size_t v14 = size;
...
uint64_t ACMContextRemoveCredentialsByTypeAndScope(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_10001D060((uint64_t)a1, 9, 0, v7, 0x18uLL, 0, 0);
  ...
  if (v9 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v11 = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
  ...
  if (a2 && (v7 & 1) == 0)
  {
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!v13) {
          uint64_t v13 = sub_10001D060(a1, 6, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        size_t v14 = size;
    ...
    else
    {
      ...
      if (v7)
      {
        *(_OWORD *)__int16 v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_10001D060((uint64_t)a1, 4, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_10001D060((uint64_t)a1, 16, 0, v7, 0x18uLL, 0, 0);
...
uint64_t ACMContextReplacePassphraseCredentialsWithScope(uint64_t a1, _DWORD *a2, uint64_t a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedReplacePassphraseCredentialSize = sub_10001CE7C();
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!v13) {
          uint64_t v13 = sub_10001D060(a1, 15, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        bzero(v12, size);
        size_t v14 = size;
    ...
    else
    {
      ...
      if (v7)
      {
        *(_OWORD *)char v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_10001D060((uint64_t)a1, 13, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
...
uint64_t ACMContextVerifyPolicy(_OWORD *a1, char *a2, uint64_t a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextVerifyPolicy_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_10001C684, (uint64_t)&v9, a1, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
  ...
  if (v7 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v11 = "ACMLib";
    __int16 v12 = 2080;
...
uint64_t ACMContextVerifyPolicyWithPreflight(_OWORD *a1, char *__s1, uint64_t a3, uint64_t a4)
{
  ...
  uint64_t v11 = a1;
  uint64_t v8 = LibCall_ACMContextVerifyPolicyWithPreflight_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_10001C684, (uint64_t)&v11, a1, __s1, a3, a4);
  if (v8) {
    unsigned int v9 = 70;
  }
  else {
...
void ACMContextVerifyPolicyEx(_OWORD *a1, char *__s1, uint64_t a3, _DWORD *a4, unsigned int a5, uint64_t a6, uint64_t a7)
{
  ...
  __int16 v14 = a1;
  LibCall_ACMContextVerifyPolicyEx_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_10001C684, (uint64_t)&v14, a1, __s1, a3, a4, a5, a6, a7);
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    __int16 v16 = "ACMLib";
...
{
  unsigned int v9 = a1;
  return LibCall_ACMContextVerifyAclConstraint((uint64_t)sub_10001C684, (uint64_t)&v9, a1, a2, a3, a4, a5, a6, a7, a8);
}
...
{
  uint64_t v11 = a1;
  return LibCall_ACMContextVerifyAclConstraintForOperation((uint64_t)sub_10001C684, (uint64_t)&v11, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
}
...
uint64_t ACMParseAclAndCopyConstraintCharacteristics(const void *a1, uint64_t a2, uint64_t a3)
{
  ...
  uint64_t SerializedProcessAclSize = sub_10001CE7C();
...
LABEL_31:
  ...
  uint64_t v13 = sub_10001D060(0, 20, 0, v9, size, v12, &__n);
  size_t v11 = __n;
  if (v13)
  {
    uint64_t v6 = v13;
...
LABEL_19:
  ...
  if (v17 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v22 = "ACMLib";
    __int16 v23 = 2080;
...
LABEL_13:
  ...
  if (v5 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v8 = 136315650;
    unint64_t v9 = "ACMLib";
    __int16 v10 = 2080;
...
void ACMGetAclAuthMethod(__n128 *a1, uint64_t a2)
{
  ...
  uint64_t v4 = a1;
  LibCall_ACMGetAclAuthMethod_Block((uint64_t)sub_10001C684, (uint64_t)&v4, a1, a2);
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v6 = "ACMLib";
...
uint64_t ACMSetEnvironmentVariable(int a1, const void *a2, size_t a3)
{
  ...
  uint64_t v9 = 0;
  uint64_t v6 = LibCall_ACMSetEnvironmentVariable((uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_10001C684, (uint64_t)&v9, a1, 0, 0, 0, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
...
uint64_t ACMSetEnvironmentVariableWithAccessPolicy(int a1, _OWORD *a2, _OWORD *a3, uint64_t a4, const void *a5, size_t a6)
{
  ...
  uint64_t v15 = 0;
  uint64_t v12 = LibCall_ACMSetEnvironmentVariable((uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_10001C684, (uint64_t)&v15, a1, a2, a3, a4, a5, a6);
  if (v12) {
    unsigned int v13 = 70;
  }
  else {
  ...
  if (v13 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315906;
    int v17 = "ACMLib";
    __int16 v18 = 2080;
...
uint64_t ACMGetEnvironmentVariable(int a1, uint64_t a2)
{
  ...
  uint64_t v7 = 0;
  uint64_t v4 = LibCall_ACMGetEnvironmentVariable_Block((uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, uint64_t, uint64_t))sub_10001C684, (uint64_t)&v7, a1, a2);
  if (v4) {
    unsigned int v5 = 70;
  }
  else {
...
uint64_t ACMKernelControl(int a1)
{
  ...
  uint64_t v2 = LibCall_ACMKernelControl_Block((uint64_t)sub_10001C684);
  if (v2) {
    unsigned int v3 = 70;
  }
  else {
...
{
  uint64_t v4 = 0;
  return LibCall_ACMSEPControl_Block((uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_10001C684, (uint64_t)&v4, a1, a2, 0, 0, 0, a3);
}

uint64_t ACMSEPControlEx(uint64_t a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6)
{
  uint64_t v7 = 0;
  return LibCall_ACMSEPControl_Block((uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_10001C684, (uint64_t)&v7, a4, a5, a1, a2, a3, a6);
}
...
void ACMGlobalContextCredentialGetProperty(int a1, int a2, uint64_t a3)
{
  ...
  uint64_t v6 = 0;
  LibCall_ACMGlobalContextCredentialGetProperty_Block((uint64_t)sub_10001C684, (uint64_t)&v6, a1, a2, a3);
  if (byte_100046DE1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, uint64_t a4)
{
  ...
  {
    __int16 v9 = a1;
    uint64_t v8 = LibCall_ACMContextCredentialGetProperty((uint64_t (*)(uint64_t, uint64_t, void, __n128 *, uint64_t, uint64_t, uint64_t, __n128))sub_10001C684, (uint64_t)&v9, a1, a2, a3, (uint64_t)buf, (uint64_t)&v10);
...
uint64_t ACMContextSetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, const void *a5, size_t a6)
{
  ...
  __int16 v15 = a1;
  uint64_t v12 = LibCall_ACMContextSetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, void, void))sub_10001C684, (uint64_t)&v15, a1, a2, a3, a4, a5, a6);
  if (v12) {
    unsigned int v13 = 70;
  }
  else {
...
uint64_t ACMContextGetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, uint64_t a5)
{
  ...
  uint64_t v21 = 4;
  __int16 v19 = a1;
  uint64_t v10 = LibCall_ACMContextGetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_10001C684, (uint64_t)&v19, a1, a2, 1, a3, a4, (uint64_t)&size, (uint64_t)&v21);
  if (!v10)
  {
    uint64_t v11 = size;
    if (size)
    {
      ...
      uint64_t v20 = size;
      __int16 v18 = a1;
      uint64_t v13 = LibCall_ACMContextGetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_10001C684, (uint64_t)&v18, a1, a2, 0, a3, a4, (uint64_t)v12, (uint64_t)&v20);
      uint64_t v14 = v13;
      if (a5 && !v13) {
...
LABEL_11:
  unsigned int v16 = 70;
LABEL_15:
  if (v16 >= byte_100046DE1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
...
uint64_t ACMContextGetInfo(long long *a1, int a2, void *a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextGetInfo((uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, _OWORD *, unint64_t *))sub_10001C684, (uint64_t)&v9, a1, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
...
{
  uint64_t v1 = 0;
  return LibCall_ACMPing((uint64_t (*)(uint64_t, uint64_t, void, void, void, void, void))sub_10001C684, (uint64_t)&v1, 29);
}
...
void sub_100021780()
{
  ...
  if (IOConnectCallScalarMethod(dword_100046ED0, 2u, 0, 0, &output, &outputCnt)) {
    goto LABEL_8;
  }
  unsigned __int8 v0 = output;
  unsigned int v1 = output;
  byte_100046DE1 = output;
...
LABEL_8:
    unsigned int v1 = byte_100046DE1;
  }
...
{
  return sub_100025674(a1, a2, 12, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, 0, 0);
}

uint64_t sub_100025674(uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, _DWORD *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
...
LABEL_84:
  ...
  if (a5 && a13 && a6)
  {
    uint64_t v25 = sub_1000267C4(a1, a2, a5, a6, a13);
LABEL_76:
    if (v25) {
      unsigned int v24 = 70;
    }
...
{
  return sub_100025674(a1, a2, 30, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14);
}
...
uint64_t sub_1000267C4(uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, const void *a3, unsigned int a4, unsigned char *a5)
{
  int v19 = 0;
  uint64_t v18 = 4;
  size_t v10 = a4;
...
id sub_1000269B0(uint64_t a1, uint64_t a2)
{
  uint64_t v10 = 0;
  uint64_t v11 = &v10;
  uint64_t v12 = 0x3032000000;
  unsigned int v13 = sub_100026B48;
  uint64_t v14 = sub_100026B58;
  id v15 = 0;
  id v4 = [objc_alloc((Class)NSXPCConnection) initWithMachServiceName:@"com.apple.CoreAuthentication.daemon.EndpointProvider" options:4096];
  uint64_t v5 = +[NSXPCInterface interfaceWithProtocol:&OBJC_PROTOCOL___LAProtocolEndpointProviderServer];
  [v4 setRemoteObjectInterface:v5];

  [v4 resume];
  uint64_t v6 = [v4 synchronousRemoteObjectProxyWithErrorHandler:&stru_1000392B8];
  v9[0] = _NSConcreteStackBlock;
  v9[1] = 3221225472;
  _DWORD v9[2] = sub_100026C08;
  unint64_t v9[3] = &unk_100038C58;
  v9[4] = &v10;
...
void sub_100026B30(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
uint64_t sub_100026B48(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_100026B60(id a1, NSError *a2)
{
  uint64_t v2 = a2;
  unsigned int v3 = sub_100026BB4();
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG)) {
    sub_100026F34((uint64_t)v2, v3, v4, v5, v6, v7, v8, v9);
  }
}

id sub_100026BB4()
{
  if (qword_100046ED8 != -1) {
    dispatch_once(&qword_100046ED8, &stru_1000392D8);
  }
  uint64_t v0 = (void *)qword_100046EE0;
...
{
  if (qword_100046EF0 != -1) {
    dispatch_once(&qword_100046EF0, &stru_1000392F8);
  }
  uint64_t v2 = sub_100026BB4();
  ...
  if (!byte_100046EE8)
  {
    if (qword_100046F00 != -1) {
      dispatch_once(&qword_100046F00, &stru_100039318);
    }
    unsigned int v3 = sub_100026BB4();
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG)) {
      sub_100027040(v3);
  ...
  if (([v5 hasPrefix:@"com.apple.SecurityAgent"] & 1) != 0
    || ([v5 hasPrefix:@"com.apple.authorizationhost"] & 1) != 0)
  {
    unsigned int v6 = 1;
  }
  else
  {
    unsigned int v6 = [v5 hasPrefix:@"com.apple.AppSSOAgent"];
  }
  uint64_t v7 = sub_100026BB4();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    sub_100026FA0((uint64_t)v5, v6, v7);
  }

  if (v6)
  {
    uint64_t v8 = sub_1000269B0(a1, 0xFFFFFFFFLL);
  }
  else
  {
LABEL_19:
...
void sub_100026DC0(id a1)
{
  qword_100046EE0 = (uint64_t)os_log_create("com.apple.LocalAuthentication", "EndpointProvider");
...
void sub_100026E04(id a1)
{
  ...
  {
    uint64_t v1 = sub_100026BB4();
    if (os_log_type_enabled(v1, OS_LOG_TYPE_DEBUG)) {
      sub_100027148((uint64_t)&__s1, v1, v2, v3, v4, v5, v6, v7);
    }

    uint64_t v8 = __s1;
    byte_100046EE8 = strcmp(__s1, "System") == 0;
    free(v8);
  }
}
...
void sub_100026E9C(id a1)
{
  ...
  if (!vproc_swap_string())
  {
    uint64_t v1 = sub_100026BB4();
    if (os_log_type_enabled(v1, OS_LOG_TYPE_DEBUG)) {
      sub_1000271B8((uint64_t)&__s1, v1, v2, v3, v4, v5, v6, v7);
    }

    uint64_t v8 = __s1;
    byte_100046EF8 = strcmp(__s1, "LoginWindow") == 0;
    free(v8);
  }
}

void sub_100026F34(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100026FA0(uint64_t a1, char a2, os_log_t log)
{
  CFStringRef v3 = @"YES";
  if ((a2 & 1) == 0) {
    CFStringRef v3 = @"NO";
  ...
  __int16 v6 = 2112;
  CFStringRef v7 = v3;
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "isKnownProcess:'%@' %@", (uint8_t *)&v4, 0x16u);
}

void sub_100027040(os_log_t log)
{
  v1[0] = 67109120;
  v1[1] = byte_100046EF8;
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "runningInLoginWindowContext = %d", (uint8_t *)v1, 8u);
}

void sub_1000270C4(os_log_t log)
{
  v1[0] = 67109120;
  v1[1] = byte_100046EE8;
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "runningInSystemContext = %d", (uint8_t *)v1, 8u);
}

void sub_100027148(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000271B8(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
{
  sub_1000082E0();
  sub_1000082C4((void *)&_mh_execute_header, v0, v1, "ignoring repeating feedback", v2, v3, v4, v5, v6);
}

void sub_10002725C(int a1, NSObject *a2, uint64_t a3)
{
  v3[0] = 67109120;
  v3[1] = a1;
  sub_1000082EC((void *)&_mh_execute_header, a2, a3, "pending feedback: %d", (uint8_t *)v3);
}

void sub_1000272CC(int a1, NSObject *a2, uint64_t a3)
{
  v3[0] = 67109120;
  v3[1] = a1;
  sub_1000082EC((void *)&_mh_execute_header, a2, a3, "scheduling feedback: %d", (uint8_t *)v3);
}

void sub_10002733C()
{
  sub_1000082E0();
  sub_1000082C4((void *)&_mh_execute_header, v0, v1, "done waiting, no pending feedback", v2, v3, v4, v5, v6);
}

void sub_100027370(id *a1, NSObject *a2)
{
  unsigned int v3 = [*a1 intValue];
  v5[0] = 67109120;
  v5[1] = v3;
  sub_1000082EC((void *)&_mh_execute_header, a2, v4, "done waiting, found pending feedback: %d", (uint8_t *)v5);
}

void sub_1000273F8()
{
  sub_1000082E0();
  sub_1000082C4((void *)&_mh_execute_header, v0, v1, "finished", v2, v3, v4, v5, v6);
}

void sub_10002742C()
{
  sub_1000082E0();
  sub_1000082C4((void *)&_mh_execute_header, v0, v1, "dispatched directly", v2, v3, v4, v5, v6);
}

void sub_100027460(uint64_t a1, NSObject *a2)
{
  unsigned int v3 = [*(id *)(a1 + 32) count];
  v5[0] = 67109120;
  v5[1] = v3;
  sub_1000082EC((void *)&_mh_execute_header, a2, v4, "pending block[%d]", (uint8_t *)v5);
}

void sub_1000274E8(uint64_t a1, NSObject *a2)
{
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  id v5 = WeakRetained;
  ...
  __int16 v12 = 2114;
  id v13 = v7;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "RemoteUIListener invalidated connection: %{public}@(hash:%x) listener:%{public}@", (uint8_t *)&v8, 0x1Cu);
}

void sub_1000275D0(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "connection invalidated", v1, 2u);
}

void sub_100027614(uint64_t a1, NSObject *a2)
{
  int v2 = 134217984;
  uint64_t v3 = a1;
  _os_log_debug_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_DEBUG, "Invalid endpointId: %ld", (uint8_t *)&v2, 0xCu);
}

void sub_10002768C(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "getEndpoint failed %@", (uint8_t *)&v2, 0xCu);
}

void sub_100027704(uint64_t a1, NSObject *a2)
{
  int v2 = 138543362;
  uint64_t v3 = a1;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "Failed to create context for security delay restart: %{public}@", (uint8_t *)&v2, 0xCu);
}
...
void sub_10002777C(id *a1)
{
  [*a1 identifier];
  sub_100011AE8();
  sub_100011B00((void *)&_mh_execute_header, v1, v2, "credentialOfType rid:%u returned %{public}@", v3, v4, v5, v6, v7);
}
...
void sub_1000277FC(id *a1)
{
  [*a1 identifier];
  sub_100011AE8();
  sub_100011B00((void *)&_mh_execute_header, v1, v2, "externalizedContextWithReply rid:%u returned %{public}@", v3, v4, v5, v6, v7);
}

void sub_10002787C(id *a1)
{
  [*a1 identifier];
  sub_100011AE8();
  sub_100011B00((void *)&_mh_execute_header, v1, v2, "tokenForTransferToUnknownProcess rid:%u returned %{public}@", v3, v4, v5, v6, v7);
}

void sub_1000278FC(uint64_t a1, NSObject *a2)
{
  int v2 = *(_DWORD *)(a1 + 40);
  v3[0] = 67109120;
  v3[1] = v2;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "Exceeded maximum context count, invalidating context for PID: %d", (uint8_t *)v3, 8u);
}

void sub_100027978(uint64_t a1, NSObject *a2)
{
  unsigned int v4 = [*(id *)(a1 + 32) identifier];
  unsigned int v5 = [*(id *)(a1 + 40) pid];
  v6[0] = 67109376;
  v6[1] = v4;
  __int16 v7 = 1024;
  unsigned int v8 = v5;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "Exceeded maximum context count, invalidating context for rid:%u held by pid:%d", (uint8_t *)v6, 0xEu);
}

void sub_100027A2C(uint64_t *a1, NSObject *a2)
{
  uint64_t v2 = *a1;
  int v3 = 138412290;
  uint64_t v4 = v2;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "Timeout waiting for confirmation from: %@", (uint8_t *)&v3, 0xCu);
}

void sub_100027AA8(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3 = 138543618;
  uint64_t v4 = a1;
  __int16 v5 = 2114;
  uint64_t v6 = a2;
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "Clearing unexpected notification: %{public}@, pending: %{public}@", (uint8_t *)&v3, 0x16u);
}

void sub_100027B30(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100027BA0(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100027C10(uint64_t a1, NSObject *a2)
{
  int v2 = 138543362;
  uint64_t v3 = a1;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "Created module: %{public}@", (uint8_t *)&v2, 0xCu);
}

void sub_100027C88(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3 = 138543618;
  uint64_t v4 = a1;
  __int16 v5 = 2114;
  uint64_t v6 = a2;
  _os_log_fault_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_FAULT, "Class issue detected while loading principal class from bundle: %{public}@ at %{public}@", (uint8_t *)&v3, 0x16u);
}
...
uint64_t LACDTBiometryWatchdogGlobalFallbackTime()
{
  return _LACDTBiometryWatchdogGlobalFallbackTime();
}
...
uint64_t LACLogDTOStorage()
{
  return _LACLogDTOStorage();
}

uint64_t LACLogEnvironment()
{
  return _LACLogEnvironment();
}

uint64_t LALogCategoryForOptions()
{
  return _LALogCategoryForOptions();
}
...
id objc_msgSend__startBiometryMonitoring(void *a1, const char *a2, ...)
{
  return [a1 _startBiometryMonitoring];
}

id objc_msgSend__startDTO(void *a1, const char *a2, ...)
{
  return [a1 _startDTO];
}

id objc_msgSend__startEnvironment(void *a1, const char *a2, ...)
{
  return [a1 _startEnvironment];
}

id objc_msgSend__startMonitors(void *a1, const char *a2, ...)
{
  return [a1 _startMonitors];
}

id objc_msgSend__startNotificationServices(void *a1, const char *a2, ...)
{
  return [a1 _startNotificationServices];
}

id objc_msgSend__startUserPasswordMonitoring(void *a1, const char *a2, ...)
{
  return [a1 _startUserPasswordMonitoring];
}

id objc_msgSend__workQueue(void *a1, const char *a2, ...)
{
  return [a1 _workQueue];
}
...
id objc_msgSend_axApplePayConfirmation(void *a1, const char *a2, ...)
{
  return [a1 axApplePayConfirmation];
}

id objc_msgSend_biometryHelper(void *a1, const char *a2, ...)
{
  return [a1 biometryHelper];
}
...
id objc_msgSend_bypassEntitlements(void *a1, const char *a2, ...)
{
  return [a1 bypassEntitlements];
}
...
{
  return [a1 cachedExternalizedContext];
}
...
id objc_msgSend_collectIfNeeded(void *a1, const char *a2, ...)
{
  return [a1 collectIfNeeded];
}
...
id objc_msgSend_dto(void *a1, const char *a2, ...)
{
  return [a1 dto];
}

id objc_msgSend_dtoAnalytics(void *a1, const char *a2, ...)
{
  return [a1 dtoAnalytics];
}

id objc_msgSend_dumpStatus(void *a1, const char *a2, ...)
{
  return [a1 dumpStatus];
}
...
id objc_msgSend_errorNotSupported(void *a1, const char *a2, ...)
{
  return [a1 errorNotSupported];
}
...
id objc_msgSend_evaluationProcessor(void *a1, const char *a2, ...)
{
  return [a1 evaluationProcessor];
}
...
id objc_msgSend_featureFlagDimpleKeyGracePeriodEnabled(void *a1, const char *a2, ...)
{
  return [a1 featureFlagDimpleKeyGracePeriodEnabled];
}

id objc_msgSend_hasCompletedSetup(void *a1, const char *a2, ...)
{
  return [a1 hasCompletedSetup];
}
...
id objc_msgSend_listenToLaunchNotifications(void *a1, const char *a2, ...)
{
  return [a1 listenToLaunchNotifications];
}
...
{
  return [a1 managedContext];
}

id objc_msgSend_mechanismManager(void *a1, const char *a2, ...)
{
  return [a1 mechanismManager];
}
...
id objc_msgSend_nullInstance(void *a1, const char *a2, ...)
{
  return [a1 nullInstance];
}
...
id objc_msgSend_oneness(void *a1, const char *a2, ...)
{
  return [a1 oneness];
}

id objc_msgSend_onenessSessionMonitor(void *a1, const char *a2, ...)
{
  return [a1 onenessSessionMonitor];
}
...
id objc_msgSend_originatorId(void *a1, const char *a2, ...)
{
  return [a1 originatorId];
}

id objc_msgSend_passcodeHelper(void *a1, const char *a2, ...)
{
  return [a1 passcodeHelper];
}
...
id objc_msgSend_requestFromCurrentConnection(void *a1, const char *a2, ...)
{
  return [a1 requestFromCurrentConnection];
}

id objc_msgSend_resultInfo(void *a1, const char *a2, ...)
{
  return [a1 resultInfo];
}
...
id objc_msgSend_secureStorage(void *a1, const char *a2, ...)
{
  return [a1 secureStorage];
}
...
id objc_msgSend_sharedMode(void *a1, const char *a2, ...)
{
  return [a1 sharedMode];
}
...
id objc_msgSend_startController(void *a1, const char *a2, ...)
{
  return [a1 startController];
}
...
id objc_msgSend_trustStateProvider(void *a1, const char *a2, ...)
{
  return [a1 trustStateProvider];
}
...
{
  return [a1 uiController];
}

id objc_msgSend_underlyingPtr(void *a1, const char *a2, ...)
{
  return [a1 underlyingPtr];
}
...
id objc_msgSend_xpcController(void *a1, const char *a2, ...)
{
  return [a1 xpcController];
}