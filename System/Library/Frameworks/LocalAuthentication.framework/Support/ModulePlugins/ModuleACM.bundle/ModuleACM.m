void sub_2EC0(_Unwind_Exception *a1)
{
  uint64_t v1;
...
{
  if (qword_30FF8 != -1) {
    dispatch_once(&qword_30FF8, &stru_2CC40);
  }
  v0 = (void *)qword_31000;
...
void sub_3298(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  id v6 = a5;
  v7 = LACLogACM();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2112;
    v13 = v9;
    _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEFAULT, "Policy '%s' is requesting: %@", (uint8_t *)&v10, 0x16u);
  }
  (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
}

void sub_33B0(uint64_t a1, uint64_t a2, uint64_t a3, int *a4, void *a5)
{
  id v9 = a5;
  if (!v9)
  {
    [*(id *)(a1 + 32) setImmediateSuccess:a3];
    int v10 = *(void **)(a1 + 40);
    uint64_t v11 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"ACM verification of %s", +[LAACMHelper acmPolicyForPolicy:*(void *)(a1 + 80)]);
    ...
    if (a2 == -2)
    {
      __int16 v12 = +[LAErrorHelper errorWithCode:-10 message:@"ACM context not found."];
      v13 = [*(id *)(a1 + 48) callback];
    ...
    if (a3
      && (*(void *)(a1 + 80) != 1004
       || (v18[0] = _NSConcreteStackBlock,
           ...
           v18[3] = &unk_2C598,
           v18[4] = &v19,
           ACMRequirementGetSubrequirements(a4, (uint64_t)v18),
           *((unsigned char *)v20 + 24))))
    {
      v14 = [*(id *)(a1 + 40) resultInfo];
      v15 = [v14 objectForKey:@"Result"];

      uint64_t v16 = *(void *)(a1 + 72);
      if (!v15)
      {
        (*(void (**)(void, _UNKNOWN **, void))(v16 + 16))(*(void *)(a1 + 72), &off_2EA98, 0);
        goto LABEL_13;
      }
      v17 = [*(id *)(a1 + 40) resultInfo];
      (*(void (**)(uint64_t, void *, void))(v16 + 16))(v16, v17, 0);
    }
    else
    {
      v17 = [*(id *)(a1 + 40) createInternalInfoWithPolicy:*(void *)(a1 + 80) policyOptions:*(void *)(a1 + 56) request:*(void *)(a1 + 32) originator:*(void *)(a1 + 48)];
...
void sub_3650(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
void sub_3B9C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, id *location)
{
...
void sub_4614(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
...
void sub_53D0(_Unwind_Exception *a1)
{
...
const char *acm_mem_alloc_info(const char *result, const void *a2, uint64_t a3, const char *a4, int a5, const char *a6)
{
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_alloc_info", v7, a2, a3, qword_31060, 0, qword_31068, qword_31070, v8, a5, v6);
  }
  return result;
}
...
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v8 = 136315394;
    id v9 = "ACMLib";
    __int16 v10 = 2080;
    uint64_t v11 = "ACMRequirementGetSubrequirements";
...
void ACMContextGetExternalForm(const void *a1, uint64_t a2)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    ...
    unint64_t v5 = "ACMLib";
    __int16 v6 = 2080;
    unint64_t v7 = "ACMContextGetExternalForm";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", (uint8_t *)&v4, 0x16u);
  }
  if (!a1 || !a2 || sub_6928() || sub_65A4((uint64_t)a1, 19, 0, a1, 0x10uLL, 0, 0)) {
...
uint64_t ACMContextCreate(uint64_t *a1)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v8 = "ACMLib";
    __int16 v9 = 2080;
    __int16 v10 = "ACMContextCreate";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  uint64_t v6 = 0;
  uint64_t v2 = LibCall_ACMContextCreate((uint64_t (*)(uint64_t, uint64_t, void, void, void, unsigned char *, uint64_t *))sub_63C4, (uint64_t)&v6, a1, &byte_30FF1, 1);
  if (v2)
  {
    sub_1D684();
    unsigned int v3 = 70;
  ...
  if (v3 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    int v8 = "ACMLib";
    __int16 v9 = 2080;
...
{
  unsigned int v4 = byte_30FF1;
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
    unsigned int v14 = "ACMContextDelete";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
    unsigned int v4 = byte_30FF1;
  }
  ...
  unsigned int v10 = a1;
  uint64_t v7 = LibCall_ACMContextDelete((void (*)(uint64_t, uint64_t, void, void *, uint64_t, void, void))sub_63C4, (uint64_t)&v10, a1, a2);
  if (v7) {
    unsigned int v8 = 70;
  }
  else {
  ...
  if (v8 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
...
uint64_t sub_63C4(uint64_t *a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315394;
  ...
  if (a1)
  {
    ...
    {
      uint64_t v16 = sub_65A4(*a1, a2, a3, a4, a5, a6, a7);
      if (v16) {
        unsigned int v15 = 70;
      }
      else {
  ...
  if (v15 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315650;
    uint64_t v19 = "ACMLib";
    __int16 v20 = 2080;
...
uint64_t sub_65A4(uint64_t a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
  ...
  if (v14)
  {
    ...
    else
    {
      ...
      size_t v22 = v16;
      uint64_t v17 = IOConnectCallStructMethod(dword_31078, 0, v14, inputStructCnt, a6, &v22);
      uint64_t v18 = v17;
      if (a1) {
      ...
      if (v17)
      {
        if (byte_30FF1 <= 0x46u && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
        {
      ...
      {
        if (byte_30FF1 <= 0x28u && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 136315906;
          v25 = "ACMLib";
          __int16 v26 = 2080;
  ...
  if (v20 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    v25 = "ACMLib";
    __int16 v26 = 2080;
...
uint64_t sub_6928()
{
  ...
  else
  {
    ...
    uint64_t v0 = IOServiceOpen(MatchingService, mach_task_self_, 0, (io_connect_t *)&dword_31078);
    if (v0)
    {
      unsigned int v4 = 70;
      goto LABEL_10;
  ...
  unsigned int v4 = 10;
LABEL_10:
  if (v4 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v6 = 136315650;
    uint64_t v7 = "ACMLib";
    __int16 v8 = 2080;
...
void sub_6B0C(uint64_t a1, uint64_t a2)
{
  uint64_t v2 = *(void **)(a1 + 32);
  id v3 = +[NSNumber numberWithUnsignedInt:ACMRequirementGetType(a2, a2)];
  [v2 addObject:v3];
}

void sub_7624(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  uint64_t v7 = [v5 availableMechanisms];
  __int16 v8 = [v5 mechanismTree];
  unsigned int v9 = [v5 internalInfo];
  __int16 v10 = *(void **)(a1 + 32);
  if (v10) {
    [v10 event:0 params:v7 reply:&stru_2C6F0];
  }
  uint64_t v11 = [v5 mechanism];
  if (v11)
  {
    ...
    id v27 = *(id *)(a1 + 80);
    id v26 = v8;
    [v14 authenticateForPolicy:v13 constraintData:v15 internalInfo:v22 uiDelegate:v18 originator:v16 request:v17 mechanism:v11 reply:v19];
...
void sub_7878(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  id v9 = a2;
  id v10 = a3;
  id v11 = a4;
  id v12 = a5;
  unsigned int v13 = +[LAErrorHelper error:v12 hasCode:-1004];
  uint64_t v14 = &CFGetTypeID_ptr;
  if (v13)
  {
    uint64_t v31 = 0;
    __int16 v32 = &v31;
    ...
    uint64_t v15 = +[NSMutableDictionary dictionaryWithObject:v32[5] forKey:LAAvailableMechanisms];
    [v15 setObject:v11 forKeyedSubscript:LAMechanismTree];
    uint64_t v16 = +[BiometryHelper sharedInstance];
    uint64_t v17 = [*(id *)(a1 + 32) objectForKeyedSubscript:@"UserId"];
    uint64_t v18 = [v16 biometryDatabaseHashForUser:v17 error:0];

    if (v18) {
      [v15 setObject:v18 forKey:LABiometryDatabaseHash];
    }
    size_t v19 = [v12 userInfo];
    id v20 = +[NSDictionary dictionaryByMerging:v19 with:v15];

    uint64_t v21 = +[LAErrorHelper errorWithCode:-1004 userInfo:v20];
  ...
  if (v12)
  {
    ...
    id v26 = [v22 dictionaryWithDictionary:v25];

    id v27 = +[BiometryHelper sharedInstance];
    __int16 v28 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v27 biometryType]);
...
void sub_7BB4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_7BD8(uint64_t a1, void *a2, void *a3)
{
  id v5 = a3;
  id v6 = [a2 objectForKey:@"Result"];
  if ([*(id *)(a1 + 32) _shouldRetryEvaluationForError:v5 options:*(void *)(a1 + 40)])
  {
    ...
    [v8 evaluatePolicy:v7 options:v9 uiDelegate:v10 originator:WeakRetained request:*(void *)(a1 + 48) reply:*(void *)(a1 + 64)];
  }
  else
  {
    if (!a2
      && [*(id *)(a1 + 32) _isBiometricOnlyPolicy:*(void *)(a1 + 80)]
      && [v5 code] == (id)-5)
    {
      id v12 = +[BiometryHelper sharedInstance];
      id v26 = 0;
      unsigned int v13 = [v12 deviceHasBiometryWithError:&v26];
      id v14 = v26;

      if (v13)
      {
        uint64_t v15 = +[BiometryHelper sharedInstance];
        id v16 = objc_loadWeakRetained((id *)(a1 + 72));
        uint64_t v17 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", [v16 userId]);
        id v25 = v14;
        unsigned int v18 = [v15 isEnrolled:v17 error:&v25];
        id v19 = v25;
      ...
      id v20 = [v14 userInfo];
      uint64_t v21 = +[NSMutableDictionary dictionaryWithDictionary:v20];

      id v22 = +[BiometryHelper sharedInstance];
      uint64_t v23 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v22 biometryType]);
      [v21 setObject:v23 forKey:LAErrorInfoBiometryType];

      uint64_t v24 = +[LAErrorHelper errorWithCode:userInfo:](LAErrorHelper, "errorWithCode:userInfo:", [v14 code], v21);
...
void sub_7E5C(uint64_t a1, uint64_t a2)
{
  ...
  id v25 = 0;
  uint64_t v9 = [v4 _nonUiMechanismForACMRequirement:a2 acmContextRecord:v5 policy:v7 internalInfo:v6 request:v8 state:&v26 error:&v25];
  id v10 = v25;
  id v12 = v10;
  if (!v9)
  {
  ...
  id v24 = v10;
  id v14 = [v9 bestEffortAvailableMechanismForRequest:v13 error:&v24];
  id v15 = v24;

  if (v14) {
    goto LABEL_5;
  }
  if (([v9 canRecoverFromError:v15 request:*(void *)(a1 + 56)] & 1) == 0)
  {
...
LABEL_5:
  ...
  if (*(void *)(a1 + 104) == 1004)
  {
    unsigned int v18 = +[LAACMHelper requirement:a2 hasFlag:2 andType:3];
    if (v16 == 1) {
      int v17 = 1;
    }
    else {
  ...
  if (v16 == 2)
  {
    v17 |= +[LAACMHelper requirement:a2 hasState:2 andType:11];
    if (*(void *)(a1 + 112) == 2)
    {
      if ([*(id *)(a1 + 64) containsObject:&off_2E968])
      {
        if ((([*(id *)(a1 + 56) customUI] ^ 1 | v17) & 1) == 0) {
          goto LABEL_14;
        }
        goto LABEL_17;
      }
...
LABEL_26:
  ...
  {
    id v22 = *(void **)(a1 + 80);
    uint64_t v23 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v15 code]);
    [v22 setObject:v15 forKey:v23];
  }
}

void sub_86B4(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (a2)
  {
    id v6 = +[NSData dataWithBytes:a2 length:a3];
    (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
  }
  else
  {
    uint64_t v4 = *(void *)(a1 + 32);
    id v6 = +[NSString stringWithFormat:@"ACMContextGetExternalForm failed."];
    uint64_t v5 = +[LAErrorHelper internalErrorWithMessage:](LAErrorHelper, "internalErrorWithMessage:");
    (*(void (**)(uint64_t, void, void *))(v4 + 16))(v4, 0, v5);
  }
}

void sub_883C(uint64_t a1, uint64_t a2)
{
  if (+[LAACMHelper requirement:a2 hasFlag:2 andType:3])
  {
    unsigned __int8 v9 = 0;
    id v3 = +[BiometryHelper sharedInstance];
    id v8 = 0;
    unsigned int v4 = [v3 userPresent:&v9 error:&v8];
    id v5 = v8;
    int v6 = v9;
...
void sub_93A8(_Unwind_Exception *a1)
{
  _Block_object_dispose((const void *)(v1 - 176), 8);
  _Unwind_Resume(a1);
}

void sub_93CC(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  if (v5)
  {
  ...
  else
  {
    ...
    id v8 = *(void (**)(uint64_t, void, id))(v7 + 16);
    id v9 = a3;
    v8(v7, 0, v9);
  }
}
...
void sub_954C(uint64_t a1, void *a2)
{
  if (a2)
  {
    uint64_t v3 = [a2 objectForKeyedSubscript:@"PIN"];
    uint64_t v4 = *(void *)(a1 + 32);
    id v7 = (id)v3;
    if (v3)
    {
    ...
    {
      id v6 = +[LAErrorHelper internalErrorWithMessage:@"Missing CTK PIN"];
...
uint64_t sub_96B0(uint64_t a1)
{
  uint64_t v1 = [*(id *)(a1 + 32) userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:LAErrorSubcodeKey];

  if (v2) {
    uint64_t v3 = [&off_2EAE8 containsObject:v2] ^ 1;
  }
  else {
    uint64_t v3 = 1;
  }
...
uint64_t sub_9720(uint64_t result, uint64_t a2)
{
...
void sub_9738(uint64_t a1, void *a2, void *a3)
{
  id v8 = a2;
  if ([a3 BOOLValue])
  {
    uint64_t v5 = [*(id *)(*(void *)(*(void *)(a1 + 32) + 8) + 40) arrayByAddingObject:v8];
...
void sub_97BC(uint64_t a1, void *a2, void *a3)
{
  uint64_t v14 = *(void *)(a1 + 112);
  id v15 = *(void **)(a1 + 32);
  id v16 = a3;
  id v5 = a2;
  int v17 = [v5 objectForKeyedSubscript:@"ConstraintData"];
  uint64_t v6 = [v17 objectForKeyedSubscript:*(void *)(a1 + 40)];
  id v7 = v6;
  if (!v6) {
    id v7 = *(void **)(a1 + 48);
  }
  ...
  id v19 = *(id *)(a1 + 80);
  id v20 = *(id *)(a1 + 88);
  [v15 finishedAuthenticationForPolicy:v14 constraintData:v7 operation:v13 internalInfo:v8 uiDelegate:v9 originator:WeakRetained request:v11 availabilityEvents:v12 result:v5 error:v16 reply:v18];
}

uint64_t sub_9930(void *a1, uint64_t a2, uint64_t a3)
{
  return (*(uint64_t (**)(void, uint64_t, void, void, uint64_t))(a1[6] + 16))(a1[6], a2, a1[4], a1[5], a3);
}

uint64_t sub_9A84(uint64_t a1, uint64_t a2)
{
  uint64_t v3 = [*(id *)(a1 + 32) _unsatisfiedListForRequirement:a2];
  if (v3) {
...
void sub_A044(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id *location)
{
  objc_destroyWeak(location);
...
void sub_A074(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  if (*(void *)(a1 + 32))
...
void sub_A190(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
  _Unwind_Resume(a1);
}

void sub_A1A4(uint64_t a1, void *a2)
{
  uint64_t v3 = (id *)(a1 + 48);
  id v4 = a2;
  id WeakRetained = objc_loadWeakRetained(v3);
  id v6 = [v4 integerValue];
  id v7 = [*(id *)(a1 + 32) objectForKeyedSubscript:@"Result"];
  id v8 = [WeakRetained _isEvent:v6 contributingToResult:v7];

  uint64_t v13 = &off_2E770;
  ...
  [v11 event:v12 params:v10 reply:&stru_2C7B0];
}

void sub_A2E0(uint64_t a1, uint64_t a2, uint64_t a3, char a4, uint64_t a5, void *a6)
{
  id v11 = a6;
  if (v11)
  {
    id v12 = *(void (**)(void))(*(void *)(a1 + 96) + 16);
LABEL_3:
    v12();
    goto LABEL_10;
  }
  ...
  if (v14)
  {
    id v15 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", +[LAACMHelper acmPolicyForPolicy:*(void *)(a1 + 104)]);
  }
  else
  {
    id v15 = *(void **)(a1 + 40);
  }
  id v16 = +[NSString stringWithFormat:@"Final ACM verification of %@", v15];
...
LABEL_12:
    ...
    if (*(void *)(a1 + 48))
    {
      unsigned int v18 = +[LAACMHelper requirement:a5 uint32Property:700];
      if ([v18 unsignedIntValue] <= 1)
      {
      }
      else
      {
        unsigned int v19 = +[LAACMHelper requirement:a5 hasState:1 andType:8];
    ...
    if (+[LAACMHelper requirement:a5 hasFlag:16 andType:3])
    {
      uint64_t v20 = *(void *)(a1 + 96);
      id v21 = +[LAErrorHelper errorWithCode:-1022 message:@"Failed to match the bound identity."];
      (*(void (**)(uint64_t, void, void *))(v20 + 16))(v20, 0, v21);
    }
    else
    {
      id v22 = [*(id *)(a1 + 56) objectForKeyedSubscript:@"SecondAcmRound"];
      unsigned int v23 = [v22 BOOLValue];

      if (v23)
      {
        uint64_t v24 = *(void *)(a1 + 96);
        id v25 = [*(id *)(a1 + 32) _unsatisfiedListForRequirement:a5];
        int v26 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"ACM %s succeeded, but ACM is still requesting %@ on ACMContext %u after a retry.", a2, v25, [*(id *)(a1 + 32) instanceId]);
        id v27 = +[LAErrorHelper internalErrorWithMessage:v26];
        (*(void (**)(uint64_t, void, void *))(v24 + 16))(v24, 0, v27);
      }
      else
      {
        __int16 v28 = [*(id *)(a1 + 64) log];
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          unsigned int v30 = [*(id *)(a1 + 32) instanceId];
          uint64_t v31 = [*(id *)(a1 + 32) _unsatisfiedListForRequirement:a5];
          *(_DWORD *)buf = 136315650;
          uint64_t v33 = a2;
          __int16 v34 = 1024;
        ...
        v29 = +[NSMutableDictionary dictionaryWithDictionary:*(void *)(a1 + 56)];
...
uint64_t sub_A6BC(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16))();
}

uint64_t sub_A7CC(uint64_t a1)
{
...
void sub_AE94(uint64_t a1, void *a2, void *a3)
{
  uint64_t v4 = *(void *)(a1 + 32);
  id v5 = a3;
  id v6 = a2;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"Result"];
  id v9 = (id)v7;
  if (v7) {
    id v8 = (id)v7;
  }
...
void sub_AF24(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  if (v5 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && ![*(id *)(a1 + 32) integerValue])
  {
...
void sub_B094(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  if (!v10)
...
LABEL_7:
  ...
  if (v6)
  {
    uint64_t v8 = +[NSDictionary dictionaryByMerging:*(void *)(a1 + 32) with:v10];
    (*(void (**)(uint64_t, void *, void))(v7 + 16))(v7, v8, 0);
  }
  else
  {
    (*(void (**)(void, id, void))(v7 + 16))(*(void *)(a1 + 40), v10, 0);
  }
LABEL_9:
}

void sub_B5D0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,char a27)
{
}
...
void sub_B5F0(uint64_t a1)
{
  ...
  id v6 = v10;
  *(unsigned char *)(*(void *)(a1 + 56) + 64) = 0;
  if (v5)
  {
    uint64_t v7 = [*(id *)(a1 + 64) log];
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)id v9 = 0;
...
void sub_BC44(_Unwind_Exception *a1)
{
  _Block_object_dispose((const void *)(v1 - 176), 8);
  _Unwind_Resume(a1);
}

void sub_BC64(uint64_t a1)
{
...
void sub_BD38(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  uint64_t v7 = +[DaemonUtils queue];
...
uint64_t sub_BE24(void *a1)
{
  return (*(uint64_t (**)(void, void, void))(a1[6] + 16))(a1[6], a1[4], a1[5]);
}

void sub_C044(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
...
void sub_C060(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  if (!v5)
  {
    id v13 = *(void (**)(void))(*(void *)(a1 + 88) + 16);
LABEL_8:
    v13();
    goto LABEL_9;
  }
  ...
  id v18 = *(id *)(a1 + 88);
  id v17 = v5;
  unsigned int v12 = [v14 _validatePassword:1 options:v15 uiDelegate:v7 originator:WeakRetained request:v9 callerName:v10 callerBundleId:v11 reply:v16];
...
uint64_t sub_C1D4(uint64_t a1, int a2)
{
  uint64_t v3 = *(void *)(a1 + 40);
  if (a2) {
    uint64_t v4 = *(void *)(a1 + 32);
...
uint64_t sub_C978(uint64_t a1, id a2)
{
  if (*(void *)(a1 + 32)) {
    **(void **)(a1 + 32) = a2;
  }
...
void sub_D0D8(uint64_t a1, uint64_t a2, int a3, uint64_t a4, uint64_t a5)
{
  if (a5)
  {
    id v6 = *(void (**)(void))(*(void *)(a1 + 128) + 16);
    v6();
    return;
  }
  ...
  if (a2)
  {
    if (a2 == -2)
    {
      id v30 = +[LAErrorHelper errorWithCode:-10 message:@"ACM context not found."];
      id v13 = [*(id *)(a1 + 48) callback];
      [v13 invalidatedWithError:v30];
    ...
    if (a2 == -3)
    {
      ...
      id v30 = +[NSString stringWithFormat:@"Invalid constraint: %@", *(void *)(a1 + 40)];
      uint64_t v11 = +[LAErrorHelper parameterErrorWithMessage:v30];
...
LABEL_16:
    ...
    id v30 = +[NSNumber numberWithInt:a2];
    uint64_t v15 = +[NSString stringWithFormat:@"ACM constraint verification failed: %@", v30];
    id v16 = +[LAErrorHelper internalErrorWithMessage:v15];
...
LABEL_15:
  ...
  {
    unsigned int v12 = *(void (**)(void))(*(void *)(a1 + 128) + 16);
    v12();
  }
  else
  {
    if (a3)
    {
      ...
      id v30 = [*(id *)(a1 + 64) resultInfo];
      uint64_t v15 = [v30 objectForKeyedSubscript:@"Result"];
      if (v15)
      {
        id v18 = [*(id *)(a1 + 64) resultInfo];
        (*(void (**)(uint64_t, void *, void))(v17 + 16))(v17, v18, 0);
      }
      else
      {
        (*(void (**)(uint64_t, _UNKNOWN **, void))(v17 + 16))(v17, &off_2EAC0, 0);
      }
      goto LABEL_15;
    }
    unsigned int v19 = [*(id *)(a1 + 64) createInternalInfo:*(void *)(a1 + 72) skipCallerIdentification:*(void *)(a1 + 80) != 0 callerBundleId:*(void *)(a1 + 88) request:*(void *)(a1 + 32) originator:*(void *)(a1 + 48)];
    uint64_t v20 = v19;
    ...
    if (*(_DWORD *)(a1 + 136))
    {
      unsigned int v23 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:");
      [v20 setObject:v23 forKey:@"GlobalCredential"];
    }
    [v20 setObject:*(void *)(a1 + 40) forKey:@"Constraint"];
    [v20 setObject:*(void *)(a1 + 96) forKey:@"ConstraintData"];
    [v20 setObject:*(void *)(a1 + 104) forKey:@"ConstraintOp"];
...
void sub_D5CC(uint64_t a1, void *a2, void *a3)
{
  id v7 = a2;
  id v5 = a3;
  if ([*(id *)(a1 + 32) _shouldRetryEvaluationForError:v5 options:*(void *)(a1 + 40)])
  {
    [*(id *)(a1 + 48) setRetryingForError:v5];
    LOBYTE(v6) = *(unsigned char *)(a1 + 112);
...
void sub_D9DC(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
  objc_destroyWeak((id *)(v2 - 96));
  _Unwind_Resume(a1);
...
void sub_DA00(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  if (!v5)
  {
    id v13 = *(void (**)(void))(*(void *)(a1 + 80) + 16);
LABEL_8:
    v13();
    goto LABEL_9;
  }
  ...
  id v18 = *(id *)(a1 + 80);
  id v17 = v5;
  unsigned int v12 = [v14 _validatePassword:0 options:v15 uiDelegate:v7 originator:WeakRetained request:v9 callerName:v10 callerBundleId:v11 reply:v16];
...
uint64_t sub_DB74(uint64_t a1, int a2)
{
  uint64_t v3 = *(void *)(a1 + 40);
  if (a2) {
    uint64_t v4 = *(void *)(a1 + 32);
...
void sub_DE94(uint64_t a1, void *a2)
{
  id v3 = a2;
  if (v3)
  {
    ...
    if ([v3 count])
    {
      ...
      uint64_t v6 = [v4 dictionaryByMergingWith:v5];
...
void sub_E570(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, id *location)
{
  objc_destroyWeak(location);
  objc_destroyWeak((id *)(v17 - 104));
  _Unwind_Resume(a1);
}

void sub_E594(uint64_t a1, void *a2)
{
  id v3 = a2;
  id v4 = [*(id *)(a1 + 32) objectForKey:&off_2E7E8];
  id v5 = v4;
  if (v4)
  {
    [v4 doubleValue];
...
void sub_E75C(uint64_t a1)
{
  uint64_t v1 = *(void **)(a1 + 32);
  id v2 = +[LAErrorHelper errorWithCode:-1003 message:@"Timeout expired."];
...
void sub_F3C8(uint64_t a1, int a2)
{
  if (a2)
  {
    id WeakRetained = objc_loadWeakRetained((id *)(a1 + 48));
    [WeakRetained _setOptions:*(void *)(a1 + 32) forInternalOperation:*(void *)(a1 + 56) originatorId:*(void *)(a1 + 64) reply:*(void *)(a1 + 40)];
  }
  else
  {
...
void sub_F660(uint64_t a1, void *a2, char a3, void *a4, void *a5)
{
  id v9 = a2;
  id v10 = a4;
  id v11 = a5;
  if (!v9)
  {
    if (v10 && (+[LAUtils isDaytona] & 1) == 0)
    {
      ...
      id v24 = 0;
      unsigned int v12 = [v17 _setPragueInstructions:v10 signature:v11 error:&v24];
      id v13 = v24;
      if (a3) {
        goto LABEL_6;
      }
...
LABEL_14:
    ...
    {
      (*(void (**)(uint64_t, void, id))(v18 + 16))(v18, 0, v13);
    }
    else
    {
      unsigned int v19 = +[LAErrorHelper parameterErrorWithMessage:@"No instructions."];
...
void sub_F840(uint64_t a1, char a2, void *a3)
{
  id v6 = a3;
...
void sub_10010(uint64_t a1, uint64_t a2)
{
  if (a2 == -7)
  {
    uint64_t v3 = *(void *)(a1 + 32);
    id v5 = +[LAErrorHelper errorWithCode:-1008 message:@"Blob not found."];
  ...
  else
  {
    ...
    if (a2)
    {
      id v5 = +[NSString stringWithFormat:@"ACM failed to get ACL auth method: %d", a2];
      id v4 = +[LAErrorHelper internalErrorWithMessage:](LAErrorHelper, "internalErrorWithMessage:");
...
void sub_1016C(id a1)
{
  qword_31000 = LALogForCategory();

  _objc_release_x1();
}

Class sub_101A8(uint64_t a1)
{
  sub_10200();
  ...
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  ...
  {
    qword_31008 = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  }
  else
  {
    sub_225A0();
    return (Class)sub_10200();
  }
  return result;
}
...
uint64_t sub_10200()
{
  ...
  if (!qword_31010)
  {
    ...
    v3[4] = &unk_2CCA0;
    v3[5] = v3;
    long long v4 = off_2CC88;
    uint64_t v5 = 0;
    qword_31010 = _sl_dlopen();
  }
  uint64_t v0 = qword_31010;
...
Class sub_10374(uint64_t a1)
{
  ...
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  if (*(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24))
  {
    qword_31018 = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  }
  else
  {
    uint64_t v3 = sub_225C8();
    return (Class)sub_103CC(v3);
  }
  return result;
}

Class sub_103CC(uint64_t a1)
{
  sub_10200();
  Class result = objc_getClass("TKClientToken");
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  if (*(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24))
  {
    qword_31020 = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  }
  else
  {
    uint64_t v3 = sub_225F0();
    return (Class)sub_10424(v3);
  }
  return result;
}

void *sub_10424(uint64_t a1)
{
  uint64_t v2 = (void *)sub_10200();
  Class result = dlsym(v2, "TKAccessControlProtectionTokenIDKey");
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  qword_31028 = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  return result;
}

void sub_10D10(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,uint64_t a28,uint64_t a29,uint64_t a30,uint64_t a31,uint64_t a32,char a33)
{
}

uint64_t sub_10D5C(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_10D74(uint64_t a1, void *a2)
{
  id v4 = a2;
  uint64_t v5 = *(void **)(*(void *)(*(void *)(a1 + 32) + 8) + 40);
  id v12 = v4;
  id v6 = [v4 creationTime];
  dispatch_time_t v7 = [v5 laterDate:v6];
  id v8 = *(void **)(*(void *)(*(void *)(a1 + 32) + 8) + 40);

  if (v7 == v8)
  {
    uint64_t v9 = [v12 creationTime];
...
void sub_11190(id a1)
{
  qword_31030 = objc_opt_new();

  _objc_release_x1();
}

id sub_111CC(uint64_t a1)
{
  id v2 = [objc_alloc((Class)NSMutableDictionary) initWithDictionary:*(void *)(a1 + 32)];
  [v2 setObject:*(void *)(a1 + 40) forKeyedSubscript:@"AcmContextRecord"];

  return v2;
}

id sub_11470(uint64_t a1)
{
  id v2 = +[LAACMHelper requirement:*(void *)(a1 + 48) uint32Property:305];
  uint64_t v3 = v2;
  if (v2)
  {
    if ([v2 unsignedIntValue])
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v9 = 2114;
        uint64_t v10 = v3;
        _os_log_impl(&dword_0, v4, OS_LOG_TYPE_DEFAULT, "Unbound identity has to be resolved with %{public}@, bind offset: %{public}@", (uint8_t *)&v7, 0x16u);
      }
    }
    else
    {
...
id sub_1157C(uint64_t a1, void *a2)
{
  id v3 = a2;
  id v4 = v3;
  if (v3)
  {
    ...
    id v6 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v3 eventIdentifier]);
    ...
    uint64_t v8 = [v4 preCompanion];
    }

    __int16 v9 = [*(id *)(a1 + 40) log];
    ...
    if (!v8)
    {
      if (v10)
      {
        ...
        id v21 = v16;
        __int16 v22 = 2114;
        char v23 = (const char *)v4;
        _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "%{public}@ will become a %{public}s-companion of %{public}@", (uint8_t *)&v18, 0x20u);
      }
    ...
    if (v10)
    {
      ...
      __int16 v22 = 2080;
      char v23 = v12;
      _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "%{public}@ will become a standalone mechanism because %{public}@ already has a %s-companion", (uint8_t *)&v18, 0x20u);
    }
  }
  id v13 = *(void **)(a1 + 48);
LABEL_15:
...
uint64_t sub_117B0(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_117C0(uint64_t a1)
{
}

uint64_t sub_117C8(uint64_t a1, uint64_t a2, uint64_t a3)
{
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 40) = +[NSData dataWithBytes:a2 length:a3];

  return _objc_release_x1();
}

void sub_12210(uint64_t a1, void *a2, void *a3)
{
  id v5 = a3;
  id v8 = a2;
  id v6 = objc_msgSend(*(id *)(a1 + 32), "findMechanismWithEventIdentifier:", objc_msgSend(v8, "integerValue"));
...
BOOL sub_124E8(uint64_t a1, void *a2, void *a3)
{
  id v4 = a2;
  uint64_t v17 = 0;
  int v18 = &v17;
  ...
  if (v4)
  {
    id v6 = [v4 objectForKeyedSubscript:&off_2E9F8];
    id v7 = v6;
    if (v6 && [v6 count])
    {
      id v8 = SecAccessControlGetConstraints();
      if (v8)
      {
        __int16 v9 = +[NSMutableDictionary dictionaryWithDictionary:v8];
        v13[0] = _NSConcreteStackBlock;
        v13[1] = 3221225472;
        void v13[2] = sub_126BC;
        v13[3] = &unk_2CE28;
        id v14 = v8;
        uint64_t v16 = &v17;
        id v10 = v9;
...
void sub_12698(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_126BC(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
  id v7 = a2;
  id v8 = a3;
  __int16 v9 = [*(id *)(a1 + 32) objectForKeyedSubscript:v7];
  if (!*(void *)(a1 + 32))
  {
    uint64_t v11 = (uint64_t *)(*(void *)(*(void *)(a1 + 48) + 8) + 24);
    id v12 = @"Invalid update request.";
LABEL_9:
    sub_1287C(v12, -1000, v11);
    *a4 = 1;
    goto LABEL_10;
  }
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    uint64_t v11 = (uint64_t *)(*(void *)(*(void *)(a1 + 48) + 8) + 24);
    id v12 = @"Invalid update value type.";
    goto LABEL_9;
  }
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    uint64_t v11 = (uint64_t *)(*(void *)(*(void *)(a1 + 48) + 8) + 24);
    id v12 = @"Invalid update value type, expecting dictionary.";
    goto LABEL_9;
  }
...
void sub_1287C(void *a1, uint64_t a2, uint64_t *a3)
{
  if (a3)
  {
    ...
    uint64_t v7 = +[NSError errorWithDomain:@"Error.LocalAuthentication.coreauthd_client" code:a2 userInfo:v6];

    *a3 = v7;
  }
}

id sub_12958(uint64_t a1, uint64_t a2, uint64_t a3)
{
  return [*(id *)(a1 + 32) setObject:a3 forKeyedSubscript:a2];
}

BOOL sub_12964(void *a1, uint64_t a2, const void *a3, uint64_t a4, uint64_t *a5, uint64_t *a6)
{
  uint64_t v13 = sub_12BCC();
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&v25[14] = a3;
    __int16 v26 = 2112;
    uint64_t v27 = a4;
    _os_log_impl(&dword_0, v13, OS_LOG_TYPE_DEFAULT, "LAEvaluateAndUpdateACL(%@, %@, %@)", v25, 0x20u);
  }

  id v14 = sub_12F9C(a1, a6);
  if (!a1) {
    goto LABEL_13;
  }
  ...
  {
    id v21 = @"Invalid operation type.";
LABEL_12:
    sub_1287C(v21, -1006, a6);
LABEL_13:
    BOOL v20 = 0;
    goto LABEL_14;
  }
  if (!a2)
  {
    id v21 = @"Invalid 'ACL' argument.";
    goto LABEL_12;
  }
  uint64_t v16 = (void *)SecAccessControlCreateFromData();
  if (v16)
  {
    *(void *)uint64_t v25 = 0;
  ...
  {
    sub_1287C(@"Invalid 'ACL' argument.", -1006, a6);
    BOOL v20 = 0;
  }

LABEL_14:
  __int16 v22 = sub_12BCC();
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v25[8] = 2112;
    *(void *)&v25[10] = v23;
    _os_log_impl(&dword_0, v22, OS_LOG_TYPE_DEFAULT, "LAEvaluateAndUpdateACL -> %d, %@", v25, 0x12u);
  }
...
{
  if (qword_31040 != -1) {
    dispatch_once(&qword_31040, &stru_2CE70);
  }
  uint64_t v0 = (void *)qword_31048;

  return v0;
}

uint64_t sub_12C20(uint64_t a1, int a2, uint64_t a3, uint64_t a4)
{
  uint64_t v13 = 0;
  id v14 = &v13;
...
void sub_12D00(uint64_t a1)
{
  id v2 = (const void *)sub_12D64(*(void **)(a1 + 40), *(_DWORD *)(a1 + 64), *(void *)(a1 + 48), *(uint64_t **)(a1 + 56));
...
uint64_t sub_12D64(void *a1, int a2, uint64_t a3, uint64_t *a4)
{
  uint64_t v9 = sub_12BCC();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&void v18[4] = a1;
    ...
    WORD2(v20[0]) = 2112;
    *(void *)((char *)v20 + 6) = a3;
    _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "LACopyResultOfPolicyEvaluation(%@, %d, %@)", v18, 0x1Cu);
  }

  id v10 = sub_12F9C(a1, a4);
  uint64_t v11 = v10;
  if (v10)
  {
    *(void *)id v18 = 0;
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&void v18[4] = v12;
    __int16 v19 = 2112;
    v20[0] = v16;
    _os_log_impl(&dword_0, v15, OS_LOG_TYPE_DEFAULT, "LACopyResultOfPolicyEvaluation -> %@, %@", v18, 0x16u);
  }

  return v12;
}

id sub_12F20(void *a1, uint64_t a2, int a3, uint64_t *a4)
{
  uint64_t v9 = sub_12F9C(a1, a4);
  id v10 = [v9 setCredential:a2 type:a3];

  return v10;
}

id sub_12F9C(void *a1, uint64_t *a2)
{
  id v3 = a1;
  if (v3 && (sub_131F0(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    id v4 = v3;
  }
  else
  {
    sub_1287C(@"Invalid 'context' argument.", -1006, a2);
    id v4 = 0;
  }
...
id sub_13018(void *a1, int a2, uint64_t *a3)
{
  uint64_t v7 = sub_12F9C(a1, a3);
  id v8 = [v7 isCredentialSet:a2];

  return v8;
}

id sub_13084(void *a1, uint64_t *a2)
{
  id v5 = a1;
  if (v5 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    sub_1287C(@"Invalid acmContext.", -1006, a2);
    id v7 = 0;
  }
  else
  {
    id v6 = [objc_alloc((Class)sub_131F0()) initWithExternalizedContext:v5];
    id v7 = v6;
    if (a2 && !v6)
    {
      NSErrorUserInfoKey v11 = NSDebugDescriptionErrorKey;
      CFStringRef v12 = @"Failed to create LAContext";
...
id sub_131F0()
{
  ...
  uint64_t v0 = (void *)qword_31050;
  uint64_t v7 = qword_31050;
  if (!qword_31050)
  {
...
void sub_132BC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
uint64_t sub_132D4(void *a1, uint64_t *a2)
{
  id v5 = sub_12F9C(a1, a2);
  uint64_t v6 = v5;
  if (!v5) {
    goto LABEL_5;
  }
  ...
  {
    NSErrorUserInfoKey v11 = NSDebugDescriptionErrorKey;
    CFStringRef v12 = @"Failed to get externalized context from LAContext";
...
BOOL sub_133EC(void *a1, uint64_t a2, const void *a3, uint64_t a4, uint64_t *a5)
{
  BOOL v11 = sub_12964(a1, a2, a3, a4, 0, a5);
  return v11;
}

id sub_13460(int a1, uint64_t a2, uint64_t *a3)
{
  int v10 = a1;
  id v6 = [objc_alloc((Class)sub_131F0()) initWithExternalizedContext:a2 userSession:&v10];
  id v7 = v6;
  if (a3 && !v6)
  {
    NSErrorUserInfoKey v11 = NSDebugDescriptionErrorKey;
...
void sub_13564(id a1)
{
  qword_31048 = (uint64_t)os_log_create("com.apple.LocalAuthentication", "coreauthd_client");

  _objc_release_x1();
}

Class sub_135A8(uint64_t a1)
{
  v4[0] = 0;
  if (!qword_31058)
  {
    ...
    v4[4] = &unk_2CCA0;
    v4[5] = v4;
    long long v5 = off_2CE90;
    uint64_t v6 = 0;
    qword_31058 = _sl_dlopen();
    id v2 = (void *)v4[0];
    if (!qword_31058)
    {
      abort_report_np();
...
LABEL_7:
    id v2 = (void *)sub_137A4();
LABEL_8:
    free(v2);
  }
  qword_31050 = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  return result;
}
...
uint64_t GetSerializedVerifyPolicySize(uint64_t a1, char *__s1, uint64_t a3, uint64_t a4, _DWORD *a5, unsigned int a6, void *a7)
{
  ...
  if (a1 && __s1 && a7)
  {
    ...
    {
      size_t v13 = v12;
      uint64_t result = sub_13878(a5, a6, &v14);
      if (!result) {
        *a7 = v13 + v14 + 26;
      }
    }
...
uint64_t sub_13878(_DWORD *a1, unsigned int a2, _DWORD *a3)
{
  if (gACMLoggingLevel <= 0xAu) {
            ...
            if (!result)
            {
              ...
              *a7 = *a1;
              ...
              else
              {
                ...
                v19[17] = a3;
                *(_DWORD *)(v19 + 1_Block_object_dispose(&STACK[0x220], 8) = v15;
                size_t v20 = v18 + 22;
                uint64_t result = sub_13AA8((uint64_t)a5, a6, (uint64_t)a7, (uint64_t *)&v20);
                if (!result) {
                  *a8 = v20;
                }
              }
...
uint64_t sub_13AA8(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  LODWORD(v6) = a2;
  if (gACMLoggingLevel <= 0xAu) {
...
uint64_t DeserializeVerifyPolicy(uint64_t a1, unint64_t a2, _OWORD *a3, void *a4, BOOL *a5, _DWORD *a6, void *a7, _DWORD *a8)
{
  ...
  if (a2 >= 0x10 && a1 && a3 && a4 && a5 && a6 && a7 && a8)
  {
    *a3 = *(_OWORD *)a1;
    ...
    __int16 v26 = a4;
    unint64_t v18 = v17 + 1;
    __int16 v19 = acm_mem_alloc_data(v17 + 1);
    ...
    else
    {
      ...
      uint64_t v8 = sub_13DE8(a1, a2, &v29, &v28, &v27);
      if (!v8)
      {
        *__int16 v26 = v19;
        BOOL *v20 = v21;
...
uint64_t sub_13DE8(uint64_t a1, unint64_t a2, unint64_t *a3, void *a4, _DWORD *a5)
{
...
LABEL_24:
  ...
  while (1)
  {
    ...
    *(void *)&v16[v17 + 8] = 0;
    ...
    uint64_t v21 = sub_1685C(&v16[v17]);
    if (v21)
    {
      uint64_t v12 = v21;
      unsigned int v11 = 70;
...
uint64_t GetSerializedVerifyAclConstraintSize(int a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, unsigned int a6, uint64_t a7, uint64_t a8, _DWORD *a9, unsigned int a10, void *a11)
{
  ...
  if (a3)
  {
    if (a11)
    {
      ...
      {
        uint64_t result = sub_13878(a9, a10, &v18);
        if (!result)
        {
          uint64_t v15 = 29;
          if (a1 == 32) {
...
uint64_t SerializeVerifyAclConstraint(int a1, _OWORD *a2, const void *a3, unsigned int a4, const void *a5, unsigned int a6, char a7, int a8, _DWORD *a9, unsigned int a10, uint64_t a11, void *a12)
{
  ...
  {
    unsigned int v31 = 0;
    uint64_t result = sub_13878(a9, a10, &v31);
    if (!result)
    {
      uint64_t v21 = 29;
      if (a1 == 32) {
      ...
      else
      {
        ...
        {
          *(void *)a11 = 0;
          *(void *)(a11 + _Block_object_dispose(&STACK[0x220], 8) = 0;
        }
        *(_DWORD *)(a11 + 16) = a4;
        ...
        *(_DWORD *)(v26 + 1) = v28;
        uint64_t v30 = v24 + 5;
        uint64_t result = sub_13AA8((uint64_t)a9, a10, a11, &v30);
        if (!result) {
          *a12 = v30;
        }
      }
...
LABEL_19:
            if (v22 != v16)
            {
              ...
              if (v16 - (v22 + 1) >= 4)
              {
                ...
                unint64_t v34 = v22 + 5;
                uint64_t v12 = sub_13DE8(a2, v16, &v34, &v33, &v32);
                if (!v12)
                {
...
uint64_t GetSerializedProcessAclSize(uint64_t a1, uint64_t a2, unsigned int a3, uint64_t a4, unsigned int a5, uint64_t a6, _DWORD *a7, unsigned int a8, void *a9)
{
  ...
  {
    uint64_t result = sub_13878(a7, a8, &v12);
    if (!result) {
    ...
    if (!v15 && a8 <= 0xA && (a7 != 0) == (a8 != 0))
    {
      ...
      if (!result)
      {
        ...
        else
        {
          ...
          {
            *(void *)a9 = 0;
            *(void *)(a9 + _Block_object_dispose(&STACK[0x220], 8) = 0;
          }
          *(_DWORD *)(a9 + 16) = a3;
          ...
          *(_DWORD *)(a9 + v21) = v17;
          unint64_t v22 = v21 + 4;
          uint64_t result = sub_13AA8((uint64_t)a7, a8, a9, (uint64_t *)&v22);
          if (!result) {
            *a10 = v22;
          }
        }
                ...
                if (a9 && a10 && a2 >= 0x10)
                {
                  ...
                  *a3 = *(_OWORD *)a1;
                  ...
                  else
                  {
                    ...
                    unint64_t v40 = 20;
                    __int16 v19 = acm_mem_alloc_data(v18);
...
LABEL_20:
                            ...
                            else
                            {
                              ...
                              unint64_t v40 = v21 + 4;
                              uint64_t v10 = sub_13DE8(a1, v17, &v40, &v39, &v38);
                              if (!v10)
                              {
          ...
          if (v7 == *((_DWORD *)__s2 + 7))
          {
            ...
            switch(*(_DWORD *)__s1)
            {
              ...
              case 7:
                ...
                BOOL v9 = sub_1567C((unint64_t)(__s1 + 4), 0x20uLL, (unint64_t)(__s2 + 4), 32);
                if (!v9) {
                  goto LABEL_100;
                }
              ...
              case 0xA:
                ...
                BOOL v9 = sub_1567C((unint64_t)__s1 + 36, 0x10uLL, (unint64_t)__s2 + 36, 16);
                if (!v9) {
                  goto LABEL_100;
                }
...
LABEL_8:
              ...
              case 0x15:
                ...
                uint64_t v22 = 128;
LABEL_103:
                LOBYTE(v9) = sub_1567C((unint64_t)v13, v21, (unint64_t)v14, v22);
                goto LABEL_100;
              default:
                return v3;
            }
...
BOOL sub_1567C(unint64_t __s1, size_t __n, unint64_t __s2, uint64_t a4)
{
  if (__n != a4) {
    return 0;
  }
      ...
      if (__src)
      {
        if ((v7 & 1) == 0)
        {
          ...
          if (*__src <= 0x17 && ((1 << *__src) & 0xFFF7FE) != 0 && *a5 >= (unint64_t)__src[7] + 52)
          {
            ...
            {
              *(void *)a4 = 0;
              *(void *)(a4 + _Block_object_dispose(&STACK[0x220], 8) = 0;
            }
            uint64_t v13 = *a5 - 16;
...
uint64_t LibSer_StorageSetData_GetSize(uint64_t a1, _DWORD *a2, unsigned int a3, void *a4)
{
  ...
  uint64_t result = sub_13878(a2, a3, &v7);
  if (!result) {
    *a4 = a1 + v7 + 28;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a7)
      {
        ...
        {
          unsigned int v18 = 0;
          uint64_t result = sub_13878(a5, a6, &v18);
          if (!result)
          {
            if (*a8 < a4 + v18 + 28)
            {
            ...
            else
            {
              ...
              *(_DWORD *)(a7 + 20) = a4;
              ...
              size_t v17 = a4 + 24;
              uint64_t result = sub_13AA8((uint64_t)a5, a6, a7, (uint64_t *)&v17);
              if (!result) {
                *a8 = v17;
              }
            }
...
uint64_t LibSer_StorageSetData_Deserialize(uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, void *a5, void *a6, void *a7, _DWORD *a8)
{
  ...
  if (a1 && a2 >= 0x18 && a6 && a3 && a4 && a5 && a7 && a8)
  {
    ...
    *a6 = v11;
    ...
    return sub_13DE8(a1, a2, v14, a7, a8);
  }
  return v10;
}
...
uint64_t LibSer_StorageGetData_GetSize(_DWORD *a1, unsigned int a2, void *a3)
{
  ...
  uint64_t result = sub_13878(a1, a2, &v5);
  if (!result) {
    *a3 = v5 + 25;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a6)
      {
        ...
        {
          unsigned int v16 = 0;
          uint64_t result = sub_13878(a4, a5, &v16);
          if (!result)
          {
            ...
            else
            {
              ...
              *(unsigned char *)(a6 + 20) = a3;
              uint64_t v15 = 21;
              uint64_t result = sub_13AA8((uint64_t)a4, a5, a6, &v15);
              if (!result) {
                *a7 = v15;
              }
            }
...
uint64_t LibSer_StorageGetData_Deserialize(uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, BOOL *a5, void *a6, _DWORD *a7)
{
  ...
  if (a1 && a2 >= 0x15 && a3 && a4 && a5)
  {
    ...
    *a5 = *(unsigned char *)(a1 + 20) != 0;
    v11[0] = 21;
    return sub_13DE8(a1, a2, v11, a6, a7);
  }
  return v9;
}
...
uint64_t LibSer_GetUnlockSecret_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, _OWORD *a4, void *a5)
{
  ...
  if (a1)
  {
    if (a4)
    {
      ...
      {
        unsigned int v12 = 0;
        uint64_t result = sub_13878(a2, a3, &v12);
        if (!result)
        {
          ...
          else
          {
            *a4 = *a1;
            uint64_t v11 = 16;
            uint64_t result = sub_13AA8((uint64_t)a2, a3, (uint64_t)a4, &v11);
            if (!result) {
              *a5 = v11;
            }
          }
...
uint64_t LibSer_GetUnlockSecret_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5)
{
  ...
  if (a2 >= 0x10 && a3 && a4)
  {
    if (a5)
    {
      ...
      *a3 = *a1;
      v9[0] = 16;
      return sub_13DE8((uint64_t)a1, a2, v9, a4, a5);
    }
  }
  return result;
}
...
uint64_t LibSer_SEPControl_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6, void *a7)
{
  ...
  if (a6)
  {
    ...
    {
      unsigned int v18 = 0;
      uint64_t result = sub_13878(a2, a3, &v18);
      if (!result)
      {
        if (*a7 < a5 + v18 + 24)
        {
        ...
        else
        {
          ...
          {
            *(void *)a6 = 0;
            *(void *)(a6 + _Block_object_dispose(&STACK[0x220], 8) = 0;
          }
          uint64_t v17 = 16;
          uint64_t result = sub_13AA8((uint64_t)a2, a3, a6, &v17);
          if (!result)
          {
            uint64_t v15 = v17;
            *(_DWORD *)(a6 + v17) = a5;
...
uint64_t LibSer_SEPControl_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5, unint64_t *a6, void *a7)
{
  ...
  if (a2 >= 0x18 && a7 && a3 && a4 && a5 && a6)
  {
    *a3 = *a1;
    unint64_t v12 = 16;
    uint64_t result = sub_13DE8((uint64_t)a1, a2, &v12, a4, a5);
    if (!result)
    {
...
{
  return sub_177F8(a1, a2, 0xBu, a3, a4, a5, 0, 0, a6, a7, a8, a9, a10);
}

uint64_t sub_177F8(uint64_t result, uint64_t a2, unsigned __int8 a3, _OWORD *a4, const void *a5, uint64_t a6, const void *a7, unsigned int a8, unsigned __int8 a9, _DWORD *a10, unsigned int a11, unsigned int a12, uint64_t a13)
{
...
{
  return sub_177F8(a1, a2, 0x20u, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);
}
...
_DWORD *ACMContextCreateWithExternalForm(_OWORD *a1, uint64_t a2)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    rsize_t v10 = "ACMLib";
    __int16 v11 = 2080;
    unint64_t v12 = "ACMContextCreateWithExternalForm";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  uint64_t v8 = 0;
  unint64_t v4 = LibCall_ACMContextCreateWithExternalForm((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, uint64_t, void *, uint64_t *))sub_63C4, (uint64_t)&v8, a1, a2, &byte_30FF1, 1);
  if (v4)
  {
    if (byte_30FF1 <= 0x28u && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
    {
  ...
  if (v6 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    rsize_t v10 = "ACMLib";
    __int16 v11 = 2080;
...
uint64_t ACMContextAddCredentialWithScope(_OWORD *a1, unsigned int *a2, int a3)
{
  ...
  {
    *(_DWORD *)buf = 136315394;
    unsigned int v18 = "ACMLib";
    __int16 v19 = 2080;
    size_t v20 = "ACMContextAddCredentialWithScope";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  size_t size = 0;
  if (a1) {
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedAddCredentialSize = sub_6928();
    ...
    {
      size_t v11 = size;
      unint64_t v12 = acm_mem_alloc_data(size);
      ...
      if (v12)
      {
        ...
        if (!v13) {
          uint64_t v13 = sub_65A4((uint64_t)a1, 5, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        size_t v14 = size;
...
uint64_t ACMContextRemoveCredentialsByTypeAndScope(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_65A4((uint64_t)a1, 9, 0, v7, 0x18uLL, 0, 0);
  ...
  if (v9 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v11 = 136315650;
    unint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
...
uint64_t ACMContextRemoveCredentialsByValueAndScope(uint64_t a1, _DWORD *a2, uint64_t a3)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    unsigned int v18 = "ACMLib";
    __int16 v19 = 2080;
    size_t v20 = "ACMContextRemoveCredentialsByValueAndScope";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  size_t size = 0;
  if (a1) {
  ...
  if (a2 && (v7 & 1) == 0)
  {
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!v13) {
          uint64_t v13 = sub_65A4(a1, 6, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        size_t v14 = size;
...
uint64_t ACMContextContainsCredentialTypeEx(_OWORD *a1, int a2, int a3)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v16 = "ACMLib";
    __int16 v17 = 2080;
    unsigned int v18 = "ACMContextContainsCredentialTypeEx";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  int v14 = 0;
  size_t v13 = 4;
    ...
    else
    {
      ...
      if (v7)
      {
        *(_OWORD *)__int16 v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_65A4((uint64_t)a1, 4, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_65A4((uint64_t)a1, 16, 0, v7, 0x18uLL, 0, 0);
...
uint64_t ACMContextReplacePassphraseCredentialsWithScope(uint64_t a1, _DWORD *a2, uint64_t a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedReplacePassphraseCredentialSize = sub_6928();
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        if (!v13) {
          uint64_t v13 = sub_65A4(a1, 15, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        bzero(v12, size);
        size_t v14 = size;
...
uint64_t ACMContextContainsPassphraseCredentialWithPurpose(_OWORD *a1, int a2, int a3)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v16 = "ACMLib";
    __int16 v17 = 2080;
    unsigned int v18 = "ACMContextContainsPassphraseCredentialWithPurpose";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  int v14 = 0;
  size_t v13 = 4;
    ...
    else
    {
      ...
      if (v7)
      {
        *(_OWORD *)char v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_65A4((uint64_t)a1, 13, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
...
uint64_t ACMContextVerifyPolicy(_OWORD *a1, char *a2, uint64_t a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextVerifyPolicy_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_63C4, (uint64_t)&v9, a1, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
  ...
  if (v7 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v11 = "ACMLib";
    __int16 v12 = 2080;
...
uint64_t ACMContextVerifyPolicyWithPreflight(_OWORD *a1, char *__s1, uint64_t a3, uint64_t a4)
{
  ...
  uint64_t v11 = a1;
  uint64_t v8 = LibCall_ACMContextVerifyPolicyWithPreflight_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_63C4, (uint64_t)&v11, a1, __s1, a3, a4);
  if (v8) {
    unsigned int v9 = 70;
  }
  else {
...
void ACMContextVerifyPolicyEx(_OWORD *a1, char *__s1, uint64_t a3, _DWORD *a4, unsigned int a5, uint64_t a6, uint64_t a7)
{
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    __int16 v16 = "ACMLib";
    __int16 v17 = 2080;
    unsigned int v18 = "ACMContextVerifyPolicyEx";
    _os_log_impl(&dword_0, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called.\n", buf, 0x16u);
  }
  __int16 v14 = a1;
  LibCall_ACMContextVerifyPolicyEx_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_63C4, (uint64_t)&v14, a1, __s1, a3, a4, a5, a6, a7);
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    __int16 v16 = "ACMLib";
...
{
  unsigned int v9 = a1;
  return LibCall_ACMContextVerifyAclConstraint((uint64_t)sub_63C4, (uint64_t)&v9, a1, a2, a3, a4, a5, a6, a7, a8);
}
...
{
  uint64_t v11 = a1;
  return LibCall_ACMContextVerifyAclConstraintForOperation((uint64_t)sub_63C4, (uint64_t)&v11, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
}
...
uint64_t ACMParseAclAndCopyConstraintCharacteristics(const void *a1, uint64_t a2, uint64_t a3)
{
  ...
  uint64_t SerializedProcessAclSize = sub_6928();
...
LABEL_31:
  ...
  uint64_t v13 = sub_65A4(0, 20, 0, v9, size, v12, &__n);
  size_t v11 = __n;
  if (v13)
  {
    uint64_t v6 = v13;
...
LABEL_19:
  ...
  if (v17 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v22 = "ACMLib";
    __int16 v23 = 2080;
...
LABEL_13:
  ...
  if (v5 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v8 = 136315650;
    unint64_t v9 = "ACMLib";
    __int16 v10 = 2080;
...
void ACMGetAclAuthMethod(__n128 *a1, uint64_t a2)
{
  ...
  uint64_t v4 = a1;
  LibCall_ACMGetAclAuthMethod_Block((uint64_t)sub_63C4, (uint64_t)&v4, a1, a2);
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v6 = "ACMLib";
...
uint64_t ACMSetEnvironmentVariable(int a1, const void *a2, size_t a3)
{
  ...
  uint64_t v9 = 0;
  uint64_t v6 = LibCall_ACMSetEnvironmentVariable((uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_63C4, (uint64_t)&v9, a1, 0, 0, 0, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
...
uint64_t ACMSetEnvironmentVariableWithAccessPolicy(int a1, _OWORD *a2, _OWORD *a3, uint64_t a4, const void *a5, size_t a6)
{
  ...
  uint64_t v15 = 0;
  uint64_t v12 = LibCall_ACMSetEnvironmentVariable((uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_63C4, (uint64_t)&v15, a1, a2, a3, a4, a5, a6);
  if (v12) {
    unsigned int v13 = 70;
  }
  else {
  ...
  if (v13 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315906;
    int v17 = "ACMLib";
    __int16 v18 = 2080;
...
uint64_t ACMGetEnvironmentVariable(int a1, uint64_t a2)
{
  ...
  uint64_t v7 = 0;
  uint64_t v4 = LibCall_ACMGetEnvironmentVariable_Block((uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, uint64_t, uint64_t))sub_63C4, (uint64_t)&v7, a1, a2);
  if (v4) {
    unsigned int v5 = 70;
  }
  else {
...
uint64_t ACMKernelControl(int a1)
{
  ...
  uint64_t v2 = LibCall_ACMKernelControl_Block((uint64_t)sub_63C4);
  if (v2) {
    unsigned int v3 = 70;
  }
  else {
...
{
  uint64_t v4 = 0;
  return LibCall_ACMSEPControl_Block((uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_63C4, (uint64_t)&v4, a1, a2, 0, 0, 0, a3);
}

uint64_t ACMSEPControlEx(uint64_t a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6)
{
  uint64_t v7 = 0;
  return LibCall_ACMSEPControl_Block((uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_63C4, (uint64_t)&v7, a4, a5, a1, a2, a3, a6);
}
...
void ACMGlobalContextCredentialGetProperty(int a1, int a2, uint64_t a3)
{
  ...
  uint64_t v6 = 0;
  LibCall_ACMGlobalContextCredentialGetProperty_Block((uint64_t)sub_63C4, (uint64_t)&v6, a1, a2, a3);
  if (byte_30FF1 <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, uint64_t a4)
{
  ...
  {
    __int16 v9 = a1;
    uint64_t v8 = LibCall_ACMContextCredentialGetProperty((uint64_t (*)(uint64_t, uint64_t, void, __n128 *, uint64_t, uint64_t, uint64_t, __n128))sub_63C4, (uint64_t)&v9, a1, a2, a3, (uint64_t)buf, (uint64_t)&v10);
...
uint64_t ACMContextSetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, const void *a5, size_t a6)
{
  ...
  __int16 v15 = a1;
  uint64_t v12 = LibCall_ACMContextSetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, void, void))sub_63C4, (uint64_t)&v15, a1, a2, a3, a4, a5, a6);
  if (v12) {
    unsigned int v13 = 70;
  }
  else {
...
uint64_t ACMContextGetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, uint64_t a5)
{
  ...
  uint64_t v21 = 4;
  __int16 v19 = a1;
  uint64_t v10 = LibCall_ACMContextGetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_63C4, (uint64_t)&v19, a1, a2, 1, a3, a4, (uint64_t)&size, (uint64_t)&v21);
  if (!v10)
  {
    uint64_t v11 = size;
    if (size)
    {
      ...
      uint64_t v20 = size;
      __int16 v18 = a1;
      uint64_t v13 = LibCall_ACMContextGetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_63C4, (uint64_t)&v18, a1, a2, 0, a3, a4, (uint64_t)v12, (uint64_t)&v20);
      uint64_t v14 = v13;
      if (a5 && !v13) {
...
LABEL_11:
  unsigned int v16 = 70;
LABEL_15:
  if (v16 >= byte_30FF1 && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
...
uint64_t ACMContextGetInfo(long long *a1, int a2, void *a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextGetInfo((uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, _OWORD *, unint64_t *))sub_63C4, (uint64_t)&v9, a1, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
...
{
  uint64_t v1 = 0;
  return LibCall_ACMPing((uint64_t (*)(uint64_t, uint64_t, void, void, void, void, void))sub_63C4, (uint64_t)&v1, 29);
}
...
void sub_1D684()
{
  ...
  if (IOConnectCallScalarMethod(dword_31078, 2u, 0, 0, &output, &outputCnt)) {
    goto LABEL_8;
  }
    ...
    switch(a2)
    {
      ...
      case 303:
        if (__n == 65 && *a1 == 3)
        {
          ...
          *(_OWORD *)(a1 + 42) = v21;
          *(_OWORD *)(a1 + 3_Block_object_dispose(&STACK[0x220], 8) = v20;
          *(_OWORD *)(a1 + 34) = v19;
        }
        break;
      case 304:
...
uint64_t LibCall_ACMSetEnvironmentVariable(uint64_t (*a1)(uint64_t, uint64_t, void, char *, size_t, void, void), uint64_t a2, int a3, _OWORD *a4, _OWORD *a5, uint64_t a6, const void *a7, size_t a8)
{
  ...
  if (v15 && a6 == 16 * (a5 != 0) && (a7 ? (BOOL v16 = a8 - 129 < 0xFFFFFFFFFFFFFF80) : (BOOL v16 = a8 != 0), !v16))
  {
    ...
    *((_DWORD *)v17 + 2) = a8;
    *(_OWORD *)(v17 + 12) = 0u;
    *(_OWORD *)(v17 + 2_Block_object_dispose(&STACK[0x220], 8) = 0u;
    if (a4) {
      *(_OWORD *)(v17 + 12) = *a4;
    }
    if (a5) {
      *(_OWORD *)(v17 + 2_Block_object_dispose(&STACK[0x220], 8) = *a5;
    }
    if (a8) {
      memcpy(v17 + 44, a7, a8);
    }
...
{
  return sub_210B8(a1, a2, 12, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, 0, 0);
}

uint64_t sub_210B8(uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, _DWORD *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
  ...
  if (a7 || a9 || a12)
  {
    ...
    uint64_t v29 = v45;
    int v30 = acm_mem_alloc_data(v45);
...
LABEL_84:
  ...
  if (a5 && a13 && a6)
  {
    uint64_t v25 = sub_22208(a1, a2, a5, a6, a13);
LABEL_76:
    if (v25) {
      unsigned int v24 = 70;
    }
...
{
  return sub_210B8(a1, a2, 30, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14);
}
...
uint64_t sub_22208(uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, const void *a3, unsigned int a4, unsigned char *a5)
{
  int v19 = 0;
  uint64_t v18 = 4;
  size_t v10 = a4;
...
void sub_223F4(int a1, int a2, os_log_t log)
{
  v3[0] = 67109376;
  v3[1] = a1;
  __int16 v4 = 1024;
...
void sub_2247C(int a1, NSObject *a2)
{
  v2[0] = 67109120;
  v2[1] = a1;
...
void sub_224F4(uint64_t a1, int a2, os_log_t log)
{
  v3[0] = 67109378;
  v3[1] = a2;
  __int16 v4 = 2114;
...
void sub_2265C(uint64_t *a1, uint64_t a2, os_log_t log)
{
  uint64_t v3 = *a1;
...
uint64_t LACLogContext()
{
  return _LACLogContext();
}
...
uint64_t NSStringFromACMRequirement()
{
  return _NSStringFromACMRequirement();
}

uint64_t SecAccessControlCopyConstraintData()
{
  return _SecAccessControlCopyConstraintData();
}
...
{
  return _SecAccessControlGetRequirePassword();
}
...
id objc_msgSend__cleanupPlugins(void *a1, const char *a2, ...)
{
  return [a1 _cleanupPlugins];
}

id objc_msgSend__deviceHasPearl(void *a1, const char *a2, ...)
{
  return [a1 _deviceHasPearl];
}

id objc_msgSend__removeEmptyRecords(void *a1, const char *a2, ...)
{
  return [a1 _removeEmptyRecords];
}

id objc_msgSend_acmFlags(void *a1, const char *a2, ...)
{
  return [a1 acmFlags];
}

id objc_msgSend_acmParameterDoNotStartDTOTimers(void *a1, const char *a2, ...)
{
  return [a1 acmParameterDoNotStartDTOTimers];
}

id objc_msgSend_acmParameters(void *a1, const char *a2, ...)
{
  return [a1 acmParameters];
}

id objc_msgSend_allInfos(void *a1, const char *a2, ...)
{
  return [a1 allInfos];
}
...
{
  return [a1 authenticationError];
}

id objc_msgSend_availableMechanisms(void *a1, const char *a2, ...)
{
  return [a1 availableMechanisms];
}
...
id objc_msgSend_contextOwner(void *a1, const char *a2, ...)
{
  return [a1 contextOwner];
}
...
id objc_msgSend_customUI(void *a1, const char *a2, ...)
{
  return [a1 customUI];
}
...
id objc_msgSend_forciblyInvalidate(void *a1, const char *a2, ...)
{
  return [a1 forciblyInvalidate];
}
...
{
  return [a1 internalInfo];
}

id objc_msgSend_invalidationBlock(void *a1, const char *a2, ...)
{
  return [a1 invalidationBlock];
}

id objc_msgSend_isDaytona(void *a1, const char *a2, ...)
{
  return [a1 isDaytona];
}
...
id objc_msgSend_isRunningInBATS(void *a1, const char *a2, ...)
{
  return [a1 isRunningInBATS];
}
...
id objc_msgSend_localizedPINLabel(void *a1, const char *a2, ...)
{
  return [a1 localizedPINLabel];
}

id objc_msgSend_localizedPasswordLabel(void *a1, const char *a2, ...)
{
  return [a1 localizedPasswordLabel];
}
...
id objc_msgSend_maxPINLength(void *a1, const char *a2, ...)
{
  return [a1 maxPINLength];
}
...
id objc_msgSend_mechanismTree(void *a1, const char *a2, ...)
{
  return [a1 mechanismTree];
}

id objc_msgSend_mechanismTreeDescription(void *a1, const char *a2, ...)
{
  return [a1 mechanismTreeDescription];
}

id objc_msgSend_minPINLength(void *a1, const char *a2, ...)
{
  return [a1 minPINLength];
}
...
id objc_msgSend_updateConstraintOffset(void *a1, const char *a2, ...)
{
  return [a1 updateConstraintOffset];
}
