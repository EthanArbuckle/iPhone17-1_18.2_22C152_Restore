...
- (void)scheduleFeedback:(int64_t)a3
{
  ...
  if (self->_finished)
  {
    ...
    {
      *(_WORD *)v16 = 0;
      _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEFAULT, "ignoring feedback (already finished)", v16, 2u);
    }
LABEL_10:
...
- (void)_sendFeedback:(int64_t)a3
{
  ...
  [v13 mechanismEvent:14 value:v14 reply:&stru_C290];
...
- (void)dispatchNowOrWhenFeedbackDurationAchieved:(BOOL)a3 finish:(BOOL)a4 block:(id)a5
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v22 = 2112;
    __int16 v23 = self;
    _os_log_impl(&dword_0, v9, OS_LOG_TYPE_DEFAULT, "%s %d, %d on %@", (uint8_t *)&v16, 0x22u);
  }
  ...
  if (self->_finished)
  {
    ...
    {
      LOWORD(v16) = 0;
      _os_log_impl(&dword_0, v10, OS_LOG_TYPE_DEFAULT, "won't dispatch, already finished", (uint8_t *)&v16, 2u);
    }
