...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)objc_msgSend(v4, "initWithTimestamp:devicePose:trackingState:lightEstimate:majorRelocalization:minorRelocalization:", trackingState, majorRelocalization, minorRelocalization, timestamp, *(double *)&v10, *(double *)&v11, *(double *)&v12, *(double *)&v13, lightEstimate);
}
...
- (NIVisionInput)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(_OWORD *)&v5[2].super.isa = v10;
    v5->_int64_t trackingState = [v4 decodeIntegerForKey:@"trackingState"];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    else
    {
      ...
      float32x4_t v29 = v12;
      int64_t trackingState = self->_trackingState;
      uint64_t v15 = [(NIVisionInput *)v6 trackingState];
      double lightEstimate = self->_lightEstimate;
      [(NIVisionInput *)v6 lightEstimate];
      double v18 = v17;
      int majorRelocalization = self->_majorRelocalization;
      int v20 = [(NIVisionInput *)v6 majorRelocalization];
      int minorRelocalization = self->_minorRelocalization;
      int v22 = [(NIVisionInput *)v6 minorRelocalization];
      BOOL v23 = 0;
      if (timestamp == v9
...
- (unint64_t)hash
{
  uint64_t v15 = [MEMORY[0x1E4F1C9B8] dataWithBytes:&self[1] length:64];
  uint64_t v14 = [v15 hash];
  ...
  unint64_t v12 = v4 ^ v14 ^ v6 ^ v8 ^ v10 ^ [v11 hash];
