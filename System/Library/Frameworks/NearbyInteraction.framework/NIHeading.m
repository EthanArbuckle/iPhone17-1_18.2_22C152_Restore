...
LABEL_17:
    ...
    char v10 = [(NSDate *)timestamp isEqual:v9];
...
- (unint64_t)hash
{
  timestamp = self->_timestamp;
  if (timestamp) {
    uint64_t v4 = [(NSDate *)timestamp hash];
  }
  else {
    uint64_t v4 = 0;
  }
  ...
  unint64_t v10 = v6 ^ v4 ^ v8 ^ [v9 hash];
...
- (id)description
{
  ...
  uint64_t v6 = [(NIHeading *)self descriptionInternal];
  double v7 = (void *)[v3 initWithFormat:@"<%@: %@>", v5, v6];
...
- (id)descriptionInternal
{
  ...
  {
    id v3 = objc_msgSend(NSString, "stringWithFormat:", @"%.1fdeg", *(void *)&self->_trueHeading);
    uint64_t v4 = objc_msgSend(NSString, "stringWithFormat:", @"%.1fdeg", *(void *)&self->_magneticHeading);
    v5 = objc_msgSend(NSString, "stringWithFormat:", @"%.1fdeg", *(void *)&self->_headingAccuracy);
    uint64_t v6 = [NSString stringWithFormat:@"Time: %@. TrueHeading: %@. MagHeading: %@. HeadingAcc: %@", self->_timestamp, v3, v4, v5];
  }
  else
  {
    uint64_t v6 = @"***";
