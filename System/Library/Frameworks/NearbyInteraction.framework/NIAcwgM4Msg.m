...
+ (id)fromStruct:(AcwgM4MsgStruct *)a3
{
  unint64_t v3 = (void *)[objc_alloc((Class)a1) initWithStsIndex0:a3->var0 uwbTime0:a3->var1 hopKey:a3->var2 selectedSyncCodeIndex:a3->var3];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)[v4 initWithStsIndex0:stsIndex0 uwbTime0:uwbTime0 hopKey:hopKey selectedSyncCodeIndex:selectedSyncCodeIndex];
}
...
- (NIAcwgM4Msg)initWithCoder:(id)a3
{
  ...
  if (self)
  {
    ...
    self->_unint64_t uwbTime0 = [v5 decodeInt64ForKey:@"uwbTime0"];
