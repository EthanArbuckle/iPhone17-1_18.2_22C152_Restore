...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v7 = (void *)[v4 initWithRealPart:v5 imagPart:v6];
...
- (id)description
{
  ...
  return (id)[v3 stringWithFormat:@"RealVal=%d, ImagVal=%d", v5, (int)v6];
}

- (unint64_t)hash
{
  uint64_t v3 = [(NSNumber *)self->_real hash];
  return [(NSNumber *)self->_imag hash] ^ v3;
}
