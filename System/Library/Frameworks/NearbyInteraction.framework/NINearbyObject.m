...
- (NINearbyObject)initWithToken:(id)a3
{
  ...
  if (v7)
  {
    ...
    *(void *)&v8->_timestamp = NINearbyObjectMachContTimeNotAvailable;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)[v4 initWithNearbyObject:self];
}
...
- (NINearbyObject)initWithCoder:(id)a3
{
  ...
  if (v5 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    uint64_t v11 = [v4 decodeIntegerForKey:@"relationship"];
    [v4 decodeDoubleForKey:@"timestamp"];
    double v13 = v12;
    uint64_t v14 = [v4 decodeIntegerForKey:@"measurementQuality"];
    uint64_t v15 = [v4 decodeIntegerForKey:@"motionState"];
    ...
    uint64_t v18 = [v4 decodeIntegerForKey:@"verticalDirectionEstimate"];
    ...
    long long v46 = v29;
    char v45 = [v4 decodeBoolForKey:@"requiresBiasCorrection"];
    ...
    double v31 = v30;
    char v42 = [v4 decodeBoolForKey:@"canInteract"];
    char v41 = [v4 decodeBoolForKey:@"resetARSession"];
    char v40 = [v4 decodeBoolForKey:@"revokeFindingExperience"];
    [v4 decodeFloatForKey:@"boundedRegionRange"];
    float v33 = v32;
    uint64_t v39 = [v4 decodeIntegerForKey:@"algorithmSource"];
...
LABEL_11:
            ...
            uint64_t v20 = [(NINearbyObject *)v6 distanceMeasurementQuality];
            unint64_t relationship = self->_relationship;
            uint64_t v22 = [(NINearbyObject *)v6 relationship];
            double timestamp = self->_timestamp;
            [(NINearbyObject *)v6 timestamp];
            double v25 = v24;
            int64_t motionState = self->_motionState;
            uint64_t v115 = [(NINearbyObject *)v6 motionState];
...
LABEL_15:
                ...
                uint64_t v39 = [(NINearbyObject *)v6 verticalDirectionEstimate];
...
LABEL_27:
                            ...
                            char v96 = v51;
                            int v94 = [(NINearbyObject *)v6 requiresBiasCorrection];
                            ...
                            BOOL v56 = [(UWBSignalFeatures *)uwbSignalFeatures isEqual:v55];

                            LOBYTE(v54) = !v56;
LABEL_31:
                            int nbRxStatus = self->_nbRxStatus;
                            int v58 = [(NINearbyObject *)v6 nbRxStatus];
                            int mmsRxStatus = self->_mmsRxStatus;
                            int v92 = [(NINearbyObject *)v6 mmsRxStatus];
                            int v89 = mmsRxStatus;
                            double nbRssi = self->_nbRssi;
                            [(NINearbyObject *)v6 nbRssi];
                            double v90 = v60;
                            BOOL canInteract = self->_canInteract;
                            int v88 = [(NINearbyObject *)v6 canInteract];
                            int resetARSession = self->_resetARSession;
                            int v86 = [(NINearbyObject *)v6 resetARSession];
                            int v84 = canInteract;
                            char v85 = (char)v54;
                            int revokeFindingExperience = self->_revokeFindingExperience;
                            int v82 = [(NINearbyObject *)v6 revokeFindingExperience];
                            char v62 = v14;
                            char v63 = v10;
                            ...
                            uint64_t v65 = [(NINearbyObject *)v6 algorithmSource];
                            ...
                            char v69 = [(NSString *)debugDisplayInfo isEqualToString:v68];
...
LABEL_35:
                        ...
                        char v51 = [(NSUUID *)bluetoothPeerIdentifier isEqual:v50];
                    ...
                    char v99 = [(NSData *)bluetoothAdvertisingAddress isEqualToData:v47];
                ...
                char v100 = [(NSNumber *)spatialScore isEqualToNumber:v44];
            ...
            char v37 = [(NSString *)name isEqualToString:v36];
        ...
        char v14 = [(NSString *)deviceIdentifier isEqualToString:v13];
    ...
    char v10 = [(NIDiscoveryToken *)discoveryToken isEqual:v9];
...
- (unint64_t)hash
{
  discoveryToken = self->_discoveryToken;
  if (discoveryToken) {
    uint64_t v64 = [(NIDiscoveryToken *)discoveryToken hash];
  }
  else {
    uint64_t v64 = 0;
  }
  ...
  if ((vminvq_u32(v8) & 0x80000000) != 0) {
    uint64_t HashFromSimdFloat3 = 0;
  }
  else {
    uint64_t HashFromSimdFloat3 = extractHashFromSimdFloat3(v7);
  }
  double timestamp = self->_timestamp;
  double v10 = *(double *)&NINearbyObjectMachContTimeNotAvailable;
  ...
  else
  {
    ...
    uint64_t v61 = [v32 hash];
  }
  BOOL v71 = [NSNumber numberWithInteger:self->_distanceMeasurementQuality];
  uint64_t v60 = [v71 hash];
  uint32x4_t v70 = [NSNumber numberWithInteger:self->_motionState];
  uint64_t v58 = [v70 hash];
  char v69 = [NSNumber numberWithInteger:self->_relationship];
  uint64_t v57 = [v69 hash];
  ...
  else
  {
    *(float *)&double v11 = self->_horizontalAngleAccuracy;
    ...
    uint64_t v49 = [v30 hash];
  }
  uint64_t v50 = [(NSNumber *)self->_spatialScore hash];
  uint64_t v48 = [(NSData *)self->_bluetoothAdvertisingAddress hash];
  uint64_t v47 = [(NSUUID *)self->_bluetoothPeerIdentifier hash];
  v67 = [NSNumber numberWithDouble:self->_signalStrength];
  uint64_t v46 = [v67 hash];
  v66 = [NSNumber numberWithInt:self->_remoteTxAntennaMask];
  uint64_t v45 = [v66 hash];
  uint64_t v65 = [NSNumber numberWithDouble:self->_rangeBiasEstimate];
  uint64_t v44 = [v65 hash];
  v59 = [NSNumber numberWithDouble:self->_rangeUncertainty];
  uint64_t v43 = [v59 hash];
  ...
  if ((vminvq_u32(v17) & 0x80000000) != 0) {
    ...
    uint64_t v42 = extractHashFromSimdFloat3(v16);
  }
  v55 = [NSNumber numberWithBool:self->_requiresBiasCorrection];
  uint64_t v41 = [v55 hash];
  unint64_t v40 = [(UWBSignalFeatures *)self->_uwbSignalFeatures hash];
  char v51 = [NSNumber numberWithInt:self->_nbRxStatus];
  uint64_t v39 = [v51 hash];
  float32x4_t v18 = [NSNumber numberWithInt:self->_mmsRxStatus];
  uint64_t v38 = [v18 hash];
  float v19 = [NSNumber numberWithDouble:self->_nbRssi];
  uint64_t v37 = [v19 hash];
  uint64_t v20 = [NSNumber numberWithBool:self->_canInteract];
  uint64_t v36 = [v20 hash];
  float v21 = [NSNumber numberWithBool:self->_resetARSession];
  uint64_t v35 = [v21 hash];
  uint64_t v22 = [NSNumber numberWithBool:self->_revokeFindingExperience];
  uint64_t v34 = [v22 hash];
...
- (id)description
{
  ...
  float v6 = (void *)[v3 initWithFormat:@"<%@: ", v5];
  ...
  [v6 appendFormat:@", Vertical Direction Estimate: %@ ", off_1E5AC2D78[verticalDirectionEstimate]];
  [v6 appendString:@">"];
...
- (id)descriptionInternal
{
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%0.2frad", horizontalAngleAccuracy);
    uint32x4_t v11 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  ...
  {
    int v41 = 46;
    uint64_t v42 = "NIDistanceMeasurementQualityToString";
    goto LABEL_57;
  }
  [v6 appendFormat:@", Ranging Quality: %@ ", off_1E5AC2DA0[distanceMeasurementQuality]];
  unint64_t motionState = self->_motionState;
  if (motionState >= 3)
  {
    int v41 = 60;
    uint64_t v42 = "NIMotionActivityStateToString";
LABEL_57:
    __assert_rtn(v42, "NINearbyObject.mm", v41, "false");
  }
  [v6 appendFormat:@", Motion State: %@", off_1E5AC2DC0[motionState]];
  double signalStrength = self->_signalStrength;
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%0.2f dBm", *(void *)&self->_signalStrength);
    __n128 v16 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"0x%02x", self->_remoteTxAntennaMask);
    float v19 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%0.2f m", *(void *)&self->_rangeBiasEstimate);
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%0.2f m", *(void *)&self->_rangeUncertainty);
    NSUInteger v28 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%d", self->_nbRxStatus);
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%d", self->_mmsRxStatus);
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%0.2f dBm", *(void *)&self->_nbRssi);
