...
- (NIDevicePresenceConfiguration)initWithInnerBoundary:(id)a3 outerBoundary:(id)a4 error:(id *)a5
{
  ...
  v22[0] = v10[7];
  v22[1] = v10[8];
  uint64_t v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v22 count:2];
  v18 = (void *)v10[9];
  v10[9] = v17;
...
- (NIDevicePresenceConfiguration)initWithDiscoveryToken:(id)a3 regions:(id)a4 preferredUpdateRate:(int64_t)a5 error:(id *)a6
{
  ...
  if (v16)
  {
    ...
    if (v18)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(*(id *)(*((void *)&v24 + 1) + 8 * v20++), "setPreferredUpdateRate:", a5, (void)v24);
        }
        while (v18 != v20);
        uint64_t v18 = [v17 countByEnumeratingWithState:&v24 objects:v28 count:16];
      }
    ...
    uint64_t v21 = [objc_alloc(MEMORY[0x1E4F1C978]) initWithArray:v17 copyItems:1];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v10 = [(NSArray *)self->_monitoredRegions copyWithZone:a3];
  id v11 = (void *)v5[9];
  v5[9] = v10;
...
- (NIDevicePresenceConfiguration)initWithCoder:(id)a3
{
  ...
  uint64_t v12 = [v4 decodeIntegerForKey:@"allowedDevices"];
  if (!+[NIInternalUtils isIntValidRelationshipSpecifier:v12])goto LABEL_5; {
  v5->_allowedDevices = v12;
  }
  uint64_t v13 = [v4 decodeIntegerForKey:@"monitoringOption"];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    else
    {
      ...
      int v8 = [v7 isEqual:self->_innerBoundary];

      id v9 = [(NIDevicePresenceConfiguration *)v6 outerBoundary];
      int v10 = [v9 isEqual:self->_outerBoundary];
      ...
      int v15 = [v14 isEqualToArray:self->_monitoredRegions];

      uint64_t v16 = [(NIDevicePresenceConfiguration *)v6 allowedDevices];
      int v23 = v15;
      unint64_t allowedDevices = self->_allowedDevices;
      uint64_t v24 = [(NIDevicePresenceConfiguration *)v6 monitoringOption];
      unint64_t monitoringOption = self->_monitoringOption;
      objc_super v18 = [(NIDevicePresenceConfiguration *)v6 token];
      LODWORD(v14) = v8;
      token = self->_token;

      BOOL v19 = [(NIDevicePresenceConfiguration *)v6 isCameraAssistanceEnabled];
      BOOL v13 = 0;
      if ((v14 & (v10 | v12)) == 1
        && v16 == allowedDevices
...
- (id)descriptionInternal
{
  ...
  unint64_t v6 = +[NIInternalUtils NIRelationshipSpecifierToString:self->_allowedDevices];
  ...
  return (id)[v3 stringWithFormat:@"<innerboundary: %@, outerboundary: %@, allowedDevices: %s, monitoringOption: %s>, isCameraAssistanceEnabled: %s", innerBoundary, outerBoundary, v6, v7, v8];
}
