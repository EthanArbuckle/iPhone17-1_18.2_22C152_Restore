...
{
  id v4 = a3;
  uint64_t v5 = [v4 decodeIntForKey:@"antennaMask"];
  ...
  double v26 = v25;
  uint64_t v27 = [v4 decodeIntForKey:@"rxAntennaPacket1"];
  ...
  double v32 = v31;
  uint64_t v33 = [v4 decodeIntForKey:@"rxAntennaPacket2"];
  v45.receiver = self;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)[v4 initWithBiasEstimatorFeatures:self];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    uint64_t v5 = (BiasEstimatorFeatures *)v4;
    double v6 = v5;
    if (v5 == self)
    {
      BOOL v56 = 1;
LABEL_36:
    ...
    int v8 = [(BiasEstimatorFeatures *)v5 antennaMask];
...
LABEL_7:
        ...
        int v37 = [(BiasEstimatorFeatures *)v6 rxAntennaPacket1];
        ...
        uint64_t v39 = [(BiasEstimatorFeatures *)v6 cirPacket2];
        BOOL v40 = [(NSArray *)cirPacket2 isEqualToArray:v39];
        double v41 = v14;
        double v42 = timestamp;
        double v43 = v11;
        double v44 = uwbTime;
...
LABEL_11:
        ...
        int v52 = [(BiasEstimatorFeatures *)v6 rxAntennaPacket2];
        ...
        BOOL v55 = (leadingEdgePacket2 == v47) & ~((v54
                                            || toaPpwinPeak != v74
                                            || rttInitiator != v72
                                            || tatInitiator != v70
                                            || rttResponder != v68
    ...
    BOOL v32 = [(NSArray *)cirPacket1 isEqualToArray:v31];
...
- (id)description
{
  ...
  double v6 = (void *)[v3 initWithFormat:@"<%@: ", v5];

  objc_msgSend(v6, "appendFormat:", @"AntennaMask: %d", self->_antennaMask);
  ...
  if (cirPacket1)
  {
    int v8 = [(NSArray *)cirPacket1 description];
...
- (id)populateOrderedInputFeature
{
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F28E78]) initWithFormat:@"%d, %f, %f, %d, %.3f, %.3f", self->_antennaMask, *(void *)&self->_timestamp, *(void *)&self->_uwbTime, (int)self->_tofPicSecond, *(void *)&self->_rssiDbm, *(void *)&self->_soiRssiDbm];
  ...
  {
    uint64_t v5 = [(NSArray *)self->_cirPacket1 objectAtIndex:i];
    double v6 = [v5 real];

    double v7 = [(NSArray *)self->_cirPacket1 objectAtIndex:i];
    int v8 = [v7 imag];

    [v3 appendFormat:@", %d, %d", objc_msgSend(v6, "intValue"), objc_msgSend(v8, "intValue")];
  }
  ...
  for (unint64_t j = 0; [(NSArray *)self->_cirPacket2 count] > j; ++j)
  {
    ...
    [v3 appendFormat:@", %d, %d", objc_msgSend(v11, "intValue"), objc_msgSend(v13, "intValue")];
  }
...
- (unint64_t)hash
{
  ...
  uint64_t v5 = [v4 hash];
  uint64_t v6 = [(NSArray *)self->_cirPacket2 hash];
  ...
  unint64_t v12 = v31 ^ v33 ^ v30 ^ v28 ^ v27 ^ v25 ^ v24 ^ v23 ^ v21 ^ v20 ^ v18 ^ v17 ^ v16 ^ v15 ^ v14 ^ v3 ^ v5 ^ v6 ^ v8 ^ v10 ^ [v11 hash];
