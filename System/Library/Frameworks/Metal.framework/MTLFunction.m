...
{
  result = [[MTLFunctionReflectionInternal alloc] initWithDevice:*(void *)(a1[4] + 24) reflectionData:a3 functionType:*(void *)(a1[4] + 32) options:a1[6]];
...
{
  v4 = [[MTLFunctionReflectionInternal alloc] initWithDevice:*(void *)(a1[4] + 24) reflectionData:a3 functionType:*(void *)(a1[4] + 32) options:a1[6]];
  (*(void (**)(void))(a1[5] + 16))();
}
