...
{
  v3.receiver = self;
  v3.super_class = (Class)MTLResourceStatePassSampleBufferAttachmentDescriptorInternal;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  self = (MTLResourceStatePassSampleBufferAttachmentDescriptorInternal *)((char *)self + 8);
