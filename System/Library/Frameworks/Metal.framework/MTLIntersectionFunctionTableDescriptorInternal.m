...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  {
    v6.receiver = a1;
    v6.super_class = (Class)&OBJC_METACLASS___MTLIntersectionFunctionTableDescriptorInternal;
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v5 = NSString;
  v10.receiver = self;
  v10.super_class = (Class)MTLIntersectionFunctionTableDescriptorInternal;
  id v6 = [(MTLIntersectionFunctionTableDescriptorInternal *)&v10 description];
  v11[0] = v4;
  v11[1] = @"functionCount =";
...
- (id)description
{
  return [(MTLIntersectionFunctionTableDescriptorInternal *)self formattedDescription:0];
}
