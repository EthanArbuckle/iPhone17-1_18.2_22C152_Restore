...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v5 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)MTLFunctionStitchingBuiltinThreadPositionInThreadgroup;
...
- (NSString)description
{
  return (NSString *)[(MTLFunctionStitchingBuiltinThreadPositionInThreadgroup *)self formattedDescription:0];
}
