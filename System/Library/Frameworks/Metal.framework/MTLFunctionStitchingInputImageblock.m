...
{
  v5.receiver = self;
  v5.super_class = (Class)MTLFunctionStitchingInputImageblock;
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v7 = [(MTLFunctionStitchingInputImageblock *)self bindIndex];
  return v7 == [a3 bindIndex];
}

- (unint64_t)hash
{
  unint64_t v3 = [(MTLFunctionStitchingInputImageblock *)self bindIndex];
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)MTLFunctionStitchingInputImageblock;
  v6 = [(MTLFunctionStitchingInputImageblock *)&v8 description];
  v9[0] = v4;
  v9[1] = @"bind index = ";
...
- (NSString)description
{
  return (NSString *)[(MTLFunctionStitchingInputImageblock *)self formattedDescription:0];
}
