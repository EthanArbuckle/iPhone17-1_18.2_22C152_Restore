...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v7 = [(MTLFunctionStitchingInputTexture *)self bindIndex];
  return v7 == [a3 bindIndex];
}

- (unint64_t)hash
{
  unint64_t v3 = [(MTLFunctionStitchingInputTexture *)self bindIndex];
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v6 = [(MTLFunctionStitchingInputTexture *)&v8 description];
  v9[0] = v4;
  v9[1] = @"bind index = ";
...
- (NSString)description
{
  return (NSString *)[(MTLFunctionStitchingInputTexture *)self formattedDescription:0];
}
