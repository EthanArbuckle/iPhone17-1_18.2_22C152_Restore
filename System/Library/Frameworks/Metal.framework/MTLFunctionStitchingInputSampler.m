...
- (BOOL)isEqual:(id)a3;
- (MTLFunctionStitchingInputSampler)initWithBindIndex:(unint64_t)a3;
...
{
  v5.receiver = self;
  v5.super_class = (Class)MTLFunctionStitchingInputSampler;
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v7 = [(MTLFunctionStitchingInputSampler *)self bindIndex];
  return v7 == [a3 bindIndex];
}

- (unint64_t)hash
{
  unint64_t v3 = [(MTLFunctionStitchingInputSampler *)self bindIndex];
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)MTLFunctionStitchingInputSampler;
...
- (NSString)description
{
  return (NSString *)[(MTLFunctionStitchingInputSampler *)self formattedDescription:0];
}
