...
- (BOOL)isEqual:(id)a3;
- (MTLArgumentDescriptorInternal)init;
...
@implementation MTLArgumentDescriptorInternal

- (id)formattedDescription:(unint64_t)a3
{
  v5 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)MTLArgumentDescriptorInternal;
  id v6 = [(MTLArgumentDescriptorInternal *)&v8 description];
...
{
  v3.receiver = self;
  v3.super_class = (Class)MTLArgumentDescriptorInternal;
  result = [(MTLArgumentDescriptorInternal *)&v3 init];
  if (result)
  {
...
- (id)description
{
  return [(MTLArgumentDescriptorInternal *)self formattedDescription:0];
}
