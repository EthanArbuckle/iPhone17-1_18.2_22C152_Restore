...
- (void)setTexture:(id)a3
{
  ...
  if (a3 && MTLFailureTypeGetEnabled(1uLL) && ([a3 conformsToProtocol:&unk_1ECB41A58] & 1) == 0) {
    MTLReportFailure(1uLL, "-[MTLRenderPassStencilAttachmentDescriptorInternal setTexture:]", 921, @"texture is not a MTLTextureImplementation.", v6, v7, v8, v9, v10);
  }
...
- (void)setResolveTexture:(id)a3
{
  ...
  if (a3 && MTLFailureTypeGetEnabled(1uLL) && ([a3 conformsToProtocol:&unk_1ECB41A58] & 1) == 0) {
    MTLReportFailure(1uLL, "-[MTLRenderPassStencilAttachmentDescriptorInternal setResolveTexture:]", 922, @"resolveTexture is not a MTLTextureImplementation.", v7, v8, v9, v10, v11);
  }
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  id v6 = [(MTLRenderPassStencilAttachmentDescriptorInternal *)&v8 description];
  return (id)[v5 stringWithFormat:@"%@%@", v6, stencilAttachmentFormattedDescription(a3, &self->_private)];
}

- (id)description
{
  return [(MTLRenderPassStencilAttachmentDescriptorInternal *)self formattedDescription:0];
}
