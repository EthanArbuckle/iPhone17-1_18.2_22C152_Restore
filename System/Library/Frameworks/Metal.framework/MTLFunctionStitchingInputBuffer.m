...
- (BOOL)isEqual:(id)a3;
- (MTLFunctionStitchingInputBuffer)initWithBindIndex:(unint64_t)a3;
...
{
  v5.receiver = self;
  v5.super_class = (Class)MTLFunctionStitchingInputBuffer;
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v7 = [(MTLFunctionStitchingInputBuffer *)self bindIndex];
  return v7 == [a3 bindIndex];
}

- (unint64_t)hash
{
  unint64_t v3 = [(MTLFunctionStitchingInputBuffer *)self bindIndex];
...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)MTLFunctionStitchingInputBuffer;
...
- (NSString)description
{
  return (NSString *)[(MTLFunctionStitchingInputBuffer *)self formattedDescription:0];
}
