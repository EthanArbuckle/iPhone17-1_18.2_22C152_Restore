...
{
  v12.receiver = self;
  v12.super_class = (Class)SKButtonNode;
...
- (SKButtonNode)initWithCoder:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SKButtonNode;
...
{
  v5.receiver = self;
  v5.super_class = (Class)SKButtonNode;
  id v4 = a3;
...
- (void)touchEnded:(unint64_t)a3 location:(CGPoint)a4
{
  ...
  if ((touches < 0) ^ v5 | (touches == 0))
  {
    ...
    id upBlock = (void (**)(id, SKButtonNode *))self->_upBlock;
    if (upBlock) {
...
{
  v7.receiver = self;
  v7.super_class = (Class)SKButtonNode;
  id v4 = [(SKLabelNode *)&v7 copyWithZone:a3];
  objc_storeStrong(v4 + 20, self->_downAction);
  objc_storeStrong(v4 + 21, self->_upAction);
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  objc_storeWeak(v4 + 19, WeakRetained);
...
- (SKButtonNodeDelegate)delegate
{
  ...
  return (SKButtonNodeDelegate *)WeakRetained;
}
