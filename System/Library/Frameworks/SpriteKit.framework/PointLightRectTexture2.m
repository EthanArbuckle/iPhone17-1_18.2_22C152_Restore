@interface PointLightRectTexture2
@end

@implementation PointLightRectTexture2

void __PointLightRectTexture2_fsh_block_invoke()
{
  ...
  v1 = (void *)PointLightRectTexture2_fsh::shader;
  PointLightRectTexture2_fsh::shader = v0;
}
