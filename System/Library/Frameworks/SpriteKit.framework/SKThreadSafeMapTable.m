...
- (void)forwardInvocation:(id)a3
{
  ...
  else
  {
    ...
    [(SKThreadSafeMapTable *)&v5 forwardInvocation:v4];
  }
}
...
- (id)methodSignatureForSelector:(SEL)a3
{
  ...
  objc_super v5 = -[SKThreadSafeMapTable methodSignatureForSelector:](&v7, sel_methodSignatureForSelector_);
  if (!v5)
  {
    objc_super v5 = [(NSMutableArray *)self->_storage methodSignatureForSelector:a3];
  }
