...
- (id)_actionNameForActivation:(BOOL)a3
{
  ...
  id v6 = [v4 localizedStringForKey:@"Deactivate Mention" value:@"Deactivate Mention" table:@"Localizable"];
  }
...
- (id)description
{
  ...
  id v5 = [(PKMentionItem *)self mentionResult];
  id v6 = [(PKMentionItem *)self mentionUUID];
