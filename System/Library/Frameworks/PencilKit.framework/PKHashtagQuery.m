...
- (PKHashtagQuery)initWithRecognitionSessionManager:(id)a3;
...
- (void)queryDidUpdateResult:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = [[PKHashtagQueryItem alloc] initWithCoreHandwritingPrefixQueryItem:*(void *)(*((void *)&v19 + 1) + 8 * v13)];
          [v8 addObject:v14];
    ...
    if (v16)
    {
      ...
      v18 = (void *)[v8 copy];
      [v17 hashtagQuery:self foundItems:v18];
    }
  }
}
