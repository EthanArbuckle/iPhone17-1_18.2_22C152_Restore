...
- (PKProofreadingQuery)initWithRecognitionSessionManager:(id)a3
{
  ...
  if (v5)
  {
    id v6 = objc_alloc(MEMORY[0x1E4F5C098]);
...
- (void)queryDidUpdateResult:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = [[PKProofreadingQueryItem alloc] initWithCoreHandwritingTextCheckingQueryItem:*(void *)(*((void *)&v19 + 1) + 8 * v13)];
          [v8 addObject:v14];
    ...
    if (v16)
    {
      ...
      v18 = (void *)[v8 copy];
      [v17 proofreadingQuery:self foundItems:v18];
    }
  }
}
