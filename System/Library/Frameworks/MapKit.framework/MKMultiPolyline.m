...
- ($FD2884BA735A6398BD92EEF91FE53E55)_boundingMapRectForPolylines:(id)a3;
- ($FD2884BA735A6398BD92EEF91FE53E55)boundingMapRect;
- (CLLocationCoordinate2D)coordinate;
- (MKMultiPolyline)init;
    ...
    if (v12)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          id v16 = [[MKPolyline alloc] _initWithGeoJSONPoints:*(void *)(*((void *)&v22 + 1) + 8 * v15) error:a4];
          if (!v16)
          {
...
- (MKMultiPolyline)initWithPolylines:(NSArray *)polylines
{
  v4 = polylines;
  v14.receiver = self;
  v14.super_class = (Class)MKMultiPolyline;
  v5 = [(MKMultiPolyline *)&v14 init];
  if (v5)
  {
    uint64_t v6 = [(NSArray *)v4 copy];
    v7 = v5->_polylines;
    v5->_polylines = (NSArray *)v6;

    [(MKMultiPolyline *)v5 _boundingMapRectForPolylines:v5->_polylines];
...
- (MKMultiPolyline)init
{
  return [(MKMultiPolyline *)self initWithPolylines:MEMORY[0x1E4F1CBF0]];
}
...
- (MKMultiPolyline)initWithCoder:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)MKMultiPolyline;
  ...
  if (v5)
  {
    ...
    uint64_t v9 = [v4 decodeObjectOfClasses:v8 forKey:@"MKMultiPolylinePolylines"];
    polylines = v5->_polylines;
    v5->_polylines = (NSArray *)v9;
...
{
  v5.receiver = self;
  v5.super_class = (Class)MKMultiPolyline;
  id v4 = a3;
  [(MKShape *)&v5 encodeWithCoder:v4];
  objc_msgSend(v4, "encodeObject:forKey:", self->_polylines, @"MKMultiPolylinePolylines", v5.receiver, v5.super_class);
}
