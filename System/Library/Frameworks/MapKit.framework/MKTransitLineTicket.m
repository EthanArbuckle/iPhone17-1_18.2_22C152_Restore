...
void __58___MKTransitLineTicket_submitWithHandler_networkActivity___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v8)
  {
    if (v6)
    {
      ...
      v13[1] = 3221225472;
      v10 = __58___MKTransitLineTicket_submitWithHandler_networkActivity___block_invoke_2;
      v11 = v6;
    }
    else
    {
      ...
      v12[1] = 3221225472;
      v10 = __58___MKTransitLineTicket_submitWithHandler_networkActivity___block_invoke_3;
      v11 = v5;
    }
    v9[2] = v10;
    v9[3] = &unk_1E54B8360;
