...
- (_MKCuratedCollectionItemsTicket)initWithTicket:(id)a3
{
  ...
  v6 = [(_MKCuratedCollectionItemsTicket *)&v9 init];
  v7 = v6;
  if (v6) {
...
- (GEOMapServiceTraits)traits
{
  return (GEOMapServiceTraits *)[(GEOMapServiceCuratedCollectionItemsTicket *)self->_ticket traits];
}
...
- (void)submitWithCallbackQueue:(id)a3 handler:(id)a4 networkActivity:(id)a5
{
  ...
  id v11 = v8;
  id v12 = v9;
  [(GEOMapServiceCuratedCollectionItemsTicket *)ticket submitWithHandler:v13 networkActivity:a5];
}
