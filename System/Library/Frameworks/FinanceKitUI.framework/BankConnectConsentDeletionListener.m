...
- (void).cxx_destruct
{
  ...
  sub_243A6F580(*(uint64_t *)((char *)&self->super.isa
                           + OBJC_IVAR____TtC12FinanceKitUI34BankConnectConsentDeletionListener_onDeletionOfLastConsent));
  v3 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC12FinanceKitUI34BankConnectConsentDeletionListener_context);
}
...
- (void)controller:(id)a3 didChangeObject:(id)a4 atIndexPath:(id)a5 forChangeType:(unint64_t)a6 newIndexPath:(id)a7
{
  ...
  sub_243C591E8((uint64_t)v26, (uint64_t)v17, a6);

  sub_243C5958C((uint64_t)v14);
  sub_243C5958C((uint64_t)v17);
