@interface StepByDecodeTime
@end

@implementation StepByDecodeTime

uint64_t __remoteSampleCursor_StepByDecodeTime_block_invoke(uint64_t a1, CMBlockBufferRef theBuffer)
{
  size_t v8 = 0;
  dataPointerOut = 0;
...
uint64_t __remoteSampleCursor_StepByDecodeTime_block_invoke_2(uint64_t a1, CMBlockBufferRef theBuffer)
{
  size_t v5 = 0;
  dataPointerOut = 0;
...
uint64_t __remoteSampleCursor_StepByDecodeTime_block_invoke_3()
{
