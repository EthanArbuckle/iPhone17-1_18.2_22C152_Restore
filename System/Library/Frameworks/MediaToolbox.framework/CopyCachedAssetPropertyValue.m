@interface CopyCachedAssetPropertyValue
@end
...
{
  value = 0;
  CFTypeRef result = (CFTypeRef)CFDictionaryGetValueIfPresent(*(CFDictionaryRef *)(*(void *)(a1 + 40) + 32), *(const void **)(a1 + 48), (const void **)&value);
  if (result)
  {
