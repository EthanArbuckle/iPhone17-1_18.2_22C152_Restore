@interface CGColorSpaceCreateExtendedLinearized
@end

@implementation CGColorSpaceCreateExtendedLinearized

uint64_t (*__CGColorSpaceCreateExtendedLinearized_block_invoke())()
{
  ...
  CGColorSpaceCreateExtendedLinearized_f = (uint64_t (*)(void, void))v1;
  return result;
}
