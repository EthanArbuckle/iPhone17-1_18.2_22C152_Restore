@interface CGCMSUtilsCreateProfileForCalGray
@end

@implementation CGCMSUtilsCreateProfileForCalGray

uint64_t (*__CGCMSUtilsCreateProfileForCalGray_block_invoke())()
{
  ...
  CGCMSUtilsCreateProfileForCalGray_f = (uint64_t (*)(void))v1;
  return result;
}
