...
uint64_t (*__CGImageCreateWithJPEGDataProvider3_block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8))(void)
{
  ...
  CGImageCreateWithJPEGDataProvider3_f_122 = result;
  return result;
}
