@interface CGImageWriteToFile
@end

@implementation CGImageWriteToFile

uint64_t (*__CGImageWriteToFile_block_invoke_3(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8))(void)
{
  ...
  CGImageWriteToFile_f_251 = result;
  return result;
}
