@interface CGColorSpaceCreateCopyWithStandardRange
@end

@implementation CGColorSpaceCreateCopyWithStandardRange

uint64_t (*__CGColorSpaceCreateCopyWithStandardRange_block_invoke())()
{
  ...
  CGColorSpaceCreateCopyWithStandardRange_f = (uint64_t (*)(void, void))v1;
  return result;
}
