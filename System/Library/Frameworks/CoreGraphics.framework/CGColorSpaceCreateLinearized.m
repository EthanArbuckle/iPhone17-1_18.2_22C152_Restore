@interface CGColorSpaceCreateLinearized
@end

@implementation CGColorSpaceCreateLinearized

uint64_t (*__CGColorSpaceCreateLinearized_block_invoke())()
{
  ...
  CGColorSpaceCreateLinearized_f = (uint64_t (*)(void, void))v1;
  return result;
}
