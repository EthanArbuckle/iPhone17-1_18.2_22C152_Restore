@interface CGCMSUtilsCreateDataForCalLab
@end

@implementation CGCMSUtilsCreateDataForCalLab

uint64_t (*__CGCMSUtilsCreateDataForCalLab_block_invoke())()
{
  ...
  CGCMSUtilsCreateDataForCalLab_f = (uint64_t)v1;
  return result;
}
