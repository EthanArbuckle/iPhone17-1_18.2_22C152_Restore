...
- (AAUILabel)initWithFrame:(CGRect)a3
{
  ...
  result = -[AAUILabel initWithFrame:](&v5, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (result)
  {
    long long v4 = *(_OWORD *)&UIEdgeInsetsZero.bottom;
    *(_OWORD *)&result->_edgeInsets.top = *(_OWORD *)&UIEdgeInsetsZero.top;
...
- (AAUILabel)initWithEdgeInsets:(UIEdgeInsets)a3
{
  ...
  result = -[AAUILabel initWithFrame:](&v8, "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  if (result)
  {
...
- (void)drawTextInRect:(CGRect)a3
{
  ...
  if (vminv_u16((uint16x4_t)vcltz_s16(vshl_n_s16(vmovn_s32(vuzp1q_s32((int32x4_t)vceqq_f64(v3, *(float64x2_t *)&UIEdgeInsetsZero.top), (int32x4_t)vceqq_f64(v4, *(float64x2_t *)&UIEdgeInsetsZero.bottom))), 0xFuLL))))-[AAUILabel drawTextInRect:](&v6, "drawTextInRect:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, v5.receiver, v5.super_class, self, AAUILabel); {
  else
  }
    -[AAUILabel drawTextInRect:](&v5, "drawTextInRect:", a3.origin.x + v3.f64[1], a3.origin.y + v3.f64[0], a3.size.width - (v3.f64[1] + v4.f64[1]), a3.size.height - (v3.f64[0] + v4.f64[0]), self, AAUILabel, v6.receiver, v6.super_class);
}
