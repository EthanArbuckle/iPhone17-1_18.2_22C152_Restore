...
+ (id)alertContentForFirstJoinAlertWithRecordName:(id)a3 appName:(id)a4 bundleID:(id)a5 shareMetadata:(id)a6 currentUserName:(id)a7 currentUserFormattedUsername:(id)a8
{
  ...
  if (v22 <= 0x1D)
  {
    if (((1 << v22) & 0x32200000) != 0)
    {
      ...
      if ([v20 length])
      {
        ...
        id v48 = v20;
        v52 = v15;
        v26 = sub_4164(@"TITLED_DOCUMENT_OPEN_TITLE", @"%@%@");
      }
      else
      {
  ...
  v38 = sub_4164(v37, @"%@");
  v39 = objc_msgSend(v17, "share", v50);
  ...
  {
    v51 = (void *)v43;
    v45 = sub_4164(@"PUBLIC_ANONYMOUS_SHARING_OPEN_BODY", @"%@");
  }
  else
  {
    ...
    id v54 = v62;
    v51 = v44;
    v45 = sub_4164(@"GENERIC_APP_SHARING_OPEN_BODY", @"%@%@%@");
  }
  if (!v38 || !v45)
  {
...
+ (id)_alertContentForAppStoreOperationWithApp:(id)a3 shareMetadata:(id)a4 keyPrefix:(id)a5 titleKeySuffix:(id)a6 bodyKeySuffix:(id)a7 isSourceICS:(BOOL)a8
{
  ...
  id v18 = objc_msgSend(v13, "ownerIdentity", v12);
...
+ (id)alertContentForInitiateVettingError:(id)a3 shareTitle:(id)a4 isEmail:(BOOL)a5 address:(id)a6
{
  ...
  id v13 = sub_4164(v12, &stru_14C08);
  id v14 = sub_4164(@"VETTING_FAILURE_ALERT_BODY_INITIATE_GENERIC_ERROR", &stru_14C08);
  id v15 = [v9 domain];
    ...
    switch((unint64_t)v19)
    {
      ...
      case 0x1F47uLL:
        ...
        if (v7)
        {
          ...
          uint64_t v24 = sub_4164(v23, &stru_14C08);

          if (!v22 || ([v22 isEqualToString:&stru_14C08] & 1) != 0)
          {
            id v33 = v11;
...
+ (id)_sanitizedShareURLSlug:(id)a3
{
  id v3 = a3;
  if (qword_19978 != -1) {
    dispatch_once(&qword_19978, &stru_145E0);
  }
  v4 = [v3 CKURLSlug];
  if ([(id)qword_19980 containsObject:v4]) {
    BOOL v5 = v4;
  }
  else {
    BOOL v5 = @"share";
...
+ (id)alertContentForCompleteVettingError:(id)a3 shareTitle:(id)a4 email:(id)a5 phone:(id)a6 reconstructedShareURL:(id)a7
{
  ...
  id v19 = sub_4164(v18, &stru_14C08);
  v20 = sub_4164(@"VETTING_FAILURE_ALERT_BODY_COMPLETE_GENERIC_ERROR_ADDRESS", &stru_14C08);
  if (v14)
  {
    uint64_t v21 = sub_4164(@"VETTING_FAILURE_ALERT_BODY_COMPLETE_GENERIC_ERROR_EMAIL", &stru_14C08);
  ...
  if (v15)
  {
    uint64_t v22 = sub_4164(@"VETTING_FAILURE_ALERT_BODY_COMPLETE_GENERIC_ERROR_PHONE", &stru_14C08);
  ...
  if (v24)
  {
    ...
    switch((unint64_t)v29)
    {
      case 0x1F42uLL:
        ...
        uint64_t v31 = sub_4164(v33, &stru_14C08);
      ...
      case 0x1F44uLL:
        ...
        uint64_t v31 = sub_4164(v30, &stru_14C08);
...
LABEL_31:
      ...
      case 0x1F49uLL:
        ...
        uint64_t v35 = sub_4164(v34, &stru_14C08);
      ...
      case 0x1F4BuLL:
        if (v14)
        {
          ...
          uint64_t v39 = sub_4164(v38, &stru_14C08);
        ...
        else
        {
          ...
          uint64_t v50 = sub_4164(v49, &stru_14C08);
        ...
        uint64_t v51 = sub_4164(v42, &stru_14C08);
...
LABEL_40:
            ...
            uint64_t v73 = sub_4164(v75, &stru_14C08);
        ...
        {
          SEL v56 = (char *)[v42 code];

          if (v56 == (unsigned char *)&dword_8 + 3)
          {
...
+ (id)alertContentForShareMetadataErrorWithURL:(id)a3
{
  ...
  id v6 = sub_4164(v5, &stru_14C08);
  v10[1] = @"ckVettingAlertBody";
  v11[0] = v6;
  BOOL v7 = sub_4164(@"ITEM_UNAVAILABLE_FAILURE_ALERT_BODY", &stru_14C08);
  v11[1] = v7;
...
LABEL_6:
  ...
  {
    uint64_t v21 = (char *)[v7 code];

    if (v21 == (unsigned char *)&stru_3D8.addr + 7)
    {
      ...
      id v25 = objc_msgSend(v8, "ownerIdentity", v40);
...
+ (id)_alertContentForDropDownSelectionWithShareName:(id)a3 ownerName:(id)a4 currentUserName:(id)a5 currentUserFormattedUsername:(id)a6 dropDownTitles:(id)a7 locKeyPrefix:(id)a8 isSourceICS:(BOOL)a9
{
  ...
  if (v15)
  {
    ...
    uint64_t v21 = +[CKVettingAlerts mediumNameFromComponents:v15];
  ...
  else
  {
    ...
    uint64_t v21 = +[CKVettingAlerts mediumNameFromComponents:v16];
    uint64_t v30 = v17;
    uint64_t v22 = CKLocalizedString();
  }
...
+ (void)showICloudAccountSettingAlert:(id)a3 appName:(id)a4 previewRequested:(BOOL *)a5 isSourceICS:(BOOL)a6
{
  ...
  else
  {
    if ((responseFlags & 3) == 0)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_0, v21, OS_LOG_TYPE_INFO, "Redirecting user to iCloud preferences", buf, 2u);
      }
      ...
      if ((v24 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(ck_log_facility_ck, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138412290;
          id v34 = v25;
          _os_log_error_impl(&dword_0, v26, OS_LOG_TYPE_ERROR, "Failed to open iCloud settings: %@", buf, 0xCu);
        }
      }
    }
    BOOL v27 = 0;
...
+ (id)alertContentForGenericInitiateVettingError
{
  ...
  id v3 = sub_4164(v2, &stru_14C08);
  v7[1] = @"ckVettingAlertBody";
  v8[0] = v3;
  id v4 = sub_4164(@"VETTING_FAILURE_ALERT_BODY_INITIATE_GENERIC_ERROR", &stru_14C08);
  v8[1] = v4;
...
+ (id)appSpecificLocKeyForBundleID:(id)a3 shareType:(id)a4 prefix:(id)a5
{
  ...
  id v9 = a5;
  if (qword_19988 != -1) {
    dispatch_once(&qword_19988, &stru_14600);
  }
  uint64_t v10 = [(id)qword_19990 objectForKey:v7];

  if (v10)
  {
    id v11 = [(id)qword_19990 objectForKeyedSubscript:v7];
    id v12 = [(id)qword_19998 objectForKeyedSubscript:v11];
