@interface BYODGetDnsRecordsRequest
+ (Class)responseClass;
- (BYODGetDnsRecordsRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5;
- (id)bodyDictionary;
- (id)urlString;
- (void)performRequestWithCallback:(id)a3;
@end

@implementation BYODGetDnsRecordsRequest
...
- (BYODGetDnsRecordsRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  v11 = [(BYODGetDnsRecordsRequest *)self urlString];
  v14.receiver = self;
  v14.super_class = (Class)BYODGetDnsRecordsRequest;
...
- (id)urlString
{
  ...
  v4 = [v3 objectForKeyedSubscript:@"getDnsRecordsURL"];
