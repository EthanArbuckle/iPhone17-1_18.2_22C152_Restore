@interface BYODAcceptInviteRequest
+ (Class)responseClass;
- (BYODAcceptInviteRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5;
- (NSString)domainName;
- (id)bodyDictionary;
- (id)urlString;
...
@implementation BYODAcceptInviteRequest
...
- (BYODAcceptInviteRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  v11 = [(BYODAcceptInviteRequest *)self urlString];
  v14.receiver = self;
  v14.super_class = (Class)BYODAcceptInviteRequest;
...
- (id)urlString
{
  ...
  v4 = [v3 objectForKeyedSubscript:@"domainMemberAcceptInviteURL"];
