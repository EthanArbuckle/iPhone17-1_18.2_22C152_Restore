@interface BYODListDomainRequest
+ (Class)responseClass;
- (BYODListDomainRequest)initWithAccount:(id)a3 accountStore:(id)a4;
- (id)urlString;
- (void)performRequestWithCallback:(id)a3;
@end

@implementation BYODListDomainRequest

- (BYODListDomainRequest)initWithAccount:(id)a3 accountStore:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  v8 = [(BYODListDomainRequest *)self urlString];
  v11.receiver = self;
  v11.super_class = (Class)BYODListDomainRequest;
...
- (id)urlString
{
  ...
  v4 = [v3 objectForKeyedSubscript:@"listCustomDomainURL"];
