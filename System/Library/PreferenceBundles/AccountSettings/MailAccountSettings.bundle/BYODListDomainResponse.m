...
- (BYODListDomainResponse)initWithHTTPResponse:(id)a3 data:(id)a4
{
  ...
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BYODListDomainResponse;
  ...
  {
    v9 = [(BYODListDomainResponse *)v9 initWithDictionary:*(void *)&v9->super.AAResponse_opaque[OBJC_IVAR___AAResponse__responseDictionary]];
  }
