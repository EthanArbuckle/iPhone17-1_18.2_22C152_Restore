...
- (YahooNeedsAuthenticationFooterView)initWithSpecifier:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)YahooNeedsAuthenticationFooterView;
...
{
  v7.receiver = self;
  v7.super_class = (Class)YahooNeedsAuthenticationFooterView;
...
- (double)preferredHeightForWidth:(double)a3
{
  [(YahooNeedsAuthenticationFooterView *)self _heightForMessageConstrainedToWidth:a3];
  return v3 + 28.0;
}
...
- (double)_heightForMessageConstrainedToWidth:(double)a3
{
  ...
  double v5 = [(YahooNeedsAuthenticationFooterView *)self _font];
  v11 = v5;
