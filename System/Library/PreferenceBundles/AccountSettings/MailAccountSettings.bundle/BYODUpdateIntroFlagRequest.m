...
+ (Class)responseClass;
- (BYODUpdateIntroFlagRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5;
- (NSString)domainName;
- (id)bodyDictionary;
- (id)urlString;
...
- (BYODUpdateIntroFlagRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  v11 = [(BYODUpdateIntroFlagRequest *)self urlString];
  v14.receiver = self;
  v14.super_class = (Class)BYODUpdateIntroFlagRequest;
