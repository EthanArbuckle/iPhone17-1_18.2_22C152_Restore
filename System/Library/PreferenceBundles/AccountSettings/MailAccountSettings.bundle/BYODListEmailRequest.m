@interface BYODListEmailRequest
+ (Class)responseClass;
- (BYODListEmailRequest)initWithAccount:(id)a3 accountStore:(id)a4;
- (id)urlString;
- (void)performRequestWithCallback:(id)a3;
@end

@implementation BYODListEmailRequest

- (BYODListEmailRequest)initWithAccount:(id)a3 accountStore:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  v8 = [(BYODListEmailRequest *)self urlString];
  v11.receiver = self;
  v11.super_class = (Class)BYODListEmailRequest;
...
- (id)urlString
{
  ...
  v4 = [v3 objectForKeyedSubscript:@"listAvailableSendFromURL"];
