...
+ (Class)responseClass;
- (BYODDomainVerifyTransferRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5;
- (id)bodyDictionary;
- (id)urlString;
...
- (BYODDomainVerifyTransferRequest)initWithAccount:(id)a3 accountStore:(id)a4 domain:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  v11 = [(BYODDomainVerifyTransferRequest *)self urlString];
  v14.receiver = self;
  v14.super_class = (Class)BYODDomainVerifyTransferRequest;
