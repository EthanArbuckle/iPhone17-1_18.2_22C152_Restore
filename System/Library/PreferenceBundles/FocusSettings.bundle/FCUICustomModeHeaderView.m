...
{
  v59.receiver = self;
  v59.super_class = (Class)FCUICustomModeHeaderView;
  v3 = -[FCUICustomModeHeaderView initWithFrame:](&v59, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    ...
    v18 = (UITextField *)objc_msgSend(objc_alloc((Class)UITextField), "initWithFrame:", CGRectZero.origin.x, y, width, height);
    ...
    v23 = [v22 localizedStringForKey:@"ONBOARDING_MODE_TITLE_CUSTOM_PLACEHOLDER_TEXT" value:&stru_1D300 table:0];
...
{
  v3.receiver = self;
  v3.super_class = (Class)FCUICustomModeHeaderView;
...
+ (NSString)reuseIdentifier
{
  return (NSString *)@"FCUICustomModeHeaderView";
}
