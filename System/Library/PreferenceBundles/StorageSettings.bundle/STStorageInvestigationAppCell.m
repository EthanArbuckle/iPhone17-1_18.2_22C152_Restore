...
- (STStorageInvestigationAppCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  id v8 = a5;
  v28.receiver = self;
  v28.super_class = (Class)STStorageInvestigationAppCell;
  ...
  if (v9)
  {
    ...
    v19 = (UILabel *)objc_msgSend(v15, "initWithFrame:", CGRectZero.origin.x, y, width, height);
...
- (void)updateConstraints
{
  ...
  id v8 = +[NSLayoutConstraint constraintWithItem:appNameLabel attribute:3 relatedBy:0 toItem:v7 attribute:15 multiplier:1.0 constant:0.0];
  ...
  id v15 = [(STStorageInvestigationAppCell *)self contentView];
  ...
  v37.receiver = self;
  v37.super_class = (Class)STStorageInvestigationAppCell;
...
{
  v15.receiver = self;
  v15.super_class = (Class)STStorageInvestigationAppCell;
  id v4 = a3;
  [(STStorageInvestigationAppCell *)&v15 refreshCellContentsWithSpecifier:v4];
  v5 = objc_msgSend(v4, "propertyForKey:", @"APP_CASE", v15.receiver, v15.super_class);
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_diffSpaceLabel, 0);
  objc_storeStrong((id *)&self->_calculatedSpaceLabel, 0);
  objc_storeStrong((id *)&self->_reportedSpaceLabel, 0);
