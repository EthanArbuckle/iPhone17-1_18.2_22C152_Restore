...
+ (id)specifierForSystem
{
  uint64_t v2 = STSizeOfSystemVolume();
  v3 = +[PSSpecifier preferenceSpecifierNamed:&stru_2D2C0 target:0 set:0 get:0 detail:objc_opt_class() cell:2 edit:0];
...
{
  v7.receiver = self;
  v7.super_class = (Class)STStorageSystemCell;
  id v4 = a3;
