...
{
  if (qword_3A528 != -1) {
    dispatch_once(&qword_3A528, &stru_2CE48);
  }
  v2 = (void *)qword_3A520;
...
+ (id)mediaTypesForIdentifier:(id)a3
{
  uint64_t v3 = qword_3A538;
  id v4 = a3;
  if (v3 != -1) {
    dispatch_once(&qword_3A538, &stru_2CE68);
  }
  v5 = [(id)qword_3A530 objectForKey:v4];
...
- (NSMutableDictionary)mediaCache
{
  ...
  if (!mediaCache)
  {
    ...
    uint64_t v17 = [(STMediaCache *)self cacheItemForQuery:v16 withGroupingType:10 splitByPropertyName:MPMediaItemPropertyStorePlaylistID defaultPropertyValue:&off_2FF18];
