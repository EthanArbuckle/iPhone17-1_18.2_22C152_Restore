...
- (STStorageMessageItemCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  id v8 = a5;
  v19.receiver = self;
  v19.super_class = (Class)STStorageMessageItemCell;
...
- (void)updateConstraints
{
  ...
  {
    id v3 = [(STStorageMessageItemCell *)self contentView];
  ...
  v16.receiver = self;
  v16.super_class = (Class)STStorageMessageItemCell;
...
{
  v6.receiver = self;
  v6.super_class = (Class)STStorageMessageItemCell;
  id v4 = a3;
  [(STStorageMessageItemCell *)&v6 refreshCellContentsWithSpecifier:v4];
  v5 = objc_msgSend(v4, "propertyForKey:", STStorageTitleKey, v6.receiver, v6.super_class);
