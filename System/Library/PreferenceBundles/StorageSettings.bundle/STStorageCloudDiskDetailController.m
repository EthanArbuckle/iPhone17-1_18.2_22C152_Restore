...
- (id)specifiers
{
  ...
  v4 = [*(id *)&self->super.PSListController_opaque[OBJC_IVAR___PSViewController__specifier] propertyForKey:STStorageAppKey];
  if (v4)
  {
  ...
  [v3 addObject:v7];
  v10 = +[PSSpecifier groupSpecifierWithID:&stru_2D2C0];
  ...
  v13 = *(void **)&self->super.PSListController_opaque[OBJC_IVAR___PSListController__specifiers];
  *(void *)&self->super.PSListController_opaque[OBJC_IVAR___PSListController__specifiers] = v3;
  id v14 = v3;

  id v15 = *(id *)&self->super.PSListController_opaque[v12];
  return v15;
}
