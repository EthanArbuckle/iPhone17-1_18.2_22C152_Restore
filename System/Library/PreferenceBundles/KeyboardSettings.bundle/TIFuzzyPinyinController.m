...
- (void)viewDidAppear:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)TIFuzzyPinyinController;
  [(TIFuzzyPinyinController *)&v4 viewDidAppear:a3];
    ...
    if (v3)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v4; ++i)
        {
          ...
          uint64_t v9 = objc_msgSend((id)objc_msgSend(*(id *)(v5 + 1760), "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"FUZZY_PINYIN_PAIR_FORMAT", &stru_26E29DC78, @"Keyboard");
          if ([v8 count] == 2)
          {
            ...
            [v11 setProperty:&unk_26E2A71F8 forKey:v18];
            v12 = NSNumber;
            uint64_t v13 = [(NSMutableSet *)[(TIFuzzyPinyinController *)self fuzzyPinyinPairs] containsObject:v8];
            v14 = v12;
...
- (void)setKeyboardPreferenceValue:(id)a3 forSpecifier:(id)a4
{
  ...
  int v7 = [a3 BOOLValue];
  uint64_t v8 = [(TIFuzzyPinyinController *)self fuzzyPinyinPairSpecifiers];
  if (v7)
  {
...
- (id)specifiers
{
  ...
  if (!result)
  {
    ...
    uint64_t v6 = objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"FUZZY_PINYIN_OPTION", &stru_26E29DC78, @"Keyboard"), self, sel_setKeyboardPreferenceValue_forSpecifier_, sel_keyboardPreferenceValue_, 0, 6, 0);
    ...
    if (v10 != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      if ([v12 BOOLForPreferenceKey:*MEMORY[0x263F7E740]])
      {
        ...
        NSUInteger v15 = [(NSArray *)[(TIFuzzyPinyinController *)self fuzzyPinyinPairSpecifiers] count];
        if (v15)
        {
          NSUInteger v16 = v15;
          do
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if ([a4 section] == 1)
  {
    ...
    {
      id v8 = [(NSArray *)[(TIFuzzyPinyinController *)self fuzzyPinyinPairSpecifiers] objectAtIndex:v7];
      ...
      uint64_t v13 = [(TIFuzzyPinyinController *)self fuzzyPinyinPairs];
      if (v10 == 3) {
      ...
      uint64_t v16 = [(NSMutableSet *)[(TIFuzzyPinyinController *)self fuzzyPinyinPairs] allObjects];
