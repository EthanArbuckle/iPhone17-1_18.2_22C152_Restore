    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        if (objc_msgSend((id)objc_msgSend(v7, "objectForKeyedSubscript:", objc_msgSend(v12, "identifier")), "BOOLValue"))
        {
          ...
          if (!-[NSDictionary objectForKeyedSubscript:](-[KeyboardController offlineStatusForLanguage](self, "offlineStatusForLanguage"), "objectForKeyedSubscript:", objc_msgSend((id)objc_msgSend(v12, "identifier"), "stringByReplacingOccurrencesOfString:withString:", @"_", @"-")))
          {
            uint64_t v13 = _AFPreferencesReplacementLanguageForLocalRecognizerLanguageCode();
            if (v13) {
              [(NSDictionary *)[(KeyboardController *)self offlineStatusForLanguage] objectForKeyedSubscript:v13];
            }
          }
...
{
  v11.receiver = self;
  v11.super_class = (Class)KeyboardController;
  v2 = [(KeyboardController *)&v11 init];
  if (v2)
  {
...
void __26__KeyboardController_init__block_invoke()
{
...
uint64_t __26__KeyboardController_init__block_invoke_2()
{
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)KeyboardController;
...
- (id)readPreferenceValue:(id)a3
{
  ...
  else
  {
    if (!objc_msgSend((id)objc_msgSend(a3, "propertyForKey:", v5), "isEqualToString:", @"KanaLeftToRight"))
    {
      v11.receiver = self;
      v11.super_class = (Class)KeyboardController;
      return [(KeyboardController *)&v11 readPreferenceValue:a3];
    }
...
uint64_t __42__KeyboardController_readPreferenceValue___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
...
uint64_t __42__KeyboardController_readPreferenceValue___block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
...
- (void)setKeyboardPreferenceValue:(id)a3 forSpecifier:(id)a4
{
  ...
  {
    int v15 = [(KeyboardController *)self containsSpecifier:[(KeyboardController *)self deleteWordSpecifier]];
    if (![a3 BOOLValue] || (v15 & 1) != 0)
    {
      if (([a3 BOOLValue] & 1) == 0 && ((v15 ^ 1) & 1) == 0)
      {
        -[KeyboardController setDeleteWordSpecifierIndex:](self, "setDeleteWordSpecifierIndex:", objc_msgSend(-[KeyboardController specifiers](self, "specifiers"), "indexOfObject:", -[KeyboardController deleteWordSpecifier](self, "deleteWordSpecifier")));
    ...
    else
    {
      ...
      unint64_t v16 = [(KeyboardController *)self deleteWordSpecifierIndex];
      unint64_t v17 = objc_msgSend(-[KeyboardController specifiers](self, "specifiers"), "count");
      uint64_t v18 = [(KeyboardController *)self deleteWordSpecifier];
      if (v16 >= v17) {
  ...
  {
    int v19 = [(KeyboardController *)self containsSpecifier:[(KeyboardController *)self inlineCompletionSpecifier]];
    if (![a3 BOOLValue] || (v19 & 1) != 0)
    {
      if (([a3 BOOLValue] & 1) == 0 && ((v19 ^ 1) & 1) == 0)
      {
        -[KeyboardController setInlineCompletionSpecifierIndex:](self, "setInlineCompletionSpecifierIndex:", objc_msgSend(-[KeyboardController specifiers](self, "specifiers"), "indexOfObject:", -[KeyboardController inlineCompletionSpecifier](self, "inlineCompletionSpecifier")));
    ...
    else
    {
      ...
      unint64_t v20 = [(KeyboardController *)self inlineCompletionSpecifierIndex];
      unint64_t v21 = objc_msgSend(-[KeyboardController specifiers](self, "specifiers"), "count");
      uint64_t v22 = [(KeyboardController *)self inlineCompletionSpecifier];
      if (v20 >= v21) {
...
- (id)readKeyboardAllowPaddlePreferenceValue:(id)a3
{
  [a3 propertyForKey:*MEMORY[0x263F60170]];
...
- (void)setAutocorrectionPreferenceValue:(id)a3 forSpecifier:(id)a4
{
  if (![(KeyboardController *)self feedbackFeatureEnabled]
...
- (BOOL)feedbackFeatureEnabled
{
  if (feedbackFeatureEnabled_once_token != -1) {
    dispatch_once(&feedbackFeatureEnabled_once_token, &__block_literal_global_219);
  }
  ...
  if (IXACanLogMessageAtLevel())
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG)) {
      [(KeyboardController *)v2 feedbackFeatureEnabled];
    }
  }
  return v2;
}

uint64_t __44__KeyboardController_feedbackFeatureEnabled__block_invoke()
{
...
- (void)showDictationEnableDialogForSpecifier:(id)a3
{
  ...
  uint64_t v7 = [v5 localizedStringForKey:v6 value:&stru_26E29DC78 table:@"Keyboard"];
  ...
  uint64_t v9 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v8, &stru_26E29DC78, @"Keyboard");
  uint64_t v10 = *MEMORY[0x263F60018];
  uint64_t v11 = *MEMORY[0x263F60010];
  uint64_t v12 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_ENABLE_OK", &stru_26E29DC78, @"Keyboard");
  objc_msgSend(a3, "setupWithDictionary:", objc_msgSend(v14, "dictionaryWithObjectsAndKeys:", v9, v10, v15, v11, v12, *MEMORY[0x263F60008], objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_ENABLE_CANCEL", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F5FFF8], 0));
  uint64_t v13 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F1C5C0], "currentDevice"), "sf_isiPad");

  [(KeyboardController *)self showConfirmationViewForSpecifier:a3 useAlert:v13 swapAlertButtons:0];
}
...
- (void)showDictationDisabledDialogForSpecifier:(id)a3
{
  ...
  uint64_t v14 = [v5 localizedStringForKey:v6 value:&stru_26E29DC78 table:@"Keyboard"];
  ...
  uint64_t v8 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v7, &stru_26E29DC78, @"Keyboard");
  uint64_t v9 = *MEMORY[0x263F60018];
  uint64_t v10 = *MEMORY[0x263F60010];
  uint64_t v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_DISABLE_OK", &stru_26E29DC78, @"Keyboard");
  objc_msgSend(a3, "setupWithDictionary:", objc_msgSend(v13, "dictionaryWithObjectsAndKeys:", v8, v9, v14, v10, v11, *MEMORY[0x263F60008], objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_DISABLE_CANCEL", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F5FFF8], 0));
...
- (void)dictationEnabledConfirmed:(id)a3
{
  ...
  uint64_t v8 = [(KeyboardController *)self dictationAutoPunctuationSpecifier];
  if (v8) {
    BOOL v3 = v8;
  }
  if ([(KeyboardController *)self dictationLanguageSpecifier])
  {
    ...
    BOOL v3 = [(KeyboardController *)self dictationLanguageSpecifier];
  }
...
- (id)shuangpinType:(id)a3
{
  BOOL v3 = objc_msgSend(MEMORY[0x263F7E6C8], "sharedPreferencesController", a3);
...
+ (id)localizedStringForGeneralKeyboardSpecifier
{
  ...
  if (!localizedStringForGeneralKeyboardSpecifier_sKeyboardLocalizedString)
  {
    ...
    {
      id result = +[KeyboardController localizedStringForKeyboardController];
    }
...
- (void)emitNavigationEventForRootController
{
  ...
  id v5 = +[KeyboardController localizedStringForKeyboardController];
  v6[0] = v4;
  -[KeyboardController pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:](self, "pe_emitNavigationEventForSystemSettingsWithGraphicIconIdentifier:title:localizedNavigationComponents:deepLink:", @"com.apple.graphic-icon.keyboard", v5, [MEMORY[0x263EFF8C0] arrayWithObjects:v6 count:1], v3);
}
...
+ (void)emitNavigationEventForSpecifier:(id)a3 viewController:(id)a4
{
  ...
  if ([v6 isSubclassOfClass:objc_opt_class()])
  {
    ...
    if (v7)
    {
      ...
      {
        uint64_t v12 = v11;
        id v13 = +[KeyboardController localizedStringForGeneralKeyboardSpecifier];
...
- (void)viewDidAppear:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)KeyboardController;
  [(KeyboardController *)&v4 viewDidAppear:a3];
...
- (void)preferencesDidChange:(id)a3
{
  ...
  block[1] = 3221225472;
  block[2] = __43__KeyboardController_preferencesDidChange___block_invoke;
  block[3] = &unk_264A00E58;
  block[4] = self;
  dispatch_async(MEMORY[0x263EF83A0], block);
}

void __43__KeyboardController_preferencesDidChange___block_invoke(uint64_t a1)
{
  ...
  if (!*(unsigned char *)(v1 + 1409))
  {
    *(unsigned char *)(v1 + 1409) = 1;
    ...
    block[0] = MEMORY[0x263EF8330];
    block[1] = 3221225472;
    block[2] = __43__KeyboardController_preferencesDidChange___block_invoke_2;
    block[3] = &unk_264A00E58;
    block[4] = *(void *)(a1 + 32);
...
uint64_t __43__KeyboardController_preferencesDidChange___block_invoke_2(uint64_t a1)
{
...
- (void)managedKeyboardSettingsDidChange
{
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
  block[2] = __54__KeyboardController_managedKeyboardSettingsDidChange__block_invoke;
  block[3] = &unk_264A00E58;
  block[4] = self;
  dispatch_async(MEMORY[0x263EF83A0], block);
}

uint64_t __54__KeyboardController_managedKeyboardSettingsDidChange__block_invoke(uint64_t a1)
{
  char v2 = *(void **)(a1 + 32);
...
- (void)movePeriodShortcutPreferenceToEndAndAddFooterTextForGroup:(id)a3
{
  -[KeyboardController moveCharacterPreviewPreferenceToEndForGroup:](self, "moveCharacterPreviewPreferenceToEndForGroup:");
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      objc_msgSend(v6, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"PERIOD_SHORTCUT_DESCRIPTION", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F600F8]);
      [a3 removeObject:v5];
      [a3 addObject:v5];
    }
  }
...
LABEL_3:
    ...
    while (1)
    {
      ...
      {
        if ([(id)MEMORY[0x230FB4830](v9) isEqualToString:@"Hans"]) {
          break;
        }
      }
      if (v6 == ++v8)
...
- (void)addFooterTextForDialectSpecifierForGroup:(id)a3
{
  ...
  if (v3)
  {
    uint64_t v4 = (void *)v3;
    uint64_t v5 = (void *)[MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    uint64_t v6 = [v5 localizedStringForKey:SFLocalizableWAPIStringKeyForKey() value:&stru_26E29DC78 table:@"Preferences_pinyin"];
...
- (void)moveSpaceConfirmationPreferenceToEndAndAddFooterTextForGroup:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (![v4 propertyForKey:*MEMORY[0x263F600F8]])
    {
      ...
      {
        uint64_t v8 = v7;
        objc_msgSend(v5, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"SPACE_CONFIRMATION_EXPLANATION", &stru_26E29DC78, @"Keyboard"), v6);
        [a3 removeObject:v8];
        [a3 addObject:v8];
      }
    }
...
- (void)moveEnableDictationPreferenceToEndAndAddFooterTextForGroup:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      {
        if ([v8 name]) {
          uint64_t v10 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_GROUP_TITLE", &stru_26E29DC78, @"Keyboard");
        }
        else {
          uint64_t v10 = 0;
        }
...
+ (void)localizeAndSortPreferencesArray:(id)a3
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((void *)&v8 + 1) + 8 * v7), "setName:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", objc_msgSend(*(id *)(*((void *)&v8 + 1) + 8 * v7), "name"), &stru_26E29DC78, @"Keyboard"));
        ++v7;
      }
      while (v5 != v7);
  ...
  [a3 sortedArrayUsingComparator:&__block_literal_global_380];
}

uint64_t __54__KeyboardController_localizeAndSortPreferencesArray___block_invoke(uint64_t a1, void *a2, void *a3)
{
...
+ (id)localizedDisplayNameForInputMode:(id)a3 forDictation:(BOOL)a4
{
  ...
  objc_msgSend((id)objc_msgSend(MEMORY[0x263F1C748], "sharedInputModeController"), "identifierIsValidSystemInputMode:", NormalizedIdentifier);
  return v5;
}
  ...
  if (v42)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v42; ++j)
      {
        ...
        v26 = (void *)[(KeyboardController *)self loadSpecifiersFromPlistName:*(void *)(*((void *)&v47 + 1) + 8 * j) target:self];
        long long v43 = 0u;
        long long v44 = 0u;
        long long v45 = 0u;
        long long v46 = 0u;
...
- (id)mergePreferences:(id)a3 inputModesToPreferences:(id)a4
{
  ...
  v22[1] = 3221225472;
  v22[2] = __63__KeyboardController_mergePreferences_inputModesToPreferences___block_invoke;
  v22[3] = &unk_264A00EA0;
  v22[4] = a3;
...
uint64_t __63__KeyboardController_mergePreferences_inputModesToPreferences___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  if ((unint64_t)[a2 count] > 3) {
    return 1;
  }
  id v7 = (void *)[MEMORY[0x263EFFA08] setWithArray:a2];
  int v8 = objc_msgSend(v7, "isEqualToSet:", objc_msgSend(MEMORY[0x263EFFA08], "setWithArray:", &unk_26E2A6CB8));
  if (v8) {
    return v8 ^ 1u;
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        v32[1] = 3221225472;
        v32[2] = __61__KeyboardController_groupPreferences_forMapping_inputModes___block_invoke;
        v32[3] = &unk_264A00EC8;
        v32[4] = v13;
  ...
  if (v16)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v17; ++j)
      {
        ...
        v27[1] = 3221225472;
        v27[2] = __61__KeyboardController_groupPreferences_forMapping_inputModes___block_invoke_2;
        v27[3] = &unk_264A00EF0;
        v27[4] = a5;
...
uint64_t __61__KeyboardController_groupPreferences_forMapping_inputModes___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  return [a3 containsObject:*(void *)(a1 + 32)];
}

int64_t __61__KeyboardController_groupPreferences_forMapping_inputModes___block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3)
{
  return +[KeyboardController compareUsingOrderInArray:*(void *)(a1 + 32) withFirst:a2 second:a3];
}
...
- (id)sortPreferencesKeysByInputModeOrderAndCount:(id)a3 inputModes:(id)a4
{
  ...
  v7[1] = 3221225472;
  void v7[2] = __77__KeyboardController_sortPreferencesKeysByInputModeOrderAndCount_inputModes___block_invoke;
  v7[3] = &unk_264A00F18;
  v7[4] = a4;
  return (id)[v5 sortedArrayUsingComparator:v7];
}

int64_t __77__KeyboardController_sortPreferencesKeysByInputModeOrderAndCount_inputModes___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6 && v6 == v9)
  {
    ...
    return +[KeyboardController compareUsingOrderInArray:v10 withFirst:v11 second:v12];
  }
  return result;
}
    ...
    do
    {
      ...
      do
      {
        ...
        if (([a5 containsObject:TIInputModeGetBaseLanguage()]
           ...
           || (id v14 = +[KeyboardController localizedDisplayNameForInputMode:forDictation:](KeyboardController, "localizedDisplayNameForInputMode:forDictation:", v13, v6)) != 0)&& ([v8 containsObject:v14] & 1) == 0)
        {
          [v8 addObject:v14];
        }
        ++v12;
...
- (id)loadAllKeyboardPreferences
{
  ...
  uint64_t v3 = [(KeyboardController *)self loadSpecifiersFromPlistName:@"Preferences_base" target:self];
  if (!v3) {
    return 0;
  }
  uint64_t v4 = v3;
  uint64_t v5 = [MEMORY[0x263EFF9A0] dictionary];
  id v6 = [(KeyboardController *)self addAllPreferencesToArray:v4 mapPreferenceToInputMode:v5];
  id v7 = [(KeyboardController *)self groupPreferences:v4 forMapping:v5 inputModes:v6];
  if (!objc_msgSend((id)objc_msgSend(v7, "allKeys"), "count")) {
    return 0;
  }
  id v8 = [(KeyboardController *)self sortPreferencesKeysByInputModeOrderAndCount:v7 inputModes:v6];
  id v9 = [(KeyboardController *)self mergePreferences:v8 inputModesToPreferences:v7];
    ...
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        if (v10 >= 2)
        {
          if (v13)
          {
            id v18 = +[KeyboardController localizedListForInputModes:v16 forDictation:0 duplicatedBaseLanguages:0];
            goto LABEL_14;
          }
          if (v22 == v21)
          {
            id v18 = (id)objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"All Keyboards", &stru_26E29DC78, @"Keyboard");
LABEL_14:
            id v19 = v18;
          }
          else
...
- (void)addHardwareKeyboardAndShortcuts:(id)a3
{
  ...
  if (v5 && GSEventIsHardwareKeyboardAttached()) {
    objc_msgSend(a3, "ps_insertObject:afterObject:", -[KeyboardController hardwareKeyboardSpecifier](self, "hardwareKeyboardSpecifier"), v5);
  }
  uint64_t v6 = [a3 specifierForID:@"Hardware Keyboard"];
  id v7 = [(KeyboardController *)self openShortcutsSpecifiers];
  if (v6) {
    uint64_t v8 = v6;
  }
  else {
  ...
  {
    id v10 = [(KeyboardController *)self reachableKeyboardSpecifier];
  ...
  {
    id v11 = [(KeyboardController *)self proKeyboardSpecifier];
...
- (void)addDictationItems:(id)a3
{
  ...
  else
  {
    ...
    uint64_t v9 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Dictation Languages", &stru_26E29DC78, @"Dictation");
    -[KeyboardController setDictationLanguageSpecifier:](self, "setDictationLanguageSpecifier:", [v8 preferenceSpecifierNamed:v9 target:0 set:0 get:0 detail:objc_opt_class() cell:1 edit:0]);
    id v10 = [(KeyboardController *)self dictationLanguageSpecifier];
    [(PSSpecifier *)v10 setProperty:@"DictationSettings" forKey:*MEMORY[0x263F60138]];
    if (v6 && DictationIsEnabled()) {
      objc_msgSend(a3, "ps_insertObject:afterObject:", -[KeyboardController dictationLanguageSpecifier](self, "dictationLanguageSpecifier"), v6);
    }
  }
  if (_os_feature_enabled_impl())
  {
    -[KeyboardController setDictationAutoPunctuationSpecifier:](self, "setDictationAutoPunctuationSpecifier:", objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Auto-Punctuation", &stru_26E29DC78, @"Dictation"), self, sel_setAutoPunctuation_specifier_, sel_autoPunctuation_, 0, 6, 0));
    id v11 = [(KeyboardController *)self dictationAutoPunctuationSpecifier];
    ...
    {
      objc_msgSend(a3, "ps_insertObject:afterObject:", -[KeyboardController dictationAutoPunctuationSpecifier](self, "dictationAutoPunctuationSpecifier"), v6);
    }
  }
  if (v6 && DictationIsEnabled() && GSEventIsHardwareKeyboardAttached())
  {
    ...
    if ([(KeyboardController *)self dictationLanguageSpecifier])
    {
      uint64_t v12 = [(KeyboardController *)self dictationHardwareShortcutSpecifier];
      char v13 = [(KeyboardController *)self dictationLanguageSpecifier];
      id v14 = a3;
      uint64_t v15 = v12;
    }
    else
    {
      long long v16 = [(KeyboardController *)self dictationAutoPunctuationSpecifier];
      long long v17 = [(KeyboardController *)self dictationHardwareShortcutSpecifier];
      if (v16)
      {
        char v13 = [(KeyboardController *)self dictationAutoPunctuationSpecifier];
        id v14 = a3;
        uint64_t v15 = v17;
      }
      else
...
- (id)specifiers
{
  ...
  {
    uint64_t v4 = [(KeyboardController *)self loadSpecifiersFromPlistName:@"Preferences" target:self];
    if (v4)
    {
      uint64_t v5 = (void *)v4;
      id v6 = [(KeyboardController *)self loadAllKeyboardPreferences];
      if (v6) {
      ...
      [(KeyboardController *)self addHardwareKeyboardAndShortcuts:v5];
      [(KeyboardController *)self addEnabledExtensionSpecifiersToArray:v5];
      [(KeyboardController *)self addFooterTextForStickers:v5];
      [(KeyboardController *)self addDictationItems:v5];
      -[KeyboardController setDeleteWordSpecifier:](self, "setDeleteWordSpecifier:", [v5 specifierForID:@"KeyboardContinuousPathDeleteWholeWord"]);
      uint64_t v7 = [v5 specifierForID:@"KeyboardContinuousPathEnabled"];
      if (!v7
        || (objc_msgSend(-[KeyboardController readCPPreferenceValue:](self, "readCPPreferenceValue:", v7), "BOOLValue") & 1) == 0)
      {
        -[KeyboardController setDeleteWordSpecifierIndex:](self, "setDeleteWordSpecifierIndex:", objc_msgSend(v5, "indexOfObject:", -[KeyboardController deleteWordSpecifier](self, "deleteWordSpecifier")));
        objc_msgSend(v5, "removeObject:", -[KeyboardController deleteWordSpecifier](self, "deleteWordSpecifier"));
      }
      -[KeyboardController setInlineCompletionSpecifier:](self, "setInlineCompletionSpecifier:", [v5 specifierForID:@"KeyboardInlineCompletion"]);
      uint64_t v8 = [v5 specifierForID:@"KeyboardPrediction"];
      if (!v8
        || (objc_msgSend(-[KeyboardController readPredictionPreferenceValue:](self, "readPredictionPreferenceValue:", v8), "BOOLValue") & 1) == 0)
      {
        -[KeyboardController setInlineCompletionSpecifierIndex:](self, "setInlineCompletionSpecifierIndex:", objc_msgSend(v5, "indexOfObject:", -[KeyboardController inlineCompletionSpecifier](self, "inlineCompletionSpecifier")));
        objc_msgSend(v5, "removeObject:", -[KeyboardController inlineCompletionSpecifier](self, "inlineCompletionSpecifier"));
      }
      *(Class *)((char *)&self->super.super.super.super.super.super.isa + v3) = (Class)v5;
      -[KeyboardController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"KEYBOARDS", &stru_26E29DC78, @"Keyboard"));
...
- (void)addFooterTextForStickers:(id)a3
{
  ...
  if (v4 && v5 != 0x7FFFFFFFFFFFFFFFLL && v5)
  {
    ...
    objc_msgSend(v7, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"SHOW_STICKERS_DESCRIPTION", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F600F8]);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(a3, "addObjectsFromArray:", +[TIAddExtensionKeyboardController specifiersForExtensionInputMode:parentSpecifier:](TIAddExtensionKeyboardController, "specifiersForExtensionInputMode:parentSpecifier:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), -[KeyboardController specifier](self, "specifier")));
      }
      while (v7 != v9);
...
- (id)hardwareKeyboardSpecifier
{
  ...
  uint64_t v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Hardware Keyboard", &stru_26E29DC78, @"Keyboard");
  uint64_t v5 = (void *)[v3 preferenceSpecifierNamed:v4 target:self set:0 get:0 detail:objc_opt_class() cell:2 edit:0];
  [v5 setProperty:@"HardwareKeyboard" forKey:*MEMORY[0x263F60138]];
  return v5;
}
...
{
  uint64_t v3 = (void *)MEMORY[0x263F5FC40];
  uint64_t v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_SHORTCUT", &stru_26E29DC78, @"Dictation");
...
- (void)dictationShortcutSubtitle:(id)a3
{
  id v5 = +[TIDictationShortcutController attributedTitleForDictationShortcutValue:](TIDictationShortcutController, "attributedTitleForDictationShortcutValue:", (int)objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x263F7E6C8], "sharedPreferencesController"), "valueForPreferenceKey:", @"HWKeyboardDictationShortcut"), "intValue"));
  uint64_t v6 = objc_msgSend((id)-[KeyboardController cachedCellForSpecifier:](self, "cachedCellForSpecifier:", a3), "valueLabel");
...
- (void)hardwareKeyboardAvailabilityChanged
{
  if (GSEventIsHardwareKeyboardAttached())
  {
    ...
    uint64_t v3 = [(KeyboardController *)self specifierForID:@"Dictation"];
    if ([(KeyboardController *)self dictationLanguageSpecifier])
    {
      uint64_t v4 = [(KeyboardController *)self dictationLanguageSpecifier];
    }
    else
    {
      ...
      {
LABEL_15:
        uint64_t v6 = [(KeyboardController *)self dictationHardwareShortcutSpecifier];
        [(KeyboardController *)self insertSpecifier:v6 afterSpecifier:v3 animated:1];
        return;
      }
      uint64_t v4 = [(KeyboardController *)self dictationAutoPunctuationSpecifier];
    }
  ...
  if ([(KeyboardController *)self dictationHardwareShortcutSpecifier])
  {
    id v5 = [(KeyboardController *)self dictationHardwareShortcutSpecifier];
...
{
  v6.receiver = self;
  v6.super_class = (Class)KeyboardController;
  id v4 = -[KeyboardController selectSpecifier:](&v6, sel_selectSpecifier_);
...
- (id)reachableKeyboardSpecifier
{
  ...
  uint64_t v3 = (void *)MEMORY[0x263F5FC40];
  uint64_t v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"REACHABLE_KEYBOARD", &stru_26E29DC78, @"Keyboard");
  ...
  objc_msgSend(v5, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"REACHABLE_EXPLANATION", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F60280]);
  v7[0] = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"REACHABLE_OPTION_NONE", &stru_26E29DC78, @"Keyboard");
  v7[1] = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"REACHABLE_OPTION_LEFT", &stru_26E29DC78, @"Keyboard");
  void v7[2] = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"REACHABLE_OPTION_RIGHT", &stru_26E29DC78, @"Keyboard");
  objc_msgSend(v5, "setValues:titles:", &unk_26E2A6CD0, objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:count:", v7, 3));
  return v5;
}
...
- (BOOL)_supportsProKeyboard
{
  if (TIGetToggleFourOrFiveRowKeyboardValue_onceToken != -1) {
    dispatch_once(&TIGetToggleFourOrFiveRowKeyboardValue_onceToken, &__block_literal_global_724);
  }
...
- (NSArray)openShortcutsSpecifiers
{
  if (self->_openShortcutsSpecifiers
    || (uint64_t v3 = (void *)MEMORY[0x263F5FC40],
        uint64_t v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"USER_DICTIONARY", &stru_26E29DC78, @"Keyboard"), v5 = objc_msgSend(v3, "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", v4, 0, 0, 0, objc_opt_class(), 2, 0), objc_msgSend(v5, "setProperty:forKey:", @"USER_DICTIONARY", *MEMORY[0x263F60138]), v6 = objc_alloc(MEMORY[0x263EFF8C0]), result = (NSArray *)objc_msgSend(v6,
                              "initWithObjects:",
                              [MEMORY[0x263F5FC40] groupSpecifierWithName:&stru_26E29DC78],
                              v5,
                              0),
...
- (void)init
{
  v0 = (void *)[MEMORY[0x263F08690] currentHandler];
  objc_msgSend(v0, "handleFailureInFunction:file:lineNumber:description:", objc_msgSend(NSString, "stringWithUTF8String:", "NSString *getMCKeyboardSettingsChangedNotification(void)"), @"KeyboardController.m", 64, @"%s", dlerror());
  __break(1u);
}
...
- (void)feedbackFeatureEnabled
{
  ...
  *(_DWORD *)buf = 138412290;
  uint64_t v4 = [NSString stringWithFormat:@"%s Feedback %@: RC_SEED_BUILD: 0 enabled: %d", "-[KeyboardController feedbackFeatureEnabled]", @"KeyboardAutocorrection", a1 & 1];
  _os_log_debug_impl(&dword_22F249000, a2, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
}
