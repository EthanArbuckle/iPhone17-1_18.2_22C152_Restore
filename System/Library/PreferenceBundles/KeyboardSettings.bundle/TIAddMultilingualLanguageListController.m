...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  [(TIAddMultilingualLanguageListController *)&v7 viewWillAppear:a3];
  objc_super v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v5 = [v4 localizedStringForKey:@"MULTILINGUAL_DETAIL_ADD_LANGUAGE_TITLE" value:&stru_26E29DC78 table:@"Keyboard"];
  v6 = [(TIAddMultilingualLanguageListController *)self navigationItem];
  [v6 setTitle:v5];
}
...
- (NSArray)multilingualSet
{
  ...
  if (!multilingualSet)
  {
    id v4 = [(TIAddMultilingualLanguageListController *)self parentController];
...
LABEL_12:
  ...
  long long v21 = [(TIAddMultilingualLanguageListController *)self navigationController];
...
{
  id v4 = [(TIAddMultilingualLanguageListController *)self parentController];
  uint64_t v3 = [(TIAddMultilingualLanguageListController *)self multilingualSet];
