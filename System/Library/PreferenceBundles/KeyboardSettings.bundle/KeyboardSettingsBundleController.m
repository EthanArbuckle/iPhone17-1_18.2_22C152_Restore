...
- (id)keyboardsValue:(id)a3
{
  unint64_t v3 = +[TIKeyboardListController count];
  return (id)objc_msgSend(NSString, "stringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"KEYBOARD_COUNT", &stru_26E29DC78, @"Keyboard"), objc_msgSend(MEMORY[0x263F08A30], "localizedStringFromNumber:numberStyle:", objc_msgSend(NSNumber, "numberWithUnsignedInteger:", v3), 1));
}
...
- (id)specifiersWithSpecifier:(id)a3
{
  if (!self->_specifier)
  {
    ...
    if (objc_msgSend((id)objc_msgSend(a3, "propertyForKey:", *MEMORY[0x263F60138]), "isEqualToString:", @"General"))
    {
      ...
      uint64_t v7 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Keyboard", &stru_26E29DC78, @"Keyboard");
    ...
    else
    {
      if (objc_msgSend((id)objc_msgSend(a3, "propertyForKey:", v5), "isEqualToString:", @"Keyboard"))
      {
        ...
        uint64_t v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"KEYBOARDS", &stru_26E29DC78, @"Keyboard");
      ...
      else
      {
        ...
        if (!objc_msgSend(+[TIKeyboardExtensionController keyboardsForBundleID:](TIKeyboardExtensionController, "keyboardsForBundleID:", v13), "count"))return (id)MEMORY[0x263EFFA68]; {
        v14 = (void *)MEMORY[0x263F5FC40];
        }
        uint64_t v15 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"KEYBOARDS", &stru_26E29DC78, @"Keyboard");
