...
- (DictationFooterView)initWithSpecifier:(id)a3
{
  ...
  {
    v5 = (void *)[a3 target];
    uint64_t v6 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_ON_DEVICE_ABOUT_LINK", &stru_26E29DC78, @"Keyboard");
    uint64_t v7 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_ON_DEVICE_MANAGE_STORAGE_LINK", &stru_26E29DC78, @"Keyboard");
...
- (id)offlineExplanationSuffixTextWithOfflineDictationStatus:(id)a3 privacyLinkText:(id)a4
{
  ...
  objc_super v23 = __Block_byref_object_dispose__0;
  uint64_t v24 = 0;
  ...
  if ([(id)v20[5] count])
  {
    ...
    uint64_t v12 = [v7 localizedStringForKey:v8 value:&stru_26E29DC78 table:@"Keyboard"];
    uint64_t v10 = objc_msgSend(v6, "stringWithFormat:", v12, +[KeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", objc_msgSend((id)v20[5], "allObjects"), 1, 0));
    if (v10) {
      goto LABEL_9;
    }
  }
  else if (*((unsigned char *)v16 + 24))
  {
    ...
    uint64_t v10 = [v9 localizedStringForKey:SFLocalizableWAPIStringKeyForKey() value:&stru_26E29DC78 table:@"Keyboard"];
    if (v10)
    {
LABEL_9:
      uint64_t v11 = (void *)[NSString stringWithFormat:@"%@ %@", v10, a4];
      goto LABEL_10;
    }
  }
  uint64_t v11 = 0;
...
- (id)explanationSuffixTextWithOfflineDictationStatus:(id)a3 privacyLinkText:(id)a4 lowStorage:(BOOL)a5
{
    ...
    && objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x263F1C748], "sharedInputModeController"), "enabledDictationLanguages"), "containsObject:", objc_msgSend(v10, "firstObject")))
  {
    ...
    if (AFOfflineDictationStatusStringIsHighQualityModelSupported())
    {
      ...
      if (IsInstalled)
      {
        uint64_t v19 = [v18 localizedStringForKey:@"DICTATION_ON_DEVICE_PRIVATE_PROCESSING" value:&stru_26E29DC78 table:@"Keyboard"];
        ...
        id v31 = (id)[v20 localizedStringForKey:v21 value:&stru_26E29DC78 table:@"Keyboard"];
        id v32 = a4;
        uint64_t v30 = v19;
        v22 = @"%@ %@ %@";
        goto LABEL_28;
      }
      uint64_t v25 = [v18 localizedStringForKey:@"DICTATION_ON_DEVICE_SERVER_WHEN_NECESSARY" value:&stru_26E29DC78 table:@"Keyboard"];
      uint64_t v26 = v25;
      if (IsInstalling)
      {
        if (!a5)
...
LABEL_27:
          id v31 = a4;
          id v32 = (id)[v27 localizedStringForKey:v28 value:&stru_26E29DC78 table:@"Keyboard"];
          uint64_t v30 = v26;
          v22 = @"%@ %@\n\n%@";
          goto LABEL_28;
        }
...
LABEL_28:
    ...
    objc_super v23 = (void *)[NSString stringWithFormat:@"%@ %@", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"DICTATION_ON_DEVICE_SERVER", &stru_26E29DC78, @"Keyboard", a4, v32];
  }
  else
  {
    objc_super v23 = 0;
...
+ (id)dictationAutoPunctuationText
{
  ...
  if ((v22 & 1) == 0)
  {
    ...
    objc_super v23 = (__CFString *)objc_msgSend(v24, "stringWithFormat:", objc_msgSend(v25, "localizedStringForKey:value:table:", v26, &stru_26E29DC78, @"Keyboard"), +[KeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v28, 1, v4));
  }
  return v23;
}
