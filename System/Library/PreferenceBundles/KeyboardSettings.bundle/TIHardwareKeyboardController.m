...
+ (id)IOHIDKeyboardLanguageToCapsLockKeyLabel
{
  if (IOHIDKeyboardLanguageToCapsLockKeyLabel___onceToken != -1) {
    dispatch_once(&IOHIDKeyboardLanguageToCapsLockKeyLabel___onceToken, &__block_literal_global_6);
  }
  return (id)IOHIDKeyboardLanguageToCapsLockKeyLabel___map;
}

id __71__TIHardwareKeyboardController_IOHIDKeyboardLanguageToCapsLockKeyLabel__block_invoke()
{
...
{
  v10.receiver = self;
  v10.super_class = (Class)TIHardwareKeyboardController;
  v2 = [(TIHardwareKeyboardController *)&v10 init];
  if (v2)
  {
    ...
    v9[1] = 3221225472;
    v9[2] = __36__TIHardwareKeyboardController_init__block_invoke;
    v9[3] = &unk_264A01280;
    v9[4] = v2;
    [(KeyboardBrightnessClient *)v4 registerNotificationForKeys:&unk_26E2A6DD8 keyboardID:v5 block:v9];
...
void __36__TIHardwareKeyboardController_init__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v4[0] = MEMORY[0x263EF8330];
  v4[1] = 3221225472;
  v4[2] = __36__TIHardwareKeyboardController_init__block_invoke_2;
  v4[3] = &unk_264A01258;
...
uint64_t __36__TIHardwareKeyboardController_init__block_invoke_2(uint64_t a1)
{
  objc_opt_class();
...
- (void)dealloc
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)TIHardwareKeyboardController;
  [(TIHardwareKeyboardController *)&v6 dealloc];
}
...
- (id)specifiers
{
  ...
  if (!result)
  {
    uint64_t v5 = [(TIHardwareKeyboardController *)self title];
    *(Class *)((char *)&self->super.super.super.super.super.isa + v3) = (Class)[(TIHardwareKeyboardController *)self newSpecifiers];
...
- (id)newSpecifiers
{
  ...
  objc_msgSend(v16, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"PERIOD_SHORTCUT_DESCRIPTION_HWKB", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F600F8]);
  [v34 addObject:v16];
  v32 = v4;
  id v17 = [(TIHardwareKeyboardController *)v4 separateHWKeyboardSpecifiers];
  long long v39 = 0u;
  long long v40 = 0u;
  long long v41 = 0u;
  long long v42 = 0u;
  ...
  if (v18)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v19; ++j)
      {
        ...
        objc_msgSend(*(id *)(*((void *)&v39 + 1) + 8 * j), "setName:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", objc_msgSend(*(id *)(*((void *)&v39 + 1) + 8 * j), "name"), &stru_26E29DC78, @"Keyboard"));
      }
  ...
  if ([v30 count])
  {
    ...
    objc_msgSend(v23, "setName:", +[KeyboardController localizedListForInputModes:forDictation:duplicatedBaseLanguages:](KeyboardController, "localizedListForInputModes:forDictation:duplicatedBaseLanguages:", v30, 0, 0));
    [v34 addObject:v23];
    v24 = (void *)[(TIHardwareKeyboardController *)v32 loadSpecifiersFromPlistName:@"Preferences_HWLiveConversion" target:v32];
    long long v35 = 0u;
    long long v36 = 0u;
    long long v37 = 0u;
    long long v38 = 0u;
    ...
    if (v25)
    {
      ...
      do
      {
        for (uint64_t k = 0; k != v26; ++k)
        {
          ...
          objc_msgSend(*(id *)(*((void *)&v35 + 1) + 8 * k), "setName:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", objc_msgSend(*(id *)(*((void *)&v35 + 1) + 8 * k), "name"), &stru_26E29DC78, @"Keyboard"));
        }
  ...
  if ([(TIHardwareKeyboardController *)v32 shouldShowGlobeKeyPreference]) {
    objc_msgSend(v22, "addObjectsFromArray:", -[TIHardwareKeyboardController globeAsEmojiSpecifiers](v32, "globeAsEmojiSpecifiers"));
  }
  objc_msgSend(v22, "addObjectsFromArray:", -[TIHardwareKeyboardController capsLockSwitchSpecifiersFromModes:](v32, "capsLockSwitchSpecifiersFromModes:", v33));
  objc_msgSend(v22, "addObjectsFromArray:", -[TIHardwareKeyboardController keyboardBrightnessSpecifiers](v32, "keyboardBrightnessSpecifiers"));
  objc_msgSend(v22, "addObjectsFromArray:", -[TIHardwareKeyboardController modifierRemapSpecifiers](v32, "modifierRemapSpecifiers"));
  ...
  {
    objc_msgSend(v22, "addObjectsFromArray:", -[TIHardwareKeyboardController keyboardTypeRemapSpecifiers](v32, "keyboardTypeRemapSpecifiers"));
  }
  return v22;
}
...
- (id)capsLockSwitchSpecifiersFromModes:(id)a3
{
  ...
  long long v37 = 0u;
  long long v38 = 0u;
  uint64_t v6 = [a3 countByEnumeratingWithState:&v35 objects:v40 count:16];
  if (v6)
  {
    uint64_t v7 = v6;
    uint64_t v8 = 0;
    ...
    do
    {
      ...
      uint64_t v7 = [a3 countByEnumeratingWithState:&v35 objects:v40 count:16];
    }
    while (v7);
    if (v9 && v8)
    {
      ...
      {
        v14 = objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "IOHIDKeyboardLanguageToCapsLockKeyLabel"), "objectForKey:", HardwareKeyboardLanguage);
      }
      else
      {
        v14 = 0;
      }
      v15 = (void *)[MEMORY[0x263F5FC40] groupSpecifierWithID:@"HWKeyboardCapsLockSwitch"];
      if (v9 >= 2) {
        uint64_t v16 = 2;
      }
      else {
      ...
      uint64_t v18 = (void *)[MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
      if (v17)
      {
        uint64_t v19 = [v18 localizedStringForKey:@"LANGUAGE_SWITCH_LATIN_TITLE" value:&stru_26E29DC78 table:@"Keyboard"];
        uint64_t v20 = objc_msgSend(NSString, "stringWithFormat:", v19, v14);
        uint64_t v21 = [(id)objc_msgSend(MEMORY[0x263F086E0] bundleForClass:objc_opt_class()), "localizedStringForKey:value:table:", objc_msgSend(NSString, "stringWithFormat:", @"LANGUAGE_SWITCH_LATIN_DESCRIPTION_%lu", v16), &stru_26E29DC78, @"Keyboard"];
        if (v16 == 1)
        {
          [0 hasPrefix:@"%2$@"];
          uint64_t v22 = objc_msgSend(NSString, "stringWithFormat:", v21, v14, TUIKeyboardDisplayNameFromIdentifierForContext());
        }
        else
        {
          uint64_t v22 = objc_msgSend(NSString, "stringWithFormat:", v21, v14, v30);
        }
        uint64_t v23 = v22;
      }
      else
      {
        uint64_t v20 = [v18 localizedStringForKey:@"CAPS_LOCK_LATIN_TITLE" value:&stru_26E29DC78 table:@"Keyboard"];
        uint64_t v23 = [(id)objc_msgSend(MEMORY[0x263F086E0] bundleForClass:objc_opt_class()), "localizedStringForKey:value:table:", objc_msgSend(NSString, "stringWithFormat:", @"CAPS_LOCK_LATIN_DESCRIPTION_%lu", v16), &stru_26E29DC78, @"Keyboard"];
        if (v16 == 1)
        {
          [0 hasPrefix:@"%@"];
          uint64_t v23 = objc_msgSend(NSString, "stringWithFormat:", v23, TUIKeyboardDisplayNameFromIdentifierForContext());
        }
      }
      [v15 setProperty:v23 forKey:*MEMORY[0x263F600F8]];
      [v5 addObject:v15];
      v24 = (void *)[(TIHardwareKeyboardController *)self loadSpecifiersFromPlistName:@"Preferences_HWCapsLock" target:self];
      long long v31 = 0u;
      long long v32 = 0u;
      long long v33 = 0u;
      long long v34 = 0u;
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)TIHardwareKeyboardController;
  [(TIHardwareKeyboardController *)&v16 viewWillAppear:a3];
  long long v14 = 0u;
  long long v15 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
  id v4 = [(TIHardwareKeyboardController *)self specifiers];
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        if (objc_msgSend((id)objc_msgSend(v10, "identifier"), "isEqualToString:", @"Keyboard Type.0"))-[TIHardwareKeyboardController reloadSpecifier:](self, "reloadSpecifier:", v10); {
      }
        }
...
{
  v4.receiver = self;
  v4.super_class = (Class)TIHardwareKeyboardController;
  [(TIHardwareKeyboardController *)&v4 viewWillDisappear:a3];
  [(TIHardwareKeyboardController *)self suspendIdleDimming:0];
}

- (void)appWillEnterForeground:(id)a3
{
  [(TIHardwareKeyboardController *)self reloadSpecifiers];
...
- (id)separateHWKeyboardSpecifiers
{
  return (id)[(TIHardwareKeyboardController *)self loadSpecifiersFromPlistName:@"Preferences_HWKeyboard" target:self];
}
...
- (id)readRomanCapsLockPreferenceValue:(id)a3
{
  ...
  uint64_t v4 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F1C738], "sharedInstance", a3), "isCapsLockSwitchEnabled");
...
- (id)keyboardBrightnessSpecifiers
{
  ...
  {
    uint64_t v4 = objc_msgSend(MEMORY[0x263F5FC40], "groupSpecifierWithID:name:", @"Keyboard Brightness Group", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Keyboard Brightness", &stru_26E29DC78, @"Keyboard"));
    objc_msgSend(v4, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"KEYBOARD_BRIGHTNESS_DESCRIPTION", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F600F8]);
    [v3 addObject:v4];
    uint64_t v5 = objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Keyboard Brightness", &stru_26E29DC78, @"Keyboard"), self, sel_setBrightness_specifier_, sel_getBrightness_, 0, 5, 0);
    ...
    [v5 setObject:&unk_26E2A7288 forKeyedSubscript:*MEMORY[0x263F60038]];
    [v5 setObject:&unk_26E2A7298 forKeyedSubscript:*MEMORY[0x263F60030]];
...
- (void)setBrightness:(id)a3 specifier:(id)a4
{
  BOOL v6 = [(TIHardwareKeyboardController *)self isTrackingBrightnessSlider];
...
- (BOOL)isTrackingBrightnessSlider
{
  v2 = (void *)[(TIHardwareKeyboardController *)self specifierForID:@"Keyboard Brightness"];
...
- (id)globeKeyPreference:(id)a3
{
  ...
  if (v5) {
    ...
    uint64_t v6 = [(TIHardwareKeyboardController *)self defaultValueForGlobeAsEmojiKey];
  }
  uint64_t v7 = v6;
...
- (id)modifierRemapSpecifiers
{
  ...
  uint64_t v5 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MODIFIER_KEYS", &stru_26E29DC78, @"Keyboard");
...
- (id)keyboardTypeRemapSpecifiers
{
  ...
  [v3 addObject:v4];
  uint64_t v5 = (void *)MEMORY[0x263F5FC40];
  uint64_t v6 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"Keyboard Type", &stru_26E29DC78, @"Keyboard");
  ...
  objc_msgSend(v4, "setProperty:forKey:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"KEYBOARD_TYPE_FOOTER_TEXT", &stru_26E29DC78, @"Keyboard"), *MEMORY[0x263F600F8]);
  [v3 addObject:v7];
  return v3;
}
...
- (void)hardwareKeyboardAvailabilityChanged
{
  if (GSEventIsHardwareKeyboardAttached())
  {
    ...
    if (![(TIHardwareKeyboardController *)self specifierForID:@"Keyboard Type"]
      && ((BKSHIDKeyboardWantsStandardTypeOverride() & 1) != 0
       || CFPreferencesGetAppBooleanValue(@"KeyboardTypeCustomization", @"com.apple.keyboard.preferences", 0)))
    {
      id v3 = [(TIHardwareKeyboardController *)self keyboardTypeRemapSpecifiers];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  v16.receiver = self;
  v16.super_class = (Class)TIHardwareKeyboardController;
  id v6 = -[TIHardwareKeyboardController tableView:cellForRowAtIndexPath:](&v16, sel_tableView_cellForRowAtIndexPath_, a3);
  uint64_t v7 = (void *)[(TIHardwareKeyboardController *)self specifierAtIndexPath:a4];
  ...
  if ([v8 isEqualToString:*MEMORY[0x263F7E750]])
  {
    ...
    if (v10 != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      objc_msgSend(v14, "replaceCharactersInRange:withAttributedString:", v12, v13, +[TIKeyboardListController attributedStringForSymbolName:](TIKeyboardListController, "attributedStringForSymbolName:", @"globe"));
...
- (void)tableView:(id)a3 willDisplayFooterView:(id)a4 forSection:(int64_t)a5
{
  ...
  if (v6)
  {
    ...
    if (v7 != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      objc_msgSend(v11, "replaceCharactersInRange:withAttributedString:", v9, v10, +[TIKeyboardListController attributedStringForSymbolName:](TIKeyboardListController, "attributedStringForSymbolName:", @"globe"));
