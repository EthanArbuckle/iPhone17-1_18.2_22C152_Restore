...
{
  v34.receiver = self;
  v34.super_class = (Class)CPSReportProblemDetailTextViewTableViewCell;
  ...
  if (v4)
  {
    ...
    -[UITextView setTextContainerInset:](v4->_textView, "setTextContainerInset:", 10.0, 10.0, 10.0, 10.0);
    v7 = +[UIFont preferredFontForTextStyle:UIFontTextStyleBody];
    [(UITextView *)v4->_textView setFont:v7];

    v33 = _CPSLocalizedString();
    id v8 = [objc_alloc((Class)NSAttributedString) initWithString:v33];
    ...
    v18 = objc_msgSend(v16, "cps_setPriority:", v17);
    v35[4] = v18;
