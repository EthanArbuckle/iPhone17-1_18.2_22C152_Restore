...
{
  v17.receiver = self;
  v17.super_class = (Class)CSSyncDurationsController;
  [(CSSyncDurationsController *)&v17 viewDidAppear:a3];
  ...
  v8 = [v7 bundleURL];
  id v9 = [v5 initWithKey:@"Sync Specifier Name" table:@"MobileCalSettings" locale:v6 bundleURL:v8];
...
{
  v5.receiver = self;
  v5.super_class = (Class)CSSyncDurationsController;
  [(CSSyncDurationsController *)&v5 viewDidDisappear:a3];
