...
{
  v21.receiver = self;
  v21.super_class = (Class)CSDefaultAllDayEventAlarmsController;
  ...
  v7 = [v6 bundleURL];
  id v8 = [v4 initWithKey:@"All-Day Events" table:@"MobileCalSettings" locale:v5 bundleURL:v7];
...
{
  v4.receiver = self;
  v4.super_class = (Class)CSDefaultAllDayEventAlarmsController;
