...
- (UIImageView)linkArrowImageView;
- (UILabel)titleLabel;
- (void)commonInit;
- (void)setLinkArrowImageView:(id)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)ENUIRegionFAQWebsiteCell;
...
- (void)commonInit
{
  ...
  id v25 = [v20 initWithArrangedSubviews:v24];
...
- (UIImageView)linkArrowImageView
{
  return self->_linkArrowImageView;
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_linkArrowImageView, 0);
