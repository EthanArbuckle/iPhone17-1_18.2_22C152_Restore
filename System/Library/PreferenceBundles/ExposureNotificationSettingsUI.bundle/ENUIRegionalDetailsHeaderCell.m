...
- (UITextView)subtitleText;
- (_TtC28HealthExposureNotificationUI20OnboardingHeaderView)headerView;
- (void)commonInit;
...
- (void)commonInit
{
  ...
  id v5 = [v4 supportsFeatures:32];
  id v6 = objc_alloc((Class)_TtC28HealthExposureNotificationUI20OnboardingHeaderView);
  v7 = [v4 header];
  id v8 = objc_msgSend(v6, "initWithHeader:insets:proxyDisabled:corners:", v7, v5, 0, 16.0, 16.0, 16.0, 16.0);
  ...
  double v107 = 0.0;
  double v108 = 0.0;
  BOOL v12 = [v11 getRed:&v110 green:&v109 blue:&v108 alpha:&v107]
     && vabdd_f64(v114, v110) <= 0.05
     && vabdd_f64(v113, v109) <= 0.05
     && vabdd_f64(v112, v108) <= 0.05
     && vabdd_f64(v111, v107) <= 0.05;
...
LABEL_12:
  ...
  uint64_t v20 = [v19 fontDescriptorWithDesign:UIFontDescriptorSystemDesignSerif];
  ...
  id v35 = [v34 countByEnumeratingWithState:&v103 objects:v119 count:16];
  if (v35)
  {
    id v36 = v35;
    ...
    do
    {
      for (i = 0; i != v36; i = (char *)i + 1)
      {
        ...
        v39 = *(void **)(*((void *)&v103 + 1) + 8 * i);
        [v39 setTranslatesAutoresizingMaskIntoConstraints:0];
        v40 = [(ENUIRegionalDetailsHeaderCell *)self contentView];
        [v40 addSubview:v39];
      }
      id v36 = [v34 countByEnumeratingWithState:&v103 objects:v119 count:16];
    }
    while (v36);
  }
