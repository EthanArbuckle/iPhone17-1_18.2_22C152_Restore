...
- (UILabel)agencyNameLabel;
- (UILabel)titleLabel;
- (UIStackView)headerStack;
- (UITextView)messageTextView;
- (void)refreshCellContentsWithSpecifier:(id)a3;
- (void)setAgencyNameLabel:(id)a3;
- (void)setContinueButton:(id)a3;
- (void)setHeaderStack:(id)a3;
...
{
  v8.receiver = self;
  v8.super_class = (Class)ENUIExposureDetailHeaderView;
...
- (void)setUp
{
  ...
  objc_super v8 = [(ENUIExposureDetailHeaderView *)self agencyNameLabel];
  [v8 setTextColor:v7];
  ...
  objc_msgSend(v21, "setTextContainerInset:", v18, 0.0, v20, 0.0);
  ...
  id v43 = [v38 initWithArrangedSubviews:v42];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  v7 = [v19 title];
  objc_super v8 = [(ENUIExposureDetailHeaderView *)self titleLabel];
  [v8 setText:v7];
  ...
  uint64_t v12 = [(ENUIExposureDetailHeaderView *)self learnMoreURL];
  if (!v12) {
    goto LABEL_4;
  }
  v13 = (void *)v12;
  ...
  unsigned int v16 = [v14 canOpenURL:v15];

  if (v16)
  {
    double v17 = [(ENUIExposureDetailHeaderView *)self headerStack];
    double v18 = [(ENUIExposureDetailHeaderView *)self continueButton];
...
- (void)tappedContinueButton:(id)a3
{
  uint64_t v4 = [(ENUIExposureDetailHeaderView *)self learnMoreURL];
  if (v4)
  {
    v5 = (void *)v4;
    v6 = +[UIApplication sharedApplication];
    v7 = [(ENUIExposureDetailHeaderView *)self learnMoreURL];
    unsigned int v8 = [v6 canOpenURL:v7];
