...
{
  v7.receiver = self;
  v7.super_class = (Class)CapsuleLabel;
  v3 = -[CapsuleLabel initWithFrame:](&v7, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
...
- (void)setUp
{
  ...
  objc_super v7 = [(CapsuleLabel *)self capsule];
...
{
  id v4 = a3;
  id v5 = [(CapsuleLabel *)self textLabel];
  [v5 setText:v4];
}
...
{
  id v4 = a3;
  id v5 = [(CapsuleLabel *)self capsule];
  ...
  {
    id v16 = [(CapsuleLabel *)self capsule];
    v14 = [v16 layer];
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_capsule, 0);
