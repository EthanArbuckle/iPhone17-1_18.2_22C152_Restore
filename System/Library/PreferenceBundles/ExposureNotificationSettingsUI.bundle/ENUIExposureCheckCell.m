...
{
  v7.receiver = self;
  v7.super_class = (Class)ENUIExposureCheckCell;
...
- (void)commonInit
{
  ...
  id v30 = [v25 initWithArrangedSubviews:v29];
  ...
  id v36 = [v32 initWithArrangedSubviews:v35];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    v17 = [v16 font];
    [v17 pointSize];
    double v18 = +[UIFont boldSystemFontOfSize:](UIFont, "boldSystemFontOfSize:");
  ...
  {
    id v30 = +[UIImage systemImageNamed:@"exclamationmark.circle.fill"];
    id v31 = [v30 imageWithRenderingMode:2];
    id v32 = [(ENUIExposureCheckCell *)self titleIconImageView];
    [v32 setImage:v31];

    uint64_t v29 = +[UIColor systemRedColor];
  }
  else
  {
    if (!v7)
    {
      ...
      id v25 = [(ENUIExposureCheckCell *)self titleIconImageView];
    ...
    uint64_t v29 = +[UIColor systemGreenColor];
  }
  v21 = (void *)v29;
