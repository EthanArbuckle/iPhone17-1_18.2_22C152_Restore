...
{
  v7.receiver = self;
  v7.super_class = (Class)ENUILoggingStatusCell;
...
- (void)commonInit
{
  ...
  id v38 = [v33 initWithArrangedSubviews:v37];
  ...
  id v44 = [v40 initWithArrangedSubviews:v43];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    objc_super v7 = +[UIImage systemImageNamed:@"circle.fill" withConfiguration:v6];
  ...
  double v17 = [v19 objectForKeyedSubscript:@"subtitleKey"];
