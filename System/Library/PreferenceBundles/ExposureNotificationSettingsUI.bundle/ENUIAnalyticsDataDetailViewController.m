...
{
  v49.receiver = self;
  v49.super_class = (Class)ENUIAnalyticsDataDetailViewController;
  ...
  id v48 = 0;
  uint64_t v7 = +[NSString stringWithContentsOfURL:v6 encoding:4 error:&v48];
  id v8 = v48;
  if (v8)
  {
    v9 = ENUILogForCategory();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      sub_1DEC8((uint64_t)v6, (uint64_t)v8, v9);
    }
  }
