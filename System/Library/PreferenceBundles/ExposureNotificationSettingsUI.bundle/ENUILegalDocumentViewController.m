...
{
  v49.receiver = self;
  v49.super_class = (Class)ENUILegalDocumentViewController;
  ...
  id v7 = objc_msgSend(objc_alloc((Class)UITextView), "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  ...
  objc_msgSend(v16, "setContentInset:", 20.0, 20.0, 20.0, 20.0);
