...
{
  v8.receiver = self;
  v8.super_class = (Class)ENUIRegionCell;
...
- (void)commonInit
{
  ...
  objc_super v8 = [(ENUIRegionCell *)self sectionLabel];
  [v8 setFont:v7];
  ...
  id v22 = [v17 initWithArrangedSubviews:v21];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  id v17 = [(ENUIRegionCell *)self regionCapsuleLabel];
  v18 = [v17 text];
  objc_msgSend(v16, "setHidden:", objc_msgSend(v18, "length") == 0);

  v19 = [(ENUIRegionCell *)self sectionLabel];
  v20 = [v4 objectForKeyedSubscript:PSValueKey];
  objc_msgSend(v19, "setHidden:", objc_msgSend(v20, "BOOLValue") ^ 1);

  v21 = (char *)[v4 cellType];
  [(ENUIRegionCell *)self setAccessoryType:v21 == (unsigned char *)&dword_0 + 1];
}
...
- (CapsuleLabel)regionCapsuleLabel
{
  return self->_regionCapsuleLabel;
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_regionCapsuleLabel, 0);
