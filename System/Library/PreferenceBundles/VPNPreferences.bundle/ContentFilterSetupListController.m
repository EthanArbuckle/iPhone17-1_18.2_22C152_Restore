...
- (void)appWillEnterForeground:(id)a3
{
  ...
  v8 = objc_msgSend(v6, "connectionWithServiceID:withGrade:", v7, -[ContentFilterSetupListController vpnGrade](self, "vpnGrade"));
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  [(ContentFilterSetupListController *)&v10 viewWillAppear:v3];
  objc_destroyWeak(&location);
}
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  [(ContentFilterSetupListController *)&v3 viewDidAppear:a3];
}
...
- (id)connection
{
  ...
  id v4 = [(ContentFilterSetupListController *)self serviceID];
  objc_super v5 = objc_msgSend(v3, "connectionWithServiceID:withGrade:", v4, -[ContentFilterSetupListController vpnGrade](self, "vpnGrade"));
...
- (id)statusForConnection:(id)a3
{
  uint64_t v3 = [(ContentFilterSetupListController *)self connection];
  id v4 = v3;
  if (v3)
  {
...
- (id)specifiers
{
  ...
  {
    uint64_t v3 = [(ContentFilterSetupListController *)self displayName];
    [(ContentFilterSetupListController *)v2 setTitle:v3];
    ...
    v59 = v4;
    [v4 addObject:v13];
    uint64_t v15 = [(ContentFilterSetupListController *)v2 includedBundleIDs];
    if (v15)
    {
      v16 = (void *)v15;
      v17 = [(ContentFilterSetupListController *)v2 includedBundleIDs];
      ...
      if (v18)
      {
        ...
        long long v62 = 0u;
        long long v63 = 0u;
        id obj = [(ContentFilterSetupListController *)v2 includedBundleIDs];
          ...
          do
          {
            for (uint64_t i = 0; i != v25; ++i)
            {
              ...
              if (v34)
              {
                ...
                v37 = [(ContentFilterSetupListController *)v24 includedBundleIDs];
  ...
  {
    v48 = [(ContentFilterSetupListController *)self navigationController];
