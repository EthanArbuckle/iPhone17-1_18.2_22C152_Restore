...
{
  v29.receiver = self;
  v29.super_class = (Class)PedestrianARSettingsFooterView;
...
- (double)preferredHeightForWidth:(double)a3
{
  ...
  -[PedestrianARSettingsFooterView systemLayoutSizeFittingSize:withHorizontalFittingPriority:verticalFittingPriority:](self, "systemLayoutSizeFittingSize:withHorizontalFittingPriority:verticalFittingPriority:", a3, UILayoutFittingCompressedSize.height, v3, v4);
  return v5;
}
