  ...
  else
  {
    ...
    if (v9 == (unsigned char *)&dword_4 + 1)
    {
      ...
      if (v12)
      {
        ...
        long long v20 = 0u;
        long long v21 = 0u;
        id v13 = [&off_7C400 countByEnumeratingWithState:&v20 objects:v24 count:16];
        if (v13)
        {
          id v14 = v13;
...
LABEL_6:
          ...
          {
            if (*(void *)v21 != v15) {
              objc_enumerationMutation(&off_7C400);
            }
            ...
            if (v14 == (id)++v16)
            {
              id v14 = [&off_7C400 countByEnumeratingWithState:&v20 objects:v24 count:16];
              if (v14) {
                goto LABEL_6;
              }
              break;
