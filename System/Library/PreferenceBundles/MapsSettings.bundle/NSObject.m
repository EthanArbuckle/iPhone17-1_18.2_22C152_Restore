...
{
  BOOL v5 = a3;
  uint64_t v7 = objc_getAssociatedObject(self, off_8A7D0);
  id v8 = (id)v7;
  if (v5)
  {
    if (!v7)
    {
      ...
      objc_setAssociatedObject(self, off_8A7D0, v8, (char *)&dword_0 + 1);
    }
    v9 = NSStringFromSelector(a4);
    [v8 addObject:v9];

    v10 = objc_getAssociatedObject(self, off_8A7C8);

    if (!v10)
    {
      objc_setAssociatedObject(self, off_8A7C8, &__kCFBooleanTrue, (char *)&dword_0 + 3);
...
- (BOOL)_maps_needsUpdateWithSelector:(SEL)a3
{
  v4 = objc_getAssociatedObject(self, off_8A7D0);
