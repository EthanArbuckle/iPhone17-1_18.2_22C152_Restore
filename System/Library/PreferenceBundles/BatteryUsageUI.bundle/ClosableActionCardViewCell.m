...
- (ClosableActionCardViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  id v8 = a5;
  v44.receiver = self;
  v44.super_class = (Class)ClosableActionCardViewCell;
  ...
  if (v9)
  {
    ...
    v15 = +[ClosableActionCardViewFactory createWithTitle:v10 subtitle:v11 actionTitle:v12 action:v13 close:v14];
...
- (UIView)cardView
{
  return (UIView *)objc_getProperty(self, a2, 120, 1);
}
...
- (UIViewController)child
{
  return (UIViewController *)objc_getProperty(self, a2, 128, 1);
}
