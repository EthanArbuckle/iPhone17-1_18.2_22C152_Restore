...
{
  v12.receiver = self;
  v12.super_class = (Class)CACGridOverlayMaxLevelController;
  id v6 = a4;
  v7 = [(CACGridOverlayMaxLevelController *)&v12 tableView:a3 cellForRowAtIndexPath:v6];
  v8 = -[CACGridOverlayMaxLevelController specifierAtIndexPath:](self, "specifierAtIndexPath:", v6, v12.receiver, v12.super_class);

  v9 = [v8 propertyForKey:@"GridOverlayMaxLevel"];
  v10 = +[CACPreferences sharedPreferences];
  objc_msgSend(v7, "setChecked:", objc_msgSend(v10, "gridOverlayMaxLevel") == objc_msgSend(v9, "integerValue"));
...
{
  v10.receiver = self;
  v10.super_class = (Class)CACGridOverlayMaxLevelController;
  id v6 = a4;
  [(CACGridOverlayMaxLevelController *)&v10 tableView:a3 didSelectRowAtIndexPath:v6];
  v7 = -[CACGridOverlayMaxLevelController specifierAtIndexPath:](self, "specifierAtIndexPath:", v6, v10.receiver, v10.super_class);
  v8 = [v7 propertyForKey:@"GridOverlayMaxLevel"];
  v9 = +[CACPreferences sharedPreferences];
  objc_msgSend(v9, "setGridOverlayMaxLevel:", objc_msgSend(v8, "integerValue"));
