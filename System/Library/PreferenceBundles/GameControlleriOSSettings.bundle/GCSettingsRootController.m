...
{
  v4.receiver = self;
  v4.super_class = (Class)GCSettingsRootController;
  [(GCSettingsRootController *)&v4 viewDidLoad];
  uint64_t v3 = +[SwiftUIViewFactory makeSwiftUIView];
...
- (void)displayContentController:(id)a3
{
  ...
  objc_super v6 = [(GCSettingsRootController *)self view];
  v7 = [v4 view];
  [v6 addSubview:v7];
