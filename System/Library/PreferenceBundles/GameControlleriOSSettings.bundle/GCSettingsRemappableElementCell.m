...
- (UIImageView)remappedElementView;
- (void)awakeFromNib;
- (void)setRemappedElementView:(id)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)GCSettingsRemappableElementCell;
...
- (void)setup
{
  ...
  objc_super v7 = self->_remappedElementView;
  ...
  v13 = [(GCSettingsRemappableElementCell *)self textLabel];
  }
  ...
  id v19 = [(GCSettingsRemappableElementCell *)self imageView];
  v16 = [v19 image];
  if (v16) {
    [(GCSettingsRemappableElementCell *)self imageView];
  }
  else {
  v17 = [(GCSettingsRemappableElementCell *)self textLabel];
  }
...
{
  v2.receiver = self;
  v2.super_class = (Class)GCSettingsRemappableElementCell;
...
{
  v4.receiver = self;
  v4.super_class = (Class)GCSettingsRemappableElementCell;
  [(GCSettingsRemappableElementCell *)&v4 setSelected:a3 animated:a4];
}

- (UIImageView)remappedElementView
{
  return self->_remappedElementView;
}
