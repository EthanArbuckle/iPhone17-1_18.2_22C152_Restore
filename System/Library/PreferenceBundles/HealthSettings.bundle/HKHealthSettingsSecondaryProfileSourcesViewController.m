...
- (HKHealthSettingsSecondaryProfileSourcesViewController)init
{
  ...
  v5 = [(HKHealthSettingsProfile *)v3 initWithHealthStore:v4];

  v8.receiver = self;
  v8.super_class = (Class)HKHealthSettingsSecondaryProfileSourcesViewController;
  v6 = [(HKHealthSettingsSecondaryProfileSourcesViewController *)&v8 initWithProfile:v5 usingInsetStyling:0];
