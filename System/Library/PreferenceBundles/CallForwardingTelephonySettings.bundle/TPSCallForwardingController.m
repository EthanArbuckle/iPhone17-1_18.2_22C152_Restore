...
- (TPSCallForwardingController)initWithSubscriptionContext:(id)a3
{
  id v5 = a3;
  v13.receiver = self;
  v13.super_class = (Class)TPSCallForwardingController;
  v6 = [(TPSCallForwardingController *)&v13 init];
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_subscriptionContext, a3);
    v8 = (TPSCarrierBundleController *)objc_alloc_init((Class)TPSCarrierBundleController);
    ...
    v10 = (TPSCallForwardingRequestController *)objc_alloc_init((Class)TPSCallForwardingRequestController);
...
- (void)updateServiceType:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2112;
    objc_super v13 = v9;
    _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEFAULT, "Transitioning call forwarding service from %@ to %@.", (uint8_t *)&v10, 0x16u);
  }
  if (v6 == 2)
  {
    if ((a3 | 2) == 3)
    {
      if ((char *)[(TPSCallForwardingController *)self unconditionalServiceState] == (char *)&dword_0 + 3)
      {
...
LABEL_16:
  ...
  if ((char *)[(TPSCallForwardingController *)self conditionalServiceState] == (char *)&dword_0 + 3)
  {
    [(TPSCallForwardingController *)self setPendingServiceType:a3];
...
- (BOOL)isConditionalServiceAvailable
{
  return (char *)[(TPSCallForwardingController *)self conditionalServiceState] != (char *)&dword_0 + 1;
}
...
- (NSArray)conditionalServiceRequests
{
  ...
  {
    id v4 = objc_alloc((Class)TPSCallForwardingRequest);
    int64_t v5 = [(TPSCallForwardingController *)self subscriptionContext];
    id v6 = [v4 initWithSubscriptionContext:v5 reason:1];
    id v7 = objc_alloc((Class)TPSCallForwardingRequest);
    v8 = [(TPSCallForwardingController *)self subscriptionContext];
    id v9 = [v7 initWithSubscriptionContext:v8 reason:2];
    v16[1] = v9;
    id v10 = objc_alloc((Class)TPSCallForwardingRequest);
    v11 = [(TPSCallForwardingController *)self subscriptionContext];
    id v12 = [v10 initWithSubscriptionContext:v11 reason:3];
    v16[2] = v12;
    objc_super v13 = +[NSArray arrayWithObjects:v16 count:3];
...
LABEL_17:
    ...
    if (v7)
    {
      id v4 = [(TPSCallForwardingController *)self conditionalServiceBusyValue];
      if ([v4 enabled])
      {
        int64_t v8 = 3;
      }
      ...
      {
        id v9 = [(TPSCallForwardingController *)self conditionalServiceUnansweredValue];
        if ([v9 enabled])
        {
          int64_t v8 = 3;
        }
        ...
        {
          id v10 = [(TPSCallForwardingController *)self conditionalServiceUnreachableValue];
          if ([v10 enabled]) {
            int64_t v8 = 3;
          }
          else {
...
- (NSString)conditionalServiceBusyPhoneNumber
{
  ...
  id v6 = TPSLocalizedPhoneNumberString();
...
- (void)setConditionalServiceBusyPhoneNumber:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v7 = TPSNormalizedPhoneNumberString();
    ...
    if (v9 | v10)
    {
      ...
      if (v10)
      {
        unsigned __int8 v12 = [(id)v9 isEqualToString:v10];
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        int v15 = 138412290;
        id v16 = v13;
        _os_log_impl(&dword_0, v14, OS_LOG_TYPE_DEFAULT, "Sending set conditional call forwarding service busy phone number request for value %@.", (uint8_t *)&v15, 0xCu);
      }
  ...
  if (v5)
  {
    ...
    if (v9 | v10)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        int v15 = 138412290;
        id v16 = v13;
        _os_log_impl(&dword_0, v14, OS_LOG_TYPE_DEFAULT, "Sending set conditional call forwarding service unanswered phone number request for value %@.", (uint8_t *)&v15, 0xCu);
      }
  ...
  if (v5)
  {
    ...
    if (v9 | v10)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        int v15 = 138412290;
        id v16 = v13;
        _os_log_impl(&dword_0, v14, OS_LOG_TYPE_DEFAULT, "Sending set conditional call forwarding service unreachable phone number request for value %@.", (uint8_t *)&v15, 0xCu);
      }
...
- (NSArray)unconditionalServiceRequests
{
  ...
  if (!unconditionalServiceRequests)
  {
    ...
    id v6 = [v4 initWithSubscriptionContext:v5 reason:0];
    id v10 = v6;
  ...
  if (v5)
  {
    ...
    if (v9 | v10)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        int v15 = 138412290;
        id v16 = v13;
        _os_log_impl(&dword_0, v14, OS_LOG_TYPE_DEFAULT, "Sending set unconditional call forwarding service phone number request for value %@.", (uint8_t *)&v15, 0xCu);
      }
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        unint64_t v9 = TPSCallForwardingLog();
...
- (void)sendServicesRequest
{
  uint64_t v3 = TPSCallForwardingLog();
...
- (void)sendSetAllServicesDisabledRequest
{
  if ([(TPSCallForwardingController *)self isConditionalServiceAvailable])
  {
    id v3 = objc_alloc_init((Class)CTCallForwardingValue);
    [v3 setClss:1];
    [v3 setEnabled:0];
    [v3 setReason:4];
  }
  ...
  {
    id v4 = [(TPSCallForwardingController *)self unconditionalServiceValue];
    id v3 = [v4 copy];

    [v3 setEnabled:0];
  }
  id v5 = TPSCallForwardingLog();
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    id v7 = v3;
    _os_log_impl(&dword_0, v5, OS_LOG_TYPE_DEFAULT, "Sending disable call forwarding services request for value %@.", (uint8_t *)&v6, 0xCu);
  }
...
- (void)sendSetUnconditionalServiceDisabledRequest
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    id v7 = v4;
    _os_log_impl(&dword_0, v5, OS_LOG_TYPE_DEFAULT, "Sending disable all unconditional call forwarding services request for value %@.", (uint8_t *)&v6, 0xCu);
  }
...
{
  id v4 = a3;
  id v5 = objc_alloc((Class)TPSSetCallForwardingRequest);
  int v6 = [(TPSCallForwardingController *)self subscriptionContext];
  id v8 = [v5 initWithSubscriptionContext:v6 value:v4];
...
- (void)sendEnableSetRequestForValue:(id)a3
{
  ...
  if (([v4 enabled] & 1) == 0)
  {
    ...
    if (v6)
    {
      id v7 = [v4 copy];
      [v7 setEnabled:1];
      id v8 = TPSCallForwardingLog();
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        int v9 = 138412290;
        id v10 = v7;
        _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Sending enable call forwarding service request for value %@.", (uint8_t *)&v9, 0xCu);
      }
...
- (void)requestController:(id)a3 didReceiveResponse:(id)a4
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&v28[14] = v5;
    id v7 = *(id *)&v28[4];
    _os_log_impl(&dword_0, v6, OS_LOG_TYPE_DEFAULT, "%@ received response %@.", v28, 0x16u);
  }
  id v8 = [v5 value];
  int v9 = v8;
  if (!v8) {
  ...
  {
    case 0u:
      id v10 = [(TPSCallForwardingController *)self unconditionalServiceValue];
      if (v10)
      {
        objc_msgSend(v10, "setEnabled:", objc_msgSend(v9, "enabled"));
        long long v11 = [v9 saveNumber];
        [v10 setSaveNumber:v11];

        if ([v10 enabled])
        {
          long long v12 = TPSCallForwardingLog();
          if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)v28 = 138412290;
            *(void *)&v28[4] = v10;
            _os_log_impl(&dword_0, v12, OS_LOG_TYPE_DEFAULT, "Setting service type to Unconditional for value %@.", v28, 0xCu);
          }

          long long v13 = &dword_0 + 2;
        }
        else if ([(TPSCallForwardingController *)self isConditionalServiceAvailable])
        {
          ...
          {
            *(_WORD *)v28 = 0;
            _os_log_impl(&dword_0, v17, OS_LOG_TYPE_DEFAULT, "Conditional service is available; settings service type to Conditional.",
              v28,
              2u);
          }

          long long v13 = &dword_0 + 3;
        }
        else
        {
          long long v13 = &dword_0 + 1;
        }
      }
      else
      {
    ...
    case 4u:
      ...
      objc_msgSend(v10, "setEnabled:", objc_msgSend(v9, "enabled"));
      long long v13 = [(TPSCallForwardingController *)self pendingServiceType];
      break;
    default:
      goto LABEL_21;
  }
...
LABEL_21:
    ...
    else
    {
      ...
      if (v18 == 3)
      {
        v20 = TPSCallForwardingLog();
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
        {
          *(_WORD *)v28 = 0;
          _os_log_impl(&dword_0, v20, OS_LOG_TYPE_DEFAULT, "Conditional service is enabled; setting service type to Conditional.",
            v28,
            2u);
        }
        long long v13 = &dword_0 + 3;
      ...
      else
      {
        ...
        if (v22 <= 1 && v21 == 2)
        {
          ...
          {
            *(_WORD *)v28 = 0;
            _os_log_impl(&dword_0, v20, OS_LOG_TYPE_DEFAULT, "Conditional service is unavailable/disabled and Unconditional service is disabled; setting service type to None.",
              v28,
              2u);
          }
          long long v13 = &dword_0 + 1;
        ...
        else if (v23)
        {
          *(_WORD *)v28 = 0;
          long long v13 = &dword_0 + 2;
          _os_log_impl(&dword_0, v20, OS_LOG_TYPE_DEFAULT, "Unconditional service is enabled; setting service type to Unconditional.",
            v28,
            2u);
        }
        else
  ...
  if ((void *)[(TPSCallForwardingController *)self currentServiceType] == v13)
  {
