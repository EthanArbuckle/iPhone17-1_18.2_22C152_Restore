...
{
  v3.receiver = self;
  v3.super_class = (Class)TPSCallingLineIdRestrictionBundleController;
  if ([(TPSCallingLineIdRestrictionBundleController *)&v3 isHidden]) {
    return 1;
  }
  else {
...
- (id)supportedSubscriptions
{
  ...
  {
    v21.receiver = self;
    v21.super_class = (Class)TPSCallingLineIdRestrictionBundleController;
      ...
      do
      {
        for (i = 0; i != v8; i = (char *)i + 1)
        {
          ...
          if ((objc_msgSend(v11, "isSimHidden", (void)v17) & 1) == 0)
          {
            ...
            unsigned int v13 = [v12 supportsSystemCapabilityCallerIDForSubscriptionContext:v11];
