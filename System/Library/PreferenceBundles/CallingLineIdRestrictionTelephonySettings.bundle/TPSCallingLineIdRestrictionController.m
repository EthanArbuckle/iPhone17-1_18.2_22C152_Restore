...
- (TPSCallingLineIdRestrictionController)initWithSubscriptionContext:(id)a3
{
  ...
  if (v6)
  {
    ...
    v7->_state = 0;
    v8 = (TPSCallingLineIdRestrictionRequestController *)objc_alloc_init((Class)TPSCallingLineIdRestrictionRequestController);
...
{
  id v4 = a3;
  id v5 = [objc_alloc((Class)TPSCallingLineIdRestrictionRequest) initWithSubscriptionContext:v4];
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    int v7 = 138412290;
    id v8 = v5;
    _os_log_impl(&dword_0, v6, OS_LOG_TYPE_DEFAULT, "Sending caller line ID restriction request %@.", (uint8_t *)&v7, 0xCu);
  }
...
- (void)requestStateChange:(int64_t)a3
{
  if ([(TPSCallingLineIdRestrictionController *)self state] != a3)
  {
    ...
    id v5 = objc_alloc((Class)TPSCallingLineIdRestrictionSetRequest);
    v6 = [(TPSCallingLineIdRestrictionController *)self subscriptionContext];
    id v7 = [v5 initWithSubscriptionContext:v6 state:a3];

    id v8 = TPSCallingLineIdRestrictionLog();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      int v10 = 138412290;
      id v11 = v7;
      _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Sending caller line ID restriction set request %@.", (uint8_t *)&v10, 0xCu);
    }
...
- (void)requestController:(id)a3 didReceiveResponse:(id)a4
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v16 = v5;
    id v7 = v14;
    _os_log_impl(&dword_0, v6, OS_LOG_TYPE_DEFAULT, "%@ received response %@.", (uint8_t *)&v13, 0x16u);
  }
  ...
  id v8 = [(TPSCallingLineIdRestrictionController *)self delegate];
