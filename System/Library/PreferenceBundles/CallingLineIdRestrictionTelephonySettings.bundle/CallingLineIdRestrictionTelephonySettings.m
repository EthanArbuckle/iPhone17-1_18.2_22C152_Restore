...
{
  if (qword_8C80 != -1) {
    dispatch_once(&qword_8C80, &stru_41A8);
  }
  return qword_8C78;
}
...
void sub_1FB4(id a1)
{
  qword_8C78 = (uint64_t)os_log_create("com.apple.TelephonySettings", "CallingLineIdRestriction");
}
...
id objc_msgSend_callingLineIdRestrictionController(void *a1, const char *a2, ...)
{
  return [a1 callingLineIdRestrictionController];
}
