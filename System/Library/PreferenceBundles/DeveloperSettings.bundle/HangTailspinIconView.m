...
{
  v17.receiver = self;
  v17.super_class = (Class)HangTailspinIconView;
  v3 = -[HangTailspinIconView initWithFrame:](&v17, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
...
{
  id v4 = a3;
  id v5 = [(HangTailspinIconView *)self fileTypeLabel];
  [v5 setText:v4];
}

- (UILabel)fileTypeLabel
{
  return self->_fileTypeLabel;
}
