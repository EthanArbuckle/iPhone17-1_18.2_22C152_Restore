...
- (id)displayName
{
  ...
  switch(self->_type)
  {
    case 1uLL:
      ...
      uint64_t v4 = [v3 localizedStringForKey:@"VIP" value:&stru_39200 table:@"Main"];
      goto LABEL_8;
    case 2uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"FLAGGED" value:&stru_39200 table:@"Main"];
      goto LABEL_8;
    case 3uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"UNREAD" value:&stru_39200 table:@"Main"];
      goto LABEL_8;
    case 4uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"TO_OR_CC" value:&stru_39200 table:@"Main"];
      goto LABEL_8;
    case 6uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"IMPORTANT_THREADS" value:&stru_39200 table:@"Main"];
      goto LABEL_8;
    case 7uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"TODAY" value:&stru_39200 table:@"Main"];
LABEL_8:
      v2 = (void *)v4;
