...
- (id)foundInDescriptionIncludingAccount:(BOOL)a3
{
  ...
  uint64_t v7 = [v6 localizedStringForKey:@"MAILBOX_SUFFIX" value:&stru_39200 table:@"Main"];
  if ([v5 hasSuffix:v7])
  {
    int v8 = 1;
  }
  else
  {
    ...
    v10 = [v9 localizedStringForKey:@"BOX_SUFFIX" value:&stru_39200 table:@"Main"];
    if ([v5 hasSuffix:v10])
    {
      int v8 = 1;
    }
    else
    {
      ...
      v12 = [v11 localizedStringForKey:@"FOLDER_SUFFIX" value:&stru_39200 table:@"Main"];
  ...
  if ((unint64_t)(v13 - 2) >= 4 && v13 != (unsigned char *)&dword_4 + 3) {
    goto LABEL_12;
  }
...
{
  id v4 = a3;
  id v5 = (int *)[(MFMailboxUid *)self type];
...
- (BOOL)mv_isSelectable
{
  return [(MFMailboxUid *)self isStore];
}
