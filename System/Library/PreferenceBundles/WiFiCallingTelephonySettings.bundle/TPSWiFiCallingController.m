...
- (TUSenderIdentityCapabilities)subscriptionCapabilities
{
  ...
  v4 = [v3 uuid];
  id v5 = [(TPSWiFiCallingController *)self subscriptionCapabilitiesForSubscriptionContextUUID:v4];
...
- (BOOL)isThumperCallingEnabled
{
  ...
  {
    unsigned __int8 v3 = +[TUCallCapabilities isRelayCallingEnabled];
  }
  else
  {
...
{
  v2 = [(TPSWiFiCallingController *)self subscriptionCapabilities];
  unsigned __int8 v3 = [v2 isWiFiCallingRoamingEnabled];
...
{
  v2 = [(TPSWiFiCallingController *)self subscriptionCapabilities];
  unsigned __int8 v3 = [v2 supportsWiFiCalling];
...
{
  v2 = [(TPSWiFiCallingController *)self subscriptionCapabilities];
  unsigned __int8 v3 = [v2 supportsEmergencyWiFiCalling];
...
- (BOOL)isWiFiCallingCertified
{
  unsigned __int8 v3 = [(TPSWiFiCallingController *)self carrierBundleController];
  id v4 = [(TPSWiFiCallingController *)self subscriptionContext];
  id v5 = [v3 objectForKeyHierarchy:&off_8728 subscriptionContext:v4];
...
- (TPSCarrierBundleController)carrierBundleController
{
  ...
  {
    id v4 = (TPSCarrierBundleController *)objc_alloc_init((Class)TPSCarrierBundleController);
...
- (TPSEncryptedIdentityClient)encryptedIdentityClient
{
  ...
  {
    id v4 = (TPSEncryptedIdentityClient *)objc_alloc_init((Class)TPSEncryptedIdentityClient);
    id v5 = self->_encryptedIdentityClient;
...
- (NSDictionary)encryptedIdentityInfo
{
  ...
  if (!encryptedIdentityInfo)
  {
    ...
    id v5 = [(TPSWiFiCallingController *)self subscriptionContext];
    unsigned int v6 = [v4 encryptedIdentityInfoForSubscriptionContext:v5 type:1];
...
- (void)didChangeThumperCallingCapabilitiesForSenderIdentityWithUUID:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = TPSWiFiCallingLog();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      uint64_t v9 = [(TPSWiFiCallingController *)self subscriptionContext];
      int v11 = 138412290;
      unsigned int v12 = v9;
      _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "Thumper calling capabilities changed for subscription context %@.", (uint8_t *)&v11, 0xCu);
    }
...
- (void)didChangeWiFiCallingCapabilitiesForSenderIdentityWithUUID:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138412290;
      unsigned int v12 = v9;
      _os_log_impl(&dword_0, v8, OS_LOG_TYPE_DEFAULT, "WiFi calling capabilities changed for subscription context %@.", (uint8_t *)&v11, 0xCu);
    }
    v10 = +[NSNotificationCenter defaultCenter];
    [v10 postNotificationName:@"TPSWiFiCallingControllerSubscriptionCapabilitiesChangedNotification" object:self];
  }
