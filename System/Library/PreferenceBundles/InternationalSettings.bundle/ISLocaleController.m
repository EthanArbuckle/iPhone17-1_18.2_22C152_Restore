...
- (id)_mainContentView
{
  ...
  if (!contentView)
  {
    ...
    v26 = [v25 localizedStringForKey:@"SEARCH" value:&stru_31478 table:@"InternationalSettings"];
    v27 = [(ISLocaleController *)self searchBar];
    [v27 setPlaceholder:v26];

    v28 = (UITableView *)objc_msgSend(objc_alloc((Class)UITableView), "initWithFrame:style:", 0, 0.0, 0.0, v7, v9);
    [(UITableView *)v28 setAutoresizingMask:18];
    [(UITableView *)v28 setDataSource:self];
    [(UITableView *)v28 setDelegate:self];
    [(UITableView *)v28 setRowHeight:UITableViewAutomaticDimension];
    [(UITableView *)v28 setEstimatedRowHeight:UITableViewDefaultRowHeight];
    [(UITableView *)v28 setKeyboardDismissMode:1];
...
- (void)loadRegions
{
  ...
  {
    v19 = self;
    objc_super v4 = +[ISInternationalViewController currentLocale];
...
- (void)viewDidLoad
{
  ...
  objc_super v4 = [v3 localizedStringForKey:@"SELECT_REGION" value:&stru_31478 table:@"InternationalSettings"];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  id v10 = +[ISInternationalViewController currentLocale];
...
- (void)searchBar:(id)a3 textDidChange:(id)a4
{
  ...
  if ([v7 length])
  {
    ...
    unsigned __int8 v13 = sub_858C;
    uint64_t v14 = &unk_30E48;
    v15 = self;
    id v16 = v7;
