...
- (void)commit
{
  if (self->_languageToSet)
  {
    if ([(ISLanguageSetupController *)self isSettingDifferentLanguage])
    {
      ...
      v4 = [v3 localizedStringForKey:@"CHANGE_TO_%@_FOR_NEW_DEVICE_LANGUAGE" value:&stru_31478 table:@"InternationalSettings"];
      ...
      v44 = [v5 localizedStringForKey:@"CANCEL_CHANGE_LANGUAGE" value:&stru_31478 table:@"InternationalSettings"];

      v6 = +[IPLanguageListManager manager];
      uint64_t v7 = [v6 systemDisplayLanguage];

      v8 = +[NSBundle bundleForClass:objc_opt_class()];
      v9 = [v8 localizedStringForKey:@"USE_%@" value:&stru_31478 table:@"InternationalSettings"];
      ...
      v11 = [v10 localizedStringForKey:@"USE_%@" value:&stru_31478 table:@"InternationalSettings"];
      v45 = (void *)v7;
      ...
      v14 = [(id)v13 localizedStringForKey:@"WOULD_YOU_LIKE_TO_USE_%@_AS_PRIMARY_LANGUAGE" value:&stru_31478 table:@"InternationalSettings"];
      ...
      else
      {
        ...
        [v20 localizedStringForKey:v21 value:&stru_31478 table:@"InternationalSettings"];
        v22 = v41 = v12;
        ...
        v24 = [v23 localizedStringForKey:@"PREFER_%@" value:&stru_31478 table:@"InternationalSettings"];
        ...
        v27 = [v26 localizedStringForKey:@"PREFER_%@" value:&stru_31478 table:@"InternationalSettings"];
        ...
        v19 = [v29 localizedStringForKey:@"ADD_PREFERRED_LANGUAGE_TITLE" value:&stru_31478 table:@"InternationalSettings"];
        v18 = v41;
...
{
  BOOL v3 = a3;
  id v14 = +[ISInternationalViewController preferredLanguages];
  if (![v14 count]) {
    sub_20CB4();
  }
  if ([v14 count])
  {
    ...
    else
    {
      ...
      if (!v8)
      {
        v9 = +[ISInternationalViewController currentLocale];
        v10 = [v9 regionCode];
    ...
    uint64_t v13 = (void *)CFPreferencesCopyValue(@"AppleKeyboards", kCFPreferencesAnyApplication, kCFPreferencesCurrentUser, kCFPreferencesAnyHost);
    if (v13) {
      +[NSLocale enableDefaultKeyboardForPreferredLanguages];
    }
  }
}
...
- (void)setupController
{
  ...
  v4 = [v3 localizedStringForKey:@"Language" value:&stru_31478 table:@"InternationalSettings"];
  [v6 setName:v4];
