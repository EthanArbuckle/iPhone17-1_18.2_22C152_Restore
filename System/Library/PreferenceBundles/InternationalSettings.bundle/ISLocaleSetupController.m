...
- (void)commitRegion
{
  ...
  if (v3)
  {
    ...
    v59 = [v8 localizedStringForKey:@"CHANGE_REGION_TITLE" value:&stru_31478 table:@"InternationalSettings"];

    v9 = +[NSBundle bundleForClass:objc_opt_class()];
    uint64_t v56 = [v9 localizedStringForKey:@"CANCEL_CHANGE_REGION" value:&stru_31478 table:@"InternationalSettings"];

    v10 = +[UIDevice currentDevice];
    unsigned int v54 = objc_msgSend(v10, "sf_isiPad");

    id v11 = objc_alloc((Class)IPLanguageListManager);
    v12 = +[ISInternationalViewController preferredLanguages];
    ...
    if (+[NSLocale _language:v15 usesSameLocalizationAs:v25])
    {
      ...
      v32 = [v31 localizedStringForKey:@"CHANGE_TO_%@_AS_REGION" value:&stru_31478 table:@"InternationalSettings"];
    ...
    else
    {
      ...
      v39 = [v38 localizedStringForKey:@"CHANGE_TO_%@_AS_PRIMARY_LANGUAGE" value:&stru_31478 table:@"InternationalSettings"];
      ...
      v41 = v40 = (void *)v25;
      v42 = [v41 localizedStringForKey:@"KEEP_%@_AS_PRIMARY_LANGUAGE" value:&stru_31478 table:@"InternationalSettings"];
      ...
      v45 = [v43 localizedStringForKey:v44 value:&stru_31478 table:@"InternationalSettings"];
      v26 = v40;
...
- (void)handleAlertActionAndChangeLanguage:(BOOL)a3
{
  ...
  v8 = +[ISInternationalViewController preferredLanguages];
  v9 = +[ISInternationalViewController currentLocale];
  id v10 = [v7 initWithPreferredLanguages:v8 preferredLocale:v9];

  [v10 setRegion:v6 updateFirstLanguage:v3];
  +[IPSettingsUtilities setRegion:v6 changeLanguageVariant:v3 postNotification:0];
  id v11 = +[NSBundle bundleForClass:objc_opt_class()];
  v12 = [v11 localizedStringForKey:@"CHANGE_DEVICE_REGION" value:&stru_31478 table:@"InternationalSettings"];
  id v13 = [v10 systemDisplayLanguage];
  v14[0] = _NSConcreteStackBlock;
  v14[1] = 3221225472;
  v14[2] = sub_9790;
  v14[3] = &unk_30D70;
  v14[4] = self;
  [(ISLocaleSetupController *)self showUpdatingLanguageViewWithLabel:v12 languageIdentifier:v13 completionBlock:v14];
}
...
- (void)setupController
{
  ...
  v4 = [v3 localizedStringForKey:@"LOCALE" value:&stru_31478 table:@"InternationalSettings"];
  [v6 setName:v4];
