...
{
  v5.receiver = self;
  v5.super_class = (Class)AppleEthernetDNSConfigurator;
...
LABEL_5:
  ...
  if (!v12)
  {
    uint64_t v13 = [v7 objectForKeyedSubscript:kSCPropNetDNSDomainName];
    if (v13)
    {
      v14 = (void *)v13;
...
- (void)updateSettings:(id)a3 fromCurrentConfig:(id)a4 toNewConfig:(id)a5
{
  ...
  id v7 = a4;
  id v8 = a5;
  if ([v8 dnsConfig] == (char *)&dword_0 + 1)
  {
  ...
  else if ([v7 dnsConfig] == (char *)&dword_0 + 1)
  {
