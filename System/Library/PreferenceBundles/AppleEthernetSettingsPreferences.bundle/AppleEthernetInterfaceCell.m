...
{
  v7.receiver = self;
  v7.super_class = (Class)AppleEthernetInterfaceCell;
...
{
  v4.receiver = self;
  v4.super_class = (Class)AppleEthernetInterfaceCell;
...
- (void)initializeWithInterface:(id)a3
{
  id v5 = [a3 displayName];
  objc_super v4 = [(AppleEthernetInterfaceCell *)self textLabel];
  [v4 setText:v5];
}
