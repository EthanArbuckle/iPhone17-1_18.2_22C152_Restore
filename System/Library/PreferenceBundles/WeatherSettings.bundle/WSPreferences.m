...
{
  id v3 = a3;
  id v4 = [objc_alloc((Class)LSApplicationRecord) initWithBundleIdentifier:@"com.apple.weather" allowPlaceholder:0 error:0];
  ...
  v10 = (void *)_CFPreferencesCopyAppValueWithContainer();
...
+ (void)writePreferenceForKey:(id)a3 value:(id)a4
{
  id v12 = a3;
  id v5 = a4;
  id v6 = [objc_alloc((Class)LSApplicationRecord) initWithBundleIdentifier:@"com.apple.weather" allowPlaceholder:0 error:0];
