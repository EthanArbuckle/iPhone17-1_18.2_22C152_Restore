...
{
  v63.receiver = self;
  v63.super_class = (Class)ASTStepperCell;
  v5 = [(ASTStepperCell *)&v63 initWithStyle:a3 reuseIdentifier:a4 specifier:a5];
  v6 = v5;
  if (v5)
  {
    [(ASTStepperCell *)v5 setUserInteractionEnabled:1];
    v7 = (UIStepper *)objc_msgSend(objc_alloc((Class)UIStepper), "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
    stepper = v6->_stepper;
    v6->_stepper = v7;
    ...
    -[UIStepper setValue:](v6->_stepper, "setValue:", (double)(unint64_t)[v60 count]);
    ...
    -[UILabel setTextAlignment:](v6->_stepperLabel, "setTextAlignment:", 2 * ([v17 layoutDirection] != (char *)&dword_0 + 1));
...
id __58__ASTStepperCell_initWithStyle_reuseIdentifier_specifier___block_invoke(uint64_t a1)
{
  ...
  objc_msgSend(*(id *)(*(void *)(a1 + 32) + 120), "setValue:", (double)(unint64_t)objc_msgSend(v3, "count"));
...
- (void)_updateLabel
{
  [(UIStepper *)self->_stepper value];
  double v4 = v3;
  settingsLocString(@"NumberOfAssistiveTouchButtons", @"HandSettings");
  id v6 = (id)objc_claimAutoreleasedReturnValue();
  v5 = +[NSString localizedStringWithFormat:](NSString, "localizedStringWithFormat:", v6, (int)v4);
...
- (void)_stepperChanged:(id)a3
{
  ...
  id v4 = [(ASTStepperCell *)self stepperDelegate];
  [v4 stepperCellCountChanged:self];
}

- (ASTStepperCellDelegate)stepperDelegate
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_stepperDelegate);

  return (ASTStepperCellDelegate *)WeakRetained;
}
...
- (void).cxx_destruct
{
  objc_destroyWeak((id *)&self->_stepperDelegate);
  objc_storeStrong((id *)&self->_stepperLabel, 0);
