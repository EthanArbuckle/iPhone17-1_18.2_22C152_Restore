...
+ (id)sharedInstance
{
  ...
  v2 = (void *)sharedInstance___SharedUtils;
...
- (id)allSoundsForAssetURL:(id)a3
{
  ...
  uint64_t v5 = [(SoundActionsPracticeUtilities *)self dataForSoundUsage:5 assetURL:v4];
  v6 = [(SoundActionsPracticeUtilities *)self dataForSoundUsage:9 assetURL:v4];
  id v7 = [(SoundActionsPracticeUtilities *)self dataForSoundUsage:10 assetURL:v4];
  ...
  v11 = (void *)v5;
  v12 = +[NSArray axArrayByIgnoringNilElementsWithCount:](NSArray, "axArrayByIgnoringNilElementsWithCount:", 14, v22, v21, v19, v16, v18, v15, v17, v14, v5, v6, v7, v8, v9, v10);
  id v20 = [v12 copy];
...
- (id)_tipForUsage:(int64_t)a3
{
  ...
  {
    v3 = [@"SOUND_ACTION_LEARN_PAGE_DESC_" stringByAppendingString:off_209C18[a3 - 1]];
  }
