...
{
  v11.receiver = self;
  v11.super_class = (Class)AXSpeakHighlightColorCell;
  id v7 = a5;
  v8 = [(AXColorChooserCell *)&v11 initWithStyle:a3 reuseIdentifier:a4 specifier:v7];
  v9 = objc_msgSend(v7, "propertyForKey:", @"type", v11.receiver, v11.super_class);
