...
- (id)specifiers
{
  ...
  else
  {
    ...
    do
    {
      uint64_t v8 = (unsigned __int16)word_1A14B0[v6];
      v9 = AXLocalizedNameForMIDIChannel(v8);
    ...
    while (v6 != 17);
    v12 = *(void **)&self->AXUISettingsSetupCapableListController_opaque[v15];
    *(void *)&self->AXUISettingsSetupCapableListController_opaque[v15] = v5;
    id v13 = v5;

    id v3 = *(id *)&self->AXUISettingsSetupCapableListController_opaque[v15];
  }
...
{
  v14.receiver = self;
  v14.super_class = (Class)SCATMIDISwitchChannelViewController;
  v5 = [(SCATMIDISwitchChannelViewController *)&v14 tableView:a3 cellForRowAtIndexPath:a4];
  uint64_t v6 = [v5 specifier];
  uint64_t v7 = [(SCATMIDISwitchChannelViewController *)self modelSwitch];
  uint64_t v8 = [v7 midiEvent];
  unsigned int v9 = [v8 channel];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v14.super_class = (Class)SCATMIDISwitchChannelViewController;
  v5 = [(SCATMIDISwitchChannelViewController *)&v14 tableView:a3 cellForRowAtIndexPath:a4];
  uint64_t v6 = [(SCATMIDISwitchChannelViewController *)self modelSwitch];
  uint64_t v7 = [v5 specifier];
  uint64_t v8 = [v7 propertyForKey:@"MIDIChannel"];
...
uint64_t __73__SCATMIDISwitchChannelViewController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  v4 = [v2 midiEvent];
  unsigned int v5 = [v4 channel];

  uint64_t v6 = [v3 propertyForKey:@"MIDIChannel"];
