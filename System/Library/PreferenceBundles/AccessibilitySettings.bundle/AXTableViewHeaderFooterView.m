...
- (AXTableViewHeaderFooterView)initWithSpecifier:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)AXTableViewHeaderFooterView;
  v5 = -[AXTableViewHeaderFooterView initWithFrame:](&v15, "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
  if (v5)
  {
    v6 = [v4 name];
