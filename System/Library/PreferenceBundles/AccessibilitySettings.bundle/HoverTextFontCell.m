...
{
  v12.receiver = self;
  v12.super_class = (Class)HoverTextFontCell;
  id v7 = a5;
  v8 = [(HoverTextFontCell *)&v12 initWithStyle:a3 reuseIdentifier:a4 specifier:v7];
  -[HoverTextFontCell setSpecifier:](v8, "setSpecifier:", v7, v12.receiver, v12.super_class);
...
- (void)_updateLabel
{
  id v3 = [(HoverTextFontCell *)self specifier];
  id v22 = [v3 propertyForKey:PSIDKey];

  v4 = [(HoverTextFontCell *)self textLabel];
  double v5 = [(HoverTextFontCell *)self specifier];
  double v6 = [v5 propertyForKey:PSTitleKey];
  if (v6)
  {
    [v4 setText:v6];
  }
  ...
  {
    id v7 = [(HoverTextFontCell *)self specifier];
    v8 = [v7 name];
    [v4 setText:v8];
  }
  ...
  if (v13)
  {
    v14 = (const __CTFont *)_CTFontCreateWithNameAndSymbolicTraits();
    CFCharacterSetRef v15 = CTFontCopyCharacterSet(v14);
    v16 = [v4 text];
    CFCharacterSetRef v17 = CFCharacterSetCreateWithCharactersInString(kCFAllocatorDefault, v16);
