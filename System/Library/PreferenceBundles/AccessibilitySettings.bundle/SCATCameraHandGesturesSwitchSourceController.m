...
void __72__SCATCameraHandGesturesSwitchSourceController__shouldEnableHandSwitch___block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  id v9 = a2;
  v5 = [v9 source];
  if ([v5 isEqual:SCATSwitchSourceCameraHandGesture])
  {
    id v6 = [v9 accessibilityEventUsage];
    id v7 = *(id *)(a1 + 40);
...
- (id)specifiers
{
  ...
  if (!v4)
  {
    ...
    uint64_t v10 = +[NSNumber numberWithBool:[(SCATCameraHandGesturesSwitchSourceController *)self _shouldEnableHandSwitch:1]];
...
{
  v15.receiver = self;
  v15.super_class = (Class)SCATCameraHandGesturesSwitchSourceController;
  v5 = [(SCATCameraHandGesturesSwitchSourceController *)&v15 tableView:a3 cellForRowAtIndexPath:a4];
  id v6 = [v5 specifier];
  id v7 = [v6 identifier];

  uint64_t v8 = +[AXSwitch switchWithAction:0 name:0 source:SCATSwitchSourceCameraHandGesture type:SCATSwitchTypeOptional];
...
LABEL_6:
  ...
  v12 = [(SCATCameraHandGesturesSwitchSourceController *)self rootController];
  ...
  [(SCATCameraHandGesturesSwitchSourceController *)self showController:v11 animate:1];
}
