...
{
  v13.receiver = self;
  v13.super_class = (Class)ClarityUIListLayoutController;
  id v6 = a4;
  v7 = [(ClarityUIListLayoutController *)&v13 tableView:a3 cellForRowAtIndexPath:v6];
  v8 = -[ClarityUIListLayoutController specifierAtIndexPath:](self, "specifierAtIndexPath:", v6, v13.receiver, v13.super_class);

  uint64_t v9 = [v8 propertyForKey:@"ListLayout"];
  v10 = +[CLFSettings sharedInstance];
  v11 = [v10 listLayout];
  objc_msgSend(v7, "setChecked:", objc_msgSend(v11, "isEqualToString:", v9));
...
{
  v10.receiver = self;
  v10.super_class = (Class)ClarityUIListLayoutController;
  id v6 = a4;
  [(ClarityUIListLayoutController *)&v10 tableView:a3 didSelectRowAtIndexPath:v6];
  v7 = -[ClarityUIListLayoutController specifierAtIndexPath:](self, "specifierAtIndexPath:", v6, v10.receiver, v10.super_class);
  v8 = [v7 propertyForKey:@"ListLayout"];
  uint64_t v9 = +[CLFSettings sharedInstance];
  [v9 setListLayout:v8];
