...
- (ASTOnDeviceEyeTrackingSettingsAutoHideOpacitySliderCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5;
- (double)initialValue;
- (double)maximumValue;
- (double)minimumValue;
...
{
  v8.receiver = self;
  v8.super_class = (Class)ASTOnDeviceEyeTrackingSettingsAutoHideOpacitySliderCell;
  v5 = [(ASTOnDeviceEyeTrackingSettingsAutoHideOpacitySliderCell *)&v8 initWithStyle:a3 reuseIdentifier:a4 specifier:a5];
  v6 = v5;
  if (v5)
  {
    [(ASTOnDeviceEyeTrackingSettingsAutoHideOpacitySliderCell *)v5 initialValue];
    -[ASTOnDeviceEyeTrackingSettingsAutoHideOpacitySliderCell _updateRightLabelWithValue:](v6, "_updateRightLabelWithValue:");
  }
  return v6;
}
...
- (void)_updateRightLabelWithValue:(double)a3
{
  ...
  if (v6)
  {
    ...
    objc_super v8 = [(ASTOnDeviceEyeTrackingSettingsAutoHideOpacitySliderCell *)self slider];
