...
- (id)specifiers
{
  ...
  if (!v4)
  {
    ...
    *(void *)&self->super.AXUISettingsListController_opaque[v3] = v16;
...
- (id)flashWhileUnlocked:(id)a3
{
  ...
  id v4 = +[NSNumber numberWithBool:](NSNumber, "numberWithBool:", [v3 shouldFlashWhileUnlocked]);
...
{
  uint64_t v3 = +[AXSettings sharedInstance];
  id v4 = +[NSNumber numberWithBool:](NSNumber, "numberWithBool:", [v3 shouldFlashForAlertInSilentMode]);
...
- (id)ledFlashEnabled:(id)a3
{
  uint64_t v3 = _AXSVisualAlertEnabled();
