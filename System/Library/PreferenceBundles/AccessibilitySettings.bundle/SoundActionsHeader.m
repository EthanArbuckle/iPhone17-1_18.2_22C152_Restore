...
- (SoundActionsPracticeVisualizerView)visualizerView;
...
{
  v6.receiver = self;
  v6.super_class = (Class)SoundActionsHeader;
  v3 = -[SoundActionsHeader initWithFrame:](&v6, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3) {
...
- (void)_setupVisualizerView
{
  ...
  objc_super v6 = settingsLocString(@"SOUND_ACTION_PRACTICE_PAGE_HINT", @"Accessibility");
  [(SoundActionsPracticeVisualizerView *)self->_visualizerView setAccessibilityHint:v6];

  v7 = self->_visualizerView;
  unint64_t v8 = (unint64_t)[(SoundActionsPracticeVisualizerView *)v7 accessibilityTraits];
