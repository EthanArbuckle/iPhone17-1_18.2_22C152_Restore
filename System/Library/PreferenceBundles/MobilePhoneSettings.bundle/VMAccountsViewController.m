...
- (void)viewDidLoad
{
  ...
  v4 = [MEMORY[0x263F1C550] dynamicBackgroundColor];
  [v3 setBackgroundColor:v4];

  v5 = [MEMORY[0x263F08A00] defaultCenter];
  uint64_t v6 = *MEMORY[0x263F84D18];
...
- (void)handleVMVoicemailManagerAccountsDidChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v10 = v4;
    id v6 = v8;
    _os_log_impl(&dword_227DC6000, v5, OS_LOG_TYPE_DEFAULT, "%@ is handling %@", (uint8_t *)&v7, 0x16u);
  }
  [(VMAccountsViewController *)self updateAccounts];
  [(VMAccountsViewController *)self updateAccountsView];
}
