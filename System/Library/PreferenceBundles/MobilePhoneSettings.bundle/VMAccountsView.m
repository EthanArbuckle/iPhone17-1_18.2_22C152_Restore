...
- (VMAccountsView)initWithFrame:(CGRect)a3
{
  ...
  v3 = -[VMAccountsView initWithFrame:](&v6, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3) {
...
- (void)commonInit
{
  ...
  v7 = [MEMORY[0x263F1C658] telephonyUISubheadlineShortFont];
  [(UILabel *)self->_messageLabel setFont:v7];

  [(UILabel *)self->_messageLabel setLineBreakMode:0];
  [(UILabel *)self->_messageLabel setNumberOfLines:0];
  [(UILabel *)self->_messageLabel setTextAlignment:1];
  v8 = [MEMORY[0x263F1C550] dynamicSecondaryLabelColor];
  ...
  v10 = (UIStackView *)objc_msgSend(v9, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
...
- (void)loadConstraints
{
  ...
  v20 = objc_msgSend(v17, "constraintGreaterThanOrEqualToAnchor:constant:", v19);
...
- (void)reloadData
{
  ...
  uint64_t v9 = [v8 numberOfRowsForAccountsView:self];
  ...
  if (v27)
  {
    ...
    do
    {
      for (uint64_t k = 0; k != v28; ++k)
      {
        ...
        [*(id *)(*((void *)&v31 + 1) + 8 * k) setPreferredIntrinsicContentSizeWidth:v18];
      }
...
- (double)messageLabelFirstBaselineAnchorLayoutConstraintConstant
{
  ...
  if (v5)
  {
    uint64_t v6 = [MEMORY[0x263F1C668] metricsForTextStyle:v5];
