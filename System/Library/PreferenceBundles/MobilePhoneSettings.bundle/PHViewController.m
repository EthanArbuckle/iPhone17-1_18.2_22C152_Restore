...
- (void)commonInit
{
  ...
  if ([(PHViewController *)self conformsToProtocol:&unk_26DC4EC10])
  {
    v3 = (objc_class *)MEMORY[0x263F1CA38];
    v4 = self;
    id v5 = [v3 alloc];
    objc_super v6 = [(PHViewController *)v4 tabBarItemTitle];
    objc_super v7 = [(PHViewController *)v4 tabBarItemImage];
    v8 = [(PHViewController *)v4 tabBarItemSelectedImage];

    id v10 = (id)[v5 initWithTitle:v6 image:v7 selectedImage:v8];
    goto LABEL_6;
  }
  if ([(PHViewController *)self conformsToProtocol:&unk_26DC4EC70])
  {
    objc_super v6 = self;
    id v10 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F1CA38]), "initWithTabBarSystemItem:tag:", -[PHViewController tabBarSystemItem](v6, "tabBarSystemItem"), -[PHViewController tabBarSystemItemTag](v6, "tabBarSystemItemTag"));
...
LABEL_7:
    ...
    objc_super v7 = [(PHViewController *)v6 tabBarSystemItemTitle];
    [v10 _setInternalTitle:v7];
LABEL_6:
...
LABEL_9:
  id v11 = v9;
  [(PHViewController *)self setTabBarItem:v9];
}
...
- (void)didReceiveMemoryWarning
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    ...
    id v4 = v7;
    _os_log_impl(&dword_227DC6000, v3, OS_LOG_TYPE_DEFAULT, "%@ received memory warning, purging variables that can be dynamically restored.", buf, 0xCu);
  }
  v5.receiver = self;
  v5.super_class = (Class)PHViewController;
...
- (void)setContentUnavailable:(BOOL)a3 animated:(BOOL)a4
{
  if (self->_contentUnavailable != a3)
  {
          ...
          v7))
    {
      ...
      BOOL v14 = a3;
      v13[4] = self;
      uint64_t v8 = (void (**)(void, void))MEMORY[0x22A687790](v13, a2);
      ...
      v11[4] = self;
      BOOL v12 = a3;
      uint64_t v9 = MEMORY[0x22A687790](v11);
      id v10 = (void *)v9;
      if (v4)
      {
        [MEMORY[0x263F1CB60] animateWithDuration:4 delay:v9 options:v8 animations:0.300000012 completion:0.0];
      }
      else
      {
...
- (PHContentUnavailable)contentUnavailableView
{
  ...
  {
    id v4 = objc_alloc(MEMORY[0x263F1CC50]);
    objc_super v5 = [(PHViewController *)self view];
    [v5 bounds];
    objc_super v6 = (PHContentUnavailable *)objc_msgSend(v4, "initWithFrame:title:", self->_contentUnavailableViewTitle);
    ...
    uint64_t v8 = [(PHViewController *)self view];
