void sub_227DC7BA4(_Unwind_Exception *a1)
{
  void *v1;
...
void sub_227DC806C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, id location)
{
...
void sub_227DCCBBC(_Unwind_Exception *a1)
{
  objc_destroyWeak(v1);
