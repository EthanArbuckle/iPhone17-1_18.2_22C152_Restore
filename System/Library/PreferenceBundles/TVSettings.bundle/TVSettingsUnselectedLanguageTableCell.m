...
- (TVSettingsUnselectedLanguageTableCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  id v8 = a5;
  v14.receiver = self;
  v14.super_class = (Class)TVSettingsUnselectedLanguageTableCell;
...
- (void)updateLabels
{
  ...
  id v6 = [(TVSettingsUnselectedLanguageTableCell *)self detailTextLabel];
...
- (id)title
{
  ...
  else
  {
    ...
    unsigned __int8 v6 = [v5 isEqualToString:@"DEVICE_AUDIO_LANGUAGE"];
