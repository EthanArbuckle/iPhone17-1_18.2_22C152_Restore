...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)TVSettingsListItemsMonitorController;
...
{
  v6.receiver = self;
  v6.super_class = (Class)TVSettingsListItemsMonitorController;
  objc_super v4 = [(TVSettingsListItemsMonitorController *)&v6 initWithNibName:a3 bundle:a4];
  if (v4) {
