...
{
  v9.receiver = self;
  v9.super_class = (Class)STStorageHLSController;
  [(STStorageHLSController *)&v9 viewDidLoad];
  v3 = dispatch_queue_attr_make_with_autorelease_frequency(0, DISPATCH_AUTORELEASE_FREQUENCY_WORK_ITEM);
  v4 = dispatch_queue_attr_make_with_qos_class(v3, QOS_CLASS_USER_INITIATED, 0);
  v5 = (OS_dispatch_queue *)dispatch_queue_create("StorageHLSAssetDeleteAuete", v4);
  deleteQueue = self->deleteQueue;
  self->deleteQueue = v5;

  [(STStorageHLSController *)self setEditing:0];
  v7 = [(STStorageHLSController *)self table];
  [v7 setAllowsMultipleSelectionDuringEditing:0];
...
{
  v11.receiver = self;
  v11.super_class = (Class)STStorageHLSController;
  [(STStorageHLSController *)&v11 viewWillAppear:a3];
  v4 = STLocalizedString(@"Downloaded Videos");
  v5 = [(STStorageHLSController *)self navigationItem];
  [v5 setTitle:v4];

  v6 = [(STStorageHLSController *)self editButtonItem];
  [v6 setTarget:self];

  v7 = [(STStorageHLSController *)self editButtonItem];
  [v7 setAction:"toggleEditing:"];

  v8 = [(STStorageHLSController *)self parentViewController];
  objc_super v9 = [v8 navigationItem];
  v10 = [(STStorageHLSController *)self editButtonItem];
  [v9 setRightBarButtonItem:v10];
}

- (void)toggleEditing:(id)a3
{
  uint64_t v4 = [(STStorageHLSController *)self isEditing] ^ 1;
  [(STStorageHLSController *)self setEditing:v4];
  id v5 = [(STStorageHLSController *)self table];
  [v5 setEditing:v4];
}
...
- (id)hlsSpecifiers
{
  ...
  [v6 sortUsingComparator:&stru_966A8];
  ...
  if (v46)
  {
    ...
    do
    {
      for (j = 0; j != v46; j = (char *)j + 1)
      {
        ...
        [v24 sortUsingComparator:&stru_966C8];
        long long v54 = 0u;
        long long v55 = 0u;
        long long v52 = 0u;
        long long v53 = 0u;
  ...
  if ([v4 count])
  {
    [v4 sortUsingComparator:&stru_966E8];
...
- (id)specifiers
{
  ...
  if (!*v3)
  {
    ...
    if (!*v3)
    {
      id v4 = +[PSSpecifier preferenceSpecifierNamed:&stru_98A78 target:0 set:0 get:0 detail:0 cell:15 edit:0];
      id v9 = v4;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->deleteQueue, 0);
