...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((uint64_t)v9 > 2047)
    {
      if (v9 == "/usr/lib/swift/libswiftDataDetection.dylib")
      {
LABEL_20:
        v10 = @"VIDEOS_FMT";
        goto LABEL_31;
      }
      if (v9 == "Library/PrivateFrameworks/StorageUI.framework/StorageUI")
      {
LABEL_27:
        v10 = @"LESSONS_FMT";
        goto LABEL_31;
...
LABEL_25:
  ...
  {
    if (qword_A4C18 != -1) {
      dispatch_once(&qword_A4C18, &stru_96760);
    }
    id v20 = (id)qword_A4C10;
