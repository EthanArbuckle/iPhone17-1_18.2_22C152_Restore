...
- (STStorageHeaderLabelCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  id v8 = a5;
  v19.receiver = self;
  v19.super_class = (Class)STStorageHeaderLabelCell;
...
- (void)updateConstraints
{
  ...
  {
    id v3 = [(STStorageHeaderLabelCell *)self contentView];
  ...
  v12.receiver = self;
  v12.super_class = (Class)STStorageHeaderLabelCell;
...
{
  v7.receiver = self;
  v7.super_class = (Class)STStorageHeaderLabelCell;
  id v4 = a3;
  [(STStorageHeaderLabelCell *)&v7 refreshCellContentsWithSpecifier:v4];
  v5 = objc_msgSend(v4, "propertyForKey:", STStorageTitleKey, v7.receiver, v7.super_class);
