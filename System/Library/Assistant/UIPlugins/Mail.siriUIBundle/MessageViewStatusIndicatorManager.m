...
- (void)updateImageViews
{
  ...
  if (v3)
  {
    ...
    do
    {
      uint64_t v12 = qword_112C0[v10];
      if ((v12 & v3) != 0)
      {
        v13 = [(MessageStatusIndicatorManager *)self statusIndicatorColorWithOptionsMask:qword_112C0[v10]];
        ...
        objc_msgSend(v15, "setHidden:", 0, (void)v17);
        [v15 setImage:v14];
