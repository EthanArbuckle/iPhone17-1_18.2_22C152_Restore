...
- (double)midXToMidXSpacing
{
  double result = *(double *)&qword_1F020;
  double v3 = -*(double *)&qword_1F020;
  if (*(double *)&qword_1F020 >= 0.0) {
    double v3 = *(double *)&qword_1F020;
  }
  if (v3 < 2.22044605e-16)
  {
    ...
    [v4 size];
    *(double *)&qword_1F020 = v5 * 1.5;

    return *(double *)&qword_1F020;
  }
  return result;
}
...
LABEL_30:
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2048;
    int64_t v11 = v3;
    _os_log_impl(&def_4BE8, v6, OS_LOG_TYPE_DEFAULT, "#Warning %s: No image pair for options %lu", (uint8_t *)&v8, 0x16u);
  }
...
+ (unint64_t)statusIndicatorOptionsForMessage:(id)a3
{
  ...
  id v7 = (char *)[v3 conversationNotificationLevel];
  unsigned int v8 = [v3 isBlocked];
  unint64_t v9 = v5 ^ 1;
  if (v4) {
    v9 |= 4uLL;
  }
  if (v7 == (unsigned char *)&def_4BE8 + 2) {
    v9 |= 0x40uLL;
  }
  if (v7 == (unsigned char *)&def_4BE8 + 1) {
    v9 |= 0x80uLL;
  }
  if (v8) {
