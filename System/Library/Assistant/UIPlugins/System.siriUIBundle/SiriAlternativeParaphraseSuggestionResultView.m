...
- (SiriAlternativeParaphraseSuggestionResultView)initWithAlternativeSuggestionResult:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)SiriAlternativeParaphraseSuggestionResultView;
...
{
  v13.receiver = self;
  v13.super_class = (Class)SiriAlternativeParaphraseSuggestionResultView;
