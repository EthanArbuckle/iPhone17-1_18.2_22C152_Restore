...
{
  if (qword_20D50 != -1) {
    dispatch_once(&qword_20D50, &stru_18520);
  }
  v2 = (void *)qword_20D58;
...
{
  if (qword_20D60 != -1) {
    dispatch_once(&qword_20D60, &stru_18540);
  }
  v2 = (void *)qword_20D68;
...
{
  if (qword_20D70 != -1) {
    dispatch_once(&qword_20D70, &stru_18560);
  }
  v2 = (void *)qword_20D78;
...
- (void)loadNoteDataWithContext:(id)a3
{
  ...
  v28 = [v27 objectID];
  v29 = objc_msgSend(v113, "ic_existingObjectWithID:", v28);
  ...
  v32 = objc_msgSend(v31, "ic_briefFormattedDate");
  ...
  if (!v51)
  {
    ...
    if (v67 > 0.0)
    {
      ...
      if (!v66)
      {
        uint64_t v72 = objc_msgSend(v62, "ic_substringWithRange:", 0, v70);

        id v62 = (id)v72;
        goto LABEL_37;
      }
      uint64_t v71 = objc_msgSend(v66, "attributedSubstringFromRange:", 0, v70);
...
LABEL_38:
      if ([v29 isUnsupported])
      {
        ...
        v74 = [v73 localizedStringForKey:@"Content hidden" value:&stru_186B0 table:0];
        objc_msgSend(v74, "ic_attributedString");
      ...
      if (![(ICNoteResultsCellConfiguration *)v4 isLargerThanAXLarge])
      {
        ...
        if (v75)
        {
          ...
          if (v77)
          {
            ...
            objc_msgSend(v65, "ic_attributedStringByPrependingString:", v79);
            id v80 = v8;
            id v81 = v6;
            v83 = id v82 = v10;
      ...
      if (v84 > 0.0)
      {
        ...
        uint64_t v87 = objc_msgSend(v65, "ic_attributedSubstringFromRange:", 0, (unint64_t)v86);
...
LABEL_37:
  ...
  v54 = objc_msgSend(v52, "attributedTitleWithBaseAttributes:highlightColor:insideFrame:", v6, v53, v12, v14, v16, v18);
  ...
  v57 = objc_msgSend(v55, "attributedSummaryWithBaseAttributes:highlightColor:insideFrame:", v8, v56, v20, v22, v24, v26);
  ...
  if (v63)
  {
    objc_msgSend(v62, "ic_appendString:", @"  ");
...
- (void)loadInvitationDataWithContext:(id)a3
{
  ...
  v27 = objc_msgSend(v64, "ic_existingObjectWithID:", v26);
  ...
  else
  {
    ...
    v32 = [v31 localizedStringForKey:@"Invitation" value:&stru_186B0 table:0];
  ...
  else
  {
    ...
    v37 = objc_msgSend(v33, "ic_substringWithRange:", 0, (unint64_t)v36);
    [(ICNoteResultsCellConfiguration *)v4 setTitleString:v37];
  }
  v38 = [v27 creationDate];
  id v39 = objc_msgSend(v38, "ic_briefFormattedDate");
...
LABEL_14:
  ...
  else
  {
    ...
    v52 = objc_msgSend(v48, "ic_substringWithRange:", 0, (unint64_t)v51);
...
- (id)symbolImageConfiguration
{
  ...
  else
  {
    ...
    v2 = objc_msgSend(v3, "ic_fontWithSingleLineA");
  }
...
- (id)accessibilityLabel
{
  ...
  if (v3)
  {
    ...
    double v10 = [v7 localizedStringForKey:v9 value:&stru_186B0 table:0];
    ...
    double v16 = objc_msgSend(v15, "ic_briefFormattedDate");

    double v17 = [(ICNoteResultsCellConfiguration *)self invitation];
    double v18 = [v17 contentDescription];

    double v19 = +[NSBundle mainBundle];
    double v20 = [v19 localizedStringForKey:@"Shared with me via iCloud" value:&stru_186B0 table:0];
  ...
  else
  {
    ...
    id v27 = objc_msgSend(v16, "paragraphRangeForRange:", 0, 0);
    double v18 = objc_msgSend(v16, "substringWithRange:", v27, v28);
    double v20 = 0;
    if ([(ICNoteResultsCellConfiguration *)self showPinnedBadge])
    {
      double v29 = +[NSBundle mainBundle];
      double v20 = [v29 localizedStringForKey:@"pinned" value:&stru_186B0 table:0];
    }
    v30 = [(ICNoteResultsCellConfiguration *)self note];
    uint64_t v31 = [v30 folderName];

    v32 = +[NSBundle mainBundle];
    uint64_t v33 = [v32 localizedStringForKey:@"In folder %@" value:&stru_186B0 table:0];
...
LABEL_12:
        [v36 localizedStringForKey:v38 value:&stru_186B0 table:0];
        v56 = v55 = 0;
        id v39 = v18;
        double v18 = 0;
        goto LABEL_21;
      case 3uLL:
        ...
        v55 = [v42 localizedStringForKey:v43 value:&stru_186B0 table:0];
        v56 = 0;
        goto LABEL_21;
      case 4uLL:
        objc_opt_class();
        ...
        v37 = [v46 localizedStringForKey:v48 value:&stru_186B0 table:0];
...
LABEL_21:
    ...
    if ([v51 isSharedViaICloud] && objc_msgSend(v51, "hasUnreadChanges"))
    {
      ...
      v53 = [v52 localizedStringForKey:@"has unread changes" value:&stru_186B0 table:0];
