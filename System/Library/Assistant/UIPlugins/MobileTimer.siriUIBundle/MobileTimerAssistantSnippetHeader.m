...
{
  v6.receiver = self;
  v6.super_class = (Class)MobileTimerAssistantSnippetHeader;
  v3 = -[MobileTimerAssistantSnippetHeader initWithFrame:](&v6, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3) {
...
- (void)setupTitleLabel
{
  ...
  objc_super v6 = +[UIFont _preferredFontForTextStyle:UIFontTextStyleBody maximumContentSizeCategory:UIContentSizeCategoryAccessibilityLarge];
  ...
  id v9 = [(MobileTimerAssistantSnippetHeader *)self titleLabel];
