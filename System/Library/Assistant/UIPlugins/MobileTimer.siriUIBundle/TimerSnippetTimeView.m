...
{
  v13.receiver = self;
  v13.super_class = (Class)TimerSnippetTimeView;
  v3 = -[TimerSnippetTimeView initWithFrame:](&v13, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v8 = objc_msgSend(v7, "mtui_fontByAddingTimeFontAttributes");
...
- (void)setupConstraints
{
  ...
  id v4 = [(TimerSnippetTimeView *)self centerXAnchor];
...
- (void)setRemainingTime:(double)a3
{
  ...
  -[TimerSnippetTimeView setupWithDuration:](self, "setupWithDuration:");
}
...
- (BOOL)updateDisplayWithTime:(double)a3
{
  ...
  double v4 = fmax(self->_fireTime - round(a3), 0.0);
  v5 = FormatTime();
