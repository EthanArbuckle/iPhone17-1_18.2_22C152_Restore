...
- (CLLocation)clRepresentation
{
  ...
  [v7 doubleValue];
  id v9 = [v3 initWithLatitude:v6 longitude:v8];
...
- (NSDictionary)locationActivityMetaData
{
  ...
  if (v4)
  {
    double v5 = [(SALocation *)self label];
    double v6 = +[_DKLocationApplicationActivityMetadataKey locationName];
  ...
  if (v7)
  {
    double v8 = [(SALocation *)self city];
    id v9 = +[_DKLocationApplicationActivityMetadataKey city];
...
- (BOOL)isRegionCity
{
  ...
  unsigned __int8 v3 = [v2 isEqualToString:SARegionTypeCityValue];
...
{
  v2 = [(SALocation *)self regionType];
  unsigned __int8 v3 = [v2 isEqualToString:SARegionTypeCountyValue];
...
{
  v2 = [(SALocation *)self regionType];
  unsigned __int8 v3 = [v2 isEqualToString:SARegionTypeStateValue];
...
{
  v2 = [(SALocation *)self regionType];
  unsigned __int8 v3 = [v2 isEqualToString:SARegionTypeCountryValue];
