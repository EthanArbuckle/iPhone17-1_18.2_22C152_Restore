...
- (SiriGKVideoPod)initWithPod:(id)a3 safariBackURL:(id)a4 usingPersistentStore:(id)a5;
@end
...
- (SiriGKVideoPod)initWithPod:(id)a3 safariBackURL:(id)a4 usingPersistentStore:(id)a5
{
  ...
  id v10 = a5;
  v27.receiver = self;
  v27.super_class = (Class)SiriGKVideoPod;
    ...
    if (v15)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v19 = [[SiriGKImageLinkView alloc] initWithImageLinkedAnswer:*(void *)(*((void *)&v23 + 1) + 8 * (void)v18) safariBackURL:v9 isVideoResult:1 usingPersistentStore:v10];
