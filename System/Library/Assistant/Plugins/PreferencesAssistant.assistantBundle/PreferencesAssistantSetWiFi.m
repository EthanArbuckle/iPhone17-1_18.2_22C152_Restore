...
{
  v4 = (void (**)(id, void *))a3;
  id v5 = +[PSWiFiSettingsDetail isEnabled];
  [(PreferencesAssistantSetWiFi *)self failOnSiriDisconnectWarnings];
  if ([(PreferencesAssistantSetWiFi *)self toggle]) {
    id v6 = (id)(v5 ^ 1);
  }
  else {
    id v6 = [(PreferencesAssistantSetWiFi *)self value];
  }
  unsigned int v7 = [(PreferencesAssistantSetWiFi *)self dryRun];
  if (v5 == v6)
  {
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v19[22] = 2112;
    ...
    __int16 v21 = 2112;
    id v22 = v8;
    _os_log_impl(&dword_0, v10, OS_LOG_TYPE_DEFAULT, "########## PreferencesAssistantSetWiFi (%@ / prev: %@ / value: %@ / %@)", v19, 0x2Au);
  }
