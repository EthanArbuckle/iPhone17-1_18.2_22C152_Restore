...
- (void)performWithCompletion:(id)a3 serviceHelper:(id)a4
{
  ...
  {
    LOWORD(v18) = 0;
    _os_log_impl(&dword_0, v7, OS_LOG_TYPE_DEFAULT, "########## PAOpenSiri", (uint8_t *)&v18, 2u);
  }

  v8 = (void *)MCFeatureSafariAllowed;
  BOOL v9 = sub_6234(MCFeatureSafariAllowed);
  int v10 = sub_6298(v8);
  int v11 = v10;
  if (v9 && (v10 & 1) != 0)
  {
