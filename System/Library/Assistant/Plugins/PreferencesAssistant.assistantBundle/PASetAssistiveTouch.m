@interface PASetAssistiveTouch
- (void)performWithCompletion:(id)a3;
@end

@implementation PASetAssistiveTouch

- (void)performWithCompletion:(id)a3
{
  v4 = (void (**)(id, void *))a3;
  id v5 = +[PSAssistiveTouchSettingsDetail isEnabled];
  if ([(PASetAssistiveTouch *)self toggle]) {
    id v6 = (id)(v5 ^ 1);
  }
  else {
    id v6 = [(PASetAssistiveTouch *)self value];
  }
  unsigned int v7 = [(PASetAssistiveTouch *)self dryRun];
  if (v5 == v6)
  {
    ...
    if ((v10 & 1) == 0)
    {
      +[PSAssistiveTouchSettingsDetail setEnabled:v6];
      BOOL v9 = 0;
    }
  }
  else
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v20[22] = 2112;
    ...
    __int16 v22 = 2112;
    id v23 = v8;
    _os_log_impl(&dword_0, v11, OS_LOG_TYPE_DEFAULT, "########## PASetAssistiveTouch (%@ / prev: %@ / value: %@ / %@)", v20, 0x2Au);
  }
