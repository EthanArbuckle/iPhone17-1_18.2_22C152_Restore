...
{
  v2 = [(NSUserActivity *)self contentAttributeSet];
  unsigned __int8 v3 = [v2 phoneNumbers];
  BOOL v4 = [v3 count] != 0;
...
- (id)clientUserActivity
{
  id v3 = objc_alloc_init((Class)SAClientUserActivity);
  BOOL v4 = [(NSUserActivity *)self _uniqueIdentifier];
  v5 = [v4 UUIDString];
  [v3 setAceId:v5];

  objc_msgSend(v3, "setIsEligibleForDirections:", -[NSUserActivity hasLocationData](self, "hasLocationData"));
  objc_msgSend(v3, "setIsEligibleForAppPunchout:", -[NSUserActivity hasPhoneNumber](self, "hasPhoneNumber"));
  ...
  objc_msgSend(v3, "setIsEligibleForSearch:", -[NSUserActivity isEligibleForSearch](self, "isEligibleForSearch"));
  objc_msgSend(v3, "setIsEligibleForPublicIndexing:", -[NSUserActivity isEligibleForPublicIndexing](self, "isEligibleForPublicIndexing"));
  objc_msgSend(v3, "setIsEligibleForHandoff:", -[NSUserActivity isEligibleForHandoff](self, "isEligibleForHandoff"));
...
- (id)combinedUserInfo
{
  id v3 = [(NSUserActivity *)self userInfo];
  BOOL v4 = +[NSMutableDictionary dictionaryWithDictionary:v3];
