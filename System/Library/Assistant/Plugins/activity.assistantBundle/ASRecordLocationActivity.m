...
LABEL_8:
    ...
    id v13 = [objc_alloc((Class)SACommandFailed) initWithReason:v11];
    v14 = [v13 dictionary];
    v4[2](v4, v14);
...
- (id)_activityFromLocation:(id)a3 sourceType:(id)a4
{
  ...
  CFStringRef v11 = @"com.apple.siri";
  if (([v6 isEqualToString:@"Default"] & 1) == 0
    && [v6 isEqualToString:@"HomePod"])
  {
    CFStringRef v11 = @"com.apple.siri.homepod";
  }
  [v8 setType:v11];
...
- (id)_locationMetadataFromLocation:(id)a3
{
  ...
  {
    id v13 = +[_DKLocationApplicationActivityMetadataKey locationName];
