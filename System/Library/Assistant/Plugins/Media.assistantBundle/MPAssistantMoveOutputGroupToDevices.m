...
- (void)performWithCompletion:(id)a3
{
  ...
  if (![(NSString *)self->_requestAceHash length])
  {
    ...
    sub_1D4244ECC(@"Move Output Group To Devices", v5);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v9;
    _os_log_impl(&dword_1D422A000, v8, OS_LOG_TYPE_DEFAULT, "Move Output Group To Devices (invoke) <%{public}@>: invoked", buf, 0xCu);
  }

  v10 = self->_requestAceHash;
  v11 = [(MPAssistantMoveOutputGroupToDevices *)self hashedRouteUIDs];
  sub_1D4245018(@"Move Output Group To Devices", v10, v11);
