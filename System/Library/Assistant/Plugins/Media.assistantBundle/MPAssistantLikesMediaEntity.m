...
- (void)_performWithCompletion:(id)a3
{
  ...
  id v9 = v4;
  id v7 = v4;
  sub_1D4245514(@"Likes Media Entity", requestAceHash, 21, userIdentity, v8);
}
...
- (void)performWithCompletion:(id)a3
{
  ...
  if (![(NSString *)self->_requestAceHash length])
  {
    ...
    sub_1D4244ECC(@"Likes Media Entity", v5);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v9;
    _os_log_impl(&dword_1D422A000, v8, OS_LOG_TYPE_DEFAULT, "Likes Media Entity (invoke) <%{public}@>: invoked", buf, 0xCu);
  }
  ...
  id v15 = v4;
  id v13 = v4;
  sub_1D4246230(@"Likes Media Entity", v10, v11, v12, v14);
}
