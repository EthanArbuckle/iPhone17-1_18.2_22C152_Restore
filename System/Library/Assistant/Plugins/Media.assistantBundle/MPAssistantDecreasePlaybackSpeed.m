...
- (void)performWithCompletion:(id)a3
{
  ...
  if (![(NSString *)self->_requestAceHash length])
  {
    ...
    sub_1D4244ECC(@"Decrease Playback Speed", v6);
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1D422A000, v9, OS_LOG_TYPE_DEFAULT, "Decrease Playback Speed (invoke) <%{public}@>: %lu UIDs", buf, 0x16u);
  }
  v12 = self->_requestAceHash;
  v13 = [(MPAssistantDecreasePlaybackSpeed *)self hashedRouteUIDs];
  sub_1D4245018(@"Decrease Playback Speed", v12, v13);
