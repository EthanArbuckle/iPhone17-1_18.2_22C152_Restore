@interface MKMapItem
+ (MKMapItem)mapItemWithLocalSearchMapItem:(id)a3;
...
+ (MKMapItem)mapItemWithLocalSearchMapItem:(id)a3
{
  return (MKMapItem *)[a1 mapItemWithLocalSearchMapItem:a3 reservationDelegate:0];
}
...
+ (MKMapItem)mapItemWithLocalSearchMapItem:(id)a3 reservationDelegate:(id)a4
{
  if (a3)
  {
    ...
    v12 = objc_msgSend(v11, "_ma_reservationInfoWithDelegate:", v5);
...
- (id)_ma_detourText
{
  ...
  if (v3)
  {
    ...
    v3 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v12, v10);
  }
