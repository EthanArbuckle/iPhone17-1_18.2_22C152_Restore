...
{
  if (qword_55CD8 != -1) {
    dispatch_once(&qword_55CD8, &stru_30838);
  }
  v8 = +[NSLocale _ma_locale];
  [(id)qword_55CD0 setLocale:v8];

  v9 = +[NSNumberFormatter _ma_sharedNumberFormatterWithStyle:1 fractionDigits:a3];
  [(id)qword_55CD0 setNumberFormatter:v9];

  [(id)qword_55CD0 setUnitOptions:a4];
  [(id)qword_55CD0 setUnitStyle:a5];
  v10 = (void *)qword_55CD0;
