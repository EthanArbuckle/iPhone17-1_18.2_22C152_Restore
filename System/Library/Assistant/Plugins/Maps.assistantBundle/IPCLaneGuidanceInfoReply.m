...
- (IPCLaneGuidanceInfoReply)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v14 = IPCMessageGetServerFormattedInstructionArrayForKey(v4, @"kIPCLaneGuidanceInfoReplyInstructionsKey");
    [(IPCLaneGuidanceInfoReply *)v5 setTextAlternatives:v14];

    v15 = IPCMessageGetServerFormattedInstructionArrayForKey(v4, @"kIPCLaneGuidanceInfoReplyMidStepKey");
...
- (id)dictionaryValue
{
  ...
  id v3 = [(IPCMessageObject *)&v16 dictionaryValue];
...
- (id)description
{
  ...
  id v3 = [(IPCLaneGuidanceInfoReply *)&v11 description];
