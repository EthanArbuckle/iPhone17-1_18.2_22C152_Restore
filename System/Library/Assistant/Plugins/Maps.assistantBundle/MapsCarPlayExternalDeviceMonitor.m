...
{
  if (qword_55D28 != -1) {
    dispatch_once(&qword_55D28, &stru_30CC8);
  }
  v2 = (void *)qword_55D30;
...
- (MapsCarPlayExternalDeviceMonitor)init
{
  ...
  if (v2)
  {
    ...
    {
      LOWORD(buf[0]) = 0;
      _os_log_impl(&dword_0, v3, OS_LOG_TYPE_DEFAULT, "Initializing", (uint8_t *)buf, 2u);
    }
...
- (void)_populateExternalDevice
{
  ...
  dispatch_queue_t v5 = +[AVExternalDevice currentCarPlayExternalDevice];
  ...
  {
    uint64_t v8 = self->_externalDevice;
