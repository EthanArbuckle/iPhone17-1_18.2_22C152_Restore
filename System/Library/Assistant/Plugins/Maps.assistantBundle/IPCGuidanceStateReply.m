...
- (IPCGuidanceStateReply)initWithDictionary:(id)a3
{
  ...
  uint64_t v6 = [v4 objectForKeyedSubscript:@"kIPCGuidanceStateReplyGuidanceStateKey"];
  ...
  uint64_t v8 = [v4 objectForKeyedSubscript:@"kIPCGuidanceStateReplyAffectsDimmingKey"];
...
- (id)dictionaryValue
{
  ...
  uint64_t v8 = +[NSNumber numberWithInt:[(IPCGuidanceStateReply *)self transportType]];
...
- (id)description
{
  ...
  v20 = MapsMap(v3, &stru_417E8);

  id v4 = [(IPCGuidanceStateReply *)self secondaryInstructions];
  v19 = MapsMap(v4, &stru_41808);
  ...
  v14 = [(IPCGuidanceStateReply *)self originalWaypointRouteData];
...
- (id)shortDescription
{
  ...
  uint64_t v8 = [(IPCGuidanceStateReply *)self distance];
  [v8 doubleValue];
...
- (BOOL)isArriving
{
  ...
  BOOL v3 = [v2 arrivalState] == (char *)&dword_0 + 2;
...
- (BOOL)isArrived
{
  ...
  else
  {
    ...
    char v4 = [v5 arrivalState] == (char *)&dword_0 + 3;
  }
  return v4;
}
...
{
  BOOL v3 = [(IPCGuidanceStateReply *)self arrivalInfo];
  if ([v3 arrivalState] == (char *)&dword_4 + 1)
  {
    char v4 = 1;
  }
  else
  {
    v5 = [(IPCGuidanceStateReply *)self arrivalInfo];
    char v4 = [v5 arrivalState] == (char *)&dword_4 + 2;
  }
  return v4;
}
...
{
  v2 = [(IPCGuidanceStateReply *)self arrivalInfo];
  BOOL v3 = [v2 arrivalState] == (char *)&dword_0 + 1;
