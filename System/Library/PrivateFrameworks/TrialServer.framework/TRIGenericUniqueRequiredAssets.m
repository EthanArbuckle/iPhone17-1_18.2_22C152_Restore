...
- (TRIGenericUniqueRequiredAssets)initWithCloudKit:(id)a3 mobileAsset:(id)a4
{
  ...
  else
  {
    ...
    [v14 handleFailureInMethod:a2, self, @"TRIServerTupleTypes.m", 3608, @"Invalid parameter not satisfying: %@", @"cloudKit != nil" object file lineNumber description];
  ...
  [v15 handleFailureInMethod:a2, self, @"TRIServerTupleTypes.m", 3609, @"Invalid parameter not satisfying: %@", @"mobileAsset != nil" object file lineNumber description];
...
- (BOOL)isEqualToAssets:(id)a3
{
  ...
  {
    v10 = [v5 cloudKit];
    int v11 = [(NSDictionary *)cloudKit isEqual:v10];
...
LABEL_8:
  ...
  else
  {
    ...
    if (mobileAsset)
    {
      ...
      char v17 = [(NSDictionary *)mobileAsset isEqual:v16];
    }
    else
    {
      char v17 = 1;
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (TRIGenericUniqueRequiredAssets *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(TRIGenericUniqueRequiredAssets *)self isEqualToAssets:v5];
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSDictionary *)self->_cloudKit hash];
  return [(NSDictionary *)self->_mobileAsset hash] - v3 + 32 * v3;
}

- (id)description
{
  v2 = (void *)[[NSString alloc] initWithFormat:@"<TRIGenericUniqueRequiredAssets | cloudKit:%@ mobileAsset:%@>", self->_cloudKit, self->_mobileAsset];
  return v2;
}
