...
- (BOOL)isUnmanagedToManagedPasteAllowed
{
  if (![(MCProfileConnection *)self isManagedPasteboardRequired]
    || ![(MCProfileConnection *)self isOpenInRestrictionInEffect])
  {
    return 1;
  }
  ...
  if ((-[MCProfileConnection isBundleIDAccountBasedForDragDrop:](self, "isBundleIDAccountBasedForDragDrop:", v6) & 1) != 0|| [v6 isEqualToString:@"com.apple.UIKitester"])
  {
    if (!a4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_FAULT))
      {
        int v9 = 138543362;
        id v10 = v6;
        _os_log_fault_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_FAULT, "Account-based app tried to access the pasteboard with an undefined data owner: %{public}@", (uint8_t *)&v9, 0xCu);
      }
