...
- (TSUAggregateEnumerator)initWithObjects:(id)a3;
- (id)nextObject;
...
{
  v10.receiver = self;
  v10.super_class = (Class)TSUAggregateEnumerator;
  v11 = a4;
...
- (TSUAggregateEnumerator)initWithObjects:(id)a3
{
  return [(TSUAggregateEnumerator *)self initWithFirstObject:a3 argumentList:&v4];
}
...
- (TSUAggregateEnumerator)init
{
  return [(TSUAggregateEnumerator *)self initWithObjects:0];
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)TSUAggregateEnumerator;
