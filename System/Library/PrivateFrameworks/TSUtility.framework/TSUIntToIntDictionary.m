...
- (TSUIntToIntDictionary)init
{
  return [(TSUIntToIntDictionary *)self initWithCapacity:0];
}
...
- (TSUIntToIntDictionary)initWithCapacity:(unint64_t)a3
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)TSUIntToIntDictionary;
...
- (id)arrayOfBoxedKeys
{
  size_t v3 = [(TSUIntToIntDictionary *)self count];
  CFIndex v4 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[TSUIntToIntDictionary count](self, "count"));
...
- (id)mutableCopyWithZone:(_NSZone *)a3
{
  id v4 = objc_alloc_init(TSUIntToIntDictionary);
...
- (id)description
{
  id v3 = [(TSUIntToIntDictionary *)self keyEnumerator];
  ...
  if (v5 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    {
      int64_t v7 = [(TSUIntToIntDictionary *)self intForKey:i];
