...
- (void)dealloc
{
  ...
  {
    MEMORY[0x223C9F9B0]();
    NSZoneFree((NSZone *)[(SFURegularExpression *)self zone], self->_reserved);
  }
  v3.receiver = self;
  v3.super_class = (Class)SFURegularExpression;
  [(SFURegularExpression *)&v3 dealloc];
}

- (SFURegularExpression)initWithExpressionString:(id)a3
{
  return [(SFURegularExpression *)self initWithExpressionString:a3 options:0];
}
...
- (SFURegularExpression)initWithExpressionString:(id)a3 options:(unsigned int)a4
{
  ...
  id v6 = [(SFURegularExpression *)&v14 init];
  if (v6)
  {
    size_t v7 = [a3 length];
    CFIndex v8 = v7;
    ...
    *((void *)v6 + 2) = v10;
    ...
    if (v12)
    {
      NSLog((NSString *)@"*** %s: error %d", "-[SFURegularExpression initWithExpressionString:options:]", v12);
...
- (SFURegularExpression)init
{
  return [(SFURegularExpression *)self initWithExpressionString:&stru_26D4F03D0];
}

- (id)copyWithZone:(_NSZone *)a3
{
  if ((_NSZone *)[(SFURegularExpression *)self zone] == a3)
  {
    return self;
  }
  else
...
- (_NSRange)matchedRangeForCString:(const char *)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  unint64_t v11 = a6;
  unint64_t v12 = a6;
  if ([(SFURegularExpression *)self numberOfSubexpressions] < a6) {
    unint64_t v12 = [(SFURegularExpression *)self numberOfSubexpressions];
  }
  unint64_t v13 = v12 + 1;
  if (v12 + 1 >= 6) {
...
- (_NSRange)matchedRangeForString:(id)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  uint64_t v12 = -[SFURegularExpression matchedRangeForCString:range:subexpressionRanges:count:](self, "matchedRangeForCString:range:subexpressionRanges:count:", [(__CFData *)ASCIIData bytes], location, length, a5, v6);
  NSUInteger v14 = v13;
...
- (SFURegularExpression)initWithCoder:(id)a3
{
  ...
  return [(SFURegularExpression *)self initWithExpressionString:v9];
}
