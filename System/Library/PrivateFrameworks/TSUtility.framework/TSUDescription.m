...
- (TSUDescription)initWithObject:(id)a3 format:(id)a4
{
  return [(TSUDescription *)self initWithObject:a3 class:object_getClass(a3) format:a4 arguments:&v5];
}

- (TSUDescription)initWithObject:(id)a3
{
  Class Class = object_getClass(a3);
  return [(TSUDescription *)self initWithObject:a3 class:Class format:&stru_26D4F03D0];
}

+ (id)descriptionWithObject:(id)a3 class:(Class)a4 format:(id)a5
{
  return [[TSUDescription alloc] initWithObject:a3 class:a4 format:a5 arguments:&v6];
}

+ (id)descriptionWithObject:(id)a3 format:(id)a4
{
  return [[TSUDescription alloc] initWithObject:a3 class:object_getClass(a3) format:a4 arguments:&v5];
}

+ (id)descriptionWithObject:(id)a3 class:(Class)a4
{
  v4 = [[TSUDescription alloc] initWithObject:a3 class:a4 format:&stru_26D4F03D0];
  return v4;
}
...
+ (id)descriptionWithCFType:(void *)a3 format:(id)a4
{
  ...
  uint64_t v6 = [[TSUDescription alloc] initWithCFType:a3 header:v5];
...
+ (id)descriptionWithObject:(id)a3
{
  return (id)[a1 descriptionWithObject:a3 format:&stru_26D4F03D0];
}
...
- (void)addSuperDescription
{
  ...
  id v5 = [(TSUDescription *)&v6 description];
...
LABEL_5:
    id v3 = [(TSUDescription *)self p_header];
    goto LABEL_6;
  }
  v4 = (void *)[MEMORY[0x263F089D8] stringWithFormat:@"%@ {", -[TSUDescription p_header](self, "p_header")];
