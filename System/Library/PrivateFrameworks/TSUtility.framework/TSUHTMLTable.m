...
+ (id)_keyForCell:(unint64_t)a3 :(unint64_t)a4
{
  return (id)objc_msgSend(NSString, "stringWithFormat:", @"%lu,%lu", a3, a4);
}
...
- (id)markup
{
  ...
  context = (void *)MEMORY[0x223C9F510]();
...
- (void)addRowWithCellText:(id)a3
{
  uint64_t v4 = objc_msgSend(a3, "tsu_arrayByTransformingWithBlock:", &__block_literal_global_6);
...
uint64_t __35__TSUHTMLTable_addRowWithCellText___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    return [v3 componentsJoinedByString:&stru_26D4F03D0];
  }
  else
  {
...
- (void)deleteColumnWithTitle:(id)a3
{
  unint64_t v4 = [(TSUHTMLTable *)self indexOfColumnWithTitle:a3];
