...
- (TSUCustomCallBackDictionary)initWithCFDictionary:(__CFDictionary *)a3;
- (TSUCustomCallBackDictionary)initWithCapacity:(unint64_t)a3;
- (TSUCustomCallBackDictionary)initWithCapacity:(unint64_t)a3 keyCallBacks:(id *)a4 valueCallBacks:(id *)a5;
- (id)allKeys;
- (id)allValues;
- (id)keyEnumerator;
...
- (TSUCustomCallBackDictionary)init
{
  return [(TSUCustomCallBackDictionary *)self initWithCapacity:0 keyCallBacks:MEMORY[0x263EFFF88] valueCallBacks:MEMORY[0x263EFFF90]];
}

- (TSUCustomCallBackDictionary)initWithCFDictionary:(__CFDictionary *)a3
{
  v6.receiver = self;
  v6.super_class = (Class)TSUCustomCallBackDictionary;
...
- (TSUCustomCallBackDictionary)initWithCapacity:(unint64_t)a3
{
  return [(TSUCustomCallBackDictionary *)self initWithCapacity:a3 keyCallBacks:MEMORY[0x263EFFF88] valueCallBacks:MEMORY[0x263EFFF90]];
}

- (TSUCustomCallBackDictionary)initWithCapacity:(unint64_t)a3 keyCallBacks:(id *)a4 valueCallBacks:(id *)a5
{
  v10.receiver = self;
  v10.super_class = (Class)TSUCustomCallBackDictionary;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)TSUCustomCallBackDictionary;
...
- (id)objectEnumerator
{
  id v2 = [(TSUCustomCallBackDictionary *)self allValues];
...
- (id)keyEnumerator
{
  id v2 = [(TSUCustomCallBackDictionary *)self allKeys];
  return (id)[v2 objectEnumerator];
}
