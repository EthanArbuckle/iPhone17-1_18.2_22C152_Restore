...
{
  v8.receiver = self;
  v8.super_class = (Class)SFUJsonScanner;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SFUJsonScanner;
...
- (id)parseHexCharacter
{
  ...
  while (1)
  {
    int v5 = [(SFUJsonScanner *)self nextCharacter];
    __int16 v6 = v5 - 48;
    if ((v5 - 48) >= 0xA) {
      break;
    }
...
- (id)parseString
{
  ...
  while (2)
  {
    ...
    while (1)
    {
      unsigned int v6 = [(SFUJsonScanner *)self nextCharacter];
      if (v6 == 34)
      {
        -[SFUJsonScanner appendCharactersInRange:toString:](self, "appendCharactersInRange:toString:", mOffset, v5, v4);
        return v4;
      }
      unsigned int v7 = v6;
      if (v6 == 92) {
    ...
    -[SFUJsonScanner appendCharactersInRange:toString:](self, "appendCharactersInRange:toString:", mOffset, v5, v4);
    int v9 = [(SFUJsonScanner *)self nextCharacter];
    id result = 0;
    if (v9 > 97)
    {
      switch(v9)
      {
        ...
        case 't':
          ...
          goto LABEL_26;
        case 'u':
          id result = [(SFUJsonScanner *)self parseHexCharacter];
...
- (id)parseDictionaryWithMaxDepth:(int)a3
{
  ...
  if ((int)v8 < 0 == v7 && v5 == 123)
  {
    ...
    else
    {
      ...
      id result = [(SFUJsonScanner *)self parseString];
      if (result)
      {
        id v12 = result;
        while (1)
        {
          ...
          [(SFUJsonScanner *)self skipWhitespace];
          id result = [(SFUJsonScanner *)self parseObjectWithMaxDepth:v8];
          if (!result) {
            return result;
          }
          [v11 setObject:result forKey:v12];
          [(SFUJsonScanner *)self skipWhitespace];
          int v13 = [(SFUJsonScanner *)self nextCharacter];
          if (v13 != 44) {
            break;
          }
          [(SFUJsonScanner *)self skipWhitespace];
...
- (BOOL)parseConstantString:(const char *)a3
{
  ...
  do
  {
    BOOL result = [(SFUJsonScanner *)self nextCharacter] == *(v4 - 1);
    if (!result) {
      break;
    }
  }
...
{
  unint64_t mOffset = self->mOffset;
  uint64_t v4 = [(SFUJsonScanner *)self nextCharacter];
  if (v4 == 45) {
    uint64_t v4 = [(SFUJsonScanner *)self nextCharacter];
  }
  if ([(NSCharacterSet *)self->mDecimalDigitCharacterSet characterIsMember:v4])
  {
    do
    {
      uint64_t v5 = [(SFUJsonScanner *)self nextCharacter];
      if (!v5) {
        goto LABEL_17;
      }
      int v6 = v5;
    ...
    if (v6 == 46)
    {
      if (![(NSCharacterSet *)self->mDecimalDigitCharacterSet characterIsMember:[(SFUJsonScanner *)self nextCharacter]])return 0; {
      do
      }
      {
        uint64_t v7 = [(SFUJsonScanner *)self nextCharacter];
        if (!v7) {
          goto LABEL_17;
        }
        int v6 = v7;
...
LABEL_17:
    ...
    uint64_t v8 = [(SFUJsonScanner *)self nextCharacter];
    if (v8 == 45 || (uint64_t v9 = v8, v8 == 43)) {
      uint64_t v9 = [(SFUJsonScanner *)self nextCharacter];
    }
    if ([(NSCharacterSet *)self->mDecimalDigitCharacterSet characterIsMember:v9])
    {
      do
        uint64_t v10 = [(SFUJsonScanner *)self nextCharacter];
      while (v10
