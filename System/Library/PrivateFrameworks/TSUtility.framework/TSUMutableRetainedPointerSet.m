...
@implementation TSUMutableRetainedPointerSet

- (TSUMutableRetainedPointerSet)init
{
  if ([(TSUMutableRetainedPointerSet *)self isMemberOfClass:objc_opt_class()])
  {
    return [(TSUMutableRetainedPointerSet *)self initWithCapacity:0];
  }
  else
  {
    v4.receiver = self;
    v4.super_class = (Class)TSUMutableRetainedPointerSet;
...
{
  v8.receiver = self;
  v8.super_class = (Class)TSUMutableRetainedPointerSet;
  objc_super v4 = [(TSUMutablePointerSet *)&v8 init];
  if (v4)
  {
    v7.version = 0;
