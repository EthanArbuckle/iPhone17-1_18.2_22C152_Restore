...
- (void)main
{
  ...
  objc_msgSend(v6, "setIc_debugName:", @"ImageClassificationOperationContext");
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v27 = 1024;
    int v28 = v19;
    _os_log_debug_impl(&dword_1B08EB000, v14, OS_LOG_TYPE_DEBUG, "%@ %@ %@ image classifcation %d", buf, 0x26u);
  }
}
...
void __64__ICAttachmentPreviewGeneratorImageClassificationOperation_main__block_invoke_13(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    int v4 = 138412290;
    uint64_t v5 = v3;
    _os_log_impl(&dword_1B08EB000, v2, OS_LOG_TYPE_INFO, "Skipping image classification for attachment because it is either cancelled or not needed: %@", (uint8_t *)&v4, 0xCu);
  }
}
...
void __64__ICAttachmentPreviewGeneratorImageClassificationOperation_main__block_invoke_cold_1(id *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v8 = 2112;
  uint64_t v9 = a2;
  _os_log_error_impl(&dword_1B08EB000, a3, OS_LOG_TYPE_ERROR, "Error getting object from ID %@ for image classification %@", (uint8_t *)&v6, 0x16u);
}
