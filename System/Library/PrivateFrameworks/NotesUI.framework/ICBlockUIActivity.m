...
- (ICBlockUIActivity)init;
- (ICBlockUIActivity)initWithBlock:(id)a3;
- (ICBlockUIActivity)initWithTitle:(id)a3 block:(id)a4;
- (ICBlockUIActivity)initWithTitle:(id)a3 image:(id)a4 activityType:(id)a5 block:(id)a6;
- (ICBlockUIActivity)initWithTitle:(id)a3 image:(id)a4 block:(id)a5;
- (ICBlockUIActivity)initWithTitle:(id)a3 systemImageName:(id)a4 activityType:(id)a5 block:(id)a6;
- (ICBlockUIActivity)initWithTitle:(id)a3 systemImageName:(id)a4 block:(id)a5;
- (NSString)title;
- (NSString)type;
- (UIImage)image;
- (id)activityType;
...
- (ICBlockUIActivity)init
{
  return [(ICBlockUIActivity *)self initWithBlock:&__block_literal_global_87];
}

- (ICBlockUIActivity)initWithBlock:(id)a3
{
  return [(ICBlockUIActivity *)self initWithTitle:0 block:a3];
}

- (ICBlockUIActivity)initWithTitle:(id)a3 block:(id)a4
{
  return [(ICBlockUIActivity *)self initWithTitle:a3 image:0 activityType:0 block:a4];
}

- (ICBlockUIActivity)initWithTitle:(id)a3 image:(id)a4 block:(id)a5
{
  return [(ICBlockUIActivity *)self initWithTitle:a3 image:a4 activityType:0 block:a5];
}

- (ICBlockUIActivity)initWithTitle:(id)a3 systemImageName:(id)a4 block:(id)a5
{
  return [(ICBlockUIActivity *)self initWithTitle:a3 systemImageName:a4 activityType:0 block:a5];
}
...
- (ICBlockUIActivity)initWithTitle:(id)a3 image:(id)a4 activityType:(id)a5 block:(id)a6
{
  ...
  id v14 = a6;
  v20.receiver = self;
  v20.super_class = (Class)ICBlockUIActivity;
