...
- (NSString)accountId
{
  return (NSString *)sub_1B0AF6540((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___ICThumbnailKey_accountId);
}

- (NSString)objectId
{
  return (NSString *)sub_1B0AF6540((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___ICThumbnailKey_objectId);
}
...
- (ICThumbnailKey)initWithType:(int64_t)a3 accountId:(id)a4 objectId:(id)a5 preferredSize:(CGSize)a6 scale:(double)a7 appearance:(unint64_t)a8 isRTL:(BOOL)a9 contentSizeCategory:(id)a10 hasBoldText:(BOOL)a11 hasButtonShapes:(BOOL)a12 hasDarkerSystemColors:(BOOL)a13 hasBorder:(BOOL)a14
{
  ...
  if (a4)
  {
    v20 = (void *)sub_1B0B8240C();
    uint64_t v22 = v21;
    if (v18)
    {
LABEL_3:
      uint64_t v18 = sub_1B0B8240C();
      uint64_t v24 = v23;
      goto LABEL_6;
    }
  }
...
LABEL_6:
  ...
  return (ICThumbnailKey *)sub_1B0AF9028(a3, v20, v22, v18, v24, a8, v25, v27, width, height, a7, a11, a13, a14);
}
...
- (NSURL)containerUrl
{
  ...
  uint64_t v7 = self;
  sub_1B0AF5F88((uint64_t)v6);

  uint64_t v8 = (void *)sub_1B0B7FB8C();
...
- (NSURL)descriptionUrl
{
  return (NSURL *)sub_1B0AF78A0(self, (uint64_t)a2, MEMORY[0x1E4FBCE78]);
}

- (NSURL)imageUrl
{
  return (NSURL *)sub_1B0AF78A0(self, (uint64_t)a2, MEMORY[0x1E4FBCE50]);
}
