...
- (CGPoint)randomErrorForKeyString:(id)a3 rect:(CGRect)a4
{
  ...
  *(float *)&double v11 = self->_perTouchStdevY;
  ...
  if ([v9 isEqualToString:@" "]
    && [(TIErrorGenerator *)self spaceHorizontalErrorMode] == 1)
  {
...
- (TIGaussianErrorGenerator)initWithAttributes:(id)a3
{
  ...
  double v5 = [(TIErrorGenerator *)&v24 initWithAttributes:v4];
  double v6 = v5;
  if (v5)
  {
    v5->_perTouchStdevX = 0.0;
    v5->_perTouchStdevY = 0.0;
    v5->_float globalStdevX = 0.0;
    v5->_float globalStdevY = 0.0;
    double v7 = [v4 valueForKey:@"GAUSSIAN_ERROR_STDDEV_X"];

    if (v7)
    {
      float v8 = [v4 objectForKey:@"GAUSSIAN_ERROR_STDDEV_X"];
      [v8 floatValue];
      v6->_perTouchStdevX = v9;
    }
    float v10 = [v4 valueForKey:@"GAUSSIAN_ERROR_STDDEV_Y"];

    if (v10)
    {
      float v11 = [v4 objectForKey:@"GAUSSIAN_ERROR_STDDEV_Y"];
      [v11 floatValue];
      v6->_perTouchStdevY = v12;
    }
    double v13 = [v4 valueForKey:@"SKEW_STDDEV_X"];

    if (v13)
    {
      double v14 = [v4 valueForKey:@"SKEW_STDDEV_X"];
      [v14 floatValue];
      v6->_float globalStdevX = v15;
    }
    float v16 = [v4 valueForKey:@"SKEW_STDDEV_Y"];

    if (v16)
    {
      double v17 = [v4 valueForKey:@"SKEW_STDDEV_Y"];
      [v17 floatValue];
      v6->_float globalStdevY = v18;
    }
    CGRect v19 = [v4 valueForKey:@"SCALE_ERROR_UNITS_TO_POINTS"];

    if (v19)
    {
      CGRect v20 = [v4 valueForKey:@"SCALE_ERROR_UNITS_TO_POINTS"];
      [v20 floatValue];
      float v22 = v21;
    }
    else
    ...
    v6->_float globalStdevX = v22 * v6->_globalStdevX;
    v6->_float globalStdevY = v22 * v6->_globalStdevY;
  }
