    ...
    if (v10)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          uint64_t v15 = -[ACTKeyboardLayoutUtils representedStringForKey:shifted:includeSecondaryStrings:](self, "representedStringForKey:shifted:includeSecondaryStrings:", v14, [v9 isShiftKeyplane], v23);
          if ([v7 isEqualToString:v15]) {
            goto LABEL_13;
          }
          uint64_t v16 = [v14 name];
          int v17 = [v16 hasPrefix:@"TenKey-Chinese-Pinyin"];

          if (v17)
          {
            uint64_t v18 = [v14 displayString];
            uint64_t v19 = [v18 rangeOfString:v7 options:1];
...
- (id)representedStringForKey:(id)a3 shifted:(BOOL)a4 includeSecondaryStrings:(BOOL)a5
{
  ...
  int v11 = [v10 isEqualToString:@"Latin-Accents"];
  ...
  if (!v11)
  {
          ...
          !v16))
    {
      ...
      int v17 = [v8 secondaryRepresentedStrings];
  ...
  uint64_t v12 = [(NSMutableDictionary *)self->_keyOverrides objectForKeyedSubscript:*MEMORY[0x263F1D448]];
  id v13 = v12;
  if (v12)
  {
    if ([v12 length] == 2)
...
- (id)substitutesForKey:(id)a3 preferBaseKeyVariants:(BOOL)a4 preferManualShift:(BOOL)a5 substituteUpperCaseForLowerCase:(BOOL)a6
{
  ...
  if ([v10 length] == 1)
  {
    if (v8)
    {
      uint64_t v12 = [(ACTKeyboardLayoutUtils *)self baseKeyForString:v10];
      if (v12) {
        [v11 addObject:v12];
      }
    }
    uint64_t v13 = [v10 characterAtIndex:0];
    id v14 = [MEMORY[0x263F08708] uppercaseLetterCharacterSet];
    LODWORD(v13) = [v14 characterIsMember:v13];

    if (v13 && !a5)
    {
      uint64_t v15 = [v10 lowercaseStringWithLocale:self->_locale];
      [v11 addObject:v15];
      if (v8)
      {
        uint64_t v16 = [(ACTKeyboardLayoutUtils *)self baseKeyForString:v15];
        if (v16) {
          [v11 addObject:v16];
        }
      }
    ...
    if (v6)
    {
      uint64_t v17 = [v10 characterAtIndex:0];
      uint64_t v18 = [MEMORY[0x263F08708] lowercaseLetterCharacterSet];
      LODWORD(v17) = [v18 characterIsMember:v17];

      if (v17)
      {
        id v19 = [v10 uppercaseStringWithLocale:self->_locale];
        [v11 addObject:v19];
        if (v8)
        {
          id v20 = [(ACTKeyboardLayoutUtils *)self baseKeyForString:v19];
          if (v20) {
            [v11 addObject:v20];
          }
        }
...
{
  id v4 = a3;
  BOOL v5 = [[TTKKeyboardPlane alloc] initWithUIKBTree:v4 layoutUtils:self];
...
- (ACTKeyboardLayoutUtils)initWithLocale:(id)a3
{
  ...
  BOOL v6 = [(ACTKeyboardLayoutUtils *)&v10 init];
  if (v6)
  {
