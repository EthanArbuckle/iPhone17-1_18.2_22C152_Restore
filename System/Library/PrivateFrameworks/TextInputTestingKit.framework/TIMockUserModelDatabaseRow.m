...
- (BOOL)isMatchForKeyPrefix:(id)a3 forInputMode:(id)a4 sinceDate:(id)a5
{
  id v8 = a4;
  id v9 = a5;
  BOOL v10 = [(NSString *)self->_key hasPrefix:a3]
     && (!v8 || [v8 isEqualToString:self->_inputMode])
     && [(TIMockUserModelDatabaseRow *)self isMatchSinceDate:v9];
...
- (BOOL)isMatchForKeyPrefix:(id)a3 forInputMode:(id)a4 weeklyKeySuffixes:(id)a5 endDate:(id)a6
{
    ...
    && (!v11 || [v11 isEqualToString:self->_inputMode]))
  {
    ...
    v16 = (unint64_t *)MEMORY[0x263F7E960];
    if (!v15) {
      v16 = (unint64_t *)MEMORY[0x263F7E958];
    }
    v17 = [MEMORY[0x263EFF910] dateWithTimeInterval:v13 sinceDate:-((double)(int)*MEMORY[0x263F7E970] * (double)*v16)];
    if ([(TIMockUserModelDatabaseRow *)self isMatchSinceDate:v17]) {
      BOOL v18 = ![(TIMockUserModelDatabaseRow *)self isMatchSinceDate:v13];
    }
    else {
      LOBYTE(v18) = 0;
    }
...
- (BOOL)isMatchForKey:(id)a3 forInputMode:(id)a4 sinceDate:(id)a5
{
  id v8 = a4;
  id v9 = a5;
  BOOL v10 = [a3 isEqualToString:self->_key]
     && (!v8 || [v8 isEqualToString:self->_inputMode])
     && [(TIMockUserModelDatabaseRow *)self isMatchSinceDate:v9];
...
{
  id v4 = a3;
  BOOL v5 = !v4 || [(NSDate *)self->_lastUpdateDate compare:v4] == NSOrderedDescending;
...
- (TIMockUserModelDatabaseRow)initWithKey:(id)a3 inputMode:(id)a4 value:(id)a5 secondaryValue:(id)a6 realValue:(id)a7 properties:(id)a8 creationDate:(id)a9 lastUpdateDate:(id)a10
{
  ...
  BOOL v18 = [(TIMockUserModelDatabaseRow *)&v28 init];
  v19 = v18;
  if (v18)
  {
