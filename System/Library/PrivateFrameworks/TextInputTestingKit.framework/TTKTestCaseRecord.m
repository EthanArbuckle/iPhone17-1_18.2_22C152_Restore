...
- (NSArray)intendedText
{
  return (NSArray *)[MEMORY[0x263EFF8C0] arrayWithObject:self->_primaryIntendedText];
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        id v10 = objc_msgSend(*(id *)(*((void *)&v17 + 1) + 8 * i), "toJsonDictionary", (void)v17);
        [v4 addObject:v10];
      }
...
- (TTKTestCaseRecord)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    long long v19 = [v4 objectForKey:@"annotations"];
    if (v19)
    {
    ...
    long long v38 = 0u;
    id v26 = v24;
    uint64_t v27 = [v26 countByEnumeratingWithState:&v35 objects:v40 count:16];
    if (v27)
    {
      uint64_t v28 = v27;
      ...
      do
      {
        ...
        do
        {
          ...
          v31 = [[TIContinuousPath alloc] initWithJsonDictionary:*(void *)(*((void *)&v35 + 1) + 8 * v30)];
          [(NSArray *)v25 addObject:v31];

          ++v30;
        }
        while (v28 != v30);
        uint64_t v28 = [v26 countByEnumeratingWithState:&v35 objects:v40 count:16];
      }
      while (v28);
    }
...
- (TTKTestCaseRecord)initWithIntendedText:(id)a3 additionalIntendedTexts:(id)a4 touchDataCollection:(id)a5 recordID:(id)a6 layoutName:(id)a7 inputText:(id)a8 transliteration:(id)a9 context:(id)a10 annotations:(id)a11
{
  ...
  if (v21)
  {
    ...
    uint64_t v23 = [MEMORY[0x263EFF8C0] arrayWithArray:v19];
    ...
    if (v20)
    {
      uint64_t v25 = [MEMORY[0x263EFF9A0] dictionaryWithDictionary:v20];
