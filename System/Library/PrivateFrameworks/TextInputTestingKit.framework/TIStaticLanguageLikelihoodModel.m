...
- (float)_priorProbabilityForLanguage:(id)a3 recipient:(id)a4
{
  ...
  {
    id v11 = [(TIStaticLanguageLikelihoodModel *)self secondaryInputMode];
    uint64_t v12 = [v11 normalizedIdentifier];
...
- (id)rankedLanguagesForRecipient:(id)a3
{
  ...
  id v5 = [(TIStaticLanguageLikelihoodModel *)self primaryInputMode];
  v6 = v5;
  if (v5)
  {
    ...
    [v4 addObject:v8];
    float v9 = [(TIStaticLanguageLikelihoodModel *)self secondaryInputMode];
    float v10 = v9;
    if (v9)
    {
      id v11 = [v9 normalizedIdentifier];
...
- (TIStaticLanguageLikelihoodModel)initWithPrimaryInputMode:(id)a3 secondaryInputMode:(id)a4 secondaryLanguageWeight:(float)a5
{
  ...
  id v11 = [(TIStaticLanguageLikelihoodModel *)&v14 init];
  uint64_t v12 = v11;
  if (v11)
  {
