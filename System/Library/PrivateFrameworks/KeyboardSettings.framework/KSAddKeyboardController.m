...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  [(KSAddKeyboardController *)&v7 viewWillAppear:a3];
  objc_super v4 = (void *)[(KSAddKeyboardController *)self navigationItem];
  v5 = (void *)[(KSAddKeyboardController *)self specifier];
...
- (void)viewDidAppear:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)KSAddKeyboardController;
  [(KSAddKeyboardController *)&v4 viewDidAppear:a3];
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  [(KSAddKeyboardController *)&v5 viewDidDisappear:v3];
}
...
- (id)specifiers
{
  ...
  if (!result)
  {
    id result = [(KSAddKeyboardController *)self newSpecifiers];
...
+ (BOOL)shouldAddInputMode:(id)a3 toEnabledInputModes:(id)a4
{
  return ![(id)TIInputModeGetLanguageWithRegion() isEqualToString:@"ja_JP"]
      ...
      || objc_msgSend((id)objc_msgSend(a4, "indexesOfObjectsPassingTest:", &__block_literal_global_8), "count") == 0;
}

uint64_t __66__KSAddKeyboardController_shouldAddInputMode_toEnabledInputModes___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
...
- (void)setSpecifier:(id)a3
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)KSAddKeyboardController;
  [(KSAddKeyboardController *)&v17 setSpecifier:a3];
  ...
  {
    id v7 = +[KSKeyboardListController supportedBaseInputModesForLanguage:v6];
    if (_os_feature_enabled_impl())
    {
      long long v15 = 0u;
      long long v16 = 0u;
  ...
  if (_os_feature_enabled_impl()) {
    id v12 = [(KSAddKeyboardController *)self koreanEnglishBilingualInputModeIdentifier:v6 enabledInputModes:v4];
  }
  else {
    id v12 = 0;
  }
  [(KSAddKeyboardController *)self setProposedMultilingualInputModes:v5];
...
- (id)newSpecifiers
{
  ...
  if ([(KSAddKeyboardController *)self supportsMultilingual]
    && (objc_msgSend(v3, "addObjectsFromArray:", -[KSAddKeyboardController keyboardTypeSpecifiers](self, "keyboardTypeSpecifiers")), !-[KSAddKeyboardController showsMonolingualOption](self, "showsMonolingualOption")))
  {
    if ([(NSArray *)[(KSAddKeyboardController *)self proposedMultilingualInputModes] count] < 2)return v3; {
    id v4 = [(KSAddKeyboardController *)self multilingualSpecifiers];
    }
  }
  else
  {
    id v4 = [(KSAddKeyboardController *)self monolingualSpecifiers];
  }
...
{
  id v3 = objc_alloc_init(MEMORY[0x263EFF980]);
  id v4 = (void *)[MEMORY[0x263F5FC40] groupSpecifierWithID:0 name:&stru_2703C6C20];
  [v3 addObject:v4];
  if ([(KSAddKeyboardController *)self koreanEnglishBilingualInputModeIdentifier])
  {
    ...
    {
      id v5 = +[KSKeyboardListController keyboardDisplayNameForIdentifier:@"ko_KR"];
      objc_msgSend(v4, "setProperty:forKey:", objc_msgSend(NSString, "localizedStringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MULTILINGUAL_KEYBOARD_ADD_FOOTER", &stru_2703C6C20, @"Keyboard"), v5), *MEMORY[0x263F600F8]);
    }
    id v6 = +[KSKeyboardListController keyboardDisplayNameForIdentifier:@"en"];
    id v7 = objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend(NSString, "localizedStringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MULTILINGUAL_KEYBOARD_ADD_TITLE_WITH_LANGUAGE", &stru_2703C6C20, @"Keyboard"), v6), self, 0, 0, 0, 3, 0);
    [v7 setButtonAction:sel_enableMultilingualKeyboards_];
    uint64_t v8 = [(KSAddKeyboardController *)self koreanEnglishBilingualInputModeIdentifier];
    uint64_t v9 = *MEMORY[0x263F60138];
    goto LABEL_10;
  }
  if ([(NSArray *)[(KSAddKeyboardController *)self proposedMultilingualInputModes] count] > 1)
  {
    id v7 = objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MULTILINGUAL_KEYBOARD_ADD_TITLE", &stru_2703C6C20, @"Keyboard"), self, 0, 0, 0, 3, 0);
    [v7 setButtonAction:sel_enableMultilingualKeyboards_];
    uint64_t v9 = *MEMORY[0x263F60138];
...
LABEL_10:
  ...
  id v10 = [(NSArray *)[(KSAddKeyboardController *)self proposedMultilingualInputModes] firstObject];
  if (![(KSAddKeyboardController *)self showsMonolingualOption])
  {
    ...
    objc_msgSend(v4, "setProperty:forKey:", objc_msgSend(NSString, "localizedStringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MULTILINGUAL_KEYBOARD_ADD_FOOTER", &stru_2703C6C20, @"Keyboard"), v13), *MEMORY[0x263F600F8]);
  }
  ...
  id v7 = objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend(NSString, "localizedStringWithFormat:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MULTILINGUAL_KEYBOARD_ADD_TITLE_WITH_LANGUAGE", &stru_2703C6C20, @"Keyboard"), v15), self, 0, 0, 0, 3, 0);
  [v7 setButtonAction:sel_enableMultilingualKeyboards_];
  [v7 setProperty:v10 forKey:*MEMORY[0x263F60308]];
  uint64_t v9 = *MEMORY[0x263F60138];
  [v7 setProperty:@"Multilingual" forKey:*MEMORY[0x263F60138]];
  [v7 setProperty:MEMORY[0x263EFFA88] forKey:*MEMORY[0x263F5FEF8]];
  [v7 setUserInfo:&unk_2703CEA08];
LABEL_11:
  [v3 addObject:v7];
  long long v16 = objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ADD_MONOLINGUAL_KEYBOARD_TITLE", &stru_2703C6C20, @"Keyboard"), self, 0, 0, 0, 3, 0);
...
- (id)multilingualSpecifiers
{
  ...
  objc_msgSend(v17, "addObject:", objc_msgSend(MEMORY[0x263F5FC40], "preferenceSpecifierNamed:target:set:get:detail:cell:edit:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MULTILINGUAL_KEYBOARD_TITLE", &stru_2703C6C20, @"Keyboard"), self, 0, 0, 0, 0, 0));
  long long v20 = 0u;
  long long v21 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
...
- (id)monolingualSpecifiers
{
  ...
  id obj = +[KSKeyboardListController supportedBaseInputModesForLanguage:](KSKeyboardListController, "supportedBaseInputModesForLanguage:", objc_msgSend(*(id *)((char *)&self->super.super.super.super.super.isa + (int)*MEMORY[0x263F5FE98]), "propertyForKey:"));
  if ([(KSAddKeyboardController *)self supportsMultilingual]) {
    uint64_t v3 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"MONOLINGUAL_KEYBOARD_TITLE", &stru_2703C6C20, @"Keyboard");
  }
  else {
    uint64_t v3 = 0;
  }
  ...
  if (v23)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v32 = +[KSKeyboardListController softwareLayoutsForBaseInputMode:*(void *)(*((void *)&v40 + 1) + 8 * v5)];
            ...
            do
            {
              for (uint64_t i = 0; i != v35; ++i)
              {
                ...
                if (([v9 isEqualToString:@"Korean-With-QWERTY"] & 1) == 0)
                {
                  ...
                  uint64_t v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v9, &stru_2703C6C20, @"KeyboardLayouts");
                  ...
                  if (v12 && v29 >= 2 && v28 >= 2)
                  {
                    ...
                    id v17 = v15;
                    self = v14;
                    uint64_t v13 = [v30 stringWithFormat:objc_msgSend((id)objc_msgSend(v17, "bundleForClass:", v16), "localizedStringForKey:value:table:", @"KEYBOARD_VARIANT_%@_WITH_LAYOUT_%@", &stru_2703C6C20, @"Keyboard", v10, v11];
                  }
...
{
  v11.receiver = self;
  v11.super_class = (Class)KSAddKeyboardController;
  id v6 = -[KSAddKeyboardController tableView:cellForRowAtIndexPath:](&v11, sel_tableView_cellForRowAtIndexPath_, a3);
  uint64_t v7 = (void *)[(KSAddKeyboardController *)self specifierAtIndex:[(KSAddKeyboardController *)self indexForIndexPath:a4]];
  ...
  if ([v6 isUserInteractionEnabled])
  {
    if ([v8 isEqualToString:@"Multilingual"]
      || -[KSAddKeyboardController koreanEnglishBilingualInputModeIdentifier](self, "koreanEnglishBilingualInputModeIdentifier")&& objc_msgSend(v8, "isEqualToString:", -[KSAddKeyboardController koreanEnglishBilingualInputModeIdentifier](self, "koreanEnglishBilingualInputModeIdentifier")))
    {
      BOOL v9 = [(KSAddKeyboardController *)self showsMonolingualOption] ^ 1;
    }
    else
    {
      ...
      BOOL v9 = [(KSAddKeyboardController *)self showsMonolingualOption];
    }
  }
  else
  {
...
- (id)koreanEnglishBilingualInputModeIdentifier:(id)a3 enabledInputModes:(id)a4
{
  ...
  long long v24 = 0u;
  long long v25 = 0u;
  id obj = +[KSKeyboardListController supportedBaseInputModesForLanguage:a3];
  ...
  while (2)
  {
    for (uint64_t i = 0; i != v16; ++i)
    {
      ...
      id v8 = +[KSKeyboardListController softwareLayoutsForBaseInputMode:v6];
      if ([v8 count])
      {
        long long v20 = 0u;
        long long v21 = 0u;
...
- (BOOL)supportsMultilingual
{
  return [(NSArray *)[(KSAddKeyboardController *)self proposedMultilingualInputModes] count]|| [(KSAddKeyboardController *)self koreanEnglishBilingualInputModeIdentifier] != 0;
}

- (void)addCheckedInputModes
{
  uint64_t v23 = *MEMORY[0x263EF8340];
  uint64_t v3 = (void *)[MEMORY[0x263F1C748] sharedInputModeController];
  [v3 setDisableFloatingKeyboardFilter:1];
  id v16 = (id)[v3 enabledInputModeIdentifiers];
  ...
  long long v21 = 0u;
  uint64_t v17 = self;
  id v4 = [(KSAddKeyboardController *)self specifiers];
  ...
  if (v5)
  {
    ...
    uint64_t v9 = *MEMORY[0x263F60138];
    uint64_t v14 = *MEMORY[0x263F60308];
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        uint64_t v12 = objc_msgSend(v11, "propertyForKey:", v8, v14);
        uint64_t v13 = (void *)[v11 propertyForKey:v9];
        if ((![v13 isEqualToString:@"Multilingual"]
           || -[NSArray count](-[KSAddKeyboardController proposedMultilingualInputModes](v17, "proposedMultilingualInputModes"), "count") <= 1)&& ([v13 isEqualToString:@"Monolingual"] & 1) == 0&& objc_msgSend(v12, "isChecked"))
        {
          if (_os_feature_enabled_impl()
            && objc_msgSend((id)objc_msgSend((id)objc_msgSend(v11, "userInfo"), "objectForKeyedSubscript:", @"multilingual"), "BOOLValue"))
          {
            id v16 = TIUIGetInputModesByAddingProposedInputMode((void *)[v11 propertyForKey:v14], v16);
          }
          else if (([v16 containsObject:v13] & 1) == 0)
          {
            [v15 addObject:v13];
          }
        }
  ...
  +[KSKeyboardListController setInputModes:](KSKeyboardListController, "setInputModes:", [v16 arrayByAddingObjectsFromArray:v15]);
}
...
- (void)updateDoneButton
{
  ...
  long long v18 = 0u;
  long long v19 = 0u;
  id v2 = [(KSAddKeyboardController *)self specifiers];
      ...
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if (([v11 isEqualToString:@"Monolingual"] & 1) == 0
          && (![v11 isEqualToString:@"Multilingual"]
           || [(NSArray *)[(KSAddKeyboardController *)self proposedMultilingualInputModes] count] <= 1))
        {
  ...
  uint64_t v14 = 0;
LABEL_16:
  objc_msgSend((id)objc_msgSend((id)-[KSAddKeyboardController navigationItem](self, "navigationItem"), "rightBarButtonItem"), "setEnabled:", v14);
}
...
- (void)toggleMultilingualInputMode:(id)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  id v5 = [(KSAddKeyboardController *)self specifiers];
  ...
  [(KSAddKeyboardController *)self toggleInputMode:a3];
}

- (void)cancelButtonTapped
{
  id v2 = (void *)[(KSAddKeyboardController *)self navigationController];
...
- (void)doneButtonTapped
{
  ...
  uint64_t v3 = (void *)[(KSAddKeyboardController *)self parentController];
  [v3 dismissForDone];
}
