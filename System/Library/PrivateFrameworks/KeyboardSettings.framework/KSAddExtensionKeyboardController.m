...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)KSAddExtensionKeyboardController;
...
- (id)specifiers
{
  ...
  if (!result)
  {
    id result = [(KSAddExtensionKeyboardController *)self newSpecifiers];
...
uint64_t __82__KSAddExtensionKeyboardController_setNetworkAccessSpecifierForKeyboardInputMode___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
...
- (id)newSpecifiers
{
  ...
  long long v20 = 0u;
  long long v21 = 0u;
  id obj = (id)objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", @"TIKBIdentifiersKey");
  ...
  -[KSAddExtensionKeyboardController setModuleSpecifiers:](v17, "setModuleSpecifiers:", [v3 sortedArrayUsingComparator:&__block_literal_global_0]);
  unint64_t v12 = [(NSArray *)[(KSAddExtensionKeyboardController *)v17 moduleSpecifiers] count];
  v17->_didRequestOpenAccess = v6;
  if (![obj count]
    || [(KSAddExtensionKeyboardController *)v17 behavesAsModalForAddSheet]
    || ((v6 ^ 1) & 1) != 0)
  {
    v13 = v15;
    if (v12 >= 2) {
  ...
  {
    -[KSAddExtensionKeyboardController setNetworkAccessSpecifierForKeyboardInputMode:](v17, "setNetworkAccessSpecifierForKeyboardInputMode:", [obj firstObject]);
    v13 = v15;
    objc_msgSend(v15, "addObject:", -[KSAddExtensionKeyboardController networkAccessSpecifier](v17, "networkAccessSpecifier"));
    if (v12 >= 2)
    {
      objc_msgSend(v15, "addObject:", objc_msgSend(MEMORY[0x263F5FC40], "groupSpecifierWithName:", &stru_2703C6C20));
LABEL_19:
      objc_msgSend(v13, "addObjectsFromArray:", -[KSAddExtensionKeyboardController moduleSpecifiers](v17, "moduleSpecifiers"));
    }
  }
  [(KSAddExtensionKeyboardController *)v17 trackExtensionsContainedInApp];
  return v13;
}
...
- (void)trackExtensionsContainedInApp
{
  ...
  {
    uint64_t v3 = objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", @"TIKBAllIdentifiersKey");
    TIStatisticGetKey();
    [v3 count];
    ...
    if (v4)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v5; ++i)
        {
          ...
          if (objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "specifiersForExtensionInputMode:parentSpecifier:", *(void *)(*((void *)&v9 + 1) + 8 * i), -[KSAddExtensionKeyboardController specifier](self, "specifier")), "count"))
          {
            ++v6;
          }
        }
...
- (void)setPrivacyAccess:(id)a3 forSpecifier:(id)a4
{
  if (objc_msgSend((id)-[PSSpecifier name](-[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier"), "name"), "isEqualToString:", objc_msgSend(a4, "name")))
  {
    int v7 = objc_msgSend((id)-[PSSpecifier identifier](-[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier"), "identifier"), "isEqualToString:", objc_msgSend(a4, "identifier"));
    int v8 = v7;
    ...
    if (!v9 && [a3 BOOLValue])
    {
      ...
      v24[1] = 3221225472;
      v24[2] = __66__KSAddExtensionKeyboardController_setPrivacyAccess_forSpecifier___block_invoke;
      v24[3] = &unk_2653A9328;
      v24[4] = self;
      long long v10 = NSString;
      uint64_t v11 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ADD_THIRD_PARTY_KEYBOARD_WARNING_TITLE", &stru_2703C6C20, @"Keyboard");
      long long v12 = (void *)[(KSAddExtensionKeyboardController *)self specifier];
      uint64_t v13 = objc_msgSend(v10, "stringWithFormat:", v11, objc_msgSend(v12, "propertyForKey:", *MEMORY[0x263F602D0]), v24[0], 3221225472, __66__KSAddExtensionKeyboardController_setPrivacyAccess_forSpecifier___block_invoke, &unk_2653A9328, self);
      uint64_t v14 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ADD_THIRD_PARTY_KEYBOARD_WARNING_MESSAGE", &stru_2703C6C20, @"Keyboard");
      uint64_t v15 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ADD_THIRD_PARTY_KEYBOARD_WARNING_CANCEL", &stru_2703C6C20, @"Keyboard");
      uint64_t v16 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ADD_THIRD_PARTY_KEYBOARD_WARNING_ACTION", &stru_2703C6C20, @"Keyboard");
      -[KSAddExtensionKeyboardController setNetworkAccessAlertController:](self, "setNetworkAccessAlertController:", [MEMORY[0x263F1C3F8] alertControllerWithTitle:v13 message:v14 preferredStyle:1]);
      -[KSAddExtensionKeyboardController setNetworkAccessAlertActionDefault:](self, "setNetworkAccessAlertActionDefault:", [MEMORY[0x263F1C3F0] actionWithTitle:v16 style:0 handler:v24]);
      -[KSAddExtensionKeyboardController setNetworkAccessAlertActionCancel:](self, "setNetworkAccessAlertActionCancel:", [MEMORY[0x263F1C3F0] actionWithTitle:v15 style:1 handler:v24]);
      ...
      if (objc_msgSend((id)-[KSAddExtensionKeyboardController view](self, "view"), "window")) {
        long long v18 = self;
      }
      else {
        long long v18 = (KSAddExtensionKeyboardController *)objc_msgSend((id)objc_msgSend(MEMORY[0x263F1CBC8], "keyWindow"), "rootViewController");
      }
      uint64_t v23 = [(KSAddExtensionKeyboardController *)v18 view];
      objc_msgSend((id)objc_msgSend(MEMORY[0x263F1CB68], "_viewControllerForFullScreenPresentationFromView:", v23), "presentViewController:animated:completion:", -[KSAddExtensionKeyboardController networkAccessAlertController](self, "networkAccessAlertController"), 1, 0);
      return;
    }
...
- (void)didEnterBackground:(id)a3
{
  ...
  uint64_t v5 = [(KSAddExtensionKeyboardController *)self networkAccessSpecifier];
  uint64_t v6 = (void *)[(PSSpecifier *)v5 propertyForKey:*MEMORY[0x263F602B0]];
  int v7 = [(KSAddExtensionKeyboardController *)self networkAccessSpecifier];
...
- (void)updateNetworkPolicyState
{
  ...
  CFBundleRef cf = CFBundleCreate(0, (CFURLRef)objc_msgSend((id)objc_msgSend((id)objc_msgSend((id)objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", @"TIKBAllIdentifiersKey"), "firstObject"), "containingBundle"), "bundleURL"));
  uint64_t v4 = (void *)TCCAccessCopyInformationForBundle();
  long long v17 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
  long long v20 = 0u;
  ...
  if (v5)
  {
    ...
    int v8 = (void *)MEMORY[0x263F7C4E8];
    BOOL v9 = (void *)MEMORY[0x263F7C570];
    long long v10 = (void *)MEMORY[0x263F7C4D8];
    do
    {
...
LABEL_16:
  uint64_t v13 = [(KSAddExtensionKeyboardController *)self networkAccessSpecifier];
  uint64_t v14 = *MEMORY[0x263F602B0];
  uint64_t v15 = (void *)[(PSSpecifier *)v13 propertyForKey:*MEMORY[0x263F602B0]];
  objc_msgSend(v15, "setValue:", objc_msgSend(NSNumber, "numberWithBool:", v3 & 1));
  objc_msgSend((id)-[PSSpecifier propertyForKey:](-[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier"), "propertyForKey:", v14), "reloadWithSpecifier:animated:", -[KSAddExtensionKeyboardController networkAccessSpecifier](self, "networkAccessSpecifier"), 1);
}

- (void)setNetworkPolicyValue:(id)a3
{
  uint64_t v20 = *MEMORY[0x263EF8340];
  uint64_t v4 = objc_msgSend((id)-[KSAddExtensionKeyboardController specifier](self, "specifier"), "propertyForKey:", @"TIKBAllIdentifiersKey");
  CFBundleRef v5 = CFBundleCreate(0, (CFURLRef)objc_msgSend((id)objc_msgSend((id)objc_msgSend(v4, "firstObject"), "containingBundle"), "bundleURL"));
  [a3 BOOLValue];
...
{
  v6.receiver = self;
  v6.super_class = (Class)KSAddExtensionKeyboardController;
  [(PSAppListController *)&v6 viewWillAppear:a3];
  if ([(KSAddExtensionKeyboardController *)self behavesAsModalForAddSheet])
  {
    uint64_t v4 = (void *)[(KSAddExtensionKeyboardController *)self navigationItem];
    CFBundleRef v5 = (void *)[(KSAddExtensionKeyboardController *)self specifier];
...
{
  v4.receiver = self;
  v4.super_class = (Class)KSAddExtensionKeyboardController;
  [(KSAddExtensionKeyboardController *)&v4 viewDidAppear:a3];
...
- (id)selectedInputModes
{
  ...
  if ([(NSArray *)[(KSAddExtensionKeyboardController *)self moduleSpecifiers] count] > 1)
  {
    ...
    long long v14 = 0u;
    long long v15 = 0u;
    CFBundleRef v5 = [(KSAddExtensionKeyboardController *)self moduleSpecifiers];
  ...
  {
    id v4 = [(NSArray *)[(KSAddExtensionKeyboardController *)self moduleSpecifiers] firstObject];
...
- (void)addCheckedInputModes
{
  ...
  id v4 = [(KSAddExtensionKeyboardController *)self selectedInputModes];
  if ([v4 count])
  {
...
- (void)updateDoneButton
{
  if ([(KSAddExtensionKeyboardController *)self behavesAsModalForAddSheet])
  {
    BOOL v3 = objc_msgSend(-[KSAddExtensionKeyboardController selectedInputModes](self, "selectedInputModes"), "count") != 0;
    id v4 = objc_msgSend((id)-[KSAddExtensionKeyboardController navigationItem](self, "navigationItem"), "rightBarButtonItem");
    [v4 setEnabled:v3];
  }
}
...
- (void)cancelButtonTapped
{
  v2 = (void *)[(KSAddExtensionKeyboardController *)self parentController];
  [v2 dismiss];
}
...
- (void)doneButtonTapped
{
  ...
  BOOL v3 = (void *)[(KSAddExtensionKeyboardController *)self parentController];
  [v3 dismissForDone];
}
