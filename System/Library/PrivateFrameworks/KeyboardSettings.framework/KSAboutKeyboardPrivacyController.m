...
{
  v11.receiver = self;
  v11.super_class = (Class)KSAboutKeyboardPrivacyController;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)KSAboutKeyboardPrivacyController;
...
- (void)setSpecifier:(id)a3
{
  ...
  uint64_t v5 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"APP_KEYBOARDS_INFO", &stru_2703C6C20, @"Keyboard");
  uint64_t v6 = objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"APP_KEYBOARDS_INFO_LINK", &stru_2703C6C20, @"Keyboard");
  BOOL v7 = [(KSAboutKeyboardPrivacyController *)self asHeader];
...
- (void)addPrivacyLinkViewIfNecessaryToHeaderView:(id)a3 forSection:(int64_t)a4
{
  ...
  {
    BOOL v7 = (void *)[(PSListController *)[(KSAboutKeyboardPrivacyController *)self listController] indexPathForSpecifier:[(KSAboutKeyboardPrivacyController *)self specifier]];
    uint64_t v8 = [(KSAboutKeyboardPrivacyController *)self asHeader]
       ? [a3 detailTextLabel]
       : [a3 textLabel];
    uint64_t v9 = (void *)v8;
    if ([v7 section] == a4)
    {
      ...
      if (v10 != [a3 contentView])
      {
        ...
        v13 = (void *)[v9 text];
        uint64_t v14 = objc_msgSend(v13, "rangeOfString:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"APP_KEYBOARDS_INFO_LINK", &stru_2703C6C20, @"Keyboard"));
        uint64_t v16 = v15;
        objc_msgSend(v12, "addAttribute:value:range:", *MEMORY[0x263F81500], objc_msgSend(MEMORY[0x263F1C550], "systemBlueColor"), v14, v15);
        objc_msgSend(v12, "addAttribute:value:range:", *MEMORY[0x263F81520], objc_msgSend(NSURL, "URLWithString:", &stru_2703C6C20), v14, v16);
        objc_msgSend(v12, "addAttribute:value:range:", *MEMORY[0x263F815F8], MEMORY[0x263EFFA80], v14, v16);
        objc_msgSend(v12, "removeAttribute:range:", *MEMORY[0x263F81540], 0, objc_msgSend(v12, "length"));
...
- (BOOL)textView:(id)a3 shouldInteractWithURL:(id)a4 inRange:(_NSRange)a5 interaction:(int64_t)a6
{
  BOOL v7 = [(KSAboutKeyboardPrivacyController *)self specifier];
  if (v7)
  {
    id v8 = objc_alloc_init(MEMORY[0x263F1CB68]);
    objc_msgSend(v8, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ABOUT_APP_KEYBOARDS_TITLE", &stru_2703C6C20, @"Keyboard"));
    ...
    objc_msgSend(v11, "setText:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ABOUT_APP_KEYBOARDS_INFO_TEXT", &stru_2703C6C20, @"Keyboard"));
    objc_msgSend(v11, "setFont:", objc_msgSend(MEMORY[0x263F81708], "preferredFontForTextStyle:", *MEMORY[0x263F1D260]));
    [v11 setEditable:0];
