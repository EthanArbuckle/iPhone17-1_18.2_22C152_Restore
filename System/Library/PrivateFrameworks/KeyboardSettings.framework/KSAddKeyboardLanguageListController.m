...
- (void)viewDidLoad
{
  ...
  objc_msgSend((id)-[KSAddKeyboardLanguageListController navigationItem](self, "navigationItem"), "setSearchController:", (id)objc_msgSend(objc_alloc(MEMORY[0x263F1C958]), "initWithSearchResultsController:", 0));
...
- (BOOL)inputMode:(id)a3 matchesPredicate:(id)a4
{
  ...
  id v7 = +[KSKeyboardListController keyboardDisplayNameForIdentifier:LanguageWithRegion];
  ...
  id v9 = +[KSKeyboardListController supportedBaseInputModesForLanguage:LanguageWithRegion];
  long long v30 = 0u;
  long long v31 = 0u;
  long long v32 = 0u;
  long long v33 = 0u;
  ...
  long long v24 = 0u;
  long long v25 = 0u;
  uint64_t v15 = [v8 countByEnumeratingWithState:&v22 objects:v34 count:16];
  if (v15)
  {
    ...
    while (2)
    {
      for (uint64_t j = 0; j != v15; ++j)
      {
        ...
        v21[4] = a4;
        v21[5] = &v26;
        objc_msgSend(v18, "enumerateSubstringsInRange:options:usingBlock:", 0, v19, 3, v21);
...
uint64_t __66__KSAddKeyboardLanguageListController_inputMode_matchesPredicate___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, unsigned char *a7)
{
...
- (id)specifiers
{
  ...
  if (!result)
  {
    id result = [(KSAddKeyboardLanguageListController *)self generateSpecifiers];
...
- (id)generateSpecifiers
{
  ...
  if ([(NSString *)[(KSAddKeyboardLanguageListController *)self searchText] length]) {
    uint64_t v11 = [MEMORY[0x263F08A98] predicateWithFormat:@"SELF beginswith[cd] %@", -[KSAddKeyboardLanguageListController searchText](self, "searchText")];
  }
  else {
    uint64_t v11 = 0;
  }
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v13; ++j)
      {
        ...
        if ((!v11
           || [(KSAddKeyboardLanguageListController *)val inputMode:*(void *)(*((void *)&v54 + 1) + 8 * j) matchesPredicate:v11])&& (!_os_feature_enabled_impl() || (TIInputModeIsMultilingualOnly() & 1) == 0))
        {
          v17 = (void *)[MEMORY[0x263F1C740] keyboardInputModeWithIdentifier:v16];
            ...
            || objc_msgSend(+[KSKeyboardListController availableInputModesForLanguage:](KSKeyboardListController, "availableInputModesForLanguage:", v16), "count"))
          {
            ...
            else
            {
              ...
              id v23 = +[KSKeyboardListController keyboardDisplayNameForIdentifier:v20];
              uint64_t v19 = 0;
              uint64_t v21 = v20;
            }
            if (![v47 member:v20])
            {
              ...
              if ([v17 isExtensionInputMode])
              {
                ...
                {
                  uint64_t v26 = (void *)[v24 propertyForKey:@"TIKBIdentifiersKey"];
                  if (!v26)
                  {
                    uint64_t v26 = (void *)[MEMORY[0x263EFF980] array];
  ...
  if (v29) {
    objc_msgSend(v32, "addObject:", objc_msgSend(MEMORY[0x263F5FC40], "groupSpecifierWithName:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"SUGGESTED_KEYBOARDS", &stru_2703C6C20, @"Keyboard")));
  }
  [v32 addObjectsFromArray:v39];
  if (v30)
  {
    uint64_t v33 = objc_msgSend(MEMORY[0x263F5FC40], "groupSpecifierWithName:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"APP_KEYBOARDS", &stru_2703C6C20, @"Keyboard"));
    [v32 addObject:v33];
  ...
  if (v31)
  {
    ...
    uint64_t v35 = objc_msgSend(MEMORY[0x263F5FC40], "groupSpecifierWithName:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", v34, &stru_2703C6C20, @"Keyboard"));
  }
  else
  {
...
- (void)createAboutPrivacyControllerIfNeeded:(id)a3
{
  ...
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
  uint64_t v5 = __76__KSAddKeyboardLanguageListController_createAboutPrivacyControllerIfNeeded___block_invoke;
  uint64_t v6 = &unk_2653A98A0;
...
uint64_t __76__KSAddKeyboardLanguageListController_createAboutPrivacyControllerIfNeeded___block_invoke(uint64_t a1)
{
  ...
  {
    uint64_t v6 = [[KSAboutKeyboardPrivacyController alloc] initWithGroupSpecifier:*(void *)(a1 + 32) asHeader:1 inListController:Weak];
...
- (void)handleSoleInputModeAddition:(id)a3
{
  +[KSKeyboardListController setInputModes:](KSKeyboardListController, "setInputModes:", objc_msgSend((id)objc_msgSend((id)objc_msgSend(MEMORY[0x263F1C748], "sharedInputModeController"), "enabledInputModeIdentifiers"), "arrayByAddingObject:", a3));
  objc_super v4 = objc_msgSend((id)-[KSAddKeyboardLanguageListController parentController](self, "parentController"), "parentController");
  if (objc_opt_respondsToSelector())
  {
    [v4 setNewKeyboardsAdded:1];
    [v4 reloadSpecifiers];
  }
  uint64_t v5 = (void *)[(KSAddKeyboardLanguageListController *)self parentController];
  [v5 dismiss];
}

- (void)tableView:(id)a3 willDisplayHeaderView:(id)a4 forSection:(int64_t)a5
{
  id v7 = [(KSAddKeyboardLanguageListController *)self aboutPrivacyController];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  id v6 = -[KSAddKeyboardLanguageListController tableView:cellForRowAtIndexPath:](&v9, sel_tableView_cellForRowAtIndexPath_, a3);
  id v7 = (void *)[(KSAddKeyboardLanguageListController *)self specifierAtIndex:[(KSAddKeyboardLanguageListController *)self indexForIndexPath:a4]];
...
- (void)showAddSystemKeyboardSheet:(id)a3
{
  ...
  id v6 = +[KSKeyboardListController supportedInputModesForLanguage:v5];
  if (!+[KSAddKeyboardController shouldShowAddKeyboardControllerForInputModes:](KSAddKeyboardController, "shouldShowAddKeyboardControllerForInputModes:", v6)&& (id v7 = +[KSKeyboardListController availableInputModesForLanguage:](KSKeyboardListController, "availableInputModesForLanguage:", v5), v8 = [v6 count], v8 == objc_msgSend(v7, "count"))&& (v9 = objc_msgSend(v7, "firstObject")) != 0)
  {
    uint64_t v10 = v9;
  ...
  {
    uint64_t v11 = objc_alloc_init(KSAddKeyboardController);
...
- (void)showAddExtensionKeyboardSheet:(id)a3
{
  uint64_t v5 = objc_alloc_init(KSAddExtensionKeyboardController);
...
- (void)cancelButtonTapped
{
  uint64_t v2 = (void *)[(KSAddKeyboardLanguageListController *)self parentController];
  [v2 dismiss];
}
...
- (void)viewWillAppear:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)KSAddKeyboardLanguageListController;
  [(KSAddKeyboardLanguageListController *)&v4 viewWillAppear:a3];
  -[KSAddKeyboardLanguageListController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"ADD_NEW_KEYBOARD_SHORT", &stru_2703C6C20, @"Keyboard"));
  objc_msgSend((id)-[KSAddKeyboardLanguageListController navigationItem](self, "navigationItem"), "setLeftBarButtonItem:", (id)objc_msgSend(objc_alloc(MEMORY[0x263F1C468]), "initWithBarButtonSystemItem:target:action:", 1, self, sel_cancelButtonTapped));
}
...
- (void)viewDidAppear:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)KSAddKeyboardLanguageListController;
  [(KSAddKeyboardLanguageListController *)&v4 viewDidAppear:a3];
  [(KSAddKeyboardLanguageListController *)self emitNavigationEventForAddKeyboardLanguageListController];
}

- (void)dismissForDone
{
  uint64_t v3 = objc_msgSend((id)-[KSAddKeyboardLanguageListController parentController](self, "parentController"), "parentController");
  if (objc_opt_respondsToSelector())
  {
    [v3 setNewKeyboardsAdded:1];
    [v3 reloadSpecifiers];
  }
  objc_super v4 = (void *)[(KSAddKeyboardLanguageListController *)self parentController];
  [v4 dismiss];
}
