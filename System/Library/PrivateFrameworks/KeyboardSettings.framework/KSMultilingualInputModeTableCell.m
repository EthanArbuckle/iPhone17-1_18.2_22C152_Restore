...
- (KSMultilingualInputModeTableCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4 specifier:(id)a5
{
  ...
  if (v6)
  {
    -[KSMultilingualInputModeTableCell setInputModes:](v6, "setInputModes:", [a5 propertyForKey:*MEMORY[0x263F60308]]);
...
- (id)subtitle
{
  uint64_t LanguageCount = TIUIMultilingualSetGetLanguageCount([(KSMultilingualInputModeTableCell *)self inputModes]);
  ...
  return (id)[v3 localizedStringForKey:v4 value:&stru_2703C6C20 table:@"Keyboard"];
}
...
- (void)downloadButtonPressed:(id)a3 withEvent:(id)a4
{
  ...
  long long v11 = 0u;
  long long v12 = 0u;
  uint64_t v4 = [(KSMultilingualInputModeTableCell *)self inputModes];
