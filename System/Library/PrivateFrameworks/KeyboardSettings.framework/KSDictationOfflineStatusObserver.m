...
- (KSDictationOfflineStatusObserver)initWithDelegate:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)KSDictationOfflineStatusObserver;
...
uint64_t __53__KSDictationOfflineStatusObserver_initWithDelegate___block_invoke(uint64_t a1)
{
...
- (void)dealloc
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)KSDictationOfflineStatusObserver;
...
- (KSDictationOfflineStatusObserverDelegate)delegate
{
  ...
  return (KSDictationOfflineStatusObserverDelegate *)WeakRetained;
}
