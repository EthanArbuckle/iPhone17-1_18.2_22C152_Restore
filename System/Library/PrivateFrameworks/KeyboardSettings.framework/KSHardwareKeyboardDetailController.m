...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  [(KSHardwareKeyboardDetailController *)&v6 viewWillAppear:a3];
  objc_super v4 = (void *)[(KSHardwareKeyboardDetailController *)self specifier];
...
- (id)specifiers
{
  ...
  if (!result)
  {
    id result = [(KSHardwareKeyboardDetailController *)self newSpecifiers];
...
- (id)newSpecifiers
{
  ...
  uint64_t v3 = [(KSHardwareKeyboardDetailController *)self inputMode];
  ...
  long long v28 = 0u;
  long long v29 = 0u;
  id v6 = +[KSKeyboardListController inputModes];
...
- (UIKeyboardInputMode)uiKeyboardinputMode
{
  ...
  if (!result)
  {
    ...
    v5 = (void *)[(KSHardwareKeyboardDetailController *)self specifier];
