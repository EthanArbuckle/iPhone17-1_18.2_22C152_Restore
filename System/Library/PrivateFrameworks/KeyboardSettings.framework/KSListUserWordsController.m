...
- (id)_mainContentView
{
  ...
  if (!result)
  {
    ...
    -[UIToolbar setItems:](self->_toolbar, "setItems:", objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:", -[KSListUserWordsController editButtonItem](self, "editButtonItem"), 0));
    ...
    self->_searchResultsController = -[KSSearchUserWordsController initWithNavigationController:](v15, "initWithNavigationController:", [objc_loadWeak((id *)((char *)&self->super.super.super.super.isa+ (int)*MEMORY[0x263F5FE78])) navigationController]);
    ...
    -[UISearchBar setPlaceholder:](v18, "setPlaceholder:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"SEARCH_LOCAL_PLACEHOLDER", &stru_2703C6C20, @"Keyboard"));
    ...
    objc_msgSend((id)-[KSListUserWordsController navigationItem](self, "navigationItem"), "setRightBarButtonItem:", v19);
...
- (void)loadView
{
  double v3 = [(KSListUserWordsController *)self _mainContentView];
...
- (void)reloadSections
{
  ...
  double v8 = [(KSUserWordsManager *)[(KSListUserWordsController *)self dictionaryController] entries];
  long long v18 = 0u;
  long long v19 = 0u;
  long long v20 = 0u;
  long long v21 = 0u;
  ...
  if ([(KSListUserWordsController *)self currentShortcut]
    && [(NSArray *)[(KSListUserWordsController *)self sections] count])
  {
    uint64_t v14 = 0;
    while (1)
    {
      id v15 = [(NSArray *)[(KSListUserWordsController *)self sections] objectAtIndexedSubscript:v14];
      if ([v15 count]) {
        break;
      }
LABEL_21:
...
- (void)viewDidLoad
{
  ...
  -[KSListUserWordsController setTitle:](self, "setTitle:", objc_msgSend((id)objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class()), "localizedStringForKey:value:table:", @"SHORTCUTS", &stru_2703C6C20, @"Keyboard"));
  [(KSListUserWordsController *)self parentController];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    double v3 = (KSUserWordsManager *)objc_msgSend((id)-[KSListUserWordsController parentController](self, "parentController"), "dictionaryController");
  }
  else {
    double v3 = objc_alloc_init(KSUserWordsManager);
  }
  ...
  v6[5] = self;
  uint64_t v4 = [(KSListUserWordsController *)self dictionaryController];
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  [(KSListUserWordsController *)&v4 viewWillAppear:a3];
...
- (void)viewDidAppear:(BOOL)a3
{
  v4.receiver = self;
  v4.super_class = (Class)KSListUserWordsController;
  [(KSListUserWordsController *)&v4 viewDidAppear:a3];
...
- (BOOL)_shouldHideIndex
{
  ...
  int64_t v4 = [(KSListUserWordsController *)self numberOfSectionsInTableView:[(KSListUserWordsController *)self tableView]];
  uint64_t v5 = 15;
  if (v3 == 1) {
    uint64_t v5 = 20;
  }
...
- (void)setEditing:(BOOL)a3 animated:(BOOL)a4
{
  ...
  [(UITableView *)[(KSListUserWordsController *)self tableView] setEditing:v5 animated:v4];
}

- (void)tableView:(id)a3 willBeginEditingRowAtIndexPath:(id)a4
{
  self->_manualEditing = 1;
  [(KSListUserWordsController *)self setEditing:1 animated:1];
}
...
- (void)tableView:(id)a3 commitEditingStyle:(int64_t)a4 forRowAtIndexPath:(id)a5
{
  ...
  if (a4 == 1)
  {
    ...
    uint64_t v9 = objc_msgSend(-[NSArray objectAtIndex:](-[KSListUserWordsController sections](self, "sections"), "objectAtIndex:", objc_msgSend(a5, "section")), "objectAtIndex:", objc_msgSend(a5, "row"));
    uint64_t v10 = [(KSListUserWordsController *)self dictionaryController];
    v11[0] = v9;
    -[KSUserWordsManager addEntries:removeEntries:withCompletionHandler:](v10, "addEntries:removeEntries:withCompletionHandler:", 0, [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:1], &__block_literal_global_6);
    self->_manualEditing = 0;
    if (!v8) {
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  uint64_t v6 = -[KSEditUserWordController initWithUserWord:]([KSEditUserWordController alloc], "initWithUserWord:", objc_msgSend(-[NSArray objectAtIndex:](-[KSListUserWordsController sections](self, "sections"), "objectAtIndex:", objc_msgSend(a4, "section")), "objectAtIndex:", objc_msgSend(a4, "row")));
...
- (int64_t)numberOfSectionsInTableView:(id)a3
{
  uint64_t v3 = [(KSListUserWordsController *)self sections];
  return [(NSArray *)v3 count];
}

- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  id v4 = [(NSArray *)[(KSListUserWordsController *)self sections] objectAtIndex:a4];
  return [v4 count];
}
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  objc_super v7 = objc_msgSend(-[NSArray objectAtIndex:](-[KSListUserWordsController sections](self, "sections"), "objectAtIndex:", objc_msgSend(a4, "section")), "objectAtIndex:", objc_msgSend(a4, "row"));
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  id result = (id)objc_msgSend(-[NSArray objectAtIndex:](-[KSListUserWordsController sections](self, "sections", a3), "objectAtIndex:", a4), "count");
  if (result)
  {
    objc_super v7 = [(UILocalizedIndexedCollation *)[(KSListUserWordsController *)self collation] sectionTitles];
...
- (id)sectionIndexTitlesForTableView:(id)a3
{
  ...
  BOOL v5 = [(KSListUserWordsController *)self collation];
...
- (int64_t)tableView:(id)a3 sectionForSectionIndexTitle:(id)a4 atIndex:(int64_t)a5
{
  ...
  NSInteger v8 = [(UILocalizedIndexedCollation *)[(KSListUserWordsController *)self collation] sectionForSectionIndexTitleAtIndex:a5];
  int64_t v9 = [(NSArray *)[(KSListUserWordsController *)self sections] count];
  if (v8 < 0)
  {
LABEL_8:
    int64_t v11 = v8 + 1;
    do
    {
      ...
      uint64_t v12 = objc_msgSend(-[NSArray objectAtIndex:](-[KSListUserWordsController sections](self, "sections"), "objectAtIndex:", v11), "count");
      int64_t v11 = v7 + 1;
    }
    while (!v12);
  }
  ...
  uint64_t v14 = [(KSListUserWordsController *)self collation];
...
- (void)addUserWord
{
  uint64_t v3 = objc_alloc_init(KSEditUserWordController);
...
- (void)inlineUserDictionaryDoneEditing
{
  int v2 = (void *)[(KSListUserWordsController *)self navigationController];
  [v2 popViewControllerAnimated:1];
}

- (void)navigationController:(id)a3 willShowViewController:(id)a4 animated:(BOOL)a5
{
  if ([(KSListUserWordsController *)self searchNavControllerChanges])
  {
    ...
    else
    {
      ...
      long long v20 = __82__KSListUserWordsController_navigationController_willShowViewController_animated___block_invoke_3;
      long long v21 = &unk_2653A96E0;
      v22 = self;
      uint64_t v13 = MEMORY[0x263EF8330];
      uint64_t v14 = 3221225472;
      id v15 = __82__KSListUserWordsController_navigationController_willShowViewController_animated___block_invoke_4;
      uint64_t v16 = &unk_2653A96E0;
      int64_t v11 = &v18;
      uint64_t v12 = &v13;
    }
