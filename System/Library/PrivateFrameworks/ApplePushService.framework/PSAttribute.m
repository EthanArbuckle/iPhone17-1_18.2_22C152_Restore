...
{
  v7.receiver = self;
  v7.super_class = (Class)PSAttribute;
  v3 = [(PSAttribute *)&v7 description];
  v4 = [(PSAttribute *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000B0A0C((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[PSAttribute setKey:](self, "setKey:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[PSAttribute setValue:](self, "setValue:");
    id v4 = v5;
  }
}
