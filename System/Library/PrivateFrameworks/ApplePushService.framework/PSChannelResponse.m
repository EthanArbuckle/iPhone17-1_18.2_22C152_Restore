...
{
  v7.receiver = self;
  v7.super_class = (Class)PSChannelResponse;
  id v3 = [(PSChannelResponse *)&v7 description];
  int v4 = [(PSChannelResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10001FBAC((uint64_t)self, (uint64_t)a3);
}
...
LABEL_13:
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_channelSubscriptionCheckpoint != *((void *)v4 + 1)) {
      goto LABEL_13;
    }
    BOOL v6 = 1;
  }
