...
- (id)eventName;
- (uint64_t)incrementCountByNumber:(uint64_t)result;
...
+ (id)counterInCollection:(void *)a3 withEventName:
{
  ...
  id v5 = a2;
  uint64_t v6 = self;
  v7 = +[_DKEventStatsCollection counterWithClass:collectionName:eventName:eventType:eventTypePossibleValues:hasResult:scalar:]((uint64_t)_DKEventStatsCollection, v6, v5, v4, 0, 0, 0, 1);
...
- (uint64_t)incrementCountByNumber:(uint64_t)result
{
  ...
  {
    uint64_t v3 = result;
    result = -[_DKEventStatsCounterInternal incrementCountByNumber:typeValue:success:](*(void *)(result + 8), a2, 0, 0);
