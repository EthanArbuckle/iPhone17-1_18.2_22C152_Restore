...
- (_CDEventHandlerForDefaultPairedNearby)init;
...
@implementation _CDEventHandlerForDefaultPairedNearby

- (_CDEventHandlerForDefaultPairedNearby)init
{
  v10.receiver = self;
  v10.super_class = (Class)_CDEventHandlerForDefaultPairedNearby;
  v2 = [(_CDEventHandlerForDefaultPairedNearby *)&v10 init];
  if (v2)
  {
...
- (void)eventHandler:(id)a3 withFileHandle:(id)a4
{
  ...
  v9 = [(_CDEventHandlerForDefaultPairedNearby *)self anonymizer];
  objc_super v10 = -[_CDDataCollectionAnonymizer anonymizeDictionary:](v9, v14);

  v11 = [(_CDEventHandlerForDefaultPairedNearby *)self utility];
  v12 = -[_CDFileUtility fileHandlerUtiity:withBundleId:withMetaData:]((uint64_t)v11, v7, 0, v10);

  v13 = [(_CDEventHandlerForDefaultPairedNearby *)self utility];
