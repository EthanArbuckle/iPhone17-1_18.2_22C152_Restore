...
{
  v10.receiver = self;
  v10.super_class = (Class)_CDEventHandlerForActivityLevel;
  v2 = [(_CDEventHandlerForActivityLevel *)&v10 init];
  if (v2)
  {
