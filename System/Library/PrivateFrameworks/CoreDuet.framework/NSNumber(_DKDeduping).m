...
- (id)dk_dedup
{
  if (dk_dedup_onceToken_3 != -1) {
    dispatch_once(&dk_dedup_onceToken_3, &__block_literal_global_7);
  }
  id v2 = a1;
  os_unfair_lock_lock((os_unfair_lock_t)&dk_dedup_lock_5);
  v3 = [(id)dk_dedup_set_4 member:v2];
  v4 = v3;
  if (v3)
  {
    id v5 = v3;
  ...
  else if ((unint64_t)[(id)dk_dedup_set_4 count] <= 0x7F)
  {
    [(id)dk_dedup_set_4 addObject:v2];
  }
