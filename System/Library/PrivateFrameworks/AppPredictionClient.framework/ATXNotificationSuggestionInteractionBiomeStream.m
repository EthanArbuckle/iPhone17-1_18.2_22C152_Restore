...
- (NSString)identifier
{
  return (NSString *)@"notificationSuggestionInteraction";
}

- (ATXNotificationSuggestionInteractionBiomeStream)init
{
  return [(ATXNotificationSuggestionInteractionBiomeStream *)self initWithStoreConfig:0];
}
...
- (ATXNotificationSuggestionInteractionBiomeStream)initWithStoreConfig:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = v6;
    uint64_t v8 = [objc_alloc(MEMORY[0x1E4F50490]) initWithPrivateStreamIdentifier:@"notificationSuggestionInteraction" storeConfig:v6 eventDataClass:objc_opt_class()];
    inner = v5->_inner;
