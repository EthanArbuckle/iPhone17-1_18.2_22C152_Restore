...
{
  v5.receiver = self;
  v5.super_class = (Class)ATXUserEducationSuggestionCustomizeFocus;
...
- (ATXUserEducationSuggestionCustomizeFocus)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)ATXUserEducationSuggestionCustomizeFocus;
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136315394;
      v13 = "-[ATXUserEducationSuggestionCustomizeFocus initWithCoder:]";
      __int16 v14 = 2114;
      v15 = v8;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      -[ATXUserEducationSuggestionCustomizeFocus initWithCoder:](v7);
    }
  }
...
- (void)initWithCoder:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  int v1 = 136315138;
  id v2 = "-[ATXUserEducationSuggestionCustomizeFocus initWithCoder:]";
