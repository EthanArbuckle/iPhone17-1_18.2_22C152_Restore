...
+ (void)logAppDirectoryCaptureWithTracker:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  v5 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:35];
  [v4 setConsumerSubType:v5];

  [v4 setCaptured:1];
  [v4 setCaptureType:1];
  v6 = [MEMORY[0x1E4F93950] stringForExecutableType:1];
...
+ (void)logAppDirectoryDiversionWithCaptureType:(int)a3 tracker:(id)a4
{
  ...
  id v5 = a4;
  v6 = objc_opt_new();
  v7 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:35];
  [v6 setConsumerSubType:v7];

  [v6 setCaptured:0];
  [v6 setCaptureType:v4];
  v8 = [MEMORY[0x1E4F93950] stringForExecutableType:1];
...
+ (void)logHomeScreenCaptureWithTracker:(id)a3
{
  ...
  id v5 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:34];
  [v4 setConsumerSubType:v5];
...
+ (void)logHomeScreenDiversionWithCaptureType:(int)a3 tracker:(id)a4
{
  ...
  id v5 = a4;
  v6 = objc_opt_new();
  v7 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:34];
  [v6 setConsumerSubType:v7];
...
+ (void)logSpotlightAppCaptureWithTracker:(id)a3
{
  id v3 = a3;
  uint64_t v4 = objc_opt_new();
  id v5 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:9];
  [v4 setConsumerSubType:v5];
...
+ (void)logSpotlightAppDiversionWithCaptureType:(int)a3 tracker:(id)a4
{
  ...
  id v5 = a4;
  v6 = objc_opt_new();
  v7 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:9];
  [v6 setConsumerSubType:v7];
...
+ (void)logSpotlightActionCaptureWithTracker:(id)a3
{
  id v3 = a3;
  uint64_t v4 = objc_opt_new();
  id v5 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:21];
  [v4 setConsumerSubType:v5];

  [v4 setCaptured:1];
  [v4 setCaptureType:1];
  v6 = [MEMORY[0x1E4F93950] stringForExecutableType:2];
  [v4 setExecutableType:v6];
...
+ (void)logSpotlightActionDiversionWithCaptureType:(int)a3 tracker:(id)a4
{
  ...
  id v5 = a4;
  v6 = objc_opt_new();
  v7 = [MEMORY[0x1E4F4B680] stringForConsumerSubtype:21];
  [v6 setConsumerSubType:v7];

  [v6 setCaptured:0];
  [v6 setCaptureType:v4];
  v8 = [MEMORY[0x1E4F93950] stringForExecutableType:2];
  [v6 setExecutableType:v8];
...
+ (void)logAppDirectoryCaptureWithTracker:.cold.1()
{
  ...
  [(id)OUTLINED_FUNCTION_5_4() consumerSubType];
    ...
    switch((int)v4)
    {
      ...
      default:
        switch(v4)
        {
          ...
          default:
            uint64_t v15 = v4;
            v8 = [NSString stringWithFormat:@"(unknown: %i)"];
            break;
        }
        break;
    }
  ...
  OUTLINED_FUNCTION_1_10(&dword_1A790D000, v9, v10, "LOGGED: %@ - ATXMPBBlendingCaptureRateTracker with consumerSubType: %@ captureType: %@", v11, v12, v13, v14, v15, v16, v17);
}
