...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ATXMPBFeedbackRecordedTracker;
  int v4 = [(ATXMPBFeedbackRecordedTracker *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return ATXMPBFeedbackRecordedTrackerReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[ATXMPBFeedbackRecordedTracker setConsumerSubType:](self, "setConsumerSubType:");
    id v4 = v5;
  }
}
