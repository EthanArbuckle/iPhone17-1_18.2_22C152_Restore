...
- (id)publisherFromStartTime:(double)a3
{
  ...
  v4 = [v3 filterWithIsIncluded:&__block_literal_global_32];
...
- (id)publisherFromStartTime:(double)a3 consumerSubType:(unsigned __int8)a4
{
  ...
  v5 = [v4 filterWithIsIncluded:&__block_literal_global_8_0];
...
- (id)deprecatedPublisherFromStartTime:(double)a3
{
  ...
  v4 = [v3 filterWithIsIncluded:&__block_literal_global_12];
