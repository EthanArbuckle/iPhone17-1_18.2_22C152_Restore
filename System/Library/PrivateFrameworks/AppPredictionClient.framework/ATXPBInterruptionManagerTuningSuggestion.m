...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ATXPBInterruptionManagerTuningSuggestion;
  int v4 = [(ATXPBInterruptionManagerTuningSuggestion *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return ATXPBInterruptionManagerTuningSuggestionReadFrom((uint64_t)self, (uint64_t)a3);
}
