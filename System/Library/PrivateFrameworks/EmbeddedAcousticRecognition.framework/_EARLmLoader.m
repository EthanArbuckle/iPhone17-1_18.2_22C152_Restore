...
{
  v8.receiver = self;
  v8.super_class = (Class)_EARLmLoader;
  v2 = [(_EARLmLoader *)&v8 init];
  if (v2)
  {
    std::allocate_shared[abi:ne180100]<quasar::LmLoader2,std::allocator<quasar::LmLoader2>,char const(&)[1],void>("", &v7);
    long long v3 = v7;
    long long v7 = 0uLL;
...
LABEL_11:
  ...
  if (v28)
  {
    ...
    id v18 = [(_EARLmModel *)v17 _initWithModel:&v20];
    if (v21) {
