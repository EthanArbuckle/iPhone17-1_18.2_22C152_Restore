...
- (TUIMismatchedAppleIDModel)init;
...
- (TUIMismatchedAppleIDModel)init
{
  return [(TUIMismatchedAppleIDModel *)self initWithFlow:0];
}

- (TUIMismatchedAppleIDModel)initWithFlow:(unint64_t)a3
{
  v24.receiver = self;
  v24.super_class = (Class)TUIMismatchedAppleIDModel;
  v4 = [(TUIMismatchedAppleIDModel *)&v24 init];
  v5 = v4;
  if (v4)
  {
    symbolName = v4->_symbolName;
    v4->_symbolName = (NSString *)@"person.icloud";

    v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    uint64_t v8 = [v7 localizedStringForKey:@"MISMATCHED_APPLEID_ERROR_TITLE" value:&stru_270C3F140 table:@"Localizable"];
    title = v5->_title;
    ...
    {
      v11 = v10;
      v12 = @"MISMATCHED_APPLEID_OPTIN_ERROR_DETAIL";
    }
    ...
    uint64_t v16 = [v15 localizedStringForKey:@"MISMATCHED_APPLEID_ERROR_PRIMARY_BUTTON" value:&stru_270C3F140 table:@"Localizable"];
