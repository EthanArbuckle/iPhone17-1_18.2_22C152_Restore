...
- (_TtC10CAFCombine27CAFBooleanSettingObservable)init;
...
{
  v2 = self;
  uint64_t v3 = CAFBooleanSettingObservable.description.getter();
  uint64_t v5 = v4;
...
{
  v2 = self;
  CAFBooleanSettingObservable.__deallocating_deinit();
}
...
- (void)automakerSettingService:(id)a3 didUpdateDisabled:(BOOL)a4
{
  id v5 = a3;
  v6 = self;
  CAFBooleanSettingObservable.automakerSettingService(_:didUpdateDisabled:)();
}
...
- (void)automakerSettingService:(id)a3 didUpdateLimitableUIElement:(BOOL)a4
{
  id v5 = a3;
  v6 = self;
  CAFBooleanSettingObservable.automakerSettingService(_:didUpdateLimitableUIElement:)();
}
...
- (void)automakerSettingService:(id)a3 didUpdateHidden:(BOOL)a4
{
  id v5 = a3;
  v6 = self;
  CAFBooleanSettingObservable.automakerSettingService(_:didUpdateHidden:)();
}
...
- (void)automakerSettingService:(id)a3 didUpdateShowAudioBrandLogo:(BOOL)a4
{
  id v5 = a3;
  v6 = self;
  CAFBooleanSettingObservable.automakerSettingService(_:didUpdateShowAudioBrandLogo:)();
}
...
- (void)automakerSettingService:(id)a3 didUpdateProminenceInfo:(id)a4
{
  ...
  id v7 = a4;
  v8 = self;
  CAFBooleanSettingObservable.automakerSettingService(_:didUpdateProminenceInfo:)((uint64_t)v8, a4);
}
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9 = a4;
  v11 = self;
  CAFBooleanSettingObservable.serviceDidUpdate(_:characteristic:fromGroupUpdate:)((uint64_t)v11, v10, a5);
}
...
- (void)serviceDidUpdate:(id)a3 receivedAllValues:(BOOL)a4
{
  id v6 = a3;
  id v7 = self;
  CAFBooleanSettingObservable.serviceDidUpdate(_:receivedAllValues:)((uint64_t)v7, a4);
}
