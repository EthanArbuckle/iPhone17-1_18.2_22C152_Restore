...
- (_TtC10CAFCombine22CAFDriveModeObservable)init;
- (void)dealloc;
...
{
  v2 = self;
  uint64_t v3 = CAFDriveModeObservable.description.getter();
  uint64_t v5 = v4;
...
{
  v2 = self;
  CAFDriveModeObservable.__deallocating_deinit();
}
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  id v9 = a4;
  v11 = self;
  CAFDriveModeObservable.serviceDidUpdate(_:characteristic:fromGroupUpdate:)((uint64_t)v11, v10, a5);
}
...
- (void)serviceDidUpdate:(id)a3 receivedAllValues:(BOOL)a4
{
  id v6 = a3;
  v7 = self;
  CAFDriveModeObservable.serviceDidUpdate(_:receivedAllValues:)((uint64_t)v7, a4);
}
