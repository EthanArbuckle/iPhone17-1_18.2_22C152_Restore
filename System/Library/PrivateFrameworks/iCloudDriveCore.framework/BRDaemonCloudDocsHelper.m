...
void __58__BRDaemonCloudDocsHelper_queryPathsForPersona_withError___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (v5)
    {
      ...
      [*(id *)(a1 + 32) setObject:v6 forKeyedSubscript:*MEMORY[0x263F32520]];
      ...
      if ([v9 isOpen])
      {
        v10 = objc_msgSend(MEMORY[0x263F325C0], "br_getProviderDomainIDForCurrentPersona");
        if (v10)
        {
          uint64_t v11 = *(void *)(*(void *)(a1 + 40) + 8);
          id obj = *(id *)(v11 + 40);
          v12 = [MEMORY[0x263F054C8] providerDomainWithID:v10 cachePolicy:0 error:&obj];
        ...
        if ([v17 count])
        {
          ...
          id v19 = objc_msgSend(v18, "br_realpathURLWithIsDirectory:", 1);

          if (v19)
          {
            [*(id *)(a1 + 32) setObject:v19 forKeyedSubscript:*MEMORY[0x263F324E0]];
          }
        }
      }
      else
    ...
    else
    {
      ...
      uint64_t v15 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: No home directory");
...
void __58__BRDaemonCloudDocsHelper_queryPathsForPersona_withError___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: No home directory%@", (uint8_t *)&v2, 0xCu);
}
...
void __58__BRDaemonCloudDocsHelper_queryPathsForPersona_withError___block_invoke_cold_2(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_debug_impl(&dword_23FA42000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Session %@ is not open. We can't get the mobile document path%@", (uint8_t *)&v3, 0x16u);
}
