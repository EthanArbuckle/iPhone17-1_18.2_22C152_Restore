...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sharing/copy-shareURL", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)_completedWithURL:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v19 = 2112;
    v20 = v9;
    _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished copying URL %@ for share %@ error %@%@", (uint8_t *)&v13, 0x2Au);
  }
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v40 = 2112;
        v41 = v10;
        _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Share: %@%@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v40 = 2112;
        v41 = v12;
        _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] Prepared record: %@%@", buf, 0x16u);
      }
...
LABEL_28:
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v40 = 2112;
        v41 = v32;
        _os_log_fault_impl(&dword_23FA42000, v33, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't get a share URL for %@%@", buf, 0x16u);
      }

      v29 = (void *)MEMORY[0x263F087E8];
      uint64_t v30 = *MEMORY[0x263F32430];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Couldn't get a share URL%@", v2, v3, v4, v5, v6);
}
