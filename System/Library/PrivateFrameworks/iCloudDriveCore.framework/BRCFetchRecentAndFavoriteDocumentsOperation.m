...
- (BRCFetchRecentAndFavoriteDocumentsOperation)initWithServerZone:(id)a3 sessionContext:(id)a4
{
  ...
  if (v13)
  {
    ...
    v14 = objc_msgSend(MEMORY[0x263EFD780], "br_fetchRecents");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sync/fetch-recents", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)_performQueryOperationForBit:(unsigned int)a3 index:(id)a4 completion:(id)a5
{
  ...
  {
    v28 = [MEMORY[0x263F08A98] predicateWithFormat:@"%K == %@", @"indexName", v8];
    v10 = (void *)[objc_alloc(MEMORY[0x263EFD7B0]) initWithRecordType:@"SearchIndexes" predicate:v28];
    ...
    id v40 = v9;
    v27 = v13;
    objc_super v16 = (void *)MEMORY[0x2455D9A50](v36);
    v17 = (void *)[objc_alloc(MEMORY[0x263EFD7C0]) initWithQuery:v10];
  ...
  if (v6 && (objc_msgSend(v6, "brc_isRetriable") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v23 = 2112;
      v24 = v8;
      _os_log_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] We seem to be unable to fetch %@. Setting the bit anyway to allow the sync engine to progress (error %@)%@", buf, 0x20u);
    }
...
void __93__BRCFetchRecentAndFavoriteDocumentsOperation__performQueryOperationForBit_index_completion___block_invoke_5(uint64_t a1)
{
  ...
  else
  {
    ...
    else
    {
      ...
      id v13 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: Couldn't allocate ranks when fetching query %@", *(void *)(a1 + 48));
...
void __93__BRCFetchRecentAndFavoriteDocumentsOperation__performQueryOperationForBit_index_completion___block_invoke_5_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_fault_impl(&dword_23FA42000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't allocate ranks when fetching query %@%@", (uint8_t *)&v4, 0x16u);
}
