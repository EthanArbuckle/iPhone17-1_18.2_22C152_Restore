...
uint64_t __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
  v4 = [v3 domain];
  int v5 = [v4 isEqualToString:*MEMORY[0x263F32360]];
...
LABEL_6:
  ...
  v12 = [v3 domain];
  int v13 = [v12 isEqualToString:*MEMORY[0x263EFD498]];
  ...
  {
    v14 = [v3 userInfo];
    v15 = [v14 objectForKeyedSubscript:*MEMORY[0x263F08608]];

    v16 = [v15 domain];
    if ([v16 isEqualToString:*MEMORY[0x263EFD4C0]])
    {
...
uint64_t __40__NSError_BRCAdditions__brc_isRetriable__block_invoke(uint64_t a1, void *a2)
{
  id v2 = a2;
  id v3 = [v2 domain];
  if (([v3 isEqualToString:*MEMORY[0x263F07F70]] & 1) != 0
    || ([v3 isEqualToString:*MEMORY[0x263F08570]] & 1) != 0)
  {
LABEL_3:
    uint64_t v4 = 1;
    goto LABEL_4;
  }
  if (![v3 isEqualToString:*MEMORY[0x263EFD498]])
  {
    if ([v3 isEqualToString:*MEMORY[0x263F32360]])
    {
LABEL_9:
      uint64_t v4 = 0;
      goto LABEL_4;
    }
    if (([v3 isEqualToString:*MEMORY[0x263F32430]] & 1) == 0)
    {
      v7 = brc_bread_crumbs();
      v8 = brc_default_log();
...
uint64_t __46__NSError_BRCAdditions__brc_isOutOfSpaceError__block_invoke(uint64_t a1, void *a2)
{
  ...
  int v4 = [v3 isEqualToString:*MEMORY[0x263F07F70]];
  ...
  int v7 = [v6 isEqualToString:*MEMORY[0x263F08438]];
...
void __35__NSError_BRCAdditions__initialize__block_invoke()
{
  ...
  id v2 = class_getInstanceMethod(v0, sel_brc_description);
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Server container was reset, we need to reset ourselves%@", v2, v3, v4, v5, v6);
}

void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Server change token expired, we need to reset ourselves%@", v2, v3, v4, v5, v6);
}

void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Server container was reset, zone not found, we need to reset ourselves%@", v2, v3, v4, v5, v6);
}

void __74__NSError_BRCAdditions__brc_containerResetErrorForSharedZone_resetReason___block_invoke_cold_4()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Server container was reset, user deleted zone, we need to reset ourselves%@", v2, v3, v4, v5, v6);
}

void __40__NSError_BRCAdditions__brc_isRetriable__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] unknown error domain: %@, we should retry%@");
}
