...
- (BRCSyncContext)metadataSyncContext
{
  ...
  {
    id v4 = [(BRCAccountSessionFPFS *)self->_session syncContextProvider];
...
- (NSString)ownerName
{
  return (NSString *)(id)*MEMORY[0x263EFD488];
}

- (CKRecordZoneID)zoneID
{
  id v3 = objc_alloc(MEMORY[0x263EFD808]);
...
- (BRMangledID)mangledID
{
  id v3 = objc_alloc(MEMORY[0x263F325E0]);
...
- (NSMutableDictionary)plist
{
  NSUInteger v3 = (void *)[objc_alloc(MEMORY[0x263EFF9A0]) initWithCapacity:4];
...
- (BOOL)_verifyChildbasehashSaltKeysForItemID:(id)a3 saltInfo:(id)a4 record:(id)a5
{
  ...
  uint64_t v11 = [v9 childBasehashSalt];
  if (!v11) {
    goto LABEL_4;
  }
  id v12 = (void *)v11;
  id v13 = [v9 childBasehashSalt];
  v14 = objc_msgSend(v13, "brc_truncatedSHA256");
  ...
  if ((v16 & 1) == 0)
  {
    ...
    id v24 = +[AppTelemetryTimeSeriesEvent newEDPKeysMismatchForRecordID:v22 mangledID:v23];
...
- (BOOL)_saveItemID:(id)a3 stat:(id)a4 serverMetrics:(id)a5 record:(id)a6 origName:(id)a7 base:(id)a8 no:(id)a9 ext:(id)a10
{
  ...
  id v24 = [v23 zoneID];
  v25 = [v24 ownerName];
  uint64_t v26 = [(BRCAccountSessionFPFS *)session userKeyForOwnerName:v25 db:self->_db];
...
LABEL_37:
      uint64_t v182 = 0;
      if ([(BRCServerZone *)v20 isSharedZone]
        && ([v17 parentID],
            v60 = objc_claimAutoreleasedReturnValue(),
            char v61 = [v60 isSharedZoneRoot],
            v60,
            (v61 & 1) == 0))
      {
        db = v20->_db;
        v64 = [(BRCServerZone *)v20 dbRowID];
        id v65 = [(BRCPQLConnection *)db fetch:@"SELECT item_favoriterank, item_lastusedtime, item_finder_tags, item_side_car_ckinfo FROM server_items WHERE item_id = %@ AND zone_rowid = %@", v16, v64];
        ...
        if (v66)
        {
          ...
          v67 = [v65 dataAtIndex:2];
          [v17 setFinderTags:v67];

          v171 = [v65 objectOfClass:objc_opt_class() atIndex:3];
          id v68 = v65;
        }
        else
        {
          v69 = [(BRCServerZone *)v20 asSharedZone];
          v70 = [v16 sideCarRecordNameWithZone:v69];

          id v68 = [(BRCPQLConnection *)v20->_db fetch:@"SELECT item_favoriterank, item_lastusedtime, item_finder_tags, item_side_car_ckinfo FROM side_car_lookahead WHERE record_name = %@", v70];
          if ([v68 next])
          {
            ...
            v71 = [v68 dataAtIndex:2];
            [v17 setFinderTags:v71];

            v171 = [v68 objectOfClass:objc_opt_class() atIndex:3];
            [(BRCPQLConnection *)v20->_db execute:@"DELETE FROM side_car_lookahead WHERE record_name = %@", v70];
          }
          else
          {
            v171 = 0;
      ...
      unsigned int v72 = [v17 type];
      uint64_t v73 = -1;
      if (v72 <= 0xA && ((1 << v72) & 0x611) != 0)
      {
        [v22 deserializeFolderSharingOptions:&v182];
        if (([(BRCServerZone *)v20 state] & 4) != 0)
        {
          [v17 setType:0];
        }
        else
        {
          id v74 = [(PQLConnection *)v20->_db numberWithSQL:@"SELECT item_type FROM server_items WHERE item_id = %@ AND zone_rowid = %@", v16, v20->_dbRowID];
          v75 = v74;
          if (v74)
          {
            objc_msgSend(v17, "setType:", (char)objc_msgSend(v74, "longLongValue"));
            unsigned int v115 = [v17 type];
          ...
          {
            v76 = [(BRCServerZone *)v20 mangledID];
            v77 = +[BRCUserDefaults defaultsForMangledID:v76];
            int v78 = [v77 forceDeltaInitialSync];
      ...
      if (v80)
      {
        unsigned int v81 = [v17 type];
        uint64_t v169 = 2;
        if (v81 > 0xA || ((1 << v81) & 0x611) == 0) {
          goto LABEL_70;
        }
        if (([v22 hasChainPCS] & 1) == 0)
        {
          ...
          v84 = [(BRCAccountSessionFPFS *)v20->_session clientTruthWorkloop];
          block[0] = MEMORY[0x263EF8330];
          block[1] = 3221225472;
      ...
      uint64_t v169 = v85;
LABEL_70:
      v173 = [[BRCBasehashSaltInfo alloc] initWithRecord:v22];
      ...
      {
        v86 = objc_msgSend(MEMORY[0x263EFF8F8], "brc_generateBogusKey");
        [(BRCBasehashSaltInfo *)v173 setChildBasehashSalt:v86];
      }
      v167 = v17;
      v165 = v20;
      if (v62) {
      ...
      int v150 = [v17 type];
      int v148 = [v17 mode];
      uint64_t v144 = [v17 birthtime];
      uint64_t v142 = [v17 lastUsedTime];
      uint64_t v140 = [v17 favoriteRank];
      v161 = [v17 parentID];
      v96 = (__CFString *)v17[7];
      if (!v96) {
        v96 = &stru_26F3822F0;
      }
      v146 = v96;
      unsigned int v132 = [v17 isHiddenExt];
      v159 = [v17 finderTags];
      v138 = [v17 xattrSignature];
      v136 = [v17 trashPutBackPath];
      v134 = [v17 trashPutBackParentID];
      v126 = [v17 aliasTarget];
      v130 = [v17 creatorRowID];
      v128 = [v27 quotaUsed];
      [v27 recursiveChildCount];
      v124 = v97 = v27;
      v98 = [v27 sharedByMeRecursiveCount];
      v99 = [v27 sharedAliasRecursiveCount];
      v100 = [v97 childCount];
      v101 = [(BRCBasehashSaltInfo *)v173 childBasehashSalt];
      uint64_t v102 = v73;
      uint64_t v103 = [(BRCBasehashSaltInfo *)v173 saltingState];
      [(BRCBasehashSaltInfo *)v173 basehashSaltValidation];
      v104 = uint64_t v120 = v103;
      BOOL v157 = -[BRCPQLConnection execute:](v156, "execute:", @"UPDATE server_items SET   item_rank = NULL, item_depth = 0, item_origname = %@, pcs_state = %d, item_sharing_options = (%lu | (item_sharing_options & %lu)), item_side_car_ckinfo = %@, item_stat_ckinfo = %@, item_state = %d, item_type = %d, item_mode = %d, item_birthtime = %lld, item_lastusedtime = %lld, item_favoriterank = %lld, item_parent_id = %@, item_filename = %@, item_hidden_ext = %d, item_finder_tags = %@, item_xattr_signature = %@, item_trash_put_back_path = %@, item_trash_put_back_parent_id = %@, item_alias_target = %@, item_creator = %@, quota_used = %@, recursive_child_count = %@, shared_children_count = %@, shared_alias_count = %@, child_count = %@, child_basehash_salt = %@, salting_state = %u, basehash_salt_validation_key = %@ WHERE item_id = %@ AND zone_rowid = %@", v176, v169, v154, v102, v171, v164, v152, v150, v148, v144, v142, v140, v161, v146, v132, v159,
               v138,
               v136,
               v134,
               v126,
      ...
      BOOL v17 = v167;
      v27 = v175;
      if (![(BRCPQLConnection *)v20->_db changes])
      {
LABEL_75:
        if (([v179 isDocumentsFolder] & 1) == 0
          && [(NSArray *)v20->_directoriesCreatedLastSyncUp containsObject:v179]
          && [v17 type] == 9)
        {
          ...
          {
            v89 = [v179 debugItemIDString];
            *(_DWORD *)buf = 138412546;
            id v184 = v89;
            __int16 v185 = 2112;
            id v186 = v87;
            _os_log_impl(&dword_23FA42000, v88, OS_LOG_TYPE_DEFAULT, "[NOTICE] Promoting %@ to be a normal directory because it was created from our own sync up%@", buf, 0x16u);
          }
          [v17 setType:0];
        }
        uint64_t v153 = v182;
        ...
        int v149 = [v17 type];
        int v143 = [v17 mode];
        uint64_t v147 = [v17 birthtime];
        uint64_t v145 = [v17 lastUsedTime];
        uint64_t v139 = [v17 favoriteRank];
        v158 = [v17 parentID];
        v90 = (__CFString *)v17[7];
        if (!v90) {
          v90 = &stru_26F3822F0;
        }
        v135 = v90;
        ...
        v141 = [v17 finderTags];
        v137 = [v17 xattrSignature];
        v160 = [v17 trashPutBackPath];
        v123 = [v17 trashPutBackParentID];
        v131 = [v17 aliasTarget];
        v129 = [v17 creatorRowID];
        dbRowID = v20->_dbRowID;
        v122 = [v27 quotaUsed];
        v127 = [v27 recursiveChildCount];
        v121 = [v27 sharedByMeRecursiveCount];
        v125 = [v27 sharedAliasRecursiveCount];
        v92 = [v27 childCount];
        v93 = [(BRCBasehashSaltInfo *)v173 childBasehashSalt];
        uint64_t v94 = [(BRCBasehashSaltInfo *)v173 saltingState];
        v95 = [(BRCBasehashSaltInfo *)v173 basehashSaltValidation];
        BOOL v170 = -[BRCPQLConnection execute:](v155, "execute:", @"INSERT INTO server_items(item_id, item_creator_id, item_sharing_options, item_side_car_ckinfo, item_rank, item_origname, pcs_state, item_stat_ckinfo, item_state, item_type, item_mode, item_birthtime, item_lastusedtime, item_favoriterank,item_parent_id, item_filename, item_hidden_ext, item_finder_tags, item_xattr_signature, item_trash_put_back_path, item_trash_put_back_parent_id, item_alias_target, item_creator, zone_rowid, quota_used, recursive_child_count, shared_children_count, shared_alias_count, child_count, child_basehash_salt, salting_state, basehash_salt_validation_key) VALUES(%@, %@, %ld, %@, NULL, %@, %d, %@, %d, %d, %d, %lld, %lld, %lld, %@, %@, %d, %@, %@, %@, %@, %@, %@, %@, %@, %@, %@, %@, %@, %@, %u, %@)", v179, v174, v153, v171, v176, v169, v163, v151, v149, v143, v147, v145, v139, v158, v135, v133,
                 v141,
                 v137,
                 v160,
                 v123,
...
LABEL_96:
      ...
      uint64_t v22 = v168;
      if ([(BRCPQLConnection *)v20->_db changes] != 1)
      {
      ...
      unsigned int v105 = [v17 type];
      id v19 = v166;
      if (v105 <= 0xA
        && ((1 << v105) & 0x611) != 0
        && ([v168 modificationDate],
            v106 = objc_claimAutoreleasedReturnValue(),
            [v106 timeIntervalSince1970],
            uint64_t v108 = (uint64_t)v107,
            v106,
            ![(BRCPQLConnection *)v20->_db execute:@"UPDATE server_items SET  version_mtime = %lld  WHERE item_id = %@ AND zone_rowid = %@", v108, v179, v20->_dbRowID]))
      {
        BOOL v30 = 0;
      }
      else
    ...
    v32 = [v17 parentID];
    v33 = [v17 logicalName];
    id v34 = [(PQLConnection *)v31 itemIDWithSQL:@"SELECT item_id FROM server_items  WHERE item_id != %@ AND item_parent_id = %@ AND item_filename = %@ AND +zone_rowid = %@", v16, v32, v33, self->_dbRowID];
...
LABEL_36:
    ...
    v35 = v20->_db;
    v36 = [v17 parentID];
    id v37 = [(BRCPQLConnection *)v35 fetch:@"SELECT item_origname, item_filename FROM server_items  WHERE item_id = %@ AND item_parent_id = %@ AND +zone_rowid = %@", v16, v36, v20->_dbRowID];

    if ([v37 next])
    {
      v172 = v37;
      v38 = [v37 stringAtIndex:0];
      v39 = [v17 logicalName];
      ...
      if (v40)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v187 = 2112;
          v188 = v42;
          _os_log_debug_impl(&dword_23FA42000, v43, OS_LOG_TYPE_DEBUG, "[DEBUG] Keeping bounce of %@ even though it clashes with %@%@", buf, 0x20u);
        }

        v44 = [v172 stringAtIndex:1];
        [v17 setLogicalName:v44];
        v45 = v176;
        id v176 = v38;
        goto LABEL_33;
      }
    ...
    unint64_t v46 = [v19 integerValue];
    if (v46 <= 1) {
      uint64_t v47 = 1;
    }
    else {
...
LABEL_35:
    ...
    {
      v49 = NSString;
      v50 = [NSNumber numberWithUnsignedInteger:v48];
      v51 = [v50 stringValue];
      v44 = objc_msgSend(v49, "br_representableHFSFileNameWithBase:suffix:extension:makeDotFile:", v178, v51, v177, 0);

      if (![(BRCPQLConnection *)v41->_db execute:@"UPDATE OR IGNORE server_items SET  item_rank = NULL, item_depth = 0, item_filename = %@, item_origname = IFNULL(item_origname, item_filename) WHERE zone_rowid = %@ AND item_id = %@", v44, v41->_dbRowID, v34])
      {
        v52 = brc_bread_crumbs();
        v53 = brc_default_log();
        if (os_log_type_enabled(v53, OS_LOG_TYPE_FAULT))
        {
          v162 = [(BRCPQLConnection *)v41->_db lastError];
          v57 = [v162 localizedDescription];
          *(_DWORD *)buf = 138412546;
          id v184 = v57;
          __int16 v185 = 2112;
          id v186 = v52;
          _os_log_fault_impl(&dword_23FA42000, v53, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: got a SQL Error: %@%@", buf, 0x16u);
        }
      }
      if ([(BRCPQLConnection *)v41->_db changes]) {
        break;
      }
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v187 = 2112;
        v188 = v54;
        _os_log_debug_impl(&dword_23FA42000, v55, OS_LOG_TYPE_DEBUG, "[DEBUG] Not bouncing %@ to %@ because that's not a unique filename%@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      __int16 v191 = 2112;
      v192 = v45;
      _os_log_impl(&dword_23FA42000, v58, OS_LOG_TYPE_DEFAULT, "[WARNING] Bounced itemID %@ from \"%@\" to \"%@\" because it clashes with %@%@", buf, 0x34u);
    }
    v27 = v175;
LABEL_33:
...
LABEL_34:
  ...
  if (os_log_type_enabled(v29, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v187 = 2112;
    v188 = v28;
    _os_log_error_impl(&dword_23FA42000, v29, (os_log_type_t)0x90u, "[ERROR] can't save %@: missing ownerKey for ownerName \"%@\"%@", buf, 0x20u);
  }
  BOOL v30 = 0;
  v27 = v175;
LABEL_97:
...
- (BOOL)_saveItemID:(id)a3 stat:(id)a4 serverMetrics:(id)a5 record:(id)a6 error:(id *)a7
{
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if ((v19 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        v83 = v17;
        __int16 v84 = 2112;
        uint64_t v85 = (const char *)v14;
        __int16 v86 = 2112;
        v87 = v41;
        _os_log_fault_impl(&dword_23FA42000, v42, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't deserialize filename: %@ of %@%@", buf, 0x20u);
      }
    ...
    id v22 = v81;
    v23 = [v79 stringValue];
    id v24 = objc_msgSend(v21, "br_representableHFSFileNameWithBase:suffix:extension:makeDotFile:", v22, v23, v80, 0);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      __int16 v90 = 2112;
      v91 = v25;
      _os_log_impl(&dword_23FA42000, v26, OS_LOG_TYPE_DEFAULT, "[WARNING] changing filename to \"%@\" because \"%@\" is unrepresentable (item ID: %@, last editor: %@)%@", buf, 0x34u);
    }
    id v13 = v20;
    a7 = v74;
  }
  ...
  id v34 = objc_msgSend(NSString, "br_emptyFilenameAlternativeName");
  id v35 = v81;
  id v81 = v34;
  ...
  if (v80)
  {
    int v40 = objc_msgSend(v81, "stringByAppendingPathExtension:");
...
LABEL_28:
  ...
  if (os_log_type_enabled(v52, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v88 = 2112;
    v89 = v51;
    _os_log_error_impl(&dword_23FA42000, v52, (os_log_type_t)0x90u, "[ERROR] changing filename to \"%@\" because \"%@\" is %s name%@", buf, 0x2Au);
  }
  v53 = [v12 logicalName];
...
LABEL_35:
  if (!v81)
  {
    ...
    {
      brc_bread_crumbs();
      char v62 = (id *)objc_claimAutoreleasedReturnValue();
      v63 = brc_default_log();
      if (os_log_type_enabled(v63, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v86 = 2112;
        v87 = v62;
        _os_log_fault_impl(&dword_23FA42000, v63, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't deserialize filename: %@ of %@%@", buf, 0x20u);
      }
  ...
  if (-[BRCServerZone _saveItemID:stat:serverMetrics:record:origName:base:no:ext:](v33, "_saveItemID:stat:serverMetrics:record:origName:base:no:ext:", v11, v12, v13, v14, v18, v79, v80))
  {
    ...
    else
    {
      id v65 = v14;
      int v66 = a7;
      objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"no record to update: %@", v11);
      ...
      if (a7)
      {
        ...
        if (os_log_type_enabled(v68, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          ...
          __int16 v88 = 2112;
          v89 = v67;
          _os_log_error_impl(&dword_23FA42000, v68, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
        }
      }
      if (v66) {
        *int v66 = a7;
  ...
  char v61 = brc_default_log();
  if (os_log_type_enabled(v61, (os_log_type_t)0x90u))
  {
    unsigned int v72 = [(BRCPQLConnection *)v33->_db lastError];
    *(_DWORD *)buf = 138412802;
    v83 = (const char *)v11;
    __int16 v84 = 2112;
    uint64_t v85 = v72;
    __int16 v86 = 2112;
    v87 = v60;
    _os_log_error_impl(&dword_23FA42000, v61, (os_log_type_t)0x90u, "[ERROR] Failed to update record (%@): %@%@", buf, 0x20u);
...
- (BOOL)_saveItemID:(id)a3 version:(id)a4 record:(id)a5 contentBoundaryKey:(id)a6 iWorkSharingOptions:(unint64_t)a7
{
  ...
  db = self->_db;
  id v35 = a6;
  id v34 = [v12 originalPOSIXName];
  v33 = [v12 ckInfo];
  uint64_t v32 = [v12 mtime];
  uint64_t v31 = [v12 size];
  uint64_t v30 = [v12 thumbnailSize];
  v29 = [v12 thumbnailSignature];
  v28 = [v12 contentSignature];
  id v13 = [v12 xattrSignature];
  id v14 = [v12 editedSinceShared];
  v15 = [v12 lastEditorDeviceOrUserRowID];
  char v16 = [v12 conflictLoserEtags];
  BOOL v17 = [v12 quarantineInfo];
  BOOL v18 = -[BRCPQLConnection execute:](db, "execute:", @"UPDATE server_items    SET item_rank = NULL, item_depth = 0, item_sharing_options = (%lu | (item_sharing_options & %lu)),         content_boundary_key = %@, version_name = %@, version_ckinfo = %@, version_mtime = %lld, version_size = %lld, version_thumb_size = %lld, version_thumb_signature = %@, version_content_signature = %@, version_xattr_signature = %@, version_edited_since_shared = %@, version_device = %@, version_conflict_loser_etags = %@, version_quarantine_info = %@  WHERE item_id = %@ AND zone_rowid = %@", a7, -8, v35, v34, v33, v32, v31, v30, v29, v28, v13, v14, v15, v16, v17, v11,
          self->_dbRowID);
  ...
  if (!v18)
  {
    ...
    {
      v21 = v27;
      v25 = [v27 debugDescription];
      uint64_t v26 = [(BRCPQLConnection *)self->_db lastError];
      *(_DWORD *)buf = 138412802;
      id v39 = v25;
      __int16 v40 = 2112;
      id v41 = v26;
      __int16 v42 = 2112;
      v43 = v22;
      _os_log_error_impl(&dword_23FA42000, v23, (os_log_type_t)0x90u, "[ERROR] failed saving document %@: %@%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v42 = 2112;
        v43 = v22;
        _os_log_debug_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Document without a structure record but we haven't completed full sync.  Dropping the record on the floor for now i:%@ %@%@", buf, 0x20u);
      }
    }
    goto LABEL_11;
  }
...
- (BOOL)_saveEditedDirOrDocStructureRecord:(id)a3 error:(id *)a4
{
  ...
  id location = 0;
  id v7 = [v6 recordID];
  id v8 = objc_msgSend(v7, "brc_itemIDWithSession:error:", self->_session, &location);
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v30 = 2112;
      id v31 = v17;
      _os_log_error_impl(&dword_23FA42000, v18, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
    }
    if (a4)
    {
      BOOL v13 = 0;
...
- (BOOL)_saveEditedDocumentContentRecord:(id)a3 error:(id *)a4
{
  ...
  if (!v8)
  {
    ...
    if (v33)
    {
      ...
      {
        unint64_t v46 = "(passed to caller)";
        *(_DWORD *)buf = 136315906;
        id v79 = "-[BRCServerZone _saveEditedDocumentContentRecord:error:]";
        __int16 v80 = 2080;
        if (!a4) {
          unint64_t v46 = "(ignored by caller)";
        }
        id v81 = (id)v46;
        __int16 v82 = 2112;
        id v83 = v33;
  ...
  if (v15)
  {
    ...
    if (v19)
    {
      ...
      v21 = [(BRCAccountSessionFPFS *)self->_session cachedCurrentUserRecordName];
      id v70 = 0;
      ...
      if (v22)
      {
        if (([v63 isEqualToString:v22] & 1) == 0)
        {
          ...
          if ((v24 & 1) == 0)
          {
            ...
            [v16 setEditedSinceShared:MEMORY[0x263EFFA88]];
            id v22 = v25;
          }
        }
      }
      if ([v22 isEqualToString:*MEMORY[0x263EFD488]])
      {
        ...
        if (v29 == 64)
        {
          __int16 v32 = [(BRCAccountSessionFPFS *)session createUserKeyForOwnerName:v22];
          [v16 setLastEditorRowID:v32];
        }
        else
        {
          __int16 v32 = [(BRCAccountSessionFPFS *)session createDeviceKeyForNameInServerDB:v28];
      ...
      id v41 = [(BRCAccountSessionFPFS *)self->_session createUserKeyForOwnerName:v22];
...
LABEL_54:
      ...
      __int16 v42 = [(BRCAccountSessionFPFS *)self->_session serverDB];
      char v61 = v22;
      v43 = +[BRCAccountSessionFPFS userIdentityForName:v22 db:v42];
      uint64_t v44 = v43;
      if (v43) {
        v45 = v43;
      }
...
LABEL_55:
          ...
          if ((v51 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v55, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v82 = 2112;
              id v83 = v54;
              _os_log_fault_impl(&dword_23FA42000, v55, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't deserialize extension: %@ of %@%@", buf, 0x20u);
            }
        ...
        int v58 = [(BRCAccountSessionFPFS *)self->_session analyticsReporter];
...
LABEL_53:
  ...
  _os_log_error_impl(&dword_23FA42000, v37, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
  ...
  if (!v8)
  {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v17, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 136315906;
        id v37 = "-[BRCServerZone _saveEditedSymlinkRecord:error:]";
        __int16 v38 = 2080;
        if (!a4) {
...
LABEL_31:
        ...
        if (os_log_type_enabled(v25, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v40 = 2112;
          id v41 = v24;
          _os_log_error_impl(&dword_23FA42000, v25, (os_log_type_t)0x90u, "[ERROR] failed saving symlink %@: %@%@", buf, 0x20u);
        }
        if (a4)
        {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v40 = 2112;
          id v41 = v21;
          _os_log_error_impl(&dword_23FA42000, v22, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
        }
        if (a4)
        {
          id v23 = location;
LABEL_29:
  ...
  {
    uint64_t v26 = [v6 debugDescription];
    *(_DWORD *)buf = 138412802;
    id v37 = v26;
    __int16 v38 = 2112;
    id v39 = location;
    __int16 v40 = 2112;
    id v41 = v18;
    _os_log_error_impl(&dword_23FA42000, v19, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
  }
  if (!a4)
  {
LABEL_19:
...
LABEL_18:
      ...
      if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v37 = 2112;
        __int16 v38 = v23;
        _os_log_error_impl(&dword_23FA42000, v24, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
      }
      if (!a4)
      {
        BOOL v19 = 0;
...
LABEL_12:
  ...
  if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v37 = 2112;
    __int16 v38 = v20;
    _os_log_error_impl(&dword_23FA42000, v21, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
  }
  if (!a4) {
    goto LABEL_12;
  }
...
- (BOOL)_saveEditedAliasRecord:(id)a3 zonesNeedingAllocRanks:(id)a4 error:(id *)a5
{
  ...
  uint64_t v14 = [(BRCAccountSessionFPFS *)session userKeyForOwnerName:v13 db:self->_db];
    ...
    if (v16)
    {
      ...
      if (v19)
      {
        ...
        if (v31)
        {
          ...
          id v33 = [(BRCAccountSessionFPFS *)self->_session clientZoneByMangledID:v32];
          id v16 = v70;
          id v9 = v71;
          if ([v33 isSharedZone])
          {
            ...
            if ([(BRCPQLConnection *)self->_db changes])
            {
              ...
              if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138412802;
                ...
                __int16 v80 = 2112;
                id v81 = v37;
                _os_log_debug_impl(&dword_23FA42000, v38, OS_LOG_TYPE_DEBUG, "[DEBUG] Requesting a new item rank for target %@ of %@%@", buf, 0x20u);
              }
        ...
        if (os_log_type_enabled(v50, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v80 = 2112;
          id v81 = v49;
          _os_log_error_impl(&dword_23FA42000, v50, (os_log_type_t)0x90u, "[ERROR] failed saving alias %@: %@%@", buf, 0x20u);
        }
        id v16 = v70;
        a5 = v58;
        if (v58)
      ...
      {
        unint64_t v46 = brc_bread_crumbs();
        ...
        if (os_log_type_enabled(v47, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v80 = 2112;
          id v81 = v46;
          _os_log_error_impl(&dword_23FA42000, v47, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
        }
        if (a5)
        {
          id v48 = location;
...
LABEL_9:
  [(BRCAccountSessionFPFS *)self->_session learnParticipantIdentitiesForShare:v6 forceUpdate:0];
  if (!v8)
  {
    char v24 = brc_bread_crumbs();
    v25 = brc_default_log();
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      BOOL v40 = v24;
      _os_log_impl(&dword_23FA42000, v25, OS_LOG_TYPE_DEFAULT, "[WARNING] ignoring unknown itemID on share%@", buf, 0xCu);
    }
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v43 = 2112;
      uint64_t v44 = v27;
      _os_log_error_impl(&dword_23FA42000, v28, (os_log_type_t)0x90u, "[ERROR] can't deserialize %@: %@%@", buf, 0x20u);
    }
    if (a4)
    {
      id v29 = v17;
  ...
  if (![(BRCPQLConnection *)self->_db execute:@"UPDATE server_items    SET item_rank = NULL, item_sharing_options = (%lu | (item_sharing_options & %lu)),         item_mode = (%ld | (item_mode & %lu)), item_depth = 0  WHERE item_id = %@ AND zone_rowid = %@", v38, 7, ((unint64_t)(v38 & 0x20) >> 5) ^ 1, v18, v8, self->_dbRowID])
  {
    ...
    if (os_log_type_enabled(v31, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v43 = 2112;
      uint64_t v44 = v30;
      _os_log_error_impl(&dword_23FA42000, v31, (os_log_type_t)0x90u, "[ERROR] failed saving document %@: %@%@", buf, 0x20u);
    }
    if (a4)
    {
  ...
  if ([v12 isEqualToString:@"structure"])
  {
    ...
    else
    {
      if (![v11 hasPrefix:@"finderBookmark/"])
      {
        ...
        uint64_t v27 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: structure record which isn't a directory or document");
        if (v27)
        {
          ...
          if (os_log_type_enabled(v29, (os_log_type_t)0x90u))
          {
            ...
            __int16 v37 = 2112;
            uint64_t v38 = v28;
            _os_log_error_impl(&dword_23FA42000, v29, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v31, 0x2Au);
          }
        }
        if (a5) {
          *a5 = v27;
...
LABEL_20:
  ...
  if ([v12 isEqualToString:*MEMORY[0x263EFD510]])
  {
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v33 = 2112;
    id v34 = v22;
    _os_log_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Consistent state but unknown record type (recordType: %@).%@", (uint8_t *)&v31, 0x16u);
  }
  BOOL v19 = 1;
LABEL_21:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v13 = 2112;
        int v14 = v7;
        _os_log_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] deleted shareID %@ was for already dead item%@", buf, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v15 = 2112;
      char v16 = v7;
      _os_log_error_impl(&dword_23FA42000, v8, (os_log_type_t)0x90u, "[ERROR] failed saving tombstone share %@: %@%@", buf, 0x20u);
    }
  }
...
- (BOOL)_markItemDeadForRecordID:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v7 = [v4 zoneID];
    id v8 = [v7 ownerName];
    id v9 = [(BRCAccountSessionFPFS *)session userKeyForOwnerName:v8 db:self->_db];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v24 = 2112;
          v25 = v14;
          _os_log_error_impl(&dword_23FA42000, v15, (os_log_type_t)0x90u, "[ERROR] failed saving tombstone %@: %@%@", buf, 0x20u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v24 = 2112;
        v25 = v10;
        _os_log_error_impl(&dword_23FA42000, v14, (os_log_type_t)0x90u, "[ERROR] can't save %@: missing ownerKey for ownerName \"%@\"%@", buf, 0x20u);
      }
      char v13 = 0;
    }
  }
...
- (BOOL)_saveEditedStructureRecords:(id)a3 zonesNeedingAllocRanks:(id)a4
{
  ...
  if (v7)
  {
    ...
    uint64_t v10 = *MEMORY[0x263EFD510];
    while (2)
    {
...
LABEL_3:
    ...
    while (1)
    {
      ...
      uint64_t v10 = (void *)MEMORY[0x2455D97F0](v5);
...
- (void)_reportCantSaveProblem:(id)a3 record:(id)a4
{
  ...
  if ([v8 isEqualToString:*MEMORY[0x263F32430]])
  {
  ...
  if (v7)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        BOOL v13 = (void *)MEMORY[0x2455D97F0]();
        int v14 = [v12 recordType];
...
- (BOOL)_saveEditedShareRecords:(id)a3 deletedShareRecordIDs:(id)a4 zonesNeedingAllocRanks:(id)a5
{
  ...
  if (v10)
  {
    ...
    uint64_t v13 = *MEMORY[0x263EFD510];
    while (2)
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        BOOL v16 = (void *)MEMORY[0x2455D97F0]();
...
LABEL_21:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v26 = 2112;
    long long v27 = v20;
    _os_log_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Recovered sharing options on %@ by setting ck share options to null%@", buf, 0x16u);
  }
LABEL_22:
...
- (void)_recomputeMinLastUsedTime
{
  ...
  if (v8 != v6)
  {
    id v9 = [(BRCAccountSessionFPFS *)self->_session serverState];
    [v9 setMinLastUsedTime:v6];

    id v10 = [(BRCAccountSessionFPFS *)self->_session serverState];
...
- (BOOL)allocateRanksWhenCaughtUp:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v118[8] = 2112;
    *(void *)&v118[10] = v10;
    _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] caughtUp [%s] fullSync [%s]%@", buf, 0x20u);
  }
  ...
  v106 = [MEMORY[0x263F8C720] rawInjection:v12 length:v13];
  ...
  if ([v14 next])
  {
    ...
    int v102 = v15 | v109;
    int v105 = v15 & v109;
    unint64_t v16 = 0x26507D000uLL;
    uint64_t v103 = v6;
    uint64_t v104 = v6;
    do
    {
      uint64_t v17 = MEMORY[0x2455D97F0]();
          ...
          if ([v29 BOOLValue])
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v117 = 2112;
              *(void *)v118 = v30;
              _os_log_debug_impl(&dword_23FA42000, v31, OS_LOG_TYPE_DEBUG, "[DEBUG] Server killed %@ but it still has live children%@", buf, 0x16u);
            }
            ...
            if (v109)
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
              {
                ...
                *(_WORD *)&v118[4] = 2112;
                *(void *)&v118[6] = v33;
                _os_log_fault_impl(&dword_23FA42000, v34, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server killed %s but it still has %d live children%@", buf, 0x1Cu);
              }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_WORD *)&v118[4] = 2112;
                *(void *)&v118[6] = v35;
                _os_log_debug_impl(&dword_23FA42000, v36, OS_LOG_TYPE_DEBUG, "[DEBUG] State inconsistent because %@ has %d live children%@", buf, 0x1Cu);
              }
              id v32 = v29;
            }
            ...
            if (v105)
            {
              ...
              if (os_log_type_enabled(v47, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = 138412546;
                ...
                __int16 v117 = 2112;
                *(void *)v118 = v46;
                _os_log_fault_impl(&dword_23FA42000, v47, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: State inconsistent because %@ is a document with no version%@", buf, 0x16u);
              }

              id v48 = [(BRCClientZone *)self->_clientZone asPrivateClientZone];
              v49 = [*(id *)(v16 + 3288) structureRecordPrefixForItemType:1 targetZoneShared:0];
...
LABEL_47:
            ...
            else
            {
              ...
              if (os_log_type_enabled(v49, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138412546;
                ...
                __int16 v117 = 2112;
                *(void *)v118 = v48;
                _os_log_debug_impl(&dword_23FA42000, v49, OS_LOG_TYPE_DEBUG, "[DEBUG] We haven't received a content record on %@ yet, delaying for now%@", buf, 0x16u);
                goto LABEL_47;
              }
            }
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v117 = 2112;
              *(void *)v118 = v29;
              _os_log_debug_impl(&dword_23FA42000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %@ to be a directory fault because it has a new unapplied item%@", buf, 0x16u);
            }
            id v39 = 0;
            uint64_t v23 = -3;
LABEL_66:
              ...
              else
              {
                if (v109)
                {
                  ...
                  if (os_log_type_enabled(v62, OS_LOG_TYPE_FAULT))
                  {
                    ...
                    *(_WORD *)&v118[8] = 2112;
                    *(void *)&v118[10] = v61;
                    _os_log_fault_impl(&dword_23FA42000, v62, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent live item %s parented to dead item %s%@", buf, 0x20u);
                  }
                ...
                if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_WORD *)&v118[8] = 2112;
                  *(void *)&v118[10] = v75;
                  _os_log_impl(&dword_23FA42000, v76, OS_LOG_TYPE_DEFAULT, "[WARNING] Server sent us live item %@ parented to dead item %@ but we haven't completed full sync. Delaying apply%@", buf, 0x20u);
                }
              ...
              if (([v39 next] & 1) == 0)
              {
                if (!v102)
                {
                  ...
                  if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_WORD *)&v118[8] = 2112;
                    *(void *)&v118[10] = v29;
                    _os_log_debug_impl(&dword_23FA42000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] Server sent us an item %@ which we couldn't locate share for, but we aren't caught up yet (parented to %@)%@", buf, 0x20u);
                  }
                  goto LABEL_51;
                }
                ...
                if (os_log_type_enabled(v79, OS_LOG_TYPE_FAULT))
                {
                  ...
                  *(_WORD *)&v118[8] = 2112;
                  *(void *)&v118[10] = v101;
                  _os_log_fault_impl(&dword_23FA42000, v79, OS_LOG_TYPE_FAULT, "[CRIT] Server sent us an item %@ which has non-root share options but isn't parented to a share (parented to %@)%@", buf, 0x20u);
                }
                ...
                if (![(BRCServerZone *)self _recoverFromCorruptShareOptionsWithItemType:v20 itemID:v112 parentID:v18 sharingOptions:v24])
                {
                  ...
                  if (os_log_type_enabled(v35, OS_LOG_TYPE_FAULT))
                  {
                    ...
                    *(_WORD *)&v118[8] = 2112;
                    *(void *)&v118[10] = v29;
                    _os_log_fault_impl(&dword_23FA42000, v35, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent us an item %@ which has non-root share options but isn't parented to a share (parented to %@)%@", buf, 0x20u);
                  }
LABEL_51:
                  uint64_t v23 = -4;
                  goto LABEL_66;
...
LABEL_68:
            ...
            if (os_log_type_enabled(v68, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_WORD *)&v118[8] = 2112;
              *(void *)&v118[10] = v67;
              _os_log_fault_impl(&dword_23FA42000, v68, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent item %@ which is parented to a non-directory %@%@", buf, 0x20u);
            }
...
LABEL_82:
          ...
          if ((v108 & 4) != 0)
          {
            ...
            if (os_log_type_enabled(v41, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)buf = 136315394;
              ...
              __int16 v117 = 2112;
              *(void *)v118 = v40;
              _os_log_fault_impl(&dword_23FA42000, v41, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent item %s which isn't a descendant of 'root'%@", buf, 0x16u);
            }

            long long v42 = [(BRCClientZone *)self->_clientZone asPrivateClientZone];
            __int16 v43 = [*(id *)(v16 + 3288) structureRecordPrefixForItemType:v20 targetZoneShared:0];
          ...
          if (os_log_type_enabled(v53, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&v118[8] = 2112;
            *(void *)&v118[10] = v52;
            _os_log_debug_impl(&dword_23FA42000, v53, OS_LOG_TYPE_DEBUG, "[DEBUG] Found orphan when we haven't completed initial sync item [%@] parent [%@].  Delaying apply for now%@", buf, 0x20u);
          }
...
LABEL_94:
            ...
            v77 = [(BRCClientZone *)self->_clientZone db];
...
LABEL_95:
          ...
          id v73 = [(BRCAccountSessionFPFS *)self->_session serverState];
...
LABEL_93:
          _os_log_debug_impl(&dword_23FA42000, v57, OS_LOG_TYPE_DEBUG, v58, buf, 0xCu);
          goto LABEL_94;
        }
        uint64_t v23 = 0;
        id v22 = 0;
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v117 = 2112;
          *(void *)v118 = v26;
          _os_log_fault_impl(&dword_23FA42000, v27, OS_LOG_TYPE_FAULT, "[CRIT] Server sent us an item %@ which has non-root share options but should be a root share%@", buf, 0x16u);
        }
          ...
          || ![(BRCServerZone *)self _recoverFromCorruptShareOptionsWithItemType:v20 itemID:v112 parentID:v18 sharingOptions:v24])
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v117 = 2112;
            *(void *)v118 = v29;
            _os_log_fault_impl(&dword_23FA42000, v35, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Server sent us an item %@ which has non-root share options but should be a root share%@", buf, 0x16u);
          }
          id v39 = 0;
          goto LABEL_51;
        }
...
LABEL_69:
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v118[8] = 2112;
        *(void *)&v118[10] = v59;
        _os_log_debug_impl(&dword_23FA42000, v60, OS_LOG_TYPE_DEBUG, "[DEBUG] Setting rowid [%lld] item_depth [%lld]%@", buf, 0x20u);
      }
  ...
  if ([v86 next])
  {
    ...
    do
    {
      ...
      if (os_log_type_enabled(v91, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v118[8] = 2112;
        *(void *)&v118[10] = v90;
        _os_log_debug_impl(&dword_23FA42000, v91, OS_LOG_TYPE_DEBUG, "[DEBUG] Setting rowid [%lld] rank to [%lld]%@", buf, 0x20u);
      }
  ...
  if (os_log_type_enabled(v93, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&v118[10] = v87;
    __int16 v119 = 2112;
    uint64_t v120 = v92;
    _os_log_debug_impl(&dword_23FA42000, v93, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: Allocated ranks [%lld, %lld]%@", buf, 0x2Au);
  }
  uint64_t v94 = [(BRCAccountSessionFPFS *)self->_session serverState];
  [v94 setNextRank:v87];

  v95 = [(BRCAccountSessionFPFS *)self->_session serverState];
  v96 = [(BRCAccountSessionFPFS *)self->_session serverDB];
  [v95 saveToDB:v96];
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] %@ has no more directory faults so it is now full sync%@");
}
...
LABEL_4:
      ...
      while (1)
      {
        ...
        uint64_t v12 = (void *)[objc_alloc(MEMORY[0x263F325E0]) initWithZoneName:v10 ownerName:0];
        uint64_t v13 = [(BRCAccountSessionFPFS *)self->_session getOrCreateAppLibraryAndPrivateZonesIfNecessary:v12];
...
LABEL_15:
      ...
      if (v18)
      {
        ...
        uint64_t v21 = *MEMORY[0x263F324E8];
        do
        {
          for (uint64_t i = 0; i != v19; ++i)
          {
            ...
            if ([v23 isEqualToString:v21])
            {
              ...
              if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = 138412290;
                long long v36 = v24;
                _os_log_fault_impl(&dword_23FA42000, v25, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Can't CZM the clouddocs zone%@", buf, 0xCu);
              }
            }
            else
            {
              uint64_t v24 = [(BRCAccountSessionFPFS *)self->_session privateServerZoneByID:v23];
              if (v24) {
                [v14 addObject:v24];
              }
            }
      ...
      [(BRCAccountSessionFPFS *)self->_session scheduleZoneMovesToCloudDocs:v14];
    }
    id v4 = v26;
  }
}
...
- (unint64_t)didSyncDownRequestID:(unint64_t)a3 serverChangeToken:(id)a4 editedRecords:(id)a5 deletedRecordIDs:(id)a6 deletedShareRecordIDs:(id)a7 allocRankZones:(id *)a8 caughtUp:(BOOL)a9 pendingChanges:(id)a10
{
  ...
  state.opaque[0] = 0;
  state.opaque[1] = 0;
  id v48 = _os_activity_create(&dword_23FA42000, "server-zone/did-sync-down", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2048;
    ...
    LOWORD(v73) = 2112;
    *(void *)((char *)&v73 + 2) = v20;
    _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx saving sync-down batch (edits:%ld deletions:%ld)%@", buf, 0x2Au);
  }
  ...
  *((void *)&v73 + 1) = v22;
  ...
  v49[1] = 3221225472;
  v49[2] = __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_202;
  v49[3] = &unk_265081E10;
  v49[4] = buf;
  [(BRCPQLConnection *)db performWithFlags:9 action:v50 whenFlushed:v49];
  if (v67[3])
  {
    long long v30 = (void *)MEMORY[0x263F32588];
    long long v31 = [(BRCServerZone *)self mangledID];
    uint64_t v32 = *MEMORY[0x263F32388];
    long long v33 = [(BRCServerChangeState *)self->_changeState lastSyncDownDate];
    long long v34 = v33;
    if (!v33)
    {
      long long v34 = [MEMORY[0x263EFF910] distantPast];
    }
  ...
  if ([*(id *)(a1 + 32) count] && objc_msgSend(*(id *)(a1 + 40), "count"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      __int16 v145 = 2112;
      v146 = v4;
      _os_log_impl(&dword_23FA42000, v5, OS_LOG_TYPE_DEFAULT, "[NOTICE] received %lu edited items and %lu deleted items from the cloud for %@\n%@", buf, 0x2Au);
    }
  }
  else
  {
    ...
    _os_log_impl(&dword_23FA42000, v5, OS_LOG_TYPE_DEFAULT, v11, buf, 0x20u);
  }
LABEL_11:
  ...
  if ([*(id *)(a1 + 56) count])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218242;
      ...
      _os_log_impl(&dword_23FA42000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] Saving %lu failed directory list operations first%@", buf, 0x16u);
    }
  ...
  v118 = v3;
  uint64_t v121 = [MEMORY[0x263EFF9C0] setWithArray:*(void *)(a1 + 32)];
  uint64_t v120 = [MEMORY[0x263EFF9C0] setWithArray:*(void *)(a1 + 64)];
  id v29 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9C0]), "initWithObjects:", *(void *)(a1 + 48), 0);
  ...
  if (v32)
  {
    ...
    uint64_t v35 = *MEMORY[0x263EFD510];
    do
    {
          ...
          if (([v40 isEqualToString:@"content"] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v43, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              ...
              _os_log_fault_impl(&dword_23FA42000, v43, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [record.recordType isEqualToString:kBRRecordTypeContent] || [record.recordType isEqualToString:kBRRecordTypeStructure]%@", buf, 0xCu);
            }
          }
        }
      }
...
LABEL_60:
  ...
  if (os_log_type_enabled(v49, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    _os_log_impl(&dword_23FA42000, v49, OS_LOG_TYPE_DEFAULT, "[WARNING] Promoting %@ to full sync because we have completed full sync before and now we're caught up again%@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v58, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v143 = 2112;
    uint64_t v144 = v57;
    _os_log_debug_impl(&dword_23FA42000, v58, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items to be normal directories in %@%@", buf, 0x20u);
  }
  ...
  if (v69)
  {
    ...
    if (os_log_type_enabled(v74, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v145 = 2112;
      v146 = v73;
      _os_log_debug_impl(&dword_23FA42000, v74, OS_LOG_TYPE_DEBUG, "[DEBUG] updating %@\nwith requestID:%llu token:%@%@", buf, 0x2Au);
    }
    id v75 = brc_bread_crumbs();
    id v76 = brc_default_log();
...
LABEL_101:
    ...
    uint64_t v89 = [MEMORY[0x263F087C8] defaultCenter];
    uint64_t v90 = *MEMORY[0x263F323A0];
    uint64_t v134 = *MEMORY[0x263F32488];
    v91 = [*(id *)(v119 + 48) changeState];
    uint64_t v92 = [v91 lastSyncDownDate];
    v135 = v92;
    v93 = [NSDictionary dictionaryWithObjects:&v135 forKeys:&v134 count:1];
    [v89 postNotificationName:v90 object:0 userInfo:v93];

    uint64_t v94 = [*(id *)(v119 + 80) serverState];
    v95 = [*(id *)(v119 + 48) db];
    [v94 saveToDB:v95];
...
LABEL_90:
  ...
  if (os_log_type_enabled(v101, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    ...
    _os_log_impl(&dword_23FA42000, v101, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed enumerating the changes stream but don't broken structure%@", buf, 0xCu);
  }
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_202(uint64_t a1)
{
...
- (unint64_t)didListDirectoryChangesWithResults:(id)a3 pendingFetchChanges:(id)a4
{
  ...
  uint64_t v8 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9C0]), "initWithCapacity:", objc_msgSend(v6, "count"));
  long long v39 = 0u;
  long long v40 = 0u;
  long long v41 = 0u;
  long long v42 = 0u;
  ...
  id v15 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9C0]), "initWithObjects:", self, 0);
...
LABEL_16:
  ...
  id v29 = [(BRCAccountSessionFPFS *)self->_session serverState];
  uint64_t v30 = [v29 nextRank];

  if (v21 && ([(BRCServerZone *)self checkIfFinishedFullSync], v30))
  {
    if ([(BRCAccountSessionFPFS *)self->_session saveServerZoneToDB:self]) {
      unint64_t v31 = v30;
    }
    else {
      unint64_t v31 = 0;
  ...
  if ([*(id *)(*(void *)(a1 + 32) + 48) activated])
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      __int16 v20 = 2112;
      int v21 = v2;
      _os_log_debug_impl(&dword_23FA42000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Starting to GC %ld server tombstones in %@%@", buf, 0x2Au);
    }

    id v4 = *(void **)(*(void *)(a1 + 32) + 24);
    v10[0] = MEMORY[0x263EF8330];
    v10[1] = 3221225472;
    v10[2] = __39__BRCServerZone_collectTombstoneRanks___block_invoke_215;
    v10[3] = &unk_265080760;
    id v5 = *(id *)(a1 + 40);
...
uint64_t __39__BRCServerZone_collectTombstoneRanks___block_invoke_215(uint64_t a1)
{
...
uint64_t __48__BRCServerZone_resetServerTruthAndDestroyZone___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v22 = 2112;
    uint64_t v23 = v10;
    _os_log_error_impl(&dword_23FA42000, v11, (os_log_type_t)0x90u, "[ERROR] failed purging zone %@ - %@%@", buf, 0x20u);
  }
  uint64_t v12 = 0;
LABEL_15:
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: !appLibrary.wasMovedToCloudDocs%@", v2, v3, v4, v5, v6);
}
  ...
  if (v7 != state)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v26 = 2112;
      id v27 = v9;
      _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ server state changed, %@ -> %@%@", buf, 0x2Au);
    }
...
- (void)clearStateBits:(unsigned int)a3
{
  ...
  if ((state & a3) != 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v17 = 2112;
      long long v18 = v6;
      _os_log_debug_impl(&dword_23FA42000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ server state changed, %@ -> %@%@", (uint8_t *)&v11, 0x2Au);
    }
  }
}
...
uint64_t __43__BRCServerZone_dumpStatusToContext_error___block_invoke(uint64_t a1, void *a2, int a3, void *a4, uint64_t a5)
{
  ...
  id v36 = v8;
  id v42 = v36;
  long long v38 = (void (**)(void))MEMORY[0x2455D9A50](v40);
  id v9 = [*(id *)(a1 + 32) db];
  ...
  do
  {
    ...
    long long v12 = (void *)MEMORY[0x2455D97F0]();
    ...
    {
      uint64_t v14 = [v10 integerAtIndex:44];
...
- (BOOL)dumpTablesToContext:(id)a3 includeAllItems:(BOOL)a4 error:(id *)a5
{
  ...
  int v81 = __Block_byref_object_dispose__19;
  id v82 = 0;
  id v8 = [(BRCServerZone *)self descriptionWithContext:v6];
  ...
  if (v8)
  {
    ...
    long long v12 = [v11 asPrivateClientZone];
    int v13 = [v12 appLibraries];
    ...
    long long v57 = 0u;
    long long v58 = 0u;
    __int16 v15 = [(BRCServerZone *)self clientZone];
    uint64_t v16 = [v15 asPrivateClientZone];
    id obj = [v16 appLibraries];

    uint64_t v17 = [obj countByEnumeratingWithState:&v57 objects:v83 count:16];
    if (v17)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v17; ++i)
        {
          ...
          {
            if ((v19 & 1) == 0) {
              [v9 writeLineWithFormat:&stru_26F3822F0];
            }
            long long v22 = [v21 logName];
            long long v23 = [v21 dbRowID];
          ...
          *((_DWORD *)v70 + 6) = 0;
          uint64_t v24 = v74[3];
          int v25 = [v21 rootItemID];
          (*(void (**)(uint64_t, void *, void, id *))(v24 + 16))(v24, v25, 0, a5);
  ...
  [v9 writeLineWithFormat:&stru_26F3822F0];
  __int16 v26 = [v9 db];
  id obj = (id)[v26 numberWithSQL:@"SELECT COUNT(*) FROM server_items WHERE zone_rowid = %@", self->_dbRowID];

  uint64_t v27 = [obj unsignedIntegerValue];
  if (v27 == [v50 count])
  {
    uint64_t v28 = 0;
  }
  else
  {
    ...
    v55[3] = &unk_26507F148;
    int v56 = (BRCPendingChangesStream *)v50;
    unint64_t v31 = (void *)MEMORY[0x2455D9A50](v55);
    uint64_t v28 = (void *)[v29 fetch:@"SELECT zone_rowid, item_rank, item_origname, pcs_state, item_id, item_creator_id, item_sharing_options, item_side_car_ckinfo, item_stat_ckinfo, item_state, item_type, item_mode, item_birthtime, item_lastusedtime, item_favoriterank,item_parent_id, item_filename, item_hidden_ext, item_finder_tags, item_xattr_signature, item_trash_put_back_path, item_trash_put_back_parent_id, item_alias_target, item_creator, version_name, version_ckinfo, version_mtime, version_size, version_thumb_size, version_thumb_signature, version_content_signature, version_xattr_signature, version_edited_since_shared, version_device, version_conflict_loser_etags, version_quarantine_info, child_basehash_salt, salting_state, basehash_salt_validation_key, quota_used, recursive_child_count, shared_children_count, shared_alias_count, child_count, validation_key(content_boundary_key) FROM server_items WHERE zone_rowid = %@ AND call_block(%@, rowid)", dbRowID, v31];

    *((_DWORD *)v70 + 6) = 0;
    while ([v28 next])
    {
      uint64_t v32 = (void *)MEMORY[0x2455D97F0]();
      session = self->_session;
      uint64_t v34 = (id *)(v78 + 5);
      id v54 = (id)v78[5];
      id v35 = [(BRCAccountSessionFPFS *)session newServerItemFromPQLResultSet:v28 error:&v54];
      objc_storeStrong(v34, v54);
      id v36 = [v28 dataAtIndex:44];
      id v37 = v36;
      if (v36)
      {
        long long v38 = NSString;
        char v39 = objc_msgSend(v36, "brc_hexadecimalString");
        uint64_t v40 = +[BRCDumpContext highlightedString:v39 type:2 context:v9];
        id v41 = [v38 stringWithFormat:@" ctvk{%@}", v40];
      }
      else
      {
        id v41 = &stru_26F3822F0;
      }
      ++*((_DWORD *)v70 + 6);
      int v42 = objc_msgSend(v9, "shouldKeepDumpingWithItemCount:includeAllItems:");
      char v43 = v42;
      if (v42)
      {
        int v44 = [v35 descriptionWithContext:v9];
  ...
  char v46 = [[BRCPendingChangesStream alloc] initWithServerZone:self];
  BOOL v47 = [(BRCPendingChangesStream *)v46 dumpTablesToContext:v9 includeAllItems:v51 error:a5];
  BOOL v45 = v47;
  if (a5) {
    BOOL v48 = v47;
  }
...
uint64_t __59__BRCServerZone_dumpTablesToContext_includeAllItems_error___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  if ([v9 next])
  {
    ...
    while (1)
    {
      ...
      uint64_t v11 = [v9 integerAtIndex:44];
      long long v12 = [v9 dataAtIndex:45];
      int v13 = *(void **)(a1 + 32);
      ++*(_DWORD *)(*(void *)(*(void *)(a1 + 56) + 8) + 24);
      if (!objc_msgSend(v13, "shouldKeepDumpingWithItemCount:includeAllItems:")) {
        break;
      }
      if ([*(id *)(a1 + 48) containsIndex:v11])
      {
        unint64_t v14 = *(void **)(a1 + 32);
        __int16 v15 = [v9 objectOfClass:objc_opt_class() atIndex:4];
        uint64_t v16 = +[BRCDumpContext stringFromItemID:v15 context:*(void *)(a1 + 32)];
        [v14 writeLineWithFormat:@"%*sERROR: item ID %@ seen twice", a3, "", v16];
      }
      else
      {
        [*(id *)(a1 + 48) addIndex:v11];
        uint64_t v17 = *(void **)(*(void *)(a1 + 40) + 16);
        uint64_t v18 = *(void *)(*(void *)(a1 + 64) + 8);
        id obj = *(id *)(v18 + 40);
        __int16 v15 = (void *)[v17 newServerItemFromPQLResultSet:v9 error:&obj];
        ...
        {
          char v19 = NSString;
          long long v20 = objc_msgSend(v12, "brc_hexadecimalString");
          long long v21 = +[BRCDumpContext highlightedString:v20 type:2 context:*(void *)(a1 + 32)];
          uint64_t v16 = [v19 stringWithFormat:@" ctvk{%@}", v21];
        }
        else
        {
          uint64_t v16 = &stru_26F3822F0;
        }
        long long v22 = *(void **)(a1 + 32);
        long long v23 = [v15 descriptionWithContext:v22];
        [v22 writeLineWithFormat:@"%*s%@%@", a3, "", v23, v16];

        uint64_t v24 = [*(id *)(*(void *)(a1 + 40) + 16) applyScheduler];
        int v25 = [v24 descriptionForServerItem:v15 context:*(void *)(a1 + 32)];

        if (v25) {
          [*(id *)(a1 + 32) writeLineWithFormat:@"%*s> apply{%@}", a3, "", v25];
        }
        int v26 = [v15 isDirectory];
        if ((int)a3 <= 99)
        {
          if (v26)
          {
            uint64_t v27 = *(void *)(*(void *)(*(void *)(a1 + 72) + 8) + 24);
            uint64_t v28 = [v15 itemID];
            LOBYTE(v27) = (*(uint64_t (**)(uint64_t, void *, void, uint64_t))(v27 + 16))(v27, v28, (a3 + 1), v32);
...
- (id)matchingJobsWhereSQLClause
{
  uint64_t v2 = (void *)MEMORY[0x263F8C710];
  id v3 = [(BRCServerZone *)self dbRowID];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: can't czm move clouddocs zone%@", v2, v3, v4, v5, v6);
}

- (void)asPrivateZone
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: This is not a private zone%@", v2, v3, v4, v5, v6);
}

- (void)asSharedZone
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: This is not a shared zone%@", v2, v3, v4, v5, v6);
}

- (void)_verifyChildbasehashSaltKeysForItemID:saltInfo:record:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Got unexpected basehash validation key for %@%@");
}

- (void)_saveItemID:stat:serverMetrics:record:origName:base:no:ext:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _db.changes == 1%@", v2, v3, v4, v5, v6);
}

- (void)_saveItemID:stat:serverMetrics:record:origName:base:no:ext:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] PCS chained directory doesn't have chain PCS! %@%@");
}

- (void)_saveItemID:stat:serverMetrics:record:origName:base:no:ext:.cold.4()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: BRCItemTypeIsDirectory(st.type)%@", v2, v3, v4, v5, v6);
}

- (void)_saveItemID:stat:serverMetrics:record:error:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: !(st.logicalName.br_isSideFaultName || [st.logicalName br_isExcludedWithMaximumDepth:1])%@", v2, v3, v4, v5, v6);
}
...
- (void)_saveEditedDirOrDocStructureRecord:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_12_0(&dword_23FA42000, v2, v3, "[DEBUG] saving consistent structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
}

- (void)_saveEditedDocumentContentRecord:error:.cold.1()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Adding %@ to the list of force package extensions (according to CKRecord)%@");
}

- (void)_saveEditedDocumentContentRecord:error:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Marking %@ as edited since shared because the modifier name is different%@");
}
...
- (void)_saveEditedDocumentContentRecord:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_12_0(&dword_23FA42000, v2, v3, "[DEBUG] saving consistent document record (%@) to db %@%@", v4, v5, v6, v7, v8);
}
...
- (void)_saveEditedSymlinkRecord:error:.cold.1()
{
  ...
  os_log_t v1 = [v0 parent];
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_12_0(&dword_23FA42000, v2, v3, "[DEBUG] saving consistent symlink structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
}
...
- (void)_saveEditedFinderBookmarkRecord:error:.cold.1()
{
  ...
  os_log_t v1 = [v0 parent];
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_12_0(&dword_23FA42000, v2, v3, "[DEBUG] saving consistent finder bookmark structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
}
...
- (void)_saveEditedAliasRecord:(void *)a1 zonesNeedingAllocRanks:(uint64_t)a2 error:(NSObject *)a3 .cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v14 = 2112;
  uint64_t v15 = a2;
  _os_log_error_impl(&dword_23FA42000, a3, (os_log_type_t)0x90u, "[ERROR] can't save %@: missing ownerKey for ownerName \"%@\"%@", (uint8_t *)&v10, 0x20u);
}
...
- (void)_saveEditedAliasRecord:zonesNeedingAllocRanks:error:.cold.2()
{
  ...
  os_log_t v1 = [v0 parent];
  OUTLINED_FUNCTION_2_1();
  OUTLINED_FUNCTION_12_0(&dword_23FA42000, v2, v3, "[DEBUG] saving consistent alias structure record (%@) to db %@%@", v4, v5, v6, v7, v8);
}

- (void)_saveEditedShareRecord:error:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] share without root record:\n    i:%@\n\n   this typically indicates either of two problems:\n    - either we failed processing the last sync down and we\n       failed inserting the shared record,\n    - or the server forgot to send it to us.%@");
}

- (void)_saveEditedShareRecord:error:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: share.currentUserParticipant.role != CKShareParticipantRoleOwner%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] saving consistent share record to db %@%@");
}

- (void)_saveEditedRecord:zonesNeedingAllocRanks:error:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Can't save zone root record %@%@");
}

- (void)_saveEditedRecord:zonesNeedingAllocRanks:error:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: structure record which isn't a directory or document%@", v2, v3, v4, v5, v6);
}

- (void)_markShareIDDead:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] marked shareID dead %@%@");
}

- (void)_markItemDeadForRecordID:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Couldn't decode itemID from recordID %@%@");
}

- (void)_markItemDeadForRecordID:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Not inserting tombstone entry for %@ because we don't have a server item already.  Let's go through rejected code path for perf.%@");
}

- (void)_markItemDeadForRecordID:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] saving consistent record delete to db %@%@");
}

- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Failed to recover sharing options on %@%@");
}

- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] Fixing up sharing options to have shareID for something that looks like a shared zone root for %@%@");
}

- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Can't recover share options on shared zone child item %@%@");
}

- (void)_recoverFromCorruptShareOptionsWithItemType:itemID:parentID:sharingOptions:.cold.4()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] Stripping share options for something that doesn't seem to need them %@%@");
}

- (void)allocateRanksWhenCaughtUp:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Forcing caught up state because we completed full sync so we must have synced down an unrelated zone%@", v2, v3, v4, v5, v6);
}
...
- (void)handleMovedZoneNames:(NSObject *)a3 .cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  _os_log_fault_impl(&dword_23FA42000, a3, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Can't create app library and zones for zone named: %s%@", v4, 0x16u);
}
...
- (void)didSyncDownRequestID:(uint8_t *)buf serverChangeToken:(os_log_t)log editedRecords:deletedRecordIDs:deletedShareRecordIDs:allocRankZones:caughtUp:pendingChanges:.cold.1(void *a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_fault_impl(&dword_23FA42000, log, OS_LOG_TYPE_FAULT, "[CRIT] %@%@", buf, 0x16u);
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Delta sync successfully alloced rank so allowing finished changes stream to be destroyed%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Allocating ranks for %@%@");
}
...
void __148__BRCServerZone_didSyncDownRequestID_serverChangeToken_editedRecords_deletedRecordIDs_deletedShareRecordIDs_allocRankZones_caughtUp_pendingChanges___block_invoke_cold_3(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  OUTLINED_FUNCTION_3_0();
  _os_log_error_impl(&dword_23FA42000, a3, (os_log_type_t)0x90u, "[ERROR] something went wrong while saving to the db: %@%@", v5, 0x16u);
}
...
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] %@ is no longer full sync because of a large delta sync operation%@");
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: requestID >= self->_changeState.clientRequestID%@", v2, v3, v4, v5, v6);
}

- (void)didListDirectoryChangesWithResults:pendingFetchChanges:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Listed directory changes in zones %@%@");
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _failedListDirectoryOperations[itemID] == nil%@", v2, v3, v4, v5, v6);
}

- (void)_collectTombstoneForRank:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Removing applied tombstone: %@%@");
}

void __48__BRCServerZone_resetServerTruthAndDestroyZone___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Finished resetting server truth%@", v2, v3, v4, v5, v6);
}

void __48__BRCServerZone_resetServerTruthAndDestroyZone___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Finishing destroying server truth%@", v2, v3, v4, v5, v6);
}

- (void)deleteAllContentsOnServerWithCompletionBlock:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: attempted delete all content on an unsupported zone type: %@%@");
}
