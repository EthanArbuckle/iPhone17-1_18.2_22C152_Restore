...
void __48__BRCAutoCancelOperation__initializeCancelTimer__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    v4 = dispatch_source_create(MEMORY[0x263EF8400], 0, 0, *(dispatch_queue_t *)(a1 + 32));
    ...
    {
      v12 = ((void (*)(void *))*MEMORY[0x263F32768])(v10);
    }
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "BRCAutoCancelOperation/? (subclass activity missing)", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] No one is waiting on %@ anymore so cancelling%@");
}

void __48__BRCAutoCancelOperation__initializeCancelTimer__block_invoke_2_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] We have observers again for %@ so not cancelling yet%@");
}
