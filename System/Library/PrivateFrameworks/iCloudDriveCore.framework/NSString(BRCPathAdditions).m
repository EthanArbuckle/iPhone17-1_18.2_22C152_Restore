...
LABEL_11:
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v12 = v6;
      _os_log_impl(&dword_23FA42000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] No path for Caches directory%@", buf, 0xCu);
    }
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = v27;
          ...
          __int16 v34 = 2112;
          v35 = v17;
          _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Located ubiquity salt path by the duck test - %@%@", buf, 0x16u);
        }
...
LABEL_21:
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v34 = 2112;
        v35 = v24;
        _os_log_impl(&dword_23FA42000, v25, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't locate ubiquity salt path in %@%@", buf, 0x16u);
      }
...
+ (id)br_currentMobileDocumentsDirWithRefreshCache:()BRCPathAdditions
{
  ...
  if (!v7)
  {
    if (MEMORY[0x2455D88C0]())
    {
      long long v8 = objc_msgSend(MEMORY[0x263F325C0], "br_getProviderDomainIDForCurrentPersona");
      if (v8)
      {
        id v30 = 0;
        v9 = [MEMORY[0x263F054C8] providerDomainWithID:v8 cachePolicy:0 error:&v30];
        id v10 = v30;
      }
      else
      {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        ...
        LOWORD(v34) = 2112;
        *(void *)((char *)&v34 + 2) = v11;
        _os_log_debug_impl(&dword_23FA42000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] Getting root item for provider domain ID: %@. Found domain: %@. Current persona: %@%@", buf, 0x2Au);
      }
      ...
      if (v9)
      {
        ...
        *((void *)&v34 + 1) = 0;
        ...
        if (v14)
        {
          ...
          char v21 = [MEMORY[0x263F054C0] defaultManager];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&uint8_t buf[4] = v23;
        _os_log_impl(&dword_23FA42000, v24, OS_LOG_TYPE_DEFAULT, "[WARNING] No path for Mobile Documents directory%@", buf, 0xCu);
      }
    }
  }
  id v25 = v7;
...
+ (id)_brc_fileProviderStoragePath
{
  ...
  id v2 = [v1 path];
  id v3 = [v2 stringByAppendingPathComponent:@"File Provider Storage"];
...
+ (id)brc_groupDownloadStagePath
{
  v0 = objc_msgSend(NSString, "_brc_fileProviderStoragePath");
...
+ (void)br_currentMobileDocumentsDirWithRefreshCache:()BRCPathAdditions .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_debug_impl(&dword_23FA42000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Getting root URL from storage URLs: %@%@", (uint8_t *)&v4, 0x16u);
}
