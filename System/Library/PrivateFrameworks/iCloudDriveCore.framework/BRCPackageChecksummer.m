...
LABEL_40:
  ...
  if (-[BRCChecksummingOutputStream write:maxLength:](self->_stream, "write:maxLength:", (char *)&addItem_error__tags + (int)[v6 type], 1) != -1&& -[BRCChecksummingOutputStream write:maxLength:](self->_stream, "write:maxLength:", &addItem_error__nul, 1) != -1)
  {
    ...
    if (!v8)
    {
      ...
      objc_msgSend(MEMORY[0x263F087E8], "br_errorWithPOSIXCode:description:", 22, @"NULL path for item: %@", v6);
    ...
    if ([(BRCChecksummingOutputStream *)self->_stream write:v8 maxLength:strlen(v8) + 1] != -1)
    {
        ...
        && [(BRCChecksummingOutputStream *)self->_stream write:&addItem_error__nul maxLength:1] != -1)
      {
        if ([v6 type] == 3)
        {
          ...
          objc_msgSend(MEMORY[0x263F087E8], "br_errorWithPOSIXCode:description:", 22, @"NULL path for item symlink: %@", v6);
          id v16 = (id)objc_claimAutoreleasedReturnValue();
          if (!v16)
          {
LABEL_17:
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _stream%@", v2, v3, v4, v5, v6);
}

- (void)addItem:error:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: NULL path for item: %@%@");
}

- (void)addItem:error:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: NULL path for item symlink content: %@%@");
}
