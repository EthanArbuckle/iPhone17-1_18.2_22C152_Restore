...
- (id)brc_truncatedSHA256
{
  ...
  v6 = [MEMORY[0x263EFF8F8] dataWithBytes:v8 length:v5];
  return v6;
}

+ (id)brc_generateSaltingKey
{
  v0 = [MEMORY[0x263EFF990] dataWithLength:32];
  v1 = (const __SecRandom *)*MEMORY[0x263F17510];
  id v2 = v0;
...
+ (id)brc_generateBogusKey
{
  if (brc_generateBogusKey_onceToken != -1) {
    dispatch_once(&brc_generateBogusKey_onceToken, &__block_literal_global_53);
  }
...
+ (void)brc_generateSaltingKey
{
  ...
  __int16 v4 = 2112;
  uint64_t v5 = a1;
  _os_log_error_impl(&dword_23FA42000, log, (os_log_type_t)0x90u, "[ERROR] Can't generate salting key %{errno}d%@", (uint8_t *)v3, 0x12u);
}
