...
LABEL_36:
    ...
    if (v40) {
      qsort_b(v39, v40, 8uLL, &__block_literal_global_78_1);
    }
    v41 = v38;
    ...
    if (v43) {
      qsort_b(v42, v43, 8uLL, &__block_literal_global_78_1);
    }
    v20 = v41;
LABEL_41:
    v16 = v20;
  ...
  if (v12 < 0)
  {
    v17 = objc_msgSend(MEMORY[0x263F087E8], "br_errorFromErrno");
    if (v17)
    {
  ...
  if (a4 < 0 || v12 <= a4)
  {
    uint64_t v21 = [objc_alloc(MEMORY[0x263EFF990]) initWithLength:v12];
    ...
    {
      v27 = objc_msgSend(MEMORY[0x263F087E8], "br_errorFromErrno");
      if (v27)
      {
    ...
    *(void *)&buf[16] = __countSyncableXattrs_block_invoke;
    ...
    v11->_xattrCount = v26;
    uint64_t v30 = [objc_alloc(MEMORY[0x263EFF990]) initWithLength:8 * v11->_xattrCount];
...
LABEL_26:
  ...
  objc_msgSend(MEMORY[0x263F087E8], "br_errorWithPOSIXCode:", 12);
  v16 = 0;
  ...
  if ((sizeLimit & 0x8000000000000000) == 0 && self->_cacheSize >= sizeLimit)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      char v35 = v22;
      _os_log_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Do not attempt to get xattr size cache is full%@", buf, 0xCu);
    }
...
- (void)initWithFD:(os_log_t)log sizeLimit:syncable:error:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a1;
  _os_log_error_impl(&dword_23FA42000, log, (os_log_type_t)0x90u, "[ERROR] Xattr name list exceed size limit %ld%@", (uint8_t *)&v3, 0x16u);
}

- (void)getXattrValue:error:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: [cached isKindOfClass:[NSData class]]%@", v2, v3, v4, v5, v6);
}
