...
+ (id)newFromSqliteValue:(sqlite3_value *)a3
{
  ...
  v5 = (void *)[MEMORY[0x263EFF8F8] newFromSqliteValue:a3];
...
+ (id)newFromSqliteStatement:(sqlite3_stmt *)a3 atIndex:(int)a4
{
  ...
  v7 = (void *)[MEMORY[0x263EFF8F8] newFromSqliteStatement:a3 atIndex:v4];
...
+ (id)_newTelemetryEventInZoneWithMangledID:(id)a3 enhancedDrivePrivacyEnabled:(id)a4 error:(id)a5 errorDescription:(id)a6 itemIDString:(id)a7
{
  ...
  if (v11 || v13 || v14 || (v17 = 0, v18 = 0, v15))
  {
    ...
    if (v13)
    {
      ...
      v25 = [v13 userInfo];
      v26 = [v25 objectForKeyedSubscript:*MEMORY[0x263F08608]];
...
+ (id)newTestMetricEventWithMagnitude:(unsigned int)a3
{
  ...
  id v6 = (void *)[v5 initWithZoneName:@"com.apple.testZone" ownerName:*MEMORY[0x263EFD488]];
...
{
  BOOL v4 = a4;
  BOOL v6 = (objc_class *)MEMORY[0x263F325E0];
  id v7 = a3;
  id v8 = [v6 alloc];
  BOOL v9 = [v7 zoneID];
...
+ (id)itemStatsInvestigationWithFoundInfo:(id)a3
{
  ...
  uint64_t v31 = [v3 objectForKey:*MEMORY[0x263F05248]];
  v32 = v31;
  if (v31)
  {
  ...
  v67 = [v3 objectForKey:*MEMORY[0x263F051E0]];
  if (v67)
  {
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
  ...
  v124 = [v3 objectForKey:*MEMORY[0x263F05190]];
  if (v124)
  {
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
...
LABEL_19:
  ...
  {
    id v17 = off_265085770[magnitude];
  }
