...
- (BRCAccountWaitOperation)initWithCKContainer:(id)a3
{
  ...
  if (v6)
  {
    ...
    dispatch_source_t v13 = dispatch_source_create(MEMORY[0x263EF83B8], 0, 0, v12);
    source = v7->_source;
    ...
    v19 = v17;
    v20 = v19;
    v21 = (void (**)(void *))MEMORY[0x263F32768];
    v22 = v19;
    if (*MEMORY[0x263F32768])
    {
      v22 = ((void (*)(void *))*MEMORY[0x263F32768])(v19);
    }
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "account-waiter", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)_accountChangeHandler
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx handling account change%@");
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v27 = v6;
    _os_log_debug_impl(&dword_23FA42000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got status %ld%@", block, 0x20u);
  }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v27 = v13;
    _os_log_debug_impl(&dword_23FA42000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx dispatching to %s%@", block, 0x20u);
  }
...
- (void)start
{
  ...
  [v3 addObserver:self selector:sel__accountDidChange name:*MEMORY[0x263EFD478] object:0];
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  [v8 removeObserver:self name:*MEMORY[0x263EFD478] object:0];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Simulating an account did change to refresh the CK account status%@", v2, v3, v4, v5, v6);
}

void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_31_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Account is now available%@", v2, v3, v4, v5, v6);
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_31_cold_2()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unknown account status%@", v1, 0xCu);
}
...
void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_31_cold_3()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_1_1();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] Error when asking CloudKit about the account status: %@%@", v1, 0x16u);
}

void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_31_cold_4()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] No account loaded yet, let's wait for the account notification from CloudKit%@", v2, v3, v4, v5, v6);
}

void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_31_cold_5()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Account is restricted let's wait for a notification from CloudKit%@", v2, v3, v4, v5, v6);
}

void __48__BRCAccountWaitOperation__accountChangeHandler__block_invoke_31_cold_6()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Account is temporarily unavailable, let's wait for a notification from CloudKit%@", v2, v3, v4, v5, v6);
}
