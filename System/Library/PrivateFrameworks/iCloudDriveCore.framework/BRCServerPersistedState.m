  ...
  if (v5)
  {
    if (([v4 execute:@"UPDATE server_state SET state = %@", v7] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT)) {
        __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_131_cold_1(v9, (uint64_t)v10, v11);
      }
      ...
      while (1)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = v27;
          ...
          __int16 v36 = 2112;
          v37 = v17;
          _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Ignoring share alias migration key for %@ because the user default is no%@", buf, 0x16u);
        }
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138413058;
          ...
          __int16 v40 = 2112;
          v41 = v23;
          _os_log_debug_impl(&dword_23FA42000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] pending migration for %@: %@ from cursor:%@%@", buf, 0x2Au);
        }
        id v21 = v13;
        goto LABEL_24;
      }
...
- (void)initiateMigrationQueryForMangledIDs:(uint64_t)a1 key:.cold.1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 8);
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] pending migrations: %@%@", (void)v3, DWORD2(v3));
}
...
- (void)migrationQueryKeyForMangledID:(uint64_t)a1 continuationCursor:.cold.1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] no pending migration for %@%@", (void)v3, DWORD2(v3));
}
...
- (void)migrationQueryForMangledID:(uint64_t)a1 key:didUpdateWithCursor:.cold.1(uint64_t a1)
{
  ...
  uint64_t v3 = a1;
  OUTLINED_FUNCTION_1_0();
  _os_log_fault_impl(&dword_23FA42000, v1, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unknown migration completed for container %@%@", (uint8_t *)&v2, 0x16u);
}
