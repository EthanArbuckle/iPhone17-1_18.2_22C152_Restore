...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sharing/lookup-participants", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}

- (void)main
{
  v3 = (void *)[objc_alloc(MEMORY[0x263EFD6F8]) initWithUserIdentityLookupInfos:self->_userIdentities];
...
void __45__BRCSharingLookupParticipantsOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (!v3)
  {
    ...
    if (v9 == [*(id *)(*(void *)(a1 + 32) + 520) count])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] fetched share participants: %@%@", (uint8_t *)&v18, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
      {
        ...
        __int16 v22 = 2112;
        v23 = v12;
        _os_log_fault_impl(&dword_23FA42000, v13, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Unexpected number of share participants: expected %lu got %lu%@", (uint8_t *)&v18, 0x20u);
      }

      v4 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32360], 15, @"Unexpected number of share participants");
      id v8 = *(void **)(a1 + 32);
      if (v4)
      {
        uint64_t v7 = 0;
  ...
  if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
  {
    ...
    __int16 v22 = 2112;
    v23 = v5;
    _os_log_error_impl(&dword_23FA42000, v6, (os_log_type_t)0x90u, "[ERROR] failed share participant lookup for %@ - %@%@", (uint8_t *)&v18, 0x20u);
  }
