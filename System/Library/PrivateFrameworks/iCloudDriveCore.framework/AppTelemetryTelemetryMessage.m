...
- (id)description
{
  ...
  id v4 = [(AppTelemetryTelemetryMessage *)&v8 description];
  v5 = [(AppTelemetryTelemetryMessage *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v11 = [NSNumber numberWithUnsignedLongLong:self->_token];
    [v3 setObject:v11 forKey:@"token"];
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearEvents];
    unint64_t v4 = [(AppTelemetryTelemetryMessage *)self eventsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(AppTelemetryTelemetryMessage *)self eventsAtIndex:i];
        [v8 addEvents:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 24) & 1) != 0 && self->_token == *((void *)v4 + 1))
    {
      BOOL v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has) {
    unint64_t v4 = 2654435761u * self->_token;
  }
  else {
    unint64_t v4 = 0;
  }
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[AppTelemetryTelemetryMessage addEvents:](self, "addEvents:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
