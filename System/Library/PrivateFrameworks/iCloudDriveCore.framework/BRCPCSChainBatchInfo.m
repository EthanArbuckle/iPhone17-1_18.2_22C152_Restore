...
- (void)addFullyChainedRecordInfo:(id)a3
{
  ...
  unint64_t v9 = 0x263EFD000uLL;
  if (v8 <= 8 && ((1 << v8) & 0x106) != 0)
  {
    long long v10 = [v4 itemID];
    long long v11 = [v10 contentsRecordIDInZoneID:v7];

    long long v12 = (void *)[objc_alloc(MEMORY[0x263EFD7C8]) initWithRecordType:@"content" recordID:v11];
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413570;
    ...
    __int16 v71 = 2112;
    v72 = v14;
    _os_log_debug_impl(&dword_23FA42000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] PCS chaining %@ (st:%@, ct:%@) to %@ for op %@%@", buf, 0x3Eu);

    v7 = v60;
    unint64_t v9 = 0x263EFD000;
  }
  v16 = [v4 itemID];
  ...
  if (v21 > 0xA
    ...
    || ([(NSMutableDictionary *)self->_halfChainedRecordMap objectForKeyedSubscript:v20],
        ...
        !v23))
  {
    v23 = (void *)[objc_alloc(*(Class *)(v9 + 1992)) initWithRecordType:@"structure" recordID:v20];
...
LABEL_23:
  ...
  if (([(NSMutableSet *)self->_alreadyHalfChainedRecords containsObject:v33] & 1) == 0)
  {
    ...
    v34 = (void *)[objc_alloc(*(Class *)(v9 + 1992)) initWithRecordType:@"structure" recordID:v33];
          ...
          if (!v28)
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              v53 = v30;
              _os_log_fault_impl(&dword_23FA42000, v31, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: preppedRecord.protectionData%@", buf, 0xCu);
            }
          }
          if (v9 >= [v5 count])
          {
    ...
    for (; v32 < [v5 count]; ++v32)
    {
      ...
      if (!v37)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v53 = v43;
          _os_log_fault_impl(&dword_23FA42000, v38, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: halfChainInfo != nil%@", buf, 0xCu);
        }
      }
      [v37 setRecord:v34];
    }
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: parentCKInfo%@", v2, v3, v4, v5, v6);
}

- (void)addFullyChainedRecordInfo:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: No parent item?!?!%@", v2, v3, v4, v5, v6);
}

- (void)addFullyChainedRecordInfo:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: !_fullyChainRecordInfoMap[parentRecordID]%@", v2, v3, v4, v5, v6);
}

- (void)_chainPreppedRecordToParent:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: unkown record type%@", v2, v3, v4, v5, v6);
}

- (void)chainPreparedRecordBatch:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: preppedRecords.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)chainPreparedRecordBatch:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: j + _halfChainedRecordMap.count == preppedRecords.count%@", v2, v3, v4, v5, v6);
}

- (void)chainPreparedRecordBatch:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Received records from first PCS step: %@%@");
}
