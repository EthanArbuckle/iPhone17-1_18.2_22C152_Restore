...
- (BRCLocateRecordOperation)initWithRecordID:(id)a3 serverZone:(id)a4 isUserWaiting:(BOOL)a5 maxBackoff:(double)a6 sessionContext:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v33 = 2112;
    v34 = v18;
    _os_log_impl(&dword_23FA42000, v19, OS_LOG_TYPE_INFO, "[INFO] Request to locate record: [%@] of item [%@]%@", buf, 0x20u);
  }
  ...
  if (v23)
  {
    v24 = objc_msgSend(MEMORY[0x263EFD780], "br_locateRecord");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sync/locate-record", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)_performAfterLocatingRecord:(id)a3
{
  ...
  v6 = [MEMORY[0x263EFF980] arrayWithObject:self->_recordID];
...
LABEL_6:
  ...
  objc_super v28 = (void *)[objc_alloc(MEMORY[0x263EFD6D8]) initWithRecordIDs:v6];
  [v28 setShouldFetchAssetContent:0];
  v29 = [MEMORY[0x263EFD7C8] desiredKeysWithMask:185];
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v15 = 2112;
      v16 = v9;
      _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] record with id %@ encountered an error while locating - %@%@", (uint8_t *)&v11, 0x20u);
    }
  }
}
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2(uint64_t a1)
{
    ...
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v36 = 2112;
        v37 = v10;
        _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Failed to look up record %@ - %@%@", buf, 0x20u);
      }
  ...
  if (([*(id *)(a1 + 40) saveRecordsWithQueryCursor:0] & 1) == 0)
  {
    ...
    uint64_t v9 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: Can't alloc ranks after fetching records");
  ...
  if (!v4)
  {
    ...
    if (![*(id *)(*(void *)(a1 + 48) + 536) isSharedZone])
    {
      ...
      if (!*v14)
      {
        ...
        uint64_t v9 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32360], 7, @"Could not locate record");
...
LABEL_23:
      ...
      uint64_t v25 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: parent isn't a reference %@", *v14);
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v30 = 2112;
      id v31 = v7;
      _os_log_impl(&dword_23FA42000, v8, OS_LOG_TYPE_INFO, "[INFO] Locating recordID %@ in zone %@ --> Record not found. Error %@%@", buf, 0x2Au);
    }
    id v12 = *(void **)(a1 + 32);
...
void __32__BRCLocateRecordOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      v19 = v4;
      _os_log_impl(&dword_23FA42000, v5, OS_LOG_TYPE_INFO, "[INFO] Locating recordID %@ in zone %@ --> Fetch parent chain failed with error %@%@", (uint8_t *)&v12, 0x2Au);
    }
    uint64_t v9 = *(void **)(a1 + 32);
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  uint64_t v13 = self;
  objc_sync_enter(v13);
  v13->_exists = [v6 isEqual:MEMORY[0x263EFFA88]];
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Located record in shared zone. No need to fetch the parent chain.%@", v1, 0xCu);
}
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2_cold_3(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_fault_impl(&dword_23FA42000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: parent isn't a reference %@%@", (uint8_t *)&v4, 0x16u);
}
...
void __56__BRCLocateRecordOperation__performAfterLocatingRecord___block_invoke_2_cold_4()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Can't alloc ranks after fetching records%@", v1, 0xCu);
}
...
void __32__BRCLocateRecordOperation_main__block_invoke_cold_1()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Record located. No need to fetch the parent chain.%@", v1, 0xCu);
}
...
void __32__BRCLocateRecordOperation_main__block_invoke_21_cold_1()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: fetchParentChainOp%@", v1, 0xCu);
}
