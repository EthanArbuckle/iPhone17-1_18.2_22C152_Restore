...
- (void)setNextNotifRank:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: nextNotifRank >= _nextNotifRank%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)setNextPackageItemRank:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: nextPackageItemRank >= _nextPackageItemRank%@", (uint8_t *)&v2, 0xCu);
}
