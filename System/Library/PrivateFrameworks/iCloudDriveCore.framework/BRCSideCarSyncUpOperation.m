...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sync/side-car-sync-up", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}

- (void)_markItemsFailedSync
{
  v3 = [(BRCAccountSessionFPFS *)self->_session clientTruthWorkloop];
  ...
  if (v2)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v3; ++i)
      {
        ...
        [v6 markLatestSyncRequestFailedInZone:&unk_26F3DD130];
...
- (void)_syncUpRecordBatchWithModifiedRecords:(id)a3 deletedRecordIDs:(id)a4 recordIDToZoneMap:(id)a5 requestID:(unint64_t)a6
{
  ...
  if (v13 + [v11 count])
  {
    ...
    v19 = [MEMORY[0x263EFF8F8] dataWithBytes:&v32 length:8];
    ...
    v20 = [(BRCAccountSessionFPFS *)self->_session clientTruthWorkloop];
  ...
  if (objc_msgSend(v9, "brc_isCloudKitErrorImplyingZoneNeedsCreation"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&location[4] = WeakRetained;
      ...
      __int16 v37 = 2112;
      v38 = v11;
      _os_log_debug_impl(&dword_23FA42000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] We need to create the side car zone on %@ - %@%@", location, 0x20u);
    }

    uint64_t v13 = objc_msgSend(MEMORY[0x263EFD808], "brc_sideCarZoneID");
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v19, (os_log_type_t)0x90u))
      {
        ...
        *(void *)&location[4] = WeakRetained;
        ...
        __int16 v37 = 2112;
        v38 = v18;
        _os_log_error_impl(&dword_23FA42000, v19, (os_log_type_t)0x90u, "[ERROR] Failed syncing up side cars on %@ - %@%@", location, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(void *)&location[4] = v7;
        ...
        __int16 v37 = 2112;
        v38 = v20;
        _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] finished side car sync up: %@, op: %@%@", location, 0x20u);
      }
      ...
      do
      {
        ...
        if (!v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v16;
            uint64_t v23 = v13;
            _os_log_fault_impl(&dword_23FA42000, v14, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: clientZone%@", buf, 0xCu);
          }
        }
        id v21 = v8;
...
- (void)fakeSyncForItem:(id)a3 itemRank:(unint64_t)a4
{
  ...
  [v8 markLatestSyncRequestAcknowledgedInZone:&unk_26F3DD130];
  [v8 saveToDBForServerEdit:1 keepAliases:1];
  if (a4)
  {
    uint64_t v6 = [(BRCAccountSessionFPFS *)self->_session applyScheduler];
...
- (void)main
{
  ...
  long long v4 = [(BRCAccountSessionFPFS *)v3 clientTruthWorkloop];
        ...
        || (v12 & 0x1A00) != 0 && v14 && ([v11 hasfieldsToSync] & 1) == 0)
      {
        ...
        if (!v17)
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            v86 = v28;
            _os_log_debug_impl(&dword_23FA42000, v29, OS_LOG_TYPE_DEBUG, "[DEBUG] Faking sync for side car info delete which isn't known to the server%@", buf, 0xCu);
          }
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v87 = 2112;
          v88 = v18;
          _os_log_debug_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] Deleting side-car record for %@%@", buf, 0x16u);
        }
...
LABEL_29:
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v87 = 2112;
            v88 = v40;
            _os_log_debug_impl(&dword_23FA42000, v41, OS_LOG_TYPE_DEBUG, "[DEBUG] Faking sync of side-car record for %@%@", buf, 0x16u);
          }
...
LABEL_34:
      ...
      v43 = objc_msgSend(MEMORY[0x263EFD7E8], "brc_fetchShareIDWithSharedItem:", v10);
      v44 = v43;
      if ((v42 & 1) == 0)
      {
        v75 = v3;
        ...
        if (!v45)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            v86 = v65;
            _os_log_fault_impl(&dword_23FA42000, v66, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: itemID%@", buf, 0xCu);
          }
        }
        v46 = [v10 serverZone];
        v47 = [v46 ownerName];
      ...
      if (v44)
      {
        v52 = (void *)[objc_alloc(MEMORY[0x263EFD820]) initWithRecordID:v44 action:0];
...
LABEL_39:
        ...
        if (os_log_type_enabled(v55, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v87 = 2112;
          v88 = v54;
          _os_log_debug_impl(&dword_23FA42000, v55, OS_LOG_TYPE_DEBUG, "[DEBUG] Syncing up side-car record for %@%@", buf, 0x16u);
        }
...
LABEL_42:
      ...
      if (os_log_type_enabled(v64, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v87 = 2112;
        v88 = v63;
        _os_log_fault_impl(&dword_23FA42000, v64, OS_LOG_TYPE_FAULT, "[CRIT] Unable to compute reference recordID for %@%@", buf, 0x16u);
      }
...
- (void)_syncUpRecordBatchWithModifiedRecords:(os_log_t)log deletedRecordIDs:recordIDToZoneMap:requestID:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a1;
  _os_log_debug_impl(&dword_23FA42000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Syncing up side car records with request %llu%@", (uint8_t *)&v3, 0x16u);
}
...
- (void)_syncUpRecordBatchWithModifiedRecords:(uint64_t)a1 deletedRecordIDs:(NSObject *)a2 recordIDToZoneMap:requestID:.cold.2(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: requestID%@", (uint8_t *)&v2, 0xCu);
}
...
void __33__BRCSideCarSyncUpOperation_main__block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: state%@", (uint8_t *)&v2, 0xCu);
}
