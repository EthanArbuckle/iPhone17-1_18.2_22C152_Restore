...
+ (id)sharedABCReporter
{
  if (sharedABCReporter_onceToken != -1) {
    dispatch_once(&sharedABCReporter_onceToken, &__block_literal_global_13);
  }
...
- (void)captureLogsForOperationType:(id)a3 ofSubtype:(id)a4 withContext:(id)a5 waitForCompletion:(BOOL)a6
{
    ...
    if (v17 + v16 < brc_current_date_nsec())
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138413314;
        ...
        __int16 v36 = 2112;
        v37 = v18;
        _os_log_debug_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] Not sending recently rejected ABC report with signature: type = %@, subtype = %@, subtype context = %@, rejected time = %@%@", buf, 0x34u);
      }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v34 = 2112;
    v35 = v20;
    _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] Sending ABC report with signature: type = %@, subtype = %@, subtype context = %@%@", buf, 0x2Au);
  }

  id v13 = objc_alloc_init(MEMORY[0x263F7C080]);
...
void __97__BRCAutoBugCaptureReporter_captureLogsForOperationType_ofSubtype_withContext_waitForCompletion___block_invoke_14(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  v4 = [v3 objectForKeyedSubscript:*MEMORY[0x263F7C160]];
  int v5 = [v4 BOOLValue];
  ...
  else
  {
    ...
    {
      id v10 = [v3 objectForKeyedSubscript:*MEMORY[0x263F7C128]];
      id v11 = [v3 objectForKeyedSubscript:*MEMORY[0x263F7C138]];
      ...
      __int16 v21 = 2112;
      v22 = v8;
      _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ABC report got rejected - error code = %@, description = %@ adding throttle (%@, %@)%@", (uint8_t *)&v13, 0x34u);
    }
...
- (BOOL)_shouldIgnoreReportForOperationType:(id)a3 ofSubtype:(id)a4 forError:(id)a5
{
  ...
  if (![v7 isEqualToString:@"SyncHealth"]
    ...
    || ([v9 domain],
        ...
        int v11 = [v10 isEqualToString:*MEMORY[0x263EFD498]],
        v10,
        !v11))
  {
LABEL_9:
...
void __97__BRCAutoBugCaptureReporter_captureLogsForOperationType_ofSubtype_withContext_waitForCompletion___block_invoke_14_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_23FA42000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Sent ABC report successfully%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)_shouldIgnoreReportForOperationType:(void *)a1 ofSubtype:forError:.cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Ignoring expected CK error %ld%@", v3, v4, v5, v6, v7);
}
...
- (void)_shouldIgnoreReportForOperationType:(void *)a1 ofSubtype:forError:.cold.2(void *a1)
{
  [a1 code];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Ignoring expected CK 'cross-zone migration already done' error %ld%@", v3, v4, v5, v6, v7);
}
...
- (void)_shouldIgnoreReportForOperationType:(void *)a1 ofSubtype:forError:.cold.3(void *a1)
{
  [a1 code];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Ignoring CloudKit open error (Operation not permitted) protected class error %ld%@", v3, v4, v5, v6, v7);
}
