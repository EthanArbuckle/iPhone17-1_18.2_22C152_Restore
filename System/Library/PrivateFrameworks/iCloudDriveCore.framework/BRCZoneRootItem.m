...
LABEL_9:
  ...
  if (![v7 isSharedZoneRoot])
  {
    ...
    v14 = [(BRCAccountSessionFPFS *)v8 appLibraryByRowID:v13];
...
- (void)initWithZoneRootItemID:session:.cold.1()
{
  ...
  __int16 v3 = 2112;
  uint64_t v4 = v0;
  _os_log_fault_impl(&dword_23FA42000, v1, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Constructing shared zone root item for itemID %@ is not supported%@", v2, 0x16u);
}

- (void)initWithZoneRootItemID:session:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: itemID.isNonDesktopRoot%@", v2, v3, v4, v5, v6);
}

- (void)saveToDB
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] API MISUSE: can't save a zone root item%@", v2, v3, v4, v5, v6);
}

- (void)parentItemOnFS
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: asking the parent item of a root item%@", v2, v3, v4, v5, v6);
}

- (void)parentItemID
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: asking the parent item ID of a root item%@", v2, v3, v4, v5, v6);
}

- (void)st
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: asking the structural bit of a zone root is not supported%@", v2, v3, v4, v5, v6);
}
