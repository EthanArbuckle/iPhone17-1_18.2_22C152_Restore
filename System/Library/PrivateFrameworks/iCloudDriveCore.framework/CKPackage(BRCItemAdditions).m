...
+ (void)destroyAnchorAndPackageAnchoredAtURL:()BRCItemAdditions
{
  ...
  {
    v6 = [NSDictionary dictionaryWithContentsOfURL:v3];
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v18 = 2112;
      v19 = v9;
      _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Destroying anchor %@, databaseBasePath: %@, UUID: %@%@", (uint8_t *)&v12, 0x2Au);
    }

    if (v7) {
      [MEMORY[0x263EFD790] destroyClientPackageWithDatabaseBasePath:v7 UUID:v8];
    }
...
- (uint64_t)anchorAtURL:()BRCItemAdditions error:
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v29 = 2112;
    v30 = v7;
    _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Anchoring %@ at %@ (db at %@)%@", buf, 0x2Au);
  }
  ...
  int v12 = [MEMORY[0x263F08AC0] dataWithPropertyList:v11 format:100 options:0 error:a4];
  id v13 = v12;
  if (v12)
  {
...
+ (void)destroyAnchorAndPackageAnchoredAtURL:()BRCItemAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Destroying anchor %@%@", v1, 0x16u);
}
...
- (void)anchorAtURL:()BRCItemAdditions error:.cold.1()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] Unable to serialize property list - %@%@", v1, 0x16u);
}
