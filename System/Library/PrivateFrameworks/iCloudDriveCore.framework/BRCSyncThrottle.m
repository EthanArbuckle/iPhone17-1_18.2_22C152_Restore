...
- (BRCSyncThrottle)initWithName:(id)a3 andParameters:(id)a4
{
  ...
  if ([(BRCSyncThrottle *)self _validateThrottleParams:v7])
  {
    ...
    if (v8)
    {
      ...
      if (v9)
      {
        uint64_t v10 = [MEMORY[0x263F08A98] predicateWithFormat:v9];
...
- (void)_validateThrottleParams:(NSObject *)a3 .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v11 = 2112;
  uint64_t v12 = a2;
  _os_log_debug_impl(&dword_23FA42000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] throttle dict %@ isn't for our platform %@%@", (uint8_t *)&v7, 0x20u);
}

- (void)_validateThrottleParams:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Platforms %@ isn't an array%@");
}

- (void)_validateThrottleParams:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Throttle %@ isn't a dictionary%@");
}
