...
+ (uint64_t)newFromSqliteValue:()BRCAddition
{
  v0 = objc_msgSend(MEMORY[0x263EFF8F8], "newFromSqliteValue:");
  if (v0) {
    uint64_t v1 = [objc_alloc(MEMORY[0x263EFD838]) initWithData:v0];
  }
  else {
    uint64_t v1 = 0;
  }
...
+ (uint64_t)newFromSqliteStatement:()BRCAddition atIndex:
{
  v0 = objc_msgSend(MEMORY[0x263EFF8F8], "newFromSqliteStatement:atIndex:");
  if (v0) {
    uint64_t v1 = [objc_alloc(MEMORY[0x263EFD838]) initWithData:v0];
  }
  else {
