...
- (BOOL)boostFileProvider
{
  ...
  else
  {
    ...
    {
      v6 = +[BRCStringAdditions _br_currentMobileDocumentsDirForLegacy];
      if (v6)
      {
        ...
        *((void *)&buf + 1) = &buf;
        ...
        id v15 = 0;
        v8 = [MEMORY[0x263F05448] synchronousSharedConnectionProxy];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(void *)((char *)&buf + 4) = v7;
          _os_log_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Can't find Mobile Documents path for current persona%@", (uint8_t *)&buf, 0xCu);
        }
...
void __44__BRCFileProviderDaemonUtils_sharedInstance__block_invoke(uint64_t a1)
{
  ...
  uint64_t v4 = [objc_alloc(*(Class *)(a1 + 32)) _initWithSyncBubble:v3 isFPFS:1];
...
- (void)interrupt
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v5 = 138412290;
    v6 = v3;
    _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] got interrupted%@", (uint8_t *)&v5, 0xCu);
  }
...
- (void)_signalFPReady
{
  ...
  if (!v2->_fpReady)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      int v5 = 138412290;
      v6 = v3;
      _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] FP is now ready to accept xpc connections%@", (uint8_t *)&v5, 0xCu);
    }
...
- (void)_waitIsOver
{
  ...
  {
    if (obj->_interrupted) {
      objc_msgSend(MEMORY[0x263F087E8], "br_errorWithPOSIXCode:description:", 4, @"BRCFileProviderDaemonUtils was interrupted while waiting for FP to accept xpc connections");
    }
    else {
    uint64_t v3 = objc_msgSend(MEMORY[0x263F087E8], "brc_unkownErrorWithDescription:", @"Waiting without success for FP to accept xpc connections");
    }
...
- (void)enableFileProviderBoosting
{
  obj = self;
  objc_sync_enter(obj);
  obj->_BOOL shouldBoostFileProvider = 1;
  objc_sync_exit(obj);
}
...
- (BOOL)waitForFPToBeReadyToAcceptXPCWithError:(id *)a3
{
  ...
  if (!self->_isFPFS && self->_inSyncBubble)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)long long buf = 138412290;
      v41 = v10;
      _os_log_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEFAULT, "[NOTICE] Device is in sync bubble%@", buf, 0xCu);
    }

    objc_msgSend(MEMORY[0x263F087E8], "brc_errorCantCallFPInSyncBubble");
    uint64_t v12 = (BRCFileProviderDaemonUtils *)(id)objc_claimAutoreleasedReturnValue();
    BOOL fpReady = v12 == 0;
    if (v12)
    {
  ...
  if (!startedWaitingForFP)
  {
    ...
    else
    {
      ...
      v39[3] = &unk_2650805D0;
      v39[4] = v4;
      objc_super v16 = [MEMORY[0x263F054C8] beginMonitoringProviderDomainChangesWithHandler:v39];
      ...
      [MEMORY[0x263F054C8] endMonitoringProviderDomainChanges:v16];
    }
...
LABEL_26:
  ...
  dispatch_sync((dispatch_queue_t)v12->_fileProviderReadyQueue, &__block_literal_global_65);
  v26 = v12;
  objc_sync_enter(v26);
  if (v12->_fpReady)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: FP is not ready but we don't have an error");
...
uint64_t __69__BRCFileProviderDaemonUtils_waitForFPToBeReadyToAcceptXPCWithError___block_invoke(uint64_t result, uint64_t a2, uint64_t a3)
{
  ...
  if (!a3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      int v6 = 138412290;
      uint64_t v7 = v4;
      _os_log_impl(&dword_23FA42000, v5, OS_LOG_TYPE_DEFAULT, "[NOTICE] Got com.apple.fileprovider.providers-changed notification. FP is ready to accept XPC calls%@", (uint8_t *)&v6, 0xCu);
    }
...
- (void)waitForFPToBeReadyToAcceptXPCWithError:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: FP is not ready but we don't have an error%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)waitForFPToBeReadyToAcceptXPCWithError:(uint64_t)a1 .cold.2(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_23FA42000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] FP is already ready to connect after boosting%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)waitForFPToBeReadyToAcceptXPCWithError:(uint64_t)a1 .cold.3(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_23FA42000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Starting to wait for FP to be ready to accept xpc connections%@", (uint8_t *)&v2, 0xCu);
}
