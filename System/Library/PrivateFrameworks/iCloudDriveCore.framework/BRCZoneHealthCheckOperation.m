...
LABEL_14:
          _os_log_fault_impl(&dword_23FA42000, p_super, OS_LOG_TYPE_FAULT, v20, buf, 0x16u);
          goto LABEL_19;
        }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v31;
            ...
            __int16 v44 = 2112;
            v45 = v18;
            _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] We don't have a container for %@%@", buf, 0x16u);
          }
        }
LABEL_19:
      }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┣%llx starting a fetch-record-changes operation for health zone%@");
}
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v34 = 2112;
    long long v35 = v5;
    _os_log_debug_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got a changed record %@ in operation %@%@", buf, 0x2Au);
  }
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v32 = 2112;
        long long v33 = v15;
        _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ignoring zone details record %@ in operation %@%@", buf, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v32 = 2112;
        long long v33 = v15;
        _os_log_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] ignoring record of unexpected type %@ in operation %@%@", buf, 0x20u);
      }
    }
  }
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_17(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v25 = 2112;
    long long v26 = v8;
    _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx recordID was deleted %@ in operation %@%@", buf, 0x2Au);
  }
...
void __35__BRCZoneHealthCheckOperation_main__block_invoke_19(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v23 = 2112;
    uint64_t v24 = v12;
    _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx Received token update %@, requestID %llu%@", buf, 0x2Au);
  }
  ...
  *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = 1;
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    __int16 v33 = 2112;
    __int16 v34 = v18;
    _os_log_debug_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx finished sync down of zone-health %@ with requestID %llu changeToken %@%@", buf, 0x34u);
  }
  if (objc_msgSend(v13, "brc_isCloudKitErrorImplyingZoneNeedsCreation"))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v29 = 2112;
      __int16 v30 = v20;
      _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] No zone-health zone %@: %@%@", buf, 0x20u);
    }
LABEL_12:
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v29 = 2112;
      __int16 v30 = v20;
      _os_log_error_impl(&dword_23FA42000, v21, (os_log_type_t)0x90u, "[ERROR] Failed syncing down zone-health op %@: %@%@", buf, 0x20u);
    }
    goto LABEL_12;
  }
LABEL_13:
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self->_recordsByID[record.recordID] == nil%@", v2, v3, v4, v5, v6);
}

void __35__BRCZoneHealthCheckOperation_main__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: ![self->_deletedRecordIds containsObject:record.recordID]%@", v2, v3, v4, v5, v6);
}

void __35__BRCZoneHealthCheckOperation_main__block_invoke_17_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self->_recordsByID[recordID] == nil%@", v2, v3, v4, v5, v6);
}

void __35__BRCZoneHealthCheckOperation_main__block_invoke_17_cold_2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: ![self->_deletedRecordIds containsObject:recordID]%@", v2, v3, v4, v5, v6);
}

void __35__BRCZoneHealthCheckOperation_main__block_invoke_23_cold_1()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┳%llx sync down of zone-health-check was cancelled?%@");
}
