...
- (BRCThrottle)initWithName:(id)a3 andParameters:(id)a4
{
  ...
  if (v4)
  {
    uint64_t v5 = [objc_alloc(MEMORY[0x263EFF9A0]) initWithCapacity:32];
    retryCounters = v4->_retryCounters;
    v4->_retryCounters = (NSMutableDictionary *)v5;

    v7 = [[BRCMinHeap alloc] initWithComparator:&__block_literal_global_20];
  ...
  if (v12 == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&v28[6] = v14;
      ...
      uint32_t v19 = 38;
LABEL_14:
      _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, v17, buf, v19);
      goto LABEL_11;
    }
    goto LABEL_11;
  }
...
LABEL_31:
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
        {
          ...
          *(void *)&uint8_t buf[4] = v21;
          _os_log_fault_impl(&dword_23FA42000, v22, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: unhandled format specifier%@", buf, 0xCu);
        }
        ...
        if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
        {
          ...
          *(_WORD *)&buf[8] = 2112;
          *(void *)&buf[10] = v23;
          _os_log_error_impl(&dword_23FA42000, v24, (os_log_type_t)0x90u, "[ERROR] unhandled format specifier %%%c\n%@", buf, 0x12u);
        }
