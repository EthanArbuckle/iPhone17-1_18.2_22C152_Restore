...
- (BOOL)_setupTimerRequiredForDeadline:(int64_t)a3 now:(int64_t)a4
{
  ...
  if ((v8 & 1) == 0)
  {
    ...
    {
      v16 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x263EF8400], 0, 0, (dispatch_queue_t)self->_workloop);
      v17 = self->_delay;
      self->_delay = v16;
      ...
      {
        v26 = ((void (*)(void *))*MEMORY[0x263F32768])(v24);
      }
...
- (void)dealloc
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_fault_impl(&dword_23FA42000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ was deallocated without being closed%@", (uint8_t *)&v3, 0x16u);
}
