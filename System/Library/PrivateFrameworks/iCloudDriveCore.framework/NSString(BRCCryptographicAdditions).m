...
{
  unint64_t v4 = a4;
  v15[128] = *MEMORY[0x263EF8340];
  v6 = (__CFString *)[objc_alloc(MEMORY[0x263F089D8]) initWithCapacity:2 * a4];
  if (v6)
  {
    for (; v4; v4 -= v7)
    {
...
- (id)brc_SHA256
{
  ...
  v3 = [MEMORY[0x263EFF8F8] dataWithBytes:v5 length:32];
  return v3;
}
...
- (id)brc_SHA256WithSalt:()BRCCryptographicAdditions
{
  ...
  unsigned int v11 = [MEMORY[0x263EFF8F8] dataWithBytes:v13 length:32];
  return v11;
}
...
- (id)brc_dataFromHexidecimalString
{
  ...
  {
    id v4 = [MEMORY[0x263EFF990] dataWithCapacity:v3 >> 1];
    char v9 = 0;
    char v7 = 0;
    if (v3)
    {
