...
- (id)_utiForExtension:(id)a3
{
  PreferredIdentifierForTag = (__CFString *)UTTypeCreatePreferredIdentifierForTag((CFStringRef)*MEMORY[0x263F01910], (CFStringRef)a3, 0);
...
- (void)_invalidateCahceIfNeeded
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_23FA42000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Invalidating UTI cache%@", (uint8_t *)&v2, 0xCu);
}
