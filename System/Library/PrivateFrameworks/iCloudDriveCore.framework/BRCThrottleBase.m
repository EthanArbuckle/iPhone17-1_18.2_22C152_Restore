...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _nsecsBeforeForgettingCounter >= _maximumNsecsBetweenRetries%@", v2, v3, v4, v5, v6);
}

- (void)initWithName:andParameters:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _maximumNsecsBetweenRetries > 0%@", v2, v3, v4, v5, v6);
}

- (void)initWithName:andParameters:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _minimumNsecsBetweenRetries > 0%@", v2, v3, v4, v5, v6);
}

- (void)initWithName:andParameters:.cold.4()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _minimumNsecsBetweenRetries <= _maximumNsecsBetweenRetries%@", v2, v3, v4, v5, v6);
}

- (void)initWithName:andParameters:.cold.5()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _initialRetryCount <= _finalRetryCount%@", v2, v3, v4, v5, v6);
}
...
- (void)nsecsToNextRetry:retryCount:now:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] We haven't finished the previous throttle%@", v1, 0xCu);
}
...
- (void)nsecsToNextRetry:retryCount:now:.cold.2()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Forgetting retry counter%@", v1, 0xCu);
}
