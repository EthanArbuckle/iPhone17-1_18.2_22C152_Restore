...
LABEL_6:
      ...
      v17->_processType = a5;
      v39 = objc_msgSend(MEMORY[0x263EFD780], "br_sharingMisc");
    ...
    if ([v41 isNonDesktopRoot])
    {
      ...
      if ([v42 isCloudDocsZone])
      {
        v43 = [v10 st];
        v44 = [v43 filename];
        if (([v44 isEqualToString:*MEMORY[0x263F32500]] & 1) == 0)
        {
          v46 = [v10 st];
          [v46 filename];
          v45 = v47 = v43;
          char v48 = [v45 isEqualToString:*MEMORY[0x263F32510]];
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sharing/clean-subitems", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
void __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke(uint64_t a1)
{
    ...
    do
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v51 = 2112;
        v52 = v8;
        _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Removing shareID %@%@", buf, 0x16u);
      }
      ...
      do
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v51 = 2112;
          v52 = v27;
          _os_log_debug_impl(&dword_23FA42000, v28, OS_LOG_TYPE_DEBUG, "[DEBUG] Removing alias record %@%@", buf, 0x16u);
        }
  ...
  {
    id v31 = objc_alloc(MEMORY[0x263EFD748]);
    if ([v38 count]) {
      uint64_t v32 = v38;
    }
    else {
...
uint64_t __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_385(uint64_t a1)
{
...
- (BOOL)_completeAfterProcessingClientTruthIfNecessaryWithError:(id)a3
{
  if (!a3)
  {
    ...
    if (v5)
    {
      ...
      v27[1] = 3221225472;
      v27[2] = __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke;
      v27[3] = &unk_265085660;
      id v28 = v5;
      id v10 = v6;
      id v29 = v10;
      id v11 = v7;
      id v30 = v11;
      float v12 = (void *)MEMORY[0x2455D9A50](v27);
      dispatch_group_t v13 = dispatch_group_create();
      uint64_t v14 = [v9 serialQueue];
      block[0] = MEMORY[0x263EF8330];
      block[1] = 3221225472;
    ...
    {
      objc_msgSend(MEMORY[0x263F087E8], "brc_errorInvalidParameter:value:", @"zoneRowID", 0);
      id v19 = (id)objc_claimAutoreleasedReturnValue();
      [(_BRCOperation *)self completedWithResult:0 error:v19];
    }
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingClientTruthIfNecessaryWithError___block_invoke_2(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v7 = [*(id *)(*(void *)(a1 + 32) + 248) session];
        int v8 = [v7 itemByItemGlobalID:v6 db:*(void *)(a1 + 40)];

        if (v8)
        {
          dispatch_group_enter(*(dispatch_group_t *)(a1 + 48));
          uint64_t v9 = objc_msgSend(MEMORY[0x263F055B8], "br_sharedProviderManager");
          id v10 = [v8 fileObjectID];
          id v11 = [v10 asString];
  ...
  float v12 = *(NSObject **)(a1 + 48);
  dispatch_group_t v13 = [*(id *)(a1 + 32) callbackQueue];
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
...
{
  objc_msgSend(MEMORY[0x263F087E8], "brc_errorFolderHasSharedSubitemsWithSharedByMeURLs:sharedToMeURLs:", *(void *)(a1 + 32), *(void *)(a1 + 40));
  id v2 = (id)objc_claimAutoreleasedReturnValue();
  [*(id *)(a1 + 48) completedWithResult:0 error:v2];
}
...
LABEL_21:
    ...
    long long v27 = v31;
    long long v28 = [v31 URLByAppendingPathComponent:v13];
    goto LABEL_22;
  }
  while (1)
  {
...
LABEL_20:
  ...
  __int16 v14 = (void *)[v7 stringWithSQL:@"SELECT item_alias_target FROM server_items WHERE item_id = %@ AND zone_rowid = %@", v33, self->_rootClientZone];
  if (!v14)
  {
    id v13 = brc_bread_crumbs();
    uint64_t v30 = brc_default_log();
...
LABEL_29:
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v41 = 2112;
      id v42 = v19;
      _os_log_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't parse unsalted bookmark data %@ - %@%@", buf, 0x20u);
    }
    goto LABEL_18;
  }
  id v18 = [v32 serverZoneByMangledID:v35];
  id v19 = v18;
  if (v18)
  {
    id v20 = v36;
    ...
    *(_DWORD *)buf = 138412546;
    ...
    v40 = v23;
    long long v25 = v24;
    long long v26 = "[WARNING] No filename found on alias target %@%@";
    goto LABEL_16;
  }
  id v23 = brc_bread_crumbs();
  id v24 = brc_default_log();
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    v40 = v23;
    long long v25 = v24;
    long long v26 = "[WARNING] Couldn't find server zone for %@%@";
LABEL_16:
    _os_log_impl(&dword_23FA42000, v25, OS_LOG_TYPE_DEFAULT, v26, buf, 0x16u);
  }
LABEL_17:
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke(uint64_t a1)
{
  ...
  v15[1] = v15;
  v15[2] = 0x3032000000;
  v15[3] = __Block_byref_object_copy__44;
  v15[4] = __Block_byref_object_dispose__44;
  ...
  v14[5] = v17;
  v14[6] = v15;
  id v2 = (void *)MEMORY[0x2455D9A50](v14);
  uint64_t v3 = [*(id *)(a1 + 40) appLibraryByRowID:*(void *)(*(void *)(a1 + 32) + 608)];
  uint64_t v4 = objc_msgSend(MEMORY[0x263F055B8], "br_sharedProviderManager");
  id v5 = [v3 rootFileObjectID];
  id v6 = [v5 asString];
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke_405(uint64_t a1, void *a2)
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v17 = objc_msgSend(*(id *)(a1 + 32), "computeURLForItemID:rootURL:", *(void *)(*((void *)&v19 + 1) + 8 * v15), v3, (void)v19);
        [v16 addObject:v17];
  ...
  id v18 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorFolderHasSharedSubitemsWithSharedByMeURLs:sharedToMeURLs:", *(void *)(*(void *)(*(void *)(a1 + 40) + 8) + 40), *(void *)(*(void *)(*(void *)(a1 + 48) + 8) + 40));
...
void __100__BRCSharingProcessFolderSubitemsOperation__completeAfterProcessingServerTruthIfNecessaryWithError___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  uint64_t v7 = [*(id *)(a1 + 32) serverTruthWorkloop];
...
{
  if (*(void *)(a1 + 32)) {
    return objc_msgSend(*(id *)(a1 + 40), "completedWithResult:error:", 0);
  }
  else {
...
void __85__BRCSharingProcessFolderSubitemsOperation_processServerItemsUnderItemID_completion___block_invoke(uint64_t a1)
{
  ...
  while ([v7 next])
  {
    ...
    id v53 = v14;
    v54 = v55;
    id v15 = (void (**)(void))MEMORY[0x2455D9A50](v50);
    uint64_t v16 = v11;
    if ((v11 & 4) != 0)
    {
      ...
      if ((v11 & 0x48) != 0 && *(void *)(v24 + 544) != 2)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v61 = 2112;
          v62 = v34;
          _os_log_impl(&dword_23FA42000, v35, OS_LOG_TYPE_DEFAULT, "[WARNING] subitem %@ is already shared inside %@%@", buf, 0x20u);
        }
    ...
    else
    {
      if (v10 == 3)
      {
        ...
        if (*(void *)(v17 + 544) != 2)
        {
          id v18 = [*(id *)(v17 + 592) serverItemByItemID:v14];
        ...
        if (([*(id *)(v17 + 568) containsObject:v14] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            __int16 v61 = 2112;
            v62 = v22;
            _os_log_debug_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Found shared-to-me alias to delete %@ in %@%@", buf, 0x20u);
          }
      ...
      if (v10 - 9 > 1)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v59 = 2112;
          v60 = v32;
          _os_log_fault_impl(&dword_23FA42000, v37, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Huh?  We shouldn't be processing this item if it's not shared and not a directory fault %@%@", buf, 0x16u);
        }
...
LABEL_31:
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v59 = 2112;
        v60 = v30;
        _os_log_debug_impl(&dword_23FA42000, v31, OS_LOG_TYPE_DEBUG, "[DEBUG] We need to fetch %@ before we can continue%@", buf, 0x16u);
      }
...
- (BOOL)deleteShareInfoFromZone:(id)a3 zoneRowID:(id)a4 itemID:(id)a5 sharingOptions:(unint64_t)a6 itemsTable:(id)a7
{
  ...
  long long v22 = [MEMORY[0x263F8C718] nameWithString:v15];
...
LABEL_7:
  ...
  if (((1 << v24) & 0x611) == 0)
  {
    if (((1 << v24) & 0x106) != 0)
    {
      id v32 = objc_alloc(MEMORY[0x263EFD7C8]);
      long long v27 = [v12 zoneID];
  ...
  long long v27 = [v13 directoryStructureRecordIDInZone:v12];
...
LABEL_10:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 136315650;
    ...
    __int16 v46 = 2112;
    long long v47 = v36;
    _os_log_debug_impl(&dword_23FA42000, v37, OS_LOG_TYPE_DEBUG, "[DEBUG] deleting %s shareID %@%@", buf, 0x20u);
  }
...
{
  uint64_t v2 = [*(id *)(a1[4] + 248) session];
  uint64_t v3 = [v2 itemByRowID:*(void *)(a1[4] + 520) db:a1[5]];
  ...
  (*(void (**)(void, void, uint64_t, uint64_t, uint64_t))(a1[7] + 16))(a1[7], 0, v7, v8, v9);
}

void __77__BRCSharingProcessFolderSubitemsOperation_processClientTruthWithCompletion___block_invoke_2(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  ...
  if ((a3 & 0x48) != 0 && *(void *)(*(void *)(a1 + 32) + 544) != 2)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v29 = 2112;
      uint64_t v30 = v18;
      _os_log_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEFAULT, "[WARNING] subitem %@ is already shared inside %@%@", (uint8_t *)&v25, 0x20u);
    }

    [*(id *)(*(void *)(a1 + 32) + 552) addObject:v7];
  ...
  {
    uint64_t v8 = [v7 zoneRowID];
    uint64_t v9 = [*(id *)(*(void *)(a1 + 32) + 592) dbRowID];
    ...
    else
    {
      ...
      [*(id *)(*(void *)(a1 + 32) + 592) itemMovedIntoShareInThisZone:v17 associatedItemID:0];
    }
  }
}
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Not processing child items on %@ because it already has a shareID%@");
}
...
uint64_t __48__BRCSharingProcessFolderSubitemsOperation_main__block_invoke_3(uint64_t a1, uint64_t a2)
{
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Removing shared subitems in op %@%@");
}

void __79__BRCSharingProcessFolderSubitemsOperation_removeSharedSubitemsWithCompletion___block_invoke_384_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Remove share subitems batch completed with error - %@%@");
}

- (void)computeURLForItemID:rootURL:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Can't find alias target for %@%@");
}
...
- (void)computeURLForItemID:rootURL:.cold.2()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] an item in the path has a nil filename%@", v1, 0xCu);
}

- (void)processServerItemsUnderItemID:completion:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Processing server truth in op %@%@");
}
...
- (void)deleteShareInfoFromZone:(os_log_t)log zoneRowID:itemID:sharingOptions:itemsTable:.cold.1(char a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v4 = 2112;
  uint64_t v5 = a2;
  _os_log_fault_impl(&dword_23FA42000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Don't know how to unshare item of type %d%@", (uint8_t *)v3, 0x12u);
}

- (void)deleteShareInfoFromZone:zoneRowID:itemID:sharingOptions:itemsTable:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Can't locate the item type we are deleting?%@", v2, v3, v4, v5, v6);
}

- (void)processClientTruthWithCompletion:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Processing client truth in op %@%@");
}

void __77__BRCSharingProcessFolderSubitemsOperation_processClientTruthWithCompletion___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: (options & BRCSharingItemHasShareID) != 0%@", v2, v3, v4, v5, v6);
}
