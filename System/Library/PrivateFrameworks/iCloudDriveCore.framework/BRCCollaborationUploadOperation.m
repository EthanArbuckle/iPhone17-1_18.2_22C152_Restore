...
- (BRCCollaborationUploadOperation)initWithRecord:(id)a3 progress:(id)a4 syncContext:(id)a5 sessionContext:(id)a6
{
  ...
  if (v18)
  {
    ...
    v19 = objc_msgSend(MEMORY[0x263EFD780], "br_collaborationUpload");
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Starting the upload operation%@", v1, 0xCu);
}
...
void __39__BRCCollaborationUploadOperation_main__block_invoke(uint64_t a1, void *a2, double a3)
{
  ...
  if (a3 < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v6;
      _os_log_impl(&dword_23FA42000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Upload: Received negative progress from CK. progress [%f]%@", (uint8_t *)&v9, 0x16u);
    }
  }
...
void __39__BRCCollaborationUploadOperation_main__block_invoke_150(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  id v8 = a2;
  id v6 = a4;
  if (v6 || [v8 count] != 1)
