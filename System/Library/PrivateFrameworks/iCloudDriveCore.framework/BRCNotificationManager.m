...
void __50__BRCNotificationManager_pipeDelegateInvalidated___block_invoke(uint64_t a1)
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  v3 = objc_msgSend(v2, "objectEnumerator", 0);
...
- (BRCNotificationManager)initWithAccountSession:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v16 = (BRNotificationQueue *)objc_alloc_init(MEMORY[0x263F325E8]);
    notifs = v7->_notifs;
    v7->_notifs = v16;
    ...
    v20 = [(BRCAccountSessionFPFS *)v7->_session clientDB];
    v21 = [v20 serialQueue];
    ...
    uint64_t v25 = objc_msgSend(MEMORY[0x263F08968], "weakToStrongObjectsMapTable", v28, v29, v30, v31);
...
{
  v2 = +[BRCPersistedState loadFromClientStateInSession:*(void *)(a1 + 32)];
  uint64_t v3 = [v2 nextNotifRank];

  *(void *)(*(void *)(a1 + 40) + 88) = v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v11 + 1) + 8 * v10++) registerQueryIsRecursive:v9];
      }
      while (v7 != v10);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v11 + 1) + 8 * v10++) unregisterQueryIsRecursive:v9];
      }
      while (v7 != v10);
      uint64_t v7 = [v5 countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
...
- (void)registerPipe:(id)a3 asWatcherForFileObjectID:(id)a4
{
  ...
  unint64_t v9 = [(NSMapTable *)v8->_fileObjectIDByWatcher objectForKey:v6];
  if (v9)
  {
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v18 = 2112;
    v19 = v12;
    _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[NOTIF] Pipe %@ watching %@%@", (uint8_t *)&v14, 0x20u);
  }
...
- (void)unregisterPipeAsWatcher:(id)a3
{
  ...
  if (v6)
  {
    ...
    unint64_t v9 = brc_notifications_log();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v8;
      _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[NOTIF] Pipe %@ no longer watching %@%@", (uint8_t *)&v10, 0x20u);
    }
  }
  objc_sync_exit(v5);
}
...
{
  v2 = [[BRCNotificationPipe alloc] initWithXPCReceiver:a1[4] client:a1[5] manager:a1[6] startingRank:*(void *)(a1[6] + 88)];
...
{
  v2 = [[BRCNotificationPipe alloc] initWithReceiver:a1[4] manager:a1[5] startingRank:*(void *)(a1[5] + 88)];
...
{
  return [*(id *)(*(void *)(a1 + 32) + 56) addNotification:*(void *)(a1 + 40) asDead:0];
}
...
- (void)_dispatchUpdatesToPipesWithRank:(unint64_t)a3
{
  ...
  {
    id v5 = objc_msgSend(MEMORY[0x263F325C0], "br_getDomainIdentifierForCurrentPersona");
    id v6 = objc_msgSend(MEMORY[0x263F055B8], "br_sharedProviderManagerWithDomainID:", v5);
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v13 = (void *)MEMORY[0x2455D97F0](v8);
  ...
  if ([(NSMutableSet *)self->_additionalUpdatesItemRowID count])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v26 = 2112;
      v27 = v4;
      _os_log_debug_impl(&dword_23FA42000, v5, OS_LOG_TYPE_DEBUG, "[NOTIF] ┏%llx collecting %lu additional folder updates%@", buf, 0x20u);
    }
    ...
    if (v7)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v7; ++i)
        {
          ...
          id v12 = -[BRCAccountSessionFPFS itemByRowID:](self->_session, "itemByRowID:", [v10 unsignedLongLongValue]);
...
void __63__BRCNotificationManager_invalidatePipesWatchingAppLibraryIDs___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v2;
    _os_log_debug_impl(&dword_23FA42000, v3, OS_LOG_TYPE_DEBUG, "[NOTIF] ┏%llx invalidating pipes watching %@%@", buf, 0x20u);
  }
...
void __87__BRCNotificationManager_invalidatePipeReceiversWatchingAppLibraryIDs_completionBlock___block_invoke(void *a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v2;
    _os_log_debug_impl(&dword_23FA42000, v3, OS_LOG_TYPE_DEBUG, "[NOTIF] ┏%llx invalidating NSMDQs watching %@%@", buf, 0x20u);
  }
...
- (void)getPipeWithXPCReceiver:(uint64_t)a1 client:(NSObject *)a2 reply:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: reply%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)queueUpdate:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: item.fileObjectID%@", (uint8_t *)&v2, 0xCu);
}
...
void __58__BRCNotificationManager__dispatchUpdatesToPipesWithRank___block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_error_impl(&dword_23FA42000, log, (os_log_type_t)0x90u, "[ERROR] failed to signal enumerator for root container: %@%@", (uint8_t *)&v3, 0x16u);
}
