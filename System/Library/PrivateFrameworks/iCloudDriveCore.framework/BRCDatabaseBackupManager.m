    ...
    if (!v10->_destinationDirectory)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 138412290;
        v18 = v13;
        _os_log_impl(&dword_23FA42000, v14, OS_LOG_TYPE_INFO, "[INFO] ~/Library/Application Support/CloudDocs/session does not exist. No need to back up.%@", buf, 0xCu);
      }
    }
  }
...
LABEL_20:
          _os_log_error_impl(&dword_23FA42000, v14, (os_log_type_t)0x90u, v17, buf, 0x20u);
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v43 = 2112;
        v44 = v29;
        _os_log_impl(&dword_23FA42000, v30, OS_LOG_TYPE_DEFAULT, "[NOTICE] Calling completion block with URL: %@, error: %@%@", buf, 0x20u);
      }
      if (v26)
      {
...
- (NSArray)urlPropertiesToFetch
{
  ...
  uint64_t v2 = *MEMORY[0x263EFFAD0];
  v6[0] = *MEMORY[0x263EFF5E0];
  v6[1] = v2;
  uint64_t v3 = *MEMORY[0x263EFF690];
  v6[2] = *MEMORY[0x263EFF620];
  v6[3] = v3;
  v6[4] = *MEMORY[0x263EFF6A8];
...
LABEL_3:
    ...
    while (1)
    {
      ...
      char v20 = (void *)MEMORY[0x2455D97F0]();
      id v24 = v18;
...
LABEL_25:
  ...
  id v65 = 0;
  uint64_t v15 = *MEMORY[0x263EFF5E0];
  uint64_t v64 = 0;
  uint64_t v50 = v15;
  ...
  if (v16)
  {
    ...
    v54 = (void *)v18;
    char v20 = [v19 enumeratorAtURL:v10 includingPropertiesForKeys:v18 options:2 errorHandler:&__block_literal_global_18];
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v69 = 2112;
      v70 = v21;
      _os_log_impl(&dword_23FA42000, v22, OS_LOG_TYPE_INFO, "[INFO] Enumarating URL: %@%@", buf, 0x16u);
    }
    char v42 = v16;
    id v43 = v11;
    id v44 = v10;
    ...
    if (v55)
    {
      ...
      uint64_t v48 = *MEMORY[0x263EFF620];
      uint64_t v49 = *MEMORY[0x263EFFAD0];
      uint64_t v46 = *MEMORY[0x263EFF6A8];
      uint64_t v47 = *MEMORY[0x263EFF690];
      do
      {
        for (uint64_t i = 0; i != v55; ++i)
        {
          ...
          long long v26 = (void *)MEMORY[0x2455D97F0]();
          v59 = v17;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
            {
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v71 = 2112;
              v72 = v35;
              _os_log_error_impl(&dword_23FA42000, v28, (os_log_type_t)0x90u, "[ERROR] Failed to fetch resource values for %@. Error: %@%@", buf, 0x20u);
            }
          }
        }
        uint64_t v55 = [obj countByEnumeratingWithState:&v60 objects:v66 count:16];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v71 = 2112;
      v72 = v40;
      _os_log_error_impl(&dword_23FA42000, v41, (os_log_type_t)0x90u, "[ERROR] Could not get the canonical path for the root URL %@. Error: %@%@", buf, 0x20u);
    }
...
uint64_t __66__BRCDatabaseBackupManager_enumerateURL_rootURL_usingBlock_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v7, (os_log_type_t)0x90u))
  {
    ...
    __int16 v13 = 2112;
    char v14 = v6;
    _os_log_error_impl(&dword_23FA42000, v7, (os_log_type_t)0x90u, "[ERROR] Enumeration error: %@. Error: %@%@", (uint8_t *)&v9, 0x20u);
  }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v15 = 2112;
      char v16 = v7;
      _os_log_error_impl(&dword_23FA42000, v8, (os_log_type_t)0x90u, "[ERROR] Failed to remove directory %@: %@%@", buf, 0x20u);
    }
  }
}
...
void __54__BRCDatabaseBackupManager_backUpWithCompletionBlock___block_invoke_cold_1()
{
  ...
  uint64_t v3 = v0;
  _os_log_debug_impl(&dword_23FA42000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] %@%@", v2, 0x16u);
}
...
- (void)enumerateURL:(uint64_t)a1 rootURL:(NSObject *)a2 usingBlock:error:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_23FA42000, a2, (os_log_type_t)0x90u, "[ERROR] rootURL is nil, nothing to enumerate.%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)enumerateURL:(NSObject *)a3 rootURL:usingBlock:error:.cold.2(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  OUTLINED_FUNCTION_0_0();
  uint64_t v7 = a2;
  _os_log_error_impl(&dword_23FA42000, a3, (os_log_type_t)0x90u, "[ERROR] %@ does not exist, nothing to enumerate.%@", v6, 0x16u);
}
