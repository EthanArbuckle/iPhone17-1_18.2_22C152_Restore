...
- (double)tombstonesAgeDeltaAfterEnumerated;
...
{
  v2 = [a1 _userDefaultsManager];
  v3 = [v2 defaultsForIdentifier:*MEMORY[0x263F32528]];
...
{
  v2 = [a1 _userDefaultsManager];
  v3 = [v2 defaultsForIdentifier:*MEMORY[0x263F327C8]];
...
- (BOOL)_isSharedDefaults
{
  return [(NSString *)self->_clientZoneIdentifier isEqualToString:*MEMORY[0x263F32528]];
}
...
- (id)_loadObjectForKey:(id)a3 inheritFromGlobal:(BOOL)a4 suiteName:(id)a5 validateWithBlock:(id)a6
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v30 = 2112;
      v31 = v14;
      _os_log_debug_impl(&dword_23FA42000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] server default for %@: %@%@", (uint8_t *)&v26, 0x20u);
    }
  }
  if (v11)
  {
    objc_super v16 = (void *)[objc_alloc(MEMORY[0x263EFFA40]) initWithSuiteName:v11];
  }
  else
  {
    objc_super v16 = [MEMORY[0x263EFFA40] standardUserDefaults];
  }
  v17 = v16;
...
LABEL_13:
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v30 = 2112;
      v31 = v20;
      _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] user default for %@: %@%@", (uint8_t *)&v26, 0x20u);
    }
...
- (id)_serverDefaultForKey:(id)a3
{
  ...
  long long v32 = 0u;
  id v27 = self;
  id v6 = self->_serverContainerConfigurationDict;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v35 = 2112;
              v36 = v13;
              _os_log_fault_impl(&dword_23FA42000, v14, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: no version for key: %@%@", buf, 0x16u);
            }
          }
        }
      }
...
LABEL_27:
  ...
  while (1)
  {
    ...
    {
      id v19 = [@"defaults.clouddocs." stringByAppendingString:v18];
...
LABEL_3:
  ...
  if (os_log_type_enabled(v12, (os_log_type_t)0x90u))
  {
    ...
    __int16 v27 = 2112;
    __int16 v28 = v11;
    _os_log_error_impl(&dword_23FA42000, v12, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%d,%d]; using default:%d%@",
      (uint8_t *)&v17,
      0x32u);
  }
...
LABEL_4:
  BOOL v8 = [*(id *)(v6 + 2584) numberWithInt:v4];
...
LABEL_3:
  ...
  unint64_t v6 = 0x263F08000;
LABEL_4:
  BOOL v8 = [*(id *)(v6 + 2584) numberWithUnsignedInt:v4];
...
LABEL_3:
  ...
  if (os_log_type_enabled(v12, (os_log_type_t)0x90u))
  {
    ...
    __int16 v27 = 2112;
    unint64_t v28 = v11;
    _os_log_error_impl(&dword_23FA42000, v12, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%lld,%lld]; using default:%lld%@",
      (uint8_t *)&v17,
      0x3Eu);
  }
  ...
  unint64_t v6 = 0x263F08000;
LABEL_4:
  BOOL v8 = [*(id *)(v6 + 2584) numberWithUnsignedLongLong:v4];
...
LABEL_3:
  ...
  if (os_log_type_enabled(v13, (os_log_type_t)0x90u))
  {
    ...
    __int16 v28 = 2112;
    uint64_t v29 = v12;
    _os_log_error_impl(&dword_23FA42000, v13, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%f,%f]; using default:%f%@",
      (uint8_t *)&v18,
      0x3Eu);
  }
...
LABEL_4:
  *(float *)&double v8 = v4;
  uint64_t v9 = [*(id *)(v6 + 2584) numberWithFloat:v8];
...
- (double)doubleForKey:(id)a3 min:(double)a4 max:(double)a5 byDefault:(double)a6
{
  ...
  __int16 v24 = __50__BRCUserDefaults_doubleForKey_min_max_byDefault___block_invoke;
  double v25 = &unk_265086710;
  double v27 = a6;
  double v28 = a4;
  double v29 = a5;
  id v26 = v10;
  id v11 = v10;
  id v12 = [(BRCUserDefaults *)self objectForKey:v11 inheritFromGlobal:1 validateWithBlock:&v22];
  ...
  if (validateUserDouble(v3, (double *)(a1 + 48), (double *)(a1 + 56), &v12) == 2)
  {
    ...
    if (os_log_type_enabled(v5, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413570;
      ...
      __int16 v23 = 2112;
      __int16 v24 = v4;
      _os_log_error_impl(&dword_23FA42000, v5, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@ range:[%f,%f]; using default:%f%@",
        buf,
        0x3Eu);
    }
  }
  ...
  if (validateUserBool(v3, &v10) == 2)
  {
    ...
    if (os_log_type_enabled(v5, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v4;
      _os_log_error_impl(&dword_23FA42000, v5, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@: %@; using default:%s%@",
        buf,
        0x2Au);
    }
  }
...
id __57__BRCUserDefaults_xpcActivityDictionaryForKey_byDefault___block_invoke(uint64_t a1, void *a2)
{
  ...
  v73[1] = @"delay";
  v73[2] = @"grace";
  id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v73 count:3];
...
LABEL_17:
  ...
  id v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v71 count:5];
...
LABEL_31:
  ...
  id v26 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  double v27 = [NSString stringWithUTF8String:*MEMORY[0x263EF8290]];
  double v28 = objc_msgSend(v25, "setWithObjects:", v26, v27, 0);
...
LABEL_34:
    ...
    if (os_log_type_enabled(v33, (os_log_type_t)0x90u))
    {
      ...
      *(void *)&uint8_t buf[4] = v48;
      ...
      __int16 v69 = 2112;
      v70 = v32;
      _os_log_error_impl(&dword_23FA42000, v33, (os_log_type_t)0x90u, "[ERROR] invalid user default for %@.%@: %@; using default:%@%@",
        buf,
        0x34u);
    }

    uint64_t v34 = [MEMORY[0x263EFF9A0] dictionaryWithDictionary:*(void *)(v51 + 32)];
...
LABEL_38:
  ...
  v37 = v36;
  if (v36) {
    xpc_dictionary_set_int64(v35, (const char *)*MEMORY[0x263EF81D8], [v36 longLongValue]);
  }
  uint64_t v38 = [v5 objectForKeyedSubscript:@"delay"];

  if (v38) {
    xpc_dictionary_set_int64(v35, (const char *)*MEMORY[0x263EF81A0], [v38 longLongValue]);
  }
  v39 = [v5 objectForKeyedSubscript:@"grace"];

  if (v39) {
    xpc_dictionary_set_int64(v35, (const char *)*MEMORY[0x263EF81C0], [v39 longLongValue]);
  }
  v40 = [v5 objectForKeyedSubscript:@"repeat"];

  if (v40) {
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x263EF82A0], [v40 BOOLValue]);
  }
  v41 = [v5 objectForKeyedSubscript:@"priority"];

  if (v41) {
    xpc_dictionary_set_string(v35, (const char *)*MEMORY[0x263EF8280], (const char *)[v41 UTF8String]);
  }
  v42 = [v5 objectForKeyedSubscript:@"battery"];

  if (v42) {
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x263EF8180], [v42 BOOLValue]);
  }
  v43 = [v5 objectForKeyedSubscript:@"powernap"];

  if (v43) {
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x263EF8270], [v43 BOOLValue]);
  }
  v44 = [v5 objectForKeyedSubscript:@"screen.sleep"];

  if (v44) {
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x263EF82D8], [v44 BOOLValue]);
  }
  v45 = [v5 objectForKeyedSubscript:@"disk-intensive"];

  if (v45) {
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x263EF81A8], [v45 BOOLValue]);
  }
  v46 = [v5 objectForKeyedSubscript:@"may.reboot"];

  if (v46) {
    xpc_dictionary_set_BOOL(v35, (const char *)*MEMORY[0x263EF8228], [v46 BOOLValue]);
  }
...
id __62__BRCUserDefaults__extensionSetForKey_startingWithExtensions___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v4 = [MEMORY[0x263EFF9C0] setWithArray:*(void *)(a1 + 32)];
  }
  BOOL v5 = v4;
...
- (NSSet)packageExtensions
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.pkg.extensions" startingWithExtensions:&unk_26F3DDBC8];
}

- (NSSet)blacklistedPackageExtensions
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.pkg.blacklist.extensions" startingWithExtensions:&unk_26F3DDBE0];
}

- (NSSet)iworkShareableExtensions
{
  unsigned int v3 = [MEMORY[0x263F32640] iWorkShareableExtensions];
...
- (NSSet)extensionsSkippingBundleBitFixup
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.bundle-bit.fixup.backlist.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)shouldBeGreedyExtensions
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.greedy.extensions.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)nonAutoEvictableExtensions
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.non-auto-evictable.extensions.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)nonEvictableExtensions
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.non-evictable.extensions.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)nonEvictablePathComponents
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"fs.non-evictable.path-components.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)nonAutoEvictableUTIs
{
  return (NSSet *)[(BRCUserDefaults *)self _UTISetFor:@"fs.non-auto-evictable.utis.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)autoEvictableUTIs
{
  return (NSSet *)[(BRCUserDefaults *)self _UTISetFor:@"fs.auto-evictable.utis.ios" startingWithExtensions:MEMORY[0x263EFFA68]];
}

- (NSSet)blacklistedThumbnailExtensions
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"doc.thumbnail-blacklist.extensions" startingWithExtensions:&unk_26F3DDBF8];
}
...
- (OS_xpc_object)configurationUpdateXPCActivity
{
  ...
  v11[0] = @"interval";
  uint64_t v3 = *MEMORY[0x263EF81E8];
  id v4 = [NSNumber numberWithLongLong:2 * *MEMORY[0x263EF81E8]];
  v12[0] = v4;
  v11[1] = @"delay";
  ...
  v11[3] = @"repeat";
  v11[4] = @"priority";
  id v7 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  v11[5] = @"battery";
  void v12[4] = v7;
  v12[5] = MEMORY[0x263EFFA80];
  uint64_t v8 = [NSDictionary dictionaryWithObjects:v12 forKeys:v11 count:6];
...
- (OS_xpc_object)transmogrifyXPCActivity
{
  ...
  v11[0] = @"interval";
  uint64_t v3 = *MEMORY[0x263EF81E8];
  id v4 = [NSNumber numberWithLongLong:3 * *MEMORY[0x263EF81E8]];
  v12[0] = v4;
  v11[1] = @"delay";
  BOOL v5 = [NSNumber numberWithLongLong:v3];
  v12[1] = v5;
...
- (NSArray)syncThrottles
{
  return (NSArray *)[(BRCUserDefaults *)self objectForKey:@"sync-throttles" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_1613];
}
...
- (NSDictionary)appLibraryScanThrottleParams
{
  ...
  void v10[4] = &unk_26F3DD550;
  v10[5] = &unk_26F3DD568;
  id v3 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:6];
...
- (BRCSyncOperationThrottleParams)syncDownThrottle
{
  return (BRCSyncOperationThrottleParams *)[(BRCUserDefaults *)self objectForKey:@"sync.down.throttle" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_1700];
}
...
BRCSyncOperationThrottleParams *__35__BRCUserDefaults_syncDownThrottle__block_invoke(uint64_t a1, void *a2)
{
  ...
  v7[6] = @"kickback-ratio";
  v8[6] = &unk_26F3DDDB0;
  id v4 = [NSDictionary dictionaryWithObjects:v8 forKeys:v7 count:7];
...
- (BRCSyncOperationThrottleParams)syncUpThrottle
{
  return (BRCSyncOperationThrottleParams *)[(BRCUserDefaults *)self objectForKey:@"sync.up.throttle" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_1712];
}
...
- (float)syncUpDailyBudget
{
  ...
  if (clientZoneIdentifier
    && ![(NSString *)clientZoneIdentifier isEqualToString:*MEMORY[0x263F324E8]])
  {
...
- (NSDictionary)readerThrottleParams
{
  ...
  v9[4] = @"forget-after";
  v9[5] = @"max-elemnt-count";
  void v10[4] = &unk_26F3DD5B0;
  v10[5] = &unk_26F3DD748;
  double v3 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:6];
  v7[0] = MEMORY[0x263EF8330];
  v7[1] = 3221225472;
...
- (BOOL)shouldAppLibraryBeGreedy
{
  BOOL v3 = [(NSString *)self->_clientZoneIdentifier isEqualToString:*MEMORY[0x263F32460]];
...
- (OS_xpc_object)stageGCXPCActivity
{
  ...
  v11[0] = @"interval";
  uint64_t v3 = *MEMORY[0x263EF81F0];
  id v4 = [NSNumber numberWithLongLong:*MEMORY[0x263EF81F0]];
  v12[0] = v4;
  v11[1] = @"delay";
  float v5 = [NSNumber numberWithLongLong:*MEMORY[0x263EF8200]];
  v12[1] = v5;
  v11[2] = @"grace";
  ...
  v11[3] = @"repeat";
  v11[4] = @"priority";
  int v7 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  void v12[4] = v7;
...
- (OS_xpc_object)cacheDeletePushXPCActivity
{
  ...
  v10[0] = @"delay";
  uint64_t v3 = *MEMORY[0x263EF8208];
  id v4 = [NSNumber numberWithLongLong:*MEMORY[0x263EF8208]];
  v11[0] = v4;
  v10[1] = @"grace";
  ...
  v10[3] = @"screen.sleep";
  v11[1] = v5;
  v11[2] = MEMORY[0x263EFFA88];
  v11[3] = MEMORY[0x263EFFA88];
  v11[4] = MEMORY[0x263EFFA88];
  void v10[4] = @"powernap";
  v10[5] = @"battery";
  void v11[5] = MEMORY[0x263EFFA80];
  v10[6] = @"priority";
  double v6 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  void v11[6] = v6;
  int v7 = [NSDictionary dictionaryWithObjects:v11 forKeys:v10 count:7];
...
- (NSString)serverConfigurationURL
{
  return (NSString *)[(BRCUserDefaults *)self objectForKey:@"server-config-url" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_1878];
}
...
- (NSDictionary)recentsEnumeratorFailureThrottleParams
{
  ...
  void v10[4] = &unk_26F3DD550;
  v10[5] = &unk_26F3DD568;
  uint64_t v3 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:6];
  v7[0] = MEMORY[0x263EF8330];
  v7[1] = 3221225472;
...
- (NSDictionary)migrationThrottleParams
{
  ...
  v9[4] = @"forget-after";
  void v10[4] = &unk_26F3DD6A0;
  uint64_t v3 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:5];
  v7[0] = MEMORY[0x263EF8330];
  v7[1] = 3221225472;
...
- (NSSet)blacklistPCSPrep
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"zone-pcs-migration.blacklist-pcs-prep" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2058];
}

id __35__BRCUserDefaults_blacklistPCSPrep__block_invoke(uint64_t a1, void *a2)
{
  double v2 = _stringSetFromDefaultValue(a2, 0);
  uint64_t v3 = *MEMORY[0x263F324E8];
  [v2 addObject:*MEMORY[0x263F324E8]];
  if (v2)
  {
    id v4 = v2;
  }
  ...
  {
    objc_msgSend(MEMORY[0x263EFF9C0], "setWithObjects:", v3, *MEMORY[0x263F324D8], *MEMORY[0x263F32550], @"_defaultZone", 0);
...
- (NSSet)excludedFilenamesWorthWarningAtLogout
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"excluded-filenames-worth-warning-at-logout" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2093];
}
...
id __56__BRCUserDefaults_excludedFilenamesWorthWarningAtLogout__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v4 = [MEMORY[0x263F32620] defaultExcludedFilenamesWorthWarningAtLogout];
  }
  float v5 = v4;
...
- (NSSet)excludedFilenamesWorthPreserving
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"excluded-filenames-worth-preservering" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2099];
}
...
id __51__BRCUserDefaults_excludedFilenamesWorthPreserving__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v4 = [MEMORY[0x263F32620] defaultExcludedFilenamesWorthPreserving];
  }
  float v5 = v4;
...
- (NSSet)excludedExtensionsWorthPreserving
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"excluded-extensions-worth-preservering" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2104];
}
...
id __52__BRCUserDefaults_excludedExtensionsWorthPreserving__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v4 = [MEMORY[0x263F32620] defaultExcludedExtensionsWorthPreserving];
  }
  float v5 = v4;
...
- (BOOL)shouldAutoMigrateToCloudDocs
{
  if ([(NSString *)self->_clientZoneIdentifier isEqualToString:*MEMORY[0x263F32320]])
  {
    ...
    if (v16 >= v8)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          __int16 v29 = 2112;
          id v30 = v17;
          _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] We are denylisted from %@ because %d < %d and %d%@", (uint8_t *)&v21, 0x28u);
        }
        BOOL v15 = 0;
      }
    }
...
- (OS_xpc_object)aggressivePCSChainActivity
{
  void v10[6] = *MEMORY[0x263EF8340];
  v10[0] = &unk_26F3DD670;
  v9[0] = @"delay";
  v9[1] = @"grace";
  uint64_t v3 = [NSNumber numberWithLongLong:*MEMORY[0x263EF8218]];
  uint64_t v4 = MEMORY[0x263EFFA80];
  v10[1] = v3;
  v10[2] = MEMORY[0x263EFFA80];
  v9[2] = @"repeat";
  v9[3] = @"priority";
  int v5 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  v10[3] = v5;
  void v10[4] = v4;
  v9[4] = @"battery";
  void v9[5] = @"screen.sleep";
  v10[5] = MEMORY[0x263EFFA88];
  id v6 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:6];
...
- (OS_xpc_object)finishSaltingPartiallySaltedDirectoriesActivity
{
  ...
  v9[0] = @"delay";
  v9[1] = @"grace";
  uint64_t v3 = [NSNumber numberWithLongLong:*MEMORY[0x263EF81E8]];
  uint64_t v4 = MEMORY[0x263EFFA80];
  v10[1] = v3;
  v10[2] = MEMORY[0x263EFFA80];
  v9[2] = @"repeat";
...
- (BOOL)canSaveRecordsDirectlyForDeltaSync
{
  BOOL v3 = [(NSString *)self->_clientZoneIdentifier isEqualToString:*MEMORY[0x263F32528]];
...
- (BOOL)isBlacklistedFromFolderSharing
{
  BOOL v3 = [(NSString *)self->_clientZoneIdentifier isEqualToString:*MEMORY[0x263F32340]];
...
- (OS_xpc_object)fpfsMigrationTrialRefreshXPCActivity
{
  ...
  v8[0] = @"interval";
  double v3 = [NSNumber numberWithLongLong:6 * *MEMORY[0x263EF81F0]];
  v9[0] = v3;
  v8[1] = @"priority";
  uint64_t v4 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  v9[1] = v4;
  v9[2] = MEMORY[0x263EFFA88];
  v8[2] = @"battery";
  v8[3] = @"screen.sleep";
  v8[4] = @"repeat";
  v9[3] = MEMORY[0x263EFFA80];
  v9[4] = MEMORY[0x263EFFA88];
...
- (OS_xpc_object)fpfsMigrationSchedulerXPCActivity
{
  ...
  if ([MEMORY[0x263F32628] isInternalBuild]) {
    ...
    uint64_t v3 = 3 * *MEMORY[0x263EF81E8];
  }
  uint64_t v4 = [NSNumber numberWithLongLong:v3];
  v10[0] = v4;
  v9[0] = @"interval";
  v9[1] = @"priority";
  uint64_t v5 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  v10[1] = v5;
  v10[2] = MEMORY[0x263EFFA80];
  v9[2] = @"battery";
  v9[3] = @"screen.sleep";
  v9[4] = @"may.reboot";
  v10[3] = MEMORY[0x263EFFA88];
  void v10[4] = MEMORY[0x263EFFA88];
  id v6 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:5];
...
- (OS_xpc_object)appTelemetryGatherXPCActivity
{
  void v9[5] = *MEMORY[0x263EF8340];
  v8[0] = @"interval";
  uint64_t v3 = [NSNumber numberWithLongLong:2 * *MEMORY[0x263EF81E8]];
  v9[0] = v3;
  v8[1] = @"priority";
  uint64_t v4 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  v9[1] = v4;
...
- (NSSet)telemetryHeaderSupportedClasses
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"telemetry.header-send-supported-classes" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2375];
}
...
- (NSSet)benignTelemetryErrorDescriptions
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"telemetry.benign-error-descriptions" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2390];
}
...
id __51__BRCUserDefaults_benignTelemetryErrorDescriptions__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v2)
  {
    double v2 = objc_msgSend(MEMORY[0x263EFFA08], "setWithObjects:", @"CKErrorZoneNotFound", @"CKErrorSharedZoneNotFound", @"CKErrorUserDeletedZone", @"zone became healthy", @"testing", 0);
  }
  return v2;
}
...
id __51__BRCUserDefaults__healthErrorSetForKey_byDefault___block_invoke(uint64_t a1, void *a2)
{
      ...
      do
      {
        ...
        if ((int)objc_msgSend(*(id *)(*((void *)&v16 + 1) + 8 * v8), "intValue", v15) >= 20)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v15;
            long long v21 = v9;
            _os_log_fault_impl(&dword_23FA42000, v10, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [error intValue] < BRCProblemTypeMaxValue%@", buf, 0xCu);
          }
        }
        ++v8;
      }
  ...
  {
    id v12 = [MEMORY[0x263EFF9C0] setWithArray:*(void *)(a1 + 32)];
  }
  uint64_t v13 = v12;
...
- (NSSet)healthErrorsForReset
{
  return (NSSet *)[(BRCUserDefaults *)self _healthErrorSetForKey:@"zone-health.errors-for-reset" byDefault:&unk_26F3DDC10];
}

- (NSSet)healthErrorsToReport
{
  return (NSSet *)[(BRCUserDefaults *)self _healthErrorSetForKey:@"zone-health.errors-to-report" byDefault:&unk_26F3DDC28];
}

- (NSSet)recordsToIgnoreOnSyncDown
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"sync.ignored-record-names" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2475];
}
...
id __44__BRCUserDefaults_recordsToIgnoreOnSyncDown__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v2)
  {
    double v2 = objc_msgSend(MEMORY[0x263EFFA08], "setWithObjects:", @"directory/appData_com.apple.Desktop", @"directory/appDocuments_com.apple.Desktop", @"directory/appData_com.apple.Documents", @"directory/appDocuments_com.apple.Documents", 0);
  }
  return v2;
}
...
- (OS_xpc_object)dbIntegrityCheckXPCActivity
{
  ...
  v9[3] = MEMORY[0x263EFFA88];
  v9[4] = MEMORY[0x263EFFA88];
  long long v5 = [NSDictionary dictionaryWithObjects:v9 forKeys:v8 count:5];
...
- (BOOL)dbIntegrityCheckLostZombieDirectories
{
  return [(BRCUserDefaults *)self BOOLForKey:@"db.integrity-check.lost-zombie-directories" byDefault:1];
}
...
- (OS_xpc_object)syncConsistencyCheckerXPCActivity
{
  void v9[6] = *MEMORY[0x263EF8340];
  v8[0] = @"interval";
  int v3 = [NSNumber numberWithLongLong:*MEMORY[0x263EF8218]];
  v9[0] = v3;
  v8[1] = @"priority";
  uint64_t v4 = [NSString stringWithUTF8String:*MEMORY[0x263EF8288]];
  v9[1] = v4;
  ...
  v8[4] = @"disk-intensive";
  void v8[5] = @"repeat";
  void v9[5] = MEMORY[0x263EFFA88];
  long long v5 = [NSDictionary dictionaryWithObjects:v9 forKeys:v8 count:6];
...
- (NSDictionary)serverStitchingThrottleParams
{
  ...
  void v10[4] = &unk_26F3DD550;
  v10[5] = &unk_26F3DD748;
  int v3 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:6];
  v7[0] = MEMORY[0x263EF8330];
  v7[1] = 3221225472;
...
{
  uint64_t v23 = *MEMORY[0x263EF8340];
  int v3 = _numberSetFromDefaultValue(a2);
  long long v16 = 0u;
  long long v17 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
      ...
      do
      {
        ...
        if ((int)objc_msgSend(*(id *)(*((void *)&v16 + 1) + 8 * v8), "intValue", v15) <= 0)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v15;
            long long v21 = v9;
            _os_log_fault_impl(&dword_23FA42000, v10, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [errorID intValue] > 0%@", buf, 0xCu);
          }
        }
        ++v8;
      }
...
- (double)tombstonesAgeDeltaAfterEnumerated
{
  [(BRCUserDefaults *)self doubleForKey:@"fpfs.enumeration.tombstone-age-time-after-enumerated" min:0.0 max:1.79769313e308 byDefault:3600.0];
  return result;
}

- (double)downloadStageAgeDelta
{
  [(BRCUserDefaults *)self doubleForKey:@"disk-space-reclaimer.download-stage-age-time-fpfs" min:0.0 max:1.79769313e308 byDefault:86400.0];
  return result;
}

- (double)itemsCreationAgeDelta
{
  [(BRCUserDefaults *)self doubleForKey:@"disk-space-reclaimer.item-creation-age-time-fpfs" min:0.0 max:1.79769313e308 byDefault:86400.0];
  return result;
}

- (double)liveItemsStageAgeDelta
{
  [(BRCUserDefaults *)self doubleForKey:@"disk-space-reclaimer.live-items-stage-age-delta-fpfs" min:0.0 max:1.79769313e308 byDefault:86400.0];
  return result;
}
...
- (unsigned)fpfsImportStatusTelemetryStuckMigrationDaysThreshold
{
  return [(BRCUserDefaults *)self unsignedIntForKey:@"fpfs.migration.import-status-telemetry-stuck-migration-days-threshold" min:0 max:1000000 byDefault:5];
}

- (BOOL)fpfsStuckMigrationTakeReconciledItemsIntoAccount
{
  return [(BRCUserDefaults *)self BOOLForKey:@"fpfs.migration.stuck-migration-take-reconciled-items-into-account" byDefault:0];
}

- (unsigned)fpfsStuckMigrationRecoveryDaysWithoutProgressThreshold
{
  return [(BRCUserDefaults *)self unsignedIntForKey:@"fpfs.migration.stuck-migration-recovery-days-without-progress-threshold" min:0 max:1000000 byDefault:2];
}

- (unsigned)fpfsStuckMigrationRecoveryDaysSinceImportStartedThreshold
{
  return [(BRCUserDefaults *)self unsignedIntForKey:@"fpfs.migration.stuck-migration-recovery-days-since-import-started-threshold" min:0 max:1000000 byDefault:9];
}

- (unsigned)fpfsStuckMigrationRecoveryDaysSinceUpgradeThreshold
{
  return [(BRCUserDefaults *)self unsignedIntForKey:@"fpfs.migration.stuck-migration-recovery-days-since-upgrade-threshold" min:0 max:1000000 byDefault:2];
}

- (BOOL)requestCKCacheAssetClone
{
  return [(BRCUserDefaults *)self BOOLForKey:@"enable.ck-cache" byDefault:1];
}

- (NSSet)sendTapToRadarForMigrationErrors
{
  return (NSSet *)[(BRCUserDefaults *)self _brErrorSetForKey:@"fpfs.send-tap-to-radar-for-migration-errors" byDefault:&unk_26F3DDC40];
}

- (BOOL)deleteFPFSDomainOnReimportRootError
{
  return [(BRCUserDefaults *)self BOOLForKey:@"fpfs.delete-fpfs-domain-on-reimport-error" byDefault:1];
}

- (BOOL)stripFileProviderXattrBeforeImport
{
  return [(BRCUserDefaults *)self BOOLForKey:@"fpfs.strip-fp-xattr-on-import-domain" byDefault:0];
}

- (unint64_t)itemsNotMigratedToInvestigateLimit
{
  return [(BRCUserDefaults *)self unsignedLongLongForKey:@"fpfs.migration.items-not-migrated-investigation-count" min:0 max:-1 byDefault:100];
}

- (unint64_t)itemsNotMigratedTelemetryLimit
{
  return [(BRCUserDefaults *)self unsignedLongLongForKey:@"fpfs.migration.items-not-migrated-telemetry-count" min:0 max:-1 byDefault:10];
}

- (unint64_t)migrationStatusPendingItemsTelemetryLimit
{
  return [(BRCUserDefaults *)self unsignedLongLongForKey:@"fpfs.migration.pending-items-status-telemetry-count" min:0 max:-1 byDefault:5];
}

- (BOOL)filterDecendantsOfNotMigratedFolders
{
  return [(BRCUserDefaults *)self BOOLForKey:@"fpfs.filter-decendants-of-not-migrated-folders" byDefault:1];
}

- (BOOL)failModifyRequestsWhenInFlightUnAckedChanges
{
  return [(BRCUserDefaults *)self BOOLForKey:@"fpfs.sync.fail-modify-requests-with-in-flight-un-acked-changes" byDefault:1];
}

- (BOOL)reimportRootContainerWhenDomainDecorationIsInvalid
{
  return [(BRCUserDefaults *)self BOOLForKey:@"fpfs.reimport-root-container-when-domain-decoration-invalid" byDefault:1];
}
...
- (NSSet)ignoredCKErrorsForABC
{
  return (NSSet *)[(BRCUserDefaults *)self _brErrorSetForKey:@"abc.ignored-ck-errors" byDefault:&unk_26F3DDC58];
}
...
- (BOOL)shouldBoostDefaultZone
{
  if ([(NSString *)self->_clientZoneIdentifier isEqualToString:*MEMORY[0x263F32460]])
  {
...
void __36__BRCUserDefaults_dumpDateFormatter__block_invoke(uint64_t a1)
{
  ...
  uint64_t v3 = (void *)dumpDateFormatter_df;
...
- (BOOL)useIDSDecisionService
{
  return [(BRCUserDefaults *)self BOOLForKey:@"ttr.use.ids.decision.service" byDefault:1];
}

- (NSURL)idsDecisionServiceURL
{
  id v2 = [(BRCUserDefaults *)self stringForKey:@"ttr.ids.decision.service.url" byDefault:@"https://support.ess.apple.com/WebObjects/SupportService.woa/internal/checkTapToRadarDecision"];
...
- (NSDictionary)tapToRadarDailyThrottleRules
{
  ...
  v4[3] = &unk_265086738;
  id v5 = &unk_26F3DDD40;
  id v2 = [(BRCUserDefaults *)self objectForKey:@"ttr.daily.throttle.rules" inheritFromGlobal:1 validateWithBlock:v4];
...
- (NSDictionary)tapToRadarWeeklyThrottleRules
{
  ...
  v4[3] = &unk_265086738;
  id v5 = &unk_26F3DDD68;
  id v2 = [(BRCUserDefaults *)self objectForKey:@"ttr.weekly.throttle.rules" inheritFromGlobal:1 validateWithBlock:v4];
...
+ (id)generateThrottleTTRIdentifiersForTriggerRootCause:(id)a3
{
  ...
  uint64_t v7 = [v3 stringWithFormat:@"%@_%ld", v5, v6];
...
- (NSSet)weeklyThrottledErrorsForTTR
{
  return (NSSet *)[(BRCUserDefaults *)self objectForKey:@"ttr.weekly.throttled.errors" inheritFromGlobal:1 validateWithBlock:&__block_literal_global_2807];
}
...
id __46__BRCUserDefaults_weeklyThrottledErrorsForTTR__block_invoke(uint64_t a1, void *a2)
{
  ...
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0
    || (uint64_t v3 = v2, (objc_msgSend(v2, "br_all_of_type:", objc_opt_class()) & 1) == 0))
  {
    long long v18 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorInitialScanItemBouncedByServer");
    long long v17 = +[BRCUserDefaults generateThrottleTTRIdentifiersForTriggerRootCause:v18];
    v19[0] = v17;
    long long v16 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorInitialScanItemTypeMismatch");
    long long v15 = +[BRCUserDefaults generateThrottleTTRIdentifiersForTriggerRootCause:v16];
    v19[1] = v15;
    id v4 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorRecordBouncedByServer");
    id v5 = +[BRCUserDefaults generateThrottleTTRIdentifiersForTriggerRootCause:v4];
    v19[2] = v5;
    uint64_t v6 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorBouncedItemNotKnownByServer");
    uint64_t v7 = +[BRCUserDefaults generateThrottleTTRIdentifiersForTriggerRootCause:v6];
    v19[3] = v7;
    uint64_t v8 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorNoEtagAvailableForDownloadOfItemWithIdentifier:", &stru_26F3822F0);
    Class v9 = +[BRCUserDefaults generateThrottleTTRIdentifiersForTriggerRootCause:v8];
    v19[4] = v9;
    id v10 = objc_alloc(MEMORY[0x263F087E8]);
    uint64_t v11 = (void *)[v10 initWithDomain:*MEMORY[0x263F32360] code:52 userInfo:0];
    id v12 = +[BRCUserDefaults generateThrottleTTRIdentifiersForTriggerRootCause:v11];
    v19[5] = v12;
    uint64_t v3 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:6];
  }
  uint64_t v13 = [MEMORY[0x263EFF9C0] setWithArray:v3];
...
- (NSSet)resetReasonsToTriggerTTR
{
  return (NSSet *)[(BRCUserDefaults *)self _extensionSetForKey:@"reset.reasons.to.trigger.ttr" startingWithExtensions:&unk_26F3DDC70];
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: def <= max%@", v2, v3, v4, v5, v6);
}

- (void)intForKey:min:max:byDefault:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: min <= def%@", v2, v3, v4, v5, v6);
}

- (void)intForKey:min:max:byDefault:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: min < max%@", v2, v3, v4, v5, v6);
}

- (void)_shouldRampForKey:session:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] We are not denylisted from %@%@");
}

- (void)_shouldRampForKey:session:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] We are not denylisted from %@ chaining because we are in carry%@");
}

- (void)_shouldRampForKey:session:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] We are not denylisted from %@ because we are on an internal build%@");
}

- (void)_shouldRampForKey:session:.cold.4()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] We are not denylisted from %@ because we are on an internal build and in carry%@");
}
