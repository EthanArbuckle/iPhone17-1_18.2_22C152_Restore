  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      ...
      *(void *)((char *)&v23 + 2) = v10;
      ...
      uint32_t v14 = 42;
LABEL_15:
      _os_log_error_impl(&dword_23FA42000, v13, (os_log_type_t)0x90u, v12, v21, v14);
    }
  }
  else
  {
  ...
  if (v18 <= 0x1A && ((1 << v18) & 0x5000800) != 0)
  {
    ...
    (*(void (**)(uint64_t, id, id, void *))(v19 + 16))(v19, WeakRetained, v9, &__block_literal_global_0);
  }
}
...
uint64_t __37__BRCPQLConnection__setLockedHandler__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  v11 = [MEMORY[0x263F089D8] stringWithFormat:@"%@ has been locked for %f seconds: %@", v6, *(void *)&v9, v8];
  objc_super v12 = v11;
  if (v7) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v22 = 2112;
      long long v23 = v13;
      _os_log_impl(&dword_23FA42000, v14, OS_LOG_TYPE_DEFAULT, "[WARNING] %@%@", buf, 0x16u);
    }
  }
...
void __56__BRCPQLConnection__registerStaticDBFunctionsWithError___block_invoke_6(uint64_t a1, sqlite3_context *a2, int a3, void *a4)
{
  ...
  id v6 = (void *)[MEMORY[0x263EFF8F8] newFromSqliteValue:*a4];
...
- (void)setProfilingEnabled:(BOOL)a3
{
  if (a3)
  {
    ...
    -[BRCPQLConnection setProfilingHook:](&v4, sel_setProfilingHook_, v5, v3.receiver, v3.super_class, self, BRCPQLConnection, MEMORY[0x263EF8330], 3221225472, __40__BRCPQLConnection_setProfilingEnabled___block_invoke, &unk_26507EC88, self, v6);
  }
  else
  {
    ...
    if (v8)
    {
      ...
      if (*(unsigned char *)(a1 + 40) || v12 < v10)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v33[34] = 2112;
          *(void *)&v33[36] = v26;
          _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] %s %@:\n  binds:    %d\n  columns:  %d\n  rows:     %ld\n  vm steps: %d (max: %lu)\n  sql:      %s\n  %@%@", buf, 0x5Au);
        }
      }
    }
    else
    {
      ...
      if (*(unsigned char *)(a1 + 40) || v12 < v10)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v33[28] = 2112;
          *(void *)&v33[30] = v27;
          _os_log_impl(&dword_23FA42000, v17, OS_LOG_TYPE_DEFAULT, "[WARNING] %s %@:\n  binds:    %d\n  changes:  %lld\n  vm steps: %d (max: %lu)\n  sql:      %s\n  %@%@", buf, 0x54u);
        }
    ...
    if (10 * v12 < v10)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
      {
        ...
        *(void *)&v29[16] = v11;
        __int16 v30 = 2112;
        *(void *)v31 = v20;
        _os_log_fault_impl(&dword_23FA42000, v21, OS_LOG_TYPE_FAULT, "[CRIT] Significantly too slow SQL statement(vm steps: %u  max:%lu): %s%@", buf, 0x26u);
      }
...
- (void)setProfilingHook:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v10 = 2112;
    BOOL v11 = v4;
    _os_log_fault_impl(&dword_23FA42000, v5, OS_LOG_TYPE_FAULT, "[CRIT] %@%@", buf, 0x16u);
  }
  brc_append_system_info_to_message();
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v16 = 2112;
      objc_super v17 = v8;
      _os_log_fault_impl(&dword_23FA42000, v9, OS_LOG_TYPE_FAULT, "[CRIT] error closing connection %@: %@%@", buf, 0x20u);
    }
  }
  if (a3) {
    *a3 = v7;
...
void __60__BRCPQLConnection__setErrorHandlerWithDBCorruptionHandler___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Got really unexpected error: %@%@", v1, 0x16u);
}

void __37__BRCPQLConnection__setLockedHandler__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] %@%@");
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] _registerStaticDBFunctions failed with %@%@");
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: !set || [set isKindOfClass:[NSIndexSet class]]%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] API MISUSE: you need to provide a radar%@", v2, v3, v4, v5, v6);
}

- (void)executeWithExpectedIndex:sql:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] API MISUSE: you need to an index to use%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _batchingPacer%@", v2, v3, v4, v5, v6);
}

- (void)_validateIsRunningWithCorrectPersona
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Running on the connection with the wrong persona%@", v2, v3, v4, v5, v6);
}
