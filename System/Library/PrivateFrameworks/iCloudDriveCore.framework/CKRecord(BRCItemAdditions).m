...
- (uint64_t)brc_isInterestingRecordForSyncDown
{
  ...
  if (![v2 isEqualToString:@"structure"])
  {
    ...
    {
      uint64_t v9 = [v2 isEqualToString:*MEMORY[0x263EFD510]];
      goto LABEL_16;
    }
    v8 = @"documentContent/";
LABEL_14:
...
- (BOOL)brc_safeToGetURL
{
  ...
  v6 = [MEMORY[0x263F32640] iWorkShareableExtensions];
...
- (id)brc_lastModifiedUserRecordNameWithCurrentUserRecordName:()BRCItemAdditions personNameComponents:
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    id v32 = 0;
    BOOL v9 = [MEMORY[0x263F08900] JSONObjectWithData:v8 options:0 error:&v32];
    id v10 = v32;
    objc_opt_class();
    id v11 = 0;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v37 = 2112;
          v38 = v16;
          _os_log_fault_impl(&dword_23FA42000, v17, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid lastEditorDeviceName on %@: %@%@", buf, 0x20u);
        }
        id v11 = 0;
      }
    }
...
- (uint64_t)brc_currentUserOwnsLastEditorDeviceWithSessionContext:()BRCItemAdditions
{
  ...
  uint64_t v6 = [v5 isEqualToString:*MEMORY[0x263EFD488]];
...
- (id)brc_lastEditorDeviceName
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    id v15 = 0;
    v4 = [MEMORY[0x263F08900] JSONObjectWithData:v3 options:0 error:&v15];
    id v5 = v15;
    objc_opt_class();
    uint64_t v6 = 0;
    if ((objc_opt_isKindOfClass() & 1) == 0) {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v20 = 2112;
        char v21 = v11;
        _os_log_fault_impl(&dword_23FA42000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid lastEditorDeviceName on %@: %@%@", buf, 0x20u);
      }
    }
    uint64_t v6 = 0;
LABEL_10:
...
+ (id)rootDirectoryRecordForZoneID:()BRCItemAdditions
{
  ...
  id v5 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initWithRecordName:v4 zoneID:v3];

  id v6 = (void *)[objc_alloc(MEMORY[0x263EFD7C8]) initWithRecordType:@"structure" recordID:v5];
  uint64_t v7 = [MEMORY[0x263EFF8F8] data];
...
+ (id)rootAppLibraryRecordForAppLibraryID:()BRCItemAdditions zoneID:
{
  ...
  else
  {
    ...
    v16 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initWithRecordName:v24 zoneID:v6];
    BOOL v9 = (void *)[objc_alloc(MEMORY[0x263EFD7C8]) initWithRecordType:@"structure" recordID:v16];
    v17 = [@"directory/" stringByAppendingString:@"root"];
    __int16 v18 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initWithRecordName:v17 zoneID:v6];
    id v19 = objc_alloc(MEMORY[0x263EFD820]);
    __int16 v20 = (void *)[v19 initWithRecordID:v18 action:*MEMORY[0x263EFD528]];
...
+ (id)desiredKeysWithMask:()BRCItemAdditions
{
  ...
  if ((a3 & 0xC) != 0)
  {
    ...
    BOOL v9 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:5];
  ...
  if ((a3 & 4) != 0)
  {
    ...
    v24[1] = @"pkgManifest";
    v24[2] = @"pkgXattrs";
    __int16 v18 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:3];
...
LABEL_8:
  ...
  id v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
...
LABEL_21:
  ...
  __int16 v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:2];
...
LABEL_11:
  ...
  {
LABEL_12:
    uint64_t v10 = *MEMORY[0x263EFD5A0];
    v21[0] = *MEMORY[0x263EFD5A8];
    v21[1] = v10;
...
- (uint64_t)validateEnhancedDrivePrivacyFieldsWithSession:()BRCItemAdditions error:
{
  v76[7] = *MEMORY[0x263EF8340];
  id v5 = a3;
  id v6 = objc_alloc(MEMORY[0x263F325E0]);
  ...
  v76[5] = @"pkgContent";
  v76[6] = @"pkgXattrs";
  v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v76 count:7];
...
LABEL_3:
    ...
    while (1)
    {
      ...
      id v19 = (void *)MEMORY[0x263EFD7C8];
              ...
              if ([v55 count])
              {
                ...
                if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
                {
                  *(_DWORD *)buf = v51;
                  ...
                  __int16 v69 = 2112;
                  v70 = v24;
                  _os_log_fault_impl(&dword_23FA42000, v25, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ has different boundary key then other assets in the record!%@", buf, 0x16u);
                }
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v73 = 2112;
      v74 = v34;
      _os_log_impl(&dword_23FA42000, v35, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ is%s in mmcsV2 when it should%s be%@", buf, 0x2Au);
    }
...
LABEL_19:
  ...
  v66[0] = @"mtime";
  v66[1] = @"birthtime";
  id v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:v66 count:2];
  if (v11)
  {
...
- (void)brc_fillWithChildBasehashSalt:()BRCItemAdditions
{
  ...
  if (v13 && v5)
  {
    id v6 = objc_msgSend(MEMORY[0x263EFF8F8], "brc_generateBogusKey");
    ...
    if (v7)
    {
      ...
      {
        uint64_t v10 = (void *)[objc_alloc(MEMORY[0x263EFF9A0]) initWithCapacity:1];
      }

      [v10 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"br_bougusSaltingKey"];
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: rootAppLibraryRecordForAppLibraryID: should not be called with a bogus app library id %@%@");
}

+ (void)_validateCKObject:()BRCItemAdditions enhancedDrivePrivacyEnabled:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: CKObject of unexpected type - %@%@");
}

- (void)validateEnhancedDrivePrivacyFieldsWithSession:()BRCItemAdditions error:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Rounding amount should be at least 1 minute%@", v2, v3, v4, v5, v6);
}

- (void)validateEnhancedDrivePrivacyFieldsWithSession:()BRCItemAdditions error:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: %@ is not rounded the correct amount%@");
}
