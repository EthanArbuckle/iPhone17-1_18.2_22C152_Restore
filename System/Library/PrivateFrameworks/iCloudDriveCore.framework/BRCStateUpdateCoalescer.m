...
- (void)_setupCoalesceUpdateTimerWithUtilityHandlerBlock:(id)a3
{
  ...
  v5 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x263EF8400], 0, 0, (dispatch_queue_t)self->_callbackQueue);
  coalesceUpdateTimer = self->_coalesceUpdateTimer;
  ...
  {
    v17 = ((void (*)(void *))*MEMORY[0x263F32768])(v15);
  }
...
{
  OUTLINED_FUNCTION_2(&dword_23FA42000, a2, a3, "[CRIT] Assertion failed: coalesceUpdateTimer == self->_coalesceUpdateTimer Expecting same address%@", a5, a6, a7, a8, 2u);
}
