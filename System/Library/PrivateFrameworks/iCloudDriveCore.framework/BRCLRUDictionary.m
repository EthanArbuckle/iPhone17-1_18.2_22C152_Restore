...
- (BRCLRUDictionary)initWithMaximumCapacity:(unint64_t)a3
{
  ...
  if (v13)
  {
    uint64_t v14 = [objc_alloc(MEMORY[0x263EFF9A0]) initWithCapacity:v3];
...
- (id)allValues
{
  unint64_t v3 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", -[NSMutableDictionary count](self->_dictionary, "count"));
...
- (id)description
{
  unint64_t v3 = [MEMORY[0x263F089D8] stringWithFormat:@"<%@: %p>{\n", objc_opt_class(), self];
...
{
  OUTLINED_FUNCTION_2(&dword_23FA42000, a2, a3, "[CRIT] UNREACHABLE: Initialized with maximumCapacity == 0%@", a5, a6, a7, a8, 2u);
}
...
{
  OUTLINED_FUNCTION_2(&dword_23FA42000, a2, a3, "[CRIT] Assertion failed: key != nil%@", a5, a6, a7, a8, 2u);
}
