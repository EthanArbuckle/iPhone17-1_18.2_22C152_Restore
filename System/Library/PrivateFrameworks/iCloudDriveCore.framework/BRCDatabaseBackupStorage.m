...
- (BRCDatabaseBackupStorage)initWithDatabaseURL:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      uint64_t v12 = *MEMORY[0x263EFFAD0];
      v22[0] = *MEMORY[0x263EFF5E0];
      v22[1] = v12;
      uint64_t v13 = *MEMORY[0x263EFF690];
      v22[2] = *MEMORY[0x263EFF620];
      v22[3] = v13;
      v22[4] = *MEMORY[0x263EFF6A8];
      uint64_t v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:5];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v27 = 2112;
        v28 = v16;
        _os_log_error_impl(&dword_23FA42000, v17, (os_log_type_t)0x90u, "[ERROR] Can't open database at %@: %@%@", buf, 0x20u);
      }
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v13 = 2112;
      uint64_t v14 = v5;
      _os_log_error_impl(&dword_23FA42000, v6, (os_log_type_t)0x90u, "[ERROR] Can't close database at %@: %@%@", buf, 0x20u);
    }
  }
}
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v20 = 2112;
      objc_super v21 = v10;
      _os_log_error_impl(&dword_23FA42000, v11, (os_log_type_t)0x90u, "[ERROR] Can't insert into the database %@: %@%@", buf, 0x20u);
    }
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v24 = 2112;
        __int16 v25 = v13;
        _os_log_error_impl(&dword_23FA42000, v14, (os_log_type_t)0x90u, "[ERROR] Can't insert into the database %@: %@%@", buf, 0x20u);
      }
    }
    id v6 = v19;
  }
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v12, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v20 = 2112;
      objc_super v21 = v11;
      _os_log_error_impl(&dword_23FA42000, v12, (os_log_type_t)0x90u, "[ERROR] Can't close database at %@: %@%@", buf, 0x20u);
    }
  }
  [*v1 setDatabase:0];
}
...
- (id)backupManifestEnumerator:(id)a3
{
  ...
  id v4 = [v3 enumerateObjects:&__block_literal_global_25];
...
- (void)populateNewColumnsWithBasePath:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v5;
    _os_log_impl(&dword_23FA42000, v6, OS_LOG_TYPE_INFO, "[INFO] Populating new columns with base path: %@%@", buf, 0x16u);
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v10 = (void *)MEMORY[0x2455D97F0](v5);
...
- (void)populateNewColumnsInDatabase:(id)a3 forRecord:(id)a4 basePath:(id)a5
{
  ...
  if (v15)
  {
    uint64_t v17 = [v15 objectForKeyedSubscript:*MEMORY[0x263EFFAD0]];
    ...
    id v21 = [v15 objectForKeyedSubscript:*MEMORY[0x263EFF690]];
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&v41[6] = v32;
      __int16 v42 = 2112;
      v43 = v23;
      _os_log_debug_impl(&dword_23FA42000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] Updating %@ %@ %d into database for %@%@", buf, 0x30u);
    }
    ...
    if ((v25 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
      {
        ...
        *(void *)&v41[6] = v30;
        ...
        __int16 v44 = 2112;
        v45 = v27;
        _os_log_error_impl(&dword_23FA42000, v28, (os_log_type_t)0x90u, "[ERROR] Failed to update %@ %@ %d into database for %@: %@%@", buf, 0x3Au);
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v40 = 2112;
      *(void *)v41 = v17;
      _os_log_error_impl(&dword_23FA42000, v19, (os_log_type_t)0x90u, "[ERROR] Unable to fetch URL properties for %@: %@%@", buf, 0x20u);
    }
  }
}
...
- (BOOL)attachDatabase:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v8;
    _os_log_impl(&dword_23FA42000, v9, OS_LOG_TYPE_INFO, "[INFO] Attaching database %@%@", buf, 0x16u);
  }
  ...
  if (self->_attachedDatabaseURL)
  {
    ...
    if (os_log_type_enabled(v13, (os_log_type_t)0x90u))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v37 = v12;
      _os_log_error_impl(&dword_23FA42000, v13, (os_log_type_t)0x90u, "[ERROR] Already have attached database %@ while trying to attach database %@.%@", buf, 0x20u);
    }
    char v14 = 1;
  }
  else
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)v30 = 138412802;
        ...
        __int16 v34 = 2112;
        id v35 = v17;
        _os_log_error_impl(&dword_23FA42000, v18, (os_log_type_t)0x90u, "[ERROR] Unable to attach db %@: %@%@", v30, 0x20u);
      }
      if (a4) {
        *a4 = *(id *)(*(void *)&buf[8] + 40);
      }
  ...
  if (self->_attachedDatabaseURL)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v3;
      _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_INFO, "[INFO] Updating attached database %@ %@%@", buf, 0x20u);
    }
...
- (BOOL)fixUpBackupDetector:(id)a3
{
  ...
  id v30 = 0;
  uint64_t v10 = *MEMORY[0x263EFFAD0];
  id v29 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v35 = 2112;
        v36 = v20;
        _os_log_error_impl(&dword_23FA42000, v22, (os_log_type_t)0x90u, "[ERROR] Unable to get inode for %@: %@%@", buf, 0x20u);
      }
    }
    BOOL v21 = 0;
LABEL_20:
  ...
  if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v35 = 2112;
    v36 = v15;
    _os_log_error_impl(&dword_23FA42000, v20, (os_log_type_t)0x90u, "[ERROR] Unable to get inode for %@: %@%@", buf, 0x20u);
  }
  BOOL v21 = 0;
  id v16 = v13;
LABEL_21:
...
void __48__BRCDatabaseBackupStorage_addRecordIfNotExist___block_invoke_cold_1(void *a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *a1;
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] Added record: %@%@", (void)v3, DWORD2(v3));
}
...
void __41__BRCDatabaseBackupStorage_flushAndClose__block_invoke_cold_1(id *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v14 = 2112;
  uint64_t v15 = a2;
  _os_log_error_impl(&dword_23FA42000, a3, (os_log_type_t)0x90u, "[ERROR] Could not create a unique index %@: %@%@", (uint8_t *)&v10, 0x20u);
}
...
- (void)docIDForURL:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to open %@%@", v4, v5, v6, v7, v8);
}
...
- (void)docIDForURL:.cold.2()
{
  ...
  uint64_t v1 = [v0 path];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] failed closing %@%@", v4, v5, v6, v7, v8);
}
...
- (void)updateAttachedDatabase
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] Not updating attached database because no database has been attached.%@", v1, 0xCu);
}
...
void __50__BRCDatabaseBackupStorage_updateAttachedDatabase__block_invoke_cold_1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] Successfully finished updating attach database batch: %@%@", (void)v3, DWORD2(v3));
}
...
void __50__BRCDatabaseBackupStorage_updateAttachedDatabase__block_invoke_cold_2(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] Beginning update attach database batch: %@%@", (void)v3, DWORD2(v3));
}
...
- (void)setForeignKeys:enabled:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to enable foreign keys: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)setForeignKeys:enabled:.cold.2()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to disable foreign keys: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)negateIDs:.cold.1()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when negating doc ids%@", v3, v4, v5, v6, v7);
}
...
- (void)negateIDs:.cold.2()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to negate doc ids: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)negateIDs:.cold.3()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when negating file ids%@", v3, v4, v5, v6, v7);
}
...
- (void)negateIDs:.cold.4()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to negate file ids: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)updateIDs:.cold.1()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when updating doc ids%@", v3, v4, v5, v6, v7);
}
...
- (void)updateIDs:.cold.2()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to update the doc ids: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)updateIDs:.cold.3()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when updating file ids%@", v3, v4, v5, v6, v7);
}
...
- (void)updateIDs:.cold.4()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to update the file ids: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)updateIDs:.cold.5()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when updating gen counts%@", v3, v4, v5, v6, v7);
}
...
- (void)updateIDs:.cold.6()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to update the gen count: %@%@", v4, v5, v6, v7, v8);
}

- (void)updateIDs:.cold.7()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Created doc_id_index%@", v2, v3, v4, v5, v6);
}
...
- (void)updateIDs:.cold.8()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to create doc_id_index, so updating will be incredibly slow: %@%@", v4, v5, v6, v7, v8);
}

- (void)updateIDs:.cold.9()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Created file_id_gen_count_index%@", v2, v3, v4, v5, v6);
}
...
- (void)updateIDs:.cold.10()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to create file_id_gen_count_index, so updating will be incredibly slow: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)clearStagedIDs:.cold.1()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when clearing the staged file ids%@", v3, v4, v5, v6, v7);
}
...
- (void)clearStagedIDs:.cold.2()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to update the staged file ids: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)clearStagedIDs:.cold.3()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Changed %lld items when clearing the staged generation ids%@", v3, v4, v5, v6, v7);
}

- (void)fixUpBackupDetector:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Patched the backup detector%@", v2, v3, v4, v5, v6);
}
...
- (void)fixUpBackupDetector:.cold.2()
{
  ...
  uint64_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_1_2(&dword_23FA42000, v2, v3, "[ERROR] Failed to update the backup detector value: %@%@", v4, v5, v6, v7, v8);
}
