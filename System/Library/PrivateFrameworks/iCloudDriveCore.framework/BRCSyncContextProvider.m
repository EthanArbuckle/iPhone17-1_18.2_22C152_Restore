...
- (id)defaultSyncContext
{
  return [(BRCSyncContextProvider *)self _syncContextForContextIdentifier:*MEMORY[0x263F324D8] isShared:0 createIfNeeded:1];
}

- (id)sharedMetadataSyncContext
{
  return [(BRCSyncContextProvider *)self _syncContextForContextIdentifier:*MEMORY[0x263F32528] isShared:1 createIfNeeded:1];
}

- (id)zoneHealthSyncContext
{
  return [(BRCSyncContextProvider *)self _syncContextForContextIdentifier:*MEMORY[0x263F32550] isShared:0 createIfNeeded:1];
}

- (id)sideCarSyncContext
{
  return [(BRCSyncContextProvider *)self _syncContextForContextIdentifier:*MEMORY[0x263F327C8] isShared:0 createIfNeeded:1];
}
      ...
      do
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 134218498;
          ...
          __int16 v35 = 2112;
          v36 = v10;
          _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cancelling %@...%@", buf, 0x20u);
        }
      ...
      do
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 134218498;
          ...
          __int16 v35 = 2112;
          v36 = v17;
          _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx closing %@...%@", buf, 0x20u);
        }
