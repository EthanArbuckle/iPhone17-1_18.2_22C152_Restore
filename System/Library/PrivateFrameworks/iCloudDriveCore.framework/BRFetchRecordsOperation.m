    ...
    if (v12 < v14)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v36 = v15;
        _os_log_impl(&dword_23FA42000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] Batch operatoin completed but some records were not handled by perRecordCompletionBlock%@", buf, 0xCu);
      }

      v17 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F32360] code:149 userInfo:0];
      long long v30 = 0u;
      long long v31 = 0u;
      long long v32 = 0u;
      long long v33 = 0u;
...
- (void)setFetchRecordsCompletionBlock:(id)a3
{
  objc_super v4 = (void *)MEMORY[0x2455D9A50](a3, a2);
