...
- (BRCSharingCopyAccessTokenOperation)initWithItem:(id)a3 sessionContext:(id)a4
{
  ...
  if (v10)
  {
    ...
    v12 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initShareIDWithShareableItem:v6];
    [(BRCSharingCopyAccessTokenOperation *)v10 setShareID:v12];

    [(_BRCOperation *)v10 setNonDiscretionary:1];
    v13 = objc_msgSend(MEMORY[0x263EFD780], "br_sharingMisc");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sharing/access-token", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  v11[0] = v4;
  v5 = [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:1];
  id v6 = (void *)[v3 initWithRecordIDs:v5];

  uint64_t v7 = *MEMORY[0x263EFD598];
  v10[0] = *MEMORY[0x263EFD4E0];
  v10[1] = v7;
...
void __42__BRCSharingCopyAccessTokenOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v11 = [v10 objectForKeyedSubscript:*MEMORY[0x263EFD4E0]];

  uint64_t v12 = [v9 objectForKeyedSubscript:*MEMORY[0x263EFD598]];
  v13 = (void *)v12;
  if (!v5 && !v11 && v12 == 0)
  {
  ...
  if (!v5)
  {
    if (v11)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: encrypted access token %@ is of unexpected type", v11);
        goto LABEL_23;
      }
    }
  }
  if (!v5 && v13)
  {
    ...
    objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: reference identifier %@ is of unexpected type", v13);
LABEL_23:
    id v5 = (id)objc_claimAutoreleasedReturnValue();
    id v15 = 0;
    if (v5) {
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: reference identifier %@ is of unexpected type%@");
}

void __42__BRCSharingCopyAccessTokenOperation_main__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: encrypted access token %@ is of unexpected type%@");
}
