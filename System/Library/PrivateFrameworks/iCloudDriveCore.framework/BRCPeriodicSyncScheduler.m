  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v36 = 2112;
      v37 = v10;
      _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Creating %@%@", buf, 0x20u);
    }
    ...
    uint64_t v18 = [(BRCAccountSessionFPFS *)v9->_session personaIdentifier];
    ...
    *(_WORD *)&v9->_shouldTriggerPeriodicSync = 0;
    ...
    uint64_t v25 = [MEMORY[0x263EFF910] now];
...
- (void)_registerToNotifications
{
  ...
  v3 = objc_msgSend((id)*MEMORY[0x263F32308], "br_libnotifyPerPersonaNotificationName:", self->_personaIdentifier);
...
- (void)resume
{
  id v3 = [(BRCAccountSessionFPFS *)self->_session clientTruthWorkloop];
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
    ...
    *(unsigned char *)(*(void *)(a1 + 32) + 35) = *(unsigned char *)(a1 + 40);
    ...
    if (v13 >= v14)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v15;
        _os_log_debug_impl(&dword_23FA42000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Network disconnected for %.1f mins --> Assume missing push%@", (uint8_t *)&v18, 0x20u);
      }
...
LABEL_10:
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v17 = 2112;
        int v18 = v10;
        _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - User did not use iCloud Drive for %.1f mins --> trigger periodic sync%@", buf, 0x20u);
      }
    }
...
- (void)_schedulePeriodicSyncRequest
{
    ...
    && !self->_periodicSyncRequestTimer)
  {
    ...
    v46[2] = v18;
    uint64_t v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v46 count:3];

    __int16 v20 = objc_msgSend(v19, "br_maxWithComparator:", *MEMORY[0x263F32758]);
    [v20 doubleValue];
    double v22 = v21;
    ...
    {
      uint64_t v23 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x263EF8400], 0, 0, (dispatch_queue_t)self->_syncQueue);
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138413058;
        ...
        __int16 v44 = 2112;
        v45 = v34;
        _os_log_debug_impl(&dword_23FA42000, v35, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - scheduled _periodicSyncRequestTimer %@ in %llu sec%@", buf, 0x2Au);
      }
    }
  }
}
...
- (void)_cancelPeriodicSyncRequestScheduler
{
  ...
  if (self->_periodicSyncRequestTimer)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v11 = 2112;
      double v12 = v3;
      _os_log_debug_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - cancelling periodicSyncRequestTimer %@%@", (uint8_t *)&v7, 0x20u);
    }
...
- (void)_tiggerPeriodicSync
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@: Periodic sync already running%@", v1, 0x16u);
}

void __47__BRCPeriodicSyncScheduler__tiggerPeriodicSync__block_invoke(uint64_t a1)
{
  uint64_t v2 = *(void **)(*(void *)(a1 + 32) + 8);
  id v3 = objc_msgSend(MEMORY[0x263EFD780], "br_syncDownPeriodic");
  v4[0] = MEMORY[0x263EF8330];
  v4[1] = 3221225472;
...
- (void)_periodicSyncCompletionWithError:(id)a3
{
  ...
  id v4 = a3;
  double v5 = [(BRCAccountSessionFPFS *)self->_session clientDB];
  [v5 assertOnQueue];
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v21 = 2112;
    double v22 = v9;
    _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - persist last periodic sync date: %@%@", buf, 0x20u);
  }

  __int16 v11 = [(BRCAccountSessionFPFS *)self->_session clientState];
  [v11 setObject:v8 forKeyedSubscript:@"periodicSyncDate"];

  double v12 = [(BRCAccountSessionFPFS *)self->_session clientDB];
  [v12 forceBatchStart];
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Failed to adopt persona: %@%@");
}
...
void __34__BRCPeriodicSyncScheduler_resume__block_invoke_cold_1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(*(void *)a1 + 40);
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] Last periodic sync date: %@%@", (void)v3, DWORD2(v3));
}
...
void __34__BRCPeriodicSyncScheduler_resume__block_invoke_9_cold_1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 32);
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] %@ - try trigger periodic sync on startup%@", (void)v3, DWORD2(v3));
}
...
void __79__BRCPeriodicSyncScheduler__appLibraryDidBoostForPresenterNotificationHandler___block_invoke_cold_1(void *a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] %@ - long time since last periodic sync --> trigger periodic sync%@", (void)v3, DWORD2(v3));
}

- (void)_periodicSyncCompletionWithError:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Periodic sync failed with: %@%@");
}
