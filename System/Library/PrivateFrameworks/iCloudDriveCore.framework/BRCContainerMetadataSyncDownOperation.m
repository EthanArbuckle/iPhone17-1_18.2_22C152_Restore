...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sync-down/container-metadata", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)performAfterCreatingZoneIfNeeded:(id)a3
{
  ...
  else
  {
    ...
    id v7 = objc_msgSend(MEMORY[0x263EFD808], "brc_containerMetadataZoneID");
...
- (void)performAfterFetchingRecordChanges:(id)a3
{
  ...
  id v12 = objc_alloc(MEMORY[0x263EFD6B8]);
  v59[0] = v5;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v59 count:1];
  v57 = v5;
  v58 = v6;
  v14 = [NSDictionary dictionaryWithObjects:&v58 forKeys:&v57 count:1];
  ...
  [v17 setSourceApplicationBundleIdentifier:*MEMORY[0x263F324D8]];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v56 = v18;
    _os_log_debug_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx starting fetch container-metadata changes operation %@%@", buf, 0x20u);
  }
  ...
  *(void *)&buf[16] = 0x2020000000;
  ...
  objc_msgSend(MEMORY[0x263EFF980], "arrayWithObjects:", @"infoPlist", 0, v31, v32, v33, v34);
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingRecordChanges___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v68 = 2112;
    v69 = v4;
    _os_log_debug_impl(&dword_23FA42000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got container-metadata changes for %@ keys:%@ changeTag:%@ modified:%@%@", buf, 0x3Eu);
  }
  v6 = [v3 recordID];
  uint64_t v46 = [v6 recordName];

  id v7 = (void *)v46;
  if ([MEMORY[0x263F325E0] validateContainerID:v46])
  {
    char v54 = 0;
    uint64_t v45 = (void *)[objc_alloc(MEMORY[0x263F325E0]) initWithAppLibraryName:v46];
...
LABEL_19:
    ...
    {
      id v53 = 0;
      long long v44 = objc_msgSend(MEMORY[0x263F08AC0], "propertyListWithData:options:format:error:", v12, 0, 0, &v53, v12);
      id v13 = v53;
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412802;
          ...
          _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] received container-metadata properties plist %@ for %@%@", buf, 0x20u);
        }

        if (![MEMORY[0x263F32588] isDocumentScopePublicWithProperties:v44 mangledID:v45])
        {
          uint64_t v17 = 1;
          goto LABEL_15;
        }
              ...
              if ((v27 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)buf = 138412802;
                  ...
                  __int16 v62 = 2112;
                  uint64_t v63 = v17;
                  _os_log_debug_impl(&dword_23FA42000, v28, OS_LOG_TYPE_DEBUG, "[DEBUG] we'll download icon %@ for container %@%@", buf, 0x20u);
                }
...
LABEL_15:
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            _os_log_debug_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] updating container-metadata %@ at etag:%@ (no asset downloaded)%@", buf, 0x20u);
          }
...
LABEL_14:
      ...
      if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        _os_log_error_impl(&dword_23FA42000, v16, (os_log_type_t)0x90u, "[ERROR] failed parsing container-metadata plist for container %@: %@%@", buf, 0x20u);
      }
    }
    else
    {
  ...
  *(unsigned char *)(*(void *)(*(void *)(a1 + 56) + 8) + 24) = 1;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v42 = 2112;
    v43 = v15;
    _os_log_debug_impl(&dword_23FA42000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx container-metadata receieved server change token %@, caught-up:%s client change token %@ error:%@%@", buf, 0x3Eu);
  }
...
- (void)performAfterFetchingAssetContents:(id)a3
{
  ...
  id v4 = a3;
  v5 = (void *)[objc_alloc(MEMORY[0x263EFD6D8]) initWithRecordIDs:self->_recordIDsForDesiredAssets];
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v7;
    _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx adding sub-operation to fetch asset contents: %@ for records: %@%@", buf, 0x2Au);
  }
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v39 = 2112;
    __int16 v40 = v10;
    _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx per record callback: %@ - %@%@", buf, 0x2Au);
  }

  if (objc_msgSend(v9, "brc_isCloudKitUnknownItemError"))
  {
    id v12 = *(void **)(*(void *)(a1 + 32) + 504);
    id v13 = objc_alloc(MEMORY[0x263F325E0]);
    id v14 = [v8 zoneID];
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v37 = 2112;
        id v38 = v25;
        _os_log_debug_impl(&dword_23FA42000, v26, OS_LOG_TYPE_DEBUG, "[DEBUG] updating container metadata %@ at etag:%@ (after asset download)%@", buf, 0x20u);
      }
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke_30(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v19 = 2112;
    id v20 = v7;
    _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx finished %@%@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEFAULT, "[NOTICE] fetched %lu containers metadata from the cloud - %@%@", buf, 0x20u);
  }
...
uint64_t __83__BRCContainerMetadataSyncDownOperation__completedWithServerChangeToken_requestID___block_invoke(void *a1)
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v27 = 2112;
    id v28 = v13;
    _os_log_debug_impl(&dword_23FA42000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] remembering container-metadata server change token %@ requestID %llu%@", buf, 0x20u);
  }
...
LABEL_9:
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v18 = 2112;
      long long v19 = v8;
      _os_log_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Sync up of app library container metdata failed for %@ because requestIDs differ %lld vs %lld%@", (uint8_t *)&v12, 0x2Au);
    }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx Sync: syncing down container metadata%@");
}
...
void __45__BRCContainerMetadataSyncDownOperation_main__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    char v5 = objc_msgSend(v7, "brc_checkErrorsFromCloudKit:", &__block_literal_global_23);
    id v6 = v7;
    if ((v5 & 1) == 0)
    {
LABEL_3:
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] containerID %@ had no properties plist%@");
}

void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingRecordChanges___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┳%llx finished operation%@");
}
...
void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] unknown container %@%@", v1, 0x16u);
}

void __75__BRCContainerMetadataSyncDownOperation_performAfterFetchingAssetContents___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] got asset contents for %@%@");
}

void __83__BRCContainerMetadataSyncDownOperation__completedWithServerChangeToken_requestID___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Sync up of app library container metdata succeeded for %@%@");
}
