...
- (BRCUserDefaults)defaults
{
  ...
  {
    v3 = (void *)[objc_alloc(MEMORY[0x263F325E0]) initWithAppLibraryName:self->_contextIdentifier];
...
- (BRCSyncContext)initWithSession:(id)a3 contextIdentifier:(id)a4 isShared:(BOOL)a5
{
  ...
  if (v19)
  {
    ...
    v47 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x263F08A48]);
    ...
    v49 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x263F08A48]);
    ...
    v66 = (NSMutableSet *)objc_alloc_init(MEMORY[0x263EFF9C0]);
    ...
    uint64_t v74 = [MEMORY[0x263F088B0] weakObjectsHashTable];
...
void __61__BRCSyncContext_initWithSession_contextIdentifier_isShared___block_invoke(id *a1, uint64_t a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v26 = 2112;
    v27 = v10;
    _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Uploader: preparing next batch for %@ (max-count:%ld size:%@ priority:%ld)%@", buf, 0x3Eu);
  }
  v12 = [a1[5] fsUploader];
...
void __61__BRCSyncContext_initWithSession_contextIdentifier_isShared___block_invoke_37(id *a1, uint64_t a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v26 = 2112;
    v27 = v10;
    _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Downloader: preparing next batch for %@ (max-count:%ld size:%@ priority:%ld)%@", buf, 0x3Eu);
  }
...
+ (id)_createCKContainerForAccountID:(id)a3 contextIdentifier:(id)a4
{
  id v5 = (objc_class *)MEMORY[0x263EFD620];
  id v6 = a4;
  id v7 = a3;
  id v8 = [v5 alloc];
  uint64_t v9 = 1;
  id v10 = (void *)[v8 initWithContainerIdentifier:*MEMORY[0x263F324C8] environment:1];
  v11 = objc_opt_new();
  v12 = (void *)[objc_alloc(MEMORY[0x263EFD5C8]) initWithAccountID:v7];
  ...
  if (v15)
  {
    id v16 = objc_alloc(MEMORY[0x263EFD668]);
    uint64_t v17 = (void *)[v16 initWithLevel:2 name:*MEMORY[0x263F323C0] value:*MEMORY[0x263F323C8]];
    [v13 addObject:v17];
  ...
  __int16 v18 = +[BRCDaemonFPFS daemon];
  ...
  [v19 setSourceApplicationSecondaryIdentifier:*MEMORY[0x263F32390]];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: [[[UMUserManager sharedManager] br_currentPersonaID] isEqualToString:_session.personaIdentifier]%@", v2, v3, v4, v5, v6);
}
            ...
            if ((objc_msgSend(v14, "isFinished", obj) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
              {
                *(_DWORD *)buf = 138412802;
                ...
                __int16 v40 = 2112;
                uint64_t v41 = v15;
                _os_log_debug_impl(&dword_23FA42000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] Cancelling discretionary operation %@ to make room for a non discretionary operation %@%@", buf, 0x20u);
              }
          ...
          for (uint64_t j = 0; j != v18; ++j)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v40 = 2112;
              uint64_t v41 = v22;
              _os_log_debug_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Blocking discretionary op %@ on %@%@", buf, 0x20u);
            }
...
LABEL_10:
    ...
    if (v23)
    {
      ...
      [v29 setSourceApplicationBundleIdentifier:*MEMORY[0x263F32390]];
    }
    else
    {
      contextIdentifier = self->_contextIdentifier;
      ...
      [v27 setSourceApplicationSecondaryIdentifier:*MEMORY[0x263F32390]];
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v59 = 2112;
    v60 = v32;
    _os_log_debug_impl(&dword_23FA42000, v33, OS_LOG_TYPE_DEBUG, "[DEBUG] scheduling %@ on %@ (account %@)%@", buf, 0x2Au);
  }
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
  ...
  {
    id v42 = v8;
    uint64_t v43 = [(BRCAccountSessionFPFS *)self->_session accountWaitOperation];
    if (v43) {
...
- (void)resume
{
  ...
  if ([v3 isEqualToString:*MEMORY[0x263F32460]])
  {
  }
  else
  {
    BOOL v4 = [(BRCSyncContext *)self contextIdentifier];
    int v5 = [v4 isEqualToString:*MEMORY[0x263F324D8]];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _isCancelled%@", v2, v3, v4, v5, v6);
}
    ...
    *(void *)(*(void *)(a1 + 32) + 80) = 1;
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v28 = 2112;
      long long v29 = v6;
      _os_log_debug_impl(&dword_23FA42000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] beginning forced foreground for %@ for %.1fs%@", buf, 0x20u);
    }

    uint64_t v8 = dispatch_source_create(MEMORY[0x263EF8400], 0, 0, *(dispatch_queue_t *)(*(void *)(a1 + 32) + 72));
    ...
    {
      char v16 = ((void (*)(void *))*MEMORY[0x263F32768])(v14);
    }
...
- (void)addForegroundClient:(id)a3
{
  ...
  if (self->_isShared)
  {
    uint64_t v5 = [(BRCAccountSessionFPFS *)self->_session syncContextProvider];
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 2112;
    char v16 = v9;
    _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Added %@ as a foreground client%@", (uint8_t *)&v11, 0x20u);
  }
...
- (void)removeForegroundClient:(id)a3
{
  ...
  if (self->_isShared)
  {
    uint8_t v6 = [(BRCAccountSessionFPFS *)self->_session syncContextProvider];
  ...
  if ([(NSMutableSet *)v8->_foregroundClients containsObject:v4])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v15 = 2112;
      char v16 = v9;
      _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Removed %@ as a foreground client%@", (uint8_t *)&v11, 0x20u);
    }
...
void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&location[4] = v24;
    ...
    __int16 v34 = 2112;
    BOOL v35 = v9;
    _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] beginning foreground grace period for %@ from %@ for %.1fs%@", location, 0x2Au);
  }

  int v11 = dispatch_source_create(MEMORY[0x263EF8400], 0, 0, *(dispatch_queue_t *)(*(void *)(a1 + 32) + 72));
  ...
  if (*MEMORY[0x263F32768])
  {
    long long v19 = ((void (*)(void *))*MEMORY[0x263F32768])(v17);
  }
...
void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke_88(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (!v8)
    {
      ...
      int64_t v9 = [MEMORY[0x263F08A00] defaultCenter];
...
- (void)initWithSession:(void *)a1 contextIdentifier:isShared:.cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_4_3(&dword_23FA42000, v1, v2, "[CRIT] UNREACHABLE: Trying to create a sync context while downloadsDeadlineScheduler still missing. Session open: %d%@", v3, v4, v5, v6, v7);
}
...
- (void)initWithSession:(void *)a1 contextIdentifier:isShared:.cold.2(void *a1)
{
  [a1 isOpen];
  OUTLINED_FUNCTION_3_2();
  OUTLINED_FUNCTION_4_3(&dword_23FA42000, v1, v2, "[CRIT] UNREACHABLE: Trying to create a sync context while uploadsDeadlineScheduler still missing. Session open: %d%@", v3, v4, v5, v6, v7);
}
...
- (void)addOperation:(uint64_t)a1 allowsCellularAccess:nonDiscretionary:.cold.1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  ...
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v1, v2, "[CRIT] UNREACHABLE: missing group for %@%@", (void)v3, DWORD2(v3));
}

- (void)addOperation:allowsCellularAccess:nonDiscretionary:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: database%@", v2, v3, v4, v5, v6);
}

void __54__BRCSyncContext_forceContainerForegroundForDuration___block_invoke_83_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self->_foregroundState == BRCContainerForegroundStateForcedForeground%@", v2, v3, v4, v5, v6);
}
...
void __54__BRCSyncContext_forceContainerForegroundForDuration___block_invoke_83_cold_2(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 32);
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] forced foreground grace period over for %@%@", (void)v3, DWORD2(v3));
}

void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: there should be no timer created%@", v2, v3, v4, v5, v6);
}
...
void __63__BRCSyncContext__armForegroundGraceTimerForClientDescription___block_invoke_88_cold_1()
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = v1;
  _os_log_debug_impl(&dword_23FA42000, v2, OS_LOG_TYPE_DEBUG, "[DEBUG] grace period over for %@ %@%@", v3, 0x20u);
}
...
void __52__BRCSyncContext__notifyContainerBeingNowForeground__block_invoke_cold_1(void *a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] Cancelling foreground grace timer for %@ because we're now foreground again%@", (void)v3, DWORD2(v3));
}
