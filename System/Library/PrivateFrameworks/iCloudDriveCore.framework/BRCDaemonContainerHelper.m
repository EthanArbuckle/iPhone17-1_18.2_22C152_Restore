...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] About to compute the enabled and disabled bundle IDs via TCC%@", v2, v3, v4, v5, v6);
}
...
- (BOOL)cloudSyncTCCDisabledForContainerMeta:(id)a3
{
  ...
  char v6 = [v5 isEqualToString:*MEMORY[0x263F324E8]];
...
LABEL_35:
        _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, v14, (uint8_t *)&v62, 0x16u);
        goto LABEL_36;
      }
      goto LABEL_36;
    }
...
LABEL_36:
    ...
    if ([v8 isSharedToMeTopLevelItem] && objc_msgSend(v9, "isInTrashScope"))
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v64 = 2112;
        v65 = v12;
        _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] Error trying to move shared top item %@ into trash%@", (uint8_t *)&v62, 0x16u);
      }
...
LABEL_38:
      ...
      uint32_t v20 = 22;
LABEL_25:
      _os_log_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEFAULT, v18, (uint8_t *)&v62, v20);
      goto LABEL_26;
    }
...
LABEL_110:
            _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, v21, (uint8_t *)&v62, 0x20u);
            goto LABEL_111;
          }
          goto LABEL_111;
        }
...
LABEL_85:
            ...
            if (([v9 isSharedToMe] & 1) != 0 || objc_msgSend(v9, "isSharedByMe"))
            {
              ...
              if (v46)
              {
                ...
                if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  __int16 v66 = 2112;
                  v67 = v12;
                  _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] Moving item with a shared child %@ into a share with parent %@%@", (uint8_t *)&v62, 0x20u);
                }
            ...
            if ([v9 isInTrashScope])
            {
              ...
              if (v55)
              {
                ...
                if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  __int16 v66 = 2112;
                  v67 = v12;
                  _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] Moving an item with a shared child %@ into trash at parent %@%@", (uint8_t *)&v62, 0x20u);
                }
        ...
        objc_msgSend(MEMORY[0x263EFD7E8], "brc_fetchShareIDWithSharedItem:", v8);
        v12 = (char *)objc_claimAutoreleasedReturnValue();
        id v13 = objc_msgSend(MEMORY[0x263EFD7E8], "brc_fetchShareIDWithSharedItem:", v9);
        if (!v13
          || ([v12 recordName],
              ...
              (v25 & 1) == 0))
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
          {
            ...
            __int16 v66 = 2112;
            v67 = v26;
            _os_log_impl(&dword_23FA42000, v27, OS_LOG_TYPE_DEFAULT, "[WARNING] Moving item %@ into a different share with parent %@%@", (uint8_t *)&v62, 0x20u);
          }
...
LABEL_78:
            ...
            if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
            {
              ...
              __int16 v66 = 2112;
              v67 = v43;
              _os_log_impl(&dword_23FA42000, v44, OS_LOG_TYPE_DEFAULT, "[WARNING] Moving item %@ into another shared item %@%@", (uint8_t *)&v62, 0x20u);
            }
            unsigned __int16 v17 = 128;
          }
...
LABEL_59:
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
          {
            ...
            __int16 v66 = 2112;
            v67 = v12;
            _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] We need to download item %@ which is moving in or out of a shared zone to parent %@%@", (uint8_t *)&v62, 0x20u);
          }
...
LABEL_106:
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
          {
            ...
            _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] We need to download item %@ which is crossing zone boundaries to %@%@", (uint8_t *)&v62, 0x20u);
          }
          else
          {
            unsigned __int16 v17 = 32;
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        uint32_t v49 = 12;
LABEL_100:
        _os_log_impl(&dword_23FA42000, v48, OS_LOG_TYPE_DEFAULT, v47, (uint8_t *)&v62, v49);
      }
    }
    unsigned __int16 v17 = 256;
    goto LABEL_37;
  }
  objc_msgSend(MEMORY[0x263F087E8], "br_errorWithPOSIXCode:", 20);
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v68 = 2112;
      v69 = v15;
      _os_log_debug_impl(&dword_23FA42000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] %s: %s error: %@%@", (uint8_t *)&v62, 0x2Au);
    }
  }
  if (a6)
  {
...
- (unsigned)br_capabilityToMoveFromURL:(id)a3 toNewParent:(id)a4 error:(id *)a5
{
  ...
  if (a5)
  {
    objc_msgSend(MEMORY[0x263F087E8], "brc_errorNotSupportedInFPFS");
...
- (void)cloudSyncTCCDisabledForContainerMeta:(NSObject *)a3 .cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v8 = 2112;
  uint64_t v9 = a2;
  _os_log_debug_impl(&dword_23FA42000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ is disabled by TCC%@", (uint8_t *)&v6, 0x16u);
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Allowing server-side asset copy for subitem moving %@%@");
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Allowing server-side asset copy for shared folder transfer for %@%@");
}

- (void)br_capabilityToMoveFromLocalItem:toNewParent:session:error:.cold.7()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Allowing server-side asset copy for %@%@");
}

- (void)br_capabilityToMoveFromURL:toNewParent:error:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: br_capabilityToMoveFromURL is not supported in FPFS%@", v2, v3, v4, v5, v6);
}

- (void)itemIDForURL:error:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: can't get an itemID from a URL inside the daemon%@", v2, v3, v4, v5, v6);
}
