...
- (NSUUID)operationID
{
  v2 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDBytes:self->_operationUUID];
  return (NSUUID *)v2;
}
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v54 = 2112;
      v55 = v36;
      _os_log_debug_impl(&dword_23FA42000, v37, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx creating operation %@%@", buf, 0x20u);
    }

    long long v38 = v47;
    *(void *)&v15->_logSections.line = v48;
    *(_OWORD *)&v15->_logSections.sectionID = v38;
    v39 = [MEMORY[0x263F841B0] sharedManager];
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "BRCOperation/? (subclass activity missing)", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)setGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v13 = 2112;
    v14 = v5;
    _os_log_debug_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx now using group: %@%@", buf, 0x20u);
  }
...
- (void)dealloc
{
  ...
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v2, (uint64_t)v2, "[DEBUG] ┳%llx dealloc%@", (uint8_t *)&v3);
}
...
- (BOOL)_finishIfCancelled
{
  ...
  if (v3)
  {
    id v4 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263EFD498] code:20 userInfo:0];
...
- (void)_scheduleExecutionWithPreviousError:(id)a3
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v61 = 2112;
    v62 = v16;
    _os_log_debug_impl(&dword_23FA42000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] throttle backoff: %03fs for hash:0x%016llx%@", buf, 0x20u);
  }
        ...
        !v20))
  {
    ...
    if (v27 == 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      v30 = v5;
      objc_sync_enter(v30);
      uint64_t v31 = [MEMORY[0x263EFF910] distantFuture];
    ...
    else if ((double)v27 / 1000000000.0 >= v5->_maxBackoff)
    {
      ...
      __int16 v52 = (void *)[v51 initWithDomain:*MEMORY[0x263F32360] code:23 userInfo:0];
      v53 = (void *)MEMORY[0x2455D97F0]();
    ...
    else if (v27)
    {
      ...
      v35 = v5;
      objc_sync_enter(v35);
      uint64_t v36 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:(double)v27 / 1000000000.0];
      v37 = v35->_nextTryDate;
      v35->_nextTryDate = (NSDate *)v36;

      objc_sync_exit(v35);
      long long v38 = [(_BRCOperation *)v35 callbackQueue];
      dispatch_source_t v39 = dispatch_source_create(MEMORY[0x263EF8400], 0, 0, v38);
      ...
      {
        long long v47 = ((void (*)(void *))*MEMORY[0x263F32768])(v45);
      }
  ...
  else
  {
    ...
    dispatch_queue_t v23 = (void *)MEMORY[0x2455D97F0]();
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: there should be a group created for %@%@");
}
...
- (void)cancel
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v39 = 2112;
    long long v40 = v3;
    _os_log_debug_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cancelling %@%@", buf, 0x20u);
  }
      ...
      for (uint64_t j = 0; j != v13; ++j)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v39 = 2112;
          long long v40 = v17;
          _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Removed %@ as dependency of cancelled op %@%@", buf, 0x20u);
        }
      }
      uint64_t v13 = [v12 countByEnumeratingWithState:&v23 objects:v33 count:16];
    }
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v33 = 2112;
    v34 = v8;
    _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx finishing %@%@", buf, 0x20u);
  }
...
- (void)_completedWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219522;
    ...
    unint64_t sectionID = logSections.sectionID;
    __int16 v28 = 2112;
    id v21 = &stru_26F3822F0;
    long long v29 = &stru_26F3822F0;
    uint64_t v22 = @"\nwith error: ";
    if (!v7) {
      uint64_t v22 = &stru_26F3822F0;
    }
    __int16 v30 = 2112;
    if (v7) {
      id v21 = v7;
    ...
    __int16 v38 = 2112;
    __int16 v39 = v8;
    _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx %@%@ %@%@%@%@", buf, 0x48u);
  }
  ...
  if (![(_BRCOperation *)self _finishIfCancelled])
  {
    ...
    if ([(__CFString *)v7 brc_isDenylistError])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v28 = 2112;
        long long v29 = v11;
        _os_log_impl(&dword_23FA42000, v12, OS_LOG_TYPE_DEFAULT, "[WARNING] We are denylisted! Not notifying about finishing %@%@", buf, 0x16u);
      }
    ...
    uint64_t v19 = (void *)MEMORY[0x2455D97F0]();
  ...
  if ((BRCurrentPersonaMatchesID() & 1) == 0)
  {
      ...
      || (uint64_t v13 = self->_personaID) == 0)
    {
      if (completedWithResult_error____personaOnceToken != -1) {
        dispatch_once(&completedWithResult_error____personaOnceToken, &__block_literal_global_1);
      }
    ...
    uint64_t v16 = [MEMORY[0x263F841B0] sharedManager];
    ...
    else
    {
      ...
      else
      {
        if (!v15 || ([v17 isDataSeparatedPersona] & 1) != 0)
        {
          ...
          BOOL v20 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F08438] code:22 userInfo:0];
          goto LABEL_14;
        }
        long long v29 = brc_bread_crumbs();
        __int16 v30 = brc_default_log();
      ...
      if ((objc_opt_isKindOfClass() & 1) != 0 && ([v4 nonDiscretionary] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v12 = 2112;
          id v13 = v5;
          _os_log_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Adding discretionary op %@ as a dependency of a non-discretionary op %@%@", buf, 0x20u);
        }
      }
    }
  }
  ...
  if (([(_BRCOperation *)self isCancelled] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&location[4] = v17;
      ...
      __int16 v30 = 2112;
      __int16 v31 = v5;
      _os_log_debug_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] Blocking %@ on high priority operation %@%@", location, 0x20u);
    }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 134218498;
          ...
          __int16 v31 = 2112;
          uint64_t v32 = v9;
          _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Launching timeout timer of %llu seconds for operation %@%@", buf, 0x20u);
        }
        dispatch_time_t v11 = dispatch_time(0, v8);
        dispatch_source_t v12 = dispatch_source_create(MEMORY[0x263EF8400], 0, 0, 0);
        ...
        if (*MEMORY[0x263F32768])
        {
          id v20 = ((void (*)(void *))*MEMORY[0x263F32768])(v18);
        }
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self.finished%@", v2, v3, v4, v5, v6);
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] throttle backoff is greater than max.  Failing the operation%@", v1, 0xCu);
}

- (void)_scheduleExecutionWithPreviousError:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] %@ has been denylisted and won't be attempted again%@");
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.3()
{
  ...
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, v1, "[DEBUG] attempting execution again in %.03fs%@", v2);
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.4()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] cancelling operation since reached to maximal allowed backoff%@", v1, 0xCu);
}
...
- (void)_scheduleExecutionWithPreviousError:.cold.5()
{
  uint64_t v3 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, v1, "[DEBUG] server provided backoff: %.03fs%@", v2);
}

- (void)_completedWithResult:error:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _operationFailureThrottle%@", v2, v3, v4, v5, v6);
}
...
- (void)_completedWithResult:error:.cold.2()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, (uint64_t)v0, "[DEBUG] CloudKit account is temporarily unavailable. Invalidating account status after %@%@", v1);
}

- (void)completedWithResult:error:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] won't restore persona: %@%@");
}
...
- (void)completedWithResult:error:.cold.2()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Not allowed to adopt persona - should fallback persona%@", v1, 0xCu);
}
...
- (void)completedWithResult:error:.cold.3()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Not allowed to adopt persona but data-separatedness matches%@", v1, 0xCu);
}

- (void)completedWithResult:error:.cold.4()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] Completed operation %@ with different persona than we started with%@");
}

- (void)addSubOperation:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: _syncContext%@", v2, v3, v4, v5, v6);
}

- (void)cancelAfterDelay:(uint64_t)a3 .cold.1(void *a1, uint64_t a2, uint64_t a3)
{
  OUTLINED_FUNCTION_7((uint64_t)a1, a2, a3, 5.778e-34);
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v6, v4, "[DEBUG] Timeout already expired, cancelling operation %@%@", v5);
}
