...
LABEL_24:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v170[4] = 2112;
    *(void *)&v170[6] = v19;
    _os_log_debug_impl(&dword_23FA42000, v20, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Sync: syncing up clientZone %@. batch size - %u%@", buf, 0x26u);
  }

  unint64_t v21 = v17;
  v137 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:v17];
  v22 = [v140 mangledID];
  ...
  v29 = (NSMutableArray *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:v21];
  ...
  v33 = (NSMutableArray *)objc_alloc_init(MEMORY[0x263EFF980]);
  createdAppLibraryNames = self->_createdAppLibraryNames;
  self->_createdAppLibraryNames = v33;

  v35 = (NSMutableOrderedSet *)objc_alloc_init(MEMORY[0x263EFF9B0]);
  ...
  v41 = (NSMutableArray *)objc_alloc_init(MEMORY[0x263EFF980]);
  ...
  v47 = (NSMutableDictionary *)objc_alloc_init(MEMORY[0x263EFF9A0]);
          ...
          if ((v65 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v67, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = 138412546;
              ...
              _os_log_debug_impl(&dword_23FA42000, v67, OS_LOG_TYPE_DEBUG, "[DEBUG] ignoring item with negative cost for now %@%@", buf, 0x16u);
            }
          }
          int v59 = 14;
        }
  ...
  if (v69)
  {
    ...
    do
    {
      ...
      for (uint64_t j = 0; j != v144; ++j)
      {
        ...
        v72 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initShareIDWithShareableItem:v71];
  ...
  if (self->_itemNeedingBasehashSalting || self->_itemNeedingPCSChaining)
  {
    ...
    if (os_log_type_enabled(v87, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v169 = 2112;
      *(void *)v170 = v86;
      _os_log_debug_impl(&dword_23FA42000, v87, OS_LOG_TYPE_DEBUG, "[DEBUG] Dedicating this sync up operation to %@ %@%@", buf, 0x20u);
    }
    ...
    || v84->_itemNeedingBasehashSalting)
  {
    ...
    if (os_log_type_enabled(v117, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&v170[10] = v126;
      ...
      __int16 v175 = 2112;
      v176 = v116;
      _os_log_debug_impl(&dword_23FA42000, v117, OS_LOG_TYPE_DEBUG, "[DEBUG] preparing to send in requestID:%lld: %lu records, delete %lu recordIDs, unshare %lu iwork shares, rename %lu shares, about %lu items%@", buf, 0x48u);
    }
    ...
    if (os_log_type_enabled(v119, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v169 = 2112;
      *(void *)v170 = v118;
      _os_log_impl(&dword_23FA42000, v119, OS_LOG_TYPE_DEFAULT, "[NOTICE] sending %lu items to the cloud for %@\n%@", buf, 0x20u);
    }
    if (a4) {
      *a4 = 0;
    }
...
- (BRCSyncUpOperation)initWithZone:(id)a3 sessionContext:(id)a4 syncUpCallback:(id)a5
{
  ...
  v14 = [v9 ownerName];
  char v15 = [v14 isEqualToString:*MEMORY[0x263EFD488]];
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sync-up", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
void __80__BRCSyncUpOperation__performMetadataSaltingOperationIfNecessaryWithCompletion___block_invoke_2(uint64_t a1, int a2, int a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413314;
    ...
    __int16 v28 = 2112;
    v29 = v8;
    _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished metadata salting a batch for item %@ when completed: %d validation: %d error: %@%@", buf, 0x2Cu);
  }
...
void __73__BRCSyncUpOperation__performPCSChainOperationIfNecessaryWithCompletion___block_invoke_2(uint64_t a1, int a2, void *a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 67109890;
    ...
    __int16 v32 = 2112;
    v33 = v10;
    _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished PCS chaining a batch when completed: %d listOp: %@ error: %@%@", buf, 0x26u);
  }
...
- (void)_performModifyRecordsOrBatchOperationWithCompletion:(id)a3
{
  ...
  if (![(BRCSyncUpOperation *)self _performMetadataSaltingOperationIfNecessaryWithCompletion:v4]&& ![(BRCSyncUpOperation *)self _performPCSChainOperationIfNecessaryWithCompletion:v4])
  {
    ...
    {
      __int16 v30 = v6;
      id v9 = objc_alloc_init(MEMORY[0x263EFD748]);
      ...
      [v9 setSavePolicy:0];
      id v11 = [MEMORY[0x263EFF8F8] dataWithBytes:&self->_requestID length:8];
      ...
      id v14 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9A0]), "initWithCapacity:", -[NSMutableArray count](self->_recordsToSave, "count"));
      long long v41 = 0u;
      long long v42 = 0u;
      long long v43 = 0u;
      long long v44 = 0u;
      uint64_t v15 = self->_recordsToSave;
      ...
      if (v16)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v17; ++i)
          {
            ...
            id v21 = objc_msgSend(v20, "recordID", v27);
      ...
      char v24 = [v23 skipPerItemSyncUpThrottling];

      v33[0] = MEMORY[0x263EF8330];
      v33[1] = 3221225472;
      v33[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke;
      v33[3] = &unk_265082338;
      id v34 = v5;
      v35 = self;
      id v36 = v27;
      ...
      id v25 = v14;
      id v26 = v27;
      [v28 setPerRecordCompletionBlock:v33];
      v31[0] = MEMORY[0x263EF8330];
      v31[1] = 3221225472;
      v31[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_45;
      v31[3] = &unk_265082360;
      id v32 = v4;
      [v28 setModifyRecordsCompletionBlock:v31];
      [(_BRCOperation *)self addSubOperation:v28];
    }
    else
    {
...
void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5 && v6)
  {
    ...
    __brc_create_section(0, (uint64_t)"-[BRCSyncUpOperation _performModifyRecordsOrBatchOperationWithCompletion:]_block_invoke", 740, v49);
    uint64_t v8 = brc_bread_crumbs();
    id v9 = brc_default_log();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&uint8_t buf[4] = v30;
      ...
      __int16 v55 = 2112;
      v56 = v8;
      _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx sync-up error for record %@: %@%@", buf, 0x2Au);
    }
    id v10 = [*(id *)(a1 + 32) db];
    v40[0] = MEMORY[0x263EF8330];
    v40[1] = 3221225472;
    v40[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37;
    v40[3] = &unk_265082310;
    id v41 = v7;
    id v42 = v5;
    id v11 = *(id *)(a1 + 32);
  ...
  else if (v5)
  {
    ...
    if (v17)
    {
      ...
      if (([v21 isDocumentBeingCopiedToNewZone] & 1) == 0)
      {
        ...
        char v24 = objc_msgSend(v23, "br_pathExtension");
    ...
    v38 = [*(id *)(*(void *)(a1 + 40) + 256) bouncingAnalyzer];
    [v38 analyzeServerBouncingOriginalRecord:v37 savedRecord:v5];
  }
}
...
LABEL_21:
    ...
    || objc_msgSend(*(id *)(a1 + 32), "brc_isReferenceValidationError"))
  {
    ...
    if (v15 && ([v15 isNonDesktopRoot] & 1) == 0)
    {
      ...
      uint64_t v18 = [v17 itemByItemID:v16];
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "brc_containsCloudKitErrorCode:", 10))
  {
    ...
    id v29 = *(id *)(a1 + 48);
    uint64_t v30 = [v28 recordID];
    id v31 = [v29 session];
    id v32 = objc_msgSend(v30, "brc_itemIDWithSession:", v31);

    v33 = [v29 itemByItemID:v32];
    id v34 = [v29 mangledID];
    ...
    v106 = objc_msgSend(MEMORY[0x263EFD7E8], "brc_fetchShareIDWithSharedItem:", v33);
    char v105 = objc_msgSend(v106, "brc_shareItemID");
    uint64_t v36 = [v35 maxSyncPathDepth];
    id v37 = [v33 db];
    v38 = [v33 itemID];
    id v39 = [v29 dbRowID];
    char v40 = [v29 dbRowID];
    ...
    if (v105 && [v41 isEqualToItemID:v105])
    {
...
LABEL_29:
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v123 = 2112;
      uint64_t v124 = v50;
      _os_log_impl(&dword_23FA42000, v51, OS_LOG_TYPE_DEFAULT, "[WARNING] We changed share roots from %@ to %@ on %@ and got a permission error so behaving like an unknown item%@", buf, 0x2Au);
    }

    [v33 handleUnknownItemError];
    char v52 = [v33 saveToDB];
...
LABEL_30:
  if (objc_msgSend(*(id *)(a1 + 32), "brc_isCloudKitErrorRequiringAssetRescan"))
  {
    id v42 = *(void **)(a1 + 40);
    id v43 = *(id *)(a1 + 48);
    uint64_t v44 = [v42 recordID];
    id v45 = [v43 session];
    objc_msgSend(v44, "brc_itemIDWithSession:", v45);
    id v9 = (id)objc_claimAutoreleasedReturnValue();

    id v10 = [v43 itemByItemID:v9];
...
LABEL_20:
  ...
  if (objc_msgSend(*(id *)(a1 + 32), "brc_isCloudKitErrorRequiringAssetReupload"))
  {
  ...
  id v46 = *(void **)(a1 + 32);
  id v116 = 0;
  int v47 = objc_msgSend(v46, "brc_isCloudKitErrorUnsupportedOSForItemAndGetMinimumSupported:", &v116);
  id v27 = v116;
  if (v47)
  {
  ...
  char v48 = *(void **)(a1 + 32);
  id v115 = 0;
  int v49 = objc_msgSend(v48, "brc_isCloudKitErrorReparentedToNewParent:", &v115);
  id v26 = v115;
  if (v49)
  {
  ...
  v56 = *(void **)(a1 + 32);
  id v114 = 0;
  int v57 = objc_msgSend(v56, "brc_isCloudKitErrorRemappedToNewRecordName:", &v114);
  id v25 = v114;
  if (v57)
  {
  ...
  {
    float v58 = [*(id *)(a1 + 40) recordID];
    int v59 = [*(id *)(a1 + 48) session];
    objc_msgSend(v58, "brc_itemIDWithSession:", v59);
    id v60 = (id)objc_claimAutoreleasedReturnValue();

    v61 = [*(id *)(a1 + 48) itemByItemID:v60];
    ...
    v64 = *(void **)(a1 + 48);
    char v65 = *(void **)(*(void *)(a1 + 56) + 512);
    v66 = [v64 dbRowID];
    [v65 blockSyncUpCallback:v61 inZone:v66];
    goto LABEL_55;
  }
    ...
    || !objc_msgSend(*(id *)(a1 + 32), "brc_containsCloudKitInternalErrorCode:", 2040))
  {
          ...
          v71))
    {
      v72 = *(void **)(a1 + 32);
      id v107 = 0;
      int v73 = objc_msgSend(v72, "brc_isCloudKitShouldBeUsingEnhancedDrivePrivacyWithFieldName:", &v107);
      id v60 = v107;
      if (!v73)
      {
        ...
        {
          uint64_t v78 = brc_bread_crumbs();
          uint64_t v79 = brc_default_log();
          if (os_log_type_enabled(v79, OS_LOG_TYPE_DEBUG)) {
            __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_6();
          }
        }
        else
        {
          ...
          {
            id v88 = brc_bread_crumbs();
            uint64_t v89 = brc_default_log();
            if (os_log_type_enabled(v89, OS_LOG_TYPE_DEBUG)) {
              __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_7();
            }
          }
          else
          {
          ...
          BOOL v100 = [*(id *)(a1 + 40) parent];
          *(unsigned char *)(*(void *)(a1 + 56) + 520) = v100 != 0;
        }
        goto LABEL_94;
      }
      ...
      if (os_log_type_enabled(v75, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v121 = 2112;
        v122 = v74;
        _os_log_debug_impl(&dword_23FA42000, v75, OS_LOG_TYPE_DEBUG, "[DEBUG] Enabling server zone %@ to use enhanced drive privacy (fieldName %@)%@", buf, 0x20u);
      }

      v76 = *(void **)(a1 + 48);
      uint64_t v77 = 0x400000;
      goto LABEL_67;
    }
    v80 = [*(id *)(a1 + 40) recordID];
    v81 = [*(id *)(a1 + 48) session];
    objc_msgSend(v80, "brc_itemIDWithSession:", v81);
    id v60 = (id)objc_claimAutoreleasedReturnValue();

    v61 = [*(id *)(a1 + 48) itemByItemID:v60];
    v66 = [*(id *)(a1 + 48) serverItemByItemID:v60];
    if ([v61 isZoneRoot])
    {
      id v82 = 0;
    }
    else
    {
      ...
      uint64_t v91 = [v61 st];
      v92 = [v91 parentID];
      id v82 = [v90 serverItemByItemID:v92];

      if (v82 && ![v82 pcsChainState])
      {
        ...
        if (os_log_type_enabled(v103, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412290;
          v118 = v102;
          _os_log_impl(&dword_23FA42000, v103, OS_LOG_TYPE_DEFAULT, "[WARNING] Updating parent item to be chained because it is unknown and we encountered a PCS error%@", buf, 0xCu);
        }

        v104 = [*(id *)(a1 + 72) serverTruthWorkloop];
        v111[0] = MEMORY[0x263EF8330];
        v111[1] = 3221225472;
        v111[2] = __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_38;
        v111[3] = &unk_26507ED98;
        id v112 = *(id *)(a1 + 72);
        id v82 = v82;
        id v113 = v82;
        dispatch_async(v104, v111);

        v99 = v112;
        goto LABEL_98;
      }
    }
    if (!v66 || [v66 pcsChainState])
    {
      ...
      if (os_log_type_enabled(v94, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v119 = 2112;
        id v120 = v93;
        _os_log_impl(&dword_23FA42000, v94, OS_LOG_TYPE_DEFAULT, "[WARNING] Encountered an unknown pcs error for %@%@", buf, 0x16u);
      }
    ...
    if (os_log_type_enabled(v97, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v118 = v96;
      _os_log_impl(&dword_23FA42000, v97, OS_LOG_TYPE_DEFAULT, "[WARNING] Updating local item to be chained because it is unknown and we encountered a PCS error%@", buf, 0xCu);
    }

    v98 = [*(id *)(a1 + 72) serverTruthWorkloop];
    block[0] = MEMORY[0x263EF8330];
    block[1] = 3221225472;
...
LABEL_94:
  ...
  v67 = [*(id *)(a1 + 40) recordID];
  int v68 = objc_msgSend(v67, "brc_isZoneRootRecordID");

  if (!v68)
  {
    char v83 = [*(id *)(a1 + 40) recordID];
    int v84 = objc_msgSend(v83, "brc_isAppLibraryRootRecordID");

    if (!v84) {
      goto LABEL_22;
    }
    id v85 = *(void **)(a1 + 72);
    v86 = [*(id *)(a1 + 40) recordID];
    v87 = objc_msgSend(v86, "brc_appLibraryRootZoneName");
    id v60 = [v85 appLibraryByID:v87];

    v76 = v60;
    uint64_t v77 = 2;
LABEL_67:
    [v76 setStateBits:v77];
    goto LABEL_94;
  }
  if ([*(id *)(a1 + 48) isPrivateZone])
  {
    uint64_t v69 = [*(id *)(a1 + 48) asPrivateClientZone];
    v70 = [v69 defaultAppLibrary];
    [v70 setStateBits:2];
  }
LABEL_22:
}
    ...
    || [(NSMutableDictionary *)self->_renamedShareIDsToNames count])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v27 = 2112;
      __int16 v28 = iworkUnsharedShareIDs;
      __int16 v29 = 2112;
      uint64_t v30 = v7;
      _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetching share IDs shared by us for renames: %@ and unshare: %@%@", buf, 0x20u);
    }
    ...
    id v12 = objc_alloc(MEMORY[0x263EFD6D8]);
...
void __41__BRCSyncUpOperation_performShareUpdate___block_invoke(uint64_t a1, void *a2, void *a3)
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v62 = 2112;
        v63 = v9;
        _os_log_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] got an error while fetching the records and shares %@, but ignoring it%@", buf, 0x16u);
      }
    }
  }
  id v37 = v7;
  ...
  if (v45)
  {
    ...
    uint64_t v39 = *MEMORY[0x263EFD538];
    uint64_t v38 = *MEMORY[0x263F32480];
    id v40 = v5;
    uint64_t v41 = a1;
    uint64_t v42 = *MEMORY[0x263EFD510];
            ...
            if (v24)
            {
              ...
              do
              {
                for (uint64_t j = 0; j != v25; ++j)
                {
                  ...
                  __int16 v28 = *(void **)(*((void *)&v48 + 1) + 8 * j);
                  if ([v28 type] != 1) {
...
LABEL_28:
  ...
  if ([v11 count])
  {
    ...
    v33 = (void *)[objc_alloc(MEMORY[0x263EFD748]) initWithRecordsToSave:v11 recordIDsToDelete:0];
...
LABEL_6:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v7;
    _os_log_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] Got a permanent error %@ when fetching records and shares%@", (uint8_t *)&v11, 0x16u);
  }
  ...
  if (v17)
  {
    ...
    if ((v20 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
      {
        ...
        __int16 v34 = 2112;
        id v35 = v21;
        _os_log_fault_impl(&dword_23FA42000, v22, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Protection data mismatch between share and record being shared! (%@ vs %@)%@", (uint8_t *)&v30, 0x20u);
      }
      if (v7) {
...
LABEL_11:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v38 = 2112;
    uint64_t v39 = v23;
    _os_log_debug_impl(&dword_23FA42000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] updated content record %@ with protectionData %@ baseToken %@ routingKey %@%@", (uint8_t *)&v30, 0x34u);
  }
}
...
- (BOOL)_recordIsIWorkShareable:(id)a3
{
  ...
  if (v4)
  {
    id v5 = [MEMORY[0x263F32640] iWorkShareableExtensions];
...
LABEL_6:
    ...
    v32[1] = v32;
    v32[2] = 0x3032000000;
    v32[3] = __Block_byref_object_copy__22;
    v32[4] = __Block_byref_object_dispose__22;
    id v33 = 0;
    char v20 = (void *)[objc_alloc(MEMORY[0x263EFD6D8]) initWithRecordIDs:v26];
    [v20 setShouldFetchAssetContent:0];
    uint64_t v21 = *MEMORY[0x263EFD5B0];
    v34[0] = *MEMORY[0x263EFD598];
    v34[1] = v21;
    uint64_t v22 = *MEMORY[0x263EFD5A0];
    v34[2] = *MEMORY[0x263EFD5A8];
    v34[3] = v22;
    uint64_t v23 = [MEMORY[0x263EFF8C0] arrayWithObjects:v34 count:4];
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  int v12 = [v11 isEqualToString:*MEMORY[0x263EFD510]];
  ...
  if (v12)
  {
    ...
    int v68 = objc_msgSend(v8, "brc_shareItemID");
    BOOL v57 = 0;
    uint64_t v64 = 0;
    int v17 = 0;
    if (!v15) {
...
LABEL_27:
    ...
    uint64_t v36 = *MEMORY[0x263EFD5B0];
    uint64_t v60 = *MEMORY[0x263EFD598];
    uint64_t v59 = *MEMORY[0x263EFD5A8];
    uint64_t v58 = *MEMORY[0x263EFD5A0];
    *(void *)&long long v34 = 138412802;
    long long v52 = v34;
    uint64_t v65 = *MEMORY[0x263EFD5B0];
    v56 = v16;
    while (1)
    {
      for (uint64_t i = 0; i != v67; ++i)
      {
        ...
        if (v35)
        {
          ...
          {
            uint64_t v43 = a1;
            uint64_t v44 = [v39 encryptedValues];
            uint64_t v45 = [v44 objectForKeyedSubscript:v36];

            if (!v45)
            {
              id v46 = [v39 encryptedValues];
            ...
            if (([v15 isEqualToData:v45] & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v47, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = v52;
                ...
                __int16 v78 = 2112;
                id v79 = v46;
                _os_log_fault_impl(&dword_23FA42000, v47, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: protection data mismatch! ignoring content records version (%@ to %@)%@", buf, 0x20u);
              }
...
LABEL_52:
  ...
  if (v19)
  {
    ...
    uint64_t v21 = v20;
    uint64_t v22 = (uint64_t *)MEMORY[0x263EFD5B0];
    if (v20)
    {
      id v15 = v20;
      uint64_t v23 = *v22;
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138413058;
        ...
        __int16 v80 = 2112;
        v81 = v28;
        _os_log_fault_impl(&dword_23FA42000, v29, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: protection data mismatch between content public sharing identity and web sharing data (%@ vs %@) for %@%@", buf, 0x2Au);
      }
    }
    else
    {
...
LABEL_23:
    ...
    {
      id v32 = [v7 objectForKeyedSubscript:*MEMORY[0x263EFD598]];
    }
    char v16 = v32;

    id v33 = [*(id *)(*(void *)(a1 + 32) + 248) session];
    int v68 = objc_msgSend(v8, "brc_itemIDWithSession:", v33);

    int v17 = [v7 objectForKeyedSubscript:*MEMORY[0x263EFD5A8]];
    uint64_t v64 = [v7 objectForKeyedSubscript:*MEMORY[0x263EFD5A0]];
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_59(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!*(void *)(*(void *)(*(void *)(a1 + 56) + 8) + 40))
  {
    ...
    uint64_t v38 = 0;
    uint64_t v7 = *MEMORY[0x263EFD5B0];
    uint64_t v8 = *MEMORY[0x263F32430];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v41 = 2112;
          uint64_t v42 = v14;
          _os_log_debug_impl(&dword_23FA42000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] record %@ still needs web sharing protection data%@", buf, 0x16u);
        }
        ...
        if (dispatch_group_wait(v19, v20))
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v26;
            uint64_t v40 = v21;
            _os_log_fault_impl(&dword_23FA42000, v22, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Timed out while waiting for new web-sharing identity%@", buf, 0xCu);
          }

          uint64_t v23 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", v8, 15, @"unreachable: Timed out while waiting for new web-sharing identity");
...
void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_60(uint64_t a1, void *a2, void *a3)
{
  ...
  uint64_t v10 = *MEMORY[0x263EFD5B0];
  [v9 setObject:v5 forKeyedSubscript:*MEMORY[0x263EFD5B0]];
...
void __26__BRCSyncUpOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5 && !v6 && ([v11 isEqualToItemID:v14] & 1) != 0)
  {
    ...
    uint64_t v18 = *MEMORY[0x263EFD5B0];
    [v17 setObject:v5 forKeyedSubscript:*MEMORY[0x263EFD5B0]];
...
LABEL_9:
  ...
  if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
  {
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v19;
    _os_log_error_impl(&dword_23FA42000, v20, (os_log_type_t)0x90u, "[ERROR] Failed getting web sharing identity for %@ - %@%@", (uint8_t *)&v26, 0x20u);
  }
LABEL_12:
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Can't prepare sync for a zone that is blocked%@", v2, v3, v4, v5, v6);
}

- (void)prepareWithMaxCost:retryAfter:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: items.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)prepareWithMaxCost:retryAfter:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] no record needs syncing at the moment.%@", v2, v3, v4, v5, v6);
}

- (void)prepareWithMaxCost:retryAfter:.cold.4()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Because this is our first time syncing up, adding %@%@");
}

- (void)prepareWithMaxCost:retryAfter:.cold.5()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] destroying shares instead of unsharing%@", v2, v3, v4, v5, v6);
}

- (void)prepareWithMaxCost:retryAfter:.cold.6()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Avoid syncing up a pristine zone%@", v2, v3, v4, v5, v6);
}

- (void)prepareWithMaxCost:retryAfter:.cold.7()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] %@ is not pristine and needs sync%@");
}
...
void __80__BRCSyncUpOperation__performMetadataSaltingOperationIfNecessaryWithCompletion___block_invoke_26_cold_1()
{
  ...
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, v3, "[DEBUG] Scheduling sync down for zone %@%@", v4);
}

void __80__BRCSyncUpOperation__performMetadataSaltingOperationIfNecessaryWithCompletion___block_invoke_26_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Postponing sync up for item %@%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Uploaded an iWork package of size 0 (itemID: %@)%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Unable to open iwork package %@%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Forcing item dead in the server truth to re-upload as a rejected item - %@%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Forcing sync up of dead parent %@%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] item %@ doesn't need to be re-scanned%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_4()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] item %@ needs to be re-scanned%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_5()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] Blocking %@ from sync up until it is next modified because the server failed with a permanent error%@");
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_6()
{
  OUTLINED_FUNCTION_12();
  uint64_t v5 = *MEMORY[0x263EF8340];
  uint64_t v2 = [*v1 recordID];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, v3, "[DEBUG] ignoring error for %@ because an other item in the batch failed%@", v4);
}

void __74__BRCSyncUpOperation__performModifyRecordsOrBatchOperationWithCompletion___block_invoke_37_cold_7()
{
  OUTLINED_FUNCTION_12();
  uint64_t v5 = *MEMORY[0x263EF8340];
  uint64_t v2 = [*v1 recordID];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, v3, "[DEBUG] skipping throttling item %@ even though it caused the failure%@", v4);
}

- (void)performShareUpdate:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self.serverZone.isPrivateZone%@", v2, v3, v4, v5, v6);
}

void __41__BRCSyncUpOperation_performShareUpdate___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] No shares need saving%@", v2, v3, v4, v5, v6);
}

void __41__BRCSyncUpOperation_performShareUpdate___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Saving shares %@ shared by us for unshare and rename%@");
}

void __82__BRCSyncUpOperation__scheduleShareUpdateAndModifyRecordsAndZoneCreationOperation__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v0, v1, "[ERROR] send metadata error: %@%@");
}

- (void)_setSharingFieldsOnContentRecord:withProtectionData:baseToken:routingKey:forceOverwrite:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: protectionData%@", v2, v3, v4, v5, v6);
}

- (void)_setSharingFieldsOnContentRecord:withProtectionData:baseToken:routingKey:forceOverwrite:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: [contentRecord.recordType isEqualToString:kBRRecordTypeContent]%@", v2, v3, v4, v5, v6);
}

void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: share.publicSharingIdentity%@", v2, v3, v4, v5, v6);
}

void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: content record is missing protection data %@%@");
}

void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_cold_3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: !fetchedRecord%@", v2, v3, v4, v5, v6);
}

void __69__BRCSyncUpOperation__performUpdateSharingProtectionDataIfNecessary___block_invoke_60_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Failed to get new web sharing identity: %@%@");
}
...
void __26__BRCSyncUpOperation_main__block_invoke_cold_1()
{
  ...
  __int16 v9 = 2112;
  uint64_t v10 = v1;
  _os_log_debug_impl(&dword_23FA42000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Sync: sending requestID:%lld for container %@%@", (uint8_t *)&v5, 0x20u);
}

void __26__BRCSyncUpOperation_main__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: invalid sharing records count%@", v2, v3, v4, v5, v6);
}
...
void __26__BRCSyncUpOperation_main__block_invoke_2_cold_1()
{
  ...
  uint64_t v2 = [v1 recordID];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, v3, "[DEBUG] got web sharing identity for %@%@", v4);
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: [firstItemID isEqual:secondItemID]%@", v2, v3, v4, v5, v6);
}
