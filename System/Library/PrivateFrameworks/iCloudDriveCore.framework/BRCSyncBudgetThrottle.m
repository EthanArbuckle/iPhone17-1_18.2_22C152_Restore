...
{
  id v4 = a3;
  float v5 = (void *)[objc_alloc(MEMORY[0x263F089D8]) initWithCapacity:64];
...
- (void)initWithCoder:(os_log_t)log .cold.1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_fault_impl(&dword_23FA42000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid length: %ld%@", (uint8_t *)&v4, 0x16u);
}
