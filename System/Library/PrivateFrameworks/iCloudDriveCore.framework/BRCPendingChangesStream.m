...
- (id)_getChangesStreamSafeDBHolder
{
  ...
  v35[4] = v11;
  v14 = (void (**)(void))MEMORY[0x2455D9A50](v35);
  if ([(id)_pendingChangesStreamPool count] <= v13)
  {
    if ([(id)_pendingChangesStreamPool count] > v11 && !_getChangesStreamSafeDBHolder__closeChangesTimer)
    {
      ...
      v20 = [v19 serialQueue];
      dispatch_source_t v21 = dispatch_source_create(MEMORY[0x263EF8400], 0, 0, v20);
      ...
      {
        v32 = ((void (*)(void))*MEMORY[0x263F32768])(v30);
      }
  ...
  while (1)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = v12;
      ...
      __int16 v15 = 2112;
      v16 = v9;
      _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Closing changes stream %@%@", buf, 0x16u);
    }
  ...
  if (dbHasOpened)
  {
    ...
    if ((v12 & 1) == 0)
    {
      ...
      if ((v13 & 1) == 0)
      {
        ...
        if ([v17 isEqualToString:*MEMORY[0x263F8C730]])
        {
...
- (id)initForListingWithParent:(id)a3 serverZone:(id)a4
{
  ...
  if (v8)
  {
    ...
    char v22 = [v21 isEqualToString:*MEMORY[0x263EFD488]];
    if (v22)
    {
      v23 = &stru_26F3822F0;
    }
...
uint64_t __51__BRCPendingChangesStream__createSchemaIfNecessary__block_invoke(uint64_t a1, void *a2)
{
  ...
  int v8 = (void *)MEMORY[0x263F8C720];
  id v9 = v6;
...
- (void)_openDB
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_debug_impl(&dword_23FA42000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] database is opening so creating at %@%@", buf, 0x16u);
}
...
void __34__BRCPendingChangesStream__openDB__block_invoke_184(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
  {
    ...
    __int16 v21 = 2112;
    char v22 = v10;
    _os_log_error_impl(&dword_23FA42000, v11, (os_log_type_t)0x90u, "[ERROR] sqlite error handler called on pending sync db - %@ (%@)%@", (uint8_t *)&v17, 0x20u);
  }
...
void __34__BRCPendingChangesStream__openDB__block_invoke_189(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
  {
    ...
    __int16 v21 = 2112;
    char v22 = v10;
    _os_log_error_impl(&dword_23FA42000, v11, (os_log_type_t)0x90u, "[ERROR] Auto rollback handler called on pending sync db - %@ (%@)%@", (uint8_t *)&v17, 0x20u);
  }
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] %@ - Closing the database (setting to nil)%@");
}
...
- (void)fetchTokenState:(id)a3
{
  ...
  if (self->_hasBeenCreated)
  {
    ...
    if (!self->_error)
    {
      ...
      objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: Trying to fetch token state without a db");
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        char v11 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: There should always be one entry");
        id v2 = 0;
        int v10 = 1;
      }
    }
...
- (void)fetchQueryCursor:(id)a3
{
  ...
  if (self->_hasBeenCreated)
  {
    ...
    if (!self->_error)
    {
      ...
      objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: Trying to fetch query cursor without a db");
      char v11 = (NSError *)objc_claimAutoreleasedReturnValue();
      error = self->_error;
      self->_error = v11;
    }
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        uint64_t v13 = objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: There should always be one entry");
        id v2 = 0;
        int v12 = 1;
      }
    }
  ...
  if (self->_hasBeenCreated)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: Trying to enumerate records without a db");
...
uint64_t __56__BRCPendingChangesStream_enumerateRecordsOfType_block___block_invoke(void *a1, void *a2)
{
  ...
  while ([v4 next])
  {
    int v5 = (void *)MEMORY[0x2455D97F0]();
...
uint64_t __139__BRCPendingChangesStream_saveEditedRecords_deletedRecordIDs_deletedShareIDs_subResourceEditedRecords_serverChangeToken_clientChangeToken___block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v63 = *MEMORY[0x263EFD510];
  LOBYTE(v6) = 1;
  do
  {
    for (uint64_t i = 0; i != v5; ++i)
    {
      ...
      char v9 = (void *)MEMORY[0x2455D97F0]();
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412290;
        v87 = v22;
        _os_log_fault_impl(&dword_23FA42000, v23, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rc && db.changes == 1%@", buf, 0xCu);
      }
      ...
      if ([v3 changes])
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          _os_log_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEFAULT, "[WARNING] Removed item in pending resources table because it was saved %@%@", buf, 0x16u);
        }
      }
      LOBYTE(v6) = 1;
LABEL_21:
...
LABEL_25:
  ...
  while (2)
  {
    ...
    while (2)
    {
      ...
      id v30 = (void *)MEMORY[0x2455D97F0]();
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412290;
        v87 = v33;
        _os_log_fault_impl(&dword_23FA42000, v34, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rc && db.changes == 1%@", buf, 0xCu);
      }
        ...
        }
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v88 = 2112;
            uint64_t v89 = v6;
            _os_log_impl(&dword_23FA42000, v32, OS_LOG_TYPE_DEFAULT, "[WARNING] Removed item in pending resources table because it was deleted %@%@", buf, 0x16u);
          }
  ...
  while (2)
  {
    ...
    while (2)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412290;
        v87 = v66;
        _os_log_fault_impl(&dword_23FA42000, v43, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rc && db.changes == 1%@", buf, 0xCu);
      }
...
uint64_t __82__BRCPendingChangesStream_saveEditedRecords_subResourceEditedRecords_queryCursor___block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v45 = *MEMORY[0x263EFD510];
  LOBYTE(v7) = 1;
  do
  {
    uint64_t v43 = v6;
  ...
  if (v27)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v28; ++i)
      {
        ...
        dispatch_block_t v33 = (void *)MEMORY[0x2455D97F0]();
        if (v7) {
  ...
  if (v9)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        int v15 = (void *)MEMORY[0x2455D97F0]();
        if (v5) {
          ...
          if ([v3 changes])
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v46 = 2112;
              long long v47 = v27;
              _os_log_debug_impl(&dword_23FA42000, v28, OS_LOG_TYPE_DEBUG, "[DEBUG] Deleted %@ from the pending subResources table because it was persisted directly to the server truth%@", buf, 0x16u);
            }
          }
...
- (BOOL)hasRecordIDsToDeserialize
{
  ...
  {
    uint64_t v6 = [v3 db];
    char v5 = [v6 performWithFlags:1 action:&__block_literal_global_269];
  }
  return v5;
}
...
- (BOOL)hasRecordDeletes
{
  ...
  {
    uint64_t v6 = [v3 db];
    char v5 = [v6 performWithFlags:1 action:&__block_literal_global_308_0];
  }
  return v5;
}
    ...
    if ([v7 changes])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v31 = 2112;
        uint64_t v32 = v10;
        _os_log_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Removed recordID %@ from record changes table because it now needs sub resources%@", buf, 0x16u);
      }
    }
  ...
  if ([v7 changes])
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v33 = 2112;
      v34 = error;
      _os_log_debug_impl(&dword_23FA42000, v23, OS_LOG_TYPE_DEBUG, "[DEBUG] Unblocked %lld records waiting on save of %@ even though it's a sub-resource record%@", buf, 0x20u);
    }
    BOOL v24 = 1;
    goto LABEL_17;
  }
        ...
        if ([v3 changes])
        {
          ...
          if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 134218498;
            ...
            __int16 v27 = 2112;
            uint64_t v28 = v10;
            _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items which no longer need to fetch xattr %@%@", buf, 0x20u);
          }
        }
      }
  ...
  if ([v3 changes])
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v24 = 2112;
      __int16 v25 = v5;
      _os_log_error_impl(&dword_23FA42000, v6, (os_log_type_t)0x90u, "[ERROR] We couldn't fetch recordID %@ so it's not going to save. We deleted %lld items from pending subresources table for this%@", buf, 0x20u);
    }
  }
  if (v4) {
  ...
  if ([v3 changes])
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v24 = 2112;
      __int16 v25 = v7;
      _os_log_error_impl(&dword_23FA42000, v8, (os_log_type_t)0x90u, "[ERROR] We couldn't fetch recordID %@ so it's not going to save. We marked %lld as not needing fetch anymore%@", buf, 0x20u);
    }
  }
  if (v4) {
  ...
  if ([v3 changes])
  {
    ...
    if (os_log_type_enabled(v10, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v24 = 2112;
      __int16 v25 = v9;
      _os_log_error_impl(&dword_23FA42000, v10, (os_log_type_t)0x90u, "[ERROR] We couldn't fetch recordID %@ so it's not going to save. We marked %lld as not blocked for save anymore%@", buf, 0x20u);
    }
  }
  if ((v4 & 1) == 0)
  {
  ...
  if ([v3 execute:@"UPDATE records_needing_subresources SET record_id_blocking_save = NULL WHERE record_id = %@ AND record_id_blocking_save = %@", *(void *)(a1 + 32), *(void *)(a1 + 40)]&& objc_msgSend(v3, "changes"))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_debug_impl(&dword_23FA42000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Unblocked record %@ blocked on record %@%@", buf, 0x20u);
    }
    uint64_t v6 = 1;
  }
  else
  ...
  }
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v21 = 2112;
      __int16 v22 = v8;
      _os_log_debug_impl(&dword_23FA42000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items to be unblocked for fetching %@%@", buf, 0x20u);
    }
  }
    ...
    if ([v6 changes])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 134218498;
        ...
        __int16 v21 = 2112;
        __int16 v22 = v10;
        _os_log_debug_impl(&dword_23FA42000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated %llu items to be unblocked for saving %@%@", buf, 0x20u);
      }
    }
    BOOL v12 = 1;
  }
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] %@ - Destroying the database%@");
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Opening changes stream %@%@");
}

- (void)_dbBecameCorrupted:withDescription:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Deleting database at path: %@%@");
}
...
- (void)_dbBecameCorrupted:withDescription:.cold.2()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] We are in an error scenario, trying to close the DB, but it's busy - let's avoid dealloc it%@", v1, 0xCu);
}

- (void)_dbBecameCorrupted:withDescription:.cold.3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_2_0(&dword_23FA42000, v0, v1, "[CRIT] error closing BRCPendingChangesStream DB connection: %@%@");
}
...
- (void)_dropExistingTablesWithDB:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v2, v3, "[DEBUG] Dropping pending fetch table at %@%@", v4, v5, v6, v7, v8);
}
...
void __51__BRCPendingChangesStream__createSchemaIfNecessary__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5(&dword_23FA42000, v2, v3, "[CRIT] UNREACHABLE: Failed to set the cache spill - %@%@", v4, v5, v6, v7, v8);
}
...
void __51__BRCPendingChangesStream__createSchemaIfNecessary__block_invoke_cold_2()
{
  ...
  os_log_t v1 = [v0 lastError];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5(&dword_23FA42000, v2, v3, "[CRIT] UNREACHABLE: Failed to set the cache size - %@%@", v4, v5, v6, v7, v8);
}
...
void __34__BRCPendingChangesStream__openDB__block_invoke_cold_1()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] db corruption handler called on pending sync db%@", v1, 0xCu);
}

void __34__BRCPendingChangesStream__openDB__block_invoke_184_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] disk is full - exiting%@", v2, v3, v4, v5, v6);
}

- (void)fetchTokenState:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Trying to fetch token state without a db%@", v2, v3, v4, v5, v6);
}

void __43__BRCPendingChangesStream_fetchTokenState___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: There should always be one entry%@", v2, v3, v4, v5, v6);
}

- (void)fetchQueryCursor:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Trying to fetch query cursor without a db%@", v2, v3, v4, v5, v6);
}

- (void)enumerateRecordsOfType:block:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Trying to enumerate records without a db%@", v2, v3, v4, v5, v6);
}
...
void __56__BRCPendingChangesStream_enumerateRecordsOfType_block___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5(&dword_23FA42000, v2, v3, "[CRIT] UNREACHABLE: Failed enumerating records - %@%@", v4, v5, v6, v7, v8);
}

- (void)_recordTypeFromRecordID:isShare:isDelete:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: recordType != 0%@", v2, v3, v4, v5, v6);
}
...
void __139__BRCPendingChangesStream_saveEditedRecords_deletedRecordIDs_deletedShareIDs_subResourceEditedRecords_serverChangeToken_clientChangeToken___block_invoke_cold_1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  ...
  OUTLINED_FUNCTION_4(&dword_23FA42000, v1, v2, "[ERROR] Failed saving to the pending changes stream - %@%@", (void)v3, DWORD2(v3));
}
...
void __139__BRCPendingChangesStream_saveEditedRecords_deletedRecordIDs_deletedShareIDs_subResourceEditedRecords_serverChangeToken_clientChangeToken___block_invoke_cold_2()
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Persisted %llu records needing subResource fetch%@");
}

void __82__BRCPendingChangesStream_saveEditedRecords_subResourceEditedRecords_queryCursor___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_4_2();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Persisted %llu sub resource records which need fetch%@");
}

void __82__BRCPendingChangesStream_saveEditedRecords_subResourceEditedRecords_queryCursor___block_invoke_cold_3()
{
  OUTLINED_FUNCTION_4_2();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Persisted %llu records which are fully fetched%@");
}
...
void __88__BRCPendingChangesStream_saveSubResourceRecords_afterSavingMainTableItems_queryCursor___block_invoke_cold_1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v1, v2, "[ERROR] Failed to save subResource records after saving main table items - %@%@", (void)v3, DWORD2(v3));
}

void __88__BRCPendingChangesStream_saveSubResourceRecords_afterSavingMainTableItems_queryCursor___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_4_2();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Persisted %lld subResource records to the pending changes db%@");
}
...
void __88__BRCPendingChangesStream_saveSubResourceRecords_afterSavingMainTableItems_queryCursor___block_invoke_cold_3()
{
  ...
  [v0 changes];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_3_1(&dword_23FA42000, v1, v2, "[DEBUG] Removed %llu records from the pending fetches table because we should have just saved them%@", v3, v4, v5, v6, v7);
}

- (void)_finishedFetchingRecordMetadata:withDB:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: db.isInTransaction%@", v2, v3, v4, v5, v6);
}
