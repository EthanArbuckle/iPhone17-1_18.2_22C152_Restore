...
- (BRCFileUnlinker)initWithCacheDirPath:(id)a3
{
  ...
  if (v5)
  {
    ...
    dispatch_source_t v13 = dispatch_source_create(MEMORY[0x263EF83B8], 0, 0, (dispatch_queue_t)v6->_queue);
    ...
    {
      v21 = ((void (*)(void *))*MEMORY[0x263F32768])(v19);
    }
...
- (void)resume
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: suspendCount >= 0%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)suspend
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_debug_impl(&dword_23FA42000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] suspending - suspendCount:%d->%d%@", (uint8_t *)v3, 0x18u);
}
...
- (void)_purge
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_debug_impl(&dword_23FA42000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] removed '%@/*'%@", (uint8_t *)&v3, 0x16u);
}
...
- (BOOL)renameAndUnlinkInBackgroundItemAt:(int)a3 path:(id)a4
{
  ...
  if ((fstatat(a3, (const char *)[v6 fileSystemRepresentation], &v46, 32) & 0x80000000) == 0)
  {
    ...
    id v9 = objc_msgSend(MEMORY[0x263F08C38], "UUID", *(void *)&v46.st_dev);
    v10 = [v9 UUIDString];
    ...
    if ((BRCRenameAt(a3, v6, -1, v11, 0) & 0x80000000) == 0)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)&v76[40] = v46.st_flags;
        __int16 v77 = 2112;
        *(void *)v78 = v12;
        _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] renamed '%@' to '%@' deviceID:%u fileID:%llu mode:%c%c%c%c%c%c%c%c%c%c nlink:%u uid:%u gid:%u atime:%lu mtime:%lu ctime:%lu size:%llu flags:0x%x%@", buf, 0xACu);
      }
    ...
    if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)&v78[6] = v22;
      __int16 v79 = 2112;
      v80 = v23;
      _os_log_error_impl(&dword_23FA42000, v24, (os_log_type_t)0x90u, "[ERROR] renameat(%d, '%@', -1, '%@' deviceID:%u fileID:%llu mode:%c%c%c%c%c%c%c%c%c%c nlink:%u uid:%u gid:%u atime:%lu mtime:%lu ctime:%lu size:%llu flags:0x%x failed %{errno}d%@", buf, 0xB8u);
    }
...
LABEL_18:
  ...
  if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
  {
    ...
    *(_WORD *)&v48[14] = 2112;
    *(void *)&v48[16] = v20;
    _os_log_error_impl(&dword_23FA42000, v21, (os_log_type_t)0x90u, "[ERROR] lstat('%@') failed %{errno}d%@", buf, 0x1Cu);
  }
...
- (void)renameAndUnlinkInBackgroundItemAt:(NSObject *)a3 path:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v12 = 2112;
  uint64_t v13 = a2;
  _os_log_debug_impl(&dword_23FA42000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] failed removing documentID for %@ (%s)%@", (uint8_t *)&v8, 0x20u);
}
