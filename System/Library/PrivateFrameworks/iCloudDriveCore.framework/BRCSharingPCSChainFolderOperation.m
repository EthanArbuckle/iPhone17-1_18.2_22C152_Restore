...
- (BRCSharingPCSChainFolderOperation)initWithItem:(id)a3 sessionContext:(id)a4 syncUpCallback:(id)a5
{
  ...
  if (v16)
  {
    ...
    v23 = objc_msgSend(MEMORY[0x263EFD780], "br_sharingMisc");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sharing/prepareFolderPCS", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  {
    objc_msgSend(MEMORY[0x263F087E8], "brc_errorInvalidParameter:value:", @"serverItem", 0);
