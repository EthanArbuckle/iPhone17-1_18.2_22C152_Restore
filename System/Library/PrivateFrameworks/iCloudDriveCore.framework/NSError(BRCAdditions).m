...
- (double)br_suggestedRetryTimeInterval
{
  ...
  v2 = [a1 userInfo];
  v3 = [v2 objectForKeyedSubscript:*MEMORY[0x263EFD4A0]];
  [v3 doubleValue];
  double v5 = v4;
  ...
  if (objc_msgSend(a1, "_brc_isCloudKitErrorCode:", 2))
  {
    ...
    char v7 = [v6 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
...
- (uint64_t)brc_isRetriable
{
  ...
  return objc_msgSend(a1, "brc_checkErrorsFromCloudKit:", &__block_literal_global_54);
}
  ...
  else
  {
    ...
    if ([v6 isEqualToString:*MEMORY[0x263EFD498]])
    {
      ...
      if (v7 == 2)
      {
        ...
        uint64_t v9 = [v8 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
...
- (id)_brc_cloudKitInternalWithErrorCode:()BRCAdditions
{
  ...
  uint64_t v10 = *MEMORY[0x263EFD4C0];
  int v11 = [v9 isEqualToString:*MEMORY[0x263EFD4C0]];
...
LABEL_5:
  ...
  if ([v4 code] == 2055)
  {
    ...
    uint64_t v14 = [v13 objectForKeyedSubscript:*MEMORY[0x263F08608]];
...
- (id)br_cloudKitErrorForIdentifier:()BRCAdditions
{
  ...
  uint64_t v8 = [v7 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v3; ++i)
      {
        ...
        if (objc_msgSend(v6, "br_isNSURLErrorCode:", -1009))
        {
          ...
          uint64_t v8 = [v7 objectForKeyedSubscript:*MEMORY[0x263F085A0]];
          uint64_t v3 = v8 == 0;
      ...
      if (v12)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            int v16 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initWithRecordName:*(void *)(*((void *)&v21 + 1) + 8 * v15) zoneID:v6];
            [v10 addObject:v16];
...
- (BOOL)brc_isCloudKitMMCSErrorChunksCouldNotBeRegisteredError
{
  if (objc_msgSend(a1, "_brc_isCloudKitErrorCode:", 4))
  {
    v2 = [a1 userInfo];
    uint64_t v3 = *MEMORY[0x263F08608];
    uint64_t v4 = [v2 objectForKeyedSubscript:*MEMORY[0x263F08608]];

    uint64_t v5 = [v4 domain];
    if ([v5 isEqualToString:*MEMORY[0x263EFD588]])
    {
      uint64_t v6 = [v4 code];
...
LABEL_12:
      ...
      uint64_t v7 = [v4 userInfo];
      uint64_t v5 = [v7 objectForKeyedSubscript:v3];

      uint64_t v8 = [v5 domain];
      if ([v8 isEqualToString:*MEMORY[0x263F534D8]]) {
        BOOL v9 = [v5 code] == 29;
      }
      else {
        BOOL v9 = 0;
...
- (id)brc_ckPartialErrorsByItemID
{
  ...
  {
    v2 = [a1 userInfo];
    uint64_t v4 = [v2 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
LABEL_5:
...
- (uint64_t)brc_isCloudKitErrorRequiringAssetRescan
{
  ...
  if (v3)
  {
    ...
    id v4 = [v6 objectForKeyedSubscript:*MEMORY[0x263F08608]];
  }
  else
  {
    id v4 = a1;
  ...
  int v8 = [v7 isEqualToString:*MEMORY[0x263EFD4C0]];
...
- (uint64_t)brc_isCloudKitErrorRequiringAssetReupload
{
  ...
  id v4 = [a1 domain];
  int v5 = [v4 isEqualToString:*MEMORY[0x263EFD498]];

  if (v5)
  {
    uint64_t v6 = [a1 userInfo];
    id v2 = [v6 objectForKeyedSubscript:*MEMORY[0x263F08608]];
  }
  else
  {
    id v2 = a1;
...
- (BOOL)_brc_isCloudKitPluginErrorCode:()BRCAdditions
{
  ...
  int v5 = [v4 userInfo];
  uint64_t v6 = [v5 objectForKey:*MEMORY[0x263F08608]];
...
- (id)_brc_cloudKitPluginErrorPayload
{
  ...
  id v4 = [v3 userInfo];
  int v5 = [v4 objectForKey:*MEMORY[0x263EFD4B0]];
...
- (uint64_t)brc_isCloudKitErrorUnsupportedOSForItemAndGetMinimumSupported:()BRCAdditions
{
  ...
  if (v5)
  {
    uint64_t v6 = objc_msgSend(a1, "_brc_cloudKitPluginErrorPayload");
    uint64_t v7 = [[BRCExtensionErrorPayload alloc] initWithData:v6];
    int v8 = v7;
    if (a3)
    {
...
- (BOOL)brc_isIndividualItemBlacklistError
{
  ...
  int v7 = [v6 isEqualToString:*MEMORY[0x263EFD4C0]];
...
{
  id v2 = [a1 domain];
  uint64_t v3 = *MEMORY[0x263EFD4C0];
  char v4 = [v2 isEqualToString:*MEMORY[0x263EFD4C0]];
      ...
      if ((unint64_t)(v5 - 2000) < 0x38)
      {
        ...
        if (v5 > 2021)
        {
          switch(v5)
          {
            ...
            case 2055:
              int v16 = [a1 userInfo];
              id v17 = [v16 objectForKeyedSubscript:*MEMORY[0x263F08608]];
...
LABEL_61:
  ...
  long long v11 = [v10 objectForKey:*MEMORY[0x263F08608]];
...
LABEL_6:
  ...
  if (v9)
  {
    ...
    switch([a1 code])
    {
      case 1:
        BOOL v10 = [a1 userInfo];
        long long v11 = [v10 objectForKeyedSubscript:*MEMORY[0x263F08608]];
      ...
      case 2:
        ...
        int v16 = [v15 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
      ...
      case 12:
        ...
        id v17 = [v22 objectForKeyedSubscript:*MEMORY[0x263F08608]];
      ...
      case 15:
        v25 = [a1 userInfo];
        id v17 = [v25 objectForKeyedSubscript:*MEMORY[0x263F08608]];
...
LABEL_53:
      ...
      case 22:
        ...
        v27 = [v26 objectForKeyedSubscript:*MEMORY[0x263F08608]];
...
LABEL_82:
  ...
  int v13 = [a1 domain];
  int v14 = [v13 isEqualToString:*MEMORY[0x263EFD4C0]];
...
{
  id v2 = [a1 domain];
  if ([v2 isEqualToString:*MEMORY[0x263F3F610]]) {
    BOOL v3 = [a1 code] == 1;
  }
  else {
    BOOL v3 = 0;
...
{
  id v2 = [a1 domain];
  uint64_t v3 = *MEMORY[0x263EFD498];
  if ([v2 isEqualToString:*MEMORY[0x263EFD498]])
  {
  ...
  char v5 = [v4 isEqualToString:*MEMORY[0x263EFD4C0]];
...
LABEL_4:
    ...
    if ([v7 isEqualToString:v3])
    {
      ...
      {
        int v9 = [a1 userInfo];
        id v10 = (id)*MEMORY[0x263EFD4C8];
        long long v11 = [v9 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
...
+ (id)brc_errorWithDomain:()BRCAdditions code:underlyingError:
{
  ...
  long long v11 = [v9 objectForKeyedSubscript:*MEMORY[0x263F08320]];

  uint64_t v12 = (void *)MEMORY[0x263F087E8];
  if (v11)
  {
    v20[0] = *MEMORY[0x263F08608];
    v20[1] = v10;
    v21[0] = v7;
    v21[1] = v11;
    id v13 = NSDictionary;
...
{
  id v2 = [a1 domain];
  uint64_t v3 = (void *)*MEMORY[0x263F32360];
  if ([v2 isEqualToString:*MEMORY[0x263F32360]])
  {

    goto LABEL_4;
  }
  uint64_t v4 = [a1 domain];
  char v5 = (void *)*MEMORY[0x263F07F70];
  int v6 = [v4 isEqualToString:*MEMORY[0x263F07F70]];

  if (v6) {
    goto LABEL_4;
  }
  uint64_t v10 = [a1 domain];
  if ([v10 isEqualToString:*MEMORY[0x263EFD498]])
  {
...
LABEL_12:
    ...
    id v8 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorWithDomain:code:underlyingError:", v14, v15, v13);

    goto LABEL_6;
  }
  long long v11 = [a1 domain];
  int v12 = [v11 isEqualToString:*MEMORY[0x263EFD4C0]];

  if (v12) {
    goto LABEL_12;
  }
  uint64_t v16 = [a1 domain];
  int v17 = [v16 isEqualToString:*MEMORY[0x263F08438]];

  if (v17)
  {
    objc_msgSend(MEMORY[0x263F087E8], "brc_errorWithDomain:code:underlyingError:", v5, 512, a1);
    id v7 = (id)objc_claimAutoreleasedReturnValue();
    goto LABEL_5;
  }
  id v18 = [a1 domain];
  int v19 = [v18 isEqualToString:*MEMORY[0x263F406A0]];
  ...
  if (v19)
  {
    ...
    id v8 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorWithDomain:code:underlyingError:", v20, v23, a1);
...
+ (uint64_t)brc_daemonAccessDisabledError
{
  return objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32360], 16, @"Sync is restricted for this client");
}
...
- (id)brc_description
{
  ...
  uint64_t v5 = [a1 code];
  int v6 = [a1 userInfo];
  id v7 = [v2 stringWithFormat:@"<%@:%p(%@:%ld) - %@>", v3, a1, v4, v5, v6];
...
{
  id v2 = [a1 userInfo];
  uint64_t v3 = [v2 objectForKeyedSubscript:*MEMORY[0x263EFD4A8]];
  uint64_t v4 = v3;
  if (v3)
  {
    id v5 = v3;
  ...
  {
    int v6 = [a1 userInfo];
    id v5 = [v6 objectForKeyedSubscript:*MEMORY[0x263EFD490]];
  }
  return v5;
}
...
LABEL_5:
  ...
  {
    id v7 = [v4 userInfo];
    id v5 = [v7 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
...
{
  id v2 = [a1 domain];
  int v3 = [v2 isEqualToString:*MEMORY[0x263F07F70]];
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Printing Underline Errors Chain for %@%@");
}

- (void)_brc_isCloudKitErrorCode:()BRCAdditions .cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: code < CKErrorInternalGenericError%@", v2, v3, v4, v5, v6);
}

- (void)_brc_isCloudKitInternalErrorCode:()BRCAdditions .cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: code == CKErrorInternalSuccess || code == CKErrorInternalCancelled || code >= CKErrorInternalGenericError%@", v2, v3, v4, v5, v6);
}

- (void)br_cloudKitErrorForIdentifier:()BRCAdditions .cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: there should be a recordID%@", v2, v3, v4, v5, v6);
}

- (void)brc_isCloudKitErrorReparentedToNewParent:()BRCAdditions .cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: errorPayload.hasRecordId%@", v2, v3, v4, v5, v6);
}

- (void)_brc_isCloudKitInternalErrorSafeToSyncUpWithoutSyncDown
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] we should sync-down again after %@%@");
}

- (void)brc_isCloudKitErrorSafeToSyncUpWithoutSyncDown
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Cloudd crashed, our sync up could have been received by the server%@", v2, v3, v4, v5, v6);
}
