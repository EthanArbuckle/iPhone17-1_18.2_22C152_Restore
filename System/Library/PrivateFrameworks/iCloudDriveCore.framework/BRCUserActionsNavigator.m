...
LABEL_8:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v38 = 2112;
    v39 = v21;
    _os_log_debug_impl(&dword_23FA42000, v22, OS_LOG_TYPE_DEBUG, "[DEBUG] Opening in web browser (reason: %@) %@%@", buf, 0x20u);
  }

  v23 = [MEMORY[0x263F01880] defaultWorkspace];
  uint64_t v32 = *MEMORY[0x263F01800];
...
- (void)openShareURLInWebBrowser:withReason:.cold.1()
{
  ...
  __int16 v3 = 2112;
  uint64_t v4 = v0;
  _os_log_error_impl(&dword_23FA42000, v1, (os_log_type_t)0x90u, "[ERROR] Can't open \"%@\" using default web browser%@", v2, 0x16u);
}
...
- (void)openShareURLInWebBrowser:withReason:.cold.2()
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: redirectReason%@", v1, 0xCu);
}
...
- (void)openShareURLInWebBrowser:withReason:.cold.3()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_fault_impl(&dword_23FA42000, v0, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: shareURL%@", v1, 0xCu);
}
...
- (void)openAppStoreForBundleID:.cold.1()
{
  uint64_t v2 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(&dword_23FA42000, v0, (os_log_type_t)0x90u, "[ERROR] passed nil app bundle ID%@", v1, 0xCu);
}
