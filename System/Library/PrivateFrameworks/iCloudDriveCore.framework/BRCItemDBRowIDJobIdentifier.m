...
- (id)matchingJobsWhereSQLClause
{
  return (id)objc_msgSend(MEMORY[0x263F8C710], "formatInjection:", @"throttle_id = %lld", self->_itemDBRowID);
}

- (id)columns
{
  return (id)[MEMORY[0x263F8C720] rawInjection:"throttle_id" length:11];
}

- (id)columnsValues
{
  return (id)objc_msgSend(MEMORY[0x263F8C710], "formatInjection:", @"%lld", self->_itemDBRowID);
}
