...
+ (uint64_t)newFromSqliteValue:()BRCItemAdditions
{
  if (sqlite3_value_type(a3) == 3)
  {
    ...
    uint64_t v5 = [objc_alloc(MEMORY[0x263EFD7E8]) initWithSqliteRepresentation:v4];
...
+ (uint64_t)newFromSqliteStatement:()BRCItemAdditions atIndex:
{
  if (sqlite3_column_type(a3, iCol) == 3)
  {
    ...
    uint64_t v7 = [objc_alloc(MEMORY[0x263EFD7E8]) initWithSqliteRepresentation:v6];
...
LABEL_26:
  ...
  {
    v13 = [a1 zoneID];
    v14 = (void *)[objc_alloc(MEMORY[0x263F325E0]) initWithRecordZoneID:v13];
    if ([v14 isShared])
    {
...
- (void)brc_itemIDWithSession:()BRCItemAdditions error:
{
  ...
  id v7 = [a1 zoneID];
  v8 = [v7 zoneName];
  if ([v8 isEqualToString:*MEMORY[0x263F327C8]])
  {
    v9 = 0;
    goto LABEL_5;
  }
  id v10 = [v7 ownerName];
  int v11 = [v10 isEqualToString:*MEMORY[0x263EFD488]];
  ...
  v8 = (void *)[objc_alloc(MEMORY[0x263F325E0]) initWithRecordZoneID:v7];
...
LABEL_7:
  ...
  if (!v9)
  {
    ...
    objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 1004, @"Can't find appLibrary corresponding to zoneID %@", v7, v16);
    goto LABEL_14;
  }
  if (a4)
  {
    objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 1004, @"Found appLibrary %@ with invalid dbRowID for zoneID %@", v9, v7);
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: sqlite3_value_type(value) == SQLITE_NULL%@", v2, v3, v4, v5, v6);
}

+ (void)newFromSqliteStatement:()BRCItemAdditions atIndex:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: sqlite3_column_type(stmt, index) == SQLITE_NULL%@", v2, v3, v4, v5, v6);
}

- (void)brc_appLibraryRootZoneName
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self.brc_isAppLibraryRootRecordID%@", v2, v3, v4, v5, v6);
}

- (void)brc_appLibraryDocumentsZoneName
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: self.brc_isAppLibraryDocumentsRecordID%@", v2, v3, v4, v5, v6);
}

- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: libraryRowID%@", v2, v3, v4, v5, v6);
}

- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.3()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: libraryRowID || sharedZoneRowID || !([identifier isEqualToString:BRCItemIDZoneRoot] || [identifier isEqualToString:BRCItemIDDocuments])%@", v2, v3, v4, v5, v6);
}

- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.5()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: Corrupt side car file%@", v2, v3, v4, v5, v6);
}
...
- (void)_itemIDWithLibraryRowID:()BRCItemAdditions session:.cold.6()
{
  ...
  OUTLINED_FUNCTION_5(&dword_23FA42000, v1, v2, "[CRIT] UNREACHABLE: attempt to extract an itemID from '%s'%@", v3, v4, v5, v6, v7);
}
...
- (void)brc_itemType
{
  ...
  [v0 UTF8String];
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_5(&dword_23FA42000, v1, v2, "[CRIT] UNREACHABLE: attempt to extract an itemType from '%s'%@", v3, v4, v5, v6, v7);
}
