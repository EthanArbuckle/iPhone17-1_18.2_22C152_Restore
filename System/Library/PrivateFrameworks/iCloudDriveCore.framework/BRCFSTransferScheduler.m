...
- (void)moveAppLibraryTransfers:(id)a3 toAppLibrary:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  v26 = [(BRCAccountSessionFPFS *)self->super._session clientDB];
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      __int16 v35 = 2112;
      v36 = v20;
      _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: moved %lld throttles from %@ to %@%@", buf, 0x34u);
    }
