...
- (uint64_t)brc_signatureIsValid
{
  if ((objc_msgSend(a1, "brc_signatureIsPendingPlaceHolder") & 1) == 0)
  {
    if ((objc_msgSend(a1, "brc_signatureIsPackage") & 1) != 0
      || ([MEMORY[0x263EFD858] isValidSignature:a1] & 1) != 0)
    {
      return 1;
    }
...
- (id)brc_signature
{
  id v2 = objc_alloc_init(MEMORY[0x263EFD858]);
  id v3 = a1;
...
- (void)brc_signatureIsValid
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_error_impl(&dword_23FA42000, log, (os_log_type_t)0x90u, "[ERROR] invalid signature in %@%@", (uint8_t *)&v3, 0x16u);
}
