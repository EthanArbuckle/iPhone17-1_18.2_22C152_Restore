...
+ (id)sharedBuddyFlowObserver
{
  if (sharedBuddyFlowObserver_onceToken != -1) {
    dispatch_once(&sharedBuddyFlowObserver_onceToken, &__block_literal_global_14);
  }
...
- (void)_registerForBYSetupAssistantFinishedNotification
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v19 = v3;
    _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Register for BYSetupAssistantFinishedDarwinNotification%@", buf, 0xCu);
  }

  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)_buddyHasFinished, (CFStringRef)*MEMORY[0x263F67FC8], 0, CFNotificationSuspensionBehaviorDrop);
  ...
  id v9 = objc_alloc(MEMORY[0x263F32648]);
...
- (void)_unregisterForBYSetupAssistantFinishedNotification
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    objc_super v7 = v3;
    _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Unregister for BYSetupAssistantFinishedDarwinNotification%@", (uint8_t *)&v6, 0xCu);
  }

  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterRemoveObserver(DarwinNotifyCenter, self, (CFNotificationName)*MEMORY[0x263F67FC8], 0);
}
  ...
  if ([(BRCBuddyFlowObserver *)self doesBuddyFlowNeedsToRun])
  {
    ...
    if ([(BRCBuddyFlowObserver *)v11 doesBuddyFlowNeedsToRun])
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v45 = v12;
        _os_log_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEFAULT, "[NOTICE] We are in Buddy. Register block [%@] with key [%@]%@", buf, 0x20u);
      }
        ...
        if (*(void *)(*(void *)&buf[8] + 40))
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)v40 = 138412546;
            ...
            __int16 v42 = 2112;
            v43 = v18;
            _os_log_impl(&dword_23FA42000, v19, OS_LOG_TYPE_DEFAULT, "[NOTICE] Key %@ already registered%@", v40, 0x16u);
          }
        }
        else
        {
...
uint64_t __73__BRCBuddyFlowObserver_observeBuddyIfNecessaryWithKey_block_description___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v8 = 2112;
    id v9 = v2;
    _os_log_impl(&dword_23FA42000, v3, OS_LOG_TYPE_DEFAULT, "[NOTICE] Buddy has finished. Execute block [%@]%@", (uint8_t *)&v6, 0x16u);
  }
...
uint64_t __73__BRCBuddyFlowObserver_observeBuddyIfNecessaryWithKey_block_description___block_invoke_13(void *a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v9 = 2112;
    uint64_t v10 = v2;
    _os_log_impl(&dword_23FA42000, v3, OS_LOG_TYPE_DEFAULT, "[NOTICE] Buddy has finished. Execute block [%@]%@", (uint8_t *)&v7, 0x16u);
  }
...
- (void)logStatus
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v8 = 2112;
    __int16 v9 = v3;
    _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Waiting for buddy to complete: %@%@", (uint8_t *)&v6, 0x16u);
  }
  ...
  if (self->_waitingForBuddy)
  {
    ...
    if (self->_waitingForBuddy)
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        uint64_t v10 = v3;
        _os_log_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] Unregister for BYSetupAssistantFinishedDarwinNotification%@", buf, 0xCu);
      }
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v11 = 2112;
        double v12 = v5;
        _os_log_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] Trigger %@%@", buf, 0x16u);
      }
