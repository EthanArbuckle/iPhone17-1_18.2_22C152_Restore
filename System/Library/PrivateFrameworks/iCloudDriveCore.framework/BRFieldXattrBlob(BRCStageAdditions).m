...
+ (void)loadXattrsFromURL:()BRCStageAdditions structuralBlob:contentBlob:localBlob:withMaximumSize:error:.cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v12 = 2112;
  uint64_t v13 = a2;
  _os_log_error_impl(&dword_23FA42000, a3, (os_log_type_t)0x90u, "[ERROR] Failed with %d opening file at: %@%@", (uint8_t *)v9, 0x1Cu);
}
...
+ (void)loadXattrsFromFD:()BRCStageAdditions structuralBlob:contentBlob:localBlob:withMaximumSize:error:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: locBlobOut == NULL%@", (uint8_t *)&v2, 0xCu);
}
