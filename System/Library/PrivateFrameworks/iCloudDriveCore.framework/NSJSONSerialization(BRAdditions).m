...
+ (id)_jsonifyObject:()BRAdditions
{
  ...
  if (_jsonifyObject__onceToken != -1) {
    dispatch_once(&_jsonifyObject__onceToken, &__block_literal_global_38);
  }
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    else
    {
      ...
      v9 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", objc_msgSend(v4, "count"));
...
+ (id)jsonStringFromDictionary:()BRAdditions options:error:
{
  ...
  id v12 = 0;
  id v7 = [MEMORY[0x263F08900] dataWithJSONObject:v6 options:1 error:&v12];
  id v8 = v12;
  v9 = v8;
  if (v7)
  {
