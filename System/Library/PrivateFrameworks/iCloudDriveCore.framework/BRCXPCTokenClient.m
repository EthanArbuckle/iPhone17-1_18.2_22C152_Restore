...
- (void)currentAccountCopyTokenWithBundleID:(id)a3 version:(id)a4 reply:(id)a5
{
  ...
  if (objc_msgSend(v30, "br_isEnabledForCloudDocs"))
  {
    ...
    if (currentAccountCopyTokenWithBundleID_version_reply____personaOnceToken != -1) {
      dispatch_once(&currentAccountCopyTokenWithBundleID_version_reply____personaOnceToken, &__block_literal_global_269_0);
    }
    id v36 = (id)currentAccountCopyTokenWithBundleID_version_reply____personalPersona;
    int v37 = 1;
LABEL_32:
    v38 = [MEMORY[0x263F841B0] sharedManager];
      ...
      if (voucher_process_can_use_arbitrary_personas())
      {
        ...
        *(void *)buf = v48;
        ...
        if (os_log_type_enabled(v54, (os_log_type_t)0x90u))
        {
          ...
          *(void *)&ctx.ctx[6] = v53;
          _os_log_error_impl(&dword_23FA42000, v54, (os_log_type_t)0x90u, "[ERROR] Can't adopt persona %@: %@%@", (uint8_t *)&ctx, 0x20u);
        }
      }
      else
      {
        if (!v37 || ([v63 isDataSeparatedPersona] & 1) != 0)
        {
          ...
          v40 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F08438] code:22 userInfo:0];
          goto LABEL_35;
        }
        v53 = brc_bread_crumbs();
        v54 = brc_default_log();
      ...
      if (v43)
      {
        ...
        if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)((char *)&ctx.ctx[8] + 2) = v57;
          _os_log_impl(&dword_23FA42000, v58, OS_LOG_TYPE_INFO, "[INFO] %@: reply(%@, %@)%@", (uint8_t *)&ctx, 0x2Au);
        }
...
LABEL_3:
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)((char *)&ctx.ctx[3] + 2) = v56;
      HIWORD(ctx.ctx[5]) = 2112;
      *(void *)&ctx.ctx[6] = v14;
      _os_log_debug_impl(&dword_23FA42000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: %@%@", (uint8_t *)&ctx, 0x20u);
    }
    if (v13 == 1 || v13 == 253)
    {
            ...
            v12))
      {
        ...
        v27 = [MEMORY[0x263EFF8F8] dataWithBytes:macOut length:20];
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&buf[4] = self;
          ...
          __int16 v71 = 2112;
          v72 = v28;
          _os_log_impl(&dword_23FA42000, v29, OS_LOG_TYPE_INFO, "[INFO] %@: reply(%@, %@)%@", buf, 0x2Au);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)((char *)&ctx.ctx[8] + 2) = v46;
          _os_log_impl(&dword_23FA42000, v47, OS_LOG_TYPE_INFO, "[INFO] %@: reply(%@, %@)%@", (uint8_t *)&ctx, 0x2Au);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)((char *)&ctx.ctx[8] + 2) = v32;
        _os_log_impl(&dword_23FA42000, v33, OS_LOG_TYPE_INFO, "[INFO] %@: reply(%@, %@)%@", (uint8_t *)&ctx, 0x2Au);
      }
...
LABEL_22:
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)((char *)&ctx.ctx[8] + 2) = v34;
    _os_log_impl(&dword_23FA42000, v35, OS_LOG_TYPE_INFO, "[INFO] %@: reply(%@, %@)%@", (uint8_t *)&ctx, 0x2Au);
  }
...
- (void)getPrimaryiCloudAccountStatus:(id)a3
{
  ...
  __brc_create_section(1, (uint64_t)"-[BRCXPCTokenClient getPrimaryiCloudAccountStatus:]", 1458, v46);
  id v4 = brc_bread_crumbs();
  objc_super v5 = brc_default_log();
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    __int16 v57 = 2112;
    v58 = v4;
    _os_log_impl(&dword_23FA42000, v5, OS_LOG_TYPE_INFO, "[INFO] ┏%llx %@ (%@) %s %@", buf, 0x34u);
  }
  ...
  id v42 = v3;
  id v45 = v42;
  int v9 = _brc_ipc_check_logged_status(self, 0, v44);

  if (v9)
  {
    id v10 = +[BRCAccountHandler currentiCloudAccount];
    uint64_t v11 = [v10 isEnabledForDataclass:*MEMORY[0x263EFB4C0]];
    uint64_t v12 = objc_msgSend(v10, "br_isCloudDocsMigrationComplete");
    v40 = objc_msgSend(v10, "br_dsid");
    uint64_t v13 = +[BRCAccountsManager sharedManager];
    v14 = [v10 identifier];
    v41 = [v13 accountHandlerForACAccountID:v14];
    ...
    uint64_t v19 = BRGetMigrationStatusForDSID();
    v20 = [v41 loggedOutError];
    uint64_t v21 = objc_msgSend(v20, "br_isCloudDocsErrorCode:", 22);
    int v37 = v20;
    v22 = [v41 session];
    __int16 v23 = [v22 clientState];
    v38 = [v23 objectForKeyedSubscript:@"kBRCFPFSMigrationStateKey"];

    if (v38) {
      BOOL v24 = [v38 intValue] != 3;
    }
    else {
      BOOL v24 = 0;
    }
    v47[0] = *MEMORY[0x263F322F8];
    id v39 = [NSNumber numberWithChar:v19];
    v48[0] = v39;
    v47[1] = *MEMORY[0x263F322D8];
    __int16 v25 = [NSNumber numberWithBool:v11];
    v48[1] = v25;
    v47[2] = *MEMORY[0x263F322C0];
    size_t v26 = [NSNumber numberWithBool:v12];
    v48[2] = v26;
    v47[3] = *MEMORY[0x263F322C8];
    uint64_t v27 = [NSNumber numberWithBool:v21];
    v48[3] = v27;
    v47[4] = *MEMORY[0x263F322E8];
    v28 = objc_msgSend(NSNumber, "numberWithBool:", objc_msgSend(v10, "br_isEnabledForDesktopSync"));
    v48[4] = v28;
    v47[5] = *MEMORY[0x263F322F0];
    v29 = objc_msgSend(NSNumber, "numberWithBool:", objc_msgSend(v10, "br_isEnabledForDesktopSync"));
    v48[5] = v29;
    v47[6] = *MEMORY[0x263F322E0];
    v30 = NSNumber;
    v31 = [(BRCXPCClient *)self session];
    v32 = [v30 numberWithInt:v31 != 0];
    v48[6] = v32;
    v47[7] = *MEMORY[0x263F322D0];
    v33 = [NSNumber numberWithBool:v24];
    v48[7] = v33;
    v34 = [NSDictionary dictionaryWithObjects:v48 forKeys:v47 count:8];
    ...
    (*((void (**)(id, BRCXPCTokenClient *, void))v42 + 2))(v42, v34, 0);
  }
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: should have an account dsid%@", v2, v3, v4, v5, v6);
}

- (void)getPrimaryiCloudAccountStatus:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] checking status for %@%@");
}

- (void)getPrimaryiCloudAccountStatus:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] account: %@%@");
}
