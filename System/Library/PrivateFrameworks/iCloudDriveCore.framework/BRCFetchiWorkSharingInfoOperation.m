...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_23FA42000, "sharing/iWork-publishing-fetch", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  uint64_t v6 = *MEMORY[0x263EFD5A0];
  v10[0] = *MEMORY[0x263EFD5A8];
  v10[1] = v6;
  uint64_t v7 = *MEMORY[0x263EFD5B0];
  v10[2] = *MEMORY[0x263EFD598];
  v10[3] = v7;
  v8 = [MEMORY[0x263EFF8C0] arrayWithObjects:v10 count:4];
...
void __41__BRCFetchiWorkSharingInfoOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  objc_msgSend(MEMORY[0x263F087E8], "br_errorWithDomain:code:description:", *MEMORY[0x263F32430], 15, @"unreachable: No error and invalid number of records %lu", objc_msgSend(v5, "count"));
...
void __41__BRCFetchiWorkSharingInfoOperation_main__block_invoke_cold_1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v7 = 2112;
  uint64_t v8 = a2;
  _os_log_fault_impl(&dword_23FA42000, a3, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: No error and invalid number of records %lu%@", (uint8_t *)&v5, 0x16u);
}
