...
- (BRCClientState)init
{
  return [(BRCClientState *)self initWithDictionary:MEMORY[0x263EFFA78] clientStateData:0];
}
...
- (id)_stateToData
{
  ...
  dict = self->_dict;
  id v10 = 0;
  v4 = [MEMORY[0x263F08910] archivedDataWithRootObject:dict requiringSecureCoding:1 error:&v10];
  if (v10)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT)) {
      __52__BRCDaemonFPFS_listener_shouldAcceptNewConnection___block_invoke_131_cold_1(v6, (uint64_t)v7, v8);
    }
...
- (id)objectForKey:(id)a3
{
  ...
  id v16 = __Block_byref_object_dispose__53;
  id v17 = 0;
  queue = self->_queue;
...
- (void)hasStateChangesAndClearSaveStatusWithResultingState:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_23FA42000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: data%@", (uint8_t *)&v2, 0xCu);
}
