...
- (BRCContainerScheduler)initWithAccountSession:(id)a3 pushWorkloop:(id)a4
{
  ...
  if (v7)
  {
    ...
    v10 = [(BRCAccountSessionFPFS *)v7->_session clientState];
    ...
    v28 = [MEMORY[0x263F325E0] containerMetadataMangledID];
    ...
    v32 = [MEMORY[0x263F325E0] containerMetadataMangledID];
    ...
    v39 = [MEMORY[0x263F325E0] sharedDatabaseMangledID];
    ...
    v46 = [MEMORY[0x263F325E0] zoneHealthMangledID];
    ...
    v50 = [MEMORY[0x263F325E0] zoneHealthMangledID];
    ...
    v60 = [MEMORY[0x263F325E0] sideCarMangledID];
    ...
    v64 = [MEMORY[0x263F325E0] sideCarMangledID];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Enabling push topics registration%@", v2, v3, v4, v5, v6);
}
...
- (id)_newSyncDeadlineSourceWithName:(id)a3
{
  ...
  uint8_t v6 = [(BRCAccountSessionFPFS *)self->_session defaultScheduler];
...
- (void)_unscheduleClientZone:(id)a3
{
  ...
  if ([v3 isPrivateZone])
  {
    ...
    long long v16 = 0u;
    id v14 = v3;
    uint64_t v5 = [v3 asPrivateClientZone];
    uint8_t v6 = [v5 appLibraries];
        ...
        do
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v21 = 2112;
            v22 = v12;
            _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] unscheduling app library %@%@", buf, 0x16u);
          }
...
- (void)closeContainers
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx shutting down periodic metadata sync%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_40(uint64_t a1)
{
  ...
  [*(id *)(*(void *)(a1 + 32) + 72) setEnabledTopics:MEMORY[0x263EFFA68] ignoredTopics:MEMORY[0x263EFFA68] opportunisticTopics:MEMORY[0x263EFFA68]];
...
void __30__BRCContainerScheduler_close__block_invoke(uint64_t a1)
{
  ...
  uint64_t v7 = BRPersonaSpecificName();
...
- (void)setup
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx loading containers%@");
}
...
- (void)schedulePeriodicSyncInGroup:(id)a3 completion:(id)a4
{
  ...
  {
    uint64_t v9 = objc_msgSend(MEMORY[0x263F087E8], "brc_errorOperationAlreadyRunning:", @"Periodic Sync");
    v7[2](v7, v9);
  }
  else
  {
    ...
    long long v15 = [(BRCSideCarSyncPersistedState *)self->_sideCarSyncPersistedState serverChangeToken];
    ...
    uint64_t v18 = [(BRCAccountSessionFPFS *)self->_session clientTruthWorkloop];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Sync: resuming sync%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] marking side-car needs-sync-up%@", v2, v3, v4, v5, v6);
}
...
- (void)_syncScheduleForContainersMetadata
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx scheduling container-metadata sync%@");
}
...
void __59__BRCContainerScheduler__syncScheduleForContainersMetadata__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  *(void *)(v6 + 104) = 0;
  ...
  if (v8)
  {
    ...
    id v11 = (void *)[v10 initWithZoneName:*MEMORY[0x263F324D8] ownerName:*MEMORY[0x263EFD488]];
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v42 = 2112;
      v43 = v17;
      _os_log_debug_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx resetting container-metadata: %s%@", buf, 0x20u);
    }

    if (v8 >= 2)
    {
      [*(id *)(*(void *)(a1 + 32) + 8) enumerateAppLibraries:&__block_literal_global_22];
      v9 |= 1u;
    }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v42 = 2112;
    v43 = v20;
    _os_log_debug_impl(&dword_23FA42000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] Container metadata sync state (%@) -> (%@)%@", buf, 0x20u);
  }
...
- (void)_syncScheduleForSharedDatabase
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx scheduling shared-db sync%@");
}
  ...
  *(void *)(v7 + 152) = 0;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&v16[4] = v15;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v9;
    _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished sharedb sync down with more coming: %s, error %@%@", v16, 0x20u);
  }
...
- (void)_syncScheduleForZoneHealth
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx scheduling zone-health sync%@");
}
  ...
  if (objc_msgSend(v5, "brc_containerResetErrorForSharedZone:resetReason:", 0, &v32))
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v38 = v17;
      _os_log_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Resetting zone health%@", buf, 0xCu);
    }

    id v19 = objc_alloc(MEMORY[0x263F325E0]);
    uint64_t v20 = (void *)[v19 initWithZoneName:*MEMORY[0x263F32550] ownerName:*MEMORY[0x263EFD488]];
    uint64_t v21 = [*(id *)(*(void *)(a1 + 32) + 8) clientZoneByMangledID:v20];
    uint64_t v22 = [v21 enhancedDrivePrivacyEnabled];
    id v23 = [*(id *)(*(void *)(a1 + 32) + 176) lastSyncDownDate];
...
- (void)_syncScheduleForSideCar
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx scheduling side-car sync%@");
}
...
void __48__BRCContainerScheduler__syncScheduleForSideCar__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  *(void *)(v7 + 248) = 0;
  ...
  {
    id v10 = objc_alloc(MEMORY[0x263F325E0]);
    uint64_t v11 = (void *)[v10 initWithZoneName:*MEMORY[0x263F327C8] ownerName:*MEMORY[0x263EFD488]];
    uint64_t v12 = [*(id *)(*(void *)(a1 + 32) + 8) clientZoneByMangledID:v11];
    uint64_t v13 = [v12 enhancedDrivePrivacyEnabled];
    ...
    v24[3] = &unk_26507ED70;
    v24[4] = *(void *)(a1 + 32);
    dispatch_async_with_logs_4(v17, v24);
...
LABEL_13:
  *(_DWORD *)(*(void *)(a1 + 32) + 240) &= 0xFFFFFFF3;
  ...
  if ((*(unsigned char *)(v22 + 240) & 3) == 0)
  {
    ...
    id v23 = [*(id *)(*(void *)(a1 + 32) + 8) clientDB];
    [v23 forceBatchStart];
...
uint64_t __48__BRCContainerScheduler__syncScheduleForSideCar__block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    uint64_t v7 = v2;
    _os_log_impl(&dword_23FA42000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Resetting side car zone%@", (uint8_t *)&v6, 0xCu);
  }
...
- (void)dumpToContext:(id)a3 includeAllItems:(BOOL)a4 db:(id)a5
{
  ...
  double v10 = +[BRCSystemResourcesManager manager];
  ...
  {
    v79 = +[BRCDumpContext stringFromErrorString:@"offline" context:v7];
  }
  if ([v10 isPowerOK])
  {
    uint64_t v78 = @"healthy";
  }
  else
  {
    uint64_t v78 = +[BRCDumpContext stringFromErrorString:@"low" context:v7];
  }
  double v11 = [(BRCAccountSessionFPFS *)self->_session volume];
  char v12 = objc_msgSend(v10, "hasEnoughSpaceForDevice:", objc_msgSend(v11, "deviceID"));
  ...
  {
    id v13 = +[BRCDumpContext stringFromErrorString:@"low disk" context:v7];
  }
  uint64_t v14 = +[BRCContainerCellularSettings containerCellularSettings];
  char v15 = [v14 isCellularEnabled];
  ...
  {
    v77 = +[BRCDumpContext stringFromErrorString:@"disabled" context:v7];
  }
  v73 = (void *)v9;
  v80 = (void *)[v8 fetchObjectOfClass:objc_opt_class() sql:@"SELECT COUNT(*) from server_items"];
  uint64_t v76 = (void *)[v8 fetchObjectOfClass:objc_opt_class() sql:@"SELECT COUNT(*) from client_items"];
  BOOL v72 = (unint64_t)[v76 unsignedLongLongValue] > 0x3E8
     || (unint64_t)[v80 unsignedLongLongValue] >= 0x3E9;
  double v16 = [(BRCAccountSessionFPFS *)self->_session volume];
  double v17 = [v16 fsTypeName];
  uint64_t v18 = [v17 uppercaseString];
  uint64_t v19 = [v7 highlightedString:v18 type:7];
  ...
  int v21 = self;
  objc_sync_enter(v21);
  environmentName = v21->_environmentName;
  if (environmentName)
  {
    v75 = environmentName;
  }
  ...
  {
    v75 = +[BRCDumpContext stringFromErrorString:@"no environment" context:v7];
  }
  id v23 = [(NSData *)v21->_pushToken description];
  id v24 = v23;
  uint64_t v70 = v8;
  if (v23)
  {
  ...
  {
    id v74 = +[BRCDumpContext stringFromErrorString:@"no token" context:v7];
  }

  objc_sync_exit(v21);
  id v25 = [(BRCAccountSessionFPFS *)self->_session fsUploader];
  uint64_t v26 = [v25 quotaAvailableForOwner:*MEMORY[0x263EFD488]];

  int v27 = [(objc_class *)getUIDeviceClass() currentDevice];
  unsigned int v28 = [v27 name];

  [v7 writeLineWithFormat:@"system"];
  [v7 writeLineWithFormat:@"-----------------------------------------------------"];
  [v7 pushIndentation];
  [v7 writeLineWithFormat:@"+ network: %@", v79];
  [v7 writeLineWithFormat:@"+ disk:    %@", v20];
  [v7 writeLineWithFormat:@"+ power:   %@", v78];
  BOOL v29 = [(BRCAccountSessionFPFS *)self->_session hasOptimizeStorageEnabled];
  uint64_t v30 = "disabled";
  if (v29) {
    uint64_t v30 = "enabled";
  }
  objc_msgSend(v7, "writeLineWithFormat:", @"+ optimize storage: %s", v30);
  uint64_t v31 = objc_msgSend(v28, "fp_obfuscatedFilename");
  [v7 writeLineWithFormat:@"+ device name:   %@", v31];

  [v7 writeLineWithFormat:@"+ cellular: %@", v77];
  [v7 popIndentation];
  [v7 writeLineWithFormat:&stru_26F3822F0];
  [v7 writeLineWithFormat:@"scheduler"];
  [v7 writeLineWithFormat:@"-----------------------------------------------------"];
  [v7 pushIndentation];
  id v32 = +[BRCDumpContext stringFromCount:context:](BRCDumpContext, "stringFromCount:context:", [v76 unsignedLongLongValue], v7);
  long long v33 = +[BRCDumpContext stringFromCount:context:](BRCDumpContext, "stringFromCount:context:", [v80 unsignedLongLongValue], v7);
  [v7 writeLineWithFormat:@"+ items:                 client:%@, server: %@", v32, v33];

  if (v72)
  {
    long long v34 = +[BRCDumpContext highlightedString:@"output may be truncated" type:3 context:v7];
    [v7 writeLineWithFormat:@"                         warning: %@", v34];
  }
  [v7 writeLineWithFormat:@"+ push environment:      %@", v75];
  [v7 writeLineWithFormat:@"+ push token:            %@", v74];
  long long v35 = [(BRCSyncBudgetThrottle *)v21->_syncUpBudget debugDescriptionWithDefaults:v73];
  [v7 writeLineWithFormat:@"+ global sync up budget: %@", v35];

  uint64_t v36 = [(BRCOperationSubclass *)v21->_periodicSyncOperation descriptionWithContext:v7];
  id v37 = (void *)v36;
  v38 = @"idle";
  if (v36) {
    v38 = (__CFString *)v36;
  }
  [v7 writeLineWithFormat:@"+ periodic sync:         %@", v38];

  if (v26)
  {
    v39 = +[BRCDumpContext stringFromByteCount:context:](BRCDumpContext, "stringFromByteCount:context:", [v26 longLongValue], v7);
    uint64_t v40 = [(BRCAccountSessionFPFS *)self->_session fsUploader];
    int v41 = [v40 isDefaultOwnerOutOfQuota];
    __int16 v42 = @" [pending-quota]";
    if (!v41) {
      __int16 v42 = &stru_26F3822F0;
    }
    [v7 writeLineWithFormat:@"+ available quota:       %@%@", v39, v42];
  }
  uint64_t v43 = brc_current_date_nsec();
  uint64_t v44 = v28;
  if (v21->_containerMetadataSyncState)
  {
    BRCPrettyPrintBitmap();
  ...
  uint64_t v46 = [(BRCOperationSubclass *)v21->_containerMetadataSyncOperation descriptionWithContext:v7];
  ...
  [v7 writeLineWithFormat:@"+ container-metadata:    %@ %@", v45, v48];

  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_containerMetadataSyncDownThrottle context:v7 error:v21->_lastContainerMetadataSyncDownError now:v43];
  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_containerMetadataSyncUpThrottle context:v7 error:v21->_lastContainerMetadataSyncUpError now:v43];
  if (v21->_sharedDBSyncState)
  {
    BRCPrettyPrintBitmap();
  ...
  uint64_t v50 = [(BRCOperationSubclass *)v21->_sharedDatabaseSyncOperation descriptionWithContext:v7];
  ...
  [v7 writeLineWithFormat:@"+ sharedb:               %@ %@", v49, v52];

  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_sharedDatabaseSyncDownThrottle context:v7 error:v21->_lastSharedDatabaseSyncDownError now:v43];
  if (v21->_zoneHealthSyncState)
  {
    BRCPrettyPrintBitmap();
  ...
  uint64_t v54 = [(BRCOperationSubclass *)v21->_zoneHealthSyncOperation descriptionWithContext:v7];
  v55 = (void *)v54;
  if (v54) {
    uint64_t v56 = (__CFString *)v54;
  }
  else {
    uint64_t v56 = &stru_26F3822F0;
  }
  [v7 writeLineWithFormat:@"+ zone-health:           %@ %@", v53, v56];

  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_zoneHealthSyncDownThrottle context:v7 error:v21->_lastZoneHealthSyncDownError now:v43];
  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_zoneHealthSyncUpThrottle context:v7 error:v21->_lastZoneHealthSyncUpError now:v43];
  if (v21->_sideCarSyncState)
  {
    BRCPrettyPrintBitmap();
  ...
  uint64_t v58 = [(BRCOperationSubclass *)v21->_sideCarSyncOperation descriptionWithContext:v7];
  v59 = (void *)v58;
  if (v58) {
    v60 = (__CFString *)v58;
  }
  ...
  [v7 writeLineWithFormat:@"+ side-car:              %@ %@", v57, v60];

  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_sideCarSyncDownThrottle context:v7 error:v21->_lastSideCarSyncDownError now:v43];
  [(BRCContainerScheduler *)v21 _printSyncErrorIfNecessaryWithThrottle:v21->_sideCarSyncUpThrottle context:v7 error:v21->_lastSideCarSyncUpError now:v43];
  migrateZonePCSOperation = v21->_migrateZonePCSOperation;
  if (migrateZonePCSOperation)
  {
    v62 = [(_BRCOperation *)migrateZonePCSOperation descriptionWithContext:v7];
    [v7 writeLineWithFormat:@"+ pcs-migration:         %@", v62];
  }
  else
  {
    BOOL v63 = [(BRCAccountSessionFPFS *)self->_session PCSMigrationComplete];
    v64 = @"unfinished";
    if (v63) {
      v64 = @"complete";
    }
    [v7 writeLineWithFormat:@"+ pcs-migration:         %@", v64];
  }
  char v81 = 0;
  uint64_t v65 = [(BRCAccountSessionFPFS *)self->_session fetchAccountWaitOperationWithAccountReady:&v81];
  v66 = v65;
  if (v65)
  {
    v67 = v71;
    if (([v65 isFinished] & 1) == 0)
    {
      uint64_t v68 = [v66 descriptionWithContext:v7];
LABEL_67:
      v69 = (void *)v68;
      [v7 writeLineWithFormat:@"+ account: %@", v68];
    }
  }
  else
  {
    ...
    if (!v81)
    {
      uint64_t v68 = [v7 highlightedString:@"not ready" type:3];
      goto LABEL_67;
    }
  }
  [v7 popIndentation];
...
- (void)receivedUpdatedZoneHealthServerChangeToken:(id)a3 requestID:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    uint64_t v9 = [v6 descriptionWithContext:0];
    int v10 = 138412802;
    double v11 = v9;
    __int16 v12 = 2048;
    unint64_t v13 = a4;
    __int16 v14 = 2112;
    char v15 = v7;
    _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated zone health sync token:%@ requestID:%lld%@", (uint8_t *)&v10, 0x20u);
  }
...
- (void)finishedZoneHealthSyncDownWithRequestID:(unint64_t)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v7;
    _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Completed zone health sync requestID:%lld error:%@%@", buf, 0x20u);
  }
  ...
  if (!v6)
  {
    ...
    v10[4] = a3;
    [(BRCAccountSessionFPFS *)session enumeratePrivateClientZones:v10];
...
- (id)internalZoneSyncDownAnalyticsErrors
{
  ...
  {
    uint64_t v9 = [(NSError *)self->_lastSideCarSyncDownError brc_telemetryReportableErrorWithRecordName:0];
    int v10 = [MEMORY[0x263F325E0] sideCarMangledID];
    double v11 = [(BRCContainerScheduler *)self session];
  ...
  double v16 = v15;
  uint64_t v17 = [MEMORY[0x263F325E0] zoneHealthMangledID];
  ...
  if (v16 > v20)
  {
    ...
    uint64_t v22 = [MEMORY[0x263F325E0] zoneHealthMangledID];

    id v23 = [(BRCContainerScheduler *)self session];
    ...
    int v27 = [MEMORY[0x263F325E0] zoneHealthMangledID];
  ...
  if (v29 > v32)
  {
    ...
    uint64_t v34 = [MEMORY[0x263F325E0] containerMetadataMangledID];

    long long v35 = [(BRCContainerScheduler *)self session];
    uint64_t v36 = [v35 clientZoneByMangledID:v34];
  ...
  double v40 = v39;
  int v41 = +[BRCUserDefaults defaultsForSharedZone];
  ...
  if (v40 > v43)
  {
    ...
    uint64_t v45 = [MEMORY[0x263F325E0] sharedDatabaseMangledID];

    uint64_t v46 = [(BRCContainerScheduler *)self session];
    uint64_t v47 = [v46 clientZoneByMangledID:v45];
...
- (id)internalZoneSyncUpAnalyticsErrors
{
  ...
  {
    uint64_t v9 = [(NSError *)self->_lastSideCarSyncUpError brc_telemetryReportableErrorWithRecordName:0];
    int v10 = [MEMORY[0x263F325E0] sideCarMangledID];
    double v11 = [(BRCContainerScheduler *)self session];
    unint64_t v12 = [v11 clientZoneByMangledID:v10];
    uint64_t v13 = [v12 enhancedDrivePrivacyEnabled];
  ...
  if (v28 > v31)
  {
    ...
    uint64_t v33 = [MEMORY[0x263F325E0] containerMetadataMangledID];

    uint64_t v34 = [(BRCContainerScheduler *)self session];
    long long v35 = [v34 clientZoneByMangledID:v33];
...
- (void)receivedUpdatedSideCarServerChangeToken:(id)a3 requestID:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v14 = 2112;
    double v15 = v7;
    _os_log_debug_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Updated side car sync token:%@ requestID:%lld%@", (uint8_t *)&v10, 0x20u);
  }
...
- (void)_scheduleCrossZoneMovePCSPrep
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx starting cross zone move migration PCS prep%@");
}
...
- (void)syncContextDidBecomeForeground:(id)a3
{
  ...
  id v30 = a3;
  double v4 = [(BRCAccountSessionFPFS *)self->_session personaIdentifier];
  if ([v4 isEqualToString:@"__defaultPersonaID__"])
  {
  }
  else
  {
    id v5 = [(BRCAccountSessionFPFS *)self->_session personaIdentifier];
  ...
  if (syncContextDidBecomeForeground____personaOnceToken != -1) {
    dispatch_once(&syncContextDidBecomeForeground____personaOnceToken, &__block_literal_global_243);
  }
  id v5 = (id)syncContextDidBecomeForeground____personalPersona;
  int v6 = 1;
LABEL_8:
  double v7 = [MEMORY[0x263F841B0] sharedManager];
  ...
  if (voucher_process_can_use_arbitrary_personas())
  {
    ...
    double v11 = [v8 generateAndRestorePersonaContextWithPersonaUniqueString:v5];
    ...
    if (v11)
    {
      ...
      {
        double v27 = [(BRCAccountSessionFPFS *)self->_session personaIdentifier];
        *(_DWORD *)buf = 138412802;
        uint64_t v34 = v27;
        __int16 v35 = 2112;
        uint64_t v36 = v11;
...
LABEL_34:
  ...
  else
  {
    ...
    double v11 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F08438] code:22 userInfo:0];
  }
LABEL_11:
  ...
  if (([v12 isShared] & 1) == 0)
  {
    ...
    __int16 v14 = [(BRCAccountSessionFPFS *)self->_session appLibraryByID:v13];
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        uint64_t v34 = v17;
        _os_log_impl(&dword_23FA42000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Container became foreground that we didn't think was installed, forcing an apps list refresh%@", buf, 0xCu);
      }
...
- (void)syncContextDidBecomeBackground:(id)a3
{
  ...
  {
    id v6 = [(BRCAccountSessionFPFS *)self->_session personaIdentifier];
  ...
  if (syncContextDidBecomeBackground____personaOnceToken != -1) {
    dispatch_once(&syncContextDidBecomeBackground____personaOnceToken, &__block_literal_global_248);
  }
  id v6 = (id)syncContextDidBecomeBackground____personalPersona;
  int v7 = 1;
LABEL_8:
  double v8 = [MEMORY[0x263F841B0] sharedManager];
  ...
  if (voucher_process_can_use_arbitrary_personas())
  {
    ...
    if (v12)
    {
      ...
      {
        double v20 = [(BRCAccountSessionFPFS *)self->_session personaIdentifier];
        *(_DWORD *)buf = 138412802;
        uint64_t v26 = v20;
        __int16 v27 = 2112;
        double v28 = v12;
...
LABEL_28:
  ...
  else
  {
    ...
    __int16 v12 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F08438] code:22 userInfo:0];
  }
LABEL_11:
  [(BRCContainerScheduler *)self _scheduleUpdatePushTopicsRegistration];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] scheduling push topics registration%@", v2, v3, v4, v5, v6);
}

- (void)_updatePushTopicsRegistration
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] Assertion failed: !_isInSyncBubble%@", v2, v3, v4, v5, v6);
}
...
uint64_t __54__BRCContainerScheduler__updatePushTopicsRegistration__block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    uint64_t v5 = *MEMORY[0x263F32478];
...
- (void)connection:(id)a3 didReceiveToken:(id)a4 forTopic:(id)a5 identifier:(id)a6
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v12;
    _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] received %@ push token %@ for %@:%@%@", (uint8_t *)&v15, 0x34u);
  }
}
...
- (void)_connection:(id)a3 didReceiveIncomingMessage:(id)a4
{
  ...
  id v79 = v6;
  v77 = session;
  double v8 = [@"com.apple.icloud-container." stringByAppendingString:*MEMORY[0x263F32478]];
  id v9 = [v79 topic];
  ...
  if (session)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      {
        v73 = [v12 objectForKeyedSubscript:@"met"];
        id v74 = @"fet";
        *(_DWORD *)buf = 138412802;
        if (v73) {
          id v74 = @"met";
        ...
        *(_WORD *)&buf[22] = 2112;
        ...
        _os_log_fault_impl(&dword_23FA42000, v23, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid push payload[%@] %@%@", buf, 0x20u);
      }
      id v16 = 0;
      __int16 v17 = 0;
      id v18 = 0;
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      uint64_t v26 = [(BRCAccountSessionFPFS *)v77 cachedCurrentUserRecordName];
      if (v26 && [v22 isEqualToString:v26])
      {
        __int16 v27 = (id)*MEMORY[0x263EFD488];

        id v22 = v27;
      }
      id v16 = (id)[objc_alloc(MEMORY[0x263F325E0]) initWithZoneName:v19 ownerName:v22];
      id v18 = v11;
    }
    else
    {
...
LABEL_34:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    ...
    _os_log_fault_impl(&dword_23FA42000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid push topic '%s' (expected prefix '%s')%@", buf, 0x20u);
  }
  id v16 = 0;
  __int16 v17 = 0;
  id v18 = 0;
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&v95[12] = v54;
      ...
      __int16 v98 = 2112;
      v99 = v31;
      _os_log_debug_impl(&dword_23FA42000, v32, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx received a push in the %@ database for topic:'%@' payload:%@ token:%@ priority:%ld%@", buf, 0x48u);
    }
    kdebug_trace();
    uint64_t v33 = objc_msgSend(MEMORY[0x263EFD780], "br_syncDownPushTriggered");
    uint64_t v34 = [v29 appLibraryOrZoneName];
    int v35 = [v34 isEqualToString:*MEMORY[0x263F324D8]];
    ...
    if (v35)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&uint8_t buf[4] = v36;
        _os_log_impl(&dword_23FA42000, v37, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for the container-metadata zone%@", buf, 0xCu);
      }
    ...
    int v41 = [v40 isEqualToString:*MEMORY[0x263F32550]];
    ...
    if (v41)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&uint8_t buf[4] = v42;
        _os_log_impl(&dword_23FA42000, v43, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for the zone-health zone%@", buf, 0xCu);
      }
    ...
    int v45 = [v44 isEqualToString:*MEMORY[0x263F327C8]];
    ...
    if (v45)
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&uint8_t buf[4] = v46;
        _os_log_impl(&dword_23FA42000, v47, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for the side-car zone%@", buf, 0xCu);
      }
    ...
    *(void *)&v95[8] = [(BRCAccountSessionFPFS *)v78->_session clientZoneByMangledID:v29];
    uint64_t v48 = [(BRCAccountSessionFPFS *)v78->_session appLibraryByMangledID:v29];
    v49 = v48;
    if (*(void *)(*(void *)&buf[8] + 40))
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)v87 = 138412546;
        ...
        __int16 v89 = 2112;
        id v90 = v50;
        _os_log_impl(&dword_23FA42000, v51, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for client zone %@%@", v87, 0x16u);
      }
    }
    else if (v48)
    {
      ...
      *(void *)(*(void *)&buf[8] + 40) = v57;
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)v87 = 138412802;
        ...
        __int16 v91 = 2112;
        id v92 = v50;
        _os_log_impl(&dword_23FA42000, v51, OS_LOG_TYPE_DEFAULT, "[NOTICE] received a push for app library %@ -> zone %@%@", v87, 0x20u);
      }
    }
    else
    {
      if ([v29 isShared])
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)v87 = 138412546;
          ...
          __int16 v89 = 2112;
          id v90 = v62;
          _os_log_impl(&dword_23FA42000, v63, OS_LOG_TYPE_DEFAULT, "[NOTICE] receiving a push for an unknown ID shared zone %@, creating the zone%@", v87, 0x16u);
        }

        uint64_t v64 = [(BRCAccountSessionFPFS *)v78->_session getOrCreateSharedZones:v29];
        uint64_t v50 = *(void **)(*(void *)&buf[8] + 40);
        *(void *)(*(void *)&buf[8] + 40) = v64;
        goto LABEL_71;
      }
      uint64_t v65 = v78->_session;
      id v66 = objc_alloc(MEMORY[0x263F325E0]);
      v67 = (void *)[v66 initWithZoneName:*MEMORY[0x263F324E8] ownerName:0];
      uint64_t v68 = [(BRCAccountSessionFPFS *)v65 clientZoneByMangledID:v67];
      ...
      *(void *)(*(void *)&buf[8] + 40) = v68;
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)v87 = 138412546;
        ...
        __int16 v89 = 2112;
        id v90 = v50;
        _os_log_impl(&dword_23FA42000, v51, OS_LOG_TYPE_DEFAULT, "[NOTICE] receiving a push for an unknown ID %@ -> com.apple.CloudDocs%@", v87, 0x16u);
      }
    }
  ...
  if (*(void *)(*(void *)(*(void *)(a1 + 64) + 8) + 40))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v20 = 2112;
      int v21 = v3;
      _os_log_debug_impl(&dword_23FA42000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx scheduling sync down for client zone %@ because of a push%@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      ...
      _os_log_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] no zone found, dropping the push%@", buf, 0xCu);
    }
  }
...
- (void)connection:(id)a3 didReceiveIncomingMessage:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  double v8 = [(BRCAccountSessionFPFS *)self->_session personaIdentifier];
  id v11 = v7;
  id v9 = v7;
  id v10 = v6;
...
void __59__BRCContainerScheduler_notifyAfterNextZoneHealthSyncDown___block_invoke(uint64_t a1)
{
  ...
  id v6 = (id)MEMORY[0x2455D9A50](*(void *)(a1 + 40));
  [v2 addObject:v6];
}
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] Push notification source created in a disabled state%@", v2, v3, v4, v5, v6);
}
...
void __61__BRCContainerScheduler_initWithAccountSession_pushWorkloop___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Sync: no global budget anymore: %@%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx cancelling sideCarSyncSource%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx cancelling migrateZonePCSSource%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_3()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx cancelling zoneHealthSyncSource%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_4()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx cancelling sharedDatabaseSyncSource%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_cold_5()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx cancelling containerMetadataSyncSource...%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_37_cold_1()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx cancelling periodicSyncOperation%@");
}
...
void __40__BRCContainerScheduler_closeContainers__block_invoke_38_cold_1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] unscheduling client zone %@%@", (void)v3, DWORD2(v3));
}
...
- (void)schedulePeriodicSyncInGroup:completion:.cold.1()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx Considering containers needing forced sync down%@");
}
...
void __64__BRCContainerScheduler_schedulePeriodicSyncInGroup_completion___block_invoke_cold_1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v1, v2, "[ERROR] periodic sync failed %@%@", (void)v3, DWORD2(v3));
}
...
- (void)didInitialSyncDownForClientZone:.cold.1()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx just synced down the default container%@");
}

void __71__BRCContainerScheduler_scheduleSyncDownForContainerMetadataWithGroup___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] marking container-metadata needs-sync-down%@", v2, v3, v4, v5, v6);
}

void __70__BRCContainerScheduler_scheduleSyncDownForSharedDatabaseImmediately___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] scheduling sync for sharedb in %llus%@");
}

void __64__BRCContainerScheduler_scheduleSyncDownForZoneHealthWithGroup___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] scheduling sync for zone-health%@", v2, v3, v4, v5, v6);
}

void __61__BRCContainerScheduler_scheduleSyncDownForSideCarWithGroup___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] scheduling sync for side-car%@", v2, v3, v4, v5, v6);
}

void __47__BRCContainerScheduler_redoZonePCSPreperation__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] scheduling sync for zone-pcs%@", v2, v3, v4, v5, v6);
}

void __70__BRCContainerScheduler_didChangeSyncStatusForZoneHealthForContainer___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] marking zone-health needs-sync-up%@", v2, v3, v4, v5, v6);
}

void __77__BRCContainerScheduler_didChangeSyncStatusForContainerMetadataForContainer___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_4_0(&dword_23FA42000, v0, v1, "[DEBUG] marking container-metadata needs-sync-up%@", v2, v3, v4, v5, v6);
}
...
- (void)syncContextDidBecomeForeground:(uint64_t)a1 .cold.1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_4(&dword_23FA42000, v1, v2, "[ERROR] won't restore persona: %@%@", (void)v3, DWORD2(v3));
}
...
- (void)connection:(uint64_t)a1 didReceivePublicToken:.cold.1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  OUTLINED_FUNCTION_1_0();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v1, v2, "[DEBUG] received public push token %@%@", (void)v3, DWORD2(v3));
}
...
- (void)_connection:(NSObject *)a3 didReceiveIncomingMessage:.cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v12 = 2112;
  uint64_t v13 = a2;
  _os_log_error_impl(&dword_23FA42000, a3, (os_log_type_t)0x90u, "[ERROR] unable to parse push for topic:'%@' payload:%@%@", (uint8_t *)&v8, 0x20u);
}
...
- (void)_connection:didReceiveIncomingMessage:.cold.2()
{
  ...
  OUTLINED_FUNCTION_8_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: invalid push ZoneOwnerID at payload[%@] %@%@", v2);
}
...
- (void)_connection:didReceiveIncomingMessage:.cold.3()
{
  int v2 = 138412802;
  OUTLINED_FUNCTION_6_1();
  OUTLINED_FUNCTION_8_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: invalid push DatabaseScope at payload[%@] %@%@", v2);
}
...
- (void)_connection:didReceiveIncomingMessage:.cold.4()
{
  int v2 = 138412802;
  OUTLINED_FUNCTION_6_1();
  OUTLINED_FUNCTION_8_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: invalid push ZoneIdentifier at payload[%@] %@%@", v2);
}
...
- (void)_connection:didReceiveIncomingMessage:.cold.5()
{
  int v2 = 138412802;
  OUTLINED_FUNCTION_6_1();
  OUTLINED_FUNCTION_8_0(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: invalid push payload[%@] %@%@", v2);
}
...
void __63__BRCContainerScheduler__connection_didReceiveIncomingMessage___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_11_0(*MEMORY[0x263EF8340]);
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] Also scheduling a sync down on the private zone %@%@");
}

void __62__BRCContainerScheduler_connection_didReceiveIncomingMessage___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2(&dword_23FA42000, v0, v1, "[CRIT] UNREACHABLE: dropping push notification because we can't adopt persona%@", v2, v3, v4, v5, v6);
}
