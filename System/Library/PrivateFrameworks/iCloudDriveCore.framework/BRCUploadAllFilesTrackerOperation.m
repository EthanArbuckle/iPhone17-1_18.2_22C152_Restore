...
- (BRCUploadAllFilesTrackerOperation)initWithSession:(id)a3 appLibraries:(id)a4
{
  ...
  if (v11)
  {
    ...
    v22 = objc_msgSend(MEMORY[0x263EFD780], "br_logout");
...
- (void)cancel
{
  ...
  v3 = [(BRCAccountSessionFPFS *)self->_session clientDB];
  v4 = [v3 serialQueue];
...
- (void)clientZone:(id)a3 didFinishUploadingAllItemsWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v31 = 2112;
    v32 = v9;
    _os_log_debug_impl(&dword_23FA42000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: finished uploading all items in %@: %@%@", buf, 0x2Au);
  }
...
- (void)main
{
  ...
  uint64_t v3 = [(BRCAccountSessionFPFS *)self->_session clientDB];
  ...
  uint64_t v5 = v4;
  id v6 = v18;
  long long v11 = (void *)MEMORY[0x2455D97F0](v6, v7, v8, v9, v10);
  long long v19 = 0uLL;
  uint64_t v20 = 0;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&block[22] = 2112;
    v22 = v12;
    _os_log_debug_impl(&dword_23FA42000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx dispatching to %s%@", block, 0x20u);
  }
  ...
  *(void *)&block[16] = __dispatch_async_with_logs_block_invoke_18;
  v22 = &unk_26507EE60;
  uint64_t v14 = v5;
  uint64_t v23 = v14;
  uint64_t v15 = v6;
