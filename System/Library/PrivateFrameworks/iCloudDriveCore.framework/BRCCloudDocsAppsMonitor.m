...
- (void)_refetchApps
{
  ...
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx refetching installed apps list%@");
}
      ...
      if (v10)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v11; ++i)
          {
            ...
            if (!v15)
            {
              v15 = (void *)[objc_alloc(MEMORY[0x263EFF9C0]) initWithCapacity:1];
...
- (void)forceRefetchAppList
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_23FA42000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] forced a refetch of the list of apps%@", (uint8_t *)&v2, 0xCu);
}

- (void)_start
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx start monitoring cloud apps%@");
}
...
void __39__BRCCloudDocsAppsMonitor_addObserver___block_invoke(uint64_t a1)
{
  ...
  long long v9 = __Block_byref_object_dispose__51;
  id v10 = 0;
...
- (id)applicationIdentifiersForContainerID:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    long long v18 = v5;
    _os_log_debug_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx asked appIDs for %@%@", buf, 0x20u);
  }

  *(void *)buf = 0;
  *(void *)&buf[8] = buf;
  *(void *)&buf[16] = 0x3032000000;
  long long v18 = __Block_byref_object_copy__51;
  long long v19 = __Block_byref_object_dispose__51;
  id v20 = 0;
  queue = self->_queue;
...
- (id)containerIDsForApplicationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    long long v18 = v5;
    _os_log_debug_impl(&dword_23FA42000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx asked containerIDs for %@%@", buf, 0x20u);
  }
...
- (id)allApplicationIdentifiers
{
  ...
  id v14 = __Block_byref_object_copy__51;
...
+ (id)cloudDocsAppsMonitor
{
  if (cloudDocsAppsMonitor_once != -1) {
    dispatch_once(&cloudDocsAppsMonitor_once, &__block_literal_global_63);
  }
...
- (void)dumpToContext:(id)a3
{
  ...
  long long v17 = self;
  dispatch_sync(queue, block);
  [v6 writeLineWithFormat:&stru_26F3822F0];
...
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_1(&dword_23FA42000, v0, v1, "[DEBUG] ┏%llx asked appIDs%@");
}
