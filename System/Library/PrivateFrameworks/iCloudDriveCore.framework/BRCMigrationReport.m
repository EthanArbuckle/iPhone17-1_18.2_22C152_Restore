  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v7;
      _os_log_impl(&dword_23FA42000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed restoring migration report: %@%@", buf, 0x16u);
    }
  }
...
+ (id)cleanupStateURL
{
  v2 = objc_msgSend(NSURL, "brc_ciconiaWorkDirForCurrentPersona");
