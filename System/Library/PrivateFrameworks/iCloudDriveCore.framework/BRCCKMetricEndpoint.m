...
- (void)submitEventMetric:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!v7)
    {
      id v8 = objc_alloc(MEMORY[0x263EFD688]);
    ...
    v15 = [(BRCAccountSessionFPFS *)self->_session syncContextProvider];
...
- (void)submitEventMetric:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_5_0(&dword_23FA42000, v0, (uint64_t)v0, "[DEBUG] analytics: submitting event %@%@", v1);
}
