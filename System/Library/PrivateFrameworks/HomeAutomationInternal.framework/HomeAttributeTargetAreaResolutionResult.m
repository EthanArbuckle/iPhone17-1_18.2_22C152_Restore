...
+ (id)successWithResolvedHomeAttributeTargetArea:(id)a3
{
  ...
  id v4 = a3;
  id v5 = sub_22E6CAB9C((uint64_t)v4);
...
+ (id)confirmationRequiredWithHomeAttributeTargetAreaToConfirm:(id)a3
{
  swift_getObjCClassMetadata();
  id v4 = a3;
  id v5 = sub_22E6CADB4((uint64_t)a3);
...
- (HomeAttributeTargetAreaResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  swift_bridgeObjectRelease();
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for HomeAttributeTargetAreaResolutionResult();
  v8 = [(HomeAttributeTargetAreaResolutionResult *)&v11 initWithJSONDictionary:v7 forIntent:v6];
