...
- (HomeSceneTypeResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for HomeSceneTypeResolutionResult();
  v8 = [(HomeSceneTypeResolutionResult *)&v11 initWithJSONDictionary:v7 forIntent:v6];
