...
- (BOOL)isEqual:(id)a3
{
  return sub_22E329BAC(self, (uint64_t)a2, (uint64_t)a3, (uint64_t (*)(_OWORD *))HomeAttributeValue.isEqual(_:));
}

- (NSString)description
{
  return (NSString *)sub_22E4EDE28(self, (uint64_t)a2, (void (*)(void))HomeAttributeValue.description.getter);
}
...
- (HomeAttributeValue)initWithCoder:(id)a3
{
  ...
  return [(HomeAttributeValue *)&v5 initWithCoder:a3];
}
