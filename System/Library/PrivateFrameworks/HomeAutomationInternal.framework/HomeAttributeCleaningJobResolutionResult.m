...
+ (id)successWithResolvedHomeAttributeCleaningJob:(id)a3
{
  ...
  id v4 = a3;
  id v5 = sub_22E6C9F9C((uint64_t)v4);
...
+ (id)confirmationRequiredWithHomeAttributeCleaningJobToConfirm:(id)a3
{
  swift_getObjCClassMetadata();
  id v4 = a3;
  id v5 = sub_22E6CA1B4((uint64_t)a3);
...
- (HomeAttributeCleaningJobResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  swift_bridgeObjectRelease();
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for HomeAttributeCleaningJobResolutionResult();
  v8 = [(HomeAttributeCleaningJobResolutionResult *)&v11 initWithJSONDictionary:v7 forIntent:v6];
