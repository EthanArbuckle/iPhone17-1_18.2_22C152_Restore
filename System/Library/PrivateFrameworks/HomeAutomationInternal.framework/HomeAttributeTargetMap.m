...
- (BOOL)isEqual:(id)a3
{
  ...
  BOOL v6 = HomeAttributeTargetMap.isEqual(_:)((uint64_t)v8);
...
- (HomeAttributeTargetMap)initWithIdentifier:(id)a3 displayString:(id)a4 pronunciationHint:(id)a5
{
  ...
  return (HomeAttributeTargetMap *)HomeAttributeTargetMap.init(identifier:display:pronunciationHint:)(v6, v8, v9, v11, v12, v14);
}
...
- (HomeAttributeTargetMap)initWithCoder:(id)a3
{
  ...
  return [(HomeAttributeTargetMap *)&v5 initWithCoder:a3];
}
