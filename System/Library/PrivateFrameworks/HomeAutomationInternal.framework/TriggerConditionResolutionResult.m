...
+ (id)successWithResolvedTriggerCondition:(id)a3
{
  ...
  id v4 = a3;
  id v5 = sub_22E6C2D1C((uint64_t)v4);
...
+ (id)confirmationRequiredWithTriggerConditionToConfirm:(id)a3
{
  swift_getObjCClassMetadata();
  id v4 = a3;
  id v5 = sub_22E6C2E78((uint64_t)a3);
...
- (TriggerConditionResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  swift_bridgeObjectRelease();
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for TriggerConditionResolutionResult();
  v8 = [(TriggerConditionResolutionResult *)&v11 initWithJSONDictionary:v7 forIntent:v6];
