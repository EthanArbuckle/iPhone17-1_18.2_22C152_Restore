...
- (DayOfWeekOptionsResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for DayOfWeekOptionsResolutionResult();
  v8 = [(DayOfWeekOptionsResolutionResult *)&v11 initWithJSONDictionary:v7 forIntent:v6];
