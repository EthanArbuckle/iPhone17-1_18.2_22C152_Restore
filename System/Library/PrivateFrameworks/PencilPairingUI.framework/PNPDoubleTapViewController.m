...
+ (id)_controllerWithType:(int64_t)a3 buttonType:(int64_t)a4 deviceType:(int64_t)a5 delegate:(id)a6
{
  ...
  v12 = [v11 localizedStringForKey:@"QUICK_SWAP_TITLE" value:&stru_26ECD9920 table:0];
  v13 = PencilPairingUIBundle();
  v14 = [v13 localizedStringForKey:@"QUICK_SWAP_DESCRIPTION" value:&stru_26ECD9920 table:0];
  v15 = [(PNPDoubleTapViewController *)v10 initWithTitle:v12 detailText:v14 icon:0];
...
- (void)viewDidLoad
{
  ...
  id v9 = [(PNPWizardScratchpadView *)v4 topAnchor];
  v10 = [v3 topAnchor];
  ...
  id v30 = objc_alloc_init(MEMORY[0x263F1C848]);
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  [(PNPDoubleTapViewController *)&v5 viewWillDisappear:a3];
...
- (void)pencilInteractionDidTap:(id)a3
{
  ...
  objc_super v5 = [(PNPDoubleTapViewController *)self pencilView];
  [v5 eventSource:0 hadPencilDoubleTapped:0];

  id v6 = [(PNPDoubleTapViewController *)self scratchPadView];
...
- (void)eventSource:(id)a3 hadPencilDoubleTapped:(id)a4
{
  ...
  id v9 = [(PNPDoubleTapViewController *)self pencilView];
...
{
  if (([*(id *)(a1 + 32) animationsCancelled] & 1) == 0)
  {
    ...
    objc_super v5 = [WeakRetained quickSwapEventSource];
    [v5 play];
  }
}
...
- (void)scratchPadViewHadInteractionEvent:(id)a3
{
  ...
  id v4 = [(PNPDoubleTapViewController *)self quickSwapEventSource];
  [v4 stop];
}
