...
{
  v3.receiver = self;
  v3.super_class = (Class)SBFParallaxSettings;
...
+ (id)settingsControllerModule
{
  ...
  v53 = [MEMORY[0x1E4F941E8] rowWithTitle:@"Slide enabled" valueKeyPath:@"slideEnabled"];
  v59[0] = v53;
  v50 = [MEMORY[0x1E4F94110] rowWithTitle:@"Horizontal direction" valueKeyPath:@"slideDirectionX"];
  v47 = [v50 possibleValues:&unk_1ED89E9F8 titles:&unk_1ED89EA10];
  v44 = [v47 conditionFormat:@"slideEnabled != 0"];
  v59[1] = v44;
  v42 = [MEMORY[0x1E4F94140] rowWithTitle:@"Horizontal offset (pixels)" valueKeyPath:@"slidePixelsX"];
  v39 = [v42 between:0.0 and:200.0];
  v2 = [v39 precision:0];
  objc_super v3 = [v2 conditionFormat:@"slideEnabled != 0"];
  v59[2] = v3;
  v4 = [MEMORY[0x1E4F94110] rowWithTitle:@"Vertical direction" valueKeyPath:@"slideDirectionY"];
  v5 = [v4 possibleValues:&unk_1ED89E9F8 titles:&unk_1ED89EA10];
  v6 = [v5 conditionFormat:@"slideEnabled != 0"];
  v59[3] = v6;
  v7 = [MEMORY[0x1E4F94140] rowWithTitle:@"Vertical offset (pixels)" valueKeyPath:@"slidePixelsY"];
  ...
  v54 = [MEMORY[0x1E4F94168] sectionWithRows:v41 title:@"Slide"];
  v51 = [MEMORY[0x1E4F941E8] rowWithTitle:@"Tilt enabled" valueKeyPath:@"tiltEnabled"];
  v58[0] = v51;
  v48 = [MEMORY[0x1E4F94110] rowWithTitle:@"Horizontal direction" valueKeyPath:@"tiltDirectionX"];
  v45 = [v48 possibleValues:&unk_1ED89E9F8 titles:&unk_1ED89EA10];
  v43 = [v45 conditionFormat:@"tiltEnabled != 0"];
  v58[1] = v43;
  v40 = [MEMORY[0x1E4F94140] rowWithTitle:@"Horizontal rotation (degrees)" valueKeyPath:@"tiltDegreesX"];
  v38 = [v40 between:0.0 and:90.0];
  v11 = [v38 precision:1];
  v12 = [v11 conditionFormat:@"tiltEnabled != 0"];
  v58[2] = v12;
  v13 = [MEMORY[0x1E4F94110] rowWithTitle:@"Vertical direction" valueKeyPath:@"tiltDirectionY"];
  v14 = [v13 possibleValues:&unk_1ED89E9F8 titles:&unk_1ED89EA10];
  v15 = [v14 conditionFormat:@"tiltEnabled != 0"];
  v58[3] = v15;
  v16 = [MEMORY[0x1E4F94140] rowWithTitle:@"Vertical rotation (degrees)" valueKeyPath:@"tiltDegreesY"];
  ...
  v52 = [MEMORY[0x1E4F94168] sectionWithRows:v20 title:@"Tilt"];
  v21 = [MEMORY[0x1E4F94140] rowWithTitle:@"Distance from screen" valueKeyPath:@"distanceFromScreen"];
  v22 = [v21 precision:0];
  v57 = v22;
  v23 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v57 count:1];

  v49 = [MEMORY[0x1E4F94168] sectionWithRows:v23 title:@"Perspective" conditionFormat:@"tiltEnabled != 0"];
  v46 = [MEMORY[0x1E4F941E8] rowWithTitle:@"Lock effects enabled" valueKeyPath:@"increaseEnabled"];
  v56[0] = v46;
  v24 = [MEMORY[0x1E4F94140] rowWithTitle:@"Horizontal slide increase (px)" valueKeyPath:@"slideIncreaseX"];
  v25 = [v24 between:0.0 and:200.0];
  v26 = [v25 precision:0];
  v27 = [v26 conditionFormat:@"increaseEnabled != 0 && slideEnabled != 0"];
  v56[1] = v27;
  v28 = [MEMORY[0x1E4F94140] rowWithTitle:@"Vertical slide increase (px)" valueKeyPath:@"slideIncreaseY"];
  ...
  v33 = [MEMORY[0x1E4F94168] sectionWithRows:v32 title:@"Directional Lock Effects"];
