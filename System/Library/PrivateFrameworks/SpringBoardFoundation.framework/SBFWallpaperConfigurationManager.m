...
{
  v4.receiver = self;
  v4.super_class = (Class)SBFWallpaperConfigurationManager;
...
- (id)wallpaperConfigurationForVariant:(int64_t)a3 includingValuesForTypes:(unint64_t)a4
{
  ...
  objc_super v4 = [(PBUIWallpaperConfigurationManager *)&v6 wallpaperConfigurationForVariant:a3 includingValuesForTypes:a4];
  return v4;
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)SBFWallpaperConfigurationManager;
