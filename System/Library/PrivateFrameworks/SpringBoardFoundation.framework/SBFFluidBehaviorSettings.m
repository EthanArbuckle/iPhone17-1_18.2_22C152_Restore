...
- ($6E732EA7D3E0C9EC9CEEF7385E7E4683)parametersForTransitionFromState:(SEL)a3 toState:(int)a4
{
  ...
  *(_OWORD *)&retstr->var0 = 0u;
  if (a5 == 1)
  {
    ...
    retstr->var10 = v10;
    result = ($6E732EA7D3E0C9EC9CEEF7385E7E4683 *)[(SBFFluidBehaviorSettings *)self smoothingAndProjectionEnabled];
    if (result)
    {
...
- (void)setFrameRateRange:(CAFrameRateRange)a3 highFrameRateReason:(unsigned int)a4
{
  ...
  id v11 = [(SBFFluidBehaviorSettings *)self preferredFrameRateRange];
...
- (unint64_t)hash
{
  ...
  float v3 = [v14 appendCGFloat:self->_trackingResponse];
  ...
  float v7 = [v6 appendCGFloat:self->_responseSmoothing];
  id v8 = [v7 appendCGFloat:self->_trackingDampingRatioSmoothing];
  float v9 = [v8 appendCGFloat:self->_trackingResponseSmoothing];
  id v10 = [v9 appendCGFloat:self->_inertialTargetSmoothingRatio];
  float v11 = [v10 appendCGFloat:self->_inertialProjectionDeceleration];
...
- (NSString)description
{
  return (NSString *)[(SBFFluidBehaviorSettings *)self descriptionWithMultilinePrefix:0];
}
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  float v3 = [(SBFFluidBehaviorSettings *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  id v4 = [(SBFFluidBehaviorSettings *)self succinctDescriptionBuilder];
...
{
  v2 = *(void **)(a1 + 32);
  float v3 = [*(id *)(a1 + 40) BSAnimationSettings];
...
- (id)BSAnimationSettings
{
  [(SBFFluidBehaviorSettings *)self dampingRatio];
  [(SBFFluidBehaviorSettings *)self response];
  float v3 = (void *)MEMORY[0x1E4F4F840];
...
+ (id)_moduleWithSectionTitle:(id)a3
{
  ...
  id v4 = objc_msgSend(MEMORY[0x1E4F28F60], "predicateWithFormat:", @"behaviorType == %d OR behaviorType == %d", 1, 2);
  id v5 = objc_msgSend(MEMORY[0x1E4F28F60], "predicateWithFormat:", @"behaviorType == %d", 2);
  id v6 = objc_msgSend(MEMORY[0x1E4F28F60], "predicateWithFormat:", @"behaviorType == %d AND smoothingAndProjectionEnabled = YES", 2);
  id v7 = objc_msgSend(MEMORY[0x1E4F28F60], "predicateWithFormat:", @"behaviorType == %d AND smoothingAndProjectionEnabled = YES", 2);
  id v8 = [MEMORY[0x1E4F1CA48] array];
  float v9 = [MEMORY[0x1E4F94110] rowWithTitle:@"Behavior Type" valueKeyPath:@"behaviorType"];
  id v10 = [v9 possibleValues:&unk_1ED89EAD0 titles:&unk_1ED89EAE8];
  [v8 addObject:v10];

  float v11 = [MEMORY[0x1E4F94140] rowWithTitle:@"Deceleration" valueKeyPath:@"deceleration"];
  unint64_t v12 = [v11 between:0.0 and:1.0];
  v13 = [v12 condition:v69];
  [v8 addObject:v13];

  id v14 = [MEMORY[0x1E4F94140] rowWithTitle:@"Damping Ratio" valueKeyPath:@"dampingRatio"];
  v15 = [v14 between:0.001 and:10.0];
  id v16 = [v15 precision:3];
  v17 = [v16 condition:v4];
  [v8 addObject:v17];

  id v18 = [MEMORY[0x1E4F94140] rowWithTitle:@"Response" valueKeyPath:@"response"];
  v19 = [v18 between:0.0 and:1000.0];
  id v20 = [v19 precision:3];
  v21 = [v20 condition:v4];
  [v8 addObject:v21];

  id v22 = [MEMORY[0x1E4F94140] rowWithTitle:@"Retarget Impulse" valueKeyPath:@"retargetImpulse"];
  v23 = [v22 between:0.0 and:1.0];
  v24 = [v23 precision:3];
  id v25 = [v24 condition:v4];
  [v8 addObject:v25];

  v26 = [MEMORY[0x1E4F94140] rowWithTitle:@"Tracking Damping Ratio" valueKeyPath:@"trackingDampingRatio"];
  v27 = [v26 between:0.001 and:10.0];
  id v28 = [v27 precision:3];
  v29 = [v28 condition:v5];
  [v8 addObject:v29];

  v30 = [MEMORY[0x1E4F94140] rowWithTitle:@"Tracking Response" valueKeyPath:@"trackingResponse"];
  id v31 = [v30 between:0.0 and:1000.0];
  v32 = [v31 precision:3];
  v33 = [v32 condition:v5];
  [v8 addObject:v33];

  id v34 = [MEMORY[0x1E4F94140] rowWithTitle:@"Tracking Retarget Impulse" valueKeyPath:@"trackingRetargetImpulse"];
  v35 = [v34 between:0.0 and:1.0];
  v36 = [v35 precision:3];
  id v37 = [v36 condition:v4];
  [v8 addObject:v37];

  v38 = [MEMORY[0x1E4F941E8] rowWithTitle:@"Use Smoothing and Projection" valueKeyPath:@"smoothingAndProjectionEnabled"];
  [v8 addObject:v38];

  v39 = [MEMORY[0x1E4F94140] rowWithTitle:@"Damping Ratio Smoothing" valueKeyPath:@"dampingRatioSmoothing"];
  id v40 = [v39 between:0.0 and:1.0];
  v41 = [v40 precision:3];
  v42 = [v41 condition:v6];
  [v8 addObject:v42];

  id v43 = [MEMORY[0x1E4F94140] rowWithTitle:@"Response Smoothing" valueKeyPath:@"responseSmoothing"];
  v44 = [v43 between:0.0 and:1.0];
  v45 = [v44 precision:3];
  v46 = [v45 condition:v6];
  [v8 addObject:v46];

  v47 = [MEMORY[0x1E4F94140] rowWithTitle:@"Tracking Damping Ratio Smoothing" valueKeyPath:@"trackingDampingRatioSmoothing"];
  v48 = [v47 between:0.0 and:1.0];
  v49 = [v48 precision:3];
  v50 = [v49 condition:v7];
  [v8 addObject:v50];

  v51 = [MEMORY[0x1E4F94140] rowWithTitle:@"Tracking Response Smoothing" valueKeyPath:@"trackingResponseSmoothing"];
  v52 = [v51 between:0.0 and:1.0];
  v53 = [v52 precision:3];
  v54 = [v53 condition:v7];
  [v8 addObject:v54];

  v55 = [MEMORY[0x1E4F94140] rowWithTitle:@"Target Smoothing Ratio" valueKeyPath:@"inertialTargetSmoothingRatio"];
  id v56 = [v55 between:0.0 and:1.0];
  v57 = [v56 precision:3];
  id v58 = [v57 condition:v7];
  [v8 addObject:v58];

  v59 = [MEMORY[0x1E4F94140] rowWithTitle:@"Projection Deceleration" valueKeyPath:@"inertialProjectionDeceleration"];
  id v60 = [v59 between:0.0 and:1.0];
  v61 = [v60 precision:7];
  id v62 = [v61 condition:v7];
  [v8 addObject:v62];

  v63 = [MEMORY[0x1E4F94138] rowWithTitle:@"Frame Rate Range" childSettingsKeyPath:@"preferredFrameRateRange"];
  [v8 addObject:v63];

  id v64 = (void *)MEMORY[0x1E4F94168];
  v65 = [MEMORY[0x1E4F94168] sectionWithRows:v8 title:v70];
