...
{
  return notify_register_dispatch("com.apple.springboard.screenchanged", &_SBFScreenTimeRegisterForExternalChangeNotification___token, MEMORY[0x1E4F14428], &__block_literal_global_7);
}
...
void ___SBFScreenTimeRegisterForExternalChangeNotification_block_invoke_2(int a1, int token)
{
  ...
  v3 = [NSNumber numberWithUnsignedLongLong:v5];
  v7[0] = v3;
