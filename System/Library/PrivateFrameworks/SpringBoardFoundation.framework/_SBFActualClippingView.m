...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  id v7 = a4;
  v20.receiver = self;
  v20.super_class = (Class)_SBFActualClippingView;
  if (-[_SBFActualClippingView pointInside:withEvent:](&v20, sel_pointInside_withEvent_, v7, x, y))
  {
    BOOL v8 = 1;
  }
    ...
    if (v10)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          -[_SBFActualClippingView convertPoint:toView:](self, "convertPoint:toView:", v14, x, y);
