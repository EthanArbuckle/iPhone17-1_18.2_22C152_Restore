...
- (SBFSAlwaysOnLiveRenderingAssertionFBSScene)initWithScene:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)SBFSAlwaysOnLiveRenderingAssertionFBSScene;
  v5 = [(SBFAlwaysOnLiveRenderingSceneBLSAttributesProvider *)&v8 _init];
  v6 = (SBFSAlwaysOnLiveRenderingAssertionFBSScene *)v5;
  if (v5) {
...
- (id)assertionAttributes
{
  ...
  if (WeakRetained)
  {
    v3 = [MEMORY[0x1E4F4F528] requestLiveUpdatingForFBSScene:WeakRetained];
    v7[0] = v3;
    id v4 = [MEMORY[0x1E4F4F530] requestUnrestrictedFramerateForFBSScene:WeakRetained];
    v7[1] = v4;
