...
- (SBFFrameRateAssertion)initWithFrameRateRange:(CAFrameRateRange)a3 highFrameRateReason:(unsigned int)a4
{
  ...
  if (v8)
  {
    ...
    v17 = v12;
    int v18 = v4;
    uint64_t v13 = [v10 initWithIdentifier:@"SBFFrameRateAssertion" forReason:v11 invalidationBlock:v16];
...
uint64_t __68__SBFFrameRateAssertion_initWithFrameRateRange_highFrameRateReason___block_invoke(uint64_t a1)
{
  return MEMORY[0x1F4102FE8](*(void *)(a1 + 32) + 16, *(unsigned int *)(a1 + 40));
}
