...
- (SOAuthorizationCredentialCore)initWithAuthorizationCredential:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)SOAuthorizationCredentialCore;
  ...
  if (v5)
  {
    ...
    uint64_t v12 = [v4 secKeyProxyEndpoints];
    secKeyProxyEndpoints = v5->_secKeyProxyEndpoints;
    v5->_secKeyProxyEndpoints = (NSArray *)v12;
  }
  return v5;
}
...
- (SOAuthorizationCredentialCore)initWithCoder:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)SOAuthorizationCredentialCore;
