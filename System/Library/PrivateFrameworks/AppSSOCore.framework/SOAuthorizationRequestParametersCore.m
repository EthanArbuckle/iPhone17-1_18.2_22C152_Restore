...
- (SOAuthorizationRequestParametersCore)initWithAuthorizationParameters:(id)a3
{
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)SOAuthorizationRequestParametersCore;
  ...
  if (v5)
  {
    ...
    v5->_requestedOperation = (NSString *)v10;

    uint64_t v12 = [v4 httpHeaders];
    httpHeaders = v5->_httpHeaders;
    v5->_httpHeaders = (NSDictionary *)v12;

    uint64_t v14 = [v4 httpBody];
    httpBody = v5->_httpBody;
    v5->_httpBody = (NSData *)v14;
    ...
    uint64_t v18 = [v4 impersonationBundleIdentifier];
    impersonationBundleIdentifier = v5->_impersonationBundleIdentifier;
    v5->_impersonationBundleIdentifier = (NSString *)v18;
...
- (SOAuthorizationRequestParametersCore)initWithCoder:(id)a3
{
  id v4 = a3;
  v91.receiver = self;
  v91.super_class = (Class)SOAuthorizationRequestParametersCore;
  ...
  if (v5)
  {
    ...
    objc_super v21 = NSStringFromSelector(sel_httpHeaders);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v42 = [NSNumber numberWithBool:self->_showOnCoverScreen];
...
- (id)description
{
  ...
  v23[2] = @"RequestedOperation";
  v23[3] = @"Realm";
  realm = (__CFString *)self->_realm;
  if (!realm) {
    realm = @"(null)";
  }
  v24[2] = requestedOperation;
  v24[3] = realm;
  authorizationOptions = self->_authorizationOptions;
  ...
  v23[4] = @"AuthorizationOptions";
  v23[5] = @"UseInternalExtensions";
  ...
  v24[8] = v14;
  v24[9] = callerTeamIdentifier;
  v23[9] = @"CallerTeamIdentifier";
  v23[10] = @"LocalizedCallerDisplayName";
  ...
  v24[10] = v17;
  v24[11] = v18;
  v23[11] = @"EnableUserInteraction";
  v23[12] = @"ImpersonationBundleIdentifier";
  ...
  v24[12] = impersonationBundleIdentifier;
  v20 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v24 forKeys:v23 count:13];
