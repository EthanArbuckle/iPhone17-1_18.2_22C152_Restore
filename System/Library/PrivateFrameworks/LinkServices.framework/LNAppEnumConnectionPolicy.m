...
- (NSString)appEnumIdentifier;
- (NSString)appEnumMangledTypeName;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_appEnumMangledTypeName, 0);
  objc_storeStrong((id *)&self->_appEnumIdentifier, 0);
}
...
- (NSString)appEnumMangledTypeName
{
  return self->_appEnumMangledTypeName;
}

- (NSString)appEnumIdentifier
{
  return self->_appEnumIdentifier;
}

- (BOOL)isEqual:(id)a3
{
  v4 = (LNAppEnumConnectionPolicy *)a3;
  v5 = v4;
  if (self != v4)
  {
    v6 = v4;
...
LABEL_42:
    ...
    v26 = [(LNAppEnumConnectionPolicy *)self appBundleIdentifier];
    v27 = [(LNAppEnumConnectionPolicy *)v6 appBundleIdentifier];
    id v28 = v26;
    id v29 = v27;
    v38 = v29;
    id v39 = v28;
...
LABEL_41:
    ...
    v32 = [(LNAppEnumConnectionPolicy *)self processInstanceIdentifier];
    v33 = [(LNAppEnumConnectionPolicy *)v6 processInstanceIdentifier];
    id v28 = v32;
    id v34 = v33;
    v35 = v34;
    if (v28 == v34)
...
- (unint64_t)hash
{
  ...
  uint64_t v8 = [v7 hash];
  id v9 = [(LNAppEnumConnectionPolicy *)self appBundleIdentifier];
...
- (id)description
{
  ...
  uint64_t v6 = [(LNAppEnumConnectionPolicy *)self appEnumIdentifier];
  v7 = [(LNAppEnumConnectionPolicy *)self appEnumMangledTypeName];
  uint64_t v8 = [(LNAppEnumConnectionPolicy *)self effectiveBundleIdentifier];
  id v9 = [(LNAppEnumConnectionPolicy *)self appBundleIdentifier];
  uint64_t v10 = [(LNAppEnumConnectionPolicy *)self processInstanceIdentifier];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v6 = [(LNAppEnumConnectionPolicy *)self appEnumMangledTypeName];
  [v4 encodeObject:v6 forKey:@"appEnumMangledTypeName"];

  v7 = [(LNAppEnumConnectionPolicy *)self effectiveBundleIdentifier];
  [v4 encodeObject:v7 forKey:@"effectiveBundleIdentifier"];

  uint64_t v8 = [(LNAppEnumConnectionPolicy *)self appBundleIdentifier];
  [v4 encodeObject:v8 forKey:@"appBundleIdentifier"];

  id v9 = [(LNAppEnumConnectionPolicy *)self processInstanceIdentifier];
...
- (LNAppEnumConnectionPolicy)initWithCoder:(id)a3
{
  ...
  uint64_t v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"appEnumMangledTypeName"];
...
- (id)connectionWithError:(id *)a3
{
  return [(LNAppEnumConnectionPolicy *)self connectionWithUserIdentity:0 error:a3];
}
...
LABEL_8:
    ...
    [v32 handleFailureInMethod:a2, self, @"LNAppEnumConnectionPolicy.m", 23, @"Invalid parameter not satisfying: %@", @"appEnumMangledTypeName" object file lineNumber description];
  ...
  [v31 handleFailureInMethod:a2, self, @"LNAppEnumConnectionPolicy.m", 22, @"Invalid parameter not satisfying: %@", @"appEnumIdentifier" object file lineNumber description];
...
LABEL_9:
  ...
  [v33 handleFailureInMethod:a2, self, @"LNAppEnumConnectionPolicy.m", 24, @"Invalid parameter not satisfying: %@", @"effectiveBundleIdentifier" object file lineNumber description];

LABEL_4:
  v34.receiver = self;
  v34.super_class = (Class)LNAppEnumConnectionPolicy;
  id v18 = [(LNAppEnumConnectionPolicy *)&v34 init];
  if (v18)
  {
    uint64_t v19 = [v13 copy];
    appEnumIdentifier = v18->_appEnumIdentifier;
    v18->_appEnumIdentifier = (NSString *)v19;

    uint64_t v21 = [v14 copy];
    appEnumMangledTypeName = v18->_appEnumMangledTypeName;
    v18->_appEnumMangledTypeName = (NSString *)v21;
