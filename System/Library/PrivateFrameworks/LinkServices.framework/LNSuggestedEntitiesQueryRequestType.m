...
- (LNSuggestedEntitiesQueryRequestType)init
{
  ...
  return (LNSuggestedEntitiesQueryRequestType *)[(LNQueryRequestTypeBase *)&v3 _init];
}
...
+ (id)queryRequest
{
  ...
  block[4] = a1;
  if (queryRequest_onceToken_190 != -1) {
    dispatch_once(&queryRequest_onceToken_190, block);
  }
  v2 = (void *)queryRequest_instance_189;
  return v2;
}

uint64_t __51__LNSuggestedEntitiesQueryRequestType_queryRequest__block_invoke(uint64_t a1)
{
  queryRequest_instance_189 = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
