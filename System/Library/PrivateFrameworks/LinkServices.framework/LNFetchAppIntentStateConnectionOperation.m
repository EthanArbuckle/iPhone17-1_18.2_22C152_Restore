...
- (NSArray)appIntentIdentifiers;
- (NSDictionary)results;
- (id)completionHandler;
- (void)finishWithError:(id)a3;
- (void)setAppIntentIdentifiers:(id)a3;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_appIntentIdentifiers, 0);
...
- (NSArray)appIntentIdentifiers
{
  return self->_appIntentIdentifiers;
}
...
- (void)finishWithError:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)LNFetchAppIntentStateConnectionOperation;
...
{
  v8.receiver = self;
  v8.super_class = (Class)LNFetchAppIntentStateConnectionOperation;
  [(LNConnectionOperation *)&v8 start];
  v3 = getLNLogCategoryConnection();
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1A4419000, v3, OS_LOG_TYPE_INFO, "Fetching intent state", buf, 2u);
  }
...
LABEL_8:
    ...
    [v22 handleFailureInMethod:a2, self, @"LNFetchAppIntentStateConnectionOperation.m", 30, @"Invalid parameter not satisfying: %@", @"appIntentIdentifiers" object file lineNumber description];
  ...
  [v21 handleFailureInMethod:a2, self, @"LNFetchAppIntentStateConnectionOperation.m", 29, @"Invalid parameter not satisfying: %@", @"connectionInterface" object file lineNumber description];
...
LABEL_9:
  ...
  [v23 handleFailureInMethod:a2, self, @"LNFetchAppIntentStateConnectionOperation.m", 31, @"Invalid parameter not satisfying: %@", @"completionHandler" object file lineNumber description];

LABEL_4:
  v15 = [MEMORY[0x1E4F29128] UUID];
  v24.receiver = self;
  v24.super_class = (Class)LNFetchAppIntentStateConnectionOperation;
  v16 = [(LNInterfaceConnectionOperation *)&v24 initWithIdentifier:v15 connectionInterface:v11 priority:1 queue:v13 activity:&__block_literal_global_8628];

  if (v16)
  {
    objc_storeStrong((id *)&v16->_appIntentIdentifiers, a4);
    v17 = _Block_copy(v14);
...
{
  os_activity_t v0 = _os_activity_create(&dword_1A4419000, "appintents:fetch intent state", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v0;
}
