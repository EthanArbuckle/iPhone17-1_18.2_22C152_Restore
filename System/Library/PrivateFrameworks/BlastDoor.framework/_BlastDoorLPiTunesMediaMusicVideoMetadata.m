...
- (_BlastDoorLPiTunesMediaMusicVideoMetadata)initWithCoder:(id)a3;
...
- (_BlastDoorLPiTunesMediaMusicVideoMetadata)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)_BlastDoorLPiTunesMediaMusicVideoMetadata;
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[_BlastDoorLPiTunesMediaMusicVideoMetadata allocWithZone:a3];
  if (v4)
  {
    id v5 = [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)self storeIdentifier];
    [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)v4 setStoreIdentifier:v6];

    v7 = [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)self name];
    [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)v4 setName:v7];

    uint64_t v8 = [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)self artist];
    [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)v4 setArtist:v8];

    v9 = [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)self artwork];
    [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)v4 setArtwork:v9];

    uint64_t v10 = [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)self artworkMetadata];
    [(_BlastDoorLPiTunesMediaMusicVideoMetadata *)v4 setArtworkMetadata:v10];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)_BlastDoorLPiTunesMediaMusicVideoMetadata;
  if ([(_BlastDoorLPiTunesMediaMusicVideoMetadata *)&v14 isEqual:v4])
  {
    char v5 = 1;
  }
  else
