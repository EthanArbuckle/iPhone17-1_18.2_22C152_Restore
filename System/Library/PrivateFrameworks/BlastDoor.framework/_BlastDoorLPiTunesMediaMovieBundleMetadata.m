@interface _BlastDoorLPiTunesMediaMovieBundleMetadata
...
- (_BlastDoorLPiTunesMediaMovieBundleMetadata)initWithCoder:(id)a3;
...
@implementation _BlastDoorLPiTunesMediaMovieBundleMetadata
...
- (_BlastDoorLPiTunesMediaMovieBundleMetadata)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)_BlastDoorLPiTunesMediaMovieBundleMetadata;
  v5 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)&v20 init];
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[_BlastDoorLPiTunesMediaMovieBundleMetadata allocWithZone:a3];
  if (v4)
  {
    id v5 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)self storeIdentifier];
    [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)v4 setStoreIdentifier:v6];

    v7 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)self name];
    [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)v4 setName:v7];

    uint64_t v8 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)self genre];
    [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)v4 setGenre:v8];

    v9 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)self artwork];
    [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)v4 setArtwork:v9];

    uint64_t v10 = [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)self artworkMetadata];
    [(_BlastDoorLPiTunesMediaMovieBundleMetadata *)v4 setArtworkMetadata:v10];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)_BlastDoorLPiTunesMediaMovieBundleMetadata;
  if ([(_BlastDoorLPiTunesMediaMovieBundleMetadata *)&v14 isEqual:v4])
  {
    char v5 = 1;
  }
  else
