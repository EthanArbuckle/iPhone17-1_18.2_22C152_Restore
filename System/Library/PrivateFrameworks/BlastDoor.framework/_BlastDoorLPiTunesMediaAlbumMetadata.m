...
- (_BlastDoorLPiTunesMediaAlbumMetadata)initWithCoder:(id)a3;
...
- (_BlastDoorLPiTunesMediaAlbumMetadata)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)_BlastDoorLPiTunesMediaAlbumMetadata;
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[_BlastDoorLPiTunesMediaAlbumMetadata allocWithZone:a3];
  if (v4)
  {
    id v5 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self storeIdentifier];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setStoreIdentifier:v6];

    v7 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self name];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setName:v7];

    uint64_t v8 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self artist];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setArtist:v8];

    v9 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self artwork];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setArtwork:v9];

    uint64_t v10 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self artworkMetadata];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setArtworkMetadata:v10];

    v11 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self offers];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setOffers:v11];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)_BlastDoorLPiTunesMediaAlbumMetadata;
  if ([(_BlastDoorLPiTunesMediaAlbumMetadata *)&v15 isEqual:v4])
  {
    char v5 = 1;
  }
  else
