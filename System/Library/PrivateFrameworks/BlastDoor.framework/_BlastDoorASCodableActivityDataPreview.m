...
- (id)description
{
  ...
  id v4 = [(_BlastDoorASCodableActivityDataPreview *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_workouts, "count"));
    long long v28 = 0u;
    long long v29 = 0u;
    long long v30 = 0u;
    long long v31 = 0u;
    v7 = self->_workouts;
    uint64_t v8 = [(NSMutableArray *)v7 countByEnumeratingWithState:&v28 objects:v27 count:16];
    if (v8)
    {
      uint64_t v9 = v8;
      ...
      do
      {
        ...
        uint64_t v9 = [(NSMutableArray *)v7 countByEnumeratingWithState:&v28 objects:v27 count:16];
      }
      while (v9);
    }
  ...
  {
    v13 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_achievements, "count"));
    long long v23 = 0u;
    long long v24 = 0u;
    long long v25 = 0u;
    long long v26 = 0u;
    v14 = self->_achievements;
    uint64_t v15 = [(NSMutableArray *)v14 countByEnumeratingWithState:&v23 objects:v22 count:16];
    if (v15)
    {
      uint64_t v16 = v15;
      ...
      do
      {
        ...
        uint64_t v16 = [(NSMutableArray *)v14 countByEnumeratingWithState:&v23 objects:v22 count:16];
      }
      while (v16);
    }
...
- (void)writeTo:(id)a3
{
  ...
  long long v22 = 0u;
  v5 = self->_workouts;
  uint64_t v6 = [(NSMutableArray *)v5 countByEnumeratingWithState:&v21 objects:v20 count:16];
  if (v6)
  {
    uint64_t v7 = v6;
    ...
    do
    {
      ...
      while (v7 != v9);
      uint64_t v7 = [(NSMutableArray *)v5 countByEnumeratingWithState:&v21 objects:v20 count:16];
    }
    while (v7);
  }
  ...
  uint64_t v11 = [(NSMutableArray *)v10 countByEnumeratingWithState:&v16 objects:v15 count:16];
  if (v11)
  {
    uint64_t v12 = v11;
    ...
    do
    {
      ...
      while (v12 != v14);
      uint64_t v12 = [(NSMutableArray *)v10 countByEnumeratingWithState:&v16 objects:v15 count:16];
    }
    while (v12);
  }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v12 clearWorkouts];
    unint64_t v4 = [(_BlastDoorASCodableActivityDataPreview *)self workoutsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(_BlastDoorASCodableActivityDataPreview *)self workoutsAtIndex:i];
        [v12 addWorkouts:v7];
      }
    }
  }
  if ([(_BlastDoorASCodableActivityDataPreview *)self achievementsCount])
  {
    ...
    unint64_t v8 = [(_BlastDoorASCodableActivityDataPreview *)self achievementsCount];
    if (v8)
    {
      unint64_t v9 = v8;
      for (uint64_t j = 0; j != v9; ++j)
      {
        uint64_t v11 = [(_BlastDoorASCodableActivityDataPreview *)self achievementsAtIndex:j];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(_BlastDoorASCodableActivitySnapshot *)self->_activitySnapshot copyWithZone:a3];
  ...
  *(void *)(v5 + 24) = v6;
  ...
  uint64_t v9 = [(NSMutableArray *)v8 countByEnumeratingWithState:&v27 objects:v26 count:16];
  if (v9)
  {
    uint64_t v10 = v9;
    ...
    do
    {
      ...
      while (v10 != v12);
      uint64_t v10 = [(NSMutableArray *)v8 countByEnumeratingWithState:&v27 objects:v26 count:16];
    }
    while (v10);
  }
  ...
  uint64_t v15 = [(NSMutableArray *)v14 countByEnumeratingWithState:&v22 objects:v21 count:16];
  if (v15)
  {
    uint64_t v16 = v15;
    ...
    do
    {
      ...
      do
      {
        ...
        long long v19 = (void *)[*(id *)(*((void *)&v22 + 1) + 8 * v18) copyWithZone:a3];
        [(id)v5 addAchievements:v19];

        ++v18;
      }
      while (v16 != v18);
      uint64_t v16 = [(NSMutableArray *)v14 countByEnumeratingWithState:&v22 objects:v21 count:16];
    }
    while (v16);
  }
...
- (unint64_t)hash
{
  unint64_t v3 = [(_BlastDoorASCodableActivitySnapshot *)self->_activitySnapshot hash];
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        [(_BlastDoorASCodableActivityDataPreview *)self addWorkouts:*(void *)(*((void *)&v23 + 1) + 8 * i)];
      }
  ...
  if (v13)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v14; ++j)
      {
        ...
        [(_BlastDoorASCodableActivityDataPreview *)self addAchievements:*(void *)(*((void *)&v18 + 1) + 8 * j)];
      }
