...
- (id)description
{
  ...
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_BlastDoorASCodableShareLocations;
...
- (BOOL)readFrom:(id)a3
{
  return _BlastDoorASCodableShareLocationsReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[_BlastDoorASCodableShareLocations setActivityShareURL:](self, "setActivityShareURL:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[_BlastDoorASCodableShareLocations setRelationshipShareURL:](self, "setRelationshipShareURL:");
    id v4 = v5;
  }
}
