...
- (_BlastDoorLPiTunesMediaTVSeasonMetadata)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)_BlastDoorLPiTunesMediaTVSeasonMetadata;
  v5 = [(_BlastDoorLPiTunesMediaTVSeasonMetadata *)&v20 init];
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[_BlastDoorLPiTunesMediaTVSeasonMetadata allocWithZone:a3];
  if (v4)
  {
    id v5 = [(_BlastDoorLPiTunesMediaTVSeasonMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaTVSeasonMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(_BlastDoorLPiTunesMediaTVSeasonMetadata *)self storeIdentifier];
    ...
    uint64_t v8 = [(_BlastDoorLPiTunesMediaTVSeasonMetadata *)self genre];
    ...
    uint64_t v10 = [(_BlastDoorLPiTunesMediaTVSeasonMetadata *)self artworkMetadata];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)_BlastDoorLPiTunesMediaTVSeasonMetadata;
  if ([(_BlastDoorLPiTunesMediaTVSeasonMetadata *)&v14 isEqual:v4])
  {
    char v5 = 1;
  }
  else
