...
- (_BlastDoorLPiTunesMediaRadioMetadata)initWithCoder:(id)a3;
...
- (_BlastDoorLPiTunesMediaRadioMetadata)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)_BlastDoorLPiTunesMediaRadioMetadata;
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[_BlastDoorLPiTunesMediaRadioMetadata allocWithZone:a3];
  if (v4)
  {
    id v5 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self storeIdentifier];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setStoreIdentifier:v6];

    v7 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self name];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setName:v7];

    uint64_t v8 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self curator];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setCurator:v8];

    v9 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self artwork];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setArtwork:v9];

    uint64_t v10 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self artworkMetadata];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setArtworkMetadata:v10];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)_BlastDoorLPiTunesMediaRadioMetadata;
  if ([(_BlastDoorLPiTunesMediaRadioMetadata *)&v14 isEqual:v4])
  {
    char v5 = 1;
  }
  else
