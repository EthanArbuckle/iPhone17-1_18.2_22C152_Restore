...
- (id)description
{
  ...
  __int16 v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_BlastDoorASCodableWorkout;
  v4 = [(_BlastDoorASCodableWorkout *)&v8 description];
  v5 = [(_BlastDoorASCodableWorkout *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _BlastDoorASCodableWorkoutReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (unint64_t)hash
{
  unint64_t v43 = [(_BlastDoorASCodableSample *)self->_sample hash];
  __int16 has = (__int16)self->_has;
  if ((has & 0x80) != 0)
  {
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[_BlastDoorASCodableWorkout setSample:](self, "setSample:");
  }
  id v4 = v9;
LABEL_7:
  __int16 v7 = *((_WORD *)v4 + 62);
...
LABEL_15:
  if (*((void *)v4 + 9))
  {
    -[_BlastDoorASCodableWorkout setBundleID:](self, "setBundleID:");
    id v4 = v9;
  }
  ...
  if (*((void *)v4 + 10))
  {
    -[_BlastDoorASCodableWorkout setDeviceManufacturer:](self, "setDeviceManufacturer:");
    id v4 = v9;
  }
  if (*((void *)v4 + 11))
  {
    -[_BlastDoorASCodableWorkout setDeviceModel:](self, "setDeviceModel:");
    id v4 = v9;
  }
  if (*((_WORD *)v4 + 62))
  {
  ...
  if (*((void *)v4 + 13))
  {
    [(_BlastDoorASCodableWorkout *)self setSeymourCatalogWorkoutIdentifier:"setSeymourCatalogWorkoutIdentifier:"];
    id v4 = v9;
  }
  if (*((void *)v4 + 14)) {
    -[_BlastDoorASCodableWorkout setSeymourMediaType:](self, "setSeymourMediaType:");
  }
  MEMORY[0x1F41817F8]();
}
