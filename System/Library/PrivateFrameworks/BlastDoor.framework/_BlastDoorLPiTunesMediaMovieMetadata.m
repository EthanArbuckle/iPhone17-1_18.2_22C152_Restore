@interface _BlastDoorLPiTunesMediaMovieMetadata
...
- (_BlastDoorLPiTunesMediaMovieMetadata)initWithCoder:(id)a3;
...
@implementation _BlastDoorLPiTunesMediaMovieMetadata
...
- (_BlastDoorLPiTunesMediaMovieMetadata)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)_BlastDoorLPiTunesMediaMovieMetadata;
  v5 = [(_BlastDoorLPiTunesMediaMovieMetadata *)&v20 init];
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = +[_BlastDoorLPiTunesMediaMovieMetadata allocWithZone:a3];
  if (v4)
  {
    id v5 = [(_BlastDoorLPiTunesMediaMovieMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaMovieMetadata *)v4 setStoreFrontIdentifier:v5];

    uint64_t v6 = [(_BlastDoorLPiTunesMediaMovieMetadata *)self storeIdentifier];
    [(_BlastDoorLPiTunesMediaMovieMetadata *)v4 setStoreIdentifier:v6];

    v7 = [(_BlastDoorLPiTunesMediaMovieMetadata *)self name];
    [(_BlastDoorLPiTunesMediaMovieMetadata *)v4 setName:v7];

    uint64_t v8 = [(_BlastDoorLPiTunesMediaMovieMetadata *)self genre];
    [(_BlastDoorLPiTunesMediaMovieMetadata *)v4 setGenre:v8];

    v9 = [(_BlastDoorLPiTunesMediaMovieMetadata *)self artwork];
    [(_BlastDoorLPiTunesMediaMovieMetadata *)v4 setArtwork:v9];

    uint64_t v10 = [(_BlastDoorLPiTunesMediaMovieMetadata *)self artworkMetadata];
    [(_BlastDoorLPiTunesMediaMovieMetadata *)v4 setArtworkMetadata:v10];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)_BlastDoorLPiTunesMediaMovieMetadata;
  if ([(_BlastDoorLPiTunesMediaMovieMetadata *)&v14 isEqual:v4])
  {
    char v5 = 1;
  }
  else
