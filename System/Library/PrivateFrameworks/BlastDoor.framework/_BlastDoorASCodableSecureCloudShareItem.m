...
- (id)description
{
  ...
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_BlastDoorASCodableSecureCloudShareItem;
...
- (BOOL)readFrom:(id)a3
{
  return _BlastDoorASCodableSecureCloudShareItemReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  NSUInteger v4 = a3;
  if (v4[2]) {
    -[_BlastDoorASCodableSecureCloudShareItem setShareURL:](self, "setShareURL:");
  }
  if (v4[3]) {
    -[_BlastDoorASCodableSecureCloudShareItem setZoneName:](self, "setZoneName:");
  }
  if (v4[1]) {
    -[_BlastDoorASCodableSecureCloudShareItem setInvitationToken:](self, "setInvitationToken:");
  }
}
