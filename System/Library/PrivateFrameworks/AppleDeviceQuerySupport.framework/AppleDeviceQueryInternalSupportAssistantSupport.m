...
+ (id)getInternalSupportPath
{
  ...
  {
    ZhuGeLog(262400, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getInternalSupportPath]", 135, @"Skip retrieving internal support path in restoreOS", v4, v5, v6, v37);
    id v7 = 0;
    long long v8 = 0;
LABEL_27:
    id v33 = 0;
  ...
  if (!v9)
  {
    ...
    ZhuGeLog(262400, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getInternalSupportPath]", 142, @"Retrieving unchanged internal supported path: %@", v29, v30, v31, (uint64_t)v8);
    id v7 = 0;
    goto LABEL_27;
  }
...
LABEL_31:
    ...
    ZhuGeLog(524544, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getInternalSupportPath]", 174, @"ZhuGe internal support path is updated to: %@", v34, v35, v36, (uint64_t)v8);
  ...
  if (a3)
  {
    *a3 = 0;
    ...
    if (![a1 dylibHandler])
    {
      ...
      if (!v10)
      {
        ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getDylibHandlerWithError:]", 207, @"Failed to get ZhuGe internal support path for dylib handler!", v11, v12, v13, v23);
        id v20 = [MEMORY[0x263F087E8] errorWithZhuGeErrorCode:43 underlyingError:0];
        id v9 = 0;
        goto LABEL_10;
      }
      ...
      if (![a1 dylibHandler])
      {
        ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getDylibHandlerWithError:]", 218, @"Failed to dlopen ZhuGe internal armory dylib!", v17, v18, v19, v23);
        id v20 = [MEMORY[0x263F087E8] errorWithZhuGeErrorCode:13 underlyingError:0];
LABEL_10:
        *a3 = v20;
      }
    }
  ...
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getDylibHandlerWithError:]", 194, @"error p-pointer is nil!", v5, v6, v7, v23);
    long long v8 = 0;
    id v9 = 0;
  }
  pthread_mutex_unlock((pthread_mutex_t *)[a1 recursiveMutex]);
...
+ (id)getXpcProxyWithError:(id *)a3
{
  ...
  if (!a3)
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 273, @"error p-pointer is nil!", v5, v6, v7, v39);
LABEL_9:
    id v9 = 0;
    id v10 = 0;
    uint64_t v11 = 0;
  ...
  *a3 = 0;
  ...
  if (v13)
  {
    ...
    uint64_t v18 = [MEMORY[0x263EFF8C0] arrayWithObjects:v48 count:2];
    uint64_t v19 = [v17 pathWithComponents:v18];

    id v10 = v19;
    [v10 UTF8String];
    xpc_add_bundle();
    uint64_t v11 = (void *)[objc_alloc(MEMORY[0x263F08D68]) initWithServiceName:@"com.apple.ZhuGeInternalService"];
    if (v11)
    {
      uint64_t v23 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26FC2F9A8];
      ...
      v47[1] = 3221225472;
      v47[2] = __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke;
      v47[3] = &__block_descriptor_40_e5_v8__0l;
      v47[4] = a1;
      [v11 setInvalidationHandler:v47];
      v46[0] = MEMORY[0x263EF8330];
      v46[1] = 3221225472;
      v46[2] = __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke_2;
      ...
      v45[1] = 3221225472;
      v45[2] = __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke_3;
      ...
      ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 339, @"Failed to get proxy for \"%@\"!", v33, v34, v35, @"com.apple.ZhuGeInternalService");
      id v36 = [MEMORY[0x263F087E8] errorWithZhuGeErrorCode:66 underlyingError:0];
      goto LABEL_16;
    }
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 297, @"Failed to connect \"%@\"!", v20, v21, v22, @"com.apple.ZhuGeInternalService");
    id v36 = [MEMORY[0x263F087E8] errorWithZhuGeErrorCode:67 underlyingError:0];
  }
  else
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]", 286, @"Failed to get ZhuGe internal support path for xpc proxy!", v14, v15, v16, v39);
    id v36 = [MEMORY[0x263F087E8] errorWithZhuGeErrorCode:43 underlyingError:0];
    id v10 = 0;
    uint64_t v11 = 0;
  }
  uint64_t v12 = 0;
...
uint64_t __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke(uint64_t a1)
{
  ...
  ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]_block_invoke", 317, @"Connection to \"%@\" invalidated!", v2, v3, v4, @"com.apple.ZhuGeInternalService");
...
{
  pthread_mutex_lock((pthread_mutex_t *)[*(id *)(a1 + 32) recursiveMutex]);
  ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]_block_invoke_2", 323, @"Connection to \"%@\" interrupted!", v2, v3, v4, @"com.apple.ZhuGeInternalService");
  [*(id *)(a1 + 32) setXpcProxy:0];
  uint64_t v5 = (pthread_mutex_t *)[*(id *)(a1 + 32) recursiveMutex];
...
uint64_t __72__AppleDeviceQueryInternalSupportAssistantSupport_getXpcProxyWithError___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe/ZhuGeInternalSupport/ZhuGeInternalSupportAssistant.m", "+[AppleDeviceQueryInternalSupportAssistantSupport getXpcProxyWithError:]_block_invoke_3", 333, @"Internal connection failed to provide a synchronized proxy, error : %@!", v5, v6, v7, (uint64_t)v4);
