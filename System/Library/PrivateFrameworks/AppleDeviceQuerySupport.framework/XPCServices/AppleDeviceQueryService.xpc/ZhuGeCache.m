...
- (ZhuGeCache)initWithName:(id)a3 andCapacity:(id)a4 andCacheType:(Class)a5
{
  ...
  if (v11)
  {
    ...
    v13 = (NSMutableArray *)objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSNumber integerValue](v12->_capacity, "integerValue"));
    cacheList = v12->_cacheList;
    v12->_cacheList = v13;

    v15 = (NSMutableDictionary *)objc_msgSend(objc_alloc((Class)NSMutableDictionary), "initWithCapacity:", -[NSNumber integerValue](v12->_capacity, "integerValue"));
...
- (id)getCacheForKey:(id)a3
{
  ...
  p_aRecursiveMutex = &self->aRecursiveMutex;
  pthread_mutex_lock(&self->aRecursiveMutex);
  unsigned int v6 = [(ZhuGeCache *)self cacheList];
...
- (BOOL)setCache:(id)a3 forKey:(id)a4 withError:(id *)a5
{
  ...
  if (!a5)
  {
    ...
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 91, @"In %@, error p-pointer is nil!", v30, v31, v32, (uint64_t)v29);
  ...
  *a5 = 0;
  if (!v8)
  {
    ...
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 97, @"In %@, aCache pointer is nil!", v34, v35, v36, (uint64_t)v33);
LABEL_17:

    uint64_t v40 = 45;
LABEL_18:
    +[NSError errorWithZhuGeErrorCode:v40 underlyingError:0];
    BOOL v28 = 0;
  ...
  {
    v33 = [(ZhuGeCache *)self name];
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 103, @"In %@, aKey pointer is nil!", v37, v38, v39, (uint64_t)v33);
    goto LABEL_17;
  }
  ...
  if ([(ZhuGeCache *)self cacheType])
  {
    ...
    {
      v42 = [(ZhuGeCache *)self name];
      objc_opt_class();
      ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeCache.m", "-[ZhuGeCache setCache:forKey:withError:]", 115, @"In %@, key \"%@\" got a wrong cache class type \"%@\"!", v43, v44, v45, (uint64_t)v42);
