...
- (ESAtomIndexed)initWithEditOperation:(int64_t)a3 indexToEdit:(unint64_t)a4 newText:(id)a5 indexInArrayB:(unint64_t)a6
{
  ...
  v11 = [(ESAtomIndexed *)&v14 init];
  v12 = v11;
  if (v11)
  {
    [(ESAtomIndexed *)v11 setEditOperation:a3];
    [(ESAtomIndexed *)v12 setIndexToEdit:a4];
    [(ESAtomIndexed *)v12 setIndexInArrayB:a6];
    [(ESAtomIndexed *)v12 setReplacementText:v10];
  }
...
{
  id v9 = a5;
  id v10 = [[ESAtomIndexed alloc] initWithEditOperation:a3 indexToEdit:a4 newText:v9 indexInArrayB:a6];
