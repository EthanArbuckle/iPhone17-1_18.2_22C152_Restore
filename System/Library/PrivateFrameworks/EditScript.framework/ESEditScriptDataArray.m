@interface ESEditScriptDataArray
...
- (ESEditScriptDataArray)initWithString:(id)a3 chunkSize:(int64_t)a4
{
  ...
  v7 = [(ESEditScriptDataArray *)&v40 init];
  v8 = v7;
  if (v7)
  {
    [(ESEditScriptDataArray *)v7 setCachedStringValue:v6];
    unint64_t v9 = [v6 length];
    if (a4 == 1)
    {
      uint64_t v12 = [MEMORY[0x263EFF980] arrayWithCapacity:1];
      data = v8->_data;
      v8->_data = (NSArray *)v12;

      unint64_t v14 = 0x2689C6000uLL;
      if (!initWithString_chunkSize__whitespaceOrPunctuationCharacterSet)
      {
        uint64_t v15 = [MEMORY[0x263F089C0] whitespaceCharacterSet];
      ...
      if (v9)
      {
        ...
        do
        {
          uint64_t v22 = IsCharacterAtIndexMemberOfCharacterSet(v6, &v37, *(void **)(v14 + 2296));
          int v23 = v22;
          uint64_t v24 = v37;
          if ((v22 & 1) != 0 || v37 == v21)
          {
    ...
    {
      uint64_t v10 = [MEMORY[0x263EFF980] arrayWithCapacity:v9];
      v11 = v8->_data;
...
{
  return [*(id *)(*(void *)(a1 + 32) + 8) addObject:a2];
}
...
- (ESEditScriptDataArray)initWithArray:(id)a3
{
  ...
  v5 = [(ESEditScriptDataArray *)&v9 init];
  if (v5)
  {
    uint64_t v6 = [v4 copy];
    data = v5->_data;
...
{
  id v5 = a3;
  uint64_t v6 = [[ESEditScriptDataArray alloc] initWithString:v5 chunkSize:a4];
...
{
  id v3 = a3;
  id v4 = [[ESEditScriptDataArray alloc] initWithArray:v3];
...
- (id)stringValue
{
  ...
  {
    id v4 = [(NSArray *)self->_data componentsJoinedByString:&stru_26EC8A8E0];
    [(ESEditScriptDataArray *)self setCachedStringValue:v4];
...
- (int64_t)characterIndexForItem:(int64_t)a3
{
  ...
  int64_t v6 = 0;
  do
    v6 += [(ESEditScriptDataArray *)self lengthOfItem:v5++];
  while (a3 != v5);
  return v6;
}
...
- (int64_t)indexOfFirstDifferenceWithOtherData:(id)a3 shouldReverseIterate:(BOOL)a4 fallsOnWordBoundary:(BOOL *)a5
{
  BOOL v6 = a4;
  id v8 = a3;
  unint64_t v9 = [(ESEditScriptDataArray *)self length];
  ...
  while (1)
  {
    ...
    uint64_t v19 = -[ESEditScriptDataArray stringAtIndex:](self, "stringAtIndex:", v17, v28, v29, v30);
...
LABEL_19:
    ...
    else
    {
      ...
      uint64_t v31 = v22;
      int v23 = [MEMORY[0x263F08708] whitespaceAndNewlineCharacterSet];
