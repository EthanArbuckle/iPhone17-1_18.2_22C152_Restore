...
{
  sharedHangTracerService_sharedHangTracerService = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
...
- (MXHangTracerService)init
{
  ...
  if (v2)
  {
    os_log_t v3 = os_log_create("com.apple.metrickit.service.hangtracer", (const char *)&unk_238876085);
    ...
    if (!v2->_MXHangTracerServiceLogHandle) {
      objc_storeStrong((id *)&v2->_MXHangTracerServiceLogHandle, &_os_log_internal);
    }
    v5 = dispatch_queue_attr_make_with_qos_class(0, QOS_CLASS_BACKGROUND, 0);
    dispatch_queue_t v6 = dispatch_queue_create("com.apple.metrickitd.service.hangtracer.requestqueue", v5);
...
- (BOOL)startService
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_23886F000, MXHangTracerServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Starting hang tracer service.", buf, 2u);
  }
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
    -[MXHangTracerService startService](v5);
  }
  v6.receiver = self;
  ...
  if ([(MXService *)&v7 stopService])
  {
    ...
    if (os_log_type_enabled(MXHangTracerServiceLogHandle, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)objc_super v6 = 0;
      _os_log_impl(&dword_23886F000, MXHangTracerServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Stopping hang tracer service.", v6, 2u);
    }
  }
  return ![(MXService *)self isStarted];
}
...
- (BOOL)_updateService
{
  ...
  v5 = [&unk_26EB8AAC0 objectAtIndexedSubscript:3];
...
- (void)unarchiveHangTracerDataForDateString:(id)a3
{
  ...
  long long v46 = 0u;
  v37 = (void *)v4;
  id obj = [(NSMutableArray *)self->_hangTracerDataPaths filteredArrayUsingPredicate:v4];
      ...
      for (uint64_t i = 0; i != v42; uint64_t i = v26 + 1)
      {
        ...
        if (os_log_type_enabled(MXHangTracerServiceLogHandle, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          _os_log_impl(&dword_23886F000, MXHangTracerServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Found log file: %@ for date: %@", buf, 0x16u);
        }
        id v10 = [MEMORY[0x263F08850] defaultManager];
        objc_super v11 = +[MXUtilities containerPath];
        v12 = [&unk_26EB8AAD8 objectAtIndexedSubscript:3];
          ...
          if (v23)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
            {
              *(_DWORD *)buf = 138412290;
              ...
              _os_log_error_impl(&dword_23886F000, v24, OS_LOG_TYPE_ERROR, "Failed to unarchive hang data: %@", buf, 0xCu);
            }
          }
          else
          {
              ...
              && (uint64_t v31 = [v22 sourceID], v31 == -[MXService sourceID](v19, "sourceID")))
            {
              ...
              [(NSMutableArray *)v19->_unarchivedHangTracerData addObject:v22];
            }
            else
            {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412290;
            uint64_t v50 = (uint64_t)v8;
            _os_log_debug_impl(&dword_23886F000, v25, OS_LOG_TYPE_DEBUG, "Failed to read hang tracer data contents: %@", buf, 0xCu);
          }
        }
      }
      uint64_t v42 = [obj countByEnumeratingWithState:&v45 objects:v57 count:16];
...
- (id)getDiagnosticsForClient:(id)a3 dateString:(id)a4
{
  ...
  if (!self->_unarchivedHangTracerData)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_23886F000, MXHangTracerServiceLogHandle, OS_LOG_TYPE_DEFAULT, "Unarchived hang tracer data not yet set, running unarchive.", buf, 2u);
    }
    [(MXHangTracerService *)self unarchiveHangTracerDataForDateString:v7];
  }
  v30 = v7;
  ...
  long long v37 = 0u;
  long long v38 = 0u;
  id v10 = self->_unarchivedHangTracerData;
  ...
  if ([v9 count])
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v41 = v6;
      _os_log_impl(&dword_23886F000, v20, OS_LOG_TYPE_DEFAULT, "Found hang diagnostics for client: %@", buf, 0xCu);
    }
...
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_23886F000, log, OS_LOG_TYPE_ERROR, "Failed to start hang tracer service.", v1, 2u);
}
