...
- (unsigned)week
{
  return [(TSGPSTime *)self extendedWeek] & 0x3FF;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    unint64_t v5 = [(TSGPSTime *)self nanosecondsSinceEpoch];
...
{
  v3 = NSString;
  uint64_t v4 = [(TSGPSTime *)self extendedWeek];
  [(TSGPSTime *)self seconds];
  return (id)objc_msgSend(v3, "stringWithFormat:", @"GPS Time week %u seconds %0.9f", v4, v5);
}
