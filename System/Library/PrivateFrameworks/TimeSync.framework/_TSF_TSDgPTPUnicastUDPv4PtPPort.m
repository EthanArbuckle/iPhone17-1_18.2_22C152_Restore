...
- (_TSF_TSDgPTPUnicastUDPv4PtPPort)initWithService:(id)a3 pid:(int)a4;
...
@implementation _TSF_TSDgPTPUnicastUDPv4PtPPort

- (_TSF_TSDgPTPUnicastUDPv4PtPPort)initWithService:(id)a3 pid:(int)a4
{
  v9.receiver = self;
  v9.super_class = (Class)_TSF_TSDgPTPUnicastUDPv4PtPPort;
  v4 = [(_TSF_TSDgPTPFDPtPPort *)&v9 initWithService:a3 pid:*(void *)&a4];
  v5 = v4;
  if (v4)
  {
    uint64_t v6 = [(_TSF_TSDgPTPUnicastUDPv4PtPPort *)v4 _destinationIPv4Address];
...
- (id)_sourceAddressString
{
  ...
  if (v5)
  {
    ...
    uint64_t v7 = objc_msgSend(NSString, "stringWithFormat:", @"%u.%u.%u.%u", HIBYTE(v6), BYTE2(v6), BYTE1(v6), v6);
...
- (id)propertiesForXPC
{
  ...
  unsigned int v6 = [(_TSF_TSDgPTPPort *)self service];
...
+ (id)diagnosticInfoForService:(id)a3
{
  id v4 = a3;
  v15.receiver = a1;
  v15.super_class = (Class)&OBJC_METACLASS____TSF_TSDgPTPUnicastUDPv4PtPPort;
  ...
  if (v7)
  {
    ...
    v10 = objc_msgSend(NSString, "stringWithFormat:", @"%u.%u.%u.%u", HIBYTE(v9), BYTE2(v9), BYTE1(v9), v9);
  ...
  if (v11)
  {
    ...
    v13 = objc_msgSend(NSString, "stringWithFormat:", @"%u.%u.%u.%u", HIBYTE(v12), BYTE2(v12), BYTE1(v12), v12);
