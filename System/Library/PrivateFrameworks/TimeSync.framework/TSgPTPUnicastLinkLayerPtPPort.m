...
- (TSgPTPUnicastLinkLayerPtPPort)initWithImplDC:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    if (os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 136316418;
      v10 = "[portImpl isKindOfClass:[TSDgPTPUnicastLinkLayerPtPPort class]]";
      __int16 v11 = 2048;
      uint64_t v12 = 0;
      __int16 v13 = 2048;
      uint64_t v14 = 0;
  ...
  v8.receiver = self;
  v8.super_class = (Class)TSgPTPUnicastLinkLayerPtPPort;
  id v5 = [(TSgPTPFDPtPPort *)&v8 initWithImplDC:v4];
  if (v5)
  {
    id v6 = v4;
    self = (TSgPTPUnicastLinkLayerPtPPort *)*((void *)v5 + 8);
    *((void *)v5 + 8) = v6;
LABEL_4:
  }
  return (TSgPTPUnicastLinkLayerPtPPort *)v5;
}
...
- (NSData)destinationMACAddress
{
  return [(_TSF_TSDgPTPUnicastLinkLayerPtPPort *)self->_impl destinationMACAddress];
}
