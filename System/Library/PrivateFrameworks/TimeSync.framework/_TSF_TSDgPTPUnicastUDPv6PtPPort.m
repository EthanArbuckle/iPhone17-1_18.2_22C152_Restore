...
+ (id)iokitMatchingDictionaryForInterfaceName:(id)a3 andIPv6Address:(char *)a4
{
  ...
  v20[0] = @"IOTimeSyncUnicastUDPv6PtPPort";
  v19[0] = @"IOProviderClass";
  v19[1] = @"IOParentMatch";
  id v16 = a3;
  v17[0] = @"IOProviderClass";
  v17[1] = @"IOPropertyMatch";
  v18[0] = @"IOTimeSyncInterfaceAdapter";
  v15 = @"InterfaceName";
  v5 = (void *)MEMORY[0x1E4F1C9E8];
  id v6 = a3;
  v7 = [v5 dictionaryWithObjects:&v16 forKeys:&v15 count:1];
  v18[1] = v7;
  v8 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v18 forKeys:v17 count:2];
  v20[1] = v8;
  v19[2] = @"IOPropertyMatch";
  v13 = @"DestinationIPAddress";
  v9 = [MEMORY[0x1E4F1C9B8] dataWithBytes:a4 length:16];
  v14 = v9;
  v10 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v14 forKeys:&v13 count:1];
  v20[2] = v10;
  v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v20 forKeys:v19 count:3];
...
- (_TSF_TSDgPTPUnicastUDPv6PtPPort)initWithService:(id)a3 pid:(int)a4
{
  ...
  if (v4)
  {
    uint64_t v6 = [(_TSF_TSDgPTPUnicastUDPv6PtPPort *)v4 _destinationIPv6Address];
