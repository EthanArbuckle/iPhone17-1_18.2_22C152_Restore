...
- (void)viewDidLoad
{
  ...
  id v5 = [(CDPUICustodianInstructionsViewModel *)self->_viewModel footerText];
  ...
  if (v6)
  {
    ...
    objc_super v10 = [(CDPUICustodianInstructionsViewController *)self buttonTray];
    [v10 addButton:v7];
  }
...
- (void)_handleContinueAction:(id)a3
{
  ...
  if (v4)
  {
    id v6 = [(CDPUICustodianInstructionsViewModel *)self->_viewModel continueOption];
    id v5 = [v6 escapeAction];
    v5[2]();
  }
}
