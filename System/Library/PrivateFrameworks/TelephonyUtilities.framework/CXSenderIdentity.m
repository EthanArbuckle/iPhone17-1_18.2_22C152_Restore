...
- (TUSenderIdentity)tuSenderIdentity
{
  id v15 = objc_alloc((Class)TUSenderIdentity);
  ...
  v11 = [v10 tuHandle];
  id v12 = [v15 initWithUUID:v14 accountUUID:v3 ISOCountryCode:v4 localizedName:v5 localizedShortName:v7 localizedServiceName:v9 handle:v11];

  return (TUSenderIdentity *)v12;
}
