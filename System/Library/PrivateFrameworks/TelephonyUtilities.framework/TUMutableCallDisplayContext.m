...
- (void)mergeValuesFromDisplayContext:(id)a3
{
  ...
  v5 = TUBundle();
  v6 = [v5 localizedStringForKey:@"UNKNOWN" value:&stru_1EECEA668 table:@"TelephonyUtilities"];
  BOOL v7 = [v4 isEqualToString:v6] == 0;
  v8 = v40;
  if (v7) {
    v8 = self;
  }
  ...
  BOOL v7 = [(TUCallDisplayContext *)self callDirectoryIdentityType] == 0;
  v38 = v40;
  if (!v7) {
    v38 = self;
  }
  [(TUCallDisplayContext *)self setCallDirectoryIdentityType:[(TUCallDisplayContext *)v38 callDirectoryIdentityType]];
  BOOL v7 = [(TUCallDisplayContext *)self legacyAddressBookIdentifier] == -1;
  v39 = v40;
  if (!v7) {
    v39 = self;
  }
