@interface EDPBInteractionEventLinkClicked
- (BOOL)hasAccountId;
...
@implementation EDPBInteractionEventLinkClicked
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBInteractionEventLinkClicked;
  int v4 = [(EDPBInteractionEventLinkClicked *)&v8 description];
  v5 = [(EDPBInteractionEventLinkClicked *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C040B8[mailboxType];
    }
...
- (BOOL)readFrom:(id)a3
{
  return EDPBInteractionEventLinkClickedReadFrom((uint64_t)self, (uint64_t)a3);
}
