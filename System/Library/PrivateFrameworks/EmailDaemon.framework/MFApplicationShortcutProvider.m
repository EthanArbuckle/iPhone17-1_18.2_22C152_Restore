...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10005287C;
  block[3] = &unk_100139B30;
  block[4] = a1;
  if (qword_10016BA10 != -1) {
    dispatch_once(&qword_10016BA10, block);
  }
  v2 = (void *)qword_10016BA08;
...
- (id)_iconImageWithBackgroundColor:(id)a3
{
  ...
  double v6 = sub_10004BCE8(2, v5, 36.0);
  double v7 = sub_10004BCE8(3, v5, 36.0);
  if (v6 < v7) {
    double v6 = v7;
  }
  id v8 = +[NSBundle mainBundle];
  id v9 = sub_10004B734(2, v5, v8, v3, 0, v6);

  id v10 = +[NSBundle mainBundle];
  id v11 = sub_10004B734(3, v5, v10, v3, 0, v6);
  ...
  objc_msgSend(v9, "drawInRect:", CGRectZero.origin.x, y, v15, v17);
  [v9 size];
  objc_msgSend(v11, "drawInRect:", CGRectZero.origin.x, y + v20 + 2.0, v16, v18);
...
{
  id v3 = a3;
  id v4 = objc_msgSend(v3, "ef_map:", &stru_10013B6A0);
