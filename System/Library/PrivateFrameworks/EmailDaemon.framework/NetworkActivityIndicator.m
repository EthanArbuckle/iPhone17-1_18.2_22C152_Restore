...
- (void)setStatusBarShowsProgress:(BOOL)a3
{
  if (byte_10016BDE0 != a3)
  {
    byte_10016BDE0 = a3;
    off_10016B488(a3, @"com.apple.mobilemail", 2000);
  }
}
...
- (void)setStatusBarShowsMailProgress:(id)a3
{
  ...
  if (+[NSThread isMainThread])
  {
    if ([v11 BOOLValue])
    {
      uint64_t v5 = qword_10016BDE8;
      if (*(double *)&qword_10016BDE8 == 0.0)
      {
    ...
    {
      +[NSDate timeIntervalSinceReferenceDate];
      double v7 = v6 - *(double *)&qword_10016BDE8;
      double v8 = 1.0 - v7;
      BOOL v9 = v7 < 1.0;
