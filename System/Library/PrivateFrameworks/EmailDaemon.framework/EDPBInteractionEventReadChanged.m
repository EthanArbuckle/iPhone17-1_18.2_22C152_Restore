@interface EDPBInteractionEventReadChanged
- (BOOL)hasAccountId;
...
@implementation EDPBInteractionEventReadChanged
...
- (void)withHasher:(id)a3 setMessage:(id)a4 data:(id)a5
{
  ...
  -[EDPBInteractionEventReadChanged setValue:](self, "setValue:", [v10 BOOLValue]);
}
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBInteractionEventReadChanged;
  int v4 = [(EDPBInteractionEventReadChanged *)&v8 description];
  v5 = [(EDPBInteractionEventReadChanged *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C04268[mailboxType];
    }
  ...
  if ((has & 0x20) != 0)
  {
    id v11 = [NSNumber numberWithBool:self->_value];
...
- (BOOL)readFrom:(id)a3
{
  return EDPBInteractionEventReadChangedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_15:
  ...
  *((unsigned char *)v4 + 48) |= 8u;
  ...
  {
LABEL_7:
    *((unsigned char *)v4 + 44) = self->_value;
...
LABEL_7:
  *((unsigned char *)result + 44) = self->_value;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 48) & 1) == 0 || self->_accountId != *((void *)v4 + 1)) {
      goto LABEL_29;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 48) & 4) == 0 || self->_mailboxId != *((void *)v4 + 3)) {
      goto LABEL_29;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 0x10) != 0)
  {
    if ((*((unsigned char *)v4 + 48) & 0x10) == 0 || self->_mailboxType != *((_DWORD *)v4 + 10)) {
      goto LABEL_29;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 48) & 2) == 0 || self->_conversationId != *((void *)v4 + 2)) {
      goto LABEL_29;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 48) & 8) == 0 || self->_messageId != *((void *)v4 + 4)) {
      goto LABEL_29;
    }
  }
  ...
  BOOL v5 = (*((unsigned char *)v4 + 48) & 0x20) == 0;
  if ((*(unsigned char *)&self->_has & 0x20) != 0)
  {
...
LABEL_7:
  uint64_t v7 = 2654435761 * self->_value;
  return v3 ^ v2 ^ v4 ^ v5 ^ v6 ^ v7;
}
...
LABEL_15:
  ...
  *(unsigned char *)&self->_has |= 8u;
  ...
  {
LABEL_7:
    self->_value = *((unsigned char *)v4 + 44);
    *(unsigned char *)&self->_has |= 0x20u;
  }
LABEL_8:
}
