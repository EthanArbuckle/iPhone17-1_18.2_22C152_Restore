...
+ (id)sharedChangeManager
{
  if (qword_10016B880 != -1) {
    dispatch_once(&qword_10016B880, &stru_10013AD08);
  }
  v2 = (void *)qword_10016B878;
...
- (BOOL)addChange:(id)a3 currentAndPendingChangesBlock:(id)a4
{
  ...
  {
    objc_super v11 = (NSMutableArray *)objc_alloc_init((Class)NSMutableArray);
...
- (void)processPendingChanges
{
  ...
  while (1)
  {
    ...
    if ((v8 & 1) == 0)
    {
      ...
      {
        v18 = +[MFError errorWithDomain:v37 code:1030 localizedDescription:v16 title:v17 userInfo:&off_1001465B0];
...
LABEL_9:
  ...
  long long v25 = 0u;
  long long v26 = 0u;
  uint64_t v16 = self->_pendingChanges;
...
LABEL_17:
  v20 = objc_msgSend(v11, "uniqueID", (void)v25);
  if (v20)
  {
  ...
  long long v22 = [v14 flattenedMailboxTreeRepresentation];
...
{
  id v7 = a5;
  BOOL v8 = [a3 treeOfAllGenericMailboxes];
  pendingChanges = self->_pendingChanges;
  if (pendingChanges && [(NSMutableArray *)pendingChanges count])
  {
    if (!self->_currentChange) {
...
LABEL_15:
  ...
  v14 = objc_msgSend(v8, "flattenedMailboxTreeRepresentation", (void)v16);
...
- (id)parentForMailbox:(id)a3
{
  ...
  id v6 = [v4 account];
  id v7 = [v6 uniqueID];
  BOOL v8 = [(NSMutableDictionary *)lastCalculatedMailboxDictionary objectForKeyedSubscript:v7];
