@interface EDPBInteractionEventForwardDraftStarted
- (BOOL)hasAccountId;
...
- (id)description
{
  ...
  int v4 = [(EDPBInteractionEventForwardDraftStarted *)&v8 description];
  v5 = [(EDPBInteractionEventForwardDraftStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C04028[mailboxType];
    }
