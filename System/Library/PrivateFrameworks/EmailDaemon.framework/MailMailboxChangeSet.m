...
- (BOOL)commit
{
  ...
  unsigned int v3 = [(MCSMailboxOperation *)self->_mailboxOperation commit];
  v4 = MFLogGeneral();
...
- (id)description
{
  ...
  unsigned int v3 = [(MailMailboxChangeSet *)&v6 description];
...
- (BOOL)allowOtherChange:(id)a3
{
  ...
  if ((v4 == 0) | ((objc_opt_isKindOfClass() & 1) == 0)) {
    ...
    unsigned __int8 v5 = [(MCSMailboxOperation *)self->_mailboxOperation allowOtherMailboxOperation:v4[3]];
  }
