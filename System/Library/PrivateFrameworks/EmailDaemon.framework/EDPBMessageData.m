...
- (void)withHasher:(id)a3 setDataFromMessage:(id)a4;
- (void)withHasher:(id)a3 setDataFromMessage:(id)a4 account:(id)a5;
- (void)writeTo:(id)a3;
@end

@implementation EDPBMessageData
...
- (void)withHasher:(id)a3 setDataFromMessage:(id)a4 account:(id)a5
{
  ...
  if (v9) {
    -[EDPBMessageData setAccountId:](self, "setAccountId:", [v11 hashedAccountID:v9]);
  }
  v10 = [v11 hashedMessageHeadersForMessage:v8];
  [(EDPBMessageData *)self setHeaders:v10];
}
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBMessageData;
  int v4 = [(EDPBMessageData *)&v8 description];
  v5 = [(EDPBMessageData *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C04340[mailboxType];
    }
  ...
  if (headers)
  {
    v12 = [(EDPBMessageHeaders *)headers dictionaryRepresentation];
    [v3 setObject:v12 forKey:@"headers"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return EDPBMessageDataReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_7:
  id v8 = [(EDPBMessageHeaders *)self->_headers copyWithZone:a3];
  id v9 = (void *)v6[5];
  v6[5] = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 52) & 1) == 0 || self->_accountId != *((void *)v4 + 1)) {
      goto LABEL_29;
    }
  }
...
LABEL_29:
  ...
  {
    if ((*((unsigned char *)v4 + 52) & 4) == 0 || self->_mailboxId != *((void *)v4 + 3)) {
      goto LABEL_29;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 0x10) != 0)
  {
    if ((*((unsigned char *)v4 + 52) & 0x10) == 0 || self->_mailboxType != *((_DWORD *)v4 + 12)) {
      goto LABEL_29;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 52) & 2) == 0 || self->_conversationId != *((void *)v4 + 2)) {
      goto LABEL_29;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 8) != 0)
  {
    if ((*((unsigned char *)v4 + 52) & 8) == 0 || self->_messageId != *((void *)v4 + 4)) {
      goto LABEL_29;
    }
  }
  ...
  headers = self->_headers;
  if ((unint64_t)headers | *((void *)v4 + 5)) {
    char v6 = -[EDPBMessageHeaders isEqual:](headers, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
LABEL_11:
    uint64_t v6 = 0;
    return v3 ^ v2 ^ v4 ^ v5 ^ v6 ^ [(EDPBMessageHeaders *)self->_headers hash];
  }
LABEL_9:
  uint64_t v4 = 0;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
...
LABEL_7:
  ...
  {
    -[EDPBMessageData setHeaders:](self, "setHeaders:");
  }
}
