...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10004D4B0;
  block[3] = &unk_100139B30;
  block[4] = a1;
  if (qword_10016B9E0 != -1) {
    dispatch_once(&qword_10016B9E0, block);
  }
  v2 = (void *)qword_10016B9D8;
...
LABEL_8:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = objc_msgSend(v13, "ef_publicDescription");
...
- (BOOL)shouldHealFromAlternateAccount
{
  ...
  if (v14)
  {
    ...
    BOOL v18 = (uint64_t)[v17 day] > 0 || (uint64_t)objc_msgSend(v17, "hour") > 24;
  }
  else
  {
    BOOL v18 = 1;
...
- (id)_fetchServerFromACEDB:(id)a3 forIncomingServer:(BOOL)a4
{
  ...
  else
  {
    ...
    {
      unsigned int v8 = &stru_10013ED08;
    }
  }
...
- (id)_getMailAccountFromDeliveryAccount:(id)a3
{
  ...
  id v5 = v3;
  id v9 = v5;
  id v6 = objc_msgSend(v4, "ef_firstObjectPassingTest:", v8);
