@interface EDPBInteractionEventFlagChanged
- (BOOL)hasAccountId;
...
- (void)withHasher:(id)a3 setMessage:(id)a4 data:(id)a5
{
  ...
  -[EDPBInteractionEventFlagChanged setValue:](self, "setValue:", [v10 BOOLValue]);
}
...
- (id)description
{
  ...
  int v4 = [(EDPBInteractionEventFlagChanged *)&v8 description];
  v5 = [(EDPBInteractionEventFlagChanged *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C03FE0[mailboxType];
    }
