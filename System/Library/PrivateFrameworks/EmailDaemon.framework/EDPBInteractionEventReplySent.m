@interface EDPBInteractionEventReplySent
- (BOOL)hasAccountId;
...
@implementation EDPBInteractionEventReplySent
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBInteractionEventReplySent;
  int v4 = [(EDPBInteractionEventReplySent *)&v8 description];
  v5 = [(EDPBInteractionEventReplySent *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C042F8[mailboxType];
    }
...
- (BOOL)readFrom:(id)a3
{
  return EDPBInteractionEventReplySentReadFrom((uint64_t)self, (uint64_t)a3);
}
