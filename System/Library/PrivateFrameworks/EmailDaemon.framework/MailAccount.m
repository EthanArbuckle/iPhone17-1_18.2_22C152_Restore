...
- (id)mailboxesToBeObserved:(id)a3;
- (id)mailboxesToBeObservedWithFavoritesReader:(id)a3;
...
+ (id)nano_bridgeSettingsInboxesFromAccounts:(id)a3
{
  id v3 = objc_msgSend(a3, "ef_map:", &stru_10013AAF0);
  v4 = objc_msgSend(v3, "ef_filter:", &stru_10013AB10);
...
+ (id)accountImageForAccounts:(id)a3
{
  ...
  if ((unint64_t)[v3 count] <= 1)
  {
    ...
    if (!qword_10016B858)
    {
      ...
      uint64_t v7 = (void *)qword_10016B858;
      qword_10016B858 = (uint64_t)v6;
    }
    v8 = [v5 iconString];
    v4 = [(id)qword_10016B858 objectForKey:v8];
    if (!v4)
    {
      if (!qword_10016B860)
      {
        uint64_t v9 = +[NSBundle bundleForClass:objc_opt_class()];
        v10 = (void *)qword_10016B860;
        qword_10016B860 = v9;
      }
      ...
      [(id)qword_10016B858 setObject:v4 forKey:v8];
    }
...
- (void)_loadOutbox:(id)a3
{
  ...
  id v9 = +[DaemonAppController sharedController];
...
- (id)mailboxesToBeObserved:(id)a3
{
  ...
  BOOL v6 = [(MailAccount *)self pushedMailboxUids];
  id v7 = [v5 initWithSet:v6];

  id v8 = [v4 favoriteMailboxesForAccount:self];
  [v7 unionSet:v8];
...
- (id)mailboxesToBeObservedWithFavoritesReader:(id)a3
{
  ...
  BOOL v6 = [(MailAccount *)self pushedMailboxUids];
  id v7 = [v5 initWithSet:v6];
  id v8 = objc_msgSend(v7, "ef_filter:", &stru_10013DB00);
  ...
  long long v20 = 0u;
  long long v21 = 0u;
  int v10 = objc_msgSend(v4, "mailboxesCollection", 0);
  long long v11 = [v10 visibleItems];
    ...
    do
    {
      for (i = 0; i != v12; i = (char *)i + 1)
      {
        ...
        if ([v15 type] == (id)2)
        {
          ...
          if (v16 == self)
          {
            int v17 = [v15 representingMailbox];
            BOOL v18 = v17 == 0;

            if (v18) {
              continue;
            }
            v16 = [v15 representingMailbox];
            [v9 addObject:v16];
          }
        }
      }
