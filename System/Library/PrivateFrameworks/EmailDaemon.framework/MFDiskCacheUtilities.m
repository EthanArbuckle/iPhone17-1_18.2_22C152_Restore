...
+ (void)_enumerateContentsForAccounts:(id)a3 withType:(unint64_t)a4 handler:(id)a5
{
  ...
  char v40 = 0;
  objc_msgSend(v21, "ef_flatMap:", &stru_10013BEC0);
  long long v35 = 0u;
  long long v36 = 0u;
  long long v34 = 0u;
  long long v33 = 0u;
...
+ (int64_t)deletePlaceholderAttachments
{
  return (int64_t)[a1 deletePlaceholderAttachmentsWithCreationDateOver:30];
}
...
+ (void)_enumeratePurgeableFileInTemporaryDirectoryWithHandler:(id)a3
{
  ...
  id v12 = v5;
  id v16 = v12;
  objc_msgSend(v10, "mf_enumerateAtPath:withBlock:", v9, v14);
}
