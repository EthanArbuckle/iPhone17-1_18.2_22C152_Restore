...
@implementation EDPETSubmittedEvent
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPETSubmittedEvent;
  v4 = [(EDPETSubmittedEvent *)&v8 description];
  v5 = [(EDPETSubmittedEvent *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return EDPETSubmittedEventReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_timezoneOffset;
  return v3 ^ v2;
}
