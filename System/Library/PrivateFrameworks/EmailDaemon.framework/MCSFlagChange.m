...
- (MCSFlagChange)initWithFlagsToSet:(id)a3 flagsToClear:(id)a4 reason:(int64_t)a5
{
  ...
  if (v10)
  {
    sub_10003CC30((uint64_t)v10, v11, v12, v13, v14, v15, v16, v17, (uint64_t)v8);
...
- (BOOL)commitToMessages:(id)a3 failures:(id)a4 newMessages:(id)a5
{
  ...
  if ([v23 count])
  {
    ...
    objc_msgSend(v19, "mf_dictionaryWithMessagesSortedByStore");
    long long v26 = 0u;
    long long v27 = 0u;
    long long v24 = 0u;
    long long v25 = 0u;
...
- (id)localizedShortOperationDescription
{
  ...
  uint64_t v3 = [v2 localizedStringForKey:@"OPERATION_FLAG_DESC" value:&stru_10013ED08 table:@"Main"];
