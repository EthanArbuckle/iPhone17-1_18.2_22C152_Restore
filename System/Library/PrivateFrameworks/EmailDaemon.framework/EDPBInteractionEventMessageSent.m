@interface EDPBInteractionEventMessageSent
- (BOOL)hasAccountId;
...
- (void)withHasher:(id)a3 setDataFromMessage:(id)a4 account:(id)a5
{
  ...
  if (v9) {
    -[EDPBInteractionEventMessageSent setAccountId:](self, "setAccountId:", [v11 hashedAccountID:v9]);
  }
  v10 = [v11 hashedMessageHeadersForMessage:v8];
  [(EDPBInteractionEventMessageSent *)self setHeaders:v10];
}
...
- (id)description
{
  ...
  int v4 = [(EDPBInteractionEventMessageSent *)&v8 description];
  v5 = [(EDPBInteractionEventMessageSent *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C04190[mailboxType];
    }
