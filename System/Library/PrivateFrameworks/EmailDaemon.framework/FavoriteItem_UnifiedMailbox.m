...
- (FavoriteItem_UnifiedMailbox)initWithDictionary:(id)a3
{
  ...
  objc_super v5 = [(FavoriteItem *)&v8 initWithDictionary:v4];
  if (v5)
  {
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (FavoriteItem_UnifiedMailbox *)a3;
  objc_super v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
...
- (id)itemID
{
  ...
  if (!itemID)
  {
    ...
    objc_super v5 = +[NSString stringWithFormat:@"%@-%ld", collectionID, [(FavoriteItem_UnifiedMailbox *)self mailboxType]];
...
- (id)dictionaryRepresentation
{
  ...
  unsigned __int8 v4 = +[NSNumber numberWithInteger:self->_mailboxType];
