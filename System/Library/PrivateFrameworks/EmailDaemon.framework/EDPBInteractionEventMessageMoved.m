@interface EDPBInteractionEventMessageMoved
- (BOOL)hasAccountId;
...
@implementation EDPBInteractionEventMessageMoved
...
- (void)withHasher:(id)a3 setMessage:(id)a4 mailbox:(id)a5
{
  ...
  id v9 = a5;
  v10 = [v8 account];
  -[EDPBInteractionEventMessageMoved setAccountId:](self, "setAccountId:", [v19 hashedAccountID:v10]);

  -[EDPBInteractionEventMessageMoved setConversationId:](self, "setConversationId:", objc_msgSend(v19, "hashedConversationID:", objc_msgSend(v8, "conversationID")));
  v11 = [v8 messageIDHeader];
  v12 = objc_msgSend(v11, "ec_messageIDSubstring");
  -[EDPBInteractionEventMessageMoved setMessageId:](self, "setMessageId:", [v19 hashedString:v12]);

  v13 = [v8 mailbox];
  -[EDPBInteractionEventMessageMoved setFromMailboxId:](self, "setFromMailboxId:", [v19 hashedMailboxID:v13]);
  ...
  [(EDPBInteractionEventMessageMoved *)self setFromMailboxType:v16];

  -[EDPBInteractionEventMessageMoved setToMailboxId:](self, "setToMailboxId:", [v19 hashedMailboxID:v9]);
  ...
  [(EDPBInteractionEventMessageMoved *)self setToMailboxType:v18];
}
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBInteractionEventMessageMoved;
  int v4 = [(EDPBInteractionEventMessageMoved *)&v8 description];
  v5 = [(EDPBInteractionEventMessageMoved *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x20) != 0)
  {
    ...
    {
      v10 = off_1E6C04148[fromMailboxType];
    }
  ...
  if ((has & 0x40) != 0)
  {
    ...
    {
      v13 = off_1E6C04148[toMailboxType];
    }
...
- (BOOL)readFrom:(id)a3
{
  return EDPBInteractionEventMessageMovedReadFrom((uint64_t)self, (uint64_t)a3);
}
