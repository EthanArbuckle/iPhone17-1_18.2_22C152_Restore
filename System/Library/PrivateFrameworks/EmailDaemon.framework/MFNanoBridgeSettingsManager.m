...
+ (id)sharedInstance
{
  if (qword_10016BC50 != -1) {
    dispatch_once(&qword_10016BC50, &stru_10013CED8);
  }
  v2 = (void *)qword_10016BC48;
...
- (MFNanoBridgeSettingsManager)init
{
  if (MFDeviceSupportsNanoCompanion())
  {
    ...
    if (v3)
    {
      ...
      v10 = (NPSManager *)objc_alloc_init(off_10016AA60());
...
- (BOOL)_askBeforeDeleting
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_10016AA88();
  }
  BOOL v6 = v5;
...
- (BOOL)_loadRemoteImages
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_10016AA98();
  }
  BOOL v6 = v5;
...
- (BOOL)_organizeByThread
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_10016AAA8();
  }
  BOOL v6 = v5;
...
- (id)_signature
{
  ...
  else
  {
    ...
    id v7 = off_10016AAD0();
    id v5 = [v6 localizedStringForKey:v7 value:&stru_10013ED08 table:@"NanoMailKit"];
  }
...
- (BOOL)_alwaysLoadContentDirectly
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_10016AAE0();
  }
  BOOL v6 = v5;
...
- (BOOL)_cloudNotificationsEnabled
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_10016AAF0();
  }
  BOOL v6 = v5;
...
LABEL_8:
  ...
  if (v24)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG)) {
      sub_1000C1F48((uint64_t)v11, v25);
    }
...
- (id)domainAccessor
{
  ...
  if (!domainAccessor)
  {
    id v4 = (NPSDomainAccessor *)[objc_alloc(off_10016AB08()) initWithDomain:@"com.apple.NanoMail"];
