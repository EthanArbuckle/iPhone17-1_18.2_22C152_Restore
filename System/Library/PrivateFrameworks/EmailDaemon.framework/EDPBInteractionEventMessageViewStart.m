@interface EDPBInteractionEventMessageViewStart
- (BOOL)hasAccountId;
...
@implementation EDPBInteractionEventMessageViewStart
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBInteractionEventMessageViewStart;
  int v4 = [(EDPBInteractionEventMessageViewStart *)&v8 description];
  v5 = [(EDPBInteractionEventMessageViewStart *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C04220[mailboxType];
    }
...
- (BOOL)readFrom:(id)a3
{
  return EDPBInteractionEventMessageViewStartReadFrom((uint64_t)self, (uint64_t)a3);
}
