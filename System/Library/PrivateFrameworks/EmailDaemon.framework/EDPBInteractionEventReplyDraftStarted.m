@interface EDPBInteractionEventReplyDraftStarted
- (BOOL)hasAccountId;
...
@implementation EDPBInteractionEventReplyDraftStarted
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)EDPBInteractionEventReplyDraftStarted;
  int v4 = [(EDPBInteractionEventReplyDraftStarted *)&v8 description];
  v5 = [(EDPBInteractionEventReplyDraftStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x10) != 0)
  {
    ...
    {
      objc_super v8 = off_1E6C042B0[mailboxType];
    }
...
- (BOOL)readFrom:(id)a3
{
  return EDPBInteractionEventReplyDraftStartedReadFrom((uint64_t)self, (uint64_t)a3);
}
