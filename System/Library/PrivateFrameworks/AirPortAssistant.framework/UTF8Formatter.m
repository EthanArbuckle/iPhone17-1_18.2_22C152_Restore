...
- (id)initAFPFormatterWithLength:(unint64_t)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v11 = objc_msgSend_invertedSet(v7, v9, v10);
...
- (UTF8Formatter)initWithMaxByteCount:(unint64_t)a3 maxLength:(unint64_t)a4
{
  uint64_t v5 = (UTF8Formatter *)objc_msgSend_initWithMaxLength_(self, a2, a4);
  v7 = v5;
  if (v5)
  {
    objc_msgSend_setMaxByteCount_(v5, v6, a3);
    uint64_t v10 = objc_msgSend_controlCharacterSet(MEMORY[0x263F08708], v8, v9);
    objc_msgSend_setInvertedCharacterSet_(v7, v11, v10);
    v14 = objc_msgSend_invertedCharacterSet(v7, v12, v13);
    uint64_t v17 = objc_msgSend_invertedSet(v14, v15, v16);
...
- (BOOL)isPartialStringValid:(id)a3 newEditingString:(id *)a4 errorDescription:(id *)a5
{
  ...
  BOOL v9 = -[APFormatter isPartialStringValid:newEditingString:errorDescription:](&v20, sel_isPartialStringValid_newEditingString_errorDescription_);
  if (v9)
  {
    if (objc_msgSend_length(a3, v10, v11))
    {
      unint64_t v14 = objc_msgSend_maxByteCount(self, v12, v13);
      unint64_t v18 = objc_msgSend_UTF8ByteCount(a3, v15, v16);
      LOBYTE(v9) = 1;
      if (v14 && v18 > v14)
      {
        if (a4) {
...
+ (id)afpSet
{
  ...
  uint64_t v5 = objc_msgSend_controlCharacterSet(MEMORY[0x263F08708], v3, v4);
