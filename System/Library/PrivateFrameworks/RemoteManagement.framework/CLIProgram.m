...
+ (id)globalOptionSet
{
  return [(id)qword_100025418 _copiedSet];
}
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        v9 = objc_msgSend((id)qword_100025410, "objectForKey:", v8, (void)v13);
        v10 = [v9 _copiedSet];
        v11 = [v8 name];
...
+ (CLIProgram)sharedProgram
{
  ...
  if (qword_100025430 != -1) {
    dispatch_once(&qword_100025430, &stru_10001C878);
  }
  id v4 = (void *)qword_100025438;
...
+ (id)nextOptionParser
{
  ...
  uint64_t v4 = qword_100025450;
  id v5 = (char *)[v3 count];
  objc_super v6 = +[NSIndexSet indexSetWithIndexesInRange:](NSIndexSet, "indexSetWithIndexesInRange:", v4, &v5[-qword_100025450]);
...
LABEL_6:
      ...
      if (v9)
      {
        ...
        if (v15)
        {
          sub_100011860(@"ambiguous command \"%@\" - did you mean \"%@\"?", v16, v17, v18, v19, v20, v21, v22, (uint64_t)v9);
        }
        else
        {
          sub_100011860(@"unknown command \"%@\"", v16, v17, v18, v19, v20, v21, v22, (uint64_t)v9);
          sub_10000E520(0);
        }
        exit(64);
      }
