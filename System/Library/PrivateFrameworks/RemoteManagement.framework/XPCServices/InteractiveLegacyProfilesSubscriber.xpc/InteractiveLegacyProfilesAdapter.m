...
- (id)configurationClasses
{
  ...
  *(_OWORD *)(v2 + 16) = xmmword_100009D10;
  *(void *)(v2 + 32) = sub_1000087A4(0, &qword_1000109C8);
  sub_100001E9C(&qword_100010B80);
  v3.super.isa = sub_100009560().super.isa;
...
- (void)beginProcessingConfigurationsForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  v13[5] = v12;
  v14 = self;
  sub_1000045CC((uint64_t)v8, (uint64_t)&unk_100010B78, (uint64_t)v13);
  swift_release();
}
...
- (void)endProcessingConfigurations:(BOOL)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  *(void *)(v12 + 40) = self;
  ...
  v15[5] = v14;
  v16 = self;
  sub_1000045CC((uint64_t)v10, (uint64_t)&unk_100010B58, (uint64_t)v15);
  swift_release();
}
...
- (void)allDeclarationKeysForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  v13[5] = v12;
  v14 = self;
  sub_1000045CC((uint64_t)v8, (uint64_t)&unk_100010B28, (uint64_t)v13);
  swift_release();
}
...
- (void)applyConfiguration:(RMSubscribedConfigurationReference *)a3 replaceKey:(RMStoreDeclarationKey *)a4 scope:(int64_t)a5 completionHandler:(id)a6
{
  ...
  v19 = a4;
  v20 = self;
  sub_1000045CC((uint64_t)v12, (uint64_t)&unk_100010B00, (uint64_t)v17);
  swift_release();
}
...
- (void)removeDeclarationKey:(RMStoreDeclarationKey *)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  v16 = a3;
  uint64_t v17 = self;
  sub_1000045CC((uint64_t)v10, (uint64_t)&unk_100010AD0, (uint64_t)v15);
  swift_release();
}

- (id)declarationKeyForConfiguration:(id)a3
{
  NSArray v3 = *(void **)((char *)self
