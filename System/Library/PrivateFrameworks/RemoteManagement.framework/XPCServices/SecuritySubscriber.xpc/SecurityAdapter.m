...
- (id)configurationClasses
{
  ...
  *(_OWORD *)(v2 + 16) = xmmword_1000111B0;
  *(void *)(v2 + 32) = sub_10000B8A0(0, &qword_100018BC8);
  *(void *)(v2 + 40) = sub_10000B8A0(0, &qword_100018BD0);
  sub_100003028(&qword_100018D40);
  v3.super.isa = sub_100010788().super.isa;
...
- (void)allDeclarationKeysForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  v13[5] = v12;
  v14 = self;
  sub_10000CB04((uint64_t)v8, (uint64_t)&unk_100018D28, (uint64_t)v13);
  swift_release();
}
...
- (void)applyConfiguration:(RMSubscribedConfigurationReference *)a3 replaceKey:(RMStoreDeclarationKey *)a4 scope:(int64_t)a5 completionHandler:(id)a6
{
  ...
  v19 = a4;
  v20 = self;
  sub_10000CB04((uint64_t)v12, (uint64_t)&unk_100018D00, (uint64_t)v17);
  swift_release();
}
...
- (void)removeDeclarationKey:(RMStoreDeclarationKey *)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  v16 = a3;
  v17 = self;
  sub_10000CB04((uint64_t)v10, (uint64_t)&unk_100018CE0, (uint64_t)v15);
  swift_release();
}
