@interface AccountTransformerCardDAV
...
@implementation AccountTransformerCardDAV
...
- (void)accountPropertiesFromConfiguration:(id)a3 account:(id)a4 accountStore:(id)a5 completionHandler:(id)a6
{
  ...
  id v20 = v11;
  v16.receiver = self;
  v16.super_class = (Class)AccountTransformerCardDAV;
  id v12 = v21;
  id v13 = v11;
  id v14 = v22;
  id v15 = v10;
...
LABEL_14:
        ...
        id v19 = +[RMLog accountTransformerCardDAV];
...
LABEL_13:
      ...
      id v13 = +[RMLog accountTransformerCardDAV];
...
- (void)configurationUIForConfiguration:(id)a3 completionHandler:(id)a4
{
  ...
  v6 = +[RMLog accountTransformerCardDAV];
  ...
  id v14 = +[RMStoreLocalizable string:@"UI.Description.CardDAV"];
