...
+ (NSArray)registeredCommandNames
{
  return (NSArray *)[(id)qword_100025408 allKeys];
}

+ (id)registeredCommandWithName:(id)a3
{
  return [(id)qword_100025408 objectForKeyedSubscript:a3];
}
...
- (void)register
{
  ...
  if ([(id)qword_100025420 containsObject:self])
  {
  ...
  else
  {
    ...
    [(id)qword_100025408 setObject:self forKeyedSubscript:v8];
    long long v19 = 0u;
    long long v20 = 0u;
    long long v17 = 0u;
    long long v18 = 0u;
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v12; i = (char *)i + 1)
        {
          ...
          [(id)qword_100025408 setObject:self forKeyedSubscript:*(void *)(*((void *)&v17 + 1) + 8 * i)];
        }
