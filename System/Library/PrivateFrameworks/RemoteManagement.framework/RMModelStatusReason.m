...
+ (id)failedWithUnknownPayloadKeys:(id)a3
{
  CFStringRef v9 = @"UnknownPayloadKeys";
  id v10 = a3;
  id v4 = a3;
...
+ (id)failedWithUnknownDeclarationType:(id)a3
{
  CFStringRef v9 = @"UnknownDeclarationType";
  id v10 = a3;
  id v4 = a3;
  v5 = +[NSDictionary dictionaryWithObjects:&v10 forKeys:&v9 count:1];
  v6 = +[RMModelAnyPayload buildFromDictionary:v5];
...
+ (id)predicateEvaluatedToFalseForActivation:(id)a3
{
  ...
  v18[1] = v8;
  v17[2] = @"Predicate";
  CFStringRef v9 = [v3 predicateDescription];
...
+ (id)predicateEvaluationFailedWithError:(id)a3 forActivation:(id)a4
{
  ...
  if ([v7 isEqualToString:RMErrorDomain] && (uint64_t)objc_msgSend(v5, "code") >= 2100)
  {
    ...
    if (v8 <= 2199)
    {
      CFStringRef v9 = +[RMModelStatusReason reasonWithError:v5];
      id v10 = [v9 statusDetails];
      v11 = [v10 dictKeys];
  ...
  else
  {
    ...
    {
      id v21 = [v5 localizedFailureReason];
    }
    id v18 = v21;
  }
  uint64_t v40 = [v6 identifier];
  v42 = [v6 serverToken];
  ...
  id v44 = +[RMModelStatusReason buildWithCode:@"Error.PredicateFailed" description:v22 details:v30];
...
+ (id)missingAssetIdentifiers:(id)a3 forConfiguration:(id)a4
{
  ...
  id v6 = a3;
  v7 = [v5 identifier];
  uint64_t v8 = [v5 serverToken];
  CFStringRef v9 = +[NSString stringWithFormat:@"Configuration (%@:%@) is missing assets.", v7, v8];
  v19[0] = @"Identifier";
...
+ (id)missingConfigurationIdentifiers:(id)a3 forActivation:(id)a4
{
  ...
  v7 = [v5 identifier];
  uint64_t v8 = [v5 serverToken];
  CFStringRef v9 = +[NSString stringWithFormat:@"Activation (%@:%@) is missing configurations.", v7, v8];
  v19[0] = @"Identifier";
  id v10 = [v5 identifier];
  v20[0] = v10;
  v19[1] = @"ServerToken";
...
+ (id)invalidPayloadForDeclaration:(id)a3
{
  id v3 = a3;
  id v4 = [v3 entity];
  id v5 = +[RMActivationPayload entity];
  ...
  {
    uint64_t v8 = +[RMAssetPayload entity];
    ...
    {
      id v10 = +[RMConfigurationPayload entity];
  ...
  v13 = [v3 serverToken];
  id v14 = +[NSString stringWithFormat:@"%@ (%@:%@) has an invalid payload.", v7, v12, v13];
  v21[0] = @"Identifier";
  v15 = [v3 identifier];
  v21[1] = @"ServerToken";
  v22[0] = v15;
  ...
  id v18 = +[RMModelAnyPayload buildFromDictionary:v17];
...
+ (id)missingStateForDeclaration:(id)a3
{
  ...
  id v12 = [v3 identifier];
  v13 = [v3 serverToken];
  id v14 = +[NSString stringWithFormat:@"%@ (%@:%@) is missing state.", v7, v12, v13];
  v21[0] = @"Identifier";
  v15 = [v3 identifier];
  v21[1] = @"ServerToken";
  v22[0] = v15;
...
+ (id)activationFailed:(id)a3
{
  id v3 = a3;
  id v4 = [v3 identifier];
  id v5 = [v3 serverToken];
  unsigned __int8 v6 = +[NSString stringWithFormat:@"Activation “%@:%@” has errors.", v4, v5];
  v13[0] = @"Identifier";
  v7 = [v3 identifier];
  v13[1] = @"ServerToken";
  v14[0] = v7;
  uint64_t v8 = [v3 serverToken];

  v14[1] = v8;
  unsigned __int8 v9 = +[NSDictionary dictionaryWithObjects:v14 forKeys:v13 count:2];
  id v10 = +[RMModelAnyPayload buildFromDictionary:v9];
  unsigned __int8 v11 = +[RMModelStatusReason buildWithCode:@"Error.ActivationFailed" description:v6 details:v10];
...
+ (id)configurationFailed:(id)a3
{
  ...
  id v4 = [v3 identifier];
  id v5 = [v3 serverToken];
  unsigned __int8 v6 = +[NSString stringWithFormat:@"Configuration “%@:%@” has errors.", v4, v5];
  v13[0] = @"Identifier";
  v7 = [v3 identifier];
  v13[1] = @"ServerToken";
  v14[0] = v7;
  ...
  unsigned __int8 v9 = +[NSDictionary dictionaryWithObjects:v14 forKeys:v13 count:2];
  id v10 = +[RMModelAnyPayload buildFromDictionary:v9];
  unsigned __int8 v11 = +[RMModelStatusReason buildWithCode:@"Error.ConfigurationFailed" description:v6 details:v10];
...
+ (id)configurationIsNotReferencedByAnActivation:(id)a3
{
  ...
  id v4 = [v3 identifier];
  id v5 = [v3 serverToken];
  unsigned __int8 v6 = +[NSString stringWithFormat:@"Configuration “%@:%@” is not referenced by an activation.", v4, v5];
  v13[0] = @"Identifier";
  v7 = [v3 identifier];
  v13[1] = @"ServerToken";
  v14[0] = v7;
  ...
  unsigned __int8 v9 = +[NSDictionary dictionaryWithObjects:v14 forKeys:v13 count:2];
  id v10 = +[RMModelAnyPayload buildFromDictionary:v9];
  unsigned __int8 v11 = +[RMModelStatusReason buildWithCode:@"Info.NotReferencedByActivation" description:v6 details:v10];
...
+ (id)assetIsNotReferencedByConfiguration:(id)a3
{
  ...
  id v4 = [v3 identifier];
  id v5 = [v3 serverToken];
  unsigned __int8 v6 = +[NSString stringWithFormat:@"Asset “%@:%@” is not referenced by a configuration.", v4, v5];
  v13[0] = @"Identifier";
  v7 = [v3 identifier];
  v13[1] = @"ServerToken";
  v14[0] = v7;
  ...
  unsigned __int8 v9 = +[NSDictionary dictionaryWithObjects:v14 forKeys:v13 count:2];
  id v10 = +[RMModelAnyPayload buildFromDictionary:v9];
  unsigned __int8 v11 = +[RMModelStatusReason buildWithCode:@"Info.NotReferencedByConfiguration" description:v6 details:v10];
