...
- (NDOLongValueCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  v4 = [(NDOLongValueCell *)&v44 initWithStyle:a3 reuseIdentifier:a4];
  v5 = v4;
  if (v4)
  {
...
- (void)updateConstraints
{
  ...
  int64_t v12 = [(PSTableCell *)self type];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  v10 = self;
  v11 = [v10 stackView];
  int64_t v12 = [(NDOLongValueCell *)self secondaryLabel];
  int v13 = [v11 containsView:v12];
