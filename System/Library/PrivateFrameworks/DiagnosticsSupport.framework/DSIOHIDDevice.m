...
+ (id)deviceWithAccessory:(unint64_t)a3 identifierMask:(unint64_t)a4
{
  ...
  v9 = (void *)[v7 initWithDeviceIdentifiers:v8 identifierMask:a4];
...
+ (id)deviceMatchingAccessories:(id)a3 identifierMask:(unint64_t)a4
{
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        v12 = +[DSIODeviceIdentifier identifierForAccessoryModel:](DSIODeviceIdentifier, "identifierForAccessoryModel:", (int)objc_msgSend(v11, "intValue", v16));
        if (v12)
        {
          [v5 addObject:v12];
        }
        else
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412290;
            v23 = v11;
            _os_log_fault_impl(&dword_22CA94000, v13, OS_LOG_TYPE_FAULT, "Identifier not found for accessory %@", buf, 0xCu);
          }
        }
      }
  ...
  v14 = (void *)[[v16 alloc] initWithDeviceIdentifiers:v5 identifierMask:a4];
  return v14;
}
...
- (DSIOHIDDevice)initWithDeviceIdentifiers:(id)a3 identifierMask:(unint64_t)a4
{
  ...
  uint64_t v7 = [(DSIOHIDDevice *)&v41 init];
  if (!v7)
  {
LABEL_36:
    v30 = v7;
  ...
  uint64_t v8 = IOHIDManagerCreate((CFAllocatorRef)*MEMORY[0x263EFFB08], 0);
  v35 = v7;
  v7->_manager = v8;
  ...
  do
  {
    ...
    do
    {
      ...
      if (v4)
      {
        long long v18 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", objc_msgSend(v14, "usagePage"));
...
LABEL_9:
      ...
      long long v19 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", objc_msgSend(v14, "usage"));
...
LABEL_11:
        v16 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", objc_msgSend(v14, "productID"));
        [v15 setObject:v16 forKeyedSubscript:@"ProductID"];

        goto LABEL_12;
      }
LABEL_16:
      long long v20 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", objc_msgSend(v14, "vendorID"));
...
LABEL_12:
    ...
    while (v11 != v13);
    uint64_t v21 = [obj countByEnumeratingWithState:&v37 objects:v44 count:16];
    uint64_t v11 = v21;
  }
  while (v21);
LABEL_19:
...
LABEL_34:
    if (!v35->_device)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        id v43 = obj;
        _os_log_impl(&dword_22CA94000, v24, OS_LOG_TYPE_DEFAULT, "Could not find accessory matching identifiers: %@", buf, 0xCu);
      }
      goto LABEL_39;
    }
  ...
  {
    uint64_t v25 = DiagnosticLogHandleForCategory(6);
...
LABEL_33:
  ...
  {
    v33 = v32;
    v35->_deviceModel = [v32 accessoryModel];
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22CA94000, v0, v1, "Unable to close device.", v2, v3, v4, v5, v6);
}
...
- (id)serialNumber
{
  ...
  if (Property)
  {
    ...
    uint64_t v8 = DiagnosticLogHandleForCategory(6);
...
void __37__DSIOHIDDevice_stringFromHIDReport___block_invoke(uint64_t a1)
{
  ...
  *(_OWORD *)report = 0u;
  ...
  {
    uint64_t v5 = objc_msgSend([NSString alloc], "initWithBytes:length:encoding:", &report[1], strnlen((const char *)&report[1], 0x80uLL), 4);
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22CA94000, v0, v1, "Cannot open IOHIDManager.", v2, v3, v4, v5, v6);
}

- (void)initWithDeviceIdentifiers:identifierMask:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22CA94000, v0, v1, "identifierForIOHIDDevice unexpectedly returned nil", v2, v3, v4, v5, v6);
}
...
- (void)initWithDeviceIdentifiers:(int)a1 identifierMask:(NSObject *)a2 .cold.3(int a1, NSObject *a2)
{
  ...
  v2[0] = 67109120;
  v2[1] = a1;
  _os_log_error_impl(&dword_22CA94000, a2, OS_LOG_TYPE_ERROR, "Failed to open IOHIDDevice %d", (uint8_t *)v2, 8u);
}
...
- (void)initWithDeviceIdentifiers:(os_log_t)log identifierMask:.cold.4(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "Multiple devices found when matching identifiers (%@) to devices (%@); using one",
    (uint8_t *)&v3,
    0x16u);
}
...
- (void)serialNumber
{
  ...
  _os_log_error_impl(&dword_22CA94000, a2, OS_LOG_TYPE_ERROR, "Unable to parse serial number with type = %lu.", (uint8_t *)&v3, 0xCu);
}

void __37__DSIOHIDDevice_stringFromHIDReport___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22CA94000, v0, v1, "Unable to retieve HID report.", v2, v3, v4, v5, v6);
}
...
- (void)reportWithID:(uint64_t)a1 reportType:(NSObject *)a2 object:length:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v3[0] = 67109120;
  v3[1] = v2;
  _os_log_error_impl(&dword_22CA94000, a2, OS_LOG_TYPE_ERROR, "Unable to retieve HID report. Status code: %d", (uint8_t *)v3, 8u);
}
