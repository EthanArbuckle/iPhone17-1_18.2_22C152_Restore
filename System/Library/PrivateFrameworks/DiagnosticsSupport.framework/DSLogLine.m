...
- (int)integerFromFieldAtIndex:(int)a3
{
  ...
  uint64_t v7 = [(DSLogLine *)self fields];
...
- (void)initWithLine:(id *)a1 .cold.1(id *a1, NSObject *a2)
{
  ...
  int v4 = 134217984;
  uint64_t v5 = v3;
  _os_log_error_impl(&dword_22CA94000, a2, OS_LOG_TYPE_ERROR, "[DSLogLine] ignoring log line, field count too small: %ld", (uint8_t *)&v4, 0xCu);
}

- (void)initWithLine:(os_log_t)log .cold.2(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "[DSLogLine] ignoring log line, log date unparseable", v1, 2u);
}
...
- (void)initWithLine:(os_log_t)log .cold.3(os_log_t log, double a2)
{
  ...
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "[DSLogLine] ignoring log line, log date out of range: %ld", (uint8_t *)&v2, 0xCu);
}

- (void)initWithLine:(os_log_t)log .cold.4(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "[DSLogLine] ignoring log line, type is blank", v1, 2u);
}
