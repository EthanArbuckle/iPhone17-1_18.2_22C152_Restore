...
void __75__DSHardwareButtonEventMonitor_addTarget_action_forButtonEvents_propagate___block_invoke(uint64_t a1)
{
  ...
  uint64_t v3 = [*(id *)(a1 + 40) buttonEventHandlers];
  [v3 addObject:v5];
...
void __45__DSHardwareButtonEventMonitor_removeTarget___block_invoke(uint64_t a1)
{
  ...
  uint64_t v3 = [*(id *)(a1 + 32) buttonEventHandlers];
  [v3 minusSet:v5];
...
- (BOOL)hasTarget:(id)a3
{
  uint64_t v3 = [(DSHardwareButtonEventMonitor *)self _handlersForTarget:a3];
  BOOL v4 = [v3 count] != 0;
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (v8) {
          ...
          char v8 = [v11 preventPropagation];
        }
      }
...
{
  v2 = [*(id *)(a1 + 32) target];
  uint64_t v3 = (void (*)(id, uint64_t, void))objc_msgSend(v2, "methodForSelector:", objc_msgSend(*(id *)(a1 + 32), "action"));
