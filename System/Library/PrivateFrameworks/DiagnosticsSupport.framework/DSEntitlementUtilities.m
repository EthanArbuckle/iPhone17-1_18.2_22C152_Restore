...
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "Unable to find entitlement for current process", v1, 2u);
}

+ (void)auditToken:(os_log_t)log hasEntitlement:.cold.1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "Unable to find entitlement", v1, 2u);
}
