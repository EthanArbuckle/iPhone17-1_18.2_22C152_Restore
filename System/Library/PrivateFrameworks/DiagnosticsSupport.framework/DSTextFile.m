...
- (DSTextFile)initWithFilePath:(id)a3 withBufferSize:(unint64_t)a4
{
  ...
  uint64_t v8 = [MEMORY[0x263F08840] fileHandleForReadingAtPath:v6];
  ...
  {
    v7->_bufferSize = a4;
    uint64_t v10 = [MEMORY[0x263EFF980] arrayWithObject:&unk_26E030650];
    linePositions = v7->_linePositions;
    v7->_linePositions = (NSMutableArray *)v10;

    uint64_t v12 = [MEMORY[0x263EFF8F8] dataWithBytes:&kDALineBreak length:1];
...
- (void)enumerateUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    {
      BOOL v5 = [(DSTextFile *)self advanceToNextLine:0];
      [(DSTextFile *)self setSkipCount:[(DSTextFile *)self skipCount] - 1];
    }
    else
    {
      id v6 = (void *)MEMORY[0x230F72B40]();
      id v10 = 0;
      BOOL v5 = [(DSTextFile *)self advanceToNextLine:&v10];
      id v7 = v10;
...
{
  id v4 = a3;
  BOOL v5 = (void *)[objc_alloc((Class)a1) initWithFilePath:v4];
...
- (id)readDataOfLength:(unint64_t)a3
{
  ...
  BOOL v5 = [v4 readDataOfLength:a3];
...
- (BOOL)advanceToNextLine:(id *)a3
{
  BOOL v5 = [(DSTextFile *)self linePositions];
  ...
  uint64_t v8 = [(DSTextFile *)self linePositions];
  unint64_t v9 = [v8 count];
  unint64_t v10 = [(DSTextFile *)self currentLineIndex] + 1;
...
- (id)extractLine:(unint64_t)a3
{
  ...
  unint64_t v6 = [(DSTextFile *)self getOffsetAtLineIndex:a3 + 1] + ~v5;
...
- (BOOL)searchForNextLineFromCurrentPosition:(id *)a3
{
  if (a3)
  {
    unint64_t v5 = objc_msgSend(MEMORY[0x263EFF990], "dataWithCapacity:", -[DSTextFile bufferSize](self, "bufferSize"));
  }
  else
  {
    unint64_t v5 = 0;
  }
  unint64_t v6 = (void *)MEMORY[0x230F72B40]();
  unint64_t v7 = 0;
  while (1)
  {
    uint64_t v8 = v7;
    ...
    uint64_t v12 = objc_msgSend(v7, "rangeOfData:options:range:", v11, 0, 0, v10);
    ...
    if (v12 != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      uint64_t v14 = v12 + v13 - [v7 length] + 1;
      if (a3 && v12)
      {
        v15 = objc_msgSend(v7, "subdataWithRange:", 0, v12);
        [v5 appendData:v15];
      }
...
- (void)initWithFilePath:(uint64_t)a1 withBufferSize:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_22CA94000, a2, OS_LOG_TYPE_ERROR, "Failed to init handle for file at path %@", (uint8_t *)&v2, 0xCu);
}
