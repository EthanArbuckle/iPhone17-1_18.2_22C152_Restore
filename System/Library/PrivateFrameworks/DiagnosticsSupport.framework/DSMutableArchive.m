...
- (BOOL)_addPathToContents:(id)a3 searchQueue:(id)a4 flatten:(BOOL)a5 error:(id *)a6
{
  ...
  v13 = [v10 sourceUrl];
  v14 = [v13 path];
  int v15 = [v12 fileExistsAtPath:v14 isDirectory:&v20];
  ...
  else
  {
    if (a6)
    {
      *a6 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:6 userInfo:0];
    }
...
- (BOOL)_addDirectoryToContents:(id)a3 searchQueue:(id)a4 flatten:(BOOL)a5 error:(id *)a6
{
  ...
  if (v13)
  {
    ...
    long long v28 = 0u;
    id v19 = v13;
    uint64_t v20 = [v19 countByEnumeratingWithState:&v27 objects:v32 count:16];
    if (v20)
    {
      uint64_t v21 = v20;
      ...
      do
      {
        ...
        do
        {
          ...
          v24 = +[DSArchivePath archivePathWithSource:*(void *)(*((void *)&v27 + 1) + 8 * v23) prefix:v15 root:0];
          [v10 addObject:v24];

          ++v23;
        }
        while (v21 != v23);
        uint64_t v21 = [v19 countByEnumeratingWithState:&v27 objects:v32 count:16];
      }
      while (v21);
    }
  ...
  else
  {
    if (a6)
    {
      *a6 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:5 userInfo:0];
    }
...
- (BOOL)_addFile:(id)a3 archive:(archive *)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v27 = 2112;
    long long v28 = v12;
    _os_log_impl(&dword_22CA94000, v13, OS_LOG_TYPE_DEFAULT, "Archiving [%@] as [%@]", buf, 0x16u);
  }
  ...
  if (v15 == -1)
  {
    BOOL v16 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:3 userInfo:0];
    uint64_t v21 = DiagnosticLogHandleForCategory(3);
  ...
  if (fstat(v15, &v24))
  {
    BOOL v16 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:2 userInfo:0];
    v17 = DiagnosticLogHandleForCategory(3);
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR)) {
  ...
  if (!v18)
  {
    BOOL v16 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:8 userInfo:0];
...
LABEL_26:
  ...
  BOOL v16 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:9 userInfo:0];
...
- (BOOL)_writeArchive:(archive *)a3 error:(id *)a4
{
  ...
  if (a4)
  {
    *a4 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:10 userInfo:0];
  }
...
- (id)archiveAsDataWithError:(id *)a3
{
  ...
  if (archive_write_open())
  {
    ...
    if (a3)
    {
      id v7 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:1 userInfo:0];
      uint64_t v8 = 0;
      *a3 = v7;
      goto LABEL_9;
    }
  ...
  {
    uint64_t v8 = [(DSMutableArchive *)self dataBuffer];
    goto LABEL_9;
  }
  uint64_t v8 = 0;
LABEL_9:
...
- (id)archiveAsTempDirectoryWithName:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    id v45 = v6;
    _os_log_impl(&dword_22CA94000, v7, OS_LOG_TYPE_DEFAULT, "Archiving as temp directory with name %@", buf, 0xCu);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    id v45 = v12;
    _os_log_impl(&dword_22CA94000, v15, OS_LOG_TYPE_DEFAULT, "Cleaning up prior temp directory archive at [%@]", buf, 0xCu);
  }

  [v8 removeItemAtURL:v12 error:a4];
  if (*a4)
  {
    BOOL v16 = DiagnosticLogHandleForCategory(0);
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      -[DSMutableArchive archiveAsTempDirectoryWithName:error:]((uint64_t)v12, a4);
    }
...
LABEL_10:
    ...
    if (!*a4)
    {
      ...
      uint64_t v18 = [(NSMutableArray *)obj countByEnumeratingWithState:&v40 objects:v50 count:16];
      if (v18)
      {
        uint64_t v19 = v18;
        ...
        do
        {
          for (uint64_t i = 0; i != v19; ++i)
          {
            ...
            uint64_t v22 = [v21 prefix];
            uint64_t v23 = v12;
            stat v24 = [v12 URLByAppendingPathComponent:v22];
            v25 = [v21 sourceUrl];
            id v26 = [v25 lastPathComponent];
            __int16 v27 = [v24 URLByAppendingPathComponent:v26];

            long long v28 = [v27 URLByDeletingLastPathComponent];
            [v39 createDirectoryAtURL:v28 withIntermediateDirectories:1 attributes:0 error:a4];

            uint64_t v29 = [v21 sourceUrl];
            if (*a4) {
              long long v30 = 0;
            }
            else {
            ...
            char v31 = [v39 copyItemAtURL:v29 toURL:v27 error:v30];
            ...
            if ((v31 & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138412802;
                ...
                __int16 v48 = 2112;
                v49 = v34;
                _os_log_error_impl(&dword_22CA94000, v32, OS_LOG_TYPE_ERROR, "Failed to copy file in archive to temp directory from [%@] to [%@]. Error: [%@]", buf, 0x20u);
              }
            }

            v12 = v23;
          }
          uint64_t v19 = [(NSMutableArray *)obj countByEnumeratingWithState:&v40 objects:v50 count:16];
        }
        while (v19);
      }
...
- (id)archiveAsTempFileWithTemplate:(id)a3 directory:(id)a4 suffix:(id)a5 error:(id *)a6
{
  ...
  if (!v11)
  {
    ...
    id v11 = [v13 fileURLWithPath:v14];
  }
  int v15 = [v11 URLByAppendingPathComponent:v10];
  BOOL v16 = [v15 path];
  ...
  uint64_t v22 = (char *)malloc_type_malloc(v21 + 1, 0x1BDC3ABBuLL);
  if (v22)
  {
    uint64_t v23 = v22;
    stat v24 = strcpy(v22, v20);
    uint64_t v25 = mkstemps(v24, v18);
    if ((v25 & 0x80000000) == 0) {
      goto LABEL_29;
    }
    char v31 = DiagnosticLogHandleForCategory(3);
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR)) {
      -[DSMutableArchive archiveAsTempFileWithTemplate:directory:suffix:error:]();
    }

    uint64_t v32 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:4 userInfo:0];
    if (!v32)
    {
LABEL_29:
      if ([(DSMutableArchive *)self archiveAsFileUsingDescriptor:v25 error:a6])
      {
        id v26 = [MEMORY[0x263F08850] defaultManager];
        __int16 v27 = [v26 stringWithFileSystemRepresentation:v23 length:strlen(v23)];

        long long v28 = [NSURL fileURLWithPath:v27];
      }
      else
      {
        long long v28 = 0;
  ...
  {
    uint64_t v29 = DiagnosticLogHandleForCategory(3);
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR)) {
      -[DSMutableArchive archiveAsTempFileWithTemplate:directory:suffix:error:]();
    }

    id v30 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:7 userInfo:0];
  }
  long long v28 = 0;
  if (a6 && v30)
  {
...
- (BOOL)archiveAsFile:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138412290;
    BOOL v16 = v9;
    _os_log_impl(&dword_22CA94000, v8, OS_LOG_TYPE_DEFAULT, "Attempting to write archive to [%@]", (uint8_t *)&v15, 0xCu);
  }
  id v10 = [v6 path];
  [v10 UTF8String];
  ...
  if (v11)
  {
    ...
    if (a4)
    {
      [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:1 userInfo:0];
      BOOL v13 = 0;
...
- (BOOL)archiveAsFileUsingDescriptor:(int)a3 error:(id *)a4
{
  ...
  {
    *(_WORD *)int v11 = 0;
    _os_log_impl(&dword_22CA94000, v7, OS_LOG_TYPE_DEFAULT, "Attempting to write archive to file descriptor.", v11, 2u);
  }
  ...
  id v9 = [MEMORY[0x263F087E8] errorWithDomain:@"com.apple.Diagnostics.DSMutableArchive" code:1 userInfo:0];
  BOOL result = 0;
  *a4 = v9;
  return result;
}
...
+ (BOOL)extractArchive:(id)a3 toDirectory:(id)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    id v30 = v5;
    _os_log_impl(&dword_22CA94000, v7, OS_LOG_TYPE_DEFAULT, "Opening archive for extraction: %@", buf, 0xCu);
  }
  ...
  if (v12 + 1 > 0x3FF)
  {
    BOOL v16 = DiagnosticLogHandleForCategory(3);
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
  ...
  else
  {
    ...
    else
    {
      ...
      while (1)
      {
        ...
        id v19 = (const char *)archive_entry_pathname();
        size_t v20 = strlen(v11);
        strcpy(&v13[v20], v19);
        archive_entry_set_pathname();
        size_t v21 = DiagnosticLogHandleForCategory(3);
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 136315138;
          id v30 = v13;
          _os_log_impl(&dword_22CA94000, v21, OS_LOG_TYPE_DEFAULT, "Extracting %s", buf, 0xCu);
        }
...
LABEL_31:
        ...
        BOOL v22 = +[DSMutableArchive extractEntry:v8 toArchive:v9];
        char v15 = v22;
        if (!v22 || archive_write_finish_entry())
        {
          uint64_t v23 = DiagnosticLogHandleForCategory(3);
          if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138412290;
            id v30 = v5;
            _os_log_error_impl(&dword_22CA94000, v23, OS_LOG_TYPE_ERROR, "Failed to extract %@", buf, 0xCu);
          }

          stat v24 = DiagnosticLogHandleForCategory(3);
      ...
      if (next_header == 1)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412290;
          id v30 = v5;
          _os_log_impl(&dword_22CA94000, v14, OS_LOG_TYPE_DEFAULT, "Finished extracting %@", buf, 0xCu);
        }
        goto LABEL_8;
      }
      uint64_t v25 = DiagnosticLogHandleForCategory(3);
...
- (void)_addPathToContents:(void *)a1 searchQueue:flatten:error:.cold.1(void *a1)
{
  ...
  v2 = [v1 path];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_0_1(&dword_22CA94000, v3, v4, "File or directory does not exist: [%@]", v5, v6, v7, v8, v9);
}
...
- (void)_addDirectoryToContents:(void *)a1 searchQueue:flatten:error:.cold.1(void *a1)
{
  ...
  v2 = [v1 path];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_3_0(&dword_22CA94000, v3, v4, "Could not enumerate directory: [%@]: %@", v5, v6, v7, v8, v9);
}
...
- (void)_addFile:archive:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_0_1(&dword_22CA94000, v0, v1, "Error writing header: %s", v2, v3, v4, v5, v6);
}

- (void)_addFile:(os_log_t)log archive:error:.cold.2(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&dword_22CA94000, log, OS_LOG_TYPE_ERROR, "Error creating entry.", v1, 2u);
}
...
- (void)_addFile:archive:error:.cold.3()
{
  ...
  strerror(*v0);
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_3_0(&dword_22CA94000, v1, v2, "Error during stat of file %@: %s", v3, v4, v5, v6, v7);
}
...
- (void)_addFile:archive:error:.cold.4()
{
  ...
  strerror(*v0);
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_3_0(&dword_22CA94000, v1, v2, "Error opening file %@: %s", v3, v4, v5, v6, v7);
}
...
- (void)_writeArchive:(int)a1 error:(NSObject *)a2 .cold.1(int a1, NSObject *a2)
{
  ...
  v2[0] = 67109120;
  v2[1] = a1;
  _os_log_fault_impl(&dword_22CA94000, a2, OS_LOG_TYPE_FAULT, "Failed to write completed archive to storage with archive status: %d", (uint8_t *)v2, 8u);
}
...
- (void)_writeArchive:(void *)a1 error:(NSObject *)a2 .cold.2(void *a1, NSObject *a2)
{
  ...
  OUTLINED_FUNCTION_3();
  _os_log_fault_impl(&dword_22CA94000, a2, OS_LOG_TYPE_FAULT, "Failed to add file to archive: %@", v4, 0xCu);
}
...
- (void)archiveAsDataWithError:.cold.1()
{
  archive_error_string();
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_0_1(&dword_22CA94000, v0, v1, "Error creating archive: %s", v2, v3, v4, v5, v6);
}

- (void)archiveAsTempDirectoryWithName:(uint64_t)a1 error:(id *)a2 .cold.1(uint64_t a1, id *a2)
{
  uint64_t v8 = [*a2 description];
  OUTLINED_FUNCTION_3_0(&dword_22CA94000, v2, v3, "Failed to clean up up prior temp directory archive at [%@]. Error: [%@]", v4, v5, v6, v7, 2u);
}
...
- (void)archiveAsTempFileWithTemplate:directory:suffix:error:.cold.1()
{
  uint64_t v3 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2_0(&dword_22CA94000, v0, v1, "Could not allocate %lu bytes.", v2);
}
...
- (void)archiveAsTempFileWithTemplate:directory:suffix:error:.cold.2()
{
  ...
  strerror(*v0);
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_0_1(&dword_22CA94000, v1, v2, "Could not create temp file: %s", v3, v4, v5, v6, v7);
}
...
+ (void)extractArchive:toDirectory:.cold.1()
{
  archive_error_string();
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_0_1(&dword_22CA94000, v0, v1, "Extract error: %s", v2, v3, v4, v5, v6);
}
...
+ (void)extractArchive:toDirectory:.cold.2()
{
  uint64_t v3 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2_0(&dword_22CA94000, v0, v1, "Failed to extract %@", v2);
}
...
+ (void)extractArchive:toDirectory:.cold.4()
{
  uint64_t v3 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2_0(&dword_22CA94000, v0, v1, "Failed to extract from %@", v2);
}
...
+ (void)extractArchive:(uint64_t *)a3 toDirectory:(NSObject *)a4 .cold.5(uint8_t *a1, uint64_t a2, uint64_t *a3, NSObject *a4)
{
  ...
  *(_DWORD *)a1 = 136315138;
  *a3 = v7;
  _os_log_error_impl(&dword_22CA94000, a4, OS_LOG_TYPE_ERROR, "Extract error: %s", a1, 0xCu);
}
...
+ (void)extractArchive:toDirectory:.cold.6()
{
  uint64_t v3 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2_0(&dword_22CA94000, v0, v1, "Failed to open archive for extraction: %@", v2);
}
...
+ (void)extractArchive:toDirectory:.cold.7()
{
  uint64_t v3 = *MEMORY[0x263EF8340];
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_2_0(&dword_22CA94000, v0, v1, "The extract destination path %@ is too long to use as the extraction destination!", v2);
}
