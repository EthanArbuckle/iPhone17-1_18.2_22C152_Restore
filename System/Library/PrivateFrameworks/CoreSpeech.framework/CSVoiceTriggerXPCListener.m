...
- (void)_handleNewRemoteConnection:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      int v7 = 136315394;
      id v8 = "-[CSVoiceTriggerXPCListener _handleNewRemoteConnection:]";
      __int16 v9 = 2050;
      id v10 = v4;
      _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "%s Getting new client connection : %{public}p", (uint8_t *)&v7, 0x16u);
    }
    if (+[CSUtils machXPCConnection:v4 hasEntitlement:@"voicetrigger.voicetriggerservice"])
    {
      v6 = [[CSVoiceTriggerXPCConnection alloc] initWithConnection:v4];
...
- (void)_handleListenerEvent:(id)a3
{
  ...
  {
    int v7 = 136315138;
    __int16 v8 = "-[CSVoiceTriggerXPCListener _handleListenerEvent:]";
  ...
  if (v4)
  {
    if (xpc_get_type(v4) == (xpc_type_t)&_xpc_type_error) {
      [(CSVoiceTriggerXPCListener *)self _handleListenerError:v4];
    }
    else {
      [(CSVoiceTriggerXPCListener *)self _handleNewRemoteConnection:v4];
    }
  }
  else
  {
...
- (void)listen
{
  ...
  if (os_log_type_enabled(CSLogContextFacilityCoreSpeech, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315138;
    __int16 v8 = "-[CSVoiceTriggerXPCListener listen]";
...
{
  v12.receiver = self;
  v12.super_class = (Class)CSVoiceTriggerXPCListener;
  id v2 = [(CSVoiceTriggerXPCListener *)&v12 init];
  if (v2)
  {
    dispatch_queue_t v3 = dispatch_queue_create("CSVoiceTriggerXPCListener", 0);
