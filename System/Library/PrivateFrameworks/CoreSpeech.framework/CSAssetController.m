...
- (void)_downloadAsset:(id)a3 withComplete:(id)a4
{
  ...
  id v9 = v7;
  id v10 = v6;
  [(CSAssetController *)self _startDownloadingAsset:v10 progress:&stru_100250330 completion:v11];
}
...
- (id)installedAssetOfType:(unint64_t)a3 withLanguage:(id)a4
{
  ...
  unint64_t v22 = sub_10009750C;
  __int16 v23 = sub_10009751C;
  id v24 = 0;
  queue = self->_queue;
  id v11 = _NSConcreteStackBlock;
  uint64_t v12 = 3221225472;
  id v13 = sub_100097524;
  id v14 = &unk_1002521E0;
  int v17 = &v19;
  unint64_t v18 = a3;
  id v15 = self;
  id v8 = v6;
...
- (void)assetOfType:(unint64_t)a3 language:(id)a4 compatibilityVersion:(unint64_t)a5 completion:(id)a6
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10009796C;
  block[3] = &unk_100250250;
  block[4] = self;
  unint64_t v18 = a3;
  unint64_t v19 = a5;
  id v16 = v10;
...
- (id)allInstalledAssetsOfType:(unint64_t)a3 language:(id)a4
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      int v17 = [v10 sortedArrayUsingComparator:&stru_1002501D8];
      +[NSMutableArray array];
      uint64_t v21 = _NSConcreteStackBlock;
      uint64_t v22 = 3221225472;
      __int16 v23 = sub_10009809C;
      id v24 = &unk_100250200;
...
+ (id)sharedController
{
  if (qword_1002A3830 != -1) {
    dispatch_once(&qword_1002A3830, &stru_100250198);
  }
  v2 = (void *)qword_1002A3828;
  return v2;
}
