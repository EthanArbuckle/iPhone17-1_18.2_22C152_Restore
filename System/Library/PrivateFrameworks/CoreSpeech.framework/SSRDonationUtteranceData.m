...
LABEL_12:
  ...
  v9 = [MEMORY[0x1E4FA5710] convertToUtteranceDataWithDonationString:v6];
  v10 = v9;
  if (!v9)
  {
    v13 = *MEMORY[0x1E4F5D4A8];
...
LABEL_15:
    _os_log_error_impl(&dword_1C9338000, v13, OS_LOG_TYPE_ERROR, v14, buf, 0xCu);
    goto LABEL_9;
  }
  if ([v9 count])
  {
    ...
    else
    {
      ...
      v8->_triggerPhrase = objc_msgSend(MEMORY[0x1E4FA5710], "convertToEnrollmentTriggerPhraseWithPhId:", objc_msgSend(v17, "unsignedIntegerValue"));
    }
