...
- (BOOL)containsMultiUserThresholds
{
  ...
  if (v3)
  {
    v4 = [MEMORY[0x1E4F1C9B8] dataWithContentsOfFile:v1];
    if (!v4)
    {
      v10 = *MEMORY[0x1E4F5D180];
      BOOL v8 = 0;
      if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5D180], OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v18 = 2114;
        v19 = v1;
        _os_log_impl(&dword_1C9338000, v10, OS_LOG_TYPE_DEFAULT, "%s Could not read: %{public}@", buf, 0x16u);
        BOOL v8 = 0;
      }
      goto LABEL_17;
    }
    id v15 = 0;
    v5 = [MEMORY[0x1E4F28D90] JSONObjectWithData:v4 options:0 error:&v15];
    id v6 = v15;
    if (v6)
    {
...
LABEL_17:
      ...
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v20 = 2114;
      id v21 = v6;
      _os_log_impl(&dword_1C9338000, v7, OS_LOG_TYPE_DEFAULT, "%s Could not decode contents of: %{public}@: err: %{public}@", buf, 0x20u);
    }
    else if (v5)
    {
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5D180], OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v18 = 2114;
    v19 = v1;
    _os_log_impl(&dword_1C9338000, v9, OS_LOG_TYPE_DEFAULT, "%s %{public}@ doesnt exist", buf, 0x16u);
    BOOL v8 = 0;
  }
LABEL_18:
...
{
  BOOL v2 = [a1 resourcePath];
  if ([MEMORY[0x1E4F5D450] horsemanDeviceType] != 1
    || ([MEMORY[0x1E4F5D490] getDefaultRecognizerForB238],
...
- (uint64_t)maxAllowedEnrollmentUtterances
{
  v1 = [a1 getNumberForKey:@"maxEnrollmentUtterances" category:@"speakerRecognition" default:&unk_1F23C4AD8];
...
- (uint64_t)pruningNumRetentionUtterance
{
  v1 = [a1 getNumberForKey:@"numPruningRetentionUtt" category:@"speakerRecognition" default:&unk_1F23C4AC0];
  uint64_t v2 = [v1 unsignedIntegerValue];
...
- (float)pruningThresholdPSR
{
  v1 = [a1 getNumberForKey:@"pruningPSRThreshold" category:@"speakerRecognition" default:&unk_1F23C5388];
  [v1 floatValue];
  float v3 = v2;
...
- (float)pruningThresholdSAT
{
  v1 = [a1 getNumberForKey:@"pruningSATThreshold" category:@"speakerRecognition" default:&unk_1F23C5388];
  [v1 floatValue];
  float v3 = v2;
...
- (float)pruningExplicitUttThresholdPSR
{
  v1 = [a1 getNumberForKey:@"pruningExplicitPSRThreshold" category:@"speakerRecognition" default:&unk_1F23C5388];
  [v1 floatValue];
  float v3 = v2;
...
- (float)pruningExplicitUttThresholdSAT
{
  v1 = [a1 getNumberForKey:@"pruningExplicitSATThreshold" category:@"speakerRecognition" default:&unk_1F23C5388];
  [v1 floatValue];
  float v3 = v2;
...
- (float)satVTImplicitThreshold
{
  v1 = [a1 getNumberForKey:@"implicitVTThreshold" category:@"speakerRecognition" default:&unk_1F23C5388];
  [v1 floatValue];
  float v3 = v2;
...
- (float)satImplicitProfileDeltaThreshold
{
  v1 = [a1 getNumberForKey:@"implicitProfileDeltaThreshold" category:@"speakerRecognition" default:&unk_1F23C4EC8];
  [v1 floatValue];
  float v3 = v2;
...
- (float)psrCombinationWeight
{
  v1 = [a1 getNumberForKey:@"combinationWeight" category:@"speakerRecognition" default:&unk_1F23C4EB8];
  [v1 floatValue];
  float v3 = v2;
...
- (uint64_t)multiUserDeltaScoreThreshold
{
  v1 = [a1 getNumberForKey:@"multiUserDeltaScoreThreshold" category:@"speakerRecognition" default:&unk_1F23C4AA8];
...
- (uint64_t)multiUserConfidentScoreThreshold
{
  v1 = [a1 getNumberForKey:@"multiUserConfidentScoreThreshold" category:@"speakerRecognition" default:&unk_1F23C4A90];
  uint64_t v2 = [v1 integerValue];
...
- (uint64_t)multiUserHighScoreThreshold
{
  v1 = [a1 getNumberForKey:@"multiUserHighScoreThreshold" category:@"speakerRecognition" default:&unk_1F23C4A78];
  uint64_t v2 = [v1 integerValue];
...
- (uint64_t)multiUserLowScoreThreshold
{
  v1 = [a1 getNumberForKey:@"multiUserLowScoreThreshold" category:@"speakerRecognition" default:&unk_1F23C4A60];
  uint64_t v2 = [v1 integerValue];
...
- (float)satScoreThreshold
{
  v1 = [a1 getNumberForKey:@"satThreshold" category:@"speakerRecognition" default:&unk_1F23C5378];
  [v1 floatValue];
  float v3 = v2;
...
- (id)getPhraseConfig:()SpeakerRecognition
{
  ...
  if (v4 && [v4 count] <= a3)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5D180], OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 1024;
      int v12 = a3;
      _os_log_error_impl(&dword_1C9338000, v7, OS_LOG_TYPE_ERROR, "%s Config for ph: %d doesn't exist, use default", (uint8_t *)&v9, 0x12u);
    }
    float v6 = 0;
  }
  else
