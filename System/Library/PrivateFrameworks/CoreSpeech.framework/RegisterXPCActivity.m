      ...
      if (!xpc_activity_set_state(v3, 4))
      {
        ...
        if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5D180], OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 136315138;
          ...
          _os_log_error_impl(&dword_1C9338000, v5, OS_LOG_TYPE_ERROR, "%s Failed setting activity state to continue", buf, 0xCu);
        }
      }
  ...
  if (xpc_activity_should_defer(v3))
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5D180], OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_1C9338000, v9, OS_LOG_TYPE_DEFAULT, "%s Deferring activity:%@ deferred:%@", buf, 0x20u);
    }
  }
LABEL_15:
}
...
void ___RegisterXPCActivity_block_invoke_6(uint64_t a1)
{
  ...
  {
    v1 = *MEMORY[0x1E4F5D180];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5D180], OS_LOG_TYPE_ERROR))
    {
      int v2 = 136315138;
      v3 = "_RegisterXPCActivity_block_invoke";
      _os_log_error_impl(&dword_1C9338000, v1, OS_LOG_TYPE_ERROR, "%s Failed setting activity state to done", (uint8_t *)&v2, 0xCu);
    }
  }
}
