...
- (void)_handleNewRemoteConnection:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      int v7 = 136315394;
      id v8 = "-[CSXPCListener _handleNewRemoteConnection:]";
      __int16 v9 = 2050;
      id v10 = v4;
...
- (void)_handleListenerError:(id)a3
{
  ...
  if (os_log_type_enabled(CSLogContextFacilityCoreSpeech, OS_LOG_TYPE_ERROR))
  {
    v5 = v4;
    int v6 = 136315394;
    int v7 = "-[CSXPCListener _handleListenerError:]";
    __int16 v8 = 2082;
...
- (void)_handleListenerEvent:(id)a3
{
  ...
  {
    int v7 = 136315138;
    __int16 v8 = "-[CSXPCListener _handleListenerEvent:]";
...
- (void)listen
{
  ...
  if (os_log_type_enabled(CSLogContextFacilityCoreSpeech, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315138;
    __int16 v8 = "-[CSXPCListener listen]";
    _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_DEFAULT, "%s CSXPCListener start listening", buf, 0xCu);
  }
  objc_initWeak((id *)buf, self);
  listener = self->_listener;
  handler[0] = _NSConcreteStackBlock;
  handler[1] = 3221225472;
  handler[2] = sub_1000E177C;
...
{
  v12.receiver = self;
  v12.super_class = (Class)CSXPCListener;
  id v2 = [(CSXPCListener *)&v12 init];
  if (v2)
  {
    dispatch_queue_t v3 = dispatch_queue_create("CSXPCListener", 0);
    ...
    *((void *)v2 + 1) = v3;
    ...
    xpc_connection_t mach_service = xpc_connection_create_mach_service("com.apple.corespeech.corespeechd.xpc", *((dispatch_queue_t *)v2 + 1), 1uLL);
