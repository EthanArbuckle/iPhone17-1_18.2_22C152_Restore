  ...
  else
  {
    ...
    if (v4)
    {
      ...
      if (+[CSUtils supportTrialMitigationAssets]) {
        +[NSArray arrayWithObjects:](NSArray, "arrayWithObjects:", &off_10001E1F8, &off_10001E210, 0);
      }
      else {
        +[NSArray arrayWithObjects:](NSArray, "arrayWithObjects:", &off_10001E228, &off_10001E240, 0);
      }
      long long v18 = 0u;
      long long v19 = 0u;
      long long v16 = 0u;
...
+ (id)sharedInstance
{
  if (qword_100022D60 != -1) {
    dispatch_once(&qword_100022D60, &stru_10001C5F0);
  }
  v2 = (void *)qword_100022D58;
  return v2;
}
