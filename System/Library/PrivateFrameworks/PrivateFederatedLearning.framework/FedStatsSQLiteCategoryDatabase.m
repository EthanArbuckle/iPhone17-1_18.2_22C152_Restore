...
+ (id)databaseWithFileURL:(id)a3 error:(id *)a4
{
  ...
  v75[1] = &unk_26D0B5180;
  v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v75 count:2];
  v76[0] = v10;
  v74[0] = @"SELECT COUNT(*) AS count FROM PRAGMA_TABLE_XINFO('categories')";
  v74[1] = &unk_26D0B5198;
  objc_super v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:v74 count:2];
  v76[1] = v11;
  ...
  v73[1] = &unk_26D0B51B0;
  v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v73 count:2];
  v76[2] = v12;
  ...
  v72[1] = &unk_26D0B5180;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v72 count:2];
  v76[3] = v13;
  v71[0] = @"SELECT COUNT(*) AS count FROM PRAGMA_INDEX_LIST('categories') AS indices, PRAGMA_TABLE_XINFO('categories') AS table_info, PRAGMA_INDEX_XINFO(indices.name) AS index_info WHERE indices.origin != 'pk' AND indices.[unique] == 1 AND index_info.key == 1 AND index_info.name == table_info.name AND index_info.name == 'category' AND table_info.type == 'TEXT'";
  v71[1] = &unk_26D0B5180;
  v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:v71 count:2];
  v76[4] = v14;
  ...
  v70[1] = &unk_26D0B5198;
  v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v70 count:2];
  v76[5] = v15;
  v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v76 count:6];
  ...
  long long v65 = 0u;
  id v17 = v16;
  uint64_t v54 = [v17 countByEnumeratingWithState:&v64 objects:v69 count:16];
  v18 = 0;
  v19 = 0;
  v20 = 0;
  if (!v54)
...
LABEL_42:
    ...
    v22 = v60;
    v18 = v31;
    uint64_t v54 = [obj countByEnumeratingWithState:&v64 objects:v69 count:16];
    if (v54) {
      continue;
    }
    break;
    ...
    if (v36)
    {
      ...
      if (v39)
      {
        ...
        if (v40)
        {
          ...
          {
            v33 = objc_msgSend([v48 alloc], "initWithSQLiteDatabase:dimensionality:", v57, objc_msgSend(v42, "unsignedLongValue"));
          }
          else if (v50)
          {
...
- (id)decode:(unint64_t)a3 error:(id *)a4
{
  v5 = objc_msgSend(NSString, "stringWithFormat:", @"SELECT category FROM categories WHERE idx == %lu", a4, a3);
...
+ (id)categoryDatabaseAt:(id)a3 withCategories:(id)a4 error:(id *)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      id v32 = 0;
      v14 = +[FedStatsSQLiteDatabase databaseWithURL:v7 mode:119 error:&v32];
      id v15 = v32;
      v16 = v15;
      if (v14)
      {
        id v31 = v15;
        int v17 = [v14 execute:@"CREATE TABLE categories (idx INTEGER UNIQUE, category TEXT UNIQUE, PRIMARY KEY(idx,category)) WITHOUT ROWID,STRICT", &v31 error];
        id v18 = v31;
        ...
        if (v17)
        {
          ...
          do
          {
            ...
            v21 = NSString;
            uint64_t v22 = [v9 objectAtIndex:v20 - 1];
            uint64_t v23 = [v21 stringWithFormat:@"INSERT INTO categories VALUES (%lu, '%@')", v20, v22];
      ...
      else
      {
        ...
        v27 = +[FedStatsError errorWithCode:302 underlyingError:v15 description:@"Cannot create new database"];
        id v18 = v16;
      }
      *a5 = v27;
LABEL_34:
