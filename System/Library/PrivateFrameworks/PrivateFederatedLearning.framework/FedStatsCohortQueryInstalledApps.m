...
+ (void)initialize
{
  ...
  {
    uint64_t v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_26D0B5288];
...
- (void)resolveDomainToBundleIds
{
  ...
  {
    LOWORD(v11) = 0;
    _os_log_impl(&dword_21F0DC000, v3, OS_LOG_TYPE_INFO, "FedStatsCohortQueryInstalledApps#resolveDomainToBundleIds start.", (uint8_t *)&v11, 2u);
  }
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_21F0DC000, v5, OS_LOG_TYPE_INFO, "FedStatsCohortQueryInstalledApps#resolveDomainToBundleIds resolved domain to bundle ids: %@", (uint8_t *)&v11, 0xCu);
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    int v11 = 134217984;
    uint64_t v12 = v9;
    _os_log_impl(&dword_21F0DC000, v10, OS_LOG_TYPE_INFO, "FedStatsCohortQueryInstalledApps#resolveDomainToBundleIds complete in %fms", (uint8_t *)&v11, 0xCu);
  }
}
  ...
  if (v4)
  {
    ...
    *(void *)&long long v5 = 138412802;
    ...
    do
    {
        ...
        if ([(FedStatsCohortQueryInstalledApps *)self _isSupportedIntentMediaApp:v8 :v11 :v12])
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = v23;
            ...
            __int16 v29 = 2112;
            v30 = v22;
            _os_log_debug_impl(&dword_21F0DC000, v20, OS_LOG_TYPE_DEBUG, "bundle record: %@ has supported intent %@ and supported media categories: %@", buf, 0x20u);
          }
          v3 = v24;
        }
      }
      ...
      {
        int v11 = [*(id *)(v7 + 3344) framework];
        if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138412290;
          v26 = v6;
          _os_log_error_impl(&dword_21F0DC000, v11, OS_LOG_TYPE_ERROR, "Error enumerating app records; app record: %@ has nil bundle identifier",
            buf,
            0xCu);
        }
      }
...
void __57__FedStatsCohortQueryInstalledApps_lsPluginKitExtensions__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    unint64_t v7 = +[_PFLLog framework];
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      if ([*(id *)(a1 + 40) _isSupportedIntentMediaApp:v7 :v10 :v11])
      {
        ...
        unint64_t v16 = +[_PFLLog framework];
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          __int16 v22 = 2112;
          long long v23 = v10;
          _os_log_debug_impl(&dword_21F0DC000, v16, OS_LOG_TYPE_DEBUG, "pluginkit record: %@ has supported intent %@ and supported media categories: %@", (uint8_t *)&v18, 0x20u);
        }
      }
    }
    else
...
- (void)applyFilteringForMediaDomain
{
  ...
  uint64_t v4 = [v3 objectsPassingTest:&__block_literal_global_82];

  id v5 = [v4 objectsPassingTest:&__block_literal_global_84];
...
uint64_t __64__FedStatsCohortQueryInstalledApps_applyFilteringForMediaDomain__block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v3 = [&unk_26D0B5270 containsObject:v2] ^ 1;
...
void __57__FedStatsCohortQueryInstalledApps_lsPluginKitExtensions__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_21F0DC000, a2, OS_LOG_TYPE_ERROR, "Error enumerating plugins; missing containing bundle of plugin: %@",
    (uint8_t *)&v2,
    0xCu);
}
...
void __57__FedStatsCohortQueryInstalledApps_lsPluginKitExtensions__block_invoke_cold_2(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  __int16 v8 = 2112;
  id v9 = v5;
  _os_log_error_impl(&dword_21F0DC000, a3, OS_LOG_TYPE_ERROR, "Error enumerating plugins; matching query: %@, error: %@",
    (uint8_t *)&v6,
    0x16u);
}
