...
- (id)sampleForIndex:(unint64_t)a3
{
  ...
  {
    objc_super v5 = objc_msgSend(&stru_26D0AFFA8, "stringByPaddingToLength:withString:startingAtIndex:", -[FedStatsGeoHashType hashLength](self, "hashLength"), @"@", 0);
  }
  return v5;
}
