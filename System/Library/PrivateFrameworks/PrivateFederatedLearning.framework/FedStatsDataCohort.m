...
+ (id)sharedInstance
{
  ...
  block[4] = a1;
  if (sharedInstance_onceToken_221 != -1) {
    dispatch_once(&sharedInstance_onceToken_221, block);
  }
...
+ (id)keysForCohorts:(id)a3 namespaceID:(id)a4 parameters:(id)a5 possibleError:(id *)a6
{
  ...
  if (v13)
  {
    ...
    long long v45 = 0u;
    id obj = v9;
    uint64_t v15 = [obj countByEnumeratingWithState:&v42 objects:v52 count:16];
    if (v15)
    {
      uint64_t v16 = v15;
      ...
      while (1)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v50 = 2112;
          id v51 = v38;
          _os_log_debug_impl(&dword_21F0DC000, v23, OS_LOG_TYPE_DEBUG, "cohortName:cohortKey => %@=%@ for namespace %@", buf, 0x20u);
        }
        ...
        if (v41)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v48 = 2112;
            id v49 = v41;
            _os_log_debug_impl(&dword_21F0DC000, v24, OS_LOG_TYPE_DEBUG, "\"%@\" cohort error while creating the key: %@", buf, 0x16u);
          }
        }
        [v14 addObject:v22];
...
LABEL_17:
    ...
    v25 = [MEMORY[0x263EFF8C0] arrayWithArray:v14];
    id v10 = v38;
LABEL_27:
  }
  else
