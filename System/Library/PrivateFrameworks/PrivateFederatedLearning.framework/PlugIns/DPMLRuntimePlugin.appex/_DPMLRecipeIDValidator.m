...
+ (id)sharedInstanceWithError:(id *)a3
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10000C8A8;
  block[3] = &unk_100030728;
  block[4] = a1;
  if (qword_10003DCB8 == -1)
  {
    if (!a3) {
      goto LABEL_4;
    }
  ...
  dispatch_once(&qword_10003DCB8, block);
  if (a3) {
LABEL_3:
  }
    *a3 = (id) qword_10003DCB0;
LABEL_4:
  v4 = (void *)qword_10003DCA8;
  return v4;
}
...
LABEL_11:
  ...
  if (v9)
  {
    ...
    {
      v16 = [v7 stringByReplacingOccurrencesOfString:@"fedstats:" withString:&stru_100031610];
