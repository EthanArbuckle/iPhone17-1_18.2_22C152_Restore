        ...
        switch(v21)
        {
          ...
          case 6:
            ...
            if (v33)
            {
              ...
              v86 = v34;
              uint64_t v36 = sub_100017300(v35, v34);
...
LABEL_53:
                ...
                CFStringRef v122 = &stru_100031610;
...
LABEL_45:
  ...
  if (v5 == 1)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v8 = [v7 description];
      sub_1000207D8(v8, (uint64_t)v57, v6, v7);
    }
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      sub_100020788(v12, (uint64_t)v56, v11);
    }
...
LABEL_197:
      ...
      if (os_log_type_enabled(v179, OS_LOG_TYPE_DEBUG)) {
        sub_100020988(v84, (uint64_t)v205, v179);
      }
  ...
  do
  {
    for (i = 0; i != v222; i = (char *)i + 1)
    {
      ...
      id v268 = 0;
      id v25 = [p_vtable + 197 keysForCohorts:v20 namespaceID:v19 parameters:v24 possibleError:&v268];
      id v26 = v25;
      if (v25)
      {
        v230 = i;
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_DEBUG)) {
          sub_100020B04((uint64_t)v280, (uint64_t)v30);
        }
...
LABEL_33:
          ...
          if (v47 == [v35 count])
          {
            ...
            id v19 = v208;
            id v20 = v210;
            p_vtable = (void **)(FedStatsError + 24);
            goto LABEL_36;
          }
          uint64_t v48 = @"N/A";
          id v19 = v208;
        ...
        if (v153)
        {
          ...
          if (v158)
          {
            if (os_log_type_enabled(v159, OS_LOG_TYPE_DEBUG)) {
              sub_100020A14((uint64_t)v278, (uint64_t)v212);
            }
...
+ (id)DSLSupportedClassesSet
{
  if (qword_10003DCE8 != -1) {
    dispatch_once(&qword_10003DCE8, &stru_100030938);
  }
  v2 = (void *)qword_10003DCE0;
  return v2;
}
