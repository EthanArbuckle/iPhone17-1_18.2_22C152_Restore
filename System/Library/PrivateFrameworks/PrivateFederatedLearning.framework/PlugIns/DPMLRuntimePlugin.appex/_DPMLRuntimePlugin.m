...
- (id)performTask:(id)a3 outError:(id *)a4
{
  ...
  v6 = objc_opt_new();
  v7 = [v5 parameters];
  v8 = [v7 stringValueForKey:@"namespaceID" defaultValue:&stru_100031610];
  [v6 setNamespaceIdentifier:v8];

  v9 = [v6 namespaceIdentifier];
  unsigned int v10 = [v9 isEqualToString:&stru_100031610];

  if (v10)
  {
    v11 = +[_PFLLog extension];
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR)) {
      sub_10001FBA8(v11, v12, v13, v14, v15, v16, v17, v18);
    }
  ...
  {
    v20 = [v5 parameters];
    v21 = [v20 stringValueForKey:@"recipeURL" defaultValue:&stru_100031610];

    if ([v21 isEqualToString:&stru_100031610])
    {
      v22 = +[_PFLLog extension];
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR)) {
        sub_10001FC20(v22, v23, v24, v25, v26, v27, v28, v29);
      }
      ...
      if ([v13 containsString:@"com.apple.insights.iconic-scenes"])
      {
        ...
        if ((v14 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR)) {
            sub_10001FEE8((uint64_t)v17, v18, v19, v20, v21, v22, v23, v24);
          }
...
LABEL_32:
      ...
      if (v39)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG)) {
          sub_10001FE34((uint64_t)v39, v40, v41);
        }
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR)) {
      sub_10001FDC8((uint64_t)v10, v12, v33, v34, v35, v36, v37, v38);
    }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
    sub_10001FD50(v8, v25, v26, v27, v28, v29, v30, v31);
  }
