...
- (FedStatsDataEncoder)initWithDataTypes:(id)a3 combinationTypes:(id)a4
{
  ...
  if (v9)
  {
    ...
    v11 = [v8 allKeys];
    v12 = [v11 sortedArrayUsingComparator:&stru_1000308B0];
    ...
    v26 = [v14 allObjects];
    v27 = [v26 sortedArrayUsingComparator:&stru_1000308B0];
...
+ (BOOL)encodeDataArrayAndRecord:(id)a3 dataTypeContent:(id)a4 metadata:(id)a5 baseKey:(id)a6 errorOut:(id *)a7
{
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG)) {
      sub_1000202B0((uint64_t)v20, v21);
    }
    ...
    else
    {
      ...
      CFStringRef v79 = &stru_100031610;
...
LABEL_61:
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_DEBUG)) {
        sub_1000201F4((uint64_t)v20, v39);
      }
      BOOL v26 = 1;
    }
    else
