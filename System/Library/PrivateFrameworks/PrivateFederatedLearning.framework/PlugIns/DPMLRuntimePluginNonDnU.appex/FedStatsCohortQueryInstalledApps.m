...
+ (void)initialize
{
  ...
  {
    uint64_t v2 = +[NSSet setWithArray:&off_100034920];
    v3 = (void *)qword_10003DD30;
    qword_10003DD30 = v2;
...
- (void)lsAppRecords
{
  ...
  {
    v6 = (void *)v4;
    p_cache = FedStatsCategoricalTypeSubcategory.cache;
    *(void *)&long long v5 = 138412802;
    ...
    do
    {
      ...
      {
        objc_super v10 = [p_cache + 123 framework];
...
- (void)lsPluginKitExtensions
{
  v3 = [(id)qword_10003DD38 allObjects];
...
- (BOOL)_isSupportedIntentMediaApp:(id)a3 :(id)a4 :(id)a5
{
  ...
  {
    v12 = +[NSMutableSet setWithSet:qword_10003DD30];
    [v12 intersectSet:v8];
    if ([v12 count] && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      id v13 = +[NSMutableSet setWithSet:qword_10003DD38];
...
- (void)applyFilteringForMediaDomain
{
  ...
  v3 = [v6 objectsPassingTest:&stru_100030A40];
  uint64_t v4 = [v3 objectsPassingTest:&stru_100030A60];

  long long v5 = [v4 objectsPassingTest:&stru_100030A80];
