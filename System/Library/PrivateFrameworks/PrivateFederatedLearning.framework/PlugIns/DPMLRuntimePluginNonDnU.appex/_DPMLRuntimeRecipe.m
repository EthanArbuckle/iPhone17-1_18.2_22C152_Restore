        ...
        switch(v21)
        {
          ...
          case 6:
            ...
            if (v33)
            {
              ...
              v86 = v34;
              uint64_t v36 = sub_100019190(v35, v34);
...
LABEL_53:
                ...
                CFStringRef v122 = &stru_100031EA0;
...
LABEL_33:
      ...
      else
      {
        ...
        unsigned int v28 = [&off_1000348D8 containsObject:v27];
...
LABEL_45:
  ...
  if (v5 == 1)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v8 = [v7 description];
      sub_100020658(v8, (uint64_t)v57, v6, v7);
    }
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      sub_100020608(v12, (uint64_t)v56, v11);
    }
...
LABEL_197:
      ...
      if (os_log_type_enabled(v179, OS_LOG_TYPE_DEBUG)) {
        sub_100020808(v84, (uint64_t)v205, v179);
      }
  ...
  id v22 = &selRef_initWithSQLiteDatabase_dimensionality_;
  ...
  do
  {
    for (i = 0; i != v222; i = (char *)i + 1)
    {
      ...
      id v268 = 0;
      id v25 = [v22 + 370 keysForCohorts:v20 namespaceID:v19 parameters:v24 possibleError:&v268];
      id v26 = v25;
      if (v25)
      {
        v230 = i;
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_DEBUG)) {
          sub_100020984((uint64_t)v280, (uint64_t)v30);
        }
        ...
        if (v153)
        {
          ...
          if (v158)
          {
            if (os_log_type_enabled(v159, OS_LOG_TYPE_DEBUG)) {
              sub_100020894((uint64_t)v278, (uint64_t)v212);
            }
...
+ (id)DSLSupportedClassesSet
{
  if (qword_10003DD28 != -1) {
    dispatch_once(&qword_10003DD28, &stru_100030988);
  }
  v2 = (void *)qword_10003DD20;
  return v2;
}
