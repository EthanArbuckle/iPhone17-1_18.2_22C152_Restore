...
+ (id)readDataWithCount:(int)a3 startDate:(id)a4 endDate:(id)a5
{
  ...
  v18[3] = &unk_100030830;
  v18[4] = &v19;
  id v15 = [v14 sinkWithCompletion:&stru_100030808 receiveInput:v18];
    ...
    do
    {
      ...
      do
      {
        ...
        if (v14)
        {
          ...
          if (v17)
          {
            v18 = [p_cache + 123 extension];
            if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR)) {
              sub_10001F970(&v93, v94);
            }
          }
          else
          {
            ...
            uint64_t v6 = v67;
            id v7 = v68;
            p_cache = (void **)(FedStatsCategoricalTypeSubcategory + 16);
            id v11 = v69;
            v18 = v70;
            uint64_t v9 = v66;
          }
