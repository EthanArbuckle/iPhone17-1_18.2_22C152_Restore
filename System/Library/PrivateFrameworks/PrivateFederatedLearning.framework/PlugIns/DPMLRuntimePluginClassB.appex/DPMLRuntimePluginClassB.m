id sub_10000374C(id a1, NSArray *a2, id *a3)
{
  NSArray *v3;
  void *v4;
  char isKindOfClass;
...
id sub_1000037FC(uint64_t a1, void *a2)
{
  id v3 = a2;
...
{
  qword_10003DCA0 = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
  return _objc_release_x1();
}

uint64_t sub_100005DF4(uint64_t a1)
{
  qword_10003DCB0 = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
  return _objc_release_x1();
}

void sub_100006354(id a1)
{
  off_10003D9E8 = os_log_create("com.apple.FedStats", "Framework");
  _objc_release_x1();
}

id sub_100008698(id a1)
{
  return a1;
}

void sub_1000086BC(void *a1, uint64_t a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
LABEL_21:
  ...
  v18 = (void *)qword_10003DCC8;
  qword_10003DCC8 = (uint64_t)v17;
LABEL_25:
...
void sub_1000096D0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,uint64_t a28,uint64_t a29,uint64_t a30,uint64_t a31,uint64_t a32,char a33)
{
}

void sub_1000096F0(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = [v6 count];
  if (v5 && v7)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG)) {
      sub_10001F860((uint64_t)v6, v19, v28);
    }
...
void sub_10000AE8C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
uint64_t sub_10000AEA4(uint64_t result, uint64_t a2)
{
...
void sub_10000AEB4(uint64_t a1)
{
}
...
void sub_10000B33C(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 2u);
}

void sub_10000C094(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, ...)
{
  va_start(va, a16);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
uint64_t sub_10000C0BC(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_10000C0D4(uint64_t a1, void *a2)
{
  id v3 = a2;
...
void sub_10000FDE0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
uint64_t sub_10000FDF8(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_10000FE10(uint64_t a1, void *a2, void *a3)
{
  id v6 = a2;
...
int64_t sub_100010838(id a1, NSString *a2, NSString *a3)
{
  return [(NSString *)a2 compare:a3];
}

void sub_100011D4C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
uint64_t sub_100011D64(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_100011D7C(id a1, BPSCompletion *a2)
{
  v2 = a2;
...
unsigned char *sub_1000126BC(unsigned char *result, unsigned char *a2)
{
  *result = 0;
  *a2 = 0;
  return result;
...
void sub_1000126CC(void *a1, int a2, os_log_t log, const char *a4, uint8_t *a5)
{
...
{
  off_10003DB70 = os_log_create("com.apple.PrivateFederatedLearning", "Framework");
  _objc_release_x1();
}

void sub_10001325C(id a1)
{
  qword_10003DCF0 = (uint64_t)os_log_create("com.apple.PrivateFederatedLearning", "Telemetry");
  _objc_release_x1();
}

void sub_1000132F4(id a1)
{
  off_10003DB78 = os_log_create("com.apple.PrivateFederatedLearning", "MLRuntimePlugin");
  _objc_release_x1();
}

void sub_100013A54(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 0xCu);
}

void sub_100013A70(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_debug_impl(a1, a2, OS_LOG_TYPE_DEBUG, a4, &a9, 2u);
}

int64_t sub_100014B10(id a1, NSString *a2, NSString *a3)
{
  return [(NSString *)a2 compare:a3];
}

void sub_1000175F4(uint64_t a1)
{
  id v17 = 0;
  v2 = +[NSBundle bundleForClass:objc_opt_class()];
  id v3 = v2;
  if (v2)
  {
    ...
    if (v4)
    {
      ...
      if (v5)
      {
        id v6 = [v3 URLForResource:@"DPMLSQLQueryBlockList" withExtension:@"plist"];
        if (v6)
        {
          ...
          if (v7)
          {
            ...
            uint64_t v9 = (void *)qword_10003DD00;
            qword_10003DD00 = (uint64_t)v8;
          }
          else
          {
  ...
  else
  {
    ...
    unsigned int v11 = (void *)qword_10003DD08;
    qword_10003DD08 = v10;
  }
}

id sub_100019384(void *a1, void *a2)
{
  id v18 = a1;
  id v3 = a2;
...
uint64_t sub_1000195C4(void *a1, void *a2, void *a3)
{
  id v5 = a1;
  id v6 = a2;
  id v7 = a3;
...
void sub_100019F6C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,char a25,uint64_t a26,uint64_t a27,uint64_t a28,uint64_t a29,uint64_t a30,char a31)
{
...
uint64_t sub_100019FB4(uint64_t result, uint64_t a2)
{
  *(void *)(result + 40) = *(void *)(a2 + 40);
  *(void *)(a2 + 40) = 0;
  return result;
...
void sub_100019FCC(void *a1, void *a2)
{
  id v3 = a2;
  if ([v3 state])
  {
  ...
  else
  {
    uint64_t v15 = +[_PFLLog extension];
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR)) {
      sub_1000208B0((uint64_t)(a1 + 5), v15);
    }
...
void sub_10001C14C(id a1)
{
  uint64_t v1 = objc_opt_class();
  uint64_t v2 = objc_opt_class();
  uint64_t v3 = objc_opt_class();
  qword_10003DD18 = +[NSSet setWithObjects:](NSSet, "setWithObjects:", v1, v2, v3, objc_opt_class(), 0);
  _objc_release_x1();
}

void sub_10001C354(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint8_t *a5)
{
...
void sub_10001C38C(void *a1, uint64_t a2, uint64_t a3, const char *a4)
{
  _os_log_debug_impl(a1, v4, OS_LOG_TYPE_DEBUG, a4, v5, 0xCu);
}

void sub_10001D41C(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = +[_PFLLog extension];
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG)) {
    sub_100020CE4(a1, a2, v4);
  }
}

void sub_10001D480(uint64_t a1, char a2, void *a3)
{
  id v5 = a3;
  if ((a2 & 1) == 0)
  {
...
void sub_10001D668(uint64_t a1, char a2, void *a3)
{
  id v5 = a3;
  uint64_t v6 = +[_PFLLog extension];
  id v7 = v6;
...
void sub_10001DBC0(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint8_t *a5)
{
  _os_log_debug_impl(a1, a2, OS_LOG_TYPE_DEBUG, a4, a5, 0x16u);
}

void sub_10001DBD8(void *a1, uint64_t a2, os_log_t log, const char *a4, ...)
{
  va_start(va, a4);
  _os_log_error_impl(a1, log, OS_LOG_TYPE_ERROR, a4, (uint8_t *)va, 0x16u);
}

void sub_10001E4B0(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  if (v6)
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
        sub_100020F94((uint64_t)v5, v9);
      }
    }
  }
}

BOOL sub_10001E940(id a1, InstalledApp *a2, BOOL *a3)
{
...
BOOL sub_10001E988(id a1, InstalledApp *a2, BOOL *a3)
{
...
BOOL sub_10001E9F0(id a1, InstalledApp *a2, BOOL *a3)
{
...
void sub_10001EF74(uint64_t a1)
{
  memset(&v6, 0, 512);
  uname(&v6);
...
void sub_10001F4D8(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
...
void sub_10001F6B4(void *a1)
{
  uint64_t v1 = [a1 firstObject];
  int v2 = objc_opt_class();
  id v3 = sub_100008698(v2);
  sub_1000086BC((void *)&_mh_execute_header, v4, v5, "Recording data of type: %@ for key: %@", v6, v7, v8, v9, v10);
}

void sub_10001F750(void *a1)
{
  uint64_t v1 = [a1 firstObject];
  int v2 = objc_opt_class();
  id v3 = sub_100008698(v2);
  sub_1000086BC((void *)&_mh_execute_header, v4, v5, "Recording data of type array, with first object class: %@ for key: %@", v6, v7, v8, v9, v10);
}
...
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "Failed to record data with DifferentialPrivacy framework.", v2, v3, v4, v5, v6);
}

void sub_10001F860(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3 = 138412546;
  uint64_t v4 = a1;
  __int16 v5 = 2112;
...
void sub_10001F8E8(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "No encoding database is provoided, should implement dataItemToBitString: encodingClient: in subclass.", v2, v3, v4, v5, v6);
}

void sub_10001F994()
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "Default encoding only supports NSString now.", v2, v3, v4, v5, v6);
}

void sub_10001F9C8(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_10001FA40(void *a1, uint64_t a2, NSObject *a3)
{
...
void sub_10001FB88(unsigned char *a1, unsigned char *a2)
{
  sub_1000126BC(a1, a2);
  sub_1000126CC((void *)&_mh_execute_header, v2, v3, "BMKeyboardTokenFrequency has no locale, drop the event.", v4);
}

void sub_10001FBB4(unsigned char *a1, unsigned char *a2)
{
  sub_1000126BC(a1, a2);
  sub_1000126CC((void *)&_mh_execute_header, v2, v3, "The locale of BMKeyboardTokenFrequency is from multilingual keyboard, drop the event.", v4);
}

void sub_10001FBE0(unsigned char *a1, unsigned char *a2)
{
  sub_1000126BC(a1, a2);
  sub_1000126CC((void *)&_mh_execute_header, v2, v3, "BMKeyboardTokenFrequency has unknown token type, drop the event.", v4);
}

void sub_10001FC0C(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_10001FC84(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
void sub_10001FD3C(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_10001FDB4(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_10001FE2C(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_10001FE98(uint64_t a1, void *a2, NSObject *a3)
{
...
void sub_10001FF4C(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "Loaded recipe", v2, v3, v4, v5, v6);
}

void sub_10001FFEC()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "Received recipe attachment", v2, v3, v4, v5, v6);
}

void sub_100020020()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "Stopping extension", v2, v3, v4, v5, v6);
}

void sub_100020054(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_1000200CC(uint64_t a1, uint64_t a2, os_log_t log)
{
  int v3 = 138412546;
  uint64_t v4 = a1;
  __int16 v5 = 2112;
...
void sub_100020154(uint8_t *buf, unsigned char *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
...
void sub_100020194(uint8_t *buf, unsigned char *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
...
void sub_1000201D4(uint8_t *a1, void *a2, void *a3, NSObject *a4)
{
...
void sub_10002024C(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_1000202C4(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
...
void sub_100020308(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_100020380(void *a1, NSObject *a2)
{
  uint64_t v3 = [a1 description];
  sub_10001C36C();
  sub_10001C354((void *)&_mh_execute_header, a2, v4, "base64 graph dsl %@", v5);
}

void sub_10002040C(void *a1, NSObject *a2)
{
  uint64_t v3 = [a1 description];
  sub_10001C36C();
  sub_10001C354((void *)&_mh_execute_header, a2, v4, "base64 graph data %@", v5);
}

void sub_100020498(void *a1, NSObject *a2)
{
  [a1 UTF8String];
  sub_10001C36C();
  sub_10001C354((void *)&_mh_execute_header, a2, v3, "base64 graph %s", v4);
}

void sub_10002051C()
{
  sub_10001C36C();
  sub_10001C354((void *)&_mh_execute_header, v0, v1, "SQL Query: \"%@\"", v2);
}
...
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "Dedisco configuration is missing Server configuration.", v2, v3, v4, v5, v6);
}

void sub_100020630()
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "Dedisco Server configuration is missing helper servers.", v2, v3, v4, v5, v6);
}

void sub_100020664()
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "Helper in Dedisco Server configuration cannot be 1st party.", v2, v3, v4, v5, v6);
}

void sub_100020698()
{
  sub_10000B358();
  sub_10000B33C((void *)&_mh_execute_header, v0, v1, "The SQL query does not filter against only private relay signal on the table.", v2, v3, v4, v5, v6);
}

void sub_1000206CC()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "The client ID is associated with explicit use-case with private relay.", v2, v3, v4, v5, v6);
}

void sub_100020700()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "The client ID is associated with explicit use-case without private relay.", v2, v3, v4, v5, v6);
}

void sub_100020734()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "The client ID is not associated with private relay.", v2, v3, v4, v5, v6);
}

void sub_100020768(void *a1, uint64_t a2, NSObject *a3)
{
  *(_DWORD *)a2 = 138412290;
  *(void *)(a2 + 4) = a1;
  sub_10001C354((void *)&_mh_execute_header, a3, (uint64_t)a3, "Loaded publisher %@", (uint8_t *)a2);
}

void sub_1000207B8(void *a1, uint64_t a2, NSObject *a3, void *a4)
{
  *(_DWORD *)a2 = 138412290;
  *(void *)(a2 + 4) = a1;
  sub_10001C354((void *)&_mh_execute_header, a3, (uint64_t)a3, "Running graph %@", (uint8_t *)a2);
}

void sub_100020810()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "Nothing to record ¯\\_(ツ)_/¯", v2, v3, v4, v5, v6);
}

void sub_100020844()
{
  sub_10001C36C();
  sub_10001C354((void *)&_mh_execute_header, v0, v1, "Cannot record all data: %@", v2);
}

void sub_1000208B0(uint64_t a1, NSObject *a2)
{
...
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "Received event", v2, v3, v4, v5, v6);
}

void sub_100020968(char a1, uint64_t a2, os_log_t log)
{
  v3[0] = 67109378;
  v3[1] = a1 & 1;
  __int16 v4 = 2112;
...
{
  id v4 = objc_msgSend((id)sub_10001C378(a1, a2), "count");
  *uint64_t v3 = 134217984;
  void *v2 = v4;
  sub_10001C38C((void *)&_mh_execute_header, v5, v6, "Recorded %lu data");
}

void sub_100020A44()
{
  sub_10001C36C();
  sub_10001C354((void *)&_mh_execute_header, v0, v1, "levelURLs = %@", v2);
}

void sub_100020AB0()
{
  sub_10000B358();
  sub_100013A70((void *)&_mh_execute_header, v0, v1, "No factors needed.", v2, v3, v4, v5, v6);
}

void sub_100020AE4(uint64_t a1, uint64_t a2)
{
  uint64_t v4 = objc_msgSend((id)sub_10001C378(a1, a2), "allObjects");
  uint64_t v5 = [v4 componentsJoinedByString:@"', '"];
  *uint64_t v3 = 138412290;
  void *v2 = v5;
  sub_10001C38C((void *)&_mh_execute_header, v6, v7, "factor fields in data = ['%@']");
}

void sub_100020B60(uint8_t *buf, unsigned char *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
...
void sub_100020BE4(uint64_t *a1, uint64_t *a2, NSObject *a3)
{
  ...
  __int16 v7 = 2112;
  uint64_t v8 = v4;
  sub_10001DBC0((void *)&_mh_execute_header, a3, (uint64_t)a3, "Recipe %@ content: %@", (uint8_t *)&v5);
}

void sub_100020C6C(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_100020CE4(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v6 = 2048;
  uint64_t v7 = a2;
  sub_10001DBC0((void *)&_mh_execute_header, a3, (uint64_t)a3, "Downloading %@, progress %li", (uint8_t *)&v4);
}

void sub_100020D68()
{
  sub_10001DBA8();
  sub_10001DBD8((void *)&_mh_execute_header, v0, v1, "Trial failed to download %@, error %@");
}

void sub_100020DD4(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  __int16 v9 = 2112;
  uint64_t v10 = v5;
  sub_10001DBC0((void *)&_mh_execute_header, a3, v6, "Removing factor %@ for namespace %@", (uint8_t *)&v7);
}

void sub_100020E80(uint64_t a1, NSObject *a2)
{
  uint64_t v3 = *(void *)(a1 + 32);
  ...
  __int16 v8 = 2112;
  __int16 v9 = v4;
  sub_10001DBC0((void *)&_mh_execute_header, a2, v5, "Removing factor %@ for namespace %@ succeed.", (uint8_t *)&v6);
}

void sub_100020F28()
{
  sub_10001DBA8();
  sub_10001DBD8((void *)&_mh_execute_header, v0, v1, "Failed to delete %@, error %@");
}

void sub_100020F94(uint64_t a1, NSObject *a2)
{
  int v2 = 138412290;
  uint64_t v3 = a1;
...
void sub_10002100C(uint64_t a1, void *a2, NSObject *a3)
{
