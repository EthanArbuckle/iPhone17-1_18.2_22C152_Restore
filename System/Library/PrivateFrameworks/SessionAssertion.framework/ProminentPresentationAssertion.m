...
- (_TtC16SessionAssertion30ProminentPresentationAssertion)initWithExplanation:(id)a3 activityIdentifier:(id)a4 duration:(double)a5 invalidationHandler:(id)a6
{
  ...
  return (_TtC16SessionAssertion30ProminentPresentationAssertion *)ProminentPresentationAssertion.init(explanation:activityIdentifier:duration:invalidationHandler:)(v8, v10, v11, v13, (uint64_t)v15, v14, a5);
}

- (void)invalidate
{
  if (*(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC16SessionAssertion30ProminentPresentationAssertion_attributeAssertion))
  {
    v2 = self;
    swift_retain();
    sub_1B8F821F4();
...
- (_TtC16SessionAssertion30ProminentPresentationAssertion)init
{
  result = (_TtC16SessionAssertion30ProminentPresentationAssertion *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_1B8F6F3B8(*(uint64_t *)((char *)&self->super.isa
                           + OBJC_IVAR____TtC16SessionAssertion30ProminentPresentationAssertion_invalidationHandler));
  swift_bridgeObjectRelease();
