...
- (uint64_t)mp_basicPropertiesToCopy
{
  return objc_msgSend(MEMORY[0x1E4F1CA80], "setWithObjects:", @"bounds", @"position", @"zPosition", @"anchorPoint", @"anchorPointZ", @"transform", @"hidden", @"doubleSided", @"geometryFlipped", @"sublayerTransform", @"masksToBounds", @"contents", @"contentsRect", @"contentsGravity", @"contentsScale", @"contentsCenter", @"minificationFilter",
           @"magnificationFilter",
...
- (id)mp_propertiesToCopy
{
  v1 = objc_msgSend(a1, "mp_basicPropertiesToCopy");
  objc_opt_class();
        ...
        if (v9)
        {
          ...
          do
          {
            for (uint64_t j = 0; j != v10; ++j)
            {
              ...
              long long v13 = [v7 animationForKey:*(void *)(*((void *)&v16 + 1) + 8 * j)];
              [v2 addObject:v13];
            }
...
- (void)mp_moveAndResizeWithinParentLayer:()MicaPlayerAdditions usingGravity:geometryFlipped:retinaScale:animate:
{
  ...
  id v29 = (void *)*MEMORY[0x1E4F3A3F8];
  if (a6)
  {
    if ([v12 isEqualToString:*MEMORY[0x1E4F3A3F8]])
    {
      v30 = (void **)MEMORY[0x1E4F3A3B0];
LABEL_22:
      long long v33 = *v30;
LABEL_23:
      id v34 = v33;
    ...
    v31 = (void *)*MEMORY[0x1E4F3A3F0];
    if ([v12 isEqualToString:*MEMORY[0x1E4F3A3F0]])
    {
      v30 = (void **)MEMORY[0x1E4F3A3A8];
      goto LABEL_22;
    }
    v32 = (void *)*MEMORY[0x1E4F3A400];
    if ([v12 isEqualToString:*MEMORY[0x1E4F3A400]])
    {
      v30 = (void **)MEMORY[0x1E4F3A3B8];
      goto LABEL_22;
    }
    char v40 = [v12 isEqualToString:*MEMORY[0x1E4F3A3B0]];
    long long v33 = v29;
    if (v40) {
      goto LABEL_23;
    }
    char v41 = [v12 isEqualToString:*MEMORY[0x1E4F3A3A8]];
    long long v33 = v31;
    if (v41) {
      goto LABEL_23;
    }
    int v42 = [v12 isEqualToString:*MEMORY[0x1E4F3A3B8]];
    long long v33 = v32;
    if (v42) {
      goto LABEL_23;
    }
...
LABEL_31:
  ...
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3C8]]) {
    goto LABEL_48;
  }
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3C0]])
  {
    double v39 = 0.5;
    double v14 = v14 + v25 * 0.5 - v27 * 0.5;
LABEL_49:
  ...
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3E8]])
  {
    double v14 = v14 + v25 - v27;
LABEL_48:
    double v39 = 0.5;
  ...
  double v35 = 1.0;
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3B0]]) {
    goto LABEL_31;
  }
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3A8]])
  {
    double v14 = v14 + v25 * 0.5 - v27 * 0.5;
    goto LABEL_31;
  }
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3B8]])
  {
    double v14 = v14 + v25 - v27;
    goto LABEL_31;
  }
  if ([v12 isEqualToString:*MEMORY[0x1E4F3A3D0]])
  {
    double v36 = v25 / v27;
    double v35 = v26 / v28;
  }
  ...
  {
    if ([v12 isEqualToString:*MEMORY[0x1E4F3A3D8]])
    {
      if (v25 / v27 >= v26 / v28) {
        double v35 = v26 / v28;
      }
    ...
    {
      if (![v12 isEqualToString:*MEMORY[0x1E4F3A3E0]])
      {
