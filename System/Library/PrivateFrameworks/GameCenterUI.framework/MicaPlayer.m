...
- (CALayer)rootLayer;
- (MicaPlayer)initWithFileName:(id)a3 bundle:(id)a4 retinaScale:(double)a5;
...
- (MicaPlayer)initWithFileName:(id)a3 retinaScale:(double)a4
{
  ...
  id v7 = a3;
  v8 = [v6 mainBundle];
  v9 = [(MicaPlayer *)self initWithFileName:v7 bundle:v8 retinaScale:a4];
...
{
  id v8 = a3;
  v9 = [a4 URLForResource:v8 withExtension:@"caar"];
  v10 = v9;
  if (v9)
  {
    v11 = [v9 path];
    v12 = [(MicaPlayer *)self initWithPath:v11 retinaScale:a5];
    self = v11;
  }
  else
  {
    v13 = [0 path];
    NSLog(&cfstr_UnableToFindMi.isa, v8, v13);
...
{
  id v6 = a3;
  id v7 = +[MicaPlayer rootDictForPath:v6];
  id v8 = v7;
  if (!v7
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v7 = [(MicaPlayer *)self rootLayer];
  id v8 = objc_msgSend(v7, "mp_deepCopyLayer");

  uint64_t v9 = [(MicaPlayer *)self publishedObjects];
