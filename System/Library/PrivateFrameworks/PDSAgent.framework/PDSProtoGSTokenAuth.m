...
- (id)description
{
  ...
  v4 = [(PDSProtoGSTokenAuth *)&v8 description];
  v5 = [(PDSProtoGSTokenAuth *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (gsAuthToken) {
    [v3 setObject:gsAuthToken forKey:@"gs_auth_token"];
  }
  return v4;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSString *)self->_gsAuthToken copyWithZone:a3];
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)gsAuthToken | v4[1]) {
      char v6 = -[NSString isEqual:](gsAuthToken, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSString *)self->_gsAuthToken hash];
}
