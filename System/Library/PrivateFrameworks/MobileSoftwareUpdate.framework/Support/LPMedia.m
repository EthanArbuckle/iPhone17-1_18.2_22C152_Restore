...
LABEL_10:
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (v13)
      {
        ...
        {
          id v24 = [(NSMutableArray *)v36 sortedArrayUsingComparator:&__block_literal_global_15];
...
LABEL_8:
  ...
  uint64_t v21 = 0;
  long long v20 = xmmword_1000410E0;
  id v9 = v6;
  [v9 UTF8String];
  __strlcpy_chk();
  v22[0] = 8;
...
- (id)deviceModel
{
  ...
  while (1)
  {
    unint64_t v4 = (void *)IORegistryEntrySearchCFProperty([(LPMedia *)self ioMedia], "IOService", *(__CFString **)((char *)&off_10005A6D0 + v3), kCFAllocatorDefault, 3u);
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      break;
    }
