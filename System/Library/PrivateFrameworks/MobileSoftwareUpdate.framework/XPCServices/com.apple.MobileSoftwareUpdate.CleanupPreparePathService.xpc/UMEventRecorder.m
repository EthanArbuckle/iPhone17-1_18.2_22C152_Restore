  ...
  if (v5)
  {
    ...
    if (v13)
    {
      ...
      if (-[NSFileManager fileExistsAtPath:](+[NSFileManager defaultManager](NSFileManager, "defaultManager"), "fileExistsAtPath:", [v17 path]))
      {
        ...
        {
          uint64_t v19 = v16;
          id v17 = objc_msgSend(-[UMEventRecorder _eventDirectory](self, "_eventDirectory"), "URLByAppendingPathComponent:", objc_msgSend(v16[441], "stringWithFormat:", @"%@-%@-%@-%d.plist", v14, objc_msgSend(a3, "objectForKey:", @"event"), objc_msgSend(a3, "objectForKey:", @"eventTime"), v18));
...
- (void)submitEventsInBackground:(BOOL)a3 withOptions:(id)a4
{
  ...
  if (v4) {
    dispatch_async(submitQueue, v7);
  }
  else {
    dispatch_sync(submitQueue, v7);
  }
  _Block_release(v7);
}
...
- (id)_copyUnsubmittedEventsFromDirectory:(id)a3 skipEventsIfPreviouslySubmittedAndWithinBackoffTime:(BOOL)a4 previouslySubmittedEventSkipped:(BOOL *)a5
{
  ...
  if (v21)
  {
    ...
    while (1)
    {
      ...
      id v34 = [v25[431] dictionaryWithContentsOfURL:v33];
      if (v34)
      {
        uint64_t v41 = v34;
        CFStringRef v42 = v23;
