...
- (unsigned)_findFirmwareInfoEntry
{
  ...
  if (!IORegistryCreateIterator(kIOMasterPortDefault, "IODeviceTree", 1u, &iterator))
  {
    ...
    while (v4 && !_is_firmware_info_entry(v4));
...
LABEL_27:
      ...
      && [(IODualSPIWriter *)self _crossingRegionChangeBoundary])
    {
      ...
      *(const char **)((char *)&self->_regBuffer + 4) = (const char *)&kJadePORExtendedRegions;
...
LABEL_13:
  ...
  unsigned int v47 = -[IODualSPIWriter eraseBytes:ofLength:withError:](self, "eraseBytes:ofLength:withError:", [v12 startLocation], objc_msgSend(v12, "length"), &v91);
...
- (id)findHeaders
{
  ...
  else
  {
    ...
    id v30 = objc_msgSend(objc_alloc((Class)NSArray), "initWithObjects:", v16, v17, 0);
...
- (int)_writeFirmware:(id)a3 toHeader:(id)a4 withError:(id *)a5
{
  ...
  if ((unint64_t)v21 <= v13)
  {
    ...
    objc_msgSend(v10, "increaseLengthBy:", v13 - (void)objc_msgSend(a3, "length"));
LABEL_8:
    ...
    else
    {
      ...
      if (v72 == 1)
      {
        ...
        unsigned int v81 = -[IODualSPIWriter _writeBytes:atOffset:ofLength:withError:](self, "_writeBytes:atOffset:ofLength:withError:", (char *)[v10 bytes] + v71, objc_msgSend(a4, "secondaryPayloadOffset"), v80, &v113);
        if (v81)
        {
          int v29 = v81;
