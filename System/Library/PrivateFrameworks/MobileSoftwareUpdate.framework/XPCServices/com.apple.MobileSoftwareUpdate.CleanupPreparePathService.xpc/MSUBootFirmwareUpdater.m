...
+ (id)updaterWithIOService:(unsigned int)a3
{
  ...
  if ((id)objc_opt_class() == a1)
  {
    ...
    long long v11 = 0u;
    long long v12 = 0u;
    id v7 = objc_msgSend(a1, "_updaterClasses", 0);
...
- (MSUBootFirmwareUpdater)initWithIOServiceMatching:(id)a3
{
  ...
  if (MatchingService && IOObjectRelease(MatchingService)) {
    -[MSUBootFirmwareUpdater initWithIOServiceMatching:](&v9, v10);
  }
  return v7;
}
...
- (BOOL)generateFirmwareImagesWithCallback:(ramrod_update_callbacks *)a3 context:(firmware_update_context *)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
      ...
      do
      {
        for (i = 0; i != v33; i = (char *)i + 1)
        {
          ...
          if ([v10 objectForKeyedSubscript:v36])
          {
            ...
            objc_msgSend(v77, "addObject:", objc_msgSend(v10, "objectForKeyedSubscript:", v36));
    ...
    a4 = v72;
    a3 = v74;
    objc_msgSend(v77, "addObjectsFromArray:", objc_msgSend(v10, "allValues"));
  }
  else
  {
    objc_opt_class();
...
uint64_t __69__MSUBootFirmwareUpdater_generateFirmwareImagesWithCallback_context___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
  objc_opt_class();
