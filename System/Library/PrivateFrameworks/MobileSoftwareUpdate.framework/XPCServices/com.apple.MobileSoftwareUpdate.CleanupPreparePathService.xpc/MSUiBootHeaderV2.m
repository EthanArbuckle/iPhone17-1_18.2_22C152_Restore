...
- (void)makeValid
{
  ...
  id v3 = objc_msgSend(-[MSUiBootHeaderV2 computeHash](self, "computeHash"), "bytes");
...
- (id)computeHash
{
  id v3 = objc_msgSend(-[MSUiBootHeaderV2 packStructure](self, "packStructure"), "subdataWithRange:", 0, 32);
