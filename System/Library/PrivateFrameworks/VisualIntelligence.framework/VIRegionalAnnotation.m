...
- (VIRegionalAnnotation)initWithLabel:(id)a3 normalizedBoundingBox:(CGRect)a4 confidence:(float)a5
{
  ...
  id v11 = a3;
  v16.receiver = self;
  v16.super_class = (Class)VIRegionalAnnotation;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (confidence == v8
      && ([(VIRegionalAnnotation *)v6 normalizedBoundingBox],
          ...
          CGRectEqualToRect(self->_normalizedBoundingBox, v17)))
    {
      ...
      char IsEqual = VIObjectIsEqual((unint64_t)label, (uint64_t)v14);
    }
    else
    {
      char IsEqual = 0;
...
- (unint64_t)hash
{
  ...
  return v23 ^ v11 ^ v31 ^ v39 ^ v47 ^ [(NSString *)self->_label hash];
}
