...
- (VIObjectCategory)initWithCoder:(id)a3;
- (VIObjectCategory)initWithKnowledgeGraphID:(id)a3 labelDebugDescription:(id)a4;
- (unint64_t)hash;
...
- (VIObjectCategory)initWithKnowledgeGraphID:(id)a3 labelDebugDescription:(id)a4
{
  ...
  id v7 = a4;
  v14.receiver = self;
  v14.super_class = (Class)VIObjectCategory;
