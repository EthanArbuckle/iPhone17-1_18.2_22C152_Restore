...
- (UILabel)customTextLabel
{
  ...
  return (UILabel *)[(RemoteUICustomTableViewCell *)self _textLabelInternal];
}
...
- (UILabel)customDetailTextLabel
{
  ...
  return (UILabel *)[(RemoteUICustomTableViewCell *)self _detailTextLabelInternal];
}
...
- (id)_detailTextLabelInternal
{
  ...
  if (!customDetailTextLabelInternal)
  {
    ...
    v6 = [MEMORY[0x263F81708] preferredFontForTextStyle:*MEMORY[0x263F835C0]];
...
- (UILabel)customValueLabel
{
  ...
  return (UILabel *)[(RemoteUICustomTableViewCell *)self _valueLabelInternal];
}
...
- (UITextField)customEditableTextField
{
  ...
  return (UITextField *)[(RemoteUICustomTableViewCell *)self _editableTextFieldInternal];
}
...
- (id)_editableTextFieldInternal
{
  ...
  {
    v4 = (UITextField *)objc_alloc_init(MEMORY[0x263F82CF0]);
...
{
  [(RemoteUICustomTableViewCell *)self _initializeViews];
  return (UIImageView *)[(RemoteUICustomTableViewCell *)self _imageViewInternal];
}
...
- (void)_initializeViews
{
  ...
  if (!self->_stackView)
  {
    ...
    v76 = objc_msgSend(v77, "constraintLessThanOrEqualToConstant:");
    v99[5] = v76;
    ...
    v99[16] = v36;
    v37 = [MEMORY[0x263EFF8C0] arrayWithObjects:v99 count:17];
