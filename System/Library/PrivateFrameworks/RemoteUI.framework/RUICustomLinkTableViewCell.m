...
- (UILabel)customLinkTextLabel
{
  ...
  return (UILabel *)[(RUICustomLinkTableViewCell *)self _textLabelInternal];
}
...
- (UILabel)customLinkDetailTextLabel
{
  ...
  return (UILabel *)[(RUICustomLinkTableViewCell *)self _detailTextLabelInternal];
}
...
- (UILabel)customLinkSubLabel
{
  ...
  return (UILabel *)[(RUICustomLinkTableViewCell *)self _subLabelInternal];
}
...
- (id)_detailTextLabelInternal
{
  ...
  if (!customLinkDetailTextLabelInternal)
  {
    ...
    v6 = [MEMORY[0x263F81708] systemFontOfSize:15.0 weight:*MEMORY[0x263F81840]];
...
- (void)_initializeViews
{
  ...
  if (!self->_stackView)
  {
    ...
    double v9 = self->_innerStackView;
    ...
    v56[7] = v26;
    v27 = [MEMORY[0x263EFF8C0] arrayWithObjects:v56 count:8];
...
- (void)setDetailLinkText:(id)a3 handler:(id)a4
{
  ...
  double v9 = [(RUICustomLinkTableViewCell *)self _subLabelInternal];
  [v9 removeFromSuperview];

  v10 = _Block_copy(v7);
  id detailLinkHandler = self->_detailLinkHandler;
  self->_id detailLinkHandler = v10;

  v12 = [MEMORY[0x263F824E8] buttonWithType:1];
  detailLinkButton = self->_detailLinkButton;
  ...
  v19 = [MEMORY[0x263F81708] systemFontOfSize:15.0 weight:*MEMORY[0x263F81840]];
  [v18 setFont:v19];

  v20 = self->_detailLinkButton;
  v21 = [MEMORY[0x263F825C8] _labelColor];
  ...
  double v31 = [(UIButton *)self->_detailLinkButton imageView];
...
- (void)_detailLinkPressed
{
  if (_isInternalInstall())
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_2144F2000, v3, OS_LOG_TYPE_DEFAULT, "detail pressed", buf, 2u);
    }
  }
...
{
  return (*(uint64_t (**)(void))(*(void *)(*(void *)(a1 + 32) + 1160) + 16))();
}
...
void __48__RUICustomLinkTableViewCell__detailLinkPressed__block_invoke_2(uint64_t a1, char a2, void *a3)
{
  ...
  if ((a2 & 1) == 0 && _isInternalInstall())
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      int v6 = 138412290;
      id v7 = v4;
      _os_log_impl(&dword_2144F2000, v5, OS_LOG_TYPE_DEFAULT, "error %@", (uint8_t *)&v6, 0xCu);
    }
  }
}
