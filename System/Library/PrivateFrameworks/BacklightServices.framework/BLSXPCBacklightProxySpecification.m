...
+ (NSString)identifier
{
  return (NSString *)@"com.apple.BacklightServices.backlight";
}
...
void __46__BLSXPCBacklightProxySpecification_interface__block_invoke()
{
  ...
  v2 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1F0E55FC0];
  [v6 setServer:v2];

  v3 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1F0E4E3E8];
  [v6 setClient:v3];
