@interface AWDMETRICSCellularPowerLogNRDCEvent
- (BOOL)hasEvent;
- (BOOL)hasFr;
- (BOOL)hasSubsId;
- (BOOL)hasTimestamp;
...
@implementation AWDMETRICSCellularPowerLogNRDCEvent
...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"NRDC_OFF"]) {
    int v4 = 0;
  }
  else {
    int v4 = [v3 isEqualToString:@"NRDC_ON"];
  }
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLogNRDCEvent;
  int v4 = [(AWDMETRICSCellularPowerLogNRDCEvent *)&v8 description];
  v5 = [(AWDMETRICSCellularPowerLogNRDCEvent *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLogNRDCEventReadFrom((uint64_t)self, (uint64_t)a3);
}
