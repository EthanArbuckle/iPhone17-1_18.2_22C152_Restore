...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLogNRSCGRel;
  int v4 = [(AWDMETRICSCellularPowerLogNRSCGRel *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLogNRSCGRelReadFrom((uint64_t)self, (uint64_t)a3);
}
