...
- (int)StringAsFR1:(id)a3
{
  ...
  if ([v3 isEqualToString:@"NOT_AVAILABLE"]) {
    ...
    int v4 = [v3 isEqualToString:@"AVAILABLE"];
  }
...
- (id)description
{
  ...
  int v4 = [(AWDMETRICSCellularPowerLogNRFRCoverage *)&v8 description];
...
LABEL_14:
      ...
      if (fR2)
      {
        ...
        {
          objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_fR2);
  ...
  if (fR1)
  {
    ...
    {
      objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_fR1);
...
LABEL_21:
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 28) & 2) == 0 || self->_fR1 != *((_DWORD *)v4 + 4)) {
      goto LABEL_21;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 4) != 0)
  {
    if ((*((unsigned char *)v4 + 28) & 4) == 0 || self->_fR2 != *((_DWORD *)v4 + 5)) {
      goto LABEL_21;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
LABEL_3:
      uint64_t v3 = 2654435761 * self->_fR1;
      if ((*(unsigned char *)&self->_has & 8) != 0) {
        goto LABEL_4;
      }
LABEL_8:
...
LABEL_5:
  uint64_t v5 = 2654435761 * self->_fR2;
  return v3 ^ v2 ^ v4 ^ v5;
}
