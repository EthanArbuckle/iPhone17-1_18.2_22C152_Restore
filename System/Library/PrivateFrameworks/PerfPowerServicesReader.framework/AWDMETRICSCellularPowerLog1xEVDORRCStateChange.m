...
@implementation AWDMETRICSCellularPowerLog1xEVDORRCStateChange
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLog1xEVDORRCStateChange;
  int v4 = [(AWDMETRICSCellularPowerLog1xEVDORRCStateChange *)&v8 description];
  v5 = [(AWDMETRICSCellularPowerLog1xEVDORRCStateChange *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLog1xEVDORRCStateChangeReadFrom((uint64_t)self, (uint64_t)a3);
}
