@interface EspressoPass_lstm_atomizer
- (BOOL)runOnNetwork:(void *)a3;
@end

@implementation EspressoPass_lstm_atomizer
...
- (BOOL)runOnNetwork:(void *)a3
{
  ...
  *((void *)v4 + 1) = 0;
  *((void *)v4 + 2) = 0;
  *(void *)v4 = &unk_1EE3867E8;
  v5 = (void *)((char *)v4 + 24);
  *((void *)v4 + 4) = 0;
  *((void *)v4 + 5) = 0;
  *((void *)v4 + 3) = &unk_1EE34E970;
  v7 = Espresso::espresso_os_log_subsystem(v4, v6);
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315138;
    unint64_t v12 = (unint64_t)"N8Espresso18pass_lstm_atomizerE" & 0x7FFFFFFFFFFFFFFFLL;
