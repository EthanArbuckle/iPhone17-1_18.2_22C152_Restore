...
@implementation EspressoPass_style_transfer_two_nets

- (BOOL)runOnNetwork:(void *)a3
{
  uint64_t v14 = *MEMORY[0x1E4F143B8];
  v4 = (Espresso *)operator new(0x48uLL);
  *((void *)v4 + 1) = 0;
  *((void *)v4 + 2) = 0;
  *(void *)v4 = &unk_1EE388B90;
  v5 = (void *)((char *)v4 + 24);
  *((void *)v4 + 4) = 0;
  *((void *)v4 + 5) = 0;
  *((void *)v4 + 3) = &unk_1EE363A30;
  *((void *)v4 + 7) = 0;
  *((void *)v4 + 8) = 0;
  *((void *)v4 + 6) = &unk_1EE36BD70;
  v7 = Espresso::espresso_os_log_subsystem(v4, v6);
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315138;
    unint64_t v12 = (unint64_t)"N8Espresso28pass_style_transfer_two_netsE" & 0x7FFFFFFFFFFFFFFFLL;
