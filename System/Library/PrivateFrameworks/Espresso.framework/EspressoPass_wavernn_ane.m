@interface EspressoPass_wavernn_ane
- (BOOL)runOnNetwork:(void *)a3;
@end

@implementation EspressoPass_wavernn_ane

- (BOOL)runOnNetwork:(void *)a3
{
  uint64_t v14 = *MEMORY[0x1E4F143B8];
  v4 = (Espresso *)operator new(0x38uLL);
  *((void *)v4 + 1) = 0;
  *((void *)v4 + 2) = 0;
  *(void *)v4 = &unk_1EE3848D8;
  v5 = (void *)((char *)v4 + 24);
  *((void *)v4 + 4) = 0;
  *((void *)v4 + 5) = 0;
  *((void *)v4 + 3) = &unk_1EE33DE88;
  *((void *)v4 + 6) = 0x52000001C0;
  v7 = Espresso::espresso_os_log_subsystem(v4, v6);
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 136315138;
    unint64_t v12 = (unint64_t)"N8Espresso16pass_wavernn_aneE" & 0x7FFFFFFFFFFFFFFFLL;
