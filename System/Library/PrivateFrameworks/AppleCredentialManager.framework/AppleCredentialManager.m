...
{
  if (qword_10001C358 != -1) {
    dispatch_once(&qword_10001C358, &stru_1000182B0);
  }
  return byte_10001C350;
}

void sub_10000141C(id a1)
{
  byte_10001C350 = MGGetBoolAnswer();
}

uint64_t sub_100001444()
{
  if (qword_10001C368 != -1) {
    dispatch_once(&qword_10001C368, &stru_1000182D0);
  }
  return byte_10001C360;
}

void sub_100001488(id a1)
{
  byte_10001C360 = MGGetBoolAnswer();
}
...
id sub_1000014B8(void *a1, void *a2)
{
  v3 = a2;
...
BOOL sub_100001558(void *a1, void *a2, void *a3)
{
  kern_return_t v10;
  io_connect_t v11;
  BOOL v12;
  ...
  id v6 = a3;
  connect = 0;
  CFDictionaryRef v7 = IOServiceMatching((const char *)[a1 UTF8String]);
...
id sub_10000163C(void *a1)
{
  return sub_1000014B8(@"IOService:/IOResources/AppleCredentialManager", a1);
}

BOOL sub_10000164C(void *a1, void *a2)
{
  return sub_100001558(@"AppleCredentialManager", a1, a2);
}

id sub_100001660(uint64_t a1)
{
...
uint64_t sub_100001778(const char *a1, void *a2, int a3)
{
  id v5 = a2;
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
  ...
  int v7 = open_dprotected_np(a1, 514, 4, 0, 384);
  if ((v7 & 0x80000000) == 0)
  {
    int v8 = v7;
...
void start()
{
  targetq = dispatch_queue_create("com.apple.AppleCredentialManagerDaemon.notifications", 0);
  v1 = [[TransportRestrictedModeService alloc] initWithNotificationQueue:targetq];
  v26 = v1;
...
void sub_100001C60(uint64_t a1, void *a2)
{
  id v3 = a2;
  id v4 = (void *)os_transaction_create();
  id v5 = +[NSString stringWithUTF8String:xpc_dictionary_get_string(v3, _xpc_event_key_name)];
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    __int16 v17 = "acmd";
    __int16 v18 = 2080;
    __int16 v19 = "main_block_invoke";
    __int16 v20 = 2112;
    uint64_t v21 = v5;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((void *)&v11 + 1) + 8 * (void)v10), "handleXPCEventWithName:", v5, (void)v11);
        id v10 = (char *)v10 + 1;
      }
      while (v8 != v10);
...
id sub_100002280(uint64_t a1)
{
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    ...
    id v4 = "ACMTRM-D";
    __int16 v5 = 2080;
    id v6 = "-[TransportRestrictedModeService initWithNotificationQueue:]_block_invoke";
...
id sub_100002A9C()
{
  ...
  id v1 = [v0 isUSBRestrictedModeAllowed];
...
uint64_t sub_100003FD8(void *a1, rsize_t __n)
{
...
{
  return qword_10001C378;
}

void *sub_100003FF0(size_t size)
{
  uint64_t result = malloc_type_calloc(1uLL, size, 0xCB62F0E9uLL);
  if (result) {
    qword_10001C380 += size;
  }
  return result;
}

void sub_100004038(void *a1, rsize_t __n)
{
  if (a1)
  {
    memset_s(a1, __n, 0, __n);
    free(a1);
    uint64_t v4 = qword_10001C380 - __n;
    if (qword_10001C380 < __n) {
      uint64_t v4 = 0;
    }
    qword_10001C380 = v4;
  }
...
void *sub_10000408C(size_t size)
{
  uint64_t result = malloc_type_calloc(1uLL, size, 0xDB9956F0uLL);
  if (result) {
    qword_10001C388 += size;
  }
  return result;
}

void sub_1000040D4(void *a1, rsize_t __n)
{
  if (a1)
  {
    memset_s(a1, __n, 0, __n);
    free(a1);
    uint64_t v4 = qword_10001C388 - __n;
    if (qword_10001C388 < __n) {
      uint64_t v4 = 0;
    }
    qword_10001C388 = v4;
  }
...
const char *sub_100004128(const char *result, const void *a2, uint64_t a3, const char *a4, int a5, const char *a6)
{
  if (a2) {
    qword_10001C378 += a3;
  }
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_alloc_info", v7, a2, a3, qword_10001C378, 0, qword_10001C380, qword_10001C388, v8, a5, v6);
  }
  return result;
}

const char *sub_1000041D4(const char *result, const void *a2, unint64_t a3, const char *a4, int a5, const char *a6)
{
  if (a2)
  {
    uint64_t v6 = qword_10001C378 - a3;
    if (qword_10001C378 < a3) {
      uint64_t v6 = 0;
    }
    qword_10001C378 = v6;
  }
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return (const char *)printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_free_info", v8, a2, a3, qword_10001C378, 0, qword_10001C380, qword_10001C388, v9, a5, v7);
  }
  return result;
}
...
uint64_t GetSerializedVerifyPolicySize(uint64_t a1, char *__s1, uint64_t a3, uint64_t a4, _DWORD *a5, unsigned int a6, void *a7)
{
  ...
  if (a1 && __s1 && a7)
  {
    ...
    {
      size_t v13 = v12;
      uint64_t result = sub_100004318(a5, a6, &v14);
      if (!result) {
        *a7 = v13 + v14 + 26;
      }
    }
...
uint64_t sub_100004318(_DWORD *a1, unsigned int a2, _DWORD *a3)
{
            ...
            if (!result)
            {
              ...
              *a7 = *a1;
              ...
              else
              {
                ...
                *(_DWORD *)(v19 + 18) = v15;
                size_t v20 = v18 + 22;
                uint64_t result = sub_100004548((uint64_t)a5, a6, (uint64_t)a7, (uint64_t *)&v20);
                if (!result) {
                  *a8 = v20;
                }
              }
...
uint64_t sub_100004548(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  LODWORD(v6) = a2;
  if (gACMLoggingLevel <= 0xAu) {
    ...
    if (v6)
    {
      ...
      while (1)
      {
        *(_OWORD *)__src = *(_OWORD *)a1;
        ...
        uint64_t v12 = sub_1000072FC(__src);
        if (v12) {
          break;
        }
...
uint64_t DeserializeVerifyPolicy(uint64_t a1, unint64_t a2, _OWORD *a3, void *a4, BOOL *a5, _DWORD *a6, void *a7, _DWORD *a8)
{
  ...
  if (a2 >= 0x10 && a1 && a3 && a4 && a5 && a6 && a7 && a8)
  {
    *a3 = *(_OWORD *)a1;
    ...
    v26 = a4;
    unint64_t v18 = v17 + 1;
    __int16 v19 = sub_100003FF0(v17 + 1);
    sub_100004128("<data>", v19, v17 + 1, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 349, "DeserializeVerifyPolicy");
    if (!v19) {
      return 4294967292;
    }
    ...
    else
    {
      ...
      uint64_t v8 = sub_100004888(a1, a2, &v29, &v28, &v27);
      if (!v8)
      {
        void *v26 = v19;
        *size_t v20 = v21;
    ...
    sub_1000041D4("<data>", v19, v18, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 378, "DeserializeVerifyPolicy");
    sub_100004038(v19, v18);
    if (v28) {
...
uint64_t sub_100004888(uint64_t a1, unint64_t a2, unint64_t *a3, void *a4, _DWORD *a5)
{
...
LABEL_24:
  ...
  int v27 = v14;
  uint64_t v15 = 24 * v14;
  v16 = (char *)sub_10000408C(24 * v14);
  sub_100004128("array of ACMParameter", v16, v15, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 194, "deserializeParameters");
  if (!v16)
  {
    unsigned int v11 = 70;
  ...
  while (1)
  {
    ...
    *(void *)&v16[v17 + 8] = 0;
    ...
    uint64_t v21 = sub_1000072FC(&v16[v17]);
    if (v21)
    {
      uint64_t v12 = v21;
      unsigned int v11 = 70;
...
LABEL_20:
  ...
  long long v22 = sub_100003FF0(v20);
  sub_100004128("<data>", v22, v20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 212, "deserializeParameters");
  *((void *)v18 + 1) = v22;
  if (v22)
  {
...
uint64_t GetSerializedVerifyAclConstraintSize(int a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, unsigned int a6, uint64_t a7, uint64_t a8, _DWORD *a9, unsigned int a10, void *a11)
{
  ...
  if (a3)
  {
    if (a11)
    {
      ...
      {
        uint64_t result = sub_100004318(a9, a10, &v18);
        if (!result)
        {
          uint64_t v15 = 29;
          if (a1 == 32) {
...
uint64_t SerializeVerifyAclConstraint(int a1, _OWORD *a2, const void *a3, unsigned int a4, const void *a5, unsigned int a6, char a7, int a8, _DWORD *a9, unsigned int a10, uint64_t a11, void *a12)
{
  ...
  {
    unsigned int v31 = 0;
    uint64_t result = sub_100004318(a9, a10, &v31);
    if (!result)
    {
      uint64_t v21 = 29;
      if (a1 == 32) {
      ...
      else
      {
        ...
        *(_DWORD *)(v26 + 1) = v28;
        uint64_t v30 = v24 + 5;
        uint64_t result = sub_100004548((uint64_t)a9, a10, a11, &v30);
        if (!result) {
          *a12 = v30;
        }
      }
  ...
  if (a2 && a4 && a5 && a6 && a9 && a10 && a11 && a12 && a3 >= 0x10)
  {
    ...
    *a4 = *(_OWORD *)a2;
    ...
    else
    {
      ...
      unint64_t v34 = 20;
      uint64_t v21 = sub_100003FF0(v20);
      sub_100004128("<data>", v21, v20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 532, "DeserializeVerifyAclConstraint");
      if (v21)
      {
        if (v16 - 20 < v20) {
          goto LABEL_24;
...
LABEL_24:
        ...
        else
        {
          ...
          uint64_t v25 = sub_100003FF0(v23);
          sub_100004128("<data>", v25, v23, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 544, "DeserializeVerifyAclConstraint");
          if (!v25)
          {
            uint64_t v12 = 4294967292;
LABEL_26:
            sub_1000041D4("<data>", v21, v20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 580, "DeserializeVerifyAclConstraint");
            sub_100004038(v21, v20);
            if (v25)
            {
              sub_1000041D4("<data>", v25, v23, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 583, "DeserializeVerifyAclConstraint");
              sub_100004038(v25, v23);
            }
            goto LABEL_30;
          }
          if (v16 - v24 >= v23)
...
LABEL_19:
            if (v22 != v16)
            {
              ...
              if (v16 - (v22 + 1) >= 4)
              {
                ...
                unint64_t v34 = v22 + 5;
                uint64_t v12 = sub_100004888(a2, v16, &v34, &v33, &v32);
                if (!v12)
                {
...
uint64_t GetSerializedProcessAclSize(uint64_t a1, uint64_t a2, unsigned int a3, uint64_t a4, unsigned int a5, uint64_t a6, _DWORD *a7, unsigned int a8, void *a9)
{
  ...
  {
    uint64_t result = sub_100004318(a7, a8, &v12);
    if (!result) {
    ...
    if (!v15 && a8 <= 0xA && (a7 != 0) == (a8 != 0))
    {
      ...
      if (!result)
      {
        ...
        else
        {
          ...
          *(_DWORD *)(a9 + v21) = v17;
          unint64_t v22 = v21 + 4;
          uint64_t result = sub_100004548((uint64_t)a7, a8, a9, (uint64_t *)&v22);
          if (!result) {
            *a10 = v22;
          }
        }
                ...
                if (a9 && a10 && a2 >= 0x10)
                {
                  ...
                  *a3 = *(_OWORD *)a1;
                  ...
                  else
                  {
                    ...
                    unint64_t v40 = 20;
                    __int16 v19 = sub_100003FF0(v18);
                    sub_100004128("<data>", v19, v18, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 722, "DeserializeProcessAcl");
                    if (v19)
                    {
                      if (v17 - 20 < v18
                      ...
                      else
                      {
                        ...
                        unint64_t v24 = v15;
                        size_t v25 = v20;
                        BOOL v26 = sub_100003FF0(v20);
                        sub_100004128("<data>", v26, v25, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 734, "DeserializeProcessAcl");
                        if (v26)
                        {
                          int v27 = v26;
...
LABEL_20:
                            ...
                            else
                            {
                              ...
                              unint64_t v40 = v21 + 4;
                              uint64_t v10 = sub_100004888(a1, v17, &v40, &v39, &v38);
                              if (!v10)
                              {
...
LABEL_32:
                      sub_1000041D4("<data>", v19, v18, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 763, "DeserializeProcessAcl");
                      sub_100004038(v19, v18);
                      if (v32)
                      {
                        sub_1000041D4("<data>", v32, v37, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 766, "DeserializeProcessAcl");
                        sub_100004038(v32, v37);
                      }
                      goto LABEL_34;
                    }
                    uint64_t v10 = 4294967292;
          ...
          if (v7 == *((_DWORD *)__s2 + 7))
          {
            ...
            switch(*(_DWORD *)__s1)
            {
              ...
              case 7:
                ...
                BOOL v9 = sub_10000611C((unint64_t)(__s1 + 4), 0x20uLL, (unint64_t)(__s2 + 4), 32);
                if (!v9) {
                  goto LABEL_100;
                }
              ...
              case 0xA:
                ...
                BOOL v9 = sub_10000611C((unint64_t)__s1 + 36, 0x10uLL, (unint64_t)__s2 + 36, 16);
                if (!v9) {
                  goto LABEL_100;
                }
...
LABEL_8:
              ...
              case 0x15:
                ...
                uint64_t v22 = 128;
LABEL_103:
                LOBYTE(v9) = sub_10000611C((unint64_t)v13, v21, (unint64_t)v14, v22);
                goto LABEL_100;
              default:
                return v3;
            }
...
BOOL sub_10000611C(unint64_t __s1, size_t __n, unint64_t __s2, uint64_t a4)
{
  if (__n != a4) {
    return 0;
  }
    ...
    if (a3)
    {
      if (a4)
      {
        ...
        if (v8 <= 0x3E8)
        {
          if (v8)
          {
            uint64_t v10 = (char *)sub_10000408C(8 * v8);
            sub_100004128("array of ACMCredentialRef", v10, 8 * v8, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 1778, "DeserializeCredentialList");
            if (v10)
            {
              uint64_t v11 = 0;
              uint64_t v12 = 4;
...
void DeallocCredentialList(_DWORD **a1, unsigned int a2)
{
  if (a1)
  {
    ...
    unint64_t v6 = 8 * v3;
    sub_1000041D4("array of ACMCredentialRef", a1, v6, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibSerialization.c", 1816, "DeallocCredentialList");
    sub_1000040D4(a1, v6);
  }
}
...
uint64_t LibSer_StorageSetData_GetSize(uint64_t a1, _DWORD *a2, unsigned int a3, void *a4)
{
  ...
  uint64_t result = sub_100004318(a2, a3, &v7);
  if (!result) {
    *a4 = a1 + v7 + 28;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a7)
      {
        ...
        {
          unsigned int v18 = 0;
          uint64_t result = sub_100004318(a5, a6, &v18);
          if (!result)
          {
            if (*a8 < a4 + v18 + 28)
            {
            ...
            else
            {
              ...
              *(_DWORD *)(a7 + 20) = a4;
              ...
              size_t v17 = a4 + 24;
              uint64_t result = sub_100004548((uint64_t)a5, a6, a7, (uint64_t *)&v17);
              if (!result) {
                *a8 = v17;
              }
            }
...
uint64_t LibSer_StorageSetData_Deserialize(uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, void *a5, void *a6, void *a7, _DWORD *a8)
{
  ...
  if (a1 && a2 >= 0x18 && a6 && a3 && a4 && a5 && a7 && a8)
  {
    ...
    *a6 = v11;
    ...
    return sub_100004888(a1, a2, v14, a7, a8);
  }
  return v10;
}
...
uint64_t LibSer_StorageGetData_GetSize(_DWORD *a1, unsigned int a2, void *a3)
{
  ...
  uint64_t result = sub_100004318(a1, a2, &v5);
  if (!result) {
    *a3 = v5 + 25;
  }
  return result;
  ...
  if (a1)
  {
    if (a2)
    {
      if (a6)
      {
        ...
        {
          unsigned int v16 = 0;
          uint64_t result = sub_100004318(a4, a5, &v16);
          if (!result)
          {
            ...
            else
            {
              ...
              *(unsigned char *)(a6 + 20) = a3;
              uint64_t v15 = 21;
              uint64_t result = sub_100004548((uint64_t)a4, a5, a6, &v15);
              if (!result) {
                *a7 = v15;
              }
            }
...
uint64_t LibSer_StorageGetData_Deserialize(uint64_t a1, unint64_t a2, _OWORD *a3, _DWORD *a4, BOOL *a5, void *a6, _DWORD *a7)
{
  ...
  if (a1 && a2 >= 0x15 && a3 && a4 && a5)
  {
    ...
    *a5 = *(unsigned char *)(a1 + 20) != 0;
    v11[0] = 21;
    return sub_100004888(a1, a2, v11, a6, a7);
  }
  return v9;
}
...
uint64_t LibSer_GetUnlockSecret_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, _OWORD *a4, void *a5)
{
  ...
  if (a1)
  {
    if (a4)
    {
      ...
      {
        unsigned int v12 = 0;
        uint64_t result = sub_100004318(a2, a3, &v12);
        if (!result)
        {
          ...
          else
          {
            *a4 = *a1;
            uint64_t v11 = 16;
            uint64_t result = sub_100004548((uint64_t)a2, a3, (uint64_t)a4, &v11);
            if (!result) {
              *a5 = v11;
            }
          }
...
uint64_t LibSer_GetUnlockSecret_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5)
{
  ...
  if (a2 >= 0x10 && a3 && a4)
  {
    if (a5)
    {
      ...
      *a3 = *a1;
      v9[0] = 16;
      return sub_100004888((uint64_t)a1, a2, v9, a4, a5);
    }
  }
  return result;
}
...
uint64_t LibSer_SEPControl_Serialize(_OWORD *a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6, void *a7)
{
  ...
  if (a6)
  {
    ...
    {
      unsigned int v18 = 0;
      uint64_t result = sub_100004318(a2, a3, &v18);
      if (!result)
      {
        if (*a7 < a5 + v18 + 24)
        {
        ...
        else
        {
          ...
          uint64_t v17 = 16;
          uint64_t result = sub_100004548((uint64_t)a2, a3, a6, &v17);
          if (!result)
          {
            uint64_t v15 = v17;
            *(_DWORD *)(a6 + v17) = a5;
...
uint64_t LibSer_SEPControl_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5, unint64_t *a6, void *a7)
{
  ...
  if (a2 >= 0x18 && a7 && a3 && a4 && a5 && a6)
  {
    *a3 = *a1;
    unint64_t v12 = 16;
    uint64_t result = sub_100004888((uint64_t)a1, a2, &v12, a4, a5);
    if (!result)
    {
...
uint64_t sub_1000072FC(_DWORD *a1)
{
  if (!a1) {
    return 4294967293;
  }
...
uint64_t LibCall_ACMGetEnvironmentVariable_Block(uint64_t (*a1)(uint64_t, uint64_t, void, int *, uint64_t, uint64_t, uint64_t), uint64_t a2, int a3, uint64_t a4)
{
  ...
  if (a3 == 36)
  {
    int v8 = sub_100003FF0(0x800uLL);
    sub_100004128("<data>", v8, 2048, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCallBlock.c", 162, "LibCall_ACMGetEnvironmentVariable_Block");
    if (!v8)
    {
      unsigned int v12 = 70;
    ...
    if (!v9)
    {
      ...
      sub_1000041D4("<data>", v8, 0x800uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCallBlock.c", 176, "LibCall_ACMGetEnvironmentVariable_Block");
      sub_100004038(v8, 0x800uLL);
LABEL_16:
      unsigned int v12 = 10;
      goto LABEL_17;
    }
...
{
  return sub_100008298(a1, a2, 0xBu, a3, a4, a5, 0, 0, a6, a7, a8, a9, a10);
}

uint64_t sub_100008298(uint64_t result, uint64_t a2, unsigned __int8 a3, _OWORD *a4, const void *a5, uint64_t a6, const void *a7, unsigned int a8, unsigned __int8 a9, _DWORD *a10, unsigned int a11, unsigned int a12, uint64_t a13)
{
...
{
  return sub_100008298(a1, a2, 0x20u, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);
}
  ...
  if (a1)
  {
    ...
    if (a2)
    {
      ...
      do
      {
        ...
        {
          unint64_t v7 = *v4;
          sub_1000041D4("<data>", *((const void **)v4 - 1), v7, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 118, "Util_SafeDeallocParameters");
          sub_100004038(v6, v7);
        }
        v4 += 6;
        --v5;
    ...
    sub_1000041D4("array of ACMParameter", a1, 24 * v3, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 121, "Util_SafeDeallocParameters");
    sub_1000040D4(a1, 24 * v3);
  }
}
  ...
  if (a1)
  {
    ...
    switch(*a1)
    {
      ...
      case 0x15:
        ...
        int v8 = 177;
LABEL_6:
        sub_1000041D4(v4, v6, v7, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", v8, "Util_DeallocCredential");
        sub_1000040D4(a1, v5);
        uint64_t v2 = 0;
        unsigned int v3 = 10;
        break;
...
uint64_t Util_AllocCredential(int a1, void *a2)
{
  ...
  {
    case 1:
      rsize_t v5 = sub_10000408C(0x3CuLL);
      sub_100004128("ACMCredential - ACMCredentialDataPasscodeValidated", v5, 60, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 226, "Util_AllocCredential");
      int v6 = 28;
      goto LABEL_4;
    case 2:
      rsize_t v5 = sub_10000408C(0xA8uLL);
      sub_100004128("ACMCredential - ACMCredentialDataPassphraseEntered", v5, 168, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 216, "Util_AllocCredential");
      int v6 = 136;
      goto LABEL_4;
    case 3:
      rsize_t v5 = sub_10000408C(0x151uLL);
      sub_100004128("ACMCredential - ACMCredentialDataBiometryMatched", v5, 337, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 221, "Util_AllocCredential");
      int v6 = 305;
      goto LABEL_4;
    case 4:
    case 5:
    ...
    case 22:
    case 23:
      rsize_t v5 = sub_10000408C(0x20uLL);
      sub_100004128("ACMCredential", v5, 32, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 280, "Util_AllocCredential");
      int v6 = 0;
      goto LABEL_4;
    case 7:
      rsize_t v5 = sub_10000408C(0x58uLL);
      sub_100004128("ACMCredential - ACMCredentialDataUserOutputDisplayed", v5, 88, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 236, "Util_AllocCredential");
      int v6 = 56;
      goto LABEL_4;
    case 9:
      rsize_t v5 = sub_10000408C(0x38uLL);
      sub_100004128("ACMCredential - ACMCredentialDataContinuityUnlock", v5, 56, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 241, "Util_AllocCredential");
      int v6 = 24;
      goto LABEL_4;
    case 10:
      rsize_t v5 = sub_10000408C(0x54uLL);
      sub_100004128("ACMCredential - ACMCredentialDataPasscodeValidated2", v5, 84, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 231, "Util_AllocCredential");
      int v6 = 52;
      goto LABEL_4;
    case 12:
    case 15:
      rsize_t v5 = sub_10000408C(0x28uLL);
      sub_100004128("ACMCredential - ACMCredentialDataKextDenyList", v5, 40, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 247, "Util_AllocCredential");
      int v6 = 8;
      goto LABEL_4;
    case 13:
      rsize_t v5 = sub_10000408C(0xA4uLL);
      unint64_t v7 = "ACMCredential - ACMCredentialDataPassphraseExtractable";
      int v8 = v5;
      int v9 = 211;
      goto LABEL_18;
    case 17:
      rsize_t v5 = sub_10000408C(0x71uLL);
      sub_100004128("ACMCredential - ACMCredentialDataSecureIntent", v5, 113, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 252, "Util_AllocCredential");
      int v6 = 81;
      goto LABEL_4;
    case 18:
      rsize_t v5 = sub_10000408C(0x34uLL);
      sub_100004128("ACMCredential - ACMCredentialDataBiometryMatchAttempted", v5, 52, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 257, "Util_AllocCredential");
      int v6 = 20;
      goto LABEL_4;
    case 20:
      rsize_t v5 = sub_10000408C(0x40uLL);
      sub_100004128("ACMCredential - ACMCredentialDataAP", v5, 64, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 262, "Util_AllocCredential");
      int v6 = 32;
      goto LABEL_4;
    case 21:
      rsize_t v5 = sub_10000408C(0xA4uLL);
      ...
      int v9 = 267;
LABEL_18:
      sub_100004128(v7, v8, 164, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", v9, "Util_AllocCredential");
      int v6 = 132;
LABEL_4:
      if (v5)
      {
  ...
  if (a3)
  {
    ...
    switch(a1)
    {
      ...
      case 2:
        ...
        goto LABEL_49;
      case 3:
        int v8 = sub_10000408C(0xACuLL);
        sub_100004128("ACMRequirement - ACMRequirementDataBiometryMatched", v8, 172, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 348, "Util_AllocRequirement");
        int v9 = 156;
        if (!v8) {
          goto LABEL_50;
        }
      ...
      case 5:
        ...
        int v16 = 398;
LABEL_28:
        sub_100004128(v14, v15, 100, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", v16, "Util_AllocRequirement");
        int v9 = 84;
        if (!v8) {
          goto LABEL_50;
        }
      ...
      case 27:
      case 28:
        int v8 = sub_10000408C(0x10uLL);
        sub_100004128("ACMRequirement", v8, 16, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 333, "Util_AllocRequirement");
        int v9 = 0;
        if (v8) {
          goto LABEL_6;
        }
      ...
      case 7:
        ...
        int v8 = sub_10000408C(0x68uLL);
        sub_100004128("ACMRequirement - ACMRequirementDataKofN", v8, 104, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 391, "Util_AllocRequirement");
        int v9 = 88;
        if (!v8) {
          goto LABEL_50;
        }
        goto LABEL_6;
      case 8:
        int v8 = sub_10000408C(0x410uLL);
        sub_100004128("ACMRequirement - ACMRequirementDataAccessGroups", v8, 1040, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 378, "Util_AllocRequirement");
        int v9 = 1024;
        if (!v8) {
          goto LABEL_50;
        }
        goto LABEL_6;
      case 13:
        int v8 = sub_10000408C(0x30uLL);
        sub_100004128("ACMRequirement - ACMRequirementDataUserOutputDisplayed", v8, 48, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 363, "Util_AllocRequirement");
        int v9 = 32;
        if (!v8) {
          goto LABEL_50;
        }
      ...
      case 21:
        ...
        int v13 = 358;
LABEL_49:
        sub_100004128(v11, v12, 20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", v13, "Util_AllocRequirement");
        int v9 = 4;
        if (!v8) {
          goto LABEL_50;
        }
        goto LABEL_6;
      case 24:
        int v8 = sub_10000408C(0x434uLL);
        sub_100004128("ACMRequirement - ACMRequirementDataAP", v8, 1076, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 368, "Util_AllocRequirement");
        int v9 = 1060;
        if (!v8) {
          goto LABEL_50;
        }
        goto LABEL_6;
      case 25:
        int v8 = sub_10000408C(0x3BuLL);
        sub_100004128("ACMRequirement - ACMRequirementDataKeyRef", v8, 59, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 373, "Util_AllocRequirement");
        int v9 = 43;
        if (!v8) {
          goto LABEL_50;
        }
        goto LABEL_6;
      case 26:
        int v8 = sub_10000408C(0x2CuLL);
        sub_100004128("ACMRequirement - ACMRequirementDataRatchet", v8, 44, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 384, "Util_AllocRequirement");
        int v9 = 28;
        if (!v8)
        {
LABEL_50:
      ...
      default:
        switch(a1)
        {
          case 1000:
            ...
            int v8 = sub_10000408C(0x88uLL);
            sub_100004128("ACMRequirement - ACMRequirementDataKofNWithAttributes", v8, 136, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 414, "Util_AllocRequirement");
            int v9 = 120;
            if (!v8) {
              goto LABEL_50;
            }
            goto LABEL_6;
          case 1001:
            int v8 = sub_10000408C(0xB8uLL);
            sub_100004128("ACMRequirement - ACMRequirementDataBiometryMatchedWithAttributes", v8, 184, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 419, "Util_AllocRequirement");
            int v9 = 168;
            if (!v8) {
              goto LABEL_50;
            }
          ...
          case 1003:
            ...
            goto LABEL_49;
          case 1004:
            int v8 = sub_10000408C(0x20uLL);
            sub_100004128("ACMRequirement - ACMRequirementDataPasscodeValidatedWithAttributes", v8, 32, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", 434, "Util_AllocRequirement");
            int v9 = 16;
            if (!v8) {
              goto LABEL_50;
            }
...
LABEL_25:
  ...
  switch(v2)
  {
    ...
    case 26:
      ...
      int v13 = 579;
LABEL_27:
      sub_1000041D4(v9, v11, v12, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/CommonUtil.c", v13, "Util_DeallocRequirement");
      sub_1000040D4(a1, v10);
      uint64_t v7 = 0;
      unsigned int v8 = 10;
      break;
    default:
...
{
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
  ...
  uint64_t v6 = 0;
  uint64_t v2 = LibCall_ACMContextCreate((uint64_t (*)(uint64_t, uint64_t, void, void, void, unsigned char *, uint64_t *))sub_100009FC4, (uint64_t)&v6, a1, &byte_10001C34A, 1);
  if (v2)
  {
    sub_10000F0C0();
    unsigned int v3 = 70;
  ...
  if (v3 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    unsigned int v8 = "ACMLib";
    __int16 v9 = 2080;
...
uint64_t sub_100009FC4(uint64_t *a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315394;
  ...
  if (a1)
  {
    ...
    {
      uint64_t v16 = sub_10000A9A0(*a1, a2, a3, a4, a5, a6, a7);
      if (v16) {
        unsigned int v15 = 70;
      }
      else {
  ...
  if (v15 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v18 = 136315650;
    uint64_t v19 = "ACMLib";
    __int16 v20 = 2080;
...
_DWORD *ACMContextCreateWithExternalForm(_OWORD *a1, uint64_t a2)
{
  ...
  uint64_t v8 = 0;
  uint64_t v4 = LibCall_ACMContextCreateWithExternalForm((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, uint64_t, void *, uint64_t *))sub_100009FC4, (uint64_t)&v8, a1, a2, &byte_10001C34A, 1);
  if (v4)
  {
    if (byte_10001C34A <= 0x28u && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
    {
      int v5 = v4[4];
      *(_DWORD *)buf = 136315650;
      rsize_t v10 = "ACMLib";
  ...
  if (v6 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    rsize_t v10 = "ACMLib";
    __int16 v11 = 2080;
...
{
  unsigned int v4 = byte_10001C34A;
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    uint64_t v12 = "ACMLib";
  ...
  rsize_t v10 = a1;
  uint64_t v7 = LibCall_ACMContextDelete((void (*)(uint64_t, uint64_t, void, void *, uint64_t, void, void))sub_100009FC4, (uint64_t)&v10, a1, a2);
  if (v7) {
    unsigned int v8 = 70;
  }
  else {
  ...
  if (v8 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
...
void ACMContextGetExternalForm(const void *a1, uint64_t a2)
{
  ...
  if (!a1
    || !a2
    || sub_10000A7BC()
    || sub_10000A9A0((uint64_t)a1, 19, 0, a1, 0x10uLL, 0, 0))
  {
...
uint64_t sub_10000A7BC()
{
  ...
  else
  {
    ...
    uint64_t v0 = IOServiceOpen(MatchingService, mach_task_self_, 0, (io_connect_t *)&dword_10001C390);
    if (v0)
    {
      unsigned int v4 = 70;
      goto LABEL_10;
  ...
  unsigned int v4 = 10;
LABEL_10:
  if (v4 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v6 = 136315650;
    uint64_t v7 = "ACMLib";
    __int16 v8 = 2080;
...
uint64_t sub_10000A9A0(uint64_t a1, int a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
  ...
  if (v14)
  {
    ...
    else
    {
      ...
      size_t v22 = v16;
      uint64_t v17 = IOConnectCallStructMethod(dword_10001C390, 0, v14, inputStructCnt, a6, &v22);
      uint64_t v18 = v17;
      if (a1) {
    ...
    sub_1000041D4("<data>", v15, inputStructCnt, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 134, "performCommand");
    sub_100004038(v15, v19);
    if (v18) {
      unsigned int v20 = 70;
    }
    else {
  ...
  if (v20 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    size_t v25 = "ACMLib";
    __int16 v26 = 2080;
...
uint64_t ACMContextAddCredentialWithScope(_OWORD *a1, unsigned int *a2, int a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedAddCredentialSize = sub_10000A7BC();
    ...
    {
      size_t v11 = size;
      uint64_t v12 = sub_100003FF0(size);
      sub_100004128("<data>", v12, v11, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 325, "ACMContextAddCredentialWithScope");
      if (v12)
      {
        uint64_t v13 = SerializeAddCredential(a1, a2, a3, (uint64_t)v12, &size);
        if (!v13) {
          uint64_t v13 = sub_10000A9A0((uint64_t)a1, 5, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        size_t v14 = size;
        sub_1000041D4("<data>", v12, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 338, "ACMContextAddCredentialWithScope");
        sub_100004038(v12, v14);
        if (v9) {
          unsigned int v8 = 70;
        }
        else {
...
uint64_t ACMContextRemoveCredentialsByTypeAndScope(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1 || a3 == 2)
  {
    ...
    {
      __int16 v7 = sub_100003FF0(0x18uLL);
      sub_100004128("<data>", v7, 24, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 386, "ACMContextRemoveCredentialsByTypeAndScope");
      if (v7)
      {
        if (a1)
        {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_10000A9A0((uint64_t)a1, 9, 0, v7, 0x18uLL, 0, 0);
        sub_1000041D4("<data>", v7, 0x18uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 407, "ACMContextRemoveCredentialsByTypeAndScope");
        sub_100004038(v7, 0x18uLL);
        if (v8) {
          unsigned int v9 = 70;
        }
        else {
  ...
  if (v9 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v11 = 136315650;
    uint64_t v12 = "ACMLib";
    __int16 v13 = 2080;
...
uint64_t ACMContextRemoveCredentialsByValueAndScope(uint64_t a1, _DWORD *a2, uint64_t a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    ...
    else
    {
      size_t v11 = size;
      uint64_t v12 = sub_100003FF0(size);
      sub_100004128("<data>", v12, v11, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 457, "ACMContextRemoveCredentialsByValueAndScope");
      if (v12)
      {
        uint64_t v13 = SerializeRemoveCredential(a1, a2, a3, v12, &size);
        if (!v13) {
          uint64_t v13 = sub_10000A9A0(a1, 6, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        size_t v14 = size;
        sub_1000041D4("<data>", v12, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 470, "ACMContextRemoveCredentialsByValueAndScope");
        sub_100004038(v12, v14);
        if (v9) {
          unsigned int v8 = 70;
        }
...
uint64_t ACMContextContainsCredentialTypeEx(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1)
  {
    ...
    {
      __int16 v7 = sub_100003FF0(0x18uLL);
      sub_100004128("<data>", v7, 24, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 576, "ACMContextContainsCredentialTypeEx");
      unsigned int v8 = 70;
      if (v7)
      {
        *(_OWORD *)__int16 v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_10000A9A0((uint64_t)a1, 4, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
        ...
        sub_1000041D4("<data>", v7, 0x18uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 590, "ACMContextContainsCredentialTypeEx");
        sub_100004038(v7, 0x18uLL);
        if (v11) {
          unsigned int v8 = 70;
        }
...
uint64_t ACMContextRemovePassphraseCredentialsByPurposeAndScope(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1 || a3 == 2)
  {
    ...
    {
      __int16 v7 = sub_100003FF0(0x18uLL);
      sub_100004128("<data>", v7, 24, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 492, "ACMContextRemovePassphraseCredentialsByPurposeAndScope");
      if (v7)
      {
        if (a1)
        {
        ...
        *((_DWORD *)v7 + 4) = a2;
        *((_DWORD *)v7 + 5) = a3;
        uint64_t v8 = sub_10000A9A0((uint64_t)a1, 16, 0, v7, 0x18uLL, 0, 0);
        sub_1000041D4("<data>", v7, 0x18uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 513, "ACMContextRemovePassphraseCredentialsByPurposeAndScope");
        sub_100004038(v7, 0x18uLL);
        if (v8) {
          unsigned int v9 = 70;
        }
...
uint64_t ACMContextReplacePassphraseCredentialsWithScope(uint64_t a1, _DWORD *a2, uint64_t a3)
{
  ...
  if (a2 && (v7 & 1) == 0)
  {
    uint64_t SerializedReplacePassphraseCredentialSize = sub_10000A7BC();
    ...
    else
    {
      size_t v11 = size;
      uint64_t v12 = sub_100003FF0(size);
      sub_100004128("<data>", v12, v11, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 538, "ACMContextReplacePassphraseCredentialsWithScope");
      if (v12)
      {
        uint64_t v13 = SerializeReplacePassphraseCredential(a1, a2, a3, v12, &size);
        if (!v13) {
          uint64_t v13 = sub_10000A9A0(a1, 15, 0, v12, size, 0, 0);
        }
        uint64_t v9 = v13;
        bzero(v12, size);
        size_t v14 = size;
        sub_1000041D4("<data>", v12, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 552, "ACMContextReplacePassphraseCredentialsWithScope");
        sub_100004038(v12, v14);
        if (v9) {
          unsigned int v8 = 70;
        }
...
uint64_t ACMContextContainsPassphraseCredentialWithPurpose(_OWORD *a1, int a2, int a3)
{
  ...
  if (a1)
  {
    ...
    {
      char v7 = sub_100003FF0(0x18uLL);
      sub_100004128("<data>", v7, 24, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 614, "ACMContextContainsPassphraseCredentialWithPurpose");
      unsigned int v8 = 70;
      if (v7)
      {
        *(_OWORD *)char v7 = *a1;
        v7[4] = a2;
        v7[5] = a3;
        unsigned int v9 = sub_10000A9A0((uint64_t)a1, 13, 0, v7, 0x18uLL, &v14, &v13);
        if (v14) {
          unsigned int v10 = 0;
        }
        else {
        ...
        sub_1000041D4("<data>", v7, 0x18uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 628, "ACMContextContainsPassphraseCredentialWithPurpose");
        sub_100004038(v7, 0x18uLL);
        if (v11) {
          unsigned int v8 = 70;
        }
...
uint64_t ACMContextVerifyPolicy(_OWORD *a1, char *a2, uint64_t a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextVerifyPolicy_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_100009FC4, (uint64_t)&v9, a1, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
  ...
  if (v7 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v11 = "ACMLib";
    __int16 v12 = 2080;
...
uint64_t ACMContextVerifyPolicyWithPreflight(_OWORD *a1, char *__s1, uint64_t a3, uint64_t a4)
{
  ...
  uint64_t v11 = a1;
  uint64_t v8 = LibCall_ACMContextVerifyPolicyWithPreflight_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_100009FC4, (uint64_t)&v11, a1, __s1, a3, a4);
  if (v8) {
    unsigned int v9 = 70;
  }
  else {
...
void ACMContextVerifyPolicyEx(_OWORD *a1, char *__s1, uint64_t a3, _DWORD *a4, unsigned int a5, uint64_t a6, uint64_t a7)
{
  ...
  __int16 v14 = a1;
  LibCall_ACMContextVerifyPolicyEx_Block((uint64_t (*)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *))sub_100009FC4, (uint64_t)&v14, a1, __s1, a3, a4, a5, a6, a7);
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    __int16 v16 = "ACMLib";
...
{
  unsigned int v9 = a1;
  return LibCall_ACMContextVerifyAclConstraint((uint64_t)sub_100009FC4, (uint64_t)&v9, a1, a2, a3, a4, a5, a6, a7, a8);
}
...
{
  uint64_t v11 = a1;
  return LibCall_ACMContextVerifyAclConstraintForOperation((uint64_t)sub_100009FC4, (uint64_t)&v11, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
}
...
uint64_t ACMParseAclAndCopyConstraintCharacteristics(const void *a1, uint64_t a2, uint64_t a3)
{
  ...
  uint64_t SerializedProcessAclSize = sub_10000A7BC();
...
LABEL_28:
  ...
  size_t v8 = size;
  unsigned int v9 = sub_100003FF0(size);
  sub_100004128("<data>", v9, v8, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 744, "ACMParseAclAndCopyConstraintCharacteristics");
  if (!v9)
  {
    uint64_t v6 = 4294967292;
    goto LABEL_28;
  ...
  size_t v11 = 4096;
  __int16 v12 = sub_100003FF0(0x1000uLL);
  sub_100004128("<data>", v12, 4096, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 750, "ACMParseAclAndCopyConstraintCharacteristics");
  if (!v12)
  {
    __int16 v14 = 0;
LABEL_31:
  ...
  uint64_t v13 = sub_10000A9A0(0, 20, 0, v9, size, v12, &__n);
  size_t v11 = __n;
  if (v13)
  {
    uint64_t v6 = v13;
  ...
  __int16 v14 = sub_100003FF0(__n);
  sub_100004128("<data>", v14, v11, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 756, "ACMParseAclAndCopyConstraintCharacteristics");
  size_t v11 = __n;
  if (!v14) {
    goto LABEL_31;
  }
...
LABEL_15:
  ...
  size_t v15 = size;
  sub_1000041D4("<data>", v9, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 767, "ACMParseAclAndCopyConstraintCharacteristics");
  sub_100004038(v9, v15);
  if (v12)
  {
    sub_1000041D4("<data>", v12, 0x1000uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 770, "ACMParseAclAndCopyConstraintCharacteristics");
    sub_100004038(v12, 0x1000uLL);
  }
  if (v14)
  {
    size_t v16 = __n;
    sub_1000041D4("<data>", v14, __n, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 773, "ACMParseAclAndCopyConstraintCharacteristics");
    sub_100004038(v14, v16);
  }
LABEL_19:
  if (v6) {
    unsigned int v17 = 70;
  ...
  if (v17 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315650;
    uint64_t v22 = "ACMLib";
    __int16 v23 = 2080;
...
LABEL_13:
  ...
  if (v5 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    int v8 = 136315650;
    unint64_t v9 = "ACMLib";
    __int16 v10 = 2080;
...
void ACMGetAclAuthMethod(__n128 *a1, uint64_t a2)
{
  ...
  uint64_t v4 = a1;
  LibCall_ACMGetAclAuthMethod_Block((uint64_t)sub_100009FC4, (uint64_t)&v4, a1, a2);
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v6 = "ACMLib";
...
uint64_t ACMSetEnvironmentVariable(int a1, const void *a2, size_t a3)
{
  ...
  uint64_t v9 = 0;
  uint64_t v6 = LibCall_ACMSetEnvironmentVariable((uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_100009FC4, (uint64_t)&v9, a1, 0, 0, 0, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
...
uint64_t ACMSetEnvironmentVariableWithAccessPolicy(int a1, _OWORD *a2, _OWORD *a3, uint64_t a4, const void *a5, size_t a6)
{
  ...
  uint64_t v15 = 0;
  uint64_t v12 = LibCall_ACMSetEnvironmentVariable((uint64_t (*)(uint64_t, uint64_t, void, char *, size_t, void, void))sub_100009FC4, (uint64_t)&v15, a1, a2, a3, a4, a5, a6);
  if (v12) {
    unsigned int v13 = 70;
  }
  else {
  ...
  if (v13 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315906;
    int v17 = "ACMLib";
    __int16 v18 = 2080;
...
uint64_t ACMGetEnvironmentVariable(int a1, uint64_t a2)
{
  ...
  uint64_t v7 = 0;
  uint64_t v4 = LibCall_ACMGetEnvironmentVariable_Block((uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, uint64_t, uint64_t))sub_100009FC4, (uint64_t)&v7, a1, a2);
  if (v4) {
    unsigned int v5 = 70;
  }
  else {
...
uint64_t ACMKernelControl(int a1)
{
  ...
  uint64_t v2 = LibCall_ACMKernelControl_Block((uint64_t)sub_100009FC4);
  if (v2) {
    unsigned int v3 = 70;
  }
  else {
...
{
  uint64_t v4 = 0;
  return LibCall_ACMSEPControl_Block((uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_100009FC4, (uint64_t)&v4, a1, a2, 0, 0, 0, a3);
}

uint64_t ACMSEPControlEx(uint64_t a1, _DWORD *a2, unsigned int a3, const void *a4, size_t a5, uint64_t a6)
{
  uint64_t v7 = 0;
  return LibCall_ACMSEPControl_Block((uint64_t (*)(uint64_t, uint64_t, void, char *, uint64_t, unsigned int *, unint64_t *))sub_100009FC4, (uint64_t)&v7, a4, a5, a1, a2, a3, a6);
}
...
void ACMGlobalContextCredentialGetProperty(int a1, int a2, uint64_t a3)
{
  ...
  uint64_t v6 = 0;
  LibCall_ACMGlobalContextCredentialGetProperty_Block((uint64_t)sub_100009FC4, (uint64_t)&v6, a1, a2, a3);
  if (byte_10001C34A <= 0xAu && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    int v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, uint64_t a4)
{
  ...
  {
    __int16 v9 = a1;
    uint64_t v8 = LibCall_ACMContextCredentialGetProperty((uint64_t (*)(uint64_t, uint64_t, void, __n128 *, uint64_t, uint64_t, uint64_t, __n128))sub_100009FC4, (uint64_t)&v9, a1, a2, a3, (uint64_t)buf, (uint64_t)&v10);
...
uint64_t ACMContextSetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, const void *a5, size_t a6)
{
  ...
  __int16 v15 = a1;
  uint64_t v12 = LibCall_ACMContextSetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, void, void))sub_100009FC4, (uint64_t)&v15, a1, a2, a3, a4, a5, a6);
  if (v12) {
    unsigned int v13 = 70;
  }
  else {
...
uint64_t ACMContextGetDataEx(_OWORD *a1, int a2, _DWORD *a3, unsigned int a4, uint64_t a5)
{
  ...
  uint64_t v21 = 4;
  __int16 v19 = a1;
  uint64_t v10 = LibCall_ACMContextGetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_100009FC4, (uint64_t)&v19, a1, a2, 1, a3, a4, (uint64_t)&size, (uint64_t)&v21);
  if (!v10)
  {
    uint64_t v11 = size;
    if (size)
    {
      uint64_t v12 = sub_100003FF0(size);
      sub_100004128("<data>", v12, v11, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 1199, "ACMContextGetDataEx");
      if (!v12)
      {
        unsigned int v16 = 70;
      ...
      uint64_t v20 = size;
      __int16 v18 = a1;
      uint64_t v13 = LibCall_ACMContextGetData((uint64_t (*)(uint64_t, uint64_t, void, void *, size_t, uint64_t, uint64_t))sub_100009FC4, (uint64_t)&v18, a1, a2, 0, a3, a4, (uint64_t)v12, (uint64_t)&v20);
      uint64_t v14 = v13;
      if (a5 && !v13) {
        (*(void (**)(uint64_t, void *, uint64_t))(a5 + 16))(a5, v12, v20);
      }
      rsize_t v15 = size;
      sub_1000041D4("<data>", v12, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/ACMLib/ACMLib.c", 1213, "ACMContextGetDataEx");
      sub_100004038(v12, v15);
      if (v14) {
        goto LABEL_11;
      }
    }
...
LABEL_11:
  unsigned int v16 = 70;
LABEL_15:
  if (v16 >= byte_10001C34A && os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
...
uint64_t ACMContextGetInfo(long long *a1, int a2, void *a3)
{
  ...
  unsigned int v9 = a1;
  uint64_t v6 = LibCall_ACMContextGetInfo((uint64_t (*)(uint64_t, uint64_t, void, int *, uint64_t, _OWORD *, unint64_t *))sub_100009FC4, (uint64_t)&v9, a1, a2, a3);
  if (v6) {
    unsigned int v7 = 70;
  }
  else {
...
{
  uint64_t v1 = 0;
  return LibCall_ACMPing((uint64_t (*)(uint64_t, uint64_t, void, void, void, void, void))sub_100009FC4, (uint64_t)&v1, 29);
}
...
void sub_10000F0C0()
{
  ...
  if (IOConnectCallScalarMethod(dword_10001C390, 2u, 0, 0, &output, &outputCnt)) {
    goto LABEL_8;
  }
  unsigned __int8 v0 = output;
  unsigned int v1 = output;
  byte_10001C34A = output;
...
LABEL_8:
    unsigned int v1 = byte_10001C34A;
  }
...
unsigned char *LibCall_BuildCommand(char a1, char a2, char a3, const void *a4, size_t a5, void *a6)
{
  ...
  if (!v13 && a6)
  {
    ...
    {
      __int16 v12 = sub_100003FF0(a5 + 8);
      sub_100004128("<data>", v12, a5 + 8, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 22, "LibCall_BuildCommand");
      if (v12)
      {
        *a6 = a5 + 8;
...
uint64_t LibCall_ACMContextCreate(uint64_t (*a1)(uint64_t, uint64_t, void, void, void, unsigned char *, uint64_t *), uint64_t a2, void *a3, unsigned char *a4, int a5)
{
  ...
  __int16 v12 = sub_10000408C(0x14uLL);
  sub_100004128("ACMHandleWithPayload", v12, 20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 50, "LibCall_ACMContextCreate");
  if (!v12)
  {
    unsigned int v10 = 70;
    uint64_t v11 = 4294967292;
  ...
  if (a5)
  {
    ...
    {
LABEL_23:
      sub_1000041D4("ACMHandleWithPayload", v12, 0x14uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 89, "LibCall_ACMContextCreate");
      sub_1000040D4(v12, 0x14uLL);
      unsigned int v10 = 70;
      goto LABEL_25;
    }
  }
...
LABEL_19:
      ...
      {
        __int16 v12 = sub_10000408C(0x14uLL);
        sub_100004128("ACMHandleWithPayload", v12, 20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 128, "LibCall_ACMContextCreateWithExternalForm");
        if (!v12)
        {
          unsigned int v13 = 70;
          int v14 = -4;
        ...
        *(_OWORD *)__int16 v12 = *a3;
        ...
        if (v14)
        {
          sub_1000041D4("ACMHandleWithPayload", v12, 0x14uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 147, "LibCall_ACMContextCreateWithExternalForm");
          sub_1000040D4(v12, 0x14uLL);
LABEL_29:
          unsigned int v13 = 70;
          goto LABEL_31;
...
uint64_t LibCall_ACMContextDelete(void (*a1)(uint64_t, uint64_t, void, void *, uint64_t, void, void), uint64_t a2, void *a3, int a4)
{
  ...
  {
LABEL_7:
    sub_1000041D4("ACMHandleWithPayload", a3, 0x14uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 172, "LibCall_ACMContextDelete");
    sub_1000040D4(a3, 0x14uLL);
    uint64_t v8 = 0;
    unsigned int v9 = 10;
    goto LABEL_8;
  }
...
uint64_t LibCall_ACMContexAddCredentialWithScope(uint64_t (*a1)(uint64_t, uint64_t, void, void *, size_t, void, void), uint64_t a2, _OWORD *a3, unsigned int *a4, int a5)
{
  ...
  if (a4 && (v11 & 1) == 0)
  {
    ...
    {
      size_t v15 = size;
      int v16 = sub_100003FF0(size);
      sub_100004128("<data>", v16, v15, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 192, "LibCall_ACMContexAddCredentialWithScope");
      if (v16)
      {
        ...
        uint64_t v13 = v17;
        size_t v18 = size;
        sub_1000041D4("<data>", v16, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 203, "LibCall_ACMContexAddCredentialWithScope");
        sub_100004038(v16, v18);
        if (v13) {
          unsigned int v12 = 70;
        }
        else {
...
uint64_t LibCall_ACMContexRemoveCredentialsByTypeAndScope(uint64_t (*a1)(uint64_t, uint64_t, void, _OWORD *, uint64_t, void, void), uint64_t a2, _OWORD *a3, int a4, int a5)
{
  ...
  if (a3 || a5 == 2)
  {
    BOOL v10 = sub_100003FF0(0x18uLL);
    sub_100004128("<data>", v10, 24, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 217, "LibCall_ACMContexRemoveCredentialsByTypeAndScope");
    if (v10)
    {
      if (a3)
      {
      ...
      *((_DWORD *)v10 + 5) = a5;
      ...
      sub_1000041D4("<data>", v10, 0x18uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 233, "LibCall_ACMContexRemoveCredentialsByTypeAndScope");
      sub_100004038(v10, 0x18uLL);
      if (v11) {
        unsigned int v12 = 70;
      }
      else {
...
uint64_t LibCall_ACMContextRemoveCredentialsByValueAndScope(uint64_t (*a1)(uint64_t, uint64_t, void, void *, size_t, void, void), uint64_t a2, uint64_t a3, _DWORD *a4, uint64_t a5)
{
  ...
  if (a4 && (v11 & 1) == 0)
  {
    ...
    else
    {
      size_t v15 = size;
      int v16 = sub_100003FF0(size);
      sub_100004128("<data>", v16, v15, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 251, "LibCall_ACMContextRemoveCredentialsByValueAndScope");
      if (v16)
      {
        ...
        uint64_t v13 = v17;
        size_t v18 = size;
        sub_1000041D4("<data>", v16, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 264, "LibCall_ACMContextRemoveCredentialsByValueAndScope");
        sub_100004038(v16, v18);
        if (v13) {
          unsigned int v12 = 70;
        }
...
uint64_t LibCall_ACMContextVerifyPolicyAndCopyRequirementEx(uint64_t (*a1)(uint64_t, uint64_t, void, _OWORD *, size_t, unsigned int *, unint64_t *), uint64_t a2, _OWORD *a3, char *__s1, uint64_t a5, _DWORD *a6, unsigned int a7, uint64_t a8, BOOL *a9, void *a10)
{
  ...
  if (a1 && a3 && __s1 && a9)
  {
    ...
    else
    {
      ...
      {
        size_t v21 = size;
        __int16 v22 = sub_100003FF0(size);
        sub_100004128("<data>", v22, v21, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 293, "LibCall_ACMContextVerifyPolicyAndCopyRequirementEx");
        if (v22)
        {
          size_t v32 = size;
          ...
          {
            BOOL v24 = (unsigned int *)sub_100003FF0(0x1000uLL);
            sub_100004128("<data>", v24, 4096, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 300, "LibCall_ACMContextVerifyPolicyAndCopyRequirementEx");
            if (v24)
            {
          ...
          size_t v27 = size;
          sub_1000041D4("<data>", v22, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 324, "LibCall_ACMContextVerifyPolicyAndCopyRequirementEx");
          sub_100004038(v22, v27);
          if (v24)
          {
            sub_1000041D4("<data>", v24, 0x1000uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 327, "LibCall_ACMContextVerifyPolicyAndCopyRequirementEx");
            sub_100004038(v24, 0x1000uLL);
          }
          if (v19) {
            unsigned int v18 = 70;
          }
...
LABEL_18:
  ...
  {
    size_t v20 = size;
    long long v21 = sub_100003FF0(size);
    sub_100004128("<data>", v21, v20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1257, "LibCall_ACMContextVerifyPolicyEx");
    if (v21)
    {
      ...
      {
        uint64_t v23 = (unsigned int *)sub_100003FF0(0x1000uLL);
        sub_100004128("<data>", v23, 4096, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1263, "LibCall_ACMContextVerifyPolicyEx");
        if (v23)
        {
      ...
      size_t v26 = size;
      sub_1000041D4("<data>", v21, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1288, "LibCall_ACMContextVerifyPolicyEx");
      sub_100004038(v21, v26);
      if (v23)
      {
        sub_1000041D4("<data>", v23, 0x1000uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1291, "LibCall_ACMContextVerifyPolicyEx");
        sub_100004038(v23, 0x1000uLL);
      }
    }
    else
    {
...
uint64_t LibCall_ACMContextLoadFromImage(uint64_t a1)
{
  ...
  {
    uint64_t v13 = sub_10000408C(0x14uLL);
    sub_100004128("ACMHandleWithPayload", v13, 20, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1447, "LibCall_ACMContextLoadFromImage");
    if (v13)
    {
      bzero(v21, 0x1005uLL);
      char v20 = 1;
      *(_WORD *)&v21[1] = 6;
      ...
      sub_1000041D4("ACMHandleWithPayload", v13, 0x14uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1508, "LibCall_ACMContextLoadFromImage");
      sub_1000040D4(v13, 0x14uLL);
      unsigned int v11 = 70;
    }
    else
    {
...
uint64_t LibCall_ACMContextSetData(uint64_t (*a1)(uint64_t, uint64_t, void, void *, size_t, void, void), uint64_t a2, _OWORD *a3, int a4, _DWORD *a5, unsigned int a6, const void *a7, size_t a8)
{
  ...
  if (a1 && a3)
  {
    ...
    else
    {
      ...
      {
        size_t v19 = size;
        int v20 = sub_100003FF0(size);
        sub_100004128("<data>", v20, v19, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1593, "LibCall_ACMContextSetData");
        if (v20)
        {
          ...
          uint64_t v17 = v21;
          size_t v22 = size;
          sub_1000041D4("<data>", v20, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1605, "LibCall_ACMContextSetData");
          sub_100004038(v20, v22);
          if (v17) {
            unsigned int v16 = 70;
          }
          else {
    ...
    if (a3)
    {
      ...
      if (a8)
      {
        if (a9)
        {
          ...
          {
            size_t v21 = size;
            size_t v22 = sub_100003FF0(size);
            sub_100004128("<data>", v22, v21, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1628, "LibCall_ACMContextGetData");
            if (v22)
            {
              ...
              size_t v24 = size;
              sub_1000041D4("<data>", v22, size, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1640, "LibCall_ACMContextGetData");
              sub_100004038(v22, v24);
              if (v18) {
                unsigned int v17 = 70;
              }
              else {
...
LABEL_19:
  ...
  {
    uint64_t v22 = v36;
    uint64_t v23 = sub_100003FF0(v36);
    sub_100004128("<data>", v23, v22, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1929, "verifyAclConstraintInternal");
    if (v23)
    {
      ...
      {
        unint64_t v25 = (unsigned int *)sub_100003FF0(0x1000uLL);
        sub_100004128("<data>", v25, 4096, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1935, "verifyAclConstraintInternal");
        if (v25)
        {
      ...
      rsize_t v28 = v36;
      sub_1000041D4("<data>", v23, v36, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1958, "verifyAclConstraintInternal");
      sub_100004038(v23, v28);
      if (v25)
      {
        sub_1000041D4("<data>", v25, 0x1000uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1961, "verifyAclConstraintInternal");
        sub_100004038(v25, 0x1000uLL);
      }
    }
    else
    {
...
{
  return sub_100012FB4(a1, a2, 12, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, 0, 0);
}

uint64_t sub_100012FB4(uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, _DWORD *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
  ...
  if (a7 || a9 || a12)
  {
    ...
    uint64_t v29 = v45;
    __int16 v30 = sub_100003FF0(v45);
    sub_100004128("<data>", v30, v29, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1776, "processAclInternal");
    if (!v30)
    {
      unsigned int v37 = 70;
    ...
    unint64_t v44 = 4096;
    unint64_t v31 = sub_100003FF0(0x1000uLL);
    sub_100004128("<data>", v31, 4096, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1780, "processAclInternal");
    if (!v31)
    {
      unint64_t v35 = 0;
      unint64_t v34 = 0;
    ...
    if (v44 >= 8)
    {
      *a12 = *v31;
      ...
      {
LABEL_67:
        sub_1000041D4("<data>", v31, 0x1000uLL, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1817, "processAclInternal");
        sub_100004038(v31, 0x1000uLL);
LABEL_68:
        rsize_t v36 = v45;
        sub_1000041D4("<data>", v30, v45, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1821, "processAclInternal");
        sub_100004038(v30, v36);
        if (v25 && v35)
        {
          sub_1000041D4("<data>", v35, v34, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1825, "processAclInternal");
          sub_100004038(v35, v34);
          unsigned int v37 = 70;
        }
        else if (v25)
        {
...
LABEL_74:
      ...
      if (v33 >= 0xC)
      {
        ...
        if (v34)
        {
          if (v33 >= v34 + 12)
          {
            unint64_t v35 = sub_100003FF0(v31[2]);
            sub_100004128("<data>", v35, v34, "/Library/Caches/com.apple.xbs/Sources/AppleCredentialManager_ClientLibs/common/LibCall.c", 1805, "processAclInternal");
            if (v35)
            {
...
LABEL_84:
  ...
  if (a5 && a13 && a6)
  {
    uint64_t v25 = sub_100014104(a1, a2, a5, a6, a13);
LABEL_76:
    if (v25) {
      unsigned int v24 = 70;
    }
...
{
  return sub_100012FB4(a1, a2, 30, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14);
}
...
uint64_t sub_100014104(uint64_t (*a1)(uint64_t, uint64_t, void, char *, uint64_t, int *, uint64_t *), uint64_t a2, const void *a3, unsigned int a4, unsigned char *a5)
{
  int v19 = 0;
  uint64_t v18 = 4;
  size_t v10 = a4;
...
id objc_msgSend_isUSBRestrictedModeAllowed(void *a1, const char *a2, ...)
{
  return [a1 isUSBRestrictedModeAllowed];
}
...
id objc_msgSend_onDeviceLostStatusChanged(void *a1, const char *a2, ...)
{
  return [a1 onDeviceLostStatusChanged];
}

id objc_msgSend_onManagedConfigurationChanged(void *a1, const char *a2, ...)
{
  return [a1 onManagedConfigurationChanged];
}

id objc_msgSend_prepareDataDir(void *a1, const char *a2, ...)
{
  return [a1 prepareDataDir];
}

id objc_msgSend_purgeLegacyFiles(void *a1, const char *a2, ...)
{
  return [a1 purgeLegacyFiles];
}
