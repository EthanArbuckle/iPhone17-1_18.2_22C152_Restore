...
- (void)_configureView
{
  ...
  v14 = [v13 localizedStringForKey:@"NOTIFICATION_REMOTE_MANAGEMENT_MUTING_SUGGESTION_ONE_HOUR" value:&stru_1F2F516F8 table:0];
  ...
  v18 = [v17 localizedStringForKey:@"NOTIFICATION_REMOTE_MANAGEMENT_MUTING_SUGGESTION_TODAY" value:&stru_1F2F516F8 table:0];
