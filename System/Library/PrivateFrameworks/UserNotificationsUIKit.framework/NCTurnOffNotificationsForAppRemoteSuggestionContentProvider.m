...
- (NCTurnOffNotificationsForAppRemoteSuggestionContentProvider)initWithNotificationRequest:(id)a3 bundleDisplayName:(id)a4 managementDelegate:(id)a5 suggestionDelegate:(id)a6 uuid:(id)a7
{
  id v12 = a4;
  v19.receiver = self;
  v19.super_class = (Class)NCTurnOffNotificationsForAppRemoteSuggestionContentProvider;
  ...
  if (v13)
  {
    ...
    v16 = [v15 localizedStringForKey:@"NOTIFICATION_MANAGEMENT_SUGGESTION_EXPLANATION" value:&stru_1F2F516F8 table:0];
