...
- (NCDigestOnboardingIntroductionViewController)initWithDeferButtonText:(id)a3
{
  ...
  v7 = [v6 localizedStringForKey:@"NOTIFICATION_DIGEST_ONBOARDING_INTRODUCTION_TITLE" value:&stru_1F2F516F8 table:0];
  v8 = NCUserNotificationsUIKitFrameworkBundle();
  v9 = [v8 localizedStringForKey:@"NOTIFICATION_DIGEST_ONBOARDING_INTRODUCTION_DESCRIPTION" value:&stru_1F2F516F8 table:0];
  v12.receiver = self;
...
- (void)viewDidLoad
{
  ...
  id v3 = [MEMORY[0x1E4F83AB8] linkButton];
  ...
  objc_super v12 = [(NCDigestOnboardingIntroductionViewController *)self contentView];
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  id v5 = [(NCDigestOnboardingIntroductionViewController *)self navigationController];
...
- (id)customContentView
{
  ...
  v127 = [MEMORY[0x1E4FB1618] colorWithRed:0.258823529 green:0.537254902 blue:0.82745098 alpha:1.0];
  v126 = [MEMORY[0x1E4FB1618] colorWithRed:0.749019608 green:0.980392157 blue:0.423529412 alpha:1.0];
  v124 = [[NCGradientView alloc] initWithVerticalStartColor:v127 verticalEndColor:v126];
  [(NCGradientView *)v124 setTranslatesAutoresizingMaskIntoConstraints:0];
  v128 = v8;
  [v8 addSubview:v124];
  ...
  v13 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v4, v5, v6, v7);
  ...
  v125 = [v18 imageWithRenderingMode:2];

  [v15 setImage:v125];
  v19 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.15];
  [v15 setTintColor:v19];

  [v15 setContentMode:2];
  [v15 setClipsToBounds:0];
  v20 = [v15 layer];
  [v20 setCompositingFilter:*MEMORY[0x1E4F3A2E0]];
  ...
  v36 = [v33 localizedStringForKey:v35 value:&stru_1F2F516F8 table:0];
  [(UILabel *)v32 setText:v36];

  [(UILabel *)self->_clockLabel setTextAlignment:1];
  [(UILabel *)self->_clockLabel setClipsToBounds:0];
  v37 = [MEMORY[0x1E4FB08E0] systemFontOfSize:42.0];
  objc_super v38 = [v37 fontDescriptor];
  v123 = [v38 fontDescriptorWithDesign:*MEMORY[0x1E4FB0938]];

  v39 = self->_clockLabel;
  v40 = [MEMORY[0x1E4FB08E0] fontWithDescriptor:v123 size:42.0];
  ...
  [v47 setCompositingFilter:*MEMORY[0x1E4F3A2E8]];
...
- (id)secondaryCustomContentView
{
  ...
  double v6 = *(double *)(MEMORY[0x1E4F1DB28] + 16);
  double v7 = *(double *)(MEMORY[0x1E4F1DB28] + 24);
  v121 = objc_msgSend(v3, "initWithFrame:", *MEMORY[0x1E4F1DB28], v5, v6, v7);
  [v121 setTranslatesAutoresizingMaskIntoConstraints:0];
  v122 = [MEMORY[0x1E4FB08E0] preferredFontForTextStyle:*MEMORY[0x1E4FB28D0]];
  [v122 pointSize];
  double v9 = v8;
  v120 = [MEMORY[0x1E4FB1830] configurationWithPointSize:6 weight:29.0];
  uint64_t v10 = (void *)MEMORY[0x1E4FB08E0];
  [v122 pointSize];
  v118 = objc_msgSend(v10, "systemFontOfSize:weight:");
  v119 = [MEMORY[0x1E4FB1618] secondaryLabelColor];
  v11 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v4, v5, v6, v7);
  ...
  v117 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1838]), "initWithFrame:", v4, v5, v6, v7);
  [v117 setTranslatesAutoresizingMaskIntoConstraints:0];
  v116 = [MEMORY[0x1E4FB1818] systemImageNamed:@"deskclock" withConfiguration:v120];
  [v117 setImage:v116];
  ...
  v17 = NCUserNotificationsUIKitFrameworkBundle();
  v18 = [v17 localizedStringForKey:@"NOTIFICATION_DIGEST_ONBOARDING_INTRODUCTION_EXPLAINER_1_TITLE" value:&stru_1F2F516F8 table:0];
  ...
  v19 = (UILabel *)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1930]), "initWithFrame:", v4, v5, v6, v7);
  ...
  id v21 = self->_explainer1Label;
  v22 = NCUserNotificationsUIKitFrameworkBundle();
  v23 = [v22 localizedStringForKey:@"NOTIFICATION_DIGEST_ONBOARDING_INTRODUCTION_EXPLAINER_1_BODY" value:&stru_1F2F516F8 table:0];
  ...
  v24 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v4, v5, v6, v7);
  ...
  v114 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1838]), "initWithFrame:", v4, v5, v6, v7);
  [v114 setTranslatesAutoresizingMaskIntoConstraints:0];
  v115 = [MEMORY[0x1E4FB1818] systemImageNamed:@"exclamationmark.bubble" withConfiguration:v120];
  [v114 setImage:v115];
  v26 = [MEMORY[0x1E4FB1618] systemBlueColor];
  [v114 setTintColor:v26];

  [v114 setContentMode:7];
  [(UIView *)self->_explainer2Container addSubview:v114];
  v27 = (UILabel *)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1930]), "initWithFrame:", v4, v5, v6, v7);
  ...
  int v31 = [v30 localizedStringForKey:@"NOTIFICATION_DIGEST_ONBOARDING_INTRODUCTION_EXPLAINER_2_TITLE" value:&stru_1F2F516F8 table:0];
  ...
  v32 = (UILabel *)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1930]), "initWithFrame:", v4, v5, v6, v7);
  ...
  v36 = [v35 localizedStringForKey:@"NOTIFICATION_DIGEST_ONBOARDING_INTRODUCTION_EXPLAINER_2_BODY" value:&stru_1F2F516F8 table:0];
  ...
  objc_super v38 = [(UIView *)self->_explainer1Container topAnchor];
  v39 = [v121 topAnchor];
  v40 = [v38 constraintEqualToAnchor:v39 constant:v9];
  [v37 addObject:v40];

  double v41 = [(UIView *)self->_explainer1Container leadingAnchor];
  ...
  v47 = [v117 topAnchor];
  id v48 = [(UILabel *)self->_explainer1Title topAnchor];
...
- (void)_deferButtonPressed:(id)a3
{
  double v4 = [(NCDigestOnboardingIntroductionViewController *)self navigationController];
  [v4 dismissViewControllerAnimated:1 completion:0];

  id v5 = [(NCOnboardingViewController *)self delegate];
