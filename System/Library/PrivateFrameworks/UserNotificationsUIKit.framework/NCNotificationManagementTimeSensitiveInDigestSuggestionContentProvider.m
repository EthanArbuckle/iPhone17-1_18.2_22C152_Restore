...
- (NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider)initWithNotificationRequest:(id)a3 bundleDisplayName:(id)a4 managementDelegate:(id)a5 suggestionDelegate:(id)a6
{
  ...
  if (v11)
  {
    ...
    v14 = [v13 localizedStringForKey:@"NOTIFICATION_MANAGEMENT_TIME_SENSITIVE_IN_DIGEST_SUGGESTION" value:&stru_1F2F516F8 table:0];
...
- (id)auxiliaryOptionActions
{
  ...
  v17[1] = 3221225472;
  v17[2] = __96__NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider_auxiliaryOptionActions__block_invoke;
  v17[3] = &unk_1E6A91930;
  objc_copyWeak(&v18, &location);
  v5 = [v2 actionWithTitle:v4 image:0 identifier:@"notification-management-suggestion-time-sensitive-in-digest-turn-off" handler:v17];
  ...
  v14 = __96__NCNotificationManagementTimeSensitiveInDigestSuggestionContentProvider_auxiliaryOptionActions__block_invoke_2;
  v15 = &unk_1E6A91930;
  objc_copyWeak(&v16, &location);
  v9 = [v6 actionWithTitle:v8 image:0 identifier:@"notification-management-suggestion-time-sensitive-in-digest-leave-on" handler:&v12];
