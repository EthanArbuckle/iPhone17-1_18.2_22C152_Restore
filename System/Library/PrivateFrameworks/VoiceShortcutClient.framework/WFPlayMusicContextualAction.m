...
LABEL_3:
  ...
  else
  {
    ...
    [v13 handleFailureInMethod:a2, self, @"WFPlayMusicContextualAction.m", 42, @"Invalid parameter not satisfying: %@", @"intent" object file lineNumber description];
...
LABEL_6:
  ...
  v15 = WFLocalizedString(@"Play Music");
  ...
  v19 = [(WFTopHitItemContextualAction *)&v23 initWithItem:v9 identifier:@"is.workflow.actions.playmusic" wfActionIdentifier:@"is.workflow.actions.playmusic" associatedAppBundleIdentifier:@"com.apple.Music" parameters:MEMORY[0x1E4F1CBF0] displayFormatString:v14 title:v15 subtitleFormatString:v18 primaryColor:0 icon:v12 accessoryIcon:0 namedQueryInfo:v11];
  if (!v17)
  {
  }
  [(WFPlayMusicContextualAction *)v19 setIntent:v9];
...
- (id)displayString
{
  ...
  {
    id v10 = [(WFPlayMusicContextualAction *)self intent];
...
- (id)uniqueIdentifier
{
  ...
  id v4 = [(WFPlayMusicContextualAction *)self intent];
...
void __90__WFPlayMusicContextualAction_disambiguationEntriesForCollection_limit_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  if (a2)
  {
    objc_msgSend(a2, "if_compactMap:", &__block_literal_global_19832);
...
WFPlayMusicContextualAction *__90__WFPlayMusicContextualAction_disambiguationEntriesForCollection_limit_completionHandler___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  id v4 = WFLocalizedString(@"Suggested");
  v5 = [(WFAppShortcutNamedQueryInfo *)v3 initWithName:v4 symbolName:@"music.and.sparkles"];

  objc_super v6 = [WFPlayMusicContextualAction alloc];
  id v7 = [v2 intent];
  id v8 = [v2 artwork];

  id v9 = [(WFPlayMusicContextualAction *)v6 initWithIntent:v7 artwork:v8 namedQueryInfo:v5];
  return v9;
}
...
+ (WFContextualActionParameter)disambiguationParameter
{
  id v2 = [[WFContextualActionParameter alloc] initWithType:@"WFMPMediaContentItem" displayString:&stru_1F0C7EBE0 wfParameterKey:@"WFMediaItems" askEachTime:1];
  return v2;
}
...
+ (WFTopHitItemContextualAction)disambiguationAction
{
  ...
  objc_super v6 = WFLocalizedStringWithKey(@"Recently Played Music (Display Format String)", @"Play %@");
  id v7 = WFLocalizedStringWithKey(@"Recently Played (Title)", @"Recently Played");
  id v8 = [[WFContextualActionIcon alloc] initWithSystemName:@"music.quarternote.3"];
  id v9 = [(WFTopHitItemContextualAction *)v3 initWithItem:0 identifier:@"is.workflow.actions.playmusic" wfActionIdentifier:@"is.workflow.actions.playmusic" associatedAppBundleIdentifier:@"com.apple.Music" parameters:v5 displayFormatString:v6 title:v7 subtitleFormatString:0 primaryColor:0 icon:v8 accessoryIcon:0 namedQueryInfo:0];
