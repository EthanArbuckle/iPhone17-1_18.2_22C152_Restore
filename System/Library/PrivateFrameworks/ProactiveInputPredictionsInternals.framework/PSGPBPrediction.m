...
- (void)setPortraitTimeout:(BOOL)a3;
- (void)setRequiredAppUnavailable:(BOOL)a3;
...
- (BOOL)requiredAppUnavailable
{
  return self->_requiredAppUnavailable;
}

- (BOOL)portraitTimeout
{
  return self->_portraitTimeout;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 3))
  {
    -[PSGPBPrediction setExperimentId:](self, "setExperimentId:");
    id v4 = v9;
  }
  if (*((void *)v4 + 11))
  {
    -[PSGPBPrediction setTreatmentId:](self, "setTreatmentId:");
    id v4 = v9;
  }
  if (*((void *)v4 + 12))
  {
    -[PSGPBPrediction setTreatmentName:](self, "setTreatmentName:");
    id v4 = v9;
  }
...
LABEL_11:
  if (*((void *)v4 + 9))
  {
    -[PSGPBPrediction setTextContentType:](self, "setTextContentType:");
    id v4 = v9;
  }
  if (*((void *)v4 + 5))
  {
    -[PSGPBPrediction setLocaleIdentifier:](self, "setLocaleIdentifier:");
    id v4 = v9;
  }
  if (*((void *)v4 + 1))
  {
    -[PSGPBPrediction setBundleIdentifier:](self, "setBundleIdentifier:");
    id v4 = v9;
  }
  ...
  if (*((void *)v4 + 4))
  {
    -[PSGPBPrediction setInitiatingProcess:](self, "setInitiatingProcess:");
    id v4 = v9;
  }
  ...
  if (*((void *)v4 + 10))
  {
    -[PSGPBPrediction setTextualResponseCategory:](self, "setTextualResponseCategory:");
    id v4 = v9;
  }
  ...
  if (*((void *)v4 + 16))
  {
    -[PSGPBPrediction setTriggerCategory:](self, "setTriggerCategory:");
    id v4 = v9;
  }
  if (*((void *)v4 + 15))
  {
    -[PSGPBPrediction setTriggerAttributeType:](self, "setTriggerAttributeType:");
    id v4 = v9;
  }
  if (*((void *)v4 + 14))
  {
    -[PSGPBPrediction setTriggerAttributeSubtype:](self, "setTriggerAttributeSubtype:");
    id v4 = v9;
  }
  if (*((void *)v4 + 13))
  {
    -[PSGPBPrediction setTriggerAttributeField:](self, "setTriggerAttributeField:");
    id v4 = v9;
  }
  __int16 v8 = *((_WORD *)v4 + 74);
  if ((v8 & 0x1000) != 0)
  {
    self->_portraitTimeout = *((unsigned char *)v4 + 145);
...
LABEL_41:
  ...
  else if ((*((_WORD *)v4 + 74) & 0x2000) == 0)
  {
    goto LABEL_41;
  }
  self->_requiredAppUnavailable = *((unsigned char *)v4 + 146);
...
- (unint64_t)hash
{
  NSUInteger v33 = [(NSString *)self->_experimentId hash];
  NSUInteger v32 = [(NSString *)self->_treatmentId hash];
  NSUInteger v31 = [(NSString *)self->_treatmentName hash];
...
LABEL_6:
  ...
  uint64_t v30 = 2654435761 * self->_hasResponseContext;
  if ((*(_WORD *)&self->_has & 0x800) == 0) {
    goto LABEL_6;
  }
LABEL_3:
  uint64_t v29 = 2654435761 * self->_isResponseContextBlacklisted;
  if ((*(_WORD *)&self->_has & 0x400) != 0)
  {
LABEL_4:
    uint64_t v28 = 2654435761 * self->_isDocumentEmpty;
    goto LABEL_8;
  }
LABEL_7:
  uint64_t v28 = 0;
LABEL_8:
  NSUInteger v27 = [(NSString *)self->_textContentType hash];
  NSUInteger v26 = [(NSString *)self->_localeIdentifier hash];
  NSUInteger v25 = [(NSString *)self->_bundleIdentifier hash];
  __int16 has = (__int16)self->_has;
  if ((has & 8) != 0)
  {
    uint64_t v24 = 2654435761 * self->_maxTextualResponseItems;
    if ((has & 4) != 0) {
      goto LABEL_10;
    }
  }
  else
  {
    ...
    {
LABEL_10:
      uint64_t v23 = 2654435761 * self->_maxStructuredInfoItems;
      goto LABEL_13;
    }
  }
  uint64_t v23 = 0;
LABEL_13:
  NSUInteger v21 = [(NSString *)self->_initiatingProcess hash];
...
LABEL_21:
  ...
  if ((v13 & 0x1000) != 0)
  {
    uint64_t v14 = 2654435761 * self->_portraitTimeout;
    if ((*(_WORD *)&self->_has & 0x2000) != 0)
    {
LABEL_23:
      uint64_t v15 = 2654435761 * self->_requiredAppUnavailable;
      if ((v13 & 0x80) != 0) {
        goto LABEL_24;
      }
      goto LABEL_30;
  ...
  {
LABEL_24:
    uint64_t v16 = 2654435761 * self->_hasContextBeforeInput;
    if ((v13 & 2) != 0) {
      goto LABEL_25;
    }
    goto LABEL_31;
...
LABEL_30:
  ...
  {
LABEL_25:
    uint64_t v17 = 2654435761 * self->_maxPredictionItems;
...
LABEL_26:
  uint64_t v18 = 2654435761 * self->_hasRecipientNames;
  if ((v13 & 1) == 0) {
    goto LABEL_33;
  }
LABEL_27:
  uint64_t v19 = 2654435761 * self->_dataSourceType;
  return v32 ^ v33 ^ v31 ^ v30 ^ v29 ^ v28 ^ v27 ^ v26 ^ v25 ^ v24 ^ v23 ^ v22 ^ v4 ^ v5 ^ v7 ^ v8 ^ v9 ^ v10 ^ v11 ^ v12 ^ v14 ^ v15 ^ v16 ^ v17 ^ v18 ^ v19;
}
...
LABEL_5:
  ...
  *(void *)(v5 + 112) = v29;
  ...
  NSUInteger v32 = *(void **)(v5 + 104);
  *(void *)(v5 + 104) = v31;

  __int16 v33 = (__int16)self->_has;
  if ((v33 & 0x1000) != 0)
  {
    *(unsigned char *)(v5 + 145) = self->_portraitTimeout;
    *(_WORD *)(v5 + 148) |= 0x1000u;
    __int16 v33 = (__int16)self->_has;
    if ((v33 & 0x2000) == 0)
    {
LABEL_17:
  ...
  *(unsigned char *)(v5 + 146) = self->_requiredAppUnavailable;
  *(_WORD *)(v5 + 148) |= 0x2000u;
  __int16 v33 = (__int16)self->_has;
  if ((v33 & 0x80) == 0)
  {
LABEL_18:
...
LABEL_11:
  ...
  if ((v8 & 0x1000) != 0)
  {
    *((unsigned char *)v4 + 145) = self->_portraitTimeout;
    *((_WORD *)v4 + 74) |= 0x1000u;
    __int16 v8 = (__int16)self->_has;
    if ((v8 & 0x2000) == 0)
    {
LABEL_41:
  ...
  *((unsigned char *)v4 + 146) = self->_requiredAppUnavailable;
  *((_WORD *)v4 + 74) |= 0x2000u;
  __int16 v8 = (__int16)self->_has;
  if ((v8 & 0x80) == 0)
  {
...
- (BOOL)readFrom:(id)a3
{
  return PSGPBPredictionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_25:
  ...
  if ((v21 & 0x10) != 0)
  {
    NSUInteger v26 = [NSNumber numberWithUnsignedInt:self->_numStructuredInfoItems];
...
LABEL_33:
  ...
  {
    uint64_t v28 = off_265037E20[dataSourceType];
  }
...
LABEL_46:
    ...
    {
      uint64_t v30 = off_265037E78[triggerSourceType];
    }
...
LABEL_50:
  ...
  if ((v35 & 0x1000) != 0)
  {
    v36 = [NSNumber numberWithBool:self->_portraitTimeout];
  ...
  if ((v35 & 0x2000) != 0)
  {
    v37 = [NSNumber numberWithBool:self->_requiredAppUnavailable];
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PSGPBPrediction;
  id v4 = [(PSGPBPrediction *)&v8 description];
  uint64_t v5 = [(PSGPBPrediction *)self dictionaryRepresentation];
...
{
  *(_WORD *)&self->_has |= 0x2000u;
  self->_requiredAppUnavailable = a3;
}
