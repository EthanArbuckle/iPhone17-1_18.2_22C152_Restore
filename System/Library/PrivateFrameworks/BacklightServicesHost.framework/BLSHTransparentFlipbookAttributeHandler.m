@interface BLSHTransparentFlipbookAttributeHandler
...
@implementation BLSHTransparentFlipbookAttributeHandler
...
- (id)initForService:(id)a3 provider:(id)a4
{
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BLSHTransparentFlipbookAttributeHandler;
