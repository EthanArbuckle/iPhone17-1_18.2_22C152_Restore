...
+ (id)registerHandlerForService:(id)a3 provider:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  v7 = -[BLSHDisableFlipbookAttributeHandler initForService:provider:]([BLSHDisableFlipbookAttributeHandler alloc], (uint64_t)v6, v5);
...
- (id)initForService:(void *)a3 provider:
{
  ...
  {
    v10.receiver = a1;
    v10.super_class = (Class)BLSHDisableFlipbookAttributeHandler;
