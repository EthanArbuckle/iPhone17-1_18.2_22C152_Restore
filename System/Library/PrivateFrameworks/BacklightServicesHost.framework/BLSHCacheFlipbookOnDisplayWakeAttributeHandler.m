...
uint64_t __78__BLSHCacheFlipbookOnDisplayWakeAttributeHandler_activateForSceneEnvironment___block_invoke(uint64_t a1)
{
  ...
  {
    v2 = *(void **)(a1 + 32);
    return [v2 setCacheFlipbookOnDisplayWake:1];
  }
  else
  {
    id v4 = NSString;
    ...
    if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
      __78__BLSHCacheFlipbookOnDisplayWakeAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(a1, (uint64_t)v8);
    }
    [v8 UTF8String];
...
{
  return [*(id *)(a1 + 32) setCacheFlipbookOnDisplayWake:0];
}
...
void __78__BLSHCacheFlipbookOnDisplayWakeAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(uint64_t a1, uint64_t a2)
{
  ...
  uint64_t v13 = v7;
  __int16 v14 = 2114;
  v15 = @"BLSHCacheFlipbookOnDisplayWakeAttributeHandler.m";
  __int16 v16 = 1024;
  int v17 = 33;
  __int16 v18 = 2114;
  uint64_t v19 = a2;
