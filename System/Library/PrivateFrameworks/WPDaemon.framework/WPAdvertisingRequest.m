...
- (WPAdvertisingRequest)initWithCoder:(id)a3
{
  ...
  v5 = [(WPAdvertisingRequest *)&v17 init];
  if (v5)
  {
    ...
    v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v18 count:4];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v6 = [(WPAdvertisingRequest *)self advertisingOptions];
...
- (id)description
{
  ...
  double v8 = [(WPAdvertisingRequest *)self advertisingData];
  BOOL v9 = [(WPAdvertisingRequest *)self connectable];
  BOOL v10 = [(WPAdvertisingRequest *)self stopOnAdvertisingAddressChange];
  v11 = [(WPAdvertisingRequest *)self advertisingOptions];
  uint64_t v12 = [(WPAdvertisingRequest *)self advertisementRequestedAt];
