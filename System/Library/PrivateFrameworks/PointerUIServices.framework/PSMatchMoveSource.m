...
{
  v7.receiver = self;
  v7.super_class = (Class)PSMatchMoveSource;
...
- (id)debugDescription
{
  ...
  v4 = (objc_class *)objc_opt_class();
  BOOL v5 = NSStringFromClass(v4);
  objc_msgSend(v3, "stringWithFormat:", @"<%@: %p; <0x%x -> 0x%llx> shouldInvalidateIfPointerLeavesDisplay: %d>",
    v5,
    self,
    self->_sourceContextID,
    self->_sourceLayerRenderID,
  v6 = self->_shouldBeInvalidatedIfPointerLeavesDisplay);
...
- (PSMatchMoveSource)initWithCoder:(id)a3
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)PSMatchMoveSource;
  BOOL v5 = [(PSMatchMoveSource *)&v7 init];
  if (v5)
  {
