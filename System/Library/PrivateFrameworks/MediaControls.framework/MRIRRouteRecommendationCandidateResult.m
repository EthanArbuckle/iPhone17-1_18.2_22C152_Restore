...
- (NSString)classificationDescription
{
  return (NSString *)sub_1AE8DC50C((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___MRIRRouteRecommendationCandidateResult_classificationDescription);
}
...
- (MRIRRouteRecommendationCandidateResult)initWithClassification:(int64_t)a3 classificationDescription:(id)a4 candidate:(id)a5 sortingHint:(id)a6 isCallToAction:(BOOL)a7 isLockScreenControl:(BOOL)a8 isConservativeFiltered:(BOOL)a9
{
  ...
  id v17 = a5;
  id v18 = a6;
  v19 = (MRIRRouteRecommendationCandidateResult *)sub_1AE8DDEA0(a3, v14, v16, v17, a6, a7, a8, a9);
...
- (NSString)description
{
  return (NSString *)sub_1AE8DAB94(self, (uint64_t)a2, type metadata accessor for RouteRecommendationCandidateResult, &qword_1E9A89C18, (void (*)(void))type metadata accessor for RouteRecommendationCandidateResult);
}
