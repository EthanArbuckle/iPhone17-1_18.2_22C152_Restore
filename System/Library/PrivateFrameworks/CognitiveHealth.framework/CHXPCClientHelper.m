  ...
  if (!self->_conn)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&buf[4] = serviceName;
      _os_log_impl(&dword_24A47C000, v3, OS_LOG_TYPE_DEFAULT, "Establishing new connection to %@ .", buf, 0xCu);
    }

    id v5 = (NSXPCConnection *)[objc_alloc(MEMORY[0x263F08D68]) initWithMachServiceName:self->_serviceName options:0];
    conn = self->_conn;
    self->_conn = v5;
    ...
    *(void *)buf = 0;
    ...
    v10 = __48__CHXPCClientHelper__locked_establishConnection__block_invoke_3;
    v11 = &unk_265287B90;
...
void __48__CHXPCClientHelper__locked_establishConnection__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR))
    {
      ...
      int v4 = 138412290;
      uint64_t v5 = v3;
      _os_log_error_impl(&dword_24A47C000, v2, OS_LOG_TYPE_ERROR, "Connection to %@ interrupted.", (uint8_t *)&v4, 0xCu);
    }
...
void __48__CHXPCClientHelper__locked_establishConnection__block_invoke_3(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR))
    {
      ...
      int v5 = 138412290;
      uint64_t v6 = v4;
      _os_log_error_impl(&dword_24A47C000, v2, OS_LOG_TYPE_ERROR, "Connection to %@ invalidated.", (uint8_t *)&v5, 0xCu);
    }

    (*(void (**)(void))(*((void *)WeakRetained + 14) + 16))();
    pthread_mutex_lock((pthread_mutex_t *)(WeakRetained + 8));
    uint64_t v3 = (void *)*((void *)WeakRetained + 9);
