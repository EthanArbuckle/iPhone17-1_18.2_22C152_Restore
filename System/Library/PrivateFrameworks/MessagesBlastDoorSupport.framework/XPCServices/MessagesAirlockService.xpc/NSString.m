...
- (id)__stringByStrippingAttachmentAndControlCharacters
{
  if (qword_100043730[0] != -1) {
    dispatch_once(qword_100043730, &stru_10003D688);
  }
  id v3 = [(NSString *)self stringByRemovingCharactersFromSet:qword_100043728];
  v4 = v3;
  if (!v3) {
    id v3 = &stru_10003EA60;
  }
  v5 = v3;
