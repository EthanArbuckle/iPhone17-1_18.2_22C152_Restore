...
+ (id)sharedInstance
{
  if (qword_1000EE0D8 != -1) {
    dispatch_once(&qword_1000EE0D8, &stru_1000E0590);
  }
  v2 = (void *)qword_1000EE0D0;
...
- (BOOL)parseContext:(id)a3
{
  ...
  v10 = [v5 name];
  CFDictionaryRef Mutable = (const __CFDictionary *)qword_1000EE0E0;
  if (!qword_1000EE0E0)
  {
    CFDictionaryRef Mutable = CFDictionaryCreateMutable(0, 0, &kCFTypeDictionaryKeyCallBacks, 0);
    qword_1000EE0E0 = (uint64_t)Mutable;
  }
  ...
  if (!Value)
  {
    ...
    CFDictionarySetValue((CFMutableDictionaryRef)qword_1000EE0E0, v10, v13);
  }
