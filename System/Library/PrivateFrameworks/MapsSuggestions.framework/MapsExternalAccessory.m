...
+ (id)sharedInstance
{
  if (qword_100081ED0 != -1) {
    dispatch_once(&qword_100081ED0, &stru_1000720D0);
  }
  v2 = (void *)qword_100081EC8;
  return v2;
}
...
- (void)_startListenForDebugTestNotifications
{
  if (qword_100081EE0 != -1) {
    dispatch_once(&qword_100081EE0, &stru_100072118);
  }
  long long v12 = 0u;
  long long v13 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
  id v3 = (id)qword_100081ED8;
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)sub_100036F24, v8, 0, CFNotificationSuspensionBehaviorDeliverImmediately);
      }
...
- (void)_handleFake:(id)a3
{
  ...
  if (qword_100081EE8 != -1) {
    dispatch_once(&qword_100081EE8, &stru_100072138);
  }
  ...
  if ([v23 hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.type"])
  {
    ...
    id v7 = [(id)qword_100081EF0 objectForKeyedSubscript:EAVehicleInfoEngineTypeBitmaskKey];
    unsigned int v8 = [v7 longLongValue];

    v9 = +[NSNumber numberWithUnsignedInt:sub_1000349A0(v5) | v8];
    [(id)qword_100081EF0 setObject:v9 forKeyedSubscript:v6];
  }
  else
  {
    if ([v23 hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.low"])
    {
      long long v10 = (void *)qword_100081EF0;
      long long v11 = (void *)qword_100081EB0;
      long long v12 = +[NSNumber numberWithUnsignedInt:sub_1000349A0(v5)];
      long long v13 = [v11 objectForKeyedSubscript:v12];
      [v10 setObject:&__kCFBooleanTrue forKeyedSubscript:v13];

      long long v14 = (void *)qword_100081EF0;
      long long v15 = (void *)qword_100081EA8;
      v9 = +[NSNumber numberWithUnsignedInt:sub_1000349A0(v5)];
      long long v16 = [v15 objectForKeyedSubscript:v9];
      long long v17 = &off_100074E40;
    }
    else
    {
      ...
      v18 = (void *)qword_100081EF0;
      uint64_t v19 = (void *)qword_100081EB0;
      v20 = +[NSNumber numberWithUnsignedInt:sub_1000349A0(v5)];
      v21 = [v19 objectForKeyedSubscript:v20];
      [v18 setObject:&__kCFBooleanFalse forKeyedSubscript:v21];

      long long v14 = (void *)qword_100081EF0;
      v22 = (void *)qword_100081EA8;
      v9 = +[NSNumber numberWithUnsignedInt:sub_1000349A0(v5)];
      long long v16 = [v22 objectForKeyedSubscript:v9];
      long long v17 = &off_100074E58;
    }
    [v14 setObject:v17 forKeyedSubscript:v16];
  }
LABEL_11:
  [(MapsExternalAccessory *)self _updateFromNotificationName:@"Fake Update" userInfo:qword_100081EF0];
}
...
- (void)_postNotificationIfNeeded
{
  ...
  unsigned __int8 v5 = sub_100035A34();
  id v6 = v5;
  if (!v4)
  {
