...
- (id)description
{
  ...
  v6 = +[NSString stringWithFormat:@"%@ <repeating: %s, next fire: %@>", v3, v4, v5];
...
+ (id)scheduledTimerWithTimeInterval:(double)a3 queue:(id)a4 block:(id)a5
{
  return _[a1 scheduledTimerWithTimeInterval:a4 queue:0 repeating:a5 block:a3];
}
...
+ (id)scheduledTimerWithTimeInterval:(double)a3 queue:(id)a4 repeating:(BOOL)a5 block:(id)a6
{
  ...
  id v9 = a6;
  id v10 = a4;
  id v11 = [[GCDTimer alloc] initWithTimeInterval:v10 queue:v6 repeating:v9 block:a3];
