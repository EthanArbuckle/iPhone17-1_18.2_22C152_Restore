...
+ (void)prepareForUse
{
  if (qword_100081E90 != -1) {
    dispatch_once(&qword_100081E90, &stru_100072040);
  }
}
...
{
  id v32 = a3;
  objc_super v4 = (void *)qword_100081EA8;
...
- (id)description
{
  ...
  unsigned int v5 = sub_100034948(v4 & 1 | (((v4 >> 2) & 1) << 16) & 0xFEFFFEFF | (((v4 >> 3) & 1) << 24) | (((v4 >> 1) & 1) << 8));
