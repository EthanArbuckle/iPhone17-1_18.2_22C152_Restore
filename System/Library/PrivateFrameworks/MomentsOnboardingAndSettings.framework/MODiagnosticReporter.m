...
- (MODiagnosticReporter)init
{
  ...
  if (v2)
  {
    ...
    *(_OWORD *)(v2 + 56) = xmmword_256D51120;
...
- (void)_notificationHandlerWithNotificationRef:(__CFUserNotification *)a3 andOptionFlags:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v13 = 138412290;
    v14 = v9;
    _os_log_impl(&dword_256D32000, v8, OS_LOG_TYPE_DEFAULT, "Received response flags %@", (uint8_t *)&v13, 0xCu);
  }
  if ((a4 & 3) != 0)
  {
    self->_lastResult = 2;
  ...
  CFRunLoopRemoveSource(Main, self->_notificationSource, (CFRunLoopMode)*MEMORY[0x263EFFE78]);
  *p_notification = 0;
  p_notification[1] = 0;
...
- (void)showUserNotificationWithTitle:(id)a3 message:(id)a4 cancelButtonTitle:(id)a5 acceptButtonTitle:(id)a6 withAcceptanceBlock:(id)a7
{
  ...
  {
    objc_msgSend(NSDictionary, "dictionaryWithObjectsAndKeys:", a3, *MEMORY[0x263EFFFC8], a4, *MEMORY[0x263EFFFD8], a6, *MEMORY[0x263F00000], a5, *MEMORY[0x263EFFFE8], 0);
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      ...
      _os_log_impl(&dword_256D32000, v15, OS_LOG_TYPE_DEFAULT, "Prompting diagnostic report notification with alert parameters %@", buf, 0xCu);
    }

    *(_DWORD *)buf = 0;
    CFAllocatorRef v16 = (const __CFAllocator *)*MEMORY[0x263EFFB08];
    v17 = CFUserNotificationCreate((CFAllocatorRef)*MEMORY[0x263EFFB08], 60.0, 0, (SInt32 *)buf, v14);
    ...
    if (v17)
    {
      ...
      if (RunLoopSource)
      {
        ...
        Main = CFRunLoopGetMain();
        CFRunLoopAddSource(Main, self->_notificationSource, (CFRunLoopMode)*MEMORY[0x263EFFE78]);
LABEL_15:
...
LABEL_21:
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v38 = 2112;
              id v39 = v10;
              _os_log_impl(&dword_256D32000, v18, OS_LOG_TYPE_DEFAULT, "MODiagnosticReporter reporting incident [subtype=%@,context=%@]", buf, 0x16u);
            }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138413570;
              ...
              __int16 v46 = 2112;
              v47 = v29;
              _os_log_debug_impl(&dword_256D32000, v24, OS_LOG_TYPE_DEBUG, "MODiagnosticReporter states [_lastResult=%@, _timeOfLastIncident=%@, interval=%@, _refractoryPeriodAfterAcceptance=%@, _refractoryPeriodAfterRejection=%@, _onboardingStatus=%@]", buf, 0x3Eu);
            }
...
- (void)reportIncidentAfterUserConsent:(id)a3 subtype:(id)a4 context:(id)a5
{
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412290;
    v27 = v24;
    _os_log_impl(&dword_256D32000, v23, OS_LOG_TYPE_DEFAULT, "Triggering tap to radar with url [%@]", buf, 0xCu);
  }
  uint64_t v25 = [MEMORY[0x263F01880] defaultWorkspace];
...
{
  OUTLINED_FUNCTION_2();
  _os_log_fault_impl(&dword_256D32000, v0, OS_LOG_TYPE_FAULT, "Unexpected notification handler call", v1, 2u);
}
...
- (void)showUserNotificationWithTitle:(int *)a1 message:(NSObject *)a2 cancelButtonTitle:acceptButtonTitle:withAcceptanceBlock:.cold.1(int *a1, NSObject *a2)
{
  ...
  v3[0] = 67109120;
  v3[1] = v2;
  _os_log_error_impl(&dword_256D32000, a2, OS_LOG_TYPE_ERROR, "Could not create diagnostic reporter user notification (error:%i)", (uint8_t *)v3, 8u);
}

- (void)showUserNotificationWithTitle:message:cancelButtonTitle:acceptButtonTitle:withAcceptanceBlock:.cold.2()
{
  OUTLINED_FUNCTION_2();
  _os_log_error_impl(&dword_256D32000, v0, OS_LOG_TYPE_ERROR, "Could not create diagnostic reporter user notification runloop", v1, 2u);
}

- (void)showUserNotificationWithTitle:message:cancelButtonTitle:acceptButtonTitle:withAcceptanceBlock:.cold.3()
{
  OUTLINED_FUNCTION_2();
  _os_log_fault_impl(&dword_256D32000, v0, OS_LOG_TYPE_FAULT, "A notification is already being processed", v1, 2u);
}

- (void)reportIncident:subtype:context:.cold.1()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_256D32000, v0, v1, "Attempting to report MODiagnosticReporter incident but user is not onboarded in journaling suggestions. Skipping.", v2, v3, v4, v5, v6);
}

- (void)reportIncident:subtype:context:.cold.2()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_256D32000, v0, v1, "Attempting to report MODiagnosticReporter incident but user is not onboarded in diagnostic reporter. Skipping.", v2, v3, v4, v5, v6);
}

- (void)reportIncident:subtype:context:.cold.3()
{
  OUTLINED_FUNCTION_2();
  _os_log_error_impl(&dword_256D32000, v0, OS_LOG_TYPE_ERROR, "Attempting to report MODiagnosticReporter incident but recent incident is too close in the past. Skipping.", v1, 2u);
}

- (void)reportIncident:subtype:context:.cold.4()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_1_0(&dword_256D32000, v0, v1, "Attempting to report MODiagnosticReporter incident but report feature is overriden as disabled. Skipping.", v2, v3, v4, v5, v6);
}
...
void __71__MODiagnosticReporter_reportIncidentAfterUserConsent_subtype_context___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_256D32000, a2, OS_LOG_TYPE_ERROR, "Launching TTR failed %@", (uint8_t *)&v2, 0xCu);
}
...
- (void)_configureFromDictionary:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_256D32000, a2, OS_LOG_TYPE_DEBUG, "Received configuration %@", (uint8_t *)&v2, 0xCu);
}
