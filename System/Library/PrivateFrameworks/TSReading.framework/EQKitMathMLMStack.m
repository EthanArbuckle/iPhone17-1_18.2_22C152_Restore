...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMStack mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStack mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesData);
  }
