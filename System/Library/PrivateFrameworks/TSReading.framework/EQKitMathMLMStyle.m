...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMStyle mathMLAttributes]::sAttributesSet, -[EQKitMathMLMStyle mathMLAttributes]::sAttributesDataInherited, &-[EQKitMathMLMAlignGroup mathMLAttributes]::sAttributesData);
  }
