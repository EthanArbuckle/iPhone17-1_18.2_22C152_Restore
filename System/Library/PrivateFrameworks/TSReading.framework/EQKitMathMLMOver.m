...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMOver mathMLAttributes]::sAttributesSet, (int *)&-[EQKitMathMLMOver mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMUnder mathMLAttributes]::sAttributesData);
  }
