...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMUnder mathMLAttributes]::sAttributesSet, (int *)&-[EQKitMathMLMUnder mathMLAttributes]::sAttributesData, -[EQKitMathMLMUnderover mathMLAttributes]::sAttributesData);
  }
