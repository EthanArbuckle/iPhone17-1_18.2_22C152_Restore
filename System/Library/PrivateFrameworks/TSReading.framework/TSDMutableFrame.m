...
- (void)setAssetScale:(double)a3
{
  ...
  if (self->super.mAssetScale != v4)
  {
    ...
    p_calculateDerivedValuesFromFrameSpecAndAssetScale(mSpec, &self->super.mLeftWidth, &self->super.mRightWidth, &self->super.mTopHeight, &self->super.mBottomHeight, (uint64_t)&self->super.mAdornmentSize, v4);
  }
}
