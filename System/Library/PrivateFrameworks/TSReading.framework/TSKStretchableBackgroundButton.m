...
{
  if (a3) {
    a3 = (id)[a3 stretchableImageWithLeftCapWidth:self->mBackgroundLeftCapWidth topCapHeight:self->mBackgroundTopCapHeight];
  }
  v6.receiver = self;
...
LABEL_5:
    ...
    int64_t *p_mBackgroundLeftCapWidth = a4;
...
- (void)guessBackgroundTopLeftCapSize
{
  v3 = (void *)[(TSKStretchableBackgroundButton *)self backgroundImageForState:0];
  if (v3)
  {
    [v3 size];
    unint64_t v5 = vcvtmd_s64_f64(v4 * 0.5);
    unint64_t v7 = vcvtmd_s64_f64(v6 * 0.5);
...
- (void)p_resetBackgroundImageForState:(unint64_t)a3
{
  uint64_t v5 = -[TSKStretchableBackgroundButton backgroundImageForState:](self, "backgroundImageForState:");
