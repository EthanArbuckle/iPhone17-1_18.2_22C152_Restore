...
- (NSXPCConnection)messageChannelServiceConnection
{
  ...
  if (!v3)
  {
    ...
    {
      uint64_t v4 = [objc_alloc(MEMORY[0x263F08D68]) initWithMachServiceName:@"com.apple.coordination.messaging" options:4096];
    ...
    [(NSXPCConnection *)v2->_messageChannelServiceConnection setInvalidationHandler:v6];
    v3 = v2->_messageChannelServiceConnection;
