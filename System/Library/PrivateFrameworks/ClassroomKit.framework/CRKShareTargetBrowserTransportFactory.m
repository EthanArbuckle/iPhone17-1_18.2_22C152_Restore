...
{
  id v4 = a3;
  id v5 = [(CRKShareTargetBrowserTransportFactory *)self makeStudentdTransportProvider];
...
{
  id v4 = a3;
  id v5 = [(CRKShareTargetBrowserTransportFactory *)self makeInstructordTransportProvider];
  [v5 fetchTransportWithCompletion:v4];
}
...
- (id)makeInstructordTransportProvider
{
  ...
  id v4 = [CRKFailIfSimulatorTransportProvider alloc];
  id v5 = CRKErrorWithCodeAndUserInfo(101, 0);
