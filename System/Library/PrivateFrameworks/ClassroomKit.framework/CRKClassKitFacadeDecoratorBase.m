...
- (CRKClassKitFacadeDecoratorBase)init
{
  ...
  [v4 handleFailureInMethod:a2, self, @"CRKClassKitFacadeDecoratorBase.m", 20, @"Use %@ instead", v5 object file lineNumber description];
...
+ (id)keyPathsForValuesAffectingAccountState
{
  return (id)[MEMORY[0x263EFFA08] setWithObject:@"underlyingClassKitFacade.accountState"];
}
...
- (id)classDataObserverWithSortDescriptors:(id)a3
{
  id v4 = a3;
  id v5 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  char v6 = [v5 classDataObserverWithSortDescriptors:v4];
...
- (id)locationsObserverWithSortDescriptors:(id)a3
{
  id v4 = a3;
  id v5 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  char v6 = [v5 locationsObserverWithSortDescriptors:v4];
...
- (id)personObserverWithPersonIDs:(id)a3 sortDescriptors:(id)a4
{
  ...
  objc_super v9 = [v8 personObserverWithPersonIDs:v7 sortDescriptors:v6];
...
- (void)instructorsInClassWithObjectID:(id)a3 completion:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
...
- (id)objectIDsOfStudentsInClass:(id)a3
{
  id v4 = a3;
  id v5 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  id v6 = [v5 objectIDsOfStudentsInClass:v4];
...
- (id)objectIDsOfInstructorsInClass:(id)a3
{
  id v4 = a3;
  id v5 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  id v6 = [v5 objectIDsOfInstructorsInClass:v4];
...
- (id)makeClassWithLocationID:(id)a3 name:(id)a4
{
  ...
  id v7 = a3;
  id v8 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  objc_super v9 = [v8 makeClassWithLocationID:v7 name:v6];
...
- (id)subscribeToClassMembershipChangeEvents:(id)a3
{
  id v4 = a3;
  id v5 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  id v6 = [v5 subscribeToClassMembershipChangeEvents:v4];
...
- (id)subscribeToCurrentUserDidChangeEvents:(id)a3
{
  id v4 = a3;
  id v5 = [(CRKClassKitFacadeDecoratorBase *)self underlyingClassKitFacade];
  id v6 = [v5 subscribeToCurrentUserDidChangeEvents:v4];
