...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = [(CRKSetAirPlayRouteRequest *)self routeUID];
  [v4 encodeObject:v5 forKey:@"routeUID"];

  v6 = [(CRKSetAirPlayRouteRequest *)self password];
  [v4 encodeObject:v6 forKey:@"password"];

  uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[CRKSetAirPlayRouteRequest suppressPasscodePrompt](self, "suppressPasscodePrompt"));
