...
- (CBSParseBookMetadataOperation)initWithBook:(id)a3 parseImage:(BOOL)a4
{
  id v7 = a3;
  v11.receiver = self;
  v11.super_class = (Class)CBSParseBookMetadataOperation;
...
- (void)main
{
  ...
  v5 = [v4 path];
  id v7 = [(CBSParseOPFFilePathOperation *)v3 initWithBookFilePath:v5];
...
- (void)parseContentsFilePathOperationDidFinish:(id)a3
{
  ...
  else
  {
    ...
    if (v6)
    {
      id v7 = [CBSParseOPFPackageContentsOperation alloc];
      v8 = [v17 resultObject];
      v9 = [(CBSParseBookMetadataOperation *)self book];
      v10 = [v9 webURL];
      objc_super v11 = [v10 host];
  ...
  else
  {
    ...
    if (v6)
    {
      ...
      if (self->mParseImage)
      {
        ...
        objc_super v11 = [(CBSParseBookMetadataOperation *)self book];
        [v11 setImage:v10];
      }
...
- (void)updateTitle:(id)a3
{
  ...
  {
    id v4 = a3;
    id v5 = [(CBSParseBookMetadataOperation *)self book];
    [v5 setTitle:v4];
  }
}
