...
- (CRKFetchCoursesResultObject)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CRKFetchCoursesResultObject;
  ...
  if (v5)
  {
    ...
    uint64_t v9 = [v4 decodeObjectOfClasses:v8 forKey:@"courses"];
    courses = v5->_courses;
    v5->_courses = (NSArray *)v9;
  }
  return v5;
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)CRKFetchCoursesResultObject;
  id v4 = a3;
  [(CATTaskResultObject *)&v6 encodeWithCoder:v4];
  v5 = [(CRKFetchCoursesResultObject *)self courses];
