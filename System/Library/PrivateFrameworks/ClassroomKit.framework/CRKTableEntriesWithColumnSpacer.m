...
- (CRKTableEntriesWithColumnSpacer)initWithOrigin:(id)a3 index:(unint64_t)a4 spacerEntry:(id)a5
{
  ...
  else
  {
    ...
    [v16 handleFailureInMethod:a2, self, @"CRKTableEntriesWithColumnSpacer.m", 23, @"Invalid parameter not satisfying: %@", @"origin" object file lineNumber description];
  ...
  [v17 handleFailureInMethod:a2, self, @"CRKTableEntriesWithColumnSpacer.m", 24, @"Invalid parameter not satisfying: %@", @"spacerEntry" object file lineNumber description];

LABEL_3:
  v18.receiver = self;
  v18.super_class = (Class)CRKTableEntriesWithColumnSpacer;
  v13 = [(CRKTableEntriesWithColumnSpacer *)&v18 init];
  v14 = v13;
  if (v13)
  {
