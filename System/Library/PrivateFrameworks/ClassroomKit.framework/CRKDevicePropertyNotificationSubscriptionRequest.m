...
- (CRKDevicePropertyNotificationSubscriptionRequest)initWithCoder:(id)a3;
...
- (CRKDevicePropertyNotificationSubscriptionRequest)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)CRKDevicePropertyNotificationSubscriptionRequest;
...
{
  v6.receiver = self;
  v6.super_class = (Class)CRKDevicePropertyNotificationSubscriptionRequest;
  id v4 = a3;
  [(CATTaskRequest *)&v6 encodeWithCoder:v4];
  v5 = [(CRKDevicePropertyNotificationSubscriptionRequest *)self propertyKeys];
