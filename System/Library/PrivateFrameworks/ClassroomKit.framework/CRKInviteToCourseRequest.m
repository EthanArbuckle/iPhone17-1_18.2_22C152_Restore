...
- (CRKInviteToCourseRequest)initWithCoder:(id)a3;
...
- (CRKInviteToCourseRequest)initWithCoder:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)CRKInviteToCourseRequest;
...
{
  v6.receiver = self;
  v6.super_class = (Class)CRKInviteToCourseRequest;
  id v4 = a3;
  [(CATTaskRequest *)&v6 encodeWithCoder:v4];
  v5 = [(CRKInviteToCourseRequest *)self invitation];
