...
- (CRKFetchControlGroupIdentifiersRequest)initWithCoder:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)CRKFetchControlGroupIdentifiersRequest;
...
{
  v7.receiver = self;
  v7.super_class = (Class)CRKFetchControlGroupIdentifiersRequest;
  id v4 = a3;
  [(CATTaskRequest *)&v7 encodeWithCoder:v4];
  v5 = objc_msgSend(NSNumber, "numberWithBool:", -[CRKFetchControlGroupIdentifiersRequest includeTemporary](self, "includeTemporary", v7.receiver, v7.super_class));
