...
- (void)_processAttributes:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    [(AAUICDPStatusUpdateHook *)(uint64_t)self _processAttributes:v8];
  }
}
...
- (void)_updateStatusWithAction:(id)a3 forObjectModel:(id)a4 completion:(id)a5
{
  ...
  id v22 = a4;
  id v9 = a5;
  id v10 = [(AAUICDPStatusUpdateHook *)self changeControllerForAction:v8];
  if (v10)
  {
    id v11 = [(AAUICDPStatusUpdateHook *)self delegate];
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      -[AAUICDPStatusUpdateHook _updateStatusWithAction:forObjectModel:completion:](v20, (uint64_t)v18, buf, v19);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT)) {
      -[AAUICDPStatusUpdateHook _updateStatusWithAction:forObjectModel:completion:]((uint64_t)self, (uint64_t)v8, v21);
    }
...
- (void)_handleUserInteractionWithCallback:(id)a3 onModel:(id)a4 forHookAction:(id)a5 userAction:(unint64_t)a6
{
  ...
  if (!a6)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v12;
      _os_log_impl(&dword_209754000, v14, OS_LOG_TYPE_DEFAULT, "%@: Status for %@ not being updated due to user decline.", (uint8_t *)&v15, 0x16u);
    }
...
- (void)_handleCompletionWithCallback:(id)a3 onModel:(id)a4 forHookAction:(id)a5 userAction:(unint64_t)a6 error:(id)a7
{
  ...
  if (!a6 && !v15)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v35 = 2112;
      v36 = v16;
      _os_log_debug_impl(&dword_209754000, v17, OS_LOG_TYPE_DEBUG, "%@: User declined status update for %@ and no error was provided. Using %@", buf, 0x20u);
    }
  }
  BOOL v19 = a6 != 3 && v16 == 0;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v37 = 2112;
    v38 = v16;
    _os_log_impl(&dword_209754000, v20, OS_LOG_TYPE_DEFAULT, "%@: Calling completion callback for %@ with (didChange: %@, error: %@)", buf, 0x2Au);
  }
  ...
  id v27 = [(AAUICDPStatusUpdateHook *)self additionalPayloadForAction:v14 error:v16];
...
- (void)_invokeJSCallback:(id)a3 onModel:(id)a4 withArguments:(id)a5
{
  ...
  if (v13)
  {
    if (v15)
    {
      ...
      __int16 v23 = 2112;
      id v24 = v9;
      _os_log_impl(&dword_209754000, v14, OS_LOG_TYPE_DEFAULT, "%@: Calling %@ callback using %@ with arguments: %@", (uint8_t *)&v17, 0x2Au);
    }
  ...
  else
  {
    if (v15)
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_209754000, v14, OS_LOG_TYPE_DEFAULT, "%@: Skipping %@ callback, no function provided.", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)_processAttributes:(os_log_t)log .cold.1(uint64_t a1, uint64_t *a2, os_log_t log)
{
  ...
  __int16 v6 = 2048;
  uint64_t v7 = v3;
  _os_log_debug_impl(&dword_209754000, log, OS_LOG_TYPE_DEBUG, "%@: presentation type is: %lu", (uint8_t *)&v4, 0x16u);
}
...
- (void)_updateStatusWithAction:(uint64_t)a1 forObjectModel:(uint64_t)a2 completion:(NSObject *)a3 .cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v7 = 2112;
  uint64_t v8 = a2;
  _os_log_fault_impl(&dword_209754000, a3, OS_LOG_TYPE_FAULT, "%@: Unexpected action processed - %@", (uint8_t *)&v5, 0x16u);
}
...
- (void)_updateStatusWithAction:(uint8_t *)buf forObjectModel:(os_log_t)log completion:.cold.2(uint64_t a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_debug_impl(&dword_209754000, log, OS_LOG_TYPE_DEBUG, "%@: Presenting CDP status change controller for %@", buf, 0x16u);
}

void __77__AAUICDPStatusUpdateHook__updateStatusWithAction_forObjectModel_completion___block_invoke_cold_1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_209754000, log, OS_LOG_TYPE_ERROR, "AAUICDPStatusUpdateHook not present when userActionCallback was called. Skipping user interaction JS callbacks.", v1, 2u);
}

void __77__AAUICDPStatusUpdateHook__updateStatusWithAction_forObjectModel_completion___block_invoke_46_cold_1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_209754000, log, OS_LOG_TYPE_FAULT, "AAUICDPStatusUpdateHook not present when completionCallback was called. Status update may have been successful, but JS callbacks/refreshUrl handling will not be invoked.", v1, 2u);
}
