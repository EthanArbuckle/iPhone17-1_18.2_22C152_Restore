...
{
  v7.receiver = self;
  v7.super_class = (Class)AAUIDataclassSpecifierCell;
  v4 = [(AAUIDataclassSpecifierCell *)&v7 initWithStyle:a3 reuseIdentifier:a4];
  v5 = v4;
  if (v4)
  {
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)AAUIDataclassSpecifierCell;
  [(PSTableCell *)&v15 refreshCellContentsWithSpecifier:v4];
  v5 = [(PSTableCell *)self titleLabel];
  [v5 setText:&stru_26BD39CD8];

  v6 = [(AAUIDataclassSpecifierCell *)self imageView];
  [v6 setImage:0];

  double v7 = [(AAUIDataclassSpecifierCell *)self headerImageView];
