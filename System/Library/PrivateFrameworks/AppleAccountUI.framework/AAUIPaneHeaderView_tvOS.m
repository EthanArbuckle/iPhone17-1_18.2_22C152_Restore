...
{
  v10.receiver = self;
  v10.super_class = (Class)AAUIPaneHeaderView_tvOS;
  v3 = -[AAUIPaneHeaderView_tvOS initWithFrame:](&v10, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    uint64_t v12 = 0;
    v13 = &v12;
...
{
  v7.receiver = self;
  v7.super_class = (Class)AAUIPaneHeaderView_tvOS;
...
- (double)innerHeaderMaxY
{
  ...
  double v5 = [(AAUIPaneHeaderView_tvOS *)self superview];
  header = self->_header;
  if (v4)
  {
...
- (void)makeAllTheTextFits
{
  ...
  double v5 = [(AAUIPaneHeaderView_tvOS *)self textLabel];
  uint64_t v17 = 0;
  double v18 = &v17;
  uint64_t v19 = 0x2050000000;
  double v6 = (void *)getBFFStyleClass_softClass;
  uint64_t v20 = getBFFStyleClass_softClass;
  if (!getBFFStyleClass_softClass)
  {
    ...
    v16[3] = &unk_263F92608;
    v16[4] = &v17;
    __getBFFStyleClass_block_invoke((uint64_t)v16);
  ...
  double v10 = [(AAUIPaneHeaderView_tvOS *)self detailTextLabel];
