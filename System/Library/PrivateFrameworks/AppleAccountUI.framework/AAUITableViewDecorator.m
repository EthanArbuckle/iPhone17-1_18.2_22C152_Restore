...
- (AAUITableViewDecoratorProtocol)tableView;
...
- (AAUITableViewDecorator)initWithTableView:(id)a3
{
  id v5 = a3;
  v11.receiver = self;
  v11.super_class = (Class)AAUITableViewDecorator;
...
{
  v9.receiver = self;
  v9.super_class = (Class)AAUITableViewDecorator;
  if (-[AAUITableViewDecorator respondsToSelector:](&v9, sel_respondsToSelector_)
