...
- (BOOL)allowsContext:(id)a3 withError:(id *)a4
{
  ...
  if (a4 && (v7 & 1) == 0)
  {
    ...
    v10 = [NSString stringWithFormat:@"originator doesn't have entitlement %@", self->_entitlement, *MEMORY[0x263F08338]];
    v14[0] = v10;
...
- (id)_initWithEntitlement:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RBOriginatorEntitlementDomainRestriction;
...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  else if (a4)
  {
    ...
    v8 = [NSString stringWithFormat:@"RBOriginatorEntitlementDomainRestriction doesn't specify entitlement: %@", v5, *MEMORY[0x263F08338]];
    v14[0] = v8;
