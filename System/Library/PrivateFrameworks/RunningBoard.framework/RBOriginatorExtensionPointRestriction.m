...
- (id)_initWithExtensionPoint:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RBOriginatorExtensionPointRestriction;
...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  else if (a4)
  {
    ...
    v8 = [NSString stringWithFormat:@"RBOriginatorExtensionPointRestriction doesn't specify extensionPoint: %@", v5, *MEMORY[0x263F08338]];
    v14[0] = v8;
...
- (BOOL)allowsContext:(id)a3 withError:(id *)a4
{
  ...
  uint64_t v6 = [a3 originatorProcess];
  v7 = [v6 identity];
  ...
  if ((v8 & 1) == 0)
  {
    ...
    v14 = [NSString stringWithFormat:@"originator isn't extension"];
    v23[0] = v14;
    v15 = NSDictionary;
    v16 = (void **)v23;
    v17 = &v22;
LABEL_8:
  ...
  if ((extensionPoint & 1) == 0)
  {
    ...
    v12 = (void *)MEMORY[0x263F087E8];
    uint64_t v13 = *MEMORY[0x263F646B8];
    v14 = [NSString stringWithFormat:@"originator doesn't have extensionPoint %@", self->_extensionPoint, *MEMORY[0x263F08338]];
    v21 = v14;
    v15 = NSDictionary;
    v16 = &v21;
    v17 = &v20;
