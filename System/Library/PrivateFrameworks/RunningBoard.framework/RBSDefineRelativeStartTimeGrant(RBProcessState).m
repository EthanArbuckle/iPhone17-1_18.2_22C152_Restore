...
- (void)applyToAssertionIntransientState:()RBProcessState attributePath:context:
{
  ...
  if ([v7 isActiveDueToInheritedEndowment])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR)) {
      -[RBSDefineRelativeStartTimeGrant(RBProcessState) applyToAssertionIntransientState:attributePath:context:](v7);
    }
  }
  else
  {
...
{
  v1 = [a1 assertion];
  OUTLINED_FUNCTION_0(&dword_226AB3000, v2, v3, "Not applying RBSDefineRelativeStartTimeGrant as it is not permitted as the subattribute of a hereditary grant for assertion %{public}@", v4, v5, v6, v7, 2u);
}
