...
void __41__BTAudioSession_activateWithCompletion___block_invoke(uint64_t a1)
{
  ...
  else
  {
    *(unsigned char *)(v2 + 8) = 1;
    uint64_t v3 = MEMORY[0x223C23220](*(void *)(a1 + 40));
...
LABEL_12:
  ...
  v15 = (void (**)(void, void))MEMORY[0x223C23220](*(void *)(v11 + 16));
...
- (id)_ensureXPCStarted
{
  if (!self->_xpcCnx)
  {
    ...
    id v7 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26CF20C28];
    ...
    id v8 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26CF20C88];
...
void __28__BTAudioSession_invalidate__block_invoke(uint64_t a1)
{
  ...
  if (!*(unsigned char *)(v1 + 24))
  {
    *(unsigned char *)(v1 + 24) = 1;
    ...
    int v12 = (void (**)(id, void *))MEMORY[0x223C23220](*(void *)(v7 + 16));
    uint64_t v9 = *(void *)(a1 + 32);
    v10 = *(void **)(v9 + 16);
    *(void *)(v9 + 16) = 0;
...
- (void)_invalidated
{
  if (!self->_invalidateDone)
  {
    ...
    if (!self->_xpcCnx)
    {
      uint64_t v11 = (void (**)(id, void *))MEMORY[0x223C23220](self->_activateCompletion, a2);
      ...
      uint64_t v5 = (void (**)(void))MEMORY[0x223C23220](self->_invalidationHandler);
...
- (void)_reportError:(id)a3
{
  ...
  uint64_t v7 = (void (**)(void, void))MEMORY[0x223C23220](self->_activateCompletion);
  id activateCompletion = self->_activateCompletion;
  self->_id activateCompletion = 0;
