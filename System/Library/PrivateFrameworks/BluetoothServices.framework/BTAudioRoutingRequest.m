...
void __34__BTAudioRoutingRequest__activate__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    int v4 = (void (**)(void, void))MEMORY[0x223C23220](*(void *)(*(void *)(a1 + 32) + 72));
    if (v4)
    {
...
{
  *(void *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) = [*(id *)(a1 + 32) _activateSync];
...
- (id)_activateSync
{
  ...
  id v3 = [(BTAudioRoutingRequest *)self _ensureXPCStarted];
  if (v3)
  {
    [(BTAudioRoutingRequest *)self _reportError:v3];
    id v4 = 0;
...
- (id)_ensureXPCStarted
{
  if (!self->_xpcCnx)
  {
    ...
    uint64_t v7 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26CF20C28];
...
- (void)_invalidated
{
  if (!self->_invalidateDone)
  {
    ...
    if (!self->_xpcCnx)
    {
      uint64_t v7 = (void (**)(id, BTAudioRoutingResponse *))MEMORY[0x223C23220](self->_responseHandler, a2);
...
- (void)updateAudioState:(id)a3 withState:(unsigned int)a4
{
    ...
    && (gLogCategory_BTAudioRoutingRequest != -1 || _LogCategory_Initialize()))
  {
    if (v4 > 2) {
      ...
      uint64_t v7 = off_2644A0CD0[(int)v4];
    }
    v12 = v7;
    id v13 = v6;
    uint64_t clientID = self->_clientID;
...
- (void)_reportError:(id)a3
{
  ...
  int v4 = (void (**)(void, void))MEMORY[0x223C23220](self->_responseHandler);
  if (v4)
  {
    id responseHandler = self->_responseHandler;
    self->_id responseHandler = 0;
