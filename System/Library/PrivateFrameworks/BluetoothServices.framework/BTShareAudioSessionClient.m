...
- (id)_ensureXPCStarted
{
  if (!self->_xpcCnx)
  {
    ...
    v19 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26CF20C28];
    ...
    v16 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26CF20C88];
...
- (void)_interrupted
{
  ...
  uint64_t v3 = MEMORY[0x223C23220](self->_progressHandler);
  id v4 = (void *)v3;
  if (v3) {
...
- (void)shareAudioProgressEvent:(int)a3 info:(id)a4
{
  ...
  uint64_t v6 = MEMORY[0x223C23220](self->_progressHandler);
  id v7 = (void *)v6;
  if (v6) {
