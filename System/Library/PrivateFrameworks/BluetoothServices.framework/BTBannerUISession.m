...
{
  uint64_t v2 = MEMORY[0x223C23220](*(void *)(*(void *)(a1 + 32) + 48));
  v3 = (void *)v2;
  if (v2) {
...
{
  id v16 = a3;
  if (MEMORY[0x223C23440]() == MEMORY[0x263EF8708])
  {
  ...
  else if (v16 == (id)MEMORY[0x263EF86A8])
  {
    ...
    uint64_t v8 = MEMORY[0x223C23220](self->_actionHandler);
    v9 = (void *)v8;
    if (v8) {
  ...
  else if (v16 == (id)MEMORY[0x263EF86A0])
  {
    ...
    uint64_t v11 = MEMORY[0x223C23220](self->_actionHandler);
    v12 = (void *)v11;
    if (v11) {
...
- (void)_xpcCompleted:(id)a3
{
  ...
  else
  {
    ...
    if (v5)
    {
      ...
      uint64_t v6 = MEMORY[0x223C23220](self->_actionHandler);
      uint64_t v7 = (void *)v6;
      if (v6) {
...
- (void)_xpcConnectionMessage:(id)a3
{
  ...
  switch(int64)
  {
    ...
    case 1:
      ...
      uint64_t v9 = MEMORY[0x223C23220](self->_actionHandler);
      id v8 = (void *)v9;
      if (!v9) {
        break;
      }
    ...
    case 3:
      ...
      uint64_t v12 = MEMORY[0x223C23220](self->_actionHandler);
      id v8 = (void *)v12;
      if (!v12) {
        break;
      }
