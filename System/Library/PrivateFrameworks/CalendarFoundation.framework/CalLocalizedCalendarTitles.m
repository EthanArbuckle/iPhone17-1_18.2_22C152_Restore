...
+ (id)localizedTitleForTitle:(id)a3 isSuggestedEventCalendar:(BOOL)a4 isBirthdayCalendar:(BOOL)a5 allowsReminders:(BOOL)a6 isIntegrationCalendar:(BOOL)a7
{
  ...
  {
    id v13 = [a1 localizedDefaultCalendarTitle];
    goto LABEL_17;
  }
  ...
  {
    id v13 = [a1 localizedVirtualCalendarTitle];
    goto LABEL_17;
  }
  if (v7)
  {
    id v13 = [a1 localizedScheduledRemindersCalendarTitle];
    goto LABEL_17;
  }
  if (!+[CalCompatibility isProgramSDKAtLeast:0x7E30901FFFFFFFFLL])goto LABEL_22; {
  if (v10)
  }
  {
    id v13 = [a1 localizedSiriSuggestedEventsCalendarTitle];
    goto LABEL_17;
  }
  if (v9)
  {
    id v13 = [a1 localizedBirthdayCalendarTitle];
  }
  else
  {
LABEL_22:
    ...
    {
LABEL_4:
      id v13 = [a1 localizedDefaultReminderListTitle];
      goto LABEL_17;
    }
    id v13 = v12;
  }
...
{
  v2 = +[CalFoundationBundle bundle];
  v3 = [v2 localizedStringForKey:@"Siri Suggestions" value:&stru_1EE0C39E0 table:0];
...
{
  v2 = +[CalFoundationBundle bundle];
  v3 = [v2 localizedStringForKey:@"Birthdays" value:&stru_1EE0C39E0 table:0];
...
{
  v2 = +[CalFoundationBundle bundle];
  v3 = [v2 localizedStringForKey:@"Scheduled Reminders" value:&stru_1EE0C39E0 table:0];
