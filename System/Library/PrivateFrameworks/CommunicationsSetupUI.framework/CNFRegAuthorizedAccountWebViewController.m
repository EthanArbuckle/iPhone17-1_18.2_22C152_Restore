...
- (BOOL)canSendURLRequest:(id)a3
{
  ...
  if (!v5)
  {
    ...
    {
      *(_WORD *)v11 = 0;
      _os_log_impl(&dword_21ED18000, v8, OS_LOG_TYPE_DEFAULT, "No auth token for request, denying send", v11, 2u);
    }
...
LABEL_17:
  ...
  if (!v6)
  {
    ...
    {
      *(_WORD *)v11 = 0;
      _os_log_impl(&dword_21ED18000, v9, OS_LOG_TYPE_DEFAULT, "No auth id for request, denying send", v11, 2u);
    }
