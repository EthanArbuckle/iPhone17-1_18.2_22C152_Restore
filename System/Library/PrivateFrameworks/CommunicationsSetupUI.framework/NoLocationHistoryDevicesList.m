...
- (void)setUpConstraints
{
  ...
  v29 = [(NoLocationHistoryDevicesList *)self contentView];
  v27 = [v29 centerYAnchor];
  v26 = [v28 constraintEqualToAnchor:v27];
  v31[0] = v26;
  v25 = [v4 view];
  v23 = [v25 centerXAnchor];
  v24 = [(NoLocationHistoryDevicesList *)self contentView];
  v22 = [v24 centerXAnchor];
  v20 = [v23 constraintEqualToAnchor:v22];
  v31[1] = v20;
  v19 = [v4 view];
  v18 = [v19 widthAnchor];
  objc_super v9 = [(NoLocationHistoryDevicesList *)self contentView];
  v10 = [v9 widthAnchor];
