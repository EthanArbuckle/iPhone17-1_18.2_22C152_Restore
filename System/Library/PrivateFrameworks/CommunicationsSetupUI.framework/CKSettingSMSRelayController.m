...
- (BOOL)isMiCEnabled
{
  ...
  else
  {
    ...
    if (v4)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_21ED18000, v5, OS_LOG_TYPE_INFO, "Auto SMS forwarding disabled, proceeding as if MiC is disabled.", buf, 2u);
      }
    ...
    if (IMOSLoggingEnabled())
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138412290;
        v47 = v7;
        _os_log_impl(&dword_21ED18000, v6, OS_LOG_TYPE_INFO, "Is Messages in iCloud enabled on this device? {%@}", buf, 0xCu);
      }
    }
...
- (id)getDeviceActive:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      int v10 = 138412290;
      id v11 = v4;
      _os_log_impl(&dword_21ED18000, v7, OS_LOG_TYPE_INFO, "Device {%@} has SMS Forwarding enabled.", (uint8_t *)&v10, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      int v10 = 138412290;
      id v11 = v4;
      _os_log_impl(&dword_21ED18000, v7, OS_LOG_TYPE_INFO, "Device {%@} has SMS Forwarding disabled.", (uint8_t *)&v10, 0xCu);
    }
  }
...
- (id)getDeviceOn:(id)a3
{
  ...
  int v4 = [v3 localizedStringForKey:@"SMS_RELAY_ON" value:@"SMS_RELAY_ON" table:@"Messages"];
...
- (void)setDeviceActive:(id)a3 specifier:(id)a4
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138412290;
      v19 = v10;
      _os_log_impl(&dword_21ED18000, v9, OS_LOG_TYPE_INFO, "Has smsAccount? {%@}", (uint8_t *)&v18, 0xCu);
    }
  }
  ...
  if (v11)
  {
    if (v12)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138412290;
        v19 = v14;
        _os_log_impl(&dword_21ED18000, v13, OS_LOG_TYPE_INFO, "Enrolling device in SMS relay. specifier_identifier={%@}", (uint8_t *)&v18, 0xCu);
      }
    }
    v15 = [v6 identifier];
  ...
  else
  {
    if (v12)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138412290;
        v19 = v17;
        _os_log_impl(&dword_21ED18000, v16, OS_LOG_TYPE_INFO, "Unenrolling device in SMS relay. specifier_identifier={%@}", (uint8_t *)&v18, 0xCu);
      }
    }
    v15 = [v6 identifier];
