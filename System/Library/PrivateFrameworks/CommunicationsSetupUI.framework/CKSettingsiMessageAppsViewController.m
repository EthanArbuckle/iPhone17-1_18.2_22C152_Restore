...
void __51__CKSettingsiMessageAppsViewController__deleteApp___block_invoke(uint64_t a1, void *a2)
{
  ...
  else if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138412290;
    uint64_t v8 = v6;
    _os_log_impl(&dword_21ED18000, v5, OS_LOG_TYPE_DEFAULT, "Uninstalled app with bundleID: %@", (uint8_t *)&v7, 0xCu);
  }
}
...
- (void)installediMessageAppsDidChange:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_21ED18000, v4, OS_LOG_TYPE_DEFAULT, "iMessage Apps view controller notified of installed apps change", buf, 2u);
  }

  id v5 = [(CKSettingsiMessageAppsViewController *)self appManager];
  if ([v5 haveDeletableApps])
  {
    uint64_t v6 = [(CKSettingsiMessageAppsViewController *)self _generateiMessageAppSpecifiers];
    [(CKSettingsiMessageAppsViewController *)self updateSpecifiers:*(Class *)((char *)&self->super.super.super.super.super.isa + (int)*MEMORY[0x263F5FDB8]) withSpecifiers:v6];
  }
  else
  {
    int v7 = csui_log();
    ...
    {
      *(_WORD *)uint64_t v9 = 0;
      _os_log_impl(&dword_21ED18000, v7, OS_LOG_TYPE_DEFAULT, "There are no deletable apps remaining, popping the user back to Messages settings.", v9, 2u);
    }

    uint64_t v6 = [(CKSettingsiMessageAppsViewController *)self navigationController];
    id v8 = (id)[v6 popViewControllerAnimated:1];
  }
}
...
- (void)setIsMessagesAppShownInSendMenu:(id)a3 specifier:(id)a4
{
  id v6 = a3;
  id v8 = [a4 identifier];
  int v7 = [(CKSettingsiMessageAppManager *)self->_appManager appWithBundleID:v8];
...
- (id)getIsMessagesAppShownInSendMenuForSpecifier:(id)a3
{
  ...
  int v7 = [NSNumber numberWithBool:v6 ^ 1u];
...
- (void)tableView:(id)a3 commitEditingStyle:(int64_t)a4 forRowAtIndexPath:(id)a5
{
  ...
  if (a4 == 1)
  {
    int v6 = [(CKSettingsiMessageAppsViewController *)self specifierAtIndexPath:a5];
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      int v10 = 138412290;
      uint64_t v11 = v7;
      _os_log_impl(&dword_21ED18000, v8, OS_LOG_TYPE_DEFAULT, "User requested uninstall of app with bundleID: %@", (uint8_t *)&v10, 0xCu);
    }

    uint64_t v9 = [(CKSettingsiMessageAppManager *)self->_appManager appWithBundleID:v7];
...
void __51__CKSettingsiMessageAppsViewController__deleteApp___block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_error_impl(&dword_21ED18000, log, OS_LOG_TYPE_ERROR, "Error uninstalling app: %@. Error: %@", (uint8_t *)&v4, 0x16u);
}
