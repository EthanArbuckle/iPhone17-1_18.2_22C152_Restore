...
{
  v12.receiver = self;
  v12.super_class = (Class)NoLocationHistoryMapAsset;
...
- (void)setUpConstraints
{
  ...
  v28 = [(NoLocationHistoryMapAsset *)self assetView];
  v26 = [v28 centerYAnchor];
  v27 = [(NoLocationHistoryMapAsset *)self contentView];
  v25 = [v27 centerYAnchor];
  v24 = [v26 constraintEqualToAnchor:v25];
  v29[0] = v24;
  v23 = [(NoLocationHistoryMapAsset *)self assetView];
  v21 = [v23 centerXAnchor];
  v22 = [(NoLocationHistoryMapAsset *)self contentView];
  v20 = [v22 centerXAnchor];
  v18 = [v21 constraintEqualToAnchor:v20];
  v29[1] = v18;
  v17 = [(NoLocationHistoryMapAsset *)self assetView];
  v7 = [v17 widthAnchor];
