...
- (gan_model_pre_A11)initWithMLModel:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)gan_model_pre_A11;
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(gan_model_pre_A11 *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(gan_model_pre_A11 *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(gan_model_pre_A11 *)self model];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(gan_model_pre_A11 *)self model];
...
{
  id v6 = a3;
  id v7 = [[gan_model_pre_A11Input alloc] initWithInput:v6];

  id v8 = [(gan_model_pre_A11 *)self predictionFromFeatures:v7 error:a4];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1B88A2000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not load gan_model_pre_A11.mlmodelc in the bundle resource", v0, 2u);
}
