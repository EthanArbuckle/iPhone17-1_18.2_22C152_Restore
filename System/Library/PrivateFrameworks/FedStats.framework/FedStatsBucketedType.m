...
- (id)decodeFromIndex:(id)a3 possibleError:(id *)a4
{
  ...
  if (v6)
  {
    ...
    if (v8 < [(FedStatsBucketedType *)self classCount])
    {
      ...
      if (v9) {
        [(FedStatsBucketedType *)self sampleForIndex:v9];
      }
      else {
      float v11 = +[FedStatsBoundedULongType gFedStatsOutOfBoundsNumber];
      }
      goto LABEL_13;
    }
    if (a4)
    {
      float v10 = @"The decoder requires a number less than the class count";
      goto LABEL_9;
    }
  }
  else if (a4)
  {
    float v10 = @"The decoder can only work with a number type";
LABEL_9:
