...
- (id)encodeToIndex:(id)a3 possibleError:(id *)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0
    && (uint64_t v7 = [v6 longValue], v7 == objc_msgSend(v6, "unsignedLongValue")))
  {
    uint64_t v8 = [v6 unsignedLongValue];
    if (v8 + 1 <= [(FedStatsBoundedULongType *)self bound]) {
      uint64_t v9 = v8 + 1;
    }
    else {
      uint64_t v9 = 0;
...
- (id)decodeFromIndex:(id)a3 possibleError:(id *)a4
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      uint64_t v8 = [NSNumber numberWithUnsignedLong:v7 - 1];
    }
    else
    {
      uint64_t v8 = &unk_27000ECF8;
    }
  }
  else if (a4)
  {
...
- (id)encodeToOneHotVector:(id)a3 possibleError:(id *)a4
{
  id v5 = [(FedStatsBoundedULongType *)self encodeToIndex:a3 possibleError:a4];
  id v6 = v5;
  if (v5)
  {
    uint64_t v7 = [v5 unsignedLongValue];
