...
+ (id)createFromDict:(id)a3 possibleError:(id *)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v7 == round(v8))
    {
      uint64_t v9 = [v5 unsignedLongValue];
      if (v9 == [v5 longValue])
      {
...
- (id)encodeToIndex:(id)a3 possibleError:(id *)a4
{
  ...
  if (v10 > [(FedStatsGeoHashType *)self hashLength])
  {
    if (a4)
    {
      uint64_t v11 = objc_msgSend(NSString, "stringWithFormat:", @"This geohash encoder accepts hashes of length %lu", -[FedStatsGeoHashType hashLength](self, "hashLength"));
...
LABEL_9:
  ...
  uint64_t v12 = 1;
  uint64_t v13 = [v6 cStringUsingEncoding:1];
  if ([(FedStatsGeoHashType *)self hashLength])
  {
    ...
    while (1)
    {
      unint64_t v17 = +[FedStatsGeoHashType geoHashCharToInteger:*(char *)(v13 + v14)];
      if (v17 == -1) {
        break;
      }
...
LABEL_15:
  ...
  uint64_t v9 = [v18 numberWithUnsignedLong:v19];
LABEL_18:
...
- (id)decodeFromIndex:(id)a3 possibleError:(id *)a4
{
  ...
  if (v7 == [v6 longValue])
  {
    ...
    {
      unint64_t v8 = v7 - 1;
      uint64_t v9 = malloc_type_malloc([(FedStatsGeoHashType *)self hashLength] + 1, 0x100004077774924uLL);
      v9[[(FedStatsGeoHashType *)self hashLength]] = 0;
      int v10 = [(FedStatsGeoHashType *)self hashLength];
      do
      {
...
- (id)sampleForIndex:(unint64_t)a3
{
  if (a3)
  {
    v4 = objc_msgSend(NSNumber, "numberWithUnsignedLong:");
    objc_super v5 = [(FedStatsGeoHashType *)self decodeFromIndex:v4 possibleError:0];
  }
  else
  {
    objc_super v5 = objc_msgSend(&stru_270008ED0, "stringByPaddingToLength:withString:startingAtIndex:", -[FedStatsGeoHashType hashLength](self, "hashLength"), @"@", 0);
  }
  return v5;
}
