...
- (IKJSTimerContext)initWithCallback:(id)a3 callbackArgs:(id)a4 repeating:(BOOL)a5 ownerObject:(id)a6 timer:(id)a7
{
  ...
  if (v16)
  {
    ...
    if ([v13 count])
    {
      v22 = [[IKJSManagedArray alloc] initWithArray:v13 ownerObject:v14];
...
{
  v3 = NSString;
  v4 = [(IKJSTimerContext *)self timer];
  v5 = objc_msgSend(v3, "stringWithFormat:", @"Timer:%p Context:%p Repeating:%d", v4, self, -[IKJSTimerContext isRepeating](self, "isRepeating"));
...
- (void)removeManagedReferences
{
  v3 = [(IKJSTimerContext *)self managedCallback];
  id v11 = [v3 value];

  v4 = [v11 context];
  v5 = [v4 virtualMachine];
  v6 = [(IKJSTimerContext *)self managedCallback];
  v7 = [(IKJSTimerContext *)self ownerObject];
