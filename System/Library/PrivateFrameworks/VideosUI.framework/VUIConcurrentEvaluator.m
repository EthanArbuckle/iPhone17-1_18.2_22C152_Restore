...
- (VUIConcurrentEvaluator)initWithQueue:(id)a3
{
  return [(VUIConcurrentEvaluator *)self initWithQueue:a3 concurrencyCount:10];
}
...
- (id)objectForKey:(id)a3
{
  ...
  v5 = self;
  objc_sync_enter(v5);
  id v6 = [(VUIConcurrentEvaluator *)v5 _getterForKey:v4];
  objc_sync_exit(v5);
...
LABEL_4:
    ...
    id v7 = [(NSMutableDictionary *)self->_fetchers objectForKeyedSubscript:v6];
...
{
  id v4 = a3;
  uint64_t v5 = [(VUIConcurrentEvaluator *)self _removeFetcherForKey:v4];
  id v6 = (void *)v5;
  if (v5) {
    (*(void (**)(uint64_t))(v5 + 16))(v5);
  }
  id v7 = [(NSMutableDictionary *)self->_getters objectForKeyedSubscript:v4];
...
- (void)_scheduleFetchRelayed:(BOOL)a3
{
  ...
  id v11 = __48__VUIConcurrentEvaluator__scheduleFetchRelayed___block_invoke;
  v12 = &unk_1E6DF4A30;
