...
+ (id)viewControllerForMediaEntity:(id)a3 withFamilyMember:(id)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v11 = (VUILibraryMediaCollectionViewController *)[objc_alloc(*v10) initWithMediaItem:v7];
    goto LABEL_29;
  }
  objc_opt_class();
...
+ (id)viewControllerForMediaEntity:(id)a3
{
  return +[VUILibraryViewFactory viewControllerForMediaEntity:a3 withFamilyMember:0];
}

+ (id)moviePlaceholderImage
{
  if (moviePlaceholderImage_onceToken != -1) {
    dispatch_once(&moviePlaceholderImage_onceToken, &__block_literal_global_133);
  }
  v2 = (void *)moviePlaceholderImage_moviePlaceholder;
  return v2;
}

void __46__VUILibraryViewFactory_moviePlaceholderImage__block_invoke()
{
  uint64_t v0 = +[VUIImageResourceMap imageForResourceName:@"PreloadAsset-Movie"];
...
+ (id)tvPlaceholderImage
{
  if (tvPlaceholderImage_onceToken != -1) {
    dispatch_once(&tvPlaceholderImage_onceToken, &__block_literal_global_18_0);
  }
  v2 = (void *)tvPlaceholderImage_tvPlaceholder;
  return v2;
}

void __43__VUILibraryViewFactory_tvPlaceholderImage__block_invoke()
{
  uint64_t v0 = +[VUIImageResourceMap imageForResourceName:@"PreloadAsset-TV"];
