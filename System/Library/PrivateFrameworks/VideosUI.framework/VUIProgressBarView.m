...
- (VUIProgressBarView)initWithFrame:(CGRect)a3
{
  ...
  v4 = v3;
  if (v3) {
    [(VUIProgressBarView *)v3 setContentMode:3];
  }
  return v4;
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  [(VUIProgressBarView *)self bounds];
  double v10 = v9;
  double v12 = v11;
  double v14 = v13;
  double v16 = v15;
  ...
  {
    v17 = [(VUIProgressBarView *)self completeTintColor];
    [v17 setFill];
    v18 = objc_msgSend(MEMORY[0x1E4FB14C0], "bezierPathWithRoundedRect:cornerRadius:", v10, v12, v14, v16, self->_cornerRadius);
    [v18 fill];
  }
  ...
  [(VUIProgressBarView *)self progress];
  double v23 = 0.0;
  if (v24 > 0.0)
  {
    [(VUIProgressBarView *)self progress];
  ...
  v31 = objc_msgSend(MEMORY[0x1E4FB14C0], "bezierPathWithRoundedRect:byRoundingCorners:cornerRadii:", v30, v26, v27, v28, v29, self->_cornerRadius, self->_cornerRadius);
  if (self->_gradientStartColor && self->_gradientEndColor)
  {
    ...
    *(void *)&v38[1] = [(UIColor *)self->_gradientEndColor CGColor];
    CFArrayRef v33 = [MEMORY[0x1E4F1C978] arrayWithObjects:v38 count:2];
  ...
  {
    v37 = [(VUIProgressBarView *)self progressTintColor];
    [v37 setFill];
...
- (void)setCompleteTintColor:(id)a3
{
  ...
  if ((-[UIColor isEqual:](self->_completeTintColor, "isEqual:") & 1) == 0)
  {
    ...
    [(VUIProgressBarView *)self setNeedsDisplay];
  }
}
