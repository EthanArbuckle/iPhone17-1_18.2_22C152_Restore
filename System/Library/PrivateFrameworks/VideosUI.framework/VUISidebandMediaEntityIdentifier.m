...
- (VUISidebandMediaEntityIdentifier)initWithManagedObjectID:(id)a3 mediaEntityType:(id)a4
{
  ...
  id v8 = a4;
  if (!v7) {
    [MEMORY[0x1E4F1CA00] raise:*MEMORY[0x1E4F1C3C8], @"The %@ parameter must not be nil.", @"managedObjectID" format];
  }
  v14.receiver = self;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v4 = (VUISidebandMediaEntityIdentifier *)a3;
  v5 = v4;
  if (v4 == self)
  {
    char v11 = 1;
  ...
  else if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    id v7 = [(VUISidebandMediaEntityIdentifier *)v5 managedObjectID];
    id v8 = v6;
    id v9 = v7;
    v10 = v9;
    if (v8 == v9)
