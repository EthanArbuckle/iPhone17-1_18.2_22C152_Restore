...
- (VUIJSSportsKitInterface)initWithAppContext:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [v4 jsContext];
    uint64_t v8 = [(VUIJSSportsKitJavascriptInterface *)v6 initWithContext:v7];
...
- (id)checkActivityExists:(id)a3
{
  return [(VUIJSSportsKitJavascriptInterface *)self->_implementation checkActivityExistsFor:a3];
}
...
- (id)registerForSportsCanonical:(id)a3 :(id)a4 :(id)a5
{
  ...
  id v11 = v9;
  id v12 = v8;
  [(VUIJSSportsKitJavascriptInterface *)implementation registerWithRequest:a3 successHandler:v23 errorHandler:&v18];
