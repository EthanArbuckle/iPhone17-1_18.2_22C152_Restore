...
- (SUUICounterTimeView)initWithClientContext:(id)a3
{
  ...
  if (v6)
  {
    ...
    v11 = +[SUUIClientContext localizedStringForKey:@"COUNTDOWN_DAYS" inBundles:0];
    }
    [v10 setText:v11];
    ...
    v15 = +[SUUIClientContext localizedStringForKey:@"COUNTDOWN_HOURS" inBundles:0];
    }
    [v14 setText:v15];
    ...
    v19 = +[SUUIClientContext localizedStringForKey:@"COUNTDOWN_MINUTES" inBundles:0];
    }
    [v18 setText:v19];
    ...
    v23 = +[SUUIClientContext localizedStringForKey:@"COUNTDOWN_SECONDS" inBundles:0];
    }
    [v22 setText:v23];
...
- (void)setEndDate:(id)a3
{
  ...
  if ((id)endDate != v4)
  {
    ...
    if ((endDate & 1) == 0)
    {
      ...
      uint64_t endDate = -[SUUICounterTimeView _setValuesUsingTimestamp:](self, "_setValuesUsingTimestamp:");
      id v4 = v9;
    }
  }
  MEMORY[0x270F9A758](endDate, v4);
}
...
- (void)layoutSubviews
{
  ...
  double v3 = [(SUUICounterTimeView *)self _allFieldViews];
  id v4 = [(SUUICounterTimeView *)self _visibleFieldViews];
...
- (void)setBackgroundColor:(id)a3
{
  ...
  id v4 = a3;
  double v5 = [(SUUICounterTimeView *)self _allFieldViews];
  long long v11 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
  long long v14 = 0u;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  uint64_t v8 = [(SUUICounterTimeView *)self _visibleFieldViews];
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
  long long v24 = 0u;
...
- (void)_setValuesUsingTimestamp:(int64_t)a3
{
  ...
  BOOL v9 = [(_SUUICounterTimeFieldView *)self->_daysFieldView valueLabel];
  ...
  double v13 = [(_SUUICounterTimeFieldView *)self->_hoursFieldView valueLabel];
  ...
  double v17 = [(_SUUICounterTimeFieldView *)self->_minutesFieldView valueLabel];
  double v18 = [NSNumber numberWithInteger:a3 / 60 % 60];
  double v19 = [v24 stringFromNumber:v18];
  [v17 setText:v19];

  double v20 = [(_SUUICounterTimeFieldView *)self->_secondsFieldView valueLabel];
