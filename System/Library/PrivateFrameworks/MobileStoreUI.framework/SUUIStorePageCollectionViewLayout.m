...
- (SUUIStorePageCollectionViewLayout)init
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SUUIStorePageCollectionViewLayout;
  ...
  if (v2)
  {
    ...
    uint64_t v4 = *MEMORY[0x263F83510];
    v8[0] = *MEMORY[0x263F83500];
    v8[1] = v4;
    v9[0] = &unk_2705D0AA8;
    v9[1] = &unk_2705D0AA8;
    ...
    [(SUUIStorePageCollectionViewLayout *)v3 registerClass:objc_opt_class() forDecorationViewOfKind:0x2704F8530];
    [(SUUIStorePageCollectionViewLayout *)v3 registerClass:objc_opt_class() forDecorationViewOfKind:0x270506E10];
  }
  return v3;
}
...
- (void)setExpandChildPageSectionsIndexSet:(id)a3
{
  uint64_t v4 = (NSIndexSet *)[a3 copy];
...
{
  v5.receiver = self;
  v5.super_class = (Class)SUUIStorePageCollectionViewLayout;
...
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)SUUIStorePageCollectionViewLayout;
  objc_super v5 = [(SUUIStorePageCollectionViewLayout *)&v29 initialLayoutAttributesForAppearingItemAtIndexPath:v4];
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  if (expandChildPageSectionsIndexSet
    && -[NSIndexSet containsIndex:](expandChildPageSectionsIndexSet, "containsIndex:", [v4 section])
    && self->_updateItems)
  {
    objc_super v7 = -[SUUIStorePageCollectionViewLayout _getCollectionViewUpdateItemForItemFromIndex:initalLayout:](self, "_getCollectionViewUpdateItemForItemFromIndex:initalLayout:", [v4 section], 1);
...
- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)a3
{
  id v4 = a3;
  v28.receiver = self;
  v28.super_class = (Class)SUUIStorePageCollectionViewLayout;
  objc_super v5 = [(SUUIStorePageCollectionViewLayout *)&v28 finalLayoutAttributesForDisappearingItemAtIndexPath:v4];
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  if (expandChildPageSectionsIndexSet
    && -[NSIndexSet containsIndex:](expandChildPageSectionsIndexSet, "containsIndex:", [v4 section])
    && self->_updateItems)
  {
    objc_super v7 = -[SUUIStorePageCollectionViewLayout _getCollectionViewUpdateItemForItemFromIndex:initalLayout:](self, "_getCollectionViewUpdateItemForItemFromIndex:initalLayout:", [v4 section], 0);
    uint64_t v8 = [v7 updateAction];
    if (!v7 || v8 != 1) {
      goto LABEL_13;
    }
...
- (id)invalidationContextForBoundsChange:(CGRect)a3
{
  ...
  v27.receiver = self;
  v27.super_class = (Class)SUUIStorePageCollectionViewLayout;
  ...
  {
    double v25 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
    if ([v25 count])
    {
      [v8 invalidateItemsAtIndexPaths:v25];
      [v8 invalidateDecorationElementsOfKind:0x2704F8530 atIndexPaths:v25];
    }
  }
  return v8;
}
...
- (void)invalidateLayoutWithContext:(id)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SUUIStorePageCollectionViewLayout;
...
- (id)layoutAttributesForDecorationViewOfKind:(id)a3 atIndexPath:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  if ([v6 isEqualToString:0x2704F8530])
  {
    objc_super v8 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v7];
    v9 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v7];
    double v10 = [(SUUIStorePageCollectionViewLayout *)self _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:v7 pinningConfiguration:v8 layoutInformation:v9];
  ...
  if (![v6 isEqualToString:0x270506E10]
    || (+[UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:0x270506E10 withIndexPath:v7], (double v10 = objc_claimAutoreleasedReturnValue()) == 0))
  {
LABEL_6:
    v12.receiver = self;
    v12.super_class = (Class)SUUIStorePageCollectionViewLayout;
    double v10 = [(SUUIStorePageCollectionViewLayout *)&v12 layoutAttributesForDecorationViewOfKind:v6 atIndexPath:v7];
  }
LABEL_7:
...
- (id)layoutAttributesForElementsInRect:(CGRect)a3
{
  ...
  v35.receiver = self;
  v35.super_class = (Class)SUUIStorePageCollectionViewLayout;
  ...
  -[SUUIStorePageCollectionViewLayout _appendAdditionalLayoutAttributesForPinningItemsInRect:toArray:](self, "_appendAdditionalLayoutAttributesForPinningItemsInRect:toArray:", v9, x, y, width, height);
  --self->_inLayoutAttributesForElementsCount;
  long long v31 = 0u;
  long long v32 = 0u;
  long long v33 = 0u;
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        {
          double v17 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
          uint64_t v18 = [v17 containsObject:v16];

          if (v18)
          {
            BOOL v19 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v16];
            unsigned int v20 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v16];
          }
          else
          {
            unsigned int v20 = 0;
          ...
          if (v30
            && [(SUUIStorePageCollectionViewLayout *)self _allowsBackdropDecorationForItemPinningConfiguration:v20 atIndexPath:v16])
          {
            BOOL v21 = [(SUUIStorePageCollectionViewLayout *)self _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:v16 pinningConfiguration:v20 layoutInformation:v19];
            if (v21)
            {
              unsigned int v22 = v29;
              if (!v29) {
                unsigned int v22 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:1];
              }
              objc_msgSend(v22, "addObject:", v21, v22);
            }
          }
        }
        BOOL v23 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForBackgroundGradients];
        int v24 = [v23 containsObject:v16];

        if (v24)
        {
          double v25 = [(SUUIStorePageCollectionViewLayout *)self _layoutAttributesForGradientDecorationViewAtIndexPath:v16 currentAttributes:v15];
          if (v25)
          {
            double v26 = v29;
            if (!v29) {
              double v26 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:1];
            }
  ...
  -[SUUIStorePageCollectionViewLayout _alginCellsToTop:](self, "_alginCellsToTop:", v10, v29);
...
- (void)_alginCellsToTop:(id)a3
{
  ...
  id v7 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  long long v53 = 0u;
  long long v54 = 0u;
  long long v55 = 0u;
  long long v56 = 0u;
      ...
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        if ((v15 & 1) == 0 && ![v13 representedElementCategory])
        {
          ...
          if ([v6 count])
          {
            ...
            v38 = objc_msgSend(MEMORY[0x263F08D40], "valueWithCGRect:", v65.origin.x, v65.origin.y, v65.size.width, v65.size.height);
          ...
          {
LABEL_13:
            v36 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithObjects:", v13, 0);
            [v5 addObject:v36];

            double v25 = objc_msgSend(MEMORY[0x263F08D40], "valueWithCGRect:", v17, v19, v21, v23);
            [v6 addObject:v25];
          }
        }
      }
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  if (!self->_inLayoutAttributesForElementsCount && ![v5 representedElementCategory])
  {
    ...
    if (v8)
    {
      uint64_t v9 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v4];
      uint64_t v10 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v4];
    }
    else
    {
      uint64_t v10 = 0;
...
- (void)prepareForCollectionViewUpdates:(id)a3
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)SUUIStorePageCollectionViewLayout;
...
{
  v14.receiver = self;
  v14.super_class = (Class)SUUIStorePageCollectionViewLayout;
  ...
  *(unsigned char *)&self->_collectionViewDelegateFlags = *(unsigned char *)&self->_collectionViewDelegateFlags & 0xDF | v9;
  ...
  id v12 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  id v13 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForBackgroundGradients];
}
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)a3
{
  double y = a3.origin.y;
  v10.receiver = self;
  v10.super_class = (Class)SUUIStorePageCollectionViewLayout;
  ...
  char v6 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  if ([v6 count])
  {
    char v7 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
    [v7 bounds];
    BOOL v5 = y != v8;
  }
  else
...
- (void)_updateItemsLayoutForRect:(CGRect)a3
{
  ...
  if (self->_overrideContentWidth >= 0.00000011920929)
  {
    double v8 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
    [v8 setOverrideBoundsWidth:self->_overrideContentWidth];
    v9.receiver = self;
    v9.super_class = (Class)SUUIStorePageCollectionViewLayout;
    -[SUUIStorePageCollectionViewLayout _updateItemsLayoutForRect:](&v9, sel__updateItemsLayoutForRect_, x, y, width, height);
  ...
  else
  {
    v10.receiver = self;
    v10.super_class = (Class)SUUIStorePageCollectionViewLayout;
    -[SUUIStorePageCollectionViewLayout _updateItemsLayoutForRect:](&v10, sel__updateItemsLayoutForRect_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  }
}
...
- (id)layoutAttributesForUnpinnedItemAtIndexPath:(id)a3
{
  ...
  if (!self->_inLayoutAttributesForElementsCount && ![v5 representedElementCategory])
  {
    char v7 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
    int v8 = [v7 containsObject:v4];

    if (v8)
    {
      objc_super v9 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v4];
      objc_super v10 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v4];
    }
    else
    {
      objc_super v10 = 0;
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        if (![v15 representedElementCategory])
        {
          ...
          long long v17 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
          uint64_t v18 = [v17 containsObject:v16];

          if (v18)
          {
            long long v19 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v16];
            double v20 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v16];
          }
          else
          {
            double v20 = 0;
          ...
          char v23 = 0;
          [(SUUIStorePageCollectionViewLayout *)self _configureCellLayoutAttributes:v15 forItemWithPinningConfiguration:v20 layoutInformation:v19 atIndexPath:v16 allowPinning:v18 returningIsPinning:&v23];
          if (v23)
          {
            [v15 frame];
            -[SUUIStorePageCollectionViewLayout _pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:](self, "_pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:", v20, v16);
            objc_msgSend(v15, "setFrame:");
            if (!v12) {
              objc_super v12 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:1];
            }
            [v12 addObject:v15];
          }
        }
...
- (void)setAllowsPinningTransitions:(BOOL)a3
{
  if (self->_allowsPinningTransitions != a3)
  {
    ...
    [(SUUIStorePageCollectionViewLayout *)self invalidateLayoutWithContext:v4];
  }
}
...
- (void)setBackdropGroupName:(id)a3
{
  ...
  if (backdropGroupName != v4)
  {
    ...
    if ((backdropGroupName & 1) == 0)
    {
      ...
      int v8 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
      if ([v8 count])
      {
        ...
        [v9 invalidateDecorationElementsOfKind:0x2704F8530 atIndexPaths:v8];
        [(SUUIStorePageCollectionViewLayout *)self invalidateLayoutWithContext:v9];
      }
      id v4 = v10;
    }
  }
  MEMORY[0x270F9A758](backdropGroupName, v4);
}

- (BOOL)_allowsBackdropDecorationForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  int64_t v4 = [(SUUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:a3 atIndexPath:a4];
  if (v4) {
    BOOL v5 = v4 == 3;
  }
  else {
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_super v14 = -[SUUIStorePageCollectionViewLayout _itemPinningLayoutInformationForItemAtIndexPath:](self, "_itemPinningLayoutInformationForItemAtIndexPath:", v13, v32);
        ...
        if (CGRectIntersectsRect(v48, v49))
        {
          ...
          self = v23;
          v36.receiver = v23;
          v36.super_class = (Class)SUUIStorePageCollectionViewLayout;
...
- (void)_calculatePinningLayoutInformation
{
  ...
  uint64_t v9 = v8;
  uint64_t v11 = v10;
  uint64_t v12 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  v34[0] = 0;
  v34[1] = v34;
  v34[2] = 0x4010000000;
  v34[3] = "";
  long long v13 = *(_OWORD *)(MEMORY[0x263F834E8] + 16);
...
void __71__SUUIStorePageCollectionViewLayout__calculatePinningLayoutInformation__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v77.super_class = (Class)SUUIStorePageCollectionViewLayout;
...
LABEL_47:
  long long v56 = objc_alloc_init(SUUIStorePageItemPinningLayoutInformation);
  -[SUUIStorePageItemPinningLayoutInformation setAvailablePinningFrame:](v56, "setAvailablePinningFrame:", MinX, rect, v41, v42);
  -[SUUIStorePageItemPinningLayoutInformation setLayoutAttributesFrame:](v56, "setLayoutAttributesFrame:", v11, v13, v15, v75);
  [(SUUIStorePageItemPinningLayoutInformation *)v56 setAfterPinningLocationYAdditions:v73];
  [(SUUIStorePageItemPinningLayoutInformation *)v56 setBeforePinningLocationYAdditions:*(double *)(*(void *)(*(void *)(a1 + 56) + 8) + 24)];
  v57 = *(void **)(*(void *)(a1 + 32) + 592);
  if (!v57)
  {
    uint64_t v58 = objc_msgSend(objc_alloc(MEMORY[0x263F08968]), "initWithKeyOptions:valueOptions:capacity:", 0, 0, objc_msgSend(*(id *)(a1 + 40), "count"));
...
- (void)_configureCellLayoutAttributes:(id)a3 forItemWithPinningConfiguration:(id)a4 layoutInformation:(id)a5 atIndexPath:(id)a6 allowPinning:(BOOL)a7 returningIsPinning:(BOOL *)a8
{
  ...
  id v16 = a5;
  id v17 = a6;
  double v18 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
  double v19 = v18;
  ...
  if (v9)
  {
    -[SUUIStorePageCollectionViewLayout _targetFrameForStartingFrame:itemPinningConfiguration:layoutInformation:atIndexPath:returningIsPinning:](self, "_targetFrameForStartingFrame:itemPinningConfiguration:layoutInformation:atIndexPath:returningIsPinning:", v15, v16, v17, &v39, v26, v27, v28, v29);
    double v30 = v34;
    double v31 = v35;
    double v32 = v36;
    double v33 = v37;
    if (v39)
    {
      ...
      {
        long long v38 = [MEMORY[0x263F825C8] clearColor];
...
- (id)_itemPinningConfigurationForItemAtIndexPath:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!v5)
    {
      id v5 = objc_alloc_init(SUUIStorePageItemPinningConfiguration);
      indexPathToItemPinningConfiguration = self->_indexPathToItemPinningConfiguration;
      if (!indexPathToItemPinningConfiguration)
      {
        uint64_t v7 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:0 capacity:1];
...
- (id)_layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:(id)a3 pinningConfiguration:(id)a4 layoutInformation:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  double v11 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
  uint64_t v12 = +[UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:0x2704F8530 withIndexPath:v8];
  ...
  -[SUUIStorePageCollectionViewLayout _targetFrameForStartingFrame:itemPinningConfiguration:layoutInformation:atIndexPath:returningIsPinning:](self, "_targetFrameForStartingFrame:itemPinningConfiguration:layoutInformation:atIndexPath:returningIsPinning:", v9, v10, v8, &v40);
  BOOL v13 = v40 == 0;
  double v14 = 0.0;
  if (v40)
  {
    -[SUUIStorePageCollectionViewLayout _pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:](self, "_pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:", v9, v8);
    objc_msgSend(v12, "setFrame:");
    [v12 setZIndex:150];
    int64_t v15 = [(SUUIStorePageCollectionViewLayout *)self _pinningTransitionStyleForItemPinningConfiguration:v9 atIndexPath:v8];
    if (v15)
    {
      int64_t v16 = v15;
      int64_t v17 = [(SUUIStorePageCollectionViewLayout *)self _pinnedBackdropViewStyle];
      int64_t v18 = v17;
      if (v17)
      {
        if (v17 == 2)
...
LABEL_16:
      ...
      else if (v16 == 1)
      {
        ...
        if (!v18)
        {
          ...
          double v25 = v23 + v24;
          v39.receiver = self;
          v39.super_class = (Class)SUUIStorePageCollectionViewLayout;
...
- (id)_layoutAttributesForGradientDecorationViewAtIndexPath:(id)a3 currentAttributes:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
  uint64_t v9 = objc_msgSend(v8, "numberOfItemsInSection:", objc_msgSend(v6, "section"));
  id v10 = [(SUUIStorePageCollectionViewLayout *)self layoutAttributesForDecorationViewOfKind:0x270506E10 atIndexPath:v6];
  [v8 bounds];
  [v7 size];
  double v12 = v11;
  [v7 frame];
  if (v9 >= 2)
  {
    ...
    {
      double v22 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", i, objc_msgSend(v6, "section"));
      double v23 = [(SUUIStorePageCollectionViewLayout *)self layoutAttributesForItemAtIndexPath:v22];
...
- (UIEdgeInsets)_pinningContentInsetForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  if (([v6 hasValidPinningContentInset] & 1) == 0)
  {
    ...
    {
      double v12 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
...
- (int64_t)_pinningStyleForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  if (([v6 hasValidPinningStyle] & 1) == 0)
  {
    ...
    {
      double v9 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
...
- (int64_t)_pinningTransitionStyleForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  if (self->_allowsPinningTransitions)
  {
    if (([v6 hasValidPinningTransitionStyle] & 1) == 0)
    {
      ...
      {
        double v10 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
...
- (CGRect)_targetFrameForStartingFrame:(CGRect)a3 itemPinningConfiguration:(id)a4 layoutInformation:(id)a5 atIndexPath:(id)a6 returningIsPinning:(BOOL *)a7
{
  ...
  id v14 = a5;
  id v15 = a6;
  [(SUUIStorePageCollectionViewLayout *)self _pinningContentInsetForItemPinningConfiguration:v13 atIndexPath:v15];
  double v17 = v16;
  double v19 = v18;
  double v21 = v20;
  double v23 = v22;
  double v24 = [(SUUIStorePageCollectionViewLayout *)self collectionView];
  [v24 contentOffset];
  double v26 = v25;
  [v24 _effectiveContentInset];
  double v28 = v27;
  int64_t v29 = [(SUUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:v13 atIndexPath:v15];
  CGFloat v88 = x;
  double v30 = -v21;
  double v31 = -v23;
  double v32 = x - v19;
  ...
  switch(v29)
  {
    case 1:
      ...
      v68 = [(SUUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
      CGFloat v69 = v68;
      if (!v68
      ...
      else
      {
        ...
        else
        {
          ...
          CGRect v86 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v72];
          double v73 = [(SUUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v72];
          int64_t v74 = [(SUUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:v73 atIndexPath:v72];
          BOOL v43 = 0;
          if (v74 && v74 != 3)
          {
            [v86 layoutAttributesFrame];
            -[SUUIStorePageCollectionViewLayout _pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:](self, "_pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:", v73, v72);
...
LABEL_7:
    ...
    case 4:
      ...
      double v58 = v42;
LABEL_8:
      -[SUUIStorePageCollectionViewLayout _pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:](v56, "_pinningFrameForStartingFrame:itemPinningConfiguration:atIndexPath:", v13, v15, v57, v58, width, v44);
