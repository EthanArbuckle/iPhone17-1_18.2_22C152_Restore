...
- (void)_transitionToSteadyState
{
  if (self->_topBarHeight >= self->_topBarHeightForState[1] * 0.9
    || (BOOL v3 = [(SUUIDynamicBarAnimator *)self canTransitionToState:0], v4 = 0, !v3))
  {
    uint64_t v4 = 1;
  }
...
- (void)_updateOutputs
{
  ...
  double v5 = __40__SUUIDynamicBarAnimator__updateOutputs__block_invoke(self->_unroundedTopBarHeight);
  [(SUUIDynamicBarAnimator *)self _bottomBarOffsetForTopBarHeight:self->_unroundedTopBarHeight];
  double v7 = __40__SUUIDynamicBarAnimator__updateOutputs__block_invoke(v6);
...
- (void)_updateDisplayLink
{
    ...
    || vabdd_f64(self->_lastUnroundedTopBarHeight, self->_unroundedTopBarHeight) >= 10.0)
  {
    ...
    {
      double v6 = [MEMORY[0x263F15780] displayLinkWithTarget:self selector:sel__displayLinkFired_];
      displayLink = self->_displayLink;
      self->_displayLink = v6;

      BOOL v8 = self->_displayLink;
      BOOL v9 = [MEMORY[0x263EFF9F0] mainRunLoop];
...
- (void)endDraggingWithTargetOffset:(double)a3 velocity:(double)a4
{
  ...
  {
    if (![(SUUIDynamicBarAnimator *)self targetState]
      && [(SUUIDynamicBarAnimator *)self canTransitionToState:0])
    {
      double v5 = self;
      uint64_t v6 = 0;
LABEL_7:
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUIDynamicBarAnimatorDelegate *)WeakRetained;
}
