...
- (SUUIJSPhysicalCirclesTemplate)initWithAppContext:(id)a3 DOMFeature:(id)a4
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SUUIJSPhysicalCirclesTemplate;
...
- (void)_performAnimationWithType:(int64_t)a3 callback:(id)a4
{
  ...
  uint64_t v8 = objc_alloc_init(SUUIPhysicalCirclesAnimationRequest);
  [(SUUIPhysicalCirclesAnimationRequest *)v8 setAnimationType:a3];
  if (v6)
  {
    id v9 = [MEMORY[0x263F10388] managedValueWithValue:v6];
    id v10 = [v6 context];
