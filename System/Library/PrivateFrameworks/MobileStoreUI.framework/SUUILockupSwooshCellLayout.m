...
{
  v7.receiver = self;
  v7.super_class = (Class)SUUILockupSwooshCellLayout;
  v3 = [(SUUICellLayout *)&v7 initWithCollectionViewCell:a3];
  if (v3)
  {
    SUUILockupStyleDefault((uint64_t)v5);
...
- (void)setArtistName:(id)a3
{
  ...
  if (v4 != v10 && ([v4 isEqualToString:v10] & 1) == 0)
  {
    ...
    if (v10)
    {
      if (!artistNameLabel)
      {
        float v6 = [(SUUILockupSwooshCellLayout *)self _newDefaultLabel];
        double v7 = self->_artistNameLabel;
        self->_artistNameLabel = v6;

        double v8 = [(SUUICellLayout *)self contentView];
...
- (void)setColoringWithColorScheme:(id)a3
{
  ...
  {
    double v7 = [MEMORY[0x263F825C8] colorWithWhite:0.0 alpha:0.600000024];
  ...
  {
    float v9 = [MEMORY[0x263F825C8] colorWithWhite:0.0 alpha:0.600000024];
  ...
  {
    v11 = [MEMORY[0x263F825C8] colorWithWhite:0.0 alpha:0.600000024];
...
- (void)setTitle:(id)a3
{
  ...
  if (v4 != v17 && ([v4 isEqualToString:v17] & 1) == 0)
  {
    ...
    if (v17)
    {
      if (!titleLabel)
      {
        float v6 = (UILabel *)objc_alloc_init(MEMORY[0x263F828E0]);
        double v7 = self->_titleLabel;
        self->_titleLabel = v6;

        double v8 = self->_titleLabel;
        float v9 = [(SUUICellLayout *)self parentCellView];
        ...
        double v16 = [(SUUICellLayout *)self contentView];
...
{
  id v17 = a3;
  id v4 = [(SUUILockupSwooshCellLayout *)self videoThumbnailImage];
  ...
  if (v4 != v17)
  {
    if (v17)
    {
      float v6 = [(SUUICellLayout *)self contentView];
      if (!self->_videoImageView)
      {
        ...
        id v10 = [(SUUICellLayout *)self parentCellView];
      ...
      if (!self->_videoPlayButtonImageView)
      {
        ...
        double v15 = (UIImageView *)[objc_alloc(MEMORY[0x263F82828]) initWithImage:v14];
...
- (void)layoutSubviews
{
  ...
  double v12 = [(SUUIItemCellLayout *)self iconImageView];
  id v18 = v12;
  if ((self->_visibleFields & 2) != 0)
  {
    [v12 frame];
    objc_msgSend(v18, "setFrame:", 0.0, v4 + self->_maxImageSize.height - v14);
    BOOL v13 = [(SUUIItemCellLayout *)self isIconImageHidden];
    double v12 = v18;
  }
  else
  {
  ...
  {
    double v16 = [(SUUIItemCellLayout *)self iconImageView];
    [v16 frame];
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SUUILockupSwooshCellLayout;
...
{
  v4.receiver = self;
  v4.super_class = (Class)SUUILockupSwooshCellLayout;
...
{
  v5.receiver = self;
  v5.super_class = (Class)SUUILockupSwooshCellLayout;
...
- (void)_layoutFieldsHorizontal
{
  ...
  v34[0] = 16;
  v34[1] = titleLabel;
  long long v35 = *MEMORY[0x263F001B0];
  categoryLabel = self->_categoryLabel;
  uint64_t v36 = 8;
  v37 = categoryLabel;
  long long v38 = v35;
  ...
  do
  {
    ...
    if ((v34[v9] & self->_visibleFields) != 0)
    {
      if (v17)
      {
        ...
        {
          CGRect v20 = [MEMORY[0x263F82B60] mainScreen];
          [v20 scale];
...
- (void)_layoutFieldsVertical
{
  ...
  if ((self->_visibleFields & 4) != 0)
  {
    ...
    double v28 = [MEMORY[0x263F82B60] mainScreen];
    [v28 scale];
...
- (id)_newDefaultLabel
{
  ...
  double v4 = [(SUUICellLayout *)self parentCellView];
  double v5 = [v4 backgroundColor];
  [v3 setBackgroundColor:v5];

  objc_super v6 = [MEMORY[0x263F81708] systemFontOfSize:12.0];
  [v3 setFont:v6];
...
- (void)_reloadPriceLabel
{
  id v3 = [(SUUIItemCellLayout *)self itemState];
  char v4 = [v3 state];

  if ((v4 & 3) != 0)
  {
    double v5 = [(SUUICellLayout *)self clientContext];
    if (v5)
    {
...
LABEL_14:
  ...
  uint64_t v8 = +[SUUIClientContext localizedStringForKey:v7 inBundles:0];
LABEL_19:
  id v10 = (id)v8;
...
LABEL_21:
  id v10 = [(SUUIItemCellLayout *)self itemOffer];
...
- (void)_reloadHighlight
{
  if ([(SUUIItemCellLayout *)self isHighlighted]
    || [(SUUIItemCellLayout *)self isSelected])
  {
    iconHighlightImageView = self->_iconHighlightImageView;
    if (!iconHighlightImageView)
    {
      char v4 = (UIImageView *)objc_alloc_init(MEMORY[0x263F82828]);
      ...
      uint64_t v9 = [(SUUICellLayout *)self contentView];
      [v9 addSubview:self->_iconHighlightImageView];

      [(SUUICellLayout *)self setNeedsLayout];
      iconHighlightImageView = self->_iconHighlightImageView;
    }
    id v10 = [(SUUIItemCellLayout *)self iconImage];
    CGFloat v11 = [MEMORY[0x263F825C8] blackColor];
    ...
    if (videoImageView && ([(UIImageView *)videoImageView isHidden] & 1) == 0)
    {
      ...
      if (!videoHighlightImageView)
      {
        ...
        double v20 = [(SUUICellLayout *)self contentView];
...
uint64_t __46__SUUILockupSwooshCellLayout__reloadHighlight__block_invoke(uint64_t a1)
{
