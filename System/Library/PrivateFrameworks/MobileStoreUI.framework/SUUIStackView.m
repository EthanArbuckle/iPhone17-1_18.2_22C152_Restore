  ...
  if (v4)
  {
    ...
    if ([(SUUIStackView *)v5 _stackDepth] >= 1)
    {
      ...
      do
      {
        ...
        v10 = [MEMORY[0x263F825C8] colorWithWhite:1.0 alpha:0.8];
        [(SUUIStackViewItemView *)v9 setBorderColor:v10];

        int64_t stackViewStyle = v5->_stackViewStyle;
        if (stackViewStyle == 1)
        {
        ...
        else if (!stackViewStyle)
        {
          ...
          [(SUUIStackViewItemView *)v9 setShouldFlipImageHorizontal:(0x2AuLL >> v8) & 1];
          [(SUUIStackViewItemView *)v9 setShouldFlipImageVertical:(unint64_t)(v8 - 1) < 2];
        }
...
{
  id v4 = a3;
  objc_super v5 = [(SUUIStackView *)self superview];
...
void __66__SUUIStackView_performCompressionAnimationWithCompletionHandler___block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  v23 = [MEMORY[0x263F15890] animationWithKeyPath:@"transform"];
  v24 = (void *)MEMORY[0x263F08D40];
  ...
  v28 = [MEMORY[0x263F08D40] valueWithCATransform3D:&v45];
  [v23 setToValue:v28];
  ...
  v29 = [MEMORY[0x263F15890] animationWithKeyPath:@"transform"];
  v30 = (void *)MEMORY[0x263F08D40];
  if (v22) {
    [v22 transform];
  }
  else {
