@interface SUUIContextActionsPresentationRegistration
...
- (SUUIContextActionsPresentationRegistration)initWithViewController:(id)a3 handler:(id)a4
{
  ...
  v9 = [(SUUIContextActionsPresentationRegistration *)&v14 init];
  v10 = v9;
  if (v9)
  {
...
- (void)dealloc
{
  ...
  [(SUUIContextActionsPresentationRegistration *)&v5 dealloc];
}
...
- (BOOL)previewInteractionShouldBegin:(id)a3
{
  ...
  {
    v9 = [(SUUIContextActionsPresentationRegistration *)self viewController];
    if (v9)
    {
      ...
      v22 = [(SUUIContextActionsPresentationRegistration *)self handler];
      ((void (**)(void, SUUIContextActionsPresentationRegistration *))v22)[2](v22, self);
      ...
      if (v12)
      {
        ...
        double v26 = v25;
        v9 = v72;
        v27 = [[SUUIContextActionsPresentationSource alloc] initWithViewController:v72];
        ...
        v32 = [[SUUIContextActionsViewController alloc] initWithConfiguration:v12];
        [(SUUIContextActionsViewController *)v32 setOrbPresentation:1];
        v33 = [(SUUIContextActionsPresentationRegistration *)self longPressGestureRecognizer];
        [(SUUIContextActionsViewController *)v32 setSystemProvidedGestureRecognzier:v33];
        ...
        v36 = (void *)MEMORY[0x263F82E10];
        v94[0] = MEMORY[0x263EF8330];
        v94[1] = 3221225472;
        v94[2] = __76__SUUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke;
        v94[3] = &unk_265400890;
        id v12 = v12;
        id v95 = v12;
        v37 = v32;
        ...
        [(SUUIContextActionsPresentationRegistration *)self setOrbContextActionsViewController:v37];
        v38 = [(SUUIContextActionsViewController *)v37 transitionPresentationController];
        v39 = v38;
        BOOL v8 = v38 != 0;
        if (v38)
        {
          ...
          v45 = +[SUUIContextActionsBlurEffect effectWithStyle:1];
          v68 = v43;
          id v46 = objc_alloc(MEMORY[0x263F82E30]);
          v90[0] = MEMORY[0x263EF8330];
          v90[1] = 3221225472;
          v90[2] = __76__SUUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_2;
          v90[3] = &unk_265400958;
          id v66 = v40;
          id v91 = v66;
          id v92 = v45;
          ...
          [(SUUIContextActionsPresentationRegistration *)self setPreviewPhasePropertyAnimator:v48];

          v49 = [(SUUIContextActionsViewController *)v71 view];
          [v73 bounds];
          ...
          id v58 = objc_alloc(MEMORY[0x263F82E30]);
          v80[0] = MEMORY[0x263EF8330];
          v80[1] = 3221225472;
          v80[2] = __76__SUUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_3;
          v80[3] = &unk_265400958;
          id v81 = v47;
          id v82 = v66;
          id v59 = v49;
          ...
          [(SUUIContextActionsPresentationRegistration *)self setCommitPhasePropertyAnimator:v61];

          v77[0] = MEMORY[0x263EF8330];
          v77[1] = 3221225472;
          CGAffineTransform v79 = v89;
          v77[2] = __76__SUUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_4;
          v77[3] = &unk_265403840;
          id v78 = v59;
          id v62 = v59;
          [v69 setDismissalAnimations:v77];
          v63 = (void *)MEMORY[0x263EFFA20];
          v75[0] = MEMORY[0x263EF8330];
          v75[1] = 3221225472;
          v75[2] = __76__SUUIContextActionsPresentationRegistration_previewInteractionShouldBegin___block_invoke_5;
          v75[3] = &unk_265403868;
          v75[4] = self;
          id v76 = v4;
          v64 = [v63 scheduledTimerWithTimeInterval:0 repeats:v75 block:1.0];
          [(SUUIContextActionsPresentationRegistration *)self setPreviewInteractionTimeout:v64];

          [(SUUIContextActionsPresentationRegistration *)self setPreviewInteractionDidEnd:0];
          v37 = v71;
        ...
        else
        {
          ...
          [(SUUIContextActionsPresentationRegistration *)self cleanupPreviewInteraction:v4];
        }
      }
      else
      {
...
- (void)previewInteraction:(id)a3 didUpdatePreviewTransition:(double)a4 ended:(BOOL)a5
{
  ...
  double v8 = a4 * a4;
  double v9 = [(SUUIContextActionsPresentationRegistration *)self previewPhasePropertyAnimator];
  [v9 fractionComplete];
  double v11 = v10;

  if (v8 < 1.0 || v11 != 0.0)
  {
    CGFloat v12 = [(SUUIContextActionsPresentationRegistration *)self previewPhasePropertyAnimator];
    [v12 setFractionComplete:v8];
  }
  if (v5)
  {
    [(SUUIContextActionsPresentationRegistration *)self setPreviewInteractionDidEnd:1];
    double v13 = [(SUUIContextActionsPresentationRegistration *)self orbContextActionsViewController];
    CGFloat v14 = [v13 view];
    [v14 setUserInteractionEnabled:1];

    uint64_t v15 = [(SUUIContextActionsPresentationRegistration *)self orbContextActionsViewController];
    uint64_t v16 = [v15 view];
    [v16 setHidden:0];

    id v17 = [(SUUIContextActionsPresentationRegistration *)self commitPhasePropertyAnimator];
    [v17 startAnimation];

    v18 = [(SUUIContextActionsPresentationRegistration *)self previewPhasePropertyAnimator];
    [v18 pauseAnimation];

    uint64_t v19 = (void *)[objc_alloc(MEMORY[0x263F82BF0]) initWithDampingRatio:1.0];
    uint64_t v20 = [(SUUIContextActionsPresentationRegistration *)self previewPhasePropertyAnimator];
    [v20 continueAnimationWithTimingParameters:v19 durationFactor:0.400000006];

    [(SUUIContextActionsPresentationRegistration *)self setOrbContextActionsViewController:0];
    [(SUUIContextActionsPresentationRegistration *)self cleanupPreviewInteraction:v21];
  }
}
...
{
  id v4 = a3;
  if ([(SUUIContextActionsPresentationRegistration *)self previewInteractionDidEnd])
  {
  ...
  else
  {
    ...
    [(SUUIContextActionsPresentationRegistration *)self cleanupPreviewInteraction:v4];
    [(SUUIContextActionsPresentationRegistration *)self setOrbContextActionsViewController:0];
    [(SUUIContextActionsPresentationRegistration *)self setCommitPhasePropertyAnimator:0];
    [(SUUIContextActionsPresentationRegistration *)self setPreviewPhasePropertyAnimator:0];
  }
}
...
{
  id v8 = a3;
  id v4 = [(SUUIContextActionsPresentationRegistration *)self previewInteractionTimeout];
  [v4 invalidate];

  [(SUUIContextActionsPresentationRegistration *)self setPreviewInteractionTimeout:0];
  BOOL v5 = [v8 valueForKey:@"touchObservingGestureRecognizer"];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    [v5 setCancelsTouchesInView:0];
  }
  uint64_t v6 = [(SUUIContextActionsPresentationRegistration *)self orbContextActionsViewController];
...
- (void)longPressGestureRecognizerTriggered:(id)a3
{
  ...
  if ([v7 state] == 1)
  {
    ...
    if (v6 != 2) {
      [(SUUIContextActionsPresentationRegistration *)self _presentFromGestureRecognizer:v7];
    }
  }
}
...
{
  id v13 = a3;
  id v4 = [(SUUIContextActionsPresentationRegistration *)self handler];
  BOOL v5 = ((void (**)(void, SUUIContextActionsPresentationRegistration *))v4)[2](v4, self);

  if (v5)
  {
    id v6 = [SUUIContextActionsPresentationSource alloc];
    id v7 = [(SUUIContextActionsPresentationRegistration *)self viewController];
    id v8 = [(SUUIContextActionsPresentationSource *)v6 initWithViewController:v7];

    double v9 = [v13 view];
    [(SUUIContextActionsPresentationSource *)v8 setSourceView:v9];
    ...
    double v11 = [[SUUIContextActionsViewController alloc] initWithConfiguration:v5];
    [(SUUIContextActionsViewController *)v11 setSystemProvidedGestureRecognzier:v13];
