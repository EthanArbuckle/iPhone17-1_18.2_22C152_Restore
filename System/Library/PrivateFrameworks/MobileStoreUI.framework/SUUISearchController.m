...
LABEL_15:
  ...
  v29 = [MEMORY[0x263F82438] sharedApplication];
  v30 = [v29 keyWindow];
  [v30 bounds];
...
LABEL_17:
  ...
  v41 = (NSMutableString *)objc_alloc_init(MEMORY[0x263F089D8]);
  ...
  if ((v54 & 1) == 0)
  {
    ...
    v56 = [v55 searchField];
    if ([(SUUISearchController *)self isActive]) {
      v57 = 0;
    }
    else {
...
- (void)setActive:(BOOL)a3
{
  ...
  v6 = [v5 text];
  v15.receiver = self;
  v15.super_class = (Class)SUUISearchController;
...
- (SUUISearchBar)searchBar
{
  ...
  if (!searchBar)
  {
    id v4 = objc_alloc_init(SUUISearchBar);
    v5 = self->_searchBar;
    self->_searchBar = v4;
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SUUISearchController;
  id v7 = a4;
  -[SUUISearchController viewWillTransitionToSize:withTransitionCoordinator:](&v9, sel_viewWillTransitionToSize_withTransitionCoordinator_, v7, width, height);
  v8 = [(SUUISearchController *)self delegate];
