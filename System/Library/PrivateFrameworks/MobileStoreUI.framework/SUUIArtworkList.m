...
- (SUUIArtworkList)initWithArtworkListArray:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)SUUIArtworkList;
      ...
      do
      {
        ...
        do
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            v17 = -[SUUIArtwork initWithArtworkDictionary:](v16, "initWithArtworkDictionary:", v15, (void)v19);
            if (v17) {
...
- (SUUIArtworkList)initWithLookupArray:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)SUUIArtworkList;
  id v5 = [(SUUIArtworkList *)&v21 init];
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            uint64_t v14 = [SUUIArtwork alloc];
            uint64_t v15 = -[SUUIArtwork initWithArtworkDictionary:](v14, "initWithArtworkDictionary:", v13, (void)v17);
            if (v15) {
...
- (id)bestArtworkForScaledSize:(CGSize)a3
{
  ...
  return -[SUUIArtworkList bestArtworkForSize:](self, "bestArtworkForSize:", v9, v10);
}
...
- (id)preferredExactArtworkForSize:(CGSize)a3
{
  ...
  while (2)
  {
    ...
    do
    {
      ...
      long long v14 = (void *)MEMORY[0x25A2A9B80](v6);
...
+ (id)artworkForSize:(int64_t)a3 artworkDictionaries:(id)a4
{
  ...
  do
  {
    for (uint64_t i = 0; i != v7; ++i)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        long long v13 = [[SUUIArtwork alloc] initWithArtworkDictionary:v12];
        uint64_t v14 = [(SUUIArtwork *)v13 width];
        if (!v10) {
          goto LABEL_15;
        }
        uint64_t v15 = v14 - a3;
...
- (void)setArtworks:(id)a3
{
  if (self->_artworks != a3)
  {
    ...
    self->_artworks = v4;
    MEMORY[0x270F9A758](v4, artworks);
  }
}
...
- (NSString)description
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SUUIArtworkList;
  id v4 = [(SUUIArtworkList *)&v7 description];
...
- (SUUIArtworkList)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUUIArtworkList;
  uint64_t v5 = [(SUUIArtworkList *)&v9 init];
  if (v5)
  {
...
- (SUUIArtworkList)initWithCacheRepresentation:(id)a3
{
  ...
  {
    v11.receiver = self;
    v11.super_class = (Class)SUUIArtworkList;
    uint64_t v5 = [(SUUIArtworkList *)&v11 init];
    if (v5)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        uint64_t v8 = SUUICacheCodingDecodeArray(v6, v7);
        artworks = v5->_artworks;
...
- (NSMutableDictionary)cacheRepresentation
{
  ...
  id v4 = SUUICacheCodingEncodeArray(self->_artworks);
