...
- (SUUINetworkErrorViewController)init
{
  return [(SUUINetworkErrorViewController *)self initWithError:0];
}
...
- (SUUINetworkErrorViewController)initWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v9 = *MEMORY[0x263F89418];
    v10 = [MEMORY[0x263F894C0] sharedInstance];
...
LABEL_6:
      uint64_t v10 = [(SUUIClientContext *)clientContext localizedStringForKey:v9];
      goto LABEL_10;
    }
  ...
  uint64_t v10 = +[SUUIClientContext localizedStringForKey:v11 inBundles:0];
LABEL_10:
...
LABEL_21:
    uint64_t v16 = +[SUUIClientContext localizedStringForKey:v15 inBundles:0];
    goto LABEL_27;
  }
  if (!v4)
  {
...
LABEL_26:
  uint64_t v16 = [(SUUIClientContext *)v13 localizedStringForKey:v14];
LABEL_27:
  v17 = (void *)v16;
  id v18 = objc_alloc(MEMORY[0x263F82EF0]);
  v19 = objc_msgSend(v18, "initWithFrame:title:style:", v20, 0, *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
  [v19 setMessage:v17];
  [(SUUINetworkErrorViewController *)self setView:v19];
}
