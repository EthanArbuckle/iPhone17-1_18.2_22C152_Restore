...
{
  v4.receiver = self;
  v4.super_class = (Class)SUUISearchCollectionViewFlowLayout;
...
- (id)layoutAttributesForElementsInRect:(CGRect)a3
{
  ...
  v30.receiver = self;
  v30.super_class = (Class)SUUISearchCollectionViewFlowLayout;
  v8 = [(SUUIItemGridCollectionViewLayout *)&v30 layoutAttributesForElementsInRect:sel_layoutAttributesForElementsInRect_];
  ...
  if (v15 < v19 - 1)
  {
    do
    {
      v24 = [MEMORY[0x263F088C8] indexPathWithIndex:v15];
  ...
  if ((uint64_t)(v22 - 1) > v21)
  {
    ...
    do
    {
      v27 = [MEMORY[0x263F088C8] indexPathWithIndex:v26];
...
{
  v13.receiver = self;
  v13.super_class = (Class)SUUISearchCollectionViewFlowLayout;
