...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v12 = a5;
  id v8 = a3;
  uint64_t v9 = [v12 labelLayoutCache];
  uint64_t v10 = [v8 textElement];

  if (v10)
  {
    int v11 = [a1 _attributedStringForLabel:v10 context:v12];
    [v9 requestLayoutForLabel:v10 attributedString:v11 width:(uint64_t)a4];
  }
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5 numberOfLines:(unint64_t *)a6
{
  ...
  v31 = "";
  long long v32 = *MEMORY[0x263F001B0];
  id v12 = [v10 imageElements];
  ...
  if (v13)
  {
    double v14 = v29[4] + 7.0;
    v29[4] = v14;
    long long v15 = [a1 _attributedStringForLabel:v13 context:v11];
    long long v16 = [a1 _textViewLayoutWithWidth:v15 string:a3 - v14];
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  id v10 = [(SUUIStackItemView *)self imageViewToImageResourceCacheKey];
  [v10 removeAllObjects];

  uint64_t v13 = MEMORY[0x263EF8330];
  uint64_t v14 = 3221225472;
  long long v15 = __57__SUUIStackItemView_reloadWithViewElement_width_context___block_invoke;
  long long v16 = &unk_265400C88;
  id v17 = v8;
  double v18 = self;
  double v20 = a4;
  id v19 = v9;
  ...
  -[SUUIStackItemView setViewElement:](self, "setViewElement:", v12, v13, v14, v15, v16);
...
void __57__SUUIStackItemView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v13 = __57__SUUIStackItemView_reloadWithViewElement_width_context___block_invoke_2;
  uint64_t v14 = &unk_265402FB0;
  id v15 = v3;
  id v16 = *(id *)(a1 + 48);
  id v17 = v7;
...
void __57__SUUIStackItemView_reloadWithViewElement_width_context___block_invoke_2(id *a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      ...
      if (!v5)
      {
        double v6 = (void *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:1];
...
- (BOOL)setImage:(id)a3 forArtworkRequest:(id)a4 context:(id)a5
{
  ...
  long long v26 = 0u;
  long long v27 = 0u;
  uint64_t v11 = [(SUUIStackItemView *)self imageViewToImageResourceCacheKey];
  ...
  if (v12)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        id v17 = [(SUUIStackItemView *)self imageViewToImageResourceCacheKey];
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  double v37 = v5;
  uint64_t v38 = v11;
  uint64_t v12 = [(SUUIStackItemView *)self imageViews];
  ...
  *(double *)&v32[5] = width - v6 - v10;
  ...
  v40.size.double width = *(CGFloat *)(MEMORY[0x263F001A8] + 16);
  v40.size.height = *(CGFloat *)(MEMORY[0x263F001A8] + 24);
  CGFloat v13 = v34[5];
  ...
  id v17 = [(SUUIStackItemView *)self textView];
  ...
  double v22 = [(SUUIStackItemView *)self textView];
  [v22 setLayout:v21];

  id v23 = [(SUUIStackItemView *)self textView];
...
{
  v54.receiver = self;
  v54.super_class = (Class)SUUIStackItemView;
  ...
  double v53 = v12;
  double v45 = v12;
  id v19 = [(SUUIStackItemView *)self imageViews];
  ...
  *(double *)&v47[5] = v20;
  ...
  double v29 = [(SUUIStackItemView *)self textView];
  double v30 = [v29 layout];
  double v31 = [v30 attributedString];
  long long v32 = [v24 _textViewLayoutWithWidth:v31 string:v28];
  uint64_t v33 = [(SUUIStackItemView *)self textView];
  [v33 setLayout:v32];
  ...
  if ([(SUUIStackItemView *)self numberOfLines] < 2)
  {
    ...
    uint64_t v35 = [(SUUIStackItemView *)self textView];
  ...
  else
  {
    ...
    uint64_t v35 = [(SUUIStackItemView *)self imageViews];
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  id v6 = a4;
  double v7 = [v5 style];
  CGFloat v8 = SUUIViewElementFontWithStyle(v7);
  if (!v8)
  {
    CGFloat v8 = SUUIFontPreferredFontForTextStyle(5);
  }
...
+ (id)_textViewLayoutWithWidth:(double)a3 string:(id)a4
{
  ...
  id v6 = objc_alloc_init(MEMORY[0x263F81650]);
  [v6 setLineSpacing:-2.0];
  objc_msgSend(v5, "addAttribute:value:range:", *MEMORY[0x263F81540], v6, 0, objc_msgSend(v5, "length"));
  double v7 = [[SUUIAttributedStringLayoutRequest alloc] initWithAttributedString:v5];
  [(SUUIAttributedStringLayoutRequest *)v7 setWidth:a3];
  CGFloat v8 = [[SUUIAttributedStringLayout alloc] initWithLayoutRequest:v7];
