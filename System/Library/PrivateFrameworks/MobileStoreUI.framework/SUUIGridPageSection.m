...
- (SUUIGridPageSection)initWithPageComponent:(id)a3
{
  ...
  id v4 = a3;
  v34.receiver = self;
  v34.super_class = (Class)SUUIGridPageSection;
  v5 = [(SUUIStorePageSection *)&v34 initWithPageComponent:v4];
  if (v5)
  {
    uint64_t v6 = [objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:5 valueOptions:0 capacity:0];
    v7 = (void *)*((void *)v5 + 11);
    *((void *)v5 + 11) = v6;
        ...
        if (v14)
        {
          ...
          do
          {
            for (uint64_t i = 0; i != v15; ++i)
            {
              ...
              double v21 = SUUILockupImageSizeForLockupSize(v19, [v20 itemKind]);
              long long v27 = v22;
              float64_t v28 = v21;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SUUIGridPageSection;
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  ...
  unint64_t v12 = [(SUUIStorePageSection *)self pageComponent];
  v13 = [v12 viewElement];
  [v6 addItemViewElement:v13];

  uint64_t v14 = [v19 item];
  uint64_t v15 = [(SUUIStorePageSection *)self pageComponent];
...
- (id)cellForIndexPath:(id)a3
{
  ...
  switch([v5 gridType])
  {
    ...
    case 5:
      ...
      uint64_t v8 = [(SUUIGridPageSection *)self _itemCellWithLockups:v7 indexPath:v4];
      goto LABEL_6;
    case 1:
      unint64_t v7 = [v5 children];
      uint64_t v8 = [(SUUIGridPageSection *)self _editorialLockupCellWithLockups:v7 indexPath:v4];
      goto LABEL_6;
    case 3:
      unint64_t v7 = [v5 children];
      uint64_t v8 = [(SUUIGridPageSection *)self _editorialCellWithEditorials:v7 indexPath:v4];
      goto LABEL_6;
    case 4:
      unint64_t v7 = [v5 children];
      uint64_t v8 = [(SUUIGridPageSection *)self _mediaCellWithMedia:v7 indexPath:v4];
LABEL_6:
      id v6 = (void *)v8;
...
{
  v9.receiver = self;
  v9.super_class = (Class)SUUIGridPageSection;
  uint64_t v7 = -[SUUIStorePageSection clickEventWithItem:elementName:index:](&v9, sel_clickEventWithItem_elementName_index_, a3, a4);
...
- (void)collectionViewDidConfirmItemOfferAtIndexPath:(id)a3
{
  ...
  double v5 = [(SUUIGridPageSection *)self _itemForIndex:v4];
  if (v5)
  {
    id v6 = [(SUUIStorePageSection *)self context];
    uint64_t v7 = [(SUUIGridPageSection *)self itemOfferClickEventWithItem:v5 elementName:*MEMORY[0x263F7BBB8] index:v4];
    if (v7)
    {
    ...
    double v11 = [(SUUIStorePageSection *)self performItemOfferActionForItem:v5];
...
- (void)collectionViewDidEndDisplayingCellForItemAtIndexPath:(id)a3
{
  uint64_t v4 = -[SUUIGridPageSection _itemForIndex:](self, "_itemForIndex:", [a3 item]);
  uint64_t v5 = v4;
  if (v4)
  {
    uint64_t v10 = v4;
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  id v6 = [(SUUIGridPageSection *)self _itemForIndex:v5];
  if (v6)
  {
  ...
  else if ([v4 gridType] == 4)
  {
    ...
    if (v5 < [v7 count])
    {
      ...
      uint64_t v10 = [(SUUIStorePageSection *)self clickEventWithMedia:v9 elementName:*MEMORY[0x263F7BBB8] index:v5];
      if (v10)
      {
...
{
  id v4 = a3;
  unint64_t v5 = -[SUUIGridPageSection _itemForIndex:](self, "_itemForIndex:", [v4 item]);
  id v6 = [v5 videos];
  ...
  if (v8)
  {
    char v9 = [(SUUIStorePageSection *)self context];
    uint64_t v10 = [v9 collectionView];

    double v11 = [v10 cellForItemAtIndexPath:v4];
    uint64_t v15 = MEMORY[0x263EF8330];
    uint64_t v16 = 3221225472;
    double v17 = __60__SUUIGridPageSection_collectionViewDidTapVideoAtIndexPath___block_invoke;
    double v18 = &unk_265402738;
    id v19 = v10;
    id v20 = v11;
    id v12 = v11;
    id v13 = v10;
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  ...
  id v8 = [v4 indexPath];
  uint64_t v5 = [v8 item];
  id v6 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", v5 / self->_numberOfColumns, objc_msgSend(v8, "section"));
  uint64_t v7 = [(SUUIStorePageSection *)self backgroundColorForIndexPath:v6];
...
- (id)itemOfferClickEventWithItem:(id)a3 elementName:(id)a4 index:(int64_t)a5
{
  v9.receiver = self;
  v9.super_class = (Class)SUUIGridPageSection;
  uint64_t v7 = -[SUUIStorePageSection itemOfferClickEventWithItem:elementName:index:](&v9, sel_itemOfferClickEventWithItem_elementName_index_, a3, a4);
  [(SUUIGridPageSection *)self _setPositionForClickEvent:v7 withElementIndex:a5];
  return v7;
}
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  if (self->_containsLockups)
  {
    ...
    double v17 = [(SUUIStorePageSection *)self pageComponent];
    uint64_t v18 = [v17 gridType];

    id v19 = [(SUUIStorePageSection *)self pageComponent];
    id v20 = v19;
    if (v19)
    {
      [v19 lockupStyle];
...
void __51__SUUIGridPageSection_prefetchResourcesWithReason___block_invoke(uint64_t a1, void *a2, BOOL *a3)
{
  ...
  if (*(void *)(a1 + 72) == 5)
  {
    ...
    if (v9)
    {
      ...
      {
        +[SUUILockupItemCellLayout videoThumbnailSizeForVideo:v9 clientContext:*(void *)(*(void *)(a1 + 32) + 96)];
  ...
  if ((v8 & 0xFFFFFFFFFFFFFFFDLL) == 1)
  {
    ...
    while (1)
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        if (v15 == 5)
        {
          uint64_t v16 = [(SUUIGridPageSection *)self _editorialLayoutForEditorial:v14];
        }
        else
        {
          if (v15 != 9) {
          ...
          uint64_t v16 = [(SUUIGridPageSection *)self _editorialLayoutForLockup:v14];
        }
        double v17 = v16;
...
LABEL_14:
  ...
  if (self->_isPad)
  {
    ...
    {
      self->_isLandscape = 0;
      int64_t v20 = [(SUUIGridPageSection *)self _numberOfPortraitColumnsWithGridType:v8];
    }
    else
    {
      self->_isLandscape = 1;
      int64_t v20 = [(SUUIGridPageSection *)self _numberOfLandscapeColumnsWithGridType:v8];
    }
  ...
  uint64_t v27 = objc_alloc_init(SUUIVideoImageDataConsumer);
  ...
  uint64_t v31 = SUUIUserInterfaceIdiom(self->_clientContext);
  uint64_t v32 = self->_videoImageDataConsumer;
  if (v31 == 1)
  {
    [(SUUIVideoImageDataConsumer *)v32 setAllowedOrientations:2];
    -[SUUIVideoImageDataConsumer setLandscapeSize:](self->_videoImageDataConsumer, "setLandscapeSize:", 221.0, 166.0);
  }
  else
  {
    [(SUUIVideoImageDataConsumer *)v32 setAllowedOrientations:3];
    -[SUUIVideoImageDataConsumer setLandscapeSize:](self->_videoImageDataConsumer, "setLandscapeSize:", 320.0, 180.0);
    -[SUUIVideoImageDataConsumer setPortraitSize:](self->_videoImageDataConsumer, "setPortraitSize:", 180.0, 320.0);
  }
  v33.receiver = self;
  v33.super_class = (Class)SUUIGridPageSection;
...
- (void)willHideInContext:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SUUIGridPageSection;
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
        ...
        v10 > 375.0))
  {
    ...
    if (self->_isPad)
    {
      if (self->_isLandscape) {
        int64_t v13 = [(SUUIGridPageSection *)self _numberOfLandscapeColumnsWithGridType:v12];
      }
      else {
        int64_t v13 = [(SUUIGridPageSection *)self _numberOfPortraitColumnsWithGridType:v12];
      }
    }
  ...
  v17.receiver = self;
  v17.super_class = (Class)SUUIGridPageSection;
  -[SUUIStorePageSection willTransitionToSize:withTransitionCoordinator:](&v17, sel_willTransitionToSize_withTransitionCoordinator_, v7, width, height);
}
...
void __51__SUUIGridPageSection_artworkRequest_didLoadImage___block_invoke(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
  id v17 = a2;
  id v7 = a3;
...
void __51__SUUIGridPageSection_artworkRequest_didLoadImage___block_invoke_2(uint64_t a1, void *a2, unsigned char *a3)
{
  id v13 = a2;
...
- (void)mediaView:(id)a3 playbackStateDidChange:(int64_t)a4
{
  ...
  if (v22)
  {
    ...
    if (v24 == [(SUUIStorePageSection *)self sectionIndex])
    {
      ...
      if ([v26 canRecordEventWithType:*MEMORY[0x263F7BB60]])
      {
        id v27 = objc_alloc_init(MEMORY[0x263F7B268]);
        uint64_t v28 = SUUIMetricsMediaEventTypeForPlaybackState((id)a4);
        [v27 setMediaEventType:v28];

        uint64_t v29 = [(SUUIStorePageSection *)self pageComponent];
        ...
        if (v32 && v33)
        {
          v39[0] = v33;
          v39[1] = v32;
          long long v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:v39 count:2];
...
void __77__SUUIGridPageSection_missingItemLoader_didLoadItems_invalidItemIdentifiers___block_invoke_2(uint64_t a1)
{
  ...
  v3 = objc_msgSend(MEMORY[0x263F088D0], "indexSetWithIndex:", objc_msgSend(*(id *)(a1 + 32), "sectionIndex"));
...
- (void)productPageOverlayDidDismiss:(id)a3
{
  ...
  uint64_t v5 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", self->_overlaySourceItemIndex, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
...
- (id)_artworkContextForLockupSize:(int64_t)a3
{
  ...
  {
    id v6 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:1282 valueOptions:0 capacity:0];
  ...
  id v8 = (SUUIItemArtworkContext *)objc_claimAutoreleasedReturnValue();
  if (!v8)
  {
    id v8 = objc_alloc_init(SUUIItemArtworkContext);
    uint64_t v9 = [(SUUIStorePageSection *)self context];
    id v10 = [v9 colorScheme];
    [(SUUIItemArtworkContext *)v8 setColorScheme:v10];

    id v11 = +[SUUIProductImageDataConsumer lockupConsumerWithSize:a3 itemKind:7];
    [(SUUIItemArtworkContext *)v8 setGeneralConsumer:v11];

    double v12 = +[SUUIStyledImageDataConsumer lockupIconConsumerWithSize:a3];
    [(SUUIItemArtworkContext *)v8 setIconConsumer:v12];

    uint64_t v13 = +[SUUIProductImageDataConsumer lockupConsumerWithSize:a3 itemKind:8];
    [(SUUIItemArtworkContext *)v8 setLetterboxConsumer:v13];

    id v14 = +[SUUIStyledImageDataConsumer lockupProductImageConsumerWithSize:a3];
    [(SUUIItemArtworkContext *)v8 setNewsstandConsumer:v14];

    id v15 = +[SUUIProductImageDataConsumer lockupConsumerWithSize:a3 itemKind:6];
...
LABEL_4:
  ...
  double v12 = [(SUUIGridPageSection *)self _artworkContextForLockupSize:a4];
...
- (id)_editorialCellWithEditorials:(id)a3 indexPath:(id)a4
{
  ...
  double v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x27050B070 forIndexPath:v7];
  double v11 = [v10 layout];
  BOOL v12 = SUUIEditorialLayoutOrientationForView(v9);
  ...
  else
  {
    ...
    double v15 = [(SUUIGridPageSection *)self _editorialLayoutForEditorial:v14];
...
- (id)_editorialLayoutForEditorial:(id)a3
{
  ...
  if (!v5)
  {
    id v6 = [SUUIEditorialLayout alloc];
    id v7 = [(SUUIStorePageSection *)self context];
    uint64_t v8 = [v7 textLayoutCache];
    double v5 = [(SUUIEditorialLayout *)v6 initWithEditorial:v4 layoutCache:v8];
    ...
    if (!editorialLayouts)
    {
      double v19 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
...
- (id)_editorialLayoutForLockup:(id)a3
{
  ...
  if (!v5)
  {
    ...
    double v5 = [(SUUIEditorialLayout *)v7 initWithEditorial:v6 layoutCache:v9];

    if (v4) {
      [v4 lockupStyle];
    }
    BOOL IsHorizontal = SUUILockupLayoutStyleIsHorizontal(0);
    double v11 = 328.0;
    if (IsHorizontal)
    {
      double v11 = 477.0;
    ...
    -[SUUIEditorialLayout setLayoutWidth:forOrientation:](v5, "setLayoutWidth:forOrientation:", 1, v11, 200.0);
    [(SUUIEditorialLayout *)v5 setLayoutWidth:0 forOrientation:v12];
    editorialLayouts = self->_editorialLayouts;
    if (!editorialLayouts)
    {
      double v14 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
...
- (id)_editorialLockupCellWithLockups:(id)a3 indexPath:(id)a4
{
  ...
  uint64_t v8 = [(SUUIStorePageSection *)self context];
  uint64_t v9 = [v8 collectionView];
  double v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x2704F98B0 forIndexPath:v7];
  double v11 = [v10 layout];
...
- (void)_enumerateVisibleIndexPathsWithBlock:(id)a3
{
  ...
  int64_t v7 = [(SUUIStorePageSection *)self sectionIndex];
...
- (double)_heightForEditorialAtIndexPath:(id)a3
{
  ...
  if (self->_numberOfColumns == 1)
  {
    ...
    uint64_t v9 = [(SUUIGridPageSection *)self _editorialLayoutForEditorial:v8];
  ...
  else
  {
    ...
    uint64_t v9 = [(SUUIGridPageSection *)self _editorialLayoutForEditorial:v13];
    ...
    if (v15 < [v6 count])
    {
      ...
      long long v17 = [(SUUIGridPageSection *)self _editorialLayoutForEditorial:v16];
...
- (double)_heightForEditorialLockup:(id)a3
{
  ...
  double v6 = v5;
  id v7 = [(SUUIGridPageSection *)self _editorialLayoutForLockup:v4];
...
- (id)_itemCellWithLockups:(id)a3 indexPath:(id)a4
{
  ...
  double v8 = [(SUUIStorePageSection *)self context];
  uint64_t v9 = [v8 collectionView];
  uint64_t v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x270506410 forIndexPath:v7];
  ...
  if (v16 >= [v6 count])
  {
    ...
    objc_msgSend(v14, "setVideoThumbnailSize:", *MEMORY[0x263F001B0], *(double *)(MEMORY[0x263F001B0] + 8));
  ...
  if (self->_isPad)
  {
    double v18 = [(SUUIStorePageSection *)self pageComponent];
...
- (void)_loadImageForItem:(id)a3 lockupSize:(int64_t)a4 loader:(id)a5 reason:(int64_t)a6
{
  id v18 = a3;
  id v10 = a5;
  unint64_t v11 = [(SUUIGridPageSection *)self _artworkContextForLockupSize:a4];
  double v12 = [v11 URLForItem:v18];

  if (v12)
  {
    double v13 = objc_alloc_init(SUUIArtworkRequest);
    [(SUUIArtworkRequest *)v13 setDelegate:self];
    unint64_t v14 = [(SUUIGridPageSection *)self _artworkContextForLockupSize:a4];
    ...
    unint64_t v17 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[SUUIResourceRequest requestIdentifier](v13, "requestIdentifier"));
...
- (void)_loadImageForVideo:(id)a3 thumbnailSize:(CGSize)a4 loader:(id)a5 reason:(int64_t)a6
{
  ...
  if (v14)
  {
    ...
    artworkRequests = self->_artworkRequests;
    unint64_t v17 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[SUUIResourceRequest requestIdentifier](v15, "requestIdentifier"));
    [(NSMapTable *)artworkRequests setObject:v17 forKey:v18];
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    id v7 = [(SUUIGridPageSection *)self _missingItemLoader];
...
- (id)_mediaCellWithMedia:(id)a3 indexPath:(id)a4
{
  ...
  id v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x2704FAC30 forIndexPath:v7];
...
LABEL_6:
        ...
        if (v18)
        {
          id v19 = [(SUUIGridPageSection *)self _newSizeToFitArtworkRequestWithArtwork:v18 mediaIndex:v11];
          artworkRequests = self->_artworkRequests;
...
- (id)_newSizeToFitArtworkRequestWithArtwork:(id)a3 mediaIndex:(int64_t)a4
{
  ...
  -[SUUIGridPageSection _mediaWidthForMediaIndex:gridWidth:](self, "_mediaWidthForMediaIndex:gridWidth:", a4);
  double v12 = v11;

  double v13 = +[SUUISizeToFitImageDataConsumer consumerWithConstraintSize:](SUUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", v12, v9);
...
- (id)_popSourceViewForOverlayController:(id)a3
{
  ...
  float v8 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", self->_overlaySourceItemIndex, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
  ...
  if (v14)
  {
    if (v13)
    {
      ...
      if ((v38 & 2) != 0)
      {
        ...
        {
          long long v35 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x263F089C8]);
...
- (void)_reloadEditorialLockupCell:(id)a3 withLockup:(id)a4 index:(int64_t)a5
{
  id v8 = a3;
  id v9 = a4;
  uint64_t v33 = [(SUUIStorePageSection *)self context];
  ...
  CGFloat v32 = [(SUUIGridPageSection *)self _cellImageForItem:v12 lockupSize:0];
  ...
  double v31 = [(SUUIGridPageSection *)self _editorialLayoutForLockup:v9];
  ...
  double v24 = +[SUUIItemStateCenter defaultCenter];
...
- (void)_reloadItemCell:(id)a3 withLockup:(id)a4 index:(int64_t)a5
{
  ...
  if (v10)
  {
    double v12 = [(SUUIGridPageSection *)self _cellImageForItem:v10 lockupSize:0];
    ...
    objc_msgSend(v11, "setVideoThumbnailSize:", *MEMORY[0x263F001B0], *(double *)(MEMORY[0x263F001B0] + 8));
  }
  else
  {
    [v11 setIconImage:0];
  ...
  double v13 = +[SUUIItemStateCenter defaultCenter];
...
- (void)_selectItem:(id)a3 withIndex:(int64_t)a4
{
  ...
  id v8 = [(SUUIGridPageSection *)self clickEventWithItem:v6 elementName:*MEMORY[0x263F7BBB8] index:a4];
  if (v8)
  {
    ...
    || ([v11 sectionsViewController:v10 showProductPageForItem:v6] & 1) == 0)
  {
    ...
    {
      CGFloat v25 = [[SUUIPlayableAsset alloc] initWithVideo:v15];
      int64_t v26 = a4;
      id v18 = [(SUUIStorePageSection *)self context];
      id v19 = [v18 clientContext];
      SUUIVideoPreviewPlayPlayableAsset(v25, v19);
      id v21 = v20 = v7;

      double v22 = [(SUUIStorePageSection *)self context];
...
uint64_t __45__SUUIGridPageSection__selectItem_withIndex___block_invoke(uint64_t a1)
{
...
void __63__SUUIGridPageSection__showProductPageWithItem_index_animated___block_invoke(uint64_t a1, char a2)
{
  if ((a2 & 1) == 0)
  {
    ...
    if (!*(void *)(v5 + 176))
    {
      id v6 = [[SUUIProductPageOverlayController alloc] initWithParentViewController:v9];
        ...
        if ([v16 section] == v7)
        {
          ...
          if (v17 < v10)
          {
            ...
            if (v9 == 1)
            {
              ...
              id v21 = [(SUUIGridPageSection *)v25 _editorialLayoutForLockup:v23];
            ...
            else
            {
              ...
              id v21 = [(SUUIGridPageSection *)v25 _editorialLayoutForEditorial:v20];
...
LABEL_4:
    ...
    -[SUUIGridPageSection _loadImageForVideo:thumbnailSize:loader:reason:](self, "_loadImageForVideo:thumbnailSize:loader:reason:", v7, v9, 1, width, height);
  uint64_t v13 = -[SUUISizeValue initWithSize:]([SUUISizeValue alloc], "initWithSize:", width, height);
  uint64_t v12 = [(NSMutableDictionary *)self->_videoPlaceholderImages objectForKey:v13];
  if (!v12)
  {
    uint64_t v14 = width <= height ? 1 : 2;
    uint64_t v12 = [(SUUIVideoImageDataConsumer *)self->_videoImageDataConsumer imageForColor:0 orientation:v14];
    if (v12) {
