...
- (SUUIRedeemIdViewController)initWithClientContext:(id)a3
{
  ...
  if (v5)
  {
    v6 = (void *)[MEMORY[0x263EFFA78] mutableCopy];
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  double v8 = [(SUUIRedeemIdViewController *)self manager];
...
{
  id v6 = a4;
  id v8 = [(SUUIRedeemIdViewController *)self _fieldForIndexPath:a3];
  id v7 = [(SUUIRedeemIdViewController *)self fields];
...
- (void)_refreshNavigationItem
{
  BOOL v3 = [(SUUIRedeemIdViewController *)self _validateForm];
  id v4 = [(SUUIRedeemIdViewController *)self nextButton];
  [v4 setEnabled:v3];
}

- (BOOL)_validateForm
{
  BOOL v3 = [(SUUIRedeemIdViewController *)self fields];
  id v4 = [v3 objectForKeyedSubscript:@"national_redeem_first_name"];
  uint64_t v5 = [v4 length];

  id v6 = [(SUUIRedeemIdViewController *)self fields];
  id v7 = [v6 objectForKeyedSubscript:@"national_redeem_last_name"];
  uint64_t v8 = [v7 length];

  double v9 = [(SUUIRedeemIdViewController *)self fields];
...
- (void)_reloadFooter
{
  id v3 = [(SUUIRedeemIdViewController *)self tableView];
  v2 = [MEMORY[0x263F088D0] indexSetWithIndex:3];
...
- (id)_finalOutputFields
{
  ...
  id v3 = NSString;
  id v4 = [(SUUIRedeemIdViewController *)self fields];
  ...
  v16[1] = v10;
  v15[2] = @"nationalId";
  uint64_t v11 = [(SUUIRedeemIdViewController *)self fields];
  v12 = [v11 objectForKeyedSubscript:@"national_redeem_national_id"];
  v16[2] = v12;
  objc_super v13 = [NSDictionary dictionaryWithObjects:v16 forKeys:v15 count:3];
...
- (void)_initializeManager
{
  id v3 = [SUUIRedeemIdManager alloc];
  id v4 = [(SUUIRedeemIdViewController *)self clientContext];
  uint64_t v5 = [(SUUIRedeemIdManager *)v3 initWithClientContext:v4];
  [(SUUIRedeemIdViewController *)self setManager:v5];

  id v6 = [(SUUIRedeemIdViewController *)self manager];
  [v6 setDelegate:self];
}
...
- (void)_initializeTableView
{
  ...
  id v4 = objc_msgSend(v3, "initWithFrame:style:", 1, *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
  [(SUUIRedeemIdViewController *)self setTableView:v4];

  uint64_t v5 = [(SUUIRedeemIdViewController *)self manager];
  id v6 = [(SUUIRedeemIdViewController *)self tableView];
  [v6 setDataSource:v5];

  id v7 = [(SUUIRedeemIdViewController *)self manager];
  uint64_t v8 = [(SUUIRedeemIdViewController *)self tableView];
  [v8 setDelegate:v7];

  double v9 = [(SUUIRedeemIdViewController *)self view];
  objc_super v10 = [(SUUIRedeemIdViewController *)self tableView];
  [v9 addSubview:v10];

  id v12 = [(SUUIRedeemIdViewController *)self tableView];
  uint64_t v11 = [(SUUIRedeemIdViewController *)self manager];
  [v11 setTableView:v12];
}

- (void)_initializeNavigationItem
{
  id v16 = (id)[objc_alloc(MEMORY[0x263F824A8]) initWithBarButtonSystemItem:1 target:self action:sel__cancelPressed];
  ...
  id v6 = +[SUUIClientContext localizedStringForKey:@"REDEEM_NATIONAL_ID_NEXT_BUTTON" inBundles:0 inTable:@"Redeem"];
  }
  ...
  uint64_t v8 = [(SUUIRedeemIdViewController *)self nextButton];
  [v8 setEnabled:0];

  double v9 = [(SUUIRedeemIdViewController *)self navigationItem];
  objc_super v10 = [(SUUIRedeemIdViewController *)self clientContext];
  uint64_t v11 = v10;
  if (v10) {
    [v10 localizedStringForKey:@"REDEEM_NATIONAL_ID_VIEW_TITLE" inTable:@"Redeem"];
  }
  else {
  id v12 = +[SUUIClientContext localizedStringForKey:@"REDEEM_NATIONAL_ID_VIEW_TITLE" inBundles:0 inTable:@"Redeem"];
  }
  [v9 setTitle:v12];

  objc_super v13 = [(SUUIRedeemIdViewController *)self navigationItem];
  [v13 setLeftBarButtonItem:v16];

  uint64_t v14 = [(SUUIRedeemIdViewController *)self navigationItem];
...
- (void)_cancelPressed
{
  id v3 = [(SUUIRedeemIdViewController *)self delegate];
  [v3 redeemIdViewControllerDidCancel:self];
}

- (void)_nextPressed
{
  id v4 = [(SUUIRedeemIdViewController *)self manager];
  [v4 handleNextPressed];

  if (![(SUUIRedeemIdViewController *)self _validateForm])
  {
    id v6 = [MEMORY[0x263F08690] currentHandler];
    id v7 = [(SUUIRedeemIdViewController *)self fields];
    [v6 handleFailureInMethod:a2, self, @"SUUIRedeemIdViewController.m", 205, @"Submitting fields (next pressed) without the form actually being valid. %@", v7 object file lineNumber description];
  }
  id v8 = [(SUUIRedeemIdViewController *)self delegate];
  uint64_t v5 = [(SUUIRedeemIdViewController *)self _finalOutputFields];
  [v8 redeemIdViewController:self submittedWithFields:v5];
}
...
- (void)_subscribeToKeyboardEvents
{
  ...
  [v4 addObserver:self selector:sel__keyboardDidHide_ name:*MEMORY[0x263F837A0] object:0];
}

- (void)_keyboardWillShow:(id)a3
{
  id v5 = [a3 userInfo];
  id v4 = [v5 valueForKey:*MEMORY[0x263F837B8]];
...
{
  id v4 = a3;
  id v5 = [(SUUIRedeemIdViewController *)self manager];
  [v5 dismissActiveCell];

  id v6 = [v4 userInfo];
  id v7 = [v6 valueForKey:*MEMORY[0x263F837B8]];

  id v8 = [v4 userInfo];

  double v9 = [v8 objectForKeyedSubscript:*MEMORY[0x263F83780]];

  objc_super v10 = (void *)MEMORY[0x263F82E00];
  [v9 floatValue];
...
- (void)_adjustInsetsForKeyboardFrameValue:(id)a3
{
  ...
  double v9 = v8;
  double v11 = v10;
  double v12 = [(SUUIRedeemIdViewController *)self tableView];
  ...
  id v39 = [(SUUIRedeemIdViewController *)self tableView];
...
- (SUUIRedeemIdDelegate)delegate
{
  ...
  return (SUUIRedeemIdDelegate *)WeakRetained;
}
