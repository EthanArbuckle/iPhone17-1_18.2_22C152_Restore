...
- (void)setTitleView:(id)a3
{
  ...
  if (v5)
  {
    [(SUUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost *)self addSubview:v9];
...
- (void)layoutSubviews
{
  ...
  *(void *)&rect.size.CGFloat width = SUUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost;
  [(CGFloat *)(objc_super *)&rect.origin.y layoutSubviews];
  [(SUUIMenuBarTemplateDocumentViewControllerEmbeddedPaletteHost *)self bounds];
  CGFloat v4 = v3;
  CGFloat v6 = v5;
  CGFloat v8 = v7;
  CGFloat v10 = v9;
