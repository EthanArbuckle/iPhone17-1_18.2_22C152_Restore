...
- (id)formattedAddressString
{
  uint64_t v3 = SUUIContactsFramework();
  id v4 = objc_alloc_init((Class)SUUIWeakLinkedClassForString(&cfstr_Cnmutableposta.isa, v3));
  v5 = v4;
  ...
  uint64_t v7 = SUUIContactsFramework();
  v8 = objc_msgSend(SUUIWeakLinkedClassForString(&cfstr_Cnpostaladdres.isa, v7), "singleLineStringFromPostalAddress:addCountryName:", v5, 1);
