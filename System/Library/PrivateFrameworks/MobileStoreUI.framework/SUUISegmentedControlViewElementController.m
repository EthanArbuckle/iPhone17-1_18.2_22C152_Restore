...
- (SUUISegmentedControlViewElementController)initWithViewElement:(id)a3
{
  return [(SUUISegmentedControlViewElementController *)self initWithViewElement:a3 segmentedControl:0];
}
...
- (void)menuPopover:(id)a3 didSelectMenuItemAtIndex:(int64_t)a4
{
  int64_t v5 = [(SUUIFlexibleSegmentedControl *)self->_segmentedControl moreListIndex] + a4;
  [(SUUISegmentedControlViewElement *)self->_viewElement dispatchEventOfType:2 forItemAtIndex:v5];
  [(SUUIFlexibleSegmentedControl *)self->_segmentedControl setSelectedSegmentIndex:v5];
  [(SUUISegmentedControlViewElementController *)self _destroyPopoverController];
}
...
- (void)_connectToSegmentedControl:(id)a3
{
  ...
  int64_t v5 = [(SUUISegmentedControlViewElement *)self->_viewElement moreListTitle];
  ...
  CGFloat v6 = [(SUUISegmentedControlViewElement *)self->_viewElement style];
  CGFloat v7 = SUUIViewElementPlainColorWithStyle(v6, 0);
  [v8 setTintColor:v7];
...
{
  id v8 = a3;
  int64_t defaultMaximumNumberOfVisibleItems = [(SUUISegmentedControlViewElement *)self->_viewElement maximumNumberOfVisibleItems];
  ...
  int64_t v5 = [(SUUISegmentedControlViewElement *)self->_viewElement style];
...
- (void)_showMoreListSheetWithTitles:(id)a3 selectedIndex:(int64_t)a4
{
  ...
  {
    id v6 = a3;
    id v26 = [(SUUISegmentedControlViewElementController *)self parentViewController];
    ...
    v11 = [[SUUIMenuViewController alloc] initWithMenuTitles:v6];
    ...
    v14 = [(SUUIFlexibleSegmentedControl *)self->_segmentedControl moreListTitle];
    [(SUUIMenuViewController *)v13 setTitle:v14];

    if (v10 == 1) {
      [(SUUIMenuViewController *)self->_menuSheetViewController setMenuStyle:1];
    }
    v15 = (UIBarButtonItem *)objc_alloc_init(MEMORY[0x263F824A8]);
    menuSheetCancelButtonItem = self->_menuSheetCancelButtonItem;
    ...
    v18 = [(SUUISegmentedControlViewElementController *)self clientContext];
    v19 = v18;
    if (v18) {
      [v18 localizedStringForKey:@"CANCEL"];
    }
    else {
    v20 = +[SUUIClientContext localizedStringForKey:@"CANCEL" inBundles:0];
    }
    [(UIBarButtonItem *)v17 setTitle:v20];

    v21 = [(SUUIMenuViewController *)self->_menuSheetViewController navigationItem];
    [v21 setLeftBarButtonItem:self->_menuSheetCancelButtonItem];

    v22 = (void *)[objc_alloc(MEMORY[0x263F829B8]) initWithRootViewController:self->_menuSheetViewController];
...
- (void)_showPopoverMoreListWithTitles:(id)a3
{
  ...
  {
    id v4 = a3;
    int64_t v5 = [[SUUIMenuPopoverController alloc] initWithMenuTitles:v4];
    ...
    segmentedControl = self->_segmentedControl;
    -[SUUIMenuPopoverController presentFromRect:inView:permittedArrowDirections:animated:](v7, "presentFromRect:inView:permittedArrowDirections:animated:", segmentedControl, 15, 1);
  }
}
