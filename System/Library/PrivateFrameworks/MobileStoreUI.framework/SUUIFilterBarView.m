...
- (SUUIFilterBarView)initWithFrame:(CGRect)a3;
...
@implementation SUUIFilterBarView

- (SUUIFilterBarView)initWithFrame:(CGRect)a3
{
  v13.receiver = self;
  v13.super_class = (Class)SUUIFilterBarView;
  ...
  if (v3)
  {
    ...
    centerElementViews = v3->_centerElementViews;
    v3->_centerElementViews = v4;

    v6 = (NSMutableArray *)objc_alloc_init(MEMORY[0x263EFF980]);
    leftElementViews = v3->_leftElementViews;
    v3->_leftElementViews = v6;

    v8 = (NSMutableArray *)objc_alloc_init(MEMORY[0x263EFF980]);
    rightElementViews = v3->_rightElementViews;
    v3->_rightElementViews = v8;
    ...
    v3->_viewElementViews = (NSMapTable *)v10;
  }
  return v3;
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SUUIFilterBarView;
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  v11[1] = 3221225472;
  v11[2] = __68__SUUIFilterBarView_prefetchResourcesForViewElement_reason_context___block_invoke;
  v11[3] = &unk_265400BE8;
  id v9 = v8;
  objc_super v13 = &v15;
  int64_t v14 = a4;
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v13[1] = 3221225472;
  v13[2] = __63__SUUIFilterBarView_requestLayoutForViewElement_width_context___block_invoke;
  v13[3] = &unk_265400C10;
  double v16 = a4;
  id v17 = a1;
  id v14 = v10;
...
uint64_t __63__SUUIFilterBarView_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  id v8 = a2;
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  v14[1] = 3221225472;
  v14[2] = __59__SUUIFilterBarView_sizeThatFitsWidth_viewElement_context___block_invoke;
  v14[3] = &unk_265400BE8;
  id v9 = v8;
  double v17 = a3;
  id v15 = v9;
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v14[0] = MEMORY[0x263EF8330];
  v14[1] = 3221225472;
  v14[2] = __57__SUUIFilterBarView_reloadWithViewElement_width_context___block_invoke;
  v14[3] = &unk_265400C88;
  void v14[4] = self;
  id v15 = v8;
  double v17 = a4;
...
void __57__SUUIFilterBarView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  do
  {
    uint64_t v5 = [*(id *)(a1 + 40) childViewElementsForAlignment:qword_2568A1EF0[v4]];
    long long v36 = 0u;
    long long v37 = 0u;
    long long v38 = 0u;
    long long v39 = 0u;
      ...
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (v11 <= 68)
        {
          if (v11 > 12)
          {
            ...
            [(SUUISearchBarController *)v23 addTarget:*(void *)(a1 + 32) action:sel__imageTapAction_];
            goto LABEL_37;
          }
          if (v11 != 8)
          {
...
LABEL_29:
        ...
        switch(v11)
        {
          case 'E':
            ...
            goto LABEL_37;
          case 'j':
            uint64_t v23 = [[SUUISearchBarController alloc] initWithSearchBarViewElement:v10];
            v24 = [*(id *)(a1 + 48) clientContext];
            [(SUUISearchBarController *)v23 setClientContext:v24];

            v25 = [*(id *)(a1 + 48) parentViewController];
            [(SUUISearchBarController *)v23 setParentViewController:v25];
            ...
            [v26 addObject:v23];
            id v13 = [(SUUISearchBarController *)v23 searchBar];
            [v3 addView:v13];
LABEL_37:
          ...
          case 'm':
            uint64_t v12 = v4;
            id v13 = [v3 addReusableViewWithReuseIdentifier:0x270504D50];
            id v14 = [[SUUISegmentedControlViewElementController alloc] initWithViewElement:v10 segmentedControl:v13];
            id v15 = [*(id *)(a1 + 48) clientContext];
            [(SUUISegmentedControlViewElementController *)v14 setClientContext:v15];

            id v16 = [*(id *)(a1 + 48) parentViewController];
            [(SUUISegmentedControlViewElementController *)v14 setParentViewController:v16];
...
- (void)setContentInset:(UIEdgeInsets)a3
{
    ...
    || a3.bottom != self->_contentInset.bottom)
  {
    ...
    [(SUUIFilterBarView *)self setNeedsLayout];
  }
}
...
- (void)layoutSubviews
{
  ...
  if (v54->_bottomDividerView)
  {
    ...
    -[SUUIDividerView setFrame:](v54->_bottomDividerView, "setFrame:", 0.0, v6 - v51, v53, v51);
  }
...
- (void)menuPopover:(id)a3 didSelectMenuItemAtIndex:(int64_t)a4
{
  if (self->_focusedMenuButton)
  {
    ...
    [(SUUIFilterBarView *)self _destroyMenuPopover];
  }
}
...
- (void)_buttonAction:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = SUUICollectionViewCellForView(self);
  CGFloat v6 = SUUICollectionViewForView(self);
...
{
  id v4 = a3;
  [(SUUIFilterBarView *)self bringSubviewToFront:v4];
...
- (void)_menuButtonAction:(id)a3
{
  ...
  if (v8)
  {
    ...
    uint64_t v10 = [SUUIMenuPopoverController alloc];
    uint64_t v11 = [v8 menuItemTitles];
    float v12 = -[SUUIMenuPopoverController initWithMenuTitles:selectedIndex:](v10, "initWithMenuTitles:selectedIndex:", v11, [v8 selectedItemIndex]);
...
+ (id)_attributedStringForButtonText:(id)a3 style:(id)a4 context:(id)a5
{
  ...
  if (!v10)
  {
    uint64_t v10 = [MEMORY[0x263F81708] systemFontOfSize:17.0];
  }
  uint64_t v11 = [v9 tintColor];
  float v12 = SUUIViewElementPlainColorWithStyle(v8, v11);

  if (!v12)
  {
    float v12 = [MEMORY[0x263F825C8] labelColor];
  }
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  if (!v8)
  {
    id v8 = [MEMORY[0x263F81708] systemFontOfSize:17.0];
  }
  id v9 = [v6 tintColor];
