...
- (SUUIStorePageSectionsViewController)initWithLayoutStyle:(int64_t)a3
{
  ...
  v5 = [(SUUIStorePageSectionsViewController *)&v12 initWithNibName:0 bundle:0];
  v6 = v5;
  if (v5)
  {
    v5->_layoutStyle = a3;
    ...
    [(SUUIStorePageSectionsViewController *)v6 setRestorationIdentifier:v8];

    v9 = +[SUUIItemStateCenter defaultCenter];
    [v9 addObserver:v6];

    v10 = [MEMORY[0x263F08A00] defaultCenter];
    [v10 addObserver:v6 selector:sel__contentSizeChangeNotification_ name:*MEMORY[0x263F83428] object:0];
  }
  return v6;
}
...
- (SUUIStorePageSectionsViewController)initWithCoder:(id)a3
{
  return [(SUUIStorePageSectionsViewController *)self initWithLayoutStyle:0];
}
...
- (void)dealloc
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SUUIStorePageSectionsViewController *)self _unregisterForNotificationsForEntityProvider:*(void *)(*((void *)&v12 + 1) + 8 * v9++)];
      }
      while (v7 != v9);
  ...
  [(SUUICollectionView *)self->_collectionView setDataSource:0];
  [(SUUICollectionView *)self->_collectionView setDelegate:0];
  ...
  [(SUUIViewController *)&v11 dealloc];
}
...
- (UICollectionView)collectionView
{
  ...
  if (!collectionView)
  {
    id v4 = [(SUUIStorePageSectionsViewController *)self _newStorePageCollectionViewLayout];
    v5 = [SUUICollectionView alloc];
    uint64_t v6 = [MEMORY[0x263F82B60] mainScreen];
    [v6 bounds];
    uint64_t v7 = -[SUUICollectionView initWithFrame:collectionViewLayout:](v5, "initWithFrame:collectionViewLayout:", v4);
    ...
    uint64_t v9 = [(SUUIColorScheme *)self->_colorScheme backgroundColor];
    v10 = v9;
    if (v9)
    {
      id v11 = v9;
    ...
    long long v13 = (void *)[objc_alloc(MEMORY[0x263F82938]) initWithTarget:self action:sel__longPressAction_];
    [(SUUICollectionView *)self->_collectionView addGestureRecognizer:v13];
    [v13 setCancelsTouchesInView:1];
    [v13 setDelaysTouchesBegan:0];
    long long v14 = (UITapGestureRecognizer *)[objc_alloc(MEMORY[0x263F82CB0]) initWithTarget:self action:sel__handleTap_];
...
- (id)defaultSectionForComponent:(id)a3
{
  ...
  {
    case 1:
      uint64_t v6 = SUUIAccountButtonsSection;
      goto LABEL_27;
    case 3:
      uint64_t v7 = [v4 viewElement];

      if (v7) {
        uint64_t v6 = SUUIRowViewElementPageSection;
      }
      else {
        uint64_t v6 = SUUIRowSection;
      }
      goto LABEL_27;
    case 4:
      uint64_t v6 = SUUIDividerPageSection;
      goto LABEL_27;
    case 5:
      uint64_t v6 = SUUIEditorialPageSection;
      goto LABEL_27;
    case 6:
    case 13:
    case 18:
      uint64_t v6 = SUUICarouselPageSection;
      goto LABEL_27;
    case 8:
      uint64_t v8 = [(SUUIStorePageSectionsViewController *)self _defaultSectionForGridComponent:v4];
      goto LABEL_28;
    case 9:
      v5 = [v4 viewElement];
      ...
      break;
    case 10:
      uint64_t v6 = SUUIMediaPageSection;
      goto LABEL_27;
    case 12:
      uint64_t v6 = SUUIQuicklinksPageSection;
      goto LABEL_27;
    case 14:
      uint64_t v6 = SUUISpacePageSection;
      goto LABEL_27;
    case 15:
      uint64_t v8 = [(SUUIStorePageSectionsViewController *)self _defaultSectionForSwooshComponent:v4];
      goto LABEL_28;
    case 16:
      uint64_t v6 = SUUIBrowseItemPageSection;
      goto LABEL_27;
    case 17:
      uint64_t v6 = SUUIBrowseHeaderPageSection;
      goto LABEL_27;
    case 20:
      uint64_t v6 = SUUIFacebookPageSection;
      goto LABEL_27;
    case 21:
      uint64_t v6 = SUUIReviewListPageSection;
      goto LABEL_27;
    case 22:
      ...
      goto LABEL_27;
    case 23:
      uint64_t v6 = SUUITracklistPageSection;
      goto LABEL_27;
    case 24:
LABEL_10:
      uint64_t v6 = SUUIViewElementPageSection;
      goto LABEL_27;
    case 25:
      uint64_t v6 = SUUISearchBarPageSection;
      goto LABEL_27;
    case 26:
      uint64_t v6 = SUUIKeyValueInfoListPageSection;
      goto LABEL_27;
    case 27:
      uint64_t v6 = SUUIVerticalInfoListPageSection;
LABEL_27:
...
{
  [(SUUIProductPageOverlayController *)self->_overlayController setDelegate:0];
  [(SUUIProductPageOverlayController *)self->_overlayController dismiss];
...
- (void)invalidateAndReload
{
  ...
  id v4 = [(SUUIStorePageSectionsViewController *)self _collectionViewSublayouts];
  long long v22 = 0u;
  long long v23 = 0u;
  long long v24 = 0u;
  long long v25 = 0u;
  ...
  uint64_t v9 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
  [v9 invalidateLayout];
...
- (SUUIResourceLoader)resourceLoader
{
  ...
  if (!resourceLoader)
  {
    ...
    uint64_t v5 = [(SUUIViewController *)self clientContext];
    ...
    [(SUUIStorePageSectionsViewController *)self setResourceLoader:v6];
    resourceLoader = self->_resourceLoader;
  }
...
- (void)setColorScheme:(id)a3
{
  if (self->_colorScheme != a3)
  {
    ...
    id v6 = [(SUUIColorScheme *)self->_colorScheme backgroundColor];
    uint64_t v7 = v6;
    if (v6)
    {
      id v8 = v6;
...
- (void)setActiveMetricsImpressionSession:(id)a3
{
  id v5 = (SUUIMetricsImpressionSession *)a3;
...
- (void)setPinningTransitionStyle:(int64_t)a3
{
  if (self->_pinningTransitionStyle != a3)
  {
    ...
    v5[3] = &unk_265401D88;
    v5[4] = self;
    [(SUUIStorePageSectionsViewController *)self _enumerateSectionContextsUsingBlock:v5];
    id v4 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
    [v4 invalidateLayout];
  }
}
...
- (void)setMetricsController:(id)a3
{
  id v5 = (SUUIMetricsController *)a3;
...
- (void)setSectionsWithPageComponents:(id)a3
{
  ...
  if (v6)
  {
    id v4 = objc_alloc_init(SUUIStorePageSplitsDescription);
    id v5 = objc_alloc_init(SUUIStorePageSplit);
  ...
  {
    [(SUUIStorePageSectionsViewController *)self setSectionsWithSplitsDescription:0];
  }
}
...
- (void)setSectionsWithSplitsDescription:(id)a3
{
  ...
  id v5 = (SUUIStorePageSplitsDescription *)a3;
  id v6 = v5;
  if (self->_ignoreSectionsChangeCount < 1)
  {
    if (self->_splitsDescription != v5)
    {
      ...
      id v56 = (id)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:0 capacity:0];
      long long v47 = 0u;
      long long v48 = 0u;
      long long v49 = 0u;
      long long v50 = 0u;
      ...
      int64_t v15 = [(SUUIStorePageSplitsDescription *)self->_splitsDescription numberOfSplits];
      ...
      long long v18 = (objc_class *)objc_alloc_init(MEMORY[0x263EFF980]);
      long long v19 = *(Class *)((char *)&self->super.super.super.super.isa + v31);
      *(Class *)((char *)&self->super.super.super.super.isa + v31) = v18;

      long long v20 = (SUUIStorePageSplitsDescription *)[(SUUIStorePageSplitsDescription *)v6 copy];
      splitsDescription = self->_splitsDescription;
      self->_splitsDescription = v20;

      int64_t v22 = [(SUUIStorePageSplitsDescription *)self->_splitsDescription numberOfSplits];
      uint64_t v43 = 0;
      v44 = &v43;
      ...
      v36[6] = &v51;
      v36[7] = &v43;
      [(SUUIStorePageSectionsViewController *)self _updateCollectionViewWithUpdates:v36];
      if (!v44[3]) {
        goto LABEL_31;
      }
      long long v34 = 0u;
...
LABEL_31:
        ...
        [(SUUIStorePageSectionsViewController *)self _reloadRelevantEntityProviders];
  ...
  {
    long long v24 = [MEMORY[0x263EFF9D0] null];
...
void __72__SUUIStorePageSectionsViewController_setSectionsWithSplitsDescription___block_invoke_2(uint64_t a1, void *a2, double a3)
{
  ...
  id v9 = &OBJC_IVAR___SUUIViewReuseCollectionViewCell__allViewTextProperties;
  if (v8)
  {
    uint64_t v10 = v8;
    uint64_t v50 = 0;
...
LABEL_27:
  ...
  uint64_t v50 = 0;
LABEL_31:
  v44 = [*(id *)(*(void *)(a1 + 32) + v9[653]) lastObject];
...
- (void)showOverlayWithProductPage:(id)a3 metricsPageEvent:(id)a4
{
  ...
  id v7 = [[SUUIProductPageOverlayController alloc] initWithParentViewController:self];
  overlayController = self->_overlayController;
  self->_overlayController = v7;

  id v9 = self->_overlayController;
  uint64_t v10 = [(SUUIViewController *)self clientContext];
  ...
  if (a3)
  {
    if (!refreshControl)
    {
      ...
      if (collectionView)
      {
        ...
        [(SUUICollectionView *)collectionView setRefreshControl:v8];
      }
      return;
    }
  }
...
- (void)_longPressAction:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v6 = -[SUUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:");
    id v7 = v6;
    if (v6)
    {
...
- (void)loadView
{
  ...
  objc_super v5 = [(SUUIStorePageSectionsViewController *)self collectionView];
  ...
  if (self->_stackedBar)
  {
    ...
    {
      uint64_t v12 = [(SUUIStorePageSectionsViewController *)self navigationController];
      uint64_t v13 = [v12 navigationBar];
      [v13 frame];
      double Height = CGRectGetHeight(v21);

      objc_super v15 = [MEMORY[0x263F82438] sharedApplication];
      [v15 statusBarFrame];
      double v16 = CGRectGetHeight(v22);

      double v11 = Height + v16;
    }
    [(SUUIStackedBar *)self->_stackedBar setAutoresizingMask:2];
    -[SUUIStackedBar setFrame:](self->_stackedBar, "setFrame:", v8, v11, v10, 0.0);
    [v19 addSubview:self->_stackedBar];
  }
  if (__orbSupported)
  {
    long long v17 = [(SUUIStorePageSectionsViewController *)self registerForPreviewingWithDelegate:self sourceView:v5];
    viewControllerPreviewing = self->_viewControllerPreviewing;
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  if (initialOverlayURLs)
  {
    if (!self->_overlayController)
    {
      id v6 = [[SUUIProductPageOverlayController alloc] initWithParentViewController:self];
      overlayController = self->_overlayController;
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  objc_super v5 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
  id v6 = [(SUUIStorePageSectionsViewController *)self _currentBackdropGroupName];
  ...
  if (self->_itemsChangedStateWhileDisappeared)
  {
    ...
    uint64_t v12 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  id v6 = [(SUUIStorePageSectionsViewController *)self view];
  [v6 bounds];
  *(float *)&double v8 = v7;
  ...
  [(SUUICollectionView *)self->_collectionView setClipsToBounds:1];
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  double v7 = NSNumber;
  id v8 = a4;
  uint64_t v9 = [(SUUIStorePageSectionsViewController *)self view];
  [v9 bounds];
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  id v6 = [(SUUIStorePageSectionsViewController *)self traitCollection];
  uint64_t v7 = [v6 userInterfaceStyle];

  if (v5 != v7)
  {
    id v8 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      id v9 = v8;
      ...
      if ([v10 count])
      {
        ...
        [v11 invalidateDecorationElementsOfKind:0x2704F8530 atIndexPaths:v10];
...
void __73__SUUIStorePageSectionsViewController_itemStateCenter_itemStatesChanged___block_invoke(uint64_t a1)
{
  ...
  if ([v23 count])
  {
    ...
    v27[1] = 3221225472;
    v27[2] = __73__SUUIStorePageSectionsViewController_itemStateCenter_itemStatesChanged___block_invoke_2;
    v27[3] = &unk_265401E00;
    v27[4] = *(void *)(a1 + 32);
    id v15 = v14;
    id v28 = v15;
    ...
    v25[1] = 3221225472;
    v25[2] = __73__SUUIStorePageSectionsViewController_itemStateCenter_itemStatesChanged___block_invoke_3;
    v25[3] = &unk_265401E28;
    v25[4] = *(void *)(a1 + 32);
    id v26 = v15;
    id v17 = v15;
...
LABEL_10:
  ...
  long long v11 = [(SUUICollectionView *)self->_collectionView cellForItemAtIndexPath:indexPathOfEditedCell];
...
- (void)collectionView:(id)a3 willBeginEditingItemAtIndexPath:(id)a4
{
  ...
  id v6 = [(SUUICollectionView *)self->_collectionView indexPathsForSelectedItems];
  id v7 = v6;
  if (v6 && [v6 count])
  {
    collectionView = self->_collectionView;
...
- (id)indexPathsForPinningItemsInCollectionView:(id)a3 layout:(id)a4
{
  ...
  uint64_t v26 = 0;
  id v24 = "";
  id v8 = [(SUUIStorePageSectionsViewController *)self _collectionViewSublayouts];
  ...
  else
  {
    ...
    do
    {
      ...
      {
        if (!v13) {
          double v13 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", objc_msgSend(v15, "count"));
        }
...
void __88__SUUIStorePageSectionsViewController_indexPathsForPinningItemsInCollectionView_layout___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
...
void __89__SUUIStorePageSectionsViewController_indexPathsForGradientItemsInCollectionView_layout___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  uint64_t v7 = [a2 numberOfPageSections];
  id v8 = *(void **)(a1 + 32);
  uint64_t v9 = [*(id *)(a1 + 40) objectAtIndex:a3];
...
- (BOOL)performTestWithName:(id)a3 options:(id)a4
{
  ...
  if ([v6 hasPrefix:@"Scroll"])
  {
    ...
    [(SUUICollectionView *)collectionView _performScrollTest:v6 iterations:v14 delta:v15 length:(int)v16];
  }
  return 1;
}
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  uint64_t v10 = [(SUUIStorePageSectionsViewController *)self metricsController];
...
{
  id v4 = a3;
  id v5 = [(SUUIStorePageSectionsViewController *)self view];
  [v5 bounds];
  ...
  double v13 = NSNumber;
  uint64_t v14 = [(SUUIStorePageSectionsViewController *)self view];
  [v14 bounds];
  *(float *)&double v16 = v15;
  ...
  [(SUUICollectionView *)self->_collectionView reloadData];
  [(SUUIStorePageSectionsViewController *)self _reloadCollectionView];
  [(SUUIStorePageSectionsViewController *)self _scrollFirstAppearanceSectionToView];
LABEL_6:
  if (SUUICollectionViewWillLayoutSubviews__sLayoutRespondsToFrame == 255) {
    SUUICollectionViewWillLayoutSubviews__sLayoutRespondsToFrame = [MEMORY[0x263F82590] instancesRespondToSelector:sel__frame];
  }
  double v19 = [(SUUIStorePageSplitsDescription *)self->_splitsDescription leftSplit];
  if (v19
    && ([(SUUIStorePageSplitsDescription *)self->_splitsDescription rightSplit],
    ...
    && ([v19 dividerColor], (uint64_t v21 = objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    if (SUUICollectionViewWillLayoutSubviews__sLayoutRespondsToFrame)
    {
      ...
      long long v60 = *MEMORY[0x263F001A8];
      long long v61 = v26;
      double v27 = [(SUUIStorePageSectionsViewController *)self _collectionViewSublayouts];
      splitsDescription = self->_splitsDescription;
      uint64_t v49 = MEMORY[0x263EF8330];
      uint64_t v50 = 3221225472;
      uint64_t v51 = __76__SUUIStorePageSectionsViewController_SUUICollectionViewWillLayoutSubviews___block_invoke_2;
      long long v52 = &unk_265401E50;
      id v53 = v19;
      id v29 = v27;
      id v54 = v29;
      long long v55 = &v56;
      ...
      double v31 = v30;
      long long v32 = [MEMORY[0x263F82B60] mainScreen];
      [v32 scale];
      double v34 = v33;
...
void __76__SUUIStorePageSectionsViewController_SUUICollectionViewWillLayoutSubviews___block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
  if (*(void *)(a1 + 32) == a2)
  {
...
- (void)scrollViewDidScroll:(id)a3
{
  ...
  {
    id v4 = -[SUUICollectionView cellForItemAtIndexPath:](self->_collectionView, "cellForItemAtIndexPath:");
...
- (void)scrollViewWillEndDragging:(id)a3 withVelocity:(CGPoint)a4 targetContentOffset:(CGPoint *)a5
{
  double x = a5->x;
  double y = a5->y;
  id v8 = -[SUUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:", a3, a5->x, y);
  uint64_t v9 = [v8 item];
  ...
  double v17 = -[SUUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:", x, v16);
...
- (id)previewingContext:(id)a3 viewControllerForLocation:(CGPoint)a4
{
  ...
  uint64_t v9 = -[SUUICollectionView indexPathForItemAtPoint:](self->_collectionView, "indexPathForItemAtPoint:");
...
- (void)previewingContext:(id)a3 commitViewController:(id)a4
{
  id v19 = a3;
  id v6 = a4;
  id v7 = [(SUUIStorePageSectionsViewController *)self navigationController];
  id v8 = [(SUUIStorePageSectionsViewController *)self parentViewController];
  if (v8)
  {
    while (1)
    {
      uint64_t v9 = [v8 navigationController];
      unint64_t v10 = [(SUUIViewController *)self clientContext];
      double v11 = [v10 applicationController];
      double v12 = [v11 rootViewController];
      BOOL IsDescendent = SUUIViewControllerIsDescendent(v9, v12);
      ...
      if ([v8 conformsToProtocol:&unk_2706A77A0])
      {
...
LABEL_11:
  id v17 = v6;
  uint64_t v18 = v17;
  if ([v17 conformsToProtocol:&unk_27065F5B0])
  {
...
- (void)willPresentPreviewViewController:(id)a3 forLocation:(CGPoint)a4 inSourceView:(id)a5
{
  ...
  id v22 = a3;
  id v9 = a5;
  unint64_t v10 = [(SUUIStorePageSectionsViewController *)self collectionView];
  objc_msgSend(v10, "convertPoint:fromView:", v9, x, y);
  double v12 = v11;
  double v14 = v13;

  id v15 = [(SUUIStorePageSectionsViewController *)self collectionView];
  uint64_t v16 = objc_msgSend(v15, "indexPathForItemAtPoint:", v12, v14);

  id v17 = [(SUUIStorePageSectionsViewController *)self collectionView];
...
+ (id)viewControllerWithRestorationIdentifierPath:(id)a3 coder:(id)a4
{
  ...
  id v5 = +[SUUIStateRestorationContext sharedContext];
  ...
  if (!v4)
  {
    ...
    if (v3)
    {
      if (self->_deferredSplitsDescription)
      {
        ...
        [(SUUIStorePageSectionsViewController *)self setSectionsWithSplitsDescription:v8];
      }
    }
  }
}
...
- (void)_insertSectionsWithComponents:(id)a3 afterSection:(id)a4
{
  ...
  {
    uint64_t v8 = v7;
    unint64_t v20 = [(SUUIStorePageSectionsViewController *)self _splitForSectionIndex:v7];
    ...
    if (v11)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v12; ++i)
        {
          ...
          id v17 = [(SUUIStorePageSectionsViewController *)self defaultSectionForComponent:*(void *)(*((void *)&v22 + 1) + 8 * i)];
          uint64_t v18 = v17;
          if (v17)
          {
    ...
    id v19 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
...
- (void)_setSelectedIndex:(int64_t)a3 forMenuSection:(id)a4
{
  ...
  id v8 = [(SUUIStorePageSectionsViewController *)self _menuContextForMenuComponent:v7];
  ...
  if (v9 != a3)
  {
    ...
    id v21 = -[SUUIStorePageSectionsViewController _splitForSectionIndex:](self, "_splitForSectionIndex:");
    uint64_t v11 = [v21 sectionContext];
    uint64_t v12 = [(SUUIStorePageSectionsViewController *)self _childSectionsForMenuComponent:v7 selectedIndex:a3];
    long long v23 = 0u;
    long long v24 = 0u;
    long long v25 = 0u;
    long long v26 = 0u;
    ...
    uint64_t v18 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
...
- (void)_updateSectionsForIndex:(int64_t)a3 menuSection:(id)a4
{
  ...
  if ([v8 selectedIndex] == a3)
  {
    ...
    if (!v10)
    {
      uint64_t v19 = -[SUUIStorePageSectionsViewController _splitForSectionIndex:](self, "_splitForSectionIndex:", [v6 sectionIndex]);
...
- (id)_visibleMetricsImpressionsString
{
  ...
  BOOL v3 = objc_alloc_init(SUUIMetricsImpressionSession);
  id v4 = [(SUUICollectionView *)self->_collectionView indexPathsForVisibleItems];
  long long v13 = 0u;
  long long v14 = 0u;
  long long v15 = 0u;
  long long v16 = 0u;
  ...
  uint64_t v11 = [(SUUIMetricsImpressionSession *)v3 impressionsString];
...
- (id)_impressionableViewElements
{
  ...
  uint64_t v11 = [(SUUIMetricsImpressionSession *)v3 impressionableViewElements];
...
- (void)_entityProviderDidInvalidateNotification:(id)a3
{
  ...
  uint64_t v9 = __80__SUUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke;
  uint64_t v10 = &unk_265400890;
  id v5 = v4;
  id v11 = v5;
  uint64_t v12 = self;
  uint64_t v6 = (void (**)(void))_Block_copy(&v7);
  if (objc_msgSend(MEMORY[0x263F08B88], "isMainThread", v7, v8, v9, v10)) {
    v6[2](v6);
  }
  else {
...
void __80__SUUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke(uint64_t a1)
{
  ...
  if ([v3 count])
  {
    ...
    id v5 = [v4 objectForKey:*MEMORY[0x263F4B300]];
    ...
    id v11 = __80__SUUIStorePageSectionsViewController__entityProviderDidInvalidateNotification___block_invoke_2;
    uint64_t v12 = &unk_265401E78;
    id v13 = v3;
    id v14 = v2;
    id v15 = v5;
    ...
    objc_msgSend(MEMORY[0x263F82E00], "setAnimationsEnabled:", v6, v9, v10, v11, v12);
  }
}
...
- (void)_beginActiveImpressionsForImpressionableViewElements
{
  ...
  uint64_t v3 = [(SUUIStorePageSectionsViewController *)self _impressionableViewElements];
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v9 = [(SUUIStorePageSectionsViewController *)self activeMetricsImpressionSession];
...
- (id)_childSectionsForMenuComponent:(id)a3 selectedIndex:(int64_t)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [(SUUIStorePageSectionsViewController *)self _menuContextForMenuComponent:v6];
    ...
    if (v11)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v12; ++i)
        {
          ...
          uint64_t v15 = [(SUUIStorePageSectionsViewController *)self defaultSectionForComponent:*(void *)(*((void *)&v17 + 1) + 8 * i)];
          if (v15) {
            [v9 addObject:v15];
          }
        }
...
- (id)_collectionViewSublayouts
{
  id v2 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
...
LABEL_38:
        ...
        if ([v20 isOpen])
        {
          ...
          id v37 = [(SUUIStorePageSectionsViewController *)self _newSectionsWithPageComponent:v36];
              ...
              for (uint64_t j = 0; j != v39; ++j)
              {
                ...
                if (a8 == 1)
                {
                  ...
                  if ([v40 isOpen] && (objc_msgSend(v40, "previousIsOpen") & 1) == 0)
                  {
                    ...
                    {
                      double v45 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x263F089C8]);
        ...
        if (a8 == 1 && v47)
        {
          ...
          {
            uint64_t v51 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x263F089C8]);
...
- (id)_currentBackdropGroupName
{
  id v2 = [(SUUIStorePageSectionsViewController *)self navigationController];
  if (objc_opt_respondsToSelector())
  {
...
- (id)_defaultSectionForGridComponent:(id)a3
{
  ...
  else
  {
    if (((1 << v4) & 0x3B) != 0)
    {
      uint64_t v5 = SUUIGridPageSection;
    }
    else if (v4 == 2)
    {
      uint64_t v5 = SUUIBrickGridPageSection;
    }
    else
    {
...
- (id)_defaultSectionForSwooshComponent:(id)a3
{
  ...
  if (v4 > 2) {
    ...
    uint64_t v5 = (void *)[objc_alloc(*off_265401FD0[v4]) initWithPageComponent:v3];
  }
...
- (void)_deselectCellsForAppearance:(BOOL)a3
{
  BOOL v3 = a3;
  uint64_t v25 = *MEMORY[0x263EF8340];
  uint64_t v5 = [(SUUICollectionView *)self->_collectionView indexPathsForSelectedItems];
  long long v19 = 0u;
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SUUICollectionView *)self->_collectionView deselectItemAtIndexPath:*(void *)(*((void *)&v19 + 1) + 8 * v9++) animated:v3];
      }
      while (v7 != v9);
...
- (void)_endAllPendingActiveImpression
{
  id v2 = [(SUUIStorePageSectionsViewController *)self activeMetricsImpressionSession];
...
- (void)_enumerateVisibleSectionsUsingBlock:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(SUUICollectionView *)self->_collectionView indexPathsForVisibleItems];
...
- (void)_invalidateIfLastKnownWidthChanged
{
  ...
  {
    id v3 = [(SUUIStorePageSectionsViewController *)self view];
    [v3 bounds];
    double v5 = v4;
    double v7 = v6;
    ...
    *(float *)&double v9 = v5;
    ...
    MEMORY[0x270F9A758](v10, lastKnownWidth);
  }
}
...
- (void)_invalidateLayoutWithNewSize:(CGSize)a3 transitionCoordinator:(id)a4
{
  ...
  float v8 = [(SUUIStorePageSectionsViewController *)self _collectionViewSublayouts];
  long long v40 = 0u;
  long long v41 = 0u;
  long long v42 = 0u;
  long long v43 = 0u;
  ...
  uint64_t v13 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
  ...
  long long v22 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
  [v22 commitLayoutRequests];

  if ([v14 count])
  {
    uint64_t v23 = (void *)MEMORY[0x263F82E00];
...
- (id)_expandContextForMenuComponent:(id)a3
{
  ...
  if (!v5)
  {
    ...
    {
      double v6 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
      expandSectionContexts = self->_expandSectionContexts;
      self->_expandSectionContexts = v6;
    }
    double v5 = objc_alloc_init(SUUIExpandPageSectionContext);
...
- (id)_menuContextForMenuComponent:(id)a3
{
  ...
  if (!v5)
  {
    ...
    double v5 = objc_alloc_init(SUUIMenuPageSectionContext);
...
- (id)_newSectionContext
{
  id v3 = objc_alloc_init(SUUIStorePageSectionContext);
  [(SUUIStorePageSectionContext *)v3 _setCollectionView:self->_collectionView];
  [(SUUIStorePageSectionContext *)v3 _setColorScheme:self->_colorScheme];
  [(SUUIStorePageSectionContext *)v3 _setDefaultPinningTransitionStyle:self->_pinningTransitionStyle];
  ...
  id v4 = [(SUUIStorePageSectionsViewController *)self resourceLoader];
  [(SUUIStorePageSectionContext *)v3 _setResourceLoader:v4];

  double v5 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
  ...
  if ([(SUUIStorePageSectionsViewController *)self isViewLoaded])
  {
    double v6 = [(SUUIStorePageSectionsViewController *)self view];
    [v6 bounds];
    double v8 = v7;
    double v10 = v9;

    uint64_t v11 = [(SUUICollectionView *)self->_collectionView indexBarControl];

    if (v11)
    {
      id v12 = [(SUUICollectionView *)self->_collectionView indexBarControl];
      objc_msgSend(v12, "sizeThatFits:", v8, v10);
      double v14 = v13;

      double v8 = v8 - v14;
    }
    [(SUUIStorePageSectionContext *)v3 _setActivePageWidth:v8];
    [(SUUIStorePageSectionContext *)v3 _setLandscapePageWidth:v10];
    [(SUUIStorePageSectionContext *)v3 _setPortraitPageWidth:v8];
  }
  return v3;
}
...
- (id)_newSectionsWithPageComponent:(id)a3
{
  ...
  {
    id v6 = v4;
    double v7 = [[SUUIMenuPageSection alloc] initWithPageComponent:v6];
    [v5 addObject:v7];
    double v8 = -[SUUIStorePageSectionsViewController _childSectionsForMenuComponent:selectedIndex:](self, "_childSectionsForMenuComponent:selectedIndex:", v6, [v6 defaultSelectedIndex]);
    if (v8) {
  ...
  {
    id v6 = [(SUUIStorePageSectionsViewController *)self defaultSectionForComponent:v4];
    [v5 addObject:v6];
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v11 = -[SUUIStorePageSectionsViewController _newSectionsWithPageComponent:](self, "_newSectionsWithPageComponent:", *(void *)(*((void *)&v13 + 1) + 8 * v10), (void)v13);
...
- (id)_newStorePageCollectionViewLayout
{
  id v3 = objc_alloc_init(SUUIStorePageCollectionViewLayout);
  id v4 = [(SUUIStorePageSectionsViewController *)self _currentBackdropGroupName];
...
- (id)_prepareLayoutForSections
{
  ...
  {
    id v4 = [(SUUIStorePageSectionsViewController *)self _newSectionContext];
    v15[0] = 0;
    v15[1] = v15;
    v15[2] = 0x2020000000;
    v15[3] = 0;
    ...
    uint64_t v10 = objc_alloc_init(SUUIStorePageSplitCollectionViewLayout);
    id v12 = [(SUUIStorePageSectionsViewController *)self _currentBackdropGroupName];
  ...
  {
    id v3 = [(SUUIStorePageSplitsDescription *)self->_splitsDescription firstSplit];
    ...
    uint64_t v10 = [(SUUIStorePageSectionsViewController *)self _newStorePageCollectionViewLayout];
  }
...
- (void)_reloadCollectionView
{
  ...
  long long v32 = [(SUUIStorePageSectionsViewController *)self _prepareLayoutForSections];
...
LABEL_11:
  ...
  [(SUUICollectionView *)self->_collectionView setAlwaysBounceVertical:v8];
  [(SUUICollectionView *)self->_collectionView setScrollEnabled:v8];
  uint64_t v9 = [(SUUIColorScheme *)self->_colorScheme backgroundColor];
  uint64_t v10 = v9;
  if (v9)
  {
  ...
  if ([(NSMutableArray *)self->_sections count])
  {
    ...
    long long v17 = self;
    long long v18 = v17;
    while (![v18 conformsToProtocol:&unk_2706447B0])
    {
    ...
    if (v20)
    {
      uint64_t v21 = [(SUUIStorePageSectionsViewController *)v17 navigationController];
...
LABEL_21:
    ...
    [(SUUICollectionView *)self->_collectionView contentInset];
    [(SUUICollectionView *)self->_collectionView setContentInset:v25 + p_contentInsetAdjustments->top - top];
  }
  uint64_t v26 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
  ...
  if (v4)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        if (!v6) {
          long long v6 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9C0]), "initWithCapacity:", -[NSMapTable count](self->_entityProviderToRelevantSections, "count"));
        }
        [v6 addObject:v9];
      }
    ...
    do
    {
      for (uint64_t j = 0; j != v32; ++j)
      {
        ...
        if ([v12 count])
        {
          ...
          {
            long long v13 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:0 capacity:0];
          ...
          if (v16)
          {
            ...
            do
            {
              for (uint64_t k = 0; k != v17; ++k)
              {
                ...
                if (!v21)
                {
                  uint64_t v21 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:0];
                  [(NSMapTable *)self->_entityProviderToRelevantSections setObject:v21 forKey:v20];
                  [(SUUIStorePageSectionsViewController *)self _registerForNotificationsForEntityProvider:v20];
                }
                [v21 addObject:v11];
              }
  ...
  if (v23)
  {
    ...
    do
    {
      for (uint64_t m = 0; m != v24; ++m)
      {
        ...
        [(SUUIStorePageSectionsViewController *)self _unregisterForNotificationsForEntityProvider:v27];
...
- (void)_setPageSize:(CGSize)a3
{
  double height = a3.height;
  double width = a3.width;
  uint64_t v6 = [(SUUIStorePageSectionsViewController *)self _collectionViewSublayouts];
  uint64_t v7 = [(SUUICollectionView *)self->_collectionView indexBarControl];

  if (v7)
  {
    uint64_t v8 = [(SUUICollectionView *)self->_collectionView indexBarControl];
...
- (id)_splitForSectionIndex:(int64_t)a3
{
  ...
  double v10 = __Block_byref_object_copy__13;
  long long v11 = __Block_byref_object_dispose__13;
  id v12 = 0;
  splitsDescription = self->_splitsDescription;
  v6[0] = MEMORY[0x263EF8330];
  v6[1] = 3221225472;
  ...
  void v6[4] = v13;
  v6[5] = &v7;
  [(SUUIStorePageSplitsDescription *)splitsDescription enumerateSplitsUsingBlock:v6];
  id v4 = (id)v8[5];
...
void __61__SUUIStorePageSectionsViewController__splitForSectionIndex___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v12 = a2;
...
- (id)_textLayoutCache
{
  ...
  if (!textLayoutCache)
  {
    id v4 = objc_alloc_init(SUUILayoutCache);
...
- (void)_updateCollectionViewWithUpdates:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    id v6 = [(SUUIStorePageSectionsViewController *)self _textLayoutCache];
    [v6 commitLayoutRequests];

    uint64_t v7 = [(SUUICollectionView *)self->_collectionView collectionViewLayout];
    aBlock[0] = MEMORY[0x263EF8330];
    aBlock[1] = 3221225472;
    aBlock[2] = __72__SUUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_2;
    aBlock[3] = &unk_265401F88;
    uint64_t v25 = v5;
    aBlock[4] = self;
    id v8 = v7;
    id v24 = v8;
    ...
    {
      [(SUUIStorePageSectionsViewController *)self _beginIgnoringSectionChanges];
      collectionView = self->_collectionView;
      v21[0] = MEMORY[0x263EF8330];
      v21[1] = 3221225472;
      v21[2] = __72__SUUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_4;
      v21[3] = &unk_265400890;
      void v21[4] = self;
      id v22 = v8;
      uint64_t v15 = MEMORY[0x263EF8330];
      uint64_t v16 = 3221225472;
      uint64_t v17 = __72__SUUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_5;
      uint64_t v18 = &unk_265401FB0;
      uint64_t v19 = self;
      id v20 = v9;
  ...
  else if (self->_didInitialReload && self->_collectionView)
  {
    ...
    v26[1] = 3221225472;
    v26[2] = __72__SUUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke;
    v26[3] = &unk_265400980;
    v26[4] = self;
    [MEMORY[0x263F82E00] performWithoutAnimation:v26];
  }
  if ([(SUUIStorePageSectionsViewController *)self isViewLoaded])
  {
    overlayController = self->_overlayController;
    ...
    {
      id v12 = [(SUUIProductPageOverlayController *)overlayController view];
...
void __72__SUUIStorePageSectionsViewController__updateCollectionViewWithUpdates___block_invoke_2(void *a1)
{
...
- (void)_updateSectionsAfterMenuChange
{
  ...
  [(SUUICollectionView *)self->_collectionView setAlwaysBounceVertical:v6];
  [(SUUICollectionView *)self->_collectionView setScrollEnabled:v6];
  [(SUUICollectionView *)self->_collectionView setScrollsToTop:v6];
  collectionView = self->_collectionView;
  [(SUUICollectionView *)collectionView reloadData];
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUIStorePageSectionsDelegate *)WeakRetained;
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_pullToRefreshDelegate);
  return (SUUICollectionViewPullToRefreshDelegate *)WeakRetained;
}
