...
- (SUUIHorizontalLockupLayout)initWithLockup:(id)a3 context:(id)a4
{
  ...
  if (v8)
  {
    ...
    v49[0] = xmmword_2568A1DD0;
    v49[1] = xmmword_2568A1DE0;
    v49[2] = xmmword_2568A1DF0;
    uint64_t v50 = 6;
    v10 = (void *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:1282 valueOptions:0 capacity:7];
    v47[0] = 0;
    v47[1] = v47;
    v47[2] = 0x2020000000;
    v47[3] = 0;
    ...
    *((double *)v8 + 2) = v17;
    ...
    {
      *(_OWORD *)(v8 + 24) = xmmword_2568A1E00;
      *(_OWORD *)(v8 + 40) = xmmword_2568A1E10;
    ...
    else
    {
      ...
      {
        long long v24 = *(_OWORD *)(MEMORY[0x263F834E8] + 16);
        *(_OWORD *)(v8 + 24) = *MEMORY[0x263F834E8];
        *(_OWORD *)(v8 + 40) = v24;
      }
      uint64_t v18 = 0;
    }
    *((void *)v8 + 7) = v18;
    ...
    uint64_t v26 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMapTable count](v25, "count"));
    v27 = (void *)*((void *)v8 + 1);
    *((void *)v8 + 1) = v26;
...
LABEL_36:
  ...
  if (v8 <= 89)
  {
    if (v8 != 77)
    {
      ...
      double v16 = [*(id *)(a1 + 40) aggregateValueForKey:0x2705026F0];
  ...
  if (v8 == 127)
  {
    ...
    if (v19 < *(void *)(a1 + 88) - 1)
    {
      v24[0] = xmmword_2568A1DD0;
      v24[1] = xmmword_2568A1DE0;
      v24[2] = xmmword_2568A1DF0;
      uint64_t v25 = 6;
      *(void *)(v18 + 24) = v19 + 1;
...
+ (id)fontForButtonViewElement:(id)a3 context:(id)a4
{
  ...
  if (v7)
  {
    int v9 = SUUIViewElementFontWithStyle(v7);
  }
  else
  {
    v10 = [v5 style];
    int v9 = SUUIViewElementFontWithStyle(v10);
  }
  if (!v9)
  {
    ...
    int v9 = SUUIFontLimitedPreferredFontForTextStyle(v11, 5);
  }
...
+ (id)fontForLabelViewElement:(id)a3 context:(id)a4
{
  ...
  if (!v8)
  {
    ...
    else
    {
      ...
      uint64_t v8 = SUUIFontLimitedPreferredFontForTextStyle(v10, 5);
    }
  }
...
+ (id)fontForOrdinalViewElement:(id)a3 context:(id)a4
{
  ...
  id v5 = SUUIViewElementFontWithStyle(v4);

  if (!v5)
  {
    id v6 = SUUIFontForTextStyle(25);
    id v7 = (void *)MEMORY[0x263F81708];
    [v6 pointSize];
    id v5 = objc_msgSend(v7, "_lightSystemFontOfSize:");
  }
  return v5;
}
...
- (CGSize)_sizeForRightAlignedColumn:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  id v36 = "";
  long long v37 = *MEMORY[0x263F001B0];
    ...
    if (v14)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v14; ++i)
        {
          ...
          {
            [(SUUIHorizontalLockupLayout *)self _sizeForViewElement:v17 width:(uint64_t)a4 context:v12];
            v34[5] = v18 + v34[5];
          }
        }
        uint64_t v14 = [v13 countByEnumeratingWithState:&v24 objects:v38 count:16];
