...
- (SUUIRowSection)initWithPageComponent:(id)a3
{
  ...
  v3 = [(SUUIStorePageSection *)&v8 initWithPageComponent:a3];
  if (v3)
  {
    ...
    v3->_isPad = [v6 userInterfaceIdiom] == 1;
  }
  return v3;
}
...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  else
  {
    ...
    id v7 = [(SUUIStorePageSection *)&v10 backgroundColorForIndexPath:v4];
  }
  objc_super v8 = v7;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (v11 == 5)
  {
    uint64_t v13 = [v6 dequeueReusableCellWithReuseIdentifier:0x27050B070 forIndexPath:v4];
    [(SUUIRowSection *)self _reloadEditorialCell:v13 forComponent:v10 columnIndex:v7];
  }
  else if (v11 == 9)
  {
    v12 = [v10 editorial];
    ...
    if (v12)
    {
      uint64_t v13 = [v6 dequeueReusableCellWithReuseIdentifier:0x2704F98B0 forIndexPath:v4];
      [(SUUIRowSection *)self _reloadEditorialLockupCell:v13 forComponent:v10 columnIndex:v7];
    }
    else
    {
      uint64_t v13 = [v6 dequeueReusableCellWithReuseIdentifier:0x270506410 forIndexPath:v4];
      [(SUUIRowSection *)self _reloadLockupCell:v13 forComponent:v10 columnIndex:v7];
    }
  }
  else
  {
    uint64_t v13 = [v6 dequeueReusableCellWithReuseIdentifier:@"SUUIRowSectionMiscReuseIdentifer" forIndexPath:v4];
    if (v10)
    {
      v14 = [(SUUIRowSection *)self _columnViews];
    ...
    [(SUUIRowSection *)self _edgeInsetsForColumnIndex:v7];
    objc_msgSend(v13, "setContentInsets:");
    uint64_t v16 = [v10 componentType];
    if (v16 == 10)
    {
      [(SUUIRowSection *)self _reloadView:v15 forMediaComponent:v10 columnIndex:v7];
    }
    else if (v16 == 7)
    {
      [(SUUIRowSection *)self _loadImagesForGalleryComponent:v10 columnIndex:v7];
    }
  }
  return v13;
}
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  else
  {
    ...
    [(SUUIRowSection *)self _heightForComponent:v15 columnIndex:(double)v13 rowWidth:v8];
    double v17 = v16;
  }
  uint64_t v20 = [v4 item];
  [(SUUIRowSection *)self _columnWidthForColumnIndex:v20 rowWidth:v8];
  double v22 = v21;
  [(SUUIRowSection *)self _edgeInsetsForColumnIndex:v20];
...
- (id)clickEventWithItem:(id)a3 elementName:(id)a4 index:(int64_t)a5
{
  ...
  double v7 = -[SUUIStorePageSection clickEventWithItem:elementName:index:](&v9, sel_clickEventWithItem_elementName_index_, a3, a4);
  [(SUUIRowSection *)self _setPositionForClickEvent:v7 elementIndex:a5];
  return v7;
}
...
- (void)collectionViewDidConfirmItemOfferAtIndexPath:(id)a3
{
  ...
  if ([v7 componentType] == 9)
  {
    ...
    double v10 = [(SUUIRowSection *)self itemOfferClickEventWithItem:v9 elementName:@"Column" index:v4];
    if (v10)
    {
    ...
    v14 = [(SUUIStorePageSection *)self performItemOfferActionForItem:v9];
    v15 = [v13 layout];
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  {
    case 5:
      [(SUUIRowSection *)self _expandEditorialComponent:v8 columnIndex:v5];
      break;
    case 7:
      [(SUUIRowSection *)self _selectGalleryComponent:v8 columnIndex:v5];
      break;
    case 9:
      [(SUUIRowSection *)self _selectLockupComponent:v8 columnIndex:v5];
      break;
    case 10:
      [(SUUIRowSection *)self _selectMediaComponent:v8 columnIndex:v5];
      break;
    default:
      break;
  }
  v9.receiver = self;
  v9.super_class = (Class)SUUIRowSection;
  [(SUUIStorePageSection *)&v9 collectionViewDidSelectItemAtIndexPath:v4];
}
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  ...
  id v6 = [(SUUIRowSection *)self backgroundColorForIndexPath:v5];
  [v4 setBackgroundColor:v6];

  v7.receiver = self;
  v7.super_class = (Class)SUUIRowSection;
  [(SUUIStorePageSection *)&v7 collectionViewWillApplyLayoutAttributes:v4];
}
...
- (id)itemOfferClickEventWithItem:(id)a3 elementName:(id)a4 index:(int64_t)a5
{
  v9.receiver = self;
  v9.super_class = (Class)SUUIRowSection;
  objc_super v7 = -[SUUIStorePageSection itemOfferClickEventWithItem:elementName:index:](&v9, sel_itemOfferClickEventWithItem_elementName_index_, a3, a4);
  [(SUUIRowSection *)self _setPositionForClickEvent:v7 elementIndex:a5];
  return v7;
}
...
- (int64_t)numberOfCells
{
  ...
  objc_super v2 = [(SUUIStorePageSection *)self pageComponent];
  v3 = [v2 columnWidths];
  long long v12 = 0u;
  long long v13 = 0u;
  long long v14 = 0u;
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  {
    uint64_t v5 = [(SUUIRowSection *)self _missingItemLoader];
...
- (void)willAppearInContext:(id)a3
{
  ...
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:@"SUUIRowSectionMiscReuseIdentifer"];
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x27050B070];
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x270506410];
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x2704F98B0];
  id v6 = [(SUUIStorePageSection *)self pageComponent];
  ...
  [(SUUIStorePageSection *)&v12 willAppearInContext:v4];
}
...
void __65__SUUIRowSection_willTransitionToSize_withTransitionCoordinator___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5 == 9)
  {
    ...
    if (v6)
    {
      id v7 = [MEMORY[0x263F088C8] indexPathForItem:a3 inSection:*(void *)(a1 + 48)];
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(SUUIRowSection *)self _columnViews];
  uint64_t v9 = [v7 requestIdentifier];

  id v10 = [(SUUIStorePageSection *)self pageComponent];
...
void __46__SUUIRowSection_artworkRequest_didLoadImage___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v14 = a2;
...
LABEL_7:
      ...
      uint64_t v11 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", a3, objc_msgSend(*(id *)(a1 + 32), "sectionIndex"));
...
LABEL_3:
    ...
    id v14 = [(SUUIStorePageSection *)self pageComponent];
...
LABEL_23:
    ...
    uint64_t v20 = [(SUUIStorePageSection *)self context];
    id v13 = [v20 metricsController];

    if ([v13 canRecordEventWithType:*MEMORY[0x263F7BB60]])
    {
      id v21 = objc_alloc_init(MEMORY[0x263F7B268]);
      double v22 = SUUIMetricsMediaEventTypeForPlaybackState((id)a4);
      [v21 setMediaEventType:v22];

      double v23 = [(SUUIStorePageSection *)self pageComponent];
      ...
      if (v24 && v25)
      {
        v35[0] = v25;
        v35[1] = v24;
        double v27 = [MEMORY[0x263EFF8C0] arrayWithObjects:v35 count:2];
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if ([v6 count])
  {
    ...
    if ([v8 count])
    {
      ...
      int64_t v12 = [(SUUIStorePageSection *)self sectionIndex];
      v15[0] = MEMORY[0x263EF8330];
      v15[1] = 3221225472;
...
{
  id v4 = *(void **)(a1 + 32);
  id v5 = [MEMORY[0x263F088C8] indexPathForItem:a2 inSection:*(void *)(a1 + 56)];
...
- (void)productPageOverlayDidDismiss:(id)a3
{
  id v9 = [(SUUIRowSection *)self _overlaySourceCell];
  id v4 = [v9 layout];
...
- (id)_columnViews
{
  ...
  if (!columnViews)
  {
    id v4 = (NSMapTable *)objc_alloc_init(MEMORY[0x263F08968]);
...
- (id)_editorialLayoutForEditorial:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (!editorialLayouts)
  {
    uint64_t v8 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
  ...
  if (!v10)
  {
    float v11 = [(SUUIStorePageSection *)self context];
    double v12 = [SUUIEditorialLayout alloc];
    double v13 = [(SUUIStorePageSection *)self context];
    double v14 = [v13 textLayoutCache];
    double v10 = [(SUUIEditorialLayout *)v12 initWithEditorial:v6 layoutCache:v14];
...
- (id)_editorialLayoutForLockup:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    if (!editorialLayouts)
    {
      double v9 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
    ...
    if (!v11)
    {
      ...
      double v13 = [SUUIEditorialLayout alloc];
      double v14 = [(SUUIStorePageSection *)self context];
      double v15 = [v14 textLayoutCache];
      float v11 = [(SUUIEditorialLayout *)v13 initWithEditorial:v7 layoutCache:v15];

      long long v19 = 0uLL;
      uint64_t v20 = 0;
      [(SUUIRowSection *)self _lockupStyleForComponent:v6 columnIndex:a4];
...
void __45__SUUIRowSection__enumerateLockupsWithBlock___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  {
    int64_t v5 = [MEMORY[0x263F088C8] indexPathForItem:a3 inSection:*(void *)(a1 + 40)];
...
- (void)_expandEditorialComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  BOOL v9 = SUUIEditorialLayoutOrientationForView(v8);
  id v10 = [(SUUIRowSection *)self _editorialLayoutForEditorial:v6 columnIndex:a4];
    ...
    && ([(NSMutableIndexSet *)self->_expandedEditorialIndexes containsIndex:a4] & 1) == 0)
  {
    ...
    {
      double v13 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x263F089C8]);
    ...
    self->_landscapeCellContentHeight = 0.0;
    self->_portraitCellContentHeight = 0.0;
    double v15 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", a4, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
    v17[0] = v15;
    double v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v17 count:1];
...
{
  id v8 = a3;
  [(SUUIRowSection *)self _columnWidthForColumnIndex:a4 rowWidth:a5];
  double v10 = v9;
...
- (double)_heightForComponent:(id)a3 columnIndex:(double)a4 rowWidth:(double)a5
{
  ...
  {
    case 2:
      [(SUUIRowSection *)self _heightForCountdownComponent:v8 columnIndex:(uint64_t)a4 rowWidth:a5];
      goto LABEL_8;
    case 5:
      [(SUUIRowSection *)self _heightForEditorialComponent:v8 columnIndex:(uint64_t)a4 rowWidth:a5];
      goto LABEL_8;
    case 7:
      [(SUUIRowSection *)self _heightForGalleryComponent:v8 columnIndex:(uint64_t)a4 rowWidth:a5];
      goto LABEL_8;
    case 9:
      [(SUUIRowSection *)self _heightForLockupComponent:v8 columnIndex:(uint64_t)a4 rowWidth:a5];
      goto LABEL_8;
    case 10:
      [(SUUIRowSection *)self _heightForMediaComponent:v8 columnIndex:(uint64_t)a4 rowWidth:a5];
      goto LABEL_8;
    case 14:
      [v8 height];
LABEL_8:
...
- (double)_heightForCountdownComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  if (v10)
  {
    [(SUUIRowSection *)self _heightForArtwork:v10 columnIndex:a4 rowWidth:a5];
    double v12 = v11;
  }
  else
  {
...
- (double)_heightForEditorialComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  double v7 = [(SUUIRowSection *)self _editorialLayoutForEditorial:a3 columnIndex:a5];
  id v8 = [(SUUIStorePageSection *)self context];
  double v9 = [v8 collectionView];
  BOOL v10 = SUUIEditorialLayoutOrientationForView(v9);
  ...
  if (v9)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        [(SUUIRowSection *)self _heightForMediaComponent:*(void *)(*((void *)&v16 + 1) + 8 * i) columnIndex:a4 rowWidth:a5];
        if (v12 < v14) {
          double v12 = v14;
        }
      }
...
- (double)_heightForLockupComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  long long v24 = 0uLL;
  uint64_t v25 = 0;
  [(SUUIRowSection *)self _lockupStyleForComponent:v7 columnIndex:a4];
  uint64_t v10 = [v7 item];
  uint64_t v11 = [v8 parentViewController];
  double v12 = [v11 clientContext];
  long long v22 = v24;
  uint64_t v23 = v25;
  +[SUUILockupItemCellLayout heightForLockupStyle:&v22 item:v10 editorial:v9 clientContext:v12];
  double v14 = v13;

  if (v9)
  {
    double v15 = [(SUUIRowSection *)self _editorialLayoutForLockup:v7 columnIndex:a4];
    long long v16 = [v8 collectionView];
    BOOL v17 = SUUIEditorialLayoutOrientationForView(v16);
...
- (double)_heightForMediaComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  if (v8)
  {
    [(SUUIRowSection *)self _heightForArtwork:v8 columnIndex:a4 rowWidth:a5];
    double v10 = v9;
  }
  else
  {
...
- (id)_imageConsumerWithItem:(id)a3 lockupSize:(int64_t)a4
{
  ...
  {
    id v6 = +[SUUIStyledImageDataConsumer lockupIconConsumerWithSize:](SUUIStyledImageDataConsumer, "lockupIconConsumerWithSize:", a4, v5);
  }
  else
  {
    id v6 = +[SUUIProductImageDataConsumer lockupConsumerWithSize:a4 itemKind:v5];
  }
  return v6;
}
...
- (double)_interColumnSpacing
{
  ...
  objc_super v2 = [(SUUIStorePageSection *)self context];
...
{
  id v6 = a3;
  double v7 = [(SUUIRowSection *)self _viewControllerForGalleryComponent:v6];
  if (v7)
  {
    id v8 = [(SUUIStorePageSection *)self context];
    ...
    [(SUUIRowSection *)self _columnWidthForColumnIndex:a4 rowWidth:v11];
    uint64_t v13 = v12;
...
LABEL_6:
    ...
    {
      id v11 = [(SUUIRowSection *)self _lockupPlaceholderForComponent:v4];
      goto LABEL_6;
    }
  }
  double v10 = [v4 item];
  ...
  double v13 = SUUILockupImageSizeForLockupSize(0, [v10 itemKind]);
  ...
  if (v17)
  {
    double v18 = objc_alloc_init(SUUIArtworkRequest);
    double v19 = [(SUUIRowSection *)self _imageConsumerWithItem:v10 lockupSize:0];
    ...
    uint64_t v21 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[SUUIResourceRequest requestIdentifier](v18, "requestIdentifier"));
    [(NSMapTable *)componentArtworkRequestIDs setObject:v21 forKey:v4];

    [v6 loadResourceWithRequest:v18 reason:1];
  }
  uint64_t v12 = [(SUUIRowSection *)self _lockupPlaceholderForComponent:v4];
...
- (id)_lockupPlaceholderForComponent:(id)a3
{
  ...
  double v7 = [(SUUIRowSection *)self _imageConsumerWithItem:v5 lockupSize:v6];

  id v8 = [MEMORY[0x263F825C8] colorWithWhite:0.8 alpha:1.0];
...
{
  id v6 = a3;
  double v7 = objc_alloc_init(SUUIArtworkRequest);
  ...
  [(SUUIRowSection *)self _columnWidthForColumnIndex:a4 rowWidth:v12];
  double v13 = +[SUUISizeToFitImageDataConsumer consumerWithConstraintSize:](SUUISizeToFitImageDataConsumer, "consumerWithConstraintSize:");
...
- (id)_newViewWithMediaComponent:(id)a3
{
  id v4 = objc_alloc_init(SUUIEmbeddedMediaView);
...
- (id)_overlaySourceCell
{
  if (self->_overlaySourceComponent)
  {
    ...
    id v8 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", v7, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
...
- (id)_popSourceViewForOverlayController:(id)a3
{
  ...
  {
    id v6 = [(SUUIRowSection *)self _overlaySourceCell];
...
- (void)_reloadEditorialCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  id v20 = a3;
  id v8 = a4;
  double v9 = [(SUUIRowSection *)self _editorialLayoutForEditorial:v8 columnIndex:a5];
  double v10 = [(SUUIStorePageSection *)self context];
  double v11 = [v10 collectionView];
  BOOL v12 = SUUIEditorialLayoutOrientationForView(v11);
  ...
  [(SUUIRowSection *)self _edgeInsetsForColumnIndex:a5];
  objc_msgSend(v14, "setContentInset:");
  double v15 = [(SUUIStorePageSection *)self context];
  ...
  double v19 = +[SUUIClientContext localizedStringForKey:@"MORE_BUTTON" inBundles:0];
  }
...
- (void)_reloadEditorialLockupCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  uint64_t v24 = 0;
  uint64_t v25 = 0;
  [(SUUIRowSection *)self _lockupStyleForComponent:v8 columnIndex:a5];
  [v11 setLayoutStyle:v24];
  [v11 setVisibleFields:v25];
  BOOL v12 = [(SUUILockupComponent *)v8 item];
  [v9 configureForItem:v12 clientContext:self->_clientContext];
  [v9 setSeparatorStyle:0];

  uint64_t v13 = [(SUUIRowSection *)self _lockupImageForComponent:v8];
  ...
  double v15 = [(SUUIRowSection *)self _editorialLayoutForLockup:v8 columnIndex:a5];

  double v16 = [(SUUIStorePageSection *)self context];
  id v17 = [v16 collectionView];
  BOOL v18 = SUUIEditorialLayoutOrientationForView(v17);
...
- (void)_reloadLockupCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  uint64_t v13 = [(SUUILockupComponent *)v8 item];
  ...
  double v14 = [(SUUIRowSection *)self _lockupImageForComponent:v8];
  [v11 setIconImage:v14];
  BOOL v15 = self->_overlaySourceComponent == v8;

  [v11 setIconImageHidden:v15];
  double v16 = +[SUUIItemStateCenter defaultCenter];
...
- (void)_reloadView:(id)a3 forMediaComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  if (!v11)
  {
    ...
    id v14 = [(SUUIRowSection *)self _newSizeToFitArtworkRequestWithArtwork:v13 columnIndex:a5];
    componentArtworkRequestIDs = self->_componentArtworkRequestIDs;
    ...
    && (objc_msgSend(v10, "trySetReason:forRequestWithIdentifier:", 1, objc_msgSend(v12, "unsignedIntegerValue")) & 1) == 0)
  {
    ...
    if (v14)
    {
      id v15 = [(SUUIRowSection *)self _newSizeToFitArtworkRequestWithArtwork:v14 columnIndex:a5];
...
- (void)_selectGalleryComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  uint64_t v7 = [(SUUIStorePageSection *)self clickEventWithMedia:v6 elementName:@"Column" index:a4];
  if (v7)
  {
    id v8 = [(SUUIStorePageSection *)self context];
...
- (void)_selectLockupComponent:(id)a3 columnIndex:(int64_t)a4
{
  id v6 = a3;
  uint64_t v7 = [v6 item];
  id v8 = [(SUUIRowSection *)self clickEventWithItem:v7 elementName:@"Column" index:a4];
  if (v8)
  {
    id v9 = [(SUUIStorePageSection *)self context];
  ...
  {
    if (SUUIItemKindIsSoftwareKind([v7 itemKind])
...
uint64_t __53__SUUIRowSection__selectLockupComponent_columnIndex___block_invoke(uint64_t result, char a2)
{
  if ((a2 & 1) == 0)
  {
    ...
    if (!*(void *)(v4 + 168))
    {
      double v5 = [[SUUIProductPageOverlayController alloc] initWithParentViewController:*(void *)(result + 40)];
...
{
  id v9 = a3;
  double v5 = -[SUUIStorePageSection clickEventWithMedia:elementName:index:](self, "clickEventWithMedia:elementName:index:");
  if (v5)
  {
...
- (void)_setPositionForClickEvent:(id)a3 elementIndex:(int64_t)a4
{
  if (a3)
  {
    ...
    id v8 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", a4, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
...
- (id)_viewControllerForCountdownComponent:(id)a3
{
  ...
  {
    id v6 = [(SUUIStorePageSection *)self context];
    uint64_t v7 = [SUUICountdownViewController alloc];
    id v8 = [v6 resourceLoader];
    double v5 = [(SUUICountdownViewController *)v7 initWithCountdownComponent:v4 artworkLoader:v8];
    ...
    BOOL v12 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", v11, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
    uint64_t v13 = [(SUUICountdownViewController *)v5 view];
    id v14 = [(SUUIRowSection *)self backgroundColorForIndexPath:v12];
    [v13 setBackgroundColor:v14];

    countdownViewControllers = self->_countdownViewControllers;
    if (!countdownViewControllers)
    {
      double v16 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
...
- (id)_viewControllerForGalleryComponent:(id)a3
{
  ...
  {
    id v6 = [(SUUIStorePageSection *)self context];
    uint64_t v7 = [SUUIGalleryViewController alloc];
    id v8 = [v6 resourceLoader];
    double v5 = [(SUUIGalleryViewController *)v7 initWithGalleryComponent:v4 artworkLoader:v8];
    ...
    BOOL v12 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", v11, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
    uint64_t v13 = [(SUUIRowSection *)self backgroundColorForIndexPath:v12];
    ...
    {
      uint64_t v15 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:0];
