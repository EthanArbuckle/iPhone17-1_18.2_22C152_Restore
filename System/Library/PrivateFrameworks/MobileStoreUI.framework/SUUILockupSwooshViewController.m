...
- (SUUILockupSwooshViewController)initWithItemList:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(_OWORD *)&p_defaultLockupStyle->artworkSize = v8;
    ...
    if (v13)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          long long v31 = v18;
          id v19 = [(SUUILockupSwooshViewController *)v6 _newLockupComponentWithItem:v17 defaultStyle:&v31];
          [v11 addObject:v19];
    ...
    {
      uint64_t v23 = [objc_alloc(NSURL) initWithString:v22];
...
- (SUUILockupSwooshViewController)initWithSwoosh:(id)a3
{
  ...
  return (SUUILockupSwooshViewController *)v5;
}
...
- (void)dealloc
{
  ...
  id v4 = [(SUUISwooshView *)self->_swooshView seeAllControl];
...
- (CGRect)seeAllButtonFrame
{
  ...
  if (seeAllStyle == 1)
  {
    uint64_t v3 = [(SUUISwooshView *)self->_swooshView chevronTitleControl];
  }
  else
  {
    if (seeAllStyle)
    ...
    uint64_t v3 = [(SUUISwooshView *)self->_swooshView seeAllControl];
  }
  id v4 = (void *)v3;
LABEL_7:
  [v4 bounds];
...
- (void)setLockups:(id)a3
{
  ...
  long long v26 = __Block_byref_object_copy__84;
  long long v27 = __Block_byref_object_dispose__84;
  id v28 = 0;
...
void __45__SUUILockupSwooshViewController_setLockups___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      id v10 = *(void **)(a1 + 40);
      id v8 = [MEMORY[0x263F088C8] indexPathForItem:v9 inSection:0];
      [v10 addObject:v8];
    }
...
- (void)setSeeAllHidden:(BOOL)a3
{
  if (self->_seeAllHidden != a3)
  {
    ...
    {
      id v7 = [(SUUISwooshView *)self->_swooshView seeAllControl];
      [v7 setHidden:v3];
    }
  }
}
...
- (SUUIVideoImageDataConsumer)videoImageConsumer
{
  ...
  {
    id v4 = objc_alloc_init(SUUIVideoImageDataConsumer);
    ...
    unint64_t v6 = [(SUUISwooshViewController *)self colorScheme];
...
- (id)popImageViewForItemAtIndex:(int64_t)a3
{
  ...
  if (v7)
  {
    ...
    double v13 = [(SUUILockupSwooshViewController *)self view];
    [v12 frame];
    ...
    {
      double v15 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x263F089C8]);
...
{
  collectionView = self->_collectionView;
  double v6 = (void *)MEMORY[0x263F088C8];
  id v7 = a3;
...
void __46__SUUILockupSwooshViewController_unhideImages__block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  BOOL v3 = [MEMORY[0x263F088C8] indexPathForRow:a2 inSection:0];
...
- (void)loadView
{
  if (!self->_swooshView)
  {
    BOOL v3 = objc_alloc_init(SUUISwooshView);
    swooshView = self->_swooshView;
    self->_swooshView = v3;
    ...
    if (seeAllStyle == 1)
    {
      objc_super v8 = [(SUUISwooshView *)self->_swooshView chevronTitleControl];
    ...
    {
      double v6 = [(SUUISwooshView *)self->_swooshView seeAllControl];
    ...
    double v11 = [(SUUISwooshViewController *)self colorScheme];
  ...
  else
  {
    ...
    {
      id v28 = [(SUUISwooshViewController *)self clientContext];
      uint64_t v29 = v28;
      if (v28) {
        [v28 localizedStringForKey:@"SWOOSH_SEE_ALL_TITLE"];
      }
      else {
      uint64_t v31 = +[SUUIClientContext localizedStringForKey:@"SWOOSH_SEE_ALL_TITLE" inBundles:0];
      }
  ...
  if (!collectionView)
  {
    double v16 = objc_alloc_init(SUUISwooshCollectionViewLayout);
    double v17 = [(SUUISwooshView *)self->_swooshView backgroundColor];
    ...
    uint64_t v20 = (UICollectionView *)objc_msgSend(objc_alloc(MEMORY[0x263F82528]), "initWithFrame:collectionViewLayout:", v16, 0.0, 0.0, 0.0, self->_maxCellSize.height);
    ...
    uint64_t v23 = [(SUUISwooshView *)self->_swooshView backgroundColor];
  ...
  long long v27 = [(SUUILockupSwooshViewController *)self title];
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  uint64_t v8 = [(SUUISwooshViewController *)self clientContext];
  BOOL v9 = [v7 layout];
  ...
  long long v13 = [(SUUISwooshViewController *)self colorScheme];
  ...
  double v15 = [(SUUISwooshViewController *)self delegate];
...
{
  id v6 = a4;
  id v5 = [(SUUISwooshViewController *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
{
  id v6 = a5;
  double v7 = objc_alloc_init(SUUILockupSwooshCollectionViewCell);
  double v8 = [(SUUILockupSwooshCollectionViewCell *)v7 layout];
  lockups = self->_lockups;
  uint64_t v10 = [v6 item];
...
- (void)_seeAllAction:(id)a3
{
  id v4 = [(SUUISwooshViewController *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
- (CGSize)_maximumCellSizeForImageSize:(CGSize)a3
{
  ...
  uint64_t v10 = objc_alloc_init(SUUILockupSwooshCollectionViewCell);
  long long v11 = [(SUUILockupSwooshCollectionViewCell *)v10 layout];
  long long v29 = 0u;
  long long v30 = 0u;
  long long v31 = 0u;
  long long v32 = 0u;
...
- (id)_newArtworkContextForSwooshType:(int64_t)a3
{
  id v5 = objc_alloc_init(SUUIItemArtworkContext);
  double v6 = [(SUUISwooshViewController *)self colorScheme];
  ...
  if ((self->_defaultLockupStyle.visibleFields & 0x400) != 0)
  {
    ...
    uint64_t v13 = +[SUUIProductImageDataConsumer consumerWithSize:](SUUIProductImageDataConsumer, "consumerWithSize:", width, p_videoLockupIconSize->height);
    [(SUUIItemArtworkContext *)v5 setGeneralConsumer:v13];

    double v14 = +[SUUIStyledImageDataConsumer appIconConsumerWithSize:](SUUIStyledImageDataConsumer, "appIconConsumerWithSize:", p_videoLockupIconSize->width, p_videoLockupIconSize->height);
    [(SUUIItemArtworkContext *)v5 setIconConsumer:v14];
  }
  else
  {
    double v8 = +[SUUIProductImageDataConsumer consumerWithSize:](SUUIProductImageDataConsumer, "consumerWithSize:", self->_metrics.newsstandSize.width, self->_metrics.newsstandSize.height);
    [(SUUIItemArtworkContext *)v5 setGeneralConsumer:v8];

    double v9 = +[SUUIStyledImageDataConsumer appIconConsumerWithSize:](SUUIStyledImageDataConsumer, "appIconConsumerWithSize:", p_metrics->iconSize.width, p_metrics->iconSize.height);
  ...
  double v15 = +[SUUIStyledImageDataConsumer productImageConsumerWithSize:](SUUIStyledImageDataConsumer, "productImageConsumerWithSize:", p_videoLockupIconSize->width, *p_height);
...
- (id)_newLockupComponentWithItem:(id)a3 defaultStyle:(SUUILockupStyle *)a4
{
  ...
  double v6 = [SUUILockupComponent alloc];
  long long v9 = *(_OWORD *)&a4->artworkSize;
  unint64_t visibleFields = a4->visibleFields;
  double v7 = [(SUUILockupComponent *)v6 initWithItem:v5 style:&v9];
...
- (void)_reloadSizes
{
  BOOL v3 = [(SUUILockupSwooshViewController *)self _newArtworkContextForSwooshType:self->_swooshType];
  artworkContext = self->_artworkContext;
  self->_artworkContext = v3;

  if ([(NSArray *)self->_lockups count]
    || (self->_expectedImageSize.width == *MEMORY[0x263F001B0]
      ? (BOOL v5 = self->_expectedImageSize.height == *(double *)(MEMORY[0x263F001B0] + 8))
      : (BOOL v5 = 0),
        v5))
  {
...
- ($0F9D46A54E891E2DFD6B960C8B4302D3)_lockupSwooshMetrics
{
  ...
  *(_OWORD *)&retstr->var7 = 0u;
  ...
  retstr->var2 = 0u;
  retstr->var0 = 0u;
  uint64_t v4 = [(SUUISwooshViewController *)self clientContext];
  uint64_t v5 = SUUIUserInterfaceIdiom(v4);

  if (v5 == 1)
  {
    retstr->var0 = (CGSize)vdupq_n_s64(0x4056800000000000uLL);
    retstr->var1 = (CGSize)xmmword_2568A1850;
    retstr->var2 = (CGSize)xmmword_2568A1880;
    retstr->var3 = (CGSize)vdupq_n_s64(0x4046000000000000uLL);
    retstr->var4 = (CGSize)xmmword_2568A1890;
    *(_OWORD *)&retstr->var5 = xmmword_2568A18A0;
    __asm { FMOV            V0.2D, #30.0 }
    *(_OWORD *)&retstr->var7 = _Q0;
  }
  else
  {
    int64_t v12 = [MEMORY[0x263F82B60] mainScreen];
    [v12 bounds];
    double v14 = v13;

    if (v14 <= 375.0)
    {
      long long v16 = [MEMORY[0x263F82B60] mainScreen];
      [v16 bounds];
      double v18 = v17;
      ...
      if (v18 <= 320.0)
      {
        ...
        retstr->var1 = (CGSize)xmmword_2568A17F0;
        retstr->var2 = (CGSize)xmmword_2568A1800;
        retstr->var3 = (CGSize)vdupq_n_s64(0x4046000000000000uLL);
        CGSize v15 = (CGSize)xmmword_2568A1810;
      }
      else
      {
        retstr->var0 = (CGSize)vdupq_n_s64(0x4057C00000000000uLL);
        retstr->var1 = (CGSize)xmmword_2568A1820;
        retstr->var2 = (CGSize)xmmword_2568A1830;
        retstr->var3 = (CGSize)vdupq_n_s64(0x4046000000000000uLL);
        CGSize v15 = (CGSize)xmmword_2568A1840;
      }
    }
    else
    {
      ...
      retstr->var1 = (CGSize)xmmword_2568A1850;
      retstr->var2 = (CGSize)xmmword_2568A1860;
      retstr->var3 = (CGSize)vdupq_n_s64(0x4046000000000000uLL);
      CGSize v15 = (CGSize)xmmword_2568A1870;
    }
