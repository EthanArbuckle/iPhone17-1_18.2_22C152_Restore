...
- (SUUIProductPagePlaceholderView)initWithPlaceholderString:(id)a3 isPad:(BOOL)a4
{
  ...
  id v6 = a3;
  v21.receiver = self;
  v21.super_class = (Class)SUUIProductPagePlaceholderView;
  v7 = [(SUUIProductPagePlaceholderView *)&v21 init];
  if (v7)
  {
    v8 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    id v9 = objc_alloc(MEMORY[0x263F82828]);
    v10 = [MEMORY[0x263F827E8] imageNamed:@"RelatedProxyGraphicApp" inBundle:v8];
    ...
    v15 = v7->_label;
    v16 = [MEMORY[0x263F825C8] colorWithWhite:0.384313732 alpha:1.0];
    ...
    v19 = [MEMORY[0x263F81708] systemFontOfSize:v18];
...
- (void)setTextColor:(id)a3
{
  ...
  {
    id v6 = [MEMORY[0x263F825C8] colorWithWhite:0.384313732 alpha:1.0];
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SUUIProductPagePlaceholderView;
