...
- (void)setPerspectiveTargetView:(id)a3
{
  ...
  [(SUUIViewReuseCollectionViewCell *)self enumerateExistingViewsForReuseIdentifier:0x270504D70 usingBlock:v4];
  objc_destroyWeak(&v5);
...
- (void)setVanishingPoint:(CGPoint)a3
{
  ...
  CGPoint v4 = a3;
  [(SUUIViewReuseCollectionViewCell *)self enumerateExistingViewsForReuseIdentifier:0x270504D70 usingBlock:v3];
}
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v8 = a5;
  id v9 = a3;
  double v10 = [[SUUIProductLockupLayout alloc] initWithLockup:v9 width:v8 context:a4];

  [(SUUIProductLockupLayout *)v10 metadataWidthForWidth:a4];
  double v12 = v11;
  double v13 = [(SUUIProductLockupLayout *)v10 viewElementsForSection:5];
  [a1 _requestLayoutForViewElements:v13 width:v8 context:v12];

  int64_t v14 = [(SUUIProductLockupLayout *)v10 viewElementsForSection:1];
  [a1 _requestLayoutForViewElements:v14 width:v8 context:v12];

  if (v10) {
    [(SUUIProductLockupLayout *)v10 layoutWidthsForWidth:a4];
  }
  uint64_t v15 = -[SUUIProductLockupLayout viewElementsForSection:](v10, "viewElementsForSection:", 4, (unsigned __int128)0, (unsigned __int128)0);
  ...
  uint64_t v17 = [(SUUIProductLockupLayout *)v10 viewElementsForSection:0];
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  id v7 = a5;
  id v8 = a4;
  id v9 = [[SUUIProductLockupLayout alloc] initWithLockup:v8 width:v7 context:a3];

  double v10 = [(SUUIProductLockupLayout *)v9 viewElementsForSection:3];
  ...
  unint64_t v14 = 0.0 > 0.00000011920929;
  if (0.0 > 0.00000011920929) {
    v14 += 2;
  }
  double v15 = 0.0 + 0.0 + 0.0;
  if (v14 > 1) {
    double v15 = v15 + (double)(uint64_t)(v14 - 1) * 5.0;
  }
  double v16 = -0.0;
  if (0.0 > 0.00000011920929) {
    double v16 = 5.0;
  }
  double v17 = 0.0 + 0.0 + v16;
  if (v15 >= v17) {
    double v17 = v15;
  }
  if (v12 < v17) {
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  double v11 = [[SUUIProductLockupLayout alloc] initWithLockup:v10 width:v8 context:a4];
...
void __75__SUUIProductLockupCollectionViewCell_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
  ...
  v8[1] = 3221225472;
  v8[2] = __75__SUUIProductLockupCollectionViewCell_reloadWithViewElement_width_context___block_invoke_2;
  v8[3] = &unk_2654084E0;
  double v11 = v6;
  v8[4] = v4;
  id v9 = v3;
    ...
    if (v9 > 134)
    {
      ...
      switch(v9)
      {
        ...
        default:
          ...
          v25 = [*(id *)(a1 + 40) addImageViewWithVideoElement:v53 context:*(void *)(a1 + 48)];
          break;
      }
LABEL_39:
      v24 = v25;
LABEL_44:
    ...
    if (v9 == 109)
    {
      unint64_t v14 = [*(id *)(a1 + 40) addReusableViewWithReuseIdentifier:0x270504D50];
      v20 = [[SUUISegmentedControlViewElementController alloc] initWithViewElement:v53 segmentedControl:v14];
      v28 = [*(id *)(a1 + 48) clientContext];
      [(SUUISegmentedControlViewElementController *)v20 setClientContext:v28];

      [(SUUISegmentedControlViewElementController *)v20 setDesiredSegmentWidth:40.0];
...
LABEL_49:
  ...
  if (v9 > 48)
  {
    if (v9 <= 61)
    {
      ...
      v26 = [*(id *)(a1 + 40) addImageViewWithElement:v53 context:*(void *)(a1 + 48)];
      v27 = [v26 tapRecognizer];
    ...
    if (v9 != 62)
    {
      ...
      unint64_t v14 = [*(id *)(a1 + 40) addOfferViewWithViewElement:v20 width:*(void *)(a1 + 48) context:a4];
      if ([(SUUISegmentedControlViewElementController *)v20 isSimpleOffer])
      {
        if (v7 == 1) {
      ...
      {
        uint64_t v49 = [(SUUISegmentedControlViewElementController *)v14 metadataPosition];
        uint64_t v21 = 0;
        if (v49 != 1) {
          *(void *)(*(void *)(a1 + 32) + 872) = v49;
        }
      }
      [(SUUISegmentedControlViewElementController *)v14 setDelegate:v21];
      if (!v14) {
        goto LABEL_79;
      }
      ...
      if (!v29)
      {
        uint64_t v50 = [objc_alloc(MEMORY[0x263F088B0]) initWithOptions:517 capacity:1];
...
LABEL_15:
      double v16 = [*(id *)(a1 + 40) addButtonWithElement:v53 width:*(void *)(a1 + 48) context:a4];
    ...
    v25 = [*(id *)(a1 + 40) addBadgeViewWithElement:v53 width:*(void *)(a1 + 48) context:a4];
    goto LABEL_39;
  }
  if (v9 != 13)
  {
...
LABEL_42:
    unint64_t v14 = (SUUISegmentedControlViewElementController *)v15;
LABEL_80:
    double v11 = 0;
    double v12 = 0;
    double v13 = 0;
...
LABEL_35:
  v22 = [*(id *)(a1 + 40) addButtonWithElement:v53 width:*(void *)(a1 + 48) context:a4];
...
LABEL_53:
  if (v11)
  {
    ...
    if (v35)
    {
      ...
      if (!v36)
      {
        uint64_t v37 = [objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:517 capacity:1];
  ...
  if (v13)
  {
    ...
    if (v40)
    {
      ...
      if (!v41)
      {
        uint64_t v42 = [objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:1];
  ...
  if (v12)
  {
    ...
    if (!v45)
    {
      uint64_t v46 = [objc_alloc(MEMORY[0x263F088B0]) initWithOptions:517 capacity:1];
...
{
  v140.receiver = self;
  v140.super_class = (Class)SUUIProductLockupCollectionViewCell;
  [(SUUICollectionViewCell *)&v140 layoutSubviews];
  id v3 = [(SUUIProductLockupCollectionViewCell *)self contentView];
  [v3 bounds];
  CGFloat v5 = v4;
  CGFloat v7 = v6;
  CGFloat v9 = v8;
  ...
  uint64_t v134 = 0;
  v135 = (double *)&v134;
  uint64_t v136 = 0x3010000000;
  v137 = "";
  uint64_t v71 = v15;
  uint64_t v72 = v14;
  uint64_t v138 = v15;
  uint64_t v139 = v14;
  long long v16 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:3];
  ...
  if (v17)
  {
    ...
    v135[4] = CGRectGetMaxX(v141) + 13.0;
  }
  double v81 = v135[5];
  double v82 = v135[4];
  v25 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:5];
  int ShouldReverseLayoutDirection = storeShouldReverseLayoutDirection();
  double v79 = v11 - v78 - v81;
  double v80 = v9 - v77 - v82;
  double v27 = SUUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v82, v81, v80, v79, v5, v7, v9, v11);
  ...
  -[SUUIProductLockupCollectionViewCell _stackElements:alignment:inRect:](self, "_stackElements:alignment:inRect:", v25, v28, v27, v11 - v78);
  double v76 = SUUIRectByRemovingStoreUserInterfaceLayoutDirectionInRect(v29, v30, v31, v32, v5, v7, v9, v11);
  uint64_t v69 = v34;
  uint64_t v70 = v33;
  uint64_t v68 = v35;
  uint64_t v36 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:1];
  -[SUUIProductLockupCollectionViewCell _stackBottomRightElements:inRect:](self, "_stackBottomRightElements:inRect:", v36, v82, v81, v80, v79);
  double v67 = v37;
  double v74 = v39;
  double v75 = v38;
  double rect = v40;
  ...
  double v130 = v82;
  double v131 = v81;
  double v132 = v9 - v77 - v82;
  double v133 = v11 - v78 - v81;
  if ([v25 count]) {
    v127[6] = v76 - 5.0 - v127[4];
  }
  v41 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:4];
  ...
  [(SUUIProductLockupCollectionViewCell *)self _stackElements:v41 alignment:v42 inRect:SUUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v127[4], v127[5], v127[6], v127[7], v5, v7, v9, v11)];
  CGFloat v47 = SUUIRectByRemovingStoreUserInterfaceLayoutDirectionInRect(v43, v44, v45, v46, v5, v7, v9, v11);
  uint64_t v49 = v48;
  uint64_t v51 = v50;
  uint64_t v53 = v52;
  ...
  aBlock[3] = &unk_265408508;
  v104 = &v126;
  double v105 = v82;
  double v106 = v81;
  double v107 = v9 - v77 - v82;
  double v108 = v11 - v78 - v81;
  id v54 = v41;
  id v100 = v54;
  CGFloat v109 = v47;
  uint64_t v110 = v49;
  ...
  v57[2](v67, v75, v74, rect, 0.0);
  v58 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:0];
  if ([v58 count])
  {
    int64_t v59 = [(SUUIProductLockupLayout *)self->_layout bottomLeftLayoutStyle];
    if (v59 == 2)
    {
      uint64_t v93 = 0;
      v94 = (double *)&v93;
      v60 = (const char *)*((void *)v135 + 4);
      uint64_t v95 = 0x2020000000;
      v96 = v60;
      v98[0] = MEMORY[0x263EF8330];
      v98[1] = 3221225472;
      v98[2] = __53__SUUIProductLockupCollectionViewCell_layoutSubviews__block_invoke_2;
      v98[3] = &unk_265408530;
      *(double *)&v98[6] = v9 - v77 - v82;
      *(double *)&v98[7] = v11 - v78 - v81;
      v98[4] = self;
      v98[5] = &v93;
      *(CGFloat *)&v98[8] = v5;
      *(CGFloat *)&v98[9] = v7;
      ...
      *(double *)&v98[14] = v78;
      *(double *)&v98[15] = v77;
      [v58 enumerateObjectsUsingBlock:v98];
      if ([v56 count])
      {
        v142.origin.x = v67;
        v142.size.width = v74;
        ...
        if (CGRectGetMinX(v142) < v94[3])
        {
          if ([(SUUIProductLockupLayout *)self->_layout hasBottomRightElementWithRightAlignment])
          {
            ...
            v143.origin.x = v82;
            v143.origin.y = v81;
            v143.size.width = v9 - v77 - v82;
            v143.size.height = v79;
            double MinY = CGRectGetMinY(v143);
            v144.origin.x = v82;
            v144.origin.y = v81;
            v144.size.width = v80;
            v144.size.height = v79;
            double MaxX = CGRectGetMaxX(v144);
            v145.origin.x = v82;
            v145.origin.y = v81;
            v145.size.width = v80;
            v145.size.height = v79;
            -[SUUIProductLockupCollectionViewCell _stackBottomRightElements:inRect:](self, "_stackBottomRightElements:inRect:", v56, v61, MinY, MaxX - v94[3], CGRectGetHeight(v145));
    ...
    {
      if ([v56 count]) {
        double v64 = v67 - 5.0 - v82;
      }
      else {
        double v64 = v9 - v77 - v82;
      }
      uint64_t v93 = 0;
      v94 = (double *)&v93;
      uint64_t v95 = 0x3010000000;
      v96 = "";
      long long v97 = *MEMORY[0x263F001B0];
      uint64_t v89 = 0;
      v90 = &v89;
      ...
      v84[1] = 3221225472;
      v84[2] = __53__SUUIProductLockupCollectionViewCell_layoutSubviews__block_invoke_3;
      v84[3] = &unk_265408558;
      *(double *)&v84[8] = v64;
      *(CGFloat *)&v84[9] = v5;
      *(CGFloat *)&v84[10] = v7;
      ...
      *(CGFloat *)&v84[12] = v11;
      ...
      v84[6] = &v93;
      v84[7] = &v89;
      [v58 enumerateObjectsUsingBlock:v84];
      v65 = v94;
      if (v59 && v94[4] < v64) {
        double v64 = v94[4];
      }
      ...
      v83[1] = 3221225472;
      v83[2] = __53__SUUIProductLockupCollectionViewCell_layoutSubviews__block_invoke_4;
      v83[3] = &unk_265408580;
      v83[4] = self;
      v83[5] = &v134;
      v83[6] = &v89;
      ...
      *(CGFloat *)&v83[11] = v9;
      *(CGFloat *)&v83[12] = v11;
      [v58 enumerateObjectsUsingBlock:v83];
...
double __53__SUUIProductLockupCollectionViewCell_layoutSubviews__block_invoke(uint64_t a1, double a2, double a3, double a4, double a5, double a6)
{
  ...
  *(_OWORD *)(v10 + 48) = v11;
  ...
  CGFloat v19 = *(CGFloat **)(*(void *)(a1 + 64) + 8);
  objc_msgSend(v17, "_stackElements:alignment:inRect:", v18, *(void *)(a1 + 232), SUUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v19[4], v19[5], v19[6], v19[7], *(CGFloat *)(a1 + 136), *(CGFloat *)(a1 + 144), *(CGFloat *)(a1 + 152), *(CGFloat *)(a1 + 160)));
  double v21 = v20;
...
void __53__SUUIProductLockupCollectionViewCell_layoutSubviews__block_invoke_2(uint64_t a1, uint64_t a2)
{
  ...
  if (([v9 isHidden] & 1) == 0)
  {
    ...
    objc_msgSend(v9, "setFrame:", SUUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v12.origin.x, v12.origin.y, v12.size.width, v12.size.height, *(CGFloat *)(a1 + 64), *(CGFloat *)(a1 + 72), *(CGFloat *)(a1 + 80), *(CGFloat *)(a1 + 88)));
...
void __53__SUUIProductLockupCollectionViewCell_layoutSubviews__block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if (([v3 isHidden] & 1) == 0)
  {
    ...
    objc_msgSend(v3, "setFrame:", SUUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v22.origin.x, v22.origin.y, v22.size.width, v22.size.height, *(CGFloat *)(a1 + 72), *(CGFloat *)(a1 + 80), *(CGFloat *)(a1 + 88), *(CGFloat *)(a1 + 96)));
...
- (void)_buttonAction:(id)a3
{
  ...
  id v4 = a3;
  double v15 = SUUICollectionViewForView(self);
...
+ (id)_attributedStringForButton:(id)a3 context:(id)a4
{
  ...
  if (!v11)
  {
    double v11 = SUUIFontLimitedPreferredFontForTextStyle(21, 5);
  }
  ...
  long long v15 = [v14 attributedStringWithDefaultFont:v11 foregroundColor:v13 style:v10];
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  switch([v5 labelViewStyle])
  {
    ...
    case 1:
      ...
      {
        uint64_t v8 = SUUIFontForTextStyle(10);
        if (!v10)
        {
LABEL_15:
          double v11 = (void *)MEMORY[0x263F825C8];
          double v12 = 0.6;
          goto LABEL_22;
        }
      }
LABEL_24:
      long long v14 = [v5 text];
      long long v15 = [v14 attributedStringWithDefaultFont:v8 foregroundColor:v10 style:v7];
    ...
    case 5:
      ...
      {
        uint64_t v8 = SUUIFontLimitedPreferredFontForTextStyle(2, 5);
        if (v10) {
          goto LABEL_24;
        }
      }
    ...
    case 4:
      ...
      {
        uint64_t v8 = SUUIFontLimitedPreferredFontForTextStyle(21, 5);
        if (v10) {
          goto LABEL_24;
        }
      }
      ...
      double v12 = 0.8;
LABEL_22:
      uint64_t v13 = [v11 colorWithWhite:0.0 alpha:v12];
LABEL_23:
      double v10 = (void *)v13;
      goto LABEL_24;
    default:
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        uint64_t v17 = objc_msgSend(v16, "elementType", (void)v20);
        if (v17 > 76)
        {
          switch(v17)
          {
            case 135:
              long long v18 = SUUIStarRatingViewElementView;
              break;
            case 136:
            case 137:
            case 139:
            ...
            case 143:
              continue;
            case 138:
              long long v19 = [a1 _attributedStringForLabel:v16 context:v9];
              [v10 requestLayoutForLabel:v16 attributedString:v19 width:(uint64_t)a4];
              goto LABEL_23;
            case 141:
              goto LABEL_16;
            case 144:
              long long v18 = SUUITomatoRatingView;
              break;
            default:
              if (v17 == 77)
              {
                long long v18 = SUUIOfferView;
              }
              else
              {
                if (v17 != 131) {
                ...
                long long v18 = SUUIStackListCollectionViewCell;
              }
              break;
          }
LABEL_26:
        ...
        if (v17 > 47)
        {
          if (v17 == 48)
          {
            long long v18 = SUUISectionHeaderView;
          }
          else
          {
            if (v17 != 62) {
            ...
            long long v18 = SUUIHorizontalListView;
          }
          goto LABEL_26;
        }
        if (v17 == 8)
        ...
        {
LABEL_16:
          long long v19 = [a1 _attributedStringForButton:v16 context:v9];
...
- (CGRect)_frameForSection:(int64_t)a3
{
  ...
  long long v20 = v4;
  id v5 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:a3];
...
- (void)_layoutConfirmationGradientRelativeToSection:(int64_t)a3 alpha:(double)a4
{
  ...
  if (offerConfirmationGradientView)
  {
    ...
    *((void *)&v32 + 1) = v11;
    CGFloat v12 = [(SUUIGradientView *)self->_offerConfirmationGradientView layer];
    ...
    if (a3)
    {
      ...
      v21[6] = v14 + 30.0;
      v33[0] = &unk_2705D0E08;
      long long v22 = [NSNumber numberWithDouble:30.0 / (v14 + 30.0)];
      v33[1] = v22;
      v33[2] = &unk_2705D0DF0;
    ...
    else
    {
      ...
      v21[6] = v14 + 30.0;
      v34[0] = &unk_2705D0DF0;
      long long v22 = [NSNumber numberWithDouble:1.0 - 30.0 / (v14 + 30.0)];
      v34[1] = v22;
      v34[2] = &unk_2705D0E08;
      [MEMORY[0x263EFF8C0] arrayWithObjects:v34 count:3];
    long long v23 = };
    [v12 setLocations:v23];

    CGFloat v24 = [(SUUIGradientView *)self->_offerConfirmationGradientView superview];
...
- (void)_prepareOfferConfirmationGradientForView:(id)a3
{
  ...
  id v22 = a3;
  long long v23 = -[SUUIProductLockupCollectionViewCell _viewElementForView:](self, "_viewElementForView:");
  if (v23)
  {
    CGFloat v4 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:1];
    ...
    long long v32 = __Block_byref_object_copy__92;
    uint64_t v33 = __Block_byref_object_dispose__92;
    id v34 = 0;
    CGFloat v7 = -[SUUIProductLockupLayout viewElementsForSection:](self->_layout, "viewElementsForSection:");
    v26[0] = MEMORY[0x263EF8330];
    v26[1] = 3221225472;
    v26[2] = __80__SUUIProductLockupCollectionViewCell__prepareOfferConfirmationGradientForView___block_invoke;
    v26[3] = &unk_265405D00;
    v26[4] = self;
    uint64_t v28 = &v29;
    id v8 = v6;
    ...
    {
      CGRect v10 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:qword_2568A1958[i]];
      v24[0] = MEMORY[0x263EF8330];
      v24[1] = 3221225472;
      v24[2] = __80__SUUIProductLockupCollectionViewCell__prepareOfferConfirmationGradientForView___block_invoke_2;
      v24[3] = &unk_2654085F8;
      v24[4] = self;
      id v11 = v8;
      id v25 = v11;
    ...
    if (!offerConfirmationGradientView)
    {
      double v13 = [SUUIGradientView alloc];
      double v14 = -[SUUIGradientView initWithFrame:](v13, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
      double v15 = self->_offerConfirmationGradientView;
      self->_offerConfirmationGradientView = v14;

      uint64_t v16 = [(SUUIProductLockupCollectionViewCell *)self backgroundColor];
      uint64_t v17 = [(SUUIGradientView *)self->_offerConfirmationGradientView layer];
      ...
      id v20 = v19;
      v35[2] = [v20 CGColor];
      long long v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v35 count:3];
      [v17 setColors:v21];
...
{
  id v4 = a3;
  double v5 = [(SUUIProductLockupCollectionViewCell *)self _viewElementForView:v4];
  double v6 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:1];
  ...
  else
  {
    ...
    {
      double v18 = [(SUUIProductLockupLayout *)self->_layout viewElementsForSection:0];
      uint64_t v37 = 0;
...
uint64_t __84__SUUIProductLockupCollectionViewCell__updateLayoutToAnimateOfferTransitionForView___block_invoke(void *a1, uint64_t a2)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (v26 == (void *)a1[5])
    {
      objc_msgSend(v26, "sizeThatFits:", *(double *)(MEMORY[0x263F00190] + 16), *(double *)(MEMORY[0x263F00190] + 24));
      double v10 = v16;
      double v12 = v17;
    }
    if (storeShouldReverseLayoutDirection())
