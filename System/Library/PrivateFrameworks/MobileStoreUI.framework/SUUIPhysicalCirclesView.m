...
- (SUUIPhysicalCirclesView)initWithFrame:(CGRect)a3
{
  ...
  id v3 = -[SUUIPhysicalCirclesView initWithFrame:](&v16, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    uint64_t v4 = SUUIPhysicsKitFramework();
    *((void *)v3 + 70) = v4;
    id v5 = objc_alloc_init((Class)SUUIWeakLinkedClassForString(&cfstr_Pkphysicsworld.isa, v4));
    v6 = (void *)*((void *)v3 + 71);
    *((void *)v3 + 71) = v5;

    [*((id *)v3 + 71) setContactDelegate:v3];
    objc_msgSend(*((id *)v3 + 71), "setGravity:", 0.0, 0.0);
    id v7 = objc_alloc_init((Class)SUUIWeakLinkedClassForString(&cfstr_Pkphysicsbody.isa, *((void *)v3 + 70)));
    v8 = (void *)*((void *)v3 + 64);
    *((void *)v3 + 64) = v7;

    objc_msgSend(*((id *)v3 + 64), "setPosition:", 0.0, 0.0);
    [*((id *)v3 + 71) addBody:*((void *)v3 + 64)];
    [*((id *)v3 + 64) setDynamic:0];
    *((void *)v3 + 65) = 0x7FFFFFFFFFFFFFFFLL;
    uint64_t v9 = [objc_alloc(MEMORY[0x263F82938]) initWithTarget:v3 action:sel__longPressAction_];
    v10 = (void *)*((void *)v3 + 66);
    *((void *)v3 + 66) = v9;

    [v3 addGestureRecognizer:*((void *)v3 + 66)];
    uint64_t v11 = [objc_alloc(MEMORY[0x263F82A00]) initWithTarget:v3 action:sel__panGestureAction_];
    v12 = (void *)*((void *)v3 + 69);
    *((void *)v3 + 69) = v11;

    [v3 addGestureRecognizer:*((void *)v3 + 69)];
    uint64_t v13 = [objc_alloc(MEMORY[0x263F82CB0]) initWithTarget:v3 action:sel__tapGestureAction_];
    v14 = (void *)*((void *)v3 + 73);
    *((void *)v3 + 73) = v13;

    [v3 addGestureRecognizer:*((void *)v3 + 73)];
...
- (id)addRepellorWithCenter:(CGPoint)a3 radius:(double)a4 bufferSize:(double)a5
{
  ...
  uint64_t v11 = objc_msgSend(SUUIWeakLinkedClassForString(&cfstr_Pkphysicsbody.isa, (uint64_t)self->_physicsKitFramework), "bodyWithCircleOfRadius:", a4);
...
- (void)reloadData
{
  ...
  id v3 = [(SUUIPhysicalCirclesView *)self traitCollection];
  BOOL v4 = [v3 horizontalSizeClass] == 2;

  double v5 = dbl_2568A1CD0[v4];
  *(void *)&self->_maximumFrequencyDistance = qword_2568A1CC0[v4];
    ...
    if (v8)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v9; ++i)
        {
          ...
          v14 = objc_msgSend(v13, "representedObject", v25);
...
- (void)removeAllRepellors
{
  ...
  id v3 = (void *)[(NSMutableArray *)self->_repellors copy];
  long long v9 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUIPhysicalCirclesView removeRepellor:](self, "removeRepellor:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
...
{
  BOOL v5 = a4;
  uint64_t v8 = (objc_class *)MEMORY[0x263F088D0];
  id v9 = a5;
...
- (void)removeCirclesInIndexSet:(id)a3 byAnimatingToPoint:(CGPoint)a4 delay:(double)a5 completionBlock:(id)a6
{
  ...
  id v15 = (void *)MEMORY[0x263F158F8];
  ...
  if (v39)
  {
    ...
    uint64_t v37 = *MEMORY[0x263F15AB0];
    do
    {
      uint64_t v17 = 0;
      do
      {
        ...
        uint64_t v19 = [MEMORY[0x263F15760] animationWithKeyPath:@"position.x"];
        id v20 = +[SUUISimpleAnimationFactory easeQuadOutTimingFunction];
        ...
        v24 = [MEMORY[0x263F15760] animationWithKeyPath:@"position.y"];
        uint64_t v25 = +[SUUISimpleAnimationFactory easeQuadInTimingFunction];
        ...
        id v30 = [MEMORY[0x263F15760] animationWithKeyPath:@"transform.scale"];
        v31 = +[SUUISimpleAnimationFactory easeQuadInOutTimingFunction];
        [v30 setTimingFunction:v31];

        [v30 setFromValue:&unk_2705D0E20];
        [v30 setToValue:&unk_2705D0980];
        v32 = [MEMORY[0x263F15750] animation];
        v49[0] = v19;
        v49[1] = v24;
        v49[2] = v30;
        id v33 = [MEMORY[0x263EFF8C0] arrayWithObjects:v49 count:3];
...
- (void)setSize:(CGSize)a3 forCircleAtIndex:(int64_t)a4
{
  ...
  uint64_t v6 = (float (*)(void))SUUIWeakLinkedSymbolForString("PKGet_INV_PTM_RATIO", self->_physicsKitFramework);
  if (v6) {
...
- (void)startPhysics
{
  ...
  uint64_t v4 = [MEMORY[0x263F15780] displayLinkWithTarget:self selector:sel__displayLinkTick_];
  uint64_t v5 = self->_displayLink;
  self->_displayLink = v4;

  uint64_t v6 = self->_displayLink;
  id v7 = [MEMORY[0x263EFF9F0] mainRunLoop];
...
{
  id v12 = a3;
  uint64_t v4 = [(SUUIPhysicalCirclesView *)self delegate];
  ...
  if (v5 == 1)
  {
    ...
    int64_t v9 = -[SUUIPhysicalCirclesView _circleIndexForPoint:](self, "_circleIndexForPoint:");
...
{
  id v6 = a3;
  id v4 = [(SUUIPhysicalCirclesView *)self delegate];
  if ((objc_opt_respondsToSelector() & 1) != 0 && [v6 state] == 3)
  {
    [v6 locationInView:self];
    int64_t v5 = -[SUUIPhysicalCirclesView _circleIndexForPoint:](self, "_circleIndexForPoint:");
...
- (void)_addSpringForCircleBody:(id)a3
{
  ...
  double v10 = v9;
  double v12 = v11;
  objc_msgSend(SUUIWeakLinkedClassForString(&cfstr_Pkphysicsjoint.isa, (uint64_t)self->_physicsKitFramework), "jointWithBodyA:bodyB:localAnchorA:localAnchorB:", self->_groundBody, v4, v6, v8, *MEMORY[0x263F00148], *(double *)(MEMORY[0x263F00148] + 8));
...
- (id)_circleBodyWithView:(id)a3
{
  ...
  double v8 = v7;
  double v10 = v9;
  id v11 = SUUIWeakLinkedClassForString(&cfstr_Pkphysicsbody.isa, (uint64_t)self->_physicsKitFramework);
  float v12 = v6 * 0.5;
...
void __48__SUUIPhysicalCirclesView__circleIndexForPoint___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
...
- (void)_loadCirclesWithStartIndex:(int64_t)a3 totalCount:(int64_t)a4
{
  if (a3 < a4)
  {
    ...
    do
    {
      ...
      double v9 = [(SUUIPhysicalCirclesView *)self _circleBodyWithView:v8];
  ...
  double v10 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x263EF8400], 0, 0, MEMORY[0x263EF83A0]);
  circleLoadStepTimer = self->_circleLoadStepTimer;
...
- (void)_reloadDidFinish
{
  ...
  id v5 = [(SUUIPhysicalCirclesView *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource);
  return (SUUIPhysicalCirclesDataSource *)WeakRetained;
}
...
- (SUUIPhysicalCirclesDelegate)delegate
{
  ...
  return (SUUIPhysicalCirclesDelegate *)WeakRetained;
}
