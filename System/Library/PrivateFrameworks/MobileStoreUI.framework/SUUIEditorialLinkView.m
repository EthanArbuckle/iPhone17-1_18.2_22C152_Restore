...
- (SUUIEditorialLinkLayout)linkLayout;
...
{
  v9.receiver = self;
  v9.super_class = (Class)SUUIEditorialLinkView;
  v3 = -[SUUIEditorialLinkView initWithFrame:](&v9, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    id v6 = [(SUUIEditorialLinkView *)v3 _newButton];
    [(SUUIEditorialLinkView *)v3 addSubview:v6];
    [(NSMutableArray *)v3->_buttons addObject:v6];

    id v7 = [(SUUIEditorialLinkView *)v3 _newButton];
...
- (void)dealloc
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SUUIEditorialLinkView;
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        {
          v16 = [(SUUIEditorialLinkView *)self tintColor];
...
- (void)setLinkLayout:(id)a3
{
  uint64_t v5 = (SUUIEditorialLinkLayout *)a3;
  p_layout = &self->_layout;
  if (self->_layout != v5)
  {
    uint64_t v7 = v5;
    objc_storeStrong((id *)p_layout, a3);
    p_layout = (SUUIEditorialLinkLayout **)[(SUUIEditorialLinkView *)self setNeedsLayout];
    uint64_t v5 = v7;
  }
...
- (void)layoutSubviews
{
  if (self->_layout)
  {
    ...
    uint64_t v8 = v7;
    uint64_t v10 = v9;
    uint64_t v11 = [(SUUIEditorialLinkLayout *)self->_layout links];
    v24[0] = 0;
    v24[1] = v24;
    v24[2] = 0x2020000000;
    v24[3] = 0;
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SUUIEditorialLinkView;
...
- (CGSize)sizeThatFits:(CGSize)result
{
  layout = self->_layout;
  if (layout) {
    [(SUUIEditorialLinkLayout *)layout totalSize];
  }
  return result;
}
...
- (void)tintColorDidChange
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)SUUIEditorialLinkView;
  ...
  if (v4)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        {
          double v10 = [(SUUIEditorialLinkView *)self tintColor];
        ...
        {
          uint64_t v12 = [(SUUIEditorialLinkView *)self tintColor];
...
- (void)_linkButtonAction:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      uint64_t v7 = v6;
      unint64_t v8 = [(SUUIEditorialLinkLayout *)self->_layout links];
...
- (id)_newButton
{
  unint64_t v3 = [[SUUILinkButton alloc] initWithArrowStyle:1];
  ...
  {
    uint64_t v6 = [(SUUIEditorialLinkView *)self tintColor];
  ...
  {
    unint64_t v8 = [(SUUIEditorialLinkView *)self tintColor];
    [(SUUILinkButton *)v3 setTitleColor:v8 forState:1];
  }
  unint64_t v9 = [(SUUILinkButton *)v3 titleLabel];
  id v10 = [MEMORY[0x263F81708] systemFontOfSize:12.0];
  [v9 setFont:v10];
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUIEditorialLinkViewDelegate *)WeakRetained;
}
