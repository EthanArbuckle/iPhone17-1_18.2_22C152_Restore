...
void __62__SUUIHorizontalListView_preferredSizeForViewElement_context___block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  id v20 = a2;
...
LABEL_9:
  ...
  *(_OWORD *)(*(void *)(*(void *)(a1 + 40) + 8) + 32) = *MEMORY[0x263F001B0];
...
uint64_t __68__SUUIHorizontalListView_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 > 68)
  {
    ...
    {
      case 135:
        double v6 = SUUIStarRatingControlView;
        goto LABEL_15;
      case 136:
      case 137:
      case 139:
      ...
      case 141:
        goto LABEL_8;
      case 144:
        double v6 = SUUITomatoRatingView;
LABEL_15:
...
LABEL_13:
  ...
  double v6 = SUUIVerticalLockupView;
LABEL_16:
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  char v40 = 0;
  id v10 = [a1 _linesWithViewElement:v8 width:v9 context:a3];
  uint64_t v11 = [v10 count];
  uint64_t v25 = MEMORY[0x263EF8330];
  uint64_t v26 = 3221225472;
  uint64_t v27 = __64__SUUIHorizontalListView_sizeThatFitsWidth_viewElement_context___block_invoke;
  uint64_t v28 = &unk_265402E78;
  v30 = &v37;
  id v34 = a1;
  double v35 = a3;
  id v12 = v9;
  ...
  {
    v13 = objc_msgSend(v10, "objectAtIndex:", v25, v26, v27, v28);
  ...
  if (*((unsigned char *)v38 + 24) && v50[4] < a3) {
    v50[4] = a3;
  }
  id v15 = objc_msgSend(v8, "style", v25, v26, v27, v28);
  [v15 elementPadding];
  double v17 = v16;
  double v19 = v18;
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  uint64_t v8 = (SUUIListViewElement *)a3;
  id v9 = a5;
  ...
  else
  {
    ...
    *(_OWORD *)&p_bigHitInsets->top = *MEMORY[0x263F834E8];
...
LABEL_49:
                    ...
                    uint64_t v25 = [v3 addImageViewWithVideoElement:v14 context:*(void *)(a1 + 40)];
                    break;
                }
LABEL_34:
                id v26 = v25;
...
LABEL_37:
                id v29 = [*(id *)(a1 + 40) imageResourceCacheKeyForViewElement:v14];
                if (v29)
                {
                  v30 = *(void **)(*(void *)(a1 + 32) + 512);
                  if (!v30)
                  {
                    uint64_t v31 = [objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:517 valueOptions:0 capacity:1];
                    uint64_t v32 = *(void *)(a1 + 32);
                    long long v33 = *(void **)(v32 + 512);
                    *(void *)(v32 + 512) = v31;
              ...
              if (v15 <= 48)
              {
                if (v15 == 8)
                {
                  uint64_t v25 = [v3 addBadgeViewWithElement:v14 width:*(void *)(a1 + 40) context:*(double *)(a1 + 48)];
                  goto LABEL_34;
                }
                id v17 = 0;
                if (v15 != 12) {
              ...
              else
              {
                if (v15 == 49)
                {
                  uint64_t v27 = [v3 addImageViewWithElement:v14 context:*(void *)(a1 + 40)];
                  uint64_t v28 = [v27 tapRecognizer];
...
LABEL_51:
              ...
              *(double *)(*(void *)(a1 + 32) + 496) = v36;
              if (v18)
              {
                uint64_t v37 = *(void **)(*(void *)(a1 + 32) + 424);
                if (!v37)
                {
                  uint64_t v38 = [objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:1];
                  uint64_t v39 = *(void *)(a1 + 32);
                  char v40 = *(void **)(v39 + 424);
                  *(void *)(v39 + 424) = v38;
...
{
  id v4 = a3;
  double v5 = [(SUUIViewElement *)self->_listElement flattenedChildren];
  double v6 = [(SUUIViewReuseView *)self allExistingViews];
  uint64_t v15 = 0;
  id v16 = &v15;
  uint64_t v17 = 0x3032000000;
  int v18 = __Block_byref_object_copy__21;
...
void __51__SUUIHorizontalListView_viewForElementIdentifier___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v21 = a2;
  id v7 = [v21 itmlID];
  id v8 = v21;
...
- (void)layoutSubviews
{
  ...
  id v4 = [(SUUIListViewElement *)self->_listElement style];
  ...
  if (v63)
  {
    ...
    uint64_t v12 = *MEMORY[0x263F001A8];
    uint64_t v13 = *(void *)(MEMORY[0x263F001A8] + 8);
    double v66 = *(double *)(MEMORY[0x263F00190] + 24);
    double v67 = *(double *)(MEMORY[0x263F00190] + 16);
    uint64_t v59 = v13;
    uint64_t v60 = *MEMORY[0x263F001A8];
    do
    {
      uint64_t v14 = 0;
      do
        ...
        if (v17)
        {
          ...
          do
          {
            for (uint64_t i = 0; i != v18; ++i)
            {
              ...
              {
                uint64_t v25 = [v3 objectAtIndex:v23];
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = (Class)SUUIHorizontalListView;
    return -[SUUIHorizontalListView pointInside:withEvent:](&v13, sel_pointInside_withEvent_, a4, a3.x, a3.y);
  }
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  uint64_t v6 = [(SUUIViewReuseView *)self allExistingViews];
  long long v52 = 0u;
  long long v53 = 0u;
  long long v54 = 0u;
  long long v55 = 0u;
  ...
  uint64_t v33 = [(SUUIListViewElement *)v40->_listElement style];
  [v33 elementPadding];
  double v35 = v34;
  double v37 = v36;
...
- (void)_buttonAction:(id)a3
{
  ...
  id v4 = a3;
  double v5 = [(SUUIViewElement *)self->_listElement flattenedChildren];
  CGFloat v6 = [(SUUIViewReuseView *)self allExistingViews];
  ...
  if (v7 < [v5 count])
  {
    ...
    {
      CGFloat v9 = SUUICollectionViewCellForView(self);
      double v10 = SUUICollectionViewForView(v9);
...
- (void)_imageTapAction:(id)a3
{
  listElement = self->_listElement;
  id v5 = a3;
  id v10 = [(SUUIViewElement *)listElement flattenedChildren];
  CGFloat v6 = [(SUUIViewReuseView *)self allExistingViews];
...
- (void)_menuButtonAction:(id)a3
{
  ...
  unint64_t v8 = [(SUUIHorizontalListView *)self _viewElementForView:v24];
  if (v8)
  {
    p_focusedMenuButton = &self->_focusedMenuButton;
    objc_storeStrong((id *)&self->_focusedMenuButton, a3);
    id v10 = [SUUIMenuPopoverController alloc];
    double v11 = [v8 menuItemTitles];
    id v12 = -[SUUIMenuPopoverController initWithMenuTitles:selectedIndex:](v10, "initWithMenuTitles:selectedIndex:", v11, [v8 selectedItemIndex]);
...
+ (id)_attributedStringForButtonText:(id)a3 type:(int64_t)a4 style:(id)a5 context:(id)a6
{
  ...
  id v10 = a5;
  id v11 = a6;
  id v12 = SUUIViewElementFontWithStyle(v10);
  if (!v12)
  {
    if (a4) {
      uint64_t v13 = 5;
    ...
    id v12 = SUUIFontPreferredFontForTextStyle(v13);
  }
  uint64_t v14 = [v11 tintColor];
  double v15 = SUUIViewElementPlainColorWithStyle(v10, v14);
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  id v6 = a4;
  id v7 = [v5 style];
  unint64_t v8 = SUUIViewElementFontWithStyle(v7);
  if (!v8)
  {
    unint64_t v8 = SUUIFontPreferredFontForTextStyle(5);
  }
  id v9 = [v6 tintColor];
...
+ (id)_linesWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  double v10 = objc_alloc_init(SUUIViewElementHorizontalLayout);
  ...
  id v14 = v9;
  id v18 = v14;
  long long v15 = [(SUUIViewElementHorizontalLayout *)v10 layoutViewElements:v13 usingSizingBlock:v17];
...
- (id)_viewElementForView:(id)a3
{
  listElement = self->_listElement;
  id v5 = a3;
  id v6 = [(SUUIViewElement *)listElement flattenedChildren];
  id v7 = [(SUUIViewReuseView *)self allExistingViews];
