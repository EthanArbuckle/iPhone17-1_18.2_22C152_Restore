...
- (SUUIShareTemplateURLItemProvider)initWithTemplateElement:(id)a3
{
  ...
  uint64_t v7 = v14[5];
  v11.receiver = self;
  v11.super_class = (Class)SUUIShareTemplateURLItemProvider;
...
- (id)activityViewController:(id)a3 thumbnailImageForActivityType:(id)a4 suggestedSize:(CGSize)a5
{
  ...
  uint64_t v13 = [(SUUIShareTemplateViewElement *)templateElement activityForUIActivityType:v12];

  v14 = [v13 image];
  uint64_t v15 = [v14 URL];
  if (v15)
  {
    v16 = (void *)[objc_alloc(MEMORY[0x263F7B3A0]) initWithURL:v15];
    [v16 setITunesStoreRequest:0];
    v17 = [[SUUIStyledImageDataConsumer alloc] initWithViewElement:v14];
    -[SUUIStyledImageDataConsumer setImageSize:](v17, "setImageSize:", width, height);
...
void __103__SUUIShareTemplateURLItemProvider_activityViewController_thumbnailImageForActivityType_suggestedSize___block_invoke(uint64_t a1, void *a2)
{
}
