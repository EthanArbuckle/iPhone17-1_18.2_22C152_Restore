@interface SUUIArtworkItemProvider
- (NSData)imageData;
...
- (SUUIArtworkItemProvider)initWithURL:(id)a3 usingResourceLoader:(id)a4
{
  ...
  v9 = [(SUUIArtworkItemProvider *)&v18 init];
  v10 = v9;
  if (v9)
  {
    objc_storeStrong((id *)&v9->_url, a3);
    objc_storeStrong((id *)&v10->_resourceLoader, a4);
    uint64_t v11 = [MEMORY[0x263F08AB8] progressWithTotalUnitCount:1];
    ...
    [(SUUIArtworkItemProvider *)v10 registerDataRepresentationForTypeIdentifier:*MEMORY[0x263F01A80] visibility:3 loadHandler:&__block_literal_global_30];
    v15 = objc_alloc_init(SUUIArtworkRequest);
    [(SUUIArtworkRequest *)v15 setURL:v10->_url];
    v16 = +[SSVURLDataConsumer consumer];
    [(SUUIArtworkRequest *)v15 setDataConsumer:v16];

    [(SUUIArtworkRequest *)v15 setDelegate:v10];
    [(SUUIResourceLoader *)v10->_resourceLoader loadResourceWithRequest:v15 reason:1];
  }
  return v10;
}
...
- (id)loadDataRepresentationForTypeIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  if ([v6 isEqualToString:*MEMORY[0x263F01A80]])
  {
  ...
  else
  {
    ...
    id v8 = [(SUUIArtworkItemProvider *)&v13 loadDataRepresentationForTypeIdentifier:v6 completionHandler:v7];
  }
  uint64_t v11 = v8;
