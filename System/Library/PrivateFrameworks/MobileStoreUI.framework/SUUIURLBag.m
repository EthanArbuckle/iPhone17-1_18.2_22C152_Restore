...
+ (ISOperationQueue)bagQueue
{
  if (bagQueue_onceToken != -1) {
    dispatch_once(&bagQueue_onceToken, &__block_literal_global_53);
  }
...
{
  id v0 = objc_alloc_init(MEMORY[0x263F894E0]);
...
uint64_t __45__SUUIURLBag_getTrustForURL_completionBlock___block_invoke_2(uint64_t a1)
{
...
uint64_t __46__SUUIURLBag_loadValueForKey_completionBlock___block_invoke_2(uint64_t a1)
{
...
- (id)existingBagDictionary
{
  ...
  id v8 = __Block_byref_object_copy__81;
  id v9 = __Block_byref_object_dispose__81;
  id v10 = 0;
...
uint64_t __38__SUUIURLBag_loadWithCompletionBlock___block_invoke_2(uint64_t a1)
{
  return (*(uint64_t (**)(void, void, void))(*(void *)(a1 + 40) + 16))(*(void *)(a1 + 40), *(void *)(a1 + 32), 0);
}
...
- (void)_enqueueOperationWithContext:(id)a3 completionBlock:(id)a4
{
  ...
  if (!self->_operation)
  {
    ...
    id v14 = (ISLoadURLBagOperation *)[objc_alloc(MEMORY[0x263F894B0]) initWithBagContext:v6];
...
void __59__SUUIURLBag__enqueueOperationWithContext_completionBlock___block_invoke(id *a1)
{
  v1 = a1;
