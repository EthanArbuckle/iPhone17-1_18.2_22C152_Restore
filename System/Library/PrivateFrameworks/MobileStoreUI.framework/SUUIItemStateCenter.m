...
- (SUUIItemStateCenter)init
{
  ...
  id v2 = [(SUUIItemStateCenter *)&v32 init];
  if (v2)
  {
    dispatch_queue_t v3 = dispatch_queue_create("com.apple.iTunesStoreUI.SUUIItemStateCenter.access", 0);
    v4 = (void *)*((void *)v2 + 1);
    *((void *)v2 + 1) = v3;

    dispatch_queue_t v5 = dispatch_queue_create("com.apple.iTunesStoreUI.SUUIItemStateCenter.observers", 0);
    v6 = (void *)*((void *)v2 + 15);
    *((void *)v2 + 15) = v5;

    dispatch_queue_t v7 = dispatch_queue_create("com.apple.iTunesStoreUI.SUUIItemStateCenter.mediaLibrary", 0);
    v8 = (void *)*((void *)v2 + 12);
    *((void *)v2 + 12) = v7;
    ...
    *((void *)v2 + 19) = v16;
    ...
    id v18 = objc_alloc_init(MEMORY[0x263F7B180]);
    v19 = [MEMORY[0x263F7B178] allStoreDownloadKinds];
    [v18 setDownloadKinds:v19];

    v34[0] = *MEMORY[0x263F7B558];
    v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:v34 count:1];
    [v18 setPrefetchedDownloadExternalProperties:v20];

    uint64_t v21 = *MEMORY[0x263F7B628];
    v33[0] = *MEMORY[0x263F7B6D8];
    v33[1] = v21;
    uint64_t v22 = *MEMORY[0x263F7B658];
    v33[2] = *MEMORY[0x263F7B640];
    v33[3] = v22;
    v33[4] = *MEMORY[0x263F7B660];
    v23 = [MEMORY[0x263EFF8C0] arrayWithObjects:v33 count:5];
    [v18 setPrefetchedDownloadProperties:v23];

    uint64_t v24 = [objc_alloc(MEMORY[0x263F7B178]) initWithManagerOptions:v18];
    v25 = (void *)*((void *)v2 + 6);
    *((void *)v2 + 6) = v24;

    [*((id *)v2 + 6) addObserver:v2];
    uint64_t v26 = [v2 _jobManager];
    v27 = (void *)*((void *)v2 + 4);
    *((void *)v2 + 4) = v26;

    v28 = [MEMORY[0x263F2BA20] sharedInstance];
    [v28 addObserver:v2];
    ...
    [v29 addObserver:v2 selector:sel__restrictionsChangedNotification_ name:*MEMORY[0x263F536E0] object:0];
    [v29 addObserver:v2 selector:sel__storefrontDidChangeNotification_ name:*MEMORY[0x263F7B440] object:0];
    DistributedCenter = CFNotificationCenterGetDistributedCenter();
    CFNotificationCenterAddObserver(DistributedCenter, v2, (CFNotificationCallback)__SoftwareLibraryChangeNotification, @"com.apple.LaunchServices.applicationRegistered", 0, CFNotificationSuspensionBehaviorCoalesce);
    CFNotificationCenterAddObserver(DistributedCenter, v2, (CFNotificationCallback)__SoftwareLibraryChangeNotification, @"com.apple.LaunchServices.applicationUnregistered", 0, CFNotificationSuspensionBehaviorCoalesce);
  }
...
- (id)_jobManager
{
  ...
  if (!jobManager)
  {
    ...
    dispatch_queue_t v5 = (ASDJobManager *)[objc_alloc(MEMORY[0x263F25460]) initWithOptions:v4];
    v6 = self->_jobManager;
    self->_jobManager = v5;
...
- (void)dealloc
{
  ...
  [v3 removeObserver:self name:*MEMORY[0x263F253C0] object:0];
  v4 = (void *)SUUIMediaPlayerFramework();
  id v5 = *(id *)SUUIWeakLinkedSymbolForString("MPMediaLibraryDidChangeNotification", v4);
  [v3 removeObserver:self name:v5 object:0];
  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterRemoveObserver(DarwinNotifyCenter, self, (CFNotificationName)*MEMORY[0x263F7B448], 0);
  DistributedCenter = CFNotificationCenterGetDistributedCenter();
...
+ (id)defaultCenter
{
  ...
  id v2 = (void *)defaultCenter_sCenter_0;
  return v2;
}
...
- (void)cancelDownloadForItemWithIdentifier:(int64_t)a3
{
  id v5 = [SUUIStoreIdentifier alloc];
  uint64_t v6 = [NSNumber numberWithLongLong:a3];
  dispatch_queue_t v7 = [(SUUIStoreIdentifier *)v5 initWithNumber:v6];
...
void __59__SUUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke(uint64_t a1, void *a2)
{
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        if ([v8 storeItemID] == *(void *)(a1 + 64))
        {
          ...
          id v14 = objc_msgSend(NSNumber, "numberWithLongLong:", objc_msgSend(v8, "persistentID"));
          uint64_t v24 = v14;
          id v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v24 count:1];
          [WeakRetained cancelJobsWithIDs:v15 completionBlock:&__block_literal_global_67];
  ...
  v16[1] = 3221225472;
  id v16[2] = __59__SUUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_3;
  v16[3] = &unk_265408DC0;
...
void __59__SUUIItemStateCenter_cancelDownloadForItemWithIdentifier___block_invoke_42(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    uint64_t v6 = *MEMORY[0x263F7B6D8];
    do
    {
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v10 = SUUILibraryItemForStoreIdentifier(*(void **)(*((void *)&v15 + 1) + 8 * v9));
        [v4 addObject:v10];
...
uint64_t __39__SUUIItemStateCenter_isGratisEligible__block_invoke_2(uint64_t a1, uint64_t a2, void *a3, unsigned char *a4)
{
...
- (BOOL)isItemRestrictedWithParentalControlsRank:(int64_t)a3
{
  return [(SUUIItemStateCenter *)self isRunningInStoreDemoMode]
      || [(SUUIItemStateCenter *)self isApplicationInstallRestricted]
      || [(SUUIItemStateCenter *)self parentalControlsRank] < a3;
}
...
uint64_t __47__SUUIItemStateCenter_isRunningInStoreDemoMode__block_invoke(uint64_t result)
{
  ...
  if (v2 == 255)
  {
    uint64_t result = [MEMORY[0x263F82438] isRunningInStoreDemoMode];
...
{
  id v4 = a3;
  uint64_t v5 = -[SUUIItemStateCenter stateForItemWithIdentifier:](self, "stateForItemWithIdentifier:", [v4 itemIdentifier]);
  char v6 = [v5 state];
  if ((v6 & 2) != 0)
  {
    char v9 = (id *)MEMORY[0x263F7BB18];
LABEL_6:
    id v8 = *v9;
    goto LABEL_13;
  }
  ...
  {
    if ((v6 & 8) != 0) {
      char v9 = (id *)MEMORY[0x263F7BB20];
    }
    else {
      char v9 = (id *)MEMORY[0x263F7BB10];
    }
    goto LABEL_6;
  }
  id v8 = 0;
...
void __43__SUUIItemStateCenter_parentalControlsRank__block_invoke(uint64_t a1)
{
  ...
  if (v2 == -1)
  {
    int64_t v3 = [MEMORY[0x263F53C50] sharedConnection];
    id v4 = [v3 effectiveValueForSetting:*MEMORY[0x263F53970]];
...
- (id)performActionForItem:(id)a3 withCompletionBlock:(id)a4
{
  return [(SUUIItemStateCenter *)self performActionForItem:a3 clientContext:0 completionBlock:a4];
}
...
- (id)performActionForItem:(id)a3 clientContext:(id)a4 completionBlock:(id)a5
{
  ...
  uint64_t v12 = [(SUUIItemStateCenter *)self performActionForItem:v10 offer:v11 clientContext:v9 completionBlock:v8];
...
- (id)performActionForItem:(id)a3 clientContext:(id)a4
{
  ...
  id v10 = [(SUUIItemStateCenter *)self performActionForItem:v7 offer:v9 clientContext:v6 completionBlock:0];
  }
...
- (id)performActionForItem:(id)a3 offer:(id)a4 clientContext:(id)a5 completionBlock:(id)a6
{
  ...
  id v12 = a5;
  id v13 = a6;
  id v14 = [(SUUIItemStateCenter *)self metricsActionTypeForItem:v10];
  if (([v14 isEqualToString:*MEMORY[0x263F7BB10]] & 1) != 0
    || [v14 isEqualToString:*MEMORY[0x263F7BB20]])
  {
    ...
    long long v16 = -[SUUIItemStateCenter stateForItemWithIdentifier:](self, "stateForItemWithIdentifier:", [v10 itemIdentifier]);
LABEL_4:

    goto LABEL_5;
  }
  if ([v14 isEqualToString:*MEMORY[0x263F7BB28]])
  {
    long long v18 = [v10 bundleIdentifier];
    SUUIMetricsLaunchApplicationWithIdentifier((uint64_t)v18, 0);
    CFRelease(v18);
  }
  else if ([v14 isEqualToString:*MEMORY[0x263F7BB18]])
  {
  ...
  if (v13)
  {
    ...
    v20[1] = 3221225472;
    id v20[2] = __80__SUUIItemStateCenter_performActionForItem_offer_clientContext_completionBlock___block_invoke_2;
    v20[3] = &unk_265403930;
    long long v15 = &v21;
    id v21 = v13;
...
- (id)performActionForSoftwareItem:(id)a3 offer:(id)a4 clientContext:(id)a5 completionBlock:(id)a6
{
    ...
    || [v14 isEqualToString:*MEMORY[0x263F7BB20]])
  {
    if (SUUIItemStateCenterUseAppstoredPurchases(v10))
    {
      ...
      v24[1] = 3221225472;
      long long v16 = __88__SUUIItemStateCenter_performActionForSoftwareItem_offer_clientContext_completionBlock___block_invoke;
    }
    else
    {
      long long v15 = v23;
      ...
      v23[1] = 3221225472;
      long long v16 = __88__SUUIItemStateCenter_performActionForSoftwareItem_offer_clientContext_completionBlock___block_invoke_2;
    }
    v15[2] = v16;
    v15[3] = &unk_265408E88;
    v15[4] = v13;
    ...
    long long v17 = -[SUUIItemStateCenter stateForItemWithIdentifier:](self, "stateForItemWithIdentifier:", [v10 itemIdentifier]);
  }
  else
  {
    if ([v14 isEqualToString:*MEMORY[0x263F7BB28]])
...
void __72__SUUIItemStateCenter_purchaseItem_offer_clientContext_completionBlock___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (v7) {
      id v6 = objc_msgSend(objc_alloc(MEMORY[0x263EFF8C0]), "initWithObjects:", v7, 0);
    }
    else {
      id v6 = 0;
    }
...
void __80__SUUIItemStateCenter_purchaseSoftwareItem_offer_clientContext_completionBlock___block_invoke(uint64_t a1)
{
  ...
  else if ([*(id *)(a1 + 32) itemKind] == 12)
  {
    ...
    {
      v13[0] = v3;
      uint64_t v2 = [MEMORY[0x263EFF8C0] arrayWithObjects:v13 count:1];
    }
    else
    {
      uint64_t v2 = 0;
...
void __82__SUUIItemStateCenter_reloadGratisEligibilityWithBundleIdentifiers_clientContext___block_invoke(uint64_t a1)
{
  if (([*(id *)(a1 + 32) _gratisStateIsValid] & 1) == 0)
  {
    *(void *)(*(void *)(a1 + 32) + 64) = 1;
    ++*(void *)(*(void *)(a1 + 32) + 80);
    uint64_t v2 = [[SUUILoadGratisEligibilityOperation alloc] initWithBundleIdentifiers:*(void *)(a1 + 40) clientContext:*(void *)(a1 + 48)];
...
- (id)stateForItemWithIdentifier:(int64_t)a3
{
  ...
  id v10 = __Block_byref_object_copy__103;
...
{
  id v6 = [[SUUIStoreIdentifier alloc] initWithLongLong:a1[6]];
...
- (id)stateForItemWithStoreIdentifier:(id)a3
{
  ...
  id v15 = __Block_byref_object_copy__103;
  id v16 = __Block_byref_object_dispose__103;
  id v17 = 0;
  accessQueue = self->_accessQueue;
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
...
{
  id v6 = a4;
  id v7 = (objc_class *)MEMORY[0x263F7B188];
  id v8 = a3;
  id v9 = [v7 alloc];
  id v10 = [MEMORY[0x263EFC630] requestWithURL:v8];

  id v11 = (void *)[v9 initWithURLRequest:v10];
  [v11 setManifestFormat:1];
  uint64_t v12 = -[SUUIStoreIdentifier initWithLongLong:]([SUUIStoreIdentifier alloc], "initWithLongLong:", [v6 itemIdentifier]);
  accessQueue = self->_accessQueue;
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
...
- (ASDSoftwareUpdatesStore)appstoredUpdatesStore
{
  ...
  id v9 = __Block_byref_object_copy__103;
  id v10 = __Block_byref_object_dispose__103;
  id v11 = 0;
  accessQueue = self->_accessQueue;
  v5[0] = MEMORY[0x263EF8330];
  v5[1] = 3221225472;
...
void __50__SUUIItemStateCenter_beginObservingLibraryItems___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    uint64_t v11 = [objc_alloc(MEMORY[0x263F08760]) initWithSet:*(void *)(a1 + 40)];
...
void __50__SUUIItemStateCenter_beginObservingLibraryItems___block_invoke_2(uint64_t a1)
{
  ...
  id v3 = SUUIWeakLinkedClassForString(&cfstr_Mpmedialibrary.isa, v2);
  id v4 = [v3 defaultMediaLibrary];
  [v4 beginGeneratingLibraryChangeNotifications];

  uint64_t v5 = (void *)SUUIMediaPlayerFramework();
  uint64_t v6 = (id *)SUUIWeakLinkedSymbolForString("MPMediaLibraryDidChangeNotification", v5);
...
- (void)evaluatePurchaseResponseForRentals:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v10 = [v9 valueForDownloadProperty:*MEMORY[0x263F7B6D8]];
    ...
    id v13 = [[SUUIStoreIdentifier alloc] initWithNumber:v10];
    long long v14 = [v23 purchase];
    long long v15 = [v14 valueForDownloadProperty:*MEMORY[0x263F7B658]];
    ...
    {
      uint64_t v20 = [MEMORY[0x263EFFA08] setWithObject:v13];
      id v22 = [(SUUIItemStateCenter *)self _setStateFlag:2048 forItemsWithIdentifiers:v20 sendNotification:1];
LABEL_12:

      id v4 = v23;
      goto LABEL_13;
    }
    uint64_t v20 = [(SUUIItemStateCenter *)self stateForItemWithStoreIdentifier:v13];
    if (([v20 state] & 0x800) != 0) {
      id v21 = [(SUUIItemStateCenter *)self _removeState:2048 forItemIdentifier:v13];
    }
    goto LABEL_12;
  }
LABEL_13:
  ...
  if (v3)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if (v8 == 1)
        {
          uint64_t v9 = [SUUIStoreIdentifier alloc];
          id v10 = [v7 storeItemIdentifier];
          uint64_t v11 = [(SUUIStoreIdentifier *)v9 initWithNumber:v10];
...
{
  id v4 = a3;
  uint64_t v5 = [(SUUIItemStateCenter *)self appstoredUpdatesStore];
  v7[0] = MEMORY[0x263EF8330];
  v7[1] = 3221225472;
    ...
    while (2)
    {
      for (uint64_t j = 0; j != v10; ++j)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          ...
          long long v15 = [NSURL URLWithString:v8];
          long long v16 = [MEMORY[0x263F82438] sharedApplication];
          [v16 openURL:v15 options:MEMORY[0x263EFFA78] completionHandler:0];
...
void __85__SUUIItemStateCenter_findLibraryItemsForContentIdentifiers_options_completionBlock___block_invoke(uint64_t a1)
{
  ...
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    uint64_t v3 = (void *)[objc_alloc(MEMORY[0x263EFFA08]) initWithArray:v2];
  }
  else {
    uint64_t v3 = 0;
  }
  ...
  id v13 = objc_alloc_init(SUUISoftwareLibraryInterface);
  id v14 = v13;
  if (!v3
    || ([(SUUISoftwareLibraryInterface *)v13 exposedPlatformItemKinds],
  ...
  if (v3)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        uint64_t v8 = objc_alloc_init(SUUILibraryItem);
        objc_opt_class();
        if (objc_opt_isKindOfClass()) {
          id v9 = v7;
        }
        ...
        id v10 = v9;
        uint64_t v11 = [[SUUIStoreIdentifier alloc] initWithNumber:v9];
  ...
  if (v13)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v14; ++j)
      {
        ...
        uint64_t v18 = (void *)MEMORY[0x25A2A9B80]();
...
void __85__SUUIItemStateCenter_findLibraryItemsForContentIdentifiers_options_completionBlock___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if ([v5 availability] == 2)
  {
    ...
    if (!v6 || (uint64_t v7 = *(void **)(a1 + 32)) == 0 || [v7 containsObject:v6])
    {
      ...
      [v8 setObject:v10 forKey:0x2704FC590];
...
void __81__SUUIItemStateCenter_purchaseTone_withProperties_clientContext_completionBlock___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    id v10 = objc_msgSend(objc_alloc(MEMORY[0x263EFF8C0]), "initWithObjects:", v5, 0);
    id v11 = *(void **)(a1 + 32);
    v15[0] = MEMORY[0x263EF8330];
    v15[1] = 3221225472;
...
void __71__SUUIItemStateCenter_addRelationshipForParentAdamId_withChildAdamIds___block_invoke(uint64_t a1)
{
  ...
  id v2 = [[SUUIStoreIdentifier alloc] initWithNumber:*(void *)(a1 + 32)];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v10 = [SUUIStoreIdentifier alloc];
        id v11 = -[SUUIStoreIdentifier initWithNumber:](v10, "initWithNumber:", v9, (void)v12);
        [v3 addObject:v11];
  ...
  if (v57)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v57; ++i)
      {
        ...
        id v5 = [[SUUIStoreIdentifier alloc] initWithNumber:v4];
...
LABEL_30:
        ...
        if (!v8)
        {
          id v29 = [MEMORY[0x263F7B1F8] sharedConfig];
...
LABEL_39:
        ...
        long long v12 = [MEMORY[0x263F7B1F8] sharedConfig];
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v10 = objc_msgSend(*(id *)(v6 + 2584), "numberWithLongLong:", objc_msgSend(v9, "storeItemID", v24));
        if (!v10)
        {
          unint64_t v11 = 0;
LABEL_20:
        ...
        unint64_t v11 = (void *)[objc_alloc((Class)v7[310]) initWithNumber:v10];
        if (!v11) {
          goto LABEL_20;
        }
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v9 = objc_msgSend(*(id *)(v6 + 2584), "numberWithLongLong:", objc_msgSend(v8, "storeItemID", v26));
        if (!v9)
        {
          uint64_t v10 = 0;
          goto LABEL_22;
        }
        uint64_t v10 = [[SUUIStoreIdentifier alloc] initWithNumber:v9];
        if (v10)
        {
...
void __63__SUUIItemStateCenter_downloadManager_downloadStatesDidChange___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    uint64_t v6 = *MEMORY[0x263F7B670];
    uint64_t v7 = *MEMORY[0x263F7B570];
    id v40 = v2;
    uint64_t v41 = *MEMORY[0x263F7B6D8];
    uint64_t v34 = *MEMORY[0x263F7B5C0];
    uint64_t v42 = *MEMORY[0x263F7B570];
    uint64_t v43 = a1;
    while (1)
    {
      uint64_t v8 = 0;
      ...
      do
      {
        ...
        if ((v11 & 1) == 0)
        {
          ...
          if (v13)
          {
            id v14 = [[SUUIStoreIdentifier alloc] initWithNumber:v13];
            if (v14)
            {
              ...
              *(float *)&double v20 = v20;
              ...
              if ([*(id *)(*(void *)(v15 + 40) + 152) itemHasParent:v14])
              {
                ...
                if (!v22)
                {
                  float v22 = objc_alloc_init(SUUIItemState);
                  [v21 itemIdentifier];
                  double v23 = v37 = v21;
                  [(SUUIItemState *)v22 setItemIdentifier:v23];

                  [(SUUIItemState *)v22 setStoreIdentifier:v37];
                ...
                *(float *)&double v31 = (float)(*(float *)&v31 / v28) + v30;
                ...
                [(SUUIItemState *)v22 setDownloadProgress:v31];
                if (([v35 isEqual:v34] & 1) == 0)
                {
                  [v9 downloadPhaseIdentifier];
                  uint64_t v32 = v38 = v21;
                  [(SUUIItemState *)v22 setDownloadPhase:v32];
...
void __61__SUUIItemStateCenter_downloadQueue_downloadStatesDidChange___block_invoke(uint64_t a1)
{
  ...
  if (v30)
  {
    ...
    uint64_t v27 = *MEMORY[0x263F7B5C0];
    uint64_t v26 = *MEMORY[0x263F7B5D0];
    id v25 = v3;
    do
    {
...
LABEL_15:
        uint64_t v12 = [[SUUIStoreIdentifier alloc] initWithNumber:v6];
        if (v12)
        {
...
void __73__SUUIItemStateCenter_downloadQueue_downloadStates_didCompleteWithError___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    uint64_t v40 = *MEMORY[0x263F7B5D0];
...
LABEL_8:
          uint64_t v44 = v6;
          id v9 = [[SUUIStoreIdentifier alloc] initWithNumber:v7];
          if (!v9
          ...
          if (v13)
          {
            ...
            do
            {
              for (uint64_t i = 0; i != v14; ++i)
              {
                ...
                if (objc_opt_respondsToSelector())
                {
                  id v20 = objc_alloc_init(SUUILibraryItem);
                  uint64_t v21 = [[SUUIStoreIdentifier alloc] initWithNumber:v15];
...
LABEL_38:
        uint64_t v27 = [MEMORY[0x263F7B1F8] sharedConfig];
    ...
    if (v5)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          double v11 = [(SUUIStoreItemRelationshipCounsellor *)relationshipCouncellor childItemsForItem:v10];
          ...
          if (v13)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                uint64_t v17 = SUUILibraryItemForStoreIdentifier(*(void **)(*((void *)&v23 + 1) + 8 * v16));
                [v4 addObject:v17];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          uint64_t v13 = v8;
          uint64_t v14 = [SUUIStoreIdentifier alloc];
          double v11 = [v9 storeItemIdentifier];
          uint64_t v15 = v14;
          uint64_t v8 = v13;
          uint64_t v12 = [(SUUIStoreIdentifier *)v15 initWithNumber:v11];
        }
...
LABEL_14:
          ...
          if ([*(id *)(*(void *)(a1 + 32) + 152) itemHasParent:v16])
          {
            ...
            if (([v64 containsObject:v30] & 1) == 0)
            {
              ...
              {
                uint64_t v57 = v33;
                long long v34 = objc_alloc_init(SUUIItemState);
              ...
              if (v38)
              {
                ...
                do
                {
                  for (uint64_t i = 0; i != v39; ++i)
                  {
                    ...
                    uint64_t v44 = SUUILibraryItemForStoreIdentifier(v43);
...
- (id)_addState:(unint64_t)a3 forItemIdentifier:(id)a4
{
  ...
  {
    uint64_t v8 = v7;
    uint64_t v9 = [(SUUIItemState *)v7 state];
    if ((v9 & a3) == 0)
    {
  ...
  if (v6)
  {
    uint64_t v8 = objc_alloc_init(SUUIItemState);
  ...
  uint64_t v8 = [MEMORY[0x263F7B1F8] sharedConfig];
  int v11 = [(SUUIItemState *)v8 shouldLog];
  ...
  uint64_t v13 = [(SUUIItemState *)v8 OSLogObject];
...
- (id)_appstoredUpdatesStore
{
  ...
  {
    uint64_t v3 = (ASDSoftwareUpdatesStore *)objc_alloc_init(MEMORY[0x263F25500]);
    ...
    if ([(ASDSoftwareUpdatesStore *)self->_appstoredUpdatesStore hasEntitlement])
    {
      ...
      [v5 addObserver:self selector:sel__appstoredUpdatesStoreChangeNotification_ name:*MEMORY[0x263F253C0] object:self->_appstoredUpdatesStore];
    }
  }
...
- (id)_copyItemsStatesForLibraryItems:(id)a3
{
  uint64_t v4 = (objc_class *)MEMORY[0x263F08968];
  id v5 = a3;
...
void __55__SUUIItemStateCenter__copyItemsStatesForLibraryItems___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v18 = a2;
  id v5 = a3;
  id v6 = objc_alloc_init(SUUIItemState);
  ...
  [(SUUIItemState *)v6 setLibraryContentFlags:v14];
  [(SUUIItemState *)v6 setState:v13];
...
{
  if ((unint64_t)a3 > 6) {
    uint64_t v3 = (id *)MEMORY[0x263F7B5E8];
  }
  else {
    uint64_t v3 = (id *)qword_265409218[a3];
  }
  id v4 = *v3;
  return v4;
}
...
- (id)_newPurchaseWithItem:(id)a3 offer:(id)a4
{
  ...
  [v10 setValue:v12 forDownloadProperty:*MEMORY[0x263F7B600]];
  uint64_t v13 = objc_msgSend(objc_alloc(NSNumber), "initWithLongLong:", objc_msgSend(v6, "itemIdentifier"));
  [v10 setValue:v13 forDownloadProperty:*MEMORY[0x263F7B6D8]];
  uint64_t v14 = [v6 artistName];
  [v10 setValue:v14 forDownloadProperty:*MEMORY[0x263F7B5F0]];

  uint64_t v15 = [v6 _downloadKind];
  [v10 setValue:v15 forDownloadProperty:*MEMORY[0x263F7B670]];

  id v16 = [v6 title];
  [v10 setValue:v16 forDownloadProperty:*MEMORY[0x263F7B738]];

  if ([v6 isNewsstandApp]) {
    [v10 setValue:*MEMORY[0x263F7B740] forDownloadProperty:*MEMORY[0x263F7B6A8]];
  }
  if ([v6 hasPrerenderedArtwork])
  {
    uint64_t v17 = [NSNumber numberWithBool:1];
    [v10 setValue:v17 forDownloadProperty:*MEMORY[0x263F7B5F8]];
  }
  id v18 = [v7 variantIdentifier];
  int v19 = [v18 isEqualToString:@"HD"];

  if (v19) {
    [v10 setValue:MEMORY[0x263EFFA88] forDownloadProperty:*MEMORY[0x263F7B640]];
  }
  if ([v6 itemKind] == 18) {
    [v10 setEnabledServiceType:&unk_2705D0E50];
  }
  ...
  if (v20 == 3)
  {
    uint64_t v21 = *MEMORY[0x263F7B658];
    long long v23 = (void *)MEMORY[0x263EFFA88];
    long long v22 = v10;
    goto LABEL_19;
  }
  if (v20 == 2)
  {
    uint64_t v21 = *MEMORY[0x263F7B6E8];
    long long v22 = v10;
    long long v23 = v13;
LABEL_19:
    [v22 setValue:v23 forDownloadProperty:v21];
  }
  long long v24 = [[SUUIStoreIdentifier alloc] initWithNumber:v13];
  ...
  if (v25)
  {
    ...
    if ((v27 & 8) != 0)
    {
      [v10 setValue:MEMORY[0x263EFFA88] forDownloadProperty:*MEMORY[0x263F7B650]];
    }
    else if ((v27 & 0x10) != 0)
    {
      if (v12)
      {
        v41[0] = v12;
        long long v29 = (void *)MEMORY[0x263EFF8C0];
    ...
    if ((~v28 & 0x24) == 0)
    {
      ...
      if (!v33) {
        id v33 = objc_alloc_init(MEMORY[0x263F7B290]);
      }
  ...
  {
    [v10 setValue:&unk_2705D0E68 forDownloadProperty:*MEMORY[0x263F7B630]];
  }
  long long v34 = [MEMORY[0x263F82B60] mainScreen];
  [v34 scale];
  if (v35 <= 1.0) {
    uint64_t v36 = 64;
  }
  ...
  [v10 setValue:v38 forDownloadProperty:*MEMORY[0x263F7B730]];
...
- (id)_newSoftwarePurchaseWithItem:(id)a3 offer:(id)a4
{
  ...
  if (v8)
  {
    id v9 = objc_alloc_init(MEMORY[0x263F25478]);
    ...
    id v16 = [[SUUIStoreIdentifier alloc] initWithNumber:v13];
    ...
    if (v17)
    {
      ...
      else if ((v19 & 0x10) != 0)
      {
        ...
        {
          v38[0] = v12;
          uint64_t v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v38 count:1];
          [v9 setGratisIdentifiers:v21];
        }
        else
        {
          double v35 = [MEMORY[0x263F7B1F8] sharedConfig];
...
- (id)_newPurchasesWithBundleItem:(id)a3 bundleOffer:(id)a4
{
        ...
        for (uint64_t i = 0; i != v15; ++i)
        {
          ...
          if ((v23 & 1) == 0)
          {
            ...
            else if ((v23 & 8) != 0)
            {
              ...
              id v25 = [(SUUIItemStateCenter *)self _newPurchaseWithItem:v19 offer:v24];
  ...
  {
    id v26 = [(SUUIItemStateCenter *)self _newPurchaseWithItem:v6 offer:v7];
    int v27 = v26;
    if (v26)
    {
      [v26 setValue:MEMORY[0x263EFFA88] forDownloadProperty:*MEMORY[0x263F7B6A0]];
      [v8 addObject:v27];
    }
  }
  return v8;
...
- (id)_newPurchasesForSoftwareWithBundleItem:(id)a3 bundleOffer:(id)a4
{
      ...
      do
      {
        for (uint64_t i = 0; i != v15; ++i)
        {
          ...
          if ((v23 & 1) == 0)
          {
            ...
            {
              int v24 = [v19 primaryItemOffer];
              id v25 = [(SUUIItemStateCenter *)self _newSoftwarePurchaseWithItem:v19 offer:v24];
  ...
  {
    id v26 = [(SUUIItemStateCenter *)self _newSoftwarePurchaseWithItem:v6 offer:v7];
    int v27 = v26;
    if (v26)
    {
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v12 = (void *)MEMORY[0x25A2A9B80](v7);
        uint64_t v13 = objc_msgSend(v11, "itemKind", (void)v17);
        uint64_t v14 = [v11 primaryItemOffer];
        if (v13 == 17)
        {
          id v15 = [(SUUIItemStateCenter *)self _newPurchasesWithBundleItem:v11 bundleOffer:v14];
        ...
        {
          id v15 = [(SUUIItemStateCenter *)self _newPurchaseWithItem:v11 offer:v14];
...
- (void)_performPurchases:(id)a3 hasBundlePurchase:(BOOL)a4 withClientContext:(id)a5 completionBlock:(id)a6
{
  ...
  if (v9)
  {
    ...
    uint64_t v10 = *MEMORY[0x263F7B6D8];
    uint64_t v44 = *MEMORY[0x263F7B640];
    uint64_t v43 = *MEMORY[0x263F7B658];
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        if (v13)
        {
          int8x16_t v14 = [[SUUIStoreIdentifier alloc] initWithNumber:v13];
          long long v15 = [(SUUIItemStateCenter *)self _addState:1 forItemIdentifier:v14];
          if (v15)
          {
            id v16 = v12;
  ...
  if ([obj count] == 1)
  {
    ...
    id v25 = [v24 valueForDownloadProperty:*MEMORY[0x263F7B658]];
    [v25 BOOLValue];
  }
  if ([obj count] == 1)
  {
    id v26 = [obj lastObject];
    int v27 = [v26 valueForDownloadProperty:*MEMORY[0x263F7B670]];
    ...
    {
      id v31 = [v26 valueForDownloadProperty:*MEMORY[0x263F7B6E8]];
      BOOL v30 = v31 == 0;
    }
    else
    {
  ...
  id v33 = [MEMORY[0x263F7B420] weakReferenceWithObject:self];
  long long v34 = (void *)[objc_alloc(MEMORY[0x263F7B2E8]) initWithPurchases:obj];
  long long v35 = v34;
  if (IsSoftwareKind) {
...
void __93__SUUIItemStateCenter__performPurchases_hasBundlePurchase_withClientContext_completionBlock___block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v5 = [v4 valueForDownloadProperty:*MEMORY[0x263F7B6D8]];

  if (v5)
  {
    uint64_t v6 = [[SUUIStoreIdentifier alloc] initWithNumber:v5];
...
void __93__SUUIItemStateCenter__performPurchases_hasBundlePurchase_withClientContext_completionBlock___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (![*(id *)(a1 + 40) count])
  {
    id v4 = objc_alloc_init(MEMORY[0x263F7B2F0]);
    [v4 setError:v6];
...
- (void)_performSoftwarePurchases:(id)a3 withClientContext:(id)a4 completionBlock:(id)a5
{
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        if (v14)
        {
          long long v15 = [[SUUIStoreIdentifier alloc] initWithNumber:v14];
          id v16 = [(SUUIItemStateCenter *)self _addState:1 forItemIdentifier:v15];
          if (v16) {
            [v22 addObject:v16];
          }
        }
  ...
  long long v17 = (void *)[objc_alloc(MEMORY[0x263F254A8]) initWithPurchases:obj];
  int v18 = (void *)[objc_alloc(MEMORY[0x263F254A0]) initWithOptions:v17];
...
void __83__SUUIItemStateCenter__performSoftwarePurchases_withClientContext_completionBlock___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (!v11)
  {
    id v13 = objc_alloc(MEMORY[0x263F254B0]);
    uint64_t v12 = (void *)[v13 initWithPurchaseResponseItems:MEMORY[0x263EFFA68]];
...
- (id)_purchaseHistoryDatabase
{
  ...
  {
    id v4 = [MEMORY[0x263F7B0F8] databasePath];
  ...
  {
    id v6 = (SSAppPurchaseHistoryDatabase *)[MEMORY[0x263F7B0F0] newDefaultInstance];
    purchaseHistoryDatabase = self->_purchaseHistoryDatabase;
    self->_purchaseHistoryDatabase = v6;

    DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)__PurchaseHistoryChangeNotification, (CFStringRef)*MEMORY[0x263F7B448], 0, CFNotificationSuspensionBehaviorCoalesce);
  }
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              long long v15 = SUUILibraryItemForStoreIdentifier(*(void **)(*((void *)&v22 + 1) + 8 * v14));
              [v2 addObject:v15];
      ...
      do
      {
        ...
        if ([*(id *)(*(void *)(a1 + 40) + 112) containsObject:v6])
        {
          ...
          else
          {
            ...
            uint64_t v9 = [(SUUIStoreIdentifier *)v10 initWithNumber:v8];
          }
            ...
            if (v16)
            {
              ...
              do
              {
                for (uint64_t i = 0; i != v17; ++i)
                {
                  ...
                  id v21 = SUUILibraryItemForStoreIdentifier(*(void **)(*((void *)&v35 + 1) + 8 * i));
...
{
  objc_initWeak(&location, *(id *)(a1 + 32));
  id v2 = objc_alloc_init(MEMORY[0x263F7B330]);
  v3[0] = MEMORY[0x263EF8330];
  v3[1] = 3221225472;
...
void __45__SUUIItemStateCenter__reloadPurchaseHistory__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      uint64_t v8 = *MEMORY[0x263F7BCA0];
      ...
      do
      {
        for (uint64_t i = 0; i != v6; ++i)
        {
          ...
          if (v12)
          {
            uint64_t v13 = [[SUUIStoreIdentifier alloc] initWithNumber:v12];
  ...
  uint64_t v16 = [MEMORY[0x263F7B0E8] defaultStore];
...
uint64_t __45__SUUIItemStateCenter__reloadPurchaseHistory__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  id v4 = [MEMORY[0x263F7B308] predicateWithProperty:*MEMORY[0x263F7B450] equalToValue:*(void *)(a1 + 32)];
  id v5 = (void *)MEMORY[0x263F7B100];
  uint64_t v6 = [v3 database];
  uint64_t v7 = [v5 queryWithDatabase:v6 predicate:v4];

  v21[0] = (id)*MEMORY[0x263F7B460];
  v21[1] = (id)*MEMORY[0x263F7B458];
  v21[2] = (id)*MEMORY[0x263F7B468];
  id v8 = objc_alloc_init(MEMORY[0x263EFF9C0]);
  uint64_t v15 = MEMORY[0x263EF8330];
  uint64_t v16 = 3221225472;
  uint64_t v17 = __45__SUUIItemStateCenter__reloadPurchaseHistory__block_invoke_4;
  uint64_t v18 = &unk_2654043E0;
  id v9 = v8;
  id v19 = v9;
  id v20 = *(id *)(a1 + 40);
...
void __45__SUUIItemStateCenter__reloadPurchaseHistory__block_invoke_4(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  id v8 = [[SUUIStoreIdentifier alloc] initWithNumber:v10];
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (v8)
        {
          uint64_t v9 = [[SUUIStoreIdentifier alloc] initWithNumber:v8];
  ...
  if (v27)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v27; ++i)
      {
        ...
        id v6 = -[SUUIStoreIdentifier initWithLongLong:]([SUUIStoreIdentifier alloc], "initWithLongLong:", [v5 storeItemIdentifier]);
        id v7 = [*(id *)(*(void *)(a1 + 40) + 88) objectForKey:v6];
        uint64_t v8 = [(SUUIItemState *)v7 state];
        switch([v5 updateState])
        {
          ...
          default:
            ...
            {
LABEL_19:
              id v7 = objc_alloc_init(SUUIItemState);
              id v10 = [(SUUIStoreIdentifier *)v6 numberValue];
              [(SUUIItemState *)v7 setItemIdentifier:v10];

              [(SUUIItemState *)v7 setStoreIdentifier:v6];
              [(SUUIItemState *)v7 setState:v9];
...
void __37__SUUIItemStateCenter__setDownloads___block_invoke(uint64_t a1)
{
  ...
  id v3 = objc_alloc_init(MEMORY[0x263EFF9C0]);
  id v61 = objc_alloc_init(MEMORY[0x263EFF9C0]);
  long long v88 = 0u;
  long long v89 = 0u;
  long long v90 = 0u;
  long long v91 = 0u;
  ...
  if (v4)
  {
    ...
    uint64_t v7 = *MEMORY[0x263F7B670];
    uint64_t v8 = *MEMORY[0x263F7B570];
    uint64_t v70 = *MEMORY[0x263F7B6D8];
    uint64_t v65 = *MEMORY[0x263F7B660];
    uint64_t v63 = *MEMORY[0x263F7B658];
    uint64_t v64 = *MEMORY[0x263F7B640];
    id v62 = v2;
    uint64_t v67 = *MEMORY[0x263F7B670];
    uint64_t v68 = *(void *)v89;
    uint64_t v66 = *MEMORY[0x263F7B570];
    BOOL v58 = v3;
    uint64_t v59 = v1;
    do
    {
      ...
      do
      {
        ...
        if ((v12 & 1) == 0)
        {
          ...
          if (v13)
          {
            ...
            uint64_t v27 = v25;
            long long v28 = [(SUUIItemState *)v15 variantIdentifier];
            long long v74 = v27;
            char v29 = [v28 isEqualToString:v27];

            if ((v29 & 1) == 0)
            {
              [(SUUIItemState *)v15 setVariantIdentifier:v27];
              [v3 addObject:v15];
            }
              ...
              if (v36)
              {
                ...
                while (2)
                {
                  for (uint64_t i = 0; i != v37; ++i)
                  {
                    ...
                    long long v40 = [(SUUIItemState *)v31 downloadIdentifiers];
                    ...
                    if (v42)
                    {
                      uint64_t v43 = [(SUUIItemState *)v31 state];
                      id v3 = v58;
                      if ((v43 & 2) == 0)
                      {
                        [(SUUIItemState *)v31 setState:v43 | 2];
                        [v58 addObject:v31];
                      }
                      uint64_t v1 = v59;
                      uint64_t v44 = *(void **)(*(void *)(v59 + 32) + 152);
                      uint64_t v45 = [MEMORY[0x263EFFA08] setWithObject:v73];
  ...
  if (v31)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v31; ++i)
      {
        ...
        if (v5)
        {
          id v6 = [[SUUIStoreIdentifier alloc] initWithNumber:v5];
          uint64_t v7 = [v28 objectForKey:v6];
          if (!v7)
          {
            uint64_t v7 = objc_alloc_init(SUUIItemState);
          ...
          *(float *)&double v12 = v12;
          ...
          uint64_t v13 = [(SUUIItemState *)v7 downloadContentFlags];
          if ((v13 & v11) != 0) {
...
- (void)_setInstalledItems:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v8)
    {
      ...
      uint64_t v11 = *MEMORY[0x263F7BC80];
      do
      {
        for (uint64_t i = 0; i != v9; ++i)
        {
...
void __42__SUUIItemStateCenter__setInstalledItems___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    uint64_t v4 = v3;
    uint64_t v5 = *(void *)v29;
    uint64_t v6 = *MEMORY[0x263F7BCA0];
    uint64_t v24 = *MEMORY[0x263F7BC90];
    uint64_t v21 = *MEMORY[0x263F7BC80];
    id v7 = &off_2653FF000;
    do
    {
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if (v10)
        {
          uint64_t v11 = (void *)[objc_alloc((Class)v7[310]) initWithNumber:v10];
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        uint64_t v16 = [(SUUIItemStateCenter *)self _addState:a3 forItemIdentifier:v15];
        if (v16) {
          [v8 addObject:v16];
        }
  ...
  if (v18)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v19; ++j)
      {
        ...
        id v22 = [(SUUIItemStateCenter *)self _removeState:a3 forItemIdentifier:*(void *)(*((void *)&v25 + 1) + 8 * j)];
        if (v22) {
          [v8 addObject:v22];
        }
      }
...
- (id)_setStateFlag:(unint64_t)a3 forOnlyItemsWithIdentifiers:(id)a4 sendNotification:(BOOL)a5
{
  ...
  id v8 = a4;
  id v9 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9C0]), "initWithCapacity:", objc_msgSend(v8, "count"));
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        uint64_t v16 = [SUUIStoreIdentifier alloc];
        id v17 = -[SUUIStoreIdentifier initWithNumber:](v16, "initWithNumber:", v15, (void)v20);
        [v9 addObject:v17];
      }
  ...
  uint64_t v18 = [(SUUIItemStateCenter *)self _setStateFlag:a3 forItemsWithIdentifiers:v9 sendNotification:v5];
  ...
  if (v3)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if (v8)
        {
          id v9 = [SUUIStoreIdentifier alloc];
          id v10 = [v7 itemID];
          uint64_t v11 = [(SUUIStoreIdentifier *)v9 initWithNumber:v10];
