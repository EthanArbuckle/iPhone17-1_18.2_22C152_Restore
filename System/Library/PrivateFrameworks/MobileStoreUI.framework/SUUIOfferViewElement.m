...
void __37__SUUIOfferViewElement_isSimpleOffer__block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  id v5 = a2;
...
- (BOOL)isCompactModeEnabled
{
  char v2 = [(SUUIOfferViewElement *)self attributes];
...
- (void)enumerateChildrenUsingBlock:(id)a3
{
  ...
  id v8 = v4;
  v6.receiver = self;
  v6.super_class = (Class)SUUIOfferViewElement;
  id v5 = v4;
