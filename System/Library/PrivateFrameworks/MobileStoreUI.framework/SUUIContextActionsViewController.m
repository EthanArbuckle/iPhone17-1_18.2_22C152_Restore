...
- (void)viewDidLoad
{
  ...
  v3 = (void *)[objc_alloc(MEMORY[0x263F82CB0]) initWithTarget:self action:sel_viewTapped_];
  v4 = [(SUUIContextActionsViewController *)self view];
  [v4 addGestureRecognizer:v3];

  id v5 = objc_alloc(MEMORY[0x263F82E50]);
  v6 = [MEMORY[0x263F824D8] effectWithStyle:0];
  ...
  v12 = (UIStackView *)[v11 initWithArrangedSubviews:MEMORY[0x263EFFA68]];
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  objc_super v4 = [(SUUIContextActionsViewController *)self systemProvidedGestureRecognzier];
  if (v4)
  {
    id v5 = [(SUUIContextActionsViewController *)self view];
    v6 = [v5 window];
...
- (void)viewDidLayoutSubviews
{
  ...
  objc_super v4 = [(SUUIContextActionsViewController *)self view];
  [v4 bounds];
  objc_msgSend(v3, "systemLayoutSizeFittingSize:", v5, v6);
  double v8 = v7;
  objc_super v9 = [(SUUIContextActionsViewController *)self scrollableActionGroupView];
  [v9 bounds];
  double Height = CGRectGetHeight(v14);

  if (v8 > Height) {
    [MEMORY[0x263F825C8] colorWithWhite:0.0 alpha:0.0399999991];
  }
  else {
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  if (v4)
  {
    ...
    double v6 = [(SUUIContextActionsViewController *)self traitCollection];
...
{
  id v29 = [MEMORY[0x263F82670] currentDevice];
...
- (void)systemProvidedGestureRecognzierTriggered:(id)a3
{
  ...
  double v6 = v5;
  double v7 = v4;
  BOOL v8 = v5 == *MEMORY[0x263F00148] && v4 == *(double *)(MEMORY[0x263F00148] + 8);
  if (!v8 && [v17 state] == 2)
  {
    objc_super v9 = [(SUUIContextActionsViewController *)self view];
    v10 = [v9 window];
...
- (void)_applySystemRecognizer
{
  uint64_t v3 = [(SUUIContextActionsViewController *)self contextActionView];
  double v4 = [(SUUIContextActionsViewController *)self systemProvidedGestureRecognzier];
  [v3 beginTrackingSessionByTakingOverForSystemProvidedGestureRecognizer:v4];

  double v5 = [(SUUIContextActionsViewController *)self systemProvidedGestureRecognzier];

  if (v5)
  {
    double v6 = [(SUUIContextActionsViewController *)self systemProvidedGestureRecognzier];
...
- (void)_reloadViewsConfiguration
{
  ...
  double v4 = [(SUUIContextActionsViewController *)self constraints];
  ...
  long long v153 = 0u;
  long long v154 = 0u;
  double v5 = [(SUUIContextActionsViewController *)self stackView];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        double v12 = [(SUUIContextActionsViewController *)self stackView];
        [v12 setSpacing:0.0];

        double v13 = [(SUUIContextActionsViewController *)self stackView];
  ...
  uint64_t v15 = *MEMORY[0x263F83628];
  uint64_t v17 = __61__SUUIContextActionsViewController__reloadViewsConfiguration__block_invoke(v16, *MEMORY[0x263F83628], 0, 0x8000);
  uint64_t v161 = *MEMORY[0x263F81798];
  uint64_t v162 = *MEMORY[0x263F03A48];
  v18 = [NSDictionary dictionaryWithObjects:&v162 forKeys:&v161 count:1];
  uint64_t v19 = __61__SUUIContextActionsViewController__reloadViewsConfiguration__block_invoke((uint64_t)v18, v15, v18, 0);

  v20 = [(SUUIContextActionsViewController *)self configuration];
  uint64_t v21 = [v20 contextActions];

  id v22 = objc_alloc(MEMORY[0x263F82858]);
  v145 = (void *)v21;
  double v23 = [MEMORY[0x263F82850] actionGroupWithActions:v21];
  ...
  {
    if ([(SUUIContextActionsViewController *)self _isInPopoverPresentation])
    {
      double v26 = 0;
    }
    else
    {
      double v27 = (void *)MEMORY[0x263F82848];
      double v28 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
      id v29 = [v28 localizedStringForKey:@"CANCEL" value:&stru_2704F8130 table:0];
      ...
      id v35 = objc_alloc(MEMORY[0x263F82858]);
      v36 = (void *)MEMORY[0x263F82850];
      v160 = v30;
      v37 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v160 count:1];
      ...
      v159 = v41;
      v42 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v159 count:1];
  ...
  v44 = objc_msgSend(v43, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
  [v44 setAxis:1];
  [v44 setTranslatesAutoresizingMaskIntoConstraints:0];
  v45 = [(SUUIContextActionsViewController *)self stackView];
  [v45 addArrangedSubview:v44];

  int v46 = [(SUUIContextActionsViewController *)self _isInPopoverPresentation];
  if ((v46 & 1) == 0)
  {
  ...
  if ((v46 & 1) == 0)
  {
    ...
    [v86 setPriority:v87];
    v88 = [(SUUIContextActionsViewController *)self stackView];
    v89 = [v88 topAnchor];
    v90 = [(SUUIContextActionsViewController *)self view];
    v91 = [v90 topAnchor];
    ...
    v138 = v92;
    [v92 setPriority:v93];
    v130 = [(SUUIContextActionsViewController *)self constraints];
    v158[0] = v92;
    v158[1] = v86;
    v136 = [(SUUIContextActionsViewController *)self stackView];
    v132 = [v136 widthAnchor];
    v134 = [(SUUIContextActionsViewController *)self view];
    v94 = [v134 heightAnchor];
    v95 = [v132 constraintLessThanOrEqualToAnchor:v94 constant:v81];
    v158[2] = v95;
    v96 = [(SUUIContextActionsViewController *)self stackView];
    v97 = [v96 centerXAnchor];
    v98 = [(SUUIContextActionsViewController *)self view];
    v99 = [v98 centerXAnchor];
    v100 = [v97 constraintEqualToAnchor:v99];
    v158[3] = v100;
    v101 = [MEMORY[0x263EFF8C0] arrayWithObjects:v158 count:4];
    ...
    v104 = [(SUUIContextActionsViewController *)self backgroundView];
    [v104 setHidden:0];
  }
  v151 = [(SUUIContextActionsViewController *)self constraints];
  v157[0] = v152;
  v157[1] = v72;
  v157[2] = v75;
  v139 = [(SUUIContextActionsViewController *)self stackView];
  v135 = [v139 bottomAnchor];
  v137 = [(SUUIContextActionsViewController *)self view];
  v133 = [v137 bottomAnchor];
  v131 = [v135 constraintLessThanOrEqualToAnchor:v133];
  v157[3] = v131;
  v129 = [(SUUIContextActionsViewController *)self backgroundView];
  v128 = [v129 centerYAnchor];
  v127 = [v44 centerYAnchor];
  v126 = [v128 constraintEqualToAnchor:v127];
  v157[4] = v126;
  v125 = [(SUUIContextActionsViewController *)self backgroundView];
  ...
  v157[6] = v108;
  v109 = [(SUUIContextActionsViewController *)self backgroundView];
  v110 = [v109 heightAnchor];
  v111 = [v44 heightAnchor];
  v112 = [v110 constraintEqualToAnchor:v111];
  v157[7] = v112;
  v113 = [MEMORY[0x263EFF8C0] arrayWithObjects:v157 count:8];
  [v151 addObjectsFromArray:v113];

  v114 = (void *)MEMORY[0x263F08938];
  v115 = [(SUUIContextActionsViewController *)self constraints];
  [v114 activateConstraints:v115];

  if (v142)
  {
    v116 = [(SUUIContextActionsViewController *)self stackView];
    v117 = [(SUUIContextActionsViewController *)self view];
    [v117 bounds];
...
{
  id v6 = a3;
  uint64_t v7 = [MEMORY[0x263F81720] defaultFontDescriptorWithTextStyle:a2];
  uint64_t v8 = v7;
  if (v6)
  {
  ...
  double v11 = [MEMORY[0x263F81708] fontWithDescriptor:v8 size:0.0];

  return v11;
}

void __61__SUUIContextActionsViewController__reloadViewsConfiguration__block_invoke_2(uint64_t a1, uint64_t a2, unsigned char *a3)
{
  *a3 = 1;
}
...
- (id)_transitionPresentationControllerForPresentedViewController:(id)a3 presentingViewController:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(SUUIContextActionsViewController *)self transitionPresentationController];

  if (!v8)
  {
    uint64_t v9 = [[SUUIContextActionsPresentationController alloc] initWithPresentedViewController:v6 presentingViewController:v7];
    [(SUUIContextActionsViewController *)self setTransitionPresentationController:v9];
  }
  uint64_t v10 = [(SUUIContextActionsViewController *)self transitionPresentationController];
