...
- (id)formattedBylineWithClientContext:(id)a3
{
  ...
  char v6 = 1;
  [v5 setLenient:1];
  uint64_t v7 = [MEMORY[0x263EFFA18] timeZoneForSecondsFromGMT:0];
  [v5 setTimeZone:v7];

  uint64_t v8 = 0;
  long long v19 = xmmword_265403CD0;
  do
  {
    char v9 = v6;
  ...
  if (v13)
  {
    if (self->_reviewer)
    {
      ...
      v17 = +[SUUIClientContext localizedStringForKey:@"REVIEW_BYLINE_WITH_DATE" inBundles:0 inTable:@"ProductPage"];
      }
...
LABEL_28:
    if (self->_reviewer)
    {
      ...
      v16 = +[SUUIClientContext localizedStringForKey:@"REVIEW_BYLINE_NO_DATE" inBundles:0 inTable:@"ProductPage"];
      }
