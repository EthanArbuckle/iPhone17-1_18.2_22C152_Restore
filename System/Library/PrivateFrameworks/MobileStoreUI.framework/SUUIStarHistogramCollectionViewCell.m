...
void __81__SUUIStarHistogramCollectionViewCell_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 == 138)
  {
    ...
    objc_super v5 = [*(id *)(a1 + 32) labelLayoutCache];
    [v5 requestLayoutForLabel:v6 attributedString:v4 width:(uint64_t)*(double *)(a1 + 40)];
  }
  else if (v3 == 135)
  {
    +[SUUIStarRatingViewElementView requestLayoutForViewElement:v6 width:*(void *)(a1 + 32) context:*(double *)(a1 + 40)];
  }
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  v24 = "";
  uint64_t v26 = *(void *)(MEMORY[0x263F001B0] + 8);
  double v25 = a3;
...
- (void)layoutSubviews
{
  ...
  uint64_t v3 = [(SUUIStarHistogramCollectionViewCell *)self contentView];
  [v3 bounds];
  CGFloat v37 = v5;
  CGFloat v38 = v4;
  double rect = v6;
  ...
  double v12 = v11;
  double v14 = v13;
  double v15 = [(SUUIViewReuseCollectionViewCell *)self allExistingViews];
...
{
  uint64_t v3 = [a3 text];
  double v4 = [MEMORY[0x263F81708] systemFontOfSize:12.0];
