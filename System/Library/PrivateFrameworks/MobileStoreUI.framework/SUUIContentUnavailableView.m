...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  id v12 = [v16 messageLabel];

  if (v12)
  {
    v13 = [a1 _attributedStringWithMessageLabel:v12 context:v8];
    [v9 requestLayoutForLabel:v12 attributedString:v13 width:(uint64_t)a4];
  }
  int64_t v14 = [v16 button];
  if (v14)
  {
    uint64_t v15 = [a1 _attributedStringWithButton:v14 context:v8];
    [v9 requestLayoutForButton:v14 attributedString:v15 width:(uint64_t)a4];
  }
}
...
- (void)_buttonAction:(id)a3
{
  ...
  uint64_t v4 = SUUICollectionViewForView(v9);
...
+ (id)_attributedStringWithButton:(id)a3 context:(id)a4
{
  ...
  if (!v11)
  {
    double v11 = [MEMORY[0x263F81708] systemFontOfSize:17.0];
  }
  double v12 = [v6 tintColor];
  float v13 = SUUIViewElementPlainColorWithStyle(v10, v12);
...
+ (id)_attributedStringWithMessageLabel:(id)a3 context:(id)a4
{
  ...
  if (!v10)
  {
    double v10 = [MEMORY[0x263F825C8] secondaryLabelColor];
  }
...
+ (id)_attributedStringWithTitleLabel:(id)a3 context:(id)a4
{
  ...
  if (!v8)
  {
    double v8 = [MEMORY[0x263F81708] systemFontOfSize:27.0];
  }
  id v9 = [v6 tintColor];
  double v10 = SUUIViewElementPlainColorWithStyle(v7, v9);
...
- (double)_baselineOffsetForView:(id)a3
{
  ...
  if (self->_button == button)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      button = self->_button;
LABEL_6:
      [(UIControl *)button baselineOffset];
      double v6 = v7;
    }
  }
...
- (double)_firstBaselineOffsetForView:(id)a3
{
  ...
  if (self->_button == button)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      button = self->_button;
LABEL_6:
      [(UIControl *)button firstBaselineOffset];
      double v6 = v7;
    }
  }
