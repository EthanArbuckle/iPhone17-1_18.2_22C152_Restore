...
- (SUUIProfileImagePicker)initWithClientContext:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUUIProfileImagePicker;
...
- (void)imagePickerController:(id)a3 didFinishPickingMediaWithInfo:(id)a4
{
  id v5 = a4;
  [(SUUIProfileImagePicker *)self dismissViewControllerAnimated:1 completion:0];
  id v12 = [v5 objectForKeyedSubscript:*MEMORY[0x263F836A0]];
  v6 = [v5 objectForKeyedSubscript:*MEMORY[0x263F83668]];
...
{
  v4.receiver = self;
  v4.super_class = (Class)SUUIProfileImagePicker;
...
+ (id)_fixCropRect:(id)a3 forOriginalImage:(id)a4
{
  ...
  {
    uint64_t v26 = objc_msgSend(MEMORY[0x263F08D40], "valueWithCGRect:", v15, v10, v14, v19);
...
- (void)_presentImagePickerWithSourceType:(int64_t)a3
{
  ...
  char v5 = (UIImagePickerController *)objc_alloc_init(MEMORY[0x263F82808]);
  imagePicker = self->_imagePicker;
  self->_imagePicker = v5;

  [(UIImagePickerController *)self->_imagePicker setSourceType:a3];
  double v7 = (void *)SUUIMobileCoreServicesFramework();
  double v8 = (id *)SUUIWeakLinkedSymbolForString("kUTTypeImage", v7);
  ...
  double v12 = (void *)MEMORY[0x263EFF9A0];
  double v13 = [(UIImagePickerController *)self->_imagePicker _properties];
  double v14 = [v12 dictionaryWithDictionary:v13];

  uint64_t v15 = *MEMORY[0x263F83D80];
  v18[0] = *MEMORY[0x263F83660];
  v18[1] = v15;
  v19[0] = MEMORY[0x263EFFA88];
  v19[1] = MEMORY[0x263EFFA88];
  uint64_t v16 = *MEMORY[0x263F83D20];
  v18[2] = *MEMORY[0x263F83CC8];
  v18[3] = v16;
  v19[2] = MEMORY[0x263EFFA88];
  v19[3] = MEMORY[0x263EFFA88];
  v18[4] = *MEMORY[0x263F83CC0];
  v19[4] = MEMORY[0x263EFFA88];
  double v17 = [NSDictionary dictionaryWithObjects:v19 forKeys:v18 count:5];
...
- (void)_showImagePicker
{
  int v3 = [MEMORY[0x263F82808] isSourceTypeAvailable:1];
  int v4 = [MEMORY[0x263F82808] isSourceTypeAvailable:0];
  if (v3 & 1) != 0 || (v4)
  {
    if ((v3 & v4) == 1)
    {
  ...
  {
    id v6 = [MEMORY[0x263F82400] actionWithTitle:@"OK" style:1 handler:0];
    char v5 = [MEMORY[0x263F82418] alertControllerWithTitle:@"PROFILE_NO_PHOTO_SOURCE" message:0 preferredStyle:1];
    [v5 addAction:v6];
...
- (void)_showImageSourcePicker
{
  ...
  int v4 = +[SUUIClientContext localizedStringForKey:@"SETTINGS_PROFILE_CANCEL" inBundles:0 inTable:@"Settings"];
  }
  ...
  v17[3] = &unk_265401390;
  v17[4] = self;
  char v5 = [MEMORY[0x263F82400] actionWithTitle:v4 style:1 handler:v17];
  id v6 = self->_clientContext;
  if (v6) {
    [(SUUIClientContext *)v6 localizedStringForKey:@"SETTINGS_PROFILE_TAKE_PHOTO" inTable:@"Settings"];
  }
  else {
  double v7 = +[SUUIClientContext localizedStringForKey:@"SETTINGS_PROFILE_TAKE_PHOTO" inBundles:0 inTable:@"Settings"];
  }
  ...
  v16[3] = &unk_265401390;
  v16[4] = self;
  double v8 = [MEMORY[0x263F82400] actionWithTitle:v7 style:0 handler:v16];
  double v9 = self->_clientContext;
  if (v9) {
    [(SUUIClientContext *)v9 localizedStringForKey:@"SETTINGS_PROFILE_CHOOSE_PHOTO" inTable:@"Settings"];
  }
  else {
  id v10 = +[SUUIClientContext localizedStringForKey:@"SETTINGS_PROFILE_CHOOSE_PHOTO" inBundles:0 inTable:@"Settings"];
  }
  ...
  v15[3] = &unk_265401390;
  v15[4] = self;
  double v11 = [MEMORY[0x263F82400] actionWithTitle:v10 style:0 handler:v15];
  double v12 = [MEMORY[0x263F82670] currentDevice];
  uint64_t v13 = [v12 userInterfaceIdiom];

  double v14 = [MEMORY[0x263F82418] alertControllerWithTitle:0 message:0 preferredStyle:(v13 & 0xFFFFFFFFFFFFFFFBLL) == 1];
  [v14 addAction:v5];
  [v14 addAction:v8];
  [v14 addAction:v11];
...
uint64_t __48__SUUIProfileImagePicker__showImageSourcePicker__block_invoke(uint64_t a1)
{
  return [*(id *)(a1 + 32) _didCancel];
}

uint64_t __48__SUUIProfileImagePicker__showImageSourcePicker__block_invoke_2(uint64_t a1)
{
  return [*(id *)(a1 + 32) _presentImagePickerWithSourceType:1];
}

uint64_t __48__SUUIProfileImagePicker__showImageSourcePicker__block_invoke_3(uint64_t a1)
{
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUIProfileImagePickerDelegate *)WeakRetained;
}
