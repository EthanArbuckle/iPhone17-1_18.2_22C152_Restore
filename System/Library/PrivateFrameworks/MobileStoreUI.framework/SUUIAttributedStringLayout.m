...
- (SUUIAttributedStringLayout)initWithLayoutRequest:(id)a3
{
  id v4 = a3;
  v61.receiver = self;
  v61.super_class = (Class)SUUIAttributedStringLayout;
  ...
  if (v5)
  {
    ...
    v8 = (NSStringDrawingContext *)objc_alloc_init(MEMORY[0x263F81668]);
    context = v5->_context;
    v5->_context = v8;
    ...
    v19 = (long long *)MEMORY[0x263F834E8];
    ...
    uint64_t v26 = *MEMORY[0x263F81560];
    ...
    uint64_t v31 = *MEMORY[0x263F81540];
...
{
  long long v11 = *MEMORY[0x263F834E8];
...
void __52__SUUIAttributedStringLayout_initWithLayoutRequest___block_invoke_3(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, unsigned char *a5)
{
  *a5 = 1;
}

uint64_t __52__SUUIAttributedStringLayout_initWithLayoutRequest___block_invoke_4(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, unsigned char *a5)
{
