@interface SUUIMenuBarViewElementConfiguration
- (BOOL)_needsReload;
- (BOOL)scrollEnabled;
...
- (void)menuBarDocument:(id)a3 didReplaceDocumentForEntityWithUniqueIdentifier:(id)a4
{
  ...
  id v5 = [(SUUIMenuBarViewElementConfiguration *)self delegate];
...
- (void)menuBarDocument:(id)a3 didReplaceDocumentForMenuItem:(id)a4
{
  ...
  {
    id v7 = [(SUUIMenuBarViewElementConfiguration *)self delegate];
    if (objc_opt_respondsToSelector()) {
...
- (void)menuBarDocument:(id)a3 didSelectMenuItem:(id)a4 animated:(BOOL)a5
{
  ...
  if ([(NSArray *)self->_menuItemViewElements containsObject:v9])
  {
    ...
    uint64_t v8 = [(SUUIMenuBarViewElementConfiguration *)self delegate];
    if (objc_opt_respondsToSelector()) {
...
- (void)contentWillAppearForMenuItemAtIndex:(unint64_t)a3 withEntityValueProvider:(id)a4 clientContext:(id)a5
{
  ...
  if (v8)
  {
    ...
    if (!v13)
    {
      id v14 = objc_alloc(MEMORY[0x263F4B450]);
...
- (SUUIMenuBarViewElementConfigurationDelegate)delegate
{
  ...
  return (SUUIMenuBarViewElementConfigurationDelegate *)WeakRetained;
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_reloadDelegate);
  return (_SUUIMenuBarViewElementConfigurationReloadDelegate *)WeakRetained;
}
