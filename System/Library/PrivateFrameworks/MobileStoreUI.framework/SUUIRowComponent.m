...
- (SUUIRowComponent)initWithCustomPageContext:(id)a3
{
  ...
  id v4 = a3;
  v39.receiver = self;
  v39.super_class = (Class)SUUIRowComponent;
  v5 = [(SUUIPageComponent *)&v39 initWithCustomPageContext:v4];
  if (v5)
  {
    ...
    {
      uint64_t v9 = SUUIColorWithHTMLCode(v8);
...
{
  v4.receiver = self;
  v4.super_class = (Class)SUUIRowComponent;
...
- (void)enumerateMissingItemIdentifiersFromIndex:(int64_t)a3 usingBlock:(id)a4
{
  ...
  if (v7 > a3)
  {
    ...
    do
    {
      uint64_t v9 = (void *)MEMORY[0x25A2A9B80]();
...
- (id)_childComponentWithContext:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0
    || ((v6 = SUUIPageComponentTypeForBlockType(v5), v6 <= 0xE) ? (BOOL v7 = ((1 << v6) & 0x46A4) == 0) : (BOOL v7 = 1), v7))
  {
    int64_t v8 = 0;
  }
  else
  {
    int64_t v8 = (void *)[objc_alloc((Class)SUUIPageComponentClassForComponentType(v6)) initWithCustomPageContext:v3];
  }
...
- (id)description
{
  id v3 = NSString;
  v7.receiver = self;
  v7.super_class = (Class)SUUIRowComponent;
  id v4 = [(SUUIRowComponent *)&v7 description];
