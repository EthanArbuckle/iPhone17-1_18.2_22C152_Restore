...
- (void)loadURL:(id)a3 withCompletionBlock:(id)a4
{
  v6 = (objc_class *)MEMORY[0x263EFC630];
  id v7 = a4;
  id v8 = a3;
...
- (void)loadURL:(id)a3 withDataConsumer:(id)a4 completionBlock:(id)a5
{
  id v8 = (objc_class *)MEMORY[0x263EFC630];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
...
- (void)loadURLRequest:(id)a3 withDataConsumer:(id)a4 completionBlock:(id)a5
{
  ...
  [MEMORY[0x263EFF940] raise:*MEMORY[0x263EFF4A0] format:v11];
  id v10 = v20;
LABEL_6:
  ...
  v18 = (void *)[objc_alloc(MEMORY[0x263F7B3A0]) initWithURLRequest:v20];
...
- (NSOperationQueue)operationQueue
{
  ...
  if (!operationQueue)
  {
    objc_super v4 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x263F08A48]);
...
- (void)setRefreshControl:(id)a3
{
  ...
  if (refreshControl != v5)
  {
    ...
    id v8 = [(SUUIStorePageSectionsViewController *)self->_sectionsViewController collectionView];
    if (v8)
    {
...
- (void)setStorePage:(id)a3
{
  ...
  {
    objc_super v4 = (SUUIStorePage *)[a3 copy];
...
- (void)decodeRestorableStateWithCoder:(id)a3
{
  ...
  double v12 = [(SUUIStorePageViewController *)self _sectionsViewController];
...
{
  metricsController = self->_metricsController;
  id v6 = SUUIMetricsWindowOrientationForInterfaceOrientation([(SUUIStorePageViewController *)self interfaceOrientation]);
...
- (void)encodeRestorableStateWithCoder:(id)a3
{
  ...
  id v6 = [(SUUIStorePageViewController *)self _colorScheme];
  [v5 encodeObject:v6 forKey:@"colorScheme"];

  objc_super v7 = [(SUUIStorePageViewController *)self title];
...
- (void)_metricsEnterEventNotification:(id)a3
{
  ...
  {
    id v4 = [(SUUIStorePageViewController *)self presentedViewController];
    if (v4)
    {
    }
...
- (void)loadWithJSONData:(id)a3 fromOperation:(id)a4 completionBlock:(id)a5
{
  ...
  lastDataConsumerClassName = self->_lastDataConsumerClassName;
  self->_lastDataConsumerClassName = (NSString *)@"SUUIStorePageDataConsumer";

  lastPageEvent = self->_lastPageEvent;
  self->_lastPageEvent = 0;

  objc_super v14 = (void *)[objc_alloc(MEMORY[0x263F7B3A0]) initWithData:v10 fromOperation:v9];
  v15 = +[SSVURLDataConsumer consumer];
  [v14 setDataConsumer:v15];

  [(SUUIStorePageViewController *)self _loadWithOperation:v14 completionBlock:v8];
}
...
- (id)_colorScheme
{
  ...
  if (storePage)
  {
    id v4 = [(SUUIStorePage *)storePage uber];
    id v5 = v4;
    if (!v4 || ([v4 colorScheme], (id v6 = (SUUIColorScheme *)objc_claimAutoreleasedReturnValue()) == 0))
    {
      char v7 = [(SUUIStorePage *)self->_storePage backgroundArtwork];

      if (v7) {
        id v6 = objc_alloc_init(SUUIColorScheme);
      }
      else {
        id v6 = 0;
      }
...
- (void)_loadWithOperation:(id)a3 completionBlock:(id)a4
{
  ...
  v19[1] = 3221225472;
  v19[2] = __66__SUUIStorePageViewController__loadWithOperation_completionBlock___block_invoke;
  v19[3] = &unk_265407240;
  ...
  if (!self->_metricsController)
  {
    ...
    v16 = __66__SUUIStorePageViewController__loadWithOperation_completionBlock___block_invoke_3;
    v17 = &unk_265402C90;
    objc_copyWeak(&v18, &location);
    [(SUUIClientContext *)clientContext getDefaultMetricsControllerWithCompletionBlock:&v14];
    objc_destroyWeak(&v18);
  }
  v13 = [(SUUIStorePageViewController *)self operationQueue];
...
{
  id v7 = a3;
  id v8 = (SUUIStorePage *)a4;
  id v9 = v8;
  if (self->_metricsController)
  {
    if (self->_storePage == v8)
    {
      id v10 = [(SUUIStorePageViewController *)self navigationController];
      id v11 = [v10 viewControllers];
      unint64_t v12 = [v11 count];

      if (v12 >= 2) {
        [v7 setNavigationType:*MEMORY[0x263F7BB98]];
      }
      id v13 = [MEMORY[0x263EFF910] date];
      [v13 timeIntervalSince1970];
      objc_msgSend(v7, "setPageRenderTime:");

      uint64_t v14 = [(SUUIStorePage *)v9 uber];
      [v7 setUbered:v14 != 0];

      if (![(SUUIStorePageSectionsViewController *)self->_sectionsViewController isDisplayingOverlays])[(SUUIMetricsController *)self->_metricsController recordEvent:v7]; {
...
- (id)_sectionsViewController
{
  ...
  {
    uint64_t v4 = objc_alloc_init(SUUIStorePageSectionsViewController);
    id v5 = self->_sectionsViewController;
    self->_sectionsViewController = v4;

    id v6 = self->_sectionsViewController;
    id v7 = [(SUUIStorePageViewController *)self clientContext];
    ...
    id v9 = [(SUUIStorePageViewController *)self operationQueue];
    [(SUUIViewController *)v8 setOperationQueue:v9];

    id v10 = self->_sectionsViewController;
    id v11 = [(SUUIStorePageViewController *)self _colorScheme];
    ...
    if (storePage)
    {
      ...
      uint64_t v14 = [(SUUIStorePage *)storePage pageComponents];
...
- (void)_setMetricsController:(id)a3
{
  ...
  if (!self->_metricsController)
  {
    ...
    uint64_t v8 = [(SUUIStorePage *)self->_storePage metricsConfiguration];
    [(SUUIMetricsController *)v7 setPageConfiguration:v8];

    id v9 = *p_metricsController;
    id v10 = [(SUUIClientContext *)self->_clientContext metricsPageContextForViewController:self];
    [(SUUIMetricsController *)v9 setPageContext:v10];

    id v11 = *p_metricsController;
    unint64_t v12 = [(SUUIStorePage *)self->_storePage pageURL];
    uint64_t v13 = [v12 absoluteString];
    [(SUUIMetricsController *)v11 setPageURL:v13];

    uint64_t v14 = *p_metricsController;
    uint64_t v15 = [MEMORY[0x263F82438] sharedApplication];
    v16 = SUUIMetricsWindowOrientationForInterfaceOrientation([v15 statusBarOrientation]);
    [(SUUIMetricsController *)v14 setWindowOrientation:v16];

    [(SUUIStorePageSectionsViewController *)self->_sectionsViewController setMetricsController:*p_metricsController];
    id v17 = *p_metricsController;
    uint64_t v18 = [(SUUIStorePage *)self->_storePage metricsConfiguration];
    id v19 = [v18 pingURLs];
    [(SUUIMetricsController *)v17 pingURLs:v19 withClientContext:self->_clientContext];
...
LABEL_10:
  ...
  if (v10)
  {
    uint64_t v8 = [(SUUIStorePageViewController *)self clientContext];
    id v11 = [v6 ITMLData];
...
LABEL_9:
  ...
  if (v6)
  {
    ...
    metricsController = self->_metricsController;
    uint64_t v15 = [(SUUIStorePage *)self->_storePage metricsConfiguration];
    v16 = [v15 pingURLs];
...
- (void)_showProductPage:(id)a3 withPageEvent:(id)a4
{
  ...
  if (SUUIItemKindIsSoftwareKind(v9) || v9 == 5)
  {
    ...
    {
      id v19 = [[SUUIIPhoneProductPageViewController alloc] initWithProductPage:v6];
      id v20 = [(SUUIStorePageViewController *)self clientContext];
      [(SUUIViewController *)v19 setClientContext:v20];

      [(SUUIIPhoneProductPageViewController *)v19 configureMetricsWithPageEvent:v7];
      double v21 = [(SUUIStorePageViewController *)self navigationController];
  ...
  {
    id v10 = objc_alloc_init(MEMORY[0x263F17FC8]);
    ...
    uint64_t v15 = objc_msgSend(v11, "initWithObjectsAndKeys:", v14, @"id", 0);
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUIStorePageDelegate *)WeakRetained;
}
