  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      *((void *)v6 + 1) = v7;
      ...
      if (v11)
      {
        id v12 = objc_alloc(MEMORY[0x263F4B418]);
      ...
      *((void *)v6 + 11) = v14;
      ...
      v16 = [v4 valueForStyle:*MEMORY[0x263F4B358]];
      v17 = v16;
      if (v16)
      {
        memset(v37, 0, sizeof(v37));
        [v16 getValue:v37];
        *((void *)v6 + 2) = v37[0].receiver;
      }
      else
      {
      ...
      v20 = [v4 valueForStyle:*MEMORY[0x263F4B390]];
      v21 = v20;
      if (v20)
      {
        [v20 getValue:v6 + 24];
      ...
      {
        *(_OWORD *)(v6 + 24) = xmmword_2568A1570;
        *(_OWORD *)(v6 + 40) = xmmword_2568A1570;
      }
      v22 = [v4 borderRadius];
      v23 = v22;
      if (v22)
...
- (id)bezierPathWithBounds:(CGRect)a3
{
  ...
  v8 = [MEMORY[0x263F824C0] bezierPath];
