...
- (SUUIMediaSocialAdminPermissionsOperation)initWithClientContext:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SUUIMediaSocialAdminPermissionsOperation;
...
- (id)outputBlock
{
  ...
  v4[1] = 3221225472;
  v4[2] = __55__SUUIMediaSocialAdminPermissionsOperation_outputBlock__block_invoke;
  v4[3] = &unk_2654008E0;
  v4[4] = self;
  v4[5] = &v5;
...
uint64_t __55__SUUIMediaSocialAdminPermissionsOperation_outputBlock__block_invoke(uint64_t a1)
{
...
void *__59__SUUIMediaSocialAdminPermissionsOperation_setOutputBlock___block_invoke(uint64_t a1)
{
...
- (void)main
{
  ...
  uint64_t v4 = [v3 objectForKey:*MEMORY[0x263F7BD30]];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v17[1] = 3221225472;
    v17[2] = __48__SUUIMediaSocialAdminPermissionsOperation_main__block_invoke;
    v17[3] = &unk_265402EF0;
    v17[4] = &v18;
    v17[5] = &v24;
    ...
    if (v19[5])
    {
      id v10 = -[SUUIMediaSocialAdminPermissionsOperation _authorsWithResponseDictionary:](self, "_authorsWithResponseDictionary:");
    }
    else
    {
      id v10 = 0;
    ...
    if (!v25[5] && ![v10 count])
    {
      ...
      uint64_t v13 = [MEMORY[0x263F087E8] errorWithDomain:@"SUUIErrorDomain" code:2 userInfo:0];
      }
      v14 = (void *)v25[5];
      v25[5] = v13;
    }
  ...
  uint64_t v15 = [(SUUIMediaSocialAdminPermissionsOperation *)self outputBlock];
  v16 = (void *)v15;
  if (v15) {
...
void __48__SUUIMediaSocialAdminPermissionsOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v11 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (id)_authorsWithResponseDictionary:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
      ...
      do
      {
        for (uint64_t i = 0; i != v13; ++i)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            uint64_t v18 = [(SUUIMediaSocialAuthor *)v17 identifier];
            if (v18)
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                v21 = (void *)[objc_alloc(MEMORY[0x263F7B200]) initWithLookupDictionary:v19];
                v22 = [v21 artwork];
                id v23 = [v22 lastObject];

                uint64_t v24 = [v21 displayName];
                [(SUUIMediaSocialAuthor *)v17 setName:v24];

                v25 = [v23 URLWithHeight:125 width:125];
                [(SUUIMediaSocialAuthor *)v17 setThumbnailImageURL:v25];

                id v11 = v57;
                [(SUUIMediaSocialAuthor *)v17 setStorePlatformData:v19];
              }
              uint64_t v26 = [(SUUIMediaSocialAuthor *)v17 name];
    ...
    if ([v56 count])
    {
      v28 = [(SUUIMediaSocialAdminPermissionsOperation *)v51 _lookupResponseForMissingAuthors:v56 error:0];
      long long v64 = 0u;
      long long v65 = 0u;
      long long v66 = 0u;
      long long v67 = 0u;
...
- (id)_lookupResponseForMissingAuthors:(id)a3 error:(id *)a4
{
  ...
  id v32 = 0;
  id v7 = objc_alloc(MEMORY[0x263F7B3B0]);
  unint64_t v8 = [(SUUIClientContext *)self->_clientContext URLBag];
  uint64_t v9 = [v8 existingBagDictionary];
  uint64_t v10 = (void *)[v7 initWithBagDictionary:v9];

  id v11 = (void *)[objc_alloc(MEMORY[0x263F7B3B8]) initWithPlatformContext:v10];
  [v11 setKeyProfile:*MEMORY[0x263F7B9B0]];
  [v11 setPersonalizationStyle:2];
  uint64_t v12 = [(SUUIClientContext *)self->_clientContext valueForConfigurationKey:@"sfsuffix"];
  ...
  v22[1] = 3221225472;
  v22[2] = __83__SUUIMediaSocialAdminPermissionsOperation__lookupResponseForMissingAuthors_error___block_invoke;
  v22[3] = &unk_265402F18;
  v22[4] = &v33;
  v22[5] = &v27;
...
void __83__SUUIMediaSocialAdminPermissionsOperation__lookupResponseForMissingAuthors_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
