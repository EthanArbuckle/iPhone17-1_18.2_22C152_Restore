...
- (SUUILoadGratisEligibilityOperation)initWithBundleIdentifiers:(id)a3 clientContext:(id)a4
{
  ...
  if (v8)
  {
    ...
    id v11 = (id) [[NSString alloc] initWithFormat:@"com.apple.iTunesStoreUI.SUUILoadGratisEligibilityOperation"];
...
- (void)main
{
  ...
  uint64_t v4 = [(SUUIClientContext *)self->_clientContext URLBag];
  ...
  if (v19[5])
  {
    id v6 = objc_alloc(MEMORY[0x263EFC5E8]);
    id v7 = (void *)[v6 initWithURL:v19[5]];
    id v8 = [(SUUILoadGratisEligibilityOperation *)self _bodyData];
    [v7 setHTTPBody:v8];

    [v7 setHTTPMethod:@"POST"];
    [v7 setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
    id v9 = [(SUUIClientContext *)self->_clientContext newLoadStoreURLOperationWithURLRequest:v7];
    v10 = [MEMORY[0x263F7B418] consumer];
  ...
  uint64_t v11 = [(SUUILoadGratisEligibilityOperation *)self outputBlock];
...
void __42__SUUILoadGratisEligibilityOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    uint64_t v6 = [objc_alloc(NSURL) initWithString:v12];
...
- (id)_bodyData
{
  id v3 = objc_alloc_init(MEMORY[0x263F7B398]);
  uint64_t v4 = [MEMORY[0x263F7B0E8] defaultStore];
