...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  {
    objc_super v8 = [(SUUIPlayButtonControl *)self element];

    if (v8)
    {
      objc_super v9 = [(SUUIPlayButtonControl *)self element];
...
- (void)layoutSubviews
{
  ...
  double v8 = [(SUUIPlayButtonControl *)self _imageView];
  objc_msgSend(v8, "setFrame:", v7, 0.0, v4, v6);

  double v9 = [(SUUIPlayButtonControl *)self _backgroundView];
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  if ([(SUUIPlayButtonControl *)self _renderAsEnabled])
  {
    ...
    {
      double v5 = [(SUUIPlayButtonControl *)self _classicBackdropView];
    ...
    else if (!v3)
    {
      ...
      v8[3] = &unk_265400980;
      v8[4] = self;
      [MEMORY[0x263F82E00] animateWithDuration:0 delay:v8 options:0 animations:0.47 completion:0.0];
    }
  }
}
...
- (void)setSelected:(BOOL)a3
{
  ...
  if (self->_backgroundType == 3)
  {
    objc_super v4 = [(SUUIPlayButtonControl *)self _classicBackdropView];
...
- (void)beginIndeterminateAnimation
{
  ...
  objc_super v4 = [(SUUIPlayButtonShapeView *)self->_outerProgressLayer layer];
  double v5 = v4;
  if (indeterminate)
  {
  ...
  double v8 = [(SUUIPlayButtonControl *)self window];
...
+ (id)blurColorForColor:(id)a3
{
  ...
  {
    double v9 = v9 * 1.8;
    objc_super v4 = objc_msgSend(MEMORY[0x263F825C8], "colorWithHue:saturation:brightness:alpha:", v10);
    double v5 = [MEMORY[0x263F825C8] colorWithWhite:0.980392157 alpha:0.78];
    objc_super v3 = [v4 _colorBlendedWithColor:v5 compositingFilter:*MEMORY[0x263F15D98]];
  }
  return v3;
}
...
- (id)defaultBackgroundColor
{
  return (id)[MEMORY[0x263F825C8] colorWithRed:0.933333333 green:0.933333333 blue:0.909803922 alpha:1.0];
}
...
- (void)endIndeterminateAnimation
{
  ...
  {
    double v3 = [(SUUIPlayButtonControl *)self _outerProgressLayer];
    objc_super v4 = [v3 layer];

    [v4 setStrokeStart:0.0];
    [v4 removeAllAnimations];
    double v5 = [(SUUIPlayButtonControl *)self _outerProgressLayer];
...
- (void)hideProgressAnimated:(BOOL)a3
{
  if (self->_showingProgress || self->_indeterminate)
  {
    ...
    objc_super v4 = [(SUUIPlayButtonControl *)self _innerProgressLayer];
    [v4 setHidden:1];
    ...
    {
      double v5 = [(SUUIPlayButtonControl *)self _backgroundView];
      CGAffineTransform v6 = v5;
      if (v5)
      {
        [v5 setHidden:0];
        [v6 setAlpha:1.0];
        uint64_t v7 = [(SUUIPlayButtonControl *)self _imageView];
...
- (void)setBackdropGroupName:(id)a3
{
  ...
  MEMORY[0x270F9A758](backdropGroupName, v5);
}
...
- (void)setBackgroundType:(int64_t)a3
{
  ...
  else
  {
    ...
    if (a3 == 4)
    {
      ...
      {
        float v8 = [(SUUIPlayButtonControl *)self _gradientBackgroundView];
    ...
    if (!v6)
    {
      id v10 = [(SUUIPlayButtonControl *)self _defaultBackgroundView];
  ...
  if (v12)
  {
    [(SUUIPlayButtonGradientView *)v12 removeFromSuperview];
  ...
  if (a3 == 3)
  {
    ...
    {
      double v14 = [(SUUIPlayButtonControl *)self _classicBackdropView];
      ...
      [(SUUIPlayButtonControl *)self insertSubview:v14 atIndex:0];
LABEL_16:
...
- (void)setControlColor:(id)a3
{
  ...
  if (backgroundColor != v5)
  {
    ...
    if ((backgroundColor & 1) == 0)
    {
      ...
      if (!v9 && v10 != 0)
      {
        double v12 = [(SUUIPlayButtonControl *)self _backgroundView];
  ...
  MEMORY[0x270F9A758](backgroundColor, v5);
}
...
- (void)setSelectionColor:(id)a3 withCompositingFilter:(id)a4
{
  ...
  double v12 = [(SUUIPlayButtonShapeView *)self->_selectedLayer layer];
  double v13 = v9;
  objc_msgSend(v12, "setFillColor:", -[UIColor CGColor](v13, "CGColor"));

  id v14 = [(SUUIPlayButtonShapeView *)self->_selectedLayer layer];
...
- (void)setControlForegroundColor:(id)a3
{
  ...
  if (controlForeGroundColor != v5)
  {
    ...
    if ((controlForeGroundColor & 1) == 0)
    {
      ...
      id v7 = [(SUUIPlayButtonControl *)self _imageView];
      [v7 setTintColor:v8];

      id v5 = v8;
    }
  }
  MEMORY[0x270F9A758](controlForeGroundColor, v5);
}
...
- (void)setCustomPlayImage:(id)a3
{
  ...
  if ((id)customPlayImage != v5)
  {
    ...
    if ((customPlayImage & 1) == 0)
    {
      ...
      uint64_t customPlayImage = [(SUUIPlayButtonControl *)self _showPlayIndicator:self->_showingPlayIndicator];
      id v5 = v7;
    }
  }
  MEMORY[0x270F9A758](customPlayImage, v5);
}
...
- (void)setProgress:(float)a3 animated:(BOOL)a4
{
  ...
  if (self->_progress != a3)
  {
    ...
    self->_progress = v7;
    id v8 = [(SUUIPlayButtonControl *)self _innerProgressLayer];
    id v12 = [v8 layer];

    if (a4)
    {
      BOOL v9 = [MEMORY[0x263F15760] animationWithKeyPath:@"strokeEnd"];
      [v9 setDuration:0.2];
...
- (void)setShowBorder:(BOOL)a3
{
  if (self->_showBorder != a3)
  {
    ...
    if (a3)
    {
      id v4 = [(SUUIPlayButtonControl *)self _borderLayer];
      [v4 setHidden:0];
    }
    else
    {
...
- (void)setShowOuterBorder:(BOOL)a3
{
  if (self->_showOuterBorder != a3)
  {
    ...
    id v5 = [(SUUIPlayButtonControl *)self _outerProgressLayer];
    [v5 setHidden:!v3];
...
- (void)updateOuterProgressLayerStroke
{
  ...
  if (bufferProgressIndicatorColor)
  {
    ...
    id v5 = &OBJC_IVAR___SUUIPlayButtonControl__bufferProgressIndicatorCompositingFilter;
LABEL_7:
  ...
  if (!self->_usesBlurredBackground
    || self->_indeterminate
    || [(SUUIPlayButtonControl *)self showOuterBorder])
  {
    id v4 = [(SUUIPlayButtonControl *)self outerBorderColor];
    id v5 = &OBJC_IVAR___SUUIPlayButtonControl__progressIndicatorCompositingFilter;
    goto LABEL_7;
  }
  id v4 = 0;
  id v6 = 0;
LABEL_8:
  float v7 = [(SUUIPlayButtonShapeView *)self->_outerProgressLayer layer];
  BOOL v9 = v4;
  objc_msgSend(v7, "setStrokeColor:", -[UIColor CGColor](v9, "CGColor"));

  id v8 = [(SUUIPlayButtonShapeView *)self->_outerProgressLayer layer];
...
{
  [(SUUIPlayButtonControl *)self updateOuterProgressLayerStroke];
  id v3 = [(SUUIPlayButtonControl *)self _outerProgressLayer];
  id v4 = [v3 layer];
  [v4 removeAllAnimations];
  ...
  v6[3] = &unk_265400980;
  v6[4] = self;
  [MEMORY[0x263F82E00] animateKeyframesWithDuration:197228 delay:v6 options:0 animations:1.0 completion:0.0];
}
...
- (id)_borderLayer
{
  ...
  if (!borderLayer)
  {
    ...
    float v17 = [MEMORY[0x263F82B60] mainScreen];
    [v17 scale];
    double v19 = v7 + 1.0 / v18 * 2.0;

    v20 = [MEMORY[0x263F82B60] mainScreen];
    [v20 scale];
    CGRect v22 = -[SUUIPlayButtonControl _newShapeViewWithBounds:lineWidth:](self, "_newShapeViewWithBounds:lineWidth:", v10, v13, v16, v19, 1.0 / v21);
    ...
    id v27 = [MEMORY[0x263F825C8] clearColor];
    ...
    id v30 = [MEMORY[0x263F825C8] colorWithWhite:0.0 alpha:0.1];
...
- (id)_cancelImage
{
  uint64_t v2 = [(SUUIPlayButtonControl *)self cancelImage];
...
- (void)_createGradient:(id)a3 withGradientType:(int64_t)a4
{
  ...
  id v6 = a3;
  double v7 = [(SUUIPlayButtonControl *)self _gradientBackgroundView];
  id v8 = [v7 layer];
...
LABEL_6:
  double v13 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", objc_msgSend(v6, "count"));
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
...
- (id)_classicBackdropView
{
  ...
  if (!backdropView)
  {
    double v4 = [MEMORY[0x263F82EC0] settingsForPrivateStyle:2010];
    [v4 setColorBurnTintAlpha:0.0];
    [v4 setGrayscaleTintAlpha:0.0];
    double v5 = [MEMORY[0x263F825C8] colorWithWhite:0.862745098 alpha:1.0];
    [v4 setColorTint:v5];

    int v6 = [(SUUIPlayButtonControl *)self isHighlighted];
    double v7 = 0.7;
    if (v6) {
      double v7 = 0.35;
    }
    ...
    [v4 setScale:0.5];
    id v8 = objc_alloc(MEMORY[0x263F82EB8]);
...
- (id)_defaultBackgroundView
{
  ...
  if (!backgroundView)
  {
    ...
    double v5 = (UIView *)objc_msgSend(v4, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
    ...
    double v10 = [(SUUIPlayButtonControl *)self defaultBackgroundColor];
...
- (BOOL)_renderAsEnabled
{
  int v3 = [(SUUIPlayButtonControl *)self isEnabled];
  if (v3) {
...
- (id)_gradientBackgroundView
{
  ...
  if (!gradientBackgroundView)
  {
    id v4 = [SUUIPlayButtonGradientView alloc];
    double v5 = -[SUUIPlayButtonGradientView initWithFrame:](v4, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
    ...
    double v7 = [(SUUIPlayButtonGradientView *)self->_gradientBackgroundView layer];
    [(SUUIPlayButtonControl *)self buttonCornerRadius];
    [v7 setCornerRadius:v8];

    double v9 = self->_gradientBackgroundView;
    double v10 = [MEMORY[0x263F825C8] colorWithWhite:1.0 alpha:1.0];
...
- (id)_imageView
{
  ...
  if (!imageView)
  {
    ...
    double v5 = (UIImageView *)objc_msgSend(v4, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
...
- (id)_newShapeViewWithBounds:(CGRect)a3 lineWidth:(double)a4
{
  ...
  double v9 = [SUUIPlayButtonShapeView alloc];
  v15.origin.CGFloat x = x;
  v15.origin.CGFloat y = y;
  v15.size.CGFloat width = width;
  v15.size.CGFloat height = height;
  CGRect v16 = CGRectInset(v15, a4 * 0.5, a4 * 0.5);
  double v10 = -[SUUIPlayButtonShapeView initWithFrame:](v9, "initWithFrame:", v16.origin.x, v16.origin.y, v16.size.width, v16.size.height);
  CGAffineTransformMakeRotation(&v14, -1.57079633);
  [(SUUIPlayButtonShapeView *)v10 setTransform:&v14];
  double v11 = [(SUUIPlayButtonShapeView *)v10 layer];
  [v11 setLineWidth:a4];
...
- (void)_prepareForReuse
{
  ...
  double v10 = [(SUUIPlayButtonControl *)self _imageView];
  [v10 setAlpha:v9];

  double v11 = [(SUUIPlayButtonControl *)self _imageView];
  [v11 setAlpha:v9];
  ...
  if ((self->_backgroundType & 0xFFFFFFFFFFFFFFFELL) == 2)
  {
    ...
    CGAffineTransform v14 = [(SUUIPlayButtonControl *)self _imageView];
    CGRect v15 = [v14 layer];
    CGRect v16 = v15;
    uint64_t v17 = *MEMORY[0x263F15D50];
  }
  else
  {
  ...
  id v19 = [(SUUIPlayButtonControl *)self _imageView];
  ...
  long long v23 = [(SUUIPlayButtonControl *)self defaultBackgroundColor];
...
- (id)_innerProgressLayer
{
  ...
  {
    [(SUUIPlayButtonControl *)self buttonSize];
    int v6 = -[SUUIPlayButtonControl _newShapeViewWithBounds:lineWidth:](self, "_newShapeViewWithBounds:lineWidth:", 0.0, 0.0, v4, v5, 2.0);
    ...
    double v10 = [(SUUIPlayButtonShapeView *)self->_innerProgressLayer layer];
...
- (id)_outerProgressLayer
{
  ...
  {
    [(SUUIPlayButtonControl *)self buttonSize];
    int v6 = -[SUUIPlayButtonControl _newShapeViewWithBounds:lineWidth:](self, "_newShapeViewWithBounds:lineWidth:", 0.0, 0.0, v4, v5, 1.5);
    ...
    double v10 = [(SUUIPlayButtonShapeView *)self->_outerProgressLayer layer];
    id v11 = [MEMORY[0x263F825C8] clearColor];
    objc_msgSend(v10, "setFillColor:", objc_msgSend(v11, "CGColor"));
...
- (id)_playImage
{
  uint64_t v2 = [(SUUIPlayButtonControl *)self playImage];
...
- (id)_selectedLayer
{
  ...
  {
    [(SUUIPlayButtonControl *)self buttonSize];
    int v6 = -[SUUIPlayButtonShapeView initWithFrame:]([SUUIPlayButtonShapeView alloc], "initWithFrame:", 0.0, 0.0, v4, v5);
    double v7 = self->_selectedLayer;
    self->_selectedLayer = v6;

    float v8 = [(SUUIPlayButtonShapeView *)self->_selectedLayer layer];
    selectionColor = self->_selectionColor;
    if (selectionColor)
    {
    ...
    {
      double v10 = [MEMORY[0x263F825C8] colorWithWhite:0.0 alpha:0.16];
...
- (void)_showPlayIndicator:(BOOL)a3
{
  ...
  int v6 = [(SUUIPlayButtonControl *)self _cancelImage];
  }
...
- (void)_toggleToPlayState
{
  ...
  BOOL v3 = [(SUUIPlayButtonControl *)self _outerProgressLayer];
  [v3 setHidden:0];

  id v4 = [(SUUIPlayButtonControl *)self _innerProgressLayer];
  [v4 setHidden:0];
}
...
void __80__SUUIPlayButtonControl__updateBackgroundBlur_withOffsetRight_withOffsetBottom___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    id v5 = +[SUUIPlayButtonControl blurColorForImage:forButtonSize:withOffsetRight:withOffsetBottom:](SUUIPlayButtonControl, "blurColorForImage:forButtonSize:withOffsetRight:withOffsetBottom:", v4);
    block[0] = MEMORY[0x263EF8330];
    block[1] = 3221225472;
    block[2] = __80__SUUIPlayButtonControl__updateBackgroundBlur_withOffsetRight_withOffsetBottom___block_invoke_3;
    block[3] = &unk_265401A00;
...
{
  uint64_t v2 = objc_getAssociatedObject(*(id *)(a1 + 32), (const void *)_SUUIPlayButtonControlBackgroundImageAssociatedObjectKeyColorCache);
  ...
  *(void *)(v3 + 40) = v2;
  ...
  if (!v5)
  {
    ...
    *(void *)(v7 + 40) = v6;
    ...
    objc_setAssociatedObject(*(id *)(a1 + 32), (const void *)_SUUIPlayButtonControlBackgroundImageAssociatedObjectKeyColorCache, *(id *)(*(void *)(*(void *)(a1 + 64) + 8) + 40), (void *)1);
    id v5 = *(void **)(*(void *)(*(void *)(a1 + 64) + 8) + 40);
  }
...
- (void)_updateInnerProgressLayerStroke
{
  ...
  {
    uint64_t v4 = [(SUUIPlayButtonControl *)self tintColor];
    id v5 = 0;
  }
  uint64_t v6 = [(SUUIPlayButtonShapeView *)self->_innerProgressLayer layer];
  id v8 = v4;
  objc_msgSend(v6, "setStrokeColor:", -[UIColor CGColor](v8, "CGColor"));

  uint64_t v7 = [(SUUIPlayButtonShapeView *)self->_innerProgressLayer layer];
...
- (void)_updateEnabledState
{
  if (self->_backgroundType == 3)
  {
    uint64_t v3 = [(SUUIPlayButtonControl *)self _classicBackdropView];
...
+ ($8452678F12DBC466148836A9D382CAFC)_calculateStatistics:(SEL)a3 withSize:(CGImage *)a4
{
  ...
  *(_OWORD *)&retstr->var2 = 0u;
  uint64_t v12 = malloc_type_malloc(v11 * (unint64_t)a5.height, 0x2A8BC29FuLL);
  ...
  {
    char v25 = v24;
    size_t v26 = qword_2568A0C20[v15];
    if (v26 < v10)
    {
