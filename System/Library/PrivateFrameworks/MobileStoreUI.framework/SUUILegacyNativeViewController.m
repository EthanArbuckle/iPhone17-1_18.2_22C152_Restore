...
- (void)reloadData
{
  if (self->_initialData)
  {
    ...
    objc_super v3 = [(SUUILegacyNativeViewController *)self _storePageViewController];
...
{
  BOOL v3 = a3;
  id v5 = [(SUUIStorePageViewController *)self->_storePageViewController storePage];
  if (v5
    || [(SUUIStorePageViewController *)self->_storePageViewController isSkLoading]
    || [MEMORY[0x263F82438] shouldMakeUIForDefaultPNG])
  {
  }
  else
  {
...
- (void)willAnimateRotationToInterfaceOrientation:(int64_t)a3 duration:(double)a4
{
  char v7 = [MEMORY[0x263F82670] currentDevice];
...
- (void)categoryController:(id)a3 didSelectCategory:(id)a4
{
  ...
  uint64_t v8 = [(SUUILegacyNativeViewController *)self navigationItem];
...
- (id)activeMetricsController
{
  return [(SUUIStorePageViewController *)self->_storePageViewController activeMetricsController];
}
...
- (id)_categoryController
{
  ...
  if (!categoryController)
  {
    ...
    char v7 = [(SUUIViewController *)self clientContext];
    ...
    objc_super v9 = [(SUUIViewController *)self operationQueue];
...
- (void)_finishLoadWithResult:(BOOL)a3 error:(id)a4
{
  ...
  if (v4)
  {
    char v7 = [(SUUILegacyNativeViewController *)self _categoryController];
    uint64_t v8 = [v7 category];

    if (!v8)
    {
      objc_super v9 = [(SUUIStorePageViewController *)self->_storePageViewController storePage];
      char v10 = [v9 valueForPageKey:@"categoryList"];
      uint64_t v11 = [v9 valueForPageKey:@"categoryListUrl"];
      objc_opt_class();
      if (objc_opt_isKindOfClass())
      {
        id v12 = [[SUUICategory alloc] initWithCategoryDictionary:v10];
        [v7 setCategory:v12];
      }
      else
      {
    ...
    id v14 = [(SUUIStorePageViewController *)self->_storePageViewController storePage];
    v15 = [v14 title];
...
- (void)_reloadNavigationItem
{
  id v15 = [(SUUILegacyNativeViewController *)self navigationItem];
  [v15 setLeftItemsSupplementBackButton:1];
  [v15 setLeftBarButtonItem:0];
  [v15 setTitleView:0];
  BOOL v3 = [(SUUILegacyNativeViewController *)self _categoryController];
  BOOL v4 = [v3 category];
  id v5 = [v4 children];
  ...
  {
    char v7 = [(SUUIViewController *)self clientContext];
    uint64_t v8 = SUUIUserInterfaceIdiom(v7);

    if (v8 == 1
      && ([(SUUIStorePageViewController *)self->_storePageViewController storePage],
...
- (id)_storePageViewController
{
  ...
  {
    BOOL v4 = objc_alloc_init(SUUIStorePageViewController);
