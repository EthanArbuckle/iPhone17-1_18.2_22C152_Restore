...
- (void)commonInitWithFrame:(CGRect)a3
{
  ...
  v8 = objc_msgSend(objc_alloc(MEMORY[0x263F82BF8]), "initWithFrame:", x, y, width, height);
  ...
  v9 = objc_msgSend(objc_alloc(MEMORY[0x263F82BF8]), "initWithFrame:", x, y, width, height);
  ...
  objc_super v10 = [MEMORY[0x263F82670] currentDevice];
...
LABEL_4:
  ...
  [MEMORY[0x263F08938] constraintsWithVisualFormat:@"V:|-(>=TITLE_MINIMUM_ORIGIN_Y)-[titleStackView]" options:0 metrics:&unk_2705D0ED8 views:v17];
...
- (void)setTrendingTitleView:(id)a3
{
  ...
  id v8 = [(SUUITrendingSearchView *)self titleStackView];
...
LABEL_5:
    ...
    double v7 = v6;
    uint64_t v8 = [(SUUITrendingSearchView *)self titleStackView];
    [v8 bounds];
