...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  if (v17)
  {
    ...
    v27[1] = [v23 CGColor];
    id v24 = [MEMORY[0x263F825C8] systemBackgroundColor];
    v27[2] = [v24 CGColor];
    id v25 = [MEMORY[0x263F825C8] systemBackgroundColor];
    v27[3] = [v25 CGColor];
    v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:4];
    [v19 setColors:v26];
  }
}
...
- (void)_setupTitle
{
  ...
  id v4 = [(SUUIComposeReviewNicknameView *)self titleView];
  v5 = SUUIFontLimitedPreferredFontForTextStyle(15, 7);
  [v4 setFont:v5];

  objc_super v6 = [(SUUIComposeReviewNicknameView *)self titleView];
  ...
  int v17 = [v15 constraintEqualToAnchor:v16 constant:20.0];
  [v17 setActive:1];

  v18 = [(SUUIComposeReviewNicknameView *)self titleView];
  v19 = [v18 trailingAnchor];
  v20 = [(SUUIComposeReviewNicknameView *)self trailingAnchor];
  id v21 = [v19 constraintEqualToAnchor:v20 constant:-20.0];
  [v21 setActive:1];

  v22 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v23 = [v22 localizedStringForKey:@"NICKNAME_VIEW_TITLE" value:&stru_2704F8130 table:0];
  id v24 = [(SUUIComposeReviewNicknameView *)self titleView];
  [v24 setText:v23];

  id v25 = [(SUUIComposeReviewNicknameView *)self titleView];
...
- (void)_setupSampleCardView
{
  ...
  id v4 = [(SUUIComposeReviewNicknameView *)self sampleCardView];
  [v4 setTranslatesAutoresizingMaskIntoConstraints:0];

  v5 = [(SUUIComposeReviewNicknameView *)self sampleCardView];
  [(SUUIComposeReviewNicknameView *)self addSubview:v5];

  objc_super v6 = [(SUUIComposeReviewNicknameView *)self sampleCardView];
  v7 = [v6 topAnchor];
  v8 = [(SUUIComposeReviewNicknameView *)self titleView];
  v9 = [v8 bottomAnchor];
  ...
  v16 = -[SUUIGradientView initWithFrame:](v15, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
  [(SUUIComposeReviewNicknameView *)self setSampleCardGradientView:v16];

  int v17 = [(SUUIComposeReviewNicknameView *)self sampleCardGradientView];
  ...
  id v25 = [(SUUIComposeReviewNicknameView *)self sampleCardGradientView];
  ...
  v41 = [v40 layer];
  v42 = [MEMORY[0x263F825C8] systemBackgroundColor];
  id v43 = [v42 colorWithAlphaComponent:0.0];
  v51[0] = [v43 CGColor];
  v44 = [MEMORY[0x263F825C8] systemBackgroundColor];
  id v45 = [v44 colorWithAlphaComponent:0.0];
  v51[1] = [v45 CGColor];
  id v46 = [MEMORY[0x263F825C8] systemBackgroundColor];
  v51[2] = [v46 CGColor];
  id v47 = [MEMORY[0x263F825C8] systemBackgroundColor];
  v51[3] = [v47 CGColor];
  v48 = [MEMORY[0x263EFF8C0] arrayWithObjects:v51 count:4];
  [v41 setColors:v48];

  v49 = [(SUUIComposeReviewNicknameView *)self sampleCardGradientView];
  v50 = [v49 layer];
  [v50 setLocations:&unk_2705D0A90];
}
...
- (void)_setupTextField
{
  ...
  id v4 = [(SUUIComposeReviewNicknameView *)self nicknameBackgroundView];
  [v4 setTranslatesAutoresizingMaskIntoConstraints:0];

  v5 = [MEMORY[0x263F825C8] secondarySystemBackgroundColor];
  objc_super v6 = [(SUUIComposeReviewNicknameView *)self nicknameBackgroundView];
  ...
  id v24 = [(SUUIComposeReviewNicknameView *)self nicknamePlaceholderLabel];
  [v24 setTranslatesAutoresizingMaskIntoConstraints:0];

  id v25 = [(SUUIComposeReviewNicknameView *)self nicknameBackgroundView];
  ...
  id v43 = [v40 constraintEqualToAnchor:v42 constant:-18.0];
  [v43 setActive:1];
  ...
  id v46 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v47 = [v46 localizedStringForKey:@"NICKNAME_VIEW_PLACEHOLDER" value:&stru_2704F8130 table:0];
  ...
  id v82 = [(SUUIComposeReviewNicknameView *)self nicknameTextfield];
...
- (void)_setupInfo
{
  ...
  id v4 = [(SUUIComposeReviewNicknameView *)self nicknameInfoLabel];
  [v4 setTranslatesAutoresizingMaskIntoConstraints:0];

  v5 = [(SUUIComposeReviewNicknameView *)self nicknameInfoLabel];
  [(SUUIComposeReviewNicknameView *)self addSubview:v5];

  objc_super v6 = [(SUUIComposeReviewNicknameView *)self nicknameInfoLabel];
  ...
  int v17 = [v15 constraintEqualToAnchor:v16 constant:-40.0];
  [v17 setActive:1];
  ...
  id v23 = [(SUUIComposeReviewNicknameView *)self nicknameInfoLabel];
  id v24 = [v23 bottomAnchor];
  id v25 = [(SUUIComposeReviewNicknameView *)self bottomAnchor];
  ...
  v29 = [v31 localizedStringForKey:@"NICKNAME_VIEW_MESSAGE" value:&stru_2704F8130 table:0];
