...
- (id)cellForIndexPath:(id)a3
{
  ...
  id v7 = [v6 dequeueReusableCellWithReuseIdentifier:@"SUUISearchBarReuseIdentifier" forIndexPath:v4];
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  id v7 = [(SUUISearchBarPageSection *)self _searchBarController];
  v8 = [v7 searchBar];
...
- (id)_searchBarController
{
  ...
  if (!searchBarController)
  {
    ...
    objc_super v6 = [[SUUISearchBarController alloc] initWithSearchBarViewElement:v5];
...
LABEL_12:
    ...
    -[SUUISearchBarController setParentViewController:](self->_searchBarController, "setParentViewController:", v17, (void)v23);
    searchBarController = self->_searchBarController;
  }
