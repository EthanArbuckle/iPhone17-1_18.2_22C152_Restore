...
- (_Badge)initWithText:(id)a3
{
  ...
  v5 = -[_Badge initWithFrame:](&v9, sel_initWithFrame_, *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
  if (v5)
  {
    v6 = [MEMORY[0x263F825C8] whiteColor];
    [(_Badge *)v5 setTextColor:v6];

    v7 = [MEMORY[0x263F81708] systemFontOfSize:13.0];
...
- (void)setText:(id)a3
{
  ...
  double v5 = v4;
  double v7 = v6;
  -[_Badge sizeThatFits:](self, "sizeThatFits:", *MEMORY[0x263F001B0], *(double *)(MEMORY[0x263F001B0] + 8));
...
- (void)drawTextInRect:(CGRect)a3
{
  ...
  double v9 = [MEMORY[0x263F825C8] colorWithRed:1.0 green:0.231372549 blue:0.188235294 alpha:1.0];
  [v9 set];
  ...
  double v10 = objc_msgSend(MEMORY[0x263F824C0], "bezierPathWithRoundedRect:cornerRadius:", x, y, width, height, CGRectGetHeight(v12) * 0.5);
  [v10 fill];
