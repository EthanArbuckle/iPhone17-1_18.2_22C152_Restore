...
{
  id v4 = a3;
  v5 = [(SUUITabBarController *)self selectedViewController];
  v8.receiver = self;
  v8.super_class = (Class)SUUITabBarController;
  [(SUUITabBarController *)&v8 _setSelectedViewController:v4];

  v6 = [(SUUITabBarController *)self selectedViewController];
  if (v5 == v6)
  {
    v7 = [(SUUITabBarController *)self delegate];
    if (![(SUUITabBarController *)self sizeTransitionInProgress]
...
- (id)moreNavigationController
{
  v8.receiver = self;
  v8.super_class = (Class)SUUITabBarController;
  v3 = [(SUUITabBarController *)&v8 moreNavigationController];
...
- (SUUITabBarController)init
{
  ...
  if (v2)
  {
    uint64_t v4 = [(SUUITabBarController *)v2 tabBar];
    [v4 setSemanticContentAttribute:storeSemanticContentAttribute()];
  }
  return v3;
}
...
- (id)traitCollection
{
  ...
  v3 = [(SUUITabBarController *)&v12 traitCollection];
  uint64_t v4 = [(SUUITabBarController *)self view];
  [v4 bounds];
  double Width = CGRectGetWidth(v15);
  double v6 = SUUICompactThreshold();
  ...
  {
    v7 = [MEMORY[0x263F82DA0] traitCollectionWithHorizontalSizeClass:2];
    objc_super v8 = (void *)MEMORY[0x263F82DA0];
    v13[0] = v3;
    v13[1] = v7;
...
- (void)setTransientViewController:(id)a3 animated:(BOOL)a4
{
  ...
  [(SUUITabBarController *)&v4 setTransientViewController:a3 animated:0];
}
...
- (BOOL)containsTransientViewControllerOnly
{
  objc_super v3 = [(SUUITabBarController *)self transientViewController];
  if (v3)
  {
    objc_super v4 = [(SUUITabBarController *)self viewControllers];
    if ([v4 count] == 1)
    {
      v5 = [(SUUITabBarController *)self viewControllers];
...
- (void)setFloatingOverlayViewController:(id)a3 animated:(BOOL)a4
{
  ...
  if (floatingOverlayViewController != v7)
  {
    if (v7 && floatingOverlayViewController)
    {
      ...
      objc_super v12 = [(UIViewController *)*p_floatingOverlayViewController view];
      [(SUUIFloatingOverlayView *)floatingOverlayView setContentView:v12];
    ...
    else if (v7)
    {
      ...
      CGRect v15 = self->_floatingOverlayView;
      v16 = [(UIViewController *)*p_floatingOverlayViewController view];
      [(SUUIFloatingOverlayView *)v15 setContentView:v16];

      v17 = [(SUUITabBarController *)self view];
      ...
      if (v4)
      {
        ...
        [(SUUIFloatingOverlayView *)v18 setBackgroundColor:v20];

        v27[0] = MEMORY[0x263EF8330];
        v27[1] = 3221225472;
        v27[2] = __66__SUUITabBarController_setFloatingOverlayViewController_animated___block_invoke_3;
        v27[3] = &unk_265400980;
        v27[4] = self;
        v26[0] = MEMORY[0x263EF8330];
        v26[1] = 3221225472;
        v26[2] = __66__SUUITabBarController_setFloatingOverlayViewController_animated___block_invoke_4;
        v26[3] = &unk_265400AC8;
        v26[4] = self;
        [MEMORY[0x263F82E00] animateWithDuration:v27 animations:v26 completion:0.3];
      }
    }
    else
    {
      *p_floatingOverlayViewController = 0;
      ...
      if (v4)
      {
        v23 = [MEMORY[0x263F825C8] systemBackgroundColor];
        v24 = [v23 colorWithAlphaComponent:0.8];
        [(SUUIFloatingOverlayView *)v21 setBackgroundColor:v24];

        v25 = (void *)MEMORY[0x263F82E00];
        v30[0] = MEMORY[0x263EF8330];
        v30[1] = 3221225472;
        v30[2] = __66__SUUITabBarController_setFloatingOverlayViewController_animated___block_invoke;
        v30[3] = &unk_265400980;
        v31 = v21;
        v28[0] = MEMORY[0x263EF8330];
        v28[1] = 3221225472;
        v28[2] = __66__SUUITabBarController_setFloatingOverlayViewController_animated___block_invoke_2;
        v28[3] = &unk_265400AC8;
        v29 = v31;
      ...
      {
        [(SUUIFloatingOverlayView *)v21 removeFromSuperview];
      }
    }
  }
}
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  objc_super v8 = [(SUUITabBarController *)self delegate];
...
- (void)moreNavigationController:(id)a3 didSelectItemAtIndex:(int64_t)a4
{
  id v6 = [(SUUITabBarController *)self delegate];
  if (objc_opt_respondsToSelector())
  {
    v5 = [(SUUITabBarController *)self selectedViewController];
...
- (void)_layoutFloatingOverlayView
{
  id v29 = [(SUUITabBarController *)self view];
  [v29 bounds];
  CGFloat v4 = v3;
  CGFloat v6 = v5;
  CGFloat v8 = v7;
  ...
  if (v17)
  {
    ...
    CGFloat v20 = v19;
    CGFloat v22 = v21;
    v23 = [MEMORY[0x263F82438] sharedApplication];
