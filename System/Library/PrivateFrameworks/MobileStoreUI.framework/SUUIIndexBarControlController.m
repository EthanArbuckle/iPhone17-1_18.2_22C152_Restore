...
- (SUUIIndexBarControlController)init
{
  ...
  if (v2)
  {
    uint64_t v3 = [objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:0 capacity:1];
...
- (void)reloadSections:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:0];
...
{
  self->_hasValidCombinedEntryDescriptor = 0;
  uint64_t v3 = [(NSMapTable *)self->_indexPathToEntryDescriptor objectEnumerator];
  id v4 = [v3 allObjects];
...
- (id)combinedEntryForIndexBarControl:(id)a3
{
  ...
  {
    uint64_t v5 = [(SUUIIndexBarControlController *)self _combinedEntryDescriptor];
    if (v5)
    {
      uint64_t v3 = [(SUUIIndexBarControlController *)self _entryForEntryDescriptor:v5 loadingIfNeeded:1];
    }
    else
    {
      uint64_t v3 = 0;
  ...
  {
    uint64_t v3 = +[SUUIIndexBarEntry systemCombinedEntry];
  }
  return v3;
}
...
- (id)indexBarControl:(id)a3 entryAtIndexPath:(id)a4
{
  uint64_t v5 = [(SUUIIndexBarControlController *)self _entryDescriptorAtIndexPath:a4];
  uint64_t v6 = [(SUUIIndexBarControlController *)self _entryForEntryDescriptor:v5 loadingIfNeeded:1];
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        uint64_t v10 = [(SUUIIndexBarControlController *)self _URLForEntryDescriptor:v9];
        if (v10)
        {
          long long v11 = [(SUUIResourceLoader *)self->_resourceLoader requestIdentifierForCacheKey:v10];
          if (v11)
          {
...
- (id)_cachedEntryForEntryDescriptor:(id)a3
{
    ...
    || (uint64_t v6 = NSMapGet(entryDescriptorToCachedEntry, v4)) == 0)
  {
    ...
    if (v7)
    {
      ...
      {
        id v8 = [v4 image];
        uint64_t v9 = +[SUUIIndexBarEntry entryWithImage:v8];
LABEL_10:
        uint64_t v6 = (void *)v9;
      ...
      if (v7 == 1)
      {
        ...
        uint64_t v9 = +[SUUIIndexBarEntry entryWithAttributedString:v8];
        goto LABEL_10;
      }
      uint64_t v6 = 0;
    }
    ...
    {
      [v4 size];
      uint64_t v6 = +[SUUIIndexBarEntry placeholderEntryWithSize:](SUUIIndexBarEntry, "placeholderEntryWithSize:");
      if (v6)
      {
LABEL_11:
...
- (id)_entryDescriptorAtIndexPath:(id)a3
{
    ...
    || (uint64_t v6 = NSMapGet(indexPathToEntryDescriptor, v4)) == 0)
  {
    ...
    if (!v8)
    {
      uint64_t v9 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:0 capacity:1];
...
- (id)_entryForEntryDescriptor:(id)a3 loadingIfNeeded:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  id v7 = [(SUUIIndexBarControlController *)self _cachedEntryForEntryDescriptor:v6];
  if (!v7)
  {
    id v7 = [(SUUIIndexBarControlController *)self _placeholderEntryForEntryDescriptor:v6];
    if (v4) {
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              long long v16 = +[SUUIIndexBarEntry entryWithImage:v7];
...
{
  id v13 = a3;
  BOOL v4 = -[SUUIIndexBarControlController _URLForEntryDescriptor:](self, "_URLForEntryDescriptor:");
  if (v4)
  {
    id v5 = [(SUUIResourceLoader *)self->_resourceLoader requestIdentifierForCacheKey:v4];
    if (v5
    ...
    else
    {
      ...
      {
        id v8 = (NSMapTable *)[objc_alloc(MEMORY[0x263F08968]) initWithKeyOptions:0 valueOptions:0 capacity:1];
        requestIDToDescriptors = self->_requestIDToDescriptors;
        self->_requestIDToDescriptors = v8;
      }
      id v10 = objc_alloc_init(SUUIArtworkRequest);
      ...
      uint64_t v12 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[SUUIResourceRequest requestIdentifier](v10, "requestIdentifier"));
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource);
  return (SUUIIndexBarControlControllerDataSource *)WeakRetained;
}

- (SUUIIndexBarControlControllerDelegate)delegate
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUIIndexBarControlControllerDelegate *)WeakRetained;
}
