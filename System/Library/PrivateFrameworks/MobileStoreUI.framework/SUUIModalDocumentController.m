...
void __61__SUUIModalDocumentController_navigationDocumentForDocument___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v11 = a2;
  id v6 = [v11 document];
  id v7 = *(void **)(a1 + 32);
...
void __73__SUUIModalDocumentController_navigationDocumentForNavigationController___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
...
- (void)pushDocument:(id)a3 options:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(SUUIModalDocumentController *)self delegate];
  char v9 = objc_opt_respondsToSelector();

  if ((v9 & 1) == 0
    || ([(SUUIModalDocumentController *)self delegate],
        ...
        v11))
  {
    ...
    else
    {
      if (v13 > 100)
      {
        ...
        {
          case 101:
            uint64_t v14 = +[SUUIReportAConcernConfiguration configurationWithTemplateElement:v12];
            uint64_t v16 = [[SUUIReportAConcernViewController alloc] initWithConfiguration:v14];
            ...
            goto LABEL_50;
          case 117:
            uint64_t v14 = [[SUUIDocumentStackItem alloc] initWithDocument:v6 presentationOptions:v7];
            [(SUUIDocumentStackItem *)v14 setUsesNavigationControllerForModalPresentation:0];
            long long v19 = [SUUIShareTemplateActivityViewController alloc];
            long long v20 = [(SUUIModalDocumentController *)self clientContext];
            long long v15 = [(SUUIShareTemplateActivityViewController *)v19 initWithTemplateElement:v12 clientContext:v20];
            ...
            [(SUUIDocumentStackItem *)v15 setCompletionWithItemsHandler:v36];
            long long v21 = [(SUUIDocumentStackItem *)v14 presentationType];
            LODWORD(v20) = [v21 isEqualToString:0x27050BF30];
            ...
            else
            {
              ...
              {
                v26 = [(SUUIDocumentStackItem *)v15 popoverPresentationController];
                [(SUUIModalDocumentController *)self _pushPopoverSheetDocument:v6 viewController:v15 popoverPresentationController:v26 options:v7];
              }
              else
              {
          ...
          case 153:
            ...
            if (v14) {
              long long v15 = (SUUIDocumentStackItem *)[objc_alloc(NSURL) initWithString:v14];
            }
            else {
              long long v15 = 0;
            }
            v27 = objc_alloc_init(SUUIComposeReviewViewController);
            [(SUUIComposeReviewViewController *)v27 setDelegate:self];
            [(SUUIComposeReviewViewController *)v27 setTemplateViewElement:v12];
            ...
            v31 = v27;
            v34 = v31;
            [(SUUIComposeReviewViewController *)v31 loadReviewWithURL:v15 completionBlock:v33];
            [(SUUIModalDocumentController *)self _pushSheetDocument:v6 viewController:v31];
...
LABEL_28:
        uint64_t v14 = [(SUUIModalDocumentController *)self clientContext];
        long long v15 = [[SUUIDocumentStackItem alloc] initWithDocument:v6 presentationOptions:v7];
        long long v22 = [(SUUIDocumentStackItem *)v14 modalDocumentViewControllerForDocument:v6 options:v7];
        if (v22)
        {
          ...
          if (objc_opt_respondsToSelector()) {
            -[SUUIDocumentStackItem setUsesNavigationControllerForModalPresentation:](v15, "setUsesNavigationControllerForModalPresentation:", [v22 needsNavigationDocument]);
          }
          v23 = v22;
        }
        else
        {
          v23 = [[SUUIDocumentContainerViewController alloc] initWithDocument:v6 options:v7 clientContext:v14];
          if (!v23)
          {
...
LABEL_50:
        ...
        [(SUUIDocumentStackItem *)v15 setViewController:v23];
        v32 = [(SUUIDocumentStackItem *)v15 presentationType];
        if ([v32 isEqualToString:0x270508FD0])
        {
          [(SUUIModalDocumentController *)self _pushOverlayStackItem:v15];
        }
        else if ([v32 isEqualToString:0x27050BF30])
        {
...
void __52__SUUIModalDocumentController_pushDocument_options___block_invoke_2(void **a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v2) {
      id v3 = objc_msgSend(objc_alloc(NSDictionary), "initWithObjectsAndKeys:", v2, @"activityType", 0);
    }
    else {
      id v3 = 0;
    }
...
LABEL_11:
  ...
  char v18 = [v17 isEqualToString:0x270508FD0];

  if (v18)
  {
    long long v19 = [SUUIDocumentContainerViewController alloc];
    long long v20 = [(SUUIModalDocumentController *)self clientContext];
    long long v21 = [(SUUIDocumentContainerViewController *)v19 initWithDocument:v9 options:v10 clientContext:v20];
...
- (void)setOverlayNavigationController:(id)a3 withTransitionCoordinator:(id)a4
{
  ...
  if (self->_overlayNavigationController != v7)
  {
    if (v7)
    {
      id v10 = [(SUUIOverlayContainerViewController *)self->_overlayViewController viewControllers];
...
void __104__SUUIModalDocumentController_ensureOverlayNavigationControllerStackConsistencyForNavigationController___block_invoke(uint64_t a1, void *a2)
{
  ...
  [v3 isEqualToString:0x270508FD0];
...
void __78__SUUIModalDocumentController__composeReviewViewControllerDidFinish_finished___block_invoke(uint64_t a1)
{
  if (*(unsigned char *)(a1 + 32))
  {
    ...
    id v3 = [SUUIToastViewController alloc];
    BOOL v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    id v5 = [v4 localizedStringForKey:@"TOAST_REVIEW_FINISHED_PRIMARY" value:&stru_2704F8130 table:0];
    id v6 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    float v7 = [v6 localizedStringForKey:@"TOAST_REVIEW_FINISHED_SECONDARY" value:&stru_2704F8130 table:0];
    BOOL v8 = [(SUUIToastViewController *)v3 initWithTitle:v5 description:v7 image:v9];

    [(SUUIToastViewController *)v8 present];
  }
}
...
- (void)overlayContainerViewController:(id)a3 willPopViewController:(id)a4
{
  ...
  long long v17 = __Block_byref_object_dispose__2;
...
- (void)_overlayControllerBackstopAction:(id)a3
{
  ...
  id v5 = [(SUUIOverlayContainerViewController *)self->_overlayViewController viewControllers];
  long long v16 = 0u;
  long long v17 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
...
void __64__SUUIModalDocumentController__overlayControllerBackstopAction___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  uint64_t v7 = [a2 viewController];
  BOOL IsDescendent = SUUIViewControllerIsDescendent(v7, *(void **)(a1 + 32));
...
- (void)_dismissOverlayControllerWithStackItem:(id)a3 animated:(BOOL)a4
{
  ...
  double v7 = [(SUUIOverlayContainerViewController *)self->_overlayViewController backstopControl];
  ...
  {
    CGFloat v9 = [(SUUIOverlayContainerViewController *)v6 view];
...
- (void)_garbageCollectActivityViewController:(id)a3
{
  ...
  BOOL IsDescendent = SUUIViewControllerIsDescendent(v7, v4);
...
- (id)_imageForImageViewElement:(id)a3
{
  ...
  if (v3)
  {
    id v5 = SUUIImageWithResourceName(v3);
  }
  else
  {
    id v5 = 0;
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        int v11 = [v10 isEqualToString:0x270508FD0];
...
- (BOOL)_popoverController:(id)a3 containsStackItem:(id)a4
{
  ...
  BOOL v11 = SUUIViewControllerIsDescendent(v9, v6)
...
- (void)_popOverlayStackItem:(id)a3 animated:(BOOL)a4 completion:(id)a5
{
  ...
  id v11 = a3;
  id v8 = a5;
  CGFloat v9 = [(SUUIOverlayContainerViewController *)self->_overlayViewController viewControllers];
...
- (id)_presenterViewController
{
  uint64_t v2 = [(SUUIModalDocumentController *)self rootViewController];
...
- (void)_presentOverlayViewControllersFromNavigationController:(id)a3
{
  ...
  uint64_t v19 = self;
  id v7 = [(SUUIModalDocumentController *)self _overlayStackItems];
  ...
  if ([v6 count])
  {
    long long v17 = [(SUUIModalDocumentController *)v19 _showOverlayContainerViewController];
...
- (void)_pushCharityDocument:(id)a3 options:(id)a4
{
  ...
  if (v6)
  {
    id v7 = [[SUUIDonationViewController alloc] initWithCharityIdentifier:v6];
  }
  else
  {
    ...
    if (v8)
    {
      ...
      uint64_t v11 = [(SUUIURL *)v9 initWithURL:v10];
    }
    else
    {
      uint64_t v11 = 0;
    }
    id v7 = [[SUUIDonationViewController alloc] initWithURL:v11];
  }
  uint64_t v12 = [(SUUIModalDocumentController *)self clientContext];
...
- (void)_presentAlertForDialog:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!dialogController)
    {
      id v6 = objc_alloc_init(SUUIStoreDialogController);
      id v7 = self->_dialogController;
      self->_dialogController = v6;

      dialogController = self->_dialogController;
    }
    unint64_t v8 = [(SUUIModalDocumentController *)self _presenterViewController];
...
- (void)_presetPopoverSheetDocument:(id)a3 viewController:(id)a4 popoverPresentationController:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  uint64_t v12 = [[SUUIDocumentStackItem alloc] initWithDocument:v10 presentationOptions:0];
  ...
  uint64_t v11 = [(SUUIModalDocumentController *)self _presenterViewController];
...
- (void)_promptForStarRating:(id)a3
{
  ...
  id v4 = [MEMORY[0x263F17FB0] starRatingAlertController];
  uint64_t v5 = MEMORY[0x263EF8330];
  uint64_t v6 = 3221225472;
  id v7 = __52__SUUIModalDocumentController__promptForStarRating___block_invoke;
  id v8 = &unk_265400FF0;
...
- (void)_pushDialogDocument:(id)a3 options:(id)a4
{
  ...
  switch([v41 dialogType])
  {
    case 0:
    case 3:
      id v47 = [MEMORY[0x263F82418] alertControllerWithTitle:v38 message:v39 preferredStyle:1];
      BOOL v10 = 0;
      goto LABEL_5;
    case 1:
      id v47 = [MEMORY[0x263F82418] alertControllerWithTitle:v38 message:v39 preferredStyle:0];
      v36 = [v47 popoverPresentationController];
      [v36 setDelegate:self];
      goto LABEL_6;
    case 2:
      objc_initWeak(&location, self);
      uint64_t v11 = [(SUUIModalDocumentController *)self dataSource];
        ...
        if (v12)
        {
          ...
          do
          {
            ...
            for (uint64_t i = 0; i != v48; ++i)
            {
              ...
              if (v19)
              {
                id v20 = [(SUUIModalDocumentController *)self _imageForImageViewElement:v19];
              }
              else
              {
                id v20 = 0;
              ...
              v49[4] = v14;
              long long v24 = [v21 _actionWithTitle:v23 image:v20 style:v18 handler:v49 shouldDismissHandler:&__block_literal_global_0];

              if (v17)
              {
                uint64_t v25 = [v14 buttonTitleStyle];
                uint64_t v26 = SUUIViewElementAlignmentForStyle(v25);
                if (v26) {
                  [v24 _setTitleTextAlignment:SUUIViewElementNSTextAlignmentForIKElementAlignment(v26)];
                }
                long long v27 = v25;
                if (!v25)
                {
                ...
                long long v28 = SUUIViewElementPlainColorWithStyle(v27, 0);
                if (!v25) {
                ...
                v31 = SUUIViewElementPlainColorWithStyle(v29, 0);
                if (!v30) {
...
LABEL_42:
      ...
      uint64_t v32 = objc_msgSend(MEMORY[0x263F82670], "currentDevice", v36);
...
LABEL_50:
      ...
      return;
    case 4:
      v34 = [[SUUIToastViewController alloc] initWithDialogTemplate:v41];
      [(SUUIToastViewController *)v34 present];
...
{
  id v5 = a3;
  uint64_t v6 = SUUIAccountsFramework();
  id v11 = objc_alloc_init((Class)SUUIWeakLinkedClassForString(&cfstr_Acaccountstore.isa, v6));
  uint64_t v7 = SUUIAppleAccountUIFramework();
  id v8 = objc_alloc((Class)SUUIWeakLinkedClassForString(&cfstr_Aauifamilysetu.isa, v7));
...
- (void)_pushGiftDocument:(id)a3 options:(id)a4
{
  ...
  uint64_t v7 = [SUUIGift alloc];
  id v8 = v7;
  if (v6)
  {
    id v9 = [v16 productItem];
    BOOL v10 = [(SUUIGift *)v8 initWithItem:v9];
  }
  else
  {
    BOOL v10 = [(SUUIGift *)v7 initWithGiftCategory:0];
  }
  id v11 = [[SUUIGiftViewController alloc] initWithGift:v10];
  uint64_t v12 = [(SUUIModalDocumentController *)self clientContext];
...
- (void)_pushOverlayStackItem:(id)a3
{
  ...
  else
  {
    ...
    if ([v8 isEqualToString:0x2705083D0]
      && [v5 usesNavigationControllerForModalPresentation])
    {
      BOOL v10 = objc_alloc_init(_SUUIModalSheetNavigationController);
      ...
      uint64_t v12 = v10;
      id v13 = [[SUUINavigationDocumentController alloc] initWithNavigationController:v12];
      long long v14 = [(SUUIModalDocumentController *)self clientContext];
      ...
      id v16 = [(SUUIModalDocumentController *)self delegate];
      if (objc_opt_respondsToSelector())
      {
        uint64_t v17 = [v16 modalDocumentController:self barStyleForStackItem:v5];
        uint64_t v18 = [(_SUUIModalSheetNavigationController *)v12 navigationBar];
        [v18 setBarStyle:v17];
      }
    }
    else
    ...
    uint64_t v19 = [(SUUIModalDocumentController *)self _showOverlayContainerViewController];
    if (![v19 _appearState])
    {
...
void __61__SUUIModalDocumentController__pushPlaylistDocument_options___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v6 = a2;
  id v10 = [[SUUIPlayableAsset alloc] initWithVideoViewElement:*(void *)(a1 + 32) assetViewElement:v6];

  uint64_t v7 = [*(id *)(a1 + 40) clientContext];
  id v8 = SUUIVideoPreviewPlayPlayableAsset(v10, v7);
...
{
  id v4 = a3;
  id v5 = [(SUUIModalDocumentController *)self _modalSourceViewProviderFromStackItems];
...
void __53__SUUIModalDocumentController__pushPopoverStackItem___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4 | v5)
  {
    ...
    if ([*(id *)(a1 + 40) usesNavigationControllerForModalPresentation])
    {
      ...
      id v9 = [[SUUINavigationDocumentController alloc] initWithNavigationController:v7];
      ...
      uint64_t v11 = [objc_alloc(MEMORY[0x263F82AA0]) initWithContentViewController:v7];
    ...
    {
      uint64_t v27 = [objc_alloc(MEMORY[0x263F82AA0]) initWithContentViewController:v6];
    ...
    if (*MEMORY[0x263F001B0] == v33 && v32 == v30) {
    ...
    {
      v46[0] = *(void *)(a1 + 40);
      id v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:v46 count:1];
  ...
  id v39 = [MEMORY[0x263F82438] sharedApplication];
...
- (id)_modalSourceViewProviderFromStackItems
{
  if ([(NSMutableArray *)self->_stackItems count])
  {
    ...
    if ([v4 conformsToProtocol:&unk_270654A60]) {
      id WeakRetained = v4;
    }
    else {
      id WeakRetained = 0;
...
{
  id v5 = a3;
  double v9 = [[SUUIRedeemViewController alloc] initWithRedeemCategory:0];
  double v6 = [(SUUIModalDocumentController *)self clientContext];
...
- (void)_pushSheetDocument:(id)a3 viewController:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  double v9 = [[SUUIDocumentStackItem alloc] initWithDocument:v7 presentationOptions:0];

  [(SUUIDocumentStackItem *)v9 setViewController:v6];
  [(NSMutableArray *)self->_stackItems addObject:v9];
  double v8 = [(SUUIModalDocumentController *)self _presenterViewController];
...
- (void)_pushPopoverSheetDocument:(id)a3 viewController:(id)a4 popoverPresentationController:(id)a5 options:(id)a6
{
  ...
  if (v11 && v17)
  {
    ...
    uint64_t v19 = [(SUUIModalDocumentController *)self _presenterViewController];
    id v20 = [v19 view];
    ...
    long long v22 = [(SUUIModalDocumentController *)self _presenterViewController];
    double v23 = [v22 view];
...
- (void)_pushSheetStackItem:(id)a3
{
  ...
  id v13 = (_SUUIModalSheetNavigationController *)objc_claimAutoreleasedReturnValue();
  long long v14 = [(SUUIModalDocumentController *)self _presenterViewController];
  if ([v4 usesNavigationControllerForModalPresentation])
  {
    id v15 = objc_alloc_init(_SUUIModalSheetNavigationController);
    ...
    uint64_t v18 = [[SUUINavigationDocumentController alloc] initWithNavigationController:v17];
    uint64_t v19 = [(SUUIModalDocumentController *)self clientContext];
    [(SUUINavigationDocumentController *)v18 setClientContext:v19];

    [v4 setNavigationDocumentController:v18];
    v27[0] = v4;
    id v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:1];
    [(SUUINavigationDocumentController *)v18 setStackItems:v20 animated:0];

    long long v21 = [(SUUIModalDocumentController *)self delegate];
    if (objc_opt_respondsToSelector())
    {
      uint64_t v22 = [v21 modalDocumentController:self barStyleForStackItem:v4];
      double v23 = [(_SUUIModalSheetNavigationController *)v17 navigationBar];
      [v23 setBarStyle:v22];
    }
  }
  else
  ...
  if ([v24 isEqualToString:0x27050BF70]) {
    [(_SUUIModalSheetNavigationController *)v17 setModalPresentationStyle:2];
  }
  if (v12)
  {
    id v25 = [[SUUIBackdropContentViewController alloc] initWithContentViewController:v17];
...
- (void)_sendDidFinishIfApplicable
{
  id v3 = [(SUUIModalDocumentController *)self delegate];
...
- (id)_showOverlayContainerViewController
{
  ...
  {
    id v4 = objc_alloc_init(SUUIOverlayContainerViewController);
    id v5 = self->_overlayViewController;
    self->_overlayViewController = v4;

    id v6 = [(SUUIOverlayContainerViewController *)self->_overlayViewController backstopControl];
    ...
    double v13 = v12;
    double v15 = v14;
    BOOL v16 = [(SUUIOverlayContainerViewController *)self->_overlayViewController view];
    ...
    int v17 = [MEMORY[0x263F82DA0] traitCollectionWithUserInterfaceLevel:1];
...
- (void)_unloadDocumentForPopoverController:(id)a3
{
  ...
  double v13 = __67__SUUIModalDocumentController__unloadDocumentForPopoverController___block_invoke;
  double v14 = &unk_265401100;
  double v15 = self;
  id v6 = v4;
  id v16 = v6;
  uint64_t v7 = [(NSMutableArray *)stackItems indexOfObjectPassingTest:&v11];
...
- (SUUIModalDocumentDelegate)delegate
{
  ...
  return (SUUIModalDocumentDelegate *)WeakRetained;
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_modalSourceViewProvider);
  return (SUUIModalSourceViewProvider *)WeakRetained;
}
...
- (SUUIModalDocumentDataSource)dataSource
{
  ...
  return (SUUIModalDocumentDataSource *)WeakRetained;
}
