...
- (SUUIURL)initWithURL:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      uint64_t v11 = [objc_alloc(NSURL) initWithString:url];
      v12 = v5->_url;
      v5->_url = (NSURL *)v11;
    }
  }
...
- (SUUIURL)initWithURL:(id)a3 sourceApplication:(id)a4 annotation:(id)a5
{
  ...
  if (v10)
  {
    ...
    {
      uint64_t v11 = (void *)SUUIMobileCoreServicesFramework();
      id v12 = *(id *)SUUIWeakLinkedSymbolForString("LSReferrerURLKey", v11);
      if (v12)
      {
...
- (SUUIURL)initWithURLBagKey:(id)a3
{
  ...
  id v8 = [MEMORY[0x263F08BD0] queryItemWithName:@"action" value:@"bagurl"];
  [v7 addObject:v8];

  id v9 = [MEMORY[0x263F08BD0] queryItemWithName:@"bagkey" value:v5];

  [v7 addObject:v9];
  [v6 setQueryItems:v7];
  v10 = [v6 URL];
  uint64_t v11 = [(SUUIURL *)self initWithURL:v10];
...
- (id)newURLRequest
{
  return [(SUUIURL *)self newURLRequestWithBaseURL:self->_url];
}

- (id)newURLRequestWithBaseURL:(id)a3
{
  id v4 = (NSURL *)a3;
  id v5 = objc_alloc_init(MEMORY[0x263EFC5E8]);
  id v6 = [(SUUIURL *)self _queryDictionary];
  ...
  if (v8)
  {
    if (v7 || self->_url != v4)
    {
      ...
      id v34 = 0;
      id v12 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithObjects:", @"action", @"bagKey", @"x-apple-serial-number", 0);
      v13 = v12;
      if (v11) {
      ...
      if (v30[5])
      {
        v16 = -[SUUIURL _searchGroupForSearchKind:](self, "_searchGroupForSearchKind:");
        if ([v16 length]) {
...
- (NSString)searchTerm
{
  ...
  uint64_t v4 = [(SUUIURL *)self _decodedQueryParameter:v10[5]];
  id v5 = (void *)v10[5];
  v10[5] = v4;
...
void __21__SUUIURL_searchTerm__block_invoke(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
  id v14 = a2;
  id v7 = a3;
...
{
  id v4 = a3;
  id v5 = [(SUUIURL *)self _queryDictionary];
...
- (id)_searchURLBagKey
{
  ...
  else
  {
    ...
    {
      id v5 = [(SUUIURL *)self _appStoreSearchURLBagKey];
    }
    ...
    {
      id v8 = [(SUUIURL *)self _queryDictionary];
...
- (id)description
{
  ...
  uint64_t v4 = [(SUUIURL *)&v7 description];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    objc_super v7 = [(SUUIURL *)self underlyingURL];
