...
- (SUUIModernChartsDocumentViewController)initWithTemplateElement:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)SUUIModernChartsDocumentViewController;
...
- (void)documentDidUpdate:(id)a3
{
  ...
  -[SUUIModernChartsDocumentViewController _reloadWithTemplateElement:](self, "_reloadWithTemplateElement:");
...
- (void)viewWillLayoutSubviews
{
  ...
  -[SUUIModernChartsView setContentInset:](chartsView, "setContentInset:");
  ...
  v5.receiver = self;
  v5.super_class = (Class)SUUIModernChartsDocumentViewController;
...
{
  id v5 = a3;
  uint64_t v4 = [(SUUIModernChartsDocumentViewController *)self parentViewController];
...
- (void)resourceLoader:(id)a3 didLoadAllForReason:(int64_t)a4
{
  ...
  id v6 = [(SUUIModernChartsDocumentViewController *)self parentViewController];
...
- (UIEdgeInsets)_contentInset
{
  ...
  id v6 = [(SUUIModernChartsDocumentViewController *)self bottomLayoutGuide];
  [v6 length];
  double v8 = v7;
...
- (id)_layoutCache
{
  ...
  if (!layoutCache)
  {
    double v4 = objc_alloc_init(SUUILayoutCache);
...
- (id)_newColumnViewControllersWithReusableViewControllers:(id)a3
{
  ...
  long long v28 = [(SUUIViewController *)self clientContext];
  ...
  if (v34)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v34; ++i)
      {
        ...
        id v6 = objc_msgSend(objc_alloc((Class)SUUIPageComponentClassForComponentType(objc_msgSend(v5, "pageComponentType"))), "initWithViewElement:", v5);
        if (v6)
        {
...
LABEL_15:
          ...
          id v22 = [(SUUIViewController *)v20 operationQueue];
          ...
          if (v11) {
            ...
            uint64_t v24 = &stru_2704F8130;
          }
          [(SUUIStorePageSectionsViewController *)v21 setTitle:v24];
          uint64_t v25 = objc_alloc_init(SUUIMetricsImpressionSession);
          [(SUUIStorePageSectionsViewController *)v21 setActiveMetricsImpressionSession:v25];

LABEL_21:
          v44 = v6;
          long long v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v44 count:1];
...
- (void)_reloadWithTemplateElement:(id)a3
{
  ...
  double v7 = [(SUUIModernChartsDocumentViewController *)self _newColumnViewControllersWithReusableViewControllers:v6];
  ...
  uint64_t v16 = [(SUUIChartsTemplateViewElement *)self->_templateElement activityIndicator];
...
- (void)_showActivityIndicator
{
  id v14 = [(SUUIModernChartsDocumentViewController *)self view];
  ...
  id v5 = [(SUUIChartsTemplateViewElement *)self->_templateElement activityIndicator];
  id v6 = [(SUUIModernChartsDocumentViewController *)self _viewLayoutContext];
  double v7 = [MEMORY[0x263F82B60] mainScreen];
  [v7 bounds];
  double v9 = v8;

  [(id)objc_opt_class() requestLayoutForViewElement:v5 width:v6 context:v9];
  uint64_t v10 = [(SUUIModernChartsDocumentViewController *)self _layoutCache];
...
- (CGRect)_computedFrameForActivityIndicatorView
{
  ...
  -[SUUIActivityIndicatorView sizeThatFits:](self->_activityIndicatorView, "sizeThatFits:", v5, v7);
  double v9 = v8;
  double v11 = v10;
...
- (id)_viewLayoutContext
{
  ...
  if (!viewLayoutContext)
  {
    ...
    double v8 = [(SUUIModernChartsDocumentViewController *)self _layoutCache];
    ...
    double v10 = [[SUUIResourceLoader alloc] initWithClientContext:v6];
