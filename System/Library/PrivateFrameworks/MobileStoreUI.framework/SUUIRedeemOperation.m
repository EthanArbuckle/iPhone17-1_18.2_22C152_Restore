...
- (SUUIRedeemOperation)initWithCode:(id)a3;
...
- (SUUIRedeemOperation)initWithCode:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUUIRedeemOperation;
...
LABEL_8:
  ...
  *(void *)&v70[16] = 0x3032000000;
  ...
  id v13 = objc_alloc(MEMORY[0x263F7B2F8]);
  v69 = self->_code;
  v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v69 count:1];
  v15 = (void *)[v13 initWithRedeemCodes:v14];

  v16 = [(SUUIRedeemOperation *)self _authenticationContext];
  ...
  {
    v24 = [v20 redirectURL];
    v25 = [(SUUIRedeemOperation *)self _requestPropertiesForThankYouWithURL:v24];
...
LABEL_46:
    if (!v62[5])
    {
      ...
      v30 = +[SUUIClientContext localizedStringForKey:@"REDEEM_UNAVAILABLE" inBundles:0 inTable:v29];
      }

      v68 = v30;
      v31 = [NSDictionary dictionaryWithObjects:&v68 forKeys:&v67 count:1];
      uint64_t v32 = [v27 errorWithDomain:*MEMORY[0x263F18040] code:0 userInfo:v31];
      v33 = (void *)v62[5];
      v62[5] = v32;
    }
    v20 = 0;
  ...
  if (v62[5])
  {
    v34 = [MEMORY[0x263F7B1F8] sharedConfig];
...
- (id)_authenticationContext
{
  ...
  if (v3
    && ([v3 uniqueIdentifier],
        ...
        v6))
  {
    uint64_t v7 = (void *)[objc_alloc(MEMORY[0x263F7B288]) initWithAccount:v3];
    ...
    for (uint64_t i = 0; i != v7; ++i)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (objc_opt_respondsToSelector())
        {
          ...
          v110 = v15;
          v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v110 count:1];
...
LABEL_39:
        ...
        if (objc_opt_isKindOfClass())
        {
          v19 = [&unk_2705D0EB0 objectForKey:@"productType"];
          v20 = v19;
          if (!v19) {
            v19 = &unk_2705D0CB8;
          }
        ...
        if (objc_opt_isKindOfClass())
        {
          v33 = [NSURL URLWithString:v14];
          if (v33)
          {
            v34 = -[SUUIArtwork initWithURL:size:]([SUUIArtwork alloc], "initWithURL:size:", v33, 10.0, 10.0);
            int v35 = objc_alloc_init(SUUIArtworkList);
            v109 = v34;
            int v36 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v109 count:1];
...
LABEL_52:
        ...
        for (uint64_t j = 0; j != v44; ++j)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            if (objc_opt_respondsToSelector())
            {
              ...
              v107 = v49;
              id v50 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v107 count:1];
  ...
  if ([v4 count])
  {
    if ([v4 count] == 1)
    {
      ...
      v53 = (void *)v52;
      id v54 = (void *)MEMORY[0x263EFFA68];
      if (v52) {
        id v54 = (void *)v52;
      }
      id v55 = v54;

      v56 = [MEMORY[0x263EFFA08] setWithArray:v55];
  ...
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    v76 = (void *)[objc_alloc(NSURL) initWithString:v75];
  }
  else {
    v76 = 0;
  }
  ...
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    v78 = (void *)[objc_alloc(NSURL) initWithString:v77];
  }
  else {
    v78 = 0;
  }
  ...
  if ([v67 length] || objc_msgSend(v4, "count"))
  {
    ...
    [(SUUIRedeem *)v39 setCreditDisplay:v74];
    v81 = v89;
...
- (id)_itemsForItemIdentifiers:(id)a3
{
  ...
  id v26 = objc_alloc_init(MEMORY[0x263F7B210]);
  [v26 setKeyProfile:*MEMORY[0x263F7B9B0]];
  [v26 setValue:v4 forRequestParameter:*MEMORY[0x263F7B9C8]];
  uint64_t v34 = 0;
  int v35 = &v34;
  ...
  if (v15)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v15; ++j)
      {
        ...
        uint64_t v21 = [(SUUIItem *)v19 initWithLookupDictionary:v20];
        [v13 addObject:v21];
      }
      uint64_t v15 = [v14 countByEnumeratingWithState:&v27 objects:v44 count:16];
    }
...
LABEL_14:
    ...
    if (v22)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v23; ++j)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            long long v27 = [[SUUILink alloc] initWithLinkDictionary:v26];
            if (v27) {
              [v20 addObject:v27];
            }
          }
  ...
  if (objc_opt_isKindOfClass())
  {
    long long v29 = [MEMORY[0x263EFF9A0] dictionaryWithDictionary:v28];
    ...
    if (v30)
    {
      ...
      {
        id v32 = [SUUIArtworkList alloc];
        uint64_t v45 = v29;
        v33 = [*(id *)(v8 + 2240) arrayWithObjects:&v45 count:1];
        uint64_t v34 = [(SUUIArtworkList *)v32 initWithArtworkListArray:v33];
...
- (id)_performRequestWithProperties:(id)a3 error:(id *)a4
{
  ...
  uint64_t v22 = __Block_byref_object_copy__76;
  uint64_t v23 = __Block_byref_object_dispose__76;
  id v24 = 0;
  uint64_t v6 = [(SSURLConnectionRequest *)[SUUIURLConnectionRequest alloc] initWithRequestProperties:v4];
  uint64_t v13 = MEMORY[0x263EF8330];
  uint64_t v14 = 3221225472;
  uint64_t v15 = __59__SUUIRedeemOperation__performRequestWithProperties_error___block_invoke;
  uint64_t v16 = &unk_265403070;
  v18 = &v19;
  uint64_t v7 = v5;
  v17 = v7;
