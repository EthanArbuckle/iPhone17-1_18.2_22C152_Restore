...
- (UIBarButtonItem)categoryButton
{
  ...
  if (!button)
  {
    ...
    v5 = +[SUUIClientContext localizedStringForKey:@"CATEGORIES_BUTTON" inBundles:0];
    }
    v6 = (UIBarButtonItem *)[objc_alloc(MEMORY[0x263F824A8]) initWithTitle:v5 style:0 target:self action:sel_buttonAction_];
    v7 = self->_button;
    self->_button = v6;
...
- (void)loadFromURL:(id)a3 withCompletionBlock:(id)a4
{
  ...
  objc_super v8 = (SSVLoadURLOperation *)[objc_alloc(MEMORY[0x263F7B3A0]) initWithURL:v6];
...
- (UISegmentedControl)segmentedControl
{
  ...
  if (!segmentedControl)
  {
    id v4 = [SUUISegmentedControl alloc];
    id v5 = [(SUUISegmentedControl *)v4 initWithItems:MEMORY[0x263EFFA68]];
...
- (void)setCategory:(id)a3
{
  ...
  if (self->_rootCategory != v5)
  {
    ...
    p_rootCategory = (SUUICategory **)[(SUUICategoryController *)self _reloadSegmentedControl];
    id v5 = v7;
  }
  MEMORY[0x270F9A758](p_rootCategory, v5);
}
...
{
  [(SUUICategoryController *)self dismiss];
  id v26 = [(SUUICategoryController *)self _rootMetricsLocations];
  id v4 = [(SUUICategoryController *)self _tableViewControllerWithCategory:self->_rootCategory];
  tableViewController = self->_tableViewController;
  ...
  if (v7 == 1)
  {
    ...
    v9 = (void *)[objc_alloc(MEMORY[0x263F829B8]) initWithRootViewController:self->_tableViewController];
  ...
  {
    id v12 = (void *)[objc_alloc(MEMORY[0x263F829B8]) initWithRootViewController:self->_tableViewController];
    [v12 _setClipUnderlapWhileTransitioning:1];
    id v13 = self->_rootCategory;
    uint64_t v14 = [(SUUICategory *)v13 subcategoryContainingURL:self->_selectedURL];
    if (v14)
    {
      id v15 = (void *)v14;
      uint64_t v16 = *MEMORY[0x263F7BBC0];
      while (1)
      {
        v17 = [v15 children];
        ...
        id v19 = [(SUUICategoryController *)self _tableViewControllerWithCategory:v15];
        v20 = [(SUUICategory *)v13 children];
        uint64_t v21 = [v20 indexOfObjectIdenticalTo:v15];

        if (v21 != 0x7FFFFFFFFFFFFFFFLL)
        {
          id v22 = objc_alloc_init(MEMORY[0x263F7B250]);
        ...
        id v15 = [(SUUICategory *)v23 subcategoryContainingURL:self->_selectedURL];
...
{
  [(SUUICategoryController *)self dismiss];
  uint64_t v4 = [(SUUISegmentedControl *)self->_segmentedControl selectedSegmentIndex];
  ...
  if (isKindOfClass)
  {
    uint64_t v7 = [(SUUICategoryController *)self _tableViewControllerWithCategory:rootCategory];
    tableViewController = self->_tableViewController;
    self->_tableViewController = v7;

    v9 = self->_tableViewController;
    id v10 = [(SUUICategoryController *)self _metricsLocationsWithIndex:v4];
...
LABEL_6:
    id v17 = objc_alloc(MEMORY[0x263F82AA0]);
    uint64_t v18 = (void *)[objc_alloc(MEMORY[0x263F829B8]) initWithRootViewController:self->_tableViewController];
...
LABEL_7:
  ...
  {
    id v11 = [(SUUICategory *)v28 children];
    uint64_t v12 = [v11 count];

    if (v12)
    {
      id v13 = [(SUUICategoryController *)self _tableViewControllerWithCategory:v28];
      uint64_t v14 = self->_tableViewController;
      self->_tableViewController = v13;

      id v15 = self->_tableViewController;
      uint64_t v16 = [(SUUICategoryController *)self _metricsLocationsWithIndex:v4];
  ...
  if ((v27 & 1) == 0)
  {
    ...
    uint64_t v22 = [(SUUICategoryController *)self categoryTableView:0 didSelectCategory:v28];
    goto LABEL_7;
  }
LABEL_8:
  MEMORY[0x270F9A758](v22, v23);
}
...
- (id)metricsPageContextForCategoryTableView:(id)a3
{
  ...
  if (WeakRetained)
  {
    id v5 = [(SUUIClientContext *)self->_clientContext metricsPageContextForViewController:WeakRetained];
  }
  else
  {
    id v5 = 0;
...
- (id)_artworkLoader
{
  ...
  if (!artworkLoader)
  {
    uint64_t v4 = [[SUUIResourceLoader alloc] initWithClientContext:self->_clientContext];
    id v5 = [[SUUICategoryArtworkLoader alloc] initWithArtworkLoader:v4];
    char v6 = self->_artworkLoader;
    self->_artworkLoader = v5;

    id v7 = self->_artworkLoader;
    id v8 = +[SUUIStyledImageDataConsumer categoryIconConsumer];
...
- (id)_metricsLocationsWithIndex:(int64_t)a3
{
  ...
  id v4 = objc_alloc_init(MEMORY[0x263F7B250]);
  [v4 setLocationPosition:a3];
  [v4 setLocationType:*MEMORY[0x263F7BBC0]];
  id v5 = objc_alloc_init(MEMORY[0x263F7B250]);
  [v5 setLocationPosition:0];
  [v5 setLocationType:@"topNav"];
  v8[0] = v4;
  v8[1] = v5;
  char v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v8 count:2];
...
- (void)_reloadSegmentedControl
{
  if (self->_segmentedControl)
  {
    ...
    id v4 = [(SUUICategory *)self->_rootCategory children];
    id v5 = [v4 objectEnumerator];

    char v6 = [(SUUICategory *)self->_rootCategory parentLabel];
...
LABEL_10:
    ...
    uint64_t v12 = [(SUUISegmentedControl *)self->_segmentedControl selectedSegmentIndex];
...
void __49__SUUICategoryController__reloadSegmentedControl__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      uint64_t v6 = +[SUUIClientContext localizedStringForKey:@"CATEGORIES_MORE_SEGMENT" inBundles:0];
      }
    }
  }
  id v8 = (void *)v6;
...
- (void)_precacheArtworkForCategory:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [(SUUICategoryController *)self _artworkLoader];
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SUUICategoryController *)self _precacheArtworkForCategory:*(void *)(*((void *)&v11 + 1) + 8 * v10++)];
      }
      while (v8 != v10);
...
- (void)_recordClickEventWithCategory:(id)a3 index:(int64_t)a4
{
  ...
  if (WeakRetained)
  {
    uint64_t v8 = [(SUUIClientContext *)self->_clientContext metricsPageContextForViewController:WeakRetained];
  }
  else
  {
    uint64_t v8 = 0;
...
void __62__SUUICategoryController__recordClickEventWithCategory_index___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ([v3 canRecordEventWithType:*MEMORY[0x263F7BB50]])
  {
    ...
    [v4 setActionType:*MEMORY[0x263F7BB30]];
    ...
    uint64_t v6 = *MEMORY[0x263F7BBC0];
    [v4 setTargetType:*MEMORY[0x263F7BBC0]];
...
- (void)_reloadSelectedSegment
{
  ...
  selectedURL = self->_selectedURL;
  id v4 = [(SUUICategory *)self->_rootCategory URL];
  ...
  else
  {
    ...
    if ((v5 & 1) == 0)
    {
      uint64_t v7 = [(SUUICategory *)self->_rootCategory children];
      if ([v7 count])
      {
        uint64_t v8 = 0;
        while (1)
...
- (id)_rootMetricsLocations
{
  id v2 = objc_alloc_init(MEMORY[0x263F7B250]);
  [v2 setLocationPosition:0];
  [v2 setLocationType:@"topNav"];
  id v3 = [MEMORY[0x263EFF980] arrayWithObject:v2];
...
- (void)_setResponse:(id)a3 error:(id)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    uint64_t v6 = [[SUUICategory alloc] initWithCategoryDictionary:v8];
    rootCategory = self->_rootCategory;
...
- (id)_tableViewControllerWithCategory:(id)a3
{
  id v4 = (SUUICategory *)a3;
  char v5 = objc_alloc_init(SUUICategoryTableViewController);
  uint64_t v6 = [(SUUICategoryController *)self _artworkLoader];
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (SUUICategoryControllerDelegate *)WeakRetained;
}
