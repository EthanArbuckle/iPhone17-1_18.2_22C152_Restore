@interface SUUIClientContextPreviewContainer
...
- (void)previewDocument:(id)a3 :(id)a4
{
  ...
  if (v6 && self->_previewContainerViewController)
  {
    ...
    if ([MEMORY[0x263F4B3D8] instancesRespondToSelector:sel_initWithAppContext_document_owner_])id v9 = objc_msgSend(objc_alloc(MEMORY[0x263F4B3D8]), "initWithAppContext:document:owner:", v8, v6, self); {
    else
    }
      id v9 = 0;
...
void __54__SUUIClientContextPreviewContainer_previewDocument::__block_invoke(void *a1)
{
  if (*(void *)(a1[4] + 32))
  {
    ...
    id v6 = [(SUUIDocumentContainerViewController *)v2 initWithDocument:v4 options:v3 clientContext:WeakRetained];
