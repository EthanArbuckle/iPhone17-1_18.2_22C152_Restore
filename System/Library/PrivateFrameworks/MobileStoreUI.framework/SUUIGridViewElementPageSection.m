...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  id v6 = [(SUUIGridViewElementPageSectionConfiguration *)self->_configuration backgroundColorForViewElement:v5];
  NSUInteger v7 = [(SUUIStorePageSection *)self pageComponent];
  ...
  if (v10 || [0 colorType] == 3)
  {
    ...
    {
      uint64_t v14 = [MEMORY[0x263F825C8] clearColor];
    }
    v15 = (void *)v14;
  }
  ...
  else
  {
    if (!v6)
    {
      ...
      id v6 = [(SUUIStorePageSection *)&v17 backgroundColorForIndexPath:v4];
    }
    id v6 = v6;
    v15 = v6;
  }
...
- (id)cellForIndexPath:(id)a3
{
  ...
  NSUInteger v7 = [(SUUIGridViewElementPageSectionConfiguration *)self->_configuration cellForViewElement:v6 indexPath:v5];
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      [v6 dispatchEvent:0x270509DB0 eventAttribute:0x270509DD0 canBubble:1 isCancelable:0 extraInfo:0 completionBlock:0];
    }
  }
...
- (void)collectionViewWillScrollToOffset:(CGPoint)a3 visibleRange:(SUUIIndexPathRange *)a4
{
  double y = a3.y;
  double x = a3.x;
  int64_t v8 = [(SUUIGridViewElementPageSection *)self numberOfCells];
...
{
  id v6 = a3;
  id v7 = (void (**)(id, SUUIModalSourceViewProvider *))a4;
  uint64_t v20 = 0;
  uint64_t v21 = &v20;
  ...
  if (v21[5])
  {
    uint64_t v10 = objc_alloc_init(SUUIModalSourceViewProvider);
...
void __83__SUUIGridViewElementPageSection_getModalSourceViewForViewElement_completionBlock___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
  if ([*(id *)(a1 + 32) isDescendentFromViewElement:a2])
  {
    uint64_t v7 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", a3, objc_msgSend(*(id *)(a1 + 40), "sectionIndex"));
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  long long v16 = [(SUUIStorePageSection *)self pageComponent];
  ...
  if (v11 < v17)
  {
    ...
    do
    {
      ...
      if ([(objc_class *)[(SUUIGridViewElementPageSectionConfiguration *)self->_configuration cellClassForViewElement:v19] prefetchResourcesForViewElement:v19 reason:a3 context:self->_cellLayoutContext])
      {
        ...
        {
          int64_t v20 = 10
              / [(SUUIGridViewElementPageSectionConfiguration *)self->_configuration numberOfColumns];
          if (v20 <= 1) {
            int64_t v20 = 1;
          }
        }
...
- (void)reloadVisibleCellsWithReason:(int64_t)a3
{
  ...
  cellLayoutContext = self->_cellLayoutContext;
  id v5 = objc_msgSend(NSNumber, "numberWithBool:", -[SUUIGridViewElementPageSectionConfiguration showsEditMode](self->_configuration, "showsEditMode"));
...
- (id)targetScrollingIndexPathForElementWithIndexBarEntryID:(id)a3 relativeSectionIndex:(int64_t)a4
{
  ...
  if (v8)
  {
    ...
    {
      v13 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", v12, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
    }
  }
  else
  {
...
- (void)willAppearInContext:(id)a3
{
  ...
  id v10 = objc_msgSend(NSNumber, "numberWithBool:", -[SUUIGridViewElementPageSectionConfiguration showsEditMode](self->_configuration, "showsEditMode"));
  [(SUUIViewElementLayoutContext *)v9 setAggregateValue:v10 forKey:0x2705094F0];

  [(SUUIViewElementLayoutContext *)self->_cellLayoutContext setAggregateValue:MEMORY[0x263EFFA88] forKey:0x2705026F0];
  [(SUUIViewElementLayoutContext *)self->_cellLayoutContext setAggregateValue:&unk_2705D0DA8 forKey:0x270505AD0];
  ...
  [(SUUIGridViewElementPageSection *)self _resetLayoutProperties];
  [(SUUIGridViewElementPageSection *)self _requestLayoutForCells];
  int v13 = [(SUUIStorePageSection *)self pageComponent];
  ...
  if (v16 && [v16 colorType] == 3)
  {
    ...
    double v19 = objc_msgSend(MEMORY[0x263F088C8], "indexPathForItem:inSection:", 0, -[SUUIStorePageSection sectionIndex](self, "sectionIndex"));
    v25[0] = v19;
    double v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:1];
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUIGridViewElementPageSectionConfiguration requestCellLayoutForViewElement:](self->_configuration, "requestCellLayoutForViewElement:", *(void *)(*((void *)&v8 + 1) + 8 * v7++), (void)v8);
      }
      while (v5 != v7);
