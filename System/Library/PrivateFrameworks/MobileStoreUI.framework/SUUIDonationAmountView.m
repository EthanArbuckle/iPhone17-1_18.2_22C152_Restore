@interface SUUIDonationAmountView
...
- (SUUIDonationAmountView)initWithCharity:(id)a3
{
  ...
  v6 = [(SUUIDonationAmountView *)&v60 init];
  v7 = v6;
  if (v6)
  {
    ...
    uint64_t v9 = [MEMORY[0x263F825C8] systemBackgroundColor];
    v10 = (UIScrollView *)objc_alloc_init(MEMORY[0x263F82B88]);
    ...
    [(SUUIDonationAmountView *)v7 addSubview:v7->_scrollView];
    ...
    if (v12)
    {
      ...
      v16 = [MEMORY[0x263F81708] systemFontOfSize:13.0];
    ...
    if (v19)
    {
      ...
      v23 = [MEMORY[0x263F81708] boldSystemFontOfSize:17.0];
    ...
    if (v26)
    {
      ...
      v30 = [MEMORY[0x263F81708] systemFontOfSize:13.0];
      ...
      v32 = [MEMORY[0x263F825C8] labelColor];
    ...
    if (v33)
    {
      ...
      v37 = [MEMORY[0x263F81708] systemFontOfSize:11.0];
      ...
      v39 = [MEMORY[0x263F825C8] secondaryLabelColor];
    ...
    uint64_t v41 = SUUIGiftAmountButtonsWithAmounts(v40);
...
- (void)dealloc
{
  ...
  [(SUUIDonationAmountView *)&v8 dealloc];
}
...
- (SUUIGiftAmount)selectedAmount
{
  v3 = [(SUUIGiftCharity *)self->_charity donationAmounts];
...
{
  id v15 = a3;
  id v4 = [(SUUIDonationAmountView *)self logoImage];
  ...
  if (v4 != v15)
  {
    ...
    if (v15)
    {
      ...
      uint64_t v5 = [(SUUIDonationAmountView *)self setNeedsLayout];
    }
    else
    {
...
- (void)layoutSubviews
{
  [(SUUIDonationAmountView *)self bounds];
  double v4 = v3;
  ...
  double v11 = v4 - v10;
  long long v12 = [(SUUIGiftCharity *)self->_charity logoArtwork];
  v13 = v12;
  if (v12)
  {
    double v14 = (double)[v12 height];
    id v15 = [MEMORY[0x263F82B60] mainScreen];
    [v15 scale];
  ...
  uint64_t v46 = [MEMORY[0x263F82B60] mainScreen];
  [v46 scale];
  double v48 = 1.0 / v47;
  ...
  v54 = [MEMORY[0x263F82670] currentDevice];
...
- (void)_amountButtonUpInside:(id)a3
{
  ...
  [v6 postNotificationName:@"SUUIDonationAmountViewChangedNotification" object:self];
}
...
- (void)_amountButtonUpOutside:(id)a3
{
  ...
  if (self->_selectedAmountIndex == -[NSArray indexOfObjectIdenticalTo:](self->_amountButtons, "indexOfObjectIdenticalTo:"))
  {
    ...
    [v4 postNotificationName:@"SUUIDonationAmountViewChangedNotification" object:self];
  }
}
