...
{
  v11.receiver = self;
  v11.super_class = (Class)SUUIShelfLayoutData;
  v6 = [(SUUIShelfLayoutData *)&v11 init];
  v7 = v6;
  if (v6)
  {
    ...
    v7->_numberOfRows = a3;
    v7->_rowHeights = (double *)malloc_type_malloc(8 * a3, 0x100004000313F17uLL);
  }
  return v7;
}
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SUUIShelfLayoutData;
...
uint64_t __50__SUUIShelfLayoutData_enumerateColumnsUsingBlock___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
...
- (void)reloadWithItemCount:(int64_t)a3 sizeBlock:(id)a4
{
  ...
  if (a3 >= 1)
  {
    ...
    do
    {
      id v8 = (void *)MEMORY[0x25A2A9B80](v7);
      if (self->_numberOfRows < 1)
      {
        double v12 = 0.0;
      }
...
- (double)rowHeightForIndex:(int64_t)a3
{
  ...
  {
    __n128 v7 = [MEMORY[0x263F08690] currentHandler];
    objc_msgSend(v7, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"SUUIShelfLayoutData.m", 85, @"Invalid row index: %ld", a3);
  }
