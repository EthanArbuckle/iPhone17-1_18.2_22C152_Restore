...
- (void)enumerateResourceURLReferences:(id)a3
{
  ...
  id v6 = [v5 sortedArrayUsingComparator:&stru_100041080];
...
- (id)logMessageSummaryWithFullPath:(BOOL)a3
{
  ...
  uint64_t v11 = sub_10000BE24;
  unsigned int v12 = &unk_100041038;
...
+ (BOOL)getSignatureString:(id *)a3 filenameSummary:(id *)a4 forDictionaryRepresentation:(id)a5
{
  ...
  long long v34 = 0u;
  id v11 = [v9 allKeys];
  BOOL v12 = [v11 sortedArrayUsingComparator:&stru_100040F98];
