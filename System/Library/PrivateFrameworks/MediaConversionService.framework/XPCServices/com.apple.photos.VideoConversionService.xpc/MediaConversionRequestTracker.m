...
- (void)didCompleteRequest
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_SIGNPOST_INTERVAL_END, signpostId, "com.apple.photos.mediaconversion.service.processing", (const char *)&unk_10003D619, buf, 2u);
  }
...
- (void)didDequeueAndStartProcessingRequest
{
  ...
  {
    LOWORD(v10) = 0;
    _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_SIGNPOST_INTERVAL_END, signpostId, "com.apple.photos.mediaconversion.service.enqueue", (const char *)&unk_10003D619, (uint8_t *)&v10, 2u);
  }
...
- (unint64_t)hashForObject:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v30 = 0u;
    id v6 = [v5 allKeys];
    id v7 = [v6 sortedArrayUsingComparator:&stru_100041848];
...
- (BOOL)copyDuplicateRequestOutputFromOriginalRequestTracker:(id)a3 error:(id *)a4
{
  ...
  long long v26 = sub_100026348;
  long long v27 = sub_100026358;
  id v28 = 0;
  id v8 = +[NSFileManager defaultManager];
