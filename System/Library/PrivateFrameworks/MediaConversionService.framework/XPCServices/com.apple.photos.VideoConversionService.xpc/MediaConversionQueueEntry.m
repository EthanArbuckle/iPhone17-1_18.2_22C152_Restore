...
- (int64_t)compareProcessingOrderToEntry:(id)a3
{
  ...
  uint64_t v7 = [v6 sortedArrayUsingComparator:&stru_100041218];

  uint64_t v8 = [v5 clientRequestsSnapshot];
  char v9 = [v8 sortedArrayUsingComparator:&stru_100041218];
...
- (id)clientRequestForIdentifier:(id)a3
{
  ...
  long long v13 = sub_10000F0E8;
  long long v14 = sub_10000F0F8;
  id v15 = 0;
