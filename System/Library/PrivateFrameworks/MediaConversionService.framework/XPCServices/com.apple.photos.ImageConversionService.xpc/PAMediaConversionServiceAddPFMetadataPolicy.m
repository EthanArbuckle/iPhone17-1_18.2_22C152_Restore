...
- (id)processMetadata:(id)a3
{
  ...
  v7 = [(PAMediaConversionServiceAddPFMetadataPolicy *)self key];
  v8 = [(PAMediaConversionServiceAddPFMetadataPolicy *)self value];
  unsigned __int8 v9 = +[PFMetadataUtilities addMakerApplePropertyWithKey:v7 value:v8 toProperties:v6];
