...
+ (id)imageDataForPhotosAdjustmentsComposition:(id)a3 source:(id)a4 exporterImageOptions:(id)a5 outOutputSize:(CGSize *)a6 job:(id)a7
{
  ...
  if ([v11 mediaType] == (id)1)
  {
    ...
    *(void *)buf = 0;
    ...
    v38 = sub_10000DA34;
    id v39 = 0;
    dispatch_block_t v16 = dispatch_block_create(DISPATCH_BLOCK_ASSIGN_CURRENT, &stru_100035300);
...
LABEL_33:
        ...
        *(void *)&uint8_t buf[16] = 0x3032000000;
        ...
        v73[3] = &unk_1000352B8;
        v75 = buf;
        dispatch_block_t block = dispatch_block_create(DISPATCH_BLOCK_ASSIGN_CURRENT, &stru_100035290);
        id v74 = block;
...
LABEL_44:
            ...
            {
              *(_WORD *)v76 = 0;
              _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_SIGNPOST_INTERVAL_BEGIN, spid, "com.apple.photos.mediaconversion.service.neutrino.postprocessing", "", v76, 2u);
            }
            ...
            {
              *(_WORD *)v76 = 0;
              _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_SIGNPOST_INTERVAL_END, spid, "com.apple.photos.mediaconversion.service.neutrino.postprocessing", "", v76, 2u);
            }
...
LABEL_66:
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_SIGNPOST_INTERVAL_END, spid, "com.apple.photos.mediaconversion.service.neutrino", "", buf, 2u);
  }
...
+ (id)generatePortraitAdjustmentForURL:(id)a3 contentType:(id)a4 orientation:(unsigned int)a5 error:(id *)a6
{
  ...
  id v77 = sub_10000DA24;
  v78 = sub_10000DA34;
  id v79 = 0;
  uint64_t v68 = 0;
  id v69 = &v68;
  uint64_t v70 = 0x3032000000;
  id v71 = sub_10000DA24;
  __int16 v72 = sub_10000DA34;
  id v73 = 0;
...
+ (void)executeConversionJob:(id)a3
{
  ...
  if (!v6)
  {
    id v77 = +[NSAssertionHandler currentHandler];
    [v77 handleFailureInMethod:a2, a1, @"PAMediaConversionServiceSharedUtilitiesServiceSide.m", 1276, @"Invalid parameter not satisfying: %@", @"job.sourceResourceURLCollection" object file lineNumber description];
  }
...
LABEL_17:
        ...
        if (v18)
        {
          ...
          {
            id v79 = 0;
            id v26 = [a1 compositionForConversionJob:v5 error:&v79];
            id v27 = v79;
            if (v26)
            {
              ...
              {
                *(_WORD *)buf = 0;
                _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_SIGNPOST_INTERVAL_END, v23, "com.apple.photos.mediaconversion.service.adjusted", "", buf, 2u);
              }
          ...
          else
          {
            ...
            [v42 handleFailureInMethod:a2 object:a1 file:@"PAMediaConversionServiceSharedUtilitiesServiceSide.m" lineNumber:1347 description:@"Unknown photos adjustments rendering request"];
...
LABEL_83:
        ...
        if (v17)
        {
          ...
          uint64_t v38 = v37;
          id v39 = [v5 colorspaceMode];
          if ([v26 conformsToType:UTTypeRAWImage])
          {
            CGColorSpaceRef v40 = CGColorSpaceCreateWithName(kCGColorSpaceDisplayP3);
            ColorSpace = (CGColorSpace *)CFAutorelease(v40);
          }
          else
          {
            ColorSpace = CGImageGetColorSpace(v38);
          }
          uint64_t v45 = ColorSpace;
          if (ColorSpace)
          {
            ...
            CFTypeRef v47 = sub_10001736C(v46, v45);
          }
          else
          {
            CGColorSpaceRef v50 = CGColorSpaceCreateWithName(kCGColorSpaceSRGB);
            if (!v50)
            {
              CFTypeRef v51 = 0;
              goto LABEL_64;
            }
            CFTypeRef v47 = CFAutorelease(v50);
          }
          CFTypeRef v51 = v47;
LABEL_64:
          [v5 scaleFactor];
          id v53 = (CGImage *)objc_msgSend(a1, "newScaledImageForImageRef:scaleFactor:orientation:colorspace:", v38, objc_msgSend(v5, "orientation"), v51, v52);
          if (!v53)
          {
            if (!os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR)) {
              goto LABEL_80;
            }
            uint64_t v55 = [v5 sourceResourceURLCollection];
            id v56 = [v55 logMessageSummary];
            *(_DWORD *)buf = 138412290;
            *(void *)CFStringRef v83 = v56;
            id v57 = "Unable to create output image for %@";
            goto LABEL_86;
          }
          id v54 = v53;
          CGImageDestinationAddImage(v35, v53, (CFDictionaryRef)v13);
          CGImageRelease(v54);
LABEL_77:
          if (CGImageDestinationFinalize(v35))
          {
            id v73 = [v5 imageDestinationData];
            [v5 setDestinationData:v73];

            uint64_t v74 = [v5 imageDestinationData];
            +[PAMediaConversionServiceSharedUtilitiesServiceSide imageSizeForImageData:v74];
...
LABEL_80:
          ...
          *(_DWORD *)buf = 138412290;
          *(void *)CFStringRef v83 = v56;
          id v57 = "Unable to finalize output image for image conversion of %@";
LABEL_86:
          _os_log_error_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, v57, buf, 0xCu);
        ...
        {
          v80[0] = kCIContextCacheIntermediates;
          v80[1] = kCIContextName;
          v81[0] = &__kCFBooleanFalse;
          v81[1] = @"PAMediaConversionSeriveSharedUtilitiesServerSide-executeConversionJob";
          v80[2] = kCIContextIntermediateMemoryTarget;
          v81[2] = &off_100037478;
          id v58 = +[NSDictionary dictionaryWithObjects:v81 forKeys:v80 count:3];
          id v59 = +[CIContext contextWithOptions:v58];

          int v60 = +[NSMutableDictionary dictionary];
          [v5 scaleFactor];
          if (v61 != 1.0)
          {
            [v5 scaleFactor];
            id v62 = +[NSNumber numberWithDouble:](NSNumber, "numberWithDouble:");
            [v60 setObject:v62 forKeyedSubscript:kCIInputScaleFactorKey];
          }
          int v63 = [v5 mainSourceResourceURL];
          long long v64 = +[CIFilter filterWithImageURL:v63 options:v60];

          long long v65 = [v64 outputImage];
          CGColorSpaceRef v66 = CGColorSpaceCreateWithName(kCGColorSpaceDisplayP3);
          long long v67 = (CGColorSpace *)CFAutorelease(v66);
          [v65 extent];
          __int16 v72 = (CGImage *)objc_msgSend(v59, "createCGImage:fromRect:format:colorSpace:deferred:", v65, kCIFormatRGBA8, sub_10001736C((uint64_t)objc_msgSend(v5, "colorspaceMode"), v67), 1, v68, v69, v70, v71);
          if (v72)
          {
            [v13 setObject:&off_100037490 forKeyedSubscript:kCGImagePropertyOrientation];
            [v13 removeObjectForKey:kCGImageDestinationOptimizeColorForSharing];
            CGImageDestinationAddImage(v35, v72, (CFDictionaryRef)v13);
            CFRelease(v72);
          }
          else
          {
            if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
            {
              v78 = [v5 sourceResourceURLCollection];
              uint64_t v76 = [v78 logMessageSummary];
              *(_DWORD *)buf = 138412290;
              *(void *)CFStringRef v83 = v76;
        ...
        if (v43 != 1.0)
        {
          id v44 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v5 requestedOrCalculatedMaximumLongSideLength]);
          [v13 setObject:v44 forKeyedSubscript:kCGImageDestinationImageMaxPixelSize];
        }
        ...
        [v13 setObject:&off_1000374A8 forKeyedSubscript:kCGImageDestinationLossyCompressionQuality];
        if (v16)
        {
          if (v16 == (id)1)
          {
...
LABEL_59:
            id v48 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v5 requestedOrCalculatedMaximumLongSideLength]);
            [v13 setObject:v48 forKeyedSubscript:kCGImageDestinationImageMaxPixelSize];
          }
        }
