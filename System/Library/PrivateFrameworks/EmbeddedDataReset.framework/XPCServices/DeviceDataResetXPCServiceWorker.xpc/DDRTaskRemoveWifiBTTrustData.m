...
- (void)run
{
  ...
  unsigned int v4 = [v17 fileExistsAtPath:v3];
  ...
  unsigned int v9 = [v17 fileExistsAtPath:v8];
  ...
  unsigned int v14 = [v17 fileExistsAtPath:v13];
...
- (id)identifier
{
  return @"com.apple.devicedatareset.RemoveWifiBTTrustData";
}
