@interface PBBProtoTinkerWirelessCredentials
...
@implementation PBBProtoTinkerWirelessCredentials
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PBBProtoTinkerWirelessCredentials;
  id v4 = [(PBBProtoTinkerWirelessCredentials *)&v8 description];
  v5 = [(PBBProtoTinkerWirelessCredentials *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return PBBProtoTinkerWirelessCredentialsReadFrom(self, (uint64_t)a3);
}
...
{
  id v8 = a3;
  if ([(PBBProtoTinkerWirelessCredentials *)self serializedNetworkRecordsCount])
  {
    [v8 clearSerializedNetworkRecords];
    unint64_t v4 = [(PBBProtoTinkerWirelessCredentials *)self serializedNetworkRecordsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(PBBProtoTinkerWirelessCredentials *)self serializedNetworkRecordAtIndex:i];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PBBProtoTinkerWirelessCredentials addSerializedNetworkRecord:](self, "addSerializedNetworkRecord:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
