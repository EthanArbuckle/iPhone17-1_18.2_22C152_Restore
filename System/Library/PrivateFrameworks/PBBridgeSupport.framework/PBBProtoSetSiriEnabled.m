...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PBBProtoSetSiriEnabled;
  v4 = [(PBBProtoSetSiriEnabled *)&v8 description];
  v5 = [(PBBProtoSetSiriEnabled *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return PBBProtoSetSiriEnabledReadFrom((uint64_t)self, (uint64_t)a3);
}
