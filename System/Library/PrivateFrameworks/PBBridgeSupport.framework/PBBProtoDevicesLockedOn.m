...
- (id)description
{
  ...
  v5 = [(PBBProtoDevicesLockedOn *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [NSNumber numberWithDouble:self->_intendedFireDate];
    [v3 setObject:v4 forKey:@"intendedFireDate"];
  }
  return v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 16) & 1) != 0 && self->_intendedFireDate == *((double *)v4 + 1))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
...
- (unint64_t)hash
{
  ...
  double v4 = -intendedFireDate;
  if (intendedFireDate >= 0.0) {
    double v4 = self->_intendedFireDate;
  }
