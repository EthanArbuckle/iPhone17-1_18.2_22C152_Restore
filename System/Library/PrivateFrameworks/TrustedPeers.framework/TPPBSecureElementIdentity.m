...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[TPPBSecureElementIdentity setPeerIdentifier:](self, "setPeerIdentifier:");
    v4 = v5;
  }
  if (v4[1])
  {
    -[TPPBSecureElementIdentity setPeerData:](self, "setPeerData:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return TPPBSecureElementIdentityReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)TPPBSecureElementIdentity;
  id v4 = [(TPPBSecureElementIdentity *)&v8 description];
  id v5 = [(TPPBSecureElementIdentity *)self dictionaryRepresentation];
