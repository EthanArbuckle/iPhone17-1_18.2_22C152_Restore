...
+ (id)errorWithDomain:()UsefulConstructors code:description:underlying:
{
  ...
  [v13 setObject:v10 forKeyedSubscript:*MEMORY[0x263F08608]];
  v14 = [MEMORY[0x263F087E8] errorWithDomain:v12 code:a4 userInfo:v13];
...
+ (uint64_t)errorWithDomain:()UsefulConstructors code:description:
{
  return [MEMORY[0x263F087E8] errorWithDomain:a3 code:a4 description:a5 underlying:0];
}
