...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)TPPBDispositionDisallowedMachineID;
  char v4 = [(TPPBDispositionDisallowedMachineID *)&v8 description];
  v5 = [(TPPBDispositionDisallowedMachineID *)self dictionaryRepresentation];
