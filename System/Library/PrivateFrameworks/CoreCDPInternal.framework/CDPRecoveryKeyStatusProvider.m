...
- (CDPRecoveryKeyStatusProvider)initWithContext:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [MEMORY[0x263F34350] preflightContext:v4];
    context = v5->_context;
...
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_218640000, log, OS_LOG_TYPE_ERROR, "CDPContext cliqueConfiguration returned nil. Cannot check if RK state matches across systems.", v1, 2u);
}
