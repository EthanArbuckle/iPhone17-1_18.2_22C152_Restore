...
- (IMStewieChat)init
{
  ...
  v8 = (IMStewieChat *)objc_msgSend_initWithDaemon_(self, v6, (uint64_t)v5, v7);
...
- (void)sendQuestionnaire:(id)a3
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v8 = 0;
      _os_log_impl(&dword_1A4AF7000, v7, OS_LOG_TYPE_INFO, "Sending request to daemon to send questionnaire", v8, 2u);
    }
  }
  objc_msgSend_sendQuestionnaire_(self->_daemon, v5, (uint64_t)v4, v6);
}
...
- (void)locationUpdateDelivered:(id)a3
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v8 = 0;
      _os_log_impl(&dword_1A4AF7000, v7, OS_LOG_TYPE_INFO, "Sending a location update", v8, 2u);
    }
  }
  objc_msgSend_locationUpdateDelivered_(self->_daemon, v5, (uint64_t)v4, v6);
}
...
- (void)openStewieChatWithContext:(id)a3
{
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v8 = 0;
      _os_log_impl(&dword_1A4AF7000, v7, OS_LOG_TYPE_INFO, "Opening Stewie chat", v8, 2u);
    }
  }
  objc_msgSend_openStewieChatWithContext_(self->_daemon, v5, (uint64_t)v4, v6);
}
...
- (IMStewieChat)initWithDaemon:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)IMStewieChat;
  v5 = [(IMStewieChat *)&v13 init];
  v8 = v5;
  if (v5)
  {
...
- (void)dealloc
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)IMStewieChat;
  [(IMStewieChat *)&v12 dealloc];
}
...
- (void)setUpConnectionToDaemaon
{
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_1A4AF7000, v5, OS_LOG_TYPE_INFO, "Setting up IMAgent connect for Stewie chat", buf, 2u);
    }
  }
  ...
  v16 = objc_msgSend_stringWithFormat_(NSString, v14, @"%@-IMStewieChat", v15, v13);
