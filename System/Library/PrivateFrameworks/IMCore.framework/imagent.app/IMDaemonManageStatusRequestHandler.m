...
- (void)autoLoginActiveAccountsIfNecessary
{
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v5 = 0;
      _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEBUG, "Request to auto log in all accounts", v5, 2u);
    }
  }
...
- (void)loginAllAccounts
{
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v5 = 0;
      _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEBUG, "Request to log in all accounts", v5, 2u);
    }
  }
  v3 = +[IMDAccountController sharedAccountController];
  v4 = [v3 activeSessions];
...
- (void)logoutAllAccounts
{
  if (IMOSLoggingEnabled())
  {
    ...
    {
      *(_WORD *)v5 = 0;
      _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEBUG, "Request to log out all accounts", v5, 2u);
    }
  }
  v3 = +[IMDAccountController sharedAccountController];
  v4 = [v3 activeSessions];
