...
- (id)_initWithItem:(id)a3 parentItem:(id)a4 replyMessageGUID:(id)a5 replyIsFromMe:(BOOL)a6 text:(id)a7 index:(int64_t)a8 messagePartRange:(_NSRange)a9 transferGUID:(id)a10 chatContext:(id)a11
{
  ...
  id v17 = a5;
  v30.receiver = self;
  v30.super_class = (Class)IMReplyContextAttachmentMessagePartChatItem;
  v21 = -[IMAttachmentMessagePartChatItem _initWithItem:text:index:messagePartRange:transferGUID:chatContext:](&v30, sel__initWithItem_text_index_messagePartRange_transferGUID_chatContext_, v16, a7, a8, a9.location, a9.length, a10, a11);
  if (v21)
  {
    ...
    objc_storeStrong(v21 + 27, a4);
    *((unsigned char *)v21 + 208) = a6;
    objc_storeStrong(v21 + 28, obj);
  }
  return v21;
}
...
- (id)_initWithItem:(id)a3 parentItem:(id)a4 replyMessageGUID:(id)a5 replyIsFromMe:(BOOL)a6 text:(id)a7 index:(int64_t)a8 messagePartRange:(_NSRange)a9 transferGUID:(id)a10 chatContext:(id)a11 visibleAssociatedMessageChatItems:(id)a12
{
  ...
  id v17 = a5;
  v32.receiver = self;
  v32.super_class = (Class)IMReplyContextAttachmentMessagePartChatItem;
  v21 = -[IMAttachmentMessagePartChatItem _initWithItem:text:index:messagePartRange:transferGUID:chatContext:visibleAssociatedMessageChatItems:](&v32, sel__initWithItem_text_index_messagePartRange_transferGUID_chatContext_visibleAssociatedMessageChatItems_, v16, a7, a8, a9.location, a9.length, a10, a11, a12);
  if (v21)
  {
    v22 = objc_msgSend_guid(v16, v18, v19, v20);
    v23 = (void *)sub_1A4C4EEE8();
    ...
    objc_msgSend__setGUID_(v21, v24, (uint64_t)v23, v25);
    objc_storeStrong(v21 + 27, obj);
    *((unsigned char *)v21 + 208) = a6;
    objc_storeStrong(v21 + 28, v29);
  }
  return v21;
}
