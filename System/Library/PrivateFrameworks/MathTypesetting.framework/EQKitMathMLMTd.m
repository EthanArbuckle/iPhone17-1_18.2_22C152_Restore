...
- (EQKitMathMLMTd)init
{
  ...
  return [(EQKitMathMLMTd *)self initWithChildren:v3];
}

- (EQKitMathMLMTd)initWithChildren:(id)a3
{
  return [(EQKitMathMLMTd *)self initWithChildren:a3 node:0];
}
...
- (id)initFromXMLNode:(_xmlNode *)a3 parser:(id)a4
{
  ...
  return [(EQKitMathMLMTd *)self initWithChildren:v7 node:a3];
}

- (const)mathMLAttributes
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMTd mathMLAttributes]::sAttributesSet, (int *)&-[EQKitMathMLMTd mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMText mathMLAttributes]::sAttributesData);
  }
