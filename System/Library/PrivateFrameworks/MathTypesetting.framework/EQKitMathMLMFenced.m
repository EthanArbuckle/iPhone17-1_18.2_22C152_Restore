...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMFenced mathMLAttributes]::sAttributesSet, -[EQKitMathMLMFenced mathMLAttributes]::sAttributesData, -[EQKitMathMLMFraction mathMLAttributes]::sAttributesData);
  }
