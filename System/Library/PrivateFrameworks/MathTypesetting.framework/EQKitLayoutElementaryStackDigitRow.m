  ...
  if (a4)
  {
    ...
    if (v8 != 0.0)
    {
      ...
      if (v9 != 0.0)
      {
        ...
        [(EQKitOverlayBox *)v5 height];
        double v14 = v13;
        uint64_t v15 = *(void *)(EQKitLayoutManager::layoutContext((EQKitLayoutManager *)a5) + 112);
        unint64_t v16 = EQKitLayoutManager::layoutContext((EQKitLayoutManager *)a5);
        unint64_t v18 = v16;
        uint64_t v19 = *(void *)(v16 + 88);
        if (*(unsigned char *)(v16 + 120)) {
          v17.n128_u64[0] = *(void *)(v16 + 128);
        }
        else {
          v17.n128_f64[0] = EQKitLayoutContext::pComputeRuleThickness((EQKitLayoutContext *)v16);
        }
        v20 = [(EQKitPathBox *)v12 initWithCGPath:PathForNotation height:v15 cgColor:2 drawingMode:v14 lineWidth:(*(double (**)(uint64_t, uint64_t, unint64_t, __n128))(*(void *)v19 + 56))(v19, 23, v18 + 8, v17)];
