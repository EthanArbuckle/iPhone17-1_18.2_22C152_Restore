...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMTable mathMLAttributes]::sAttributesSet, -[EQKitMathMLMTable mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMTr mathMLAttributes]::sAttributesData);
  }
