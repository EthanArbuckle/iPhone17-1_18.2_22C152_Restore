...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMStackCarry mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStackCarry mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesData);
  }
