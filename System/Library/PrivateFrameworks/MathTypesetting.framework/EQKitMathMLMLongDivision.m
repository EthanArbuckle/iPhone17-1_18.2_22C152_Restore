...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMLongDivision mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMLongDivision mathMLAttributes]::sAttributesData, -[EQKitMathMLMOperator mathMLAttributes]::sAttributesData);
  }
