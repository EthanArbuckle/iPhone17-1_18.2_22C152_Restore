...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMStackRow mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStackRow mathMLAttributes]::sAttributesData, -[EQKitMathMLMStyle mathMLAttributes]::sAttributesDataInherited);
  }
