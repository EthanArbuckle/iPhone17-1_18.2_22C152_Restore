...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne180100]<EQKitTypes::Attributes::Enum const*>((uint64_t)&-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesSet, (int *)&-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesData, (int *)&-[EQKitMathMLMStackLine mathMLAttributes]::sAttributesData);
  }
