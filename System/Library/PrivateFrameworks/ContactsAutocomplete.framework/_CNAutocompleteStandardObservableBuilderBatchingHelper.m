...
{
  id v4 = a3;
  id v5 = [(_CNAutocompleteStandardObservableBuilderBatchingHelper *)self helper];
...
- (void)addCachedCalendarServerObservable:(id)a3
{
  ...
  {
    *(_WORD *)id v4 = 0;
    _os_log_impl(&dword_1BEF57000, v3, OS_LOG_TYPE_DEFAULT, "Not adding a cached calendar observable; use the calendar search type",
      v4,
      2u);
  }
}
...
- (void)addCalendarServerObservable:(id)a3
{
  ...
  {
    *(_WORD *)id v4 = 0;
    _os_log_impl(&dword_1BEF57000, v3, OS_LOG_TYPE_DEFAULT, "Not adding a calendar observable; use the calendar search type",
      v4,
      2u);
  }
}
