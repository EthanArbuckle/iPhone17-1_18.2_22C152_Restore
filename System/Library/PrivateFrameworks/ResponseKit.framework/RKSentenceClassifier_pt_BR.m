...
- (id)alternativeConjunctions
{
  return &unk_26C8EC350;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_pt_BR;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_pt_BR;
...
{
  v8.receiver = self;
  v8.super_class = (Class)RKSentenceClassifier_pt_BR;
