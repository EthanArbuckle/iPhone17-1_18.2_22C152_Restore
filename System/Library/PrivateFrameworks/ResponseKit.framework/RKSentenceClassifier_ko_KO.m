...
- (id)alternativeConjunctions
{
  return &unk_26C8EA328;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_ko_KO;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_ko_KO;
...
{
  v8.receiver = self;
  v8.super_class = (Class)RKSentenceClassifier_ko_KO;
