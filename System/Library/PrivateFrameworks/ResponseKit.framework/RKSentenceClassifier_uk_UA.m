...
@implementation RKSentenceClassifier_uk_UA

- (id)alternativeConjunctions
{
  return &unk_26C8EC200;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_uk_UA;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_uk_UA;
...
{
  v8.receiver = self;
  v8.super_class = (Class)RKSentenceClassifier_uk_UA;
  ...
  if (![v3 sentenceType])
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __46__RKSentenceClassifier_uk_UA_classifySentence__block_invoke;
    v6[3] = &unk_2642D1DD8;
    id v7 = v3;
