...
- (id)alternativeConjunctions
{
  return &unk_26C8EC488;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_it_IT;
...
- (id)lexicalEntitiesFromString:(id)a3
{
  ...
  objc_super v6 = [v5 stringByReplacingOccurrencesOfString:@"cos'è" withString:@"cosa è"];
  ...
  v11.receiver = self;
  v11.super_class = (Class)RKSentenceClassifier_it_IT;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_it_IT;
...
{
  v12.receiver = self;
  v12.super_class = (Class)RKSentenceClassifier_it_IT;
  ...
  {
    v5 = [MEMORY[0x263F08A98] predicateWithFormat:@"partOfSpeech == %@ && ((word == 'ti') || (word == 'tu'))", *MEMORY[0x263F08298]];
