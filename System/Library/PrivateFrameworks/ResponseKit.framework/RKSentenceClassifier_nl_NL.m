...
- (id)alternativeConjunctions
{
  return &unk_26C8EC308;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_nl_NL;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_nl_NL;
...
{
  v12.receiver = self;
  v12.super_class = (Class)RKSentenceClassifier_nl_NL;
  ...
  {
    v5 = [MEMORY[0x263F08A98] predicateWithFormat:@"word == 'je'"];
