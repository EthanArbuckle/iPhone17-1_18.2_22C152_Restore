...
- (id)alternativeConjunctions
{
  return &unk_26C8EC4E8;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_sv_SE;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_sv_SE;
...
{
  v8.receiver = self;
  v8.super_class = (Class)RKSentenceClassifier_sv_SE;
