...
- (id)alternativeConjunctions
{
  return &unk_26C8EC2F0;
}

- (id)addSentenceTerminatorQuestion:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)RKSentenceClassifier_vi_VN;
...
{
  v2.receiver = self;
  v2.super_class = (Class)RKSentenceClassifier_vi_VN;
...
{
  v12.receiver = self;
  v12.super_class = (Class)RKSentenceClassifier_vi_VN;
  ...
  {
    v5 = [MEMORY[0x263F08A98] predicateWithFormat:@"word == 'bạn'"];
