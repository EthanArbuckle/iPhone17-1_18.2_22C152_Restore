  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        [*(id *)(*((void *)&v40 + 1) + 8 * i) removeObserver:self forKeyPath:@"preferredContentSize"];
      }
...
LABEL_27:
  ...
  if ((unint64_t)v15 <= a4)
  {
    ...
    [v29 handleFailureInMethod:a2, self, @"DOCAutoBarHidingTabBarController.m", 278, @"Invalid index (%@) provided", v30 object file lineNumber description];
  }
  long long v38 = 0u;
  long long v39 = 0u;
  long long v36 = 0u;
  ...
  if (v17)
  {
    ...
    do
    {
      for (j = 0; j != v18; j = (char *)j + 1)
      {
        ...
        [*(id *)(*((void *)&v36 + 1) + 8 * (void)j) addObserver:self forKeyPath:@"preferredContentSize" options:1 context:0];
      }
  ...
  id v34 = v16;
  id v26 = v24;
  [(DOCAutoBarHidingTabBarController *)self _performWhileNotingInflightSelectedViewController:v25 block:v32];
