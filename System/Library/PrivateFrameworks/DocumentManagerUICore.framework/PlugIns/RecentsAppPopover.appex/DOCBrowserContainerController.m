...
- (_TtC17RecentsAppPopover29DOCBrowserContainerController)init;
- (_TtC17RecentsAppPopover33DOCBrowserContainedViewController)contentViewController;
...
- (_TtC17RecentsAppPopover33DOCBrowserContainedViewController)contentViewController
{
  v2 = (id *)((char *)&self->super.super.super.super.isa
            + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_contentViewController);
  swift_beginAccess();
  return (_TtC17RecentsAppPopover33DOCBrowserContainedViewController *)*v2;
}
...
- (BOOL)allowsPickingMultipleItems
{
  return *((unsigned char *)&self->super.super.super.super.isa
         + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_allowsPickingMultipleItems);
}
...
{
  return *((unsigned char *)&self->super.super.super.super.isa
         + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_preventAppearanceForwarding);
}
...
- (void)setPreventAppearanceForwarding:(BOOL)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_preventAppearanceForwarding) = a3;
  if (v3 == 1 && !a3)
  {
    id v5 = self;
    sub_10036C1AC();
...
- (void)activateContentViewController
{
  uint64_t v3 = *(void *)&self->super.appearStateTracker[OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_dataSource];
...
- (void)viewDidLoad
{
  ...
  uint64_t v3 = *(void *)&v2[OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_dataSource + 8];
  uint64_t ObjectType = swift_getObjectType();
  if (((*(uint64_t (**)(uint64_t, uint64_t))(v3 + 40))(ObjectType, v3) & 1) == 0)
  {
    sub_100369B20();
    if (*(void *)&v2[OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_state] == 5) {
      sub_100369C90(0, 0, 0);
    }
  }
}
...
- (void)setEditing:(BOOL)a3 animated:(BOOL)a4
{
  ...
  v7 = (id *)&v6[OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_contentViewController];
  swift_beginAccess();
...
- (_TtC17RecentsAppPopover29DOCBrowserContainerController)init
{
  result = (_TtC17RecentsAppPopover29DOCBrowserContainerController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_unknownObjectWeakDestroy();
  sub_10036F820(*(unint64_t *)((char *)&self->super.super.super.super.isa
                                    + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_state));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_queue));
  sub_100035EB4(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_stateReporting));
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_actionReporting);
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController_overlayDelegate);
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  uint64_t v3 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC17RecentsAppPopover29DOCBrowserContainerController__containerNavigationItem);
}
...
- (void)revealWithItems:(id)a3 selectEvenIfVisible:(BOOL)a4 completionBlock:(id)a5
{
  ...
  *(void *)(v9 + 16) = v7;
  id v10 = self;
  DOCBrowserContainerController.reveal(items:selectEvenIfVisible:completionBlock:)(v8, a4, (uint64_t)sub_100370178, v9);
