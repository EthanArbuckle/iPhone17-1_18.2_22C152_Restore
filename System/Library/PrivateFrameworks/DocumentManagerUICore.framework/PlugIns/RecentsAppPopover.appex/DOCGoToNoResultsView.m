...
- (_TtC17RecentsAppPopoverP33_3359B5A0BE6F8B7B2BB047FB348B6B4B20DOCGoToNoResultsView)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopoverP33_3359B5A0BE6F8B7B2BB047FB348B6B4B20DOCGoToNoResultsView)initWithFrame:(CGRect)a3;
- (_TtC17RecentsAppPopoverP33_3359B5A0BE6F8B7B2BB047FB348B6B4B20DOCGoToNoResultsView)initWithFrame:(CGRect)a3 title:(id)a4 style:(unint64_t)a5;
- (_TtC17RecentsAppPopoverP33_3359B5A0BE6F8B7B2BB047FB348B6B4B20DOCGoToNoResultsView)initWithFrame:(CGRect)a3 title:(id)a4 style:(unint64_t)a5 includeBackdrop:(BOOL)a6;
- (double)_labelAlpha;
@end
