...
- (_TtC17RecentsAppPopover24DOCServiceViewController)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopover24DOCServiceViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (DOCConfiguration)configuration
{
  result = *(Class *)((char *)&self->super.super.super.isa
                    + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController__configuration);
  if (result) {
    return result;
  }
  __break(1u);
...
- (BOOL)isBrowserViewController
{
  return *((unsigned char *)&self->super.super.super.isa
         + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController_isBrowserViewController);
}

- (void)setIsBrowserViewController:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController_isBrowserViewController) = a3;
}

- (BOOL)shouldOverrideWindowAppearance
{
  return *((unsigned char *)&self->super.super.super.isa
         + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController_shouldOverrideWindowAppearance);
}

- (void)setShouldOverrideWindowAppearance:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController_shouldOverrideWindowAppearance) = a3;
}
...
- (_TtC17RecentsAppPopover24DOCServiceViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC17RecentsAppPopover24DOCServiceViewController *)sub_1000D6530(v5, v7, a4);
}

- (_TtC17RecentsAppPopover24DOCServiceViewController)initWithCoder:(id)a3
{
  return (_TtC17RecentsAppPopover24DOCServiceViewController *)sub_1000D66DC(a3);
}
...
- (void)viewDidMoveToWindow:(id)a3 shouldAppearOrDisappear:(BOOL)a4
{
  ...
  if (a3)
  {
    if ((*((unsigned char *)&self->super.super.super.isa
          + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController_shouldOverrideWindowAppearance) & 1) != 0)
    {
      uint64_t v7 = *(uint64_t *)((char *)&self->super.super.super.isa
                      + OBJC_IVAR____TtC17RecentsAppPopover24DOCServiceViewController_lastAppearance);
      id v8 = self;
      [a3 setAppearance:v7];
    }
    else
...
- (void)updateAppearance:(id)a3 completionBlock:(id)a4
{
  objc_super v6 = (uint64_t (*)())_Block_copy(a4);
  if (v6)
  {
    uint64_t v7 = swift_allocObject();
    *(void *)(v7 + 16) = v6;
    objc_super v6 = sub_1000A6A30;
  }
  else
  {
    uint64_t v7 = 0;
...
- (NSArray)preferredFocusEnvironments
{
  ...
  if (Strong)
  {
    ...
    *(_OWORD *)(v5 + 16) = xmmword_1004D67A0;
    *(void *)(v5 + 32) = v4;
    sub_1004BEE00();
  }
  else
  ...
  sub_100031860((uint64_t *)&unk_10061B430);
  v8.super.isa = sub_1004BEDC0().super.isa;
