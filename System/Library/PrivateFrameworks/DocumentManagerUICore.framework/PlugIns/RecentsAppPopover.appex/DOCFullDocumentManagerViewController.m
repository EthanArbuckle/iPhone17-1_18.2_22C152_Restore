...
- (_TtC17RecentsAppPopover16DOCActionManager)actionManager;
- (_TtC17RecentsAppPopover16DOCPickerContext)pickerContext;
- (_TtC17RecentsAppPopover18DOCDocumentManager)documentManager;
- (_TtC17RecentsAppPopover19DOCSearchController)effectiveSearchController;
- (_TtC17RecentsAppPopover21DOCFileProviderSource)currentGoToFileProviderSource;
- (_TtC17RecentsAppPopover21DOCPickerFilenameView)pickerFilenameView;
- (_TtC17RecentsAppPopover22DOCHierarchyController)hierarchyController;
- (_TtC17RecentsAppPopover22DOCLocationChangePacer)locationChangePacer;
- (_TtC17RecentsAppPopover22DOCSourceOrderObserver)sourceOrderObserver;
- (_TtC17RecentsAppPopover25DOCItemCollectionViewPool)itemCollectionViewPool;
- (_TtC17RecentsAppPopover27DOCDisplayModeChangeHandler)displayModeHandler;
- (_TtC17RecentsAppPopover29DOCBrowserContainerController)effectiveBrowserViewController;
- (_TtC17RecentsAppPopover30DOCBrowserNavigationDataSource)dataSource;
...
- (void)preloadLaunchServiceDatabase
{
  if (qword_10062BDF0 != -1) {
    dispatch_once(&qword_10062BDF0, &stru_1005A38D8);
  }
}
...
- (void)doc_commonInitWithSourceObserver:(id)a3
{
  ...
  v9 = objc_alloc_init(_TtC17RecentsAppPopover27DOCDisplayModeChangeHandler);
  displayModeHandler = self->_displayModeHandler;
  self->_displayModeHandler = v9;

  objc_storeWeak((id *)&self->_sourceObserver, v4);
  v11 = [_TtC17RecentsAppPopover25DOCItemCollectionViewPool alloc];
  ...
  v15 = [_TtC17RecentsAppPopover42DOCFullDocumentManagerNavigationController alloc];
  ...
  v19 = [_TtC17RecentsAppPopover22DOCHierarchyController alloc];
  ...
  [(DOCHierarchyController *)self->_hierarchyController addObserver:self forKeyPath:@"lastLocation" options:1 context:off_1006156E8];
  [(DOCHierarchyController *)self->_hierarchyController addObserver:self forKeyPath:@"effectiveRootLocation" options:1 context:off_1006156E8];
  [(DOCHierarchyController *)self->_hierarchyController addObserver:self forKeyPath:@"locations" options:1 context:off_1006156E8];
  v22 = docUILogHandle;
  if (!docUILogHandle)
  {
    DOCInitLogging();
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG)) {
    sub_1004BB114(self, v22);
  }
  v23 = [_TtC17RecentsAppPopover18DOCDocumentManager alloc];
  ...
  v27 = [_TtC17RecentsAppPopover22DOCLocationChangePacer alloc];
  ...
  v31 = [_TtC17RecentsAppPopover30DOCBrowserNavigationDataSource alloc];
...
LABEL_9:
  ...
  return (_TtC17RecentsAppPopover29DOCBrowserContainerController *)v12;
}
...
LABEL_11:
  ...
  return (_TtC17RecentsAppPopover19DOCSearchController *)v8;
}
...
- (void)beginForcedNavigationTransitionChromeIfNeeded:(id)a3 appearingViewController:(id)a4 animated:(BOOL)a5
{
  ...
  objc_super v10 = sub_10000FF78(v8);
  uint64_t v11 = v10;
...
- (void)setPickerContext:(id)a3
{
  id v5 = (_TtC17RecentsAppPopover16DOCPickerContext *)a3;
...
- (_TtC17RecentsAppPopover22DOCHierarchyController)hierarchyController
{
  return (_TtC17RecentsAppPopover22DOCHierarchyController *)objc_getProperty(self, a2, 64, 1);
}
...
- (_TtC17RecentsAppPopover18DOCDocumentManager)documentManager
{
  return (_TtC17RecentsAppPopover18DOCDocumentManager *)objc_getProperty(self, a2, 72, 1);
}
...
- (_TtC17RecentsAppPopover16DOCActionManager)actionManager
{
  return (_TtC17RecentsAppPopover16DOCActionManager *)objc_getProperty(self, a2, 80, 1);
}
...
- (_TtC17RecentsAppPopover27DOCDisplayModeChangeHandler)displayModeHandler
{
  return (_TtC17RecentsAppPopover27DOCDisplayModeChangeHandler *)objc_getProperty(self, a2, 88, 1);
}

- (_TtC17RecentsAppPopover30DOCBrowserNavigationDataSource)dataSource
{
  return (_TtC17RecentsAppPopover30DOCBrowserNavigationDataSource *)objc_getProperty(self, a2, 96, 1);
}

- (_TtC17RecentsAppPopover25DOCItemCollectionViewPool)itemCollectionViewPool
{
  return (_TtC17RecentsAppPopover25DOCItemCollectionViewPool *)objc_getProperty(self, a2, 104, 1);
}

- (_TtC17RecentsAppPopover22DOCLocationChangePacer)locationChangePacer
{
  return (_TtC17RecentsAppPopover22DOCLocationChangePacer *)objc_getProperty(self, a2, 112, 1);
}
...
- (void)dataSource:(id)a3 didUpdate:(id)a4 animated:(BOOL)a5
{
  ...
  id v8 = (char *)sub_1004BEDE0();
  id v9 = a3;
  id v10 = self;
  sub_100218290((uint64_t)v9, v8, v5);
...
- (id)provideContainerControllerAt:(id)a3 from:(id)a4 isUserInteraction:(BOOL)a5 isBrowsingTrash:(BOOL)a6
{
  ...
  id v11 = a4;
  id v12 = self;
  id v13 = sub_10021ACDC(v10, a4, v7, v6);
...
- (void)beginLoadingAdditionalParents:(id)a3
{
  ...
  *(void *)(v8 + 16) = sub_1003DEE70;
  *(void *)(v8 + 24) = v5;
  swift_retain();
  sub_100074AF0((uint64_t)sub_100445868, v8);
...
- (unint64_t)effectiveTabSwitcherTab
{
  ...
  unint64_t v4 = (_TtC17RecentsAppPopover22DOCHierarchyController *)sub_1000743F0();
  if (v4)
  {
    id v5 = v4;
...
- (id)targetForAction:(SEL)a3 withSender:(id)a4
{
  ...
  if (v18)
  {
    uint64_t v9 = sub_100032F0C(v17, v18);
...
- (void)didPresentSearchController:(id)a3
{
  id v4 = a3;
  id v5 = self;
  sub_1004401B8((uint64_t)v4, [v4 showsSearchResultsController]);
}
...
- (BOOL)canPerformGoToEnclosingFolder
{
  ...
  uint64_t v4 = *(uint64_t *)((char *)&v3->super.isa
                  + OBJC_IVAR____TtC17RecentsAppPopover30DOCBrowserNavigationDataSource_viewStyle);
...
- (void)performViewAsUserSizeSmaller:(id)a3
{
  id v4 = a3;
  unsigned __int8 v5 = self;
  sub_1004B9DFC((unsigned int *)&enum case for DOCAdjustmentDirection.decrement(_:));
}
...
- (void)performViewAsUserSizeLarger:(id)a3
{
  id v4 = a3;
  unsigned __int8 v5 = self;
  sub_1004B9DFC((unsigned int *)&enum case for DOCAdjustmentDirection.increment(_:));
}
