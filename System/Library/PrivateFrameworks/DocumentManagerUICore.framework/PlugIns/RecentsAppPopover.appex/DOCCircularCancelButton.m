...
- (_TtC17RecentsAppPopover23DOCCircularCancelButton)initWithFrame:(CGRect)a3;
...
- (_TtC17RecentsAppPopover23DOCCircularCancelButton)initWithFrame:(CGRect)a3
{
  result = (_TtC17RecentsAppPopover23DOCCircularCancelButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
