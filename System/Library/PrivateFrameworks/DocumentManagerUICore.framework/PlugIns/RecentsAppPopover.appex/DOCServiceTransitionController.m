...
- (_TtC17RecentsAppPopover30DOCServiceTransitionController)init;
- (void)endTransition;
...
- (_TtC17RecentsAppPopover30DOCServiceTransitionController)init
{
  result = (_TtC17RecentsAppPopover30DOCServiceTransitionController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
