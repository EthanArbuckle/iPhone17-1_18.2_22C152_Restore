...
- (_TtC17RecentsAppPopover32DOCSearchControllerStackedLayout)init;
...
- (void)_searchBarWillLayoutSubviews:(id)a3 inSearchFieldContainer:(id)a4 searchTextFieldFrame:(CGRect)a5 cancelButtonFrame:(CGRect)a6
{
  ...
  id v18 = a4;
  v19 = self;
  sub_1003252E4(a3, a4, v13, v12, v11, v10, x, y, width, height);
}

- (_TtC17RecentsAppPopover32DOCSearchControllerStackedLayout)init
{
  result = (_TtC17RecentsAppPopover32DOCSearchControllerStackedLayout *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC17RecentsAppPopover32DOCSearchControllerStackedLayout_appMenuButton);
}
