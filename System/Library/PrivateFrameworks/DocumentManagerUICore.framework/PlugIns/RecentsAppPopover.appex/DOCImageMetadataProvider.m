...
+ (id)imageMetadataProviderWithNode:(id)a3 levelOfDetail:(int64_t)a4 URL:(id)a5
{
  ...
  if (qword_10062BDE8 != -1) {
    dispatch_once(&qword_10062BDE8, &stru_1005A36E8);
  }
  v9 = (void *)qword_10062BDE0;
  v10 = [v7 contentType];
  v11 = [v10 identifier];
...
- (NSDictionary)metadataValues
{
  ...
  if (levelOfDetail)
  {
    ...
    else
    {
      ...
      objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"DOCImageMetadataProvider.m", 384, @"Unhandled DOCMetadataLevelOfDetail %lu", self->_levelOfDetail);
    }
  }
  else
  {
