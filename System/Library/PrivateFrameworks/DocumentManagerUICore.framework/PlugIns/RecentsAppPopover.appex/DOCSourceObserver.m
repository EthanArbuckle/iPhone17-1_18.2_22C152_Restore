...
- (_TtC17RecentsAppPopover16DOCActionManager)sourcesActionManager;
...
- (DOCSourceObserver)initWithUserAction:(unint64_t)a3 hostIdentifier:(id)a4
{
  ...
  if (v7)
  {
    ...
    v16 = objc_alloc_init(_TtC17RecentsAppPopover16DOCActionManager);
...
- (id)_addSubscriberForConfiguration:(id)a3 usingBlock:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100018DF8;
  block[3] = &unk_1005A3D10;
...
- (int)startObservingDefaultSaveLocation
{
  ...
  handler[2] = sub_10001A960;
  handler[3] = &unk_1005A3920;
  objc_copyWeak(&v6, &location);
