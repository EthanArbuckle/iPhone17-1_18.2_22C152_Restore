...
- (_TtC17RecentsAppPopover24DOCContentDimmingOverlay)browserOverlay;
- (_TtC17RecentsAppPopover24DOCContentDimmingOverlay)sourcesOverlay;
- (_TtC17RecentsAppPopover24DOCSidebarViewController)sidebarViewController;
...
- (DOCSplitBrowserViewController)initWithConfiguration:(id)a3 sourceObserver:(id)a4
{
  ...
  if (v9)
  {
    ...
    v26 = [[_TtC17RecentsAppPopover24DOCSidebarViewController alloc] initWithConfiguration:v25 sourceObserver:*p_sourceObserver];
    ...
    v36 = objc_alloc_init(_TtC17RecentsAppPopover34DOCSidebarPaneNavigationController);
            ...
            for (i = 0; i != v43; i = (char *)i + 1)
            {
              ...
              if (!v49)
              {
                ...
                if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR)) {
                  sub_1004BB08C((uint64_t)v46, (uint64_t)v50, v53);
                }
...
LABEL_23:
        ...
        v57 = [_TtC17RecentsAppPopover16DOCPickerContext alloc];
        v58 = v57;
        if (v54 == v56)
        {
      ...
      {
        v51 = [_TtC17RecentsAppPopover16DOCPickerContext alloc];
...
- (void)viewDidLoad
{
  ...
  [(DOCFullDocumentManagerViewController *)self->_fullDocumentManagerViewController addObserver:self forKeyPath:@"editing" options:1 context:off_1006155C0];
  [(DOCSidebarViewController *)self->_sidebarViewController addObserver:self forKeyPath:@"editing" options:1 context:off_1006155C0];
  v12 = [[_TtC17RecentsAppPopover24DOCContentDimmingOverlay alloc] initForCovering:self->_sidebarNavigationController];
  ...
  id v16 = [[_TtC17RecentsAppPopover24DOCContentDimmingOverlay alloc] initForCovering:self->_fullDocumentManagerViewController];
...
{
  id v11 = a3;
  long long v12 = (_TtC17RecentsAppPopover24DOCSidebarViewController *)a4;
  if (off_1006155C0 == a6)
  {
...
LABEL_6:
  ...
  id v14 = v6;
  id v12 = v6;
  [v9 animateAlongsideTransition:&stru_1005A3778 completion:v13];
}
...
- (_TtC17RecentsAppPopover24DOCSidebarViewController)sidebarViewController
{
  return (_TtC17RecentsAppPopover24DOCSidebarViewController *)objc_getProperty(self, a2, 64, 1);
}
...
- (void)sidebarViewController:(id)a3 didSelect:(id)a4
{
  ...
  _sSo29DOCSplitBrowserViewControllerC17RecentsAppPopoverE9didSelect_2atySo19DOCConcreteLocationC_AGSgtF_0(v7);
}
...
- (void)didSelectLocation:(id)a3 atParentLocation:(id)a4
{
  ...
  id v7 = a4;
  uint64_t v8 = self;
  _sSo29DOCSplitBrowserViewControllerC17RecentsAppPopoverE9didSelect_2atySo19DOCConcreteLocationC_AGSgtF_0(v6);
}
...
- (id)targetForAction:(SEL)a3 withSender:(id)a4
{
  ...
  DOCSplitBrowserViewController.target(forAction:withSender:)((uint64_t)a3, (uint64_t)v15, (uint64_t)v16);

  sub_10003A60C((uint64_t)v15);
  uint64_t v8 = v17;
  if (v17)
  {
    id v9 = sub_100032F0C(v16, v17);
    uint64_t v10 = *(void *)(v8 - 8);
    __chkstk_darwin(v9);
    id v12 = (char *)v15 - ((v11 + 15) & 0xFFFFFFFFFFFFFFF0);
    (*(void (**)(char *))(v10 + 16))(v12);
    id v13 = (void *)sub_1004C0830();
    (*(void (**)(char *, uint64_t))(v10 + 8))(v12, v8);
    sub_10003D0C0((uint64_t)v16);
  }
  else
  {
    id v13 = 0;
