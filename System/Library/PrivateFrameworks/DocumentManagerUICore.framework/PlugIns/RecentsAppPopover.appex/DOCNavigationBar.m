...
- (_TtC17RecentsAppPopover16DOCNavigationBar)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopover16DOCNavigationBar)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
...
- (_TtC17RecentsAppPopover16DOCNavigationBar)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC17RecentsAppPopover16DOCNavigationBar_titlePositionAdjustment) = 0;
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover16DOCNavigationBar_chromelessAppearanceDisabled) = 0;
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC17RecentsAppPopover16DOCNavigationBar_overrideScrollEdgeAppearance) = 0;
  id v4 = a3;

  result = (_TtC17RecentsAppPopover16DOCNavigationBar *)sub_1004C0670();
  __break(1u);
  return result;
}
...
- (UINavigationBarAppearance)scrollEdgeAppearance
{
  id v3 = *(UINavigationBarAppearance **)((char *)&self->super.super.super.super.isa
                                     + OBJC_IVAR____TtC17RecentsAppPopover16DOCNavigationBar_overrideScrollEdgeAppearance);
  if (v3)
  {
    objc_super v4 = self;
    v5 = v3;
