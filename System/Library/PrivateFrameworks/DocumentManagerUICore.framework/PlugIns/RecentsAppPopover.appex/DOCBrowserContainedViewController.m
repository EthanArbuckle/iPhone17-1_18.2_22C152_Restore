...
- (_TtC17RecentsAppPopover33DOCBrowserContainedViewController)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopover33DOCBrowserContainedViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (_TtC17RecentsAppPopover18DOCDocumentManager)documentManager
{
  return (_TtC17RecentsAppPopover18DOCDocumentManager *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.super.isa
...
- (BOOL)allowsPickingMultipleItems
{
  return *((unsigned char *)&self->super.super.super.super.isa
         + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_allowsPickingMultipleItems);
}
...
- (void)setForceEditingMode:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_forceEditingMode) = a3;
  if (a3) {
...
{
  id v4 = a4;
  result = (_TtC17RecentsAppPopover33DOCBrowserContainedViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_eventReporting);
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_viewReusing);
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_actionReporting);
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_overlayDelegate);
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_documentManager));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_actionManager));
  swift_release();
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_containerNavigationItem));
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  objc_super v3 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_uipDocLandingBackground);
}
...
- (void)setEditing:(BOOL)a3 animated:(BOOL)a4
{
  ...
  sub_1000338CC(0, (unint64_t *)&unk_10061F600);
  v7 = (void *)sub_1004BF480();
  if (v7)
  {
    v8 = v7;
...
- (BOOL)hidesNavigationBackButton
{
  objc_super v3 = (char *)self + OBJC_IVAR____TtC17RecentsAppPopover33DOCBrowserContainedViewController_overlayDelegate;
