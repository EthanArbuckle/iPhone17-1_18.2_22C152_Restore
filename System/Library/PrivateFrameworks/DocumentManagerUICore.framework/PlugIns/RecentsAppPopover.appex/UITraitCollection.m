...
- (_TtC17RecentsAppPopover21DOCNavigationBarStyle)preferredNavigationBarStyle_objc;
...
- (_TtC17RecentsAppPopover21DOCNavigationBarStyle)preferredNavigationBarStyle_objc
{
  ...
  v5[OBJC_IVAR____TtC17RecentsAppPopover21DOCNavigationBarStyle_style] = v3;
  v8.receiver = v5;
  v8.super_class = v4;
  v6 = [(UITraitCollection *)&v8 init];

  return (_TtC17RecentsAppPopover21DOCNavigationBarStyle *)v6;
}
