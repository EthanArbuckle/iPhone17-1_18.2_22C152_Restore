...
- (_TtC17RecentsAppPopover21DOCItemCollectionCell)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopover21DOCItemCollectionCell)initWithFrame:(CGRect)a3;
...
- (_TtC17RecentsAppPopover21DOCItemCollectionCell)initWithFrame:(CGRect)a3
{
  ...
  v8 = (_TtC17RecentsAppPopover21DOCItemCollectionCell *)(*(uint64_t (**)(void, double, double, double, double))(ObjectType + 600))(0, x, y, width, height);
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  sub_1000338CC(0, (unint64_t *)&qword_100618FD0);
  id v7 = a3;
  id v8 = a4;
  v9 = self;
  id v10 = sub_1000CD758();
  LOBYTE(a4) = sub_1004BFEC0();

  if ((a4 & 1) != 0
    && ([v8 locationInView:v9],
        CGFloat v12 = v11,
        CGFloat v14 = v13,
        sub_1000CFCAC((uint64_t)v17),
        sub_1000319A8((uint64_t)v17, (uint64_t)&v18, &qword_10061AF70),
        (v19 & 1) == 0))
  {
    v20.double x = v12;
    v20.double y = v14;
...
- (BOOL)gestureRecognizer:(id)a3 shouldRequireFailureOfGestureRecognizer:(id)a4
{
  ...
  v9 = self;
  id v10 = sub_1000CD758();
  LOBYTE(a3) = sub_1004BFEC0();

  if (a3)
  {
    sub_1000338CC(0, &qword_10061AF80);
...
- (id)accessibilityThumbnailView
{
  return objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.super.super.super.isa
                                                 + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_thumbnailView));
}

- (BOOL)accessibilityIsRenaming
{
  return *((unsigned char *)&self->super.super.super.super.super.super.isa
         + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_isRenaming);
}

- (void).cxx_destruct
{
  sub_10003CC04((uint64_t)self + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_delegate);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_thumbnailView));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_itemStatusBadgeConstraintX));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_itemStatusBadgeConstraintY));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_itemAccessStatusBadgeConstraintX));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_itemAccessStatusBadgeConstraintY));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell____lazy_storage___itemStatusBadge));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell____lazy_storage___itemAccessStatusBadge));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell____lazy_storage___renameGestureRecognizer));
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
                     + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_cellContent));
  swift_bridgeObjectRelease();
  objc_release(*(id *)((char *)&self->super.super.super.super.super.super.isa
  ...
  id v3 = *(Class *)((char *)&self->super.super.super.super.super.super.isa
                + OBJC_IVAR____TtC17RecentsAppPopover21DOCItemCollectionCell_renameTextView);
}
