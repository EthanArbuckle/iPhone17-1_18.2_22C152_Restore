...
- (_TtC17RecentsAppPopover24DOCNamedLocationResolver)namedLocationResolver;
- (_TtC17RecentsAppPopover25DOCDefaultSourceUIManager)defaultSourceUIManager;
- (_TtC17RecentsAppPopover29DOCBrowserContainerController)effectiveBrowserViewController;
...
+ (id)globalMapTable
{
  if (qword_10062BE00 != -1) {
    dispatch_once(&qword_10062BE00, &stru_1005A3A58);
  }
  v2 = (void *)qword_10062BDF8;
  return v2;
}
...
- (void)doc_commonInit
{
  ...
  [v15 registerDefaults:&off_1005CD578];
...
- (void)_loadFullHierarchy
{
  ...
  if (*(_OWORD *)&self->_fullRecentsViewController == 0 && !self->_splitBrowserViewController)
  {
    ...
    double v29 = [_TtC17RecentsAppPopover25DOCDefaultSourceUIManager alloc];
    ...
    double v32 = [_TtC17RecentsAppPopover24DOCNamedLocationResolver alloc];
    ...
    [v68 addObserver:self forKeyPath:@"editing" options:1 context:off_100615750];

    v69 = [(DOCTabbedBrowserViewController *)self fullSharedViewController];
    [v69 addObserver:self forKeyPath:@"editing" options:1 context:off_100615750];
...
- (void)configureUIPDocumentLandingStyleIfNecessary
{
  ...
  [(DOCTabbedBrowserViewController *)self enumerateAllFullBrowserViewControllers:&stru_1005A3B38];
}
...
- (void)_updateColumnViewAvailablityFromTraitCollection:(id)a3 andSize:(CGSize)a4
{
  BOOL v5 = +[DOCColumnViewController supportsDisplayInTraitCollection:availableArea:](_TtC17RecentsAppPopover23DOCColumnViewController, "supportsDisplayInTraitCollection:availableArea:", a3, a4.width, a4.height);
...
- (_TtC17RecentsAppPopover29DOCBrowserContainerController)effectiveBrowserViewController
{
  ...
  return (_TtC17RecentsAppPopover29DOCBrowserContainerController *)v3;
}
...
LABEL_5:
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT)) {
      sub_1004BB598((uint64_t)self, a3, v12);
    }
...
- (id)forceBrowseTabDefaultsValue
{
  ...
  v3[4] = self;
  v3[5] = a2;
  if (qword_10062BE10[0] != -1) {
    dispatch_once(qword_10062BE10, v3);
  }
  return (id)qword_10062BE08;
}
...
- (_TtC17RecentsAppPopover24DOCNamedLocationResolver)namedLocationResolver
{
  return (_TtC17RecentsAppPopover24DOCNamedLocationResolver *)objc_getProperty(self, a2, 64, 1);
}
...
- (_TtC17RecentsAppPopover25DOCDefaultSourceUIManager)defaultSourceUIManager
{
  return (_TtC17RecentsAppPopover25DOCDefaultSourceUIManager *)objc_getProperty(self, a2, 96, 1);
}
...
- (void)performConnectToServer:(id)a3
{
  uint64_t v5 = sub_1004BD580();
  uint64_t v6 = *(void *)(v5 - 8);
  __chkstk_darwin(v5);
  long long v8 = (char *)&v16 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v9 = sub_1004BD5A0();
  ...
  sub_1004BD590();
  sub_1004BC690();
  objc_super v15 = (void *)sub_1004BC680();
  sub_1004BC670();
...
- (void)performGoToDownloads:(id)a3
{
  ...
  v7[2] = v5;
  long long v8 = v5;
  sub_100386E14(2, (uint64_t)sub_10010C9A4, (uint64_t)v7);
...
- (id)newViewControllersSharing:(id)a3 tabBarItems:(id)a4
{
  ...
  unint64_t v6 = sub_1004BEDE0();
  id v7 = a3;
  id v8 = self;
  sub_10011828C(v6, v7, v8);
...
- (void)presentConnectToServer:(id)a3
{
  uint64_t v5 = sub_100031860((uint64_t *)&unk_100616AB0);
  ...
  uint64_t v10 = self;
  sub_10048D5A4((uint64_t)v7);

  sub_1000516C4((uint64_t)v7, (uint64_t *)&unk_100616AB0);
}
...
- (void)actionController:(id)a3 presentError:(id)a4 completion:(id)a5
{
  ...
  id v12 = a4;
  id v10 = self;
  uint64_t v11 = (void *)sub_1004BBAA0();
