...
- (_TtC17RecentsAppPopover28DOCHorizontalBarProgressView)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopover28DOCHorizontalBarProgressView)initWithFrame:(CGRect)a3;
@end
...
- (_TtC17RecentsAppPopover28DOCHorizontalBarProgressView)initWithFrame:(CGRect)a3
{
  ...
  v7 = (char *)self + OBJC_IVAR____TtC17RecentsAppPopover28DOCHorizontalBarProgressView_changeAnimationDuration;
  *(void *)v7 = 0;
  v7[8] = 1;
  v9.receiver = self;
...
- (_TtC17RecentsAppPopover28DOCHorizontalBarProgressView)initWithCoder:(id)a3
{
  v4 = (char *)self + OBJC_IVAR____TtC17RecentsAppPopover28DOCHorizontalBarProgressView_changeAnimationDuration;
  *(void *)v4 = 0;
  v4[8] = 1;
  v6.receiver = self;
