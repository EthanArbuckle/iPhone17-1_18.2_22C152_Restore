...
- (_TtC17RecentsAppPopover21DOCBarButtonItemGroup)initWithBarButtonItems:(id)a3 representativeItem:(id)a4;
- (_TtC17RecentsAppPopover21DOCBarButtonItemGroup)initWithCoder:(id)a3;
...
- (_TtC17RecentsAppPopover21DOCBarButtonItemGroup)initWithCoder:(id)a3
{
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC17RecentsAppPopover21DOCBarButtonItemGroup_autoHideIfItemsHidden) = 1;
  *((unsigned char *)&self->super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover21DOCBarButtonItemGroup__isHiddenExternalClientSetting) = 0;
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC17RecentsAppPopover21DOCBarButtonItemGroup_itemObservances) = (Class)_swiftEmptyArrayStorage;
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC17RecentsAppPopover21DOCBarButtonItemGroup_hasVisibleItems) = 0;
  id v4 = a3;

  result = (_TtC17RecentsAppPopover21DOCBarButtonItemGroup *)sub_1004C0670();
  __break(1u);
  return result;
}
