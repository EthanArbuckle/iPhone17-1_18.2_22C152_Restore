...
- (_TtC17RecentsAppPopover24DOCSidebarCollectionView)initWithCoder:(id)a3;
- (_TtC17RecentsAppPopover24DOCSidebarCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4;
...
- (_TtC17RecentsAppPopover24DOCSidebarCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC17RecentsAppPopover24DOCSidebarCollectionView_isHandlingTouchesEndedCount) = 0;
  *((unsigned char *)&self->super.super.super.super.super.isa
  + OBJC_IVAR____TtC17RecentsAppPopover24DOCSidebarCollectionView_requireCanBecomeFocusedTrue) = 0;
  v12.receiver = self;
...
- (_TtC17RecentsAppPopover24DOCSidebarCollectionView)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC17RecentsAppPopover24DOCSidebarCollectionView *)sub_1004C0670();
  __break(1u);
  return result;
}
...
- (id)dequeueReusableCellWithReuseIdentifier:(id)a3 forIndexPath:(id)a4
{
  ...
  uint64_t v9 = sub_1004BEB10();
  uint64_t v11 = v10;
  sub_1004BBF40();
  objc_super v12 = self;
  v13 = (void *)sub_10048B410(v9, v11, (uint64_t)v8);
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  sub_10046F028();
  sub_1004BF0D0();
  uint64_t v6 = OBJC_IVAR____TtC17RecentsAppPopover24DOCSidebarCollectionView_isHandlingTouchesEndedCount;
  uint64_t v7 = *(uint64_t *)((char *)&self->super.super.super.super.super.isa
                  + OBJC_IVAR____TtC17RecentsAppPopover24DOCSidebarCollectionView_isHandlingTouchesEndedCount);
  ...
  {
    *(Class *)((char *)&self->super.super.super.super.super.isa
             + OBJC_IVAR____TtC17RecentsAppPopover24DOCSidebarCollectionView_isHandlingTouchesEndedCount) = v9;
    id v10 = a4;
    uint64_t v11 = self;
...
- (BOOL)canBecomeFocused
{
  if ((*((unsigned char *)&self->super.super.super.super.super.isa
        + OBJC_IVAR____TtC17RecentsAppPopover24DOCSidebarCollectionView_requireCanBecomeFocusedTrue) & 1) != 0)
    return 1;
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for DOCSidebarCollectionView();
