...
- (_TtC11SaveToFiles30DOCServiceTransitionController)init;
- (void)endTransition;
...
- (_TtC11SaveToFiles30DOCServiceTransitionController)init
{
  result = (_TtC11SaveToFiles30DOCServiceTransitionController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
