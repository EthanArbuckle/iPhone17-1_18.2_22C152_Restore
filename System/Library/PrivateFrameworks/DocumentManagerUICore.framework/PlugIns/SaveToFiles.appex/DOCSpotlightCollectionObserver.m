...
- (_TtC11SaveToFiles30DOCSpotlightCollectionObserver)init;
...
- (_TtC11SaveToFiles30DOCSpotlightCollectionObserver)init
{
  result = (_TtC11SaveToFiles30DOCSpotlightCollectionObserver *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC11SaveToFiles30DOCSpotlightCollectionObserver_configuration));
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC11SaveToFiles30DOCSpotlightCollectionObserver_itemCollection));
  uint64_t v3 = *(uint64_t *)((char *)&self->super.isa
                  + OBJC_IVAR____TtC11SaveToFiles30DOCSpotlightCollectionObserver_collectionUpdateBlock);
  sub_10003B980(v3);
}
