...
- (CGRect)frame;
- (NSArray)nodes;
- (_TtC11SaveToFiles18DOCInfoActionsView)initWithFrame:(CGRect)a3;
- (double)spacing;
- (void)layoutSubviews;
...
- (CGRect)bounds
{
  sub_10027C1AC(self, (uint64_t)a2, (SEL *)&selRef_bounds);
...
- (CGRect)frame
{
  sub_10027C1AC(self, (uint64_t)a2, (SEL *)&selRef_frame);
  result.size.height = v5;
  result.size.width = v4;
  result.origin.y = v3;
  result.origin.x = v2;
...
- (_TtC11SaveToFiles18DOCInfoActionsView)initWithFrame:(CGRect)a3
{
  CGRect result = (_TtC11SaveToFiles18DOCInfoActionsView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC11SaveToFiles18DOCInfoActionsView_configuration));
  sub_10003BA48((uint64_t)self + OBJC_IVAR____TtC11SaveToFiles18DOCInfoActionsView_actionDelegate);
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  swift_release();
}
