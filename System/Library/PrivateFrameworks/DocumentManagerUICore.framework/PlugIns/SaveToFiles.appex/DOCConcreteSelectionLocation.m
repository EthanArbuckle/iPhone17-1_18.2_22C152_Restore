...
- (_TtC11SaveToFiles28DOCConcreteSelectionLocation)init;
- (_TtC11SaveToFiles28DOCConcreteSelectionLocation)initWithCoder:(id)a3;
- (_TtC11SaveToFiles28DOCConcreteSelectionLocation)initWithSourceIdentifier:(id)a3 node:(id)a4;
- (_TtC11SaveToFiles28DOCConcreteSelectionLocation)initWithSourceIdentifier:(id)a3 title:(id)a4;
- (_TtC11SaveToFiles28DOCConcreteSelectionLocation)initWithTaggedItemsSourceRepresentedTag:(id)a3;
@end
...
- (_TtC11SaveToFiles28DOCConcreteSelectionLocation)initWithSourceIdentifier:(id)a3 node:(id)a4
{
  *(void *)&self->DOCConcreteLocation_opaque[OBJC_IVAR____TtC11SaveToFiles28DOCConcreteSelectionLocation_selectedNodes] = _swiftEmptyArrayStorage;
  v7.receiver = self;
