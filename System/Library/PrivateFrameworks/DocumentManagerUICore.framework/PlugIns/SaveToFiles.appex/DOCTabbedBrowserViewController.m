...
+ (id)globalMapTable
{
  if (qword_100641818 != -1) {
    dispatch_once(&qword_100641818, &stru_1005B7A48);
  }
  v2 = (void *)qword_100641810;
  return v2;
}
...
- (void)doc_commonInit
{
  ...
  [v15 registerDefaults:&off_1005E23A0];
...
- (void)_loadFullHierarchy
{
  ...
  if (*(_OWORD *)&self->_fullRecentsViewController == 0 && !self->_splitBrowserViewController)
  {
    ...
    double v29 = [_TtC11SaveToFiles25DOCDefaultSourceUIManager alloc];
    ...
    double v32 = [_TtC11SaveToFiles24DOCNamedLocationResolver alloc];
    ...
    [v68 addObserver:self forKeyPath:@"editing" options:1 context:off_10062A3A0];

    v69 = [(DOCTabbedBrowserViewController *)self fullSharedViewController];
    [v69 addObserver:self forKeyPath:@"editing" options:1 context:off_10062A3A0];
...
- (void)configureUIPDocumentLandingStyleIfNecessary
{
  ...
  [(DOCTabbedBrowserViewController *)self enumerateAllFullBrowserViewControllers:&stru_1005B7B28];
}
...
- (void)_updateColumnViewAvailablityFromTraitCollection:(id)a3 andSize:(CGSize)a4
{
  BOOL v5 = +[DOCColumnViewController supportsDisplayInTraitCollection:availableArea:](_TtC11SaveToFiles23DOCColumnViewController, "supportsDisplayInTraitCollection:availableArea:", a3, a4.width, a4.height);
...
- (_TtC11SaveToFiles29DOCBrowserContainerController)effectiveBrowserViewController
{
  ...
  return (_TtC11SaveToFiles29DOCBrowserContainerController *)v3;
}
...
LABEL_5:
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT)) {
      sub_1004CD5F8((uint64_t)self, a3, v11);
    }
...
- (id)forceBrowseTabDefaultsValue
{
  if (qword_100641828 != -1) {
    dispatch_once(&qword_100641828, &stru_1005B7CF8);
  }
  id v2 = (void *)qword_100641820;
  return v2;
}
...
- (_TtC11SaveToFiles24DOCNamedLocationResolver)namedLocationResolver
{
  return (_TtC11SaveToFiles24DOCNamedLocationResolver *)objc_getProperty(self, a2, 64, 1);
}
...
- (_TtC11SaveToFiles25DOCDefaultSourceUIManager)defaultSourceUIManager
{
  return (_TtC11SaveToFiles25DOCDefaultSourceUIManager *)objc_getProperty(self, a2, 96, 1);
}
...
- (void)presentConnectToServer:(id)a3
{
  ...
  {
    uint64_t v9 = sub_1004CE370();
    (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v9 - 8) + 56))(v7, 1, 1, v9);
  }
  uint64_t v10 = self;
  sub_100154880((uint64_t)v7);

  sub_10003D810((uint64_t)v7, &qword_10062D9F0);
}
...
- (void)actionController:(id)a3 presentError:(id)a4 completion:(id)a5
{
  ...
  id v12 = a4;
  id v10 = self;
  uint64_t v11 = (void *)sub_1004CE1B0();
...
- (void)applyBrowserStateChange:(id)a3
{
  ...
  *(void *)(v5 + 16) = self;
  *(void *)(v5 + 24) = a3;
  void v10[4] = sub_10036F140;
  void v10[5] = v5;
  v10[0] = _NSConcreteStackBlock;
  v10[1] = 1107296256;
  _OWORD v10[2] = sub_100053418;
  v10[3] = &unk_1005D5370;
...
- (id)newViewControllersSharing:(id)a3 tabBarItems:(id)a4
{
  ...
  unint64_t v6 = sub_1004D1510();
  id v7 = a3;
  id v8 = self;
  sub_100470B68(v6, v7, v8);
...
- (void)performConnectToServer:(id)a3
{
  uint64_t v5 = sub_1004CFCB0();
  uint64_t v6 = *(void *)(v5 - 8);
  __chkstk_darwin(v5);
  long long v8 = (char *)&v17 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v9 = sub_1004CFCD0();
...
- (void)performGoToDownloads:(id)a3
{
  ...
  v7[2] = v5;
  long long v8 = v5;
  sub_10023E788(2, (uint64_t)sub_1004CD31C, (uint64_t)v7);
