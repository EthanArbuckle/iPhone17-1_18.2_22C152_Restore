...
- (_TtC11SaveToFiles13DOCTabBarItem)DOCTabBarItem;
...
- (_TtC11SaveToFiles13DOCTabBarItem)DOCTabBarItem
{
  ...
  if (result)
  {
    ...
    return (_TtC11SaveToFiles13DOCTabBarItem *)v4;
  }
  else
  {
    __break(1u);
...
- (void)objc_doc_preheatForPresentingWithCompletion:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  _Block_copy(v4);
  if (v6) {
    DOCPresentationPreheatable<>.doc_preheatForPresenting(completion:)((void (*)(void))sub_100152C70, v5);
  }
  else {
    v4[2](v4);
  }
