...
- (UIImage)iconForRecents
{
  return (UIImage *)sub_10044A760((uint64_t)self, (uint64_t)a2, 0x6B636F6C63, 0xE500000000000000);
}

- (UIImage)iconForShared
{
  return (UIImage *)sub_10044A760((uint64_t)self, (uint64_t)a2, 0xD000000000000018, 0x8000000100516660);
}

- (UIImage)iconForSyncError
{
  return (UIImage *)sub_10044A760((uint64_t)self, (uint64_t)a2, 0xD00000000000002BLL, 0x800000010053EAE0);
}

- (UIImage)iconForCompletedSync
{
  return (UIImage *)sub_10044A760((uint64_t)self, (uint64_t)a2, 0xD000000000000010, 0x800000010051C4D0);
}
...
- (id)ejectIconFor:(int64_t)a3 iconColor:(id)a4
{
  ...
  id v8 = sub_10044BE40(0x69632E7463656A65, 0xEC000000656C6372, 0, 1);
