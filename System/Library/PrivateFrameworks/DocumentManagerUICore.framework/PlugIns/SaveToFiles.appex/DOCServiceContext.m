...
- (_TtC11SaveToFiles17DOCServiceContext)init;
- (_TtC11SaveToFiles17DOCServiceContext)initWithInputItems:(id)a3;
- (_TtC11SaveToFiles17DOCServiceContext)initWithInputItems:(id)a3 contextUUID:(id)a4;
- (_TtC11SaveToFiles17DOCServiceContext)initWithInputItems:(id)a3 listenerEndpoint:(id)a4 contextUUID:(id)a5;
...
+ (id)_extensionAuxiliaryHostProtocol
{
  return sub_10044C068((uint64_t)a1, (uint64_t)a2, (SEL *)&selRef_hostProtocol);
}

+ (id)_extensionAuxiliaryVendorProtocol
{
  return sub_10044C068((uint64_t)a1, (uint64_t)a2, (SEL *)&selRef_vendorProtocol);
}
...
- (void)updateAppearance:(id)a3 completionBlock:(id)a4
{
  ...
  id v8 = a3;
  v9 = self;
  sub_10044C814(v8, (uint64_t)v6, v7);
...
- (void)updateAppearance:(id)a3 shouldFlushCA:(BOOL)a4 completionBlock:(id)a5
{
  ...
  id v10 = a3;
  uint64_t v11 = self;
  sub_10044CA28(v10, a4, (uint64_t)v8, v9);
...
- (_TtC11SaveToFiles17DOCServiceContext)initWithInputItems:(id)a3 contextUUID:(id)a4
{
  uint64_t v6 = sub_100026870((uint64_t *)&unk_1006331B0);
  ...
  {
    sub_1004CE520();
    uint64_t v9 = sub_1004CE540();
    (*(void (**)(char *, void, uint64_t, uint64_t))(*(void *)(v9 - 8) + 56))(v8, 0, 1, v9);
  }
  else
  {
    uint64_t v10 = sub_1004CE540();
    (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v10 - 8) + 56))(v8, 1, 1, v10);
  }
  return (_TtC11SaveToFiles17DOCServiceContext *)sub_10044CE5C((uint64_t)a3, (uint64_t)v8);
}

- (_TtC11SaveToFiles17DOCServiceContext)initWithInputItems:(id)a3 listenerEndpoint:(id)a4 contextUUID:(id)a5
{
  uint64_t v8 = sub_100026870((uint64_t *)&unk_1006331B0);
  ...
  {
    sub_1004CE520();
    uint64_t v11 = sub_1004CE540();
    (*(void (**)(char *, void, uint64_t, uint64_t))(*(void *)(v11 - 8) + 56))(v10, 0, 1, v11);
  }
  else
  {
    uint64_t v12 = sub_1004CE540();
    (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v12 - 8) + 56))(v10, 1, 1, v12);
  }
  id v13 = a4;
  return (_TtC11SaveToFiles17DOCServiceContext *)sub_10044D118((uint64_t)a3, a4, (uint64_t)v10);
}
