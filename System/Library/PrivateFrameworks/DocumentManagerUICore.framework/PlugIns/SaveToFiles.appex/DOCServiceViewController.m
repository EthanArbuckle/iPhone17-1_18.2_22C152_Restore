...
- (_TtC11SaveToFiles24DOCServiceViewController)initWithCoder:(id)a3;
- (_TtC11SaveToFiles24DOCServiceViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (DOCConfiguration)configuration
{
  result = *(Class *)((char *)&self->super.super.super.isa
                    + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController__configuration);
  if (result) {
    return result;
  }
  __break(1u);
...
- (BOOL)isBrowserViewController
{
  return *((unsigned char *)&self->super.super.super.isa
         + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController_isBrowserViewController);
}

- (void)setIsBrowserViewController:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.isa
  + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController_isBrowserViewController) = a3;
}

- (BOOL)shouldOverrideWindowAppearance
{
  return *((unsigned char *)&self->super.super.super.isa
         + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController_shouldOverrideWindowAppearance);
}

- (void)setShouldOverrideWindowAppearance:(BOOL)a3
{
  *((unsigned char *)&self->super.super.super.isa
  + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController_shouldOverrideWindowAppearance) = a3;
}
...
- (_TtC11SaveToFiles24DOCServiceViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC11SaveToFiles24DOCServiceViewController *)sub_10044D57C(v5, v7, a4);
}

- (_TtC11SaveToFiles24DOCServiceViewController)initWithCoder:(id)a3
{
  return (_TtC11SaveToFiles24DOCServiceViewController *)sub_10044D728(a3);
}
...
- (void)viewDidMoveToWindow:(id)a3 shouldAppearOrDisappear:(BOOL)a4
{
  ...
  if (a3)
  {
    if ((*((unsigned char *)&self->super.super.super.isa
          + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController_shouldOverrideWindowAppearance) & 1) != 0)
    {
      uint64_t v7 = *(uint64_t *)((char *)&self->super.super.super.isa
                      + OBJC_IVAR____TtC11SaveToFiles24DOCServiceViewController_lastAppearance);
      id v8 = self;
      [a3 setAppearance:v7];
    }
    else
...
- (void)updateAppearance:(id)a3 completionBlock:(id)a4
{
  ...
  *(unsigned char *)(v8 + 48) = 0;
  ...
  id v11 = self;
  id v12 = v10;
  sub_100036330((uint64_t)v6);
  swift_release();
  DOCRunInMainThread();
  _Block_release(v9);
  sub_10003B980((uint64_t)v6);
}
...
- (NSArray)preferredFocusEnvironments
{
  ...
  if (Strong)
  {
    ...
    *(_OWORD *)(v5 + 16) = xmmword_1004E9810;
    *(void *)(v5 + 32) = v4;
    sub_1004D1530();
  }
  else
  ...
  sub_100026870(&qword_10062F1D0);
  v8.super.isa = sub_1004D14F0().super.isa;
