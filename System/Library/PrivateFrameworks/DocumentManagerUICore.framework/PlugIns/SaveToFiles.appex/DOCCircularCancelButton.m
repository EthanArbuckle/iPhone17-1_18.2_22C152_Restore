...
- (_TtC11SaveToFiles23DOCCircularCancelButton)initWithFrame:(CGRect)a3;
...
- (_TtC11SaveToFiles23DOCCircularCancelButton)initWithFrame:(CGRect)a3
{
  result = (_TtC11SaveToFiles23DOCCircularCancelButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
