...
- (_TtC11SaveToFiles21DOCBarButtonItemGroup)initWithBarButtonItems:(id)a3 representativeItem:(id)a4;
- (_TtC11SaveToFiles21DOCBarButtonItemGroup)initWithCoder:(id)a3;
...
- (_TtC11SaveToFiles21DOCBarButtonItemGroup)initWithCoder:(id)a3
{
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC11SaveToFiles21DOCBarButtonItemGroup_autoHideIfItemsHidden) = 1;
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC11SaveToFiles21DOCBarButtonItemGroup__isHiddenExternalClientSetting) = 0;
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC11SaveToFiles21DOCBarButtonItemGroup_itemObservances) = (Class)_swiftEmptyArrayStorage;
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC11SaveToFiles21DOCBarButtonItemGroup_hasVisibleItems) = 0;
  id v4 = a3;

  result = (_TtC11SaveToFiles21DOCBarButtonItemGroup *)sub_1004D2DC0();
  __break(1u);
  return result;
}
