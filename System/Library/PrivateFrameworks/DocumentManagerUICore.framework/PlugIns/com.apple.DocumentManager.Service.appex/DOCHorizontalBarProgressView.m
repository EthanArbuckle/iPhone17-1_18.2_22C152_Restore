...
- (_TtC33com_apple_DocumentManager_Service28DOCHorizontalBarProgressView)initWithCoder:(id)a3;
- (_TtC33com_apple_DocumentManager_Service28DOCHorizontalBarProgressView)initWithFrame:(CGRect)a3;
@end
...
- (_TtC33com_apple_DocumentManager_Service28DOCHorizontalBarProgressView)initWithFrame:(CGRect)a3
{
  ...
  v7 = (char *)self
     + OBJC_IVAR____TtC33com_apple_DocumentManager_Service28DOCHorizontalBarProgressView_changeAnimationDuration;
  *(void *)v7 = 0;
  v7[8] = 1;
  v9.receiver = self;
