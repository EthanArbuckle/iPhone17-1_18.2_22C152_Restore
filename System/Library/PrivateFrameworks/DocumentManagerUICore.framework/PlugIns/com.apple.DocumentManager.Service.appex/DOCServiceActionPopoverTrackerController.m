...
- (_TtC33com_apple_DocumentManager_Service40DOCServiceActionPopoverTrackerController)init;
...
- (_TtC33com_apple_DocumentManager_Service40DOCServiceActionPopoverTrackerController)init
{
  result = (_TtC33com_apple_DocumentManager_Service40DOCServiceActionPopoverTrackerController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC33com_apple_DocumentManager_Service40DOCServiceActionPopoverTrackerController_action);
}
