...
- (_TtC33com_apple_DocumentManager_Service21DOCNavigationBarStyle)preferredNavigationBarStyle_objc;
...
- (_TtC33com_apple_DocumentManager_Service21DOCNavigationBarStyle)preferredNavigationBarStyle_objc
{
  ...
  v5[OBJC_IVAR____TtC33com_apple_DocumentManager_Service21DOCNavigationBarStyle_style] = v3;
  v8.receiver = v5;
  v8.super_class = v4;
  v6 = [(UITraitCollection *)&v8 init];

  return (_TtC33com_apple_DocumentManager_Service21DOCNavigationBarStyle *)v6;
}
