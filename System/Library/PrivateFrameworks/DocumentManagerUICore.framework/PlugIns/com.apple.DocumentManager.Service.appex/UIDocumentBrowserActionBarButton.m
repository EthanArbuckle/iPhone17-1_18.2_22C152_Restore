...
- (_TtC33com_apple_DocumentManager_Service32UIDocumentBrowserActionBarButton)init;
- (_TtC33com_apple_DocumentManager_Service32UIDocumentBrowserActionBarButton)initWithCoder:(id)a3;
...
- (UIDocumentBrowserAction)docAction
{
  return (UIDocumentBrowserAction *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.isa
                                                                            + OBJC_IVAR____TtC33com_apple_DocumentManager_Service32UIDocumentBrowserActionBarButton_docAction));
}
...
- (void)setDocAction:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa
           + OBJC_IVAR____TtC33com_apple_DocumentManager_Service32UIDocumentBrowserActionBarButton_docAction) = (Class)a3;
  id v3 = a3;
}
...
{
  *(Class *)((char *)&self->super.super.super.isa
           + OBJC_IVAR____TtC33com_apple_DocumentManager_Service32UIDocumentBrowserActionBarButton_docAction) = 0;
  v3.receiver = self;
