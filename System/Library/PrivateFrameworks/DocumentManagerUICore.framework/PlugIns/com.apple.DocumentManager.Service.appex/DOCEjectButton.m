...
- (CGRect)frame;
- (_TtC33com_apple_DocumentManager_Service14DOCEjectButton)initWithCoder:(id)a3;
- (_TtC33com_apple_DocumentManager_Service14DOCEjectButton)initWithFrame:(CGRect)a3;
...
- (void)didMoveToWindow
{
  ...
  if (*((unsigned char *)v2 + OBJC_IVAR____TtC33com_apple_DocumentManager_Service14DOCEjectButton_iconUpdateNeeded) == 1)
  {
...
- (_TtC33com_apple_DocumentManager_Service14DOCEjectButton)initWithFrame:(CGRect)a3
{
  CGRect result = (_TtC33com_apple_DocumentManager_Service14DOCEjectButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_super v3 = (char *)self + OBJC_IVAR____TtC33com_apple_DocumentManager_Service14DOCEjectButton_buttonSize;
  uint64_t v4 = sub_1004CE830();
  (*(void (**)(char *, uint64_t))(*(void *)(v4 - 8) + 8))(v3, v4);
  id v5 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC33com_apple_DocumentManager_Service14DOCEjectButton_color);
}
