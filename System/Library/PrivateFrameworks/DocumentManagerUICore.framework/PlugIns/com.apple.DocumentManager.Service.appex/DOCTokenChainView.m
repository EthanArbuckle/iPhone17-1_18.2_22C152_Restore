...
- (_TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView)initWithCoder:(id)a3;
- (_TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView)initWithFrame:(CGRect)a3;
...
- (_TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView)initWithFrame:(CGRect)a3
{
  return (_TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView *)sub_100308B38(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
{
  v2 = self;
  unsigned __int8 v3 = sub_100308D68();
...
- (NSArray)keyCommands
{
  return (NSArray *)sub_10030BACC(self, (uint64_t)a2, sub_100309224);
}
...
{
  v2 = (char *)self
     + OBJC_IVAR____TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView_tokens;
  swift_beginAccess();
...
- (void).cxx_destruct
{
  sub_10003EA7C((uint64_t)self+ OBJC_IVAR____TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView_delegate);
  swift_unknownObjectWeakDestroy();
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC33com_apple_DocumentManager_ServiceP33_C9B62473443A75CECED72060B0D1A59E17DOCTokenChainView_font));
  swift_bridgeObjectRelease();
}
...
- (id)selectionRectsForRange:(id)a3
{
  sub_10003AE74(0, &qword_100638828);
