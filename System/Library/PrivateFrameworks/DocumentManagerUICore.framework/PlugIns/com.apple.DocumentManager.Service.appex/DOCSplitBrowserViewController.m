...
- (_TtC33com_apple_DocumentManager_Service24DOCContentDimmingOverlay)browserOverlay;
- (_TtC33com_apple_DocumentManager_Service24DOCContentDimmingOverlay)sourcesOverlay;
- (_TtC33com_apple_DocumentManager_Service24DOCSidebarViewController)sidebarViewController;
...
- (DOCSplitBrowserViewController)initWithConfiguration:(id)a3 sourceObserver:(id)a4
{
  ...
  if (v9)
  {
    ...
    v26 = [[_TtC33com_apple_DocumentManager_Service24DOCSidebarViewController alloc] initWithConfiguration:v25 sourceObserver:*p_sourceObserver];
    ...
    v36 = objc_alloc_init(_TtC33com_apple_DocumentManager_Service34DOCSidebarPaneNavigationController);
            ...
            for (i = 0; i != v43; i = (char *)i + 1)
            {
              ...
              if (!v49)
              {
                ...
                if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR)) {
                  sub_1004C9870((uint64_t)v46, (uint64_t)v50, v53);
                }
...
LABEL_23:
        ...
        v57 = [_TtC33com_apple_DocumentManager_Service16DOCPickerContext alloc];
        v58 = v57;
        if (v54 == v56)
        {
      ...
      {
        v51 = [_TtC33com_apple_DocumentManager_Service16DOCPickerContext alloc];
...
- (void)viewDidLoad
{
  ...
  [(DOCFullDocumentManagerViewController *)self->_fullDocumentManagerViewController addObserver:self forKeyPath:@"editing" options:1 context:off_100629EE0];
  [(DOCSidebarViewController *)self->_sidebarViewController addObserver:self forKeyPath:@"editing" options:1 context:off_100629EE0];
  v12 = [[_TtC33com_apple_DocumentManager_Service24DOCContentDimmingOverlay alloc] initForCovering:self->_sidebarNavigationController];
  ...
  id v16 = [[_TtC33com_apple_DocumentManager_Service24DOCContentDimmingOverlay alloc] initForCovering:self->_fullDocumentManagerViewController];
...
{
  id v11 = a3;
  long long v12 = (_TtC33com_apple_DocumentManager_Service24DOCSidebarViewController *)a4;
  if (off_100629EE0 == a6)
  {
    if ([v11 isEqualToString:@"editing"])
    {
      unsigned __int8 v13 = [(DOCFullDocumentManagerViewController *)self->_fullDocumentManagerViewController prefersTabBarHidden];
      ...
      unsigned int v14 = [(DOCSidebarViewController *)self->_sidebarViewController isEditing];
      if (+[UITraitCollection enclosingTabSwitcherCanBeFloating])
      {
        v15 = [(DOCSplitBrowserViewController *)self traitCollection];
        BOOL v16 = [v15 horizontalSizeClass] == (id)2;
      }
      else
      {
        BOOL v16 = 0;
      ...
      char v26 = v14;
      +[UIView doc_performAllowingAnimations:v16 block:v23];
      [(DOCSplitBrowserViewController *)self updateDisplayModeButtonVisibility];
      if (![(DOCSplitBrowserViewController *)self isCollapsed])
      {
        ...
        [v18 setEnabled:v14 ^ 1];

        objc_super v19 = [(DOCSplitBrowserViewController *)self _tapToCloseSidebarGestureRecognizer];
        [v19 setEnabled:v14 ^ 1];
        ...
        v22 = [(DOCSplitBrowserViewController *)self doc_splitViewState];
    ...
    else
    {
      ...
      [v17 handleFailureInMethod:a2, self, @"DOCSplitBrowserViewController.m", 424, @"Unhandled keyPath: %@", v11 object file lineNumber description];
    }
  }
  else
  {
    v27.receiver = self;
    v27.super_class = (Class)DOCSplitBrowserViewController;
...
LABEL_6:
  ...
  id v14 = v6;
  id v12 = v6;
  [v9 animateAlongsideTransition:&stru_1005B77D8 completion:v13];
}
...
- (void)splitViewController:(id)a3 willChangeToDisplayMode:(int64_t)a4
{
  ...
  if (a4 == 1 && (v25 & 1) == 0)
  {
    char v26 = [(DOCSplitBrowserViewController *)self sidebarViewController];
    if ([v26 isEditing]) {
      [v26 setEditing:0];
    }
  }
...
- (_TtC33com_apple_DocumentManager_Service24DOCSidebarViewController)sidebarViewController
{
  return (_TtC33com_apple_DocumentManager_Service24DOCSidebarViewController *)objc_getProperty(self, a2, 64, 1);
}
...
- (id)targetForAction:(SEL)a3 withSender:(id)a4
{
  ...
  if (v18)
  {
    ...
    objc_super v14 = (void *)sub_1004CF030();
...
- (void)sidebarViewController:(id)a3 didSelect:(id)a4
{
  ...
  _sSo29DOCSplitBrowserViewControllerC33com_apple_DocumentManager_ServiceE9didSelect_2atySo19DOCConcreteLocationC_AGSgtF_0(v7);
}
...
- (void)sidebarViewController:(id)a3 wantsToReveal:(id)a4
{
  ...
  {
    id v9 = v8;
    uint64_t v10 = [(DOCSplitBrowserViewController *)v7 fullDocumentManagerViewController];
...
- (void)importScannedDocumentAt:(id)a3 presentingController:(id)a4
{
  ...
  id v10 = a4;
  id v11 = self;
  uint64_t v12 = [(DOCSplitBrowserViewController *)v11 fullDocumentManagerViewController];
  sub_1004CA370(v13);
  id v15 = v14;
...
- (void)didSelectLocation:(id)a3 atParentLocation:(id)a4
{
  ...
  id v7 = a4;
  uint64_t v8 = self;
  _sSo29DOCSplitBrowserViewControllerC33com_apple_DocumentManager_ServiceE9didSelect_2atySo19DOCConcreteLocationC_AGSgtF_0(v6);
}
