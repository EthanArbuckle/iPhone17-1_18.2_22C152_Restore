...
- (_TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController)init;
- (_TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController)initWithConfiguration:(id)a3;
- (_TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController)initWithRootViewController:(id)a3;
...
- (_TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController)initWithConfiguration:(id)a3
{
  *((unsigned char *)&self->super.super.super.super.super.isa
  + OBJC_IVAR____TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController_chromelessAppearanceDisabled) = 1;
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController_configuration) = (Class)a3;
  v9.receiver = self;
  ...
  v6 = *(Class *)((char *)&v5->super.super.super.super.super.isa
                + OBJC_IVAR____TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController_configuration);
  v7 = v5;
...
- (BOOL)chromelessAppearanceDisabled
{
  return *((unsigned char *)&self->super.super.super.super.super.isa
         + OBJC_IVAR____TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController_chromelessAppearanceDisabled);
}
...
- (_TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController)init
{
  result = (_TtC33com_apple_DocumentManager_Service42DOCFullDocumentManagerNavigationController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
