...
- (_TtC33com_apple_DocumentManager_Service24DOCNamedLocationResolver)namedLocationResolver;
- (_TtC33com_apple_DocumentManager_Service25DOCDefaultSourceUIManager)defaultSourceUIManager;
...
+ (id)globalMapTable
{
  if (qword_100640990 != -1) {
    dispatch_once(&qword_100640990, &stru_1005B7958);
  }
  v2 = (void *)qword_100640988;
  return v2;
}
...
- (void)dealloc
{
  ...
  v10 = [(DOCTabbedBrowserViewController *)self configuration];
...
- (void)doc_commonInit
{
  ...
  [v15 registerDefaults:&off_1005E1D58];
...
- (void)_loadFullHierarchy
{
  ...
  if (*(_OWORD *)&self->_fullRecentsViewController == 0 && !self->_splitBrowserViewController)
  {
    ...
    double v29 = [_TtC33com_apple_DocumentManager_Service25DOCDefaultSourceUIManager alloc];
    ...
    double v32 = [_TtC33com_apple_DocumentManager_Service24DOCNamedLocationResolver alloc];
    ...
    [v68 addObserver:self forKeyPath:@"editing" options:1 context:off_10062A008];

    v69 = [(DOCTabbedBrowserViewController *)self fullSharedViewController];
    [v69 addObserver:self forKeyPath:@"editing" options:1 context:off_10062A008];
...
- (void)configureUIPDocumentLandingStyleIfNecessary
{
  ...
  [(DOCTabbedBrowserViewController *)self enumerateAllFullBrowserViewControllers:&stru_1005B7A10];
}
...
- (void)_updateColumnViewAvailablityFromTraitCollection:(id)a3 andSize:(CGSize)a4
{
  BOOL v5 = +[DOCColumnViewController supportsDisplayInTraitCollection:availableArea:](_TtC33com_apple_DocumentManager_Service23DOCColumnViewController, "supportsDisplayInTraitCollection:availableArea:", a3, a4.width, a4.height);
...
- (_TtC33com_apple_DocumentManager_Service29DOCBrowserContainerController)effectiveBrowserViewController
{
  ...
  return (_TtC33com_apple_DocumentManager_Service29DOCBrowserContainerController *)v3;
}
...
LABEL_5:
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT)) {
      sub_1004C99B4((uint64_t)self, a3, v12);
    }
    uint64_t v13 = +[NSAssertionHandler currentHandler];
    [v13 handleFailureInMethod:a2, self, @"DOCTabbedBrowserViewController.m", 915, @"%@ Couldn't find DOCTab (%lu) index", self, a3 object file lineNumber description];
...
- (void)switchToLocation:(id)a3
{
  ...
  {
    id v9 = v4;
    unint64_t v8 = +[NSArray arrayWithObjects:&v9 count:1];
    [(DOCTabbedBrowserViewController *)self _setLocationsInBrowseTab:v8];
  }
}
...
- (void)presentTab:(unint64_t)a3 rawTabSwitchOnly:(BOOL)a4
{
  unint64_t v8 = [(DOCTabbedBrowserViewController *)self browserContentStrategy];
  if (v8) {
    BOOL v9 = a4;
  }
  else {
  ...
  if (a3 >= 3)
  {
    double v29 = +[NSAssertionHandler currentHandler];
    [v29 handleFailureInMethod:a2 object:self file:@"DOCTabbedBrowserViewController.m" lineNumber:1012 description:@"Illegal tab"];
  }
  if ([(DOCTabbedBrowserViewController *)self shouldDeferBrowserStateChanges])
  {
    id v30 = objc_alloc_init((Class)DOCUIPBrowserState);
    [v30 setTab:a3];
    [(DOCTabbedBrowserViewController *)self updateDeferredBrowserStateChangesWith:v30];
    goto LABEL_28;
  }
  double v10 = +[DOCDeprecatedUIMenuController shared];
  [v10 hideMenu];

  id v11 = [(DOCTabbedBrowserViewController *)self splitBrowserViewController];
  id v12 = [v11 fullDocumentManagerViewController];
  [v12 setEditing:0];

  uint64_t v13 = [(DOCTabbedBrowserViewController *)self fullRecentsViewController];
  [v13 setEditing:0];

  CGRect v14 = [(DOCTabbedBrowserViewController *)self fullSharedViewController];
  [v14 setEditing:0];
  ...
  id v16 = [(DOCTabbedBrowserViewController *)self tabBarController];
  id v17 = [v16 selectedOrInflightSelectedTab];

  if (v17 != (id)v15)
  {
    unint64_t v18 = [(DOCTabbedBrowserViewController *)self tabControllerIndexForTab:v15];
    double v19 = [(DOCTabbedBrowserViewController *)self tabBarController];
    id v20 = [v19 selectedIndex];
  ...
  double v22 = [(DOCTabbedBrowserViewController *)self effectiveFullBrowserForTab:a3];
  id v23 = v22;
  id v30 = v22;
  if (!v9)
  {
    v24 = [v22 hierarchyController];
    BOOL v25 = [v24 locationForDeterminingCurrentEffectiveTab];

    if (v25)
    {
      id v26 = [v24 effectiveTabSwitcherTab];
    ...
    {
      double v27 = [(DOCTabbedBrowserViewController *)self effectiveFullBrowser];
      unsigned __int8 v28 = [v27 isViewLoaded];
...
- (void)splitViewController:(id)a3 wantsToShowTabBar:(BOOL)a4
{
  ...
  if (v6 == v7)
  {
    unint64_t v8 = [v9 fullDocumentManagerViewController];
...
- (void)revealDocumentAtURL:(id)a3 importIfNeeded:(BOOL)a4 openDocument:(BOOL)a5 revealContents:(BOOL)a6 updateLastUsedDate:(BOOL)a7 completion:(id)a8
{
  ...
  id v40 = 0;
  CGRect v14 = [v10 promisedItemResourceValuesForKeys:v13 error:&v40];
  id v15 = v40;
  ...
  id v17 = [v14 objectForKeyedSubscript:NSURLIsDirectoryKey];
...
- (id)forceBrowseTabDefaultsValue
{
  ...
  v3[4] = self;
  v3[5] = a2;
  if (qword_1006409A0[0] != -1) {
    dispatch_once(qword_1006409A0, v3);
  }
  return (id)qword_100640998;
}
  ...
  else
  {
    ...
    else
    {
      ...
      if (v8 != v19)
      {
        ...
        [v9 handleFailureInMethod:a2 object:self file:@"DOCTabbedBrowserViewController.m" lineNumber:1628 description:@"Unexpected didFinishGatheringItemsAndThumbnails callback"];
LABEL_12:

        goto LABEL_13;
      }
      unint64_t v10 = [(DOCTabbedBrowserViewController *)self effectiveTabSwitcherTab];
    }
  }
  didLoadStateByTab = self->_didLoadStateByTab;
  id v12 = +[NSNumber numberWithUnsignedInteger:v10];
  id v13 = [(NSMutableDictionary *)didLoadStateByTab objectForKeyedSubscript:v12];
  unsigned int v14 = [v13 BOOLValue];

  if ((v14 & 1) == 0)
  {
    objc_super v15 = self->_didLoadStateByTab;
    id v16 = +[NSNumber numberWithUnsignedInteger:v10];
    [(NSMutableDictionary *)v15 setObject:&__kCFBooleanTrue forKeyedSubscript:v16];
  }
  id v17 = [(DOCTabbedBrowserViewController *)self tabbedBrowserViewControllerDelegate];
  char v18 = objc_opt_respondsToSelector();

  if (v18)
  {
    uint64_t v9 = [(DOCTabbedBrowserViewController *)self tabbedBrowserViewControllerDelegate];
    [v9 tabbedBrowserViewController:self didFinishInitialLoad:v14 ^ 1 ofTab:v10];
    goto LABEL_12;
  }
LABEL_13:
}
...
- (_TtC33com_apple_DocumentManager_Service24DOCNamedLocationResolver)namedLocationResolver
{
  return (_TtC33com_apple_DocumentManager_Service24DOCNamedLocationResolver *)objc_getProperty(self, a2, 64, 1);
}
...
- (_TtC33com_apple_DocumentManager_Service25DOCDefaultSourceUIManager)defaultSourceUIManager
{
  return (_TtC33com_apple_DocumentManager_Service25DOCDefaultSourceUIManager *)objc_getProperty(self, a2, 96, 1);
}
...
- (void)performConnectToServer:(id)a3
{
  uint64_t v5 = sub_1004CBD60();
  uint64_t v6 = *(void *)(v5 - 8);
  __chkstk_darwin(v5);
  long long v8 = (char *)&v16 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v9 = sub_1004CBD80();
  ...
  sub_1004CBD70();
  sub_1004CAE60();
  objc_super v15 = (void *)sub_1004CAE50();
  sub_1004CAE40();
...
- (void)performGoToDownloads:(id)a3
{
  ...
  v7[2] = v5;
  long long v8 = v5;
  sub_1003F1F18(2, (uint64_t)sub_100155B18, (uint64_t)v7);
...
- (id)newViewControllersSharing:(id)a3 tabBarItems:(id)a4
{
  ...
  unint64_t v6 = sub_1004CD5C0();
  id v7 = a3;
  id v8 = self;
  sub_1004A4CC8(v6, v7, v8);
...
- (void)presentConnectToServer:(id)a3
{
  ...
  {
    uint64_t v9 = sub_1004CA420();
    (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v9 - 8) + 56))(v7, 1, 1, v9);
  }
  uint64_t v10 = self;
  sub_1004C0E6C((uint64_t)v7);

  sub_10003B3B8((uint64_t)v7, (uint64_t *)&unk_10062D2E0);
}
...
- (void)actionController:(id)a3 presentError:(id)a4 completion:(id)a5
{
  ...
  id v12 = a4;
  id v10 = self;
  uint64_t v11 = (void *)sub_1004CA260();
