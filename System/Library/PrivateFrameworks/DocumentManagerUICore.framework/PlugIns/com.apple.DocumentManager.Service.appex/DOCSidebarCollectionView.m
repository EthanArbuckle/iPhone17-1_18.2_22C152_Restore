...
- (_TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView)initWithCoder:(id)a3;
- (_TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4;
...
- (_TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView_isHandlingTouchesEndedCount) = 0;
  *((unsigned char *)&self->super.super.super.super.super.isa
  + OBJC_IVAR____TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView_requireCanBecomeFocusedTrue) = 0;
  v12.receiver = self;
...
- (_TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView *)sub_1004CEE70();
  __break(1u);
  return result;
}
...
- (id)dequeueReusableCellWithReuseIdentifier:(id)a3 forIndexPath:(id)a4
{
  ...
  uint64_t v9 = sub_1004CD2F0();
  uint64_t v11 = v10;
  sub_1004CA700();
  objc_super v12 = self;
  v13 = (void *)sub_10048A4A4(v9, v11, (uint64_t)v8);
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  sub_100383C48();
  sub_1004CD8E0();
  uint64_t v6 = OBJC_IVAR____TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView_isHandlingTouchesEndedCount;
  uint64_t v7 = *(uint64_t *)((char *)&self->super.super.super.super.super.isa
                  + OBJC_IVAR____TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView_isHandlingTouchesEndedCount);
  ...
  {
    *(Class *)((char *)&self->super.super.super.super.super.isa
             + OBJC_IVAR____TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView_isHandlingTouchesEndedCount) = v9;
    id v10 = a4;
    uint64_t v11 = self;
...
- (BOOL)canBecomeFocused
{
  if ((*((unsigned char *)&self->super.super.super.super.super.isa
        + OBJC_IVAR____TtC33com_apple_DocumentManager_Service24DOCSidebarCollectionView_requireCanBecomeFocusedTrue) & 1) != 0)
    return 1;
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for DOCSidebarCollectionView();
