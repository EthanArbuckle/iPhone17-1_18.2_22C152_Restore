...
- (_TtC33com_apple_DocumentManager_ServiceP33_FF8FEF0715E7699D7C3880DD173B58EB17DOCInsetTextField)initWithCoder:(id)a3;
- (_TtC33com_apple_DocumentManager_ServiceP33_FF8FEF0715E7699D7C3880DD173B58EB17DOCInsetTextField)initWithFrame:(CGRect)a3;
@end
...
- (CGRect)textRectForBounds:(CGRect)a3
{
  ...
  v7 = self;
  double v8 = sub_100384F08(x, y, width, height);
  double v10 = v9;
  double v12 = v11;
  double v14 = v13;
