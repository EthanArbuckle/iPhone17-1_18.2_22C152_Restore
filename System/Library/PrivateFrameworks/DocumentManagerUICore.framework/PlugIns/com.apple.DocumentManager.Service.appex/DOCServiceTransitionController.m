...
- (_TtC33com_apple_DocumentManager_Service30DOCServiceTransitionController)init;
- (void)endTransition;
...
- (_TtC33com_apple_DocumentManager_Service30DOCServiceTransitionController)init
{
  result = (_TtC33com_apple_DocumentManager_Service30DOCServiceTransitionController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
