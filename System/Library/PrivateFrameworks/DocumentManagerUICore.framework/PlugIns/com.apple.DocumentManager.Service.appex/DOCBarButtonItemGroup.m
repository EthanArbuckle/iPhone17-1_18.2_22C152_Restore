...
- (_TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup)initWithBarButtonItems:(id)a3 representativeItem:(id)a4;
- (_TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup)initWithCoder:(id)a3;
...
- (_TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup)initWithCoder:(id)a3
{
  *((unsigned char *)&self->super.super.isa
  + OBJC_IVAR____TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup_autoHideIfItemsHidden) = 1;
  *((unsigned char *)&self->super.super.isa
  + OBJC_IVAR____TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup__isHiddenExternalClientSetting) = 0;
  *(Class *)((char *)&self->super.super.isa
           + OBJC_IVAR____TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup_itemObservances) = (Class)_swiftEmptyArrayStorage;
  *((unsigned char *)&self->super.super.isa
  + OBJC_IVAR____TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup_hasVisibleItems) = 0;
  id v4 = a3;

  result = (_TtC33com_apple_DocumentManager_Service21DOCBarButtonItemGroup *)sub_1004CEE70();
  __break(1u);
  return result;
}
