...
- (_TtC33com_apple_DocumentManager_Service16DOCActionManager)sourcesActionManager;
...
- (DOCSourceObserver)initWithUserAction:(unint64_t)a3 hostIdentifier:(id)a4
{
  ...
  if (v7)
  {
    ...
    v16 = objc_alloc_init(_TtC33com_apple_DocumentManager_Service16DOCActionManager);
...
- (id)_addSubscriberForConfiguration:(id)a3 usingBlock:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10000B9A0;
  block[3] = &unk_1005B75E8;
...
- (void)removeSubscriberForToken:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10000BC50;
  block[3] = &unk_1005B7638;
...
- (int)startObservingDefaultSaveLocation
{
  ...
  handler[2] = sub_10000D508;
  handler[3] = &unk_1005B7430;
  objc_copyWeak(&v6, &location);
