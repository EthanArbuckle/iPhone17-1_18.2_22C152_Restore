...
- (_TtC33com_apple_DocumentManager_Service23DOCCircularCancelButton)initWithFrame:(CGRect)a3;
...
- (_TtC33com_apple_DocumentManager_Service23DOCCircularCancelButton)initWithFrame:(CGRect)a3
{
  result = (_TtC33com_apple_DocumentManager_Service23DOCCircularCancelButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
