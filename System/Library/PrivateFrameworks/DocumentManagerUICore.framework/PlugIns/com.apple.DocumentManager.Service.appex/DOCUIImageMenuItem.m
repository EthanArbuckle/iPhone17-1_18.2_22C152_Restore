...
- (_TtC33com_apple_DocumentManager_Service18DOCUIImageMenuItem)initWithCoder:(id)a3;
@end
...
- (_TtC33com_apple_DocumentManager_Service18DOCUIImageMenuItem)initWithCoder:(id)a3
{
  v5 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtC33com_apple_DocumentManager_Service18DOCUIImageMenuItem_longTitle);
