...
- (_TtC33com_apple_DocumentManager_Service13DOCTabBarItem)DOCTabBarItem;
...
- (void)objc_doc_preheatForPresentingWithCompletion:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  _Block_copy(v4);
  if (v6) {
    DOCPresentationPreheatable<>.doc_preheatForPresenting(completion:)(sub_100116D98, v5);
  }
  else {
    v4[2](v4);
  }
...
- (_TtC33com_apple_DocumentManager_Service13DOCTabBarItem)DOCTabBarItem
{
  ...
  if (result)
  {
    ...
    return (_TtC33com_apple_DocumentManager_Service13DOCTabBarItem *)v4;
  }
  else
  {
    __break(1u);
