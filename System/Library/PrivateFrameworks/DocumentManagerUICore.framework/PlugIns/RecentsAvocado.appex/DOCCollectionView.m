...
- (CGSize)contentSize;
- (_TtC14RecentsAvocado17DOCCollectionView)initWithCoder:(id)a3;
- (_TtC14RecentsAvocado17DOCCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4;
...
- (_TtC14RecentsAvocado17DOCCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
           + OBJC_IVAR____TtC14RecentsAvocado17DOCCollectionView____lazy_storage___offsetAdjustmentBehaviors) = 0;
  v10.receiver = self;
