...
- (_TtC14RecentsAvocado17DOCServiceContext)init;
- (_TtC14RecentsAvocado17DOCServiceContext)initWithInputItems:(id)a3;
- (_TtC14RecentsAvocado17DOCServiceContext)initWithInputItems:(id)a3 contextUUID:(id)a4;
- (_TtC14RecentsAvocado17DOCServiceContext)initWithInputItems:(id)a3 listenerEndpoint:(id)a4 contextUUID:(id)a5;
...
+ (id)_extensionAuxiliaryHostProtocol
{
  return sub_1000C0C90((uint64_t)a1, (uint64_t)a2, (SEL *)&selRef_hostProtocol);
}

+ (id)_extensionAuxiliaryVendorProtocol
{
  return sub_1000C0C90((uint64_t)a1, (uint64_t)a2, (SEL *)&selRef_vendorProtocol);
}
...
- (void)updateAppearance:(id)a3 completionBlock:(id)a4
{
  ...
  id v8 = a3;
  v9 = self;
  sub_1000C143C(v8, (uint64_t)v6, v7);
...
- (void)updateAppearance:(id)a3 shouldFlushCA:(BOOL)a4 completionBlock:(id)a5
{
  ...
  id v10 = a3;
  uint64_t v11 = self;
  sub_1000C1650(v10, a4, (uint64_t)v8, v9);
...
- (_TtC14RecentsAvocado17DOCServiceContext)initWithInputItems:(id)a3 contextUUID:(id)a4
{
  uint64_t v6 = sub_100031648((uint64_t *)&unk_100629AC0);
  ...
  return (_TtC14RecentsAvocado17DOCServiceContext *)sub_1000C1A84((uint64_t)a3, (uint64_t)v8);
}

- (_TtC14RecentsAvocado17DOCServiceContext)initWithInputItems:(id)a3 listenerEndpoint:(id)a4 contextUUID:(id)a5
{
  uint64_t v8 = sub_100031648((uint64_t *)&unk_100629AC0);
  ...
  id v13 = a4;
  return (_TtC14RecentsAvocado17DOCServiceContext *)sub_1000C1D40((uint64_t)a3, a4, (uint64_t)v10);
}
