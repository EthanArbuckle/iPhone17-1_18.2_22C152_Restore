...
- (CGRect)frame;
- (_TtC14RecentsAvocado14DOCEjectButton)initWithCoder:(id)a3;
- (_TtC14RecentsAvocado14DOCEjectButton)initWithFrame:(CGRect)a3;
...
- (void)didMoveToWindow
{
  ...
  if (*((unsigned char *)v2 + OBJC_IVAR____TtC14RecentsAvocado14DOCEjectButton_iconUpdateNeeded) == 1)
  {
...
- (_TtC14RecentsAvocado14DOCEjectButton)initWithFrame:(CGRect)a3
{
  CGRect result = (_TtC14RecentsAvocado14DOCEjectButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_super v3 = (char *)self + OBJC_IVAR____TtC14RecentsAvocado14DOCEjectButton_buttonSize;
  uint64_t v4 = sub_1004CF080();
  (*(void (**)(char *, uint64_t))(*(void *)(v4 - 8) + 8))(v3, v4);
  id v5 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC14RecentsAvocado14DOCEjectButton_color);
}
