...
- (_TtC14RecentsAvocado40DOCServiceActionPopoverTrackerController)init;
...
- (_TtC14RecentsAvocado40DOCServiceActionPopoverTrackerController)init
{
  result = (_TtC14RecentsAvocado40DOCServiceActionPopoverTrackerController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC14RecentsAvocado40DOCServiceActionPopoverTrackerController_action);
}
