...
- (_TtC14RecentsAvocado16DOCActionManager)sourcesActionManager;
...
- (DOCSourceObserver)initWithUserAction:(unint64_t)a3 hostIdentifier:(id)a4
{
  ...
  if (v7)
  {
    ...
    v16 = objc_alloc_init(_TtC14RecentsAvocado16DOCActionManager);
...
- (id)_addSubscriberForConfiguration:(id)a3 usingBlock:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10001A324;
  block[3] = &unk_1005B3C60;
...
- (void)removeSubscriberForToken:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001A5D4;
  block[3] = &unk_1005B3CB0;
...
- (int)startObservingDefaultSaveLocation
{
  ...
  handler[2] = sub_10001BE8C;
  handler[3] = &unk_1005B3870;
  objc_copyWeak(&v6, &location);
