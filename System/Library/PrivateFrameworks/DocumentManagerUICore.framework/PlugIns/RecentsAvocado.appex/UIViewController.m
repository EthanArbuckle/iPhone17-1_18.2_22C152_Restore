...
- (_TtC14RecentsAvocado13DOCTabBarItem)DOCTabBarItem;
...
- (void)objc_doc_preheatForPresentingWithCompletion:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  _Block_copy(v4);
  if (v6) {
    DOCPresentationPreheatable<>.doc_preheatForPresenting(completion:)(sub_1000674A0, v5);
  }
  else {
    v4[2](v4);
  }
...
- (_TtC14RecentsAvocado13DOCTabBarItem)DOCTabBarItem
{
  ...
  if (result)
  {
    ...
    return (_TtC14RecentsAvocado13DOCTabBarItem *)v4;
  }
  else
  {
    __break(1u);
