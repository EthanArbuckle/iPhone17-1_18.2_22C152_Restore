...
- (_TtC14RecentsAvocado21DOCNavigationBarStyle)preferredNavigationBarStyle_objc;
...
- (_TtC14RecentsAvocado21DOCNavigationBarStyle)preferredNavigationBarStyle_objc
{
  ...
  v5[OBJC_IVAR____TtC14RecentsAvocado21DOCNavigationBarStyle_style] = v3;
  v8.receiver = v5;
  v8.super_class = v4;
  v6 = [(UITraitCollection *)&v8 init];

  return (_TtC14RecentsAvocado21DOCNavigationBarStyle *)v6;
}
