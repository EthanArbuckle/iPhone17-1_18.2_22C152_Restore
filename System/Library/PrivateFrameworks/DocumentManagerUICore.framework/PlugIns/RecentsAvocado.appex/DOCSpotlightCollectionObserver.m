...
- (_TtC14RecentsAvocado30DOCSpotlightCollectionObserver)init;
...
- (_TtC14RecentsAvocado30DOCSpotlightCollectionObserver)init
{
  result = (_TtC14RecentsAvocado30DOCSpotlightCollectionObserver *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado30DOCSpotlightCollectionObserver_configuration));
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado30DOCSpotlightCollectionObserver_itemCollection));
  uint64_t v3 = *(uint64_t *)((char *)&self->super.isa
                  + OBJC_IVAR____TtC14RecentsAvocado30DOCSpotlightCollectionObserver_collectionUpdateBlock);
  sub_1000388F0(v3);
}
