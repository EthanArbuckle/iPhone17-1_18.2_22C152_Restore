...
- (_TtC14RecentsAvocado23DOCColumnViewController)initWithCoder:(id)a3;
- (_TtC14RecentsAvocado23DOCColumnViewController)initWithCollectionViewLayout:(id)a3;
- (_TtC14RecentsAvocado23DOCColumnViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
+ (NSString)DOCColumnViewControllerUpdatedNavigationItem
{
  if (qword_100626860 != -1) {
    swift_once();
  }
  v2 = (void *)qword_1006505E0;
  return (NSString *)v2;
}
...
- (BOOL)showsHierarchyIndicator
{
  return *((unsigned char *)&self->super.super.super.super.isa
         + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_showsHierarchyIndicator);
}
...
- (void)setShowsHierarchyIndicator:(BOOL)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_showsHierarchyIndicator) = a3;
  if (v3 != a3)
  {
    objc_super v4 = self;
    sub_1001BE3EC();
...
{
  id v3 = a3;
  result = (_TtC14RecentsAvocado23DOCColumnViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_configuration));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_diffableDataSource));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_columnViewSpecs));
  sub_100049B74((uint64_t)self + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_pendingScrollToItem, &qword_10062E5D0);
  sub_100049B74((uint64_t)self + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_activeScrollToItemContext, &qword_10062E5D8);
  swift_release();
  id v3 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_fakeLeadingSeparator);
}
...
- (int64_t)collectionView:(id)a3 numberOfItemsInSection:(int64_t)a4
{
  id v6 = (unint64_t *)((char *)self + OBJC_IVAR____TtC14RecentsAvocado23DOCColumnViewController_containerControllers);
  swift_beginAccess();
  unint64_t v7 = *v6;
  if (!(v7 >> 62)) {
...
- (void)getTransitionControllerForURL:(id)a3 completionBlock:(id)a4
{
  ...
  *(void *)(v11 + 16) = v10;
  id v12 = self;
  sub_1001C3880((uint64_t)v9, (uint64_t)sub_1001B38C4, v11);
...
- (void)getViewFor:(id)a3 waitForNewThumbnail:(BOOL)a4 :(id)a5
{
  ...
  *(void *)(v9 + 16) = v8;
  id v10 = a3;
  uint64_t v11 = self;
  sub_1001C3FB4((uint64_t)v10, a4, (uint64_t)sub_1001AF78C, v9);
...
- (void)revealWithItems:(id)a3 selectEvenIfVisible:(BOOL)a4 completionBlock:(id)a5
{
  ...
  *(void *)(v9 + 16) = v7;
  id v10 = self;
  sub_1001C4500(v8, a4, (uint64_t)sub_10009FA28, v9);
