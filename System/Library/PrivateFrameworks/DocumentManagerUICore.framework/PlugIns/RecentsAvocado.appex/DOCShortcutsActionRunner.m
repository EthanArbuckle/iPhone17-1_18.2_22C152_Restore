...
- (_TtC14RecentsAvocadoP33_F21BF70E1053D7D0846D485EA2C4DF2F24DOCShortcutsActionRunner)init;
...
- (void)workflowRunnerClient:(id)a3 didFinishRunningWorkflowWithOutputFiles:(id)a4 error:(id)a5 cancelled:(BOOL)a6
{
  ...
  if (a4)
  {
    sub_1000333C8(0, (unint64_t *)&unk_100631480);
    uint64_t v7 = sub_1004CDE30();
  }
  v10 = *(void (**)(uint64_t, id))((char *)&self->super.isa
                                           + OBJC_IVAR____TtC14RecentsAvocadoP33_F21BF70E1053D7D0846D485EA2C4DF2F24DOCShortcutsActionRunner_completionHandler);
  id v11 = a3;
  id v12 = a5;
  v13 = self;
  swift_retain();
