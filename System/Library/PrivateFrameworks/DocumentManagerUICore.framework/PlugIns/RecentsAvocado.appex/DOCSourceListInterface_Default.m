...
- (UIImage)iconForRecents
{
  return (UIImage *)sub_10036B0C4((uint64_t)self, (uint64_t)a2, 0x6B636F6C63, 0xE500000000000000);
}

- (UIImage)iconForShared
{
  return (UIImage *)sub_10036B0C4((uint64_t)self, (uint64_t)a2, 0xD000000000000018, 0x80000001005122A0);
}

- (UIImage)iconForSyncError
{
  return (UIImage *)sub_10036B0C4((uint64_t)self, (uint64_t)a2, 0xD00000000000002BLL, 0x8000000100532F10);
}

- (UIImage)iconForCompletedSync
{
  return (UIImage *)sub_10036B0C4((uint64_t)self, (uint64_t)a2, 0xD000000000000010, 0x80000001005230F0);
}
...
- (id)ejectIconFor:(int64_t)a3 iconColor:(id)a4
{
  ...
  id v8 = sub_10036C7A4(0x69632E7463656A65, 0xEC000000656C6372, 0, 1);
