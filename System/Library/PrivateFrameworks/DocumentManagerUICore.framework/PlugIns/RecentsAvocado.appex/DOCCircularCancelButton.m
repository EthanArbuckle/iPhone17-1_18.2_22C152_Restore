...
- (_TtC14RecentsAvocado23DOCCircularCancelButton)initWithFrame:(CGRect)a3;
...
- (_TtC14RecentsAvocado23DOCCircularCancelButton)initWithFrame:(CGRect)a3
{
  result = (_TtC14RecentsAvocado23DOCCircularCancelButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
