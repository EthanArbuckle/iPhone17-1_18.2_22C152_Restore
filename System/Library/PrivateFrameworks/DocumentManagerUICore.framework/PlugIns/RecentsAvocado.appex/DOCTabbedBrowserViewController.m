...
- (_TtC14RecentsAvocado24DOCNamedLocationResolver)namedLocationResolver;
- (_TtC14RecentsAvocado25DOCDefaultSourceUIManager)defaultSourceUIManager;
- (_TtC14RecentsAvocado29DOCBrowserContainerController)effectiveBrowserViewController;
...
+ (id)globalMapTable
{
  if (qword_10063CF60 != -1) {
    dispatch_once(&qword_10063CF60, &stru_1005B39A8);
  }
  v2 = (void *)qword_10063CF58;
  return v2;
}
...
- (void)doc_commonInit
{
  ...
  [v15 registerDefaults:&off_1005DDB48];
...
- (void)_loadFullHierarchy
{
  ...
  if (*(_OWORD *)&self->_fullRecentsViewController == 0 && !self->_splitBrowserViewController)
  {
    ...
    double v29 = [_TtC14RecentsAvocado25DOCDefaultSourceUIManager alloc];
    ...
    double v32 = [_TtC14RecentsAvocado24DOCNamedLocationResolver alloc];
    ...
    [v68 addObserver:self forKeyPath:@"editing" options:1 context:off_100626558];

    v69 = [(DOCTabbedBrowserViewController *)self fullSharedViewController];
    [v69 addObserver:self forKeyPath:@"editing" options:1 context:off_100626558];
...
- (void)configureUIPDocumentLandingStyleIfNecessary
{
  ...
  [(DOCTabbedBrowserViewController *)self enumerateAllFullBrowserViewControllers:&stru_1005B3A88];
}
...
- (void)_updateColumnViewAvailablityFromTraitCollection:(id)a3 andSize:(CGSize)a4
{
  BOOL v5 = +[DOCColumnViewController supportsDisplayInTraitCollection:availableArea:](_TtC14RecentsAvocado23DOCColumnViewController, "supportsDisplayInTraitCollection:availableArea:", a3, a4.width, a4.height);
...
- (_TtC14RecentsAvocado29DOCBrowserContainerController)effectiveBrowserViewController
{
  ...
  return (_TtC14RecentsAvocado29DOCBrowserContainerController *)v3;
}
...
LABEL_5:
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT)) {
      sub_1004CA548((uint64_t)self, a3, v12);
    }
...
- (id)forceBrowseTabDefaultsValue
{
  ...
  v3[4] = self;
  v3[5] = a2;
  if (qword_10063CF70[0] != -1) {
    dispatch_once(qword_10063CF70, v3);
  }
  return (id)qword_10063CF68;
}
...
- (_TtC14RecentsAvocado24DOCNamedLocationResolver)namedLocationResolver
{
  return (_TtC14RecentsAvocado24DOCNamedLocationResolver *)objc_getProperty(self, a2, 64, 1);
}
...
- (_TtC14RecentsAvocado25DOCDefaultSourceUIManager)defaultSourceUIManager
{
  return (_TtC14RecentsAvocado25DOCDefaultSourceUIManager *)objc_getProperty(self, a2, 96, 1);
}
...
- (void)performConnectToServer:(id)a3
{
  uint64_t v5 = sub_1004CC5A0();
  uint64_t v6 = *(void *)(v5 - 8);
  __chkstk_darwin(v5);
  long long v8 = (char *)&v16 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v9 = sub_1004CC5C0();
  ...
  sub_1004CC5B0();
  sub_1004CB640();
  objc_super v15 = (void *)sub_1004CB630();
  sub_1004CB620();
...
- (void)performGoToDownloads:(id)a3
{
  ...
  v7[2] = v5;
  long long v8 = v5;
  sub_1003A13F0(2, (uint64_t)sub_100116CF8, (uint64_t)v7);
...
- (void)presentConnectToServer:(id)a3
{
  uint64_t v5 = sub_100031648((uint64_t *)&unk_10062B3B0);
  ...
  uint64_t v10 = self;
  sub_1004A7C58((uint64_t)v7);

  sub_100049B74((uint64_t)v7, (uint64_t *)&unk_10062B3B0);
}
...
- (void)actionController:(id)a3 presentError:(id)a4 completion:(id)a5
{
  ...
  id v12 = a4;
  id v10 = self;
  uint64_t v11 = (void *)sub_1004CAA50();
