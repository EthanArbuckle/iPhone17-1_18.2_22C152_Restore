...
- (_TtC14RecentsAvocado16DOCActionManager)actionManager;
- (_TtC14RecentsAvocado16DOCPickerContext)pickerContext;
- (_TtC14RecentsAvocado18DOCDocumentManager)documentManager;
- (_TtC14RecentsAvocado19DOCSearchController)effectiveSearchController;
- (_TtC14RecentsAvocado21DOCFileProviderSource)currentGoToFileProviderSource;
- (_TtC14RecentsAvocado21DOCPickerFilenameView)pickerFilenameView;
- (_TtC14RecentsAvocado22DOCHierarchyController)hierarchyController;
- (_TtC14RecentsAvocado22DOCLocationChangePacer)locationChangePacer;
- (_TtC14RecentsAvocado22DOCSourceOrderObserver)sourceOrderObserver;
- (_TtC14RecentsAvocado25DOCItemCollectionViewPool)itemCollectionViewPool;
- (_TtC14RecentsAvocado27DOCDisplayModeChangeHandler)displayModeHandler;
- (_TtC14RecentsAvocado29DOCBrowserContainerController)effectiveBrowserViewController;
- (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource)dataSource;
...
- (void)preloadLaunchServiceDatabase
{
  if (qword_10063CF50 != -1) {
    dispatch_once(&qword_10063CF50, &stru_1005B3828);
  }
}
...
- (void)doc_commonInitWithSourceObserver:(id)a3
{
  ...
  v9 = objc_alloc_init(_TtC14RecentsAvocado27DOCDisplayModeChangeHandler);
  displayModeHandler = self->_displayModeHandler;
  self->_displayModeHandler = v9;

  objc_storeWeak((id *)&self->_sourceObserver, v4);
  v11 = [_TtC14RecentsAvocado25DOCItemCollectionViewPool alloc];
  ...
  v15 = [_TtC14RecentsAvocado42DOCFullDocumentManagerNavigationController alloc];
  ...
  v19 = [_TtC14RecentsAvocado22DOCHierarchyController alloc];
  ...
  [(DOCHierarchyController *)self->_hierarchyController addObserver:self forKeyPath:@"lastLocation" options:1 context:off_1006264E8];
  [(DOCHierarchyController *)self->_hierarchyController addObserver:self forKeyPath:@"effectiveRootLocation" options:1 context:off_1006264E8];
  [(DOCHierarchyController *)self->_hierarchyController addObserver:self forKeyPath:@"locations" options:1 context:off_1006264E8];
  v22 = docUILogHandle;
  if (!docUILogHandle)
  {
    DOCInitLogging();
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG)) {
    sub_1004CA0C4(self, v22);
  }
  v23 = [_TtC14RecentsAvocado18DOCDocumentManager alloc];
  ...
  v27 = [_TtC14RecentsAvocado22DOCLocationChangePacer alloc];
  ...
  v31 = [_TtC14RecentsAvocado30DOCBrowserNavigationDataSource alloc];
...
LABEL_9:
  ...
  return (_TtC14RecentsAvocado29DOCBrowserContainerController *)v12;
}
...
LABEL_11:
  ...
  return (_TtC14RecentsAvocado19DOCSearchController *)v8;
}
...
- (void)beginForcedNavigationTransitionChromeIfNeeded:(id)a3 appearingViewController:(id)a4 animated:(BOOL)a5
{
  ...
  objc_super v10 = sub_1000114A4(v8);
  uint64_t v11 = v10;
...
- (void)setPickerContext:(id)a3
{
  id v5 = (_TtC14RecentsAvocado16DOCPickerContext *)a3;
...
- (_TtC14RecentsAvocado22DOCHierarchyController)hierarchyController
{
  return (_TtC14RecentsAvocado22DOCHierarchyController *)objc_getProperty(self, a2, 64, 1);
}
...
- (_TtC14RecentsAvocado18DOCDocumentManager)documentManager
{
  return (_TtC14RecentsAvocado18DOCDocumentManager *)objc_getProperty(self, a2, 72, 1);
}
...
- (_TtC14RecentsAvocado16DOCActionManager)actionManager
{
  return (_TtC14RecentsAvocado16DOCActionManager *)objc_getProperty(self, a2, 80, 1);
}
...
- (_TtC14RecentsAvocado27DOCDisplayModeChangeHandler)displayModeHandler
{
  return (_TtC14RecentsAvocado27DOCDisplayModeChangeHandler *)objc_getProperty(self, a2, 88, 1);
}

- (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource)dataSource
{
  return (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource *)objc_getProperty(self, a2, 96, 1);
}

- (_TtC14RecentsAvocado25DOCItemCollectionViewPool)itemCollectionViewPool
{
  return (_TtC14RecentsAvocado25DOCItemCollectionViewPool *)objc_getProperty(self, a2, 104, 1);
}

- (_TtC14RecentsAvocado22DOCLocationChangePacer)locationChangePacer
{
  return (_TtC14RecentsAvocado22DOCLocationChangePacer *)objc_getProperty(self, a2, 112, 1);
}
...
- (BOOL)canPerformGoToEnclosingFolder
{
  ...
  uint64_t v4 = *(uint64_t *)((char *)&v3->super.isa + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_viewStyle);
...
- (void)performViewAsUserSizeSmaller:(id)a3
{
  id v4 = a3;
  unsigned __int8 v5 = self;
  sub_10010E8AC((unsigned int *)&enum case for DOCAdjustmentDirection.decrement(_:));
}
...
- (void)performViewAsUserSizeLarger:(id)a3
{
  id v4 = a3;
  unsigned __int8 v5 = self;
  sub_10010E8AC((unsigned int *)&enum case for DOCAdjustmentDirection.increment(_:));
}
...
- (void)dataSource:(id)a3 didUpdate:(id)a4 animated:(BOOL)a5
{
  ...
  id v8 = (char *)sub_1004CDE30();
  id v9 = a3;
  id v10 = self;
  sub_100209C80((uint64_t)v9, v8, v5);
...
- (id)provideContainerControllerAt:(id)a3 from:(id)a4 isUserInteraction:(BOOL)a5 isBrowsingTrash:(BOOL)a6
{
  ...
  id v11 = a4;
  id v12 = self;
  id v13 = sub_10020C6CC(v10, a4, v7, v6);
...
- (void)beginLoadingAdditionalParents:(id)a3
{
  ...
  *(void *)(v8 + 16) = sub_100352860;
  *(void *)(v8 + 24) = v5;
  swift_retain();
  sub_10006E558((uint64_t)sub_10047302C, v8);
...
- (unint64_t)effectiveTabSwitcherTab
{
  ...
  unint64_t v4 = (_TtC14RecentsAvocado22DOCHierarchyController *)sub_10006DE58();
  if (v4)
  {
    id v5 = v4;
...
- (id)targetForAction:(SEL)a3 withSender:(id)a4
{
  ...
  if (v18)
  {
    uint64_t v9 = sub_100032FD8(v17, v18);
...
- (void)didPresentSearchController:(id)a3
{
  id v4 = a3;
  id v5 = self;
  sub_10046DA14((uint64_t)v4, [v4 showsSearchResultsController]);
}
