...
- (_TtC14RecentsAvocado23DOCSuggestionsTableView)initWithFrame:(CGRect)a3 style:(int64_t)a4;
...
- (_TtC14RecentsAvocado23DOCSuggestionsTableView)initWithFrame:(CGRect)a3 style:(int64_t)a4
{
  ...
  swift_getObjectType();
  v10 = (char *)self + OBJC_IVAR____TtC14RecentsAvocado23DOCSuggestionsTableView_cachedIntrinsicSize;
  *(void *)v10 = 0;
  *((void *)v10 + 1) = 0;
  v10[16] = 1;
  v15.receiver = self;
  ...
  *(_OWORD *)(v12 + 16) = xmmword_1004E12A0;
  *(void *)(v12 + 32) = sub_1004CD280();
...
- (id)invalidateIntrinsicContentSize
{
  v1 = &a1[OBJC_IVAR____TtC14RecentsAvocado23DOCSuggestionsTableView_cachedIntrinsicSize];
  *(void *)v1 = 0;
  *((void *)v1 + 1) = 0;
  v1[16] = 1;
  v3.receiver = a1;
...
- (CGSize)intrinsicContentSize
{
  objc_super v3 = (double *)((char *)self + OBJC_IVAR____TtC14RecentsAvocado23DOCSuggestionsTableView_cachedIntrinsicSize);
  if (self->cachedIntrinsicSize[OBJC_IVAR____TtC14RecentsAvocado23DOCSuggestionsTableView_cachedIntrinsicSize + 8])
  {
