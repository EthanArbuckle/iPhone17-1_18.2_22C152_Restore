...
- (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource)init;
- (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource)initWithConfiguration:(id)a3 sourceObserver:(id)a4;
- (_TtP14RecentsAvocado42DOCBrowserNavigationDataSourceItemProvider_)itemProvider;
- (_TtP14RecentsAvocado44DOCBrowserNavigationDataSourceUpdateObserver_)updateObserver;
...
- (NSArray)containerControllers
{
  v2 = (Class *)((char *)&self->super.isa
               + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_containerControllers);
  swift_beginAccess();
  if (*v2)
  {
...
- (void)setContainerControllers:(id)a3
{
  ...
  {
    type metadata accessor for DOCBrowserContainerController();
    uint64_t v3 = sub_1004CDE30();
  }
  v5 = (uint64_t *)((char *)self + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_containerControllers);
  swift_beginAccess();
  uint64_t *v5 = v3;
  swift_bridgeObjectRelease();
}
...
- (NSArray)columnViewControllers
{
  if (*(Class *)((char *)&self->super.isa
                + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_columnViewControllers))
  {
...
- (void)setColumnViewControllers:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa
           + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_columnViewControllers) = v4;
  swift_bridgeObjectRelease();
}
...
- (void)setCurrentContainers:(id)a3
{
  ...
  v5 = (uint64_t *)((char *)self + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_currentContainers);
  swift_beginAccess();
  uint64_t *v5 = v4;
  swift_bridgeObjectRelease();
}
...
- (_TtP14RecentsAvocado44DOCBrowserNavigationDataSourceUpdateObserver_)updateObserver
{
  ...
  return (_TtP14RecentsAvocado44DOCBrowserNavigationDataSourceUpdateObserver_ *)Strong;
}
...
{
  Strong = (void *)swift_unknownObjectWeakLoadStrong();
  return (_TtP14RecentsAvocado42DOCBrowserNavigationDataSourceItemProvider_ *)Strong;
}
...
- (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource)initWithConfiguration:(id)a3 sourceObserver:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  v7 = (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource *)sub_10020F38C(v5, v6);
...
- (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource)init
{
  result = (_TtC14RecentsAvocado30DOCBrowserNavigationDataSource *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_historyDataSource));
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_configuration));
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_sourceObserver));
  swift_bridgeObjectRelease();
  sub_1000391D4((uint64_t)self + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_updateObserver);
  NSString v3 = (char *)self + OBJC_IVAR____TtC14RecentsAvocado30DOCBrowserNavigationDataSource_itemProvider;
...
- (void)hierarchyController:(id)a3 prepareControllersFor:(id)a4 :(id)a5 isUserInteraction:(BOOL)a6 isBrowsingTrash:(BOOL)a7 completion:(id)a8
{
  ...
  *(void *)(v15 + 16) = v13;
  ...
  id v17 = a5;
  v18 = self;
  sub_10020FA64(v14, a5, a6, a7, (uint64_t)sub_100212540, v15);
...
- (void)hierarchyController:(id)a3 willAppend:(id)a4 animated:(BOOL)a5
{
  ...
  if (v9)
  {
    ...
    id v12 = a3;
    v13 = self;
    sub_100210088((uint64_t)v12, (uint64_t)v13, v10);
    sub_10020FC60(a5);
...
- (void)hierarchyController:(id)a3 didAppend:(id)a4 animated:(BOOL)a5
{
  ...
  if (v9)
  {
    ...
    id v12 = a3;
    v13 = self;
    unint64_t v14 = sub_100210088((uint64_t)v12, (uint64_t)v13, v10);
    sub_100205B84(v14, v15, v5);
...
- (void)hierarchyController:(id)a3 willReplaceTrailingLocations:(int64_t)a4 with:(id)a5 animated:(BOOL)a6 completion:(id)a7
{
  ...
  sub_1000333C8(0, (unint64_t *)&qword_10062DDD0);
  unint64_t v12 = sub_1004CDE30();
  _Block_copy(v11);
  id v13 = a3;
  unint64_t v14 = self;
  sub_100210574((int)v13, a4, v12, a6, (uint64_t)v14, v11);
  _Block_release(v11);
  _Block_release(v11);
...
- (void)hierarchyController:(id)a3 didReplaceTrailingLocations:(int64_t)a4 with:(id)a5 animated:(BOOL)a6
{
  ...
  id v11 = a3;
  unint64_t v12 = self;
  sub_100206B8C((uint64_t)v11, a4, v10, a6);
...
- (void)hierarchyController:(id)a3 didPrepend:(id)a4 source:(id)a5
{
  ...
  id v10 = a5;
  id v11 = self;
  sub_1002072E8((uint64_t)v8, (uint64_t)v9, (uint64_t)a5);
}
...
- (void)hierarchyController:(id)a3 willPopLocations:(int64_t)a4 animated:(BOOL)a5 completion:(id)a6
{
  ...
  id v11 = a3;
  unint64_t v12 = self;
  sub_1002102FC(a4, a5, (uint64_t)v12, (void (**)(void))v10);
  _Block_release(v10);
  _Block_release(v10);
}
