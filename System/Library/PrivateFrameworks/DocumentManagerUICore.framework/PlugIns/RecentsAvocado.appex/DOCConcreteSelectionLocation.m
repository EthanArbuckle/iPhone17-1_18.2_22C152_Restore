...
- (_TtC14RecentsAvocado28DOCConcreteSelectionLocation)init;
- (_TtC14RecentsAvocado28DOCConcreteSelectionLocation)initWithCoder:(id)a3;
- (_TtC14RecentsAvocado28DOCConcreteSelectionLocation)initWithSourceIdentifier:(id)a3 node:(id)a4;
- (_TtC14RecentsAvocado28DOCConcreteSelectionLocation)initWithSourceIdentifier:(id)a3 title:(id)a4;
- (_TtC14RecentsAvocado28DOCConcreteSelectionLocation)initWithTaggedItemsSourceRepresentedTag:(id)a3;
@end
...
- (_TtC14RecentsAvocado28DOCConcreteSelectionLocation)initWithSourceIdentifier:(id)a3 node:(id)a4
{
  *(void *)&self->DOCConcreteLocation_opaque[OBJC_IVAR____TtC14RecentsAvocado28DOCConcreteSelectionLocation_selectedNodes] = _swiftEmptyArrayStorage;
  v7.receiver = self;
