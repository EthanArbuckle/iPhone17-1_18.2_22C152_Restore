...
{
  v5.receiver = self;
  v5.super_class = (Class)SiriVocalShortcutSource;
...
void __46__SiriVocalShortcutSource_configureConnection__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v15[1] = 3221225472;
    v15[2] = __46__SiriVocalShortcutSource_configureConnection__block_invoke_2;
    v15[3] = &unk_1E6B67518;
    id v10 = v7;
    id v16 = v10;
    [v3 setInvalidationHandler:v15];
    [v3 setInterruptionHandler:&__block_literal_global_21];
    v12[0] = MEMORY[0x1E4F143A8];
    v12[1] = 3221225472;
    v12[2] = __46__SiriVocalShortcutSource_configureConnection__block_invoke_26;
    v12[3] = &unk_1E6B67560;
...
void __46__SiriVocalShortcutSource_configureConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  {
    int v6 = 136315394;
    v7 = "-[SiriVocalShortcutSource configureConnection]_block_invoke_2";
    __int16 v8 = 2112;
    id v9 = v3;
  ...
  [v5 unregisterNonButtonSourceWithType:&unk_1F337C710 withUUID:*(void *)(a1 + 32)];
}
...
void __46__SiriVocalShortcutSource_configureConnection__block_invoke_24(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F4E360], OS_LOG_TYPE_ERROR)) {
    __46__SiriVocalShortcutSource_configureConnection__block_invoke_24_cold_1((uint64_t)v2, v3);
  }
}
...
void __46__SiriVocalShortcutSource_configureConnection__block_invoke_26(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    {
      int v8 = 136315394;
      id v9 = "-[SiriVocalShortcutSource configureConnection]_block_invoke";
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D9588000, v6, OS_LOG_TYPE_DEFAULT, "%s #activation BSServiceConnection Activated %@", (uint8_t *)&v8, 0x16u);
    }
    v7 = [v3 remoteTarget];
    [v7 registerNonButtonSourceWithType:&unk_1F337C710 withUUID:*(void *)(a1 + 32)];
...
- (void)activateWithContext:(id)a3
{
  ...
  [v6 activationRequestFromVocalShortcutWithContext:v5];
...
void __46__SiriVocalShortcutSource_configureConnection__block_invoke_24_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 136315394;
  id v3 = "-[SiriVocalShortcutSource configureConnection]_block_invoke";
  __int16 v4 = 2112;
  uint64_t v5 = a1;
