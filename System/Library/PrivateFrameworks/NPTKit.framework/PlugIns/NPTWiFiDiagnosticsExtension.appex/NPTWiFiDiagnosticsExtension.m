void sub_10000324C(uint64_t a1, void *a2)
{
  void *v3;
  void *v4;
  void *v5;
...
intptr_t sub_100003330(uint64_t a1, void *a2)
{
  v3 = [a2 asDictionary];
  v4 = [*(id *)(a1 + 32) results];
...
id objc_msgSend_defaultConfigurationWiFi(void *a1, const char *a2, ...)
{
  return [a1 defaultConfigurationWiFi];
}
