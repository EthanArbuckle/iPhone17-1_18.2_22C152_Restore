...
+ (uint64_t)DMCErrorWithDomain:()DMCUtilities code:descriptionArray:errorType:
{
  return [a1 DMCErrorWithDomain:a3 code:a4 descriptionArray:a5 suggestion:0 USEnglishSuggestion:0 underlyingError:0 errorType:a6];
}

+ (uint64_t)DMCErrorWithDomain:()DMCUtilities code:descriptionArray:underlyingError:errorType:
{
  return [a1 DMCErrorWithDomain:a3 code:a4 descriptionArray:a5 suggestion:0 USEnglishSuggestion:0 underlyingError:a6 errorType:a7];
}
...
LABEL_7:
  ...
  if (!v15)
  {
    ...
    id v29 = [v17 DMCFindPrimaryError];
    if (!v29) {
      id v29 = v17;
    }
...
- (id)DMCVerboseDescription
{
  ...
  uint64_t v10 = [a1 DMCUSEnglishDescription];
  v11 = (void *)v10;
  if (v10) {
    [v5 appendFormat:@"US Desc: %@\n", v10];
  }
  v27 = v7;
  uint64_t v12 = [a1 DMCUSEnglishSuggestion];
  v13 = (void *)v12;
  if (v12) {
  ...
  id v15 = [a1 userInfo];
  id v16 = [v15 objectForKey:@"DMCErrorType"];
