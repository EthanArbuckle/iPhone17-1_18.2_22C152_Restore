...
- (void)mergeUnknownKeysFrom:(id)a3 parentKey:(id)a4
{
  ...
  if (v9)
  {
    ...
    v19 = [(DMCModelPayloadBase *)v21 unknownPayloadKeys];
    v20 = [v19 setByAddingObjectsFromSet:v12];
    [(DMCModelPayloadBase *)v21 setUnknownPayloadKeys:v20];
  }
}
...
- (id)createNestedObjectWithClass:(Class)a3 serializationType:(signed __int16)a4 parentKey:(id)a5 payload:(id)a6 error:(id *)a7
{
  ...
  id v12 = a5;
  v13 = [(objc_class *)a3 load:a6 serializationType:v9 error:a7];
  if (v13)
  {
    [(DMCModelPayloadBase *)self mergeUnknownKeysFrom:v13 parentKey:v12];
    id v14 = v13;
  }
  else if (a7)
  {
    uint64_t v15 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v16 = [NSString stringWithFormat:@"Wrong nested item, key: %@", v12, *MEMORY[0x1E4F28568]];
    v20[0] = v16;
    uint64_t v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v20 forKeys:&v19 count:1];
    *a7 = [v15 errorWithDomain:@"error" code:1 userInfo:v17];
  }
  return v13;
}
...
+ (id)loadData:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  if (v6 == 1)
  {
    uint64_t v9 = [MEMORY[0x1E4F28D90] JSONObjectWithData:v8 options:0 error:a5];
    goto LABEL_5;
  }
  if (!v6)
  {
    uint64_t v9 = [MEMORY[0x1E4F28F98] propertyListWithData:v8 options:0 format:0 error:a5];
LABEL_5:
    v10 = (void *)v9;
...
- (id)serializeAsDataWithType:(signed __int16)a3 error:(id *)a4
{
  ...
  if (a3 == 1)
  {
    ...
    uint64_t v6 = -[DMCModelPayloadBase serializeWithType:](self, "serializeWithType:");
    uint64_t v7 = [v8 dataWithJSONObject:v6 options:1 error:v4];
    goto LABEL_5;
  }
  if (!a3)
  {
...
LABEL_5:
  ...
  if (a4)
  {
    ...
    v10 = objc_msgSend(NSString, "stringWithFormat:", @"Unsupported serialization type: %d", a3, *MEMORY[0x1E4F28568]);
    v14[0] = v10;
...
LABEL_3:
  ...
  if (a9)
  {
    ...
    long long v22 = [NSString stringWithFormat:@"Wrong type, key: %@", v13, *MEMORY[0x1E4F28568]];
    v26 = v22;
    long long v23 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v26 forKeys:&v25 count:1];
...
- (BOOL)loadStringFromDictionary:(id)a3 usingKey:(id)a4 forKeyPath:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7 error:(id *)a8
{
  ...
  id v17 = a3;
  id v23 = 0;
  BOOL v18 = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v17 usingKey:v16 isRequired:v10 defaultValue:v15 payloadValue:&v23 error:a8];

  id v19 = v23;
  v20 = v19;
  if (v18 && v19 != 0) {
    [(DMCModelPayloadBase *)self setValue:v19 forKey:v14];
  }
...
- (BOOL)loadIntegerFromDictionary:(id)a3 usingKey:(id)a4 forKeyPath:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7 error:(id *)a8
{
  ...
  id v17 = a3;
  id v24 = 0;
  BOOL v18 = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v17 usingKey:v16 isRequired:v10 defaultValue:v15 payloadValue:&v24 error:a8];
  ...
  if (v18 && v19 != 0)
  {
    ...
    [(DMCModelPayloadBase *)self setValue:v22 forKey:v14];
  }
  return v18;
}
...
- (BOOL)loadFloatFromDictionary:(id)a3 usingKey:(id)a4 forKeyPath:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7 error:(id *)a8
{
  ...
  id v17 = a3;
  id v25 = 0;
  BOOL v18 = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v17 usingKey:v16 isRequired:v10 defaultValue:v15 payloadValue:&v25 error:a8];
  ...
  if (v18 && v19 != 0)
  {
    ...
    [(DMCModelPayloadBase *)self setValue:v23 forKey:v14];
  }
  return v18;
}
...
LABEL_6:
    ...
    if (objc_opt_isKindOfClass())
    {
      id v23 = objc_msgSend(MEMORY[0x1E4F28C10], "rmmodel_sharedRFC3339DateFormatter");
...
LABEL_7:
  id v35 = 0;
  BOOL v25 = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v21 usingKey:v16 isRequired:v11 defaultValue:v18 payloadValue:&v35 error:a9];
  id v26 = v35;
  long long v22 = v26;
  if (v25 && v26 != 0) {
    [(DMCModelPayloadBase *)self setValue:v26 forKey:v17];
  }
LABEL_18:
...
- (BOOL)loadArrayFromDictionary:(id)a3 usingKey:(id)a4 forKeyPath:(id)a5 validator:(id)a6 isRequired:(BOOL)a7 defaultValue:(id)a8 error:(id *)a9
{
  ...
  id v19 = a8;
  id v46 = 0;
  BOOL v20 = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v15 usingKey:v16 isRequired:v10 defaultValue:v19 payloadValue:&v46 error:a9];
  id v21 = v46;
  long long v22 = v21;
  if (v20)
  {
    ...
    {
      id v17 = v40;
      [(DMCModelPayloadBase *)v36 setValue:v23 forKey:v40];
      BOOL v32 = 1;
      id v31 = v26;
      id v16 = v39;
    }
...
- (BOOL)loadArrayFromDictionary:(id)a3 usingKey:(id)a4 forKeyPath:(id)a5 classType:(Class)a6 nested:(BOOL)a7 isRequired:(BOOL)a8 defaultValue:(id)a9 serializationType:(signed __int16)a10 error:(id *)a11
{
  ...
  id v55 = 0;
  id v46 = v16;
  LODWORD(v19) = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v15 usingKey:v16 isRequired:v19 defaultValue:v18 payloadValue:&v55 error:a11];
  id v20 = v55;
  id v21 = v20;
  if (v19)
  {
    long long v44 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v20, "count"));
    long long v51 = 0u;
    long long v52 = 0u;
    long long v53 = 0u;
    long long v54 = 0u;
...
LABEL_27:
            ...
            uint64_t v19 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v24, "count"));
            long long v47 = 0u;
            long long v48 = 0u;
            long long v49 = 0u;
            long long v50 = 0u;
            ...
            if (v26)
            {
              ...
              while (2)
              {
                for (uint64_t i = 0; i != v27; ++i)
                {
                  ...
                  uint64_t v30 = [(DMCModelPayloadBase *)self createNestedObjectWithClass:a6 serializationType:v22 parentKey:v46 payload:*(void *)(*((void *)&v47 + 1) + 8 * i) error:a11];
                  if (!v30)
                  {
                    id v17 = v37;
                    id v15 = v38;
          ...
          {
            uint64_t v19 = [(DMCModelPayloadBase *)self createNestedObjectWithClass:a6 serializationType:v22 parentKey:v46 payload:v24 error:a11];
            if (!v19) {
              goto LABEL_27;
            }
            [v44 addObject:v19];
...
- (BOOL)loadDictionaryFromDictionary:(id)a3 usingKey:(id)a4 forKeyPath:(id)a5 classType:(Class)a6 isRequired:(BOOL)a7 defaultValue:(id)a8 serializationType:(signed __int16)a9 error:(id *)a10
{
  ...
  id v16 = a5;
  id v22 = 0;
  BOOL v17 = [(DMCModelPayloadBase *)self getModelObjectFromDictionary:a3 usingKey:a4 classType:a6 isRequired:v11 defaultValue:a8 serializationType:a9 payloadValue:&v22 error:a10];
  id v18 = v22;
  uint64_t v19 = v18;
  if (v17 && v18 != 0) {
    [(DMCModelPayloadBase *)self setValue:v18 forKey:v16];
  }
...
- (BOOL)getModelObjectFromDictionary:(id)a3 usingKey:(id)a4 classType:(Class)a5 isRequired:(BOOL)a6 defaultValue:(id)a7 serializationType:(signed __int16)a8 payloadValue:(id *)a9 error:(id *)a10
{
  ...
  id v18 = a3;
  id v27 = 0;
  BOOL v19 = [(DMCModelPayloadBase *)self _loadObjectOfClass:objc_opt_class() fromDictionary:v18 usingKey:v16 isRequired:v12 defaultValue:v17 payloadValue:&v27 error:a10];
  ...
  if (v19)
  {
    if (v20)
    {
      id v22 = [(DMCModelPayloadBase *)self createNestedObjectWithClass:a5 serializationType:v10 parentKey:v16 payload:v20 error:a10];
      uint64_t v23 = v22;
      BOOL v24 = v22 != 0;
      if (v22) {
        id v25 = v22;
...
- (void)serializeStringIntoDictionary:(id)a3 usingKey:(id)a4 value:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7
{
  ...
  id v13 = a4;
  id v14 = a3;
  -[DMCModelPayloadBase _serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:](self, "_serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:", v14, v13, v12, v8, [v12 isEqual:a7]);
}
...
- (void)serializeIntegerIntoDictionary:(id)a3 usingKey:(id)a4 value:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7
{
  ...
  -[DMCModelPayloadBase _serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:](self, "_serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:", v16, v12, v15, v8, [v13 isEqual:v14]);
}
...
- (void)serializeFloatIntoDictionary:(id)a3 usingKey:(id)a4 value:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7
{
  ...
  -[DMCModelPayloadBase _serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:](self, "_serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:", v17, v12, v16, v8, [v13 isEqual:v14]);
}
...
- (void)serializeDateIntoDictionary:(id)a3 usingKey:(id)a4 value:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7 serializationType:(signed __int16)a8
{
  ...
  if (v17)
  {
    ...
    if (v8 == 1)
    {
      id v20 = objc_msgSend(MEMORY[0x1E4F28C10], "rmmodel_sharedRFC3339DateFormatter");
      BOOL v19 = [v20 stringFromDate:v18];
    }
  }
  -[DMCModelPayloadBase _serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:](self, "_serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:", v21, v14, v19, v10, [v18 isEqual:v16]);
}
...
- (void)serializeDataIntoDictionary:(id)a3 usingKey:(id)a4 value:(id)a5 isRequired:(BOOL)a6 defaultValue:(id)a7 serializationType:(signed __int16)a8
{
  ...
  -[DMCModelPayloadBase _serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:](self, "_serializeItemIntoDictionary:usingKey:value:isRequired:isDefaultValue:", v20, v14, v19, v10, [v18 isEqual:v16]);
}
...
- (void)serializeArrayIntoDictionary:(id)a3 usingKey:(id)a4 value:(id)a5 itemSerializer:(id)a6 isRequired:(BOOL)a7 defaultValue:(id)a8
{
  ...
  if (v15)
  {
    ...
    BOOL v28 = a7;
    id v29 = v13;
    BOOL v19 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v15, "count"));
    long long v30 = 0u;
    long long v31 = 0u;
    long long v32 = 0u;
    long long v33 = 0u;
...
{
  id v4 = a3;
  id v5 = [(DMCModelPayloadBase *)self serializeWithType:0];
...
- (DMCModelPayloadBase)initWithCoder:(id)a3
{
  ...
  id v5 = [(DMCModelPayloadBase *)&v22 init];
  if (!v5) {
    goto LABEL_3;
  }
