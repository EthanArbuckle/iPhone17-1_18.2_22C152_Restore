...
- (void)significantUserInteractionOccurred
{
  ...
  objc_super v4 = [(SCLSettingsSyncState *)self stateMachine];
  [v4 performSync];
}
...
- (void)enqueueFailedWithError:(id)a3
{
  ...
  objc_super v5 = [(SCLSettingsSyncState *)self stateMachine];
  v6 = [v5 context];
  [v6 setError:v4];

  objc_super v7 = [(SCLSettingsSyncState *)self stateMachine];
