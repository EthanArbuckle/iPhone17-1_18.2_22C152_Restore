...
+ (void)setStatusCondition:(id)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    v6 = [MEMORY[0x263F087E8] errorWithDomain:@"ADStatusConditionsErrorDomain" code:-1102 userInfo:0];
    v5[2](v5, v6);
  }
...
+ (void)isStatusConditionRegistered:(id)a3 bundleIdentifier:(id)a4 completionHandler:(id)a5
{
  id v10 = a3;
  id v7 = a4;
  v8 = (void (**)(id, void, ADStatusConditionsImpl *))a5;
  if (v10 && v7)
  {
  ...
  else
  {
    ...
    v9 = [MEMORY[0x263F087E8] errorWithDomain:@"ADStatusConditionsErrorDomain" code:-1102 userInfo:0];
    v8[2](v8, 0, v9);
  }
