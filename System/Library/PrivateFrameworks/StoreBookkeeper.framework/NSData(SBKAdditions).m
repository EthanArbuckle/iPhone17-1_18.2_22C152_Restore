...
- (id)SBKDataByDeflatingWithGZip
{
  v0 = (void *)ISCopyGzippedDataForData();
  return v0;
}

- (id)SBKDataByInflatingWithGZip
{
  v0 = (void *)ISCopyDecompressedGZipDataForData();
  return v0;
}

- (uint64_t)SBKDataByDeflatingWithNoZipHeader
{
  return [a1 _SBKDataByDeflatingWithNoZipHeaderWithCompression:2];
}
...
- (id)_SBKDataByDeflatingWithNoZipHeaderWithCompression:()SBKAdditions
{
  ...
  id v4 = a1;
  if ((unint64_t)[v4 length] >= 0xFFFFFFFF)
  {
    NSLog(&cfstr_ErrorUnableToZ.isa, (double)(unint64_t)[v4 length] / 1000000000.0);
    id v5 = 0;
    goto LABEL_23;
  }
  id v6 = v4;
  v7 = (Bytef *)[v6 bytes];
  uInt v8 = [v6 length];
  v9 = (void *)[objc_alloc(MEMORY[0x263EFF990]) initWithCapacity:(v8 >> 1) + 1];
  id v5 = 0;
  if (v7 && v8)
  {
...
- (id)_SBKDataByInflatingWithNoZipHeader
{
  ...
  id v1 = a1;
  if ((unint64_t)[v1 length] >> 32)
  {
    NSLog(&cfstr_ErrorUnableToZ.isa, (double)(unint64_t)[v1 length] / 1000000000.0);
LABEL_3:
    id v2 = 0;
    goto LABEL_11;
  }
...
+ (__CFString)SBKStringByMD5HashingString:()SBKAdditions
{
  ...
  id v4 = v3;
  CC_MD5_Update((CC_MD5_CTX *)v56, (const void *)[v4 UTF8String], objc_msgSend(v4, "length"));
  ...
  if (*(uint64_t *)v57 > 3999)
  {
    if (*(uint64_t *)v57 > 4255)
    {
      if (*(void *)v57 == 4256)
      {
        ...
        for (uint64_t i = 0; i != 64; i += 2)
        {
          ...
          v51 = &v47[i];
          char *v51 = MSVFastHexStringFromBytes_hexCharacters[(unint64_t)v50 >> 4];
      ...
      else
      {
        ...
        for (uint64_t j = 0; j != 128; j += 2)
        {
          ...
          v29 = &v25[j];
          char *v29 = MSVFastHexStringFromBytes_hexCharacters[(unint64_t)v28 >> 4];
    ...
    else if (*(void *)v57 == 4000)
    {
      ...
      for (uint64_t k = 0; k != 32; k += 2)
      {
        ...
        v41 = &v37[k];
        char *v41 = MSVFastHexStringFromBytes_hexCharacters[(unint64_t)v40 >> 4];
    ...
    else
    {
      ...
      for (uint64_t m = 0; m != 40; m += 2)
      {
        ...
        BOOL v16 = &v12[m];
        *BOOL v16 = MSVFastHexStringFromBytes_hexCharacters[(unint64_t)v15 >> 4];
    ...
    if (*(void *)v57 == 3000)
    {
      ...
      do
      {
        ...
        *(v44 - 1) = MSVFastHexStringFromBytes_hexCharacters[v45 >> 4];
        unsigned char *v44 = MSVFastHexStringFromBytes_hexCharacters[v45 & 0xF];
        v44 += 2;
        ++v43;
      }
      while (v43 != 4);
    ...
    else
    {
      ...
      do
      {
        ...
        *(v22 - 1) = MSVFastHexStringFromBytes_hexCharacters[v23 >> 4];
        unsigned char *v22 = MSVFastHexStringFromBytes_hexCharacters[v23 & 0xF];
        v22 += 2;
        ++v21;
      }
      while (v21 != 8);
...
LABEL_50:
  v54 = objc_msgSend(MEMORY[0x263F08690], "currentHandler", 4000, *(void *)v56);
  ...
  if (v5 >= 1)
  {
    ...
    do
    {
      *(v8 - 1) = MSVFastHexStringFromBytes_hexCharacters[(unint64_t)*v4 >> 4];
      char v9 = *v4++;
      *uint64_t v8 = MSVFastHexStringFromBytes_hexCharacters[v9 & 0xF];
      v8 += 2;
      --v5;
    }
    while (v5);
  }
  int v10 = (void *)[[NSString alloc] initWithBytesNoCopy:v7 length:v6 encoding:4 freeWhenDone:1];
