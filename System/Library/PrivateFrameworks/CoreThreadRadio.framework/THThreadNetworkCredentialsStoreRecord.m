...
+ (id)computedUniqueIdentifierForNetwork:(id)a3 keychainAccessGroup:(id)a4
{
  ...
  id v6 = a3;
  CC_SHA256_Init(&v18);
  CC_SHA256_Update(&v18, &THThreadNetworkUUIDNamespace, 0x10u);
  id v7 = v5;
...
LABEL_7:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR)) {
    [(THThreadNetworkCredentialsStoreRecord(CredentialsServerKeychainRepr) *)self computedUniqueIdentifier];
  }
  ...
  if (v6 && v8 && v12)
  {
    ...
    if (!v18)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR)) {
        +[THThreadNetworkCredentialsStoreRecord(CredentialsServerKeychainRepr) recordFromKeychainDictionary:].cold.4();
      }
    ...
    if (!v32)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR)) {
        +[THThreadNetworkCredentialsStoreRecord(CredentialsServerKeychainRepr) recordFromKeychainDictionary:]();
      }
      id v16 = 0;
      v22 = v30;
      goto LABEL_52;
      ...
      if (v25)
      {
        ...
        if (([v28 isEqual:v13] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR)) {
            +[THThreadNetworkCredentialsStoreRecord(CredentialsServerKeychainRepr) recordFromKeychainDictionary:v27];
          }
        }
LABEL_51:
...
LABEL_52:
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR)) {
      +[THThreadNetworkCredentialsActiveDataSetRecord(Keychain) activeDataSetRecordFromKeychainDictionary:](v25);
    }
    id v16 = 0;
    goto LABEL_51;
  }
...
- (id)keyChainQueryForUpdateOperation
{
  ...
  if (v5)
  {
    ...
    if (v8 && v3)
    {
      ...
      id v13 = base64StringFromData_0(v12);
      v18[4] = v13;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
    [(THThreadNetworkCredentialsStoreRecord(CredentialsServerKeychainRepr) *)self keyChainQueryForUpdateOperation];
  }
  v15 = 0;
LABEL_9:
