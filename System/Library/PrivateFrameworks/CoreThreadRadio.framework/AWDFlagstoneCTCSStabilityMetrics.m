...
{
  v7.receiver = self;
  v7.super_class = (Class)AWDFlagstoneCTCSStabilityMetrics;
...
- (BOOL)readFrom:(id)a3
{
  return AWDFlagstoneCTCSStabilityMetricsReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v9 = [(AWDCtcsReadWriteStabilityS *)self->_sCntrsStability copyWithZone:a3];
  v10 = (void *)v6[3];
  v6[3] = v9;
...
LABEL_11:
  ...
  {
    unsigned __int8 v8 = -[AWDCtcsReadWriteStabilityS isEqual:](sCntrsStability, "isEqual:");
