...
- (BOOL)hasSCntrsCoex
{
  return self->_sCntrsCoex != 0;
}

- (BOOL)hasSHistCoex
{
  return self->_sHistCoex != 0;
}

- (id)description
{
  v7.receiver = self;
  v7.super_class = (Class)AWDFlagstoneCoexMetrics;
...
- (BOOL)readFrom:(id)a3
{
  return AWDFlagstoneCoexMetricsReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v9 = [(AWDCountersCoexS *)self->_sCntrsCoex copyWithZone:a3];
  v10 = (void *)v6[3];
  v6[3] = v9;

  id v11 = [(AWDHistogramsCoexS *)self->_sHistCoex copyWithZone:a3];
  v12 = (void *)v6[4];
  v6[4] = v11;
...
LABEL_13:
  ...
  sCntrsCoex = self->_sCntrsCoex;
  if ((unint64_t)sCntrsCoex | *((void *)v4 + 3))
  {
    if (!-[AWDCountersCoexS isEqual:](sCntrsCoex, "isEqual:")) {
      goto LABEL_13;
    }
  }
  sHistCoex = self->_sHistCoex;
  if ((unint64_t)sHistCoex | *((void *)v4 + 4))
  {
    unsigned __int8 v9 = -[AWDHistogramsCoexS isEqual:](sHistCoex, "isEqual:");
...
- (unint64_t)hash
{
  ...
  unint64_t v5 = [(AWDCountersCoexS *)self->_sCntrsCoex hash];
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_sHistCoex, 0);
  objc_storeStrong((id *)&self->_sCntrsCoex, 0);
