...
- (PRBeaconListener)initWithDelegate:(id)a3 queue:(id)a4
{
  ...
  id v7 = a4;
  v25.receiver = self;
  v25.super_class = (Class)PRBeaconListener;
  ...
  if (v8)
  {
    ...
    v22[1] = 3221225472;
    v22[2] = __43__PRBeaconListener_initWithDelegate_queue___block_invoke;
    v22[3] = &unk_1E5999DA8;
    objc_copyWeak(&v23, &location);
    v10 = (void *)MEMORY[0x19F3B9AF0](v22);
    v20[0] = MEMORY[0x1E4F143A8];
    v20[1] = 3221225472;
    v20[2] = __43__PRBeaconListener_initWithDelegate_queue___block_invoke_2;
    v20[3] = &unk_1E5999DA8;
    ...
    v19.receiver = v9;
    v19.super_class = (Class)PRBeaconListener;
...
- (void)pushBeaconAllowlist:(id)a3 completionHandler:(id)a4
{
  id v8 = a3;
  id v6 = a4;
  id v7 = [(NSXPCConnection *)self->_service._connection remoteObjectProxyWithErrorHandler:&__block_literal_global_3];
...
void __37__PRBeaconListener_didFailWithError___block_invoke(uint64_t a1)
{
  ...
  [WeakRetained beaconListener:*(void *)(a1 + 32) didFailWithError:*(void *)(a1 + 40)];
}

- (void)rangingServiceDidUpdateState:(unint64_t)a3 cause:(int64_t)a4
{
  if (a3 <= 4) {
    -[PRBeaconListener _updateState:](self, "_updateState:", qword_19E02CE78[a3], a4);
  }
}
...
{
  if (a3 <= 3) {
    [(PRBeaconListener *)self _updateState:qword_19E02CEA0[a3]];
  }
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (PRBeaconListenerDelegate *)WeakRetained;
}
