...
{
  v52.receiver = self;
  v52.super_class = (Class)NWSUDPSnapshot;
  v3 = [(NWSSnapshot *)&v52 _createCountsForProvider:4];
  v4 = v3;
  if (!v3) {
    goto LABEL_34;
  }
  [v3 setObject:kNStatProviderUDP forKeyedSubscript:kNStatSrcKeyProvider];
  v5 = [(NWSUDPSnapshot *)self localAddress];

  if (v5)
  {
    v6 = (void *)MEMORY[0x263EFF8F8];
    v7 = [(NWSUDPSnapshot *)self localAddress];
    v8 = [v6 dataWithData:v7];
    [v4 setObject:v8 forKeyedSubscript:kNStatSrcKeyLocal];
  }
  v9 = [(NWSUDPSnapshot *)self remoteAddress];

  if (v9)
  {
    v10 = (void *)MEMORY[0x263EFF8F8];
    v11 = [(NWSUDPSnapshot *)self remoteAddress];
...
- (id)description
{
  __ret = 0;
  v7.receiver = self;
  v7.super_class = (Class)NWSUDPSnapshot;
...
{
  v14.receiver = self;
  v14.super_class = (Class)NWSUDPSnapshot;
