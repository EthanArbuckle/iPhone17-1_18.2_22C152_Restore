...
- (NWStatisticsTCPSource)initWithManager:(id)a3 local:(const sockaddr *)a4 remote:(const sockaddr *)a5
{
  ...
  id v8 = a3;
  v24.receiver = self;
  v24.super_class = (Class)NWStatisticsTCPSource;
  v9 = [(NWStatisticsSource *)&v24 initWithManager:v8 source:0 provider:2];
  if (!v9) {
    goto LABEL_5;
  }
  long long v40 = 0u;
...
LABEL_5:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v35 = 2096;
    v36 = a5;
    _os_log_impl(&dword_21C4BC000, v12, OS_LOG_TYPE_INFO, "Manager %p: %s TCP source for local address %{network:sockaddr}.*P, remote address %{network:sockaddr}.*P", buf, 0x36u);
  }
