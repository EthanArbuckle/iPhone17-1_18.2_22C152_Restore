...
+ (id)unc_applicationRecordIfEligibleToDeliverNotificationsForBundleIdentifier:()UserNotificationsCore
{
  ...
  if (v5)
  {
    ...
    v10 = (void *)*MEMORY[0x263F1E088];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F1E088], OS_LOG_TYPE_ERROR)) {
      +[LSApplicationRecord(UserNotificationsCore) unc_applicationRecordIfEligibleToDeliverNotificationsForBundleIdentifier:v10];
    }
  }
  else if ((objc_msgSend(v9, "unc_isEligibleToDeliverNotifications") & 1) == 0)
  {
    UNRegisterUserNotificationsLogging();
    v11 = *MEMORY[0x263F1E088];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F1E088], OS_LOG_TYPE_ERROR)) {
      +[LSApplicationRecord(UserNotificationsCore) unc_applicationRecordIfEligibleToDeliverNotificationsForBundleIdentifier:]((uint64_t)v3, v11);
    }
...
+ (void)_uns_enumerateRecordsWithOptions:()UserNotificationsCore block:
{
  ...
  [v6 setFilter:&__block_literal_global_15];
  long long v14 = 0u;
  long long v15 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
...
+ (void)unc_applicationRecordIfEligibleToDeliverNotificationsForBundleIdentifier:()UserNotificationsCore .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138543362;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_2608DB000, a2, OS_LOG_TYPE_ERROR, "Application record for bundle-id '%{public}@' is ineligible to deliver notifications.", (uint8_t *)&v2, 0xCu);
}
...
+ (void)unc_applicationRecordIfEligibleToDeliverNotificationsForBundleIdentifier:()UserNotificationsCore .cold.2(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  BOOL v4 = a2 != 0;
  id v5 = a3;
  uint64_t v6 = MEMORY[0x2612218B0](v4);
  int v7 = 138543618;
  uint64_t v8 = a1;
  __int16 v9 = 2114;
  uint64_t v10 = v6;
  _os_log_error_impl(&dword_2608DB000, v5, OS_LOG_TYPE_ERROR, "Error looking up application record for bundle-id '%{public}@'. Bundle record exists: '%{public}@'", (uint8_t *)&v7, 0x16u);
}
