      ...
      if (v10)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            char v15 = objc_msgSend(a1, "unc_isToneEnabledForAlertType:topic:", v7, v14);
...
LABEL_14:
    ...
    {
      int v16 = objc_msgSend(a1, "unc_isToneEnabledForAlertType:topic:", v7, 0);
    }
...
- (uint64_t)unc_isToneEnabledForAlertConfiguration:()BulletinBoard
{
  v1 = objc_msgSend(a1, "unc_toneIdentifierForAlertConfiguration:");
  uint64_t v2 = [v1 isEqualToString:*MEMORY[0x263F7FD70]] ^ 1;
