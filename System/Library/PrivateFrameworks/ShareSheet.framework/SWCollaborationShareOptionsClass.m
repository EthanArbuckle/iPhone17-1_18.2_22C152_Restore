...
Class __get_SWCollaborationShareOptionsClass_block_invoke(uint64_t a1)
{
  ...
  if (!SharedWithYouCoreLibraryCore_frameworkLibrary)
  {
    ...
    v4[5] = v4;
    long long v5 = xmmword_1E5A21898;
    uint64_t v6 = 0;
...
LABEL_7:
    v2 = (void *)__get_SWCollaborationShareOptionsClass_block_invoke_cold_1();
LABEL_8:
    free(v2);
  }
  get_SWCollaborationShareOptionsClass_softClass = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  return result;
}
...
{
  v0 = abort_report_np();
  return -[SHSheetGroupActivitySharingController initWithItemProvider:](v0);
}
