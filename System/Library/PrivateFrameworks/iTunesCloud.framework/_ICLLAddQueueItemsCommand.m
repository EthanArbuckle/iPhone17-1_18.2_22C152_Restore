...
LABEL_6:
  ...
  if (*(unsigned char *)&self->_has) {
    uint64_t v6 = 2654435761 * self->_insertPositionType;
  }
  else {
    uint64_t v6 = 0;
  }
  uint64_t v7 = v4 ^ v3 ^ v6 ^ v5;
  NSUInteger v8 = [(NSString *)self->_queueContext hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 4) != 0)
  {
    if ((*((unsigned char *)v4 + 52) & 4) == 0 || self->_revision != *((_DWORD *)v4 + 12)) {
      goto LABEL_24;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 52) & 2) == 0 || self->_position != *((_DWORD *)v4 + 6)) {
      goto LABEL_24;
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v14 = -[NSString copyWithZone:](self->_queueContext, "copyWithZone:", a3, (void)v19);
  v15 = *(void **)(v6 + 32);
  *(void *)(v6 + 32) = v14;
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    long long v14 = [NSNumber numberWithInt:self->_insertPositionType];
...
- (id)description
{
  ...
  id v4 = [(_ICLLAddQueueItemsCommand *)&v8 description];
  uint64_t v5 = [(_ICLLAddQueueItemsCommand *)self dictionaryRepresentation];
