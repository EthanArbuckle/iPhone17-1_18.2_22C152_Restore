...
- (BOOL)readFrom:(id)a3
{
  return _ICLLCurrentItemTransitionCommandReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)_ICLLCurrentItemTransitionCommand;
  id v4 = [(_ICLLCurrentItemTransitionCommand *)&v8 description];
  id v5 = [(_ICLLCurrentItemTransitionCommand *)self dictionaryRepresentation];
