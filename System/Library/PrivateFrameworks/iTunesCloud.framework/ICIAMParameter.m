...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[ICIAMParameter setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[2])
  {
    -[ICIAMParameter setValue:](self, "setValue:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return ICIAMParameterReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)ICIAMParameter;
  id v4 = [(ICIAMParameter *)&v8 description];
  id v5 = [(ICIAMParameter *)self dictionaryRepresentation];
