...
- (void)execute
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1A2D01000, v3, OS_LOG_TYPE_DEFAULT, "%{public}@ Enabling push notifications for type %{public}@ with params %{public}@", buf, 0x20u);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v28 = v23;
        _os_log_impl(&dword_1A2D01000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@ Missing add-push-notification-type-url url in bag - skipping", buf, 0xCu);
      }
...
void __48__ICPushNotificationsEnableTypesRequest_execute__block_invoke_21(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v15 = 2114;
      v16 = v5;
      _os_log_impl(&dword_1A2D01000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@ addPushNotification request failed. err=%{public}@", (uint8_t *)&v13, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v15 = 2114;
      v16 = v6;
      _os_log_impl(&dword_1A2D01000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@ addPushNotification request returned response %{public}@", (uint8_t *)&v13, 0x16u);
    }
...
uint64_t __75__ICPushNotificationsEnableTypesRequest_performRequestWithResponseHandler___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (result) {
    return (*(uint64_t (**)(uint64_t, void, uint64_t))(result + 16))(result, *(void *)(*(void *)(a1 + 32) + 328), a2);
  }
  return result;
}
