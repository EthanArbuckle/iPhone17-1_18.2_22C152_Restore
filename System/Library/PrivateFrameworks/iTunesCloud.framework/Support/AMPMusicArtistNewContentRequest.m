...
{
  v7.receiver = self;
  v7.super_class = (Class)AMPMusicArtistNewContentRequest;
  id v3 = [(AMPMusicArtistNewContentRequest *)&v7 description];
  int v4 = [(AMPMusicArtistNewContentRequest *)self dictionaryRepresentation];
