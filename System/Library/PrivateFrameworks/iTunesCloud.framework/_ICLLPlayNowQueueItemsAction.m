...
- (id)dictionaryRepresentation
{
  ...
  if (radioSource)
  {
    id v18 = [(_ICLLRadioSource *)radioSource dictionaryRepresentation];
...
- (id)description
{
  ...
  id v4 = [(_ICLLPlayNowQueueItemsAction *)&v8 description];
  uint64_t v5 = [(_ICLLPlayNowQueueItemsAction *)self dictionaryRepresentation];
