...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_removedItemIds, 0);
...
- (unint64_t)hash
{
  ...
  uint64_t v6 = v4 ^ v3 ^ v5 ^ [(NSMutableArray *)self->_removedItemIds hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 44) & 2) == 0 || self->_revision != *((_DWORD *)v4 + 10)) {
      goto LABEL_19;
    }
  }
...
LABEL_19:
  ...
  if (has)
  {
    if ((v6 & 1) == 0 || self->_removeType != *((_DWORD *)v4 + 6)) {
      goto LABEL_19;
    }
  }
  else if (v6)
  ...
  if ((unint64_t)removedItemIds | *((void *)v4 + 4)
    && !-[NSMutableArray isEqual:](removedItemIds, "isEqual:"))
  {
    goto LABEL_19;
  }
  queueQuery = self->_queueQuery;
  if ((unint64_t)queueQuery | *((void *)v4 + 2)) {
    char v10 = -[_ICLLQueueQuery isEqual:](queueQuery, "isEqual:");
  }
  else {
    char v10 = 1;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v6 + 8) = v7;
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[_ICLLRemoveQueueItemAction addRemovedItemIds:](v6, v14);
  ...
  id v15 = [(_ICLLQueueQuery *)self->_queueQuery copyWithZone:a3];
  v16 = *(void **)(v6 + 16);
  *(void *)(v6 + 16) = v15;
...
- (void)writeTo:(id)a3
{
  ...
  long long v10 = 0u;
  long long v11 = 0u;
  uint64_t v5 = self->_removedItemIds;
...
- (BOOL)readFrom:(id)a3
{
  return _ICLLRemoveQueueItemActionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (queueQuery)
  {
    uint64_t v9 = [(_ICLLQueueQuery *)queueQuery dictionaryRepresentation];
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_ICLLRemoveQueueItemAction;
  id v4 = [(_ICLLRemoveQueueItemAction *)&v8 description];
  uint64_t v5 = [(_ICLLRemoveQueueItemAction *)self dictionaryRepresentation];
