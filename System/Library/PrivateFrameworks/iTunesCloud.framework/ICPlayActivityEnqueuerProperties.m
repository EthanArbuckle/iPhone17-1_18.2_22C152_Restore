...
- (BOOL)isSBEnabled;
- (ICPlayActivityEnqueuerProperties)initWithCoder:(id)a3;
...
@implementation ICPlayActivityEnqueuerProperties
...
- (ICPlayActivityEnqueuerProperties)initWithCoder:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)ICPlayActivityEnqueuerProperties;
  uint64_t v5 = [(ICPlayActivityEnqueuerProperties *)&v19 init];
  if (v5)
  {
