...
- (BOOL)readFrom:(id)a3
{
  return _ICLLReactionCommandReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)_ICLLReactionCommand;
  id v4 = [(_ICLLReactionCommand *)&v8 description];
  id v5 = [(_ICLLReactionCommand *)self dictionaryRepresentation];
