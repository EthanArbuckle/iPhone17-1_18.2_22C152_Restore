...
- (ICCloudClientCloudService)initWithListenerEndpointProvider:(id)a3
{
  ...
  if (v5)
  {
    ...
    dispatch_queue_t v7 = dispatch_queue_create("com.apple.itunescloudd.ICCloudClientCloudService.serial.queue", 0);
...
- (void)dealloc
{
  ...
  [(ICCloudClientCloudService *)&v4 dealloc];
}
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134217984;
      uint64_t v21 = v4;
      _os_log_impl(&dword_1A2D01000, v3, OS_LOG_TYPE_DEFAULT, "ICCloudClientCloudService %p - Creating XPC Client Connection [started]", buf, 0xCu);
    }

    v5 = [*(id *)(a1 + 32) listenerEndpointProvider];
    id v19 = 0;
    v6 = [v5 listenerEndpointForService:3 error:&v19];
    id v7 = v19;
...
- (id)_xpcConnectionWithListenerEndpoint:(id)a3
{
  ...
  if (v4)
  {
    ...
    v6 = [MEMORY[0x1E4F29280] interfaceWithProtocol:&unk_1EF67B720];
    id v7 = (void *)MEMORY[0x1E4F1CAD0];
    uint64_t v8 = objc_opt_class();
    uint64_t v9 = objc_msgSend(v7, "setWithObjects:", v8, objc_opt_class(), 0);
    [v6 setClasses:v9 forSelector:sel_loadBooksForStoreIDs_configuration_completion_ argumentIndex:0 ofReply:1];
    ...
    v13[1] = 3221225472;
    v13[2] = __64__ICCloudClientCloudService__xpcConnectionWithListenerEndpoint___block_invoke;
    v13[3] = &unk_1E5ACD778;
    objc_copyWeak(&v14, location);
    [v5 setInterruptionHandler:v13];
    v11[0] = MEMORY[0x1E4F143A8];
    v11[1] = 3221225472;
    v11[2] = __64__ICCloudClientCloudService__xpcConnectionWithListenerEndpoint___block_invoke_164;
    v11[3] = &unk_1E5ACD778;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = self;
      _os_log_impl(&dword_1A2D01000, v6, OS_LOG_TYPE_ERROR, "ICCloudClientCloudService %p - Unable to create XPC Connection [no listener endpoint]", (uint8_t *)location, 0xCu);
    }
    v5 = 0;
  }
...
- (NSXPCConnection)xpcConnection
{
  ...
  objc_super v10 = __Block_byref_object_copy__1106;
  v11 = __Block_byref_object_dispose__1107;
  id v12 = 0;
...
void __64__ICCloudClientCloudService__xpcConnectionWithListenerEndpoint___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 134217984;
    id v8 = WeakRetained;
    _os_log_impl(&dword_1A2D01000, v2, OS_LOG_TYPE_DEFAULT, "ICCloudClientCloudService %p - Connection to cloud availability service interrupted", buf, 0xCu);
  }
...
void __64__ICCloudClientCloudService__xpcConnectionWithListenerEndpoint___block_invoke_164(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 134217984;
    id v8 = WeakRetained;
    _os_log_impl(&dword_1A2D01000, v2, OS_LOG_TYPE_DEFAULT, "ICCloudClientCloudService %p - Connection to cloud availability service invalidated", buf, 0xCu);
  }
...
void __64__ICCloudClientCloudService__xpcConnectionWithListenerEndpoint___block_invoke_165(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v6 = 134217984;
    uint64_t v7 = v3;
    _os_log_impl(&dword_1A2D01000, v2, OS_LOG_TYPE_DEFAULT, "ICCloudClientCloudService %p - Resetting XPC connection to nil", (uint8_t *)&v6, 0xCu);
  }
