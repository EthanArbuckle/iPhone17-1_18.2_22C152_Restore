...
LABEL_17:
  ...
  if ((unint64_t)queueContext | *((void *)v4 + 3)) {
    char v9 = -[NSString isEqual:](queueContext, "isEqual:");
  }
  else {
    char v9 = 1;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v6 + 8) = v7;
  ...
  uint64_t v9 = [(NSString *)self->_queueContext copyWithZone:a3];
  v10 = *(void **)(v6 + 24);
  *(void *)(v6 + 24) = v9;
...
- (BOOL)readFrom:(id)a3
{
  return _ICLLMoveQueueItemCommandReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)_ICLLMoveQueueItemCommand;
  id v4 = [(_ICLLMoveQueueItemCommand *)&v8 description];
  id v5 = [(_ICLLMoveQueueItemCommand *)self dictionaryRepresentation];
