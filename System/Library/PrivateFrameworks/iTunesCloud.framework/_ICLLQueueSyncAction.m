...
- (BOOL)readFrom:(id)a3
{
  return _ICLLQueueSyncActionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)_ICLLQueueSyncAction;
  id v4 = [(_ICLLQueueSyncAction *)&v8 description];
  id v5 = [(_ICLLQueueSyncAction *)self dictionaryRepresentation];
