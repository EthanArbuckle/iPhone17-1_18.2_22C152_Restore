...
+ (id)sharedInstanceWithPixelFormat:(unint64_t)a3
{
  ...
  if (!qword_10003CB70)
  {
    ...
    v6 = (void *)qword_10003CB70;
    qword_10003CB70 = (uint64_t)v5;
  }
  objc_sync_exit(v4);

  v7 = (void *)qword_10003CB70;
  if (*(void *)(qword_10003CB70 + 32) != a3) {
    sub_100028C68();
  }
  return v7;
}
...
- (void)_asyncDeallocInstance
{
  ...
  if (v2)
  {
    _[v3 _deallocInstance:0];
  }
  else
  {
    _objc_msgSend(v3, "performSelectorOnMainThread:withObject:waitUntilDone:", "_deallocInstance:");
  }
}
...
- (void)_loadMTLBufferData
{
  id v3 = [(MTLDevice *)self->_device newBufferWithLength:128 options:0];
  id v4 = (float32x2_t *)[v3 contents];
  *(_OWORD *)v4->f32 = xmmword_10002BB00;
  *(_OWORD *)v4[2].f32 = unk_10002BB10;
  uint64_t v5 = v4 + 5;
  int v6 = 17;
  uint64_t v7 = 6;
...
- (id)_pipelineStateForShaderType:(unint64_t)a3 vertexName:(id)a4 fragmentName:(id)a5 inLibrary:(id)a6 archive:(id)a7 allowsBlending:(BOOL)a8
{
  ...
  uint64_t v19 = +[NSString stringWithFormat:@"%@_blend_%@", *(&off_1000350C0 + a3), v18];
  BOOL v50 = v8;
  v20 = objc_opt_new();
  ...
  id v22 = [v17 newFunctionInLibrary:v16 withDescriptor:v21];
  v48 = v15;
  [v21 setName:v15];
  v46 = v16;
  id v23 = [v17 newFunctionInLibrary:v16 withDescriptor:v21];
  ...
  id v42 = [v17 newRenderPipelineStateForDevice:self->_device withDescriptor:v24];
  if (!v42) {
    sub_100028C94();
  }
  v43 = v42;
...
- (void)_queue_setupPipelineForType:(unint64_t)a3 vertexName:(id)a4 fragmentName:(id)a5 inLibrary:(id)a6 archive:(id)a7
{
  ...
  CFStringRef v18 = (void *)*((void *)v17 + 5);
  *((void *)v17 + 5) = v16;
...
{
  device = self->_device;
  if (qword_10003CB80 != -1) {
    dispatch_once(&qword_10003CB80, &stru_100035100);
  }
  id v8 = 0;
  id v4 = (id)qword_10003CB78;
  id v5 = [(MTLDevice *)device newDefaultLibraryWithBundle:v4 error:&v8];
  id v6 = v8;

  uint64_t v7 = +[CLKUIMetalBinaryArchive archiveWithName:@"NTKKaleidoscopeShaders" bundle:self->_bundle device:self->_device];
