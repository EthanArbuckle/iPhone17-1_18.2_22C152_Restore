@interface BMProactiveHarvestingParsecSearchEntityTopic
+ (id)columns;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMProactiveHarvestingParsecSearchEntityTopic *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMProactiveHarvestingParsecSearchEntityTopic *)self identifier];
      v10 = [v5 identifier];
    ...
    if (![(BMProactiveHarvestingParsecSearchEntityTopic *)self hasScore]
      && ![v5 hasScore])
    {
      BOOL v12 = 1;
      goto LABEL_13;
    ...
    if ([(BMProactiveHarvestingParsecSearchEntityTopic *)self hasScore]
      && [v5 hasScore])
    {
      [(BMProactiveHarvestingParsecSearchEntityTopic *)self score];
      double v14 = v13;
      [v5 score];
      BOOL v12 = v14 == v15;
LABEL_13:
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMProactiveHarvestingParsecSearchEntityTopic *)self identifier];
  if (![(BMProactiveHarvestingParsecSearchEntityTopic *)self hasScore]
    || ([(BMProactiveHarvestingParsecSearchEntityTopic *)self score], fabs(v4) == INFINITY))
  {
    v6 = 0;
  }
  else
...
- (BMProactiveHarvestingParsecSearchEntityTopic)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  self = [(BMProactiveHarvestingParsecSearchEntityTopic *)self initWithIdentifier:v8 score:v10];
  int v11 = self;
LABEL_8:
...
{
  v3 = objc_opt_new();
  [(BMProactiveHarvestingParsecSearchEntityTopic *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = [(BMProactiveHarvestingParsecSearchEntityTopic *)self identifier];
  id v5 = NSNumber;
  [(BMProactiveHarvestingParsecSearchEntityTopic *)self score];
  id v6 = objc_msgSend(v5, "numberWithDouble:");
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMProactiveHarvestingParsecSearchEntityTopic with identifier: %@, score: %@", v4, v6];
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"score" number:2 type:1 subMessageClass:0];
  v6[1] = v3;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"score" dataType:1 requestOnly:0 fieldNumber:2 protoDataType:1 convertedType:0];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 2)
  {
    ...
    id v7 = [[BMProactiveHarvestingParsecSearchEntityTopic alloc] initByReadFrom:v6];
    id v8 = v7;
    if (v7) {
      v7[5] = 2;
    }
