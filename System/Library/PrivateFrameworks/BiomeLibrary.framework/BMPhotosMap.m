@interface BMPhotosMap
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosMap)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosMap)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosMap *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosMap *)self identifier];
      v10 = [v5 identifier];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosMap *)self identifier];
  id v4 = [(BMPhotosMap *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosMap type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        objc_msgSend(NSNumber, "numberWithInt:", bsearch_b(v11, BMPhotosMapTypeFromString_sortedStrings, 1uLL, 8uLL, &__block_literal_global_77572) != 0);
    ...
    self = -[BMPhotosMap initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, [v12 intValue]);
    v16 = self;
LABEL_24:
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosMap;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosMap *)self identifier];
  id v5 = [(BMPhotosMap *)self subset];
  id v6 = BMPhotosMapTypeAsString([(BMPhotosMap *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosMap with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosMap)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosMap;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosMap alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
