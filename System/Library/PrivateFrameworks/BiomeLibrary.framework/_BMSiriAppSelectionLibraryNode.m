...
+ (id)configurationForMusic
{
  ...
  v13 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"F04191E2-A706-4693-9A55-7C017291F227"];
  BYTE2(v16) = 1;
  LOWORD(v16) = 1;
  v14 = objc_msgSend(v12, "_libraryStreamConfigurationWithUUID:streamIdentifier:eventClass:storeConfig:syncPolicy:legacyNames:internalMetadata:enableSubscriptions:enableSubscriptionSubstream:enableTombstoneSubstream:allowedClients:pruningTriggers:spaceAttributionOwner:", v13, @"Siri.AppSelection.Music", objc_opt_class(), v3, v4, 0, 0, v16, 0, v11, 0, v17[0]);
...
+ (id)storeConfigurationForMusic
{
  id v2 = (void *)[objc_alloc(MEMORY[0x1E4F50268]) initPruneOnAccess:0 filterByAgeOnRead:0 maxAge:52428800 maxStreamSize:10000 maxEventCount:15552000.0];
  v3 = (void *)[MEMORY[0x1E4F50278] newLibraryStoreConfigForStreamIdentifier:@"Siri.AppSelection.Music" domain:0 segmentSize:0x100000 protectionClass:3 pruningPolicy:v2];
...
+ (id)Music
{
  ...
  id v2 = [a1 configurationForMusic];
  ...
  v9 = (void *)[objc_alloc(MEMORY[0x1E4F50428]) initWithTableName:@"Siri.AppSelection.Music" columns:v8];
  v10 = (void *)[objc_alloc(MEMORY[0x1E4F50498]) initWithIdentifier:@"Siri.AppSelection.Music" schema:v9 configuration:v2];
