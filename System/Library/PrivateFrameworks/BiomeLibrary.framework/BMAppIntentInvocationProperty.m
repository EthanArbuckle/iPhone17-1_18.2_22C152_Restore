...
- (BMAppIntentInvocationProperty)initWithIdentifier:(id)a3 value:(id)a4;
- (BMAppIntentInvocationProperty)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMAppIntentInvocationProperty *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMAppIntentInvocationProperty *)self identifier];
      v10 = [v5 identifier];
...
LABEL_11:
    ...
    v13 = [(BMAppIntentInvocationProperty *)self value];
    v14 = [v5 value];
    if (v13 == v14)
    {
      char v12 = 1;
    ...
    {
      v15 = [(BMAppIntentInvocationProperty *)self value];
      v16 = [v5 value];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMAppIntentInvocationProperty *)self identifier];
  id v4 = [(BMAppIntentInvocationProperty *)self value];
...
- (BMAppIntentInvocationProperty)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      v9 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"identifier"];
      v26[0] = v9;
...
LABEL_7:
  ...
  if (objc_opt_isKindOfClass())
  {
    id v13 = v9;
    id v22 = 0;
    v10 = [[BMAppIntentInvocationValue alloc] initWithJSONDictionary:v13 error:&v22];
    id v14 = v22;
    if (v14)
    {
      v15 = v14;
  ...
  v10 = (BMAppIntentInvocationValue *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"value"];
  v24 = v10;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v26.receiver = self;
  v26.super_class = (Class)BMAppIntentInvocationProperty;
...
LABEL_15:
      ...
      if ((v12 >> 3) == 2)
      {
        ...
        id v22 = [[BMAppIntentInvocationValue alloc] initByReadFrom:v4];
        if (!v22) {
          goto LABEL_28;
        }
        value = v5->_value;
...
- (NSString)description
{
  ...
  id v4 = [(BMAppIntentInvocationProperty *)self identifier];
  id v5 = [(BMAppIntentInvocationProperty *)self value];
  id v6 = (void *)[v3 initWithFormat:@"BMAppIntentInvocationProperty with identifier: %@, value: %@", v4, v5];
...
- (BMAppIntentInvocationProperty)initWithIdentifier:(id)a3 value:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMAppIntentInvocationProperty;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"value_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_760];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMAppIntentInvocationProperty alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
