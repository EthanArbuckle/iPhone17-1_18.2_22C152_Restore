...
- (BMOasisAnalyticsTrackingLostEvent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMOasisAnalyticsTrackingLostEvent)initWithQualityTrace:(id)a3 metadata:(id)a4 payload:(id)a5;
- (BMOasisAnalyticsTrackingLostType)payload;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMOasisAnalyticsTrackingLostEvent *)self qualityTrace];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMOasisAnalyticsTrackingLostEvent *)self qualityTrace];
      v10 = [v5 qualityTrace];
    ...
    v13 = [(BMOasisAnalyticsTrackingLostEvent *)self metadata];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMOasisAnalyticsTrackingLostEvent *)self metadata];
      v17 = [v5 metadata];
...
LABEL_15:
    ...
    v19 = [(BMOasisAnalyticsTrackingLostEvent *)self payload];
    v20 = [v5 payload];
    if (v19 == v20)
    {
      char v12 = 1;
    ...
    {
      v21 = [(BMOasisAnalyticsTrackingLostEvent *)self payload];
      v22 = [v5 payload];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMOasisAnalyticsTrackingLostEvent *)self qualityTrace];
  id v4 = [v3 jsonDictionary];

  id v5 = [(BMOasisAnalyticsTrackingLostEvent *)self metadata];
  v6 = [v5 jsonDictionary];

  uint64_t v7 = [(BMOasisAnalyticsTrackingLostEvent *)self payload];
...
LABEL_12:
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        id v19 = v11;
        id v31 = 0;
        char v12 = [[BMOasisAnalyticsTrackingLostType alloc] initWithJSONDictionary:v19 error:&v31];
        id v20 = v31;
        if (v20)
        {
          v21 = v20;
      ...
      if (a4)
      {
        ...
        char v12 = (BMOasisAnalyticsTrackingLostType *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"payload"];
        v35 = v12;
...
- (void)writeTo:(id)a3
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMOasisAnalyticsTrackingLostType *)self->_payload writeTo:v4];
    PBDataWriterRecallMark();
  }
}
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v26.receiver = self;
  v26.super_class = (Class)BMOasisAnalyticsTrackingLostEvent;
...
LABEL_15:
      ...
      else if (v20 == 2)
      {
        ...
        v21 = [[BMOasisAnalyticsTrackingLostType alloc] initByReadFrom:v4];
        if (!v21) {
          goto LABEL_35;
        }
        uint64_t v22 = 40;
...
- (NSString)description
{
  ...
  id v4 = [(BMOasisAnalyticsTrackingLostEvent *)self qualityTrace];
  id v5 = [(BMOasisAnalyticsTrackingLostEvent *)self metadata];
  id v6 = [(BMOasisAnalyticsTrackingLostEvent *)self payload];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMOasisAnalyticsTrackingLostEvent with qualityTrace: %@, metadata: %@, payload: %@", v4, v5, v6];
...
- (BMOasisAnalyticsTrackingLostEvent)initWithQualityTrace:(id)a3 metadata:(id)a4 payload:(id)a5
{
  ...
  id v11 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMOasisAnalyticsTrackingLostEvent;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF78D8;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"qualityTrace_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_572];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"metadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_574];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"payload_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_576];
  v7[0] = v3;
  v7[1] = v4;
  v7[2] = v2;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
