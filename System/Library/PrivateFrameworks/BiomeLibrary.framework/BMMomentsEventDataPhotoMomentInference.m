@interface BMMomentsEventDataPhotoMomentInference
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMMomentsEventDataPhotoMomentInference)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMMomentsEventDataPhotoMomentInference)initWithType:(int)a3;
- (BOOL)isEqual:(id)a3;
...
@implementation BMMomentsEventDataPhotoMomentInference
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    int v6 = [(BMMomentsEventDataPhotoMomentInference *)self type];
    int v7 = [v5 type];
...
- (id)jsonDictionary
{
  ...
  v2 = objc_msgSend(NSNumber, "numberWithInt:", -[BMMomentsEventDataPhotoMomentInference type](self, "type"));
  int v6 = @"type";
  v3 = v2;
  if (!v2)
  {
...
- (BMMomentsEventDataPhotoMomentInference)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_9:
    self = -[BMMomentsEventDataPhotoMomentInference initWithType:](self, "initWithType:", [a4 intValue]);
    BOOL v8 = self;
    goto LABEL_10;
  }
  objc_opt_class();
...
LABEL_8:
  ...
  if (objc_opt_isKindOfClass())
  {
    int v7 = [NSNumber numberWithInt:BMMomentsEventDataPhotoMomentInferenceTypeFromString(v6)];
    goto LABEL_8;
  }
  if (a4)
  {
...
{
  v3 = objc_opt_new();
  [(BMMomentsEventDataPhotoMomentInference *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)BMMomentsEventDataPhotoMomentInference;
...
- (NSString)description
{
  ...
  id v4 = BMMomentsEventDataPhotoMomentInferenceTypeAsString([(BMMomentsEventDataPhotoMomentInference *)self type]);
  id v5 = (void *)[v3 initWithFormat:@"BMMomentsEventDataPhotoMomentInference with type: %@", v4];
...
{
  v6.receiver = self;
  v6.super_class = (Class)BMMomentsEventDataPhotoMomentInference;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    BOOL v8 = [[BMMomentsEventDataPhotoMomentInference alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
