...
- (BMPhotosDelete)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosDelete)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosDelete *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosDelete *)self identifier];
      v10 = [v5 identifier];
    ...
    v13 = [(BMPhotosDelete *)self subset];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMPhotosDelete *)self subset];
      v17 = [v5 subset];
...
LABEL_12:
    ...
    int v19 = [(BMPhotosDelete *)self type];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosDelete *)self identifier];
  id v4 = [(BMPhotosDelete *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosDelete type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        id v13 = [NSNumber numberWithInt:BMPhotosDeleteTypeFromString(v11)];
      }
      BOOL v12 = v13;
    }
    else
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosDelete;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosDelete *)self identifier];
  id v5 = [(BMPhotosDelete *)self subset];
  id v6 = BMPhotosDeleteTypeAsString([(BMPhotosDelete *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosDelete with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosDelete)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosDelete;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosDelete alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
