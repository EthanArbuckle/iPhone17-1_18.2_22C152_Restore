@interface BMIntelligencePlatformFeatureStoreFeatureValueNamedValue
+ (id)columns;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self name];
    uint64_t v7 = [v5 name];
    if (v6 == (void *)v7)
    {
    }
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self name];
      v10 = [v5 name];
...
LABEL_11:
    ...
    v13 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self value];
    v14 = [v5 value];
    if (v13 == v14)
    {
      char v12 = 1;
    ...
    {
      v15 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self value];
      v16 = [v5 value];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self name];
  id v4 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self value];
...
- (BMIntelligencePlatformFeatureStoreFeatureValueNamedValue)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      v9 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"name"];
      v26[0] = v9;
  ...
  if (!v9 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v10 = 0;
LABEL_7:
    self = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self initWithName:v8 value:v10];
    int v11 = self;
    goto LABEL_8;
  }
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    id v13 = v9;
    id v22 = 0;
    v10 = [[BMIntelligencePlatformFeatureStoreFeatureValueBasicValue alloc] initWithJSONDictionary:v13 error:&v22];
    id v14 = v22;
    if (v14)
    {
      v15 = v14;
  ...
  v10 = (BMIntelligencePlatformFeatureStoreFeatureValueBasicValue *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"value"];
  v24 = v10;
...
{
  v3 = objc_opt_new();
  [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self writeTo:v3];
...
LABEL_15:
      ...
      if ((v12 >> 3) == 2)
      {
        ...
        id v22 = [[BMIntelligencePlatformFeatureStoreFeatureValueBasicValue alloc] initByReadFrom:v4];
        if (!v22) {
          goto LABEL_28;
        }
        value = v5->_value;
...
- (NSString)description
{
  ...
  id v4 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self name];
  id v5 = [(BMIntelligencePlatformFeatureStoreFeatureValueNamedValue *)self value];
  id v6 = (void *)[v3 initWithFormat:@"BMIntelligencePlatformFeatureStoreFeatureValueNamedValue with name: %@, value: %@", v4, v5];
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"value_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_175];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMIntelligencePlatformFeatureStoreFeatureValueNamedValue alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
