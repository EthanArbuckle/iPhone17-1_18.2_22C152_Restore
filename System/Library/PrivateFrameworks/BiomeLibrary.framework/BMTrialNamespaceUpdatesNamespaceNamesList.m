...
- (id)_namespaceNameJSONArray
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v4 = [(BMTrialNamespaceUpdatesNamespaceNamesList *)self namespaceName];
...
- (BMTrialNamespaceUpdatesNamespaceNamesList)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  id v6 = [a3 objectForKeyedSubscript:@"namespaceName"];
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (p_isa)
        {
          ...
          v17 = (void *)[v23 initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"namespaceName", (void)v28];
          v33 = v17;
...
LABEL_22:
    ...
    if (p_isa)
    {
      ...
      v17 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type null for element of %@, must not be null", @"namespaceName"];
      v35 = v17;
...
LABEL_20:
  ...
  if (p_isa)
  {
    ...
    v9 = (void *)[[NSString alloc] initWithFormat:@"Expecting %@ as an array", @"namespaceName"];
    v38[0] = v9;
...
LABEL_23:
  ...
  return (BMTrialNamespaceUpdatesNamespaceNamesList *)p_isa;
}
...
- (void)writeTo:(id)a3
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  uint64_t v5 = self->_namespaceName;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMTrialNamespaceUpdatesNamespaceNamesList;
...
- (NSString)description
{
  ...
  id v4 = [(BMTrialNamespaceUpdatesNamespaceNamesList *)self namespaceName];
  uint64_t v5 = (void *)[v3 initWithFormat:@"BMTrialNamespaceUpdatesNamespaceNamesList with namespaceName: %@", v4];
...
- (BMTrialNamespaceUpdatesNamespaceNamesList)initWithNamespaceName:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMTrialNamespaceUpdatesNamespaceNamesList;
  uint64_t v6 = [(BMEventBase *)&v8 init];
  if (v6)
  {
    v6->_dataVersion = [(id)objc_opt_class() latestDataVersion];
    objc_storeStrong((id *)&v6->_namespaceName, a3);
  }
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"namespaceName" number:1 type:13 subMessageClass:0];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF75C0;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"namespaceName_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_40];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
id __52__BMTrialNamespaceUpdatesNamespaceNamesList_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = [v2 _namespaceNameJSONArray];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMTrialNamespaceUpdatesNamespaceNamesList alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
