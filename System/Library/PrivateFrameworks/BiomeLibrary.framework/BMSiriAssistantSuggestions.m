...
- (id)jsonDictionary
{
  ...
  id v5 = [(BMSiriAssistantSuggestions *)self _entitiesJSONArray];
  v10[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMSiriAssistantSuggestions *)self entities];
...
LABEL_19:
  ...
  v8 = v41;
  self = [(BMSiriAssistantSuggestions *)self initWithInteraction:v41 entities:v12];
  v22 = self;
  uint64_t v7 = v39;
  id v6 = v40;
LABEL_36:
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)BMSiriAssistantSuggestions;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriAssistantSuggestions *)self interaction];
  uint64_t v5 = [(BMSiriAssistantSuggestions *)self entities];
  uint64_t v6 = (void *)[v3 initWithFormat:@"BMSiriAssistantSuggestions with interaction: %@, entities: %@", v4, v5];
...
- (BMSiriAssistantSuggestions)initWithInteraction:(id)a3 entities:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMSiriAssistantSuggestions;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5B98;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_53910];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35_53911];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriAssistantSuggestions alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
