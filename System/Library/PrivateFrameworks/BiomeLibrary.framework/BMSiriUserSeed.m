...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v13 = [(BMSiriUserSeed *)self effectiveFrom];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMSiriUserSeed *)self effectiveFrom];
    ...
    if (-[BMSiriUserSeed hasValidityDays](self, "hasValidityDays") || [v5 hasValidityDays])
    {
      ...
      unsigned int v19 = [(BMSiriUserSeed *)self validityDays];
      if (v19 != [v5 validityDays]) {
        goto LABEL_29;
      }
    }
    v20 = [(BMSiriUserSeed *)self createdOn];
    ...
    {
      v22 = (void *)v21;
      v23 = [(BMSiriUserSeed *)self createdOn];
      v24 = [v5 createdOn];
    ...
    v26 = [(BMSiriUserSeed *)self adoptedOn];
    ...
    {
      v28 = (void *)v27;
      v29 = [(BMSiriUserSeed *)self adoptedOn];
      v30 = [v5 adoptedOn];
    ...
    if ([(BMSiriUserSeed *)self hasSwitchedCount]
      && [v5 hasSwitchedCount])
    {
      unsigned int v32 = [(BMSiriUserSeed *)self switchedCount];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMSiriUserSeed *)self seed];
  uint64_t v4 = [v3 UUIDString];

  id v5 = [(BMSiriUserSeed *)self effectiveFrom];
  if (v5)
  {
    v6 = NSNumber;
    uint64_t v7 = [(BMSiriUserSeed *)self effectiveFrom];
  ...
  if ([(BMSiriUserSeed *)self hasValidityDays])
  {
    v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserSeed validityDays](self, "validityDays"));
  }
  else
  {
    v9 = 0;
  }
  v10 = [(BMSiriUserSeed *)self createdOn];
  if (v10)
  {
    int v11 = NSNumber;
    BOOL v12 = [(BMSiriUserSeed *)self createdOn];
  ...
  uint64_t v14 = [(BMSiriUserSeed *)self adoptedOn];
  if (v14)
  {
    v15 = NSNumber;
    v16 = [(BMSiriUserSeed *)self adoptedOn];
  ...
  if ([(BMSiriUserSeed *)self hasSwitchedCount])
  {
    int v18 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserSeed switchedCount](self, "switchedCount"));
  }
  else
  {
    int v18 = 0;
...
- (BMSiriUserSeed)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"seed"];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (!v11)
    {
      if (a4)
      {
        ...
        v72 = (void *)[[NSString alloc] initWithFormat:@"-initWithUUIDString: for %@ returned nil", @"seed"];
        v86[0] = v72;
...
LABEL_40:
    ...
    v22 = [(BMSiriUserSeed *)v37 initWithSeed:v68 effectiveFrom:v70 validityDays:v69 createdOn:v26 adoptedOn:v38 switchedCount:v47];
    v37 = v22;
LABEL_44:
  ...
  id v8 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"seed"];
  id v84 = v8;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriUserSeed *)self seed];
  id v5 = [(BMSiriUserSeed *)self effectiveFrom];
  id v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserSeed validityDays](self, "validityDays"));
  uint64_t v7 = [(BMSiriUserSeed *)self createdOn];
  id v8 = [(BMSiriUserSeed *)self adoptedOn];
  uint64_t v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserSeed switchedCount](self, "switchedCount"));
  char v10 = (void *)[v3 initWithFormat:@"BMSiriUserSeed with seed: %@, effectiveFrom: %@, validityDays: %@, createdOn: %@, adoptedOn: %@, switchedCount: %@", v4, v5, v6, v7, v8, v9];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"seed" number:1 type:14 subMessageClass:0];
  v10[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5A60;
}

+ (id)columns
{
  v10[6] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"seed" dataType:6 requestOnly:0 fieldNumber:1 protoDataType:14 convertedType:3];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriUserSeed alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[19] = 0;
    }
