...
- (BMOasisAnalyticsDeviceWornPayload)payload;
- (BOOL)isEqual:(id)a3;
...
LABEL_12:
  ...
  if (p_isa)
  {
    ...
    v7 = (BMOasisAnalyticsDeviceWornPayload *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"payload"];
    v17[0] = v7;
...
LABEL_14:
  ...
  return (BMOasisAnalyticsDeviceWorn *)p_isa;
}
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)BMOasisAnalyticsDeviceWorn;
...
LABEL_15:
      ...
      if ((v12 >> 3) == 1)
      {
        ...
        v19 = [[BMOasisAnalyticsDeviceWornPayload alloc] initByReadFrom:v4];
        if (!v19) {
          goto LABEL_26;
        }
        payload = v5->_payload;
...
- (NSString)description
{
  ...
  id v4 = [(BMOasisAnalyticsDeviceWorn *)self payload];
  id v5 = (void *)[v3 initWithFormat:@"BMOasisAnalyticsDeviceWorn with payload: %@", v4];
...
- (BMOasisAnalyticsDeviceWorn)initWithPayload:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMOasisAnalyticsDeviceWorn;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF77E8;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"payload_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_204];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMOasisAnalyticsDeviceWorn alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
