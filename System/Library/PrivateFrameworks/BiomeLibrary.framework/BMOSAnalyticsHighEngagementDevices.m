...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v26 = [v5 highEngagementCategory1];
    if (v25 == (void *)v26)
    {
    }
    else
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMOSAnalyticsHighEngagementDevices *)self topCategory2];
  id v5 = [(BMOSAnalyticsHighEngagementDevices *)self topCategory3];
  v6 = [(BMOSAnalyticsHighEngagementDevices *)self highEngagementCategory1];
  uint64_t v7 = [(BMOSAnalyticsHighEngagementDevices *)self highEngagementCategory2];
  v17 = @"topCategory1";
  ...
  v22[2] = v10;
  uint64_t v20 = @"highEngagementCategory1";
  int v11 = v6;
  if (!v6)
  {
...
- (BMOSAnalyticsHighEngagementDevices)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"topCategory1"];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v35 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"topCategory2"];
        id v45 = v35;
    ...
    if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v13 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"topCategory3"];
        id v43 = v13;
...
LABEL_19:
    ...
    int v11 = [v6 objectForKeyedSubscript:@"highEngagementCategory1"];
    char v12 = a4;
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"highEngagementCategory1"];
        id v41 = v15;
    ...
    uint64_t v14 = [v6 objectForKeyedSubscript:@"highEngagementCategory2"];
    if (v14 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (v12)
        {
          ...
          v28 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"highEngagementCategory2"];
          v39 = v28;
    ...
    v16 = [(BMOSAnalyticsHighEngagementDevices *)v36 initWithTopCategory1:v34 topCategory2:v37 topCategory3:v35 highEngagementCategory1:v13 highEngagementCategory2:v15];
    v36 = v16;
LABEL_17:
  ...
  id v37 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"topCategory1"];
  v47[0] = v37;
...
- (NSString)description
{
  ...
  id v4 = [(BMOSAnalyticsHighEngagementDevices *)self topCategory1];
  id v5 = [(BMOSAnalyticsHighEngagementDevices *)self topCategory2];
  id v6 = [(BMOSAnalyticsHighEngagementDevices *)self topCategory3];
  uint64_t v7 = [(BMOSAnalyticsHighEngagementDevices *)self highEngagementCategory1];
  id v8 = [(BMOSAnalyticsHighEngagementDevices *)self highEngagementCategory2];
  v9 = (void *)[v3 initWithFormat:@"BMOSAnalyticsHighEngagementDevices with topCategory1: %@, topCategory2: %@, topCategory3: %@, highEngagementCategory1: %@, highEngagementCategory2: %@", v4, v5, v6, v7, v8];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"topCategory1" number:1 type:13 subMessageClass:0];
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"topCategory2", 2, 13, 0, v2);
  v9[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"topCategory3" number:3 type:13 subMessageClass:0];
  v9[2] = v4;
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"highEngagementCategory1" number:4 type:13 subMessageClass:0];
  v9[3] = v5;
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"highEngagementCategory2" number:5 type:13 subMessageClass:0];
  v9[4] = v6;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF3408;
}

+ (id)columns
{
  v9[5] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"topCategory1" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"topCategory2" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"topCategory3" dataType:2 requestOnly:0 fieldNumber:3 protoDataType:13 convertedType:0];
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"highEngagementCategory1" dataType:2 requestOnly:0 fieldNumber:4 protoDataType:13 convertedType:0];
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"highEngagementCategory2" dataType:2 requestOnly:0 fieldNumber:5 protoDataType:13 convertedType:0];
  v9[0] = v2;
  v9[1] = v3;
  v9[2] = v4;
  v9[3] = v5;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMOSAnalyticsHighEngagementDevices alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
