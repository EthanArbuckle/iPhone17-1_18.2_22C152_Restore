@interface BMScreenRecording
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMScreenRecording)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMScreenRecording)initWithStarting:(id)a3;
- (BOOL)hasStarting;
- (BOOL)isEqual:(id)a3;
- (BOOL)starting;
...
@implementation BMScreenRecording
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (-[BMScreenRecording hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMScreenRecording hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        BOOL v6 = [(BMScreenRecording *)self starting];
...
- (id)jsonDictionary
{
  ...
  if ([(BMScreenRecording *)self hasStarting])
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMScreenRecording starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (BMScreenRecording)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMScreenRecording *)self initWithStarting:a4];
    int v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)serialize
{
  ...
  [(BMScreenRecording *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMScreenRecording;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMScreenRecording starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMScreenRecording with starting: %@", v4];
...
- (BMScreenRecording)initWithStarting:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)BMScreenRecording;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 1)
  {
    ...
    id v5 = a3;
    BOOL v6 = (void *)[[v4 alloc] initWithData:v5];

    objc_super v7 = [[BMScreenRecording alloc] initByReadFrom:v6];
    v8 = v7;
    if (v7) {
      v7[5] = 1;
    }
