...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (![(BMUserFocusDoNotDisturbWhileDriving *)self hasStarting]
      && ![v5 hasStarting]
      || [(BMUserFocusDoNotDisturbWhileDriving *)self hasStarting]
      && [v5 hasStarting]
      && (int v6 = [(BMUserFocusDoNotDisturbWhileDriving *)self starting],
          v6 == [v5 starting]))
    {
      int v8 = [(BMUserFocusDoNotDisturbWhileDriving *)self reason];
...
- (id)jsonDictionary
{
  ...
  if ([(BMUserFocusDoNotDisturbWhileDriving *)self hasStarting])
  {
    v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMUserFocusDoNotDisturbWhileDriving starting](self, "starting"));
  }
  else
  {
    v3 = 0;
  }
  id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[BMUserFocusDoNotDisturbWhileDriving reason](self, "reason"));
  v9[0] = @"starting";
  id v5 = v3;
  if (!v3)
  {
...
- (BMUserFocusDoNotDisturbWhileDriving)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      id v11 = [NSNumber numberWithInt:BMUserFocusDoNotDisturbWhileDrivingReasonFromString(v9)];
    }
    v10 = v11;
  }
  else
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v33.receiver = self;
  v33.super_class = (Class)BMUserFocusDoNotDisturbWhileDriving;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMUserFocusDoNotDisturbWhileDriving starting](self, "starting"));
  id v5 = BMUserFocusDoNotDisturbWhileDrivingReasonAsString([(BMUserFocusDoNotDisturbWhileDriving *)self reason]);
  id v6 = (void *)[v3 initWithFormat:@"BMUserFocusDoNotDisturbWhileDriving with starting: %@, reason: %@", v4, v5];
...
- (BMUserFocusDoNotDisturbWhileDriving)initWithStarting:(id)a3 reason:(int)a4
{
  id v6 = a3;
  v9.receiver = self;
  v9.super_class = (Class)BMUserFocusDoNotDisturbWhileDriving;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 1)
  {
    ...
    BOOL v7 = [[BMUserFocusDoNotDisturbWhileDriving alloc] initByReadFrom:v6];
    id v8 = v7;
    if (v7) {
      v7[5] = 1;
    }
