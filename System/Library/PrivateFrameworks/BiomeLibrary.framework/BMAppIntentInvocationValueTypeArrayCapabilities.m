...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    int v6 = [(BMAppIntentInvocationValueTypeArrayCapabilities *)self value];
    int v7 = [v5 value];
...
- (id)jsonDictionary
{
  ...
  v2 = objc_msgSend(NSNumber, "numberWithInt:", -[BMAppIntentInvocationValueTypeArrayCapabilities value](self, "value"));
  int v6 = @"value";
  v3 = v2;
  if (!v2)
  {
...
- (BMAppIntentInvocationValueTypeArrayCapabilities)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  int v6 = [a3 objectForKeyedSubscript:@"value"];
...
LABEL_8:
  ...
  if (objc_opt_isKindOfClass())
  {
    int v7 = [NSNumber numberWithInt:BMAppIntentInvocationValueTypeArrayCapabilitiesCapabilitiesValueFromString(v6)];
    goto LABEL_8;
  }
  if (a4)
  {
    ...
    v12 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber (corresponding to enum value), or NSString (string version of enum)", objc_opt_class(), @"value"];
    v15[0] = v12;
...
- (NSString)description
{
  ...
  id v4 = BMAppIntentInvocationValueTypeArrayCapabilitiesCapabilitiesValueAsString([(BMAppIntentInvocationValueTypeArrayCapabilities *)self value]);
  id v5 = (void *)[v3 initWithFormat:@"BMAppIntentInvocationValueTypeArrayCapabilities with value: %@", v4];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"value" number:1 type:4 subMessageClass:0];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF4FC8;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"value" dataType:0 requestOnly:0 fieldNumber:1 protoDataType:4 convertedType:0];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    BOOL v8 = [[BMAppIntentInvocationValueTypeArrayCapabilities alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
