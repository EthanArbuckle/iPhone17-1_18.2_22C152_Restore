@interface BMPhotosEngagement
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosEngagement)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosEngagement)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
@implementation BMPhotosEngagement
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosEngagement *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosEngagement *)self identifier];
      v10 = [v5 identifier];
    ...
    v13 = [(BMPhotosEngagement *)self subset];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMPhotosEngagement *)self subset];
      v17 = [v5 subset];
...
LABEL_12:
    ...
    int v19 = [(BMPhotosEngagement *)self type];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosEngagement *)self identifier];
  id v4 = [(BMPhotosEngagement *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosEngagement type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        id v13 = [NSNumber numberWithInt:BMPhotosEngagementTypeFromString(v11)];
      }
      BOOL v12 = v13;
    }
    else
    ...
    self = -[BMPhotosEngagement initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, [v12 intValue]);
    v16 = self;
LABEL_24:
...
{
  v3 = objc_opt_new();
  [(BMPhotosEngagement *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosEngagement;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosEngagement *)self identifier];
  id v5 = [(BMPhotosEngagement *)self subset];
  id v6 = BMPhotosEngagementTypeAsString([(BMPhotosEngagement *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosEngagement with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosEngagement)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosEngagement;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosEngagement alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
