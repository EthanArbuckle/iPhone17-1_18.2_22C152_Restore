...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    int v6 = [(BMLocationSignificantVisit *)self type];
    if (v6 == [v5 type])
    {
      v7 = [(BMLocationSignificantVisit *)self identifier];
      v8 = [v5 identifier];
      if (v7 == v8)
      {
        char v11 = 1;
      ...
      {
        v9 = [(BMLocationSignificantVisit *)self identifier];
        v10 = [v5 identifier];
...
- (id)jsonDictionary
{
  ...
  v3 = objc_msgSend(NSNumber, "numberWithInt:", -[BMLocationSignificantVisit type](self, "type"));
  id v4 = [(BMLocationSignificantVisit *)self identifier];
  v9[0] = @"type";
  id v5 = v3;
  if (!v3)
  {
...
- (BMLocationSignificantVisit)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      id v9 = [NSNumber numberWithInt:BMLocationSignificantVisitTypeFromString(v7)];
    }
    v8 = v9;
  }
  else
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v16 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"identifier"];
        v22 = v16;
...
- (NSString)description
{
  ...
  id v4 = BMLocationSignificantVisitTypeAsString([(BMLocationSignificantVisit *)self type]);
  id v5 = [(BMLocationSignificantVisit *)self identifier];
  id v6 = (void *)[v3 initWithFormat:@"BMLocationSignificantVisit with type: %@, identifier: %@", v4, v5];
