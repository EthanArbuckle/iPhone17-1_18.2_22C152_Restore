...
+ (id)UserEdit
{
  ...
  v9 = (void *)[objc_alloc(MEMORY[0x1E4F50428]) initWithTableName:@"Dictation.UserEdit" columns:v8];
  v10 = (void *)[objc_alloc(MEMORY[0x1E4F50498]) initWithIdentifier:@"Dictation.UserEdit" schema:v9 configuration:v2];
...
+ (id)configurationForUserEdit
{
  ...
  v13 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"B3F3F2D7-15D7-4032-A5C4-0C360BAC1288"];
  BYTE2(v16) = 1;
  LOWORD(v16) = 1;
  v14 = objc_msgSend(v12, "_libraryStreamConfigurationWithUUID:streamIdentifier:eventClass:storeConfig:syncPolicy:legacyNames:internalMetadata:enableSubscriptions:enableSubscriptionSubstream:enableTombstoneSubstream:allowedClients:pruningTriggers:spaceAttributionOwner:", v13, @"Dictation.UserEdit", objc_opt_class(), v3, v4, 0, 0, v16, 0, v11, 0, v17[0]);
...
+ (id)storeConfigurationForUserEdit
{
  ...
  v3 = (void *)[MEMORY[0x1E4F50278] newLibraryStoreConfigForStreamIdentifier:@"Dictation.UserEdit" domain:0 segmentSize:0x20000 protectionClass:3 pruningPolicy:v2];
