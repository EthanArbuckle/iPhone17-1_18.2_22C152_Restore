...
+ (id)columns
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"intentID" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"eventType" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMSiriIntent *)self eventType];
  id v5 = [(BMSiriIntent *)self eventData];
...
- (BMSiriIntent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"intentID"];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"eventType"];
        id v28 = v12;
    ...
    int v11 = [v6 objectForKeyedSubscript:@"eventData"];
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSData", objc_opt_class(), @"eventData"];
          v26 = v20;
...
LABEL_11:
  ...
  id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"intentID"];
  v30[0] = v10;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)BMSiriIntent;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriIntent *)self intentID];
  id v5 = [(BMSiriIntent *)self eventType];
  id v6 = [(BMSiriIntent *)self eventData];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMSiriIntent with intentID: %@, eventType: %@, eventData: %@", v4, v5, v6];
...
- (BMSiriIntent)initWithIntentID:(id)a3 eventType:(id)a4 eventData:(id)a5
{
  ...
  id v11 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMSiriIntent;
  ...
  if (v12)
  {
    ...
    objc_storeStrong((id *)&v12->_eventType, a4);
    objc_storeStrong((id *)&v12->_eventData, a5);
  }
...
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"intentID" number:1 type:13 subMessageClass:0];
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"eventType", 2, 13, 0, v2);
  v7[1] = v3;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriIntent alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
