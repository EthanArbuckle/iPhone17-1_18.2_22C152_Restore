...
- (BMSafariBrowsingAssistantWebpageViewStarted)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (BMSafariBrowsingAssistantWebpageViewStarted)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMSafariBrowsingAssistantWebpageViewStarted *)self initWithWebpageViewIdentifier:a4];
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)BMSafariBrowsingAssistantWebpageViewStarted;
...
- (NSString)description
{
  ...
  id v4 = [(BMSafariBrowsingAssistantWebpageViewStarted *)self webpageViewIdentifier];
  id v5 = (void *)[v3 initWithFormat:@"BMSafariBrowsingAssistantWebpageViewStarted with webpageViewIdentifier: %@", v4];
...
- (BMSafariBrowsingAssistantWebpageViewStarted)initWithWebpageViewIdentifier:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMSafariBrowsingAssistantWebpageViewStarted;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMSafariBrowsingAssistantWebpageViewStarted alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
