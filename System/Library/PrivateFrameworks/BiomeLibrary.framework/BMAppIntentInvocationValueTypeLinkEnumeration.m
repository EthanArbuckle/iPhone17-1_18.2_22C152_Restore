...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v24.receiver = self;
  v24.super_class = (Class)BMAppIntentInvocationValueTypeLinkEnumeration;
...
- (NSString)description
{
  ...
  id v4 = [(BMAppIntentInvocationValueTypeLinkEnumeration *)self identifier];
  id v5 = (void *)[v3 initWithFormat:@"BMAppIntentInvocationValueTypeLinkEnumeration with identifier: %@", v4];
...
- (BMAppIntentInvocationValueTypeLinkEnumeration)initWithIdentifier:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMAppIntentInvocationValueTypeLinkEnumeration;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMAppIntentInvocationValueTypeLinkEnumeration alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
