...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMProcessCrashException *)self type];
  id v5 = [(BMProcessCrashException *)self signal];
...
- (BMProcessCrashException)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"codes"];
...
LABEL_4:
    ...
    if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v14 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"signal"];
        id v35 = v14;
    ...
    if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v25 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"subtype"];
          v33 = v25;
    ...
    a4 = v30;
    v15 = [(BMProcessCrashException *)v11 initWithCodes:v8 type:v30 signal:v12 subtype:v14];
    int v11 = v15;
LABEL_14:
...
LABEL_15:
  ...
  v19 = (id *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"codes"];
  v39[0] = v19;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v24.receiver = self;
  v24.super_class = (Class)BMProcessCrashException;
...
- (NSString)description
{
  ...
  id v4 = [(BMProcessCrashException *)self codes];
  id v5 = [(BMProcessCrashException *)self type];
  id v6 = [(BMProcessCrashException *)self signal];
  uint64_t v7 = [(BMProcessCrashException *)self subtype];
  id v8 = (void *)[v3 initWithFormat:@"BMProcessCrashException with codes: %@, type: %@, signal: %@, subtype: %@", v4, v5, v6, v7];
...
- (BMProcessCrashException)initWithCodes:(id)a3 type:(id)a4 signal:(id)a5 subtype:(id)a6
{
  ...
  id v14 = a6;
  v17.receiver = self;
  v17.super_class = (Class)BMProcessCrashException;
  char v15 = [(BMEventBase *)&v17 init];
  if (v15)
  {
    v15->_dataVersion = [(id)objc_opt_class() latestDataVersion];
    objc_storeStrong((id *)&v15->_codes, a3);
    objc_storeStrong((id *)&v15->_type, a4);
    objc_storeStrong((id *)&v15->_signal, a5);
    objc_storeStrong((id *)&v15->_subtype, a6);
  }
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"codes" number:1 type:13 subMessageClass:0];
  v8[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"type" number:2 type:13 subMessageClass:0];
  v8[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"signal" number:3 type:13 subMessageClass:0];
  v8[2] = v4;
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"subtype" number:4 type:13 subMessageClass:0];
  v8[3] = v5;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5388;
}

+ (id)columns
{
  v8[4] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"codes" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  ...
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"signal" dataType:2 requestOnly:0 fieldNumber:3 protoDataType:13 convertedType:0];
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"subtype" dataType:2 requestOnly:0 fieldNumber:4 protoDataType:13 convertedType:0];
  v8[0] = v2;
  v8[1] = v3;
  v8[2] = v4;
  v8[3] = v5;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMProcessCrashException alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
