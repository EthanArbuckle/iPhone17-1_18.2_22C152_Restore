...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (!-[BMDeviceNightShift hasStarting](self, "hasStarting") && ![v5 hasStarting]
      || [(BMDeviceNightShift *)self hasStarting]
      && [v5 hasStarting]
      && (int v6 = -[BMDeviceNightShift starting](self, "starting"), v6 == [v5 starting]))
    {
      int v8 = [(BMDeviceNightShift *)self reason];
...
- (id)jsonDictionary
{
  ...
  if ([(BMDeviceNightShift *)self hasStarting])
  {
    v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceNightShift starting](self, "starting"));
  }
  else
  {
    v3 = 0;
  }
  id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[BMDeviceNightShift reason](self, "reason"));
  v9[0] = @"starting";
  id v5 = v3;
  if (!v3)
  {
...
- (BMDeviceNightShift)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      id v11 = [NSNumber numberWithInt:BMDeviceNightShiftReasonFromString(v9)];
    }
    v10 = v11;
  }
  else
  ...
  self = -[BMDeviceNightShift initWithStarting:reason:](self, "initWithStarting:reason:", v8, [v10 intValue]);
  v15 = self;
LABEL_17:
...
{
  v3 = objc_opt_new();
  [(BMDeviceNightShift *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceNightShift starting](self, "starting"));
  id v5 = BMDeviceNightShiftReasonAsString([(BMDeviceNightShift *)self reason]);
  id v6 = (void *)[v3 initWithFormat:@"BMDeviceNightShift with starting: %@, reason: %@", v4, v5];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMDeviceNightShift alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
