...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v20 = [v5 locationStartID];
    if (v19 == (void *)v20)
    {
    }
    else
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMMapsFeedback *)self contactID];
  id v5 = [(BMMapsFeedback *)self locationStartID];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"contactID"];
        id v37 = v12;
    ...
    if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v14 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"locationStartID"];
        id v35 = v14;
    ...
    if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v25 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"locationEndID"];
          v33 = v25;
    ...
    a4 = v30;
    v15 = [(BMMapsFeedback *)v11 initWithHandle:v8 contactID:v30 locationStartID:v12 locationEndID:v14];
    int v11 = v15;
LABEL_14:
...
LABEL_15:
  ...
  v19 = (id *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"handle"];
  v39[0] = v19;
...
- (NSString)description
{
  ...
  id v4 = [(BMMapsFeedback *)self handle];
  id v5 = [(BMMapsFeedback *)self contactID];
  id v6 = [(BMMapsFeedback *)self locationStartID];
  uint64_t v7 = [(BMMapsFeedback *)self locationEndID];
  id v8 = (void *)[v3 initWithFormat:@"BMMapsFeedback with handle: %@, contactID: %@, locationStartID: %@, locationEndID: %@", v4, v5, v6, v7];
...
+ (id)protoFields
{
  ...
  v8[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"contactID" number:2 type:13 subMessageClass:0];
  v8[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"locationStartID" number:3 type:13 subMessageClass:0];
  v8[2] = v4;
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"locationEndID" number:4 type:13 subMessageClass:0];
  v8[3] = v5;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"contactID" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"locationStartID" dataType:2 requestOnly:0 fieldNumber:3 protoDataType:13 convertedType:0];
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"locationEndID" dataType:2 requestOnly:0 fieldNumber:4 protoDataType:13 convertedType:0];
  v8[0] = v2;
  v8[1] = v3;
  v8[2] = v4;
  v8[3] = v5;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMMapsFeedback alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
