@interface BMAccessibilityZoom
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMAccessibilityZoom)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMAccessibilityZoom)initWithStarting:(id)a3;
- (BOOL)hasStarting;
- (BOOL)isEqual:(id)a3;
- (BOOL)starting;
...
@implementation BMAccessibilityZoom
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (-[BMAccessibilityZoom hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMAccessibilityZoom hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        BOOL v6 = [(BMAccessibilityZoom *)self starting];
...
- (id)jsonDictionary
{
  ...
  if ([(BMAccessibilityZoom *)self hasStarting])
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMAccessibilityZoom starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (BMAccessibilityZoom)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMAccessibilityZoom *)self initWithStarting:a4];
    int v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)serialize
{
  ...
  [(BMAccessibilityZoom *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMAccessibilityZoom;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMAccessibilityZoom starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMAccessibilityZoom with starting: %@", v4];
...
- (BMAccessibilityZoom)initWithStarting:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)BMAccessibilityZoom;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMAccessibilityZoom alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
