...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMIntelligencePlatformFeatureStoreFeatureIdentifier *)self feature];
  id v5 = [(BMIntelligencePlatformFeatureStoreFeatureIdentifier *)self subidentifier];
  v11[0] = @"view";
  v6 = v3;
  if (!v3)
  {
...
- (BMIntelligencePlatformFeatureStoreFeatureIdentifier)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"view"];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"feature"];
        id v28 = v12;
    ...
    int v11 = [v6 objectForKeyedSubscript:@"subidentifier"];
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"subidentifier"];
          v26 = v20;
...
LABEL_11:
  ...
  id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"view"];
  v30[0] = v10;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v26.receiver = self;
  v26.super_class = (Class)BMIntelligencePlatformFeatureStoreFeatureIdentifier;
...
- (NSString)description
{
  ...
  id v4 = [(BMIntelligencePlatformFeatureStoreFeatureIdentifier *)self view];
  id v5 = [(BMIntelligencePlatformFeatureStoreFeatureIdentifier *)self feature];
  id v6 = [(BMIntelligencePlatformFeatureStoreFeatureIdentifier *)self subidentifier];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMIntelligencePlatformFeatureStoreFeatureIdentifier with view: %@, feature: %@, subidentifier: %@", v4, v5, v6];
...
- (BMIntelligencePlatformFeatureStoreFeatureIdentifier)initWithView:(id)a3 feature:(id)a4 subidentifier:(id)a5
{
  ...
  id v11 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMIntelligencePlatformFeatureStoreFeatureIdentifier;
  ...
  if (v12)
  {
    ...
    objc_storeStrong((id *)&v12->_subidentifier, a5);
  }
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"view" number:1 type:13 subMessageClass:0];
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"feature", 2, 13, 0, v2);
  v7[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"subidentifier" number:3 type:13 subMessageClass:0];
  v7[2] = v4;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF3990;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"view" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"feature" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"subidentifier" dataType:2 requestOnly:0 fieldNumber:3 protoDataType:13 convertedType:0];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMIntelligencePlatformFeatureStoreFeatureIdentifier alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
