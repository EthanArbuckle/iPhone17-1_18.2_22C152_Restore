@interface BMDeviceLowPowerMode
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMDeviceLowPowerMode)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMDeviceLowPowerMode)initWithStarting:(id)a3;
- (BOOL)hasStarting;
- (BOOL)isEqual:(id)a3;
- (BOOL)starting;
...
@implementation BMDeviceLowPowerMode
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (-[BMDeviceLowPowerMode hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceLowPowerMode hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        BOOL v6 = [(BMDeviceLowPowerMode *)self starting];
...
- (id)jsonDictionary
{
  ...
  if ([(BMDeviceLowPowerMode *)self hasStarting])
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceLowPowerMode starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (BMDeviceLowPowerMode)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMDeviceLowPowerMode *)self initWithStarting:a4];
    int v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)serialize
{
  ...
  [(BMDeviceLowPowerMode *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMDeviceLowPowerMode;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceLowPowerMode starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMDeviceLowPowerMode with starting: %@", v4];
...
- (BMDeviceLowPowerMode)initWithStarting:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)BMDeviceLowPowerMode;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMDeviceLowPowerMode alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
