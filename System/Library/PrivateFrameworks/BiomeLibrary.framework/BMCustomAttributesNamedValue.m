...
- (BMCustomAttributesBasicValue)value;
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMCustomAttributesNamedValue *)self value];
...
LABEL_7:
  ...
  if (objc_opt_isKindOfClass())
  {
    id v13 = v9;
    id v22 = 0;
    v10 = [[BMCustomAttributesBasicValue alloc] initWithJSONDictionary:v13 error:&v22];
    id v14 = v22;
    if (v14)
    {
      v15 = v14;
  ...
  v10 = (BMCustomAttributesBasicValue *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"value"];
  v24 = v10;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v26.receiver = self;
  v26.super_class = (Class)BMCustomAttributesNamedValue;
...
LABEL_15:
      ...
      if ((v12 >> 3) == 2)
      {
        ...
        id v22 = [[BMCustomAttributesBasicValue alloc] initByReadFrom:v4];
        if (!v22) {
          goto LABEL_28;
        }
        value = v5->_value;
...
- (NSString)description
{
  ...
  id v4 = [(BMCustomAttributesNamedValue *)self name];
  id v5 = [(BMCustomAttributesNamedValue *)self value];
  id v6 = (void *)[v3 initWithFormat:@"BMCustomAttributesNamedValue with name: %@, value: %@", v4, v5];
...
- (BMCustomAttributesNamedValue)initWithName:(id)a3 value:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMCustomAttributesNamedValue;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"value_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_25047];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMCustomAttributesNamedValue alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
