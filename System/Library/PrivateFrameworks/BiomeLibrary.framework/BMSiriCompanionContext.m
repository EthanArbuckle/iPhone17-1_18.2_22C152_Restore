...
- (id)_appSignalsJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMSiriCompanionContext *)self appSignals];
...
- (BMSiriCompanionContext)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  id v6 = [a3 objectForKeyedSubscript:@"appSignals"];
...
LABEL_8:
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"appSignals"];
        id v39 = v15;
      ...
      id v15 = v14;
      uint64_t v16 = [BMSiriCompanionContextAppMetadata alloc];
      id v33 = 0;
      v17 = [(BMSiriCompanionContextAppMetadata *)v16 initWithJSONDictionary:v15 error:&v33];
      id v18 = v33;
      if (v18)
      {
        v25 = v18;
...
LABEL_28:
    ...
    id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type null for element of %@, must not be null", @"appSignals"];
    id v41 = v15;
    v22 = (void *)MEMORY[0x1E4F1C9E8];
    v23 = &v41;
    v24 = &v40;
LABEL_21:
  ...
  if (p_isa)
  {
    ...
    v9 = (void *)[[NSString alloc] initWithFormat:@"Expecting %@ as an array", @"appSignals"];
    v44[0] = v9;
...
LABEL_29:
  ...
  return (BMSiriCompanionContext *)p_isa;
}
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMSiriCompanionContext;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 1)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (id v20 = [[BMSiriCompanionContextAppMetadata alloc] initByReadFrom:v4]) == 0)
        {
LABEL_27:
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriCompanionContext *)self appSignals];
  uint64_t v5 = (void *)[v3 initWithFormat:@"BMSiriCompanionContext with appSignals: %@", v4];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"appSignals" number:1 type:14 subMessageClass:objc_opt_class()];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5820;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"appSignals_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_159];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMSiriCompanionContext alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
