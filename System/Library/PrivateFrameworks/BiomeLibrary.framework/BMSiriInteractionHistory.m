@interface BMSiriInteractionHistory
+ (id)columns;
...
- (NSString)identifier
{
  ...
  v5 = [(BMSiriInteractionHistory *)self interaction];
  if (v5)
  {
    v6 = [(BMSiriInteractionHistory *)self interaction];
    v7 = [v6 identifier];
  }
  else
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMSiriInteractionHistory *)self interaction];
      v10 = [v5 interaction];
...
LABEL_11:
    ...
    v13 = [(BMSiriInteractionHistory *)self entities];
    v14 = [v5 entities];
    if (v13 == v14)
    {
      char v12 = 1;
    ...
    {
      v15 = [(BMSiriInteractionHistory *)self entities];
      v16 = [v5 entities];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMSiriInteractionHistory *)self interaction];
  id v4 = [v3 jsonDictionary];

  id v5 = [(BMSiriInteractionHistory *)self _entitiesJSONArray];
  v10[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMSiriInteractionHistory *)self entities];
...
LABEL_19:
  ...
  v8 = v41;
  self = [(BMSiriInteractionHistory *)self initWithInteraction:v41 entities:v12];
  v22 = self;
  uint64_t v7 = v39;
  id v6 = v40;
LABEL_36:
...
{
  v3 = objc_opt_new();
  [(BMSiriInteractionHistory *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriInteractionHistory *)self interaction];
  uint64_t v5 = [(BMSiriInteractionHistory *)self entities];
  uint64_t v6 = (void *)[v3 initWithFormat:@"BMSiriInteractionHistory with interaction: %@, entities: %@", v4, v5];
...
+ (id)validKeyPaths
{
  return &unk_1F0BF72F0;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_83497];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35_83498];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriInteractionHistory alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
