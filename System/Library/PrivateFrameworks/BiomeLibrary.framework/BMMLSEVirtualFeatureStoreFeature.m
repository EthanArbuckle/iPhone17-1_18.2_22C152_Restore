...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    int v6 = [(BMMLSEVirtualFeatureStoreFeature *)self featureName];
    if (v6 == [v5 featureName])
    {
      v7 = [(BMMLSEVirtualFeatureStoreFeature *)self featureValue];
      ...
      {
        v9 = (void *)v8;
        v10 = [(BMMLSEVirtualFeatureStoreFeature *)self featureValue];
        v11 = [v5 featureValue];
      ...
      if (![(BMMLSEVirtualFeatureStoreFeature *)self hasFeatureItselfVersion]
        ...
        || [(BMMLSEVirtualFeatureStoreFeature *)self hasFeatureItselfVersion]
        && [v5 hasFeatureItselfVersion]
        && (unsigned int v14 = [(BMMLSEVirtualFeatureStoreFeature *)self featureItselfVersion],
              ...
              v15 == [v5 featureFreshnessInHours]))
        {
          if (!-[BMMLSEVirtualFeatureStoreFeature hasEventVolumeToComputeFeature](self, "hasEventVolumeToComputeFeature")&& ![v5 hasEventVolumeToComputeFeature]|| -[BMMLSEVirtualFeatureStoreFeature hasEventVolumeToComputeFeature](self, "hasEventVolumeToComputeFeature")&& objc_msgSend(v5, "hasEventVolumeToComputeFeature")&& (unsigned int v16 = -[BMMLSEVirtualFeatureStoreFeature eventVolumeToComputeFeature](self, "eventVolumeToComputeFeature"), v16 == objc_msgSend(v5, "eventVolumeToComputeFeature")))
          {
            ...
            if ([(BMMLSEVirtualFeatureStoreFeature *)self hasTimeSpentToComputeFeature]
              && [v5 hasTimeSpentToComputeFeature])
            {
              unsigned int v17 = [(BMMLSEVirtualFeatureStoreFeature *)self timeSpentToComputeFeature];
...
- (id)jsonDictionary
{
  ...
  uint64_t v3 = objc_msgSend(NSNumber, "numberWithInt:", -[BMMLSEVirtualFeatureStoreFeature featureName](self, "featureName"));
  id v4 = [(BMMLSEVirtualFeatureStoreFeature *)self featureValue];
  uint64_t v5 = [v4 jsonDictionary];

  if ([(BMMLSEVirtualFeatureStoreFeature *)self hasFeatureItselfVersion])
  {
    int v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature featureItselfVersion](self, "featureItselfVersion"));
  }
  else
  {
    int v6 = 0;
  ...
  if ([(BMMLSEVirtualFeatureStoreFeature *)self hasFeatureFreshnessInHours])
  {
    v7 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature featureFreshnessInHours](self, "featureFreshnessInHours"));
  }
  else
  {
    v7 = 0;
  ...
  {
    uint64_t v8 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature eventVolumeToComputeFeature](self, "eventVolumeToComputeFeature"));
  }
  else
  {
    uint64_t v8 = 0;
  ...
  if ([(BMMLSEVirtualFeatureStoreFeature *)self hasTimeSpentToComputeFeature])
  {
    v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature timeSpentToComputeFeature](self, "timeSpentToComputeFeature"));
  }
  else
  {
    v9 = 0;
...
- (BMMLSEVirtualFeatureStoreFeature)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        uint64_t v10 = (BMMLSEVirtualFeatureStoreFeatureFeatureValue *)v47;
        goto LABEL_56;
      }
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      uint64_t v10 = (BMMLSEVirtualFeatureStoreFeatureFeatureValue *)v76;
    ...
    id v20 = v9;
    id v66 = 0;
    uint64_t v10 = [[BMMLSEVirtualFeatureStoreFeatureFeatureValue alloc] initWithJSONDictionary:v20 error:&v66];
    id v21 = v66;
    if (v21)
    {
      v22 = v21;
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_featureValue)
  {
    ...
    [(BMMLSEVirtualFeatureStoreFeatureFeatureValue *)self->_featureValue writeTo:v4];
...
LABEL_63:
        ...
        case 2u:
          ...
          id v27 = [[BMMLSEVirtualFeatureStoreFeatureFeatureValue alloc] initByReadFrom:v4];
          if (!v27) {
            goto LABEL_85;
          }
...
- (NSString)description
{
  ...
  id v4 = BMMLSEVirtualFeatureStoreFeaturefeatureNameAsString([(BMMLSEVirtualFeatureStoreFeature *)self featureName]);
  uint64_t v5 = [(BMMLSEVirtualFeatureStoreFeature *)self featureValue];
  id v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature featureItselfVersion](self, "featureItselfVersion"));
  v7 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature featureFreshnessInHours](self, "featureFreshnessInHours"));
  id v8 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature eventVolumeToComputeFeature](self, "eventVolumeToComputeFeature"));
  v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEVirtualFeatureStoreFeature timeSpentToComputeFeature](self, "timeSpentToComputeFeature"));
  char v10 = (void *)[v3 initWithFormat:@"BMMLSEVirtualFeatureStoreFeature with featureName: %@, featureValue: %@, featureItselfVersion: %@, featureFreshnessInHours: %@, eventVolumeToComputeFeature: %@, timeSpentToComputeFeature: %@", v4, v5, v6, v7, v8, v9];
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"featureValue_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_2398];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMMLSEVirtualFeatureStoreFeature alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
