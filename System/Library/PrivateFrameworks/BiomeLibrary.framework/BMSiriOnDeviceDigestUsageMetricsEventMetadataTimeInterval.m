@interface BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval
+ (id)columns;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970")|| [v5 hasStartTimestampInSecondsSince1970])
    {
      if (![(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self hasStartTimestampInSecondsSince1970])goto LABEL_13; {
      if (![v5 hasStartTimestampInSecondsSince1970])
      }
        goto LABEL_13;
      unint64_t v6 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self startTimestampInSecondsSince1970];
      if (v6 != [v5 startTimestampInSecondsSince1970]) {
        goto LABEL_13;
      }
    }
    if (![(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self hasNumberOfSeconds]
    ...
    if ([(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self hasNumberOfSeconds]
      && [v5 hasNumberOfSeconds])
    {
      unsigned int v7 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self numberOfSeconds];
...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self hasStartTimestampInSecondsSince1970])
  {
    v3 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970"));
  }
  else
  {
    v3 = 0;
  ...
  if ([(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self hasNumberOfSeconds])
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval numberOfSeconds](self, "numberOfSeconds"));
  }
  else
  {
    id v4 = 0;
...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  self = [(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self initWithStartTimestampInSecondsSince1970:v8 numberOfSeconds:v10];
  v11 = self;
LABEL_8:
...
{
  v3 = objc_opt_new();
  [(BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970"));
  id v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval numberOfSeconds](self, "numberOfSeconds"));
  id v6 = (void *)[v3 initWithFormat:@"BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval with startTimestampInSecondsSince1970: %@, numberOfSeconds: %@", v4, v5];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"startTimestampInSecondsSince1970" number:4 type:5 subMessageClass:0];
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"numberOfSeconds" number:5 type:4 subMessageClass:0];
  v6[1] = v3;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5490;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"startTimestampInSecondsSince1970" dataType:0 requestOnly:0 fieldNumber:4 protoDataType:5 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"numberOfSeconds" dataType:0 requestOnly:0 fieldNumber:5 protoDataType:4 convertedType:0];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
