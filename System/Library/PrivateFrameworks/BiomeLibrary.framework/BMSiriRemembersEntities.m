...
- (BMSiriRemembersEntities)initWithJSONDictionary:(id)a3 error:(id *)p_isa;
- (BMSiriRemembersEntities)initWithKey:(id)a3 entities:(id)a4;
- (BOOL)isEqual:(id)a3;
- (NSArray)entities;
...
LABEL_11:
    ...
    v13 = [(BMSiriRemembersEntities *)self entities];
    v14 = [v5 entities];
    if (v13 == v14)
    {
      char v12 = 1;
    ...
    {
      v15 = [(BMSiriRemembersEntities *)self entities];
      v16 = [v5 entities];
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMSiriRemembersEntities *)self _entitiesJSONArray];
  v9[0] = @"key";
  id v5 = v3;
  if (!v3)
  {
...
- (id)_entitiesJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMSiriRemembersEntities *)self entities];
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (p_isa)
      {
        ...
        id v9 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"key"];
        v57[0] = v9;
...
LABEL_11:
    ...
    while (1)
    {
      ...
      id v44 = 0;
      v20 = [(BMSiriRemembersEntitiesSiriRemembersEntity *)v19 initWithJSONDictionary:v18 error:&v44];
      id v21 = v44;
      if (v21)
      {
        v32 = v21;
...
LABEL_19:
        ...
        id v8 = v42;
        self = [(BMSiriRemembersEntities *)v41 initWithKey:v42 entities:v12];
...
LABEL_36:
  return (BMSiriRemembersEntities *)p_isa;
}
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)BMSiriRemembersEntities;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 2)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (id v22 = [[BMSiriRemembersEntitiesSiriRemembersEntity alloc] initByReadFrom:v4]) == 0)
        {
LABEL_31:
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriRemembersEntities *)self key];
  uint64_t v5 = [(BMSiriRemembersEntities *)self entities];
  uint64_t v6 = (void *)[v3 initWithFormat:@"BMSiriRemembersEntities with key: %@, entities: %@", v4, v5];
...
- (BMSiriRemembersEntities)initWithKey:(id)a3 entities:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMSiriRemembersEntities;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_156];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriRemembersEntities alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
