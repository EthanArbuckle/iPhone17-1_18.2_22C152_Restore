@interface BMPhotosLive
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosLive)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosLive)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosLive *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosLive *)self identifier];
      v10 = [v5 identifier];
...
LABEL_12:
    ...
    int v19 = [(BMPhotosLive *)self type];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosLive *)self identifier];
  id v4 = [(BMPhotosLive *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosLive type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        id v13 = [NSNumber numberWithInt:BMPhotosLiveTypeFromString(v11)];
      }
      BOOL v12 = v13;
    }
    else
    ...
    self = -[BMPhotosLive initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, [v12 intValue]);
    v16 = self;
LABEL_24:
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosLive;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosLive *)self identifier];
  id v5 = [(BMPhotosLive *)self subset];
  id v6 = BMPhotosLiveTypeAsString([(BMPhotosLive *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosLive with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosLive)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosLive;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosLive alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
