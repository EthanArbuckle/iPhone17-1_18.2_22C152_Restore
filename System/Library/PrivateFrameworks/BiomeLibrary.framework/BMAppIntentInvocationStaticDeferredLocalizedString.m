...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)self defaultValue];
  id v5 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)self table];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"defaultValue"];
        id v37 = v12;
    ...
    if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v14 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"table"];
        id v35 = v14;
    ...
    if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v25 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"bundleURL"];
          v33 = v25;
    ...
    a4 = v30;
    v15 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)v11 initWithKey:v8 defaultValue:v30 table:v12 bundleURL:v14];
    int v11 = v15;
LABEL_14:
...
LABEL_15:
  ...
  v19 = (id *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"key"];
  v39[0] = v19;
...
- (NSString)description
{
  ...
  id v4 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)self key];
  id v5 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)self defaultValue];
  id v6 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)self table];
  uint64_t v7 = [(BMAppIntentInvocationStaticDeferredLocalizedString *)self bundleURL];
  id v8 = (void *)[v3 initWithFormat:@"BMAppIntentInvocationStaticDeferredLocalizedString with key: %@, defaultValue: %@, table: %@, bundleURL: %@", v4, v5, v6, v7];
...
+ (id)protoFields
{
  ...
  v8[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"defaultValue" number:2 type:13 subMessageClass:0];
  v8[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"table" number:3 type:13 subMessageClass:0];
  v8[2] = v4;
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"bundleURL" number:4 type:13 subMessageClass:0];
  v8[3] = v5;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"defaultValue" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"table" dataType:2 requestOnly:0 fieldNumber:3 protoDataType:13 convertedType:0];
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"bundleURL" dataType:2 requestOnly:0 fieldNumber:4 protoDataType:13 convertedType:0];
  v8[0] = v2;
  v8[1] = v3;
  v8[2] = v4;
  v8[3] = v5;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMAppIntentInvocationStaticDeferredLocalizedString alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
