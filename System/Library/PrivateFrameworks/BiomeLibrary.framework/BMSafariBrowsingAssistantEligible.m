@interface BMSafariBrowsingAssistantEligible
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMSafariBrowsingAssistantEligible)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMSafariBrowsingAssistantEligible)initWithWebpageViewIdentifier:(id)a3;
- (BOOL)isEqual:(id)a3;
...
@implementation BMSafariBrowsingAssistantEligible
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
    ...
    {
      v8 = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
...
- (id)jsonDictionary
{
  ...
  v2 = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
...
- (BMSafariBrowsingAssistantEligible)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMSafariBrowsingAssistantEligible *)self initWithWebpageViewIdentifier:a4];
    v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
{
  v3 = objc_opt_new();
  [(BMSafariBrowsingAssistantEligible *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)BMSafariBrowsingAssistantEligible;
...
- (NSString)description
{
  ...
  id v4 = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
  id v5 = (void *)[v3 initWithFormat:@"BMSafariBrowsingAssistantEligible with webpageViewIdentifier: %@", v4];
...
- (BMSafariBrowsingAssistantEligible)initWithWebpageViewIdentifier:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMSafariBrowsingAssistantEligible;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMSafariBrowsingAssistantEligible alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
