...
- (BMFeedbackTextImageToImageEvaluationData)initWithCommonMetadata:(id)a3 originalContent:(id)a4 generatedContent:(id)a5;
- (BMFeedbackTextImageToImageEvaluationData)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMImageContent)generatedContent;
- (BMTextImageContent)originalContent;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMFeedbackTextImageToImageEvaluationData *)self commonMetadata];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMFeedbackTextImageToImageEvaluationData *)self commonMetadata];
    ...
    v13 = [(BMFeedbackTextImageToImageEvaluationData *)self originalContent];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMFeedbackTextImageToImageEvaluationData *)self originalContent];
...
LABEL_15:
    ...
    v19 = [(BMFeedbackTextImageToImageEvaluationData *)self generatedContent];
    ...
    {
      v21 = [(BMFeedbackTextImageToImageEvaluationData *)self generatedContent];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMFeedbackTextImageToImageEvaluationData *)self commonMetadata];
  id v4 = [v3 jsonDictionary];

  id v5 = [(BMFeedbackTextImageToImageEvaluationData *)self originalContent];
  v6 = [v5 jsonDictionary];

  uint64_t v7 = [(BMFeedbackTextImageToImageEvaluationData *)self generatedContent];
...
LABEL_4:
    ...
    if (objc_opt_isKindOfClass())
    {
      id v11 = v9;
      id v32 = 0;
      v10 = [[BMTextImageContent alloc] initWithJSONDictionary:v11 error:&v32];
      id v17 = v32;
      if (v17)
      {
        int v18 = v17;
...
LABEL_37:
    ...
    if (a4)
    {
      ...
      v10 = (BMTextImageContent *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"originalContent"];
      v37 = v10;
...
- (void)writeTo:(id)a3
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMTextImageContent *)self->_originalContent writeTo:v4];
    PBDataWriterRecallMark();
  }
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)BMFeedbackTextImageToImageEvaluationData;
...
LABEL_15:
      ...
      else if (v19 == 2)
      {
        ...
        id v20 = [[BMTextImageContent alloc] initByReadFrom:v4];
        if (!v20) {
          goto LABEL_35;
        }
        uint64_t v21 = 32;
...
- (NSString)description
{
  ...
  id v4 = [(BMFeedbackTextImageToImageEvaluationData *)self commonMetadata];
  id v5 = [(BMFeedbackTextImageToImageEvaluationData *)self originalContent];
  id v6 = [(BMFeedbackTextImageToImageEvaluationData *)self generatedContent];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMFeedbackTextImageToImageEvaluationData with commonMetadata: %@, originalContent: %@, generatedContent: %@", v4, v5, v6];
...
- (BMFeedbackTextImageToImageEvaluationData)initWithCommonMetadata:(id)a3 originalContent:(id)a4 generatedContent:(id)a5
{
  ...
  id v11 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMFeedbackTextImageToImageEvaluationData;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF3A38;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"commonMetadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_10260];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"originalContent_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_34_10261];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"generatedContent_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_36_10262];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
