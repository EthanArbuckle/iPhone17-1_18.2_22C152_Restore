  ...
  if (objc_opt_isKindOfClass())
  {
      ...
      || [v5 hasStarting])
    {
      if ([(BMAccessibilityVoiceControl *)self hasStarting]
        && [v5 hasStarting])
      {
        BOOL v6 = [(BMAccessibilityVoiceControl *)self starting];
...
- (id)jsonDictionary
{
  ...
  if ([(BMAccessibilityVoiceControl *)self hasStarting])
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMAccessibilityVoiceControl starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMAccessibilityVoiceControl;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMAccessibilityVoiceControl starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMAccessibilityVoiceControl with starting: %@", v4];
...
- (BMAccessibilityVoiceControl)initWithStarting:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)BMAccessibilityVoiceControl;
