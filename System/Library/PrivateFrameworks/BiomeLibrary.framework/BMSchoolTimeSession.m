...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (!-[BMSchoolTimeSession hasStarting](self, "hasStarting") && ![v5 hasStarting]
      || [(BMSchoolTimeSession *)self hasStarting]
      && [v5 hasStarting]
      && (int v6 = -[BMSchoolTimeSession starting](self, "starting"), v6 == [v5 starting]))
    {
      int v8 = [(BMSchoolTimeSession *)self reason];
...
- (id)jsonDictionary
{
  ...
  {
    v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMSchoolTimeSession starting](self, "starting"));
  }
  else
  {
    v3 = 0;
  }
  id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[BMSchoolTimeSession reason](self, "reason"));
  v9[0] = @"starting";
  id v5 = v3;
  if (!v3)
  {
...
- (BMSchoolTimeSession)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      id v11 = [NSNumber numberWithInt:BMSchoolTimeSessionReasonFromString(v9)];
    }
    v10 = v11;
  }
  else
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v33.receiver = self;
  v33.super_class = (Class)BMSchoolTimeSession;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMSchoolTimeSession starting](self, "starting"));
  id v5 = BMSchoolTimeSessionReasonAsString([(BMSchoolTimeSession *)self reason]);
  id v6 = (void *)[v3 initWithFormat:@"BMSchoolTimeSession with starting: %@, reason: %@", v4, v5];
...
- (BMSchoolTimeSession)initWithStarting:(id)a3 reason:(int)a4
{
  id v6 = a3;
  v9.receiver = self;
  v9.super_class = (Class)BMSchoolTimeSession;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSchoolTimeSession alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
