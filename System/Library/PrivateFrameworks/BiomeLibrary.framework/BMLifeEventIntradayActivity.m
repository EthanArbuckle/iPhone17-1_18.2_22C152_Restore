@interface BMLifeEventIntradayActivity
+ (id)columns;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMLifeEventIntradayActivity *)self activity];
    v7 = [v5 activity];
    if (v6 == v7)
    {
      char v10 = 1;
    ...
    {
      v8 = [(BMLifeEventIntradayActivity *)self activity];
      v9 = [v5 activity];
...
- (id)jsonDictionary
{
  ...
  v2 = [(BMLifeEventIntradayActivity *)self activity];
...
- (BMLifeEventIntradayActivity)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v7 = 0;
LABEL_4:
    self = [(BMLifeEventIntradayActivity *)self initWithActivity:v7];
...
{
  v3 = objc_opt_new();
  [(BMLifeEventIntradayActivity *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = [(BMLifeEventIntradayActivity *)self activity];
  id v5 = (void *)[v3 initWithFormat:@"BMLifeEventIntradayActivity with activity: %@", v4];
...
+ (id)validKeyPaths
{
  return &unk_1F0BF49E0;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"activity_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_32739];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 1)
  {
    ...
    v7 = [[BMLifeEventIntradayActivity alloc] initByReadFrom:v6];
    objc_super v8 = v7;
    if (v7) {
      v7[4] = 1;
    }
