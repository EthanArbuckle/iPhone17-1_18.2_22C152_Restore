...
LABEL_12:
    ...
    int v19 = [(BMPhotosCuration *)self type];
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMPhotosCuration *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosCuration type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        id v13 = [NSNumber numberWithInt:BMPhotosCurationTypeFromString(v11)];
      }
      BOOL v12 = v13;
    }
    else
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosCuration;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosCuration *)self identifier];
  id v5 = [(BMPhotosCuration *)self subset];
  id v6 = BMPhotosCurationTypeAsString([(BMPhotosCuration *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosCuration with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosCuration)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosCuration;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosCuration alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
