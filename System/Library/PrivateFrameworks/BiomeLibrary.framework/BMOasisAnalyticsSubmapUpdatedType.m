@interface BMOasisAnalyticsSubmapUpdatedType
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMOasisAnalyticsSubmapUpdatedType)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMOasisAnalyticsSubmapUpdatedType)initWithSubmapId:(id)a3 isLocationAttached:(id)a4 bytesWrittenToDisk:(id)a5;
...
@implementation BMOasisAnalyticsSubmapUpdatedType
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasSubmapId]
      || [v5 hasSubmapId])
    {
      if (![(BMOasisAnalyticsSubmapUpdatedType *)self hasSubmapId]) {
        goto LABEL_18;
      ...
      unint64_t v6 = [(BMOasisAnalyticsSubmapUpdatedType *)self submapId];
      if (v6 != [v5 submapId]) {
        goto LABEL_18;
      }
    }
    if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasIsLocationAttached]
      || [v5 hasIsLocationAttached])
    {
      ...
      int v7 = [(BMOasisAnalyticsSubmapUpdatedType *)self isLocationAttached];
      if (v7 != [v5 isLocationAttached]) {
        goto LABEL_18;
      }
    }
    if (![(BMOasisAnalyticsSubmapUpdatedType *)self hasBytesWrittenToDisk]
    ...
    if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasBytesWrittenToDisk]
      && [v5 hasBytesWrittenToDisk])
    {
      unint64_t v8 = [(BMOasisAnalyticsSubmapUpdatedType *)self bytesWrittenToDisk];
...
- (id)jsonDictionary
{
  ...
  if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasSubmapId])
  {
    v3 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMOasisAnalyticsSubmapUpdatedType submapId](self, "submapId"));
  }
  else
  {
    v3 = 0;
  ...
  if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasIsLocationAttached])
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMOasisAnalyticsSubmapUpdatedType isLocationAttached](self, "isLocationAttached"));
  }
  else
  {
    id v4 = 0;
  ...
  if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasBytesWrittenToDisk])
  {
    id v5 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMOasisAnalyticsSubmapUpdatedType bytesWrittenToDisk](self, "bytesWrittenToDisk"));
  }
  else
  {
    id v5 = 0;
...
LABEL_4:
    ...
    self = [(BMOasisAnalyticsSubmapUpdatedType *)self initWithSubmapId:v8 isLocationAttached:v10 bytesWrittenToDisk:v12];
    v13 = self;
LABEL_11:
...
{
  v3 = objc_opt_new();
  [(BMOasisAnalyticsSubmapUpdatedType *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v44.receiver = self;
  v44.super_class = (Class)BMOasisAnalyticsSubmapUpdatedType;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMOasisAnalyticsSubmapUpdatedType submapId](self, "submapId"));
  id v5 = objc_msgSend(NSNumber, "numberWithBool:", -[BMOasisAnalyticsSubmapUpdatedType isLocationAttached](self, "isLocationAttached"));
  id v6 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMOasisAnalyticsSubmapUpdatedType bytesWrittenToDisk](self, "bytesWrittenToDisk"));
  int v7 = (void *)[v3 initWithFormat:@"BMOasisAnalyticsSubmapUpdatedType with submapId: %@, isLocationAttached: %@, bytesWrittenToDisk: %@", v4, v5, v6];
...
- (BMOasisAnalyticsSubmapUpdatedType)initWithSubmapId:(id)a3 isLocationAttached:(id)a4 bytesWrittenToDisk:(id)a5
{
  ...
  id v10 = a5;
  v15.receiver = self;
  v15.super_class = (Class)BMOasisAnalyticsSubmapUpdatedType;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMOasisAnalyticsSubmapUpdatedType alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
