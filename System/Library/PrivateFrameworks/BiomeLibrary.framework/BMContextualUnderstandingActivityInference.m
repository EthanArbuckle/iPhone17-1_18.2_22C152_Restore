...
- (id)_inferredActivitiesJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMContextualUnderstandingActivityInference *)self inferredActivities];
...
- (BMContextualUnderstandingActivityInference)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  id v6 = [a3 objectForKeyedSubscript:@"inferredActivities"];
...
LABEL_8:
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"inferredActivities"];
        id v39 = v15;
      ...
      id v15 = v14;
      uint64_t v16 = [BMContextualUnderstandingActivityInferenceInferredActivity alloc];
      id v33 = 0;
      v17 = [(BMContextualUnderstandingActivityInferenceInferredActivity *)v16 initWithJSONDictionary:v15 error:&v33];
      id v18 = v33;
      if (v18)
      {
        v25 = v18;
...
LABEL_28:
    ...
    id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type null for element of %@, must not be null", @"inferredActivities"];
    id v41 = v15;
    v22 = (void *)MEMORY[0x1E4F1C9E8];
    v23 = &v41;
    v24 = &v40;
LABEL_21:
  ...
  if (p_isa)
  {
    ...
    v9 = (void *)[[NSString alloc] initWithFormat:@"Expecting %@ as an array", @"inferredActivities"];
    v44[0] = v9;
...
- (void)writeTo:(id)a3
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  uint64_t v5 = self->_inferredActivities;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 1)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (id v21 = [[BMContextualUnderstandingActivityInferenceInferredActivity alloc] initByReadFrom:v4]) == 0)
        {
LABEL_27:
...
- (NSString)description
{
  ...
  id v4 = [(BMContextualUnderstandingActivityInference *)self inferredActivities];
  uint64_t v5 = (void *)[v3 initWithFormat:@"BMContextualUnderstandingActivityInference with inferredActivities: %@", v4];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"inferredActivities" number:1 type:14 subMessageClass:objc_opt_class()];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5F70;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"inferredActivities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_154_58933];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
id __53__BMContextualUnderstandingActivityInference_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = [v2 _inferredActivitiesJSONArray];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMContextualUnderstandingActivityInference alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
