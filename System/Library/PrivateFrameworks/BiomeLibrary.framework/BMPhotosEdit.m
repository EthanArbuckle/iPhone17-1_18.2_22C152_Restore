@interface BMPhotosEdit
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosEdit)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosEdit)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
+ (id)columns
{
  ...
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"subset" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"type" dataType:0 requestOnly:0 fieldNumber:3 protoDataType:4 convertedType:0];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosEdit *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosEdit *)self identifier];
      v10 = [v5 identifier];
...
LABEL_12:
    ...
    int v19 = [(BMPhotosEdit *)self type];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosEdit *)self identifier];
  id v4 = [(BMPhotosEdit *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosEdit type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        id v13 = [NSNumber numberWithInt:BMPhotosEditTypeFromString(v11)];
      }
      BOOL v12 = v13;
    }
    else
    ...
    self = -[BMPhotosEdit initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, [v12 intValue]);
    v16 = self;
LABEL_24:
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosEdit;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosEdit *)self identifier];
  id v5 = [(BMPhotosEdit *)self subset];
  id v6 = BMPhotosEditTypeAsString([(BMPhotosEdit *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosEdit with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosEdit)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosEdit;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosEdit alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
