...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMLocationMicroLocationVisitProbabilityPerLocation *)self microLocationIdentifier];
    uint64_t v7 = [v5 microLocationIdentifier];
    if (v6 == (void *)v7)
    {
    }
    else
    {
      v8 = (void *)v7;
      v9 = [(BMLocationMicroLocationVisitProbabilityPerLocation *)self microLocationIdentifier];
      v10 = [v5 microLocationIdentifier];
    ...
    if (![(BMLocationMicroLocationVisitProbabilityPerLocation *)self hasProbability]
      && ![v5 hasProbability])
    {
      BOOL v12 = 1;
      goto LABEL_13;
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMLocationMicroLocationVisitProbabilityPerLocation *)self microLocationIdentifier];
  if (![(BMLocationMicroLocationVisitProbabilityPerLocation *)self hasProbability]
    || ([(BMLocationMicroLocationVisitProbabilityPerLocation *)self probability], fabs(v4) == INFINITY))
  {
    v6 = 0;
  }
  else
...
- (BMLocationMicroLocationVisitProbabilityPerLocation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"microLocationIdentifier"];
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"microLocationIdentifier"];
      v23[0] = v10;
...
- (NSString)description
{
  ...
  id v4 = [(BMLocationMicroLocationVisitProbabilityPerLocation *)self microLocationIdentifier];
  id v5 = NSNumber;
  [(BMLocationMicroLocationVisitProbabilityPerLocation *)self probability];
  id v6 = objc_msgSend(v5, "numberWithDouble:");
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMLocationMicroLocationVisitProbabilityPerLocation with microLocationIdentifier: %@, probability: %@", v4, v6];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"microLocationIdentifier" number:1 type:13 subMessageClass:0];
  v6[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5100;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"microLocationIdentifier" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMLocationMicroLocationVisitProbabilityPerLocation alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
