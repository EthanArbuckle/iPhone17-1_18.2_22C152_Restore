...
- (BMFeedbackLearningTupleInteraction)tupleInteraction;
...
LABEL_12:
  ...
  if (p_isa)
  {
    ...
    v7 = (BMFeedbackLearningTupleInteraction *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"tupleInteraction"];
    v17[0] = v7;
...
LABEL_14:
  ...
  return (BMFeedbackLearningUserInteraction *)p_isa;
}
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)BMFeedbackLearningUserInteraction;
...
LABEL_15:
      ...
      if ((v12 >> 3) == 1)
      {
        ...
        v19 = [[BMFeedbackLearningTupleInteraction alloc] initByReadFrom:v4];
        if (!v19) {
          goto LABEL_26;
        }
        tupleInteraction = v5->_tupleInteraction;
        v5->_tupleInteraction = v19;
...
- (NSString)description
{
  ...
  id v4 = [(BMFeedbackLearningUserInteraction *)self tupleInteraction];
  id v5 = (void *)[v3 initWithFormat:@"BMFeedbackLearningUserInteraction with tupleInteraction: %@", v4];
...
- (BMFeedbackLearningUserInteraction)initWithTupleInteraction:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMFeedbackLearningUserInteraction;
  v6 = [(BMEventBase *)&v8 init];
  if (v6)
  {
    v6->_dataVersion = [(id)objc_opt_class() latestDataVersion];
    objc_storeStrong((id *)&v6->_tupleInteraction, a3);
  }
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"tupleInteraction" number:1 type:14 subMessageClass:objc_opt_class()];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF4080;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"tupleInteraction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_18368];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMFeedbackLearningUserInteraction alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
