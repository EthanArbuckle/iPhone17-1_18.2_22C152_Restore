...
+ (id)columns
{
  ...
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"backlightLevel" dataType:0 requestOnly:0 fieldNumber:2 protoDataType:5 convertedType:0];
  v6[0] = v2;
  v6[1] = v3;
...
- (void)setHasBacklightLevel:(BOOL)a3
{
  self->_hasBacklightLevel = a3;
}

- (BOOL)hasBacklightLevel
{
  return self->_hasBacklightLevel;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ([(BMDeviceBacklight *)self hasBacklightLevel]
      && [v5 hasBacklightLevel])
    {
      unint64_t v13 = [(BMDeviceBacklight *)self backlightLevel];
      BOOL v12 = v13 == [v5 backlightLevel];
LABEL_13:
...
- (id)jsonDictionary
{
  ...
  {
    id v4 = NSNumber;
    id v5 = [(BMDeviceBacklight *)self absoluteTimestamp];
  ...
  if ([(BMDeviceBacklight *)self hasBacklightLevel])
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMDeviceBacklight backlightLevel](self, "backlightLevel"));
  }
  else
  {
    uint64_t v7 = 0;
  ...
  if (v16 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v22 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"backlightLevel"];
        v28 = v22;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v32.receiver = self;
  v32.super_class = (Class)BMDeviceBacklight;
...
- (NSString)description
{
  ...
  id v4 = [(BMDeviceBacklight *)self absoluteTimestamp];
  id v5 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMDeviceBacklight backlightLevel](self, "backlightLevel"));
  id v6 = (void *)[v3 initWithFormat:@"BMDeviceBacklight with absoluteTimestamp: %@, backlightLevel: %@", v4, v5];
...
- (BMDeviceBacklight)initWithAbsoluteTimestamp:(id)a3 backlightLevel:(id)a4
{
  ...
  id v7 = a4;
  v12.receiver = self;
  v12.super_class = (Class)BMDeviceBacklight;
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"backlightLevel" number:2 type:5 subMessageClass:0];
  v6[1] = v3;
