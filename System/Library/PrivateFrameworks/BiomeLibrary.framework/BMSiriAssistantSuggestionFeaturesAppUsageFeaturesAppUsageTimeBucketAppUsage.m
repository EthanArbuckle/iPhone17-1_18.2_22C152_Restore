...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (![(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self hasCount]
      && ![v5 hasCount]
      || [(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self hasCount]
      && [v5 hasCount]
      && (unsigned int v13 = [(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self count],
          v13 == [v5 count]))
    {
      ...
      if ([(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self hasTotal]
        && [v5 hasTotal])
      {
        unsigned int v14 = [(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self total];
        BOOL v12 = v14 == [v5 total];
LABEL_18:
...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self hasCount])
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage count](self, "count"));
  }
  else
  {
    id v4 = 0;
  ...
  if ([(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self hasTotal])
  {
    id v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage total](self, "total"));
  }
  else
  {
    id v5 = 0;
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"count"];
        id v28 = v12;
    ...
    int v11 = [v6 objectForKeyedSubscript:@"total"];
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"total"];
          v26 = v20;
...
LABEL_11:
  ...
  id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"key"];
  v30[0] = v10;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage *)self key];
  id v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage count](self, "count"));
  id v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage total](self, "total"));
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage with key: %@, count: %@, total: %@", v4, v5, v6];
...
- (BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage)initWithKey:(id)a3 count:(id)a4 total:(id)a5
{
  ...
  if (v12)
  {
    ...
    {
      v12->_hasTotal = 1;
      unsigned int v14 = [v11 unsignedIntValue];
    }
    else
    {
      unsigned int v14 = 0;
...
+ (id)protoFields
{
  ...
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"count", 2, 4, 0, v2);
  v7[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"total" number:3 type:4 subMessageClass:0];
  v7[2] = v4;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"count" dataType:0 requestOnly:0 fieldNumber:2 protoDataType:4 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"total" dataType:0 requestOnly:0 fieldNumber:3 protoDataType:4 convertedType:0];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriAssistantSuggestionFeaturesAppUsageFeaturesAppUsageTimeBucketAppUsage alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
