...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMEvaluationCommonMetadataQuestionAnswer *)self _answerJSONArray];
  v9[0] = @"question";
  id v5 = v3;
  if (!v3)
  {
...
- (id)_answerJSONArray
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v4 = [(BMEvaluationCommonMetadataQuestionAnswer *)self answer];
...
- (BMEvaluationCommonMetadataQuestionAnswer)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"question"];
  id v40 = v6;
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        id v9 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"question"];
        v53[0] = v9;
  ...
  id v9 = [v6 objectForKeyedSubscript:@"answer"];
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        if (v39)
        {
          ...
          v24 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"answer"];
          v46 = v24;
...
LABEL_27:
    ...
    if (v39)
    {
      ...
      v24 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type null for element of %@, must not be null", @"answer"];
      v48 = v24;
...
LABEL_26:
  ...
  if (a4)
  {
    ...
    v14 = (void *)[[NSString alloc] initWithFormat:@"Expecting %@ as an array", @"answer"];
    v51 = v14;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)BMEvaluationCommonMetadataQuestionAnswer;
...
- (NSString)description
{
  ...
  id v4 = [(BMEvaluationCommonMetadataQuestionAnswer *)self question];
  uint64_t v5 = [(BMEvaluationCommonMetadataQuestionAnswer *)self answer];
  uint64_t v6 = (void *)[v3 initWithFormat:@"BMEvaluationCommonMetadataQuestionAnswer with question: %@, answer: %@", v4, v5];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"question" number:1 type:13 subMessageClass:0];
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"answer" number:2 type:13 subMessageClass:0];
  v6[1] = v3;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF44D0;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"question" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"answer_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_309];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMEvaluationCommonMetadataQuestionAnswer alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
