@interface BMDeviceWakeOnWiFiStatus
+ (id)columns;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (-[BMDeviceWakeOnWiFiStatus hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceWakeOnWiFiStatus hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        BOOL v6 = [(BMDeviceWakeOnWiFiStatus *)self starting];
...
- (id)jsonDictionary
{
  ...
  if ([(BMDeviceWakeOnWiFiStatus *)self hasStarting])
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceWakeOnWiFiStatus starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (BMDeviceWakeOnWiFiStatus)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMDeviceWakeOnWiFiStatus *)self initWithStarting:a4];
    int v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)serialize
{
  ...
  [(BMDeviceWakeOnWiFiStatus *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceWakeOnWiFiStatus starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMDeviceWakeOnWiFiStatus with starting: %@", v4];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMDeviceWakeOnWiFiStatus alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
