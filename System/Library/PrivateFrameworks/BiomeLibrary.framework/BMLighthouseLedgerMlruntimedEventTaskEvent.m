...
- (BMLighthouseLedgerMlruntimedEventTaskEvent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMLighthouseLedgerMlruntimedEventTaskEvent)initWithSucceeded:(id)a3 errorDomain:(id)a4 errorCode:(id)a5;
- (BOOL)hasErrorCode;
- (BOOL)hasSucceeded;
- (BOOL)isEqual:(id)a3;
- (BOOL)succeeded;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
      ...
      || [v5 hasSucceeded])
    {
      ...
      int v6 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self succeeded];
      if (v6 != [v5 succeeded]) {
        goto LABEL_17;
      }
    }
    v7 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorDomain];
    ...
    {
      v9 = (void *)v8;
      v10 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorDomain];
      v11 = [v5 errorDomain];
    ...
    if ([(BMLighthouseLedgerMlruntimedEventTaskEvent *)self hasErrorCode]
      && [v5 hasErrorCode])
    {
      int v14 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorCode];
...
- (id)jsonDictionary
{
  ...
  if ([(BMLighthouseLedgerMlruntimedEventTaskEvent *)self hasSucceeded])
  {
    v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMLighthouseLedgerMlruntimedEventTaskEvent succeeded](self, "succeeded"));
  }
  else
  {
    v3 = 0;
  }
  id v4 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorDomain];
  if ([(BMLighthouseLedgerMlruntimedEventTaskEvent *)self hasErrorCode])
  {
    id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMLighthouseLedgerMlruntimedEventTaskEvent errorCode](self, "errorCode"));
  }
  else
  {
    id v5 = 0;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v39.receiver = self;
  v39.super_class = (Class)BMLighthouseLedgerMlruntimedEventTaskEvent;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMLighthouseLedgerMlruntimedEventTaskEvent succeeded](self, "succeeded"));
  id v5 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorDomain];
  id v6 = objc_msgSend(NSNumber, "numberWithInt:", -[BMLighthouseLedgerMlruntimedEventTaskEvent errorCode](self, "errorCode"));
  v7 = (void *)[v3 initWithFormat:@"BMLighthouseLedgerMlruntimedEventTaskEvent with succeeded: %@, errorDomain: %@, errorCode: %@", v4, v5, v6];
...
- (BMLighthouseLedgerMlruntimedEventTaskEvent)initWithSucceeded:(id)a3 errorDomain:(id)a4 errorCode:(id)a5
{
  ...
  id v10 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMLighthouseLedgerMlruntimedEventTaskEvent;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMLighthouseLedgerMlruntimedEventTaskEvent alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
