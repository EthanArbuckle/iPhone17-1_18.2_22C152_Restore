...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
      ...
      || [v5 hasValidityDays])
    {
      ...
      unsigned int v19 = [(BMSiriUserAggregationId *)self validityDays];
    ...
    if ([(BMSiriUserAggregationId *)self hasSwitchedCount]
      && [v5 hasSwitchedCount])
    {
      unsigned int v32 = [(BMSiriUserAggregationId *)self switchedCount];
...
- (NSUUID)aggregationId
{
  ...
  {
    v3 = [MEMORY[0x1E4F50320] convertValue:raw_aggregationId toType:3];
  }
  else
  {
    v3 = 0;
...
- (id)jsonDictionary
{
  ...
  id v5 = [(BMSiriUserAggregationId *)self effectiveFrom];
  if (v5)
  {
    v6 = NSNumber;
    uint64_t v7 = [(BMSiriUserAggregationId *)self effectiveFrom];
  ...
  if ([(BMSiriUserAggregationId *)self hasValidityDays])
  {
    v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserAggregationId validityDays](self, "validityDays"));
  }
  else
  {
    v9 = 0;
  ...
  {
    int v11 = NSNumber;
    BOOL v12 = [(BMSiriUserAggregationId *)self createdOn];
  ...
  uint64_t v14 = [(BMSiriUserAggregationId *)self adoptedOn];
  if (v14)
  {
    v15 = NSNumber;
  ...
  if ([(BMSiriUserAggregationId *)self hasSwitchedCount])
  {
    int v18 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserAggregationId switchedCount](self, "switchedCount"));
  }
  else
  {
    int v18 = 0;
...
- (BMSiriUserAggregationId)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"aggregationId"];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (!v11)
    {
      if (a4)
      {
        ...
        v72 = (void *)[[NSString alloc] initWithFormat:@"-initWithUUIDString: for %@ returned nil", @"aggregationId"];
        v86[0] = v72;
...
LABEL_40:
    ...
    v22 = [(BMSiriUserAggregationId *)v37 initWithAggregationId:v68 effectiveFrom:v70 validityDays:v69 createdOn:v26 adoptedOn:v38 switchedCount:v47];
    v37 = v22;
LABEL_44:
  ...
  id v8 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"aggregationId"];
  id v84 = v8;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v46.receiver = self;
  v46.super_class = (Class)BMSiriUserAggregationId;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriUserAggregationId *)self aggregationId];
  id v5 = [(BMSiriUserAggregationId *)self effectiveFrom];
  id v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserAggregationId validityDays](self, "validityDays"));
  uint64_t v7 = [(BMSiriUserAggregationId *)self createdOn];
  id v8 = [(BMSiriUserAggregationId *)self adoptedOn];
  uint64_t v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMSiriUserAggregationId switchedCount](self, "switchedCount"));
  char v10 = (void *)[v3 initWithFormat:@"BMSiriUserAggregationId with aggregationId: %@, effectiveFrom: %@, validityDays: %@, createdOn: %@, adoptedOn: %@, switchedCount: %@", v4, v5, v6, v7, v8, v9];
...
- (BMSiriUserAggregationId)initWithAggregationId:(id)a3 effectiveFrom:(id)a4 validityDays:(id)a5 createdOn:(id)a6 adoptedOn:(id)a7 switchedCount:(id)a8
{
  ...
  id v19 = a8;
  v29.receiver = self;
  v29.super_class = (Class)BMSiriUserAggregationId;
  ...
  if (v20)
  {
    ...
    if (v14)
    {
      ...
      v20->_raw_aggregationId = (NSData *)v21;
    }
    else
    {
      raw_aggregationId = v20->_raw_aggregationId;
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"aggregationId" number:1 type:14 subMessageClass:0];
  v10[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5CE8;
}

+ (id)columns
{
  v10[6] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"aggregationId" dataType:6 requestOnly:0 fieldNumber:1 protoDataType:14 convertedType:3];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriUserAggregationId alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[19] = 0;
    }
