...
- (BMIntelligenceEngineInteractionCandidateID)initWithIdentifier:(id)a3 bundleId:(id)a4;
- (BMIntelligenceEngineInteractionCandidateID)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
- (NSString)bundleId;
...
LABEL_11:
    ...
    {
      v15 = [(BMIntelligenceEngineInteractionCandidateID *)self bundleId];
      v16 = [v5 bundleId];
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMIntelligenceEngineInteractionCandidateID *)self bundleId];
  v9[0] = @"identifier";
  id v5 = v3;
  if (!v3)
  {
...
- (BMIntelligenceEngineInteractionCandidateID)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  self = [(BMIntelligenceEngineInteractionCandidateID *)self initWithIdentifier:v8 bundleId:v10];
  int v11 = self;
LABEL_8:
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)BMIntelligenceEngineInteractionCandidateID;
...
- (NSString)description
{
  ...
  id v4 = [(BMIntelligenceEngineInteractionCandidateID *)self identifier];
  id v5 = [(BMIntelligenceEngineInteractionCandidateID *)self bundleId];
  id v6 = (void *)[v3 initWithFormat:@"BMIntelligenceEngineInteractionCandidateID with identifier: %@, bundleId: %@", v4, v5];
...
- (BMIntelligenceEngineInteractionCandidateID)initWithIdentifier:(id)a3 bundleId:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMIntelligenceEngineInteractionCandidateID;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMIntelligenceEngineInteractionCandidateID alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
