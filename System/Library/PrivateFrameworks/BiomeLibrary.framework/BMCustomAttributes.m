...
- (id)_attributeDictJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMCustomAttributes *)self attributeDict];
...
- (BMCustomAttributes)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  id v6 = [a3 objectForKeyedSubscript:@"attributeDict"];
...
LABEL_8:
    ...
    while (1)
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"attributeDict"];
        id v39 = v15;
      ...
      id v15 = v14;
      uint64_t v16 = [BMCustomAttributesNamedValue alloc];
      id v33 = 0;
      v17 = [(BMCustomAttributesNamedValue *)v16 initWithJSONDictionary:v15 error:&v33];
      id v18 = v33;
      if (v18)
      {
        v25 = v18;
...
LABEL_16:
        ...
        self = [(BMCustomAttributes *)self initWithAttributeDict:v9];
...
LABEL_28:
    ...
    id v15 = (id)[[NSString alloc] initWithFormat:@"Unexpected type null for element of %@, must not be null", @"attributeDict"];
    id v41 = v15;
    v22 = (void *)MEMORY[0x1E4F1C9E8];
    v23 = &v41;
    v24 = &v40;
LABEL_21:
  ...
  if (p_isa)
  {
    ...
    v9 = (void *)[[NSString alloc] initWithFormat:@"Expecting %@ as an array", @"attributeDict"];
    v44[0] = v9;
...
LABEL_29:
  ...
  return (BMCustomAttributes *)p_isa;
}
...
- (void)writeTo:(id)a3
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  uint64_t v5 = self->_attributeDict;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v28.receiver = self;
  v28.super_class = (Class)BMCustomAttributes;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 1)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (id v21 = [[BMCustomAttributesNamedValue alloc] initByReadFrom:v4]) == 0)
        {
LABEL_27:
...
- (NSString)description
{
  ...
  id v4 = [(BMCustomAttributes *)self attributeDict];
  uint64_t v5 = (void *)[v3 initWithFormat:@"BMCustomAttributes with attributeDict: %@", v4];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"attributeDict" number:1 type:14 subMessageClass:objc_opt_class()];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF4470;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"attributeDict_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_199];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
id __29__BMCustomAttributes_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = [v2 _attributeDictJSONArray];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMCustomAttributes alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
