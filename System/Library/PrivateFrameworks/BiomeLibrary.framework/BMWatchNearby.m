@interface BMWatchNearby
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMWatchNearby)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMWatchNearby)initWithStarting:(id)a3;
- (BOOL)hasStarting;
- (BOOL)isEqual:(id)a3;
- (BOOL)starting;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    if (-[BMWatchNearby hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMWatchNearby hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        BOOL v6 = [(BMWatchNearby *)self starting];
...
- (id)jsonDictionary
{
  ...
  if ([(BMWatchNearby *)self hasStarting])
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMWatchNearby starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (BMWatchNearby)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMWatchNearby *)self initWithStarting:a4];
    int v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMWatchNearby;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMWatchNearby starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMWatchNearby with starting: %@", v4];
...
- (BMWatchNearby)initWithStarting:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)BMWatchNearby;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMWatchNearby alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
