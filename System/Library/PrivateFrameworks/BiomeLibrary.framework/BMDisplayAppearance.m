...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    int v6 = [(BMDisplayAppearance *)self state];
    if (v6 == [v5 state])
    {
      int v7 = [(BMDisplayAppearance *)self reason];
...
- (id)jsonDictionary
{
  ...
  v3 = objc_msgSend(NSNumber, "numberWithInt:", -[BMDisplayAppearance state](self, "state"));
  id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[BMDisplayAppearance reason](self, "reason"));
  v9[0] = @"state";
  id v5 = v3;
  if (!v3)
  {
...
- (BMDisplayAppearance)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      id v9 = [NSNumber numberWithInt:BMDisplayAppearanceStateFromString(v7)];
    }
    BOOL v8 = v9;
  }
  else
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      id v12 = [NSNumber numberWithInt:BMDisplayAppearanceReasonFromString(v10)];
    }
    v11 = v12;
  }
  else
  ...
  self = -[BMDisplayAppearance initWithState:reason:](self, "initWithState:reason:", [v8 intValue], objc_msgSend(v11, "intValue"));
  v13 = self;
LABEL_18:
...
{
  v3 = objc_opt_new();
  [(BMDisplayAppearance *)self writeTo:v3];
...
- (NSString)description
{
  ...
  id v4 = BMDisplayAppearanceStateAsString([(BMDisplayAppearance *)self state]);
  id v5 = BMDisplayAppearanceReasonAsString([(BMDisplayAppearance *)self reason]);
  id v6 = (void *)[v3 initWithFormat:@"BMDisplayAppearance with state: %@, reason: %@", v4, v5];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMDisplayAppearance alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
