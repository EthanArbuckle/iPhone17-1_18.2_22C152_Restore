...
- (BMOasisAnalyticsSubmapCreatedType)payload;
- (BOOL)isEqual:(id)a3;
...
- (id)jsonDictionary
{
  ...
  id v5 = [(BMOasisAnalyticsSubmapCreatedEvent *)self metadata];
  v6 = [v5 jsonDictionary];

  uint64_t v7 = [(BMOasisAnalyticsSubmapCreatedEvent *)self payload];
...
LABEL_12:
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        id v19 = v11;
        id v31 = 0;
        char v12 = [[BMOasisAnalyticsSubmapCreatedType alloc] initWithJSONDictionary:v19 error:&v31];
        id v20 = v31;
        if (v20)
        {
          v21 = v20;
      ...
      if (a4)
      {
        ...
        char v12 = (BMOasisAnalyticsSubmapCreatedType *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"payload"];
        v35 = v12;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v26.receiver = self;
  v26.super_class = (Class)BMOasisAnalyticsSubmapCreatedEvent;
...
LABEL_15:
      ...
      else if (v20 == 2)
      {
        ...
        v21 = [[BMOasisAnalyticsSubmapCreatedType alloc] initByReadFrom:v4];
        if (!v21) {
          goto LABEL_35;
        }
        uint64_t v22 = 40;
...
- (NSString)description
{
  ...
  id v4 = [(BMOasisAnalyticsSubmapCreatedEvent *)self qualityTrace];
  id v5 = [(BMOasisAnalyticsSubmapCreatedEvent *)self metadata];
  id v6 = [(BMOasisAnalyticsSubmapCreatedEvent *)self payload];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMOasisAnalyticsSubmapCreatedEvent with qualityTrace: %@, metadata: %@, payload: %@", v4, v5, v6];
...
- (BMOasisAnalyticsSubmapCreatedEvent)initWithQualityTrace:(id)a3 metadata:(id)a4 payload:(id)a5
{
  ...
  id v11 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMOasisAnalyticsSubmapCreatedEvent;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF7938;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"qualityTrace_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_726];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"metadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_728_90885];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"payload_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_730_90886];
  v7[0] = v3;
  v7[1] = v4;
  v7[2] = v2;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
