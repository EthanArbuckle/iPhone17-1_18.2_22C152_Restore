@interface BMPhotosMoviePlayed
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosMoviePlayed)initWithIdentifier:(id)a3 subset:(id)a4;
- (BMPhotosMoviePlayed)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
@implementation BMPhotosMoviePlayed
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosMoviePlayed *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosMoviePlayed *)self identifier];
      v10 = [v5 identifier];
...
LABEL_11:
    ...
    v13 = [(BMPhotosMoviePlayed *)self subset];
    v14 = [v5 subset];
    if (v13 == v14)
    {
      char v12 = 1;
    ...
    {
      v15 = [(BMPhotosMoviePlayed *)self subset];
      v16 = [v5 subset];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosMoviePlayed *)self identifier];
  id v4 = [(BMPhotosMoviePlayed *)self subset];
  v9[0] = @"identifier";
  id v5 = v3;
  if (!v3)
  {
...
- (BMPhotosMoviePlayed)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  self = [(BMPhotosMoviePlayed *)self initWithIdentifier:v8 subset:v10];
  int v11 = self;
LABEL_8:
...
{
  v3 = objc_opt_new();
  [(BMPhotosMoviePlayed *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v24.receiver = self;
  v24.super_class = (Class)BMPhotosMoviePlayed;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosMoviePlayed *)self identifier];
  id v5 = [(BMPhotosMoviePlayed *)self subset];
  id v6 = (void *)[v3 initWithFormat:@"BMPhotosMoviePlayed with identifier: %@, subset: %@", v4, v5];
...
- (BMPhotosMoviePlayed)initWithIdentifier:(id)a3 subset:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMPhotosMoviePlayed;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosMoviePlayed alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
