@interface BMSiriMessageHistory
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMSiriMessageHistory)initWithInteraction:(id)a3 entities:(id)a4;
- (BMSiriMessageHistory)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
@implementation BMSiriMessageHistory

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_16583];
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35_16584];
  v6[0] = v2;
  v6[1] = v3;
...
- (NSString)identifier
{
  ...
  v5 = [(BMSiriMessageHistory *)self interaction];
  if (v5)
  {
    v6 = [(BMSiriMessageHistory *)self interaction];
    v7 = [v6 identifier];
  }
  else
  {
  ...
  v8 = (void *)[[NSString alloc] initWithFormat:@"%@:%@", v4, v7];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMSiriMessageHistory *)self interaction];
      v10 = [v5 interaction];
...
LABEL_11:
    ...
    v13 = [(BMSiriMessageHistory *)self entities];
    v14 = [v5 entities];
    if (v13 == v14)
    {
      char v12 = 1;
    ...
    {
      v15 = [(BMSiriMessageHistory *)self entities];
      v16 = [v5 entities];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMSiriMessageHistory *)self interaction];
  id v4 = [v3 jsonDictionary];

  id v5 = [(BMSiriMessageHistory *)self _entitiesJSONArray];
  v10[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMSiriMessageHistory *)self entities];
...
LABEL_19:
  ...
  v8 = v41;
  self = [(BMSiriMessageHistory *)self initWithInteraction:v41 entities:v12];
  v22 = self;
  uint64_t v7 = v39;
  id v6 = v40;
LABEL_36:
...
{
  v3 = objc_opt_new();
  [(BMSiriMessageHistory *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)BMSiriMessageHistory;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriMessageHistory *)self interaction];
  uint64_t v5 = [(BMSiriMessageHistory *)self entities];
  uint64_t v6 = (void *)[v3 initWithFormat:@"BMSiriMessageHistory with interaction: %@, entities: %@", v4, v5];
...
- (BMSiriMessageHistory)initWithInteraction:(id)a3 entities:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMSiriMessageHistory;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF3F48;
}

id __31__BMSiriMessageHistory_columns__block_invoke_2(uint64_t a1, void *a2)
{
...
id __31__BMSiriMessageHistory_columns__block_invoke(uint64_t a1, void *a2)
{
  v2 = [a2 eventBodyKeepingBackingData:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriMessageHistory alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
