...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ((![(BMSiriRemembersFieldFieldValueBasicValue *)self hasBoolValue]
       && ![v5 hasBoolValue]
       || [(BMSiriRemembersFieldFieldValueBasicValue *)self hasBoolValue]
       && [v5 hasBoolValue]
       && (int v6 = [(BMSiriRemembersFieldFieldValueBasicValue *)self BOOLValue],
           v6 == [v5 BOOLValue]))
      && (![(BMSiriRemembersFieldFieldValueBasicValue *)self hasInt64Value]
       && ![v5 hasInt64Value]
       || [(BMSiriRemembersFieldFieldValueBasicValue *)self hasInt64Value]
       && [v5 hasInt64Value]
       && (int64_t v7 = [(BMSiriRemembersFieldFieldValueBasicValue *)self int64Value],
           v7 == [v5 int64Value]))
      && (![(BMSiriRemembersFieldFieldValueBasicValue *)self hasDoubleValue]
       && ![v5 hasDoubleValue]
       || [(BMSiriRemembersFieldFieldValueBasicValue *)self hasDoubleValue]
       && [v5 hasDoubleValue]
...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriRemembersFieldFieldValueBasicValue *)self hasBoolValue])
  {
    v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMSiriRemembersFieldFieldValueBasicValue BOOLValue](self, "BOOLValue"));
  }
  else
  {
    v3 = 0;
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithLongLong:", -[BMSiriRemembersFieldFieldValueBasicValue int64Value](self, "int64Value"));
  }
  else
  {
    id v4 = 0;
  }
  if (![(BMSiriRemembersFieldFieldValueBasicValue *)self hasDoubleValue]
    || ([(BMSiriRemembersFieldFieldValueBasicValue *)self doubleValue], fabs(v5) == INFINITY))
  {
    int64_t v7 = 0;
  }
  else
  ...
  double v8 = [(BMSiriRemembersFieldFieldValueBasicValue *)self stringValue];
  v15[0] = @"BOOLValue";
  double v9 = v3;
  if (!v3)
  {
...
LABEL_13:
      a4 = v31;
      char v15 = [(BMSiriRemembersFieldFieldValueBasicValue *)v11 initWithBoolValue:v8 int64Value:v31 doubleValue:v12 stringValue:v14];
      v11 = v15;
LABEL_32:
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMSiriRemembersFieldFieldValueBasicValue BOOLValue](self, "BOOLValue"));
  id v5 = objc_msgSend(NSNumber, "numberWithLongLong:", -[BMSiriRemembersFieldFieldValueBasicValue int64Value](self, "int64Value"));
  id v6 = NSNumber;
  [(BMSiriRemembersFieldFieldValueBasicValue *)self doubleValue];
  int64_t v7 = objc_msgSend(v6, "numberWithDouble:");
  id v8 = [(BMSiriRemembersFieldFieldValueBasicValue *)self stringValue];
  double v9 = (void *)[v3 initWithFormat:@"BMSiriRemembersFieldFieldValueBasicValue with BOOLValue: %@, int64Value: %@, doubleValue: %@, stringValue: %@", v4, v5, v7, v8];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriRemembersFieldFieldValueBasicValue alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      void v8[5] = 0;
    }
