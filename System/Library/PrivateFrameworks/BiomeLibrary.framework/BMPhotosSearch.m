@interface BMPhotosSearch
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosSearch)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosSearch)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosSearch *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosSearch *)self identifier];
      v10 = [v5 identifier];
    ...
    v13 = [(BMPhotosSearch *)self subset];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMPhotosSearch *)self subset];
      v17 = [v5 subset];
...
LABEL_12:
    ...
    int v19 = [(BMPhotosSearch *)self type];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosSearch *)self identifier];
  id v4 = [(BMPhotosSearch *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosSearch type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        objc_msgSend(NSNumber, "numberWithInt:", bsearch_b(v11, BMPhotosSearchTypeFromString_sortedStrings, 1uLL, 8uLL, &__block_literal_global_10836) != 0);
    ...
    self = -[BMPhotosSearch initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, [v12 intValue]);
    v16 = self;
LABEL_24:
...
{
  v3 = objc_opt_new();
  [(BMPhotosSearch *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosSearch;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosSearch *)self identifier];
  id v5 = [(BMPhotosSearch *)self subset];
  id v6 = BMPhotosSearchTypeAsString([(BMPhotosSearch *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosSearch with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosSearch)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosSearch;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosSearch alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
