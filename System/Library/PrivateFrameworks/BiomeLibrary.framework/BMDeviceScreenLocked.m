...
- (BMDeviceScreenLocked)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMDeviceScreenLocked)initWithStarting:(id)a3;
- (BOOL)hasStarting;
- (BOOL)isEqual:(id)a3;
- (BOOL)starting;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceScreenLocked hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceScreenLocked hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        BOOL v6 = [(BMDeviceScreenLocked *)self starting];
...
- (id)jsonDictionary
{
  ...
  {
    uint64_t v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceScreenLocked starting](self, "starting"));
    v9 = @"starting";
    if (v3)
    {
      id v4 = (void *)v3;
...
- (BMDeviceScreenLocked)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMDeviceScreenLocked *)self initWithStarting:a4];
    int v7 = self;
    goto LABEL_5;
  }
  objc_opt_class();
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMDeviceScreenLocked;
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[BMDeviceScreenLocked starting](self, "starting"));
  int v5 = (void *)[v3 initWithFormat:@"BMDeviceScreenLocked with starting: %@", v4];
...
- (BMDeviceScreenLocked)initWithStarting:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)BMDeviceScreenLocked;
