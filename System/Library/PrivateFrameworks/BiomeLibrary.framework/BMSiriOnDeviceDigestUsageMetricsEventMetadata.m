...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadata)initWithOddIdUUID:(id)a3 deviceAggregationId:(id)a4 userAggregationId:(id)a5 eventTimestampInMSSince1970:(id)a6 timeInterval:(id)a7;
...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval)timeInterval;
...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadata)initWithOddIdUUID:(id)a3 deviceAggregationId:(id)a4 userAggregationId:(id)a5 eventTimestampInMSSince1970:(id)a6 timeInterval:(id)a7
{
  return [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self initWithOddIdUUID:a3 deviceAggregationId:a4 userAggregationId:a5 eventTimestampInMSSince1970:a6 timeInterval:a7 userAggregationIdRotationTimestampInMs:0 userAggregationIdExpirationTimestampInMs:0];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970")|| [v5 hasEventTimestampInMSSince1970])
    {
      if (![(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self hasEventTimestampInMSSince1970])goto LABEL_34; {
      if (![v5 hasEventTimestampInMSSince1970])
      }
        goto LABEL_34;
      unint64_t v25 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self eventTimestampInMSSince1970];
    ...
    if (!-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs")&& ![v5 hasUserAggregationIdRotationTimestampInMs]|| -[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs")&& objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs")&& (unint64_t v32 = -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"), v32 == objc_msgSend(v5, "userAggregationIdRotationTimestampInMs")))
    {
      ...
      if (-[BMSiriOnDeviceDigestUsageMetricsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs")&& [v5 hasUserAggregationIdExpirationTimestampInMs])
      {
        unint64_t v33 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self userAggregationIdExpirationTimestampInMs];
...
- (id)jsonDictionary
{
  ...
  uint64_t v3 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self oddIdUUID];
  uint64_t v4 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self deviceAggregationId];
  id v5 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self userAggregationId];
  if ([(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self hasEventTimestampInMSSince1970])
  {
    v23 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970"));
  }
  else
  {
    v23 = 0;
  ...
  {
    v8 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"));
  }
  else
  {
    v8 = 0;
  }
  if ([(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self hasUserAggregationIdExpirationTimestampInMs])
  {
    v9 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs"));
  }
  else
  {
    v9 = 0;
...
LABEL_28:
    ...
    if (v13 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        uint64_t v45 = v42;
        id v8 = v41;
        v60 = (BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)v43;
        v19 = 0;
        id v66 = 0;
    ...
    if (v14 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v60 = (BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"timeInterval"];
        v73 = v60;
...
LABEL_26:
      ...
      id v20 = v14;
      id v67 = 0;
      v60 = [[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval alloc] initWithJSONDictionary:v20 error:&v67];
      id v22 = v67;
      if (v22)
      {
        v23 = v22;
    ...
    v19 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)v64 initWithOddIdUUID:v58 deviceAggregationId:v65 userAggregationId:v62 eventTimestampInMSSince1970:v66 timeInterval:v60 userAggregationIdRotationTimestampInMs:v16 userAggregationIdExpirationTimestampInMs:v18];
    v64 = v19;
LABEL_23:
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v43.receiver = self;
  v43.super_class = (Class)BMSiriOnDeviceDigestUsageMetricsEventMetadata;
...
LABEL_53:
        ...
        case 5u:
          ...
          id v28 = [[BMSiriOnDeviceDigestUsageMetricsEventMetadataTimeInterval alloc] initByReadFrom:v4];
          if (!v28) {
            goto LABEL_65;
          }
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self oddIdUUID];
  id v5 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self deviceAggregationId];
  id v6 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self userAggregationId];
  uint64_t v7 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970"));
  id v8 = [(BMSiriOnDeviceDigestUsageMetricsEventMetadata *)self timeInterval];
  v9 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"));
  char v10 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[BMSiriOnDeviceDigestUsageMetricsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs"));
  unsigned int v11 = (void *)[v3 initWithFormat:@"BMSiriOnDeviceDigestUsageMetricsEventMetadata with oddIdUUID: %@, deviceAggregationId: %@, userAggregationId: %@, eventTimestampInMSSince1970: %@, timeInterval: %@, userAggregationIdRotationTimestampInMs: %@, userAggregationIdExpirationTimestampInMs: %@", v4, v5, v6, v7, v8, v9, v10];
...
- (BMSiriOnDeviceDigestUsageMetricsEventMetadata)initWithOddIdUUID:(id)a3 deviceAggregationId:(id)a4 userAggregationId:(id)a5 eventTimestampInMSSince1970:(id)a6 timeInterval:(id)a7 userAggregationIdRotationTimestampInMs:(id)a8 userAggregationIdExpirationTimestampInMs:(id)a9
{
  ...
  id v19 = a9;
  v28.receiver = self;
  v28.super_class = (Class)BMSiriOnDeviceDigestUsageMetricsEventMetadata;
...
+ (id)columns
{
  ...
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"timeInterval_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_45597];
...
id __56__BMSiriOnDeviceDigestUsageMetricsEventMetadata_columns__block_invoke(uint64_t a1, void *a2)
{
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSiriOnDeviceDigestUsageMetricsEventMetadata alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
