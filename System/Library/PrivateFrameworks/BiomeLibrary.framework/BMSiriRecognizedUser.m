...
LABEL_4:
  ...
  if (a4)
  {
    ...
    v11 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"sharedUserId"];
    v14[0] = v11;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)BMSiriRecognizedUser;
...
- (NSString)description
{
  ...
  id v4 = [(BMSiriRecognizedUser *)self sharedUserId];
  id v5 = (void *)[v3 initWithFormat:@"BMSiriRecognizedUser with sharedUserId: %@", v4];
...
- (BMSiriRecognizedUser)initWithSharedUserId:(id)a3
{
  id v5 = a3;
  v8.receiver = self;
  v8.super_class = (Class)BMSiriRecognizedUser;
  v6 = [(BMEventBase *)&v8 init];
  if (v6)
  {
    v6->_dataVersion = [(id)objc_opt_class() latestDataVersion];
    objc_storeStrong((id *)&v6->_sharedUserId, a3);
  }
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"sharedUserId" number:1 type:13 subMessageClass:0];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF5838;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"sharedUserId" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMSiriRecognizedUser alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
