...
- (id)jsonDictionary
{
  ...
  id v5 = [(BMSafariBrowsingAssistantWebpageUrlSent *)self url];
...
- (BMSafariBrowsingAssistantWebpageUrlSent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSData", objc_opt_class(), @"webpageViewIdentifier"];
      v23[0] = v10;
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v18 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"url"];
        v21 = v18;
...
- (NSString)description
{
  ...
  id v4 = [(BMSafariBrowsingAssistantWebpageUrlSent *)self webpageViewIdentifier];
  id v5 = [(BMSafariBrowsingAssistantWebpageUrlSent *)self url];
  id v6 = (void *)[v3 initWithFormat:@"BMSafariBrowsingAssistantWebpageUrlSent with webpageViewIdentifier: %@, url: %@", v4, v5];
...
+ (id)protoFields
{
  ...
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"url" number:2 type:13 subMessageClass:0];
  v6[1] = v3;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"url" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSafariBrowsingAssistantWebpageUrlSent alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
