@interface BMPhotosFavorite
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
+ (id)validKeyPaths;
+ (unsigned)latestDataVersion;
- (BMPhotosFavorite)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5;
- (BMPhotosFavorite)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
@implementation BMPhotosFavorite
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMPhotosFavorite *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMPhotosFavorite *)self identifier];
      v10 = [v5 identifier];
    ...
    v13 = [(BMPhotosFavorite *)self subset];
    ...
    {
      v15 = (void *)v14;
      v16 = [(BMPhotosFavorite *)self subset];
      v17 = [v5 subset];
...
LABEL_12:
    ...
    int v19 = [(BMPhotosFavorite *)self type];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMPhotosFavorite *)self identifier];
  id v4 = [(BMPhotosFavorite *)self subset];
  id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMPhotosFavorite type](self, "type"));
  v11[0] = @"identifier";
  v6 = v3;
  if (!v3)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        id v13 = [NSNumber numberWithInt:BMPhotosFavoriteTypeFromString(v11)];
      }
      BOOL v12 = v13;
    }
    else
    ...
    self = -[BMPhotosFavorite initWithIdentifier:subset:type:](self, "initWithIdentifier:subset:type:", v8, v10, [v12 intValue]);
    v16 = self;
LABEL_24:
...
{
  v3 = objc_opt_new();
  [(BMPhotosFavorite *)self writeTo:v3];
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v31.receiver = self;
  v31.super_class = (Class)BMPhotosFavorite;
...
- (NSString)description
{
  ...
  id v4 = [(BMPhotosFavorite *)self identifier];
  id v5 = [(BMPhotosFavorite *)self subset];
  id v6 = BMPhotosFavoriteTypeAsString([(BMPhotosFavorite *)self type]);
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMPhotosFavorite with identifier: %@, subset: %@, type: %@", v4, v5, v6];
...
- (BMPhotosFavorite)initWithIdentifier:(id)a3 subset:(id)a4 type:(int)a5
{
  ...
  id v10 = a4;
  v13.receiver = self;
  v13.super_class = (Class)BMPhotosFavorite;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMPhotosFavorite alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
