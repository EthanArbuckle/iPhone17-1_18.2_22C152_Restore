...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v7 = [v5 topicIdentifier];
    if (v6 == (void *)v7)
    {
    }
    else
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMUniversalRecentsMetadataTopic *)self title];
  v9[0] = @"topicIdentifier";
  id v5 = v3;
  if (!v3)
  {
...
- (BMUniversalRecentsMetadataTopic)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"topicIdentifier"];
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"topicIdentifier"];
      v23[0] = v10;
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v18 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"title"];
        v21 = v18;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)BMUniversalRecentsMetadataTopic;
...
- (NSString)description
{
  ...
  id v4 = [(BMUniversalRecentsMetadataTopic *)self topicIdentifier];
  id v5 = [(BMUniversalRecentsMetadataTopic *)self title];
  id v6 = (void *)[v3 initWithFormat:@"BMUniversalRecentsMetadataTopic with topicIdentifier: %@, title: %@", v4, v5];
...
- (BMUniversalRecentsMetadataTopic)initWithTopicIdentifier:(id)a3 title:(id)a4
{
  ...
  id v8 = a4;
  v11.receiver = self;
  v11.super_class = (Class)BMUniversalRecentsMetadataTopic;
  v9 = [(BMEventBase *)&v11 init];
  if (v9)
  {
    v9->_dataVersion = [(id)objc_opt_class() latestDataVersion];
    objc_storeStrong((id *)&v9->_topicIdentifier, a3);
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"topicIdentifier" number:1 type:13 subMessageClass:0];
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"title" number:2 type:13 subMessageClass:0];
  v6[1] = v3;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF4C68;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"topicIdentifier" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 1)
  {
    ...
    id v7 = [[BMUniversalRecentsMetadataTopic alloc] initByReadFrom:v6];
    id v8 = v7;
    if (v7) {
      v7[4] = 1;
    }
