...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v7 = [v5 bundleIDwithAnchor];
    if (v6 == (void *)v7)
    {
    }
    else
    ...
    uint64_t v14 = [v5 searchResultTitle];
    if (v13 == (void *)v14)
    {
    }
    else
    ...
    if ([(BMSystemSettingsSearchTermsSearchResultClickedOn *)self hasIndex]
      && [v5 hasIndex])
    {
      int v19 = [(BMSystemSettingsSearchTermsSearchResultClickedOn *)self index];
      BOOL v12 = v19 == [v5 index];
LABEL_17:
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMSystemSettingsSearchTermsSearchResultClickedOn *)self searchResultTitle];
  if ([(BMSystemSettingsSearchTermsSearchResultClickedOn *)self hasIndex])
  {
    id v5 = objc_msgSend(NSNumber, "numberWithInt:", -[BMSystemSettingsSearchTermsSearchResultClickedOn index](self, "index"));
  }
  else
  {
    id v5 = 0;
...
- (BMSystemSettingsSearchTermsSearchResultClickedOn)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"bundleIDwithAnchor"];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"searchResultTitle"];
        id v28 = v12;
    ...
    int v11 = [v6 objectForKeyedSubscript:@"index"];
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"index"];
          v26 = v20;
...
LABEL_11:
  ...
  id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"bundleIDwithAnchor"];
  v30[0] = v10;
...
- (NSString)description
{
  ...
  id v4 = [(BMSystemSettingsSearchTermsSearchResultClickedOn *)self bundleIDwithAnchor];
  id v5 = [(BMSystemSettingsSearchTermsSearchResultClickedOn *)self searchResultTitle];
  id v6 = objc_msgSend(NSNumber, "numberWithInt:", -[BMSystemSettingsSearchTermsSearchResultClickedOn index](self, "index"));
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMSystemSettingsSearchTermsSearchResultClickedOn with bundleIDwithAnchor: %@, searchResultTitle: %@, index: %@", v4, v5, v6];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"bundleIDwithAnchor" number:1 type:13 subMessageClass:0];
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"searchResultTitle", 2, 13, 0, v2);
  v7[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"index" number:3 type:2 subMessageClass:0];
  v7[2] = v4;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF4740;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"bundleIDwithAnchor" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"searchResultTitle" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"index" dataType:0 requestOnly:0 fieldNumber:3 protoDataType:2 convertedType:0];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMSystemSettingsSearchTermsSearchResultClickedOn alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
