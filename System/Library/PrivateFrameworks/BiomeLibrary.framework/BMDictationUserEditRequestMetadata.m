...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ([(BMDictationUserEditRequestMetadata *)self hasSampling_rate]
      && objc_msgSend(v5, "hasSampling_rate"))
    {
      unsigned int v19 = [(BMDictationUserEditRequestMetadata *)self sampling_rate];
      BOOL v12 = v19 == objc_msgSend(v5, "sampling_rate");
LABEL_17:
...
- (id)jsonDictionary
{
  ...
  id v4 = [(BMDictationUserEditRequestMetadata *)self language];
  if ([(BMDictationUserEditRequestMetadata *)self hasSampling_rate])
  {
    id v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMDictationUserEditRequestMetadata sampling_rate](self, "sampling_rate"));
  }
  else
  {
    id v5 = 0;
...
- (BMDictationUserEditRequestMetadata)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  uint64_t v7 = [v6 objectForKeyedSubscript:@"task"];
...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v12 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"language"];
        id v28 = v12;
    ...
    int v11 = [v6 objectForKeyedSubscript:@"sampling_rate"];
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"sampling_rate"];
          v26 = v20;
...
LABEL_11:
  ...
  id v10 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"task"];
  v30[0] = v10;
...
- (NSString)description
{
  ...
  id v4 = [(BMDictationUserEditRequestMetadata *)self task];
  id v5 = [(BMDictationUserEditRequestMetadata *)self language];
  id v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMDictationUserEditRequestMetadata sampling_rate](self, "sampling_rate"));
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMDictationUserEditRequestMetadata with task: %@, language: %@, sampling_rate: %@", v4, v5, v6];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"task" number:1 type:13 subMessageClass:0];
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"language", 2, 13, 0, v2);
  v7[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"sampling_rate" number:3 type:4 subMessageClass:0];
  v7[2] = v4;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF7098;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"task" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"language" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"sampling_rate" dataType:0 requestOnly:0 fieldNumber:3 protoDataType:4 convertedType:0];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    id v8 = [[BMDictationUserEditRequestMetadata alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
