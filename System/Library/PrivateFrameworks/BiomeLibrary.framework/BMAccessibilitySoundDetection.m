...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v14 = [v5 soundDetectionType];
    if (v13 == (void *)v14)
    {
    }
    else
...
- (id)jsonDictionary
{
  ...
  {
    id v4 = NSNumber;
    id v5 = [(BMAccessibilitySoundDetection *)self absoluteTimestamp];
  ...
  uint64_t v7 = [(BMAccessibilitySoundDetection *)self soundDetectionType];
...
LABEL_9:
    ...
    if (v16 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v19 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"soundDetectionType"];
        id v35 = v19;
    ...
    int v18 = [v6 objectForKeyedSubscript:@"name"];
    if (v18 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v24 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"name"];
          v33 = v24;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v29.receiver = self;
  v29.super_class = (Class)BMAccessibilitySoundDetection;
...
- (NSString)description
{
  ...
  id v4 = [(BMAccessibilitySoundDetection *)self absoluteTimestamp];
  id v5 = [(BMAccessibilitySoundDetection *)self soundDetectionType];
  id v6 = [(BMAccessibilitySoundDetection *)self name];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMAccessibilitySoundDetection with absoluteTimestamp: %@, soundDetectionType: %@, name: %@", v4, v5, v6];
...
- (BMAccessibilitySoundDetection)initWithAbsoluteTimestamp:(id)a3 soundDetectionType:(id)a4 name:(id)a5
{
  ...
  id v10 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMAccessibilitySoundDetection;
  ...
  if (v11)
  {
    ...
    objc_storeStrong((id *)&v11->_soundDetectionType, a4);
...
+ (id)protoFields
{
  ...
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"soundDetectionType", 2, 13, 0, v2);
  v7[1] = v3;
...
+ (id)columns
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"soundDetectionType" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 1)
  {
    ...
    uint64_t v7 = [[BMAccessibilitySoundDetection alloc] initByReadFrom:v6];
    id v8 = v7;
    if (v7) {
      v7[8] = 1;
    }
