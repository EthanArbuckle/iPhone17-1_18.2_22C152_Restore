...
- (BMGazeEnrollmentSample)payload;
- (BMOasisAnalyticsGazeEnrollmentEvent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMOasisAnalyticsGazeEnrollmentEvent)initWithMetadata:(id)a3 payload:(id)a4 fixationSamples:(id)a5;
- (BMOasisAnalyticsMetadata)metadata;
- (BOOL)isEqual:(id)a3;
- (NSArray)fixationSamples;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_fixationSamples, 0);
...
LABEL_15:
    ...
    {
      v21 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self fixationSamples];
      v22 = [v5 fixationSamples];
...
- (id)jsonDictionary
{
  ...
  id v5 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self payload];
  v6 = [v5 jsonDictionary];

  uint64_t v7 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self _fixationSamplesJSONArray];
  v13[0] = @"metadata";
  v8 = v4;
  if (!v4)
  {
...
- (id)_fixationSamplesJSONArray
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self fixationSamples];
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v8 = (BMOasisAnalyticsMetadata *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"metadata"];
        v72[0] = v8;
    ...
    id v9 = v7;
    id v61 = 0;
    v8 = [[BMOasisAnalyticsMetadata alloc] initWithJSONDictionary:v9 error:&v61];
    id v14 = v61;
    if (v14)
    {
      v15 = v14;
...
LABEL_37:
  ...
  id v9 = [v6 objectForKeyedSubscript:@"payload"];
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    if (a4)
    {
      ...
      uint64_t v70 = [[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"payload"];
      v10 = (BMGazeEnrollmentSample *)v70;
  ...
  id v11 = v9;
  id v60 = 0;
  v10 = [[BMGazeEnrollmentSample alloc] initWithJSONDictionary:v11 error:&v60];
  id v27 = v60;
  if (v27)
  {
    v28 = v27;
...
LABEL_7:
  id v11 = [v6 objectForKeyedSubscript:@"fixationSamples"];
  ...
  if (!v13)
  {
    ...
    if (a4)
    {
      ...
      uint64_t v16 = (void *)[[NSString alloc] initWithFormat:@"Expecting %@ as an array", @"fixationSamples"];
      v68 = v16;
    ...
    for (uint64_t i = 0; i != v18; ++i)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (v48)
        {
          ...
          id v22 = (id)[[NSString alloc] initWithFormat:@"Unexpected type null for element of %@, must not be null", @"fixationSamples"];
          id v65 = v22;
...
LABEL_47:
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        if (v48)
        {
          ...
          id v22 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"fixationSamples"];
          id v63 = v22;
          v37 = (void *)MEMORY[0x1E4F1C9E8];
          v38 = &v63;
          v39 = &v62;
      ...
      id v22 = v21;
      v23 = [BMOasisAnalyticsGazeSample alloc];
      id v55 = 0;
      v24 = [(BMOasisAnalyticsGazeSample *)v23 initWithJSONDictionary:v22 error:&v55];
      id v25 = v55;
      if (v25)
      {
        v40 = v25;
...
LABEL_27:
  ...
  v8 = v50;
  v10 = v51;
  self = [(BMOasisAnalyticsGazeEnrollmentEvent *)self initWithMetadata:v50 payload:v51 fixationSamples:v16];
  v26 = self;
  id v6 = v52;
LABEL_48:
...
- (void)writeTo:(id)a3
{
  ...
  long long v11 = 0u;
  long long v12 = 0u;
  uint64_t v5 = self->_fixationSamples;
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v32.receiver = self;
  v32.super_class = (Class)BMOasisAnalyticsGazeEnrollmentEvent;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 3)
      {
        ...
        if ((PBReaderPlaceMark() & 1) == 0
          || (id v24 = [[BMOasisAnalyticsGazeSample alloc] initByReadFrom:v4]) == 0)
        {
LABEL_36:
      ...
      else
      {
        if (v21 == 2)
        {
          ...
          id v22 = [[BMGazeEnrollmentSample alloc] initByReadFrom:v4];
          if (!v22) {
            goto LABEL_36;
          }
          uint64_t v23 = 32;
        ...
        if (v21 == 1)
        {
          ...
          id v22 = [[BMOasisAnalyticsMetadata alloc] initByReadFrom:v4];
          if (!v22) {
            goto LABEL_36;
          }
          uint64_t v23 = 24;
LABEL_31:
  ...
  v5->_fixationSamples = (NSArray *)v27;
...
- (NSString)description
{
  ...
  id v4 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self metadata];
  uint64_t v5 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self payload];
  uint64_t v6 = [(BMOasisAnalyticsGazeEnrollmentEvent *)self fixationSamples];
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMOasisAnalyticsGazeEnrollmentEvent with metadata: %@, payload: %@, fixationSamples: %@", v4, v5, v6];
...
- (BMOasisAnalyticsGazeEnrollmentEvent)initWithMetadata:(id)a3 payload:(id)a4 fixationSamples:(id)a5
{
  ...
  id v11 = a5;
  v14.receiver = self;
  v14.super_class = (Class)BMOasisAnalyticsGazeEnrollmentEvent;
  ...
  if (v12)
  {
    ...
    objc_storeStrong((id *)&v12->_payload, a4);
    objc_storeStrong((id *)&v12->_fixationSamples, a5);
  }
...
+ (id)protoFields
{
  ...
  id v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F503E0]), "initWithName:number:type:subMessageClass:", @"payload", 2, 14, objc_opt_class(), v2);
  v7[1] = v3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"fixationSamples" number:3 type:14 subMessageClass:objc_opt_class()];
  v7[2] = v4;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF7680;
}

+ (id)columns
{
  v7[3] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"metadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_123_89284];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"payload_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_125];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F50408]) initWithName:@"fixationSamples_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_127];
  v7[0] = v2;
  v7[1] = v3;
  v7[2] = v4;
  uint64_t v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v7 count:3];
...
id __46__BMOasisAnalyticsGazeEnrollmentEvent_columns__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v3 = [v2 _fixationSamplesJSONArray];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    uint64_t v8 = [[BMOasisAnalyticsGazeEnrollmentEvent alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
