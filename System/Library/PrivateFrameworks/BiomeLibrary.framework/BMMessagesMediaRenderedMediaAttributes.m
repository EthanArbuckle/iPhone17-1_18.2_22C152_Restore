...
LABEL_4:
  ...
  if (a4)
  {
    ...
    v11 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"UUID"];
    v14[0] = v11;
...
- (NSString)description
{
  ...
  id v4 = [(BMMessagesMediaRenderedMediaAttributes *)self UUID];
  id v5 = (void *)[v3 initWithFormat:@"BMMessagesMediaRenderedMediaAttributes with UUID: %@", v4];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"UUID" number:1 type:13 subMessageClass:0];
  v5[0] = v2;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF6708;
}

+ (id)columns
{
  v5[1] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"UUID" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  v5[0] = v2;
  id v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    objc_super v8 = [[BMMessagesMediaRenderedMediaAttributes alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[4] = 0;
    }
