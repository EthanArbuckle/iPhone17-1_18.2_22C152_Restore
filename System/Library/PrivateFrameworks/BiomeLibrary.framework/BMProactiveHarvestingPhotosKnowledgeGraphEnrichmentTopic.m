...
- (BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic)initWithIdentifier:(id)a3 score:(id)a4;
- (BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)hasScore;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self identifier];
    ...
    {
      v8 = (void *)v7;
      v9 = [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self identifier];
      v10 = [v5 identifier];
    ...
    if (![(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self hasScore]
      && ![v5 hasScore])
    {
      BOOL v12 = 1;
      goto LABEL_13;
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self identifier];
  if (![(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self hasScore]
    || ([(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self score], fabs(v4) == INFINITY))
  {
    v6 = 0;
  }
  else
...
- (id)initByReadFrom:(id)a3
{
  id v4 = a3;
  v27.receiver = self;
  v27.super_class = (Class)BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic;
...
- (NSString)description
{
  ...
  id v4 = [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self identifier];
  id v5 = NSNumber;
  [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self score];
  id v6 = objc_msgSend(v5, "numberWithDouble:");
  uint64_t v7 = (void *)[v3 initWithFormat:@"BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic with identifier: %@, score: %@", v4, v6];
...
- (BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic)initWithIdentifier:(id)a3 score:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  if (a4 == 2)
  {
    ...
    id v7 = [[BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic alloc] initByReadFrom:v6];
    id v8 = v7;
    if (v7) {
      v7[5] = 2;
    }
