...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    int v6 = [(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self interval];
    if (v6 != [v5 interval]) {
      goto LABEL_9;
    }
    ...
    if ([(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self hasValue]
      && [v5 hasValue])
    {
      unsigned int v7 = [(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self value];
      BOOL v8 = v7 == [v5 value];
    }
    else
    {
...
- (id)jsonDictionary
{
  ...
  v3 = objc_msgSend(NSNumber, "numberWithInt:", -[BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount interval](self, "interval"));
  if ([(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self hasValue])
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount value](self, "value"));
  }
  else
  {
    id v4 = 0;
...
- (BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  unsigned int v7 = [v6 objectForKeyedSubscript:@"interval"];
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        id v11 = (id)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber (corresponding to enum value), or NSString (string version of enum)", objc_opt_class(), @"interval"];
        v24[0] = v11;
      ...
      id v9 = [NSNumber numberWithInt:BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCounttimeIntervalFromString(v7)];
    }
    BOOL v8 = v9;
  }
  else
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v16 = (void *)[[NSString alloc] initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"value"];
        v22 = v16;
...
- (NSString)description
{
  ...
  id v4 = BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCounttimeIntervalAsString([(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self interval]);
  id v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount value](self, "value"));
  id v6 = (void *)[v3 initWithFormat:@"BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount with interval: %@, value: %@", v4, v5];
...
+ (id)protoFields
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"interval" number:1 type:4 subMessageClass:0];
  v6[0] = v2;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F503E0]) initWithName:@"value" number:2 type:4 subMessageClass:0];
  v6[1] = v3;
...
+ (id)validKeyPaths
{
  return &unk_1F0BF4C98;
}

+ (id)columns
{
  v6[2] = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"interval" dataType:0 requestOnly:0 fieldNumber:1 protoDataType:4 convertedType:0];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F50420]) initWithName:@"value" dataType:0 requestOnly:0 fieldNumber:2 protoDataType:4 convertedType:0];
  v6[0] = v2;
  v6[1] = v3;
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v6 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    unsigned int v8 = [[BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount alloc] initByReadFrom:v7];
    id v4 = v8;
    if (v8) {
      v8[5] = 0;
    }
