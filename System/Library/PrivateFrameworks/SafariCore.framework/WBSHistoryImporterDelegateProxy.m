...
- (WBSHistoryImporterDelegateProxy)initWithDelegate:(id)a3;
...
- (WBSHistoryImporterDelegateProxy)initWithDelegate:(id)a3
{
  id v5 = a3;
  v12.receiver = self;
  v12.super_class = (Class)WBSHistoryImporterDelegateProxy;
...
- (void)addVisitWithURLString:(id)a3 visitTime:(double)a4 title:(id)a5 loadSuccessful:(BOOL)a6 httpGet:(BOOL)a7 redirectSourceURLString:(id)a8 redirectSourceVisitTime:(double)a9 visitCount:(unint64_t)a10
{
  ...
  id v18 = a5;
  id v19 = a8;
  v20 = [(WBSHistoryImporterDelegate *)self->_delegate remoteObjectProxyWithErrorHandler:&__block_literal_global_53];
...
void __155__WBSHistoryImporterDelegateProxy_addVisitWithURLString_visitTime_title_loadSuccessful_httpGet_redirectSourceURLString_redirectSourceVisitTime_visitCount___block_invoke(uint64_t a1, void *a2)
{
  id v2 = a2;
