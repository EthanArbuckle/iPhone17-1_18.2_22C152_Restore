...
- (id)donateActivityCommand
{
  id v2 = objc_alloc_init(MEMORY[0x263F64778]);
  v3 = [a1 address];
  ...
  if (v3)
  {
    ...
    {
      v6 = [v3 label];
      v7 = [MEMORY[0x263F350C0] locationName];
    ...
    {
      v12 = [v3 postalCode];
      v13 = [MEMORY[0x263F350C0] postalCode];
    ...
    {
      v15 = [v3 street];
      v16 = [MEMORY[0x263F350C0] thoroughfare];
    ...
    {
      v18 = [v3 stateCode];
      v19 = [MEMORY[0x263F350C0] stateOrProvince];
    ...
    {
      v21 = [v3 countryCode];
      v22 = [MEMORY[0x263F350C0] country];
    ...
    {
      v24 = [v3 longitude];
      v25 = [MEMORY[0x263F350C0] longitude];
    ...
    {
      v27 = [v3 latitude];
      v28 = [MEMORY[0x263F350C0] latitude];
  ...
  [v2 setMetadata:v4];
  [v2 setVisibility:*MEMORY[0x263F650D0]];
  [v2 setStreamType:@"/app/locationActivity"];
  id v31 = objc_alloc_init(MEMORY[0x263F64B90]);
  [v31 setActivity:v2];
