...
LABEL_5:
  ...
  if (v7)
  {
    sub_100029020(v7, &stru_100080CC0);
...
- (id)companionRouteWithID:(id)a3
{
  ...
  {
    NSUInteger v5 = objc_msgSend(v4, "_maps_data");
    uint64_t v30 = 0;
    v31 = &v30;
    ...
    if (!v8)
    {
      ...
      if (v11 != (id)0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        else
        {
          ...
          id v16 = objc_msgSend(v18, "initWithCapacity:", objc_msgSend(v19, "count"));
        }
        uint64_t v20 = v31[5];
        if ([v16 count] < v11) {
          id v11 = [v16 count];
...
- (id)routeWithID:(id)a3
{
  ...
  if ([(NanoRoutePlanningResponse *)self numberOfRoutes])
  {
    ...
    id v14 = sub_1000043A0;
    long long v15 = sub_1000043B0;
    id v16 = 0;
...
- (id)snapshot
{
  ...
  if ([(NSArray *)self->_routes count])
  {
    id v6 = sub_100029020(self->_routes, &stru_100080D58);
    [(NanoRoutePlanningResponseSnapshot *)v3 setRevisionIdentifiers:v6];

    id v7 = sub_100029020(self->_routes, &stru_100080D98);
  ...
  else
  {
    ...
    id v7 = sub_100029020(self->_companionRoutes, &stru_100080DD8);
...
- (NanoRoutePlanningResponse)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      id v9 = sub_100029020(v8, &stru_100080E18);
    }
    else
    {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1000057DC;
  block[3] = &unk_100080E60;
  char v32 = BOOL;
  if (qword_10009B720 != -1)
  {
    dispatch_once(&qword_10009B720, block);
    if (v6) {
      goto LABEL_3;
    }
LABEL_23:
