...
- (IPCGuidanceStateReply)initWithDictionary:(id)a3
{
  ...
  v17 = sub_100037F3C(v4, @"kIPCGuidanceStateReplyPrimaryInstructionsKey");
  [(IPCGuidanceStateReply *)v5 setPrimaryInstructions:v17];

  v18 = sub_100037F3C(v4, @"kIPCGuidanceStateReplySecondaryInstructionsKey");
...
- (id)description
{
  ...
  v20 = sub_100029020(v3, &stru_100082458);

  id v4 = [(IPCGuidanceStateReply *)self secondaryInstructions];
  v19 = sub_100029020(v4, &stru_100082478);
