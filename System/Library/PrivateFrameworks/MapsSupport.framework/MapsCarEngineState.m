...
+ (void)prepareForUse
{
  if (qword_1000A2410 != -1) {
    dispatch_once(&qword_1000A2410, &stru_100088DA0);
  }
}
...
{
  id v32 = a3;
  objc_super v4 = (void *)qword_1000A2428;
...
- (id)description
{
  ...
  unsigned int v5 = sub_100004BC8(v4 & 1 | (((v4 >> 2) & 1) << 16) & 0xFEFFFEFF | (((v4 >> 3) & 1) << 24) | (((v4 >> 1) & 1) << 8));
