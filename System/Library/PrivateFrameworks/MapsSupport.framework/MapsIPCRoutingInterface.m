...
- (void)loadDirections:(id)a3 completion:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  sub_10001F0F8(OS_LOG_TYPE_INFO, @"MapsIPCInterface loadDirections:completion:", v8, v9, v10, v11, v12, v13, v19[0]);
  ...
  v19[1] = 3221225472;
  v19[2] = (uint64_t)sub_10004A854;
  v19[3] = (uint64_t)&unk_100082760;
  id v20 = v6;
  id v21 = v15;
  v19[4] = (uint64_t)self;
  id v17 = v6;
  v18 = v15;
  dispatch_async(messagingQueue, v19);
}
...
- (void)startPreparedNavigation:(id)a3 completion:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  sub_10001F0F8(OS_LOG_TYPE_INFO, @"MapsIPCInterface startPreparedNavigation:completion:", v8, v9, v10, v11, v12, v13, v19[0]);
  v22[0] = _NSConcreteStackBlock;
  v22[1] = 3221225472;
  v22[2] = sub_10004AEBC;
  v22[3] = &unk_100082788;
