...
- (void)_fetchUnresolvedRAPRecordsWithLimit:(unint64_t)a3 offset:(int64_t)a4 oldestDate:(id)a5 completion:(id)a6
{
  id v10 = a5;
  id v11 = a6;
  id v12 = +[_TtC8MapsSync22MapsSyncQueryPredicate queryPredicateWithFormat:@"((status == 0) || (status == 2)) && reportId != ''" argumentArray:0];
  id v27 = v10;
...
LABEL_15:
  ...
  *((void *)&buf + 1) = &buf;
  ...
  block[1] = 3221225472;
  block[2] = sub_100012F78;
  block[3] = &unk_100039050;
  id v32 = v29;
  v33 = &buf;
  id v28 = v29;
...
- (void)_updateMapsSyncRAPRecordWithIdentifiers:(id)a3 toStatus:(signed __int16)a4 forceUpdate:(BOOL)a5 editBlock:(id)a6 completion:(id)a7
{
  ...
  if ([v12 count])
  {
    if (v9)
    {
      ...
      int v16 = +[_TtC8MapsSync22MapsSyncQueryPredicate queryPredicateWithFormat:@"reportId IN %@" argumentArray:v15];
    }
    else
    {
      ...
      int v16 = +[_TtC8MapsSync22MapsSyncQueryPredicate queryPredicateWithFormat:v15 argumentArray:v18];
    }
