...
+ (id)allKeys
{
  if (qword_1000A2440 != -1) {
    dispatch_once(&qword_1000A2440, &stru_100088DC0);
  }
  v2 = (void *)qword_1000A2438;
...
- (id)descriptionForKey:(id)a3
{
  ...
  else
  {
    ...
    {
      uint64_t v9 = sub_100004BC8((int)[(MapsExternalAccessoryState *)self engineTypes]);
    }
    else
    {
      v11.receiver = self;
...
- (void)updateWithInfo:(id)a3
{
        ...
        v11 == (id)v12))
  {
    ...
    if (v22)
    {
      ...
      [v23 setObject:v37 forKeyedSubscript:&off_100090510];
...
LABEL_14:
    ...
    [v23 setObject:v38 forKeyedSubscript:&off_100090528];
...
LABEL_16:
      ...
      [v23 setObject:v24 forKeyedSubscript:&off_100090558];

      goto LABEL_17;
    }
LABEL_33:
    v39 = +[MapsCarEngineState engineStateElectric];
    [v23 setObject:v39 forKeyedSubscript:&off_100090540];
