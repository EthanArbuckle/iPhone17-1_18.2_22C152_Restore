  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((void *)&v10 + 1) + 8 * (void)v9), "locationLeecher:receivedLocation:", self, v4, (void)v10);
...
- (void)_pruneLeachedLocations
{
  ...
  do
  {
    double v6 = (char *)[(NSMutableArray *)self->_leechedLocations count];
    if (v4 < (unint64_t)v6)
    {
      double v7 = v6;
      id v5 = (char *)v4;
      while (1)
      {
        id v8 = [(NSMutableArray *)self->_leechedLocations objectAtIndexedSubscript:v5];
        uint32_t v9 = [v8 timestamp];
        [v9 timeIntervalSinceNow];
        double v11 = -v10;
        double v12 = dbl_100066DB0[2 * v3];
    ...
    long long v13 = *(char **)&dbl_100066DB0[2 * v3 + 1];
...
+ (id)sharedLeecher
{
  if (qword_1000A2588 != -1) {
    dispatch_once(&qword_1000A2588, &stru_10008C120);
  }
  v2 = (void *)qword_1000A2580;
...
- (NavdLocationLeecher)init
{
  ...
  if (v2)
  {
    uint64_t v3 = (GEOLocationShifter *)objc_alloc_init((Class)GEOLocationShifter);
    ...
    long long v13 = +[GEONavdDefaults sharedInstance];
    unint64_t v14 = (NSMutableArray *)objc_msgSend(v12, "initWithCapacity:", objc_msgSend(v13, "maximumNumberOfLeechedLocations"));
...
- (NSArray)leechedLocations
{
  ...
  uint32_t v9 = sub_10003E464;
  uint64_t v10 = sub_10003E474;
  id v11 = 0;
  serialQueue = self->_serialQueue;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend(*(id *)(*((void *)&v10 + 1) + 8 * (void)v9), "locationLeecher:errorLeechingLocation:", self, v4, (void)v10);
    ...
    do
    {
      ...
      do
      {
        ...
        if (objc_opt_respondsToSelector()) {
          objc_msgSend(v8, "locationLeecher:didChangeCoarseMode:", self, -[NavdLocationLeecher coarseModeEnabled](self, "coarseModeEnabled", (void)v9));
        }
        id v7 = (char *)v7 + 1;
      }
      while (v5 != v7);
