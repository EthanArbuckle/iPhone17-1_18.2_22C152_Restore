...
- (FHPeerPaymentForecastingSignalRewards)initWithCoder:(id)a3
{
  ...
  objc_super v5 = [(FHPeerPaymentForecastingSignal *)&v9 initWithCoder:v4];
  if (v5)
  {
...
- (unint64_t)hash
{
  ...
  id v4 = [(FHPeerPaymentForecastingSignalRewards *)self amount];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (FHPeerPaymentForecastingSignalRewards *)a3;
  unint64_t v5 = v4;
  if (v4 == self)
  {
    char v9 = 1;
  ...
  {
    objc_super v7 = [(FHPeerPaymentForecastingSignalRewards *)self amount];
