...
void __47__SGLexiconML__lexiconTokenForToken_inLexicon___block_invoke(uint64_t a1, uint64_t a2, unsigned char *a3)
{
...
+ (BOOL)profanityInTokens:(id)a3 forLocaleIdentifier:(id)a4
{
  ...
  CFDictionaryAddValue(Mutable, (const void *)*MEMORY[0x263F51318], v7);
  CFErrorRef err = 0;
...
LABEL_24:
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_226E32000, v21, OS_LOG_TYPE_ERROR, "SGLexicon: non utf-8 token passed", buf, 2u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      v30 = v9;
      _os_log_error_impl(&dword_226E32000, v10, OS_LOG_TYPE_ERROR, "SGLexicon: Unable to load lexicon, %@", buf, 0xCu);
    }
  }
LABEL_18:
  BOOL v20 = 0;
