@interface MapsSyncServerEvaluationStatusQuery
...
- (_TtC8MapsSync35MapsSyncServerEvaluationStatusQuery)initWithDelegate:(id)a3
{
  return [(MapsSyncServerEvaluationStatusQuery *)self initWithOptions:0 delegate:a3];
}
...
- (void)fetchContents:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  v7 = self;
  swift_retain();
  sub_1A6F95778((void (*)(void, void))sub_1A6F4FF34, v6, 0);
...
- (void)fetchContentsWithCallbackQueue:(id)a3 completion:(id)a4
{
  ...
  *(void *)(v7 + 16) = v6;
  ...
  v10 = self;
  swift_retain();
  sub_1A6F95778((void (*)(void, void))sub_1A6F4FF34, v8, a3);
...
- (void)fetchQueryContents:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  uint64_t v7 = self;
  swift_retain();
  sub_1A6F95778((void (*)(void, void))sub_1A6F4FF38, v6, 0);
...
- (void)fetchQueryContentsWithCallbackQueue:(id)a3 completion:(id)a4
{
  ...
  *(void *)(v7 + 16) = v6;
  ...
  v10 = self;
  swift_retain();
  sub_1A6F95778((void (*)(void, void))sub_1A6F4FF38, v8, a3);
