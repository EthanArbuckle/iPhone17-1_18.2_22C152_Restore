@interface MSAnonymousCredentialRequest
- (MSAnonymousCredentialRequest)init;
- (MSAnonymousCredentialRequest)initWithStore:(id)a3;
...
@implementation MSAnonymousCredentialRequest
...
- (MSAnonymousCredentialRequest)init
{
  ...
  return [(MSAnonymousCredentialRequest *)self initWithStore:v3];
}

- (MSAnonymousCredentialRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for AnonymousCredential();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSAnonymousCredentialRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for AnonymousCredentialRequest();
  id v7 = a3;
  return [(MSAnonymousCredentialRequest *)&v9 init];
}
...
- (void)fetchWithCompletionHandler:(id)a3
{
  ...
  *(void *)(v9 + 24) = self;
  ...
  v12[5] = v11;
  v13 = self;
  sub_1A709B8A0((uint64_t)v7, (uint64_t)&unk_1E96E8F40, (uint64_t)v12);
  swift_release();
}
...
- (void)fetchWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4
{
  ...
  v15 = a3;
  v16 = self;
  sub_1A709B8A0((uint64_t)v9, (uint64_t)&unk_1E96E8F20, (uint64_t)v14);
  swift_release();
}
...
- (void)countWithCompletionHandler:(id)a3
{
  ...
  *(void *)(v9 + 24) = self;
  ...
  v12[5] = v11;
  v13 = self;
  sub_1A709B8A0((uint64_t)v7, (uint64_t)&unk_1E96E8F00, (uint64_t)v12);
  swift_release();
}
