@interface MSHistoryCuratedCollectionRequest
- (MSHistoryCuratedCollectionRequest)init;
- (MSHistoryCuratedCollectionRequest)initWithStore:(id)a3;
...
@implementation MSHistoryCuratedCollectionRequest
...
- (MSHistoryCuratedCollectionRequest)init
{
  ...
  return [(MSHistoryCuratedCollectionRequest *)self initWithStore:v3];
}

- (MSHistoryCuratedCollectionRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for HistoryCuratedCollection();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryCuratedCollectionRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for HistoryCuratedCollectionRequest();
  id v7 = a3;
  return [(MSHistoryCuratedCollectionRequest *)&v9 init];
}
