@interface MSCuratedCollectionRequest
- (MSCuratedCollectionRequest)init;
- (MSCuratedCollectionRequest)initWithStore:(id)a3;
...
@implementation MSCuratedCollectionRequest
...
- (MSCuratedCollectionRequest)init
{
  ...
  return [(MSCuratedCollectionRequest *)self initWithStore:v3];
}

- (MSCuratedCollectionRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for CuratedCollection();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCuratedCollectionRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for CuratedCollectionRequest();
  id v7 = a3;
  return [(MSCuratedCollectionRequest *)&v9 init];
}
