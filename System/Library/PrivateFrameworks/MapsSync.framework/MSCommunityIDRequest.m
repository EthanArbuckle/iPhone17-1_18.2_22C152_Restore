@interface MSCommunityIDRequest
- (MSCommunityIDRequest)init;
- (MSCommunityIDRequest)initWithStore:(id)a3;
...
@implementation MSCommunityIDRequest
...
- (MSCommunityIDRequest)init
{
  ...
  return [(MSCommunityIDRequest *)self initWithStore:v3];
}

- (MSCommunityIDRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for CommunityID();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSCommunityIDRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for CommunityIDRequest();
  id v7 = a3;
  return [(MSCommunityIDRequest *)&v9 init];
}
