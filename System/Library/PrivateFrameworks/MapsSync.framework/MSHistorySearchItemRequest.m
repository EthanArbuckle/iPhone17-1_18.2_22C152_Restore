@interface MSHistorySearchItemRequest
- (MSHistorySearchItemRequest)init;
- (MSHistorySearchItemRequest)initWithStore:(id)a3;
...
@implementation MSHistorySearchItemRequest
...
- (MSHistorySearchItemRequest)init
{
  ...
  return [(MSHistorySearchItemRequest *)self initWithStore:v3];
}

- (MSHistorySearchItemRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for HistorySearchItem();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistorySearchItemRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for HistorySearchItemRequest();
  id v7 = a3;
  return [(MSHistorySearchItemRequest *)&v9 init];
}
