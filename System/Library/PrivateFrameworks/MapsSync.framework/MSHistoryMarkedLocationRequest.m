@interface MSHistoryMarkedLocationRequest
- (MSHistoryMarkedLocationRequest)init;
- (MSHistoryMarkedLocationRequest)initWithStore:(id)a3;
...
@implementation MSHistoryMarkedLocationRequest
...
- (MSHistoryMarkedLocationRequest)init
{
  ...
  return [(MSHistoryMarkedLocationRequest *)self initWithStore:v3];
}

- (MSHistoryMarkedLocationRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for HistoryMarkedLocation();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryMarkedLocationRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for HistoryMarkedLocationRequest();
  id v7 = a3;
  return [(MSHistoryMarkedLocationRequest *)&v9 init];
}
