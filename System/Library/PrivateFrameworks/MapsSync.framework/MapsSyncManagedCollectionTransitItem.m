...
- (MapsSyncManagedCollectionTransitItem)initWithEntity:(id)a3 insertIntoManagedObjectContext:(id)a4;
@end
...
{
  v7.receiver = self;
  v7.super_class = (Class)type metadata accessor for MapsSyncManagedCollectionTransitItem();
