@interface MSSharedTripBlockedItemRequest
- (MSSharedTripBlockedItemRequest)init;
- (MSSharedTripBlockedItemRequest)initWithStore:(id)a3;
...
@implementation MSSharedTripBlockedItemRequest
...
- (MSSharedTripBlockedItemRequest)init
{
  ...
  return [(MSSharedTripBlockedItemRequest *)self initWithStore:v3];
}

- (MSSharedTripBlockedItemRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for SharedTripBlockedItem();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSSharedTripBlockedItemRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for SharedTripBlockedItemRequest();
  id v7 = a3;
  return [(MSSharedTripBlockedItemRequest *)&v9 init];
}
