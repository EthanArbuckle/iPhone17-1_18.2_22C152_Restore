...
- (MSIncidentReportRequest)initWithStore:(id)a3;
...
- (MSIncidentReportRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for IncidentReport();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSIncidentReportRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for IncidentReportRequest();
  id v7 = a3;
  return [(MSIncidentReportRequest *)&v9 init];
}
