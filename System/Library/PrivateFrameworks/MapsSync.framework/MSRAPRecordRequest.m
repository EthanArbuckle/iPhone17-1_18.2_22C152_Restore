@interface MSRAPRecordRequest
- (MSRAPRecordRequest)init;
- (MSRAPRecordRequest)initWithStore:(id)a3;
...
@implementation MSRAPRecordRequest
...
- (MSRAPRecordRequest)init
{
  ...
  return [(MSRAPRecordRequest *)self initWithStore:v3];
}

- (MSRAPRecordRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for RAPRecord();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSRAPRecordRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for RAPRecordRequest();
  id v7 = a3;
  return [(MSRAPRecordRequest *)&v9 init];
}
