@interface MSServerEvaluationStatusRequest
- (MSServerEvaluationStatusRequest)init;
- (MSServerEvaluationStatusRequest)initWithStore:(id)a3;
...
@implementation MSServerEvaluationStatusRequest
...
- (MSServerEvaluationStatusRequest)init
{
  ...
  return [(MSServerEvaluationStatusRequest *)self initWithStore:v3];
}

- (MSServerEvaluationStatusRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for ServerEvaluationStatus();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSServerEvaluationStatusRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for ServerEvaluationStatusRequest();
  id v7 = a3;
  return [(MSServerEvaluationStatusRequest *)&v9 init];
}
