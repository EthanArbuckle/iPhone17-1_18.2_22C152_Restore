@interface MSReviewedPlaceRequest
- (MSReviewedPlaceRequest)init;
- (MSReviewedPlaceRequest)initWithStore:(id)a3;
...
@implementation MSReviewedPlaceRequest
...
- (MSReviewedPlaceRequest)init
{
  ...
  return [(MSReviewedPlaceRequest *)self initWithStore:v3];
}

- (MSReviewedPlaceRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for ReviewedPlace();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSReviewedPlaceRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for ReviewedPlaceRequest();
  id v7 = a3;
  return [(MSReviewedPlaceRequest *)&v9 init];
}
