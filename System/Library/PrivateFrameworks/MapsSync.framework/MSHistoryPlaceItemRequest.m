@interface MSHistoryPlaceItemRequest
- (MSHistoryPlaceItemRequest)init;
- (MSHistoryPlaceItemRequest)initWithStore:(id)a3;
...
@implementation MSHistoryPlaceItemRequest
...
- (MSHistoryPlaceItemRequest)init
{
  ...
  return [(MSHistoryPlaceItemRequest *)self initWithStore:v3];
}

- (MSHistoryPlaceItemRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for HistoryPlaceItem();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryPlaceItemRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for HistoryPlaceItemRequest();
  id v7 = a3;
  return [(MSHistoryPlaceItemRequest *)&v9 init];
}
