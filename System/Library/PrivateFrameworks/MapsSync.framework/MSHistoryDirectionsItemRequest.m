@interface MSHistoryDirectionsItemRequest
- (MSHistoryDirectionsItemRequest)init;
- (MSHistoryDirectionsItemRequest)initWithStore:(id)a3;
...
@implementation MSHistoryDirectionsItemRequest
...
- (MSHistoryDirectionsItemRequest)init
{
  ...
  return [(MSHistoryDirectionsItemRequest *)self initWithStore:v3];
}

- (MSHistoryDirectionsItemRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for HistoryDirectionsItem();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSHistoryDirectionsItemRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for HistoryDirectionsItemRequest();
  id v7 = a3;
  return [(MSHistoryDirectionsItemRequest *)&v9 init];
}
