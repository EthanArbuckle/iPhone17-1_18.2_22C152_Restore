@interface MSAnalyticsIdentifierRequest
- (MSAnalyticsIdentifierRequest)init;
- (MSAnalyticsIdentifierRequest)initWithStore:(id)a3;
...
@implementation MSAnalyticsIdentifierRequest
...
- (MSAnalyticsIdentifierRequest)init
{
  ...
  return [(MSAnalyticsIdentifierRequest *)self initWithStore:v3];
}

- (MSAnalyticsIdentifierRequest)initWithStore:(id)a3
{
  uint64_t v5 = type metadata accessor for AnalyticsIdentifier();
  type metadata accessor for MapsSyncRequest();
  v6 = (objc_class *)swift_allocObject();
  *((void *)v6 + 2) = a3;
  *((void *)v6 + 3) = v5;
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___MSAnalyticsIdentifierRequest__request) = v6;
  v9.receiver = self;
  v9.super_class = (Class)type metadata accessor for AnalyticsIdentifierRequest();
  id v7 = a3;
  return [(MSAnalyticsIdentifierRequest *)&v9 init];
}
