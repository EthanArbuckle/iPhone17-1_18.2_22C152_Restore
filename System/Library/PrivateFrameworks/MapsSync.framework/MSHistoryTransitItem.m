...
- (MSHistoryTransitItem)initWithObject:(id)a3 store:(id)a4 lazyLoad:(BOOL)a5;
...
- (MSHistoryTransitItem)initWithStore:(id)a3 muid:(unint64_t)a4 transitLineStorage:(id)a5
{
  ...
  return (MSHistoryTransitItem *)HistoryTransitItem.init(store:muid:transitLineStorage:)(a3, a4, (uint64_t)v5, v11);
}
...
- (unint64_t)muid
{
  ...
  unint64_t v4 = *(unint64_t *)((char *)&v3->super.super.super.isa + OBJC_IVAR___MSHistoryTransitItem__muid);
...
{
  BOOL v5 = a5;
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR___MSHistoryTransitItem__muid) = 0;
  *(_OWORD *)((char *)&self->super.super.super.isa + OBJC_IVAR___MSHistoryTransitItem__transitLineStorage) = xmmword_1A70A4EA0;
  ...
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR___MSHistoryItem__positionIndex) = 0;
  id v8 = a3;
  return (MSHistoryTransitItem *)sub_1A6FBFBA0(a3, a4, v5);
}
