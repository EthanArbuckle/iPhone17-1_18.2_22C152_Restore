@interface MapsSyncCollectionTransitItem
...
- (NSData)transitLineStorageData
{
  ...
  unint64_t v3 = *(void *)&self->super.super.super._managedObjectID[OBJC_IVAR____TtC8MapsSync29MapsSyncCollectionTransitItem__transitLineStorage];
  if (v3 >> 60 == 15)
  {
    v4 = 0;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  char v6 = sub_1A6F264F0((uint64_t)v8);
...
- (_TtC8MapsSync29MapsSyncCollectionTransitItem)initWithObject:(id)a3
{
  *(_OWORD *)((char *)&self->super.super.super.super.isa
            + OBJC_IVAR____TtC8MapsSync29MapsSyncCollectionTransitItem__transitLineStorage) = xmmword_1A70A4EA0;
  ...
  *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8MapsSync22MapsSyncCollectionItem__collections) = 0;
  id v4 = a3;
  return (_TtC8MapsSync29MapsSyncCollectionTransitItem *)sub_1A70198A0(a3);
}
