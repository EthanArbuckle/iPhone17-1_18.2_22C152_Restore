...
- (STUIStatusBarVisualProvider_Test)init
{
  ...
  v10[3] = @"bottom-left";
  v10[4] = @"bottom-right";
  v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v10 count:5];
...
- (id)setupInContainerView:(id)a3
{
  ...
  uint64_t v6 = [[STUIStatusBarRegion alloc] initWithIdentifier:@"top-left"];
  ...
  objc_super v9 = +[STUIStatusBarRegionAxisAligningLayout aligningLayoutWithAlignment:4];
  [(STUIStatusBarRegionAxesLayout *)v7 setVerticalLayout:v9];

  [(STUIStatusBarRegion *)v6 setLayout:v7];
  v10 = [MEMORY[0x1E4F1CAD0] setWithObject:@"top-center"];
  ...
  v24 = [MEMORY[0x1E4F1CAD0] setWithObject:@"top-center"];
  ...
  v38 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"top-left", @"top-right", 0);
  ...
  v77 = [MEMORY[0x1E4F1CAD0] setWithObject:@"bottom-right"];
  ...
  v95 = [MEMORY[0x1E4F1CAD0] setWithObject:@"bottom-left"];
...
- (id)orderedDisplayItemPlacementsInRegionWithIdentifier:(id)a3
{
  return (id)[(NSMutableDictionary *)self->_orderedDisplayItemPlacements objectForKeyedSubscript:a3];
}

- (id)styleAttributesForStyle:(int64_t)a3
{
  id v4 = [(STUIStatusBarVisualProvider_Test *)self statusBar];
  v5 = +[STUIStatusBarStyleAttributes styleAttributesForStatusBar:v4 style:a3];

  uint64_t v6 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:16.0];
  [v5 setFont:v6];
...
- (void)setOverriddenStyleAttributes:(id)a3 forDisplayItemWithIdentifier:(id)a4
{
  ...
  if (!overriddenStyleAttributes)
  {
    ...
    objc_super v9 = self->_overriddenStyleAttributes;
...
- (id)overriddenStyleAttributesForDisplayItemWithIdentifier:(id)a3
{
  return (id)[(NSMutableDictionary *)self->_overriddenStyleAttributes objectForKeyedSubscript:a3];
}
