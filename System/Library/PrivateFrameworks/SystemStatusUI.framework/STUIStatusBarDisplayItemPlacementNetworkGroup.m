...
+ (id)_groupWithCellularGroup:(id)a3 wifiGroup:(id)a4 includeCellularName:(BOOL)a5
{
  ...
  id v7 = a3;
  id v8 = a4;
  BOOL v9 = +[STUIStatusBarItem defaultDisplayIdentifier];
...
{
  LOBYTE(v8) = 0;
  return (STUIStatusBarDisplayItemPlacementNetworkGroup *)[a1 groupWithHighPriority:a3 lowPriority:a4 cellularItemClass:a5 wifiItemClass:a6 cellularTypeClass:0 includeCellularName:a7 allowDualNetwork:v8];
}
