...
+ (CGSize)_pinSizeForIconSize:(int64_t)a3
{
  ...
  if ((unint64_t)(a3 - 1) >= 0x11) {
    ...
    v4 = (double *)((char *)&unk_1D7ED6958 + 8 * a3 - 8);
  }
  if ((unint64_t)(a3 - 1) >= 0x11) {
    v3 = (double *)MEMORY[0x1E4F1DB30];
  }
...
- (double)_percentageBatteryBoltScaleFactorMultiplier
{
  ...
  {
    v7.receiver = self;
    v7.super_class = (Class)STUIStatusBarBatteryView;
...
- (double)_batteryBoltScaleFactorMultiplier
{
  ...
  {
    v6.receiver = self;
    v6.super_class = (Class)STUIStatusBarBatteryView;
  ...
  else
  {
    ...
    if ((unint64_t)(v4 - 1) >= 0x11) {
      BOOL v5 = (double *)(MEMORY[0x1E4F1DB30] + 8);
    }
    else {
      BOOL v5 = (double *)((char *)&unk_1D7ED6C00 + 8 * v4 - 8);
    }
    return *v5 / 11.5;
  }
  return result;
