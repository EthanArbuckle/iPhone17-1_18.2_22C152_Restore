...
- (id)vocabularyItemFromSpeechWords:(id)a3 speechNamespace:(id)a4 error:(id *)a5
{
  ...
  if (v8 && [v8 count])
  {
    if ([v8 count] == 1)
    {
      if ([v9 isEqualToString:@"podcastTitle"])
      {
        v10 = +[CESRRawSpeechProfileTools placeholderItemIdWithCategoryName:v9];
        builder = self->_builder;
        id v38 = 0;
        id v12 = (id)[(KVItemBuilder *)builder setItemType:16 itemId:v10 error:&v38];
        id v13 = v38;
        v14 = [v8 firstObject];
        v15 = [v14 orthography];
        ...
        v16 = self->_builder;
        id v37 = v13;
        v17 = [(KVItemBuilder *)v16 addFieldWithType:700 value:v15 error:&v37];
        id v18 = v37;
...
LABEL_7:
      ...
      v10 = [NSString stringWithFormat:@"Unexpected namespace: %@ for category: %@", v9, @"com.apple.media.podcasts"];
      v42 = v10;
    ...
    else
    {
      ...
      v10 = [NSString stringWithFormat:@"rawSpeechProfile contains a Podcasts item with an unexpected number of speech words (expected only 1): %@ namespace: %@", v8, v9];
      v44 = v10;
...
- (id)speechCategoryId
{
  return @"com.apple.media.podcasts";
}

- (CESRRawSpeechProfileItemConverterPodcasts)init
{
  v6.receiver = self;
  v6.super_class = (Class)CESRRawSpeechProfileItemConverterPodcasts;
