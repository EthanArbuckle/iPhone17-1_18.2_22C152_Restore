@interface RegisterPostUpgradeANECompilationActivity
@end
...
void ___RegisterPostUpgradeANECompilationActivity_block_invoke_2(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  v3 = a3;
  +[CoreEmbeddedSpeechRecognizer compileAllAssetsWithType:3 completion:&__block_literal_global_298];
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F4E380], OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_debug_impl(&dword_1B8CCB000, v4, OS_LOG_TYPE_DEBUG, "%s On-Device ASR: XPC: Done triggering post-upgrade ANE compilation", (uint8_t *)&v5, 0xCu);
    if (!v3) {
      goto LABEL_4;
    }
    goto LABEL_3;
