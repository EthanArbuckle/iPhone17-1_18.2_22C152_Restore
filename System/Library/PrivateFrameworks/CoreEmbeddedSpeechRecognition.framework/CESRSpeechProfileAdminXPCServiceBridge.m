...
- (id)_getOrCreateXPCServiceConnection
{
  ...
  if (!serviceConnection)
  {
    ...
    uint64_t v4 = (id)*MEMORY[0x1E4F4E380];
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v20 = 2112;
      v21 = v5;
      _os_log_impl(&dword_1B8CCB000, v4, OS_LOG_TYPE_INFO, "%s Connecting to XPC service with interface: %@", buf, 0x16u);
    }
...
void __74__CESRSpeechProfileAdminXPCServiceBridge__getOrCreateXPCServiceConnection__block_invoke(uint64_t a1)
{
  ...
  {
    int v5 = 136315650;
    id v6 = "-[CESRSpeechProfileAdminXPCServiceBridge _getOrCreateXPCServiceConnection]_block_invoke";
    __int16 v7 = 2112;
    id v8 = v3;
    __int16 v9 = 2112;
    id v10 = WeakRetained;
    _os_log_impl(&dword_1B8CCB000, v4, OS_LOG_TYPE_INFO, "%s service connection %@ by %@ was interrupted", (uint8_t *)&v5, 0x20u);
  }
}
...
void __74__CESRSpeechProfileAdminXPCServiceBridge__getOrCreateXPCServiceConnection__block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F4E380], OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v9 = 2112;
    id v10 = WeakRetained;
    _os_log_impl(&dword_1B8CCB000, v4, OS_LOG_TYPE_INFO, "%s service connection %@ by %@ was invalidated", (uint8_t *)&v5, 0x20u);
  }
...
- (CESRSpeechProfileAdminXPCServiceBridge)initWithServiceProtocol:(id)a3 machServiceName:(id)a4
{
  ...
  __int16 v9 = [(CESRSpeechProfileAdminXPCServiceBridge *)&v21 init];
  id v10 = v9;
  if (v9)
  {
    ...
    dispatch_queue_t v17 = dispatch_queue_create("CESRSpeechProfileXPCConnectionQueue", v16);
    queue = v10->_queue;
