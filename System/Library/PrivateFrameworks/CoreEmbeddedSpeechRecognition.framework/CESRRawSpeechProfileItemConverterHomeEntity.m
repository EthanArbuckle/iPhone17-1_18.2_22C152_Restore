...
LABEL_28:
        ...
        v13 = +[CESRRawSpeechProfileTools placeholderItemIdWithCategoryName:@"homekit"];
        builder = self->_builder;
        id v40 = 0;
        id v23 = (id)[(KVItemBuilder *)builder setItemType:4 itemId:v13 error:&v40];
        id v24 = v40;
        v25 = [v8 firstObject];
        v26 = [v25 orthography];
...
LABEL_30:
      ...
      v13 = [NSString stringWithFormat:@"Unexpected namespace: %@ for category: %@", v10, @"com.apple.homekit.name"];
      v44 = v13;
    ...
    else
    {
      ...
      v13 = [NSString stringWithFormat:@"rawSpeechProfile contains a HomeKit item with an unexpected number of speech words (expected only 1): %@ namespace: %@", v8, v9];
      v46 = v13;
