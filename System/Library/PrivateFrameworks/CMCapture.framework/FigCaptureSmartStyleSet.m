...
+ (id)smartStyleSetWithSmartStyles:(id)a3 regions:(id)a4
{
  v4 = -[FigCaptureSmartStyleSet initWithSmartStyles:regions:]([FigCaptureSmartStyleSet alloc], a3, a4);
  return v4;
}
...
- (FigCaptureSmartStyleSet)initWithXPCEncoding:(id)a3
{
  ...
  if (v4)
  {
    xpc_object_t value = xpc_dictionary_get_value(a3, "smartStylesArray");
...
- (id)copyXPCEncoding
{
  ...
  if ([(NSArray *)self->_smartStyles count])
  {
    ...
    do
    {
      v5 = objc_msgSend(-[NSArray objectAtIndexedSubscript:](self->_smartStyles, "objectAtIndexedSubscript:", v4), "copyXPCEncoding");
...
- (id)copyWithZone:(_NSZone *)a3
{
  unint64_t v4 = +[FigCaptureSmartStyleSet allocWithZone:a3];
  smartStyles = self->_smartStyles;
  regions = self->_regions;
  return -[FigCaptureSmartStyleSet initWithSmartStyles:regions:](v4, smartStyles, regions);
}

- (NSString)description
{
  objc_super v3 = (void *)[(NSString *)[(NSArray *)self->_smartStyles description] mutableCopy];
...
- (id)largestRegionSmartStyle
{
  ...
  NSUInteger v4 = [(NSArray *)self->_smartStyles count];
  uint64_t v5 = 8;
  if (v3 > v4) {
    uint64_t v5 = 16;
  }
  ...
  do
  {
    ...
    {
      float v10 = v11 * v12;
      id v9 = [(NSArray *)self->_smartStyles objectAtIndexedSubscript:v8];
    }
    ++v8;
  }
  while (v7 != v8);
