...
uint64_t __captureSession_FileSinkResumeRecording_block_invoke(uint64_t a1)
{
...
LABEL_5:
      ...
      uint64_t result = [(id)-[FigCaptureCameraSourcePipeline captureDevice](v8) setFrameSkippingWhenNotRecordingEnabled:0];
      if (v7)
      {
        ...
        if (result == 1)
        {
          ...
          return [v10 setAutoImageControlMode:2];
        }
      }
      return result;
    }
