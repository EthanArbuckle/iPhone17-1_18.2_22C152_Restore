...
- (id)specifiers
{
  ...
  if (!*v3)
  {
    ...
    uint64_t v8 = [v7 integerForKey:@"com.apple.mobilerepair.FaceIDRepair"];

    if (v8 <= 1)
    {
      v9 = (void *)[objc_alloc(MEMORY[0x263EFFA40]) initWithSuiteName:@"com.apple.mobilerepaird.systemhealth"];
      [v9 setInteger:v8 + 1 forKey:@"com.apple.mobilerepair.FaceIDRepair"];
...
{
  v21.receiver = self;
  v21.super_class = (Class)CRDetailViewComponentFaceID;
  ...
  if (v2)
  {
    ...
    v6 = [v5 localizedStringWithKey:@"TRUEDEPTH_KB_URL" defaultString:@"TRUEDEPTH_KB_URL"];
