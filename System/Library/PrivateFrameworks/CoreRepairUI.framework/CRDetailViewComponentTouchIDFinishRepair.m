@interface CRDetailViewComponentTouchIDFinishRepair
- (CRDetailViewComponentTouchIDFinishRepair)init;
- (id)specifiers;
@end

@implementation CRDetailViewComponentTouchIDFinishRepair
...
- (id)specifiers
{
  ...
  {
    v5 = objc_opt_new();
    v6 = [@"TouchID" stringByAppendingString:@"FinishRepair"];
...
{
  v19.receiver = self;
  v19.super_class = (Class)CRDetailViewComponentTouchIDFinishRepair;
  v2 = [(CRUDetailViewComponent *)&v19 init];
  uint64_t v3 = v2;
  if (v2)
  {
    v4 = [(CRUDetailViewComponent *)v2 locale];
    v5 = [v4 localizedStringWithKey:@"NEW_TOUCH_ID" defaultString:@"NEW_TOUCH_ID"];
    ...
    v11 = [v10 localizedStringWithKey:@"FINISH_TOUCHID_DESC_IPAD" defaultString:@"FINISH_TOUCHID_DESC_IPAD"];
    ...
    v15 = [v14 localizedStringWithKey:@"TouchID" defaultString:@"TouchID"];
    [(CRUDetailViewComponent *)v3 setComponentName:v15];

    v16 = [(CRUDetailViewComponent *)v3 locale];
    v17 = [v16 localizedStringWithKey:@"TOUCHID_FOOTER_LEARN_MORE" defaultString:@"TOUCHID_FOOTER_LEARN_MORE"];
