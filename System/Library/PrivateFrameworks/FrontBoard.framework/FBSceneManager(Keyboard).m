...
+ (void)setKeyboardScene:()Keyboard .cold.1(const char *a1)
{
...
+ (void)setKeyboardScene:()Keyboard .cold.2(const char *a1)
{
  v1 = NSStringFromSelector(a1);
  v2 = (objc_class *)objc_opt_class();
  v3 = NSStringFromClass(v2);
...
+ (void)observeKeyboardSceneAvailability:()Keyboard .cold.1(const char *a1)
{
  v1 = NSStringFromSelector(a1);
  v2 = (objc_class *)objc_opt_class();
  v3 = NSStringFromClass(v2);
