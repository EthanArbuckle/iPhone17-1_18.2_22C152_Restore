...
- (UARPServiceUpdaterDASMatchingRule)initWithCoder:(id)a3
{
  ...
  v8[2] = objc_opt_class();
  v8[3] = objc_opt_class();
  return -[UARPServiceUpdaterDASMatchingRule initWithIdentifier:matchingDictionary:](self, "initWithIdentifier:matchingDictionary:", v5, objc_msgSend(a3, "decodeObjectOfClasses:forKey:", objc_msgSend(v6, "setWithArray:", objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:count:", v8, 4)), @"matchingDictionary"));
}
...
- (unint64_t)hash
{
  v2 = (void *)[NSString stringWithFormat:@"%@", self->_identifier];
  return [v2 hash];
}
