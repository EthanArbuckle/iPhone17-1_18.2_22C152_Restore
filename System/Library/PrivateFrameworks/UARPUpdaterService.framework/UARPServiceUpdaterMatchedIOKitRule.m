...
- (UARPServiceUpdaterMatchedIOKitRule)initWithCoder:(id)a3
{
  ...
  uint64_t v6 = objc_msgSend((id)objc_msgSend(a3, "decodeObjectOfClass:forKey:", objc_opt_class(), @"registryEntryID"), "unsignedLongLongValue");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v5 = [NSNumber numberWithUnsignedLongLong:self->_registryEntryID];
...
- (id)description
{
  ...
  return (id)[v3 stringWithFormat:@"<%@: Identifier=%@, Registry Entry ID=0x%llx", NSStringFromClass(v4), self->_identifier, self->_registryEntryID];
}
