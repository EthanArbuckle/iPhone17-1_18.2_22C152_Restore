@interface STAllowCalendarRestrictionsController
...
@implementation STAllowCalendarRestrictionsController
...
- (id)specifiers
{
  ...
  {
    v23.receiver = self;
    v23.super_class = (Class)STAllowCalendarRestrictionsController;
    v5 = [(PUICalendarPrivacyController *)&v23 specifiers];
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0) {
      -[STAllowCalendarRestrictionsController specifiers]();
    }
    ...
    v15 = [v8 localizedStringForKey:@"CALENDARS_EXPLANATION" value:&stru_26D9391A8 table:@"Restrictions"];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v9 = [(STAllowCalendarRestrictionsController *)self indexPathForIndex:[(STAllowCalendarRestrictionsController *)self indexOfSpecifier:self->_allowedGroup]];
    ...
    && [(PSListController *)self st_shouldShowPINSheetForPINSpecifier])
  {
    ...
    v31[1] = 3221225472;
    v31[2] = __75__STAllowCalendarRestrictionsController_tableView_didSelectRowAtIndexPath___block_invoke;
    v31[3] = &unk_264767278;
    id v32 = v6;
    id v33 = v7;
    v34 = self;
  ...
  {
    v30.receiver = self;
    v30.super_class = (Class)STAllowCalendarRestrictionsController;
    [(STAllowCalendarRestrictionsController *)&v30 tableView:v6 didSelectRowAtIndexPath:v7];
    ...
    v17 = allowedGroup;
    id v18 = v7;
    v19 = [(STAllowCalendarRestrictionsController *)v15 indexPathForIndex:[(STAllowCalendarRestrictionsController *)v15 indexOfSpecifier:v17]];
    ...
    if ([v18 section] == v20)
    {
      ...
      [(STAllowCalendarRestrictionsController *)v15 specifierAtIndex:[(STAllowCalendarRestrictionsController *)v15 indexForIndexPath:v18]];
      ...
      [(PUICalendarPrivacyController *)v15 updateSpecifiersForImposedSettings];
      [v11 reloadSpecifier:v16];
    }
  }
}

void __75__STAllowCalendarRestrictionsController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, int a2)
{
  if (a2)
  {
    ...
    v25.super_class = (Class)STAllowCalendarRestrictionsController;
