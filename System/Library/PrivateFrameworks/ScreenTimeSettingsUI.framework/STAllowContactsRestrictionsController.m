@interface STAllowContactsRestrictionsController
...
- (id)specifiers
{
  ...
  if (!v4)
  {
    ...
    v5 = [(PUIContactsPrivacyController *)&v23 specifiers];
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0) {
      -[STAllowContactsRestrictionsController specifiers]();
    }
    ...
    v15 = [v8 localizedStringForKey:@"CONTACTS_EXPLANATION" value:&stru_26D9391A8 table:@"Restrictions"];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v9 = [(STAllowContactsRestrictionsController *)self indexPathForIndex:[(STAllowContactsRestrictionsController *)self indexOfSpecifier:self->_allowedGroup]];
  ...
  else
  {
    ...
    [(STAllowContactsRestrictionsController *)&v30 tableView:v6 didSelectRowAtIndexPath:v7];
    ...
    v17 = allowedGroup;
    id v18 = v7;
    v19 = [(STAllowContactsRestrictionsController *)v15 indexPathForIndex:[(STAllowContactsRestrictionsController *)v15 indexOfSpecifier:v17]];
    ...
    if ([v18 section] == v20)
    {
      ...
      [(STAllowContactsRestrictionsController *)v15 specifierAtIndex:[(STAllowContactsRestrictionsController *)v15 indexForIndexPath:v18]];
      ...
      [(PUIContactsPrivacyController *)v15 updateSpecifiersForImposedSettings];
