...
- (STTableViewHeaderFooterView)initWithReuseIdentifier:(id)a3
{
  return [(STTableViewHeaderFooterView *)self initWithReuseIdentifier:a3 useLayoutMarginsGuide:0];
}
...
- (STTableViewHeaderFooterView)initWithReuseIdentifier:(id)a3 useLayoutMarginsGuide:(BOOL)a4
{
  ...
  if (v5)
  {
    ...
    if (v4)
    {
      uint64_t v8 = [(STTableViewHeaderFooterView *)v6 layoutMarginsGuide];
    ...
    else
    {
      ...
      v63[11] = v23;
      v24 = [MEMORY[0x263EFF8C0] arrayWithObjects:v63 count:12];
...
- (void)layoutSubviews
{
  ...
  if (v3)
  {
    ...
    {
      BOOL v4 = [(STTableViewHeaderFooterView *)self superview];
