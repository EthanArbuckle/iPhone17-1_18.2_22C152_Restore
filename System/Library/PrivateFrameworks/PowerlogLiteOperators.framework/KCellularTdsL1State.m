...
@implementation KCellularTdsL1State
...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"KTDS_STATE_INIT"])
  {
    int v4 = 0;
  }
  else if ([v3 isEqualToString:@"KTDS_STATE_CS"])
  {
    int v4 = 1;
  }
  else if ([v3 isEqualToString:@"KTDS_STATE_IDLE"])
  {
    int v4 = 2;
  }
  else if ([v3 isEqualToString:@"KTDS_STATE_RA"])
  {
    int v4 = 3;
  }
  else if ([v3 isEqualToString:@"KTDS_STATE_FACH"])
  {
    int v4 = 4;
  }
  else if ([v3 isEqualToString:@"KTDS_STATE_CNNT"])
  {
    int v4 = 5;
  }
  else
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)KCellularTdsL1State;
  int v4 = [(KCellularTdsL1State *)&v8 description];
  v5 = [(KCellularTdsL1State *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return KCellularTdsL1StateReadFrom((uint64_t)self, (uint64_t)a3);
}
