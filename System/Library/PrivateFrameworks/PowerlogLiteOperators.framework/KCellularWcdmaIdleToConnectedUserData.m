...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)KCellularWcdmaIdleToConnectedUserData;
...
- (BOOL)readFrom:(id)a3
{
  return KCellularWcdmaIdleToConnectedUserDataReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[KCellularWcdmaIdleToConnectedUserData setUserData:](self, "setUserData:");
    id v4 = v6;
  }
