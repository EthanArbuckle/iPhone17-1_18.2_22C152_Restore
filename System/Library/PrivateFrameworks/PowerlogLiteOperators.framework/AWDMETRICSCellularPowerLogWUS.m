...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"DISABLE"]) {
    int v4 = 0;
  }
  else {
    int v4 = [v3 isEqualToString:@"ENABLE"];
  }
...
- (id)description
{
  ...
  int v4 = [(AWDMETRICSCellularPowerLogWUS *)&v8 description];
  v5 = [(AWDMETRICSCellularPowerLogWUS *)self dictionaryRepresentation];
