...
- (id)causeAsString:(int)a3
{
  int v4 = @"ORIG_CONV_CALL";
  switch(a3)
  {
    case 0:
      goto LABEL_64;
    case 1:
      int v4 = @"ORIG_STREAM_CALL";
      break;
    case 2:
      int v4 = @"ORIG_INTERACT_CALL";
      break;
    case 3:
      int v4 = @"ORIG_BACKGND_CALL";
      break;
    case 4:
      int v4 = @"ORIG_SUBSCRIBED_TRF_CALL";
      break;
    case 5:
      int v4 = @"TERM_CONV_CALL";
      break;
    case 6:
      int v4 = @"TERM_STREAM_CALL";
      break;
    case 7:
      int v4 = @"TERM_INTERACT_CALL";
      break;
    case 8:
      int v4 = @"TERM_BACKGND_CALL";
      break;
    case 9:
      int v4 = @"EMERGENCY_CALL";
      break;
    case 10:
      int v4 = @"INTER_RAT_CELL_RESELECT";
      break;
    case 11:
      int v4 = @"INTER_RAT_CELL_CHANGE_ORDER";
      break;
    case 12:
      int v4 = @"REGISTRATION";
      break;
    case 13:
      ...
      break;
    case 14:
      int v4 = @"HI_PRI_SIGNALLING";
      break;
    case 15:
      int v4 = @"LOW_PRI_SIGNALLING";
      break;
    case 16:
      int v4 = @"CALL_RE_ESTABLISH";
      break;
    case 17:
      int v4 = @"TERM_HI_SIGNALLING";
      break;
    case 18:
      int v4 = @"TERM_LOW_SIGNALLING";
      break;
    case 19:
      int v4 = @"TERM_UNKNOWN";
      break;
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLogWCDMARRCStateChange;
  int v4 = [(AWDMETRICSCellularPowerLogWCDMARRCStateChange *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLogWCDMARRCStateChangeReadFrom((uint64_t)self, (uint64_t)a3);
}
