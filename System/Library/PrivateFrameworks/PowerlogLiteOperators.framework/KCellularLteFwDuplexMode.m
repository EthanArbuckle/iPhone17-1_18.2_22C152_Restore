...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)KCellularLteFwDuplexMode;
...
LABEL_3:
  ...
  objc_super v8 = [NSNumber numberWithBool:self->_isInTddMode];
...
- (BOOL)readFrom:(id)a3
{
  return KCellularLteFwDuplexModeReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  ...
  *((unsigned char *)v4 + 20) = self->_isInTddMode;
...
LABEL_3:
  ...
  *((unsigned char *)result + 20) = self->_isInTddMode;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_isInTddMode;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
    goto LABEL_7;
  }
LABEL_4:
...
LABEL_3:
  ...
  self->_isInTddMode = *((unsigned char *)v4 + 20);
  *(unsigned char *)&self->_has |= 4u;
