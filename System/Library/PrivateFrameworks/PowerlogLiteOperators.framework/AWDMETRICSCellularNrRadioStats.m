...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSMutableArray)bwpInfos;
- (id)bwpInfoAtIndex:(unint64_t)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (id)dictionaryRepresentation;
- (unint64_t)bwpInfosCount;
- (unint64_t)hash;
- (unint64_t)timestamp;
- (unsigned)durationMs;
- (unsigned)subsId;
...
- (unint64_t)bwpInfosCount
{
  return [(NSMutableArray *)self->_bwpInfos count];
}

- (id)bwpInfoAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_bwpInfos objectAtIndex:a3];
}
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularNrRadioStats;
  id v4 = [(AWDMETRICSCellularNrRadioStats *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_bwpInfos, "count"));
    long long v16 = 0u;
    long long v17 = 0u;
    long long v18 = 0u;
    long long v19 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularNrRadioStatsReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v10 clearBwpInfos];
    unint64_t v5 = [(AWDMETRICSCellularNrRadioStats *)self bwpInfosCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(AWDMETRICSCellularNrRadioStats *)self bwpInfoAtIndex:i];
        [v10 addBwpInfo:v8];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  bwpInfos = self->_bwpInfos;
  if ((unint64_t)bwpInfos | *((void *)v4 + 2))
  {
    if (!-[NSMutableArray isEqual:](bwpInfos, "isEqual:"))
    {
LABEL_19:
      BOOL v8 = 0;
      goto LABEL_20;
  ...
  if ((has & 4) != 0)
  {
    if ((v6 & 4) == 0 || self->_subsId != *((_DWORD *)v4 + 7)) {
      goto LABEL_19;
    }
  }
  else if ((v6 & 4) != 0)
  ...
  if ((has & 2) != 0)
  {
    if ((v6 & 2) == 0 || self->_durationMs != *((_DWORD *)v4 + 6)) {
      goto LABEL_19;
    }
    BOOL v8 = 1;
  }
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [(NSMutableArray *)self->_bwpInfos hash];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        -[AWDMETRICSCellularNrRadioStats addBwpInfo:](self, "addBwpInfo:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
