...
- (void)setupBatterySaverModeForNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    id v19 = v4;
    _os_log_debug_impl(&dword_1D2690000, v5, OS_LOG_TYPE_DEBUG, "batterysaver: setting up %@", buf, 0xCu);
  }
  ...
  if (v10)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v20 = 1024;
      uint32_t v21 = v10;
      _os_log_error_impl(&dword_1D2690000, v12, OS_LOG_TYPE_ERROR, "batterysaver: failed to register for %@ with status %d", buf, 0x12u);
    }
  }
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      id v19 = v9;
      _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "batterysaver: re-syncing %@", buf, 0xCu);
    }
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      id v19 = v9;
      _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "batterysaver: setup complete for %@", buf, 0xCu);
    }
  }
}
  ...
  if (state)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v15 = 1024;
      LODWORD(v16) = v8;
      _os_log_error_impl(&dword_1D2690000, v9, OS_LOG_TYPE_ERROR, "batterysaver: notify_get_state failed for %@ with status %d", buf, 0x12u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412546;
      ...
      _os_log_debug_impl(&dword_1D2690000, v11, OS_LOG_TYPE_DEBUG, "batterysaver: callback %@=%llu", buf, 0x16u);
    }

    [(PLDuetService *)self logEventForwardBatterySaverModeWithState:v10 != 0 fromNotification:v6];
  }
}
...
- (void)logEventForwardBatterySaverModeWithState:(BOOL)a3 fromNotification:(id)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 1024;
    BOOL v16 = v4;
    _os_log_debug_impl(&dword_1D2690000, v7, OS_LOG_TYPE_DEBUG, "batterysaver: %@=%d", (uint8_t *)&v13, 0x12u);
  }

  uint32_t v8 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D30] andName:@"BatterySaverMode"];
  ...
  objc_super v12 = [NSNumber numberWithBool:v4];
