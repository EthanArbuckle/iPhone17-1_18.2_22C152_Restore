...
- (void)taskingStartNotificationReceived:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1D2690000, v4, OS_LOG_TYPE_DEFAULT, "Received tasking start notification", buf, 2u);
  }
...
void __47__PLSoCAgent_taskingStartNotificationReceived___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
    {
      int v5 = 138412290;
      v6 = v2;
      _os_log_debug_impl(&dword_1D2690000, v4, OS_LOG_TYPE_DEBUG, "Got callback for PLSoCAgent_EventPoint_LifetimeServoStats: %@", (uint8_t *)&v5, 0xCu);
    }
  ...
  else
  {
    ...
    {
      LOWORD(v5) = 0;
      _os_log_error_impl(&dword_1D2690000, v4, OS_LOG_TYPE_ERROR, "LTSStats are unavailable", (uint8_t *)&v5, 2u);
    }
  }
}
...
- (void)taskingEndNotificationReceived:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1D2690000, v4, OS_LOG_TYPE_DEFAULT, "Received tasking end notification", buf, 2u);
  }
...
LABEL_11:
    ...
    v12 = (uint8_t *)&v18;
LABEL_22:
    _os_log_error_impl(&dword_1D2690000, v6, OS_LOG_TYPE_ERROR, v11, v12, 2u);
    goto LABEL_11;
  }
  ...
  int v5 = xpc_dictionary_create(0, 0, 0);
  if (!v5)
  {
    v6 = PLLogSoC();
    if (!os_log_type_enabled(v6, OS_LOG_TYPE_ERROR)) {
  ...
  if (v7)
  {
    if (MEMORY[0x1D942AE70](v7) == MEMORY[0x1E4F14590])
    {
    ...
    else
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_error_impl(&dword_1D2690000, v9, OS_LOG_TYPE_ERROR, "Received an error in response", v15, 2u);
      }
  ...
  else
  {
    ...
    {
      *(_WORD *)v16 = 0;
      _os_log_error_impl(&dword_1D2690000, v13, OS_LOG_TYPE_ERROR, "Did not receive a response", v16, 2u);
    }
