...
+ (id)entryEventNoneDefinitionsDASPoliciesBlockingCriteria
{
  ...
  v2 = objc_opt_new();
  [v2 setObject:&unk_1F29F0840 forKeyedSubscript:*MEMORY[0x1E4F92CD0]];
...
+ (id)entryEventNoneDefinitionsDASActivityLifecycle
{
  ...
  v75 = objc_opt_new();
  [v75 setObject:&unk_1F29F0850 forKeyedSubscript:*MEMORY[0x1E4F92CD0]];
...
- (void)initOperatorDependanciesDAS:(id)a3
{
  ...
  if (v4)
  {
    if (([MEMORY[0x1E4F92A88] isPowerlogHelperd] & 1) == 0)
    {
      ...
      v34[3] = &unk_1E692A6F8;
      v34[4] = self;
      uint64_t v6 = (void *)[v5 initWithOperator:v4 withRegistration:&unk_1F29E97E8 withBlock:v34];
      ...
      v33[3] = &unk_1E692A6F8;
      void v33[4] = self;
      v8 = (void *)[v7 initWithOperator:v4 withRegistration:&unk_1F29E9810 withBlock:v33];
      ...
      v32[3] = &unk_1E692A6F8;
      v32[4] = self;
      uint64_t v10 = (void *)[v9 initWithOperator:v4 withRegistration:&unk_1F29E9838 withBlock:v32];
      ...
      v31[3] = &unk_1E692A6F8;
      v31[4] = self;
      uint64_t v12 = (void *)[v11 initWithOperator:v4 withRegistration:&unk_1F29E9860 withBlock:v31];
      ...
      v30[3] = &unk_1E692A6F8;
      v30[4] = self;
      v14 = (void *)[v13 initWithOperator:v4 withRegistration:&unk_1F29E9888 withBlock:v30];
      ...
      v29[3] = &unk_1E692A6F8;
      v29[4] = self;
      v16 = (void *)[v15 initWithOperator:v4 withRegistration:&unk_1F29E98B0 withBlock:v29];
      ...
      v28[3] = &unk_1E692A6F8;
      v28[4] = self;
      v18 = (void *)[v17 initWithOperator:v4 withRegistration:&unk_1F29E98D8 withBlock:v28];
      ...
      v27[3] = &unk_1E692A6F8;
      v27[4] = self;
      v20 = (void *)[v19 initWithOperator:v4 withRegistration:&unk_1F29E9900 withBlock:v27];
      ...
      v26[3] = &unk_1E692A6F8;
      v26[4] = self;
      v22 = (void *)[v21 initWithOperator:v4 withRegistration:&unk_1F29E9928 withBlock:v26];
      ...
      if ([MEMORY[0x1E4F929C0] taskMode])
      {
        ...
        {
          *(_WORD *)v25 = 0;
          _os_log_impl(&dword_1D2690000, v23, OS_LOG_TYPE_DEFAULT, "PerfPowerServices is ready to receive Background Processing Payload", v25, 2u);
        }

        dispatch_time_t v24 = dispatch_time(0, 60000000000);
        dispatch_after(v24, MEMORY[0x1E4F14428], &__block_literal_global_360_0);
      }
    }
  }
}
...
void __48__PLDuetServiceDAS_initOperatorDependanciesDAS___block_invoke_358()
{
  ...
  if (v0)
  {
    if (os_log_type_enabled(v1, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v5 = 1024;
      uint32_t v6 = v0;
      _os_log_error_impl(&dword_1D2690000, v2, OS_LOG_TYPE_ERROR, "Failed to post %s : %d", (uint8_t *)&v3, 0x12u);
    }
  }
  else if (os_log_type_enabled(v1, OS_LOG_TYPE_INFO))
  {
    int v3 = 136315138;
    id v4 = "com.apple.perfpowerservices.reportfeaturestatus";
    _os_log_impl(&dword_1D2690000, v2, OS_LOG_TYPE_INFO, "Posted %s", (uint8_t *)&v3, 0xCu);
  }
}
...
- (void)didReceiveDASActivityEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    block[4] = v5;
    if (qword_1EBD5BDF8 != -1) {
      dispatch_once(&qword_1EBD5BDF8, block);
    }
    if (_MergedGlobals_89)
    {
      uint32_t v6 = [NSString stringWithFormat:@"payload=%@", v4];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    id v75 = v4;
    _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "didReceiveDASActivityEvent: payload=%@", buf, 0xCu);
  }
...
- (void)didReceiveDASActivityLifecycleEventWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    int v14 = 138412290;
    id v15 = v4;
    _os_log_debug_impl(&dword_1D2690000, v5, OS_LOG_TYPE_DEBUG, "didReceiveDASActivityLifecycle payload=%@", (uint8_t *)&v14, 0xCu);
  }

  uint32_t v6 = (void *)MEMORY[0x1D942A350]();
  uint64_t v7 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D40] andName:@"DASActivityLifecycle"];
...
- (void)didReceiveDASInfoEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    uint64_t v24 = v5;
    if (qword_1EBD5BE00 != -1) {
      dispatch_once(&qword_1EBD5BE00, &block);
    }
    if (byte_1EBD5BDE1)
    {
      uint32_t v6 = [NSString stringWithFormat:@"payload=%@", v4, block, v21, v22, v23, v24];
      uint64_t v7 = (void *)MEMORY[0x1E4F929B8];
      v8 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Services/PLDuetServiceDAS.m"];
      id v9 = [v8 lastPathComponent];
  ...
  if (v4)
  {
    ...
    if (v12)
    {
      ...
      int v14 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D40] andName:@"DASInfo"];
...
- (void)didReceiveDASBudgetEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v23 = &__block_descriptor_40_e5_v8__0lu32l8;
    uint64_t v24 = v5;
    if (qword_1EBD5BE08 != -1) {
      dispatch_once(&qword_1EBD5BE08, &block);
    }
    if (byte_1EBD5BDE2)
    {
      uint32_t v6 = [NSString stringWithFormat:@"payload=%@", v4, block, v21, v22, v23, v24];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    id v26 = v4;
    _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "energyBudget payload=%@", buf, 0xCu);
  }
  ...
  if (v4)
  {
    ...
    if (v13)
    {
      int v14 = (void *)MEMORY[0x1D942A350]();
...
- (void)didReceiveDASDataBudgetEventWithPayload:(id)a3
{
  ...
  if (v4
    && ([(PLDuetServiceDAS *)self duetService],
        ...
        v5))
  {
    uint32_t v6 = PLLogDuetServiceDAS();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      int v12 = 138412290;
      id v13 = v4;
      _os_log_debug_impl(&dword_1D2690000, v6, OS_LOG_TYPE_DEBUG, "Received dataBudget payload: %@", (uint8_t *)&v12, 0xCu);
    }

    uint64_t v7 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D30] andName:@"DASDataBudgetAvailable"];
  ...
  {
    uint64_t v7 = PLLogDuetServiceDAS();
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      int v12 = 138412290;
      id v13 = v4;
      _os_log_error_impl(&dword_1D2690000, v7, OS_LOG_TYPE_ERROR, "Empty Payload for dataBudget %@", (uint8_t *)&v12, 0xCu);
    }
  }
}
...
- (void)didReceiveDASReportEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    uint64_t v23 = v5;
    if (qword_1EBD5BE10 != -1) {
      dispatch_once(&qword_1EBD5BE10, &block);
    }
    if (byte_1EBD5BDE3)
    {
      uint32_t v6 = [NSString stringWithFormat:@"payload=%@", v4, block, v20, v21, v22, v23];
      uint64_t v7 = (void *)MEMORY[0x1E4F929B8];
      v8 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Services/PLDuetServiceDAS.m"];
      id v9 = [v8 lastPathComponent];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    id v25 = v4;
    _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "energyReport payload=%@", buf, 0xCu);
  }

  if (v4)
  {
    id v13 = [(PLDuetServiceDAS *)self duetService];

    if (v13)
    {
      uint64_t v14 = (void *)MEMORY[0x1D942A350]();
...
- (void)didReceiveDASPredictionEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    block[4] = v5;
    if (qword_1EBD5BE18 != -1) {
      dispatch_once(&qword_1EBD5BE18, block);
    }
    if (byte_1EBD5BDE4)
    {
      uint32_t v6 = [NSString stringWithFormat:@"payload=%@", v4];
  ...
  if (v4)
  {
    int v12 = [(PLDuetServiceDAS *)self duetService];
    ...
    if (v12)
    {
      ...
      id v13 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v35];
      uint64_t v14 = [v4 objectForKeyedSubscript:@"powerPluggedInPrediction"];
...
- (void)didReceiveDASPoliciesBlockingCriteriaEventWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    id v25 = v4;
    _os_log_debug_impl(&dword_1D2690000, v5, OS_LOG_TYPE_DEBUG, "DASPoliciesBlockingCriteria payload=%@", buf, 0xCu);
  }

  uint32_t v6 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D40] andName:@"DASPoliciesBlockingCriteria"];
  context = (void *)MEMORY[0x1D942A350]();
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        int v12 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v6];
        id v13 = [v11 objectForKeyedSubscript:@"Policy"];
        [v12 setObject:v13 forKeyedSubscript:@"Policy"];

        uint64_t v14 = [v11 objectForKeyedSubscript:&unk_1F29E5F98];
        [v12 setObject:v14 forKeyedSubscript:@"Utility"];

        id v15 = [v11 objectForKeyedSubscript:&unk_1F29E5FB0];
...
- (void)didReceiveDASTrialEventWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    int v11 = 138412290;
    id v12 = v4;
    _os_log_debug_impl(&dword_1D2690000, v5, OS_LOG_TYPE_DEBUG, "DASTrial payload=%@", (uint8_t *)&v11, 0xCu);
  }
