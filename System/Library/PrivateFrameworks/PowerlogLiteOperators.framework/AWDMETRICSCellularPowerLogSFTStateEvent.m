...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLogSFTStateEvent;
  int v4 = [(AWDMETRICSCellularPowerLogSFTStateEvent *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLogSFTStateEventReadFrom((uint64_t)self, (uint64_t)a3);
}
