...
- (void)initOperatorDependancies:(id)a3
{
  ...
  if (v4)
  {
    ...
    v45[3] = &unk_1E692A6F8;
    v45[4] = self;
    v6 = (void *)[v5 initWithOperator:v4 withRegistration:&unk_1F29EB840 withBlock:v45];
    ...
    v44[3] = &unk_1E692A118;
    v44[4] = self;
    v8 = (void *)[v7 initWithOperator:v4 withRegistration:&unk_1F29EB868 withBlock:v44];
    ...
    v43[3] = &unk_1E692A6F8;
    v43[4] = self;
    v10 = (void *)[v9 initWithOperator:v4 withRegistration:&unk_1F29EB890 withBlock:v43];
    ...
    if (v12)
    {
      ...
      v16 = (void *)[objc_alloc(MEMORY[0x1E4F92A90]) initWithKey:@"timestampEnd" withValue:&unk_1F29E7A20 withComparisonOperation:6];
      v17 = [v4 storage];
      v47[0] = v16;
...
- (void)didReceiveStartEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v83[4] = v5;
    if (qword_1EBD5A8C8 != -1) {
      dispatch_once(&qword_1EBD5A8C8, v83);
    }
    if (byte_1EBD5A843)
    {
  ...
  if (v17)
  {
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v82[4] = v19;
      if (qword_1EBD5A8D0 != -1) {
        dispatch_once(&qword_1EBD5A8D0, v82);
      }
      if (byte_1EBD5A844)
      {
  ...
  uint64_t v45 = [v44 countByEnumeratingWithState:&v78 objects:v84 count:16];
  if (v45)
  {
    uint64_t v46 = v45;
    ...
    do
    {
      ...
      do
      {
        ...
        if (!v50)
        {
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            block[4] = v51;
            if (qword_1EBD5A8D8 != -1) {
              dispatch_once(&qword_1EBD5A8D8, block);
            }
            if (byte_1EBD5A845)
            {
              v52 = self;
      ...
      while (v46 != v48);
      uint64_t v46 = [v44 countByEnumeratingWithState:&v78 objects:v84 count:16];
    }
    while (v46);
  }
  ...
  v62 = v73;
  [v61 setObject:v26 forKeyedSubscript:v73];
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v76[4] = v63;
    if (qword_1EBD5A8E0 != -1) {
      dispatch_once(&qword_1EBD5A8E0, v76);
    }
    if (byte_1EBD5A846)
    {
      v64 = NSString;
      ...
      v68 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Services/PLDuetService.m"];
      v69 = [v68 lastPathComponent];
      v70 = [NSString stringWithUTF8String:"-[PLDuetServiceSimple didReceiveStartEventWithPayload:]"];
      [v67 logMessage:v66 fromFile:v69 fromFunction:v70 fromLineNumber:841];
...
- (id)didReceiveStopEventWithPayload:(id)a3
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v213[4] = v5;
    v6 = v213;
    if (qword_1EBD5A8E8 != -1) {
      dispatch_once(&qword_1EBD5A8E8, v6);
    }
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v212[4] = v16;
    v17 = v212;
    if (qword_1EBD5A8F0 != -1) {
      dispatch_once(&qword_1EBD5A8F0, v17);
    }
  ...
  if (v15)
  {
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v211[4] = v34;
      v35 = v211;
      if (qword_1EBD5A8F8 != -1) {
        dispatch_once(&qword_1EBD5A8F8, v35);
      }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v210[4] = v44;
      uint64_t v45 = v210;
      if (qword_1EBD5A900 != -1) {
        dispatch_once(&qword_1EBD5A900, v45);
      }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v209[4] = v53;
      v54 = v209;
      if (qword_1EBD5A908 != -1) {
        dispatch_once(&qword_1EBD5A908, v54);
      }
    ...
    uint64_t v187 = [obj countByEnumeratingWithState:&v205 objects:v217 count:16];
    if (v187)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            v204[4] = v65;
            v66 = v204;
            if (qword_1EBD5A910 != -1) {
              dispatch_once(&qword_1EBD5A910, v66);
            }
          ...
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            v203[4] = v82;
            v83 = v203;
            if (qword_1EBD5A918 != -1) {
              dispatch_once(&qword_1EBD5A918, v83);
            }
            ...
            if (byte_1EBD5A84D)
            {
              ...
              uint64_t v87 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Services/PLDuetService.m"];
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v202[4] = v93;
      v94 = v202;
      if (qword_1EBD5A920 != -1) {
        dispatch_once(&qword_1EBD5A920, v94);
      }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v201[4] = v103;
      v104 = v201;
      if (qword_1EBD5A928 != -1) {
        dispatch_once(&qword_1EBD5A928, v104);
      }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v200[4] = v112;
      v113 = v200;
      if (qword_1EBD5A930 != -1) {
        dispatch_once(&qword_1EBD5A930, v113);
      }
      ...
      if (byte_1EBD5A850)
      {
        ...
        if (os_log_type_enabled(v119, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v219 = v114;
          _os_log_debug_impl(&dword_1D2690000, v119, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
        }
      }
    }
    v120 = [v15 info];
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v199[4] = v123;
      v124 = v199;
      if (qword_1EBD5A938 != -1) {
        dispatch_once(&qword_1EBD5A938, v124);
      }
      ...
      if (byte_1EBD5A851)
      {
        ...
        if (os_log_type_enabled(v130, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v219 = v125;
          _os_log_debug_impl(&dword_1D2690000, v130, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
        }
      }
    }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v198[4] = v137;
      v138 = v198;
      if (qword_1EBD5A940 != -1) {
        dispatch_once(&qword_1EBD5A940, v138);
      }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v197[4] = v146;
      v147 = v197;
      if (qword_1EBD5A948 != -1) {
        dispatch_once(&qword_1EBD5A948, v147);
      }
      ...
      if (byte_1EBD5A853)
      {
        ...
        if (os_log_type_enabled(v155, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          v219 = v150;
          _os_log_debug_impl(&dword_1D2690000, v155, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
        }
      }
    }
    double v156 = 0.0;
    ...
    if (v158)
    {
      ...
      if (v161)
      {
        ...
        v164 = (void *)[objc_alloc(MEMORY[0x1E4F92A90]) initWithKey:@"timestampEnd" withValue:&unk_1F29E7A20 withComparisonOperation:6];
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v188[4] = v172;
      v173 = v188;
      if (qword_1EBD5A950 != -1) {
        dispatch_once(&qword_1EBD5A950, v173);
      }
    ...
    v214 = @"energy";
    v180 = [NSNumber numberWithDouble:v156];
    v215 = v180;
...
void __54__PLDuetServiceSimple_didReceiveStopEventWithPayload___block_invoke_476(uint64_t a1)
{
  ...
  v6 = [NSNumber numberWithDouble:*(double *)(a1 + 64)];
...
- (double)numCPUSecondsForPid:(int)a3
{
  ...
  double result = 0.0;
  if (!v3) {
    objc_msgSend(MEMORY[0x1E4F92A88], "secondsFromMachTime:", (void)v6, 0.0);
  }
  return result;
}
...
- (double)numCPUSecondsForBundleID:(id)a3
{
  int v3 = (void *)MEMORY[0x1F4188790](self);
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v50[4] = v6;
    if (qword_1EBD5A958 != -1) {
      dispatch_once(&qword_1EBD5A958, v50);
    }
    if (byte_1EBD5A855)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(void *)&__b[4] = v7;
        _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "%@", __b, 0xCu);
      }
  ...
  if (v13)
  {
      ...
      do
      {
        ...
        if (v18 >= 1)
        {
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
            block[4] = v19;
            if (qword_1EBD5A960 != -1) {
              dispatch_once(&qword_1EBD5A960, block);
            }
            if (byte_1EBD5A856)
            {
              ...
              if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
              {
                ...
                double v52 = v20;
                _os_log_debug_impl(&dword_1D2690000, v25, OS_LOG_TYPE_DEBUG, "%@", (uint8_t *)&buffer, 0xCu);
              }
            }
          }
          ...
          if (!v29)
          {
            uint64_t v29 = [MEMORY[0x1E4F92A88] bundleIDFromPid:v17];
            if (!v29)
            {
          ...
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            v48[4] = v30;
            if (qword_1EBD5A968 != -1) {
              dispatch_once(&qword_1EBD5A968, v48);
            }
            if (byte_1EBD5A857)
            {
              ...
              if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
              {
                int buffer = 138412290;
                double v52 = v31;
                _os_log_debug_impl(&dword_1D2690000, v36, OS_LOG_TYPE_DEBUG, "%@", (uint8_t *)&buffer, 0xCu);
              }
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v47[4] = v38;
      if (qword_1EBD5A970 != -1) {
        dispatch_once(&qword_1EBD5A970, v47);
      }
      if (byte_1EBD5A858)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_DEBUG))
        {
          int buffer = 138412290;
          double v52 = v29;
          _os_log_debug_impl(&dword_1D2690000, v43, OS_LOG_TYPE_DEBUG, "%@", (uint8_t *)&buffer, 0xCu);
        }
