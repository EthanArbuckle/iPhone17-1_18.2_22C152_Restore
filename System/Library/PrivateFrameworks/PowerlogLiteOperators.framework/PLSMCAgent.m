...
void __43__PLSMCAgent_logThermalAggregationKeysToCA__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  v4 = [*(id *)(a1 + 32) readKey:v3];
  if ([v3 isEqualToString:@"SDTO"])
  {
    uint64_t v5 = [v3 stringByAppendingString:@"_"];

    [v4 doubleValue];
    objc_msgSend(MEMORY[0x1E4F92A88], "roundToSigFigDouble:withSigFig:", 1);
    double v7 = 10.0;
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    int v12 = 138412290;
    id v13 = v3;
    _os_log_debug_impl(&dword_1D2690000, v11, OS_LOG_TYPE_DEBUG, "logging key to CA: %@", (uint8_t *)&v12, 0xCu);
  }
...
- (void)logThermalInstantAndAccumlatedKeys
{
  ...
  id v3 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D48] andName:@"ThermalInstantKeys"];
  v4 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v3];
  long long v33 = 0u;
  long long v34 = 0u;
  long long v35 = 0u;
  long long v36 = 0u;
  uint64_t v5 = [(PLSMCAgent *)self thermalInstantKeys];
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v11 = *(id *)(*((void *)&v33 + 1) + 8 * v10);
        int v12 = v11;
        if ([v11 isEqualToString:@"SDTO"])
        {
          int v12 = [v11 stringByAppendingString:@"_"];
        }
        id v13 = [(PLSMCAgent *)self readKey:v11];
        ...
        {
          v17 = [(PLSMCAgent *)self lastThermalInstantEntry];
          if (v17)
          {
            v18 = [(PLSMCAgent *)self lastThermalInstantEntry];
            v19 = [v18 objectForKeyedSubscript:v12];
            if (v19)
            {
              v31 = [(PLSMCAgent *)self lastThermalInstantEntry];
              v20 = [v31 objectForKeyedSubscript:v12];
              [v20 doubleValue];
              double v22 = v21;
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        v38 = v4;
        _os_log_debug_impl(&dword_1D2690000, v27, OS_LOG_TYPE_DEBUG, "Logging Thermal Instant entry: %@", buf, 0xCu);
      }

      [(PLOperator *)self logEntry:v4];
      [(PLSMCAgent *)self setLastThermalInstantEntry:v4];
    }
  }
  else
  {
        ...
        if (!SMCReadKeyAsNumericWithKnownKeyInfo())
        {
          ...
          if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(void *)buf_4 = v6;
            __int16 v11 = 2112;
            uint64_t v12 = 0;
            _os_log_debug_impl(&dword_1D2690000, v8, OS_LOG_TYPE_DEBUG, "%@: %@", (uint8_t *)&buf, 0x16u);
          }
        }
      }
    }
...
- (id)thermalInstantKeys
{
  if (qword_1EBD57BB0 != -1) {
    dispatch_once(&qword_1EBD57BB0, &__block_literal_global_812);
  }
  v2 = (void *)qword_1EBD57BB8;
  return v2;
}
...
+ (BOOL)supportsThermalSMC
{
  if (qword_1EBD57C10 != -1) {
    dispatch_once(&qword_1EBD57C10, &__block_literal_global_828);
  }
  return byte_1EBD57B1D;
}
...
- (void)logThermalAggregationKeysToCA
{
  ...
  uint64_t v5 = [(PLStateTrackingComposition *)stateTracker getState:1 beforeDate:v4];

  id v6 = self->_stateTracker;
  uint64_t v7 = [MEMORY[0x1E4F1C9C8] monotonicDate];
  int v8 = [(PLStateTrackingComposition *)v6 getState:8 beforeDate:v7];

  uint64_t v9 = self->_stateTracker;
  uint64_t v10 = [MEMORY[0x1E4F1C9C8] monotonicDate];
  __int16 v11 = [(PLStateTrackingComposition *)v9 getState:64 beforeDate:v10];
  int v12 = [v11 BOOLValue];

  uint64_t v13 = PLLogSMC();
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    *(_WORD *)int buf = 0;
    _os_log_debug_impl(&dword_1D2690000, v13, OS_LOG_TYPE_DEBUG, "Log Thermal Aggregated Keys to CA", buf, 2u);
  }

  uint64_t v14 = (void *)MEMORY[0x1E4F1CA60];
  BOOL v15 = [NSNumber numberWithBool:v12 ^ 1u];
  BOOL v16 = objc_msgSend(v14, "dictionaryWithObjectsAndKeys:", v5, @"Plugged", v8, @"Wake", v15, @"Active", 0);
...
- (id)thermalAggregationKeys
{
  if (qword_1EBD57BC0 != -1) {
    dispatch_once(&qword_1EBD57BC0, &__block_literal_global_814);
  }
  v2 = (void *)qword_1EBD57BC8;
  return v2;
}

- (void)registerThermalTimer
{
  id v3 = [(PLSMCAgent *)self thermalLoggingTimer];
  ...
  if (!v3)
  {
    ...
    int v8 = [(PLSMCAgent *)self thermalLoggingTimer];
    [v8 arm];
  }
}
...
- (void)virtualTemperatureMonitorCallback
{
  ...
  else
  {
    ...
    if (v3)
    {
      id v4 = [(PLSMCAgent *)self thermalLoggingTimer];
      [v4 invalidate];
...
- (BOOL)anyVirtualTemperatureAboveThreshold
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  id v3 = [(PLSMCAgent *)self virtualTemperatureKeys];
  ...
  if (v4)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        int v8 = [(PLSMCAgent *)self readKey:*(void *)(*((void *)&v13 + 1) + 8 * i)];
        uint64_t v9 = v8;
        if (v8)
        {
          [v8 doubleValue];
...
- (id)virtualTemperatureKeys
{
  if (qword_1EBD57C00 != -1) {
    dispatch_once(&qword_1EBD57C00, &__block_literal_global_826);
  }
  v2 = (void *)qword_1EBD57C08;
  return v2;
}
...
+ (id)entryEventPointDefinitions
{
  ...
  v8[0] = @"ThermalKeys";
  id v3 = [a1 entryEventPointDefinitionThermalKeys];
  v9[0] = v3;
  v8[1] = @"ThermalInstantKeys";
  uint64_t v4 = [a1 entryEventPointDefinitionThermalInstantKeys];
  v9[1] = v4;
  v8[2] = @"MetricMonitorInstantKeys";
  uint64_t v5 = [a1 entryEventPointDefinitionMetricMonitorInstantKeys];
  v9[2] = v5;
...
+ (id)entryEventPointDefinitionThermalInstantKeys
{
  ...
  uint64_t v40 = objc_msgSend(v41, "commonTypeDict_RealFormat");
  v232[94] = v40;
  v231[95] = @"RP01";
  ...
  long long v36 = objc_msgSend(v37, "commonTypeDict_RealFormat");
  v232[96] = v36;
  v231[97] = @"SDRC";
  long long v35 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v34 = objc_msgSend(v35, "commonTypeDict_RealFormat");
  v232[97] = v34;
  v231[98] = @"SPDM";
  long long v33 = [MEMORY[0x1E4F929D8] sharedInstance];
  ...
  id v22 = objc_msgSend(v23, "commonTypeDict_RealFormat");
  v232[103] = v22;
  v231[104] = @"TDCP";
  ...
  v232[104] = v20;
  v231[105] = @"TR0Q";
  id v19 = [MEMORY[0x1E4F929D8] sharedInstance];
  uint64_t v18 = objc_msgSend(v19, "commonTypeDict_RealFormat");
  v232[105] = v18;
  v231[106] = @"TMPP";
  v17 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v16 = objc_msgSend(v17, "commonTypeDict_RealFormat");
  v232[106] = v16;
  v231[107] = @"TVB5";
  long long v15 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v14 = objc_msgSend(v15, "commonTypeDict_RealFormat");
  v232[107] = v14;
  v231[108] = @"PZCB";
  ...
  uint64_t v6 = objc_msgSend(v5, "commonTypeDict_RealFormat");
  v232[109] = v6;
  v231[110] = @"PZD1";
  ...
  v232[111] = v10;
  BOOL v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v232 forKeys:v231 count:112];
  v236[1] = v11;
  int v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v236 forKeys:v235 count:2];
...
+ (id)entryEventPointDefinitionMetricMonitorInstantKeys
{
  ...
  if ([MEMORY[0x1E4F92A88] isPowerlogHelperd])
  {
    ...
    double v10 = objc_msgSend(v9, "commonTypeDict_RealFormat");
    v26[8] = v10;
    BOOL v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v26 forKeys:v25 count:9];
    v30[1] = v11;
    int v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v30 forKeys:v29 count:2];
  }
  else
  {
    int v12 = (void *)MEMORY[0x1E4F1CC08];
  }
  return v12;
}
...
+ (id)entryEventBackwardDefinitions
{
  ...
  id v3 = [a1 entryEventBackwardDefinitionAccumulatedKeys];
  v9[0] = v3;
  v8[1] = @"PowerAccumulatedKeys";
  uint64_t v4 = [a1 entryEventBackwardDefinitionPowerAccumulatedKeys];
  v9[1] = v4;
  v8[2] = @"DisplayPowerKeys";
  uint64_t v5 = [a1 entryEventBackwardDefinitionDisplayPowerKeys];
  v9[2] = v5;
  uint64_t v6 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v9 forKeys:v8 count:3];
...
+ (id)entryEventBackwardDefinitionAccumulatedKeys
{
  ...
  v311[89] = v42;
  v41 = [MEMORY[0x1E4F929D8] sharedInstance];
  uint64_t v40 = objc_msgSend(v41, "commonTypeDict_IntegerFormat");
  v312[89] = v40;
  ...
  v312[90] = v37;
  long long v36 = [a1 cycleCountKey:@"MSAi"];
  v311[91] = v36;
  long long v35 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v34 = objc_msgSend(v35, "commonTypeDict_IntegerFormat");
  v312[91] = v34;
  long long v33 = [a1 variantKey:@"MSAi"];
  v311[92] = v33;
  uint64_t v32 = [MEMORY[0x1E4F929D8] sharedInstance];
  v31 = objc_msgSend(v32, "commonTypeDict_IntegerFormat");
  v312[92] = v31;
  uint64_t v30 = [a1 channelValueKey:@"PW3C"];
  v311[93] = v30;
  v29 = [MEMORY[0x1E4F929D8] sharedInstance];
  v28 = objc_msgSend(v29, "commonTypeDict_RealFormat");
  v312[93] = v28;
  ...
  v312[95] = v22;
  double v21 = [a1 variantKey:@"PW3C"];
  v311[96] = v21;
  v20 = [MEMORY[0x1E4F929D8] sharedInstance];
  id v19 = objc_msgSend(v20, "commonTypeDict_IntegerFormat");
  v312[96] = v19;
  uint64_t v18 = [a1 channelValueKey:@"PO3R"];
  v311[97] = v18;
  v17 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v16 = objc_msgSend(v17, "commonTypeDict_RealFormat");
  v312[97] = v16;
  long long v15 = [a1 channelValueDiffKey:@"PO3R"];
  v311[98] = v15;
  uint64_t v4 = [MEMORY[0x1E4F929D8] sharedInstance];
  uint64_t v5 = objc_msgSend(v4, "commonTypeDict_RealFormat");
  v312[98] = v5;
  uint64_t v6 = [a1 cycleCountKey:@"PO3R"];
  v311[99] = v6;
  uint64_t v7 = [MEMORY[0x1E4F929D8] sharedInstance];
  int v8 = objc_msgSend(v7, "commonTypeDict_IntegerFormat");
  v312[99] = v8;
  uint64_t v9 = [a1 variantKey:@"PO3R"];
  v311[100] = v9;
  double v10 = [MEMORY[0x1E4F929D8] sharedInstance];
  BOOL v11 = objc_msgSend(v10, "commonTypeDict_IntegerFormat");
  v312[100] = v11;
  int v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v312 forKeys:v311 count:101];
  v316[1] = v12;
  long long v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v316 forKeys:v315 count:2];
...
+ (id)entryEventBackwardDefinitionPowerAccumulatedKeys
{
  ...
  v441[133] = v37;
  long long v36 = [a1 variantKey:@"PZCU"];
  v440[134] = v36;
  long long v35 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v34 = objc_msgSend(v35, "commonTypeDict_IntegerFormat");
  v441[134] = v34;
  long long v33 = [a1 channelValueDiffKey:@"PZCU"];
  v440[135] = v33;
  uint64_t v32 = [MEMORY[0x1E4F929D8] sharedInstance];
  v31 = objc_msgSend(v32, "commonTypeDict_RealFormat");
  v441[135] = v31;
  uint64_t v30 = [a1 channelValueKey:@"PZD1"];
  v440[136] = v30;
  v29 = [MEMORY[0x1E4F929D8] sharedInstance];
  v28 = objc_msgSend(v29, "commonTypeDict_RealFormat");
  v441[136] = v28;
  ...
  id v22 = objc_msgSend(v23, "commonTypeDict_IntegerFormat");
  v441[138] = v22;
  double v21 = [a1 channelValueDiffKey:@"PZD1"];
  v440[139] = v21;
  v20 = [MEMORY[0x1E4F929D8] sharedInstance];
  id v19 = objc_msgSend(v20, "commonTypeDict_RealFormat");
  v441[139] = v19;
  uint64_t v18 = [a1 channelValueKey:@"PGDP"];
  v440[140] = v18;
  v17 = [MEMORY[0x1E4F929D8] sharedInstance];
  long long v16 = objc_msgSend(v17, "commonTypeDict_RealFormat");
  v441[140] = v16;
  long long v15 = [a1 cycleCountKey:@"PGDP"];
  v440[141] = v15;
  uint64_t v4 = [MEMORY[0x1E4F929D8] sharedInstance];
  uint64_t v5 = objc_msgSend(v4, "commonTypeDict_IntegerFormat");
  v441[141] = v5;
  uint64_t v6 = [a1 variantKey:@"PGDP"];
  v440[142] = v6;
  uint64_t v7 = [MEMORY[0x1E4F929D8] sharedInstance];
  int v8 = objc_msgSend(v7, "commonTypeDict_IntegerFormat");
  v441[142] = v8;
  uint64_t v9 = [a1 channelValueDiffKey:@"PGDP"];
  v440[143] = v9;
  double v10 = [MEMORY[0x1E4F929D8] sharedInstance];
  BOOL v11 = objc_msgSend(v10, "commonTypeDict_RealFormat");
  v441[143] = v11;
  int v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v441 forKeys:v440 count:144];
  v445[1] = v12;
  long long v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v445 forKeys:v444 count:2];
...
+ (id)entryEventNoneDefinitions
{
  ...
  v7[1] = @"DRAMVendorKey";
  v8[0] = v3;
  uint64_t v4 = [a1 entryEventNoneDefinitionDRAMVendorKey];
  v8[1] = v4;
...
- (void)initOperatorDependancies
{
  if (+[PLSMCAgent supportsThermalSMC])
  {
    if ([(PLSMCAgent *)self accumSupported])
    {
      ...
      uint64_t v4 = [(PLSMCAgent *)self stateTracker];
    ...
    v23[3] = &unk_1E692A0F0;
    v23[4] = self;
    uint64_t v5 = [MEMORY[0x1E4F929E8] significantBatteryChangeNotificationWithOperator:self withBlock:v23];
    sbc = self->_sbc;
    self->_sbc = v5;
    ...
    {
      uint64_t v7 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D30] andName:@"ScreenState"];
      ...
      v22[3] = &unk_1E692A0F0;
      v22[4] = self;
      uint64_t v9 = (void *)[v8 initWithOperator:self forEntryKey:v7 withFilter:MEMORY[0x1E4F1CC08] withBlock:v22];
      [(PLSMCAgent *)self setScreenStateNotification:v9];
    }
    id v10 = objc_alloc(MEMORY[0x1E4F92A80]);
    uint64_t v11 = [MEMORY[0x1E4F1C9C8] date];
    int v12 = [(PLOperator *)self workQueue];
    v21[0] = MEMORY[0x1E4F143A8];
    v21[1] = 3221225472;
    v21[2] = __38__PLSMCAgent_initOperatorDependancies__block_invoke_4;
    v21[3] = &unk_1E692A200;
    v21[4] = self;
    long long v13 = (void *)[v10 initWithFireDate:v11 withInterval:1 withTolerance:0 repeats:v12 withUserInfo:v21 withQueue:60.0 withBlock:0.0];
    [(PLSMCAgent *)self setThermalMonitorTimer:v13];

    long long v14 = [(PLSMCAgent *)self thermalMonitorTimer];
    [v14 arm];
    ...
    v20[3] = &unk_1E692A200;
    v20[4] = self;
    uint64_t v18 = (void *)[v15 initWithFireDate:v16 withInterval:1 withTolerance:0 repeats:v17 withUserInfo:v20 withQueue:600.0 withBlock:0.0];
...
- (void)logEventPointThermalKeys
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  uint64_t v5 = [(PLSMCAgent *)self thermalKeys];
...
- (void)logEventPointMetricMonitorInstantKeys
{
  ...
  if ([MEMORY[0x1E4F92A88] isPowerlogHelperd])
  {
    ...
    long long v15 = 0u;
    long long v16 = 0u;
    uint64_t v5 = [(PLSMCAgent *)self metricMonitorInstantKeys];
    ...
    do
    {
      ...
      do
      {
        ...
        if ([MEMORY[0x1E4F929C0] debugEnabled])
        {
          ...
          block[4] = v11;
          if (qword_1EBD57B38 != -1) {
            dispatch_once(&qword_1EBD57B38, block);
          }
      ...
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        if (-[PLSMCAgent SMCKeyExists:](self, "SMCKeyExists:", v12, v16, (void)v17))
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)int buf = v16;
            uint64_t v22 = v12;
            _os_log_debug_impl(&dword_1D2690000, v14, OS_LOG_TYPE_DEBUG, "ExistingKeys: keyName=%@", buf, 0xCu);
          }
        }
      }
...
- (id)getPowerEntryFromSample:(id)a3 lastSample:(id)a4 withEntryKey:(id)a5
{
  ...
  if (v7)
  {
    ...
    long long v19 = __Block_byref_object_dispose__2;
...
void __62__PLSMCAgent_getPowerEntryFromSample_lastSample_withEntryKey___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (v7
      ...
      && ([v5 channelValue],
          ...
          v14 > 0))
    {
      uint64_t v15 = [NSNumber numberWithDouble:(v11 - v13) / (double)v14];
  ...
  else if ([v5 cycleCount])
  {
    ...
    id v8 = [NSNumber numberWithDouble:v19 / (double)v20];
...
void __71__PLSMCAgent_getAccumEntryFromSample_lastSample_withEntryKey_withDate___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v31 = a2;
  id v5 = a3;
  id v6 = +[PLSMCAgent channelValueKey:v31];
  ...
  id v11 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", objc_msgSend(v5, "cycleCount"));
  id v12 = *(void **)(a1 + 32);
  double v13 = +[PLSMCAgent cycleCountKey:v31];
  [v12 setObject:v11 forKeyedSubscript:v13];

  int v14 = objc_msgSend(NSNumber, "numberWithUnsignedChar:", objc_msgSend(v5, "variant"));
  id v15 = *(void **)(a1 + 32);
  uint64_t v16 = +[PLSMCAgent variantKey:v31];
  [v15 setObject:v14 forKeyedSubscript:v16];

  id v17 = +[PLSMCAgent channelValueDiffKey:v31];
  ...
  if (v16)
  {
    ...
    if (v19)
    {
      id v20 = [v19 objectForKeyedSubscript:v31];
      id v21 = v20;
      if (v20)
      {
        ...
        if (v22 <= [v5 cycleCount])
        {
          ...
          v28 = (void *)MEMORY[0x1E4F92A88];
LABEL_10:
          [v28 roundToSigFigDouble:4 withSigFig:v26];
          uint64_t v30 = objc_msgSend(v27, "numberWithDouble:");
          [*(id *)(a1 + 32) setObject:v30 forKeyedSubscript:v17];
...
- (void)logAccumKeysToCA:(id)a3 withLastSample:(id)a4 andDate:(id)a5
{
  ...
  if (v8 && v9 && a5)
  {
    ...
    if (!v15)
    {
      ...
      {
        *(_WORD *)int buf = 0;
        _os_log_debug_impl(&dword_1D2690000, v16, OS_LOG_TYPE_DEBUG, "Log Power Accumulated Keys to CA", buf, 2u);
      }
...
id __54__PLSMCAgent_logAccumKeysToCA_withLastSample_andDate___block_invoke_2(uint64_t a1)
{
  ...
  v8[0] = @"KeyName";
  v8[1] = @"ChannelValue";
  uint64_t v2 = [NSNumber numberWithDouble:*(double *)(a1 + 56)];
  v9[1] = v2;
  v8[2] = @"CycleCount";
  id v3 = [NSNumber numberWithUnsignedInt:*(unsigned int *)(a1 + 64)];
...
void __29__PLSMCAgent_logDisplayPower__block_invoke(uint64_t a1)
{
  if ([*(id *)(a1 + 32) smcConnection])
  {
    ...
    else
    {
      ...
      {
        *(_WORD *)int buf = 0;
        _os_log_error_impl(&dword_1D2690000, v19, OS_LOG_TYPE_ERROR, "Failed to sample OSAccumulator channel", buf, 2u);
      }
  ...
  else
  {
    ...
    {
      *(_WORD *)id v20 = 0;
      _os_log_error_impl(&dword_1D2690000, v4, OS_LOG_TYPE_ERROR, "Failed to log, invalid SMC connection", v20, 2u);
    }
  }
}
...
- (BOOL)accumSupported
{
  ...
  block[3] = &unk_1E692A250;
  block[4] = self;
  if (qword_1EBD57B40 != -1) {
    dispatch_once(&qword_1EBD57B40, block);
  }
  return byte_1EBD57B19;
}
...
- (BOOL)writeKeyNumeric:(id)a3 withValue:(unint64_t)a4
{
  ...
  if (!v6)
  {
    ...
    *(_WORD *)int buf = 0;
    id v16 = "Not a valid key name";
    id v17 = v15;
    uint32_t v18 = 2;
LABEL_13:
    _os_log_error_impl(&dword_1D2690000, v17, OS_LOG_TYPE_ERROR, v16, buf, v18);
    goto LABEL_10;
  }
  id v8 = v6;
  [v8 UTF8String];
  int v9 = SMCMakeUInt32Key();
  if (v9)
  {
    int v10 = v9;
    *(void *)int buf = 0;
    ...
    if (v11)
    {
      ...
      {
        *(_DWORD *)double v23 = 67109376;
        *(_DWORD *)&v23[4] = v10;
        *(_WORD *)&v23[8] = 1024;
        *(_DWORD *)&v23[10] = v12;
        double v14 = "SMCGetKeyInfo for %u key failed with %d";
LABEL_6:
        _os_log_error_impl(&dword_1D2690000, v13, OS_LOG_TYPE_ERROR, v14, v23, 0xEu);
      }
    }
    else
    {
      [(PLSMCAgent *)self smcConnection];
      int v20 = SMCWriteKeyAsNumeric();
      id v21 = PLLogSMC();
      double v13 = v21;
      if (!v20)
      {
        ...
        {
          *(_DWORD *)double v23 = 138412546;
          *(void *)&v23[4] = v8;
          *(_WORD *)&v23[12] = 2048;
          *(void *)&v23[14] = a4;
          _os_log_debug_impl(&dword_1D2690000, v13, OS_LOG_TYPE_DEBUG, "%@: %llu", v23, 0x16u);
        }
        BOOL v19 = 1;
        goto LABEL_17;
      }
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v23[8] = 1024;
        *(_DWORD *)&v23[10] = v20;
        double v14 = "Writing to %u key failed with %d";
        goto LABEL_6;
      }
    }
    BOOL v19 = 0;
LABEL_17:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)&uint8_t buf[4] = 0;
    id v16 = "SMCMakeUInt32Key for %u key returned 0";
    id v17 = v15;
    uint32_t v18 = 8;
    goto LABEL_13;
  }
...
- (BOOL)sampleKey:(id *)a3 forKey:(unsigned int)a4
{
  ...
  if (![(PLSMCAgent *)self getChannelInfo:*(void *)&a4])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      v11[0] = 67109120;
      v11[1] = a4;
      BOOL v7 = "Fail to fetch channelInfo for key %u";
      id v8 = v6;
      uint32_t v9 = 8;
      goto LABEL_10;
    }
LABEL_6:
  ...
  if (SMCOSAccumSampleChannel())
  {
    ...
    {
      LOWORD(v11[0]) = 0;
      BOOL v7 = "SMCOSAccumSampleChannel fails";
      id v8 = v6;
      uint32_t v9 = 2;
LABEL_10:
      _os_log_error_impl(&dword_1D2690000, v8, OS_LOG_TYPE_ERROR, v7, (uint8_t *)v11, v9);
      goto LABEL_6;
    }
    goto LABEL_6;
  }
...
- (const)getChannelInfo:(unsigned int)a3
{
  ...
  if (!ChannelInfoForKey)
  {
    ...
    {
      *(_WORD *)id v6 = 0;
      _os_log_error_impl(&dword_1D2690000, v4, OS_LOG_TYPE_ERROR, "Invalid reference to SMCAccumChannelInfo", v6, 2u);
    }
  }
...
LABEL_4:
    ...
    if ([(PLSMCAgent *)self sampleKey:a4 forKey:v9])
    {
      if (a4->var1)
      {
        int v11 = PLLogSMC();
        ...
        {
          *(_DWORD *)int buf = 138412290;
          uint64_t v27 = (const char *)v8;
          _os_log_debug_impl(&dword_1D2690000, v11, OS_LOG_TYPE_DEBUG, "Accumulated key: %@", buf, 0xCu);
        }
        LOBYTE(v9) = 1;
        goto LABEL_16;
      }
      ...
      int v20 = __41__PLSMCAgent_readKeyViaOSAccum_toOutput___block_invoke_685;
      id v21 = &__block_descriptor_40_e5_v8__0lu32l8;
      uint64_t v22 = v12;
      if (qword_1EBD57B58 != -1) {
        dispatch_once(&qword_1EBD57B58, &v18);
      }
      if (!byte_1EBD57B1C) {
        goto LABEL_4;
      }
      int v11 = [NSString stringWithFormat:@"%s: Returned cycleCount is zero for %u key, returning kSMCReturnError", "-[PLSMCAgent readKeyViaOSAccum:toOutput:]", v9, v18, v19, v20, v21, v22];
      double v13 = (void *)MEMORY[0x1E4F929B8];
      double v14 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Agents/Hardware/PLSMCAgent.m"];
      BOOL v15 = [v14 lastPathComponent];
      id v16 = [NSString stringWithUTF8String:"-[PLSMCAgent readKeyViaOSAccum:toOutput:]"];
      [v13 logMessage:v11 fromFile:v15 fromFunction:v16 fromLineNumber:3031];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)int buf = 136315394;
        uint64_t v27 = "-[PLSMCAgent readKeyViaOSAccum:toOutput:]";
        __int16 v28 = 1024;
        int v29 = v9;
        _os_log_error_impl(&dword_1D2690000, v11, OS_LOG_TYPE_ERROR, "%s: %u key call to sampleKey failed, returning kSMCReturnError", buf, 0x12u);
      }
    }
    LOBYTE(v9) = 0;
LABEL_16:
...
- (void)logPowerDeliveryKeys
{
  ...
  id v21 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D40] andName:@"PowerDeliveryKeys"];
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v21];
  int v4 = [MEMORY[0x1E4F1CA60] dictionary];
  long long v31 = 0u;
  long long v32 = 0u;
  long long v33 = 0u;
  long long v34 = 0u;
  int v5 = [(PLSMCAgent *)self powerDeliveryKeys];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        int v11 = [(PLSMCAgent *)self readKey:v10];
        if (v11)
        {
  ...
  uint64_t v12 = PLLogSMC();
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_WORD *)int buf = 0;
    _os_log_debug_impl(&dword_1D2690000, v12, OS_LOG_TYPE_DEBUG, "Log Power Delivery Keys to CA", buf, 2u);
  }

  uint64_t v26 = MEMORY[0x1E4F143A8];
  uint64_t v27 = 3221225472;
  __int16 v28 = __34__PLSMCAgent_logPowerDeliveryKeys__block_invoke;
  int v29 = &unk_1E692A228;
  id v20 = v4;
  id v30 = v20;
  AnalyticsSendEventLazy();
  long long v22 = 0u;
  ...
  long long v24 = 0u;
  long long v25 = 0u;
  double v13 = [(PLSMCAgent *)self powerDeliveryResetKeys];
  uint64_t v14 = [v13 countByEnumeratingWithState:&v22 objects:v37 count:16];
  if (v14)
  {
    uint64_t v15 = v14;
    ...
    do
    {
      for (uint64_t j = 0; j != v15; ++j)
      {
        ...
        {
          uint64_t v19 = PLLogSMC();
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)int buf = 138412290;
            uint64_t v36 = v18;
            _os_log_debug_impl(&dword_1D2690000, v19, OS_LOG_TYPE_DEBUG, "%@ key has been successfully reset", buf, 0xCu);
          }
        }
      }
      uint64_t v15 = [v13 countByEnumeratingWithState:&v22 objects:v37 count:16];
    }
    while (v15);
  }
}
...
- (void)logDRAMVendorKey
{
  ...
  id v3 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D40] andName:@"DRAMVendorKey"];
  int v4 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v3];
  int v5 = [(PLSMCAgent *)self DRAMVendorKey];
  uint64_t v6 = [(PLSMCAgent *)self readKey:v5];
  if (v6)
  {
    uint64_t v7 = PLLogSMC();
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      int v8 = 138412290;
      uint64_t v9 = v6;
      _os_log_debug_impl(&dword_1D2690000, v7, OS_LOG_TYPE_DEBUG, "Log DRAM Vendor key with value %@", (uint8_t *)&v8, 0xCu);
    }
...
- (id)thermalKeys
{
  if (qword_1EBD57B60 != -1) {
    dispatch_once(&qword_1EBD57B60, &__block_literal_global_693);
  }
  uint64_t v2 = (void *)qword_1EBD57B68;
  return v2;
}
...
- (id)metricMonitorInstantKeys
{
  if (qword_1EBD57B70 != -1) {
    dispatch_once(&qword_1EBD57B70, &__block_literal_global_804);
  }
  uint64_t v2 = (void *)qword_1EBD57B78;
  return v2;
}

uint64_t __38__PLSMCAgent_metricMonitorInstantKeys__block_invoke()
{
  qword_1EBD57B78 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"B0AP", @"zSLi", @"zSPi", @"xRPE", @"CHAS", @"TB0T", @"TVRM", @"TVBM", @"TVBH", 0);
  return MEMORY[0x1F41817F8]();
}

- (id)displayAccumulatedKeys
{
  if (qword_1EBD57B80 != -1) {
    dispatch_once(&qword_1EBD57B80, &__block_literal_global_806);
  }
  uint64_t v2 = (void *)qword_1EBD57B88;
  return v2;
}

uint64_t __36__PLSMCAgent_displayAccumulatedKeys__block_invoke()
{
  qword_1EBD57B88 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"PDLP", @"PDEP", 0);
  return MEMORY[0x1F41817F8]();
}

- (id)accumulatedKeys
{
  if (qword_1EBD57B90 != -1) {
    dispatch_once(&qword_1EBD57B90, &__block_literal_global_808);
  }
  uint64_t v2 = (void *)qword_1EBD57B98;
  return v2;
}

uint64_t __29__PLSMCAgent_accumulatedKeys__block_invoke()
{
  qword_1EBD57B98 = [MEMORY[0x1E4F1CAD0] set];
  return MEMORY[0x1F41817F8]();
}

- (id)powerAccumulatedKeys
{
  if (qword_1EBD57BA0 != -1) {
    dispatch_once(&qword_1EBD57BA0, &__block_literal_global_810);
  }
  uint64_t v2 = (void *)qword_1EBD57BA8;
  return v2;
}
...
uint64_t __36__PLSMCAgent_thermalAggregationKeys__block_invoke()
{
  objc_msgSend(MEMORY[0x1E4F1CA80], "setWithObjects:", @"B0AP", @"TB5B", @"TVBA", @"TVBB", @"TVBC", @"TVBF", @"TVBQ", @"TVBM", @"TVBR", @"TVFD", @"TVFL", @"TVFG", @"TVLN", @"TV0s", @"TV2s", @"TG0V", @"TH0T",
    ...
    @"TVB4",
    @"TPSP",
  qword_1EBD57BC8 = @"TIOP");
  return MEMORY[0x1F41817F8]();
}

- (id)powerDeliveryKeys
{
  if (qword_1EBD57BD0 != -1) {
    dispatch_once(&qword_1EBD57BD0, &__block_literal_global_820);
  }
  uint64_t v2 = (void *)qword_1EBD57BD8;
  return v2;
}

uint64_t __31__PLSMCAgent_powerDeliveryKeys__block_invoke()
{
  qword_1EBD57BD8 = [MEMORY[0x1E4F1CAD0] set];
  return MEMORY[0x1F41817F8]();
}

- (id)powerDeliveryResetKeys
{
  if (qword_1EBD57BE0 != -1) {
    dispatch_once(&qword_1EBD57BE0, &__block_literal_global_822);
  }
  uint64_t v2 = (void *)qword_1EBD57BE8;
  return v2;
}

uint64_t __36__PLSMCAgent_powerDeliveryResetKeys__block_invoke()
{
  qword_1EBD57BE8 = [MEMORY[0x1E4F1CAD0] set];
  return MEMORY[0x1F41817F8]();
}

- (id)DRAMVendorKey
{
  if (qword_1EBD57BF0 != -1) {
    dispatch_once(&qword_1EBD57BF0, &__block_literal_global_824);
  }
  uint64_t v2 = (void *)qword_1EBD57BF8;
  return v2;
}

void __27__PLSMCAgent_DRAMVendorKey__block_invoke()
{
  v0 = (void *)qword_1EBD57BF8;
  qword_1EBD57BF8 = @"MDSV";
}
...
- (void)stopThermalTimerAndlogFirstLowSample:(BOOL)a3
{
  ...
  int v5 = [(PLSMCAgent *)self thermalLoggingTimer];
...
uint64_t __32__PLSMCAgent_supportsThermalSMC__block_invoke()
{
  ...
  byte_1EBD57B1D = (int)result > 1001014;
  return result;
}

+ (BOOL)shouldModelDisplayPowerFromSMC
{
  if (qword_1EBD57C18 != -1) {
    dispatch_once(&qword_1EBD57C18, &__block_literal_global_831);
  }
  return byte_1EBD57B1E;
}
...
uint64_t __44__PLSMCAgent_shouldModelDisplayPowerFromSMC__block_invoke()
{
  ...
  byte_1EBD57B1E = result;
  return result;
}

+ (BOOL)supportsBasicSMC
{
  if (qword_1EBD57C20 != -1) {
    dispatch_once(&qword_1EBD57C20, &__block_literal_global_833);
  }
  return byte_1EBD57B1F;
}

uint64_t __30__PLSMCAgent_supportsBasicSMC__block_invoke()
{
  uint64_t result = [MEMORY[0x1E4F92A38] kPLSoCClassOfDevice];
  byte_1EBD57B1F = (int)result > 1001009;
  return result;
}
...
{
  int v4 = [MEMORY[0x1E4F1CA60] dictionary];
  if ([&unk_1F29ED778 count])
  {
    char v5 = 0;
    unint64_t v6 = 0;
    do
    {
      uint64_t v7 = [&unk_1F29ED778 objectAtIndexedSubscript:v6];
      int v8 = [NSNumber numberWithUnsignedChar:(a3 >> v5)];
      [v4 setObject:v8 forKeyedSubscript:v7];

      ++v6;
      v5 += 8;
    }
    while (v6 < [&unk_1F29ED778 count]);
  }
  return v4;
}
...
+ (void)reportPMUEventsToCA:(id)a3
{
  ...
  if (![v3 unsignedLongLongValue])
  {
    ...
    if (qword_1EBD57C28 != -1) {
      dispatch_once(&qword_1EBD57C28, &__block_literal_global_853);
    }
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)int buf = 134218242;
      ...
      __int16 v10 = 2112;
      int v11 = v5;
      _os_log_impl(&dword_1D2690000, v6, OS_LOG_TYPE_INFO, "PMU events: %llu -> %@", buf, 0x16u);
    }
...
void __34__PLSMCAgent_reportPMUEventsToCA___block_invoke()
{
  ...
  {
    *(_WORD *)v1 = 0;
    _os_log_impl(&dword_1D2690000, v0, OS_LOG_TYPE_INFO, "PMU events: pushed empty event", v1, 2u);
  }
