...
- (id)description
{
  ...
  int v4 = [(KCellularServingCellLost *)&v8 description];
  v5 = [(KCellularServingCellLost *)self dictionaryRepresentation];
...
LABEL_3:
  ...
  uint64_t lastSysMode = self->_lastSysMode;
  if (lastSysMode >= 0xC)
  {
    objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_lastSysMode);
    v9 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v9 = off_1E692B620[lastSysMode];
  }
  [v3 setObject:v9 forKey:@"last_sys_mode"];
...
LABEL_16:
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_lastSysMode != *((_DWORD *)v4 + 4)) {
      goto LABEL_16;
    }
  }
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_lastSysMode;
  if ((*(unsigned char *)&self->_has & 4) == 0) {
    goto LABEL_7;
  }
LABEL_4:
...
LABEL_3:
  ...
  self->_uint64_t lastSysMode = *((_DWORD *)v4 + 4);
  *(unsigned char *)&self->_has |= 2u;
