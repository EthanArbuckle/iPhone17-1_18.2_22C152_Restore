...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLogNRCarrierComponentInfo;
  id v4 = [(AWDMETRICSCellularPowerLogNRCarrierComponentInfo *)&v8 description];
  v5 = [(AWDMETRICSCellularPowerLogNRCarrierComponentInfo *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_carrierInfos, "count"));
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
    long long v18 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLogNRCarrierComponentInfoReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(AWDMETRICSCellularPowerLogNRCarrierComponentInfo *)self carrierInfosCount])
  {
    ...
    unint64_t v6 = [(AWDMETRICSCellularPowerLogNRCarrierComponentInfo *)self carrierInfosCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(AWDMETRICSCellularPowerLogNRCarrierComponentInfo *)self carrierInfoAtIndex:i];
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        -[AWDMETRICSCellularPowerLogNRCarrierComponentInfo addCarrierInfo:](self, "addCarrierInfo:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
