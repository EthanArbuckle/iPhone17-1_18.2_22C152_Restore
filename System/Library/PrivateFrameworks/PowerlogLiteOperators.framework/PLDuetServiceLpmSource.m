...
{
  id v4 = a3;
  if (v4 && ([MEMORY[0x1E4F92A88] isPowerlogHelperd] & 1) == 0)
  {
    ...
    v12[3] = &unk_1E692A6F8;
    v12[4] = self;
    v7 = (void *)[v5 initWithOperator:v6 withRegistration:&unk_1F29E9950 withBlock:v12];
    ...
    v11[3] = &unk_1E692A6F8;
    v11[4] = self;
    v10 = (void *)[v8 initWithOperator:v9 withRegistration:&unk_1F29E9978 withBlock:v11];
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412290;
        id v23 = v6;
        _os_log_debug_impl(&dword_1D2690000, v8, OS_LOG_TYPE_DEBUG, "didReceiveLpmSourceInfoWithPayload payload=%@", buf, 0xCu);
      }
      ...
      v13 = [NSNumber numberWithShort:v4];
      ...
      MEMORY[0x1D94294C0]([v19 stringByAppendingString:v12], 1);
