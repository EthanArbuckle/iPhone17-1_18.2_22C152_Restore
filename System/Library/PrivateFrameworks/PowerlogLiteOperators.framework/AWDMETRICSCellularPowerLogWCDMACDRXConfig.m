@interface AWDMETRICSCellularPowerLogWCDMACDRXConfig
...
- (id)description
{
  ...
  v4 = [(AWDMETRICSCellularPowerLogWCDMACDRXConfig *)&v8 description];
  v5 = [(AWDMETRICSCellularPowerLogWCDMACDRXConfig *)self dictionaryRepresentation];
...
LABEL_3:
  ...
  objc_super v8 = [NSNumber numberWithUnsignedInt:self->_drxCycleLength];
  [v3 setObject:v8 forKey:@"drx_cycle_length"];
...
LABEL_3:
  ...
  *((_DWORD *)v4 + 4) = self->_drxCycleLength;
...
LABEL_16:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_drxCycleLength != *((_DWORD *)v4 + 4)) {
      goto LABEL_16;
    }
  }
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_drxCycleLength;
  if ((*(unsigned char *)&self->_has & 4) == 0) {
    goto LABEL_7;
  }
LABEL_4:
