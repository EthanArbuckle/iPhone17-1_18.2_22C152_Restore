...
- (id)description
{
  ...
  int v4 = [(KCellularCdma1XRrState *)&v8 description];
  v5 = [(KCellularCdma1XRrState *)self dictionaryRepresentation];
...
LABEL_10:
  v7 = [NSNumber numberWithUnsignedInt:self->_prevCpState];
  [v3 setObject:v7 forKey:@"prev_cp_state"];
...
LABEL_13:
    ...
    {
      v11 = off_1E692D418[currNormalizedState];
    }
...
LABEL_11:
  objc_super v8 = [NSNumber numberWithUnsignedInt:self->_currCpState];
  [v3 setObject:v8 forKey:@"curr_cp_state"];
...
LABEL_31:
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 8) == 0 || self->_prevCpState != *((_DWORD *)v4 + 6)) {
      goto LABEL_31;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 2) == 0 || self->_currCpState != *((_DWORD *)v4 + 4)) {
      goto LABEL_31;
    }
  }
...
LABEL_3:
  ...
  {
LABEL_4:
    uint64_t v4 = 2654435761 * self->_prevCpState;
    if ((*(unsigned char *)&self->_has & 2) != 0) {
      goto LABEL_5;
    }
    goto LABEL_11;
...
LABEL_10:
  ...
  {
LABEL_5:
    uint64_t v5 = 2654435761 * self->_currCpState;
    if ((*(unsigned char *)&self->_has & 0x10) != 0) {
      goto LABEL_6;
    }
LABEL_12:
