...
LABEL_3:
  ...
  objc_super v8 = [NSNumber numberWithUnsignedInt:self->_earfcn];
...
LABEL_13:
  v9 = [NSNumber numberWithUnsignedInt:self->_phyCellId];
...
LABEL_14:
  v10 = [NSNumber numberWithUnsignedInt:self->_nbMs];
...
LABEL_31:
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 2) == 0 || self->_earfcn != *((_DWORD *)v4 + 4)) {
      goto LABEL_31;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 0x10) == 0 || self->_phyCellId != *((_DWORD *)v4 + 7)) {
      goto LABEL_31;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 4) == 0 || self->_nbMs != *((_DWORD *)v4 + 5)) {
      goto LABEL_31;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 8) == 0 || self->_pagingCycleMs != *((_DWORD *)v4 + 6)) {
      goto LABEL_31;
    }
  }
...
LABEL_10:
  ...
  {
LABEL_5:
    uint64_t v5 = 2654435761 * self->_nbMs;
    if ((*(unsigned char *)&self->_has & 8) != 0) {
      goto LABEL_6;
    }
LABEL_12:
...
LABEL_6:
  uint64_t v6 = 2654435761 * self->_pagingCycleMs;
  if ((*(unsigned char *)&self->_has & 0x20) == 0) {
    goto LABEL_13;
  }
LABEL_7:
