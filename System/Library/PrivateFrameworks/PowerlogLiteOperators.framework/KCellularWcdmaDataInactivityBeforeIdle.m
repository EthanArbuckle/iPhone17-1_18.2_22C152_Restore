@interface KCellularWcdmaDataInactivityBeforeIdle
...
@implementation KCellularWcdmaDataInactivityBeforeIdle
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)KCellularWcdmaDataInactivityBeforeIdle;
  v4 = [(KCellularWcdmaDataInactivityBeforeIdle *)&v8 description];
  v5 = [(KCellularWcdmaDataInactivityBeforeIdle *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return KCellularWcdmaDataInactivityBeforeIdleReadFrom((uint64_t)self, (uint64_t)a3);
}
