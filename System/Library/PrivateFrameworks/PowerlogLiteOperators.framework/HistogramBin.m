...
- (void)setHasIds:(BOOL)a3;
- (void)setHasValue:(BOOL)a3;
- (void)setIds:(unsigned int)a3;
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HistogramBin;
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [NSNumber numberWithUnsignedInt:self->_ids];
  ...
  if ((has & 2) != 0)
  {
    v6 = [NSNumber numberWithUnsignedInt:self->_value];
...
- (BOOL)readFrom:(id)a3
{
  return HistogramBinReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 16) & 1) == 0 || self->_ids != *((_DWORD *)v4 + 2)) {
      goto LABEL_11;
    }
  }
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_has)
  {
    uint64_t v2 = 2654435761 * self->_ids;
    if ((*(unsigned char *)&self->_has & 2) != 0) {
      goto LABEL_3;
    }
LABEL_5:
