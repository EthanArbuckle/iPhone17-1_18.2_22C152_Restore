...
- (unint64_t)hash
{
  v3 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[PLProcessExitAggregator labelIdx](self, "labelIdx"));
  uint64_t v4 = [v3 hash];
  unsigned int v5 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[PLProcessExitAggregator lastTTR](self, "lastTTR"));
  uint64_t v6 = [v5 hash] ^ v4;
  int v7 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[PLProcessExitAggregator exitReasonNamespace](self, "exitReasonNamespace"));
  uint64_t v8 = [v7 hash];
  BOOL v9 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[PLProcessExitAggregator exitReasonCode](self, "exitReasonCode"));
