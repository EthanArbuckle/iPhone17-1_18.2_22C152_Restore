...
- (id)description
{
  ...
  id v4 = [(KCellularProtocolStackPerStateHist *)&v8 description];
  v5 = [(KCellularProtocolStackPerStateHist *)self dictionaryRepresentation];
...
LABEL_6:
  ...
  {
    [v10 clearHists];
    unint64_t v6 = [(KCellularProtocolStackPerStateHist *)self histsCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(KCellularProtocolStackPerStateHist *)self histAtIndex:i];
        [v10 addHist:v9];
      }
    }
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        -[KCellularProtocolStackPerStateHist addHist:](self, "addHist:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
