...
- (id)description
{
  ...
  int v4 = [(KCellularWcdmaRrcConnectionState *)&v8 description];
  v5 = [(KCellularWcdmaRrcConnectionState *)self dictionaryRepresentation];
...
LABEL_15:
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_establishmentCause);
    v11 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v11 = off_1E692AF70[establishmentCause];
  }
...
LABEL_19:
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_releaseCause);
    v13 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v13 = off_1E692B028[releaseCause];
  }
