...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDMETRICSCellularPowerLogServiceEvent;
  int v4 = [(AWDMETRICSCellularPowerLogServiceEvent *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return AWDMETRICSCellularPowerLogServiceEventReadFrom((uint64_t)self, (uint64_t)a3);
}
