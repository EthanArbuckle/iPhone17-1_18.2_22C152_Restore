...
- (id)description
{
  ...
  int v4 = [(ComponentCarrierInfo *)&v8 description];
...
LABEL_3:
  ...
  if (dlBandwidth >= 7)
  {
    objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_dlBandwidth);
    v9 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
  else
  {
    v9 = off_1E692D878[dlBandwidth];
  }
