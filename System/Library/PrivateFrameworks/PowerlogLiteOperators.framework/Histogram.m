...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)Histogram;
  id v4 = [(Histogram *)&v8 description];
  v5 = [(Histogram *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [NSNumber numberWithUnsignedInt:self->_index];
    [v3 setObject:v4 forKey:@"index"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return HistogramReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  id v9 = v4;
  if ([(Histogram *)self binsCount])
  {
    [v9 clearBins];
    unint64_t v5 = [(Histogram *)self binsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(Histogram *)self binAtIndex:i];
        [v9 addBin:v8];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 20) & 1) == 0 || self->_index != *((_DWORD *)v4 + 4)) {
      goto LABEL_9;
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[Histogram addBin:](self, "addBin:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
