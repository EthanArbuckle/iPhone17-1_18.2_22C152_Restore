...
+ (void)addRulesForU1ToCollection:(id)a3
{
  ...
  long long v19 = 0u;
  long long v20 = 0u;
  uint64_t v4 = [&unk_1F3DC7830 countByEnumeratingWithState:&v17 objects:v16 count:16];
  if (!v4) {
    return;
  }
  uint64_t v5 = v4;
  ...
  while (2)
  {
    ...
    {
      if (*(void *)v18 != v6) {
        objc_enumerationMutation(&unk_1F3DC7830);
      }
      uint64_t v8 = [*(id *)(*((void *)&v17 + 1) + 8 * i) intValue];
      v9 = [VCVideoRule alloc];
      LODWORD(v10) = 30.0;
      uint64_t v11 = [(VCVideoRule *)v9 initWithFrameWidth:256 frameHeight:768 frameRate:v8 payload:v10];
      if (!v11)
      {
        if ((int)VRTraceGetErrorLogLevelForModule() >= 3)
        {
          ...
          if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F47A50], OS_LOG_TYPE_ERROR)) {
            +[VCVideoRuleCollectionsFaceTexture addRulesForU1ToCollection:v15];
          }
        }
        return;
      }
...
LABEL_13:
      ...
      if (+[VCHardwareSettings supportsHEVCEncoding]) {
        [a3 addVideoRules:v13 transportType:1 payload:100 encodingType:1];
      }
...
LABEL_14:
    ...
    uint64_t v5 = [&unk_1F3DC7830 countByEnumeratingWithState:&v17 objects:v16 count:16];
    if (v5) {
      continue;
    }
    break;
...
+ (void)addRulesForU1ToCollection:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  uint64_t v4 = a1;
  __int16 v5 = 2080;
  uint64_t v6 = "+[VCVideoRuleCollectionsFaceTexture addRulesForU1ToCollection:]";
  __int16 v7 = 1024;
  int v8 = 20;
  __int16 v9 = 2112;
  uint64_t v10 = a2;
