...
- (VCAudioHALPluginRemoteDeviceInfo)init
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)VCAudioHALPluginRemoteDeviceInfo;
  v2 = [(VCAudioHALPluginRemoteDeviceInfo *)&v12 init];
  if (v2)
  {
    if ((VCAudioHALPluginRemoteDeviceInfo *)objc_opt_class() == v2)
    {
...
LABEL_12:
    ...
    else
    {
      if (objc_opt_respondsToSelector()) {
        v3 = (__CFString *)[(VCAudioHALPluginRemoteDeviceInfo *)v2 performSelector:sel_logPrefix];
      }
      else {
        v3 = &stru_1F3D3E450;
      }
...
- (void)dealloc
{
  ...
  if ((VCAudioHALPluginRemoteDeviceInfo *)objc_opt_class() == self)
  {
    if ((int)VRTraceGetErrorLogLevelForModule() >= 6)
    {
      uint64_t v4 = VRTraceErrorLogLevelToCSTR();
      ...
      if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F47A50], OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 136315650;
        uint64_t v13 = v4;
        __int16 v14 = 2080;
        __int16 v15 = "-[VCAudioHALPluginRemoteDeviceInfo dealloc]";
        __int16 v16 = 1024;
        int v17 = 26;
        v6 = " [%s] %s:%d ";
        v7 = v5;
...
LABEL_11:
  ...
  {
    if (objc_opt_respondsToSelector()) {
      v3 = (__CFString *)[(VCAudioHALPluginRemoteDeviceInfo *)self performSelector:sel_logPrefix];
    }
    else {
      v3 = &stru_1F3D3E450;
    }
  ...
  v11.receiver = self;
  v11.super_class = (Class)VCAudioHALPluginRemoteDeviceInfo;
