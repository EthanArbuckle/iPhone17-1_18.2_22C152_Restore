...
- (GDSpeedBucketValue)initWithBucket:(int64_t)a3 bucketValue:(double)a4;
- (GDSpeedBucketValue)initWithCoder:(id)a3;
- (double)bucketValue;
...
- (id)description
{
  ...
  if (bucket > 8) {
    ...
    v4 = off_1E6013800[bucket];
  }
  id v5 = [NSString alloc];
  v9 = objc_msgSend_initWithFormat_(v5, v6, @"GDSpeedBucketValue<bucket: %@, bucketValue: %lf>", v7, v8, v4, *(void *)&self->_bucketValue);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = objc_msgSend_allocWithZone_(GDSpeedBucketValue, a2, (uint64_t)a3, v3, v4);
...
- (GDSpeedBucketValue)initWithCoder:(id)a3
{
  ...
  return (GDSpeedBucketValue *)MEMORY[0x1F4181798](self, sel_initWithBucket_bucketValue_, v14, v24, v25);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)GDSpeedBucketValue;
