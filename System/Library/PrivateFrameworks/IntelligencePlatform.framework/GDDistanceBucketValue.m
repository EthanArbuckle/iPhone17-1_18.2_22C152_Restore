...
- (id)description
{
  ...
  if (bucket > 4) {
    ...
    v4 = off_1E6013880[bucket];
  }
  id v5 = [NSString alloc];
  v9 = objc_msgSend_initWithFormat_(v5, v6, @"GDDistanceBucketValue<bucket: %@, bucketValue: %lf>", v7, v8, v4, *(void *)&self->_bucketValue);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = objc_msgSend_allocWithZone_(GDDistanceBucketValue, a2, (uint64_t)a3, v3, v4);
...
- (GDDistanceBucketValue)initWithCoder:(id)a3
{
  ...
  return (GDDistanceBucketValue *)MEMORY[0x1F4181798](self, sel_initWithBucket_bucketValue_, v14, v24, v25);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)GDDistanceBucketValue;
