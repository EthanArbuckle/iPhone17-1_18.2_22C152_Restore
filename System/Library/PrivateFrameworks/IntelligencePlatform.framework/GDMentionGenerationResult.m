...
{
  v5 = NSString;
  v6 = objc_msgSend_mentions(self, a2, v2, v3, v4);
  v10 = objc_msgSend_stringWithFormat_(v5, v7, @"<GDMentionGenerationResult: %@>", v8, v9, v6);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)objc_msgSend_initWithMentions_(v9, v10, (uint64_t)mentions, v11, v12);
}
...
- (GDMentionGenerationResult)initWithCoder:(id)a3
{
  ...
  uint64_t v12 = NSStringFromSelector(sel_mentions);
  v15 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v13, (uint64_t)v11, (uint64_t)v12, v14);

  if (v15)
  {
    self = (GDMentionGenerationResult *)(id)objc_msgSend_initWithMentions_(self, v16, (uint64_t)v15, v18, v19);
    v20 = self;
  }
  else
  {
    ...
    if (!v21)
    {
      ...
      v32[0] = @"GDMentionGenerationResult mentions is nil";
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v5, (uint64_t)mentions, (uint64_t)v7, v6);
}
...
- (GDMentionGenerationResult)initWithMentions:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)GDMentionGenerationResult;
  uint64_t v9 = [(GDMentionGenerationResult *)&v13 init];
  if (v9)
  {
    uint64_t v10 = objc_msgSend_copy(v4, v5, v6, v7, v8);
    mentions = v9->_mentions;
    v9->_mentions = (NSArray *)v10;
  }
  return v9;
}
