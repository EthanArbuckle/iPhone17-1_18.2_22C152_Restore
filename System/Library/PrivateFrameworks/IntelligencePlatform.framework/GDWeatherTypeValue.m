...
- (id)description
{
  ...
  if (type > 7) {
    ...
    v4 = off_1E60138F0[type];
  }
  id v5 = [NSString alloc];
  v9 = objc_msgSend_initWithFormat_(v5, v6, @"GDWeatherTypeValue<type: %@, typeValue: %lf>", v7, v8, v4, *(void *)&self->_typeValue);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = objc_msgSend_allocWithZone_(GDWeatherTypeValue, a2, (uint64_t)a3, v3, v4);
...
- (GDWeatherTypeValue)initWithCoder:(id)a3
{
  ...
  return (GDWeatherTypeValue *)MEMORY[0x1F4181798](self, sel_initWithType_typeValue_, v14, v24, v25);
}
