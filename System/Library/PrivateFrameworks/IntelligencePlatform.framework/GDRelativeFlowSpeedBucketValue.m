...
- (id)description
{
  ...
  if (bucket > 6) {
    ...
    v4 = off_1E6013848[bucket];
  }
  id v5 = [NSString alloc];
  v9 = objc_msgSend_initWithFormat_(v5, v6, @"GDRelativeFlowSpeedBucketValue<bucket: %@, bucketValue: %lf>", v7, v8, v4, *(void *)&self->_bucketValue);
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v6 = objc_msgSend_allocWithZone_(GDRelativeFlowSpeedBucketValue, a2, (uint64_t)a3, v3, v4);
...
- (GDRelativeFlowSpeedBucketValue)initWithCoder:(id)a3
{
  ...
  return (GDRelativeFlowSpeedBucketValue *)MEMORY[0x1F4181798](self, sel_initWithBucket_bucketValue_, v14, v24, v25);
}
