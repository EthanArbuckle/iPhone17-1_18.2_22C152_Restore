...
- (TAPersistenceManagerSettings)init
{
  return [(TAPersistenceManagerSettings *)self initWithDirectoryURLOrDefault:0 storeFileNameOrDefault:0];
}
...
- (TAPersistenceManagerSettings)initWithDirectoryURLOrDefault:(id)a3 storeFileNameOrDefault:(id)a4
{
  ...
  v7 = (__CFString *)a4;
  v13.receiver = self;
  v13.super_class = (Class)TAPersistenceManagerSettings;
  ...
  if (v8)
  {
    ...
    {
      v9 = [NSURL fileURLWithPath:@"/var/root/Library/Caches/locationd/TrackingAvoidance/" isDirectory:1];
    }
...
- (id)_getStoreURL
{
  return (id)[NSURL fileURLWithPath:self->_persistenceStoreFileName relativeToURL:self->_persistenceDirectoryURL];
}
