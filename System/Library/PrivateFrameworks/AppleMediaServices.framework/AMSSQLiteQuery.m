...
- (id)initOnConnection:(id)a3 descriptor:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)AMSSQLiteQuery;
  ...
  if (v9)
  {
    ...
    v10->_descriptor = (AMSSQLiteQueryDescriptor *)v11;
  }
  return v10;
}
...
- (void)applyBinding:(id)a3 atIndex:(int *)a4
{
  ...
  int64_t v7 = [(AMSSQLiteQueryDescriptor *)self->_descriptor limitCount];
  if (v7) {
...
{
  v2 = *(void **)(a1 + 32);
  id v3 = [MEMORY[0x1E4F28ED0] numberWithLongLong:a2];
  [v2 addObject:v3];
}
...
- (id)copySelectSQLWithProperties:(id)a3
{
  ...
  id v13 = [(AMSSQLiteQueryDescriptor *)self->_descriptor _newSelectSQLWithProperties:v7 columns:v5];
  return v13;
}
...
uint64_t __33__AMSSQLiteQuery_countOfEntities__block_invoke(uint64_t result)
{
  return result;
}
...
- (BOOL)createTemporaryTableWithName:(id)a3 properties:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = (void *)[objc_alloc(MEMORY[0x1E4F28E78]) initWithString:@"CREATE TEMPORARY TABLE "];
  v22 = v6;
  [v8 appendString:v6];
  [v8 appendString:@" AS "];
  uint64_t v9 = (void *)[(AMSSQLiteQueryDescriptor *)self->_descriptor copy];
  [v9 setOrderingDirections:0];
  [v9 setOrderingProperties:0];
  id v10 = objc_alloc_init(MEMORY[0x1E4F1CA48]);
  uint64_t v11 = [(AMSSQLiteQueryDescriptor *)self->_descriptor entityClass];
  long long v25 = 0u;
  long long v26 = 0u;
  long long v27 = 0u;
  long long v28 = 0u;
...
void __35__AMSSQLiteQuery_deleteAllEntities__block_invoke_2(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
...
- (void)enumerateMemoryEntitiesUsingBlock:(id)a3
{
  ...
  id v5 = a3;
  id v6 = [(AMSSQLiteQueryDescriptor *)descriptor memoryEntityClass];
  if (!v6) {
...
- (void)enumerateMemoryEntitiesWithProperties:(id)a3 usingBlock:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(AMSSQLiteQueryDescriptor *)self->_descriptor memoryEntityClass];
  if (!v8) {
...
uint64_t __51__AMSSQLiteQuery_enumeratePersistentIDsUsingBlock___block_invoke(uint64_t a1)
{
...
- (void)enumeratePersistentIDsAndProperties:(id)a3 usingBlock:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = [(AMSSQLiteQuery *)self _newSelectSQLWithProperties:v6];
  connection = self->_connection;
  v12[0] = MEMORY[0x1E4F143A8];
  v12[1] = 3221225472;
...
void __65__AMSSQLiteQuery_enumeratePersistentIDsAndProperties_usingBlock___block_invoke_2(void *a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  uint64_t v7 = (void *)MEMORY[0x192FA47D0]();
  id v8 = [MEMORY[0x1E4F1CA60] dictionaryWithCapacity:a1[7]];
  id v9 = v8;
  if (v5)
  {
    id v10 = (void *)a1[4];
    ...
    long long v17 = __65__AMSSQLiteQuery_enumeratePersistentIDsAndProperties_usingBlock___block_invoke_3;
    long long v18 = &unk_1E55A6720;
    id v11 = v8;
    id v19 = v11;
    id v12 = v5;
    id v20 = v12;
...
void __65__AMSSQLiteQuery_enumeratePersistentIDsAndProperties_usingBlock___block_invoke_3(uint64_t a1, void *a2, int a3)
{
  ...
  uint64_t v5 = (a3 + 1);
  id v6 = a2;
  AMSSQLiteCopyFoundationValue(v4, v5);
...
- (AMSSQLiteQueryDescriptor)queryDescriptor
{
  uint64_t v2 = (void *)[(AMSSQLiteQueryDescriptor *)self->_descriptor copy];
  return (AMSSQLiteQueryDescriptor *)v2;
}
...
- (id)_newSelectSQLWithProperties:(id)a3
{
  ...
  id v4 = a3;
  id v5 = objc_alloc_init(MEMORY[0x1E4F1CA48]);
  id v6 = [(AMSSQLiteQueryDescriptor *)self->_descriptor entityClass];
  id v7 = [(objc_class *)v6 disambiguatedSQLForProperty:0x1EDCC1FC8];
  [v5 addObject:v7];
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v13 = -[objc_class disambiguatedSQLForProperty:](v6, "disambiguatedSQLForProperty:", *(void *)(*((void *)&v16 + 1) + 8 * v12), (void)v16);
        [v5 addObject:v13];
  ...
  id v14 = [(AMSSQLiteQueryDescriptor *)self->_descriptor _newSelectSQLWithProperties:v8 columns:v5];
  return v14;
}
