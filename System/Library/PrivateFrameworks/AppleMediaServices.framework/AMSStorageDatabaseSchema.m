...
+ (BOOL)createOrUpdateSchemaUsingConnection:(id)a3
{
  ...
  while (1)
  {
    ...
    if (!v6)
    {
      ...
      v15[1] = 3221225472;
      v15[2] = __64__AMSStorageDatabaseSchema_createOrUpdateSchemaUsingConnection___block_invoke;
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v17 = v11;
        _os_log_impl(&dword_18D554000, v10, OS_LOG_TYPE_ERROR, "%{public}@: Failed to update AMSStorage database scheme. User version did not change", buf, 0xCu);
      }
      BOOL v12 = 1;
      goto LABEL_18;
    }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v17 = v13;
    _os_log_impl(&dword_18D554000, v10, OS_LOG_TYPE_ERROR, "%{public}@: Failed to update AMSStorage database scheme. Success = NO", buf, 0xCu);
  }
  BOOL v12 = 0;
LABEL_18:
...
+ (void)migrateVersion0to1WithMigration:(id)a3
{
  ...
  [v3 executeStatement:@"CREATE TABLE IF NOT EXISTS data (domain TEXT, key TEXT, valueType INT, value BLOB, lastModified REAL, PRIMARY KEY (key, domain));"];
}
