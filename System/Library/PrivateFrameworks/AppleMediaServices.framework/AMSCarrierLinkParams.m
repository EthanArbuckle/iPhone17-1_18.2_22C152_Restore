...
- (AMSCarrierLinkParams)initWithString:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)AMSCarrierLinkParams;
...
{
  id v4 = a3;
  id v5 = [(AMSCarrierLinkParams *)self dictionary];
  [v4 encodeObject:v5 forKey:@"dictionary"];

  id v6 = [(AMSCarrierLinkParams *)self linkParamsString];
...
- (AMSCarrierLinkParams)initWithCoder:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)AMSCarrierLinkParams;
  id v5 = [(AMSCarrierLinkParams *)&v12 init];
  if (v5)
  {
