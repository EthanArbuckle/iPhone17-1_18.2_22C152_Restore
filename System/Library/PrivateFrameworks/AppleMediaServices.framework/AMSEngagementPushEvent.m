...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v6 = [(AMSEngagementPushEvent *)self data];
  [v4 encodeObject:v6 forKey:@"kCodingKeyData"];

  id v7 = [(AMSEngagementPushEvent *)self request];
...
- (AMSEngagementPushEvent)initWithCoder:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)AMSEngagementPushEvent;
  ...
  if (v5)
  {
    ...
    uint64_t v9 = objc_msgSend(MEMORY[0x1E4F1CAD0], "ams_PLISTClasses");
