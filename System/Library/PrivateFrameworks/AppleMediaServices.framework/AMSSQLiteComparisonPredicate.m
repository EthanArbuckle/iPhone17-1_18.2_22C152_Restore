...
+ (id)predicateWithProperty:(id)a3 value:(id)a4 comparisonType:(int64_t)a5
{
  ...
  if ([v7 conformsToProtocol:&unk_1EDD035C0]) {
    id v12 = (id)[v7 copy];
  }
  else {
    id v12 = v7;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(AMSSQLitePropertyPredicate *)&v12 isEqual:v4]
    && (int64_t v5 = [(AMSSQLiteComparisonPredicate *)self comparisonType],
        v5 == [v4 comparisonType]))
  {
    unint64_t v6 = [(AMSSQLiteComparisonPredicate *)self value];
    id v7 = [v4 value];
    if (v6 == v7)
    {
      char v10 = 1;
    ...
    {
      id v8 = [(AMSSQLiteComparisonPredicate *)self value];
      v9 = [v4 value];
...
- (id)SQLForEntityClass:(Class)a3
{
  int64_t v5 = [(AMSSQLitePropertyPredicate *)self property];
  unint64_t v6 = [(objc_class *)a3 disambiguatedSQLForProperty:v5];

  id v7 = NSString;
  id v8 = [(AMSSQLiteComparisonPredicate *)self _comparisonTypeString];
...
- (id)_comparisonTypeString
{
  int64_t v2 = [(AMSSQLiteComparisonPredicate *)self comparisonType];
  if ((unint64_t)(v2 - 1) > 6) {
    return 0;
  }
  else {
    return off_1E55A6840[v2 - 1];
  }
}
