...
- (CerKRQOmMu7LBUoc)initWithContext:(id)a3
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1000BE658;
  block[3] = &unk_100117340;
  v5 = [(CerKRQOmMu7LBUoc *)&v17 init];
  v16 = v5;
  if (qword_1001370C0 != -1) {
    dispatch_once(&qword_1001370C0, block);
  }
  context = v5->_context;
  v5->_context = v4;
  v7 = v4;
...
- (id)VkBISyFszEu5z9lr:(id)a3 error:(id *)a4
{
  uint64_t v12 = 0;
  id v5 = a3;
  sub_1000C04CC((uint64_t)[v5 bytes], (uint64_t)objc_msgSend(v5, "length"), (uint64_t)&v12);
  if (v6)
  {
    int v7 = v6;
...
- (void)triggerCoreODI
{
  id v3 = objc_alloc_init(off_100130250());
