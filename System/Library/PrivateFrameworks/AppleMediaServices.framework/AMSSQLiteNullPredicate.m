...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(AMSSQLitePropertyPredicate *)&v8 isEqual:v4])
  {
    BOOL v5 = [(AMSSQLiteNullPredicate *)self matchesNull];
...
- (id)SQLForEntityClass:(Class)a3
{
  BOOL v5 = [(AMSSQLitePropertyPredicate *)self property];
  int v6 = [(objc_class *)a3 disambiguatedSQLForProperty:v5];

  v7 = NSString;
  BOOL v8 = [(AMSSQLiteNullPredicate *)self matchesNull];
  v9 = @"IS NOT NULL";
  if (v8) {
    v9 = @"IS NULL";
  }
