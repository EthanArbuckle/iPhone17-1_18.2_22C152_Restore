...
- (AMSSQLiteStatement)initWithStatement:(sqlite3_stmt *)a3 onConnection:(id)a4;
- (BOOL)isReadOnly;
...
@implementation AMSSQLiteStatement
...
- (NSDictionary)columnIndexByName
{
  ...
  if (statement)
  {
    ...
    if (v4 >= 1)
    {
      ...
      do
      {
        v7 = (void *)[objc_alloc(MEMORY[0x1E4F28ED0]) initWithInt:v6];
        v8 = objc_msgSend([NSString alloc], "initWithUTF8String:", sqlite3_column_name(self->_statement, v6));
  ...
  {
    [MEMORY[0x1E4F1CA00] raise:*MEMORY[0x1E4F1C3B8] format:@"[AMSSQLiteStatement] Statement already finalized"];
    v5 = 0;
  }
...
{
  if (a3) {
    [(AMSSQLiteStatement *)self bindString:a3 atPosition:*(void *)&a4];
  }
  else {
    [(AMSSQLiteStatement *)self bindNullAtPosition:*(void *)&a4];
  }
}
...
- (AMSSQLiteStatement)initWithStatement:(sqlite3_stmt *)a3 onConnection:(id)a4
{
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)AMSSQLiteStatement;
  v8 = [(AMSSQLiteStatement *)&v11 init];
  v9 = v8;
  if (v8)
  {
...
- (void)bindDouble:(double)a3 atPosition:(int)a4
{
  ...
  if (statement) {
    ...
    objc_msgSend(MEMORY[0x1E4F1CA00], "raise:format:", *MEMORY[0x1E4F1C3B8], @"[AMSSQLiteStatement] Statement already finalized", a3);
  }
}
...
{
  uint64_t v4 = *(void *)&a4;
  id v6 = [MEMORY[0x1E4F28D90] dataWithJSONObject:a3 options:0 error:0];
  [(AMSSQLiteStatement *)self bindData:v6 atPosition:v4];
}
...
- (void)bindDate:(id)a3 atPosition:(int)a4
{
  ...
  -[AMSSQLiteStatement bindDouble:atPosition:](self, "bindDouble:atPosition:", v4);
}
...
- (void)bindStringCopy:(id)a3 atPosition:(int)a4
{
  ...
  if (statement)
  {
    CFNumberRef v6 = (const char *)[a3 UTF8String];
  ...
  else
  {
    ...
    [v7 raise:v8 format:@"[AMSSQLiteStatement] Statement already finalized"];
  }
}
...
- (void)bindURL:(id)a3 atPosition:(int)a4
{
  ...
  [(AMSSQLiteStatement *)self bindString:v6 atPosition:v4];
}
