...
- (NSLocale)locale;
- (_TtC9WeatherUI13WindFormatter)init;
- (_TtC9WeatherUI13WindFormatter)initWithCoder:(id)a3;
...
- (NSLocale)locale
{
  ...
  v6 = self;
  WindFormatter.locale.getter((uint64_t)v5);
...
- (void)setLocale:(id)a3
{
  ...
  uint64_t v10 = self;
  WindFormatter.locale.setter((uint64_t)v7);
}

- (_TtC9WeatherUI13WindFormatter)init
{
  return (_TtC9WeatherUI13WindFormatter *)WindFormatter.init()();
}
