...
- (NSLocale)locale;
- (_TtC9WeatherUI19VisibilityFormatter)init;
- (_TtC9WeatherUI19VisibilityFormatter)initWithCoder:(id)a3;
...
- (NSLocale)locale
{
  ...
  v6 = self;
  VisibilityFormatter.locale.getter((uint64_t)v5);
...
- (void)setLocale:(id)a3
{
  ...
  uint64_t v10 = self;
  VisibilityFormatter.locale.setter((uint64_t)v7);
}

- (_TtC9WeatherUI19VisibilityFormatter)init
{
  return (_TtC9WeatherUI19VisibilityFormatter *)VisibilityFormatter.init()();
}
