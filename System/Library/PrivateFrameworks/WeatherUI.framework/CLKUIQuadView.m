...
- (BOOL)renderSynchronouslyWithImageQueueDiscard:(BOOL)a3 inGroup:(id)a4 completion:(id)a5
{
  ...
  if ([(NSCountedSet *)self->_disabledRenderingReasons count])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&buf[14] = disabledRenderingReasons;
      _os_log_impl(&dword_1B41E7000, v10, OS_LOG_TYPE_DEFAULT, "CLKUIQuadView (%@): Rendering disabled for reasons: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    *(void *)&buf[16] = 0x2020000000;
    ...
    {
      BOOL v13 = [(CLKUIQuadView *)self _sync_prepareAndRenderForTime:v8 inGroup:!v6 checkForDrawable:v9 completion:v14];
...
{
  uint64_t result = objc_msgSend(*(id *)(a1 + 32), "_sync_prepareAndRenderForTime:inGroup:checkForDrawable:completion:", *(void *)(a1 + 40), *(unsigned char *)(a1 + 72) == 0, *(void *)(a1 + 48), *(double *)(a1 + 64));
...
{
  objc_msgSend(*(id *)(a1 + 32), "_sync_prepareAndRenderForTime:inGroup:checkForDrawable:completion:", *(void *)(a1 + 40), *(unsigned __int8 *)(a1 + 64), *(void *)(a1 + 48), *(double *)(a1 + 56));
...
- (BOOL)_sync_prepareAndRenderForTime:(double)a3 inGroup:(id)a4 checkForDrawable:(BOOL)a5 completion:(id)a6
{
  ...
  BOOL v13 = v10;
  id v14 = v11;
  BOOL v15 = [(CLKUIQuadView *)self _displayAndCheckForDrawable:v7 withCompletion:v17];
  ++self->_frameNum;
