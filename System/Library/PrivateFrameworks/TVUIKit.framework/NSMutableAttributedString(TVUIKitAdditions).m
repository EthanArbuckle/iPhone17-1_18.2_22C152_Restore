...
- (void)tv_addLanguageAwareness:()TVUIKitAdditions
{
  ...
  if (v6)
  {
    ...
    *(_OWORD *)buffer = 0u;
    ...
    v50 = v5;
    uint64_t v15 = -1;
    uint64_t v51 = *MEMORY[0x263F81540];
    uint64_t v52 = *MEMORY[0x263F81608];
...
LABEL_12:
        ...
        {
          int v28 = MEMORY[0x2455C19B0](CharacterAtIndex);
          int v29 = 0;
          BOOL v30 = 0;
          int v18 = 0;
          uint64_t v21 = 1;
...
LABEL_94:
    ...
    if (v11 && (double)v11 / (double)(v11 + v12) >= 0.4)
    {
      if (defaultParagraphStyle_sOnceForRightToLeft != -1) {
        dispatch_once(&defaultParagraphStyle_sOnceForRightToLeft, &__block_literal_global_16);
      }
      uint64_t v39 = 1;
    ...
    else
    {
      ...
      if (defaultParagraphStyle_sOnceForNatural != -1) {
        dispatch_once(&defaultParagraphStyle_sOnceForNatural, &__block_literal_global_14);
      }
      uint64_t v39 = -1;
