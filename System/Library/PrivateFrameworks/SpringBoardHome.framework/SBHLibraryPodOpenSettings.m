...
- (void)setDefaultValues
{
  ...
  v4 = [(id)objc_opt_class() _defaultCentralAnimationSettings];
  [v3 applySettings:v4];
  ...
  v6 = [(id)objc_opt_class() _defaultCrossfadeSettings];
  [v5 applySettings:v6];
  ...
  v12 = [(id)objc_opt_class() _defaultInnerFolderZoomAnimationSettings];
  ...
  v15 = [(id)objc_opt_class() _defaultInnerFolderZoomAnimationSettings];
  [v14 applySettings:v15];

  [(id)objc_opt_class() _defaultInnerFolderZoomDelay];
  double v17 = v16;
