...
- (AXElementVision__generated__)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  uint64_t v8 = [(AXElementVision__generated__ *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(AXElementVision__generated__ *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  id v6 = [AXElementVision__generated__Output alloc];
  id v7 = [v5 featureValueForName:@"confidence"];
  id v8 = [v7 multiArrayValue];
  id v9 = [v5 featureValueForName:@"coordinates"];
  v10 = [v9 multiArrayValue];
  uint64_t v11 = [(AXElementVision__generated__Output *)v6 initWithConfidence:v8 coordinates:v10];
...
- (id)predictionFromImage:(__CVBuffer *)a3 iouThreshold:(double)a4 confidenceThreshold:(double)a5 error:(id *)a6
{
  id v8 = [[AXElementVision__generated__Input alloc] initWithImage:a3 iouThreshold:a4 confidenceThreshold:a5];
  id v9 = [(AXElementVision__generated__ *)self predictionFromFeatures:v8 error:a6];
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if ([v9 count] >= 1)
  {
    ...
    do
    {
      ...
      objc_super v15 = [v14 multiArrayValue];
