...
- (CGRect)resultBox
{
  double v2 = sub_1B588F39C((uint64_t)self, (uint64_t)a2, &OBJC_IVAR____TtC16AXMediaUtilities24AXMElementDetectorResult_box);
...
- (_TtC16AXMediaUtilities24AXMElementDetectorResult)init
{
  CGRect result = (_TtC16AXMediaUtilities24AXMElementDetectorResult *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
