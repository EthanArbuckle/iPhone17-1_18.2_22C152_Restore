...
- (UARPSupportedAccessoryA2049DFUSimulated)init
{
  ...
  if (v2)
  {
    ...
    v6 = [[UARPAccessoryHardwareUSB alloc] initWithVendorID:+[UARPSupportedAccessoryA2049Simulated vendorID](UARPSupportedAccessoryA2049Simulated, "vendorID") productID:+[UARPSupportedAccessoryA2049DFUSimulated productID]];
    hwID = v2->hwID;
    v2->hwID = v6;
...
+ (unsigned)productID
{
  return +[UARPSupportedAccessoryA2049DFU productID];
}
