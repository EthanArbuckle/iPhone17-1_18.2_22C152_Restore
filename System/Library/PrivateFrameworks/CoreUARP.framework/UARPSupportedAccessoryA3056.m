...
- (UARPSupportedAccessoryA3056)init
{
  ...
  if (v2)
  {
    v3 = +[UARPSupportedAccessoryA3056 appleModelNumber];
    ...
    long long v12 = 0u;
    long long v13 = 0u;
    v4 = +[UARPSupportedAccessoryA3056 alternativeAppleModelNumbers];
    ...
    v9 = [[UARPAccessoryHardwareBluetooth alloc] initWithVendorIDSource:1 vendorID:+[UARPSupportedAccessoryAirPodsBud vendorID](UARPSupportedAccessoryAirPodsBud, "vendorID") productID:+[UARPSupportedAccessoryA3056 productID] productVersion:1];
    hwID = v2->hwID;
    v2->hwID = v9;
...
+ (id)alternativeAppleModelNumbers
{
  return (id)objc_msgSend(MEMORY[0x263EFFA08], "setWithObjects:", @"A3055", 0);
}
