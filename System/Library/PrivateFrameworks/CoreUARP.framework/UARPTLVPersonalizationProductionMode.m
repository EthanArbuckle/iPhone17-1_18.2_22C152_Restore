@interface UARPTLVPersonalizationProductionMode
+ (id)metaDataTableEntry;
+ (id)tlvFromPropertyListValue:(id)a3;
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4;
+ (unsigned)tlvType;
- (UARPTLVPersonalizationProductionMode)init;
- (id)description;
- (id)generateTLV;
- (id)tlvValue;
...
@implementation UARPTLVPersonalizationProductionMode

- (UARPTLVPersonalizationProductionMode)init
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationProductionMode;
...
- (id)description
{
  objc_super v3 = +[UARPTLVPersonalizationProductionMode metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationProductionMode tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationProductionMode;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationProductionMode;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  uint64_t v2 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationProductionMode tlvType](UARPTLVPersonalizationProductionMode, "tlvType"));
  v6[1] = v2;
