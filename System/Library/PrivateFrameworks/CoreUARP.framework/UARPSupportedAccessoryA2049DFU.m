...
- (UARPSupportedAccessoryA2049DFU)init
{
  ...
  if (v2)
  {
    v3 = +[UARPSupportedAccessoryA2049DFU appleModelNumber];
    [(UARPSupportedAccessory *)v2 setAppleModelNumber:v3];

    v4 = +[UARPSupportedAccessoryA2049DFU modelName];
    ...
    v6 = [[UARPAccessoryHardwareUSB alloc] initWithVendorID:+[UARPSupportedAccessoryUSB vendorID](UARPSupportedAccessoryUSB, "vendorID") productID:+[UARPSupportedAccessoryA2049DFU productID]];
    hwID = v2->hwID;
    v2->hwID = v6;
