...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationChipRevision;
...
- (id)description
{
  objc_super v3 = +[UARPTLVPersonalizationChipRevision metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationChipRevision tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationChipRevision;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationChipRevision;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  uint64_t v2 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationChipRevision tlvType](UARPTLVPersonalizationChipRevision, "tlvType"));
  v6[1] = v2;
