...
- (id)description
{
  objc_super v3 = +[UARPTLVPersonalizationPayloadTag metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  ...
  int v8 = uarpHtonl(+[UARPTLVPersonalizationPayloadTag tlvType]);
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationPayloadTag tlvType](UARPTLVPersonalizationPayloadTag, "tlvType"));
  v6[1] = v2;
