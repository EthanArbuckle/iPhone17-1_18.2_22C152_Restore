...
- (id)description
{
  objc_super v3 = +[UARPTLVPersonalizedManifest metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizedManifest tlvType];
  manifest = self->_manifest;
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizedManifest;
  uint64_t v5 = [(UARPMetaDataTLVData *)&v7 generateTLV:v3 tlvValue:manifest];
  return v5;
}
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizedManifest tlvType](UARPTLVPersonalizedManifest, "tlvType"));
  v6[1] = v2;
