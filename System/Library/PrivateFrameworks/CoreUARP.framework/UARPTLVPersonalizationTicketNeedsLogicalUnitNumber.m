...
- (id)description
{
  objc_super v3 = +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumber metaDataTableEntry];
  v4 = NSString;
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumber tlvType];
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationTicketNeedsLogicalUnitNumber;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationTicketNeedsLogicalUnitNumber;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  uint64_t v2 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationTicketNeedsLogicalUnitNumber tlvType](UARPTLVPersonalizationTicketNeedsLogicalUnitNumber, "tlvType"));
  v6[1] = v2;
