...
- (PVAppIdentityDigest)initWithError:(id)a3 version:(id)a4
{
  ...
  if (v8)
  {
    uint64_t v9 = objc_msgSend(MEMORY[0x263F087E8], "pvai_wrappedError:error:", -10000, v6);
...
+ (id)digestWithErrorCode:(int64_t)a3
{
  ...
  v5 = objc_msgSend(MEMORY[0x263F087E8], "pvai_errorWithCode:", a3);
  id v6 = [(PVAppIdentityDigest *)v4 initWithError:v5 version:&unk_27087BB40];
...
- (id)asDictionary
{
  ...
  if (error)
  {
    uint64_t v4 = [(NSError *)error code];
    version = self->version;
    v17[0] = @"version";
    v17[1] = @"error";
    v18[0] = version;
