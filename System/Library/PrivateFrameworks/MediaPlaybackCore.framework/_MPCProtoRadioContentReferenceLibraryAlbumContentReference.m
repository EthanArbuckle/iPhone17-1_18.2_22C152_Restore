...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)albumName | *((void *)v4 + 3))
  {
...
- (BOOL)readFrom:(id)a3
{
  return _MPCProtoRadioContentReferenceLibraryAlbumContentReferenceReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)_MPCProtoRadioContentReferenceLibraryAlbumContentReference;
  id v4 = [(_MPCProtoRadioContentReferenceLibraryAlbumContentReference *)&v8 description];
  uint64_t v5 = [(_MPCProtoRadioContentReferenceLibraryAlbumContentReference *)self dictionaryRepresentation];
