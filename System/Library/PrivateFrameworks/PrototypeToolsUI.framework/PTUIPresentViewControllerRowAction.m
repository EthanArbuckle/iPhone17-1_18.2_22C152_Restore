@interface PTUIPresentViewControllerRowAction
...
@implementation PTUIPresentViewControllerRowAction
...
- (id)defaultHandler
{
  ...
  v4[1] = 3221225472;
  v4[2] = __52__PTUIPresentViewControllerRowAction_defaultHandler__block_invoke;
  v4[3] = &unk_26425ED70;
  v4[4] = self;
...
uint64_t __52__PTUIPresentViewControllerRowAction_defaultHandler__block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
