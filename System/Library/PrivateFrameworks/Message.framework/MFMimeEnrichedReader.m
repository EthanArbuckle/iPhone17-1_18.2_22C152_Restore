...
- (void)mismatchError:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    int v5 = 138412290;
    id v6 = a3;
    _os_log_impl(&dword_1A7EFF000, v4, OS_LOG_TYPE_INFO, "Ignoring unmatched </%@> command", (uint8_t *)&v5, 0xCu);
  }
}
...
- (void)nowWouldBeAGoodTimeToAppendToTheAttributedString
{
  if (*((unsigned char *)self + 212))
  {
    ...
    [(NSMutableString *)outputBuffer setString:&stru_1EFF11268];
    return;
  }
...
LABEL_27:
  ...
  *(_OWORD *)buffer = v21;
  long long v42 = v21;
  v22 = self->_outputBuffer;
  v49 = v22;
  uint64_t v52 = 0;
  int64_t v53 = v20;
  CharactersPtr = CFStringGetCharactersPtr((CFStringRef)v22);
  CStringPtr = 0;
  v50 = CharactersPtr;
  if (!CharactersPtr) {
    CStringPtr = CFStringGetCStringPtr((CFStringRef)v22, 0x600u);
  }
  v51 = CStringPtr;
  int64_t v54 = 0;
  int64_t v55 = 0;
  if (v20)
  {
    ...
    do
    {
      ...
      UniChar chars = -21846;
      if (v27 < 0 || (uint64_t v30 = v53, v53 <= v27))
      {
        UniChar chars = 0;
      }
      else
      {
        if (v50)
        {
          UniChar v31 = v50[v27 + v52];
        }
        else if (v51)
        {
          UniChar v31 = v51[v52 + v27];
        }
        else
        {
          if (v55 <= v27 || (int64_t v32 = v54, v54 > v27))
          {
            uint64_t v33 = -v29;
            uint64_t v34 = v29 + v25;
            ...
            v57.length = v30 + v34;
            v57.location = v36 + v52;
            CFStringGetCharacters((CFStringRef)v49, v57, buffer);
            int64_t v32 = v54;
          }
          UniChar v31 = buffer[v27 - v32];
        }
        UniChar chars = v31;
        if (v31 > 0x25u)
        {
...
LABEL_82:
  ...
  CFStringReplaceAll(self->_prependHTML, &stru_1EFF11268);
  CFStringReplaceAll(self->_postpendHTML, &stru_1EFF11268);
  CFStringReplaceAll((CFMutableStringRef)self->_outputBuffer, &stru_1EFF11268);
}
...
- (void)beginCommand:(id)a3
{
  ...
  {
    v5 += 2;
    if (v5 >= &__block_descriptor_40_ea8_32s_e24_v16__0__NSNotification_8ls32l8) {
      return;
    }
  }
          ...
          if (v10 < inputLength)
          {
            ...
            while (1)
            {
              ...
              if ((v10 & 0x8000000000000000) == 0)
              {
                ...
                if (v30 > v10)
                {
                  UniChar v31 = self->_inputBuffer.directUniCharBuffer;
                  if (v31)
                  {
...
- (void)convertRichTextString:(id)a3 intoOutputString:(id)a4
{
  ...
  while (1)
  {
    int64_t v7 = [(MFMimeEnrichedReader *)self readTokenInto:&v8];
    if (v7 == 3)
    {
...
- (void)convertEnrichedString:(id)a3 intoOutputString:(id)a4
{
  ...
  while (1)
  {
    int64_t v9 = [(MFMimeEnrichedReader *)self readTokenInto:&v14];
    if (v9 == 3)
    {
...
LABEL_12:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134218496;
    ...
    __int16 v19 = 2048;
    uint64_t v20 = v13;
    _os_log_impl(&dword_1A7EFF000, v10, OS_LOG_TYPE_INFO, "elapsed time %gs (input length=%ld, output length=%lu)", buf, 0x20u);
  }
}
...
{
  __assert_rtn("-[MFMimeEnrichedReader setupFontStackEntry:]", "MimeEnrichedReader.m", 500, "NULL != stackEntry");
}
