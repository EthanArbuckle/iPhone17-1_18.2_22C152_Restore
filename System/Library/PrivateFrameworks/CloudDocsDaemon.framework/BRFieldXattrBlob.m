...
+ (id)loadXattrsFromFD:(int)a3 withMaximumSize:(unint64_t)a4 error:(id *)a5
{
  v8 = [[BRCLazyXattrsCollection alloc] initWithFD:*(void *)&a3 sizeLimit:a4 syncable:1 error:a5];
  v9 = v8;
...
+ (BOOL)loadXattrsFromFD:(int)a3 structuralBlob:(id *)a4 contentBlob:(id *)a5 localBlob:(id *)a6 withMaximumSize:(unint64_t)a7 error:(id *)a8
{
  ...
  id v17 = objc_alloc_init(MEMORY[0x1E4F94098]);
  v18 = v15;
...
{
  BOOL v5 = a4;
  v7 = [[BRCLazyXattrsCollection alloc] initWithFD:*(void *)&a3 sizeLimit:-1 syncable:1 error:a5];
  v8 = v7;
  if (v7)
  {
    v9 = v7;
    ...
    if (v5)
    {
      v11 = [(BRCLazyXattrsCollection *)v9 xattrNamesBegin];
      unsigned int v12 = [(BRCLazyXattrsCollection *)v10 xattrNamesCount];
    }
    else
    {
      v11 = [(BRCLazyXattrsCollection *)v9 structuralXattrNamesBegin];
      ...
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 136315650;
          ...
          __int16 v34 = 2112;
          v35 = v15;
          _os_log_debug_impl(&dword_1D353B000, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] added xattr %s (%lld bytes)%@", buf, 0x20u);
        }
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_xattrs, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
