...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync/sharedb", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v17;
            ...
            __int16 v26 = 2112;
            v27 = v14;
            _os_log_debug_impl(&dword_1D353B000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] inserted new ownerKey %@ for %@%@", buf, 0x20u);
          }
        }
        ++v9;
      }
...
- (void)_performAfterRegisteringForPushes:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = (void *)[objc_alloc(MEMORY[0x1E4F19F50]) initWithSubscriptionID:@"sharedZoneSubscription"];
  id v6 = objc_alloc_init(MEMORY[0x1E4F1A1E0]);
  [v6 setShouldSendContentAvailable:1];
  [v5 setNotificationInfo:v6];
  id v7 = objc_alloc(MEMORY[0x1E4F1A1B8]);
  v16[0] = v5;
...
void __68__BRCSharedDatabaseSyncOperation__performAfterRegisteringForPushes___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    __int16 v27 = 2112;
    v28 = v11;
    _os_log_debug_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Handling result of creating %@ (operationID=%@): %@%@", buf, 0x34u);
  }
...
- (void)_performFetchChangedZones
{
  ...
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F1A038]) initWithPreviousServerChangeToken:v3];
...
void __59__BRCSharedDatabaseSyncOperation__performFetchChangedZones__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v5;
    _os_log_debug_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ zone %@ changed%@", (uint8_t *)&v7, 0x20u);
  }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v29 = 2112;
      *(void *)v30 = v10;
      _os_log_error_impl(&dword_1D353B000, v11, (os_log_type_t)0x90u, "[ERROR] %@ failed: %@%@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)&v30[6] = v19;
      __int16 v31 = 2112;
      v32 = v12;
      _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ done: %u zones were changed and %u deleted%@", buf, 0x2Cu);
    }
      ...
      *(void *)&long long v6 = 138412290;
      ...
      do
      {
        ...
        do
        {
          ...
          id v10 = (void *)[objc_alloc(MEMORY[0x1E4F594E8]) initWithRecordZoneID:*(void *)(*((void *)&v26 + 1) + 8 * v9)];
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v32 = 2112;
            uint64_t v33 = v13;
            _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] scheduling sync for %@%@", buf, 0x16u);
          }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = v22;
              __int16 v31 = v17;
              _os_log_fault_impl(&dword_1D353B000, v18, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: there should be a container%@", buf, 0xCu);
            }
          }
          ++v9;
        }
...
- (void)main
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_debug_impl(&dword_1D353B000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Sync: fetching changed zones in the shared-database%@", (uint8_t *)&v4, 0x16u);
}
...
void __59__BRCSharedDatabaseSyncOperation__performFetchChangedZones__block_invoke_2_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v17 = 2112;
  uint64_t v18 = a2;
  _os_log_debug_impl(&dword_1D353B000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] updating shared-database from %@ with token:%@ caught-up:%s%@", (uint8_t *)&v11, 0x2Au);
}
