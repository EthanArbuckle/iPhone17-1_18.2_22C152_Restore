  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_INFO, "[INFO] Initializing restore manager with %@%@", buf, 0x16u);
    }
  }
      ...
      if (v13)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 138412290;
          v25 = v15;
          _os_log_impl(&dword_1D353B000, v16, OS_LOG_TYPE_INFO, "[INFO] Calling completion block with success.%@", buf, 0xCu);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v28 = 2112;
      v29 = v17;
      _os_log_error_impl(&dword_1D353B000, v18, (os_log_type_t)0x90u, "[ERROR] Unable to attach db %@: %@%@", buf, 0x20u);
    }
...
- (void)restoreWithCompletionBlock:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_error_impl(&dword_1D353B000, log, (os_log_type_t)0x90u, "[ERROR] Failed to update attached database %@%@", (uint8_t *)&v3, 0x16u);
}
