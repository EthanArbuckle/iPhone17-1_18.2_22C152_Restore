...
void __86__NSFileProviderManager_BRCAdditions__br_removeDomain_options_sync_completionHandler___block_invoke_6(void *a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v8;
      _os_log_error_impl(&dword_1D353B000, v9, (os_log_type_t)0x90u, "[ERROR] couldn't remove domain %@: %@%@", (uint8_t *)&v11, 0x20u);
    }
  }
  else
  {
...
{
  return [MEMORY[0x1E4F25DE0] importDomain:a1[4] forProviderIdentifier:a1[5] fromDirectoryAtURL:a1[6] error:a2];
}
...
{
  return [MEMORY[0x1E4F25DE0] importDomain:a1[4] forProviderIdentifier:a1[5] fromDirectoryAtURL:a1[6] knownFolders:a1[7] error:a2];
}
...
{
  return [MEMORY[0x1E4F25DE0] addDomain:*(void *)(a1 + 32) forProviderIdentifier:*(void *)(a1 + 40) error:a2];
}
...
void __90__NSFileProviderManager_BRCAdditions___br_removeDomain_options_retries_completionHandler___block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Failed to adopt persona for _br_removeDomain retry%@", (uint8_t *)&v2, 0xCu);
}
...
void __86__NSFileProviderManager_BRCAdditions__br_removeDomain_options_sync_completionHandler___block_invoke_6_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a2;
  OUTLINED_FUNCTION_1(&dword_1D353B000, a2, a3, "[DEBUG] Successfully removed domain %@%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}
