...
- (id)_logWrapUserReplyBlock:(id)a3
{
  ...
  id v10 = v3;
  id v11 = v7;
  v12 = (void *)MEMORY[0x1D94389C0](v14);
...
void __74__BRCUserNotification__displayDialogWithType_dict_options_userReplyBlock___block_invoke(uint64_t a1)
{
  ...
  *(void *)(v10 + 48) = v9;
  ...
  {
    v25 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v23);
  }
  ...
  if (v4)
  {
    ...
    *(void *)(*(void *)(a1 + 32) + 16) = CFUserNotificationCreateRunLoopSource(0, v3, (CFUserNotificationCallBack)_notificationCallback, 0);
    if (*(void *)(*(void *)(a1 + 32) + 16))
    {
      ...
      if (!v8) {
        CFStringRef v8 = (const __CFString *)CFRetain((CFTypeRef)*MEMORY[0x1E4F1D410]);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v13 = v6;
      _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] ignore user notification udate: no KVO observer registered%@", buf, 0xCu);
    }
  }
}
...
- (id)_localizationKey:(id)a3 forTypeOfShare:(id)a4
{
  ...
  else
  {
    ...
    else
    {
      ...
      else if ([v6 isEqualToString:*MEMORY[0x1E4F59640]])
      {
        uint64_t v9 = @"_FOLDER";
      }
      else
...
void __72__BRCUserNotification_showJoinDialogForShareMetadata_ckContainer_reply___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v9)
  {
    ...
    id v21 = (void *)*MEMORY[0x1E4F59640];
    if (!v17) {
      id v21 = (void *)v20;
    }
    id v22 = v21;
...
LABEL_16:
        ...
        id v28 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
        v41 = (void *)v20;
        v39 = (void *)v15;
        uint64_t v38 = *(void *)(*(void *)(*(void *)(a1 + 64) + 8) + 40);
        id v29 = _BRLocalizedStringWithFormat();

        uint64_t v30 = *MEMORY[0x1E4F1D9A8];
        v45[0] = *MEMORY[0x1E4F1D990];
        v45[1] = v30;
        id v31 = (void *)v24;
        v46[0] = v24;
        v46[1] = v29;
        v45[2] = *MEMORY[0x1E4F1D9D0];
        v32 = objc_msgSend(MEMORY[0x1E4F28B50], "bundleForClass:", objc_opt_class(), v15, v38);
        v33 = _BRLocalizedStringWithFormat();
        v46[2] = v33;
        v45[3] = *MEMORY[0x1E4F1D9E0];
        v34 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
        v35 = _BRLocalizedStringWithFormat();
        v46[3] = v35;
        v36 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v46 forKeys:v45 count:4];
...
- (void)showErrorTurnOniCloudDriveForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  id v31 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
  uint64_t v30 = _BRLocalizedStringWithFormat();
  v38[0] = v30;
  v37[1] = *MEMORY[0x1E4F1D9A8];
  ...
  v38[1] = v16;
  v37[2] = *MEMORY[0x1E4F1D9D0];
  objc_msgSend(MEMORY[0x1E4F28B50], "bundleForClass:", objc_opt_class(), v32);
  id v17 = v9;
  id v18 = v29 = v9;
  id v19 = _BRLocalizedStringWithFormat();
  v38[2] = v19;
  v37[3] = *MEMORY[0x1E4F1DA10];
  ...
  v38[3] = v22;
  v37[4] = *MEMORY[0x1E4F1D9E0];
  id v23 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
  uint64_t v24 = _BRLocalizedStringWithFormat();
  v38[4] = v24;
  id v25 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v38 forKeys:v37 count:5];
...
- (void)showErrorInstallNativeAppForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  {
    id v26 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", @"shareMetadata", v6);
...
- (void)showErrorNativeAppDisabledByProfileForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  v31[1] = v14;
  v30[2] = *MEMORY[0x1E4F1DA10];
  uint64_t v15 = [(BRCUserNotification *)self _localizationKey:@"PREVIEW_BUTTON" forTypeOfShare:v9];
  id v22 = self;
  dispatch_time_t v16 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
  uint64_t v17 = _BRLocalizedStringWithFormat();
  v31[2] = v17;
  v30[3] = *MEMORY[0x1E4F1D9E0];
  id v18 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
  id v19 = _BRLocalizedStringWithFormat();
  v31[3] = v19;
  uint64_t v20 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v31 forKeys:v30 count:4];
...
- (void)showErrorParticipantLimitReachedForShareMetadata:(id)a3 reply:(id)a4
{
  ...
  id v19 = (void *)v16;
  v34[2] = v16;
  v33[3] = *MEMORY[0x1E4F1D9E0];
  uint64_t v20 = [(BRCUserNotification *)v18 _localizationKey:@"PREVIEW_BUTTON" forTypeOfShare:v17];
  id v21 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
  id v22 = _BRLocalizedStringWithFormat();
  v34[3] = v22;
  id v23 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v34 forKeys:v33 count:4];
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] User notification completion block should run with %@ persona%@");
}

- (void)_logWrapUserReplyBlock:.cold.2()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] ┣%llx updating dialog...%@");
}

void __46__BRCUserNotification__logWrapUserReplyBlock___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] ┳%llx sending user reply%@");
}
...
void __74__BRCUserNotification__displayDialogWithType_dict_options_userReplyBlock___block_invoke_2_cold_1(_DWORD *a1, uint64_t a2, NSObject *a3)
{
  ...
  LOWORD(v4) = 2112;
  *(void *)((char *)&v4 + 2) = a2;
  OUTLINED_FUNCTION_16_0(&dword_1D353B000, a2, a3, "[ERROR] can't create user notification: %d%@", v3, (void)v4, WORD4(v4), *MEMORY[0x1E4F143B8]);
}
...
void __74__BRCUserNotification__displayDialogWithType_dict_options_userReplyBlock___block_invoke_2_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: self->_source == NULL%@", (uint8_t *)&v2, 0xCu);
}
...
void __65__BRCUserNotification__updateDialogWithType_dict_userReplyBlock___block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  LOWORD(v4) = 2112;
  *(void *)((char *)&v4 + 2) = a1;
  OUTLINED_FUNCTION_16_0(&dword_1D353B000, a2, a3, "[ERROR] can't update user notification: %d%@", v3, (void)v4, WORD4(v4), *MEMORY[0x1E4F143B8]);
}
...
- (void)showErrorInstallNativeAppForShareMetadata:(uint64_t)a1 reply:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !shareMetadata.share.isFolderShare%@", (uint8_t *)&v2, 0xCu);
}
