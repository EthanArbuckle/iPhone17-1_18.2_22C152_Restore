...
void __52__BRCSharedClientZone_addAcceptOperation_forItemID___block_invoke(uint64_t a1)
{
  ...
  id v2 = *(id *)(a1 + 32);
  objc_sync_enter(v2);
  id v3 = [*(id *)(*(void *)(a1 + 32) + 528) objectForKeyedSubscript:*(void *)(a1 + 40)];

  if (v3 == WeakRetained) {
    [*(id *)(*(void *)(a1 + 32) + 528) setObject:0 forKeyedSubscript:*(void *)(a1 + 40)];
  }
      ...
      do
      {
        ...
        if ((objc_msgSend(v9, "isShareAcceptationFault", v17) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v17;
            v23 = v14;
            _os_log_fault_impl(&dword_1D353B000, v15, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: item.isShareAcceptationFault%@", buf, 0xCu);
          }
        }
        v10 = [v9 itemID];
...
- (void)setServerZone:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [serverZone isKindOfClass:[BRCSharedServerZone class]]%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)addAcceptOperation:(os_log_t)log forItemID:.cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_fault_impl(&dword_1D353B000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: there is already a share acceptation running for that itemID; %@%@",
    (uint8_t *)&v3,
    0x16u);
}
