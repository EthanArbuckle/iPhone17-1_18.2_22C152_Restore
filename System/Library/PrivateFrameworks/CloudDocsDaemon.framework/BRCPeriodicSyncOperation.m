...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync-down/periodic-sync", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (BOOL)scheduleSyncDownIfNeededForZoneID:(id)a3 zoneIfAny:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v65 = 2112;
    v66 = v10;
    _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx considering whether or not to schedule sync down for %@%@", buf, 0x20u);
  }

  if (![v9 isEqualToString:*MEMORY[0x1E4F59408]])
  {
    if ([v9 isEqualToString:*MEMORY[0x1E4F59480]])
    {
    ...
    if ([v9 isEqualToString:*MEMORY[0x1E4F596D8]])
    {
...
LABEL_51:
        ...
        if ([(CKServerChangeToken *)v14 hasValue:*MEMORY[0x1E4F59300] forName:*MEMORY[0x1E4F592F8]])
        {
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self.group%@", v2, v3, v4, v5, v6);
}
...
void __32__BRCPeriodicSyncOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v26 = 2112;
    char v27 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx completed fetching changed zone\nzones: %@%@", buf, 0x20u);
  }
  ...
  if (!v5)
  {
    if (!v6)
    {
      ...
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: No error found");
...
void __32__BRCPeriodicSyncOperation_main__block_invoke_18(uint64_t a1)
{
  ...
  else
  {
    ...
    id v5 = [v4 objectForKey:*MEMORY[0x1E4F19CD8]];
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v20 = 2112;
      id v21 = v7;
      _os_log_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEFAULT, "[NOTICE] scheduled a %s periodic sync%@", buf, 0x16u);
    }
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] container-metadata appears to be out of sync in the periodic check, forcing sync%@", v2, v3, v4, v5, v6);
}

- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] zone health appears to be out of sync in the periodic check, forcing sync%@", v2, v3, v4, v5, v6);
}

- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] side-car appears to be out of sync in the periodic check, forcing sync%@", v2, v3, v4, v5, v6);
}
...
- (void)scheduleSyncDownIfNeededForZoneID:zoneIfAny:.cold.4()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[NOTIF] Enhanced Drive Privacy enablement detected via periodic sync for %@%@", v1, 0x16u);
}
...
- (void)scheduleSyncDownIfNeededForZoneID:(uint64_t)a3 zoneIfAny:.cold.5(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Not considering %@ for periodic sync because it is blocked from sync%@", v4, 0x16u);
}

- (void)scheduleSyncDownIfNeededForZoneID:(uint64_t)a3 zoneIfAny:.cold.6(void *a1, uint64_t a2, uint64_t a3)
{
  OUTLINED_FUNCTION_7((uint64_t)a1, a2, a3, 5.778e-34);
  _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ appears to be out of sync in the periodic check, forcing sync%@", v4, 0x16u);
}

void __32__BRCPeriodicSyncOperation_main__block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] can't fetch all changed zones: %@%@");
}

void __32__BRCPeriodicSyncOperation_main__block_invoke_2_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: No error found%@", v2, v3, v4, v5, v6);
}
