...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sharing/modifyAccess", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  id v7 = objc_alloc(MEMORY[0x1E4F1A178]);
...
LABEL_5:
    v22 = v6;
    v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v22 count:1];
...
void __39__BRCSharingModifyAccessOperation_main__block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v7 && !v8 && !v9)
  {
    ...
    uint64_t v10 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no dict and no error");
  }
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
    {
      ...
      __int16 v29 = 2112;
      v30 = v13;
      _os_log_error_impl(&dword_1D353B000, v14, (os_log_type_t)0x90u, "[ERROR] Failed %@ access to %@ - %@%@", (uint8_t *)&v23, 0x2Au);
    }
...
void __39__BRCSharingModifyAccessOperation_main__block_invoke_2_cold_1()
{
  ...
  __int16 v6 = v1;
  uint64_t v7 = v2;
  _os_log_debug_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ access to %@%@", v4, 0x20u);
}

void __39__BRCSharingModifyAccessOperation_main__block_invoke_2_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no dict and no error%@", v2, v3, v4, v5, v6);
}
