...
- (void)perform
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v24 = 2112;
    v25 = v3;
    _os_log_debug_impl(&dword_1D353B000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx performing migration for %@%@", buf, 0x20u);
  }
  ...
  id v17 = v7;
  v18 = self;
  v8 = (void *)MEMORY[0x1D94389C0](v16);
  if (v7)
  {
    v9 = (void *)[objc_alloc(MEMORY[0x1E4F4BF90]) initWithAccount:v7];
    BRSetupAARequest(v9);
...
void __29__BRCAccountMigrator_perform__block_invoke_100(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v26 = 2112;
    v27 = v10;
    _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Setting migration state. response: %@, error: %@%@", buf, 0x2Au);
  }
...
void __29__BRCAccountMigrator_perform__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: handler%@", v2, v3, v4, v5, v6);
}

void __29__BRCAccountMigrator_perform__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] migration completed%@", v2, v3, v4, v5, v6);
}

void __29__BRCAccountMigrator_perform__block_invoke_100_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] status: %@%@");
}
