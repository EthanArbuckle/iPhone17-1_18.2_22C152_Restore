...
- (BRCRecursiveListDirectoryContentsOperation)initWithItemID:(id)a3 sessionContext:(id)a4 zone:(id)a5 isUserWaiting:(BOOL)a6
{
  ...
  if (v17)
  {
    ...
    v22 = objc_msgSend(MEMORY[0x1E4F1A218], "br_listDirectoryContents");
...
- (BOOL)_finishIfBlockedFromListing
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      int v9 = 138412290;
      v10 = v5;
      _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Can't list anymore in the middle of a rec-list operation%@", (uint8_t *)&v9, 0xCu);
    }

    id v7 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorSyncBlocked");
    ...
    while (1)
    {
      ...
      if ([v11 isDocumentsFolder])
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v24 = v16;
          _os_log_fault_impl(&dword_1D353B000, v12, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !childID.isDocumentsFolder%@", buf, 0xCu);
        }
      }
      if ([*(id *)(*(void *)(a1 + 40) + 528) containsObject:v11])
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v24 = v17;
          _os_log_fault_impl(&dword_1D353B000, v15, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: ![self->_itemsToList containsObject:childID]%@", buf, 0xCu);
        }
      }
    ...
    if (v2)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v28 = 2112;
        v29 = v4;
        _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ listing next item %@%@", buf, 0x20u);
      }
        ...
        if (([v2 isEqualToItemID:*(void *)(v8 + 536)] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v26 = 2112;
            v27 = v15;
            _os_log_impl(&dword_1D353B000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] ItemID %@ isn't able to be listed%@", buf, 0x16u);
          }
        }
  ...
  if (([*(id *)(a1 + 32) finishIfCancelled] & 1) == 0)
  {
    if (objc_msgSend(v3, "brc_isIgnorableListDirectoryError"))
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v12 = 2112;
        uint64_t v13 = v4;
        _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Continuing %@ after encountering a ignorable error for %@%@", (uint8_t *)&v8, 0x20u);
      }
...
- (void)addRecursiveDirectoryListCompletionBlock:(id)a3
{
  ...
  {
    uint64_t v7 = (void *)MEMORY[0x1D94389C0](v4);
...
void __58__BRCRecursiveListDirectoryContentsOperation_listNextItem__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: ![self->_itemsFailedListing containsObject:itemID]%@", (uint8_t *)&v2, 0xCu);
}
