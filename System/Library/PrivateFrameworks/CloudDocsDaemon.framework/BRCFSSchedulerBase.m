...
- (BRCFSSchedulerBase)initWithSession:(id)a3 name:(id)a4 tableName:(id)a5
{
  ...
  if (v12)
  {
    ...
    uint64_t v14 = [MEMORY[0x1E4FBA900] nameWithString:v11];
...
void __53__BRCFSSchedulerBase_initWithSession_name_tableName___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v14 = 2112;
    v15 = v4;
    _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@: scheduling%@", buf, 0x20u);
  }
...
- (BOOL)canRetryJobWithID:(id)a3
{
  ...
  uint64_t v8 = [v4 matchingJobsWhereSQLClause];
  id v9 = (void *)[v5 numberWithSQL:@"SELECT next_retry_stamp > %llu FROM %@ WHERE %@", v6, tableName, v8];

  LOBYTE(v8) = [v9 BOOLValue] ^ 1;
  return (char)v8;
}
...
- (id)descriptionForJobsMatching:(id)a3 ordering:(id)a4 additionalColumns:(id)a5 additionalValuesHandler:(id)a6 context:(id)a7
{
  ...
  {
    id v17 = [(BRCAccountSession *)self->_session clientDB];
  }
  v39 = v17;
  ...
  if (v13)
  {
    dispatch_group_t v18 = [MEMORY[0x1E4FBA908] rawInjection:"," length:1];
    v19 = v13;
  }
  else
  {
    dispatch_group_t v18 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
  ...
  {
    uint64_t v24 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
...
- (void)describeInBuffer:(id)a3 aggregateOfJobsMatching:(id)a4 context:(id)a5
{
  ...
  {
    id v12 = [(BRCAccountSession *)self->_session clientDB];
  }
  id v13 = v12;
...
- (id)aggregateDescriptionForJobsMatching:(id)a3 context:(id)a4
{
  uint64_t v6 = (objc_class *)MEMORY[0x1E4F28E78];
  id v7 = a4;
  id v8 = a3;
...
- (unint64_t)postponeJobID:(id)a3 withThrottle:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v29 = 2112;
    uint64_t v30 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: post-poning job%@", buf, 0x20u);
  }

  id v9 = [(BRCAccountSession *)self->_session clientDB];
  tableName = self->_tableName;
  ...
  id v14 = [(BRCAccountSession *)self->_session clientDB];
...
- (brc_job_update)insertOrUpdateJobID:(id)a3 throttle:(id)a4 withState:(int)a5 insertedSQLColumn:(id)a6 insertedSQLValues:(id)a7 updatedSQLValues:(id)a8 error:(id *)a9
{
  ...
  if (DWORD1(v77) == -1)
  {
    v71 = [(BRCAccountSession *)self->_session clientDB];
    tableName = self->_tableName;
    uint64_t v69 = [v14 columns];
    if (v15)
    {
      uint64_t v67 = [MEMORY[0x1E4FBA908] rawInjection:"," length:1];
    }
    else
    {
      uint64_t v67 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
      id v15 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
    }
    uint64_t v30 = v77;
    ...
    if (v16)
    {
      v34 = [MEMORY[0x1E4FBA908] rawInjection:"," length:1];
      id v65 = v16;
      uint64_t v63 = v31;
    ...
    {
      id v66 = v14;
      v34 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
      v38 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
      uint64_t v64 = v31;
      objc_super v35 = (void *)v67;
      v37 = (void *)v69;
      v36 = v71;
  ...
  else
  {
    ...
    uint64_t v18 = [(BRCAccountSession *)self->_session clientDB];
    v70 = self->_tableName;
    uint64_t v19 = v77;
    long long v20 = v78;
    if (v75)
    {
      uint64_t v21 = [MEMORY[0x1E4FBA908] rawInjection:"," length:1];
      v22 = v75;
    }
    else
    {
      uint64_t v21 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
      v22 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
    }
    id v23 = v14;
  ...
  _os_log_debug_impl(&dword_1D353B000, v53, OS_LOG_TYPE_DEBUG, v52, buf, v54);
LABEL_23:
...
- (void)rescheduleSuspendedJobsMatching:(id)a3 inState:(int)a4
{
  ...
  if (v6)
  {
    id v9 = [MEMORY[0x1E4FBA908] rawInjection:"AND " length:4];
    [v6 matchingJobsWhereSQLClause];
  }
  else
  {
    id v9 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
    [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
  int v10 = };
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      __int16 v27 = 2112;
      id v28 = v13;
      _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: retrying %lld suspended jobs matching %@ in %s%@", buf, 0x34u);
    }
...
- (void)computeStamps:(throttle_stamps *)a3 forJobID:(id)a4 throttle:(id)a5 shouldBackoff:(BOOL)a6
{
  ...
  id v13 = [(BRCAccountSession *)self->_session clientDB];
  tableName = self->_tableName;
    ...
    if ([(BRCFSSchedulerBase *)self updateStamps:a3 throttle:v11 now:v12])
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138413314;
        ...
        __int16 v34 = 2112;
        objc_super v35 = v17;
        _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: backing off %.3fs (count: %d)%@", buf, 0x30u);
      }
    }
  }
LABEL_11:
...
- (BOOL)setState:(int)a3 forJobID:(id)a4
{
  ...
  BOOL v6 = [(BRCAccountSession *)self->_session clientDB];
...
- (BOOL)setState:(int)a3 forJobsMatching:(id)a4
{
  ...
  int v20 = a3;
  v19[4] = self;
  int64_t v9 = (void *)MEMORY[0x1D94389C0](v19);
  ...
  id v11 = [(BRCAccountSession *)self->_session clientDB];
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413314;
      ...
      __int16 v29 = 2112;
      __int16 v30 = v13;
      _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: Updated %lld jobs to state %s%@", buf, 0x34u);
    }
  }
...
- (void)deleteJobsMatching:(id)a3
{
  ...
  id v4 = a3;
  int v5 = [(BRCAccountSession *)self->_session clientDB];
  tableName = self->_tableName;
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v10;
      _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: Deleted %lld jobs%@", buf, 0x2Au);
    }
...
- (void)resetBackoffForJobWithID:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v19 = 2112;
    __int16 v20 = v5;
    _os_log_debug_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@[%@]: resetting backoff for job%@", buf, 0x20u);
  }
...
- (void)deleteExpiredJobs
{
  ...
  BOOL v3 = [(BRCAccountSession *)self->_session clientDB];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v13 = 2112;
      id v14 = v6;
      _os_log_debug_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: Cleaned up %lld expired jobs%@", buf, 0x20u);
    }
  }
}
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v12 = 2112;
        __int16 v13 = v5;
        _os_log_debug_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: Throttle id %@ has work%@", buf, 0x20u);
      }
    }
...
- (void)schedule
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_FAULT))
  {
    int v4 = 138412290;
    uint64_t v5 = v2;
    _os_log_fault_impl(&dword_1D353B000, v3, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: should be implemented by subclass%@", (uint8_t *)&v4, 0xCu);
  }
}
...
- (void)scheduleWithBatchSize:(int)a3 whereSQLClause:(id)a4 columns:(id)a5 actionHandler:(id)a6
{
  ...
  uint64_t v14 = [(BRCAccountSession *)self->_session clientDB];
  ...
  if (v10)
  {
    __int16 v17 = objc_msgSend(MEMORY[0x1E4FBA908], "rawInjection:length:", "AND (", 5);
    id v18 = objc_msgSend(MEMORY[0x1E4FBA908], "rawInjection:length:", ")", 1);
  ...
  else
  {
    ...
    id v18 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
    __int16 v19 = [MEMORY[0x1E4FBA908] rawInjection:"" length:0];
...
LABEL_18:
  ...
  if ([(BRCFSSchedulerBase *)self canScheduleMoreJobs])
  {
    do
    {
      ...
      uint64_t v21 = (void *)MEMORY[0x1D9438760]();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v33 = 2112;
        __int16 v34 = v24;
        _os_log_debug_impl(&dword_1D353B000, v25, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: going to sleep for %.3fs%@", buf, 0x20u);
      }
    }
...
- (void)cancel
{
  OUTLINED_FUNCTION_3(*MEMORY[0x1E4F143B8]);
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] %@: cancelling!%@");
}
...
void __53__BRCFSSchedulerBase_initWithSession_name_tableName___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] cancelled%@", v1, 0xCu);
}

- (void)canRetryJobWithID:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: jobID%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: stamps.state != BRCJobStateInvalid%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: throttle%@", v2, v3, v4, v5, v6);
}

- (void)computeStamps:forJobID:throttle:shouldBackoff:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !rs.next%@", v2, v3, v4, v5, v6);
}
...
- (void)scheduleWithBatchSize:whereSQLClause:columns:actionHandler:.cold.1()
{
  ...
  __int16 v10 = 2112;
  uint64_t v11 = v0;
  _os_log_debug_impl(&dword_1D353B000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] %@: nothing schedulable, going to sleep %s%@", (uint8_t *)&v6, 0x20u);
}
...
- (void)scheduleWithBatchSize:whereSQLClause:columns:actionHandler:.cold.2()
{
  OUTLINED_FUNCTION_3(*MEMORY[0x1E4F143B8]);
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] %@: Finishing batch and allowing other jobs to run%@");
}
