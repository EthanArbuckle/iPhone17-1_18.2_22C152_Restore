...
- (BRCSharingCopyShortTokenOperation)initWithItem:(id)a3 sessionContext:(id)a4
{
  v6 = (objc_class *)MEMORY[0x1E4F1A2F8];
  id v7 = a4;
  id v8 = a3;
  v9 = (void *)[[v6 alloc] initShareIDWithShareableItem:v8];
  v10 = [v8 baseRecord];
  v11 = (void *)[objc_alloc(MEMORY[0x1E4F1A390]) initWithRootRecord:v10 shareID:v9];
  v12 = [v8 st];
  v13 = [v12 logicalName];
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sharing/copy-shortToken", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
void __41__BRCSharingCopyShortTokenOperation_main__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: No short token found on record");
...
void __41__BRCSharingCopyShortTokenOperation_main__block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: No short token found on record%@", v2, v3, v4, v5, v6);
}
