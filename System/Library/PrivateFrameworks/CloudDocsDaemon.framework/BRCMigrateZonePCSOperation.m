...
- (void)_createCloudDocsZone:(id)a3
{
  ...
  v6 = (void *)[v5 initWithZoneName:*MEMORY[0x1E4F59418] ownerName:*MEMORY[0x1E4F19C08]];
...
void __51__BRCMigrateZonePCSOperation__createCloudDocsZone___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5) {
    ...
    id v7 = (id)[objc_alloc(MEMORY[0x1E4F1A310]) initWithZoneID:*(void *)(a1 + 32)];
  }
  uint64_t v8 = v7;
...
- (void)_fetchZonesNeedingMigration:(id)a3
{
  ...
  uint64_t v8 = (void *)[v7 initWithZoneName:*MEMORY[0x1E4F59418] ownerName:*MEMORY[0x1E4F19C08]];
  v9 = [MEMORY[0x1E4F1A090] fetchAllRecordZonesOperation];
  uint64_t v13 = MEMORY[0x1E4F143A8];
  uint64_t v14 = 3221225472;
  id v15 = __58__BRCMigrateZonePCSOperation__fetchZonesNeedingMigration___block_invoke;
  id v16 = &unk_1E6998E90;
  id v17 = v8;
  id v18 = v6;
  v19 = self;
  id v20 = v4;
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v26 = 2112;
      v27 = v10;
      _os_log_error_impl(&dword_1D353B000, v11, (os_log_type_t)0x90u, "[ERROR] Failed fetching zones to prep PCS for %@ - %@%@", buf, 0x20u);
    }
    ...
    if ([v7 count])
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v26 = 2112;
        v27 = v12;
        _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] Prepping PCS for %@ -> %@%@", buf, 0x20u);
      }

      uint64_t v14 = (void *)[objc_alloc(MEMORY[0x1E4F19E38]) initWithSourceZoneIDs:v7 targetZone:v8];
  ...
  if (v6 && !objc_msgSend(v6, "brc_isCloudKitErrorZoneMigrated"))
  {
    ...
    if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v25 = 2112;
      __int16 v26 = v13;
      _os_log_error_impl(&dword_1D353B000, v14, (os_log_type_t)0x90u, "[ERROR] Failed migrating PCS for %@ - %@%@", buf, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v25 = 2112;
      __int16 v26 = v8;
      _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] PCS migration %@ for %@%@", buf, 0x20u);
    }
...
void __34__BRCMigrateZonePCSOperation_main__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1D353B000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] No zones need PCS prep currently%@", (uint8_t *)&v2, 0xCu);
}
