...
+ (id)brc_containerMetadataRecordWithContainer:()BRCContainerMetadataAdditions
{
  ...
  if (v4)
  {
    ...
    v9 = (void *)[objc_alloc(MEMORY[0x1E4F1A2D8]) initWithRecordType:@"AppContainer" recordID:v8];
...
+ (void)brc_containerMetadataRecordWithContainer:()BRCContainerMetadataAdditions .cold.1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: dataRepresentation != nil%@", v2, v3, v4, v5, v6);
}
