...
- (NSData)signature
{
  ...
  v3 = [MEMORY[0x1E4F1C9B8] dataWithBytes:self->_sig length:21];
  return (NSData *)v3;
}
...
- (void)signature
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !_isOpen%@", (uint8_t *)&v2, 0xCu);
}
