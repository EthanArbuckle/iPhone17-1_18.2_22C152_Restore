...
- (uint64_t)parseUnsaltedBookmarkDataWithItemID:()BRCBookmarkAdditions mangledID:error:
{
  ...
  if ([v9 count] == 2)
  {
    ...
    if (v12)
    {
      ...
      objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", @"unsaltedBookmarkData", a1);
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v23, (os_log_type_t)0x90u))
        {
          ...
          __int16 v34 = 2112;
          v35 = v22;
          _os_log_error_impl(&dword_1D353B000, v23, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v28, 0x2Au);
        }
      }
      if (a5) {
        *a5 = v21;
    ...
    else
    {
      ...
      if (v15)
      {
        ...
        if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
        {
          ...
          __int16 v34 = 2112;
          v35 = v19;
          _os_log_error_impl(&dword_1D353B000, v20, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v28, 0x2Au);
        }
      }
      if (a5)
      {
...
LABEL_27:
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      __int16 v34 = 2112;
      v35 = v17;
      _os_log_error_impl(&dword_1D353B000, v18, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", (uint8_t *)&v28, 0x2Au);
    }
  }
  if (a5)
  {
...
- (uint64_t)parseBookmarkDataWithAccountSession:()BRCBookmarkAdditions docID:itemID:mangledID:unsaltedBookmarkData:error:
{
  ...
  if ([v14 count] == 3)
  {
    ...
    id obj = (id)[objc_alloc(MEMORY[0x1E4F594E8]) initWithAliasTargetContainerString:v15];
      ...
      && ([v17 isEqualToString:@"BRGetFileNameFromServerInfoBlob"] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v32, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138413058;
        ...
        __int16 v63 = 2112;
        v64 = v31;
        _os_log_error_impl(&dword_1D353B000, v32, (os_log_type_t)0x90u, "[ERROR] checksum from bookmark %@ is not equal to expected checksum %@ for %@%@", buf, 0x2Au);
      }

      v18 = obj;
      if (v30)
      {
        objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorAccountMismatch");
        uint64_t v27 = 0;
...
LABEL_29:
    ...
    {
      v41 = v16;
      v42 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", @"bookmarkData", a1);
      if (v42)
      {
        v43 = a8;
...
LABEL_41:
  ...
  objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", @"bookmarkData", a1);
...
+ (void)bookmarkDataWithItemResolutionString:()BRCBookmarkAdditions serverZoneMangledID:saltAccountDSID:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: should have an accountID to salt with%@", (uint8_t *)&v2, 0xCu);
}
