...
+ (id)newFromSqliteValue:(sqlite3_value *)a3
{
  *(void *)&v24[13] = *MEMORY[0x1E4F143B8];
  ...
  if (v4 != 4)
  {
    ...
    {
      v19 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v10 length:v11];
      int v21 = 138412802;
      v22 = v19;
      __int16 v23 = 1024;
      *(_DWORD *)v24 = v5;
      v24[2] = 2112;
      *(void *)&v24[3] = v12;
      _os_log_fault_impl(&dword_1D353B000, v13, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unmigrated? invalid BRCItemID (%@) - %d%@", (uint8_t *)&v21, 0x1Cu);
    }
    return 0;
  }
  ...
  if (v7 != 21)
  {
    ...
    {
      v20 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v6 length:v14];
      int v21 = 138412546;
      v22 = v20;
      __int16 v23 = 2112;
      *(void *)v24 = v17;
      _os_log_fault_impl(&dword_1D353B000, v18, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid BRCItemID (%@)%@", (uint8_t *)&v21, 0x16u);
    }
    return 0;
  }
...
- (void)itemIDString
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: we should not have alias uuid types anymores%@", v2, v3, v4, v5, v6);
}

- (void)initWithRootObject:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: object->item_code == 1 || object->item_code == 2%@", v2, v3, v4, v5, v6);
}

- (void)initWithUUIDObject:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: object->item_code == 4 || object->item_code == 5%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: rio.app_lib_rowid%@", v2, v3, v4, v5, v6);
}

- (void)sqliteBind:index:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: uio.app_lib_rowid%@", v2, v3, v4, v5, v6);
}
...
- (void)_initAsLibraryRootWithAppLibraryRowID:enclosureUUID:.cold.2()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid enclosure uuid - %@%@", v1, 0x16u);
}
