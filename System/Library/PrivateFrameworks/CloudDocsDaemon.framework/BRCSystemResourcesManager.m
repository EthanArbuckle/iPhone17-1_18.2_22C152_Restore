  ...
  if (a3)
  {
    ...
    else
    {
      if (powerLevelOKTimer)
      {
        ...
        {
          v15 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v13);
        }
      ...
      {
        v17 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_notificationQueue);
        ...
        if (*MEMORY[0x1E4F59658])
        {
          v22 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v20);
        }
...
- (void)_initPowerManager
{
  ...
  v12[4] = self;
  id v6 = v12;
  double v7 = (void *)MEMORY[0x1E4FB36F8];
  ...
  id v15 = v6;
  dispatch_block_t v16 = "com.apple.system.powermanagement.SystemLoadAdvisory";
  id v14 = v10;
  id v11 = v10;
...
- (BRCSystemResourcesManager)init
{
  ...
  if (v2)
  {
    uint64_t v3 = dispatch_queue_attr_make_with_qos_class(0, QOS_CLASS_UTILITY, 0);
    ...
    [(BRCSystemResourcesManager *)v2 _initXPCFSEvents];
    double v7 = brc_bread_crumbs();
    id v8 = brc_default_log();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
      -[BRCSystemResourcesManager init]();
...
- (void)reset
{
  ...
  id v1 = OUTLINED_FUNCTION_1_2(v0);
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] [%@] has been reset%@", v4, v5, v6, v7, v8);
}

- (void)_initScreenLockManager
{
  uint64_t v3 = [MEMORY[0x1E4F59538] sharedScreenLockMonitor];
  [v3 addObserver:self];
...
- (void)_initReachability
{
  ...
  BOOL v3 = [MEMORY[0x1E4F28D30] weakObjectsHashTable];
  ...
  long long v14 = [MEMORY[0x1E4F59520] sharedReachabilityMonitor];
...
- (void)_invalidateReachability
{
  ...
  uint64_t v4 = [MEMORY[0x1E4F59520] sharedReachabilityMonitor];
...
- (void)_setNetworkReachable:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v20 = 2112;
    v21 = v5;
    _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] Network really becomes %sreachable%@", buf, 0x16u);
  }
...
- (void)_initLowDiskManager
{
  ...
  BOOL v7 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x1E4F14498], 0, 0x1304uLL, (dispatch_queue_t)self->_notificationQueue);
  ...
  if (*MEMORY[0x1E4F59658])
  {
    long long v13 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v11);
  }
...
void __48__BRCSystemResourcesManager__initLowDiskManager__block_invoke(uint64_t a1)
{
  ...
  if (!*(void *)(v3 + 128))
  {
    dispatch_source_t v4 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, *(dispatch_queue_t *)(v3 + 8));
    ...
    if (*MEMORY[0x1E4F59658])
    {
      dispatch_block_t v14 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v12);
    }
  ...
  if (*(unsigned char *)(a1 + 40) || has_enough_space == v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v27 = 2112;
      BOOL v28 = v10;
      _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] disk %@ has %senough space now%@", buf, 0x20u);
    }
...
- (void)_initLowMemory
{
  ...
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _memoryNotificationEventSource == NULL%@", v1, 0xCu);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Memory warning received%@", v2, v3, v4, v5, v6);
}
...
void __60__BRCSystemResourcesManager_addProcessMonitor_forProcessID___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    uint64_t v3 = (void *)[objc_alloc(MEMORY[0x1E4F59510]) initForProcessID:*(unsigned int *)(a1 + 48) observer:*(void *)(a1 + 40)];
    if (v3)
    {
      uint64_t v4 = v3;
...
- (void)init
{
  ...
  id v1 = OUTLINED_FUNCTION_1_2(v0);
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] [%@] has been initialized%@", v4, v5, v6, v7, v8);
}
...
void __34__BRCSystemResourcesManager_close__block_invoke_cold_1()
{
  os_log_t v0 = objc_opt_class();
  id v1 = OUTLINED_FUNCTION_1_2(v0);
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] [%@] has been invalidated%@", v4, v5, v6, v7, v8);
}

- (void)_setPowerLevel:.cold.1()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Power level really becomes %s%@");
}
...
- (void)addLowDiskObserver:forDevice:.cold.1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_3_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: deviceID != 0%@", v1, 0xCu);
}

void __50__BRCSystemResourcesManager__initAppListObservers__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Received an app install notification%@", v2, v3, v4, v5, v6);
}
