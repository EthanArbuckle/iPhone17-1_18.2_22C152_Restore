...
- (void)setCKInfoFieldsInRecord:(id)a3 includeCZMEtag:(BOOL)a4
{
  ...
  if (v7 && v4)
  {
    ...
    {
      uint64_t v10 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:3];
    }
...
+ (id)newFromSqliteValue:(sqlite3_value *)a3
{
  ...
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F1C9B8]) initWithBytesNoCopy:v5 length:sqlite3_value_bytes(a3) freeWhenDone:0];
...
+ (id)newFromSqliteStatement:(sqlite3_stmt *)a3 atIndex:(int)a4
{
  ...
  char v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1C9B8]), "initWithBytesNoCopy:length:freeWhenDone:", v7, sqlite3_column_bytes(a3, a4), 0);
