...
- (BRCListDirectoryContentsOperation)initWithItemID:(id)a3 sessionContext:(id)a4 zone:(id)a5 isUserWaiting:(BOOL)a6
{
  ...
  if (v17)
  {
    ...
    v24 = objc_msgSend(MEMORY[0x1E4F1A218], "br_listDirectoryContents");
...
- (void)_cursorWasUpdated:(id)a3 subResourcesOp:(id)a4
{
  ...
  if (v8
    && ([v7 error],
        ...
        int v10 = objc_msgSend(v9, "brc_checkErrorsFromCloudKit:", &__block_literal_global_67),
        v9,
        v10))
  {
    id v11 = [v7 error];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v12;
      _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ finished listing batch with cursor %@%@", (uint8_t *)&v20, 0x20u);
    }
...
- (void)_scheduleQueryOp
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a2;
  OUTLINED_FUNCTION_1(&dword_1D353B000, a2, a3, "[DEBUG] Dropping list directory database because of a token fetch error - %@%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}
...
LABEL_4:
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v4;
    _os_log_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] Not trying to promote %@ to a normal directory%@", buf, 0x16u);
  }
LABEL_10:
}
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_2_107(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v25 = 2112;
    uint64_t v26 = v10;
    _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] Listing directory contents of %@: Got record: ID [%@] Type [%@], error %@%@", (uint8_t *)&v17, 0x34u);
  }
  if (v8)
  {
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] Listing directory contents of %@%@", v4, v5, v6, v7, v8);
}
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  id v14 = [v13 objectForKeyedSubscript:*MEMORY[0x1E4F19CD8]];
...
- (void)addPreFlushDirectoryListCompletionBlock:(id)a3
{
  ...
  id v8 = (void *)MEMORY[0x1D94389C0](v4);
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_76_cold_1(uint64_t a1)
{
  ...
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] Finished listing directory contents of %@%@", v4, v5, v6, v7, v8);
}
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_2_103_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1D353B000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetching the root as well of this share accept fault%@", (uint8_t *)&v2, 0xCu);
}
...
void __53__BRCListDirectoryContentsOperation__scheduleQueryOp__block_invoke_3_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !continuationCursor%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)finishWithResult:(NSObject *)a3 error:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v21 = 2112;
  uint64_t v22 = a2;
  _os_log_debug_impl(&dword_1D353B000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Listing directory contents of %@ took [%f] Secs and fetched [%llu,%llu] records [%llu] xattrs%@", (uint8_t *)&v11, 0x3Eu);
}
