...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync/pcs-chain", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
...
LABEL_5:
  ...
  v9 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Can't PCS chain to documents, trash, or root");
...
- (void)_sendRecordBatch:(id)a3 recursed:(BOOL)a4 completion:(id)a5
{
  ...
  if ([v8 count])
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          uint64_t v37 = v12;
          v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v37 forKeys:&v36 count:1];
    ...
    id v29 = 0;
    id v16 = (void *)[objc_alloc(MEMORY[0x1E4F1A198]) initWithRecordsToSave:v9 recordIDsToDelete:0];
    [v16 setSavePolicy:0];
    [v16 setAtomic:1];
          ...
          if (v24)
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v63 = 2112;
              id v64 = v31;
              _os_log_impl(&dword_1D353B000, v32, OS_LOG_TYPE_DEFAULT, "[WARNING] Got an error indicating we need to reparent %@ to %@%@", buf, 0x20u);
            }
  ...
  if (v6 && (objc_msgSend(v6, "brc_isCloudKitAtomicFailure") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v63 = 2112;
      id v64 = v16;
      _os_log_impl(&dword_1D353B000, v29, OS_LOG_TYPE_DEFAULT, "[WARNING] Encountered pcs chaining error %@ for record %@%@", buf, 0x20u);
    }
    goto LABEL_29;
  }
LABEL_30:
...
void __64__BRCPCSChainingOperation__sendRecordBatch_recursed_completion___block_invoke_189(void *a1)
{
  ...
  if (([v4 localDiffs] & 0x20) != 0 && objc_msgSend(v4, "needsSyncUp"))
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_error_impl(&dword_1D353B000, v6, (os_log_type_t)0x90u, "[ERROR] Blocking %@ from sync up until it is next modified because the server failed to pcs chain %@ with a permanent error%@", (uint8_t *)&v11, 0x20u);
    }
...
uint64_t __64__BRCPCSChainingOperation__sendRecordBatch_recursed_completion___block_invoke_191(uint64_t a1)
{
  ...
  if (*(void *)(*(void *)(*(void *)(a1 + 48) + 8) + 40))
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v9 = 2112;
      uint64_t v10 = v2;
      _os_log_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Retrying with new record batch because we were told about a new parent - %@%@", (uint8_t *)&v7, 0x16u);
    }
        ...
        for (uint64_t i = 0; i != v3; ++i)
        {
          ...
          if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v67 = 2112;
            v68 = v8;
            _os_log_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Learning etag in the server truth for half chained parent %@%@", buf, 0x16u);
          }
          ...
          if (!v19)
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412290;
              uint64_t v66 = v20;
              _os_log_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Uh oh... the record changed server side while we were mid pcs chain batch.  We might have oplock conflicts%@", buf, 0xCu);
            }
          }
              ...
              !v36))
        {
          ...
          if (!v46)
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              uint64_t v66 = v47;
              _os_log_fault_impl(&dword_1D353B000, v48, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: record.parent%@", buf, 0xCu);
            }
          }
          v36 = [*(id *)(a1 + 48) db];
        ...
        else
        {
          ...
          if (v39)
          {
            ...
            if (os_log_type_enabled(v50, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412290;
              uint64_t v66 = v49;
              _os_log_fault_impl(&dword_1D353B000, v50, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: !record.parent%@", buf, 0xCu);
            }
          }
...
uint64_t __40__BRCPCSChainingOperation__chainRecords__block_invoke_204(uint64_t a1)
{
  ...
  {
    uint64_t v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(*(id *)(a1 + 48), "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
  ...
  if (self->_canSyncDownBeforeRetry && self->_syncDownBeforeRetry)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v10 = 2112;
      uint64_t v11 = v3;
      _os_log_impl(&dword_1D353B000, v4, OS_LOG_TYPE_DEFAULT, "[WARNING] Syncing down before retrying %@%@", buf, 0x16u);
    }
...
void __31__BRCPCSChainingOperation_main__block_invoke_3(uint64_t a1)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v13 = 2112;
      long long v14 = v8;
      _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Refreshed root item from db %@%@", (uint8_t *)&v11, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      int v11 = 138412290;
      uint64_t v12 = v8;
      _os_log_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't refresh item from the database%@", (uint8_t *)&v11, 0xCu);
    }
  }
...
- (void)initWithRootItem:appLibrary:sessionContext:syncUpCallback:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: rootItem%@", v2, v3, v4, v5, v6);
}

- (void)_buildRecordListWithCompletion:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Can't PCS chain to documents, trash, or root%@", v2, v3, v4, v5, v6);
}

void __58__BRCPCSChainingOperation__buildRecordListWithCompletion___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] %@ is already chained%@");
}

void __58__BRCPCSChainingOperation__buildRecordListWithCompletion___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: listOp%@", v2, v3, v4, v5, v6);
}

void __58__BRCPCSChainingOperation__buildRecordListWithCompletion___block_invoke_cold_3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: si%@", v2, v3, v4, v5, v6);
}

void __64__BRCPCSChainingOperation__sendRecordBatch_recursed_completion___block_invoke_188_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: [newParent hasPrefix:kBRRecordIDPrefixDirectoryStructure]%@", v2, v3, v4, v5, v6);
}

void __40__BRCPCSChainingOperation__chainRecords__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Failed iterating PCS - %@%@");
}

void __40__BRCPCSChainingOperation__chainRecords__block_invoke_194_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] failed sending first PCS step - %@%@");
}

void __40__BRCPCSChainingOperation__chainRecords__block_invoke_195_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Failed sending second PCS step - %@%@");
}
