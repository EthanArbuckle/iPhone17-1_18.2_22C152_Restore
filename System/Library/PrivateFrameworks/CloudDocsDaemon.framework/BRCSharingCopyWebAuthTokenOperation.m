...
- (BRCSharingCopyWebAuthTokenOperation)initWithSyncContext:(id)a3 ckContainerID:(id)a4 sessionContext:(id)a5
{
  ...
  if (v10)
  {
    ...
    v12 = objc_msgSend(MEMORY[0x1E4F1A218], "br_sharingMisc");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sharing/copy-web-auth-token", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
...
- (void)main
{
  id v3 = objc_alloc_init(MEMORY[0x1E4F1A100]);
  v4 = objc_opt_new();
  [v3 setConfiguration:v4];

  v5 = [MEMORY[0x1E4F19EC8] containerWithIdentifier:self->_ckContainerID];
  v6 = [v3 configuration];
  [v6 setContainer:v5];
...
void __43__BRCSharingCopyWebAuthTokenOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      __int16 v14 = 2112;
      v15 = v7;
      _os_log_error_impl(&dword_1D353B000, v8, (os_log_type_t)0x90u, "[ERROR] failed fetching webauth token for %@: %@%@", (uint8_t *)&v10, 0x20u);
    }
  }
