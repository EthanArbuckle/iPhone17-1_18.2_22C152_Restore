...
- (id)initDeltaSyncWithServerZone:(id)a3 sessionContext:(id)a4
{
  ...
  v11 = [v7 ownerName];
  char v12 = [v11 isEqualToString:*MEMORY[0x1E4F19C08]];
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync-down", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)_performAfterFetchingRecordChanges:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v112[10] = 2112;
      *(void *)&v112[12] = v12;
      _os_log_impl(&dword_1D353B000, v13, OS_LOG_TYPE_INFO, "[INFO] ┣%llx %@ fetch record changes operation for %@ from token %@%@", buf, 0x34u);
    }
    ...
    v20 = [MEMORY[0x1E4F1A2D8] desiredKeysWithMask:185];
    [v19 setDesiredKeys:v20];
    v48 = v19;

    id v21 = objc_alloc(MEMORY[0x1E4F1A070]);
    v22 = [(BRCServerZone *)v4 zoneID];
    v109 = v22;
    double v23 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v109 count:1];
    double v24 = [(BRCServerZone *)v4 zoneID];
    v107 = v24;
    v108 = v48;
    v25 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v108 forKeys:&v107 count:1];
    ...
    *(void *)&v112[8] = 0;
    ...
    v73 = buf;
    id v71 = v37;
    v38 = (void *)MEMORY[0x1D94389C0](v70);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_18(uint64_t a1, void *a2)
{
  ...
  if ([v5 hasValue:*MEMORY[0x1E4F59300] forName:*MEMORY[0x1E4F592F8]])
  {
...
{
  id v2 = objc_alloc(MEMORY[0x1E4F594E8]);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_23(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v33 = 2112;
    v34 = v11;
    _os_log_impl(&dword_1D353B000, v12, OS_LOG_TYPE_INFO, "[INFO] ┳%llx got a record in operation %@%@", buf, 0x20u);
  }
...
LABEL_18:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v33 = 2112;
    v34 = v17;
    _os_log_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEFAULT, "[WARNING] Record fetch failed for %@ with error %@%@", buf, 0x20u);
  }
LABEL_12:
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_25(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v21 = 2112;
    v22 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx got a deletion in operation %@%@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v19 = 2112;
    BOOL v20 = v10;
    _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_INFO, "[INFO] record was deleted: %@%@", buf, 0x16u);
  }

  int v12 = [v6 isEqualToString:*MEMORY[0x1E4F19D78]];
  v13 = *(void **)(a1 + 32);
  if (v12) {
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_27(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v46 = 2112;
    v47 = v14;
    _os_log_debug_impl(&dword_1D353B000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx received updated server change token %@ client change token %@ in operation %@ status %ld%@", buf, 0x3Eu);
  }
  ...
  if (([*(id *)(a1 + 32) saveRecordsWithServerChangeToken:v8 clientChangeToken:v21 syncStatus:v13] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v40 = 2112;
      id v41 = v24;
      _os_log_fault_impl(&dword_1D353B000, v25, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: broken structure in op %@ change token %@%@", buf, 0x20u);
    }
    long long v26 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v27 = [WeakRetained operationID];
    v28 = [v8 descriptionWithContext:0];
    uint64_t v29 = objc_msgSend(v26, "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: broken structure in op %@ change token %@", v27, v28);
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_33(uint64_t a1, void *a2, void *a3, void *a4, int a5, void *a6)
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v32 = 2112;
    __int16 v33 = v16;
    _os_log_debug_impl(&dword_1D353B000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx fetch changes completion for zone in operation %@%@", buf, 0x20u);
  }
  if (!v14)
  {
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_4(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v24 = 2112;
    id v25 = v4;
    _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx fetch changes completed for operation %@%@", buf, 0x20u);
  }
  if (v3)
  {
...
LABEL_9:
  ...
  if (![*(id *)(a1 + 64) handleZoneNotFoundIfSyncingDownForTheFirstTime:v3])
  {
    ...
    else
    {
      ...
      char v11 = [v10 isEqualToString:*MEMORY[0x1E4F19C08]];
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v24 = 2112;
        id v25 = v9;
        _os_log_error_impl(&dword_1D353B000, v14, (os_log_type_t)0x90u, "[ERROR] sync-down failed for %@: %@%@", buf, 0x20u);
      }
    }
LABEL_21:
...
- (void)_saveInitialServerZoneData:(id)a3 clientChangeTokenData:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v27 = 2112;
    v28 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetched initial server zone tokens %@ and %@ for %@%@", buf, 0x2Au);
  }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v27 = 2112;
    v28 = v13;
    _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] Saving initial zone data of %@ with server token %@ client token %@%@", buf, 0x2Au);
  }
  ...
  [(_BRCOperation *)self completedWithResult:&unk_1F2B27660 error:0];
}
...
void __68__BRCSyncDownOperation__fetchInitialZoneIfNecessaryWithCreatedZone___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!(v5 | v9))
  {
    ...
    uint64_t v5 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no fetched zone and no error");
  }
...
- (void)main
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Sync: fetching record changes for %@%@", buf, 0x20u);
  }
  [(BRCSyncDownOperation *)self hash];
  kdebug_trace();
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[NOTIF] Enhanced Drive Privacy enablement discovered via delta sync for %@%@");
}

void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_23_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !record || record.etag != nil%@", v2, v3, v4, v5, v6);
}

void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_23_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: got a nil record and recordID%@", v2, v3, v4, v5, v6);
}
...
void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_23_cold_3(void *a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_debug_impl(&dword_1D353B000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] record changed: %@%@", buf, 0x16u);
}

void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_4_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] success%@", v2, v3, v4, v5, v6);
}

void __59__BRCSyncDownOperation__performAfterFetchingRecordChanges___block_invoke_4_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] cancelled%@", v2, v3, v4, v5, v6);
}

- (void)handleZoneNotFoundIfSyncingDownForTheFirstTime:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] ignoring zone not found error, because we're syncing down for the first time%@", v2, v3, v4, v5, v6);
}

void __68__BRCSyncDownOperation__fetchInitialZoneIfNecessaryWithCreatedZone___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no fetched zone and no error%@", v2, v3, v4, v5, v6);
}

void __66__BRCSyncDownOperation__startCreateZoneAndSubscriptionAndSyncDown__block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] can't register pushes: %@%@");
}
...
void __66__BRCSyncDownOperation__startCreateZoneAndSubscriptionAndSyncDown__block_invoke_2_cold_2()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] can't create zone or register pushes: %@%@", v1, 0x16u);
}
