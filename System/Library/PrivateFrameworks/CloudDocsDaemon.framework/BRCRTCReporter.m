...
- (void)_init
{
  ...
  uint64_t v3 = *MEMORY[0x1E4F94690];
  v23[0] = *MEMORY[0x1E4F94688];
  v23[1] = v3;
  v24[0] = @"bird";
  v24[1] = @"clouddocs";
  v4 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v24 forKeys:v23 count:2];
  ...
  v22[5] = v15;
  v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v22 forKeys:v21 count:6];
...
- (BRCRTCReporter)init
{
  uint64_t v3 = [MEMORY[0x1E4F61980] defaultManager];
  if (!v3)
  {
    v4 = brc_bread_crumbs();
...
- (void)init
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_1D353B000, a2, (os_log_type_t)0x90u, "[ERROR] BRCRTCReporter Failed to start%@", (uint8_t *)&v2, 0xCu);
}
