...
- (BRCPackageManifestWriter)initWithZone:(id)a3 stageID:(id)a4 url:(id)a5
{
  ...
  if (v12)
  {
    ...
    uint64_t v14 = [MEMORY[0x1E4F1CAA8] outputStreamWithURL:v11 append:0];
    stream = v13->_stream;
    v13->_stream = (NSOutputStream *)v14;

    [(NSOutputStream *)v13->_stream open];
    uint64_t v16 = [objc_alloc(MEMORY[0x1E4F940A8]) initWithOutputStream:v13->_stream];
    writer = v13->_writer;
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, (os_log_type_t)0x90u))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v17 = 2112;
      v18 = v10;
      _os_log_error_impl(&dword_1D353B000, v11, (os_log_type_t)0x90u, "[ERROR] Failed setting quarantine info for item %@: %@%@", buf, 0x20u);
    }
  }
}
...
- (void)_applyDirectoryMetadataWithManifestItem:(id)a3 packageRootFD:(int)a4
{
  ...
  if ((v14 & 0x80000000) != 0)
  {
    ...
    if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
    {
      ...
      __int16 v23 = 2112;
      v24 = v17;
      _os_log_error_impl(&dword_1D353B000, v18, (os_log_type_t)0x90u, "[ERROR] Failed to open pkg item at %@ %{errno}d%@", (uint8_t *)&v19, 0x1Cu);
    }
  ...
  {
    int v15 = v14;
    [(BRCPackageManifestWriter *)self _applyQuarantineMetadataWithManifestItem:v6 isDocumentModifiedByOtherUser:0 fd:v14];
    close(v15);
  }
}
...
- (void)_applyFileMetadataWithManifestItem:(id)a3 isDocumentModifiedByOtherUser:(BOOL)a4 packageRootFD:(int)a5
{
  ...
  id v8 = a3;
  long long v29 = xmmword_1D38876C0;
  uint64_t v30 = 0;
  int v28 = 0;
  uint64_t v9 = [v8 path];
    ...
    if ((v17 & 0x80000000) != 0)
    {
      ...
      if (os_log_type_enabled(v26, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v35 = 2112;
        v36 = v25;
        _os_log_error_impl(&dword_1D353B000, v26, (os_log_type_t)0x90u, "[ERROR] openat failed to apply metadata for manifest item %@ %{errno}d%@", buf, 0x1Cu);
      }
      ...
      if (BRCFSetAttrList(v18, &v29, &v28, 4uLL))
      {
        ...
        if (os_log_type_enabled(v21, (os_log_type_t)0x90u))
        {
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v35 = 2112;
          v36 = v20;
          _os_log_error_impl(&dword_1D353B000, v21, (os_log_type_t)0x90u, "[ERROR] fsetattrlist failed for pkg item %@ %{errno}d%@", buf, 0x1Cu);
        }
...
- (BOOL)_stageExistingPackageItem:(id)a3 withLiveFd:(int)a4 stageFd:(int)a5 isDocumentModifiedByOtherUser:(BOOL)a6
{
  ...
  {
    uint64_t v18 = v12;
    int v19 = BRCOpenAt(v8, v12, 33028, v13, v14, v15, v16, v17, v50);
    if (v19 < 0)
    {
      int v22 = *__error();
    ...
    if (v21)
    {
      ...
      if (os_log_type_enabled(v24, (os_log_type_t)0x90u))
      {
        ...
        *(void *)&v53[16] = v23;
        ...
        v26 = buf;
LABEL_27:
        _os_log_error_impl(&dword_1D353B000, v24, (os_log_type_t)0x90u, v25, v26, 0x1Cu);
        goto LABEL_11;
      }
      goto LABEL_11;
    }
    BOOL v51 = v6;
    BOOL v31 = [(BRCPackageManifestWriter *)self _packageItem:v10 matchesMode:v58.st_mode];
    id v32 = [(BRCClientZone *)self->_clientZone session];
    __int16 v33 = [v32 volume];
    int v34 = [v33 hasCloning];
...
LABEL_35:
          _os_log_error_impl(&dword_1D353B000, v37, (os_log_type_t)0x90u, v38, buf, 0x32u);
          goto LABEL_20;
        }
        goto LABEL_20;
      }
...
LABEL_20:
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v53[18] = 2112;
        *(void *)&v53[20] = v46;
        _os_log_debug_impl(&dword_1D353B000, v47, OS_LOG_TYPE_DEBUG, "[DEBUG] hardlinked at %@ for package staged in %@%@", buf, 0x20u);
      }
...
LABEL_31:
    ...
    v39 = [(BRCClientZone *)self->_clientZone session];
    v40 = [v39 stageRegistry];
    int v41 = [v40 copyPackageFileWithPackageFd:v8 toStageFd:v7 relpath:v11];
...
LABEL_25:
        ...
        [(BRCPackageManifestWriter *)self _applyFileMetadataWithManifestItem:v10 isDocumentModifiedByOtherUser:v51 packageRootFD:v7];
        goto LABEL_31;
      }
      v44 = self->_stageID;
      *(_DWORD *)buf = 138412802;
...
LABEL_33:
      _os_log_debug_impl(&dword_1D353B000, v43, OS_LOG_TYPE_DEBUG, v45, buf, 0x20u);
      goto LABEL_25;
    }
  }
  BOOL v29 = 0;
...
LABEL_62:
      ...
      unint64_t v167 = v27;
      BOOL v29 = [MEMORY[0x1E4F28CB8] defaultManager];
      id v186 = v28;
      ...
      id v159 = v18;
      BOOL v31 = (const char *)[v159 fileSystemRepresentation];
...
LABEL_12:
            ...
            while (1)
            {
              ...
              uint64_t v181 = 512;
              long long v180 = xmmword_1D38876D8;
              uint64_t v178 = 0;
              uint64_t v179 = 0;
              uint64_t v177 = 0;
              if ([v45 type] == 4)
              {
                if (v166 >= v167)
                {
                  ...
                  if (os_log_type_enabled(v102, OS_LOG_TYPE_FAULT))
                  {
                    ...
                    *(_WORD *)&v192[18] = 2112;
                    *(void *)&v192[20] = v101;
                    _os_log_fault_impl(&dword_1D353B000, v102, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Package has been corrupted on the serverAsking for asset index out of bounds %lu vs %lu in package: %@%@", buf, 0x2Au);
                  }

                  uint64_t v103 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Package has been corrupted on the serverAsking for asset index out of bounds %lu vs %lu in package: %@", v166, v167, v16);
              ...
              else
              {
                ...
                if (!getattrlistat(v43, v47, &v180, &v177, 0x18uLL, 0x21uLL))
                {
                  ...
                  if (os_log_type_enabled(v108, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_WORD *)&v192[8] = 2112;
                    *(void *)&v192[10] = v107;
                    _os_log_debug_impl(&dword_1D353B000, v108, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ already exists in stage for package %@%@", buf, 0x20u);
                  }
                ...
                switch(v49)
                {
                  case 3:
                    ...
                    if (v52 < 0)
                    {
                      ...
                      if (*__error() != 17)
                      {
                        uint64_t v137 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorFromErrno");
                        ...
                        if (os_log_type_enabled(v139, (os_log_type_t)0x90u))
                        {
                          ...
                          *(_WORD *)&v192[18] = 2112;
                          *(void *)&v192[20] = v138;
                          _os_log_error_impl(&dword_1D353B000, v139, (os_log_type_t)0x90u, "[ERROR] Failed to create symlink %@ -> %@ for package %@%@", buf, 0x2Au);
                        }
LABEL_136:
                  ...
                  case 2:
                    if (v166 >= v167)
                    {
                      ...
                      if (os_log_type_enabled(v127, OS_LOG_TYPE_FAULT))
                      {
                        ...
                        *(_WORD *)&v192[18] = 2112;
                        *(void *)&v192[20] = v126;
                        _os_log_fault_impl(&dword_1D353B000, v127, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Package has been corrupted in the cloudAsking for asset index out of bounds %lu vs %lu in package: %@%@", buf, 0x2Au);
                      }

                      uint64_t v128 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Package has been corrupted in the cloudAsking for asset index out of bounds %lu vs %lu in package: %@", v166, v167, v16);
                    ...
                    if (!v53)
                    {
                      ...
                      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Can't find item at index %ld", v166, v151);
                    ...
                    if (v55)
                    {
                      if (BRCRenameAt(-1, v55, v170, v161, 0))
                      {
                        ...
                        if (os_log_type_enabled(v135, (os_log_type_t)0x90u))
                        {
                          ...
                          *(_WORD *)&v192[20] = 2112;
                          *(void *)&v192[22] = v134;
                          _os_log_error_impl(&dword_1D353B000, v135, (os_log_type_t)0x90u, "[ERROR] renameat(-1, %@, %d, %@) %{errno}d%@", buf, 0x2Cu);
                        }
...
LABEL_146:
                      ...
                      if (os_log_type_enabled(v57, OS_LOG_TYPE_DEBUG))
                      {
                        ...
                        *(_WORD *)&v192[18] = 2112;
                        *(void *)&v192[20] = v56;
                        _os_log_debug_impl(&dword_1D353B000, v57, OS_LOG_TYPE_DEBUG, "[DEBUG] staged from %@ to %@ in %@%@", buf, 0x2Au);
                      }
                  ...
                  case 1:
                    if (mkdirat(v43, v165, v152) && *__error() != 17)
                    {
                      ...
                      if (os_log_type_enabled(v132, (os_log_type_t)0x90u))
                      {
                        ...
                        *(_WORD *)&v192[8] = 2112;
                        *(void *)&v192[10] = v138;
                        _os_log_error_impl(&dword_1D353B000, v132, (os_log_type_t)0x90u, "[ERROR] Failed to mkdir %@ for package %@%@", buf, 0x20u);
                      }
                ...
                if ([v48 hasXattrIndex])
                {
                    ...
                    || (uint64_t v58 = [v48 xattrIndex], v58 >= objc_msgSend(v172, "itemCount")))
                  {
                    ...
                    if (os_log_type_enabled(v110, OS_LOG_TYPE_FAULT))
                    {
                      ...
                      *(_WORD *)&v192[8] = 2112;
                      *(void *)&v192[10] = v109;
                      _os_log_fault_impl(&dword_1D353B000, v110, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: xattr index is out of bounds %ld of total %ld%@", buf, 0x20u);
                    }

                    objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: xattr index is out of bounds %ld of total %ld", objc_msgSend(v164, "xattrIndex"), objc_msgSend(v172, "itemCount"));
                    goto LABEL_104;
                  }
                  uint64_t v59 = objc_msgSend(v172, "itemAtIndex:", objc_msgSend(v48, "xattrIndex"));
                  if (!v59)
                  {
                    ...
                    objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Can't find xattr at index %ld", objc_msgSend(v164, "xattrIndex"), v151);
                    goto LABEL_104;
                  }
                  v60 = v59;
                  v61 = (void *)MEMORY[0x1E4F1C9B8];
                  v62 = [v59 fileURL];
                  id v176 = v24;
                  ...
                  if (!v157 || v63)
                  {
                    ...
                    if (!v63)
                    {
                      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F592A8], 15, @"Can't load xattr");
                  ...
                  if (!v75)
                  {
                    ...
                    if (os_log_type_enabled(v124, (os_log_type_t)0x90u))
                    {
                      *(_DWORD *)buf = 138412546;
                      ...
                      __int16 v191 = 2112;
                      *(void *)v192 = v123;
                      _os_log_error_impl(&dword_1D353B000, v124, (os_log_type_t)0x90u, "[ERROR] Failed to apply xattrs to file descriptor: %@%@", buf, 0x16u);
                    }
...
LABEL_65:
                    if (!*p_error)
                    {
                      ...
                      {
                        objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithPOSIXCode:description:", 22, @"unknown error");
                  ...
                  if (os_log_type_enabled(v76, OS_LOG_TYPE_DEBUG))
                  {
                    ...
                    *(_WORD *)&v192[8] = 2112;
                    *(void *)&v192[10] = v154;
                    _os_log_debug_impl(&dword_1D353B000, v76, OS_LOG_TYPE_DEBUG, "[DEBUG] Successfully applied xattrs %@ to package item %@%@", buf, 0x20u);
                ...
                if (getattrlistat(v43, v165, &v180, &v177, 0x18uLL, 0x21uLL))
                {
                  ...
                  if (os_log_type_enabled(v113, (os_log_type_t)0x90u))
                  {
                    ...
                    *(_WORD *)&v192[14] = 2112;
                    *(void *)&v192[16] = v112;
                    _os_log_error_impl(&dword_1D353B000, v113, (os_log_type_t)0x90u, "[ERROR] unable to stat %@ for package %@ %{errno}d%@", buf, 0x26u);
                  }
...
LABEL_78:
          ...
          if (os_log_type_enabled(v98, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&v192[18] = 2112;
            *(void *)&v192[20] = v97;
            _os_log_debug_impl(&dword_1D353B000, v98, OS_LOG_TYPE_DEBUG, "[DEBUG] Finished staging package for %@. Item count:%lu.  Asset index:%lu%@", buf, 0x2Au);
          }
        ...
        uint64_t v94 = *MEMORY[0x1E4F59368];
        id v95 = [v159 path];
...
LABEL_64:
      ...
      uint64_t v90 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithPOSIXCode:", *__error());
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Adding %@ to the manifest%@");
}

- (void)_applyFileMetadataWithManifestItem:isDocumentModifiedByOtherUser:packageRootFD:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Invalid args in %@%@");
}

- (void)_stageExistingPackageItem:withLiveFd:stageFd:isDocumentModifiedByOtherUser:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: we should have downloaded this file if there is nothing live%@", v2, v3, v4, v5, v6);
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.1()
{
  ...
  OUTLINED_FUNCTION_5(&dword_1D353B000, v2, v3, "[CRIT] UNREACHABLE: No reader to stage package at %s%@", v4, v5, v6, v7, v8);
}

- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: relpath should always exist%@", v2, v3, v4, v5, v6);
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.3()
{
  ...
  __int16 v4 = 2112;
  uint64_t v5 = v1;
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid item type: %d%@", (uint8_t *)v3, 0x12u);
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.4()
{
  ...
  [v0 xattrIndex];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5(&dword_1D353B000, v1, v2, "[CRIT] UNREACHABLE: Can't find xattr at index %ld%@", v3, v4, v5, v6, v7);
}

- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.5()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Failed to read xattrs blob: %@%@");
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.6()
{
  ...
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Unable to add item to manifest: %@%@");
}
...
- (void)stagePackageWithReader:(NSObject *)a3 package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.7(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a1;
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, a2, a3, "[CRIT] UNREACHABLE: Can't find item at index %ld%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}
...
- (void)stagePackageWithReader:package:xattrsPackage:stageItemURL:livefd:recordName:isDocumentModifiedByOtherUser:.cold.8()
{
  ...
  [v1 UTF8String];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5(&dword_1D353B000, v2, v3, "[CRIT] UNREACHABLE: We didn't fetch the corresponding pkg item from the server, but we were also not given a path to hardlink it from! (item: %s)%@", v4, v5, v6, v7, v8);
}
