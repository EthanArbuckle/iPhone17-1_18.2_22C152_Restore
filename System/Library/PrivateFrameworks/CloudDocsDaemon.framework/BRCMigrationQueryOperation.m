...
- (BRCMigrationQueryOperation)initWithServerZone:(id)a3 migrationKey:(id)a4 continuationCursor:(id)a5 sessionContext:(id)a6
{
  ...
  if (v16)
  {
    ...
    v19 = objc_msgSend(MEMORY[0x1E4F1A218], "br_osUpgradeMigration");
...
- (BOOL)_saveFetchedRecords:(id)a3 cursor:(id)a4 error:(id *)a5
{
  ...
  uint64_t v41 = 0;
  id v12 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA80]), "initWithObjects:", self->super._serverZone, 0);
  id v13 = [v10 serverDB];
  ...
  {
    objc_super v21 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorSyncBlocked");
    if (v21)
    {
      ...
      if (os_log_type_enabled(v23, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 136315906;
        ...
        __int16 v48 = 2112;
        v49 = v22;
        _os_log_error_impl(&dword_1D353B000, v23, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
      }
    }
    if (a5) {
...
- (BOOL)_updatedContinuationCursor:(id)a3 fetchedRecords:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v41 = 2112;
    v42 = v13;
    _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] share-query progressed from cursor:%@ to cursor:%@%@", buf, 0x20u);
  }
  if ([(NSMutableArray *)self->_shareIDsToFetch count])
  {
    uint64_t v15 = (void *)[objc_alloc(MEMORY[0x1E4F1A0A8]) initWithRecordIDs:self->_shareIDsToFetch];
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, (os_log_type_t)0x90u))
    {
      ...
      *(void *)&obj[4] = "-[BRCMigrationQueryOperation _updatedContinuationCursor:fetchedRecords:error:]_block_invoke_2";
      ...
      __int16 v26 = 2112;
      long long v27 = v9;
      _os_log_error_impl(&dword_1D353B000, v10, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", obj, 0x2Au);
    }
...
- (void)_performQuery:(id)a3 recordFetchedBlock:(id)a4 cursorUpdatedBlock:(id)a5 desiredKeys:(id)a6 completion:(id)a7
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    WORD2(v49[0]) = 2112;
    *(void *)((char *)v49 + 6) = v17;
    _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx query for %@ starting with batchSize:%u%@", buf, 0x26u);
  }
  if (self->_continuationCursor)
  {
    uint64_t v19 = (void *)[objc_alloc(MEMORY[0x1E4F1A2B8]) initWithCursor:self->_continuationCursor];
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v48 = 2112;
      v49[0] = v20;
      _os_log_debug_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] created query %@ from cursor:%@%@", buf, 0x20u);
    }
  }
  else
  {
    uint64_t v19 = (void *)[objc_alloc(MEMORY[0x1E4F1A2B8]) initWithQuery:v34];
    uint64_t v20 = brc_bread_crumbs();
    objc_super v21 = brc_default_log();
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v48 = 2112;
      v49[0] = v20;
      _os_log_debug_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] created query %@ from query:%@%@", buf, 0x20u);
    }
  }
...
void __105__BRCMigrationQueryOperation__performQuery_recordFetchedBlock_cursorUpdatedBlock_desiredKeys_completion___block_invoke_2(void *a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx handling result of %@: %@%@", buf, 0x2Au);
  }
...
{
  id v4 = a3;
  uint64_t v5 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"%K == %@", @"brPrefix", @"shareAlias/"];
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F1A2A0]) initWithRecordType:@"RecordPrefixList" predicate:v5];
  v24[0] = 0;
  v24[1] = v24;
  v24[2] = 0x3032000000;
  ...
  id v8 = v7;
  id v23 = v8;
  id v9 = (void *)MEMORY[0x1D94389C0](v22);
  ...
  id v20 = v10;
  uint64_t v21 = v24;
  long long v11 = (void *)MEMORY[0x1D94389C0](v19);
  id v12 = [MEMORY[0x1E4F1A2D8] desiredKeysWithMask:185];
...
void __81__BRCMigrationQueryOperation__performAfterQueryingForShareAliasesWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v18 = 2112;
    __int16 v19 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] fetched share alias record %@ with etag:%@ in query %@%@", (uint8_t *)&v12, 0x2Au);
  }
...
- (void)_performAfterQueryingForShareIDsOfFolders:(BOOL)a3 completion:(id)a4
{
  BOOL v4 = a3;
  id v6 = a4;
  uint64_t v7 = objc_msgSend(MEMORY[0x1E4F28F60], "predicateWithFormat:", @"%K != NULL", *MEMORY[0x1E4F19D60]);
  id v8 = objc_alloc(MEMORY[0x1E4F1A2A0]);
  ...
  v27[1] = v27;
  v27[2] = 0x3032000000;
  v27[3] = __Block_byref_object_copy__29;
  v27[4] = __Block_byref_object_dispose__29;
  id v28 = 0;
  ...
  id v12 = v11;
  id v26 = v12;
  id v13 = (void *)MEMORY[0x1D94389C0](v25);
  v22[0] = MEMORY[0x1E4F143A8];
  v22[1] = 3221225472;
  ...
  id v23 = v14;
  id v24 = v27;
  __int16 v15 = (void *)MEMORY[0x1D94389C0](v22);
  ...
  id v17 = v6;
  id v20 = v17;
  [(BRCMigrationQueryOperation *)self _performQuery:v10 recordFetchedBlock:v13 cursorUpdatedBlock:v15 desiredKeys:MEMORY[0x1E4F1CBF0] completion:v18];
...
void __83__BRCMigrationQueryOperation__performAfterQueryingForShareIDsOfFolders_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v26 = 2112;
      uint64_t v27 = v10;
      _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] fetched shared record %@ with etag:%@ in query %@%@", (uint8_t *)&v20, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v14;
      _os_log_fault_impl(&dword_1D353B000, v15, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unable to parse itemID from %@ in query %@%@", (uint8_t *)&v20, 0x20u);
    }
  }
}
...
- (void)main
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_fault_impl(&dword_1D353B000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unknown migration %s%@", buf, 0x16u);
}
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v25 = 2112;
    __int16 v26 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx migration-query '%@' %@ completed%@", buf, 0x2Au);
  }
  if (v7)
  {
