...
- (void)_reportRecords:(id)a3 requestID:(unint64_t)a4
{
  id v6 = a3;
  v21 = (void *)a4;
  v7 = (void *)[objc_alloc(MEMORY[0x1E4F1A198]) initWithRecordsToSave:v6 recordIDsToDelete:0];
  v8 = [MEMORY[0x1E4F1C9B8] dataWithBytes:&v21 length:8];
  ...
  uint64_t v10 = *MEMORY[0x1E4F59480];
  ...
  if (objc_msgSend(v9, "brc_isCloudKitErrorImplyingZoneNeedsCreation"))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&location[4] = WeakRetained;
      ...
      __int16 v25 = 2112;
      v26 = v11;
      _os_log_debug_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] We need to create the zone health zone on %@ - %@%@", location, 0x20u);
    }

    uint64_t v13 = objc_msgSend(MEMORY[0x1E4F1A320], "brc_zoneHealthZoneID");
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
      {
        ...
        *(void *)&location[4] = WeakRetained;
        ...
        __int16 v25 = 2112;
        v26 = v17;
        _os_log_error_impl(&dword_1D353B000, v18, (os_log_type_t)0x90u, "[ERROR] Failed reporting zone health on %@ - %@%@", location, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(void *)&location[4] = v7;
        ...
        __int16 v25 = 2112;
        v26 = v17;
        _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] finished reporting zone health: %@, op: %@%@", location, 0x20u);
      }
    }
...
- (void)main
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1D353B000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] No zone health errors to report%@", (uint8_t *)&v2, 0xCu);
}
...
uint64_t __36__BRCZoneHealthReportOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if ([v4 needsSyncUp])
  {
    uint64_t v49 = a1;
    id v5 = [v3 serverZone];
    uint64_t v6 = objc_msgSend(MEMORY[0x1E4F1A320], "brc_zoneHealthZoneID");
    id v7 = NSString;
    ...
    v48 = (void *)v11;
    v50 = (void *)v6;
    uint64_t v15 = [objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:v11 zoneID:v6];
    v47 = (void *)v14;
    v16 = (void *)[objc_alloc(MEMORY[0x1E4F1A2D8]) initWithRecordType:@"zoneState" recordID:v14];
    v46 = (void *)v15;
    v17 = (void *)[objc_alloc(MEMORY[0x1E4F1A2D8]) initWithRecordType:@"zoneDetails" recordID:v15];
    ...
    if ((int)v14 <= (int)v9)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v61 = v19;
        _os_log_impl(&dword_1D353B000, v20, OS_LOG_TYPE_DEFAULT, "[WARNING] not updating zone health state because we think we are less broken than the server does%@", buf, 0xCu);
      }
    }
    else
    {
    ...
    [v16 setObject:&stru_1F2AC7720 forKeyedSubscript:@"clientInfo"];
    if (![v4 state])
    {
    ...
    id v26 = objc_alloc(MEMORY[0x1E4F1A320]);
    v53 = v3;
    uint64_t v27 = [v3 serverZone];
    v28 = [v27 zoneName];
    v29 = (void *)[v26 initWithZoneName:v28 ownerName:*MEMORY[0x1E4F19C08]];
    ...
    if (v32)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v33; ++i)
        {
          ...
          v36 = (void *)[objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:*(void *)(*((void *)&v54 + 1) + 8 * i) zoneID:v29];
          v37 = (void *)[objc_alloc(MEMORY[0x1E4F1A348]) initWithRecordID:v36 action:0];
          [v30 addObject:v37];
        }
    ...
    v58[0] = v17;
    v58[1] = v45;
    v41 = [MEMORY[0x1E4F1C978] arrayWithObjects:v58 count:2];
...
void __36__BRCZoneHealthReportOperation_main__block_invoke_2_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: report.state != BRCZoneHealthStateHealthy%@", (uint8_t *)&v2, 0xCu);
}
