...
- (BRCThumbnailGenerateOperation)initWithDocumentAtURL:(id)a3 targetURL:(id)a4 timeout:(id)a5 sessionContext:(id)a6
{
  ...
  if (v18)
  {
    v19 = objc_msgSend(MEMORY[0x1E4F1A218], "br_operationGroupWithName:", @"ThumbnailGenerate");
...
- (void)main
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _url && _targetURL%@", (uint8_t *)&v2, 0xCu);
}
...
void __37__BRCThumbnailGenerateOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 2112;
    v16 = v4;
    _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] Saved the thumbnail of %@ to %@ with error %@%@", (uint8_t *)&v9, 0x2Au);
  }
...
- (void)cancel
{
  if ([(_BRCOperation *)self timedOut])
  {
    ...
    uint64_t v7 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorThumbnailGenerationOperationTimedOut");
    [(BRCTapToRadarManager *)tapToRadarManager requestTapToRadarWithTitle:v5 description:@"Possible issue in QL, Thumbnail generation operation was running for too long" keywords:MEMORY[0x1E4F1CBF0] attachments:MEMORY[0x1E4F1CBF0] sendFullLog:0 displayReason:@"thumbnail generation encountered an error" triggerRootCause:v7];
  }
  uint64_t v8 = (void (**)(void, void))MEMORY[0x1D94389C0](self->_saveThumbnailCompletionBlock);
  if (v8)
  {
    int v9 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorOperationCancelled");
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  id saveThumbnailCompletionBlock = self->_saveThumbnailCompletionBlock;
  id v8 = a3;
  uint64_t v9 = MEMORY[0x1D94389C0](saveThumbnailCompletionBlock);
