...
- (BRCClientPrivilegesDescriptor)initWithAuditToken:(id *)a3
{
  ...
  if (v4)
  {
    ...
    *((void *)v5 + 4) = v8;
    ...
    v5[24] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59318], v14, v15);
    v5[25] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59320]);
    if (v5[18])
    {
      v5[17] = 1;
...
LABEL_10:
    ...
    v5[17] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59298]);
    if (v5[24])
    {
      v5[20] = 1;
    }
    ...
    {
      int v10 = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F592C8]);
      v5[20] = v10;
      if (!v10)
      {
        v5[21] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59350]);
        v5[23] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59348]);
        char v11 = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59328]);
        goto LABEL_9;
      }
    }
    char v11 = 1;
...
LABEL_9:
    v5[22] = v11;
    v5[27] = objc_msgSend(v7, "brc_BOOLeanValueForKey:", *MEMORY[0x1E4F59360]);
    goto LABEL_10;
  }
  return (BRCClientPrivilegesDescriptor *)v5;
}
  ...
  if ([v10 _isNonSandboxedForAuditToken:&v21])
  {
    ...
    if (v12)
    {
      ...
      *(_DWORD *)&v13->_isProxyEntitled = 16843009;
      [(id)*MEMORY[0x1E4F59320] UTF8String];
      id v15 = (void *)xpc_copy_entitlement_for_token();
      BOOL v16 = MEMORY[0x1D9439280]() == MEMORY[0x1E4F14570] && xpc_BOOL_get_value(v15);
      v13->_isBRCTL = v16;
...
- (void)pid
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: self.hasPid%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)auditToken
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _hasAuditToken%@", (uint8_t *)&v2, 0xCu);
}

- (void)_computeCloudEnabledStatusWithoutLogOutStatus
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] %@ is restricted from sync (TCC)%@");
}
