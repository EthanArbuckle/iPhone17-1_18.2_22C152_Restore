...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  __brc_create_section(0, (uint64_t)"-[BRCDaemon listener:shouldAcceptNewConnection:]", 962, v40);
  v8 = brc_bread_crumbs();
  v9 = brc_default_log();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v47 = 2112;
    v48 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx received new XPC connection: %@, for uid: %u%@", buf, 0x26u);
  }

  if (!self->_shouldRejectXPCCalls)
  {
    dispatch_sync((dispatch_queue_t)self->_xpcListenersReadyQueue, &__block_literal_global_123);
    v14 = +[BRCFileProviderDaemonUtils sharedInstance];
    [v14 boostFileProvider];

    dispatch_sync((dispatch_queue_t)self->_accountReadyQueue, &__block_literal_global_126);
    ...
    v10 = [(BRCClientPrivilegesDescriptor *)v17 initWithAuditToken:v39];
      ...
      if (!v19)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412290;
          ...
          _os_log_impl(&dword_1D353B000, v20, OS_LOG_TYPE_DEFAULT, "[WARNING] Denying xpc connection because the daemon is in the sync bubble%@", buf, 0xCu);
        }
        BOOL v13 = 0;
LABEL_25:
    ...
    v36[1] = 3221225472;
    v36[2] = __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_130;
    v36[3] = &unk_1E6995E90;
    id v38 = v7;
    v26 = v21;
    ...
    v32 = __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_2_136;
    v33 = &unk_1E6995EB8;
    v11 = v26;
    v34 = v11;
    id v35 = v7;
...
LABEL_6:
    _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, v12, buf, 0xCu);
  }
LABEL_7:
  BOOL v13 = 0;
LABEL_26:
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] We are running under bundle %@, not initializing signals because this is not bird daemon%@");
}

void __19__BRCDaemon_daemon__block_invoke()
{
  uint64_t v0 = objc_opt_new();
  os_log_t v1 = (void *)gDaemon;
  gDaemon = v0;
...
void __18__BRCDaemon_start__block_invoke(uint64_t a1)
{
  ...
  v9[1] = 3221225472;
  v9[2] = __18__BRCDaemon_start__block_invoke_90;
  v9[3] = &unk_1E6993698;
  v9[4] = *(void *)(a1 + 32);
  v2 = (void (**)(void))MEMORY[0x1D94389C0](v9);
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v11 = v5;
      _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] BYSetupAssistantNeedsToRun --> pausing daemon startup until done.%@", buf, 0xCu);
    }
  }
  else
  {
...
id __30__BRCDaemon__setupCacheDelete__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v29 = 2112;
    uint64_t v30 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cache delete requested us to compute purgeable space: (urgency: %d) %@%@", buf, 0x26u);
  }
  ...
  [v10 setObject:&unk_1F2B26E38 forKeyedSubscript:@"CACHE_DELETE_AMOUNT"];
  [v10 setObject:&unk_1F2B26E38 forKeyedSubscript:@"CACHE_DELETE_NONPURGEABLE_AMOUNT"];
  v11 = *(void **)(a1 + 32);
  v18[0] = MEMORY[0x1E4F143A8];
  v18[1] = 3221225472;
  v18[2] = __30__BRCDaemon__setupCacheDelete__block_invoke_36;
  v18[3] = &unk_1E6995CE0;
  int v21 = v9;
  id v12 = v10;
  id v19 = v12;
...
- (void)_setupCacheDelete
{
  ...
  {
    v9[9] = self;
    v9[10] = MEMORY[0x1E4F143A8];
    v9[11] = 3221225472;
    v9[12] = __30__BRCDaemon__setupCacheDelete__block_invoke;
    v9[13] = &unk_1E6995D08;
    v9[14] = self;
    void v9[5] = MEMORY[0x1E4F143A8];
    v9[6] = 3221225472;
    v9[7] = __30__BRCDaemon__setupCacheDelete__block_invoke_41;
    v9[8] = &unk_1E6995D08;
    CacheDeleteRegisterInfoCallbacks();
    v3 = +[BRCUserDefaults defaultsForMangledID:0];
    int v4 = [v3 cacheDeletePushXPCActivity];

    v9[0] = MEMORY[0x1E4F143A8];
    v9[1] = 3221225472;
    v9[2] = __30__BRCDaemon__setupCacheDelete__block_invoke_2_52;
    v9[3] = &unk_1E6995E18;
    v9[4] = self;
    id v5 = v4;
    v6 = v9;
    ...
    {
      uint64_t v8 = ((void (*)(void *))*MEMORY[0x1E4F59650])(v6);
...
- (void)_finishStartup
{
  ...
  *(void *)((char *)&v3 + 4) = *a1;
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] ┏%llx sending token change notification%@", (void)v3, DWORD2(v3));
}
...
- (id)currentSession
{
  return [(BRCDaemon *)self getCurrentSessionMustFinishedLoading:0];
}
...
- (void)performWithSessionForVolume:(id)a3 action:(id)a4
{
  ...
  if (lstat((const char *)[v7 fileSystemRepresentation], &v14) < 0)
  {
    ...
    if (os_log_type_enabled(v10, (os_log_type_t)0x90u)) {
      -[BRCDaemon performWithSessionForVolume:action:]((uint64_t)v7, (uint64_t)v9, v10);
    }
  }
  else
  {
...
- (BOOL)shouldRejectXPCCalls
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      int v6 = 138412290;
      id v7 = v3;
      _os_log_impl(&dword_1D353B000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] We are running as Root user. We should reject all XPC connections%@", (uint8_t *)&v6, 0xCu);
    }
  }
  return v2 == 0;
}
...
- (BRCDaemon)init
{
  ...
  uid_t v2 = [(BRCDaemon *)&v27 init];
  char v3 = v2;
  if (v2)
  {
    [(BRCDaemon *)v2 _initSignals];
    [(BRCDaemon *)v3 _setupVNodeRapidAging];
    int v4 = dispatch_queue_attr_make_with_qos_class(0, QOS_CLASS_UNSPECIFIED, 0);
    ...
    id v12 = dispatch_queue_attr_make_with_qos_class(0, QOS_CLASS_UNSPECIFIED, 0);
    stat v13 = dispatch_queue_attr_make_with_autorelease_frequency(v12, DISPATCH_AUTORELEASE_FREQUENCY_WORK_ITEM);
    ...
    id v16 = dispatch_queue_attr_make_with_qos_class(0, QOS_CLASS_UTILITY, 0);
    ...
    int v21 = dispatch_queue_attr_make_with_autorelease_frequency(v20, DISPATCH_AUTORELEASE_FREQUENCY_WORK_ITEM);
    ...
    uint64_t v24 = objc_alloc_init(BRCFPFSMigrationScheduler);
...
- (void)waitForConfiguration
{
  ...
  char v3 = [MEMORY[0x1E4F29290] serviceListener];
...
{
  BOOL v3 = a3;
  id v4 = [(BRCDaemon *)self currentAccountHandler];
  id v5 = v4;
  ...
  {
    dispatch_queue_t v6 = [v5 session];
  }
...
void __30__BRCDaemon__setupCacheDelete__block_invoke_36(uint64_t a1, void *a2)
{
  id v3 = a2;
  ...
  uint64_t v8 = [v7 nonPurgeableSizeWithPurgeableSize:v6];
  [*(id *)(a1 + 32) setObject:*(void *)(a1 + 40) forKeyedSubscript:@"CACHE_DELETE_VOLUME"];
  id v9 = [NSNumber numberWithLongLong:v6];
...
id __30__BRCDaemon__setupCacheDelete__block_invoke_41(uint64_t a1, int a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cache delete requested us to purge: (urgency: %d) %@%@", buf, 0x26u);
  }
  ...
  v18[0] = MEMORY[0x1E4F143A8];
  v18[1] = 3221225472;
  v18[2] = __30__BRCDaemon__setupCacheDelete__block_invoke_42;
  v18[3] = &unk_1E6995D58;
  int v22 = a2;
  id v11 = v5;
  id v19 = v11;
  ...
  id v13 = v6;
  id v21 = v13;
  [v10 performWithSessionForVolume:v13 action:v18];
  dispatch_queue_t v14 = brc_bread_crumbs();
  v15 = brc_default_log();
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
    __30__BRCDaemon__setupCacheDelete__block_invoke_41_cold_1();
  }
...
void __30__BRCDaemon__setupCacheDelete__block_invoke_42(uint64_t a1, void *a2)
{
  id v3 = a2;
  uint64_t v16 = 0;
  v17 = &v16;
  ...
  block[3] = &unk_1E6995D30;
  dispatch_queue_t v14 = &v16;
  id v6 = v3;
  id v13 = v6;
  int v15 = *(_DWORD *)(a1 + 56);
  dispatch_sync(v5, block);

  uint64_t v7 = [*(id *)(a1 + 32) objectForKeyedSubscript:@"CACHE_DELETE_AMOUNT"];
  uint64_t v8 = [v7 longLongValue];

  id v9 = [v6 diskReclaimer];
  uint64_t v10 = [v9 purgeSpace:v8 withUrgency:*((unsigned int *)v17 + 6)];

  [*(id *)(a1 + 40) setObject:*(void *)(a1 + 48) forKeyedSubscript:@"CACHE_DELETE_VOLUME"];
  id v11 = [NSNumber numberWithLongLong:v10];
  [*(id *)(a1 + 40) setObject:v11 forKeyedSubscript:@"CACHE_DELETE_AMOUNT"];
...
id __30__BRCDaemon__setupCacheDelete__block_invoke_2_46(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v18 = 2112;
    int v19 = v4;
    _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx cache delete requested us to periodically purge: %@%@", buf, 0x20u);
  }
  ...
  v11[0] = MEMORY[0x1E4F143A8];
  v11[1] = 3221225472;
  v11[2] = __30__BRCDaemon__setupCacheDelete__block_invoke_49;
  v11[3] = &unk_1E6995DA0;
  id v8 = v6;
  id v12 = v8;
...
void __30__BRCDaemon__setupCacheDelete__block_invoke_2_52(uint64_t a1, void *a2)
{
  ...
  if (xpc_activity_should_defer(v3))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)((char *)&buf + 4) = v4;
      _os_log_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to defer the state%@", (uint8_t *)&buf, 0xCu);
    }
  }
  memset(v13, 0, sizeof(v13));
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __30__BRCDaemon__setupCacheDelete__block_invoke_2_52_cold_1(v13);
  }
  ...
  if (!xpc_activity_set_state(v3, 4))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      LODWORD(buf) = 138412290;
      *(void *)((char *)&buf + 4) = v8;
      _os_log_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to set the xpc state to continue%@", (uint8_t *)&buf, 0xCu);
    }
  }
  ...
  *((void *)&buf + 1) = &buf;
  ...
  v12[1] = 3221225472;
  v12[2] = __30__BRCDaemon__setupCacheDelete__block_invoke_53;
  v12[3] = &unk_1E6995DF0;
  v12[4] = &buf;
...
void __30__BRCDaemon__setupCacheDelete__block_invoke_53(uint64_t a1, void *a2)
{
  id v3 = [a2 session];
  id v4 = v3;
  if (v3)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __30__BRCDaemon__setupCacheDelete__block_invoke_2_54;
    v6[3] = &unk_1E6995DC8;
...
void __30__BRCDaemon__setupCacheDelete__block_invoke_2_54(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u)) {
      __30__BRCDaemon__setupCacheDelete__block_invoke_2_54_cold_3();
    }
  ...
  {
    id v10 = [*(id *)(a1 + 32) volume];
    id v11 = [v10 mountPath];

    if (v11)
    {
      id v12 = [v6 objectForKeyedSubscript:&unk_1F2B26E50];
      uint64_t v13 = [v12 unsignedLongLongValue];

      dispatch_queue_t v14 = [*(id *)(a1 + 32) diskReclaimer];
      uint64_t v15 = [v14 nonPurgeableSizeWithPurgeableSize:v13];
      ...
      uint64_t v23[3] = v16;
      uint64_t v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v23 forKeys:v22 count:4];

      __int16 v18 = brc_bread_crumbs();
      int v19 = brc_default_log();
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG)) {
        __30__BRCDaemon__setupCacheDelete__block_invoke_2_54_cold_2();
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, (os_log_type_t)0x90u)) {
        __30__BRCDaemon__setupCacheDelete__block_invoke_2_54_cold_1();
      }
...
- (void)_setDoneXpcActivity:(id)a3 description:(id)a4
{
  ...
  if (!xpc_activity_set_state((xpc_activity_t)a3, 5))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v6;
      _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to set the xpc state to done for \"%@\"%@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (void)_dbgSleepIfRequested
{
  ...
  OUTLINED_FUNCTION_11_0(&dword_1D353B000, v1, v2, "[DEBUG] Start date expired: %@ (%f)%@", v3, v4, v5, v6, 2u);
}
...
- (void)_startXPCListeners
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)long long buf = 136315650;
    ...
    __int16 v32 = 2112;
    *(void *)v33 = v3;
    _os_log_impl(&dword_1D353B000, v4, OS_LOG_TYPE_DEFAULT, "[NOTICE] starting bird in %s mode%s%@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v19 = NSHomeDirectory();
    uint64_t v20 = objc_msgSend(v19, "br_realpath");
    id v21 = +[BRCAccountsManager sharedManager];
    ...
    *(_DWORD *)&v33[6] = v16;
    ...
    __int16 v42 = 2112;
    __int16 v43 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Starting up, welcome, bundle:%@, pid:%d, uid:%d, os:%@, version:%@, home:\"%@\", in sync bubble:%@%@", buf, 0x54u);
  }
  [(BRCDaemon *)self _dbgSleepIfRequested];
  if (!self->_unitTestMode)
  {
    id v9 = objc_alloc(MEMORY[0x1E4F29290]);
    __int16 v10 = (NSXPCListener *)[v9 initWithMachServiceName:*MEMORY[0x1E4F59660]];
    xpcListener = self->_xpcListener;
    self->_xpcListener = v10;

    [(NSXPCListener *)self->_xpcListener setDelegate:self];
    id v12 = objc_alloc(MEMORY[0x1E4F29290]);
    uint64_t v13 = (NSXPCListener *)[v12 initWithMachServiceName:*MEMORY[0x1E4F59668]];
...
- (void)_startupAndLoadAccount
{
  ...
  *(void *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] using Cloud Database class: %@%@", (void)v3, DWORD2(v3));
}
...
- (void)start
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: qos_class_self() == QOS_CLASS_DEFAULT%@", v2, v3, v4, v5, v6);
}

void __18__BRCDaemon_start__block_invoke_90(uint64_t a1)
{
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          id v26 = v6;
          id v18 = [MEMORY[0x1E4F25D78] wrapperWithURL:v5 readonly:0 error:&v26];
          id v19 = v26;
...
- (void)registerWaiterBlock:(id)a3 forShareURL:(id)a4
{
  ...
  id v19 = (void *)MEMORY[0x1D94389C0](v6);
  [v18 addObject:v19];
  ...
  dispatch_source_t v21 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)v8->_accountResumedQueue);
  ...
  {
    long long v29 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v27);
  }
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)long long buf = 138412546;
            ...
            __int16 v37 = 2112;
            __int16 v38 = v9;
            _os_log_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] No accept operation found for key %@%@", buf, 0x16u);
          }
          ...
          if (v13)
          {
            ...
            do
            {
              for (uint64_t j = 0; j != v13; ++j)
              {
                ...
                uint64_t v17 = [MEMORY[0x1E4F28C58] errorWithDomain:v4 code:11 userInfo:0];
...
- (void)localeDidChange
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    int v4 = 138412290;
    id v5 = v2;
    _os_log_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEFAULT, "[NOTICE] Language changed, exiting%@", (uint8_t *)&v4, 0xCu);
  }

  exit(0);
}

uint64_t __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_130(uint64_t a1)
{
  [*(id *)(a1 + 40) invalidate];
  ...
  if (result)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT)) {
      __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_130_cold_1(v3, (uint64_t)v4, v5);
    }

    brc_append_system_info_to_message();
    uint64_t v6 = (const char *)[ objc_claimAutoreleasedReturnValue() UTF8String];
    __assert_rtn("-[BRCDaemon listener:shouldAcceptNewConnection:]_block_invoke", "/Library/Caches/com.apple.xbs/Sources/CloudDocs_plugins/core/shared/daemon/BRCDaemon.m", 1010, v6);
  }
  return result;
}

void __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_2_136(uint64_t a1)
{
  uint64_t v12 = *MEMORY[0x1E4F143B8];
  memset(v5, 0, sizeof(v5));
  __brc_create_section(0, (uint64_t)"-[BRCDaemon listener:shouldAcceptNewConnection:]_block_invoke_2", 1014, v5);
  uint64_t v2 = brc_bread_crumbs();
  uint64_t v3 = brc_default_log();
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)long long buf = 134218498;
    ...
    __int16 v10 = 2112;
    id v11 = v2;
    _os_log_debug_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Client %@ connection was invalidated%@", buf, 0x20u);
  }
...
- (BOOL)selfCheck:(__sFILE *)a3
{
  ...
  char v23 = 0;
  uint64_t v4 = [(BRCDaemon *)self currentSession];
  id v5 = [v4 clientDB];
  [v5 performWithFlags:17 action:&__block_literal_global_140];
  id v19 = 0;
  ...
  if (v6)
  {
    ...
    uint64_t v14 = __23__BRCDaemon_selfCheck___block_invoke_144;
    uint64_t v15 = &unk_1E6995F08;
    uint64_t v17 = &v20;
    id v16 = v4;
    uint64_t v18 = a3;
...
uint64_t __23__BRCDaemon_selfCheck___block_invoke_144(uint64_t a1, void *a2)
{
  id v3 = a2;
...
- (void)networkReachabilityChanged:(BOOL)a3
{
  ...
  if (v3) {
    dispatch_async((dispatch_queue_t)self->_startupQueue, &__block_literal_global_148);
  }
}
...
void __40__BRCDaemon_networkReachabilityChanged___block_invoke()
{
  ...
  [v0 enumerateAccountHandlerIfFinishedLoading:&__block_literal_global_150];
}

void __40__BRCDaemon_networkReachabilityChanged___block_invoke_2(uint64_t a1, void *a2)
{
  uint64_t v2 = [a2 session];
  BOOL v3 = [v2 clientTruthWorkloop];

  if (v3)
  {
    int v4 = [v2 clientTruthWorkloop];
    block[0] = MEMORY[0x1E4F143A8];
    block[1] = 3221225472;
...
{
  return [*(id *)(a1 + 32) enumerateAppLibraries:&__block_literal_global_153];
}

uint64_t __40__BRCDaemon_networkReachabilityChanged___block_invoke_4(uint64_t a1, void *a2)
{
  id v2 = a2;
  BOOL v3 = [v2 defaultClientZone];
...
- (void)handleExitSignal:(int)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v5;
    _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] starting exit sequence because of received signal (%s)%@", (uint8_t *)&v11, 0x16u);
  }
  ...
  [(BRCFPFSMigrationScheduler *)self->_fpfsMigrationScheduler removeSchedule];
  uint64_t v8 = (BRCDaemon *)[(BRCDaemon *)self exitWithCode:0];
  [(BRCDaemon *)v8 exitWithCode:v10];
}

- (void)exitWithCode:(int)a3
{
  uint64_t v13 = *MEMORY[0x1E4F143B8];
  int v4 = +[BRCAccountsManager sharedManager];
  v7[0] = MEMORY[0x1E4F143A8];
  v7[1] = 3221225472;
  v7[2] = __26__BRCDaemon_exitWithCode___block_invoke;
  v7[3] = &unk_1E6995DA0;
  id v8 = v4;
  [v8 enumerateAccountHandlers:v7];
  uint64_t v5 = brc_bread_crumbs();
  char v6 = brc_default_log();
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)long long buf = 67109378;
    ...
    __int16 v11 = 2112;
    BOOL v12 = v5;
    _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] exiting with code %d...%@", buf, 0x12u);
  }
...
void __26__BRCDaemon_exitWithCode___block_invoke(uint64_t a1, void *a2)
{
  ...
  char v6 = [v5 volume];
  id v7 = objc_msgSend(v3, "numberWithInt:", objc_msgSend(v6, "deviceID"));
  id v8 = [v2 versionsProviderForVolume:v7];
  [v8 suspend];
...
- (void)performWithSessionForVolume:(NSObject *)a3 action:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v12 = 2112;
  uint64_t v13 = a2;
  _os_log_error_impl(&dword_1D353B000, a3, (os_log_type_t)0x90u, "[ERROR] cannot retrieve device ID for '%@': %s%@", (uint8_t *)&v8, 0x20u);
}

void __30__BRCDaemon__setupCacheDelete__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] purgeable space is %@%@");
}

void __30__BRCDaemon__setupCacheDelete__block_invoke_41_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Purged space is %@%@");
}

void __30__BRCDaemon__setupCacheDelete__block_invoke_2_52_cold_1(void *a1)
{
  LODWORD(v3) = 134218242;
  *(void *)((char *)&v3 + 4) = *a1;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] ┏%llx pushing purgeable update to cache delete%@", (void)v3, DWORD2(v3));
}

void __30__BRCDaemon__setupCacheDelete__block_invoke_2_54_cold_1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_3_0();
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] Failed to get volume path%@", v1, 0xCu);
}

void __30__BRCDaemon__setupCacheDelete__block_invoke_2_54_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Purgeable info: %@ (not returned)%@");
}

void __30__BRCDaemon__setupCacheDelete__block_invoke_2_54_cold_3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_3_2();
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] welcome %@!%@");
}

void __48__BRCDaemon_listener_shouldAcceptNewConnection___block_invoke_130_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v8 = 2112;
  uint64_t v9 = a2;
  _os_log_fault_impl(&dword_1D353B000, a3, OS_LOG_TYPE_FAULT, "[CRIT] %@%@", (uint8_t *)&v6, 0x16u);
}
...
- (void)networkReachabilityChanged:.cold.1()
{
  ...
  OUTLINED_FUNCTION_6_1();
  OUTLINED_FUNCTION_11_0(&dword_1D353B000, v1, v2, "[DEBUG] sending server availability: %savailable (%@)%@", v3, v4, v5, v6, 2u);
}
