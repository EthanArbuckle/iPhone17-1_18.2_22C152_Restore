...
- (void)resumeAndAutoClose
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 8);
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] performer already registered for %@%@", (void)v3, DWORD2(v3));
}
...
- (void)perform
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_FAULT))
  {
    int v4 = 138412290;
    id v5 = v2;
    _os_log_fault_impl(&dword_1D353B000, v3, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: implemented by subclass%@", (uint8_t *)&v4, 0xCu);
  }
}
