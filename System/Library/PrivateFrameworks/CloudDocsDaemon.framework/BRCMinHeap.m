...
- (BRCMinHeap)initWithComparator:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = MEMORY[0x1D94389C0](v4);
...
{
  OUTLINED_FUNCTION_2(&dword_1D353B000, a2, a3, "[CRIT] Assertion failed: _getIndex(self, o) == nil%@", a5, a6, a7, a8, 2u);
}
...
{
  OUTLINED_FUNCTION_2(&dword_1D353B000, a2, a3, "[CRIT] Assertion failed: _array[index] == o%@", a5, a6, a7, a8, 2u);
}
