...
- (void)shareChangedDuringCheckWithSession:(id)a3
{
  ...
  {
    objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorItemChanged");
...
- (void)incrementErrorRetryCountWithSession:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v25 = 2112;
    v26 = v9;
    _os_log_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] Telemetry report at %@ finished with error %@ retry count %llu%@", buf, 0x2Au);
  }
  v15 = [v4 clientDB];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v27 = 2112;
      v28 = v20;
      _os_log_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Telemetry report at %@ did not run%@", buf, 0x16u);
    }
  }
...
+ (void)generateReportForSharedFolder:(id)a3 qualityOfService:(int64_t)a4 completionHandler:(id)a5
{
  ...
  id v9 = v8;
  id v10 = a3;
  uint64_t v11 = (void (**)(void, void, void))MEMORY[0x1D94389C0](v14);
  id v12 = [[BRCItemToPathLookup alloc] initWithItem:v10];
  id v13 = [(BRCItemToPathLookup *)v12 coordinatedReadURL];
  [(BRCItemToPathLookup *)v12 closePaths];
  ((void (**)(void, void *, id))v11)[2](v11, v13, v10);
}
  ...
  if (v14 && ![v6 containsPendingUploadOrSyncUp])
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v63 = 2112;
      v64 = v26;
      _os_log_debug_impl(&dword_1D353B000, v27, OS_LOG_TYPE_DEBUG, "[DEBUG] Telemetry - Server metrics found %@ items under %@%@", buf, 0x20u);
    }
    id v58 = 0;
    v28 = [MEMORY[0x1E4F25D78] wrapperWithURL:v5 readonly:1 error:&v58];
    id v29 = v58;
    id v30 = v58;
    if (v30)
    {
    ...
    else
    {
      ...
      v53[1] = 3221225472;
      v53[2] = __95__BRCItemCountMismatchReport_generateReportForSharedFolder_qualityOfService_completionHandler___block_invoke_646;
      v53[3] = &unk_1E69948C8;
      v32 = v9;
      ...
      v45[1] = 3221225472;
      v45[2] = __95__BRCItemCountMismatchReport_generateReportForSharedFolder_qualityOfService_completionHandler___block_invoke_647;
      v45[3] = &unk_1E69948F0;
      v35 = v32;
...
void __95__BRCItemCountMismatchReport_generateReportForSharedFolder_qualityOfService_completionHandler___block_invoke_646(uint64_t a1, void *a2)
{
  id v4 = a2;
  if (v4)
  {
...
void __95__BRCItemCountMismatchReport_generateReportForSharedFolder_qualityOfService_completionHandler___block_invoke_647(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    *(unsigned char *)(*(void *)(a1 + 32) + 26) = 1;
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v7;
      _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Telemetry - Disk checker found %@ items under %@%@", (uint8_t *)&v12, 0x20u);
    }
...
- (void)shareChangedDuringCheckWithSession:(uint64_t)a1 .cold.1(uint64_t a1)
{
  ...
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v2, (uint64_t)v2, "[DEBUG] The share changed while we were checking telemetry on %@ but we already reported an error%@", (uint8_t *)&v3);
}
...
void __70__BRCItemCountMismatchReport__finishReport_session_completionHandler___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, v4, "[DEBUG] Telemetry report at %@ succeeded%@", v5);
}
...
void __95__BRCItemCountMismatchReport_generateReportForSharedFolder_qualityOfService_completionHandler___block_invoke_cold_1()
{
  ...
  int v3 = objc_msgSend(v2, "fp_obfuscatedPath");
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, v4, "[DEBUG] Generating telemetry report at %@%@", v5);
}
