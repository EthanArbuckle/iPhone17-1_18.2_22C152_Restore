...
+ (id)brc_fetchShareIDWithSharedItem:()BRCShareIDAdditions
{
  ...
  if (([v3 sharingOptions] & 0x48) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v29 = v7;
      _os_log_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEFAULT, "[WARNING] No share options set on an item which is clearly shared%@", buf, 0xCu);
    }
  }
  id v9 = [v3 appLibrary];
  ...
  if (v20)
  {
    id v21 = objc_alloc(MEMORY[0x1E4F1A2F8]);
    v22 = [v3 serverZone];
    v23 = [v22 zoneID];
...
LABEL_5:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v18 = 2112;
    id v19 = v11;
    _os_log_impl(&dword_1D353B000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] No collaboration identifier can be computed yet for %@%@", buf, 0x16u);
  }
...
- (void)initShareIDWithItemID:()BRCShareIDAdditions zoneID:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: itemID %@ has no share name%@", v1, 0x16u);
}
...
+ (void)brc_fetchShareIDWithSharedItem:()BRCShareIDAdditions .cold.1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] Couldn't find root share for %@%@", v1, 0x16u);
}
