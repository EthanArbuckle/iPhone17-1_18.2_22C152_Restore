...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sharing/iWork-publishing", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  id v7 = (void *)[objc_alloc(MEMORY[0x1E4F1A1C0]) initWithRecordIDsToWebShare:v6 recordIDsToUnshare:v5];
...
void __35__BRCiWorkPublishingOperation_main__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v9)
  {
    ...
    if (*(unsigned char *)(v10 + 520) && !*(void *)(v10 + 528))
    {
      ...
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: No sharing info and no error");
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_2(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (!a4 || v9)
  {
    ...
    if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
    {
      ...
      __int16 v23 = 2112;
      char v24 = v15;
      _os_log_error_impl(&dword_1D353B000, v16, (os_log_type_t)0x90u, "[ERROR] Failed sharing %@ - %@%@", (uint8_t *)&v19, 0x20u);
    }
  }
  else
  {
...
void __35__BRCiWorkPublishingOperation_main__block_invoke_11(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_error_impl(&dword_1D353B000, v8, (os_log_type_t)0x90u, "[ERROR] Failed unsharing %@ - %@%@", (uint8_t *)&v15, 0x20u);
    }
  }
  else
  {
...
- (void)initWithDocumentItem:sessionContext:forPublish:readonly:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: item.st.iWorkShareable%@", v2, v3, v4, v5, v6);
}

void __35__BRCiWorkPublishingOperation_main__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: No sharing info and no error%@", v2, v3, v4, v5, v6);
}

void __35__BRCiWorkPublishingOperation_main__block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self->_forPublish%@", v2, v3, v4, v5, v6);
}

void __35__BRCiWorkPublishingOperation_main__block_invoke_2_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] %@ was shared%@");
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] %@ was unshared%@");
}
