...
- (void)_createCloudKitZoneWithGroup:(id)a3 completion:(id)a4
{
  ...
  if (!self->_createZoneOperation)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v29 = 2112;
      v30 = v8;
      _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx scheduling zone creation operation for %@%@", buf, 0x20u);
    }
    long long v22 = v20;
    uint64_t v23 = v21;
  ...
  id v13 = (void *)MEMORY[0x1D94389C0](v7);
...
void __64__BRCPrivateClientZone__createCloudKitZoneWithGroup_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v17 = 2112;
    long long v18 = v4;
    _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx finished zone creation with error: %@%@", buf, 0x20u);
  }

  WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  id v7 = WeakRetained[67];
...
void __64__BRCPrivateClientZone__createCloudKitZoneWithGroup_completion___block_invoke_5(uint64_t a1)
{
  ...
  v2 = (void *)[*(id *)(*(void *)(a1 + 32) + 544) copy];
  [*(id *)(*(void *)(a1 + 32) + 544) removeAllObjects];
  long long v12 = 0u;
  long long v13 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
...
- (void)resume
{
  ...
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Activation done%@", v1, 0xCu);
}
...
- (void)close
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_3_0();
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] zoneCreationOp finished%@", v1, 0xCu);
}

uint64_t __29__BRCPrivateClientZone_close__block_invoke(uint64_t a1)
{
  objc_storeStrong((id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40), *(id *)(*(void *)(a1 + 32) + 528));
...
uint64_t __57__BRCPrivateClientZone_reportProblemWithType_recordName___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    uint64_t v5 = *(void **)(v7 + 576);
    *(void *)(v7 + 576) = v6;
  }

  [*(id *)(*(void *)(a1 + 32) + 576) addProblemWithType:*(unsigned int *)(a1 + 48) recordName:*(void *)(a1 + 40)];
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v14 = 2112;
        uint64_t v15 = v8;
        _os_log_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] problem report for %@ wasn't acked%@", (uint8_t *)&v12, 0x16u);
      }
...
- (BOOL)resetFrequencyIsTooHigh
{
  ...
  if (!lastResets)
  {
    uint64_t v21 = [MEMORY[0x1E4F1CA48] arrayWithObject:v3];
...
LABEL_9:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v28 = 2112;
    __int16 v29 = v14;
    _os_log_impl(&dword_1D353B000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] Zone has resetted more than %lu times during the last %f seconds%@", (uint8_t *)&v24, 0x20u);
  }
  [(NSMutableArray *)self->_lastResets removeObjectAtIndex:0];
  BOOL v20 = 1;
LABEL_10:
...
- (void)syncedDownZoneHealthState:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v23 = 2112;
    int v24 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] zone-health changed for %@ previous %@ new %@%@", (uint8_t *)&v17, 0x2Au);
  }
      ...
      || (self->super._state & 0x10000) != 0)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          int v17 = 138412290;
          long long v18 = v14;
          _os_log_impl(&dword_1D353B000, v15, OS_LOG_TYPE_DEFAULT, "[WARNING] We had a problem and the zone is healthy again, resetting the zone%@", (uint8_t *)&v17, 0xCu);
        }
...
LABEL_20:
        _os_log_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEFAULT, v13, (uint8_t *)&v17, 0xCu);
      }
    }
  }
LABEL_5:
...
- (BOOL)recomputeAppSyncBlockState
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v33 = 2112;
    v34 = v9;
    _os_log_debug_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx recomputing app sync block state for %@%@", buf, 0x20u);
  }
  ...
  if ((v6 ^ v8))
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v33 = 2112;
      v34 = v16;
      _os_log_debug_impl(&dword_1D353B000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] sync remaining %s for %@%@", buf, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 136315650;
      ...
      __int16 v33 = 2112;
      v34 = v18;
      _os_log_debug_impl(&dword_1D353B000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] updating sync state to be %s for %@%@", buf, 0x20u);
    }
...
- (BOOL)dumpActivityToContext:(id)a3 includeExpensiveActivity:(BOOL)a4 error:(id *)a5
{
  ...
  if (v10)
  {
    ...
    if ([(NSMutableArray *)self->_faultsLiveBarriers count]) {
      objc_msgSend(v8, "writeLineWithFormat:", @"+ barriers:  %ld", -[NSMutableArray count](self->_faultsLiveBarriers, "count"));
    }
...
- (unsigned)pcsChainStateForItem:(id)a3
{
  ...
  if ([v4 isNonDesktopRoot])
  {
    ...
    unint64_t v7 = [(BRCAccountSession *)session appLibraryByRowID:v6];
...
- (id)unchainedItemInfoInServerTruthEnumeratorParentedTo:(id)a3
{
  ...
  char v8 = [MEMORY[0x1E4FBA8F8] formatInjection:@"AND NOT (item_type = 3 AND item_alias_target like '%%:\\_%%' ESCAPE '\\')"];
  }
  uint64_t v9 = [(BRCClientZone *)self db];
  uint64_t v10 = [(BRCClientZone *)self dbRowID];
    ...
    if ((v8 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v33 = 2112;
        v34 = v10;
        _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't parse unsalted bookmark data %@ - %@%@", buf, 0x20u);
      }
    }
    if (v28)
    {
  ...
  if ([v16 next])
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138413314;
      ...
      __int16 v37 = 2112;
      v38 = v19;
      _os_log_debug_impl(&dword_1D353B000, v20, OS_LOG_TYPE_DEBUG, "[DEBUG] Overriding structural and content info from (%@, %@) -> (%@, %@) because the item is OOB sync%@", buf, 0x34u);
    }
  }
  else
  {
...
- (id)resolveClashOfAlias:(id)a3 atPath:(id)a4 withAlias:(id)a5 atPath:(id)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134219266;
    ...
    __int16 v39 = 2112;
    v40 = v13;
    _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Resolving alias clash:\n alias1: %@\nrelpath1: %@\n\n alias2: %@\nrelpath2:%@%@", buf, 0x3Eu);
  }
  ...
  [v9 markDead];
  [v9 saveToDB];
  if (![v12 resolveMustExist:1 error:0])
  {
    [v10 resolveMustExist:1 error:0];
    brc_bread_crumbs();
    id v22 = (id)objc_claimAutoreleasedReturnValue();
    uint64_t v23 = brc_default_log();
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG)) {
      -[BRCPrivateClientZone(LegacyAdditions) resolveClashOfAlias:atPath:withAlias:atPath:]();
    }
  ...
  char v19 = v12;
  if ([v10 resolveMustExist:1 error:0])
  {
    ...
    v26[3] = &unk_1E6994A60;
    id v27 = v10;
    [v27 performOnOpenParentFileDescriptor:v26 error:0];
    id v22 = v27;
    char v19 = v12;
LABEL_15:
  }
...
- (void)signalFaultingWatchersWithError:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = self->_faultsLiveBarriers;
...
- (void)notifyClient:(id)a3 whenFaultingIsDone:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(BRCPQLConnection *)self->super._db serialQueue];
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
void __73__BRCPrivateClientZone_LegacyAdditions__notifyClient_whenFaultingIsDone___block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned char *)(v4 + 76))
  {
    ...
    if (!v5)
    {
      ...
      *(void *)(v7 + 552) = v6;
      ...
      uint64_t v5 = *(void **)(*(void *)(a1 + 40) + 552);
    }
    id v9 = (void *)MEMORY[0x1D94389C0](*(void *)(a1 + 48));
    [v5 addObject:v9];
  ...
  {
    id v10 = objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorLoggedOut");
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _defaultAppLibrary%@", v2, v3, v4, v5, v6);
}

- (void)setServerZone:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: [serverZone isKindOfClass:[BRCPrivateServerZone class]]%@", v2, v3, v4, v5, v6);
}
...
- (void)syncedDownZoneHealthRequestID:.cold.1()
{
  ...
  __int16 v3 = 2112;
  uint64_t v4 = v0;
  _os_log_debug_impl(&dword_1D353B000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] problem report for %@ completed%@", v2, 0x16u);
}
...
void __97__BRCPrivateClientZone_BRCPCSChainAdditions__unchainedItemInfoInServerTruthEnumeratorParentedTo___block_invoke_cold_1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Can't locate target server zone from bookmark data %@%@", v1, 0x16u);
}
...
void __73__BRCPrivateClientZone_LegacyAdditions__notifyClient_whenFaultingIsDone___block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a2;
  OUTLINED_FUNCTION_1(&dword_1D353B000, a2, a3, "[DEBUG] Queueing faults live barrier for %@%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}
