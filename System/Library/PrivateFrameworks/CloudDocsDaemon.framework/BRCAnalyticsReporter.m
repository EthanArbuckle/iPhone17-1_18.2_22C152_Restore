...
- (void)registerBackgroundXPCActivities
{
  ...
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] iCloud Analytics collection is disabled, unregistering xpc_activity%@", v2, v3, v4, v5, v6);
}
...
void __55__BRCAnalyticsReporter_registerBackgroundXPCActivities__block_invoke_28(uint64_t a1)
{
  ...
  if (!v7)
  {
    if (BRCEventKindUserDownload_block_invoke___personaOnceToken != -1) {
      dispatch_once(&BRCEventKindUserDownload_block_invoke___personaOnceToken, &__block_literal_global_8);
    }
    id v8 = (id)BRCEventKindUserDownload_block_invoke___personalPersona;
  }
  v9 = [MEMORY[0x1E4FB36F8] sharedManager];
...
LABEL_49:
  ...
  else
  {
    ...
    v12 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:22 userInfo:0];
  }
LABEL_11:
...
- (void)_waitForApplySchedulerToBeIdleWithCompletion:(id)a3
{
  ...
  id v7 = v4;
  id v18 = v7;
  id v8 = (void (**)(void, void))MEMORY[0x1D94389C0](v16);
  v9 = [(BRCAccountSession *)v6 applyScheduler];
  id v10 = [v9 hasActiveWorkGroup];
...
- (void)_handleApplySchedulerTimeoutWithActivity:(id)a3 telemetryEventType:(int)a4
{
  ...
  id v6 = self->_session;
  dispatch_time_t v7 = [(BRCAccountSession *)v6 cloudDocsClientZone];
  id v8 = [v7 rootItemID];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    uint64_t v26 = v10;
    _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Telemetry timed out waiting for the apply scheduler%@", buf, 0xCu);
  }

  v12 = [(BRCAccountSession *)v6 clientDB];
  ...
  if (v14 < v16)
  {
    v17 = [(BRCAccountSession *)v6 clientDB];
...
LABEL_14:
  uint64_t v23 = [(BRCAccountSession *)v6 clientDB];
...
- (void)_gatherAppTelemetryEventsWithActivity:(id)a3
{
  ...
  uint64_t v5 = self->_session;
  uint64_t v6 = [(BRCAccountSession *)v5 clientTruthWorkloop];
  if (!v6) {
    goto LABEL_7;
  }
  dispatch_time_t v7 = (void *)v6;
  id v8 = [(BRCAccountSession *)v5 applyScheduler];
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke(uint64_t a1, int a2)
{
  ...
  else
  {
    ...
    v31[1] = 3221225472;
    v31[2] = __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_51;
    v31[3] = &unk_1E6994120;
    id v32 = *(id *)(a1 + 32);
    ...
    if (v16)
    {
      if ([v16 isDirectory])
      {
        ...
        *(void *)(v18 + 64) = v17;
        ...
        v27[1] = 3221225472;
        v27[2] = __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_58;
        v27[3] = &unk_1E6994628;
        id v28 = v16;
...
id __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_51(uint64_t a1, void *a2, uint64_t a3)
{
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_58(uint64_t a1, void *a2)
{
  id v3 = a2;
  uint64_t v4 = v3;
  if (v3)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, (os_log_type_t)0x90u)) {
      __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_58_cold_1(a1);
    }
  }
}
...
- (void)_setupSyncConsistencyDeferralTimerWithActivity:(id)a3
{
  ...
  else
  {
    ...
    v9 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_queue);
    [v5 syncConsistencyXPCActivityDeferralCheckInterval];
    ...
    v18[1] = 3221225472;
    v18[2] = __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke_60;
    v18[3] = &unk_1E6993C50;
    ...
    {
      uint64_t v16 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v14);
...
void __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke(uint64_t a1)
{
  ...
  if (xpc_activity_should_defer(*(xpc_activity_t *)(a1 + 32)))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      int v8 = 138412290;
      v9 = v4;
      _os_log_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEFAULT, "[WARNING] Deferring the sync consistency checker%@", (uint8_t *)&v8, 0xCu);
    }
...
void __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke_60(uint64_t a1)
{
...
- (void)_setupSyncConsistencyCancellationTimerWithActivity:(id)a3 session:(id)a4
{
  ...
  else
  {
    ...
    id v14 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_queue);
    ...
    v23[1] = 3221225472;
    v23[2] = __83__BRCAnalyticsReporter__setupSyncConsistencyCancellationTimerWithActivity_session___block_invoke_63;
    v23[3] = &unk_1E6993C50;
    ...
    if (*MEMORY[0x1E4F59658])
    {
      uint64_t v20 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v18);
...
void __83__BRCAnalyticsReporter__setupSyncConsistencyCancellationTimerWithActivity_session___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    id v7 = v2;
    _os_log_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Cancelling the sync consistency checker because it timed out%@", (uint8_t *)&v6, 0xCu);
  }
...
void __83__BRCAnalyticsReporter__setupSyncConsistencyCancellationTimerWithActivity_session___block_invoke_63(uint64_t a1)
{
  WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  if (WeakRetained)
  {
...
- (BOOL)_resumePausedTreeConsistencyCheckOperationWithActivity:(id)a3
{
  ...
  v11[1] = 3221225472;
  v11[2] = __79__BRCAnalyticsReporter__resumePausedTreeConsistencyCheckOperationWithActivity___block_invoke_65;
  v11[3] = &unk_1E6994678;
  v11[4] = &v13;
...
void __79__BRCAnalyticsReporter__resumePausedTreeConsistencyCheckOperationWithActivity___block_invoke_65(uint64_t a1, void *a2)
{
}

- (BOOL)_shouldDeferForExistingSnapshot
{
  id v2 = [(BRCAccountSession *)self->_session volume];
  id v3 = [v2 mountPath];
...
void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke(uint64_t a1, int a2)
{
  ...
  else
  {
    ...
    block[0] = MEMORY[0x1E4F143A8];
    block[1] = 3221225472;
    block[2] = __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_66;
...
void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_66(uint64_t a1)
{
...
- (void)_reportSyncUpBackoffInfo
{
  ...
  long long v27 = 0u;
  long long v28 = 0u;
  id v2 = [(BRCAccountSession *)self->_session clientZones];
          ...
          if (v12 > v15)
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v33 = 2112;
              v34 = v16;
              _os_log_impl(&dword_1D353B000, v17, OS_LOG_TYPE_DEFAULT, "[WARNING] Client zone %@ has a sync up backoff ratio of %f which is too large%@", buf, 0x20u);
            }
          ...
          if (v14 > v18)
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v33 = 2112;
              v34 = v19;
              _os_log_impl(&dword_1D353B000, v20, OS_LOG_TYPE_DEFAULT, "[WARNING] Client zone %@ has a sync up backoff delay of %f which is too large%@", buf, 0x20u);
            }
      ...
      do
      {
        ...
        if ((v14 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = v19;
            long long v25 = v15;
            _os_log_fault_impl(&dword_1D353B000, v16, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: [metric.eventName isEqualToString:kind]%@", buf, 0xCu);
          }
        }
        ++v12;
      }
...
- (void)dumpToContext:(id)a3
{
  ...
  uint64_t v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v29 count:2];
  ...
  [v13 writeLineWithFormat:&stru_1F2AC7720];
  ...
  [v15 writeLineWithFormat:&stru_1F2AC7720];
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Failed to defer the activity for analytics%@", v2, v3, v4, v5, v6);
}

void __55__BRCAnalyticsReporter_registerBackgroundXPCActivities__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Reporting analytics metrics%@", v2, v3, v4, v5, v6);
}

- (void)_handleApplySchedulerTimeoutWithActivity:telemetryEventType:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Defering app telemetry gather for now%@", v2, v3, v4, v5, v6);
}

- (void)_handleApplySchedulerTimeoutWithActivity:telemetryEventType:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_13(&dword_1D353B000, v0, v1, "[ERROR] Failed to defer the app telemetry xpc activity%@", v2, v3, v4, v5, v6);
}

- (void)_handleApplySchedulerTimeoutWithActivity:telemetryEventType:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_13(&dword_1D353B000, v0, v1, "[ERROR] Failed to finish the app telemetry xpc activity%@", v2, v3, v4, v5, v6);
}

- (void)_gatherAppTelemetryEventsWithActivity:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Finishing app telemetry gather because the session logged out%@", v2, v3, v4, v5, v6);
}

- (void)_gatherAppTelemetryEventsWithActivity:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_13(&dword_1D353B000, v0, v1, "[ERROR] Failed to set the app telemetry xpc activity state to done%@", v2, v3, v4, v5, v6);
}

void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_13(&dword_1D353B000, v0, v1, "[ERROR] Failed to finish the app telemetry activity%@", v2, v3, v4, v5, v6);
}

void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: %@ should be a directory%@");
}
...
void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_cold_4(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(*(void *)a1 + 64);
  ...
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v1, v2, "[CRIT] UNREACHABLE: We are already checking telemetry on %@%@", (void)v3, DWORD2(v3));
}

void __62__BRCAnalyticsReporter__gatherAppTelemetryEventsWithActivity___block_invoke_58_cold_1(uint64_t a1)
{
  LODWORD(v3) = 138412546;
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 32);
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v1, v2, "[ERROR] Failed to generate a report for shared folder %@%@", (void)v3, DWORD2(v3));
}

- (void)_setupSyncConsistencyDeferralTimerWithActivity:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Already have a deferral timer registered%@", v2, v3, v4, v5, v6);
}

void __71__BRCAnalyticsReporter__setupSyncConsistencyDeferralTimerWithActivity___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Can't defer the sync consistency activity%@", v2, v3, v4, v5, v6);
}

- (void)_setupSyncConsistencyCancellationTimerWithActivity:session:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Already have a cancellation timer registered%@", v2, v3, v4, v5, v6);
}

- (void)_resumePausedTreeConsistencyCheckOperationWithActivity:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Successfully resumed existing tree consistency operation%@", v2, v3, v4, v5, v6);
}

- (void)_resumePausedTreeConsistencyCheckOperationWithActivity:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Failed resuming tree consistency operation%@", v2, v3, v4, v5, v6);
}

void __79__BRCAnalyticsReporter__resumePausedTreeConsistencyCheckOperationWithActivity___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] error connecting to telemetry-disk-checker xpc service: %@%@");
}

void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Failed to defer the xpc activity%@", v2, v3, v4, v5, v6);
}

void __58__BRCAnalyticsReporter__checkSyncConsistencyWithActivity___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Deferring activity because a snapshot already exists%@", v2, v3, v4, v5, v6);
}
...
void __66__BRCAnalyticsReporter_createFSEventToSyncUpEventForFileID_genID___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_11_0(&dword_1D353B000, v1, v2, "[DEBUG] analytics: creating %@ event for fileID %lld%@", v3, v4, v5, v6, 2u);
}
...
void __86__BRCAnalyticsReporter_createUserDownloadEventForOperationID_isRecursive_isForBackup___block_invoke_cold_1()
{
  ...
  uint64_t v4 = v0;
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v1, v2, "[DEBUG] analytics: creating %@ event%@", v3);
}
