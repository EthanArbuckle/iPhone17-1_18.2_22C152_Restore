...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync/zone-purge", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  id v9 = objc_alloc(MEMORY[0x1E4F1A180]);
  ...
  if ([v8 count])
  {
    v17 = (void *)[objc_alloc(MEMORY[0x1E4F1A180]) initWithRecordZonesToSave:0 recordZoneIDsToDelete:v8];
...
void __29__BRCZonePurgeOperation_main__block_invoke_2_cold_1()
{
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] deleted %@ on server%@");
}

void __29__BRCZonePurgeOperation_main__block_invoke_5_cold_1()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] deleted shared zones associated to %@ on server%@");
}
