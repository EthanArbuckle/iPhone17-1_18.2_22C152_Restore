...
- (uint64_t)getAndUpdateBoundaryKeyForItem:()BRCSerializationAdditions;
...
- (uint64_t)deserializeFilename:()BRCSerializationAdditions basename:bounceno:extension:userInfo:error:
{
  ...
  if ((v15 & 1) == 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v47);
      v25 = 0;
      id v24 = 0;
      id v26 = 0;
      v18 = 0;
    ...
    if (v18 && [(__CFString *)v18 integerValue] <= 1)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v50 = 2112;
        v51 = v39;
        _os_log_impl(&dword_1D353B000, v40, OS_LOG_TYPE_DEFAULT, "[WARNING] The server sent a bounceNo <= 1: %@%@", buf, 0x16u);
      }
    ...
    if (v15)
    {
      ...
      if (v18)
      {
        ...
        if ((v22 & 1) == 0)
        {
          ...
          {
            objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v102);
        ...
        if ([v11 count])
        {
          uint64_t v29 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F59368] code:1001 userInfo:v11];
          if (v29)
          {
...
LABEL_45:
        ...
        if ((v85 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            __int16 v107 = 2112;
            v108 = v43;
            _os_log_fault_impl(&dword_1D353B000, v44, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Aliases parent ref zoneID %@ must be equal to aliases zoneID %@!%@", buf, 0x20u);
          }
          v89 = (void *)MEMORY[0x1E4F28C58];
          uint64_t v45 = *MEMORY[0x1E4F59368];
          id v46 = [a1 recordID];
          id v47 = [v46 zoneID];
          v48 = [v14 recordID];
          v49 = [v48 zoneID];
        ...
        v41 = (void *)[objc_alloc(MEMORY[0x1E4F594E8]) initWithRecordZoneID:v38];
        v83 = v41;
        if ([v41 isPrivate])
        {
              ...
              if ((v71 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v74, OS_LOG_TYPE_DEFAULT))
                {
                  *(_DWORD *)buf = 138412546;
                  ...
                  __int16 v105 = 2112;
                  v106 = v73;
                  _os_log_impl(&dword_1D353B000, v74, OS_LOG_TYPE_DEFAULT, "[WARNING] can't deserialize filename: %@%@", buf, 0x16u);
                }
              }
...
- (BOOL)deserializeiWorkSharingOptions:()BRCSerializationAdditions error:
{
  ...
  id v20 = 0;
  uint64_t v8 = *MEMORY[0x1E4F19E00];
  char v9 = [a1 _deserializeValue:&v20 forKey:*MEMORY[0x1E4F19E00] encrypted:0 expectClass:objc_opt_class() allowNil:1 errorDescription:&v22];
  id v10 = v20;
  uint64_t v11 = v10;
  if ((v9 & 1) == 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v22);
  ...
  if ([v10 BOOLValue])
  {
    v21 |= 1uLL;
    id v19 = 0;
    uint64_t v12 = *MEMORY[0x1E4F19DF8];
    char v13 = [a1 _deserializeValue:&v19 forKey:*MEMORY[0x1E4F19DF8] encrypted:0 expectClass:objc_opt_class() allowNil:0 errorDescription:&v22];
    id v14 = v19;
    char v15 = v14;
    if (v13)
    {
...
- (uint64_t)deserializeStatInfo:()BRCSerializationAdditions serverMetrics:itemID:session:error:
{
  ...
  uint64_t v18 = *MEMORY[0x1E4F19C08];
  int v19 = [v17 isEqualToString:*MEMORY[0x1E4F19C08]];
    ...
    else
    {
      ...
      else
      {
        ...
        if ((v32 & 1) == 0)
        {
          ...
          if (v22)
          {
            objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v77);
  ...
  if ((v33 & 1) == 0)
  {
    ...
    {
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v224);
  ...
  if (BRCIsBusyDate([v37 longLongValue]))
  {
    ...
    if (os_log_type_enabled(v73, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      _os_log_impl(&dword_1D353B000, v73, OS_LOG_TYPE_DEFAULT, "[WARNING] Ignoring Finder busy date on %@%@", buf, 0x16u);
    }
LABEL_110:
...
LABEL_115:
    ...
    {
      v79 = v103;
      v104 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F59368] code:1001 userInfo:v14];
      if (v104)
      {
        ...
        if (os_log_type_enabled(v106, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          ...
          __int16 v231 = 2112;
          v232 = v105;
          _os_log_error_impl(&dword_1D353B000, v106, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
        }
      }
      v49 = v71;
      id v22 = v37;
...
LABEL_132:
      ...
      {
        id v131 = objc_alloc(MEMORY[0x1E4F594E8]);
        v132 = [a1 recordID];
        v133 = [v132 zoneID];
...
LABEL_163:
        ...
        v159 = [v203 serverDB];
        v160 = +[BRCAccountSession userIdentityForName:v154 db:v159];
        v161 = v160;
        if (v160) {
          v162 = v160;
        }
...
LABEL_187:
            ...
            v157 = v201;
LABEL_188:
            id v169 = objc_alloc_init(MEMORY[0x1E4F59540]);
...
LABEL_197:
    ...
    if (os_log_type_enabled(v116, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v231 = 2112;
      v232 = v115;
      _os_log_fault_impl(&dword_1D353B000, v116, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ parent ref zoneID %@ must be equal to record's zoneID %@!%@", buf, 0x2Au);

      v114 = v190;
    }

    v117 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v118 = *MEMORY[0x1E4F59368];
    v119 = [a1 recordID];
    v120 = [v119 zoneID];
    v121 = [v114 recordID];
    v122 = [v121 zoneID];
    ...
    if (v123)
    {
      ...
      if (os_log_type_enabled(v125, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 136315906;
        ...
        __int16 v231 = 2112;
        v232 = v124;
        _os_log_error_impl(&dword_1D353B000, v125, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
      }
    }
    id v22 = v37;
    if (v191) {
...
- (uint64_t)deserializeSymlinkTarget:()BRCSerializationAdditions error:
{
  ...
  if ((v6 & 1) == 0)
  {
    if (a4)
    {
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v15);
      *a4 = (id)objc_claimAutoreleasedReturnValue();
    }
    id v10 = v8;
    uint64_t v8 = 0;
...
- (uint64_t)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:
{
  ...
  if ((v15 & 1) == 0)
  {
    ...
    else
    {
      if (a8)
      {
        objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 1001, @"%@", v194);
        v30 = 0;
        uint64_t v31 = 0;
        char v32 = 0;
        char v33 = 0;
    ...
    if (v51)
    {
      ...
      if (v50
        && (objc_msgSend(v50, "brc_truncatedSHA256"),
            ...
            (v159 & 1) == 0))
      {
        objc_msgSend(MEMORY[0x1E4F1C9B8], "brc_generateBogusKey");
        *a5 = (id)objc_claimAutoreleasedReturnValue();
        v72 = brc_bread_crumbs();
        v73 = brc_default_log();
        if (os_log_type_enabled(v73, OS_LOG_TYPE_FAULT)) {
        ...
        id v74 = objc_alloc(MEMORY[0x1E4F594E8]);
        v156 = [a1 recordID];
        v75 = [v156 zoneID];
        ...
        if (!v170)
        {
          ...
          if (os_log_type_enabled(v80, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)buf = 136315394;
            ...
            __int16 v197 = 2112;
            char v198 = v79;
            _os_log_fault_impl(&dword_1D353B000, v80, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: The server should have set an mtime for %s%@", buf, 0x16u);
          }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v108, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138413314;
              ...
              __int16 v203 = 2112;
              v204 = v107;
              _os_log_impl(&dword_1D353B000, v108, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ record %@ has a size inconsistency, %llu != %llu%@", buf, 0x34u);
            }
...
LABEL_144:
        ...
        if ([v14 count])
        {
          v92 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F59368] code:1001 userInfo:v14];
          if (v92)
          {
            ...
            if (os_log_type_enabled(v94, (os_log_type_t)0x90u))
            {
              ...
              *(_DWORD *)buf = 136315906;
              ...
              _os_log_error_impl(&dword_1D353B000, v94, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
            }
          }
          if (a8) {
            *a8 = v92;
          ...
          if (os_log_type_enabled(v96, (os_log_type_t)0x90u))
          {
            *(_DWORD *)buf = 138412802;
            ...
            _os_log_error_impl(&dword_1D353B000, v96, (os_log_type_t)0x90u, "[ERROR] failed deserializing version in %@: %@%@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v120, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              _os_log_impl(&dword_1D353B000, v120, OS_LOG_TYPE_DEFAULT, "[WARNING] Server gave us an unrepresentable filename: \"%@\" using \"%@\"%@", buf, 0x20u);
            }
            id v34 = v171;
          }
          a8 = v168;
          ...
          if (v128)
          {
            id v129 = objc_alloc(MEMORY[0x1E4F1CAD0]);
...
- (uint64_t)locateSideCarServerZone:()BRCSerializationAdditions shareRecordName:withSession:
{
  ...
  if (v9)
  {
    ...
    *a4 = (void *)v14;
    ...
    {
      id v18 = objc_alloc(MEMORY[0x1E4F594E8]);
      id v19 = [v13 zoneID];
...
- (void)serializeSpecialIdentityForFilename:()BRCSerializationAdditions parentIDIsCloudDocsRoot:parentIDisDocumentsFolder:
{
  ...
  if (a4)
  {
    if ([v9 isEqualToString:*MEMORY[0x1E4F59430]])
    {
      id v8 = &unk_1F2B26EC8;
LABEL_11:
    ...
    if ([v9 isEqualToString:*MEMORY[0x1E4F59440]])
    {
      id v8 = &unk_1F2B26EE0;
      goto LABEL_11;
    }
    if ([v9 isEqualToString:*MEMORY[0x1E4F59468]])
    {
LABEL_10:
      id v8 = &unk_1F2B26EF8;
      goto LABEL_11;
    }
    if ([v9 isEqualToString:*MEMORY[0x1E4F59448]])
    {
      id v8 = &unk_1F2B26F10;
      goto LABEL_11;
    }
  }
  else if (a5 && [v9 isEqualToString:*MEMORY[0x1E4F59468]])
  {
    goto LABEL_10;
  }
LABEL_12:
...
- (void)serializeFilename:()BRCSerializationAdditions forCreation:setExtension:inSharedAlias:basehashSaltIfNotShareAlias:parentIDIsCloudDocsRoot:parentIDIsDocumentsFolder:
{
  ...
  if (v17)
  {
    ...
    if (v16)
    {
      char v23 = objc_msgSend(MEMORY[0x1E4F1C9B8], "brc_generateBogusKey");
      ...
      if (v24)
      {
        ...
        {
          int v27 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:1];
        }

        [v27 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:@"br_bougusSaltingKey"];
  ...
  if (v13 < 0)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v32 = 2112;
      char v33 = v21;
      _os_log_fault_impl(&dword_1D353B000, v22, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: %@ has negative value %@!%@", buf, 0x20u);
    }

    if (v27)
    {
      objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", v11, v10);
  ...
  if ((a4 & 0x100) != 0 || v120)
  {
    ...
    if (v79)
    {
      ...
      if (v80)
      {
        if (v113)
        {
          char v85 = objc_msgSend(MEMORY[0x1E4F1C9B8], "brc_generateSaltingKey");
        }
        else
        {
          char v85 = 0;
        }
        id v89 = objc_msgSend(MEMORY[0x1E4F19E50], "br_assetWithFileURL:boundaryKey:", v83, v85);
      ...
      if ([v15 isFinderBookmark])
      {
        ...
        if (os_log_type_enabled(v109, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          _os_log_impl(&dword_1D353B000, v109, OS_LOG_TYPE_DEFAULT, "[WARNING] Item is missing structure CKInfo so using the version CKInfo because they are the same record %@%@", buf, 0x16u);
        }
...
- (uint64_t)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:
{
  ...
  if (([v10 isPausedFromSync] & 1) != 0 || objc_msgSend(v10, "isResumingSync")) {
    int v13 = 0x40000;
  }
  else {
    int v13 = 33423360;
  ...
  if (!v11)
  {
    BOOL v58 = brc_bread_crumbs();
    BOOL v59 = brc_default_log();
    if (os_log_type_enabled(v59, OS_LOG_TYPE_FAULT)) {
      -[CKRecord(BRCSerializationAdditions) serializeVersion:diffs:deadInServerTruth:basehashSalt:error:].cold.4();
    }
  }
  id v16 = [v10 appLibrary];
  if ([v16 isCloudDocsAppLibrary])
  {
    uint64_t v17 = [v10 clientZone];
    if ([v17 isCloudDocsZone])
    {
      id v18 = [v10 parentItemIDInZone];
      uint64_t v19 = [v18 isNonDesktopRoot];
    }
    else
    {
      uint64_t v19 = 0;
  ...
  id v20 = [v10 parentItemIDInZone];
  uint64_t v21 = [v20 isDocumentsFolder];
  ...
  if ([v10 isSharedToMeTopLevelItem])
  {
    ...
    if (v22 == 1)
    {
      char v23 = [v10 clientZone];
      int v24 = [v10 itemID];
      unsigned int v25 = [v23 serverItemByItemID:v24];

      uint64_t v26 = [v25 latestVersion];
      int v27 = [v26 originalPOSIXName];
      char v28 = v27;
      if (v27)
      {
        id v29 = v27;
      ...
      {
        id v29 = [v11 originalPOSIXName];
      }
      __int16 v32 = v29;

      [a1 serializeFilename:v32 forCreation:1 basehashSalt:0 parentIDIsCloudDocsRoot:v19 parentIDIsDocumentsFolder:v21];
    }
    int v31 = (void *)[objc_alloc(MEMORY[0x1E4F1A2F8]) initShareIDWithShareableItem:v10];
    char v33 = (void *)[objc_alloc(MEMORY[0x1E4F1A348]) initWithRecordID:v31 action:0];
    [a1 setShare:v33];
  ...
  if ((v30 & 1) == 0)
  {
    int v31 = [v11 originalPOSIXName];
    [a1 serializeFilename:v31 forCreation:v67 == 0 basehashSalt:v68 parentIDIsCloudDocsRoot:v19 parentIDIsDocumentsFolder:v21];
LABEL_30:
  }
  if ((v12 & 1) != 0 || (a4 & v66 & 0x80000) != 0)
  {
  ...
  {
LABEL_39:
    char v35 = objc_msgSend(NSNumber, "numberWithLongLong:", objc_msgSend(v11, "mtime"));
    goto LABEL_41;
  }
  char v35 = 0;
LABEL_41:
  uint64_t v36 = objc_msgSend(a1, "_updateSize:mtime:shouldUseEnhancedDrivePrivacy:item:error:", v34, v35, objc_msgSend(v10, "shouldUseEnhancedDrivePrivacyWhenNeedsPreserving:", v68 != 0), v10, a7);
  if ((v36 & 1) == 0) {
    goto LABEL_63;
  }
  if ((v12 & 1) == 0 && (a4 & v66 & 0x200000) == 0) {
    goto LABEL_48;
  }
  int v37 = [v11 xattrSignature];
  BOOL v38 = v37 == 0;

  if (!v38)
  {
    v39 = [a1 objectForKeyedSubscript:@"xattr"];
    BOOL v40 = v39 == 0;
    ...
    int v41 = [a1 encryptedValues];
    char v42 = [v41 objectForKeyedSubscript:@"xattrSignature"];
    if (v42) {
      goto LABEL_47;
    }
    id v56 = [v10 clientZone];
    int v57 = [v56 enhancedDrivePrivacyEnabled];
...
LABEL_48:
  ...
  {
LABEL_52:
    char v43 = [MEMORY[0x1E4F1C9B8] data];
    id v44 = [a1 encryptedValues];
    [v44 setObject:v43 forKeyedSubscript:@"quarantine"];

    goto LABEL_53;
  }
  [a1 setObject:0 forKeyedSubscript:@"xattr"];
  char v43 = [a1 encryptedValues];
  [v43 setObject:0 forKeyedSubscript:@"xattrSignature"];
LABEL_53:

LABEL_54:
  uint64_t v45 = [v10 resolvedConflictLoserEtags];
  id v46 = v45;
  if ((a4 & 0x800000) != 0 && [v45 count] && v67)
  {
    uint64_t v47 = [v11 conflictLoserEtags];
    uint64_t v48 = (void *)[v47 mutableCopy];

    [v48 minusSet:v46];
    char v49 = [v48 allObjects];
    [a1 setConflictLoserEtags:v49];
  }
  if (v64)
  {
    id v50 = [v10 clientZone];
    char v51 = [v50 mangledID];
    id v52 = +[BRCUserDefaults defaultsForMangledID:v51];
    int v53 = [v52 forceFailIfExistOnRevival];
  ...
  {
    char v54 = [v11 ckInfo];
    objc_msgSend(a1, "serializeSystemFields:includeCZMEtag:", v54, objc_msgSend(v10, "isDocumentBeingCopiedToNewZone") ^ 1);
  }
LABEL_63:
...
- (id)_createAppLibraryIfNecessary:()BRCSerializationAdditions session:
{
  ...
  char v13 = 0;
  uint64_t v5 = (objc_class *)MEMORY[0x1E4F594E8];
  id v6 = a4;
  id v7 = a3;
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v10;
      _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Created app library through sync flow %@%@", buf, 0x16u);
    }
  }
  return v9;
}
...
LABEL_30:
    ...
    if (objc_msgSend(v12, "brc_isAppLibraryRootRecordID"))
    {
      ...
      uint64_t v19 = [v9 session];
      id v20 = [v19 clientTruthWorkloop];
    ...
    if (objc_msgSend(v12, "brc_isAppLibraryRootRecordID"))
    {
      ...
      if ([v22 isEqualToString:*MEMORY[0x1E4F59418]])
      {
    ...
    if (objc_msgSend(v12, "brc_isAppLibraryDocumentsRecordID"))
    {
      ...
      if ([v25 isEqualToString:*MEMORY[0x1E4F59418]])
      {
        int v37 = brc_bread_crumbs();
        BOOL v38 = brc_default_log();
    ...
    {
      char v28 = [v16 recordID];
      if (objc_msgSend(v28, "brc_isAppLibraryRootRecordID"))
      {
        id v29 = objc_msgSend(v28, "brc_appLibraryRootZoneName");
        char v30 = brc_bread_crumbs();
        ...
        if ([v29 isEqualToString:*MEMORY[0x1E4F59418]])
        {
          v39 = brc_bread_crumbs();
      ...
      if ([v32 isEqualToString:*MEMORY[0x1E4F59418]])
      {
        int v41 = brc_bread_crumbs();
        char v42 = brc_default_log();
        if (os_log_type_enabled(v42, OS_LOG_TYPE_FAULT)) {
...
- (void)deserializeFilename:()BRCSerializationAdditions basename:bounceno:extension:userInfo:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: empty basename and no bounceno%@", v2, v3, v4, v5, v6);
}
...
- (void)deserializeFilename:()BRCSerializationAdditions basename:bounceno:extension:userInfo:error:.cold.2()
{
  ...
  OUTLINED_FUNCTION_3_0();
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] basename is nil -> replace with empty string%@", v1, 0xCu);
}

- (void)deserializeAliasInfo:()BRCSerializationAdditions serverZone:error:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: No alias target%@", v2, v3, v4, v5, v6);
}

- (void)_deserializeRootSharingOptions:()BRCSerializationAdditions .cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Record %@ is missing its PSK or routing key!%@");
}
...
- (void)deserializeStatInfo:()BRCSerializationAdditions serverMetrics:itemID:session:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_5(&dword_1D353B000, v1, v2, "[CRIT] UNREACHABLE: The server should have set a birthtime on %s%@", v3, v4, v5, v6, v7);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: The record name is not a content in the shared zone%@", v2, v3, v4, v5, v6);
}
...
- (void)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:.cold.2()
{
  ...
  __int16 v10 = 2112;
  uint64_t v11 = v1;
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] %@ record %@ doesn't have a lastEditorDeviceName%@", (uint8_t *)&v6, 0x20u);
}
...
- (void)deserializeVersion:()BRCSerializationAdditions fakeStatInfo:contentBoundaryKey:clientZone:outOfBandUpload:error:.cold.3()
{
  ...
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5(&dword_1D353B000, v2, v3, "[CRIT] UNREACHABLE: Got unexpected content boundary key for recordID %@%@", v4, v5, v6, v7, v8);
}

- (void)_locateSideCarServerZone:()BRCSerializationAdditions withShareAliasReference:withSession:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: si.isBRAlias%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: invalid filename%@", v2, v3, v4, v5, v6);
}
...
- (void)serializeFilename:()BRCSerializationAdditions forCreation:setExtension:inSharedAlias:basehashSaltIfNotShareAlias:parentIDIsCloudDocsRoot:parentIDIsDocumentsFolder:.cold.2()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] couldn't set basename to '%@'%@", v1, 0x16u);
}
...
- (void)serializeStatInfo:()BRCSerializationAdditions diffs:stageID:deadInServerTruth:shouldPCSChainStatus:basehashSaltGetter:childBasehashSaltGetter:error:.cold.1(void *a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_fault_impl(&dword_1D353B000, log, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't find xattr for signature %@%@", buf, 0x16u);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: childBasehashSaltGetter%@", v2, v3, v4, v5, v6);
}

- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self.encryptedValues[kBRRecordKeyXattrSignature] || !item.clientZone.enhancedDrivePrivacyEnabled%@", v2, v3, v4, v5, v6);
}

- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self[kBRRecordKeyXattr]%@", v2, v3, v4, v5, v6);
}

- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: (diffs & BRC_IF_CONTENT_SIGNATURE) || item.isDocumentBeingCopiedToNewZone%@", v2, v3, v4, v5, v6);
}

- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: version != nil%@", v2, v3, v4, v5, v6);
}

- (void)serializeVersion:()BRCSerializationAdditions diffs:deadInServerTruth:basehashSalt:error:.cold.5()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] On Sync-up of %@ using old etag due to iWork conflict%@");
}

- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![zoneName isEqualToString:BRUbiquitousDefaultContainerID]%@", v2, v3, v4, v5, v6);
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.2()
{
  ...
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] found parent app documents record named: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.4()
{
  ...
  uint64_t v1 = [v0 recordName];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] found parent app library record named: %@%@", v4, v5, v6, v7, v8);
}

- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.5()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: parent is not a CKReference for %@%@");
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.7()
{
  ...
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] found app documents record named: %@%@", v4, v5, v6, v7, v8);
}
...
- (void)processAppLibraryDataWithMovedZoneNames:()BRCSerializationAdditions serverZone:isDeltaSync:.cold.9()
{
  ...
  os_log_t v1 = [v0 recordName];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] found app library record named: %@%@", v4, v5, v6, v7, v8);
}
