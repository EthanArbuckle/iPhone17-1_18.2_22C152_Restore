...
LABEL_19:
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = v24;
        ...
        __int16 v27 = 2112;
        v28 = v7;
        _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] Enumerating pcs under new directory %@%@", buf, 0x16u);
      }
    ...
    objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorFolderHierarchyTooDeep");
...
- (void)initWithPCSChainInfo:(NSObject *)a3 clientZone:.cold.1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a2;
  OUTLINED_FUNCTION_1(&dword_1D353B000, a2, a3, "[DEBUG] We need to list the root item %@%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}
...
- (void)nextObject
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] We need to list %@%@", v4, v5, v6, v7, v8);
}
