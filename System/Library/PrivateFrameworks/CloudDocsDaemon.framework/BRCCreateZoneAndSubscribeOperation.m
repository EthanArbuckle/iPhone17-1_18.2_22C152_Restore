...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "create-zone", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !_optimisticSubscribe%@", v2, v3, v4, v5, v6);
}
...
- (void)_createZoneWithZoneID:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = (void *)[objc_alloc(MEMORY[0x1E4F1A310]) initWithZoneID:v4];
...
- (void)_registerSubscriptionForZoneID:(id)a3 isOptimisticSubscribe:(BOOL)a4
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x1E4F1A340]) initWithZoneID:v6 subscriptionID:v8];
  id v10 = objc_alloc_init(MEMORY[0x1E4F1A1E0]);
...
void __91__BRCCreateZoneAndSubscribeOperation__registerSubscriptionForZoneID_isOptimisticSubscribe___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134219010;
    ...
    __int16 v30 = 2112;
    __int16 v31 = v12;
    _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Handling result of creating %@ (operationID=%@): %@%@", buf, 0x34u);
  }
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: savedZones.count == 1%@", v2, v3, v4, v5, v6);
}

- (void)_registerSubscriptionForZoneID:isOptimisticSubscribe:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !self->_syncContext.isShared%@", v2, v3, v4, v5, v6);
}
...
void __91__BRCCreateZoneAndSubscribeOperation__registerSubscriptionForZoneID_isOptimisticSubscribe___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_3_0();
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] optimistic subscribe failed with Zone Not Found, try to create the zone first%@", v1, 0xCu);
}
