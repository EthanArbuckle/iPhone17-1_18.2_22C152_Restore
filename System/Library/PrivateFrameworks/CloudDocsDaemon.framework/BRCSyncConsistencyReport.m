...
uint64_t __91__BRCSyncConsistencyReport__finishReport_session_temporaryDBURL_mountFD_completionHandler___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      int v5 = 138412290;
      v6 = v2;
      _os_log_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEFAULT, "[WARNING] Telemetry sync consistency report did not run%@", (uint8_t *)&v5, 0xCu);
    }
  }
...
LABEL_11:
      ...
      v84 = v34;
      v38 = [MEMORY[0x1E4F1CB10] fileURLWithPath:v34];
      v39 = [MEMORY[0x1E4F594C0] mobileDocumentsURL];
      v40 = [v39 path];
      v83 = v38;
      ...
      if (v9 && [v9 count])
      {
        ...
        v115[1] = 3221225472;
        v115[2] = __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_710;
        v115[3] = &unk_1E6994940;
        id v116 = v41;
      ...
      {
        v126 = v41;
        v42 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v126 count:1];
      }
      v43 = objc_opt_new();
      long long v111 = 0u;
      long long v112 = 0u;
      ...
      if (v45)
      {
        ...
        while (2)
        {
          for (uint64_t i = 0; i != v46; ++i)
          {
            ...
            id v110 = 0;
            v50 = [MEMORY[0x1E4F25D78] wrapperWithURL:v49 readonly:1 error:&v110];
            v51 = (NSError *)v110;
            if (v51)
            {
      ...
      v108[1] = 3221225472;
      v108[2] = __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_2_712;
      v108[3] = &unk_1E6994968;
      id v52 = v25;
      id v109 = v52;
      ...
      v93[1] = 3221225472;
      v93[2] = __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_715;
      v93[3] = &unk_1E69949B8;
      v94 = v53;
      id v99 = v92;
      id v95 = v76;
      ...
      if (v31)
      {
        ...
        if (os_log_type_enabled(v70, (os_log_type_t)0x90u))
        {
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v131 = 2112;
          v132 = v69;
          _os_log_error_impl(&dword_1D353B000, v70, (os_log_type_t)0x90u, "[ERROR] Failed to mount snapshot at %@ - %@%@", buf, 0x20u);
        }
...
LABEL_31:
      ...
      if (os_log_type_enabled(v64, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v131 = 2112;
        v132 = v63;
        _os_log_error_impl(&dword_1D353B000, v64, (os_log_type_t)0x90u, "[ERROR] Failed to generate snapshot at %@ - %@%@", buf, 0x20u);
      }
  ...
  uint64_t v36 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithPOSIXCode:", 28);
  v37 = v11->_lastError;
...
uint64_t __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_710(uint64_t a1, uint64_t a2)
{
  return [*(id *)(a1 + 32) URLByAppendingPathComponent:a2];
}

id __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_2_712(uint64_t a1, void *a2)
{
  v2 = *(void **)(a1 + 32);
  v3 = (objc_class *)MEMORY[0x1E4F594E8];
  id v4 = a2;
...
void __76__BRCSyncConsistencyReport_generateReportWithSession_mangledIDs_completion___block_invoke_715(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  else
  {
    ...
    *(unsigned char *)(*(void *)(a1 + 32) + 8) = 1;
    ...
    if (v8)
    {
      id v19 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(v8, "count"));
      long long v29 = 0u;
      long long v30 = 0u;
      long long v31 = 0u;
      long long v32 = 0u;
...
void __91__BRCSyncConsistencyReport__finishReport_session_temporaryDBURL_mountFD_completionHandler___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_11_0(&dword_1D353B000, v4, v5, "[DEBUG] Telemetry sync consistency report succeeded with %lu error and %lu warning events%@", v6, v7, v8, v9, 2u);
}

+ (void)cleanupApfsSnapshotWithMountFD:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Failed to delete old snapshot - %@%@");
}

+ (void)cleanupApfsSnapshotWithMountFD:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Failed to unmount old snapshot - %@%@");
}
