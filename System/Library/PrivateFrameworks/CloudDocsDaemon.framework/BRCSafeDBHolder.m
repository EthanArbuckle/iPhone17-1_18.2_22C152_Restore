...
+ (id)newSafeDBHolder:(id)a3 withDatabaseURL:(id)a4
{
  ...
  if (v6 && v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v17 = 2112;
      v18 = v10;
      _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] <BRCSafeDBHolder %p> - Creating for db in path: %@%@", (uint8_t *)&v13, 0x20u);
    }
  }
  return v9;
}
...
- (void)closeDatabaseSynchronously:(BOOL)a3 dispatchToSerialQueue:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (v10)
  {
    ...
    v20 = v14;
    id v21 = v8;
    uint64_t v15 = MEMORY[0x1D94389C0](v18);
    v16 = (void *)v15;
    if (v6)
    {
      if (!v5)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v16 = 2112;
      __int16 v17 = v7;
      _os_log_fault_impl(&dword_1D353B000, v8, OS_LOG_TYPE_FAULT, "[CRIT] %@ - Error closing BRCPendingChangesStream DB connection: %@%@", buf, 0x20u);
    }
  }
...
- (BOOL)closeWithError:(id *)a3
{
  ...
  uint64_t v13 = __Block_byref_object_copy__28;
  __int16 v14 = __Block_byref_object_dispose__28;
  id v15 = 0;
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 136315906;
      ...
      __int16 v22 = 2112;
      v23 = v5;
      _os_log_error_impl(&dword_1D353B000, v6, (os_log_type_t)0x90u, "[ERROR] %s: %s error: %@%@", buf, 0x2Au);
    }
  }
  if (a3) {
    *a3 = v4;
...
- (void)dealloc
{
  ...
  *(void *)((char *)&v3 + 4) = a1;
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] <BRCSafeDBHolder %p> - dealloc called%@", (void)v3, DWORD2(v3));
}
...
void __86__BRCSafeDBHolder_closeDatabaseSynchronously_dispatchToSerialQueue_completionHandler___block_invoke_cold_1(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 32);
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] %@ - Database closed%@", (void)v3, DWORD2(v3));
}
...
void __86__BRCSafeDBHolder_closeDatabaseSynchronously_dispatchToSerialQueue_completionHandler___block_invoke_cold_2(uint64_t a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *(void *)(a1 + 32);
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] %@ - Closing the database%@", (void)v3, DWORD2(v3));
}
