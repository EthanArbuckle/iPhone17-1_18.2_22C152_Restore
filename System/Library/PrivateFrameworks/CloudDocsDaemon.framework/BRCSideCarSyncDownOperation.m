...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync/side-car-fetch", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}

- (void)_createZone
{
  v3 = objc_msgSend(MEMORY[0x1E4F1A320], "brc_sideCarZoneID");
...
- (void)_saveChangedRecords:(id)a3 deletedRecords:(id)a4 serverChangeToken:(id)a5 clientChangeToken:(id)a6
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138413314;
    ...
    __int16 v50 = 2112;
    v51 = v17;
    _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] Saving side car changed records %@\ndeleted record %@\nserver change token %@\nrequestID %llu%@", buf, 0x34u);
  }
...
LABEL_19:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
            {
              *(_DWORD *)buf = 138412546;
              ...
              __int16 v70 = 2112;
              v71 = v20;
              _os_log_fault_impl(&dword_1D353B000, v21, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't parse alias record name for %@%@", buf, 0x16u);
            }
          }
          a1 = v49;
          goto LABEL_24;
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v70 = 2112;
          v71 = v11;
          _os_log_fault_impl(&dword_1D353B000, v12, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't deserialize side car info on %@%@", buf, 0x16u);
        }
LABEL_25:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v70 = 2112;
            v71 = v31;
            _os_log_debug_impl(&dword_1D353B000, v32, OS_LOG_TYPE_DEBUG, "[DEBUG] Ignoring deleted recordID where we couldn't locate the server zone %@%@", buf, 0x16u);
          }
        }
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v37 = 2112;
      id v38 = v6;
      _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Marking sync request in side care zone as failed because requestIDs differ %lld vs %lld%@", buf, 0x20u);
    }
  }
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        if (v4 == v5) {
          [v14 markLatestSyncRequestAcknowledgedInZone:&unk_1F2B26D30];
        }
        else {
          [v14 markLatestSyncRequestFailedInZone:&unk_1F2B26D30];
        }
...
- (void)_createSyncDownOperation
{
  ...
  uint64_t v5 = [MEMORY[0x1E4F1A2D8] desiredKeysWithMask:185];
  [v4 setDesiredKeys:v5];

  uint64_t v6 = objc_msgSend(MEMORY[0x1E4F1A320], "brc_sideCarZoneID");
  id v7 = objc_alloc(MEMORY[0x1E4F1A070]);
  v36[0] = v6;
...
void __102__BRCSideCarSyncDownOperation__saveChangedRecords_deletedRecords_serverChangeToken_clientChangeToken___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: failed to alloc ranks when syncing down side cars for %@%@", v1, 0x16u);
}
...
void __102__BRCSideCarSyncDownOperation__saveChangedRecords_deletedRecords_serverChangeToken_clientChangeToken___block_invoke_18_cold_1(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a2;
  OUTLINED_FUNCTION_1(&dword_1D353B000, a2, a3, "[DEBUG] Succeeded in syncing up the side car zone with requestID %lld%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}

void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: sideCarRecordsByRecordID[record.recordID] == nil%@", v2, v3, v4, v5, v6);
}

void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![deletedRecordIDs containsObject:record.recordID]%@", v2, v3, v4, v5, v6);
}
...
void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_cold_3(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v8 = 2112;
  uint64_t v9 = a2;
  _os_log_debug_impl(&dword_1D353B000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Ignoring record of unknown type %@%@", (uint8_t *)&v6, 0x16u);
}

void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_28_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: sideCarRecordsByRecordID[recordID] == nil%@", v2, v3, v4, v5, v6);
}

void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_28_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![deletedRecordIDs containsObject:recordID]%@", v2, v3, v4, v5, v6);
}

void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_28_cold_3()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Ignoring record of unknown type %@%@");
}

void __55__BRCSideCarSyncDownOperation__createSyncDownOperation__block_invoke_3_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Finished syncing down side cars - %@%@");
}
