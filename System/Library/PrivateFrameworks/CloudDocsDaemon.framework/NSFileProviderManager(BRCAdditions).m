    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, (os_log_type_t)0x90u))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v38 = 2112;
        v39 = v17;
        _os_log_error_impl(&dword_1D353B000, v18, (os_log_type_t)0x90u, "[ERROR] couldn't remove domain %@ in a sync way: %@%@", buf, 0x20u);
      }
    }
...
+ (uint64_t)br_importDomain:()BRCAdditions forProviderIdentifier:fromDirectoryAtURL:knownFolders:error:
{
  ...
  id v13 = a5;
  id v14 = a6;
  id v15 = (void *)MEMORY[0x1E4F59578];
...
- (uint64_t)br_signalWorkingSetEnumeratorWithCompletionHandler:()BRCAdditions
{
  return objc_msgSend(a1, "br_signalEnumeratorForContainerItemIdentifier:completionHandler:", *MEMORY[0x1E4F25CA8], a3);
}
...
- (void)br_removeDomain:()BRCAdditions options:sync:completionHandler:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  *(_WORD *)&v3[12] = 2112;
  *(void *)&v3[14] = a2;
  OUTLINED_FUNCTION_1(&dword_1D353B000, a2, a3, "[DEBUG] Successfully removed domain %@ in a sync way%@", *(void *)v3, *(void *)&v3[8], *(void *)&v3[16], *MEMORY[0x1E4F143B8]);
}
