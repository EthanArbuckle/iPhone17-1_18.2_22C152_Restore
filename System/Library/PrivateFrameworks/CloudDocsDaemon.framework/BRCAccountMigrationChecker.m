...
- (void)perform
{
  ...
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] No ACAccount found%@", v1, 0xCu);
}
...
void __37__BRCAccountMigrationChecker_perform__block_invoke_115(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v24 = 2112;
    v25 = v10;
    _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Request for CloudKit migration status done. response: %@, error: %@%@", buf, 0x2Au);
  }
  ...
  if (v8 && !v9 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (v12) {
      [v12 isEqualToString:*MEMORY[0x1E4F4BF40]];
    }
...
void __37__BRCAccountMigrationChecker_perform__block_invoke_cold_2(char a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v4 = 2112;
  uint64_t v5 = a2;
  _os_log_debug_impl(&dword_1D353B000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] migration status: %d%@", (uint8_t *)v3, 0x12u);
}

void __37__BRCAccountMigrationChecker_perform__block_invoke_115_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] migration state: %@%@");
}
