...
- (BRCSharingModifyShareOperation)initWithName:(id)a3 zone:(id)a4 share:(id)a5 sessionContext:(id)a6
{
  ...
  if (v16)
  {
    v17 = objc_msgSend(MEMORY[0x1E4F1A218], "br_sharingMisc");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "BRCSharingModifyShareOperation/? (subclass activity missing)", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
...
LABEL_27:
    ...
    id v13 = [[BRCItemToPathLookup alloc] initWithItem:v3];
    v20 = [(BRCItemToPathLookup *)v13 byFileSystemID];
    [v3 setOrRemoveSpotlightAttributeAt:v20];
  ...
  {
    brc_bread_crumbs();
    id v13 = (BRCItemToPathLookup *)objc_claimAutoreleasedReturnValue();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v31 = 2112;
      v32 = v13;
      _os_log_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't find item %@ in zone %@%@", buf, 0x20u);
    }
  }
...
- (void)_performAfterCopyingPublicSharingKeyWithRecordID:(id)a3 completion:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_alloc(MEMORY[0x1E4F1A0A8]);
  v18[0] = v6;
...
void __94__BRCSharingModifyShareOperation__performAfterCopyingPublicSharingKeyWithRecordID_completion___block_invoke(void *a1, void *a2, void *a3)
{
  ...
  if (!v12)
  {
    ...
    if (v8
      || (objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorPermissionError:", @"Couldn't get public sharing key"),
...
- (void)_performAfterGettingPublicSharingKeyForRecord:(id)a3 completion:(id)a4
{
  ...
  id v11 = objc_alloc(MEMORY[0x1E4F1A198]);
  v22[0] = v6;
...
void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (!v7 && !v9)
  {
    ...
    uint64_t v7 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no records and no error");
  }
  ...
  if (!(v12 | v7))
  {
    ...
    uint64_t v7 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no error and no sharing key");
  }
  if (v7)
  {
  ...
  else
  {
    ...
    int v18 = [v8 displayedHostname];
    [*(id *)(*(void *)(a1 + 32) + 528) setDisplayedHostname:v18];

    id v19 = [v8 routingKey];
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v36 = 2112;
      v37 = v20;
      _os_log_debug_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] Got sharing identity for share - %@%@", buf, 0x16u);
    }
...
LABEL_4:
  ...
  else
  {
    ...
    id v20 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no public sharing identity. avoiding breaking iwork shares");
...
void __95__BRCSharingModifyShareOperation__performAfterFetchingiWorkRoutingTokenIfNecessary_completion___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (!(v4 | v5))
  {
    ...
    uint64_t v4 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no routing key on share identity prepared record");
  }
...
LABEL_7:
  ...
  id v18 = objc_alloc(MEMORY[0x1E4F1A0A8]);
  v32[0] = v17;
...
void __108__BRCSharingModifyShareOperation__performAfterFetchingiWorkSharingIdentityOnItem_wantRoutingKey_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  BOOL v7 = [v6 objectForKeyedSubscript:*MEMORY[0x1E4F19DF0]];
  id v8 = [v6 mutableEncryptedPublicSharingKeyData];
  if (v8
    || ([v6 encryptedValues],
        uint64_t v9 = objc_claimAutoreleasedReturnValue(),
        [v9 objectForKeyedSubscript:*MEMORY[0x1E4F19E08]],
        ...
        v8))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      uint64_t v12 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: sharing identity isn't encrypted data");
  ...
  if (v7)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      uint64_t v15 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: base token isn't a string");
  ...
  if (v16 && !v5)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v42 = 2112;
      v43 = v17;
      _os_log_fault_impl(&dword_1D353B000, v18, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: no base token %@ or sharing identity %@ and no error%@", buf, 0x20u);
    }

    objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no base token %@ or sharing identity %@ and no error", v7, v8);
    id v5 = (id)objc_claimAutoreleasedReturnValue();
    id v19 = [*(id *)(a1 + 40) clientZone];
  ...
  else
  {
    ...
    uint64_t v27 = *MEMORY[0x1E4F19E08];
    v22 = [v26 objectForKeyedSubscript:*MEMORY[0x1E4F19E08]];
    ...
    if (!v22 || ([v8 isEqualToData:v22] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v42 = 2112;
        v43 = v28;
        _os_log_fault_impl(&dword_1D353B000, v29, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Sharing identities don't match (%@ vs %@)! Trying to fix up the identities%@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v40 = 2112;
      v41 = v35;
      _os_log_debug_impl(&dword_1D353B000, v36, OS_LOG_TYPE_DEBUG, "[DEBUG] Got iWork sharing identify for share - %@%@", buf, 0x16u);
    }
...
LABEL_7:
  ...
  id v13 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: not a directory nor a document");
...
- (void)initWithName:zone:share:sessionContext:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _itemID%@", v2, v3, v4, v5, v6);
}

- (void)_performAfterGettingPublicSharingKeyForRecord:completion:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: contentsRecord%@", v2, v3, v4, v5, v6);
}

- (void)_performAfterGettingPublicSharingKeyForRecord:completion:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] requesting sharing identity on %@%@");
}

void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Fetching sharing identity failed - %@%@");
}

void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no error and no sharing key%@", v2, v3, v4, v5, v6);
}

void __91__BRCSharingModifyShareOperation__performAfterGettingPublicSharingKeyForRecord_completion___block_invoke_cold_3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no records and no error%@", v2, v3, v4, v5, v6);
}

- (void)_performAfterFetchingiWorkRoutingTokenIfNecessary:completion:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no public sharing identity. avoiding breaking iwork shares%@", v2, v3, v4, v5, v6);
}

- (void)_performAfterFetchingiWorkRoutingTokenIfNecessary:completion:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Yanking the routing key from the server for %@%@");
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: [self->_share.publicSharingIdentity isEqualToData:self->_sharingIdentityPreparedRecord.encryptedPublicSharingKey]%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no routing key on share identity prepared record%@", v2, v3, v4, v5, v6);
}

- (void)_performAfterFetchingiWorkSharingIdentityOnItem:wantRoutingKey:completion:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Requesting iwork sharing identity on %@%@");
}
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] Fetching iWork sharing identity failed - %@%@");
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: base token isn't a string%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: sharing identity isn't encrypted data%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: not a directory nor a document%@", v2, v3, v4, v5, v6);
}
