...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync-up/container-metadata", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)performAfterSavingRecords:(id)a3
{
  ...
  if (v10)
  {
    ...
    v14 = (void *)[objc_alloc(MEMORY[0x1E4F1A198]) initWithRecordsToSave:v11 recordIDsToDelete:0];
    [v14 setSavePolicy:0];
    [v14 setAtomic:1];
    v15 = objc_opt_new();
    ...
    v18 = [MEMORY[0x1E4F1C9B8] dataWithBytes:&v29 length:8];
...
void __65__BRCContainerMetadataSyncUpOperation_performAfterSavingRecords___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v8;
    _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] completed sync up for %lu records: %@%@", (uint8_t *)&v15, 0x20u);
  }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v17 = 2112;
    v18 = v10;
    _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, "[NOTICE] saved %lu containers metadata in the cloud%@", (uint8_t *)&v15, 0x16u);
  }
...
- (void)main
{
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] ┏%llx Sync: syncing up container metadata%@");
}
...
- (void)performAfterSavingRecords:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1D353B000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] no records to save%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)performAfterSavingRecords:(void *)a1 .cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v1, v2, "[DEBUG] preparing to send %lu records%@", v3, v4, v5, v6, v7);
}

void __65__BRCContainerMetadataSyncUpOperation_performAfterSavingRecords___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] adding sub-operation to save the records: %@%@");
}
