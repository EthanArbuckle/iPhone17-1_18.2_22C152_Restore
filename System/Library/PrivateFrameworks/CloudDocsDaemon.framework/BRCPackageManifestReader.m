...
- (BRCPackageManifestReader)initWithInputStream:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v9 = [objc_alloc(MEMORY[0x1E4F940A0]) initWithStream:*p_stream];
    reader = v7->_reader;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138413058;
        ...
        __int16 v25 = 2112;
        v26 = v13;
        _os_log_error_impl(&dword_1D353B000, v14, (os_log_type_t)0x90u, "[ERROR] unable to read package header %@ with version %d - %@%@", buf, 0x26u);
      }
...
- (BRCPackageManifestReader)initWithURL:(id)a3
{
  uint64_t v4 = [MEMORY[0x1E4F1CA10] inputStreamWithURL:a3];
...
- (BRCPackageManifestReader)initWithDeviceID:(int)a3 fileID:(unint64_t)a4
{
  ...
  v6 = [MEMORY[0x1E4F1CA10] inputStreamWithFileAtPath:v5];
...
- (void)nextObject
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _reader%@", v2, v3, v4, v5, v6);
}
