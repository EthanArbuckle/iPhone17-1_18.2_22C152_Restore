...
- (id)description
{
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F28E78]) initWithFormat:@"<%@ delay:%.1fs id:%@", objc_opt_class(), *(void *)&self->_delay, self->_mangledID];
  id v4 = v3;
  if (self->_graceNextRequest) {
...
- (void)updateForError:(id)a3
{
  ...
  if (v16 != 0.0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v31 = 2112;
      v32 = v18;
      _os_log_debug_impl(&dword_1D353B000, v19, OS_LOG_TYPE_DEBUG, "[DEBUG] server provided backoff %.03fs (delay %.03fs)%@", (uint8_t *)&v27, 0x20u);
    }
...
- (BOOL)scheduleIfPossibleWithCurrentTimestamp:(int64_t)a3 signalSourceIfFailed:(id)a4 description:(id)a5
{
  ...
  if (v10 - a3 >= 0x2540BE401)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v11;
      _os_log_debug_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ sync-%@ is throttled for more than 10s: %.1fs (%@)%@", (uint8_t *)&v24, 0x34u);
    }
  }
  if (v10 > a3)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v28 = 2112;
      __int16 v29 = v13;
      _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] syncing %@ %@%@", (uint8_t *)&v24, 0x20u);
    }
...
- (void)updateForError:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_debug_impl(&dword_1D353B000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Sync: Updated sync throttle %@%@", (uint8_t *)&v3, 0x16u);
}
