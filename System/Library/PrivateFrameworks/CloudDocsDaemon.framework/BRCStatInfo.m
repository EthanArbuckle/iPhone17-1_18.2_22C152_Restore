...
- (BRMangledID)_aliasTargetMangledID
{
  ...
  if (aliasTarget)
  {
    ...
    v4 = (void *)[objc_alloc(MEMORY[0x1E4F594E8]) initWithAliasTargetContainerString:v3];
  }
  else
  {
    v4 = 0;
...
- (id)descriptionWithContext:(id)a3 origName:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  int v8 = (void *)[objc_alloc(MEMORY[0x1E4F28E78]) initWithCapacity:64];
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: containerID%@", v2, v3, v4, v5, v6);
}

- (void)diffAgainst:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Stat shouldn't be nil%@", v2, v3, v4, v5, v6);
}

- (void)setCreatorRowID:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: creatorRowIDLongLongValue >= 0%@", v2, v3, v4, v5, v6);
}
