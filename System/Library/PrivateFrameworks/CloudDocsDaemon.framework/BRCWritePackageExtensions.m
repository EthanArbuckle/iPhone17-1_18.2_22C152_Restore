...
void ___BRCWritePackageExtensions_block_invoke_2()
{
  ...
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F1CB18]) initWithSuiteName:@"com.apple.fileproviderd"];
...
void ___BRCWritePackageExtensions_block_invoke_2_cold_1()
{
  ...
  uint64_t v3 = v0;
  _os_log_debug_impl(&dword_1D353B000, v1, OS_LOG_TYPE_DEBUG, "[DEBUG] Persisting %@ for FileProvider%@", v2, 0x16u);
}
...
void ___BRCWritePackageExtensions_block_invoke_4_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't change personas while saving package extensions list%@", (uint8_t *)&v2, 0xCu);
}
