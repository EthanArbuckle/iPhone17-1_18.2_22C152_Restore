...
- (id)fetchOperationForTransfers:(id)a3 traceCode:(int)a4
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_FAULT)) {
      -[BRCTransferBatchOperation(Downloads) fetchOperationForTransfers:traceCode:]((uint64_t)v32, v33, v34, v35, v36, v37, v38, v39);
    }
  }
  v7 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[BRCTransferBatchOperation itemsCount](self, "itemsCount"));
  id v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA60]), "initWithCapacity:", -[BRCTransferBatchOperation itemsCount](self, "itemsCount"));
  long long v49 = 0u;
  long long v50 = 0u;
  long long v47 = 0u;
  long long v48 = 0u;
      ...
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        if (v16)
        {
          ...
          if (([v13 progressPublished] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_WORD *)&buf[22] = 2112;
              v52 = v23;
              _os_log_debug_impl(&dword_1D353B000, v24, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Publishing download progress for %@%@", buf, 0x20u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(void *)&buf[14] = v17;
            _os_log_fault_impl(&dword_1D353B000, v18, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: We got two downloads for the same record ID: %@%@", buf, 0x16u);
          }
        }
      }
      uint64_t v10 = [v9 countByEnumeratingWithState:&v47 objects:v55 count:16];
  ...
  *(void *)&buf[16] = 0x3032000000;
  ...
  v44[1] = 3221225472;
  v44[2] = __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_2;
  v44[3] = &unk_1E69987A8;
  v44[4] = self;
  [(BRFetchRecordsOperation *)v29 setPerRecordProgressBlock:v44];
  v43[0] = MEMORY[0x1E4F143A8];
  v43[1] = 3221225472;
  v43[2] = __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_101;
  v43[3] = &unk_1E69987D0;
  v43[4] = self;
  [(BRFetchRecordsOperation *)v29 setPerRecordCompletionBlock:v43];
  v42[0] = MEMORY[0x1E4F143A8];
  v42[1] = 3221225472;
  v42[2] = __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_105;
  v42[3] = &unk_1E69987F8;
  v42[4] = self;
  v42[5] = buf;
  [(BRFetchRecordsOperation *)v29 setFetchRecordsCompletionBlock:v42];
...
void __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_2(uint64_t a1, void *a2, double a3)
{
  ...
  if (a3 < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v13 = 2112;
      v14 = v6;
      _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ - Download: Received negative progress from CK. progress [%f]%@", (uint8_t *)&v9, 0x20u);
    }
  }
  [*(id *)(a1 + 32) setProgress:v5 forRecordID:a3];
}

void __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_101(uint64_t a1, void *a2, void *a3, void *a4)
{
  unint64_t v7 = a2;
  id v8 = a3;
  uint64_t v9 = a4;
  if (!(v7 | v9))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT)) {
      __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_101_cold_1((uint64_t)v10, v11, v12, v13, v14, v15, v16, v17);
    }

    uint64_t v9 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no record and no error");
  }
  v18 = (void *)MEMORY[0x1D9438760]();
  [*(id *)(a1 + 32) finishedTransferForRecord:v7 recordID:v8 error:v9];
}

void __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_105(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v20 = 2112;
    v21 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Finished records: %@, Error: %@%@", (uint8_t *)&v14, 0x2Au);
  }
  ...
  *(void *)(v9 + 40) = v6;
  ...
  uint64_t v12 = [*(id *)(a1 + 32) pendingGroup];
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "BRCTransferBatchOperation/? (subclass activity missing)", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)mainWithTransfers:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_FAULT))
  {
    int v5 = 138412290;
    id v6 = v3;
    _os_log_fault_impl(&dword_1D353B000, v4, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: should be subclassed%@", (uint8_t *)&v5, 0xCu);
  }
}
...
- (void)_addTransfer:(id)a3
{
  ...
  if (v8)
  {
    ...
    uint64_t v12 = [v13 secondaryRecordID];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v16 = 2112;
      objc_super v17 = v6;
      _os_log_debug_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - cancelling %@%@", buf, 0x20u);
    }

    id v8 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F19C40] code:20 userInfo:0];
    ...
    if (![(NSMutableDictionary *)self->_entriesByRecordID count])
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 134218754;
        ...
        __int16 v18 = 2112;
        id v19 = v9;
        _os_log_debug_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ - operation is now empty, cancelling %@%@", buf, 0x2Au);
      }
...
- (void)_setProgress:(double)a3 forTransfer:(id)a4
{
  ...
  if (v7 > v8)
  {
    ...
    if ((a3 < 0.0 || os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_DEBUG))
      && round((double)v7 / (double)(unint64_t)[v6 totalSize] * 1000.0) != round((double)v10/ (double)(unint64_t)objc_msgSend(v6, "totalSize")* 1000.0))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v24 = 2112;
        v25 = v16;
        _os_log_debug_impl(&dword_1D353B000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - %@ progress %.1f%%%@", (uint8_t *)&v18, 0x2Au);
      }
    }
  }
}
...
- (void)_finishedTransfer:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v23 = 2112;
    __int16 v24 = v14;
    _os_log_debug_impl(&dword_1D353B000, v15, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - done with %@: %@%@", (uint8_t *)&v17, 0x2Au);
  }
}
...
- (void)finishedTransferForRecord:(id)a3 recordID:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    ...
    LOWORD(v28) = 2112;
    *(void *)((char *)&v28 + 2) = v12;
    _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ - Finished transfer for recordID: %@ with error: %@%@", buf, 0x2Au);
  }
...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (v9)
  {
    ...
    uint64_t v27 = *MEMORY[0x1E4F59368];
    id obj = v8;
    do
    {
      uint64_t v11 = 0;
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v56 = 2112;
            v57 = v16;
            _os_log_fault_impl(&dword_1D353B000, v17, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Missing transfer error for record %@%@", buf, 0x16u);
          }

          id v15 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", v27, 15, @"unreachable: Missing transfer error for record %@", v12);
        }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v58 = 2112;
    v59 = v20;
    _os_log_debug_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] ┣%llx %@ - waiting for callback...%@", buf, 0x20u);
  }
...
LABEL_10:
      _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, v16, buf, 0x52u);
    }
  }
  else
  {
...
void __52__BRCTransferBatchOperation_finishWithResult_error___block_invoke_25(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v14 = 2112;
    id v15 = v2;
    _os_log_debug_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx %@ - callbacks finished%@", buf, 0x20u);
  }
...
void __77__BRCTransferBatchOperation_Downloads__fetchOperationForTransfers_traceCode___block_invoke_101_cold_1(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
- (void)sendTransferCompletionCallBack:(uint64_t)a1 error:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] API MISUSE: implement in subclass%@", (uint8_t *)&v2, 0xCu);
}
...
void __52__BRCTransferBatchOperation_finishWithResult_error___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: entries.count == 0 || error%@", (uint8_t *)&v2, 0xCu);
}
