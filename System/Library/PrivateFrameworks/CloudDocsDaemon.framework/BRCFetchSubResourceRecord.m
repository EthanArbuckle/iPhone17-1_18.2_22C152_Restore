...
- (int64_t)resolveRecordType
{
  ...
  else
  {
    ...
    char v6 = [v5 isEqualToString:*MEMORY[0x1E4F19D78]];
...
- (void)initWithRecordIDNeedingFetch:(void *)a1 recordType:.cold.1(void *a1)
{
  ...
  *(void *)((char *)&v3 + 4) = *a1;
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] initWithRecordIDNeedingFetch: %@%@", (void)v3, DWORD2(v3));
}

- (void)resolveRecordType
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Unsuported record type %@%@");
}
