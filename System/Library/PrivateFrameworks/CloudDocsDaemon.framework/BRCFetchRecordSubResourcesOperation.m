...
LABEL_10:
    ...
    *((void *)v19 + 70) = v41;
    ...
    v44 = (const dispatch_source_type_s *)MEMORY[0x1E4F14440];
    dispatch_source_t v45 = dispatch_source_create(MEMORY[0x1E4F14440], 0, 0, v43);
    ...
    *((void *)v19 + 74) = v48;
    ...
    v54 = v52;
    v55 = v54;
    v56 = (void (**)(void *))MEMORY[0x1E4F59658];
    v57 = v54;
    if (*MEMORY[0x1E4F59658])
    {
      v57 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v54);
    }
...
void __149__BRCFetchRecordSubResourcesOperation_initAndScheduleWithServerZone_parentOperation_pendingChangesStream_contentRecordsFetchedInline_sessionContext___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v11 = 2112;
    v12 = v2;
    _os_log_debug_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ scheduling xattr fetch%@", buf, 0x20u);
  }
...
void __149__BRCFetchRecordSubResourcesOperation_initAndScheduleWithServerZone_parentOperation_pendingChangesStream_contentRecordsFetchedInline_sessionContext___block_invoke_7(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    __int16 v11 = 2112;
    v12 = v2;
    _os_log_debug_impl(&dword_1D353B000, v3, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx %@ scheduling deserialize%@", buf, 0x20u);
  }
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "fetch-record-subresources", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
    ...
    if ((objc_msgSend(v4, "brc_isInterestingRecordForSyncDown") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v154 = 2112;
        v155 = v15;
        _os_log_impl(&dword_1D353B000, v29, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ got a record we're not interested in: '%@'%@", buf, 0x20u);
      }
      goto LABEL_100;
    }
    ...
    if ((objc_msgSend(v4, "brc_isInterestingRecordForSave") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v154 = 2112;
        v155 = v33;
        _os_log_debug_impl(&dword_1D353B000, v34, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ ignoring record we're not interested in saving named: %@%@", buf, 0x20u);
      }
    ...
    else if (![(BRCPendingChangesStream *)self->_pendingChangesStream hasFetchRecordByID:v27])
    {
      ...
      if (os_log_type_enabled(v106, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v154 = 2112;
        v155 = v105;
        _os_log_debug_impl(&dword_1D353B000, v106, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ needs to fetch shareID %@%@", buf, 0x20u);
      }
      v36 = v27;
      goto LABEL_27;
    }
...
LABEL_28:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v154 = 2112;
          v155 = v46;
          _os_log_debug_impl(&dword_1D353B000, v47, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ needs to fetch xattr signature %@%@", buf, 0x20u);
    ...
    if (v49)
    {
      ...
      id v53 = objc_alloc(MEMORY[0x1E4F1A2F8]);
      ...
      if (v56)
      {
        ...
        if (os_log_type_enabled(v58, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v154 = 2112;
          v155 = v57;
          _os_log_debug_impl(&dword_1D353B000, v58, OS_LOG_TYPE_DEBUG, "[DEBUG] Release block %@ on %@%@", buf, 0x20u);
        }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            __int16 v154 = 2112;
            v155 = v141;
            _os_log_impl(&dword_1D353B000, v81, OS_LOG_TYPE_DEFAULT, "[WARNING] Expected recordIDBlockingSave %@ got %@%@", buf, 0x20u);
        ...
        if (!v91)
        {
          ...
          if (os_log_type_enabled(v94, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            __int16 v154 = 2112;
            v155 = v93;
            _os_log_debug_impl(&dword_1D353B000, v94, OS_LOG_TYPE_DEBUG, "[DEBUG] Block %@ on %@%@", buf, 0x20u);
...
LABEL_82:
    ...
    if ([v62 isEqualToString:@"structure"])
    {
      ...
      if (v64)
      {
        ...
        v68 = (void *)v67;
        id v69 = objc_alloc(MEMORY[0x1E4F1A2F8]);
          ...
          if (!v107)
          {
            ...
            if (os_log_type_enabled(v112, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v154 = 2112;
              v155 = v111;
              _os_log_debug_impl(&dword_1D353B000, v112, OS_LOG_TYPE_DEBUG, "[DEBUG] Block %@ on %@%@", buf, 0x20u);
        ...
        if (v36 || v79 || v78)
        {
          ...
          if (os_log_type_enabled(v101, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            _os_log_debug_impl(&dword_1D353B000, v101, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ record changed %@ which needs subResources fetched%@", buf, 0x20u);
          }
          v36 = v148;
        }
        else
        {
          ...
          if (os_log_type_enabled(v97, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            __int16 v154 = 2112;
            v155 = v96;
            _os_log_debug_impl(&dword_1D353B000, v97, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ record changed %@%@", buf, 0x20u);
          }
        }
...
LABEL_100:
    ...
    int v74 = [v73 isEqualToString:*MEMORY[0x1E4F19D78]];
    ...
    id v71 = [v4 objectForKeyedSubscript:*MEMORY[0x1E4F19DD0]];
    if (!v71)
    {
      brc_bread_crumbs();
      ...
      if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v152 = 2112;
        v153 = v75;
        _os_log_impl(&dword_1D353B000, v76, OS_LOG_TYPE_DEFAULT, "[WARNING] Couldn't determine record type for root share record %@%@", buf, 0x16u);
      }
    }
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0
      && [v71 isEqualToString:*MEMORY[0x1E4F593B8]])
    {
  ...
  if (!self->_error && ([(BRCFetchRecordSubResourcesOperation *)self isCancelled] & 1) == 0)
  {
    ...
    else if (![(BRCPendingChangesStream *)self->_pendingChangesStream hasFetchRecordByID:v6])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ scheduling recordID deserialize for %@%@", buf, 0x20u);
      }
      goto LABEL_8;
    }
    brc_bread_crumbs();
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v30 = 2112;
      uint64_t v31 = v9;
      _os_log_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ has no need to deserialize %@ because we've already fetch it%@", buf, 0x20u);
    }
LABEL_8:
  }
}
    ...
    if (objc_msgSend(v4, "brc_isZoneRootRecordID"))
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v34 = 2112;
        id v35 = v6;
        _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ Zone root record ID was deleted %@%@", buf, 0x20u);
      }
    ...
    else if (objc_msgSend(v4, "brc_isAppLibraryRootRecordID"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v34 = 2112;
        id v35 = v10;
        _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ App library root record ID was deleted %@%@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v34 = 2112;
        id v35 = v9;
        _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ record ID was deleted %@%@", buf, 0x20u);
      }
    }
  }
}
  ...
  if (!self->_error && ([(BRCFetchRecordSubResourcesOperation *)self isCancelled] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v18 = 2112;
      id v19 = v7;
      _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ share ID was deleted %@%@", buf, 0x20u);
    }
  }
}
...
- (void)_notifyWhenRecordsAreFetched:(id)a3
{
  ...
  id v5 = v4;
  id v17 = v5;
  uint64_t v6 = MEMORY[0x1D94389C0](&v12);
...
- (void)stopWithError:(id)a3
{
  ...
  if (!self->_isDoneFetchingRecords)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v7;
      _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ stopping fetching records with error %@%@", (uint8_t *)&v12, 0x20u);
    }
...
- (void)cancel
{
  ...
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, (uint64_t)v0, "[DEBUG] cancelling %@%@", v1);
}
...
- (void)stop
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _xattrFetchingGroup == nil%@", v2, v3, v4, v5, v6);
}
...
- (BOOL)_willFetchRecordForDeserialize:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v8 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Fetch loop trying to fetch %@", v4);
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _deserializeState != BRCDeserializeStateWaitingForNextBatchSave%@", v2, v3, v4, v5, v6);
}
...
LABEL_4:
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v59 = 2112;
      id v60 = v12;
      _os_log_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEFAULT, "[WARNING] We deserialized record id %@ which was useless because it came later%@", buf, 0x16u);
    }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v43, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v63 = 2112;
      int v64 = v42;
      _os_log_error_impl(&dword_1D353B000, v43, (os_log_type_t)0x90u, "[ERROR] %@ Deserialize record failed for %@ - %@%@", buf, 0x2Au);
    }
    *(unsigned char *)(*(void *)(*(void *)(a1 + 40) + 8) + 24) = 1;
...
void __59__BRCFetchRecordSubResourcesOperation__scheduleDeserialize__block_invoke_33(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (objc_msgSend(v4, "brc_isCloudKitCancellationError"))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v5;
      _os_log_debug_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] failed to deserialize records for %@: %@%@", (uint8_t *)&v16, 0x20u);
LABEL_22:
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v6, (os_log_type_t)0x90u))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v5;
      _os_log_error_impl(&dword_1D353B000, v6, (os_log_type_t)0x90u, "[ERROR] failed to deserialize records for %@: %@%@", (uint8_t *)&v16, 0x20u);
      goto LABEL_22;
    }
  }
...
LABEL_16:
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v12;
      _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ finished fetching record batch to deserialize%s%@", (uint8_t *)&v16, 0x20u);
    }
    goto LABEL_19;
  }
  id v9 = brc_bread_crumbs();
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v20 = 2112;
    uint64_t v21 = v9;
    _os_log_debug_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ encountered an operation error so we should stop %@%@", (uint8_t *)&v16, 0x20u);
  }
...
LABEL_4:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v11;
    _os_log_debug_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ has sub resource that no longer has info to fetch %@ -> %@%@", (uint8_t *)&v15, 0x2Au);
  }
      ...
      do
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v26 = 2112;
          id v27 = v8;
          _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] %@%@", buf, 0x16u);
        }
...
- (void)_scheduleXattrFetch
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, a3, (uint64_t)a3, "[DEBUG] ┣%llx running the xattr fetch operation%@", (uint8_t *)&v4);
}
...
void __58__BRCFetchRecordSubResourcesOperation__scheduleXattrFetch__block_invoke_40(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218498;
    ...
    _os_log_debug_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] ┳%llx %@ finished fetching xattrs%@", buf, 0x20u);
  }
  if (v5)
  {
    if (objc_msgSend(v5, "brc_isCloudKitCancellationError"))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] failed to fetch xattr assets for %@: %@%@", buf, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v76 = 2112;
        uint64_t v77 = (uint64_t)v8;
        _os_log_error_impl(&dword_1D353B000, v9, (os_log_type_t)0x90u, "[ERROR] failed to fetch xattr assets for %@: %@%@", buf, 0x20u);
      }
    }
              ...
              if (v23)
              {
                ...
                if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)buf = 138413058;
                  ...
                  __int16 v78 = 2112;
                  objc_super v79 = v24;
                  _os_log_debug_impl(&dword_1D353B000, v25, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ saved xattr for signature: %@ sz:%lld%@", buf, 0x2Au);
                }
                [v56 addObject:v17];
              }
              else
              {
                ...
                if (os_log_type_enabled(v27, (os_log_type_t)0x90u))
                {
                  ...
                  *(_DWORD *)buf = 138413058;
                  ...
                  __int16 v78 = 2112;
                  objc_super v79 = v26;
                  _os_log_error_impl(&dword_1D353B000, v27, (os_log_type_t)0x90u, "[ERROR] %@ failed to store xattr for signature: %@ - %@%@", buf, 0x2Au);
                }
...
LABEL_42:
  ...
  if (os_log_type_enabled(v46, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v78 = 2112;
    objc_super v79 = v45;
    _os_log_fault_impl(&dword_1D353B000, v46, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Received %lu xattr records instead of expected %lu records for %@%@", buf, 0x2Au);
  }
  id v47 = (void *)MEMORY[0x1E4F28C58];
  uint64_t v48 = [v54 count];
  uint64_t v49 = *(void *)(v58 + 72);
  long long v50 = [*(id *)(v58 + 32) name];
  objc_msgSend(v47, "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Received %lu xattr records instead of expected %lu records for %@", v48, v49, v50);
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Creating _deserializeGroup because we have more records to deserialize in _pendingChangesStream%@", v2, v3, v4, v5, v6);
}
...
- (void)_prepareToSaveRecords
{
  ...
  __int16 v18 = 2112;
  uint64_t v19 = a2;
  _os_log_debug_impl(&dword_1D353B000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ preparing to save record batch with %lu in memory items %lu subresource items %lu moved zone names%@", (uint8_t *)&v10, 0x34u);
}
...
void __60__BRCFetchRecordSubResourcesOperation__prepareToSaveRecords__block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (([v7 sharingOptions] & 0x48) != 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v29 = 2112;
      uint64_t v30 = v9;
      _os_log_debug_impl(&dword_1D353B000, v10, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ no longer needs to fetch shareID in %@ from server truth check%@", (uint8_t *)&v25, 0x20u);
    }
  ...
  if (v14)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v29 = 2112;
        uint64_t v30 = v16;
        _os_log_debug_impl(&dword_1D353B000, v17, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ is no longer blocked for save in %@ from server truth check%@", (uint8_t *)&v25, 0x20u);
      }
...
void __60__BRCFetchRecordSubResourcesOperation__prepareToSaveRecords__block_invoke_48(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v19 = 2112;
      BOOL v20 = v8;
      _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ is no longer blocked for save in %@ from server truth check%@", (uint8_t *)&v15, 0x20u);
    }
          ...
          if ((pendingChangesStream & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138412802;
              ...
              __int16 v51 = 2112;
              long long v52 = v20;
              _os_log_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] We need to fetch %@ to unblock %@ from saving, but it wasn't found.  Forcing fetch%@", buf, 0x20u);
            }
            ...
            if (!v2->_deserializeGroup)
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
              {
                *(_DWORD *)buf = v41;
                ...
                _os_log_debug_impl(&dword_1D353B000, v27, OS_LOG_TYPE_DEBUG, "[DEBUG] Creating _deserializeGroup because we have more records to deserialize in memory%@", buf, 0xCu);
              }
  ...
  if (v33)
  {
    ...
    if (os_log_type_enabled(v35, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v51 = 2112;
      long long v52 = v34;
      _os_log_error_impl(&dword_1D353B000, v35, (os_log_type_t)0x90u, "[ERROR] We need to fetch %llu records in the pending changes stream to allow saving for %@.  Forcing fetch%@", buf, 0x20u);
    }
    if (!v2->_deserializeGroup)
    {
  ...
  if (!error)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138413570;
      ...
      __int16 v59 = 2112;
      long long v60 = v13;
      _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ saving records with server change token:%@ requestID:%llu caught up:%s directly:%s%@", buf, 0x3Eu);
    }
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          _os_log_impl(&dword_1D353B000, v26, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ Allocating ranks failed when not caught up.  We'll save to pending changes from now on%@", buf, 0x16u);
        }
  ...
  if (!self->_error)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)&v58[22] = 2080;
      ...
      __int16 v60 = 2112;
      uint64_t v61 = v8;
      _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[DEBUG] %@ saving records with query cursor:%@ directly:%s%@", v58, 0x2Au);
    }
    ...
    else
    {
      ...
      if (v13)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v56 = 2112;
          __int16 v57 = v27;
          _os_log_impl(&dword_1D353B000, v28, OS_LOG_TYPE_DEFAULT, "[WARNING] %@ got a (temporary) broken structure while listing directory contents%@", buf, 0x16u);
        }
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        __int16 v55 = v33;
        _os_log_impl(&dword_1D353B000, v34, OS_LOG_TYPE_DEFAULT, "[WARNING] Allocating ranks failed when not caught up and listing.  We'll save to pending changes from now on%@", buf, 0xCu);
      }
    }
    BOOL v6 = 1;
LABEL_29:
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _subResourceRecordsByID.count == 0 && _pendingChangesStream == nil%@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: serverZone && parentOperation%@", v2, v3, v4, v5, v6);
}

- (void)addRecord:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _recordsByID[recordID] == nil%@", v2, v3, v4, v5, v6);
}

- (void)addRecord:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![_deletedRecordIDs containsObject:recordID]%@", v2, v3, v4, v5, v6);
}

- (void)addRecord:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![_deletedShareIDs containsObject:recordID]%@", v2, v3, v4, v5, v6);
}

- (void)addRecord:.cold.7()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: [contentRecordName hasPrefix:kBRRecordIDPrefixContent]%@", v2, v3, v4, v5, v6);
}

- (void)addRecord:.cold.8()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !_isDoneFetchingRecords%@", v2, v3, v4, v5, v6);
}

- (void)addRecordIDToDeserialize:recordType:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _subResourceRecordsByID[recordID] == nil%@", v2, v3, v4, v5, v6);
}

- (void)shareIDWasDeleted:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![_deletedShareIDs containsObject:shareID]%@", v2, v3, v4, v5, v6);
}

- (void)shareIDWasDeleted:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _recordsByID[shareID] == nil%@", v2, v3, v4, v5, v6);
}

- (void)_notifyWhenRecordsAreFetched:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Wait on _deserializeGroup to remaining records to deserialize%@", v2, v3, v4, v5, v6);
}

void __68__BRCFetchRecordSubResourcesOperation__notifyWhenRecordsAreFetched___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Wait on _xattrFetchingGroup to remaining xattrs records%@", v2, v3, v4, v5, v6);
}

- (void)notifyWhenCaughtUp:whenRecordsAreFetchedAndFinish:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Not fetching records blocking save because we aren't caught up%@", v2, v3, v4, v5, v6);
}

- (void)notifyWhenCaughtUp:whenRecordsAreFetchedAndFinish:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _recordsByID.count == 0 && _deletedShareIDs.count == 0 && _deletedRecordIDs.count == 0 && _subResourceRecordsByID.count == 0%@", v2, v3, v4, v5, v6);
}
...
- (void)notifyWhenCaughtUp:whenRecordsAreFetchedAndFinish:.cold.3()
{
  ...
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] %@ waiting to fetch all records%@", v4, v5, v6, v7, v8);
}

void __89__BRCFetchRecordSubResourcesOperation_notifyWhenCaughtUp_whenRecordsAreFetchedAndFinish___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] Done waiting on deserialize/xattr groups%@", v2, v3, v4, v5, v6);
}
...
- (void)stopWithError:.cold.1()
{
  ...
  uint64_t v1 = [v0 name];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] %@ resuming deserialize source which was waiting for batch save%@", v4, v5, v6, v7, v8);
}

- (void)finishWithResult:error:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _queryFinishedClientTruthCallback == nil%@", v2, v3, v4, v5, v6);
}

- (void)finishWithResult:error:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _queryFinishedServerTruthCallback == nil%@", v2, v3, v4, v5, v6);
}

- (void)finishWithResult:error:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self.cancelled || _deserializeGroup == nil%@", v2, v3, v4, v5, v6);
}

- (void)finishWithResult:error:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self.cancelled || _xattrFetchingGroup == nil%@", v2, v3, v4, v5, v6);
}
...
- (void)finishWithResult:error:.cold.5()
{
  ...
  uint64_t v1 = [v0 name];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] %@ finished record fetcher%@", v4, v5, v6, v7, v8);
}
...
- (void)_willFetchRecordForDeserialize:.cold.1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Fetch loop trying to fetch %@%@", v1, 0x16u);
}
...
void __59__BRCFetchRecordSubResourcesOperation__scheduleDeserialize__block_invoke_31_cold_1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] We can't find a record which really should exist - %@.  Unblocking other records from save%@", v1, 0x16u);
}
...
void __58__BRCFetchRecordSubResourcesOperation__scheduleXattrFetch__block_invoke_40_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a1;
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, a3, (uint64_t)a3, "[DEBUG] Removed xattr requirement from %lld in-memory subResourceRecords%@", (uint8_t *)&v3);
}
...
- (void)saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:.cold.1()
{
  ...
  uint64_t v1 = [v0 name];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0(&dword_1D353B000, v2, v3, "[DEBUG] %@ recreating pending changes stream with updated change token%@", v4, v5, v6, v7, v8);
}

- (void)saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !_queryFinishedClientTruthCallback%@", v2, v3, v4, v5, v6);
}

- (void)saveRecordsWithServerChangeToken:clientChangeToken:syncStatus:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !_queryFinishedServerTruthCallback%@", v2, v3, v4, v5, v6);
}

- (void)saveRecordsWithQueryCursor:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _pendingChangesStream%@", v2, v3, v4, v5, v6);
}
...
- (void)saveRecordsWithQueryCursor:(uint64_t)a3 .cold.2(void *a1, uint64_t a2, uint64_t a3, NSObject *a4)
{
  ...
  *(_WORD *)(a3 + 12) = 2112;
  *(void *)(a3 + 14) = a2;
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, a4, a3, "[DEBUG] %@ Destroying pending changes db because we are done with it%@", (uint8_t *)a3);
}

- (void)saveRecordsWithQueryCursor:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _pendingChangesStream || !cursor%@", v2, v3, v4, v5, v6);
}
