...
- (BRCFetchParentChainOperation)initWithParentID:(id)a3 sessionContext:(id)a4 zone:(id)a5 isUserWaiting:(BOOL)a6
{
  ...
  if (v17)
  {
    v18 = objc_msgSend(MEMORY[0x1E4F1A218], "br_fetchParentChain");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sync/fetch-parent-chain", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
  return v2;
}
...
- (void)_fetchParentChain:(id)a3
{
  ...
  {
    id v7 = objc_alloc(MEMORY[0x1E4F594E8]);
    v8 = [v4 zoneID];
    ...
    id v13 = objc_alloc(MEMORY[0x1E4F1A348]);
    v14 = (void *)[v13 initWithRecordID:v4 action:*MEMORY[0x1E4F19D98]];
    ...
    v18 = (void *)[objc_alloc(MEMORY[0x1E4F1A2A0]) initWithRecordType:@"FetchAncestors" predicate:v17];
    uint64_t v19 = (void *)[objc_alloc(MEMORY[0x1E4F1A2B8]) initWithQuery:v18];
    v20 = [v4 zoneID];
    [v19 setZoneID:v20];
  ...
  else
  {
    ...
    *(void *)(*(void *)(a1 + 40) + 520) = [*(id *)(a1 + 32) xattrsFetchedTotalSize];
    ...
    else
    {
      ...
      id v8 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: Couldn't allocate ranks when fetching parent chain");
...
- (void)main
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_debug_impl(&dword_1D353B000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetching parent chain of %@%@", (uint8_t *)&v4, 0x16u);
}
...
- (void)cancelToBeReplacedByOperation:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    ...
    __int16 v32 = 2112;
    v33 = v5;
    _os_log_debug_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEBUG, "[DEBUG] Cancelling %@ to be replaced by %@%@", buf, 0x20u);
  }
...
- (void)_fetchParentChain:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1D353B000, a2, OS_LOG_TYPE_DEBUG, "[DEBUG] found zone root record ID%@", (uint8_t *)&v2, 0xCu);
}
...
void __50__BRCFetchParentChainOperation__fetchParentChain___block_invoke_3_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Couldn't allocate ranks when fetching parent chain%@", (uint8_t *)&v2, 0xCu);
}
...
- (void)finishWithResult:(NSObject *)a3 error:.cold.1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v21 = 2112;
  uint64_t v22 = a2;
  _os_log_debug_impl(&dword_1D353B000, a3, OS_LOG_TYPE_DEBUG, "[DEBUG] Fetch parent chain of %@ took [%f] Secs and fetched [%llu,%llu] records [%llu] xattrs%@", (uint8_t *)&v11, 0x3Eu);
}
