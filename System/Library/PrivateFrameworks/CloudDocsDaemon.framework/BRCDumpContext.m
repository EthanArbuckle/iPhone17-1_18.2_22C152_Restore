...
+ (id)stringFromCount:(int64_t)a3 showActualCount:(BOOL)a4 suffix:(id)a5 isByteCount:(BOOL)a6 context:(id)a7
{
  ...
  if (v13 <= 0x3E7)
  {
    ...
    v16 = objc_msgSend(MEMORY[0x1E4F28E78], "stringWithFormat:", v14, v13, v15);
    goto LABEL_39;
  }
  if (v13 > 0xF423F)
  {
    if (v13 >= 0x3B9ACA00)
    {
      ...
      if (v13 > 0x2540BE3FFLL)
      {
        ...
        objc_msgSend(MEMORY[0x1E4F28E78], "stringWithFormat:", v25, v13 / 0x3B9ACA00, v26);
        goto LABEL_37;
      }
      if (a3 >= 0) {
        v21 = @"%.2f %@";
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x1E4F28E78], "stringWithFormat:", v17, v18, v19);
  }
  v27 = LABEL_37:;
  v16 = v27;
  if (v9) {
...
- (BRCDumpContext)initWithFile:(__sFILE *)a3 db:(id)a4
{
  ...
  if (v8)
  {
    ...
    uint64_t v13 = [objc_alloc(MEMORY[0x1E4F59498]) initWithFile:a3 forceColor:0];
    dumper = v9->_dumper;
...
- (id)highlightedString:(id)a3 type:(int64_t)a4
{
  ...
  {
    uint64_t v9 = dword_1D38875C4[v8];
    uint64_t v10 = dword_1D38875E0[v8];
  }
...
- (void)popIndentation
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: _indentation > 0%@", (uint8_t *)&v2, 0xCu);
}
