...
void __44__BRCUserDefaultsManager_initWithPersonaID___block_invoke(uint64_t a1, void *a2)
{
    ...
    || (id v4 = *(id *)(a1 + 32)) == 0)
  {
    if (BRCUserDefaultsPerVersionServerDictionaryKeyPrefix_block_invoke___personaOnceToken != -1) {
      dispatch_once(&BRCUserDefaultsPerVersionServerDictionaryKeyPrefix_block_invoke___personaOnceToken, &__block_literal_global_59);
    }
...
void __60__BRCUserDefaultsManager__loadServerConfigurationDictionary__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    id v5 = [MEMORY[0x1E4F18DD0] backgroundSessionConfigurationWithIdentifier:@"fetch-configuration"];
    [v5 setHTTPCookieStorage:0];
    [v5 setURLCredentialStorage:0];
    [v5 setURLCache:0];
    [v5 setDiscretionary:1];
    uint64_t v6 = [MEMORY[0x1E4F18DC0] sessionWithConfiguration:v5 delegate:*(void *)(a1 + 32) delegateQueue:*(void *)(*(void *)(a1 + 32) + 40)];
  ...
  {
LABEL_5:
    id v9 = [v3 downloadTaskWithURL:*(void *)(v2 + 8)];
...
- (id)defaultsForIdentifier:(id)a3
{
  ...
  uint64_t v6 = v5;
  uint64_t v7 = self->_userDefaultsCache;
  objc_sync_enter(v7);
  v8 = [(NSMutableDictionary *)self->_userDefaultsCache objectForKeyedSubscript:v6];
  if (!v8)
  {
    if (!v4
      || ([(NSMutableDictionary *)self->_userDefaultsCache objectForKeyedSubscript:@"default"], id v9 = objc_claimAutoreleasedReturnValue(), v9, !v9))
    {
      v10 = brc_bread_crumbs();
      v11 = brc_default_log();
...
- (void)_prepopulateGlobalUserDefaults
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !_userDefaultsCache[kBRCGlobalUserDefaultsKey]%@", v2, v3, v4, v5, v6);
}
...
- (BRCUserDefaultsManager)initWithPersonaID:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v17 = *MEMORY[0x1E4F28AC8];
...
- (void)_setServerConfigurationURL:(id)a3 whenLoaded:(id)a4
{
  ...
  id v9 = (void *)MEMORY[0x1D94389C0](v8);
  ...
  objc_sync_enter(v11);
  id v12 = [(NSDictionary *)self->_serverConfigurationDict objectForKeyedSubscript:@"etag"];
  ...
  uint64_t v17 = +[BRCUserDefaults defaultsForMangledID:0];
  uint64_t v18 = [v17 configurationUpdateXPCActivity];
  ...
  {
    uint64_t v22 = ((void (*)(void *))*MEMORY[0x1E4F59650])(v20);
...
void __64__BRCUserDefaultsManager__setServerConfigurationURL_whenLoaded___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (xpc_activity_should_defer(v3))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)((char *)&buf + 4) = v5;
      _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to defer the state%@", (uint8_t *)&buf, 0xCu);
    }
  }
    ...
    if (!xpc_activity_set_state(v3, 5))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)id v13 = 138412290;
        ...
        _os_log_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEFAULT, "[WARNING] Failed to set the xpc state to done%@", v13, 0xCu);
      }
    }
    __brc_leave_section((uint64_t *)&buf);
  }
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didFinishDownloadingToURL:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)long long buf = 134218754;
    ...
    __int16 v33 = 2112;
    v34 = v11;
    _os_log_debug_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx config: download task finished %@, plist %@%@", buf, 0x2Au);
  }
...
- (void)URLSession:(id)a3 didBecomeInvalidWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v8, (os_log_type_t)0x90u))
  {
    ...
    _os_log_error_impl(&dword_1D353B000, v8, (os_log_type_t)0x90u, "[ERROR] config: session %@ become invalid: %@%@", (uint8_t *)&v9, 0x20u);
  }
}
...
LABEL_14:
    ...
    if (os_log_type_enabled(v16, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)long long buf = 138413058;
      ...
      __int16 v25 = 2112;
      id v26 = v11;
      _os_log_error_impl(&dword_1D353B000, v16, (os_log_type_t)0x90u, "[ERROR] config: can't download task %@%@: %@%@", buf, 0x2Au);
    }
...
- (void)loadCachedServerConfiguration
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] Loaded cached server configuration %@%@", (void)v3, DWORD2(v3));
}
...
LABEL_11:
  ...
  id v23 = 0;
  id v6 = [MEMORY[0x1E4F28F98] propertyListWithData:v5 options:0 format:0 error:&v23];
  id v7 = v23;
  if (v6)
  {
...
LABEL_5:
  ...
  if (os_log_type_enabled(v20, (os_log_type_t)0x90u))
  {
    ...
    *(_DWORD *)long long buf = 138412802;
    ...
    __int16 v28 = 2112;
    __int16 v29 = v19;
    _os_log_error_impl(&dword_1D353B000, v20, (os_log_type_t)0x90u, "[ERROR] failed parsing plist at %@: %@%@", buf, 0x20u);
  }
...
- (void)_loadServerConfigurationDictionary
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)long long buf = 134218498;
    ...
    __int16 v17 = 2112;
    uint64_t v18 = v3;
    _os_log_debug_impl(&dword_1D353B000, v4, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx config: asynchronously loading %@%@", buf, 0x20u);
  }
  ...
  if ([(NSURL *)self->_serverConfigurationURL isFileURL])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)long long buf = 138412290;
      ...
      _os_log_impl(&dword_1D353B000, v6, OS_LOG_TYPE_DEFAULT, "[NOTICE] loading iCloud Drive configuration from disk%@", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)long long buf = 138412290;
      ...
      _os_log_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEFAULT, "[NOTICE] downloading iCloud Drive configuration%@", buf, 0xCu);
    }
...
void __44__BRCUserDefaultsManager_initWithPersonaID___block_invoke_cold_1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] ┏%llx defaults changed%@", (void)v3, DWORD2(v3));
}

- (void)defaultsForIdentifier:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: clientZoneIdentifier && _userDefaultsCache[kBRCGlobalUserDefaultsKey]%@", v2, v3, v4, v5, v6);
}

- (void)defaultsForIdentifier:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: ![clientZoneIdentifier isEqualToString:kBRCGlobalUserDefaultsKey]%@", v2, v3, v4, v5, v6);
}
...
- (void)_setServerConfigurationURL:whenLoaded:.cold.1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] ┏%llx config: initial load%@", (void)v3, DWORD2(v3));
}

- (void)_setServerConfigurationURL:whenLoaded:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[DEBUG] config: not updating the configuration, waiting for next activity callback%@", v2, v3, v4, v5, v6);
}
...
void __64__BRCUserDefaultsManager__setServerConfigurationURL_whenLoaded___block_invoke_cold_1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] ┏%llx config: it's activity time%@", (void)v3, DWORD2(v3));
}

- (void)URLSession:downloadTask:didFinishDownloadingToURL:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_4(&dword_1D353B000, v0, v1, "[ERROR] config: failed to move downloaded cache file into place %@%@");
}

- (void)URLSession:task:didCompleteWithError:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] config: download finished for %@%@");
}
...
- (void)_parsePlistWithURL:.cold.1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[DEBUG] config: Loaded server configuration from %@%@", (void)v3, DWORD2(v3));
}
...
- (void)_parsePlistWithURL:(uint8_t *)buf .cold.2(void *a1, uint64_t a2, uint8_t *buf, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a2;
  _os_log_debug_impl(&dword_1D353B000, log, OS_LOG_TYPE_DEBUG, "[DEBUG] Server configuration changed to etag %@%@", buf, 0x16u);
}

void __60__BRCUserDefaultsManager__loadServerConfigurationDictionary__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] scheduling config download %@%@");
}
