...
+ (id)_databaseRootDirectory
{
  ...
  if ([v3 isEqualToString:*MEMORY[0x1E4F592E0]])
  {
    uint64_t v4 = [MEMORY[0x1E4F594C0] cloudDocsAppSupportURL];
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v50 = 2112;
      v51 = v27;
      _os_log_error_impl(&dword_1D353B000, v28, (os_log_type_t)0x90u, "[ERROR] Failed creating root folder for DB: %@. %@%@", buf, 0x20u);
    }
...
void __54__BRCSQLBackedSet_initArrayOfClass_withSQLType_error___block_invoke_13(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v8;
    _os_log_error_impl(&dword_1D353B000, v9, (os_log_type_t)0x90u, "[ERROR] sqlite error handler called - %@ (%@)%@", (uint8_t *)&v11, 0x20u);
  }
...
void __54__BRCSQLBackedSet_initArrayOfClass_withSQLType_error___block_invoke_15(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v8;
    _os_log_error_impl(&dword_1D353B000, v9, (os_log_type_t)0x90u, "[ERROR] Auto rollback handler called - %@ (%@)%@", (uint8_t *)&v11, 0x20u);
  }
...
LABEL_17:
  ...
  {
    objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", @"object", 0);
...
- (void)initArrayOfClass:withSQLType:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0();
  _os_log_debug_impl(&dword_1D353B000, v0, OS_LOG_TYPE_DEBUG, "[DEBUG] Opening db at: %@%@", v1, 0x16u);
}
...
void __54__BRCSQLBackedSet_initArrayOfClass_withSQLType_error___block_invoke_cold_1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_1D353B000, v0, (os_log_type_t)0x90u, "[ERROR] db corruption handler called: %@%@", v1, 0x16u);
}
