...
void __37__BRCGlobalProgress_initWithSession___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained && WeakRetained[8])
  {
    ...
    [v6[10] updateUnitCount];
    [v6 _updateGlobalProgress];
    v2 = [v6[10] progress];
    int v3 = [v2 isFinished];

    if (v3) {
      [v6 _destroyDownloadWithReason:0];
    }
    id v4 = [v6[9] progress];
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v16 = [MEMORY[0x1E4F594D0] fileObjectIDWithString:v15];
    if (v16)
    {
      v17 = [v13 userInfo];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412290;
          v32 = v21;
          _os_log_impl(&dword_1D353B000, v22, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: observing a progress that doesn't have a progress group%@", buf, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v32 = v18;
        _os_log_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: observing a progress that doesn't have an objectID%@", buf, 0xCu);
      }
    }
  }
  else
...
void __68__BRCGlobalProgress_observeValueForKeyPath_ofObject_change_context___block_invoke(uint64_t a1)
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_debug_impl(&dword_1D353B000, v20, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: ignore delta update because %@ for doc with objectID %@ isn't tracked anymore%@", (uint8_t *)&v39, 0x20u);
    }
  ...
  id v11 = [*(id *)(a1 + 56) objectForKeyedSubscript:*MEMORY[0x1E4F284C8]];
  ...
  if (v9 > v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v45 = 2112;
      v46 = v13;
      _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: negative delta update for doc with objectID %@; [%lld -> %lld]%@",
        (uint8_t *)&v39,
        0x2Au);
    }
  ...
  if (v16)
  {
    if (v12 >= [v16 longLongValue])
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v47 = 2112;
        v48 = v24;
        _os_log_debug_impl(&dword_1D353B000, v25, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: ignore delta update ([%lld -> %lld] == %@) for doc with objectID %@ because it was counted as part of the resume operation%@", (uint8_t *)&v39, 0x34u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v47 = 2112;
        v48 = v22;
        _os_log_debug_impl(&dword_1D353B000, v23, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: ignore delta update ([%lld -> %lld] < %@) for doc with objectID %@ because it was counted as part of the resume operation%@", (uint8_t *)&v39, 0x34u);
      }
    }
    uint64_t v12 = 0;
    uint64_t v9 = 0;
...
LABEL_27:
  ...
  if (*(unsigned char *)(a1 + 72))
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_debug_impl(&dword_1D353B000, v30, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: %s finished for doc with objectID %@%@", (uint8_t *)&v39, 0x20u);
    }
...
- (void)willScheduleDocumentForDownload:(id)a3
{
  id v4 = a3;
  BOOL v5 = v4;
  if (v4 && [v4 isVisibleIniCloudDrive])
  {
    uint64_t v6 = [v5 desiredVersion];
    ...
    if (!v6)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_FAULT)) {
        -[BRCGlobalProgress willScheduleDocumentForDownload:]();
      }
    }
    uint64_t v7 = [v5 st];
    uint64_t v8 = [v7 documentID];

    uint64_t v9 = [v5 desiredVersion];
...
LABEL_12:
    ...
    else
    {
      brc_bread_crumbs();
      id v13 = (id)objc_claimAutoreleasedReturnValue();
      long long v14 = brc_notifications_log();
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG)) {
        -[BRCGlobalProgress willScheduleDocumentForDownload:]();
      }
    }
...
void __53__BRCGlobalProgress_willScheduleDocumentForDownload___block_invoke(uint64_t a1)
{
  ...
  int v2 = [*(id *)(*(void *)(a1 + 32) + 80) versionSizes];
  ...
  if (v3)
  {
    ...
    [*(id *)(a1 + 32) _cancelDownloadForObjectID:*(void *)(a1 + 40) destroyIfLast:0 willRetryTransfer:0];
  }
  uint64_t v6 = *(id **)(a1 + 32);
  id v7 = v6[10];
  if (v7)
  {
    objc_msgSend(v7, "setSumOfTotalUnitCountDelta:", *(void *)(a1 + 48) + objc_msgSend(v6[10], "sumOfTotalUnitCountDelta"));
    br_pacer_signal();
  }
  else
  {
    [v6 _createDownloadMetadataWithCompletedUnitCount:0 totalUnitCount:*(void *)(a1 + 48)];
  }
  uint64_t v8 = [NSNumber numberWithLongLong:*(void *)(a1 + 48)];
  uint64_t v9 = [*(id *)(*(void *)(a1 + 32) + 80) versionSizes];
  [v9 setObject:v8 forKeyedSubscript:*(void *)(a1 + 40)];

  uint64_t v10 = brc_bread_crumbs();
  id v11 = brc_notifications_log();
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v18 = 2112;
    uint64_t v19 = v10;
    _os_log_debug_impl(&dword_1D353B000, v11, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: start tracking download for doc with objectID %@ because document is pending-download (versionSize: %lld)%@", (uint8_t *)&v14, 0x20u);
  }
}
...
- (void)_resumeProgressForZone:(id)a3 startingRowID:(unint64_t)a4 whenDone:(id)a5
{
  ...
  __int16 v18 = [WeakRetained clientTruthWorkloop];
...
LABEL_8:
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v41 = 2112;
            uint64_t v42 = v12;
            _os_log_debug_impl(&dword_1D353B000, v13, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: resuming global progress for '%@'%@", buf, 0x16u);
          }
        ...
        __int16 v16 = [v10 asPrivateClientZone];
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v41 = 2112;
          uint64_t v42 = v15;
          _os_log_debug_impl(&dword_1D353B000, v19, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: nothing to resume for '%@'%@", buf, 0x16u);
        }
LABEL_17:
...
uint64_t __43__BRCGlobalProgress_stopPublishingProgress__block_invoke(uint64_t a1)
{
  ...
  long long v28 = 0u;
  long long v29 = 0u;
  __int16 v16 = objc_msgSend(*(id *)(*(void *)(a1 + 32) + 80), "childProgresses", 0);
  ...
  [*(id *)(a1 + 32) _destroyDownloadWithReason:3];
...
- (void)addProgress:(id)a3 forDocument:(id)a4 inGroup:(char)a5
{
  ...
  {
    uint64_t v12 = [v9 st];
    id v13 = [v12 documentID];

    if (v13)
    {
      int v14 = [v9 syncUpState];
      int v15 = [v9 fileObjectID];
      queue = self->_queue;
...
void __53__BRCGlobalProgress_addProgress_forDocument_inGroup___block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned char *)(a1 + 60) == 1)
  {
    ...
    if (v3)
    {
      uint64_t v4 = [v3 versionSizes];
      BOOL v5 = [v4 objectForKeyedSubscript:*(void *)(a1 + 40)];

      if (v5)
      {
        uint64_t v6 = [*(id *)(*(void *)(a1 + 32) + 72) childProgresses];
        ...
        if (v7)
        {
          ...
          if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
          {
            ...
            _os_log_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: attempt to add an upload progress more than once for doc with objectID %@%@", (uint8_t *)&v58, 0x16u);
          }

          [*(id *)(a1 + 32) _cancelUploadForObjectID:*(void *)(a1 + 40) inState:*(unsigned int *)(a1 + 56) willRetryTransfer:1];
        }
        uint64_t v11 = *(void *)(a1 + 48);
        uint64_t v12 = [*(id *)(*(void *)(a1 + 32) + 72) childProgresses];
        [v12 setObject:v11 forKeyedSubscript:*(void *)(a1 + 40)];

        id v13 = brc_bread_crumbs();
        int v14 = brc_notifications_log();
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          uint64_t v15 = *(void *)(a1 + 40);
          uint64_t v16 = [*(id *)(a1 + 48) totalUnitCount];
          int v58 = 138412802;
          uint64_t v59 = v15;
          __int16 v60 = 2048;
          uint64_t v61 = v16;
          __int16 v62 = 2112;
          v63 = v13;
          _os_log_debug_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: start tracking upload progress for doc with objectID %@ (progressSize: %lld)%@", (uint8_t *)&v58, 0x20u);
        }
        goto LABEL_34;
      }
    }
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint64_t v42 = "[WARNING] Progress: attempt to add an upload progress for doc with objectID %@ without a version size%@";
LABEL_25:
      _os_log_impl(&dword_1D353B000, v40, OS_LOG_TYPE_DEFAULT, v42, (uint8_t *)&v58, 0x16u);
      goto LABEL_26;
    }
    goto LABEL_26;
  }
  ...
  if (!v17
    || ([v17 versionSizes],
        ...
        [v18 objectForKeyedSubscript:*(void *)(a1 + 40)],
        ...
        !v19))
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v60 = 2112;
      uint64_t v61 = (uint64_t)v39;
      uint64_t v42 = "[WARNING] Progress: attempt to add a download progress for doc with objectID %@ without a version size%@";
      goto LABEL_25;
    }
LABEL_26:
  ...
  uint64_t v20 = [*(id *)(*(void *)(a1 + 32) + 80) childProgresses];
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1D353B000, v23, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: attempt to add a download progress more than once for doc with objectID %@%@", (uint8_t *)&v58, 0x16u);
    }

    [*(id *)(a1 + 32) _cancelDownloadForObjectID:*(void *)(a1 + 40) destroyIfLast:1 willRetryTransfer:1];
  }
  v25 = [*(id *)(*(void *)(a1 + 32) + 80) versionSizes];
  id v26 = [v25 objectForKeyedSubscript:*(void *)(a1 + 40)];
  uint64_t v27 = [v26 longLongValue];
  uint64_t v28 = [*(id *)(a1 + 48) totalUnitCount];
  ...
  long long v30 = [*(id *)(*(void *)(a1 + 32) + 80) childProgresses];
  [v30 setObject:v29 forKeyedSubscript:*(void *)(a1 + 40)];

  uint64_t v31 = [*(id *)(a1 + 48) completedUnitCount];
  long long v32 = [*(id *)(*(void *)(a1 + 32) + 80) resumeUnitCounts];
  id v13 = [v32 objectForKeyedSubscript:*(void *)(a1 + 40)];

  if (v31 >= [v13 longLongValue])
  {
    if (v13)
    {
      uint64_t v44 = brc_bread_crumbs();
      __int16 v45 = brc_notifications_log();
      if (os_log_type_enabled(v45, OS_LOG_TYPE_DEBUG))
      {
        uint64_t v53 = *(void *)(a1 + 40);
        uint64_t v54 = [*(id *)(a1 + 48) completedUnitCount];
        uint64_t v55 = [*(id *)(a1 + 48) totalUnitCount];
        int v58 = 138413314;
        uint64_t v59 = v53;
        __int16 v60 = 2048;
        uint64_t v61 = v54;
        ...
        __int16 v66 = 2112;
        v67 = v44;
        _os_log_debug_impl(&dword_1D353B000, v45, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: resume tracking download progress for doc with objectID %@ (completedSize: %lld (-%@), progressSize: %lld)%@", (uint8_t *)&v58, 0x34u);
      }

      int v14 = [*(id *)(*(void *)(a1 + 32) + 80) previousUnitCounts];
  ...
  {
    long long v33 = brc_bread_crumbs();
    long long v34 = brc_default_log();
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
    {
      uint64_t v35 = *(void *)(a1 + 40);
      uint64_t v36 = [*(id *)(a1 + 48) completedUnitCount];
      uint64_t v37 = [*(id *)(a1 + 48) totalUnitCount];
      int v58 = 138413314;
      uint64_t v59 = v35;
      __int16 v60 = 2048;
      uint64_t v61 = v36;
      ...
      __int16 v66 = 2112;
      v67 = v33;
      _os_log_impl(&dword_1D353B000, v34, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: progress for doc with objectID %@ has a negative value of completed unit count (completedSize: %lld (-%@), progressSize: %lld)%@", (uint8_t *)&v58, 0x34u);
    }

    objc_msgSend(*(id *)(*(void *)(a1 + 32) + 80), "setSumOfCompletedUnitCountDelta:", objc_msgSend(*(id *)(*(void *)(a1 + 32) + 80), "sumOfCompletedUnitCountDelta")- -[NSObject longLongValue](v13, "longLongValue"));
    uint64_t v38 = [*(id *)(*(void *)(a1 + 32) + 80) resumeUnitCounts];
    [v38 removeObjectForKey:*(void *)(a1 + 40)];
  }
  int v14 = brc_bread_crumbs();
  v46 = brc_notifications_log();
  if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
  {
    uint64_t v51 = *(void *)(a1 + 40);
    uint64_t v52 = [*(id *)(a1 + 48) totalUnitCount];
    int v58 = 138412802;
    uint64_t v59 = v51;
    __int16 v60 = 2048;
    uint64_t v61 = v52;
    __int16 v62 = 2112;
    v63 = v14;
    _os_log_debug_impl(&dword_1D353B000, v46, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: start tracking download progress for doc with objectID %@ (progressSize: %lld)%@", (uint8_t *)&v58, 0x20u);
  }

LABEL_34:
  __int16 v47 = *(void **)(a1 + 48);
  v48 = [*(id *)(a1 + 40) asString];
  [v47 setUserInfoObject:v48 forKey:@"_BRCObjectIDKey"];

  uint64_t v49 = *(void **)(a1 + 48);
  v50 = [NSNumber numberWithChar:*(char *)(a1 + 60)];
  [v49 setUserInfoObject:v50 forKey:@"_BRCProgressGroupKey"];
...
void __61__BRCGlobalProgress_updateUploadThrottleForDocument_toState___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      uint64_t v12 = v10;
      __int16 v13 = 2080;
      *(void *)int v14 = BRCPrettyPrintEnum();
      *(_WORD *)&v14[8] = 2112;
      *(void *)&v14[10] = v4;
      _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: stop tracking upload for doc with objectID %@ because transfer failed (toState: %s)%@", (uint8_t *)&v11, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&v14[14] = 2112;
      *(void *)&v14[16] = v6;
      _os_log_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: upload failed for doc with objectID %@ without being tracked (syncUpState: %d, toState: %s)%@", (uint8_t *)&v11, 0x26u);
    }
  }
}
  ...
  if (v6 && [v6 isVisibleIniCloudDrive] && (objc_msgSend(v7, "isDead") & 1) == 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT)) {
        -[BRCGlobalProgress updateDownloadThrottleForDocument:toState:]();
      }
    }
  }
}
...
void __63__BRCGlobalProgress_updateDownloadThrottleForDocument_toState___block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = [*(id *)(*(void *)(a1 + 32) + 80) versionSizes];
  uint64_t v3 = [v2 objectForKeyedSubscript:*(void *)(a1 + 40)];
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v11 = 2112;
      uint64_t v12 = v4;
      _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: stop tracking download progress for doc with objectID %@ because transfer failed (toState: %s)%@", (uint8_t *)&v7, 0x20u);
    }

    [*(id *)(a1 + 32) _cancelDownloadForObjectID:*(void *)(a1 + 40) destroyIfLast:1 willRetryTransfer:*(_DWORD *)(a1 + 48) == 1];
  }
}
...
uint64_t __35__BRCGlobalProgress_dumpToContext___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    BOOL v5 = [*(id *)(*(void *)(a1 + 32) + 64) localizedDescription];
    ...
    {
      [v2 writeLineWithFormat:@"global progress {%@ d:'%@%@'}", v4, v5, &stru_1F2AC7720];
    }
  }
  else
  {
  ...
  int v15 = [*(id *)(*(void *)(a1 + 32) + 72) childProgresses];
  ...
  if (v21)
  {
    uint64_t v23 = [*(id *)(*(void *)(a1 + 32) + 72) outOfQuotaObjIDs];
    uint64_t v24 = [v23 count];
    v25 = [*(id *)(*(void *)(a1 + 32) + 72) outOfQuotaObjIDs];
  ...
  if (v34)
  {
    uint64_t v36 = [*(id *)(*(void *)(a1 + 32) + 80) childProgresses];
    objc_msgSend(v35, "writeLineWithFormat:", @"download progresses (%lu): {", objc_msgSend(v36, "count"));

    [*(id *)(a1 + 40) pushIndentation];
    uint64_t v37 = [*(id *)(*(void *)(a1 + 32) + 80) childProgresses];
  ...
  uint64_t v41 = [*(id *)(*(void *)(a1 + 32) + 80) resumeUnitCounts];
  if ([v41 count])
  {
  ...
  return [*(id *)(a1 + 40) writeLineWithFormat:&stru_1F2AC7720];
}
...
- (void)_stopObservingProgress:(id)a3
{
  ...
  long long v14 = [MEMORY[0x1E4F594D0] fileObjectIDWithString:v13];
  if (!v14)
  {
...
- (id)_buildGlobalProgressObjectsWihCompletedUnitCount:(int64_t)a3 totalUnitCount:(int64_t)a4
{
  ...
  v13[4] = a3;
  void v13[5] = a4;
  uint64_t v7 = (void (**)(void, void))MEMORY[0x1D94389C0](v13);
  uint64_t v8 = [MEMORY[0x1E4F594C0] mobileDocumentsURL];
  uint64_t v9 = ((void (**)(void, void *))v7)[2](v7, v8);
  [v6 addObject:v9];
  uint64_t v10 = [v8 URLByAppendingPathComponent:*MEMORY[0x1E4F59420]];
  id v11 = ((void (**)(void, void *))v7)[2](v7, v10);
...
BRCProgress *__85__BRCGlobalProgress__buildGlobalProgressObjectsWihCompletedUnitCount_totalUnitCount___block_invoke(uint64_t a1, void *a2)
{
  ...
  [(BRCProgress *)v4 setUserInfoObject:v3 forKey:*MEMORY[0x1E4F28890]];
...
- (void)_createNewGlobalProgressInGroup:(id)a3 completedUnitCount:(int64_t)a4 totalUnitCount:(int64_t)a5
{
  ...
  if (!self->_lazyInitDone)
  {
    ...
    br_pacer_resume();
    uint64_t v10 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_queue);
    operationTimer = self->_operationTimer;
    ...
    {
      uint64_t v18 = ((void (*)(void *))*MEMORY[0x1E4F59658])(v16);
    }
  ...
  int v22 = [[BRCProgressMultiplex alloc] initWithUnderlineProgressObjects:v21];
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&location[4] = v33;
    __int16 v47 = 2112;
    v48 = v24;
    _os_log_debug_impl(&dword_1D353B000, v25, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: new global progress to track %s%@", location, 0x16u);
  }
...
LABEL_3:
  ...
  [(BRCGlobalProgress *)self _createNewGlobalProgressInGroup:&unk_1F2B26F70 completedUnitCount:a3 totalUnitCount:a4];
...
LABEL_3:
  ...
  if ([(BRCProgressMultiplex *)self->_globalProgressMultiplex indeterminate])
  {
    uint64_t v7 = brc_bread_crumbs();
    id v8 = brc_notifications_log();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
      -[BRCGlobalProgress _createDownloadMetadataWithCompletedUnitCount:totalUnitCount:]();
    }

    [(BRCGlobalProgress *)self _destroyProgressInGroup:0 reason:2];
  }
  BOOL v9 = objc_alloc_init(_BRCDownloadInfo);
  downloads = self->_downloads;
  self->_downloads = v9;

  id v11 = [(_BRCTransferInfo *)self->_downloads progress];
  [v11 setCompletedUnitCount:a3];

  long long v12 = [(_BRCTransferInfo *)self->_downloads progress];
  [v12 setTotalUnitCount:a4];

  long long v13 = [(_BRCTransferInfo *)self->_downloads progress];
  [v13 setCancellable:0];

  globalProgressMultiplex = self->_globalProgressMultiplex;
  if (!globalProgressMultiplex)
  {
    [(BRCGlobalProgress *)self _createNewGlobalProgressInGroup:&unk_1F2B26F58 completedUnitCount:a3 totalUnitCount:a4];
    globalProgressMultiplex = self->_globalProgressMultiplex;
  }
  if ([(BRCProgressMultiplex *)globalProgressMultiplex isPublished])
  {
    long long v15 = [(_BRCTransferInfo *)self->_downloads progress];
    objc_msgSend(v15, "brc_publish");
  }
  br_pacer_signal();
}
...
- (void)_updateGlobalProgress
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _globalProgressMultiplex.indeterminate%@", v2, v3, v4, v5, v6);
}
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)&v39[6] = v7;
      ...
      __int16 v44 = 2112;
      id v45 = v17;
      _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: cancelling upload for doc with objectID %@ (syncUpState: %d, willRetry: %d, pendingQuota:%d, hasProgress: %d)%@", (uint8_t *)&v36, 0x2Eu);
    }
...
LABEL_15:
        ...
        uint64_t v23 = [(_BRCTransferInfo *)self->_uploads versionSizes];
        uint64_t v24 = [v23 count];
    ...
    else
    {
      ...
      if (v6)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          ...
          __int16 v38 = 2112;
          *(void *)int v39 = v21;
          _os_log_impl(&dword_1D353B000, v22, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: forcing pending quota to NO for doc with objectID %@ because transfer isn't retryable%@", (uint8_t *)&v36, 0x16u);
        }
      }
    }
    dispatch_block_t v19 = [(_BRCUploadInfo *)self->_uploads outOfQuotaObjIDs];
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    int v36 = 138412290;
    id v37 = v12;
    _os_log_impl(&dword_1D353B000, v14, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: can't proceed to upload cancelation without objectID%@", (uint8_t *)&v36, 0xCu);
  }
LABEL_31:
}
...
- (void)_cancelDownloadForObjectID:(id)a3 destroyIfLast:(BOOL)a4 willRetryTransfer:(BOOL)a5
{
  ...
  if (v8)
  {
    BOOL v9 = [(_BRCTransferInfo *)self->_downloads versionSizes];
    ...
    id v11 = [(_BRCTransferInfo *)self->_downloads childProgresses];
    long long v12 = [v11 objectForKeyedSubscript:v8];

    long long v13 = [(_BRCTransferInfo *)self->_downloads previousUnitCounts];
    long long v14 = [v13 objectForKeyedSubscript:v8];

    long long v15 = [(_BRCDownloadInfo *)self->_downloads resumeUnitCounts];
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)((char *)&v39 + 2) = v12 != 0;
      HIWORD(v39) = 2112;
      __int16 v40 = v17;
      _os_log_debug_impl(&dword_1D353B000, v18, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: cancelling download for doc with objectID %@ (destroyIfLast: %d, willRetry: %d, hasProgress: %d)%@", (uint8_t *)&v35, 0x28u);
    }

    if (v12)
    {
      [(BRCGlobalProgress *)self _stopObservingProgress:v12];
      dispatch_block_t v19 = [(_BRCTransferInfo *)self->_downloads childProgresses];
    ...
    if (v5)
    {
      if (v14)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_WORD *)&v38[8] = 2112;
          int v39 = v20;
          _os_log_debug_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: keep %@ unit counts completed for doc with objectID %@%@", (uint8_t *)&v35, 0x20u);
        }

        int v22 = [(_BRCDownloadInfo *)self->_downloads resumeUnitCounts];
        [v22 setObject:v14 forKeyedSubscript:v8];
      }
      goto LABEL_28;
    }
    uint64_t v23 = [(_BRCTransferInfo *)self->_downloads versionSizes];
    [v23 removeObjectForKey:v8];

    uint64_t v24 = [(_BRCDownloadInfo *)self->_downloads resumeUnitCounts];
    [v24 removeObjectForKey:v8];

    long long v25 = [(_BRCTransferInfo *)self->_downloads versionSizes];
    uint64_t v26 = [v25 count];

    if (!v26 && v6)
    {
      [(BRCGlobalProgress *)self _destroyDownloadWithReason:1];
LABEL_28:
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(void *)__int16 v38 = v27;
          _os_log_impl(&dword_1D353B000, v28, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: download progress for doc with objectID %@ has no previous completed unit count%@", (uint8_t *)&v35, 0x16u);
        }
      }
      downloads = self->_downloads;
      dispatch_time_t v30 = v14;
    }
    else
    {
      if (!v16) {
    ...
    -[_BRCTransferInfo setSumOfCompletedUnitCountDelta:](downloads, "setSumOfCompletedUnitCountDelta:", -[_BRCTransferInfo sumOfCompletedUnitCountDelta](downloads, "sumOfCompletedUnitCountDelta")- [v30 longLongValue]);
LABEL_24:
    -[_BRCTransferInfo setSumOfTotalUnitCountDelta:](self->_downloads, "setSumOfTotalUnitCountDelta:", -[_BRCTransferInfo sumOfTotalUnitCountDelta](self->_downloads, "sumOfTotalUnitCountDelta")- [v10 longLongValue]);
    if (os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_DEBUG) && v6) {
      [(_BRCTransferInfo *)self->_downloads verifyFutureProgressIsNotFinished];
    }
    br_pacer_signal();
    goto LABEL_28;
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    int v35 = 138412290;
    id v36 = v10;
    _os_log_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: can't proceed to download cancelation without objectID%@", (uint8_t *)&v35, 0xCu);
  }
LABEL_29:
}
...
- (void)_destroyProgressInGroup:(id)a3 reason:(char)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    {
      [v6 integerValue];
      uint64_t v61 = (const char *)BRCPrettyPrintEnum();
    }
    else
    {
      uint64_t v61 = "none";
    ...
    *(_DWORD *)buf = 136315906;
    ...
    __int16 v99 = 2112;
    v100 = v11;
    _os_log_debug_impl(&dword_1D353B000, v12, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: did finish global progress (group: %s, reason: %s, userVisible: %d)%@", buf, 0x26u);
  }
  ...
  if ([v6 integerValue] == 1)
  {
    ...
    long long v87 = 0u;
    long long v88 = 0u;
    uint64_t v23 = [(_BRCTransferInfo *)self->_uploads childProgresses];
  ...
  else
  {
    ...
    int v35 = [(_BRCTransferInfo *)self->_downloads childProgresses];
    ...
    __int16 v37 = [(_BRCTransferInfo *)self->_downloads previousUnitCounts];
    ...
    long long v83 = 0u;
    long long v84 = 0u;
    uint64_t v41 = [(_BRCTransferInfo *)self->_downloads childProgresses];
...
LABEL_45:
  if (v7 == 1)
  {
    ...
    uint64_t v52 = [(_BRCTransferInfo *)self->_uploads progress];
...
LABEL_47:
    uint64_t v54 = [*p_uploads progress];
  ...
  if (v4 != 2 && v9 == 2)
  {
    ...
    int v58 = [(_BRCTransferInfo *)self->_downloads progress];
...
- (void)_destroyUploadWithReason:(char)a3
{
  ...
  if (self->_uploads)
  {
    [(BRCGlobalProgress *)self _destroyProgressInGroup:&unk_1F2B26F70 reason:v3];
  }
}
...
- (void)_destroyDownloadWithReason:(char)a3
{
  ...
  if (self->_downloads)
  {
    [(BRCGlobalProgress *)self _destroyProgressInGroup:&unk_1F2B26F58 reason:v3];
  }
}
...
- (void)_resumeProgressForAnotherOperationIfNeeded
{
  ...
  uint64_t v2 = [*v1 versionSizes];
  [v2 count];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, v3, "[NOTIF] Progress: resume download progress (%lu item downloading)%@", v4);
}
...
void __37__BRCGlobalProgress__updateDocument___block_invoke(uint64_t a1)
{
  ...
  {
    case 4:
      int v7 = [*(id *)(*(void *)(a1 + 32) + 72) versionSizes];
      int v8 = [v7 objectForKeyedSubscript:*(void *)(a1 + 40)];

      if (v8)
      {
        int v9 = [*(id *)(*(void *)(a1 + 32) + 72) childProgresses];
        id v61 = [v9 objectForKeyedSubscript:*(void *)(a1 + 40)];

        BOOL v10 = v61;
        if (v61)
        {
          [*(id *)(a1 + 32) _stopObservingProgress:v61];
      ...
      {
        uint64_t v29 = *(void *)(a1 + 48);
        uint64_t v30 = 105 * v29 / 100;
        if (v30 == v29) {
          uint64_t v31 = v30 + 1;
        }
        else {
          uint64_t v31 = 105 * v29 / 100;
        }
        long long v32 = *(id **)(a1 + 32);
        id v33 = v32[9];
        if (v33)
        {
          objc_msgSend(v33, "setSumOfCompletedUnitCountDelta:", *(void *)(a1 + 48) + objc_msgSend(v32[9], "sumOfCompletedUnitCountDelta"));
          objc_msgSend(*(id *)(*(void *)(a1 + 32) + 72), "setSumOfTotalUnitCountDelta:", objc_msgSend(*(id *)(*(void *)(a1 + 32) + 72), "sumOfTotalUnitCountDelta") + v31);
          br_pacer_signal();
        }
        else
        {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138413058;
          ...
          __int16 v68 = 2112;
          v69 = v46;
          _os_log_debug_impl(&dword_1D353B000, v47, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: resume upload for doc with objectID %@ because document is needs-sync-up but not tracked yet (versionSize: %lld, transferSize: %lld)%@", buf, 0x2Au);
        }
      }
      break;
    case 3:
      ...
      uint64_t v14 = [v12 objectForKeyedSubscript:*(void *)(a1 + 40)];
      ...
      if (v14)
      {
        if (*(_DWORD *)(a1 + 60) == 4)
        {
          ...
          [*(id *)(a1 + 32) _cancelUploadForObjectID:*(void *)(a1 + 40) inState:*(unsigned int *)(a1 + 60) willRetryTransfer:1];
        }
        else
        {
          int v39 = brc_bread_crumbs();
          ...
          if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            _os_log_impl(&dword_1D353B000, v40, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: doc with objectID %@ shouldn't be uploading before its status is set to needs-upload%@", buf, 0x16u);
          }
        }
      }
      else
      {
        ...
        uint64_t v35 = 105 * v34 / 100;
        if (v35 == v34) {
          uint64_t v36 = v35 + 1;
        }
        else {
          uint64_t v36 = 105 * v34 / 100;
        }
        __int16 v37 = *(id **)(a1 + 32);
        id v38 = v37[9];
        if (v38)
        {
        ...
        {
          [v37 _createUploadMetadataWithCompletedUnitCount:0 totalUnitCount:v36];
        }
        v48 = [NSNumber numberWithLongLong:*(void *)(a1 + 48)];
        uint64_t v49 = [*(id *)(*(void *)(a1 + 32) + 72) versionSizes];
        [v49 setObject:v48 forKeyedSubscript:*(void *)(a1 + 40)];

        v50 = brc_bread_crumbs();
        uint64_t v51 = brc_notifications_log();
        if (os_log_type_enabled(v51, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138413058;
          ...
          __int16 v68 = 2112;
          v69 = v50;
          _os_log_debug_impl(&dword_1D353B000, v51, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: start tracking upload for doc with objectID %@ because document is needs-upload (versionSize: %lld, transferSize: %lld)%@", buf, 0x2Au);
        }

        if (*(unsigned char *)(a1 + 64))
        {
          char v22 = [*(id *)(*(void *)(a1 + 32) + 72) outOfQuotaObjIDs];
      ...
      break;
    case 2:
      uint64_t v3 = [*(id *)(*(void *)(a1 + 32) + 72) versionSizes];
      ...
      return;
    default:
      int v21 = [*(id *)(*(void *)(a1 + 32) + 72) versionSizes];
      char v22 = [v21 objectForKeyedSubscript:*(void *)(a1 + 40)];
      ...
      if (v22)
      {
        if (*(_DWORD *)(a1 + 60) == 4)
        {
          ...
          if (105 * v23 / 100 == v23) {
            ...
            uint64_t v24 = 105 * v23 / 100 - v23;
          }
          if (v24 <= 0)
          {
            int v59 = brc_bread_crumbs();
            __int16 v60 = brc_default_log();
            if (os_log_type_enabled(v60, OS_LOG_TYPE_FAULT)) {
              __37__BRCGlobalProgress__updateDocument___block_invoke_cold_1();
            }
          }
          objc_msgSend(*(id *)(*(void *)(a1 + 32) + 72), "setSumOfCompletedUnitCountDelta:", objc_msgSend(*(id *)(*(void *)(a1 + 32) + 72), "sumOfCompletedUnitCountDelta") + v24);
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            _os_log_debug_impl(&dword_1D353B000, v26, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: stop tracking upload for doc with objectID %@ because document is idle (syncUpSize: %lld)%@", buf, 0x20u);
          }

          uint64_t v27 = [*(id *)(*(void *)(a1 + 32) + 72) versionSizes];
          [v27 removeObjectForKey:*(void *)(a1 + 40)];

          double v28 = [*(id *)(*(void *)(a1 + 32) + 72) outOfQuotaObjIDs];
          [v28 removeObject:*(void *)(a1 + 40)];
...
- (void)_deleteDocument:(id)a3 reason:(char)a4 sync:(BOOL)a5
{
  ...
  if ([v10 rawID])
  {
    ...
    char v20 = a4;
    int v19 = v12;
    uint64_t v13 = (void *)MEMORY[0x1D94389C0](v17);
    queue = self->_queue;
    if (v5) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v15;
      _os_log_impl(&dword_1D353B000, v16, OS_LOG_TYPE_DEFAULT, "[WARNING] Progress: can't delete document from progress without an objectID %@%@", buf, 0x16u);
    }
  }
}
...
void __49__BRCGlobalProgress__deleteDocument_reason_sync___block_invoke(uint64_t a1)
{
  ...
  int v2 = [*(id *)(*(void *)(a1 + 32) + 72) versionSizes];
  uint64_t v3 = [v2 objectForKeyedSubscript:*(void *)(a1 + 40)];

  id v4 = [*(id *)(*(void *)(a1 + 32) + 80) versionSizes];
  BOOL v5 = [v4 objectForKeyedSubscript:*(void *)(a1 + 40)];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      uint64_t v14 = v10;
      __int16 v15 = 2080;
      uint64_t v16 = BRCPrettyPrintEnum();
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_debug_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: stop tracking download progress of doc with objectID %@ (reason: %s)%@", (uint8_t *)&v13, 0x20u);
    }

    [*(id *)(a1 + 32) _cancelDownloadForObjectID:*(void *)(a1 + 40)];
  }
  if (v3)
  {
    id v8 = brc_bread_crumbs();
    int v9 = brc_notifications_log();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      uint64_t v11 = *(void *)(a1 + 40);
      uint64_t v12 = BRCPrettyPrintEnum();
      int v13 = 138412802;
      uint64_t v14 = v11;
      __int16 v15 = 2080;
      uint64_t v16 = v12;
      __int16 v17 = 2112;
      id v18 = v8;
      _os_log_debug_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEBUG, "[NOTIF] Progress: stop tracking upload progress of doc with objectID %@ (reason: %s)%@", (uint8_t *)&v13, 0x20u);
    }
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[NOTIF] Progress: ignore download for doc %@ because its version size is equal to zero%@");
}

- (void)willScheduleDocumentForDownload:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: can't register progress for item without a document id %@%@");
}

- (void)willScheduleDocumentForDownload:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: item.desiredVersion%@", v2, v3, v4, v5, v6);
}
...
void __53__BRCGlobalProgress_willScheduleDocumentForDownload___block_invoke_cold_1()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  ...
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[NOTIF] Progress: update details for download of doc with objectID %@ because it was edited%@", (void)v3, DWORD2(v3));
}
...
void __44__BRCGlobalProgress_resumeProgressForZones___block_invoke_cold_1()
{
  ...
  [*v1 count];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, v2, "[NOTIF] Progress: started resuming progress for %lu zones%@", v3);
}

void __44__BRCGlobalProgress_resumeProgressForZones___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !self->_resumeTracker%@", v2, v3, v4, v5, v6);
}

void __44__BRCGlobalProgress_resumeProgressForZones___block_invoke_142_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[NOTIF] Progress: finished resuming progresses%@", v2, v3, v4, v5, v6);
}
...
- (void)didUpdateDocument:.cold.1()
{
  OUTLINED_FUNCTION_8();
  uint64_t v5 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = [v1 fileObjectID];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, v3, "[NOTIF] Progress: doc %@ was reparented outside the visible scope of iCloud Drive, force deletion%@", v4);
}
...
- (void)didUpdateDocument:.cold.2()
{
  ...
  uint64_t v2 = [v1 fileObjectID];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5_0(&dword_1D353B000, v0, v3, "[NOTIF] Progress: doc %@ is now dead, force deletion%@", v4);
}

- (void)didDeleteDocument:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: item%@", v2, v3, v4, v5, v6);
}

void __43__BRCGlobalProgress_stopPublishingProgress__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[NOTIF] Progress: stop publishing global progress%@", v2, v3, v4, v5, v6);
}

- (void)addProgress:forDocument:inGroup:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: can't add progress for item without a document id %@%@");
}

- (void)addProgress:forDocument:inGroup:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: group == BRCProgressUploadGroup || group == BRCProgressDownloadGroup%@", v2, v3, v4, v5, v6);
}

- (void)addProgress:forDocument:inGroup:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: progress%@", v2, v3, v4, v5, v6);
}

void __53__BRCGlobalProgress_addProgress_forDocument_inGroup___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: [self->_downloads.versionSizes[objID] longLongValue] == progress.totalUnitCount%@", v2, v3, v4, v5, v6);
}
...
- (void)updateUploadThrottleForDocument:toState:.cold.1()
{
  ...
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't update progress for document without an objectID %@%@", (uint8_t *)&v1, 0x16u);
}
...
- (void)updateDownloadThrottleForDocument:toState:.cold.1()
{
  ...
  uint64_t v2 = 0;
  OUTLINED_FUNCTION_9_0();
  _os_log_fault_impl(&dword_1D353B000, v0, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: can't update dowload throttle progress for item without an objectID %@%@", (uint8_t *)&v1, 0x16u);
}

- (void)_stopObservingProgress:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: progressGroup%@", v2, v3, v4, v5, v6);
}

- (void)_stopObservingProgress:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: objID%@", v2, v3, v4, v5, v6);
}

- (void)_createNewGlobalProgressInGroup:completedUnitCount:totalUnitCount:.cold.1()
{
  OUTLINED_FUNCTION_10_0();
  OUTLINED_FUNCTION_15_0(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Invalid suspend count (_operationTimerSuspendCount: %u)%@");
}

- (void)_createNewGlobalProgressInGroup:completedUnitCount:totalUnitCount:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _operationTimer%@", v2, v3, v4, v5, v6);
}

- (void)_createNewGlobalProgressInGroup:completedUnitCount:totalUnitCount:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: !group || BRCProgressGroupPrettyPrint(group.intValue)%@", v2, v3, v4, v5, v6);
}

- (void)_createNewGlobalProgressInGroup:completedUnitCount:totalUnitCount:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: (!group && totalUnitCount >= 0) || totalUnitCount > 0%@", v2, v3, v4, v5, v6);
}

- (void)_createNewGlobalProgressInGroup:completedUnitCount:totalUnitCount:.cold.5()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: completedUnitCount >= 0%@", v2, v3, v4, v5, v6);
}

- (void)_createNewGlobalProgressInGroup:completedUnitCount:totalUnitCount:.cold.6()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _globalProgressMultiplex == nil%@", v2, v3, v4, v5, v6);
}

- (void)_createUploadMetadataWithCompletedUnitCount:totalUnitCount:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[NOTIF] Progress: take over current progress because uploads have priority%@", v2, v3, v4, v5, v6);
}

- (void)_createUploadMetadataWithCompletedUnitCount:totalUnitCount:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: totalUnitCount >= completedUnitCount%@", v2, v3, v4, v5, v6);
}

- (void)_createUploadMetadataWithCompletedUnitCount:totalUnitCount:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _uploads == nil%@", v2, v3, v4, v5, v6);
}

- (void)_createDownloadMetadataWithCompletedUnitCount:totalUnitCount:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2_0(&dword_1D353B000, v0, v1, "[NOTIF] Progress: take over on current progress because downloads have priority%@", v2, v3, v4, v5, v6);
}

- (void)_createDownloadMetadataWithCompletedUnitCount:totalUnitCount:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _downloads == nil%@", v2, v3, v4, v5, v6);
}

- (void)_cancelUploadForObjectID:inState:willRetryTransfer:pendingQuota:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: objectID%@", v2, v3, v4, v5, v6);
}

- (void)_cancelUploadForObjectID:inState:willRetryTransfer:pendingQuota:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[NOTIF] Progress: upload progress for doc with objectID %@ has no previous completed unit count%@");
}

- (void)_cancelUploadForObjectID:inState:willRetryTransfer:pendingQuota:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: versionSize%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _uploads.outOfQuotaObjIDs.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _uploads.previousUnitCounts.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _uploads.childProgresses.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.5()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _uploads.versionSizes.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.6()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _downloads.resumeUnitCounts.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.7()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _downloads.previousUnitCounts.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.8()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _downloads.childProgresses.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.9()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: _downloads.versionSizes.count == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.10()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: transferInfo.sumOfTotalUnitCountDelta == 0%@", v2, v3, v4, v5, v6);
}

- (void)_destroyProgressInGroup:reason:.cold.11()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: transferInfo.sumOfCompletedUnitCountDelta == 0%@", v2, v3, v4, v5, v6);
}

- (void)_updateDocument:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[NOTIF] Progress: ignore upload for doc with objectID %@ because its version size is equal to zero.%@");
}

- (void)_updateDocument:.cold.2()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: can't register progress for item without an objectID %@%@");
}

void __37__BRCGlobalProgress__updateDocument___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: syncUpSize > 0%@", v2, v3, v4, v5, v6);
}
...
void __37__BRCGlobalProgress__updateDocument___block_invoke_cold_2()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[NOTIF] Progress: cancelling upload for doc with objectID %@ because its wasn't uploaded%@", (void)v3, DWORD2(v3));
}
...
void __37__BRCGlobalProgress__updateDocument___block_invoke_cold_3()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[NOTIF] Progress: stop tracking upload for doc with objectID %@ because document is in needs-read%@", (void)v3, DWORD2(v3));
}

void __37__BRCGlobalProgress__updateDocument___block_invoke_cold_4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: [self->_uploads.versionSizes[objID] longLongValue] == versionSize%@", v2, v3, v4, v5, v6);
}
...
void __37__BRCGlobalProgress__updateDocument___block_invoke_cold_5()
{
  ...
  *(void *)((char *)&v3 + 4) = v0;
  OUTLINED_FUNCTION_3_1();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v1, v2, "[NOTIF] Progress: cancelling upload for doc with objectID %@ because its needs to be uploaded again%@", (void)v3, DWORD2(v3));
}
