  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, (os_log_type_t)0x90u))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v14 = 2112;
      objc_super v15 = v6;
      _os_log_error_impl(&dword_1D353B000, v7, (os_log_type_t)0x90u, "[ERROR] failed saving sharing options update %@: %@%@", buf, 0x20u);
    }
    int64_t v5 = 0;
  }
  ...
  if ([(BRCPQLConnection *)self->super._db changes])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218242;
      ...
      __int16 v30 = 2112;
      v31 = v8;
      _os_log_impl(&dword_1D353B000, v9, OS_LOG_TYPE_DEFAULT, "[WARNING] Forced %lld orphans to be tombstones in the shared zone%@", buf, 0x16u);
    }
  }
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 134218498;
            ...
            __int16 v32 = 2112;
            v33 = v20;
            _os_log_debug_impl(&dword_1D353B000, v21, OS_LOG_TYPE_DEBUG, "[DEBUG] propagated delete of %lld recursive children of %@%@", buf, 0x20u);
          }
        }
        if (([v11 next] & 1) == 0)
        {
...
- (void)sideCarZoneWasReset
{
  ...
  BOOL v3 = [(BRCAccountSession *)self->super._session clientTruthWorkloop];
...
- (BRCSyncContext)transferSyncContext
{
  BOOL v3 = [(BRCAccountSession *)self->super._session syncContextProvider];
...
- (void)_propagateFolderDeletesToTheirChildren
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_fault_impl(&dword_1D353B000, a2, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: Path depth overflow%@", (uint8_t *)&v2, 0xCu);
}
