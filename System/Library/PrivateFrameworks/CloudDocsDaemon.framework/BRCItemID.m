...
- (id)documentStructureRecordIDInZoneID:(id)a3
{
  ...
  id v7 = (void *)[objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:v6 zoneID:v4];
  return v7;
}

- (id)validatingDirectoryReferenceInZone:(id)a3
{
  return [(BRCItemID *)self directoryReferenceInZone:a3 action:*MEMORY[0x1E4F19D98]];
}
...
- (id)pcsChainDocumentStructureReferenceInZoneID:(id)a3
{
  ...
  id v7 = (void *)[objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:v6 zoneID:v4];
  v8 = (void *)[objc_alloc(MEMORY[0x1E4F1A348]) initWithRecordID:v7 action:0];
...
- (id)sideCarRecordIDWithZone:(id)a3
{
  id v4 = (void *)MEMORY[0x1E4F1A320];
  id v5 = a3;
  uint64_t v6 = objc_msgSend(v4, "brc_sideCarZoneID");
  id v7 = [(BRCItemID *)self sideCarRecordNameWithZone:v5];

  id v8 = (void *)[objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:v7 zoneID:v6];
  return v8;
}
...
- (id)directoryReferenceInZone:(id)a3 action:(unint64_t)a4
{
  ...
  v12 = (void *)[objc_alloc(MEMORY[0x1E4F1A348]) initWithRecordID:v11 action:a4];
...
+ (id)defaultDesktopItemID
{
  ...
  id v3 = [(BRCItemID *)v2 initWithUUIDString:*MEMORY[0x1E4F59428]];
  return v3;
}
...
{
  id v2 = [BRCItemID alloc];
  id v3 = [(BRCItemID *)v2 initWithUUIDString:*MEMORY[0x1E4F59438]];
  return v3;
}
...
+ (id)newFromSqliteValue:(sqlite3_value *)a3
{
  *(void *)&v23[13] = *MEMORY[0x1E4F143B8];
  ...
  if (v4 != 4)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
    {
      v18 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v10 length:v11];
      int v20 = 138412802;
      v21 = v18;
      __int16 v22 = 1024;
      *(_DWORD *)uint64_t v23 = v5;
      v23[2] = 2112;
      *(void *)&v23[3] = v12;
      _os_log_fault_impl(&dword_1D353B000, v13, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unmigrated? invalid BRCItemID (%@) - %d%@", (uint8_t *)&v20, 0x1Cu);
    }
    return 0;
  }
  ...
  if (v7 != 5)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
    {
      v19 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v6 length:v14];
      int v20 = 138412546;
      v21 = v19;
      __int16 v22 = 2112;
      *(void *)uint64_t v23 = v16;
      _os_log_fault_impl(&dword_1D353B000, v17, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid BRCItemID (%@)%@", (uint8_t *)&v20, 0x16u);
    }
    return 0;
  }
...
+ (id)newFromSqliteStatement:(sqlite3_stmt *)a3 atIndex:(int)a4
{
  *(void *)&v23[13] = *MEMORY[0x1E4F143B8];
  ...
  if (v6 != 4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
    {
      v19 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v12 length:v13];
      int v20 = 138412802;
      v21 = v19;
      __int16 v22 = 1024;
      *(_DWORD *)uint64_t v23 = v7;
      v23[2] = 2112;
      *(void *)&v23[3] = v14;
      _os_log_fault_impl(&dword_1D353B000, v15, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: unmigrated? invalid BRCItemID (%@) - %d%@", (uint8_t *)&v20, 0x1Cu);
    }
    goto LABEL_9;
  }
  ...
  if (v9 != 5)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
    {
      v18 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v8 length:v16];
      int v20 = 138412546;
      v21 = v18;
      __int16 v22 = 2112;
      *(void *)uint64_t v23 = v14;
      _os_log_fault_impl(&dword_1D353B000, v15, OS_LOG_TYPE_FAULT, "[CRIT] UNREACHABLE: invalid BRCItemID (%@)%@", (uint8_t *)&v20, 0x16u);
    }
LABEL_9:
...
+ (id)parseMangledItemIDString:(id)a3 mangledID:(id *)a4 etag:(id *)a5 session:(id)a6
{
  ...
  if ([v11 count] == 3)
  {
    ...
    v18 = (void *)[objc_alloc(MEMORY[0x1E4F594E8]) initWithMangledString:v14];
    if (a4) {
...
LABEL_15:
  ...
  if ([v11 count] == 4)
  {
    ...
    __int16 v22 = (void *)[objc_alloc(MEMORY[0x1E4F594E8]) initWithZoneName:v21 ownerName:v18];
    v17 = [[BRCItemID alloc] initWithUUIDString:v15];
    if (a4) {
...
+ (BOOL)migrateItemIDsToVersion5WithDB:(id)a3 serverTruth:(BOOL)a4
{
  ...
  objc_super v8 = [MEMORY[0x1E4FBA900] nameWithString:v6];
  id v9 = [MEMORY[0x1E4FBA900] nameWithString:v7];
  id v10 = (void *)[v5 fetch:@"SELECT rowid FROM %@ WHERE zone_owner != %@", v9, *MEMORY[0x1E4F19C08]];
  if ([v10 next])
  {
    BOOL v21 = v4;
    char v11 = 1;
    do
    {
      ...
      if (!v25)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          v27 = v16;
          _os_log_fault_impl(&dword_1D353B000, v17, OS_LOG_TYPE_FAULT, "[CRIT] Assertion failed: rio.app_lib_rowid%@", buf, 0xCu);
        }
      }
      ...
      if (v11)
      {
        ...
        id v14 = v12;
        id v23 = v14;
        uint64_t v15 = (void *)MEMORY[0x1D94389C0](v22);
  ...
  if (![v5 execute:@"UPDATE %@ SET item_id = call_block(%@, item_id, zone_rowid) WHERE item_type = 3", v8, &__block_literal_global_31]|| !objc_msgSend(v5, "execute:", @"UPDATE %@ SET item_parent_id = call_block(%@, zone_rowid) WHERE item_parent_id = \"root\", v8, &__block_literal_global_65)|| !objc_msgSend(v5, "execute:", @"UPDATE %@ SET item_parent_id = call_block(%@, zone_rowid) WHERE item_parent_id = \"documents\", v8, &__block_literal_global_68))
  {
LABEL_26:
    char v19 = 0;
    goto LABEL_27;
...
void __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_59(uint64_t a1, sqlite3_context *a2, int a3, sqlite3_value **a4)
{
  ...
  if (a3 != 2)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT)) {
      __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_59_cold_3();
    }
  }
...
+ (BOOL)migrateItemIDsToVersion11WithDB:(id)a3 serverTruth:(BOOL)a4
{
  ...
  int v8 = [MEMORY[0x1E4FBA900] nameWithString:v6];
  long long v17 = [MEMORY[0x1E4FBA900] nameWithString:v7];
  char v9 = (void *)[v5 fetch:@"SELECT rowid FROM %@ WHERE zone_owner != %@", v17, *MEMORY[0x1E4F19C08]];
  if ([v9 next])
  {
    char v10 = 1;
    do
    {
      ...
      if (v10)
      {
        ...
        id v14 = v11;
        id v19 = v14;
        char v15 = (void *)MEMORY[0x1D94389C0](v18);
...
- (void)appLibraryRowID
{
  ...
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self.isNonDesktopRoot || self.isDocumentsFolder%@", v2, v3, v4, v5, v6);
}

- (void)sharedZoneRowID
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: self.isSharedZoneRoot%@", v2, v3, v4, v5, v6);
}

- (void)zoneUniqueItemIDStringWithSession:.cold.1()
{
  OUTLINED_FUNCTION_10_0();
  OUTLINED_FUNCTION_15_0(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: unknown itemID type %d%@");
}

- (void)zoneUniqueItemIDStringWithSession:.cold.3()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: sharedZone%@", v2, v3, v4, v5, v6);
}

- (void)debugItemIDStringWithVerbose:.cold.2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: we should not have alias or share uuid types anymores%@", v2, v3, v4, v5, v6);
}

- (void)isEqualToItemID:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: we should not have alias or shared uuid types anymores%@", v2, v3, v4, v5, v6);
}

- (void)initWithString:libraryRowID:sharedZoneRowID:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: libraryRowID || sharedZoneRowID%@", v2, v3, v4, v5, v6);
}
...
- (void)initWithUUIDString:(void *)a1 .cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_5(&dword_1D353B000, v1, v2, "[CRIT] UNREACHABLE: invalid UUID: %s%@", v3, v4, v5, v6, v7);
}

- (void)_initAsLibraryRootWithAppLibraryRowID:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: can't initialize library root with invalid library rowid %@%@");
}

- (void)_initAsZoneRootWithZoneRowID:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: can't initialize shared zone root with invalid zone rowid %@%@");
}

- (void)initAsDocumentsWithAppLibraryRowID:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_1(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: can't initialize document with invalid library rowid %@%@");
}

- (void)initWithRootObject:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: object->item_code == BRCItemIDCodeDocuments || object->item_code == BRCItemIDCodeZoneRoot || object->item_code == BRCItemIDCodeSharedZoneRoot%@", v2, v3, v4, v5, v6);
}

+ (void)appLibraryRowIDFromRootOrDocumentsSQLiteValue:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: appLibraryRowID%@", v2, v3, v4, v5, v6);
}

- (void)initWithCoder:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: decoding an unknown kind of itemid%@", v2, v3, v4, v5, v6);
}

- (void)encodeWithCoder:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: encoding an item id with an unknown kind%@", v2, v3, v4, v5, v6);
}

- (void)sqliteBind:index:.cold.1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: unknown itemID kind%@", v2, v3, v4, v5, v6);
}

- (void)sqliteBind:index:.cold.4()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: rio.zone_rowid%@", v2, v3, v4, v5, v6);
}
...
+ (void)parseMangledItemIDString:(void *)a1 mangledID:etag:session:.cold.1(void *a1)
{
  [a1 UTF8String];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_5(&dword_1D353B000, v1, v2, "[CRIT] UNREACHABLE: unparsable mangled itemID: %s%@", v3, v4, v5, v6, v7);
}

void __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Invalid Shared ItemID%@", v2, v3, v4, v5, v6);
}

void __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: len == sizeof(uuid_t)%@", v2, v3, v4, v5, v6);
}

void __56__BRCItemID_migrateItemIDsToVersion5WithDB_serverTruth___block_invoke_59_cold_3()
{
  OUTLINED_FUNCTION_3_0();
...
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: Invalid Alias ItemID%@", v2, v3, v4, v5, v6);
}

void __56__BRCItemID_migrateItemIDsToVersion8WithDB_serverTruth___block_invoke_cold_2()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: len == sizeof(_UUIDItemObject_OLD)%@", v2, v3, v4, v5, v6);
}

void __57__BRCItemID_migrateItemIDsToVersion11WithDB_serverTruth___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: p->item_code == _UNUSED_BRCItemIDCodeSharedUUID%@", v2, v3, v4, v5, v6);
}

void __57__BRCItemID_migrateItemIDsToVersion11WithDB_serverTruth___block_invoke_88_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] Assertion failed: len == sizeof(_UUIDItemObject_OLD) && ((_UUIDItemObject_OLD*)blob)->item_code == BRCItemIDCodeSharedZoneRoot%@", v2, v3, v4, v5, v6);
}
