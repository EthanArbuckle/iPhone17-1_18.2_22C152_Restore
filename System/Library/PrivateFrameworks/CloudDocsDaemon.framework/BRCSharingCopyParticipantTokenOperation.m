...
- (BRCSharingCopyParticipantTokenOperation)initWithItem:(id)a3 sessionContext:(id)a4
{
  ...
  if (v13)
  {
    ...
    uint64_t v15 = objc_msgSend(MEMORY[0x1E4F1A2F8], "brc_fetchShareIDWithSharedItem:", v6);
    ...
    v19 = objc_msgSend(MEMORY[0x1E4F1A218], "br_sharingMisc");
...
- (id)createActivity
{
  os_activity_t v2 = _os_activity_create(&dword_1D353B000, "sharing/copyParticipantToken", MEMORY[0x1E4F144F0], OS_ACTIVITY_FLAG_DEFAULT);
...
- (void)_fetchBaseTokenWithCompletion:(id)a3
{
  ...
  if (self->_iWorkShareable && !self->_isChildOfShare)
  {
    ...
    uint64_t v12 = *MEMORY[0x1E4F19DF0];
...
void __73__BRCSharingCopyParticipantTokenOperation__fetchBaseTokenWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  uint64_t v7 = [v6 objectForKeyedSubscript:*MEMORY[0x1E4F19DF0]];
  if (v7)
  {
    uint64_t v8 = v7;
  }
  else
  {
    ...
    if (!(v5 | v8))
    {
      ...
      uint64_t v5 = objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: No base token so the share token we would return would be invalid for iwork");
      uint64_t v8 = 0;
    }
  }
...
- (void)_fetchParticipantKeyWithCompletion:(id)a3
{
  ...
  id v4 = a3;
  id v5 = objc_alloc(MEMORY[0x1E4F1A0D0]);
  v20[0] = self->_shareID;
  ...
  if (baseToken)
  {
    ...
    v19 = baseToken;
    v9 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v19 forKeys:&shareID count:1];
...
LABEL_2:
  ...
  if (!*(void *)(v5 + 560) && !*(void *)(v5 + 544))
  {
    ...
    objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no error and no participantKey");
...
{
  id v4 = a3;
  uint64_t v5 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"%K == %@", @"participantKey", self->_participantKey];
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F1A2A0]) initWithRecordType:@"FetchParticipantDocumentToken" predicate:v5];
  id v7 = (void *)[objc_alloc(MEMORY[0x1E4F1A2B8]) initWithQuery:v6];
...
void __88__BRCSharingCopyParticipantTokenOperation__fetchParticipantDocumentTokenWithCompletion___block_invoke_2(void *a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134218754;
    ...
    __int16 v22 = 2112;
    objc_super v23 = v7;
    _os_log_debug_impl(&dword_1D353B000, v8, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx handling result of %@: %@%@", buf, 0x2Au);
  }
  ...
  if (!v6)
  {
    ...
    else
    {
      ...
      objc_msgSend(MEMORY[0x1E4F28C58], "br_errorWithDomain:code:description:", *MEMORY[0x1E4F59368], 15, @"unreachable: no error and no participantDocumentToken");
...
- (void)main
{
  ...
  {
    objc_msgSend(MEMORY[0x1E4F28C58], "brc_errorInvalidParameter:value:", @"shareID", 0);
    id v3 = (id)objc_claimAutoreleasedReturnValue();
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      __int16 v19 = 2112;
      __int16 v20 = v4;
      _os_log_debug_impl(&dword_1D353B000, v5, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Failed to get participantDocumentToken for item: %@ with error %@%@", buf, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 134218498;
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_debug_impl(&dword_1D353B000, v7, OS_LOG_TYPE_DEBUG, "[DEBUG] ┏%llx Succeed to get participantDocumentToken. item: %@%@", buf, 0x20u);
    }
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1D353B000, v0, v1, "[DEBUG] Can't fetch shareID for item %@%@");
}

void __73__BRCSharingCopyParticipantTokenOperation__fetchBaseTokenWithCompletion___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: No base token so the share token we would return would be invalid for iwork%@", v2, v3, v4, v5, v6);
}

void __78__BRCSharingCopyParticipantTokenOperation__fetchParticipantKeyWithCompletion___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no error and no participantKey%@", v2, v3, v4, v5, v6);
}

void __88__BRCSharingCopyParticipantTokenOperation__fetchParticipantDocumentTokenWithCompletion___block_invoke_2_cold_1()
{
  OUTLINED_FUNCTION_3_0();
  OUTLINED_FUNCTION_2(&dword_1D353B000, v0, v1, "[CRIT] UNREACHABLE: no error and no participantDocumentToken%@", v2, v3, v4, v5, v6);
}
