...
{
  v6 = [a1 eventStore];
  uint64_t v7 = [v6 saveSource:a1 commit:0 error:a4];
...
{
  v6 = [a1 eventStore];
  uint64_t v7 = [v6 removeSource:a1 commit:0 error:a4];
...
- (void)CUIKEditingContext_saveWithSpan:()Saving error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2_1(&dword_1BDF08000, v0, v1, "Source %@ failed to save with error %@");
}

- (void)CUIKEditingContext_removeWithSpan:()Saving error:.cold.1()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_2_1(&dword_1BDF08000, v0, v1, "Source %@ failed to remove with error %@");
}
