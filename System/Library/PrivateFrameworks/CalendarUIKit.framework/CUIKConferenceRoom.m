...
@implementation CUIKConferenceRoom

- (CUIKConferenceRoom)init
{
  v3.receiver = self;
  v3.super_class = (Class)CUIKConferenceRoom;
  result = [(CUIKConferenceRoom *)&v3 init];
  if (result) {
