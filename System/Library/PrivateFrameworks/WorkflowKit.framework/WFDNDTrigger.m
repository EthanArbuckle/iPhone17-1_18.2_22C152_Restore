...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = objc_msgSend(NSNumber, "numberWithBool:", -[WFDNDTrigger onEnable](self, "onEnable", v7.receiver, v7.super_class));
  [v4 encodeObject:v5 forKey:@"onEnable"];

  objc_super v6 = objc_msgSend(NSNumber, "numberWithBool:", -[WFDNDTrigger onDisable](self, "onDisable"));
...
+ (id)localizedDisplayExplanation
{
  return WFLocalizedString(@"Ex. “When Do Not Disturb is turned on”");
}

+ (id)localizedDisplayName
{
  return WFLocalizedString(@"Do Not Disturb");
}
