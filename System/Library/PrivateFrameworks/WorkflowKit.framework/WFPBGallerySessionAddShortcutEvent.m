...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](sessionIdentifier, "isEqual:")))
  {
    ...
    if ((unint64_t)shortcutIdentifier | v4[3]) {
      char v8 = -[NSString isEqual:](shortcutIdentifier, "isEqual:");
    }
    else {
      char v8 = 1;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v10 = [(NSString *)self->_shortcutIdentifier copyWithZone:a3];
  v11 = (void *)v5[3];
  v5[3] = v10;
...
- (id)description
{
  ...
  id v4 = [(WFPBGallerySessionAddShortcutEvent *)&v8 description];
  id v5 = [(WFPBGallerySessionAddShortcutEvent *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"GallerySessionAddShortcut";
  }
}
