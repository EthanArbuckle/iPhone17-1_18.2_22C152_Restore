...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 4))
  {
    -[WFPBOpenShortcutEvent setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[12])
  {
  ...
  if (*((void *)v4 + 2))
  {
    -[WFPBOpenShortcutEvent setAddToSiriBundleIdentifier:](self, "setAddToSiriBundleIdentifier:");
    v4 = v5;
  }
  if (*((void *)v4 + 3))
  {
    -[WFPBOpenShortcutEvent setGalleryIdentifier:](self, "setGalleryIdentifier:");
    v4 = v5;
  }
  if (*((void *)v4 + 5))
  {
    -[WFPBOpenShortcutEvent setShortcutSource:](self, "setShortcutSource:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return WFPBOpenShortcutEventReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)WFPBOpenShortcutEvent;
  id v4 = [(WFPBOpenShortcutEvent *)&v8 description];
  id v5 = [(WFPBOpenShortcutEvent *)self dictionaryRepresentation];
