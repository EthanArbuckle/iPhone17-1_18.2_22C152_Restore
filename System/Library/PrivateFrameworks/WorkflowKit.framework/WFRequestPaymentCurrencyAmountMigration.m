...
+ (BOOL)workflowNeedsMigration:(id)a3 fromClientVersion:(id)a4
{
  ...
  if (WFCompareBundleVersions(a4, @"1084")) {
    char HasActionsWithIdentifier = WFWorkflowHasActionsWithIdentifier(@"is.workflow.actions.venmo.request", v5);
  }
  else {
...
- (void)migrateWorkflow
{
  [(WFWorkflowMigration *)self enumerateActionsWithIdentifier:@"is.workflow.actions.venmo.request" usingBlock:&__block_literal_global_176_25823];
