...
+ (void)deserializeUserInfoAtURL:(id)a3 completionHandler:(id)a4
{
  ...
  v5 = (void (**)(id, void))a4;
  if ([v19 isFileURL]
    && (+[WFTemporaryFileManager sharedAppGroupDirectoryURL](WFTemporaryFileManager, "sharedAppGroupDirectoryURL"), id v6 = objc_claimAutoreleasedReturnValue(), v7 = objc_msgSend(v19, "wf_isContainedByDirectoryAtURL:", v6), v6, (v7 & 1) != 0))
  {
