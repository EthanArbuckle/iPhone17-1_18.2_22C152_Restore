...
- (void)provideFolderOptionsCollectionForShortcutsWidgetConfiguration:(id)a3 withCompletion:(id)a4
{
  ...
  v8 = [v7 descriptors];
  v9 = objc_msgSend(v8, "if_map:", &stru_100008478);
  ...
  id v13 = [objc_alloc((Class)INObjectCollection) initWithItems:v12];
  v5[2](v5, v13, 0);
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)WFShortcutsWidgetConfigurationIntentHandler;
