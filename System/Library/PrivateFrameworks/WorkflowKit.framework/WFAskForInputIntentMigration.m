...
+ (BOOL)workflowNeedsMigration:(id)a3 fromClientVersion:(id)a4
{
  ...
  if (WFCompareBundleVersions(a4, @"900")) {
    char HasActionsWithIdentifier = WFWorkflowHasActionsWithIdentifier(@"is.workflow.actions.ask", v5);
  }
  else {
...
- (void)migrateWorkflow
{
  [(WFWorkflowMigration *)self enumerateActionsWithIdentifier:@"is.workflow.actions.ask" usingBlock:&__block_literal_global_61849];
...
void __47__WFAskForInputIntentMigration_migrateWorkflow__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if ([v3 isEqualToString:@"Date"])
  {
    ...
    id v5 = @"Time";
    if (([v4 isEqualToString:@"Time"] & 1) != 0
      || (id v5 = @"Date and Time", [v4 isEqualToString:@"Date and Time"]))
    {
  ...
  if (v6)
  {
    ...
    else if ([v7 isEqualToString:@"URL"])
    {
      v8 = @"WFAskActionDefaultAnswerURL";
           ...
           || (v8 = @"WFAskActionDefaultAnswerDate",
    }
               [v10 objectForKeyedSubscript:@"WFAskActionDefaultAnswerDate"],
