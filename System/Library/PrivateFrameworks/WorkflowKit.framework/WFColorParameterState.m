...
+ (id)valueFromSerializedRepresentation:(id)a3 variableProvider:(id)a4 parameter:(id)a5
{
  ...
  if ([v8 count]) {
    v11 = (void *)[objc_alloc(MEMORY[0x1E4FB45E0]) initWithSerializedRepresentation:v8];
  }
  else {
    v11 = 0;
  }
...
LABEL_3:
  ...
  else
  {
    ...
    [v7 handleFailureInMethod:a2, a1, @"WFColorParameterState.m", 20, @"Invalid parameter not satisfying: %@", @"[value isKindOfClass:[WFColor class]]" object file lineNumber description];
