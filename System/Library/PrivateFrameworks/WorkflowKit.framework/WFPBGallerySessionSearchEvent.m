...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[WFPBGallerySessionSearchEvent setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[2])
  {
    -[WFPBGallerySessionSearchEvent setSessionIdentifier:](self, "setSessionIdentifier:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return WFPBGallerySessionSearchEventReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)WFPBGallerySessionSearchEvent;
  id v4 = [(WFPBGallerySessionSearchEvent *)&v8 description];
  id v5 = [(WFPBGallerySessionSearchEvent *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"GallerySessionSearch";
  }
}
