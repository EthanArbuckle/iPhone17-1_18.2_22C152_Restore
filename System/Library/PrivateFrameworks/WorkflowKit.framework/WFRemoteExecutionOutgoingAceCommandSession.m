...
{
  id v4 = a3;
  v5 = [(WFRemoteExecutionOutgoingAceCommandSession *)self completion];

  if (v5)
  {
    v6 = [(WFRemoteExecutionOutgoingAceCommandSession *)self completion];
...
- (void)handleIncomingProtobuf:(id)a3
{
  ...
  id v21 = 0;
  objc_super v7 = [(WFRemoteExecutionAceCommandRequestResponse *)v5 initWithData:v6 error:&v21];
  id v8 = v21;

  if (v7)
  {
    v9 = [(WFRemoteExecutionAceCommandRequestResponse *)v7 originatingRequestIdentifier];
    ...
    if (v12)
    {
      v13 = [(WFRemoteExecutionOutgoingAceCommandSession *)self completion];
      v14 = [(WFRemoteExecutionAceCommandRequestResponse *)v7 aceCommandResponseDictionary];
      v15 = [(WFRemoteExecutionAceCommandRequestResponse *)v7 error];
      ((void (**)(void, void *, void *))v13)[2](v13, v14, v15);
  ...
  {
    BOOL v17 = +[WFRemoteExecutionRequest isUnsupportedVersionError:v8];
    ...
    if (v17)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315138;
        ...
        _os_log_impl(&dword_1C7F0A000, v19, OS_LOG_TYPE_ERROR, "%s Encountered unsupported version of ace command request response", buf, 0xCu);
      }
      uint64_t v20 = 2;
    }
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v24 = 2114;
        id v25 = v8;
        _os_log_impl(&dword_1C7F0A000, v19, OS_LOG_TYPE_FAULT, "%s Failed to read ace command response: %{public}@", buf, 0x16u);
      }
      uint64_t v20 = 1;
    }
...
- (void)sendToDestinations:(id)a3 options:(id)a4
{
  ...
  if (v10)
  {
    ...
    v14 = (void *)[v12 initWithProtobufData:v13 type:8 isResponse:0];

    v15 = getWFRemoteExecutionLogObject();
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      uint64_t v16 = [(WFRemoteExecutionSession *)self request];
      BOOL v17 = [v16 identifier];
      *(_DWORD *)buf = 136315394;
      v31 = "-[WFRemoteExecutionOutgoingAceCommandSession sendToDestinations:options:]";
      __int16 v32 = 2114;
      v33 = v17;
      _os_log_impl(&dword_1C7F0A000, v15, OS_LOG_TYPE_INFO, "%s <%{public}@> sending ace command", buf, 0x16u);
    }
...
LABEL_8:
    ...
    [v19 handleFailureInMethod:a2, self, @"WFRemoteExecutionOutgoingAceCommandSession.m", 31, @"Invalid parameter not satisfying: %@", @"request" object file lineNumber description];
  ...
  [v18 handleFailureInMethod:a2, self, @"WFRemoteExecutionOutgoingAceCommandSession.m", 30, @"Invalid parameter not satisfying: %@", @"service" object file lineNumber description];
...
LABEL_9:
  ...
  [v20 handleFailureInMethod:a2, self, @"WFRemoteExecutionOutgoingAceCommandSession.m", 32, @"Invalid parameter not satisfying: %@", @"completion" object file lineNumber description];
