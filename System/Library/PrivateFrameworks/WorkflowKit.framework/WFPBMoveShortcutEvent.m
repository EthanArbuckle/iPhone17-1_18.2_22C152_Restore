...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[WFPBMoveShortcutEvent setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[2])
  {
    -[WFPBMoveShortcutEvent setSource:](self, "setSource:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return WFPBMoveShortcutEventReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)WFPBMoveShortcutEvent;
  id v4 = [(WFPBMoveShortcutEvent *)&v8 description];
  id v5 = [(WFPBMoveShortcutEvent *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"MoveShortcutEvent";
  }
}
