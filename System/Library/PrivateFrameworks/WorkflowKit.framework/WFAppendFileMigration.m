...
@implementation WFAppendFileMigration

+ (BOOL)workflowNeedsMigration:(id)a3 fromClientVersion:(id)a4
{
  id v5 = a3;
  if (WFCompareBundleVersions(a4, @"1106")) {
    char HasActionsWithIdentifier = WFWorkflowHasActionsWithIdentifier(@"is.workflow.actions.file.append", v5);
  }
  else {
  ...
  if (v3)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if ([v9 isEqualToString:@"is.workflow.actions.file.append"])
        {
          ...
          if (v15)
          {
            ...
            [v7 setObject:@"is.workflow.actions.dropbox.appendfile" forKey:v16];
          }
