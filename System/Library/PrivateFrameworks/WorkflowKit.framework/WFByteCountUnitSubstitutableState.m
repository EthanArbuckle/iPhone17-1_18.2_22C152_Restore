...
void __94__WFByteCountUnitSubstitutableState_processWithContext_userInputRequiredHandler_valueHandler___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  long long v19 = 0u;
  id v8 = &unk_1F2317A90;
  uint64_t v9 = [&unk_1F2317A90 countByEnumeratingWithState:&v16 objects:v20 count:16];
  if (v9)
  {
    uint64_t v10 = v9;
    ...
    while (2)
    {
      ...
      {
        if (*(void *)v17 != v11) {
          objc_enumerationMutation(&unk_1F2317A90);
        }
        v13 = WFLabelForByteCountUnit([*(id *)(*((void *)&v16 + 1) + 8 * v12) unsignedIntegerValue]);
      ...
      while (v10 != v12);
      uint64_t v10 = [&unk_1F2317A90 countByEnumeratingWithState:&v16 objects:v20 count:16];
      if (v10) {
        continue;
      }
      break;
