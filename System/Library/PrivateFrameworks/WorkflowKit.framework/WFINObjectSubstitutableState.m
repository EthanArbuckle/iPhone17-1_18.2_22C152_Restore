...
@implementation WFINObjectSubstitutableState
...
- (void)processWithContext:(id)a3 userInputRequiredHandler:(id)a4 valueHandler:(id)a5
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      v17[1] = 3221225472;
      v17[2] = __89__WFINObjectSubstitutableState_processWithContext_userInputRequiredHandler_valueHandler___block_invoke;
      v17[3] = &unk_1E65504F0;
      v17[4] = self;
      id v18 = v10;
  ...
  {
    v16.receiver = self;
    v16.super_class = (Class)WFINObjectSubstitutableState;
    [(WFVariableSubstitutableParameterState *)&v16 processWithContext:v8 userInputRequiredHandler:v9 valueHandler:v10];
  }
}

void __89__WFINObjectSubstitutableState_processWithContext_userInputRequiredHandler_valueHandler___block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5)
{
  id v7 = a2;
  ...
  {
    id v9 = a5;
    id v10 = (id)objc_msgSend(objc_alloc((Class)objc_msgSend((id)objc_opt_class(), "processingValueClass")), "initWithIdentifier:displayString:", 0, v12);
    (*(void (**)(uint64_t, id, id))(v8 + 16))(v8, v10, v9);
  }
  else
  {
    char v11 = *(void (**)(uint64_t, void, id))(v8 + 16);
    id v10 = a5;
    v11(v8, 0, v10);
  }
}
