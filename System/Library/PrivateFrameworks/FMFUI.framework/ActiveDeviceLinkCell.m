...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  v5 = objc_msgSend(MEMORY[0x263F086E0], "bundleForClass:", objc_opt_class(), v15.receiver, v15.super_class);
  v6 = [v5 localizedStringForKey:@"FROM_TITLE" value:&stru_26CA0AD00 table:@"LocalizableUI"];
  v7 = [(ActiveDeviceLinkCell *)self fromLabel];
  [v7 setText:v6];

  objc_super v8 = [v4 propertyForKey:@"ActiveDeviceLinkNameKey"];
...
- (void)setupSubviews
{
  uint64_t v3 = 2 * ([(id)*MEMORY[0x263F1D020] userInterfaceLayoutDirection] != 1);
  ...
  objc_super v8 = [MEMORY[0x263F1C658] preferredFontForTextStyle:*MEMORY[0x263F1D268]];
  v9 = [(ActiveDeviceLinkCell *)self deviceNameLabel];
  [v9 setFont:v8];

  v10 = [MEMORY[0x263F1C550] tableCellGrayTextColor];
  ...
  objc_super v15 = [(ActiveDeviceLinkCell *)self detailsLabel];
  [v15 setFont:v14];

  v16 = [MEMORY[0x263F1C550] tableCellGrayTextColor];
  ...
  id v24 = [(ActiveDeviceLinkCell *)self contentView];
...
- (void)setupConstraints
{
  uint64_t v3 = [(ActiveDeviceLinkCell *)self deviceNameLabel];
  [v3 setTranslatesAutoresizingMaskIntoConstraints:0];

  id v4 = [(ActiveDeviceLinkCell *)self detailsLabel];
  ...
  id v109 = [(ActiveDeviceLinkCell *)self detailsLabel];
...
- (void)layoutSubviews
{
  ...
  id v4 = [v3 propertyForKey:*MEMORY[0x263F600A8]];
  uint64_t v5 = [v4 BOOLValue];

  v6 = [(ActiveDeviceLinkCell *)self deviceNameLabel];
  [v6 setHidden:v5 ^ 1];

  double v7 = [(ActiveDeviceLinkCell *)self detailsLabel];
  [v7 setHidden:v5 ^ 1];
  ...
  if (v5) {
    ...
    double v8 = 0.400000006;
  }
  double v9 = [(ActiveDeviceLinkCell *)self fromLabel];
  [v9 setAlpha:v8];
