...
- (NSArray)modelDiagnosticSignals;
- (NSData)jsonData;
- (float)modelDiagnosticSignalsAtIndex:(unint64_t)a3;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (unint64_t)modelDiagnosticSignalsCount;
...
- (JRSchemaJRModelDiagnosticsSignals)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)JRSchemaJRModelDiagnosticsSignals;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              -[JRSchemaJRModelDiagnosticsSignals addModelDiagnosticSignals:](v5, "addModelDiagnosticSignals:");
            }
            ++v11;
          }
          while (v9 != v11);
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(JRSchemaJRModelDiagnosticsSignals *)self modelDiagnosticSignals];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_modelDiagnosticSignals hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(JRSchemaJRModelDiagnosticsSignals *)self modelDiagnosticSignals];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(JRSchemaJRModelDiagnosticsSignals *)self modelDiagnosticSignals];
      uint64_t v11 = [v4 modelDiagnosticSignals];
...
- (void)writeTo:(id)a3
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  v5 = self->_modelDiagnosticSignals;
...
- (BOOL)readFrom:(id)a3
{
  return JRSchemaJRModelDiagnosticsSignalsReadFrom(self, (uint64_t)a3, v3);
}

- (float)modelDiagnosticSignalsAtIndex:(unint64_t)a3
{
  double v3 = [(NSArray *)self->_modelDiagnosticSignals objectAtIndexedSubscript:a3];
  [v3 floatValue];
  float v5 = v4;
...
- (unint64_t)modelDiagnosticSignalsCount
{
  return [(NSArray *)self->_modelDiagnosticSignals count];
}
...
- (void)addModelDiagnosticSignals:(float)a3
{
  ...
  if (!modelDiagnosticSignals)
  {
    ...
    uint64_t v7 = self->_modelDiagnosticSignals;
