...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTPickExpression;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTPickExpression *)self statementId];
...
- (IFTSchemaIFTPickExpression)initWithDictionary:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)IFTSchemaIFTPickExpression;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithLongLong:", -[IFTSchemaIFTPickExpression index](self, "index"));
...
LABEL_12:
  ...
  uint64_t v8 = [(IFTSchemaIFTPickExpression *)self statementId];
  if (v8)
  {
    objc_super v9 = (void *)v8;
    v10 = [(IFTSchemaIFTPickExpression *)self statementId];
    objc_super v11 = [v4 statementId];
...
{
  id v6 = a3;
  uint64_t v4 = [(IFTSchemaIFTPickExpression *)self statementId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTPickExpressionReadFrom(self, (uint64_t)a3);
}
