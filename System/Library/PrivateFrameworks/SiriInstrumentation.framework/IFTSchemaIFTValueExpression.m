...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTValueExpression)initWithDictionary:(id)a3;
- (IFTSchemaIFTValueExpression)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (IFTSchemaIFTValueExpression)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTValueExpression;
  v5 = [(IFTSchemaIFTValueExpression *)&v9 init];
  if (v5)
  {
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTValueExpression *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaIFTValueExpression exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTValueExpressionReadFrom(self, (uint64_t)a3);
}
