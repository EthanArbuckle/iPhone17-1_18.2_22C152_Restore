...
{
  v9.receiver = self;
  v9.super_class = (Class)GMSSchemaGMSClientEventMetadata;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(GMSSchemaGMSClientEventMetadata *)self gmsId];
...
- (GMSSchemaGMSClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)GMSSchemaGMSClientEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_gmsId)
  {
    id v4 = [(GMSSchemaGMSClientEventMetadata *)self gmsId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_gmsId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(GMSSchemaGMSClientEventMetadata *)self gmsId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(GMSSchemaGMSClientEventMetadata *)self gmsId];
      v11 = [v4 gmsId];
...
- (BOOL)readFrom:(id)a3
{
  return GMSSchemaGMSClientEventMetadataReadFrom(self, (uint64_t)a3);
}
