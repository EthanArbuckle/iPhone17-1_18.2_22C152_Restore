...
{
  v9.receiver = self;
  v9.super_class = (Class)MHSchemaMHVoiceTriggerSecondPassRejected;
  id v4 = a3;
...
- (MHSchemaMHVoiceTriggerSecondPassRejected)initWithDictionary:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)MHSchemaMHVoiceTriggerSecondPassRejected;
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(MHSchemaMHVoiceTriggerSecondPassRejected *)self reason] - 1;
    if (v4 > 8) {
...
- (unint64_t)hash
{
  unint64_t v3 = [(MHSchemaMHVoiceTriggerEventInfo *)self->_voiceTriggerEventInfo hash];
  if (*(unsigned char *)&self->_has) {
...
LABEL_12:
  ...
  uint64_t v8 = [(MHSchemaMHVoiceTriggerSecondPassRejected *)self voiceTriggerEventInfo];
  if (v8)
  {
    objc_super v9 = (void *)v8;
    v10 = [(MHSchemaMHVoiceTriggerSecondPassRejected *)self voiceTriggerEventInfo];
    objc_super v11 = [v4 voiceTriggerEventInfo];
...
{
  id v6 = a3;
  uint64_t v4 = [(MHSchemaMHVoiceTriggerSecondPassRejected *)self voiceTriggerEventInfo];
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHVoiceTriggerSecondPassRejectedReadFrom(self, (uint64_t)a3);
}
