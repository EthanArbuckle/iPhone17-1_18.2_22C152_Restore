...
- (QDSchemaQDCollectionFailed)initWithDictionary:(id)a3;
- (QDSchemaQDCollectionFailed)initWithJSON:(id)a3;
...
- (QDSchemaQDCollectionFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)QDSchemaQDCollectionFailed;
...
- (NSData)jsonData
{
  v2 = [(QDSchemaQDCollectionFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[QDSchemaQDCollectionFailed errorCode](self, "errorCode"));
    [v3 setObject:v4 forKeyedSubscript:@"errorCode"];
  }
  if (self->_errorDomain)
  {
    v5 = [(QDSchemaQDCollectionFailed *)self errorDomain];
    v6 = (void *)[v5 copy];
...
LABEL_12:
  ...
  uint64_t v8 = [(QDSchemaQDCollectionFailed *)self errorDomain];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(QDSchemaQDCollectionFailed *)self errorDomain];
...
{
  id v5 = a3;
  uint64_t v4 = [(QDSchemaQDCollectionFailed *)self errorDomain];
...
- (BOOL)readFrom:(id)a3
{
  return QDSchemaQDCollectionFailedReadFrom(self, (uint64_t)a3);
}
