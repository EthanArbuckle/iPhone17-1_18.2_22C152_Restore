@interface PEGASUSSchemaPEGASUSSportsExecution
...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (PEGASUSSchemaPEGASUSSportsExecution)initWithDictionary:(id)a3;
- (PEGASUSSchemaPEGASUSSportsExecution)initWithJSON:(id)a3;
...
@implementation PEGASUSSchemaPEGASUSSportsExecution
...
- (PEGASUSSchemaPEGASUSSportsExecution)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)PEGASUSSchemaPEGASUSSportsExecution;
  v5 = [(PEGASUSSchemaPEGASUSSportsExecution *)&v14 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"sportsUsecase"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PEGASUSSchemaPEGASUSSportsExecution setSportsUsecase:](v5, "setSportsUsecase:", [v6 intValue]);
    }
    v7 = [v4 objectForKeyedSubscript:@"isSportsWatchFaceRequest"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PEGASUSSchemaPEGASUSSportsExecution setIsSportsWatchFaceRequest:](v5, "setIsSportsWatchFaceRequest:", [v7 BOOLValue]);
    }
    v8 = [v4 objectForKeyedSubscript:@"isSnippetNextCardRequest"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PEGASUSSchemaPEGASUSSportsExecution setIsSnippetNextCardRequest:](v5, "setIsSnippetNextCardRequest:", [v8 BOOLValue]);
    }
    v9 = [v4 objectForKeyedSubscript:@"isMachineUtterance"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PEGASUSSchemaPEGASUSSportsExecution setIsMachineUtterance:](v5, "setIsMachineUtterance:", [v9 BOOLValue]);
    }
    v10 = [v4 objectForKeyedSubscript:@"isDisambiguation"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PEGASUSSchemaPEGASUSSportsExecution setIsDisambiguation:](v5, "setIsDisambiguation:", [v10 BOOLValue]);
    }
    v11 = [v4 objectForKeyedSubscript:@"isLiveScoreRequest"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PEGASUSSchemaPEGASUSSportsExecution setIsLiveScoreRequest:](v5, "setIsLiveScoreRequest:", [v11 BOOLValue]);
    }
    v12 = v5;
  }
  return v5;
...
- (PEGASUSSchemaPEGASUSSportsExecution)initWithJSON:(id)a3
{
  ...
  {
    self = [(PEGASUSSchemaPEGASUSSportsExecution *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(PEGASUSSchemaPEGASUSSportsExecution *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 0x10) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isDisambiguation](self, "isDisambiguation"));
...
LABEL_3:
  ...
  v6 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isLiveScoreRequest](self, "isLiveScoreRequest"));
...
LABEL_10:
  uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isMachineUtterance](self, "isMachineUtterance"));
...
LABEL_12:
    v9 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isSportsWatchFaceRequest](self, "isSportsWatchFaceRequest"));
...
LABEL_13:
    unsigned int v10 = [(PEGASUSSchemaPEGASUSSportsExecution *)self sportsUsecase] - 1;
    if (v10 > 0x1E) {
      v11 = @"PEGASUSSPORTSUSECASE_UNKNOWN";
    }
    else {
      v11 = off_1E5EBC750[v10];
    }
    [v3 setObject:v11 forKeyedSubscript:@"sportsUsecase"];
    goto LABEL_17;
  }
LABEL_11:
  v8 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSSportsExecution isSnippetNextCardRequest](self, "isSnippetNextCardRequest"));
...
- (BOOL)readFrom:(id)a3
{
  return PEGASUSSchemaPEGASUSSportsExecutionReadFrom(self, (uint64_t)a3);
}
