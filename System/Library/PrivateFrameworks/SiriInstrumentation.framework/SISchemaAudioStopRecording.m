...
- (SISchemaAudioStopRecording)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SISchemaAudioStopRecording;
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(SISchemaAudioStopRecording *)self endpointType] - 1;
    if (v4 > 5) {
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int endpointType = self->_endpointType, endpointType == [v4 endpointType]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaAudioStopRecordingReadFrom(self, (uint64_t)a3);
}
