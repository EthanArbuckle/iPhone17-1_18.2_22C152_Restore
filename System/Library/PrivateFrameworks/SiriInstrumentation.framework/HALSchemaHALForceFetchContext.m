...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(HALSchemaHALForceFetchContext *)self contextId];
  ...
  v9 = [(HALSchemaHALForceFetchContext *)self startedOrChanged];
  ...
  v12 = [(HALSchemaHALForceFetchContext *)self ended];
  ...
  v15 = [(HALSchemaHALForceFetchContext *)self failed];
...
- (HALSchemaHALForceFetchContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[HALSchemaHALForceFetchEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(HALSchemaHALForceFetchContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(HALSchemaHALForceFetchContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(HALSchemaHALForceFetchContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(HALSchemaHALForceFetchContext *)self failed];
  ...
  {
    v13 = [(HALSchemaHALForceFetchContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(HALSchemaHALForceFetchStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(HALSchemaHALForceFetchEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(HALSchemaHALForceFetchContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(HALSchemaHALForceFetchContext *)self contextId];
  ...
  v6 = [(HALSchemaHALForceFetchContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(HALSchemaHALForceFetchContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(HALSchemaHALForceFetchContext *)self startedOrChanged];
  ...
  v6 = [(HALSchemaHALForceFetchContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(HALSchemaHALForceFetchContext *)self ended];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(HALSchemaHALForceFetchContext *)self ended];
    v21 = [v4 ended];
  ...
  v6 = [(HALSchemaHALForceFetchContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(HALSchemaHALForceFetchContext *)self failed];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(HALSchemaHALForceFetchContext *)self failed];
    v26 = [v4 failed];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(HALSchemaHALForceFetchContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(HALSchemaHALForceFetchContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(HALSchemaHALForceFetchContext *)self ended];

  if (v8)
  {
    v9 = [(HALSchemaHALForceFetchContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(HALSchemaHALForceFetchContext *)self failed];
  ...
  if (v10)
  {
    int v11 = [(HALSchemaHALForceFetchContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (HALSchemaHALForceFetchFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (HALSchemaHALForceFetchEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (HALSchemaHALForceFetchStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
