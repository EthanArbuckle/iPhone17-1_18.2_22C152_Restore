...
- (NSData)jsonData
{
  v2 = [(JRSchemaRankingTuple *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(JRSchemaRankingTuple *)self scores];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(JRSchemaRankingTuple *)self scores];
    v6 = [v4 scores];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(JRSchemaRankingTuple *)self scores];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(JRSchemaRankingTuple *)self scores];
