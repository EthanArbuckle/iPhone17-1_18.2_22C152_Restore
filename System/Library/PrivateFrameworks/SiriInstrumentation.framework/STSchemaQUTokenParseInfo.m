...
- (void)setTokenLength:(unsigned int)a3;
- (void)writeTo:(id)a3;
@end
...
- (STSchemaQUTokenParseInfo)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)STSchemaQUTokenParseInfo;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[STSchemaQUTokenParseInfo tokenLength](self, "tokenLength"));
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (unsigned int tokenLength = self->_tokenLength, tokenLength == [v4 tokenLength]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return STSchemaQUTokenParseInfoReadFrom(self, (uint64_t)a3);
}
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_unsigned int tokenLength = a3;
}
