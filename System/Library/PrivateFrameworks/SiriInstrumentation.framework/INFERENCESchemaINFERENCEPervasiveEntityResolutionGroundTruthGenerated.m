...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (INFERENCESchemaINFERENCEPervasiveEntityResolutionCommonSignals)commonSignals;
...
- (NSArray)choiceDependentSignals;
- (NSData)jsonData;
- (id)applySensitiveConditionsPolicy:(id)a3;
- (id)choiceDependentSignalsAtIndex:(unint64_t)a3;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)choiceDependentSignalsCount;
- (unint64_t)hash;
- (void)addChoiceDependentSignals:(id)a3;
- (void)clearChoiceDependentSignals;
- (void)deleteCommonSignals;
- (void)setChoiceDependentSignals:(id)a3;
- (void)setCommonSignals:(id)a3;
- (void)setHasCommonSignals:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_choiceDependentSignals, 0);
  objc_storeStrong((id *)&self->_commonSignals, 0);
}

- (void)setHasCommonSignals:(BOOL)a3
{
  self->_hasCommonSignals = a3;
}
...
- (NSArray)choiceDependentSignals
{
  return self->_choiceDependentSignals;
}
...
- (INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"choiceDependentSignals"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated *)self commonSignals];
...
- (unint64_t)hash
{
  unint64_t v3 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionCommonSignals *)self->_commonSignals hash];
  return [(NSArray *)self->_choiceDependentSignals hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v6 = [v4 commonSignals];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated *)self commonSignals];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated *)self commonSignals];
    uint64_t v10 = [v4 commonSignals];
  ...
  uint64_t v6 = [v4 choiceDependentSignals];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated *)self choiceDependentSignals];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated *)self choiceDependentSignals];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGenerated *)self commonSignals];
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  uint64_t v7 = self->_choiceDependentSignals;
...
- (BOOL)readFrom:(id)a3
{
  return INFERENCESchemaINFERENCEPervasiveEntityResolutionGroundTruthGeneratedReadFrom(self, (uint64_t)a3);
}

- (id)choiceDependentSignalsAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_choiceDependentSignals objectAtIndexedSubscript:a3];
}

- (unint64_t)choiceDependentSignalsCount
{
  return [(NSArray *)self->_choiceDependentSignals count];
}
