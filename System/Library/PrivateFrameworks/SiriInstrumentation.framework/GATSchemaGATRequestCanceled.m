...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GATSchemaGATRequestCanceled)initWithDictionary:(id)a3;
- (GATSchemaGATRequestCanceled)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (GATSchemaGATRequestCanceled)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)GATSchemaGATRequestCanceled;
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATRequestCanceled *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exist + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[GATSchemaGATRequestCanceled exist](self, "exist"));
...
- (BOOL)readFrom:(id)a3
{
  return GATSchemaGATRequestCanceledReadFrom(self, (uint64_t)a3);
}
