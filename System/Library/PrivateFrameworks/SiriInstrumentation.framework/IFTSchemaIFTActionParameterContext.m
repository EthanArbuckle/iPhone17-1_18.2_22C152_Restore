...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFTSchemaIFTActionParameterContext;
...
- (IFTSchemaIFTActionParameterContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)IFTSchemaIFTActionParameterContext;
  v5 = [(IFTSchemaIFTActionParameterContext *)&v12 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFTSchemaIFTActionParameterContext *)self statementId];
  ...
  if (self->_toolId)
  {
    uint64_t v7 = [(IFTSchemaIFTActionParameterContext *)self toolId];
    int v8 = (void *)[v7 copy];
    [v3 setObject:v8 forKeyedSubscript:@"toolId"];
  }
...
- (unint64_t)hash
{
  ...
  return [(NSString *)self->_toolId hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(IFTSchemaIFTActionParameterContext *)self statementId];
  if (v7)
  {
    int v8 = (void *)v7;
    v9 = [(IFTSchemaIFTActionParameterContext *)self statementId];
    objc_super v10 = [v4 statementId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(IFTSchemaIFTActionParameterContext *)self toolId];
    if (!v12)
    {
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTActionParameterContextReadFrom(self, (uint64_t)a3);
}
