...
- (SISchemaDictationEndPointStop)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SISchemaDictationEndPointStop;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass()) {
      -[SISchemaDictationEndPointStop setDictationEndPointType:](v5, "setDictationEndPointType:", [v6 intValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(SISchemaDictationEndPointStop *)self dictationEndPointType] - 1;
    if (v4 > 0x16) {
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaDictationEndPointStopReadFrom(self, (uint64_t)a3);
}
