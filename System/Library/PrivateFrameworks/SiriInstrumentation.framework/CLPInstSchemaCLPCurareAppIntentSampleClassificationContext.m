...
- (CLPInstSchemaCLPCurareAppIntentSampleClassificationContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[CLPInstSchemaCLPCurareAppIntentSampleClassificationEnded alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self ended];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  uint64_t v13 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  uint64_t v18 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self ended];
  if (v18)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self failed];
    if (!v23)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self ended];
  ...
  if (v10)
  {
    int v11 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (CLPInstSchemaCLPCurareAppIntentSampleClassificationEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (CLPInstSchemaCLPCurareAppIntentSampleClassificationStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
