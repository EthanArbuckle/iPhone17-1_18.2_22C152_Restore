...
- (PRSiriSchemaPRRequestContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[PRSiriSchemaPRRequestFailed alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[PRSiriSchemaPRRequestContext actionStatementId](self, "actionStatementId"));
  ...
  if (self->_failed)
  {
    int v8 = [(PRSiriSchemaPRRequestContext *)self failed];
  ...
  {
    int v11 = [(PRSiriSchemaPRRequestContext *)self planEventId];
  ...
  {
    int v14 = [(PRSiriSchemaPRRequestContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(PRSiriSchemaPRRequestStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(PRSiriSchemaPRRequestEnded *)self->_ended hash];
  unint64_t v5 = [(PRSiriSchemaPRRequestFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v6 = [(PRSiriSchemaPRRequestContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v8 = [(PRSiriSchemaPRRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  unint64_t v6 = [(PRSiriSchemaPRRequestContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(PRSiriSchemaPRRequestContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  unint64_t v6 = [(PRSiriSchemaPRRequestContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(PRSiriSchemaPRRequestContext *)self failed];
  if (v18)
  {
  ...
  unint64_t v6 = [(PRSiriSchemaPRRequestContext *)self planEventId];
...
LABEL_22:
  ...
  uint64_t v23 = [(PRSiriSchemaPRRequestContext *)self planEventId];
  if (v23)
  {
    v24 = (void *)v23;
  ...
  if ((*(unsigned char *)&self->_has & 1) == (v4[44] & 1))
  {
    if ((*(unsigned char *)&self->_has & 1) == 0
      || (unsigned int actionStatementId = self->_actionStatementId,
          actionStatementId == [v4 actionStatementId]))
    {
      BOOL v28 = 1;
      goto LABEL_24;
    }
...
{
  id v12 = a3;
  unint64_t v4 = [(PRSiriSchemaPRRequestContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(PRSiriSchemaPRRequestContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(PRSiriSchemaPRRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(PRSiriSchemaPRRequestContext *)self failed];
...
- (void)setFailed:(id)a3
{
  unint64_t v4 = (PRSiriSchemaPRRequestFailed *)a3;
...
- (void)setEnded:(id)a3
{
  unint64_t v4 = (PRSiriSchemaPRRequestEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  unint64_t v4 = (PRSiriSchemaPRRequestStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
