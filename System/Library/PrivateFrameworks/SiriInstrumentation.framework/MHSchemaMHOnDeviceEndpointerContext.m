...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (MHSchemaMHOnDeviceEndpointerContext)initWithDictionary:(id)a3;
- (MHSchemaMHOnDeviceEndpointerContext)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (MHSchemaMHOnDeviceEndpointerContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)MHSchemaMHOnDeviceEndpointerContext;
...
- (NSData)jsonData
{
  v2 = [(MHSchemaMHOnDeviceEndpointerContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_enabled + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[MHSchemaMHOnDeviceEndpointerContext enabled](self, "enabled"));
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHOnDeviceEndpointerContextReadFrom(self, (uint64_t)a3);
}
