@interface IFTSchemaIFTToolRetrievalResponse
- (BOOL)exists;
- (BOOL)hasExists;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (IFTSchemaIFTToolRetrievalResponse)initWithDictionary:(id)a3
{
  ...
  v5 = [(IFTSchemaIFTToolRetrievalResponse *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"exists"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[IFTSchemaIFTToolRetrievalResponse setExists:](v5, "setExists:", [v6 BOOLValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (IFTSchemaIFTToolRetrievalResponse)initWithJSON:(id)a3
{
  ...
  {
    self = [(IFTSchemaIFTToolRetrievalResponse *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTToolRetrievalResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaIFTToolRetrievalResponse exists](self, "exists"));
