...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (SISchemaUIStateDismissed)initWithDictionary:(id)a3;
- (SISchemaUIStateDismissed)initWithJSON:(id)a3;
...
- (SISchemaUIStateDismissed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SISchemaUIStateDismissed;
...
- (NSData)jsonData
{
  v2 = [(SISchemaUIStateDismissed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(SISchemaUIStateDismissed *)self dismissalReason] - 1;
    if (v4 > 0x31) {
    ...
    [v3 setObject:v5 forKeyedSubscript:@"dismissalReason"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaUIStateDismissedReadFrom(self, (uint64_t)a3);
}
