...
- (NSArray)results;
- (NSData)jsonData;
- (TTMSchemaTTMRequestEnded)initWithDictionary:(id)a3;
- (TTMSchemaTTMRequestEnded)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)TTMSchemaTTMRequestEnded;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(TTMSchemaTTMRequestEnded *)self results];
...
- (TTMSchemaTTMRequestEnded)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)TTMSchemaTTMRequestEnded;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[TTMSchemaTTMTCUResult initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
...
- (NSData)jsonData
{
  v2 = [(TTMSchemaTTMRequestEnded *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(TTMSchemaTTMRequestEnded *)self results];
    uint64_t v6 = [v4 results];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(TTMSchemaTTMRequestEnded *)self results];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(TTMSchemaTTMRequestEnded *)self results];
...
- (BOOL)readFrom:(id)a3
{
  return TTMSchemaTTMRequestEndedReadFrom(self, (uint64_t)a3);
}
