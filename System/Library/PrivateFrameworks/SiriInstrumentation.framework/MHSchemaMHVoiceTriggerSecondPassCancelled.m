...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
...
- (NSData)jsonData
{
  v2 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
    v6 = [v4 voiceTriggerEventInfo];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
