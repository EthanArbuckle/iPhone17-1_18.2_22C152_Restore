...
- (CLPInstSchemaCLPCDMReplaySampleFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CLPInstSchemaCLPCDMReplaySampleFailed;
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(CLPInstSchemaCLPCDMReplaySampleFailed *)self reason] - 1;
    if (v4 > 2) {
      v5 = @"CLPERROR_UNKNOWN";
    }
    else {
...
- (BOOL)readFrom:(id)a3
{
  return CLPInstSchemaCLPCDMReplaySampleFailedReadFrom(self, (uint64_t)a3);
}
