...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  ...
  v9 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
  ...
  v12 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
...
- (NLXSchemaCDMSingleServiceSetupAttemptContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[NLXSchemaCDMSingleServiceSetupAttemptEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
  ...
  {
    v10 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(NLXSchemaCDMSingleServiceSetupAttemptStarted *)self->_startedOrChanged hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  ...
  v6 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
  ...
  v6 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
    v21 = [v4 ended];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];

  if (v8)
  {
    v9 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setEnded:(id)a3
{
  id v4 = (NLXSchemaCDMSingleServiceSetupAttemptEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (NLXSchemaCDMSingleServiceSetupAttemptStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
