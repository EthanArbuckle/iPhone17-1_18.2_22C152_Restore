...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(IHSchemaIHModelEvaluationContext *)self contextId];
  ...
  v9 = [(IHSchemaIHModelEvaluationContext *)self startedOrChanged];
  ...
  v12 = [(IHSchemaIHModelEvaluationContext *)self ended];
  ...
  v15 = [(IHSchemaIHModelEvaluationContext *)self failed];
...
- (IHSchemaIHModelEvaluationContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[IHSchemaIHModelEvaluationEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(IHSchemaIHModelEvaluationContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(IHSchemaIHModelEvaluationContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(IHSchemaIHModelEvaluationContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(IHSchemaIHModelEvaluationContext *)self failed];
  ...
  {
    v13 = [(IHSchemaIHModelEvaluationContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(IHSchemaIHModelEvaluationStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(IHSchemaIHModelEvaluationEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(IHSchemaIHModelEvaluationContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(IHSchemaIHModelEvaluationContext *)self contextId];
  ...
  v6 = [(IHSchemaIHModelEvaluationContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(IHSchemaIHModelEvaluationContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(IHSchemaIHModelEvaluationContext *)self startedOrChanged];
  ...
  v6 = [(IHSchemaIHModelEvaluationContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(IHSchemaIHModelEvaluationContext *)self ended];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(IHSchemaIHModelEvaluationContext *)self ended];
    v21 = [v4 ended];
  ...
  v6 = [(IHSchemaIHModelEvaluationContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(IHSchemaIHModelEvaluationContext *)self failed];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(IHSchemaIHModelEvaluationContext *)self failed];
    v26 = [v4 failed];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(IHSchemaIHModelEvaluationContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(IHSchemaIHModelEvaluationContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(IHSchemaIHModelEvaluationContext *)self ended];

  if (v8)
  {
    v9 = [(IHSchemaIHModelEvaluationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(IHSchemaIHModelEvaluationContext *)self failed];
  ...
  if (v10)
  {
    int v11 = [(IHSchemaIHModelEvaluationContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (IHSchemaIHModelEvaluationFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (IHSchemaIHModelEvaluationEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (IHSchemaIHModelEvaluationStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
