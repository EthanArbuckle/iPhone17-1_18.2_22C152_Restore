...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSArray)siriTurnRestatementScores;
- (NSData)jsonData;
...
- (id)siriTurnRestatementScoresAtIndex:(unint64_t)a3;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (unint64_t)siriTurnRestatementScoresCount;
- (void)addSiriTurnRestatementScores:(id)a3;
- (void)clearSiriTurnRestatementScores;
- (void)setSiriTurnRestatementScores:(id)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v9.receiver = self;
  v9.super_class = (Class)ODMSiriSchemaODMSiriTurnRestatementScoresReported;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(ODMSiriSchemaODMSiriTurnRestatementScoresReported *)self siriTurnRestatementScores];
...
- (NSArray)siriTurnRestatementScores
{
  return self->_siriTurnRestatementScores;
}
...
- (ODMSiriSchemaODMSiriTurnRestatementScoresReported)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)ODMSiriSchemaODMSiriTurnRestatementScoresReported;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[ODMSiriSchemaODMSiriTurnRestatementScore initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
...
- (unint64_t)hash
{
  return [(NSArray *)self->_siriTurnRestatementScores hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    uint64_t v6 = [v4 siriTurnRestatementScores];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ODMSiriSchemaODMSiriTurnRestatementScoresReported *)self siriTurnRestatementScores];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(ODMSiriSchemaODMSiriTurnRestatementScoresReported *)self siriTurnRestatementScores];
      uint64_t v11 = [v4 siriTurnRestatementScores];
...
- (BOOL)readFrom:(id)a3
{
  return ODMSiriSchemaODMSiriTurnRestatementScoresReportedReadFrom(self, (uint64_t)a3);
}

- (id)siriTurnRestatementScoresAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_siriTurnRestatementScores objectAtIndexedSubscript:a3];
}

- (unint64_t)siriTurnRestatementScoresCount
{
  return [(NSArray *)self->_siriTurnRestatementScores count];
}
...
- (void)addSiriTurnRestatementScores:(id)a3
{
  ...
  if (!siriTurnRestatementScores)
  {
    ...
    uint64_t v7 = self->_siriTurnRestatementScores;
