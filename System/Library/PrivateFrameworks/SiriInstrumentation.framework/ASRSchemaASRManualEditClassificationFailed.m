...
- (ASRSchemaASRManualEditClassificationFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ASRSchemaASRManualEditClassificationFailed;
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithInt:", -[ASRSchemaASRManualEditClassificationFailed errorCode](self, "errorCode"));
  ...
  if (has)
  {
    v6 = objc_msgSend(NSNumber, "numberWithBool:", -[ASRSchemaASRManualEditClassificationFailed exists](self, "exists"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  $BDB994D23ED4E8D29EE91FF31954CD15 has = self->_has;
...
- (BOOL)readFrom:(id)a3
{
  return ASRSchemaASRManualEditClassificationFailedReadFrom(self, (uint64_t)a3);
}
