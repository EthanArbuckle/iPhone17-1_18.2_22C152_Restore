...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ORCHSchemaORCHNLRouterBridgeEnded *)self routingDecision];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(ORCHSchemaORCHNLRouterBridgeEnded *)self routingDecision];
...
- (unint64_t)hash
{
  return [(ORCHSchemaORCHNLRouterBridgeRoutingDecision *)self->_routingDecision hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ORCHSchemaORCHNLRouterBridgeEnded *)self routingDecision];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(ORCHSchemaORCHNLRouterBridgeEnded *)self routingDecision];
