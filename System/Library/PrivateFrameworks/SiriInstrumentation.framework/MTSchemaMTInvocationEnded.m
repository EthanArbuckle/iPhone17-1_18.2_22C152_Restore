...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(MTSchemaMTInvocationEnded *)self qssSessionId];
  ...
  v9 = [(MTSchemaMTInvocationEnded *)self localePair];
...
- (NSData)jsonData
{
  v2 = [(MTSchemaMTInvocationEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[MTSchemaMTInvocationEnded exists](self, "exists"));
    [v3 setObject:v4 forKeyedSubscript:@"exists"];
  }
  if (self->_localePair)
  {
    v5 = [(MTSchemaMTInvocationEnded *)self localePair];
  ...
  {
    int v8 = [(MTSchemaMTInvocationEnded *)self qssSessionId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(MTSchemaMTInvocationEnded *)self qssSessionId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(MTSchemaMTInvocationEnded *)self qssSessionId];
  ...
  v6 = [(MTSchemaMTInvocationEnded *)self localePair];
  uint64_t v7 = [v4 localePair];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(MTSchemaMTInvocationEnded *)self localePair];
    if (!v13)
    {
...
LABEL_18:
    ...
    v14 = (void *)v13;
    v15 = [(MTSchemaMTInvocationEnded *)self localePair];
    v16 = [v4 localePair];
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v4 = [(MTSchemaMTInvocationEnded *)self qssSessionId];

  if (v4)
  {
    v5 = [(MTSchemaMTInvocationEnded *)self qssSessionId];
  ...
  if (v6)
  {
    uint64_t v8 = [(MTSchemaMTInvocationEnded *)self localePair];
    PBDataWriterWriteSubmessage();
