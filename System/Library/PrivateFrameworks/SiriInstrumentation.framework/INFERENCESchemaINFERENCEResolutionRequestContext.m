...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)INFERENCESchemaINFERENCEResolutionRequestContext;
...
- (INFERENCESchemaINFERENCEResolutionRequestContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)INFERENCESchemaINFERENCEResolutionRequestContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[INFERENCESchemaINFERENCEResolutionRequestEnded alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self ended];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(INFERENCESchemaINFERENCEResolutionRequestStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(INFERENCESchemaINFERENCEResolutionRequestEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  uint64_t v13 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  uint64_t v18 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self ended];
  if (v18)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self failed];
    if (!v23)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self ended];
  ...
  if (v10)
  {
    int v11 = [(INFERENCESchemaINFERENCEResolutionRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return INFERENCESchemaINFERENCEResolutionRequestContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (INFERENCESchemaINFERENCEResolutionRequestFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (INFERENCESchemaINFERENCEResolutionRequestEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (INFERENCESchemaINFERENCEResolutionRequestStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
