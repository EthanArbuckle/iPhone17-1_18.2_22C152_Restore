...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self allocations];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];
  [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self setAllocations:v7];

  v8 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self codepathId];
...
- (NSData)jsonData
{
  v2 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_codepathId)
  {
    uint64_t v12 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self codepathId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self allocations];
  uint64_t v6 = [v4 allocations];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self allocations];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self allocations];
  ...
  v5 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self codepathId];
...
LABEL_15:
    ...
    v13 = (void *)v12;
    v14 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self codepathId];
    v15 = [v4 codepathId];
...
- (void)writeTo:(id)a3
{
  ...
  uint64_t v10 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self codepathId];

  if (v10)
  {
    int v11 = [(EXPSiriSchemaEXPClientExperimentTriggeredTier1 *)self codepathId];
    PBDataWriterWriteSubmessage();
  }
}
