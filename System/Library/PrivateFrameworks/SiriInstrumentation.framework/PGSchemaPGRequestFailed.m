...
{
  v9.receiver = self;
  v9.super_class = (Class)PGSchemaPGRequestFailed;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(PGSchemaPGRequestFailed *)self criticalError];
...
- (PGSchemaPGRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PGSchemaPGRequestFailed;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PGSchemaPGRequestFailed *)self criticalError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PGSchemaPGRequestFailed *)self criticalError];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(PGSchemaPGRequestFailed *)self criticalError];
...
- (BOOL)readFrom:(id)a3
{
  return PGSchemaPGRequestFailedReadFrom(self, (uint64_t)a3);
}
