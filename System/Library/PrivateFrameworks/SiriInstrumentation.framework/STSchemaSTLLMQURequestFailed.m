...
- (STSchemaSTLLMQURequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)STSchemaSTLLMQURequestFailed;
  v5 = [(STSchemaSTLLMQURequestFailed *)&v9 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(STSchemaSTLLMQURequestFailed *)self reason] - 1;
    if (v4 > 2) {
      v5 = @"STLLMQUFAILUREREASON_UNKNOWN";
    }
    else {
      v5 = off_1E5EC0F28[v4];
    }
...
- (BOOL)readFrom:(id)a3
{
  return STSchemaSTLLMQURequestFailedReadFrom(self, (uint64_t)a3);
}
