...
{
  v8.receiver = self;
  v8.super_class = (Class)IFTSchemaIFTSystemRequirementProtectedAppRequest;
  id v4 = a3;
...
- (IFTSchemaIFTSystemRequirementProtectedAppRequest)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFTSchemaIFTSystemRequirementProtectedAppRequest;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_bundleId)
  {
    id v4 = [(IFTSchemaIFTSystemRequirementProtectedAppRequest *)self bundleId];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTSystemRequirementProtectedAppRequest *)self bundleId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(IFTSchemaIFTSystemRequirementProtectedAppRequest *)self bundleId];
      v11 = [v4 bundleId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTSystemRequirementProtectedAppRequestReadFrom(self, (uint64_t)a3);
}
