...
- (CDASchemaCDAElectionAdvertisingEndStarted)initWithDictionary:(id)a3
{
  ...
  v5 = [(CDASchemaCDAElectionAdvertisingEndStarted *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"state"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[CDASchemaCDAElectionAdvertisingEndStarted setState:](v5, "setState:", [v6 intValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (CDASchemaCDAElectionAdvertisingEndStarted)initWithJSON:(id)a3
{
  ...
  {
    self = [(CDASchemaCDAElectionAdvertisingEndStarted *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(CDASchemaCDAElectionAdvertisingEndStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(CDASchemaCDAElectionAdvertisingEndStarted *)self state] - 1;
    if (v4 > 0x11) {
      v5 = @"CDASTATE_UNKNOWN";
    }
    else {
