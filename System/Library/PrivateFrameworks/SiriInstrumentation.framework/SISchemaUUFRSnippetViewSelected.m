...
- (SISchemaUUFRSnippetViewSelected)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SISchemaUUFRSnippetViewSelected;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SISchemaUUFRSnippetViewSelected *)self snippetAceId];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSString *)self->_snippetAceId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaUUFRSnippetViewSelected *)self snippetAceId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(SISchemaUUFRSnippetViewSelected *)self snippetAceId];
      v11 = [v4 snippetAceId];
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaUUFRSnippetViewSelectedReadFrom(self, (uint64_t)a3);
}
