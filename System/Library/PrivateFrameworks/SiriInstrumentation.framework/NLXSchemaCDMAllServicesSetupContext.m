...
- (void)setStartedOrChanged:(id)a3
{
  v4 = (NLXSchemaCDMAllServicesSetupStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
...
- (void)setEnded:(id)a3
{
  v4 = (NLXSchemaCDMAllServicesSetupEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
...
- (void)writeTo:(id)a3
{
  ...
  if (v8)
  {
    v9 = [(NLXSchemaCDMAllServicesSetupContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)NLXSchemaCDMAllServicesSetupContext;
...
- (NLXSchemaCDMAllServicesSetupContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)NLXSchemaCDMAllServicesSetupContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[NLXSchemaCDMAllServicesSetupFailed alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(NLXSchemaCDMAllServicesSetupContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(NLXSchemaCDMAllServicesSetupContext *)self failed];
  ...
  {
    id v10 = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(NLXSchemaCDMAllServicesSetupStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(NLXSchemaCDMAllServicesSetupEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    id v10 = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
  ...
  uint64_t v13 = [(NLXSchemaCDMAllServicesSetupContext *)self ended];
  if (v13)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(NLXSchemaCDMAllServicesSetupContext *)self failed];
    if (!v18)
    {
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMAllServicesSetupContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (NLXSchemaCDMAllServicesSetupFailed *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
