...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext;
...
- (FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext *)self ended];
  ...
  {
    uint64_t v7 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted *)self->_startedOrChanged hash];
  return [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationEnded *)self->_ended hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext *)self ended];
    if (!v13)
    {
...
{
  id v8 = a3;
  id v4 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return FLOWLINKSchemaFLOWLINKActionParameterConfirmationContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLINKActionParameterConfirmationEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
