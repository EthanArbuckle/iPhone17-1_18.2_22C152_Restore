...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)ExecutorSiriSchemaExecutorAppIntentCallContext;
...
- (ExecutorSiriSchemaExecutorAppIntentCallContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)ExecutorSiriSchemaExecutorAppIntentCallContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[ExecutorSiriSchemaExecutorAppIntentCallFailed alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self failed];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ExecutorSiriSchemaExecutorAppIntentCallStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(ExecutorSiriSchemaExecutorAppIntentCallEnded *)self->_ended hash] ^ v3;
  unint64_t v5 = [(ExecutorSiriSchemaExecutorAppIntentCallFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
  ...
  uint64_t v13 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  uint64_t v18 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self failed];
  if (v18)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self traceId];
    if (!v23)
    {
...
{
  id v12 = a3;
  id v4 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self failed];
  ...
  if (v10)
  {
    int v11 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self traceId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return ExecutorSiriSchemaExecutorAppIntentCallContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (ExecutorSiriSchemaExecutorAppIntentCallFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (ExecutorSiriSchemaExecutorAppIntentCallEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (ExecutorSiriSchemaExecutorAppIntentCallStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
