...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1;
...
- (PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"rewrittenUtterances"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    id v4 = [(PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1 *)self linkId];
  ...
  if ([(NSArray *)self->_rewrittenUtterances count])
  {
    ...
    long long v18 = 0u;
    long long v19 = 0u;
    int v8 = self->_rewrittenUtterances;
...
- (unint64_t)hash
{
  ...
  return [(NSArray *)self->_rewrittenUtterances hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1 *)self linkId];
  if (v7)
  {
    int v8 = (void *)v7;
    uint64_t v9 = [(PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1 *)self linkId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1 *)self rewrittenUtterances];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1 *)self rewrittenUtterances];
...
- (BOOL)readFrom:(id)a3
{
  return PEGASUSSchemaPEGASUSRewrittenUtterancesReportedTier1ReadFrom(self, (uint64_t)a3);
}

- (id)rewrittenUtterancesAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_rewrittenUtterances objectAtIndexedSubscript:a3];
}

- (unint64_t)rewrittenUtterancesCount
{
  return [(NSArray *)self->_rewrittenUtterances count];
}
