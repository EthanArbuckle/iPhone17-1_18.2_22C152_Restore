...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)FLSchemaFLInteractionDonationContext;
...
- (FLSchemaFLInteractionDonationContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)FLSchemaFLInteractionDonationContext;
  v5 = [(FLSchemaFLInteractionDonationContext *)&v12 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(FLSchemaFLInteractionDonationContext *)self ended];
  ...
  {
    uint64_t v7 = [(FLSchemaFLInteractionDonationContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(FLSchemaFLInteractionDonationStarted *)self->_startedOrChanged hash];
  return [(FLSchemaFLInteractionDonationEnded *)self->_ended hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(FLSchemaFLInteractionDonationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(FLSchemaFLInteractionDonationContext *)self ended];
    if (!v13)
    {
...
{
  id v8 = a3;
  id v4 = [(FLSchemaFLInteractionDonationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(FLSchemaFLInteractionDonationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return FLSchemaFLInteractionDonationContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (FLSchemaFLInteractionDonationEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (FLSchemaFLInteractionDonationStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
