...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SISchemaActiveAudioDevice *)self productIdentifier];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(SISchemaActiveAudioDevice *)self vendorIdentifier];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(SISchemaActiveAudioDevice *)self productIdentifier];
    if (!v12)
    {
...
{
  id v6 = a3;
  id v4 = [(SISchemaActiveAudioDevice *)self vendorIdentifier];
