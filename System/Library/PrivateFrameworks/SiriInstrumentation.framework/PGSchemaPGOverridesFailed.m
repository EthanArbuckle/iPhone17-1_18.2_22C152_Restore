...
{
  v9.receiver = self;
  v9.super_class = (Class)PGSchemaPGOverridesFailed;
  id v4 = a3;
...
- (PGSchemaPGOverridesFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PGSchemaPGOverridesFailed;
  v5 = [(PGSchemaPGOverridesFailed *)&v10 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PGSchemaPGOverridesFailed *)self criticalError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PGSchemaPGOverridesFailed *)self criticalError];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(PGSchemaPGOverridesFailed *)self criticalError];
...
- (BOOL)readFrom:(id)a3
{
  return PGSchemaPGOverridesFailedReadFrom(self, (uint64_t)a3);
}
