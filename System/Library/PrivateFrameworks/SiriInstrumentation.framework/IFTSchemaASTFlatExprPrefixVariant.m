...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaASTFlatExprPrefixVariant)initWithDictionary:(id)a3;
- (IFTSchemaASTFlatExprPrefixVariant)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (IFTSchemaASTFlatExprPrefixVariant)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaASTFlatExprPrefixVariant;
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaASTFlatExprPrefixVariant *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaASTFlatExprPrefixVariant exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaASTFlatExprPrefixVariantReadFrom(self, (uint64_t)a3);
}
