...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1;
...
- (EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_codepathId)
  {
    uint64_t v12 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self codepathId];
  ...
  if (self->_requestId)
  {
    objc_super v15 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self requestId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self allocations];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self allocations];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self requestId];
    if (!v17)
    {
...
LABEL_20:
    ...
    v18 = (void *)v17;
    long long v19 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self requestId];
    long long v20 = [v4 requestId];
...
- (void)writeTo:(id)a3
{
  ...
  uint64_t v10 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self codepathId];

  if (v10)
  {
    int v11 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self codepathId];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v12 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self requestId];

  if (v12)
  {
    int v13 = [(EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1 *)self requestId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return EXPSiriSchemaEXPClientSiriRequestExperimentTriggeredTier1ReadFrom(self, (uint64_t)a3);
}
