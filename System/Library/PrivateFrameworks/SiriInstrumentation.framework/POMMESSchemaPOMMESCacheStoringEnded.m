...
- (POMMESSchemaPOMMESCacheStoringEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)POMMESSchemaPOMMESCacheStoringEnded;
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(POMMESSchemaPOMMESCacheStoringEnded *)self status];
...
- (BOOL)readFrom:(id)a3
{
  return POMMESSchemaPOMMESCacheStoringEndedReadFrom(self, (uint64_t)a3);
}
