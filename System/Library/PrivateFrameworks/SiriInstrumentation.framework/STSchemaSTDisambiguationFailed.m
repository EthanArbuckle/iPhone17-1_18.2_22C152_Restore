...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (STSchemaSTDisambiguationFailed)initWithDictionary:(id)a3;
- (STSchemaSTDisambiguationFailed)initWithJSON:(id)a3;
...
- (STSchemaSTDisambiguationFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)STSchemaSTDisambiguationFailed;
  v5 = [(STSchemaSTDisambiguationFailed *)&v9 init];
  if (v5)
  {
...
- (NSData)jsonData
{
  v2 = [(STSchemaSTDisambiguationFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(STSchemaSTDisambiguationFailed *)self reason];
...
- (BOOL)readFrom:(id)a3
{
  return STSchemaSTDisambiguationFailedReadFrom(self, (uint64_t)a3);
}
