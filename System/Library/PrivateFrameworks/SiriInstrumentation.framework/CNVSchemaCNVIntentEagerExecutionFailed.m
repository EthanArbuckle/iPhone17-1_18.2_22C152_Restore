...
- (CNVSchemaCNVIntentEagerExecutionFailed)initWithDictionary:(id)a3
{
  ...
  v5 = [(CNVSchemaCNVIntentEagerExecutionFailed *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"reason"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[CNVSchemaCNVIntentEagerExecutionFailed setReason:](v5, "setReason:", [v6 intValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (CNVSchemaCNVIntentEagerExecutionFailed)initWithJSON:(id)a3
{
  ...
  {
    self = [(CNVSchemaCNVIntentEagerExecutionFailed *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(CNVSchemaCNVIntentEagerExecutionFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(CNVSchemaCNVIntentEagerExecutionFailed *)self reason];
