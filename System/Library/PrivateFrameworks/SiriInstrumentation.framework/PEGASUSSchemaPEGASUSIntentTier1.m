...
- (id)intentArgsAtIndex:(unint64_t)a3;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (unint64_t)intentArgsCount;
- (void)addIntentArgs:(id)a3;
- (void)clearIntentArgs;
- (void)deleteLinkId;
- (void)setHasLinkId:(BOOL)a3;
- (void)setIntentArgs:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)PEGASUSSchemaPEGASUSIntentTier1;
...
- (PEGASUSSchemaPEGASUSIntentTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)PEGASUSSchemaPEGASUSIntentTier1;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"intentArgs"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    uint64_t v12 = [(PEGASUSSchemaPEGASUSIntentTier1 *)self linkId];
...
- (unint64_t)hash
{
  ...
  return [(NSArray *)self->_intentArgs hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(PEGASUSSchemaPEGASUSIntentTier1 *)self linkId];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(PEGASUSSchemaPEGASUSIntentTier1 *)self linkId];
  ...
  uint64_t v6 = [v4 intentArgs];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(PEGASUSSchemaPEGASUSIntentTier1 *)self intentArgs];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(PEGASUSSchemaPEGASUSIntentTier1 *)self intentArgs];
    v15 = [v4 intentArgs];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(PEGASUSSchemaPEGASUSIntentTier1 *)self linkId];
...
- (BOOL)readFrom:(id)a3
{
  return PEGASUSSchemaPEGASUSIntentTier1ReadFrom(self, (uint64_t)a3);
}

- (id)intentArgsAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_intentArgs objectAtIndexedSubscript:a3];
}

- (unint64_t)intentArgsCount
{
  return [(NSArray *)self->_intentArgs count];
}
