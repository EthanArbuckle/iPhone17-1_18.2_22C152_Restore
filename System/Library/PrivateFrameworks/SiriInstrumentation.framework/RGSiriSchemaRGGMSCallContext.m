...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (RGSiriSchemaRGGMSCallContext)initWithDictionary:(id)a3;
- (RGSiriSchemaRGGMSCallContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)RGSiriSchemaRGGMSCallContext;
  v5 = [(SISchemaInstrumentationMessage *)&v19 applySensitiveConditionsPolicy:v4];
  v6 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  ...
  v9 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  ...
  v12 = [(RGSiriSchemaRGGMSCallContext *)self failed];
  ...
  v15 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
...
- (RGSiriSchemaRGGMSCallContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)RGSiriSchemaRGGMSCallContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[RGSiriSchemaRGGMSCallFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(RGSiriSchemaRGGMSCallContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(RGSiriSchemaRGGMSCallContext *)self failed];
  ...
  {
    v10 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  ...
  if (self->_traceId)
  {
    v13 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
...
- (unint64_t)hash
{
  unint64_t v3 = [(RGSiriSchemaRGGMSCallStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(RGSiriSchemaRGGMSCallEnded *)self->_ended hash] ^ v3;
  unint64_t v5 = [(RGSiriSchemaRGGMSCallFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  ...
  v6 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  ...
  v6 = [(RGSiriSchemaRGGMSCallContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(RGSiriSchemaRGGMSCallContext *)self failed];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(RGSiriSchemaRGGMSCallContext *)self failed];
    v21 = [v4 failed];
  ...
  v6 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
  uint64_t v7 = [v4 traceId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
    v26 = [v4 traceId];
...
{
  id v12 = a3;
  id v4 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(RGSiriSchemaRGGMSCallContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(RGSiriSchemaRGGMSCallContext *)self failed];

  if (v8)
  {
    v9 = [(RGSiriSchemaRGGMSCallContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(RGSiriSchemaRGGMSCallContext *)self traceId];

  if (v10)
  {
    int v11 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return RGSiriSchemaRGGMSCallContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (RGSiriSchemaRGGMSCallFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (RGSiriSchemaRGGMSCallEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (RGSiriSchemaRGGMSCallStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
