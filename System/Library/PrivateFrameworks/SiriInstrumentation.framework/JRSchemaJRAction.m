      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
              -[JRSchemaJRAction addActions:](v5, "addActions:", objc_msgSend(v12, "unsignedIntValue", (void)v15));
            }
            ++v11;
          }
          while (v9 != v11);
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(JRSchemaJRAction *)self actions];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_actions hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(JRSchemaJRAction *)self actions];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(JRSchemaJRAction *)self actions];
      uint64_t v11 = [v4 actions];
