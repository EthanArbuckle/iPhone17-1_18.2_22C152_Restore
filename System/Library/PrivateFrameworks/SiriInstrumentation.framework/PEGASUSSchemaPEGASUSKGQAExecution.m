...
- (NSData)jsonData;
- (NSString)nlgKey;
- (PEGASUSSchemaPEGASUSKGQAExecution)initWithDictionary:(id)a3;
- (PEGASUSSchemaPEGASUSKGQAExecution)initWithJSON:(id)a3;
...
- (PEGASUSSchemaPEGASUSKGQAExecution)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)PEGASUSSchemaPEGASUSKGQAExecution;
...
- (NSData)jsonData
{
  v2 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_attributes)
  {
    id v4 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
    v5 = (void *)[v4 copy];
  ...
  if ((v6 & 2) != 0)
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSKGQAExecution isDisputedResponse](self, "isDisputedResponse"));
...
LABEL_5:
  ...
  id v8 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSKGQAExecution isWebExtractedFact](self, "isWebExtractedFact"));
...
LABEL_9:
  unsigned int v9 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self kgQAUsecase] - 1;
  if (v9 > 6) {
    uint64_t v10 = @"PEGASUSKGQAUSECASE_UNKNOWN";
  }
  else {
    uint64_t v10 = off_1E5EBC660[v9];
  }
  [v3 setObject:v10 forKeyedSubscript:@"kgQAUsecase"];
LABEL_13:
  if (self->_nlgKey)
  {
    uint64_t v11 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
...
- (BOOL)isEqual:(id)a3
{
  ...
  NSUInteger v6 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
  uint64_t v7 = [v4 attributes];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v8 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
  if (v8)
  {
    unsigned int v9 = (void *)v8;
    uint64_t v10 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
  ...
  NSUInteger v6 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
...
LABEL_17:
  ...
  uint64_t v15 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
  if (v15)
  {
    v16 = (void *)v15;
    v17 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
    v18 = [v4 nlgKey];
...
- (void)writeTo:(id)a3
{
  ...
  uint64_t v10 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
...
- (BOOL)readFrom:(id)a3
{
  return PEGASUSSchemaPEGASUSKGQAExecutionReadFrom(self, (uint64_t)a3);
}
