...
- (unint64_t)hash
{
  ...
  if ((has & 2) != 0)
  {
    float uemThreshold = self->_uemThreshold;
    double v11 = uemThreshold;
    if (uemThreshold < 0.0) {
      double v11 = -uemThreshold;
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  $8D4290F366A7FB276CD1CFBCF88D8088 has = self->_has;
  ...
  if (v9 == ((v6 >> 1) & 1))
  {
    if (!v9 || (float uemThreshold = self->_uemThreshold, [v4 uemThreshold], uemThreshold == v11))
    {
      BOOL v12 = 1;
      goto LABEL_10;
    }
