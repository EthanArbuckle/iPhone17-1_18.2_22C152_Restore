...
{
  v9.receiver = self;
  v9.super_class = (Class)PGSchemaPGOverridesEnded;
  id v4 = a3;
...
- (PGSchemaPGOverridesEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PGSchemaPGOverridesEnded;
  v5 = [(PGSchemaPGOverridesEnded *)&v10 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PGSchemaPGOverridesEnded *)self transcriptEventId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PGSchemaPGOverridesEnded *)self transcriptEventId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(PGSchemaPGOverridesEnded *)self transcriptEventId];
...
- (BOOL)readFrom:(id)a3
{
  return PGSchemaPGOverridesEndedReadFrom(self, (uint64_t)a3);
}
