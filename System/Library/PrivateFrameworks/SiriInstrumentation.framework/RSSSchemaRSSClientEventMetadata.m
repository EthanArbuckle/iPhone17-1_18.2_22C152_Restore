...
{
  v9.receiver = self;
  v9.super_class = (Class)RSSSchemaRSSClientEventMetadata;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(RSSSchemaRSSClientEventMetadata *)self rssId];
...
- (RSSSchemaRSSClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RSSSchemaRSSClientEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_rssId)
  {
    id v4 = [(RSSSchemaRSSClientEventMetadata *)self rssId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_rssId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(RSSSchemaRSSClientEventMetadata *)self rssId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(RSSSchemaRSSClientEventMetadata *)self rssId];
      v11 = [v4 rssId];
...
- (BOOL)readFrom:(id)a3
{
  return RSSSchemaRSSClientEventMetadataReadFrom(self, (uint64_t)a3);
}
