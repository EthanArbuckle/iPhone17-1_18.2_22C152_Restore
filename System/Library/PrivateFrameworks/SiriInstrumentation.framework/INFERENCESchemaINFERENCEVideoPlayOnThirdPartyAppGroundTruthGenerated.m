...
- (INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppIndependentSignals)independentSignal;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated;
...
- (INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"dependentSignals"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated *)self independentSignal];
...
- (unint64_t)hash
{
  unint64_t v3 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppIndependentSignals *)self->_independentSignal hash];
  return [(NSArray *)self->_dependentSignals hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated *)self independentSignal];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated *)self independentSignal];
    uint64_t v10 = [v4 independentSignal];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated *)self dependentSignals];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated *)self dependentSignals];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGenerated *)self independentSignal];
...
- (BOOL)readFrom:(id)a3
{
  return INFERENCESchemaINFERENCEVideoPlayOnThirdPartyAppGroundTruthGeneratedReadFrom(self, (uint64_t)a3);
}
