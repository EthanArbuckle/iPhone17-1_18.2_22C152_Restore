@interface IFTSchemaIFTQueryResults
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTQueryResults)initWithDictionary:(id)a3;
- (IFTSchemaIFTQueryResults)initWithJSON:(id)a3;
- (NSArray)candidates;
- (NSData)jsonData;
...
@implementation IFTSchemaIFTQueryResults

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTQueryResults;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTQueryResults *)self candidates];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(IFTSchemaIFTQueryResults *)self setCandidates:v7];
  return v5;
}
...
- (IFTSchemaIFTQueryResults)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)IFTSchemaIFTQueryResults;
  v5 = [(IFTSchemaIFTQueryResults *)&v21 init];
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              v13 = [IFTSchemaIFTCandidate alloc];
              v14 = -[IFTSchemaIFTCandidate initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
              [(IFTSchemaIFTQueryResults *)v5 addCandidates:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (IFTSchemaIFTQueryResults)initWithJSON:(id)a3
{
  ...
  {
    self = [(IFTSchemaIFTQueryResults *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTQueryResults *)self dictionaryRepresentation];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_candidates hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(IFTSchemaIFTQueryResults *)self candidates];
    uint64_t v6 = [v4 candidates];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTQueryResults *)self candidates];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(IFTSchemaIFTQueryResults *)self candidates];
      uint64_t v11 = [v4 candidates];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTQueryResultsReadFrom(self, (uint64_t)a3);
}
