...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (DIMSchemaDIMExperimentInfo)initWithDictionary:(id)a3;
- (DIMSchemaDIMExperimentInfo)initWithJSON:(id)a3;
- (NSData)jsonData;
...
{
  v9.receiver = self;
  v9.super_class = (Class)DIMSchemaDIMExperimentInfo;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
...
- (DIMSchemaDIMExperimentInfo)initWithDictionary:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)DIMSchemaDIMExperimentInfo;
...
- (NSData)jsonData
{
  v2 = [(DIMSchemaDIMExperimentInfo *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithLongLong:", -[DIMSchemaDIMExperimentInfo deploymentId](self, "deploymentId"));
    [v3 setObject:v4 forKeyedSubscript:@"deploymentId"];
  }
  if (self->_experimentId)
  {
    v5 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
    v6 = (void *)[v5 copy];
    [v3 setObject:v6 forKeyedSubscript:@"experimentId"];
  }
  if (self->_treatmentId)
  {
    uint64_t v7 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
  v6 = [v4 experimentId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
  if (v7)
  {
    v8 = (void *)v7;
    objc_super v9 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
    v10 = [v4 experimentId];
  ...
  uint64_t v5 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
  v6 = [v4 treatmentId];
  if ((v5 == 0) == (v6 != 0))
  {
LABEL_11:
  ...
  uint64_t v12 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
  if (v12)
  {
    objc_super v13 = (void *)v12;
    v14 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
    v15 = [v4 treatmentId];
...
{
  id v7 = a3;
  unint64_t v4 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
...
- (BOOL)readFrom:(id)a3
{
  return DIMSchemaDIMExperimentInfoReadFrom(self, (uint64_t)a3);
}
