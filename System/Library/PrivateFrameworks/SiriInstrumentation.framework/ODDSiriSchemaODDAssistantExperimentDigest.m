...
- (ODDSiriSchemaODDAssistantExperimentDigest)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[ODDSiriSchemaODDAssistantExperimentTuples alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_counts)
  {
    id v4 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self counts];
  ...
  if (self->_dimensions)
  {
    uint64_t v7 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self dimensions];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ODDSiriSchemaODDAssistantExperimentDimensions *)self->_dimensions hash];
  unint64_t v4 = [(ODDSiriSchemaODDAssistantExperimentCounts *)self->_counts hash] ^ v3;
  unint64_t v5 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self->_tuples hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self dimensions];
  v6 = [v4 dimensions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_21;
  }
  ...
  unint64_t v5 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self counts];
  v6 = [v4 counts];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_21;
  }
  uint64_t v12 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self counts];
  if (v12)
  {
    id v13 = (void *)v12;
    uint64_t v14 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self counts];
  ...
  unint64_t v5 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self tuples];
  v6 = [v4 tuples];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_21;
  }
  uint64_t v17 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self tuples];
  if (v17)
  {
  ...
  unint64_t v5 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self turnIds];
  v6 = [v4 turnIds];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v22 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self turnIds];
    if (!v22)
    {
...
LABEL_25:
    ...
    long long v24 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self turnIds];
...
- (void)writeTo:(id)a3
{
  ...
  uint64_t v7 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self counts];

  if (v7)
  {
    int v8 = [(ODDSiriSchemaODDAssistantExperimentDigest *)self counts];
    PBDataWriterWriteSubmessage();
  }
