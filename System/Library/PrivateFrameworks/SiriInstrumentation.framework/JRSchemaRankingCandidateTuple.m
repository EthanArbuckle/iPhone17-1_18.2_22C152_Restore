@interface JRSchemaRankingCandidateTuple
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (JRSchemaRankingCandidateTuple)initWithDictionary:(id)a3;
- (JRSchemaRankingCandidateTuple)initWithJSON:(id)a3;
...
@implementation JRSchemaRankingCandidateTuple

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)JRSchemaRankingCandidateTuple;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(JRSchemaRankingCandidateTuple *)self candidateIds];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(JRSchemaRankingCandidateTuple *)self setCandidateIds:v7];
  return v5;
}
...
- (JRSchemaRankingCandidateTuple)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)JRSchemaRankingCandidateTuple;
  v5 = [(JRSchemaRankingCandidateTuple *)&v21 init];
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              [(JRSchemaRankingCandidateTuple *)v5 addCandidateIds:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (JRSchemaRankingCandidateTuple)initWithJSON:(id)a3
{
  ...
  {
    self = [(JRSchemaRankingCandidateTuple *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(JRSchemaRankingCandidateTuple *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(JRSchemaRankingCandidateTuple *)self candidateIds];
    uint64_t v6 = [v4 candidateIds];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(JRSchemaRankingCandidateTuple *)self candidateIds];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(JRSchemaRankingCandidateTuple *)self candidateIds];
...
- (BOOL)readFrom:(id)a3
{
  return JRSchemaRankingCandidateTupleReadFrom(self, (uint64_t)a3);
}
