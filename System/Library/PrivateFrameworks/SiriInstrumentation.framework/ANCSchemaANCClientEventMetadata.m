...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)ANCSchemaANCClientEventMetadata;
...
- (ANCSchemaANCClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)ANCSchemaANCClientEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ancId)
  {
    id v4 = [(ANCSchemaANCClientEventMetadata *)self ancId];
  ...
  if (self->_requestId)
  {
    uint64_t v7 = [(ANCSchemaANCClientEventMetadata *)self requestId];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SISchemaUUID *)self->_ancId hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(ANCSchemaANCClientEventMetadata *)self ancId];
  if (v7)
  {
    int v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(ANCSchemaANCClientEventMetadata *)self requestId];
    if (!v12)
    {
...
- (BOOL)readFrom:(id)a3
{
  return ANCSchemaANCClientEventMetadataReadFrom(self, (uint64_t)a3);
}
