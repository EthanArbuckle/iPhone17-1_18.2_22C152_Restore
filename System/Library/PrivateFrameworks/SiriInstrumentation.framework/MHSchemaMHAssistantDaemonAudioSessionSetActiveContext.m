...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)MHSchemaMHAssistantDaemonAudioSessionSetActiveContext;
...
- (MHSchemaMHAssistantDaemonAudioSessionSetActiveContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)MHSchemaMHAssistantDaemonAudioSessionSetActiveContext;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveContext *)self ended];
  ...
  {
    uint64_t v7 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveStarted *)self->_startedOrChanged hash];
  return [(MHSchemaMHAssistantDaemonAudioSessionSetActiveEnded *)self->_ended hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveContext *)self ended];
    if (!v13)
    {
...
{
  id v8 = a3;
  id v4 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(MHSchemaMHAssistantDaemonAudioSessionSetActiveContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHAssistantDaemonAudioSessionSetActiveContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (MHSchemaMHAssistantDaemonAudioSessionSetActiveEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (MHSchemaMHAssistantDaemonAudioSessionSetActiveStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
