...
- (PSESchemaPSEMediaSignalGenerated)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"mediaSignal"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PSESchemaPSEMediaSignalGenerated *)self commonSignal];
  ...
  {
    uint64_t v7 = [(PSESchemaPSEMediaSignalGenerated *)self mediaSignal];
...
- (unint64_t)hash
{
  ...
  return [(PSESchemaPSEMedia *)self->_mediaSignal hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(PSESchemaPSEMediaSignalGenerated *)self commonSignal];
  if (v7)
  {
    int v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(PSESchemaPSEMediaSignalGenerated *)self mediaSignal];
    if (!v12)
    {
