...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaIFTParameterNeedsValue exists](self, "exists"));
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[24] & 1))
    {
        ...
        || (int exists = self->_exists, exists == [v4 exists]))
      {
        ...
        if ((v6 == 0) != (v7 != 0))
        {
          uint64_t v9 = [(IFTSchemaIFTParameterNeedsValue *)self parameterId];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = (void *)v9;
          objc_super v11 = [(IFTSchemaIFTParameterNeedsValue *)self parameterId];
          v12 = [v4 parameterId];
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(IFTSchemaIFTParameterNeedsValue *)self parameterId];
