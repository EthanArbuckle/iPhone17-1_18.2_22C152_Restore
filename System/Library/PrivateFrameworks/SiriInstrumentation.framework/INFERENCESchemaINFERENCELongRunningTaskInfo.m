...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[INFERENCESchemaINFERENCELongRunningTaskInfo durationInMs](self, "durationInMs"));
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[16] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (unint64_t durationInMs = self->_durationInMs, durationInMs == [v4 durationInMs]))
      {
        BOOL v6 = 1;
      }
    }
