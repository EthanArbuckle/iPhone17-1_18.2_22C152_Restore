...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(SessionSchemaSessionId *)self sessionId];
...
- (NSData)jsonData
{
  v2 = [(SessionSchemaSessionId *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_sessionId)
  {
    id v4 = [(SessionSchemaSessionId *)self sessionId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_sessionId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(SessionSchemaSessionId *)self sessionId];
    v6 = [v4 sessionId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SessionSchemaSessionId *)self sessionId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(SessionSchemaSessionId *)self sessionId];
      v11 = [v4 sessionId];
