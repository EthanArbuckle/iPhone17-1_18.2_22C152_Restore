...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self originalAsrId];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[ASRSchemaASRSampledAudioFileDeletionFailed errorCode](self, "errorCode"));
  ...
  {
    uint64_t v7 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self originalAsrId];
  ...
  {
    v10 = objc_msgSend(NSNumber, "numberWithInt:", -[ASRSchemaASRSampledAudioFileDeletionFailed underlyingErrorCode](self, "underlyingErrorCode"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  NSUInteger v5 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self originalAsrId];
  ...
  {
    v8 = (void *)v7;
    objc_super v9 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self originalAsrId];
  ...
  NSUInteger v5 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self errorDomain];
  uint64_t v6 = [v4 errorDomain];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self errorDomain];
  if (v13)
  {
    v14 = (void *)v13;
  ...
  NSUInteger v5 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self underlyingErrorDomain];
  uint64_t v6 = [v4 underlyingErrorDomain];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v20 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self underlyingErrorDomain];
    if (!v20)
    {
...
{
  id v9 = a3;
  uint64_t v4 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self originalAsrId];
  ...
  uint64_t v6 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self errorDomain];
  ...
  uint64_t v7 = [(ASRSchemaASRSampledAudioFileDeletionFailed *)self underlyingErrorDomain];
