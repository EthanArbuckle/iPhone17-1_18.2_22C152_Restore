...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(PFAPreprocessorSessionEndStatsReported *)self offDeviceClockStatistics];
...
- (PFAPreprocessorSessionEndStatsReported)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"offDeviceClockStatistics"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(PFAPreprocessorSessionEndStatsReported *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PFAPreprocessorSessionEndStatsReported *)self offDeviceClockStatistics];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"offDeviceClockStatistics"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"offDeviceClockStatistics"];
    }
  }
...
- (unint64_t)hash
{
  return [(PFAProcessedClockStatistics *)self->_offDeviceClockStatistics hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(PFAPreprocessorSessionEndStatsReported *)self offDeviceClockStatistics];
    v6 = [v4 offDeviceClockStatistics];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PFAPreprocessorSessionEndStatsReported *)self offDeviceClockStatistics];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(PFAPreprocessorSessionEndStatsReported *)self offDeviceClockStatistics];
      v11 = [v4 offDeviceClockStatistics];
