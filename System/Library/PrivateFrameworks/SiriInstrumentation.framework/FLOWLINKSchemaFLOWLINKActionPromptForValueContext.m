...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)FLOWLINKSchemaFLOWLINKActionPromptForValueContext;
...
- (FLOWLINKSchemaFLOWLINKActionPromptForValueContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)FLOWLINKSchemaFLOWLINKActionPromptForValueContext;
  ...
  if (v5)
  {
    ...
    {
      v7 = [[FLOWLINKSchemaFLOWLINKActionPromptForValueStarted alloc] initWithDictionary:v6];
    ...
    if (objc_opt_isKindOfClass())
    {
      v9 = [[FLOWLINKSchemaFLOWLINKActionPromptForValueEnded alloc] initWithDictionary:v8];
      [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)v5 setEnded:v9];
    }
    v10 = v5;
  }
  return v5;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)self ended];
  ...
  {
    uint64_t v7 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueStarted *)self->_startedOrChanged hash];
  return [(FLOWLINKSchemaFLOWLINKActionPromptForValueEnded *)self->_ended hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)self ended];
    if (!v13)
    {
...
{
  id v8 = a3;
  id v4 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return FLOWLINKSchemaFLOWLINKActionPromptForValueContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLINKActionPromptForValueEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLINKActionPromptForValueStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
