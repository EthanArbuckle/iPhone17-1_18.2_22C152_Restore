...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (ORCHSchemaORCHPommesRequestEnded)initWithDictionary:(id)a3;
- (ORCHSchemaORCHPommesRequestEnded)initWithJSON:(id)a3;
...
- (ORCHSchemaORCHPommesRequestEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ORCHSchemaORCHPommesRequestEnded;
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHPommesRequestEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(ORCHSchemaORCHPommesRequestEnded *)self status];
...
- (BOOL)readFrom:(id)a3
{
  return ORCHSchemaORCHPommesRequestEndedReadFrom(self, (uint64_t)a3);
}
