...
- (PETSchemaPET1Key)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PETSchemaPET1Key;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_key)
  {
    id v4 = [(PETSchemaPET1Key *)self key];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PETSchemaPET1Key *)self key];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(PETSchemaPET1Key *)self key];
      v11 = [v4 key];
...
- (BOOL)readFrom:(id)a3
{
  return PETSchemaPET1KeyReadFrom(self, (uint64_t)a3);
}
