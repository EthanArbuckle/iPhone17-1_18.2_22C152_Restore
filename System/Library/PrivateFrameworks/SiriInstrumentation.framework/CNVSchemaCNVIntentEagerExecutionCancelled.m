...
- (CNVSchemaCNVIntentEagerExecutionCancelled)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CNVSchemaCNVIntentEagerExecutionCancelled;
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(CNVSchemaCNVIntentEagerExecutionCancelled *)self cancellationReason] - 1;
    if (v4 > 2) {
...
- (BOOL)readFrom:(id)a3
{
  return CNVSchemaCNVIntentEagerExecutionCancelledReadFrom(self, (uint64_t)a3);
}
