...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(ASRSchemaASRTokenTier1 *)self ipaPhoneSequence];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  ...
  NSUInteger v4 = [(NSString *)self->_phoneSequence hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(ASRSchemaASRTokenTier1 *)self text];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v12 = [(ASRSchemaASRTokenTier1 *)self phoneSequence];
  if (v12)
  {
    v13 = (void *)v12;
    objc_super v14 = [(ASRSchemaASRTokenTier1 *)self phoneSequence];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(ASRSchemaASRTokenTier1 *)self ipaPhoneSequence];
    if (!v17)
    {
...
{
  id v8 = a3;
  id v4 = [(ASRSchemaASRTokenTier1 *)self text];
