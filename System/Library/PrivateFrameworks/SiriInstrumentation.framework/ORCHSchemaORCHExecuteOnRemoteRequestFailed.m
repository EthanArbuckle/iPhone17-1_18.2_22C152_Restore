...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (ORCHSchemaORCHExecuteOnRemoteRequestFailed)initWithDictionary:(id)a3;
- (ORCHSchemaORCHExecuteOnRemoteRequestFailed)initWithJSON:(id)a3;
...
- (ORCHSchemaORCHExecuteOnRemoteRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ORCHSchemaORCHExecuteOnRemoteRequestFailed;
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHExecuteOnRemoteRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(ORCHSchemaORCHExecuteOnRemoteRequestFailed *)self aceCommandType] - 1;
    if (v4 > 4) {
...
- (BOOL)readFrom:(id)a3
{
  return ORCHSchemaORCHExecuteOnRemoteRequestFailedReadFrom(self, (uint64_t)a3);
}
