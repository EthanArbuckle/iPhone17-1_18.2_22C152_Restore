...
- (GATSchemaGATRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)GATSchemaGATRequestFailed;
  v5 = [(GATSchemaGATRequestFailed *)&v10 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithInt:", -[GATSchemaGATRequestFailed errorCode](self, "errorCode"));
  ...
  if (has)
  {
    unsigned int v6 = [(GATSchemaGATRequestFailed *)self errorDomain] - 1;
    if (v6 > 8) {
      uint64_t v7 = @"GATERRORDOMAIN_UNKNOWN";
    }
    else {
      uint64_t v7 = off_1E5EC16D0[v6];
    }
...
- (BOOL)readFrom:(id)a3
{
  return GATSchemaGATRequestFailedReadFrom(self, (uint64_t)a3);
}
