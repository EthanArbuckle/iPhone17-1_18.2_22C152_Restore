...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(PSESchemaPSEAlarmSignalGenerated *)self commonSignal];
  ...
  v9 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];
...
- (PSESchemaPSEAlarmSignalGenerated)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"alarmSignal"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(PSESchemaPSEAlarmSignalGenerated *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"alarmSignal"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"alarmSignal"];
    }
  }
  if (self->_commonSignal)
  {
    uint64_t v7 = [(PSESchemaPSEAlarmSignalGenerated *)self commonSignal];
...
- (unint64_t)hash
{
  ...
  return [(PSESchemaPSEAlarm *)self->_alarmSignal hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(PSESchemaPSEAlarmSignalGenerated *)self commonSignal];
  v6 = [v4 commonSignal];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  ...
  {
    int v8 = (void *)v7;
    v9 = [(PSESchemaPSEAlarmSignalGenerated *)self commonSignal];
    v10 = [v4 commonSignal];
  ...
  v5 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];
  v6 = [v4 alarmSignal];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];
    if (!v12)
    {
...
LABEL_15:
    ...
    v14 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];
    v15 = [v4 alarmSignal];
...
{
  id v8 = a3;
  id v4 = [(PSESchemaPSEAlarmSignalGenerated *)self commonSignal];
  ...
  v6 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];

  if (v6)
  {
    uint64_t v7 = [(PSESchemaPSEAlarmSignalGenerated *)self alarmSignal];
    PBDataWriterWriteSubmessage();
  }
}
