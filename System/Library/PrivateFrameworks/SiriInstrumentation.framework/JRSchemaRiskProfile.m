@interface JRSchemaRiskProfile
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (JRSchemaRiskProfile)initWithDictionary:(id)a3;
- (JRSchemaRiskProfile)initWithJSON:(id)a3;
- (NSArray)tuples;
- (NSData)jsonData;
...
@implementation JRSchemaRiskProfile

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)JRSchemaRiskProfile;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(JRSchemaRiskProfile *)self tuples];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(JRSchemaRiskProfile *)self setTuples:v7];
  return v5;
}
...
- (JRSchemaRiskProfile)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)JRSchemaRiskProfile;
  v5 = [(JRSchemaRiskProfile *)&v21 init];
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              v13 = [JRSchemaRiskTuple alloc];
              v14 = -[JRSchemaRiskTuple initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
              [(JRSchemaRiskProfile *)v5 addTuples:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (JRSchemaRiskProfile)initWithJSON:(id)a3
{
  ...
  {
    self = [(JRSchemaRiskProfile *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(JRSchemaRiskProfile *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(JRSchemaRiskProfile *)self tuples];
    uint64_t v6 = [v4 tuples];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(JRSchemaRiskProfile *)self tuples];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(JRSchemaRiskProfile *)self tuples];
...
- (BOOL)readFrom:(id)a3
{
  return JRSchemaRiskProfileReadFrom(self, (uint64_t)a3);
}
