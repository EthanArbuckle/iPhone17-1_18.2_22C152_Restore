...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SISchemaUEIDictationEuclidAlternativesEventTier1 *)self confusionPair];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaUEIDictationEuclidAlternativesEventTier1 *)self confusionPair];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(SISchemaUEIDictationEuclidAlternativesEventTier1 *)self confusionPair];
