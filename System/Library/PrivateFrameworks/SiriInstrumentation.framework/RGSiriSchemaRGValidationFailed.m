@interface RGSiriSchemaRGValidationFailed
- (BOOL)hasFatalError;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
...
- (RGSiriSchemaRGValidationFailed)initWithDictionary:(id)a3
{
  ...
  v5 = [(RGSiriSchemaRGValidationFailed *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"fatalError"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[RGSiriSchemaRGValidationFailed setFatalError:](v5, "setFatalError:", [v6 intValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (RGSiriSchemaRGValidationFailed)initWithJSON:(id)a3
{
  ...
  {
    self = [(RGSiriSchemaRGValidationFailed *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(RGSiriSchemaRGValidationFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [(RGSiriSchemaRGValidationFailed *)self fatalError];
