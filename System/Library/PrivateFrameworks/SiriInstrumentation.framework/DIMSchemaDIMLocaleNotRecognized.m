...
- (NSData)jsonData;
- (NSString)unknownLocale;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)deleteUnknownLocale;
- (void)setHasUnknownLocale:(BOOL)a3;
- (void)setUnknownLocale:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (DIMSchemaDIMLocaleNotRecognized)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)DIMSchemaDIMLocaleNotRecognized;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(DIMSchemaDIMLocaleNotRecognized *)self unknownLocale];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSString *)self->_unknownLocale hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(DIMSchemaDIMLocaleNotRecognized *)self unknownLocale];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(DIMSchemaDIMLocaleNotRecognized *)self unknownLocale];
...
- (BOOL)readFrom:(id)a3
{
  return DIMSchemaDIMLocaleNotRecognizedReadFrom(self, (uint64_t)a3);
}
