...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (INFERENCESchemaINFERENCEResolutionRequestFailed)initWithDictionary:(id)a3;
- (INFERENCESchemaINFERENCEResolutionRequestFailed)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (INFERENCESchemaINFERENCEResolutionRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)INFERENCESchemaINFERENCEResolutionRequestFailed;
...
- (NSData)jsonData
{
  v2 = [(INFERENCESchemaINFERENCEResolutionRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[INFERENCESchemaINFERENCEResolutionRequestFailed errorCode](self, "errorCode"));
...
- (BOOL)readFrom:(id)a3
{
  return INFERENCESchemaINFERENCEResolutionRequestFailedReadFrom(self, (uint64_t)a3);
}
