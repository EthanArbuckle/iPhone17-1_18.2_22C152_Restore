...
- (MTSchemaMTBatchRequestContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[MTSchemaMTBatchRequestEnded alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    id v4 = [(MTSchemaMTBatchRequestContext *)self cancelled];
  ...
  if (self->_contextId)
  {
    uint64_t v7 = [(MTSchemaMTBatchRequestContext *)self contextId];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(MTSchemaMTBatchRequestStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(MTSchemaMTBatchRequestEnded *)self->_ended hash];
  unint64_t v6 = v4 ^ v5 ^ [(MTSchemaMTBatchRequestFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v6 = [(MTSchemaMTBatchRequestContext *)self contextId];
  uint64_t v7 = [v4 contextId];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v8 = [(MTSchemaMTBatchRequestContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  unint64_t v6 = [(MTSchemaMTBatchRequestContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v13 = [(MTSchemaMTBatchRequestContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  unint64_t v6 = [(MTSchemaMTBatchRequestContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v18 = [(MTSchemaMTBatchRequestContext *)self ended];
  if (v18)
  {
    v19 = (void *)v18;
    int v20 = [(MTSchemaMTBatchRequestContext *)self ended];
    v21 = [v4 ended];
  ...
  unint64_t v6 = [(MTSchemaMTBatchRequestContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v23 = [(MTSchemaMTBatchRequestContext *)self failed];
  if (v23)
  {
    v24 = (void *)v23;
  ...
  unint64_t v6 = [(MTSchemaMTBatchRequestContext *)self cancelled];
  uint64_t v7 = [v4 cancelled];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v28 = [(MTSchemaMTBatchRequestContext *)self cancelled];
    if (!v28)
    {
...
{
  id v14 = a3;
  id v4 = [(MTSchemaMTBatchRequestContext *)self contextId];

  if (v4)
  {
    unint64_t v5 = [(MTSchemaMTBatchRequestContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(MTSchemaMTBatchRequestContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(MTSchemaMTBatchRequestContext *)self ended];
  ...
  if (v10)
  {
    int v11 = [(MTSchemaMTBatchRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  int v12 = [(MTSchemaMTBatchRequestContext *)self cancelled];

  if (v12)
  {
    uint64_t v13 = [(MTSchemaMTBatchRequestContext *)self cancelled];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setCancelled:(id)a3
{
  id v4 = (MTSchemaMTBatchRequestCancelled *)a3;
...
- (void)setFailed:(id)a3
{
  id v4 = (MTSchemaMTBatchRequestFailed *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setEnded:(id)a3
{
  id v4 = (MTSchemaMTBatchRequestEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (MTSchemaMTBatchRequestStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
