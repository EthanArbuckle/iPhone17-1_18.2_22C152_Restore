...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[ASRSchemaASRInterpolationWeightBundle endTimeInNs](self, "endTimeInNs"));
  ...
  if (has)
  {
    v6 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[ASRSchemaASRInterpolationWeightBundle startTimeInNs](self, "startTimeInNs"));
    [v3 setObject:v6 forKeyedSubscript:@"startTimeInNs"];
  }
  if ([(NSArray *)self->_weights count])
  {
    uint64_t v7 = [(ASRSchemaASRInterpolationWeightBundle *)self weights];
    v8 = (void *)[v7 copy];
...
LABEL_5:
    unint64_t v3 = 0;
    return v3 ^ v2 ^ [(NSArray *)self->_weights hash];
  }
  unint64_t v2 = 0;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
    goto LABEL_5;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v8 == ((v6 >> 1) & 1))
  {
    ...
    {
      uint64_t v10 = [(ASRSchemaASRInterpolationWeightBundle *)self weights];
      uint64_t v11 = [v4 weights];
      uint64_t v12 = v11;
      if ((v10 == 0) != (v11 != 0))
      {
        uint64_t v13 = [(ASRSchemaASRInterpolationWeightBundle *)self weights];
        if (!v13)
        {
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        objc_msgSend(*(id *)(*((void *)&v11 + 1) + 8 * i), "floatValue", (void)v11);
...
- (float)weightsAtIndex:(unint64_t)a3
{
  double v3 = [(NSArray *)self->_weights objectAtIndexedSubscript:a3];
  [v3 floatValue];
  float v5 = v4;
...
- (unint64_t)weightsCount
{
  return [(NSArray *)self->_weights count];
}
