...
- (HALSchemaHALForceFetchFailed)initWithDictionary:(id)a3
{
  ...
  v5 = [(HALSchemaHALForceFetchFailed *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"failureReason"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[HALSchemaHALForceFetchFailed setFailureReason:](v5, "setFailureReason:", [v6 intValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (HALSchemaHALForceFetchFailed)initWithJSON:(id)a3
{
  ...
  {
    self = [(HALSchemaHALForceFetchFailed *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(HALSchemaHALForceFetchFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(HALSchemaHALForceFetchFailed *)self failureReason] - 1;
    if (v4 > 2) {
