...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)IFTSchemaIFTEnumerationValue;
...
- (IFTSchemaIFTEnumerationValue)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)IFTSchemaIFTEnumerationValue;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFTSchemaIFTEnumerationValue *)self displayRepresentation];
  ...
  {
    uint64_t v7 = [(IFTSchemaIFTEnumerationValue *)self typeIdentifier];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(IFTSchemaIFTEnumerationValue *)self displayRepresentation];
    if (!v12)
    {
...
{
  id v8 = a3;
  id v4 = [(IFTSchemaIFTEnumerationValue *)self typeIdentifier];
  ...
  if (v6)
  {
    uint64_t v7 = [(IFTSchemaIFTEnumerationValue *)self displayRepresentation];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTEnumerationValueReadFrom(self, (uint64_t)a3);
}
