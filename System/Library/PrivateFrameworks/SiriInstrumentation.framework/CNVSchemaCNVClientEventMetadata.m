...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (CNVSchemaCNVClientEventMetadata)initWithDictionary:(id)a3;
- (CNVSchemaCNVClientEventMetadata)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)CNVSchemaCNVClientEventMetadata;
  v5 = [(SISchemaInstrumentationMessage *)&v19 applySensitiveConditionsPolicy:v4];
  v6 = [(CNVSchemaCNVClientEventMetadata *)self cnvId];
  ...
  v9 = [(CNVSchemaCNVClientEventMetadata *)self requestId];
  ...
  v12 = [(CNVSchemaCNVClientEventMetadata *)self trpId];
  ...
  v15 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_cnvId, 0);
}
...
- (CNVSchemaCNVClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)CNVSchemaCNVClientEventMetadata;
  v5 = [(CNVSchemaCNVClientEventMetadata *)&v18 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"cnvId"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(CNVSchemaCNVClientEventMetadata *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cnvId)
  {
    id v4 = [(CNVSchemaCNVClientEventMetadata *)self cnvId];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"cnvId"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"cnvId"];
    }
  }
  if (self->_requestId)
  {
    uint64_t v7 = [(CNVSchemaCNVClientEventMetadata *)self requestId];
  ...
  {
    v10 = [(CNVSchemaCNVClientEventMetadata *)self resultCandidateId];
    int v11 = (void *)[v10 copy];
    [v3 setObject:v11 forKeyedSubscript:@"resultCandidateId"];
  }
  if (self->_subRequestId)
  {
    v12 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];
  ...
  if (self->_trpId)
  {
    v15 = [(CNVSchemaCNVClientEventMetadata *)self trpId];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SISchemaUUID *)self->_cnvId hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(CNVSchemaCNVClientEventMetadata *)self cnvId];
  unint64_t v6 = [v4 cnvId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_26;
  }
  uint64_t v7 = [(CNVSchemaCNVClientEventMetadata *)self cnvId];
  if (v7)
  {
    int v8 = (void *)v7;
    v9 = [(CNVSchemaCNVClientEventMetadata *)self cnvId];
    v10 = [v4 cnvId];
  ...
  unint64_t v5 = [(CNVSchemaCNVClientEventMetadata *)self resultCandidateId];
  unint64_t v6 = [v4 resultCandidateId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_26;
  }
  uint64_t v12 = [(CNVSchemaCNVClientEventMetadata *)self resultCandidateId];
  if (v12)
  {
    v13 = (void *)v12;
    int v14 = [(CNVSchemaCNVClientEventMetadata *)self resultCandidateId];
  ...
  unint64_t v5 = [(CNVSchemaCNVClientEventMetadata *)self requestId];
  unint64_t v6 = [v4 requestId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_26;
  }
  uint64_t v17 = [(CNVSchemaCNVClientEventMetadata *)self requestId];
  if (v17)
  {
    objc_super v18 = (void *)v17;
    objc_super v19 = [(CNVSchemaCNVClientEventMetadata *)self requestId];
    v20 = [v4 requestId];
  ...
  unint64_t v5 = [(CNVSchemaCNVClientEventMetadata *)self trpId];
  unint64_t v6 = [v4 trpId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_26;
  }
  uint64_t v22 = [(CNVSchemaCNVClientEventMetadata *)self trpId];
  if (v22)
  {
    v23 = (void *)v22;
    v24 = [(CNVSchemaCNVClientEventMetadata *)self trpId];
    v25 = [v4 trpId];
  ...
  unint64_t v5 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];
  unint64_t v6 = [v4 subRequestId];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v27 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];
    if (!v27)
    {
...
LABEL_30:
    ...
    v28 = (void *)v27;
    v29 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];
    v30 = [v4 subRequestId];
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v6 = [(CNVSchemaCNVClientEventMetadata *)self resultCandidateId];
  ...
  if (v7)
  {
    int v8 = [(CNVSchemaCNVClientEventMetadata *)self requestId];
    PBDataWriterWriteSubmessage();
  }
  v9 = [(CNVSchemaCNVClientEventMetadata *)self trpId];

  if (v9)
  {
    v10 = [(CNVSchemaCNVClientEventMetadata *)self trpId];
    PBDataWriterWriteSubmessage();
  }
  int v11 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];

  if (v11)
  {
    uint64_t v12 = [(CNVSchemaCNVClientEventMetadata *)self subRequestId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return CNVSchemaCNVClientEventMetadataReadFrom(self, (uint64_t)a3);
}
