...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GATSchemaGATLoadScreenContentEventFailed)initWithDictionary:(id)a3;
- (GATSchemaGATLoadScreenContentEventFailed)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (GATSchemaGATLoadScreenContentEventFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)GATSchemaGATLoadScreenContentEventFailed;
  v5 = [(GATSchemaGATLoadScreenContentEventFailed *)&v10 init];
  if (v5)
  {
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATLoadScreenContentEventFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithInt:", -[GATSchemaGATLoadScreenContentEventFailed errorCode](self, "errorCode"));
  ...
  if (has)
  {
    unsigned int v6 = [(GATSchemaGATLoadScreenContentEventFailed *)self errorDomain] - 1;
    if (v6 > 8) {
      uint64_t v7 = @"GATERRORDOMAIN_UNKNOWN";
    }
    else {
      uint64_t v7 = off_1E5EC1640[v6];
    }
...
- (BOOL)readFrom:(id)a3
{
  return GATSchemaGATLoadScreenContentEventFailedReadFrom(self, (uint64_t)a3);
}
