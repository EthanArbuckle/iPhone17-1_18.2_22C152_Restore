...
- (SISchemaAcousticProfile)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SISchemaAcousticProfile;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_a)
  {
    id v4 = [(SISchemaAcousticProfile *)self a];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaAcousticProfile *)self a];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(SISchemaAcousticProfile *)self a];
      v11 = [v4 a];
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaAcousticProfileReadFrom(self, (uint64_t)a3);
}
