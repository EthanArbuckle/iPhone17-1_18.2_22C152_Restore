...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NLXSchemaCDMSpanMatcherContext)initWithDictionary:(id)a3;
- (NLXSchemaCDMSpanMatcherContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)NLXSchemaCDMSpanMatcherContext;
  v5 = [(SISchemaInstrumentationMessage *)&v16 applySensitiveConditionsPolicy:v4];
  v6 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  ...
  v9 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
  ...
  v12 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
...
- (NLXSchemaCDMSpanMatcherContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)NLXSchemaCDMSpanMatcherContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[NLXSchemaCDMSpanMatcherEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaCDMSpanMatcherContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
  ...
  {
    v10 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(NLXSchemaCDMSpanMatcherStarted *)self->_startedOrChanged hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  ...
  v6 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
  ...
  v6 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
    v21 = [v4 ended];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(NLXSchemaCDMSpanMatcherContext *)self ended];

  if (v8)
  {
    v9 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMSpanMatcherContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (NLXSchemaCDMSpanMatcherEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (NLXSchemaCDMSpanMatcherStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
