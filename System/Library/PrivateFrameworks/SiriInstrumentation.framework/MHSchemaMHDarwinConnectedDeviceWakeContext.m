...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)MHSchemaMHDarwinConnectedDeviceWakeContext;
...
- (MHSchemaMHDarwinConnectedDeviceWakeContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)MHSchemaMHDarwinConnectedDeviceWakeContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[MHSchemaMHDarwinConnectedDeviceWakeFailed alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];
...
- (unint64_t)hash
{
  unint64_t v3 = [(MHSchemaMHDarwinConnectedDeviceWakeStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(MHSchemaMHDarwinConnectedDeviceWakeEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
  ...
  uint64_t v13 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self ended];
  if (v13)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];
    if (!v18)
    {
...
{
  id v10 = a3;
  id v4 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];

  if (v8)
  {
    v9 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHDarwinConnectedDeviceWakeContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (MHSchemaMHDarwinConnectedDeviceWakeFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (MHSchemaMHDarwinConnectedDeviceWakeEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (MHSchemaMHDarwinConnectedDeviceWakeStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
