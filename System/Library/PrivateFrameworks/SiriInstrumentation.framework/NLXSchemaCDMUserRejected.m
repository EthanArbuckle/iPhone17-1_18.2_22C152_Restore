...
{
  v9.receiver = self;
  v9.super_class = (Class)NLXSchemaCDMUserRejected;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(NLXSchemaCDMUserRejected *)self offerId];
...
- (NLXSchemaCDMUserRejected)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NLXSchemaCDMUserRejected;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_offerId)
  {
    id v4 = [(NLXSchemaCDMUserRejected *)self offerId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(NLXSchemaCDMUserRejected *)self offerId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(NLXSchemaCDMUserRejected *)self offerId];
      v11 = [v4 offerId];
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMUserRejectedReadFrom(self, (uint64_t)a3);
}
