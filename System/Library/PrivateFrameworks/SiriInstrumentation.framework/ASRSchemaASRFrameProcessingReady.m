...
- (ASRSchemaASRFrameProcessingReady)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ASRSchemaASRFrameProcessingReady;
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[ASRSchemaASRFrameProcessingReady exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return ASRSchemaASRFrameProcessingReadyReadFrom(self, (uint64_t)a3);
}
