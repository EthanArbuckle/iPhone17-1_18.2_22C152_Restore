...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GATSchemaGATRequestHandoff)initWithDictionary:(id)a3;
- (GATSchemaGATRequestHandoff)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (GATSchemaGATRequestHandoff)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)GATSchemaGATRequestHandoff;
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATRequestHandoff *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exist + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[GATSchemaGATRequestHandoff exist](self, "exist"));
...
- (BOOL)readFrom:(id)a3
{
  return GATSchemaGATRequestHandoffReadFrom(self, (uint64_t)a3);
}
