...
- (CLPInstSchemaCLPCDMReplayTaskEnded)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"replayedSampleCount"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(CLPInstSchemaCLPCDMReplayTaskEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[CLPInstSchemaCLPCDMReplayTaskEnded replayedSampleCount](self, "replayedSampleCount"));
    [v3 setObject:v4 forKeyedSubscript:@"replayedSampleCount"];
  }
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (unsigned int replayedSampleCount = self->_replayedSampleCount,
            replayedSampleCount == [v4 replayedSampleCount]))
      {
        BOOL v6 = 1;
      }
    }
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_unsigned int replayedSampleCount = a3;
}
