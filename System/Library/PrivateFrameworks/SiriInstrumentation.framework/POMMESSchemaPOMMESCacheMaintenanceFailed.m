...
- (NSData)jsonData
{
  v2 = [(POMMESSchemaPOMMESCacheMaintenanceFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ([(POMMESSchemaPOMMESCacheMaintenanceFailed *)self reason] == 1) {
      id v4 = @"POMMESCACHEMAINTENANCEFAILEDREASON_PREPOPULATION_PEGASUS_FAILURE";
    }
    else {
      id v4 = @"POMMESCACHEMAINTENANCEFAILEDREASON_UNKNOWN";
    }
