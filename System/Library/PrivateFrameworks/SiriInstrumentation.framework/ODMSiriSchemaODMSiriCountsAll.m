...
- (ODMSiriSchemaODMSiriCountsAll)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"requestCounts"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_dimensions)
  {
    id v4 = [(ODMSiriSchemaODMSiriCountsAll *)self dimensions];
  ...
  {
    uint64_t v7 = [(ODMSiriSchemaODMSiriCountsAll *)self requestCounts];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ODMSiriSchemaODMDynamicDimensionsAll *)self->_dimensions hash];
  return [(ODMSiriSchemaODMSiriRequestCounts *)self->_requestCounts hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(ODMSiriSchemaODMSiriCountsAll *)self dimensions];
  if (v7)
  {
    int v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(ODMSiriSchemaODMSiriCountsAll *)self requestCounts];
    if (!v12)
    {
