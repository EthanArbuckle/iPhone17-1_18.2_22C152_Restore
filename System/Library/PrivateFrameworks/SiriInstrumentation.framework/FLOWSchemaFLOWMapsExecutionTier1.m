...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)FLOWSchemaFLOWMapsExecutionTier1;
...
- (FLOWSchemaFLOWMapsExecutionTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)FLOWSchemaFLOWMapsExecutionTier1;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[FLOWSchemaFLOWMapsEntity initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(FLOWSchemaFLOWMapsExecutionTier1 *)self mapsEntities];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(FLOWSchemaFLOWMapsExecutionTier1 *)self mapsEntities];
...
- (BOOL)readFrom:(id)a3
{
  return FLOWSchemaFLOWMapsExecutionTier1ReadFrom(self, (uint64_t)a3);
}
