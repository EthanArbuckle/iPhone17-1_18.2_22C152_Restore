...
{
  v9.receiver = self;
  v9.super_class = (Class)ODDSiriSchemaODDAssistantCarPlayCounts;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(ODDSiriSchemaODDAssistantCarPlayCounts *)self turnCounts];
...
- (ODDSiriSchemaODDAssistantCarPlayCounts)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ODDSiriSchemaODDAssistantCarPlayCounts;
  v5 = [(ODDSiriSchemaODDAssistantCarPlayCounts *)&v10 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_turnCounts)
  {
    id v4 = [(ODDSiriSchemaODDAssistantCarPlayCounts *)self turnCounts];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"turnCounts"];
    }
    else
    {
...
- (unint64_t)hash
{
  return [(ODDSiriSchemaODDTurnCounts *)self->_turnCounts hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ODDSiriSchemaODDAssistantCarPlayCounts *)self turnCounts];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(ODDSiriSchemaODDAssistantCarPlayCounts *)self turnCounts];
      v11 = [v4 turnCounts];
...
- (BOOL)readFrom:(id)a3
{
  return ODDSiriSchemaODDAssistantCarPlayCountsReadFrom(self, (uint64_t)a3);
}
