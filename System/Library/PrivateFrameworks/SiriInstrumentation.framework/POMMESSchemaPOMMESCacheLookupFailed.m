...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (POMMESSchemaPOMMESCacheLookupFailed)initWithDictionary:(id)a3;
- (POMMESSchemaPOMMESCacheLookupFailed)initWithJSON:(id)a3;
...
- (POMMESSchemaPOMMESCacheLookupFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)POMMESSchemaPOMMESCacheLookupFailed;
...
- (NSData)jsonData
{
  v2 = [(POMMESSchemaPOMMESCacheLookupFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(POMMESSchemaPOMMESCacheLookupFailed *)self reason];
...
- (BOOL)readFrom:(id)a3
{
  return POMMESSchemaPOMMESCacheLookupFailedReadFrom(self, (uint64_t)a3);
}
