...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (EXPSiriSchemaEXPAllocationChangelogSnapshot)initWithDictionary:(id)a3;
- (EXPSiriSchemaEXPAllocationChangelogSnapshot)initWithJSON:(id)a3;
- (NSArray)allocations;
- (NSData)jsonData;
...
@implementation EXPSiriSchemaEXPAllocationChangelogSnapshot

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)EXPSiriSchemaEXPAllocationChangelogSnapshot;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self allocations];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self setAllocations:v7];
  return v5;
}
...
- (EXPSiriSchemaEXPAllocationChangelogSnapshot)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)EXPSiriSchemaEXPAllocationChangelogSnapshot;
  v5 = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)&v21 init];
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)v5 addAllocations:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (EXPSiriSchemaEXPAllocationChangelogSnapshot)initWithJSON:(id)a3
{
  ...
  {
    self = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self allocations];
    uint64_t v6 = [v4 allocations];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self allocations];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(EXPSiriSchemaEXPAllocationChangelogSnapshot *)self allocations];
...
- (BOOL)readFrom:(id)a3
{
  return EXPSiriSchemaEXPAllocationChangelogSnapshotReadFrom(self, (uint64_t)a3);
}
