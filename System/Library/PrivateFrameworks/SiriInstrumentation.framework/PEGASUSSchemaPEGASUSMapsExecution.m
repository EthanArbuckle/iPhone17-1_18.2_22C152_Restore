...
- (PEGASUSSchemaPEGASUSMapsExecution)initWithDictionary:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)PEGASUSSchemaPEGASUSMapsExecution;
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 8) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSMapsExecution isProxySearchResult](self, "isProxySearchResult"));
...
LABEL_3:
  ...
  v6 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSMapsExecution isSearchAlongRouteRequest](self, "isSearchAlongRouteRequest"));
...
LABEL_10:
    unsigned int v8 = [(PEGASUSSchemaPEGASUSMapsExecution *)self mapsFeature] - 1;
    if (v8 > 0xB) {
...
LABEL_9:
  uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[PEGASUSSchemaPEGASUSMapsExecution isSpellCorrected](self, "isSpellCorrected"));
...
LABEL_5:
  ...
  {
LABEL_14:
    unsigned int v10 = [(PEGASUSSchemaPEGASUSMapsExecution *)self mapsQueryLabel] - 1;
    if (v10 > 0xA) {
      v11 = @"PEGASUSMAPSQUERYLABEL_UNKNOWN";
    }
    else {
      v11 = off_1E5EBC6F8[v10];
    }
...
- (BOOL)readFrom:(id)a3
{
  return PEGASUSSchemaPEGASUSMapsExecutionReadFrom(self, (uint64_t)a3);
}
