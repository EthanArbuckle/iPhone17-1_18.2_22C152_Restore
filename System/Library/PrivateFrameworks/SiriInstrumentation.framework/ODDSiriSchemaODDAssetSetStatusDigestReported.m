@interface ODDSiriSchemaODDAssetSetStatusDigestReported
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self fixedDimensions];
  v7 = [v6 applySensitiveConditionsPolicy:v4];
  int v8 = [v7 suppressMessage];

  if (v8) {
    [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self deleteFixedDimensions];
  }
  v9 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self digests];
  v10 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v9 underConditions:v4];
  [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self setDigests:v10];
...
- (ODDSiriSchemaODDAssetSetStatusDigestReported)initWithDictionary:(id)a3
{
  ...
  v5 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)&v23 init];
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      [(ODDSiriSchemaODDAssetSetStatusDigestReported *)v5 setFixedDimensions:v7];
    }
      ...
      if (v10)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              v15 = [[ODDSiriSchemaODDAssetSetStatusDigest alloc] initWithDictionary:v14];
              [(ODDSiriSchemaODDAssetSetStatusDigestReported *)v5 addDigests:v15];
            }
            ++v13;
          }
          while (v11 != v13);
...
- (ODDSiriSchemaODDAssetSetStatusDigestReported)initWithJSON:(id)a3
{
  ...
  {
    self = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self fixedDimensions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self fixedDimensions];
  uint64_t v6 = [v4 fixedDimensions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self fixedDimensions];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self fixedDimensions];
  ...
  v5 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self digests];
  uint64_t v6 = [v4 digests];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self digests];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self digests];
    v15 = [v4 digests];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(ODDSiriSchemaODDAssetSetStatusDigestReported *)self fixedDimensions];
