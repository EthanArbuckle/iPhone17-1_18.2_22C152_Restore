...
- (NSData)jsonData;
- (SISchemaMultiUserState)initWithDictionary:(id)a3;
- (SISchemaMultiUserState)initWithJSON:(id)a3;
...
@implementation SISchemaMultiUserState

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)SISchemaMultiUserState;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(SISchemaMultiUserState *)self enrolledUsers];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(SISchemaMultiUserState *)self setEnrolledUsers:v7];
  return v5;
}
...
- (SISchemaMultiUserState)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)SISchemaMultiUserState;
  v5 = [(SISchemaMultiUserState *)&v21 init];
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              v13 = [SISchemaEnrolledUserState alloc];
              v14 = -[SISchemaEnrolledUserState initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
              [(SISchemaMultiUserState *)v5 addEnrolledUsers:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (SISchemaMultiUserState)initWithJSON:(id)a3
{
  ...
  {
    self = [(SISchemaMultiUserState *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(SISchemaMultiUserState *)self dictionaryRepresentation];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_enrolledUsers hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(SISchemaMultiUserState *)self enrolledUsers];
    uint64_t v6 = [v4 enrolledUsers];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaMultiUserState *)self enrolledUsers];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(SISchemaMultiUserState *)self enrolledUsers];
      uint64_t v11 = [v4 enrolledUsers];
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaMultiUserStateReadFrom(self, (uint64_t)a3);
}
