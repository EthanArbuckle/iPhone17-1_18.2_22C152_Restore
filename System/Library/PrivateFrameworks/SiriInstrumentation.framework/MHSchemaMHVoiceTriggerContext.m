...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)MHSchemaMHVoiceTriggerContext;
...
- (MHSchemaMHVoiceTriggerContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)MHSchemaMHVoiceTriggerContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[MHSchemaMHVoiceTriggerSecondPassRejected alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    id v4 = [(MHSchemaMHVoiceTriggerContext *)self cancelled];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(MHSchemaMHVoiceTriggerContext *)self ended];
...
- (unint64_t)hash
{
  unint64_t v3 = [(MHSchemaMHVoiceTriggerSecondPassStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(MHSchemaMHVoiceTriggerSecondPassTriggered *)self->_ended hash] ^ v3;
  unint64_t v5 = [(MHSchemaMHVoiceTriggerSecondPassRejected *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(MHSchemaMHVoiceTriggerContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  uint64_t v13 = [(MHSchemaMHVoiceTriggerContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  uint64_t v18 = [(MHSchemaMHVoiceTriggerContext *)self failed];
  if (v18)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(MHSchemaMHVoiceTriggerContext *)self cancelled];
    if (!v23)
    {
...
{
  id v12 = a3;
  id v4 = [(MHSchemaMHVoiceTriggerContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(MHSchemaMHVoiceTriggerContext *)self startedOrChanged];
  ...
  uint64_t v8 = [(MHSchemaMHVoiceTriggerContext *)self failed];
  ...
  if (v10)
  {
    int v11 = [(MHSchemaMHVoiceTriggerContext *)self cancelled];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHVoiceTriggerContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setCancelled:(id)a3
{
  id v4 = (MHSchemaMHVoiceTriggerSecondPassCancelled *)a3;
...
- (void)setFailed:(id)a3
{
  id v4 = (MHSchemaMHVoiceTriggerSecondPassRejected *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setEnded:(id)a3
{
  id v4 = (MHSchemaMHVoiceTriggerSecondPassTriggered *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (MHSchemaMHVoiceTriggerSecondPassStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
