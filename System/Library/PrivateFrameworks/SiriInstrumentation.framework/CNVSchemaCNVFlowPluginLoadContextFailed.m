...
- (id)dictionaryRepresentation
{
  ...
  if (v4)
  {
    v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[CNVSchemaCNVFlowPluginLoadContextFailed errorCode](self, "errorCode"));
  ...
  if ((v4 & 2) != 0)
  {
    v6 = objc_msgSend(NSNumber, "numberWithBool:", -[CNVSchemaCNVFlowPluginLoadContextFailed hasPluginCached](self, "hasPluginCached"));
