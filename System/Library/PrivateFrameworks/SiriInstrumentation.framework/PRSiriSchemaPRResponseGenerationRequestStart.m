...
- (NSArray)actionStatementIds
{
  return self->_actionStatementIds;
}
...
- (PRSiriSchemaPRResponseGenerationRequestStart)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)PRSiriSchemaPRResponseGenerationRequestStart;
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
              -[PRSiriSchemaPRResponseGenerationRequestStart addActionStatementId:](v5, "addActionStatementId:", objc_msgSend(v12, "unsignedIntValue", (void)v15));
            }
            ++v11;
          }
          while (v9 != v11);
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PRSiriSchemaPRResponseGenerationRequestStart *)self actionStatementIds];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_actionStatementIds hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PRSiriSchemaPRResponseGenerationRequestStart *)self actionStatementIds];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(PRSiriSchemaPRResponseGenerationRequestStart *)self actionStatementIds];
      uint64_t v11 = [v4 actionStatementIds];
...
- (BOOL)readFrom:(id)a3
{
  return PRSiriSchemaPRResponseGenerationRequestStartReadFrom(self, (uint64_t)a3);
}
...
- (unint64_t)actionStatementIdCount
{
  return [(NSArray *)self->_actionStatementIds count];
}
...
- (void)addActionStatementId:(unsigned int)a3
{
  ...
  if (!actionStatementIds)
  {
    ...
    uint64_t v7 = self->_actionStatementIds;
