...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(CLPInstSchemaCLPClientEventMetadata *)self clpId];
...
- (CLPInstSchemaCLPClientEventMetadata)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"clpId"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(CLPInstSchemaCLPClientEventMetadata *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_clpId)
  {
    id v4 = [(CLPInstSchemaCLPClientEventMetadata *)self clpId];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"clpId"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"clpId"];
    }
  }
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_clpId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(CLPInstSchemaCLPClientEventMetadata *)self clpId];
    v6 = [v4 clpId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(CLPInstSchemaCLPClientEventMetadata *)self clpId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(CLPInstSchemaCLPClientEventMetadata *)self clpId];
      v11 = [v4 clpId];
