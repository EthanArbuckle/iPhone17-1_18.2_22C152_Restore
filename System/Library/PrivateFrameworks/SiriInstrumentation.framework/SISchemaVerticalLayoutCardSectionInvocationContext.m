...
- (SISchemaVerticalLayoutCardSectionInvocationContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"resultIdentifier"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
    v5 = (void *)[v4 copy];
    [v3 setObject:v5 forKeyedSubscript:@"resultIdentifier"];
  }
...
- (unint64_t)hash
{
  return [(NSString *)self->_resultIdentifier hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
    v6 = [v4 resultIdentifier];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
      v11 = [v4 resultIdentifier];
