...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (SISchemaUEISiriCarCommandFailed)initWithDictionary:(id)a3;
- (SISchemaUEISiriCarCommandFailed)initWithJSON:(id)a3;
...
- (SISchemaUEISiriCarCommandFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SISchemaUEISiriCarCommandFailed;
...
- (NSData)jsonData
{
  v2 = [(SISchemaUEISiriCarCommandFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[SISchemaUEISiriCarCommandFailed isSiriDigitalCarKeyRequest](self, "isSiriDigitalCarKeyRequest"));
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaUEISiriCarCommandFailedReadFrom(self, (uint64_t)a3);
}
