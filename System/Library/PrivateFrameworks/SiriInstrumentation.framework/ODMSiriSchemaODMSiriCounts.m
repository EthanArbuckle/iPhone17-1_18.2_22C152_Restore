...
- (id)dictionaryRepresentation
{
  ...
  if (self->_dimensions)
  {
    id v4 = [(ODMSiriSchemaODMSiriCounts *)self dimensions];
  ...
  if (self->_taskCounts)
  {
    uint64_t v7 = [(ODMSiriSchemaODMSiriCounts *)self taskCounts];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ODMSiriSchemaODMDynamicDimensions *)self->_dimensions hash];
  return [(ODMSiriSchemaODMSiriTaskCounts *)self->_taskCounts hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(ODMSiriSchemaODMSiriCounts *)self dimensions];
  if (v7)
  {
    int v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(ODMSiriSchemaODMSiriCounts *)self taskCounts];
    if (!v12)
    {
