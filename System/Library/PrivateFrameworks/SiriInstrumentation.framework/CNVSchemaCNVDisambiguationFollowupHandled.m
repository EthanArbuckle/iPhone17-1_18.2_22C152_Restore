...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (CNVSchemaCNVDisambiguationFollowupHandled)initWithDictionary:(id)a3;
- (CNVSchemaCNVDisambiguationFollowupHandled)initWithJSON:(id)a3;
- (NSData)jsonData;
...
{
  v9.receiver = self;
  v9.super_class = (Class)CNVSchemaCNVDisambiguationFollowupHandled;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(CNVSchemaCNVDisambiguationFollowupHandled *)self actionCandidateId];
...
- (CNVSchemaCNVDisambiguationFollowupHandled)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)CNVSchemaCNVDisambiguationFollowupHandled;
...
- (NSData)jsonData
{
  v2 = [(CNVSchemaCNVDisambiguationFollowupHandled *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(CNVSchemaCNVDisambiguationFollowupHandled *)self actionCandidateId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_actionCandidateId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(CNVSchemaCNVDisambiguationFollowupHandled *)self actionCandidateId];
    v6 = [v4 actionCandidateId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(CNVSchemaCNVDisambiguationFollowupHandled *)self actionCandidateId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(CNVSchemaCNVDisambiguationFollowupHandled *)self actionCandidateId];
...
- (BOOL)readFrom:(id)a3
{
  return CNVSchemaCNVDisambiguationFollowupHandledReadFrom(self, (uint64_t)a3);
}
