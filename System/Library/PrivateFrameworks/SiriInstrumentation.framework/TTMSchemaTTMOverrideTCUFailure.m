...
- (NSData)jsonData;
- (SISchemaUUID)tcuId;
- (TTMSchemaTTMOverrideTCUFailure)initWithDictionary:(id)a3;
- (TTMSchemaTTMOverrideTCUFailure)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)TTMSchemaTTMOverrideTCUFailure;
  v5 = [(SISchemaInstrumentationMessage *)&v12 applySensitiveConditionsPolicy:v4];
  v6 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
  ...
  v9 = [(TTMSchemaTTMOverrideTCUFailure *)self failures];
...
- (TTMSchemaTTMOverrideTCUFailure)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)TTMSchemaTTMOverrideTCUFailure;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"failures"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (NSData)jsonData
{
  v2 = [(TTMSchemaTTMOverrideTCUFailure *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSArray *)self->_failures count])
  {
    ...
    [v3 setObject:v4 forKeyedSubscript:@"failures"];
  }
  if (self->_tcuId)
  {
    uint64_t v12 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
...
- (unint64_t)hash
{
  ...
  return [(NSArray *)self->_failures hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
  uint64_t v6 = [v4 tcuId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
    uint64_t v10 = [v4 tcuId];
  ...
  v5 = [(TTMSchemaTTMOverrideTCUFailure *)self failures];
  uint64_t v6 = [v4 failures];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(TTMSchemaTTMOverrideTCUFailure *)self failures];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(TTMSchemaTTMOverrideTCUFailure *)self failures];
    v15 = [v4 failures];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
...
- (BOOL)readFrom:(id)a3
{
  return TTMSchemaTTMOverrideTCUFailureReadFrom(self, (uint64_t)a3);
}

- (id)failuresAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_failures objectAtIndexedSubscript:a3];
}

- (unint64_t)failuresCount
{
  return [(NSArray *)self->_failures count];
}
