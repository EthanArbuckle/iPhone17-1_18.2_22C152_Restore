...
- (ASRSchemaASRFailed)initWithDictionary:(id)a3;
- (ASRSchemaASRFailed)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)ASRSchemaASRFailed;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(ASRSchemaASRFailed *)self metrics];
...
- (ASRSchemaASRFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ASRSchemaASRFailed;
...
- (NSData)jsonData
{
  v2 = [(ASRSchemaASRFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_metrics)
  {
    id v4 = [(ASRSchemaASRFailed *)self metrics];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(ASRSchemaASRFailed *)self metrics];
    v6 = [v4 metrics];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ASRSchemaASRFailed *)self metrics];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(ASRSchemaASRFailed *)self metrics];
      v11 = [v4 metrics];
...
- (BOOL)readFrom:(id)a3
{
  return ASRSchemaASRFailedReadFrom(self, (uint64_t)a3);
}
