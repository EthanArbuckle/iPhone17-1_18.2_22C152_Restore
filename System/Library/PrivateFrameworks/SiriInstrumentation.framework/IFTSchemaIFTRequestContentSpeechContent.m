...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTRequestContentSpeechContent;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTRequestContentSpeechContent *)self candidates];
...
- (IFTSchemaIFTRequestContentSpeechContent)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)IFTSchemaIFTRequestContentSpeechContent;
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              v13 = [IFTSchemaIFTSpeechRequestCandidate alloc];
              v14 = -[IFTSchemaIFTSpeechRequestCandidate initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
              [(IFTSchemaIFTRequestContentSpeechContent *)v5 addCandidates:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTRequestContentSpeechContent *)self candidates];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(IFTSchemaIFTRequestContentSpeechContent *)self candidates];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTRequestContentSpeechContentReadFrom(self, (uint64_t)a3);
}
