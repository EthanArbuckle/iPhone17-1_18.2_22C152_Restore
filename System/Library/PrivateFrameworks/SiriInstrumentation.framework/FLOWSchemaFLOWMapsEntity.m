...
- (id)dictionaryRepresentation
{
  ...
  if (self->_addressId)
  {
    id v4 = [(FLOWSchemaFLOWMapsEntity *)self addressId];
    v5 = (void *)[v4 copy];
  ...
  if (whichEntityid == 2)
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[FLOWSchemaFLOWMapsEntity mapsFeatureId](self, "mapsFeatureId"));
  ...
  if (whichEntityid == 1)
  {
    v8 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[FLOWSchemaFLOWMapsEntity muid](self, "muid"));
    ...
    if (whichEntityid == [v4 whichEntityid])
    {
      ...
      if (muid == [v4 muid])
      {
        ...
        if (mapsFeatureId == [v4 mapsFeatureId])
        {
          ...
          if ((v8 == 0) != (v9 != 0))
          {
            uint64_t v11 = [(FLOWSchemaFLOWMapsEntity *)self addressId];
            if (!v11)
            {
