...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ODDSiriSchemaODDDictationCounts *)self turnCounts];
...
- (NSData)jsonData
{
  v2 = [(ODDSiriSchemaODDDictationCounts *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_turnCounts)
  {
    id v4 = [(ODDSiriSchemaODDDictationCounts *)self turnCounts];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(ODDSiriSchemaODDDictationCounts *)self turnCounts];
    v6 = [v4 turnCounts];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ODDSiriSchemaODDDictationCounts *)self turnCounts];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(ODDSiriSchemaODDDictationCounts *)self turnCounts];
      v11 = [v4 turnCounts];
