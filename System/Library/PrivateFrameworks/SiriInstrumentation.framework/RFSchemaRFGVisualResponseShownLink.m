...
{
  v9.receiver = self;
  v9.super_class = (Class)RFSchemaRFGVisualResponseShownLink;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(RFSchemaRFGVisualResponseShownLink *)self turnId];
...
- (RFSchemaRFGVisualResponseShownLink)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RFSchemaRFGVisualResponseShownLink;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_turnId)
  {
    id v4 = [(RFSchemaRFGVisualResponseShownLink *)self turnId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(RFSchemaRFGVisualResponseShownLink *)self turnId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(RFSchemaRFGVisualResponseShownLink *)self turnId];
      v11 = [v4 turnId];
...
- (BOOL)readFrom:(id)a3
{
  return RFSchemaRFGVisualResponseShownLinkReadFrom(self, (uint64_t)a3);
}
