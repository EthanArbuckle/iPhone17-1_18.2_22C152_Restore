...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IDENTITYSchemaIDENTITYVoiceScoreCard)initWithDictionary:(id)a3;
- (IDENTITYSchemaIDENTITYVoiceScoreCard)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)IDENTITYSchemaIDENTITYVoiceScoreCard;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IDENTITYSchemaIDENTITYVoiceScoreCard *)self identityScores];
...
- (IDENTITYSchemaIDENTITYVoiceScoreCard)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)IDENTITYSchemaIDENTITYVoiceScoreCard;
...
- (NSData)jsonData
{
  v2 = [(IDENTITYSchemaIDENTITYVoiceScoreCard *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(IDENTITYSchemaIDENTITYVoiceScoreCard *)self classification] - 1;
    if (v4 > 3) {
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(IDENTITYSchemaIDENTITYVoiceScoreCard *)self identityScores];
...
LABEL_12:
  ...
  uint64_t v8 = [(IDENTITYSchemaIDENTITYVoiceScoreCard *)self identityScores];
  if (v8)
  {
    uint64_t v9 = (void *)v8;
    uint64_t v10 = [(IDENTITYSchemaIDENTITYVoiceScoreCard *)self identityScores];
...
- (BOOL)readFrom:(id)a3
{
  return IDENTITYSchemaIDENTITYVoiceScoreCardReadFrom(self, (uint64_t)a3);
}
