...
- (void)setAlternateQuerySuggestionCount:(int)a3;
- (void)setHasAlternateQuerySuggestionCount:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
- (int)alternateQuerySuggestionCount
{
  return self->_alternateQuerySuggestionCount;
}
...
- (PEGASUSSchemaPEGASUSAlternateQuerySuggestion)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)PEGASUSSchemaPEGASUSAlternateQuerySuggestion;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[PEGASUSSchemaPEGASUSAlternateQuerySuggestion alternateQuerySuggestionCount](self, "alternateQuerySuggestionCount"));
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int alternateQuerySuggestionCount = self->_alternateQuerySuggestionCount,
            alternateQuerySuggestionCount == [v4 alternateQuerySuggestionCount]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return PEGASUSSchemaPEGASUSAlternateQuerySuggestionReadFrom(self, (uint64_t)a3);
}
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_int alternateQuerySuggestionCount = a3;
}
