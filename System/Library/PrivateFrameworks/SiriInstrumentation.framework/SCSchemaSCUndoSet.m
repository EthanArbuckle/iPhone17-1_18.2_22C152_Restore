...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (SCSchemaSCSetUndoArgs)setUndoArgs;
...
- (void)setHasSetUndoArgs:(BOOL)a3;
- (void)setSetUndoArgs:(id)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v9.receiver = self;
  v9.super_class = (Class)SCSchemaSCUndoSet;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(SCSchemaSCUndoSet *)self setUndoArgs];
...
- (SCSchemaSCUndoSet)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SCSchemaSCUndoSet;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SCSchemaSCUndoSet *)self setUndoArgs];
...
- (unint64_t)hash
{
  return [(SCSchemaSCSetUndoArgs *)self->_setUndoArgs hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SCSchemaSCUndoSet *)self setUndoArgs];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(SCSchemaSCUndoSet *)self setUndoArgs];
      v11 = [v4 setUndoArgs];
...
- (BOOL)readFrom:(id)a3
{
  return SCSchemaSCUndoSetReadFrom(self, (uint64_t)a3);
}
