...
- (ExecutorSiriSchemaExecutorAppIntentCallStarted)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ExecutorSiriSchemaExecutorAppIntentCallStarted;
  v5 = [(ExecutorSiriSchemaExecutorAppIntentCallStarted *)&v9 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[ExecutorSiriSchemaExecutorAppIntentCallStarted exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return ExecutorSiriSchemaExecutorAppIntentCallStartedReadFrom(self, (uint64_t)a3);
}
