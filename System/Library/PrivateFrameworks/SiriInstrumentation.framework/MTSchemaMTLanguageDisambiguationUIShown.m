      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
              -[MTSchemaMTLanguageDisambiguationUIShown addLocale:](v5, "addLocale:", objc_msgSend(v12, "intValue", (void)v15));
            }
            ++v11;
          }
          while (v9 != v11);
...
- (NSData)jsonData
{
  v2 = [(MTSchemaMTLanguageDisambiguationUIShown *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_locales hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
    v6 = [v4 locales];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
      uint64_t v11 = [v4 locales];
...
- (int)localeAtIndex:(unint64_t)a3
{
  v3 = [(NSArray *)self->_locales objectAtIndexedSubscript:a3];
  int v4 = [v3 intValue];
...
- (unint64_t)localeCount
{
  return [(NSArray *)self->_locales count];
}
