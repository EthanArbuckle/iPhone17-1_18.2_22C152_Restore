...
- (INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"inferenceWorkoutsAppSelectionTrainingDependentSignals"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated *)self inferenceWorkoutsAppSelectionTrainingIndependentSignals];
...
- (unint64_t)hash
{
  unint64_t v3 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionTrainingIndependentSignals *)self->_inferenceWorkoutsAppSelectionTrainingIndependentSignals hash];
  return [(NSArray *)self->_inferenceWorkoutsAppSelectionTrainingDependentSignals hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v6 = [v4 inferenceWorkoutsAppSelectionTrainingIndependentSignals];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated *)self inferenceWorkoutsAppSelectionTrainingIndependentSignals];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated *)self inferenceWorkoutsAppSelectionTrainingIndependentSignals];
    uint64_t v10 = [v4 inferenceWorkoutsAppSelectionTrainingIndependentSignals];
  ...
  uint64_t v6 = [v4 inferenceWorkoutsAppSelectionTrainingDependentSignals];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated *)self inferenceWorkoutsAppSelectionTrainingDependentSignals];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated *)self inferenceWorkoutsAppSelectionTrainingDependentSignals];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(INFERENCESchemaINFERENCEWorkoutsAppSelectionGroundTruthGenerated *)self inferenceWorkoutsAppSelectionTrainingIndependentSignals];
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  uint64_t v7 = self->_inferenceWorkoutsAppSelectionTrainingDependentSignals;
...
- (id)inferenceWorkoutsAppSelectionTrainingDependentSignalsAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_inferenceWorkoutsAppSelectionTrainingDependentSignals objectAtIndexedSubscript:a3];
}

- (unint64_t)inferenceWorkoutsAppSelectionTrainingDependentSignalsCount
{
  return [(NSArray *)self->_inferenceWorkoutsAppSelectionTrainingDependentSignals count];
}
