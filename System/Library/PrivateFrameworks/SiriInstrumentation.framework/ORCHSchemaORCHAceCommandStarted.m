...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(ORCHSchemaORCHAceCommandStarted *)self aceCommandName];
    v5 = (void *)[v4 copy];
    [v3 setObject:v5 forKeyedSubscript:@"aceCommandName"];
  }
  if (*(unsigned char *)&self->_has)
  {
    unsigned int v6 = [(ORCHSchemaORCHAceCommandStarted *)self aceCommandType] - 1;
    if (v6 > 4) {
      uint64_t v7 = @"ORCHACECOMMANDTYPE_UNKNOWN";
    }
    else {
      uint64_t v7 = off_1E5EBAD48[v6];
    }
...
LABEL_12:
  ...
  uint64_t v8 = [(ORCHSchemaORCHAceCommandStarted *)self aceCommandName];
  if (v8)
  {
    v9 = (void *)v8;
...
{
  id v5 = a3;
  uint64_t v4 = [(ORCHSchemaORCHAceCommandStarted *)self aceCommandName];
