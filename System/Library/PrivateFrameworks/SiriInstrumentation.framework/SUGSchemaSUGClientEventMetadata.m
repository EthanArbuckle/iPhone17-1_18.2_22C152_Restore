...
{
  v9.receiver = self;
  v9.super_class = (Class)SUGSchemaSUGClientEventMetadata;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(SUGSchemaSUGClientEventMetadata *)self sugId];
...
- (SUGSchemaSUGClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SUGSchemaSUGClientEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_sugId)
  {
    id v4 = [(SUGSchemaSUGClientEventMetadata *)self sugId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_sugId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SUGSchemaSUGClientEventMetadata *)self sugId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(SUGSchemaSUGClientEventMetadata *)self sugId];
      v11 = [v4 sugId];
...
- (BOOL)readFrom:(id)a3
{
  return SUGSchemaSUGClientEventMetadataReadFrom(self, (uint64_t)a3);
}
