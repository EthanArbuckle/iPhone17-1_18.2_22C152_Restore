...
- (ODDSiriSchemaODDMultiUserSetupStatus)initWithDictionary:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)ODDSiriSchemaODDMultiUserSetupStatus;
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numGuestsAccepted](self, "numGuestsAccepted"));
...
LABEL_3:
  ...
  v8 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numParticipantsWithTrust](self, "numParticipantsWithTrust"));
...
LABEL_16:
  v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWhoSyncedRecognizeMyVoice](self, "numUsersWhoSyncedRecognizeMyVoice"));
...
LABEL_17:
  v10 = objc_msgSend(NSNumber, "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithLocationServicesEnabled](self, "numUsersWithLocationServicesEnabled"));
...
LABEL_18:
  v11 = objc_msgSend(NSNumber, "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithMatchingSiriLanguage](self, "numUsersWithMatchingSiriLanguage"));
...
LABEL_19:
  v12 = objc_msgSend(NSNumber, "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithPersonalRequestsEnabled](self, "numUsersWithPersonalRequestsEnabled"));
...
LABEL_20:
  v13 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithRecognizeMyVoiceEnabled](self, "numUsersWithRecognizeMyVoiceEnabled"));
...
LABEL_21:
  v14 = objc_msgSend(NSNumber, "numberWithInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numUsersWithSiriCloudSyncEnabled](self, "numUsersWithSiriCloudSyncEnabled"));
  [v3 setObject:v14 forKeyedSubscript:@"numUsersWithSiriCloudSyncEnabled"];

  if ((*(_WORD *)&self->_has & 0x10) != 0)
  {
LABEL_10:
    v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[ODDSiriSchemaODDMultiUserSetupStatus numVoiceProfilesAvailable](self, "numVoiceProfilesAvailable"));
...
- (BOOL)readFrom:(id)a3
{
  return ODDSiriSchemaODDMultiUserSetupStatusReadFrom(self, (uint64_t)a3);
}
