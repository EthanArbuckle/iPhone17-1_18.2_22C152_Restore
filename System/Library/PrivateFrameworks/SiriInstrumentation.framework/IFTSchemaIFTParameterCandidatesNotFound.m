...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTParameterCandidatesNotFound;
  id v4 = a3;
...
- (IFTSchemaIFTParameterCandidatesNotFound)initWithDictionary:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)IFTSchemaIFTParameterCandidatesNotFound;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaIFTParameterCandidatesNotFound exists](self, "exists"));
  ...
  if (self->_value)
  {
    uint64_t v7 = [(IFTSchemaIFTParameterCandidatesNotFound *)self value];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(IFTSchemaIFTParameterCandidatesNotFound *)self parameterId];
  if (v8)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(IFTSchemaIFTParameterCandidatesNotFound *)self value];
    if (!v13)
    {
...
- (void)writeTo:(id)a3
{
  ...
  NSUInteger v4 = [(IFTSchemaIFTParameterCandidatesNotFound *)self parameterId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTParameterCandidatesNotFoundReadFrom(self, (uint64_t)a3);
}
