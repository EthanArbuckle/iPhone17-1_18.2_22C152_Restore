...
- (SISchemaTextToSpeechEnd)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SISchemaTextToSpeechEnd;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_aceID)
  {
    id v4 = [(SISchemaTextToSpeechEnd *)self aceID];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSString *)self->_aceID hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaTextToSpeechEnd *)self aceID];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(SISchemaTextToSpeechEnd *)self aceID];
      v11 = [v4 aceID];
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaTextToSpeechEndReadFrom(self, (uint64_t)a3);
}
