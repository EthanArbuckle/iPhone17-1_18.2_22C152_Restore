...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NLXSchemaCDMServiceContext)initWithDictionary:(id)a3;
- (NLXSchemaCDMServiceContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)NLXSchemaCDMServiceContext;
  v5 = [(SISchemaInstrumentationMessage *)&v19 applySensitiveConditionsPolicy:v4];
  v6 = [(NLXSchemaCDMServiceContext *)self contextId];
  ...
  v9 = [(NLXSchemaCDMServiceContext *)self startedOrChanged];
  ...
  v12 = [(NLXSchemaCDMServiceContext *)self ended];
  ...
  v15 = [(NLXSchemaCDMServiceContext *)self failed];
...
- (NLXSchemaCDMServiceContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)NLXSchemaCDMServiceContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[NLXSchemaCDMServiceEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaCDMServiceContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(NLXSchemaCDMServiceContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(NLXSchemaCDMServiceContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(NLXSchemaCDMServiceContext *)self failed];
  ...
  {
    v13 = [(NLXSchemaCDMServiceContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(NLXSchemaCDMServiceStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(NLXSchemaCDMServiceEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(NLXSchemaCDMServiceContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(NLXSchemaCDMServiceContext *)self contextId];
  ...
  v6 = [(NLXSchemaCDMServiceContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(NLXSchemaCDMServiceContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(NLXSchemaCDMServiceContext *)self startedOrChanged];
  ...
  v6 = [(NLXSchemaCDMServiceContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(NLXSchemaCDMServiceContext *)self ended];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(NLXSchemaCDMServiceContext *)self ended];
    v21 = [v4 ended];
  ...
  v6 = [(NLXSchemaCDMServiceContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(NLXSchemaCDMServiceContext *)self failed];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(NLXSchemaCDMServiceContext *)self failed];
    v26 = [v4 failed];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(NLXSchemaCDMServiceContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(NLXSchemaCDMServiceContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(NLXSchemaCDMServiceContext *)self ended];

  if (v8)
  {
    v9 = [(NLXSchemaCDMServiceContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(NLXSchemaCDMServiceContext *)self failed];
  ...
  if (v10)
  {
    int v11 = [(NLXSchemaCDMServiceContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMServiceContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (NLXSchemaCDMServiceFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (NLXSchemaCDMServiceEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (NLXSchemaCDMServiceStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
