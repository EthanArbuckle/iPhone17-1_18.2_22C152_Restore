...
- (QDSchemaQDCollectionStarted)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)QDSchemaQDCollectionStarted;
  v5 = [(QDSchemaQDCollectionStarted *)&v9 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[QDSchemaQDCollectionStarted exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return QDSchemaQDCollectionStartedReadFrom(self, (uint64_t)a3);
}
