...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (ODDSiriSchemaODDDictationExperimentCounts)initWithDictionary:(id)a3;
- (ODDSiriSchemaODDDictationExperimentCounts)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)ODDSiriSchemaODDDictationExperimentCounts;
  v5 = [(SISchemaInstrumentationMessage *)&v16 applySensitiveConditionsPolicy:v4];
  v6 = [(ODDSiriSchemaODDDictationExperimentCounts *)self turnCounts];
  ...
  v9 = [(ODDSiriSchemaODDDictationExperimentCounts *)self taskCounts];
  ...
  v12 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];
...
- (ODDSiriSchemaODDDictationExperimentCounts)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)ODDSiriSchemaODDDictationExperimentCounts;
...
- (NSData)jsonData
{
  v2 = [(ODDSiriSchemaODDDictationExperimentCounts *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];
  ...
  if (self->_taskCounts)
  {
    uint64_t v7 = [(ODDSiriSchemaODDDictationExperimentCounts *)self taskCounts];
  ...
  if (self->_turnCounts)
  {
    v10 = [(ODDSiriSchemaODDDictationExperimentCounts *)self turnCounts];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ODDSiriSchemaODDDictationExperimentCounts *)self turnCounts];
  v6 = [v4 turnCounts];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v7 = [(ODDSiriSchemaODDDictationExperimentCounts *)self turnCounts];
  if (v7)
  {
    int v8 = (void *)v7;
    v9 = [(ODDSiriSchemaODDDictationExperimentCounts *)self turnCounts];
    v10 = [v4 turnCounts];
  ...
  v5 = [(ODDSiriSchemaODDDictationExperimentCounts *)self taskCounts];
  v6 = [v4 taskCounts];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v12 = [(ODDSiriSchemaODDDictationExperimentCounts *)self taskCounts];
  if (v12)
  {
    v13 = (void *)v12;
    objc_super v14 = [(ODDSiriSchemaODDDictationExperimentCounts *)self taskCounts];
    v15 = [v4 taskCounts];
  ...
  v5 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];
  v6 = [v4 reliabilityCounts];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];
    if (!v17)
    {
...
LABEL_20:
    ...
    v18 = (void *)v17;
    v19 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];
...
{
  id v10 = a3;
  id v4 = [(ODDSiriSchemaODDDictationExperimentCounts *)self turnCounts];
  ...
  v6 = [(ODDSiriSchemaODDDictationExperimentCounts *)self taskCounts];
  ...
  int v8 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];

  if (v8)
  {
    v9 = [(ODDSiriSchemaODDDictationExperimentCounts *)self reliabilityCounts];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return ODDSiriSchemaODDDictationExperimentCountsReadFrom(self, (uint64_t)a3);
}
