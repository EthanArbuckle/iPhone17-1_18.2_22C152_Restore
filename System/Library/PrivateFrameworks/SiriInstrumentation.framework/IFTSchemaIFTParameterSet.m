@interface IFTSchemaIFTParameterSet
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTParameterSet)initWithDictionary:(id)a3;
- (IFTSchemaIFTParameterSet)initWithJSON:(id)a3;
- (NSArray)parameters;
- (NSData)jsonData;
...
@implementation IFTSchemaIFTParameterSet

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTParameterSet;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTParameterSet *)self parameters];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(IFTSchemaIFTParameterSet *)self setParameters:v7];
  return v5;
}
...
- (IFTSchemaIFTParameterSet)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)IFTSchemaIFTParameterSet;
  v5 = [(IFTSchemaIFTParameterSet *)&v21 init];
  if (v5)
  {
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              v13 = [IFTSchemaIFTParameter alloc];
              v14 = -[IFTSchemaIFTParameter initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
              [(IFTSchemaIFTParameterSet *)v5 addParameters:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (IFTSchemaIFTParameterSet)initWithJSON:(id)a3
{
  ...
  {
    self = [(IFTSchemaIFTParameterSet *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTParameterSet *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(IFTSchemaIFTParameterSet *)self parameters];
    uint64_t v6 = [v4 parameters];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTParameterSet *)self parameters];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(IFTSchemaIFTParameterSet *)self parameters];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTParameterSetReadFrom(self, (uint64_t)a3);
}
