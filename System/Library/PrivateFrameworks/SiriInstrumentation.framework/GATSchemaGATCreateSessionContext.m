...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GATSchemaGATCreateSessionContext)initWithDictionary:(id)a3;
- (GATSchemaGATCreateSessionContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)GATSchemaGATCreateSessionContext;
  v5 = [(SISchemaInstrumentationMessage *)&v16 applySensitiveConditionsPolicy:v4];
  v6 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  ...
  v9 = [(GATSchemaGATCreateSessionContext *)self ended];
  ...
  v12 = [(GATSchemaGATCreateSessionContext *)self failed];
...
- (GATSchemaGATCreateSessionContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)GATSchemaGATCreateSessionContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[GATSchemaGATCreateSessionEventFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATCreateSessionContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(GATSchemaGATCreateSessionContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(GATSchemaGATCreateSessionContext *)self failed];
  ...
  {
    v10 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(GATSchemaGATCreateSessionEventStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(GATSchemaGATCreateSessionEventEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  ...
  v6 = [(GATSchemaGATCreateSessionContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(GATSchemaGATCreateSessionContext *)self ended];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(GATSchemaGATCreateSessionContext *)self ended];
  ...
  v6 = [(GATSchemaGATCreateSessionContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(GATSchemaGATCreateSessionContext *)self failed];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(GATSchemaGATCreateSessionContext *)self failed];
    v21 = [v4 failed];
...
{
  id v10 = a3;
  id v4 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(GATSchemaGATCreateSessionContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(GATSchemaGATCreateSessionContext *)self failed];

  if (v8)
  {
    v9 = [(GATSchemaGATCreateSessionContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return GATSchemaGATCreateSessionContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (GATSchemaGATCreateSessionEventFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (GATSchemaGATCreateSessionEventEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (GATSchemaGATCreateSessionEventStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
