...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(RRSchemaRRPullerContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(RRSchemaRRPullerContext *)self failed];
...
- (unint64_t)hash
{
  unint64_t v3 = [(RRSchemaRRPullerEnded *)self->_ended hash];
  return [(RRSchemaRRPullerFailed *)self->_failed hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(RRSchemaRRPullerContext *)self ended];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(RRSchemaRRPullerContext *)self failed];
    if (!v13)
    {
...
- (void)setFailed:(id)a3
{
  id v4 = (RRSchemaRRPullerFailed *)a3;
  ended = self->_ended;
  self->_ended = 0;
...
- (void)setEnded:(id)a3
{
  id v4 = (RRSchemaRRPullerEnded *)a3;
  failed = self->_failed;
  self->_failed = 0;
