...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (CNVSchemaCNVFlowPluginInputContext)initWithDictionary:(id)a3;
- (CNVSchemaCNVFlowPluginInputContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)CNVSchemaCNVFlowPluginInputContext;
  v5 = [(SISchemaInstrumentationMessage *)&v19 applySensitiveConditionsPolicy:v4];
  v6 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  ...
  v9 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
  ...
  v12 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
  ...
  v15 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
...
- (CNVSchemaCNVFlowPluginInputContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)CNVSchemaCNVFlowPluginInputContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[CNVSchemaCNVFlowPluginInputEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(CNVSchemaCNVFlowPluginInputContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
  ...
  {
    v10 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
  ...
  {
    v13 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(CNVSchemaCNVFlowPluginInputStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(CNVSchemaCNVFlowPluginInputEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  ...
  v6 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
  ...
  v6 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
    v21 = [v4 ended];
  ...
  v6 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
  uint64_t v7 = [v4 hypothesisId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
    v26 = [v4 hypothesisId];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];

  if (v8)
  {
    v9 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
  ...
  if (v10)
  {
    int v11 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return CNVSchemaCNVFlowPluginInputContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (CNVSchemaCNVFlowPluginInputEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (CNVSchemaCNVFlowPluginInputStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
