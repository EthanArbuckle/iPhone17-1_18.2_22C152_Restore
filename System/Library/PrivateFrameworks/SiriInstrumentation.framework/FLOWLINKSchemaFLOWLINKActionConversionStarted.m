...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(FLOWLINKSchemaFLOWLINKActionConversionStarted *)self parseHypothesisId];
...
- (FLOWLINKSchemaFLOWLINKActionConversionStarted)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"parseHypothesisId"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(FLOWLINKSchemaFLOWLINKActionConversionStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(FLOWLINKSchemaFLOWLINKActionConversionStarted *)self parseHypothesisId];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"parseHypothesisId"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"parseHypothesisId"];
    }
  }
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_parseHypothesisId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(FLOWLINKSchemaFLOWLINKActionConversionStarted *)self parseHypothesisId];
    v6 = [v4 parseHypothesisId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(FLOWLINKSchemaFLOWLINKActionConversionStarted *)self parseHypothesisId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(FLOWLINKSchemaFLOWLINKActionConversionStarted *)self parseHypothesisId];
      v11 = [v4 parseHypothesisId];
