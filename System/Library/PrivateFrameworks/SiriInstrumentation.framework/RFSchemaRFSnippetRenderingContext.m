...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(RFSchemaRFSnippetRenderingContext *)self startedOrChanged];
  ...
  v9 = [(RFSchemaRFSnippetRenderingContext *)self ended];
  ...
  v12 = [(RFSchemaRFSnippetRenderingContext *)self failed];
  ...
  v15 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];
...
- (RFSchemaRFSnippetRenderingContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[RFSchemaRFSnippetRenderingFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(RFSchemaRFSnippetRenderingContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    id v4 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(RFSchemaRFSnippetRenderingContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(RFSchemaRFSnippetRenderingContext *)self failed];
  ...
  {
    v13 = [(RFSchemaRFSnippetRenderingContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(RFSchemaRFSnippetRenderingStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(RFSchemaRFSnippetRenderingEnded *)self->_ended hash] ^ v3;
  unint64_t v5 = [(RFSchemaRFSnippetRenderingFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(RFSchemaRFSnippetRenderingContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(RFSchemaRFSnippetRenderingContext *)self startedOrChanged];
  ...
  v6 = [(RFSchemaRFSnippetRenderingContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(RFSchemaRFSnippetRenderingContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(RFSchemaRFSnippetRenderingContext *)self ended];
  ...
  v6 = [(RFSchemaRFSnippetRenderingContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(RFSchemaRFSnippetRenderingContext *)self failed];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(RFSchemaRFSnippetRenderingContext *)self failed];
    v21 = [v4 failed];
  ...
  v6 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];
  uint64_t v7 = [v4 cancelled];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];
    v26 = [v4 cancelled];
...
{
  id v12 = a3;
  id v4 = [(RFSchemaRFSnippetRenderingContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(RFSchemaRFSnippetRenderingContext *)self startedOrChanged];
  ...
  uint64_t v8 = [(RFSchemaRFSnippetRenderingContext *)self failed];

  if (v8)
  {
    v9 = [(RFSchemaRFSnippetRenderingContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];

  if (v10)
  {
    int v11 = [(RFSchemaRFSnippetRenderingContext *)self cancelled];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setCancelled:(id)a3
{
  id v4 = (RFSchemaRFSnippetRenderingCancelled *)a3;
...
- (void)setFailed:(id)a3
{
  id v4 = (RFSchemaRFSnippetRenderingFailed *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setEnded:(id)a3
{
  id v4 = (RFSchemaRFSnippetRenderingEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (RFSchemaRFSnippetRenderingStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
