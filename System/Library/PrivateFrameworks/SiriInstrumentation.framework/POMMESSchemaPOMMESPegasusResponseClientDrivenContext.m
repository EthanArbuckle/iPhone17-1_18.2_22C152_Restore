...
- (POMMESSchemaPOMMESPegasusResponseClientDrivenContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)POMMESSchemaPOMMESPegasusResponseClientDrivenContext;
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(POMMESSchemaPOMMESPegasusResponseClientDrivenContext *)self type] - 1;
    if (v4 > 2) {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*(unsigned char *)&self->_has & 1) == 0 || (int type = self->_type, type == [v4 type])) {
        BOOL v6 = 1;
      }
    }
  }
...
- (BOOL)readFrom:(id)a3
{
  return POMMESSchemaPOMMESPegasusResponseClientDrivenContextReadFrom(self, (uint64_t)a3);
}
