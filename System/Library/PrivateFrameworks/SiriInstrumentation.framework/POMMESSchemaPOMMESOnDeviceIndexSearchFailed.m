...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (POMMESSchemaPOMMESOnDeviceIndexSearchFailed)initWithDictionary:(id)a3;
- (POMMESSchemaPOMMESOnDeviceIndexSearchFailed)initWithJSON:(id)a3;
...
- (POMMESSchemaPOMMESOnDeviceIndexSearchFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)POMMESSchemaPOMMESOnDeviceIndexSearchFailed;
...
- (NSData)jsonData
{
  v2 = [(POMMESSchemaPOMMESOnDeviceIndexSearchFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ([(POMMESSchemaPOMMESOnDeviceIndexSearchFailed *)self reason] == 1) {
      id v4 = @"POMMESONDEVICEINDEXSEARCHFAILUREREASON_FAILED";
    }
    else {
      id v4 = @"POMMESONDEVICEINDEXSEARCHFAILUREREASON_UNKNOWN";
    }
...
- (BOOL)readFrom:(id)a3
{
  return POMMESSchemaPOMMESOnDeviceIndexSearchFailedReadFrom(self, (uint64_t)a3);
}
