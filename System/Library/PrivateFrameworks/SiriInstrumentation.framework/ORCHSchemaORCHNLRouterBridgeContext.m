...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  ...
  v9 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  ...
  v12 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
  ...
  v15 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
...
- (ORCHSchemaORCHNLRouterBridgeContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[ORCHSchemaORCHNLRouterBridgeFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHNLRouterBridgeContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
  ...
  {
    v10 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  ...
  if (self->_trpId)
  {
    v13 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ORCHSchemaORCHNLRouterBridgeStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(ORCHSchemaORCHNLRouterBridgeEnded *)self->_ended hash] ^ v3;
  unint64_t v5 = [(ORCHSchemaORCHNLRouterBridgeFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  ...
  v6 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  ...
  v6 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
    v21 = [v4 failed];
  ...
  v6 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
  uint64_t v7 = [v4 trpId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
    v26 = [v4 trpId];
...
{
  id v12 = a3;
  id v4 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];

  if (v8)
  {
    v9 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];

  if (v10)
  {
    int v11 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (ORCHSchemaORCHNLRouterBridgeFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (ORCHSchemaORCHNLRouterBridgeEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (ORCHSchemaORCHNLRouterBridgeStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
