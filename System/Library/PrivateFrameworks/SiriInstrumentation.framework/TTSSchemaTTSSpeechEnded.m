...
- (NSArray)errorCodes;
- (NSData)jsonData;
- (TTSSchemaTTSSpeechEnded)initWithDictionary:(id)a3;
- (TTSSchemaTTSSpeechEnded)initWithJSON:(id)a3;
...
@implementation TTSSchemaTTSSpeechEnded
...
- (TTSSchemaTTSSpeechEnded)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v26.receiver = self;
  v26.super_class = (Class)TTSSchemaTTSSpeechEnded;
  v5 = [(TTSSchemaTTSSpeechEnded *)&v26 init];
  if (v5)
  {
    ...
    {
      [v6 floatValue];
      -[TTSSchemaTTSSpeechEnded setSynthesizedAudioDurationInSecond:](v5, "setSynthesizedAudioDurationInSecond:");
    }
    ...
    {
      [v7 floatValue];
      -[TTSSchemaTTSSpeechEnded setSynthesisLatencyInSecond:](v5, "setSynthesisLatencyInSecond:");
    }
    ...
    {
      [v8 floatValue];
      -[TTSSchemaTTSSpeechEnded setSynthesisRealTimeFactor:](v5, "setSynthesisRealTimeFactor:");
    }
    v9 = [v4 objectForKeyedSubscript:@"promptCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[TTSSchemaTTSSpeechEnded setPromptCount:](v5, "setPromptCount:", [v9 unsignedIntValue]);
    }
      ...
      if (v12)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
              -[TTSSchemaTTSSpeechEnded addErrorCodes:](v5, "addErrorCodes:", [v16 intValue]);
            }
            ++v15;
          }
          while (v13 != v15);
...
- (TTSSchemaTTSSpeechEnded)initWithJSON:(id)a3
{
  ...
  {
    self = [(TTSSchemaTTSSpeechEnded *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(TTSSchemaTTSSpeechEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
    v5 = (void *)[v4 copy];
  ...
  if ((has & 8) != 0)
  {
    v10 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[TTSSchemaTTSSpeechEnded promptCount](self, "promptCount"));
...
LABEL_5:
  ...
  id v11 = NSNumber;
  [(TTSSchemaTTSSpeechEnded *)self synthesisLatencyInSecond];
...
LABEL_13:
  ...
  [(TTSSchemaTTSSpeechEnded *)self synthesisRealTimeFactor];
...
LABEL_7:
    ...
    [(TTSSchemaTTSSpeechEnded *)self synthesizedAudioDurationInSecond];
  ...
  if (v9 == ((v6 >> 1) & 1))
  {
    ...
    if (v12 == ((v6 >> 2) & 1))
    {
      ...
      if (v15 == ((v6 >> 3) & 1))
      {
        ...
        {
          long double v17 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
          double v18 = [v4 errorCodes];
          uint64_t v19 = v18;
          if ((v17 == 0) != (v18 != 0))
          {
            uint64_t v20 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
            if (!v20)
            {
...
LABEL_25:
            ...
            v21 = (void *)v20;
            long long v22 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
...
- (BOOL)readFrom:(id)a3
{
  return TTSSchemaTTSSpeechEndedReadFrom(self, (uint64_t)a3, v3);
}
