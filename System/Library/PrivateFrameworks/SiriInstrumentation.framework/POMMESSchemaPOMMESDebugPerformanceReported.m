...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSArray)performanceMeasurements;
- (NSData)jsonData;
...
- (id)performanceMeasurementsAtIndex:(unint64_t)a3;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (unint64_t)performanceMeasurementsCount;
- (void)addPerformanceMeasurements:(id)a3;
- (void)clearPerformanceMeasurements;
- (void)setPerformanceMeasurements:(id)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v9.receiver = self;
  v9.super_class = (Class)POMMESSchemaPOMMESDebugPerformanceReported;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(POMMESSchemaPOMMESDebugPerformanceReported *)self performanceMeasurements];
...
- (NSArray)performanceMeasurements
{
  return self->_performanceMeasurements;
}
...
- (POMMESSchemaPOMMESDebugPerformanceReported)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)POMMESSchemaPOMMESDebugPerformanceReported;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[POMMESSchemaPOMMESFunctionPerformanceProfile initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
...
- (unint64_t)hash
{
  return [(NSArray *)self->_performanceMeasurements hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    uint64_t v6 = [v4 performanceMeasurements];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(POMMESSchemaPOMMESDebugPerformanceReported *)self performanceMeasurements];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(POMMESSchemaPOMMESDebugPerformanceReported *)self performanceMeasurements];
      uint64_t v11 = [v4 performanceMeasurements];
...
- (BOOL)readFrom:(id)a3
{
  return POMMESSchemaPOMMESDebugPerformanceReportedReadFrom(self, (uint64_t)a3);
}

- (id)performanceMeasurementsAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_performanceMeasurements objectAtIndexedSubscript:a3];
}

- (unint64_t)performanceMeasurementsCount
{
  return [(NSArray *)self->_performanceMeasurements count];
}
...
- (void)addPerformanceMeasurements:(id)a3
{
  ...
  if (!performanceMeasurements)
  {
    ...
    uint64_t v7 = self->_performanceMeasurements;
