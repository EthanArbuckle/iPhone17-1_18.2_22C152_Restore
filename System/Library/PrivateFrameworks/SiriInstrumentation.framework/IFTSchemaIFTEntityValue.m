...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTDisplayRepresentation)displayRepresentation;
- (IFTSchemaIFTEntityValue)initWithDictionary:(id)a3;
- (IFTSchemaIFTEntityValue)initWithJSON:(id)a3;
...
- (void)setHasDisplayRepresentation:(BOOL)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)IFTSchemaIFTEntityValue;
  v5 = [(SISchemaInstrumentationMessage *)&v13 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTEntityValue *)self typeIdentifier];
  ...
  v9 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];
...
- (void)setHasDisplayRepresentation:(BOOL)a3
{
  self->_hasDisplayRepresentation = a3;
}
...
- (IFTSchemaIFTEntityValue)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)IFTSchemaIFTEntityValue;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"displayRepresentation"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTEntityValue *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];
  ...
  {
    uint64_t v7 = [(IFTSchemaIFTEntityValue *)self typeIdentifier];
...
- (unint64_t)hash
{
  ...
  return [(IFTSchemaIFTDisplayRepresentation *)self->_displayRepresentation hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(IFTSchemaIFTEntityValue *)self typeIdentifier];
  ...
  {
    int v8 = (void *)v7;
    v9 = [(IFTSchemaIFTEntityValue *)self typeIdentifier];
  ...
  v5 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];
  v6 = [v4 displayRepresentation];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];
    if (!v12)
    {
...
LABEL_15:
    ...
    v14 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];
...
{
  id v8 = a3;
  id v4 = [(IFTSchemaIFTEntityValue *)self typeIdentifier];
  ...
  v6 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];

  if (v6)
  {
    uint64_t v7 = [(IFTSchemaIFTEntityValue *)self displayRepresentation];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTEntityValueReadFrom(self, (uint64_t)a3);
}
...
- (BOOL)hasDisplayRepresentation
{
  return self->_displayRepresentation != 0;
}
