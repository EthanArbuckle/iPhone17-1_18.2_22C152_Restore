...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self availableAssetDailyStatus];
  ...
  {
    uint64_t v7 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self deviceMetadata];
...
- (unint64_t)hash
{
  unint64_t v3 = [(UAFSchemaUAFDeviceMetadata *)self->_deviceMetadata hash];
  return [(SADSchemaSADAvailableAssetDailyStatus *)self->_availableAssetDailyStatus hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t whichEvent = self->_whichEvent;
  if (whichEvent != [v4 whichEvent]) {
    goto LABEL_13;
  }
  v6 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self deviceMetadata];
  uint64_t v7 = [v4 deviceMetadata];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_12;
  }
  uint64_t v8 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self deviceMetadata];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self deviceMetadata];
    int v11 = [v4 deviceMetadata];
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self availableAssetDailyStatus];
    if (!v13)
    {
...
{
  id v8 = a3;
  id v4 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self deviceMetadata];
  ...
  if (v6)
  {
    uint64_t v7 = [(UAFSchemaUAFAssetDailyStatusWithDeviceProperties *)self availableAssetDailyStatus];
    PBDataWriterWriteSubmessage();
  }
}
