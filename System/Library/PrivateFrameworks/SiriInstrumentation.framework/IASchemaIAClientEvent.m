...
- (IASchemaIAClientEventMetadata)eventMetadata;
...
- (void)setHasSiriMissEvaluationContext:(BOOL)a3;
- (void)setSiriMissEvaluationContext:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)IASchemaIAClientEvent;
  v5 = [(SISchemaInstrumentationMessage *)&v13 applySensitiveConditionsPolicy:v4];
  uint64_t v6 = [(IASchemaIAClientEvent *)self eventMetadata];
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_siriMissEvaluationContext, 0);
  objc_storeStrong((id *)&self->_eventMetadata, 0);
}

- (void)setHasSiriMissEvaluationContext:(BOOL)a3
{
  self->_hasSiriMissEvaluationContext = a3;
}

- (BOOL)hasSiriMissEvaluationContext
{
  return self->_hasSiriMissEvaluationContext;
}
...
- (IASchemaIAClientEvent)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)IASchemaIAClientEvent;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"siriMissEvaluationContext"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IASchemaIAClientEvent *)self eventMetadata];
  ...
  {
    uint64_t v7 = [(IASchemaIAClientEvent *)self siriMissEvaluationContext];
...
- (unint64_t)hash
{
  unint64_t v3 = [(IASchemaIAClientEventMetadata *)self->_eventMetadata hash];
  return [(IASchemaIASiriMissEvaluationContext *)self->_siriMissEvaluationContext hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(IASchemaIAClientEvent *)self eventMetadata];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  uint64_t v6 = [(IASchemaIAClientEvent *)self siriMissEvaluationContext];
  uint64_t v7 = [v4 siriMissEvaluationContext];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(IASchemaIAClientEvent *)self siriMissEvaluationContext];
    if (!v13)
    {
...
- (BOOL)readFrom:(id)a3
{
  return IASchemaIAClientEventReadFrom(self, (uint64_t)a3);
}
...
{
  if (self->_whichEvent_Type == 2) {
    v2 = self->_siriMissEvaluationContext;
  }
  else {
    v2 = 0;
  }
...
- (void)setSiriMissEvaluationContext:(id)a3
{
  ...
  objc_storeStrong((id *)&self->_siriMissEvaluationContext, a3);
}
