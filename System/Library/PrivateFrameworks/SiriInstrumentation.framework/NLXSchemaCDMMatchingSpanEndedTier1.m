...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NLXSchemaCDMMatchingSpanEndedTier1;
...
- (NLXSchemaCDMMatchingSpanEndedTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)NLXSchemaCDMMatchingSpanEndedTier1;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    id v4 = [(NLXSchemaCDMMatchingSpanEndedTier1 *)self linkId];
...
- (unint64_t)hash
{
  ...
  return [(NSArray *)self->_matchingSpans hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(NLXSchemaCDMMatchingSpanEndedTier1 *)self linkId];
  if (v7)
  {
    int v8 = (void *)v7;
    uint64_t v9 = [(NLXSchemaCDMMatchingSpanEndedTier1 *)self linkId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(NLXSchemaCDMMatchingSpanEndedTier1 *)self matchingSpans];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(NLXSchemaCDMMatchingSpanEndedTier1 *)self matchingSpans];
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMMatchingSpanEndedTier1ReadFrom(self, (uint64_t)a3);
}
