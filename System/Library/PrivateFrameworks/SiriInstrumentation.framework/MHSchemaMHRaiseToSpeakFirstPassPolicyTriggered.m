@interface MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered
...
- (MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered)initWithDictionary:(id)a3
{
  ...
  v5 = [(MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered *)&v10 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"isReplayModeEnabled"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered setIsReplayModeEnabled:](v5, "setIsReplayModeEnabled:", [v6 BOOLValue]);
    }
...
- (MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered)initWithJSON:(id)a3
{
  ...
  {
    self = [(MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = NSNumber;
    [(MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered *)self firstPassTriggerScore];
  ...
  if (has)
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[MHSchemaMHRaiseToSpeakFirstPassPolicyTriggered isReplayModeEnabled](self, "isReplayModeEnabled"));
