...
- (CNVSchemaCNVIntentReformationFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CNVSchemaCNVIntentReformationFailed;
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(CNVSchemaCNVIntentReformationFailed *)self reason];
...
- (BOOL)readFrom:(id)a3
{
  return CNVSchemaCNVIntentReformationFailedReadFrom(self, (uint64_t)a3);
}
