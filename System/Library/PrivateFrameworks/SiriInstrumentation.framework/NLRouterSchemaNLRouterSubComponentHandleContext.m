...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  ...
  v9 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
  ...
  v12 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  ...
  v15 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  ...
  v18 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
...
- (NLRouterSchemaNLRouterSubComponentHandleContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[NLRouterSchemaNLRouterSubComponentHandleEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  ...
  {
    v13 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
  ...
  if (self->_traceId)
  {
    v16 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(NLRouterSchemaNLRouterSubComponentHandleStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(NLRouterSchemaNLRouterSubComponentHandleEnded *)self->_ended hash];
  unint64_t v6 = v4 ^ v5 ^ [(NLRouterSchemaNLRouterSubComponentHandleFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  uint64_t v7 = [v4 contextId];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v8 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  ...
  unint64_t v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v13 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
  ...
  unint64_t v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v18 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  if (v18)
  {
    v19 = (void *)v18;
    int v20 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
    v21 = [v4 ended];
  ...
  unint64_t v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v23 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  if (v23)
  {
    v24 = (void *)v23;
    v25 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
    v26 = [v4 failed];
  ...
  unint64_t v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
  uint64_t v7 = [v4 traceId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v28 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
    if (!v28)
    {
...
LABEL_31:
    ...
    v29 = (void *)v28;
    v30 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
    v31 = [v4 traceId];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];

  if (v8)
  {
    v9 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  ...
  if (v10)
  {
    int v11 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  int v12 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];

  if (v12)
  {
    uint64_t v13 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (NLRouterSchemaNLRouterSubComponentHandleFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (NLRouterSchemaNLRouterSubComponentHandleEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (NLRouterSchemaNLRouterSubComponentHandleStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
