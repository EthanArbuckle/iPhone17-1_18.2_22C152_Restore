...
{
  v9.receiver = self;
  v9.super_class = (Class)HomeKitSchemaHomeKitEventMetadata;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(HomeKitSchemaHomeKitEventMetadata *)self hkId];
...
- (HomeKitSchemaHomeKitEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)HomeKitSchemaHomeKitEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_hkId)
  {
    id v4 = [(HomeKitSchemaHomeKitEventMetadata *)self hkId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_hkId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(HomeKitSchemaHomeKitEventMetadata *)self hkId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(HomeKitSchemaHomeKitEventMetadata *)self hkId];
      v11 = [v4 hkId];
...
- (BOOL)readFrom:(id)a3
{
  return HomeKitSchemaHomeKitEventMetadataReadFrom(self, (uint64_t)a3);
}
