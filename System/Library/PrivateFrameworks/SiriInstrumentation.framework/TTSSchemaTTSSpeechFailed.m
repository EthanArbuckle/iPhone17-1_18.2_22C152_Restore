...
- (NSArray)errorCodes;
- (NSData)jsonData;
- (TTSSchemaTTSSpeechFailed)initWithDictionary:(id)a3;
- (TTSSchemaTTSSpeechFailed)initWithJSON:(id)a3;
...
- (TTSSchemaTTSSpeechFailed)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)TTSSchemaTTSSpeechFailed;
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
              -[TTSSchemaTTSSpeechFailed addErrorCodes:](v5, "addErrorCodes:", objc_msgSend(v12, "intValue", (void)v15));
            }
            ++v11;
          }
          while (v9 != v11);
...
- (NSData)jsonData
{
  v2 = [(TTSSchemaTTSSpeechFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(TTSSchemaTTSSpeechFailed *)self errorCodes];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(TTSSchemaTTSSpeechFailed *)self errorCodes];
    v6 = [v4 errorCodes];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(TTSSchemaTTSSpeechFailed *)self errorCodes];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(TTSSchemaTTSSpeechFailed *)self errorCodes];
...
- (BOOL)readFrom:(id)a3
{
  return TTSSchemaTTSSpeechFailedReadFrom(self, (uint64_t)a3);
}
