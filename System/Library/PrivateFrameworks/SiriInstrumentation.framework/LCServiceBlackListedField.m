...
- (LCServiceBlackListedField)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"fullyQualifiedPath"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(LCServiceBlackListedField *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(LCServiceBlackListedField *)self fullyQualifiedPath];
    v5 = (void *)[v4 copy];
    [v3 setObject:v5 forKeyedSubscript:@"fullyQualifiedPath"];
  }
...
- (unint64_t)hash
{
  return [(NSString *)self->_fullyQualifiedPath hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(LCServiceBlackListedField *)self fullyQualifiedPath];
    v6 = [v4 fullyQualifiedPath];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(LCServiceBlackListedField *)self fullyQualifiedPath];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(LCServiceBlackListedField *)self fullyQualifiedPath];
      v11 = [v4 fullyQualifiedPath];
