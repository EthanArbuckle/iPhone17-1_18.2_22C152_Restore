...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTSystemRequirementAuthenticationRequest)initWithDictionary:(id)a3;
- (IFTSchemaIFTSystemRequirementAuthenticationRequest)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (void)setAuthenticationLevel:(int)a3;
- (void)setHasAuthenticationLevel:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
- (IFTSchemaIFTSystemRequirementAuthenticationRequest)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTSystemRequirementAuthenticationRequest;
  v5 = [(IFTSchemaIFTSystemRequirementAuthenticationRequest *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"authenticationLevel"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTSystemRequirementAuthenticationRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(IFTSchemaIFTSystemRequirementAuthenticationRequest *)self authenticationLevel];
    ...
    [v3 setObject:v6 forKeyedSubscript:@"authenticationLevel"];
  }
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int authenticationLevel = self->_authenticationLevel,
            authenticationLevel == [v4 authenticationLevel]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTSystemRequirementAuthenticationRequestReadFrom(self, (uint64_t)a3);
}
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_int authenticationLevel = a3;
}
