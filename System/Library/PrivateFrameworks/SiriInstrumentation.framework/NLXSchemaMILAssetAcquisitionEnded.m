...
- (NLXSchemaMILAssetAcquisitionEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)NLXSchemaMILAssetAcquisitionEnded;
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(NLXSchemaMILAssetAcquisitionEnded *)self acquisitionType];
    ...
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int acquisitionType = self->_acquisitionType,
            acquisitionType == [v4 acquisitionType]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaMILAssetAcquisitionEndedReadFrom(self, (uint64_t)a3);
}
