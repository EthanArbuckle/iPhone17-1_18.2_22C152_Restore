...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
  ...
  v9 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
  ...
  v12 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
  ...
  v15 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
...
- (FLOWLINKSchemaFLOWLINKActionContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[FLOWLINKSchemaFLOWLinkActionFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(FLOWLINKSchemaFLOWLINKActionContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    id v4 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
  ...
  {
    v13 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(FLOWLINKSchemaFLOWLinkActionStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(FLOWLINKSchemaFLOWLinkActionEnded *)self->_ended hash] ^ v3;
  unint64_t v5 = [(FLOWLINKSchemaFLOWLinkActionFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
  ...
  v6 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
  ...
  v6 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
    v21 = [v4 failed];
  ...
  v6 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
  uint64_t v7 = [v4 cancelled];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
    v26 = [v4 cancelled];
...
{
  id v12 = a3;
  id v4 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
  ...
  uint64_t v8 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];

  if (v8)
  {
    v9 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];

  if (v10)
  {
    int v11 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setCancelled:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLinkActionCancelled *)a3;
...
- (void)setFailed:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLinkActionFailed *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setEnded:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLinkActionEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (FLOWLINKSchemaFLOWLinkActionStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
