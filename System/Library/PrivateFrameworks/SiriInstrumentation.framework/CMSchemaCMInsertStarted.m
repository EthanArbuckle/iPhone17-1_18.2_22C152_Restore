...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (CMSchemaCMInsertStarted)initWithDictionary:(id)a3;
- (CMSchemaCMInsertStarted)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (CMSchemaCMInsertStarted)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CMSchemaCMInsertStarted;
...
- (NSData)jsonData
{
  v2 = [(CMSchemaCMInsertStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[CMSchemaCMInsertStarted exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return CMSchemaCMInsertStartedReadFrom(self, (uint64_t)a3);
}
