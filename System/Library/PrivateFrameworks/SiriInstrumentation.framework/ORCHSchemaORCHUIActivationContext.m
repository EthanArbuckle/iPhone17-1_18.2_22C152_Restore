...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  ...
  v9 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  ...
  v12 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHUIActivationContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  ...
  {
    uint64_t v7 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  ...
  if (self->_trpId)
  {
    v10 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ORCHSchemaORCHUIActivationStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(ORCHSchemaORCHUIActivationEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  ...
  v6 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  ...
  v6 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
  uint64_t v7 = [v4 trpId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
    v21 = [v4 trpId];
...
{
  id v10 = a3;
  id v4 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(ORCHSchemaORCHUIActivationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(ORCHSchemaORCHUIActivationContext *)self trpId];

  if (v8)
  {
    v9 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setEnded:(id)a3
{
  id v4 = (ORCHSchemaORCHUIActivationEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (ORCHSchemaORCHUIActivationStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
