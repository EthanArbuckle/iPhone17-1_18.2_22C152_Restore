...
- (unint64_t)hash;
- (void)deletePlusId;
- (void)setHasPlusId:(BOOL)a3;
- (void)setPlusId:(id)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v9.receiver = self;
  v9.super_class = (Class)PLUSSchemaPLUSClientEventMetadata;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(PLUSSchemaPLUSClientEventMetadata *)self plusId];
...
- (PLUSSchemaPLUSClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PLUSSchemaPLUSClientEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_plusId)
  {
    id v4 = [(PLUSSchemaPLUSClientEventMetadata *)self plusId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_plusId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PLUSSchemaPLUSClientEventMetadata *)self plusId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(PLUSSchemaPLUSClientEventMetadata *)self plusId];
      v11 = [v4 plusId];
...
- (BOOL)readFrom:(id)a3
{
  return PLUSSchemaPLUSClientEventMetadataReadFrom(self, (uint64_t)a3);
}
