...
- (POMMESSchemaPOMMESResourceDownloadEnded)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass()) {
      -[POMMESSchemaPOMMESResourceDownloadEnded setResourceDownloadSizeInBytes:](v5, "setResourceDownloadSizeInBytes:", [v6 unsignedIntValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[POMMESSchemaPOMMESResourceDownloadEnded resourceDownloadSizeInBytes](self, "resourceDownloadSizeInBytes"));
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (unsigned int resourceDownloadSizeInBytes = self->_resourceDownloadSizeInBytes,
            resourceDownloadSizeInBytes == [v4 resourceDownloadSizeInBytes]))
      {
        BOOL v6 = 1;
      }
    }
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_unsigned int resourceDownloadSizeInBytes = a3;
}
