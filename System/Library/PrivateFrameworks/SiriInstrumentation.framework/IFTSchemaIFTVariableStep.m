...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTVariableStep;
  id v4 = a3;
...
- (IFTSchemaIFTVariableStep)initWithDictionary:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)IFTSchemaIFTVariableStep;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaIFTVariableStep exists](self, "exists"));
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[24] & 1))
    {
        ...
        || (int exists = self->_exists, exists == [v4 exists]))
      {
        ...
        if ((v6 == 0) != (v7 != 0))
        {
          uint64_t v9 = [(IFTSchemaIFTVariableStep *)self statementId];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = (void *)v9;
          objc_super v11 = [(IFTSchemaIFTVariableStep *)self statementId];
          v12 = [v4 statementId];
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = [(IFTSchemaIFTVariableStep *)self statementId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTVariableStepReadFrom(self, (uint64_t)a3);
}
