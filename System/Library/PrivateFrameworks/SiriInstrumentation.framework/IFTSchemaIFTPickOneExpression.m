...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTPickOneExpression;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTPickOneExpression *)self statementId];
...
- (IFTSchemaIFTPickOneExpression)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFTSchemaIFTPickOneExpression;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFTSchemaIFTPickOneExpression *)self statementId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTPickOneExpression *)self statementId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(IFTSchemaIFTPickOneExpression *)self statementId];
      v11 = [v4 statementId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTPickOneExpressionReadFrom(self, (uint64_t)a3);
}
