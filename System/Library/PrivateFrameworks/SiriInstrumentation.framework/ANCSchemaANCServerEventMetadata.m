...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ANCSchemaANCServerEventMetadata *)self ancId];
...
- (NSData)jsonData
{
  v2 = [(ANCSchemaANCServerEventMetadata *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ancId)
  {
    id v4 = [(ANCSchemaANCServerEventMetadata *)self ancId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_ancId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(ANCSchemaANCServerEventMetadata *)self ancId];
    v6 = [v4 ancId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ANCSchemaANCServerEventMetadata *)self ancId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(ANCSchemaANCServerEventMetadata *)self ancId];
      v11 = [v4 ancId];
