...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(NLXSchemaCDMSystemOffered *)self offeredAct];
...
- (NLXSchemaCDMSystemOffered)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"offeredAct"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaCDMSystemOffered *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_offeredAct)
  {
    id v4 = [(NLXSchemaCDMSystemOffered *)self offeredAct];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"offeredAct"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"offeredAct"];
    }
  }
...
- (unint64_t)hash
{
  return [(NLXSchemaCDMUserDialogAct *)self->_offeredAct hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(NLXSchemaCDMSystemOffered *)self offeredAct];
    v6 = [v4 offeredAct];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(NLXSchemaCDMSystemOffered *)self offeredAct];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(NLXSchemaCDMSystemOffered *)self offeredAct];
      v11 = [v4 offeredAct];
