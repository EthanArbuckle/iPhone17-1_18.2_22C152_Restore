...
- (ODDSiriSchemaODDAssetSetStatusDimensions)dimensions;
...
{
  v9.receiver = self;
  v9.super_class = (Class)ODDSiriSchemaODDAssetSetStatusDigest;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(ODDSiriSchemaODDAssetSetStatusDigest *)self dimensions];
...
- (ODDSiriSchemaODDAssetSetStatusDigest)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ODDSiriSchemaODDAssetSetStatusDigest;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_dimensions)
  {
    id v4 = [(ODDSiriSchemaODDAssetSetStatusDigest *)self dimensions];
...
- (unint64_t)hash
{
  return [(ODDSiriSchemaODDAssetSetStatusDimensions *)self->_dimensions hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ODDSiriSchemaODDAssetSetStatusDigest *)self dimensions];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(ODDSiriSchemaODDAssetSetStatusDigest *)self dimensions];
      v11 = [v4 dimensions];
...
- (BOOL)readFrom:(id)a3
{
  return ODDSiriSchemaODDAssetSetStatusDigestReadFrom(self, (uint64_t)a3);
}
