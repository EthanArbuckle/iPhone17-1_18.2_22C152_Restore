...
- (STSchemaSTSpotlightRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)STSchemaSTSpotlightRequestFailed;
  v5 = [(STSchemaSTSpotlightRequestFailed *)&v9 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(STSchemaSTSpotlightRequestFailed *)self reason];
...
- (BOOL)readFrom:(id)a3
{
  return STSchemaSTSpotlightRequestFailedReadFrom(self, (uint64_t)a3);
}
