...
- (SUGSchemaSUGAutoCompleteSuggestionMetaData)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"autoCompleteSuggestionSource"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(SUGSchemaSUGAutoCompleteSuggestionMetaData *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(SUGSchemaSUGAutoCompleteSuggestionMetaData *)self autoCompleteSuggestionSource]- 1;
    if (v4 > 5) {
    ...
    [v3 setObject:v5 forKeyedSubscript:@"autoCompleteSuggestionSource"];
  }
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int autoCompleteSuggestionSource = self->_autoCompleteSuggestionSource,
            autoCompleteSuggestionSource == [v4 autoCompleteSuggestionSource]))
      {
        BOOL v6 = 1;
      }
    }
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_int autoCompleteSuggestionSource = a3;
}
