...
{
  v9.receiver = self;
  v9.super_class = (Class)FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted *)self parameter];
...
- (FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_parameter)
  {
    id v4 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted *)self parameter];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted *)self parameter];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(FLOWLINKSchemaFLOWLINKActionParameterConfirmationStarted *)self parameter];
      v11 = [v4 parameter];
...
- (BOOL)readFrom:(id)a3
{
  return FLOWLINKSchemaFLOWLINKActionParameterConfirmationStartedReadFrom(self, (uint64_t)a3);
}
