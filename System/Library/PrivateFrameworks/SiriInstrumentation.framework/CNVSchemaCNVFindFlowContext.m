...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  ...
  v9 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
  ...
  v12 = [(CNVSchemaCNVFindFlowContext *)self ended];
  ...
  v15 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
...
- (CNVSchemaCNVFindFlowContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[CNVSchemaCNVFindFlowEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(CNVSchemaCNVFindFlowContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(CNVSchemaCNVFindFlowContext *)self ended];
  ...
  {
    v10 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
  ...
  {
    v13 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(CNVSchemaCNVFindFlowStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(CNVSchemaCNVFindFlowEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  ...
  v6 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
  ...
  v6 = [(CNVSchemaCNVFindFlowContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(CNVSchemaCNVFindFlowContext *)self ended];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(CNVSchemaCNVFindFlowContext *)self ended];
    v21 = [v4 ended];
  ...
  v6 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
  uint64_t v7 = [v4 hypothesisId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
    v26 = [v4 hypothesisId];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    unint64_t v5 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  ...
  if (v6)
  {
    uint64_t v7 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(CNVSchemaCNVFindFlowContext *)self ended];

  if (v8)
  {
    v9 = [(CNVSchemaCNVFindFlowContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
  ...
  if (v10)
  {
    int v11 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setEnded:(id)a3
{
  id v4 = (CNVSchemaCNVFindFlowEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (CNVSchemaCNVFindFlowStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
