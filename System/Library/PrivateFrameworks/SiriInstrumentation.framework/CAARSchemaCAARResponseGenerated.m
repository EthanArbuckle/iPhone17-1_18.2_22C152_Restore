...
{
  v9.receiver = self;
  v9.super_class = (Class)CAARSchemaCAARResponseGenerated;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(CAARSchemaCAARResponseGenerated *)self actionCandidateIds];
...
- (CAARSchemaCAARResponseGenerated)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)CAARSchemaCAARResponseGenerated;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              [(CAARSchemaCAARResponseGenerated *)v5 addActionCandidateIds:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (unint64_t)hash
{
  return [(NSArray *)self->_actionCandidateIds hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(CAARSchemaCAARResponseGenerated *)self actionCandidateIds];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(CAARSchemaCAARResponseGenerated *)self actionCandidateIds];
      uint64_t v11 = [v4 actionCandidateIds];
...
- (BOOL)readFrom:(id)a3
{
  return CAARSchemaCAARResponseGeneratedReadFrom(self, (uint64_t)a3);
}
