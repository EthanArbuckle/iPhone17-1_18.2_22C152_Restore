...
- (void)setHasStartReason:(BOOL)a3;
- (void)setStartReason:(int)a3;
- (void)writeTo:(id)a3;
@end
...
- (MHSchemaMHAttendingStarted)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)MHSchemaMHAttendingStarted;
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(MHSchemaMHAttendingStarted *)self startReason];
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int startReason = self->_startReason, startReason == [v4 startReason]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHAttendingStartedReadFrom(self, (uint64_t)a3);
}
