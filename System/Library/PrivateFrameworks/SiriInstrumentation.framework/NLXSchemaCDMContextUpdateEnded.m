...
- (NSArray)reformedTurnInputBundles;
- (NSData)jsonData;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NLXSchemaCDMContextUpdateEnded;
...
- (NLXSchemaCDMContextUpdateEnded)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)NLXSchemaCDMContextUpdateEnded;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"reformedTurnInputBundles"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(NLXSchemaCDMContextUpdateEnded *)self contextId];
  ...
  if ([(NSArray *)self->_reformedTurnInputBundles count])
  {
    ...
    long long v18 = 0u;
    long long v19 = 0u;
    int v8 = self->_reformedTurnInputBundles;
...
- (unint64_t)hash
{
  ...
  return [(NSArray *)self->_reformedTurnInputBundles hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(NLXSchemaCDMContextUpdateEnded *)self contextId];
  if (v7)
  {
    int v8 = (void *)v7;
    uint64_t v9 = [(NLXSchemaCDMContextUpdateEnded *)self contextId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(NLXSchemaCDMContextUpdateEnded *)self reformedTurnInputBundles];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(NLXSchemaCDMContextUpdateEnded *)self reformedTurnInputBundles];
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMContextUpdateEndedReadFrom(self, (uint64_t)a3);
}

- (id)reformedTurnInputBundlesAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_reformedTurnInputBundles objectAtIndexedSubscript:a3];
}

- (unint64_t)reformedTurnInputBundlesCount
{
  return [(NSArray *)self->_reformedTurnInputBundles count];
}
