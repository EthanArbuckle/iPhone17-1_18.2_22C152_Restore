...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (PRSiriSchemaPRResponseGenerationRequestFailed)initWithDictionary:(id)a3;
- (PRSiriSchemaPRResponseGenerationRequestFailed)initWithJSON:(id)a3;
...
- (PRSiriSchemaPRResponseGenerationRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)PRSiriSchemaPRResponseGenerationRequestFailed;
...
- (NSData)jsonData
{
  v2 = [(PRSiriSchemaPRResponseGenerationRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[PRSiriSchemaPRResponseGenerationRequestFailed exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return PRSiriSchemaPRResponseGenerationRequestFailedReadFrom(self, (uint64_t)a3);
}
