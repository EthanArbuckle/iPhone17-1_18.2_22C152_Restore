...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
  ...
  v9 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
...
- (NSData)jsonData
{
  v2 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_counts)
  {
    id v4 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
  ...
  if (self->_dimensions)
  {
    uint64_t v7 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
...
- (unint64_t)hash
{
  unint64_t v3 = [(ODDSiriSchemaODDAssistantCarPlayDimensions *)self->_dimensions hash];
  return [(ODDSiriSchemaODDAssistantCarPlayCounts *)self->_counts hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
  v6 = [v4 dimensions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  ...
  {
    int v8 = (void *)v7;
    v9 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
    v10 = [v4 dimensions];
  ...
  v5 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
  v6 = [v4 counts];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
    if (!v12)
    {
...
LABEL_15:
    ...
    v14 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
    v15 = [v4 counts];
...
{
  id v8 = a3;
  id v4 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
  ...
  v6 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];

  if (v6)
  {
    uint64_t v7 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
    PBDataWriterWriteSubmessage();
  }
}
