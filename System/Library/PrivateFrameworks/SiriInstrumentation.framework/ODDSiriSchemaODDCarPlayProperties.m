...
- (id)dictionaryRepresentation
{
  ...
  char v4 = *(&self->_isSiriCapableDigitalCarKeyAvailable + 1);
  if (v4)
  {
    v5 = objc_msgSend(NSNumber, "numberWithBool:", -[ODDSiriSchemaODDCarPlayProperties isShowAppsBehindSiriEnabledOnCarPlay](self, "isShowAppsBehindSiriEnabledOnCarPlay"));
  ...
  if ((v4 & 2) != 0)
  {
    v6 = objc_msgSend(NSNumber, "numberWithBool:", -[ODDSiriSchemaODDCarPlayProperties isSiriCapableDigitalCarKeyAvailable](self, "isSiriCapableDigitalCarKeyAvailable"));
...
- (unint64_t)hash
{
  ...
  {
    uint64_t v2 = 2654435761 * self->_isShowAppsBehindSiriEnabledOnCarPlay;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_isSiriCapableDigitalCarKeyAvailable;
  return v3 ^ v2;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  unsigned int v5 = *((unsigned __int8 *)&self->_isSiriCapableDigitalCarKeyAvailable + 1);
...
{
  id v4 = a3;
  char v5 = *(&self->_isSiriCapableDigitalCarKeyAvailable + 1);
  id v6 = v4;
  if (v5)
  {
