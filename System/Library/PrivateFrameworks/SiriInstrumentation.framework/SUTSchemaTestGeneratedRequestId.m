...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(SUTSchemaTestGeneratedRequestId *)self requestId];
...
- (NSData)jsonData
{
  v2 = [(SUTSchemaTestGeneratedRequestId *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_requestId)
  {
    id v4 = [(SUTSchemaTestGeneratedRequestId *)self requestId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(SUTSchemaTestGeneratedRequestId *)self requestId];
    v6 = [v4 requestId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SUTSchemaTestGeneratedRequestId *)self requestId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(SUTSchemaTestGeneratedRequestId *)self requestId];
      v11 = [v4 requestId];
