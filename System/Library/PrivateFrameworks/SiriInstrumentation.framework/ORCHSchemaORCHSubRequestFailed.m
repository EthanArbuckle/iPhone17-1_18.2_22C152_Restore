@interface ORCHSchemaORCHSubRequestFailed
- (BOOL)exists;
- (BOOL)hasErrorCode;
- (BOOL)hasErrorDomain;
- (BOOL)hasExists;
...
- (ORCHSchemaORCHSubRequestFailed)initWithDictionary:(id)a3
{
  ...
  v5 = [(ORCHSchemaORCHSubRequestFailed *)&v11 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"exists"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[ORCHSchemaORCHSubRequestFailed setExists:](v5, "setExists:", [v6 BOOLValue]);
    }
    v7 = [v4 objectForKeyedSubscript:@"errorDomain"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[ORCHSchemaORCHSubRequestFailed setErrorDomain:](v5, "setErrorDomain:", [v7 intValue]);
    }
    v8 = [v4 objectForKeyedSubscript:@"errorCode"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[ORCHSchemaORCHSubRequestFailed setErrorCode:](v5, "setErrorCode:", [v8 intValue]);
    }
    v9 = v5;
  }
  return v5;
...
- (ORCHSchemaORCHSubRequestFailed)initWithJSON:(id)a3
{
  ...
  {
    self = [(ORCHSchemaORCHSubRequestFailed *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHSubRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithInt:", -[ORCHSchemaORCHSubRequestFailed errorCode](self, "errorCode"));
...
LABEL_3:
  ...
  unsigned int v8 = [(ORCHSchemaORCHSubRequestFailed *)self errorDomain] - 1;
  if (v8 > 0xE) {
...
LABEL_4:
  v5 = objc_msgSend(NSNumber, "numberWithBool:", -[ORCHSchemaORCHSubRequestFailed exists](self, "exists"));
