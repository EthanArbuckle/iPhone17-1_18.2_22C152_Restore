...
- (id)dictionaryRepresentation
{
  ...
  char v4 = *(&self->_usingConfiguredProxy + 1);
  if (v4)
  {
    v5 = objc_msgSend(NSNumber, "numberWithBool:", -[NETSchemaNETProxyConfiguration isProxyConfigured](self, "isProxyConfigured"));
  ...
  if ((v4 & 2) != 0)
  {
    v6 = objc_msgSend(NSNumber, "numberWithBool:", -[NETSchemaNETProxyConfiguration usingConfiguredProxy](self, "usingConfiguredProxy"));
...
- (unint64_t)hash
{
  ...
  {
    uint64_t v2 = 2654435761 * self->_isProxyConfigured;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_usingConfiguredProxy;
  return v3 ^ v2;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  unsigned int v5 = *((unsigned __int8 *)&self->_usingConfiguredProxy + 1);
  ...
  if (v5)
  {
    int isProxyConfigured = self->_isProxyConfigured;
...
LABEL_10:
  ...
  if (v8)
  {
    int usingConfiguredProxy = self->_usingConfiguredProxy;
...
{
  id v4 = a3;
  char v5 = *(&self->_usingConfiguredProxy + 1);
  id v6 = v4;
  if (v5)
  {
...
{
  *(&self->_usingConfiguredProxy + 1) |= 2u;
  self->_int usingConfiguredProxy = a3;
}
...
{
  *(&self->_usingConfiguredProxy + 1) |= 1u;
  self->_int isProxyConfigured = a3;
}
