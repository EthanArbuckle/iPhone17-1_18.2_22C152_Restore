...
- (ODDSiriSchemaODDiOSResponseProperties)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ODDSiriSchemaODDiOSResponseProperties;
...
- (id)dictionaryRepresentation
{
  ...
  char v4 = *(&self->_isAlwaysShowSpeechEnabled + 1);
  if (v4)
  {
    v5 = objc_msgSend(NSNumber, "numberWithBool:", -[ODDSiriSchemaODDiOSResponseProperties isAlwaysShowSiriCaptionsEnabled](self, "isAlwaysShowSiriCaptionsEnabled"));
  ...
  if ((v4 & 2) != 0)
  {
    v6 = objc_msgSend(NSNumber, "numberWithBool:", -[ODDSiriSchemaODDiOSResponseProperties isAlwaysShowSpeechEnabled](self, "isAlwaysShowSpeechEnabled"));
...
- (unint64_t)hash
{
  ...
  {
    uint64_t v2 = 2654435761 * self->_isAlwaysShowSiriCaptionsEnabled;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_isAlwaysShowSpeechEnabled;
  return v3 ^ v2;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  unsigned int v5 = *((unsigned __int8 *)&self->_isAlwaysShowSpeechEnabled + 1);
...
{
  id v4 = a3;
  char v5 = *(&self->_isAlwaysShowSpeechEnabled + 1);
  id v6 = v4;
  if (v5)
  {
...
- (BOOL)readFrom:(id)a3
{
  return ODDSiriSchemaODDiOSResponsePropertiesReadFrom(self, (uint64_t)a3);
}

- (void)deleteIsAlwaysShowSpeechEnabled
{
  *(&self->_isAlwaysShowSpeechEnabled + 1) &= ~2u;
}
...
- (BOOL)hasIsAlwaysShowSpeechEnabled
{
  return (*((unsigned __int8 *)&self->_isAlwaysShowSpeechEnabled + 1) >> 1) & 1;
}
...
- (void)deleteIsAlwaysShowSiriCaptionsEnabled
{
  *(&self->_isAlwaysShowSpeechEnabled + 1) &= ~1u;
}

- (void)setHasIsAlwaysShowSiriCaptionsEnabled:(BOOL)a3
{
  *(&self->_isAlwaysShowSpeechEnabled + 1) = *(&self->_isAlwaysShowSpeechEnabled + 1) & 0xFE | a3;
}

- (BOOL)hasIsAlwaysShowSiriCaptionsEnabled
{
  return *(&self->_isAlwaysShowSpeechEnabled + 1);
}
