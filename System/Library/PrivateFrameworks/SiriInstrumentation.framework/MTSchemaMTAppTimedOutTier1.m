...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (MTSchemaMTAppTimedOutTier1)initWithDictionary:(id)a3;
- (MTSchemaMTAppTimedOutTier1)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)MTSchemaMTAppTimedOutTier1;
  ...
  v6 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
...
- (MTSchemaMTAppTimedOutTier1)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)MTSchemaMTAppTimedOutTier1;
...
- (NSData)jsonData
{
  v2 = [(MTSchemaMTAppTimedOutTier1 *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_localePair)
  {
    id v4 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
  ...
  {
    uint64_t v7 = [(MTSchemaMTAppTimedOutTier1 *)self translationPayload];
    int v8 = (void *)[v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(MTSchemaMTAppTimedOutTier1 *)self translationPayload];
  ...
  {
    int v8 = (void *)v7;
    v9 = [(MTSchemaMTAppTimedOutTier1 *)self translationPayload];
  ...
  v5 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
  v6 = [v4 localePair];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = (void *)v12;
    v14 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
    v15 = [v4 localePair];
...
{
  id v7 = a3;
  id v4 = [(MTSchemaMTAppTimedOutTier1 *)self translationPayload];
...
- (BOOL)readFrom:(id)a3
{
  return MTSchemaMTAppTimedOutTier1ReadFrom(self, (uint64_t)a3);
}
