...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SISchemaConversationTrace *)self previousTurnID];
...
- (unint64_t)hash
{
  return [(NSData *)self->_previousTurnID hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(SISchemaConversationTrace *)self previousTurnID];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(SISchemaConversationTrace *)self previousTurnID];
