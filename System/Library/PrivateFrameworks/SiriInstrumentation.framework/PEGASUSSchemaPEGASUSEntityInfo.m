...
- (BOOL)isEqual:(id)a3
{
  ...
  double v6 = [v4 entityId];
  long double v7 = v6;
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v8 = [(PEGASUSSchemaPEGASUSEntityInfo *)self entityId];
    if (v8)
    {
      v9 = (void *)v8;
      v10 = [(PEGASUSSchemaPEGASUSEntityInfo *)self entityId];
      objc_super v11 = [v4 entityId];
    ...
    if ((*(unsigned char *)&self->_has & 1) == (v4[20] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (float confidence = self->_confidence, [v4 confidence], confidence == v14))
      {
        BOOL v15 = 1;
        goto LABEL_12;
      }
...
{
  id v5 = a3;
  unint64_t v4 = [(PEGASUSSchemaPEGASUSEntityInfo *)self entityId];
