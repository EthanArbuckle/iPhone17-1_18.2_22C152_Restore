...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[RRSchemaRRAnnotation annotationAddedTimestampInSeconds](self, "annotationAddedTimestampInSeconds"));
  ...
  if (has)
  {
    unsigned int v6 = [(RRSchemaRRAnnotation *)self name] - 1;
    if (v6 > 4) {
      uint64_t v7 = @"RRANNOTATIONNAME_UNKNOWN";
    }
    else {
      uint64_t v7 = off_1E5EB4980[v6];
    }
