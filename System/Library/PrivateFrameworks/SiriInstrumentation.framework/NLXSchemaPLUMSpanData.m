...
- (NLXSchemaPLUMSpanData)initWithDictionary:(id)a3
{
  ...
  v5 = [(NLXSchemaPLUMSpanData *)&v9 init];
  if (v5)
  {
...
- (NLXSchemaPLUMSpanData)initWithJSON:(id)a3
{
  ...
  {
    self = [(NLXSchemaPLUMSpanData *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaPLUMSpanData *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = NSNumber;
    [(NLXSchemaPLUMSpanData *)self score];
