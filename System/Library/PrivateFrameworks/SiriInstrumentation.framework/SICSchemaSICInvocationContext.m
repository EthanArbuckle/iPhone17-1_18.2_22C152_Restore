...
- (SICSchemaSICInvocationContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[SICSchemaSICInvocationCancelled alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    id v4 = [(SICSchemaSICInvocationContext *)self cancelled];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(SICSchemaSICInvocationContext *)self ended];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SICSchemaSICInvocationStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(SICSchemaSICInvocationEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(SICSchemaSICInvocationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(SICSchemaSICInvocationContext *)self startedOrChanged];
  ...
  uint64_t v13 = [(SICSchemaSICInvocationContext *)self ended];
  if (v13)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(SICSchemaSICInvocationContext *)self cancelled];
    if (!v18)
    {
...
{
  id v10 = a3;
  id v4 = [(SICSchemaSICInvocationContext *)self startedOrChanged];
  ...
  uint64_t v8 = [(SICSchemaSICInvocationContext *)self cancelled];

  if (v8)
  {
    v9 = [(SICSchemaSICInvocationContext *)self cancelled];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setCancelled:(id)a3
{
  id v4 = (SICSchemaSICInvocationCancelled *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (SICSchemaSICInvocationEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (SICSchemaSICInvocationStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
