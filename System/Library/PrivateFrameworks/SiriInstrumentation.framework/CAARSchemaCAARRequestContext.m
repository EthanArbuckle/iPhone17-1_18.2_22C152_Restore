...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (CAARSchemaCAARRequestContext)initWithDictionary:(id)a3;
- (CAARSchemaCAARRequestContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)CAARSchemaCAARRequestContext;
  v5 = [(SISchemaInstrumentationMessage *)&v16 applySensitiveConditionsPolicy:v4];
  v6 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  ...
  v9 = [(CAARSchemaCAARRequestContext *)self ended];
  ...
  v12 = [(CAARSchemaCAARRequestContext *)self failed];
...
- (CAARSchemaCAARRequestContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)CAARSchemaCAARRequestContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[CAARSchemaCAARRequestFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(CAARSchemaCAARRequestContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(CAARSchemaCAARRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(CAARSchemaCAARRequestContext *)self failed];
  ...
  {
    v10 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(CAARSchemaCAARRequestReceived *)self->_startedOrChanged hash];
  unint64_t v4 = [(CAARSchemaCAARResponseGenerated *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  ...
  v6 = [(CAARSchemaCAARRequestContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(CAARSchemaCAARRequestContext *)self ended];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(CAARSchemaCAARRequestContext *)self ended];
  ...
  v6 = [(CAARSchemaCAARRequestContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(CAARSchemaCAARRequestContext *)self failed];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(CAARSchemaCAARRequestContext *)self failed];
    v21 = [v4 failed];
...
{
  id v10 = a3;
  id v4 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(CAARSchemaCAARRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(CAARSchemaCAARRequestContext *)self failed];

  if (v8)
  {
    v9 = [(CAARSchemaCAARRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return CAARSchemaCAARRequestContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (CAARSchemaCAARRequestFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (CAARSchemaCAARResponseGenerated *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (CAARSchemaCAARRequestReceived *)a3;
  ended = self->_ended;
  self->_ended = 0;
