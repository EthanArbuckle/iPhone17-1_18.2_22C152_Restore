...
- (USPSchemaUSPSessionInfoItem)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)USPSchemaUSPSessionInfoItem;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_name)
  {
    id v4 = [(USPSchemaUSPSessionInfoItem *)self name];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(USPSchemaUSPSessionInfoItem *)self name];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(USPSchemaUSPSessionInfoItem *)self value];
    if (!v12)
    {
...
- (BOOL)readFrom:(id)a3
{
  return USPSchemaUSPSessionInfoItemReadFrom(self, (uint64_t)a3);
}
