...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[PFAEventStatistics messageCount](self, "messageCount"));
  ...
  if (has)
  {
    v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[PFAEventStatistics ordinal](self, "ordinal"));
...
- (unint64_t)hash
{
  ...
  {
    uint64_t v2 = 2654435761 * self->_ordinal;
...
- (BOOL)isEqual:(id)a3
{
  ...
  $900E4E564F88DD8AFDB962DA2A126053 has = self->_has;
  ...
  {
    unsigned int ordinal = self->_ordinal;
