...
- (id)dictionaryRepresentation
{
  ...
  if (self->_features)
  {
    id v4 = [(CAMSchemaCAMRequestReceived *)self features];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_features hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(CAMSchemaCAMRequestReceived *)self features];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(CAMSchemaCAMRequestReceived *)self features];
      uint64_t v11 = [v4 features];
