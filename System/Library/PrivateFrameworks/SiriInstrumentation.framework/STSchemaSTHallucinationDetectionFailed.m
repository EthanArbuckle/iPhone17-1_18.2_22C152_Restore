...
- (STSchemaSTHallucinationDetectionFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)STSchemaSTHallucinationDetectionFailed;
  v5 = [(STSchemaSTHallucinationDetectionFailed *)&v9 init];
  if (v5)
  {
...
- (BOOL)readFrom:(id)a3
{
  return STSchemaSTHallucinationDetectionFailedReadFrom(self, (uint64_t)a3);
}
