...
{
  v9.receiver = self;
  v9.super_class = (Class)RRSchemaRRUsoGraphTier1;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
...
- (RRSchemaRRUsoGraphTier1)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)RRSchemaRRUsoGraphTier1;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
...
- (BOOL)readFrom:(id)a3
{
  return RRSchemaRRUsoGraphTier1ReadFrom(self, (uint64_t)a3);
}
