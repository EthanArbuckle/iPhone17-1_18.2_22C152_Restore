...
- (SISchemaABExperimentAllocation)initWithDictionary:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)SISchemaABExperimentAllocation;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithLongLong:", -[SISchemaABExperimentAllocation deploymentId](self, "deploymentId"));
  ...
  {
    uint64_t v7 = [(SISchemaABExperimentAllocation *)self treatmentId];
    v8 = (void *)[v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(SISchemaABExperimentAllocation *)self experimentId];
  v6 = [v4 experimentId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(SISchemaABExperimentAllocation *)self experimentId];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v5 = [(SISchemaABExperimentAllocation *)self treatmentId];
  v6 = [v4 treatmentId];
  if ((v5 == 0) == (v6 != 0))
  {
LABEL_11:
  ...
  uint64_t v12 = [(SISchemaABExperimentAllocation *)self treatmentId];
  if (v12)
  {
...
{
  id v7 = a3;
  NSUInteger v4 = [(SISchemaABExperimentAllocation *)self experimentId];
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaABExperimentAllocationReadFrom(self, (uint64_t)a3);
}
