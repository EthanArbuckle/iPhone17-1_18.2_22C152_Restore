...
- (MHSchemaMHAssistantDaemonAudioRecordinFirstBufferReceipt)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"firstBufferReceiptTimeOffsetInNs"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(MHSchemaMHAssistantDaemonAudioRecordinFirstBufferReceipt *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[MHSchemaMHAssistantDaemonAudioRecordinFirstBufferReceipt firstBufferReceiptTimeOffsetInNs](self, "firstBufferReceiptTimeOffsetInNs"));
    [v3 setObject:v4 forKeyedSubscript:@"firstBufferReceiptTimeOffsetInNs"];
  }
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[16] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (unint64_t firstBufferReceiptTimeOffsetInNs = self->_firstBufferReceiptTimeOffsetInNs,
            firstBufferReceiptTimeOffsetInNs == [v4 firstBufferReceiptTimeOffsetInNs]))
      {
        BOOL v6 = 1;
      }
    }
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_unint64_t firstBufferReceiptTimeOffsetInNs = a3;
}
