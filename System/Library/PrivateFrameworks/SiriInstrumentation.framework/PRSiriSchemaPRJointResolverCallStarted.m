...
- (PRSiriSchemaPRJointResolverCallStarted)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)PRSiriSchemaPRJointResolverCallStarted;
...
- (id)dictionaryRepresentation
{
  ...
  {
    int v4 = [(PRSiriSchemaPRJointResolverCallStarted *)self callType];
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int callType = self->_callType, callType == [v4 callType]))
      {
        BOOL v6 = 1;
      }
    }
...
- (BOOL)readFrom:(id)a3
{
  return PRSiriSchemaPRJointResolverCallStartedReadFrom(self, (uint64_t)a3);
}
