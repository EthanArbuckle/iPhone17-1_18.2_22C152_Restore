...
- (ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel)initWithDictionary:(id)a3;
- (ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel;
  v5 = [(SISchemaInstrumentationMessage *)&v12 applySensitiveConditionsPolicy:v4];
  v6 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
  ...
  v9 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self digests];
...
- (ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel;
...
- (NSData)jsonData
{
  v2 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
  uint64_t v6 = [v4 fixedDimensions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
  ...
  v5 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self digests];
  uint64_t v6 = [v4 digests];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self digests];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self digests];
    v15 = [v4 digests];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
...
- (BOOL)readFrom:(id)a3
{
  return ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnelReadFrom(self, (uint64_t)a3);
}
