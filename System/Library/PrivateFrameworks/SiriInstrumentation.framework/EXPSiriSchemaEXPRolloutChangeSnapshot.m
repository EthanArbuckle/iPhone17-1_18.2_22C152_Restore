...
- (id)rolloutsAtIndex:(unint64_t)a3;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (unint64_t)rolloutsCount;
- (unint64_t)trialRolloutUpdateReceivedAtTimestampInMs;
- (void)addRollouts:(id)a3;
- (void)clearRollouts;
- (void)deleteTrialRolloutUpdateReceivedAtTimestampInMs;
- (void)setHasTrialRolloutUpdateReceivedAtTimestampInMs:(BOOL)a3;
- (void)setRollouts:(id)a3;
- (void)setTrialRolloutUpdateReceivedAtTimestampInMs:(unint64_t)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v9.receiver = self;
  v9.super_class = (Class)EXPSiriSchemaEXPRolloutChangeSnapshot;
  id v4 = a3;
...
- (unint64_t)trialRolloutUpdateReceivedAtTimestampInMs
{
  return self->_trialRolloutUpdateReceivedAtTimestampInMs;
}
...
- (EXPSiriSchemaEXPRolloutChangeSnapshot)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)EXPSiriSchemaEXPRolloutChangeSnapshot;
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[EXPSiriSchemaEXPRolloutChangeSnapshot trialRolloutUpdateReceivedAtTimestampInMs](self, "trialRolloutUpdateReceivedAtTimestampInMs"));
...
{
  if (*(unsigned char *)&self->_has) {
    unint64_t v2 = 2654435761u * self->_trialRolloutUpdateReceivedAtTimestampInMs;
  }
  else {
    unint64_t v2 = 0;
  }
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[24] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (unint64_t trialRolloutUpdateReceivedAtTimestampInMs = self->_trialRolloutUpdateReceivedAtTimestampInMs,
            trialRolloutUpdateReceivedAtTimestampInMs == [v4 trialRolloutUpdateReceivedAtTimestampInMs]))
      {
        uint64_t v6 = [(EXPSiriSchemaEXPRolloutChangeSnapshot *)self rollouts];
        uint64_t v7 = [v4 rollouts];
        uint64_t v8 = v7;
        if ((v6 == 0) != (v7 != 0))
        {
          uint64_t v9 = [(EXPSiriSchemaEXPRolloutChangeSnapshot *)self rollouts];
          if (!v9)
          {
...
LABEL_13:
          ...
          uint64_t v11 = [(EXPSiriSchemaEXPRolloutChangeSnapshot *)self rollouts];
          uint64_t v12 = [v4 rollouts];
...
- (BOOL)readFrom:(id)a3
{
  return EXPSiriSchemaEXPRolloutChangeSnapshotReadFrom(self, (uint64_t)a3);
}

- (id)rolloutsAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_rollouts objectAtIndexedSubscript:a3];
}

- (unint64_t)rolloutsCount
{
  return [(NSArray *)self->_rollouts count];
}
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_unint64_t trialRolloutUpdateReceivedAtTimestampInMs = a3;
}
