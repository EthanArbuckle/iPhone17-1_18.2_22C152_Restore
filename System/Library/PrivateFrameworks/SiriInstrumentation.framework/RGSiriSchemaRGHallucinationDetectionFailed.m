...
- (RGSiriSchemaRGHallucinationDetectionFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)RGSiriSchemaRGHallucinationDetectionFailed;
  v5 = [(RGSiriSchemaRGHallucinationDetectionFailed *)&v9 init];
  if (v5)
  {
...
- (BOOL)readFrom:(id)a3
{
  return RGSiriSchemaRGHallucinationDetectionFailedReadFrom(self, (uint64_t)a3);
}
