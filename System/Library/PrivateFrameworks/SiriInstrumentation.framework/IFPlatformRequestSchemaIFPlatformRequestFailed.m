...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFPlatformRequestSchemaIFPlatformRequestFailed)initWithDictionary:(id)a3;
- (IFPlatformRequestSchemaIFPlatformRequestFailed)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)IFPlatformRequestSchemaIFPlatformRequestFailed;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFPlatformRequestSchemaIFPlatformRequestFailed *)self criticalError];
...
- (IFPlatformRequestSchemaIFPlatformRequestFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFPlatformRequestSchemaIFPlatformRequestFailed;
...
- (NSData)jsonData
{
  v2 = [(IFPlatformRequestSchemaIFPlatformRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFPlatformRequestSchemaIFPlatformRequestFailed *)self criticalError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(IFPlatformRequestSchemaIFPlatformRequestFailed *)self criticalError];
    v6 = [v4 criticalError];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFPlatformRequestSchemaIFPlatformRequestFailed *)self criticalError];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(IFPlatformRequestSchemaIFPlatformRequestFailed *)self criticalError];
...
- (BOOL)readFrom:(id)a3
{
  return IFPlatformRequestSchemaIFPlatformRequestFailedReadFrom(self, (uint64_t)a3);
}
