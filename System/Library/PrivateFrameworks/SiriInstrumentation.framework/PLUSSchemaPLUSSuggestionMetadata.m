...
- (PLUSSchemaPLUSSuggestionMetadata)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"surfacedBeforeStatus"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(PLUSSchemaPLUSSuggestionMetadata *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    unsigned int v4 = [(PLUSSchemaPLUSSuggestionMetadata *)self surfacedBeforeStatus] - 1;
    if (v4 > 2) {
    ...
    [v3 setObject:v5 forKeyedSubscript:@"surfacedBeforeStatus"];
  }
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*(unsigned char *)&self->_has & 1) == (v4[12] & 1))
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (int surfacedBeforeStatus = self->_surfacedBeforeStatus,
            surfacedBeforeStatus == [v4 surfacedBeforeStatus]))
      {
        BOOL v6 = 1;
      }
    }
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_int surfacedBeforeStatus = a3;
}
