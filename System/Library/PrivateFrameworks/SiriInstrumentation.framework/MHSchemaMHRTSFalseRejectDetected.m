...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (MHSchemaMHRTSFalseRejectDetected)initWithDictionary:(id)a3;
- (MHSchemaMHRTSFalseRejectDetected)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (MHSchemaMHRTSFalseRejectDetected)initWithDictionary:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)MHSchemaMHRTSFalseRejectDetected;
...
- (NSData)jsonData
{
  v2 = [(MHSchemaMHRTSFalseRejectDetected *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[MHSchemaMHRTSFalseRejectDetected assetVersion](self, "assetVersion"));
    [v3 setObject:v4 forKeyedSubscript:@"assetVersion"];
  }
  if (self->_audioModelVersion)
  {
    v5 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
    v6 = (void *)[v5 copy];
    [v3 setObject:v6 forKeyedSubscript:@"audioModelVersion"];
  }
  if (self->_gestureModelVersion)
  {
    uint64_t v7 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
    v8 = (void *)[v7 copy];
    [v3 setObject:v8 forKeyedSubscript:@"gestureModelVersion"];
  }
  if (self->_policyModelVersion)
  {
    v9 = [(MHSchemaMHRTSFalseRejectDetected *)self policyModelVersion];
    v10 = (void *)[v9 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
  uint64_t v7 = [v4 gestureModelVersion];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_19;
  }
  uint64_t v8 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
  ...
  v6 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
  uint64_t v7 = [v4 audioModelVersion];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_19;
  }
  uint64_t v13 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
  if (v13)
  {
    v14 = (void *)v13;
    objc_super v15 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
  ...
  v6 = [(MHSchemaMHRTSFalseRejectDetected *)self policyModelVersion];
  uint64_t v7 = [v4 policyModelVersion];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(MHSchemaMHRTSFalseRejectDetected *)self policyModelVersion];
    if (!v18)
    {
...
LABEL_23:
    ...
    v19 = (void *)v18;
    v20 = [(MHSchemaMHRTSFalseRejectDetected *)self policyModelVersion];
...
- (void)writeTo:(id)a3
{
  ...
  NSUInteger v4 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];

  if (v4) {
    PBDataWriterWriteStringField();
  }
  NSUInteger v5 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
...
- (BOOL)readFrom:(id)a3
{
  return MHSchemaMHRTSFalseRejectDetectedReadFrom(self, (uint64_t)a3);
}
