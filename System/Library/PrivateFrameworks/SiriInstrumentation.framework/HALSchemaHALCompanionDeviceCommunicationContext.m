...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(HALSchemaHALCompanionDeviceCommunicationContext *)self ended];
...
- (unint64_t)hash
{
  return [(HALSchemaHALCompanionDeviceCommunicationEnded *)self->_ended hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if (whichContextevent == [v4 whichContextevent])
    {
      ...
      if ((v6 == 0) != (v7 != 0))
      {
        uint64_t v9 = [(HALSchemaHALCompanionDeviceCommunicationContext *)self ended];
        if (!v9)
        {
