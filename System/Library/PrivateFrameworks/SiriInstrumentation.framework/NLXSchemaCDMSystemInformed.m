...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NLXSchemaCDMSystemInformed;
...
- (NLXSchemaCDMSystemInformed)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)NLXSchemaCDMSystemInformed;
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"entities"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_taskId)
  {
    uint64_t v12 = [(NLXSchemaCDMSystemInformed *)self taskId];
...
- (unint64_t)hash
{
  ...
  return [(NSArray *)self->_entities hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(NLXSchemaCDMSystemInformed *)self taskId];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    id v9 = [(NLXSchemaCDMSystemInformed *)self taskId];
    uint64_t v10 = [v4 taskId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(NLXSchemaCDMSystemInformed *)self entities];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(NLXSchemaCDMSystemInformed *)self entities];
    v15 = [v4 entities];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(NLXSchemaCDMSystemInformed *)self taskId];
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMSystemInformedReadFrom(self, (uint64_t)a3);
}
