...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NLXSchemaMARRSQueryRewriteContext)initWithDictionary:(id)a3;
- (NLXSchemaMARRSQueryRewriteContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)NLXSchemaMARRSQueryRewriteContext;
  v5 = [(SISchemaInstrumentationMessage *)&v22 applySensitiveConditionsPolicy:v4];
  v6 = [(NLXSchemaMARRSQueryRewriteContext *)self started];
  ...
  v9 = [(NLXSchemaMARRSQueryRewriteContext *)self evaluated];
  ...
  v12 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];
  ...
  v15 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];
  ...
  v18 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];
...
- (NLXSchemaMARRSQueryRewriteContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v18.receiver = self;
  v18.super_class = (Class)NLXSchemaMARRSQueryRewriteContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[NLXSchemaMARRSQueryRewriteFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaMARRSQueryRewriteContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];
  ...
  if (self->_evaluated)
  {
    uint64_t v7 = [(NLXSchemaMARRSQueryRewriteContext *)self evaluated];
  ...
  if (self->_failed)
  {
    v10 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];
  ...
  if (self->_started)
  {
    v13 = [(NLXSchemaMARRSQueryRewriteContext *)self started];
  ...
  {
    v16 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(NLXSchemaMARRSQueryRewriteStarted *)self->_started hash];
  unint64_t v4 = [(NLXSchemaMARRSQueryRewriteEvaluated *)self->_evaluated hash] ^ v3;
  unint64_t v5 = [(NLXSchemaMARRSQueryRewriteFailed *)self->_failed hash];
  unint64_t v6 = v4 ^ v5 ^ [(NLXSchemaMARRSQueryRewriteStarted *)self->_startedOrChanged hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v6 = [(NLXSchemaMARRSQueryRewriteContext *)self started];
  uint64_t v7 = [v4 started];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v8 = [(NLXSchemaMARRSQueryRewriteContext *)self started];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(NLXSchemaMARRSQueryRewriteContext *)self started];
    int v11 = [v4 started];
  ...
  unint64_t v6 = [(NLXSchemaMARRSQueryRewriteContext *)self evaluated];
  uint64_t v7 = [v4 evaluated];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v13 = [(NLXSchemaMARRSQueryRewriteContext *)self evaluated];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(NLXSchemaMARRSQueryRewriteContext *)self evaluated];
    v16 = [v4 evaluated];
  ...
  unint64_t v6 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v18 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];
  if (v18)
  {
    v19 = (void *)v18;
    int v20 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];
    v21 = [v4 failed];
  ...
  unint64_t v6 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v23 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];
  if (v23)
  {
    v24 = (void *)v23;
    v25 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];
  ...
  unint64_t v6 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v28 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];
    if (!v28)
    {
...
LABEL_31:
    ...
    v29 = (void *)v28;
    v30 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];
    v31 = [v4 ended];
...
{
  id v14 = a3;
  id v4 = [(NLXSchemaMARRSQueryRewriteContext *)self started];

  if (v4)
  {
    unint64_t v5 = [(NLXSchemaMARRSQueryRewriteContext *)self started];
  ...
  uint64_t v8 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];

  if (v8)
  {
    v9 = [(NLXSchemaMARRSQueryRewriteContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];

  if (v10)
  {
    int v11 = [(NLXSchemaMARRSQueryRewriteContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  int v12 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];

  if (v12)
  {
    uint64_t v13 = [(NLXSchemaMARRSQueryRewriteContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaMARRSQueryRewriteContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (NLXSchemaMARRSQueryRewriteEvaluated *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (NLXSchemaMARRSQueryRewriteStarted *)a3;
  started = self->_started;
  self->_started = 0;
...
- (void)setFailed:(id)a3
{
  id v4 = (NLXSchemaMARRSQueryRewriteFailed *)a3;
  started = self->_started;
  self->_started = 0;
