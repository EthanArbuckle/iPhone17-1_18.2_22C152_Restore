...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)SUGSchemaSUGSuggestionsGeneratedTier1;
...
- (SUGSchemaSUGSuggestionsGeneratedTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)SUGSchemaSUGSuggestionsGeneratedTier1;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    id v4 = [(SUGSchemaSUGSuggestionsGeneratedTier1 *)self linkId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(SUGSchemaSUGSuggestionsGeneratedTier1 *)self linkId];
  if (v7)
  {
    int v8 = (void *)v7;
    uint64_t v9 = [(SUGSchemaSUGSuggestionsGeneratedTier1 *)self linkId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(SUGSchemaSUGSuggestionsGeneratedTier1 *)self suggestions];
    if (!v12)
    {
...
LABEL_15:
    ...
    uint64_t v14 = [(SUGSchemaSUGSuggestionsGeneratedTier1 *)self suggestions];
    v15 = [v4 suggestions];
...
- (BOOL)readFrom:(id)a3
{
  return SUGSchemaSUGSuggestionsGeneratedTier1ReadFrom(self, (uint64_t)a3);
}
