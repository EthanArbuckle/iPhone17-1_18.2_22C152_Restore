...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 8) != 0)
  {
    v8 = objc_msgSend(NSNumber, "numberWithBool:", -[MHSchemaMHRaiseToSpeakSecondPassPolicyDecisionMade isReplayModeEnabled](self, "isReplayModeEnabled"));
...
LABEL_3:
  ...
  v9 = objc_msgSend(NSNumber, "numberWithBool:", -[MHSchemaMHRaiseToSpeakSecondPassPolicyDecisionMade isSecondPassTriggered](self, "isSecondPassTriggered"));
