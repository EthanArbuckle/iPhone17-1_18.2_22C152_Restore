...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(GRRSchemaGRRFeatureExtractionStarted *)self source];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_source)
  {
    id v4 = [(GRRSchemaGRRFeatureExtractionStarted *)self source];
...
- (unint64_t)hash
{
  return [(GRRSchemaGRRSource *)self->_source hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(GRRSchemaGRRFeatureExtractionStarted *)self source];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(GRRSchemaGRRFeatureExtractionStarted *)self source];
      v11 = [v4 source];
