...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(NLXSchemaCDMLanguageVariantResult *)self multilingualVariants];
...
- (NLXSchemaCDMLanguageVariantResult)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[NLXSchemaCDMMultilingualVariant initWithDictionary:](v13, "initWithDictionary:", v12, (void)v19);
    ...
    v15 = objc_msgSend(v4, "objectForKeyedSubscript:", @"cdmParser", (void)v19);
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cdmParser)
  {
    id v4 = [(NLXSchemaCDMLanguageVariantResult *)self cdmParser];
  ...
  if ([(NSArray *)self->_multilingualVariants count])
  {
    ...
    long long v18 = 0u;
    long long v19 = 0u;
    uint64_t v8 = self->_multilingualVariants;
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSArray *)self->_multilingualVariants hash];
  return [(NLXSchemaCDMParser *)self->_cdmParser hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(NLXSchemaCDMLanguageVariantResult *)self multilingualVariants];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(NLXSchemaCDMLanguageVariantResult *)self multilingualVariants];
    uint64_t v10 = [v4 multilingualVariants];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(NLXSchemaCDMLanguageVariantResult *)self cdmParser];
    if (!v12)
    {
...
- (void)writeTo:(id)a3
{
  ...
  uint64_t v10 = [(NLXSchemaCDMLanguageVariantResult *)self cdmParser];

  if (v10)
  {
    int v11 = [(NLXSchemaCDMLanguageVariantResult *)self cdmParser];
    PBDataWriterWriteSubmessage();
  }
}
...
- (id)multilingualVariantsAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_multilingualVariants objectAtIndexedSubscript:a3];
}

- (unint64_t)multilingualVariantsCount
{
  return [(NSArray *)self->_multilingualVariants count];
}
