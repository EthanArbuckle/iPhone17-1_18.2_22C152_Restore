...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTRejectExpression)initWithDictionary:(id)a3;
- (IFTSchemaIFTRejectExpression)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTRejectExpression;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTRejectExpression *)self statementId];
...
- (IFTSchemaIFTRejectExpression)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFTSchemaIFTRejectExpression;
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTRejectExpression *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFTSchemaIFTRejectExpression *)self statementId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(IFTSchemaIFTRejectExpression *)self statementId];
    v6 = [v4 statementId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTRejectExpression *)self statementId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(IFTSchemaIFTRejectExpression *)self statementId];
      v11 = [v4 statementId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTRejectExpressionReadFrom(self, (uint64_t)a3);
}
