...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GMSSchemaGMSModelRequestContext)initWithDictionary:(id)a3;
- (GMSSchemaGMSModelRequestContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)GMSSchemaGMSModelRequestContext;
  v5 = [(SISchemaInstrumentationMessage *)&v16 applySensitiveConditionsPolicy:v4];
  v6 = [(GMSSchemaGMSModelRequestContext *)self started];
  ...
  v9 = [(GMSSchemaGMSModelRequestContext *)self ended];
  ...
  v12 = [(GMSSchemaGMSModelRequestContext *)self failed];
...
- (GMSSchemaGMSModelRequestContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)GMSSchemaGMSModelRequestContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[GMSSchemaGMSModelRequestFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(GMSSchemaGMSModelRequestContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(GMSSchemaGMSModelRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(GMSSchemaGMSModelRequestContext *)self failed];
  ...
  if (self->_started)
  {
    v10 = [(GMSSchemaGMSModelRequestContext *)self started];
...
- (unint64_t)hash
{
  unint64_t v3 = [(GMSSchemaGMSModelRequestStarted *)self->_started hash];
  unint64_t v4 = [(GMSSchemaGMSModelRequestEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(GMSSchemaGMSModelRequestContext *)self started];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(GMSSchemaGMSModelRequestContext *)self started];
  ...
  v6 = [(GMSSchemaGMSModelRequestContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(GMSSchemaGMSModelRequestContext *)self ended];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(GMSSchemaGMSModelRequestContext *)self ended];
  ...
  v6 = [(GMSSchemaGMSModelRequestContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(GMSSchemaGMSModelRequestContext *)self failed];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(GMSSchemaGMSModelRequestContext *)self failed];
    v21 = [v4 failed];
...
{
  id v10 = a3;
  id v4 = [(GMSSchemaGMSModelRequestContext *)self started];

  if (v4)
  {
    v5 = [(GMSSchemaGMSModelRequestContext *)self started];
  ...
  if (v6)
  {
    uint64_t v7 = [(GMSSchemaGMSModelRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(GMSSchemaGMSModelRequestContext *)self failed];

  if (v8)
  {
    v9 = [(GMSSchemaGMSModelRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return GMSSchemaGMSModelRequestContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (GMSSchemaGMSModelRequestFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (GMSSchemaGMSModelRequestEnded *)a3;
  started = self->_started;
  self->_started = 0;
...
- (void)setStarted:(id)a3
{
  id v4 = (GMSSchemaGMSModelRequestStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
