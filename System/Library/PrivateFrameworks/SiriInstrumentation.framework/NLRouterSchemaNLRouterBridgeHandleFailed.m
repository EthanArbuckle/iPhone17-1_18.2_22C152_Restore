...
{
  v9.receiver = self;
  v9.super_class = (Class)NLRouterSchemaNLRouterBridgeHandleFailed;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(NLRouterSchemaNLRouterBridgeHandleFailed *)self routingDecision];
...
- (NLRouterSchemaNLRouterBridgeHandleFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)NLRouterSchemaNLRouterBridgeHandleFailed;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      objc_super v9 = [[NLRouterSchemaNLRouterBridgeRoutingDecision alloc] initWithDictionary:v8];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = objc_msgSend(NSNumber, "numberWithInt:", -[NLRouterSchemaNLRouterBridgeHandleFailed errorCode](self, "errorCode"));
  ...
  {
    uint64_t v7 = [(NLRouterSchemaNLRouterBridgeHandleFailed *)self routingDecision];
...
LABEL_5:
    uint64_t v3 = 0;
    return v3 ^ v2 ^ [(NLRouterSchemaNLRouterBridgeRoutingDecision *)self->_routingDecision hash];
  }
  uint64_t v2 = 0;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
    goto LABEL_5;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v8 == ((v6 >> 1) & 1))
  {
    if (!v8 || (int errorCode = self->_errorCode, errorCode == [v4 errorCode]))
    {
      ...
      if ((v10 == 0) != (v11 != 0))
      {
        uint64_t v13 = [(NLRouterSchemaNLRouterBridgeHandleFailed *)self routingDecision];
        if (!v13)
        {
...
- (BOOL)readFrom:(id)a3
{
  return NLRouterSchemaNLRouterBridgeHandleFailedReadFrom(self, (uint64_t)a3);
}
