...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)CNVSchemaCNVFlowPluginExecutionContext;
...
- (CNVSchemaCNVFlowPluginExecutionContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)CNVSchemaCNVFlowPluginExecutionContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[CNVSchemaCNVFlowPluginExecutionEnded alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    id v4 = [(CNVSchemaCNVFlowPluginExecutionContext *)self contextId];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(CNVSchemaCNVFlowPluginExecutionStarted *)self->_startedOrChanged hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(CNVSchemaCNVFlowPluginExecutionContext *)self contextId];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  uint64_t v13 = [(CNVSchemaCNVFlowPluginExecutionContext *)self startedOrChanged];
  if (v13)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];
    if (!v18)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    uint64_t v7 = [(CNVSchemaCNVFlowPluginExecutionContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];

  if (v8)
  {
    v9 = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return CNVSchemaCNVFlowPluginExecutionContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setEnded:(id)a3
{
  id v4 = (CNVSchemaCNVFlowPluginExecutionEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (CNVSchemaCNVFlowPluginExecutionStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
