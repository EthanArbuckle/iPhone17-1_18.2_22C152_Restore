...
{
  v9.receiver = self;
  v9.super_class = (Class)IFPlatformRequestSchemaIFPlanCycleGenerated;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFPlatformRequestSchemaIFPlanCycleGenerated *)self planCycleId];
...
- (IFPlatformRequestSchemaIFPlanCycleGenerated)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFPlatformRequestSchemaIFPlanCycleGenerated;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFPlatformRequestSchemaIFPlanCycleGenerated *)self planCycleId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_planCycleId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFPlatformRequestSchemaIFPlanCycleGenerated *)self planCycleId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(IFPlatformRequestSchemaIFPlanCycleGenerated *)self planCycleId];
      v11 = [v4 planCycleId];
...
- (BOOL)readFrom:(id)a3
{
  return IFPlatformRequestSchemaIFPlanCycleGeneratedReadFrom(self, (uint64_t)a3);
}
