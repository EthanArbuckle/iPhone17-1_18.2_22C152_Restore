...
- (NSData)jsonData
{
  v2 = [(PLUSSchemaPLUSUniversalSuggestion *)self dictionaryRepresentation];
...
- (unint64_t)hash
{
  ...
  double v4 = -confidence;
  if (confidence >= 0.0) {
    double v4 = self->_confidence;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*(unsigned char *)&self->_has & 1) == 0
        || (double confidence = self->_confidence, [v4 confidence], confidence == v6))
      {
        BOOL v7 = 1;
      }
    }
