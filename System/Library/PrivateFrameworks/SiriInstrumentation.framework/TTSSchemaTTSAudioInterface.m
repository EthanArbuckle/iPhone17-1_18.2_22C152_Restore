...
- (id)dictionaryRepresentation
{
  ...
  if (self->_productId)
  {
    id v4 = [(TTSSchemaTTSAudioInterface *)self productId];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(TTSSchemaTTSAudioInterface *)self vendorId];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(TTSSchemaTTSAudioInterface *)self productId];
    if (!v12)
    {
...
{
  id v6 = a3;
  id v4 = [(TTSSchemaTTSAudioInterface *)self vendorId];
