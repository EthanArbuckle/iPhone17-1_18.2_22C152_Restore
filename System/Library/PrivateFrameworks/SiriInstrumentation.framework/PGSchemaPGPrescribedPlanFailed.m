...
- (NSData)jsonData;
- (PGSchemaPGPrescribedPlanFailed)initWithDictionary:(id)a3;
- (PGSchemaPGPrescribedPlanFailed)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)PGSchemaPGPrescribedPlanFailed;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
...
- (PGSchemaPGPrescribedPlanFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)PGSchemaPGPrescribedPlanFailed;
...
- (NSData)jsonData
{
  v2 = [(PGSchemaPGPrescribedPlanFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
    v6 = [v4 criticalError];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
...
- (BOOL)readFrom:(id)a3
{
  return PGSchemaPGPrescribedPlanFailedReadFrom(self, (uint64_t)a3);
}
