...
{
  v9.receiver = self;
  v9.super_class = (Class)ODDSiriSchemaODDExperimentFixedDimensions;
  id v4 = a3;
...
- (ODDSiriSchemaODDExperimentFixedDimensions)initWithDictionary:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)ODDSiriSchemaODDExperimentFixedDimensions;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithLongLong:", -[ODDSiriSchemaODDExperimentFixedDimensions deploymentId](self, "deploymentId"));
  ...
  {
    uint64_t v7 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self treatmentId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self experimentId];
  v6 = [v4 experimentId];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_11;
  }
  uint64_t v7 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self experimentId];
  if (v7)
  {
    v8 = (void *)v7;
    objc_super v9 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self experimentId];
    v10 = [v4 experimentId];
  ...
  uint64_t v5 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self treatmentId];
  v6 = [v4 treatmentId];
  if ((v5 == 0) == (v6 != 0))
  {
LABEL_11:
  ...
  uint64_t v12 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self treatmentId];
  if (v12)
  {
...
{
  id v7 = a3;
  unint64_t v4 = [(ODDSiriSchemaODDExperimentFixedDimensions *)self experimentId];
...
- (BOOL)readFrom:(id)a3
{
  return ODDSiriSchemaODDExperimentFixedDimensionsReadFrom(self, (uint64_t)a3);
}
