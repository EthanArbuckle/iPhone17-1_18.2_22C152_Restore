...
- (NSData)jsonData
{
  v2 = [(HALSchemaHALCrossDeviceCommandExecutionFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    unsigned int v5 = [(HALSchemaHALCrossDeviceCommandExecutionFailed *)self action] - 1;
    if (v5 > 0x14) {
  ...
  if (has)
  {
    unsigned int v7 = [(HALSchemaHALCrossDeviceCommandExecutionFailed *)self reason] - 1;
    if (v7 > 2) {
...
- (BOOL)isEqual:(id)a3
{
  ...
  $D9801B3D703CE409932895AE19E41252 has = self->_has;
