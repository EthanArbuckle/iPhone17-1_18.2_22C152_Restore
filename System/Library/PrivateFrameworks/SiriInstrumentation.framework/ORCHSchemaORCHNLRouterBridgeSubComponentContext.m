...
- (ORCHSchemaORCHNLRouterBridgeSubComponentContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[ORCHSchemaORCHNLRouterBridgeSubComponentEnded alloc] initWithDictionary:v10];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self failed];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SISchemaUUID *)self->_traceId hash];
  unint64_t v4 = [(ORCHSchemaORCHNLRouterBridgeSubComponentStarted *)self->_startedOrChanged hash] ^ v3;
  unint64_t v5 = [(ORCHSchemaORCHNLRouterBridgeSubComponentEnded *)self->_ended hash];
  unint64_t v6 = v4 ^ v5 ^ [(ORCHSchemaORCHNLRouterBridgeSubComponentFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v6 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self traceId];
  uint64_t v7 = [v4 traceId];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v8 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self traceId];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  unint64_t v6 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v13 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self startedOrChanged];
  if (v13)
  {
    int v14 = (void *)v13;
  ...
  unint64_t v6 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v18 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self ended];
  if (v18)
  {
    v19 = (void *)v18;
    int v20 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self ended];
    v21 = [v4 ended];
  ...
  unint64_t v6 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_27;
  }
  uint64_t v23 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self failed];
  if (v23)
  {
    v24 = (void *)v23;
  ...
  unint64_t v6 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self trpId];
  uint64_t v7 = [v4 trpId];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v28 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self trpId];
    if (!v28)
    {
...
{
  id v14 = a3;
  id v4 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self traceId];

  if (v4)
  {
    unint64_t v5 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self traceId];
  ...
  if (v6)
  {
    uint64_t v7 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self ended];
  ...
  if (v10)
  {
    int v11 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  int v12 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self trpId];

  if (v12)
  {
    uint64_t v13 = [(ORCHSchemaORCHNLRouterBridgeSubComponentContext *)self trpId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (ORCHSchemaORCHNLRouterBridgeSubComponentFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (ORCHSchemaORCHNLRouterBridgeSubComponentEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (ORCHSchemaORCHNLRouterBridgeSubComponentStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
