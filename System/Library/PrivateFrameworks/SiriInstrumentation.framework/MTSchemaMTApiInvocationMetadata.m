...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(MTSchemaMTApiInvocationMetadata *)self localePair];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_localePair)
  {
    id v4 = [(MTSchemaMTApiInvocationMetadata *)self localePair];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(MTSchemaMTApiInvocationMetadata *)self localePair];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(MTSchemaMTApiInvocationMetadata *)self localePair];
      v11 = [v4 localePair];
