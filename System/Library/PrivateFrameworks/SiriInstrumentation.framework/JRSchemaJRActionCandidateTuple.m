@interface JRSchemaJRActionCandidateTuple
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (JRSchemaJRActionCandidateTuple)initWithDictionary:(id)a3;
- (JRSchemaJRActionCandidateTuple)initWithJSON:(id)a3;
...
@implementation JRSchemaJRActionCandidateTuple

- (id)applySensitiveConditionsPolicy:(id)a3
{
  v9.receiver = self;
  v9.super_class = (Class)JRSchemaJRActionCandidateTuple;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(JRSchemaJRActionCandidateTuple *)self candidateIds];
  v7 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v6 underConditions:v4];

  [(JRSchemaJRActionCandidateTuple *)self setCandidateIds:v7];
  return v5;
}
...
- (JRSchemaJRActionCandidateTuple)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)JRSchemaJRActionCandidateTuple;
  v5 = [(JRSchemaJRActionCandidateTuple *)&v21 init];
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[SISchemaUUID initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
              [(JRSchemaJRActionCandidateTuple *)v5 addCandidateIds:v14];
            }
            ++v11;
          }
          while (v9 != v11);
...
- (JRSchemaJRActionCandidateTuple)initWithJSON:(id)a3
{
  ...
  {
    self = [(JRSchemaJRActionCandidateTuple *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(JRSchemaJRActionCandidateTuple *)self dictionaryRepresentation];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_candidateIds hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(JRSchemaJRActionCandidateTuple *)self candidateIds];
    uint64_t v6 = [v4 candidateIds];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(JRSchemaJRActionCandidateTuple *)self candidateIds];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(JRSchemaJRActionCandidateTuple *)self candidateIds];
...
- (BOOL)readFrom:(id)a3
{
  return JRSchemaJRActionCandidateTupleReadFrom(self, (uint64_t)a3);
}
