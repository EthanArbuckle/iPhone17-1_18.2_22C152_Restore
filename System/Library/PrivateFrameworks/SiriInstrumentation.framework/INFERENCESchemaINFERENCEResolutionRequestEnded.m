...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (INFERENCESchemaINFERENCEResolutionRequestEnded)initWithDictionary:(id)a3;
- (INFERENCESchemaINFERENCEResolutionRequestEnded)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (INFERENCESchemaINFERENCEResolutionRequestEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)INFERENCESchemaINFERENCEResolutionRequestEnded;
...
- (NSData)jsonData
{
  v2 = [(INFERENCESchemaINFERENCEResolutionRequestEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[INFERENCESchemaINFERENCEResolutionRequestEnded exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return INFERENCESchemaINFERENCEResolutionRequestEndedReadFrom(self, (uint64_t)a3);
}
