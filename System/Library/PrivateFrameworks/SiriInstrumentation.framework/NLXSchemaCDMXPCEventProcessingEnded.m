...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NLXSchemaCDMXPCEventProcessingEnded)initWithDictionary:(id)a3;
- (NLXSchemaCDMXPCEventProcessingEnded)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NLXSchemaCDMXPCEventProcessingEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)NLXSchemaCDMXPCEventProcessingEnded;
...
- (NSData)jsonData
{
  v2 = [(NLXSchemaCDMXPCEventProcessingEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[NLXSchemaCDMXPCEventProcessingEnded exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaCDMXPCEventProcessingEndedReadFrom(self, (uint64_t)a3);
}
