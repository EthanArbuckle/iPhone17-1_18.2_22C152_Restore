...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(ASRSchemaASREmbeddedSpeechProcessContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  return [(ASRSchemaASREmbeddedSpeechProcessStarted *)self->_startedOrChanged hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if (whichContextevent == [v4 whichContextevent])
    {
      ...
      if ((v6 == 0) != (v7 != 0))
      {
        uint64_t v9 = [(ASRSchemaASREmbeddedSpeechProcessContext *)self startedOrChanged];
        if (!v9)
        {
