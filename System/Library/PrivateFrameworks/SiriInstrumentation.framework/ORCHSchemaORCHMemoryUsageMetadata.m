...
- (ORCHSchemaORCHMemoryUsageMetadata)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"maxRSS"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHMemoryUsageMetadata *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[ORCHSchemaORCHMemoryUsageMetadata maxRSS](self, "maxRSS"));
    [v3 setObject:v4 forKeyedSubscript:@"maxRSS"];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*(unsigned char *)&self->_has & 1) == 0 || (unint64_t maxRSS = self->_maxRSS, maxRSS == [v4 maxRSS])) {
        BOOL v6 = 1;
      }
    }
  }
