      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
              -[ASRSchemaASRUtterance addInterpretationIndices:](v5, "addInterpretationIndices:", objc_msgSend(v12, "unsignedIntValue", (void)v15));
            }
            ++v11;
          }
          while (v9 != v11);
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(ASRSchemaASRUtterance *)self interpretationIndices];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_interpretationIndices hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(ASRSchemaASRUtterance *)self interpretationIndices];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(ASRSchemaASRUtterance *)self interpretationIndices];
...
- (unint64_t)interpretationIndicesCount
{
  return [(NSArray *)self->_interpretationIndices count];
}
...
- (void)addInterpretationIndices:(unsigned int)a3
{
  ...
  if (!interpretationIndices)
  {
    ...
    uint64_t v7 = self->_interpretationIndices;
