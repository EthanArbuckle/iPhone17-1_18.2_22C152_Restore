@interface SISchemaUEISiriCarCommandEnded
- (BOOL)hasIsSiriDigitalCarKeyRequest;
- (BOOL)isEqual:(id)a3;
- (BOOL)isSiriDigitalCarKeyRequest;
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (SISchemaUEISiriCarCommandEnded)initWithDictionary:(id)a3;
- (SISchemaUEISiriCarCommandEnded)initWithJSON:(id)a3;
...
@implementation SISchemaUEISiriCarCommandEnded
...
- (SISchemaUEISiriCarCommandEnded)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SISchemaUEISiriCarCommandEnded;
  v5 = [(SISchemaUEISiriCarCommandEnded *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"isSiriDigitalCarKeyRequest"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[SISchemaUEISiriCarCommandEnded setIsSiriDigitalCarKeyRequest:](v5, "setIsSiriDigitalCarKeyRequest:", [v6 BOOLValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (SISchemaUEISiriCarCommandEnded)initWithJSON:(id)a3
{
  ...
  {
    self = [(SISchemaUEISiriCarCommandEnded *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(SISchemaUEISiriCarCommandEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[SISchemaUEISiriCarCommandEnded isSiriDigitalCarKeyRequest](self, "isSiriDigitalCarKeyRequest"));
...
- (BOOL)readFrom:(id)a3
{
  return SISchemaUEISiriCarCommandEndedReadFrom(self, (uint64_t)a3);
}
