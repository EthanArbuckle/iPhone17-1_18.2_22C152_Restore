...
- (CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed)initWithDictionary:(id)a3
{
  ...
  v5 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed *)&v9 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"errorCode"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed setErrorCode:](v5, "setErrorCode:", [v6 unsignedIntValue]);
    }
    v7 = v5;
  }
  return v5;
...
- (CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed)initWithJSON:(id)a3
{
  ...
  {
    self = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (NSData)jsonData
{
  v2 = [(CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[CLPInstSchemaCLPCurareAppIntentSampleClassificationFailed errorCode](self, "errorCode"));
