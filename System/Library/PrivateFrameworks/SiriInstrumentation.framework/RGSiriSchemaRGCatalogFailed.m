...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (RGSiriSchemaRGCatalogFailed)initWithDictionary:(id)a3;
- (RGSiriSchemaRGCatalogFailed)initWithJSON:(id)a3;
...
- (RGSiriSchemaRGCatalogFailed)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)RGSiriSchemaRGCatalogFailed;
  v5 = [(RGSiriSchemaRGCatalogFailed *)&v9 init];
  if (v5)
  {
...
- (NSData)jsonData
{
  v2 = [(RGSiriSchemaRGCatalogFailed *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return RGSiriSchemaRGCatalogFailedReadFrom(self, (uint64_t)a3);
}
