...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTPrimitive)initWithDictionary:(id)a3;
- (IFTSchemaIFTPrimitive)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (IFTSchemaIFTPrimitive)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTPrimitive;
  v5 = [(IFTSchemaIFTPrimitive *)&v9 init];
  if (v5)
  {
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTPrimitive *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[IFTSchemaIFTPrimitive exists](self, "exists"));
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTPrimitiveReadFrom(self, (uint64_t)a3);
}
