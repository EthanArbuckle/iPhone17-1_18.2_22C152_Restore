...
- (NSArray)mentionResolverSpansTier1s;
- (NSData)jsonData;
- (SISchemaUUID)linkId;
- (id)applySensitiveConditionsPolicy:(id)a3;
- (id)dictionaryRepresentation;
- (id)mentionResolverSpansTier1AtIndex:(unint64_t)a3;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (unint64_t)mentionResolverSpansTier1Count;
- (void)addMentionResolverSpansTier1:(id)a3;
- (void)clearMentionResolverSpansTier1;
- (void)deleteLinkId;
- (void)setHasLinkId:(BOOL)a3;
- (void)setLinkId:(id)a3;
- (void)setMentionResolverSpansTier1s:(id)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v11.receiver = self;
  v11.super_class = (Class)NLXSchemaMARRSMentionResolverEndedTier1;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v11 applySensitiveConditionsPolicy:v4];
  v6 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self mentionResolverSpansTier1s];
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_mentionResolverSpansTier1s, 0);
}
...
- (NSArray)mentionResolverSpansTier1s
{
  return self->_mentionResolverSpansTier1s;
}
...
- (NLXSchemaMARRSMentionResolverEndedTier1)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v23.receiver = self;
  v23.super_class = (Class)NLXSchemaMARRSMentionResolverEndedTier1;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    id v4 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self linkId];
  ...
  if ([(NSArray *)self->_mentionResolverSpansTier1s count])
  {
    ...
    long long v18 = 0u;
    long long v19 = 0u;
    uint64_t v8 = self->_mentionResolverSpansTier1s;
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSArray *)self->_mentionResolverSpansTier1s hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self mentionResolverSpansTier1s];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    uint64_t v9 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self mentionResolverSpansTier1s];
    uint64_t v10 = [v4 mentionResolverSpansTier1s];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self linkId];
    if (!v12)
    {
...
- (void)writeTo:(id)a3
{
  ...
  uint64_t v10 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self linkId];

  if (v10)
  {
    int v11 = [(NLXSchemaMARRSMentionResolverEndedTier1 *)self linkId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return NLXSchemaMARRSMentionResolverEndedTier1ReadFrom(self, (uint64_t)a3);
}
...
- (id)mentionResolverSpansTier1AtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_mentionResolverSpansTier1s objectAtIndexedSubscript:a3];
}

- (unint64_t)mentionResolverSpansTier1Count
{
  return [(NSArray *)self->_mentionResolverSpansTier1s count];
}
...
- (void)addMentionResolverSpansTier1:(id)a3
{
  ...
  if (!mentionResolverSpansTier1s)
  {
    ...
    uint64_t v7 = self->_mentionResolverSpansTier1s;
