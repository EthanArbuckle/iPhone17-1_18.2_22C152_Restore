...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  uint64_t v6 = [(SRSTSchemaSRSTClientEvent *)self eventMetadata];
...
- (SRSTSchemaSRSTClientEvent)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    int v8 = [v4 objectForKeyedSubscript:@"stateTransitionEvent"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(SRSTSchemaSRSTClientEvent *)self eventMetadata];
  ...
  {
    uint64_t v7 = [(SRSTSchemaSRSTClientEvent *)self stateTransitionEvent];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SRSTSchemaSRSTClientEventMetadata *)self->_eventMetadata hash];
  return [(SRSTSchemaSRSTStateTransitionEvent *)self->_stateTransitionEvent hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(SRSTSchemaSRSTClientEvent *)self eventMetadata];
  if (v8)
  {
    v9 = (void *)v8;
  ...
  uint64_t v6 = [(SRSTSchemaSRSTClientEvent *)self stateTransitionEvent];
  uint64_t v7 = [v4 stateTransitionEvent];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(SRSTSchemaSRSTClientEvent *)self stateTransitionEvent];
    if (!v13)
    {
