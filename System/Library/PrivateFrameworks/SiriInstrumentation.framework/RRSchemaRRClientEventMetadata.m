...
- (id)dictionaryRepresentation
{
  ...
  if (self->_requestId)
  {
    id v4 = [(RRSchemaRRClientEventMetadata *)self requestId];
  ...
  if (self->_rrID)
  {
    uint64_t v7 = [(RRSchemaRRClientEventMetadata *)self rrID];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SISchemaUUID *)self->_rrID hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v12 = [(RRSchemaRRClientEventMetadata *)self requestId];
  if (v12)
  {
    v13 = (void *)v12;
    objc_super v14 = [(RRSchemaRRClientEventMetadata *)self requestId];
    v15 = [v4 requestId];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(RRSchemaRRClientEventMetadata *)self subRequestId];
    if (!v17)
    {
...
{
  id v10 = a3;
  id v4 = [(RRSchemaRRClientEventMetadata *)self rrID];
  ...
  if (v6)
  {
    uint64_t v7 = [(RRSchemaRRClientEventMetadata *)self requestId];
    PBDataWriterWriteSubmessage();
  }
  int v8 = [(RRSchemaRRClientEventMetadata *)self subRequestId];

  if (v8)
  {
    v9 = [(RRSchemaRRClientEventMetadata *)self subRequestId];
    PBDataWriterWriteSubmessage();
  }
}
