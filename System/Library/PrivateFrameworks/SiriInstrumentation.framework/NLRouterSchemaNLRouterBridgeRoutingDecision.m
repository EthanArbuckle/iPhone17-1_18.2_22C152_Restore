...
- (NLRouterSchemaNLRouterBridgeRoutingDecision)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)NLRouterSchemaNLRouterBridgeRoutingDecision;
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    unsigned int v5 = [(NLRouterSchemaNLRouterBridgeRoutingDecision *)self routerDecisionType] - 1;
    if (v5 > 7) {
  ...
  if (has)
  {
    unsigned int v7 = [(NLRouterSchemaNLRouterBridgeRoutingDecision *)self routingDecisionSource] - 1;
    if (v7 > 2) {
...
- (BOOL)readFrom:(id)a3
{
  return NLRouterSchemaNLRouterBridgeRoutingDecisionReadFrom(self, (uint64_t)a3);
}
