...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (POMMESSchemaPOMMESRequestContext)initWithDictionary:(id)a3;
- (POMMESSchemaPOMMESRequestContext)initWithJSON:(id)a3;
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)POMMESSchemaPOMMESRequestContext;
  v5 = [(SISchemaInstrumentationMessage *)&v19 applySensitiveConditionsPolicy:v4];
  v6 = [(POMMESSchemaPOMMESRequestContext *)self startedOrChanged];
  ...
  v9 = [(POMMESSchemaPOMMESRequestContext *)self ended];
  ...
  v12 = [(POMMESSchemaPOMMESRequestContext *)self failed];
  ...
  v15 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];
...
- (POMMESSchemaPOMMESRequestContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)POMMESSchemaPOMMESRequestContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[POMMESSchemaPOMMESRequestFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  v2 = [(POMMESSchemaPOMMESRequestContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    id v4 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];
  ...
  if (self->_ended)
  {
    uint64_t v7 = [(POMMESSchemaPOMMESRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    v10 = [(POMMESSchemaPOMMESRequestContext *)self failed];
  ...
  {
    v13 = [(POMMESSchemaPOMMESRequestContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(POMMESSchemaPOMMESRequestStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(POMMESSchemaPOMMESRequestEnded *)self->_ended hash] ^ v3;
  unint64_t v5 = [(POMMESSchemaPOMMESRequestFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(POMMESSchemaPOMMESRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(POMMESSchemaPOMMESRequestContext *)self startedOrChanged];
  ...
  v6 = [(POMMESSchemaPOMMESRequestContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v13 = [(POMMESSchemaPOMMESRequestContext *)self ended];
  if (v13)
  {
    int v14 = (void *)v13;
    v15 = [(POMMESSchemaPOMMESRequestContext *)self ended];
  ...
  v6 = [(POMMESSchemaPOMMESRequestContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_22;
  }
  uint64_t v18 = [(POMMESSchemaPOMMESRequestContext *)self failed];
  if (v18)
  {
    objc_super v19 = (void *)v18;
    v20 = [(POMMESSchemaPOMMESRequestContext *)self failed];
    v21 = [v4 failed];
  ...
  v6 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];
  uint64_t v7 = [v4 cancelled];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v23 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = (void *)v23;
    v25 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];
    v26 = [v4 cancelled];
...
{
  id v12 = a3;
  id v4 = [(POMMESSchemaPOMMESRequestContext *)self startedOrChanged];

  if (v4)
  {
    unint64_t v5 = [(POMMESSchemaPOMMESRequestContext *)self startedOrChanged];
  ...
  uint64_t v8 = [(POMMESSchemaPOMMESRequestContext *)self failed];

  if (v8)
  {
    v9 = [(POMMESSchemaPOMMESRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
  v10 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];

  if (v10)
  {
    int v11 = [(POMMESSchemaPOMMESRequestContext *)self cancelled];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return POMMESSchemaPOMMESRequestContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setCancelled:(id)a3
{
  id v4 = (POMMESSchemaPOMMESRequestUnableToHandle *)a3;
...
- (void)setFailed:(id)a3
{
  id v4 = (POMMESSchemaPOMMESRequestFailed *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setEnded:(id)a3
{
  id v4 = (POMMESSchemaPOMMESRequestEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (POMMESSchemaPOMMESRequestStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
