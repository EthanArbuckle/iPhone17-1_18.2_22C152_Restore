...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)SUGSchemaSUGRequestContext;
...
- (SUGSchemaSUGRequestContext)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)SUGSchemaSUGRequestContext;
  ...
  if (v5)
  {
    ...
    {
      v7 = [[SUGSchemaSUGRequestStarted alloc] initWithDictionary:v6];
    ...
    if (objc_opt_isKindOfClass())
    {
      v9 = [[SUGSchemaSUGRequestEnded alloc] initWithDictionary:v8];
    ...
    if (objc_opt_isKindOfClass())
    {
      int v11 = [[SUGSchemaSUGRequestFailed alloc] initWithDictionary:v10];
      [(SUGSchemaSUGRequestContext *)v5 setFailed:v11];
    }
    v12 = v5;
  }
  return v5;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(SUGSchemaSUGRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(SUGSchemaSUGRequestContext *)self failed];
...
- (unint64_t)hash
{
  unint64_t v3 = [(SUGSchemaSUGRequestStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(SUGSchemaSUGRequestEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(SUGSchemaSUGRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(SUGSchemaSUGRequestContext *)self startedOrChanged];
  ...
  uint64_t v13 = [(SUGSchemaSUGRequestContext *)self ended];
  if (v13)
  {
  ...
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(SUGSchemaSUGRequestContext *)self failed];
    if (!v18)
    {
...
{
  id v10 = a3;
  id v4 = [(SUGSchemaSUGRequestContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(SUGSchemaSUGRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(SUGSchemaSUGRequestContext *)self failed];

  if (v8)
  {
    v9 = [(SUGSchemaSUGRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return SUGSchemaSUGRequestContextReadFrom(self, (uint64_t)a3);
}
...
- (void)setFailed:(id)a3
{
  id v4 = (SUGSchemaSUGRequestFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (SUGSchemaSUGRequestEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (SUGSchemaSUGRequestStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
