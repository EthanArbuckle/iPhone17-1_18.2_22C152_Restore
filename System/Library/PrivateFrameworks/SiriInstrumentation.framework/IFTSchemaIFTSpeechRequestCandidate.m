...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (IFTSchemaIFTSpeechRequestCandidate)initWithDictionary:(id)a3;
- (IFTSchemaIFTSpeechRequestCandidate)initWithJSON:(id)a3;
...
{
  v9.receiver = self;
  v9.super_class = (Class)IFTSchemaIFTSpeechRequestCandidate;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
...
- (IFTSchemaIFTSpeechRequestCandidate)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IFTSchemaIFTSpeechRequestCandidate;
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTSpeechRequestCandidate *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
    v6 = [v4 statementId];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
      v11 = [v4 statementId];
...
- (BOOL)readFrom:(id)a3
{
  return IFTSchemaIFTSpeechRequestCandidateReadFrom(self, (uint64_t)a3);
}
