...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
  ...
  v9 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
...
- (NSData)jsonData
{
  v2 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
  ...
  {
    uint64_t v7 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  unint64_t v3 = [(CLPInstSchemaCLPCDMReplayTaskStarted *)self->_startedOrChanged hash];
  return [(CLPInstSchemaCLPCDMReplayTaskEnded *)self->_ended hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v8 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
  ...
  v6 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v13 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
    if (!v13)
    {
...
LABEL_16:
    ...
    v14 = (void *)v13;
    v15 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
    v16 = [v4 ended];
...
{
  id v8 = a3;
  id v4 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setEnded:(id)a3
{
  id v4 = (CLPInstSchemaCLPCDMReplayTaskEnded *)a3;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (CLPInstSchemaCLPCDMReplayTaskStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
