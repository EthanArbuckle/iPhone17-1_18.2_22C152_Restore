...
{
  v9.receiver = self;
  v9.super_class = (Class)IASchemaIAClientEventMetadata;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(IASchemaIAClientEventMetadata *)self iaId];
...
- (IASchemaIAClientEventMetadata)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)IASchemaIAClientEventMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_iaId)
  {
    id v4 = [(IASchemaIAClientEventMetadata *)self iaId];
...
- (unint64_t)hash
{
  return [(SISchemaUUID *)self->_iaId hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(IASchemaIAClientEventMetadata *)self iaId];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(IASchemaIAClientEventMetadata *)self iaId];
      v11 = [v4 iaId];
...
- (BOOL)readFrom:(id)a3
{
  return IASchemaIAClientEventMetadataReadFrom(self, (uint64_t)a3);
}
