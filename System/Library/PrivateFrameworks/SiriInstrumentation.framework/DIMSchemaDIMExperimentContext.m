...
- (unint64_t)hash;
- (unsigned)experimentalBucketId;
- (void)addExperimentInfo:(id)a3;
- (void)clearExperimentInfo;
- (void)deleteExperimentalBucketId;
- (void)setExperimentInfos:(id)a3;
- (void)setExperimentalBucketId:(unsigned int)a3;
- (void)setHasExperimentalBucketId:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
{
  v9.receiver = self;
  v9.super_class = (Class)DIMSchemaDIMExperimentContext;
  id v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(DIMSchemaDIMExperimentContext *)self experimentInfos];
...
- (unsigned)experimentalBucketId
{
  return self->_experimentalBucketId;
}
...
- (DIMSchemaDIMExperimentContext)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)DIMSchemaDIMExperimentContext;
  ...
  if (v5)
  {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[DIMSchemaDIMExperimentInfo initWithDictionary:](v13, "initWithDictionary:", v12, (void)v18);
    ...
    v15 = objc_msgSend(v4, "objectForKeyedSubscript:", @"experimentalBucketId", (void)v18);
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v12 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[DIMSchemaDIMExperimentContext experimentalBucketId](self, "experimentalBucketId"));
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSArray *)self->_experimentInfos hash];
  if (*(unsigned char *)&self->_has) {
    uint64_t v4 = 2654435761 * self->_experimentalBucketId;
  }
  else {
    uint64_t v4 = 0;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v6 = [v4 experimentInfos];
  uint64_t v7 = v6;
  if ((v5 == 0) == (v6 != 0))
  {
...
LABEL_12:
  ...
  uint64_t v8 = [(DIMSchemaDIMExperimentContext *)self experimentInfos];
  if (v8)
  {
    uint64_t v9 = (void *)v8;
    uint64_t v10 = [(DIMSchemaDIMExperimentContext *)self experimentInfos];
    uint64_t v11 = [v4 experimentInfos];
  ...
  if (*(unsigned char *)&self->_has)
  {
    unsigned int experimentalBucketId = self->_experimentalBucketId;
...
- (BOOL)readFrom:(id)a3
{
  return DIMSchemaDIMExperimentContextReadFrom(self, (uint64_t)a3);
}
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_unsigned int experimentalBucketId = a3;
}
