...
uint64_t __72___UIWindowSceneReplacePlacement_descriptionBuilderWithMultilinePrefix___block_invoke(uint64_t a1)
{
  return [*(id *)(a1 + 32) appendString:*(void *)(*(void *)(a1 + 40) + 8) withName:@"targetScenePersistentIdentifier"];
}
...
- (id)_initWithTargetSceneSession:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)UIWindowSceneReplacePlacement;
...
{
  v9.receiver = self;
  v9.super_class = (Class)UIWindowSceneReplacePlacement;
...
- (BOOL)isEqual:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)UIWindowSceneReplacePlacement;
...
{
  v12.receiver = self;
  v12.super_class = (Class)UIWindowSceneReplacePlacement;
  id v4 = a3;
