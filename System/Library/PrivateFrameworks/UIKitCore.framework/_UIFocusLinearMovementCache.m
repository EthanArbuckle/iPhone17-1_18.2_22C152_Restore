        ...
        do
        {
          ...
          if (v10)
          {
            ...
            do
            {
              ...
              uint64_t v12 = [v11 parentFocusEnvironment];
...
- (void)environmentDidAppear:(id)a3
{
  ...
  id v4 = a3;
  BOOL v5 = +[UIFocusSystem focusSystemForEnvironment:v4];
  if (![v5 _isEnvironmentLocked:v4])
  {
    uint64_t v6 = _UIFocusItemSafeCast(v4);
    uint64_t v7 = v6;
...
LABEL_29:
    ...
    uint64_t v8 = [v4 parentFocusEnvironment];
    if (v8)
    {
      uint64_t v9 = (void *)v8;
      do
      {
        id v10 = _UIFocusItemSafeCast(v9);
        v11 = v10;
        if (v10) {
          int IsFocusedOrFocusable = _UIFocusItemIsFocusedOrFocusable(v10);
        }
        else {
          int IsFocusedOrFocusable = 0;
        }
        long long v13 = [v9 parentFocusEnvironment];
        ...
        if (v24)
        {
          ...
          while (2)
          {
            for (uint64_t i = 0; i != v25; ++i)
            {
              ...
              v34.origin.x = _UIFocusItemFrameInCoordinateSpace(*(void **)(*((void *)&v28 + 1) + 8 * i), v14);
              v35.origin.x = v16;
              v35.origin.y = v18;
              v35.size.width = v20;
              v35.size.height = v22;
