...
- (_UIAlertControllerVisualStyleAlertTVCustomCurveFactory)init;
...
- (_UIAlertControllerVisualStyleAlertTVCustomCurveFactory)init
{
  return [(_UIAlertControllerVisualStyleAlertTVCustomCurveFactory *)self initWithCustomCurve:0];
}

- (_UIAlertControllerVisualStyleAlertTVCustomCurveFactory)initWithCustomCurve:(unint64_t)a3
{
  v5.receiver = self;
  v5.super_class = (Class)_UIAlertControllerVisualStyleAlertTVCustomCurveFactory;
...
- (id)_timingFunctionForAnimationInView:(id)a3 withKeyPath:(id)a4
{
  unint64_t v4 = [(_UIAlertControllerVisualStyleAlertTVCustomCurveFactory *)self curve];
  if (v4 == 1)
  {
