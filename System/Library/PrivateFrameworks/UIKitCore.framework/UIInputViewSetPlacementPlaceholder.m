...
- (id)verticalConstraintForInputViewSet:(id)a3 hostView:(id)a4 containerView:(id)a5
{
  if (a4)
  {
    v6 = [MEMORY[0x1E4F5B268] constraintWithItem:a4 attribute:3 relatedBy:0 toItem:a5 attribute:4 multiplier:1.0 constant:-self->_height];
  }
  else
  {
    v6 = 0;
