@interface _UIBackdropViewSettingsATVUltraLight
- (void)setDefaultValues;
@end

@implementation _UIBackdropViewSettingsATVUltraLight

- (void)setDefaultValues
{
  v11.receiver = self;
  v11.super_class = (Class)_UIBackdropViewSettingsATVUltraLight;
  ...
  if ([(_UIBackdropViewSettings *)self graphicsQuality] == 10 || v3)
  {
    ...
    [(_UIBackdropViewSettings *)self setColorTintAlpha:0.75];
    ...
    if (v3)
    {
      v9 = +[UIColor colorWithRed:0.88627451 green:0.894117647 blue:0.898039216 alpha:1.0];
...
LABEL_7:
      ...
      [(_UIBackdropViewSettings *)self setColorOffsetAlpha:0.12];
    }
    [(_UIBackdropViewSettings *)self setGrayscaleTintLevel:0.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintAlpha:0.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskAlpha:1.0];
