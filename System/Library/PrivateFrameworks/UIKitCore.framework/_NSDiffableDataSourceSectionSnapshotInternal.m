...
{
  v6.receiver = self;
  v6.super_class = (Class)_NSDiffableDataSourceSectionSnapshotInternal;
  objc_super v4 = [(NSDiffableDataSourceSectionSnapshot *)&v6 childrenOfParent:a3 recursive:a4];
  return v4;
}
...
- (id)childrenOfParent:(id)a3
{
  ...
  objc_super v3 = [(NSDiffableDataSourceSectionSnapshot *)&v5 childrenOfParent:a3];
  return v3;
}
...
- (id)parentOfChild:(id)a3
{
  v5.receiver = self;
  v5.super_class = (Class)_NSDiffableDataSourceSectionSnapshotInternal;
  objc_super v3 = [(NSDiffableDataSourceSectionSnapshot *)&v5 parentOfChild:a3];
  return v3;
}
