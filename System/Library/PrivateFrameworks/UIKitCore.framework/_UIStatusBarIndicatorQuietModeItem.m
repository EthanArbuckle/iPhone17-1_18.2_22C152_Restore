...
+ (_UIStatusBarIdentifier)emphasizedQuietModeIdentifier
{
  return (_UIStatusBarIdentifier *)[a1 displayItemIdentifierFromString:@"emphasizedQuietModeIdentifier"];
}
...
- (id)viewForIdentifier:(id)a3
{
  ...
  if (v5 == v4)
  {
    uint64_t v6 = [(_UIStatusBarIndicatorQuietModeItem *)self emphasizedImageView];
  }
  else
  {
    v9.receiver = self;
...
- (id)imageViewForIdentifier:(id)a3
{
  ...
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)_UIStatusBarIndicatorQuietModeItem;
    uint64_t v6 = [(_UIStatusBarIndicatorItem *)&v9 imageViewForIdentifier:v4];
  }
  v7 = (void *)v6;
...
- (BOOL)shouldUpdateIndicatorForIdentifier:(id)a3
{
  ...
  else
  {
    ...
    BOOL v6 = [(_UIStatusBarIndicatorItem *)&v8 shouldUpdateIndicatorForIdentifier:v4];
  }
...
- (id)applyUpdate:(id)a3 toDisplayItem:(id)a4
{
  ...
  objc_super v8 = [(_UIStatusBarIndicatorItem *)&v20 applyUpdate:v6 toDisplayItem:v7];
  if ([v6 dataChanged])
  {
    ...
    uint64_t v13 = v11 ^ 1u;
    v14 = [v7 identifier];
    v15 = [(_UIStatusBarIndicatorQuietModeItem *)self imageViewForIdentifier:v14];
    [v15 setUseDisabledAppearanceForAccessibilityHUD:v13];

    v16 = [v6 data];
    v17 = [v16 quietModeEntry];
    v18 = [v17 focusName];
    [(_UIStatusBarIndicatorQuietModeItem *)self setFocusName:v18];
  }
  return v8;
}
