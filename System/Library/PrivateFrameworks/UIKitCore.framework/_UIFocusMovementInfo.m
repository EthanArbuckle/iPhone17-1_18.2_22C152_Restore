...
- (_UIFocusMovementInfo)initWithHeading:(unint64_t)a3 linearHeading:(unint64_t)a4 isInitial:(BOOL)a5 shouldLoadScrollableContainer:(BOOL)a6 looping:(BOOL)a7 groupFilter:(int64_t)a8;
...
- (_UIFocusMovementInfo)initWithHeading:(unint64_t)a3 velocity:(CGVector)a4 isInitial:(BOOL)a5 shouldLoadScrollableContainer:(BOOL)a6 groupFilter:(int64_t)a7;
...
{
  v4.receiver = self;
  v4.super_class = (Class)_UIFocusMovementInfo;
  ...
  if (result)
  {
    ...
    *(_DWORD *)&result->_looping = 65792;
    ...
    result->_fallbackMovementOriginatingFrame.origin = (CGPoint)*MEMORY[0x1E4F1DB20];
...
- (_UIFocusMovementInfo)initWithHeading:(unint64_t)a3 velocity:(CGVector)a4 isInitial:(BOOL)a5 shouldLoadScrollableContainer:(BOOL)a6 groupFilter:(int64_t)a7
{
  return -[_UIFocusMovementInfo initWithHeading:velocity:isInitial:shouldLoadScrollableContainer:groupFilter:inputType:](self, "initWithHeading:velocity:isInitial:shouldLoadScrollableContainer:groupFilter:inputType:", a3, a5, a6, a7, 5, a4.dx, a4.dy);
}

- (_UIFocusMovementInfo)initWithHeading:(unint64_t)a3 linearHeading:(unint64_t)a4 isInitial:(BOOL)a5 shouldLoadScrollableContainer:(BOOL)a6 looping:(BOOL)a7 groupFilter:(int64_t)a8
{
  return [(_UIFocusMovementInfo *)self initWithHeading:a3 linearHeading:a4 isInitial:a5 shouldLoadScrollableContainer:a6 looping:a7 groupFilter:a8 inputType:5];
}
...
- (BOOL)_isLinearMovement
{
  return self->_linearHeading || ([(_UIFocusMovementInfo *)self heading] & 0x330) != 0;
}
...
- (_UIFocusMovementInfo)initWithXPCDictionary:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)_UIFocusMovementInfo;
...
- (_UIFocusMovementInfo)initWithCoder:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)_UIFocusMovementInfo;
...
{
  id v5 = a3;
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo heading](self, "heading"), @"FocusMovementHeadingKey");
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo _linearHeading](self, "_linearHeading"), @"FocusMovementLinearHeadingKey");
  ...
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _isVelocityBased](self, "_isVelocityBased"), @"FocusMovementIsVelocityBasedKey");
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _isInitialMovement](self, "_isInitialMovement"), @"FocusMovementIsInitialMovementKey");
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _shouldLoadScrollableContainer](self, "_shouldLoadScrollableContainer"), @"FocusMovementShouldLoadScrollableContainerKey");
  objc_msgSend(v5, "encodeBool:forKey:", -[_UIFocusMovementInfo _isLooping](self, "_isLooping"), @"FocusMovementLoopingKey");
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo _groupFilter](self, "_groupFilter"), @"FocusMovementGroupFilterKey");
  objc_msgSend(v5, "encodeInteger:forKey:", -[_UIFocusMovementInfo _inputType](self, "_inputType"), @"FocusMovementInputTypeKey");
