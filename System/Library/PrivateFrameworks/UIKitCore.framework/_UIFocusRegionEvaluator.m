...
+ (id)subregionFromRegion:(id)a3 withSnapshotFrame:(CGRect)a4 inSnapshot:(id)a5
{
  ...
  else
  {
    ...
    [v18 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 21, @"Invalid parameter not satisfying: %@", @"region" object file lineNumber description];
  ...
  [v19 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 22, @"Invalid parameter not satisfying: %@", @"snapshot" object file lineNumber description];
...
+ (CGRect)frameForRegion:(id)a3 inCoordinateSpace:(id)a4
{
  ...
  if (!v7)
  {
    ...
    [v27 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 31, @"Invalid parameter not satisfying: %@", @"region" object file lineNumber description];
...
LABEL_8:
    ...
    [v28 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 32, @"Invalid parameter not satisfying: %@", @"coordinateSpace" object file lineNumber description];
...
+ (id)_visibleSubregionsWhenRegion:(id)a3 occludedByRegion:(id)a4 inSnapshot:(id)a5
{
  ...
  else
  {
    ...
    [v58 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 49, @"Invalid parameter not satisfying: %@", @"occludedRegion" object file lineNumber description];
  ...
  [v59 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 50, @"Invalid parameter not satisfying: %@", @"occludingRegion" object file lineNumber description];

LABEL_3:
  if (v9 == v10)
  {
    v60 = [MEMORY[0x1E4F28B00] currentHandler];
    [v60 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 51, @"Invalid parameter not satisfying: %@", @"occludedRegion != occludingRegion" object file lineNumber description];
  ...
  [v61 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 52, @"Invalid parameter not satisfying: %@", @"snapshot" object file lineNumber description];
...
LABEL_29:
    v88[0] = v9;
    id v44 = [MEMORY[0x1E4F1C978] arrayWithObjects:v88 count:1];
  }
  else
  {
...
+ (id)__regionsByEvaluatingOcclusionsForBaseRegions:(id)a3 occludingRegions:(id)a4 baseRegionsCanOccludeEachOther:(BOOL)a5 inSnapshot:(id)a6
{
  ...
  if (!v11)
  {
    ...
    v46 = id v45 = v10;
    [v46 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 146, @"Invalid parameter not satisfying: %@", @"occludingRegions" object file lineNumber description];
...
+ (id)regionsByEvaluatingOcclusionsForRegions:(id)a3 inSnapshot:(id)a4
{
  ...
  else
  {
    ...
    [v13 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 213, @"Invalid parameter not satisfying: %@", @"regions" object file lineNumber description];
  ...
  [v14 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 214, @"Invalid parameter not satisfying: %@", @"snapshot" object file lineNumber description];
...
LABEL_8:
    ...
    [v16 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 223, @"Invalid parameter not satisfying: %@", @"occludingRegions" object file lineNumber description];
  ...
  [v15 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 222, @"Invalid parameter not satisfying: %@", @"regions" object file lineNumber description];
...
LABEL_9:
  ...
  [v17 handleFailureInMethod:a2, a1, @"_UIFocusRegionEvaluator.m", 224, @"Invalid parameter not satisfying: %@", @"snapshot" object file lineNumber description];
