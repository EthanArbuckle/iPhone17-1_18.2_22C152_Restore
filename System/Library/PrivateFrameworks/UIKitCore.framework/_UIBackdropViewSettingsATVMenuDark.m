@interface _UIBackdropViewSettingsATVMenuDark
- (void)setDefaultValues;
@end

@implementation _UIBackdropViewSettingsATVMenuDark

- (void)setDefaultValues
{
  v11.receiver = self;
  v11.super_class = (Class)_UIBackdropViewSettingsATVMenuDark;
...
LABEL_7:
      ...
      [(_UIBackdropViewSettings *)self setColorOffsetAlpha:0.02];
    }
    [(_UIBackdropViewSettings *)self setGrayscaleTintLevel:0.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintAlpha:0.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskAlpha:1.0];
