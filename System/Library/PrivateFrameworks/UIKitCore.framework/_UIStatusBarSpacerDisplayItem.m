...
{
  id v4 = a3;
  id v5 = [(_UIStatusBarDisplayItem *)self containerView];

  if (v5 != v4)
  {
    double v6 = [(_UIStatusBarDisplayItem *)self containerView];

    if (v6) {
      [MEMORY[0x1E4F5B268] deactivateConstraints:self->_constraints];
    }
    v7.receiver = self;
