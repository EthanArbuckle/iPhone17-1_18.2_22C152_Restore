...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  UIUserNotificationActionBehavior v7 = [(UIUserNotificationAction *)self behavior];
  v8 = [(UIUserNotificationAction *)self parameters];
  UIUserNotificationActivationMode v9 = [(UIUserNotificationAction *)self activationMode];
  BOOL v10 = [(UIUserNotificationAction *)self isAuthenticationRequired];
