...
- (id)initialState
{
  ...
  v5 = -[UIKeyboardCandidateViewConfiguration candidateFontWithSize:](self, "candidateFontWithSize:");
  v6 = [(UIKeyboardCandidateViewState *)v3 style];
  [v6 setCandidateFont:v5];

  v7 = [(UIKeyboardCandidateViewState *)v3 style];
  v8 = [v7 candidateFont];
  CTFontRef CopyWithSymbolicTraits = CTFontCreateCopyWithSymbolicTraits(v8, 0.0, 0, 2u, 2u);
  ...
  if (v22)
  {
    ...
    v27 = objc_msgSend(v26, "pocketShadowImageForDarkKeyboard:fadesToBottom:drawShadow:topPadding:bottomPadding:height:", -[UIKeyboardCandidateViewConfiguration darkKeyboard](self, "darkKeyboard"), 0, 0, 1.0, 1.0, 42.0);
...
LABEL_19:
    uint64_t v42 = +[UIColor systemBackgroundColor];
    goto LABEL_21;
  }
  ...
  v36 = +[UIColor lineSeparatorColor];
  }
  ...
  v38 = +[UIColor candidateRowBackgroundColor];
  }
  ...
  v40 = +[UIColor candidateRowHighlightedColor];
  }
  ...
  uint64_t v42 = +[UIColor candidateRowHighlightedColor];
LABEL_21:
  v43 = (void *)v42;
  ...
  if (_os_feature_enabled_impl())
  {
    v57 = [off_1E52D39B8 systemFontOfSize:14.0 weight:*(double *)off_1E52D6BD8];
  ...
  else
  {
    ...
    v77 = objc_msgSend(v75, "highlightedBarCellBackgroundImageWithColor:insets:", v76, 3.0, 3.0, 3.0, 3.0);
