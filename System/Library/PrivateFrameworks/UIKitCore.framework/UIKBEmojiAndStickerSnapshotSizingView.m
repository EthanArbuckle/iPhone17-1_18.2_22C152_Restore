@interface UIKBEmojiAndStickerSnapshotSizingView
- (CGSize)intrinsicContentSize;
- (UIKBEmojiAndStickerSnapshotSizingView)initWithSnapshotView:(id)a3;
- (UIView)snapshotView;
@end

@implementation UIKBEmojiAndStickerSnapshotSizingView
...
- (UIKBEmojiAndStickerSnapshotSizingView)initWithSnapshotView:(id)a3
{
  ...
  id v5 = a3;
  v27.receiver = self;
  v27.super_class = (Class)UIKBEmojiAndStickerSnapshotSizingView;
