@interface _UICollectionViewSpringLoadedBehavior
...
- (BOOL)shouldAllowInteraction:(id)a3 withContext:(id)a4
{
  ...
  v8 = objc_msgSend(v6, "_indexPathForItemAtPoint:");
  v9 = [v6 _cellForItemAtIndexPath:v8];
  v10 = v9;
...
LABEL_5:
  ...
  v12 = [v5 targetView];
  if (![v6 _shouldSpringLoadItemAtIndexPath:v8 withContext:v5]) {
    goto LABEL_13;
  }
  v13 = [v5 targetView];
  ...
  if ((v16 & 1) == 0
    || ([v6 _delegateProxy],
        ...
        int v18 = [v17 collectionView:v6 shouldHighlightItemAtIndexPath:v8],
        v17,
        v18))
  {
