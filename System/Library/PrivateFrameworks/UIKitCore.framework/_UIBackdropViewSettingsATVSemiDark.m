@interface _UIBackdropViewSettingsATVSemiDark
- (void)setDefaultValues;
@end

@implementation _UIBackdropViewSettingsATVSemiDark

- (void)setDefaultValues
{
  v9.receiver = self;
  v9.super_class = (Class)_UIBackdropViewSettingsATVSemiDark;
  ...
  if ([(_UIBackdropViewSettings *)self graphicsQuality] == 10 || v3)
  {
    ...
    if (v3)
    {
      v8 = +[UIColor colorWithRed:0.247058824 green:0.266666667 blue:0.274509804 alpha:1.0];
