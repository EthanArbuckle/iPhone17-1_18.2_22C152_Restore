...
void __66___UISelectionFeedbackGeneratorConfiguration_defaultConfiguration__block_invoke(uint64_t a1, void *a2)
{
  ...
  [v2 setFeedback:v5];
  [v2 setHidFeedbackPatternName:0x1ED11BE20];
...
void __65___UISelectionFeedbackGeneratorConfiguration_strongConfiguration__block_invoke(uint64_t a1, void *a2)
{
  ...
  [v2 setFeedback:v5];
  [v2 setHidFeedbackPatternName:0x1ED11BE40];
  [v2 setMinimumInterval:0.04];
}
...
{
  id v2 = a2;
  id v5 = +[_UICustomDiscreteFeedback customDiscreteFeedbackWithEventType:32556 systemSoundID:1157];
  v3 = [v5 hapticParameters];
  LODWORD(v4) = 0.5;
  [v3 setVolume:v4];

  [v5 _setCategory:0x1ED11D520];
  [v2 setFeedback:v5];
