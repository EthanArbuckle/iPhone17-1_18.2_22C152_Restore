...
void __74___UIStatesFeedbackGeneratorSwipeActionConfiguration_defaultConfiguration__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  id v14 = [v2 dictionary];
  v4 = [(id)objc_opt_class() keyFromState:0 toState:@"confirm"];
  ...
  [(_UIFeedbackStateChangeConfiguration *)v5 setHidThresholdFeedbackPatternName:0x1ED0EBDE0];
  [v14 setObject:v5 forKeyedSubscript:v4];

  v9 = [(id)objc_opt_class() keyFromState:@"confirm" toState:0];
  ...
  [(_UIFeedbackStateChangeConfiguration *)v10 setHidThresholdFeedbackPatternName:0x1ED0EBDE0];
