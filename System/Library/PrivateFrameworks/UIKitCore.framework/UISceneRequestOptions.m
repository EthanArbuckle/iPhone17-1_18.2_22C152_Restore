...
+ (id)initialClientSettings:(id)a3 activationOptions:(id)a4 targetSession:(id)a5
{
  ...
  if (os_variant_has_internal_diagnostics())
  {
    ...
    *(_DWORD *)buf = 138412290;
    v20 = v16;
    _os_log_fault_impl(&dword_1853B0000, v15, OS_LOG_TYPE_FAULT, "An error was produced while building scene request options but will be ignored because a deprecated factory method was used. Error: %@", buf, 0xCu);
LABEL_11:
...
LABEL_12:
  ...
  if (v13)
  {
    v17 = *(NSObject **)(__UILogGetCategoryCachedImpl("Assert", &initialClientSettings_activationOptions_targetSession____s_category)+ 8);
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v20 = v16;
      _os_log_impl(&dword_1853B0000, v15, OS_LOG_TYPE_ERROR, "An error was produced while building scene request options but will be ignored because a deprecated factory method was used. Error: %@", buf, 0xCu);
      goto LABEL_11;
    }
  }
LABEL_3:
