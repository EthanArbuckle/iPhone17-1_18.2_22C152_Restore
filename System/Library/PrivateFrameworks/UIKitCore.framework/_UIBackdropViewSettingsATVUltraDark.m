...
@implementation _UIBackdropViewSettingsATVUltraDark

- (void)setDefaultValues
{
  v11.receiver = self;
  v11.super_class = (Class)_UIBackdropViewSettingsATVUltraDark;
  ...
  if ([(_UIBackdropViewSettings *)self graphicsQuality] == 10 || v3)
  {
    ...
    if (v3)
    {
      v9 = +[UIColor colorWithRed:0.168627451 green:0.180392157 blue:0.188235294 alpha:1.0];
...
LABEL_7:
      ...
      [(_UIBackdropViewSettings *)self setColorOffsetAlpha:0.03];
    }
    [(_UIBackdropViewSettings *)self setGrayscaleTintLevel:0.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintAlpha:0.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskAlpha:1.0];
