...
- (id)_emojiDefaultControlKeyActiveBackgroundColorGradient
{
  ...
  int64_t v6 = +[UIKBGradient gradientWithFlatColor:v5];
...
- (id)_emojiCategoryControlKeyActiveTraits
{
  int v3 = +[UIKBRenderTraits emptyTraits];
  v4 = [(UIKBRenderFactory *)self renderConfig];
  int v5 = [v4 whiteText];
  int64_t v6 = UIKBColorWhite_Alpha10;
  if (!v5) {
    int64_t v6 = UIKBColorKeyGrayKeyLightBackground;
  }
  v7 = *v6;

  objc_super v8 = +[UIKBGradient gradientWithFlatColor:v7];
