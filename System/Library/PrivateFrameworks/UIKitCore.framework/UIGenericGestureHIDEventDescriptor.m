@interface UIGenericGestureHIDEventDescriptor
@end
...
id __68___UIGenericGestureHIDEventDescriptor_appendDescriptionToFormatter___block_invoke(uint64_t a1)
{
  ...
  id v9 = (id)[*(id *)(a1 + 32) appendUInt64:*(unsigned __int16 *)(*(void *)(a1 + 40) + 24) withName:@"gestureType"];
  return (id)[*(id *)(a1 + 32) appendUInt64:*(unsigned __int16 *)(*(void *)(a1 + 40) + 32) withName:@"tapCount"];
}
