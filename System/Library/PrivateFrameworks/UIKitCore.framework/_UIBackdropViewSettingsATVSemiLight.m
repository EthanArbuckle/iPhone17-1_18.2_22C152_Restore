@interface _UIBackdropViewSettingsATVSemiLight
- (void)setDefaultValues;
@end

@implementation _UIBackdropViewSettingsATVSemiLight

- (void)setDefaultValues
{
  v9.receiver = self;
  v9.super_class = (Class)_UIBackdropViewSettingsATVSemiLight;
  ...
  if ([(_UIBackdropViewSettings *)self graphicsQuality] == 10 || v3)
  {
    ...
    [(_UIBackdropViewSettings *)self setGrayscaleTintAlpha:0.3];
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskAlpha:1.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskImage:0];
    v6 = +[UIColor colorWithRed:0.882352941 green:0.882352941 blue:0.882352941 alpha:1.0];
  ...
  else if ([(_UIBackdropViewSettings *)self graphicsQuality] == 100)
  {
    ...
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskAlpha:1.0];
    [(_UIBackdropViewSettings *)self setGrayscaleTintMaskImage:0];
    v4 = +[UIColor colorWithRed:0.882352941 green:0.882352941 blue:0.882352941 alpha:1.0];
    [(_UIBackdropViewSettings *)self setColorTint:v4];

    [(_UIBackdropViewSettings *)self setColorTintAlpha:0.4];
    [(_UIBackdropViewSettings *)self setColorTintMaskAlpha:1.0];
    [(_UIBackdropViewSettings *)self setColorTintMaskImage:0];
