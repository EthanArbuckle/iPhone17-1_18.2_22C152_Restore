...
void ___UIConstraintBasedLayoutThrowExceptionOnUnsatisfiableConstraints_block_invoke()
{
  ...
  byte_1EB25A5AF = 0;
  v0 = objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F1CB18], "standardUserDefaults"), "objectForKey:", @"UIConstraintBasedLayoutThrowExceptionOnUnsatisfiableConstraints");
  if (v0)
  {
    int v1 = [v0 BOOLValue];
    byte_1EB25A5AF = v1;
  ...
  else if (!byte_1EB25A5AF)
  {
    return;
  }
  v2 = *(NSObject **)(__UILogGetCategoryCachedImpl("LayoutConstraints", &qword_1EB25A630) + 8);
