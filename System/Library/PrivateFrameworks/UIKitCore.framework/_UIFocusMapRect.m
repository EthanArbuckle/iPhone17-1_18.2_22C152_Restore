...
- (_UIFocusMapRect)initWithFrame:(CGRect)a3 coordinateSpace:(id)a4
{
  ...
  id v9 = a4;
  v13.receiver = self;
  v13.super_class = (Class)_UIFocusMapRect;
...
- (BOOL)intersectsRegion:(id)a3 inSnapshot:(id)a4
{
  ...
  CGFloat v10 = [(_UIFocusMapRect *)self coordinateSpace];
  ...
  BOOL v12 = -[_UIFocusMapRect intersectsRect:](self, "intersectsRect:");
...
LABEL_3:
  ...
  if (!CGRectIsNull(v30))
  {
    ...
    if (fabs(CGRectGetWidth(v31)) >= 0.0001)
    {
      ...
      {
        +[_UIFocusRegionEvaluator subregionFromRegion:withSnapshotFrame:inSnapshot:](_UIFocusRegionEvaluator, "subregionFromRegion:withSnapshotFrame:inSnapshot:", v6, v7, x, y, width, height);
...
- (NSString)description
{
  ...
  v4 = NSStringFromSelector(sel_frame);
  v5 = NSStringFromCGRect(self->_frame);
  id v6 = [(UIDescriptionBuilder *)v3 appendName:v4 object:v5];

  id v7 = NSStringFromSelector(sel_coordinateSpace);
  id WeakRetained = objc_loadWeakRetained((id *)&self->_coordinateSpace);
  id v9 = [(UIDescriptionBuilder *)v3 appendName:v7 object:WeakRetained];

  double v10 = [(UIDescriptionBuilder *)v3 string];
