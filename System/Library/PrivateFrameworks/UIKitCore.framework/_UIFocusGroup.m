...
- (_UIFocusGroup)initWithIdentifier:(id)a3 parentGroup:(id)a4 coordinateSpace:(id)a5
{
  ...
  else
  {
    ...
    [v22 handleFailureInMethod:a2, self, @"_UIFocusGroup.m", 50, @"Invalid parameter not satisfying: %@", @"identifier && identifier.length > 0" object file lineNumber description];
  ...
  [v23 handleFailureInMethod:a2, self, @"_UIFocusGroup.m", 51, @"Invalid parameter not satisfying: %@", @"coordinateSpace" object file lineNumber description];
...
LABEL_4:
  ...
  if (v12)
  {
    ...
    *(_OWORD *)(v12 + 104) = *MEMORY[0x1E4F1DB20];
    *(_OWORD *)(v12 + 120) = v20;
    *(_OWORD *)(v12 + 72) = v19;
    *(_OWORD *)(v12 + 88) = v20;
...
- (void)_updateWithEnvironment:(id)a3
{
  ...
  uint64_t v6 = _UIFocusItemSafeCast(v5);
  id v7 = v6;
  if (v6)
  {
...
- (void)_invalidateItemOrder
{
  *(unsigned char *)&self->_flags &= ~1u;
  [(_UIFocusGroup *)self _invalidatePrimaryItem];
}
...
- (void)_validateItemOrderIfNecessary
{
  if ((*(unsigned char *)&self->_flags & 1) == 0)
  {
    *(unsigned char *)&self->_flags |= 1u;
    ...
    {
      items = self->_items;
      [(NSMutableArray *)items sortUsingComparator:&__block_literal_global_375];
    }
  }
}
...
- (void)_invalidateChildGroupOrder
{
  *(unsigned char *)&self->_flags &= ~2u;
  [(_UIFocusGroup *)self _invalidatePrimaryRect];
}
  ...
  if ((*(unsigned char *)&self->_flags & 4) == 0)
  {
    *(unsigned char *)&self->_flags |= 4u;
    if ([(NSMutableArray *)self->_items count])
    {
      ...
      id v7 = [(_UIFocusGroup *)self identifier];
      ...
      long long v25 = 0u;
      v23 = self;
      CGFloat v9 = [(_UIFocusGroup *)self items];
      ...
      if (v10)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v11; ++i)
          {
            ...
            uint64_t v17 = _UIFocusGroupPriorityForItem(v16, v5, v8);
            if (v17 > v13)
            {
              uint64_t v18 = v17;
              id v19 = v16;
...
- (void)_validatePrimaryRectIfNeccessary
{
  ...
  *(unsigned char *)&self->_flags |= 8u;
  ...
  self->_primaryRect.CGPoint origin = (CGPoint)*MEMORY[0x1E4F1DB20];
  ...
  uint64_t v29 = v4;
  id v5 = [(_UIFocusGroup *)self coordinateSpace];
  double v6 = _UIFocusItemFrameInCoordinateSpace(v29, v5);
  CGFloat v8 = v7;
  CGFloat v10 = v9;
  CGFloat v12 = v11;
...
LABEL_8:
    ...
    if (v13)
    {
      uint64_t v14 = [(_UIFocusGroup *)self coordinateSpace];
      [v13 primaryRect];
      double v16 = v15;
      double v18 = v17;
      double v20 = v19;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == v4) {
    ...
    BOOL v6 = v4
      ...
      && [(_UIFocusGroup *)self isEqualToFocusGroup:v5];
...
- (id)description
{
  ...
  id v5 = NSStringFromCGRect(self->_boundingBox);
  BOOL v6 = NSStringFromCGRect(self->_primaryRect);
...
- (id)debugDescription
{
  ...
  identifier = self->_identifier;
  double v7 = NSStringFromCGRect(self->_boundingBox);
  CGFloat v8 = NSStringFromCGRect(self->_primaryRect);
...
- (_UIFocusGroup)parentGroup
{
  ...
  return (_UIFocusGroup *)WeakRetained;
}
