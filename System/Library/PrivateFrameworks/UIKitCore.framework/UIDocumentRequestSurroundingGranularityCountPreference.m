@interface UIDocumentRequestSurroundingGranularityCountPreference
@end
...
void ___UIDocumentRequestSurroundingGranularityCountPreference_block_invoke()
{
  ...
  v0 = TIGetDocumentRequestSurroundingGranularityCountValue();
  objc_opt_class();
...
LABEL_2:
  ...
  qword_1EB261D38 = [v0 integerValue];
  v1 = _UIKeyboardLog();
