...
- (id)titleForRow:(int64_t)a3 inComponent:(int64_t)a4
{
  if ([(_UIDatePickerMode *)self calendarUnitForComponent:a4] == 4
    && [(_UIDatePickerMode *)self yearsSinceBaseDate] < a3)
  {
    v7 = @"----";
  }
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)_UIDatePickerMode_DateWithOptionalYear;
...
- (int64_t)yearForRow:(int64_t)a3
{
  ...
  {
    v7.receiver = self;
    v7.super_class = (Class)_UIDatePickerMode_DateWithOptionalYear;
    return [(_UIDatePickerMode *)&v7 yearForRow:a3];
  }
  else
  {
    int64_t v5 = [(_UIDatePickerMode *)self monthForRow:a3];
...
LABEL_6:
    ...
    id v15 = [(_UIDatePickerMode_Date *)&v17 rowForDate:v10 dateComponents:v11 component:a5 currentRow:a6];
    goto LABEL_7;
  }
  id v15 = (id)([(_UIDatePickerMode *)self yearsSinceBaseDate] + 1);
...
- (void)_updateSelectedDateComponentsWithNewValueInComponent:(int64_t)a3 usingSelectionBarValue:(BOOL)a4
{
  ...
  if (self->super.super._selectedDateComponents
    && (a3 == 0x7FFFFFFFFFFFFFFFLL
     || [(_UIDatePickerMode *)self calendarUnitForComponent:a3] == 4))
  {
    v6 = [(_UIDatePickerMode *)self datePickerView];
    uint64_t v7 = objc_msgSend(v6, "selectedRowInComponent:", -[_UIDatePickerMode componentForCalendarUnit:](self, "componentForCalendarUnit:", 4));
