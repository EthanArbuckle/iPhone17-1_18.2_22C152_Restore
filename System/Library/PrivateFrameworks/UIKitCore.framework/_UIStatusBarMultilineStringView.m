...
- (_UIStatusBarMultilineStringView)initWithFrame:(CGRect)a3
{
  ...
  [(UIView *)v3 bounds];
  uint64_t v5 = -[UIStackView initWithFrame:](v4, "initWithFrame:");
  ...
  [MEMORY[0x1E4F5B268] activateConstraints:v7];
  return v3;
}
...
- (void)applyStyleAttributes:(id)a3
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  uint64_t v5 = [(_UIStatusBarMultilineStringView *)self stringViews];
