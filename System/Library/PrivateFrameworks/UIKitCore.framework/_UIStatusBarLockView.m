...
{
  id v12 = a3;
  v4 = [(UIImageView *)self->_shackleView image];
  ...
  [(_UIStatusBarImageView *)self->_shackleView applyStyleAttributes:v12];
  v8 = [(UIImageView *)self->_bodyView image];

  if (!v8)
  {
    objc_super v9 = +[_UIStatusBarImageProvider sharedProvider];
    v10 = [v9 imageNamed:@"LockBody" styleAttributes:v12];
    v11 = [v10 imageWithRenderingMode:2];

    [(UIImageView *)self->_bodyView setImage:v11];
  }
  [(_UIStatusBarImageView *)self->_bodyView applyStyleAttributes:v12];
}
...
- (void)resetLock
{
  v3 = [(UIView *)self->_shackleView layer];
...
- (void)animateUnlockWithCompletionBlock:(id)a3
{
  ...
  else
  {
    ...
    [v7 setDelegate:self];
    -[UIImageView setFrame:](self->_shackleView, "setFrame:", 1.0, 0.0, 6.0, 7.0);
    v17 = [(UIView *)self->_shackleView layer];
...
- (void)jiggleWithCompletionBlock:(id)a3
{
  ...
  else
  {
    ...
    [(_UIStatusBarLockView *)self setCompletionBlock:v4];
    v29 = [(UIView *)self layer];
