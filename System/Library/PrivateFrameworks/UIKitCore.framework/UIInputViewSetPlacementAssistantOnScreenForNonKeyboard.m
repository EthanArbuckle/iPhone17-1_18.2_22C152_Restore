...
- (id)horizontalConstraintForInputViewSet:(id)a3 hostView:(id)a4 containerView:(id)a5
{
  if (a4)
  {
    v6 = [MEMORY[0x1E4F5B268] constraintWithItem:a4 attribute:1 relatedBy:0 toItem:a5 attribute:1 multiplier:1.0 constant:0.0];
  }
  else
  {
    v6 = 0;
...
LABEL_10:
    ...
    int v19 = [v18 isDescendantOfView:v10];
...
- (id)widthConstraintForInputViewSet:(id)a3 hostView:(id)a4 containerView:(id)a5
{
  if (a4)
  {
    v6 = [MEMORY[0x1E4F5B268] constraintWithItem:a4 attribute:7 relatedBy:0 toItem:a5 attribute:7 multiplier:1.0 constant:0.0];
  }
  else
  {
    v6 = 0;
