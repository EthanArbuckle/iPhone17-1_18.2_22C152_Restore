...
+ (id)objectOfClass:(Class)a3 forScreen:(id)a4 withOptions:(id)a5 createIfNecessary:(BOOL)a6
{
  ...
  block[4] = v11;
  if (qword_1EB264C08 != -1) {
    dispatch_once(&qword_1EB264C08, block);
  }
  long long v29 = 0u;
  long long v30 = 0u;
  long long v27 = 0u;
  long long v28 = 0u;
  id v12 = (id)_MergedGlobals_1296;
...
LABEL_18:
  ...
  if (!v13 && v26)
  {
    ...
    if (v20)
    {
      ...
      if ([(id)qword_1EB264C10 containsObject:v24])
      {
        id v13 = 0;
      }
      else
      {
        [(id)qword_1EB264C10 addObject:v24];
        id v13 = (id)[[a3 alloc] _initWithScreen:v9 options:v10];
        [(id)_MergedGlobals_1296 addObject:v13];
        [(id)qword_1EB264C10 removeObject:v24];
      }
    }
    else
    {
...
+ (void)screenDisconnected:(id)a3
{
  ...
  if (v9)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        id v13 = objc_msgSend(v12, "_intendedScreen", (void)v15);
        BOOL v14 = v13 == v5;
  ...
  [(id)_MergedGlobals_1296 removeObjectsInArray:v6];
  objc_sync_exit(v7);
}
...
+ (void)removeObjectsOfClass:(Class)a3
{
  ...
  [(id)_MergedGlobals_1296 removeObjectsInArray:v4];
  objc_sync_exit(v5);
}
...
+ (void)removeObject:(id)a3
{
  ...
  id v4 = a1;
  objc_sync_enter(v4);
  [(id)_MergedGlobals_1296 removeObject:v5];
  objc_sync_exit(v4);
}
