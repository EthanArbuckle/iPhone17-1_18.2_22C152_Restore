...
- (BOOL)cacheMatchesCapacity:(double)a3 fillColor:(id)a4 tintColor:(id)a5 showingBolt:(BOOL)a6 reverseLayout:(BOOL)a7 scale:(double)a8 showsPercentage:(BOOL)a9 contentSizeCategory:(id)a10
{
  ...
  if (v21 == a3)
  {
    v22 = [(_UIBatteryViewAXHUDImageCacheInfo *)self fillColor];
    if ([v22 isEqual:v18])
    {
      v23 = [(_UIBatteryViewAXHUDImageCacheInfo *)self tintColor];
      if ([v23 isEqual:v19]
        && [(_UIBatteryViewAXHUDImageCacheInfo *)self showBolt] == v14
        && [(_UIBatteryViewAXHUDImageCacheInfo *)self reverseLayoutDirection] == v13
        && ([(_UIBatteryViewAXHUDImageCacheInfo *)self scale], v24 == a8)
        && [(_UIBatteryViewAXHUDImageCacheInfo *)self showsPercentage] == v11)
      {
        v27 = [(_UIBatteryViewAXHUDImageCacheInfo *)self contentSizeCategory];
