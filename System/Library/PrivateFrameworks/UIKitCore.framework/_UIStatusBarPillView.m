...
- (_UIStatusBarPillView)initWithFrame:(CGRect)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)_UIStatusBarPillView;
  v3 = -[_UIStatusBarRoundedCornerView initWithFrame:](&v12, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  ...
  id v8 = +[UIColor colorWithWhite:0.0980392157 alpha:0.18];
...
{
  v14.receiver = self;
  v14.super_class = (Class)_UIStatusBarPillView;
  ...
  if (visualEffectView) {
    -[UIView setFrame:](visualEffectView, "setFrame:", v5, v7, v9, v11);
  }
}
...
- (void)setVisualEffect:(id)a3
{
  ...
  if (self->_visualEffect != v5)
  {
    ...
    [(UIView *)self->_visualEffectView setHidden:v5 == 0];
  }
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)_UIStatusBarPillView;
...
- (void)_updateBackgroundColor
{
  ...
  if ([v3 userInterfaceIdiom] == 3)
  {
    ...
    if (v4)
    {
      uint64_t v5 = +[UIColor _carSystemFocusColor];
      goto LABEL_6;
    }
  }
  else
  ...
  uint64_t v5 = [(_UIStatusBarPillView *)self pillColor];
LABEL_6:
  id v6 = (id)v5;
