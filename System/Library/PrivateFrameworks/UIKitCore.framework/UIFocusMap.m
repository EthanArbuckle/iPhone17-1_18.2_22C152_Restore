...
void __54___UIFocusMap__inferredDefaultFocusItemInEnvironment___block_invoke(void *a1, void *a2, unsigned char *a3)
{
  v5 = (void *)a1[4];
  id v6 = a2;
  [v5 addObject:v6];
...
uint64_t __103___UIFocusMap__nextFocusedItemForLinearFocusMovementRequest_startingFromRegion_inRegions_withSnapshot___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v4 = a2;
  v5 = [v3 searchInfo];
  uint64_t IsFocusableInFocusSystemWithSearchInfo = _UIFocusItemIsFocusableInFocusSystemWithSearchInfo(v4, v2, v5);
...
uint64_t __76___UIFocusMap__linearlySortedFocusItemsForItems_groupFilter_itemStandInMap___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
