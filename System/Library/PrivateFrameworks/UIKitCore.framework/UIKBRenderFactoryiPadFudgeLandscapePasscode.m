...
@implementation UIKBRenderFactoryiPadFudgeLandscapePasscode
...
{
  v12.receiver = self;
  v12.super_class = (Class)UIKBRenderFactoryiPadFudgeLandscapePasscode;
  id v6 = a4;
  id v7 = a3;
  ...
  if (v9)
  {
    v10 = [(UIKBRenderFactoryiPadFudgeLandscapePasscode *)self activeControlKeyTraits];
