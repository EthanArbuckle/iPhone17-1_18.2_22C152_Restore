...
- (UIDebuggingIvarTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v6 = objc_opt_new();
    v7 = objc_opt_new();
    v8 = [off_1E52D39B8 systemFontOfSize:12.0];
    [v5 setFont:v8];

    v9 = [off_1E52D39B8 fontWithName:@"Menlo" size:9.0];
    [v6 setFont:v9];

    v10 = [off_1E52D39B8 fontWithName:@"Menlo" size:12.0];
    [v7 setFont:v10];
...
- (void)_prepareConstraints
{
  ...
  objc_super v3 = [(UITableViewCell *)self contentView];
  ...
  [v56 addObject:v46];
  [v56 addObject:v45];
  [MEMORY[0x1E4F5B268] activateConstraints:v56];
}
...
- (void)setIvar:(id)a3
{
  ...
  {
    v10 = [v13 value];
    uint64_t v11 = [NSString stringWithFormat:@"%p\n%@", v10, objc_opt_class()];
