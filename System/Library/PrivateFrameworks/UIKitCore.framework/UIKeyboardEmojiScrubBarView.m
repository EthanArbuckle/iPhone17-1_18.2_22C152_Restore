...
- (void)didMoveToWindow
{
  ...
  if (!self || !self->_isFirstPartyStickers)
  {
    if ([v4 lightKeyboard])
    {
      v6 = [MEMORY[0x1E4F39BC0] filterWithType:*MEMORY[0x1E4F3A008]];
...
LABEL_12:
      ...
      uint64_t v13 = +[UIColor colorWithRed:0.435294118 green:0.4 blue:0.368627451 alpha:1.0];
    }
    else
    {
      v11 = [MEMORY[0x1E4F39BC0] filterWithType:*MEMORY[0x1E4F3A2C8]];
