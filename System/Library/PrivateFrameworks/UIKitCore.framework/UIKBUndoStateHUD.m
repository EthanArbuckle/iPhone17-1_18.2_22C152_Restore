...
- (UIKBUndoStateHUD)initWithKeyboardAppearance:(int64_t)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v135 = *(void *)off_1E52D2040;
    v9 = [(UIKBUndoStyling *)v5->_style undoStateControlLabelFont];
    v136[0] = v9;
    v10 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v136 forKeys:&v135 count:1];
    ...
    uint64_t v41 = [v39 constraintEqualToAnchor:v40 constant:0.0];
    ...
    v134 = v45;
    v46 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v134 count:1];
    ...
    id v50 = [(UIKBUndoStyling *)v5->_style HUDShadowColor];
    ...
    [(UILabel *)v5->_labelView setText:&stru_1ED0E84C0];
...
- (void)updateUndoStateHUDControlType:(int64_t)a3 available:(BOOL)a4
{
  ...
  v10 = [(UIKBUndoStyling *)style buttonGlyphColorDisabled];
  }
  ...
  double v12 = [(UIKBUndoStyling *)self->_style undoStateControlUnavailableLabelFont];
  }
  double v13 = [(UIKBUndoStateHUD *)self labelView];
  [v13 setFont:v12];
