...
- (UIAutocorrectBubble)init
{
  ...
  if (v2)
  {
    ...
    v42 = objc_msgSend(v43, "resizableImageWithCapInsets:", 0.0, 5.0, 0.0, 30.0);
    ...
    [(UILabel *)v2->_textLabel setText:&stru_1ED0E84C0];
    v7 = v2->_textLabel;
    v8 = [off_1E52D39B8 systemFontOfSize:16.0 weight:*(double *)off_1E52D6BF8];
    ...
    v47[8] = v18;
    v19 = [MEMORY[0x1E4F1C978] arrayWithObjects:v47 count:9];
...
- (id)lastBaselineAnchor
{
  double v2 = [(UIAutocorrectBubble *)self textLabel];
