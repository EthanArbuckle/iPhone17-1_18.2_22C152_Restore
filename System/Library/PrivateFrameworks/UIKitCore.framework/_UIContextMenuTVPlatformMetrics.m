...
- (_UIContextMenuTVPlatformMetrics)init
{
  ...
  if (v2)
  {
    ...
    v4 = +[UIColor colorWithDynamicProvider:&__block_literal_global_245];
    [(_UIContextMenuPlatformMetrics *)v2 setSectionSeparatorColor:v4];

    [(_UIContextMenuPlatformMetrics *)v2 setItemPrimaryCompositingFilterProvider:&__block_literal_global_4_9];
    ...
    v6 = [off_1E52D39B8 preferredFontForTextStyle:@"UICTFontTextStyleCaption1"];
    [(_UIContextMenuPlatformMetrics *)v2 setTitleFont:v6];

    v7 = [off_1E52D39B8 preferredFontForTextStyle:@"UICTFontTextStyleEmphasizedCaption2"];
    [(_UIContextMenuPlatformMetrics *)v2 setTitleEmphasizedFont:v7];

    v8 = [off_1E52D39B8 preferredFontForTextStyle:@"UICTFontTextStyleCaption2"];
    [(_UIContextMenuPlatformMetrics *)v2 setSubtitleFont:v8];

    v9 = [off_1E52D39B8 preferredFontForTextStyle:@"UICTFontTextStyleCaption1"];
    [(_UIContextMenuPlatformMetrics *)v2 setIconSymbolFont:v9];

    v10 = [off_1E52D39B8 preferredFontForTextStyle:@"UICTFontTextStyleEmphasizedCaption2"];
    [(_UIContextMenuPlatformMetrics *)v2 setIconEmphasizedSymbolFont:v10];

    [(_UIContextMenuPlatformMetrics *)v2 setItemBackgroundColorProvider:&__block_literal_global_8_6];
    [(_UIContextMenuPlatformMetrics *)v2 setItemPrimaryColorProvider:&__block_literal_global_13];
    [(_UIContextMenuPlatformMetrics *)v2 setItemPrimaryDestructiveColorProvider:&__block_literal_global_17_1];
    ...
    v15 = [off_1E52D39B8 preferredFontForTextStyle:@"UICTFontTextStyleCaption2"];
    [(_UIContextMenuPlatformMetrics *)v2 setHeaderFont:v15];

    v16 = +[UIColor colorWithDynamicProvider:&__block_literal_global_20_2];
    ...
    [(_UIContextMenuPlatformMetrics *)v2 setShouldApplyShadowHandler:&__block_literal_global_29_1];
    ...
    [(_UIContextMenuPlatformMetrics *)v2 setContentSpacingForContainer:&__block_literal_global_40_1];
    ...
    [(_UIContextMenuPlatformMetrics *)v2 setPrefersWrapToSidesHandler:&__block_literal_global_46_0];
