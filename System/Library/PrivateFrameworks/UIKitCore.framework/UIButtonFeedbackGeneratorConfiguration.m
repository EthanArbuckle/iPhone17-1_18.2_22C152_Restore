...
{
  uint64_t v2 = _UISystemSoundIDNone;
  id v3 = a2;
  ...
  id v9 = +[_UICustomDiscreteFeedback customDiscreteFeedbackWithEventType:29526 systemSoundID:_UISystemSoundIDNone];
...
void __65___UIButtonFeedbackGeneratorConfiguration_prominentConfiguration__block_invoke(uint64_t a1, void *a2)
{
  ...
  [v3 setInteractionStartedFeedback:v4];
  id v9 = +[_UICustomDiscreteFeedback customDiscreteFeedbackWithEventType:23382 systemSoundID:_UISystemSoundIDNone];
  v7 = [v9 hapticParameters];
