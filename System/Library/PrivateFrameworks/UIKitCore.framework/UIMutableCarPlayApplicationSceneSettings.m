...
{
  id v3 = [(FBSSettings *)self otherSettings];
  [v3 setFlag:BSSettingFlagForBool() forSetting:46];
}
...
- (id)keyDescriptionForSetting:(unint64_t)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)UIMutableCarPlayApplicationSceneSettings;
    if ([(UIMutableCarPlayApplicationSceneSettings *)&v10 respondsToSelector:a2])
    {
      v9.receiver = self;
      v9.super_class = (Class)UIMutableCarPlayApplicationSceneSettings;
...
- (id)valueDescriptionForFlag:(int64_t)a3 object:(id)a4 ofSetting:(unint64_t)a5
{
  ...
  {
    v13.receiver = self;
    v13.super_class = (Class)UIMutableCarPlayApplicationSceneSettings;
    if ([(UIMutableCarPlayApplicationSceneSettings *)&v13 respondsToSelector:a2])
    {
      v12.receiver = self;
      v12.super_class = (Class)UIMutableCarPlayApplicationSceneSettings;
      objc_super v10 = [(UIMutableApplicationSceneSettings *)&v12 valueDescriptionForFlag:a3 object:v9 ofSetting:a5];
    }
    else
    {
      objc_super v10 = 0;
