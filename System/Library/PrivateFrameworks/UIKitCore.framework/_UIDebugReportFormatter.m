...
- (_UIDebugReportFormatter)init
{
  ...
  id v2 = [(_UIDebugReportFormatter *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (id)stringFromReportComponents:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v18 handleFailureInMethod:a2, self, @"_UIDebugReport.m", 29, @"Invalid parameter not satisfying: %@", @"components" object file lineNumber description];
  }
  objc_super v6 = [MEMORY[0x1E4F28E78] string];
  v7 = [v5 header];
  if (([v7 isEqualToString:&stru_1ED0E84C0] & 1) == 0) {
    [v6 appendFormat:@"%@\n", v7];
  }
  v8 = [v5 body];
  if (([v8 isEqualToString:&stru_1ED0E84C0] & 1) == 0)
  {
  ...
  v13 = [v5 footer];
  if (([v13 isEqualToString:&stru_1ED0E84C0] & 1) == 0) {
    [v6 appendFormat:@"\n%@", v13];
  }
