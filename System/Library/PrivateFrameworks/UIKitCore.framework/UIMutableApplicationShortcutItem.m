...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v10 = [(UIApplicationShortcutItem *)self activationMode];
  v11 = [(UIApplicationShortcutItem *)self targetContentIdentifier];
  id v12 = [(UIApplicationShortcutItem *)v4 _initWithType:v5 localizedTitle:v6 localizedSubtitle:v7 icon:v8 userInfoData:v9 activationMode:v10 targetContentIdentifier:v11];
