...
- (void)drawRect:(CGRect)a3
{
  if (self->_showsLevelGutters)
  {
    ...
    {
      CGFloat v6 = [(MTNowPlayingIndicatorView *)self tintColor];
      v11 = [v6 colorWithAlphaComponent:0.2];
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  {
    p_maximumLevelHeight = (double *)(MEMORY[0x1E4F1DB30] + 8);
  ...
  if (v4)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        CGFloat v8 = *(void **)(*((void *)&v10 + 1) + 8 * i);
        CGFloat v9 = [(MTNowPlayingIndicatorView *)self tintColor];
...
- (void)setLevelGuttersColor:(id)a3
{
  ...
  if (self->_levelGuttersColor != v5)
  {
    ...
    p_levelGuttersColor = (UIColor **)[(MTNowPlayingIndicatorView *)self setNeedsDisplay];
    uint64_t v5 = v7;
  }
...
- (void)_reloadLevelViews
{
  ...
  else
  {
    ...
    do
    {
      ...
      {
        uint64_t v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v4, v5, v6, v7);
        CGFloat v9 = [v8 layer];
        [v9 setCornerRadius:self->_levelCornerRadius];
        objc_msgSend(v9, "setAnchorPoint:", 0.5, 1.0);
        long long v10 = [(MTNowPlayingIndicatorView *)self tintColor];
        [v8 setBackgroundColor:v10];

        levelViews = self->_levelViews;
        if (!levelViews)
        {
          long long v12 = (NSMutableArray *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:self->_numberOfLevels];
          long long v13 = self->_levelViews;
  ...
  {
    objc_super v14 = [(NSMutableArray *)self->_levelViews objectAtIndex:v3];
...
LABEL_3:
    ...
    while (2)
    {
      ...
      double v7 = *(void **)(*((void *)&v64 + 1) + 8 * v6);
      [v7 setAlpha:1.0];
      uint64_t v8 = [v7 layer];
      switch(self->_playbackState)
      {
        case 0:
          CGFloat v9 = [MEMORY[0x1E4F39B48] animationWithKeyPath:@"bounds.size.height"];
          [v9 setDuration:0.45];
          long long v10 = [MEMORY[0x1E4F39C10] functionWithName:v60];
          [v9 setTimingFunction:v10];

          [v9 setRemovedOnCompletion:0];
          [v9 setFillMode:v61];
          long long v11 = *(void **)(v5 + 3792);
          long long v12 = [v8 presentationLayer];
          long long v13 = v12;
          if (!v12) {
            long long v12 = v8;
          }
          [v12 bounds];
          objc_super v14 = [v11 numberWithDouble:CGRectGetHeight(v74)];
          [v9 setFromValue:v14];

          [v9 setToValue:&unk_1F3F6F9B8];
          goto LABEL_19;
        case 1:
          CGFloat v9 = [MEMORY[0x1E4F39BD8] animationWithKeyPath:@"bounds.size.height"];
          uint64_t v15 = [MEMORY[0x1E4F39C10] functionWithName:v60];
          [v9 setTimingFunction:v15];

          [v9 setRemovedOnCompletion:0];
          [v9 setFillMode:v61];
          [(MTNowPlayingIndicatorView *)self _seedValueForBarIndex:v4 + v6];
          ...
          double v19 = [*(id *)(v5 + 3792) numberWithDouble:self->_minimumLevelHeight];
          v68[0] = v19;
          long long v20 = [*(id *)(v5 + 3792) numberWithDouble:v18];
          v68[1] = v20;
          long long v21 = [*(id *)(v5 + 3792) numberWithDouble:self->_minimumLevelHeight];
          v68[2] = v21;
          long long v22 = [MEMORY[0x1E4F1C978] arrayWithObjects:v68 count:3];
          [v9 setValues:v22];
...
LABEL_13:
            CGFloat v9 = [MEMORY[0x1E4F39B48] animationWithKeyPath:@"bounds.size.height"];
            [v9 setDuration:0.45];
            objc_super v24 = [MEMORY[0x1E4F39C10] functionWithName:v60];
            ...
            if (v59)
            {
              uint64_t v26 = [*(id *)(v5 + 3792) numberWithDouble:self->_minimumLevelHeight];
              [v9 setFromValue:v26];
            }
            else
            {
              CGRect v27 = [v8 presentationLayer];
              v28 = v27;
              if (!v27) {
                CGRect v27 = v8;
              }
...
LABEL_19:
          ...
          else
          {
            ...
            [v39 setFillMode:v61];
            [v39 setValues:&unk_1F3F6F948];
            [v39 setKeyTimes:&unk_1F3F6F960];
