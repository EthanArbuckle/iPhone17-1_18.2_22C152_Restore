...
- (id)sizerForComponent:(id)a3 componentLayout:(id)a4 layoutOptions:(id)a5 DOMObjectProvider:(id)a6
{
  ...
  v14 = [[SXArticleLinkComponentSizer alloc] initWithComponent:v12 componentLayout:v11 componentStyle:v13 DOMObjectProvider:v9 layoutOptions:v10];
