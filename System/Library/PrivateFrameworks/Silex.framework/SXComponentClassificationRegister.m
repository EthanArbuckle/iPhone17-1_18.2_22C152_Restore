...
+ (void)registerClasses
{
  id v2 = [a1 classifications];
  [v2 enumerateObjectsUsingBlock:&__block_literal_global_71];
}

uint64_t __52__SXComponentClassificationRegister_registerClasses__block_invoke(uint64_t a1, void *a2)
{
  return [a2 registerClassification];
}

+ (id)classifications
{
  v4[61] = *MEMORY[0x263EF8340];
  v4[0] = objc_opt_class();
  v4[1] = objc_opt_class();
  v4[2] = objc_opt_class();
  v4[3] = objc_opt_class();
  ...
  id v2 = [MEMORY[0x263EFF8C0] arrayWithObjects:v4 count:61];
  return v2;
}
