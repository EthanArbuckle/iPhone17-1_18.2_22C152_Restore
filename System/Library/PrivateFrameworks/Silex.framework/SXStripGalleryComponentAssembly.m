@interface SXStripGalleryComponentAssembly
...
- (void)loadInRegistry:(id)a3
{
  ...
  [v4 whenResolvingProtocol:&unk_26D5ED4C8 scope:v5 callbackBlock:&__block_literal_global_55];

  v6 = [v3 callback];
  v7 = TFCallbackScopeAny();
  [v6 whenResolvingProtocol:&unk_26D61EA90 scope:v7 callbackBlock:&__block_literal_global_55_11];

  v8 = [v3 publicContainer];
  id v9 = (id)[v8 registerClass:objc_opt_class() factory:&__block_literal_global_59_9];

  id v11 = [v3 publicContainer];

  id v10 = (id)[v11 registerClass:objc_opt_class() factory:&__block_literal_global_126_1];
}
...
SXStripGalleryComponentViewFactory *__50__SXStripGalleryComponentAssembly_loadInRegistry___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v12 = [(SXStripGalleryComponentViewFactory *)v14 initWithDOMObjectProvider:v3 viewport:v4 presentationDelegateProvider:v5 componentStyleRendererFactory:v6 analyticsReportingProvider:v7 appStateMonitor:v8 mediaSharingPolicyProvider:v9 imageViewFactory:v10 canvasControllerFactory:v11];
  return v12;
}

SXStripGalleryComponentSizerFactory *__50__SXStripGalleryComponentAssembly_loadInRegistry___block_invoke_4()
{
  v0 = objc_alloc_init(SXStripGalleryComponentSizerFactory);
  return v0;
}
