      ...
      if (v12)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v14; ++i)
          {
            ...
            uint64_t v18 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self columnRangeForItem:v17];
            uint64_t v20 = v19;
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        uint64_t v11 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self columnRangeForItem:*(void *)(*((void *)&v35 + 1) + 8 * i)];
        uint64_t v13 = v12;
        uint64_t v14 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self columnRangeForLargeItem];
        if (v13 == v15 && v11 == v14) {
          double v9 = 0.0;
        }
...
- (_NSRange)columnRangeForItem:(id)a3
{
  ...
  if (!(v10 | v12))
  {
    if (v7 == [(SXMosaicGalleryHorizontalLivingRoomLayout *)self indexOfLargeItem]) {
      uint64_t v13 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self columnRangeForLargeItem];
    }
    else {
      uint64_t v13 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self columnRangeForSmallerItems];
    }
    uint64_t v10 = v13;
    NSUInteger v12 = v14;
...
- (_NSRange)columnRangeForLargeItem
{
  unint64_t v3 = [(SXMosaicGalleryGroupLayout *)self numberOfColumns] - 1;
  NSUInteger v4 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self reverseLayout];
  NSUInteger v5 = v3;
  result.length = v5;
  result.location = v4;
  return result;
...
- (double)desiredHeightForLargeItem
{
  unint64_t v3 = [(SXMosaicGalleryGroupLayout *)self cluster];
  NSUInteger v4 = [v3 items];
  NSUInteger v5 = objc_msgSend(v4, "objectAtIndex:", -[SXMosaicGalleryHorizontalLivingRoomLayout indexOfLargeItem](self, "indexOfLargeItem"));
...
- (double)desiredHeightForSmallerItems
{
  ...
  uint64_t v3 = [(SXMosaicGalleryHorizontalLivingRoomLayout *)self reverseLayout] ^ 1;
