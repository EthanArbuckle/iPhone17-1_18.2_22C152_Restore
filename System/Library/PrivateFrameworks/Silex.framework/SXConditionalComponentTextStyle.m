...
+ (id)valueClassBlockForPropertyWithName:(id)a3
{
  ...
  {
    v7.receiver = a1;
    v7.super_class = (Class)&OBJC_METACLASS___SXConditionalComponentTextStyle;
...
uint64_t __70__SXConditionalComponentTextStyle_valueClassBlockForPropertyWithName___block_invoke()
{
