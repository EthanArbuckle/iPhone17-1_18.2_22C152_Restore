...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v6 = [objc_alloc((Class)NSData) initWithBytes:self->_anon_20 length:48];
  [v5 encodeObject:v6 forKey:@"ColorIntrinsics"];
  id v7 = [objc_alloc((Class)NSData) initWithBytes:self->_anon_50 length:48];

  [v5 encodeObject:v7 forKey:@"DepthIntrinsics"];
  [v5 encodeObject:self->_distortionLookupTable forKey:@"DistortionLUT"];
  id v8 = [objc_alloc((Class)NSData) initWithBytes:&self->_referenceDimensions length:16];

  [v5 encodeObject:v8 forKey:@"RefDimensions"];
  id v10 = [objc_alloc((Class)NSData) initWithBytes:&self->_distortionCenter length:16];
