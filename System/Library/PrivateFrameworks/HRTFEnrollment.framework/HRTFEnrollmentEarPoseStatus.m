...
- (HRTFEnrollmentEarPoseStatus)initWithLeftYawPose:(id)a3 rightYawPose:(id)a4 leftpitchPose:(id)a5 rightpitchPose:(id)a6 earSide:(unint64_t)a7 yawAngle:(double)a8 pitchAngle:(double)a9 earBoundingBox:(CGRect)a10 earCaptureStatus:(int)a11
{
  ...
  if (v27)
  {
    ...
    uint64_t v31 = [(HRTFEnrollmentPoseStatus *)v28 initWithYawPose:v23 pitchPose:v25 isEarTracking:a11 == 0 yawAngle:v29 pitchAngle:v30];
    ...
    uint64_t v36 = [(HRTFEnrollmentPoseStatus *)v33 initWithYawPose:v24 pitchPose:v26 isEarTracking:a11 == 0 yawAngle:v34 pitchAngle:v35];
