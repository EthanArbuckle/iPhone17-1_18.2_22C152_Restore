...
@implementation TVRMSTouchMessage
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)TVRMSTouchMessage;
  v4 = [(TVRMSTouchMessage *)&v8 description];
  v5 = [(TVRMSTouchMessage *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return TVRMSTouchMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
