...
uint64_t __33__TVRMSDAAPParser_sharedInstance__block_invoke()
{
...
+ (id)objectWithData:(id)a3
{
  ...
  id v8 = 0;
  v3 = [a1 objectWithData:a3 error:&v8];
  id v4 = v8;
  if (!v3)
  {
    v5 = _TVRCRMSLog();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v10 = v6;
      _os_log_impl(&dword_2266D3000, v5, OS_LOG_TYPE_DEFAULT, "Failed to parse DAAP response data. %@", buf, 0xCu);
    }
  }
...
+ (id)objectWithData:(id)a3 error:(id *)a4
{
  ...
  id v5 = a3;
  v6 = +[TVRMSDAAPParser sharedInstance];
  ...
  if (v7 <= 7)
  {
    ...
    id v8 = objc_msgSend(NSString, "stringWithFormat:", @"Response did not include a body (only %zd bytes returned).", v7);
...
- (id)parseXMLContent:(const char *)a3 length:(unsigned int)a4
{
  ...
  if (a4)
  {
    ...
    if (v6)
    {
      unint64_t v7 = _TVRCRMSLog();
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        id v11 = v6;
        _os_log_impl(&dword_2266D3000, v7, OS_LOG_TYPE_DEFAULT, "Attempting to process XML response: %@", buf, 0xCu);
      }
    }
  }
  else
...
LABEL_10:
    ...
    default:
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v17 = 2112;
        id v18 = v10;
        _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setBool being passed a %u byte value for: <%@>!", (uint8_t *)v16, 0x12u);
      }
...
- (void)setSInt8:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setSInt8 being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setUInt8:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setUInt8 being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setSInt16:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setSInt16 being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setUInt16:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setUInt16 being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setDate:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setDate being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setUInt32:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setUInt32 being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setFloat32:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v10;
      _os_log_impl(&dword_2266D3000, v13, OS_LOG_TYPE_DEFAULT, "setFloat32 being passed a %u byte value for: <%@>!", (uint8_t *)v14, 0x12u);
    }
  }
}
...
- (void)setUInt64:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "setUInt64 being passed a %u byte value for: <%@>!", (uint8_t *)v13, 0x12u);
    }
  }
}
...
- (void)setString:(const char *)a3 size:(unsigned int)a4 inDict:(id)a5 forKey:(id)a6
{
  if (a4)
  {
    ...
    id v10 = a6;
    id v11 = a5;
    id v12 = [(TVRMSDAAPParser *)self parseUTF8String:a3 length:v7];
...
- (id)parseMACAddressListing:(const char *)a3 length:(unsigned int)a4
{
  ...
  v9[4] = self;
  v9[5] = &v10;
  [(TVRMSDAAPParser *)self enumerateDAAPChunksInBytes:a3 length:v4 usingBlock:v9];
  id v7 = (id)v11[5];
...
LABEL_99:
        ...
        uint64_t v19 = @"com.apple.itunes.req-fplay";
        goto LABEL_108;
      }
      if ((int)a2 > 1634030705)
      {
        ...
        if (a2 != 1634759279)
        {
          ...
          uint64_t v16 = @"daap.supportsgroups";
          goto LABEL_80;
        }
        id v11 = *(void **)(a1 + 32);
...
LABEL_112:
    ...
    if ((int)a2 <= 1685484664)
    {
      ...
      if (a2 == 1635018084)
      {
        __int16 v14 = *(void **)(a1 + 32);
        uint64_t v15 = *(void *)(*(void *)(a1 + 40) + 8);
        uint64_t v16 = @"daap.supportsextradata";
LABEL_80:
...
LABEL_115:
      ...
      switch(a2)
      {
        case 0x6D736578:
          uint64_t v17 = *(void **)(a1 + 32);
          uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
          uint64_t v19 = @"dmap.supportsextensions";
          break;
        case 0x6D736978:
          uint64_t v17 = *(void **)(a1 + 32);
          uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
          uint64_t v19 = @"dmap.supportsindex";
          break;
        case 0x6D736C72:
          uint64_t v17 = *(void **)(a1 + 32);
          uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
          uint64_t v19 = @"dmap.loginrequired";
          break;
        default:
          goto LABEL_115;
      }
    ...
    else if ((int)a2 <= 1836278132)
    {
      if (a2 == 1836278124)
      {
        uint64_t v17 = *(void **)(a1 + 32);
        uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
        uint64_t v19 = @"dmap.supportsautologout";
      }
      else
      {
        if (a2 != 1836278131) {
        ...
        uint64_t v17 = *(void **)(a1 + 32);
        uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
        uint64_t v19 = @"dmap.authenticationschemes";
      }
    }
    else
    {
      switch(a2)
      {
        case 0x6D736175:
          uint64_t v17 = *(void **)(a1 + 32);
          uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
          uint64_t v19 = @"dmap.authenticationmethod";
          break;
        case 0x6D736272:
          uint64_t v17 = *(void **)(a1 + 32);
          uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
          uint64_t v19 = @"dmap.supportsbrowse";
          break;
        case 0x6D736375:
          id v5 = *(void **)(a1 + 32);
          uint64_t v6 = *(void *)(*(void *)(a1 + 40) + 8);
  ...
  if ((int)a2 > 1836282988)
  {
    ...
    uint64_t v17 = *(void **)(a1 + 32);
    uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
    uint64_t v19 = @"dmap.supportsupdate";
    goto LABEL_108;
  }
  if ((int)a2 > 1836282232)
  {
    switch(a2)
    {
      case 0x6D737179:
        uint64_t v17 = *(void **)(a1 + 32);
        uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
        uint64_t v19 = @"dmap.supportsquery";
        break;
      case 0x6D737273:
        uint64_t v17 = *(void **)(a1 + 32);
        uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
        uint64_t v19 = @"dmap.supportsresolve";
        break;
      case 0x6D737463:
        id v11 = *(void **)(a1 + 32);
        uint64_t v12 = *(void *)(*(void *)(a1 + 40) + 8);
  ...
  if (a2 != 1836281196)
  {
    ...
    uint64_t v17 = *(void **)(a1 + 32);
    uint64_t v18 = *(void *)(*(void *)(a1 + 40) + 8);
    uint64_t v19 = @"dmap.supportspersistentids";
    goto LABEL_108;
  }
...
void __44__TVRMSDAAPParser_parseContentCodes_length___block_invoke(uint64_t a1, unint64_t a2, unsigned int *a3)
{
  ...
  if (a2 == 1835295596)
  {
    id v7 = [*(id *)(a1 + 32) parseContentCollectionDict:a3 length:HIDWORD(a2)];
    ...
    if (*a3 != -939524096)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 67109120;
        ...
        _os_log_impl(&dword_2266D3000, v5, OS_LOG_TYPE_DEFAULT, "DMAP returned status code %u", buf, 8u);
      }
    }
  }
  else
  {
    ...
    objc_msgSend(v6, "unknownChunk:", a2, a3);
  }
}
...
- (id)parseLogin:(const char *)a3 length:(unsigned int)a4
{
  ...
  v6[4] = self;
  v6[5] = &v7;
  [(TVRMSDAAPParser *)self enumerateDAAPChunksInBytes:a3 length:*(void *)&a4 usingBlock:v6];
  id v4 = (id)v8[5];
  ...
  else if (a2 == 1836282996)
  {
    ...
    if (*a3 != -939524096)
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
      {
        v7[0] = 67109120;
        v7[1] = bswap32(v4);
        _os_log_impl(&dword_2266D3000, v5, OS_LOG_TYPE_DEFAULT, "DMAP returned status code %u", (uint8_t *)v7, 8u);
      }
    }
  }
  else
...
- (id)parseListingCollection:(const char *)a3 length:(unsigned int)a4 capacity:(int)a5 sectionHeaders:(id *)a6
{
  ...
  id v24 = [MEMORY[0x263EFF980] arrayWithCapacity:a5];
  uint64_t v13 = 0;
  uint64_t v14 = &v13;
  ...
  v12[5] = &v19;
  v12[6] = &v13;
  [(TVRMSDAAPParser *)self enumerateDAAPChunksInBytes:a3 length:v7 usingBlock:v12];
  if (a6) {
    *a6 = (id) v14[5];
  }
  id v10 = (id)v20[5];
...
void __73__TVRMSDAAPParser_parseListingCollection_length_capacity_sectionHeaders___block_invoke(uint64_t a1, unint64_t a2, uint64_t a3)
{
  ...
  if (a2 == 1667584339)
  {
    *(void *)(*(void *)(*(void *)(a1 + 48) + 8) + 40) = [*(id *)(a1 + 32) parseQueueSectionItems:a3 length:v4];
    MEMORY[0x270F9A758]();
  }
  else if (a2 != 1836282996)
  {
...
LABEL_66:
      ...
      else
      {
        if (a2 != 1634759533)
        {
          ...
          uint64_t v19 = @"com.apple.itunes.num-manually-queued";
          goto LABEL_63;
        }
        uint64_t v10 = *(void **)(a1 + 32);
        uint64_t v11 = *(void *)(*((void *)v4[5] + 1) + 40);
  ...
  if ((int)a2 <= 1835819883)
  {
    if (a2 != 1668113010)
    {
      if (a2 == 1668117353)
      {
        ...
        id v15 = *(void **)(*((void *)v4[5] + 1) + 40);
        uint64_t v16 = @"playStatusUpdateInfo";
        id v38 = (id)v14;
LABEL_71:
    ...
    id v17 = *(void **)(a1 + 32);
    uint64_t v18 = *(void *)(*((void *)v4[5] + 1) + 40);
    uint64_t v19 = @"dmcp.bonjoursourcesrevision";
LABEL_63:
...
void __53__TVRMSDAAPParser_parseControlPromptResponse_length___block_invoke(uint64_t a1, unint64_t a2, unsigned int *a3)
{
  ...
  {
    case 0x6D64636C:
      id v9 = [*(id *)(a1 + 32) parseControlPromptCollection:a3 length:v4];
    ...
    case 0x6D696964:
      ...
      if (v4 == 4)
      {
        objc_msgSend(v7, "setUInt32:size:inDict:forKey:");
      }
      else
      {
        objc_msgSend(v7, "setUInt64:size:inDict:forKey:");
      }
      break;
    case 0x6D737474:
      unsigned int v5 = *a3;
      if (*a3 != -939524096)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 67109120;
          ...
          _os_log_impl(&dword_2266D3000, v6, OS_LOG_TYPE_DEFAULT, "DMAP returned status code %u", buf, 8u);
        }
      }
      break;
    default:
      id v8 = *(void **)(a1 + 32);
      objc_msgSend(v8, "unknownChunk:", a2, a3);
      break;
  }
}
...
void __51__TVRMSDAAPParser_parseGetSpeakersResponse_length___block_invoke(uint64_t a1, unint64_t a2, unsigned int *a3)
{
  ...
  if (a2 == 1835295596)
  {
    id v7 = [*(id *)(a1 + 32) parseListingItem:a3 length:HIDWORD(a2)];
    objc_msgSend(*(id *)(*(void *)(*(void *)(a1 + 40) + 8) + 40), "addObject:");
  }
  else if (a2 == 1836282996)
  {
          ...
          if ((int)a2 <= 1667326322)
          {
            if (a2 != 1634956397)
            {
              if (a2 == 1667326322)
              {
                id v7 = *(void **)(a1 + 32);
                uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
                unsigned int v9 = @"availableRepeatStates";
LABEL_134:
...
LABEL_15:
          ...
          if (a2 == 1667326323)
          {
            id v7 = *(void **)(a1 + 32);
            uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
            unsigned int v9 = @"availableShuffleStates";
            goto LABEL_134;
          }
          if (a2 == 1667327589)
          {
...
LABEL_85:
      ...
      switch(a2)
      {
        case 0x61655349:
          id v7 = *(void **)(a1 + 32);
          uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
          unsigned int v9 = @"com.apple.itunes.itms-songid";
          goto LABEL_134;
        case 0x61656177:
          unsigned __int16 v13 = *(void **)(a1 + 32);
          break;
      ...
      if ((int)a2 <= 1667330155)
      {
        switch((int)a2)
        {
          ...
          case 1667329652:
            id v7 = *(void **)(a1 + 32);
            uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
            unsigned int v9 = @"daap.songtimeremaining";
            goto LABEL_134;
          default:
            goto LABEL_142;
        }
      ...
      if ((int)a2 > 1667330671)
      {
        if (a2 != 1667330672)
        {
          if (a2 == 1667330913)
          {
            id v7 = *(void **)(a1 + 32);
            uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
            unsigned int v9 = @"nowPlayingSpeakersEnabled";
            goto LABEL_134;
          }
          goto LABEL_142;
        }
...
LABEL_142:
    ...
    if (a2 == 1667583569)
    {
      id v7 = *(void **)(a1 + 32);
      uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
      unsigned int v9 = @"com.apple.itunes.num-manually-queued";
      goto LABEL_134;
    }
    if (a2 != 1667584326)
    {
      if (a2 == 1667584343)
      {
        id v7 = *(void **)(a1 + 32);
        uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
        unsigned int v9 = @"com.apple.itunes.playqueue-warning-threshold";
        goto LABEL_134;
      }
      goto LABEL_142;
    }
    ...
    if ((int)a2 > 1836082545)
    {
      if (a2 != 1836082546)
      {
        ...
        if (a2 == 1836413810)
        {
          id v7 = *(void **)(a1 + 32);
          uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
          unsigned int v9 = @"dmap.serverrevision";
          goto LABEL_134;
        }
        goto LABEL_142;
      }
...
LABEL_124:
    ...
    if (a2 == 1668117362)
    {
      id v7 = *(void **)(a1 + 32);
      uint64_t v8 = *(void *)(*(void *)(a1 + 40) + 8);
      unsigned int v9 = @"dmcp.playstatusrevision";
      goto LABEL_134;
    }
    if (a2 != 1668118127) {
      goto LABEL_142;
...
LABEL_130:
  ...
  if (v18)
  {
    ...
    {
      uint64_t v19 = [v32 objectForKey:@"id"];
  ...
  if ((int)a3 > 1668113263)
  {
    if ((int)a3 > 1835364977)
    {
      if ((int)a3 > 1836282485)
      {
        ...
        if (a3 == 1836282486)
        {
          uint64_t v6 = [(TVRMSDAAPParser *)self parseServerInfo:a4 length:*(void *)&a5];
          goto LABEL_47;
        }
        goto LABEL_53;
      }
      if (a3 - 1835364978 >= 2)
      {
        if (a3 == 1835822951)
        {
          uint64_t v6 = [(TVRMSDAAPParser *)self parseLogin:a4 length:*(void *)&a5];
          goto LABEL_47;
        }
        int v5 = 1836278642;
        goto LABEL_45;
    ...
    if ((int)a3 <= 1668313711)
    {
      if (a3 == 1668113264)
      {
        uint64_t v6 = [(TVRMSDAAPParser *)self parseControlPromptResponse:a4 length:*(void *)&a5];
        goto LABEL_47;
      }
      if (a3 == 1668114292 || a3 == 1668117364)
      {
        uint64_t v6 = [(TVRMSDAAPParser *)self parseDACPPropertyResponse:a4 length:*(void *)&a5];
        goto LABEL_47;
      }
      goto LABEL_53;
    }
    if ((int)a3 <= 1835234411)
    {
      ...
      if (a3 == 1835230066)
      {
        uint64_t v6 = [(TVRMSDAAPParser *)self parseContentCodes:a4 length:*(void *)&a5];
        goto LABEL_47;
      }
      goto LABEL_53;
    }
...
LABEL_42:
    uint64_t v6 = [(TVRMSDAAPParser *)self parseListingItem:a4 length:*(void *)&a5];
    goto LABEL_47;
  }
  if ((int)a3 > 1635148897)
  {
    if ((int)a3 > 1667330927)
    {
      if ((int)a3 <= 1667584337)
      {
        if (a3 == 1667330928)
        {
          uint64_t v6 = [(TVRMSDAAPParser *)self parseGetSpeakersResponse:a4 length:*(void *)&a5];
          goto LABEL_47;
        }
        if (a3 == 1667581769)
        {
          uint64_t v6 = [(TVRMSDAAPParser *)self parseListingCollection:a4 length:*(void *)&a5 capacity:0 sectionHeaders:0];
          goto LABEL_47;
        }
        goto LABEL_53;
      }
...
LABEL_46:
    uint64_t v6 = [(TVRMSDAAPParser *)self parseListingHeader:a4 length:*(void *)&a5];
    goto LABEL_47;
  }
  if (a3 == 1634759535) {
    goto LABEL_46;
...
LABEL_53:
    ...
    -[TVRMSDAAPParser unknownChunk:](self, "unknownChunk:", bswap64(*((unsigned int *)a4 + 1) | ((unint64_t)*(unsigned int *)a4 << 32)), a4 + 8, *(void *)&a5);
  uint64_t v6 = 0;
LABEL_47:
