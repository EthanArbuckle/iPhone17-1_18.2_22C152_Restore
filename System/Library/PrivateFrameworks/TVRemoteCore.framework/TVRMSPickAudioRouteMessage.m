@interface TVRMSPickAudioRouteMessage
- (BOOL)hasMacAddress;
...
@implementation TVRMSPickAudioRouteMessage
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)TVRMSPickAudioRouteMessage;
  v4 = [(TVRMSPickAudioRouteMessage *)&v8 description];
  v5 = [(TVRMSPickAudioRouteMessage *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return TVRMSPickAudioRouteMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
