@interface TVRMSAvailableServicesDidUpdateMessage
...
- (id)description
{
  ...
  id v4 = [(TVRMSAvailableServicesDidUpdateMessage *)&v8 description];
  v5 = [(TVRMSAvailableServicesDidUpdateMessage *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  id v9 = v4;
  if ([(TVRMSAvailableServicesDidUpdateMessage *)self servicesCount])
  {
    [v9 clearServices];
    unint64_t v5 = [(TVRMSAvailableServicesDidUpdateMessage *)self servicesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(TVRMSAvailableServicesDidUpdateMessage *)self servicesAtIndex:i];
        [v9 addServices:v8];
      }
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[TVRMSAvailableServicesDidUpdateMessage addServices:](self, "addServices:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
