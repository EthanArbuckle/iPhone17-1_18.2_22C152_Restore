@interface TVRMSDAAPNowPlayingManager
...
- (TVRMSDAAPNowPlayingManager)initWithRequestManager:(id)a3
{
  ...
  v6 = [(TVRMSDAAPNowPlayingManager *)&v9 init];
  v7 = v6;
  if (v6) {
...
- (void)beginObservingNowPlaying
{
  if (self->_isObserving)
  {
    ...
    {
      LOWORD(buf[0]) = 0;
      _os_log_impl(&dword_2266D3000, v2, OS_LOG_TYPE_DEFAULT, "NowPlayingManager asked to begin observing, but observing was already in progress", (uint8_t *)buf, 2u);
    }
  }
  else
  {
    ...
    [(TVRMSDAAPNowPlayingManager *)self _requestNowPlayingInfoWithCompletionHandler:v4];
    objc_destroyWeak(&v5);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 134217984;
        id v18 = v13;
        _os_log_impl(&dword_2266D3000, v12, OS_LOG_TYPE_DEFAULT, "Now playing info unavailable, retrying in %td seconds", buf, 0xCu);
      }
...
- (void)endObservingNowPlaying
{
  ...
  [(TVRMSDAAPNowPlayingManager *)self _cancelArtworkRetryTimer];
}
...
- (void)_refreshNowPlayingInfoRequest
{
  ...
  {
    self->_isObserving = 0;
    [(TVRMSDAAPNowPlayingManager *)self beginObservingNowPlaying];
  }
}
...
- (void)_requestNowPlayingInfoWithCompletionHandler:(id)a3
{
  ...
  v7 = objc_msgSend(NSNumber, "numberWithInt:", -[TVRMSNowPlayingInfo revisionNumber](self->_currentNowPlayingInfo, "revisionNumber"));
  v15[0] = v7;
  ...
  id v13 = v4;
  id v9 = v4;
  id v10 = [(TVRMSDAAPRequestManager *)requestManager requestWithPath:v5 method:@"GET" postData:0 queryArgs:v8 completionHandler:v12];
...
void __74__TVRMSDAAPNowPlayingManager__requestNowPlayingInfoWithCompletionHandler___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (a2 == 1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      int v34 = 138412290;
      v35 = v6;
      _os_log_impl(&dword_2266D3000, v7, OS_LOG_TYPE_DEFAULT, "Received now-playing info: %@", (uint8_t *)&v34, 0xCu);
    }
...
- (void)_requestArtworkDataIfNecessaryForNowPlayingInfo:(id)a3
{
  ...
  if (!v5)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_2266D3000, v11, OS_LOG_TYPE_DEFAULT, "Now playing is empty, don't fetch artwork", buf, 2u);
    }
  ...
  if (([v5 isEqualToString:self->_currentArtworkIdentifier] & 1) == 0)
  {
    ...
    v7 = +[TVRMSNowPlayingArtworkCache sharedArtworkCache];
    ...
    if (currentArtworkIdentifier)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v20 = v6;
        _os_log_impl(&dword_2266D3000, v9, OS_LOG_TYPE_DEFAULT, "Artwork was cached for identifier: %@", buf, 0xCu);
      }
    ...
    else
    {
      ...
      v15[1] = 3221225472;
      void v15[2] = __78__TVRMSDAAPNowPlayingManager__requestArtworkDataIfNecessaryForNowPlayingInfo___block_invoke;
      v15[3] = &unk_2647AEBD8;
      objc_copyWeak(&v18, (id *)buf);
      id v16 = v4;
      id v17 = v6;
      id v13 = [(TVRMSDAAPRequestManager *)requestManager requestWithPath:WeakRetained method:@"GET" postData:0 queryArgs:0 completionHandler:v15];
    ...
    else
    {
      ...
      *((void *)WeakRetained + 10) = v10 + 1;
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v14 = 134217984;
        uint64_t v15 = v12;
        _os_log_impl(&dword_2266D3000, v11, OS_LOG_TYPE_DEFAULT, "Artwork unavailable, retrying in %td seconds", (uint8_t *)&v14, 0xCu);
      }

      [WeakRetained _scheduleArtworkRetryForNowPlayingInfo:*(void *)(a1 + 32) delay:(double)*((uint64_t *)WeakRetained + 10)];
      id v13 = objc_loadWeakRetained((id *)WeakRetained + 15);
      [v13 nowPlayingManager:WeakRetained artworkDataDidBecomeAvailable:0 identifier:0];
    }
  }
}
...
- (void)_requestAudioRoutes
{
  ...
  id v5 = [(TVRMSDAAPRequestManager *)requestManager requestWithPath:v3 method:@"POST" postData:0 queryArgs:0 completionHandler:v7];
...
void __49__TVRMSDAAPNowPlayingManager__requestAudioRoutes__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (a2 == 1 && WeakRetained)
  {
    ...
    id v24 = v5;
    id v8 = +[TVRMSDAAPParser objectWithData:v5];
    id v9 = objc_opt_new();
    long long v26 = 0u;
    long long v27 = 0u;
    long long v28 = 0u;
    ...
    if (v10)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          id v15 = objc_opt_new();
          uint64_t v16 = [v14 objectForKeyedSubscript:@"dmap.itemname"];
...
- (void)_requestVolume
{
  ...
  id v6 = [(TVRMSDAAPRequestManager *)requestManager requestWithPath:v3 method:@"POST" postData:0 queryArgs:v5 completionHandler:v8];
...
void __44__TVRMSDAAPNowPlayingManager__requestVolume__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    id v5 = +[TVRMSDAAPParser objectWithData:v14];
...
- (TVRMSDAAPNowPlayingManagerDelegate)delegate
{
  ...
  return (TVRMSDAAPNowPlayingManagerDelegate *)WeakRetained;
}
