@interface TVRMSPairingSessionDidPairMessage
- (BOOL)hasPairingGUID;
...
- (id)description
{
  ...
  v4 = [(TVRMSPairingSessionDidPairMessage *)&v8 description];
  v5 = [(TVRMSPairingSessionDidPairMessage *)self dictionaryRepresentation];
