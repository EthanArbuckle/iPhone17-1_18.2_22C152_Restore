@interface TVRMSNavigationCommandMessage
...
@implementation TVRMSNavigationCommandMessage
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)TVRMSNavigationCommandMessage;
  v4 = [(TVRMSNavigationCommandMessage *)&v8 description];
  v5 = [(TVRMSNavigationCommandMessage *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return TVRMSNavigationCommandMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
