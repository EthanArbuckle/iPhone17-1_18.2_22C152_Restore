@interface TVRMSUpdatePairedNetworNamesMessage
...
- (id)description
{
  ...
  id v4 = [(TVRMSUpdatePairedNetworNamesMessage *)&v8 description];
  v5 = [(TVRMSUpdatePairedNetworNamesMessage *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  id v9 = v4;
  if ([(TVRMSUpdatePairedNetworNamesMessage *)self pairedNetworkNamesCount])
  {
    [v9 clearPairedNetworkNames];
    unint64_t v5 = [(TVRMSUpdatePairedNetworNamesMessage *)self pairedNetworkNamesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(TVRMSUpdatePairedNetworNamesMessage *)self pairedNetworkNamesAtIndex:i];
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[TVRMSUpdatePairedNetworNamesMessage addPairedNetworkNames:](self, "addPairedNetworkNames:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
