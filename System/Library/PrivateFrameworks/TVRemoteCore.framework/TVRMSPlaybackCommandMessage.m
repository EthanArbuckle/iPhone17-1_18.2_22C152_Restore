@interface TVRMSPlaybackCommandMessage
...
@implementation TVRMSPlaybackCommandMessage
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)TVRMSPlaybackCommandMessage;
  v4 = [(TVRMSPlaybackCommandMessage *)&v8 description];
  v5 = [(TVRMSPlaybackCommandMessage *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return TVRMSPlaybackCommandMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
