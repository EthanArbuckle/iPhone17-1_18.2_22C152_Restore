...
- (void)encodeInt32:(int)a3 forCode:(unsigned int)a4
{
  ...
  [(TVRMSDAAPEncoder *)self encodeBytes:&v4 length:4 forCode:*(void *)&a4];
}

- (void)encodeInt64:(int64_t)a3 forCode:(unsigned int)a4
{
  unint64_t v4 = bswap64(a3);
  [(TVRMSDAAPEncoder *)self encodeBytes:&v4 length:8 forCode:*(void *)&a4];
}
...
- (void)encodeString:(id)a3 forCode:(unsigned int)a4
{
  ...
  if (v6)
  {
    ...
    if (!HIDWORD(v7))
    {
      -[TVRMSDAAPEncoder encodeBytes:length:forCode:](self, "encodeBytes:length:forCode:", [v8 UTF8String], v7, v4);
      id v6 = v8;
    }
  }
}
...
- (void)encodeData:(id)a3 forCode:(unsigned int)a4
{
  if (a3)
  {
    ...
    [(TVRMSDAAPEncoder *)self encodeBytes:v7 length:v8 forCode:v4];
  }
}
