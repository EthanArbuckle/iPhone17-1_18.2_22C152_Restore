...
{
  id v3 = a3;
  v4 = (void *)[objc_alloc((Class)objc_opt_class()) initWithDisbursementSummaryItem:v3];
...
- (BOOL)isValidWithError:(id *)a3
{
  return [(PKDisbursementSummaryItemValidator *)self isValidWithAPIType:0 withError:a3];
}
...
LABEL_6:
    ...
    [v14 setObject:@"PKDisbursementSummaryItem has an invalid amount" forKeyedSubscript:*MEMORY[0x1E4F28568]];
