...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  id v6 = [(SQLiteStringGlobPredicate *)self property];
  v7 = [(objc_class *)a3 disambiguatedSQLForProperty:v6];
  [v5 appendString:v7];

  [v5 appendString:@" GLOB "];
  id v8 = [(SQLiteStringGlobPredicate *)self pattern];
  [v5 appendFormat:@"'%@'", v8];
...
{
  v6.receiver = self;
  v6.super_class = (Class)SQLiteStringGlobPredicate;
...
- (BOOL)isEqual:(id)a3
{
  v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)SQLiteStringGlobPredicate;
