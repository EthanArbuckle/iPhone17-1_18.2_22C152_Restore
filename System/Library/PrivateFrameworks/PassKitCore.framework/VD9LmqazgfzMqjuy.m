...
- (VD9LmqazgfzMqjuy)initWithDictionary:(id)a3
{
  ...
  int v6 = [v5 isEqualToString:@"settings"];
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      -[VD9LmqazgfzMqjuy setSettingsType:](v7, "setSettingsType:", (int)[v10 intValue]);
...
- (id)toDictionary
{
  ...
  id v4 = objc_msgSend(NSNumber, "numberWithInt:", -[VD9LmqazgfzMqjuy endpointID](self, "endpointID"));
  [v3 setObject:v4 forKeyedSubscript:@"endpointID"];

  v5 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[VD9LmqazgfzMqjuy settingsType](self, "settingsType"));
  [v3 setObject:v5 forKeyedSubscript:@"settingsType"];

  int v6 = [(VD9LmqazgfzMqjuy *)self endpointIdentifier];
...
- (id)description
{
  ...
  [v3 appendFormat:@"<%@, %p> {\n", objc_opt_class(), self];
  id v4 = [(VD9LmqazgfzMqjuy *)self endpointIdentifier];
