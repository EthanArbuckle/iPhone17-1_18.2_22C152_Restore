@interface PKPaymentProvisioningMethodTypeCameraCapture
...
- (PKPaymentProvisioningMethodTypeCameraCapture)init
{
  ...
  return [(PKPaymentProvisioningMethod *)&v3 initWithType:64];
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  objc_super v5 = objc_alloc_init(PKPaymentProvisioningMethodTypeCameraCapture);
