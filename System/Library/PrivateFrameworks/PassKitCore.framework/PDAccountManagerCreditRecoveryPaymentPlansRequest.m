...
- (PDAccountManagerCreditRecoveryPaymentPlansRequest)initWithAccountIdentifier:(id)a3 force:(BOOL)a4
{
  id v7 = a3;
  v13.receiver = self;
  v13.super_class = (Class)PDAccountManagerCreditRecoveryPaymentPlansRequest;
  v8 = [(PDAccountManagerCreditRecoveryPaymentPlansRequest *)&v13 init];
  v9 = v8;
  if (v8)
  {
...
- (id)requestIdentifier
{
  v3 = sub_10048DC70([(PDAccountManagerCreditRecoveryPaymentPlansRequest *)self requestType]);
...
- (BOOL)coalesceWithRequest:(id)a3
{
  ...
  if (v5 != (id)[(PDAccountManagerCreditRecoveryPaymentPlansRequest *)self requestType]) {
    goto LABEL_6;
  }
  v6 = [v4 requestIdentifier];
  id v7 = [(PDAccountManagerCreditRecoveryPaymentPlansRequest *)self requestIdentifier];
  id v8 = v6;
  id v9 = v7;
  if (v8 == v9)
  {
...
- (NSString)description
{
  ...
  id v4 = sub_10048DC70([(PDAccountManagerCreditRecoveryPaymentPlansRequest *)self requestType]);
  [v3 appendFormat:@"requestType: '%@'; ", v4];

  id v5 = [(PDAccountManagerCreditRecoveryPaymentPlansRequest *)self requestIdentifier];
