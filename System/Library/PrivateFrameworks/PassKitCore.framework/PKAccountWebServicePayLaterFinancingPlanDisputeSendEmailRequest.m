@interface PKAccountWebServicePayLaterFinancingPlanDisputeSendEmailRequest
...
LABEL_14:
  ...
  if (disputeIdentifier)
  {
    ...
    v18[6] = @"sendEmail";
    v9 = [MEMORY[0x1E4F1C978] arrayWithObjects:v18 count:7];
    v10 = [(PKAccountWebServiceRequest *)self _murlRequestWithServiceURL:baseURL endpointComponents:v9 queryParameters:0 appleAccountInformation:v4];
