...
- (PDCloudStoreShareInvitationValidateRequestKeys)initWithInvitation:(id)a3 recipientHandle:(id)a4 completion:(id)a5;
- (PKCloudStoreZoneInvitation)invitation;
- (id)description;
@end

@implementation PDCloudStoreShareInvitationValidateRequestKeys
...
- (PDCloudStoreShareInvitationValidateRequestKeys)initWithInvitation:(id)a3 recipientHandle:(id)a4 completion:(id)a5
{
  ...
  id v10 = a4;
  v14.receiver = self;
  v14.super_class = (Class)PDCloudStoreShareInvitationValidateRequestKeys;
  v11 = [(PDCloudStoreShareInvitationRequest *)&v14 initWithType:1 completion:a5];
  v12 = v11;
  if (v11)
  {
