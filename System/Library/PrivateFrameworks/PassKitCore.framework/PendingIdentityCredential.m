...
- (PendingIdentityCredential)initWithPendingProvisioning:(id)a3 forBasePendingProvisioning:(id)a4 inDatabase:(id)a5
{
  ...
  [v11 setEntityPIDOrNull:v10 forKey:@"base_pid"];

  v12 = [v8 sharingInstanceIdentifier];
  [v11 setObjectOrNull:v12 forKey:@"a"];

  v13 = [v8 cardConfigurationIdentifier];
  [v11 setObjectOrNull:v13 forKey:@"b"];

  v14 = [v8 provisioningCredentialIdentifier];
  [v11 setObjectOrNull:v14 forKey:@"c"];

  v15 = [v8 credentialIdentifier];
  ...
  {
    [v11 setObjectOrNull:0 forKey:@"e"];
  }
  v18 = [v8 passTypeIdentifier];
  [v11 setObjectOrNull:v18 forKey:@"f"];

  v19 = [v8 passSerialNumber];
  [v11 setObjectOrNull:v19 forKey:@"g"];

  v20 = [v8 accountKeyIdentifier];
  [v11 setObjectOrNull:v20 forKey:@"h"];

  v21 = [(SQLiteEntity *)self initWithPropertyValues:v11 inDatabase:v9];
  return v21;
}
...
+ (void)deleteEntitiesForBasePendingProvisioningPID:(int64_t)a3 inDatabase:(id)a4
{
  ...
  v7 = +[SQLiteEntity anyInDatabase:v6 predicate:v8];
