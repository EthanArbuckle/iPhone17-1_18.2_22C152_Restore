...
- (PKPeerPaymentRemoveAssociatedAccountResponse)initWithData:(id)a3;
@end

@implementation PKPeerPaymentRemoveAssociatedAccountResponse

- (PKPeerPaymentRemoveAssociatedAccountResponse)initWithData:(id)a3
{
  uint64_t v17 = *MEMORY[0x1E4F143B8];
  v14.receiver = self;
  v14.super_class = (Class)PKPeerPaymentRemoveAssociatedAccountResponse;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v16 = v12;
        _os_log_impl(&dword_190E10000, v8, OS_LOG_TYPE_DEFAULT, "Malformed PKPeerPaymentRemoveAssociatedAccountResponse: expected dictionary and received %{public}@", buf, 0xCu);
      }
    }
  }
  return v4;
