@interface PDAccountManagerPhysicalCardsRequest
- (BOOL)coalesceWithRequest:(id)a3;
- (BOOL)force;
- (NSSet)completionHandlers;
- (NSString)accountIdentifier;
- (NSString)description;
- (PDAccountManagerPhysicalCardsRequest)initWithAccountIdentifier:(id)a3 force:(BOOL)a4;
- (id)requestIdentifier;
- (unint64_t)requestType;
- (void)addCompletion:(id)a3;
- (void)callCompletionsWithPhysicalCards:(id)a3 error:(id)a4;
@end

@implementation PDAccountManagerPhysicalCardsRequest

- (PDAccountManagerPhysicalCardsRequest)initWithAccountIdentifier:(id)a3 force:(BOOL)a4
{
  id v7 = a3;
  v13.receiver = self;
  v13.super_class = (Class)PDAccountManagerPhysicalCardsRequest;
  v8 = [(PDAccountManagerPhysicalCardsRequest *)&v13 init];
  v9 = v8;
  if (v8)
  {
...
- (id)requestIdentifier
{
  v3 = sub_10048DC70([(PDAccountManagerPhysicalCardsRequest *)self requestType]);
...
- (BOOL)coalesceWithRequest:(id)a3
{
  ...
  if (v5 != (id)[(PDAccountManagerPhysicalCardsRequest *)self requestType]) {
    goto LABEL_6;
  }
  v6 = [v4 requestIdentifier];
  id v7 = [(PDAccountManagerPhysicalCardsRequest *)self requestIdentifier];
  id v8 = v6;
  id v9 = v7;
  if (v8 == v9)
  {
...
- (NSString)description
{
  ...
  id v4 = sub_10048DC70([(PDAccountManagerPhysicalCardsRequest *)self requestType]);
  [v3 appendFormat:@"requestType: '%@'; ", v4];

  id v5 = [(PDAccountManagerPhysicalCardsRequest *)self requestIdentifier];
