...
{
  v5.receiver = self;
  v5.super_class = (Class)PKContinuityProximityVerification;
...
+ (id)verificationWithDictionary:(id)a3
{
  ...
  if (v4 && PKContinuityProximityVerifierTypeFromString(v4)) {
    v6 = [[PKContinuityProximityBLEVerification alloc] initWithDictionary:v3];
  }
  else {
    v6 = 0;
  }
...
{
  id v4 = a3;
  id v5 = [(PKContinuityProximityVerification *)self dictionaryRepresentation];
