...
- (_TtC5passd34PDARRISO18013KeySigningKeyProvider)initWithIso18013Manager:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC5passd34PDARRISO18013KeySigningKeyProvider_iso18013Manager) = (Class)a3;
  ...
  id v6 = a3;
  return [(PDARRISO18013KeySigningKeyProvider *)&v8 init];
}

- (_TtC5passd34PDARRISO18013KeySigningKeyProvider)init
{
  result = (_TtC5passd34PDARRISO18013KeySigningKeyProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void)generateKeyMaterialForRequirement:(id)a3 context:(id)a4 completion:(id)a5
{
  ...
  id v10 = a4;
  v11 = self;
  sub_100510674(v10, (uint64_t)v11, (void (**)(void, void, void, void))v8);
  _Block_release(v8);
  _Block_release(v8);
}
...
- (id)associatedRequirementsForRequirement:(id)a3 context:(id)a4
{
  ...
  *(_OWORD *)(v7 + 16) = xmmword_1005B4130;
  ...
  id v10 = a4;
  id v11 = self;
  *(void *)(v7 + 32) = [v8 initWithSignatureType:12];
