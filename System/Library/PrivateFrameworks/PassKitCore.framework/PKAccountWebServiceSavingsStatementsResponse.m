@interface PKAccountWebServiceSavingsStatementsResponse
- (NSArray)statements;
- (PKAccountWebServiceSavingsStatementsResponse)initWithData:(id)a3;
@end

@implementation PKAccountWebServiceSavingsStatementsResponse

- (PKAccountWebServiceSavingsStatementsResponse)initWithData:(id)a3
{
  uint64_t v32 = *MEMORY[0x1E4F143B8];
  v26.receiver = self;
  v26.super_class = (Class)PKAccountWebServiceSavingsStatementsResponse;
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v12 = [[PKSavingsAccountStatement alloc] initWithDictionary:*(void *)(*((void *)&v22 + 1) + 8 * v11)];
          if (v12) {
            [v6 addObject:v12];
          }
