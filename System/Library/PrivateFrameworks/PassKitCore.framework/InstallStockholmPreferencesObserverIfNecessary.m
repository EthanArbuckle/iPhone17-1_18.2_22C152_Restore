...
uint64_t ___InstallStockholmPreferencesObserverIfNecessary_block_invoke()
{
  ...
  CFNotificationCenterAddObserver(DarwinNotifyCenter, 0, (CFNotificationCallback)_StockholmPrefsChangedHandler, @"com.apple.stockholm.preferenceschanged", 0, CFNotificationSuspensionBehaviorDeliverImmediately);
