...
LABEL_21:
  ...
  if (v10)
  {
    ...
    else
    {
      ...
      {
        id v14 = (id)objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v11 + 3);
        if (v14)
        {
          v15 = v14;
          uint64_t v16 = (uint64_t)v11 + *v11 + 12;
          id v17 = (id)[MEMORY[0x1E4F1C9B8] dataWithBytes:v16 length:v11[1]];
          if (v17)
          {
            v18 = v17;
            id v19 = (id)[MEMORY[0x1E4F1C9B8] dataWithBytes:v16 + v11[1] length:v11[2]];
            if (v19)
            {
              v20 = v19;
              id v21 = v15;
...
+ (void)generateSigKey:keyData:attestation:pubKey:.cold.1()
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_2(&dword_190E10000, MEMORY[0x1E4F14500], v0, "AssertMacros: %s (value = 0x%lx), %s file: %s, line: %d\n", v1, v2, v3, v4, v5);
}
