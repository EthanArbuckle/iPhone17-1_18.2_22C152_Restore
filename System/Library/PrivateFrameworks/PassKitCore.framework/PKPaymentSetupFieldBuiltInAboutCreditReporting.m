...
- (PKPaymentSetupFieldBuiltInAboutCreditReporting)initWithIdentifier:(id)a3 type:(unint64_t)a4
{
  ...
  if (v4)
  {
    ...
    v13 = PKLocalizedApplyFeatureString(@"VERIFY_SSN_FOOTER", 2, v8, 0, v9, v10, v11, v12, (uint64_t)v30.receiver);
    [(PKPaymentSetupField *)v4 setDefaultValue:v13];

    v18 = PKLocalizedApplyFeatureString(@"VERIFY_SSN_LINK", 2, v8, 0, v14, v15, v16, v17, (uint64_t)v30.receiver);
    [(PKPaymentSetupFieldLabel *)v4 setButtonTitle:v18];

    v23 = PKLocalizedApplyFeatureString(@"VERIFY_SSN_MORE_INFO_TITLE", 2, v8, 0, v19, v20, v21, v22, (uint64_t)v30.receiver);
    [(PKPaymentSetupFieldLabel *)v4 setDetailTitle:v23];

    v28 = PKLocalizedApplyFeatureString(@"VERIFY_SSN_MORE_INFO_BODY", 2, v8, 0, v24, v25, v26, v27, (uint64_t)v30.receiver);
