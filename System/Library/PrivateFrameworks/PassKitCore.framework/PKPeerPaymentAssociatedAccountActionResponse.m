    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v16 = v12;
        _os_log_impl(&dword_190E10000, v8, OS_LOG_TYPE_DEFAULT, "Malformed PKPeerPaymentAssociatedAccountActionResponse: expected dictionary and received %{public}@", buf, 0xCu);
      }
    }
  }
  return v4;
