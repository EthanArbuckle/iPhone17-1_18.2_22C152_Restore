@interface PKPeerPaymentAcceptableDocumentsRequest
...
- (id)_urlRequestWithServiceURL:(id)a3 appleAccountInformation:(id)a4
{
  ...
  if (v6)
  {
    if (v7)
    {
      v9 = [(PKPeerPaymentWebServiceRequest *)self _murlRequestWithServiceURL:v6 endpointComponents:&unk_1EE22B5A0 queryParameters:0 appleAccountInformation:v7];
