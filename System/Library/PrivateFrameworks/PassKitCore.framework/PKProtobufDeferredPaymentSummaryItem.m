...
- (id)description
{
  ...
  v5 = [(PKProtobufDeferredPaymentSummaryItem *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [NSNumber numberWithDouble:self->_deferredDate];
    [v3 setObject:v4 forKey:@"deferredDate"];
  }
  return v3;
}
...
- (void)copyTo:(id)a3
{
  if (*(unsigned char *)&self->_has)
  {
    *((void *)a3 + 1) = *(void *)&self->_deferredDate;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *((void *)result + 1) = *(void *)&self->_deferredDate;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 16) & 1) != 0 && self->_deferredDate == *((double *)v4 + 1))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
...
- (unint64_t)hash
{
  ...
  double deferredDate = self->_deferredDate;
  double v4 = -deferredDate;
  if (deferredDate >= 0.0) {
    double v4 = self->_deferredDate;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    self->_double deferredDate = *((double *)a3 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
}
