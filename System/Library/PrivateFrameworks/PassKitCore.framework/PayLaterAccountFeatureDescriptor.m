...
- (PayLaterAccountFeatureDescriptor)initWithPayLaterAccountFeatureDescriptor:(id)a3 forAccountPID:(int64_t)a4 inDatabase:(id)a5
{
  id v8 = a5;
  id v9 = a3;
  v10 = [(id)objc_opt_class() _propertyValuesForPayLaterAccountFeatureDescriptor:v9];
...
{
  id v4 = a3;
  id v5 = [(id)objc_opt_class() _propertyValuesForPayLaterAccountFeatureDescriptor:v4];
  ...
  if (v27)
  {
    ...
    do
    {
      for (i = 0; i != v27; i = (char *)i + 1)
      {
        ...
        if (v16)
        {
          [(PayLaterAccountFeatureDescriptor *)v16 updateWithPayLaterFeatureDescriptor:v10];
          a4 = v23;
        }
        else
        {
          a4 = v23;
          v16 = [[PayLaterAccountFeatureDescriptor alloc] initWithPayLaterAccountFeatureDescriptor:v10 forAccountPID:v23 inDatabase:v8];
        }
        [v26 addObject:v11];
      }
      id v27 = [obj countByEnumeratingWithState:&v28 objects:v34 count:16];
...
+ (id)payLaterAccountFeatureDescriptorsForAccountPID:(int64_t)a3 inDatabase:(id)a4
{
  ...
  id v9 = [a1 _payLaterAccountFeatureDescriptorsWithQuery:v8];
...
- (id)payLaterAccountFeatureDescriptor
{
  id v3 = objc_alloc_init((Class)PKPayLaterAccountFeatureDescriptor);
  id v4 = [(id)objc_opt_class() _propertySettersForPayLaterAccountFeatureDescriptor];
  id v5 = [v4 allKeys];
...
{
  id v4 = a3;
  id v5 = [a1 _propertySettersForPayLaterAccountFeatureDescriptor];
