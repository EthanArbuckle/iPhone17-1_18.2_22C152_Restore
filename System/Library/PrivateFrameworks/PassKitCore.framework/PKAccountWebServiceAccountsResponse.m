...
- (PKAccountWebServiceAccountsResponse)initWithData:(id)a3
{
  ...
  v39.receiver = self;
  v39.super_class = (Class)PKAccountWebServiceAccountsResponse;
  ...
  if (v3)
  {
    ...
    {
      uint64_t v6 = [v5 PKStringForKey:@"lastUpdated"];
      lastUpdated = v4->_lastUpdated;
      v4->_lastUpdated = (NSString *)v6;
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v16 = [PKAccount alloc];
              v17 = -[PKAccount initWithDictionary:](v16, "initWithDictionary:", v15, (void)v35);
              if (v17) {
                [v9 addObject:v17];
              }
