...
- (void)dealloc
{
  ...
  [(BSContinuousMachTimer *)&v11 dealloc];
}
...
- (void)scheduleRepeatingWithFireInterval:(double)a3 repeatInterval:(double)a4 leewayInterval:(double)a5 queue:(id)a6 handler:(id)a7
{
  ...
  timer = self->_timer;
  dispatch_time_t v25 = dispatch_time(0x8000000000000000, v23);
  if (a4 >= 9223372040.0)
  {
