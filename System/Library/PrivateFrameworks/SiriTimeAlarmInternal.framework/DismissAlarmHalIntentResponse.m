...
- (DismissAlarmHalIntentResponse)initWithCoder:(id)a3
{
  return (DismissAlarmHalIntentResponse *)sub_25DC893B0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (DismissAlarmHalIntentResponse)initWithBackingStore:(id)a3
{
  return (DismissAlarmHalIntentResponse *)sub_25DC893B0((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
