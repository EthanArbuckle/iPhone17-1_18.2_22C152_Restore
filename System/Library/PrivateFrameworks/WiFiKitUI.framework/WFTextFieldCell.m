...
- (void)awakeFromNib
{
  ...
  v9 = [MEMORY[0x263F825C8] defaultTextColor];
...
- (void)prepareForReuse
{
  ...
  self->_editable = 1;
  double v6 = [MEMORY[0x263F825C8] defaultTextColor];
  double v7 = [(WFTextFieldCell *)self label];
  [v7 setTextColor:v6];

  objc_super v8 = [MEMORY[0x263F825C8] defaultTextColor];
...
- (void)copy:(id)a3
{
  ...
  if (v6)
  {
    ...
    double v7 = [v9 text];
    objc_super v8 = [MEMORY[0x263F82A18] generalPasteboard];
    [v8 setString:v7];
  }
}
