...
- (void)viewDidLoad
{
  ...
  v4 = [v3 localizedStringForKey:@"kWFLocNANSubscribe" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
...
id __57__WFNANSubscribeTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v12 == 1)
  {
    ...
    if (!v13) {
      v13 = (void *)[objc_alloc(MEMORY[0x263F82C80]) initWithStyle:1 reuseIdentifier:@"WFNANTableViewTextCellIdentifier"];
    }
...
LABEL_13:
    ...
    v29 = [v28 localizedStringForKey:@"kWFLocNANNoSubscribers" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
    v30 = [v13 textLabel];
    [v30 setText:v29];
...
LABEL_8:
    ...
    v26 = [v25 localizedStringForKey:@"kWFLocNANServiceName" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
    v27 = [v13 textField];
