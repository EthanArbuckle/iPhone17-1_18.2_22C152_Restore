...
- (WFNANDiscoveryResultsTableViewController)initWithContext:(id)a3 forSubscriber:(id)a4
{
  ...
  if (v10)
  {
    ...
    v10->_passphrase = (NSString *)&stru_26D8F6070;
...
id __64__WFNANDiscoveryResultsTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v12) {
    uint64_t v12 = (void *)[objc_alloc(MEMORY[0x263F82C80]) initWithStyle:1 reuseIdentifier:@"WFNANTableViewTextCellIdentifier"];
  }
...
LABEL_20:
  ...
  v14 = [v22 localizedStringForKey:v23 value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
  v15 = [v12 textLabel];
  [v15 setText:v14];
LABEL_21:
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
    ...
    && [(WFNANTableViewContext *)self->_context getDiscoveryResultsCountForSubscriber:self->_subscriber] >= 1)
  {
    ...
    uint64_t v11 = [v10 localizedStringForKey:@"kWFLocNANPassphrasePopupTitle" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
    uint64_t v12 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    unint64_t v13 = [v12 localizedStringForKey:@"kWFLocNANPassphrasePopupMessage" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
    ...
    uint64_t v15 = [MEMORY[0x263F82400] actionWithTitle:@"Cancel" style:0 handler:&__block_literal_global_6];
    [v14 addAction:v15];
...
void __78__WFNANDiscoveryResultsTableViewController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v5 = [v4 localizedStringForKey:@"kWFLocNANPassphrase" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
...
void __78__WFNANDiscoveryResultsTableViewController_tableView_didSelectRowAtIndexPath___block_invoke_3(uint64_t a1)
{
  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v3)
  {
    ...
    if (os_log_type_enabled(v5, v4))
    {
      ...
      int v11 = 138412290;
      uint64_t v12 = v6;
      _os_log_impl(&dword_2257EC000, v5, v4, "Establishing a data session with discovery result %@", (uint8_t *)&v11, 0xCu);
    }
  }
  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v11)
  {
    ...
    if (os_log_type_enabled(v13, v12))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v29 = 2112;
      v30 = v16;
      _os_log_impl(&dword_2257EC000, v13, v12, "NAN data session %@ confirmed for peer (address: %@, serviceSpecificInfo: %@)", buf, 0x20u);
    }
  }
...
- (void)dataSession:(id)a3 failedToStartWithError:(int64_t)a4
{
  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      __int16 v15 = 2048;
      int64_t v16 = a4;
      _os_log_impl(&dword_2257EC000, v9, v8, "NAN data session %@ failed to start with error %ld", (uint8_t *)&v13, 0x16u);
    }
  }
...
- (void)dataSession:(id)a3 terminatedWithReason:(int64_t)a4
{
  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v7)
  {
    ...
    if (os_log_type_enabled(v9, v8))
    {
      ...
      __int16 v15 = 2048;
      int64_t v16 = a4;
      _os_log_impl(&dword_2257EC000, v9, v8, "NAN data session %@ terminated with reason %ld", (uint8_t *)&v13, 0x16u);
    }
  }
...
- (void)dataSessionRequestStarted:(id)a3
{
  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v4)
  {
    ...
    if (os_log_type_enabled(v6, v5))
    {
      ...
      int v8 = 138412290;
      id v9 = v7;
      _os_log_impl(&dword_2257EC000, v6, v5, "NAN data session %@ started", (uint8_t *)&v8, 0xCu);
    }
  }
}
