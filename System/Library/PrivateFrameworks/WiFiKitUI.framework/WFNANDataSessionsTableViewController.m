...
id __60__WFNANDataSessionsTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v11) {
    v11 = (void *)[objc_alloc(MEMORY[0x263F82C80]) initWithStyle:1 reuseIdentifier:@"WFNANTableViewTextCellIdentifier"];
  }
  ...
  if (!v10)
  {
    ...
    else
    {
      ...
      unint64_t v13 = [v12 localizedStringForKey:@"kWFLocNANNoActiveDataSessions" value:&stru_26D8F6070 table:@"WiFiKitUILocalizableStrings"];
      v14 = [v11 textLabel];
      [v14 setText:v13];
    }
  }
