@interface SEMCascadeItemTypeFilter
...
+ (id)filterFromKVItemTypeNumber:(id)a3
{
  ...
  uint64_t v4 = KVItemTypeToCascadeItemType();
  if (v4 == (unsigned __int16)*MEMORY[0x263F316D0])
  {
    ...
    if (os_log_type_enabled((os_log_t)qword_26B3549D8, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v16 = 2112;
      id v17 = v3;
      _os_log_error_impl(&dword_25C7CA000, v5, OS_LOG_TYPE_ERROR, "%s Ignoring unsupported KVItemType filter: %@", buf, 0x16u);
    }
    v6 = 0;
  }
  else
  {
    ...
    id v13 = 0;
    v6 = objc_msgSend_initWithItemType_error_(v8, v9, v7, (uint64_t)&v13);
    id v10 = v13;
    if (!v6)
    {
      v11 = qword_26B3549D8;
...
- (SEMCascadeItemTypeFilter)initWithItemType:(unsigned __int16)a3 error:(id *)a4
{
  ...
  v25.receiver = self;
  v25.super_class = (Class)SEMCascadeItemTypeFilter;
  v6 = [(SEMCascadeItemTypeFilter *)&v25 init];
  v9 = v6;
  if (v6 && (v6->_itemType = v5, (objc_msgSend_isValidItemType_(MEMORY[0x263F50070], v7, v5, v8) & 1) == 0))
  {
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v4 = (SEMCascadeItemTypeFilter *)a3;
  uint64_t v5 = v4;
  if (v4 == self)
  {
    char isEqualToCascadeItemTypeFilter = 1;
  }
  else if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    char isEqualToCascadeItemTypeFilter = objc_msgSend_isEqualToCascadeItemTypeFilter_(self, v6, (uint64_t)v5, v7);
  }
  else
  {
    char isEqualToCascadeItemTypeFilter = 0;
  }
...
- (BOOL)isEqualToCascadeItemTypeFilter:(id)a3
{
  ...
  return itemType == objc_msgSend_itemType(a3, a2, (uint64_t)a3, v3);
}

- (id)description
{
  v11.receiver = self;
  v11.super_class = (Class)SEMCascadeItemTypeFilter;
  uint64_t v3 = [(SEMCascadeItemTypeFilter *)&v11 description];
  v6 = objc_msgSend_descriptionForTypeIdentifier_(MEMORY[0x263F50070], v4, self->_itemType, v5);
  v9 = objc_msgSend_stringByAppendingFormat_(v3, v7, @" itemType: %@", v8, v6);
...
- (unint64_t)hash
{
  uint64_t v3 = objc_msgSend_numberWithUnsignedShort_(NSNumber, a2, self->_itemType, v2);
