...
@implementation IDSQRProtoReallocateReallocate

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoReallocateReallocate;
  v4 = [(IDSQRProtoReallocateReallocate *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoReallocateReallocateReadFrom((uint64_t)self, (uint64_t)a3);
}
