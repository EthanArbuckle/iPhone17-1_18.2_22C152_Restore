...
- (id)description
{
  ...
  v4 = [(IDSQRProtoUnAllocBindResponse *)&v13 description];
...
- (id)dictionaryRepresentation
{
  ...
  if (reportingDataBlob) {
    objc_msgSend_setObject_forKey_(v5, v6, (uint64_t)reportingDataBlob, v7, @"reporting_data_blob");
  }
  return v8;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v15 = objc_msgSend_copyWithZone_(self->_reportingDataBlob, v13, (uint64_t)a3, v14);
  v16 = (void *)v12[1];
  v12[1] = v15;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5, v7))
  {
    ...
    if ((unint64_t)reportingDataBlob | v11) {
      char isEqual = objc_msgSend_isEqual_(reportingDataBlob, v8, v11, v9);
    }
    else {
      char isEqual = 1;
    }
