...
- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoPluginControlPluginControl;
  v4 = [(IDSQRProtoPluginControlPluginControl *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoPluginControlPluginControlReadFrom((uint64_t)self, (uint64_t)a3);
}
