...
- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoUnAllocBindUnAllocBind;
  v4 = [(IDSQRProtoUnAllocBindUnAllocBind *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoUnAllocBindUnAllocBindReadFrom((uint64_t)self, (uint64_t)a3);
}
