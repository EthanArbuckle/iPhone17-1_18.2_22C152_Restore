...
- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoDiagnosticDiagnostic;
  v4 = [(IDSQRProtoDiagnosticDiagnostic *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoDiagnosticDiagnosticReadFrom((uint64_t)self, (uint64_t)a3);
}
