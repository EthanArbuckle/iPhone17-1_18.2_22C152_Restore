...
@implementation IDSQRProtoPutMaterialResponse

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoPutMaterialResponse;
  v4 = [(IDSQRProtoPutMaterialResponse *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoPutMaterialResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
