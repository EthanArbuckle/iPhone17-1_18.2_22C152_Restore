...
- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoH3EndToEndChannelUnRegisterE2EChannelUnRegister;
  v4 = [(IDSQRProtoH3EndToEndChannelUnRegisterE2EChannelUnRegister *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoH3EndToEndChannelUnRegisterE2EChannelUnRegisterReadFrom((uint64_t)self, (uint64_t)a3);
}
