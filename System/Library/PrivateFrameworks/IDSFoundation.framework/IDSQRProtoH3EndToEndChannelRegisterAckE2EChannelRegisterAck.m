...
- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoH3EndToEndChannelRegisterAckE2EChannelRegisterAck;
  v4 = [(IDSQRProtoH3EndToEndChannelRegisterAckE2EChannelRegisterAck *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoH3EndToEndChannelRegisterAckE2EChannelRegisterAckReadFrom((uint64_t)self, (uint64_t)a3);
}
