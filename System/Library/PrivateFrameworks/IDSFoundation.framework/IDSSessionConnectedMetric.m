...
- (IDSSessionConnectedMetric)initWithGuid:(id)a3;
...
- (NSString)name
{
  return (NSString *)@"SessionConnected";
}
...
- (IDSSessionConnectedMetric)initWithGuid:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IDSSessionConnectedMetric;
  double v6 = [(IDSSessionConnectedMetric *)&v9 init];
  v7 = v6;
  if (v6) {
