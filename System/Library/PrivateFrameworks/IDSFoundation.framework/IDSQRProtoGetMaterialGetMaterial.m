@interface IDSQRProtoGetMaterialGetMaterial
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation IDSQRProtoGetMaterialGetMaterial

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoGetMaterialGetMaterial;
  v4 = [(IDSQRProtoGetMaterialGetMaterial *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoGetMaterialGetMaterialReadFrom((uint64_t)self, (uint64_t)a3);
}
