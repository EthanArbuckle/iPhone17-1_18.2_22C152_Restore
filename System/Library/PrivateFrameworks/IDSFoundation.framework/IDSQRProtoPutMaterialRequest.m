@interface IDSQRProtoPutMaterialRequest
+ (Class)materialsType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation IDSQRProtoPutMaterialRequest
...
- (id)description
{
  double v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoPutMaterialRequest;
  v4 = [(IDSQRProtoPutMaterialRequest *)&v13 description];
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_materials, v6, v7, v8))
  {
    ...
    uint64_t v13 = objc_msgSend_count(self->_materials, v10, v11, v12);
    ...
    objc_msgSend_setObject_forKey_(v5, v30, (uint64_t)v16, v31, @"materials");
  }
  return v5;
}
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoPutMaterialRequestReadFrom(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_materialsCount(self, v4, v5, v6))
  {
    ...
    if (v13)
    {
      ...
      {
        v18 = objc_msgSend_materialsAtIndex_(self, v14, i, v15);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5, v7))
  {
    ...
    if ((unint64_t)materials | v11) {
      char isEqual = objc_msgSend_isEqual_(materials, v8, v11, v9);
    }
    else {
      char isEqual = 1;
    }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addMaterials_(self, v8, *(void *)(*((void *)&v13 + 1) + 8 * v12++), v9, (void)v13);
      }
      while (v10 != v12);
