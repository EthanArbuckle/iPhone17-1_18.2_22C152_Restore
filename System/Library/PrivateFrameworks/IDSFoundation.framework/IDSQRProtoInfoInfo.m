...
@implementation IDSQRProtoInfoInfo

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoInfoInfo;
  v4 = [(IDSQRProtoInfoInfo *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoInfoInfoReadFrom((uint64_t)self, (uint64_t)a3);
}
