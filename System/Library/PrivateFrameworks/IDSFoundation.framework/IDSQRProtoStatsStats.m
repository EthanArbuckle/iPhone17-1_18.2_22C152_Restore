...
@implementation IDSQRProtoStatsStats

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoStatsStats;
  v4 = [(IDSQRProtoStatsStats *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoStatsStatsReadFrom((uint64_t)self, (uint64_t)a3);
}
