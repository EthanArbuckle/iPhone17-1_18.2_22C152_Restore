...
- (id)description
{
  id v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoAllocBindJoinInfo;
  double v4 = [(IDSQRProtoAllocBindJoinInfo *)&v13 description];
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    ...
    if (reason)
    {
      ...
      {
        v17 = @"NEWLY_JOINED";
        objc_msgSend_setObject_forKey_(v7, v5, @"NEWLY_JOINED", v8, @"reason");
      }
      else
      {
        objc_msgSend_stringWithFormat_(NSString, v5, @"(unknown: %i)", v8, self->_reason);
        v17 = (__CFString *)objc_claimAutoreleasedReturnValue();
        objc_msgSend_setObject_forKey_(v7, v18, (uint64_t)v17, v19, @"reason");
      }
    }
    else
    {
      v17 = @"NONE";
      objc_msgSend_setObject_forKey_(v7, v5, @"NONE", v8, @"reason");
    }
  }
  return v7;
}
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoAllocBindJoinInfoReadFrom((uint64_t)self, (uint64_t)a3);
}
