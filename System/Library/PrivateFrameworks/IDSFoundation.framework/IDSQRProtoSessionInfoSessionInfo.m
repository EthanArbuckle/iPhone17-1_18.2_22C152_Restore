...
@implementation IDSQRProtoSessionInfoSessionInfo

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoSessionInfoSessionInfo;
  v4 = [(IDSQRProtoSessionInfoSessionInfo *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoSessionInfoSessionInfoReadFrom((uint64_t)self, (uint64_t)a3);
}
