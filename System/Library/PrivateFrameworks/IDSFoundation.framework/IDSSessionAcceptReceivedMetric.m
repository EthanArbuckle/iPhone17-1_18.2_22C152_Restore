...
- (IDSSessionAcceptReceivedMetric)initWithGuid:(id)a3;
...
- (NSString)name
{
  return (NSString *)@"IDSSessionAcceptReceived";
}
...
- (IDSSessionAcceptReceivedMetric)initWithGuid:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)IDSSessionAcceptReceivedMetric;
  double v6 = [(IDSSessionAcceptReceivedMetric *)&v9 init];
  v7 = v6;
  if (v6) {
