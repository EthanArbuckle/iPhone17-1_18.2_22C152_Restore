...
- (id)description
{
  ...
  v4 = [(IDSQRProtoH3EndToEndChannelUnRegisterIndication *)&v13 description];
...
- (id)dictionaryRepresentation
{
  ...
  double v10 = objc_msgSend_numberWithUnsignedLongLong_(NSNumber, v6, self->_txnId, v7);
  objc_msgSend_setObject_forKey_(v8, v11, (uint64_t)v10, v12, @"txn_id");
...
- (BOOL)isEqual:(id)a3
{
  ...
  BOOL v12 = objc_msgSend_isMemberOfClass_(v4, v6, v5, v7)
