...
- (id)description
{
  ...
  v4 = [(IDSQRProtoH3EndToEndChannelRegisterResponse *)&v13 description];
...
- (id)dictionaryRepresentation
{
  ...
  if (virtualQuicServerConnectionId) {
    objc_msgSend_setObject_forKey_(v5, v6, (uint64_t)virtualQuicServerConnectionId, v7, @"virtual_quic_server_connection_id");
  }
  channelInfo = self->_channelInfo;
  if (channelInfo)
  {
    v11 = objc_msgSend_dictionaryRepresentation(channelInfo, v6, (uint64_t)virtualQuicServerConnectionId, v7);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v15 = objc_msgSend_copyWithZone_(self->_virtualQuicServerConnectionId, v13, (uint64_t)a3, v14);
  v16 = (void *)v12[2];
  v12[2] = v15;
...
- (unint64_t)hash
{
  uint64_t v5 = objc_msgSend_hash(self->_virtualQuicServerConnectionId, a2, v2, v3);
