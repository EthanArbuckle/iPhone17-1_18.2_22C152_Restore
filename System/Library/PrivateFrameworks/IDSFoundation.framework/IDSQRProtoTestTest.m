...
@implementation IDSQRProtoTestTest

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoTestTest;
  v4 = [(IDSQRProtoTestTest *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoTestTestReadFrom((uint64_t)self, (uint64_t)a3);
}
