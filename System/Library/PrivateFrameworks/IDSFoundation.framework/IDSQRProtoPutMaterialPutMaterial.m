...
@implementation IDSQRProtoPutMaterialPutMaterial

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoPutMaterialPutMaterial;
  v4 = [(IDSQRProtoPutMaterialPutMaterial *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoPutMaterialPutMaterialReadFrom((uint64_t)self, (uint64_t)a3);
}
