...
@implementation IDSQRProtoAllocBindAllocBind

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoAllocBindAllocBind;
  v4 = [(IDSQRProtoAllocBindAllocBind *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoAllocBindAllocBindReadFrom((uint64_t)self, (uint64_t)a3);
}
