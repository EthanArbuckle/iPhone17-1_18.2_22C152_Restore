...
- (NSString)name
{
  return (NSString *)@"IDSRegistrationProfileOperationValidateInvitationContext";
}
...
- (IDSRegistrationProfileOperationValidateInvitationContext)initWithGuid:(id)a3 success:(BOOL)a4 connectionType:(unsigned int)a5 resultCode:(unsigned int)a6 registrationError:(unsigned int)a7 genericError:(id)a8 URLError:(id)a9 POSIXError:(id)a10
{
  ...
  id v17 = a10;
  v24.receiver = self;
  v24.super_class = (Class)IDSRegistrationProfileOperationValidateInvitationContext;
  uint64_t v18 = [(IDSRegistrationProfileOperationValidateInvitationContext *)&v24 init];
  double v19 = v18;
  if (v18)
  {
