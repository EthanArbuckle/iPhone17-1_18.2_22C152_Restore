...
@implementation IDSQRProtoGetMaterialResponse
...
- (id)description
{
  double v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoGetMaterialResponse;
  v4 = [(IDSQRProtoGetMaterialResponse *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoGetMaterialResponseReadFrom(self, (uint64_t)a3);
}
