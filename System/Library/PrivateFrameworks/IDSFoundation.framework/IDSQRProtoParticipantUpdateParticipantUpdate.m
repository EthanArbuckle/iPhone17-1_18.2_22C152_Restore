@interface IDSQRProtoParticipantUpdateParticipantUpdate
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation IDSQRProtoParticipantUpdateParticipantUpdate

- (id)description
{
  v3 = NSString;
  v13.receiver = self;
  v13.super_class = (Class)IDSQRProtoParticipantUpdateParticipantUpdate;
  v4 = [(IDSQRProtoParticipantUpdateParticipantUpdate *)&v13 description];
...
- (BOOL)readFrom:(id)a3
{
  return IDSQRProtoParticipantUpdateParticipantUpdateReadFrom((uint64_t)self, (uint64_t)a3);
}
