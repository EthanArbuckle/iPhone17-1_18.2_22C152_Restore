...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = objc_msgSend_numberWithBool_(NSNumber, v4, self->_odmlEnabled);
    objc_msgSend_setObject_forKey_(v6, v8, (uint64_t)v7, @"odmlEnabled");
  }
  if (objc_msgSend_count(self->_features, v4, v5))
  {
    id v9 = objc_alloc(MEMORY[0x1E4F1CA48]);
    uint64_t v12 = objc_msgSend_count(self->_features, v10, v11);
    ...
    objc_msgSend_setObject_forKey_(v6, v25, (uint64_t)v14, @"features");
  }
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_featuresCount(self, v5, v6))
  {
    ...
    uint64_t v11 = objc_msgSend_featuresCount(self, v9, v10);
    if (v11)
    {
      uint64_t v13 = v11;
      for (uint64_t i = 0; i != v13; ++i)
      {
        long long v15 = objc_msgSend_featuresAtIndex_(self, v12, i);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(unsigned char *)(v10 + 16) = self->_odmlEnabled;
...
LABEL_12:
  ...
  if ((unint64_t)features | v11) {
    char isEqual = objc_msgSend_isEqual_(features, v7, v11);
  }
  else {
    char isEqual = 1;
  }
...
{
  if (*(unsigned char *)&self->_has) {
    uint64_t v3 = 2654435761 * self->_odmlEnabled;
  }
  else {
    uint64_t v3 = 0;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((unsigned char *)v4 + 20))
  {
    self->_odmlEnabled = *((unsigned char *)v4 + 16);
    *(unsigned char *)&self->_has |= 1u;
  }
  long long v15 = 0u;
  long long v16 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addFeatures_(self, v9, *(void *)(*((void *)&v13 + 1) + 8 * v12++), (void)v13);
      }
      while (v10 != v12);
