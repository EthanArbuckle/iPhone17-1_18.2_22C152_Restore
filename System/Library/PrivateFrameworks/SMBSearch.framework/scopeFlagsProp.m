...
- (scopeFlagsProp)initWithScopeFlagsArr:(id)a3 UseExtBTypes:(BOOL)a4
{
  ...
  if (v7)
  {
    ...
    if (!v10)
    {
      ...
      if (v11) {
        -[scopeFlagsProp initWithScopeFlagsArr:UseExtBTypes:](v11, v12, v13, v14, v15, v16, v17, v18);
      }
      goto LABEL_15;
    }
    if (v4)
    {
      if ([(cbaseVariant *)v10 setVectorWithType:3 ValueArray:v6])
      {
        if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
          -[scopeFlagsProp initWithScopeFlagsArr:UseExtBTypes:]();
        }
LABEL_15:
    ...
    else if ([(cbaseVariant *)v10 setArrayWithType:3 ValueArray:v6])
    {
      if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
    ...
    v19 = [[cdbProp alloc] initWithPropID:4];
    cProps = v7->_cProps;
    v7->_cProps = v19;
    ...
    if (!v7->_cProps)
    {
      ...
      if (v21) {
        -[scopeFlagsProp initWithScopeFlagsArr:UseExtBTypes:](v21, v22, v23, v24, v25, v26, v27, v28);
      }
      goto LABEL_15;
    }
  }
...
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5
{
  ...
  {
    if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
      -[scopeFlagsProp encodeBuffer:BufferOffset:BytesWritten:]();
    }
    int v11 = 12;
  }
  else
  {
    id v9 = v8;
    [v9 bytes];
    v10 = [(scopeFlagsProp *)self cProps];
    ...
    else
    {
      int v13 = v16;
      uint64_t v14 = (v16 + v6);
      uint64_t v15 = [(scopeFlagsProp *)self variant];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "scopeFlagsProp:initWithScopeFlagsArr: setVectorWithType error: %d\n", v1, v2, v3, v4, v5);
}

- (void)initWithScopeFlagsArr:UseExtBTypes:.cold.4()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "scopeFlagsProp:initWithScopeFlagsArr: setArrayWithType error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "scopeFlagsProp:encodeBuffer: encode variant error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "scopeFlagsProp:encodeBuffer: encode cProps error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.3()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_4(&dword_235F82000, &_os_log_internal, v0, "scopeFlagsProp:encodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
}
