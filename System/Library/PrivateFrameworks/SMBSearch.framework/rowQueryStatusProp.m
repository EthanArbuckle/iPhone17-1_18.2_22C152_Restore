@interface rowQueryStatusProp
- (cbaseVariant)variant;
- (cdbProp)cProps;
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5;
- (rowQueryStatusProp)initWithInt:(int)a3;
- (unsigned)propertyID;
- (void)setCProps:(id)a3;
- (void)setVariant:(id)a3;
@end

@implementation rowQueryStatusProp

- (rowQueryStatusProp)initWithInt:(int)a3
{
  uint64_t v3 = *(void *)&a3;
  v36.receiver = self;
  v36.super_class = (Class)rowQueryStatusProp;
  v4 = [(rowQueryStatusProp *)&v36 init];
  if (v4)
  {
    ...
    if (v4->_variant)
    {
      ...
      if (v7)
      {
        ...
        if ([(cbaseVariant *)v4->_variant setScalarType:3 ScalarValue:v7])
        {
          if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
            -[rowQueryStatusProp initWithInt:].cold.4();
          }
        }
        else
        {
          v26 = [[cdbProp alloc] initWithPropID:2];
          cProps = v4->_cProps;
          v4->_cProps = v26;
          ...
          if (v28) {
            -[rowQueryStatusProp initWithInt:](v28, v29, v30, v31, v32, v33, v34, v35);
          }
        }
        goto LABEL_13;
      }
      ...
      if (v17) {
        -[rowQueryStatusProp initWithInt:](v17, v18, v19, v20, v21, v22, v23, v24);
      }
    }
    else
    {
      ...
      if (v9) {
        -[rowQueryStatusProp initWithInt:](v9, v10, v11, v12, v13, v14, v15, v16);
      }
    }
    v8 = 0;
LABEL_13:
...
- (unsigned)propertyID
{
  v2 = [(rowQueryStatusProp *)self cProps];
...
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5
{
  ...
  {
    if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
      -[rowQueryStatusProp encodeBuffer:BufferOffset:BytesWritten:]();
    }
    int v11 = 12;
  }
  else
  {
    id v9 = v8;
    [v9 bytes];
    uint64_t v10 = [(rowQueryStatusProp *)self cProps];
    ...
    else
    {
      int v13 = v16;
      uint64_t v14 = (v16 + v6);
      uint64_t v15 = [(rowQueryStatusProp *)self variant];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "rowQueryStatusProp:init: setScalarType error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.1()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "rowQueryStatusProp:encodeBuffer: encode variant error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "rowQueryStatusProp:encodeBuffer: encode cProps error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.3()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_4(&dword_235F82000, &_os_log_internal, v0, "rowQueryStatusProp:encodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
}
