@interface queryRestrictionProp
...
- (queryRestrictionProp)initWithRestrictionStr:(id)a3
{
  ...
  v5 = [(queryRestrictionProp *)&v36 init];
  if (v5)
  {
    ...
    if (v8)
    {
      if ([(cbaseVariant *)v8 setStringType:8 UTF8Str:v4])
      {
        ...
        if (v9) {
          -[queryRestrictionProp initWithRestrictionStr:](v9, v10, v11, v12, v13, v14, v15, v16);
        }
      }
      else
      {
        ...
        if (v28) {
          -[queryRestrictionProp initWithRestrictionStr:](v28, v29, v30, v31, v32, v33, v34, v35);
        }
      }
    }
    else
    {
      ...
      if (v17) {
        -[queryRestrictionProp initWithRestrictionStr:](v17, v18, v19, v20, v21, v22, v23, v24);
      }
    }
...
- (unsigned)propertyID
{
  v2 = [(queryRestrictionProp *)self cProps];
...
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5
{
  ...
  if ([v8 length] <= (unint64_t)v6)
  {
    if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
      -[queryRestrictionProp encodeBuffer:BufferOffset:BytesWritten:]();
    }
    int v11 = 12;
  }
  else
  {
    id v9 = v8;
    [v9 bytes];
    uint64_t v10 = [(queryRestrictionProp *)self cProps];
    ...
    else
    {
      int v13 = v16;
      uint64_t v14 = (v16 + v6);
      uint64_t v15 = [(queryRestrictionProp *)self variant];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "queryRestrictionProp:encodeBuffer: encode variant error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "queryRestrictionProp:encodeBuffer: encode cProps error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.3()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_4(&dword_235F82000, &_os_log_internal, v0, "queryRestrictionProp:encodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
}
