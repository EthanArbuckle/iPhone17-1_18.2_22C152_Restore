...
- (machineProp)initWithServerMachine:(id)a3 UseExtBTypes:(BOOL)a4
{
  ...
  if (v7)
  {
    ...
    if (!v10)
    {
      ...
      if (v19) {
        -[machineProp initWithServerMachine:UseExtBTypes:](v19, v20, v21, v22, v23, v24, v25, v26);
      }
      goto LABEL_15;
    }
    if (v4)
    {
      if ([(cbaseVariant *)v10 setStringType:31 UTF8Str:v6])
      {
        ...
        if (v11) {
          -[machineProp initWithServerMachine:UseExtBTypes:](v11, v12, v13, v14, v15, v16, v17, v18);
        }
LABEL_15:
    ...
    if (!v7->_cProps)
    {
      ...
      if (v37) {
        -[machineProp initWithServerMachine:UseExtBTypes:](v37, v38, v39, v40, v41, v42, v43, v44);
      }
      goto LABEL_15;
    }
  }
...
- (int)encodeBuffer:(id)a3 BufferOffset:(unsigned int)a4 BytesWritten:(unsigned int *)a5
{
  ...
  if ([v8 length] <= (unint64_t)v6)
  {
    if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_ERROR)) {
      -[machineProp encodeBuffer:BufferOffset:BytesWritten:]();
    }
    int v11 = 12;
  }
  else
  {
    ...
    else
    {
      int v13 = v16;
      uint64_t v14 = (v16 + v6);
      uint64_t v15 = [(machineProp *)self variant];
...
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "machineProp:encodeBuffer: encode variant error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.2()
{
  OUTLINED_FUNCTION_3();
  OUTLINED_FUNCTION_1(&dword_235F82000, &_os_log_internal, v0, "machineProp:encodeBuffer: encode cProps error: %d\n", v1, v2, v3, v4, v5);
}

- (void)encodeBuffer:BufferOffset:BytesWritten:.cold.3()
{
  OUTLINED_FUNCTION_2();
  OUTLINED_FUNCTION_4(&dword_235F82000, &_os_log_internal, v0, "machineProp:encodeBuffer: no buffer space, bLen: %llu, bOffset: %u\n", v1, v2, v3, v4, v5);
}
