...
uint64_t __45__ISSSURLBag_getTrustForURL_completionBlock___block_invoke_2(uint64_t a1)
{
...
uint64_t __46__ISSSURLBag_loadValueForKey_completionBlock___block_invoke_2(uint64_t a1)
{
...
- (id)valueForKey:(id)a3 error:(id *)a4
{
  ...
  id v8 = v7;
  id v13 = v8;
  [(ISSSURLBag *)self loadValueForKey:v6 completionBlock:v12];
...
{
  *(void *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) = [*(id *)(*(void *)(a1 + 32) + 72) URLBagDictionary];
...
uint64_t __38__ISSSURLBag_loadWithCompletionBlock___block_invoke_2(uint64_t a1)
{
  return (*(uint64_t (**)(void, void, void))(*(void *)(a1 + 40) + 16))(*(void *)(a1 + 40), *(void *)(a1 + 32), 0);
}
...
{
  *(void *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) = [*(id *)(*(void *)(a1 + 32) + 72) storeFrontIdentifier];
...
- (void)_enqueueOperationWithContext:(id)a3 completionBlock:(id)a4
{
  ...
  id v12 = (void *)MEMORY[0x2166C7C80](v8);
  ...
  if (!self->_operation)
  {
    ...
    id v14 = [[ISLoadURLBagOperation alloc] initWithBagContext:v6];
...
void __59__ISSSURLBag__enqueueOperationWithContext_completionBlock___block_invoke(id *a1)
{
  v1 = a1;
