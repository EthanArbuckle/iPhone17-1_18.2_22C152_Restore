...
- (ASDatabaseCompetitionListEntryJournalEntry)initWithCompetitionList:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ASDatabaseCompetitionListEntryJournalEntry;
  v6 = [(ASDatabaseCompetitionListEntryJournalEntry *)&v9 init];
  v7 = v6;
  if (v6) {
    objc_storeStrong((id *)&v6->_competitionList, a3);
  }
...
- (ASDatabaseCompetitionListEntryJournalEntry)initWithCoder:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)ASDatabaseCompetitionListEntryJournalEntry;
  id v5 = [(HDJournalEntry *)&v10 initWithCoder:v4];
  if (v5)
  {
    v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"competition_list"];
    uint64_t v7 = [objc_alloc(MEMORY[0x263F23B50]) initWithData:v6];
    competitionList = v5->_competitionList;
    v5->_competitionList = (ASCodableDatabaseCompetitionListEntry *)v7;
  }
  return v5;
}
...
{
  v8.receiver = self;
  v8.super_class = (Class)ASDatabaseCompetitionListEntryJournalEntry;
  id v4 = a3;
  [(HDJournalEntry *)&v8 encodeWithCoder:v4];
  id v5 = objc_alloc(MEMORY[0x263EFF8F8]);
  v6 = [(ASCodableDatabaseCompetitionListEntry *)self->_competitionList data];
  ...
  if (v8)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v12 = objc_msgSend(*(id *)(*((void *)&v16 + 1) + 8 * v11), "competitionList", (void)v16);
        id v13 = +[ASDatabaseCompetitionListEntryEntity _insertCompetitionList:v12 database:v6 error:a3];
...
+ (void)applyEntries:withProfile:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2_0(&dword_2474C9000, v0, v1, "Error inserting journaled competition lists %@: %{public}@");
}
