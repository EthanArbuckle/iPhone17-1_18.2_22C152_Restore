@interface PNRProvisionalMetrics
...
- (PNRProvisionalMetrics)initWithDictionary:(id)a3;
- (PNRProvisionalMetrics)initWithJSON:(id)a3;
- (double)metricsValue;
...
- (BOOL)readFrom:(id)a3
{
  return PNRProvisionalMetricsReadFrom(self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  ...
  v5 = [(PNRProvisionalMetrics *)self startTimestampEventName];
  ...
  v6 = [(PNRProvisionalMetrics *)self endTimestampEventName];
...
- (BOOL)isEqual:(id)a3
{
  ...
  $6E51C8D7FCAA56AD72E55EF27F412CC7 has = self->_has;
  ...
  {
    double metricsValue = self->_metricsValue;
    [v4 metricsValue];
    if (metricsValue != v8) {
      goto LABEL_22;
    }
  ...
  v11 = [(PNRProvisionalMetrics *)self startTimestampEventName];
  v12 = [v4 startTimestampEventName];
  if ((v11 == 0) == (v12 != 0)) {
    goto LABEL_21;
  }
  uint64_t v13 = [(PNRProvisionalMetrics *)self startTimestampEventName];
  if (v13)
  {
    v14 = (void *)v13;
    v15 = [(PNRProvisionalMetrics *)self startTimestampEventName];
  ...
  v11 = [(PNRProvisionalMetrics *)self endTimestampEventName];
  v12 = [v4 endTimestampEventName];
  if ((v11 == 0) != (v12 != 0))
  {
    uint64_t v20 = [(PNRProvisionalMetrics *)self endTimestampEventName];
    if (!v20)
    {
...
LABEL_25:
    ...
    v21 = (void *)v20;
    v22 = [(PNRProvisionalMetrics *)self endTimestampEventName];
...
- (unint64_t)hash
{
  ...
  {
    double metricsValue = self->_metricsValue;
    double v6 = -metricsValue;
    if (metricsValue >= 0.0) {
      double v6 = self->_metricsValue;
    }
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 4) != 0)
  {
    unint64_t v4 = objc_msgSend(NSNumber, "numberWithLongLong:", -[PNRProvisionalMetrics endTimestamp](self, "endTimestamp"));
    [v3 setObject:v4 forKeyedSubscript:@"endTimestamp"];
  }
  if (self->_endTimestampEventName)
  {
    v5 = [(PNRProvisionalMetrics *)self endTimestampEventName];
  ...
  {
    double v8 = NSNumber;
    [(PNRProvisionalMetrics *)self metricsValue];
    uint64_t v9 = objc_msgSend(v8, "numberWithDouble:");
    [v3 setObject:v9 forKeyedSubscript:@"metricsValue"];

    char has = (char)self->_has;
  }
  if ((has & 2) != 0)
  {
    NSUInteger v10 = objc_msgSend(NSNumber, "numberWithLongLong:", -[PNRProvisionalMetrics startTimestamp](self, "startTimestamp"));
    [v3 setObject:v10 forKeyedSubscript:@"startTimestamp"];
  }
  if (self->_startTimestampEventName)
  {
    uint64_t v11 = [(PNRProvisionalMetrics *)self startTimestampEventName];
    v12 = (void *)[v11 copy];
    [v3 setObject:v12 forKeyedSubscript:@"startTimestampEventName"];
  }
  [(PNRProvisionalMetrics *)self willProduceDictionaryRepresentation:v3];
...
- (NSData)jsonData
{
  v2 = [(PNRProvisionalMetrics *)self dictionaryRepresentation];
...
- (PNRProvisionalMetrics)initWithJSON:(id)a3
{
  ...
  {
    self = [(PNRProvisionalMetrics *)self initWithDictionary:v4];
    v5 = self;
  }
...
- (PNRProvisionalMetrics)initWithDictionary:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)PNRProvisionalMetrics;
  v5 = [(PNRProvisionalMetrics *)&v15 init];
  if (v5)
  {
    double v6 = [v4 objectForKeyedSubscript:@"metricsValue"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      [v6 doubleValue];
      -[PNRProvisionalMetrics setMetricsValue:](v5, "setMetricsValue:");
    }
    uint64_t v7 = [v4 objectForKeyedSubscript:@"startTimestamp"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PNRProvisionalMetrics setStartTimestamp:](v5, "setStartTimestamp:", [v7 longLongValue]);
    }
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      [(PNRProvisionalMetrics *)v5 setStartTimestampEventName:v9];
    }
    NSUInteger v10 = [v4 objectForKeyedSubscript:@"endTimestamp"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      -[PNRProvisionalMetrics setEndTimestamp:](v5, "setEndTimestamp:", [v10 longLongValue]);
    }
    ...
    {
      v12 = (void *)[v11 copy];
      [(PNRProvisionalMetrics *)v5 setEndTimestampEventName:v12];
    }
    uint64_t v13 = v5;
  }
  return v5;
