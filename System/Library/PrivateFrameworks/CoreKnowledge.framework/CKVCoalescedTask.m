...
void __64__CKVCoalescedTask__runBlockForTask_completionQueue_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)CKLogContextVocabulary, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v8 = 2112;
    uint64_t v9 = v3;
    _os_log_impl(&dword_1A77B3000, v2, OS_LOG_TYPE_INFO, "%s Executing task - (%@)", (uint8_t *)&v6, 0x16u);
  }
  ...
  if (os_log_type_enabled((os_log_t)CKLogContextVocabulary, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v8 = 2112;
    uint64_t v9 = v5;
    _os_log_impl(&dword_1A77B3000, v4, OS_LOG_TYPE_INFO, "%s Finished executing task - (%@)", (uint8_t *)&v6, 0x16u);
  }
}
...
- (CKVCoalescedTask)initWithTaskId:(id)a3 eventId:(id)a4 date:(id)a5 taskBlock:(id)a6 completionQueue:(id)a7 completion:(id)a8
{
  ...
  if (v20)
  {
    ...
    uint64_t v22 = [(CKVCoalescedTask *)v21 _runBlockForTask:v17 completionQueue:v18 completion:v19];
...
- (id)description
{
  ...
  uint64_t v5 = [(NSDate *)self->_date ISO8601String];
  int v6 = [v2 stringWithFormat:@"taskId: %@, eventId: %@, received: %@", taskId, eventId, v5];
