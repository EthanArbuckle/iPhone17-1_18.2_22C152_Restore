@interface HSAuthorizedDSIDsUpdateRequest
- (HSAuthorizedDSIDsUpdateRequest)init;
- (id)canonicalResponseForResponse:(id)a3;
@end

@implementation HSAuthorizedDSIDsUpdateRequest
...
{
  v5.receiver = self;
  v5.super_class = (Class)HSAuthorizedDSIDsUpdateRequest;
  v2 = [(HSRequest *)&v5 initWithAction:@"authorized-dsids-update"];
  v3 = v2;
  if (v2) {
