...
- (void)sendDiagnosticsForItemIDs:(id)a3
{
  ...
  v13[6] = v11;
  swift_retain();
  sub_24D3F9C18(v9, v11);
  sub_24D3D3434((uint64_t)v7, (uint64_t)&unk_269870378, (uint64_t)v13);
  swift_release();
  sub_24D400DCC(v9, v11);
  swift_release();
}
