...
void __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1D21F2000, v2, OS_LOG_TYPE_INFO, "[MemoriesMusic] MusicCacheMusicKitConsistencyJob - beginning music cache music consistency job", buf, 2u);
  }
  ...
  if (WeakRetained)
  {
    ...
    v6 = (void *)MEMORY[0x1E4F8D7D8];
    v8[0] = MEMORY[0x1E4F143A8];
    v8[1] = 3221225472;
    v8[2] = __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_197;
    v8[3] = &unk_1E6918AA8;
    id v9 = *(id *)(a1 + 32);
...
void __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_197(uint64_t a1, int a2, void *a3)
{
  ...
  if (os_log_type_enabled((os_log_t)__PXLog_genericOSLog, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v8 = 2114;
    id v9 = v5;
    _os_log_impl(&dword_1D21F2000, v6, OS_LOG_TYPE_INFO, "[MemoriesMusic] MusicCacheMusicKitConsistencyJob - music cache music kit consistency job completed, success=%d, error=%{public}@", (uint8_t *)v7, 0x12u);
  }
  (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
}

uint64_t __91__PHAMusicCacheMusicKitConsistencyJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_2_198()
{
...
{
  v8.receiver = self;
  v8.super_class = (Class)PHAMusicCacheMusicKitConsistencyJob;
  ...
  if (v2)
  {
    ...
    dispatch_queue_t v5 = dispatch_queue_create("com.apple.photoanalysisd.music.cacheConsistencyJob", v4);
