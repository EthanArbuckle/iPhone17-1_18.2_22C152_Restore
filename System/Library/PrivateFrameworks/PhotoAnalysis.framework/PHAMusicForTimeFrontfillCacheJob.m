...
void __88__PHAMusicForTimeFrontfillCacheJob_runWithGraphManager_progressBlock_completionHandler___block_invoke(uint64_t a1)
{
  if (__PXLog_genericOnceToken != -1) {
    dispatch_once(&__PXLog_genericOnceToken, &__block_literal_global_8702);
  }
  v2 = __PXLog_genericOSLog;
  if (os_log_type_enabled((os_log_t)__PXLog_genericOSLog, OS_LOG_TYPE_INFO))
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1D21F2000, v2, OS_LOG_TYPE_INFO, "[MemoriesMusic] MusicForTimeCache - beginning music for time frontfill cache job", buf, 2u);
  }
  ...
  if (WeakRetained)
  {
    ...
    v6 = (void *)MEMORY[0x1E4F8D810];
    v8[0] = MEMORY[0x1E4F143A8];
    v8[1] = 3221225472;
    v8[2] = __88__PHAMusicForTimeFrontfillCacheJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_197;
    v8[3] = &unk_1E6918AA8;
    id v9 = *(id *)(a1 + 32);
...
void __88__PHAMusicForTimeFrontfillCacheJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_197(uint64_t a1, int a2, void *a3)
{
  uint64_t v10 = *MEMORY[0x1E4F143B8];
  id v5 = a3;
  if (__PXLog_genericOnceToken != -1) {
    dispatch_once(&__PXLog_genericOnceToken, &__block_literal_global_200_8707);
  }
  ...
  if (os_log_type_enabled((os_log_t)__PXLog_genericOSLog, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v8 = 2114;
    id v9 = v5;
    _os_log_impl(&dword_1D21F2000, v6, OS_LOG_TYPE_INFO, "[MemoriesMusic] MusicForTimeCache - music for time frontfill cache job completed, success=%d, error=%{public}@", (uint8_t *)v7, 0x12u);
  }
  (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
}

uint64_t __88__PHAMusicForTimeFrontfillCacheJob_runWithGraphManager_progressBlock_completionHandler___block_invoke_2_198()
{
...
{
  v8.receiver = self;
  v8.super_class = (Class)PHAMusicForTimeFrontfillCacheJob;
  ...
  if (v2)
  {
    ...
    dispatch_queue_t v5 = dispatch_queue_create("com.apple.photoanalysisd.music.timeFrontfillCacheJob", v4);
