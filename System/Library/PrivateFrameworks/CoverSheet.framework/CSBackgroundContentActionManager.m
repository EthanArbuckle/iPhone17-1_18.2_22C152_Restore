...
- (CSBackgroundContentActionManager)initWithDelegate:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)CSBackgroundContentActionManager;
...
- (BOOL)handleAction:(id)a3 forProvider:(id)a4
{
  ...
  if ([v5 isValid])
  {
    ...
    char v11 = [v10 slot];
    int v12 = [v11 isEqualToString:*MEMORY[0x1E4FA7030]];

    if (v12) {
      BOOL v9 = [(CSBackgroundContentActionManager *)self _addAction:v10];
    }
    else {
      BOOL v9 = 0;
    }
...
- (BOOL)_addAction:(id)a3
{
  ...
  id v10 = __47__CSBackgroundContentActionManager__addAction___block_invoke;
  ...
  uint64_t v6 = [(CSBackgroundContentActionManager *)self delegate];
...
void __47__CSBackgroundContentActionManager__addAction___block_invoke(uint64_t a1)
{
  v2[0] = MEMORY[0x1E4F143A8];
  v2[1] = 3221225472;
  v2[2] = __47__CSBackgroundContentActionManager__addAction___block_invoke_2;
  v2[3] = &unk_1E6AD87A8;
...
void __47__CSBackgroundContentActionManager__addAction___block_invoke_2(uint64_t a1)
{
...
- (CSBackgroundContentActionManagerDelegate)delegate
{
  ...
  return (CSBackgroundContentActionManagerDelegate *)WeakRetained;
}
