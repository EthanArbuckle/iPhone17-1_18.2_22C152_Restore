...
+ (CSRingLayer)ringLayerWithBlendMode:(id)a3 diameter:(double)a4 lineWidth:(double)a5 brightnessAmount:(double)a6 saturationAmount:(double)a7
{
  ...
  [v13 setLineCap:*MEMORY[0x1E4F3A458]];
  v14 = [MEMORY[0x1E4F39BC0] filterWithType:v12];

  [v13 setCompositingFilter:v14];
  v15 = [MEMORY[0x1E4F39BC0] brightnessFilterWithAmount:a6];
  v16 = [MEMORY[0x1E4F39BC0] saturationFilterWithAmount:a7];
  v19[0] = v15;
  v19[1] = v16;
