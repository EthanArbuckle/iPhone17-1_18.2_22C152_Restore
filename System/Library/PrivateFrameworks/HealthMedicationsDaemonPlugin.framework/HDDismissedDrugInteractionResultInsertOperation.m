    ...
    if (v9)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          if (!+[HDDismissedDrugInteractionResultEntity _insertDismissedDrugInteractionResult:transaction:error:]((uint64_t)HDDismissedDrugInteractionResultEntity, *(void **)(*((void *)&v15 + 1) + 8 * i), v7, (uint64_t)a5))
          {
            BOOL v13 = 0;
            goto LABEL_12;
          }
...
- (HDDismissedDrugInteractionResultInsertOperation)initWithCoder:(id)a3
{
  ...
  id v5 = [(HDDismissedDrugInteractionResultInsertOperation *)&v10 init];
  if (v5)
  {
    v6 = objc_msgSend(MEMORY[0x1E4F1CAD0], "hk_typesForArrayOf:", objc_opt_class());
    uint64_t v7 = [v4 decodeObjectOfClasses:v6 forKey:@"dismissed_results"];
