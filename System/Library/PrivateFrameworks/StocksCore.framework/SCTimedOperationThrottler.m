...
- (SCWOperationThrottler)operationThrottler;
...
- (SCTimedOperationThrottler)initWithDelegate:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)SCTimedOperationThrottler;
...
- (void)tickle
{
  id v2 = [(SCTimedOperationThrottler *)self operationThrottler];
  [v2 tickle];
}
...
{
  id v4 = a3;
  id v5 = [(SCTimedOperationThrottler *)self operationThrottler];
...
{
  BOOL v3 = a3;
  id v4 = [(SCTimedOperationThrottler *)self operationThrottler];
  [v4 setSuspended:v3];
}
...
- (void)operationThrottler:(id)a3 performAsyncOperationWithCompletion:(id)a4
{
  ...
  v8 = [(SCTimedOperationThrottler *)self delegate];
...
- (SCWOperationThrottlerDelegate)delegate
{
  ...
  return (SCWOperationThrottlerDelegate *)WeakRetained;
}
