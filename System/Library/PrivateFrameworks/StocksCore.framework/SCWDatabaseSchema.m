...
- (CKContainerID)containerID
{
  ...
  id v4 = objc_alloc(MEMORY[0x1E4F19ED8]);
  v5 = [(SCWDatabaseSchema *)self name];
  id v6 = (void *)[v4 initWithContainerIdentifier:v5 environment:v3];
...
- (NSArray)zoneIDs
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = [(SCWDatabaseSchema *)self zoneSchemas];
...
- (BOOL)requiresDeviceToDeviceEncryption
{
  return [(SCWDatabaseSchema *)self security] != 0;
}
