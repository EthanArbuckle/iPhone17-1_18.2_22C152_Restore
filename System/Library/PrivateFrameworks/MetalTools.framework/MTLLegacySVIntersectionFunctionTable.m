...
- (MTLLegacySVIntersectionFunctionTable)initWithIntersectionFunctionTable:(id)a3 device:(id)a4 descriptor:(id)a5;
- (MTLLegacySVIntersectionFunctionTable)initWithIntersectionFunctionTable:(id)a3 device:(id)a4 descriptor:(id)a5 computePipelineState:(id)a6;
- (MTLLegacySVIntersectionFunctionTable)initWithIntersectionFunctionTable:(id)a3 device:(id)a4 descriptor:(id)a5 renderPipelineState:(id)a6 stage:(unint64_t)a7;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTLLegacySVIntersectionFunctionTable;
...
{
  v10.receiver = self;
  v10.super_class = (Class)MTLLegacySVIntersectionFunctionTable;
  objc_super v8 = [(MTLToolsResource *)&v10 initWithBaseObject:a3 parent:a4];
  if (v8)
  {
    v8->_functionCount = [a5 functionCount];
    v8->_computePipelineState = (MTLLegacySVComputePipelineState *)a6;
...
{
  v12.receiver = self;
  v12.super_class = (Class)MTLLegacySVIntersectionFunctionTable;
  objc_super v10 = [(MTLToolsResource *)&v12 initWithBaseObject:a3 parent:a4];
  if (v10)
  {
    v10->_functionCount = [a5 functionCount];
    v10->_renderPipelineState = (MTLLegacySVRenderPipelineState *)a6;
...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  if (a5.length)
  {
    ...
    for (uint64_t i = 0; i != length; ++i)
      [(MTLLegacySVIntersectionFunctionTable *)self setBuffer:a3[i] offset:a4[i] atIndex:i];
  }
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)MTLLegacySVIntersectionFunctionTable;
