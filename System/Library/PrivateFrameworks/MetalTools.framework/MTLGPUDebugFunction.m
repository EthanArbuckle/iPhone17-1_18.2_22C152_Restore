...
- (MTLGPUDebugFunction)initWithFunction:(id)a3 library:(id)a4;
- (id).cxx_construct;
...
{
  v5.receiver = self;
  v5.super_class = (Class)MTLGPUDebugFunction;
...
+ (id)convertUserType:(id)a3
{
  ...
  else
  {
    ...
    {
      case 1:
        return +[MTLGPUDebugFunction internalStructTypeFromUserStructType:a3];
      case 2:
        return +[MTLGPUDebugFunction internalArrayTypeFromUserArrayType:a3];
      case 60:
        break;
      default:
        return a3;
...
LABEL_14:
    ...
    id v8 = 0;
LABEL_12:
    id v10 = +[MTLGPUDebugFunction convertUserType:v8];
    id v7 = v3;
    if (v10 != v8)
    {
      id v11 = v10;
...
LABEL_43:
    ...
    if (v14)
    {
      ...
      MTLDataType v17 = [[MTLGPUDebugArgumentEncoder alloc] initWithArgumentEncoder:v24 layout:v14 device:[(MTLToolsObject *)self device]];
...
- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3
{
  return [(MTLGPUDebugFunction *)self newArgumentEncoderWithBufferIndex:a3 reflection:0 pipelineLibrary:0 binaryArchives:0];
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4
{
  return [(MTLGPUDebugFunction *)self newArgumentEncoderWithBufferIndex:a3 reflection:a4 pipelineLibrary:0 binaryArchives:0];
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 pipelineLibrary:(id)a4
{
  return [(MTLGPUDebugFunction *)self newArgumentEncoderWithBufferIndex:a3 reflection:0 pipelineLibrary:a4 binaryArchives:0];
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4 pipelineLibrary:(id)a5
{
  return [(MTLGPUDebugFunction *)self newArgumentEncoderWithBufferIndex:a3 reflection:a4 pipelineLibrary:a5 binaryArchives:0];
}

- (id)newArgumentEncoderWithBufferIndex:(unint64_t)a3 reflection:(id *)a4 binaryArchives:(id)a5
{
  return [(MTLGPUDebugFunction *)self newArgumentEncoderWithBufferIndex:a3 reflection:a4 pipelineLibrary:0 binaryArchives:a5];
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)MTLGPUDebugFunction;
