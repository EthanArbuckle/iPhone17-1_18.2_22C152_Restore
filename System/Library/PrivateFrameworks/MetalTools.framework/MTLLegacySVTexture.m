...
{
  v7.receiver = self;
  v7.super_class = (Class)MTLLegacySVTexture;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTLLegacySVTexture;
...
- (id)newTextureViewWithPixelFormat:(unint64_t)a3 resourceIndex:(unint64_t)a4
{
  ...
  {
    id v6 = result;
    objc_super v7 = [[MTLLegacySVTexture alloc] initWithTextureView:result parentTexture:self heap:[(MTLToolsResource *)self heap] device:self->super.super.super._device];
...
- (id)newCompressedTextureViewWithPixelFormat:(unint64_t)a3 textureType:(unint64_t)a4 level:(unint64_t)a5 slice:(unint64_t)a6
{
  ...
  {
    id v8 = result;
    id v9 = [[MTLLegacySVTexture alloc] initWithTextureView:result parentTexture:self heap:[(MTLToolsResource *)self heap] device:self->super.super.super._device];
