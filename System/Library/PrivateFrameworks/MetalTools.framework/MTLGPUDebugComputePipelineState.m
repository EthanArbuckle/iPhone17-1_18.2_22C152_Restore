...
- (MTLGPUDebugImageData)kernelFunctionData;
...
- (void)_initConstantsBuffer:(id)a3 device:(id)a4
{
  ...
  if ([v7 length])
  {
    ...
    [(MTLGPUDebugImageData *)self->_kernelFunctionData setConstantData:v8];
  }
  if (self->_supportsIndirectCommandBuffers
    && (HIBYTE(self->super.super._device[2].dynamicLibraryObjectCache) & 0x20) != 0)
  {
    v9 = [[MTLGPUDebugPipelineStateInfoEncoder alloc] initWithDevice:self->super.super._device];
    v10 = objc_msgSend((id)objc_msgSend(a4, "baseObject"), "newBufferWithLength:options:", -[MTLGPUDebugPipelineStateInfoEncoder encodedLength](v9, "encodedLength"), 0);
    self->_indirectStateBuffer = -[MTLGPUDebugBuffer initWithBuffer:device:offset:length:track:]([MTLGPUDebugBuffer alloc], "initWithBuffer:device:offset:length:track:", v10, a4, 0, [v10 length], 0);

    [(MTLGPUDebugPipelineStateInfoEncoder *)v9 setArgumentBuffer:self->_indirectStateBuffer offset:0];
    [(MTLGPUDebugPipelineStateInfoEncoder *)v9 setComputePipelineState:self];

    if (self->_supportsIndirectCommandBuffers)
    {
      uint64_t v11 = *((void *)self->_kernelFunctionData + 1);
      if (v11) {
        GlobalResidentBufferList::addBuffer((uint64_t)a4 + 552, v11);
      }
      long long v20 = 0u;
      long long v21 = 0u;
      long long v18 = 0u;
      ...
      if (v13)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v14; ++i)
          {
            ...
            if (v17) {
              GlobalResidentBufferList::addBuffer((uint64_t)&self->super.super._device[4]._memorySize, v17);
            }
          }
...
- (MTLGPUDebugComputePipelineState)initWithComputePipelineState:(id)a3 descriptor:(id)a4 unwrappedDescriptor:(id)a5 reflection:(id)a6 device:(id)a7 pipelineOptions:(unint64_t)a8
{
  ...
  v43.receiver = self;
  v43.super_class = (Class)MTLGPUDebugComputePipelineState;
  ...
  if (v14)
  {
    ...
    if (objc_msgSend((id)objc_msgSend(a3, "debugInstrumentationData"), "userReflectionData"))
    {
      ...
      v14->_userReflection = (MTLComputePipelineReflection *)objc_msgSend(objc_alloc(MEMORY[0x263F12860]), "initWithSerializedData:dynamicLibraries:serializedStageInputDescriptor:device:options:flags:", objc_msgSend((id)objc_msgSend(a3, "debugInstrumentationData"), "userReflectionData"), objc_msgSend((id)objc_msgSend(a3, "debugInstrumentationData"), "linkedDynamicLibraries"), v30, objc_msgSend(a7, "baseObject"), 3, 0);
      objc_msgSend((id)objc_msgSend(a3, "debugInstrumentationData"), "releaseLinkedDynamicLibraries");
    ...
    [(MTLGPUDebugComputePipelineState *)v14 _initConstantsBuffer:a3 device:a7];
  }
  return v14;
}
...
- (MTLGPUDebugComputePipelineState)initWithComputePipelineState:(id)a3 binaryFunctions:(id)a4 withState:(id)a5 device:(id)a6 pipelineOptions:(unint64_t)a7
{
  ...
  v27.receiver = self;
  v27.super_class = (Class)MTLGPUDebugComputePipelineState;
  ...
  if (v11)
  {
    ...
    v12->_kernelFunctionData = (MTLGPUDebugImageData *)*((id *)a5 + 6);
    ...
    [(MTLGPUDebugComputePipelineState *)v12 _initConstantsBuffer:a3 device:v12->super.super._device];
  }
  return v12;
}
...
uint64_t __62__MTLGPUDebugComputePipelineState_functionHandleWithFunction___block_invoke(void *a1)
{
  ...
  return (uint64_t)[(MTLGPUDebugFunctionHandle *)v2 initWithFunctionHandle:v3 computePiplineState:v4 function:v5];
}
...
- (id)newComputePipelineStateWithAdditionalBinaryFunctions:(id)a3 error:(id *)a4
{
  ...
  uint64_t v13 = [[MTLGPUDebugComputePipelineState alloc] initWithComputePipelineState:v12 binaryFunctions:a3 withState:self device:self->super.super._device pipelineOptions:0];
...
- (MTLGPUDebugBuffer)globalConstantsBuffer
{
  ...
  if (kernelFunctionData) {
    return (MTLGPUDebugBuffer *)*((void *)kernelFunctionData + 1);
  }
  else {
    return 0;
  }
...
- (void)dealloc
{
  ...
  if (self->_supportsIndirectCommandBuffers)
  {
    ...
    if (v3) {
      GlobalResidentBufferList::removeBuffer((uint64_t)&self->super.super._device[4]._memorySize, v3);
    }
    long long v13 = 0u;
    long long v14 = 0u;
    long long v11 = 0u;
    ...
    if (v5)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v6; ++i)
        {
          ...
          if (v9) {
            GlobalResidentBufferList::removeBuffer((uint64_t)&self->super.super._device[4]._memorySize, v9);
          }
        }
  ...
  v10.receiver = self;
  v10.super_class = (Class)MTLGPUDebugComputePipelineState;
