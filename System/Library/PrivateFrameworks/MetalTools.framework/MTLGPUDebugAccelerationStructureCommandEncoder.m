...
- (MTLGPUDebugAccelerationStructureCommandEncoder)initWithAccelerationStructureCommandEncoder:(id)a3 parent:(id)a4 accelerationStructurePassDescriptor:(id)a5;
- (id).cxx_construct;
...
{
  v8.receiver = self;
  v8.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
...
- (void)newBaseAccelerationStructureCommandEncoder
{
  ...
  if (self->_accelerationStructurePassDescriptor) {
    uint64_t v4 = objc_msgSend(v3, "accelerationStructureCommandEncoderWithDescriptor:", -[MTLToolsObject unwrapMTLAccelerationStructurePassDescriptor:](self->super.super.super._parent, "unwrapMTLAccelerationStructurePassDescriptor:"));
  }
  else {
  ...
  for (i = (MTLGPUDebugAccelerationStructureCommandEncoder *)self->_resourceAndUsageList.__end_.__next_;
        i != (MTLGPUDebugAccelerationStructureCommandEncoder *)&self->_resourceAndUsageList;
        i = (MTLGPUDebugAccelerationStructureCommandEncoder *)i->super.super.super._parent)
  {
    baseObject = i->super.super.super._baseObject;
    device = i->super.super.super._device;
    v11.receiver = self;
    v11.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
    [(MTLToolsAccelerationStructureCommandEncoder *)&v11 useResource:baseObject usage:device];
  }
  for (j = (MTLGPUDebugAccelerationStructureCommandEncoder *)self->_heapList.__end_.__next_;
        j != (MTLGPUDebugAccelerationStructureCommandEncoder *)&self->_heapList;
        j = (MTLGPUDebugAccelerationStructureCommandEncoder *)j->super.super.super._parent)
  {
    v9 = j->super.super.super._baseObject;
    v10.receiver = self;
    v10.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
...
- (void)blitTypeFromAccelerationStructureDescriptor:(id)a3 toAccelerationStructure:(id)a4
{
  uint64_t v6 = MTLAccelerationStructureTypeFromDescriptor((MTLAccelerationStructureDescriptor *)a3);

  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitAccelerationStructureType:v6 toAccelerationStructure:a4];
}
...
- (id)encodeUnwrapAccelerationStructureDescriptor:(id)a3
{
  ...
  if ([v5 isSubclassOfClass:objc_opt_class()])
  {
    ...
    [v9 endEncoding];
    id v11 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self psoWithFunctionName:@"unwrap_acceleration_structure_descriptor_buffer"];
    ...
    for (i = (list<resourceAndUsage, std::allocator<resourceAndUsage>> *)p_resourceAndUsageList->__end_.__next_;
          i != p_resourceAndUsageList;
          i = (list<resourceAndUsage, std::allocator<resourceAndUsage>> *)i->__end_.__next_)
    {
...
LABEL_8:
  ...
  id v22 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self psoWithFunctionName:v20];
...
- (id)createChildrenWrappersBufferWithASDescriptor:(id)a3
{
  ...
  if ([v5 isSubclassOfClass:objc_opt_class()])
  {
    if ([a3 instanceCount])
    {
      id v6 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithIASDescriptor:a3];
      goto LABEL_6;
    }
    return 0;
  }
  ...
  id v6 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithIndirectIASDescriptor:a3];
LABEL_6:
  id v8 = v6;
  if (v6) {
...
{
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  id v11 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithASDescriptor:a4];
  id v12 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self encodeUnwrapAccelerationStructureDescriptor:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
  v13.receiver = self;
  v13.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  ...
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitTypeFromAccelerationStructureDescriptor:a4 toAccelerationStructure:a3];
  if (v11) {
    [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitChildrenWrappersBufferAddress:v11 toAccelerationStructure:a3];
  }
...
{
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  id v13 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithASDescriptor:a4];
  id v14 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self encodeUnwrapAccelerationStructureDescriptor:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
  v15.receiver = self;
  v15.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  ...
  if (a5)
  {
    [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitTypeFromAccelerationStructureDescriptor:a4 toAccelerationStructure:a5];
    if (v13) {
      [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitChildrenWrappersBufferAddress:v13 toAccelerationStructure:a5];
    }
  }
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
{
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  id v15 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithASDescriptor:a4];
  id v16 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self encodeUnwrapAccelerationStructureDescriptor:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
  v17.receiver = self;
  v17.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  ...
  if (a5)
  {
    [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitTypeFromAccelerationStructureDescriptor:a4 toAccelerationStructure:a5];
    if (v15) {
      [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitChildrenWrappersBufferAddress:v15 toAccelerationStructure:a5];
    }
  }
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  ...
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitTypeFromAccelerationStructure:a3 toAccelerationStructure:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitChildrenWrappersBufferFromAcceleratrionStructure:a3 toAccelerationStructure:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
...
{
  v6.receiver = self;
  v6.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
...
- (void)deserializePrimitiveAccelerationStructure:(id)a3 fromBuffer:(id)a4 serializedBufferOffset:(unint64_t)a5
{
  ...
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitPrimitiveTypetoAccelerationStructure:a3];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
- (void)deserializeInstanceAccelerationStructure:(id)a3 primitiveAccelerationStructures:(id)a4 fromBuffer:(id)a5 serializedBufferOffset:(unint64_t)a6
{
  ...
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitInstanceTypetoAccelerationStructure:a3];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
{
  v9.receiver = self;
  v9.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  ...
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitTypeFromAccelerationStructureDescriptor:a6 toAccelerationStructure:a3];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
- (void)deserializeInstanceAccelerationStructure:(id)a3 primitiveAccelerationStructures:(id)a4 fromBuffer:(id)a5 serializedBufferOffset:(unint64_t)a6 withDescriptor:(id)a7
{
  ...
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self blitTypeFromAccelerationStructureDescriptor:a7 toAccelerationStructure:a3];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
}
...
- (void)writeGenericBVHStructureOfAccelerationStructure:(id)a3 headerBuffer:(id)a4 headerBufferOffset:(unint64_t)a5 innerNodeBuffer:(id)a6 innerNodeBufferOffset:(unint64_t)a7 leafNodeBuffer:(id)a8 leafNodeBufferOffset:(unint64_t)a9 primitiveBuffer:(id)a10 primitiveBufferOffset:(unint64_t)a11 geometryBuffer:(id)a12 geometryOffset:(unint64_t)a13 instanceTransformBuffer:(id)a14 instanceTransformOffset:(unint64_t)a15 controlPointBuffer:(id)a16 controlPointBufferOffset:(unint64_t)a17
{
  v17.receiver = self;
  v17.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
  [(MTLToolsAccelerationStructureCommandEncoder *)&v17 writeGenericBVHStructureOfAccelerationStructure:a3 headerBuffer:a4 headerBufferOffset:a5 innerNodeBuffer:a6 innerNodeBufferOffset:a7 leafNodeBuffer:a8 leafNodeBufferOffset:a9 primitiveBuffer:a10 primitiveBufferOffset:a11 geometryBuffer:a12 geometryOffset:a13 instanceTransformBuffer:a14 instanceTransformOffset:a15 controlPointBuffer:a16 controlPointBufferOffset:a17];
}
...
- (void)useResource:(id)a3 usage:(unint64_t)a4
{
  ...
  v7[2] = a3;
  v7[3] = a4;
  prev = p_resourceAndUsageList->__end_.__prev_;
  void *v7 = p_resourceAndUsageList->__end_.__prev_;
  v7[1] = p_resourceAndUsageList;
  prev[1] = v7;
  p_resourceAndUsageList->__end_.__prev_ = v7;
  ++p_resourceAndUsageList->__size_alloc_.__value_;
}
...
- (void)useResources:(const void *)a3 count:(unint64_t)a4 usage:(unint64_t)a5
{
  if (a4)
  {
    ...
    do
    {
      ...
      [(MTLGPUDebugAccelerationStructureCommandEncoder *)self useResource:v9 usage:a5];
      --v6;
    }
    while (v6);
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)MTLGPUDebugAccelerationStructureCommandEncoder;
