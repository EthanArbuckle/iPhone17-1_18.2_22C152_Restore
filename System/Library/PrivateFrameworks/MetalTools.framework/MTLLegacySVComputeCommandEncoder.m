...
{
  v10.receiver = self;
  v10.super_class = (Class)MTLLegacySVComputeCommandEncoder;
  ...
  if (v6)
  {
    ...
    MTLGPUDebugStageBufferHandles::clear((MTLGPUDebugStageBufferHandles *)&v7->_handles);
...
{
  v11.receiver = self;
  v11.super_class = (Class)MTLLegacySVComputeCommandEncoder;
  v7 = [(MTLToolsComputeCommandEncoder *)&v11 initWithComputeCommandEncoder:a3 parent:a4 descriptor:a5];
  uint64_t v8 = (MTLLegacySVComputeCommandEncoder *)v7;
  if (v7)
  {
    uint64_t v9 = *((void *)v7 + 3) + 264;
    *((void *)v7 + 8) = v9;
    *((_DWORD *)v7 + 524) = a6;
    *((_DWORD *)v7 + 525) = 0;
    v7[56] = (*(void *)(v9 + 20) & 0x200000001) != 0;
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          if (*(void *)(v13 + 8))
          {
            ...
            [(MTLLegacySVComputeCommandEncoder *)self useResource:*(void *)(v13 + 8) usage:1];
          }
        }
...
- (void)setBuffer:(id)a3 offset:(unint64_t)a4 attributeStride:(unint64_t)a5 atIndex:(unint64_t)a6
{
  MTLGPUDebugStageBufferHandles::setBuffer((MTLGPUDebugStageBufferHandles *)&self->_handles, (MTLGPUDebugBuffer *)a3, (char *)a4, (void *)a5, a6);
...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  -[MTLLegacySVComputeCommandEncoder setBuffers:offsets:attributeStrides:withRange:](self, "setBuffers:offsets:attributeStrides:withRange:", a3, a4, v10, location, length);
  if (__p[0])
  {
    __p[1] = __p[0];
...
- (void)setBytes:(const void *)a3 length:(unint64_t)a4 attributeStride:(unint64_t)a5 atIndex:(unint64_t)a6
{
  id v9 = [(MTLLegacySVComputeCommandEncoder *)self temporaryBufferWithBytes:a3 length:a4];
...
- (void)dispatchThreads:(id *)a3 threadsPerThreadgroup:(id *)a4
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)MTLLegacySVComputeCommandEncoder;
...
- (void)dispatchThreadgroupsWithIndirectBuffer:(id)a3 indirectBufferOffset:(unint64_t)a4 threadsPerThreadgroup:(id *)a5
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)MTLLegacySVComputeCommandEncoder;
...
- (void)setThreadgroupMemoryLength:(unint64_t)a3 atIndex:(unint64_t)a4
{
  ...
  {
    p_threadgroup = (MTLGPUDebugThreadgroupLengths *)&self->_threadgroup;
    MTLGPUDebugThreadgroupLengths::setThreadgroupMemoryLength(p_threadgroup, a3, a4);
  }
  else
  {
    v5.receiver = self;
    v5.super_class = (Class)MTLLegacySVComputeCommandEncoder;
...
- (void)setComputePipelineState:(id)a3
{
  ...
  self->_currentPipeline = (MTLLegacySVComputePipelineState *)a3;
  v6.receiver = self;
  v6.super_class = (Class)MTLLegacySVComputeCommandEncoder;
...
- (void)endEncoding
{
  ...
  MTLGPUDebugStageBufferHandles::clear((MTLGPUDebugStageBufferHandles *)&self->_handles);

  self->_reportBuffer.buffer = 0;
  self->_reportBuffer.offset = 0;
  v3.receiver = self;
  v3.super_class = (Class)MTLLegacySVComputeCommandEncoder;
...
- (void)executeCommandsInBuffer:(id)a3 withRange:(_NSRange)a4
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)MTLLegacySVComputeCommandEncoder;
...
{
  v4.receiver = self;
  v4.super_class = (Class)MTLLegacySVComputeCommandEncoder;
