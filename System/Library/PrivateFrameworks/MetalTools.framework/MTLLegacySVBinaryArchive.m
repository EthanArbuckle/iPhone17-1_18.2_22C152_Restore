...
{
  v5.receiver = self;
  v5.super_class = (Class)MTLLegacySVBinaryArchive;
...
- (BOOL)addComputePipelineFunctionsWithDescriptor:(id)a3 error:(id *)a4
{
  ...
  id v9 = a3;
  uint64_t v6 = [(MTLDevice *)[(MTLToolsBinaryArchive *)self device] unwrapAndModifyComputePipelineDescriptor:&v9 options:&v8];
...
- (BOOL)addComputePipelineFunctionsWithDescriptor:(id)a3 options:(unint64_t)a4 error:(id *)a5
{
  unint64_t v9 = a4;
  id v10 = a3;
  uint64_t v7 = [(MTLDevice *)[(MTLToolsBinaryArchive *)self device] unwrapAndModifyComputePipelineDescriptor:&v10 options:&v9];
...
- (BOOL)addRenderPipelineFunctionsWithDescriptor:(id)a3 error:(id *)a4
{
  uint64_t v8 = 0x1000000;
  id v9 = a3;
  uint64_t v6 = [(MTLDevice *)[(MTLToolsBinaryArchive *)self device] unwrapAndModifyRenderPipelineDescriptor:&v9 options:&v8];
...
- (BOOL)addRenderPipelineFunctionsWithDescriptor:(id)a3 options:(unint64_t)a4 error:(id *)a5
{
  unint64_t v9 = a4;
  id v10 = a3;
  uint64_t v7 = [(MTLDevice *)[(MTLToolsBinaryArchive *)self device] unwrapAndModifyRenderPipelineDescriptor:&v10 options:&v9];
...
- (BOOL)addTileRenderPipelineFunctionsWithDescriptor:(id)a3 error:(id *)a4
{
  uint64_t v8 = 0x1000000;
  id v9 = a3;
  uint64_t v6 = [(MTLDevice *)[(MTLToolsBinaryArchive *)self device] unwrapAndModifyTileRenderPipelineDescriptor:&v9 options:&v8];
...
- (BOOL)addTileRenderPipelineFunctionsWithDescriptor:(id)a3 options:(unint64_t)a4 error:(id *)a5
{
  unint64_t v9 = a4;
  id v10 = a3;
  uint64_t v7 = [(MTLDevice *)[(MTLToolsBinaryArchive *)self device] unwrapAndModifyTileRenderPipelineDescriptor:&v10 options:&v9];
