...
- (id)commandBuffer
{
  v2 = -[MTLGPUDebugCommandBuffer initWithCommandBuffer:commandQueue:descriptor:]([MTLGPUDebugCommandBuffer alloc], "initWithCommandBuffer:commandQueue:descriptor:", objc_msgSend(-[MTLToolsObject baseObject](self, "baseObject"), "commandBuffer"), self, 0);
...
- (id)commandBufferWithDescriptor:(id)a3
{
  ...
  if (v7)
  {
    v8 = [[MTLGPUDebugCommandBuffer alloc] initWithCommandBuffer:v7 commandQueue:self descriptor:a3];
    return v8;
  }
  else
  {
