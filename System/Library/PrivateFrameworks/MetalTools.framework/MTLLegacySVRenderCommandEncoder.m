...
- (MTLLegacySVRenderCommandEncoder)initWithRenderCommandEncoder:(id)a3 commandBuffer:(id)a4 descriptor:(id)a5 encoderID:(unsigned int)a6
{
  ...
  if (v8)
  {
    *((void *)v8 + 8) = a4;
    *((void *)v8 + 1109) = 0;
    uint64_t v10 = *((void *)v8 + 3) + 264;
    *((void *)v8 + 1105) = v10;
    *((_DWORD *)v8 + 2216) = a6;
    *((_DWORD *)v8 + 2217) = 0;
    v8[62] = (*(void *)(v10 + 20) & 0x200000001) != 0;
...
- (MTLLegacySVRenderCommandEncoder)initWithRenderCommandEncoder:(id)a3 parallelEncoder:(id)a4 encoderID:(unsigned int)a5
{
  ...
  if (v7)
  {
    *((void *)v7 + 8) = [a4 commandBuffer];
    *((void *)v7 + 1109) = 3;
    uint64_t v8 = *((void *)v7 + 3) + 264;
    *((void *)v7 + 1105) = v8;
    v7[62] = (*(void *)(v8 + 20) & 0x200000001) != 0;
    *((_DWORD *)v7 + 2216) = a5;
    *((_DWORD *)v7 + 2217) = 0;
    MTLGPUDebugStageBufferHandles::clear((MTLGPUDebugStageBufferHandles *)(v7 + 72));
    if ((*(unsigned char *)(*((void *)v7 + 1105) + 22) & 0x80) == 0) {
      [v7 _initBufferArgumentData:*((void *)v7 + 3)];
    }
  }
...
- (void)flushBindings
{
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)[(MTLLegacySVRenderPipelineState *)self->_currentPipeline vertexFunctionData];
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)[(MTLLegacySVRenderPipelineState *)self->_currentPipeline fragmentFunctionData];
    ...
    {
      int v3 = [(MTLLegacySVRenderPipelineState *)self->_currentPipeline fragmentMaxCallStackDepth];
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)[(MTLLegacySVRenderPipelineState *)self->_currentPipeline tileFunctionData];
    -[MTLToolsObject setTileBytes:length:atIndex:](self->super.super.super._baseObject, "setTileBytes:length:atIndex:");
    if ((*(void *)&self->_options->var0 & 0x400000001) != 0)
    {
      LODWORD(v78) = 0;
      int v7 = [(MTLLegacySVRenderPipelineState *)self->_currentPipeline tileMaxCallStackDepth];
      uint64_t v8 = self->super.super.super._baseObject;
      v9 = self->_options;
      LODWORD(v78) = v7;
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)[(MTLLegacySVRenderPipelineState *)self->_currentPipeline objectFunctionData];
    -[MTLToolsObject setObjectBytes:length:atIndex:](self->super.super.super._baseObject, "setObjectBytes:length:atIndex:");
    if ((*(void *)&self->_options->var0 & 0x400000001) != 0)
    {
      LODWORD(v78) = 0;
      int v11 = [(MTLLegacySVRenderPipelineState *)self->_currentPipeline objectMaxCallStackDepth];
  ...
  {
    self->_drawID.entryPointImageID = (unint64_t)[(MTLLegacySVRenderPipelineState *)self->_currentPipeline meshFunctionData];
    -[MTLToolsObject setMeshBytes:length:atIndex:](self->super.super.super._baseObject, "setMeshBytes:length:atIndex:");
    if ((*(void *)&self->_options->var0 & 0x400000001) != 0)
    {
      LODWORD(v78) = 0;
      int v15 = [(MTLLegacySVRenderPipelineState *)self->_currentPipeline meshMaxCallStackDepth];
      ...
      do
      {
        for (uint64_t i = 0; i != v13; ++i)
        {
          ...
          if (*(void *)(v16 + 8))
          {
            ...
            [(MTLLegacySVRenderCommandEncoder *)self useResource:*(void *)(v16 + 8) usage:1];
          }
        }
...
- (void)setVertexBytes:(const void *)a3 length:(unint64_t)a4 attributeStride:(unint64_t)a5 atIndex:(unint64_t)a6
{
  id v9 = [(MTLLegacySVRenderCommandEncoder *)self temporaryBufferWithBytes:a3 length:a4];
...
- (void)_useResourceCommon:(id)a3 usage:(unint64_t)a4 stages:(optional<unsigned long>)a5
{
  ...
  -[MTLLegacySVRenderCommandEncoder useResourceInternal:usage:stages:](self, "useResourceInternal:usage:stages:", [a3 baseObject], a4, a5.var0.var1, *(void *)&a5.var1);
  if ((_BYTE)v5) {
    uint64_t v10 = var1;
  }
  else {
