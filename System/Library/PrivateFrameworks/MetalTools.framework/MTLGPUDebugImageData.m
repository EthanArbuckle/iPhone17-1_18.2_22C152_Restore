...
- (MTLGPUDebugImageData)initWithDynamicLibrary:(id)a3
{
  ...
  id v4 = [(MTLGPUDebugImageData *)&v6 init];
  *((void *)v4 + 21) = v4;
  *((void *)v4 + 2) = [a3 device];
...
- (MTLGPUDebugImageData)initWithFunction:(id)a3 debugInstrumentationData:(id)a4
{
  ...
  id v6 = [(MTLGPUDebugImageData *)&v8 init];
  *((void *)v6 + 21) = v6;
  *((void *)v6 + 2) = [a3 device];
...
- (void)_applyConstantRelocation:(id)a3
{
  ...
  {
    uint64_t v7 = [*((id *)self + 1) handleForOffset:0];
...
- (void)setConstantData:(id)a3
{
  ...
  if (a3 && [a3 length])
  {
    if (!*((void *)self + 1))
    {
      GPUDebugConstantBufferCache::getOrCreateBuffer((GPUDebugConstantBufferCache *)(*((void *)self + 2) + 432), (NSData *)a3, (uint64_t)v8);
      long long v6 = v8[1];
      *((_OWORD *)self + 6) = v8[0];
      *((_OWORD *)self + 7) = v6;
      uint64_t v7 = v10;
...
{
  if (*((void *)self + 17)) {
    GPUDebugConstantBufferCache::releaseBuffer((GPUDebugConstantBufferCache *)(*((void *)self + 2) + 432), (KeyBufferPair *)self + 2);
  }
