...
{
  v44.receiver = self;
  v44.super_class = (Class)MTLGPUDebugDevice;
  v5 = [(MTLToolsDevice *)&v44 initWithBaseObject:a3 parent:a4];
  if (!v5) {
  ...
  if (os_log_type_enabled((os_log_t)MTLGPUDebugLog(void)::logObject, OS_LOG_TYPE_DEBUG)) {
    -[MTLGPUDebugDevice initWithBaseObject:parent:]((uint64_t)v5);
  }
  v6 = (void *)[v5 newInternalBufferWithLength:1 options:256];
  *((void *)v5 + 81) = v6;
  ...
  *((_DWORD *)v5 + 70) = 1;
  ...
  uint64_t v7 = MTLGetEnvDefault();
  *((_DWORD *)v5 + 69) = v7 != 0;
  uint64_t v8 = 120403314;
  if (v7) {
    uint64_t v8 = 119800958;
  }
  *(void *)(v5 + 284) = v8 | *(void *)(v5 + 284) & 0xFFFFFFFFE8000200;
  int v9 = [a3 supportsArgumentBuffersTier2];
  uint64_t v10 = 0x1080000000;
  if (v9) {
    uint64_t v10 = 0x10A0000000;
  }
  *(void *)(v5 + 284) = v10 | *(void *)(v5 + 284) & 0xFFFFFFEF5FFFFFFFLL;
  int v11 = [a3 supportsRaytracing];
  uint64_t v12 = 0x100000000;
  if (!v11) {
    uint64_t v12 = 0;
  }
  *(void *)(v5 + 284) = *(void *)(v5 + 284) & 0xFFFFFFFEFFFFFFFFLL | v12;
  int v13 = [a3 supportsFunctionPointers];
  uint64_t v14 = 0x400000000;
  if (!v13) {
    uint64_t v14 = 0;
  }
  *(void *)(v5 + 284) = *(void *)(v5 + 284) & 0xFFFFFFFBFFFFFFFFLL | v14;
  v5[292] &= ~1u;
  int v15 = objc_msgSend((id)objc_msgSend(v5, "baseObject"), "supportsArgumentBuffersTier2");
...
LABEL_22:
  ...
  if (v15 == 1)
  {
    uint64_t v23 = *(void *)(v5 + 284);
    *((_DWORD *)v5 + 69) = 1;
    unint64_t v22 = v23 & 0xFFFFFFF9FF3ECCEBLL | 0x600C10210;
    goto LABEL_26;
  }
  if (!v15)
  {
    unint64_t v22 = *(void *)(v5 + 284) & 0xFFFFFFFFFF3FEFFFLL | 0x1000;
LABEL_26:
    *(void *)(v5 + 284) = v22;
  }
  int v24 = [v5 supportsGlobalVariableRelocationCompute];
  uint64_t v25 = 0x40000000;
  if (!v24) {
    uint64_t v25 = 0;
  }
  *(void *)(v5 + 284) = *(void *)(v5 + 284) & 0xFFFFFFFFBFFFFFFFLL | v25;
  v5[292] &= ~4u;
  ...
  *((void *)v26 + 4) = "full";
  ...
  if (v27)
  {
    ...
    if (v43 == 1)
    {
      unint64_t v32 = *(void *)(v5 + 284) | 0x10;
      goto LABEL_37;
    }
  }
  else
...
LABEL_35:
    operator delete(v26);
LABEL_36:
    unint64_t v32 = *(void *)(v5 + 284) & 0xFFFFFFFFFFFFFFEFLL;
LABEL_37:
    *(void *)(v5 + 284) = v32;
  }
  ...
  *((_DWORD *)v5 + 70) = MTLGetEnvDefault();
  ...
  if (v34)
  {
    ...
    v36 = MTLGPUDebugLog(void)::logObject;
    if (os_log_type_enabled((os_log_t)MTLGPUDebugLog(void)::logObject, OS_LOG_TYPE_DEBUG)) {
      -[MTLGPUDebugDevice initWithBaseObject:parent:](v36);
    }
    std::string::basic_string[abi:ne180100]<0>(&__p, v35);
    *((void *)v5 + 82) = MTLGPUDebugParsePerPSOList(&__p);
    if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
      operator delete(__p.__r_.__value_.__l.__data_);
    }
  }
  v37 = getenv("MTL_SHADER_VALIDATION_DISABLE_PIPELINES");
  if (v37)
  {
    v38 = v37;
    if (MTLGPUDebugLog(void)::onceToken != -1) {
    ...
    v39 = MTLGPUDebugLog(void)::logObject;
    if (os_log_type_enabled((os_log_t)MTLGPUDebugLog(void)::logObject, OS_LOG_TYPE_DEBUG)) {
      -[MTLGPUDebugDevice initWithBaseObject:parent:](v39);
    }
    std::string::basic_string[abi:ne180100]<0>(&__p, v38);
    *((void *)v5 + 83) = MTLGPUDebugParsePerPSOList(&__p);
    if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0) {
      operator delete(__p.__r_.__value_.__l.__data_);
    }
  }
  *((void *)v5 + 84) = [objc_alloc(MEMORY[0x263EFF8F8]) initWithBytesNoCopy:v5 + 264 length:28 freeWhenDone:0];
  v40 = objc_msgSend(v5, "newModifyPluginData:", objc_msgSend(*((id *)v5 + 2), "pluginData"));
  [*((id *)v5 + 2) setPluginData:v40];

  if ((*(void *)(v5 + 284) & 0x810000) == 0x10000)
  {
    *((void *)v5 + 85) = objc_alloc_init(MEMORY[0x263EFF980]);
    id v41 = objc_alloc_init(MEMORY[0x263F127B8]);
    [v41 setDataType:60];
    [v41 setArrayLength:31];
    [v41 setIndex:0];
    [v41 setAccess:1];
    [*((id *)v5 + 85) addObject:v41];
  }
  if (MTLGetEnvDefault())
  {
...
- (void)dealloc
{
  ...
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_2(&dword_23BD25000, v1, v2, "Device Dealloc - %s, %p", v3, v4, v5, v6, v7);
}
...
- (id)_modifyRenderPipelineDescriptor:(id)a3 options:(unint64_t *)a4
{
  ...
  uint64_t v7 = (void *)MEMORY[0x23ECD5710](-[MTLGPUDebugDevice _prepareBinaryLinkedFunctions:](self, "_prepareBinaryLinkedFunctions:", [a3 objectLinkedFunctions]));
  id v8 = -[MTLGPUDebugDevice loadDynamicLibrariesForFunction:insertLibraries:error:](self, "loadDynamicLibrariesForFunction:insertLibraries:error:", [a3 vertexFunction], objc_msgSend(a3, "vertexPreloadedLibraries"), &v20);
  long long v9 = v20;
  if (v20) {
    goto LABEL_5;
  }
  ...
  [(MTLGPUDebugDevice *)self _prepareInsertLibraries:v10];
  id v11 = -[MTLGPUDebugDevice loadDynamicLibrariesForFunction:insertLibraries:error:](self, "loadDynamicLibrariesForFunction:insertLibraries:error:", [a3 fragmentFunction], objc_msgSend(a3, "fragmentPreloadedLibraries"), &v20);
  long long v9 = v20;
  if (v20) {
    goto LABEL_5;
  }
  ...
  [(MTLGPUDebugDevice *)self _prepareInsertLibraries:v12];
  id v13 = -[MTLGPUDebugDevice loadDynamicLibrariesForFunction:insertLibraries:error:](self, "loadDynamicLibrariesForFunction:insertLibraries:error:", [a3 meshFunction], objc_msgSend(a3, "meshPreloadedLibraries"), &v20);
  long long v9 = v20;
  if (v20
    || (id v14 = v13,
        [a3 setMeshPreloadedLibraries:v13],
        [(MTLGPUDebugDevice *)self _prepareInsertLibraries:v14],
        v15 = -[MTLGPUDebugDevice loadDynamicLibrariesForFunction:insertLibraries:error:](self, "loadDynamicLibrariesForFunction:insertLibraries:error:", [a3 objectFunction], objc_msgSend(a3, "objectPreloadedLibraries"), &v20), (long long v9 = v20) != 0))
  {
LABEL_5:
  }
  else
  {
    ...
    [(MTLGPUDebugDevice *)self _prepareInsertLibraries:v17];
    ...
    *(_DWORD *)(v19 + 16) = [a3 maxObjectCallStackDepth];
    ...
    objc_msgSend(a3, "setGpuCompilerSPIOptions:", objc_msgSend(NSDictionary, "dictionaryWithDictionary:", -[MTLGPUDebugDevice setGPUCompilerSPIOptionShaderValidation:options:](self, "setGPUCompilerSPIOptionShaderValidation:options:", objc_msgSend(a3, "gpuCompilerSPIOptions"), *a4)));
    return v20;
  }
  return v9;
}
...
- (id)setGPUCompilerSPIOptionShaderValidation:(id)a3 options:(unint64_t)a4
{
  ...
  long long v34 = 0u;
  long long v35 = 0u;
  uint64_t v8 = [a3 countByEnumeratingWithState:&v32 objects:v36 count:16];
  if (v8)
  {
    uint64_t v9 = v8;
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        objc_msgSend(v7, "setObject:forKey:", objc_msgSend(a3, "objectForKeyedSubscript:", *(void *)(*((void *)&v32 + 1) + 8 * i)), *(void *)(*((void *)&v32 + 1) + 8 * i));
      }
      uint64_t v9 = [a3 countByEnumeratingWithState:&v32 objects:v36 count:16];
    }
    while (v9);
  }
  if ((a4 & 0x800000000) != 0)
  {
    objc_msgSend(v7, "setObject:forKey:", objc_msgSend(MEMORY[0x263EFF9D0], "null"), @"enable-shader-validation");
    id v15 = (char *)self + 264;
    uint64_t v16 = *(void *)((char *)self + 284);
    ...
    [v7 setObject:v17, objc_msgSend(NSString, "stringWithFormat:", v18, @"bounds-checking" forKey];
    uint64_t v19 = *(void *)(v15 + 20);
    ...
    [v7 setObject:v20, objc_msgSend(NSString, "stringWithFormat:", v21, @"threadgroup-memory-checks" forKey];
    uint64_t v22 = *(void *)(v15 + 20);
    ...
    [v7 setObject:v23, objc_msgSend(NSString, "stringWithFormat:", v24, @"texture-checks" forKey];
    uint64_t v25 = *(void *)(v15 + 20);
    ...
    [v7 setObject:v26, objc_msgSend(NSString, "stringWithFormat:", v27, @"resource-usage-validation" forKey];
    uint64_t v28 = *(void *)(v15 + 20);
    ...
    id v13 = (__CFString *)objc_msgSend(NSString, "stringWithFormat:", v30, @"stack-overflow");
    id v14 = v7;
    uint64_t v12 = v29;
    goto LABEL_27;
  }
  if ((a4 & 0x1000000000) != 0)
  {
    ...
    id v13 = @"disable-shader-validation";
    id v14 = v7;
LABEL_27:
...
- (id)_modifyComputePipelineDescriptor:(id)a3 options:(unint64_t *)a4
{
  ...
  id v7 = [(MTLGPUDebugDevice *)self loadDynamicLibrariesForComputeDescriptor:a3 error:&v12];
  uint64_t v8 = v7;
  if (v12)
  {
  }
  else
  {
    ...
    *uint64_t v10 = [a3 maxCallStackDepth];
    id v13 = @"MTLBoundsCheck::ComputePipelineData";
    v14[0] = v9;
    objc_msgSend(a3, "setPluginData:", objc_msgSend(NSDictionary, "dictionaryWithObjects:forKeys:count:", v14, &v13, 1));

    -[MTLGPUDebugDevice _prepareInsertLibraries:](self, "_prepareInsertLibraries:", [a3 preloadedLibraries]);
...
- (id)_modifyTilePipelineDescriptor:(id)a3 options:(unint64_t *)a4
{
  ...
  -[MTLGPUDebugDevice _prepareBinaryLinkedFunctions:](self, "_prepareBinaryLinkedFunctions:", [a3 linkedFunctions]);
  id v7 = -[MTLGPUDebugDevice loadDynamicLibrariesForFunction:insertLibraries:error:](self, "loadDynamicLibrariesForFunction:insertLibraries:error:", [a3 tileFunction], objc_msgSend(a3, "preloadedLibraries"), &v12);
  id v8 = v7;
  if (v12)
  {
  }
...
- (void)_modifyMeshRenderPipelineDescriptor:(id)a3 options:(unint64_t *)a4
{
  ...
  *(unsigned char *)uint64_t v8 = [a3 isAlphaToCoverageEnabled];
  *(_DWORD *)(v8 + 12) = [a3 maxMeshCallStackDepth];
  *(_DWORD *)(v8 + 16) = [a3 maxObjectCallStackDepth];
...
- (void)onRenderPipelineCreated:(id)a3
{
  LogInstrumentationFailures((MTLGPUDebugImageData *)[a3 vertexFunctionData], (MTLDebugInstrumentationData *)objc_msgSend(a3, "vertexDebugInstrumentationData"));
  LogInstrumentationFailures((MTLGPUDebugImageData *)[a3 fragmentFunctionData], (MTLDebugInstrumentationData *)objc_msgSend(a3, "fragmentDebugInstrumentationData"));
  uint64_t v4 = (MTLGPUDebugImageData *)[a3 tileFunctionData];
...
- (void)onComputePipelineCreated:(id)a3
{
  uint64_t v4 = (MTLGPUDebugImageData *)[a3 kernelFunctionData];
...
- (id)newCommandQueueWithDescriptor:(id)a3
{
  ...
  id v6 = [[MTLGPUDebugCommandQueue alloc] initWithCommandQueue:v5 device:self];
...
- (id)newRenderPipelineStateWithDescriptor:(id)a3 error:(id *)a4
{
  return [(MTLGPUDebugDevice *)self newRenderPipelineStateWithDescriptor:a3 options:0 reflection:0 error:a4];
}
...
- (id)newRenderPipelineStateWithDescriptor:(id)a3 options:(unint64_t)a4 reflection:(id *)a5 error:(id *)a6
{
  ...
  uint64_t v12 = (void *)[a3 vertexFunction];
  id v13 = (void *)[a3 fragmentFunction];
  id v14 = (void *)[a3 label];
  uint64_t v15 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v16 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v12, v13, 0, v14, v15, &v25);
  id v17 = [(MTLGPUDebugDevice *)self unwrapAndModifyRenderPipelineDescriptor:&v26 options:&v25];
  uint64_t v24 = 0;
  v18 = (void *)[*((id *)self + 2) newRenderPipelineStateWithDescriptor:v17 options:v25 reflection:&v24 error:a6];
  if (a6 && *a6) {
    id v19 = *a6;
  }
  if (v18)
  {
    uint64_t v20 = [MTLGPUDebugRenderPipelineState alloc];
...
- (void)newRenderPipelineStateWithDescriptor:(id)a3 options:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  id v13 = (void *)[a3 label];
  uint64_t v14 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v15 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v11, v12, 0, v13, v14, &v29);
  id v16 = [(MTLGPUDebugDevice *)self unwrapAndModifyRenderPipelineDescriptor:&v30 options:&v29];
  id v17 = (void *)*((void *)self + 2);
  uint64_t v18 = MEMORY[0x263EF8330];
  uint64_t v19 = 3221225472;
  uint64_t v20 = __84__MTLGPUDebugDevice_newRenderPipelineStateWithDescriptor_options_completionHandler___block_invoke;
  v21 = &unk_264E12E00;
  id v22 = v30;
  id v23 = v16;
  uint64_t v24 = self;
...
uint64_t __84__MTLGPUDebugDevice_newRenderPipelineStateWithDescriptor_options_completionHandler___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (a2)
  {
    uint64_t v4 = [[MTLGPUDebugRenderPipelineState alloc] initWithRenderPipelineState:a2 descriptor:*(void *)(a1 + 32) unwrappedDescriptor:*(void *)(a1 + 40) reflection:a3 device:*(void *)(a1 + 48) pipelineOptions:*(void *)(a1 + 72)];
    [(MTLGPUDebugRenderPipelineState *)v4 setUID:*(void *)(a1 + 56)];
  }
  else
  {
    uint64_t v4 = 0;
...
- (id)newRenderPipelineStateWithTileDescriptor:(id)a3 options:(unint64_t)a4 reflection:(id *)a5 error:(id *)a6
{
  ...
  uint64_t v12 = (void *)[a3 label];
  uint64_t v13 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v14 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v11, 0, 0, v12, v13, &v22);
  id v15 = [(MTLGPUDebugDevice *)self unwrapAndModifyTileRenderPipelineDescriptor:&v23 options:&v22];
  uint64_t v21 = 0;
  uint64_t v16 = [*((id *)self + 2) newRenderPipelineStateWithTileDescriptor:v15 options:v22 reflection:&v21 error:a6];
  if (!v16) {
    return 0;
  }
  id v17 = (void *)v16;
  uint64_t v18 = [MTLGPUDebugRenderPipelineState alloc];
  uint64_t v19 = [(MTLGPUDebugRenderPipelineState *)v18 initWithRenderPipelineState:v17 tileDescriptor:v23 reflection:v21 device:self pipelineOptions:v22];
...
- (id)newRenderPipelineStateWithTileDescriptor:(id)a3 error:(id *)a4
{
  return [(MTLGPUDebugDevice *)self newRenderPipelineStateWithTileDescriptor:a3 options:0 reflection:0 error:a4];
}
...
- (void)newRenderPipelineStateWithTileDescriptor:(id)a3 options:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  instrumentationHeapInit(self);
  BOOL v9 = (*(void *)&v6 & 0x40003) != 0;
  uint64_t v10 = (void *)[a3 tileFunction];
  id v11 = (void *)[a3 label];
  uint64_t v12 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v13 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v10, 0, 0, v11, v12, &v16);
  id v14 = [(MTLGPUDebugDevice *)self unwrapAndModifyTileRenderPipelineDescriptor:&v17 options:&v16];
  LOBYTE(v15) = v9;
  objc_msgSend(*((id *)self + 2), "newRenderPipelineStateWithTileDescriptor:options:completionHandler:", v14, MEMORY[0x263EF8330], 3221225472, __88__MTLGPUDebugDevice_newRenderPipelineStateWithTileDescriptor_options_completionHandler___block_invoke, &unk_264E12E28, v17, self, v13, a5, v16, v15);
}
...
void __88__MTLGPUDebugDevice_newRenderPipelineStateWithTileDescriptor_options_completionHandler___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (a2)
  {
    uint64_t v5 = [[MTLGPUDebugRenderPipelineState alloc] initWithRenderPipelineState:a2 tileDescriptor:*(void *)(a1 + 32) reflection:a3 device:*(void *)(a1 + 40) pipelineOptions:*(void *)(a1 + 64)];
    [(MTLGPUDebugRenderPipelineState *)v5 setUID:*(void *)(a1 + 48)];
  }
  else
  {
    uint64_t v5 = 0;
  ...
  {
    uint64_t v4 = v5;
    if ((*(unsigned char *)(*(void *)(a1 + 40) + 292) & 1) == 0)
    {
...
- (id)newRenderPipelineStateWithMeshDescriptor:(id)a3 options:(unint64_t)a4 reflection:(id *)a5 error:(id *)a6
{
  ...
  uint64_t v15 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v16 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v11, v12, v13, v14, v15, &v24);
  id v17 = [(MTLGPUDebugDevice *)self unwrapAndModifyMeshRenderPipelineDescriptor:a3 options:&v24];
  uint64_t v23 = 0;
  uint64_t v18 = [*((id *)self + 2) newRenderPipelineStateWithMeshDescriptor:v17 options:v24 reflection:&v23 error:a6];
  if (!v18) {
    return 0;
  }
  uint64_t v19 = (void *)v18;
  uint64_t v20 = [MTLGPUDebugRenderPipelineState alloc];
  uint64_t v21 = [(MTLGPUDebugRenderPipelineState *)v20 initWithRenderPipelineState:v19 meshDescriptor:a3 unwrappedDescriptor:v17 reflection:v23 device:self pipelineOptions:v24];
...
- (id)newRenderPipelineStateWithMeshDescriptor:(id)a3 error:(id *)a4
{
  return [(MTLGPUDebugDevice *)self newRenderPipelineStateWithMeshDescriptor:a3 options:0 reflection:0 error:a4];
}
...
- (void)newRenderPipelineStateWithMeshDescriptor:(id)a3 options:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  instrumentationHeapInit(self);
  BOOL v9 = (*(void *)&v6 & 0x40003) != 0;
  uint64_t v10 = (void *)[a3 meshFunction];
  id v11 = (void *)[a3 fragmentFunction];
  uint64_t v12 = (void *)[a3 objectFunction];
  uint64_t v13 = (void *)[a3 label];
  uint64_t v14 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v15 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v10, v11, v12, v13, v14, &v18);
  id v16 = [(MTLGPUDebugDevice *)self unwrapAndModifyMeshRenderPipelineDescriptor:a3 options:&v18];
  LOBYTE(v17) = v9;
  objc_msgSend(*((id *)self + 2), "newRenderPipelineStateWithMeshDescriptor:options:completionHandler:", MEMORY[0x263EF8330], 3221225472, __88__MTLGPUDebugDevice_newRenderPipelineStateWithMeshDescriptor_options_completionHandler___block_invoke, &unk_264E12E00, a3, v16, self, v15, a5, v18, v17);
}
...
void __88__MTLGPUDebugDevice_newRenderPipelineStateWithMeshDescriptor_options_completionHandler___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (a2)
  {
    uint64_t v5 = [[MTLGPUDebugRenderPipelineState alloc] initWithRenderPipelineState:a2 meshDescriptor:*(void *)(a1 + 32) unwrappedDescriptor:*(void *)(a1 + 40) reflection:a3 device:*(void *)(a1 + 48) pipelineOptions:*(void *)(a1 + 72)];
    [(MTLGPUDebugRenderPipelineState *)v5 setUID:*(void *)(a1 + 56)];
  }
  else
  {
    uint64_t v5 = 0;
  ...
  {
    uint64_t v4 = v5;
    if ((*(unsigned char *)(*(void *)(a1 + 48) + 292) & 1) == 0)
    {
      [(MTLGPUDebugRenderPipelineState *)v5 releaseReflection];
      uint64_t v4 = v5;
    }
...
- (id)newComputePipelineStateWithDescriptor:(id)a3 error:(id *)a4
{
  return [(MTLGPUDebugDevice *)self newComputePipelineStateWithDescriptor:a3 options:0 reflection:0 error:a4];
}
...
- (id)newComputePipelineStateWithDescriptor:(id)a3 options:(unint64_t)a4 reflection:(id *)a5 error:(id *)a6
{
  ...
  id v23 = a3;
  instrumentationHeapInit(self);
  id v11 = (void *)[a3 computeFunction];
  uint64_t v12 = (void *)[a3 label];
  uint64_t v13 = [a3 shaderValidation];
  [a3 shaderValidationState];
  uint64_t v14 = MTLGPUDebugSetValidationChecksOptions((uint64_t)self, v11, 0, 0, v12, v13, &v22);
  id v15 = [(MTLGPUDebugDevice *)self unwrapAndModifyComputePipelineDescriptor:&v23 options:&v22];
  uint64_t v21 = 0;
  uint64_t v16 = [*((id *)self + 2) newComputePipelineStateWithDescriptor:v15 options:v22 reflection:&v21 error:a6];
  if (!v16) {
    return 0;
  }
  uint64_t v17 = (void *)v16;
  unint64_t v18 = [MTLGPUDebugComputePipelineState alloc];
  uint64_t v19 = [(MTLGPUDebugComputePipelineState *)v18 initWithComputePipelineState:v17 descriptor:v23 unwrappedDescriptor:v15 reflection:v21 device:self pipelineOptions:v22];
...
- (void)newComputePipelineStateWithDescriptor:(id)a3 options:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  id v11 = a3;
  instrumentationHeapInit(self);
  id v7 = (void *)[a3 computeFunction];
  int v8 = (void *)[a3 label];
...
void __85__MTLGPUDebugDevice_newComputePipelineStateWithDescriptor_options_completionHandler___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (a2)
  {
    uint64_t v5 = [[MTLGPUDebugComputePipelineState alloc] initWithComputePipelineState:a2 descriptor:*(void *)(a1 + 32) unwrappedDescriptor:*(void *)(a1 + 40) reflection:a3 device:*(void *)(a1 + 48) pipelineOptions:*(void *)(a1 + 72)];
    [(MTLGPUDebugComputePipelineState *)v5 setUID:*(void *)(a1 + 56)];
  }
  else
  {
    uint64_t v5 = 0;
...
- (id)newComputePipelineStateWithFunction:(id)a3 error:(id *)a4
{
  ...
  id v8 = [(MTLGPUDebugDevice *)self newComputePipelineStateWithDescriptor:v7 error:a4];
...
- (id)newComputePipelineStateWithFunction:(id)a3 options:(unint64_t)a4 reflection:(id *)a5 error:(id *)a6
{
  ...
  id v12 = [(MTLGPUDebugDevice *)self newComputePipelineStateWithDescriptor:v11 options:a4 reflection:a5 error:a6];
...
- (id)newIndirectCommandBufferWithDescriptor:(id)a3 maxCommandCount:(unint64_t)a4 options:(unint64_t)a5
{
  if ((*((unsigned char *)self + 287) & 0x20) != 0)
  {
    ...
    id v11 = (void *)[*((id *)self + 2) newIndirectCommandBufferWithDescriptor:v10 maxCommandCount:a4 options:a5 & 0xFFFFFFFFFFFFFF0FLL];
    id v12 = [[MTLGPUDebugIndirectCommandBuffer alloc] initWithIndirectCommandBuffer:v11 descriptor:a3 maxCommandCount:a4 resourceOptions:a5 device:self];
...
- (id)newLibraryWithCIFiltersForComputePipeline:(id)a3 imageFilterFunctionInfo:(id *)a4 error:(id *)a5
{
  ...
  id v15 = (void *)*((void *)self + 2);
  if (v14) {
    uint64_t v16 = (void *)[v15 newLibraryWithCIFiltersForComputePipeline:v9 imageFilterFunctionInfo:a4 error:a5];
  }
  else {
    uint64_t v16 = (void *)[v15 newLibraryWithCIFilters:v9 imageFilterFunctionInfo:a4 error:a5];
  }
  uint64_t v17 = v16;
  if (!v16) {
    return 0;
  ...
  unint64_t v18 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v17 device:self];
...
- (id)newLibraryWithImageFilterFunctionsSPI:(id)a3 imageFilterFunctionInfo:(id *)a4 error:(id *)a5
{
  ...
  uint64_t v16 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v15 device:self];
...
- (id)newDefaultLibrary
{
  ...
  if (result)
  {
    ...
    uint64_t v5 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v4 device:self];
...
- (id)newDefaultLibraryWithBundle:(id)a3 error:(id *)a4
{
  ...
  if (result)
  {
    id v8 = result;
    [result setShaderValidationEnabled:1];
    id v9 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v8 device:self];
...
- (id)newLibraryWithDAG:(id)a3 functions:(id)a4 error:(id *)a5
{
  ...
  if (v12)
  {
    ...
    char v14 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v13 device:self];
  }
  else
  {
    char v14 = 0;
...
- (id)newLibraryWithStitchedDescriptor:(id)a3 error:(id *)a4
{
  id v6 = [(MTLGPUDebugDevice *)self unwrapStitchedLibraryDescriptor:a3];
  instrumentationHeapInit(self);
  ...
  if (result)
  {
    id v8 = result;
    [result setShaderValidationEnabled:1];
    uint64_t v9 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v8 device:self];
...
uint64_t __72__MTLGPUDebugDevice_newLibraryWithStitchedDescriptor_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  if (a2)
  {
    ...
    [[MTLGPUDebugLibrary alloc] initWithLibrary:a2 device:*(void *)(a1 + 32)];
  }
...
- (id)newLibraryWithSource:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = DebugCompileOptions(self, (MTLCompileOptions *)a4);
  instrumentationHeapInit(self);
  ...
  if (result)
  {
    id v10 = result;
    [result setShaderValidationEnabled:1];
    uint64_t v11 = [[MTLGPUDebugLibrary alloc] initWithLibrary:v10 device:self];
...
- (void)newLibraryWithSource:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v10[1] = 3221225472;
  void v10[2] = __68__MTLGPUDebugDevice_newLibraryWithSource_options_completionHandler___block_invoke;
  v10[3] = &unk_264E12EA0;
  v10[4] = self;
  v10[5] = a5;
...
- (id)newDynamicLibraryWithURL:(id)a3 error:(id *)a4
{
  return [(MTLGPUDebugDevice *)self newDynamicLibraryWithURL:a3 options:2 error:a4];
}
...
- (id)newDynamicLibrary:(id)a3 computeDescriptor:(id)a4 error:(id *)a5
{
  ...
  instrumentationHeapInit(self);
  v16[0] = 0;
  id v8 = [(MTLGPUDebugDevice *)self unwrapAndModifyComputePipelineDescriptor:&v14 options:v16];
...
- (id)loadDynamicLibrariesForFunction:(id)a3 insertLibraries:(id)a4 error:(id *)a5
{
  return [(MTLGPUDebugDevice *)self loadDynamicLibrariesForFunction:a3 insertLibraries:a4 options:0 error:a5];
}
    ...
    if (v20)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v21; ++j)
        {
          ...
          {
            id v26 = v25;
            unint64_t v27 = (void *)*((void *)self + 7);
...
- (id)newBinaryArchiveWithDescriptor:(id)a3 error:(id *)a4
{
  ...
  {
    id v6 = result;
    uint64_t v7 = [[MTLGPUDebugBinaryArchive alloc] initWithBinaryArchive:result device:self];
...
- (id)newBinaryLibraryWithOptions:(unint64_t)a3 url:(id)a4 error:(id *)a5
{
  ...
  {
    id v7 = result;
    uint64_t v8 = [[MTLGPUDebugBinaryArchive alloc] initWithBinaryArchive:result device:self];
...
- (id)newBufferWithLength:(unint64_t)a3 options:(unint64_t)a4
{
  ...
  {
    id v8 = result;
    uint64_t v9 = [[MTLGPUDebugBuffer alloc] initWithBuffer:result device:self];
...
- (id)newBufferWithBytes:(const void *)a3 length:(unint64_t)a4 options:(unint64_t)a5
{
  ...
  {
    id v10 = result;
    unint64_t v11 = [[MTLGPUDebugBuffer alloc] initWithBuffer:result device:self];
...
- (id)newBufferWithBytesNoCopy:(void *)a3 length:(unint64_t)a4 options:(unint64_t)a5 deallocator:(id)a6
{
  ...
  {
    id v12 = result;
    uint64_t v13 = [[MTLGPUDebugBuffer alloc] initWithBuffer:result device:self];
...
- (id)newBufferWithIOSurface:(__IOSurface *)a3
{
  ...
  {
    id v6 = result;
    id v7 = [[MTLGPUDebugBuffer alloc] initWithBuffer:result device:self];
...
- (id)newHeapWithDescriptor:(id)a3
{
  ...
  {
    id v6 = result;
    id v7 = [[MTLGPUDebugHeap alloc] initWithHeap:result descriptor:a3 device:self];
...
- (id)newTextureWithDescriptor:(id)a3
{
  ...
  {
    id v5 = result;
    id v6 = [[MTLGPUDebugTexture alloc] initWithTexture:result heap:0 device:self];
...
- (id)newTextureWithDescriptor:(id)a3 iosurface:(__IOSurface *)a4 plane:(unint64_t)a5
{
  ...
  {
    id v7 = result;
    id v8 = [[MTLGPUDebugTexture alloc] initWithTexture:result heap:0 device:self];
...
- (id)newSharedTextureWithHandle:(id)a3 withResourceIndex:(unint64_t)a4
{
  id result = (id)[*((id *)self + 2) newSharedTextureWithHandle:a3 withResourceIndex:a4];
  if (result)
  {
    id v6 = result;
    id v7 = [[MTLGPUDebugTexture alloc] initWithTexture:result heap:0 device:self];
...
- (id)newTextureWithDescriptor:(id)a3 iosurface:(__IOSurface *)a4 plane:(unint64_t)a5 slice:(unint64_t)a6
{
  ...
  {
    id v8 = result;
    uint64_t v9 = [[MTLGPUDebugTexture alloc] initWithTexture:result heap:0 device:self];
...
- (id)newArgumentEncoderWithArguments:(id)a3
{
  if ((*((unsigned char *)self + 286) & 0x80) != 0)
  {
    ...
    unint64_t v24 = [[MTLGPUDebugArgumentEncoder alloc] initWithArgumentEncoder:v23 layout:0 device:self];
    return v24;
  }
  else
  {
...
- (id)newAccelerationStructureWithSize:(unint64_t)a3
{
  id v5 = (void *)MEMORY[0x23ECD5710]([(MTLGPUDebugDevice *)self validateRaytracing]);
  uint64_t v6 = [*((id *)self + 2) newAccelerationStructureWithSize:a3];
  if (v6)
  {
    id v7 = (void *)v6;
    id v8 = [[MTLGPUDebugAccelerationStructure alloc] initWithAccelerationStructure:v6 device:self];
  }
  else
  {
    id v8 = 0;
...
- (id)newAccelerationStructureWithSize:(unint64_t)a3 resourceIndex:(unint64_t)a4
{
  id v7 = (void *)MEMORY[0x23ECD5710]([(MTLGPUDebugDevice *)self validateRaytracing]);
  uint64_t v8 = [*((id *)self + 2) newAccelerationStructureWithSize:a3 resourceIndex:a4];
  if (v8)
  {
    BOOL v9 = (void *)v8;
    uint64_t v10 = [[MTLGPUDebugAccelerationStructure alloc] initWithAccelerationStructure:v8 device:self];
  }
  else
  {
    uint64_t v10 = 0;
...
- (id)newAccelerationStructureWithBuffer:(id)a3 offset:(unint64_t)a4 resourceIndex:(unint64_t)a5
{
  BOOL v9 = (void *)MEMORY[0x23ECD5710]([(MTLGPUDebugDevice *)self validateRaytracing]);
  ...
  if (v10)
  {
    ...
    unsigned int v12 = [[MTLGPUDebugAccelerationStructure alloc] initWithAccelerationStructure:v10 device:self];
  }
  else
  {
    unsigned int v12 = 0;
...
- (id)deserializePrimitiveAccelerationStructureFromBytes:(void *)a3 withDescriptor:(id)a4
{
  ...
  {
    BOOL v9 = (void *)v8;
    uint64_t v10 = [[MTLGPUDebugAccelerationStructure alloc] initWithAccelerationStructure:v8 device:self type:1];
  }
  else
  {
    uint64_t v10 = 0;
...
- (id)deserializeInstanceAccelerationStructureFromBytes:(void *)a3 primitiveAccelerationStructures:(id)a4 withDescriptor:(id)a5
{
  ...
  if (v15)
  {
    uint64_t v16 = [[MTLGPUDebugAccelerationStructure alloc] initWithAccelerationStructure:v15 device:self type:2];
  }
  else
  {
    uint64_t v16 = 0;
...
- (id)newAccelerationStructureWithSize:(unint64_t)a3 withDescriptor:(id)a4
{
  ...
  {
    id v6 = result;
    id v7 = [[MTLGPUDebugAccelerationStructure alloc] initWithAccelerationStructure:result device:self];
...
- (id)newVisibleFunctionTableWithDescriptor:(id)a3
{
  ...
  {
    id v6 = result;
    id v7 = [[MTLGPUDebugVisibleFunctionTable alloc] initWithVisibleFunctionTable:result descriptor:a3 device:self];
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)a3
{
  ...
  {
    id v6 = result;
    id v7 = [[MTLGPUDebugIntersectionFunctionTable alloc] initWithIntersectionFunctionTable:result device:self descriptor:a3];
...
- (id)newResidencySetWithDescriptor:(id)a3 error:(id *)a4
{
  ...
  if (v6) {
    id v7 = [[MTLGPUDebugResidencySet alloc] initWithResidencySet:v6 device:self descriptor:a3];
  }
  else {
    id v7 = 0;
  }
...
{
  uint64_t v2 = [MTLGPUDebugFunction alloc];
  uint64_t v3 = *(void *)(a1 + 32);
  uint64_t v4 = *(void *)(a1 + 40);

  return (uint64_t)[(MTLGPUDebugFunction *)v2 initWithFunction:v3 library:v4];
}
...
- (id)newArgumentEncoderWithBufferBinding:(id)a3
{
  if ((*((unsigned char *)self + 286) & 0x80) != 0)
  {
    id result = (id)[*((id *)self + 2) newArgumentEncoderWithBufferBinding:a3];
    if (result)
    {
      id v5 = result;
      objc_super v6 = [[MTLGPUDebugArgumentEncoder alloc] initWithArgumentEncoder:result layout:0 device:self];
...
- (void)initWithBaseObject:(os_log_t)log parent:.cold.1(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_debug_impl(&dword_23BD25000, log, OS_LOG_TYPE_DEBUG, "[METAL SHADER VALIDATION] Processing MTL_SHADER_VALIDATION_DISABLE_PIPELINES", v1, 2u);
}

- (void)initWithBaseObject:(os_log_t)log parent:.cold.2(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_debug_impl(&dword_23BD25000, log, OS_LOG_TYPE_DEBUG, "[METAL SHADER VALIDATION] Processing MTL_SHADER_VALIDATION_ENABLE_PIPELINES", v1, 2u);
}
