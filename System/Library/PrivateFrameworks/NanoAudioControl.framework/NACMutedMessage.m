...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NACMutedMessage;
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [NSNumber numberWithBool:self->_muted];
...
- (BOOL)readFrom:(id)a3
{
  return NACMutedMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    *(unsigned char *)(v5 + 20) = self->_muted;
...
{
  if ((*(unsigned char *)&self->_has & 2) != 0) {
    uint64_t v3 = 2654435761 * self->_muted;
  }
  else {
    uint64_t v3 = 0;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((*((unsigned char *)v4 + 24) & 2) != 0)
  {
    self->_muted = *((unsigned char *)v4 + 20);
    *(unsigned char *)&self->_has |= 2u;
  }
  if (*((void *)v4 + 1))
  {
    id v5 = v4;
    -[NACMutedMessage setCategory:](self, "setCategory:");
    id v4 = v5;
  }
