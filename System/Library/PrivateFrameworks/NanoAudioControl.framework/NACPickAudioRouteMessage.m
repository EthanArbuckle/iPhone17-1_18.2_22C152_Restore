...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NACPickAudioRouteMessage;
...
- (BOOL)readFrom:(id)a3
{
  return NACPickAudioRouteMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[NACPickAudioRouteMessage setCategory:](self, "setCategory:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[NACPickAudioRouteMessage setIdentifier:](self, "setIdentifier:");
    id v4 = v5;
  }
}
