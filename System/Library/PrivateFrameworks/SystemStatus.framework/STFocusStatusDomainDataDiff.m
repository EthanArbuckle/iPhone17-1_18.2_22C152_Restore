...
- (STFocusStatusDomainDataDiff)init
{
  ...
  uint64_t v4 = (STFocusStatusDomainDataDiff *)-[STFocusStatusDomainDataDiff initWithChanges:](self, v3);
...
uint64_t __50__STFocusStatusDomainDataDiff_applyToMutableData___block_invoke_2(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  {
    id v8 = v5;
    id v5 = (id)[*(id *)(a1 + 32) setModeSymbol:v5];
  }
  else if (a2 == 1)
  {
    id v8 = v5;
    id v5 = (id)[*(id *)(a1 + 32) setModeName:v5];
  }
  else
  {
    if (a2) {
    ...
    id v8 = v5;
    id v5 = (id)[*(id *)(a1 + 32) setModeIdentifier:v5];
  }
  id v6 = v8;
LABEL_8:
...
- (id)diffByApplyingDiff:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    id v10 = -[STFocusStatusDomainDataDiff initWithChanges:]([STFocusStatusDomainDataDiff alloc], v7);
  }
  else
  {
    id v10 = 0;
...
- (NSString)description
{
  return (NSString *)[(STFocusStatusDomainDataDiff *)self descriptionWithMultilinePrefix:0];
}
...
- (STFocusStatusDomainDataDiff)initWithCoder:(id)a3
{
  ...
  id v6 = (STFocusStatusDomainDataDiff *)-[STFocusStatusDomainDataDiff initWithChanges:](self, v5);
  return v6;
}

- (id)succinctDescription
{
  uint64_t v2 = [(STFocusStatusDomainDataDiff *)self succinctDescriptionBuilder];
  id v3 = [v2 build];
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  id v3 = [(STFocusStatusDomainDataDiff *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  id v3 = -[STFocusStatusDomainDataDiff _descriptionBuilderWithMultilinePrefix:forDebug:]((id *)&self->super.isa, a3, 1);
  id v4 = [v3 build];
...
uint64_t __67__STFocusStatusDomainDataDiff__appendChanges_toDescriptionBuilder___block_invoke_2(uint64_t a1, unint64_t a2, void *a3)
{
  ...
  {
    id v8 = v5;
    id v5 = (id)[*(id *)(a1 + 32) appendString:v5 withName:off_1E6B63C30[a2]];
    id v6 = v8;
  }
