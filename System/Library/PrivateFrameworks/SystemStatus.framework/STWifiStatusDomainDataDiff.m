...
- (STWifiStatusDomainDataDiff)init
{
  ...
  uint64_t v4 = (STWifiStatusDomainDataDiff *)-[STWifiStatusDomainDataDiff initWithChanges:](self, v3);
...
uint64_t __49__STWifiStatusDomainDataDiff_applyToMutableData___block_invoke(uint64_t result, uint64_t a2)
{
  ...
  {
    v2 = *(void **)(result + 32);
    uint64_t v3 = BSSettingFlagIsYes();
...
- (id)diffByApplyingDiff:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [v6 applySettings:v8];
    uint64_t v9 = -[STWifiStatusDomainDataDiff initWithChanges:]([STWifiStatusDomainDataDiff alloc], v7);
  }
  else
  {
    uint64_t v9 = 0;
...
- (NSString)description
{
  return (NSString *)[(STWifiStatusDomainDataDiff *)self descriptionWithMultilinePrefix:0];
}
...
- (STWifiStatusDomainDataDiff)initWithCoder:(id)a3
{
  ...
  id v6 = (STWifiStatusDomainDataDiff *)-[STWifiStatusDomainDataDiff initWithChanges:](self, v5);
  return v6;
}
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  uint64_t v3 = [(STWifiStatusDomainDataDiff *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  uint64_t v3 = -[STWifiStatusDomainDataDiff _descriptionBuilderWithMultilinePrefix:forDebug:]((id *)&self->super.isa, a3, 1);
  id v4 = [v3 build];
...
- (id)_descriptionBuilderWithMultilinePrefix:(uint64_t)a3 forDebug:
{
  if (a1)
  {
    ...
    if (([v7 isEmpty] & 1) == 0)
    {
      char v8 = [v6 activeMultilinePrefix];
      v10[0] = MEMORY[0x1E4F143A8];
      v10[1] = 3221225472;
...
{
  id v2 = (id)objc_msgSend(*(id *)(a1 + 32), "appendFlag:withName:skipIfNotSet:", objc_msgSend(*(id *)(a1 + 40), "flagForSetting:", 0), @"wifiActive", 1);
  id v3 = (id)objc_msgSend(*(id *)(a1 + 32), "appendFlag:withName:skipIfNotSet:", objc_msgSend(*(id *)(a1 + 40), "flagForSetting:", 2), @"associatedToIOSHotspot", 1);
  id v4 = [*(id *)(a1 + 40) objectForSetting:1];
  if (v4)
  {
    id v6 = v4;
    id v5 = (id)objc_msgSend(*(id *)(a1 + 32), "appendUnsignedInteger:withName:", objc_msgSend(v4, "unsignedIntegerValue"), @"signalStrengthBars");
    id v4 = v6;
  }
}
