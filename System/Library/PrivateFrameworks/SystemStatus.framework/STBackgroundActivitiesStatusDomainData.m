...
- (NSSet)activeBackgroundActivities
{
  ...
  v3 = objc_msgSend(v2, "bs_map:", &__block_literal_global_20);
...
{
  return [a2 backgroundActivityIdentifier];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v6 = v4;
  id v7 = [(STBackgroundActivitiesStatusDomainData *)self backgroundActivitiesAttributionListData];
...
{
  return [*(id *)(a1 + 32) backgroundActivitiesAttributionListData];
}
...
- (unint64_t)hash
{
  ...
  id v4 = [(STBackgroundActivitiesStatusDomainData *)self backgroundActivitiesAttributionListData];
  id v5 = (id)[v3 appendObject:v4];

  id v6 = [(STBackgroundActivitiesStatusDomainData *)self visualDescriptorsByIdentifierDictionaryData];
...
- (NSString)description
{
  return (NSString *)[(STBackgroundActivitiesStatusDomainData *)self descriptionWithMultilinePrefix:0];
}

- (NSString)debugDescription
{
  return (NSString *)[(STBackgroundActivitiesStatusDomainData *)self debugDescriptionWithMultilinePrefix:0];
}

- (id)mutableCopyWithZone:(_NSZone *)a3
{
  id v4 = +[STMutableBackgroundActivitiesStatusDomainData allocWithZone:a3];
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  v3 = -[STBackgroundActivitiesStatusDomainData _descriptionBuilderWithMultilinePrefix:forDebug:](self, a3, 1);
  id v4 = [v3 build];
...
{
  v2 = *(void **)(a1 + 32);
  id v3 = [*(id *)(a1 + 40) backgroundActivitiesAttributionListData];
  id v4 = (id)[v2 appendObject:v3 withName:@"backgroundActivities"];
...
- (id)diffFromData:(id)a3
{
  ...
  {
    id v5 = +[STBackgroundActivitiesStatusDomainDataDiff diffFromData:v4 toData:self];
  }
  else
  {
    id v5 = 0;
...
- (id)dataByApplyingDiff:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    if ([v4 isEmpty])
    {
      id v5 = (void *)[(STBackgroundActivitiesStatusDomainData *)self copy];
    }
    else
    {
      id v5 = (void *)[(STBackgroundActivitiesStatusDomainData *)self mutableCopy];
...
{
  id v4 = a3;
  id v5 = [(STBackgroundActivitiesStatusDomainData *)self backgroundActivitiesAttributionListData];
...
- (STBackgroundActivitiesStatusDomainData)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"backgroundActivityAttributions"];
  uint64_t v15 = 0;
  v16 = &v15;
...
void __56__STBackgroundActivitiesStatusDomainData_initWithCoder___block_invoke_2(uint64_t a1, void *a2, unsigned char *a3)
{
  id v5 = a2;
  objc_opt_class();
