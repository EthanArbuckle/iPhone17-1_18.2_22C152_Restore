...
- (id)succinctDescriptionBuilder
{
  ...
  id v4 = (id)objc_msgSend(v3, "appendInteger:withName:", -[STStatusBarDataLockEntry unlockFailureCount](self, "unlockFailureCount"), @"unlockFailureCount");
...
- (id)_equalsBuilderWithObject:(id)a3
{
  ...
  id v6 = v4;
  int64_t v7 = [(STStatusBarDataLockEntry *)self unlockFailureCount];
...
{
  return [*(id *)(a1 + 32) unlockFailureCount];
}
...
- (id)_hashBuilder
{
  ...
  id v4 = (id)objc_msgSend(v3, "appendInteger:", -[STStatusBarDataLockEntry unlockFailureCount](self, "unlockFailureCount"));
...
- (void)encodeWithBSXPCCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeInt64:forKey:", self->_unlockFailureCount, @"unlockFailureCount", v5.receiver, v5.super_class);
}
