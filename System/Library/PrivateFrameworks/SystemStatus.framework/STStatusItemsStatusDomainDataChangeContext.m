...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v6 = [(STStatusItemsStatusDomainDataChangeContext *)self isUserInitiated];
...
- (unint64_t)hash
{
  ...
  id v4 = (id)objc_msgSend(v3, "appendBool:", -[STStatusItemsStatusDomainDataChangeContext isUserInitiated](self, "isUserInitiated"));
...
- (NSString)description
{
  return (NSString *)[(STStatusItemsStatusDomainDataChangeContext *)self descriptionWithMultilinePrefix:0];
}

- (id)mutableCopyWithZone:(_NSZone *)a3
{
  id result = +[STMutableStatusItemsStatusDomainDataChangeContext allocWithZone:a3];
  if (result)
  {
    id v5 = result;
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  char v3 = [(STStatusItemsStatusDomainDataChangeContext *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  char v3 = -[STStatusItemsStatusDomainDataChangeContext _descriptionBuilderWithMultilinePrefix:forDebug:](self, a3, 1);
  id v4 = [v3 build];
...
{
  id v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[STStatusItemsStatusDomainDataChangeContext isUserInitiated](self, "isUserInitiated"), @"userInitiated");
}
