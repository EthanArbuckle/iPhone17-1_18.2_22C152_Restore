...
- (NSString)description
{
  return (NSString *)[(STFocusStatusDomainUserInteraction *)self descriptionWithMultilinePrefix:0];
}
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  unint64_t v3 = [(STFocusStatusDomainUserInteraction *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
