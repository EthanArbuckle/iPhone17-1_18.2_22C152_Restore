...
- (id)_equalsBuilderWithObject:(id)a3
{
  id v4 = a3;
  v13.receiver = self;
  v13.super_class = (Class)STStatusBarDataLocationEntry;
  v5 = [(STStatusBarDataEntry *)&v13 _equalsBuilderWithObject:v4];
  id v6 = v4;
  int64_t v7 = [(STStatusBarDataLocationEntry *)self type];
...
{
  v5.receiver = self;
  v5.super_class = (Class)STStatusBarDataLocationEntry;
  id v4 = a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)STStatusBarDataLocationEntry;
  id v3 = a3;
...
- (id)succinctDescriptionBuilder
{
  ...
  unint64_t v4 = [(STStatusBarDataLocationEntry *)self type];
  if (v4 > 2) {
    uint64_t v5 = @"(unknown)";
  }
  else {
    uint64_t v5 = off_1E6B63F00[v4];
  }
...
uint64_t __57__STStatusBarDataLocationEntry__equalsBuilderWithObject___block_invoke(uint64_t a1)
{
...
{
  v6.receiver = self;
  v6.super_class = (Class)STStatusBarDataLocationEntry;
  id v3 = [(STStatusBarDataEntry *)&v6 _hashBuilder];
  id v4 = (id)objc_msgSend(v3, "appendInteger:", -[STStatusBarDataLocationEntry type](self, "type"));
