...
- (void)viewDidLoad
{
  ...
  objc_super v11 = [(PRXScannerViewController *)self indicatorView];
  [v10 addSubview:v11];
  ...
  id v23 = objc_alloc_init(MEMORY[0x263F1C778]);
  ...
  v90[12] = v41;
  v42 = [MEMORY[0x263EFF8C0] arrayWithObjects:v90 count:13];
...
- (void)showConfirmationRing
{
  id v2 = [(PRXScannerViewController *)self indicatorView];
  [v2 complete];
}
