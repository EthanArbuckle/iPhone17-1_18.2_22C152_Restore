...
{
  return _FigEndpointCentralSendCommand(*(void *)(a1 + 32), *(void *)(a1 + 40), *(void *)(a1 + 48), *(void (**)(uint64_t, uint64_t, void, uint64_t))(a1 + 56), *(void *)(a1 + 64));
}
...
uint64_t __routingContextResilientRemote_SendCommand_block_invoke(void *a1, uint64_t a2)
{
  ...
  v9 = *(uint64_t (**)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))(v8 + 136);
  if (!v9) {
    return 4294954514;
  }
...
void __routingContext_SendCommand_block_invoke(uint64_t a1)
{
  ...
  if (cf && (FigEndpointExtendedGetClassID(), CMBaseObjectIsMemberOfClass()))
  {
    ...
    *uint64_t v3 = CFRetain(*(CFTypeRef *)(a1 + 48));
    ...
    uint64_t v8 = *(uint64_t (**)(CFTypeRef, uint64_t, uint64_t, void (*)(uint64_t, uint64_t, uint64_t, CFTypeRef *), CFTypeRef *))(v7 + 72);
    if (v8) {
      uint64_t v9 = v8(v2, v4, v5, routingContext_sendCommandCompletionCallback, v3);
    }
    else {
    ...
    *(_DWORD *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = v9;
    if (*(_DWORD *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) == -12782) {
      routingContext_sendCommandCompletionCallback(v9, 4294954514, 0, v3);
    }
  }
  else
  {
    (*(void (**)(void, void, void, void))(a1 + 56))(*(void *)(a1 + 48), 0, *(unsigned int *)(*(void *)(*(void *)(a1 + 32) + 8) + 24), *(void *)(a1 + 64));
  }
  if (cf) {
    CFRelease(cf);
  }
...
uint64_t __endpointAggregate_SendCommand_block_invoke(void *a1, uint64_t a2)
{
  ...
  v10 = *(uint64_t (**)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))(v9 + 72);
  if (!v10) {
    return 4294954514;
  }
