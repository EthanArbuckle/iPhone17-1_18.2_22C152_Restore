...
- (id)description
{
  ...
  id v4 = [(NNMKProtoMessageDeletions *)&v8 description];
  v5 = [(NNMKProtoMessageDeletions *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_messageDeletions, "count"));
    long long v16 = 0u;
    long long v17 = 0u;
    long long v18 = 0u;
    long long v19 = 0u;
    ...
    [v3 setObject:v6 forKey:@"messageDeletion"];
  }
...
- (void)copyTo:(id)a3
{
  ...
  if ([(NNMKProtoMessageDeletions *)self messageDeletionsCount])
  {
    ...
    unint64_t v5 = [(NNMKProtoMessageDeletions *)self messageDeletionsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(NNMKProtoMessageDeletions *)self messageDeletionAtIndex:i];
...
LABEL_17:
  ...
  messageDeletions = self->_messageDeletions;
  if ((unint64_t)messageDeletions | *((void *)v4 + 5))
  {
...
- (unint64_t)hash
{
  ...
  uint64_t v5 = [(NSMutableArray *)self->_messageDeletions hash];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        -[NNMKProtoMessageDeletions addMessageDeletion:](self, "addMessageDeletion:", *(void *)(*((void *)&v11 + 1) + 8 * i), (void)v11);
      }
