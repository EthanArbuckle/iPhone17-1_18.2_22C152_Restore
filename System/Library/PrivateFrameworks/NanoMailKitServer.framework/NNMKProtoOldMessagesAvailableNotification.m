...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NNMKProtoOldMessagesAvailableNotification;
...
- (BOOL)readFrom:(id)a3
{
  return NNMKProtoOldMessagesAvailableNotificationReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v7 = [(NSString *)self->_mailboxId copyWithZone:a3];
...
LABEL_9:
  ...
  if ((unint64_t)mailboxId | *((void *)v4 + 2)) {
    char v6 = -[NSString isEqual:](mailboxId, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[NNMKProtoOldMessagesAvailableNotification setMailboxId:](self, "setMailboxId:");
    id v4 = v5;
  }
}
