...
- (unint64_t)accountsStatusCount
{
  return [(NSMutableArray *)self->_accountsStatus count];
}

- (id)accountsStatusAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_accountsStatus objectAtIndex:a3];
}
...
- (id)description
{
  ...
  id v4 = [(NNMKProtoAccountAuthenticationStatus *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_accountsStatus, "count"));
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(NNMKProtoAccountAuthenticationStatus *)self accountsStatusCount])
  {
    ...
    unint64_t v4 = [(NNMKProtoAccountAuthenticationStatus *)self accountsStatusCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(NNMKProtoAccountAuthenticationStatus *)self accountsStatusAtIndex:i];
  ...
  if (*(unsigned char *)&self->_has)
  {
    *((void *)v8 + 1) = *(void *)&self->_requestTime;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  uint64_t v6 = self->_accountsStatus;
...
- (BOOL)isEqual:(id)a3
{
  ...
  accountsStatus = self->_accountsStatus;
  if ((unint64_t)accountsStatus | *((void *)v4 + 2))
  {
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 24) & 1) != 0 && self->_requestTime == *((double *)v4 + 1))
    {
      BOOL v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSMutableArray *)self->_accountsStatus hash];
  if (*(unsigned char *)&self->_has)
  {
    double requestTime = self->_requestTime;
    double v6 = -requestTime;
    if (requestTime >= 0.0) {
      double v6 = self->_requestTime;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NNMKProtoAccountAuthenticationStatus addAccountsStatus:](self, "addAccountsStatus:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
  ...
  {
    self->_double requestTime = *((double *)v4 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
}
