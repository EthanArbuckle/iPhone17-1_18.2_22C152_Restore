...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NNMKProtoInitialSyncFinishedNotification;
  v4 = [(NNMKProtoInitialSyncFinishedNotification *)&v8 description];
  v5 = [(NNMKProtoInitialSyncFinishedNotification *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NNMKProtoInitialSyncFinishedNotificationReadFrom((uint64_t)self, (uint64_t)a3);
}
