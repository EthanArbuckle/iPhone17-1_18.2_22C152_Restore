...
void __70__MKMapItem_MUPlaceTileViewModel__fetchImageTilewWithSize_completion___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5)
  {
    v7 = [MEMORY[0x1E4FB1818] systemImageNamed:@"figure.walk"];
    (*(void (**)(uint64_t, void *, id, void))(v6 + 16))(v6, v7, v8, 0);
  }
  else
  {
    (*(void (**)(uint64_t, uint64_t, void, void))(v6 + 16))(v6, a3, 0, 0);
  }
}
...
void __70__MKMapItem_MUPlaceTileViewModel__fetchImageTilewWithSize_completion___block_invoke_2(uint64_t a1, uint64_t a2, char a3, uint64_t a4, uint64_t a5)
{
  ...
  else
  {
    ...
    v11[1] = 3221225472;
    v11[2] = __70__MKMapItem_MUPlaceTileViewModel__fetchImageTilewWithSize_completion___block_invoke_3;
    v11[3] = &unk_1E5750288;
    id v9 = *(id *)(a1 + 32);
    id v12 = 0;
    id v13 = v9;
