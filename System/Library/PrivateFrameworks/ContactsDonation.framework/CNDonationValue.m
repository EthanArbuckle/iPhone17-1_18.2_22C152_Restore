...
+ (id)donationValueWithImageData:(id)a3 origin:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[_CNImageDataDonationValue alloc] initWithImageData:v6 origin:v5];
...
- (CNDonationValue)initWithOrigin:(id)a3
{
  ...
  id v5 = [(CNDonationValue *)&v10 init];
  if (v5)
  {
    uint64_t v6 = [v4 copy];
    origin = v5->_origin;
...
- (CNDonationValue)initWithCoder:(id)a3
{
  ...
  id v5 = [(CNDonationValue *)&v11 init];
  if (v5)
  {
    id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"_origin"];
    uint64_t v7 = [v6 copy];
    origin = v5->_origin;
...
{
  id v4 = a3;
  id v5 = [CNDonationOrigin alloc];
  id v6 = [v4 objectForKeyedSubscript:@"origin"];
  uint64_t v7 = [(CNDonationOrigin *)v5 initWithPropertyListRepresentation:v6];

  if (!v7) {
    goto LABEL_75;
  }
  id v8 = [v4 objectForKeyedSubscript:@"name-components"];
  ...
  if (!v8)
  {
    ...
    if (v29)
    {
      ...
      id v9 = [MEMORY[0x263EFEB28] phoneNumberWithStringValue:v32];
    ...
    if (v37)
    {
      ...
      char v42 = [v10 isEqualToString:@"donation-address"];
      uint64_t v43 = 0;
      if ((v42 & 1) == 0)
      {
      ...
      id v45 = objc_alloc_init(MEMORY[0x263EFEB18]);
      objc_opt_class();
...
LABEL_75:
  ...
  id v9 = [v4 objectForKeyedSubscript:@"name-components"];
  id v10 = objc_alloc_init(MEMORY[0x263F08A68]);
  objc_opt_class();
  objc_super v11 = [v9 objectForKeyedSubscript:@"namePrefix"];
  if (objc_opt_isKindOfClass()) {
    v12 = v11;
  }
  else {
...
- (id)propertyListRepresentation
{
  ...
  [v3 setObject:&unk_26C4FAEF8 forKeyedSubscript:@"version"];
  id v4 = [(CNDonationValue *)self origin];
