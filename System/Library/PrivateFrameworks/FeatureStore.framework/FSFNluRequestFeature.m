...
- (FSFNluRequestFeature)initWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  {
    v7->_dataVersion = a4;
    uint64_t v9 = [objc_alloc(MEMORY[0x263F71CA8]) initWithData:v6];
    content = v8->_content;
...
- (FSFNluRequestFeature)initWithContentJson:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  if (+[FSFUtils isSupportedPlatform])
  {
    ...
    id v7 = [(FSFNluRequestFeature *)&v15 init];
    v8 = v7;
    if (v7)
    {
      v7->_dataVersion = a4;
      id v9 = objc_alloc(MEMORY[0x263F71CA8]);
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  uint64_t v4 = *(void *)&a4;
  id v5 = a3;
  id v6 = [[FSFNluRequestFeature alloc] initWithData:v5 dataVersion:v4];
...
- (id)serialize
{
  return (id)[(SIRINLUEXTERNALCDMNluRequest *)self->_content data];
}

- (id)json
{
  v2 = (void *)MEMORY[0x263F08900];
  v3 = [(SIRINLUEXTERNALCDMNluRequest *)self->_content dictionaryRepresentation];
...
- (id)interactionId
{
  v2 = [(SIRINLUEXTERNALCDMNluRequest *)self->_content requestId];
  v3 = [v2 idA];
