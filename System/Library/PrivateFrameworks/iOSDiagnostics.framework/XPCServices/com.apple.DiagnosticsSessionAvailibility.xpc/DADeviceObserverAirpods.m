...
- (DADeviceObserverAirpods)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v11 = +[NSSet setWithArray:&off_100015838];
    ...
    if (qword_10001C650 != -1) {
      dispatch_once(&qword_10001C650, &stru_1000144A0);
    }
    v20 = qword_10001C658;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100002A3C;
    block[3] = &unk_1000144C8;
    v23 = v2;
...
- (id)beginDiscoveringDevicesWithHandler:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100002D04;
  block[3] = &unk_100014518;
  void block[4] = self;
  id v7 = v5;
  id v13 = v7;
  id v14 = v4;
