...
- (id)_fetchDevices
{
  ...
  id v5 = +[DSIOHIDDevice deviceMatchingAccessories:&off_100015850];
  id v6 = v5;
  if (!v5) {
    goto LABEL_13;
  }
...
- (id)_accessoryIdentifiersToPromote
{
  if (qword_10001C678 != -1) {
    dispatch_once(&qword_10001C678, &stru_1000146B0);
  }
  v2 = (void *)qword_10001C670;
