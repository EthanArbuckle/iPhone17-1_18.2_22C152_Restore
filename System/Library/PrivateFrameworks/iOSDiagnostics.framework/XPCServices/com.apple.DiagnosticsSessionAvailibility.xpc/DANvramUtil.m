...
+ (id)sharedInstance
{
  if (qword_10001C668 != -1) {
    dispatch_once(&qword_10001C668, &stru_100014608);
  }
  v2 = (void *)qword_10001C660;
...
- (void)syncASTDefaultsToNVRam
{
  ...
  if (v8 && ([v8 isEqualToNumber:&off_100015760] & 1) == 0)
  {
    v12 = [v8 description];
  ...
  if (([v9 isEqualToString:&stru_100014D68] & 1) == 0)
  {
