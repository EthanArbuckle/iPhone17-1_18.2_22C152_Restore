...
- (void)availableDestinationsWithCompletion:(id)a3
{
  ...
  id v6 = [v5 remoteObjectProxyWithErrorHandler:&stru_100018740];
...
- (void)sendMessage:(id)a3 data:(id)a4 toDestination:(id)a5 forceLocalDelivery:(BOOL)a6 expectsResponse:(BOOL)a7 response:(id)a8
{
  ...
  id v19 = [v18 remoteObjectProxyWithErrorHandler:&stru_100018760];
...
- (id)_createXPCConnection
{
  ...
  [v3 setInterruptionHandler:&stru_1000187A8];
  [v3 setInvalidationHandler:&stru_1000187C8];
  [v3 resume];
...
+ (id)allowedDataClasses
{
  if (qword_1000228C0 != -1) {
    dispatch_once(&qword_1000228C0, &stru_1000187E8);
  }
  v2 = (void *)qword_1000228B8;
