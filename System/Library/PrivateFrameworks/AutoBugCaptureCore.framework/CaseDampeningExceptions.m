...
LABEL_68:
    ...
    uint64_t v9 = (void *)[objc_alloc(MEMORY[0x263EFF9A0]) initWithDictionary:&unk_26BDF5588];
    if (_isNPIDevice)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_209DBA000, v10, OS_LOG_TYPE_INFO, "Modifying Cellular exceptions list for NPI devices", buf, 2u);
      }
      [v9 setObject:&unk_26BDF5D68 forKeyedSubscript:@"Baseband Stability"];
      [v9 setObject:&unk_26BDF5D80 forKeyedSubscript:@"IMS Call KPI"];
    }
    v36[0] = @"Networking";
    v36[1] = @"Cellular";
    v34 = (void *)v8;
    ...
    v36[10] = @"FaceTime";
    v36[11] = @"CoreSpeech";
    v37[10] = &unk_26BDF5740;
    v37[11] = &unk_26BDF5790;
...
LABEL_65:
      ...
      _os_log_impl(&dword_209DBA000, v18, OS_LOG_TYPE_DEFAULT, v19, buf, 2u);
      goto LABEL_55;
    }
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0)
...
LABEL_67:
    ...
    _os_log_impl(&dword_209DBA000, v23, OS_LOG_TYPE_DEFAULT, v24, buf, 2u);
    goto LABEL_34;
  }
  BOOL v20 = 0;
LABEL_69:
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.1(uint64_t a1, void *a2)
{
  ...
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_209DBA000, v5, v6, "Found unexpected object %@ of class %@ as exception for subtype %@", v7, v8, v9, v10, v11);
}
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.2(uint64_t a1, void *a2)
{
  ...
  v4 = NSStringFromClass(v3);
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_209DBA000, v5, v6, "Found unexpected object %@ of class %@ as exception for type %@", v7, v8, v9, v10, v11);
}
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.3(uint64_t a1, void *a2)
{
  ...
  v4 = NSStringFromClass(v3);
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_209DBA000, v5, v6, "Found unexpected object %@ of class %@ as exception for domain %@", v7, v8, v9, v10, v11);
}
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.4(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_209DBA000, a2, OS_LOG_TYPE_DEBUG, "Comparing case signature %@ against allowed exceptions list.", (uint8_t *)&v2, 0xCu);
}
