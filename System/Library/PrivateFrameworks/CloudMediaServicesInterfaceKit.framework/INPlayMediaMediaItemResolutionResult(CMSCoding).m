...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (v6)
  {
    ...
    {
      uint64_t v16 = [MEMORY[0x263F0FD58] unsupported];
    }
    goto LABEL_32;
  }
  ...
  if (v14)
  {
    uint64_t v15 = [MEMORY[0x263F0FD58] needsValue];
  }
  else
  {
    ...
    {
      v19.receiver = a1;
      v19.super_class = (Class)&off_26DE6EFF8;
...
LABEL_33:
      ...
      uint64_t v16 = [objc_alloc(MEMORY[0x263F0FD58]) initWithMediaItemResolutionResult:v9];
LABEL_32:
      v13 = (void *)v16;
      goto LABEL_33;
    }
    uint64_t v15 = [MEMORY[0x263F0FD58] notRequired];
  }
  v13 = (void *)v15;
LABEL_34:
