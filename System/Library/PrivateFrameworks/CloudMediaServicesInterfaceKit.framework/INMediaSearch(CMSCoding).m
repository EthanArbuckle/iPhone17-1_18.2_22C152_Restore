...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (v3)
  {
    ...
    uint64_t v21 = INMediaItemTypeFromString(v5);

    v6 = [v4 cmsOptionalStringForKey:@"sortOrder"];
    uint64_t v7 = INMediaSortOrderFromString(v6);
    ...
    v13 = (void *)MEMORY[0x263F0FA60];
    v14 = [v4 cmsOptionalDictionaryForKey:@"releaseDate"];
    v15 = [v13 instanceFromCMSCoded:v14];

    v16 = [v4 cmsOptionalStringForKey:@"reference"];
    uint64_t v17 = INMediaReferenceFromString(v16);

    v18 = [v4 cmsOptionalStringForKey:@"mediaIdentifier"];
    v19 = (void *)[objc_alloc(MEMORY[0x263F0FC50]) initWithMediaType:v21 sortOrder:v7 mediaName:v8 artistName:v9 albumName:v10 genreNames:v11 moodNames:v12 releaseDate:v15 reference:v17 mediaIdentifier:v18];
  }
  else
  {
    v19 = 0;
...
- (id)cmsCoded
{
  v2 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:10];
