...
- (id)cmsCoded
{
  v2 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:4];
  v3 = [a1 activityType];
  if (v3) {
...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      ...
      v7 = (void *)[objc_alloc(MEMORY[0x263F08D38]) initWithActivityType:v5];
      uint64_t v8 = [v4 cmsOptionalDateForKey:@"expirationDate"];
