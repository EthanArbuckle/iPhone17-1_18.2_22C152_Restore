...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (v3)
  {
    ...
    uint64_t v7 = INMediaAffinityTypeFromString(v6);

    v8 = (void *)[objc_alloc(MEMORY[0x263F100A0]) initWithMediaItems:v4 mediaSearch:v5 affinityType:v7];
  }
  else
  {
    v8 = 0;
...
{
  v7.receiver = a1;
  v7.super_class = (Class)&off_26DE6DB38;
