...
{
  v6.receiver = self;
  v6.super_class = (Class)FCOperationExternalSignal;
  id v2 = [(FCOperationExternalSignal *)&v6 init];
  if (v2)
  {
  ...
  return (FCOperationExternalSignal *)v2;
}
...
uint64_t __44__FCOperationExternalSignal_onQueue_signal___block_invoke(uint64_t a1)
{
