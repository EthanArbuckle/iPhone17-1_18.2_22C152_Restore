@interface FCCKPQueryRetrieveResponse
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (id)dictionaryRepresentation;
- (uint64_t)addQueryResults:(uint64_t)a1;
- (unint64_t)hash;
- (void)writeTo:(id)a3;
@end
...
- (id)description
{
  ...
  id v4 = [(FCCKPQueryRetrieveResponse *)&v8 description];
  v5 = [(FCCKPQueryRetrieveResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_queryResults count])
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_queryResults, "count"));
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
    ...
    [v3 setObject:v4 forKey:@"queryResults"];
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v17 = 0u;
  long long v18 = 0u;
  uint64_t v6 = self->_queryResults;
  ...
  uint64_t v12 = [(NSData *)self->_continuationMarker copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](queryResults, "isEqual:")))
  {
    ...
    if ((unint64_t)continuationMarker | v4[1]) {
      char v7 = -[NSData isEqual:](continuationMarker, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSMutableArray *)self->_queryResults hash];
  return [(NSData *)self->_continuationMarker hash] ^ v3;
}
