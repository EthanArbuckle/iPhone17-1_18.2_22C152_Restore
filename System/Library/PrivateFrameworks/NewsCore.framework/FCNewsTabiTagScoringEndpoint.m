...
- (FCNewsTabiTagScoringConfiguration)configuration;
- (FCNewsTabiTagScoringEndpoint)init;
- (FCNewsTabiTagScoringEndpoint)initWithDictionary:(id)a3;
...
- (id)description
{
  ...
  v4 = [(FCNewsTabiTagScoringEndpoint *)self packageAssetID];
  [v3 appendFormat:@"\n\tpackageAssetID: %@;", v4];

  v5 = [(FCNewsTabiTagScoringEndpoint *)self configuration];
  v6 = [v5 indentedDescription];
  [v3 appendFormat:@"\n\tconfiguration: %@;", v6];

  v7 = [(FCNewsTabiTagScoringEndpoint *)self eventAggregationOutputs];
...
- (FCNewsTabiTagScoringEndpoint)initWithDictionary:(id)a3
{
  ...
  {
    id v7 = v5;
    v8 = [[FCNewsTabiTagScoringConfiguration alloc] initWithDictionary:v4];
    v9 = v8;
    if (v8)
    {
      v10 = v8;
      v18.receiver = self;
      v18.super_class = (Class)FCNewsTabiTagScoringEndpoint;
    ...
    else
    {
      ...
      v19[3] = &unk_1E5B4C840;
      v20 = (FCNewsTabiTagScoringConfiguration *)v4;
      __51__FCNewsTabiTagScoringEndpoint_initWithDictionary___block_invoke_5((uint64_t)v19);
      v16 = (FCNewsTabiTagScoringEndpoint *)objc_claimAutoreleasedReturnValue();
      v10 = v20;
    }
  }
  else
  {
    ...
    v21[3] = &unk_1E5B4C840;
    id v22 = v4;
    __51__FCNewsTabiTagScoringEndpoint_initWithDictionary___block_invoke((uint64_t)v21);
    v16 = (FCNewsTabiTagScoringEndpoint *)objc_claimAutoreleasedReturnValue();
    id v7 = v22;
  }
...
- (FCNewsTabiTagScoringEndpoint)init
{
  return [(FCNewsTabiTagScoringEndpoint *)self initWithDictionary:0];
}
...
uint64_t __51__FCNewsTabiTagScoringEndpoint_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    int v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1A460D000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiTagScoringEndpoint due to failure to decode packageAssetID from configuration %{public}@", (uint8_t *)&v7, 0xCu);
  }
  return 0;
}
...
uint64_t __51__FCNewsTabiTagScoringEndpoint_initWithDictionary___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    int v7 = 138543362;
    v8 = v6;
    _os_log_error_impl(&dword_1A460D000, v5, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiTagScoringEndpoint due to failure to decode configuration from configuration %{public}@", (uint8_t *)&v7, 0xCu);
  }
  return 0;
}
