...
- (FCAdCategoryFeature)init
{
  ...
  [(FCAdCategoryFeature *)self initWithTagID:&stru_1EF8299B8];
  ...
  v5 = [NSString stringWithFormat:@"%@: %s", @"Do not call method", "-[FCAdCategoryFeature init]"];
...
- (FCAdCategoryFeature)initWithTagID:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v8 = [NSString stringWithFormat:@"%@%@%@", @"fa1", @"+", v5];
