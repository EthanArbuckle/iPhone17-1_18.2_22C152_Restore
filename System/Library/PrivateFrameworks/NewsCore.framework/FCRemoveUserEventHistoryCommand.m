...
- (FCRemoveUserEventHistoryCommand)initWithSessionIDs:(id)a3;
@end
...
- (FCRemoveUserEventHistoryCommand)initWithSessionIDs:(id)a3
{
  ...
  id v5 = a3;
  id v6 = [v4 alloc];
  v7 = (void *)[v6 initWithZoneName:@"UserEventHistory" ownerName:*MEMORY[0x1E4F19C08]];
  v13[0] = MEMORY[0x1E4F143A8];
  v13[1] = 3221225472;
  v13[2] = __54__FCRemoveUserEventHistoryCommand_initWithSessionIDs___block_invoke;
  v13[3] = &unk_1E5B4DC20;
  id v14 = v7;
  id v8 = v7;
...
id __54__FCRemoveUserEventHistoryCommand_initWithSessionIDs___block_invoke(uint64_t a1, void *a2)
{
