...
- (FCArticleDraftAccessChecker)init
{
  ...
  if (os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    ...
    __int16 v9 = 2080;
    objc_super v10 = "FCArticleDraftAccessChecker.m";
    __int16 v11 = 1024;
    int v12 = 24;
    __int16 v13 = 2114;
    v14 = v2;
  ...
  id v5 = [NSString stringWithFormat:@"%@: %s", @"Do not call method", "-[FCArticleDraftAccessChecker init]"];
...
- (BOOL)canSynchronouslyCheckAccessToItem:(id)a3
{
  ...
  if (!v4 && os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    __int16 v9 = "-[FCArticleDraftAccessChecker canSynchronouslyCheckAccessToItem:]";
    __int16 v10 = 2080;
    __int16 v11 = "FCArticleDraftAccessChecker.m";
    __int16 v12 = 1024;
    int v13 = 42;
    __int16 v14 = 2114;
    uint64_t v15 = v7;
  ...
  {
    BOOL v5 = [(FCArticleDraftAccessChecker *)self shouldShowAllDraftContent];
  }
  else
  {
    BOOL v5 = 0;
...
- (BOOL)hasAccessToItem:(id)a3 blockedReason:(unint64_t *)a4 error:(id *)a5
{
  ...
  if (!v7 && os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    int v13 = "-[FCArticleDraftAccessChecker hasAccessToItem:blockedReason:error:]";
    __int16 v14 = 2080;
    uint64_t v15 = "FCArticleDraftAccessChecker.m";
    __int16 v16 = 1024;
    int v17 = 50;
    __int16 v18 = 2114;
    uint64_t v19 = v11;
  ...
  if (![v7 isDraft]
    ...
    || [(FCArticleDraftAccessChecker *)self shouldShowAllDraftContent])
  {
    LOBYTE(a5) = 1;
  }
  else if (a5)
...
- (void)checkAccessToItem:(id)a3 withQualityOfService:(int64_t)a4 completion:(id)a5
{
  ...
  if (!v8 && os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    uint64_t v19 = "-[FCArticleDraftAccessChecker checkAccessToItem:withQualityOfService:completion:]";
    __int16 v20 = 2080;
...
LABEL_6:
  ...
  {
    id v10 = [(FCArticleDraftAccessChecker *)self privateChannelMembershipController];
    ...
    id v15 = v8;
    id v16 = v9;
    [v10 isAllowedToSeeArticleID:v11 completionBlock:v14];
  }
}
