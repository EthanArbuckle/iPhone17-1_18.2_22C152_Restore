...
- (__CFString)axss_keyChordKeyDisplayValueForUSKeyboard:()AXSSKeyChordExtras
{
  if (([a1 isEqualToString:@"␣"] & 1) != 0
    || [a1 isEqualToString:@" "])
  {
    v5 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.AccessibilitySharedSupport"];
    v6 = v5;
    v7 = @"AXSSKeySymbolSpace";
LABEL_4:
    v8 = [v5 localizedStringForKey:v7 value:&stru_1F0C5BA58 table:@"AccessibilitySharedSupport"];
