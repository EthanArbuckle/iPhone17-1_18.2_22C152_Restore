...
- (void)setPid:(int)a3;
- (void)setPolicyStatus:(int64_t)a3;
- (void)setToken:(id)a3;
@end
...
{
  uint64_t v36 = *MEMORY[0x1E4F143B8];
  v5 = (BKSHIDEventDeferringToken *)a3;
  if (!v5)
  {
    v8 = NSString;
    v9 = (objc_class *)objc_opt_class();
    v10 = NSStringFromClass(v9);
    v11 = [v8 stringWithFormat:@"Value for '%@' was unexpectedly nil. Expected %@.", @"token", v10];
  ...
  {
    v15 = NSString;
    v16 = (objc_class *)[(BKSHIDEventDeferringToken *)v6 classForCoder];
    if (!v16) {
      v16 = (objc_class *)objc_opt_class();
    }
    v17 = NSStringFromClass(v16);
    v18 = (objc_class *)objc_opt_class();
    v19 = NSStringFromClass(v18);
    v20 = [v15 stringWithFormat:@"Value for '%@' was of unexpected class %@. Expected %@.", @"token", v17, v19];
