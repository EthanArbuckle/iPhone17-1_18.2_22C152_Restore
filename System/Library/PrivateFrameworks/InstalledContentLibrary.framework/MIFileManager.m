...
LABEL_15:
  ...
  if (v23)
  {
    id v25 = (void *)*MEMORY[0x1E4F28798];
...
- (BOOL)_copyItemAtURL:(id)a3 toURL:(id)a4 failIfSrcMissing:(BOOL)a5 alwaysClone:(BOOL)a6 ignoreErrors:(BOOL)a7 error:(id *)a8
{
        ...
        !lstat((const char *)[v16 fileSystemRepresentation], &v42)))
  {
    ...
    {
      uint64_t v21 = (void *)*MEMORY[0x1E4F28798];
      int v22 = [v20 path];
...
LABEL_28:
      ...
      int v29 = (void *)*MEMORY[0x1E4F28798];
      strerror(*v17);
  ...
  if (v21)
  {
    ...
    if (v23 != 30)
    {
      if (v23 != 18)
      {
        uint64_t v31 = (void *)*MEMORY[0x1E4F28798];
        strerror(*v22);
    ...
    copyfile_flags_t v24 = objc_msgSend(v12, "path", v34, v35);
...
- (id)createTemporaryDirectoryInDirectoryURL:(id)a3 error:(id *)a4
{
  ...
  if (mkdtemp(v6))
  {
    id v7 = [MEMORY[0x1E4F1CB10] fileURLWithFileSystemRepresentation:v6 isDirectory:1 relativeToURL:0];
    free(v6);
  }
  else
  {
...
LABEL_21:
  ...
  BOOL v19 = (void *)*MEMORY[0x1E4F28798];
...
LABEL_20:
  ...
  _CreateAndLogError((uint64_t)"-[MIFileManager _bulkSetPropertiesForPath:existingFD:UID:GID:mode:flags:dataProtectionClass:removeACL:error:]", 651, (void *)*MEMORY[0x1E4F28798], v27, 0, 0, @"setattrlist failed for file %s", v28, (uint64_t)v34);
LABEL_21:
...
uint64_t __125__MIFileManager_stageURLByMoving_toItemName_inStagingDir_settingUID_gid_dataProtectionClass_breakHardlinks_hasSymlink_error___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  {
    int v32 = *__error();
    int v33 = (void *)*MEMORY[0x1E4F28798];
    uint64_t v34 = v32;
    strerror(v32);
...
LABEL_41:
  id v36 = objc_msgSend(MEMORY[0x1E4F1CB10], "fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:", v13, 0, 0, v44, v46, v47, v48);
  id v55 = 0;
    ...
    switch(v27)
    {
      case 1:
        if (copyfile(*(const char **)(a2 + 16), *(const char **)(a1 + 80), 0, 0xC0008u))
        {
          ...
          _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 992, @"MIInstallerErrorDomain", 4, v55, &unk_1F170F6B0, @"Failed to copyfile %s to %s", v62, *(void *)(a2 + 16));
          goto LABEL_43;
        }
        break;
      case 3:
        if (link(*(const char **)(a2 + 16), *(const char **)(a1 + 80)))
        {
          ...
          _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1002, @"MIInstallerErrorDomain", 4, v55, &unk_1F170F6D8, @"Failed to link %s to %s", v68, *(void *)(a2 + 16));
          goto LABEL_43;
        }
        break;
      case 2:
        ...
        if (clonefile(*(const char **)(a2 + 16), *(const char **)(a1 + 80), 3u))
        {
          ...
          if (v30 != 18)
          {
            ...
            _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 981, @"MIInstallerErrorDomain", 4, v25, &unk_1F170F688, @"Failed to clonefile %s to %s", v90, *v28);
            goto LABEL_35;
          }
          ...
          {
            int v31 = *__error();
            int v32 = (void *)*MEMORY[0x1E4F28798];
            uint64_t v33 = v31;
            uint64_t v34 = *v28;
            strerror(v31);
            ...
            _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 977, @"MIInstallerErrorDomain", 4, v25, &unk_1F170F660, @"Failed to copyfile %s to %s", v36, *v28);
            goto LABEL_35;
          }
        }
        break;
...
LABEL_47:
  ...
  if (v18 == 5)
  {
    *(unsigned char *)(*(void *)(*(void *)(a1 + 72) + 8) + 24) = 1;
    ...
    if (v37 != -1)
    {
      ...
      {
        int v38 = *__error();
        unsigned int v39 = (void *)*MEMORY[0x1E4F28798];
        uint64_t v40 = v38;
        ...
        _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1032, @"MIInstallerErrorDomain", 4, v25, &unk_1F170F728, @"Failed to symlink %s -> %s", v43, *(void *)(a1 + 80));
        goto LABEL_35;
      }
      goto LABEL_47;
    }
    int v50 = *__error();
    uint64_t v51 = (void *)*MEMORY[0x1E4F28798];
    uint64_t v52 = v50;
    ...
    _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1022, @"MIInstallerErrorDomain", 4, v55, &unk_1F170F700, @"Failed to readlink %s", v56, *(void *)(a2 + 16));
  ...
  if (v18 != 2)
  {
    _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 1038, @"MIInstallerErrorDomain", 3, 0, &unk_1F170F750, @"Unknown filesystem object type %u encountered at %s", a8, *(unsigned int *)(a2 + 56));
  ...
  {
    int v20 = *__error();
    unint64_t v21 = (void *)*MEMORY[0x1E4F28798];
    uint64_t v22 = v20;
    ...
    _CreateAndLogError((uint64_t)"-[MIFileManager _stageURLByCopying:toItemName:inStagingDir:stagingMode:settingUID:gid:dataProtectionClass:hasSymlink:error:]_block_invoke", 951, @"MIInstallerErrorDomain", 4, v25, &unk_1F170F638, @"Failed to mkdir %s", v26, *(void *)(a1 + 80));
...
- (BOOL)standardizeOwnershipAtURL:(id)a3 toUID:(unsigned int)a4 GID:(unsigned int)a5 removeACLs:(BOOL)a6 setProtectionClass:(BOOL)a7 foundSymlink:(BOOL *)a8 error:(id *)a9
{
  ...
  ssize_t v37 = __Block_byref_object_dispose__9;
  id v38 = 0;
  uint64_t v29 = 0;
  uint64_t v30 = &v29;
...
uint64_t __59__MIFileManager_validateSymlinksInURLDoNotEscapeURL_error___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  int v4 = [MEMORY[0x1E4F1CB10] fileURLWithFileSystemRepresentation:*(void *)(a2 + 16) isDirectory:0 relativeToURL:0];
  uint64_t v5 = [*(id *)(a1 + 32) realPathForURL:v4 ifChildOfURL:*(void *)(a1 + 40)];
  BOOL v6 = v5 != 0;

  if (!v5)
  {
    uint64_t v8 = _CreateAndLogError((uint64_t)"-[MIFileManager validateSymlinksInURLDoNotEscapeURL:error:]_block_invoke", 1161, @"MIInstallerErrorDomain", 70, 0, &unk_1F170F778, @"invalid symlink at %s", v7, *(void *)(a2 + 16));
...
uint64_t __80__MIFileManager_enumerateURLsForItemsInDirectoryAtURL_ignoreSymlinks_withBlock___block_invoke(uint64_t a1, uint64_t a2, unsigned char *a3)
{
  ...
  {
    uint64_t v8 = [MEMORY[0x1E4F1CB10] fileURLWithFileSystemRepresentation:*(void *)(a2 + 16) isDirectory:v4 == 2 relativeToURL:0];
    *a3 = 0;
...
{
  uint64_t v6 = [MEMORY[0x1E4F1CB10] fileURLWithFileSystemRepresentation:*(void *)(a2 + 16) isDirectory:*(_DWORD *)(a2 + 56) == 2 relativeToURL:0];
  char v11 = 1;
...
- (id)urlsForItemsInDirectoryAtURL:(id)a3 ignoringSymlinks:(BOOL)a4 error:(id *)a5
{
  ...
  if (!v26[5])
  {
    if (v12)
    {
      id v15 = objc_msgSend(v11, "copy", v17, v18, v19, v20);
      if (!a5) {
        goto LABEL_9;
      }
      goto LABEL_7;
...
uint64_t __69__MIFileManager_urlsForItemsInDirectoryAtURL_ignoringSymlinks_error___block_invoke(uint64_t a1, uint64_t a2, unsigned char *a3)
{
  ...
  {
    id v9 = [MEMORY[0x1E4F1CB10] fileURLWithFileSystemRepresentation:*(void *)(a2 + 16) isDirectory:v4 == 2 relativeToURL:0];
    BOOL v10 = v9 != 0;
    if (v9)
    {
      *a3 = 0;
...
- (BOOL)_itemIsType:(unsigned __int16)a3 withDescription:(id)a4 atURL:(id)a5 error:(id *)a6
{
  ...
  if (lstat(v10, &v18))
  {
    ...
    if (a6)
    {
      uint64_t v14 = (void *)*MEMORY[0x1E4F28798];
      strerror(v13);
...
LABEL_12:
  ...
  if ((v18.st_mode & 0xF000) != v8)
  {
    if (a6)
    {
      _CreateError((uint64_t)"-[MIFileManager _itemIsType:withDescription:atURL:error:]", 1393, (void *)*MEMORY[0x1E4F28798], 22, 0, 0, @"%s is not a %@ (mode 0%ho)", v11, (uint64_t)v10);
      goto LABEL_12;
    }
LABEL_13:
    BOOL v16 = 0;
...
- (int)deviceForURLOrFirstAvailableParent:(id)a3 error:(id *)a4
{
  ...
  if (lstat(v6, &v17))
  {
    ...
    if (v9 == 2)
    {
      ...
      _CreateError((uint64_t)"-[MIFileManager deviceForURLOrFirstAvailableParent:error:]", 1460, (void *)*MEMORY[0x1E4F28798], 2, 0, 0, @"lstat for path \"/\" failed, which should never happen!", v10, v16);
    }
    else
    {
LABEL_6:
      _CreateError((uint64_t)"-[MIFileManager deviceForURLOrFirstAvailableParent:error:]", 1467, (void *)*MEMORY[0x1E4F28798], v9, 0, 0, @"lstat failed for %s", v8, (uint64_t)v6);
    }
  }
  else
  {
LABEL_7:
    ...
    _CreateError((uint64_t)"-[MIFileManager deviceForURLOrFirstAvailableParent:error:]", 1452, (void *)*MEMORY[0x1E4F28798], 22, 0, 0, @"lstat succeeded but st_dev was -1 for %s", v7, (uint64_t)v6);
  uint64_t v14 = };
  id v13 = v14;
  if (a4)
  {
...
{
  id v11 = 0;
  id v5 = [MEMORY[0x1E4F28CB0] fileHandleForReadingFromURL:a3 error:&v11];
  id v6 = v11;
  if (v5)
  {
    id v10 = 0;
...
- (id)aclTextFromURL:(id)a3 error:(id *)a4
{
  ...
  if (file)
  {
    ...
    int v16 = *__error();
    stat v17 = (void *)*MEMORY[0x1E4F28798];
    stat v18 = [v5 path];
    strerror(v16);
...
- (id)extendedAttributesFromURL:(id)a3 error:(id *)a4
{
  ...
  if ((v6 & 0x80000000) == 0)
  {
    ...
    {
      int v26 = *__error();
      uint64_t v27 = (void *)*MEMORY[0x1E4F28798];
      id v28 = [v5 path];
      strerror(v26);
    ...
    else
    {
      ...
      if (v8)
      {
        ...
        if (v10)
        {
          ...
          {
            int v35 = *__error();
            uint64_t v36 = (void *)*MEMORY[0x1E4F28798];
            id v28 = [v5 path];
            strerror(v35);
...
LABEL_22:
        ...
        int v31 = *__error();
        char v32 = (void *)*MEMORY[0x1E4F28798];
        id v28 = [v5 path];
        strerror(v31);
...
LABEL_9:
    ...
    stat v18 = (void *)*MEMORY[0x1E4F28798];
...
- (BOOL)setDataProtectionClassOfItemAtURL:(id)a3 toClass:(int)a4 ifPredicate:(id)a5 error:(id *)a6
{
  ...
  if (v12 < 0)
  {
    uint64_t v19 = (void *)*MEMORY[0x1E4F28798];
    uint64_t v20 = *__error();
...
- (BOOL)setOwnerOfURL:(id)a3 toUID:(unsigned int)a4 gid:(unsigned int)a5 error:(id *)a6
{
  ...
  {
    int v11 = *__error();
    int v12 = (void *)*MEMORY[0x1E4F28798];
...
- (BOOL)captureStoreDataFromDirectory:(id)a3 toDirectory:(id)a4 doCopy:(BOOL)a5 failureIsFatal:(BOOL)a6 includeiTunesMetadata:(BOOL)a7 withError:(id *)a8
{
  ...
  [MEMORY[0x1E4F1C978] arrayWithObjects:v49 count:5];
  long long v40 = 0u;
  long long v41 = 0u;
  long long v42 = 0u;
  long long v43 = 0u;
    ...
    while (1)
    {
      ...
      if (v35)
      {
        ...
        if (!v21)
        {
          ...
          uint64_t v23 = [&unk_1F170F9E0 objectAtIndexedSubscript:v14];
          uint64_t v47 = v23;
          BOOL v24 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v47 forKeys:&v46 count:1];
      ...
      else
      {
        ...
        if (!v26)
        {
          ...
          uint64_t v23 = [&unk_1F170F9E0 objectAtIndexedSubscript:v14];
          uint64_t v45 = v23;
          BOOL v24 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v45 forKeys:&v44 count:1];
...
- (id)_realPathWhatExistsInPath:(id)a3 isDirectory:(BOOL)a4
{
  ...
  else
  {
    do
    {
      int v8 = objc_msgSend(v5, "subarrayWithRange:", 0, v7 + 1);
      int v9 = [MEMORY[0x1E4F1CB10] fileURLWithPathComponents:v8];
      id v10 = 0;
      if ([(MIFileManager *)self itemExistsAtURL:v9])
      {
        ...
        if (v11)
        {
          uint64_t v12 = objc_msgSend(v5, "subarrayWithRange:", v7 + 1, objc_msgSend(v5, "count") - (v7 + 1));
          ...
          id v10 = objc_msgSend(v11, "URLByAppendingPathComponent:isDirectory:", v13, v17, v15, v16);
        }
        else
        {
          id v10 = 0;
...
- (id)realPathForURL:(id)a3 allowNonExistentPathComponents:(BOOL)a4 isDirectory:(BOOL)a5 error:(id *)a6
{
  ...
  {
    uint64_t v12 = [MEMORY[0x1E4F1CB10] fileURLWithFileSystemRepresentation:v22 isDirectory:v7 relativeToURL:0];
LABEL_11:
  ...
  id v15 = (void *)*MEMORY[0x1E4F28798];
    ...
    if (v10)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          else if (([v15 isEqualToString:&stru_1F16FEFE8] & 1) == 0 {
...
- (id)realPathForURL:(id)a3 ifChildOfURL:(id)a4
{
  ...
  if (v15)
  {
    ...
    uint64_t v18 = [v17 substringFromIndex:objc_msgSend(@"/private", "length")];
...
LABEL_37:
  ...
  id v31 = [v6 path];
  char v32 = [v7 path];
  uint64_t v33 = objc_msgSend(v31, "substringFromIndex:", objc_msgSend(v32, "length"));
...
- (BOOL)markBundleAsPlaceholder:(id)a3 withError:(id *)a4
{
  ...
  if (v6)
  {
    id v7 = __error();
    int v8 = *v7;
    uint64_t v10 = _CreateError((uint64_t)"-[MIFileManager markBundleAsPlaceholder:withError:]", 2101, (void *)*MEMORY[0x1E4F28798], *v7, 0, 0, @"setxattr for %s on %s failed", v9, (uint64_t)"com.apple.installd.placeholder");
    strerror(v8);
...
- (BOOL)clearPlaceholderStatusForBundle:(id)a3 withError:(id *)a4
{
  ...
  {
    id v7 = __error();
    uint64_t v9 = _CreateError((uint64_t)"-[MIFileManager clearPlaceholderStatusForBundle:withError:]", 2125, (void *)*MEMORY[0x1E4F28798], *v7, 0, 0, @"removexattr on %s for %s failed", v8, (uint64_t)v5);
...
- (BOOL)_markEAFlag:(const char *)a3 forAppIdentifier:(id)a4 insecurelyCachedOnBundle:(id)a5 error:(id *)a6
{
  ...
  if (v12 < 0)
  {
    uint64_t v23 = __error();
    int v24 = *v23;
    uint64_t v25 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:*v23 userInfo:0];
...
LABEL_10:
  ...
  if (fsetxattr(v12, a3, &value, 4uLL, 0, 0))
  {
    uint64_t v14 = __error();
    int v15 = *v14;
    BOOL v16 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:*v14 userInfo:0];
    [v11 fileSystemRepresentation];
    strerror(v15);
...
LABEL_6:
  ...
  if (fsetxattr(v13, "com.apple.installd.appIdentifier", v28, v29, 0, 0))
  {
    BOOL v30 = __error();
    int v31 = *v30;
    char v32 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:*v30 userInfo:0];
    id v33 = v11;
...
- (id)_insecureCachedAppIdentifierIfMarkedWithEAFlag:(const char *)a3 bundleURL:(id)a4 allowPlaceholders:(BOOL)a5 error:(id *)a6
{
  ...
  if (v10 < 0)
  {
    BOOL v16 = __error();
    int v17 = *v16;
    uint64_t v18 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:*v16 userInfo:0];
  ...
  if (fgetxattr(v10, a3, &value, 4uLL, 0, 0) != 4)
  {
    ...
    {
      uint64_t v27 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:v23 userInfo:0];
...
- (BOOL)setInstallType:(id)a3 inExtendedAttributeOnBundle:(id)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    int v10 = __error();
    int v11 = *v10;
    int v12 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:*v10 userInfo:0];
...
- (id)installTypeFromExtendedAttributeOnBundle:(id)a3 error:(id *)a4
{
  ...
  if (v6 < 0)
  {
    ...
    {
      uint64_t v14 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F28798] code:v9 userInfo:0];
...
LABEL_4:
  ...
  int v22 = *v21;
  int v24 = _CreateError((uint64_t)"-[MIFileManager _setData:forExtendedAttributeNamed:onURL:orFD:error:]", 2337, (void *)*MEMORY[0x1E4F28798], *v21, 0, 0, @"[f]setxattr failed for path %s fd %d", v23, (uint64_t)v14);
  strerror(v22);
...
- (id)_dataForExtendedAttributeNamed:(id)a3 length:(unint64_t)a4 onURL:(id)a5 orFD:(int)a6 error:(id *)a7
{
  id v11 = (void *)MEMORY[0x1E4F1CA58];
  id v12 = a5;
  id v13 = a3;
...
LABEL_3:
  ...
  if (v25 == 93)
  {
    uint64_t v26 = _CreateError((uint64_t)"-[MIFileManager _dataForExtendedAttributeNamed:length:onURL:orFD:error:]", 2382, (void *)*MEMORY[0x1E4F28798], 93, 0, 0, @"Attr named %s not present on \"%s\"", v24, (uint64_t)v17);
LABEL_10:
    uint64_t v23 = (void *)v26;
    goto LABEL_12;
  }
  BOOL v27 = _CreateError((uint64_t)"-[MIFileManager _dataForExtendedAttributeNamed:length:onURL:orFD:error:]", 2385, (void *)*MEMORY[0x1E4F28798], v25, 0, 0, @"[f]getxattr failed for path %s fd %d", v24, (uint64_t)v19);
  strerror(v25);
...
- (unint64_t)diskUsageForURL:(id)a3
{
  ...
  uint64_t v20 = 0;
  id v4 = [MEMORY[0x1E4F28D30] hashTableWithOptions:256];
  id v5 = v3;
...
- (BOOL)setModificationDateToNowForURL:(id)a3 error:(id *)a4
{
  ...
  {
    int v15 = *__error();
    id v16 = (void *)*MEMORY[0x1E4F28798];
...
- (id)modificationDateForURL:(id)a3 error:(id *)a4
{
  ...
  if (lstat((const char *)[v5 fileSystemRepresentation], &v11))
  {
    ...
    {
      int v6 = *__error();
      int v7 = (void *)*MEMORY[0x1E4F28798];
      int v8 = [v5 path];
      strerror(v6);
  ...
  {
    a4 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSince1970:(double)v11.st_mtimespec.tv_nsec / 1000000000.0 + (double)v11.st_mtimespec.tv_sec];
  }
...
- (id)debugDescriptionForItemAtURL:(id)a3
{
  ...
  id v16 = [v15 domain];
  if (![v16 isEqualToString:*MEMORY[0x1E4F28798]])
  {
...
LABEL_32:
  int v22 = objc_msgSend(v8, "pathExtension", v35);
  int v23 = [v22 isEqualToString:@"plist"];

  if (v23)
  {
    id v45 = v19;
    uint64_t v24 = objc_msgSend(MEMORY[0x1E4F1C9E8], "MI_dictionaryWithContentsOfURL:options:error:", v8, 0, &v45);
    id v25 = v45;
...
LABEL_37:
  ...
  stat v11 = objc_msgSend(v7, "copy", v36, v38);
...
- (void)logAccessPermissionsForURL:(id)a3
{
  ...
  id v3 = objc_msgSend(a3, "MI_allAccessURLs");
  long long v34 = 0u;
  long long v35 = 0u;
  long long v36 = 0u;
  long long v37 = 0u;
        ...
        if (!lstat((const char *)[v9 fileSystemRepresentation], &v33))
        {
          ...
          if (v12)
          {
            if (!gLogHandle || *(int *)(gLogHandle + 44) >= 5)
            {
              ...
              uint64_t v17 = objc_msgSend(v9, "path", v24, v25);
              uint64_t v27 = v17;
              uint64_t v28 = v12;
              id v25 = st_gid;
          ...
          if (!gLogHandle || *(int *)(gLogHandle + 44) >= 3)
          {
            uint64_t v24 = objc_msgSend(v9, "path", v24, v25, v26, v27, v28);
            id v25 = (char *)v11;
            MOLogWrite();
          }
LABEL_21:
...
LABEL_25:
        ...
        if (!gLogHandle || *(int *)(gLogHandle + 44) >= 3)
        {
          stat v11 = objc_msgSend(v9, "path", v24, v25);
          uint64_t v24 = v11;
          id v25 = strerror(v10);
          MOLogWrite();
LABEL_26:
...
+ (id)_sanitizeFilePathForVarOrTmpSymlink:(id)a3 error:(id *)a4
{
  ...
  if ([v5 hasPrefix:@"/var"])
  {
    uint64_t v6 = [MEMORY[0x1E4F1CB10] fileURLWithPath:@"/var/" isDirectory:1];
    ...
    if (v8)
    {
      ...
      uint64_t v12 = @"/var";
LABEL_7:
      id v14 = objc_msgSend(v5, "substringFromIndex:", -[__CFString length](v12, "length"));
  ...
  else
  {
    ...
    uint64_t v6 = [MEMORY[0x1E4F1CB10] fileURLWithPath:@"/tmp/" isDirectory:1];
...
LABEL_10:
  ...
  {
    int v34 = *__error();
    long long v35 = (void *)*MEMORY[0x1E4F28798];
    uint64_t v36 = v34;
    strerror(v34);
...
LABEL_20:
          ...
          {
            int v47 = *__error();
            uint64_t v54 = (void *)*MEMORY[0x1E4F28798];
            id v30 = [v62 path];
            id v48 = [v61 path];
            strerror(v47);
...
LABEL_28:
    ...
    int v38 = *__error();
    uint64_t v39 = (void *)*MEMORY[0x1E4F28798];
    uint64_t v40 = v38;
    strerror(v38);
...
- (void)_moveItemAtURL:(uint64_t)a1 toURL:(uint64_t)a2 failIfSrcMissing:error:.cold.1(uint64_t a1, uint64_t a2)
{
  ...
  __int16 v6 = 2080;
  uint64_t v7 = a2;
  _os_log_fault_impl(&dword_1BCA62000, MEMORY[0x1E4F14500], OS_LOG_TYPE_FAULT, "%s: Expected to move %s to %s but got EXDEV; falling back to copyfile",
    (uint8_t *)&v2,
    0x20u);
}
...
void __124__MIFileManager__stageURLByCopying_toItemName_inStagingDir_stagingMode_settingUID_gid_dataProtectionClass_hasSymlink_error___block_invoke_cold_1(uint64_t *a1, uint64_t *a2)
{
  ...
  __int16 v8 = 2080;
  uint64_t v9 = v3;
  _os_log_fault_impl(&dword_1BCA62000, MEMORY[0x1E4F14500], OS_LOG_TYPE_FAULT, "%s: Attempt to clone %s to %s failed with EXDEV; falling back to copyfile",
    (uint8_t *)&v4,
    0x20u);
}
