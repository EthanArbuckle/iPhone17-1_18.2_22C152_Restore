...
- (EKUICalendarsIntentResponse)initWithCoder:(id)a3
{
  return (EKUICalendarsIntentResponse *)sub_1DAF94DE4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (EKUICalendarsIntentResponse)initWithBackingStore:(id)a3
{
  return (EKUICalendarsIntentResponse *)sub_1DAF94DE4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
