...
- (NextEventComplicationConfigurationIntentResponse)initWithCoder:(id)a3
{
  return (NextEventComplicationConfigurationIntentResponse *)sub_100007FD4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (NextEventComplicationConfigurationIntentResponse)initWithBackingStore:(id)a3
{
  return (NextEventComplicationConfigurationIntentResponse *)sub_100007FD4((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
