...
- (LunarDateComplicationConfigurationIntentResponse)initWithCoder:(id)a3
{
  return (LunarDateComplicationConfigurationIntentResponse *)sub_100008B24((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (LunarDateComplicationConfigurationIntentResponse)initWithBackingStore:(id)a3
{
  return (LunarDateComplicationConfigurationIntentResponse *)sub_100008B24((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
