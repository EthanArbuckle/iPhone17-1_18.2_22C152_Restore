...
- (MLModel)model;
- (id)predictionFromFeature_vector:(id)a3 error:(id *)a4;
- (id)predictionFromFeatures:(id)a3 error:(id *)a4;
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5;
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5;
- (sceneLuxB2DItpMLModel)init;
- (sceneLuxB2DItpMLModel)initWithConfiguration:(id)a3 error:(id *)a4;
- (sceneLuxB2DItpMLModel)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (sceneLuxB2DItpMLModel)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (sceneLuxB2DItpMLModel)initWithMLModel:(id)a3;
...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    ...
    {
      *(_WORD *)v6 = 0;
      _os_log_error_impl(&dword_22224D000, &_os_log_internal, OS_LOG_TYPE_ERROR, "Could not load sceneLuxB2DItpMLModel.mlmodelc in the bundle resource", v6, 2u);
    }
    v4 = 0;
  }
...
- (sceneLuxB2DItpMLModel)initWithMLModel:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)sceneLuxB2DItpMLModel;
...
- (sceneLuxB2DItpMLModel)init
{
  ...
  v4 = [(sceneLuxB2DItpMLModel *)self initWithContentsOfURL:v3 error:0];
...
- (sceneLuxB2DItpMLModel)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(sceneLuxB2DItpMLModel *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(sceneLuxB2DItpMLModel *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(sceneLuxB2DItpMLModel *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(sceneLuxB2DItpMLModelOutput *)v12 initWithAnchor_points:v14];
  }
  else
  {
    v15 = 0;
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(sceneLuxB2DItpMLModel *)self model];
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(sceneLuxB2DItpMLModel *)self model];
...
{
  id v6 = a3;
  id v7 = [[sceneLuxB2DItpMLModelInput alloc] initWithFeature_vector:v6];

  id v8 = [(sceneLuxB2DItpMLModel *)self predictionFromFeatures:v7 error:a4];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(sceneLuxB2DItpMLModelOutput *)v16 initWithAnchor_points:v18];
