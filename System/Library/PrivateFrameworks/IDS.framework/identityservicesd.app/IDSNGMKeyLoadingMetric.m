...
- (IDSNGMKeyLoadingMetric)initWithErrorContainer:(id)a3 missingIdentity:(BOOL)a4 missingPrekey:(BOOL)a5
{
  id v9 = a3;
  v13.receiver = self;
  v13.super_class = (Class)IDSNGMKeyLoadingMetric;
...
- (NSDictionary)dictionaryRepresentation
{
  ...
  uint64_t v5 = [v4 registeredKeychainError];
  if (!v5)
  {
LABEL_14:
  ...
  uint64_t v8 = [v7 shouldHaveRegisteredIdentity];
  if (!v8)
  {

LABEL_6:
    objc_super v13 = [(IDSNGMKeyLoadingMetric *)self errorContainer];
...
LABEL_15:
  ...
  uint64_t v24 = [v23 unregisteredKeychainError];
  if (!v24)
  {
LABEL_28:
  ...
  uint64_t v27 = [v26 shouldHaveUnregisteredIdentity];
  if (!v27)
  {
