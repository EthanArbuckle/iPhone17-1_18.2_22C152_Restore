...
- (HFGroupDiffOperation)initWithOperationType:(unint64_t)a3 group:(id)a4 fromIndex:(id)a5 toIndex:(id)a6
{
  ...
  id v13 = a6;
  v17.receiver = self;
  v17.super_class = (Class)HFGroupDiffOperation;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      unint64_t v6 = [(HFGroupDiffOperation *)self type];
...
LABEL_24:
      ...
      id v7 = [(HFGroupDiffOperation *)self group];
      id v8 = [(HFGroupDiffOperation *)v5 group];
      if (![v7 isEqual:v8])
      {
        char v15 = 0;
LABEL_23:
      ...
      id v9 = [(HFGroupDiffOperation *)self fromIndex];
...
LABEL_22:
      ...
      objc_super v17 = [(HFGroupDiffOperation *)v5 toIndex];
      id v18 = v16;
      id v19 = v17;
      if (v18 == v19)
      {
...
- (unint64_t)hash
{
  unint64_t v3 = [(HFGroupDiffOperation *)self type];
  v4 = [(HFGroupDiffOperation *)self group];
  uint64_t v5 = [v4 hash];
  unint64_t v6 = [(HFGroupDiffOperation *)self fromIndex];
  uint64_t v7 = [v6 hash];
  id v8 = [(HFGroupDiffOperation *)self toIndex];
...
- (NSString)description
{
  ...
  uint64_t v5 = [(HFGroupDiffOperation *)self _operationDescriptionWithVerboseType:0];
...
- (NSString)operationDescription
{
  return (NSString *)[(HFGroupDiffOperation *)self _operationDescriptionWithVerboseType:1];
}
...
- (id)_operationDescriptionWithVerboseType:(BOOL)a3
{
  ...
  v13[3] = &unk_264091718;
  v13[4] = self;
  uint64_t v5 = __61__HFGroupDiffOperation__operationDescriptionWithVerboseType___block_invoke((uint64_t)v13);
  unint64_t v6 = [(HFGroupDiffOperation *)self type];
  if (v6 > 3)
  {
...
LABEL_6:
  id v8 = NSString;
  unint64_t v9 = [(HFGroupDiffOperation *)self group];
