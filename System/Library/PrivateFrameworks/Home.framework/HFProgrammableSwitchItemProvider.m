...
- (id)items
{
  v2 = [(HFProgrammableSwitchItemProvider *)self programmableSwitchAccessoryItems];
  v3 = (void *)[v2 copy];
...
- (id)reloadItems
{
  v3 = [(HFProgrammableSwitchItemProvider *)self home];
  v4 = objc_msgSend(v3, "hf_allProgrammableSwitchAccessories");
  ...
  v6 = [(HFProgrammableSwitchItemProvider *)self filter];
  v7 = [(HFItemProvider *)self reloadItemsWithHomeKitObjects:v4 filter:v6 itemMap:v5];
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
  v10[2] = __47__HFProgrammableSwitchItemProvider_reloadItems__block_invoke_2;
  v10[3] = &unk_26408D198;
...
id __47__HFProgrammableSwitchItemProvider_reloadItems__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  id v5 = [WeakRetained programmableSwitchAccessoryItems];
  v6 = [v3 addedItems];
  [v5 unionSet:v6];

  v7 = [WeakRetained programmableSwitchAccessoryItems];
...
- (HFProgrammableSwitchItemProvider)init
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"HFProgrammableSwitchItemProvider.m", 32, @"%s is unavailable; use %@ instead",
    "-[HFProgrammableSwitchItemProvider init]",
    v5);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = [(HFProgrammableSwitchItemProvider *)self home];
...
{
  id v3 = a2;
  id v4 = [HFProgrammableSwitchAccessoryItem alloc];
  id v5 = [*(id *)(a1 + 32) home];
  v6 = objc_msgSend(v5, "hf_characteristicValueManager");
  v7 = [(HFProgrammableSwitchAccessoryItem *)v4 initWithAccessory:v3 valueSource:v6];
