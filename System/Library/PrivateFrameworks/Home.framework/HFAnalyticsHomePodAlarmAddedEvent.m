...
- (id)payload;
- (void)setAlarmAddedSuccessfully:(BOOL)a3;
...
- (HFAnalyticsHomePodAlarmAddedEvent)initWithData:(id)a3
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)HFAnalyticsHomePodAlarmAddedEvent;
...
{
  v13.receiver = self;
  v13.super_class = (Class)HFAnalyticsHomePodAlarmAddedEvent;
  ...
  v6 = objc_msgSend(NSNumber, "numberWithBool:", -[HFAnalyticsHomePodAlarmAddedEvent alarmAddedSuccessfully](self, "alarmAddedSuccessfully"));
  [v4 setObject:v6 forKeyedSubscript:@"homePodAlarmAddedSuccessfully"];

  v7 = objc_msgSend(NSNumber, "numberWithBool:", -[HFAnalyticsHomePodAlarmAddedEvent isMusicAlarm](self, "isMusicAlarm"));
  [v4 setObject:v7 forKeyedSubscript:@"isHomePodMusicAlarm"];

  v8 = objc_msgSend(NSNumber, "numberWithBool:", -[HFAnalyticsHomePodAlarmAddedEvent hasCustomVolume](self, "hasCustomVolume"));
...
- (BOOL)alarmAddedSuccessfully
{
  return self->_alarmAddedSuccessfully;
}

- (void)setAlarmAddedSuccessfully:(BOOL)a3
{
  self->_alarmAddedSuccessfully = a3;
}
