...
+ (BOOL)brc_swizzleInstanceMethod:()BRCSwizzle with:
{
  ...
  {
    v14 = brc_bread_crumbs((uint64_t)"+[NSObject(BRCSwizzle) brc_swizzleInstanceMethod:with:]", 22);
...
+ (BOOL)brc_swizzleClassMethod:()BRCSwizzle with:
{
  ...
  {
    v15 = brc_bread_crumbs((uint64_t)"+[NSObject(BRCSwizzle) brc_swizzleClassMethod:with:]", 41);
...
+ (BOOL)brc_swizzleInstanceMethod:()BRCSwizzle with:newSel:
{
  ...
  {
    v16 = brc_bread_crumbs((uint64_t)"+[NSObject(BRCSwizzle) brc_swizzleInstanceMethod:with:newSel:]", 59);
...
+ (BOOL)brc_swizzleClassMethod:()BRCSwizzle with:newSel:
{
  ...
  {
    v17 = brc_bread_crumbs((uint64_t)"+[NSObject(BRCSwizzle) brc_swizzleClassMethod:with:newSel:]", 78);
...
{
  OUTLINED_FUNCTION_4();
  OUTLINED_FUNCTION_0_0(&dword_19ED3F000, v0, v1, "[CRIT] API MISUSE: one of the selectors has no implementation%@", v2, v3, v4, v5, v6);
}
