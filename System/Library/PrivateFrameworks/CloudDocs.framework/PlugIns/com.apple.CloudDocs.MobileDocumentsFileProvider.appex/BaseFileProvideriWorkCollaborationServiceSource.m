...
- (BaseFileProvideriWorkCollaborationServiceSource)initWithItemIdentifier:(id)a3 operationQueue:(id)a4;
...
- (BaseFileProvideriWorkCollaborationServiceSource)initWithItemIdentifier:(id)a3 operationQueue:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)BaseFileProvideriWorkCollaborationServiceSource;
...
- (NSString)serviceName
{
  return (NSString *)@"com.apple.iWorkCollaboration";
}
