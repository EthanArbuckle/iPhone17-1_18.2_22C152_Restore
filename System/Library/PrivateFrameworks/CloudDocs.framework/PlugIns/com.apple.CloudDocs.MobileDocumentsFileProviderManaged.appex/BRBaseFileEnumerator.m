...
- (void)enumerateItemsForObserver:(id)a3 startingAtPage:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 134218498;
    id v38 = (BRBaseFileEnumerator *)v30;
    __int16 v39 = 2112;
    v40 = self;
    __int16 v41 = 2112;
    v42 = v13;
...
- (void)enumerateChangesForObserver:(id)a3 fromSyncAnchor:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    id v22 = [(BRFileObjectID *)self->_fileObjectID asString];
    *(_DWORD *)buf = 134218754;
    long long v27 = 0;
    __int16 v28 = 2112;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412802;
    long long v27 = v10;
    __int16 v28 = 2048;
    unsigned __int8 v29 = (BRBaseFileEnumerator *)v11;
    __int16 v30 = 2112;
    id v31 = v12;
  ...
  if (v13)
  {
    ...
    do
    {
      for (i = 0; i != v13; i = (char *)i + 1)
      {
        ...
        {
          id v22 = [(NSMutableDictionary *)v16 asFileProviderItem];
          BOOL v23 = v22 == 0;
...
LABEL_13:
  ...
  if (v11->_gatherEnumerationObserver && [(NSMutableDictionary *)v11->_updatedItemsByIDs count])
  {
    ...
    unsigned __int8 v29 = brc_default_log();
    ...
    id v31 = [(NSMutableDictionary *)v11->_updatedItemsByIDs allValues];
  ...
  unint64_t v33 = (char *)[(NSMutableDictionary *)v11->_updatedItemsByIDs count];
...
- (void)containerListDidChange
{
    ...
    || (id v3 = self->_personaID) == 0)
  {
    if (qword_100043D58 != -1) {
      dispatch_once(&qword_100043D58, &stru_100038798);
    }
...
- (void)_accountTokenDidChange
{
    ...
    || (id v3 = self->_personaID) == 0)
  {
    if (qword_100043D68 != -1) {
      dispatch_once(&qword_100043D68, &stru_1000387B8);
    }
...
LABEL_10:
  ...
  block[1] = 3221225472;
  block[2] = sub_100007808;
  block[3] = &unk_1000387E0;
  block[4] = self;
