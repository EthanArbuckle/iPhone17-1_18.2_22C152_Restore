...
- (void)collaborationMetadataForItemWithIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG)) {
      sub_1000236EC((uint64_t)v16, v17);
    }
    ...
    id v13 = [objc_alloc((Class)_SWCollaborationMetadata) initWithLocalIdentifier:v6 collaborationIdentifier:&stru_100039108 title:0 defaultShareOptions:v12 initiatorHandle:0 initiatorNameComponents:0];
...
+ (void)initialize
{
  ...
  {
    brc_block_remember_persona = sub_100014E1C;
    brc_activity_block_remember_persona = sub_100014F24;
  }
...
- (void)startProvidingItemAtURL:(id)a3 readingOptions:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  if (objc_msgSend(v8, "br_isInSyncedLocation"))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v26 = BRFileCoordinatorReadingOptionsPrettyPrint();
    ...
    if (objc_msgSend(v8, "br_isPromiseURL"))
    {
      ...
      if (os_log_type_enabled(v13, (os_log_type_t)0x90u)) {
        sub_100023F24(v8, (uint64_t)v12, v13);
      }
    ...
    v38[0] = NSURLIsDirectoryKey;
    v38[1] = NSURLIsPackageKey;
    v14 = +[NSArray arrayWithObjects:v38 count:2];
...
LABEL_15:
        ...
        id v30 = v12;
        id v31 = v9;
        [v19 setFileProvidingCompletion:v29];
        id v20 = self;
        objc_sync_enter(v20);
        ...
        if (!v22)
        {
          ...
          objc_super v28 = brc_default_log();
  ...
  if (v14)
  {
    ...
    if (v15)
    {
      ...
      *(void *)&buf[16] = 0x3032000000;
      v80 = sub_10001743C;
      *(void *)&long long v81 = sub_10001744C;
      *((void *)&v81 + 1) = 0;
      ...
      if ((v20 & 0x35FB) != 0)
      {
        ...
        id v63 = v22;
        v64 = buf;
        uint64_t v23 = objc_retainBlock(v58);
        __int16 v24 = v23;
        if ((v20 & 0x243A) != 0)
        {
          ...
          {
            id v27 = [v21 path];
            sub_1000242B0(v27, (uint64_t)v25, v69, v26);
          }
          ...
          id v33 = v28;
          long long v34 = v24;
          uint64_t v35 = self->_itemsForcedDownload;
          objc_sync_enter(v35);
      ...
      else
      {
        if (!*(void *)(*(void *)&buf[8] + 40))
        {
          ...
          v78 = v39;
          uint64_t v40 = +[NSDictionary dictionaryWithObjects:&v78 forKeys:&v77 count:1];
          uint64_t v41 = +[NSError errorWithDomain:NSCocoaErrorDomain code:512 userInfo:v40];
          v42 = *(void **)(*(void *)&buf[8] + 40);
        ...
        __int16 v45 = objc_msgSend(*(id *)(*(void *)&buf[8] + 40), "br_fileProviderError");
    ...
    {
      v38 = +[NSError fileProviderErrorForNonExistentItemWithIdentifier:v51];
...
- (void)trashItemWithIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  *(void *)&buf[8] = buf;
  *(void *)&buf[16] = 0x3032000000;
  uint64_t v40 = sub_10001743C;
  uint64_t v41 = sub_10001744C;
  id v42 = 0;
  uint64_t v26 = 0;
  id v27 = &v26;
  uint64_t v28 = 0x3032000000;
  id v29 = sub_10001743C;
  id v30 = sub_10001744C;
  id v31 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)uint64_t v35 = 138412546;
      ...
      __int16 v37 = 2112;
      v38 = v15;
      _os_log_debug_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_DEBUG, "[DEBUG] trashing %@%@", v35, 0x16u);
    }
    uint64_t v17 = v27[5];
...
- (void)setTagData:(id)a3 forItemIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  id v24 = 0;
  unsigned __int8 v16 = objc_msgSend(v15, "br_setTagNames:error:", v14, &v24);
  id v17 = v24;
  uint64_t v18 = v17;
  if (v16)
  {
    id v23 = v17;
    uint64_t v19 = [(BRFileProviderExtension *)self _propertiesForNewItemAtURL:v15 error:&v23];
    id v20 = v23;
...
LABEL_14:
    ...
    || [v15 br_wouldBeExcludedFromSync])
  {
    ...
    uint64_t v35 = sub_10001975C;
    long long v36 = &unk_100038E30;
    id v25 = v24;
    id v37 = v25;
...
- (id)persistentIdentifierForItemAtURL:(id)a3
{
  ...
  if (objc_msgSend(v4, "br_isInSyncedLocation"))
  {
    ...
    id v16 = 0;
    id v7 = [(BRFileProviderExtension *)self _propertiesForItemAtURL:v4 error:&v16];
    id v8 = v16;
    if (v8)
    {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v9, (os_log_type_t)0x90u))
      {
        ...
        *(_DWORD *)buf = 136315906;
        id v23 = "-[BRFileProviderExtension _isLoggedInOrError:]";
        __int16 v24 = 2080;
        if (!a3) {
    ...
    else
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, (os_log_type_t)0x90u))
        {
          ...
          *(_DWORD *)buf = 136315906;
          uint64_t v18 = "-[BRFileProviderExtension itemForIdentifier:error:]";
          __int16 v19 = 2080;
          if (!a4) {
...
- (id)_propertiesForItemAtURL:(id)a3 forceScan:(BOOL)a4 error:(id *)a5
{
  ...
  if (!v6)
  {
    ...
    id v17 = [v13 url];
    id v28 = 0;
    [v17 getPromisedItemResourceValue:&v28 forKey:NSURLCanonicalPathKey error:0];
    id v18 = v28;

    id v27 = 0;
    [v7 getPromisedItemResourceValue:&v27 forKey:NSURLCanonicalPathKey error:0];
    id v19 = v27;
    if (v19 && ([v18 isEqualToString:v19] & 1) == 0)
    {
      NSErrorUserInfoKey v20 = brc_bread_crumbs();
      __int16 v21 = brc_default_log();
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412802;
  ...
  else
  {
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v15, (os_log_type_t)0x90u))
      {
        id v17 = "(passed to caller)";
        *(_DWORD *)buf = 136315906;
        id v19 = "-[BRFileProviderExtension enumeratorForContainerItemIdentifier:error:]";
        __int16 v20 = 2080;
        if (!a4) {
          id v17 = "(ignored by caller)";
        }
...
- (void)_fetchThumbnailForContainerID:(id)a3 representedByItemWithIdentifer:(id)a4 size:(CGSize)a5 knownContainers:(id)a6 perThumbnailCompletionHandler:(id)a7
{
  ...
  if (v15)
  {
    ...
    else
    {
      ...
      if (v14)
      {
        id v26 = objc_msgSend(v24, "br_fileProviderError");
...
- (id)fetchThumbnailsForItemIdentifiers:(id)a3 requestedSize:(CGSize)a4 perThumbnailCompletionHandlerWithType:(id)a5 completionHandler:(id)a6
{
  ...
  __int16 v32 = v30;
  uint64_t v42 = v32;
  id v33 = objc_retainBlock(v41);
  __int16 v34 = sub_100009940(v13, v31, v12, v33);
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001B61C;
  block[3] = &unk_100038ED0;
  id v39 = v37;
  __int16 v40 = v44;
  id v35 = v37;
...
- (id)_defaultApplicationContainerForBundleIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  if (v5 && ![v5 isEqualToString:@"com.apple.DocumentsApp"])
  {
    ...
    if (v31)
    {
      ...
      long long v37 = 0u;
      id v14 = v11;
      id v15 = [v14 countByEnumeratingWithState:&v37 objects:v44 count:16];
      if (v15)
      {
...
- (void)_accountDidChange
{
  ...
  {
    if (qword_100043DB8 != -1) {
      dispatch_once(&qword_100043DB8, &stru_100038F40);
    }
    id v4 = (NSString *)(id)qword_100043DC0;
    int v5 = 1;
  }
  else
  {
...
LABEL_10:
  ...
  objc_msgSend(v13, "br_signalWorkingSetEnumeratorWithCompletionHandler:", &stru_100038F60);
