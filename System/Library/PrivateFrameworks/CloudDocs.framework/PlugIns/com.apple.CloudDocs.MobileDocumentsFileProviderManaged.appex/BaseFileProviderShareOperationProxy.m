...
- (void)startOperation:(id)a3 toCopyShareURLForShare:(id)a4 reply:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218498;
    uint64_t v28 = v24;
    __int16 v29 = 2080;
    v30 = "-[BaseFileProviderShareOperationProxy startOperation:toCopyShareURLForShare:reply:]";
    __int16 v31 = 2112;
    v32 = v11;
  ...
  else
  {
    ...
    v22[3] = &unk_100038648;
    id v23 = v10;
    sub_10000D024((uint64_t)v22, v17);
    v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toSaveSharingInfo:(id)a4 reply:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218498;
    uint64_t v28 = v24;
    __int16 v29 = 2080;
    v30 = "-[BaseFileProviderShareOperationProxy startOperation:toSaveSharingInfo:reply:]";
    __int16 v31 = 2112;
    v32 = v11;
    _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_INFO, "[INFO] ┏%llx %s %@", buf, 0x20u);
  }
  ...
  else
  {
    ...
    v22[3] = &unk_100038648;
    id v23 = v10;
    sub_10000D578((uint64_t)v22, v17);
    v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toUnshareShare:(id)a4 forceDelete:(BOOL)a5 reply:(id)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218498;
    uint64_t v30 = v26;
    __int16 v31 = 2080;
    v32 = "-[BaseFileProviderShareOperationProxy startOperation:toUnshareShare:forceDelete:reply:]";
    __int16 v33 = 2112;
    v34 = v13;
  ...
  else
  {
    ...
    v24[3] = &unk_100038648;
    id v25 = v12;
    sub_10000DAA4((uint64_t)v24, v19);
    id v20 = &v25;
  }
...
- (void)copyCurrentUserNameAndDisplayHandleWithReply:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218498;
    uint64_t v19 = v15;
    __int16 v20 = 2080;
    id v21 = "-[BaseFileProviderShareOperationProxy copyCurrentUserNameAndDisplayHandleWithReply:]";
    __int16 v22 = 2112;
    id v23 = v5;
  ...
  else
  {
    ...
    v13[3] = &unk_100038648;
    id v14 = v4;
    sub_10000DF44((uint64_t)v13, v10);
  }
  __brc_leave_section();
}
...
- (void)startOperation:(id)a3 toLookupShareParticipants:(id)a4 reply:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218498;
    uint64_t v28 = v24;
    __int16 v29 = 2080;
    uint64_t v30 = "-[BaseFileProviderShareOperationProxy startOperation:toLookupShareParticipants:reply:]";
    __int16 v31 = 2112;
    v32 = v11;
    _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_INFO, "[INFO] ┏%llx %s %@", buf, 0x20u);
  }
  ...
  if (v14)
  {
    ...
    uint64_t v16 = [(BaseFileProviderShareOperationProxy *)self remoteObject];
    v19[0] = _NSConcreteStackBlock;
    v19[1] = 3221225472;
    v19[2] = sub_10000E608;
    v19[3] = &unk_100038AD8;
  ...
  else
  {
    ...
    v22[3] = &unk_100038648;
    id v23 = v10;
    sub_10000E4F0((uint64_t)v22, v17);
    v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toCopyDocumentURLForRecordID:(id)a4 syncIfNeeded:(BOOL)a5 reply:(id)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218498;
    uint64_t v30 = v26;
    __int16 v31 = 2080;
    v32 = "-[BaseFileProviderShareOperationProxy startOperation:toCopyDocumentURLForRecordID:syncIfNeeded:reply:]";
    __int16 v33 = 2112;
    v34 = v13;
    _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_INFO, "[INFO] ┏%llx %s %@", buf, 0x20u);
  }
  ...
  else
  {
    ...
    v24[3] = &unk_100038648;
    id v25 = v12;
    sub_10000EA1C((uint64_t)v24, v19);
    id v20 = &v25;
  }
