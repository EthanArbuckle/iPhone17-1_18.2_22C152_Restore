...
- (void)enumerateItemsForObserver:(id)a3 startingAtPage:(id)a4
{
  ...
  sub_10001E454(0, (uint64_t)"-[BRBaseFileEnumerator enumerateItemsForObserver:startingAtPage:]", 294, v34);
  ...
  long long v30 = 0uLL;
  uint64_t v31 = 0;
  sub_10001E454(0, (uint64_t)"-[BRBaseFileEnumerator enumerateItemsForObserver:startingAtPage:]", 299, &v30);
  uint64_t v13 = brc_bread_crumbs();
  v14 = brc_default_log();
...
- (void)enumerateChangesForObserver:(id)a3 fromSyncAnchor:(id)a4
{
  ...
  sub_10001E454(0, (uint64_t)"-[BRBaseFileEnumerator enumerateChangesForObserver:fromSyncAnchor:]", 352, v27);
...
- (void)containerListDidChange
{
    ...
    || (id v3 = self->_personaID) == 0)
  {
    if (qword_100054858 != -1) {
      dispatch_once(&qword_100054858, &stru_1000453E8);
    }
    id v4 = (NSString *)(id)qword_100054860;
    int v5 = 1;
  }
  else
  {
...
LABEL_10:
  ...
  sub_10001E454(0, (uint64_t)"-[BRBaseFileEnumerator containerListDidChange]", 449, v23);
...
- (void)_accountTokenDidChange
{
    ...
    || (id v3 = self->_personaID) == 0)
  {
    if (qword_100054868 != -1) {
      dispatch_once(&qword_100054868, &stru_100045408);
    }
