...
- (void)startOperation:(id)a3 toCopySharingInfoWithReply:(id)a4
{
  ...
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toCopySharingInfoWithReply:]", 49, v22);
  v8 = brc_bread_crumbs();
  v9 = brc_default_log();
  ...
  else
  {
    ...
    v20[3] = &unk_1000445C0;
    id v21 = v7;
    sub_10000F944((uint64_t)v20, v15);
    v16 = &v21;
  }
...
- (void)startOperation:(id)a3 toCopySharingAccessTokenWithReply:(id)a4
{
  ...
  id v7 = a4;
  memset(v22, 0, sizeof(v22));
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toCopySharingAccessTokenWithReply:]", 62, v22);
  v8 = brc_bread_crumbs();
  v9 = brc_default_log();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
  ...
  else
  {
    ...
    v20[3] = &unk_1000445C0;
    id v21 = v7;
    sub_10000FE9C((uint64_t)v20, v15);
    v16 = &v21;
  }
...
- (void)startOperation:(id)a3 toCopyShortTokenWithReply:(id)a4
{
  ...
  id v7 = a4;
  memset(v22, 0, sizeof(v22));
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toCopyShortTokenWithReply:]", 73, v22);
  v8 = brc_bread_crumbs();
  v9 = brc_default_log();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
  ...
  else
  {
    ...
    v20[3] = &unk_1000445C0;
    id v21 = v7;
    sub_1000103F4((uint64_t)v20, v15);
    v16 = &v21;
  }
...
- (void)createSharingInfoWithReply:(id)a3
{
  ...
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy createSharingInfoWithReply:]", 84, v16);
  v5 = brc_bread_crumbs();
  ...
  else
  {
    ...
    v14[3] = &unk_1000445C0;
    id v15 = v4;
    sub_1000108D4((uint64_t)v14, v11);
  }
  sub_10001E628(v16);
}
...
- (void)startOperation:(id)a3 toModifyRecordWithAllowAccess:(BOOL)a4 reply:(id)a5
{
  ...
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toModifyRecordWithAllowAccess:reply:]", 93, v24);
  ...
  else
  {
    ...
    id v23 = v9;
    sub_100010E04((uint64_t)v22, v17);
    uint64_t v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toCopyParticipantTokenWithReply:(id)a4
{
  ...
  id v7 = a4;
  memset(v22, 0, sizeof(v22));
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toCopyParticipantTokenWithReply:]", 104, v22);
  ...
  else
  {
    ...
    v20[3] = &unk_1000445C0;
    id v21 = v7;
    sub_10001135C((uint64_t)v20, v15);
    v16 = &v21;
  }
...
- (void)startOperation:(id)a3 toPrepFolderForSharingWithReply:(id)a4
{
  ...
  id v7 = a4;
  memset(v22, 0, sizeof(v22));
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toPrepFolderForSharingWithReply:]", 115, v22);
  id v8 = brc_bread_crumbs();
  id v9 = brc_default_log();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
  ...
  else
  {
    ...
    v20[3] = &unk_1000445C0;
    id v21 = v7;
    sub_1000118B4((uint64_t)v20, v15);
    v16 = &v21;
  }
...
- (void)startOperation:(id)a3 toProcessSubitemsWithMaxSubsharesFailures:(unint64_t)a4 processType:(unint64_t)a5 reply:(id)a6
{
  ...
  sub_10001E454(1, (uint64_t)"-[ICDFileProviderShareOperationProxy startOperation:toProcessSubitemsWithMaxSubsharesFailures:processType:reply:]", 127, v26);
  ...
  else
  {
    ...
    id v25 = v11;
    sub_100011DCC((uint64_t)v24, v19);
    id v20 = &v25;
  }
