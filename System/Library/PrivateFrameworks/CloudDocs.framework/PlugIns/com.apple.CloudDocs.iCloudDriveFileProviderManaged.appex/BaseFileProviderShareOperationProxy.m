...
- (void)startOperation:(id)a3 toCopyShareURLForShare:(id)a4 reply:(id)a5
{
  ...
  sub_10001E454(1, (uint64_t)"-[BaseFileProviderShareOperationProxy startOperation:toCopyShareURLForShare:reply:]", 115, v24);
  ...
  if (v14)
  {
    objc_super v15 = sub_100008918(v8);
  ...
  else
  {
    ...
    v22[3] = &unk_1000445C0;
    id v23 = v10;
    sub_100008D98((uint64_t)v22, v17);
    v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toSaveSharingInfo:(id)a4 reply:(id)a5
{
  ...
  id v10 = a5;
  memset(v24, 0, sizeof(v24));
  sub_10001E454(1, (uint64_t)"-[BaseFileProviderShareOperationProxy startOperation:toSaveSharingInfo:reply:]", 126, v24);
  id v11 = brc_bread_crumbs();
  v12 = brc_default_log();
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
  ...
  else
  {
    ...
    v22[3] = &unk_1000445C0;
    id v23 = v10;
    sub_1000092EC((uint64_t)v22, v17);
    v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toUnshareShare:(id)a4 forceDelete:(BOOL)a5 reply:(id)a6
{
  ...
  sub_10001E454(1, (uint64_t)"-[BaseFileProviderShareOperationProxy startOperation:toUnshareShare:forceDelete:reply:]", 138, v26);
  ...
  else
  {
    ...
    id v25 = v12;
    sub_100009818((uint64_t)v24, v19);
    id v20 = &v25;
  }
...
- (void)copyCurrentUserNameAndDisplayHandleWithReply:(id)a3
{
  ...
  sub_10001E454(1, (uint64_t)"-[BaseFileProviderShareOperationProxy copyCurrentUserNameAndDisplayHandleWithReply:]", 149, v15);
  v5 = brc_bread_crumbs();
  v6 = brc_default_log();
  ...
  else
  {
    ...
    v13[3] = &unk_1000445C0;
    id v14 = v4;
    sub_100009CB8((uint64_t)v13, v10);
  }
  sub_10001E628(v15);
}
...
- (void)startOperation:(id)a3 toLookupShareParticipants:(id)a4 reply:(id)a5
{
  ...
  id v10 = a5;
  memset(v24, 0, sizeof(v24));
  sub_10001E454(1, (uint64_t)"-[BaseFileProviderShareOperationProxy startOperation:toLookupShareParticipants:reply:]", 160, v24);
  id v11 = brc_bread_crumbs();
  ...
  else
  {
    ...
    v22[3] = &unk_1000445C0;
    id v23 = v10;
    sub_10000A264((uint64_t)v22, v17);
    __int16 v18 = &v23;
  }
...
- (void)startOperation:(id)a3 toCopyDocumentURLForRecordID:(id)a4 syncIfNeeded:(BOOL)a5 reply:(id)a6
{
  ...
  id v12 = a6;
  memset(v26, 0, sizeof(v26));
  sub_10001E454(1, (uint64_t)"-[BaseFileProviderShareOperationProxy startOperation:toCopyDocumentURLForRecordID:syncIfNeeded:reply:]", 176, v26);
  v13 = brc_bread_crumbs();
  unsigned __int8 v14 = brc_default_log();
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
  ...
  else
  {
    ...
    uint64_t v24[3] = &unk_1000445C0;
    id v25 = v12;
    sub_10000A790((uint64_t)v24, v19);
    id v20 = &v25;
  }
