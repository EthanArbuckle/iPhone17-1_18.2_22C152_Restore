...
- (void)extractEtagsFromBaseVersion:(id)a3 withReply:(id)a4
{
  ...
  if (v6)
  {
    ...
    sub_10001E454(1, (uint64_t)"-[ICDFileProviderClientSideCollaborationServiceProxy extractEtagsFromBaseVersion:withReply:]", 54, v24);
    v7 = brc_bread_crumbs();
    v8 = brc_default_log();
...
- (void)calculateCollaborationVersionForContents:(id)a3 reply:(id)a4
{
  ...
  {
    memset(v24, 0, sizeof(v24));
    sub_10001E454(1, (uint64_t)"-[ICDFileProviderClientSideCollaborationServiceProxy calculateCollaborationVersionForContents:reply:]", 78, v24);
    v8 = brc_bread_crumbs();
    v9 = brc_default_log();
...
- (void)fetchLatestRevisionWithReply:(id)a3
{
  ...
  if (v4)
  {
    ...
    sub_10001E454(1, (uint64_t)"-[ICDFileProviderClientSideCollaborationServiceProxy fetchLatestRevisionWithReply:]", 103, v16);
...
- (void)fetchLatestRevisionIntoURL:(id)a3 reply:(id)a4
{
  ...
  if (v7)
  {
    ...
    sub_10001E454(1, (uint64_t)"-[ICDFileProviderClientSideCollaborationServiceProxy fetchLatestRevisionIntoURL:reply:]", 121, v39);
    v8 = brc_bread_crumbs();
...
- (id)uploadContents:(id)a3 baseVersion:(id)a4 reply:(id)a5
{
  ...
  if (v10)
  {
    ...
    sub_10001E454(1, (uint64_t)"-[ICDFileProviderClientSideCollaborationServiceProxy uploadContents:baseVersion:reply:]", 169, v29);
