...
- (id)fetchParticipantListAndPublicPermission:(id)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[ICDSharingProxy fetchParticipantListAndPublicPermission:]", 72, v14);
  v5 = brc_bread_crumbs();
  v6 = brc_default_log();
...
- (void)startPreparingForShareWhenForcing:(BOOL)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[ICDSharingProxy startPreparingForShareWhenForcing:]", 80, v8);
...
- (id)fetchShareWithCompletion:(id)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[ICDSharingProxy fetchShareWithCompletion:]", 89, v29);
  v5 = brc_bread_crumbs();
...
- (id)fetchShareURLWithCompletion:(id)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[ICDSharingProxy fetchShareURLWithCompletion:]", 127, v25);
  v5 = brc_bread_crumbs();
  uint64_t v6 = brc_default_log();
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
...
- (id)saveShare:(id)a3 completion:(id)a4
{
  ...
  sub_100004FB8(1, (uint64_t)"-[ICDSharingProxy saveShare:completion:]", 155, v32);
  v8 = brc_bread_crumbs();
...
- (id)unshareWithCompletion:(id)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[ICDSharingProxy unshareWithCompletion:]", 184, v20);
  v5 = brc_bread_crumbs();
