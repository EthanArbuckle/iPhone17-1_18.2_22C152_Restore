...
- (id)fetchParticipantListAndPublicPermission:(id)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[BaseSharingProxy fetchParticipantListAndPublicPermission:]", 68, v13);
  v5 = brc_bread_crumbs();
  v6 = brc_default_log();
...
- (void)startPreparingForShareWhenForcing:(BOOL)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[BaseSharingProxy startPreparingForShareWhenForcing:]", 76, v7);
...
- (id)saveShare:(id)a3 completion:(id)a4
{
  ...
  sub_100004FB8(1, (uint64_t)"-[BaseSharingProxy saveShare:completion:]", 98, v29);
...
- (id)unshareWithCompletion:(id)a3
{
  ...
  sub_100004FB8(1, (uint64_t)"-[BaseSharingProxy unshareWithCompletion:]", 127, v19);
  v5 = brc_bread_crumbs();
  v6 = brc_default_log();
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
