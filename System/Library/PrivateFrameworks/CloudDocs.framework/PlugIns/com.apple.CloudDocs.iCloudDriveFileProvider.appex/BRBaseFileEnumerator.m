...
- (void)enumerateItemsForObserver:(id)a3 startingAtPage:(id)a4
{
  ...
  sub_100004FB8(0, (uint64_t)"-[BRBaseFileEnumerator enumerateItemsForObserver:startingAtPage:]", 294, v34);
  ...
  long long v30 = 0uLL;
  uint64_t v31 = 0;
  sub_100004FB8(0, (uint64_t)"-[BRBaseFileEnumerator enumerateItemsForObserver:startingAtPage:]", 299, &v30);
  uint64_t v13 = brc_bread_crumbs();
  v14 = brc_default_log();
...
- (void)enumerateChangesForObserver:(id)a3 fromSyncAnchor:(id)a4
{
  ...
  sub_100004FB8(0, (uint64_t)"-[BRBaseFileEnumerator enumerateChangesForObserver:fromSyncAnchor:]", 352, v27);
...
- (void)containerListDidChange
{
    ...
    || (id v3 = self->_personaID) == 0)
  {
    if (qword_1000547D0 != -1) {
      dispatch_once(&qword_1000547D0, &stru_1000449F8);
    }
    id v4 = (NSString *)(id)qword_1000547D8;
    int v5 = 1;
  }
  else
  {
...
LABEL_10:
  ...
  sub_100004FB8(0, (uint64_t)"-[BRBaseFileEnumerator containerListDidChange]", 449, v23);
...
- (void)_accountTokenDidChange
{
    ...
    || (id v3 = self->_personaID) == 0)
  {
    if (qword_1000547E0 != -1) {
      dispatch_once(&qword_1000547E0, &stru_100044A18);
    }
    id v4 = (NSString *)(id)qword_1000547E8;
    int v5 = 1;
  }
  else
  {
