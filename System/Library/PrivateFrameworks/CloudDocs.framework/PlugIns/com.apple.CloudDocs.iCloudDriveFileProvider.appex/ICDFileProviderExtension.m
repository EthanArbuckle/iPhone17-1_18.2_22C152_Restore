...
- (id)enumeratorForContainerItemIdentifier:(id)a3 request:(id)a4 error:(id *)a5
{
  ...
  if (!self->_isCiconiaDomain)
  {
    ...
    sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension enumeratorForContainerItemIdentifier:request:error:]", 198, v23);
...
- (id)fetchThumbnailsForItemIdentifiers:(id)a3 requestedSize:(CGSize)a4 perThumbnailCompletionHandler:(id)a5 completionHandler:(id)a6
{
  ...
  id v15 = a5;
  id v11 = v15;
  v12 = -[ICDFileProviderExtension fetchThumbnailsForItemIdentifiers:requestedSize:perThumbnailCompletionHandlerWithType:completionHandler:](self, "fetchThumbnailsForItemIdentifiers:requestedSize:perThumbnailCompletionHandlerWithType:completionHandler:", a3, v14, a6, width, height);
...
- (id)fetchThumbnailsForItemIdentifiers:(id)a3 requestedSize:(CGSize)a4 perThumbnailCompletionHandlerWithType:(id)a5 completionHandler:(id)a6
{
  ...
  v23[1] = 3221225472;
  v23[2] = sub_100016D7C;
  uint64_t v23[3] = &unk_100044E00;
  id v24 = v12;
  id v20 = v12;
  v21 = -[ICDFileProviderExtension fetchThumbnailsForDictionary:requestedSize:perThumbnailCompletionHandlerWithMetadata:completionHandler:](self, "fetchThumbnailsForDictionary:requestedSize:perThumbnailCompletionHandlerWithMetadata:completionHandler:", v14, v23, v13, width, height);
...
- (id)_fetchThumbnailsForItemIdentifiersWithVersionMap:(id)a3 requestedSize:(CGSize)a4 perThumbnailCompletionHandler:(id)a5 completionHandler:(id)a6
{
  ...
  id v20 = sub_10000DF74(v9, v17, v10, v19);
  v23[0] = _NSConcreteStackBlock;
  v23[1] = 3221225472;
  v23[2] = sub_100017D44;
  uint64_t v23[3] = &unk_100044E50;
  id v24 = v11;
  uint64_t v25 = v29;
  id v21 = v11;
...
- (id)_getAsyncProxyWithErrorHandler:(id)a3
{
  domainSetupWaiterQueue = self->_domainSetupWaiterQueue;
  id v5 = a3;
  dispatch_sync(domainSetupWaiterQueue, &stru_100045240);
  id v6 = [(ICDFileProviderExtension *)self _getDatabaseIDFromDomain];
  id v7 = [[ICDFileProviderExtensionBackChannel alloc] initWithExtension:self];
  id v8 = [(NSFileProviderDomain *)self->_domain identifier];
  id v9 = +[BRDaemonConnection defaultConnectionWithDomainIdentifier:v8 databaseID:v6 backChannel:v7];
  id v10 = [v9 remoteObjectProxyWithErrorHandler:v5];
...
- (id)createItemBasedOnTemplate:(id)a3 fields:(unint64_t)a4 contents:(id)a5 options:(unint64_t)a6 request:(id)a7 completionHandler:(id)a8
{
  ...
  if (!self->_isCiconiaDomain)
  {
    ...
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension createItemBasedOnTemplate:fields:contents:options:request:completionHandler:]", 245, v63);
    uint64_t v17 = v14;
    ...
    {
      uint64_t v24 = v63[0];
      uint64_t v25 = [v53 path];
      long long v26 = BRCPrettyPrintBitmap();
    ...
    {
      id v62 = 0;
      long long v27 = +[FPSandboxingURLWrapper wrapperWithURL:v53 readonly:0 error:&v62];
      id v28 = v62;
      if (v28)
      {
        id v29 = v28;
    ...
    if (v33)
    {
      id v29 = +[NSError brc_errorExcludedFromSyncDueToFilename];
      id v34 = brc_bread_crumbs();
      id v35 = brc_default_log();
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        id v36 = objc_msgSend(v29, "br_fileProviderError");
        *(_DWORD *)buf = 136316418;
        *(void *)&uint8_t buf[4] = "-[ICDFileProviderExtension createItemBasedOnTemplate:fields:contents:options:request:completionHandler:]";
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = 0;
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        id v21 = +[NSProgress progressWithTotalUnitCount:0];
        goto LABEL_27;
      }
      ...
      long long v58 = 0uLL;
      uint64_t v59 = 0;
      sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension createItemBasedOnTemplate:fields:contents:options:request:completionHandler:]", 274, &v58);
      ...
      *(_OWORD *)buf = v58;
      *(void *)&buf[16] = v59;
      long long v48 = [(ICDFileProviderExtension *)self populateNonCodableAttributesOfTemplate:v17];
...
LABEL_27:
  ...
  id v20 = +[NSError brc_errorLoggedOut];
...
- (id)deleteItemWithIdentifier:(id)a3 baseVersion:(id)a4 options:(unint64_t)a5 request:(id)a6 completionHandler:(id)a7
{
  ...
  if (self->_isCiconiaDomain)
  {
    ...
    BOOL v19 = +[NSError brc_errorLoggedOut];
    v14[2](v14, v19);
  ...
  else
  {
    ...
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension deleteItemWithIdentifier:baseVersion:options:request:completionHandler:]", 309, v39);
    id v16 = v12;
    ...
    uint64_t v25 = v14;
    id v38 = v25;
    long long v26 = [(ICDFileProviderExtension *)self _getAsyncProxyWithErrorHandler:v37];
    long long v35 = 0uLL;
    uint64_t v36 = 0;
    sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension deleteItemWithIdentifier:baseVersion:options:request:completionHandler:]", 315, &v35);
    ...
    *(void *)&buf[16] = v36;
    ...
    id v20 = +[NSProgress progressWithTotalUnitCount:0];
...
- (id)fetchContentsForItemWithIdentifier:(id)a3 version:(id)a4 request:(id)a5 completionHandler:(id)a6
{
  ...
  if (!self->_isCiconiaDomain)
  {
    ...
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension fetchContentsForItemWithIdentifier:version:request:completionHandler:]", 340, v56);
    ...
    if (v11)
    {
      uint64_t v25 = [BRFieldContentSignature alloc];
      long long v26 = [v11 contentVersion];
      long long v27 = [(BRFieldContentSignature *)v25 initWithData:v26];
    ...
    long long v52 = 0uLL;
    uint64_t v53 = 0;
    sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension fetchContentsForItemWithIdentifier:version:request:completionHandler:]", 362, &v52);
...
LABEL_27:
  ...
  id v16 = +[NSError brc_errorLoggedOut];
...
- (id)fetchContentsForItemWithIdentifier:(id)a3 version:(id)a4 usingExistingContentsAtURL:(id)a5 existingVersion:(id)a6 request:(id)a7 completionHandler:(id)a8
{
  ...
  if (!self->_isCiconiaDomain)
  {
    ...
    uint64_t v25 = [BRFieldContentSignature alloc];
    long long v26 = [v16 contentVersion];
    v65 = [(BRFieldContentSignature *)v25 initWithData:v26];

    memset(v90, 0, sizeof(v90));
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension fetchContentsForItemWithIdentifier:version:usingExistingContentsAtURL:existingVersion:request:completionHandler:]", 419, v90);
    long long v27 = brc_bread_crumbs();
    id v28 = brc_default_log();
       ...
       || !v15 && [(BRFieldContentSignature *)v21 containsLocalEdits]))
    {
      ...
      if (v85[5])
      {
        ...
        {
          long long v47 = [(id)v85[5] asFileProviderItem];
          *(_DWORD *)buf = 136316162;
        ...
        long long v48 = [(id)v85[5] asFileProviderItem];
        v67[2](v67, v66, v48, 0);
      }
      else
      {
...
- (void)_accountDidChange
{
  ...
  {
    if (qword_100054868 != -1) {
      dispatch_once(&qword_100054868, &stru_1000454F8);
    }
    id v4 = (NSString *)(id)qword_100054870;
    int v5 = 1;
  }
  else
  {
...
LABEL_10:
  ...
  [(NSFileProviderManager *)self->_fileProviderManager br_signalWorkingSetEnumeratorWithCompletionHandler:&stru_100045518];
  _BRRestorePersona();
}
...
- (void)waitForStabilizationWithCompletionHandler:(id)a3
{
  ...
  if (self->_isCiconiaDomain)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      domain = self->_domain;
      *(_DWORD *)buf = 138412546;
      long long v26 = (const char *)domain;
      __int16 v27 = 2112;
      char v28 = v5;
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 136315650;
      long long v26 = "-[ICDFileProviderExtension waitForStabilizationWithCompletionHandler:]";
      __int16 v27 = 2112;
      char v28 = v10;
      __int16 v29 = 2112;
      id v30 = v8;
  ...
  else if (+[UMUserManager br_isInSyncBubble])
  {
    ...
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension waitForStabilizationWithCompletionHandler:]", 582, v24);
    id v12 = brc_bread_crumbs();
    id v13 = brc_default_log();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 134218498;
      long long v26 = (const char *)v24[0];
      __int16 v27 = 2080;
...
- (id)itemForIdentifier:(id)a3 request:(id)a4 completionHandler:(id)a5
{
  ...
  else
  {
    ...
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension itemForIdentifier:request:completionHandler:]", 603, v46);
    ...
    if (v21)
    {
      ...
      else
      {
        ...
        long long v43 = 0uLL;
        uint64_t v44 = 0;
        sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension itemForIdentifier:request:completionHandler:]", 622, &v43);
...
- (id)modifyItem:(id)a3 baseVersion:(id)a4 changedFields:(unint64_t)a5 contents:(id)a6 options:(unint64_t)a7 request:(id)a8 completionHandler:(id)a9
{
  ...
  {
    memset(v63, 0, sizeof(v63));
    sub_100004FB8(1, (uint64_t)"-[ICDFileProviderExtension modifyItem:baseVersion:changedFields:contents:options:request:completionHandler:]", 673, v63);
    __int16 v18 = v15;
...
LABEL_25:
    ...
    else
    {
      ...
      long long v58 = 0uLL;
      uint64_t v59 = 0;
      sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension modifyItem:baseVersion:changedFields:contents:options:request:completionHandler:]", 699, &v58);
...
- (id)_defaultApplicationContainerForBundleIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    sub_100004FB8(0, (uint64_t)"-[ICDFileProviderExtension _defaultApplicationContainerForBundleIdentifier:completionHandler:]", 856, v42);
    id v12 = brc_bread_crumbs();
    id v13 = brc_default_log();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
