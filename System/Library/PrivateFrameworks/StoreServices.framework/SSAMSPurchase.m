...
- (unint64_t)hash
{
  ...
  unint64_t v3 = [(AMSPurchase *)&v10 hash];
...
- (BOOL)isEqualToPurchase:(id)a3
{
  ...
  {
    uint64_t v7 = [(SSAMSPurchase *)self accountIdentifier];
    ...
    if ([v7 isEqualToNumber:v8])
    {
      ...
      {
        BOOL v11 = [(SSAMSPurchase *)self isPreauthenticated];
        int v12 = v11 ^ [v4 isPreauthenticated] ^ 1;
      }
      else
      {
        LOBYTE(v12) = 0;
