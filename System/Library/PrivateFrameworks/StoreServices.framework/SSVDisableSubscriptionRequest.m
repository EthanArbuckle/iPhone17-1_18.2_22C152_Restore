@interface SSVDisableSubscriptionRequest
...
LABEL_16:
  ...
  id v20 = v4;
  id v17 = v4;
  [(SSRequest *)self _startWithMessageID:145 messageBlock:v19];
}
...
void __58__SSVDisableSubscriptionRequest_startWithCompletionBlock___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(void *)(a1 + 40))
  {
    ...
    uint64_t v13 = __58__SSVDisableSubscriptionRequest_startWithCompletionBlock___block_invoke_2;
