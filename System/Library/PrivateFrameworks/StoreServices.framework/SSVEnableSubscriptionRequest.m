...
- (SSVEnableSubscriptionRequest)initWithXPCEncoding:(id)a3;
- (id)copyXPCEncoding;
...
void __57__SSVEnableSubscriptionRequest_startWithCompletionBlock___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(void *)(a1 + 40))
  {
    ...
    uint64_t v13 = __57__SSVEnableSubscriptionRequest_startWithCompletionBlock___block_invoke_2;
...
uint64_t __57__SSVEnableSubscriptionRequest_startWithCompletionBlock___block_invoke_2(uint64_t a1)
{
...
- (SSVEnableSubscriptionRequest)initWithXPCEncoding:(id)a3
{
  ...
  {
    v12.receiver = self;
    v12.super_class = (Class)SSVEnableSubscriptionRequest;
    int v6 = [(SSRequest *)&v12 init];
    if (v6)
    {
      v8 = [SSAuthenticationContext alloc];
      id v9 = xpc_dictionary_get_value(v5, "0");
