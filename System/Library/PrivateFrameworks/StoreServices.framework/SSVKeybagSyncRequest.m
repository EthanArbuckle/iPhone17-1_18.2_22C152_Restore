...
- (SSVKeybagSyncRequest)initWithAccountIdentifier:(id)a3;
- (SSVKeybagSyncRequest)initWithXPCEncoding:(id)a3;
- (id)copyXPCEncoding;
...
- (SSVKeybagSyncRequest)initWithAccountIdentifier:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SSVKeybagSyncRequest;
...
void __49__SSVKeybagSyncRequest_startWithCompletionBlock___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(void *)(a1 + 40))
  {
    ...
    uint64_t v13 = __49__SSVKeybagSyncRequest_startWithCompletionBlock___block_invoke_2;
...
uint64_t __49__SSVKeybagSyncRequest_startWithCompletionBlock___block_invoke_2(uint64_t a1)
{
...
- (id)copyXPCEncoding
{
  ...
  SSXPCDictionarySetCFObject(v3, "0", (__CFString *)self->_accountID);
  return v3;
}
...
- (SSVKeybagSyncRequest)initWithXPCEncoding:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)SSVKeybagSyncRequest;
    int v6 = [(SSRequest *)&v10 init];
    if (v6)
    {
      objc_opt_class();
      CFArrayRef v8 = SSXPCDictionaryCopyCFObjectWithClass(v5, "0");
      accountID = v6->_accountID;
      v6->_accountID = (NSNumber *)v8;
    }
  }
  else
  {
