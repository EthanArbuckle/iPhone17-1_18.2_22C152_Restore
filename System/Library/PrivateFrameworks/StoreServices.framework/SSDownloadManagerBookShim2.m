...
- (id)_copyDownloadsForMessage:(int64_t)a3 downloadIDs:(id)a4
{
  ...
  id v5 = [(SSDownloadManager *)&v8 _copyDownloadsForMessage:a3 downloadIDs:a4];
  int v6 = [(SSDownloadManagerBookShim2 *)self __book_getAllDownloads];
  if ([v6 count]) {
...
- (id)__book_getAllDownloads
{
  ...
  id v4 = [(SSDownloadManagerBookShim2 *)self __book_downloadsForStati:v3 overrideFinished:0 overrideFailed:0];
...
- (id)__book_downloadsForStati:(id)a3 overrideFinished:(BOOL)a4 overrideFailed:(BOOL)a5
{
  ...
  id v7 = a3;
  objc_super v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(v7, "count"));
  long long v23 = 0u;
  long long v24 = 0u;
  long long v25 = 0u;
  long long v26 = 0u;
  ...
  if (v10)
  {
    ...
    int v13 = v6 || v5;
    if (v6) {
      uint64_t v14 = SSDownloadPhaseFinished;
    }
    else {
      uint64_t v14 = &SSDownloadPhaseFailed;
    }
    uint64_t v15 = *v14;
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        uint64_t v18 = [SSBookDownload alloc];
        v19 = -[SSBookDownload initWithDownloadStatus:](v18, "initWithDownloadStatus:", v17, (void)v23);
        uint64_t v20 = v19;
        if (v19)
        {
          if (v13) {
...
- (void)downloadQueue:(id)a3 downloadStatesDidChange:(id)a4
{
  ...
  id v5 = a4;
  BOOL v6 = +[SSLogConfig sharedStoreServicesConfig];
  if (!v6)
  {
    BOOL v6 = +[SSLogConfig sharedConfig];
  }
  int v7 = [v6 shouldLog];
  ...
  if (v8)
  {
    ...
    id v9 = objc_msgSend(NSString, "stringWithCString:encoding:", v11, 4, &v38, v34);
    free(v11);
    SSFileLog(v6, @"%@", v12, v13, v14, v15, v16, v17, (uint64_t)v9);
  }

LABEL_12:
  uint64_t v18 = [(SSDownloadManagerBookShim2 *)self __book_downloadsForStati:v5 overrideFinished:0 overrideFailed:0];
...
LABEL_12:
  int v20 = -[SSDownloadManagerBookShim2 __book_downloadsForStati:overrideFinished:overrideFailed:](self, "__book_downloadsForStati:overrideFinished:overrideFailed:", v7, a5 == 0, a5 != 0, v35);
