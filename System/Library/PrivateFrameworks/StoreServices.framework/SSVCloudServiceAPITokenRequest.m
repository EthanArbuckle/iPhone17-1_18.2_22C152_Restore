  ...
  if (*(void *)(a1 + 40))
  {
    ...
    else
    {
      if (v3 && MEMORY[0x1A62689E0](v3) == MEMORY[0x1E4F14590])
      {
        ...
        uint64_t v14 = [SSVCloudServiceAPITokenResponse alloc];
        uint64_t v15 = xpc_dictionary_get_value(v4, "3");
        int v7 = [(SSVCloudServiceAPITokenResponse *)v14 initWithXPCEncoding:v15];
...
uint64_t __57__SSVCloudServiceAPITokenRequest_startWithResponseBlock___block_invoke_2(void *a1)
{
