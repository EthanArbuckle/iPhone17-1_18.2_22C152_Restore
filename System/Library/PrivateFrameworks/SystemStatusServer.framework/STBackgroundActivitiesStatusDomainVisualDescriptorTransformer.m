...
- (STBackgroundActivitiesStatusDomainVisualDescriptorTransformer)init
{
  v3 = [MEMORY[0x1E4FA9348] sharedInstance];
...
- (id)transformedDataForData:(id)a3
{
  ...
  if (isKindOfClass)
  {
    ...
    v10 = [v7 activeBackgroundActivities];
    v11 = [(STBackgroundActivityManager *)backgroundActivityManager validBackgroundActivitiesForBackgroundActivities:v10];
    ...
    if (v13)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v14; ++i)
        {
          ...
          v18 = [v17 backgroundActivityIdentifier];
    ...
    v20 = [v8 activeBackgroundActivities];
    long long v41 = 0u;
    long long v42 = 0u;
    long long v43 = 0u;
    long long v44 = 0u;
    ...
    if (v21)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v22; ++j)
        {
          ...
          v26 = [v7 visualDescriptorForBackgroundActivityWithIdentifier:v25];

          if (!v26)
          {
            v27 = [(STBackgroundActivityManager *)v36->_backgroundActivityManager visualDescriptorForBackgroundActivityWithIdentifier:v25];
            [v8 setVisualDescriptor:v27 forBackgroundActivityWithIdentifier:v25];
          }
        }
    ...
    v28 = [v7 backgroundActivitiesWithVisualDescriptors];
    ...
    if (v31)
    {
      ...
      do
      {
        for (uint64_t k = 0; k != v32; ++k)
        {
          ...
          [v8 setVisualDescriptor:0 forBackgroundActivityWithIdentifier:*(void *)(*((void *)&v37 + 1) + 8 * k)];
        }
