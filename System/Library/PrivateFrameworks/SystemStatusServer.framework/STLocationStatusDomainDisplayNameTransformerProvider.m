@interface STLocationStatusDomainDisplayNameTransformerProvider
- (NSArray)dynamicAttributions;
- (STLocationStatusDomainDisplayNameTransformerProvider)init;
- (id)dataTransformerForClient:(id)a3;
- (void)setDynamicAttributions:(id)a3;
@end

@implementation STLocationStatusDomainDisplayNameTransformerProvider
...
- (id)dataTransformerForClient:(id)a3
{
  ...
  if (!v7)
  {
    ...
    v9 = [(STLocationStatusDomainDisplayNameTransformerProvider *)self dynamicAttributions];
    ...
    v11 = [STLocationStatusDomainDisplayNameTransformer alloc];
    v12 = [(STAttributedEntityResolver *)v8 beginBatchResolutionSession];
    v7 = [(STLocationStatusDomainDisplayNameTransformer *)v11 initWithEntityResolver:v12];
...
{
  v8.receiver = self;
  v8.super_class = (Class)STLocationStatusDomainDisplayNameTransformerProvider;
  v2 = [(STLocationStatusDomainDisplayNameTransformerProvider *)&v8 init];
  if (v2)
  {
...
- (void)setDynamicAttributions:(id)a3
{
  ...
  if (![(NSArray *)self->_dynamicAttributions isEqualToArray:v4])
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __79__STLocationStatusDomainDisplayNameTransformerProvider_setDynamicAttributions___block_invoke;
    v8[3] = &unk_1E6AD29D8;
    id v9 = v4;
...
uint64_t __79__STLocationStatusDomainDisplayNameTransformerProvider_setDynamicAttributions___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
