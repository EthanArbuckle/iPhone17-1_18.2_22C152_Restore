...
- (_TtC9SeymourUI17TrainerFilterCell)initWithFrame:(CGRect)a3
{
  return (_TtC9SeymourUI17TrainerFilterCell *)sub_239FC96F8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)prepareForReuse
{
  ...
  v11.super_class = v6;
  v7 = self;
  [(TrainerFilterCell *)&v11 prepareForReuse];
  uint64_t v8 = type metadata accessor for ShelfCellItemInfo();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v8 - 8) + 56))(v5, 1, 1, v8);
  uint64_t v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI17TrainerFilterCell_itemInfo;
  swift_beginAccess();
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3 withHorizontalFittingPriority:(float)a4 verticalFittingPriority:(float)a5
{
  ...
  uint64_t v9 = self;
  id v10 = [(TrainerFilterCell *)v9 contentView];
  *(float *)&double v11 = a4;
  *(float *)&double v12 = a5;
...
- (void).cxx_destruct
{
  sub_239C1AE10((uint64_t)self + OBJC_IVAR____TtC9SeymourUI17TrainerFilterCell_delegate);
  sub_239C752B4((uint64_t)self + OBJC_IVAR____TtC9SeymourUI17TrainerFilterCell_itemInfo);
  uint64_t v3 = *(Class *)((char *)&self->super.super.super.super.super.isa + OBJC_IVAR____TtC9SeymourUI17TrainerFilterCell_layout);
