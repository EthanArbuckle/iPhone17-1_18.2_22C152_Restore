...
- (_TtC9SeymourUI18DownloadButtonCell)initWithFrame:(CGRect)a3
{
  return (_TtC9SeymourUI18DownloadButtonCell *)sub_23A737040(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)prepareForReuse
{
  ...
  uint64_t v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI18DownloadButtonCell_itemInfo;
  swift_beginAccess();
...
- (void)handleDownloadButtonTapped:(id)a3
{
  ...
  uint64_t v9 = MEMORY[0x23ECB8640]((char *)self + OBJC_IVAR____TtC9SeymourUI18DownloadButtonCell_delegate, v6);
  if (v9)
  {
    uint64_t v10 = v9;
...
- (void).cxx_destruct
{
  sub_239C1AE10((uint64_t)self + OBJC_IVAR____TtC9SeymourUI18DownloadButtonCell_delegate);
  sub_239C752B4((uint64_t)self + OBJC_IVAR____TtC9SeymourUI18DownloadButtonCell_itemInfo);
