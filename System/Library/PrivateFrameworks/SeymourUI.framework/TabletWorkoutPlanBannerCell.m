@interface TabletWorkoutPlanBannerCell
...
- (_TtC9SeymourUI27TabletWorkoutPlanBannerCell)initWithFrame:(CGRect)a3
{
  return (_TtC9SeymourUI27TabletWorkoutPlanBannerCell *)sub_23A2DB99C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)prepareForReuse
{
  ...
  uint64_t v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI27TabletWorkoutPlanBannerCell_itemInfo;
  swift_beginAccess();
...
- (void).cxx_destruct
{
  sub_239C1AE10((uint64_t)self + OBJC_IVAR____TtC9SeymourUI27TabletWorkoutPlanBannerCell_delegate);
  sub_239C25128((uint64_t)self + OBJC_IVAR____TtC9SeymourUI27TabletWorkoutPlanBannerCell_itemInfo, &qword_268A0E7E0);
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC9SeymourUI27TabletWorkoutPlanBannerCell_styleProvider;
