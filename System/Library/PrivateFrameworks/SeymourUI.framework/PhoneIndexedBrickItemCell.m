@interface PhoneIndexedBrickItemCell
...
- (_TtC9SeymourUI25PhoneIndexedBrickItemCell)initWithFrame:(CGRect)a3
{
  return (_TtC9SeymourUI25PhoneIndexedBrickItemCell *)sub_23A012E44(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)prepareForReuse
{
  ...
  v11.super_class = v6;
  v7 = self;
  [(PhoneIndexedBrickItemCell *)&v11 prepareForReuse];
  uint64_t v8 = type metadata accessor for ShelfCellItemInfo();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v8 - 8) + 56))(v5, 1, 1, v8);
  uint64_t v9 = (uint64_t)v7 + OBJC_IVAR____TtC9SeymourUI25PhoneIndexedBrickItemCell_itemInfo;
  swift_beginAccess();
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3 withHorizontalFittingPriority:(float)a4 verticalFittingPriority:(float)a5
{
  ...
  uint64_t v9 = self;
  id v10 = [(PhoneIndexedBrickItemCell *)v9 contentView];
  *(float *)&double v11 = a4;
  *(float *)&double v12 = a5;
...
- (void)handleDownloadButtonTapped
{
  ...
  uint64_t v7 = MEMORY[0x23ECB8640]((char *)self + OBJC_IVAR____TtC9SeymourUI25PhoneIndexedBrickItemCell_delegate, v4);
  if (v7)
  {
    uint64_t v8 = v7;
...
- (void).cxx_destruct
{
  sub_239C1AE10((uint64_t)self + OBJC_IVAR____TtC9SeymourUI25PhoneIndexedBrickItemCell_delegate);
  swift_bridgeObjectRelease();
  sub_239C752B4((uint64_t)self + OBJC_IVAR____TtC9SeymourUI25PhoneIndexedBrickItemCell_itemInfo);
