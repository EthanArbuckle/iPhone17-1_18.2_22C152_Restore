...
@implementation AXIconVisionModelAssetPolicy

- (id)assetType
{
  return @"com.apple.MobileAsset.AXIconVision";
}

- (id)launchActivityIdentifier
{
  return @"com.apple.ax.AXIconVision.LaunchActivity";
}
