...
- (id)description
{
  ...
  v7 = [(MTIDSecret *)self effectiveDate];
  v8 = [(MTIDSecret *)self expirationDate];
  v9 = [v3 stringWithFormat:@"<%@: %p, value: %@, effective: %@, expiration: %@ >", v5, self, v6, v7, v8];
...
- (id)debugInfo
{
  ...
  double v9 = objc_msgSend(NSNumber, "numberWithBool:", -[MTIDSecret isSynchronized](self, "isSynchronized"));
