...
- (MTIDScheme)initWithNamespace:(id)a3 options:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      uint64_t v11 = [@"daily" compare:v10 options:1];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    unint64_t v6 = [(MTIDScheme *)self hash];
    if (v6 == [v5 hash])
    {
      id v7 = [(MTIDScheme *)self idNamespace];
      v8 = [v5 idNamespace];
      if ([v7 isEqual:v8]
        && (int64_t v9 = -[MTIDScheme lifespan](self, "lifespan"), v9 == [v5 lifespan])
        && (int64_t v10 = -[MTIDScheme idType](self, "idType"), v10 == [v5 idType]))
      {
        ...
        if ([v14 isEqual:v17])
        {
          uint64_t v18 = [(MTIDScheme *)self version];
          v31 = (void *)v18;
          if (v18) {
            v19 = (__CFString *)v18;
          }
          ...
          {
            uint64_t v23 = [(MTIDScheme *)self containerIdentifier];
            if (v23) {
              v24 = (__CFString *)v23;
            }
            else {
            ...
            uint64_t v25 = objc_msgSend(v5, "containerIdentifier", v23, v31);
            v26 = (void *)v25;
            if (v25) {
              v27 = (__CFString *)v25;
            }
            ...
            char v28 = [(__CFString *)v24 isEqual:v27];
          }
          else
          {
            char v28 = 0;
...
- (unint64_t)calculateHash
{
  ...
  int64_t v6 = v5 ^ [(MTIDScheme *)self rotationSchedule] ^ v4;
  id v7 = [(MTIDScheme *)self version];
  uint64_t v8 = [v7 hash];

  int64_t v9 = v6 ^ v8 ^ [(MTIDScheme *)self idType];
  int64_t v10 = [(MTIDScheme *)self containerIdentifier];
...
- (NSString)containerIdentifier
{
  ...
  {
    uint64_t v4 = +[MTFrameworkEnvironment sharedEnvironment];
...
- (void)overrideLifespanMaybe
{
  ...
  if (v4)
  {
    ...
    int64_t v5 = NSString;
    int64_t v6 = [(MTIDScheme *)self idNamespace];
    id v7 = [v5 stringWithFormat:@"MTIDServiceLifespanOverride~%@", v6];

    uint64_t v8 = [v9 integerForKey:v7];
    if (!v8) {
      uint64_t v8 = [v9 integerForKey:@"MTIDServiceLifespanOverride"];
    }
    if (v8 >= 1)
    {
...
- (unint64_t)storagePoolSize
{
  ...
  unint64_t v3 = 0x2A3000uLL / [(MTIDScheme *)self lifespan];
  if (v3 <= 3) {
    unint64_t v3 = 3;
  }
  if (v3 >= 0x20) {
...
{
  id v9 = a3;
  double v4 = [(MTIDScheme *)self idNamespace];
  ...
  double v5 = [(MTIDScheme *)self correlations];
  [v9 encodeObject:v5 forKey:@"correlations"];

  id v6 = [(MTIDScheme *)self version];
  [v9 encodeObject:v6 forKey:@"version"];

  id v7 = [(MTIDScheme *)self containerIdentifier];
  [v9 encodeObject:v7 forKey:@"container"];

  uint64_t v8 = [(MTIDScheme *)self topics];
...
- (id)description
{
  ...
  id v6 = [(MTIDScheme *)self idNamespace];
  int64_t v7 = [(MTIDScheme *)self lifespan];
  uint64_t v8 = [(MTIDScheme *)self correlations];
  id v9 = [v3 stringWithFormat:@"<%@: %p, namespace: %@, lifespan: %lld correlations: %@ >", v5, self, v6, v7, v8];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v6 = objc_msgSend(NSNumber, "numberWithLongLong:", -[MTIDScheme lifespan](self, "lifespan"));
    [v3 setObject:v6 forKeyedSubscript:@"lifespan"];
  }
  int64_t v7 = [(MTIDScheme *)self correlations];
  uint64_t v8 = [v7 count];

  if (v8)
  {
    id v9 = [(MTIDScheme *)self correlations];
    [v3 setObject:v9 forKeyedSubscript:@"correlations"];
  }
  objc_super v10 = [(MTIDScheme *)self version];
  ...
  if (v13)
  {
    uint64_t v14 = [(MTIDScheme *)self topics];
    [v3 setObject:v14 forKeyedSubscript:@"topics"];
  }
  if ([(MTIDScheme *)self isDefault])
  {
    uint64_t v15 = objc_msgSend(NSNumber, "numberWithBool:", -[MTIDScheme isDefault](self, "isDefault"));
...
- (MTIDScheme)initWithCoder:(id)a3
{
  ...
  double v5 = [(MTIDScheme *)&v12 init];
  if (v5)
  {
    id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"namespace"];
    ...
    int64_t v7 = [v4 decodeArrayOfObjectsOfClass:objc_opt_class() forKey:@"correlations"];
    ...
    objc_super v10 = [v4 decodeArrayOfObjectsOfClass:objc_opt_class() forKey:@"topics"];
