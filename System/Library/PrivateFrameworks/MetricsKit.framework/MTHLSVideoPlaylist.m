...
- (MTHLSVideoPlaylist)initWithMainFeatureMetricsData:(id)a3
{
  return [(MTHLSVideoPlaylist *)self initWithStartPosition:0 mainFeatureMetricsData:a3];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(MTHLSVideoPlaylist *)self addRollInfoItem:*(void *)(*((void *)&v9 + 1) + 8 * v8++)];
      }
      while (v6 != v8);
...
{
  id v8 = a5;
  long long v9 = [[MTHLSRollItem alloc] initWithStartOverallPosition:(unint64_t)(a3 * 1000.0) duration:(unint64_t)(a4 * 1000.0) metricsData:v8];
...
{
  id v8 = a5;
  long long v9 = [[MTHLSRollItem alloc] initWithStartOverallPosition:a3 duration:a4 metricsData:v8];
...
{
  char v4 = a4;
  int64_t v7 = -[MTHLSVideoPlaylist indexOfLastRollItemWithStartBeforePosition:](self, "indexOfLastRollItemWithStartBeforePosition:");
  if (v7 == 0x7FFFFFFFFFFFFFFFLL)
  {
    id v8 = [(MTHLSVideoPlaylist *)self mainFeatureItemWithStartOverallPosition:0];
  }
  else
  {
    int64_t v9 = v7;
    if ((v4 & 1) == 0)
    {
      do
      {
        long long v10 = [(MTHLSVideoPlaylist *)self rollItems];
    ...
    {
      -[MTHLSVideoPlaylist mainFeatureItemWithStartOverallPosition:](self, "mainFeatureItemWithStartOverallPosition:", [v16 endOverallPosition]);
...
- (id)itemsBetweenStartOverallPosition:(unint64_t)a3 endOverallPosition:(unint64_t)a4
{
  ...
  id v8 = [(MTHLSVideoPlaylist *)self rollItems];
  uint64_t v9 = [v8 count];

  if (v9)
  {
    unint64_t v10 = [(MTHLSVideoPlaylist *)self indexOfLastRollItemWithStartBeforePosition:a3];
    if (v10 == 0x7FFFFFFFFFFFFFFFLL)
    {
      long long v11 = [(MTHLSVideoPlaylist *)self mainFeatureItemWithStartOverallPosition:0];
      [v7 addObject:v11];
    ...
    while (1)
    {
      ...
      uint64_t v12 = [(MTHLSVideoPlaylist *)self rollItems];
      ...
      {
        uint64_t v14 = [(MTHLSVideoPlaylist *)self rollItems];
        unint64_t v15 = [v14 count];

        if (v10 >= v15)
        {
          id v17 = -[MTHLSVideoPlaylist mainFeatureItemWithStartOverallPosition:](self, "mainFeatureItemWithStartOverallPosition:", [v13 endOverallPosition]);
          [v7 addObject:v17];
        }
        else
        {
  ...
  {
    int64_t v13 = [(MTHLSVideoPlaylist *)self mainFeatureItemWithStartOverallPosition:0];
    [v7 addObject:v13];
LABEL_17:
  }
...
- (void)addRollItem:(id)a3
{
  ...
  double v6 = +[MTHLSItem comparator];
...
- (id)mainFeatureItemWithStartOverallPosition:(unint64_t)a3
{
  uint64_t v5 = [MTHLSItem alloc];
  double v6 = [(MTHLSVideoPlaylist *)self mainFeatureMetricsData];
  uint64_t v7 = [(MTHLSItem *)v5 initWithStartOverallPosition:a3 metricsData:v6];

  unint64_t v8 = [(MTHLSVideoPlaylist *)self startPosition];
  unint64_t v9 = [(MTHLSVideoPlaylist *)self indexOfLastRollItemWithStartBeforePosition:a3];
  if (v9 <= 0x7FFFFFFFFFFFFFFELL)
  {
    unint64_t v10 = v9;
    long long v11 = [(MTHLSVideoPlaylist *)self rollItems];
...
- (int64_t)indexOfLastRollItemWithStartBeforePosition:(unint64_t)a3
{
  uint64_t v5 = [(MTHLSVideoPlaylist *)self rollItems];
  double v6 = [v5 firstObject];

  if (v6 && [v6 startOverallPosition] <= a3)
  {
    unint64_t v8 = [(MTHLSVideoPlaylist *)self rollItems];
