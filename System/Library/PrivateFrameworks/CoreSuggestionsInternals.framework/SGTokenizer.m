...
{
  id v3 = a3;
  uint64_t ITSListForFTSQuery = _createITSListForFTSQuery(v3);
  if (ITSListForFTSQuery)
  {
    v5 = (const void *)ITSListForFTSQuery;
    CFCharacterSetRef v6 = CFCharacterSetCreateWithCharactersInString(0, @"()\"");
    uint64_t Count = ITSTokenListGetCount();
    v8 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:Count];
    if (Count >= 1)
    {
      for (uint64_t i = 0; i != Count; ++i)
      {
        v10 = (void *)MEMORY[0x1CB79B230]();
        uint64_t v11 = ITSTokenListCopyEscapedTokenAtIndex();
        if (v11)
        {
          v12 = (void *)v11;
...
+ (id)ftsPrefix:(id)a3
{
  uint64_t ITSListForFTSQuery = _createITSListForFTSQuery(a3);
  if (ITSListForFTSQuery)
  {
    CFCharacterSetRef v6 = (const void *)ITSListForFTSQuery;
    uint64_t Count = ITSTokenListGetCount();
    v8 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:Count];
    if (Count >= 1)
    {
      for (uint64_t i = 0; i != Count; ++i)
      {
        v10 = (void *)ITSTokenListCopyEscapedTokenAtIndex();
        if (!v10)
        {
          id v15 = [MEMORY[0x1E4F28B00] currentHandler];
          objc_msgSend(v15, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, @"SGTokenizer.m", 141, @"ITSTokenListCopyEscapedTokenAtIndex failed to get token at index %ld", i);
        }
        [v8 addObject:v10];
      }
    }
  ...
  v12 = objc_msgSend(v8, "_pas_componentsJoinedByString:", @" ");
...
uint64_t __24__SGTokenizer_tokenize___block_invoke(uint64_t a1, uint64_t a2)
{
...
+ (void)enumerateTokensInString:(id)a3 withRange:(_NSRange)a4 block:(id)a5
{
  ...
  else
  {
    ...
    [v17 handleFailureInMethod:a2, a1, @"SGTokenizer.m", 33, @"Invalid parameter not satisfying: %@", @"str" object file lineNumber description];
  ...
  [v18 handleFailureInMethod:a2, a1, @"SGTokenizer.m", 34, @"Invalid parameter not satisfying: %@", @"block" object file lineNumber description];
...
void __55__SGTokenizer_enumerateTokensInString_withRange_block___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  while (CFStringTokenizerAdvanceToNextToken(v3))
  {
    ...
    id v6 = *(void **)(a1 + 32);
    long long v7 = [MEMORY[0x1E4F28B88] whitespaceAndNewlineCharacterSet];
...
id __55__SGTokenizer_enumerateTokensInString_withRange_block___block_invoke_2(uint64_t a1)
{
  ...
  if (!v5)
  {
    ...
    [v13 handleFailureInMethod:*(void *)(a1 + 32), *(void *)(a1 + 40), @"SGTokenizer.m", 52, @"Invalid parameter not satisfying: %@", @"locale" object file lineNumber description];
  }
LABEL_8:
  ...
  if (!v6)
  {
    ...
    [v12 handleFailureInMethod:*(void *)(a1 + 32), *(void *)(a1 + 40), @"SGTokenizer.m", 58, @"Invalid parameter not satisfying: %@", @"guardedTokenizer" object file lineNumber description];
  }
  id v7 = objc_alloc(MEMORY[0x1E4F93B80]);
  uint64_t v8 = dispatch_queue_attr_make_with_autorelease_frequency(0, DISPATCH_AUTORELEASE_FREQUENCY_WORK_ITEM);
  dispatch_queue_t v9 = dispatch_queue_create("SGTokenizer", v8);
