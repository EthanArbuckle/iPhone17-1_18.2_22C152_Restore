...
+ (id)fromSchema:()schema
{
  ...
  if (!v4)
  {
    ...
    if (!v10)
    {
      ...
      id v11 = [v3 objectForKeyedSubscript:@"airplaneSeatClass"];
      v12 = [v11 objectForKeyedSubscript:@"name"];
      v15 = (void *)[objc_alloc(MEMORY[0x1E4F306C8]) initWithSeatSection:0 seatRow:0 seatNumber:v8 seatingType:v12];
      goto LABEL_7;
    }
    v9 = [v3 objectForKeyedSubscript:@"seat"];
    v8 = v9;
LABEL_6:
    id v11 = [v9 objectForKeyedSubscript:@"seatNumber"];
    ...
    v15 = (void *)[objc_alloc(MEMORY[0x1E4F306C8]) initWithSeatSection:v13 seatRow:v12 seatNumber:v11 seatingType:v14];
