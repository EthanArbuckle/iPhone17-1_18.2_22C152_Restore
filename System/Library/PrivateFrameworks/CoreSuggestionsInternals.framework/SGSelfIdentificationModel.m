...
@implementation SGSelfIdentificationModel
...
+ (id)newTransformerInstanceForLanguage:(id)a3
{
  ...
  v21 = +[SGTransformerInstance defaultSessionDescriptorForModelId:featureVersion:language:windowAndNgrams:](SGTransformerInstance, "defaultSessionDescriptorForModelId:featureVersion:language:windowAndNgrams:", @"SelfIdentification", @"1.5", v3);
  v4 = (void *)MEMORY[0x1E4F5DFC0];
  v20 = +[SGEntityMatchingTransformer withTargetMapping:@"SG_TARGET_NAME" phoneMapping:@"SG_FEATURE_PHONENUMBER" emailMapping:@"SG_FEATURE_EMAIL" addressMapping:@"SG_FEATURE_ADDRESS" andDateMapping:@"SG_FEATURE_DATE"];
  v22[0] = v20;
