...
- (id)description
{
  ...
  id v4 = [(SGM2SearchResultsIncludedPureSuggestion *)&v8 description];
  id v5 = [(SGM2SearchResultsIncludedPureSuggestion *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"SearchResultsIncludedPureSuggestion";
  }
}
