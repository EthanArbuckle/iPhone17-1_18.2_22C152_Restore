...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v5 = v4;
    -[SGM2SuggestedContactDetailShown setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[6])
  {
...
- (BOOL)readFrom:(id)a3
{
  return SGM2SuggestedContactDetailShownReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SGM2SuggestedContactDetailShown;
  id v4 = [(SGM2SuggestedContactDetailShown *)&v8 description];
  id v5 = [(SGM2SuggestedContactDetailShown *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"SuggestedContactDetailShown";
  }
}
