...
@implementation SGBoatEventSchemaCreator
...
- (id)processDURawEvent:(id)a3
{
  ...
  v77[1] = @"http://schema.org/BoatReservation";
  v76[2] = @"reservationId";
  ...
  v73[0] = @"http://schema.org/BoatTrip";
  v72[0] = @"@type";
  v72[1] = @"departureBoatTerminal";
  v71[0] = @"http://schema.org/BoatTerminal";
  uint64_t v18 = v8;
  v70[0] = @"@type";
  v70[1] = @"name";
  if (!v8)
  ...
  v73[2] = v20;
  v72[3] = @"arrivalBoatTerminal";
  v69[0] = @"http://schema.org/BoatTerminal";
  v68[0] = @"@type";
  v68[1] = @"name";
