...
- (void)setApp:(int)a3;
- (void)setDidInteractionLookup:(BOOL)a3;
...
- (BOOL)didInteractionLookup
{
  return self->_didInteractionLookup;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[SGM2UnknownContactInformationShown setKey:](self, "setKey:");
    id v4 = v6;
  }
...
LABEL_5:
  ...
  *(unsigned char *)&self->_has |= 2u;
  ...
  {
LABEL_6:
    self->_didInteractionLookup = *((unsigned char *)v4 + 25);
...
LABEL_3:
  uint64_t v5 = 2654435761 * self->_wasSuggestedContact;
  if ((*(unsigned char *)&self->_has & 4) == 0) {
    goto LABEL_7;
  }
LABEL_4:
  uint64_t v6 = 2654435761 * self->_didInteractionLookup;
  return v4 ^ v3 ^ v5 ^ v6;
}
...
LABEL_3:
  ...
  {
LABEL_4:
    *(unsigned char *)(v5 + 25) = self->_didInteractionLookup;
...
LABEL_5:
  ...
  *((unsigned char *)v4 + 28) |= 2u;
  ...
  {
LABEL_6:
    *((unsigned char *)v4 + 25) = self->_didInteractionLookup;
...
- (BOOL)readFrom:(id)a3
{
  return SGM2UnknownContactInformationShownReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v9 = [NSNumber numberWithBool:self->_wasSuggestedContact];
  ...
  if ((has & 4) != 0)
  {
    v10 = [NSNumber numberWithBool:self->_didInteractionLookup];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SGM2UnknownContactInformationShown;
  id v4 = [(SGM2UnknownContactInformationShown *)&v8 description];
  uint64_t v5 = [(SGM2UnknownContactInformationShown *)self dictionaryRepresentation];
