...
{
  if (*((void *)a3 + 1)) {
    -[SGM2ContactsInterfaceCacheCount setKey:](self, "setKey:");
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return SGM2ContactsInterfaceCacheCountReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SGM2ContactsInterfaceCacheCount;
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"ContactsInterfaceCacheCount";
  }
}
