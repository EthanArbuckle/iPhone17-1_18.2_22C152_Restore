...
- (id)description
{
  ...
  id v4 = [(SGM2SearchResultsUserSelectedContact *)&v8 description];
  uint64_t v5 = [(SGM2SearchResultsUserSelectedContact *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"SearchResultsUserSelectedContact";
  }
}
