...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v5 = v4;
    -[SGM2ContactsInterfaceCacheHit setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[20])
  {
...
- (BOOL)readFrom:(id)a3
{
  return SGM2ContactsInterfaceCacheHitReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SGM2ContactsInterfaceCacheHit;
  id v4 = [(SGM2ContactsInterfaceCacheHit *)&v8 description];
  id v5 = [(SGM2ContactsInterfaceCacheHit *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"ContactsInterfaceCacheHit";
  }
}
