...
- (void)_addObservers
{
  ...
  [v3 addObserver:self selector:sel_applicationWillEnterForeground name:*MEMORY[0x263F1D0D0] object:0];
  [v3 addObserver:self selector:sel_applicationDidEnterBackground name:*MEMORY[0x263F1D050] object:0];
}

- (WDTableViewController)initWithStyle:(int64_t)a3
{
  v6.receiver = self;
  v6.super_class = (Class)WDTableViewController;
  id v3 = [(WDTableViewController *)&v6 initWithStyle:a3];
  v4 = v3;
  if (v3) {
...
{
  v7.receiver = self;
  v7.super_class = (Class)WDTableViewController;
...
- (WDTableViewController)initWithCoder:(id)a3
{
  v6.receiver = self;
  v6.super_class = (Class)WDTableViewController;
  id v3 = [(WDTableViewController *)&v6 initWithCoder:a3];
  v4 = v3;
  if (v3) {
    [(WDTableViewController *)v3 _addObservers];
  }
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)WDTableViewController;
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)WDTableViewController;
  -[WDTableViewController viewWillAppear:](&v14, sel_viewWillAppear_);
  long long v12 = 0u;
  long long v13 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
...
- (void)viewDidLoad
{
  ...
  v18.receiver = self;
  v18.super_class = (Class)WDTableViewController;
  [(HKTableViewController *)&v18 viewDidLoad];
  uint64_t v3 = [(WDTableViewController *)self tableView];
  ...
  uint64_t v12 = [MEMORY[0x263EFF8C0] arrayWithArray:v4];
...
- (void)reloadTable
{
  id v2 = [(WDTableViewController *)self tableView];
  [v2 reloadData];
}

- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  uint64_t v4 = [(WDTableViewController *)self _section:a4];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  uint64_t v8 = [(WDTableViewController *)self _sectionAtIndexPath:v6];
  uint64_t v9 = [v6 row];
...
{
  id v6 = a3;
  id v7 = [(WDTableViewController *)self _section:a4];
  uint64_t v8 = [v7 viewForFooter:v6];
...
{
  id v5 = a4;
  id v6 = [(WDTableViewController *)self _sectionAtIndexPath:v5];
  uint64_t v7 = [v5 row];
...
{
  id v5 = a4;
  id v7 = [(WDTableViewController *)self _sectionAtIndexPath:v5];
  uint64_t v6 = [v5 row];
...
{
  id v5 = a4;
  uint64_t v6 = [(WDTableViewController *)self _sectionAtIndexPath:v5];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  double v8 = [(WDTableViewController *)self _sectionAtIndexPath:v6];
  uint64_t v9 = [v6 row];
...
{
  id v4 = a3;
  id v5 = [(WDTableViewController *)self tableView];
...
{
  BOOL v4 = a4;
  uint64_t v7 = [MEMORY[0x263F1CB60] areAnimationsEnabled];
  if (v7 == v4)
  {
    id v13 = [(WDTableViewController *)self tableView];
    uint64_t v12 = [MEMORY[0x263F088D0] indexSetWithIndex:a3];
  ...
  else
  {
    ...
    uint64_t v9 = [(WDTableViewController *)self tableView];
    uint64_t v10 = [MEMORY[0x263F088D0] indexSetWithIndex:a3];
    [v9 reloadSections:v10 withRowAnimation:5];

    id v11 = (void *)MEMORY[0x263F1CB60];
...
- (void)pushViewController:(id)a3 animated:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  id v7 = [(WDTableViewController *)self navigationController];
