...
{
  id v2 = WDBundle();
  id v3 = [v2 localizedStringForKey:@"ELECTROCARDIOGRAM_UPGRADE_TITLE" value:&stru_26D2EA890 table:@"WellnessDashboard-Localizable-Cinnamon"];
...
{
  id v2 = WDBundle();
  id v3 = [v2 localizedStringForKey:@"ELECTROCARDIOGRAM_UPGRADE_BODY" value:&stru_26D2EA890 table:@"WellnessDashboard-Localizable-Cinnamon"];
  v4 = HKConditionallyRedactedHeartRhythmString();
...
{
  id v2 = WDBundle();
  id v3 = [v2 localizedStringForKey:@"ELECTROCARDIOGRAM_UPGRADE_BUTTON_TITLE" value:&stru_26D2EA890 table:@"WellnessDashboard-Localizable-Cinnamon"];
  v4 = HKConditionallyRedactedHeartRhythmString();
