...
- (MSVRandomDistribution)initWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(MSVRandomDistribution *)self initWithRandomSource:v5 lowestValue:v6 highestValue:v7];
  return v8;
}
...
- (MSVRandomDistribution)init
{
  ...
  id v4 = [(MSVRandomDistribution *)self initWithRandomSource:v3 lowestValue:0 highestValue:0];
