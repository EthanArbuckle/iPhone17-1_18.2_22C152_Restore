...
- (id)cancellationHandler
{
  ...
  v3 = (void *)MEMORY[0x1A62426F0](v7[5]);
...
{
  *(void *)(*(void *)(*(void *)(a1 + 40) + 8) + 40) = MEMORY[0x1A62426F0](*(void *)(*(void *)(a1 + 32)
                                                                                              + 280));
  return MEMORY[0x1F41817F8]();
}
...
- (void)cancel
{
  ...
  uint64_t v3 = [(MSVAsyncBlockOperation *)self cancellationHandler];
...
- (MSVAsyncBlockOperation)initWithStartHandler:(id)a3
{
  ...
  objc_super v5 = [(MSVAsyncOperation *)&v11 init];
  if (v5)
  {
    dispatch_queue_t v6 = dispatch_queue_create("com.apple.mediaservices.MSVAsyncBlockOperation.accessQueue", MEMORY[0x1E4F14430]);
