...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 48) = v10;
  ...
  id v12 = [(ASUSQLitePredicate *)self->_predicate copyWithZone:a3];
  v13 = *(void **)(v5 + 56);
  *(void *)(v5 + 56) = v12;
...
- (id)_newSelectSQLWithProperties:(id)a3 columns:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = (void *)[objc_alloc(MEMORY[0x263F089D8]) initWithString:@"SELECT "];
  v9 = v8;
  ...
  uint64_t v13 = [(ASUSQLitePredicate *)self->_predicate SQLJoinClausesForEntityClass:self->_entityClass];
  if (v13) {
    [v12 unionSet:v13];
  }
  v36 = (void *)v13;
  ...
  else
  {
    ...
    if (v27 >= 1)
    {
      id v29 = objc_alloc_init(MEMORY[0x263F089D8]);
      unint64_t v30 = 0;
      do
      {
