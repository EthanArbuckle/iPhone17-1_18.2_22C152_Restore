...
- (ASUSQLiteStatement)initWithStatement:(sqlite3_stmt *)a3 onConnection:(id)a4
{
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)ASUSQLiteStatement;
...
- (NSDictionary)columnIndexByName
{
  ...
  if (statement)
  {
    ...
    v5 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:v4];
    if (v4 >= 1)
    {
      uint64_t v6 = 0;
      do
      {
        id v7 = (void *)[objc_alloc(NSNumber) initWithInt:v6];
  ...
  {
    [MEMORY[0x263EFF940] raise:*MEMORY[0x263EFF498] format:@"Statement already finalized"];
    v5 = 0;
  }
...
{
  uint64_t v4 = *(void *)&a4;
  id v6 = [MEMORY[0x263F08900] dataWithJSONObject:a3 options:0 error:0];
...
- (void)bindDate:(id)a3 atPosition:(int)a4
{
  ...
  -[ASUSQLiteStatement bindDouble:atPosition:](self, "bindDouble:atPosition:", v4);
}
...
- (void)bindDouble:(double)a3 atPosition:(int)a4
{
  ...
  if (statement) {
    ...
    objc_msgSend(MEMORY[0x263EFF940], "raise:format:", *MEMORY[0x263EFF498], @"Statement already finalized", a3);
  }
}
...
- (void)bindUUID:(id)a3 atPosition:(int)a4
{
  uint64_t v4 = *(void *)&a4;
  id v6 = [a3 UUIDString];
  [(ASUSQLiteStatement *)self bindString:v6 atPosition:v4];
}
