    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          ASUSQLiteBindFoundationValue(v6, *a4, *(void **)(*((void *)&v13 + 1) + 8 * i));
          ++*a4;
        }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v7 = [(ASUSQLiteContainsPredicate *)self isNegative];
    if (v7 == [v6 isNegative])
    {
      uint64_t v9 = [(ASUSQLiteContainsPredicate *)self values];
      uint64_t v10 = [v6 values];
      if (v9 == v10
        || ([(ASUSQLiteContainsPredicate *)self values],
            v3 = objc_claimAutoreleasedReturnValue(),
            [v6 values],
            v4 = objc_claimAutoreleasedReturnValue(),
            [v3 isEqual:v4]))
      {
        uint64_t v11 = [(ASUSQLiteContainsPredicate *)self query];
        ...
        else
        {
          ...
          long long v14 = [(ASUSQLiteContainsPredicate *)self query];
...
- (id)SQLForEntityClass:(Class)a3
{
  ...
  id v5 = [(ASUSQLitePropertyPredicate *)self property];
  id v6 = [(objc_class *)a3 disambiguatedSQLForProperty:v5];

  int v7 = [MEMORY[0x263F089D8] stringWithString:v6];
  char v8 = v7;
  if (self->_negative) {
  ...
  if (query)
  {
    ...
    id v12 = [(ASUSQLiteQuery *)query copySelectSQLWithProperties:v11];
