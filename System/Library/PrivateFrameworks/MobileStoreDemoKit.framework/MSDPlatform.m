...
+ (BOOL)iOSHub
{
  if (iOSHub_onceToken != -1) {
    dispatch_once(&iOSHub_onceToken, &__block_literal_global_2);
  }
  return iOSHub_isHub;
}
...
{
  Class result = NSClassFromString(&cfstr_Msdhubbundlema.isa);
...
LABEL_13:
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v12 = 2114;
    v13 = v7;
    _os_log_impl(&dword_21EF08000, v6, OS_LOG_TYPE_DEFAULT, "%s: PlatformType '%{public}@'.", buf, 0x16u);
  }
  return v2;
}
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        v10 = objc_msgSend(v9, "lowercaseString", (void)v13);
...
- (void)raiseInvalidProductListExceptionWithReason:(id)a3
{
  ...
  v3 = [MEMORY[0x263EFF940] exceptionWithName:@"InvalidManifestProductList" reason:a3 userInfo:0];
  id v4 = defaultLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v5 = 136315394;
    uint64_t v6 = "-[MSDPlatform raiseInvalidProductListExceptionWithReason:]";
    __int16 v7 = 2114;
    v8 = v3;
    _os_log_impl(&dword_21EF08000, v4, OS_LOG_TYPE_DEFAULT, "%s - Exception:  %{public}@", (uint8_t *)&v5, 0x16u);
  }
