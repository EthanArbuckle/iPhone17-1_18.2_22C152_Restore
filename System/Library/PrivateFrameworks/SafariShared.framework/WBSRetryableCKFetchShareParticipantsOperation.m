...
- (void)setFetchShareParticipantsCompletionBlock:(id)a3;
- (void)setPerShareParticipantCompletionBlock:(id)a3;
...
- (NSArray)userIdentityLookupInfos
{
  ...
  v4 = (void *)[(NSArray *)self->_userIdentityLookupInfos copy];
...
- (void)setUserIdentityLookupInfos:(id)a3
{
  ...
  self->_userIdentityLookupInfos = v6;
...
- (id)perShareParticipantCompletionBlock
{
  p_internalLock = &self->super._internalLock;
  os_unfair_lock_lock(&self->super._internalLock);
  v4 = (void *)[self->_perShareParticipantCompletionBlock copy];
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setPerShareParticipantCompletionBlock:(id)a3
{
  ...
  id perShareParticipantCompletionBlock = self->_perShareParticipantCompletionBlock;
  self->_id perShareParticipantCompletionBlock = v6;
...
- (id)fetchShareParticipantsCompletionBlock
{
  p_internalLock = &self->super._internalLock;
  os_unfair_lock_lock(&self->super._internalLock);
  v4 = (void *)[self->_fetchShareParticipantsCompletionBlock copy];
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setFetchShareParticipantsCompletionBlock:(id)a3
{
  ...
  self->_id fetchShareParticipantsCompletionBlock = v6;
...
- (id)_makeOperation
{
  id v2 = objc_alloc_init(MEMORY[0x1E4F1A0E0]);
  return v2;
}
...
- (void)_setUpOperation:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)WBSRetryableCKFetchShareParticipantsOperation;
  [(WBSRetryableCKOperation *)&v10 _setUpOperation:v4];
  if (-[NSMutableSet containsObject:](self->super._explicitlySetProperties, "containsObject:", @"userIdentityLookupInfos"))[v4 setUserIdentityLookupInfos:self->_userIdentityLookupInfos]; {
  ...
  }
  {
    ...
    [v4 setPerShareParticipantCompletionBlock:v7];
    objc_destroyWeak(&v8);
  ...
  [v4 setFetchShareParticipantsCompletionBlock:v5];
  objc_destroyWeak(&v6);
  objc_destroyWeak(&location);
}
