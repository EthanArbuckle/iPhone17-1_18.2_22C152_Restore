...
void __WBS_LOG_CHANNEL_PREFIXOfflineSearchSuggestions_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "OfflineSearchSuggestions");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXOfflineSearchSuggestions_log;
  WBS_LOG_CHANNEL_PREFIXOfflineSearchSuggestions_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXHistory_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "History");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "CloudTabs");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "CloudBookmarks");
...
void __WBS_LOG_CHANNEL_PREFIXAutoBugCapture_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "AutoBugCapture");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXAutoBugCapture_log;
  WBS_LOG_CHANNEL_PREFIXAutoBugCapture_log = (uint64_t)v0;
}
...
void __WBS_LOG_CHANNEL_PREFIXAutoPlay_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "AutoPlay");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXAutoPlay_log;
  WBS_LOG_CHANNEL_PREFIXAutoPlay_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXBanners_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Banners");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXBanners_log;
  WBS_LOG_CHANNEL_PREFIXBanners_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXCertificates_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Certificates");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXCertificates_log;
  WBS_LOG_CHANNEL_PREFIXCertificates_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXCloudHistory_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "CloudHistory");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "ContentBlockers");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "CrowdsourcedAutoFill");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Cycler");
...
void __WBS_LOG_CHANNEL_PREFIXMemory_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Memory");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXMemory_log;
  WBS_LOG_CHANNEL_PREFIXMemory_log = (uint64_t)v0;
}
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Parsec");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "PerSitePreferences");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXPerSitePreferences_log;
  WBS_LOG_CHANNEL_PREFIXPerSitePreferences_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXProfiles_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Profiles");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXProfiles_log;
  WBS_LOG_CHANNEL_PREFIXProfiles_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXReader_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Reader");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXReader_log;
  WBS_LOG_CHANNEL_PREFIXReader_log = (uint64_t)v0;
}
...
void __WBS_LOG_CHANNEL_PREFIXTabDialogs_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "TabDialogs");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXTabDialogs_log;
  WBS_LOG_CHANNEL_PREFIXTabDialogs_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXTest_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Test");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "UserMediaCapture");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXUserMediaCapture_log;
  WBS_LOG_CHANNEL_PREFIXUserMediaCapture_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXWebDriver_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "WebDriver");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXWebDriver_log;
  WBS_LOG_CHANNEL_PREFIXWebDriver_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXDigitalHealth_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "DigitalHealth");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXDigitalHealth_log;
  WBS_LOG_CHANNEL_PREFIXDigitalHealth_log = (uint64_t)v0;
}
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "CloudSettings");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "Widgets");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXWidgets_log;
  WBS_LOG_CHANNEL_PREFIXWidgets_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXBiomeDonation_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "BiomeDonation");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXBiomeDonation_log;
  WBS_LOG_CHANNEL_PREFIXBiomeDonation_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXBrowsingAssistant_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "BrowsingAssistant");
...
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "SiriSuggestedSites");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXSiriSuggestedSites_log;
  WBS_LOG_CHANNEL_PREFIXSiriSuggestedSites_log = (uint64_t)v0;
}

void __WBS_LOG_CHANNEL_PREFIXUserDefinedContentBlocker_block_invoke()
{
  os_log_t v0 = os_log_create("com.apple.SafariShared", "UserDefinedContentBlocker");
  v1 = (void *)WBS_LOG_CHANNEL_PREFIXUserDefinedContentBlocker_log;
  WBS_LOG_CHANNEL_PREFIXUserDefinedContentBlocker_log = (uint64_t)v0;
}
