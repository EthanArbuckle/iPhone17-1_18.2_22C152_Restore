...
- (id)perRecordZoneCompletionBlock
{
  p_internalLock = &self->super.super._internalLock;
  os_unfair_lock_lock(&self->super.super._internalLock);
  v4 = (void *)[self->_perRecordZoneCompletionBlock copy];
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setPerRecordZoneCompletionBlock:(id)a3
{
  ...
  id perRecordZoneCompletionBlock = self->_perRecordZoneCompletionBlock;
  self->_id perRecordZoneCompletionBlock = v6;
...
- (id)fetchRecordZonesCompletionBlock
{
  p_internalLock = &self->super.super._internalLock;
  os_unfair_lock_lock(&self->super.super._internalLock);
  v4 = (void *)[self->_fetchRecordZonesCompletionBlock copy];
  os_unfair_lock_unlock(p_internalLock);
  return v4;
}
...
- (void)setFetchRecordZonesCompletionBlock:(id)a3
{
  ...
  self->_id fetchRecordZonesCompletionBlock = v6;
...
- (id)_makeOperation
{
  id v2 = objc_alloc_init(MEMORY[0x1E4F1A088]);
  return v2;
}
...
- (void)_setUpOperation:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)WBSRetryableCKFetchRecordZonesOperation;
