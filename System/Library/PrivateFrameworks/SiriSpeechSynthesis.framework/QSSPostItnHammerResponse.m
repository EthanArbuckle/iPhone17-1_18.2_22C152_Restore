...
- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3;
- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4;
...
- (Offset<siri::speech::schema_fb::PostItnHammerResponse>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = [(QSSPostItnHammerResponse *)self speech_id];
  uint64_t v5 = v4;
  if (!v4) {
    v4 = &stru_26DEBFAF8;
  }
  ...
  long long v8 = [(QSSPostItnHammerResponse *)self session_id];
  long long v9 = v8;
  if (!v8) {
  ...
  __int16 v12 = [(QSSPostItnHammerResponse *)self language];
  uint64_t v13 = v12;
  if (!v12) {
  ...
  int v47 = [(QSSPostItnHammerResponse *)self return_code];
  v16 = [(QSSPostItnHammerResponse *)self return_str];
  v17 = v16;
  if (!v16) {
    v16 = &stru_26DEBFAF8;
  }
  ...
  v21 = [(QSSPostItnHammerResponse *)self tokens];
  ...
  long long v52 = 0u;
  long long v53 = 0u;
  v22 = [(QSSPostItnHammerResponse *)self tokens];
  v23 = a3;
  ...
  if (v32 == begin) {
    v39 = (int *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::RecognitionToken>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::RecognitionToken>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::RecognitionToken>> const&)::t;
  }
  else {
    v39 = begin;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 0xFu)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            __int16 v12 = [[QSSRecognitionToken alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v45.receiver = self;
  v45.super_class = (Class)QSSPostItnHammerResponse;
  uint64_t v10 = [(QSSPostItnHammerResponse *)&v45 init];
  uint64_t v11 = v10;
  if (!v10) {
    goto LABEL_53;
  }
  ...
  if (!a4)
  {
    ...
    a4 = (const PostItnHammerResponse *)v13 + *v13;
  }
  v11->_root = a4;
  if (!v5) {
    goto LABEL_52;
...
LABEL_51:
  if (!flatbuffers::Verifier::VerifyVectorOfTables<siri::speech::schema_fb::RecognitionToken>((flatbuffers::Verifier *)&v40, v33))goto LABEL_54; {
LABEL_52:
  }
...
- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4
{
  return [(QSSPostItnHammerResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSPostItnHammerResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSPostItnHammerResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSPostItnHammerResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
