...
- (QSSAudioPacket)initWithFlatbuffData:(id)a3;
- (QSSAudioPacket)initWithFlatbuffData:(id)a3 root:(const AudioPacket *)a4;
...
- (QSSAudioPacket)initWithFlatbuffData:(id)a3 root:(const AudioPacket *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSAudioPacket;
  id v10 = [(QSSAudioPacket *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSAudioPacket)initWithFlatbuffData:(id)a3 root:(const AudioPacket *)a4
{
  return [(QSSAudioPacket *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSAudioPacket *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSAudioPacket)initWithFlatbuffData:(id)a3
{
  return [(QSSAudioPacket *)self initWithFlatbuffData:a3 root:0 verify:0];
}
