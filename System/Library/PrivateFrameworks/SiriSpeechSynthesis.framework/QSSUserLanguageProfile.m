...
- (Offset<siri::speech::schema_fb::UserLanguageProfile>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSUserLanguageProfile *)self profile_blob_version];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSUserLanguageProfile *)self profile_checksum];
  uint64_t v11 = v10;
  if (!v10) {
...
- (QSSUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4 verify:(BOOL)a5
{
  ...
  id v10 = [(QSSUserLanguageProfile *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4
{
  return [(QSSUserLanguageProfile *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSUserLanguageProfile *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSUserLanguageProfile)initWithFlatbuffData:(id)a3
{
  return [(QSSUserLanguageProfile *)self initWithFlatbuffData:a3 root:0 verify:0];
}
