@interface QSSQSSVersionInfo
- (NSString)qss_version_brane;
- (NSString)qss_version_server;
- (NSString)qss_version_serverkit;
- (NSString)qss_version_siritts;
- (Offset<siri::speech::schema_fb::QSSVersionInfo>)addObjectToBuffer:(void *)a3;
- (QSSQSSVersionInfo)initWithFlatbuffData:(id)a3;
- (QSSQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4;
- (QSSQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSQSSVersionInfo
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSQSSVersionInfo *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__33__QSSQSSVersionInfo_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::QSSVersionInfo>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSQSSVersionInfo *)self qss_version_server];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSQSSVersionInfo *)self qss_version_brane];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  v15 = [(QSSQSSVersionInfo *)self qss_version_serverkit];
  v16 = v15;
  if (!v15) {
    v15 = &stru_26DEBFAF8;
  }
  ...
  v20 = [(QSSQSSVersionInfo *)self qss_version_siritts];
  v21 = v20;
  if (!v20) {
    v20 = &stru_26DEBFAF8;
  }
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::QSSVersionInfo>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v24);
}
...
- (QSSQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSQSSVersionInfo;
  uint64_t v10 = [(QSSQSSVersionInfo *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const QSSVersionInfo *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::QSSVersionInfo *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::QSSVersionInfo::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          size_t v23 = 0;
          goto LABEL_17;
...
- (QSSQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4
{
  return [(QSSQSSVersionInfo *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSQSSVersionInfo *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSQSSVersionInfo)initWithFlatbuffData:(id)a3
{
  return [(QSSQSSVersionInfo *)self initWithFlatbuffData:a3 root:0 verify:0];
}
