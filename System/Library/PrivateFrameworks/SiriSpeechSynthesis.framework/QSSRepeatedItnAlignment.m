@interface QSSRepeatedItnAlignment
- (NSArray)itn_alignment;
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)a3;
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3;
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4;
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSRepeatedItnAlignment
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSRepeatedItnAlignment *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__39__QSSRepeatedItnAlignment_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSRepeatedItnAlignment *)self itn_alignment];
  ...
  long long v30 = 0u;
  long long v31 = 0u;
  char v6 = [(QSSRepeatedItnAlignment *)self itn_alignment];
  ...
  if (v15 == begin) {
    v22 = (int *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::ItnAlignment>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::ItnAlignment>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::ItnAlignment>> const&)::t;
  }
  else {
    v22 = begin;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            int v12 = [[QSSItnAlignment alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSRepeatedItnAlignment;
  uint64_t v10 = [(QSSRepeatedItnAlignment *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const RepeatedItnAlignment *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::RepeatedItnAlignment *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::RepeatedItnAlignment::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          unsigned int v23 = 0;
          goto LABEL_17;
...
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4
{
  return [(QSSRepeatedItnAlignment *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSRepeatedItnAlignment *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3
{
  return [(QSSRepeatedItnAlignment *)self initWithFlatbuffData:a3 root:0 verify:0];
}
