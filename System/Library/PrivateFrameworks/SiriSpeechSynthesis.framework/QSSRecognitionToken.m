...
- (Offset<siri::speech::schema_fb::RecognitionToken>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSRecognitionToken *)self token_text];
  char v6 = v5;
  if (!v5) {
  ...
  int v10 = [(QSSRecognitionToken *)self start_milli_seconds];
  int v11 = [(QSSRecognitionToken *)self end_milli_seconds];
  int v12 = [(QSSRecognitionToken *)self silence_start_milli_seconds];
  int v13 = [(QSSRecognitionToken *)self confidence];
  int v25 = [(QSSRecognitionToken *)self add_space_after];
...
- (QSSRecognitionToken)initWithFlatbuffData:(id)a3 root:(const RecognitionToken *)a4 verify:(BOOL)a5
{
  ...
  int v10 = [(QSSRecognitionToken *)&v30 init];
  int v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSRecognitionToken)initWithFlatbuffData:(id)a3 root:(const RecognitionToken *)a4
{
  return [(QSSRecognitionToken *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSRecognitionToken *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSRecognitionToken)initWithFlatbuffData:(id)a3
{
  return [(QSSRecognitionToken *)self initWithFlatbuffData:a3 root:0 verify:0];
}
