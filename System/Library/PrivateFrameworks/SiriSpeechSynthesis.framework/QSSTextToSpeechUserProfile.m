@interface QSSTextToSpeechUserProfile
- (NSArray)resources;
- (Offset<siri::speech::schema_fb::TextToSpeechUserProfile>)addObjectToBuffer:(void *)a3;
- (QSSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3;
- (QSSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4;
- (QSSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSTextToSpeechUserProfile
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSTextToSpeechUserProfile *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__42__QSSTextToSpeechUserProfile_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::TextToSpeechUserProfile>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSTextToSpeechUserProfile *)self resources];
  ...
  long long v38 = 0u;
  long long v39 = 0u;
  uint64_t v10 = [(QSSTextToSpeechUserProfile *)self resources];
  ...
  uint64_t v24 = v13 - v7;
  if (v13 == v7) {
    v25 = (char *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechVoiceResource>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechVoiceResource>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechVoiceResource>> const&)::t;
  }
  else {
    v25 = v7;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            uint64_t v12 = [[QSSTextToSpeechVoiceResource alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSTextToSpeechUserProfile;
  uint64_t v10 = [(QSSTextToSpeechUserProfile *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const TextToSpeechUserProfile *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::TextToSpeechUserProfile *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::TextToSpeechUserProfile::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          int v23 = 0;
          goto LABEL_17;
...
- (QSSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4
{
  return [(QSSTextToSpeechUserProfile *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechUserProfile *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTextToSpeechUserProfile)initWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechUserProfile *)self initWithFlatbuffData:a3 root:0 verify:0];
}
