...
- (id)getResoruceAssetByVoice:(id)a3
{
  ...
  id v5 = [[SFSSResourceAsset alloc] init:v4 contentVersion:0];
...
- (id)getVoiceAssetByVoice:(id)a3
{
  ...
  id v5 = [[SFSSVoiceAsset alloc] init:v4 gender:2 name:@"nora" type:3 footprint:2 contentVersion:0];
...
+ (id)sharedInstance
{
  ...
  v2 = (void *)sharedInstance___sharedInstance_1568;
  return v2;
}
