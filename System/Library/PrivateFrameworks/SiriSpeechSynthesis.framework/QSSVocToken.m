...
- (QSSVocToken)initWithFlatbuffData:(id)a3;
- (QSSVocToken)initWithFlatbuffData:(id)a3 root:(const VocToken *)a4;
...
- (Offset<siri::speech::schema_fb::VocToken>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSVocToken *)self orthography];
  char v6 = v5;
  if (!v5) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  flatbuffers::FlatBufferBuilder::AddOffset<flatbuffers::Vector<unsigned char>>((flatbuffers::FlatBufferBuilder *)a3, 6, *((_DWORD *)v16 + 12));
  v12.var0 = flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v9 - v10 + v11);
...
- (QSSVocToken)initWithFlatbuffData:(id)a3 root:(const VocToken *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSVocToken;
  id v10 = [(QSSVocToken *)&v30 init];
  int v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::VocToken *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::VocToken::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          v23 = 0;
          goto LABEL_17;
...
- (QSSVocToken)initWithFlatbuffData:(id)a3 root:(const VocToken *)a4
{
  return [(QSSVocToken *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSVocToken *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSVocToken)initWithFlatbuffData:(id)a3
{
  return [(QSSVocToken *)self initWithFlatbuffData:a3 root:0 verify:0];
}
