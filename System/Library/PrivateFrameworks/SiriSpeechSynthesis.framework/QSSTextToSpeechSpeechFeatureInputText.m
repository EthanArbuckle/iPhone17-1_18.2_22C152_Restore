...
- (QSSTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)a3;
- (QSSTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputText *)a4;
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputText>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSTextToSpeechSpeechFeatureInputText *)self words];
  ...
  long long v38 = 0u;
  long long v39 = 0u;
  uint64_t v10 = [(QSSTextToSpeechSpeechFeatureInputText *)self words];
  ...
  uint64_t v24 = v13 - v7;
  if (v13 == v7) {
    v25 = (char *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>> const&)::t;
  }
  else {
    v25 = v7;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            uint64_t v12 = [[QSSTextToSpeechSpeechFeatureInputWord alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputText *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSTextToSpeechSpeechFeatureInputText;
  uint64_t v10 = [(QSSTextToSpeechSpeechFeatureInputText *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const TextToSpeechSpeechFeatureInputText *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::TextToSpeechSpeechFeatureInputText *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::TextToSpeechSpeechFeatureInputText::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          int v23 = 0;
          goto LABEL_17;
...
- (QSSTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputText *)a4
{
  return [(QSSTextToSpeechSpeechFeatureInputText *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechSpeechFeatureInputText *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechSpeechFeatureInputText *)self initWithFlatbuffData:a3 root:0 verify:0];
}
