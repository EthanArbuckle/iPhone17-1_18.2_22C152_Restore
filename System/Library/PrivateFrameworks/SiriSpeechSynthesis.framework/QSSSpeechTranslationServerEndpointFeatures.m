...
- (QSSSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)a3;
- (QSSSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationServerEndpointFeatures *)a4;
- (QSSSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationServerEndpointFeatures *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
...
- (Offset<siri::speech::schema_fb::SpeechTranslationServerEndpointFeatures>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSSpeechTranslationServerEndpointFeatures *)self conversation_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSSpeechTranslationServerEndpointFeatures *)self request_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  v15 = [(QSSSpeechTranslationServerEndpointFeatures *)self source_locale];
  v16 = v15;
  if (!v15) {
    v15 = &stru_26DEBFAF8;
  }
  ...
  v19 = [(QSSSpeechTranslationServerEndpointFeatures *)self server_endpoint_features];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::SpeechTranslationServerEndpointFeatures>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, (int)v23 - (int)v21 + (int)v22);
}
...
- (QSSSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationServerEndpointFeatures *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSSpeechTranslationServerEndpointFeatures;
  uint64_t v10 = [(QSSSpeechTranslationServerEndpointFeatures *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const SpeechTranslationServerEndpointFeatures *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::SpeechTranslationServerEndpointFeatures *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::SpeechTranslationServerEndpointFeatures::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          uint64_t v23 = 0;
          goto LABEL_17;
...
- (QSSSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationServerEndpointFeatures *)a4
{
  return [(QSSSpeechTranslationServerEndpointFeatures *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSSpeechTranslationServerEndpointFeatures *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSSpeechTranslationServerEndpointFeatures)initWithFlatbuffData:(id)a3
{
  return [(QSSSpeechTranslationServerEndpointFeatures *)self initWithFlatbuffData:a3 root:0 verify:0];
}
