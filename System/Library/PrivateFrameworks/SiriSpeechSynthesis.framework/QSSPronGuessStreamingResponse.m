...
- (Offset<siri::speech::qss_fb::PronGuessStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSPronGuessStreamingResponse *)self content_type];
  if ([(QSSPronGuessStreamingResponse *)self content_type] == 1)
  {
    char v6 = [(QSSPronGuessStreamingResponse *)self contentAsQSSPronGuessResponse];
...
- (QSSPronGuessStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSPronGuessStreamingResponse *)&v33 init];
  uint64_t v11 = v10;
  if (!v10) {
    goto LABEL_30;
  }
...
- (QSSPronGuessStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingResponse *)a4
{
  return [(QSSPronGuessStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSPronGuessStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSPronGuessStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSPronGuessStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
