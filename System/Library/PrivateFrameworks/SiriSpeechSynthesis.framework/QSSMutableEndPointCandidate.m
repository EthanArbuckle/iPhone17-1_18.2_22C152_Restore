@interface QSSMutableEndPointCandidate
- (NSString)return_str;
- (NSString)session_id;
- (NSString)speech_id;
- (QSSMutableEndPointCandidate)init;
...
@implementation QSSMutableEndPointCandidate
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableEndPointCandidate;
  v2 = [(QSSMutableEndPointCandidate *)&v6 init];
  if (v2)
  {
