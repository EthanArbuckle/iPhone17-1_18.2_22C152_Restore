@interface QSSMutableCorrectionsAlignment
- (NSString)corrected_words;
- (NSString)original_words;
- (QSSMutableCorrectionsAlignment)init;
- (id)copyWithZone:(_NSZone *)a3;
- (void)setCorrected_words:(id)a3;
- (void)setOriginal_words:(id)a3;
@end

@implementation QSSMutableCorrectionsAlignment
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableCorrectionsAlignment;
  v2 = [(QSSMutableCorrectionsAlignment *)&v6 init];
  if (v2)
  {
