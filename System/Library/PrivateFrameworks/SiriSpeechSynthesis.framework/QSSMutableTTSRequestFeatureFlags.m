@interface QSSMutableTTSRequestFeatureFlags
- (BOOL)cache_only;
...
@implementation QSSMutableTTSRequestFeatureFlags
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableTTSRequestFeatureFlags;
  v2 = [(QSSMutableTTSRequestFeatureFlags *)&v6 init];
  if (v2)
  {
