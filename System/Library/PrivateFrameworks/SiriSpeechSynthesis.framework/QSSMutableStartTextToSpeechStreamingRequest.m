@interface QSSMutableStartTextToSpeechStreamingRequest
...
- (NSString)text;
- (NSString)voice_name;
- (QSSMutableStartTextToSpeechStreamingRequest)init;
...
@implementation QSSMutableStartTextToSpeechStreamingRequest
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableStartTextToSpeechStreamingRequest;
  v2 = [(QSSMutableStartTextToSpeechStreamingRequest *)&v6 init];
  if (v2)
  {
