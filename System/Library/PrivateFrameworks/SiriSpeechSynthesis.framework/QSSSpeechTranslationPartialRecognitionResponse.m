...
- (QSSSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3;
- (QSSSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationPartialRecognitionResponse *)a4;
- (QSSSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationPartialRecognitionResponse *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
...
- (Offset<siri::speech::schema_fb::SpeechTranslationPartialRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSSpeechTranslationPartialRecognitionResponse *)self conversation_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSSpeechTranslationPartialRecognitionResponse *)self request_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  int v15 = [(QSSSpeechTranslationPartialRecognitionResponse *)self return_code];
  v16 = [(QSSSpeechTranslationPartialRecognitionResponse *)self return_str];
  v17 = v16;
  if (!v16) {
    v16 = &stru_26DEBFAF8;
  }
  ...
  v21 = [(QSSSpeechTranslationPartialRecognitionResponse *)self source_locale];
  v22 = v21;
  if (!v21) {
    v21 = &stru_26DEBFAF8;
  }
  ...
  v26 = [(QSSSpeechTranslationPartialRecognitionResponse *)self recognition_text];
  v27 = v26;
  if (!v26) {
    v26 = &stru_26DEBFAF8;
  }
  ...
  LODWORD(v28) = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v28, v29);

  int v30 = [(QSSSpeechTranslationPartialRecognitionResponse *)self confidence];
  int v31 = [(QSSSpeechTranslationPartialRecognitionResponse *)self is_stable_result];
  flatbuffers::FlatBufferBuilder::NotNested((uint64_t)a3);
  *((unsigned char *)a3 + 70) = 1;
  int v32 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  ...
  flatbuffers::FlatBufferBuilder::AddOffset<flatbuffers::Vector<unsigned char>>((flatbuffers::FlatBufferBuilder *)a3, 14, v28);
  flatbuffers::FlatBufferBuilder::AddElement<unsigned int>((unint64_t)a3, 16, v30);
  flatbuffers::FlatBufferBuilder::AddElement<unsigned char>((flatbuffers::vector_downward *)a3, 18, v31);
  return (Offset<siri::speech::schema_fb::SpeechTranslationPartialRecognitionResponse>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v32);
}
...
- (QSSSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationPartialRecognitionResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSSpeechTranslationPartialRecognitionResponse;
  uint64_t v10 = [(QSSSpeechTranslationPartialRecognitionResponse *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const SpeechTranslationPartialRecognitionResponse *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::SpeechTranslationPartialRecognitionResponse *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::SpeechTranslationPartialRecognitionResponse::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          v23 = 0;
          goto LABEL_17;
...
- (QSSSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationPartialRecognitionResponse *)a4
{
  return [(QSSSpeechTranslationPartialRecognitionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSSpeechTranslationPartialRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSSpeechTranslationPartialRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
