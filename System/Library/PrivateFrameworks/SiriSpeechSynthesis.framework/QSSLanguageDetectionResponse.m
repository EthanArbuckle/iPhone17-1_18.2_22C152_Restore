...
- (Offset<siri::speech::schema_fb::LanguageDetectionResponse>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = [(QSSLanguageDetectionResponse *)self speech_id];
  uint64_t v5 = v4;
  if (!v4) {
    v4 = &stru_26DEBFAF8;
  }
  ...
  long long v8 = [(QSSLanguageDetectionResponse *)self session_id];
  long long v9 = v8;
  if (!v8) {
  ...
  int v48 = [(QSSLanguageDetectionResponse *)self return_code];
  __int16 v12 = [(QSSLanguageDetectionResponse *)self return_string];
  uint64_t v13 = v12;
  if (!v12) {
  ...
  unsigned int v47 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v14, v15);

  v16 = [(QSSLanguageDetectionResponse *)self detected_locale];
  v17 = v16;
  if (!v16) {
    v16 = &stru_26DEBFAF8;
  }
  ...
  v21 = [(QSSLanguageDetectionResponse *)self predictions];
  ...
  long long v52 = 0u;
  long long v53 = 0u;
  v22 = [(QSSLanguageDetectionResponse *)self predictions];
  v23 = a3;
    ...
    if (*(unsigned __int16 *)v5->var0 >= 0xFu)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            __int16 v12 = [[QSSLanguageDetectionPrediction alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSLanguageDetectionResponse)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionResponse *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSLanguageDetectionResponse *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSLanguageDetectionResponse)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionResponse *)a4
{
  return [(QSSLanguageDetectionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSLanguageDetectionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSLanguageDetectionResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSLanguageDetectionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
