...
- (QSSLmScorerToken)initWithFlatbuffData:(id)a3;
- (QSSLmScorerToken)initWithFlatbuffData:(id)a3 root:(const LmScorerToken *)a4;
...
- (Offset<siri::speech::schema_fb::LmScorerToken>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSLmScorerToken *)self token_str];
  char v6 = v5;
  if (!v5) {
  ...
  double v10 = v9;
  int v11 = [(QSSLmScorerToken *)self ngram_used];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::LmScorerToken>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v12);
}
...
- (QSSLmScorerToken)initWithFlatbuffData:(id)a3 root:(const LmScorerToken *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSLmScorerToken;
  double v10 = [(QSSLmScorerToken *)&v30 init];
  int v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const LmScorerToken *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::LmScorerToken *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::LmScorerToken::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          v23 = 0;
          goto LABEL_17;
...
- (QSSLmScorerToken)initWithFlatbuffData:(id)a3 root:(const LmScorerToken *)a4
{
  return [(QSSLmScorerToken *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSLmScorerToken *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSLmScorerToken)initWithFlatbuffData:(id)a3
{
  return [(QSSLmScorerToken *)self initWithFlatbuffData:a3 root:0 verify:0];
}
