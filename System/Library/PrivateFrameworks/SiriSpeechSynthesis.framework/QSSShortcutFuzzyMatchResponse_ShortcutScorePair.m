...
- (QSSShortcutFuzzyMatchResponse_ShortcutScorePair)initWithFlatbuffData:(id)a3;
- (QSSShortcutFuzzyMatchResponse_ShortcutScorePair)initWithFlatbuffData:(id)a3 root:(const ShortcutScorePair *)a4;
...
@implementation QSSShortcutFuzzyMatchResponse_ShortcutScorePair
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSShortcutFuzzyMatchResponse_ShortcutScorePair *)self addObjectToBuffer:&v5];
...
- (Offset<siri::speech::schema_fb::ShortcutFuzzyMatchResponse_::ShortcutScorePair>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSShortcutFuzzyMatchResponse_ShortcutScorePair *)self shortcut];
  char v6 = v5;
  if (!v5) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::ShortcutFuzzyMatchResponse_::ShortcutScorePair>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v11);
}
...
- (QSSShortcutFuzzyMatchResponse_ShortcutScorePair)initWithFlatbuffData:(id)a3 root:(const ShortcutScorePair *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSShortcutFuzzyMatchResponse_ShortcutScorePair;
  double v10 = [(QSSShortcutFuzzyMatchResponse_ShortcutScorePair *)&v30 init];
  int v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const ShortcutScorePair *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
...
- (QSSShortcutFuzzyMatchResponse_ShortcutScorePair)initWithFlatbuffData:(id)a3 root:(const ShortcutScorePair *)a4
{
  return [(QSSShortcutFuzzyMatchResponse_ShortcutScorePair *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSShortcutFuzzyMatchResponse_ShortcutScorePair *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSShortcutFuzzyMatchResponse_ShortcutScorePair)initWithFlatbuffData:(id)a3
{
  return [(QSSShortcutFuzzyMatchResponse_ShortcutScorePair *)self initWithFlatbuffData:a3 root:0 verify:0];
}
