...
- (QSSBatchTranslationLoggingRequest)initWithFlatbuffData:(id)a3;
- (QSSBatchTranslationLoggingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationLoggingRequest *)a4;
...
- (Offset<siri::speech::schema_fb::BatchTranslationLoggingRequest>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSBatchTranslationLoggingRequest *)self session_id];
  char v6 = v5;
  if (!v5) {
  ...
  int v9 = [(QSSBatchTranslationLoggingRequest *)self time_to_first_response];
  int v10 = [(QSSBatchTranslationLoggingRequest *)self time_to_viewport_complete];
  int v11 = [(QSSBatchTranslationLoggingRequest *)self time_to_page_complete];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::BatchTranslationLoggingRequest>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v12);
}
...
- (QSSBatchTranslationLoggingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationLoggingRequest *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSBatchTranslationLoggingRequest;
  int v10 = [(QSSBatchTranslationLoggingRequest *)&v30 init];
  int v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const BatchTranslationLoggingRequest *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::BatchTranslationLoggingRequest *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::BatchTranslationLoggingRequest::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          v23 = 0;
          goto LABEL_17;
...
- (QSSBatchTranslationLoggingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationLoggingRequest *)a4
{
  return [(QSSBatchTranslationLoggingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSBatchTranslationLoggingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSBatchTranslationLoggingRequest)initWithFlatbuffData:(id)a3
{
  return [(QSSBatchTranslationLoggingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}
