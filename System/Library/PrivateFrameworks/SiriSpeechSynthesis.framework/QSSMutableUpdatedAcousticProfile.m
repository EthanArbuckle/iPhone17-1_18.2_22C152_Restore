@interface QSSMutableUpdatedAcousticProfile
- (NSString)return_str;
- (NSString)session_id;
- (NSString)speech_id;
- (QSSMutableUpdatedAcousticProfile)init;
...
@implementation QSSMutableUpdatedAcousticProfile
...
- (QSSUserAcousticProfile)updated_acoustic_profile
{
  return (QSSUserAcousticProfile *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"updated_acoustic_profile"];
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableUpdatedAcousticProfile;
  v2 = [(QSSMutableUpdatedAcousticProfile *)&v6 init];
  if (v2)
  {
