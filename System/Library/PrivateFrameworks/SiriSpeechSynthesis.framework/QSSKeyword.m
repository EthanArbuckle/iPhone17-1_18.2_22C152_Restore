...
- (QSSKeyword)initWithFlatbuffData:(id)a3;
- (QSSKeyword)initWithFlatbuffData:(id)a3 root:(const Keyword *)a4;
- (QSSKeyword)initWithFlatbuffData:(id)a3 root:(const Keyword *)a4 verify:(BOOL)a5;
- (double)posterior;
- (id)flatbuffData;
...
- (Offset<siri::speech::schema_fb::Keyword>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSKeyword *)self keyword_orthography];
  char v6 = v5;
  if (!v5) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::Keyword>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v11);
}
...
- (QSSKeyword)initWithFlatbuffData:(id)a3 root:(const Keyword *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSKeyword;
  double v10 = [(QSSKeyword *)&v30 init];
  int v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSKeyword)initWithFlatbuffData:(id)a3 root:(const Keyword *)a4
{
  return [(QSSKeyword *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSKeyword *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSKeyword)initWithFlatbuffData:(id)a3
{
  return [(QSSKeyword *)self initWithFlatbuffData:a3 root:0 verify:0];
}
