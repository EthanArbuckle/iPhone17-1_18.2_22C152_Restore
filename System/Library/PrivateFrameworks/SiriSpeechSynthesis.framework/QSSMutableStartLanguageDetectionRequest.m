@interface QSSMutableStartLanguageDetectionRequest
- (NSArray)locales;
- (NSString)session_id;
- (NSString)speech_id;
- (QSSMutableStartLanguageDetectionRequest)init;
...
@implementation QSSMutableStartLanguageDetectionRequest
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableStartLanguageDetectionRequest;
  v2 = [(QSSMutableStartLanguageDetectionRequest *)&v6 init];
  if (v2)
  {
