...
- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3;
- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4;
...
- (Offset<siri::speech::qss_fb::PronGuessStreamingRequest>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSPronGuessStreamingRequest *)self content_type];
  if ([(QSSPronGuessStreamingRequest *)self content_type] == 1)
  {
    char v6 = [(QSSPronGuessStreamingRequest *)self contentAsQSSStartPronGuessRequest];
  ...
  {
    long long v8 = [(QSSPronGuessStreamingRequest *)self contentAsQSSAudioPacket];
  ...
  {
    uint64_t v10 = [(QSSPronGuessStreamingRequest *)self contentAsQSSFinishAudio];
  ...
  {
    __int16 v12 = [(QSSPronGuessStreamingRequest *)self contentAsQSSCancelRequest];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::PronGuessStreamingRequest>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, (int)v17 - (int)v16 + (int)v15);
}
...
- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v33.receiver = self;
  v33.super_class = (Class)QSSPronGuessStreamingRequest;
  uint64_t v10 = [(QSSPronGuessStreamingRequest *)&v33 init];
    ...
    if (v21[2])
    {
      switch(*((unsigned char *)root + v21[2]))
      {
        case 0:
          goto LABEL_37;
        case 1:
          if (v23 && !siri::speech::schema_fb::StartPronGuessRequest::Verify(v23, (flatbuffers::Verifier *)&v28)) {
            goto LABEL_39;
          }
          goto LABEL_37;
        case 2:
        ...
        case 3:
          ...
          goto LABEL_39;
        case 4:
          if (v23 && !siri::speech::schema_fb::CancelRequest::Verify(v23, (flatbuffers::Verifier *)&v28)) {
            goto LABEL_39;
          }
          goto LABEL_37;
        default:
...
- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingRequest *)a4
{
  return [(QSSPronGuessStreamingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSPronGuessStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSPronGuessStreamingRequest)initWithFlatbuffData:(id)a3
{
  return [(QSSPronGuessStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}
