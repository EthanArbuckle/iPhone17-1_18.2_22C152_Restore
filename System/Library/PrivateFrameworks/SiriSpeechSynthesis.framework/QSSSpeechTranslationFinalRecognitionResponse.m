...
- (QSSSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3;
- (QSSSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationFinalRecognitionResponse *)a4;
...
- (Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSSpeechTranslationFinalRecognitionResponse *)self conversation_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSSpeechTranslationFinalRecognitionResponse *)self request_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  int v15 = [(QSSSpeechTranslationFinalRecognitionResponse *)self return_code];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  flatbuffers::FlatBufferBuilder::AddOffset<flatbuffers::Vector<unsigned char>>((flatbuffers::FlatBufferBuilder *)a3, 16, v31);
  return (Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v32);
}
...
- (QSSSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationFinalRecognitionResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSSpeechTranslationFinalRecognitionResponse;
  uint64_t v10 = [(QSSSpeechTranslationFinalRecognitionResponse *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const SpeechTranslationFinalRecognitionResponse *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          v23 = 0;
          goto LABEL_17;
...
- (QSSSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationFinalRecognitionResponse *)a4
{
  return [(QSSSpeechTranslationFinalRecognitionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSSpeechTranslationFinalRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSSpeechTranslationFinalRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
