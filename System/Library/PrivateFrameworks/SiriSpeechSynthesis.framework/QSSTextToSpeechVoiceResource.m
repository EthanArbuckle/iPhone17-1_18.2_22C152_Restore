...
{
  v4 = self;
  int v5 = [(QSSTextToSpeechVoiceResource *)self type];
  uint64_t v10 = 0;
  uint64_t v11 = &v10;
  ...
  v9[4] = &v10;
  v9[5] = a3;
  [(QSSTextToSpeechVoiceResource *)v4 data:v9];
...
- (QSSTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoiceResource *)a4 verify:(BOOL)a5
{
  ...
  id v10 = [(QSSTextToSpeechVoiceResource *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoiceResource *)a4
{
  return [(QSSTextToSpeechVoiceResource *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechVoiceResource *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechVoiceResource *)self initWithFlatbuffData:a3 root:0 verify:0];
}
