@interface QSSMutableFinalTextToSpeechStreamingResponse
- (NSString)error_str;
- (NSString)session_id;
- (NSString)speech_id;
- (NSString)stream_id;
- (QSSMutableFinalTextToSpeechStreamingResponse)init;
...
- (QSSTextToSpeechResponseDevData)dev_data
{
  return (QSSTextToSpeechResponseDevData *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"dev_data"];
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableFinalTextToSpeechStreamingResponse;
  v2 = [(QSSMutableFinalTextToSpeechStreamingResponse *)&v6 init];
  if (v2)
  {
