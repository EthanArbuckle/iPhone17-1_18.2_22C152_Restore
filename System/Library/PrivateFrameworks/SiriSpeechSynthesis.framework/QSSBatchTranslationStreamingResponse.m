...
- (QSSBatchTranslationStreamingResponse)initWithFlatbuffData:(id)a3;
- (QSSBatchTranslationStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingResponse *)a4;
...
- (Offset<siri::speech::qss_fb::BatchTranslationStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSBatchTranslationStreamingResponse *)self content_type];
  if ([(QSSBatchTranslationStreamingResponse *)self content_type] == 1)
  {
    char v6 = [(QSSBatchTranslationStreamingResponse *)self contentAsQSSBatchTranslationResponse];
  ...
  {
    long long v8 = [(QSSBatchTranslationStreamingResponse *)self contentAsQSSFinalBlazarResponse];
  ...
  {
    uint64_t v10 = [(QSSBatchTranslationStreamingResponse *)self contentAsQSSTranslationSupportedLanguagesResponse];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::BatchTranslationStreamingResponse>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, (int)v15 - (int)v14 + (int)v13);
}
...
- (QSSBatchTranslationStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v33.receiver = self;
  v33.super_class = (Class)QSSBatchTranslationStreamingResponse;
  uint64_t v10 = [(QSSBatchTranslationStreamingResponse *)&v33 init];
    ...
    if (v21[2])
    {
      switch(*((unsigned char *)root + v21[2]))
      {
        case 0:
          goto LABEL_34;
        case 1:
          if (v23 && !siri::speech::schema_fb::BatchTranslationResponse::Verify(v23, (flatbuffers::Verifier *)&v28)) {
            goto LABEL_36;
          }
          goto LABEL_34;
        case 2:
        ...
        case 3:
          if (!v23
            || siri::speech::schema_fb::TranslationSupportedLanguagesResponse::Verify(v23, (flatbuffers::Verifier *)&v28))
          {
            goto LABEL_34;
          }
          goto LABEL_36;
...
- (QSSBatchTranslationStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingResponse *)a4
{
  return [(QSSBatchTranslationStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSBatchTranslationStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSBatchTranslationStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSBatchTranslationStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
