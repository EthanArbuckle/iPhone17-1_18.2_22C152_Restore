@interface QSSTextToSpeechRouterStreamingStreamingResponse
...
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3;
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4;
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
- (int64_t)content_type;
@end

@implementation QSSTextToSpeechRouterStreamingStreamingResponse
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__63__QSSTextToSpeechRouterStreamingStreamingResponse_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self content_type];
  if ([(QSSTextToSpeechRouterStreamingStreamingResponse *)self content_type] == 1)
  {
    char v6 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self contentAsQSSBeginTextToSpeechStreamingResponse];
  ...
  if ([(QSSTextToSpeechRouterStreamingStreamingResponse *)self content_type] == 2)
  {
    long long v8 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self contentAsQSSPartialTextToSpeechStreamingResponse];
  ...
  if ([(QSSTextToSpeechRouterStreamingStreamingResponse *)self content_type] == 3)
  {
    uint64_t v10 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self contentAsQSSFinalTextToSpeechStreamingResponse];
...
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v33.receiver = self;
  v33.super_class = (Class)QSSTextToSpeechRouterStreamingStreamingResponse;
  uint64_t v10 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)&v33 init];
...
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4
{
  return [(QSSTextToSpeechRouterStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechRouterStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechRouterStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
