...
- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3;
- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4;
- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
...
- (Offset<siri::speech::schema_fb::RecognitionSausage>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSRecognitionSausage *)self positional_tok_phrase_alt];
  ...
  long long v30 = 0u;
  long long v31 = 0u;
  char v6 = [(QSSRecognitionSausage *)self positional_tok_phrase_alt];
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            int v12 = [[QSSRecognitionPhraseTokensAlternatives alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSRecognitionSausage;
  uint64_t v10 = [(QSSRecognitionSausage *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const RecognitionSausage *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
...
- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4
{
  return [(QSSRecognitionSausage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSRecognitionSausage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSRecognitionSausage)initWithFlatbuffData:(id)a3
{
  return [(QSSRecognitionSausage *)self initWithFlatbuffData:a3 root:0 verify:0];
}
