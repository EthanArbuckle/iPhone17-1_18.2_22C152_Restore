...
- (Offset<siri::speech::qss_fb::MultiUserStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSMultiUserStreamingResponse *)self content_type];
  if ([(QSSMultiUserStreamingResponse *)self content_type] == 1)
  {
    char v6 = [(QSSMultiUserStreamingResponse *)self contentAsQSSFinalSpeechRecognitionResponse];
  ...
  {
    long long v8 = [(QSSMultiUserStreamingResponse *)self contentAsQSSPartialSpeechRecognitionResponse];
  ...
  {
    uint64_t v10 = [(QSSMultiUserStreamingResponse *)self contentAsQSSRecognitionProgress];
  ...
  {
    __int16 v12 = [(QSSMultiUserStreamingResponse *)self contentAsQSSRecognitionCandidate];
  ...
  {
    v14 = [(QSSMultiUserStreamingResponse *)self contentAsQSSRequestStatsResponse];
  ...
  {
    v16 = [(QSSMultiUserStreamingResponse *)self contentAsQSSServerEndpointFeatures];
    unsigned int v31 = [v16 addObjectToBuffer:a3];
  }
  else
  {
    unsigned int v31 = 0;
  ...
  {
    v17 = [(QSSMultiUserStreamingResponse *)self contentAsQSSClientSetupInfo];
  ...
  {
    v19 = [(QSSMultiUserStreamingResponse *)self contentAsQSSAudioLimitExceeded];
  ...
  {
    v21 = [(QSSMultiUserStreamingResponse *)self contentAsQSSFinalBlazarResponse];
...
- (QSSMultiUserStreamingResponse)initWithFlatbuffData:(id)a3 root:(const MultiUserStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSMultiUserStreamingResponse *)&v33 init];
...
LABEL_54:
  ...
  if (v22 >= 7)
  {
    uint64_t v23 = (siri::speech::schema_fb::FinalSpeechRecognitionResponse *)v21[3];
    if (v21[3]) {
      uint64_t v23 = (siri::speech::schema_fb::FinalSpeechRecognitionResponse *)((char *)v23
    }
                                                                      + (void)root
...
- (QSSMultiUserStreamingResponse)initWithFlatbuffData:(id)a3 root:(const MultiUserStreamingResponse *)a4
{
  return [(QSSMultiUserStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSMultiUserStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSMultiUserStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSMultiUserStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
