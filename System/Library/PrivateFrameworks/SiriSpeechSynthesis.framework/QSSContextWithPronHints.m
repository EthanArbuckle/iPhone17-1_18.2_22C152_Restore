@interface QSSContextWithPronHints
- (NSArray)pron_hints;
- (NSString)contextual_text;
- (Offset<siri::speech::schema_fb::ContextWithPronHints>)addObjectToBuffer:(void *)a3;
- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3;
- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3 root:(const ContextWithPronHints *)a4;
- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3 root:(const ContextWithPronHints *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSContextWithPronHints
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSContextWithPronHints *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__39__QSSContextWithPronHints_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::ContextWithPronHints>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = [(QSSContextWithPronHints *)self contextual_text];
  uint64_t v5 = v4;
  if (!v4) {
    v4 = &stru_26DEBFAF8;
  }
  ...
  long long v8 = [(QSSContextWithPronHints *)self pron_hints];
  ...
  long long v37 = 0u;
  long long v38 = 0u;
  long long v9 = [(QSSContextWithPronHints *)self pron_hints];
...
- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3 root:(const ContextWithPronHints *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSContextWithPronHints;
  uint64_t v10 = [(QSSContextWithPronHints *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const ContextWithPronHints *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
...
- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3 root:(const ContextWithPronHints *)a4
{
  return [(QSSContextWithPronHints *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSContextWithPronHints *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSContextWithPronHints)initWithFlatbuffData:(id)a3
{
  return [(QSSContextWithPronHints *)self initWithFlatbuffData:a3 root:0 verify:0];
}
