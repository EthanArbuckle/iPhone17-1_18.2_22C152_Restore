...
- (Offset<siri::speech::schema_fb::PartialTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSPartialTextToSpeechStreamingResponse *)self speech_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSPartialTextToSpeechStreamingResponse *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  unsigned int v54 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v12, v13);

  int v14 = [(QSSPartialTextToSpeechStreamingResponse *)self error_code];
  v15 = [(QSSPartialTextToSpeechStreamingResponse *)self error_str];
  v16 = v15;
  if (!v15) {
    v15 = &stru_26DEBFAF8;
  }
  ...
  unsigned int v53 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v17, v18);

  v19 = [(QSSPartialTextToSpeechStreamingResponse *)self stream_id];
  v20 = v19;
  if (!v19) {
    v19 = &stru_26DEBFAF8;
  }
  ...
  unsigned int v49 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v21, v22);

  int v48 = [(QSSPartialTextToSpeechStreamingResponse *)self current_pkt_number];
  uint64_t v62 = 0;
  v63 = &v62;
  ...
  v61[4] = &v62;
  v61[5] = a3;
  [(QSSPartialTextToSpeechStreamingResponse *)self audio:v61];
  memset(&v60, 0, sizeof(v60));
  v23 = [(QSSPartialTextToSpeechStreamingResponse *)self word_timing_info];
  std::vector<flatbuffers::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v60, [v23 count]);

  long long v58 = 0u;
  long long v59 = 0u;
  long long v56 = 0u;
  long long v57 = 0u;
  id obj = [(QSSPartialTextToSpeechStreamingResponse *)self word_timing_info];
  uint64_t v24 = [obj countByEnumeratingWithState:&v56 objects:v69 count:16];
  int v50 = v14;
  ...
  if (v24)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v24; ++i)
      {
        ...
        int v30 = [*(id *)(*((void *)&v56 + 1) + 8 * i) addObjectToBuffer:a3];
        int v31 = v30;
        std::vector<int>::pointer end = v60.__end_;
        if (v60.__end_ >= value)
        {
          uint64_t v34 = v60.__end_ - begin;
          unint64_t v35 = v34 + 1;
          ...
          if (((char *)value - (char *)begin) >> 1 > v35) {
            unint64_t v35 = ((char *)value - (char *)begin) >> 1;
          }
  ...
  unsigned int v41 = flatbuffers::FlatBufferBuilder::CreateVector<siri::speech::schema_fb::RecognitionToken>((flatbuffers::FlatBufferBuilder *)a3, (uint64_t)v40, v33 - begin);
  v42 = [(QSSPartialTextToSpeechStreamingResponse *)v52 feature];
  unsigned int v43 = [v42 addObjectToBuffer:a3];
...
- (QSSPartialTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PartialTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v10 = [(QSSPartialTextToSpeechStreamingResponse *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSPartialTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PartialTextToSpeechStreamingResponse *)a4
{
  return [(QSSPartialTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSPartialTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSPartialTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSPartialTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
