...
- (Offset<siri::speech::schema_fb::UserDataEntity>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSUserDataEntity *)self attributes];
  ...
  long long v38 = 0u;
  long long v39 = 0u;
  uint64_t v10 = [(QSSUserDataEntity *)self attributes];
...
- (NSArray)attributes
{
  v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"attributes"];
  if (!v3)
  {
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            uint64_t v12 = [[QSSWord alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSUserDataEntity)initWithFlatbuffData:(id)a3 root:(const UserDataEntity *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSUserDataEntity *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSUserDataEntity)initWithFlatbuffData:(id)a3 root:(const UserDataEntity *)a4
{
  return [(QSSUserDataEntity *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSUserDataEntity *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSUserDataEntity)initWithFlatbuffData:(id)a3
{
  return [(QSSUserDataEntity *)self initWithFlatbuffData:a3 root:0 verify:0];
}
