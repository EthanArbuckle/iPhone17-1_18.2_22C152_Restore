@interface QSSMutableTextToSpeechSpeechFeatureResponse
- (NSArray)features;
- (NSString)error_str;
- (NSString)session_id;
- (NSString)speech_id;
- (QSSMutableTextToSpeechSpeechFeatureResponse)init;
...
@implementation QSSMutableTextToSpeechSpeechFeatureResponse
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableTextToSpeechSpeechFeatureResponse;
  v2 = [(QSSMutableTextToSpeechSpeechFeatureResponse *)&v6 init];
  if (v2)
  {
