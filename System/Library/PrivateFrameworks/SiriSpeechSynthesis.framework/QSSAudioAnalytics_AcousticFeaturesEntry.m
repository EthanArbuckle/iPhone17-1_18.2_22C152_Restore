...
- (Offset<siri::speech::schema_fb::AudioAnalytics_::AcousticFeaturesEntry>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSAudioAnalytics_AcousticFeaturesEntry *)self key];
  char v6 = v5;
  if (!v5) {
  ...
  long long v9 = [(QSSAudioAnalytics_AcousticFeaturesEntry *)self value];
  unsigned int v10 = [v9 addObjectToBuffer:a3];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  if (v10)
  {
    int v14 = flatbuffers::FlatBufferBuilder::ReferTo((flatbuffers::FlatBufferBuilder *)a3, v10);
...
- (QSSAudioAnalytics_AcousticFeaturesEntry)initWithFlatbuffData:(id)a3 root:(const AcousticFeaturesEntry *)a4 verify:(BOOL)a5
{
  ...
  unsigned int v10 = [(QSSAudioAnalytics_AcousticFeaturesEntry *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSAudioAnalytics_AcousticFeaturesEntry)initWithFlatbuffData:(id)a3 root:(const AcousticFeaturesEntry *)a4
{
  return [(QSSAudioAnalytics_AcousticFeaturesEntry *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSAudioAnalytics_AcousticFeaturesEntry *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSAudioAnalytics_AcousticFeaturesEntry)initWithFlatbuffData:(id)a3
{
  return [(QSSAudioAnalytics_AcousticFeaturesEntry *)self initWithFlatbuffData:a3 root:0 verify:0];
}
