...
- (void)setContentAsQSSLanguageDetectionResponse:(id)a3;
...
- (QSSLanguageDetectionResponse)contentAsQSSLanguageDetectionResponse
{
  ...
  return (QSSLanguageDetectionResponse *)v3;
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableLanguageDetectionStreamingResponse;
