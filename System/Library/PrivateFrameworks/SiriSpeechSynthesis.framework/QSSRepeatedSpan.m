@interface QSSRepeatedSpan
- (NSArray)span;
- (Offset<siri::speech::schema_fb::RepeatedSpan>)addObjectToBuffer:(void *)a3;
- (QSSRepeatedSpan)initWithFlatbuffData:(id)a3;
- (QSSRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4;
- (QSSRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSRepeatedSpan
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSRepeatedSpan *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__31__QSSRepeatedSpan_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::RepeatedSpan>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSRepeatedSpan *)self span];
  ...
  long long v30 = 0u;
  long long v31 = 0u;
  char v6 = [(QSSRepeatedSpan *)self span];
  ...
  if (v15 == begin) {
    v22 = (int *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::Span>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::Span>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::Span>> const&)::t;
  }
  else {
    v22 = begin;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            int v12 = [[QSSSpan alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSRepeatedSpan;
  uint64_t v10 = [(QSSRepeatedSpan *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::RepeatedSpan *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::RepeatedSpan::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          unsigned int v23 = 0;
          goto LABEL_17;
...
- (QSSRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4
{
  return [(QSSRepeatedSpan *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSRepeatedSpan *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSRepeatedSpan)initWithFlatbuffData:(id)a3
{
  return [(QSSRepeatedSpan *)self initWithFlatbuffData:a3 root:0 verify:0];
}
