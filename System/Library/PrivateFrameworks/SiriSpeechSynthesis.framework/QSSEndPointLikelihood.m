...
- (Offset<siri::speech::schema_fb::EndPointLikelihood>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSEndPointLikelihood *)self speech_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSEndPointLikelihood *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  int v15 = [(QSSEndPointLikelihood *)self return_code];
  v16 = [(QSSEndPointLikelihood *)self return_str];
  v17 = v16;
  if (!v16) {
    v16 = &stru_26DEBFAF8;
  }
  ...
  int v20 = [(QSSEndPointLikelihood *)self end_point_likelihood];
...
- (QSSEndPointLikelihood)initWithFlatbuffData:(id)a3 root:(const EndPointLikelihood *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSEndPointLikelihood *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSEndPointLikelihood)initWithFlatbuffData:(id)a3 root:(const EndPointLikelihood *)a4
{
  return [(QSSEndPointLikelihood *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSEndPointLikelihood *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSEndPointLikelihood)initWithFlatbuffData:(id)a3
{
  return [(QSSEndPointLikelihood *)self initWithFlatbuffData:a3 root:0 verify:0];
}
