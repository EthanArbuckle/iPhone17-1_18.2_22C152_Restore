...
- (QSSPronunciation)initWithFlatbuffData:(id)a3;
- (QSSPronunciation)initWithFlatbuffData:(id)a3 root:(const Pronunciation *)a4;
- (QSSPronunciation)initWithFlatbuffData:(id)a3 root:(const Pronunciation *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSPronunciation
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSPronunciation *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__32__QSSPronunciation_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::Pronunciation>)addObjectToBuffer:(void *)a3
{
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::Pronunciation>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v8);
}
...
- (QSSPronunciation)initWithFlatbuffData:(id)a3 root:(const Pronunciation *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSPronunciation;
  uint64_t v10 = [(QSSPronunciation *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const Pronunciation *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
...
- (QSSPronunciation)initWithFlatbuffData:(id)a3 root:(const Pronunciation *)a4
{
  return [(QSSPronunciation *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSPronunciation *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSPronunciation)initWithFlatbuffData:(id)a3
{
  return [(QSSPronunciation *)self initWithFlatbuffData:a3 root:0 verify:0];
}
