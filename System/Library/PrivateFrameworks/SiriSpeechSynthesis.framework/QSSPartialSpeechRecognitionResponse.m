...
- (Offset<siri::speech::schema_fb::PartialSpeechRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSPartialSpeechRecognitionResponse *)self speech_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSPartialSpeechRecognitionResponse *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  int v15 = [(QSSPartialSpeechRecognitionResponse *)self return_code];
  ...
  unsigned int v40 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v18, v19);
  ...
  int v26 = [(QSSPartialSpeechRecognitionResponse *)self is_stable_result];
  int v27 = [(QSSPartialSpeechRecognitionResponse *)self audio_duration_ms];
  int v28 = [(QSSPartialSpeechRecognitionResponse *)self confidence];
  ...
  unsigned int v33 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v31, v32);
...
- (QSSPartialSpeechRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const PartialSpeechRecognitionResponse *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSPartialSpeechRecognitionResponse *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSPartialSpeechRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const PartialSpeechRecognitionResponse *)a4
{
  return [(QSSPartialSpeechRecognitionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSPartialSpeechRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSPartialSpeechRecognitionResponse)initWithFlatbuffData:(id)a3
{
  return [(QSSPartialSpeechRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}
