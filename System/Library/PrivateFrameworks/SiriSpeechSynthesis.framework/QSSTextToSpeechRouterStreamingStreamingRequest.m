...
- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3;
- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingRequest *)a4;
- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingRequest *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingRequest>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSTextToSpeechRouterStreamingStreamingRequest *)self content_type];
  if ([(QSSTextToSpeechRouterStreamingStreamingRequest *)self content_type] == 1)
  {
    char v6 = [(QSSTextToSpeechRouterStreamingStreamingRequest *)self contentAsQSSStartTextToSpeechStreamingRequest];
...
- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v33.receiver = self;
  v33.super_class = (Class)QSSTextToSpeechRouterStreamingStreamingRequest;
  uint64_t v10 = [(QSSTextToSpeechRouterStreamingStreamingRequest *)&v33 init];
  uint64_t v11 = v10;
  if (!v10) {
    goto LABEL_30;
  }
...
- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingRequest *)a4
{
  return [(QSSTextToSpeechRouterStreamingStreamingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechRouterStreamingStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTextToSpeechRouterStreamingStreamingRequest)initWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechRouterStreamingStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}
