...
- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3;
- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4;
- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
...
- (Offset<siri::speech::schema_fb::NormalizedTokenVariant>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = [(QSSNormalizedTokenVariant *)self normalized_tokens];
  ...
  long long v32 = 0u;
  long long v33 = 0u;
  uint64_t v5 = [(QSSNormalizedTokenVariant *)self normalized_tokens];
...
- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSNormalizedTokenVariant;
  uint64_t v10 = [(QSSNormalizedTokenVariant *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const NormalizedTokenVariant *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
...
- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4
{
  return [(QSSNormalizedTokenVariant *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSNormalizedTokenVariant *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSNormalizedTokenVariant)initWithFlatbuffData:(id)a3
{
  return [(QSSNormalizedTokenVariant *)self initWithFlatbuffData:a3 root:0 verify:0];
}
