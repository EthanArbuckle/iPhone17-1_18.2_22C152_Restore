@interface QSSBatchTranslationStreamingRequest
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSBatchTranslationStreamingRequest *)self addObjectToBuffer:&v5];
...
- (Offset<siri::speech::qss_fb::BatchTranslationStreamingRequest>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSBatchTranslationStreamingRequest *)self content_type];
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 1)
  {
    char v6 = [(QSSBatchTranslationStreamingRequest *)self contentAsQSSBatchTranslationRequest];
  ...
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 2)
  {
    long long v8 = [(QSSBatchTranslationStreamingRequest *)self contentAsQSSBatchTranslationFeedbackRequest];
  ...
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 3)
  {
    uint64_t v10 = [(QSSBatchTranslationStreamingRequest *)self contentAsQSSBatchTranslationLoggingRequest];
  ...
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 4)
  {
    __int16 v12 = [(QSSBatchTranslationStreamingRequest *)self contentAsQSSTranslationSupportedLanguagesRequest];
...
- (QSSTranslationSupportedLanguagesRequest)contentAsQSSTranslationSupportedLanguagesRequest
{
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 4)
  {
    ...
    if (!v3)
    {
      ...
      v3 = [(QSSTranslationSupportedLanguagesRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (QSSBatchTranslationLoggingRequest)contentAsQSSBatchTranslationLoggingRequest
{
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 3)
  {
    ...
    if (!v3)
    {
      ...
      v3 = [(QSSBatchTranslationLoggingRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
      [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"content"];
    }
  }
  else
...
- (QSSBatchTranslationFeedbackRequest)contentAsQSSBatchTranslationFeedbackRequest
{
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 2)
  {
    ...
    if (!v3)
    {
      ...
      v3 = [(QSSBatchTranslationFeedbackRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
      [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"content"];
    }
  }
  else
...
- (QSSBatchTranslationRequest)contentAsQSSBatchTranslationRequest
{
  if ([(QSSBatchTranslationStreamingRequest *)self content_type] == 1)
  {
    ...
    if (!v3)
    {
      ...
      v3 = [(QSSBatchTranslationRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
      [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"content"];
    }
  }
  else
...
- (QSSBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSBatchTranslationStreamingRequest *)&v33 init];
...
- (QSSBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4
{
  return [(QSSBatchTranslationStreamingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSBatchTranslationStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3
{
  return [(QSSBatchTranslationStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}
