...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSLanguageDetected *)self addObjectToBuffer:&v5];
...
- (Offset<siri::speech::schema_fb::LanguageDetected>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSLanguageDetected *)self detected_locale];
  char v6 = v5;
  if (!v5) {
  ...
  long long v9 = [(QSSLanguageDetected *)self predictions];
  ...
  long long v35 = 0u;
  long long v36 = 0u;
  uint64_t v10 = [(QSSLanguageDetected *)self predictions];
...
- (QSSLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSLanguageDetected *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4
{
  return [(QSSLanguageDetected *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSLanguageDetected *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSLanguageDetected)initWithFlatbuffData:(id)a3
{
  return [(QSSLanguageDetected *)self initWithFlatbuffData:a3 root:0 verify:0];
}
