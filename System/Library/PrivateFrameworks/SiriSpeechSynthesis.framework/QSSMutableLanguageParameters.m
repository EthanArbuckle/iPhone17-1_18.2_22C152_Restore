@interface QSSMutableLanguageParameters
- (NSString)fork_id;
- (NSString)language;
- (NSString)request_locale;
- (QSSMutableLanguageParameters)init;
...
@implementation QSSMutableLanguageParameters
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableLanguageParameters;
  v2 = [(QSSMutableLanguageParameters *)&v6 init];
  if (v2)
  {
