...
- (QSSCategoryData)initWithFlatbuffData:(id)a3;
- (QSSCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4;
- (QSSCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSCategoryData
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSCategoryData *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__31__QSSCategoryData_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::CategoryData>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSCategoryData *)self category_name];
  char v6 = v5;
  if (!v5) {
  ...
  long long v9 = [(QSSCategoryData *)self category_data];
  ...
  long long v43 = 0u;
  long long v44 = 0u;
  v14 = [(QSSCategoryData *)self category_data];
  ...
  if (v17 == v11) {
    v29 = (char *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::UserDataEntity>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::UserDataEntity>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::UserDataEntity>> const&)::t;
  }
  else {
    v29 = v11;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 7u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            uint64_t v12 = [[QSSUserDataEntity alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSCategoryData;
  unint64_t v10 = [(QSSCategoryData *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::CategoryData *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::CategoryData::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          unint64_t v23 = 0;
          goto LABEL_17;
...
- (QSSCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4
{
  return [(QSSCategoryData *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSCategoryData *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSCategoryData)initWithFlatbuffData:(id)a3
{
  return [(QSSCategoryData *)self initWithFlatbuffData:a3 root:0 verify:0];
}
