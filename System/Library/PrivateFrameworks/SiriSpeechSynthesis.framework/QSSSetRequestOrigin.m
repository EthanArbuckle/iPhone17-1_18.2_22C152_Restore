...
- (QSSSetRequestOrigin)initWithFlatbuffData:(id)a3 root:(const SetRequestOrigin *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSSetRequestOrigin *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSSetRequestOrigin)initWithFlatbuffData:(id)a3 root:(const SetRequestOrigin *)a4
{
  return [(QSSSetRequestOrigin *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSSetRequestOrigin *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSSetRequestOrigin)initWithFlatbuffData:(id)a3
{
  return [(QSSSetRequestOrigin *)self initWithFlatbuffData:a3 root:0 verify:0];
}
