@interface QSSTokenProns_SanitizedSequence
- (NSArray)sanitized_tokens;
- (Offset<siri::speech::schema_fb::TokenProns_::SanitizedSequence>)addObjectToBuffer:(void *)a3;
- (QSSTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3;
- (QSSTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4;
- (QSSTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSTokenProns_SanitizedSequence
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSTokenProns_SanitizedSequence *)self addObjectToBuffer:&v5];
...
- (Offset<siri::speech::schema_fb::TokenProns_::SanitizedSequence>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSTokenProns_SanitizedSequence *)self sanitized_tokens];
  ...
  long long v38 = 0u;
  long long v39 = 0u;
  uint64_t v10 = [(QSSTokenProns_SanitizedSequence *)self sanitized_tokens];
  ...
  uint64_t v24 = v13 - v7;
  if (v13 == v7) {
    v25 = (char *)&flatbuffers::data<flatbuffers::Offset<siri::speech::schema_fb::SanitizedPronToken>,std::allocator<flatbuffers::Offset<siri::speech::schema_fb::SanitizedPronToken>>>(std::vector<flatbuffers::Offset<siri::speech::schema_fb::SanitizedPronToken>> const&)::t;
  }
  else {
    v25 = v7;
  }
    ...
    if (*(unsigned __int16 *)v5->var0 >= 5u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            uint64_t v12 = [[QSSSanitizedPronToken alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSTokenProns_SanitizedSequence;
  uint64_t v10 = [(QSSTokenProns_SanitizedSequence *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const SanitizedSequence *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      root = (siri::speech::schema_fb::TokenProns_::SanitizedSequence *)v11->_root;
      if (root)
      {
        if (!siri::speech::schema_fb::TokenProns_::SanitizedSequence::Verify(root, (flatbuffers::Verifier *)&v25))
        {
LABEL_16:
          int v23 = 0;
          goto LABEL_17;
...
- (QSSTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4
{
  return [(QSSTokenProns_SanitizedSequence *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTokenProns_SanitizedSequence *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3
{
  return [(QSSTokenProns_SanitizedSequence *)self initWithFlatbuffData:a3 root:0 verify:0];
}
