...
- (Offset<siri::speech::schema_fb::SetAlternateRecognitionSausage>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(QSSSetAlternateRecognitionSausage *)self positional_tok_phrase_alt];
  ...
  long long v30 = 0u;
  long long v31 = 0u;
  char v6 = [(QSSSetAlternateRecognitionSausage *)self positional_tok_phrase_alt];
...
- (QSSSetAlternateRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const SetAlternateRecognitionSausage *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSSetAlternateRecognitionSausage *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSSetAlternateRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const SetAlternateRecognitionSausage *)a4
{
  return [(QSSSetAlternateRecognitionSausage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSSetAlternateRecognitionSausage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSSetAlternateRecognitionSausage)initWithFlatbuffData:(id)a3
{
  return [(QSSSetAlternateRecognitionSausage *)self initWithFlatbuffData:a3 root:0 verify:0];
}
