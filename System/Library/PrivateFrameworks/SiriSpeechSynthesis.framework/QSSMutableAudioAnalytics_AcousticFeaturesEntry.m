...
- (QSSAcousticFeature)value
{
  return (QSSAcousticFeature *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"value"];
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableAudioAnalytics_AcousticFeaturesEntry;
