...
- (Offset<siri::speech::schema_fb::TextToSpeechCacheObject>)addObjectToBuffer:(void *)a3
{
  ...
  v39 = __Block_byref_object_copy__645;
  v40 = __Block_byref_object_dispose__646;
  v41 = &unk_22B66C18D;
  int v42 = 0;
  ...
  v35[4] = &v36;
  v35[5] = a3;
  [(QSSTextToSpeechCacheObject *)self audio:v35];
  memset(&v34, 0, sizeof(v34));
  uint64_t v5 = [(QSSTextToSpeechCacheObject *)self word_timing_info];
  ...
  long long v30 = 0u;
  long long v31 = 0u;
  char v6 = [(QSSTextToSpeechCacheObject *)self word_timing_info];
  uint64_t v7 = [v6 countByEnumeratingWithState:&v30 objects:v43 count:16];
  begin = v34.__begin_;
  if (v7)
  {
    ...
    if (*(unsigned __int16 *)v5->var0 >= 7u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            int v12 = [[QSSWordTimingInfo alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (QSSTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4 verify:(BOOL)a5
{
  ...
  id v10 = [(QSSTextToSpeechCacheObject *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4
{
  return [(QSSTextToSpeechCacheObject *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechCacheObject *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTextToSpeechCacheObject)initWithFlatbuffData:(id)a3
{
  return [(QSSTextToSpeechCacheObject *)self initWithFlatbuffData:a3 root:0 verify:0];
}
