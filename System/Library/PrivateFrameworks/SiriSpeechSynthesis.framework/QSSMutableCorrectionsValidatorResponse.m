@interface QSSMutableCorrectionsValidatorResponse
- (NSArray)corrections;
- (NSString)language;
- (NSString)return_str;
- (NSString)session_id;
- (NSString)speech_id;
- (QSSMutableCorrectionsValidatorResponse)init;
...
@implementation QSSMutableCorrectionsValidatorResponse
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableCorrectionsValidatorResponse;
  v2 = [(QSSMutableCorrectionsValidatorResponse *)&v6 init];
  if (v2)
  {
