...
- (QSSRecognitionStreamingRequest)initWithFlatbuffData:(id)a3;
- (QSSRecognitionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const RecognitionStreamingRequest *)a4;
- (QSSRecognitionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const RecognitionStreamingRequest *)a4 verify:(BOOL)a5;
...
- (Offset<siri::speech::qss_fb::RecognitionStreamingRequest>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(QSSRecognitionStreamingRequest *)self content_type];
  if ([(QSSRecognitionStreamingRequest *)self content_type] == 1)
  {
    char v6 = [(QSSRecognitionStreamingRequest *)self contentAsQSSStartSpeechRequest];
  ...
  {
    long long v8 = [(QSSRecognitionStreamingRequest *)self contentAsQSSUpdateAudioInfo];
  ...
  {
    uint64_t v10 = [(QSSRecognitionStreamingRequest *)self contentAsQSSSetRequestOrigin];
  ...
  {
    __int16 v12 = [(QSSRecognitionStreamingRequest *)self contentAsQSSSetSpeechContext];
  ...
  {
    v14 = [(QSSRecognitionStreamingRequest *)self contentAsQSSSetSpeechProfile];
  ...
  {
    v16 = [(QSSRecognitionStreamingRequest *)self contentAsQSSSetEndpointerState];
  ...
  {
    v18 = [(QSSRecognitionStreamingRequest *)self contentAsQSSAudioPacket];
    unsigned int v34 = [v18 addObjectToBuffer:a3];
  }
  else
  {
    unsigned int v34 = 0;
  ...
  {
    v19 = [(QSSRecognitionStreamingRequest *)self contentAsQSSFinishAudio];
    unsigned int v33 = [v19 addObjectToBuffer:a3];
  }
  else
  {
    unsigned int v33 = 0;
  ...
  {
    v20 = [(QSSRecognitionStreamingRequest *)self contentAsQSSResetServerEndpointer];
    unsigned int v32 = [v20 addObjectToBuffer:a3];
  }
  else
  {
    unsigned int v32 = 0;
  ...
  {
    v21 = [(QSSRecognitionStreamingRequest *)self contentAsQSSCheckForSpeechRequest];
  ...
  {
    v24 = [(QSSRecognitionStreamingRequest *)self contentAsQSSSetAlternateRecognitionSausage];
    unsigned int v25 = [v24 addObjectToBuffer:a3];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::RecognitionStreamingRequest>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, (int)v27 - (int)v26 + (int)v35);
}
...
- (QSSRecognitionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const RecognitionStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v33.receiver = self;
  v33.super_class = (Class)QSSRecognitionStreamingRequest;
  uint64_t v10 = [(QSSRecognitionStreamingRequest *)&v33 init];
...
LABEL_60:
  ...
  if (v22 >= 7)
  {
    if (v21[3])
    {
      unsigned int v23 = (flatbuffers::Table *)((char *)root + v21[3] + *(unsigned int *)((char *)root + v21[3]));
      goto LABEL_24;
    }
LABEL_23:
    unsigned int v23 = 0;
    ...
    if (v21[2])
    {
      switch(*((unsigned char *)root + v21[2]))
      {
        case 0:
          goto LABEL_58;
        case 1:
          if (v23 && !siri::speech::schema_fb::StartSpeechRequest::Verify(v23, (flatbuffers::Verifier *)&v28)) {
            goto LABEL_60;
          }
          goto LABEL_58;
        case 2:
        ...
        case 9:
          ...
          goto LABEL_58;
        case 0xA:
          if (v23 && !siri::speech::schema_fb::CheckForSpeechRequest::Verify(v23, (flatbuffers::Verifier *)&v28)) {
            goto LABEL_60;
          }
          goto LABEL_58;
        case 0xB:
...
- (QSSRecognitionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const RecognitionStreamingRequest *)a4
{
  return [(QSSRecognitionStreamingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSRecognitionStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSRecognitionStreamingRequest)initWithFlatbuffData:(id)a3
{
  return [(QSSRecognitionStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}
