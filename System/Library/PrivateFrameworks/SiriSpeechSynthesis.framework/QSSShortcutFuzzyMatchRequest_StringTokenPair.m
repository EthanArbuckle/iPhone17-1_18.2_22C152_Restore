...
- (Offset<siri::speech::schema_fb::ShortcutFuzzyMatchRequest_::StringTokenPair>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)self raw_string];
  uint64_t v5 = v4;
  if (!v4) {
    v4 = &stru_26DEBFAF8;
  }
  ...
  long long v8 = [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)self tokens];
  ...
  long long v37 = 0u;
  long long v38 = 0u;
  long long v9 = [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)self tokens];
...
- (QSSShortcutFuzzyMatchRequest_StringTokenPair)initWithFlatbuffData:(id)a3 root:(const StringTokenPair *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSShortcutFuzzyMatchRequest_StringTokenPair)initWithFlatbuffData:(id)a3 root:(const StringTokenPair *)a4
{
  return [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSShortcutFuzzyMatchRequest_StringTokenPair)initWithFlatbuffData:(id)a3
{
  return [(QSSShortcutFuzzyMatchRequest_StringTokenPair *)self initWithFlatbuffData:a3 root:0 verify:0];
}
