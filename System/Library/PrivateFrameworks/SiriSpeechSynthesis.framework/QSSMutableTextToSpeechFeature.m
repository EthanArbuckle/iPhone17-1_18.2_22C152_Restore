...
@implementation QSSMutableTextToSpeechFeature
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableTextToSpeechFeature;
  v2 = [(QSSMutableTextToSpeechFeature *)&v6 init];
  if (v2)
  {
