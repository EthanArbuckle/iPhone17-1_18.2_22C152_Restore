...
- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3;
- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4;
- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4 verify:(BOOL)a5;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation QSSTTSNeuralPhonemeSequence
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(QSSTTSNeuralPhonemeSequence *)self addObjectToBuffer:&v5];
  flatbuffers::FlatBufferBuilder::Finish((flatbuffers::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

flatbuffers::DetachedBuffer *__43__QSSTTSNeuralPhonemeSequence_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::TTSNeuralPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  v4 = [(QSSTTSNeuralPhonemeSequence *)self phonemes];
  ...
  long long v32 = 0u;
  long long v33 = 0u;
  uint64_t v5 = [(QSSTTSNeuralPhonemeSequence *)self phonemes];
...
- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)QSSTTSNeuralPhonemeSequence;
  uint64_t v10 = [(QSSTTSNeuralPhonemeSequence *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const TTSNeuralPhonemeSequence *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
...
- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4
{
  return [(QSSTTSNeuralPhonemeSequence *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSTTSNeuralPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3
{
  return [(QSSTTSNeuralPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:0];
}
