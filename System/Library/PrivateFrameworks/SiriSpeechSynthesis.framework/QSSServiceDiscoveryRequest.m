...
- (Offset<siri::speech::schema_fb::ServiceDiscoveryRequest>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(QSSServiceDiscoveryRequest *)self session_id];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(QSSServiceDiscoveryRequest *)self app_id];
  uint64_t v11 = v10;
  if (!v10) {
...
- (QSSServiceDiscoveryRequest)initWithFlatbuffData:(id)a3 root:(const ServiceDiscoveryRequest *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(QSSServiceDiscoveryRequest *)&v39 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (QSSServiceDiscoveryRequest)initWithFlatbuffData:(id)a3 root:(const ServiceDiscoveryRequest *)a4
{
  return [(QSSServiceDiscoveryRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(QSSServiceDiscoveryRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (QSSServiceDiscoveryRequest)initWithFlatbuffData:(id)a3
{
  return [(QSSServiceDiscoveryRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}
