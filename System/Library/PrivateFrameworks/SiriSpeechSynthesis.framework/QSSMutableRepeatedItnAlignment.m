...
- (NSArray)itn_alignment
{
  return (NSArray *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"itn_alignment"];
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)QSSMutableRepeatedItnAlignment;
