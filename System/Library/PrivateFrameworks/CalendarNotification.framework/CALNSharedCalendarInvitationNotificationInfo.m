...
- (BOOL)isDelegate;
- (CALNSharedCalendarInvitationNotificationInfo)initWithSourceClientIdentifier:(id)a3 calendarNotification:(id)a4 isDelegate:(BOOL)a5 sourceTitle:(id)a6 sourceIdentifier:(id)a7;
...
@implementation CALNSharedCalendarInvitationNotificationInfo
...
- (CALNSharedCalendarInvitationNotificationInfo)initWithSourceClientIdentifier:(id)a3 calendarNotification:(id)a4 isDelegate:(BOOL)a5 sourceTitle:(id)a6 sourceIdentifier:(id)a7
{
  ...
  id v15 = a7;
  v24.receiver = self;
  v24.super_class = (Class)CALNSharedCalendarInvitationNotificationInfo;
  v16 = [(CALNSharedCalendarInvitationNotificationInfo *)&v24 init];
  if (v16)
  {
...
- (id)description
{
  ...
  v5 = [(CALNSharedCalendarInvitationNotificationInfo *)self sourceClientIdentifier];
  v6 = [(CALNSharedCalendarInvitationNotificationInfo *)self calendarNotification];
  v7 = objc_msgSend(NSNumber, "numberWithBool:", -[CALNSharedCalendarInvitationNotificationInfo isDelegate](self, "isDelegate"));
  v8 = [(CALNSharedCalendarInvitationNotificationInfo *)self sourceTitle];
  v9 = [(CALNSharedCalendarInvitationNotificationInfo *)self sourceIdentifier];
