...
- (int)start
{
  ...
  if (*((unsigned char *)internal + 124)) {
    int v5 = *((_DWORD *)internal + 30);
  }
  else {
    int v5 = 1;
  }
...
- (void)setStart:(int)start
{
  ...
  WebCore::HTMLOListElement::setStartForBindings(self->super.super.super.super._internal);
...
LABEL_12:
  ...
  uint64_t v8 = *MEMORY[0x1E4FB6708];
  uint64_t v7 = v7;
  while (1)
  {
    uint64_t v9 = *v6;
