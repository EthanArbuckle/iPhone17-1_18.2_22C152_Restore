...
{
  if (self) {
    self = (DOMHTMLTableCellElement *)self->super.super.super.super._internal;
  }
  v2 = (WebCore::Node *)WebCore::HTMLTableCellElement::cellAbove((WebCore::HTMLTableCellElement *)self);
  return kit(v2);
}
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((uint64_t *)&v9, (WTF::AtomStringImpl *)axis, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7) {
    goto LABEL_4;
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((uint64_t *)&v9, (WTF::AtomStringImpl *)headers, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7) {
    goto LABEL_4;
...
LABEL_12:
  ...
  uint64_t v8 = *MEMORY[0x1E4FB6590];
  uint64_t v7 = v7;
  while (1)
  {
    uint64_t v9 = *v6;
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((uint64_t *)&v9, (WTF::AtomStringImpl *)abbr, v4);
  uint64_t v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7) {
    goto LABEL_4;
...
- (NSString)scope
{
  ...
  if (*(void *)WebCore::HTMLTableCellElement::scope(self->super.super.super.super._internal)) {
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((uint64_t *)&v9, (WTF::AtomStringImpl *)scope, v4);
  uint64_t v7 = v9;
