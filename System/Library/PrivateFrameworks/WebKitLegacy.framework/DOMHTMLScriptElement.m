...
- (NSString)text
{
  ...
  WebCore::ScriptElement::scriptContent((uint64_t *)&v7, (WebCore::ScriptElement *)((char *)self->super.super.super.super._internal + 128));
  if (v7)
  {
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WTF::AtomStringImpl::add((uint64_t *)&v9, (WTF::AtomStringImpl *)event, v4);
  v7 = v9;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (!v7) {
    goto LABEL_4;
...
LABEL_12:
  ...
  uint64_t v8 = *MEMORY[0x1E4FB6A98];
  uint64_t v7 = v7;
  while (1)
  {
    uint64_t v9 = *v6;
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState((WebCore::JSMainThreadNullState *)v8);
  WebCore::HTMLScriptElement::crossOrigin((uint64_t *)&v7, self->super.super.super.super._internal);
  if (v7)
  {
