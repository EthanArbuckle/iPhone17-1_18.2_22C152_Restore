...
+ (uint64_t)_repTypesAllowImageTypeOmission:()WebInternal
{
  ...
  *a1 = v2;
  ...
  v4 = objc_msgSend(+[WebHTMLRepresentation supportedNonImageMIMETypes](WebHTMLRepresentation, "supportedNonImageMIMETypes"), "objectEnumerator");
  ...
  v8 = objc_msgSend(+[WebHTMLRepresentation supportedMediaMIMETypes](WebHTMLRepresentation, "supportedMediaMIMETypes"), "objectEnumerator");
  ...
  if ((result & 1) == 0)
  {
    ...
    v13 = objc_msgSend((id)-[objc_class supportedMIMETypes](+[WebView _getPDFRepresentationClass](WebView, "_getPDFRepresentationClass"), "supportedMIMETypes"), "objectEnumerator");
