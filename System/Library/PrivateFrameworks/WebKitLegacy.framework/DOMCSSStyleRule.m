...
- (NSString)selectorText
{
  ...
  WebCore::CSSStyleRule::selectorText((uint64_t *)&v7, self->super.super._internal);
  if (v7)
  {
...
- (void)setSelectorText:(NSString *)selectorText
{
  ...
  WebCore::CSSStyleRule::setSelectorText(internal, (const WTF::String *)&v9);
  v7 = v9;
  v9 = 0;
  if (!v7) {
    goto LABEL_4;
...
- (DOMCSSStyleDeclaration)style
{
  ...
  v3 = (DOMObjectInternal *)WebCore::CSSStyleRule::style(self->super.super._internal);
