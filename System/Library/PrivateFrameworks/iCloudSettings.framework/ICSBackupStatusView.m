...
{
  v53.receiver = self;
  v53.super_class = (Class)ICSBackupStatusView;
  ...
  v7 = -[ICSBackupStatusView initWithFrame:](&v53, sel_initWithFrame_, a3, *MEMORY[0x263F001A8], v4, v5, v6);
  if (v7)
  {
    ...
    v31 = [v30 localizedStringForKey:@"ESTIMATING_TIME_REMAINING" value:&stru_270DEF3F8 table:@"Localizable-Backup"];
    ...
    v49 = [v48 localizedStringForKey:@"DETERMINING_LAST_BACKUP" value:&stru_270DEF3F8 table:@"Localizable-Backup"];
...
- (void)_sizeToFitWidth:(double)a3 inTableView:(id)a4
{
  ...
  -[ICSBackupStatusView setFrame:](self, "setFrame:", v44, v16, a3, v40);
...
{
  v8.receiver = self;
  v8.super_class = (Class)ICSBackupStatusView;
  [(ICSBackupStatusView *)&v8 sizeToFit];
  double v3 = [(ICSBackupStatusView *)self superview];

  if (v3)
  {
    double v4 = [(ICSBackupStatusView *)self superview];
    [v4 bounds];
    double v6 = v5;
    double v7 = [(ICSBackupStatusView *)self superview];
...
{
  v3.receiver = self;
  v3.super_class = (Class)ICSBackupStatusView;
...
- (void)setBackupProgress:(double)a3 timeIntervalRemaining:(double)a4
{
  if (a4 > 604800.0 || a4 <= 0.0)
  {
    ...
    double v6 = [v7 localizedStringForKey:@"ESTIMATING_TIME_REMAINING" value:&stru_270DEF3F8 table:@"Localizable-Backup"];
  }
  else
  {
...
- (void)updateViewsForBackupState:(int)a3 restoreState:(int)a4 enabled:(BOOL)a5
{
  ...
  float v9 = LogSubsystem();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 67109120;
    LODWORD(v47) = a3;
    _os_log_impl(&dword_262993000, v9, OS_LOG_TYPE_DEFAULT, "update view for backup state: %d", buf, 8u);
  }
  ...
  if (((1 << a3) & 0x79) == 0)
  {
    ...
    double v20 = [v19 localizedStringForKey:@"BACKING_UP" value:&stru_270DEF3F8 table:@"Localizable-Backup"];
  ...
  if (!self->_backupError)
  {
    ...
    {
      double v21 = LogSubsystem();
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        syncErrors = self->_syncErrors;
        *(_DWORD *)buf = 138412290;
        float v47 = syncErrors;
        _os_log_impl(&dword_262993000, v21, OS_LOG_TYPE_DEFAULT, "sync errors only: %@", buf, 0xCu);
      }
      double v23 = 0;
      goto LABEL_32;
    }
  ...
  double v11 = LogSubsystem();
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    backupError = self->_backupError;
    *(_DWORD *)buf = 138412290;
    float v47 = backupError;
    _os_log_impl(&dword_262993000, v11, OS_LOG_TYPE_DEFAULT, "backup error only: %@", buf, 0xCu);
  }
...
LABEL_47:
          ...
          double v23 = [v21 localizedStringForKey:v38 value:&stru_270DEF3F8 table:@"Localizable-Backup"];
...
LABEL_31:
    double v23 = [v24 localizedStringForKey:v25 value:&stru_270DEF3F8 table:@"Localizable-Backup"];
LABEL_32:
...
LABEL_33:
  ...
  uint64_t v27 = [(ICSBackupStatusView *)self footerText];

  if (v27)
  {
    uint64_t v28 = [(ICSBackupStatusView *)self footerText];
    double v29 = (void *)v28;
    if (v23)
    {
...
LABEL_44:
  ...
  v43[1] = 3221225472;
  v43[2] = __70__ICSBackupStatusView_updateViewsForBackupState_restoreState_enabled___block_invoke;
  v43[3] = &unk_2655B5900;
  double v44 = v10;
  id v45 = self;
  v39[0] = MEMORY[0x263EF8330];
  v39[1] = 3221225472;
  v39[2] = __70__ICSBackupStatusView_updateViewsForBackupState_restoreState_enabled___block_invoke_2;
  v39[3] = &unk_2655B6290;
  int v41 = a3;
  BOOL v42 = v5;
  v39[4] = self;
  ...
  [(ICSBackupStatusView *)self sizeToFit];
  [(ICSBackupStatusView *)self _layoutSubviews];
  double v35 = [(ICSBackupStatusView *)self superview];
  [(ICSBackupStatusView *)self frame];
