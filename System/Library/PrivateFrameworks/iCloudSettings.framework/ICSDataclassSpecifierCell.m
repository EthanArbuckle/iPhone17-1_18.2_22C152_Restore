...
- (ICSDataclassSpecifierCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  v4 = [(ICSDataclassSpecifierCell *)&v7 initWithStyle:a3 reuseIdentifier:a4];
  v5 = v4;
  if (v4)
  {
...
- (void)_setupViews
{
  ...
  v97 = [(ICSDataclassSpecifierCell *)self headerImageView];
  v96 = [v97 heightAnchor];
  v95 = [v96 constraintEqualToConstant:56.0];
  v98[0] = v95;
  v94 = [(ICSDataclassSpecifierCell *)self headerImageView];
  v93 = [v94 widthAnchor];
  v92 = [v93 constraintEqualToConstant:56.0];
  v98[1] = v92;
  v91 = [(ICSDataclassSpecifierCell *)self headerImageView];
  v89 = [v91 leadingAnchor];
  v90 = [(ICSDataclassSpecifierCell *)self contentView];
  v88 = [v90 leadingAnchor];
  v87 = [v89 constraintGreaterThanOrEqualToAnchor:v88 constant:24.0];
  v98[2] = v87;
  v86 = [(ICSDataclassSpecifierCell *)self headerImageView];
  v84 = [v86 centerXAnchor];
  v85 = [(ICSDataclassSpecifierCell *)self contentView];
  v83 = [v85 centerXAnchor];
  v82 = [v84 constraintEqualToAnchor:v83];
  v98[3] = v82;
  v81 = [(ICSDataclassSpecifierCell *)self headerImageView];
  v79 = [v81 topAnchor];
  v80 = [(ICSDataclassSpecifierCell *)self contentView];
  v78 = [v80 topAnchor];
  v77 = [v79 constraintEqualToAnchor:v78 constant:32.0];
  v98[4] = v77;
  v76 = [(ICSDataclassSpecifierCell *)self headerImageView];
  v73 = [v76 bottomAnchor];
  v74 = [(ICSDataclassSpecifierCell *)self headerTitleLabel];
  v72 = [v74 topAnchor];
  v71 = [v73 constraintEqualToAnchor:v72 constant:-16.0];
  v98[5] = v71;
  v70 = [(ICSDataclassSpecifierCell *)self headerTitleLabel];
  v68 = [v70 leadingAnchor];
  v69 = [(ICSDataclassSpecifierCell *)self contentView];
  v67 = [v69 leadingAnchor];
  v66 = [v68 constraintEqualToAnchor:v67 constant:24.0];
  v98[6] = v66;
  v65 = [(ICSDataclassSpecifierCell *)self headerTitleLabel];
  v63 = [v65 centerXAnchor];
  v64 = [(ICSDataclassSpecifierCell *)self contentView];
  v62 = [v64 centerXAnchor];
  v61 = [v63 constraintEqualToAnchor:v62];
  v98[7] = v61;
  v60 = [(ICSDataclassSpecifierCell *)self headerTitleLabel];
  v58 = [v60 bottomAnchor];
  v59 = [(ICSDataclassSpecifierCell *)self headerSubTitleTextView];
  v57 = [v59 topAnchor];
  v56 = [v58 constraintEqualToAnchor:v57 constant:-8.0];
  v98[8] = v56;
  v55 = [(ICSDataclassSpecifierCell *)self headerSubTitleTextView];
  v53 = [v55 leadingAnchor];
  v54 = [(ICSDataclassSpecifierCell *)self contentView];
  v52 = [v54 leadingAnchor];
  v51 = [v53 constraintEqualToAnchor:v52 constant:24.0];
  v98[9] = v51;
  v50 = [(ICSDataclassSpecifierCell *)self headerSubTitleTextView];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  double v7 = [(ICSDataclassSpecifierCell *)self headerImageView];
  ...
  v11 = +[ICSDataclassSpecifierCell _attributedStringFromSpecifier:v4];
  v12 = [(ICSDataclassSpecifierCell *)self headerSubTitleTextView];
  v13 = v12;
  if (v11)
  {
...
+ (_NSRange)_rangeForLinkFromSpecifier:(id)a3
{
  ...
  double v7 = [v4 objectForKeyedSubscript:@"AAUIDataclassAttributedLink"];
...
+ (id)_attributedStringFromSpecifier:(id)a3
{
  ...
  double v7 = [v5 objectForKeyedSubscript:@"AAUIDataclassAttributedLinkText"];
  BOOL v8 = [v5 objectForKeyedSubscript:@"AAUIDataclassAttributedLink"];
