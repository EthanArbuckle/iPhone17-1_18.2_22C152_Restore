...
LABEL_10:
  ...
  else
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v10 = 138412290;
      uint64_t v11 = v8;
      _os_log_impl(&dword_262993000, v5, OS_LOG_TYPE_DEFAULT, "private email remove for key %@ is success", (uint8_t *)&v10, 0xCu);
    }
...
void __72__ICSPrivateEmailUpdateCacheHook__removePrivateEmailKey_withCompletion___block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_error_impl(&dword_262993000, log, OS_LOG_TYPE_ERROR, "private email remove for key %@ failed with error %@", (uint8_t *)&v4, 0x16u);
}
