...
+ (id)_atrialFibrillationExpandedContentItemsAlgorithmVersionTwo
{
  ...
  v43[12] = v24;
  id v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:v43 count:13];
...
+ (id)_inconclusiveExpandedContentItemsAlgorithmVersionTwoUpgradingFromAlgorithmVersion:(int64_t)a3 withLearnMoreDelegate:(id)a4
{
  ...
  v18 = [(id)objc_opt_class() itemWithType:3 title:v17];
  [v7 addObject:v18];
  v19 = objc_opt_class();
  ...
  [v7 addObject:v21];
  v23 = [MEMORY[0x263EFF8C0] arrayWithArray:v7];
...
+ (id)_highOrLowAbove150Below50HeartRateExpandedContentItemsAlgorithmVersionTwoUpgradingFromAlgorithmVersion:(int64_t)a3
{
  ...
  uint64_t v5 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_3_EXPANDED_1_BODY_0");
  uint64_t v6 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_3_EXPANDED_1_BODY_1");
  uint64_t v7 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_3_EXPANDED_2_BODY_1");
  v36 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_3_EXPANDED_3_BODY_1");
  v38 = (void *)v5;
  v35 = [(id)objc_opt_class() itemWithType:2 title:v5];
  objc_msgSend(v4, "addObject:");
  v8 = objc_opt_class();
  v9 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_3_EXPANDED_1_HEADING");
  uint64_t v10 = [v8 itemWithType:1 title:v9];

  v34 = (void *)v10;
  [v4 addObject:v10];
  v37 = (void *)v6;
  v33 = [(id)objc_opt_class() itemWithType:2 title:v6];
  objc_msgSend(v4, "addObject:");
  v11 = objc_opt_class();
  ...
  [v4 addObject:v19];
  v20 = (void *)v7;
  v21 = [(id)objc_opt_class() itemWithType:2 title:v7];
  [v4 addObject:v21];
  if (a3 == 1)
  {
    v22 = objc_opt_class();
  ...
  v25 = objc_opt_class();
  id v26 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_3_EXPANDED_3_HEADING");
  v27 = [v25 itemWithType:1 title:v26];

  [v4 addObject:v27];
  v28 = [(id)objc_opt_class() itemWithType:2 title:v36];
  [v4 addObject:v28];
  v29 = objc_opt_class();
...
+ (id)_poorRecordingExpandedContentItemsForAlgorithmVersionTwoWithLearnMoreDelegate:(id)a3
{
  ...
  id v27 = a3;
  v3 = objc_opt_class();
  id v26 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_5_EXPANDED_1_HEADING");
  v25 = [v3 itemWithType:1 title:v26];
  v28[0] = v25;
  id v4 = objc_opt_class();
  v23 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_5_EXPANDED_1_LIST_1");
  uint64_t v5 = [v4 itemWithType:3 title:v23];
  v28[1] = v5;
  uint64_t v6 = objc_opt_class();
  uint64_t v7 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_5_EXPANDED_1_LIST_2");
  v8 = [v6 itemWithType:3 title:v7];
  v28[2] = v8;
  v9 = objc_opt_class();
  uint64_t v10 = HRUIECGLocalizedString(@"ECG_V2_ONBOARDING_3_SECTION_5_EXPANDED_1_LIST_3");
  ...
  v28[4] = v14;
  v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v28 count:5];
  ...
  [v16 addObject:v19];
  v21 = [MEMORY[0x263EFF8C0] arrayWithArray:v16];
...
{
  id v5 = a4;
  uint64_t v6 = (void *)[objc_alloc((Class)objc_opt_class()) initWithType:a3 title:v5];
...
+ (id)sinusRhythmItemsForAlgorithmVersion:(int64_t)a3
{
  if ((unint64_t)(a3 - 1) <= 1)
  {
    objc_msgSend(a1, "_sinusRhythmExpandedContentItemsAlgVersionOne", v3);
...
+ (id)atrialFibrillationItemsForAlgorithmVersion:(int64_t)a3
{
  if (a3 == 2)
  {
    uint64_t v3 = [a1 _atrialFibrillationExpandedContentItemsAlgorithmVersionTwo];
  }
  else
  {
    if (a3 != 1) {
    ...
    uint64_t v3 = [a1 _atrialFibrillationExpandedContentItemsAlgVersionOne];
  }
  a2 = v3;
LABEL_6:
  return (id)(id)a2;
...
+ (id)highOrLowAbove120Below50HeartRateItemsForAlgorithmVersion:(int64_t)a3
{
  if (a3 == 1)
  {
    id v5 = objc_msgSend(a1, "_highOrLowAbove120Below50HeartRateExpandedContentItemsAlgVersionOne", v3);
  }
  else
  {
...
+ (id)inconclusiveItemsForAlgorithmVersion:(int64_t)a3 upgradingFromAlgorithmVersion:(int64_t)a4 learnMoreDelegate:(id)a5
{
  ...
  if (a3 == 2)
  {
    int64_t v9 = [a1 _inconclusiveExpandedContentItemsAlgorithmVersionTwoUpgradingFromAlgorithmVersion:a4 withLearnMoreDelegate:v8];
  }
  else
  {
    if (a3 != 1) {
    ...
    int64_t v9 = [a1 _inconclusiveExpandedContentItemsAlgVersionOneWithLearnMoreDelegate:v8];
  }
  a4 = v9;
LABEL_6:
...
+ (id)highOrLowAbove150Below50HeartRateItemsForAlgorithmVersion:(int64_t)a3 upgradingFromAlgorithmVersion:(int64_t)a4
{
  ...
  else if (a3 == 1)
  {
    ...
    uint64_t v4 = *MEMORY[0x263F09920];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F09920], OS_LOG_TYPE_ERROR)) {
      +[HRExpandedContentItem highOrLowAbove150Below50HeartRateItemsForAlgorithmVersion:upgradingFromAlgorithmVersion:](v4);
    }
    a1 = (id)MEMORY[0x263EFFA68];
  }
  return a1;
}
...
+ (id)poorRecordingItemsForAlgorithmVersion:(int64_t)a3 learnMoreDelegate:(id)a4
{
  ...
  {
    _HKInitializeLogging();
    id v7 = *MEMORY[0x263F09920];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F09920], OS_LOG_TYPE_ERROR)) {
      +[HRExpandedContentItem poorRecordingItemsForAlgorithmVersion:learnMoreDelegate:](v7);
    }
    a1 = (id)MEMORY[0x263EFFA68];
  }
...
+ (id)_sinusRhythmExpandedContentItemsAlgVersionOne
{
  ...
  v2 = objc_opt_class();
  uint64_t v3 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_1_EXPANDED_1");
  uint64_t v4 = [v2 itemWithType:2 title:v3];
  v10[0] = v4;
  id v5 = objc_opt_class();
  id v6 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_1_EXPANDED_2");
  id v7 = [v5 itemWithType:2 title:v6];
  v10[1] = v7;
...
+ (id)_atrialFibrillationExpandedContentItemsAlgVersionOne
{
  ...
  id v27 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_2_EXPANDED_3_SYMPTOM_2");
  id v26 = [v8 itemWithType:3 title:v27];
  v40[6] = v26;
  int64_t v9 = objc_opt_class();
  uint64_t v10 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_2_EXPANDED_3_SYMPTOM_3");
  objc_super v11 = [v9 itemWithType:3 title:v10];
  v40[7] = v11;
  v12 = objc_opt_class();
  ...
  v40[11] = v23;
  id v25 = [MEMORY[0x263EFF8C0] arrayWithObjects:v40 count:12];
...
+ (id)_highOrLowAbove120Below50HeartRateExpandedContentItemsAlgVersionOne
{
  ...
  uint64_t v4 = [v3 itemWithType:2 title:v19];
  v22[1] = v4;
  id v5 = objc_opt_class();
  id v6 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_3_EXPANDED_1_BODY_2");
  id v7 = [v5 itemWithType:2 title:v6];
  v22[2] = v7;
  id v8 = objc_opt_class();
  int64_t v9 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_3_EXPANDED_2_HEADING");
  uint64_t v10 = [v8 itemWithType:1 title:v9];
  v22[3] = v10;
  ...
  v22[5] = v16;
  v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:6];
...
+ (id)_inconclusiveExpandedContentItemsAlgVersionOneWithLearnMoreDelegate:(id)a3
{
  ...
  uint64_t v4 = [v3 itemWithType:1 title:v44];
  v50[0] = v4;
  id v5 = objc_opt_class();
  id v6 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_4_EXPANDED_1_LIST_1");
  id v7 = [v5 itemWithType:3 title:v6];
  v50[1] = v7;
  id v8 = objc_opt_class();
  int64_t v9 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_4_EXPANDED_1_LIST_2");
  uint64_t v10 = [v8 itemWithType:3 title:v9];
  v50[2] = v10;
  objc_super v11 = objc_opt_class();
  ...
  v16 = [v14 itemWithType:3 title:v15];
  v50[4] = v16;
  v46 = [MEMORY[0x263EFF8C0] arrayWithObjects:v50 count:5];
  ...
  id v25 = [v23 itemWithType:3 title:v24];
  v49[1] = v25;
  id v26 = objc_opt_class();
  id v27 = HRUIECGLocalizedString(@"ECG_ONBOARDING_3_SECTION_4_EXPANDED_2_LIST_2");
  ...
  v49[3] = v31;
  v32 = [MEMORY[0x263EFF8C0] arrayWithObjects:v49 count:4];
  ...
  v41 = [MEMORY[0x263EFF980] arrayWithArray:v46];
  [v41 addObject:v45];
  [v41 addObjectsFromArray:v32];
  [v41 addObject:v35];
  [v41 addObjectsFromArray:v40];
  v42 = [MEMORY[0x263EFF8C0] arrayWithArray:v41];

  return v42;
}

+ (void)highOrLowAbove150Below50HeartRateItemsForAlgorithmVersion:(os_log_t)log upgradingFromAlgorithmVersion:.cold.1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_220CA3000, log, OS_LOG_TYPE_ERROR, "High or low above 150 below 50 bpm expanded card should not show when active algorithm version is 1.", v1, 2u);
}

+ (void)poorRecordingItemsForAlgorithmVersion:(os_log_t)log learnMoreDelegate:.cold.1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_220CA3000, log, OS_LOG_TYPE_ERROR, "Poor recording expanded card should not show when active algorithm version is 1.", v1, 2u);
}
