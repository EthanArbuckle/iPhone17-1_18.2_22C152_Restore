@interface RTSynthesizedLocationEnumerationContext
...
{
  v3 = objc_opt_new();
  v4 = [(RTSynthesizedLocationEnumerationContext *)self initWithEnumerationOptions:v3 offset:0];
...
- (RTSynthesizedLocationEnumerationContext)initWithEnumerationOptions:(id)a3
{
  return [(RTSynthesizedLocationEnumerationContext *)self initWithEnumerationOptions:a3 offset:0];
}
...
- (RTSynthesizedLocationEnumerationContext)initWithEnumerationOptions:(id)a3 offset:(unint64_t)a4
{
  ...
  v7 = [(RTSynthesizedLocationEnumerationContext *)&v11 init];
  if (v7)
  {
    if (v6) {
      uint64_t v8 = [v6 copy];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RTSynthesizedLocationEnumerationContext *)self options];
  id v6 = objc_msgSend(v4, "initWithEnumerationOptions:offset:", v5, -[RTSynthesizedLocationEnumerationContext offset](self, "offset"));
...
- (RTSynthesizedLocationEnumerationContext)initWithCoder:(id)a3
{
  ...
  v7 = [(RTSynthesizedLocationEnumerationContext *)self initWithEnumerationOptions:v5 offset:v6];
  return v7;
}

- (BOOL)isEqual:(id)a3
{
  id v4 = (RTSynthesizedLocationEnumerationContext *)a3;
  id v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(RTSynthesizedLocationEnumerationContext *)self isEqualToContext:v5];
...
LABEL_4:
    v9 = [v6 options];
    char v10 = [(RTSynthesizedLocationEnumerationOptions *)v8 isEqual:v9];
...
- (unint64_t)hash
{
  unint64_t v3 = [(RTSynthesizedLocationEnumerationOptions *)self->_options hash];
