...
+ (id)JSONStringFromNSDictionary:()RTExtensions error:
{
  ...
  if ([MEMORY[0x1E4F28D90] isValidJSONObject:v5])
  {
    ...
    if (v7)
    {
      ...
      v9 = [v8 localizedStringForKey:@"NSJSONSerialization failed" value:&stru_1EFF84648 table:0];
  ...
  else
  {
    ...
    v13 = [v12 localizedStringForKey:@"Invalid dictionary for JSON serialization" value:&stru_1EFF84648 table:0];
    v21[0] = v13;
    v20[1] = *MEMORY[0x1E4F285A0];
    v14 = [MEMORY[0x1E4F28B50] mainBundle];
    v15 = [v14 localizedStringForKey:@"Refer to NSJSONSerialization spec for valid dictionaries" value:&stru_1EFF84648 table:0];
    v21[1] = v15;
