  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v22 = 1024;
      int v23 = 26;
      _os_log_error_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: queue (in %s:%d)", buf, 0x12u);
    }
  }
  v19.receiver = self;
...
- (void)setup
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100007454;
  block[3] = &unk_1000245D8;
  block[4] = self;
...
- (BOOL)fireWithDate:(id)a3 error:(id *)a4
{
  ...
  {
    id v8 = sub_1000071D0(&qword_10002D358);
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: endDate", buf, 2u);
    }

    if (a4)
    {
      sub_10000BDD0(@"endDate");
...
- (void)_fireWithDate:(id)a3
{
  ...
  {
    v5 = sub_1000071D0(&qword_10002D358);
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)id v6 = 0;
      _os_log_error_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: endDate", v6, 2u);
    }
  }
}
