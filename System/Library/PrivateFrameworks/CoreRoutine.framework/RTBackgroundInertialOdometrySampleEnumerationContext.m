...
{
  v3 = objc_opt_new();
  v4 = [(RTBackgroundInertialOdometrySampleEnumerationContext *)self initWithEnumerationOptions:v3 offset:0];
...
- (RTBackgroundInertialOdometrySampleEnumerationContext)initWithEnumerationOptions:(id)a3
{
  return [(RTBackgroundInertialOdometrySampleEnumerationContext *)self initWithEnumerationOptions:a3 offset:0];
}
...
- (RTBackgroundInertialOdometrySampleEnumerationContext)initWithEnumerationOptions:(id)a3 offset:(unint64_t)a4
{
  ...
  v7 = [(RTBackgroundInertialOdometrySampleEnumerationContext *)&v11 init];
  if (v7)
  {
    if (v6) {
      uint64_t v8 = [v6 copy];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RTBackgroundInertialOdometrySampleEnumerationContext *)self options];
  id v6 = objc_msgSend(v4, "initWithEnumerationOptions:offset:", v5, -[RTBackgroundInertialOdometrySampleEnumerationContext offset](self, "offset"));
...
- (RTBackgroundInertialOdometrySampleEnumerationContext)initWithCoder:(id)a3
{
  ...
  v7 = [(RTBackgroundInertialOdometrySampleEnumerationContext *)self initWithEnumerationOptions:v5 offset:v6];
  return v7;
}

- (BOOL)isEqual:(id)a3
{
  id v4 = (RTBackgroundInertialOdometrySampleEnumerationContext *)a3;
  id v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(RTBackgroundInertialOdometrySampleEnumerationContext *)self isEqualToContext:v5];
...
LABEL_4:
    v9 = [v6 options];
    char v10 = [(RTBackgroundInertialOdometrySampleEnumerationOptions *)v8 isEqual:v9];
...
- (unint64_t)hash
{
  unint64_t v3 = [(RTBackgroundInertialOdometrySampleEnumerationOptions *)self->_options hash];
