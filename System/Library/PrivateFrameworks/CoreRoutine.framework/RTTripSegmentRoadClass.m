...
LABEL_14:
  ...
  v19.receiver = self;
  v19.super_class = (Class)RTTripSegmentRoadClass;
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      v21 = v13;
      _os_log_debug_impl(&dword_1A8FEF000, v14, OS_LOG_TYPE_DEBUG, "tripSegmentRoadClass, %@", buf, 0xCu);
    }
  }
  self = v13;
  v15 = self;
...
- (RTTripSegmentRoadClass)initWithCoder:(id)a3
{
  ...
  int v7 = [v4 decodeIntForKey:@"geoRoadClass"];
...
- (BOOL)isEqual:(id)a3
{
  ...
  int v8 = [(NSDateInterval *)dateInterval isEqual:v7];
  ...
  int64_t geoRoadClass = self->_geoRoadClass;
  uint64_t v13 = [v4 geoRoadClass];

  BOOL v14 = geoRoadClass == v13 && v11;
  if (!v8) {
    BOOL v14 = 0;
  }
  return v5 && v14;
