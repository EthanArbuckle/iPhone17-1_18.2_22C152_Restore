...
- (RTTripSegmentInertialDataEnumerationOptions)initWithDateInterval:(id)a3
{
  id v6 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RTTripSegmentInertialDataEnumerationOptions;
...
- (RTTripSegmentInertialDataEnumerationOptions)initWithCoder:(id)a3
{
  ...
  id v6 = [(RTTripSegmentInertialDataEnumerationOptions *)self initWithDateInterval:v5];
  return v6;
}

- (BOOL)isEqual:(id)a3
{
  id v4 = (RTTripSegmentInertialDataEnumerationOptions *)a3;
  v5 = v4;
  if (v4 == self) {
    BOOL v6 = 1;
  }
    ...
    BOOL v6 = v4
      ...
      && [(RTTripSegmentInertialDataEnumerationOptions *)self isEqualToOptions:v5];
