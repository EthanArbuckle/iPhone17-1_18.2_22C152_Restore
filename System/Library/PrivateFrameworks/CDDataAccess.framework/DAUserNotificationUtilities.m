...
LABEL_17:
    ...
    [v30 handleFailureInMethod:a2, a1, @"DAUserNotificationUtilities.m", 71, @"Invalid parameter not satisfying: %@", @"completionBlock != nil" object file lineNumber description];
  ...
  [v29 handleFailureInMethod:a2, a1, @"DAUserNotificationUtilities.m", 70, @"Invalid parameter not satisfying: %@", @"notification != nil" object file lineNumber description];
...
LABEL_18:
  ...
  [v31 handleFailureInMethod:a2, a1, @"DAUserNotificationUtilities.m", 72, @"Invalid parameter not satisfying: %@", @"runLoop != nil" object file lineNumber description];
...
LABEL_4:
  ...
  if (v18)
  {
    ...
    objc_msgSend(v32, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, @"DAUserNotificationUtilities.m", 73, @"Already waiting on this notification %p", a3);
  }
  ...
  else
  {
    ...
    os_log_type_t v28 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 3);
    if (os_log_type_enabled(v27, v28))
    {
      *(_DWORD *)buf = 138412290;
      v34 = a3;
      _os_log_impl(&dword_1C86FF000, v27, v28, "Couldn't schedule response for notification %@", buf, 0xCu);
    }
