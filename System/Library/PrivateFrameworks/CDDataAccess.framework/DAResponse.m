...
- (DAResponse)initWithCoder:(id)a3
{
  ...
  if (([v5 allowsKeyedCoding] & 1) == 0)
  {
    ...
    [v8 handleFailureInMethod:a2 object:self file:@"DAAction.m" lineNumber:193 description:@"Who does non-keyed coding nowadays?"];
  }
  v9.receiver = self;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (([v5 allowsKeyedCoding] & 1) == 0)
  {
    ...
    [v6 handleFailureInMethod:a2 object:self file:@"DAAction.m" lineNumber:202 description:@"Who does non-keyed coding nowadays?"];
  }
  v7.receiver = self;
