...
- (void)dealloc
{
  ...
  if ([(NSMutableArray *)v3->_queuedExclusiveTasks count])
  {
    ...
    [v11 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:117 description:@"There are queued exclusive tasks remaining during dealloc"];
  }
  if (v3->_activeExclusiveTask)
  {
    v12 = [MEMORY[0x1E4F28B00] currentHandler];
    [v12 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:118 description:@"There is an active exclusive task remaining during dealloc"];
  }
  if ([(NSMutableSet *)v3->_independentTasks count])
  {
    v13 = [MEMORY[0x1E4F28B00] currentHandler];
    [v13 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:119 description:@"There are independent tasks remaining during dealloc"];
  }
  if ([(NSMutableSet *)v3->_heldIndependentTasks count])
  {
    uint64_t v14 = [MEMORY[0x1E4F28B00] currentHandler];
    [v14 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:120 description:@"There are held independent tasks remaining during dealloc"];
  }
  if ([(NSMutableSet *)v3->_modalHeldIndependentTasks count])
  {
    uint64_t v15 = [MEMORY[0x1E4F28B00] currentHandler];
    [v15 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:121 description:@"There are modal-held independent tasks remaining during dealloc"];
  }
  if ([(NSMutableArray *)v3->_mQueuedTasks count])
  {
    v16 = [MEMORY[0x1E4F28B00] currentHandler];
    [v16 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:122 description:@"There are queued tasks remaining during dealloc"];
  }
  if (v3->_activeQueuedTask)
  {
    v17 = [MEMORY[0x1E4F28B00] currentHandler];
    [v17 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:123 description:@"There is an active queued task remaining during dealloc"];
  }
  if (v3->_modalHeldActiveQueuedTask)
  {
    uint64_t v18 = [MEMORY[0x1E4F28B00] currentHandler];
    [v18 handleFailureInMethod:a2 object:v3 file:@"DATaskManager.m" lineNumber:124 description:@"There is a modal-held active queued task remaining during dealloc"];
  }
  ...
  uint64_t v4 = MEMORY[0x1E4F50E48];
  if (v3->_transaction)
  {
    v5 = DALoggingwithCategory();
    os_log_type_t v6 = *(unsigned char *)(v4 + 5);
    if (os_log_type_enabled(v5, v6))
    {
      *(_DWORD *)buf = 138412290;
      v21 = v3;
      _os_log_impl(&dword_1C86FF000, v5, v6, "DATaskManager: Task manager %@ is being deallocated. Ending XPC transaction", buf, 0xCu);
    }
  ...
  if (v3->_daActivity)
  {
    ...
    os_log_type_t v9 = *(unsigned char *)(v4 + 5);
    if (os_log_type_enabled(v8, v9))
    {
      *(_DWORD *)buf = 138412290;
      v21 = v3;
      _os_log_impl(&dword_1C86FF000, v8, v9, "DATaskManager: Task manager %@ is being deallocated. Ending XPC activity", buf, 0xCu);
    }
...
- (void)submitExclusiveTask:(id)a3 toFrontOfQueue:(BOOL)a4
{
  ...
  id v7 = a3;
  v8 = DALoggingwithCategory();
  uint64_t v9 = MEMORY[0x1E4F50E48];
  ...
  if (os_log_type_enabled(v8, v10))
  {
    ...
    __int16 v39 = 1024;
    BOOL v40 = v4;
    _os_log_impl(&dword_1C86FF000, v8, v10, "Exclusive task %@ submitted, to front: %d", (uint8_t *)&v37, 0x12u);
  }
  ...
  if (!v11->_transaction)
  {
    ...
    os_log_type_t v15 = *(unsigned char *)(v9 + 5);
    if (os_log_type_enabled(v14, v15))
    {
      LOWORD(v37) = 0;
      _os_log_impl(&dword_1C86FF000, v14, v15, "DATaskManager: Begin an xpc transaction due to exclusive task", (uint8_t *)&v37, 2u);
    }
    ...
    {
      objc_super v19 = [(DATransaction *)v11->_transaction transactionId];
      int v37 = 138412290;
      id v38 = v19;
      _os_log_impl(&dword_1C86FF000, v18, v15, "DATaskManager: DATransaction starting, ID: %@", (uint8_t *)&v37, 0xCu);
    }
  }
  if (!v11->_daActivity)
  {
    ...
    if (v21)
    {
      ...
      os_log_type_t v23 = *(unsigned char *)(v9 + 5);
      if (os_log_type_enabled(v22, v23))
      {
        ...
        int v37 = 138412290;
        id v38 = v25;
        _os_log_impl(&dword_1C86FF000, v22, v23, "DATaskManager: Retain an xpc activity due to exclusive task for account %@", (uint8_t *)&v37, 0xCu);
      }
      v26 = [DAActivity alloc];
      v27 = [(DATaskManager *)v11 account];
      uint64_t v28 = [(DAActivity *)v26 initWithAccount:v27];
      daActivity = v11->_daActivity;
      v11->_daActivity = (DAActivity *)v28;
    }
  }
  int v30 = [(DATaskManager *)v11 state];
  if ((v30 - 1) < 4)
  {
    int v31 = 0;
    if (v4)
    {
LABEL_22:
      long long v32 = [(DATaskManager *)v11 queuedExclusiveTasks];
...
LABEL_30:
  ...
  {
    long long v33 = [(DATaskManager *)v11 activeQueuedTask];
    if (v33)
    {

      goto LABEL_29;
    }
    long long v35 = [(DATaskManager *)v11 independentTasks];
...
- (void)submitIndependentTask:(id)a3
{
  ...
  uint64_t v7 = MEMORY[0x1E4F50E48];
  os_log_type_t v8 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 7);
  if (os_log_type_enabled(v6, v8))
  {
    int v31 = 138412290;
    id v32 = v5;
    _os_log_impl(&dword_1C86FF000, v6, v8, "Independent task %@ submitted", (uint8_t *)&v31, 0xCu);
  }
  ...
  if ([(DATaskManager *)v9 state] != 5)
  {
    ...
    if (!v9->_transaction)
    {
      ...
      os_log_type_t v13 = *(unsigned char *)(v7 + 5);
      if (os_log_type_enabled(v12, v13))
      {
        LOWORD(v31) = 0;
        _os_log_impl(&dword_1C86FF000, v12, v13, "DATaskManager: Begin an xpc transaction due to independent task", (uint8_t *)&v31, 2u);
      }
      ...
      if (os_log_type_enabled(v16, v13))
      {
        ...
        int v31 = 138412290;
        id v32 = v17;
        _os_log_impl(&dword_1C86FF000, v16, v13, "DATaskManager: DATransaction starting, ID: %@", (uint8_t *)&v31, 0xCu);
      }
    }
    if (!v9->_daActivity)
    {
      uint64_t v18 = [(DATaskManager *)v9 account];
      int v19 = [v18 hasXpcActivity];

      if (v19)
      {
        v20 = DALoggingwithCategory();
        os_log_type_t v21 = *(unsigned char *)(v7 + 5);
        if (os_log_type_enabled(v20, v21))
        {
          uint64_t v22 = [(DATaskManager *)v9 account];
          os_log_type_t v23 = [v22 accountID];
          int v31 = 138412290;
          id v32 = v23;
          _os_log_impl(&dword_1C86FF000, v20, v21, "DATaskManager: Retain an xpc activity due to independent task for account %@", (uint8_t *)&v31, 0xCu);
        }
        v24 = [DAActivity alloc];
        v25 = [(DATaskManager *)v9 account];
        uint64_t v26 = [(DAActivity *)v24 initWithAccount:v25];
        daActivity = v9->_daActivity;
        v9->_daActivity = (DAActivity *)v26;
      }
    }
    int v28 = [(DATaskManager *)v9 state];
    if ((v28 - 1) >= 4)
    {
      if (!v28)
      {
        int v30 = [(DATaskManager *)v9 independentTasks];
        [v30 addObject:v5];
    ...
    {
      long long v29 = [(DATaskManager *)v9 heldIndependentTasks];
      [v29 addObject:v5];
    }
...
- (void)submitQueuedTask:(id)a3
{
  ...
  if (os_log_type_enabled(v6, v8))
  {
    int v32 = 138412290;
    id v33 = v5;
    _os_log_impl(&dword_1C86FF000, v6, v8, "Queued task %@ submitted", (uint8_t *)&v32, 0xCu);
  }
  ...
  if ([(DATaskManager *)v9 state] != 5)
  {
    ...
    if (!v9->_transaction)
    {
      ...
      {
        LOWORD(v32) = 0;
        _os_log_impl(&dword_1C86FF000, v12, v13, "DATaskManager: Begin an xpc transaction due to queued task", (uint8_t *)&v32, 2u);
      }
      ...
      if (os_log_type_enabled(v16, v13))
      {
        ...
        int v32 = 138412290;
        id v33 = v17;
        _os_log_impl(&dword_1C86FF000, v16, v13, "DATaskManager: DATransaction starting, ID: %@", (uint8_t *)&v32, 0xCu);
      }
    }
    if (!v9->_daActivity)
    {
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v20, v21))
        {
          ...
          int v32 = 138412290;
          id v33 = v23;
          _os_log_impl(&dword_1C86FF000, v20, v21, "DATaskManager: Retain an xpc activity due to queued task for account %@", (uint8_t *)&v32, 0xCu);
        }
        v24 = [DAActivity alloc];
        v25 = [(DATaskManager *)v9 account];
        uint64_t v26 = [(DAActivity *)v24 initWithAccount:v25];
    ...
    if ((v28 - 1) >= 4)
    {
      ...
      int v30 = [(DATaskManager *)v9 activeQueuedTask];
      BOOL v31 = v30 == 0;
    ...
    long long v29 = [(DATaskManager *)v9 mQueuedTasks];
    [v29 addObject:v5];
LABEL_22:
...
- (void)cancelTask:(id)a3 withUnderlyingError:(id)a4
{
  ...
  if (os_log_type_enabled(v7, v8))
  {
    int v9 = 138412290;
    id v10 = v5;
    _os_log_impl(&dword_1C86FF000, v7, v8, "Task %@ aborted", (uint8_t *)&v9, 0xCu);
  }
...
- (void)shutdown
{
  ...
  uint64_t v4 = MEMORY[0x1E4F50E48];
  os_log_type_t v5 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 7);
  if (os_log_type_enabled(v3, v5))
  {
    ...
    __int16 v26 = 2048;
    v27 = v6;
    _os_log_impl(&dword_1C86FF000, v3, v5, "Task Manager %p shutting down with account at %p", (uint8_t *)&v24, 0x16u);
  }
  ...
  if (os_log_type_enabled(v7, v5))
  {
    ...
    __int16 v26 = 2112;
    v27 = v8;
    _os_log_impl(&dword_1C86FF000, v7, v5, "Task Manager %p shutting down with state %@", (uint8_t *)&v24, 0x16u);
  }
  if ([(DATaskManager *)self state] != 5)
  {
    ...
    if (v14)
    {
      os_log_type_t v15 = [(DATaskManager *)v9 xpcTransactionTimer];
      [v15 invalidate];
    ...
    {
      uint64_t v16 = DALoggingwithCategory();
      os_log_type_t v17 = *(unsigned char *)(v4 + 5);
      if (os_log_type_enabled(v16, v17))
      {
        int v24 = 138412290;
        v25 = v9;
        _os_log_impl(&dword_1C86FF000, v16, v17, "DATaskManager: Task manager %@ is being shut down. Ending XPC transaction", (uint8_t *)&v24, 0xCu);
      }
    ...
    if (v9->_daActivity)
    {
      ...
      os_log_type_t v20 = *(unsigned char *)(v4 + 5);
      if (os_log_type_enabled(v19, v20))
      {
        int v24 = 138412290;
        v25 = v9;
        _os_log_impl(&dword_1C86FF000, v19, v20, "DATaskManager: Task manager %@ is being shut down. Releasing XPC activity", (uint8_t *)&v24, 0xCu);
      }

      daActivity = v9->_daActivity;
      v9->_daActivity = 0;
    }
    uint64_t v22 = [(DATaskManager *)v9 powerLogIdleTimer];

    if (v22)
    {
      os_log_type_t v23 = [(DATaskManager *)v9 powerLogIdleTimer];
      [v23 invalidate];
...
- (id)stateString
{
  ...
  objc_sync_enter(v2);
  BOOL v3 = NSString;
  uint64_t v16 = getStateName([(DATaskManager *)v2 state]);
  os_log_type_t v15 = [(DATaskManager *)v2 activeExclusiveTask];
  uint64_t v14 = [(DATaskManager *)v2 queuedExclusiveTasks];
  uint64_t v4 = [(DATaskManager *)v2 independentTasks];
  os_log_type_t v5 = [(DATaskManager *)v2 heldIndependentTasks];
  uint64_t v6 = [(DATaskManager *)v2 modalHeldIndependentTasks];
...
- (void)_useOpportunisticSocketsAgain
{
  ...
  if ([(DATaskManager *)self state] != 5)
  {
    ...
    if (os_log_type_enabled(v3, v4))
    {
      int v6 = 138412290;
      uint64_t v7 = self;
      _os_log_impl(&dword_1C86FF000, v3, v4, "Task manager %@ has finally drained its queue. Turning opportunistic socket support back on", (uint8_t *)&v6, 0xCu);
    }
...
- (id)_powerLogInfoDictionary
{
  ...
  if (v13)
  {
    ...
    os_log_type_t v15 = (objc_class *)objc_opt_class();
...
- (void)_clearUserInitiatedSyncTimer
{
  ...
  if ([(DATaskManager *)self state] != 5)
  {
    ...
    if (os_log_type_enabled(v3, v4))
    {
      int v6 = 138412290;
      uint64_t v7 = self;
      _os_log_impl(&dword_1C86FF000, v3, v4, "Task manager %@ has finally drained its queue. Clearing its user initiated sync state", (uint8_t *)&v6, 0xCu);
    }
...
- (void)_endXpcTransaction
{
  ...
  if (os_log_type_enabled(v3, v5))
  {
    int v6 = [(DATransaction *)self->_transaction transactionId];
    int v14 = 138412546;
    os_log_type_t v15 = self;
    __int16 v16 = 2112;
    os_log_type_t v17 = v6;
    _os_log_impl(&dword_1C86FF000, v3, v5, "DATaskManager: Task manager %@ has finally drained its queue. Ending XPC transaction %@", (uint8_t *)&v14, 0x16u);
  }
  ...
  if (os_log_type_enabled(v8, v5))
  {
    ...
    os_log_type_t v15 = self;
    __int16 v16 = 2112;
    os_log_type_t v17 = daActivity;
    _os_log_impl(&dword_1C86FF000, v8, v5, "DATaskManager: Task manager %@ has finally drained its queue. Releasing XPC activity %@", (uint8_t *)&v14, 0x16u);
  }

  long long v10 = self->_daActivity;
  self->_daActivity = 0;

  long long v11 = DALoggingwithCategory();
  os_log_type_t v12 = *(unsigned char *)(v4 + 6);
  if (os_log_type_enabled(v11, v12))
  {
    int v14 = 138412290;
    os_log_type_t v15 = self;
    _os_log_impl(&dword_1C86FF000, v11, v12, "Task manager %@ has finally drained its queue. Reset automatic fetching state", (uint8_t *)&v14, 0xCu);
  }

  uint64_t v13 = [(DATaskManager *)self account];
...
- (BOOL)_hasTasksForcingNetworkConnection
{
  ...
  uint64_t v18 = [(DATaskManager *)self activeModalTask];
  BOOL v19 = [(DATaskManager *)self _taskForcesNetworking:v18];

  if (v19) {
    return 1;
  }
  os_log_type_t v20 = [(DATaskManager *)self activeQueuedTask];
  BOOL v21 = [(DATaskManager *)self _taskForcesNetworking:v20];

  if (v21) {
    return 1;
  }
  uint64_t v22 = [(DATaskManager *)self modalHeldActiveQueuedTask];
...
- (void)taskDidFinish:(id)a3
{
  ...
  uint64_t v7 = MEMORY[0x1E4F50E48];
  os_log_type_t type = *(unsigned char *)(MEMORY[0x1E4F50E48] + 7);
  if (os_log_type_enabled(v6, type))
  {
    *(_DWORD *)buf = 138412290;
    id v148 = v5;
    _os_log_impl(&dword_1C86FF000, v6, type, "Task %@ finished.", buf, 0xCu);
  }
  ...
  if ([(DATaskManager *)self state] != 5)
  {
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  BOOL v23 = [(DATaskManager *)v8 mQueuedTasks];
                  int v24 = [v23 containsObject:v5];

                  if (!v24)
                  {
                    id v119 = [(DATaskManager *)v8 activeModalTask];
                    BOOL v120 = v119 == v5;

                    if (v120)
                    {
                      v124 = [MEMORY[0x1E4F28B00] currentHandler];
                      [v124 handleFailureInMethod:a2, v8, @"DATaskManager.m", 676, @"Finished task is not being managed, so cannot be active modal task." object file lineNumber description];
                    }
                    v121 = [(DATaskManager *)v8 queuedModalTasks];
                    int v122 = [v121 containsObject:v5];

                    if (v122)
                    {
                      v125 = [MEMORY[0x1E4F28B00] currentHandler];
                      [v125 handleFailureInMethod:a2, v8, @"DATaskManager.m", 678, @"Finished task is not being managed, so cannot be in modal queue." object file lineNumber description];
                    }
                    v111 = DALoggingwithCategory();
                    os_log_type_t v123 = *(unsigned char *)(v7 + 6);
                    if (os_log_type_enabled(v111, v123))
                    {
                      *(_DWORD *)buf = 138412290;
                      id v148 = v5;
                      _os_log_impl(&dword_1C86FF000, v111, v123, "Early return because task %@ isn't in our collection", buf, 0xCu);
                    }
                    goto LABEL_111;
                  }
    ...
    id v25 = [(DATaskManager *)v8 activeModalTask];
    ...
    else
    {
      ...
      if (v27)
      {
        uint64_t v28 = [(DATaskManager *)v8 queuedModalTasks];
        [v28 removeObject:v5];
...
LABEL_27:
    ...
    {
      case 0:
        int v30 = [(DATaskManager *)v8 queuedModalTasks];
        if ([v30 count]) {
          goto LABEL_59;
        }
        BOOL v31 = [(DATaskManager *)v8 queuedExclusiveTasks];
        if ([v31 count])
        {
        ...
        if (v54)
        {
          ...
          if (v56)
          {
            ...
            int v30 = [(DATaskManager *)v8 activeQueuedTask];
            [(DATaskManager *)v8 _schedulePerformTask:v30];
            goto LABEL_59;
          }
        }
        goto LABEL_60;
      case 1:
        uint64_t v34 = [(DATaskManager *)v8 activeQueuedTask];
        if (v34)
        {

LABEL_47:
          v45 = [(DATaskManager *)v8 queuedExclusiveTasks];
          BOOL v38 = [v45 count] == 0;

          goto LABEL_48;
        }
        uint64_t v43 = [(DATaskManager *)v8 independentTasks];
        BOOL v44 = [v43 count] == 0;

        if (!v44) {
          goto LABEL_47;
        }
        v60 = [(DATaskManager *)v8 queuedExclusiveTasks];
        uint64_t v61 = [v60 count];

        if (v61)
        {
LABEL_58:
          v62 = [(DATaskManager *)v8 queuedExclusiveTasks];
          v63 = [v62 objectAtIndexedSubscript:0];
          [(DATaskManager *)v8 setActiveExclusiveTask:v63];

          v64 = [(DATaskManager *)v8 queuedExclusiveTasks];
          [v64 removeObjectAtIndex:0];

          int v30 = [(DATaskManager *)v8 activeExclusiveTask];
          [(DATaskManager *)v8 _schedulePerformTask:v30];
LABEL_59:
        }
LABEL_60:
        [(DATaskManager *)v8 _makeStateTransition];
        v65 = [(DATaskManager *)v8 managerIdleTimer];
        ...
        v67 = [(DATaskManager *)v8 account];
        if ([v67 shouldUseOpportunisticSockets]) {
          goto LABEL_71;
        }
        BOOL v68 = [(DATaskManager *)v8 _hasTasksForcingNetworkConnection];

        if (!v68)
        {
          id v69 = objc_alloc(MEMORY[0x1E4F1CB00]);
          v70 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSinceNow:5.0];
          v71 = (void *)[v69 initWithFireDate:v70 interval:v8 target:sel__useOpportunisticSocketsAgain selector:0 userInfo:0 repeats:0.0];
          [(DATaskManager *)v8 setManagerIdleTimer:v71];

          long long v141 = 0u;
          long long v142 = 0u;
          long long v139 = 0u;
          long long v140 = 0u;
          v67 = runLoopModesToPerformDelayedSelectorsIn();
          uint64_t v72 = [v67 countByEnumeratingWithState:&v139 objects:v146 count:16];
          if (v72)
          {
            uint64_t v73 = *(void *)v140;
            do
            {
              for (uint64_t i = 0; i != v72; ++i)
              {
                ...
                uint64_t v75 = *(void *)(*((void *)&v139 + 1) + 8 * i);
                v76 = [MEMORY[0x1E4F1CAC0] currentRunLoop];
                v77 = [(DATaskManager *)v8 managerIdleTimer];
                [v76 addTimer:v77 forMode:v75];
              }
              uint64_t v72 = [v67 countByEnumeratingWithState:&v139 objects:v146 count:16];
            }
            while (v72);
...
LABEL_71:
        ...
        v78 = [(DATaskManager *)v8 userInitiatedSyncTimer];
        ...
        v80 = [(DATaskManager *)v8 account];
        if (![v80 wasUserInitiated]) {
          goto LABEL_83;
        }
        BOOL v81 = [(DATaskManager *)v8 _hasTasksIndicatingARunningSync];

        if (!v81)
        {
          id v82 = objc_alloc(MEMORY[0x1E4F1CB00]);
          v83 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSinceNow:5.0];
          v84 = (void *)[v82 initWithFireDate:v83 interval:v8 target:sel__clearUserInitiatedSyncTimer selector:0 userInfo:0 repeats:0.0];
          [(DATaskManager *)v8 setUserInitiatedSyncTimer:v84];

          long long v137 = 0u;
          long long v138 = 0u;
          long long v135 = 0u;
          long long v136 = 0u;
          v80 = runLoopModesToPerformDelayedSelectorsIn();
          uint64_t v85 = [v80 countByEnumeratingWithState:&v135 objects:v145 count:16];
          if (v85)
          {
            ...
            do
            {
              for (uint64_t j = 0; j != v85; ++j)
              {
                ...
                uint64_t v88 = *(void *)(*((void *)&v135 + 1) + 8 * j);
                v89 = [MEMORY[0x1E4F1CAC0] currentRunLoop];
                v90 = [(DATaskManager *)v8 userInitiatedSyncTimer];
                [v89 addTimer:v90 forMode:v88];
              }
              uint64_t v85 = [v80 countByEnumeratingWithState:&v135 objects:v145 count:16];
            }
            while (v85);
...
LABEL_83:
        ...
        v91 = [(DATaskManager *)v8 xpcTransactionTimer];
        ...
        if (![(DATaskManager *)v8 _hasTasksIndicatingARunningSync])
        {
          ...
          {
            v94 = [(DATaskManager *)v8 account];
            v95 = [v94 accountDescription];
            *(_DWORD *)buf = 138412290;
            id v148 = v95;
            _os_log_impl(&dword_1C86FF000, v93, type, "Pending tasks are finished for account %@", buf, 0xCu);
          }
          id v96 = objc_alloc(MEMORY[0x1E4F1CB00]);
          v97 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSinceNow:5.0];
          v98 = (void *)[v96 initWithFireDate:v97 interval:v8 target:sel__endXpcTransaction selector:0 userInfo:0 repeats:0.0];
          [(DATaskManager *)v8 setXpcTransactionTimer:v98];

          long long v133 = 0u;
          long long v134 = 0u;
          long long v131 = 0u;
          long long v132 = 0u;
          v99 = runLoopModesToPerformDelayedSelectorsIn();
          uint64_t v100 = [v99 countByEnumeratingWithState:&v131 objects:v144 count:16];
          if (v100)
          {
            ...
            do
            {
              for (uint64_t k = 0; k != v100; ++k)
              {
                ...
                uint64_t v103 = *(void *)(*((void *)&v131 + 1) + 8 * k);
                v104 = [MEMORY[0x1E4F1CAC0] currentRunLoop];
                v105 = [(DATaskManager *)v8 xpcTransactionTimer];
                [v104 addTimer:v105 forMode:v103];
              }
              uint64_t v100 = [v99 countByEnumeratingWithState:&v131 objects:v144 count:16];
            }
            while (v100);
        ...
        v106 = [(DATaskManager *)v8 powerLogIdleTimer];
        ...
        id v108 = objc_alloc(MEMORY[0x1E4F1CB00]);
        v109 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSinceNow:1.0];
        v110 = (void *)[v108 initWithFireDate:v109 interval:v8 target:sel__logSyncEnd selector:0 userInfo:0 repeats:0.0];
        [(DATaskManager *)v8 setPowerLogIdleTimer:v110];

        long long v129 = 0u;
        long long v130 = 0u;
        long long v127 = 0u;
        long long v128 = 0u;
        v111 = runLoopModesToPerformDelayedSelectorsIn();
        uint64_t v112 = [v111 countByEnumeratingWithState:&v127 objects:v143 count:16];
        if (v112)
        {
          uint64_t v113 = *(void *)v128;
          do
          {
            for (uint64_t m = 0; m != v112; ++m)
            {
              ...
              uint64_t v115 = *(void *)(*((void *)&v127 + 1) + 8 * m);
              v116 = [(DATaskManager *)v8 powerLogIdleTimer];

              if (v116)
              {
                v117 = [MEMORY[0x1E4F1CAC0] currentRunLoop];
                v118 = [(DATaskManager *)v8 powerLogIdleTimer];
                [v117 addTimer:v118 forMode:v115];
              }
            }
            uint64_t v112 = [v111 countByEnumeratingWithState:&v127 objects:v143 count:16];
          }
      ...
      case 2:
        ...
        long long v35 = [(DATaskManager *)v8 queuedExclusiveTasks];
      ...
      case 3:
        if (v29)
        {
          int v37 = [(DATaskManager *)v8 queuedModalTasks];
...
LABEL_49:
        ...
        else
        {
          ...
          __int16 v39 = [(DATaskManager *)v8 independentTasks];
          BOOL v40 = [v39 count] == 0;

          if (v40)
          {
            uint64_t v41 = [(DATaskManager *)v8 queuedModalTasks];
...
LABEL_53:
              ...
              [(DATaskManager *)v8 setActiveModalTask:v51];

              v52 = [(DATaskManager *)v8 queuedModalTasks];
              [v52 removeObjectAtIndex:0];

              int v30 = [(DATaskManager *)v8 activeModalTask];
              [(DATaskManager *)v8 _scheduleStartModal:v30];
              goto LABEL_59;
            }
          }
        }
      ...
      case 4:
        ...
        int v32 = [(DATaskManager *)v8 queuedModalTasks];
      ...
      default:
        ...
        [v30 handleFailureInMethod:a2 object:v8 file:@"DATaskManager.m" lineNumber:771 description:@"Out of bounds state"];
        goto LABEL_59;
    }
LABEL_111:
...
- (void)taskRequestModal:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v36 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:830 description:@"A nil task requested modal?"];
  }
  uint64_t v6 = DALoggingwithCategory();
  os_log_type_t v7 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 7);
  if (os_log_type_enabled(v6, v7))
  {
    int v38 = 138412290;
    id v39 = v5;
    _os_log_impl(&dword_1C86FF000, v6, v7, "Task %@ requesting modal", (uint8_t *)&v38, 0xCu);
  }
  ...
  switch([(DATaskManager *)v9 state])
  {
    case 0:
      ...
      int v32 = [(DATaskManager *)v9 activeQueuedTask];
      if (v32)
      {
      }
      else
    ...
    case 2:
      ...
      if (!v15)
      {
        ...
        [v37 handleFailureInMethod:a2 object:v9 file:@"DATaskManager.m" lineNumber:863 description:@"Only the active exclusive task can go modal immediately"];
      }
      goto LABEL_13;
    case 3:
    case 4:
    ...
    default:
      ...
      [v13 handleFailureInMethod:a2 object:v9 file:@"DATaskManager.m" lineNumber:873 description:@"Out of bounds state."];
...
LABEL_15:
      ...
      if (v10)
      {
        if (v5)
        {
          BOOL v23 = [(DATaskManager *)v9 queuedModalTasks];
          [v23 addObject:v5];
        }
        int v24 = [(DATaskManager *)v9 independentTasks];
        if ([v24 count]) {
          goto LABEL_23;
        }
        id v25 = [(DATaskManager *)v9 activeQueuedTask];
        BOOL v26 = v25 == 0;
        ...
        if (v26)
        {
          ...
          int v24 = [(DATaskManager *)v9 activeModalTask];
...
- (void)taskEndModal:(id)a3
{
  ...
  if (os_log_type_enabled(v6, v7))
  {
    *(_DWORD *)buf = 138412290;
    id v18 = v5;
    _os_log_impl(&dword_1C86FF000, v6, v7, "Task %@ ending modal", buf, 0xCu);
  }
  ...
  if ([(DATaskManager *)self state] != 5)
  {
    if ([(DATaskManager *)self state] == 4)
    {
      ...
      if (!v10)
      {
        ...
        [v16 handleFailureInMethod:a2 object:v8 file:@"DATaskManager.m" lineNumber:923 description:@"Only the active modal task can end modal behavior."];
      }
      [(DATaskManager *)v8 setActiveModalTask:0];
    ...
    {
      uint64_t v8 = [MEMORY[0x1E4F28B00] currentHandler];
      [(DATaskManager *)v8 handleFailureInMethod:a2, self, @"DATaskManager.m", 918, @"taskEndModal can only be called in Run Modal state, not %d", [(DATaskManager *)self state] object file lineNumber description];
    }
  }
}
...
- (void)_performTask:(id)a3
{
  ...
  if ([(DATaskManager *)self isShutdown])
  {
    ...
    if (os_log_type_enabled(v5, v6))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_1C86FF000, v5, v6, "The _performTask is invoked after taskManager has been shutdown. Canceling %{public}@ %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (v9)
    {
      os_log_type_t v12 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 3);
      if (os_log_type_enabled(v10, v12))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v19 = 2112;
        id v20 = v4;
        _os_log_impl(&dword_1C86FF000, v11, v12, "The device is in on-power fetch mode, but is no longer on power or on wifi. Canceling %{public}@ %@", buf, 0x16u);
      }
    ...
    {
      int v15 = *(unsigned __int8 *)(MEMORY[0x1E4F50E48] + 7);
      if (os_log_type_enabled(v10, *(os_log_type_t *)(MEMORY[0x1E4F50E48] + 7)))
      {
        *(_DWORD *)buf = 138412290;
        id v18 = v4;
        _os_log_impl(&dword_1C86FF000, v11, (os_log_type_t)v15, "performTask called on task %@", buf, 0xCu);
      }
...
- (void)_startModal:(id)a3
{
  ...
  if ([(DATaskManager *)self isShutdown])
  {
    ...
    os_log_type_t v7 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 3);
    if (os_log_type_enabled(v6, v7))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_impl(&dword_1C86FF000, v6, v7, "The _startModal is invoked after taskManager has been shutdown. Canceling %{public}@ %@", (uint8_t *)&v13, 0x16u);
    }
    [v5 cancelTaskWithReason:1 underlyingError:0];
  }
  else
  {
    if ([(DATaskManager *)self state] == 5)
    {
      ...
      [v12 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1007 description:@"Cannot handle _startModal: in Shutdown state"];
    }
    uint64_t v10 = DALoggingwithCategory();
    os_log_type_t v11 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 7);
    if (os_log_type_enabled(v10, v11))
    {
      int v13 = 138412290;
      id v14 = v5;
      _os_log_impl(&dword_1C86FF000, v10, v11, "startModal called on task %@", (uint8_t *)&v13, 0xCu);
    }
...
- (void)_reactivateHeldTasks
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      while (v5 != v7);
      uint64_t v5 = [v3 countByEnumeratingWithState:&v30 objects:v35 count:16];
    }
    while (v5);
  }

  uint64_t v10 = [(DATaskManager *)self heldIndependentTasks];
  ...
  long long v26 = 0u;
  long long v27 = 0u;
  os_log_type_t v11 = [(DATaskManager *)self modalHeldIndependentTasks];
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v17 = [(DATaskManager *)self independentTasks];
        [v17 addObject:v16];
  ...
  long long v18 = [(DATaskManager *)self modalHeldIndependentTasks];
  [v18 removeAllObjects];

  long long v19 = [(DATaskManager *)self modalHeldActiveQueuedTask];
  ...
  {
    id v20 = [(DATaskManager *)self mQueuedTasks];
    uint64_t v21 = [v20 count];

    if (v21)
    {
      int v22 = [(DATaskManager *)self mQueuedTasks];
      BOOL v23 = [v22 objectAtIndexedSubscript:0];
      [(DATaskManager *)self setActiveQueuedTask:v23];

      int v24 = [(DATaskManager *)self mQueuedTasks];
      [v24 removeObjectAtIndex:0];

      id v25 = [(DATaskManager *)self activeQueuedTask];
...
- (void)_makeStateTransition
{
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      ...
      [v69 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1038 description:@"Cannot have active queued task and active exclusive task at the same time."];
    }
    ...
    if (v7)
    {
      ...
      [v70 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1040 description:@"Cannot have running independent tasks and an active exclusive task at the same time."];
    }
  }
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      [v71 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1043 description:@"Cannot have active queued task and a modal task at the same time."];
    }
    ...
    if (v11)
    {
      ...
      [v72 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1045 description:@"Cannot have running independent tasks and a modal task at the same time."];
    }
  }
  ...
  if (os_log_type_enabled(v12, v13))
  {
    ...
    __int16 v85 = 2112;
    uint64_t v86 = v14;
    _os_log_impl(&dword_1C86FF000, v12, v13, "Task Manager %@ transitioning from state: %@", (uint8_t *)&v83, 0x16u);
  }
  switch([(DATaskManager *)self state])
  {
    case 0:
      ...
      break;
    case 1:
      int v22 = [(DATaskManager *)self activeExclusiveTask];
      ...
      break;
    case 2:
      BOOL v23 = [(DATaskManager *)self activeModalTask];

      if (v23) {
        goto LABEL_28;
      }
      int v24 = [(DATaskManager *)self activeExclusiveTask];
      ...
      break;
    case 3:
      id v25 = [(DATaskManager *)self activeModalTask];
...
LABEL_31:
        ...
        {
          uint64_t v34 = [(DATaskManager *)self activeExclusiveTask];
...
LABEL_37:
    ...
    default:
      ...
      [v21 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1103 description:@"Out of bounds state."];
  ...
  {
    uint64_t v36 = getStateName([(DATaskManager *)self state]);
    int v83 = 138412546;
    v84 = self;
    __int16 v85 = 2112;
    uint64_t v86 = v36;
    _os_log_impl(&dword_1C86FF000, v35, v13, "Task Manager %@ transitioning to state: %@", (uint8_t *)&v83, 0x16u);
  }
  switch([(DATaskManager *)self state])
  {
    case 0:
      int v37 = [(DATaskManager *)self activeExclusiveTask];

      if (v37)
      {
        uint64_t v73 = [MEMORY[0x1E4F28B00] currentHandler];
        [v73 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1111 description:@"Cannot have active exclusive task in Nominal state."];
      }
      ...
      if (v38)
      {
        ...
        [v74 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1112 description:@"Cannot have modal task in Nominal state."];
      }
      ...
      if (v40)
      {
        ...
        [v75 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1113 description:@"We shouldn't be holding independent tasks in Nominal state"];
      }
      uint64_t v41 = [(DATaskManager *)self queuedExclusiveTasks];
      uint64_t v42 = [v41 count];

      if (v42)
      {
        v76 = [MEMORY[0x1E4F28B00] currentHandler];
        [v76 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1114 description:@"We shouldn't have queued exclusive tasks in Nominal state"];
      }
      ...
      if (v44)
      {
        ...
        v46 = v45;
        uint64_t v47 = @"We shouldn't have any independent tasks that are modal in Nominal state";
        SEL v48 = a2;
        uint64_t v49 = self;
        uint64_t v50 = 1116;
        goto LABEL_52;
    ...
    case 1:
      ...
      if (v51)
      {
        ...
        [v77 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1119 description:@"Cannot have active exclusive task in Hold for Exclusive state."];
      }
      ...
      if (v52)
      {
        ...
        [v78 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1120 description:@"Should not have any modal task active in Hold for Exclusive state"];
      }
      v53 = [(DATaskManager *)self queuedExclusiveTasks];
      ...
      if (!v54)
      {
        v45 = [MEMORY[0x1E4F28B00] currentHandler];
        v46 = v45;
        uint64_t v47 = @"Should have at least one queued exclusive task in Hold for Exclusive state";
        SEL v48 = a2;
        uint64_t v49 = self;
        uint64_t v50 = 1122;
        goto LABEL_52;
      ...
      break;
    case 2:
      v55 = [(DATaskManager *)self independentTasks];
      uint64_t v56 = [v55 count];

      if (v56)
      {
        v79 = [MEMORY[0x1E4F28B00] currentHandler];
        [v79 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1125 description:@"Cannot have running independent tasks in Run Exclusive state."];
      }
      ...
      if (v57)
      {
        v45 = [MEMORY[0x1E4F28B00] currentHandler];
        v46 = v45;
        uint64_t v47 = @"Cannot have active queued task in Run Exclusive state.";
        SEL v48 = a2;
        uint64_t v49 = self;
        uint64_t v50 = 1126;
        goto LABEL_52;
    ...
    case 3:
      ...
      if (v58)
      {
        ...
        [v80 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1129 description:@"Cannot have active modal task in Hold for Modal state."];
      }
      ...
      if (!v60)
      {
        v45 = [MEMORY[0x1E4F28B00] currentHandler];
        v46 = v45;
        uint64_t v47 = @"Should have at least one queued modal task in Hold for Modal state.";
        SEL v48 = a2;
        uint64_t v49 = self;
        uint64_t v50 = 1130;
        goto LABEL_52;
      ...
      break;
    case 4:
      uint64_t v61 = [(DATaskManager *)self independentTasks];
      uint64_t v62 = [v61 count];

      if (v62)
      {
        BOOL v81 = [MEMORY[0x1E4F28B00] currentHandler];
        [v81 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1133 description:@"Should not be running other independent tasks in Run Modal state."];
      }
      v63 = [(DATaskManager *)self activeQueuedTask];

      if (v63)
      {
        id v82 = [MEMORY[0x1E4F28B00] currentHandler];
        [v82 handleFailureInMethod:a2 object:self file:@"DATaskManager.m" lineNumber:1134 description:@"Should not be running other queued task in Run Modal state."];
      }
      v64 = [(DATaskManager *)self activeExclusiveTask];

      if (v64)
      {
        v65 = [(DATaskManager *)self activeModalTask];
        ...
        if (v65 != v66)
        {
          v45 = [MEMORY[0x1E4F28B00] currentHandler];
          v46 = v45;
          uint64_t v47 = @"Only the exclusive task can currently go modal.";
          SEL v48 = a2;
          uint64_t v49 = self;
          uint64_t v50 = 1136;
          goto LABEL_52;
    ...
    default:
      v45 = [MEMORY[0x1E4F28B00] currentHandler];
      v46 = v45;
      uint64_t v47 = @"Out of bounds state.";
      SEL v48 = a2;
      uint64_t v49 = self;
      uint64_t v50 = 1142;
LABEL_52:
...
- (void)_scheduleSelector:(SEL)a3 withArgument:(id)a4
{
  ...
  uint64_t v8 = DALoggingwithCategory();
  os_log_type_t v9 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 7);
  if (os_log_type_enabled(v8, v9))
  {
    Name = sel_getName(a3);
    ...
    __int16 v17 = 2112;
    uint64_t v18 = v12;
    _os_log_impl(&dword_1C86FF000, v8, v9, "Scheduling selector: %s with argument: %@ in modes %@", (uint8_t *)&v13, 0x20u);
    if (v11 == 1) {
  }
    }
...
- (void)_scheduleStartModal:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    int v7 = 138412290;
    id v8 = v4;
    _os_log_impl(&dword_1C86FF000, v5, v6, "Scheduling modal task: %@", (uint8_t *)&v7, 0xCu);
  }
...
- (void)_cancelTasksWithReason:(int)a3
{
      ...
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        if (os_log_type_enabled(v11, v8))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v25 = 1024;
          int v26 = v3;
          _os_log_impl(&dword_1C86FF000, v11, v8, "Cancelling task %@ with reason %d", buf, 0x12u);
        }
  ...
  uint64_t v12 = [(DATaskManager *)self queuedExclusiveTasks];
...
- (void)_retainPowerAssertionForTask:(id)a3
{
  ...
  {
    uint64_t v12 = v4;
    if ((objc_opt_respondsToSelector() & 1) == 0 || (int v6 = [v12 shouldHoldPowerAssertion], v5 = v12, v6))
    {
      uint64_t v7 = [(DATaskManager *)self powerAssertionGroupID];
      os_log_type_t v8 = v7;
      if (v7)
      {
        id v9 = v7;
      ...
      {
        uint64_t v10 = [(DATaskManager *)self account];
        id v9 = [v10 persistentUUID];
      }
      uint64_t v11 = +[DAPowerAssertionManager sharedPowerAssertionManager];
