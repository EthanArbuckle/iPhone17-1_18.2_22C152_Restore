...
- (unint64_t)powerAssertionRetainCount:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"DAPowerAssertionManager.m", 61, @"%s must have a non-nil context", sel_getName(a2));
  }
  v6 = self;
  objc_sync_enter(v6);
...
- (void)retainPowerAssertion:(id)a3 withGroupIdentifier:(id)a4
{
  ...
  else
  {
    ...
    objc_msgSend(v27, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"DAPowerAssertionManager.m", 71, @"%s must have a non-nil context", sel_getName(a2));
  ...
  objc_msgSend(v28, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"DAPowerAssertionManager.m", 72, @"%s must have a non-nil group identifier", sel_getName(a2));
...
LABEL_3:
  ...
  if (os_log_type_enabled(v10, v12))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v31 = 2112;
    v32 = v9;
    _os_log_impl(&dword_1C86FF000, v10, v12, "Context %@ retaining power assertion with group identifier %@", buf, 0x16u);
  }
        ...
        v15))
  {
    ...
    if (os_log_type_enabled(v16, v17))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v31 = 2112;
      v32 = v9;
      _os_log_impl(&dword_1C86FF000, v16, v17, "Context %@ getting added to our held aside contexts, as group %@ is currently dropped", buf, 0x16u);
    }
...
- (void)releasePowerAssertion:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v24, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"DAPowerAssertionManager.m", 101, @"%s must have a non-nil context", sel_getName(a2));
  }
  v6 = DALoggingwithCategory();
  os_log_type_t v7 = *(unsigned char *)(MEMORY[0x1E4F50E48] + 6);
  if (os_log_type_enabled(v6, v7))
  {
    *(_DWORD *)buf = 138412290;
    id v26 = v5;
    _os_log_impl(&dword_1C86FF000, v6, v7, "Context %@ releasing power assertion", buf, 0xCu);
  }
...
LABEL_7:
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v11, v7))
    {
      *(_DWORD *)buf = 138412290;
      id v26 = v5;
      _os_log_impl(&dword_1C86FF000, v11, v7, "Context object %@ attempting to release power assertion without first retaining it", buf, 0xCu);
    }
    goto LABEL_7;
  }
...
- (void)dropPowerAssertionsForGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    *(_DWORD *)buf = 138412290;
    id v38 = v4;
    _os_log_impl(&dword_1C86FF000, v5, v6, "Dropping power assertion for group identifier %@", buf, 0xCu);
  }
...
- (void)reattainPowerAssertionsForGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    *(_DWORD *)buf = 138412290;
    id v38 = v4;
    _os_log_impl(&dword_1C86FF000, v5, v6, "Reattaining power assertion for group identifier %@", buf, 0xCu);
  }
...
- (BOOL)_retainAssertionForContext:(id)a3
{
  ...
  [MEMORY[0x1E4F50E38] isAppleInternalInstall];
  ...
  id v8 = (const void *)CPPowerAssertionCreate();
  ...
  {
    uint64_t v12 = [(DAPowerAssertionManager *)self contextToPowerAssertionRef];
    *(_DWORD *)buf = 138412802;
    ...
    _os_log_impl(&dword_1C86FF000, v10, v11, "DAPowerAssertionManager retained power assertion %@ for context %p, outstanding assertion count %lu", buf, 0x20u);
  }
  return v6 == 0;
}
...
- (BOOL)_releaseAssertionForContext:(id)a3
{
  ...
  if (os_log_type_enabled(v5, v6))
  {
    ...
    __int16 v14 = 1024;
    int v15 = [v7 count] - 1;
    _os_log_impl(&dword_1C86FF000, v5, v6, "DAPowerAssertionManager releasing power assertion for context %p, outstanding assertion count %u ontext", (uint8_t *)&v12, 0x12u);
  }
  id v8 = [(DAPowerAssertionManager *)self contextToPowerAssertionRef];
