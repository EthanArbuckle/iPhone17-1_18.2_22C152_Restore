...
- (DAMailMessage)initWithCoder:(id)a3
{
  ...
  {
    *(_WORD *)v7 = 0;
    _os_log_impl(&dword_1C86FF000, v4, v5, "DAMailMessage initWithCoder: should be called on a subclass only", v7, 2u);
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (os_log_type_enabled(v3, v4))
  {
    *(_WORD *)os_log_type_t v5 = 0;
    _os_log_impl(&dword_1C86FF000, v3, v4, "DAMailMessage encodeWithCoder: should be called on a subclass only", v5, 2u);
  }
}
