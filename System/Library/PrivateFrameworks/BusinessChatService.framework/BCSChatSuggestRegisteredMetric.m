...
- (NSString)coreAnalyticsEventName
{
  return (NSString *)@"com.apple.businesschatd.chatSuggestRegistered";
}
...
- (NSDictionary)coreAnalyticsPayload
{
  ...
  v10[1] = @"errorCode";
  v11[0] = v6;
  v7 = objc_msgSend(NSNumber, "numberWithInteger:", -[BCSChatSuggestRegisteredMetric errorCode](self, "errorCode"));
  v11[1] = v7;
...
{
  id v3 = a3;
  v4 = -[BCSMetric _initWithType:context:postProcessingMetricHandlers:]((id *)[BCSChatSuggestRegisteredMetric alloc], (void *)6, 0, v3);
