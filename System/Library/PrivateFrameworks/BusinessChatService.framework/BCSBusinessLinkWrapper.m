...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BCSBusinessLinkWrapper;
  v4 = [(BCSBusinessLinkWrapper *)&v8 description];
  v5 = [(BCSBusinessLinkWrapper *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  orgId = self->_orgId;
  if (orgId) {
    [v3 setObject:orgId forKey:@"orgId"];
  }
  message = self->_message;
  if (message)
  {
    v7 = [(BCSBusinessLinkMessage *)message dictionaryRepresentation];
...
LABEL_37:
      ...
      {
        v27 = objc_alloc_init(BCSBusinessLinkMessage);
        objc_storeStrong((id *)&self->_message, v27);
        if (!PBReaderPlaceMark() || (BCSBusinessLinkMessageReadFrom((uint64_t)v27, (uint64_t)a3) & 1) == 0)
        {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSString *)self->_orgId copyWithZone:a3];
  v7 = *(void **)(v5 + 24);
  *(void *)(v5 + 24) = v6;

  id v8 = [(BCSBusinessLinkMessage *)self->_message copyWithZone:a3];
  char v9 = *(void **)(v5 + 16);
  *(void *)(v5 + 16) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (!-[BCSBusinessLinkMessage isEqual:](message, "isEqual:")) {
      goto LABEL_10;
    }
  }
...
- (unint64_t)hash
{
  NSUInteger v3 = [(NSString *)self->_orgId hash];
  unint64_t v4 = [(BCSBusinessLinkMessage *)self->_message hash];
  if (*(unsigned char *)&self->_has) {
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[3])
  {
    -[BCSBusinessLinkWrapper setOrgId:](self, "setOrgId:");
    unint64_t v4 = v7;
  }
  message = self->_message;
  uint64_t v6 = v4[2];
  if (message)
  {
    ...
    -[BCSBusinessLinkMessage mergeFrom:](message, "mergeFrom:");
  }
  else
  {
    if (!v6) {
    ...
    -[BCSBusinessLinkWrapper setMessage:](self, "setMessage:");
  }
  unint64_t v4 = v7;
LABEL_9:
  if (v4[4])
