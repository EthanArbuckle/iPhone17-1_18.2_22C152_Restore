@interface BCSChatSuggestShardItem
- (BOOL)hasCount;
- (BOOL)hasFilter;
- (BOOL)hasIndex;
- (BOOL)hasTtl;
...
@implementation BCSChatSuggestShardItem
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BCSChatSuggestShardItem;
  v4 = [(BCSChatSuggestShardItem *)&v8 description];
  v5 = [(BCSChatSuggestShardItem *)self dictionaryRepresentation];
...
LABEL_5:
  ...
  {
    id v6 = v4;
    -[BCSChatSuggestShardItem setFilter:](self, "setFilter:");
    id v4 = v6;
  }
}
