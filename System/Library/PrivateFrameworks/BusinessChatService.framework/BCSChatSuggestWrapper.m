...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BCSChatSuggestWrapper;
...
LABEL_37:
      ...
      {
        v27 = objc_alloc_init(BCSChatSuggestMessage);
        objc_storeStrong((id *)&self->_message, v27);
        if (!PBReaderPlaceMark() || (BCSChatSuggestMessageReadFrom((uint64_t)v27, (uint64_t)a3) & 1) == 0)
        {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 24) = v6;
  ...
  id v8 = [(BCSChatSuggestMessage *)self->_message copyWithZone:a3];
  char v9 = *(void **)(v5 + 16);
  *(void *)(v5 + 16) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (!-[BCSChatSuggestMessage isEqual:](message, "isEqual:")) {
      goto LABEL_10;
    }
  }
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(BCSChatSuggestMessage *)self->_message hash];
  if (*(unsigned char *)&self->_has) {
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[3])
  {
    -[BCSChatSuggestWrapper setPhone:](self, "setPhone:");
    unint64_t v4 = v7;
  }
  message = self->_message;
  uint64_t v6 = v4[2];
  if (message)
  {
    ...
    -[BCSChatSuggestMessage mergeFrom:](message, "mergeFrom:");
  }
  else
  {
    if (!v6) {
    ...
    -[BCSChatSuggestWrapper setMessage:](self, "setMessage:");
  }
  unint64_t v4 = v7;
LABEL_9:
  if (v4[4])
