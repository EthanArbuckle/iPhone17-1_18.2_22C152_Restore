...
- (NSString)coreAnalyticsEventName
{
  return (NSString *)@"com.apple.businesschatd.linkRegistered";
}
...
- (NSDictionary)coreAnalyticsPayload
{
  ...
  v3 = objc_msgSend(NSNumber, "numberWithBool:", -[BCSBusinessLinkRegisteredMetric isChoppingEnabled](self, "isChoppingEnabled"));
  v13[0] = v3;
  v12[1] = @"successfulChop";
  v4 = objc_msgSend(NSNumber, "numberWithInteger:", -[BCSBusinessLinkRegisteredMetric successfulChop](self, "successfulChop"));
  v13[1] = v4;
  v12[2] = @"duration";
  v5 = NSNumber;
  ...
  v13[2] = v8;
  v12[3] = @"errorCode";
  v9 = objc_msgSend(NSNumber, "numberWithInteger:", -[BCSBusinessLinkRegisteredMetric errorCode](self, "errorCode"));
  v13[3] = v9;
...
{
  id v3 = a3;
  v4 = -[BCSMetric _initWithType:context:postProcessingMetricHandlers:]((id *)[BCSBusinessLinkRegisteredMetric alloc], (void *)3, 0, v3);
