...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_100015FF0 != -1) {
    dispatch_once(&qword_100015FF0, &stru_1000103C8);
  }
  v2 = (void *)qword_100015FF8;
  return (NSArray *)v2;
}
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = [(__CFString *)v14 isEqualToString:&stru_100010A50];
        if (v15)
        {
          v16 = v26;
        }
  ...
  if (os_log_type_enabled(obj, OS_LOG_TYPE_DEBUG)) {
    sub_100008DD4((uint64_t)v26, (uint64_t)a4, obj);
  }
  v19 = 0;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (![(NSString *)v9 isEqualToString:v8])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
      sub_100008E5C((uint64_t)v9, &self->_enablementPrefix, v10);
    }
  }
...
+ (id)sharedPrefs
{
  if (qword_100016008 != -1) {
    dispatch_once(&qword_100016008, &stru_1000103E8);
  }
  v2 = (void *)qword_100016000;
  return v2;
}
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *(_OWORD *)&result[13].var2.var0 = xmmword_10000AB10;
...
- (void)__createInternalSettings
{
  ...
  CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_100011B80, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0;
  ...
  notify_register_dispatch(EPL_STATE_CHANGED_NOTIFICATION, v30 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_TASKING_CHANGED_NOTIFICATION, (int *)v42 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_TELEMETRY_CHANGED_NOTIFICATION, v38 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_PROFILE_LIST_CHANGED_NOTIFICATION, v34 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
