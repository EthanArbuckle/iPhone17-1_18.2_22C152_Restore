...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_10001A1E0 != -1) {
    dispatch_once(&qword_10001A1E0, &stru_100014628);
  }
  v2 = (void *)qword_10001A1E8;
  return (NSArray *)v2;
}
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = [(__CFString *)v14 isEqualToString:&stru_100014DA8];
        if (v15)
        {
          v16 = v26;
        }
  ...
  if (os_log_type_enabled(obj, OS_LOG_TYPE_DEBUG)) {
    sub_10000BC28((uint64_t)v26, (uint64_t)a4, obj);
  }
  v19 = 0;
LABEL_25:
...
- (void)initNSStringProperty:(HTPrefInit *)a3
{
  ...
  {
    double v7 = shared_ht_log_handle();
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (![(NSString *)v9 isEqualToString:v8])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
      sub_10000BCB0((uint64_t)v9, &self->_enablementPrefix, v10);
    }
  }
...
+ (id)sharedPrefs
{
  if (qword_10001A1F8 != -1) {
    dispatch_once(&qword_10001A1F8, &stru_100014648);
  }
  v2 = (void *)qword_10001A1F0;
  return v2;
}
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    objc_super v4 = shared_ht_log_handle();
    ...
    *(_OWORD *)&result[13].var2.var0 = xmmword_10000DED0;
...
- (void)__createInternalSettings
{
  ...
  {
    HTPrefDefaultVal v5 = shared_ht_log_handle();
  ...
  CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_100016520, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0;
  ...
  notify_register_dispatch(EPL_STATE_CHANGED_NOTIFICATION[0], v30 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_TASKING_CHANGED_NOTIFICATION[0], (int *)v42 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_TELEMETRY_CHANGED_NOTIFICATION[0], v38 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_PROFILE_LIST_CHANGED_NOTIFICATION[0], v34 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(TEST_RESET_LOG_LIMITS_NOTIFICATION, v24 + 6, (dispatch_queue_t)self->__prefsQueue, v19);
  [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
