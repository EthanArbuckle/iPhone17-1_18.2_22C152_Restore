...
- (WLFailureViewController)initWithWelcomeController:(id)a3 context:(id)a4;
- (id)resetBlock;
...
- (WLFailureViewController)initWithWelcomeController:(id)a3 context:(id)a4
{
  ...
  v10 = [MEMORY[0x263F82670] modelSpecificLocalizedStringKeyForKey:@"FAILURE_DETAIL"];
  ...
  v40.receiver = self;
  v40.super_class = (Class)WLFailureViewController;
  ...
  if (v15)
  {
    ...
    if ([v8 isEnabled])
    {
      ...
      v18 = [(WLFailureViewController *)v15 contentView];
      [v18 addSubview:v16];

      v33 = (void *)MEMORY[0x263F08938];
      v36 = [v16 topAnchor];
      v37 = [(WLFailureViewController *)v15 contentView];
      v35 = [v37 topAnchor];
      ...
      v23 = [(WLFailureViewController *)v15 contentView];
    ...
    v29 = [(WLFailureViewController *)v15 buttonTray];
    [v29 addButton:v27];
