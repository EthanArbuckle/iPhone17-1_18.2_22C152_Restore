...
+ (id)resultWithCNContactIdentifier:(id)a3 cnContactFullname:(id)a4 suggestedContact:(BOOL)a5 matchType:(unint64_t)a6 matchTypeSuggested:(BOOL)a7 identifierOfMatchLabel:(id)a8
{
  ...
  id v14 = a4;
  id v15 = a3;
  id v16 = [[UNSCNContactResolverResult alloc] _initWithCNContactIdentifier:v15 cnContactFullname:v14 suggestedContact:v10 matchType:a6 matchTypeSuggested:v8 identifierOfMatchLabel:v13];
...
- (NSString)debugDescription
{
  return (NSString *)[(UNSCNContactResolverResult *)self descriptionWithMultilinePrefix:0];
}
...
void __68__UNSCNContactResolverResult_descriptionBuilderWithMultilinePrefix___block_invoke(uint64_t a1)
{
  ...
  id v5 = *(void **)(a1 + 32);
  BOOL v6 = [*(id *)(a1 + 40) cnContactFullname];
  ...
  BOOL v10 = *(void **)(a1 + 32);
  id v11 = objc_msgSend(*(id *)(a1 + 40), "_stringForMatchType:", objc_msgSend(*(id *)(a1 + 40), "matchType"));
...
- (id)succinctDescriptionBuilder
{
  ...
  id v4 = [(UNSCNContactResolverResult *)self cnContactIdentifier];
  id v5 = (id)[v3 appendObject:v4 withName:@"cnContactIdentifier"];

  BOOL v6 = [(UNSCNContactResolverResult *)self cnContactFullname];
  id v7 = objc_msgSend(v6, "un_logDigest");
  id v8 = (id)[v3 appendObject:v7 withName:@"cnContactFullname"];

  id v9 = (id)objc_msgSend(v3, "appendBool:withName:", -[UNSCNContactResolverResult isSuggestedContact](self, "isSuggestedContact"), @"isSuggestedContact");
  BOOL v10 = [(UNSCNContactResolverResult *)self _stringForMatchType:[(UNSCNContactResolverResult *)self matchType]];
  [v3 appendString:v10 withName:@"matchType"];

  id v11 = (id)objc_msgSend(v3, "appendBool:withName:", -[UNSCNContactResolverResult isMatchTypeSuggested](self, "isMatchTypeSuggested"), @"matchTypeSuggested");
  id v12 = [(UNSCNContactResolverResult *)self identifierOfMatchLabel];
