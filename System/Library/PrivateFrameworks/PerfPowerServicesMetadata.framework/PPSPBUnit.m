...
- (id)description
{
  ...
  v4 = [(PPSPBUnit *)&v8 description];
  v5 = [(PPSPBUnit *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSString *)self->_symbol copyWithZone:a3];
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)symbol | v4[1]) {
      char v6 = -[NSString isEqual:](symbol, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSString *)self->_symbol hash];
}
