...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PPSPBMetricType;
  v4 = [(PPSPBMetricType *)&v8 description];
  v5 = [(PPSPBMetricType *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = [NSNumber numberWithInt:self->_category];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 20) & 2) == 0 || self->_category != *((_DWORD *)v4 + 4)) {
      goto LABEL_11;
    }
  }
