...
{
  if (*((void *)a3 + 1)) {
    -[PPM2UniqueLocationsFound setActiveTreatments:](self, "setActiveTreatments:");
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return PPM2UniqueLocationsFoundReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PPM2UniqueLocationsFound;
  v4 = [(PPM2UniqueLocationsFound *)&v8 description];
  v5 = [(PPM2UniqueLocationsFound *)self dictionaryRepresentation];
...
+ (id)options
{
  if (options_once_11777 != -1) {
    dispatch_once(&options_once_11777, &__block_literal_global_11778);
  }
  v2 = (void *)options_sOptions_11779;
  return v2;
}

void __35__PPM2UniqueLocationsFound_options__block_invoke()
{
  v0 = (void *)options_sOptions_11779;
  options_sOptions_11779 = (uint64_t)&unk_1F256B0A0;
}
