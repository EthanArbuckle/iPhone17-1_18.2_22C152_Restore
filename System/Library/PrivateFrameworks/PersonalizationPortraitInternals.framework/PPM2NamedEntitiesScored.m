...
@implementation PPM2NamedEntitiesScored
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 2))
  {
    -[PPM2NamedEntitiesScored setBundleId:](self, "setBundleId:");
    id v4 = v6;
  }
...
LABEL_10:
  if (*((void *)v4 + 1))
  {
    -[PPM2NamedEntitiesScored setActiveTreatments:](self, "setActiveTreatments:");
    id v4 = v6;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return PPM2NamedEntitiesScoredReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PPM2NamedEntitiesScored;
  id v4 = [(PPM2NamedEntitiesScored *)&v8 description];
  uint64_t v5 = [(PPM2NamedEntitiesScored *)self dictionaryRepresentation];
