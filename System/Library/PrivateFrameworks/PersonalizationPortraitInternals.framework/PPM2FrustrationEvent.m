...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
      uint64_t v8 = off_1E65D9BF0[domain];
    }
...
- (id)description
{
  ...
  id v4 = [(PPM2FrustrationEvent *)&v8 description];
  id v5 = [(PPM2FrustrationEvent *)self dictionaryRepresentation];
...
+ (id)options
{
  if (options_once_19813 != -1) {
    dispatch_once(&options_once_19813, &__block_literal_global_19814);
  }
  v2 = (void *)options_sOptions_19815;
  return v2;
}

void __31__PPM2FrustrationEvent_options__block_invoke()
{
  v0 = (void *)options_sOptions_19815;
  options_sOptions_19815 = (uint64_t)&unk_1F256B140;
}
