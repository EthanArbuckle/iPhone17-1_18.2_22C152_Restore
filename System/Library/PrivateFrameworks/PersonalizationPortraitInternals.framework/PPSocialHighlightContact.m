...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    id v4 = [NSNumber numberWithBool:self->_isSignificant];
  ...
  if (*(unsigned char *)&self->_has)
  {
    uint64_t v6 = [NSNumber numberWithBool:self->_isMe];
...
- (id)description
{
  ...
  id v4 = [(PPSocialHighlightContact *)&v8 description];
  id v5 = [(PPSocialHighlightContact *)self dictionaryRepresentation];
