...
{
  if (*((void *)a3 + 1)) {
    -[PPM2UniqueNamedEntitiesFound setActiveTreatments:](self, "setActiveTreatments:");
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return PPM2UniqueNamedEntitiesFoundReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PPM2UniqueNamedEntitiesFound;
...
+ (id)options
{
  if (options_once_2327 != -1) {
    dispatch_once(&options_once_2327, &__block_literal_global_2328);
  }
  v2 = (void *)options_sOptions_2329;
  return v2;
}

void __39__PPM2UniqueNamedEntitiesFound_options__block_invoke()
{
  v0 = (void *)options_sOptions_2329;
  options_sOptions_2329 = (uint64_t)&unk_1F256B000;
}
