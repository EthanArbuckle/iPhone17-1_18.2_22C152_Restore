...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    ...
    {
      id v5 = off_1E65D6D18[donationSource];
    }
...
- (id)description
{
  ...
  id v4 = [(PPM2TopicsPerDonation *)&v8 description];
  id v5 = [(PPM2TopicsPerDonation *)self dictionaryRepresentation];
