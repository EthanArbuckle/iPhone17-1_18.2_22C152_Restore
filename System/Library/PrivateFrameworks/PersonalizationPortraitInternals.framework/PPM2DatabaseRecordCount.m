...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 3))
  {
    -[PPM2DatabaseRecordCount setTableName:](self, "setTableName:");
    v4 = v5;
  }
  if (*((void *)v4 + 1))
  {
    -[PPM2DatabaseRecordCount setActiveTreatments:](self, "setActiveTreatments:");
    v4 = v5;
  }
}
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_has) {
    uint64_t v3 = 2654435761 * self->_schemaVersion;
  }
  else {
    uint64_t v3 = 0;
  }
  NSUInteger v4 = [(NSString *)self->_tableName hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 32) & 1) == 0 || self->_schemaVersion != *((_DWORD *)v4 + 4)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if ((unint64_t)tableName | *((void *)v4 + 3) && !-[NSString isEqual:](tableName, "isEqual:")) {
    goto LABEL_11;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v7 = [(NSString *)self->_tableName copyWithZone:a3];
  v8 = (void *)v6[3];
  v6[3] = v7;
...
- (BOOL)readFrom:(id)a3
{
  return PPM2DatabaseRecordCountReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    id v4 = [NSNumber numberWithUnsignedInt:self->_schemaVersion];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PPM2DatabaseRecordCount;
  id v4 = [(PPM2DatabaseRecordCount *)&v8 description];
  id v5 = [(PPM2DatabaseRecordCount *)self dictionaryRepresentation];
