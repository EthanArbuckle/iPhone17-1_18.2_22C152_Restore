...
{
  if (*((void *)a3 + 1)) {
    -[PPM2DeviceStats setActiveTreatments:](self, "setActiveTreatments:");
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return PPM2DeviceStatsReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)PPM2DeviceStats;
...
+ (id)options
{
  if (options_once_1000 != -1) {
    dispatch_once(&options_once_1000, &__block_literal_global_1001);
  }
  v2 = (void *)options_sOptions_1002;
  return v2;
}

void __26__PPM2DeviceStats_options__block_invoke()
{
  v0 = (void *)options_sOptions_1002;
  options_sOptions_1002 = (uint64_t)&unk_1F256AFB0;
}
