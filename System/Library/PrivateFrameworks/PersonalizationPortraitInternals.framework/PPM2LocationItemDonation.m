...
@implementation PPM2LocationItemDonation
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 4))
  {
    -[PPM2LocationItemDonation setGroupId:](self, "setGroupId:");
    id v4 = v7;
  }
  ...
  if (*((void *)v4 + 2))
  {
    -[PPM2LocationItemDonation setActiveTreatments:](self, "setActiveTreatments:");
    id v4 = v7;
  }
...
- (BOOL)readFrom:(id)a3
{
  return PPM2LocationItemDonationReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(unsigned char *)&self->_has & 4) != 0)
  {
    ...
    {
      char v5 = off_1E65D41C0[donationSource];
    }
  ...
  if ((has & 2) != 0)
  {
    ...
    {
      uint64_t v10 = off_1E65D4288[algorithm];
    }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PPM2LocationItemDonation;
  id v4 = [(PPM2LocationItemDonation *)&v8 description];
  char v5 = [(PPM2LocationItemDonation *)self dictionaryRepresentation];
