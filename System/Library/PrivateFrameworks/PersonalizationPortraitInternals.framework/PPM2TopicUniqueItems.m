...
- (id)description
{
  ...
  v5 = [(PPM2TopicUniqueItems *)self dictionaryRepresentation];
...
+ (id)options
{
  if (options_once_2268 != -1) {
    dispatch_once(&options_once_2268, &__block_literal_global_2269);
  }
  v2 = (void *)options_sOptions_2270;
  return v2;
}

void __31__PPM2TopicUniqueItems_options__block_invoke()
{
  v0 = (void *)options_sOptions_2270;
  options_sOptions_2270 = (uint64_t)&unk_1F256AFD8;
}
