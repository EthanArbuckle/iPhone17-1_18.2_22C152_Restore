...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[PPM2NamedEntityInitialDonation setActiveTreatments:](self, "setActiveTreatments:");
    id v4 = v6;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return PPM2NamedEntityInitialDonationReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    {
      uint64_t v8 = off_1E65D7638[algorithm];
    }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)PPM2NamedEntityInitialDonation;
  id v4 = [(PPM2NamedEntityInitialDonation *)&v8 description];
  uint64_t v5 = [(PPM2NamedEntityInitialDonation *)self dictionaryRepresentation];
