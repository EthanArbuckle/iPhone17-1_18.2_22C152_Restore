...
void __50__TVPStateMachine_initWithName_initialState_mode___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, void *a6, void *a7)
{
  id v17 = a6;
  id v11 = a7;
  v12 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithObjectsAndKeys:", a3, @"TVPStateMachineOldStateKey", a4, @"TVPStateMachineNewStateKey", 0);
  if (v17) {
...
- (TVPStateMachine)initWithName:(id)a3 initialState:(id)a4 mode:(int64_t)a5
{
  ...
  v10 = (void *)MEMORY[0x237E144A0](&v13);
  id v11 = -[TVPStateMachine initWithName:initialState:mode:stateChangeHandler:](self, "initWithName:initialState:mode:stateChangeHandler:", v8, v9, a5, v10, v13, v14, v15, v16);
          ...
          if (v16)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                [(TVPStateMachine *)self registerHandlerForEvent:v14 onState:*(void *)(*((void *)&v23 + 1) + 8 * v19++) withBlock:v9];
              }
              while (v17 != v19);
...
- (void)registerDefaultHandlerForEvent:(id)a3 withBlock:(id)a4
{
  ...
  if ([(TVPStateMachine *)self shouldAcceptEvents])
  {
    id v8 = [(TVPStateMachine *)self logObject];

    if (v8)
    {
      id v9 = [(TVPStateMachine *)self logObject];
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        name = self->_name;
        int v14 = 138412290;
        id v15 = name;
        _os_log_impl(&dword_236FC5000, v9, OS_LOG_TYPE_DEFAULT, "State machine [%@] can not register default handlers when it is accepting events", (uint8_t *)&v14, 0xCu);
      }
    }
  }
  else
...
- (void)postEvent:(id)a3 withContext:(id)a4 userInfo:(id)a5
{
  ...
  {
    uint64_t v11 = [(TVPStateMachine *)self ignorableEvents];
    int v12 = [v11 containsObject:v8];

    if (!v12)
    {
      uint64_t v16 = [MEMORY[0x263EFF9A0] dictionaryWithObject:v8 forKey:@"TVPStateMachineEventKey"];
      int v14 = v16;
      if (v9) {
      ...
      uint64_t v17 = self->_events;
      objc_sync_enter(v17);
      [(NSMutableArray *)self->_events addObject:v14];
      BOOL v18 = [(NSMutableArray *)self->_events count] == 1;
      objc_sync_exit(v17);

      uint64_t v19 = [(TVPStateMachine *)self logObject];
      id v20 = v19;
      if (v18)
      {
        ...
        if (v20)
        {
          ...
          {
            id v22 = [(TVPStateMachine *)self name];
            int v24 = 138412546;
            long long v25 = v22;
            __int16 v26 = 2112;
            id v27 = v8;
            _os_log_impl(&dword_236FC5000, v21, OS_LOG_TYPE_DEFAULT, "State machine [%@] received event [%@], initiating event processing", (uint8_t *)&v24, 0x16u);
          }
        }
      ...
      else
      {
        ...
        {
          long long v23 = [(TVPStateMachine *)self name];
          int v24 = 138412546;
          long long v25 = v23;
          __int16 v26 = 2112;
          id v27 = v8;
          _os_log_impl(&dword_236FC5000, v20, OS_LOG_TYPE_DEFAULT, "State machine [%@] received event [%@], but existing events are pending.  Adding to queue.", (uint8_t *)&v24, 0x16u);
        }
      }
      goto LABEL_20;
    }
    uint64_t v13 = [(TVPStateMachine *)self logObject];

    if (v13)
    {
      int v14 = [(TVPStateMachine *)self logObject];
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        id v15 = [(TVPStateMachine *)self name];
        int v24 = 138412546;
        long long v25 = v15;
        __int16 v26 = 2112;
        id v27 = v8;
        _os_log_impl(&dword_236FC5000, v14, OS_LOG_TYPE_DEFAULT, "State machine named [%@] received ignorable event [%@]", (uint8_t *)&v24, 0x16u);
      }
LABEL_20:
    }
  }
...
- (void)_processEvent:(id)a3
{
  ...
  if (v20)
  {
    ...
    do
    {
      id v5 = [v4 objectForKey:@"TVPStateMachineEventKey"];
      id v6 = [v4 objectForKey:@"TVPStateMachineUserInfoKey"];
      id v7 = [v4 objectForKey:@"TVPStateMachineContextKey"];
      id v8 = [(TVPStateMachine *)self _eventHandlerForEvent:v5];
      id v9 = [(TVPStateMachine *)self logObject];
      BOOL v10 = v9 == 0;

      if (!v10)
      {
        uint64_t v11 = [(TVPStateMachine *)self logObject];
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
        {
          name = self->_name;
          uint64_t v13 = [(TVPStateMachine *)self currentState];
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v25 = 2112;
          __int16 v26 = v13;
          _os_log_impl(&dword_236FC5000, v11, OS_LOG_TYPE_DEFAULT, "State machine [%@] processing event [%@] in state [%@]", buf, 0x20u);
        }
      }
      int v14 = self;
      objc_sync_enter(v14);
      ...
      id v15 = ((void (**)(void, TVPStateMachine *, void *, void *, void *))v8)[2](v8, v14, v5, v7, v6);
      uint64_t v16 = v14;
      objc_sync_enter(v16);
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[TVPStateMachine registerHandlerForEvent:onState:withBlock:](self, "registerHandlerForEvent:onState:withBlock:", v8, *(void *)(*((void *)&v16 + 1) + 8 * v15++), v10, (void)v16);
        }
        while (v13 != v15);
...
LABEL_15:
  ...
  id v11 = [(TVPStateMachine *)self logObject];

  if (v11)
  {
    uint64_t v12 = [(TVPStateMachine *)self logObject];
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      name = self->_name;
      int v18 = 138412290;
      long long v19 = name;
      _os_log_impl(&dword_236FC5000, v12, OS_LOG_TYPE_DEFAULT, "State machine [%@] can not register event handlers when it is accepting events", (uint8_t *)&v18, 0xCu);
    }
  }
LABEL_16:
}
...
- (void)_transitionToState:(id)a3 withEvent:(id)a4 context:(id)a5 userInfo:(id)a6
{
  ...
  id v12 = a5;
  id v13 = a6;
  uint64_t v14 = [(TVPStateMachine *)self currentState];
  uint64_t v15 = (void *)[v14 copy];

  if ([v15 isEqualToString:v10])
  {
    long long v16 = [(TVPStateMachine *)self logObject];

    if (v16)
    {
      long long v17 = [(TVPStateMachine *)self logObject];
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v37 = 2112;
        id v38 = v11;
        _os_log_impl(&dword_236FC5000, v17, OS_LOG_TYPE_DEFAULT, "State machine [%@] remaining at state [%@] on event [%@]", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    long long v19 = [(TVPStateMachine *)self logObject];

    if (v19)
    {
      uint64_t v20 = [(TVPStateMachine *)self logObject];
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        __int16 v37 = 2112;
        id v38 = v10;
        _os_log_impl(&dword_236FC5000, v20, OS_LOG_TYPE_DEFAULT, "State machine [%@] transitioning from state [%@] to [%@]", buf, 0x20u);
      }
    }
    stateChangeHandler = (void (**)(id, TVPStateMachine *, void *, id, id, id, id))self->_stateChangeHandler;
    if (stateChangeHandler)
    {
      ...
      else
      {
        ...
        __int16 v25 = __74__TVPStateMachine_Private___transitionToState_withEvent_context_userInfo___block_invoke;
        __int16 v26 = &unk_264CC5278;
        uint64_t v27 = self;
        id v28 = v15;
        id v29 = v10;
        id v30 = v11;
  ...
  [(TVPStateMachine *)self _executePostTransitionBlocks];
}
...
- (id)_eventHandlerForEvent:(id)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v7 = [(TVPStateMachine *)self currentState];
  ...
  if (v9) {
    ...
    long long v10 = &__block_literal_global_4;
  }
  long long v11 = (void *)MEMORY[0x237E144A0](v10);
...
- (TVPStateMachine)initWithName:(id)a3 initialState:(id)a4 mode:(int64_t)a5 stateChangeHandler:(id)a6
{
  ...
  id v12 = a6;
  v31.receiver = self;
  v31.super_class = (Class)TVPStateMachine;
  id v13 = [(TVPStateMachine *)&v31 init];
  if (!v13)
  {
LABEL_10:
    uint64_t v27 = v13;
  ...
  if ([v10 length] && objc_msgSend(v11, "length"))
  {
    ...
    {
      id v24 = (id)[v12 copy];
      uint64_t v25 = MEMORY[0x237E144A0]();
    ...
    objc_storeStrong((id *)&v13->_logObject, &_os_log_internal);
    if (a5 == 1)
    {
...
uint64_t __74__TVPStateMachine_Private___transitionToState_withEvent_context_userInfo___block_invoke(uint64_t a1)
{
...
{
  id v6 = a3;
  objc_storeStrong((id *)&self->_loggingComponent, a3);
  if ([(NSString *)self->_loggingComponent length]) {
    os_log_t v5 = os_log_create("com.apple.AppleTV.playback", [(NSString *)self->_loggingComponent UTF8String]);
  }
  else {
    os_log_t v5 = 0;
  }
...
- (unint64_t)eventCount
{
  id v3 = self->_events;
  objc_sync_enter(v3);
  unint64_t v4 = [(NSMutableArray *)self->_events count];
  objc_sync_exit(v3);
...
- (void)registerStateTransitionFromState:(id)a3 onEvent:(id)a4 toState:(id)a5
{
  ...
  if (![(TVPStateMachine *)self shouldAcceptEvents])
  {
    ...
    v14[3] = &unk_264CC5250;
    long long v15 = v10;
    [(TVPStateMachine *)self registerHandlerForEvent:v9 onState:v8 withBlock:v14];
    long long v12 = v15;
LABEL_6:
  ...
  if (v11)
  {
    long long v12 = [(TVPStateMachine *)self logObject];
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      name = self->_name;
      *(_DWORD *)buf = 138412290;
      uint64_t v17 = name;
      _os_log_impl(&dword_236FC5000, v12, OS_LOG_TYPE_DEFAULT, "State machine [%@] can not register state transitions when it is accepting events", buf, 0xCu);
    }
    goto LABEL_6;
  }
LABEL_7:
...
id __68__TVPStateMachine_registerStateTransitionFromState_onEvent_toState___block_invoke(uint64_t a1)
{
  return *(id *)(a1 + 32);
}
...
- (void)executeBlockAfterCurrentStateTransition:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (handlingEvent)
    {
      uint64_t v7 = v5->_blocksToExecuteAfterStateTransition;
      objc_sync_enter(v7);
...
- (void)logUnhandledEvents
{
  ...
  id v3 = objc_msgSend(v35, "sortedArrayUsingSelector:");
  unint64_t v4 = [MEMORY[0x263EFF9C0] set];
  long long v57 = 0u;
  long long v58 = 0u;
  long long v59 = 0u;
  long long v60 = 0u;
  ...
  long long v49 = 0u;
  long long v50 = 0u;
  long long v15 = [(NSMutableDictionary *)self->_defaultHandlers allKeys];
        ...
        if (v25)
        {
          ...
          do
          {
            for (uint64_t m = 0; m != v26; ++m)
            {
              ...
              objc_super v31 = [v30 objectForKey:v23];
              ...
              if (!v31)
              {
                ...
                if (!v32)
                {
                  uint64_t v33 = [(TVPStateMachine *)self logObject];
                  ...
                  if (v33)
                  {
                    ...
                    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
                    {
                      *(_DWORD *)buf = 138412546;
                      ...
                      __int16 v63 = 2112;
                      uint64_t v64 = v29;
                      _os_log_impl(&dword_236FC5000, v34, OS_LOG_TYPE_INFO, "[%@] is unhandled for [%@]", buf, 0x16u);
                    }
                  }
                }
              }
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_loggingComponent, 0);
...
{
  v2 = [*(id *)(a1 + 32) objectForKey:@"TVPStateMachineEventKey"];
  id v3 = [*(id *)(a1 + 32) objectForKey:@"TVPStateMachineUserInfoKey"];
  id v4 = [*(id *)(a1 + 32) objectForKey:@"TVPStateMachineContextKey"];
...
uint64_t __43__TVPStateMachine_Private___dispatchEvent___block_invoke_2(uint64_t a1)
{
