...
- (BOOL)synchronizeFollowUpsForAccount:(id)a3 error:(id *)a4
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      -[AKFollowUpSynchronizer synchronizeFollowUpsForAccount:error:](v7);
    }
...
- (BOOL)synchronizeFollowUpsForAccount:(id)a3 inStore:(id)a4 error:(id *)a5
{
  ...
  if ([(AKFollowUpSynchronizer *)self shouldSynchronizeForAccount:v8])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR)) {
      -[AKFollowUpSynchronizer synchronizeFollowUpsForAccount:inStore:error:](v8, v10);
    }
  ...
  {
    objc_msgSend(MEMORY[0x1E4F28C58], "ak_errorWithCode:", -7064);
    char v15 = 0;
...
- (BOOL)shouldSynchronizeForAccount:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)((char *)&buf + 4) = v11;
      _os_log_impl(&dword_193494000, v10, OS_LOG_TYPE_DEFAULT, "Last follow up refresh occured %@ seconds ago", (uint8_t *)&buf, 0xCu);
    }
    if (v9 < 86400.0)
    {
      ...
      else
      {
        ...
        {
          LOWORD(buf) = 0;
          _os_log_impl(&dword_193494000, v14, OS_LOG_TYPE_DEFAULT, "Checking for sparse follow ups", (uint8_t *)&buf, 2u);
        }
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR)) {
            -[AKFollowUpSynchronizer shouldSynchronizeForAccount:](v18);
          }
        ...
        else
        {
          ...
          *((void *)&buf + 1) = &buf;
          ...
          v26[1] = 3221225472;
          v26[2] = __54__AKFollowUpSynchronizer_shouldSynchronizeForAccount___block_invoke;
          v26[3] = &unk_1E5761B68;
          v26[4] = &buf;
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)v28 = 138412290;
            v29 = v22;
            _os_log_impl(&dword_193494000, v21, OS_LOG_TYPE_DEFAULT, "Sparse followup item detected: %@", v28, 0xCu);
          }
...
LABEL_13:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      LODWORD(buf) = 138412290;
      *(void *)((char *)&buf + 4) = v24;
      _os_log_impl(&dword_193494000, v23, OS_LOG_TYPE_DEFAULT, "Will synchronize followups %@", (uint8_t *)&buf, 0xCu);
    }
  }
  else
  {
...
void __54__AKFollowUpSynchronizer_shouldSynchronizeForAccount___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v11 = a2;
  id v6 = [v11 actions];
  if ([v6 count])
...
+ (void)updateSynchronizeTimeNoSaveForAccount:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    id v7 = v3;
    _os_log_impl(&dword_193494000, v4, OS_LOG_TYPE_DEFAULT, "Updating follow up synchronization for %@", (uint8_t *)&v6, 0xCu);
  }
...
- (void)synchronizeFollowUpsForAccount:(os_log_t)log error:.cold.1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_193494000, log, OS_LOG_TYPE_ERROR, "AKFollowUpSynchronizer: Client provided nil account, defaulting to the primary iCloud account", v1, 2u);
}
...
- (void)synchronizeFollowUpsForAccount:(void *)a1 inStore:(NSObject *)a2 error:.cold.1(void *a1, NSObject *a2)
{
  ...
  int v6 = [v5 altDSIDForAccount:a1];
  int v7 = 138478083;
  uint64_t v8 = v4;
  __int16 v9 = 2113;
  uint64_t v10 = v6;
  _os_log_error_impl(&dword_193494000, a2, OS_LOG_TYPE_ERROR, "Sync for account: %{private}@ - %{private}@", (uint8_t *)&v7, 0x16u);
}

- (void)shouldSynchronizeForAccount:(os_log_t)log .cold.1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_193494000, log, OS_LOG_TYPE_ERROR, "Failed to fetch items, falling back to sync", v1, 2u);
}
...
void __66__AKFollowUpSynchronizer_updateSynchronizeTimeForAccount_inStore___block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_193494000, a2, OS_LOG_TYPE_ERROR, "Failed to update follow up synchronization date: %@", (uint8_t *)&v2, 0xCu);
}
