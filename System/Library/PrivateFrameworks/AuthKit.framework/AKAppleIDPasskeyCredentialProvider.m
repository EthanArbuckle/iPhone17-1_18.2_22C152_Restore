...
- (AKAppleIDPasskeyCredentialProvider)initWithAuthorizationController:(id)a3
{
  ...
  *(Class *)((char *)&self->super.isa + OBJC_IVAR___AKAppleIDPasskeyCredentialProvider_authorizationController) = (Class)a3;
  v7.receiver = self;
...
- (AKAppleIDPasskeyCredentialProvider)init
{
  result = (AKAppleIDPasskeyCredentialProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
