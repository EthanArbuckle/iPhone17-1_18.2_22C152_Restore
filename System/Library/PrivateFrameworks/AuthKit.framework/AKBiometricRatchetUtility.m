...
LABEL_10:
  ...
  v16 = [[AKRatchetStateData alloc] initWithDuration:v4];
  v17 = [[AKRatchetState alloc] initWithRawState:v7 data:v16];
...
+ (unint64_t)armingMethodFromRatchetResult:(id)a3
{
  id v3 = a3;
  objc_opt_class();
  id v4 = [v3 objectForKeyedSubscript:&unk_1EE43E9F8];
  ...
  objc_opt_class();
  id v6 = [v3 objectForKeyedSubscript:&unk_1EE43EA10];
  if (objc_opt_isKindOfClass()) {
    id v7 = v6;
  }
  else {
...
{
  id v3 = a3;
  id v4 = [v3 objectForKeyedSubscript:&unk_1EE43EA28];
  ...
  unint64_t v8 = [[AKBiometricRatchetResult alloc] initWithRatchetState:v7 armingMethod:v6];
...
+ (id)resultForNonArmingFromError:(id)a3
{
  id v3 = a3;
  id v4 = [v3 userInfo];
  CFStringRef v5 = [v4 objectForKeyedSubscript:*MEMORY[0x1E4F30B40]];
  ...
  else
  {
    ...
    unint64_t v8 = [[AKBiometricRatchetResult alloc] initWithRatchetState:v7 armingMethod:1];
  }
...
+ (void)setRatchetIdentifier:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  __int16 v3 = 1024;
  int v4 = 107;
  _os_log_debug_impl(&dword_193494000, log, OS_LOG_TYPE_DEBUG, "%s (%d) called", (uint8_t *)&v1, 0x12u);
}
...
+ (void)resultForSuccessfulArmingFromResponse:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_193494000, a2, OS_LOG_TYPE_DEBUG, "Ratchet is armed with state: %@", (uint8_t *)&v2, 0xCu);
}

+ (void)resultForNonArmingFromError:(os_log_t)log .cold.1(os_log_t log)
{
  *(_WORD *)int v1 = 0;
  _os_log_debug_impl(&dword_193494000, log, OS_LOG_TYPE_DEBUG, "User selected Quick Exit, calling exit(0) on purpose", v1, 2u);
}
...
+ (void)resultForNonArmingFromError:(os_log_t)log .cold.2(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v5 = 2112;
  uint64_t v6 = a2;
  _os_log_debug_impl(&dword_193494000, log, OS_LOG_TYPE_DEBUG, "Ratchet is not armed - error: %@, ratchet state: %@", (uint8_t *)&v3, 0x16u);
}
