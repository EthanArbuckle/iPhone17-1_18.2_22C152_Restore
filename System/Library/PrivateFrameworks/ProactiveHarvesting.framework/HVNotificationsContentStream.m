...
{
  id v4 = a3;
  id v5 = [(HVNotificationsContentStream *)self initWithStreamIdentifier:v4 eventClass:objc_opt_class()];
...
- (HVNotificationsContentStream)init
{
  ...
  uint64_t v7 = [(HVNotificationsContentStream *)self initWithStreamIdentifier:v6 eventClass:objc_opt_class()];
