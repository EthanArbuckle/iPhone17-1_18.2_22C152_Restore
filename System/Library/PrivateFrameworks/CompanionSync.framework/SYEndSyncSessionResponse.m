...
- (id)dictionaryRepresentation
{
  ...
  {
    v9 = [NSNumber numberWithBool:self->_didRollback];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 8) = v10;
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(unsigned char *)(v5 + 32) = self->_didRollback;
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has) {
    uint64_t v6 = 2654435761 * self->_didRollback;
  }
  else {
    uint64_t v6 = 0;
  }
...
LABEL_7:
  ...
  else
  {
    ...
    error = (SYErrorInfo *)-[SYEndSyncSessionResponse setError:](self, "setError:");
  }
  id v4 = v9;
LABEL_15:
  if (*((unsigned char *)v4 + 36))
  {
    self->_didRollback = *((unsigned char *)v4 + 32);
    *(unsigned char *)&self->_has |= 1u;
  }
