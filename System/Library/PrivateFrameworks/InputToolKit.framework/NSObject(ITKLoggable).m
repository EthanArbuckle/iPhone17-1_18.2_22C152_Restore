...
- (uint64_t)ITK_loggingIdentifier;
@end
...
- (id)ITK_loggingDescription
{
  if ([a1 conformsToProtocol:&unk_2702FD5E8]) {
    objc_msgSend((id)objc_opt_class(), "ITK_loggingDescriptionFromLoggable:isPretty:", a1, 0);
  }
  else {
  v2 = [a1 description];
  }
...
{
  if ([a1 conformsToProtocol:&unk_2702FD5E8]) {
    objc_msgSend((id)objc_opt_class(), "ITK_loggingDescriptionFromLoggable:isPretty:", a1, 1);
  }
  else {
  v2 = [a1 description];
  }
...
+ (id)ITK_loggingDescriptionFromLoggable:()ITKLoggable isPretty:
{
  ...
  v10 = objc_msgSend(v5, "ITK_loggingIdentifier");
  if (!v10)
  {
...
LABEL_3:
  ...
  v11 = @"\t%@ = %@\n";
LABEL_6:
  v12 = objc_msgSend(v5, "ITK_loggingValues");
