...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[IXPromisedOutOfBandStreamingZipTransferSeed archiveBytesConsumed](self, "archiveBytesConsumed", v9.receiver, v9.super_class));
  [v4 encodeObject:v5 forKey:@"archiveBytesConsumed"];

  v6 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[IXPromisedOutOfBandStreamingZipTransferSeed archiveSizeBytes](self, "archiveSizeBytes"));
