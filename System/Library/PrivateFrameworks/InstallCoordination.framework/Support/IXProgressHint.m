...
LABEL_16:
  ...
  else
  {
    ...
    BOOL v24 = sub_100008DF0(v22, v23);
    ...
    BOOL v27 = sub_100008DF0(v25, v26);
    ...
    if (!v27
      || ([(IXProgressHint *)self installingPhaseProportion],
          ...
          BOOL v30 = sub_100008DF0(v28, v29),
          v29,
          v28,
          !v30))
    {
...
- (NSDictionary)progressProportionsDictionaryForLaunchServices
{
  ...
  unint64_t v4 = [(IXProgressHint *)self loadingPhaseProportion];
  if (v4) {
    [v3 setObject:v4 forKey:&off_1000F4B68];
  }

  v5 = [(IXProgressHint *)self installingPhaseProportion];
  if (v5) {
    [v3 setObject:v5 forKey:&off_1000F4B80];
  }

  unint64_t v6 = [(IXProgressHint *)self postProcessingPhaseProportion];
  if (v6) {
    [v3 setObject:v6 forKey:&off_1000F4B98];
  }
...
- (BOOL)setPhaseProportionsForLoadingPhase:(id)a3 installingPhase:(id)a4 postProcessingPhase:(id)a5 error:(id *)a6
{
  ...
  else if (v13 >= 0.0)
  {
    if (v15 >= 0.0)
    {
      ...
      BOOL v24 = sub_100004B28((uint64_t)off_100109BB8);
    ...
    {
      objc_super v23 = sub_100004B28((uint64_t)off_100109BB8);
  ...
  sub_10003DAE4((uint64_t)"-[IXProgressHint setPhaseProportionsForLoadingPhase:installingPhase:postProcessingPhase:error:]", v20, @"IXErrorDomain", 0x37uLL, 0, 0, v19, v18, v38);
...
- (id)description
{
  ...
  unint64_t v6 = [(IXProgressHint *)self installingPhaseProportion];
  id v7 = [(IXProgressHint *)self postProcessingPhaseProportion];
  unint64_t v8 = +[NSString stringWithFormat:@"<%@ loading:%@ installing:%@ postprocessing:%@>", v4, v5, v6, v7];
