...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      objc_super v5 = v4;
      unsigned int v6 = [(IXUninstallOptions *)self requestUserConfirmation];
...
LABEL_32:
          _os_log_impl((void *)&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "%s: Property %s did not match", (uint8_t *)&v18, 0x16u);
        }
LABEL_33:
...
LABEL_34:
      ...
      unsigned int v9 = [(IXUninstallOptions *)self waitForDeletion];
      if (v9 == [(IXUninstallOptions *)v5 waitForDeletion])
      {
        unsigned int v10 = [(IXUninstallOptions *)self showArchiveOption];
        ...
        unsigned int v11 = [(IXUninstallOptions *)self showDemotionOption];
        ...
        unsigned int v12 = [(IXUninstallOptions *)self waitForDeletion];
        if (v12 == [(IXUninstallOptions *)v5 waitForDeletion])
        {
          unsigned int v13 = [(IXUninstallOptions *)self systemAppNotAllowed];
          if (v13 == [(IXUninstallOptions *)v5 systemAppNotAllowed])
          {
            unsigned int v14 = [(IXUninstallOptions *)self ignoreRemovability];
            if (v14 == [(IXUninstallOptions *)v5 ignoreRemovability])
            {
              unsigned int v15 = [(IXUninstallOptions *)self ignoreRestrictions];
              if (v15 == [(IXUninstallOptions *)v5 ignoreRestrictions])
              {
                unsigned int v16 = [(IXUninstallOptions *)self ignoreAppProtection];
