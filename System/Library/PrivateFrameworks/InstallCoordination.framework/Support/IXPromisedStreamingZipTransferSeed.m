...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = +[NSNumber numberWithUnsignedLongLong:[(IXPromisedStreamingZipTransferSeed *)self archiveBytesConsumed]];
  [v4 encodeObject:v5 forKey:@"archiveBytesConsumed"];

  v6 = +[NSNumber numberWithUnsignedLongLong:[(IXPromisedStreamingZipTransferSeed *)self archiveSizeBytes]];
