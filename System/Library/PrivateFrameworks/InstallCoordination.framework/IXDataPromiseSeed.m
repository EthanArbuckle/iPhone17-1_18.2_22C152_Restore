...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v6 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[IXDataPromiseSeed creatorIdentifier](self, "creatorIdentifier"));
  ...
  objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", -[IXDataPromiseSeed totalBytesNeededOnDisk](self, "totalBytesNeededOnDisk"));
