...
- (IXPlaceholderSeed)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_installType = [v10 unsignedLongLongValue];

    if ([v4 containsValueForKey:@"placeholderType"])
    {
      v11 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"placeholderType"];
      v5->_placeholderType = [v11 unsignedLongLongValue];
    }
    else
    {
      int v12 = [v4 decodeBoolForKey:@"isPlugin"];
      uint64_t v13 = 1;
      if (v12) {
        uint64_t v13 = 2;
      }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v7 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[IXPlaceholderSeed installType](self, "installType"));
  [v4 encodeObject:v7 forKey:@"installType"];

  uint64_t v8 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[IXPlaceholderSeed placeholderType](self, "placeholderType"));
