...
- (SGMContactResultInSpotlight)init
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SGMContactResultInSpotlight;
  ...
  if (v2)
  {
    ...
    uint64_t v6 = [v4 initWithFeatureId:@"Found" event:@"ContactResultInSpotlight" registerProperties:v5 propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
