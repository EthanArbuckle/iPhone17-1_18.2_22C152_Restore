...
- (SGMEventResultInSpotlight)init
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SGMEventResultInSpotlight;
  v2 = [(SGMEventResultInSpotlight *)&v9 init];
  if (v2)
  {
    v3 = [MEMORY[0x1E4F93720] freeValuedPropertyWithName:@"Visible"];
    id v4 = objc_alloc(MEMORY[0x1E4F93738]);
    v10[0] = v3;
    v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v10 count:1];
    uint64_t v6 = [v4 initWithFeatureId:@"Found" event:@"EventResultInSpotlight" registerProperties:v5 propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
