...
- (id)description
{
  ...
  id v4 = [(SGM2ContactDetailConfirmed *)&v8 description];
  uint64_t v5 = [(SGM2ContactDetailConfirmed *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"ContactDetailConfirmed";
  }
}
