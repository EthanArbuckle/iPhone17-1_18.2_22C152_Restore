@interface SGMCNtoSGContactsCacheHit
...
- (SGMCNtoSGContactsCacheHit)init
{
  ...
  v2 = [(SGMCNtoSGContactsCacheHit *)&v9 init];
  if (v2)
  {
    ...
    uint64_t v6 = [v4 initWithFeatureId:@"Found" event:@"CNtoSGContactsCacheHit" registerProperties:v5 propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
