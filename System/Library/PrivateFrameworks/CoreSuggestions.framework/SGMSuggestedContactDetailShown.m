@interface SGMSuggestedContactDetailShown
- (PETScalarEventTracker)tracker;
- (SGMSuggestedContactDetailShown)init;
- (void)trackEventWithScalar:(unint64_t)a3 app:(SGMContactDetailUsedApp_)a4;
@end

@implementation SGMSuggestedContactDetailShown
...
- (SGMSuggestedContactDetailShown)init
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SGMSuggestedContactDetailShown;
  v2 = [(SGMSuggestedContactDetailShown *)&v9 init];
  if (v2)
  {
    ...
    uint64_t v6 = [v4 initWithFeatureId:@"Found" event:@"SuggestedContactDetailShown" registerProperties:v5 propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
