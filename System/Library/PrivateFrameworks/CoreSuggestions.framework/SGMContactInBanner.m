...
- (SGMContactInBanner)init
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)SGMContactInBanner;
  ...
  if (v2)
  {
    ...
    uint64_t v10 = [v8 initWithFeatureId:@"Found" event:@"ContactInBanner" registerProperties:v9 propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
