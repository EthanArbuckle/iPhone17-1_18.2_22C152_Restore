...
- (SGMContactDetailRejected)init
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)SGMContactDetailRejected;
  ...
  if (v2)
  {
    ...
    uint64_t v8 = [v6 initWithFeatureId:@"Found" event:@"ContactDetailRejected" registerProperties:v7 propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
