...
{
  v7.receiver = self;
  v7.super_class = (Class)SGMContactOpportunityInSpotlight;
  v2 = [(SGMContactOpportunityInSpotlight *)&v7 init];
  if (v2)
  {
    id v3 = objc_alloc(MEMORY[0x1E4F93738]);
    uint64_t v4 = [v3 initWithFeatureId:@"Found" event:@"ContactOpportunityInSpotlight" registerProperties:MEMORY[0x1E4F1CBF0] propertySubsets:MEMORY[0x1E4F1CBF0]];
    tracker = v2->_tracker;
