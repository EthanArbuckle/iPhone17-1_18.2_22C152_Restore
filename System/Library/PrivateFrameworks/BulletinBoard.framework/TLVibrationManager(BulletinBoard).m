...
- (BOOL)bb_isVibrationEnabledForSectionInfo:()BulletinBoard;
      ...
      if (v10)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            char v15 = objc_msgSend(a1, "bb_isVibrationEnabledForAlertType:topic:", v7, v14);
...
LABEL_14:
    ...
    {
      int v16 = objc_msgSend(a1, "bb_isVibrationEnabledForAlertType:topic:", v7, 0);
    }
...
- (uint64_t)bb_isVibrationEnabledForAlertConfiguration:()BulletinBoard
{
  v1 = objc_msgSend(a1, "bb_vibrationIdentifierForAlertConfiguration:");
  uint64_t v2 = [v1 isEqualToString:*MEMORY[0x263F7FD78]] ^ 1;
