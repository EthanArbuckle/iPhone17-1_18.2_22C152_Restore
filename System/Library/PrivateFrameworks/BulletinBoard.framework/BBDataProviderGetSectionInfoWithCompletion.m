...
void ___BBDataProviderGetSectionInfoWithCompletion_block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)BBLogGeneral, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v3;
    _os_log_impl(&dword_217675000, v2, OS_LOG_TYPE_DEFAULT, "BBDataProvider: Get info for section %{public}@", (uint8_t *)&v7, 0xCu);
  }
  v4 = (void *)MEMORY[0x21D44A020]();
  v5 = [(id)__server _sectionInfoForSectionID:*(void *)(a1 + 32) effective:0];
