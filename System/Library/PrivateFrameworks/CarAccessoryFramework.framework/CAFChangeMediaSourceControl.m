...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFChangeMediaSourceControl;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFChangeMediaSourceControl;
...
+ (id)controlIdentifier
{
  return @"0x000000000F00004D";
}

+ (id)observerProtocol
{
  return &unk_26FDB57C0;
}
