...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFUIControl;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFUIControl;
...
- (NSArray)uiInputDeviceButtonServices
{
  ...
  objc_opt_class();
  id v8 = [(CAFAccessory *)self servicesForType:@"0x0000000011100002"];
...
+ (id)accessoryIdentifier
{
  return @"0x0000000001100001";
}

+ (id)observerProtocol
{
  return &unk_26FDAFA40;
}
