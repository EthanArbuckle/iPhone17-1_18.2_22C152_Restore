...
{
  id v4 = a3;
  v5 = (void *)[objc_alloc((Class)a1) initWithMediaItemImages:v4];
...
- (CAFMediaItemImages)initWithArray:(id)a3
{
  ...
  id v5 = [(CAFMediaItemImages *)&v18 init];
  if (v5)
  {
...
void __36__CAFMediaItemImages_initWithArray___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v4 = [[CAFMediaItemImage alloc] initWithDictionary:v3];
    [*(id *)(a1 + 32) addObject:v4];
  }
  else
  {
    uint64_t v5 = objc_msgSend(MEMORY[0x263F087E8], "CAF_elementParseFailedForDataSupportType:", @"MediaItemImages");
    ...
    *(void *)(v7 + 16) = v5;
    ...
    CAFGeneralLogging();
    id v4 = (CAFMediaItemImage *)objc_claimAutoreleasedReturnValue();
...
- (NSString)formattedValue
{
  id v3 = [(CAFMediaItemImages *)self mediaItemImages];
  if ([v3 count])
  {
    id v4 = NSString;
    uint64_t v5 = [(CAFMediaItemImages *)self mediaItemImages];
...
- (id)objectAtIndex:(unint64_t)a3
{
  id v4 = [(CAFMediaItemImages *)self mediaItemImages];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  id v8 = [(CAFMediaItemImages *)self mediaItemImages];
...
void __36__CAFMediaItemImages_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2114;
  uint64_t v7 = a2;
  _os_log_error_impl(&dword_249710000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from MediaItemImages array - %{public}@", (uint8_t *)&v4, 0x16u);
}
