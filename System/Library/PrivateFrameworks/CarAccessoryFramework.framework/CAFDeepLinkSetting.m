...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFDeepLinkSetting;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFDeepLinkSetting;
...
- (NSString)userVisibleValue
{
  objc_super v2 = [(CAFDeepLinkSetting *)self userVisibleValueCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)contentURLAction
{
  objc_super v2 = [(CAFDeepLinkSetting *)self contentURLActionCharacteristic];
...
+ (id)serviceIdentifier
{
  return @"0x0000000016000006";
}

+ (id)observerProtocol
{
  return &unk_26FDB2EC0;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ([v7 isEqual:@"0x0000000030000017"])
  {
    ...
    uint64_t v9 = [(CAFDeepLinkSetting *)self userVisibleValueCharacteristic];
    ...
    if (v11)
    {
      ...
      v13 = [(CAFDeepLinkSetting *)self userVisibleValue];
      [v12 deepLinkSettingService:self didUpdateUserVisibleValue:v13];
LABEL_8:
  ...
  if (![v12 isEqual:@"0x0000000036000066"])
  {
LABEL_9:
  ...
  v15 = [(CAFDeepLinkSetting *)self contentURLActionCharacteristic];
  ...
  {
    v12 = [(CAFService *)self observers];
    v13 = [(CAFDeepLinkSetting *)self contentURLAction];
    [v12 deepLinkSettingService:self didUpdateContentURLAction:v13];
    goto LABEL_8;
  }
LABEL_10:
  v18.receiver = self;
  v18.super_class = (Class)CAFDeepLinkSetting;
