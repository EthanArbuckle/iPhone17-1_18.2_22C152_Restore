...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFAutomakerRequestContent;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFAutomakerRequestContent;
...
- (NSArray)requestContentServices
{
  ...
  objc_opt_class();
  id v8 = [(CAFAccessory *)self servicesForType:@"0x0000000017000004"];
...
+ (id)accessoryIdentifier
{
  return @"0x0000000001200001";
}

+ (id)observerProtocol
{
  return &unk_26FDB0948;
}
