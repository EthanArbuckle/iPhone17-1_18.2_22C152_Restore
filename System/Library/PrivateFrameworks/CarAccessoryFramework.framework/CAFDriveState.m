...
- (CAFTransmissionStatus)transmissionStatusService
{
  ...
  [v6 validateRegisteredForAccessory:v7 service:@"0x000000001A000003"];
...
- (CAFGearRecommendation)gearRecommendationService
{
  ...
  objc_super v6 = [v5 registrations];
  v7 = [(id)objc_opt_class() accessoryIdentifier];
  [v6 validateRegisteredForAccessory:v7 service:@"0x000000001A000007"];
...
- (CAFDriveMode)driveModeService
{
  ...
  objc_super v6 = [v5 registrations];
  v7 = [(id)objc_opt_class() accessoryIdentifier];
  [v6 validateRegisteredForAccessory:v7 service:@"0x000000001A000008"];
...
+ (id)accessoryIdentifier
{
  return @"0x0000000009000003";
}

+ (id)observerProtocol
{
  return &unk_26FDB03C8;
}
