...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFEngineTemperature;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFEngineTemperature;
...
- (NSMeasurement)temperature
{
  objc_super v2 = [(CAFEngineTemperature *)self temperatureCharacteristic];
...
- (unsigned)temperatureState
{
  objc_super v2 = [(CAFEngineTemperature *)self temperatureStateCharacteristic];
...
- (NSMeasurement)temperatureMin
{
  objc_super v2 = [(CAFEngineTemperature *)self temperatureMinCharacteristic];
...
- (NSMeasurement)temperatureMax
{
  objc_super v2 = [(CAFEngineTemperature *)self temperatureMaxCharacteristic];
  unsigned __int8 v3 = [v2 measurementValue];
...
- (NSMeasurement)temperatureMarkerCold
{
  objc_super v2 = [(CAFEngineTemperature *)self temperatureMarkerColdCharacteristic];
  unsigned __int8 v3 = [v2 measurementValue];
...
- (NSMeasurement)temperatureMarkerHot
{
  objc_super v2 = [(CAFEngineTemperature *)self temperatureMarkerHotCharacteristic];
...
+ (id)serviceIdentifier
{
  return @"0x000000001A000010";
}

+ (id)observerProtocol
{
  return &unk_26FDB3728;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ([v7 isEqual:@"0x000000003000001D"])
  {
    ...
    v9 = [(CAFEngineTemperature *)self temperatureCharacteristic];
    ...
    if (v11)
    {
      ...
      v13 = [(CAFEngineTemperature *)self temperature];
      [v12 engineTemperatureService:self didUpdateTemperature:v13];
LABEL_24:
  ...
  if ([v14 isEqual:@"0x000000003000001E"])
  {
    ...
    v16 = [(CAFEngineTemperature *)self temperatureStateCharacteristic];
    ...
    {
      v12 = [(CAFService *)self observers];
      objc_msgSend(v12, "engineTemperatureService:didUpdateTemperatureState:", self, -[CAFEngineTemperature temperatureState](self, "temperatureState"));
      goto LABEL_25;
    }
  }
  else
  ...
  if ([v19 isEqual:@"0x0000000030000054"])
  {
    ...
    v21 = [(CAFEngineTemperature *)self temperatureMinCharacteristic];
    ...
    {
      v12 = [(CAFService *)self observers];
      v13 = [(CAFEngineTemperature *)self temperatureMin];
      [v12 engineTemperatureService:self didUpdateTemperatureMin:v13];
      goto LABEL_24;
    }
  }
  else
  ...
  if ([v24 isEqual:@"0x0000000030000055"])
  {
    ...
    v26 = [(CAFEngineTemperature *)self temperatureMaxCharacteristic];
    ...
    {
      v12 = [(CAFService *)self observers];
      v13 = [(CAFEngineTemperature *)self temperatureMax];
      [v12 engineTemperatureService:self didUpdateTemperatureMax:v13];
      goto LABEL_24;
    }
  }
  else
  ...
  if ([v29 isEqual:@"0x0000000030000056"])
  {
    ...
    v31 = [(CAFEngineTemperature *)self temperatureMarkerColdCharacteristic];
    ...
    {
      v12 = [(CAFService *)self observers];
      v13 = [(CAFEngineTemperature *)self temperatureMarkerCold];
      [v12 engineTemperatureService:self didUpdateTemperatureMarkerCold:v13];
      goto LABEL_24;
    }
  }
  else
...
LABEL_25:
  ...
  v35 = [(CAFEngineTemperature *)self temperatureMarkerHotCharacteristic];
  ...
  {
    v12 = [(CAFService *)self observers];
    v13 = [(CAFEngineTemperature *)self temperatureMarkerHot];
    [v12 engineTemperatureService:self didUpdateTemperatureMarkerHot:v13];
    goto LABEL_24;
  }
LABEL_26:
  v38.receiver = self;
  v38.super_class = (Class)CAFEngineTemperature;
