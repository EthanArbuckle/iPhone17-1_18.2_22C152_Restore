...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFRecirculation;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFRecirculation;
...
- (BOOL)on
{
  objc_super v2 = [(CAFRecirculation *)self onCharacteristic];
...
{
  BOOL v3 = a3;
  id v4 = [(CAFRecirculation *)self onCharacteristic];
  [v4 setBoolValue:v3];
}
...
- (BOOL)autoMode
{
  objc_super v2 = [(CAFRecirculation *)self autoModeCharacteristic];
  char v3 = [v2 BOOLValue];
...
+ (id)serviceIdentifier
{
  return @"0x0000000011000011";
}

+ (id)observerProtocol
{
  return &unk_26FDB5888;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ([v7 isEqual:@"0x0000000030000002"])
  {
    ...
    v9 = [(CAFRecirculation *)self onCharacteristic];
    ...
    if (v11)
    {
      ...
      objc_msgSend(v12, "recirculationService:didUpdateOn:", self, -[CAFRecirculation on](self, "on"));
LABEL_8:
  ...
  v14 = [(CAFRecirculation *)self autoModeCharacteristic];
  ...
  {
    v12 = [(CAFService *)self observers];
    objc_msgSend(v12, "recirculationService:didUpdateAutoMode:", self, -[CAFRecirculation autoMode](self, "autoMode"));
    goto LABEL_8;
  }
LABEL_9:
  v17.receiver = self;
  v17.super_class = (Class)CAFRecirculation;
