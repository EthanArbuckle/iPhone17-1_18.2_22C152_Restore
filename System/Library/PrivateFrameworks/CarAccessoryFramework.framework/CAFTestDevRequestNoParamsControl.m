...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFTestDevRequestNoParamsControl;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFTestDevRequestNoParamsControl;
...
+ (id)controlIdentifier
{
  return @"0x00000000FF000028";
}

+ (id)observerProtocol
{
  return &unk_26FDB2C78;
}
