...
{
  id v4 = a3;
  v5 = (void *)[objc_alloc((Class)a1) initWithSelectSettingEntrys:v4];
...
- (CAFSelectSettingEntryList)initWithArray:(id)a3
{
  ...
  id v5 = [(CAFSelectSettingEntryList *)&v18 init];
  if (v5)
  {
...
void __43__CAFSelectSettingEntryList_initWithArray___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v4 = [[CAFSelectSettingEntry alloc] initWithDictionary:v3];
    [*(id *)(a1 + 32) addObject:v4];
  }
  else
  {
    uint64_t v5 = objc_msgSend(MEMORY[0x263F087E8], "CAF_elementParseFailedForDataSupportType:", @"SelectSettingEntryList");
    ...
    *(void *)(v7 + 16) = v5;
    ...
    CAFGeneralLogging();
    id v4 = (CAFSelectSettingEntry *)objc_claimAutoreleasedReturnValue();
...
- (NSString)formattedValue
{
  id v3 = [(CAFSelectSettingEntryList *)self selectSettingEntrys];
  if ([v3 count])
  {
    id v4 = NSString;
    uint64_t v5 = [(CAFSelectSettingEntryList *)self selectSettingEntrys];
...
- (id)objectAtIndex:(unint64_t)a3
{
  id v4 = [(CAFSelectSettingEntryList *)self selectSettingEntrys];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  id v8 = [(CAFSelectSettingEntryList *)self selectSettingEntrys];
...
void __43__CAFSelectSettingEntryList_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2114;
  uint64_t v7 = a2;
  _os_log_error_impl(&dword_249710000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from SelectSettingEntryList array - %{public}@", (uint8_t *)&v4, 0x16u);
}
