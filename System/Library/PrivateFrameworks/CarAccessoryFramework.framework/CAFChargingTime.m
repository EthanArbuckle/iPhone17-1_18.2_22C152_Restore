...
- (CAFMeasurementCharacteristic)remainingTimeCharacteristic
{
  ...
  objc_opt_class();
  id v10 = [(CAFService *)self characteristicForType:@"0x0000000030000030"];
...
- (NSMeasurement)remainingTime
{
  objc_super v2 = [(CAFChargingTime *)self remainingTimeCharacteristic];
...
+ (id)serviceIdentifier
{
  return @"0x0000000019000007";
}

+ (id)observerProtocol
{
  return &unk_26FDB5BA8;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if (![v7 isEqual:@"0x0000000030000030"]) {
    goto LABEL_4;
  }
  v8 = [v6 uniqueIdentifier];
  v9 = [(CAFChargingTime *)self remainingTimeCharacteristic];
  ...
  if (v11)
  {
    ...
    v12 = [(CAFChargingTime *)self remainingTime];
    [v7 chargingTimeService:self didUpdateRemainingTime:v12];
...
- (BOOL)registeredForRemainingTime
{
  ...
  v8 = [(id)objc_opt_class() accessoryIdentifier];
  v9 = [(id)objc_opt_class() serviceIdentifier];
  char v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x0000000030000030"];
