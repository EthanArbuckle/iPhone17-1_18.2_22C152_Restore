...
{
  id v4 = a3;
  id v5 = [(CAFTestControlAsync *)self testDevRequestNoParamsControl];
  objc_super v6 = v5;
  if (v5)
  {
...
- (BOOL)hasTestDevRequestNoParams
{
  id v2 = [(CAFTestControlAsync *)self testDevRequestNoParamsControl];
  BOOL v3 = v2 != 0;
...
- (void)testDevRequestWithReqParamsWithTestInput1:(unsigned __int8)a3 testInput2:(id)a4 completion:(id)a5
{
  ...
  id v8 = a4;
  id v9 = a5;
  v10 = [(CAFTestControlAsync *)self testDevRequestWithReqParamsControl];
  v11 = v10;
  if (v10)
  {
...
- (BOOL)hasTestDevRequestWithReqParams
{
  id v2 = [(CAFTestControlAsync *)self testDevRequestWithReqParamsControl];
  BOOL v3 = v2 != 0;
...
{
  id v4 = a3;
  id v5 = [(CAFTestControlAsync *)self testDevRequestWithResParamsControl];
  uint64_t v6 = v5;
  if (v5)
  {
...
- (BOOL)hasTestDevRequestWithResParams
{
  id v2 = [(CAFTestControlAsync *)self testDevRequestWithResParamsControl];
  BOOL v3 = v2 != 0;
...
- (void)testDevRequestWithReqAndResParamsWithTestInput5:(unsigned __int8)a3 testInput6:(id)a4 completion:(id)a5
{
  ...
  id v8 = a4;
  id v9 = a5;
  v10 = [(CAFTestControlAsync *)self testDevRequestWithReqAndResParamsControl];
  v11 = v10;
  if (v10)
  {
...
- (BOOL)hasTestDevRequestWithReqAndResParams
{
  id v2 = [(CAFTestControlAsync *)self testDevRequestWithReqAndResParamsControl];
  BOOL v3 = v2 != 0;
...
- (id)testAccRequestNoParamsHandler
{
  id v2 = [(CAFTestControlAsync *)self testAccRequestNoParamsControl];
  id v3 = [v2 handler];
...
{
  id v4 = a3;
  id v5 = [(CAFTestControlAsync *)self testAccRequestNoParamsControl];
  [v5 setHandler:v4];
}
...
- (id)testAccRequestWithReqParamsHandler
{
  id v2 = [(CAFTestControlAsync *)self testAccRequestWithReqParamsControl];
  id v3 = [v2 handler];
...
{
  id v4 = a3;
  id v5 = [(CAFTestControlAsync *)self testAccRequestWithReqParamsControl];
  [v5 setHandler:v4];
}
...
- (id)testAccRequestWithResParamsHandler
{
  id v2 = [(CAFTestControlAsync *)self testAccRequestWithResParamsControl];
  id v3 = [v2 handler];
...
{
  id v4 = a3;
  id v5 = [(CAFTestControlAsync *)self testAccRequestWithResParamsControl];
  [v5 setHandler:v4];
}
...
- (id)testAccRequestWithReqAndResParamsHandler
{
  id v2 = [(CAFTestControlAsync *)self testAccRequestWithReqAndResParamsControl];
  id v3 = [v2 handler];
...
{
  id v4 = a3;
  id v5 = [(CAFTestControlAsync *)self testAccRequestWithReqAndResParamsControl];
  [v5 setHandler:v4];
}
...
+ (id)serviceIdentifier
{
  return @"0x00000000FE000009";
}

+ (id)observerProtocol
{
  return &unk_26FDB0368;
}
...
- (void)_controlDidUpdate:(id)a3
{
  ...
  if ([v5 isEqual:@"0x00000000FF000028"])
  {
    ...
    v7 = [(CAFTestControlAsync *)self testDevRequestNoParamsControl];
    ...
    if (v9)
    {
      ...
      [v10 testControlAsyncServiceDidUpdateTestDevRequestNoParams:self];
LABEL_16:
  ...
  if ([v11 isEqual:@"0x00000000FF000029"])
  {
    ...
    v13 = [(CAFTestControlAsync *)self testDevRequestWithReqParamsControl];
    ...
    {
      v10 = [(CAFService *)self observers];
      [v10 testControlAsyncServiceDidUpdateTestDevRequestWithReqParams:self];
      goto LABEL_16;
    }
  }
  else
  ...
  if ([v16 isEqual:@"0x00000000FF00002A"])
  {
    ...
    v18 = [(CAFTestControlAsync *)self testDevRequestWithResParamsControl];
    ...
    {
      v10 = [(CAFService *)self observers];
      [v10 testControlAsyncServiceDidUpdateTestDevRequestWithResParams:self];
      goto LABEL_16;
    }
  }
  else
  ...
  v22 = [(CAFTestControlAsync *)self testDevRequestWithReqAndResParamsControl];
  ...
  {
    v10 = [(CAFService *)self observers];
    [v10 testControlAsyncServiceDidUpdateTestDevRequestWithReqAndResParams:self];
    goto LABEL_16;
  }
LABEL_17:
  v25.receiver = self;
