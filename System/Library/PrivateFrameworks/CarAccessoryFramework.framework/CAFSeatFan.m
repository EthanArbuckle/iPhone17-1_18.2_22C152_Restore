...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFSeatFan;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFSeatFan;
...
- (id)name
{
  ...
  id v4 = [(CAFSeatFan *)self vehicleLayoutKeyCharacteristic];
...
- (BOOL)on
{
  objc_super v2 = [(CAFSeatFan *)self onCharacteristic];
...
{
  BOOL v3 = a3;
  id v4 = [(CAFSeatFan *)self onCharacteristic];
  [v4 setBoolValue:v3];
}
...
- (unsigned)fanLevel
{
  objc_super v2 = [(CAFSeatFan *)self fanLevelCharacteristic];
...
{
  uint64_t v3 = a3;
  id v4 = [(CAFSeatFan *)self fanLevelCharacteristic];
  [v4 setUint8Value:v3];
}
...
- (BOOL)autoMode
{
  objc_super v2 = [(CAFSeatFan *)self autoModeCharacteristic];
  char v3 = [v2 BOOLValue];
...
- (NSString)vehicleLayoutKey
{
  objc_super v2 = [(CAFSeatFan *)self vehicleLayoutKeyCharacteristic];
...
+ (id)serviceIdentifier
{
  return @"0x0000000022000002";
}

+ (id)observerProtocol
{
  return &unk_26FDAFF68;
}
...
- (void)_characteristicDidUpdate:(id)a3 fromGroupUpdate:(BOOL)a4
{
  ...
  if ([v7 isEqual:@"0x0000000030000002"])
  {
    ...
    v9 = [(CAFSeatFan *)self onCharacteristic];
    ...
    if (v11)
    {
      ...
      objc_msgSend(v12, "fanService:didUpdateOn:", self, -[CAFSeatFan on](self, "on"));
LABEL_16:
  ...
  if ([v13 isEqual:@"0x0000000031000012"])
  {
    v14 = [v6 uniqueIdentifier];
    v15 = [(CAFSeatFan *)self fanLevelCharacteristic];
    ...
    {
      v12 = [(CAFService *)self observers];
      objc_msgSend(v12, "fanService:didUpdateFanLevel:", self, -[CAFSeatFan fanLevel](self, "fanLevel"));
      goto LABEL_16;
    }
  }
  else
  ...
  if ([v18 isEqual:@"0x000000003000005F"])
  {
    ...
    v20 = [(CAFSeatFan *)self autoModeCharacteristic];
    ...
    {
      v12 = [(CAFService *)self observers];
      objc_msgSend(v12, "fanService:didUpdateAutoMode:", self, -[CAFSeatFan autoMode](self, "autoMode"));
      goto LABEL_16;
    }
  }
  else
  ...
  v24 = [(CAFSeatFan *)self vehicleLayoutKeyCharacteristic];
  ...
  if (v26)
  {
    ...
    v28 = [(CAFSeatFan *)self vehicleLayoutKey];
    [v27 fanService:self didUpdateVehicleLayoutKey:v28];

    v12 = [(CAFService *)self observers];
    v29 = [(CAFSeatFan *)self name];
...
LABEL_17:
  v30.receiver = self;
  v30.super_class = (Class)CAFSeatFan;
