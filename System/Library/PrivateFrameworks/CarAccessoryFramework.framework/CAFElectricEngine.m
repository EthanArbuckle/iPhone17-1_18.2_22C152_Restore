...
{
  v2.receiver = a1;
  v2.super_class = (Class)&OBJC_METACLASS___CAFElectricEngine;
...
- (void)registerObserver:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CAFElectricEngine;
...
- (CAFEnginePower)enginePowerService
{
  ...
  [v6 validateRegisteredForAccessory:v7 service:@"0x000000001A00000D"];
  ...
  return (CAFEnginePower *)v10;
}

+ (id)accessoryIdentifier
{
  return @"0x0000000009000004";
}

+ (id)observerProtocol
{
  return &unk_26FDB2DE0;
}
