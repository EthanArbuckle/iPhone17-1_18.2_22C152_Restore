@interface IMDAttachmentRecordBatchFetcher
- (id)nextBatchWithSize:(unint64_t)a3;
@end

@implementation IMDAttachmentRecordBatchFetcher
...
- (id)nextBatchWithSize:(unint64_t)a3
{
  ...
  v19[3] = &unk_1E5F8E3B8;
  v19[4] = &v20;
  [v13 fetchAttachmentRecordsFilteredUsingPredicate:v12 sortedUsingDescriptors:v14 limit:a3 completionHandler:v19];
