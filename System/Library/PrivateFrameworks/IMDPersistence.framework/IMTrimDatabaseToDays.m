...
- (void)performMessageSelectionWithOperation:(IMDSqlOperation *)a3
{
  ...
  double v6 = v5 - (double)(86400 * self->_newerThanDays);
  _IMDSqlOperationBeginQuery((uint64_t)a3, (CFStringRef)objc_msgSend(NSString, "stringWithFormat:", @"INSERT INTO message SELECT %@ from source.message WHERE date >= ?;",
