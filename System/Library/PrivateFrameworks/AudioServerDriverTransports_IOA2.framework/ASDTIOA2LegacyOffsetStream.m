@interface ASDTIOA2LegacyOffsetStream
- (id)readInputBlock;
...
{
  v9.receiver = self;
  v9.super_class = (Class)ASDTIOA2LegacyOffsetStream;
  v3 = [(ASDTStream *)&v9 readInputBlock];
  uint64_t v4 = [(ASDTIOA2LegacyOffsetStream *)self sampleTimeOffset];
  v5 = ASDTIOA2LogType();
  ...
  v8[1] = 3221225472;
  v8[2] = __44__ASDTIOA2LegacyOffsetStream_readInputBlock__block_invoke;
  v8[3] = &unk_265246418;
...
- (void)readInputBlock
{
  ...
  int v2 = 134217984;
  double v3 = a2;
  _os_log_debug_impl(&dword_248A1B000, log, OS_LOG_TYPE_DEBUG, "Stream samples offset frames: %1.0lf", (uint8_t *)&v2, 0xCu);
}
