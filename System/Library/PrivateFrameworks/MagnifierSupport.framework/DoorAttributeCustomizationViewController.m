...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v4 = (char *)v9.receiver;
  [(DoorAttributeCustomizationViewController *)&v9 viewWillDisappear:v3];
...
- (_TtC16MagnifierSupport40DoorAttributeCustomizationViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC16MagnifierSupport40DoorAttributeCustomizationViewController *)sub_235683800(v5, v7, a4);
}

- (_TtC16MagnifierSupport40DoorAttributeCustomizationViewController)initWithCoder:(id)a3
{
  return (_TtC16MagnifierSupport40DoorAttributeCustomizationViewController *)sub_2356839F0(a3);
}
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease();
  sub_23566A3AC((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport40DoorAttributeCustomizationViewController_delegate, &qword_26880F5A0);
}
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  uint64_t v5 = (char *)self + OBJC_IVAR____TtC16MagnifierSupport40DoorAttributeCustomizationViewController_doorAttributes;
  swift_beginAccess();
