...
- (_TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController *)sub_2357B2258(v5, v7, a4);
}

- (_TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController)initWithCoder:(id)a3
{
  return (_TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController *)sub_2357B2468(a3);
}

- (void).cxx_destruct
{
  sub_23566A2B4((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController_delegate);
  sub_235689B14((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController_activity, (uint64_t)v3);
  sub_235691A68(v3);
...
- (void)toggleImageCaptionsSwitchChanged:(id)a3
{
  if (MEMORY[0x237DEA060]((char *)self + OBJC_IVAR____TtC16MagnifierSupport48ActivityImageCaptionsCustomizationViewController_delegate, a2))
  {
    if (a3)
    {
      id v5 = a3;
      uint64_t v6 = self;
      sub_23576A1DC((uint64_t)objc_msgSend(v5, sel_isOn));
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  return sub_2357B30D4((uint64_t)self, (uint64_t)a2, (uint64_t)a3, a4, (void (*)(uint64_t))sub_2357B3320);
}

- (id)tableView:(id)a3 titleForFooterInSection:(int64_t)a4
{
  return sub_2357B30D4((uint64_t)self, (uint64_t)a2, (uint64_t)a3, a4, (void (*)(uint64_t))sub_2357B3424);
}
