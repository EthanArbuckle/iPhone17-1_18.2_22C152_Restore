...
{
  v1 = [a1 rawSceneUnderstandingData];
  uint64_t v2 = [v1 depthConfidenceBuffer];
...
{
  v1 = [a1 rawSceneUnderstandingData];
  uint64_t v2 = [v1 semanticSegmentationBufferSampledForDepth];
...
{
  v1 = [a1 rawSceneUnderstandingData];
  uint64_t v2 = [v1 semanticSegmentationConfidenceBufferSampledForDepth];
...
- (uint64_t)vioTrackingState
{
  ...
  uint64_t v2 = [v1 vioTrackingState];
