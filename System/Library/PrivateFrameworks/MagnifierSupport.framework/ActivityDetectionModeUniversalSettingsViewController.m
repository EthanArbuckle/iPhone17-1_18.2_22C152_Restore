...
- (_TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController *)sub_2356E3410(v5, v7, a4);
}

- (_TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController)initWithCoder:(id)a3
{
  return (_TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController *)sub_2356E362C(a3);
}

- (void).cxx_destruct
{
  sub_23566A2B4((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController_delegate);
  sub_235689B14((uint64_t)self + OBJC_IVAR____TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController_activity, (uint64_t)v3);
  sub_235691A68(v3);
...
- (void)didToggleDetectLanguagesSwitch:(id)a3
{
  if (MEMORY[0x237DEA060]((char *)self+ OBJC_IVAR____TtC16MagnifierSupport52ActivityDetectionModeUniversalSettingsViewController_delegate, a2))
  {
    id v5 = a3;
    uint64_t v6 = self;
    sub_235767580((int)objc_msgSend(v5, sel_isOn));
