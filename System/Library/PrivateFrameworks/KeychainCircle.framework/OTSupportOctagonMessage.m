...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
      BOOL v5 = off_264314A90[supported];
    }
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)OTSupportOctagonMessage;
  id v4 = [(OTSupportOctagonMessage *)&v8 description];
  BOOL v5 = [(OTSupportOctagonMessage *)self dictionaryRepresentation];
