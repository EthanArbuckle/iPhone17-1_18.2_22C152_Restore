id standardLanguage(void *a1)
{
  ...
  v1 = a1;
  v2 = objc_msgSend(v1, "stringByReplacingOccurrencesOfString:withString:options:range:", @"_", @"-", 0, 0, objc_msgSend(v1, "length"));
...
{
  v1 = (objc_class *)MEMORY[0x1E4F42EC8];
  id v2 = a1;
  id v6 = (id)[[v1 alloc] initWithTarget:v2 action:sel_textTapGestureRecognized_];
  ...
  v5 = (void *)[objc_alloc(MEMORY[0x1E4F61090]) initWithMachName:0];
  [v2 setEmojiPreferences:v5];
}

double overlayRectRelativeToRect(unint64_t a1, double a2, double a3, double a4, double a5, double a6)
{
  double v7 = (double)a1 * 36.0 + 20.0 + (double)(a1 + 1) * 4.0;
  double v8 = a2 + a4 * 0.5 - v7 * 0.5;
  double result = 16.0;
  if (v8 >= 16.0)
  {
    double result = v8;
...
id darkBackgroundColor()
{
  ...
  v0 = (void *)darkBackgroundColor_color;
  return v0;
}

uint64_t __darkBackgroundColor_block_invoke()
{
  darkBackgroundColor_color = [MEMORY[0x1E4F428B8] colorWithRed:0.37 green:0.37 blue:0.37 alpha:1.0];
  return MEMORY[0x1F41817F8]();
}

uint64_t __selectionColor_block_invoke()
{
  selectionColor_color = [MEMORY[0x1E4F428B8] colorWithRed:0.01 green:0.45 blue:0.98 alpha:1.0];
  return MEMORY[0x1F41817F8]();
}

void sub_1E4A649AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
void sub_1E4A65078(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void _EMKSetNeedsDisplaySubviewsOf(void *a1)
{
  ...
  long long v7 = 0u;
  long long v8 = 0u;
  id v2 = objc_msgSend(v1, "subviews", 0);
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        _EMKSetNeedsDisplaySubviewsOf(*(void *)(*((void *)&v7 + 1) + 8 * v6++));
      }
      while (v4 != v6);
...
void sub_1E4A66BA8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, char a19, uint64_t a20,uint64_t a21,uint64_t a22,uint64_t a23,uint64_t a24,uint64_t a25,uint64_t a26,uint64_t a27,uint64_t a28,uint64_t a29,uint64_t a30,uint64_t a31,uint64_t a32,char a33)
{
...
void sub_1E4A67520(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, id location)
{
...
void sub_1E4A6805C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
BOOL _EMKShouldDrawCTRun(const __CTRun *a1)
{
  ...
  return CFDictionaryContainsKey(Attributes, @"EMKEmojiTokenList") == 1;
}
...
void sub_1E4A6A754(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, ...)
{
  va_start(va, a15);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_1E4A6B970(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
