...
- (void)initializeWithModel:(id)a3
{
  ...
  [(GCGenericDeviceDataAddExpressionModelBuilder *)self setLeftExpression:v5];

  v6 = [v4 rightExpression];

  [(GCGenericDeviceDataAddExpressionModelBuilder *)self setRightExpression:v6];
}
...
- (id)build
{
  ...
  v5 = [(GCGenericDeviceDataAddExpressionModelBuilder *)self leftExpression];
  if (!v5)
  {
    v12 = unk_26BEED9E8(&off_26BEEDB50, "currentHandler");
    [v12 handleFailureInMethod:a2 object:self file:@"GCGenericDeviceDataAddExpressionModel.m" lineNumber:103 description:@"'leftExpression' can not be nil"];
  }
  uint64_t v6 = [v5 copy];
  objc_super v7 = (void *)v4[1];
  v4[1] = v6;

  v8 = [(GCGenericDeviceDataAddExpressionModelBuilder *)self rightExpression];
  if (!v8)
  {
    v13 = unk_26BEED9E8(&off_26BEEDB50, "currentHandler");
    [v13 handleFailureInMethod:a2 object:self file:@"GCGenericDeviceDataAddExpressionModel.m" lineNumber:107 description:@"'rightExpression' can not be nil"];
  }
  uint64_t v9 = [v8 copy];
  v10 = (void *)v4[2];
  v4[2] = v9;
