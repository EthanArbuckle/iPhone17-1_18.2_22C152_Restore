...
+ (id)description;
- (BOOL)isEqual:(id)a3;
- (GCGenericDeviceDataMultiplyExpressionModel)initWithCoder:(id)a3;
...
{
  v10.receiver = self;
  v10.super_class = (Class)GCGenericDeviceDataMultiplyExpressionModel;
  id v3 = a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)GCGenericDeviceDataMultiplyExpressionModel;
  id v4 = a3;
  [(GCGenericDeviceDataProcessorExpressionModel *)&v7 encodeWithCoder:v4];
  uint64_t v5 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
  [v4 encodeObject:v5 forKey:@"leftExpression"];

  v6 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)GCGenericDeviceDataMultiplyExpressionModel;
  if ([(GCGenericDeviceDataProcessorExpressionModel *)&v11 isEqual:v4])
  {
    ...
    if ([v5 isEqual:v6])
    {
      objc_super v7 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
...
- (id)description
{
  id v3 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
  id v4 = [v3 description];
  uint64_t v5 = [v4 stringByReplacingOccurrencesOfString:@"\n" withString:@"\n\t"];
  v6 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
  objc_super v7 = [v6 description];
  v8 = [v7 stringByReplacingOccurrencesOfString:@"\n" withString:@"\n\t"];
  char v9 = +[NSString stringWithFormat:@"(multiply\n\t%@\n\t%@\n)", v5, v8];
...
- (id)debugDescription
{
  ...
  v8 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
...
{
  id v6 = a3;
  objc_super v7 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
  v8 = [v7 buildPullExpressionWithOverrideBuilder:v6 error:a4];

  if (v8)
  {
    char v9 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
    ...
    if (v10)
    {
      ...
      v13[1] = 3221225472;
      v13[2] = __105__GCGenericDeviceDataMultiplyExpressionModel_Compilation___buildPullExpressionWithOverrideBuilder_error___block_invoke;
      v13[3] = &unk_26BEC39D8;
      id v14 = v8;
      id v15 = v10;
...
double __105__GCGenericDeviceDataMultiplyExpressionModel_Compilation___buildPullExpressionWithOverrideBuilder_error___block_invoke(uint64_t a1)
{
