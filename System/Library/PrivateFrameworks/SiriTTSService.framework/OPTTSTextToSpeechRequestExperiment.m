...
- (OPTTSTextToSpeechRequestExperiment)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestExperiment *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)OPTTSTextToSpeechRequestExperiment;
  uint64_t v10 = [(OPTTSTextToSpeechRequestExperiment *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
...
- (OPTTSTextToSpeechRequestExperiment)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestExperiment *)a4
{
  return [(OPTTSTextToSpeechRequestExperiment *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechRequestExperiment *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTextToSpeechRequestExperiment)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechRequestExperiment *)self initWithFlatbuffData:a3 root:0 verify:0];
}
