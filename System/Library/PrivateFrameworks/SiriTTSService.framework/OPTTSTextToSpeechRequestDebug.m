...
{
  v4 = self;
  int v5 = [(OPTTSTextToSpeechRequestDebug *)self force_use_tts_service];
...
- (OPTTSTextToSpeechRequestDebug)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestDebug *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(OPTTSTextToSpeechRequestDebug *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
...
- (OPTTSTextToSpeechRequestDebug)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestDebug *)a4
{
  return [(OPTTSTextToSpeechRequestDebug *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechRequestDebug *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTextToSpeechRequestDebug)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechRequestDebug *)self initWithFlatbuffData:a3 root:0 verify:0];
}
