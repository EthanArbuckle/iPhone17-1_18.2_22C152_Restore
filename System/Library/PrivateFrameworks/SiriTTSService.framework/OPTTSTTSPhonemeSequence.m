...
- (Offset<siri::speech::schema_fb::TTSPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(OPTTSTTSPhonemeSequence *)self word_phonemes];
  ...
  long long v38 = 0u;
  long long v39 = 0u;
  uint64_t v10 = [(OPTTSTTSPhonemeSequence *)self word_phonemes];
...
- (void)word_phonemes_enumerateObjectsUsingBlock:(id)a3
{
  ...
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"word_phonemes"];
  unint64_t v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            int v16 = [[OPTTSTTSWordPhonemes alloc] initWithFlatbuffData:self->_data root:&v13[*(unsigned int *)v13->var0] verify:0];
            v4[2](v4, v16, v14, &v19);
            int v17 = v19;
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      long long v7 = [[OPTTSTTSWordPhonemes alloc] initWithFlatbuffData:self->_data root:&v12[4 * a3 + 4 + *(unsigned int *)v12[4 * a3 + 4].var0] verify:0];
      goto LABEL_3;
    }
  }
  uint64_t v8 = 0;
...
- (OPTTSTTSPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSPhonemeSequence *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(OPTTSTTSPhonemeSequence *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
  ...
  unsigned __int8 v19 = (siri::speech::schema_fb::TTSPhonemeSequence *)v10->_root;
...
- (OPTTSTTSPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSPhonemeSequence *)a4
{
  return [(OPTTSTTSPhonemeSequence *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTTSPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTTSPhonemeSequence)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTTSPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:0];
}
