@interface OPTTSTTSReplacement
- (NSString)original;
- (NSString)replacement;
- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3;
- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3 root:(const TTSReplacement *)a4;
- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3 root:(const TTSReplacement *)a4 verify:(BOOL)a5;
- (Offset<siri::speech::schema_fb::TTSReplacement>)addObjectToBuffer:(void *)a3;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
@end

@implementation OPTTSTTSReplacement
...
- (id)flatbuffData
{
  ...
  __int16 v12 = 256;
  uint64_t v13 = 0;
  v2.var0 = [(OPTTSTTSReplacement *)self addObjectToBuffer:&v5];
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v5, v2.var0, v3);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__35__OPTTSTTSReplacement_flatbuffData__block_invoke(uint64_t a1)
{
...
- (Offset<siri::speech::schema_fb::TTSReplacement>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(OPTTSTTSReplacement *)self original];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(OPTTSTTSReplacement *)self replacement];
  uint64_t v11 = v10;
  if (!v10) {
...
- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3 root:(const TTSReplacement *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)OPTTSTTSReplacement;
  uint64_t v10 = [(OPTTSTTSReplacement *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
...
- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3 root:(const TTSReplacement *)a4
{
  return [(OPTTSTTSReplacement *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTTSReplacement *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTTSReplacement)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTTSReplacement *)self initWithFlatbuffData:a3 root:0 verify:0];
}
