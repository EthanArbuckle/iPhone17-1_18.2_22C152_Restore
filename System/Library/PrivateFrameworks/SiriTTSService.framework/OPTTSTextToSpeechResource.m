...
- (Offset<siri::speech::schema_fb::TextToSpeechResource>)addObjectToBuffer:(void *)a3
{
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::TextToSpeechResource>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v14);
}
...
- (OPTTSTextToSpeechResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResource *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)OPTTSTextToSpeechResource;
  uint64_t v10 = [(OPTTSTextToSpeechResource *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
