...
{
  v4 = self;
  int v5 = [(OPTTSTextToSpeechVoiceResource *)self type];
  uint64_t v10 = 0;
  uint64_t v11 = &v10;
  ...
  v9[4] = &v10;
  v9[5] = a3;
  [(OPTTSTextToSpeechVoiceResource *)v4 data:v9];
...
- (OPTTSTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoiceResource *)a4 verify:(BOOL)a5
{
  ...
  id v10 = [(OPTTSTextToSpeechVoiceResource *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
...
- (OPTTSTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechVoiceResource *)a4
{
  return [(OPTTSTextToSpeechVoiceResource *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechVoiceResource *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTextToSpeechVoiceResource)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechVoiceResource *)self initWithFlatbuffData:a3 root:0 verify:0];
}
