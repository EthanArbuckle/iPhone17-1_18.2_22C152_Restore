...
- (Offset<siri::speech::schema_fb::TTSWordPhonemes>)addObjectToBuffer:(void *)a3
{
  ...
  v37 = 0;
  unint64_t v38 = 0;
  v4 = [(OPTTSTTSWordPhonemes *)self phonemes];
  ...
  long long v32 = 0u;
  long long v33 = 0u;
  uint64_t v5 = [(OPTTSTTSWordPhonemes *)self phonemes];
...
- (OPTTSTTSWordPhonemes)initWithFlatbuffData:(id)a3 root:(const TTSWordPhonemes *)a4 verify:(BOOL)a5
{
  ...
  unint64_t v10 = [(OPTTSTTSWordPhonemes *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
...
- (OPTTSTTSWordPhonemes)initWithFlatbuffData:(id)a3 root:(const TTSWordPhonemes *)a4
{
  return [(OPTTSTTSWordPhonemes *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTTSWordPhonemes *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTTSWordPhonemes)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTTSWordPhonemes *)self initWithFlatbuffData:a3 root:0 verify:0];
}
