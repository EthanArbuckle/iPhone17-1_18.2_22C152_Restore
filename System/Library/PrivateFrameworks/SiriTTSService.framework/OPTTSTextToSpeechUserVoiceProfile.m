...
- (OPTTSTextToSpeechUserVoiceProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserVoiceProfile *)a4 verify:(BOOL)a5
{
  ...
  float v10 = [(OPTTSTextToSpeechUserVoiceProfile *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
...
- (OPTTSTextToSpeechUserVoiceProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserVoiceProfile *)a4
{
  return [(OPTTSTextToSpeechUserVoiceProfile *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechUserVoiceProfile *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTextToSpeechUserVoiceProfile)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechUserVoiceProfile *)self initWithFlatbuffData:a3 root:0 verify:0];
}
