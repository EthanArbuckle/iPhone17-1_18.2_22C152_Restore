...
- (OPTTSTextToSpeechUserVoiceProfile)user_voice_profile
{
  return (OPTTSTextToSpeechUserVoiceProfile *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"user_voice_profile"];
}
...
- (OPTTSTextToSpeechSpeechFeatureInputWave)wave_data
{
  return (OPTTSTextToSpeechSpeechFeatureInputWave *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"wave_data"];
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)OPTTSMutableTextToSpeechRequestProsodyTransferConfig;
