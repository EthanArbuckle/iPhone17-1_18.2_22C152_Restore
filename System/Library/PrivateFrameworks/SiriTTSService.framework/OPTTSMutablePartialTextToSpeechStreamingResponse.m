...
- (OPTTSTextToSpeechFeature)feature
{
  return (OPTTSTextToSpeechFeature *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"feature"];
}
...
- (void)audio:(id)a3
{
  ...
  id v4 = [(OPTTSMutablePartialTextToSpeechStreamingResponse *)self audio];
...
{
  v6.receiver = self;
  v6.super_class = (Class)OPTTSMutablePartialTextToSpeechStreamingResponse;
