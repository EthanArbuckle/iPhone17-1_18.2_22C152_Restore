...
- (STSTimer)initWithCallback:(id)a3 queue:(id)a4
{
  ...
  if (v8)
  {
    ...
    dispatch_source_t v10 = dispatch_source_create(MEMORY[0x263EF8400], 1uLL, 0, v7);
    src = v9->_src;
...
- (id)initSleepTimerWithCallback:(id)a3 queue:(id)a4
{
  ...
  {
    objc_storeStrong((id *)&v8->_queue, a4);
    dispatch_source_t v10 = dispatch_source_create(MEMORY[0x263EF8400], 2uLL, 0, v7);
    src = v9->_src;
    v9->_src = (OS_dispatch_source *)v10;
...
- (id)description
{
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"STSTimer: popTimeInSeconds: %llu", self->_popTimeInSeconds);
