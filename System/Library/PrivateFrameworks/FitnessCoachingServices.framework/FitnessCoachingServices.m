int main(int argc, const char **argv, const char **envp)
{
  ...
  v3 = sub_100002908(&qword_100008010);
  v4 = __chkstk_darwin();
  v6 = (char *)&v12 - ((v5 + 15) & 0xFFFFFFFFFFFFFFF0);
  sub_10000294C(v4, qword_100008048);
  v7 = sub_1000029B0(v3, (uint64_t)qword_100008048);
  v8 = type metadata accessor for Daemon();
  (*(void (**)(uint64_t, uint64_t, uint64_t, uint64_t))(*(void *)(v8 - 8) + 56))(v7, 1, 1, v8);
  sub_1000029E8();
  swift_beginAccess();
  sub_100002C84(v7, (uint64_t)v6);
  v10 = [self mainRunLoop];
  [v10 run];

  sub_1000034B0((uint64_t)v6, &qword_100008010);
  return 0;
}
...
uint64_t sub_1000029E8()
{
  ...
  sub_100002908(&qword_100008010);
  uint64_t v6 = __chkstk_darwin();
  v8 = (char *)&v13 - ((v7 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v9 = sub_1000029B0(v6, (uint64_t)&unk_100008048);
  Daemon.init()();
  (*(void (**)(char *, void, uint64_t, uint64_t))(v3 + 56))(v8, 0, 1, v2);
  swift_beginAccess();
  sub_100002CEC((uint64_t)v8, v9);
  swift_endAccess();
  ...
  if (!result)
  {
    ...
    *(void *)(v12 + 16) = 0;
    *(void *)(v12 + 24) = 0;
    sub_1000032FC((uint64_t)v1, (uint64_t)&unk_100008028, v12);
...
{
  uint64_t v4 = sub_100002908(&qword_100008010);
...
uint64_t sub_100002D54(uint64_t a1)
{
  ...
  uint64_t v3 = sub_100002908(&qword_100008010);
  v1[9] = sub_1000029B0(v3, (uint64_t)qword_100008048);
...
uint64_t sub_100002F6C()
{
  ...
  return _swift_task_switch(sub_1000030C4, 0, 0);
}
...
uint64_t sub_1000032FC(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  sub_1000034B0(a1, &qword_100008018);
  if (*(void *)(a3 + 16))
  {
LABEL_3:
    swift_getObjectType();
...
LABEL_5:
  ...
  *(void *)(v8 + 16) = a2;
  *(void *)(v8 + 24) = a3;
  sub_100002908(&qword_100008040);
  return swift_task_create();
}

uint64_t sub_1000034B0(uint64_t a1, uint64_t *a2)
{
  uint64_t v3 = sub_100002908(a2);
