...
- (SKTask)initWithExecutable:(id)a3 arguments:(id)a4
{
  ...
  if (v8)
  {
    v9 = (NSTask *)objc_alloc_init(MEMORY[0x263F08B50]);
    task = v8->_task;
    v8->_task = v9;
    ...
    uint64_t v23 = [MEMORY[0x263F08AB8] progressWithTotalUnitCount:100];
...
- (SKTask)initWithExecutable:(id)a3
{
  return [(SKTask *)self initWithExecutable:a3 arguments:MEMORY[0x263EFFA68]];
}
