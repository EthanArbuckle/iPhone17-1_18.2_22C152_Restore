  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_impl(&dword_23F40C000, v8, OS_LOG_TYPE_ERROR, "%s: Can't create FSM for resize", buf, 0xCu);
    }
    BOOL v14 = 0;
  }
...
- (id)resizeStateMachine:(id *)a3
{
  unint64_t v3 = [MEMORY[0x263EFF940] exceptionWithName:@"com.apple.storagekit.notimplemented" reason:@"A required method is not implemented" userInfo:0];
  [v3 raise];
...
- (id)rollbackResize:(id *)a3
{
  ...
  if (a3 && (id v5 = *a3) != 0)
  {
    ...
    if (v7)
    {
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_23F40C000, v9, OS_LOG_TYPE_ERROR, "%s: Failing resize with %@ after attempt to recover from %@", (uint8_t *)&v15, 0x20u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        _os_log_impl(&dword_23F40C000, v9, OS_LOG_TYPE_DEFAULT, "%s: Rolling back resize after %@, reverting resize direction from %llu to %llu", (uint8_t *)&v15, 0x2Au);
      }
  ...
  {
    uint64_t v12 = SKGetOSLog();
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      int v15 = 136315138;
      id v16 = "-[SKDiskResizerBase rollbackResize:]";
      _os_log_impl(&dword_23F40C000, v12, OS_LOG_TYPE_ERROR, "%s: Reached resize rollback without setting any error", (uint8_t *)&v15, 0xCu);
    }
