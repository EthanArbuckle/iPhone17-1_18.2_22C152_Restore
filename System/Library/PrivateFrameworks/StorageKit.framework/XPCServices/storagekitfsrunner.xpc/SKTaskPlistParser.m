...
+ (NSData)plistStartTag
{
  if (qword_10000DC08 != -1) {
    dispatch_once(&qword_10000DC08, &stru_100008360);
  }
  v2 = (void *)qword_10000DC00;
...
+ (NSData)plistEndTag
{
  if (qword_10000DC18 != -1) {
    dispatch_once(&qword_10000DC18, &stru_100008380);
  }
  v2 = (void *)qword_10000DC10;
  ...
  if (v6)
  {
    do
    {
      if ([(SKTaskPlistParser *)self startRange] == (id)0x7FFFFFFFFFFFFFFFLL)
      {
        ...
        id v10 = objc_msgSend(v7, "rangeOfData:options:range:", v8, 0, 0, objc_msgSend(v9, "length"));
      ...
      v20 = objc_msgSend(v18, "subdataWithRange:", -[SKTaskPlistParser startRange](self, "startRange"), &v15[v17] - (unsigned char *)-[SKTaskPlistParser startRange](self, "startRange"));
      ...
      if (v21)
      {
        ...
        v25 = objc_msgSend(v23, "subdataWithRange:", v19 + 1, (char *)objc_msgSend(v24, "length") + ~v19);
        [v22 setData:v25];
