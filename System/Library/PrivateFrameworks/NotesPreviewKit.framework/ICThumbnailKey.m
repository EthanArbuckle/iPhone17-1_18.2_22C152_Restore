...
- (NSString)accountId
{
  return (NSString *)sub_224D731BC((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___ICThumbnailKey_accountId);
}

- (NSString)objectId
{
  return (NSString *)sub_224D731BC((uint64_t)self, (uint64_t)a2, &OBJC_IVAR___ICThumbnailKey_objectId);
}
...
LABEL_5:
  ...
  uint64_t v5 = sub_224D813F8();
  uint64_t v7 = v6;
  if (!a4) {
    goto LABEL_5;
  }
LABEL_3:
  uint64_t v8 = sub_224D813F8();
  uint64_t v10 = v9;
  return (ICThumbnailKey *)ThumbnailKey.init(accountId:objectId:)(v5, v7, v8, v10);
}
...
- (ICThumbnailKey)initWithType:(int64_t)a3 accountId:(id)a4 objectId:(id)a5 preferredSize:(CGSize)a6 scale:(double)a7 appearance:(unint64_t)a8 isRTL:(BOOL)a9 contentSizeCategory:(id)a10 hasBoldText:(BOOL)a11 hasButtonShapes:(BOOL)a12 hasDarkerSystemColors:(BOOL)a13 hasBorder:(BOOL)a14
{
  ...
  if (a4)
  {
    v20 = (void *)sub_224D813F8();
    uint64_t v22 = v21;
    if (v18)
    {
LABEL_3:
      uint64_t v18 = sub_224D813F8();
      uint64_t v24 = v23;
      goto LABEL_6;
    }
  }
...
LABEL_6:
  ...
  return (ICThumbnailKey *)sub_224D775F4(a3, v20, v22, v18, v24, a8, v25, v27, width, height, a7, a11, a13, a14);
}
...
LABEL_5:
  ...
  uint64_t v14 = sub_224D813F8();
  uint64_t v16 = v15;
  if (!a5) {
    goto LABEL_5;
  }
LABEL_3:
  uint64_t v17 = sub_224D813F8();
  uint64_t v19 = v18;
  return (ICThumbnailKey *)ThumbnailKey.init(type:accountId:objectId:preferredSize:scale:appearance:)(a3, width, height, a7, v14, v16, v17, v19, a8);
}
...
- (NSURL)containerUrl
{
  ...
  uint64_t v7 = self;
  sub_224D74614((uint64_t)v6);

  uint64_t v8 = (void *)sub_224D812A8();
...
- (NSURL)descriptionUrl
{
  return (NSURL *)sub_224D74A64(self, (uint64_t)a2, MEMORY[0x263F8F388]);
}

- (NSURL)imageUrl
{
  return (NSURL *)sub_224D74A64(self, (uint64_t)a2, MEMORY[0x263F8F380]);
}
