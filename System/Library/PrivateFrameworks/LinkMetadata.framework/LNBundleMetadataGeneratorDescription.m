...
- (BOOL)isEqual:(id)a3
{
  v4 = (LNBundleMetadataGeneratorDescription *)a3;
  v5 = v4;
  if (self != v4)
  {
    v6 = v4;
...
- (id)description
{
  ...
  unint64_t v6 = [(LNBundleMetadataGeneratorDescription *)self name];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v6 = [(LNBundleMetadataGeneratorDescription *)self version];
...
- (LNBundleMetadataGeneratorDescription)initWithName:(id)a3 version:(id)a4
{
  ...
  else
  {
    ...
    [v17 handleFailureInMethod:a2, self, @"LNBundleMetadataGeneratorDescription.m", 17, @"Invalid parameter not satisfying: %@", @"name" object file lineNumber description];
  ...
  [v18 handleFailureInMethod:a2, self, @"LNBundleMetadataGeneratorDescription.m", 18, @"Invalid parameter not satisfying: %@", @"version" object file lineNumber description];

LABEL_3:
  v19.receiver = self;
  v19.super_class = (Class)LNBundleMetadataGeneratorDescription;
  id v10 = [(LNBundleMetadataGeneratorDescription *)&v19 init];
  if (v10)
  {
