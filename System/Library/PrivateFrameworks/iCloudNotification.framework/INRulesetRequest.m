...
- (INRulesetRequest)initWithAccount:(id)a3;
- (id)account;
- (id)urlRequest;
- (id)urlString;
...
- (INRulesetRequest)initWithAccount:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)INRulesetRequest;
...
- (id)urlString
{
  ...
  if (v3)
  {
    ...
    id v5 = [v4 objectForKey:@"iCloudRecommendationRules"];
...
{
  v6.receiver = self;
  v6.super_class = (Class)INRulesetRequest;
  v3 = [(INRulesetRequest *)&v6 urlRequest];
