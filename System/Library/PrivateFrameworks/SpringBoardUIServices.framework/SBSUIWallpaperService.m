...
+ (id)_setupAndActivateServiceClientConnection
{
  v3 = (void *)MEMORY[0x1E4F62888];
  id v4 = +[SBSUIWallpaperServiceInterfaceSpecification identifier];
  v5 = [v3 endpointForMachName:@"com.apple.paperboard.services" service:v4 instance:0];

  id v6 = [MEMORY[0x1E4F62880] connectionWithEndpoint:v5];
...
{
  id v3 = a2;
  id v4 = +[SBSUIWallpaperServiceInterfaceSpecification interface];
  [v3 setInterface:v4];

  v5 = +[SBSUIWallpaperServiceInterfaceSpecification serviceQuality];
...
void __65__SBSUIWallpaperService__setupAndActivateServiceClientConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v8 = 2114;
    id v9 = v2;
    _os_log_impl(&dword_1A7607000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@ Received invalidation for connection: %{public}@", (uint8_t *)&v6, 0x16u);
  }
}
