...
- (id)defaultExtensions
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SBUISystemApertureContinuitySceneSpecification;
...
- (Class)uiSceneMinimumClass
{
  return NSClassFromString(&cfstr_Sbsystemapertu.isa);
}

- (id)uiSceneSessionRole
{
  return @"SBUIWindowSceneSessionRoleSystemApertureContinuity";
}
