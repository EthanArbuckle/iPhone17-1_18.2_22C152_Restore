...
- (SBUIPasscodeLockViewInstallTonightSimpleFixedDigitKeypad)initWithLightStyle:(BOOL)a3 numberOfDigits:(unint64_t)a4
{
  ...
  v5 = [(SBUIPasscodeLockViewSimpleFixedDigitKeypad *)&v16 initWithLightStyle:a3 numberOfDigits:a4];
  if (v5)
  {
    ...
    v13 = [MEMORY[0x1E4F42A30] systemFontOfSize:16.0];
    [v12 setFont:v13];
    ...
    [(SBUIPasscodeLockViewInstallTonightSimpleFixedDigitKeypad *)v5 setShowsCancelButton:1];
  }
  return v5;
}
...
- (void)passcodeEntryFieldTextDidChange:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v6 = [(SBUIPasscodeLockViewWithKeypad *)self _numberPad];
    v7 = v6;
    uint64_t v8 = 1;
  }
  else
  ...
  [v6 setShowsBackspaceButton:v8];

  uint64_t v9 = [(SBUIPasscodeLockViewBase *)self delegate];
  if (v9)
  {
    v10 = (void *)v9;
