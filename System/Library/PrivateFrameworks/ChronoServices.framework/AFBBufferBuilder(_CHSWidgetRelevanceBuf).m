...
- (id)_chsCreateWidgetRelevanceBufUsingBlock:()_CHSWidgetRelevanceBuf
{
  ...
  if (!v5)
  {
    ...
    [v10 handleFailureInMethod:a2, a1, @"_CHSRelevanceCache_generated.mm", 1921, @"Invalid parameter not satisfying: %@", @"block" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  v7 = -[_CHSWidgetRelevanceBufBuilder initWithBufferBuilder:]((id *)[_CHSWidgetRelevanceBufBuilder alloc], a1);
  v5[2](v5, v7);
...
- (id)_chsFinishedBufferWithRootWidgetRelevanceBufOfs:()_CHSWidgetRelevanceBuf error:
{
  ...
  if (!v7)
  {
    ...
    [v16 handleFailureInMethod:a2, a1, @"_CHSRelevanceCache_generated.mm", 1943, @"Invalid parameter not satisfying: %@", @"ofs" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  v8 = [a1 firstError];
  ...
  else
  {
    ...
    id v18 = 0;
    int v12 = [a1 _chsFinishBufferWithRootWidgetRelevanceBufOfs:v7 error:&v18];
    id v13 = v18;
    if (v12)
    {
      id v17 = v13;
...
- (uint64_t)_chsFinishBufferWithRootWidgetRelevanceBufOfs:()_CHSWidgetRelevanceBuf error:
{
  ...
  if (!v7)
  {
    ...
    [v19 handleFailureInMethod:a2, a1, @"_CHSRelevanceCache_generated.mm", 1977, @"Invalid parameter not satisfying: %@", @"ofs" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  v8 = [a1 firstError];
