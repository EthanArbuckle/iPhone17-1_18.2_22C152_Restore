...
- (PGInvariantDaughterFeatureExtractor)initWithError:(id *)a3
{
  ...
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:@"DAUGHTER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_42100];

  return v13;
}

__CFString *__53__PGInvariantDaughterFeatureExtractor_initWithError___block_invoke()
{
  v0 = @"DAUGHTER";
  return @"DAUGHTER";
}
