...
- (PGInvariantFamilyFeatureExtractor)initWithError:(id *)a3
{
  ...
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:v4 featureNames:v5 relation:v12 labelForTargetBlock:&__block_literal_global_22742];
