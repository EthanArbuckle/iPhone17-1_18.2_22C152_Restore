...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v7 = v4;
      BOOL v6 = v7->_minimumWallpaperScore == self->_minimumWallpaperScore
...
- (id)copyWithZone:(_NSZone *)a3
{
  id result = +[PGCityscapeWallpaperSuggesterFilteringContext allocWithZone:a3];
  *((void *)result + 3) = *(void *)&self->_minimumWallpaperScore;
  *((void *)result + 4) = *(void *)&self->_absoluteMinimumWallpaperScore;
  *((void *)result + 5) = *(void *)&self->_minimumCropScore;
  *((unsigned char *)result + 8) = self->_ignoreClockOverlap;
  *((void *)result + 6) = *(void *)&self->_timeIntervalForCandidateDeduping;
  *((void *)result + 7) = *(void *)&self->_maximumLowLightScore;
  *((void *)result + 8) = *(void *)&self->_maximumCropZoomRatio;
  return result;
}
...
- (id)initForTopCityscapes:(BOOL)a3 withDictionary:(id)a4 orientation:(int64_t)a5
{
  ...
  if (v9)
  {
    ...
    v14 = [v8 objectForKeyedSubscript:@"absoluteMinimumWallpaperScore"];
    if (v14)
    {
      v15 = [v8 objectForKeyedSubscript:@"absoluteMinimumWallpaperScore"];
      [v15 doubleValue];
      v10[4] = v16;
    }
    v17 = [v8 objectForKeyedSubscript:@"minimumCropScore"];
    if (v17)
    {
      v18 = [v8 objectForKeyedSubscript:@"minimumCropScore"];
      [v18 doubleValue];
      v10[5] = v19;
    }
    v20 = [v8 objectForKeyedSubscript:@"ignoreClockOverlap"];
    if (v20)
    {
      v21 = [v8 objectForKeyedSubscript:@"ignoreClockOverlap"];
      *((unsigned char *)v10 + 8) = [v21 BOOLValue];
    }
    v22 = [v8 objectForKeyedSubscript:@"timeIntervalForCandidateDeduping"];
    if (v22)
    {
      v23 = [v8 objectForKeyedSubscript:@"timeIntervalForCandidateDeduping"];
      [v23 doubleValue];
      v10[6] = v24;
    }
    v25 = [v8 objectForKeyedSubscript:@"maximumLowLightScore"];
    if (v25)
    {
      v26 = [v8 objectForKeyedSubscript:@"maximumLowLightScore"];
      [v26 doubleValue];
      v10[7] = v27;
    }
    v28 = [v8 objectForKeyedSubscript:@"maximumCropZoomRatio"];
    if (v28)
    {
      v29 = [v8 objectForKeyedSubscript:@"maximumCropZoomRatio"];
      [v29 doubleValue];
      v10[8] = v30;
    }
  }
...
- (void)_commonInitInOrientation:(int64_t)a3
{
  ...
  *(_OWORD *)&self->_minimumCropScore = xmmword_1D1F4F1F0;
