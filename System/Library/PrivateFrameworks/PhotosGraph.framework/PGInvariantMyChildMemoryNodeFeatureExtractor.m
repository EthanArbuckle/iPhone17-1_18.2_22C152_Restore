...
- (PGInvariantMyChildMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)PGInvariantMyChildMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"CHILD" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_8_64441];

  return v14;
}

__CFString *__62__PGInvariantMyChildMemoryNodeFeatureExtractor_initWithError___block_invoke()
{
  return @"MyChild";
}
