...
- (PGInvariantSisterMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  ...
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"SISTER" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_40757];

  return v14;
}

__CFString *__61__PGInvariantSisterMemoryNodeFeatureExtractor_initWithError___block_invoke()
{
  v0 = @"SISTER";
  return @"SISTER";
}
