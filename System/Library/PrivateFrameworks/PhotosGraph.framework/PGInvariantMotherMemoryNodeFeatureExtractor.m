...
- (PGInvariantMotherMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  ...
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"MOTHER" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_46289];

  return v14;
}

__CFString *__61__PGInvariantMotherMemoryNodeFeatureExtractor_initWithError___block_invoke()
{
  v0 = @"MOTHER";
  return @"MOTHER";
}
