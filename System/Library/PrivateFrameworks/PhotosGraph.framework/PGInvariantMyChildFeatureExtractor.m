...
- (PGInvariantMyChildFeatureExtractor)initWithError:(id *)a3
{
  ...
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:@"CHILD" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_64431];

  return v13;
}

__CFString *__52__PGInvariantMyChildFeatureExtractor_initWithError___block_invoke()
{
  return @"MyChild";
}
