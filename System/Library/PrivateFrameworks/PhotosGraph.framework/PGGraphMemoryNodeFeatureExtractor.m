...
- (PGGraphMemoryNodeFeatureExtractor)initWithError:(id *)a3;
- (PGGraphMemoryNodeFeatureExtractor)initWithName:(id)a3 featureNames:(id)a4 relation:(id)a5 labelForTargetBlock:(id)a6;
...
{
  v7.receiver = self;
  v7.super_class = (Class)PGGraphMemoryNodeFeatureExtractor;
