...
{
  v7.receiver = self;
  v7.super_class = (Class)PGKeyCurator_PHAsset;
...
{
  v9.receiver = self;
  v9.super_class = (Class)PGKeyCurator_PHAsset;
  objc_super v7 = [(PGKeyCurator *)&v9 keyItemInItems:a3 options:a4 criteria:a5 debugInfo:a6 progressBlock:a7];
  return v7;
}
...
- (id)keyAssetWithFeeder:(id)a3 options:(id)a4 criteria:(id)a5 debugInfo:(id)a6 progressBlock:(id)a7
{
  v9.receiver = self;
  v9.super_class = (Class)PGKeyCurator_PHAsset;
  objc_super v7 = [(PGKeyCurator *)&v9 keyItemWithFeeder:a3 options:a4 criteria:a5 debugInfo:a6 progressBlock:a7];
  return v7;
}
