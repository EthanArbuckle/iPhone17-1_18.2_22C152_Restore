...
- (PGHighlightTitlingQuestion)initWithHighlightTitle:(id)a3 legacyHighlightTitle:(id)a4 keyAssetUUID:(id)a5 localFactoryScore:(double)a6 duplicatedTitles:(BOOL)a7;
...
- (PGHighlightTitlingQuestion)initWithHighlightTitle:(id)a3 legacyHighlightTitle:(id)a4 keyAssetUUID:(id)a5 localFactoryScore:(double)a6 duplicatedTitles:(BOOL)a7
{
  ...
  id v14 = a5;
  v24.receiver = self;
  v24.super_class = (Class)PGHighlightTitlingQuestion;
  ...
  if (v15)
  {
    ...
    v25[0] = *MEMORY[0x1E4F8EA90];
    v25[1] = v17;
    v26[0] = v12;
    v26[1] = &unk_1F28D0F48;
    uint64_t v18 = *MEMORY[0x1E4F8EA98];
    v26[2] = v13;
