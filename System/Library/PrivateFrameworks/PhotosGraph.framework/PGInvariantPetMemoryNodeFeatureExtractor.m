...
{
  return +[PGInvariantPetMemoryNodeFeatureExtractor _nodeProcessingForVersion:*(void *)(a1 + 32) node:a2];
}

- (PGInvariantPetMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  return [(PGInvariantPetMemoryNodeFeatureExtractor *)self initWithVersion:1 error:a3];
}
