    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        *(float *)&double v14 = v14;
        int v17 = LODWORD(v14);
        v15 = objc_msgSend(objc_alloc(MEMORY[0x1E4F71ED0]), "initWithFloats:count:", &v17, -[PGFeatureExtractorFaceQuality featureLength](self, "featureLength"));
        [v7 appendRow:v15];
      }
...
- (id)defaultFloatVectorWithError:(id *)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F71ED0]) initWithArray:&unk_1F28D3A20];
  return v3;
}
