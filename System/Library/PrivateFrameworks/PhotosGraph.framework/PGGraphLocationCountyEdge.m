...
- (PGGraphLocationCountyEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  return (PGGraphLocationCountyEdge *)[(PGGraphLocationCountyEdge *)self initFromLocationNode:a4 toCountyNode:a5];
}
...
+ (id)filter
{
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F71EB0]) initWithLabel:@"COUNTY" domain:200];
  return v2;
}
