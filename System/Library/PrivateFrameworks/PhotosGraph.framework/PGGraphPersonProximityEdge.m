...
- (PGGraphPersonProximityEdge)initWithLabel:(id)a3 sourceNode:(id)a4 targetNode:(id)a5 domain:(unsigned __int16)a6 properties:(id)a7
{
  return (PGGraphPersonProximityEdge *)[(PGGraphPersonProximityEdge *)self initFromPersonNode:a4 toMomentNode:a5];
}
...
+ (id)filter
{
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F71EB0]) initWithLabel:@"IN_PROXIMITY" domain:300];
  return v2;
}
