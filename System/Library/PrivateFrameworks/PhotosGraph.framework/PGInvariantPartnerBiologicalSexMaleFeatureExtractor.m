...
{
  return +[PGInvariantPartnerBiologicalSexMaleFeatureExtractor name];
}
...
+ (id)name
{
  return +[PGInvariantPartnerBiologicalSexMaleFeatureExtractor labelProcessingForLabel:*MEMORY[0x1E4F76B90] sex:2];
}
