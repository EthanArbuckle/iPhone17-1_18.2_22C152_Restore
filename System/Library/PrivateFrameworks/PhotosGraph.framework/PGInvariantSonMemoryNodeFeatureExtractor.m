...
- (PGInvariantSonMemoryNodeFeatureExtractor)initWithError:(id *)a3
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)PGInvariantSonMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v16 initWithName:@"SON" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_43656];

  return v14;
}

__CFString *__58__PGInvariantSonMemoryNodeFeatureExtractor_initWithError___block_invoke()
{
  v0 = @"SON";
  return @"SON";
}
