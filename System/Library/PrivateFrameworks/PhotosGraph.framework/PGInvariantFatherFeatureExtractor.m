...
- (PGInvariantFatherFeatureExtractor)initWithError:(id *)a3
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)PGInvariantFatherFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v15 initWithName:@"FATHER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_70738];

  return v13;
}

__CFString *__51__PGInvariantFatherFeatureExtractor_initWithError___block_invoke()
{
  v0 = @"FATHER";
  return @"FATHER";
}
