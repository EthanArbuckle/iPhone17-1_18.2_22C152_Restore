...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  int64_t v9 = [(PGFeatureExtractorPleasantCompositionScore *)self featureLength];
  LODWORD(v10) = v7;
...
- (id)name
{
  v2 = @"PleasantCompositionScore";
  return @"PleasantCompositionScore";
}
