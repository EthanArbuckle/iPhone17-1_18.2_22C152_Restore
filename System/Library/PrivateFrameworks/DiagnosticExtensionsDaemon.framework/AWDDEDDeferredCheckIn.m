...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDDEDDeferredCheckIn;
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v6 = [NSNumber numberWithUnsignedLongLong:self->_numtasks];
...
- (BOOL)readFrom:(id)a3
{
  return AWDDEDDeferredCheckInReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 1) == 0 || self->_numtasks != *((void *)v4 + 1)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
LABEL_3:
  unint64_t v3 = 2654435761u * self->_numtasks;
  return v3 ^ v2;
}
