...
- (id)description
{
  ...
  int v4 = [(AWDDEDFinisherStarted *)&v8 description];
...
LABEL_9:
  ...
  v6 = [NSNumber numberWithUnsignedLongLong:self->_numfiles];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 4) == 0 || self->_timestamp != *((void *)v4 + 3)) {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 2) == 0 || self->_numfiles != *((void *)v4 + 2)) {
      goto LABEL_21;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 1) == 0 || self->_numbytes != *((void *)v4 + 1)) {
      goto LABEL_21;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 8) != 0)
  {
    if ((*((unsigned char *)v4 + 36) & 8) == 0 || self->_type != *((_DWORD *)v4 + 8)) {
      goto LABEL_21;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  if ((*(unsigned char *)&self->_has & 4) != 0)
  {
    ...
    {
LABEL_3:
      unint64_t v3 = 2654435761u * self->_numfiles;
      if (*(unsigned char *)&self->_has) {
        goto LABEL_4;
      }
LABEL_8:
