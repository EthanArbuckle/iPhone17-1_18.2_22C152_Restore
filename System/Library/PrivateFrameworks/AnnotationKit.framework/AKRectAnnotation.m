...
+ (id)displayNameForUndoablePropertyChangeWithKey:(id)a3
{
  ...
  if (![v4 isEqualToString:@"cornerRadius"]
    || (+[AKController akBundle],
        ...
        [v5 localizedStringForKey:@"Corner Radius" value:&stru_26EA57918 table:@"AnnotationStrings"], v6 = objc_claimAutoreleasedReturnValue(), v5, !v6))
  {
    v8.receiver = a1;
...
- (id)displayName
{
  ...
  v3 = [v2 localizedStringForKey:@"Rectangle" value:&stru_26EA57918 table:@"AnnotationStrings"];
...
- (id)keysForValuesToObserveForUndo
{
  ...
  [v4 addObjectsFromArray:&unk_26EA75E18];
...
- (id)keysForValuesToObserveForRedrawing
{
  ...
  [v4 addObjectsFromArray:&unk_26EA75E30];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [(AKRectAnnotation *)self cornerRadius];
  objc_msgSend(v4, "encodeDouble:forKey:", @"cornerRadius");
}
