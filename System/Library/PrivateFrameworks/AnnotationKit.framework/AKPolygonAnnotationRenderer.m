...
+ (CGPath)_newConcreteTextExclusionPathForAnnotation:(id)a3 withOptionalAnnotationRect:(CGRect)a4
{
  ...
  {
    CGFloat v20 = v32 / v18;
    CGFloat v21 = (const CGPath *)[a1 _newPathForAnnotation:v9];
...
+ (void)_concreteRenderAnnotation:(id)a3 intoContext:(CGContext *)a4 forDisplay:(BOOL)a5 pageControllerOrNil:(id)a6
{
  ...
  CGContextSaveGState(a4);
  CGFloat v13 = (const CGPath *)[a1 _newPathForAnnotation:v10];
...
+ (CGPath)_newPathForAnnotation:(id)a3
{
  ...
  int64_t v12 = +[AKGeometryHelper inverseExifOrientation:](AKGeometryHelper, "inverseExifOrientation:", [v3 originalExifOrientation]);
  ...
  double v17 = +[AKGeometryHelper verticesOfPolygonWithPointCount:inRect:rotation:flippedVertically:](AKGeometryHelper, "verticesOfPolygonWithPointCount:inRect:rotation:flippedVertically:", [v3 pointCount], objc_msgSend(v3, "verticallyFlipped"), v13, v14, v15, v16, v5);
  if ([v3 pointCount])
  {
    unint64_t v18 = 0;
    do
