...
- (void)setIntersectionFunctionTables:(const void *)a3 withBufferRange:(_NSRange)a4
{
  ...
  if ([(MTLDevice *)[(_MTLIndirectArgumentEncoder *)self device] requiresRaytracingEmulation])
  {
    ...
    -[IOGPUMetalIndirectArgumentEncoder setVisibleFunctionTables:withBufferRange:](self, "setVisibleFunctionTables:withBufferRange:", (char *)v12 - ((8 * length + 15) & 0xFFFFFFFFFFFFFFF0), location, length);
  }
  else
  {
    [(IOGPUMetalIndirectArgumentEncoder *)self doesNotRecognizeSelector:a2];
