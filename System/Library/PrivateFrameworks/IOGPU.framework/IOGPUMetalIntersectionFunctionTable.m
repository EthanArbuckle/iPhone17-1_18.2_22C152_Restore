...
{
  v6.receiver = self;
  v6.super_class = (Class)IOGPUMetalIntersectionFunctionTable;
  v4 = -[IOGPUMetalResource initWithResource:](&v6, sel_initWithResource_);
  if (v4) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)IOGPUMetalIntersectionFunctionTable;
