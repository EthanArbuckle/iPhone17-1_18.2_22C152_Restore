...
- (WGWidgetPinningTeachingView)init
{
  ...
  if (v2)
  {
    ...
    [v4 addObserver:v3 selector:sel__contentSizeCategoryDidChange name:*MEMORY[0x263F1D158] object:0];
  }
  return v3;
}
...
- (void)_yesButtonTapped
{
  id v3 = [(WGWidgetPinningTeachingView *)self delegate];
...
- (void)_createContainerViews
{
  id v3 = (UIView *)objc_alloc_init(MEMORY[0x263F1CB60]);
  contentView = self->_contentView;
  self->_contentView = v3;

  v5 = self->_contentView;
  objc_super v6 = [MEMORY[0x263F1C550] systemGrayColor];
...
- (void)_createContentViews
{
  id v40 = [(WGWidgetPinningTeachingView *)self contentView];
  uint64_t v38 = *MEMORY[0x263F1D2C0];
  id v3 = objc_msgSend(MEMORY[0x263F1C660], "preferredFontDescriptorWithTextStyle:");
  ...
  objc_super v6 = self->_titleLabel;
  v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"WIDGETS_EDIT_TODAY_HEADLINE" value:&stru_26D5C79B8 table:@"Widgets"];
  [(UILabel *)v6 setText:v8];

  v9 = self->_titleLabel;
  v10 = [MEMORY[0x263F1C658] fontWithDescriptor:v39 size:0.0];
  ...
  v15 = [v14 localizedStringForKey:@"WIDGETS_PIN_TEACHING_BODY" value:&stru_26D5C79B8 table:@"Widgets"];
  [(UILabel *)v13 setText:v15];

  [(UILabel *)self->_bodyLabel setNumberOfLines:0];
  v16 = self->_bodyLabel;
  v17 = [MEMORY[0x263F1C658] preferredFontForTextStyle:v38];
  ...
  v22 = [v21 localizedStringForKey:@"WIDGETS_PIN_TEACHING_YES_BUTTON" value:&stru_26D5C79B8 table:@"Widgets"];
  [(UIButton *)v20 setTitle:v22 forState:0];

  v23 = self->_yesButton;
  v24 = [MEMORY[0x263F1C550] colorWithWhite:1.0 alpha:0.1];
  [(UIButton *)v23 setBackgroundColor:v24];

  v25 = [(UIButton *)self->_yesButton titleLabel];
  v26 = [MEMORY[0x263F1C658] preferredFontForTextStyle:v38];
  [v25 setFont:v26];
  ...
  v31 = [v30 localizedStringForKey:@"WIDGETS_PIN_TEACHING_NO_BUTTON" value:&stru_26D5C79B8 table:@"Widgets"];
  [(UIButton *)v29 setTitle:v31 forState:0];

  v32 = self->_noButton;
  v33 = [MEMORY[0x263F1C550] colorWithWhite:1.0 alpha:0.1];
  [(UIButton *)v32 setBackgroundColor:v33];

  v34 = [(UIButton *)self->_noButton titleLabel];
  v35 = [MEMORY[0x263F1C658] preferredFontForTextStyle:v38];
  [v34 setFont:v35];
...
- (void)_createConstraints
{
  id v64 = [(WGWidgetPinningTeachingView *)self contentView];
  id v3 = [(WGWidgetPinningTeachingView *)self heightAnchor];
  v4 = [v64 heightAnchor];
  v5 = [v3 constraintEqualToAnchor:v4 multiplier:1.0];
  [v5 setActive:1];

  objc_super v6 = [(WGWidgetPinningTeachingView *)self widthAnchor];
  v7 = [v64 widthAnchor];
  ...
  id v40 = [(UILabel *)self->_bodyLabel lastBaselineAnchor];
...
- (void)_updateFonts
{
  uint64_t v3 = *MEMORY[0x263F1D2C0];
  v4 = [MEMORY[0x263F1C660] preferredFontDescriptorWithTextStyle:*MEMORY[0x263F1D2C0]];
  id v9 = [v4 fontDescriptorWithSymbolicTraits:2];

  v5 = [MEMORY[0x263F1C658] fontWithDescriptor:v9 size:0.0];
  [(UILabel *)self->_titleLabel setFont:v5];
  objc_super v6 = [MEMORY[0x263F1C658] preferredFontForTextStyle:v3];
...
- (void)_updateAppearance
{
  double v3 = [(WGWidgetPinningTeachingView *)self traitCollection];
  uint64_t v4 = [v3 userInterfaceStyle];

  double v5 = [(WGWidgetPinningTeachingView *)self contentView];
  if (v4 == 2)
  {
    double v6 = [MEMORY[0x263F1C550] systemGray6Color];
    ...
    bodyLabel = self->_bodyLabel;
    v10 = [MEMORY[0x263F1C550] systemGrayColor];
    ...
    v13 = self->_yesButton;
    v14 = [MEMORY[0x263F1C550] systemGray4Color];
    ...
    v17 = self->_noButton;
    [MEMORY[0x263F1C550] systemGray4Color];
  }
  else
  {
    ...
    v21 = self->_bodyLabel;
    v22 = [MEMORY[0x263F1C550] systemGrayColor];
    ...
    v25 = self->_yesButton;
    v26 = [MEMORY[0x263F1C550] systemGray5Color];
    ...
    v17 = self->_noButton;
    [MEMORY[0x263F1C550] systemGray5Color];
  }
...
- (WGWidgetPinningTeachingViewDelegate)delegate
{
  ...
  return (WGWidgetPinningTeachingViewDelegate *)WeakRetained;
}
