...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315138;
    v8 = "-[WebBookmarkProductionSafariCloudKitSyncTabCollection dealloc]";
    _os_log_impl(&dword_21C043000, v4, OS_LOG_TYPE_INFO, "@@ %s: Unlocking tabs database", buf, 0xCu);
  }
  ...
  v6.receiver = self;
  v6.super_class = (Class)WebBookmarkProductionSafariCloudKitSyncTabCollection;
