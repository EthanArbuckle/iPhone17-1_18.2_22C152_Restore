...
- (id)description
{
  ...
  v4 = [(GEOPDPlaceSummaryLayoutUnitHikeRouteFactoidElevationGainLoss *)&v8 description];
  v5 = [(GEOPDPlaceSummaryLayoutUnitHikeRouteFactoidElevationGainLoss *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    [(GEOPDPlaceSummaryLayoutUnitHikeRouteFactoidElevationGainLoss *)self readAll:1];
    [v4 readAll:1];
  }
