...
- (id)description
{
  ...
  id v4 = [(GEOActiveResourceFilters *)&v8 description];
  v5 = [(GEOActiveResourceFilters *)self dictionaryRepresentation];
          ...
          do
          {
            for (uint64_t i = 0; i != v9; ++i)
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                ...
                if (a3) {
                  uint64_t v14 = [(GEOActiveResourceFilter *)v13 initWithJSON:v12];
                }
                else {
                  uint64_t v14 = [(GEOActiveResourceFilter *)v13 initWithDictionary:v12];
                }
                v15 = (void *)v14;
                [a1 addFilter:v14];
              }
...
{
  id v8 = a3;
  [(GEOActiveResourceFilters *)self readAll:0];
  if ([(GEOActiveResourceFilters *)self filtersCount])
  {
    [v8 clearFilters];
    unint64_t v4 = [(GEOActiveResourceFilters *)self filtersCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(GEOActiveResourceFilters *)self filterAtIndex:i];
        [v8 addFilter:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    char v5 = 1;
    [(GEOActiveResourceFilters *)self readAll:1];
    [v4 readAll:1];
    filters = self->_filters;
    if ((unint64_t)filters | v4[2]) {
      char v5 = -[NSMutableArray isEqual:](filters, "isEqual:");
    }
  }
  else
  {
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)filters hash];
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOActiveResourceFilters addFilter:](self, "addFilter:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
