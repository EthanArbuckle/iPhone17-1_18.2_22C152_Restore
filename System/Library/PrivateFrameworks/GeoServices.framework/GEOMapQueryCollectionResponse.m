...
- (id)description
{
  ...
  v4 = [(GEOMapQueryCollectionResponse *)&v8 description];
  v5 = [(GEOMapQueryCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    [(GEOMapQueryCollectionResponse *)self readAll:1];
    [v4 readAll:1];
  }
