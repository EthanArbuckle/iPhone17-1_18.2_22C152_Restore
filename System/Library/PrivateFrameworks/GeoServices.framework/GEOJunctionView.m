...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GEOJunctionView)initWithDictionary:(id)a3;
- (GEOJunctionView)initWithJSON:(id)a3;
...
@implementation GEOJunctionView
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOJunctionView;
  id v4 = [(GEOJunctionView *)&v8 description];
  v5 = [(GEOJunctionView *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOJunctionView _dictionaryRepresentation:](self, 0);
}
  ...
  if (a1)
  {
    ...
    if (v15)
    {
      ...
      if (a2)
      {
        ...
        v22[1] = 3221225472;
        v22[2] = __45__GEOJunctionView__dictionaryRepresentation___block_invoke;
        v22[3] = &unk_1E53D8860;
        id v19 = v18;
        id v23 = v19;
...
- (id)jsonRepresentation
{
  return -[GEOJunctionView _dictionaryRepresentation:](self, 1);
}

void __45__GEOJunctionView__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (GEOJunctionView)initWithDictionary:(id)a3
{
  return (GEOJunctionView *)-[GEOJunctionView _initWithDictionary:isJSON:](self, a3, 0);
}
...
- (GEOJunctionView)initWithJSON:(id)a3
{
  return (GEOJunctionView *)-[GEOJunctionView _initWithDictionary:isJSON:](self, a3, 1);
}

+ (BOOL)isValid:(id)a3
{
  return GEOJunctionViewIsValid((char *)a3);
}

- (BOOL)readFrom:(id)a3
{
  return GEOJunctionViewReadAllFrom(self, a3);
}
...
{
  id v8 = a3;
  [(GEOJunctionView *)self readAll:0];
  if ([(GEOJunctionView *)self imageIdsCount])
  {
    [v8 clearImageIds];
    unint64_t v4 = [(GEOJunctionView *)self imageIdsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(GEOJunctionView *)self imageIdAtIndex:i];
        [v8 addImageId:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    char v5 = 1;
    [(GEOJunctionView *)self readAll:1];
    [v4 readAll:1];
    imageIds = self->_imageIds;
    if ((unint64_t)imageIds | v4[2]) {
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)imageIds hash];
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOJunctionView addImageId:](self, "addImageId:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
