...
- (GEORPCuratedCollectionFeedback)init
{
  ...
  v2 = [(GEORPCuratedCollectionFeedback *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEORPCuratedCollectionFeedback)initWithData:(id)a3
{
  ...
  v3 = [(GEORPCuratedCollectionFeedback *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPCuratedCollectionFeedbackReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readCuratedCollectionContext_tags);
        objc_sync_exit(v3);
      }
    }
...
- (GEORPCuratedCollectionContext)curatedCollectionContext
{
  ...
  return curatedCollectionContext;
}
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPCuratedCollectionFeedbackReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readCuratedCollectionCorrections_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (GEORPCuratedCollectionCorrections)curatedCollectionCorrections
{
  ...
  return curatedCollectionCorrections;
}
...
- (id)description
{
  ...
  v4 = [(GEORPCuratedCollectionFeedback *)&v8 description];
  v5 = [(GEORPCuratedCollectionFeedback *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(void *)a1
{
  if (a1)
  {
    ...
    v5 = [a1 curatedCollectionContext];
    objc_super v6 = v5;
    if (v5)
    {
      if (a2)
      {
        ...
        objc_super v8 = @"curatedCollectionContext";
      }
      else
      {
        objc_super v7 = [v5 dictionaryRepresentation];
        objc_super v8 = @"curated_collection_context";
      }
      [v4 setObject:v7 forKey:v8];
    }
    v9 = [a1 curatedCollectionCorrections];
    v10 = v9;
    if (v9)
    {
      if (a2)
      {
        ...
        v12 = @"curatedCollectionCorrections";
      }
      else
      {
        v11 = [v9 dictionaryRepresentation];
        v12 = @"curated_collection_corrections";
      }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3) {
        objc_super v6 = @"curatedCollectionContext";
      }
      else {
        objc_super v6 = @"curated_collection_context";
      }
      objc_super v7 = [v5 objectForKeyedSubscript:v6];
      objc_opt_class();
      if (objc_opt_isKindOfClass())
      {
        objc_super v8 = [GEORPCuratedCollectionContext alloc];
        if (a3) {
          uint64_t v9 = [(GEORPCuratedCollectionContext *)v8 initWithJSON:v7];
        }
        else {
          uint64_t v9 = [(GEORPCuratedCollectionContext *)v8 initWithDictionary:v7];
        }
        id v10 = (void *)v9;
        [a1 setCuratedCollectionContext:v9];
      }
      if (a3) {
        v11 = @"curatedCollectionCorrections";
      }
      else {
        v11 = @"curated_collection_corrections";
      }
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (a3) {
          uint64_t v14 = [(GEORPCuratedCollectionCorrections *)v13 initWithJSON:v12];
        }
        else {
          uint64_t v14 = [(GEORPCuratedCollectionCorrections *)v13 initWithDictionary:v12];
        }
        v15 = (void *)v14;
        [a1 setCuratedCollectionCorrections:v14];
      }
    }
  }
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      objc_super v8 = (int *)&readAll__recursiveTag_605;
    }
    else {
      objc_super v8 = (int *)&readAll__nonRecursiveTag_606;
    }
  ...
  if (v3)
  {
    [(GEORPCuratedCollectionContext *)self->_curatedCollectionContext readAll:1];
    [(GEORPCuratedCollectionCorrections *)self->_curatedCollectionCorrections readAll:1];
  }
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    [(GEORPCuratedCollectionFeedback *)self readAll:0];
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    [(GEORPCuratedCollectionFeedback *)self readAll:0];
    id v8 = [(GEORPCuratedCollectionContext *)self->_curatedCollectionContext copyWithZone:a3];
    uint64_t v9 = *(void **)(v5 + 24);
    *(void *)(v5 + 24) = v8;

    id v10 = [(GEORPCuratedCollectionCorrections *)self->_curatedCollectionCorrections copyWithZone:a3];
    v11 = *(void **)(v5 + 32);
    *(void *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && (([(GEORPCuratedCollectionFeedback *)self readAll:1],
         [v4 readAll:1],
         curatedCollectionContext = self->_curatedCollectionContext,
     ...
     || -[GEORPCuratedCollectionContext isEqual:](curatedCollectionContext, "isEqual:")))
  {
    ...
    if ((unint64_t)curatedCollectionCorrections | v4[4]) {
      char v7 = -[GEORPCuratedCollectionCorrections isEqual:](curatedCollectionCorrections, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
{
  [(GEORPCuratedCollectionFeedback *)self readAll:1];
  unint64_t v3 = [(GEORPCuratedCollectionContext *)self->_curatedCollectionContext hash];
  return [(GEORPCuratedCollectionCorrections *)self->_curatedCollectionCorrections hash] ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(unsigned char *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      uint64_t v5 = reader;
      objc_sync_enter(v5);
      GEORPCuratedCollectionFeedbackReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_610);
      objc_sync_exit(v5);
    }
  }
  os_unfair_lock_unlock(p_readerLock);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(unsigned char *)&self->_flags |= 9u;
  ...
  {
    [(GEORPCuratedCollectionFeedback *)self readAll:0];
    [(GEORPCuratedCollectionContext *)self->_curatedCollectionContext clearUnknownFields:1];
    curatedCollectionCorrections = self->_curatedCollectionCorrections;
    [(GEORPCuratedCollectionCorrections *)curatedCollectionCorrections clearUnknownFields:1];
  }
}
