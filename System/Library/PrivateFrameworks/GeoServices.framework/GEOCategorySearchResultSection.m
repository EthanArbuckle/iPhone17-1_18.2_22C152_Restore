...
- (GEOCategorySearchResultSection)init
{
  result = (GEOCategorySearchResultSection *)[MEMORY[0x1E4F1CA00] raise:@"GEOMethodNotAvailableException" format:@"This method is unavailable."];
  __break(1u);
  return result;
}
...
- (GEOCategorySearchResultSection)initWithCategorySearchResultSection:(id)a3
{
  ...
  v5 = [(GEOCategorySearchResultSection *)&v15 init];
  if (v5)
  {
    int v6 = -[GEOPDSCategorySearchResultSection categorySearchResultSectionCellType]((uint64_t)v4);
    if (v6)
    {
      if (v6 != 1)
      {
LABEL_7:
        uint64_t v8 = -[GEOPDSCategorySearchResultSection sectionHeaderDisplayName](v4);
        headerDisplayName = v5->_headerDisplayName;
        v5->_headerDisplayName = (NSString *)v8;

        uint64_t v10 = -[GEOPDSCategorySearchResultSection sectionSubHeaderDisplayName](v4);
        subHeaderDisplayName = v5->_subHeaderDisplayName;
        v5->_subHeaderDisplayName = (NSString *)v10;

        uint64_t v12 = -[GEOPDSCategorySearchResultSection styleAttributes](v4);
