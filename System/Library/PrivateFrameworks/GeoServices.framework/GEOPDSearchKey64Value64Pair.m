...
@implementation GEOPDSearchKey64Value64Pair

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSearchKey64Value64Pair;
  v4 = [(GEOPDSearchKey64Value64Pair *)&v8 description];
  v5 = [(GEOPDSearchKey64Value64Pair *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return GEOPDSearchKey64Value64PairReadAllFrom((uint64_t)self, a3);
}
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_value != *((void *)v4 + 2)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
