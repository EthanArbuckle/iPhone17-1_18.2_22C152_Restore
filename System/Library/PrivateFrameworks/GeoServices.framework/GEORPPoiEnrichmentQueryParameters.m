...
- (id)description
{
  ...
  v4 = [(GEORPPoiEnrichmentQueryParameters *)&v8 description];
  v5 = [(GEORPPoiEnrichmentQueryParameters *)self dictionaryRepresentation];
...
{
  id v4 = a3;
  [(GEORPPoiEnrichmentQueryParameters *)self readAll:0];
  if (self->_scorecardVersion) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSString *)self->_scorecardVersion copyWithZone:a3];
  v7 = *(void **)(v5 + 16);
  *(void *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    char v5 = 1;
    [(GEORPPoiEnrichmentQueryParameters *)self readAll:1];
    [v4 readAll:1];
    scorecardVersion = self->_scorecardVersion;
    if ((unint64_t)scorecardVersion | v4[2]) {
      char v5 = -[NSString isEqual:](scorecardVersion, "isEqual:");
    }
  }
  else
  {
...
- (unint64_t)hash
{
  ...
  return [(NSString *)scorecardVersion hash];
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    [(GEORPPoiEnrichmentQueryParameters *)self setScorecardVersion:v5];
  }
}
