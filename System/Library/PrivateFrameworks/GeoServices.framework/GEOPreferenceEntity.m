...
- (id)description
{
  ...
  v4 = [(GEOPreferenceEntity *)&v8 description];
  v5 = [(GEOPreferenceEntity *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v5)
    {
      ...
      if (a2) {
        v7 = @"chargingNetworkMuid";
      }
      else {
        v7 = @"charging_network_muid";
      }
    ...
    if ((v5 & 2) != 0)
    {
      ...
      if (a2) {
        v9 = @"chargingStationMuid";
      }
      else {
        v9 = @"charging_station_muid";
      }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3) {
        v6 = @"chargingNetworkMuid";
      }
      else {
        v6 = @"charging_network_muid";
      }
      ...
      if (a3) {
        objc_super v8 = @"chargingStationMuid";
      }
      else {
        objc_super v8 = @"charging_station_muid";
      }
...
{
  id v5 = a3;
  [(GEOPreferenceEntity *)self readAll:0];
  char flags = (char)self->_flags;
  if (flags)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (flags)
  {
    *(void *)(v4 + 16) = self->_chargingNetworkMuid;
    *(unsigned char *)(v4 + 32) |= 1u;
    char flags = (char)self->_flags;
  }
  if ((flags & 2) != 0)
  {
    *(void *)(v4 + 24) = self->_chargingStationMuid;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOPreferenceEntity *)self readAll:1];
  [v4 readAll:1];
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 32) & 1) == 0 || self->_chargingNetworkMuid != *((void *)v4 + 2)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 32) & 2) == 0 || self->_chargingStationMuid != *((void *)v4 + 3)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    unint64_t v3 = 2654435761u * self->_chargingNetworkMuid;
    if ((*(unsigned char *)&self->_flags & 2) != 0) {
      goto LABEL_3;
    }
LABEL_5:
...
LABEL_3:
  unint64_t v4 = 2654435761u * self->_chargingStationMuid;
  return v4 ^ v3;
}
