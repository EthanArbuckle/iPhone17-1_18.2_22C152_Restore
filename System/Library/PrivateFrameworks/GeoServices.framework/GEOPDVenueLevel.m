...
- (id)description
{
  ...
  v4 = [(GEOPDVenueLevel *)&v8 description];
  v5 = [(GEOPDVenueLevel *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    if ((v5 & 2) != 0)
    {
      objc_super v8 = [NSNumber numberWithInt:*(unsigned int *)(a1 + 32)];
      [v4 setObject:v8 forKey:@"ordinal"];
    }
    id v9 = *(id *)(a1 + 16);
    v10 = v9;
    if (v9)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v8 = [(GEOPDVenueLabel *)self->_label copyWithZone:a3];
  id v9 = *(void **)(v6 + 16);
  *(void *)(v6 + 16) = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 1) == 0 || self->_levelId != *((void *)v4 + 3)) {
      goto LABEL_14;
    }
  }
...
LABEL_14:
  ...
  {
    if ((*((unsigned char *)v4 + 36) & 2) == 0 || self->_ordinal != *((_DWORD *)v4 + 8)) {
      goto LABEL_14;
    }
  }
  ...
  if ((unint64_t)label | *((void *)v4 + 2)) {
    char v6 = -[GEOPDVenueLabel isEqual:](label, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_flags)
  {
    unint64_t v2 = 2654435761u * self->_levelId;
    if ((*(unsigned char *)&self->_flags & 2) != 0) {
      goto LABEL_3;
    }
LABEL_5:
    uint64_t v3 = 0;
    return v3 ^ v2 ^ [(GEOPDVenueLabel *)self->_label hash];
  }
  unint64_t v2 = 0;
  if ((*(unsigned char *)&self->_flags & 2) == 0) {
    goto LABEL_5;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_ordinal;
  return v3 ^ v2 ^ [(GEOPDVenueLabel *)self->_label hash];
}
