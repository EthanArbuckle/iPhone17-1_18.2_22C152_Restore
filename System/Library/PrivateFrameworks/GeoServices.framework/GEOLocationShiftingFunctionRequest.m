@interface GEOLocationShiftingFunctionRequest
+ (Class)replyClass;
- (BOOL)isValid;
- (GEOLatLng)latLng;
...
- (GEOLocationShiftingFunctionRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"locationshift.shiftCoordinate" traits:a3 auditToken:a4 throttleToken:a5];
}
