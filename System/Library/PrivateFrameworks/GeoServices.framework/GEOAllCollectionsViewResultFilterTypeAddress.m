...
- (GEOAllCollectionsViewResultFilterTypeAddress)initWithFilterAddressIdentifier:(id)a3 withPlaces:(id)a4
{
  ...
  v9 = [(GEOAllCollectionsViewResultFilterTypeAddress *)&v21 init];
  if (v9)
  {
    uint64_t v15 = 0;
    v16 = &v15;
...
void __91__GEOAllCollectionsViewResultFilterTypeAddress_initWithFilterAddressIdentifier_withPlaces___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v13 = a2;
  v6 = [[GEOMapItemIdentifier alloc] initWithPlace:v13];
  id v7 = [GEOMapItemIdentifier alloc];
  id v8 = -[GEOPDAllCollectionsViewResultFilterTypeAddress geoId](*(id **)(a1 + 32));
  v9 = [(GEOMapItemIdentifier *)v7 initWithMapsIdentifier:v8];

  if ([(GEOMapItemIdentifier *)v9 isEqual:v6])
  {
...
- (GEOMapItemIdentifier)filterAddressIdentifier
{
  ...
  v4 = -[GEOPDAllCollectionsViewResultFilterTypeAddress geoId]((id *)&self->_filterAddressIdentifier->super.super.isa);
