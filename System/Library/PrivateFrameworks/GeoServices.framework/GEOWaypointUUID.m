...
@implementation GEOWaypointUUID
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOWaypointUUID;
  char v4 = [(GEOWaypointUUID *)&v8 description];
  id v5 = [(GEOWaypointUUID *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOWaypointUUID _dictionaryRepresentation:]((uint64_t)self, 0);
}
  ...
  if (a1)
  {
    ...
    if (v8)
    {
      ...
      if (a2)
      {
        ...
        v15[1] = 3221225472;
        v15[2] = __45__GEOWaypointUUID__dictionaryRepresentation___block_invoke;
        v15[3] = &unk_1E53D8860;
        id v12 = v11;
        id v16 = v12;
...
- (id)jsonRepresentation
{
  return -[GEOWaypointUUID _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __45__GEOWaypointUUID__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (uint64_t)_initWithDictionary:(uint64_t)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      char v4 = [v3 objectForKeyedSubscript:@"high"];
      objc_opt_class();
...
- (BOOL)readFrom:(id)a3
{
  return GEOWaypointUUIDReadAllFrom((uint64_t)self, a3);
}
