@interface GEOXPCDirectionsRequest
+ (Class)replyClass;
- (BOOL)isValid;
...
- (GEOXPCDirectionsRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"directions.start" traits:a3 auditToken:a4 throttleToken:a5];
}
...
- (GEOXPCDirectionsRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    if (data)
    {
      ...
      v10 = [[GEODirectionsRequest alloc] initWithData:v9];
    }
    else
    {
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  {
    id v6 = [(GEODirectionsRequest *)directionsRequest data];
...
- (BOOL)isValid
{
  v2 = [(GEOXPCDirectionsRequest *)self directionsRequest];
  BOOL v3 = v2 != 0;
