...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GEOCompanionFerryStep)init;
- (GEOCompanionFerryStep)initWithData:(id)a3;
- (GEOCompanionFerryStep)initWithDictionary:(id)a3;
- (GEOCompanionFerryStep)initWithJSON:(id)a3;
...
@implementation GEOCompanionFerryStep

- (GEOCompanionFerryStep)init
{
  v6.receiver = self;
  v6.super_class = (Class)GEOCompanionFerryStep;
  v2 = [(GEOCompanionFerryStep *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
{
  v7.receiver = self;
  v7.super_class = (Class)GEOCompanionFerryStep;
  v3 = [(GEOCompanionFerryStep *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  [(GEOCompanionFerryStep *)self clearJunctionElements];
  v3.receiver = self;
  v3.super_class = (Class)GEOCompanionFerryStep;
  [(GEOCompanionFerryStep *)&v3 dealloc];
}
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 84) & 4) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readJunctionElements_tags_245);
        objc_sync_exit(v3);
      }
    }
...
LABEL_12:
    ...
    uint64_t result = (uint64_t)malloc_type_realloc(*(void **)(a1 + 16), 16 * v9, 0x5B1193B4uLL);
    if (result)
    {
      *(void *)(a1 + 32) = v9;
      *(void *)(a1 + 16) = result;
...
- (void)addJunctionElement:(GEOJunctionElement)a3
{
  ...
  -[GEOCompanionFerryStep _readJunctionElements]((uint64_t)self);
  if (self && -[GEOCompanionFerryStep _reserveJunctionElements:]((uint64_t)self, 1uLL))
  {
...
- (void)setJunctionElements:(GEOJunctionElement *)a3 count:(unint64_t)a4
{
  ...
  *(unsigned char *)&self->_flags |= 0x40u;
  [(GEOCompanionFerryStep *)self clearJunctionElements];
  if (-[GEOCompanionFerryStep _reserveJunctionElements:]((uint64_t)self, a4))
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 84) & 0x10) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readManeuverNames_tags_246);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 72));
...
- (NSMutableArray)maneuverNames
{
  -[GEOCompanionFerryStep _readManeuverNames]((uint64_t)self);
...
- (void)addManeuverName:(id)a3
{
  id v4 = a3;
  -[GEOCompanionFerryStep _readManeuverNames]((uint64_t)self);
  -[GEOCompanionFerryStep _addNoFlagsManeuverName:]((uint64_t)self, v4);
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 84) & 0x20) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readSignposts_tags_247);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 72));
...
- (NSMutableArray)signposts
{
  -[GEOCompanionFerryStep _readSignposts]((uint64_t)self);
...
- (void)addSignpost:(id)a3
{
  id v4 = a3;
  -[GEOCompanionFerryStep _readSignposts]((uint64_t)self);
  -[GEOCompanionFerryStep _addNoFlagsSignpost:]((uint64_t)self, v4);
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 84) & 8) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionFerryStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readArtworkOverride_tags_248);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 72));
...
- (GEOPBTransitArtwork)artworkOverride
{
  -[GEOCompanionFerryStep _readArtworkOverride]((uint64_t)self);
...
- (NSString)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOCompanionFerryStep;
  id v4 = [(GEOCompanionFerryStep *)&v8 description];
  id v5 = [(GEOCompanionFerryStep *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOCompanionFerryStep _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
- (id)jsonRepresentation
{
  return -[GEOCompanionFerryStep _dictionaryRepresentation:]((uint64_t)self, 1);
}

- (GEOCompanionFerryStep)initWithDictionary:(id)a3
{
  return (GEOCompanionFerryStep *)-[GEOCompanionFerryStep _initWithDictionary:isJSON:](self, a3, 0);
}
...
LABEL_135:
  ...
  unint64_t v9 = [v5 objectForKeyedSubscript:@"junctionType"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    id v10 = v9;
    if ([v10 isEqualToString:@"JCTTYPE_NORMAL"]) {
      uint64_t v11 = 0;
    }
    else {
      uint64_t v11 = [v10 isEqualToString:@"JCTTYPE_ROUNDABOUT"];
    }
...
LABEL_142:
    [a1 setJunctionType:v11];
  }

  uint64_t v12 = [v5 objectForKeyedSubscript:@"junctionElement"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    long long v57 = 0u;
      ...
      do
      {
        for (uint64_t i = 0; i != v15; ++i)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            uint64_t v53 = 0;
            uint64_t v54 = 0;
            _GEOJunctionElementFromDictionaryRepresentation(v18, (uint64_t)&v53);
            objc_msgSend(a1, "addJunctionElement:", v53, v54);
          }
        }
  ...
  v19 = [v5 objectForKeyedSubscript:@"maneuverName"];
  objc_opt_class();
  id v44 = v5;
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v50 = 0u;
    id v20 = v19;
    uint64_t v21 = [v20 countByEnumeratingWithState:&v49 objects:v60 count:16];
    if (v21)
    {
      uint64_t v22 = v21;
      ...
      do
      {
        for (uint64_t j = 0; j != v22; ++j)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            v26 = [GEONameInfoList alloc];
            if (a3) {
              uint64_t v27 = [(GEONameInfoList *)v26 initWithJSON:v25];
            }
            else {
              uint64_t v27 = [(GEONameInfoList *)v26 initWithDictionary:v25];
            }
            v28 = (void *)v27;
            [a1 addManeuverName:v27];
          }
        }
        uint64_t v22 = [v20 countByEnumeratingWithState:&v49 objects:v60 count:16];
      }
      while (v22);
    }
  ...
  v29 = [v5 objectForKeyedSubscript:@"signpost"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    long long v47 = 0u;
    ...
    long long v46 = 0u;
    id v30 = v29;
    uint64_t v31 = [v30 countByEnumeratingWithState:&v45 objects:v59 count:16];
    if (v31)
    {
      uint64_t v32 = v31;
      ...
      do
      {
        for (uint64_t k = 0; k != v32; ++k)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            long long v36 = [GEONameInfo alloc];
            if (a3) {
        ...
        uint64_t v32 = [v30 countByEnumeratingWithState:&v45 objects:v59 count:16];
      }
      while (v32);
    }
  ...
  long long v39 = [v5 objectForKeyedSubscript:@"artworkOverride"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    long long v40 = [GEOPBTransitArtwork alloc];
    if (a3) {
      uint64_t v41 = [(GEOPBTransitArtwork *)v40 initWithJSON:v39];
    }
    else {
      uint64_t v41 = [(GEOPBTransitArtwork *)v40 initWithDictionary:v39];
    }
    v42 = (void *)v41;
    [a1 setArtworkOverride:v41];
  }
LABEL_188:
...
- (GEOCompanionFerryStep)initWithJSON:(id)a3
{
  return (GEOCompanionFerryStep *)-[GEOCompanionFerryStep _initWithDictionary:isJSON:](self, a3, 1);
}
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      uint64_t v8 = (int *)&readAll__recursiveTag_249;
    }
    else {
      uint64_t v8 = (int *)&readAll__nonRecursiveTag_250;
    }
    GEOCompanionFerryStepReadSpecified((uint64_t)self, (uint64_t)self->_reader, v8);
    objc_sync_exit(v7);
  }
  if (v3) {
    _GEOCompanionFerryStepCallReadAllRecursiveWithoutSynchronized((id *)&self->super.super.isa);
  }
...
+ (BOOL)isValid:(id)a3
{
  return GEOCompanionFerryStepIsValid((char *)a3);
}

- (BOOL)readFrom:(id)a3
{
  return GEOCompanionFerryStepReadAllFrom((uint64_t)self, a3, 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  p_readerLocuint64_t k = &self->_readerLock;
  os_unfair_lock_lock(&self->_readerLock);
  if (self->_reader && (_GEOCompanionFerryStepIsDirty((uint64_t)self) & 1) == 0)
  {
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    [(GEOCompanionFerryStep *)self readAll:0];
    char flags = (char)self->_flags;
    if ((flags & 2) != 0)
    {
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v18 + 17) = self->_readerMarkLength;
  ...
  if ([(GEOCompanionFerryStep *)self junctionElementsCount])
  {
    [v18 clearJunctionElements];
    unint64_t v5 = [(GEOCompanionFerryStep *)self junctionElementsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(GEOCompanionFerryStep *)self junctionElementAtIndex:i];
        objc_msgSend(v18, "addJunctionElement:", v8, v9);
      }
    }
  }
  if ([(GEOCompanionFerryStep *)self maneuverNamesCount])
  {
    [v18 clearManeuverNames];
    unint64_t v10 = [(GEOCompanionFerryStep *)self maneuverNamesCount];
    if (v10)
    {
      unint64_t v11 = v10;
      for (uint64_t j = 0; j != v11; ++j)
      {
        id v13 = [(GEOCompanionFerryStep *)self maneuverNameAtIndex:j];
        [v18 addManeuverName:v13];
      }
    }
  }
  if ([(GEOCompanionFerryStep *)self signpostsCount])
  {
    [v18 clearSignposts];
    unint64_t v14 = [(GEOCompanionFerryStep *)self signpostsCount];
    if (v14)
    {
      unint64_t v15 = v14;
      for (uint64_t k = 0; k != v15; ++k)
      {
        uint64_t v17 = [(GEOCompanionFerryStep *)self signpostAtIndex:k];
        [v18 addSignpost:v17];
      }
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (reader)
  {
    ...
    if ((*(unsigned char *)&self->_flags & 0x40) == 0)
    {
      *(void *)((char *)self->_reader + (int)*MEMORY[0x1E4F940E0]) = self->_readerMarkLength;
      [(PBDataReader *)self->_reader seekToOffset:self->_readerMarkPos];
      GEOCompanionFerryStepReadAllFrom(v5, self->_reader, 0);
      os_unfair_lock_unlock(&self->_readerLock);
      id v8 = (id)v5;
      objc_sync_exit(v7);
  ...
  {
    -[GEOCompanionFerryStep _reserveJunctionElements:](v5, junctionElementsCount);
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOCompanionFerryStep *)self readAll:1];
  [v4 readAll:1];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    for (uint64_t i = 0; i != v7; ++i)
    {
      ...
      -[GEOCompanionFerryStep addJunctionElement:](self, "addJunctionElement:", v9, v10);
    }
  }
  long long v29 = 0u;
  long long v30 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v13; ++j)
      {
        ...
        [(GEOCompanionFerryStep *)self addManeuverName:*(void *)(*((void *)&v27 + 1) + 8 * j)];
      }
  ...
  if (v17)
  {
    ...
    do
    {
      for (uint64_t k = 0; k != v18; ++k)
      {
        ...
        -[GEOCompanionFerryStep addSignpost:](self, "addSignpost:", *(void *)(*((void *)&v23 + 1) + 8 * k), (void)v23);
      }
  ...
  {
    -[GEOCompanionFerryStep setArtworkOverride:](self, "setArtworkOverride:");
  }
}
