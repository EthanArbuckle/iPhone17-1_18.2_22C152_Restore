...
@implementation GEOETARequestExtension

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOETARequestExtension;
  v4 = [(GEOETARequestExtension *)&v8 description];
  v5 = [(GEOETARequestExtension *)self dictionaryRepresentation];
