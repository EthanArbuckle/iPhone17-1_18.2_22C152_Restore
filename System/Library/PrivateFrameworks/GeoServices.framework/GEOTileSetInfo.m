...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GEOTileSetInfo)initWithDictionary:(id)a3;
- (GEOTileSetInfo)initWithJSON:(id)a3;
...
- (void)setUncertainty:(unsigned int)a3;
- (void)setZoom:(unsigned int)a3;
- (void)writeTo:(id)a3;
@end

@implementation GEOTileSetInfo
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOTileSetInfo;
  int v4 = [(GEOTileSetInfo *)&v8 description];
  v5 = [(GEOTileSetInfo *)self dictionaryRepresentation];
...
LABEL_126:
    ...
    [v2 setObject:v7 forKey:@"uncertainty"];
  }
LABEL_127:
...
- (GEOTileSetInfo)initWithDictionary:(id)a3
{
  return (GEOTileSetInfo *)-[GEOTileSetInfo _initWithDictionary:isJSON:](self, a3);
}
...
LABEL_238:
  ...
  objc_super v8 = [v3 objectForKeyedSubscript:@"zoom"];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    objc_msgSend(a1, "setZoom:", objc_msgSend(v8, "unsignedIntValue"));
  }

  v9 = [v3 objectForKeyedSubscript:@"uncertainty"];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    objc_msgSend(a1, "setUncertainty:", objc_msgSend(v9, "unsignedIntValue"));
  }
...
+ (BOOL)isValid:(id)a3
{
  return GEOTileSetInfoIsValid((char *)a3);
}

- (BOOL)readFrom:(id)a3
{
  return GEOTileSetInfoReadAllFrom((uint64_t)self, a3);
}
...
LABEL_9:
  *((_DWORD *)result + 5) = self->_zoom;
  *((unsigned char *)result + 24) |= 8u;
  if ((*(unsigned char *)&self->_flags & 4) == 0) {
    return result;
  }
LABEL_5:
  *((_DWORD *)result + 4) = self->_uncertainty;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOTileSetInfo *)self readAll:1];
  [v4 readAll:1];
  if ((*(unsigned char *)&self->_flags & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_style != *((_DWORD *)v4 + 3)) {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 8) == 0 || self->_zoom != *((_DWORD *)v4 + 5)) {
      goto LABEL_21;
    }
  }
  ...
  if ((*(unsigned char *)&self->_flags & 4) != 0)
  {
    if ((*((unsigned char *)v4 + 24) & 4) == 0 || self->_uncertainty != *((_DWORD *)v4 + 4)) {
      goto LABEL_21;
    }
    BOOL v5 = 1;
  }
...
LABEL_5:
  uint64_t v6 = 2654435761 * self->_uncertainty;
  return v4 ^ v3 ^ v5 ^ v6;
}
...
LABEL_11:
  self->_zoom = *((_DWORD *)v5 + 5);
  *(unsigned char *)&self->_flags |= 8u;
  if ((*((unsigned char *)v5 + 24) & 4) != 0)
  {
LABEL_5:
    self->_uncertainty = *((_DWORD *)v5 + 4);
    *(unsigned char *)&self->_flags |= 4u;
  }
LABEL_6:
}
