...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GEODirectionsCollectionResponse)initWithDictionary:(id)a3;
- (GEODirectionsCollectionResponse)initWithJSON:(id)a3;
...
@implementation GEODirectionsCollectionResponse

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEODirectionsCollectionResponse;
  v4 = [(GEODirectionsCollectionResponse *)&v8 description];
  v5 = [(GEODirectionsCollectionResponse *)self dictionaryRepresentation];
...
- (GEODirectionsCollectionResponse)initWithDictionary:(id)a3
{
  return (GEODirectionsCollectionResponse *)-[GEOACResult _initWithDictionary:isJSON:](self, a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    [(GEODirectionsCollectionResponse *)self readAll:1];
    [v4 readAll:1];
  }
