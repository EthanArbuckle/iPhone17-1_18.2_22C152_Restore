...
@implementation GEOPDSearchKeyValue64PairList
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSearchKeyValue64PairList;
  v4 = [(GEOPDSearchKeyValue64PairList *)&v8 description];
  id v5 = [(GEOPDSearchKeyValue64PairList *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDSearchKeyValue64PairList _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
- (id)jsonRepresentation
{
  return -[GEOPDSearchKeyValue64PairList _dictionaryRepresentation:]((uint64_t)self, 1);
}
...
LABEL_15:
        ...
        if ((v11 >> 3) == 1)
        {
          ...
          uint64_t v19 = objc_alloc_init(GEOPDSearchKeyValue64Pair);
          if (!GEOPDSearchKeyValue64PairReadAllFrom((uint64_t)v19, v4))
          {

            goto LABEL_27;
          }
          PBReaderRecallMark();
          -[GEOPDSearchKeyValue64PairList addPairs:]((uint64_t)self, v19);
        }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOPDSearchKeyValue64PairList addPairs:]((uint64_t)v5, v11);
