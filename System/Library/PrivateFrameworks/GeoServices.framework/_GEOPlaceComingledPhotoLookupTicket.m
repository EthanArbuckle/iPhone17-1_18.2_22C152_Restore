@interface _GEOPlaceComingledPhotoLookupTicket
...
- (_GEOPlaceComingledPhotoLookupTicket)initWithPhotoCategoryIdentifier:(id)a3 mapItemIdentifier:(id)a4 range:(_NSRange)a5 traits:(id)a6
{
  ...
  id v13 = a4;
  id v14 = a6;
  v15 = +[GEOPDPlaceRequest comingledPhotoLookupRequestWithCategoryIdentifier:mapItemIdentifier:range:traits:](GEOPDPlaceRequest, "comingledPhotoLookupRequestWithCategoryIdentifier:mapItemIdentifier:range:traits:", v12, v13, location, length, v14);
  v19.receiver = self;
