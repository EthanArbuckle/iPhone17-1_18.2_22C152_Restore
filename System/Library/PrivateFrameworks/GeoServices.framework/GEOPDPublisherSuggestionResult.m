...
@implementation GEOPDPublisherSuggestionResult
        ...
        do
        {
          for (uint64_t i = 0; i != v11; ++i)
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v17 = v16;
              -[GEOPDPublisherSuggestionResult addPublisherId:](v6, v16);
            }
          }
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDPublisherSuggestionResult;
  v4 = [(GEOPDPublisherSuggestionResult *)&v8 description];
  id v5 = [(GEOPDPublisherSuggestionResult *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if (v14)
    {
      ...
      if (a2)
      {
        ...
        v21[1] = 3221225472;
        v21[2] = __60__GEOPDPublisherSuggestionResult__dictionaryRepresentation___block_invoke;
        v21[3] = &unk_1E53D8860;
        id v18 = v17;
        id v22 = v18;
...
- (id)dictionaryRepresentation
{
  return -[GEOPDPublisherSuggestionResult _dictionaryRepresentation:]((uint64_t)self, 0);
}

- (id)jsonRepresentation
{
  return -[GEOPDPublisherSuggestionResult _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __60__GEOPDPublisherSuggestionResult__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
  ...
  if (isKindOfClass)
  {
    long long v8 = [v5 base64EncodedStringWithOptions:0];
    long long v9 = [v10 description];
    [v7 setObject:v8 forKey:v9];
  }
  else
  {
    long long v8 = [v10 description];
...
- (BOOL)readFrom:(id)a3
{
  return GEOPDPublisherSuggestionResultReadAllFrom((uint64_t)self, a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  uint64_t v6 = self->_publisherIds;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOPDPublisherSuggestionResult addPublisherId:]((uint64_t)v5, v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)publisherIds | v4[2]) {
      char v6 = -[NSMutableArray isEqual:](publisherIds, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSMutableArray *)self->_publisherIds hash];
}
