...
- (GEOAPPlaceCardModule)init
{
  ...
  v2 = [(GEOAPPlaceCardModule *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOAPPlaceCardModule)initWithData:(id)a3
{
  ...
  v3 = [(GEOAPPlaceCardModule *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  [(GEOAPPlaceCardModule *)&v3 dealloc];
}
...
- (id)typeAsString:(int)a3
{
  ...
  {
    objc_super v3 = off_1E53DF300[a3];
  }
  else
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 64) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOAPPlaceCardModuleReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readContents_tags);
        objc_sync_exit(v3);
      }
    }
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 64) & 4) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOAPPlaceCardModuleReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readMetadata_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 56));
...
- (id)description
{
  ...
  int v4 = [(GEOAPPlaceCardModule *)&v8 description];
  v5 = [(GEOAPPlaceCardModule *)self dictionaryRepresentation];
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (v4)
  {
    ...
    {
      id v6 = v5;
      if ([v6 isEqualToString:@"MODULE_TYPE_UNKNOWN"])
      {
        uint64_t v7 = 0;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_TITLE"])
      {
        uint64_t v7 = 1;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_BUTTONS"])
      {
        uint64_t v7 = 2;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_INLINE_MAP"])
      {
        uint64_t v7 = 3;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_PHOTOS"])
      {
        uint64_t v7 = 4;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_INFOS"])
      {
        uint64_t v7 = 5;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_TRANSIT_DEPARTURE"])
      {
        uint64_t v7 = 6;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_TRANSIT_ATTRIBUTION"])
      {
        uint64_t v7 = 7;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ENCYCLOPEDIC"])
      {
        uint64_t v7 = 8;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_HOURS"])
      {
        uint64_t v7 = 9;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_BUSINESS_INFOS"])
      {
        uint64_t v7 = 10;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_REVIEWS"])
      {
        uint64_t v7 = 11;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ACTIONS_ROW"])
      {
        uint64_t v7 = 12;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_RESERVATIONS"])
      {
        uint64_t v7 = 14;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_OFFICIAL_APPS"])
      {
        uint64_t v7 = 15;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_VENUE_BROWSE"])
      {
        uint64_t v7 = 16;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_VENUE_INFO"])
      {
        uint64_t v7 = 17;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_INFO_PARENT"])
      {
        uint64_t v7 = 18;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ANNOTATED_LIST"])
      {
        uint64_t v7 = 19;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ANNOTATED_PICTURE"])
      {
        uint64_t v7 = 20;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_MESSAGE"])
      {
        uint64_t v7 = 21;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_MESSAGE_HOURS"])
      {
        uint64_t v7 = 22;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ACTION_FOOTER"])
      {
        uint64_t v7 = 23;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ATTRIBUTION"])
      {
        uint64_t v7 = 24;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_WEB_CONTENT"])
      {
        uint64_t v7 = 25;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_RELATED_PLACE_LIST"])
      {
        uint64_t v7 = 26;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_SERVICE_HOURS"])
      {
        uint64_t v7 = 27;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_QUICK_LINKS"])
      {
        uint64_t v7 = 28;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_COLLECTIONS"])
      {
        uint64_t v7 = 29;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_PLACE_BROWSE_CATEGORIES"])
      {
        uint64_t v7 = 30;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_MINI_PLACE_BROWSE_CATEGORIES"])
      {
        uint64_t v7 = 31;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_CURATED_COLLECTIONS"])
      {
        uint64_t v7 = 32;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_PLACE_QUESTIONNAIRE"])
      {
        uint64_t v7 = 33;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_APPLE_RATINGS"])
      {
        uint64_t v7 = 34;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_PLACE_RIBBON"])
      {
        uint64_t v7 = 35;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_REVIEW_AND_RATING"])
      {
        uint64_t v7 = 36;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_ABOUT"])
      {
        uint64_t v7 = 37;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_TEMPLATE_PLACE"])
      {
        uint64_t v7 = 38;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_TRANSIT_LABELS"])
      {
        uint64_t v7 = 39;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_PLACECARD_ENRICHMENT"])
      {
        uint64_t v7 = 40;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_UNIFIED_ACTION_ROW"])
      {
        uint64_t v7 = 41;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_QUESTIONNAIRE_SUGGESTION"])
      {
        uint64_t v7 = 42;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_EV_CHARGER"])
      {
        uint64_t v7 = 43;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_HIKING_ASSOCIATION"])
      {
        uint64_t v7 = 44;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_NOTE"])
      {
        uint64_t v7 = 45;
      }
      else if ([v6 isEqualToString:@"MODULE_TYPE_HIKE_SUGGESTION"])
      {
        uint64_t v7 = 46;
      }
      else
...
LABEL_102:
        ...
        uint64_t v8 = [v3 objectForKeyedSubscript:@"content"];
        objc_opt_class();
        if ((objc_opt_isKindOfClass() & 1) == 0) {
          goto LABEL_149;
        }
        ...
        while (1)
        {
          ...
          do
          {
            ...
            {
              id v15 = v14;
              if ([v15 isEqualToString:@"BUTTON_TYPE_UNKNOWN"])
              {
                uint64_t v16 = 0;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_ADD_TO_GUIDES"])
              {
                uint64_t v16 = 1;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_REPORT_AN_ISSUE"])
              {
                uint64_t v16 = 2;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_SHARE"])
              {
                uint64_t v16 = 3;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_CALL"])
              {
                uint64_t v16 = 4;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_MESSAGE"])
              {
                uint64_t v16 = 5;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_WEBSITE"])
              {
                uint64_t v16 = 6;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_QUICK_LINK"])
              {
                uint64_t v16 = 7;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_GROUP"])
              {
                uint64_t v16 = 8;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_DIRECTIONS"])
              {
                uint64_t v16 = 9;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_FLYOVER"])
              {
                uint64_t v16 = 10;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_DOWNLOAD"])
              {
                uint64_t v16 = 11;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_ADD_PHOTOS"])
              {
                uint64_t v16 = 12;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_ADD_TO_FAVORITES"])
              {
                uint64_t v16 = 13;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_SAVE_TO_LIBRARY"])
              {
                uint64_t v16 = 14;
              }
              else if ([v15 isEqualToString:@"BUTTON_TYPE_ADD_A_NOTE"])
              {
                uint64_t v16 = 15;
              }
              else
            ...
            objc_msgSend(v4, "addContent:", v16, v20, v21, (void)v22);
LABEL_146:
            ++v13;
          }
          while (v11 != v13);
...
LABEL_149:
            ...
            v17 = [v3 objectForKeyedSubscript:@"metadata"];
            objc_opt_class();
            if (objc_opt_isKindOfClass())
            {
              v18 = (void *)[v17 copy];
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      uint64_t v8 = (int *)&readAll__recursiveTag_21;
    }
    else {
      uint64_t v8 = (int *)&readAll__nonRecursiveTag_21;
    }
...
- (void)writeTo:(id)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  [(GEOAPPlaceCardModule *)self readAll:0];
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v7 + 13) = self->_readerMarkLength;
  ...
  if ([(GEOAPPlaceCardModule *)self contentsCount])
  {
    [v7 clearContents];
    unint64_t v4 = [(GEOAPPlaceCardModule *)self contentsCount];
    if (v4)
    {
      unint64_t v5 = v4;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOAPPlaceCardModule *)self readAll:1];
  [v4 readAll:1];
  if (*(unsigned char *)&self->_flags)
  {
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v5 = v4;
    for (uint64_t i = 0; i != v5; ++i)
      -[GEOAPPlaceCardModule addContent:](self, "addContent:", [v8 contentAtIndex:i]);
  }
  uint64_t v7 = v8;
  if (*((void *)v8 + 5))
  {
...
+ (id)moduleFromModuleType:(int)a3
{
  uint64_t v4 = objc_alloc_init(GEOAPPlaceCardModule);
  [(GEOAPPlaceCardModule *)v4 setType:GEOPDPlaceDataLayoutConfigurationFromGEOModuleType(a3)];
