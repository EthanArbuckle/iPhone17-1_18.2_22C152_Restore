...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GEOCyclingUserPreferences)initWithDictionary:(id)a3;
- (GEOCyclingUserPreferences)initWithJSON:(id)a3;
...
@implementation GEOCyclingUserPreferences
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOCyclingUserPreferences;
  v4 = [(GEOCyclingUserPreferences *)&v8 description];
  id v5 = [(GEOCyclingUserPreferences *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOCyclingUserPreferences _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
LABEL_9:
  ...
  if (v8)
  {
    ...
    if (a2)
    {
      ...
      v19[1] = 3221225472;
      v19[2] = __55__GEOCyclingUserPreferences__dictionaryRepresentation___block_invoke;
      v19[3] = &unk_1E53D8860;
      id v12 = v11;
      id v20 = v12;
...
- (id)jsonRepresentation
{
  return -[GEOCyclingUserPreferences _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __55__GEOCyclingUserPreferences__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (GEOCyclingUserPreferences)initWithDictionary:(id)a3
{
  return (GEOCyclingUserPreferences *)-[GEOCyclingUserPreferences _initWithDictionary:isJSON:](self, a3, 0);
}
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if (a3) {
        id v10 = @"avoidBusyRoads";
      }
      else {
        id v10 = @"avoid_busy_roads";
      }
...
- (GEOCyclingUserPreferences)initWithJSON:(id)a3
{
  return (GEOCyclingUserPreferences *)-[GEOCyclingUserPreferences _initWithDictionary:isJSON:](self, a3, 1);
}

+ (BOOL)isValid:(id)a3
{
  return GEOCyclingUserPreferencesIsValid((char *)a3);
}

- (BOOL)readFrom:(id)a3
{
  return GEOCyclingUserPreferencesReadAllFrom((uint64_t)self, a3);
}

- (void)copyTo:(id)a3
{
  id v5 = a3;
  [(GEOCyclingUserPreferences *)self readAll:0];
  char flags = (char)self->_flags;
  if ((flags & 4) != 0)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOCyclingUserPreferences *)self readAll:1];
  [v4 readAll:1];
