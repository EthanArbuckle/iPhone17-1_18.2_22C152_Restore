@interface GEOMapSubscriptionStartDownloadRequest
+ (Class)replyClass;
- (BOOL)isValid;
- (BOOL)onPairedDevice;
- (GEOMapSubscriptionStartDownloadRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5;
- (GEOMapSubscriptionStartDownloadRequest)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (NSArray)identifiers;
...
@implementation GEOMapSubscriptionStartDownloadRequest
...
- (GEOMapSubscriptionStartDownloadRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"subscriptions.startDownloadForSubscriptions" traits:a3 auditToken:a4 throttleToken:a5];
}
...
- (GEOMapSubscriptionStartDownloadRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v18.receiver = self;
  v18.super_class = (Class)GEOMapSubscriptionStartDownloadRequest;
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  id v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)GEOMapSubscriptionStartDownloadRequest;
