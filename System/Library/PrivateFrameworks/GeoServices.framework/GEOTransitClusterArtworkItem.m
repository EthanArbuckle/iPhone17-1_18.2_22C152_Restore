...
- (NSString)description
{
  ...
  v4 = [(GEOTransitClusterArtworkItem *)&v8 description];
  v5 = [(GEOTransitClusterArtworkItem *)self dictionaryRepresentation];
...
{
  id v5 = a3;
  [(GEOTransitClusterArtworkItem *)self readAll:0];
  id v4 = v5;
  if (*(unsigned char *)&self->_flags)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v7 = [(GEOFormattedString *)self->_text copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOTransitClusterArtworkItem *)self readAll:1];
  [v4 readAll:1];
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_artworkIndex != *((_DWORD *)v4 + 6)) {
      goto LABEL_9;
    }
  }
...
LABEL_9:
  ...
  if ((unint64_t)text | *((void *)v4 + 2)) {
    char v6 = -[GEOFormattedString isEqual:](text, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (unint64_t)hash
{
  [(GEOTransitClusterArtworkItem *)self readAll:1];
  if (*(unsigned char *)&self->_flags) {
    uint64_t v3 = 2654435761 * self->_artworkIndex;
  }
  else {
    uint64_t v3 = 0;
  }
