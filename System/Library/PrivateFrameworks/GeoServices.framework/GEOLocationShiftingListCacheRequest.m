@interface GEOLocationShiftingListCacheRequest
+ (Class)replyClass;
- (BOOL)isValid;
...
- (GEOLocationShiftingListCacheRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"locationshift.listDiskCache" traits:a3 auditToken:a4 throttleToken:a5];
}
