...
- (id)description
{
  ...
  id v4 = [(GEOCyclingVehicleSpecifications *)&v8 description];
  id v5 = [(GEOCyclingVehicleSpecifications *)self dictionaryRepresentation];
...
{
  id v4 = a3;
  [(GEOCyclingVehicleSpecifications *)self readAll:0];
  if (*(unsigned char *)&self->_flags)
  {
    v4[16] = self->_isEbike;
    v4[20] |= 1u;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    *(unsigned char *)(v4 + 16) = self->_isEbike;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOCyclingVehicleSpecifications *)self readAll:1];
  [v4 readAll:1];
  BOOL v5 = (v4[20] & 1) == 0;
  if (*(unsigned char *)&self->_flags)
  {
