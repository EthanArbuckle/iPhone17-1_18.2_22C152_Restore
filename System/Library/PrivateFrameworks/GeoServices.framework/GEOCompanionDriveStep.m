...
- (GEOCompanionDriveStep)initWithData:(id)a3
{
  ...
  v3 = [(GEOCompanionDriveStep *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x800) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readShield_tags_203);
        objc_sync_exit(v3);
      }
    }
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x20) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readJunctionElements_tags_204);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
...
LABEL_12:
    ...
    uint64_t result = (uint64_t)malloc_type_realloc(*(void **)(a1 + 16), 16 * v9, 0x57B5C023uLL);
    if (result)
    {
      *(void *)(a1 + 32) = v9;
      *(void *)(a1 + 16) = result;
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x400) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readManeuverNames_tags_205);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x1000) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readSignposts_tags_206);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x200) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readExitNumber_tags_207);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x40) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readArtworkOverride_tags_208);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x80) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readChargingInfo_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
  ...
  if (a1)
  {
    ...
    if ((*(_WORD *)(a1 + 128) & 0x100) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOCompanionDriveStepReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readEvInfo_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 104));
...
- (NSString)description
{
  ...
  int v4 = [(GEOCompanionDriveStep *)&v8 description];
  id v5 = [(GEOCompanionDriveStep *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ([*(id *)(a1 + 72) count])
    {
      v15 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(*(id *)(a1 + 72), "count"));
      long long v51 = 0u;
      long long v52 = 0u;
      long long v53 = 0u;
      long long v54 = 0u;
    ...
    if ([*(id *)(a1 + 88) count])
    {
      v23 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(*(id *)(a1 + 88), "count"));
      long long v47 = 0u;
      long long v48 = 0u;
      long long v49 = 0u;
      long long v50 = 0u;
    ...
    {
      v31 = [NSNumber numberWithBool:*(unsigned __int8 *)(a1 + 124)];
    ...
    if (v40)
    {
      ...
      [v4 setObject:v42 forKey:@"chargingInfo"];
    }
    v43 = [(id)a1 evInfo];
    v44 = v43;
    if (v43)
    {
      ...
      [v4 setObject:v45 forKey:@"evInfo"];
    }
  }
  else
  {
...
LABEL_147:
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v75 = 0u;
    id v16 = v15;
    uint64_t v17 = [v16 countByEnumeratingWithState:&v74 objects:v80 count:16];
    if (v17)
    {
      uint64_t v18 = v17;
      ...
      do
      {
        ...
        uint64_t v18 = [v16 countByEnumeratingWithState:&v74 objects:v80 count:16];
      }
      while (v18);
    }
  }
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v69 = 0u;
    id v23 = v22;
    uint64_t v24 = [v23 countByEnumeratingWithState:&v68 objects:v79 count:16];
    if (v24)
    {
      uint64_t v25 = v24;
      ...
      do
      {
        ...
        uint64_t v25 = [v23 countByEnumeratingWithState:&v68 objects:v79 count:16];
      }
      while (v25);
    }
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v65 = 0u;
    id v33 = v32;
    uint64_t v34 = [v33 countByEnumeratingWithState:&v64 objects:v78 count:16];
    if (v34)
    {
      uint64_t v35 = v34;
      ...
      do
      {
        for (uint64_t k = 0; k != v35; ++k)
        {
          ...
          uint64_t v38 = *(void *)(*((void *)&v64 + 1) + 8 * k);
          objc_opt_class();
          if (objc_opt_isKindOfClass())
          {
        ...
        uint64_t v35 = [v33 countByEnumeratingWithState:&v64 objects:v78 count:16];
      }
      while (v35);
    }
  ...
  v42 = [v5 objectForKeyedSubscript:@"toFreeway"];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    objc_msgSend(a1, "setToFreeway:", objc_msgSend(v42, "BOOLValue"));
  }

  v43 = [v5 objectForKeyedSubscript:@"exitNumber"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
...
LABEL_200:
  ...
  long long v50 = [v5 objectForKeyedSubscript:@"artworkOverride"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    long long v51 = [GEOPBTransitArtwork alloc];
    if (a3) {
  ...
  long long v54 = [v5 objectForKeyedSubscript:@"chargingInfo"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v55 = [GEOEVChargeInfo alloc];
    if (a3) {
      uint64_t v56 = [(GEOEVChargeInfo *)v55 initWithJSON:v54];
    }
    else {
      uint64_t v56 = [(GEOEVChargeInfo *)v55 initWithDictionary:v54];
    }
    uint64_t v57 = (void *)v56;
    [a1 setChargingInfo:v56];
  }
  v58 = [v5 objectForKeyedSubscript:@"evInfo"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v59 = [GEOEVStepInfo alloc];
    if (a3) {
      uint64_t v60 = [(GEOEVStepInfo *)v59 initWithJSON:v58];
    }
    else {
      uint64_t v60 = [(GEOEVStepInfo *)v59 initWithDictionary:v58];
    }
    v61 = (void *)v60;
    [a1 setEvInfo:v60];
  }
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      uint64_t v8 = (int *)&readAll__recursiveTag_217;
    }
    else {
      uint64_t v8 = (int *)&readAll__nonRecursiveTag_218;
    }
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    [(GEOCompanionDriveStep *)self readAll:0];
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v20 + 25) = self->_readerMarkLength;
  ...
  if ([(GEOCompanionDriveStep *)self junctionElementsCount])
  {
    [v20 clearJunctionElements];
    unint64_t v6 = [(GEOCompanionDriveStep *)self junctionElementsCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(GEOCompanionDriveStep *)self junctionElementAtIndex:i];
        objc_msgSend(v20, "addJunctionElement:", v9, v10);
      }
    }
  }
  if ([(GEOCompanionDriveStep *)self maneuverNamesCount])
  {
    [v20 clearManeuverNames];
    unint64_t v11 = [(GEOCompanionDriveStep *)self maneuverNamesCount];
    if (v11)
    {
      unint64_t v12 = v11;
      for (uint64_t j = 0; j != v12; ++j)
      {
        uint64_t v14 = [(GEOCompanionDriveStep *)self maneuverNameAtIndex:j];
        [v20 addManeuverName:v14];
      }
    }
  }
  if ([(GEOCompanionDriveStep *)self signpostsCount])
  {
    [v20 clearSignposts];
    unint64_t v15 = [(GEOCompanionDriveStep *)self signpostsCount];
    if (v15)
    {
      unint64_t v16 = v15;
      for (uint64_t k = 0; k != v16; ++k)
      {
        uint64_t v18 = [(GEOCompanionDriveStep *)self signpostAtIndex:k];
        [v20 addSignpost:v18];
      }
    }
  }
  ...
  if ((*(_WORD *)&self->_flags & 0x10) != 0)
  {
    *((unsigned char *)v20 + 124) = self->_toFreeway;
    *((_WORD *)v20 + 64) |= 0x10u;
  }
  if (self->_exitNumber)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 80) = v9;
  ...
  if (v14)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v14; ++i)
      {
        ...
        uint64_t v17 = (void *)[*(id *)(*((void *)&v35 + 1) + 8 * i) copyWithZone:a3];
  ...
  if (v19)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v19; ++j)
      {
        ...
        long long v22 = objc_msgSend(*(id *)(*((void *)&v31 + 1) + 8 * j), "copyWithZone:", a3, (void)v31);
  ...
  if ((*(_WORD *)&self->_flags & 0x10) != 0)
  {
    *(unsigned char *)(v5 + 124) = self->_toFreeway;
    *(_WORD *)(v5 + 128) |= 0x10u;
  }
  id v23 = -[GEONameInfo copyWithZone:](self->_exitNumber, "copyWithZone:", a3, (void)v31);
  ...
  *(void *)(v5 + 64) = v23;
  ...
  long long v26 = *(void **)(v5 + 40);
  *(void *)(v5 + 40) = v25;

  id v27 = [(GEOEVChargeInfo *)self->_chargingInfo copyWithZone:a3];
  uint64_t v28 = *(void **)(v5 + 48);
  *(void *)(v5 + 48) = v27;

  id v29 = [(GEOEVStepInfo *)self->_evInfo copyWithZone:a3];
  id v8 = *(id *)(v5 + 56);
  *(void *)(v5 + 56) = v29;
LABEL_32:
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOCompanionDriveStep *)self readAll:1];
  [v4 readAll:1];
  __int16 flags = (__int16)self->_flags;
...
LABEL_44:
  ...
  if ((unint64_t)evInfo | (unint64_t)v4[7]) {
    char v9 = -[GEOEVStepInfo isEqual:](evInfo, "isEqual:");
  }
  else {
    char v9 = 1;
  }
...
- (unint64_t)hash
{
  [(GEOCompanionDriveStep *)self readAll:1];
  if ((*(_WORD *)&self->_flags & 4) != 0) {
    uint64_t v17 = 2654435761 * self->_maneuverType;
  }
  else {
    uint64_t v17 = 0;
  }
...
LABEL_9:
  ...
  NSUInteger v13 = v3 ^ v17 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10;
  unint64_t v14 = v11 ^ v12 ^ [(GEOPBTransitArtwork *)self->_artworkOverride hash];
  unint64_t v15 = v14 ^ [(GEOEVChargeInfo *)self->_chargingInfo hash];
  return v13 ^ v15 ^ [(GEOEVStepInfo *)self->_evInfo hash];
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v13; ++j)
      {
        ...
        [(GEOCompanionDriveStep *)self addManeuverName:*(void *)(*((void *)&v33 + 1) + 8 * j)];
      }
  ...
  if (v17)
  {
    ...
    do
    {
      for (uint64_t k = 0; k != v18; ++k)
      {
        ...
        -[GEOCompanionDriveStep addSignpost:](self, "addSignpost:", *(void *)(*((void *)&v29 + 1) + 8 * k), (void)v29);
      }
  ...
  {
    self->_toFreeway = *((unsigned char *)v4 + 124);
