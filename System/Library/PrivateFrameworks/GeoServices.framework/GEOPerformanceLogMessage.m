...
@implementation GEOPerformanceLogMessage

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPerformanceLogMessage;
  v4 = [(GEOPerformanceLogMessage *)&v8 description];
  v5 = [(GEOPerformanceLogMessage *)self dictionaryRepresentation];
