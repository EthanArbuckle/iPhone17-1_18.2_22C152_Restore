...
- (GEOPDSearchKeyValuePair)init
{
  ...
  v2 = [(GEOPDSearchKeyValuePair *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSearchKeyValuePair)initWithData:(id)a3
{
  ...
  v3 = [(GEOPDSearchKeyValuePair *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v4 = [(GEOPDSearchKeyValuePair *)&v8 description];
  v5 = [(GEOPDSearchKeyValuePair *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v3)
      {
        id v4 = v3;
        objc_sync_enter(v4);
        GEOPDSearchKeyValuePairReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readKey_tags_213);
        objc_sync_exit(v4);
      }
    }
    ...
    if ((*(unsigned char *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v6)
      {
        id v7 = v6;
        objc_sync_enter(v7);
        GEOPDSearchKeyValuePairReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readValue_tags_214);
        objc_sync_exit(v7);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 40));
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        objc_super v6 = (int *)&readAll__recursiveTag_215;
      }
      else {
        objc_super v6 = (int *)&readAll__nonRecursiveTag_216;
      }
      GEOPDSearchKeyValuePairReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 40));
  }
...
- (uint64_t)_initWithDictionary:(uint64_t)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      id v4 = [v3 objectForKeyedSubscript:@"key"];
      objc_opt_class();
