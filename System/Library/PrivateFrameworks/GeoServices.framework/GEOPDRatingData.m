...
- (GEOPDRatingData)initWithData:(id)a3
{
  ...
  v3 = [(GEOPDRatingData *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOPDRatingDataReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readRatings_tags);
        objc_sync_exit(v3);
      }
    }
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOPDRatingDataReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readVendorId_tags_8065);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (id)description
{
  ...
  v4 = [(GEOPDRatingData *)&v8 description];
  id v5 = [(GEOPDRatingData *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    v13 = -[GEOPDRatingData vendorId]((id *)a1);
    if (v13)
    {
      if (a2) {
        v14 = @"vendorId";
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        id v6 = (int *)&readAll__recursiveTag_8066;
      }
      else {
        id v6 = (int *)&readAll__nonRecursiveTag_8067;
      }
      GEOPDRatingDataReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    if (a2) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v13 = [(NSString *)self->_vendorId copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](ratings, "isEqual:")))
  {
    ...
    if ((unint64_t)vendorId | v4[4]) {
      char v7 = -[NSString isEqual:](vendorId, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
{
  -[GEOPDRatingData readAll:]((uint64_t)self, 1);
  uint64_t v3 = [(NSMutableArray *)self->_ratings hash];
