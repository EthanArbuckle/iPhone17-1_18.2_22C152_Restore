...
- (id)description
{
  ...
  v4 = [(GEOPDZoomInfo *)&v8 description];
  char v5 = [(GEOPDZoomInfo *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 32) & 2) == 0 || self->_minZoom != *((double *)v4 + 3)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 32) & 1) == 0 || self->_maxZoom != *((double *)v4 + 2)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  ...
  if ((flags & 2) != 0)
  {
    double minZoom = self->_minZoom;
    double v6 = -minZoom;
    if (minZoom >= 0.0) {
      double v6 = self->_minZoom;
    }
  ...
  if (flags)
  {
    double maxZoom = self->_maxZoom;
    double v11 = -maxZoom;
    if (maxZoom >= 0.0) {
      double v11 = self->_maxZoom;
    }
