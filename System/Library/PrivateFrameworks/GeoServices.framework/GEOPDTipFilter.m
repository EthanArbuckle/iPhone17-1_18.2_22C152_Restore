...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)GEOPDTipFilter;
...
- (uint64_t)addPhotoSizeFilter:(int)a3
{
  ...
  {
    uint64_t v5 = result;
    result = -[GEOPDTipFilter _reservePhotoSizeFilters:](result, 1uLL);
    if (result)
    {
...
LABEL_12:
    ...
    uint64_t result = (uint64_t)malloc_type_realloc(*(void **)(a1 + 16), 12 * v9, 0xD0C0B584uLL);
    if (result)
    {
      *(void *)(a1 + 32) = v9;
      *(void *)(a1 + 16) = result;
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)GEOPDTipFilter;
  unint64_t v4 = [(GEOPDTipFilter *)&v8 description];
  unint64_t v5 = [(GEOPDTipFilter *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDTipFilter _dictionaryRepresentation:](self, 0);
}
  ...
  if (a1)
  {
    ...
    if (v10)
    {
      ...
      if (a2)
      {
        ...
        v17[1] = 3221225472;
        v17[2] = __44__GEOPDTipFilter__dictionaryRepresentation___block_invoke;
        v17[3] = &unk_1E53D8860;
        id v14 = v13;
        id v18 = v14;
...
- (id)jsonRepresentation
{
  return -[GEOPDTipFilter _dictionaryRepresentation:](self, 1);
}

void __44__GEOPDTipFilter__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (BOOL)readFrom:(id)a3
{
  return GEOPDTipFilterReadAllFrom(self, a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  {
    -[GEOPDTipFilter _reservePhotoSizeFilters:](v4, photoSizeFiltersCount);
