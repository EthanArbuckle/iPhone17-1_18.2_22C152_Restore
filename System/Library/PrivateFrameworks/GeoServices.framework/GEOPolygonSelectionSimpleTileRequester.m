...
- (uint64_t)_regularTileKeyForPolygonSelectionSelectionTileKey:(uint64_t)a3 polyId:(void *)a4;
- (uint64_t)tileDataIsCacheableForTileKey:;
@end

@implementation GEOPolygonSelectionSimpleTileRequester
...
- (uint64_t)_regularTileKeyForPolygonSelectionSelectionTileKey:(uint64_t)a3 polyId:(void *)a4
{
  ...
  if (GEOSelectionTileKeyGetXYZId(a3, (int *)&v22 + 1, &v22, &v21, &v20))
  {
    ...
    long long v16 = 0u;
    long long v17 = 0u;
    uint64_t v7 = [&unk_1ED73EDA0 countByEnumeratingWithState:&v16 objects:v23 count:16];
    if (v7)
    {
      uint64_t v8 = v7;
...
LABEL_4:
      ...
      {
        if (*(void *)v17 != v9) {
          objc_enumerationMutation(&unk_1ED73EDA0);
        }
        if (objc_msgSend(v6, "supportsTileStyle:size:scale:", 69, objc_msgSend(*(id *)(*((void *)&v16 + 1) + 8 * v10), "integerValue"), 0))break; {
        if (v8 == ++v10)
        }
        {
          uint64_t v8 = [&unk_1ED73EDA0 countByEnumeratingWithState:&v16 objects:v23 count:16];
          if (v8) {
            goto LABEL_4;
          }
          goto LABEL_10;
...
- (id)activeTileSetForKey:(void *)a1
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  uint64_t v2 = [&unk_1ED73EDB8 countByEnumeratingWithState:&v10 objects:v14 count:16];
  if (v2)
  {
    uint64_t v3 = v2;
...
LABEL_3:
    ...
    {
      if (*(void *)v11 != v4) {
        objc_enumerationMutation(&unk_1ED73EDB8);
      }
      uint64_t v6 = [*(id *)(*((void *)&v10 + 1) + 8 * v5) integerValue];
      if ([v1 supportsTileStyle:69 size:v6 scale:0]) {
        break;
      }
      if (v3 == ++v5)
      {
        uint64_t v3 = [&unk_1ED73EDB8 countByEnumeratingWithState:&v10 objects:v14 count:16];
        if (v3) {
          goto LABEL_3;
        }
        goto LABEL_9;
...
LABEL_9:
  ...
  uint64_t v8 = [v7 activeTileSetForStyle:69 size:v6 scale:0];
...
- (id)urlForTileKey:(uint64_t)a3
{
  ...
  uint64_t v17 = 0;
  *(void *)&long long v25 = [a1 _regularTileKeyForPolygonSelectionSelectionTileKey:a3 polyId:&v17];
  *((void *)&v25 + 1) = v7;
  ...
  if (v8)
  {
    ...
    v18[1] = 3221225472;
    v18[2] = __56__GEOPolygonSelectionSimpleTileRequester_urlForTileKey___block_invoke;
    v18[3] = &unk_1E53E0D10;
    long long v24 = v25;
    id v19 = v5;
    uint64_t v20 = a1;
    ...
    v16.receiver = a1;
    v16.super_class = (Class)GEOPolygonSelectionSimpleTileRequester;
...
void __56__GEOPolygonSelectionSimpleTileRequester_urlForTileKey___block_invoke(uint64_t a1, void *a2)
{
  id v8 = a2;
...
- (id)_localizationURLForTileKey:(uint64_t)a3
{
  ...
  uint64_t v6 = [a1 activeTileSetForKey:a3];
  uint64_t v21 = 0;
  *(void *)&long long v29 = [a1 _regularTileKeyForPolygonSelectionSelectionTileKey:a3 polyId:&v21];
  *((void *)&v29 + 1) = v7;
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      v22[1] = 3221225472;
      v22[2] = __69__GEOPolygonSelectionSimpleTileRequester__localizationURLForTileKey___block_invoke;
      v22[3] = &unk_1E53E0D10;
      long long v28 = v29;
      id v23 = v5;
      id v24 = v13;
      ...
      v20.receiver = a1;
      v20.super_class = (Class)GEOPolygonSelectionSimpleTileRequester;
...
void __69__GEOPolygonSelectionSimpleTileRequester__localizationURLForTileKey___block_invoke(uint64_t a1, void *a2)
{
  id v7 = a2;
