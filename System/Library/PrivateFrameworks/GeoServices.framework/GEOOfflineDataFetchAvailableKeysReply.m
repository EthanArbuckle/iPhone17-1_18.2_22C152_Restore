@interface GEOOfflineDataFetchAvailableKeysReply
- (BOOL)isValid;
- (GEOOfflineDataFetchAvailableKeysReply)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (NSArray)keys;
- (void)encodeToXPCDictionary:(id)a3;
- (void)setKeys:(id)a3;
@end

@implementation GEOOfflineDataFetchAvailableKeysReply

- (GEOOfflineDataFetchAvailableKeysReply)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v18.receiver = self;
  v18.super_class = (Class)GEOOfflineDataFetchAvailableKeysReply;
  ...
  if (v7)
  {
    ...
    if (count)
    {
      for (size_t i = 0; i != count; ++i)
      {
        ...
        if (v12)
        {
          v13 = [[GEOOfflineDataKey alloc] initWithXPCDictionary:v12 error:a4];
          if (v13) {
            [v10 addObject:v13];
          }
        }
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  id v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)GEOOfflineDataFetchAvailableKeysReply;
