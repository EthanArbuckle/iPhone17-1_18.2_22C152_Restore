@interface GEOLocationShiftingListCacheResponse
- (BOOL)isValid;
- (GEOLocationShiftingListCacheResponse)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (NSArray)items;
- (void)encodeToXPCDictionary:(id)a3;
- (void)setItems:(id)a3;
@end

@implementation GEOLocationShiftingListCacheResponse

- (GEOLocationShiftingListCacheResponse)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v18.receiver = self;
  v18.super_class = (Class)GEOLocationShiftingListCacheResponse;
  v7 = [(GEOXPCReply *)&v18 initWithXPCDictionary:v6 error:a4];
  if (v7)
  {
    v8 = xpc_dictionary_get_array(v6, "items");
    ...
    if (count)
    {
      for (size_t i = 0; i != count; ++i)
      {
        ...
        if (v12)
        {
          v13 = [[GEOLocationShiftingCacheItem alloc] initWithXPCDictionary:v12 error:a4];
          if (v13) {
            [v10 addObject:v13];
          }
        }
    ...
    objc_storeStrong((id *)&v7->_items, v15);
    if (v14) {
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  id v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)GEOLocationShiftingListCacheResponse;
  ...
  if ([(NSArray *)self->_items count])
  {
    ...
    if (xpc_array_get_count(v5)) {
      xpc_dictionary_set_value(v4, "items", v5);
    }
  }
}
