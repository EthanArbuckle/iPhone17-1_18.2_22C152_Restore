...
- (id)description
{
  ...
  id v4 = [(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)&v8 description];
  v5 = [(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)self dictionaryRepresentation];
...
{
  id v8 = a3;
  [(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)self readAll:0];
  if ([(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)self buttonsCount])
  {
    [v8 clearButtons];
    unint64_t v4 = [(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)self buttonsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)self buttonsAtIndex:i];
        [v8 addButtons:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    char v5 = 1;
    [(GEORevealedPlaceCardModuleTypeUnifiedActionRow *)self readAll:1];
    [v4 readAll:1];
    buttons = self->_buttons;
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEORevealedPlaceCardModuleTypeUnifiedActionRow addButtons:](self, "addButtons:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
