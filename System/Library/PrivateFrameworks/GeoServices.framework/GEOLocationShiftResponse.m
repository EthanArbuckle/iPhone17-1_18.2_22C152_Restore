...
- (id)description
{
  ...
  v4 = [(GEOLocationShiftResponse *)&v8 description];
  v5 = [(GEOLocationShiftResponse *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(void *)a1
{
  if (a1)
  {
    ...
    [v2 setObject:v3 forKey:@"shiftedPixel"];
  }
  else
  {
    v2 = 0;
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      v4 = [v3 objectForKeyedSubscript:@"shiftedPixel"];
      objc_opt_class();
...
{
  v5 = (char *)a3;
  [(GEOLocationShiftResponse *)self readAll:0];
  uint64_t v4 = *(void *)&self->_shiftedPixel._z;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v5 = *(void *)&self->_shiftedPixel._z;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    [(GEOLocationShiftResponse *)self readAll:1];
    [v4 readAll:1];
    BOOL v7 = *(void *)&self->_shiftedPixel._x == v4[1]
      && *(void *)&self->_shiftedPixel._y == v4[2]
      && *(void *)&self->_shiftedPixel._z == v4[3];
  }
  else
  {
    BOOL v7 = 0;
