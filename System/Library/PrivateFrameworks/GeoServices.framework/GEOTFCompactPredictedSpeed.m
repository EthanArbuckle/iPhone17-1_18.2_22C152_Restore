...
- (id)description
{
  ...
  v4 = [(GEOTFCompactPredictedSpeed *)&v8 description];
  v5 = [(GEOTFCompactPredictedSpeed *)self dictionaryRepresentation];
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 16) & 2) == 0 || self->_speedKph != *((_DWORD *)v4 + 3)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_speedKph;
  return v3 ^ v2;
}
