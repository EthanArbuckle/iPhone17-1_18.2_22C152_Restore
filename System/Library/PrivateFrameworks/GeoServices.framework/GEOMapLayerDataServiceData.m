...
- (GEOMapLayerDataServiceData)init
{
  ...
  v2 = [(GEOMapLayerDataServiceData *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOMapLayerDataServiceData)initWithData:(id)a3
{
  ...
  v3 = [(GEOMapLayerDataServiceData *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v4 = [(GEOMapLayerDataServiceData *)&v8 description];
  v5 = [(GEOMapLayerDataServiceData *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v5)
      {
        id v6 = v5;
        objc_sync_enter(v6);
        GEOMapLayerDataServiceDataReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readLayer_tags);
        objc_sync_exit(v6);
      }
    }
    ...
    if ((*(unsigned char *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v10)
      {
        id v11 = v10;
        objc_sync_enter(v11);
        GEOMapLayerDataServiceDataReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readVersion_tags_4);
        objc_sync_exit(v11);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
    ...
    if ((*(unsigned char *)(a1 + 52) & 1) == 0)
    {
      ...
      if (v15)
      {
        id v16 = v15;
        objc_sync_enter(v16);
        GEOMapLayerDataServiceDataReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readIndex_tags);
        objc_sync_exit(v16);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        id v6 = (int *)&readAll__recursiveTag_65;
      }
      else {
        id v6 = (int *)&readAll__nonRecursiveTag_65;
      }
      GEOMapLayerDataServiceDataReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
  }
...
LABEL_5:
    ...
    id v12 = [(GEOMapLayerDataServiceLayerIndex *)self->_index copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[GEOMapLayerDataServiceVersion isEqual:](version, "isEqual:")))
  {
    ...
    if ((unint64_t)index | v4[2]) {
      char v8 = -[GEOMapLayerDataServiceLayerIndex isEqual:](index, "isEqual:");
    }
    else {
      char v8 = 1;
    }
...
- (unint64_t)hash
{
  ...
  unint64_t v4 = [(GEOMapLayerDataServiceVersion *)self->_version hash] ^ v3;
  return v4 ^ [(GEOMapLayerDataServiceLayerIndex *)self->_index hash];
}
