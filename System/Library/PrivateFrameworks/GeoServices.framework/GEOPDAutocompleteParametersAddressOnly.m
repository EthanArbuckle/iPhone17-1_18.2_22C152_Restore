...
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (GEOPDAutocompleteParametersAddressOnly)init;
- (GEOPDAutocompleteParametersAddressOnly)initWithData:(id)a3;
- (GEOPDAutocompleteParametersAddressOnly)initWithDictionary:(id)a3;
- (GEOPDAutocompleteParametersAddressOnly)initWithJSON:(id)a3;
...
@implementation GEOPDAutocompleteParametersAddressOnly

- (GEOPDAutocompleteParametersAddressOnly)init
{
  v6.receiver = self;
  v6.super_class = (Class)GEOPDAutocompleteParametersAddressOnly;
  v2 = [(GEOPDAutocompleteParametersAddressOnly *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
{
  v7.receiver = self;
  v7.super_class = (Class)GEOPDAutocompleteParametersAddressOnly;
  v3 = [(GEOPDAutocompleteParametersAddressOnly *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 60) & 8) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOPDAutocompleteParametersAddressOnlyReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readQuery_tags);
        objc_sync_exit(v3);
      }
    }
...
- (NSString)query
{
  -[GEOPDAutocompleteParametersAddressOnly _readQuery]((uint64_t)self);
  query = self->_query;
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 60) & 0x10) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOPDAutocompleteParametersAddressOnlyReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readViewportInfo_tags_913);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (GEOPDViewportInfo)viewportInfo
{
  -[GEOPDAutocompleteParametersAddressOnly _readViewportInfo]((uint64_t)self);
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDAutocompleteParametersAddressOnly;
  v4 = [(GEOPDAutocompleteParametersAddressOnly *)&v8 description];
  v5 = [(GEOPDAutocompleteParametersAddressOnly *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDAutocompleteParametersAddressOnly _dictionaryRepresentation:]((uint64_t)self, 0);
}
  ...
  if (a1)
  {
    ...
    if (v15)
    {
      ...
      if (a2)
      {
        ...
        v22[1] = 3221225472;
        v22[2] = __68__GEOPDAutocompleteParametersAddressOnly__dictionaryRepresentation___block_invoke;
        v22[3] = &unk_1E53D8860;
        id v19 = v18;
        id v23 = v19;
...
- (id)jsonRepresentation
{
  return -[GEOPDAutocompleteParametersAddressOnly _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __68__GEOPDAutocompleteParametersAddressOnly__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (GEOPDAutocompleteParametersAddressOnly)initWithDictionary:(id)a3
{
  return (GEOPDAutocompleteParametersAddressOnly *)-[GEOPDAutocompleteParametersAddressOnly _initWithDictionary:isJSON:](self, a3, 0);
}
...
- (GEOPDAutocompleteParametersAddressOnly)initWithJSON:(id)a3
{
  return (GEOPDAutocompleteParametersAddressOnly *)-[GEOPDAutocompleteParametersAddressOnly _initWithDictionary:isJSON:](self, a3, 1);
}
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      objc_super v8 = (int *)&readAll__recursiveTag_923;
    }
    else {
      objc_super v8 = (int *)&readAll__nonRecursiveTag_924;
    }
    GEOPDAutocompleteParametersAddressOnlyReadSpecified((uint64_t)self, (unint64_t)self->_reader, v8);
    objc_sync_exit(v7);
  }
  if (v3) {
...
+ (BOOL)isValid:(id)a3
{
  return GEOPDAutocompleteParametersAddressOnlyIsValid((char *)a3);
}

- (BOOL)readFrom:(id)a3
{
  return GEOPDAutocompleteParametersAddressOnlyReadAllFrom((uint64_t)self, a3, 0);
}
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    [(GEOPDAutocompleteParametersAddressOnly *)self readAll:0];
    if (self->_query) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (reader)
  {
    ...
    if ((*(unsigned char *)&self->_flags & 0x20) == 0)
    {
      *(void *)((char *)self->_reader + (int)*MEMORY[0x1E4F940E0]) = self->_readerMarkLength;
      [(PBDataReader *)self->_reader seekToOffset:self->_readerMarkPos];
      GEOPDAutocompleteParametersAddressOnlyReadAllFrom(v5, self->_reader, 0);
      os_unfair_lock_unlock(&self->_readerLock);
      id v8 = (id)v5;
      objc_sync_exit(v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOPDAutocompleteParametersAddressOnly *)self readAll:1];
  [v4 readAll:1];
  query = self->_query;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v8[3])
  {
    -[GEOPDAutocompleteParametersAddressOnly setQuery:](self, "setQuery:");
    unint64_t v4 = v8;
  }
  viewportInfo = self->_viewportInfo;
  uint64_t v6 = v4[4];
  ...
  else
  {
    ...
    -[GEOPDAutocompleteParametersAddressOnly setViewportInfo:](self, "setViewportInfo:");
  }
  unint64_t v4 = v8;
LABEL_9:
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(unsigned char *)&self->_flags & 4) == 0)
  {
    ...
    if (reader)
    {
      uint64_t v5 = reader;
      objc_sync_enter(v5);
      GEOPDAutocompleteParametersAddressOnlyReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_928);
      objc_sync_exit(v5);
    }
  }
  os_unfair_lock_unlock(p_readerLock);
