...
- (id)description
{
  ...
  v4 = [(GEOPDTileList *)&v8 description];
  id v5 = [(GEOPDTileList *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)tiles | v4[1]) {
      char v6 = -[NSMutableArray isEqual:](tiles, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSMutableArray *)self->_tiles hash];
}
