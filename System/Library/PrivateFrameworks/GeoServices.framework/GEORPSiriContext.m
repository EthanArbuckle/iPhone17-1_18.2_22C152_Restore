...
- (GEORPSiriContext)initWithData:(id)a3
{
  ...
  v3 = [(GEORPSiriContext *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPSiriContextReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readSiriIncidentType_tags);
        objc_sync_exit(v3);
      }
    }
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPSiriContextReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readAdditionalDetails_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 40));
...
- (id)description
{
  ...
  v4 = [(GEORPSiriContext *)&v8 description];
  v5 = [(GEORPSiriContext *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(void *)a1
{
  if (a1)
  {
    ...
    v5 = [a1 siriIncidentType];
    if (v5)
    {
      if (a2) {
        objc_super v6 = @"siriIncidentType";
      }
      else {
        objc_super v6 = @"siri_incident_type";
      }
      [v4 setObject:v5 forKey:v6];
    }

    objc_super v7 = [a1 additionalDetails];
    if (v7)
    {
      if (a2) {
        objc_super v8 = @"additionalDetails";
      }
      else {
        objc_super v8 = @"additional_details";
      }
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [a1 setSiriIncidentType:v8];
      }
      if (a3) {
        v9 = @"additionalDetails";
      }
      else {
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      objc_super v8 = (int *)&readAll__recursiveTag_351;
    }
    else {
      objc_super v8 = (int *)&readAll__nonRecursiveTag_352;
    }
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    [(GEORPSiriContext *)self readAll:0];
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    [(GEORPSiriContext *)self readAll:0];
    uint64_t v8 = [(NSString *)self->_siriIncidentType copyWithZone:a3];
    v9 = (void *)v5[3];
    v5[3] = v8;

    uint64_t v10 = [(NSString *)self->_additionalDetails copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && (([(GEORPSiriContext *)self readAll:1],
         [v4 readAll:1],
         siriIncidentType = self->_siriIncidentType,
     ...
     || -[NSString isEqual:](siriIncidentType, "isEqual:")))
  {
    ...
    if ((unint64_t)additionalDetails | v4[2]) {
      char v7 = -[NSString isEqual:](additionalDetails, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
{
  [(GEORPSiriContext *)self readAll:1];
  NSUInteger v3 = [(NSString *)self->_siriIncidentType hash];
  return [(NSString *)self->_additionalDetails hash] ^ v3;
}
