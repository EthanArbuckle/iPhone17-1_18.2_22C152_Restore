...
@implementation GEOETATrafficUpdateResponseExtension

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOETATrafficUpdateResponseExtension;
  v4 = [(GEOETATrafficUpdateResponseExtension *)&v8 description];
  v5 = [(GEOETATrafficUpdateResponseExtension *)self dictionaryRepresentation];
