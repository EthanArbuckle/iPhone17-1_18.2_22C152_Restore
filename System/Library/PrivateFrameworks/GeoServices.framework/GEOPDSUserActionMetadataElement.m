...
@implementation GEOPDSUserActionMetadataElement

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSUserActionMetadataElement;
  v4 = [(GEOPDSUserActionMetadataElement *)&v8 description];
  v5 = [(GEOPDSUserActionMetadataElement *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDSUserActionMetadataElement _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
LABEL_48:
      ...
      if (a2) {
        objc_super v8 = @"uiAction";
      }
      else {
        objc_super v8 = @"ui_action";
      }
...
LABEL_1360:
    ...
    if (v12)
    {
      ...
      if (a2)
      {
        ...
        v19[1] = 3221225472;
        v19[2] = __61__GEOPDSUserActionMetadataElement__dictionaryRepresentation___block_invoke;
        v19[3] = &unk_1E53D8860;
        id v16 = v15;
        id v20 = v16;
...
- (id)jsonRepresentation
{
  return -[GEOPDSUserActionMetadataElement _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __61__GEOPDSUserActionMetadataElement__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (BOOL)readFrom:(id)a3
{
  return GEOPDSUserActionMetadataElementReadAllFrom((uint64_t)self, a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (flags)
  {
    *(_DWORD *)(v4 + 16) = self->_uiAction;
    *(unsigned char *)(v4 + 24) |= 1u;
    char flags = (char)self->_flags;
  }
  if ((flags & 2) != 0)
  {
    *(_DWORD *)(v4 + 20) = self->_uiTarget;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 1) == 0 || self->_uiAction != *((_DWORD *)v4 + 4)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_uiTarget != *((_DWORD *)v4 + 5)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_flags)
  {
    uint64_t v2 = 2654435761 * self->_uiAction;
    if ((*(unsigned char *)&self->_flags & 2) != 0) {
      goto LABEL_3;
    }
LABEL_5:
