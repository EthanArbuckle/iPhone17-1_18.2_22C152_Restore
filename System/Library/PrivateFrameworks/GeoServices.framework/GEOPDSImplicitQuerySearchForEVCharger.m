@interface GEOPDSImplicitQuerySearchForEVCharger
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (id)description
{
  ...
  v4 = [(GEOPDSImplicitQuerySearchForEVCharger *)&v8 description];
  v5 = [(GEOPDSImplicitQuerySearchForEVCharger *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (*(unsigned char *)(a1 + 24))
    {
      ...
      if (a2) {
        v6 = @"encryptedCurrentEvchargerStopMuid";
      }
      else {
        v6 = @"encrypted_current_evcharger_stop_muid";
      }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    *(void *)(v4 + 16) = self->_encryptedCurrentEvchargerStopMuid;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 24) & 1) != 0 && self->_encryptedCurrentEvchargerStopMuid == *((void *)v4 + 2))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
