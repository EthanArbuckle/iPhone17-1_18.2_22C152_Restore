...
- (GEOPDFeatureBuilding)init
{
  ...
  v2 = [(GEOPDFeatureBuilding *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOPDFeatureBuilding)initWithData:(id)a3
{
  ...
  v3 = [(GEOPDFeatureBuilding *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v4 = [(GEOPDFeatureBuilding *)&v8 description];
  id v5 = [(GEOPDFeatureBuilding *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 60) & 8) == 0)
    {
      ...
      if (v5)
      {
        id v6 = v5;
        objc_sync_enter(v6);
        GEOPDFeatureBuildingReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readVenueContainer_tags);
        objc_sync_exit(v6);
      }
    }
    ...
    if ((*(unsigned char *)(a1 + 60) & 2) == 0)
    {
      ...
      if (v11)
      {
        id v12 = v11;
        objc_sync_enter(v12);
        GEOPDFeatureBuildingReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readBuilding_tags);
        objc_sync_exit(v12);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 56));
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        id v6 = (int *)&readAll__recursiveTag_8;
      }
      else {
        id v6 = (int *)&readAll__nonRecursiveTag_8;
      }
      GEOPDFeatureBuildingReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    if (a2) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 24) = v10;
  ...
  v20 = self;
  obj = self->_levels;
  uint64_t v12 = [(NSMutableArray *)obj countByEnumeratingWithState:&v22 objects:v26 count:16];
  if (v12)
  {
    uint64_t v13 = *(void *)v23;
    long long v14 = (os_unfair_lock_s *)(v5 + 56);
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        id v16 = (id)objc_msgSend(*(id *)(*((void *)&v22 + 1) + 8 * i), "copyWithZone:", a3, v20);
        ...
        if ((*(unsigned char *)(v5 + 60) & 4) == 0)
        {
          ...
          if (v17)
          {
            id v18 = v17;
            objc_sync_enter(v18);
            GEOPDFeatureBuildingReadSpecified(v5, *(void *)(v5 + 8), (int *)&_readLevels_tags);
            objc_sync_exit(v18);
          }
        }
