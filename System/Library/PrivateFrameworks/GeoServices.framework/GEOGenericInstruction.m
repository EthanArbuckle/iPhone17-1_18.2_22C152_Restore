...
- (id)description
{
  ...
  v4 = [(GEOGenericInstruction *)&v8 description];
  v5 = [(GEOGenericInstruction *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(void *)a1
{
  if (a1)
  {
    ...
    v5 = [a1 maneuver];
    if (v5) {
      [v4 setObject:v5 forKey:@"maneuver"];
    }
...
- (void)_initWithDictionary:(void *)a1 isJSON:(void *)a2
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      v4 = [v3 objectForKeyedSubscript:@"maneuver"];
      objc_opt_class();
...
{
  id v4 = a3;
  [(GEOGenericInstruction *)self readAll:0];
  if (self->_maneuver) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSString *)self->_maneuver copyWithZone:a3];
  v7 = *(void **)(v5 + 16);
  *(void *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    char v5 = 1;
    [(GEOGenericInstruction *)self readAll:1];
    [v4 readAll:1];
    maneuver = self->_maneuver;
    if ((unint64_t)maneuver | v4[2]) {
      char v5 = -[NSString isEqual:](maneuver, "isEqual:");
    }
  }
  else
  {
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    [(GEOGenericInstruction *)self setManeuver:v5];
  }
}
