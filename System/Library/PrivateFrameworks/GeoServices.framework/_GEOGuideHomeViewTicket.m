@interface _GEOGuideHomeViewTicket
- (void)submitWithHandler:(id)a3 networkActivity:(id)a4;
@end

@implementation _GEOGuideHomeViewTicket
...
- (void)submitWithHandler:(id)a3 networkActivity:(id)a4
{
  ...
  if (v6)
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __61___GEOGuideHomeViewTicket_submitWithHandler_networkActivity___block_invoke;
    v8[3] = &unk_1E53DEBA0;
    id v9 = v6;
