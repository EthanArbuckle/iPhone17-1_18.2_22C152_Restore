...
- (void)addRoutingFeaturesInfo:(id)a3
{
  ...
  [(NSMutableArray *)routingFeaturesInfos addObject:v4];
}

- (unint64_t)routingFeaturesInfosCount
{
  return [(NSMutableArray *)self->_routingFeaturesInfos count];
}

- (id)routingFeaturesInfoAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_routingFeaturesInfos objectAtIndex:a3];
}
...
- (id)description
{
  ...
  id v4 = [(GEORoutingFeatures *)&v8 description];
  v5 = [(GEORoutingFeatures *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(id *)a1
{
  ...
  if (a1)
  {
    ...
    if ([a1[1] count])
    {
      ...
      if (a2) {
        v13 = @"routingFeaturesInfo";
      }
      else {
        v13 = @"routing_features_info";
      }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3) {
        id v6 = @"routingFeaturesInfo";
      }
      else {
        id v6 = @"routing_features_info";
      }
          ...
          do
          {
            for (uint64_t i = 0; i != v10; ++i)
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                ...
                if (a3) {
                  uint64_t v15 = [(GEORoutingFeaturesInfo *)v14 initWithJSON:v13];
                }
                else {
                  uint64_t v15 = [(GEORoutingFeaturesInfo *)v14 initWithDictionary:v13];
                }
                long long v16 = (void *)v15;
                [a1 addRoutingFeaturesInfo:v15];
              }
            }
...
- (void)writeTo:(id)a3
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v5 = self->_routingFeaturesInfos;
...
{
  id v8 = a3;
  [(GEORoutingFeatures *)self readAll:0];
  if ([(GEORoutingFeatures *)self routingFeaturesInfosCount])
  {
    [v8 clearRoutingFeaturesInfos];
    unint64_t v4 = [(GEORoutingFeatures *)self routingFeaturesInfosCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(GEORoutingFeatures *)self routingFeaturesInfoAtIndex:i];
        [v8 addRoutingFeaturesInfo:v7];
      }
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  uint64_t v6 = self->_routingFeaturesInfos;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    char v5 = 1;
    [(GEORoutingFeatures *)self readAll:1];
    [v4 readAll:1];
    routingFeaturesInfos = self->_routingFeaturesInfos;
    if ((unint64_t)routingFeaturesInfos | v4[1]) {
      char v5 = -[NSMutableArray isEqual:](routingFeaturesInfos, "isEqual:");
    }
  }
  else
  {
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)routingFeaturesInfos hash];
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEORoutingFeatures addRoutingFeaturesInfo:](self, "addRoutingFeaturesInfo:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
