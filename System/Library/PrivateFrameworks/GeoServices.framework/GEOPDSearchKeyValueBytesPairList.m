...
@implementation GEOPDSearchKeyValueBytesPairList
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOPDSearchKeyValueBytesPairList addPairs:]((uint64_t)v5, v11);
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSearchKeyValueBytesPairList;
  v4 = [(GEOPDSearchKeyValueBytesPairList *)&v8 description];
  id v5 = [(GEOPDSearchKeyValueBytesPairList *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDSearchKeyValueBytesPairList _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
- (id)jsonRepresentation
{
  return -[GEOPDSearchKeyValueBytesPairList _dictionaryRepresentation:]((uint64_t)self, 1);
}
...
LABEL_15:
        ...
        if ((v11 >> 3) == 1)
        {
          ...
          uint64_t v19 = objc_alloc_init(GEOPDSearchKeyValueBytesPair);
          if (!GEOPDSearchKeyValueBytesPairReadAllFrom((uint64_t)v19, v4))
          {

            goto LABEL_27;
          }
          PBReaderRecallMark();
          -[GEOPDSearchKeyValueBytesPairList addPairs:]((uint64_t)self, v19);
        }
