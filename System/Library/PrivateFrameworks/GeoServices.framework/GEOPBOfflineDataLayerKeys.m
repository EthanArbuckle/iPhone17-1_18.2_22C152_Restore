@interface GEOPBOfflineDataLayerKeys
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (id)description
{
  ...
  v4 = [(GEOPBOfflineDataLayerKeys *)&v8 description];
  id v5 = [(GEOPBOfflineDataLayerKeys *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ([*(id *)(a1 + 32) count])
    {
      ...
      if (a2) {
        v15 = @"keyValueReference";
      }
      else {
        v15 = @"key_value_reference";
      }
...
LABEL_15:
        ...
        if ((v11 >> 3) == 2)
        {
          ...
          long long v18 = objc_alloc_init(GEOPBOfflineDataKeyValueReference);
...
- (void)writeTo:(id)a3
{
  ...
  long long v10 = 0u;
  long long v11 = 0u;
  id v5 = self->_keyValueReferences;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  uint64_t v8 = self->_keyValueReferences;
...
LABEL_15:
  ...
  if ((unint64_t)keyValueReferences | *((void *)v4 + 4)) {
    char v7 = -[NSMutableArray isEqual:](keyValueReferences, "isEqual:");
  }
  else {
    char v7 = 1;
  }
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_keyValueReferences hash] ^ v3;
}
