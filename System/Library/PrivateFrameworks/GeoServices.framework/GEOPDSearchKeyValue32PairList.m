...
@implementation GEOPDSearchKeyValue32PairList
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSearchKeyValue32PairList;
  v4 = [(GEOPDSearchKeyValue32PairList *)&v8 description];
  id v5 = [(GEOPDSearchKeyValue32PairList *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDSearchKeyValue32PairList _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
- (id)jsonRepresentation
{
  return -[GEOPDSearchKeyValue32PairList _dictionaryRepresentation:]((uint64_t)self, 1);
}
...
LABEL_15:
        ...
        if ((v11 >> 3) == 1)
        {
          ...
          uint64_t v19 = objc_alloc_init(GEOPDSearchKeyValue32Pair);
          if (!GEOPDSearchKeyValue32PairReadAllFrom((uint64_t)v19, v4))
          {

            goto LABEL_27;
          }
          PBReaderRecallMark();
          -[GEOPDSearchKeyValue32PairList addPairs:]((uint64_t)self, v19);
        }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOPDSearchKeyValue32PairList addPairs:]((uint64_t)v5, v11);
