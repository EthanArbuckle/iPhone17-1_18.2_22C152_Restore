...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"DodgeballAction_UNKNOWN"])
  {
    int v4 = 0;
  }
  else if ([v3 isEqualToString:@"DodgeballAction_ACCEPTED"])
  {
    int v4 = 1;
  }
  else if ([v3 isEqualToString:@"DodgeballAction_DISMISSED"])
  {
    int v4 = 2;
  }
  else
...
- (id)description
{
  ...
  int v4 = [(GEODodgeballDetails *)&v8 description];
  v5 = [(GEODodgeballDetails *)self dictionaryRepresentation];
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      {
        id v8 = v7;
        if ([v8 isEqualToString:@"DodgeballAction_UNKNOWN"])
        {
          uint64_t v9 = 0;
        }
        else if ([v8 isEqualToString:@"DodgeballAction_ACCEPTED"])
        {
          uint64_t v9 = 1;
        }
        else if ([v8 isEqualToString:@"DodgeballAction_DISMISSED"])
        {
          uint64_t v9 = 2;
        }
        else
...
{
  int v4 = a3;
  [(GEODodgeballDetails *)self readAll:0];
  if (*(unsigned char *)&self->_flags)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEODodgeballDetails *)self readAll:1];
  [v4 readAll:1];
  BOOL v5 = (*((unsigned char *)v4 + 12) & 1) == 0;
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 12) & 1) != 0 && self->_dodgeballAction == *((_DWORD *)v4 + 2))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
