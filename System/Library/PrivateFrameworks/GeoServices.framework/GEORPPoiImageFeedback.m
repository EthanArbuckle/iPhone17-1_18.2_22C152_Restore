...
- (GEORPPoiImageFeedback)init
{
  ...
  v2 = [(GEORPPoiImageFeedback *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEORPPoiImageFeedback)initWithData:(id)a3
{
  ...
  v3 = [(GEORPPoiImageFeedback *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPPoiImageFeedbackReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readPoiImageContext_tags);
        objc_sync_exit(v3);
      }
    }
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPPoiImageFeedbackReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readPoiImageCorrections_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (id)description
{
  ...
  v4 = [(GEORPPoiImageFeedback *)&v8 description];
  v5 = [(GEORPPoiImageFeedback *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if (v5)
    {
      if (a2)
      {
        ...
        objc_super v8 = @"poiImageContext";
      }
      else
      {
        objc_super v7 = [v5 dictionaryRepresentation];
        objc_super v8 = @"poi_image_context";
      }
      [v4 setObject:v7 forKey:v8];
    }
    v9 = [a1 poiImageCorrections];
    v10 = v9;
    if (v9)
    {
      if (a2)
      {
        ...
        v12 = @"poiImageCorrections";
      }
      else
      {
        v11 = [v9 dictionaryRepresentation];
        v12 = @"poi_image_corrections";
      }
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3) {
        objc_super v6 = @"poiImageContext";
      }
      else {
        objc_super v6 = @"poi_image_context";
      }
      objc_super v7 = [v5 objectForKeyedSubscript:v6];
      objc_opt_class();
      if (objc_opt_isKindOfClass())
      {
        objc_super v8 = [GEORPPoiImageFeedbackContext alloc];
        if (a3) {
          uint64_t v9 = [(GEORPPoiImageFeedbackContext *)v8 initWithJSON:v7];
        }
        else {
          uint64_t v9 = [(GEORPPoiImageFeedbackContext *)v8 initWithDictionary:v7];
        }
        id v10 = (void *)v9;
        [a1 setPoiImageContext:v9];
      }
      if (a3) {
        v11 = @"poiImageCorrections";
      }
      else {
        v11 = @"poi_image_corrections";
      }
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (a3) {
          uint64_t v14 = [(GEORPPoiImageFeedbackCorrections *)v13 initWithJSON:v12];
        }
        else {
          uint64_t v14 = [(GEORPPoiImageFeedbackCorrections *)v13 initWithDictionary:v12];
        }
        v15 = (void *)v14;
        [a1 setPoiImageCorrections:v14];
      }
    }
  }
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      objc_super v8 = (int *)&readAll__recursiveTag_3213;
    }
    else {
      objc_super v8 = (int *)&readAll__nonRecursiveTag_3214;
    }
  ...
  if (v3)
  {
    [(GEORPPoiImageFeedbackContext *)self->_poiImageContext readAll:1];
    [(GEORPPoiImageFeedbackCorrections *)self->_poiImageCorrections readAll:1];
  }
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    [(GEORPPoiImageFeedback *)self readAll:0];
...
- (BOOL)hasGreenTeaWithValue:(BOOL)a3
{
  ...
  return [(GEORPPoiImageFeedbackContext *)poiImageContext hasGreenTeaWithValue:v3];
}
...
LABEL_5:
    os_unfair_lock_unlock(&self->_readerLock);
    [(GEORPPoiImageFeedback *)self readAll:0];
    id v8 = [(GEORPPoiImageFeedbackContext *)self->_poiImageContext copyWithZone:a3];
    uint64_t v9 = *(void **)(v5 + 24);
    *(void *)(v5 + 24) = v8;

    id v10 = [(GEORPPoiImageFeedbackCorrections *)self->_poiImageCorrections copyWithZone:a3];
    v11 = *(void **)(v5 + 32);
    *(void *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && (([(GEORPPoiImageFeedback *)self readAll:1],
         [v4 readAll:1],
         poiImageContext = self->_poiImageContext,
     ...
     || -[GEORPPoiImageFeedbackContext isEqual:](poiImageContext, "isEqual:")))
  {
    ...
    if ((unint64_t)poiImageCorrections | v4[4]) {
      char v7 = -[GEORPPoiImageFeedbackCorrections isEqual:](poiImageCorrections, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
{
  [(GEORPPoiImageFeedback *)self readAll:1];
  unint64_t v3 = [(GEORPPoiImageFeedbackContext *)self->_poiImageContext hash];
  return [(GEORPPoiImageFeedbackCorrections *)self->_poiImageCorrections hash] ^ v3;
}
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(unsigned char *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      uint64_t v5 = reader;
      objc_sync_enter(v5);
      GEORPPoiImageFeedbackReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_3218);
      objc_sync_exit(v5);
    }
  }
  os_unfair_lock_unlock(p_readerLock);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(unsigned char *)&self->_flags |= 9u;
  ...
  {
    [(GEORPPoiImageFeedback *)self readAll:0];
    [(GEORPPoiImageFeedbackContext *)self->_poiImageContext clearUnknownFields:1];
    poiImageCorrections = self->_poiImageCorrections;
    [(GEORPPoiImageFeedbackCorrections *)poiImageCorrections clearUnknownFields:1];
  }
}
