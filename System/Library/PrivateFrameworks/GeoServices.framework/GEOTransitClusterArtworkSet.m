...
- (GEOTransitClusterArtworkSet)init
{
  ...
  v2 = [(GEOTransitClusterArtworkSet *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOTransitClusterArtworkSet)initWithData:(id)a3
{
  ...
  v3 = [(GEOTransitClusterArtworkSet *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  [(GEOTransitClusterArtworkSet *)&v3 dealloc];
}
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 68) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOTransitClusterArtworkSetReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readArtworkIndexs_tags);
        objc_sync_exit(v3);
      }
    }
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 68) & 4) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEOTransitClusterArtworkSetReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readArtworkItems_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 64));
...
- (void)clearArtworkItems
{
  ...
  *(unsigned char *)&self->_flags |= 8u;
  ...
  [(NSMutableArray *)artworkItems removeAllObjects];
}
...
- (unint64_t)artworkItemsCount
{
  ...
  return [(NSMutableArray *)artworkItems count];
}
...
- (id)artworkItemAtIndex:(unint64_t)a3
{
  ...
  return (id)[(NSMutableArray *)artworkItems objectAtIndex:a3];
}
...
- (id)description
{
  ...
  id v4 = [(GEOTransitClusterArtworkSet *)&v8 description];
  id v5 = [(GEOTransitClusterArtworkSet *)self dictionaryRepresentation];
          ...
          do
          {
            for (uint64_t j = 0; j != v18; ++j)
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                ...
                if (a3) {
                  uint64_t v23 = [(GEOTransitClusterArtworkItem *)v22 initWithJSON:v21];
                }
                else {
                  uint64_t v23 = [(GEOTransitClusterArtworkItem *)v22 initWithDictionary:v21];
                }
                id v24 = (void *)v23;
                [a1 addArtworkItem:v23];
              }
            }
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      id v8 = (int *)&readAll__recursiveTag_479;
    }
    else {
      id v8 = (int *)&readAll__nonRecursiveTag_480;
    }
...
- (void)writeTo:(id)a3
{
  ...
  {
    os_unfair_lock_unlock(&self->_readerLock);
    [(GEOTransitClusterArtworkSet *)self readAll:0];
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v11 + 15) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if ([(GEOTransitClusterArtworkSet *)self artworkIndexsCount])
  {
    [v11 clearArtworkIndexs];
    unint64_t v4 = [(GEOTransitClusterArtworkSet *)self artworkIndexsCount];
    if (v4)
    {
      unint64_t v5 = v4;
  ...
  if ([(GEOTransitClusterArtworkSet *)self artworkItemsCount])
  {
    [v11 clearArtworkItems];
    unint64_t v7 = [(GEOTransitClusterArtworkSet *)self artworkItemsCount];
    if (v7)
    {
      unint64_t v8 = v7;
      for (uint64_t j = 0; j != v8; ++j)
      {
        uint64_t v10 = [(GEOTransitClusterArtworkSet *)self artworkItemAtIndex:j];
        [v11 addArtworkItem:v10];
      }
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  unint64_t v8 = self->_artworkItems;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && ([(GEOTransitClusterArtworkSet *)self readAll:1],
        [v4 readAll:1],
        PBRepeatedUInt32IsEqual()))
  {
    artworkItems = self->_artworkItems;
    if ((unint64_t)artworkItems | v4[6]) {
      char v6 = -[NSMutableArray isEqual:](artworkItems, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_artworkItems hash] ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    ...
    for (uint64_t i = 0; i != v6; ++i)
      -[GEOTransitClusterArtworkSet addArtworkIndex:](self, "addArtworkIndex:", [v4 artworkIndexAtIndex:i]);
  }
  long long v15 = 0u;
  long long v16 = 0u;
  long long v13 = 0u;
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOTransitClusterArtworkSet addArtworkItem:](self, "addArtworkItem:", *(void *)(*((void *)&v13 + 1) + 8 * v12++), (void)v13);
      }
      while (v10 != v12);
...
- (PBUnknownFields)unknownFields
{
  ...
  if ((*(unsigned char *)&self->_flags & 1) == 0)
  {
    ...
    if (reader)
    {
      uint64_t v5 = reader;
      objc_sync_enter(v5);
      GEOTransitClusterArtworkSetReadSpecified((uint64_t)self, (unint64_t)self->_reader, (int *)&unknownFields_tags_484);
      objc_sync_exit(v5);
    }
  }
  os_unfair_lock_unlock(p_readerLock);
...
- (void)clearUnknownFields:(BOOL)a3
{
  ...
  *(unsigned char *)&self->_flags |= 9u;
  ...
  if (v3)
  {
    ...
    long long v12 = 0u;
    long long v13 = 0u;
    unint64_t v7 = self->_artworkItems;
...
- (id)_maps_artworkIndicesAsString
{
  unint64_t v3 = [(GEOTransitClusterArtworkSet *)self artworkIndexsCount];
  unint64_t v4 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:v3];
  if (v3)
  {
    for (uint64_t i = 0; i != v3; ++i)
    {
      uint64_t v6 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[GEOTransitClusterArtworkSet artworkIndexAtIndex:](self, "artworkIndexAtIndex:", i));
