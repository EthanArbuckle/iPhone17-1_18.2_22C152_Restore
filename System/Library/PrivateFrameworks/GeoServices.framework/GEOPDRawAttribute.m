...
- (GEOPDRawAttribute)initWithData:(id)a3
{
  ...
  v3 = [(GEOPDRawAttribute *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v4 = [(GEOPDRawAttribute *)&v8 description];
  v5 = [(GEOPDRawAttribute *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 2) == 0)
    {
      ...
      if (v5)
      {
        id v6 = v5;
        objc_sync_enter(v6);
        GEOPDRawAttributeReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readKey_tags_2);
        objc_sync_exit(v6);
      }
    }
    ...
    if ((*(unsigned char *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v8)
      {
        id v9 = v8;
        objc_sync_enter(v9);
        GEOPDRawAttributeReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readValue_tags_8086);
        objc_sync_exit(v9);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        id v6 = (int *)&readAll__recursiveTag_8090;
      }
      else {
        id v6 = (int *)&readAll__nonRecursiveTag_8091;
      }
      GEOPDRawAttributeReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
  }
