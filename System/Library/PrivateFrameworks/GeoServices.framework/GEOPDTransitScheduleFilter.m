...
- (GEOPDTransitScheduleFilter)initWithData:(id)a3;
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        v6 = (int *)&readAll__recursiveTag_9564;
      }
      else {
        v6 = (int *)&readAll__nonRecursiveTag_9565;
      }
      GEOPDTransitScheduleFilterReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
...
- (unint64_t)hash
{
  -[GEOPDTransitScheduleFilter readAll:]((uint64_t)self, 1);
...
- (void)writeTo:(id)a3
{
  ...
  else
  {
    ...
    -[GEOPDTransitScheduleFilter readAll:]((uint64_t)self, 0);
...
{
  v6.receiver = self;
  v6.super_class = (Class)GEOPDTransitScheduleFilter;
...
{
  v7.receiver = self;
  v7.super_class = (Class)GEOPDTransitScheduleFilter;
  unint64_t v3 = [(GEOPDTransitScheduleFilter *)&v7 initWithData:a3];
  id v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)GEOPDTransitScheduleFilter;
  id v4 = [(GEOPDTransitScheduleFilter *)&v8 description];
  uint64_t v5 = [(GEOPDTransitScheduleFilter *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDTransitScheduleFilter _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    -[GEOPDTransitScheduleFilter readAll:](a1, 1);
    ...
    if ((*(unsigned char *)(a1 + 68) & 8) == 0)
    {
      ...
      if (v5)
      {
        id v6 = v5;
        objc_sync_enter(v6);
        GEOPDTransitScheduleFilterReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readDeparturePredicateCountdown_tags_9556);
        objc_sync_exit(v6);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 60));
    ...
    if ((*(unsigned char *)(a1 + 68) & 0x10) == 0)
    {
      ...
      if (v11)
      {
        id v12 = v11;
        objc_sync_enter(v12);
        GEOPDTransitScheduleFilterReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readDeparturePredicateStamp_tags_9557);
        objc_sync_exit(v12);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 60));
    ...
    if (v22)
    {
      ...
      if (a2)
      {
        ...
        v29[1] = 3221225472;
        v29[2] = __56__GEOPDTransitScheduleFilter__dictionaryRepresentation___block_invoke;
        v29[3] = &unk_1E53D8860;
        id v26 = v25;
        id v30 = v26;
...
- (id)jsonRepresentation
{
  return -[GEOPDTransitScheduleFilter _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __56__GEOPDTransitScheduleFilter__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (BOOL)readFrom:(id)a3
{
  return GEOPDTransitScheduleFilterReadAllFrom((uint64_t)self, a3, 0);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (reader)
  {
    ...
    if ((*(unsigned char *)&self->_flags & 0x20) == 0)
    {
      *(void *)((char *)self->_reader + (int)*MEMORY[0x1E4F940E0]) = self->_readerMarkLength;
      [(PBDataReader *)self->_reader seekToOffset:self->_readerMarkPos];
      GEOPDTransitScheduleFilterReadAllFrom(v5, self->_reader, 0);
      os_unfair_lock_unlock(&self->_readerLock);
      id v8 = (id)v5;
      objc_sync_exit(v7);
...
- (BOOL)isEqual:(id)a3
{
  ...
  -[GEOPDTransitScheduleFilter readAll:]((uint64_t)self, 1);
  -[GEOPDTransitScheduleFilter readAll:]((uint64_t)v4, 1);
