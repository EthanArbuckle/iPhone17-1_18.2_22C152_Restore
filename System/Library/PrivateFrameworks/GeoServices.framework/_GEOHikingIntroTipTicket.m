@interface _GEOHikingIntroTipTicket
- (void)submitWithHandler:(id)a3 networkActivity:(id)a4;
@end

@implementation _GEOHikingIntroTipTicket
...
- (void)submitWithHandler:(id)a3 networkActivity:(id)a4
{
  ...
  if (v6)
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __62___GEOHikingIntroTipTicket_submitWithHandler_networkActivity___block_invoke;
    v8[3] = &unk_1E53DEBA0;
    id v9 = v6;
