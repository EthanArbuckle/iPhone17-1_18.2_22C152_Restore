...
- (id)description
{
  ...
  v4 = [(GEORPFeedbackDoubleField *)&v8 description];
  v5 = [(GEORPFeedbackDoubleField *)self dictionaryRepresentation];
...
{
  v5 = a3;
  [(GEORPFeedbackDoubleField *)self readAll:0];
  char flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v5[2] = *(void *)&self->_original;
    *((unsigned char *)v5 + 24) |= 2u;
    char flags = (char)self->_flags;
  }
  if (flags)
  {
    v5[1] = *(void *)&self->_edited;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((flags & 2) != 0)
  {
    *((void *)result + 2) = *(void *)&self->_original;
    *((unsigned char *)result + 24) |= 2u;
    char flags = (char)self->_flags;
  }
  if (flags)
  {
    *((void *)result + 1) = *(void *)&self->_edited;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEORPFeedbackDoubleField *)self readAll:1];
  [v4 readAll:1];
  if ((*(unsigned char *)&self->_flags & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_original != *((double *)v4 + 2)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 1) == 0 || self->_edited != *((double *)v4 + 1)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  ...
  if ((flags & 2) != 0)
  {
    double original = self->_original;
    double v6 = -original;
    if (original >= 0.0) {
      double v6 = self->_original;
    }
  ...
  if (flags)
  {
    double edited = self->_edited;
    double v11 = -edited;
    if (edited >= 0.0) {
      double v11 = self->_edited;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v4 & 2) != 0)
  {
    self->_double original = v5[2];
    *(unsigned char *)&self->_flags |= 2u;
    char v4 = *((unsigned char *)v5 + 24);
  }
  if (v4)
  {
    self->_double edited = v5[1];
    *(unsigned char *)&self->_flags |= 1u;
  }
}
