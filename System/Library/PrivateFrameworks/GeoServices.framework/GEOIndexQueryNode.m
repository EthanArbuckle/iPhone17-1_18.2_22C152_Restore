...
- (GEOIndexQueryNode)initWithData:(id)a3
{
  ...
  v3 = [(GEOIndexQueryNode *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 64) & 4) == 0)
    {
      ...
      if (v4)
      {
        id v5 = v4;
        objc_sync_enter(v5);
        GEOIndexQueryNodeReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readOperands_tags_1);
        objc_sync_exit(v5);
      }
    }
...
- (id)description
{
  ...
  id v4 = [(GEOIndexQueryNode *)&v8 description];
  id v5 = [(GEOIndexQueryNode *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    {
      objc_super v6 = off_1E53E6FB8[v5];
    }
    ...
    if ((*(unsigned char *)(a1 + 64) & 2) == 0)
    {
      ...
      if (v7)
      {
        id v8 = v7;
        objc_sync_enter(v8);
        GEOIndexQueryNodeReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readField_tags_0);
        objc_sync_exit(v8);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 56));
    ...
    if ((*(unsigned char *)(a1 + 64) & 8) == 0)
    {
      ...
      if (v10)
      {
        id v11 = v10;
        objc_sync_enter(v11);
        GEOIndexQueryNodeReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readValue_tags_5);
        objc_sync_exit(v11);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 56));
    ...
    if ([*(id *)(a1 + 32) count])
    {
      ...
      [v4 setObject:v13 forKey:@"operands"];
    }
    v20 = *(void **)(a1 + 16);
    if (v20)
    {
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        objc_super v6 = (int *)&readAll__recursiveTag_1494;
      }
      else {
        objc_super v6 = (int *)&readAll__nonRecursiveTag_1495;
      }
      GEOIndexQueryNodeReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    if (a2) {
...
LABEL_15:
  ...
  id v12 = [v3 objectForKeyedSubscript:@"operands"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    long long v25 = 0u;
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[GEOIndexQueryNode clearUnknownFields:](*(void *)(*((void *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
