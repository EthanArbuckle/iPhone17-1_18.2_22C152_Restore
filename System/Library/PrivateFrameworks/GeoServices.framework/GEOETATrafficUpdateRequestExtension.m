...
@implementation GEOETATrafficUpdateRequestExtension

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOETATrafficUpdateRequestExtension;
  v4 = [(GEOETATrafficUpdateRequestExtension *)&v8 description];
  v5 = [(GEOETATrafficUpdateRequestExtension *)self dictionaryRepresentation];
