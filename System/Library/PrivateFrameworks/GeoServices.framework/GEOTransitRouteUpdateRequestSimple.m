@interface GEOTransitRouteUpdateRequestSimple
+ (Class)replyClass;
- (BOOL)isValid;
...
- (GEOTransitRouteUpdateRequestSimple)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"TransitUpdate.startTransitRouteUpdateRequest" traits:a3 auditToken:a4 throttleToken:a5];
}
...
- (GEOTransitRouteUpdateRequestSimple)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    ...
    if (data)
    {
      ...
      v10 = [[GEOTransitRouteUpdateRequest alloc] initWithData:v9];
    }
    else
    {
      uint64_t v14 = xpc_dictionary_get_value(v6, "transitUpdateRequestData");
      v9 = (void *)v14;
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  if (request)
  {
    id v6 = [(GEOTransitRouteUpdateRequest *)request data];
    xpc_dictionary_set_data(v4, "transitUpdateRequestData", (const void *)[v6 bytes], objc_msgSend(v6, "length"));
  }
}

- (BOOL)isValid
{
  v2 = [(GEOTransitRouteUpdateRequestSimple *)self request];
  BOOL v3 = v2 != 0;
