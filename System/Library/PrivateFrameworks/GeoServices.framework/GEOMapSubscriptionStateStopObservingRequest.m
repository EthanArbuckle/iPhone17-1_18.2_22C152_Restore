@interface GEOMapSubscriptionStateStopObservingRequest
+ (Class)replyClass;
- (BOOL)isValid;
- (GEOMapSubscriptionStateStopObservingRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5;
- (GEOMapSubscriptionStateStopObservingRequest)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (NSArray)identifiers;
...
@implementation GEOMapSubscriptionStateStopObservingRequest
...
- (GEOMapSubscriptionStateStopObservingRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"subscriptions.stopObservingStateForSubscriptions" traits:a3 auditToken:a4 throttleToken:a5];
}
...
- (GEOMapSubscriptionStateStopObservingRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v26.receiver = self;
  v26.super_class = (Class)GEOMapSubscriptionStateStopObservingRequest;
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  id v4 = a3;
  v28.receiver = self;
  v28.super_class = (Class)GEOMapSubscriptionStateStopObservingRequest;
