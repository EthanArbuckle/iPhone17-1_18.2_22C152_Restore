...
- (GEOPDSimpleRestaurantMenuTextGroup)init
{
  ...
  v2 = [(GEOPDSimpleRestaurantMenuTextGroup *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSimpleRestaurantMenuTextGroup)initWithData:(id)a3
{
  ...
  v3 = [(GEOPDSimpleRestaurantMenuTextGroup *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (void)_readMenuItems
{
  ...
  if ((*(unsigned char *)(a1 + 52) & 2) == 0)
  {
    ...
    if (v2)
    {
      id v3 = v2;
      objc_sync_enter(v3);
      GEOPDSimpleRestaurantMenuTextGroupReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readMenuItems_tags);
      objc_sync_exit(v3);
    }
  }
...
- (id)description
{
  ...
  v4 = [(GEOPDSimpleRestaurantMenuTextGroup *)&v8 description];
  id v5 = [(GEOPDSimpleRestaurantMenuTextGroup *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 52) & 4) == 0)
    {
      ...
      if (v5)
      {
        id v6 = v5;
        objc_sync_enter(v6);
        GEOPDSimpleRestaurantMenuTextGroupReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readTitle_tags_8520);
        objc_sync_exit(v6);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        id v6 = (int *)&readAll__recursiveTag_8527;
      }
      else {
        id v6 = (int *)&readAll__nonRecursiveTag_8528;
      }
      GEOPDSimpleRestaurantMenuTextGroupReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 48));
  }
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](title, "isEqual:")))
  {
    ...
    if ((unint64_t)menuItems | v4[3]) {
      char v7 = -[NSMutableArray isEqual:](menuItems, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_menuItems hash] ^ v3;
}
