...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v7 = [(GEOPDPlaceRequestParameters *)self->_placeRequestParameters copyWithZone:a3];
  v8 = (void *)v6[1];
  v6[1] = v7;
...
- (unint64_t)hash
{
  [(GEOMapItemInitialRequestData *)self readAll:1];
  if (*(unsigned char *)&self->_flags) {
  ...
  return [(GEOPDPlaceRequestParameters *)self->_placeRequestParameters hash] ^ v3;
}
...
- (id)description
{
  ...
  int v4 = [(GEOMapItemInitialRequestData *)&v8 description];
  id v5 = [(GEOMapItemInitialRequestData *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    objc_super v8 = [(id)a1 placeRequestParameters];
    v9 = v8;
    if (v8)
    {
      if (a2)
      {
        ...
        v11 = @"placeRequestParameters";
      }
      else
      {
        v10 = [v8 dictionaryRepresentation];
        v11 = @"place_request_parameters";
      }
...
LABEL_137:
    [a1 setRequestType:v9];
  }

  if (a3) {
    v10 = @"placeRequestParameters";
  }
  else {
    v10 = @"place_request_parameters";
  }
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v12) {
      id v13 = -[GEOPDPlaceRequestParameters _initWithDictionary:isJSON:](v12, v11, a3);
    }
    else {
      id v13 = 0;
    }
    [a1 setPlaceRequestParameters:v13];
  }
LABEL_146:
...
{
  id v5 = a3;
  [(GEOMapItemInitialRequestData *)self readAll:0];
  int v4 = v5;
  if (*(unsigned char *)&self->_flags)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 20) & 1) == 0 || self->_requestType != *((_DWORD *)v4 + 4)) {
      goto LABEL_9;
    }
  }
...
LABEL_9:
  ...
  if ((unint64_t)placeRequestParameters | *((void *)v4 + 1)) {
    char v6 = -[GEOPDPlaceRequestParameters isEqual:](placeRequestParameters, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6[5])
  {
    self->_requestType = v6[4];
    *(unsigned char *)&self->_flags |= 1u;
  }
  placeRequestParameters = self->_placeRequestParameters;
  id v5 = (void *)*((void *)v6 + 1);
  if (placeRequestParameters)
  {
    if (v5) {
      -[GEOPDPlaceRequestParameters mergeFrom:](placeRequestParameters, v5);
    }
  }
  else if (v5)
  {
    placeRequestParameters = (GEOPDPlaceRequestParameters *)[(GEOMapItemInitialRequestData *)self setPlaceRequestParameters:*((void *)v6 + 1)];
  }

  MEMORY[0x1F4181820](placeRequestParameters);
}
