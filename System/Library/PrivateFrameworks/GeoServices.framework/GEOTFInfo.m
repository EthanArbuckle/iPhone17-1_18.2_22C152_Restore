...
- (GEOTFInfo)initWithData:(id)a3
{
  ...
  v3 = [(GEOTFInfo *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v4 = [(GEOTFInfo *)&v8 description];
  v5 = [(GEOTFInfo *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v3)
      {
        id v4 = v3;
        objc_sync_enter(v4);
        GEOTFInfoReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readLanguage_tags);
        objc_sync_exit(v4);
      }
    }
    ...
    id v5 = *(id *)(a1 + 24);
    if (v5) {
      [v2 setObject:v5 forKey:@"language"];
    }
    ...
    if ((*(unsigned char *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v6)
      {
        id v7 = v6;
        objc_sync_enter(v7);
        GEOTFInfoReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readComment_tags);
        objc_sync_exit(v7);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 40));
    id v8 = *(id *)(a1 + 16);
    if (v8) {
      [v2 setObject:v8 forKey:@"comment"];
    }
  }
  else
  {
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        objc_super v6 = (int *)&readAll__recursiveTag_290;
      }
      else {
        objc_super v6 = (int *)&readAll__nonRecursiveTag_291;
      }
      GEOTFInfoReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 40));
  }
...
LABEL_5:
    ...
    uint64_t v10 = [(NSString *)self->_comment copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](language, "isEqual:")))
  {
    ...
    if ((unint64_t)comment | v4[2]) {
      char v7 = -[NSString isEqual:](comment, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSString *)self->_comment hash] ^ v3;
}
