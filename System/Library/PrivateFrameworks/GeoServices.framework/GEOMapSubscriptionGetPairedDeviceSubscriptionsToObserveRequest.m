@interface GEOMapSubscriptionGetPairedDeviceSubscriptionsToObserveRequest
+ (Class)replyClass;
- (BOOL)isValid;
...
- (GEOMapSubscriptionGetPairedDeviceSubscriptionsToObserveRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"subscriptions.fetchPairedDeviceIdentifiersToObserve" traits:a3 auditToken:a4 throttleToken:a5];
}
