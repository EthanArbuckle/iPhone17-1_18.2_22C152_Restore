...
- (id)description
{
  ...
  int v4 = [(GEOCommonResponseAttributes *)&v8 description];
  v5 = [(GEOCommonResponseAttributes *)self dictionaryRepresentation];
...
- (void)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    if (a1)
    {
      ...
      {
        id v8 = v7;
        if ([v8 isEqualToString:@"ELEVATION_MODEL_EGM96"]) {
          uint64_t v9 = 0;
        }
        else {
          uint64_t v9 = [v8 isEqualToString:@"ELEVATION_MODEL_WGS84"];
        }
      }
      else
      {
...
{
  id v4 = a3;
  [(GEOCommonResponseAttributes *)self readAll:0];
  if (*(unsigned char *)&self->_flags)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOCommonResponseAttributes *)self readAll:1];
  [v4 readAll:1];
  BOOL v5 = (*((unsigned char *)v4 + 20) & 1) == 0;
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 20) & 1) != 0 && self->_elevationModel == *((_DWORD *)v4 + 4))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
