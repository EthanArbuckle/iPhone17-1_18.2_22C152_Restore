@interface GEOResourceManifestActivateFilterRequest
+ (Class)replyClass;
- (BOOL)isValid;
- (GEOActiveResourceFilter)filter;
- (GEOResourceManifestActivateFilterRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5;
- (GEOResourceManifestActivateFilterRequest)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (unint64_t)reply;
- (void)encodeToXPCDictionary:(id)a3;
- (void)setFilter:(id)a3;
@end

@implementation GEOResourceManifestActivateFilterRequest
...
- (GEOResourceManifestActivateFilterRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v16.receiver = self;
  v16.super_class = (Class)GEOResourceManifestActivateFilterRequest;
...
- (void)encodeToXPCDictionary:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)GEOResourceManifestActivateFilterRequest;
...
- (GEOResourceManifestActivateFilterRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"resourcemanifest.activateFilter" traits:a3 auditToken:a4 throttleToken:a5];
}
