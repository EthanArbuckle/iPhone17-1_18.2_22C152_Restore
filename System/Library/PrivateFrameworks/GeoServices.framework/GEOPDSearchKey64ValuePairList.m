...
@implementation GEOPDSearchKey64ValuePairList
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSearchKey64ValuePairList;
  v4 = [(GEOPDSearchKey64ValuePairList *)&v8 description];
  id v5 = [(GEOPDSearchKey64ValuePairList *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDSearchKey64ValuePairList _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
- (id)jsonRepresentation
{
  return -[GEOPDSearchKey64ValuePairList _dictionaryRepresentation:]((uint64_t)self, 1);
}
...
LABEL_15:
        ...
        if ((v11 >> 3) == 1)
        {
          ...
          uint64_t v19 = objc_alloc_init(GEOPDSearchKey64ValuePair);
          if (!GEOPDSearchKey64ValuePairReadAllFrom((uint64_t)v19, v4))
          {

            goto LABEL_27;
          }
          PBReaderRecallMark();
          -[GEOPDSearchKey64ValuePairList addPairs:]((uint64_t)self, v19);
        }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[GEOPDSearchKey64ValuePairList addPairs:]((uint64_t)v5, v11);
