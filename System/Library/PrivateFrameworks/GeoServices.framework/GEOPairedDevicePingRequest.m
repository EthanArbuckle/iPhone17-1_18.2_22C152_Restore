@interface GEOPairedDevicePingRequest
+ (BOOL)isValid:(id)a3;
- (BOOL)hasType;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (id)description
{
  ...
  int v4 = [(GEOPairedDevicePingRequest *)&v8 description];
  v5 = [(GEOPairedDevicePingRequest *)self dictionaryRepresentation];
...
{
  id v4 = a3;
  [(GEOPairedDevicePingRequest *)self readAll:0];
  if (*(unsigned char *)&self->_flags)
  {
    v4[4] = self->_type;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEOPairedDevicePingRequest *)self readAll:1];
  [v4 readAll:1];
