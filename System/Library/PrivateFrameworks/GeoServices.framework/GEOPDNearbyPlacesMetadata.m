...
- (void)dealloc
{
  ...
  [(GEOPDNearbyPlacesMetadata *)&v3 dealloc];
}
...
- (id)description
{
  ...
  v4 = [(GEOPDNearbyPlacesMetadata *)&v8 description];
  v5 = [(GEOPDNearbyPlacesMetadata *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (*(void *)(a1 + 24))
    {
      ...
      if (a2) {
        v6 = @"encryptedNearbyPlacesMuid";
      }
      else {
        v6 = @"encrypted_nearby_places_muid";
      }
