...
@implementation GEOETAResponseExtension

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOETAResponseExtension;
  v4 = [(GEOETAResponseExtension *)&v8 description];
  v5 = [(GEOETAResponseExtension *)self dictionaryRepresentation];
