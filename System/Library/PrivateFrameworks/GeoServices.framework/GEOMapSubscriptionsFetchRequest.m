@interface GEOMapSubscriptionsFetchRequest
+ (Class)replyClass;
- (BOOL)fetchExpired;
- (BOOL)isValid;
...
- (GEOMapSubscriptionsFetchRequest)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    v8 = xpc_dictionary_get_array(v6, "identifiersFilter");
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  if ([(NSArray *)self->_identifiersFilter count])
  {
...
- (GEOMapSubscriptionsFetchRequest)initWithTraits:(id)a3 auditToken:(id)a4 throttleToken:(id)a5
{
  return [(GEOXPCRequest *)self initWithMessage:@"subscriptions.fetchSubscriptions" traits:a3 auditToken:a4 throttleToken:a5];
}
