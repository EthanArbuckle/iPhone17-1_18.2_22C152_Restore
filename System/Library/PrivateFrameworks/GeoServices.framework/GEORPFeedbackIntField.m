...
- (id)description
{
  ...
  v4 = [(GEORPFeedbackIntField *)&v8 description];
  v5 = [(GEORPFeedbackIntField *)self dictionaryRepresentation];
...
{
  v5 = a3;
  [(GEORPFeedbackIntField *)self readAll:0];
  char flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v5[3] = self->_original;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEORPFeedbackIntField *)self readAll:1];
  [v4 readAll:1];
