@interface GEOPlaceFetchCacheReply
- (BOOL)isValid;
...
- (GEOPlaceFetchCacheReply)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    v8 = xpc_dictionary_get_dictionary(v6, "allCacheEntries");
...
uint64_t __55__GEOPlaceFetchCacheReply_initWithXPCDictionary_error___block_invoke(uint64_t a1, const char *a2)
{
  ...
  if (data)
  {
    ...
    id obj = *(id *)(v9 + 40);
    v10 = [v7 unarchivedObjectOfClass:v8 fromData:v6 error:&obj];
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  if ([(NSDictionary *)self->_allCacheEntries count])
  {
    ...
    id v7 = v5;
    id v9 = v7;
    [(NSDictionary *)allCacheEntries enumerateKeysAndObjectsUsingBlock:v8];
