@interface GEOExternalRequestCounterCountReply
- (BOOL)isValid;
- (GEOExternalRequestCounterCountReply)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (NSArray)objects;
- (void)encodeToXPCDictionary:(id)a3;
- (void)setObjects:(id)a3;
@end

@implementation GEOExternalRequestCounterCountReply

- (GEOExternalRequestCounterCountReply)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v18.receiver = self;
  v18.super_class = (Class)GEOExternalRequestCounterCountReply;
  v7 = [(GEOXPCReply *)&v18 initWithXPCDictionary:v6 error:a4];
  if (v7)
  {
    v8 = xpc_dictionary_get_array(v6, "objects");
    ...
    if (count)
    {
      for (size_t i = 0; i != count; ++i)
      {
        ...
        if (v12)
        {
          v13 = [[GEOExternalRequestCounterInfo alloc] initWithXPCDictionary:v12 error:a4];
          if (v13) {
            [v10 addObject:v13];
          }
        }
    ...
    objc_storeStrong((id *)&v7->_objects, v15);
    if (v14) {
...
- (void)encodeToXPCDictionary:(id)a3
{
  ...
  id v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)GEOExternalRequestCounterCountReply;
  ...
  if ([(NSArray *)self->_objects count])
  {
    ...
    if (xpc_array_get_count(v5)) {
      xpc_dictionary_set_value(v4, "objects", v5);
    }
  }
}
