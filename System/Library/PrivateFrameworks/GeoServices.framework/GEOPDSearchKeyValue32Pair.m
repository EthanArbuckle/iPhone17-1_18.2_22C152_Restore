...
- (id)description
{
  ...
  v4 = [(GEOPDSearchKeyValue32Pair *)&v8 description];
  v5 = [(GEOPDSearchKeyValue32Pair *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 20) & 1) != 0 && self->_value == *((_DWORD *)v4 + 4))
    {
      BOOL v6 = 1;
      goto LABEL_9;
    }
