...
- (id)description
{
  ...
  id v4 = [(GEOPDRap *)&v8 description];
  id v5 = [(GEOPDRap *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (*(unsigned char *)(a1 + 20))
    {
      ...
      if (a2) {
        v7 = @"placecardRapButtonType";
      }
      else {
        v7 = @"placecard_rap_button_type";
      }
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  if (a1)
  {
    ...
    {
      if (a3) {
        v6 = @"placecardRapButtonType";
      }
      else {
        v6 = @"placecard_rap_button_type";
      }
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        else if ([v8 isEqualToString:@"REPORT_AN_ISSUE"])
        {
          int v9 = 1;
        }
        else if ([v8 isEqualToString:@"SUGGEST_EDIT"])
        {
          int v9 = 2;
        }
        else
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_flags)
  {
    if ((*((unsigned char *)v4 + 20) & 1) != 0 && self->_placecardRapButtonType == *((_DWORD *)v4 + 4))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
