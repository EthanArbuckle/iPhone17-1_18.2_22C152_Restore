...
- (id)description
{
  ...
  v4 = [(GEORPFeedbackULongField *)&v8 description];
  v5 = [(GEORPFeedbackULongField *)self dictionaryRepresentation];
...
{
  v5 = a3;
  [(GEORPFeedbackULongField *)self readAll:0];
  char flags = (char)self->_flags;
  if ((flags & 2) != 0)
  {
    v5[2] = self->_original;
...
- (BOOL)isEqual:(id)a3
{
  ...
  [(GEORPFeedbackULongField *)self readAll:1];
  [v4 readAll:1];
...
- (unint64_t)hash
{
  ...
  if ((*(unsigned char *)&self->_flags & 2) != 0)
  {
    unint64_t v3 = 2654435761u * self->_original;
    if (*(unsigned char *)&self->_flags) {
      goto LABEL_3;
    }
LABEL_5:
...
LABEL_3:
  unint64_t v4 = 2654435761u * self->_edited;
  return v4 ^ v3;
}
