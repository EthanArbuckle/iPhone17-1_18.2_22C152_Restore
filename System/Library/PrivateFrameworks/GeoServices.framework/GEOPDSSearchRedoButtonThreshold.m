...
@implementation GEOPDSSearchRedoButtonThreshold

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)GEOPDSSearchRedoButtonThreshold;
  v4 = [(GEOPDSSearchRedoButtonThreshold *)&v8 description];
  v5 = [(GEOPDSSearchRedoButtonThreshold *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  return -[GEOPDSSearchRedoButtonThreshold _dictionaryRepresentation:]((uint64_t)self, 0);
}
...
LABEL_10:
  ...
  if (v8)
  {
    ...
    if (a2)
    {
      ...
      v21[1] = 3221225472;
      v21[2] = __61__GEOPDSSearchRedoButtonThreshold__dictionaryRepresentation___block_invoke;
      v21[3] = &unk_1E53D8860;
      id v12 = v11;
      id v22 = v12;
...
- (id)jsonRepresentation
{
  return -[GEOPDSSearchRedoButtonThreshold _dictionaryRepresentation:]((uint64_t)self, 1);
}

void __61__GEOPDSSearchRedoButtonThreshold__dictionaryRepresentation___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (BOOL)readFrom:(id)a3
{
  return GEOPDSSearchRedoButtonThresholdReadAllFrom((uint64_t)self, a3);
}
