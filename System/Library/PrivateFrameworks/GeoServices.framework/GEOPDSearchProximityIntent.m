...
- (GEOPDSearchProximityIntent)init
{
  ...
  v2 = [(GEOPDSearchProximityIntent *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEOPDSearchProximityIntent)initWithData:(id)a3
{
  ...
  v3 = [(GEOPDSearchProximityIntent *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (id)description
{
  ...
  v4 = [(GEOPDSearchProximityIntent *)&v8 description];
  v5 = [(GEOPDSearchProximityIntent *)self dictionaryRepresentation];
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 44) & 1) == 0)
    {
      ...
      if (v5)
      {
        id v6 = v5;
        objc_sync_enter(v6);
        GEOPDSearchProximityIntentReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readName_tags_1159);
        objc_sync_exit(v6);
      }
    }
    ...
    if ((*(unsigned char *)(a1 + 44) & 2) == 0)
    {
      ...
      if (v8)
      {
        id v9 = v8;
        objc_sync_enter(v9);
        GEOPDSearchProximityIntentReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readTokenSet_tags_1160);
        objc_sync_exit(v9);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 40));
...
- (void)readAll:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      objc_sync_enter(v5);
      if (a2) {
        id v6 = (int *)&readAll__recursiveTag_1161;
      }
      else {
        id v6 = (int *)&readAll__nonRecursiveTag_1162;
      }
      GEOPDSearchProximityIntentReadSpecified(a1, *(void *)(a1 + 8), v6);
      objc_sync_exit(v5);
    }
    if (a2) {
