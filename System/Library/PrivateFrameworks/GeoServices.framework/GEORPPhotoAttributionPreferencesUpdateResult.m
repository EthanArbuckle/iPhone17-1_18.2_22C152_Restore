...
- (GEORPPhotoAttributionPreferencesUpdateResult)init
{
  ...
  v2 = [(GEORPPhotoAttributionPreferencesUpdateResult *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (GEORPPhotoAttributionPreferencesUpdateResult)initWithData:(id)a3
{
  ...
  v3 = [(GEORPPhotoAttributionPreferencesUpdateResult *)&v7 initWithData:a3];
  v4 = v3;
  if (v3)
  {
...
- (void)dealloc
{
  ...
  [(GEORPPhotoAttributionPreferencesUpdateResult *)&v3 dealloc];
}
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 60) & 1) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPPhotoAttributionPreferencesUpdateResultReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readErrors_tags);
        objc_sync_exit(v3);
      }
    }
...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"PHOTO_ATTRIBUTION_PREFERENCES_UPDATE_ERROR_UNSPECIFIED"])
  {
    int v4 = 0;
  }
  else if ([v3 isEqualToString:@"PHOTO_ATTRIBUTION_PREFERENCES_UPDATE_ERROR_OUTDATED"])
  {
    int v4 = 1;
  }
  else if ([v3 isEqualToString:@"PHOTO_ATTRIBUTION_PREFERENCES_UPDATE_ERROR_NAME_UNAVAILABLE"])
  {
    int v4 = 2;
  }
  else
  ...
  if (a1)
  {
    ...
    if ((*(unsigned char *)(a1 + 60) & 2) == 0)
    {
      ...
      if (v2)
      {
        id v3 = v2;
        objc_sync_enter(v3);
        GEORPPhotoAttributionPreferencesUpdateResultReadSpecified(a1, *(void *)(a1 + 8), (int *)&_readPreferences_tags);
        objc_sync_exit(v3);
      }
    }
    os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 56));
...
- (id)description
{
  ...
  int v4 = [(GEORPPhotoAttributionPreferencesUpdateResult *)&v8 description];
  v5 = [(GEORPPhotoAttributionPreferencesUpdateResult *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(void *)a1
{
  if (a1)
  {
    ...
    if (v10)
    {
      ...
      [v4 setObject:v12 forKey:@"preferences"];
    }
  }
  else
  {
...
- (void)_initWithDictionary:(char)a3 isJSON:
{
  ...
  do
  {
    for (uint64_t i = 0; i != v9; ++i)
    {
      ...
      {
        id v13 = v12;
        if ([v13 isEqualToString:@"PHOTO_ATTRIBUTION_PREFERENCES_UPDATE_ERROR_UNSPECIFIED"])
        {
          uint64_t v14 = 0;
        }
        else if ([v13 isEqualToString:@"PHOTO_ATTRIBUTION_PREFERENCES_UPDATE_ERROR_OUTDATED"])
        {
          uint64_t v14 = 1;
        }
        else if ([v13 isEqualToString:@"PHOTO_ATTRIBUTION_PREFERENCES_UPDATE_ERROR_NAME_UNAVAILABLE"])
        {
          uint64_t v14 = 2;
        }
        else
...
LABEL_24:
  ...
  v15 = [v5 objectForKeyedSubscript:@"preferences"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v16 = [GEORPPhotoAttributionPreferences alloc];
    if (a3) {
      uint64_t v17 = [(GEORPPhotoAttributionPreferences *)v16 initWithJSON:v15];
    }
    else {
      uint64_t v17 = [(GEORPPhotoAttributionPreferences *)v16 initWithDictionary:v15];
    }
    v18 = (void *)v17;
    [a1 setPreferences:v17];
  }
LABEL_30:
...
- (void)readAll:(BOOL)a3
{
  ...
  if (reader)
  {
    ...
    objc_sync_enter(v7);
    if (v3) {
      uint64_t v8 = (int *)&readAll__recursiveTag_125;
    }
    else {
      uint64_t v8 = (int *)&readAll__nonRecursiveTag_126;
    }
    GEORPPhotoAttributionPreferencesUpdateResultReadSpecified((uint64_t)self, (unint64_t)self->_reader, v8);
    objc_sync_exit(v7);
  }
  if (v3) {
    [(GEORPPhotoAttributionPreferences *)self->_preferences readAll:1];
  }
...
- (void)writeTo:(id)a3
{
  ...
  os_unfair_lock_unlock(&self->_readerLock);
  [(GEORPPhotoAttributionPreferencesUpdateResult *)self readAll:0];
  id v5 = v9;
...
- (void)copyTo:(id)a3
{
  ...
  *((_DWORD *)v7 + 13) = self->_readerMarkLength;
  os_unfair_lock_unlock(&self->_readerLock);
  if ([(GEORPPhotoAttributionPreferencesUpdateResult *)self errorsCount])
  {
    [v7 clearErrors];
    unint64_t v4 = [(GEORPPhotoAttributionPreferencesUpdateResult *)self errorsCount];
    if (v4)
    {
      unint64_t v5 = v4;
...
LABEL_5:
    ...
    [(GEORPPhotoAttributionPreferencesUpdateResult *)self readAll:0];
    PBRepeatedInt32Copy();
    id v8 = [(GEORPPhotoAttributionPreferences *)self->_preferences copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && ([(GEORPPhotoAttributionPreferencesUpdateResult *)self readAll:1],
        [v4 readAll:1],
        PBRepeatedInt32IsEqual()))
  {
    preferences = self->_preferences;
    if ((unint64_t)preferences | v4[5]) {
      char v6 = -[GEORPPhotoAttributionPreferences isEqual:](preferences, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(GEORPPhotoAttributionPreferences *)self->_preferences hash] ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v5 = v4;
    for (uint64_t i = 0; i != v5; ++i)
      -[GEORPPhotoAttributionPreferencesUpdateResult addErrors:](self, "addErrors:", [v10 errorsAtIndex:i]);
  }
  preferences = self->_preferences;
  id v8 = v10;
  uint64_t v9 = v10[5];
