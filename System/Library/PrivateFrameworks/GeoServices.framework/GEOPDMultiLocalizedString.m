...
- (id)description
{
  ...
  uint64_t v4 = [(GEOPDMultiLocalizedString *)&v8 description];
  id v5 = [(GEOPDMultiLocalizedString *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if ([*(id *)(a1 + 16) count])
    {
      ...
      if (a2) {
        uint64_t v13 = @"localizedString";
      }
      else {
        uint64_t v13 = @"localized_string";
      }
...
- (uint64_t)_initWithDictionary:(int)a3 isJSON:
{
  ...
  {
    if (a3) {
      uint64_t v7 = @"localizedString";
    }
    else {
      uint64_t v7 = @"localized_string";
    }
        ...
        do
        {
          for (uint64_t i = 0; i != v11; ++i)
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              if (a3) {
                v16 = [(GEOLocalizedString *)v15 initWithJSON:v14];
              }
              else {
                v16 = [(GEOLocalizedString *)v15 initWithDictionary:v14];
              }
              v17 = v16;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)localizedStrings | v4[2]) {
      char v6 = -[NSMutableArray isEqual:](localizedStrings, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSMutableArray *)self->_localizedStrings hash];
}
...
- (id)bestLocalizedName
{
  v2 = -[GEOPDMultiLocalizedString localizedStrings]((id *)&self->super.super.isa);
