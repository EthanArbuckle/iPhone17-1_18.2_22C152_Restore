...
- (GEOSearchAutoRedoThreshold)init
{
  result = (GEOSearchAutoRedoThreshold *)[MEMORY[0x1E4F1CA00] raise:@"GEOMethodNotAvailableException" format:@"This method is unavailable."];
  __break(1u);
  return result;
}
...
- (GEOSearchAutoRedoThreshold)initWithSearchAutoRedoThreshold:(id)a3
{
  ...
  return [(GEOSearchAutoRedoThreshold *)self initWithNumberOfVisiblePOIsThreshold:v5 zoomInPercentThreshold:v6 zoomOutPercentThreshold:v7 panDeltaThresholdInMeters:v8];
}
...
- (GEOSearchAutoRedoThreshold)initWithNumberOfVisiblePOIsThreshold:(unint64_t)a3 zoomInPercentThreshold:(double)a4 zoomOutPercentThreshold:(double)a5 panDeltaThresholdInMeters:(double)a6
{
  ...
  result = [(GEOSearchAutoRedoThreshold *)&v11 init];
  if (result)
  {
