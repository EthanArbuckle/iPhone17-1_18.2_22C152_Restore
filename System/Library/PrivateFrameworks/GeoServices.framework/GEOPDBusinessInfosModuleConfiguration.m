...
- (void)dealloc
{
  ...
  [(GEOPDBusinessInfosModuleConfiguration *)&v3 dealloc];
}
...
- (id)description
{
  ...
  unint64_t v4 = [(GEOPDBusinessInfosModuleConfiguration *)&v8 description];
  v5 = [(GEOPDBusinessInfosModuleConfiguration *)self dictionaryRepresentation];
...
- (id)_dictionaryRepresentation:(uint64_t)a1
{
  if (a1)
  {
    ...
    if (*(void *)(a1 + 24))
    {
      ...
      if (a2) {
        uint64_t v6 = @"factoidItemIndex";
      }
      else {
        uint64_t v6 = @"factoid_item_index";
      }
