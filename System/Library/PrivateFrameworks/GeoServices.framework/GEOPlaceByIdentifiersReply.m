@interface GEOPlaceByIdentifiersReply
- (BOOL)isValid;
- (GEOPDPlaceResponse)response;
- (GEOPlaceByIdentifiersReply)initWithXPCDictionary:(id)a3 error:(id *)a4;
- (void)encodeToXPCDictionary:(id)a3;
- (void)setResponse:(id)a3;
@end

@implementation GEOPlaceByIdentifiersReply

- (BOOL)isValid
{
  v3 = [(GEOPlaceByIdentifiersReply *)self response];
  if (v3)
  {
    BOOL v4 = 1;
  }
...
- (GEOPlaceByIdentifiersReply)initWithXPCDictionary:(id)a3 error:(id *)a4
{
  id v6 = a3;
  v16.receiver = self;
  v16.super_class = (Class)GEOPlaceByIdentifiersReply;
...
- (void)encodeToXPCDictionary:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)GEOPlaceByIdentifiersReply;
