...
+ (id)roleParameterFromICSString:(id)a3
{
  uint64_t v3 = +[ICSUserAddress roleFromICSString:a3];
  if (v3)
  {
...
+ (id)roleParameterFromCode:(int)a3
{
  uint64_t v3 = [(ICSPredefinedValue *)[ICSRoleParameter alloc] initWithLong:a3];
  return v3;
}
...
- (void)_ICSStringWithOptions:(unint64_t)a3 appendingToString:(id)a4
{
  char v4 = a3;
  id v6 = a4;
  id v7 = +[ICSUserAddress ICSStringFromRole:[(ICSPredefinedValue *)self longValue]];
