...
+ (id)scheduleForceSendParameterFromICSString:(id)a3
{
  uint64_t v3 = +[ICSUserAddress scheduleForceSendFromICSString:a3];
  if (v3)
  {
...
+ (id)scheduleForceSendParameterFromCode:(int)a3
{
  uint64_t v3 = [(ICSPredefinedValue *)[ICSScheduleForceSendParameter alloc] initWithLong:a3];
  return v3;
}
...
- (void)_ICSStringWithOptions:(unint64_t)a3 appendingToString:(id)a4
{
  char v4 = a3;
  id v6 = a4;
  id v7 = +[ICSUserAddress ICSStringFromScheduleForceSend:[(ICSPredefinedValue *)self longValue]];
