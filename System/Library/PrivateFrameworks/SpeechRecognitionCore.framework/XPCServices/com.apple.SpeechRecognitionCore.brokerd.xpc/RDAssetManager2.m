...
+ (id)sharedInstance
{
  if (qword_10001CE68 != -1) {
    dispatch_once(&qword_10001CE68, &stru_100018CB8);
  }
...
- (id)copyInstallationStatusForLangaugesWithError:(id *)a3
{
  ...
  block[5] = &v14;
  block[6] = &v8;
  dispatch_sync((dispatch_queue_t)mainWorkQueue, block);
  if (a3) {
    *a3 = (id)v9[5];
  }
  int v5 = (void *)v15[5];
      ...
      if (v15)
      {
        ...
        do
        {
          for (i = 0; i != v15; i = (char *)i + 1)
          {
            ...
            *(void *)buf = 0;
            if ([v19 length] && sub_10000CBAC(v19, buf, @"DictationCC")) {
...
- (void)cancelDownloadForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)buf = 0;
    ...
    uint64_t v13 = sub_10000A1A8;
    uint64_t v14 = sub_10000A1B8;
    uint64_t v15 = 0;
    mainWorkQueue = self->_mainWorkQueue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10000ACE4;
...
- (void)setPurgeabilityForLanguages:(id)a3 withPurgeability:(BOOL)a4 error:(id *)a5
{
  if (a3)
  {
    ...
    *(void *)buf = 0;
    ...
    __int16 v21 = sub_10000A1A8;
    id v22 = sub_10000A1B8;
    uint64_t v23 = 0;
    ...
    v16[5] = a3;
    v16[6] = buf;
    dispatch_async((dispatch_queue_t)secondWorkQueue, v16);
    if (a5) {
      *a5 = (id)*((void *)v19 + 5);
    }
    _Block_object_dispose(buf, 8);
...
- (id)copyInstalledQuasarModelPathForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)buf = 0;
    ...
    id v22 = sub_10000A1A8;
    uint64_t v23 = sub_10000A1B8;
    uint64_t v24 = 0;
    uint64_t v13 = 0;
    double v14 = &v13;
    uint64_t v15 = 0x3052000000;
    uint64_t v16 = sub_10000A1A8;
    BOOL v17 = sub_10000A1B8;
    uint64_t v18 = 0;
    mainWorkQueue = self->_mainWorkQueue;
    ...
    v12[6] = buf;
    v12[7] = &v13;
    dispatch_sync((dispatch_queue_t)mainWorkQueue, v12);
...
- (id)_assetPathForLanguage:(id)a3 error:(id *)a4
{
  ...
  int v20 = sub_10000A1A8;
  id v21 = sub_10000A1B8;
  uint64_t v22 = 0;
  uint64_t v11 = 0;
  unsigned int v12 = &v11;
  uint64_t v13 = 0x3052000000;
  double v14 = sub_10000A1A8;
  uint64_t v15 = sub_10000A1B8;
  uint64_t v16 = 0;
  ...
  v10[6] = &v17;
  v10[4] = v7;
  +[SFSpeechAssetManager fetchAssetsForLanguage:a3 urgent:0 progress:&stru_100018D70 completion:v10];
...
- (id)_installedLocalAssetForLanguage:(id)a3 error:(id *)a4
{
  ...
  if (a3)
  {
    ...
    if (![v7 length]
      || (sub_10000CBAC(v7, 0, @"DictationCC") & 1) == 0)
    {
      id v7 = 0;
    }
    if (![v7 length])
