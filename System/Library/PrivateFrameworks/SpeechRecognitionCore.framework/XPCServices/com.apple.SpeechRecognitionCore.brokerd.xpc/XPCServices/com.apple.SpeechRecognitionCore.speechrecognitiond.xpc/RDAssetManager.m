...
+ (id)sharedInstance
{
  if (qword_1000FEBE0 != -1) {
    dispatch_once(&qword_1000FEBE0, &stru_1000EF908);
  }
  return (id)qword_1000FEBD8;
}
...
- (void)cancelDownloadForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)id v12 = 0;
    ...
    id v15 = sub_1000462F8;
    uint64_t v16 = sub_100046308;
    uint64_t v17 = 0;
    queue = self->_queue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100046FBC;
...
- (id)copyInstalledQuasarModelPathForLanguage:(id)a3 error:(id *)a4
{
  if (a3)
  {
    ...
    *(void *)buf = 0;
    ...
    id v22 = sub_1000462F8;
    CFStringRef v23 = sub_100046308;
    uint64_t v24 = 0;
    uint64_t v13 = 0;
    double v14 = &v13;
    uint64_t v15 = 0x3052000000;
    uint64_t v16 = sub_1000462F8;
    id v17 = sub_100046308;
    uint64_t v18 = 0;
    queue = self->_queue;
    ...
    switch((unint64_t)v12)
    {
      case 1uLL:
        ...
        if (v11)
        {
          ...
          v29[4] = self;
          v29[5] = a3;
          [a3 startDownload:sub_100045F10(v6) then:v29];
          goto LABEL_18;
        }
        ...
        uint64_t v13 = +[NSError errorWithDomain:@"kRXAssetDownloadErrorDomain" code:101 userInfo:&off_1000F6528];
        if ([(RDAssetManager *)self sendCallback])
        {
...
- (id)installedAssetSizeWithError:(id *)a3
{
  return sub_100048D24(a3, (uint64_t)&stru_1000EFA60);
}
...
- (id)purgeInstalledAssetsWithError:(id *)a3
{
  ...
  id v9 = &v8;
  uint64_t v10 = 0x3052000000;
  unsigned int v11 = sub_1000462F8;
  id v12 = sub_100046308;
  uint64_t v13 = 0;
  v7[0] = _NSConcreteStackBlock;
  v7[1] = 3221225472;
  v7[2] = sub_100049070;
  v7[3] = &unk_1000EFA88;
  v7[4] = &v8;
  v4 = sub_100048D24(a3, (uint64_t)v7);
  if (a3)
  {
    id v5 = (void *)v9[5];
    if (v5) {
...
- (id)_errorStringForPurgeResult:(int64_t)a3
{
  if ((unint64_t)a3 >= 0xC) {
    ...
    return off_1000EFC70[a3];
  }
}

- (id)_stateStringForAsset:(id)a3
{
  unint64_t v4 = (unint64_t)[a3 state];
  if (v4 >= 7) {
    return +[NSString stringWithFormat:@"Unknown state: %@", a3];
  }
  else {
    return off_1000EFCD0[v4];
  }
}
