...
- (id)deviceCompatibilityCapabilitiesWithHeapDescriptors:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v44 = GTCapabilitiesHeapTextureInfo_deserialize(v4, newpool, &v43);
    uint64_t v45 = v6;
  }
  uint64_t v41 = 0;
  uint64_t v42 = 0;
  ...
  if (v7)
  {
    uint64_t v41 = GTCapabilitiesHeapAccelerationStructureInfo_deserialize(v7, newpool, &v40);
    uint64_t v42 = v9;
  }
  v30 = v5;
  ...
  {
    v50[0] = v10;
    v11 = objc_msgSend(MEMORY[0x263EFF8C0], "arrayWithObjects:count:", v50, 1, v10, v8, v5, v3);
  }
  else
  {
    v11 = 0;
  ...
  long long v39 = 0u;
  id obj = v11;
  uint64_t v12 = [obj countByEnumeratingWithState:&v36 objects:v49 count:16];
  if (v12)
  {
    uint64_t v13 = v12;
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        v17 = GTCapabilitiesRuntime_serialize((const uint8_t *)v16);
        uint64_t v18 = GTCapabilitiesRuntime_heapTextureInfoCompatible(&v44, (uint64_t)v16, v15);
        uint64_t v19 = GTCapabilitiesRuntime_heapAccelerationStructureInfoCompatible((uint64_t)&v41, (uint64_t)v16, v15);
        v47[0] = @"device-name";
        v20 = [v15 name];
        v48[0] = v20;
        v48[1] = v17;
      ...
      uint64_t v13 = [obj countByEnumeratingWithState:&v36 objects:v49 count:16];
    }
    while (v13);
  }
