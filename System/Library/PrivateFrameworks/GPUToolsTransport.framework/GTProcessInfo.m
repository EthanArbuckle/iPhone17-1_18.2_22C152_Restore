  ...
  if (v5)
  {
    ...
    if (v5->_arguments)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        uint64_t v12 = [(NSArray *)v11 countByEnumeratingWithState:&v38 objects:v44 count:16];
        if (v12)
        {
          uint64_t v13 = v12;
          ...
          while (2)
          {
            ...
            uint64_t v13 = [(NSArray *)v11 countByEnumeratingWithState:&v38 objects:v44 count:16];
            if (v13) {
              continue;
            }
            break;
...
LABEL_18:
    ...
    if (v5->_environment)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        long long v35 = 0u;
        v20 = v5->_environment;
        uint64_t v21 = [(NSDictionary *)v20 countByEnumeratingWithState:&v34 objects:v43 count:16];
        if (v21)
        {
          uint64_t v22 = v21;
...
LABEL_33:
            ...
            uint64_t v22 = [(NSDictionary *)v20 countByEnumeratingWithState:&v34 objects:v43 count:16];
            if (v22) {
              continue;
            }
            break;
...
LABEL_34:
    ...
    v5->_processIdentifier = objc_msgSend(v4, "decodeInt32ForKey:", @"processIdentifier", (void)v34);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = (void *)[objc_alloc(MEMORY[0x263EFF8C0]) initWithArray:self->_arguments copyItems:1];
  [(GTProcessInfo *)v4 setArguments:v5];

  uint64_t v6 = (void *)[objc_alloc(NSDictionary) initWithDictionary:self->_environment copyItems:1];
...
- (id)description
{
  ...
  uint64_t v6 = [v3 stringWithFormat:@"<%@: processName=%@ arguments=%@ environment=%@ bundleIdentifier=%@ processIdentifier=%d ppid=%d>", v5, self->_processName, self->_arguments, self->_environment, self->_bundleIdentifier, self->_processIdentifier, self->_ppid];
