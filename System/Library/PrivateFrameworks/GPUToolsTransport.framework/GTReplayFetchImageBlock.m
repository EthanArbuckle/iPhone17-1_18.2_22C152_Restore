...
- (GTReplayFetchImageBlock)initWithCoder:(id)a3;
- (unsigned)index;
...
@implementation GTReplayFetchImageBlock
...
- (GTReplayFetchImageBlock)initWithCoder:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)GTReplayFetchImageBlock;
...
{
  v5.receiver = self;
  v5.super_class = (Class)GTReplayFetchImageBlock;
  id v4 = a3;
