...
+ (id)protocolMethods:(id)a3
{
  ...
  v5 = (void *)[v4 initWithCapacity:outCount];
  if (outCount)
  {
    unint64_t v6 = 0;
    p_name = &v3->name;
  ...
  if (v5)
  {
    ...
    if (v5->_protocolMethods)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        uint64_t v12 = [(NSArray *)v11 countByEnumeratingWithState:&v21 objects:v26 count:16];
        if (v12)
        {
          uint64_t v13 = v12;
          ...
          while (2)
          {
            ...
            uint64_t v13 = [(NSArray *)v11 countByEnumeratingWithState:&v21 objects:v26 count:16];
            if (v13) {
              continue;
            }
            break;
...
LABEL_18:
    ...
    v5->_servicePort = objc_msgSend(v4, "decodeInt64ForKey:", @"servicePort", v21);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = (void *)[objc_alloc(MEMORY[0x263EFF8C0]) initWithArray:self->_protocolMethods copyItems:1];
...
- (id)description
{
  ...
  uint64_t v6 = [v3 stringWithFormat:@"<%@: protocolName=%@ protocolMethods=%@ servicePort=%llu platform=%u deviceUDID=%@ version=%llu>", v5, self->_protocolName, self->_protocolMethods, self->_servicePort, self->_platform, self->_deviceUDID, self->_version];
