...
- (GTMTLTelemetryServiceXPCProxy)initWithConnection:(id)a3 remoteProperties:(id)a4
{
  ...
  v8 = [(GTMTLTelemetryServiceXPCProxy *)&v23 init];
  if (v8)
  {
    v9 = &unk_26EFBE468;
    ...
    os_log_t v20 = os_log_create("com.apple.gputools.transport", "TelemetryProxy");
    log = v8->_log;
...
- (BOOL)respondsToSelector:(SEL)a3
{
  ...
  else
  {
    ...
    BOOL v7 = [(GTMTLTelemetryServiceXPCProxy *)&v9 respondsToSelector:a3];
  }
