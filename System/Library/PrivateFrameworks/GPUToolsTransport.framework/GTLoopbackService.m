...
- (id)echo:(id)a3
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_23C048000, v6, OS_LOG_TYPE_INFO, "Sync: %s", (uint8_t *)&v9, 0xCu);
  }
  return v4;
}
...
- (void)echo:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_23C048000, v9, OS_LOG_TYPE_INFO, "Async: %s", (uint8_t *)&v11, 0xCu);
  }
  v7[2](v7, v6);
}
...
- (void)echo:(id)a3 repeat:(unint64_t)a4 callback:(id)a5
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_23C048000, v11, OS_LOG_TYPE_INFO, "Repeat (%llu): %s", (uint8_t *)&v13, 0x16u);
  }
  for (; a4; --a4)
    v9[2](v9, v8);
}
...
- (void)echo:(id)a3 repeat:(unint64_t)a4 callback:(id)a5 complete:(id)a6
{
  ...
  if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134218242;
    ...
    _os_log_impl(&dword_23C048000, v14, OS_LOG_TYPE_INFO, "Repeat (%llu): %s", buf, 0x16u);
  }
...
uint64_t __51__GTLoopbackService_echo_repeat_callback_complete___block_invoke(void *a1)
{
  ...
  os_log_t v3 = *(uint64_t (**)(void))(a1[6] + 16);
  return v3();
}
