...
- (DYGTMTLDeviceProfile)initWithCoder:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)DYGTMTLDeviceProfile;
  ...
  if (v5)
  {
    ...
    uint64_t v17 = [v4 decodeObjectOfClasses:v16 forKey:@"defaultSamplePositions"];
    defaultSamplePositions = v5->_defaultSamplePositions;
    v5->_defaultSamplePositions = (NSDictionary *)v17;
  }
  return v5;
}
