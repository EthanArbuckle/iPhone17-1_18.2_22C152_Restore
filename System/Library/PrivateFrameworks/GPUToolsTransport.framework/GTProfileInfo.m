...
- (id)initFromProfileInfo:(id)a3
{
  ...
  if (v5)
  {
    ...
    v26 = [v4 objectForKeyedSubscript:@"pause"];
    v6->_pause = [v26 BOOLValue];

    v27 = [v4 objectForKeyedSubscript:@"resume"];
    v6->_resume = [v27 BOOLValue];

    v28 = [v4 objectForKeyedSubscript:@"xpState"];
    v6->_xpState = [v28 unsignedIntValue];
    ...
    v48 = [v4 objectForKeyedSubscript:@"totalDrawCallCount"];
    v6->_totalDrawCallCount = [v48 unsignedIntValue];
...
- (id)toDictionary
{
  ...
  if (self->_xpState)
  {
    uint64_t v16 = objc_msgSend(NSNumber, "numberWithUnsignedInt:");
  ...
  {
    uint64_t v27 = objc_msgSend(NSNumber, "numberWithUnsignedInt:");
...
- (void)setTotalDrawCallCount:(unsigned int)a3
{
  self->_uint64_t totalDrawCallCount = a3;
}
