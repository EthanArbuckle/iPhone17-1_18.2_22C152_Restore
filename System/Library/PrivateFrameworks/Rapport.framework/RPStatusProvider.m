...
- (NSMutableDictionary)currentlyProviding;
- (NSString)description;
- (OS_dispatch_queue)dispatchQueue;
- (RPStatusProvider)init;
- (RPStatusProvider)initWithCoder:(id)a3;
...
- (void)cancelStatusUpdate:(id)a3 completion:(id)a4;
- (void)invalidate;
- (void)provideStatusUpdate:(id)a3 statusInfo:(id)a4 completion:(id)a5;
- (void)setCurrentlyProviding:(id)a3;
...
{
  v8.receiver = self;
  v8.super_class = (Class)RPStatusProvider;
...
{
  v7.receiver = self;
  v7.super_class = (Class)RPStatusProvider;
...
void __62__RPStatusProvider_provideStatusUpdate_statusInfo_completion___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    [v4 xpcStatusUpdatableProvideStatus:*(void *)(a1 + 40) statusInfo:*(void *)(a1 + 48)];
...
LABEL_9:
  ...
  {
    if (gLogCategory_StatusProvider != -1 || (int v5 = _LogCategory_Initialize(), v3 = v7, v5))
    {
      LogPrintF();
      v3 = v7;
    }
...
void __50__RPStatusProvider_cancelStatusUpdate_completion___block_invoke(uint64_t a1)
{
  ...
  {
    v4 = [*(id *)(*(void *)(a1 + 32) + 24) remoteObjectProxy];
    [v4 xpcStatusUpdatableCancelProvideStatus:*(void *)(a1 + 40)];
...
uint64_t __43__RPStatusProvider_activateWithCompletion___block_invoke(uint64_t a1)
{
...
- (void)_activateWithCompletion:(id)a3 reactivate:(BOOL)a4
{
  ...
  if (v4)
  {
    if (gLogCategory_StatusProvider > 30
      || gLogCategory_StatusProvider == -1 && !_LogCategory_Initialize())
    {
      goto LABEL_14;
    }
  }
  else if (gLogCategory_StatusProvider > 30 {
         || gLogCategory_StatusProvider == -1 && !_LogCategory_Initialize())
  }
  {
    goto LABEL_14;
  ...
  LogPrintF();
LABEL_14:
  id v8 = [(RPStatusProvider *)self _ensureXPCStarted];
  if (v8)
  {
    if (v6) {
      v6[2](v6, v8);
  ...
  else
  {
    ...
    v17[1] = 3221225472;
    v17[2] = __55__RPStatusProvider__activateWithCompletion_reactivate___block_invoke;
    v17[3] = &unk_1E605B7B8;
    BOOL v19 = v4;
    id v10 = v6;
    id v18 = v10;
    ...
    v14[1] = 3221225472;
    v14[2] = __55__RPStatusProvider__activateWithCompletion_reactivate___block_invoke_2;
    v14[3] = &unk_1E605BD18;
    BOOL v16 = v4;
    v14[4] = self;
    id v12 = v10;
    v15 = v12;
    [v11 xpcStatusProviderActivate:self completion:v14];
...
void __55__RPStatusProvider__activateWithCompletion_reactivate___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(unsigned char *)(a1 + 40))
  {
    if (gLogCategory_StatusProvider <= 60)
    {
      if (gLogCategory_StatusProvider != -1 || (int v4 = _LogCategory_Initialize(), v3 = v7, v4))
      {
LABEL_7:
        LogPrintF();
        id v3 = v7;
...
- (id)_ensureXPCStarted
{
  ...
  v13[1] = 3221225472;
  v13[2] = __37__RPStatusProvider__ensureXPCStarted__block_invoke;
  v13[3] = &unk_1E605B540;
  v13[4] = self;
  int v4 = (void *)MEMORY[0x1B3EBCC80](v13, a2);
  v12[0] = MEMORY[0x1E4F143A8];
  v12[1] = 3221225472;
  v12[2] = __37__RPStatusProvider__ensureXPCStarted__block_invoke_2;
  v12[3] = &unk_1E605B540;
  v12[4] = self;
    ...
    && self->_targetUserSession)
  {
    ...
    if (!v6)
    {
      if (gLogCategory_StatusProvider <= 50
        && (gLogCategory_StatusProvider != -1 || _LogCategory_Initialize()))
      {
        LogPrintF();
      }
  ...
  -[RPStatusProvider _connectionWithClient:queue:userProvider:interruptionHandler:invalidationHandler:](self, "_connectionWithClient:queue:userProvider:interruptionHandler:invalidationHandler:", self, self->_dispatchQueue, self->_userProvider, v4, v5, v11);
  id v8 = (NSXPCConnection *)objc_claimAutoreleasedReturnValue();
  xpcCnx = self->_xpcCnx;
  self->_xpcCnx = v8;

  if (gLogCategory_StatusProvider <= 10
    && (gLogCategory_StatusProvider != -1 || _LogCategory_Initialize()))
  {
    LogPrintF();
  }
...
uint64_t __37__RPStatusProvider__ensureXPCStarted__block_invoke(uint64_t a1)
{
...
- (NSMutableDictionary)currentlyProviding
{
  return self->_currentlyProviding;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_currentlyProviding, 0);
