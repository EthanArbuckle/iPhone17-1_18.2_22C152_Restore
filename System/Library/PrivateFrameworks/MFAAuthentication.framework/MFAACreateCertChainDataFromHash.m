@interface MFAACreateCertChainDataFromHash
@end

@implementation MFAACreateCertChainDataFromHash

CFArrayRef __MFAACreateCertChainDataFromHash_block_invoke(uint64_t a1)
{
  CFArrayRef result = (const __CFArray *)CFDictionaryGetValue(*(CFDictionaryRef *)(*(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) + 64), *(const void **)(a1 + 48));
  if (result)
  {
