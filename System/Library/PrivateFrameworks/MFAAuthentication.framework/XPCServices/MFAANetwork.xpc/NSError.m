...
+ (id)FPSAPS_errorDescriptionForCode:(int64_t)a3
{
  if ((unint64_t)a3 < 0xFFFFFFFFFFFFFFF9) {
    ...
    return *(&off_100078B78 + a3 + 7);
  }
}

+ (id)FPSAPS_errorWithCode:(int64_t)a3
{
  v4 = +[NSError FPSAPS_errorDescriptionForCode:](NSError, "FPSAPS_errorDescriptionForCode:");
  id v5 = +[NSError FPSAPS_errorWithCode:a3 andDescription:v4];
...
+ (id)FPSAPS_errorWithCode:(int64_t)a3 andDescription:(id)a4
{
  ...
  id v8 = +[NSError errorWithDomain:@"FairPlaySAPSessionErrorDomain" code:a3 userInfo:v7];
