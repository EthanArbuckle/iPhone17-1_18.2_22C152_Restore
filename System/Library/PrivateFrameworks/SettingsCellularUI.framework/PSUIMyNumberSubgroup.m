@interface PSUIMyNumberSubgroup
- (NSMutableArray)bundleControllers;
- (PSListController)listController;
- (PSSpecifier)parentSpecifier;
- (PSUIMyNumberSubgroup)initWithListController:(id)a3 groupSpecifier:(id)a4;
- (PSUIMyNumberSubgroup)initWithListController:(id)a3 groupSpecifier:(id)a4 parentSpecifier:(id)a5;
- (id)specifiers;
...
@implementation PSUIMyNumberSubgroup
...
- (PSUIMyNumberSubgroup)initWithListController:(id)a3 groupSpecifier:(id)a4 parentSpecifier:(id)a5
{
  ...
  id v8 = a5;
  v12.receiver = self;
  v12.super_class = (Class)PSUIMyNumberSubgroup;
  v9 = [(PSUIMyNumberSubgroup *)&v12 init];
  v10 = v9;
  if (v9)
  {
...
- (id)specifiers
{
  ...
  v33[0] = @"PhonebookTelephonySettings";
