...
- (id)titleTextUsingNarrowWidth:(BOOL)a3
{
  return CAMLocalizedFrameworkString(@"SEMANTIC_STYLES_DESCRIPTION_OVERLAY_TITLE", &stru_26BD78BA0);
}

- (id)detailTextUsingNarrowWidth:(BOOL)a3
{
  return CAMLocalizedFrameworkString(@"SEMANTIC_STYLES_DESCRIPTION_OVERLAY_SET_UP", &stru_26BD78BA0);
}

- (id)acknowledgmentTextUsingNarrowWidth:(BOOL)a3
{
  return CAMLocalizedFrameworkString(@"SEMANTIC_STYLES_DESCRIPTION_OVERLAY_CONTINUE", &stru_26BD78BA0);
}
...
- (id)descriptionTextUsingNarrowWidth:(BOOL)a3
{
  return CAMLocalizedFrameworkString(@"SEMANTIC_STYLES_DESCRIPTION_OVERLAY_DESCRIPTION", &stru_26BD78BA0);
}
