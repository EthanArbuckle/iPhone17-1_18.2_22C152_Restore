...
{
  v8.receiver = self;
  v8.super_class = (Class)CAMEffectsPreviewVideoDataOutputEnabledCommand;
...
{
  v5.receiver = self;
  v5.super_class = (Class)CAMEffectsPreviewVideoDataOutputEnabledCommand;
  id v4 = a3;
  [(CAMCaptureCommand *)&v5 encodeWithCoder:v4];
  objc_msgSend(v4, "encodeBool:forKey:", -[CAMEffectsPreviewVideoDataOutputEnabledCommand _isEnabled](self, "_isEnabled", v5.receiver, v5.super_class), @"CAMVideoDataOutputEnabled");
}

- (id)copyWithZone:(_NSZone *)a3
{
  v6.receiver = self;
  v6.super_class = (Class)CAMEffectsPreviewVideoDataOutputEnabledCommand;
