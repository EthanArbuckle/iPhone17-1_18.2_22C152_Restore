...
- (CAMContentAwareDistortionCorrectionCommand)initWithSubcommands:(id)a3
{
  return [(CAMContentAwareDistortionCorrectionCommand *)self initWithContentAwareDistortionCorrectionEnabled:0];
}

- (CAMContentAwareDistortionCorrectionCommand)initWithCoder:(id)a3
{
  uint64_t v4 = [a3 decodeBoolForKey:@"CAMContentAwareDistortionCorrectionKey"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[CAMContentAwareDistortionCorrectionCommand _isEnabled](self, "_isEnabled", v5.receiver, v5.super_class), @"CAMContentAwareDistortionCorrectionKey");
}
...
- (void)executeWithContext:(id)a3
{
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0
    ...
    && [v4 isContentAwareDistortionCorrectionSupported])
  {
