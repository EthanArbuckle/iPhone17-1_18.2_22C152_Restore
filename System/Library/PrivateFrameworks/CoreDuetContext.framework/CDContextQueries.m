...
{
  uint64_t v0 = +[_CDContextualKeyPath ephemeralKeyPathWithKey:@"/app/webUsage"];
  ...
  v2 = (void *)keyPathForAppWebUsageDataDictionaries_appWebUsageKeyPath;
  return [v2 setSensitiveContents:1];
}
