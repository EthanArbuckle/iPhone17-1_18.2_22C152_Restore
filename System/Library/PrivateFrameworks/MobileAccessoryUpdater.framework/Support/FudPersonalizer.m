      ...
      if (a3)
      {
        ...
        else
        {
            ...
            || ![a3 responseAlignment])
          {
            ...
            block[1] = 3221225472;
            block[2] = sub_10000AC00;
            block[3] = &unk_10007D488;
            block[5] = a3;
            block[6] = &v11;
            block[4] = self;
...
- (__CFDictionary)createPersonalizationManifestCFDict:(id)a3
{
  ...
  if ([a3 requestPrefix])
  {
    ...
    sub_10000A66C(v8, @"ApBoardID", (const __CFString *)[a3 requestPrefix], @"BoardID");
    sub_10000A66C(v8, @"ApChipID", (const __CFString *)[a3 requestPrefix], @"ChipID");
    sub_10000A66C(v8, @"ApECID", (const __CFString *)[a3 requestPrefix], @"ECID");
    sub_10000A66C(v8, @"ApSecurityDomain", (const __CFString *)[a3 requestPrefix], @"SecurityDomain");
    sub_10000A66C(v8, @"ApProductionMode", (const __CFString *)[a3 requestPrefix], @"ProductionMode");
    sub_10000A66C(v8, @"ApManifestEpoch", (const __CFString *)[a3 requestPrefix], @"ManifestEpoch");
    if ([a3 isSecurityModeSet]) {
      sub_10000A66C(v8, @"ApSecurityMode", (const __CFString *)[a3 requestPrefix], @"SecurityMode");
    }
    sub_10000A66C(v8, @"ApNonce", (const __CFString *)[a3 requestPrefix], @"Nonce");
    objc_super v9 = CFStringCreateMutable(kCFAllocatorDefault, 0);
    CFStringAppendFormat(v9, 0, @"@%@", @"ApImg4Ticket");
    sub_10000A708(v8, v9, (const __CFString *)[a3 requestPrefix], @"Ticket");
    CFRelease(v9);
  ...
  CFRelease(v10);
  sub_10000A600(v6, @"ApBoardID", (int)[a3 boardID]);
  sub_10000A600(v6, @"ApChipID", (int)[a3 chipID]);
  if ([a3 globalSigning])
  {
  ...
  else
  {
    if (![a3 extEcID])
    {
      sub_10000A594(v6, @"ApECID", (uint64_t)[a3 ecID]);
      goto LABEL_20;
    }
...
LABEL_20:
  ...
  sub_10000A600(v6, @"ApSecurityDomain", v14);
  ...
  if ([a3 isChipEpochSet]) {
    sub_10000A600(v6, @"ApManifestEpoch", (int)[a3 chipEpoch]);
  }
