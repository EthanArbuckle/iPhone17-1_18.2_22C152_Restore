...
- (UARPServiceUpdaterMatchedEARule)initWithCoder:(id)a3
{
  ...
  id v6 = [a3 decodeObjectOfClass:objc_opt_class() forKey:@"serialNumber"];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      unsigned int v5 = [(NSString *)self->_eaIdentifier isEqual:*((void *)a3 + 1)];
      if (v5)
      {
        accessorySerialNumber = self->_accessorySerialNumber;
...
- (id)description
{
  ...
  return +[NSString stringWithFormat:@"<%@: EAIdentifier=%@, acessorySerialNumber=%@", NSStringFromClass(v3), self->_eaIdentifier, self->_accessorySerialNumber];
}
