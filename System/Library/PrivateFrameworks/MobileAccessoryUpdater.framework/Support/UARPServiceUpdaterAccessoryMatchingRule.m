...
- (UARPServiceUpdaterAccessoryMatchingRule)initWithCoder:(id)a3
{
  ...
  id v6 = [a3 decodeObjectOfClass:objc_opt_class() forKey:@"xpcEventStream"];
  v8[0] = objc_opt_class();
  v8[1] = objc_opt_class();
  v8[2] = objc_opt_class();
  v8[3] = objc_opt_class();
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    else
    {
      ...
      if (v5)
      {
        unsigned int v5 = [(NSString *)self->_xpcEventStream isEqual:*((void *)a3 + 2)];
        if (v5)
        {
          matchingDictionary = self->_matchingDictionary;
...
- (id)description
{
  ...
  return +[NSString stringWithFormat:@"<%@: Identifier=%@, Event Stream=%@>", NSStringFromClass(v3), self->_identifier, self->_xpcEventStream];
}
