...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationFTABSubfileDigestBackDeploy;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationFTABSubfileDigestBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationFTABSubfileDigestBackDeploy tlvType];
  uint64_t v4 = *(void *)(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationFTABSubfileDigestBackDeploy;
