...
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationLogicalUnitNumberBackDeploy;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationLogicalUnitNumberBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationLogicalUnitNumberBackDeploy tlvType];
  uint64_t v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationLogicalUnitNumberBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationLogicalUnitNumberBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  uint64_t v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationLogicalUnitNumberBackDeploy tlvType]);
  v6[1] = v2;
