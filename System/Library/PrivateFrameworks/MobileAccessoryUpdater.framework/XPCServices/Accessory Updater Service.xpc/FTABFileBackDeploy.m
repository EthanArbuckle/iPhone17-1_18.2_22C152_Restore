...
- (FTABFileBackDeploy)initWithData:(id)a3
{
  ...
  id v5 = [(FTABFileBackDeploy *)&v10 init];
  if (v5
    && (v6 = (NSData *)[v4 copy],
        fileData = v5->_fileData,
        v5->_fileData = v6,
        fileData,
        ![(FTABFileBackDeploy *)v5 initFile]))
  {
    id v8 = 0;
  }
  else
...
- (BOOL)initFile
{
  ...
  v3 = (NSMutableArray *)+[NSMutableArray array];
...
- (FTABFileBackDeploy)init
{
  ...
  if (v2)
  {
    ...
    v6 = (NSMutableArray *)+[NSMutableArray array];
    subFileArray = v2->_subFileArray;
    v2->_subFileArray = v6;

    id v8 = +[NSData dataWithBytes:"rkosftab/usr/lib/libFDR.dylib" length:8];
    magic = v2->_magic;
    v2->_magic = v8;
  }
  return v2;
...
- (BOOL)parseFileData
{
  if (self->_fileLength > 0x2F)
  {
    ...
    if (*((void *)filePointer + 4) == 0x42415446534F4B52 || *v12 == 0x62617466736F6B72)
    {
      ...
      v15 = +[NSData dataWithBytes:filePointer + 8 length:8];
      ...
      if (v17)
      {
        ...
        if (![(FTABFileBackDeploy *)self fileValidForOffset:v18 length:*((unsigned int *)filePointer + 5)])
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_10006165C(v2, v29, v30, v31, v32, v33, v34, v35);
          }
          goto LABEL_26;
        }
        v19 = [[FTABSubfileBackDeploy alloc] initWithTag:@"Manifest" dataPointer:&self->_filePointer[v18] dataLength:v17];
      ...
      for (uint64_t i = 0;
            [(FTABFileBackDeploy *)self fileValidForOffset:(i + 48) length:16];
            i += 16)
      {
        uint64_t v24 = *(unsigned int *)&filePointer[i + 52];
        uint64_t v23 = *(unsigned int *)&filePointer[i + 56];
        if (![(FTABFileBackDeploy *)self fileValidForOffset:v24 length:v23])
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_100061548();
        ...
        if (!v25)
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_100061494((unsigned __int8 *)&filePointer[i + 48], v2);
          }
          goto LABEL_26;
        }
        v26 = v25;
        v27 = [[FTABSubfileBackDeploy alloc] initWithTag:v25 dataPointer:&self->_filePointer[v24] dataLength:v23];
  ...
  else
  {
    v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
    if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
      sub_10006141C(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
LABEL_26:
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v6; uint64_t i = (char *)i + 1)
      {
        ...
        id v10 = objc_msgSend(v9, "tag", (void)v13);
...
- (void)removeSubfileWithTag:(id)a3
{
  id v4 = [(FTABFileBackDeploy *)self subfileWithTag:a3];
  if (v4) {
...
- (BOOL)addSubfileWithTagName:(id)a3 contentsOfURL:(id)a4
{
  ...
  if (v8)
  {
    BOOL v10 = [(FTABFileBackDeploy *)self addSubfileWithTagName:v6 subfileData:v8];
  }
  else
  {
...
- (BOOL)addSubfileWithTagName:(id)a3 subfileData:(id)a4
{
  ...
  id v8 = [FTABSubfileBackDeploy alloc];
  id v9 = v6;
  id v10 = [v9 bytes];
  id v11 = [v9 length];

  uint64_t v12 = [(FTABSubfileBackDeploy *)v8 initWithTag:v7 dataPointer:v10 dataLength:v11];
...
{
  id v4 = a3;
  id v5 = [[FTABSubfileBackDeploy alloc] initWithTag:@"Manifest" data:v4];
...
- (id)createFileHandleForWritingToURL:(id)a3
{
  ...
  id v5 = [v3 path];
  unsigned int v6 = [(NSFileManager *)v4 fileExistsAtPath:v5];

  if (v6)
  {
    id v7 = [v3 path];
    id v18 = 0;
    unsigned __int8 v8 = [(NSFileManager *)v4 removeItemAtPath:v7 error:&v18];
  ...
  id v11 = [v3 path];
  unsigned __int8 v12 = [(NSFileManager *)v10 createFileAtPath:v11 contents:0 attributes:0];
...
- (BOOL)configureFileHandleWriteDestinationForURL:(id)a3
{
  ...
  unsigned int v6 = (NSFileHandle *)[(FTABFileBackDeploy *)self createFileHandleForWritingToURL:v5];
...
- (void)configureDataWriteDestination
{
  ...
  id v4 = (NSMutableData *)+[NSMutableData data];
  dataWriteDestination = self->_dataWriteDestination;
...
- (BOOL)writeToDestination
{
  ...
  if (manifest)
  {
    ...
    unsigned int v6 = [(FTABSubfileBackDeploy *)manifest dataLength];
  }
  else
  {
    unsigned int v6 = 0;
...
LABEL_30:
  ...
  if (v15
    && ![(FTABFileBackDeploy *)self writeBytes:[(FTABSubfileBackDeploy *)v15 dataPointer] length:[(FTABSubfileBackDeploy *)self->_manifest dataLength]])
  {
    id v7 = (NSMutableArray *)os_log_create("com.apple.accessoryupdater.ftab", "writing");
    if (os_log_type_enabled(&v7->super.super, OS_LOG_TYPE_ERROR)) {
      sub_100061A48(&v7->super.super);
    }
LABEL_31:
    BOOL v21 = 0;
    goto LABEL_32;
  ...
  if (v16)
  {
    ...
    while (2)
    {
      for (j = 0; j != v17; j = (char *)j + 1)
      {
        ...
        if (!-[FTABFileBackDeploy writeBytes:length:](self, "writeBytes:length:", objc_msgSend(v20, "dataPointer", (void)v24), objc_msgSend(v20, "dataLength")))
        {
          v22 = os_log_create("com.apple.accessoryupdater.ftab", "writing");
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR)) {
            sub_1000619BC(v20);
...
- (BOOL)writeToURL:(id)a3
{
  ...
  {
    BOOL v5 = [(FTABFileBackDeploy *)self writeToDestination];
    fileHandleWriteDestination = self->_fileHandleWriteDestination;
    self->_fileHandleWriteDestination = 0;
  }
  else
...
- (BOOL)writeSubfileToURL:(id)a3 tag:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = [(FTABFileBackDeploy *)self subfileWithTag:v7];
  if (v8)
  {
    id v9 = [(FTABFileBackDeploy *)self createFileHandleForWritingToURL:v6];
    if (v9) {
      unsigned __int8 v10 = objc_msgSend(v9, "writeBytes:length:", objc_msgSend(v8, "dataPointer"), objc_msgSend(v8, "dataLength"));
    }
    else {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v3 = [(FTABFileBackDeploy *)self writeToData];
  id v4 = [[FTABFileBackDeploy alloc] initWithData:v3];
