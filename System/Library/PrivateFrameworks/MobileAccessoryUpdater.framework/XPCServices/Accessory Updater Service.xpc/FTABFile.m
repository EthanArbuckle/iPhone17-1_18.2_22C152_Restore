...
- (NSString)dumpString
{
  ...
  objc_msgSend(v3, "appendFormat:", @"Generation: 0x%08x\n", -[FTABFile generation](self, "generation"));
  objc_msgSend(v3, "appendFormat:", @"Valid: %u\n", -[FTABFile valid](self, "valid"));
...
- (FTABFile)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v8 = +[NSData dataWithBytes:"rkosftab" length:8];
    magic = v2->_magic;
    v2->_magic = (NSData *)v8;
  }
  return v2;
...
- (BOOL)parseFileData
{
    ...
    if (*((void *)filePointer + 4) == 0x42415446534F4B52 || *v12 == 0x62617466736F6B72)
    {
      ...
      if (v17)
      {
        ...
        if (![(FTABFile *)self fileValidForOffset:v18 length:*((unsigned int *)filePointer + 5)])
        {
          ...
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_10006E12C(v2, v29, v30, v31, v32, v33, v34, v35);
          }
          goto LABEL_26;
        }
            ...
            i += 16)
      {
        ...
        if (!v25)
        {
          v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
          if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
            sub_10006DF64((unsigned __int8 *)&filePointer[i + 48], v2);
          }
          goto LABEL_26;
        }
        v26 = v25;
  ...
  else
  {
    v2 = os_log_create("com.apple.accessoryupdater.ftab", "parsing");
    if (os_log_type_enabled(v2, OS_LOG_TYPE_ERROR)) {
      sub_10006DEEC(v2, v3, v4, v5, v6, v7, v8, v9);
    }
  }
LABEL_26:
...
- (NSString)bverString
{
  ...
  if (v2 && (unsigned int v4 = [v2 dataLength]) != 0)
  {
    ...
    id v6 = objc_msgSend(objc_alloc((Class)NSString), "initWithBytes:length:encoding:", objc_msgSend(v3, "dataPointer"), v5, 4);
  }
  else
  {
    id v6 = 0;
