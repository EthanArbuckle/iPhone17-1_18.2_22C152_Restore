@interface UARPTLVPersonalizationFTABSubfileTagBackDeploy
+ (id)metaDataTableEntry;
+ (id)tlvFromPropertyListValue:(id)a3;
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4;
+ (unsigned)tlvType;
- (UARPAssetTagBackDeploy)tag;
- (UARPTLVPersonalizationFTABSubfileTagBackDeploy)init;
- (id)description;
- (id)generateTLV;
- (id)tlvValue;
- (void)setTag:(id)a3;
...
@implementation UARPTLVPersonalizationFTABSubfileTagBackDeploy

- (UARPTLVPersonalizationFTABSubfileTagBackDeploy)init
{
  v3.receiver = self;
  v3.super_class = (Class)UARPTLVPersonalizationFTABSubfileTagBackDeploy;
...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationFTABSubfileTagBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  ...
  int v8 = uarpHtonl(+[UARPTLVPersonalizationFTABSubfileTagBackDeploy tlvType]);
  [v3 appendBytes:&v8 length:4];
  int v7 = uarpHtonl(4u);
  [v3 appendBytes:&v7 length:4];
  id v4 = [(UARPTLVPersonalizationFTABSubfileTagBackDeploy *)self tlvValue];
  [v3 appendData:v4];
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  id v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationFTABSubfileTagBackDeploy tlvType]);
  v6[1] = v2;
