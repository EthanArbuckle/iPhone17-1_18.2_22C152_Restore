...
- (id)description
{
  id v3 = +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  uint64_t v3 = +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberBackDeploy tlvType];
  uint64_t v4 = *((unsigned __int8 *)&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  uint64_t v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationSuffixNeedsLogicalUnitNumberBackDeploy tlvType]);
  v6[1] = v2;
