...
- (id)generateHashForSubfile:(id)a3
{
  ...
  id v3 = a3;
  CC_SHA384_Init(&v8);
  id v4 = objc_msgSend(v3, "dataPointer", *(_OWORD *)v8.count, *(_OWORD *)v8.hash, *(_OWORD *)&v8.hash[2], *(_OWORD *)&v8.hash[4], *(_OWORD *)&v8.hash[6], *(_OWORD *)v8.wbuf, *(_OWORD *)&v8.wbuf[2], *(_OWORD *)&v8.wbuf[4], *(_OWORD *)&v8.wbuf[6], *(_OWORD *)&v8.wbuf[8], *(_OWORD *)&v8.wbuf[10], *(_OWORD *)&v8.wbuf[12], *(_OWORD *)&v8.wbuf[14]);
