  ...
  if (a5)
  {
    if (a7 >= 4)
    {
      ...
      while (1)
      {
        ...
        v28 = (void *)qword_100041ED0;
        uint64_t v44 = qword_100041ED0;
        if (!qword_100041ED0)
        {
...
- (void)scheduleCoreSpeechTask:(unint64_t)a3 minorVersion:(unint64_t)a4 downloadedModels:(id)a5 preinstalledModels:(id)a6
{
  ...
  if (self->delegate)
  {
    ...
    v13 = (void *)qword_100041EE0;
    uint64_t v19 = qword_100041EE0;
    if (!qword_100041EE0)
    {
      *(void *)&long long buf = _NSConcreteStackBlock;
      *((void *)&buf + 1) = 3221225472;
      unsigned int v21 = sub_100015BBC;
      uint64_t v22 = &unk_1000319B0;
      unint64_t v23 = &v16;
      sub_100015BBC((uint64_t)&buf);
      v13 = (void *)v17[3];
    }
    id v14 = v13;
