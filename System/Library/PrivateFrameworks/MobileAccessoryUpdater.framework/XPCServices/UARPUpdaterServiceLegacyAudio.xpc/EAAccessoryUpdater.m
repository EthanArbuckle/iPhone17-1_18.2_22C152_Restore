...
- (id)assetLocationForCustomBasejumperTrain:(id)a3 build:(id)a4
{
  return +[NSString stringWithFormat:@"%@/%@/%@%@", getURLForAssetURLType(4uLL), a3, a3, a4];
}
...
- (id)assetLocationForType:(unint64_t)a3 withTrain:(id)a4
{
  ...
  switch(a3)
  {
    ...
    case 2uLL:
      ...
      goto LABEL_11;
    case 3uLL:
      URLForAssetURLType = +[NSString stringWithFormat:@"%@/AirPods2022Seed", getURLForAssetURLType(2uLL), v10];
      goto LABEL_12;
    case 4uLL:
      unint64_t v8 = 4;
      goto LABEL_11;
...
- (id)trainName
{
  if (qword_100041EE8 != -1) {
    dispatch_once(&qword_100041EE8, &stru_100031A88);
  }
  if (qword_100041EF0) {
    return +[NSString stringWithFormat:@"%s", qword_100041EF0];
  }
  else {
    return 0;
  }
...
- (BOOL)prepareFirmwareBundlesFromDropbox:(id)a3 error:(id *)a4
{
  ...
  [v8 sortUsingComparator:&stru_100031AC8];
  if (![v8 count])
  {
