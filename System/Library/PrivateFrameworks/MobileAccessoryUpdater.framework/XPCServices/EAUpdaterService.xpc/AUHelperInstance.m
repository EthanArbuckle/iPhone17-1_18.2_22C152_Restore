...
+ (AUHelperInstance)sharedInstance
{
  ...
  block[4] = a1;
  if (qword_10002F9F8 != -1) {
    dispatch_once(&qword_10002F9F8, block);
  }
  return (AUHelperInstance *)qword_10002F9F0;
}
...
- (AUHelperServiceProtocol)remoteObject
{
  ...
  if (result) {
    return (AUHelperServiceProtocol *)[(AUHelperServiceProtocol *)result synchronousRemoteObjectProxyWithErrorHandler:&stru_100025650];
  }
  return result;
}
