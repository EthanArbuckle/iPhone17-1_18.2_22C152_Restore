...
- (EAFirmwareUpdater)initWithDeviceClass:(id)a3 assetType:(id)a4 skipDFU:(BOOL)a5 byteEscape:(BOOL)a6 skipReconnect:(BOOL)a7 skipVersionCheck:(BOOL)a8 options:(id)a9 serialNum:(id)a10
{
  ...
  v15->_currentSessionTimeTaken = (NSNumber *)&off_10002B978;
  v15->_cumulativeBytesDownloaded = (NSNumber *)&off_10002B978;
  v15->_totalBytesForCompleteUpdate = (NSNumber *)&off_10002B978;
  v15->_cumulativeProgressPercent = (NSNumber *)&off_10002B978;
  v15->_cumulativeTimeTaken = (NSNumber *)&off_10002B978;
  v15->_cumulativeCloakTime = (NSNumber *)&off_10002B978;
  v15->_resumeCount = (NSNumber *)&off_10002B978;
...
LABEL_14:
  ...
  dispatch_sync((dispatch_queue_t)&_dispatch_main_q, &stru_100025300);
...
- (id)validateAssetAttributes:(id)a3
{
  if (a3)
  {
    ...
    {
      sub_10000A648(0, 4, @"No firmware bundle filename in asset: %@", v11, v12, v13, v14, v15, @"FirmwareBundle");
    }
    return 0;
  }
  else
  {
    return sub_10000A648(0, 3, @"No asset attributes", v3, v4, v5, v6, v7, v19);
  }
}
...
- (id)validateAsset
{
  if (![(EAFirmwareUpdater *)self asset])
  {
    ...
    int v31 = 2;
LABEL_27:
    long long v27 = sub_10000A648(0, v31, (uint64_t)v30, v3, v4, v5, v6, v7, (uint64_t)v34);
    uint64_t v14 = 0;
    goto LABEL_19;
  }
  ...
  if (!v8)
  {
    ...
    int v33 = 5;
LABEL_32:
    long long v27 = sub_10000A648(0, v33, (uint64_t)v32, v9, v10, v11, v12, v13, (uint64_t)v34);
    goto LABEL_19;
  }
...
LABEL_16:
    ...
    long long v27 = sub_10000A648(0, 4, @"Couldn't parse SuperBinary header tag", v22, v23, v24, v25, v26, v35);
  }
  else
  {
    long long v27 = 0;
...
LABEL_88:
    v46 = sub_10000A648(0, 21, (uint64_t)v45, v5, v6, v7, v8, v9, (uint64_t)v51);
    uint64_t v11 = 0;
    id v19 = 0;
    char v44 = 1;
    goto LABEL_109;
...
LABEL_76:
          ...
          int v49 = 21;
LABEL_106:
          v46 = sub_10000A648(0, v49, (uint64_t)v48, v20, v21, v22, v23, v24, (uint64_t)v51);
          goto LABEL_107;
        }
  ...
  v46 = sub_10000A648(0, 21, (uint64_t)v47, v12, v13, v14, v15, v16, @"PersonalizationRequest");
  id v19 = 0;
LABEL_107:
  if (!v46)
  {
...
LABEL_109:
  ...
  block[1] = 3221225472;
  block[2] = sub_10000B870;
  block[3] = &unk_100025350;
  block[4] = self;
...
- (void)handleSessionError:(unsigned int)a3 message:(id)a4
{
  id v9 = sub_10000A648(0, a3, (uint64_t)a4, (uint64_t)a4, v4, v5, v6, v7, v11[0]);
  eaNotificationDispatchQueue = self->_eaNotificationDispatchQueue;
  v11[0] = (uint64_t)_NSConcreteStackBlock;
  v11[1] = 3221225472;
  v11[2] = (uint64_t)sub_10000BEA4;
  v11[3] = (uint64_t)&unk_100025350;
  v11[4] = (uint64_t)self;
...
LABEL_26:
  ...
  int v34 = 19;
LABEL_36:
  int v31 = sub_10000A648(0, v34, (uint64_t)v33, v15, v16, v17, v18, v19, (uint64_t)"-[EAFirmwareUpdater applyFirmware:progress:update:personalization:]");
  if (v31)
  {
...
- (id)openSession
{
  ...
  return sub_10000A648(0, v16, (uint64_t)v15, v3, v4, v5, v6, v7, v18);
}
...
LABEL_12:
  ...
  return sub_10000A648(0, v15, (uint64_t)v14, v3, v4, v5, v6, v7, v18);
}
...
- (id)createEndOfUpdateEventDict:(id)a3 error:(id)a4
{
  -[EAFirmwareUpdater log:format:](self, "log:format:", 5, @"%s %@", "-[EAFirmwareUpdater createEndOfUpdateEventDict:error:]", [objc_alloc((Class)NSString) initWithFormat:&stru_1000294D0]);
...
LABEL_13:
    uint64_t v13 = sub_10000A648(0, v16, (uint64_t)v15, v4, v5, v6, v7, v8, v17);
    goto LABEL_11;
  }
LABEL_10:
  uint64_t v13 = 0;
        ...
        else
        {
          ...
          if (isExpectingReconnect == 2)
          {
            ...
            if (eaNotificationDispatchQueue)
            {
              block[0] = _NSConcreteStackBlock;
              block[1] = 3221225472;
              block[2] = sub_10000DCF8;
              block[3] = &unk_1000253C8;
              block[4] = self;
              void block[5] = v22;
              id v11 = block;
              goto LABEL_16;
...
LABEL_18:
        ...
        [(EAFirmwareUpdater *)self updateComplete:v13 error:sub_10000A648(0, 11, (uint64_t)v12, v14, v15, v16, v17, v18, v19)];
      }
    }
  }
LABEL_20:
