...
void sub_100004A68(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
{
  qword_10002AC80 = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
  return _objc_release_x1();
}

id sub_100004DE0(void *a1)
{
  return [*(id *)(a1[4] + 24) recvDataFromAccessory:a1[5] data:a1[6] error:0];
}

uint64_t sub_1000061E4(uint64_t result, uint64_t a2)
{
...
void sub_1000061F4(uint64_t a1)
{
}

void sub_1000061FC(void *a1)
{
  long long v16 = 0u;
  long long v17 = 0u;
  long long v14 = 0u;
    ...
    *(void *)&long long v4 = 136315650;
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        v10 = objc_msgSend(v8, "uarpAccessory", v13, (void)v14);
        unsigned int v11 = [v10 isEqual:a1[5]];

        if (v11)
        {
          if (os_log_type_enabled(*(os_log_t *)(a1[4] + 8), OS_LOG_TYPE_DEBUG)) {
            sub_100018348();
          }
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
        {
          uint64_t v13 = a1[5];
          *(_DWORD *)buf = v14;
          __int16 v20 = "-[UARPDFUUpdater getDfuAccessoryForUarpAccessoryID:]_block_invoke";
          __int16 v21 = 2112;
          uint64_t v22 = v13;
          __int16 v23 = 2112;
          v24 = v8;
        ...
        v10 = objc_msgSend(v8, "uarpAccessory", v14, (void)v15);
        unsigned int v11 = [v10 getID];
      ...
      id v5 = [v2 countByEnumeratingWithState:&v15 objects:v25 count:16];
      if (v5) {
        continue;
      }
      break;
...
void sub_100006804(void *a1)
{
  ...
  long long v21 = 0u;
  id v2 = *(id *)(a1[4] + 32);
  id v3 = [v2 countByEnumeratingWithState:&v20 objects:v30 count:16];
  if (v3)
  {
    id v5 = v3;
    ...
    while (2)
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
        {
          uint64_t v19 = a1[5];
          long long v14 = v9;
          long long v15 = [v8 uarpAccessory];
          long long v16 = [v15 getID];
          long long v17 = [v16 serialNumber];
          *(_DWORD *)buf = v18;
          ...
          __int16 v28 = 2112;
          v29 = v17;
          _os_log_debug_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEBUG, "%s: Check match %@ vs %@", buf, 0x20u);
        }
        v10 = (void *)a1[5];
        unsigned int v11 = objc_msgSend(v8, "uarpAccessory", v18);
        unsigned int v12 = [v11 getID];
      ...
      id v5 = [v2 countByEnumeratingWithState:&v20 objects:v30 count:16];
      if (v5) {
        continue;
      }
      break;
...
void sub_100006EAC(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    int v5 = 136315650;
    uint64_t v6 = "-[UARPDFUUpdater addAccessory:enableNotification:]_block_invoke";
    __int16 v7 = 2112;
    uint64_t v8 = v3;
    __int16 v9 = 2112;
    uint64_t v10 = v4;
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_INFO, "%s: New accessory <%@> in tracked accessories %@", (uint8_t *)&v5, 0x20u);
  }
}

void sub_100006F7C(void *a1, io_iterator_t a2)
{
  id v3 = a1;
  if (v3 && a2)
  {
    ...
    if (v5)
    {
      ...
      do
      {
        ...
        {
          __int16 v7 = CFDictionaryGetValue(properties, @"kUSBSerialNumberString");
          objc_opt_class();
          if (objc_opt_isKindOfClass())
          {
            uint64_t v8 = [v3 getDfuAccessoryForSerialNumber:v7];
        ...
        io_registry_entry_t v6 = IOIteratorNext(a2);
      }
      while (v6);
    }
    long long v16 = 0u;
    ...
    if (v10)
    {
      ...
      do
      {
        for (i = 0; i != v11; i = (char *)i + 1)
        {
          ...
          objc_msgSend(*(id *)(*((void *)&v14 + 1) + 8 * i), "disableDisconnectCallback", (void)v14);
        }
...
void sub_100007234(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315650;
    long long v17 = "-[UARPDFUUpdater removeAccessory:]_block_invoke";
    __int16 v18 = 2112;
    uint64_t v19 = v3;
    __int16 v20 = 2112;
    uint64_t v21 = v4;
    _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_INFO, "%s: Removed accessory <%@> from tracked accessories %@", buf, 0x20u);
  }
  long long v13 = 0u;
  long long v14 = 0u;
  long long v11 = 0u;
...
LABEL_13:
    objc_msgSend(*(id *)(a1 + 32), "releasePowerAssertionForAccessory", (void)v11);
    return;
  }
  id v7 = v6;
  int v8 = 0;
  ...
  do
  {
    for (i = 0; i != v7; i = (char *)i + 1)
    {
      ...
      v8 |= objc_msgSend(*(id *)(*((void *)&v11 + 1) + 8 * i), "requiresPowerAssertion", (void)v11);
    }
...
void sub_100007820(uint64_t a1)
{
  ...
  id v4 = [*(id *)(a1 + 40) uarpAccessory];
  uint64_t v3 = [v4 getID];
...
{
  id v2 = [*(id *)(a1 + 32) getDfuAccessoryForUarpAccessory:*(void *)(a1 + 40)];
  [v2 recvMessage:*(void *)(a1 + 48)];
}

void sub_10000834C(uint64_t a1)
{
  id v2 = *(void **)(*(void *)(a1 + 32) + 72);
  id v4 = [*(id *)(a1 + 40) uarpAccessory];
  uint64_t v3 = [v4 getID];
...
void sub_100008744(uint64_t a1)
{
  id v2 = *(void **)(*(void *)(a1 + 32) + 72);
  id v4 = [*(id *)(a1 + 40) uarpAccessory];
  uint64_t v3 = [v4 getID];
...
void sub_1000097E4(uint64_t a1)
{
  id v2 = *(void **)(*(void *)(a1 + 32) + 72);
  id v4 = [*(id *)(a1 + 40) uarpAccessory];
  uint64_t v3 = [v4 getID];
...
void sub_100009924(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_error_impl(a1, a2, OS_LOG_TYPE_ERROR, a4, &a9, 0x16u);
}

void sub_100009940(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
  _os_log_debug_impl(a1, a2, OS_LOG_TYPE_DEBUG, a4, &a9, 0x16u);
}

uint64_t sub_10000A208(int a1, void **a2, size_t size)
{
  *a2 = malloc_type_calloc(1uLL, size, 0xE38CD912uLL);
  return 0;
}

void sub_10000A244(int a1, void *a2)
{
}

uint64_t sub_10000A24C(void *a1, uint64_t a2, void *a3, _DWORD *a4)
{
  uint64_t result = 30;
  if (a3)
  {
    if (a4)
    {
      size_t v8 = (*(_DWORD *)[a1 localEP] + 36);
      *a4 = v8;
      uint64_t v9 = malloc_type_calloc(1uLL, v8, 0xB9E71548uLL);
      uint64_t result = 0;
      *a3 = v9;
    }
  }
...
void sub_10000A2B4(int a1, int a2, void *a3)
{
  if (a3) {
    uarpFree(a3);
  }
...
uint64_t sub_10000A2C4(void *a1, void *a2, uint64_t a3, unsigned int a4)
{
  id v7 = a1;
  id v8 = a2;
  id v9 = [objc_alloc((Class)NSData) initWithBytes:a3 length:a4];
  id v10 = [v7 uarpAccessory];
  unsigned int v11 = [v8 recvUarpMsgFromAccessory:v10 uarpMsg:v9 error:0];

  if (v11)
  {
    uarpPlatformEndpointSendMessageComplete((uint64_t)[v7 localEP], (uint64_t)objc_msgSend(v7, "remoteEP"), a3);
    uint64_t v12 = 0;
  }
  else
  {
...
void sub_10000A39C(void *a1, uint64_t a2, _DWORD *a3)
{
  ...
  id v6 = [USBAudioAsset alloc];
  id v7 = [v5 pRxSuperBinaries];
  id v8 = [(USBAudioAsset *)v6 initWithUarpAsset:a3 nextAsset:v7];

  [v5 setPRxSuperBinaries:v8];
  char v14 = 0;
  unsigned __int16 v13 = 0;
  uarpPlatformEndpointAssetIsAcceptable([v5 localEP], (uint64_t)a3, &v14, (__int16 *)&v13);
  if (v14)
  {
    if ([v5 dfuModeActive])
    {
      if (uarpPlatformEndpointAssetAccept((uint64_t)[v5 localEP], (uint64_t)objc_msgSend(v5, "remoteEP"), (uint64_t)a3, (uint64_t)v8, -[USBAudioAsset callbacks](v8, "callbacks")))uarpLogError(3u, "%s: Failed to accept superbinary; 0x%08x"); {
    }
      }
    else
    {
      ...
      id v11 = [v5 localEP];
      id v12 = [v5 remoteEP];
      uarpPlatformEndpointAssetDeny((uint64_t)v11, (uint64_t)v12, (uint64_t)a3, v13, (uint64_t)v8, [(USBAudioAsset *)v8 callbacks]);
      if ([v5 setDfuMode]) {
        uarpLogError(3u, "Something went wrong when setting device into DFU mode [%x]");
      }
    }
  }
  else
  {
    uarpLogError(3u, "%s: Asset is not acceptable", "DfuOtpSuperBinaryOffered");
    id v9 = [v5 localEP];
    id v10 = [v5 remoteEP];
    uarpPlatformEndpointAssetDeny((uint64_t)v9, (uint64_t)v10, (uint64_t)a3, v13, (uint64_t)v8, [(USBAudioAsset *)v8 callbacks]);
  }
}

void sub_10000A5C0(uint64_t a1, uint64_t a2, uint64_t a3)
{
}

uint64_t sub_10000A648(void *a1, uint64_t a2, __int16 *a3)
{
  ...
  unsigned int v6 = [v5 applyFirmware];

  if (v6)
  {
    uarpLogError(3u, "Apply Staged Assets: something went wrong with firmware application [%x]", v6);
    uint64_t result = 54;
    __int16 v8 = 2;
  }
  else
...
uint64_t sub_10000A6FC(void *a1, void *a2, unsigned int *a3)
{
  ...
  if (a2 && a3)
  {
    ...
    if (v8 >= v10)
    {
      id v11 = [v7 vendorName];
      *a3 = [v11 length];

      id v12 = [v7 vendorName];
...
uint64_t sub_10000A7F8(void *a1, void *a2, unsigned int *a3)
{
...
uint64_t sub_10000A8F8(void *a1, void *a2, unsigned int *a3)
{
  ...
  if (a2 && a3)
  {
    ...
    if (v8 >= v10)
    {
      id v11 = [v7 serialNumber];
      *a3 = [v11 length];

      id v12 = [v7 serialNumber];
      memcpy(a2, [v12 UTF8String], *a3);
...
uint64_t sub_10000A9F4(uint64_t a1, uint64_t a2, _DWORD *a3)
{
  ...
  if (a2 && a3)
  {
    if (*a3 > 2u)
    {
      uint64_t result = 0;
      *a3 = 3;
      __int16 v6 = word_10002AC68;
      *(unsigned char *)(a2 + 2) = byte_10002AC6A;
      *(_WORD *)a2 = v6;
    }
    else
    {
...
uint64_t sub_10000AA8C(void *a1, uint64_t a2, void *a3)
{
...
uint64_t sub_10000AAFC(void *a1, uint64_t a2, void *a3)
{
...
uint64_t sub_10000AB6C(void *a1, uint64_t a2, void *a3, unsigned int a4, _DWORD *a5)
{
  ...
  {
    id v10 = a1;
    id v11 = [v10 modelNumber];
    unsigned int v12 = [v11 length];

    if (v12 <= a4)
    {
      unsigned __int16 v13 = [v10 modelNumber];
      *a5 = [v13 length];

      id v14 = [v10 modelNumber];
...
uint64_t sub_10000AC68(uint64_t a1, uint64_t a2, _DWORD *a3, unsigned int a4, _DWORD *a5)
{
...
uint64_t sub_10000BAE0(void *a1, void *a2)
{
  ...
  return uarpPlatformEndpointPayloadRequestAllHeadersAndMetaData((uint64_t)v5, (uint64_t)v6);
}

void sub_10000BB74(void *a1, uint64_t a2, void *a3)
{
  uarpLogDebug(3u, "%s: %s", "USBAudioAsset.m", "DfuOtpAssetAllHeadersAndMetaDataComplete");
  id v5 = a1;
  id v6 = a3;
  uint64_t SuperBinaryMetaData = uarpAssetQuerySuperBinaryMetaData((uint64_t)[v5 localEP], (uint64_t)objc_msgSend(v6, "pAsset"));
  if (SuperBinaryMetaData)
  {
    uint64_t v8 = SuperBinaryMetaData;
    do
    {
      uarpLogInfo(3u, "%s: Payload Metadata <0x%08x>", "DfuOtpAssetAllHeadersAndMetaDataComplete", *(_DWORD *)v8);
      uint64_t v8 = *(void *)(v8 + 16);
    }
    while (v8);
  }
  v21[0] = 0;
  if (!uarpPlatformEndpointAssetQueryNumberOfPayloads((uint64_t)[v5 localEP], (uint64_t)objc_msgSend(v6, "pAsset"), v21))
  {
    id v18 = [v5 activeFW];
    uint64_t v19 = v9;
    ...
    *((void *)&v20 + 1) = -1;
    if (v21[0])
    {
      ...
      while (1)
      {
        ...
        if (uarpAssetQueryPayloadInfo((uint64_t)[v5 localEP], (uint64_t)objc_msgSend(v6, "pAsset"), v10, (uint64_t)v17))break; {
        ...
        int v12 = uarpVersionCompare(&v18, (_DWORD *)v17 + 1);
        int v13 = uarpVersionCompare(&v20, (_DWORD *)v17 + 1);
        if (v12 == 1 && v13 == 2)
        {
          long long v20 = *(_OWORD *)((char *)v17 + 4);
          int v11 = v10;
        }
        uint64_t PayloadMetaData = uarpAssetQueryPayloadMetaData((uint64_t)[v5 localEP], (uint64_t)objc_msgSend(v6, "pAsset"), v10);
        if (PayloadMetaData)
        {
          uint64_t v15 = PayloadMetaData;
          do
          {
            uarpLogInfo(3u, "%s: Payload Metadata <0x%08x>, Length = %u", "DfuOtpAssetAllHeadersAndMetaDataComplete", *(_DWORD *)v15, *(_DWORD *)(v15 + 4));
        ...
        if (++v10 >= v21[0])
        {
          ...
          {
            memset(v17, 0, sizeof(v17));
            uarpAssetQueryPayloadInfo((uint64_t)[v5 localEP], (uint64_t)objc_msgSend(v6, "pAsset"), v11, (uint64_t)v17);
            ...
            [v6 setSelectedPayload:(unsigned __int16)v11];
            uarpPlatformEndpointAssetSetPayloadIndex([v5 localEP], (uint64_t)objc_msgSend(v6, "pAsset"), (int)objc_msgSend(v6, "selectedPayload"));
          }
          break;
        }
      }
...
void sub_10000BECC(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, int a5)
{
  uarpLogDebug(3u, "%s: %s", "USBAudioAsset.m", "DfuOtpPayloadData");
  id v9 = a2;
  uarpLogDebug(3u, "Payload Data <%u> Bytes %u@%u", [v9 selectedPayload], a4, a5);
  [v9 appendPayloadData:a3 length:a4];
}

void sub_10000BF78(void *a1, void *a2)
{
  uarpLogDebug(3u, "%s: %s", "USBAudioAsset.m", v10);
  id v4 = a1;
  id v5 = a2;
  memset(v13, 0, sizeof(v13));
  uarpAssetQueryPayloadInfo((uint64_t)[v4 localEP], (uint64_t)objc_msgSend(v5, "pAsset"), (int)objc_msgSend(v5, "selectedPayload"), (uint64_t)v13);
  ...
  if (v6)
  {
    ...
    {
      __chkstk_darwin();
      id v9 = (char *)&v11 - ((v8 + 15) & 0x1FFFFFFF0);
      int v12 = 0;
      ...
      if ([v4 sendBurnCommand:v9 length:(unsigned __int16)v7]) {
        break;
      }
      id v7 = [v5 getNextCommandLength];
      if (!v7) {
        goto LABEL_5;
      }
    }
    uarpLogError(3u, "%s: Error applying payload version: %x.%x.%x.%x", "DfuOtpPayloadDataComplete", DWORD1(v13[0]), DWORD2(v13[0]), HIDWORD(v13[0]), LODWORD(v13[1]));
    uarpPlatformEndpointAssetAbandon((uint64_t)[v4 localEP], (uint64_t)objc_msgSend(v4, "remoteEP"), (uint64_t)objc_msgSend(v5, "pAsset"), 2304);
  }
  else
  {
LABEL_5:
    [v5 setTransferCompleted:1];
    [v4 setStagedFW:*(_OWORD *)((char *)v13 + 4)];
    uarpPlatformEndpointAssetFullyStaged((uint64_t)[v4 localEP], (uint64_t)objc_msgSend(v5, "pAsset"));
  }
}
...
uint64_t uarpPlatformAssetResponseData(uint64_t a1, uint64_t a2, uint64_t a3, void *__src, int a5, int a6, size_t __n)
{
  ...
  *(_DWORD *)(a2 + 396) = v12;
  ...
  if (v13 == v14)
  {
    id v18 = *(uint64_t (**)(uint64_t, uint64_t, uint64_t))(a2 + 384);
...
uint64_t uarpPlatformAssetSuperBinaryPullHeader(uint64_t a1, uint64_t a2)
{
  ...
  if (a1 && a2)
  {
    ...
    else
    {
      ...
      *(void *)(a2 + 376) = sub_10000CA84;
      *(void *)(a2 + 384) = sub_10000CB90;
      return uarpPlatformAssetRequestData(a1, a2, a2 + 312);
    }
  }
  return result;
...
uint64_t sub_10000CA84(uint64_t a1, uint64_t a2, uint64_t a3)
{
    ...
    if (*(_DWORD *)(a2 + 32))
    {
      *(_DWORD *)(a2 + 688) = 0;
      ...
      else
      {
        ...
        *(void *)(a2 + 328) = *(void *)(a2 + 640);
        *(_DWORD *)(a2 + 336) = *(_DWORD *)(a2 + 648);
        *(void *)(a2 + 376) = sub_10000CC7C;
        *(void *)(a2 + 384) = sub_10000CD0C;
        return uarpPlatformAssetRequestData(a1, a2, a2 + 312);
      }
    }
    else
...
uint64_t sub_10000CD0C(uint64_t a1, uint64_t a2)
{
  return 0;
}
...
uint64_t uarpPlatformAssetSuperBinaryPullProposedPayloadHeader(uint64_t a1, uint64_t a2)
{
  ...
  if (a1 && a2 && *(_DWORD *)(a2 + 456) <= *(_DWORD *)(a2 + 448))
  {
    ...
    else
    {
      ...
      *(void *)(a2 + 328) = *(void *)(a2 + 640);
      *(_DWORD *)(a2 + 336) = *(_DWORD *)(a2 + 648);
      *(void *)(a2 + 376) = sub_10000CE04;
      *(void *)(a2 + 384) = sub_10000CE88;
      return uarpPlatformAssetRequestData(a1, a2, a2 + 312);
    }
  }
  return result;
...
uint64_t sub_10000CE04(uint64_t a1, uint64_t a2, uint64_t a3)
{
  UARPLayer2AssetStore(a1, a2);
...
uint64_t sub_10000CE88(uint64_t a1, uint64_t a2)
{
    ...
    else if (*(_DWORD *)(a2 + 492))
    {
      *(_DWORD *)(a2 + 512) = 0;
      ...
      else
      {
        ...
        *(void *)(a2 + 328) = *(void *)(a2 + 640);
        *(_DWORD *)(a2 + 336) = *(_DWORD *)(a2 + 648);
        *(void *)(a2 + 376) = sub_10000D048;
        *(void *)(a2 + 384) = sub_10000D0D8;
        return uarpPlatformAssetRequestData(a1, a2, a2 + 312);
      }
    }
    else
...
uint64_t sub_10000D048(uint64_t a1, uint64_t a2, uint64_t a3)
{
  UARPLayer2AssetStore(a1, a2);
...
uint64_t sub_10000D0D8(uint64_t a1, uint64_t a2)
{
  return 0;
}
...
uint64_t uarpPlatformAssetPayloadPullData(uint64_t a1, uint64_t a2)
{
  ...
  if (a1 && a2)
  {
    ...
    *(_DWORD *)(a2 + 336) = v7;
    *(_DWORD *)(a2 + 368) = v7;
    *(void *)(a2 + 376) = sub_10000D2C8;
    *(void *)(a2 + 384) = sub_10000D354;
...
uint64_t sub_10000D2C8(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_10000D354(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_10000D41C(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_10000D598(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (*(int *)(a2 + 448) < 1) {
    return 0;
  }
...
uint64_t uarpPlatformAssetPullAllMetaData(uint64_t a1, uint64_t a2)
{
  ...
  *(void *)(a2 + 672) = 0;
  if (!v5)
  {
    *(void *)(a2 + 328) = 0;
    *(_DWORD *)(a2 + 336) = 0;
    *(void *)(a2 + 376) = sub_10000D850;
    *(void *)(a2 + 384) = sub_10000D980;
LABEL_17:
...
uint64_t sub_10000D850(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_10000D980(uint64_t a1, uint64_t a2)
{
  return 0;
}
...
uint64_t UARPLayer2SendMessage(uint64_t a1, uint64_t a2, const void *a3, uint64_t a4)
{
  ...
  if (*(_WORD *)(a2 + 136))
  {
    ...
    uarpPlatformEndpointSendMessageComplete(a1, a2, a3);
    return 0;
  }
  else
  {
...
{
  return sub_10000FEDC(a1, a2, 1u);
}

uint64_t sub_10000FEDC(uint64_t a1, uint64_t a2, unsigned int a3)
{
  uint64_t result = 30;
  if (a1 && a2)
  {
...
{
  uint64_t result = &word_10002AC90;
  word_10002AC90 = 2492;
  byte_10002AC92 = 99;
  return result;
}
...
uint64_t uarpApplePlatformEndpointRecvMessage(uint64_t a1, uint64_t a2, unsigned __int8 *a3, int a4, unsigned int *a5, unsigned int a6)
{
  ...
  word_10002AC90 = 2492;
  byte_10002AC92 = 99;
  if (!uarpOuiCompare(a3, (unsigned __int8 *)&word_10002AC90)) {
    return 9;
  }
  if (a4 != 33)
  {
...
{
  aChdr[4] = 0;
  uint64_t result = &dword_10002AC94;
  dword_10002AC94 = *(_DWORD *)aChdr;
  return result;
}
...
{
  uint64_t result = &dword_10002AC98;
  dword_10002AC98 = 0;
  return result;
}
...
const char *uarpProcessingStatusToString(int a1)
{
  if ((a1 - 1) > 4) {
    ...
    return (&off_1000247D0)[(__int16)(a1 - 1)];
  }
}
...
long long *uarpStageStatusToString(unsigned __int16 a1)
{
  ...
  {
    case 1:
      strcpy((char *)xmmword_10002AC9C, "Upload Complete");
      return xmmword_10002AC9C;
    case 2:
      goto LABEL_7;
    case 3:
...
LABEL_7:
      ...
      snprintf((char *)xmmword_10002AC9C, 0x100uLL, "%s (%s)", v1, v2);
      return xmmword_10002AC9C;
  }
}
...
void uarpPrintDataResponseDetails(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, int a5, int a6, int a7)
{
  ...
  if (v12)
  {
    ...
    if (v14 > 2) {
      ...
      uint64_t v15 = (&off_100024840)[v14];
    }
  ...
  else
  {
    ...
    if (v23 > 2) {
      ...
      uint64_t v24 = (&off_100024840)[v23];
    }
    if (*(unsigned char *)(a3 + 80) == 1) {
      int v26 = "YES";
    }
...
{
  uint64_t v10 = sub_100013914(a1, a2, a4);
  if (v10) {
    goto LABEL_2;
  }
...
void *sub_100013914(uint64_t a1, uint64_t a2, unsigned int a3)
{
...
void uarpLogError(unsigned int a1, char *__format, ...)
{
  ...
  vsnprintf(byte_10002ADA0, 0x200uLL, __format, va);
  int v3 = sub_100013C40(a1);
  if (os_log_type_enabled(v3, OS_LOG_TYPE_ERROR)) {
    sub_10001938C(v3, v4, v5, v6, v7, v8, v9, v10);
  }
}

void *sub_100013C40(unsigned int a1)
{
  for (uint64_t i = 0; i != 9; ++i)
  {
    int v3 = uarpLoggingCategoryToString(i);
    qword_10002BDA0[i] = os_log_create("com.apple.uarp.embedded", v3);
  }
  if (a1 <= 8) {
    return (void *)qword_10002BDA0[a1];
  }
  else {
...
{
  va_start(va, __format);
  vsnprintf(byte_10002AFA0, 0x200uLL, __format, va);
  int v3 = sub_100013C40(a1);
...
{
  va_start(va, __format);
  vsnprintf(byte_10002B1A0, 0x200uLL, __format, va);
  int v3 = sub_100013C40(a1);
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315138;
    uint64_t v5 = byte_10002B1A0;
...
{
  va_start(va, __format);
  vsnprintf(byte_10002B3A0, 0x200uLL, __format, va);
  int v3 = sub_100013C40(a1);
  if (os_log_type_enabled(v3, OS_LOG_TYPE_ERROR)) {
    sub_100019488(v3, v4, v5, v6, v7, v8, v9, v10);
  }
}
...
{
  vsnprintf(byte_10002B5A0, 0x200uLL, a3, &a9);
  uint64_t v10 = sub_100013C40(a2);
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR)) {
    sub_100019500(v10, v11, v12, v13, v14, v15, v16, v17);
  }
}
...
{
  vsnprintf(byte_10002B7A0, 0x200uLL, a3, &a9);
  uint64_t v10 = sub_100013C40(a2);
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315138;
    uint64_t v12 = byte_10002B7A0;
...
{
  vsnprintf(byte_10002B9A0, 0x200uLL, a3, &a9);
  uint64_t v10 = sub_100013C40(a2);
...
{
  vsnprintf(byte_10002BBA0, 0x200uLL, a3, &a9);
  uint64_t v10 = sub_100013C40(a2);
...
uint64_t UARPSuperBinaryPrepareDynamicAsset(int a1, char *a2, uint64_t a3, uint64_t a4, int a5)
{
  ...
  *(_OWORD *)(a2 + 28) = xmmword_10001BA10;
  *((_DWORD *)a2 + 12) = a5;
  *((_DWORD *)a2 + 112) = 0;
  *((void *)a2 + 79) = 0;
  *((void *)a2 + 90) = 0;
...
void sub_100016F24(os_log_t log)
{
  int v1 = 136315138;
  uint64_t v2 = "-[USBDFUUpdater initWithVendorID:productID:serialNumber:dfuModeActive:simulator:]";
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "%s:", (uint8_t *)&v1, 0xCu);
}

void sub_100016FA8(unsigned __int8 *a1, NSObject *a2)
{
  int v2 = *a1;
  int v3 = 136315394;
  uint64_t v4 = "-[USBDFUUpdater dfuSetState:]";
  __int16 v5 = 1024;
  int v6 = v2;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "%s: Unexpected state [%x]", (uint8_t *)&v3, 0x12u);
}

void sub_100017038(int a1, NSObject *a2)
{
  int v2 = 136315394;
  int v3 = "-[USBDFUUpdater dfuSetState:]";
  __int16 v4 = 1024;
  int v5 = a1;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "%s: Error while getting current state [%x]", (uint8_t *)&v2, 0x12u);
}

void sub_1000170C4(os_log_t log)
{
  int v1 = 136315138;
  int v2 = "-[USBDFUUpdater setDfuMode]";
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "%s: Changing to DFU mode failed", (uint8_t *)&v1, 0xCu);
}

void sub_100017148(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000171C0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR, "UARPUpdaterService matching services", v0, 2u);
}

void sub_100017280(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000172F8(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017370(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000173E8(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017460(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000174D8(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017550(uint64_t a1, uint64_t *a2, os_log_t log)
{
  uint64_t v3 = *a2;
  int v4 = 138412546;
  uint64_t v5 = a1;
...
void sub_1000175DC(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017654(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000176CC(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017744(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000177BC(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017834(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000178AC(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017924(uint64_t a1, NSObject *a2)
{
  int v2 = 136315394;
  uint64_t v3 = "-[UARPUpdaterServiceDFU disabledProductIdentifiers:]";
  __int16 v4 = 2112;
  uint64_t v5 = a1;
  _os_log_debug_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_DEBUG, "%s: %@", (uint8_t *)&v2, 0x16u);
}

void sub_1000179B0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017A28(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017AA0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017B18(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017B90(void *a1, uint64_t a2, uint64_t a3)
{
  __int16 v4 = a1;
  int v5 = 136315650;
  __int16 v6 = "-[UARPUpdaterServiceDFU firmwareStagingComplete:withStatus:]";
  __int16 v7 = 2080;
  uint64_t v8 = UARPFirmwareStagingCompletionStatusToString();
  __int16 v9 = 2112;
  uint64_t v10 = a3;
  _os_log_debug_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEBUG, "%s: Status=%s, %@", (uint8_t *)&v5, 0x20u);
}

void sub_100017C58(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100017CD0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
{
  sub_100009910();
  sub_100009924((void *)&_mh_execute_header, v0, v1, "%s: Failed to create power assertion for %@", v2, v3, v4, v5, 2u);
}

void sub_100017DBC(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "Already holding power assertion for USBPD", v1, 2u);
}

void sub_100017E00(os_log_t log)
{
  int v1 = 136315138;
  uint64_t v2 = "-[UARPDFUUpdater releasePowerAssertionForAccessory]";
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "%s: Already released power assertion for USBDFU", (uint8_t *)&v1, 0xCu);
}

void sub_100017E84(os_log_t log)
{
  int v1 = 136315138;
  uint64_t v2 = "-[UARPDFUUpdater releasePowerAssertionForAccessory]";
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "%s: Failed to release power assertion for USBDFU", (uint8_t *)&v1, 0xCu);
}

void sub_100017F08()
{
  sub_100009910();
  sub_100009940((void *)&_mh_execute_header, v0, v1, "%s: properties %@", v2, v3, v4, v5, 2u);
}

void sub_100017F7C()
{
  sub_100009910();
  sub_100009924((void *)&_mh_execute_header, v0, v1, "%s: Unknown UARPAccessoryID %@", v2, v3, v4, v5, 2u);
}

void sub_100017FF0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100018068(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000180E0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100018158(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
{
  sub_100009910();
  sub_100009924((void *)&_mh_execute_header, v0, v1, "%s: Unknown UARPAccessoryID %@, dropping it", v2, v3, v4, v5, 2u);
}
...
void sub_100018244()
{
  ...
  __int16 v4 = v0;
  uint64_t v5 = v1;
  _os_log_debug_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEBUG, "%s: change asset location <%@> for <%@>", (uint8_t *)v3, 0x20u);
}

void sub_1000182D0(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
{
  sub_100009910();
  sub_100009940((void *)&_mh_execute_header, v0, v1, "%s: Matched %@", v2, v3, v4, v5, 2u);
}
...
{
  sub_100009910();
  sub_100009924((void *)&_mh_execute_header, v0, v1, "%s: Set reachable failed for accessory (%@)", v2, v3, v4, v5, 2u);
}

void sub_1000185A8()
{
  sub_100009910();
  sub_100009924((void *)&_mh_execute_header, v0, v1, "%s: Failed to add UARP accessory (%@)", v2, v3, v4, v5, 2u);
}

void sub_10001861C()
{
  sub_100009910();
  sub_100009924((void *)&_mh_execute_header, v0, v1, "%s: Unknown UARPAccessory %@, dropping it", v2, v3, v4, v5, 2u);
}
...
void sub_100018C00(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}
...
void sub_100018C78()
{
  v1[0] = 136315394;
  sub_100009910();
  _os_log_error_impl((void *)&_mh_execute_header, v0, OS_LOG_TYPE_ERROR, "%s: Unexpected hardwareID transport type for %@.", (uint8_t *)v1, 0x16u);
}
...
void sub_100018D78(os_log_t log)
{
  int v1 = 136315138;
  uint64_t v2 = "-[UARPUSBDFUAccessory initWithIdentifier:serialNumber:fwVersion:]";
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "%s:", (uint8_t *)&v1, 0xCu);
}

void sub_100018DFC(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100018E74(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100018EEC(uint64_t a1, int a2, os_log_t log)
{
  v3[0] = 67109378;
  v3[1] = a2;
  __int16 v4 = 2112;
  uint64_t v5 = a1;
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "Error %d recv uarp message %@", (uint8_t *)v3, 0x12u);
}

void sub_100018F74(os_log_t log)
{
  int v1 = 136315394;
  uint64_t v2 = "UARPUSBDFUAccessory.m";
  __int16 v3 = 2080;
  __int16 v4 = "-[UARPUSBDFUAccessory recvMessage:]";
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "%s: %s", (uint8_t *)&v1, 0x16u);
}

void sub_10001900C(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100019084(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_1000190FC(os_log_t log)
{
  int v1 = 136315394;
  uint64_t v2 = "-[UARPUSBDFUAccessory sendBurnCommand:length:]";
  __int16 v3 = 1024;
  int v4 = 0;
  _os_log_error_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_ERROR, "%s: Something went wrong while completing BASH command [%x]", (uint8_t *)&v1, 0x12u);
}

void sub_10001918C(int a1, NSObject *a2)
{
  int v2 = 136315394;
  __int16 v3 = "-[UARPUSBDFUAccessory sendBurnCommand:length:]";
  __int16 v4 = 1024;
  int v5 = a1;
  _os_log_error_impl((void *)&_mh_execute_header, a2, OS_LOG_TYPE_ERROR, "%s: Something went wrong while sending BASH command data [%x]", (uint8_t *)&v2, 0x12u);
}

void sub_100019218(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100019290(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100019308(os_log_t log)
{
  int v1 = 136315138;
  int v2 = "-[USBAudioAsset initWithUarpAsset:nextAsset:]";
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "%s:", (uint8_t *)&v1, 0xCu);
}

void sub_10001938C(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100019404(os_log_t log)
{
  int v1 = 136315138;
  int v2 = &unk_10002AFA0;
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "%s\n", (uint8_t *)&v1, 0xCu);
}

void sub_100019488(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100019500(NSObject *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
}

void sub_100019578(os_log_t log)
{
  int v1 = 136315138;
  int v2 = &unk_10002B9A0;
  _os_log_debug_impl((void *)&_mh_execute_header, log, OS_LOG_TYPE_DEBUG, "%s\n", (uint8_t *)&v1, 0xCu);
}

void sub_1000195FC(os_log_t log)
{
  int v1 = 136315138;
  int v2 = &unk_10002BBA0;
...
id objc_msgSend_activeFW(void *a1, const char *a2, ...)
{
  return [a1 activeFW];
}
...
id objc_msgSend_applyFirmware(void *a1, const char *a2, ...)
{
  return [a1 applyFirmware];
}
...
id objc_msgSend_closeDfuDevice(void *a1, const char *a2, ...)
{
  return [a1 closeDfuDevice];
}
...
id objc_msgSend_dfuDetachToAppCmd(void *a1, const char *a2, ...)
{
  return [a1 dfuDetachToAppCmd];
}

id objc_msgSend_dfuMode(void *a1, const char *a2, ...)
{
  return [a1 dfuMode];
}

id objc_msgSend_dfuModeActive(void *a1, const char *a2, ...)
{
  return [a1 dfuModeActive];
}

id objc_msgSend_disableDisconnectCallback(void *a1, const char *a2, ...)
{
  return [a1 disableDisconnectCallback];
}

id objc_msgSend_disconnectUarpController(void *a1, const char *a2, ...)
{
  return [a1 disconnectUarpController];
}
...
id objc_msgSend_getNextCommandLength(void *a1, const char *a2, ...)
{
  return [a1 getNextCommandLength];
}
...
id objc_msgSend_hvciAppDetachToDfuCmd(void *a1, const char *a2, ...)
{
  return [a1 hvciAppDetachToDfuCmd];
}
...
id objc_msgSend_initCurrentState(void *a1, const char *a2, ...)
{
  return [a1 initCurrentState];
}

id objc_msgSend_isSimulator(void *a1, const char *a2, ...)
{
  return [a1 isSimulator];
}
...
id objc_msgSend_localEP(void *a1, const char *a2, ...)
{
  return [a1 localEP];
}
...
id objc_msgSend_openDfuDevice(void *a1, const char *a2, ...)
{
  return [a1 openDfuDevice];
}

id objc_msgSend_pAsset(void *a1, const char *a2, ...)
{
  return [a1 pAsset];
}

id objc_msgSend_pRxSuperBinaries(void *a1, const char *a2, ...)
{
  return [a1 pRxSuperBinaries];
}
...
id objc_msgSend_remoteEP(void *a1, const char *a2, ...)
{
  return [a1 remoteEP];
}
...
id objc_msgSend_selectedPayload(void *a1, const char *a2, ...)
{
...
id objc_msgSend_setDfuMode(void *a1, const char *a2, ...)
{
  return [a1 setDfuMode];
}
...
id objc_msgSend_stagedFW(void *a1, const char *a2, ...)
{
  return [a1 stagedFW];
}
...
id objc_msgSend_supportedIdentifiers(void *a1, const char *a2, ...)
{
  return [a1 supportedIdentifiers];
}
...
id objc_msgSend_waitForQueriesCompletion_(void *a1, const char *a2, ...)
{
  return objc_msgSend(a1, "waitForQueriesCompletion:");
}