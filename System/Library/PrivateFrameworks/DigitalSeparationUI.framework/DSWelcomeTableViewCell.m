...
- (void)customizeProperties
{
  ...
  objc_super v7 = [(DSWelcomeTableViewCell *)self textLabel];
  v8 = [MEMORY[0x263F81708] preferredFontForTextStyle:*MEMORY[0x263F835D0]];
  [v7 setFont:v8];

  v9 = [(DSWelcomeTableViewCell *)self detailTextLabel];
  v10 = [MEMORY[0x263F81708] preferredFontForTextStyle:*MEMORY[0x263F83580]];
  [v9 setFont:v10];
  ...
  v16 = [MEMORY[0x263F825C8] tertiarySystemFillColor];
  [(DSWelcomeTableViewCell *)self setBackgroundColor:v16];

  id v17 = [(DSWelcomeTableViewCell *)self imageView];
...
- (void)constrainImageViews
{
  ...
  v6 = [v5 widthAnchor];
  objc_super v7 = [v6 constraintEqualToConstant:40.0];
  [v4 addObject:v7];
  ...
  id v23 = [(DSWelcomeTableViewCell *)self constraints];
...
- (void)constrainTextLabels
{
  ...
  v5 = [(DSWelcomeTableViewCell *)self textLabel];
  v6 = [v5 topAnchor];
  objc_super v7 = [(DSWelcomeTableViewCell *)self contentView];
  ...
  id v17 = [(DSWelcomeTableViewCell *)self constraints];
  ...
  id v23 = [(DSWelcomeTableViewCell *)self detailTextLabel];
  ...
  id v41 = [(DSWelcomeTableViewCell *)self constraints];
