...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPCodeFunctionInvokeRequestAttestationRequest;
...
- (id)dictionaryRepresentation
{
  ...
  if (entropy) {
    objc_msgSend_setObject_forKey_(v4, v5, (uint64_t)entropy, @"entropy");
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4D91E00((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v12 = objc_msgSend_copyWithZone_(self->_entropy, v11, (uint64_t)a3);
  v13 = (void *)v10[1];
  v10[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    ...
    if ((unint64_t)entropy | v9) {
      char isEqual = objc_msgSend_isEqual_(entropy, v7, v9);
    }
    else {
      char isEqual = 1;
    }
