...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKCDPErrorUserInfoEntry;
...
- (id)dictionaryRepresentation
{
  ...
  if (value)
  {
    v9 = objc_msgSend_dictionaryRepresentation(value, v5, (uint64_t)key);
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4F4553C((uint64_t)self, (uint64_t)a3);
}
