...
- (void)clearBundleIDs
{
  objc_msgSend_removeAllObjects(self->_bundleIDs, a2, v2);
}
...
- (void)addBundleID:(id)a3
{
  ...
  objc_msgSend_addObject_(bundleIDs, v4, (uint64_t)v4);
}

- (unint64_t)bundleIDsCount
{
  return objc_msgSend_count(self->_bundleIDs, a2, v2);
}

- (id)bundleIDAtIndex:(unint64_t)a3
{
  return (id)objc_msgSend_objectAtIndex_(self->_bundleIDs, a2, a3);
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPBundlesForContainerResponse;
...
- (id)dictionaryRepresentation
{
  ...
  bundleIDs = self->_bundleIDs;
  if (bundleIDs) {
    objc_msgSend_setObject_forKey_(v4, v5, (uint64_t)bundleIDs, @"bundleID");
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4E6D894(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend_clearBundleIDs(v16, v6, v7);
    uint64_t v10 = objc_msgSend_bundleIDsCount(self, v8, v9);
    if (v10)
    {
      uint64_t v12 = v10;
      for (uint64_t i = 0; i != v12; ++i)
      {
        long long v14 = objc_msgSend_bundleIDAtIndex_(self, v11, i);
        objc_msgSend_addBundleID_(v16, v15, (uint64_t)v14);
      }
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v23 = 0u;
  long long v24 = 0u;
  objc_super v11 = self->_bundleIDs;
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addBundleID_(v10, v19, (uint64_t)v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    bundleIDs = self->_bundleIDs;
    uint64_t v9 = v4[1];
    if ((unint64_t)bundleIDs | v9) {
      char isEqual = objc_msgSend_isEqual_(bundleIDs, v7, v9);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  return objc_msgSend_hash(self->_bundleIDs, a2, v2);
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addBundleID_(self, v7, *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
