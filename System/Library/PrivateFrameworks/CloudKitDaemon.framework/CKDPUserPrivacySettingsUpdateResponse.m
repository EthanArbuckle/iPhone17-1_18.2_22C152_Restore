@interface CKDPUserPrivacySettingsUpdateResponse
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation CKDPUserPrivacySettingsUpdateResponse

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPUserPrivacySettingsUpdateResponse;
  v4 = [(CKDPUserPrivacySettingsUpdateResponse *)&v11 description];
