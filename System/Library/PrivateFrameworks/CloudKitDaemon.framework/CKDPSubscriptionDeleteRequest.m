...
@implementation CKDPSubscriptionDeleteRequest

+ (id)options
{
  if (qword_1EBBD0020 != -1) {
    dispatch_once(&qword_1EBBD0020, &unk_1F20446F0);
  }
  v2 = (void *)qword_1EBBD0018;
  return v2;
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPSubscriptionDeleteRequest;
  v4 = [(CKDPSubscriptionDeleteRequest *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4FB165C((uint64_t)self, (uint64_t)a3);
}
