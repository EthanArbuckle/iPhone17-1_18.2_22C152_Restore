...
- (id)attestationsAtIndex:(unint64_t)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)description;
- (id)dictionaryRepresentation;
- (unint64_t)attestationsCount;
- (unint64_t)hash;
- (void)addAttestations:(id)a3;
...
@implementation CKCDPCodeServiceResponseAttestationResponse

- (void)clearAttestations
{
  objc_msgSend_removeAllObjects(self->_attestations, a2, v2);
}
...
- (void)addAttestations:(id)a3
{
  ...
  objc_msgSend_addObject_(attestations, v4, (uint64_t)v4);
}

- (unint64_t)attestationsCount
{
  return objc_msgSend_count(self->_attestations, a2, v2);
}

- (id)attestationsAtIndex:(unint64_t)a3
{
  return (id)objc_msgSend_objectAtIndex_(self->_attestations, a2, a3);
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKCDPCodeServiceResponseAttestationResponse;
  v4 = [(CKCDPCodeServiceResponseAttestationResponse *)&v11 description];
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_attestations, v5, v6))
  {
    ...
    uint64_t v10 = objc_msgSend_count(self->_attestations, v8, v9);
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, @"attestations");
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4F6C254(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend_clearAttestations(v16, v6, v7);
    uint64_t v10 = objc_msgSend_attestationsCount(self, v8, v9);
    if (v10)
    {
      uint64_t v12 = v10;
      for (uint64_t i = 0; i != v12; ++i)
      {
        long long v14 = objc_msgSend_attestationsAtIndex_(self, v11, i);
        objc_msgSend_addAttestations_(v16, v15, (uint64_t)v14);
      }
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v23 = 0u;
  long long v24 = 0u;
  objc_super v11 = self->_attestations;
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addAttestations_(v10, v19, (uint64_t)v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    attestations = self->_attestations;
    uint64_t v9 = v4[1];
    if ((unint64_t)attestations | v9) {
      char isEqual = objc_msgSend_isEqual_(attestations, v7, v9);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  return objc_msgSend_hash(self->_attestations, a2, v2);
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addAttestations_(self, v7, *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
