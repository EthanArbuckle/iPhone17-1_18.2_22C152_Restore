...
- (id)description
{
  ...
  v4 = [(CKDPSubscriptionRetrieveResponse *)&v11 description];
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_subscriptions, v5, v6))
  {
    ...
    uint64_t v10 = objc_msgSend_count(self->_subscriptions, v8, v9);
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, @"subscriptions");
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4EC2D20(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_subscriptionsCount(self, v4, v5))
  {
    ...
    uint64_t v10 = objc_msgSend_subscriptionsCount(self, v8, v9);
    if (v10)
    {
      uint64_t v12 = v10;
      for (uint64_t i = 0; i != v12; ++i)
      {
        long long v14 = objc_msgSend_subscriptionsAtIndex_(self, v11, i);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v23 = 0u;
  long long v24 = 0u;
  objc_super v11 = self->_subscriptions;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    ...
    if ((unint64_t)subscriptions | v9) {
      char isEqual = objc_msgSend_isEqual_(subscriptions, v7, v9);
    }
    else {
      char isEqual = 1;
    }
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addSubscriptions_(self, v7, *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
