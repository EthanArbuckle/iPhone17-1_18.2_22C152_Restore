...
@implementation CKDPUserPrivacySettingsResetResponse

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPUserPrivacySettingsResetResponse;
  v4 = [(CKDPUserPrivacySettingsResetResponse *)&v11 description];
