...
- (id)idsToArchiveAtIndex:(unint64_t)a3;
- (unint64_t)hash;
- (unint64_t)idsToArchivesCount;
- (unsigned)requestTypeCode;
- (void)addIdsToArchive:(id)a3;
- (void)clearIdsToArchives;
- (void)copyTo:(id)a3;
- (void)mergeFrom:(id)a3;
- (void)setIdsToArchives:(id)a3;
- (void)writeTo:(id)a3;
@end
...
+ (id)options
{
  if (qword_1EBBCFBB8 != -1) {
    dispatch_once(&qword_1EBBCFBB8, &unk_1F2042C10);
  }
  v2 = (void *)qword_1EBBCFBB0;
  return v2;
}

- (void)clearIdsToArchives
{
  objc_msgSend_removeAllObjects(self->_idsToArchives, a2, v2);
}
...
- (void)addIdsToArchive:(id)a3
{
  ...
  objc_msgSend_addObject_(idsToArchives, v4, (uint64_t)v4);
}

- (unint64_t)idsToArchivesCount
{
  return objc_msgSend_count(self->_idsToArchives, a2, v2);
}

- (id)idsToArchiveAtIndex:(unint64_t)a3
{
  return (id)objc_msgSend_objectAtIndex_(self->_idsToArchives, a2, a3);
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPArchiveRecordsRequest;
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_idsToArchives, v5, v6))
  {
    ...
    uint64_t v10 = objc_msgSend_count(self->_idsToArchives, v8, v9);
    ...
    objc_msgSend_setObject_forKey_(v4, v23, (uint64_t)v12, @"idsToArchive");
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4D81AF0(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    objc_msgSend_clearIdsToArchives(v16, v6, v7);
    uint64_t v10 = objc_msgSend_idsToArchivesCount(self, v8, v9);
    if (v10)
    {
      uint64_t v12 = v10;
      for (uint64_t i = 0; i != v12; ++i)
      {
        long long v14 = objc_msgSend_idsToArchiveAtIndex_(self, v11, i);
        objc_msgSend_addIdsToArchive_(v16, v15, (uint64_t)v14);
      }
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v23 = 0u;
  long long v24 = 0u;
  objc_super v11 = self->_idsToArchives;
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addIdsToArchive_(v10, v19, (uint64_t)v18);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    idsToArchives = self->_idsToArchives;
    uint64_t v9 = v4[1];
    if ((unint64_t)idsToArchives | v9) {
      char isEqual = objc_msgSend_isEqual_(idsToArchives, v7, v9);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  return objc_msgSend_hash(self->_idsToArchives, a2, v2);
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addIdsToArchive_(self, v7, *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
