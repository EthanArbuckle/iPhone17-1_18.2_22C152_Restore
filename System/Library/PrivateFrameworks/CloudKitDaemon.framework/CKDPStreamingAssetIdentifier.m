...
- (id)dictionaryRepresentation
{
  ...
  if (fileSignature) {
    objc_msgSend_setObject_forKey_(v6, v5, (uint64_t)fileSignature, @"fileSignature");
  }
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4DC5AE0((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v15 = objc_msgSend_copyWithZone_(self->_fileSignature, v14, (uint64_t)a3);
  v16 = (void *)v10[1];
  v10[1] = v15;

  uint64_t v18 = objc_msgSend_copyWithZone_(self->_referenceSignature, v17, (uint64_t)a3);
  v19 = (void *)v10[3];
  v10[3] = v18;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((owner = self->_owner, uint64_t v9 = v4[2], !((unint64_t)owner | v9))
     || objc_msgSend_isEqual_(owner, v7, v9))
    && ((fileSignature = self->_fileSignature, uint64_t v11 = v4[1], !((unint64_t)fileSignature | v11))
     || objc_msgSend_isEqual_(fileSignature, v7, v11)))
  {
    referenceSignature = self->_referenceSignature;
    uint64_t v13 = v4[3];
    if ((unint64_t)referenceSignature | v13) {
      char isEqual = objc_msgSend_isEqual_(referenceSignature, v7, v13);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  uint64_t v4 = objc_msgSend_hash(self->_owner, a2, v2);
  uint64_t v7 = objc_msgSend_hash(self->_fileSignature, v5, v6) ^ v4;
