...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPUserRetrieveResponse;
...
- (id)dictionaryRepresentation
{
  ...
  if (user)
  {
    ...
    objc_msgSend_setObject_forKey_(v6, v9, (uint64_t)v8, @"user");
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C50167BC((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v12 = objc_msgSend_copyWithZone_(self->_user, v11, (uint64_t)a3);
  v13 = (void *)v10[1];
  v10[1] = v12;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    ...
    if ((unint64_t)user | v9) {
      char isEqual = objc_msgSend_isEqual_(user, v7, v9);
    }
    else {
      char isEqual = 1;
    }
