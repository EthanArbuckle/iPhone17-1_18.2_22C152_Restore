...
@implementation CKDPSubscriptionRetrieveRequest

+ (id)options
{
  if (qword_1EBBCFF20 != -1) {
    dispatch_once(&qword_1EBBCFF20, &unk_1F2043E50);
  }
  v2 = (void *)qword_1EBBCFF18;
  return v2;
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPSubscriptionRetrieveRequest;
  v4 = [(CKDPSubscriptionRetrieveRequest *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4EE711C((uint64_t)self, (uint64_t)a3);
}
