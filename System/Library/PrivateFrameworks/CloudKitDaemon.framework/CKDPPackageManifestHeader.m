...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPPackageManifestHeader;
...
- (id)dictionaryRepresentation
{
  ...
  if (verificationKey) {
    objc_msgSend_setObject_forKey_(v5, v4, (uint64_t)verificationKey, @"verificationKey");
  }
  return v5;
}
...
- (void)copyTo:(id)a3
{
  ...
  if (verificationKey)
  {
    objc_msgSend_setVerificationKey_(v8, v5, (uint64_t)verificationKey);
    id v4 = v8;
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v16 = objc_msgSend_copyWithZone_(self->_verificationKey, v15, (uint64_t)a3);
  v17 = (void *)v12[2];
  v12[2] = v16;
...
LABEL_11:
  ...
  verificationKey = self->_verificationKey;
  uint64_t v11 = v4[2];
  if ((unint64_t)verificationKey | v11) {
    char isEqual = objc_msgSend_isEqual_(verificationKey, v7, v11);
  }
  else {
    char isEqual = 1;
  }
