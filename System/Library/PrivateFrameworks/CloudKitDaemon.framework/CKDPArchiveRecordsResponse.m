@interface CKDPArchiveRecordsResponse
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation CKDPArchiveRecordsResponse

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPArchiveRecordsResponse;
  v4 = [(CKDPArchiveRecordsResponse *)&v11 description];
