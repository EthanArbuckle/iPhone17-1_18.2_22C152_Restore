...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPRealTimeMessageDeleteRecordID;
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4DF1124((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  recordIdentifier = self->_recordIdentifier;
  if (recordIdentifier) {
    objc_msgSend_setRecordIdentifier_(a3, a2, (uint64_t)recordIdentifier);
  }
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5))
  {
    ...
    if ((unint64_t)recordIdentifier | v9) {
      char isEqual = objc_msgSend_isEqual_(recordIdentifier, v7, v9);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  return objc_msgSend_hash(self->_recordIdentifier, a2, v2);
}
