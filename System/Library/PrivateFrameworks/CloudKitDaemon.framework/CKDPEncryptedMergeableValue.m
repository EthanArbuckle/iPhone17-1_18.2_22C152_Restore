...
@implementation CKDPEncryptedMergeableValue
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPEncryptedMergeableValue;
  v4 = [(CKDPEncryptedMergeableValue *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return CKDPEncryptedMergeableValueReadFrom((uint64_t)self, (uint64_t)a3);
}
