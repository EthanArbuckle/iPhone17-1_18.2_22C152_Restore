...
@implementation CKDPZonePermittedCryptoFeatureSet
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPZonePermittedCryptoFeatureSet;
  v4 = [(CKDPZonePermittedCryptoFeatureSet *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4E7EFF8((uint64_t)self, (uint64_t)a3);
}
