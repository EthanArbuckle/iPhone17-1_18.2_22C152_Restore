...
@implementation CKDPAdopterCapabilitiesSaveResponse

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPAdopterCapabilitiesSaveResponse;
  v4 = [(CKDPAdopterCapabilitiesSaveResponse *)&v11 description];
