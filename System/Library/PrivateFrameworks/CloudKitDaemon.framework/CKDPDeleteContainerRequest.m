...
@implementation CKDPDeleteContainerRequest

+ (id)options
{
  if (qword_1EBBCFF70 != -1) {
    dispatch_once(&qword_1EBBCFF70, &unk_1F20442B0);
  }
  v2 = (void *)qword_1EBBCFF68;
  return v2;
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPDeleteContainerRequest;
  v4 = [(CKDPDeleteContainerRequest *)&v11 description];
