...
- (id)dictionaryRepresentation
{
  ...
  if (adopterCapabilities) {
    objc_msgSend_setObject_forKey_(v5, v4, (uint64_t)adopterCapabilities, @"adopterCapabilities");
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v16 = objc_msgSend_copyWithZone_(self->_adopterCapabilities, v15, (uint64_t)a3);
  v17 = (void *)v12[1];
  v12[1] = v16;
...
LABEL_11:
  ...
  if ((unint64_t)adopterCapabilities | v11) {
    char isEqual = objc_msgSend_isEqual_(adopterCapabilities, v7, v11);
  }
  else {
    char isEqual = 1;
  }
