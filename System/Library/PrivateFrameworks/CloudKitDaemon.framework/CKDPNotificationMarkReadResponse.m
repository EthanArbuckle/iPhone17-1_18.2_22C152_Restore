...
@implementation CKDPNotificationMarkReadResponse

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPNotificationMarkReadResponse;
  v4 = [(CKDPNotificationMarkReadResponse *)&v11 description];
