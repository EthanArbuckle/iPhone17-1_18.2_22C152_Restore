...
@implementation CKDPCodeFunctionInvokeRequestProtectedCloudComputeMetadata
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPCodeFunctionInvokeRequestProtectedCloudComputeMetadata;
  v4 = [(CKDPCodeFunctionInvokeRequestProtectedCloudComputeMetadata *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4E848F8(self, (uint64_t)a3);
}
