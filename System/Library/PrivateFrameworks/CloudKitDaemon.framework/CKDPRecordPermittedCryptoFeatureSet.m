...
@implementation CKDPRecordPermittedCryptoFeatureSet
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPRecordPermittedCryptoFeatureSet;
  v4 = [(CKDPRecordPermittedCryptoFeatureSet *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4E5F44C((uint64_t)self, (uint64_t)a3);
}
