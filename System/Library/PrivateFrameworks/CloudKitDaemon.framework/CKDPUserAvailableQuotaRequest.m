...
@implementation CKDPUserAvailableQuotaRequest

+ (id)options
{
  if (qword_1EBBCFFB0 != -1) {
    dispatch_once(&qword_1EBBCFFB0, &unk_1F20443F0);
  }
  v2 = (void *)qword_1EBBCFFA8;
  return v2;
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPUserAvailableQuotaRequest;
  v4 = [(CKDPUserAvailableQuotaRequest *)&v11 description];
