...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_uploadTokens, v5, v6))
  {
    ...
    uint64_t v11 = objc_msgSend_count(self->_uploadTokens, v9, v10);
    ...
    objc_msgSend_setObject_forKey_(v4, v24, (uint64_t)v13, @"uploadTokens");
  }
  authPutResponse = self->_authPutResponse;
  if (authPutResponse) {
    objc_msgSend_setObject_forKey_(v4, v7, (uint64_t)authPutResponse, @"authPutResponse");
  }
  if (objc_msgSend_count(self->_contentResponseHeaders, v7, (uint64_t)authPutResponse))
  {
    id v26 = objc_alloc(MEMORY[0x1E4F1CA48]);
    uint64_t v29 = objc_msgSend_count(self->_contentResponseHeaders, v27, v28);
    ...
    objc_msgSend_setObject_forKey_(v4, v42, (uint64_t)v31, @"contentResponseHeaders");
  }
  return v4;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4FF25D0(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_uploadTokensCount(self, v4, v5))
  {
    ...
    uint64_t v10 = objc_msgSend_uploadTokensCount(self, v8, v9);
    if (v10)
    {
      uint64_t v11 = v10;
  ...
  if (objc_msgSend_contentResponseHeadersCount(self, v6, (uint64_t)authPutResponse))
  {
    ...
    uint64_t v20 = objc_msgSend_contentResponseHeadersCount(self, v18, v19);
    if (v20)
    {
      uint64_t v22 = v20;
      for (uint64_t j = 0; j != v22; ++j)
      {
        long long v24 = objc_msgSend_contentResponseHeadersAtIndex_(self, v21, j);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v39 = 0u;
  long long v40 = 0u;
  uint64_t v11 = self->_uploadTokens;
  ...
  uint64_t v21 = objc_msgSend_copyWithZone_(self->_authPutResponse, v20, (uint64_t)a3);
  ...
  long long v33 = 0u;
  long long v34 = 0u;
  long long v23 = self->_contentResponseHeaders;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((uploadTokens = self->_uploadTokens, uint64_t v9 = v4[3], !((unint64_t)uploadTokens | v9))
     || objc_msgSend_isEqual_(uploadTokens, v7, v9))
    && ((authPutResponse = self->_authPutResponse, uint64_t v11 = v4[1], !((unint64_t)authPutResponse | v11))
     || objc_msgSend_isEqual_(authPutResponse, v7, v11)))
  {
    contentResponseHeaders = self->_contentResponseHeaders;
    uint64_t v13 = v4[2];
    if ((unint64_t)contentResponseHeaders | v13) {
      char isEqual = objc_msgSend_isEqual_(contentResponseHeaders, v7, v13);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  uint64_t v4 = objc_msgSend_hash(self->_uploadTokens, a2, v2);
  uint64_t v7 = objc_msgSend_hash(self->_authPutResponse, v5, v6) ^ v4;
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        objc_msgSend_addUploadTokens_(self, v8, *(void *)(*((void *)&v25 + 1) + 8 * i));
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v18; ++j)
      {
        ...
        objc_msgSend_addContentResponseHeaders_(self, v17, *(void *)(*((void *)&v21 + 1) + 8 * j), (void)v21);
      }
