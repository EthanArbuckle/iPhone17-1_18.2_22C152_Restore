...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptions;
...
- (BOOL)readFrom:(id)a3
{
  return CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsReadFrom((uint64_t)self, (uint64_t)a3);
}
