...
- (NSMutableDictionary)encryptedAnonymousShareHashToAddByRequestID;
...
- (void)setEncryptedAnonymousShareHashToAddByRequestID:(id)a3;
...
- (CKDAnonymousShareAddURLRequest)initWithOperation:(id)a3 encryptedAnonymousSharesToAdd:(id)a4
{
  id v7 = a4;
  v13.receiver = self;
  v13.super_class = (Class)CKDAnonymousShareAddURLRequest;
  v8 = [(CKDURLRequest *)&v13 initWithOperation:a3];
  v9 = v8;
  if (v8)
  {
    objc_storeStrong((id *)&v8->_encryptedAnonymousSharesToAdd, a4);
    uint64_t v10 = objc_opt_new();
    encryptedAnonymousShareHashToAddByRequestID = v9->_encryptedAnonymousShareHashToAddByRequestID;
    v9->_encryptedAnonymousShareHashToAddByRequestID = (NSMutableDictionary *)v10;
  }
  return v9;
}
...
{
  v15.receiver = self;
  v15.super_class = (Class)CKDAnonymousShareAddURLRequest;
  id v4 = a3;
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        v20 = objc_opt_new();
        objc_msgSend_setAnonymousShareAddRequest_(v19, v21, (uint64_t)v20);
...
{
  id v4 = a3;
  uint64_t v7 = objc_msgSend_encryptedAnonymousShareHashToAddByRequestID(self, v5, v6);
  ...
  if (v18)
  {
    objc_msgSend_anonymousShareSavedBlock(self, v19, v20);
...
- (NSMutableDictionary)encryptedAnonymousShareHashToAddByRequestID
{
  return self->_encryptedAnonymousShareHashToAddByRequestID;
}
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_encryptedAnonymousShareHashToAddByRequestID, 0);
