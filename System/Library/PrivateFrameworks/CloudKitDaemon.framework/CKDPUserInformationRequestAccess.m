...
@implementation CKDPUserInformationRequestAccess
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPUserInformationRequestAccess;
  v4 = [(CKDPUserInformationRequestAccess *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return CKDPUserInformationRequestAccessReadFrom((uint64_t)self, (uint64_t)a3);
}
