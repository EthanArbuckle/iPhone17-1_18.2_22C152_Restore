...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_deltas, v5, v6))
  {
    ...
    uint64_t v11 = objc_msgSend_count(self->_deltas, v9, v10);
    ...
    objc_msgSend_setObject_forKey_(v4, v24, (uint64_t)v13, @"deltas");
  }
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4FD66A0(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (objc_msgSend_deltasCount(self, v4, v5))
  {
    ...
    uint64_t v10 = objc_msgSend_deltasCount(self, v8, v9);
    if (v10)
    {
      uint64_t v11 = v10;
      for (uint64_t i = 0; i != v11; ++i)
      {
        long long v13 = objc_msgSend_deltasAtIndex_(self, v6, i);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((deltas = self->_deltas, uint64_t v9 = v4[2], !((unint64_t)deltas | v9))
...
- (unint64_t)hash
{
  uint64_t v4 = objc_msgSend_hash(self->_deltas, a2, v2);
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        objc_msgSend_addDeltas_(self, v8, *(void *)(*((void *)&v14 + 1) + 8 * i), (void)v14);
      }
