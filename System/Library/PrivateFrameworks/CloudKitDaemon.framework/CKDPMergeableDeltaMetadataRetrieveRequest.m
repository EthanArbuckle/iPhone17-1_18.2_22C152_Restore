...
+ (id)options
{
  if (qword_1EBBCDEC0 != -1) {
    dispatch_once(&qword_1EBBCDEC0, &unk_1F2044350);
  }
  v2 = (void *)qword_1EBBCDEB8;
  return v2;
}
...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPMergeableDeltaMetadataRetrieveRequest;
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4F4367C((uint64_t)self, (uint64_t)a3);
}
