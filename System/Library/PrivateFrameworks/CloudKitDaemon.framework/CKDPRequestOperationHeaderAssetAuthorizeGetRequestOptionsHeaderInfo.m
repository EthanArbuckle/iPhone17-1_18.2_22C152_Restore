...
@implementation CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo;
  v4 = [(CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo *)&v11 description];
...
- (BOOL)readFrom:(id)a3
{
  return CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfoReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)writeTo:(id)a3
{
  id v4 = a3;
  if (!self->_headerKey) {
    __assert_rtn("-[CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo writeTo:]", "CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo.m", 83, "nil != self->_headerKey");
  }
  id v5 = v4;
  PBDataWriterWriteStringField();
  if (!self->_headerValue) {
    __assert_rtn("-[CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo writeTo:]", "CKDPRequestOperationHeaderAssetAuthorizeGetRequestOptionsHeaderInfo.m", 88, "nil != self->_headerValue");
  }
  PBDataWriterWriteStringField();
}
