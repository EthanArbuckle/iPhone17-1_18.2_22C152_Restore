...
+ (id)options
{
  if (qword_1EBBCDD90 != -1) {
    dispatch_once(&qword_1EBBCDD90, &unk_1F2043470);
  }
  v2 = (void *)qword_1EBBCDD88;
  return v2;
}
...
- (id)dictionaryRepresentation
{
  ...
  if (protectionInfo)
  {
    v12 = objc_msgSend_dictionaryRepresentation(protectionInfo, v4, (uint64_t)participantId);
    objc_msgSend_setObject_forKey_(v6, v13, (uint64_t)v12, @"protectionInfo");
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4E36ECC((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v15 = objc_msgSend_copyWithZone_(self->_participantId, v14, (uint64_t)a3);
  v16 = (void *)v10[1];
  v10[1] = v15;

  uint64_t v18 = objc_msgSend_copyWithZone_(self->_protectionInfo, v17, (uint64_t)a3);
  v19 = (void *)v10[2];
  v10[2] = v18;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((shareId = self->_shareId, uint64_t v9 = v4[3], !((unint64_t)shareId | v9))
     || objc_msgSend_isEqual_(shareId, v7, v9))
    && ((participantId = self->_participantId, uint64_t v11 = v4[1], !((unint64_t)participantId | v11))
     || objc_msgSend_isEqual_(participantId, v7, v11)))
  {
    protectionInfo = self->_protectionInfo;
    uint64_t v13 = v4[2];
    if ((unint64_t)protectionInfo | v13) {
      char isEqual = objc_msgSend_isEqual_(protectionInfo, v7, v13);
    }
    else {
      char isEqual = 1;
    }
...
- (unint64_t)hash
{
  ...
  uint64_t v7 = objc_msgSend_hash(self->_participantId, v5, v6) ^ v4;
