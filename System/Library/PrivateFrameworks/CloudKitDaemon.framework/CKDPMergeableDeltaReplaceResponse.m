...
@implementation CKDPMergeableDeltaReplaceResponse

- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPMergeableDeltaReplaceResponse;
  v4 = [(CKDPMergeableDeltaReplaceResponse *)&v11 description];
