...
- (id)description
{
  v3 = NSString;
  v11.receiver = self;
  v11.super_class = (Class)CKDPConfigurationField;
...
- (id)dictionaryRepresentation
{
  ...
  if (value)
  {
    v9 = objc_msgSend_dictionaryRepresentation(value, v5, (uint64_t)name);
    objc_msgSend_setObject_forKey_(v6, v10, (uint64_t)v9, @"value");
  }
  return v6;
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_1C4DF6328((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (name)
  {
    objc_msgSend_setName_(v4, v5, (uint64_t)name);
    id v4 = v8;
  }
  value = self->_value;
  if (value)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5)
    && ((name = self->_name, uint64_t v9 = v4[1], !((unint64_t)name | v9))
     || objc_msgSend_isEqual_(name, v7, v9)))
  {
    value = self->_value;
    uint64_t v11 = v4[2];
...
- (unint64_t)hash
{
  uint64_t v4 = objc_msgSend_hash(self->_name, a2, v2);
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend_setName_(self, (const char *)v4, v5);
    uint64_t v4 = v8;
  }
  value = self->_value;
  uint64_t v7 = v4[2];
