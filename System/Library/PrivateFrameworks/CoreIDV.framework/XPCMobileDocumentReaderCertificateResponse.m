@interface XPCMobileDocumentReaderCertificateResponse
...
- (_TtC7CoreIDV42XPCMobileDocumentReaderCertificateResponse)initWithCoder:(id)a3
{
  return (_TtC7CoreIDV42XPCMobileDocumentReaderCertificateResponse *)sub_21489D070((uint64_t)self, (uint64_t)a2, a3, (void (*)(uint64_t))sub_2148A071C, (uint64_t)&type metadata for MobileDocumentReaderCertificateResponse, (uint64_t (*)(uint64_t))type metadata accessor for XPCMobileDocumentReaderCertificateResponse, &OBJC_IVAR____TtC7CoreIDV42XPCMobileDocumentReaderCertificateResponse_value);
}
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  v5 = self;
  sub_21489B4C4(v4, (uint64_t)&OBJC_IVAR____TtC7CoreIDV42XPCMobileDocumentReaderCertificateResponse_value, (void (*)(void))sub_2148A0774);
}
