...
- (void)setAuthenticationState:(int)a3
{
  ...
  _os_log_impl(&dword_1CFCFE000, v7, OS_LOG_TYPE_INFO, v6, v10, 2u);
}
...
- (id)responseForServerData:(id)a3
{
  ...
  if (self->_ntlmGeneratorRef)
  {
    id v5 = [(MFSASLAuthenticator *)self account];
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v17 = 2112;
      v18 = v10;
      _os_log_impl(&dword_1CFCFE000, v9, OS_LOG_TYPE_INFO, "NTLM - respond to server challenge; user = %@; domain = %@",
        buf,
        0x16u);
    }
  ...
  else
  {
    if (objc_msgSend(a3, "length", a3))
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1CFCFE000, v12, OS_LOG_TYPE_INFO, "*** Unexpected server response during NTLM authentication", buf, 2u);
      }
    }
...
- (void)responseForServerData:(int *)a1 .cold.1(int *a1, NSObject *a2)
{
  ...
  int v3 = 134217984;
  uint64_t v4 = v2;
  _os_log_error_impl(&dword_1CFCFE000, a2, OS_LOG_TYPE_ERROR, "*** Error %ld occurred during NTLM authentication", (uint8_t *)&v3, 0xCu);
}
