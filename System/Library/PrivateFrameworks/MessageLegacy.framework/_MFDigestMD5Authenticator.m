...
- (void)dealloc
{
  if (self->_expectedResponse) {
    NSZoneFree((NSZone *)[(_MFDigestMD5Authenticator *)self zone], self->_expectedResponse);
  }
...
- (void)setAuthenticationState:(int)a3
{
  ...
  if (a3 != 1)
  {
    ...
    *((unsigned char *)&self->super._authenticationState + 6) = *((unsigned char *)&self->super._authenticationState + 6) & 0xFC | 1;
  ...
  if ([(MFSASLAuthenticator *)self authenticationState] == 1)
  {
    ...
    if (v5 >= 1)
    {
      while (1)
      {
        ...
        objc_super v6 = (__CFString *)copyToken(&v72);
        v7 = v6;
        v8 = v72;
        v9 = v73;
        if (v72 < v73) {
                  ...
                  if ([(__CFString *)v7 caseInsensitiveCompare:@"maxbuf"])
                  {
                    if ([(__CFString *)v7 caseInsensitiveCompare:@"charset"])
                    {
                      if ([(__CFString *)v7 caseInsensitiveCompare:@"algorithm"])
                      {
                        ...
                        {
                          CFDataRef v52 = (const __CFData *)copyQuotedTokenList(&v72);
                          CFDataRef v21 = v52;
                          if (v52)
                          {
                            if (!(void)v76) {
                              *(void *)&long long v76 = [(__CFData *)v52 copy];
                            }
                            goto LABEL_117;
                          }
                          v55 = MFLogGeneral();
...
LABEL_60:
                        ...
                        if (v19)
                        {
                          ...
                          CFDataRef v21 = quoted_string(&v72);
                          if (v21) {
                            goto LABEL_117;
                          }
                          v22 = MFLogGeneral();
                        ...
                        {
                          if (!*((void *)&v76 + 1)) {
                            *((void *)&v76 + 1) = MFCreateDataWithString();
                          }
                          goto LABEL_117;
                        }
                        v43 = MFLogGeneral();
...
LABEL_126:
                          buf.A = 138412290;
                          *(void *)&buf.B = v7;
                          _os_log_impl(&dword_1CFCFE000, v43, OS_LOG_TYPE_INFO, "*** Unable to parse %@. Ignoring", (uint8_t *)&buf, 0xCu);
                        }
                      }
                      else
                      {
                        ...
                        if (v34
                          || (CFDataRef v53 = quoted_string(&v72)) != 0
                          && (CFDataRef v54 = v53,
                          ...
                          if ([(__CFString *)v34 caseInsensitiveCompare:@"md5-sess"])
                          {
                            ...
                            if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
                            {
                              ...
                              *(void *)((char *)&buf.D + 2) = v7;
                              _os_log_impl(&dword_1CFCFE000, v51, OS_LOG_TYPE_INFO, "*** Unexpected value %@ for %@. Ignoring", (uint8_t *)&buf, 0x16u);
                            }
                            LODWORD(v74) = 0;
                          }
                          else
                        ...
                        if ([(__CFString *)v49 caseInsensitiveCompare:@"utf-8"])
                        {
                          ...
                          if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
                          {
                            ...
                            *(void *)((char *)&buf.D + 2) = v7;
                            ...
                            uint32_t v30 = 22;
LABEL_61:
                            _os_log_impl(&dword_1CFCFE000, v28, OS_LOG_TYPE_INFO, v29, (uint8_t *)&buf, v30);
                          }
LABEL_117:
...
LABEL_116:
                  ...
                  else
                  {
                    ...
                    if (v47)
                    {
                      ...
                      int v46 = v77 & 0xFFC0003F | ((unsigned __int16)v48 << 6);
                      goto LABEL_116;
                    }
                    v43 = MFLogGeneral();
                    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO)) {
            ...
            {
              CFDataRef v31 = quoted_string(&v72);
              if (v31)
              {
                CFDataRef v21 = v31;
                if (*((void *)&v75 + 1))
                {
                  ...
                  if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
                  {
                    buf.A = 138412290;
                    *(void *)&buf.B = v7;
                    _os_log_impl(&dword_1CFCFE000, v32, OS_LOG_TYPE_INFO, "*** Duplicate value for %@. Ignoring", (uint8_t *)&buf, 0xCu);
                  }
                  LODWORD(v74) = 0;
                  goto LABEL_117;
                }
          ...
          {
            CFDataRef v26 = quoted_string(&v72);
            if (v26)
            {
              CFDataRef v21 = v26;
              if ((void)v75)
...
LABEL_51:
            ...
            uint32_t v25 = 8;
LABEL_52:
            _os_log_impl(&dword_1CFCFE000, v23, OS_LOG_TYPE_INFO, v24, (uint8_t *)&buf, v25);
LABEL_53:
            LODWORD(v74) = 0;
            goto LABEL_54;
          }
...
LABEL_54:
    ...
    if (*((void *)self + 5))
    {
      if (*((void *)&v76 + 1))
      {
        if (objc_msgSend(*((id *)&v76 + 1), "isEqual:"))
        {
...
LABEL_140:
          _os_log_impl(&dword_1CFCFE000, v59, OS_LOG_TYPE_INFO, v60, (uint8_t *)&buf, 2u);
        }
      }
LABEL_141:
    ...
    if ((v77 & 0x20) != 0)
    {
      if (MFGetRandomBytes())
      {
        ...
        *(void *)&long long v78 = (id)[(__CFData *)v62 mf_encodeBase64WithoutLineBreaks];
        CFRelease(v62);
        objc_msgSend(NSString, "stringWithFormat:", @"%08x", 1);
        *((void *)&v78 + 1) = MFCreateDataWithString();
        if ((v57 & 4) != 0)
        {
        ...
        *(void *)&long long v79 = MFCreateDataWithString();
        id v63 = [(MFSASLAuthenticator *)self account];
        [NSString stringWithFormat:@"%@/%@", objc_msgSend((id)objc_opt_class(), "saslProfileName"), objc_msgSend(v63, "hostname")];
        [v63 username];
        *((void *)&v79 + 1) = MFCreateDataWithString();
        [v63 password];
        *(void *)&long long v80 = MFCreateDataWithString();
        *((void *)&v80 + 1) = MFCreateDataWithString();
        *(void *)&long long v81 = [(id)v75 copy];
        *((void *)&v81 + 1) = _createResponseData((uint64_t)self, (uint64_t)&v75, (uint64_t)&v78, 1);
        if (*((void *)&v81 + 1))
        {
          int v64 = [(_MFDigestMD5Authenticator *)self securityLevel];
          if (v64 == 2)
          {
            ...
            if ((*((unsigned char *)&self->super._authenticationState + 6) & 3) == 2) {
          ...
          else if (v64 == 3)
          {
            ...
            {
              LOWORD(buf.A) = 0;
              _os_log_impl(&dword_1CFCFE000, v65, OS_LOG_TYPE_INFO, "*** SASLPrivacySecurityLevel is not supported.", (uint8_t *)&buf, 2u);
            }
          }
          ...
          v69 = (void *)[objc_allocWithZone(MEMORY[0x1E4F1CA58]) init];
          v70 = v69;
          if (*((void *)&v79 + 1)) {
          ...
          if ((v77 & 0x10) != 0) {
            _appendValue(v70, (uint64_t)"charset", [@"utf-8" dataUsingEncoding:1]);
          }
          id v56 = v70;
          goto LABEL_154;
        }
    ...
    else
    {
      ...
      {
        LOWORD(buf.A) = 0;
        _os_log_impl(&dword_1CFCFE000, v58, OS_LOG_TYPE_INFO, "*** Missing algorithm=md5-sess in server response", (uint8_t *)&buf, 2u);
      }
    }
    [(_MFDigestMD5Authenticator *)self setAuthenticationState:3];
    id v56 = 0;
...
- (void)setSecurityLevel:(int)a3
{
  *((unsigned char *)&self->super._authenticationState + 6) = *((unsigned char *)&self->super._authenticationState + 6) & 0xFC | a3 & 3;
}

- (int)securityLevel
{
  return *((unsigned char *)&self->super._authenticationState + 6) & 3;
}
