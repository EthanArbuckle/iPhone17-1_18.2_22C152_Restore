...
- (id)description
{
  ...
  v5 = [(NSSProfileDataReqMsg *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [NSNumber numberWithBool:self->_includeManagedPayloads];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 8) = v6;
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(unsigned char *)(v5 + 16) = self->_includeManagedPayloads;
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has) {
    uint64_t v4 = 2654435761 * self->_includeManagedPayloads;
  }
  else {
    uint64_t v4 = 0;
  }
