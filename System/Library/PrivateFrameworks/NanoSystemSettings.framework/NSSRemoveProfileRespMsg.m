...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NSSRemoveProfileRespMsg;
  v4 = [(NSSRemoveProfileRespMsg *)&v8 description];
  v5 = [(NSSRemoveProfileRespMsg *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NSSRemoveProfileRespMsgReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NSSRemoveProfileRespMsg setError:](self, "setError:");
  }
}
