...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NSSAirplaneModeSettingsReqMsg;
  v4 = [(NSSAirplaneModeSettingsReqMsg *)&v8 description];
  v5 = [(NSSAirplaneModeSettingsReqMsg *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NSSAirplaneModeSettingsReqMsgReadFrom((uint64_t)self, (uint64_t)a3);
}
