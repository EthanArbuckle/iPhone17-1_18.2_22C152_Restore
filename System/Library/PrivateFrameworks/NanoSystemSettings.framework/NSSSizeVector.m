...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    objc_opt_class();
    BOOL v5 = (objc_opt_isKindOfClass() & 1) != 0 && [(NSSSizeVector *)self isEqualToSizeVector:v4];
  }
...
- (id)plus:(id)a3
{
  ...
  v12 = [(NSSSizeVector *)v5 initWithFixed:v7 docsAndData:v9 purgeable:v11 + purgeable];
  return v12;
}
