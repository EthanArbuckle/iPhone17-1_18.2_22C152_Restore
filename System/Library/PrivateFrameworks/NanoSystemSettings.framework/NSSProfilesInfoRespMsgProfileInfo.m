...
- (id)initWithMCProfileInfo:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)NSSProfilesInfoRespMsgProfileInfo;
...
- (id)toMCProfileInfo
{
  ...
  if (v3)
  {
    id v4 = [(NSSProfilesInfoRespMsgProfileInfo *)self friendlyName];
    ...
    objc_msgSend(v3, "setIsInstalledByDeclarativeManagement:", -[NSSProfilesInfoRespMsgProfileInfo isInstalledByDeclarativeManagement](self, "isInstalledByDeclarativeManagement"));
  }
  return v3;
}
