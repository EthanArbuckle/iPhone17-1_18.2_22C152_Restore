...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NSSCancelLogTransfersReqMsg;
  v4 = [(NSSCancelLogTransfersReqMsg *)&v8 description];
  v5 = [(NSSCancelLogTransfersReqMsg *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NSSCancelLogTransfersReqMsgReadFrom((uint64_t)self, (uint64_t)a3);
}
