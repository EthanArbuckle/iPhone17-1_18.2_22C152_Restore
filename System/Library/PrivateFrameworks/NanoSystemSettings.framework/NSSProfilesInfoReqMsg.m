...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NSSProfilesInfoReqMsg;
  v4 = [(NSSProfilesInfoReqMsg *)&v8 description];
  v5 = [(NSSProfilesInfoReqMsg *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NSSProfilesInfoReqMsgReadFrom((uint64_t)self, (uint64_t)a3);
}
