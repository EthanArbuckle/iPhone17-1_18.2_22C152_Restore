@interface MODataSetSettingMetadata
- (NSSet)defaultValue;
...
@implementation MODataSetSettingMetadata

- (NSSet)defaultValue
{
  v4.receiver = self;
  v4.super_class = (Class)MODataSetSettingMetadata;
...
- (id)sanitizePersistableValue:(id)a3
{
  uint64_t v19 = *MEMORY[0x1E4F143B8];
  v17.receiver = self;
  v17.super_class = (Class)MODataSetSettingMetadata;
