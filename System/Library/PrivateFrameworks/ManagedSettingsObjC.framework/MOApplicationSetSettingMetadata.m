@interface MOApplicationSetSettingMetadata
- (NSSet)defaultValue;
...
@implementation MOApplicationSetSettingMetadata
    ...
    if (v7)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v8; ++i)
        {
          ...
          v11 = +[MOApplication initializeWithPersistableValue:](MOApplication, "initializeWithPersistableValue:", *(void *)(*((void *)&v14 + 1) + 8 * i), (void)v14);
          if (v11) {
            [v5 addObject:v11];
          }
        }
...
{
  v4.receiver = self;
  v4.super_class = (Class)MOApplicationSetSettingMetadata;
...
- (id)sanitizePersistableValue:(id)a3
{
  uint64_t v19 = *MEMORY[0x1E4F143B8];
  v17.receiver = self;
  v17.super_class = (Class)MOApplicationSetSettingMetadata;
    ...
    if (v6)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v7; ++i)
        {
          ...
          if (+[MOApplication isValidPersistableRepresentation:](MOApplication, "isValidPersistableRepresentation:", v10, (void)v13))
          {
            [v4 addObject:v10];
          }
        }
