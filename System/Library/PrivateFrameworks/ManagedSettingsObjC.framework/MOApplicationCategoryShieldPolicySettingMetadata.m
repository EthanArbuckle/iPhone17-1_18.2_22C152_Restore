@interface MOApplicationCategoryShieldPolicySettingMetadata
...
- (id)valueFromPersistableValue:(id)a3
{
  return +[MOApplicationCategoryShieldPolicy initializeWithPersistableValue:a3];
}
...
{
  v4.receiver = self;
  v4.super_class = (Class)MOApplicationCategoryShieldPolicySettingMetadata;
  v2 = [(MOSettingMetadata *)&v4 defaultValue];
  return (MOApplicationCategoryShieldPolicy *)v2;
}
...
{
  id v4 = a3;
  if (!+[MOApplicationCategoryShieldPolicy isValidPersistableRepresentation:v4])
  {
    id v7 = 0;
    goto LABEL_8;
  }
  v5 = +[MOApplicationCategoryShieldPolicy initializeWithPersistableValue:v4];
...
{
  id v6 = a4;
  id v7 = [(MOApplicationCategoryShieldPolicySettingMetadata *)self sanitizePersistableValue:a3];
  v8 = [(MOApplicationCategoryShieldPolicySettingMetadata *)self sanitizePersistableValue:v6];

  if (v7)
  {
    if (v8)
    {
      unint64_t v9 = +[MOApplicationCategoryShieldPolicy initializeWithPersistableValue:v7];
      v10 = +[MOApplicationCategoryShieldPolicy initializeWithPersistableValue:v8];
      v11 = [(MOApplicationCategoryShieldPolicySettingMetadata *)self _combine:v9 with:v10];
