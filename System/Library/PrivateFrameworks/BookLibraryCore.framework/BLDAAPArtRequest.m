...
- (BLDAAPArtRequest)initWithDSID:(id)a3 databaseID:(id)a4 body:(id)a5
{
  ...
  id v9 = a5;
  v24.receiver = self;
  v24.super_class = (Class)BLDAAPArtRequest;
  v10 = [(BLDAAPURLRequest *)&v24 initWithDSID:a3 reason:5];
  v13 = v10;
  if (v10)
  {
    objc_msgSend_setContentType_(v10, v11, 0, v12);
    v16 = objc_msgSend_stringWithFormat_(NSString, v14, @"databases/%@/extra_data/cloud-artwork-info", v15, v8);
