...
{
  v7.receiver = self;
  v7.super_class = (Class)NanoMessagesProtoFetchCurrentLocation;
  v3 = [(NanoMessagesProtoFetchCurrentLocation *)&v7 description];
  v4 = [(NanoMessagesProtoFetchCurrentLocation *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NanoMessagesProtoFetchCurrentLocationReadFrom((uint64_t)self, (uint64_t)a3);
}
