...
- (CKBlackholeTranscriptCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v24 = (UIDateLabel *)objc_alloc_init(MEMORY[0x1E4F42920]);
    ...
    v38 = (UILabel *)objc_alloc_init(MEMORY[0x1E4F42B38]);
...
- (void)configureForMessageItem:(id)a3 showSender:(BOOL)a4
{
  ...
  v17 = [v16 stringByReplacingOccurrencesOfString:@"\uFFFD" withString:&stru_1EDE4CA38];
  v18 = [v17 stringByReplacingOccurrencesOfString:@"\uFFFC" withString:&stru_1EDE4CA38];
