...
- (CKTranscriptSatelliteSMSFallbackStatusCell)initWithFrame:(CGRect)a3;
...
- (void)_updateSMSFallbackStatusTitleLabelAttributedTextAnimated:(BOOL)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)CKTranscriptSatelliteSMSFallbackStatusCell;
  ...
  if (v3)
  {
    ...
    [(CKTranscriptSatelliteSMSFallbackStatusCell *)v3 setSatelliteNoNotificationTitleLabel:v4];
  }
  return v3;
}
...
{
  v12.receiver = self;
  v12.super_class = (Class)CKTranscriptSatelliteSMSFallbackStatusCell;
  ...
  double v8 = v7;
  double v10 = v9;
  v11 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self satelliteNoNotificationTitleLabel];
...
- (void)performInsertion:(id)a3
{
  ...
  if ((unint64_t)(v6 - 1) >= 2)
  {
    ...
    {
      v9.receiver = self;
      v9.super_class = (Class)CKTranscriptSatelliteSMSFallbackStatusCell;
  ...
  [(CKTranscriptSatelliteSMSFallbackStatusCell *)self _fadeInLabelAtStartTime:v4 completion:v5 + v7];
LABEL_11:
}
...
{
  id v4 = a3;
  id v11 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self satelliteNoNotificationTitleLabel];
  double v5 = [v11 layer];
...
- (void)clearFilters
{
  id v5 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self satelliteNoNotificationTitleLabel];
  id v2 = [v5 layer];
...
{
  BOOL v3 = a3;
  id v5 = self->_SMSFallbackStatusTitleLabelAttributedText;
  if (v5)
  {
    int64_t v6 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self satelliteNoNotificationTitleLabel];
    double v7 = v6;
    if (v3)
    {
    ...
    {
      double v9 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self satelliteNoNotificationTitleLabel];
      [v9 setAttributedText:v5];
    }
  }
}

uint64_t __103__CKTranscriptSatelliteSMSFallbackStatusCell__updateSMSFallbackStatusTitleLabelAttributedTextAnimated___block_invoke(uint64_t a1)
{
...
- (void)setSMSFallbackStatusTitleLabelAttributedText:(id)a3
{
  ...
  if (self->_SMSFallbackStatusTitleLabelAttributedText != v5)
  {
    int64_t v6 = v5;
...
- (void)_fadeInLabelAtStartTime:(double)a3 completion:(id)a4
{
  ...
  double v8 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self satelliteNoNotificationTitleLabel];
  double v9 = [v8 layer];
  [v9 setOpacity:0.0];
  [(CKTranscriptCell *)self insertionBeginTime];
  objc_msgSend(v9, "convertTime:fromLayer:", 0);
  id v11 = [(CKTranscriptSatelliteSMSFallbackStatusCell *)self animationWithKeyPath:@"opacity" beginTime:&unk_1EDF16FD8 duration:&unk_1EDF16FE8 fromValue:v10 + a3 toValue:v7];
...
- (void)configureForChatItem:(id)a3 context:(id)a4 animated:(BOOL)a5 animationDuration:(double)a6 animationCurve:(int64_t)a7
{
  ...
  {
    v15.receiver = self;
    v15.super_class = (Class)CKTranscriptSatelliteSMSFallbackStatusCell;
    [(CKTranscriptCell *)&v15 configureForChatItem:v12 context:v13 animated:v9 animationDuration:a7 animationCurve:a6];
    int v14 = [v12 smsFallbackStatusTitleLabelAttributedText];
    [(CKTranscriptSatelliteSMSFallbackStatusCell *)self setSMSFallbackStatusTitleLabelAttributedText:v14];
  }
  else
  {
