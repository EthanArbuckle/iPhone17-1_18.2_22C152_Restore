...
{
  v4.receiver = self;
  v4.super_class = (Class)CKWatchfaceImageReplyPreviewBalloonView;
...
- (void)prepareForDisplay
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)CKWatchfaceImageReplyPreviewBalloonView;
...
- (void)configureForMessagePart:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)CKWatchfaceImageReplyPreviewBalloonView;
