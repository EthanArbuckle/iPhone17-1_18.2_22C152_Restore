...
+ (id)assetForAssociatedMessageType:(int64_t)a3
{
  id v3 = _s7ChatKit27TapbackClassicAssetProviderC5asset3forAA0cdE0CSgSo23IMAssociatedMessageTypeV_tFZ_0(a3);
...
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for TapbackClassicAssetProvider();
