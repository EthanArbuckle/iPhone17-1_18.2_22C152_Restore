...
- (CKBlackholeConversationListCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    -[CKBlackholeConversationListCell setSeparatorInset:](v4, "setSeparatorInset:", *MEMORY[0x1E4F437F8], *(double *)(MEMORY[0x1E4F437F8] + 8), *(double *)(MEMORY[0x1E4F437F8] + 16), *(double *)(MEMORY[0x1E4F437F8] + 24));
    ...
    v27 = (UIDateLabel *)objc_alloc_init(MEMORY[0x1E4F42920]);
