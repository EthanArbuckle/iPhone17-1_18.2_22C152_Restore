...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v7 = [(NSString *)self->_podcastUuid copy];
  v8 = (void *)v4[8];
  v4[8] = v7;

  uint64_t v9 = [(NSString *)self->_podcastFeedUrl copy];
  v10 = (void *)v4[9];
  v4[9] = v9;

  uint64_t v11 = [(NSString *)self->_episodeUuid copy];
  v12 = (void *)v4[10];
  v4[10] = v11;

  uint64_t v13 = [(NSString *)self->_podcastAdamId copy];
  v14 = (void *)v4[11];
  v4[11] = v13;

  uint64_t v15 = [(NSString *)self->_episodeAdamId copy];
  v16 = (void *)v4[12];
  v4[12] = v15;

  uint64_t v17 = [(NSString *)self->_stationUuid copy];
  v18 = (void *)v4[13];
  v4[13] = v17;

  uint64_t v19 = [(NSString *)self->_requesterDsid copy];
  v20 = (void *)v4[14];
  v4[14] = v19;
...
- (id)copyWithPlayReason:(unint64_t)a3
{
  id result = (id)[(MTURLCommandRequest *)self copy];
  *((void *)result + 4) = a3;
  return result;
}
...
- (void)_loadQueryParameterValuesFromString:(id)a3
{
  ...
  uint64_t v5 = [v4 query];
  v6 = +[MTPlaybackIdentifierUtil __queryStringToQueryDictionary:v5];

  uint64_t v7 = +[MTSingleton sharedInstance];
  char v8 = [v7 isSubscribeCommandURLString:v42];
  ...
  {
    v10 = +[MTSingleton sharedInstance];
    char v11 = [v10 isLocalSetPlaybackQueueURLString:v42];
    ...
    {
      v12 = +[MTSingleton sharedInstance];
      int v13 = [v12 isUniversalPlaybackIdentifierURLString:v42];
...
- (void)_lookupPodcastUuidIfNecessaryFromURLString:(id)a3
{
  ...
  int v13 = __66__MTURLCommandRequest__lookupPodcastUuidIfNecessaryFromURLString___block_invoke;
  v14 = &unk_265055A40;
  v16 = &v18;
  id v7 = v6;
  id v15 = v7;
  ...
  {
    char v8 = +[MTSingleton sharedInstance];
    unint64_t v9 = [v8 podcastUuidForSetPlaybackQueueRequestIdentifier:v4];
    podcastUuid = self->_podcastUuid;
...
- (void)_lookupEpisodeUuidIfNecessaryFromURLString:(id)a3
{
  ...
  uint64_t v11 = MEMORY[0x263EF8330];
  uint64_t v12 = 3221225472;
  int v13 = __66__MTURLCommandRequest__lookupEpisodeUuidIfNecessaryFromURLString___block_invoke;
  v14 = &unk_265055A40;
  v16 = &v18;
  id v7 = v6;
  id v15 = v7;
  ...
  {
    char v8 = +[MTSingleton sharedInstance];
    unint64_t v9 = [v8 episodeUuidForSetPlaybackQueueRequestIdentifier:v4];
    episodeUuid = self->_episodeUuid;
