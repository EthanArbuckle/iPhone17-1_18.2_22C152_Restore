    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [(NSUserDefaults *)self->_defaults addObserver:self forKeyPath:*(void *)(*((void *)&v8 + 1) + 8 * v7++) options:0 context:self];
        }
        while (v5 != v7);
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [(NSUserDefaults *)self->_defaults removeObserver:self forKeyPath:*(void *)(*((void *)&v8 + 1) + 8 * v7++) context:self];
        }
        while (v5 != v7);
        uint64_t v5 = [v3 countByEnumeratingWithState:&v8 objects:v12 count:16];
      }
