    ...
    if (v6)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v7; ++i)
        {
          ...
          v11 = [v10 property];
          uint64_t v12 = objc_msgSend(v10, "sruif_range");
          v4[2](v4, v11, v12, v13);
        }
...
- (void)sruif_enumerateRangesOfRegionsWithProperty:()SiriUIFoundationAdditions usingBlock:
{
  ...
  if (v7)
  {
    ...
    id v9 = v6;
    id v10 = v7;
    objc_msgSend(a1, "sruif_enumeratePropertyRangesUsingBlock:", v8);
  }
}
...
- (id)sruif_attributedStringValueWithAttribute:()SiriUIFoundationAdditions value:forRegionsWithProperty:
{
  ...
  id v16 = v9;
  id v17 = v8;
  objc_msgSend(a1, "sruif_enumerateRangesOfRegionsWithProperty:usingBlock:", v11, v21);
