...
- (id)description
{
  ...
  v12 = [v15 stringWithFormat:@"<ACCNavigationRoadObjectRoadLaneInfo: ID %@, state %@, type[left %@, right %@], color[left %@, right %@], width %@, curvature[center %@, left %@, right %@]>", v14, v3, v4, v5, v6, v7, v8, v9, v10, v11];
...
- (BOOL)_checkDataClassForType:(unsigned __int16)a3 data:(id)a4
{
  ...
  if (v4 > 9)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      v11[0] = 67109120;
      v11[1] = v4;
      _os_log_impl(&dword_22605D000, v9, OS_LOG_TYPE_DEFAULT, "[#Navigation] ERROR: Unknown RoadObjectDetection:RoadLane InfoType %d", (uint8_t *)v11, 8u);
    }
