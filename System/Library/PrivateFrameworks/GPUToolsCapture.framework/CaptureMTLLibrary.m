  ...
  if (v9)
  {
    ...
    if (v12)
    {
      ...
      *(_DWORD *)((char *)&v50 + 11) = 0;
      HIBYTE(v50) = 0;
      GTTraceEncoder_setStream((uint64_t *)&v48, (uint64_t)objc_msgSend(v51, "traceStream", (void)v48));
      uint64_t v15 = v49;
      *(_DWORD *)(v49 + 8) = -15608;
      char v16 = BYTE9(v50);
...
- (id)newFunctionWithName:(id)a3 constantValues:(id)a4 pipelineLibrary:(id)a5 error:(id *)a6
{
  ...
  *(unsigned char *)(v18 + 13) = v19;
  ...
  if (v24) {
    char v25 = (uint64_t *)objc_msgSend(v12, "traceStream", *v24);
  }
  else {
    char v25 = (uint64_t *)objc_msgSend(v12, "traceStream", 0);
  }
  if (!v25)
  {
    uint64_t v26 = 0;
...
- (id)newFunctionWithName:(id)a3 constantValues:(id)a4 error:(id *)a5
{
  ...
  long long v34 = 0u;
  traceContext = self->_traceContext;
  objc_msgSend(v37, "traceStream", 0);
...
void __74__CaptureMTLLibrary_newFunctionWithName_constantValues_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
    ...
    && [*(id *)(*(void *)(a1 + 32) + 16) newCaptureFunction:&v33 associatedWithBaseFunction:v5 captureLibrary:*(void *)(a1 + 40)])
  {
    ...
    long long v32 = 0u;
    long long v30 = 0u;
    id v9 = objc_msgSend(*(id *)(a1 + 40), "traceContext", 0);
    [v33 traceStream];
