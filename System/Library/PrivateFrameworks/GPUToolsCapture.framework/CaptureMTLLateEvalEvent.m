...
- (void)dealloc
{
  ...
  *(unsigned char *)(v3 + 13) = v4;
  v8 = [(CaptureMTLLateEvalEvent *)self traceStream];
  if (v8) {
  ...
  *(unsigned char *)(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLLateEvalEvent;
...
- (void)setSignaledValue:(unint64_t)a3
{
  ...
  *(unsigned char *)(v5 + 13) = v6;
  uint64_t v10 = [(CaptureMTLLateEvalEvent *)self traceStream];
  if (v10) {
...
{
  v7.receiver = self;
  v7.super_class = (Class)CaptureMTLLateEvalEvent;
  uint64_t v3 = [(CaptureMTLLateEvalEvent *)&v7 description];
...
- (BOOL)waitUntilSignaledValue:(unint64_t)a3 timeoutMS:(unint64_t)a4
{
  ...
  block[4] = v6;
  if (waitUntilSignaledValue_timeoutMS__onceToken_10133 != -1) {
    dispatch_once(&waitUntilSignaledValue_timeoutMS__onceToken_10133, block);
  }
  long long v19 = 0u;
  long long v20 = 0u;
  long long v18 = 0u;
  ...
  *(unsigned char *)(v8 + 13) = v9;
  id v13 = [(CaptureMTLLateEvalEvent *)self traceStream];
  if (v13) {
...
uint64_t __56__CaptureMTLLateEvalEvent_notifyListener_atValue_block___block_invoke(void *a1)
{
...
- (id)newSharedEventHandle
{
  ...
  *(unsigned char *)(v4 + 13) = v5;
  char v9 = [(CaptureMTLLateEvalEvent *)self traceStream];
  if (v9) {
...
- (CaptureMTLLateEvalEvent)initWithBaseObject:(id)a3 captureDevice:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)CaptureMTLLateEvalEvent;
  char v9 = [(CaptureMTLLateEvalEvent *)&v14 init];
  uint64_t v10 = v9;
  if (v9)
  {
