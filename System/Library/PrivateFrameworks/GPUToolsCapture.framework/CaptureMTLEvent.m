...
@implementation CaptureMTLEvent
...
- (void)dealloc
{
  ...
  *(unsigned char *)(v3 + 13) = v4;
  v8 = [(CaptureMTLEvent *)self traceStream];
  if (v8) {
  ...
  *(unsigned char *)(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLEvent;
  [(CaptureMTLEvent *)&v12 dealloc];
}
...
- (void)setLabel:(id)a3
{
  ...
  *(unsigned char *)(v5 + 13) = v6;
  uint64_t v10 = [(CaptureMTLEvent *)self traceStream];
  if (v10) {
...
- (NSString)label
{
  return (NSString *)[(MTLEvent *)self->_baseObject label];
}
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  unsigned __int8 v5 = [(MTLEvent *)baseObject conformsToProtocol:v4];
...
{
  v7.receiver = self;
  v7.super_class = (Class)CaptureMTLEvent;
  uint64_t v3 = [(CaptureMTLEvent *)&v7 description];
  id v4 = [(MTLEvent *)self->_baseObject description];
...
- (void)setEnableBarrier:(BOOL)a3
{
  ...
  [(MTLEvent *)self->_baseObject setEnableBarrier:v3];
  uint64_t v5 = v15;
  *(_DWORD *)(v15 + 8) = -15325;
  char v6 = BYTE9(v16);
...
- (BOOL)enableBarrier
{
  return [(MTLEvent *)self->_baseObject enableBarrier];
}
...
- (CaptureMTLEvent)initWithBaseObject:(id)a3 captureDevice:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)CaptureMTLEvent;
  uint64_t v9 = [(CaptureMTLEvent *)&v14 init];
  uint64_t v10 = v9;
  if (v9)
  {
