...
- (id)update:(id)a3
{
  ...
  id v6 = [v3 requests];
  id v66 = objc_msgSend(v5, "initWithCapacity:", objc_msgSend(v6, "count"));
...
- (id)startWithDescriptor:(id)a3 completionHandler:(id)a4
{
  ...
  [v8 setDestination:2];
  objc_msgSend(v8, "setSessionID:", objc_msgSend(v6, "sessionID"));
  ...
  objc_msgSend(v8, "setTriggerHitsToEnd:", objc_msgSend(v6, "triggerHitsToEnd"));
  objc_msgSend(v8, "setSuspendAfterCapture:", objc_msgSend(v6, "suspendAfterCapture"));
  objc_msgSend(v8, "setIgnoreUnusedResources:", objc_msgSend(v6, "ignoreUnusedResources"));
  objc_msgSend(v8, "setIncludeBacktrace:", objc_msgSend(v6, "includeBacktrace"));
