...
LABEL_3:
    ...
    while (1)
    {
      ...
      v9 = objc_msgSend((id)_scopes, "objectForKey:", *(void *)(*((void *)&v13 + 1) + 8 * v8), (void)v13);
      v10 = v9;
      if (v9 == (void *)a3) {
        break;
      }
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v10 = objc_msgSend((id)_scopes, "objectForKey:", *(void *)(*((void *)&v12 + 1) + 8 * (void)v9), (void)v12);
        v11 = newDYMTLCaptureScopeInfo(v10);
        [v4 addObject:v11];
...
+ (id)allCaptureScopes
{
  ...
  id v3 = objc_msgSend(v2, "initWithCapacity:", objc_msgSend((id)_scopes, "count"));
  long long v13 = 0u;
  long long v14 = 0u;
  long long v15 = 0u;
  long long v16 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        v9 = objc_msgSend((id)_scopes, "objectForKey:", *(void *)(*((void *)&v13 + 1) + 8 * i), (void)v13);
