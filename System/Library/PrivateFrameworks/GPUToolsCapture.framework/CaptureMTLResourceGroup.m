...
- (void)dealloc
{
  ...
  *(unsigned char *)(v3 + 13) = v4;
  v8 = [(CaptureMTLResourceGroup *)self traceStream];
  if (v8) {
  ...
  *(unsigned char *)(v14 + 15) |= 8u;
  ...
  v12.receiver = self;
  v12.super_class = (Class)CaptureMTLResourceGroup;
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  unsigned __int8 v5 = [(MTLResourceGroupSPI *)baseObject conformsToProtocol:v4];
...
{
  v7.receiver = self;
  v7.super_class = (Class)CaptureMTLResourceGroup;
  uint64_t v3 = [(CaptureMTLResourceGroup *)&v7 description];
  char v4 = [(MTLResourceGroupSPI *)self->_baseObject description];
...
- (CaptureMTLResourceGroup)initWithBaseObject:(id)a3 captureDevice:(id)a4
{
  ...
  id v8 = a4;
  v14.receiver = self;
  v14.super_class = (Class)CaptureMTLResourceGroup;
