...
- (void)setBuffers:(const void *)a3 offsets:(const unint64_t *)a4 withRange:(_NSRange)a5
{
  ...
  *(unsigned char *)(v12 + 8) |= 1u;
  ...
  if (length)
  {
    ...
    {
      uint64_t v20 = *v17++;
      *v18++ = objc_msgSend(v20, "baseObject", v33);
      --v19;
    }
    while (v19);
  }
...
- (CaptureMTLIntersectionFunctionTable)initWithBaseObject:(id)a3 captureRenderPipelineState:(id)a4 descriptor:(id)a5
{
  ...
  if (v12)
  {
    ...
    while (v18);
    long long v23 = (NSMutableArray *)objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", objc_msgSend(v11, "functionCount"));
...
- (CaptureMTLIntersectionFunctionTable)initWithBaseObject:(id)a3 captureDevice:(id)a4 descriptor:(id)a5
{
  ...
  if (v12)
  {
    ...
    while (v16);
    long long v21 = (NSMutableArray *)objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", objc_msgSend(v11, "functionCount"));
    functions = v13->_functions;
    v13->_functions = v21;
