...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  v7.receiver = a1;
  v7.super_class = (Class)&OBJC_METACLASS___ECPlainAuthScheme;
...
+ (ECPlainAuthScheme)plainAuthScheme
{
  ...
  v2 = (void *)plainAuthScheme_sharedInstance;
  return (ECPlainAuthScheme *)v2;
}

void __36__ECPlainAuthScheme_plainAuthScheme__block_invoke(uint64_t a1)
{
  v3.receiver = *(id *)(a1 + 32);
  v3.super_class = (Class)&OBJC_METACLASS___ECPlainAuthScheme;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)ECPlainAuthScheme;
  [(ECPlainAuthScheme *)&v5 dealloc];
}

- (id)name
{
  return &stru_1F1A635E8;
}
...
- (id)supportedSASLMechanisms
{
  return (id)objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"PLAIN", @"LOGIN", 0);
}
