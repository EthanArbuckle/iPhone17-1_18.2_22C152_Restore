...
- (CPSContentRatingContainerView)init
{
  ...
  if (v2)
  {
    ...
    [(CPSScaledImageView *)v2->_contentRatingImageView setTextStyleForScaling:*MEMORY[0x1E4F43890]];
    ...
    v39[7] = v16;
    v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v39 count:8];
...
- (void)setImage:(id)a3 usesVibrantAppearance:(BOOL)a4
{
  ...
  if (v4)
  {
    v6 = [MEMORY[0x1E4F427D8] effectWithStyle:8];
    v7 = [MEMORY[0x1E4F42FE8] effectForBlurEffect:v6 style:1];
