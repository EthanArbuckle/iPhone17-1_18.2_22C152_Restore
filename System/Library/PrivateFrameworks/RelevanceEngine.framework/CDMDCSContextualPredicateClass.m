...
Class __get_CDMDCSContextualPredicateClass_block_invoke(uint64_t a1)
{
  ...
  Class result = objc_getClass("_CDMDCSContextualPredicate");
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  if (*(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24))
  {
    get_CDMDCSContextualPredicateClass_softClass = *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24);
  }
  else
  {
    uint64_t v3 = __get_CDMDCSContextualPredicateClass_block_invoke_cold_1();
