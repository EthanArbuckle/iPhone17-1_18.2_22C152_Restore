...
Class __get_DKIdentifierClass_block_invoke(uint64_t a1)
{
  ...
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  ...
  {
    uint64_t v3 = __get_DKIdentifierClass_block_invoke_cold_1();
    return (Class)__get_DKCategoryClass_block_invoke(v3);
  }
  return result;
}

uint64_t __get_DKIdentifierClass_block_invoke_cold_1()
{
  uint64_t v0 = abort_report_np();
  return __get_DKCategoryClass_block_invoke_cold_1(v0);
}
