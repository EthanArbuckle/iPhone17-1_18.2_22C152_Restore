...
- (void)setDelegate:(id)a3
{
  ...
  [(TTRIRecurrenceChooserController *)self->_monthDayChooser setDelegate:v5];
  [(TTRIRecurrenceChooserController *)self->_ordinalChooser setDelegate:v5];
}

- (void)updateRecurrenceRuleBuilder:(id)a3
{
  id v4 = a3;
  id v5 = [(TTRIRecurrenceMonthlyChooserController *)self _currentChooser];
...
- (void)updateFromRecurrenceRule:(id)a3
{
  ...
  BOOL v6 = +[TTRICustomRecurrenceViewController isRecurrenceRuleOrdinal:v5];
...
- (void)rowTapped:(int64_t)a3
{
  ...
  double v5 = [(TTRIRecurrenceMonthlyChooserController *)self _currentChooser];
...
- (void)_selectRow:(int64_t)a3
{
  ...
  if (a3)
  {
    ...
    char v4 = &OBJC_IVAR___TTRIRecurrenceMonthlyChooserController__onEachCell;
    double v5 = &OBJC_IVAR___TTRIRecurrenceMonthlyChooserController__onTheCell;
  }
  else
  {
    char v4 = &OBJC_IVAR___TTRIRecurrenceMonthlyChooserController__onTheCell;
    double v5 = &OBJC_IVAR___TTRIRecurrenceMonthlyChooserController__onEachCell;
  }
...
- (BOOL)prohibitsMultipleDaysInMonthlyRecurrence
{
  return [(TTRIRecurrenceMonthDayChooserController *)self->_monthDayChooser prohibitsMultipleDaysInMonthlyRecurrence];
}
