...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    id v4 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:self->_value];
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)OTEscrowRecordMetadataPasscodeGeneration;
  id v4 = [(OTEscrowRecordMetadataPasscodeGeneration *)&v8 description];
  BOOL v5 = [(OTEscrowRecordMetadataPasscodeGeneration *)self dictionaryRepresentation];
