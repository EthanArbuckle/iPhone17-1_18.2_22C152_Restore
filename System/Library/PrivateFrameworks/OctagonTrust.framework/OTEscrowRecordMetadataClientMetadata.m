...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *(void *)(v5 + 16) = self->_secureBackupMetadataTimestamp;
...
LABEL_3:
  ...
  *(void *)(v5 + 24) = self->_secureBackupNumericPassphraseLength;
...
LABEL_6:
  uint64_t v8 = [(NSString *)self->_deviceColor copyWithZone:a3];
  NSUInteger v9 = *(void **)(v6 + 48);
  *(void *)(v6 + 48) = v8;

  uint64_t v10 = [(NSString *)self->_deviceEnclosureColor copyWithZone:a3];
  NSUInteger v11 = *(void **)(v6 + 56);
  *(void *)(v6 + 56) = v10;

  uint64_t v12 = [(NSString *)self->_deviceMid copyWithZone:a3];
  v13 = *(void **)(v6 + 64);
  *(void *)(v6 + 64) = v12;
  ...
  *(void *)(v6 + 72) = v14;
  ...
  uint64_t v16 = [(NSString *)self->_deviceModelClass copyWithZone:a3];
  v17 = *(void **)(v6 + 80);
  *(void *)(v6 + 80) = v16;

  uint64_t v18 = [(NSString *)self->_deviceModelVersion copyWithZone:a3];
  v19 = *(void **)(v6 + 88);
  *(void *)(v6 + 88) = v18;

  uint64_t v20 = [(NSString *)self->_deviceName copyWithZone:a3];
  v21 = *(void **)(v6 + 96);
  *(void *)(v6 + 96) = v20;
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    uint64_t v15 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:self->_secureBackupMetadataTimestamp];
...
LABEL_3:
  ...
  uint64_t v16 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:self->_secureBackupNumericPassphraseLength];
...
LABEL_27:
  v17 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:self->_secureBackupUsesComplexPassphrase];
  [v3 setObject:v17 forKey:@"secure_backup_uses_complex_passphrase"];

  if ((*(unsigned char *)&self->_has & 0x10) != 0)
  {
LABEL_5:
    id v5 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:self->_secureBackupUsesNumericPassphrase];
...
LABEL_6:
  ...
  if (*(unsigned char *)&self->_has)
  {
    v13 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:self->_devicePlatform];
...
- (id)description
{
  ...
  id v4 = [(OTEscrowRecordMetadataClientMetadata *)&v8 description];
  id v5 = [(OTEscrowRecordMetadataClientMetadata *)self dictionaryRepresentation];
