...
- (SeparatorLayer)initWithFrame:(CGRect)a3
{
  ...
  double v3 = -[SeparatorLayer initWithFrame:](&v7, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  double v4 = v3;
  if (v3)
  {
    [(SeparatorLayer *)v3 setAutoresizingMask:2];
    [(SeparatorLayer *)v4 setAxis:0];
    v5 = [MEMORY[0x1E4FB1618] mailHeaderSeparatorLayerColor];
...
- (CGSize)intrinsicContentSize
{
  -[SeparatorLayer sizeThatFits:](self, "sizeThatFits:", *MEMORY[0x1E4FB30D8], *MEMORY[0x1E4FB30D8]);
