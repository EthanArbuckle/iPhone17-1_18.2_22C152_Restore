...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ATXMagicalMomentsPBMMPredictedCountTracker;
  int v4 = [(ATXMagicalMomentsPBMMPredictedCountTracker *)&v8 description];
  v5 = [(ATXMagicalMomentsPBMMPredictedCountTracker *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return ATXMagicalMomentsPBMMPredictedCountTrackerReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[ATXMagicalMomentsPBMMPredictedCountTracker setAbGroup:](self, "setAbGroup:");
    id v4 = v5;
  }
}
