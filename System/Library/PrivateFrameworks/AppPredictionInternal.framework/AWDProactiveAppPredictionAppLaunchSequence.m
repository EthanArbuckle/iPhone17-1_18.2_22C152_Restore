...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDProactiveAppPredictionAppLaunchSequence;
  id v4 = [(AWDProactiveAppPredictionAppLaunchSequence *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return AWDProactiveAppPredictionAppLaunchSequenceReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearBundleids];
    unint64_t v5 = [(AWDProactiveAppPredictionAppLaunchSequence *)self bundleidsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(AWDProactiveAppPredictionAppLaunchSequence *)self bundleidAtIndex:i];
        [v9 addBundleid:v8];
      }
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[AWDProactiveAppPredictionAppLaunchSequence addBundleid:](self, "addBundleid:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
