...
- (id)description
{
  ...
  id v4 = [(ATXPBBlendingSessionUICache *)&v8 description];
  v5 = [(ATXPBBlendingSessionUICache *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearSuggestions];
    unint64_t v4 = [(ATXPBBlendingSessionUICache *)self suggestionsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(ATXPBBlendingSessionUICache *)self suggestionAtIndex:i];
        [v8 addSuggestion:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](consumerSubType, "isEqual:")))
  {
    ...
    if ((unint64_t)suggestions | v4[2]) {
      char v7 = -[NSMutableArray isEqual:](suggestions, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_suggestions hash] ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        -[ATXPBBlendingSessionUICache addSuggestion:](self, "addSuggestion:", *(void *)(*((void *)&v10 + 1) + 8 * i), (void)v10);
      }
