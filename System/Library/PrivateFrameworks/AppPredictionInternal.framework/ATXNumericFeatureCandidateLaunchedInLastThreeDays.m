...
- (ATXNumericFeatureCandidateLaunchedInLastThreeDays)init;
...
- (ATXNumericFeatureCandidateLaunchedInLastThreeDays)init
{
  return [(ATXImmutableCandidateRelevanceModelFeaturizer *)self initWithFeatureValueNames:&unk_1F27F3AC8];
}
