...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)AWDProactiveAppPredictionActionTimeEstimate;
  id v4 = [(AWDProactiveAppPredictionActionTimeEstimate *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_actions, "count"));
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return AWDProactiveAppPredictionActionTimeEstimateReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearActions];
    unint64_t v5 = [(AWDProactiveAppPredictionActionTimeEstimate *)self actionsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(AWDProactiveAppPredictionActionTimeEstimate *)self actionAtIndex:i];
        [v9 addAction:v8];
      }
    }
  }
...
LABEL_9:
  ...
  actions = self->_actions;
  if ((unint64_t)actions | *((void *)v4 + 2)) {
    char v6 = -[NSMutableArray isEqual:](actions, "isEqual:");
  }
  else {
    char v6 = 1;
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[AWDProactiveAppPredictionActionTimeEstimate addAction:](self, "addAction:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
