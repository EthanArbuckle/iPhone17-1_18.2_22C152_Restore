@interface ATXNumericFeatureCandidateLaunchedInLastSixHours
...
- (ATXNumericFeatureCandidateLaunchedInLastSixHours)init
{
  return [(ATXImmutableCandidateRelevanceModelFeaturizer *)self initWithFeatureValueNames:&unk_1F27F3A98];
}
