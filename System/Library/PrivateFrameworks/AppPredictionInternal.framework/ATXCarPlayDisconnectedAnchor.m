...
+ (id)longDescription
{
  return @"CarPlay device is disconnected.";
}
...
+ (id)predicateForContextStoreRegistration
{
  ...
  v4 = [v2 predicateForKeyPath:v3 equalToValue:&unk_1F27F18D8];
...
+ (id)invalidationPredicateForContextStoreRegistration
{
  v2 = (void *)MEMORY[0x1E4F5B6E8];
  v3 = [(id)objc_opt_class() keyPathForContextStore];
  v4 = [v2 predicateForKeyPath:v3 equalToValue:&unk_1F27F18F0];
