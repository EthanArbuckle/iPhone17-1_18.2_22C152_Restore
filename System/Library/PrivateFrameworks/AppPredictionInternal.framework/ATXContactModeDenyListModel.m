...
- (ATXContactModeDenyListModel)initWithMode:(unint64_t)a3 contactStore:(id)a4
{
  id v7 = a4;
  v25.receiver = self;
  v25.super_class = (Class)ATXContactModeDenyListModel;
  ...
  if (v8)
  {
    ...
    uint64_t v10 = [(ATXContactModeDenyListModel *)v9 loadContactModeModel];
...
- (id)scoredEntities
{
  ...
  if (![(ATXContactNotificationEngagementEventProvider *)self->_contactNotificationEngagementEventProvider successfullyCalculatedNotificationEvents])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR)) {
      -[ATXContactModeDenyListModel scoredEntities](v8);
    }
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315650;
    v29 = "-[ATXContactModeDenyListModel scoredEntities]";
    __int16 v30 = 2112;
    v31 = v11;
    __int16 v32 = 2048;
  ...
  [v9 enumerateKeysAndObjectsUsingBlock:&__block_literal_global_205];
  uint64_t v12 = [(ATXContactModeDenyListModel *)self meContact];
  ...
  v23[1] = 3221225472;
  v23[2] = __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_24;
  v23[3] = &unk_1E68ABCF0;
  id v24 = v16;
  objc_super v25 = self;
  v26 = v13;
...
void __45__ATXContactModeDenyListModel_scoredEntities__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
    __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_cold_1((uint64_t)v4, v5, v6);
  }
}

void __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_24(uint64_t a1, uint64_t a2, void *a3)
{
  id v26 = a3;
  id v4 = [v26 entity];
  id v5 = [v4 identifier];
  ...
  if ((v6 & 1) == 0)
  {
    ...
    v11 = [v26 entity];
    objc_msgSend(v10, "setIsVIPContact:", objc_msgSend(v11, "isVIPContactGivenVIPs:contactStore:", *(void *)(*(void *)(a1 + 40) + 40), *(void *)(*(void *)(a1 + 40) + 16)));
    ...
    if (v16)
    {
      objc_msgSend(v10, "setIsICloudFamilyMember:", objc_msgSend(*(id *)(*(void *)(a1 + 40) + 56), "containsObject:", v16));
      objc_msgSend(v10, "setIsEmergencyContact:", objc_msgSend(*(id *)(*(void *)(a1 + 40) + 48), "containsObject:", v16));
      objc_msgSend(v10, "setIsFavoriteContact:", objc_msgSend(*(id *)(*(void *)(a1 + 40) + 32), "containsObject:", v16));
...
- (id)modelName
{
  return @"ATXContactModeDenyListModel";
}

- (id)loadContactModeModel
{
  v3 = objc_opt_new();
  id v4 = [(ATXContactModeDenyListModel *)self modelName];
  ...
  {
    uint64_t v7 = [(ATXContactModeDenyListModel *)self modelName];
...
- (double)scoreFromContactFeatures:(id)a3
{
  ...
  if ((unint64_t)[v4 uniqueOccurrencesInMode] > 2)
  {
    ...
    uint64_t v11 = [(ATXContactModeDenyListModel *)self featuresToModel:v4];
    id v32 = 0;
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR)) {
        -[ATXContactModeDenyListModel scoreFromContactFeatures:]((uint64_t)v12, v13, v14, v15, v16, v17, v18, v19);
      }
    }
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR)) {
        -[ATXContactModeDenyListModel scoreFromContactFeatures:]((uint64_t)v5, v21, v22, v23, v24, v25, v26, v27);
      }
    }
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 136315907;
    uint64_t v34 = "-[ATXContactModeDenyListModel scoreFromContactFeatures:]";
    __int16 v35 = 2117;
    v36 = v7;
    __int16 v37 = 2048;
    uint64_t v38 = v8;
...
- (id)purgeDeletedContacts:(id)a3
{
  ...
  v19[1] = 3221225472;
  v19[2] = __52__ATXContactModeDenyListModel_purgeDeletedContacts___block_invoke;
  v19[3] = &unk_1E68AE580;
  uint64_t v20 = v6;
  id v11 = v4;
  id v21 = v11;
  ...
  if (v14 != [v11 count])
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG)) {
      [(ATXContactModeDenyListModel *)v11 purgeDeletedContacts:v15];
    }
  }
  uint64_t v16 = v22;
  id v17 = v12;
...
void __45__ATXContactModeDenyListModel_scoredEntities__block_invoke_cold_1(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  int v7 = 136315651;
  id v8 = "-[ATXContactModeDenyListModel scoredEntities]_block_invoke";
  __int16 v9 = 2117;
  uint64_t v10 = a1;
  __int16 v11 = 2117;
  id v12 = v6;
...
- (void)purgeDeletedContacts:(NSObject *)a3 .cold.1(void *a1, void *a2, NSObject *a3)
{
  ...
  int v6 = 136315394;
  int v7 = "-[ATXContactModeDenyListModel purgeDeletedContacts:]";
  __int16 v8 = 2048;
