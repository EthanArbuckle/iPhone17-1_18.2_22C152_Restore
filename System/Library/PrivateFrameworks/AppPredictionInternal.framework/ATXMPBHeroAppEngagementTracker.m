...
- (id)description
{
  ...
  int v4 = [(ATXMPBHeroAppEngagementTracker *)&v8 description];
  v5 = [(ATXMPBHeroAppEngagementTracker *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
      v5 = off_1E68B60E0[interactionType];
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_interactionType != *((_DWORD *)v4 + 6)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if ((unint64_t)consumerSubType | *((void *)v4 + 2)) {
    char v7 = -[NSString isEqual:](consumerSubType, "isEqual:");
  }
  else {
    char v7 = 1;
  }
