...
- (void)layOutStacks:(id)a3 numberOfColumns:(unint64_t)a4 forPageType:(int64_t)a5
{
  ...
  if ([v7 count] != 2)
  {
    ...
    [v9 handleFailureInMethod:a2, self, @"ATXSuggestedPagesStackLayoutTwoMedium.m", 46, @"Invalid parameter not satisfying: %@", @"stacks.count == 2" object file lineNumber description];
  }
