...
- (ATXNumericFeatureTimeSine)init
{
  return [(ATXImmutableCandidateRelevanceModelFeaturizer *)self initWithFeatureValueNames:&unk_1F27F39F0];
}
...
- (id)numericFeatureValueForContext:(id)a3 candidate:(id)a4
{
  ...
  v10 = [NSNumber numberWithDouble:(double)sin((double)v9 * 6.28318531 / 86400.0)];
