...
+ (id)longDescription
{
  return @"Wired audio device is connected.";
}
...
+ (id)invalidationPredicateForContextStoreRegistration
{
  return (id)[MEMORY[0x1E4F5B6B8] predicateForAudioOutputStatus:0];
}
...
+ (id)sampleEvent
{
  ...
  v5 = [(ATXAudioDuetEvent *)v2 initWithAudioState:1 deviceIdentifier:@"Headphones" portType:@"Headphones" portName:@"Headphones" routeChangeReason:&unk_1F27F04E0 startDate:v3 endDate:v4];
