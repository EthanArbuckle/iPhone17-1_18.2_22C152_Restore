...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ATXMagicalMomentsPBMMShownTracker;
  int v4 = [(ATXMagicalMomentsPBMMShownTracker *)&v8 description];
  v5 = [(ATXMagicalMomentsPBMMShownTracker *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return ATXMagicalMomentsPBMMShownTrackerReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 3))
  {
    -[ATXMagicalMomentsPBMMShownTracker setBundleId:](self, "setBundleId:");
    NSUInteger v4 = v5;
  }
  if (*((void *)v4 + 1))
  {
    -[ATXMagicalMomentsPBMMShownTracker setAbGroup:](self, "setAbGroup:");
    NSUInteger v4 = v5;
  }
  if (*((void *)v4 + 4))
  {
    -[ATXMagicalMomentsPBMMShownTracker setConsumerSubType:](self, "setConsumerSubType:");
    NSUInteger v4 = v5;
  }
}
