...
LABEL_13:
  ...
  if (v17)
  {
    uint64_t v18 = [v5 acLocalizedUnlinkedPlanStatusLabel];
...
+ (id)ctaTextWithDevice:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [v3 acLocalizedUnlinkedPlanStatusLabel];
LABEL_3:
    v7 = (void *)v6;
    goto LABEL_9;
  }
  ...
  if ([v8 length])
  {
    int v9 = [v3 acOfferEligible];

    if (v9)
    {
      uint64_t v6 = [v3 acLocalizedOfferStatusLabel];
      goto LABEL_3;
    }
  }
  else
