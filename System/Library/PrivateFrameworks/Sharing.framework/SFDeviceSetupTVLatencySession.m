...
- (void)_cleanup
{
  objc_super v8 = self->_tvLatencyEstimator;
...
uint64_t __41__SFDeviceSetupTVLatencySession_activate__block_invoke(uint64_t a1)
{
  ...
  *(void *)(*(void *)(a1 + 32) + 32) = mach_absolute_time();
  ...
  if (v3)
  {
    (*(void (**)(void, uint64_t, void))(v3 + 16))(v2[11], 10, 0);
    v2 = *(void **)(a1 + 32);
  }
...
- (void)_reportError:(id)a3
{
  ...
  if (progressHandler)
  {
    ...
    if (!v6)
    {
      ...
      v26 = v12;
      uint64_t v4 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", &v26, &v25, 1, v22);
      objc_super v8 = [v9 errorWithDomain:v10 code:-6700 userInfo:v4];
    }
    v28[0] = v8;
...
- (void)_run
{
  ...
  {
    int v3 = [(SFDeviceSetupTVLatencySession *)self _runSFSessionStart];
    if (v3 == 4 || v3 == 2)
    {
      int v4 = [(SFDeviceSetupTVLatencySession *)self _runPairVerify:0];
      if (v4 == 4 || v4 == 2)
      {
        if (self->_sessionSecured
          || ((int v5 = [(SFDeviceSetupTVLatencySession *)self _runPairVerify:1], v5 == 4) || v5 == 2)
          && (self->_sessionSecured
           || (int v9 = [(SFDeviceSetupTVLatencySession *)self _runPairSetup], v9 == 4)
           || v9 == 2))
        {
          int v6 = [(SFDeviceSetupTVLatencySession *)self _runTVLatencySetup];
          if (v6 == 4 || v6 == 2)
          {
            int v7 = [(SFDeviceSetupTVLatencySession *)self _runFinish];
            if (v7 == 4 || v7 == 2)
            {
...
- (int)_runSFSessionStart
{
  ...
  if (sfSessionState != 4 && sfSessionState != 2)
  {
    ...
    else
    {
      ...
      v14[1] = 3221225472;
      v14[2] = __51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke;
      v14[3] = &unk_1E5BBC8E8;
      v14[4] = self;
      [(SFSession *)self->_sfSession setErrorHandler:v14];
      v13[0] = MEMORY[0x1E4F143A8];
      v13[1] = 3221225472;
      v13[2] = __51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke_2;
      v13[3] = &unk_1E5BBC870;
      v13[4] = self;
      [(SFSession *)self->_sfSession setInterruptionHandler:v13];
      v12[0] = MEMORY[0x1E4F143A8];
      v12[1] = 3221225472;
      v12[2] = __51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke_3;
      v12[3] = &unk_1E5BBC870;
      v12[4] = self;
      [(SFSession *)self->_sfSession setInvalidationHandler:v12];
      v11[0] = MEMORY[0x1E4F143A8];
      v11[1] = 3221225472;
      v11[2] = __51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke_4;
      v11[3] = &unk_1E5BBC870;
      v11[4] = self;
      ...
      v10[1] = 3221225472;
      v10[2] = __51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke_5;
      v10[3] = &unk_1E5BBC8E8;
      v10[4] = self;
...
unsigned char *__51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke(uint64_t a1, uint64_t a2)
{
  result = *(unsigned char **)(a1 + 32);
  if (!result[16]) {
    return (unsigned char *)[result _reportError:a2];
  }
  return result;
}
...
uint64_t __51__SFDeviceSetupTVLatencySession__runSFSessionStart__block_invoke_4(uint64_t result)
{
  ...
  if (!*(unsigned char *)(v1 + 16) && *(_DWORD *)(v1 + 48) == 1)
  {
    *(_DWORD *)(v1 + 48) = 4;
...
- (void)_runSFSessionActivated
{
  ...
  v4[3] = &unk_1E5BBCBA8;
  v4[4] = self;
  [(SFSession *)sfSession registerRequestID:@"_sa" options:&unk_1EFA09DF0 handler:v4];
  ...
  if (!*(unsigned char *)(*(void *)(a1 + 32) + 16))
  {
    ...
    else
    {
      ...
      *(unsigned char *)(*(void *)(a1 + 32) + 28) = 1;
      ...
      (*(void (**)(void, uint64_t, void))(v5 + 16))(v4[11], 70, 0);
    }
    uint64_t v4 = *(void **)(a1 + 32);
LABEL_15:
...
- (void)_runTVLatencySetupEstimate
{
  ...
  if (v3)
  {
    uint64_t v4 = (void *)[objc_alloc((Class)getTVLAudioLatencyEstimatorClass_2[0]()) initWithMessageSession:v3];
    objc_storeStrong((id *)&self->_tvLatencyEstimator, v4);
    uint64_t v7 = MEMORY[0x1E4F143A8];
    uint64_t v8 = 3221225472;
    int v9 = __59__SFDeviceSetupTVLatencySession__runTVLatencySetupEstimate__block_invoke;
...
- (void)_handleSetupActionRequest:(id)a3 responseHandler:(id)a4
{
    ...
    && (gLogCategory_SFDeviceSetupTVLatencySession != -1 || _LogCategory_Initialize()))
  {
    if (Int64Ranged > 0xA) {
      ...
      id v9 = off_1E5BC0F10[(int)Int64Ranged];
    }
  ...
  else
  {
      ...
      && (gLogCategory_SFDeviceSetupTVLatencySession != -1 || _LogCategory_Initialize()))
    {
      if (Int64Ranged > 0xA) {
        ...
        id v11 = off_1E5BC0F68[(int)Int64Ranged];
      }
      uint64_t v12 = Int64Ranged;
      id v13 = v11;
      LogPrintF();
    }
    objc_msgSend(v7, "setObject:forKeyedSubscript:", &unk_1EFA097D0, @"er", v12, v13);
  }
