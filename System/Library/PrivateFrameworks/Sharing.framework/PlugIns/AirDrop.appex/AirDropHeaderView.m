...
{
  v34.receiver = self;
  v34.super_class = (Class)AirDropHeaderView;
  v3 = -[AirDropHeaderView initWithFrame:](&v34, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    if (v6 == (id)6)
    {
      ...
      double v12 = 0.0;
      [(AirDropHeaderView *)v10 setDirectionalLayoutMargins:"setDirectionalLayoutMargins:"];
      double v13 = 0.0;
    }
    else
    {
