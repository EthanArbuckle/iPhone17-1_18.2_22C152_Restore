...
- (CDRichComplicationCornerGaugeCustomView)initWithFontFallback:(int64_t)a3
{
  ...
  if (v3)
  {
    uint64_t v5 = [(CDRichComplicationCornerGaugeCustomView *)v3 _outerView];
...
- (void)layoutSubviews
{
  ...
  [(CDRichComplicationCornerBaseGaugeView *)&v27 layoutSubviews];
  ...
  v14 = WeakRetained;
  id v15 = objc_loadWeakRetained(&_LayoutConstants___cachedDevice_1);
  if (v15 != v12)
  {

LABEL_5:
    id v18 = objc_storeWeak(&_LayoutConstants___cachedDevice_1, v12);
    _LayoutConstants___previousCLKDeviceVersion_1 = [v12 version];

    ___LayoutConstants_block_invoke_1(v19, (uint64_t)v12);
    goto LABEL_6;
  }
  uint64_t v16 = [v12 version];
  uint64_t v17 = _LayoutConstants___previousCLKDeviceVersion_1;
...
LABEL_6:
  ...
  double v20 = *(double *)&_LayoutConstants___constants_0_0;
  double v21 = *(double *)&_LayoutConstants___constants_1_0;
