...
- (void)startServiceConnection
{
  ...
  if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&buf[4] = "-[SACSYSController startServiceConnection]";
    *(_WORD *)&buf[12] = 2080;
  ...
  *(void *)&buf[16] = 0x3042000000;
  ...
  v8 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26EA57840];
...
{
  id v7 = a3;
  dispatch_time_t v4 = [(SACSYSController *)self delegate];
