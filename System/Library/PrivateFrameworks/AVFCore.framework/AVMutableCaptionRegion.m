...
- (AVCaptionPoint)origin
{
  v4.receiver = self;
  v4.super_class = (Class)AVMutableCaptionRegion;
  return (AVCaptionPoint *)[(AVCaptionPoint *)&v4 origin];
}

- (void)setOrigin:(AVCaptionPoint *)origin
{
  AVCaptionDimension y = origin->y;
  v4[0] = origin->x;
  v4[1] = y;
...
- (AVCaptionSize)size
{
  v4.receiver = self;
  v4.super_class = (Class)AVMutableCaptionRegion;
  return (AVCaptionSize *)[(AVCaptionSize *)&v4 size];
}

- (void)setSize:(AVCaptionSize *)size
{
  AVCaptionDimension height = size->height;
  v4[0] = size->width;
  v4[1] = height;
