...
- (id)predictedOutputDeviceFromRoutingContext:(OpaqueFigRoutingContext *)a3
{
  ...
  v6 = *(uint64_t (**)(OpaqueFigRoutingContext *, CFTypeRef *))(v5 + 176);
  if (!v6) {
    return 0;
  }
  int v7 = v6(a3, &cf);
  ...
  v9 = +[AVOutputDevice outputDeviceWithRouteDescriptor:cf withRoutingContext:a3];
  CFTypeRef v8 = cf;
  if (cf) {
LABEL_7:
  }
...
- (id)outputDevicesFromRoutingContext:(OpaqueFigRoutingContext *)a3
{
  ...
  int v7 = *(unsigned int (**)(OpaqueFigRoutingContext *, CFArrayRef *))(v6 + 64);
  if (v7 && !v7(a3, &theArray))
  {
    for (CFIndex i = 0; ; ++i)
    {
      ...
      v10 = +[AVOutputDevice outputDeviceWithRouteDescriptor:CFArrayGetValueAtIndex(theArray, i) withRoutingContext:a3];
      if (v10) {
        [v4 addObject:v10];
      }
    }
...
{
  v8.receiver = self;
  v8.super_class = (Class)AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator;
  uint64_t v4 = [(AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *)&v8 init];
  uint64_t v5 = v4;
  if (v4)
  {
...
{
  v2.receiver = self;
  v2.super_class = (Class)AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator;
...
- (AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator)init
{
  ...
  return (AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *)[(AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator *)self initForUsingRouteConfigUpdatedNotification:v3];
}
...
- (id)outputDeviceFromRoutingContext:(OpaqueFigRoutingContext *)a3
{
  ...
  uint64_t v6 = *(uint64_t (**)(OpaqueFigRoutingContext *, CFTypeRef *))(v5 + 32);
  if (!v6) {
    return 0;
  }
  int v7 = v6(a3, &cf);
...
- (void)setOutputDevice:(id)a3 withOptions:(__CFDictionary *)a4 onRoutingContext:(OpaqueFigRoutingContext *)a5 completionHandler:(id)a6
{
  ...
  if (AVOutputDeviceGetFigRouteDescriptor(a3, &v15))
  {
    v12 = AVMakeSelectRouteDescriptorOperation(a5, v15, a4, self->_useRouteConfigUpdatedNotification);
    v14[0] = MEMORY[0x1E4F143A8];
    v14[1] = 3221225472;
    v14[2] = __126__AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator_setOutputDevice_withOptions_onRoutingContext_completionHandler___block_invoke;
    v14[3] = &unk_1E57B3CA8;
    v14[5] = v11;
    v14[6] = a6;
    v14[4] = v12;
...
- (void)setOutputDevices:(id)a3 withOptions:(__CFDictionary *)a4 onRoutingContext:(OpaqueFigRoutingContext *)a5 completionHandler:(id)a6
{
  ...
  if (Mutable)
  {
    v17 = AVMakeSelectRouteDescriptorsOperation(a5, Mutable, a4, self->_useRouteConfigUpdatedNotification);
    v19[0] = MEMORY[0x1E4F143A8];
    v19[1] = 3221225472;
    v19[2] = __127__AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator_setOutputDevices_withOptions_onRoutingContext_completionHandler___block_invoke;
    v19[3] = &unk_1E57B4540;
    v19[4] = v17;
    v19[5] = a6;
...
{
  CFTypeRef v15 = 0;
  int FigRouteDescriptor = AVOutputDeviceGetFigRouteDescriptor(a3, &v15);
  char v11 = FigRouteDescriptor;
  if (FigRouteDescriptor && v15)
  {
    uint64_t v12 = AVMakeAddRouteDescriptorOperation(a5, v15, a4, self->_useRouteConfigUpdatedNotification);
    v14[0] = MEMORY[0x1E4F143A8];
    v14[1] = 3221225472;
    v14[2] = __126__AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator_addOutputDevice_withOptions_toRoutingContext_completionHandler___block_invoke;
    v14[3] = &unk_1E57B4540;
    v14[4] = v12;
    v14[5] = a6;
    [(AVRouteConfigUpdatedFigRoutingContextRouteChangeOperation *)v12 setCompletionBlock:v14];
...
{
  CFTypeRef v13 = 0;
  if (AVOutputDeviceGetFigRouteDescriptor(a3, &v13) && v13)
  {
    v10 = AVMakeRemoveRouteDescriptorOperation(a5, v13, a4, self->_useRouteConfigUpdatedNotification);
    v12[0] = MEMORY[0x1E4F143A8];
    v12[1] = 3221225472;
    v12[2] = __131__AVFigRouteDescriptorFigRoutingContextOutputDeviceTranslator_removeOutputDevice_withOptions_fromRoutingContext_completionHandler___block_invoke;
    v12[3] = &unk_1E57B4540;
    v12[4] = v10;
    v12[5] = a6;
