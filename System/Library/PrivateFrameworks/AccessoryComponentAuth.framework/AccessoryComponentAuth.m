...
void InitAuthService()
{
  if (InitAuthService_onceToken != -1) {
    dispatch_once(&InitAuthService_onceToken, &__block_literal_global_0);
  }
}
...
void ACASignVeridianChallenge(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    uint64_t v12 = a1;
    _os_log_impl(&dword_235F30000, v6, OS_LOG_TYPE_DEFAULT, "challenging Veridian using data %@", buf, 0xCu);
  }
...
void __ACASignVeridianChallenge_block_invoke(uint64_t a1, void *a2, void *a3, int a4)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 1024;
    int v17 = a4;
    _os_log_impl(&dword_235F30000, v11, OS_LOG_TYPE_DEFAULT, "received response. signature=%@, deviceNonce=%@, authError=%d", (uint8_t *)&v12, 0x1Cu);
  }
...
void ACAVerifyBatteryMatch(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    uint64_t v12 = a1;
    _os_log_impl(&dword_235F30000, v6, OS_LOG_TYPE_DEFAULT, "verifying battery match using cert %@", buf, 0xCu);
  }

  id v7 = (void *)accHWService;
  v9[0] = MEMORY[0x263EF8330];
  v9[1] = 3221225472;
...
uint64_t __ACAVerifyBatteryMatch_block_invoke(uint64_t a1, int a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    v8[0] = 67109120;
    v8[1] = a2;
    _os_log_impl(&dword_235F30000, v6, OS_LOG_TYPE_DEFAULT, "received response. authError=%d", (uint8_t *)v8, 8u);
  }
...
void ACAInitForHID(void *a1)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_235F30000, v4, OS_LOG_TYPE_DEFAULT, "ACAInitForHID", buf, 2u);
  }
  ...
  *(_OWORD *)buf = v5;
  ...
  v6 = [MEMORY[0x263EFF8F8] dataWithBytes:buf length:32];
  id v7 = (void *)accHWService;
  v9[0] = MEMORY[0x263EF8330];
  v9[1] = 3221225472;
...
uint64_t __ACAInitForHID_block_invoke(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16))();
}
...
void ACASignTouchControllerChallenge(uint64_t a1, void *a2)
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_235F30000, v6, OS_LOG_TYPE_DEFAULT, "ACASignTouchControllerChallenge", buf, 2u);
  }
...
void __ACASignTouchControllerChallenge_block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4, uint64_t a5, int a6)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 1024;
    int v17 = a6;
    _os_log_impl(&dword_235F30000, v13, OS_LOG_TYPE_DEFAULT, "received response. response=%@, authError=%d", (uint8_t *)&v14, 0x12u);
  }
...
CFDataRef copyCertificateForFDRData(const __CFData *Copy)
{
  ...
  if (Copy)
  {
    ...
    if (Length < 611)
    {
      ...
      {
        LOWORD(v26) = 0;
        _os_log_impl(&dword_235F30000, v7, OS_LOG_TYPE_DEFAULT, "dataLength matches Roswell data length, return copy of fdr data", (uint8_t *)&v26, 2u);
      }

      Copy = CFDataCreateCopy((CFAllocatorRef)*MEMORY[0x263EFFB08], Copy);
    }
    else
    {
      uint64_t v5 = Length;
      ...
      {
        LOWORD(v26) = 0;
        _os_log_impl(&dword_235F30000, v6, OS_LOG_TYPE_DEFAULT, "Have a custom Roswell data structure", (uint8_t *)&v26, 2u);
      }
      ...
      if (v5 == 704)
      {
        ...
        else
        {
          ...
          BOOL v11 = &_os_log_internal;
          id v14 = &_os_log_internal;
        }
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
        {
          LOWORD(v26) = 0;
          _os_log_impl(&dword_235F30000, v11, OS_LOG_TYPE_DEFAULT, "Have a match for (t_bpFDRData_v1)", (uint8_t *)&v26, 2u);
        }

        id v15 = (UInt8 *)malloc_type_calloc(1uLL, 0x2C0uLL, 0x100004033510130uLL);
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          ...
          int v26 = 67109120;
          LODWORD(v27) = v20;
          _os_log_impl(&dword_235F30000, v17, OS_LOG_TYPE_DEFAULT, "pRoswellDataStructure->roswell_cert_len = %d", (uint8_t *)&v26, 8u);
        }

        Copy = CFDataCreate((CFAllocatorRef)*MEMORY[0x263EFFB08], v15 + 62, *((unsigned __int16 *)v15 + 30));
        free(v15);
      }
      else
      {
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    int v26 = 134217984;
    CFIndex v27 = v24;
    _os_log_impl(&dword_235F30000, v23, OS_LOG_TYPE_INFO, "Returning Roswell data of length %ld", (uint8_t *)&v26, 0xCu);
  }
...
void __init_logging_modules_block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned char *)(a1 + 48))
  {
    ...
    do
    {
      ...
      if (!v8)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 67109120;
          LODWORD(v13) = v4;
          _os_log_error_impl(&dword_235F30000, v6, OS_LOG_TYPE_ERROR, "Subsystem missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
          uint64_t v7 = *(void *)(a1 + 32);
          id v8 = "<Undefined>";
        }
      }
      BOOL v9 = *(const char **)(v7 + v3 + 8);
      if (!v9)
      {
        BOOL v9 = "<Undefined>";
        if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      ...
      *(void *)(*(void *)(a1 + 40) + 8 * v4) = v10;
      if (v10)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 136315394;
          ...
          __int16 v14 = 2080;
          id v15 = v9;
          _os_log_debug_impl(&dword_235F30000, v6, OS_LOG_TYPE_DEBUG, "Created log object %s: %s", buf, 0x16u);
        }
      }
      else if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v14 = 2080;
        id v15 = v9;
        _os_log_error_impl(&dword_235F30000, v6, OS_LOG_TYPE_ERROR, "Failed to create os_log_t object %s: %s!", buf, 0x16u);
      }
      ++v4;
    ...
    while (v4 < v11);
    uint64_t v2 = (void *)&loc_235F42000;
  }
  else
  {
    LODWORD(v11) = 0;
  ...
  if (os_log_type_enabled(&_os_log_internal, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = v2[446];
    LODWORD(v13) = v5;
    _os_log_impl(&dword_235F30000, &_os_log_internal, OS_LOG_TYPE_INFO, "Created %d log object(s)!", buf, 8u);
...
uint64_t systemInfo_isInternalBuild()
{
  if (systemInfo_isInternalBuild_onceToken != -1) {
    dispatch_once(&systemInfo_isInternalBuild_onceToken, &__block_literal_global_2);
  }
...
void __init_logging_signpost_modules_block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned char *)(a1 + 48))
  {
    ...
    while (v4 < v11);
    CFTypeID v2 = (void *)&loc_235F42000;
  }
  else
  {
    LODWORD(v11) = 0;
...
uint64_t cpGetDeviceInfo(io_registry_entry_t entry, void *a2, void *a3, void *a4, void *a5, void *a6)
{
  ...
  id v12 = (CFAllocatorRef *)MEMORY[0x263EFFB08];
  if (a2)
  {
...
uint64_t cpGetDeviceIDSN(io_registry_entry_t a1, UInt8 **a2, CFIndex *a3)
{
  ...
  if (a2)
  {
    ...
    if (CFProperty)
    {
      ...
      BOOL v9 = (UInt8 *)malloc_type_malloc(Length, 0xC0846878uLL);
      if (v9)
      {
        os_log_t v10 = v9;
        v12.location = 0;
...
uint64_t cpCreateSignatureWithIndexAndToken(mach_port_t a1, const __CFData *a2, CFDataRef *a3, uint64_t *a4, int a5)
{
  ...
  *(_OWORD *)bytes = 0u;
  ...
  CFIndex length = 128;
  BytePtr = CFDataGetBytePtr(a2);
  CFIndex v12 = CFDataGetLength(a2);
...
LABEL_34:
          ...
          CFIndex v12 = CFNumberCreate(v5, kCFNumberSInt64Type, &entryID);
          if (!v12)
          {
LABEL_45:
            long long v23 = 0;
    ...
    else
    {
      ...
      if (!v5)
      {
        ...
        if (!v5)
        {
          ...
          {
            void *v11 = v8;
            if (!MEMORY[0x237DF8650](v8, a1[1], *a1, v11)) {
              ccec_verify();
            }
          }
          return;
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_235F30000, &_os_log_internal, v0, "Make sure you have called init_logging()!\ngLogObjects: %p, gNumLogObjects: %d", v1, v2, v3, v4, v5);
}
...
void copyCertificateForFDRData_cold_4(uint64_t a1, NSObject *a2)
{
  ...
  __int16 v4 = 2048;
  uint64_t v5 = 704;
  _os_log_error_impl(&dword_235F30000, a2, OS_LOG_TYPE_ERROR, "auth CFIndex length = %ld, sizeof(t_bpFDRData_v1) = %lu, does not match", (uint8_t *)&v2, 0x16u);
}
...
void __init_logging_modules_block_invoke_cold_1(uint8_t *buf, int a2, _DWORD *a3)
{
  *(_DWORD *)buf = 67109120;
  *a3 = a2;
  _os_log_error_impl(&dword_235F30000, &_os_log_internal, OS_LOG_TYPE_ERROR, "Category missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
}
