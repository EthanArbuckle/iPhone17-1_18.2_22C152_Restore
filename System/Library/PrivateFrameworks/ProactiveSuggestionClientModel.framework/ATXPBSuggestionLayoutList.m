...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ATXPBSuggestionLayoutList;
  id v4 = [(ATXPBSuggestionLayoutList *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_layouts, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return ATXPBSuggestionLayoutListReadFrom((uint64_t)self, (uint64_t)a3);
}
  ...
  if (a1 && [*(id *)(a1 + 8) count])
  {
    ...
    if (v3)
    {
      ...
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        -[ATXPBSuggestionLayoutList addLayout:]((uint64_t)v7, v6);
      }
    }
  }
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[ATXPBSuggestionLayoutList addLayout:]((uint64_t)v5, v11);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)layouts | v4[1]) {
      char v6 = -[NSMutableArray isEqual:](layouts, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSMutableArray *)self->_layouts hash];
}
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[ATXPBSuggestionLayoutList addLayout:](a1, *(void **)(*((void *)&v8 + 1) + 8 * v7++));
        }
        while (v5 != v7);
