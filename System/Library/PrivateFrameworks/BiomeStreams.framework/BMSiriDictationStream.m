...
@implementation BMSiriDictationStream

- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"SiriDictation"];
}

- (BMSiriDictationStream)init
{
  v8.receiver = self;
  v8.super_class = (Class)BMSiriDictationStream;
  v2 = [(BMSiriDictationStream *)&v8 init];
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    v4 = [(BMSiriDictationStream *)v2 identifier];
...
- (id)publisher
{
  ...
  v4 = [(BMSiriDictationStream *)self identifier];
