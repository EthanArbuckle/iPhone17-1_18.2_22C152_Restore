...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"SiriPrivateLearningSELFEvent"];
}
...
- (BMSiriPrivateLearningSELFEventStream)init
{
  ...
  if (v2)
  {
    ...
    v4 = [(BMSiriPrivateLearningSELFEventStream *)v2 identifier];
...
- (id)publisher
{
  ...
  v4 = [(BMSiriPrivateLearningSELFEventStream *)self identifier];
