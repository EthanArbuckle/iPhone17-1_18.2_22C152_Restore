...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:27];
}

- (BMFindMyLocationChangeStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMFindMyLocationChangeStream;
  v2 = [(BMFindMyLocationChangeStream *)&v10 init];
  if (v2)
  {
    v3 = BMRootLibraryBridge();
    v4 = [v3 FindMy];
    v5 = [v4 LocationChange];
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT)) {
        -[BMFindMyLocationChangeStream init](v8);
      }
    }
  }
  return v2;
...
- (id)publisher
{
  ...
  v4 = [(BMFindMyLocationChangeStream *)self identifier];
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMFindMyLocationChangeStream, please consult error logs for cause", v1, 2u);
}
