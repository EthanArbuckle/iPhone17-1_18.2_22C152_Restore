...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:39];
}

- (BMPostSiriEngagementStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMPostSiriEngagementStream;
  v2 = [(BMPostSiriEngagementStream *)&v10 init];
  if (v2)
  {
    v3 = BMRootLibraryBridge();
    v4 = [v3 Siri];
    v5 = [v4 PostSiriEngagement];
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT)) {
        -[BMPostSiriEngagementStream init](v8);
      }
    }
  }
  return v2;
...
- (id)publisher
{
  ...
  v4 = [(BMPostSiriEngagementStream *)self identifier];
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPostSiriEngagementStream, please consult error logs for cause", v1, 2u);
}
