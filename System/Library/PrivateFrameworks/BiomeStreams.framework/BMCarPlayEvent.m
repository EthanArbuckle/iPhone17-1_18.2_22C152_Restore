...
{
  v7.receiver = self;
  v7.super_class = (Class)BMCarPlayEvent;
...
- (NSString)description
{
  ...
  v5 = (void *)[v3 initWithFormat:@"CarPlay event with reason: %ld is start: %@", self->_reason, v4];
...
- (id)json
{
  ...
  id v3 = [(BMCarPlayEvent *)self jsonDict];
  uint64_t v8 = 0;
...
LABEL_7:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT)) {
      -[BMCarPlayEvent initWithProto:]((uint64_t)self, v9);
    }

    goto LABEL_7;
  }
  id v5 = v4;
  uint64_t v6 = (int)[v5 reason];
  uint64_t v7 = [v5 isStart];
...
- (BMCarPlayEvent)initWithProtoData:(id)a3
{
  ...
  {
    id v4 = a3;
    id v5 = [[BMPBCarPlayEvent alloc] initWithData:v4];
...
- (void)initWithProto:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v5 = 138412290;
  uint64_t v6 = v4;
  _os_log_fault_impl(&dword_18E67D000, a2, OS_LOG_TYPE_FAULT, "%@: tried to initialize with a non-BMPBCarPlayEvent proto", (uint8_t *)&v5, 0xCu);
}
...
- (void)proto
{
  ...
  int v4 = 138412290;
  int v5 = v3;
  _os_log_error_impl(&dword_18E67D000, a2, OS_LOG_TYPE_ERROR, "BMCarPlayEvent: unable to convert BMCarPlayReason enum value: %@", (uint8_t *)&v4, 0xCu);
}
