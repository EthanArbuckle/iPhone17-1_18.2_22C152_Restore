...
{
  v18.receiver = self;
  v18.super_class = (Class)BMHomeKitClientMediaAccessoryControlStream;
  ...
  if (v2)
  {
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT)) {
        [(BMHomeKitClientMediaAccessoryControlStream *)v9 init];
      }
    }
  }
  return v2;
...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:15];
}
