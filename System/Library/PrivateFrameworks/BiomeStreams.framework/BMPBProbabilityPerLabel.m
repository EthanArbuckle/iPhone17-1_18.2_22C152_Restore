...
- (id)description
{
  ...
  v5 = [(BMPBProbabilityPerLabel *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [NSNumber numberWithDouble:self->_probability];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 24) & 1) != 0 && self->_probability == *((double *)v4 + 1))
    {
      BOOL v6 = 1;
      goto LABEL_9;
    }
