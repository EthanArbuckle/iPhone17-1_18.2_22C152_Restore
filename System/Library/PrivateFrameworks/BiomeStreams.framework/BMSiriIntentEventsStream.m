...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:35];
}

- (BMSiriIntentEventsStream)init
{
  v11.receiver = self;
  v11.super_class = (Class)BMSiriIntentEventsStream;
  ...
  if (v2)
  {
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT)) {
        -[BMSiriIntentEventsStream init](v9);
      }
    }
  }
  return v2;
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamSiriIntentEvents, please consult error logs for cause", v1, 2u);
}
