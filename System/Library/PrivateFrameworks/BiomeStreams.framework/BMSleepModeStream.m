...
@implementation BMSleepModeStream

- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:6];
}

- (BMSleepModeStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMSleepModeStream;
  v2 = [(BMSleepModeStream *)&v10 init];
  if (v2)
  {
...
- (id)publisher
{
  ...
  v4 = [(BMSleepModeStream *)self identifier];
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamSleepMode, please consult error logs for cause", v1, 2u);
}
