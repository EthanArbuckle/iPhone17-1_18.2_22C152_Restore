...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:22];
}

- (BMBacklightStream)init
{
  v11.receiver = self;
  v11.super_class = (Class)BMBacklightStream;
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamBacklight, please consult error logs for cause", v1, 2u);
}
