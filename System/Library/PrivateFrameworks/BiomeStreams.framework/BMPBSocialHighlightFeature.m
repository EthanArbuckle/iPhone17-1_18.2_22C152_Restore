...
@implementation BMPBSocialHighlightFeature
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BMPBSocialHighlightFeature;
  v4 = [(BMPBSocialHighlightFeature *)&v8 description];
  v5 = [(BMPBSocialHighlightFeature *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return BMPBSocialHighlightFeatureReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[BMPBSocialHighlightFeature setName:](self, "setName:");
    unint64_t v4 = v5;
  }
  if ((_BYTE)v4[3])
  {
