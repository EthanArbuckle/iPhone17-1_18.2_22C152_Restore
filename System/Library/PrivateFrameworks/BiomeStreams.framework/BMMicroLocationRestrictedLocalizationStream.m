@interface BMMicroLocationRestrictedLocalizationStream
...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"MicroLocationRestrictedLocalization"];
}
...
- (BMMicroLocationRestrictedLocalizationStream)init
{
  ...
  v2 = [(BMMicroLocationRestrictedLocalizationStream *)&v8 init];
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    v4 = [(BMMicroLocationRestrictedLocalizationStream *)v2 identifier];
...
- (id)publisher
{
  ...
  v4 = [(BMMicroLocationRestrictedLocalizationStream *)self identifier];
