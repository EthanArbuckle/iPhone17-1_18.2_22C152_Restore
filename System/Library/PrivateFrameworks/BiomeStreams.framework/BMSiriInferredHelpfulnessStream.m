@interface BMSiriInferredHelpfulnessStream
- (BMSiriInferredHelpfulnessStream)init;
- (NSString)identifier;
- (id)publisher;
...
@implementation BMSiriInferredHelpfulnessStream

- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"SiriInferredHelpfulness"];
}

- (BMSiriInferredHelpfulnessStream)init
{
  v8.receiver = self;
  v8.super_class = (Class)BMSiriInferredHelpfulnessStream;
  v2 = [(BMSiriInferredHelpfulnessStream *)&v8 init];
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    v4 = [(BMSiriInferredHelpfulnessStream *)v2 identifier];
...
- (id)publisher
{
  ...
  v4 = [(BMSiriInferredHelpfulnessStream *)self identifier];
  uint64_t v5 = [(BMDSLStreamPublisher *)v3 initWithIdentifier:v4 streamType:1 eventDataClass:objc_opt_class()];
