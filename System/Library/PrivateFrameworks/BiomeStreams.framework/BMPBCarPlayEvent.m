...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BMPBCarPlayEvent;
  int v4 = [(BMPBCarPlayEvent *)&v8 description];
  v5 = [(BMPBCarPlayEvent *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return BMPBCarPlayEventReadFrom((uint64_t)self, (uint64_t)a3);
}
