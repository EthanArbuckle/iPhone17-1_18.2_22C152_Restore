...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"MediaRendered"];
}

- (BMMediaRenderedStream)init
{
  v8.receiver = self;
  v8.super_class = (Class)BMMediaRenderedStream;
  v2 = [(BMMediaRenderedStream *)&v8 init];
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    v4 = [(BMMediaRenderedStream *)v2 identifier];
...
- (id)publisher
{
  ...
  v4 = [(BMMediaRenderedStream *)self identifier];
