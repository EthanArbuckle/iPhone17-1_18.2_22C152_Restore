...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v7 = [(NSString *)self->_soundDetectionType copyWithZone:a3];
...
LABEL_11:
  ...
  soundDetectionType = self->_soundDetectionType;
  if ((unint64_t)soundDetectionType | *((void *)v4 + 3)
...
- (unint64_t)hash
{
  ...
  NSUInteger v8 = [(NSString *)self->_soundDetectionType hash] ^ v3;
  return v8 ^ [(NSString *)self->_name hash];
}
