...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  uint64_t v4 = *(void *)&a4;
  id v5 = a3;
  id v6 = [[BMTestEvent alloc] initWithData:v5 dataVersion:v4];
...
- (BMTestEvent)initWithCoder:(id)a3
{
  ...
  if (-[BMTestEvent checkAndReportDecodingFailureIfNeededForuint32_t:key:coder:errorDomain:errorCode:](self, "checkAndReportDecodingFailureIfNeededForuint32_t:key:coder:errorDomain:errorCode:", v7, @"dataVersion", v4, v6, -1)|| (uint64_t v8 = [v4 decodeInt32ForKey:@"content"], -[BMTestEvent checkAndReportDecodingFailureIfNeededForuint32_t:key:coder:errorDomain:errorCode:](self, "checkAndReportDecodingFailureIfNeededForuint32_t:key:coder:errorDomain:errorCode:", v8, @"content", v4, v6, -1)))
  {
    v9 = 0;
  }
  else
