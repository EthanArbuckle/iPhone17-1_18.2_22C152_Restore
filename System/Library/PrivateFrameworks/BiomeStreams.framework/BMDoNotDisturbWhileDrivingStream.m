...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:8];
}

- (BMDoNotDisturbWhileDrivingStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMDoNotDisturbWhileDrivingStream;
  ...
  if (v2)
  {
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT)) {
        -[BMDoNotDisturbWhileDrivingStream init](v8);
      }
    }
  }
  return v2;
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamDoNotDisturbWhileDriving, please consult error logs for cause", v1, 2u);
}
