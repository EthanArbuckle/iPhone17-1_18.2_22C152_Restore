...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"UserFocusComputedMode"];
}

- (BMUserFocusComputedModeStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMUserFocusComputedModeStream;
  v2 = [(BMUserFocusComputedModeStream *)&v10 init];
  if (v2)
  {
    ...
    if (!v2->_storeStream)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT)) {
        -[BMUserFocusComputedModeStream init](v8);
      }
    }
  }
  return v2;
...
- (id)publisher
{
  ...
  v4 = [(BMUserFocusComputedModeStream *)self identifier];
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamsUserFocusComputedMode, please consult error logs for cause", v1, 2u);
}
