@interface BMSchoolTimeStream
- (BMSchoolTimeStream)init;
- (NSString)identifier;
- (id)publisher;
...
@implementation BMSchoolTimeStream

- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:32];
}

- (BMSchoolTimeStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMSchoolTimeStream;
  v2 = [(BMSchoolTimeStream *)&v10 init];
  if (v2)
  {
...
- (id)publisher
{
  ...
  v4 = [(BMSchoolTimeStream *)self identifier];
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMSchoolTimeStream, please consult error logs for cause", v1, 2u);
}
