...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FB88] streamIdentifierForStream:11];
}

- (BMAlarmStream)init
{
  v10.receiver = self;
  v10.super_class = (Class)BMAlarmStream;
...
{
  *(_WORD *)v1 = 0;
  _os_log_fault_impl(&dword_18E67D000, log, OS_LOG_TYPE_FAULT, "Unable to initialize BMPublicStreamAlarm, please consult error logs for cause", v1, 2u);
}
