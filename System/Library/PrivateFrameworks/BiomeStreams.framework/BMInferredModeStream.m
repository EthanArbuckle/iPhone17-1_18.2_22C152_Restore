...
- (NSString)identifier
{
  return (NSString *)[MEMORY[0x1E4F4FBA8] libraryPathForStreamIdentifier:@"InferredMode"];
}

- (BMInferredModeStream)init
{
  v8.receiver = self;
  v8.super_class = (Class)BMInferredModeStream;
  v2 = [(BMInferredModeStream *)&v8 init];
  if (v2)
  {
    v3 = [BMRestrictedStream alloc];
    v4 = [(BMInferredModeStream *)v2 identifier];
...
- (id)publisher
{
  ...
  v4 = [(BMInferredModeStream *)self identifier];
