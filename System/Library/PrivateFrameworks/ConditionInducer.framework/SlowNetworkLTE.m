...
+ (id)description
{
  return +[SlowNetworkCondition descriptionWithProfileParamsForProfile:@"LTE"];
}
...
- (SlowNetworkLTE)init
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)SlowNetworkLTE;
  v2 = [(SlowNetworkCondition *)&v6 initWithProfile:@"LTE"];
