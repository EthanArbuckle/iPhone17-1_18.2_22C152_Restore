@interface SlowNetworkWiFi80211AC
+ (id)description;
...
+ (id)description
{
  return +[SlowNetworkCondition descriptionWithProfileParamsForProfile:@"Wi-Fi 802.11ac"];
}

+ (id)profileFriendlyName
{
  return @"WiFi Network (802.11ac)";
}
...
- (SlowNetworkWiFi80211AC)init
{
  ...
  v2 = [(SlowNetworkCondition *)&v6 initWithProfile:@"Wi-Fi 802.11ac"];
