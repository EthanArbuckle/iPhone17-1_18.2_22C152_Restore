...
- (AlphanumericPINTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    {
      *(_WORD *)v28 = 0;
      _os_log_impl(&dword_1A6597000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "set devicePasscodeEntry (AlphanumericPINTableViewCell)", v28, 2u);
    }
...
- (void)layoutSubviews
{
  ...
  -[AlphanumericPINTextField sizeThatFits:](self->_pinTextField, "sizeThatFits:", *MEMORY[0x1E4F1DB30], *(double *)(MEMORY[0x1E4F1DB30] + 8));
  double v14 = v13;
  v18.origin.x = v6;
  v18.origin.y = v8;
  v18.size.width = v10;
  v18.size.height = v12;
  float v15 = (CGRectGetHeight(v18) - v14) * 0.5;
