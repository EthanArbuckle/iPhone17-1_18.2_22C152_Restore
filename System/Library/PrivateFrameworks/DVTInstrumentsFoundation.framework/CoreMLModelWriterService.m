...
+ (void)registerCapabilities:(id)a3
{
  ...
  [v4 publishCapability:v5 version:4 forClass:swift_getObjCClassFromMetadata()];
}
...
- (void)dealloc
{
  uint64_t v2 = qword_268707930;
  v3 = self;
  if (v2 != -1) {
    swift_once();
  }
  uint64_t v4 = sub_23093F1E8();
  sub_23091D0F8(v4, (uint64_t)qword_268709110);
  ...
  if (os_log_type_enabled(v6, v5))
  {
    ...
    *(_WORD *)uint64_t v7 = 0;
    _os_log_impl(&dword_23087D000, v6, v5, "ModelWriterService - deinit", v7, 2u);
    MEMORY[0x230FC2BD0](v7, -1, -1);
  }

  v8.receiver = v3;
  v8.super_class = (Class)type metadata accessor for CoreMLModelWriterService();
  [(CoreMLModelWriterService *)&v8 dealloc];
}
