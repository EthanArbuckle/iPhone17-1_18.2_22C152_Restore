...
- (id)initForSelector:(id)a3 withLocalContentURL:(id)a4 withAssetAttributes:(id)a5
{
  ...
  id v11 = a5;
  v17.receiver = self;
  v17.super_class = (Class)MAAutoAssetLock;
...
- (MAAutoAssetLock)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)MAAutoAssetLock;
  v5 = [(MAAutoAssetLock *)&v16 init];
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[MAAutoAssetLock inhibitedFromEmergencyRemoval](self, "inhibitedFromEmergencyRemoval"), @"inhibitedFromEmergencyRemoval");
  id v7 = [(MAAutoAssetLock *)self lockReasons];
...
{
  v3 = NSString;
  id v4 = [(MAAutoAssetLock *)self fullAssetSelector];
  v5 = [v4 summary];
  v6 = [(MAAutoAssetLock *)self localContentURL];
  id v7 = [v6 path];
  ...
  uint64_t v11 = [(MAAutoAssetLock *)self lockReasons];
  v12 = [v11 safeSummary];
