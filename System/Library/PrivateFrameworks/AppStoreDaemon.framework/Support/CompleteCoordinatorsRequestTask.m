...
- (void)main
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v23 = 2114;
    v24 = v6;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "[%@] Checking for incomplete coordinators at request of: %{public}@", buf, 0x16u);
  }
  ...
  uint64_t v19 = sub_1002B2A3C();
  v20 = (void *)v19;
  if (v19) {
    [*(id *)(v19 + 8) addOperation:v9];
  }
