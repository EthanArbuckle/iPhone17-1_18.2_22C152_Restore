...
@implementation XDCPingMessage

- (id)description
{
  v7.receiver = self;
  v7.super_class = (Class)XDCPingMessage;
  v3 = [(XDCPingMessage *)&v7 description];
  v4 = [(XDCPingMessage *)self dictionaryRepresentation];
