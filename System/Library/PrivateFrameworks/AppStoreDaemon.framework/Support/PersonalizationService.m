...
- (void)flushMetricsWithCompletionBlock:(id)a3
{
  ...
  v9 = sub_10031A334();
  sub_10031A4F0((uint64_t)v9, @"User request", v4);
}
...
- (void)getGroupingToken:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    v13 = v8;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "[%{public}@]: getGroupingToken for client: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  if (v4)
  {
...
- (void)getClusterMappingsWithCompletionBlock:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    v13 = v8;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "[%{public}@]: getClusterMappingsWithCompletionBlock for client: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  if (v4)
  {
    v9 = ASDErrorWithDescription();
...
- (void)getAppEventsWithCompletionBlock:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    v13 = v8;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "[%{public}@]: getPersonalizationEventsWithCompletionBlock for client: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  v9 = sub_10031A334();
  sub_10031A5D0((uint64_t)v9, v4);
}
...
- (void)reloadClusterMappingsWithCompletionBlock:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    __int16 v13 = v8;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "[%{public}@]: reloadClusterMappingsWithCompletionBlock for client: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  if (v4)
  {
    v9 = ASDErrorWithDescription();
...
- (void)resetActorIDWithCompletionBlock:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2114;
    __int16 v13 = v8;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "[%{public}@]: resetActorIDWithCompletionBlock for client: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  v9 = sub_10031A334();
  sub_10031B71C((uint64_t)v9, v4);
}
...
- (void)setClusterMapping:(id)a3 completionBlock:(id)a4
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2114;
    v14 = v9;
    _os_log_impl((void *)&_mh_execute_header, v6, OS_LOG_TYPE_DEFAULT, "[%{public}@]: setClusterMapping for client: %{public}@", (uint8_t *)&v11, 0x16u);
  }
  if (v5)
  {
    int v10 = ASDErrorWithDescription();
...
- (void)tasteProfileFeatureEnabledWithCompletionBlock:(id)a3
{
  ...
  {
    id v5 = a3;
    BOOL v4 = sub_1003F28C4();
    (*((void (**)(id, BOOL, void))a3 + 2))(v5, v4, 0);
  }
}
