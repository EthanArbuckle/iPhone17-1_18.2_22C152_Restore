...
{
  v7.receiver = self;
  v7.super_class = (Class)XDCInstallRequest;
  v3 = [(XDCInstallRequest *)&v7 description];
  v4 = [(XDCInstallRequest *)self dictionaryRepresentation];
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      ...
      sub_1003E26A0((uint64_t)self, v13);
