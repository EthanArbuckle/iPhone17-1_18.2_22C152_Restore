...
{
  v7.receiver = self;
  v7.super_class = (Class)TFUploadFeedbackResponse;
  v3 = [(TFUploadFeedbackResponse *)&v7 description];
  v4 = [(TFUploadFeedbackResponse *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(NSData *)self->_submissionId copyWithZone:a3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    submissionId = self->_submissionId;
    if ((unint64_t)submissionId | v4[1]) {
      unsigned __int8 v6 = -[NSData isEqual:](submissionId, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSData *)self->_submissionId hash];
}
