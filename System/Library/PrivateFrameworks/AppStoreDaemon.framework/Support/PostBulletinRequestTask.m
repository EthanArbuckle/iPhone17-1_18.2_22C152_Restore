...
- (void)main
{
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v63 = 2112;
    v64 = v12;
    _os_log_impl((void *)&_mh_execute_header, (os_log_t)&_os_log_default, OS_LOG_TYPE_INFO, "[%@]: Posting bulletin with title: %@ message: %@ for client %@", (uint8_t *)&v57, 0x2Au);
  }
  if (self) {
  ...
  v19 = sub_10032EF98((uint64_t)Bulletin, v15, v18);
