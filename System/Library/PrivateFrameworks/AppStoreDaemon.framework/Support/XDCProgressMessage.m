...
@implementation XDCProgressMessage

- (id)description
{
  v7.receiver = self;
  v7.super_class = (Class)XDCProgressMessage;
  v3 = [(XDCProgressMessage *)&v7 description];
  v4 = [(XDCProgressMessage *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_progress, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    ...
    [v3 setObject:v4 forKey:@"progress"];
  }
  return v3;
}
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      long long v13 = objc_alloc_init(XDCProgress);
      sub_10033B970((uint64_t)self, v13);
      if (!PBReaderPlaceMark() || (sub_1002C3F88((uint64_t)v13, (uint64_t)a3) & 1) == 0)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  unsigned int v6 = self->_progress;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)progress | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](progress, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_progress hash];
}
