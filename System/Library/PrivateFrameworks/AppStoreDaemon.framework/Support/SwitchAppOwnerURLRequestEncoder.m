...
{
  v6.receiver = self;
  v6.super_class = (Class)SwitchAppOwnerURLRequestEncoder;
  v3 = [(SwitchAppOwnerURLRequestEncoder *)&v6 initWithBag:a3];
  v4 = v3;
  if (v3) {
    [(SwitchAppOwnerURLRequestEncoder *)v3 setUrlKnownToBeTrusted:1];
  }
  return v4;
}
...
- (id)requestByEncodingRequest:(id)a3 parameters:(id)a4
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SwitchAppOwnerURLRequestEncoder;
