...
- (id)SQLForEntityClass:(Class)a3
{
    ...
    if (v7)
    {
      ...
      do
      {
        for (i = 0; i != v8; i = (char *)i + 1)
        {
          ...
          v11 = objc_msgSend(*(id *)(*((void *)&v13 + 1) + 8 * i), "SQLForEntityClass:", a3, (void)v13);
          if (v11)
          {
  ...
  {
    id v5 = +[NSMutableString stringWithString:@"1"];
  }
  return v5;
}
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; i = (char *)i + 1)
      {
        ...
        long long v16 = +[SQLiteComparisonPredicate predicateWithProperty:value:comparisonType:](SQLiteComparisonPredicate, "predicateWithProperty:value:comparisonType:", v8, *(void *)(*((void *)&v19 + 1) + 8 * i), a5, (void)v19);
        [v10 addObject:v16];
      }
...
- (unint64_t)hash
{
  ...
  id v5 = [(SQLiteCompoundPredicate *)self predicates];
