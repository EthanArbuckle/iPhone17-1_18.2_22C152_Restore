  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v31;
      _os_log_debug_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_DEBUG, "Items request received auth challenge for:%{public}@ but found no notification client to pass on to. Attempting internal auth", buf, 0xCu);
