...
- (ASDInstallManifestRequestResponse)initWithResults:(id)a3
{
  ...
  if (!*((unsigned char *)v13 + 24))
  {
    ...
    v9.receiver = self;
    v9.super_class = (Class)ASDInstallManifestRequestResponse;
  ...
  v10.receiver = self;
  v10.super_class = (Class)ASDInstallManifestRequestResponse;
...
uint64_t __53__ASDInstallManifestRequestResponse_initWithResults___block_invoke(uint64_t result, void *a2, uint64_t a3, unsigned char *a4)
{
  uint64_t v5 = result;
...
{
  v6.receiver = self;
  v6.super_class = (Class)ASDInstallManifestRequestResponse;
  id v4 = [(ASDRequestResponse *)&v6 copyWithZone:a3];
...
- (ASDInstallManifestRequestResponse)initWithCoder:(id)a3
{
  ...
  objc_super v9 = [(ASDInstallManifestRequestResponse *)self initWithResults:v8];
  return v9;
}
