...
- (HKHRCardioFitnessOnboardingStatus)initWithState:(int64_t)a3 unavailableReasons:(int64_t)a4 dateOnboarded:(id)a5 shouldOnboardingTileBeAdvertised:(BOOL)a6 isLocaleValidOnLocalDevice:(BOOL)a7 isClassificationAvailable:(BOOL)a8
{
  id v15 = a5;
  v19.receiver = self;
  v19.super_class = (Class)HKHRCardioFitnessOnboardingStatus;
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HKHRCardioFitnessOnboardingStatus *)a3;
  if (self == v4)
  {
    BOOL v7 = 1;
  }
...
- (HKHRCardioFitnessOnboardingStatus)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HKHRCardioFitnessOnboardingStatus;
  id v5 = [(HKHRCardioFitnessOnboardingStatus *)&v9 init];
  if (v5)
  {
