...
- (HKHRAFibBurdenWatchSettings)initWithSettingVisible:(BOOL)a3 settingEnabled:(BOOL)a4 statusText:(id)a5 footer:(id)a6
{
  ...
  if (v12)
  {
    [(HKHRAFibBurdenWatchSettings *)v12 setSettingVisible:v8];
    [(HKHRAFibBurdenWatchSettings *)v13 setSettingEnabled:v7];
    [(HKHRAFibBurdenWatchSettings *)v13 setStatusText:v10];
    [(HKHRAFibBurdenWatchSettings *)v13 setFooter:v11];
    v14 = v13;
  }
