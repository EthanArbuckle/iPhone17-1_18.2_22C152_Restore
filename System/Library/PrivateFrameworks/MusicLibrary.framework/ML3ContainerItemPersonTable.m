...
- (id)columns
{
  ...
  if (!columns)
  {
    ...
    v5 = +[ML3DatabaseColumn columnWithName:@"container_item_pid", 2, 16, &unk_1F09124A8, v4 datatype constraints defaultValue];
    v10[1] = v5;
    v6 = +[ML3DatabaseColumn columnWithName:@"person_pid" datatype:2 constraints:16 defaultValue:&unk_1F09124A8];
    v10[2] = v6;
