...
- (BOOL)registerWithConnection:(id)a3
{
  ...
  if (self->_functionPointer)
  {
    ...
    LODWORD(v6) = sqlite3_create_function_v2(v6, (const char *)[v7 UTF8String], -[ML3DatabaseFunction argumentCount](self, "argumentCount"), 2049, -[ML3DatabaseFunctionPointer userData](self, "userData"), (void (__cdecl *)(sqlite3_context *, int, sqlite3_value **))self->_functionPointer, 0, 0, 0);
