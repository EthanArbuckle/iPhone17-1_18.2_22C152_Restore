...
uint64_t __36__ASFAssistantMetrics_sharedMetrics__block_invoke()
{
  sharedMetrics_sSharedMetrics = objc_alloc_init(ASFAssistantMetrics);
...
+ (void)didVisit
{
  id v2 = +[ASFAssistantMetrics sharedMetrics];
  [v2 logVisit];
}
...
+ (void)didEnableSiriConfirmed:(BOOL)a3 source:(id)a4
{
  BOOL v4 = a3;
  id v5 = a4;
  id v6 = +[ASFAssistantMetrics sharedMetrics];
...
{
  BOOL v3 = a3;
  id v4 = +[ASFAssistantMetrics sharedMetrics];
...
+ (void)didDetailToggle:(id)a3 bundleId:(id)a4 on:(BOOL)a5
{
  ...
  id v7 = a4;
  id v8 = a3;
  id v9 = +[ASFAssistantMetrics sharedMetrics];
...
- (id)__enableSiriTracker
{
  ...
  if (!enableSiriTracker)
  {
    ...
    BOOL v5 = [(ASFAssistantMetrics *)self __siriSourceProperty];
    v11[0] = v5;
    id v6 = [(ASFAssistantMetrics *)self __confirmedTrueFalseProperty];
    v11[1] = v6;
...
- (id)__toggleTracker
{
  ...
  {
    id v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    BOOL v5 = [(ASFAssistantMetrics *)self __toggleTrackerNameProperty];
    v11[0] = v5;
    id v6 = [(ASFAssistantMetrics *)self __onOffProperty];
    v11[1] = v6;
    id v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:2];
...
- (id)__startEnrollmentTracker
{
  ...
  {
    id v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    BOOL v5 = [(ASFAssistantMetrics *)self __confirmedTrueFalseProperty];
    v10[0] = v5;
...
- (id)__detailVisitFoundInAppsTracker
{
  ...
  {
    id v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    BOOL v5 = [(ASFAssistantMetrics *)self __foundInAppsProperty];
    v10[0] = v5;
    id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v10 count:1];
...
- (id)__detailToggleFoundInAppsTracker
{
  ...
  {
    id v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    BOOL v5 = [(ASFAssistantMetrics *)self __detailToggleTrackerNameProperty];
    id v6 = [(ASFAssistantMetrics *)self __foundInAppsProperty];
    v12[1] = v6;
    id v7 = [(ASFAssistantMetrics *)self __onOffProperty];
    v12[2] = v7;
...
- (id)__detailToggleSearchTracker
{
  ...
  {
    id v4 = objc_alloc((Class)getPETScalarEventTrackerClass());
    BOOL v5 = [(ASFAssistantMetrics *)self __onOffProperty];
    v10[0] = v5;
    id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v10 count:1];
