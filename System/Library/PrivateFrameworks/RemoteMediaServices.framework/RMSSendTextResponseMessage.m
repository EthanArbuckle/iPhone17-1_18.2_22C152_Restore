@interface RMSSendTextResponseMessage
...
@implementation RMSSendTextResponseMessage
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSSendTextResponseMessage;
  v4 = [(RMSSendTextResponseMessage *)&v8 description];
  v5 = [(RMSSendTextResponseMessage *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return RMSSendTextResponseMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
