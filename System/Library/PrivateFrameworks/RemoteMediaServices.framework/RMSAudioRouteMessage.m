...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSAudioRouteMessage;
...
- (BOOL)readFrom:(id)a3
{
  return RMSAudioRouteMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_macAddress != *((void *)v4 + 1)) {
      goto LABEL_19;
    }
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[RMSAudioRouteMessage setDisplayName:](self, "setDisplayName:");
    id v4 = v6;
  }
