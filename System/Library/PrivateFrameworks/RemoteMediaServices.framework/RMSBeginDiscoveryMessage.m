...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSBeginDiscoveryMessage;
  id v4 = [(RMSBeginDiscoveryMessage *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return RMSBeginDiscoveryMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(RMSBeginDiscoveryMessage *)self pairedNetworkNamesCount])
  {
    ...
    unint64_t v5 = [(RMSBeginDiscoveryMessage *)self pairedNetworkNamesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(RMSBeginDiscoveryMessage *)self pairedNetworkNamesAtIndex:i];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (has)
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_discoveryTypes != *((_DWORD *)v4 + 2)) {
      goto LABEL_12;
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[RMSBeginDiscoveryMessage addPairedNetworkNames:](self, "addPairedNetworkNames:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
