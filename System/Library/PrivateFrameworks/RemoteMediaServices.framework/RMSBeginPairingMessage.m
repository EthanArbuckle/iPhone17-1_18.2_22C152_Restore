...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSBeginPairingMessage;
...
- (BOOL)readFrom:(id)a3
{
  return RMSBeginPairingMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  NSUInteger v4 = a3;
  if (v4[1]) {
    -[RMSBeginPairingMessage setAppName:](self, "setAppName:");
  }
  if (v4[3]) {
    -[RMSBeginPairingMessage setDeviceName:](self, "setDeviceName:");
  }
  if (v4[2]) {
    -[RMSBeginPairingMessage setDeviceModel:](self, "setDeviceModel:");
  }
  if (v4[4]) {
    -[RMSBeginPairingMessage setPasscode:](self, "setPasscode:");
  }
}
