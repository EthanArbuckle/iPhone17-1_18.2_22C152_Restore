...
{
  v12.receiver = self;
  v12.super_class = (Class)RMSLegacyDAAPControlSession;
  v2 = [(RMSLegacyDAAPControlSession *)&v12 init];
  if (v2)
  {
    uint64_t v3 = objc_opt_new();
    requestManager = v2->_requestManager;
    v2->_requestManager = (RMSDAAPRequestManager *)v3;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)RMSLegacyDAAPControlSession;
...
- (void)connectToService:(id)a3 pairingGUID:(id)a4 allowPairing:(BOOL)a5 completionHandler:(id)a6
{
  ...
  -[RMSDAAPRequestManager setPort:](self->_requestManager, "setPort:", (int)[v10 port]);
...
uint64_t __91__RMSLegacyDAAPControlSession_connectToService_pairingGUID_allowPairing_completionHandler___block_invoke_2(uint64_t a1, uint64_t a2)
{
...
- (void)logout
{
  ...
  id v3 = [(RMSDAAPRequestManager *)self->_requestManager requestWithPath:v4 method:@"GET" postData:0 queryArgs:0 completionHandler:0];
}
...
- (void)sendPlaybackCommand:(int64_t)a3 completionHandler:(id)a4
{
  id v6 = a4;
  v7 = NSString;
  id v8 = [(RMSLegacyDAAPControlSession *)self _stringFromRMSPlaybackCommand:a3];
  ...
  id v11 = v6;
  id v14 = v11;
  id v12 = [(RMSDAAPRequestManager *)requestManager requestWithPath:v9 method:@"POST" postData:0 queryArgs:0 completionHandler:v13];
  if ((unint64_t)(a3 - 5) <= 1
    && [(RMSDAAPNowPlayingManager *)self->_nowPlayingManager isObserving])
  {
    [(RMSDAAPNowPlayingManager *)self->_nowPlayingManager endObservingNowPlaying];
...
- (void)setVolume:(float)a3 completionHandler:(id)a4
{
  ...
  id v14 = v6;
  id v11 = v6;
  id v12 = [(RMSDAAPRequestManager *)requestManager requestWithPath:v7 method:@"POST" postData:0 queryArgs:v10 completionHandler:v13];
}
...
- (void)pickAudioRoute:(id)a3 completionHandler:(id)a4
{
  ...
  id v18 = v6;
  id v15 = v6;
  id v16 = [(RMSDAAPRequestManager *)requestManager requestWithPath:v9 method:@"POST" postData:0 queryArgs:v14 completionHandler:v17];
}
...
- (void)seekToPlaybackTime:(int)a3 completionHandler:(id)a4
{
  ...
  id v14 = v6;
  id v11 = v6;
  id v12 = [(RMSDAAPRequestManager *)requestManager requestWithPath:v7 method:@"POST" postData:0 queryArgs:v9 completionHandler:v13];
}
...
- (void)setLikedState:(int64_t)a3 itemID:(unint64_t)a4 databaseID:(unint64_t)a5 completionHandler:(id)a6
{
  ...
  id v20 = v10;
  id v17 = v10;
  id v18 = [(RMSDAAPRequestManager *)requestManager requestWithPath:v11 method:@"POST" postData:0 queryArgs:v15 completionHandler:v19];
}
...
- (void)addToWishlist:(unint64_t)a3 databaseID:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  v16[1] = 3221225472;
  void v16[2] = __74__RMSLegacyDAAPControlSession_addToWishlist_databaseID_completionHandler___block_invoke;
  v16[3] = &unk_264E744B0;
  id v17 = v8;
  id v14 = v8;
  id v15 = [(RMSDAAPRequestManager *)requestManager requestWithPath:v9 method:@"POST" postData:0 queryArgs:v12 completionHandler:v16];
}
...
- (void)nowPlayingManager:(id)a3 didUpdateNowPlayingInfo:(id)a4
{
  id v5 = (RMSNowPlayingInfo *)a4;
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  [WeakRetained controlSession:self didUpdateNowPlayingInfo:v5];

  if ([(RMSNowPlayingInfo *)self->_nowPlayingInfo revisionNumber] >= 1
    && ![(RMSNowPlayingInfo *)v5 revisionNumber])
  {
...
- (void)_initializeManagersWithControlInterface:(id)a3 completionHandler:(id)a4
{
  ...
  if (nowPlayingManager)
  {
    ...
    id v8 = [(RMSDAAPRequestManager *)self->_requestManager requestWithPath:@"playqueue-contents" method:@"POST" postData:0 queryArgs:0 completionHandler:0];
  }
  else
  {
