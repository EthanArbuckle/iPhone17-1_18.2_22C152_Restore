...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSSetVolumeMessage;
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v7 = [NSNumber numberWithInt:self->_sessionIdentifier];
...
- (BOOL)readFrom:(id)a3
{
  return RMSSetVolumeMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (unint64_t)hash
{
  ...
  if (has) {
    uint64_t v9 = 2654435761 * self->_sessionIdentifier;
  }
  else {
    uint64_t v9 = 0;
  }
