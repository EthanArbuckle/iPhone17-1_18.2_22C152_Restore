...
- (BOOL)startServerWithExpectedPasscodeHash:(id)a3 advertisedDeviceName:(id)a4 advertisedDeviceModel:(id)a5
{
  ...
  long long v20 = xmmword_26F07F400;
  long long v21 = *(_OWORD *)off_26F07F410;
  v22 = off_26F07F420;
  ...
  if (Service)
  {
    v14 = (OS_dispatch_queue *)dispatch_queue_create("com.apple.RemoteMediaServices.DAAPPairing", MEMORY[0x263EF83A8]);
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 67109120;
      int v26 = port;
      _os_log_impl(&dword_23C83A000, v17, OS_LOG_TYPE_DEFAULT, "HTTP server for pin-pairing exchange started on port %u", buf, 8u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR)) {
      -[RMSPairingServer startServerWithExpectedPasscodeHash:advertisedDeviceName:advertisedDeviceModel:](v16);
    }
  }
...
- (void)stopServer
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl(&dword_23C83A000, v3, OS_LOG_TYPE_DEFAULT, "Stopping HTTP server", v6, 2u);
  }
...
uint64_t __30__RMSPairingServer_stopServer__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
- (void)handleHTTPServerInvalidated
{
  ...
  {
    *(_WORD *)v3 = 0;
    _os_log_impl(&dword_23C83A000, v2, OS_LOG_TYPE_DEFAULT, "HTTP server invalidated", v3, 2u);
  }
}
...
- (void)handleHTTPServerDidReceiveError:(__CFError *)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
    -[RMSPairingServer handleHTTPServerDidReceiveError:]((uint64_t)a3, v5);
  }
...
- (void)handleHTTPServerDidOpenConnection:(_CFHTTPServerConnection *)a3
{
  ...
  {
    LOWORD(v6[0]) = 0;
    _os_log_impl(&dword_23C83A000, v5, OS_LOG_TYPE_DEFAULT, "HTTP server opened connection", (uint8_t *)v6, 2u);
  }
  ...
  uint64_t v11 = 0;
  v6[0] = xmmword_26F07F448;
  v6[1] = *(_OWORD *)&off_26F07F458;
  v6[2] = xmmword_26F07F468;
...
- (void)handleHTTPServerConnectionInvalidated
{
  ...
  {
    *(_WORD *)v3 = 0;
    _os_log_impl(&dword_23C83A000, v2, OS_LOG_TYPE_DEFAULT, "HTTP connection invalidated", v3, 2u);
  }
}
...
- (void)handleHTTPServerConnectionDidReceiveError:(__CFError *)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v5 = 138412290;
    v6 = a3;
    _os_log_impl(&dword_23C83A000, v4, OS_LOG_TYPE_DEFAULT, "HTTP connection error: %@", (uint8_t *)&v5, 0xCu);
  }
}
...
- (void)handleHTTPServerConnectionDidReceiveRequest:(_CFHTTPServerRequest *)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_23C83A000, v6, OS_LOG_TYPE_DEFAULT, "HTTP server received pairing request", buf, 2u);
  }
  ...
  id v7 = v5;
  id v37 = v7;
  v8 = (void (**)(void, void, void))MEMORY[0x23ECE8BF0](v36);
          ...
          && [v16 isEqualToString:self->_expectedPasscodeHash])
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v41 = 2112;
            v42 = v27;
            _os_log_impl(&dword_23C83A000, v26, OS_LOG_TYPE_DEFAULT, "Received successful pairing request from %@; pairing GUID is %@.",
              buf,
              0x16u);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138412802;
            ...
            _os_log_impl(&dword_23C83A000, v28, OS_LOG_TYPE_DEFAULT, "Received unsuccessful pairing request from %@; received passcode hash %@ but expected %@.",
              buf,
              0x20u);
          }
...
- (void)handleHTTPServerConnectionDidReplyToRequest:(_CFHTTPServerRequest *)a3 withResponse:(_CFHTTPServerResponse *)a4
{
  ...
  {
    *(_WORD *)v8 = 0;
    _os_log_impl(&dword_23C83A000, v5, OS_LOG_TYPE_DEFAULT, "HTTP server did reply to request", v8, 2u);
  }
...
- (void)handleHTTPServerConnectionDidFailToReplyToRequest:(_CFHTTPServerRequest *)a3 withResponse:(_CFHTTPServerResponse *)a4
{
  ...
  {
    *(_WORD *)uint64_t v5 = 0;
    _os_log_impl(&dword_23C83A000, v4, OS_LOG_TYPE_DEFAULT, "HTTP server failed to reply to request", v5, 2u);
  }
}
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (RMSPairingServerDelegate *)WeakRetained;
}
...
- (void)startServerWithExpectedPasscodeHash:(os_log_t)log advertisedDeviceName:advertisedDeviceModel:.cold.1(os_log_t log)
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_23C83A000, log, OS_LOG_TYPE_ERROR, "Failed to start HTTP server for pin-pairing exchange", v1, 2u);
}
...
- (void)handleHTTPServerDidReceiveError:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_23C83A000, a2, OS_LOG_TYPE_ERROR, "HTTP server error: %@", (uint8_t *)&v2, 0xCu);
}
