...
- (RMSDAAPRequestManager)init
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)RMSDAAPRequestManager;
...
- (id)requestWithPath:(id)a3 method:(id)a4 postData:(id)a5 queryArgs:(id)a6 completionHandler:(id)a7
{
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v61 = 2112;
    v62 = v42;
    _os_log_impl(&dword_23C83A000, v40, OS_LOG_TYPE_DEFAULT, "%@/ %@", buf, 0x16u);
  }
    ...
    if (v11 != -1001)
    {
      if (v11 == -999)
      {
        ...
        if (os_log_type_enabled(WeakRetained, OS_LOG_TYPE_DEFAULT))
        {
          ...
          int v27 = 138412290;
          uint64_t v28 = v13;
          _os_log_impl(&dword_23C83A000, WeakRetained, OS_LOG_TYPE_DEFAULT, "Request was cancelled: %@", (uint8_t *)&v27, 0xCu);
        }
      }
      else
      {
        uint64_t v22 = RMSLogger();
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          ...
          __int16 v29 = 2112;
          uint64_t v30 = v23;
          _os_log_impl(&dword_23C83A000, v22, OS_LOG_TYPE_DEFAULT, "Unexpected error [%@]: %@", (uint8_t *)&v27, 0x16u);
        }
...
LABEL_27:
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v27 = 138412290;
      uint64_t v28 = v20;
      _os_log_impl(&dword_23C83A000, v19, OS_LOG_TYPE_DEFAULT, "Request timed out: %@", (uint8_t *)&v27, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v29 = 2112;
      uint64_t v30 = v16;
      _os_log_impl(&dword_23C83A000, v14, OS_LOG_TYPE_DEFAULT, "HTTP response code [%zd] for [%@]", (uint8_t *)&v27, 0x16u);
    }
...
- (id)requestControlCommand:(id)a3 text:(id)a4 promptRevision:(int64_t)a5 completionHandler:(id)a6
{
  ...
  id v11 = a4;
  id v12 = a6;
  uint64_t v13 = objc_msgSend(NSString, "stringWithFormat:", @"%s/1/%s", "ctrl-int", "controlpromptentry");
  id v14 = objc_opt_new();
  uint64_t v15 = v14;
  if (v10) {
  ...
  id v23 = v12;
  id v19 = v12;
  uint64_t v20 = [(RMSDAAPRequestManager *)self requestWithPath:v13 method:@"POST" postData:v16 queryArgs:v18 completionHandler:v22];
...
- (RMSDAAPRequestManagerDelegate)delegate
{
  ...
  return (RMSDAAPRequestManagerDelegate *)WeakRetained;
}
