...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSNowPlayingArtworkAvailableMessage;
...
- (BOOL)readFrom:(id)a3
{
  return RMSNowPlayingArtworkAvailableMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[RMSNowPlayingArtworkAvailableMessage setArtworkIdentifier:](self, "setArtworkIdentifier:");
    id v4 = v5;
  }
}
