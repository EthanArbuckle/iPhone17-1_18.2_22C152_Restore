...
- (id)description
{
  __int16 v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSNowPlayingInfoMessage;
...
- (BOOL)readFrom:(id)a3
{
  return RMSNowPlayingInfoMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 11))
  {
    -[RMSNowPlayingInfoMessage setTrackName:](self, "setTrackName:");
    id v4 = v7;
  }
  if (*((void *)v4 + 7))
  {
    -[RMSNowPlayingInfoMessage setArtistName:](self, "setArtistName:");
    id v4 = v7;
  }
  if (*((void *)v4 + 6))
  {
    -[RMSNowPlayingInfoMessage setAlbumName:](self, "setAlbumName:");
    id v4 = v7;
  }
  __int16 v6 = *((_WORD *)v4 + 52);
  if ((v6 & 8) != 0)
