...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSNowPlayingArtworkRequestMessage;
...
- (BOOL)readFrom:(id)a3
{
  return RMSNowPlayingArtworkRequestMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[RMSNowPlayingArtworkRequestMessage setArtworkIdentifier:](self, "setArtworkIdentifier:");
    id v4 = v6;
  }
