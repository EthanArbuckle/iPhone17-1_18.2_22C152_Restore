...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSAudioRoutesDidUpdateMessage;
  id v4 = [(RMSAudioRoutesDidUpdateMessage *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return RMSAudioRoutesDidUpdateMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearAudioRoutes];
    unint64_t v5 = [(RMSAudioRoutesDidUpdateMessage *)self audioRoutesCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(RMSAudioRoutesDidUpdateMessage *)self audioRoutesAtIndex:i];
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[RMSAudioRoutesDidUpdateMessage addAudioRoutes:](self, "addAudioRoutes:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
