...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSNowPlayingInfoDidUpdateMessage;
...
- (BOOL)readFrom:(id)a3
{
  return RMSNowPlayingInfoDidUpdateMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v7 = [(RMSNowPlayingInfoMessage *)self->_nowPlayingInfo copyWithZone:a3];
...
LABEL_9:
  ...
  if ((unint64_t)nowPlayingInfo | *((void *)v4 + 1)) {
    char v6 = -[RMSNowPlayingInfoMessage isEqual:](nowPlayingInfo, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    if (v7) {
      -[RMSNowPlayingInfoMessage mergeFrom:](nowPlayingInfo, "mergeFrom:");
    }
  }
  else if (v7)
  {
    -[RMSNowPlayingInfoDidUpdateMessage setNowPlayingInfo:](self, "setNowPlayingInfo:");
  }
  MEMORY[0x270F9A758]();
}
