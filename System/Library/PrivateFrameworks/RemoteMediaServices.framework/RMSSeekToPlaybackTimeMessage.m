@interface RMSSeekToPlaybackTimeMessage
...
@implementation RMSSeekToPlaybackTimeMessage
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)RMSSeekToPlaybackTimeMessage;
  v4 = [(RMSSeekToPlaybackTimeMessage *)&v8 description];
  v5 = [(RMSSeekToPlaybackTimeMessage *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return RMSSeekToPlaybackTimeMessageReadFrom((uint64_t)self, (uint64_t)a3);
}
