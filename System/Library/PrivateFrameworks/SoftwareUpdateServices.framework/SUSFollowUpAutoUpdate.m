...
+ (id)titleWithDescriptor:(id)a3
{
  ...
  v5 = v4;
  if (v3) {
    v6 = @"AUTO_SU_FOLLOW_UP_TEXT_RSR_TONIGHT";
  }
  else {
    v6 = @"AUTO_SU_FOLLOW_UP_TEXT_SU_TONIGHT";
  }
  v7 = [v4 localizedStringForKey:v6 value:&stru_26CE93248 table:@"SoftwareUpdateServices"];
...
+ (id)informativeTextWithDescriptor:(id)a3
{
  ...
  if (v11)
  {
    ...
    v14 = [v13 localizedStringForKey:@"AUTO_SU_READY_TO_INSTALL" value:&stru_26CE93248 table:@"SoftwareUpdateServices"];
  ...
  else
  {
    ...
    v13 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/PrivateFrameworks/SoftwareUpdateServices.framework"];
    v15 = [v13 localizedStringForKey:@"AUTO_SU_READY_TO_INSTALL_FALLBACK" value:&stru_26CE93248 table:@"SoftwareUpdateServices"];
  }
...
+ (id)extensionIdentifier
{
  return @"com.apple.SoftwareUpdateServices.SUSFollowUpExtension";
}
...
+ (id)notificationWithDescriptor:(id)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v7 = [(id)objc_opt_class() notificationInstallNowAction];
    [v4 setActivateAction:v7];

    uint64_t v8 = [(id)objc_opt_class() notificationInstallLater];
...
+ (id)notificationInstallNowAction
{
  ...
  if (v2)
  {
    ...
    id v4 = NSString;
    uint64_t v5 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/PrivateFrameworks/SoftwareUpdateServices.framework"];
    uint64_t v6 = [v5 localizedStringForKey:@"AUTO_SU_INSTALL_NOW" value:&stru_26CE93248 table:@"SoftwareUpdateServices"];
    uint64_t v7 = [v4 stringWithFormat:v6];
    [v3 setLabel:v7];
  }
  return v3;
...
+ (id)notificationInstallLater
{
  ...
  if (v2)
  {
    ...
    id v4 = NSString;
    uint64_t v5 = [MEMORY[0x263F086E0] bundleWithPath:@"/System/Library/PrivateFrameworks/SoftwareUpdateServices.framework"];
    uint64_t v6 = [v5 localizedStringForKey:@"AUTO_SU_INSTALL_LATER" value:&stru_26CE93248 table:@"SoftwareUpdateServices"];
    uint64_t v7 = [v4 stringWithFormat:v6];
    [v3 setLabel:v7];
  }
  return v3;
