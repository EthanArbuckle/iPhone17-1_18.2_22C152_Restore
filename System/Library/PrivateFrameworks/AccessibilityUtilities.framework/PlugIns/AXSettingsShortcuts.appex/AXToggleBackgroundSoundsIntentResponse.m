...
- (AXToggleBackgroundSoundsIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4;
- (int64_t)code;
...
- (AXToggleBackgroundSoundsIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  id v6 = a4;
  v10.receiver = self;
  v10.super_class = (Class)AXToggleBackgroundSoundsIntentResponse;
  v7 = [(AXToggleBackgroundSoundsIntentResponse *)&v10 init];
  v8 = v7;
  if (v7)
  {
    v7->_code = a3;
    [(AXToggleBackgroundSoundsIntentResponse *)v7 setUserActivity:v6];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)a3
{
  ...
  [(AXToggleBackgroundSoundsIntentResponse *)v4 setState:a3];
