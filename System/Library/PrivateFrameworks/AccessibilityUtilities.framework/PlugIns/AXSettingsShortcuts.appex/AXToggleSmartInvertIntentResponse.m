...
- (AXToggleSmartInvertIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4;
- (int64_t)code;
...
- (AXToggleSmartInvertIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  id v6 = a4;
  v10.receiver = self;
  v10.super_class = (Class)AXToggleSmartInvertIntentResponse;
  v7 = [(AXToggleSmartInvertIntentResponse *)&v10 init];
  v8 = v7;
  if (v7)
  {
    v7->_code = a3;
    [(AXToggleSmartInvertIntentResponse *)v7 setUserActivity:v6];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)a3
{
  ...
  [(AXToggleSmartInvertIntentResponse *)v4 setState:a3];
