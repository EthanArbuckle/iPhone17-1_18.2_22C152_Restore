...
+ (id)confirmationRequiredWithOperationToConfirm:(int64_t)a3;
+ (id)successWithResolvedOperation:(int64_t)a3;
@end
...
{
  v5.receiver = a1;
  v5.super_class = (Class)&OBJC_METACLASS___AXOperationResolutionResult;
