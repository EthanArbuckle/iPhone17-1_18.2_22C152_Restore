...
+ (id)axGameControllerInfoRepresentationFromEvent:(__IOHIDEvent *)a3
{
  ...
  if (v24 != 0.0)
  {
    ...
    {
      case 547:
        [(AXEventGameControllerInfoRepresentation *)v3 setHomeButton:(double)IOHIDEventGetIntegerValue()];
        break;
      case 521:
        [(AXEventGameControllerInfoRepresentation *)v3 setViewButton:(double)IOHIDEventGetIntegerValue()];
        break;
      case 516:
        [(AXEventGameControllerInfoRepresentation *)v3 setMenuButton:(double)IOHIDEventGetIntegerValue()];
        break;
    }
  }
