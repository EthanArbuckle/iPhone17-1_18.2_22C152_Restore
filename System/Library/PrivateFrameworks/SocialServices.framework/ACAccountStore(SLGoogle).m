...
- (void)sl_openGoogleAuthenticationSheetWithAccountDescription:()SLGoogle completion:
{
  ...
  v10 = (void *)[objc_alloc(MEMORY[0x263EFB1F8]) initWithAccountType:v9];
...
{
  id v8 = a5;
  uint64_t v9 = *MEMORY[0x263EFAEE8];
  id v10 = a4;
  id v11 = a3;
  v12 = [a1 accountTypeWithAccountTypeIdentifier:v9];
  id v13 = (void *)[objc_alloc(MEMORY[0x263EFB1F8]) initWithAccountType:v12];
  [v13 setUsername:v11];
