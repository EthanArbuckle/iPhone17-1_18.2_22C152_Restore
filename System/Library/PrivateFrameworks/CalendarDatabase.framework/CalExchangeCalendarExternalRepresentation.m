...
+ (id)logHandle
{
  if (logHandle_onceToken_0 != -1) {
    dispatch_once(&logHandle_onceToken_0, &__block_literal_global_21);
  }
...
{
  os_log_t v0 = os_log_create("com.apple.calendar.database", "CalExchangeCalendarExternalRepresentation");
  uint64_t v1 = logHandle_logHandle_0;
...
+ (id)externalRepresentationDataWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      +[CalExchangeCalendarExternalRepresentation externalRepresentationDataWithDictionary:]((uint64_t)v5, v7, v8, v9, v10, v11, v12, v13);
    }
  }
  return v4;
}
...
+ (id)dictionaryWithExternalRepresentationData:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      +[CalExchangeCalendarExternalRepresentation dictionaryWithExternalRepresentationData:]((uint64_t)v6, v5, v9, v10, v11, v12, v13, v14);
    }
    goto LABEL_10;
  }
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      +[CalExchangeCalendarExternalRepresentation dictionaryWithExternalRepresentationData:v7];
    }
...
+ (void)dictionaryWithExternalRepresentationData:(os_log_t)log .cold.3(uint64_t a1, uint8_t *buf, os_log_t log)
{
  ...
  *(void *)(buf + 4) = a1;
  _os_log_error_impl(&dword_1A8E81000, log, OS_LOG_TYPE_ERROR, "Got unexpected data type (%{public}@) after deserializing Exchange calendar external representation data", buf, 0xCu);
}
