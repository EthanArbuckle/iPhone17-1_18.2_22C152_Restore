...
- (FCCAchievementNotificationClient)initWithQueue:(id)a3 xpcClient:(id)a4;
- (void)_postAchievementNotification:(id)a3 completion:(id)a4;
- (void)postAchievementNotification:(id)a3 completion:(id)a4;
@end
...
- (FCCAchievementNotificationClient)initWithQueue:(id)a3 xpcClient:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)FCCAchievementNotificationClient;
...
uint64_t __75__FCCAchievementNotificationClient_postAchievementNotification_completion___block_invoke(uint64_t a1)
{
  return [*(id *)(a1 + 32) _postAchievementNotification:*(void *)(a1 + 40) completion:*(void *)(a1 + 48)];
}
...
- (void)_postAchievementNotification:(id)a3 completion:(id)a4
{
  ...
  [(FCCXPCClient *)self->_xpcClient transportMessage:6 data:v7 completion:v6];
}
