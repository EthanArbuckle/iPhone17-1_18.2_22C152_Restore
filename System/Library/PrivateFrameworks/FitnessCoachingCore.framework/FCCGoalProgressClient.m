...
- (FCCGoalProgressClient)initWithQueue:(id)a3 xpcClient:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)FCCGoalProgressClient;
...
uint64_t __65__FCCGoalProgressClient_postGoalProgressNotification_completion___block_invoke(uint64_t a1)
{
  return [*(id *)(a1 + 32) _postGoalProgressNotification:*(void *)(a1 + 40) completion:*(void *)(a1 + 48)];
}
