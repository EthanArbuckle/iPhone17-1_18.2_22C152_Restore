@interface CAXPBContextualAction
...
- (id)description
{
  ...
  id v4 = [(CAXPBContextualAction *)&v8 description];
  v5 = [(CAXPBContextualAction *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_parameters, "count"));
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
...
{
  id v8 = a3;
  [v8 setActionIdentifier:self->_actionIdentifier];
  if ([(CAXPBContextualAction *)self parametersCount])
  {
    [v8 clearParameters];
    unint64_t v4 = [(CAXPBContextualAction *)self parametersCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(CAXPBContextualAction *)self parametersAtIndex:i];
        [v8 addParameters:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](actionIdentifier, "isEqual:")))
  {
    ...
    if ((unint64_t)parameters | v4[2]) {
      char v7 = -[NSMutableArray isEqual:](parameters, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_parameters hash] ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        -[CAXPBContextualAction addParameters:](self, "addParameters:", *(void *)(*((void *)&v10 + 1) + 8 * i), (void)v10);
      }
