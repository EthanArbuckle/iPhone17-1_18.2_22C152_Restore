...
- (VUIDelayOperation)initWithFireDate:(id)a3 tolerance:(double)a4
{
  id v6 = a3;
  if (!v6) {
    [MEMORY[0x1E4F1CA00] raise:*MEMORY[0x1E4F1C3C8], @"The %@ parameter must not be nil.", @"fireDate" format];
  }
  v11.receiver = self;
...
- (void)executionDidBegin
{
  ...
  objc_msgSend(NSString, "stringWithFormat:", @"com.apple.VUIDelayOperation.%p", self);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v21 = self;
    _os_log_impl(&dword_1E29E1000, v14, OS_LOG_TYPE_DEFAULT, "Delay operation timer will begin %@", buf, 0xCu);
  }
...
void __38__VUIDelayOperation_executionDidBegin__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
    {
      int v3 = 138412290;
      id v4 = WeakRetained;
      _os_log_impl(&dword_1E29E1000, v2, OS_LOG_TYPE_DEFAULT, "Delay operation timer did fire %@", (uint8_t *)&v3, 0xCu);
    }
...
void __38__VUIDelayOperation_executionDidBegin__block_invoke_18(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
    {
      int v3 = 138412290;
      id v4 = WeakRetained;
      _os_log_impl(&dword_1E29E1000, v2, OS_LOG_TYPE_DEFAULT, "Delay operation timer cancelled %@", (uint8_t *)&v3, 0xCu);
    }
