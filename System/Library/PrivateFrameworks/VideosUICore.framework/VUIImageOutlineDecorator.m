...
- (id)decoratorIdentifier
{
  ...
  uint64_t v4 = [(VUIImageScaleDecorator *)&v15 decoratorIdentifier];
  v5 = (void *)v4;
  if (v4) {
...
- (void)drawInContext:(id)a3 imageRect:(CGRect)a4
{
  ...
  else
  {
    ...
    v39 = +[VUICoreUtilities createPathForRadii:inRect:isContinuous:](VUICoreUtilities, "createPathForRadii:inRect:isContinuous:", [(VUIImageScaleDecorator *)self cornerContinuous], -(v38 * 0.5 - v22 * v14), -(v38 * 0.5 - v24 * v14), -(v38 * 0.5 - v26 * v14), -(v38 * 0.5 - v28 * v14), v50.origin.x, v50.origin.y, v50.size.width, v50.size.height);
    id v45 = [MEMORY[0x1E4F427D0] bezierPathWithCGPath:v39];
