...
- (id)description
{
  objc_super v3 = [[CUIRenditionKey alloc] initWithKeyList:self->key];
  ...
  id v5 = [(NSMutableDictionary *)self->info description];
  v7.receiver = self;
  v7.super_class = (Class)_SchemaRenditionTuple;
  return objc_msgSend(-[_SchemaRenditionTuple description](&v7, sel_description), "stringByAppendingFormat:", @"\nKey:%@\nCUInfo:\n%@", v4, v5);
}
