...
- (CGImage)uncroppedImage
{
  ...
  if (v4 != CGSizeZero.width || v6 != CGSizeZero.height)
  {
    ...
    uint64_t AlphaInfo = CGImageGetAlphaInfo(v15);
...
{
  uint64_t v5 = *(void *)&a5;
  double v9 = (unsigned __int16 *)[a3 bytes];
  double v10 = (objc_class *)[(id)objc_opt_class() renditionClassForRenditionType:v9[18] andPixelFormat:*((unsigned int *)v9 + 6)];
  if (v10) {
    double v11 = (CUIThemeRendition *)[[v10 alloc] _initWithCSIData:a3 forKey:a4 version:v5];
  }
  else {
    double v11 = 0;
  }
...
- (id)_initWithCSIData:(id)a3 forKey:(const _renditionkeytoken *)a4 version:(unsigned int)a5
{
  ...
  id result = [(CUIThemeRendition *)&v21 init];
  if (result)
  {
    double v9 = result;
    ...
    if (v10 <= 0x15)
    {
      CGFloat v12 = (void *)v9[12];
    }
    else
    {
      CGFloat v12 = malloc_type_calloc(v10 + 1, 4uLL, 0x100004052888210uLL);
      v9[12] = v12;
    }
    if (!v12) {
      CGFloat v12 = v9 + 1;
    ...
    {
      double v14 = +[CUIRenditionKey renditionKeyWithKeyList:a4];
...
- (id)_initWithCSIHeader:(const _csiheader *)a3 version:(unsigned int)a4
{
  ...
  double v6 = [(CUIThemeRendition *)&v19 init];
  v6->_colorSpaceID = *((_DWORD *)a3 + 7) & 0xF;
  [(CUIThemeRendition *)v6 _initializeTypeIdentifiersWithLayout:a3->var9.var1];
  v6->_name = (NSString *)[objc_alloc((Class)NSString) initWithUTF8String:a3->var9.var3];
...
LABEL_9:
  ...
  if (a3 == 40)
  {
    self->_int64_t type = 5;
    unsigned int v4 = 40;
    goto LABEL_15;
  }
  if (a3 == 50)
  {
    self->_int64_t type = 8;
    unsigned int v4 = 50;
LABEL_15:
    self->_subint64_t type = v4;
    return;
  }
...
- (void)_initializePropertiesFromCSIData:(const _csiheader *)a3 version:(unsigned int)a4
{
  ...
  if (var10)
  {
    unsigned int v10 = &a3->var11.var1[var0 + 1];
    unsigned int v11 = (unsigned int *)((char *)v10 + var10);
    do
    {
      unsigned int v12 = v10[1];
      if (*v10 == 1016 && !v10[2])
      {
        id v19 = [objc_alloc((Class)NSString) initWithUTF8String:v10 + 7];
        uint64_t v20 = (double *)((char *)v10 + v10[3] + 28);
        switch(v10[5])
        {
          case 0u:
            CGColorRef v21 = (CGColorRef)[objc_alloc((Class)NSString) initWithUTF8String:v20];
            goto LABEL_11;
          case 1u:
            CGColorRef v21 = (CGColorRef)[objc_alloc((Class)NSNumber) initWithLongLong:*(void *)v20];
            goto LABEL_11;
          case 2u:
            CGColorRef v21 = (CGColorRef)[objc_alloc((Class)NSNumber) initWithDouble:*v20];
            goto LABEL_11;
          case 3u:
            if ((v10[6] & 0xF) == 1)
            {
              ...
              *(_OWORD *)components = *(_OWORD *)v20;
              long long v29 = v22;
              CGColorRef v21 = CGColorCreate(space, components);
LABEL_11:
              CGColorRef v23 = v21;
              if (v19) {
                BOOL v24 = v21 == 0;
              ...
              {
                if (!v9) {
                  uint64_t v9 = (NSDictionary *)objc_alloc_init((Class)NSMutableDictionary);
                }
                [(NSDictionary *)v9 setObject:v23 forKey:v19];
              }
            }
            else
            {
              _CUILog(4, (uint64_t)"Rendition property with an unexpected color space.", v13, v14, v15, v16, v17, v18, v26);
LABEL_19:
              CGColorRef v23 = 0;
            }
      ...
      unsigned int v10 = (unsigned int *)((char *)v10 + v12 + 8);
    }
    while (v10 < v11);
  }
...
- (void)_initializeCompositingOptionsFromCSIData:(const _csiheader *)a3 version:(unsigned int)a4
{
  self->_opacitdouble y = 1.0;
  self->_blendMode = 0;
  uint64_t var10 = a3->var10;
  if (var10)
  {
    unsigned int v7 = &a3->var11.var1[a3->var11.var0 + 1];
    CGFloat v8 = (unsigned int *)((char *)v7 + var10);
    do
    {
      unsigned int v9 = v7[1];
      if (*v7 == 1004)
      {
        [(CUIThemeRendition *)self setBlendMode:v7[2]];
        [(CUIThemeRendition *)self setOpacity:*((float *)v7 + 3)];
      }
      if (a4 <= 0x34E && v9 != 12 && *v7 == 1019) {
        unsigned int v9 = 12;
      }
      unsigned int v7 = (unsigned int *)((char *)v7 + v9 + 8);
    }
    while (v7 < v8);
  }
}
  ...
  if (var10)
  {
    ...
    do
    {
      ...
      else if (*v7 == 1005 && !v7[3])
      {
        ...
        self->_utiType = (NSString *)[objc_alloc((Class)NSString) initWithUTF8String:v7 + 4];
      }
      if (a4 <= 0x34E && v9 != 12 && *v7 == 1019) {
        unsigned int v9 = 12;
      }
...
- (id)utiType
{
  id v2 = [(NSString *)self->_utiType copy];
  return v2;
}
...
+ (id)displayNameForRenditionType:(int64_t)a3
{
  return +[NSString stringWithCString:gRenditionTypes[3 * a3 + 2] encoding:4];
}
...
- (void)_initializeRenditionKey:(const _renditionkeytoken *)a3
{
  ...
  {
    kedouble y = (_renditionkeytoken *)malloc_type_calloc(v5 + 1, 4uLL, 0x100004052888210uLL);
    self->_kedouble y = key;
  }
  if (!key) {
    kedouble y = self->_stackKey;
  }
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)CUIThemeRendition;
  return objc_msgSend(-[CUIThemeRendition description](&v3, sel_description), "stringByAppendingFormat:", @" -- Rendition name: %@", -[CUIThemeRendition name](self, "name"));
}
...
{
  int v3 = a3;
  double v4 = [(CUIThemeRendition *)self key];
