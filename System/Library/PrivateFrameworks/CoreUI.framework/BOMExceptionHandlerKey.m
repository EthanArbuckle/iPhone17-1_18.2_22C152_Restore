...
{
  if (pthread_key_create((pthread_key_t *)&__BOMExceptionHandlerKey___key, 0))
  {
    _CUILog(4, (uint64_t)"__BOMExceptionHandlerKey couldn't pthread_key_create", v9, v10, v11, v12, v13, v14, a9);
  }
}
