...
{
  if (pthread_key_create((pthread_key_t *)&__BOMExceptionMessageString___key, (void (__cdecl *)(void *))&_free))
  {
    _CUILog(4, (uint64_t)"__BOMExceptionMessageString couldn't pthread_key_create", v9, v10, v11, v12, v13, v14, a9);
  }
}
