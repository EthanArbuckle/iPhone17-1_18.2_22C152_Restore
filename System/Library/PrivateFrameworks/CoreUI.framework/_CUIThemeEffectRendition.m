...
- (id)_initWithCSIHeader:(const _csiheader *)a3 version:(unsigned int)a4
{
  ...
  v5 = [(CUIThemeRendition *)&v9 _initWithCSIHeader:a3 version:*(void *)&a4];
  v5[27] = (char *)&a3->var11.var1[a3->var11.var0 + 1] + a3->var10;
  v6 = -[CUIThemeDataEffectPreset initWithEffectData:forScaleFactor:]([CUIThemeDataEffectPreset alloc], "initWithEffectData:forScaleFactor:", v5[27], (double)[v5 internalScale]);
  v5[28] = v6;
