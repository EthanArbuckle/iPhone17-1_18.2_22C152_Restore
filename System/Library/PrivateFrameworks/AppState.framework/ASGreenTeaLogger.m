...
- (void)willAccessLocationForSearch
{
  ...
  if (v2 && os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    *(_WORD *)objc_super v4 = 0;
    _os_log_impl(&dword_2307C4000, v3, OS_LOG_TYPE_INFO, "Accessing location for search ad targeting", v4, 2u);
  }
}
...
- (void)willTransmitLocationForSearch
{
  ...
  {
    *(_WORD *)objc_super v4 = 0;
    _os_log_impl(&dword_2307C4000, v3, OS_LOG_TYPE_INFO, "Transmitting location to store platform for search ad targeting", v4, 2u);
  }
}
...
- (void)willRequestAppList
{
  ...
  {
    *(_WORD *)objc_super v4 = 0;
    _os_log_impl(&dword_2307C4000, v3, OS_LOG_TYPE_INFO, "Accessing application list to update installed status", v4, 2u);
  }
}
