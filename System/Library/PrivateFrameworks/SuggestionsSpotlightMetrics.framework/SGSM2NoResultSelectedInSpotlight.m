@interface SGSM2NoResultSelectedInSpotlight
- (BOOL)hasKey;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSString)key;
...
- (id)description
{
  ...
  v4 = [(SGSM2NoResultSelectedInSpotlight *)&v8 description];
  v5 = [(SGSM2NoResultSelectedInSpotlight *)self dictionaryRepresentation];
...
- (NSString)key
{
  if (self->_key) {
    ...
    return (NSString *)@"NoResultSelectedInSpotlight";
  }
}
