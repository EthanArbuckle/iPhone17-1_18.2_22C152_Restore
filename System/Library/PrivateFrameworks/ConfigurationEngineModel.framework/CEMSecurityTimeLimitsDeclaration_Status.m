@interface CEMSecurityTimeLimitsDeclaration_Status
...
@implementation CEMSecurityTimeLimitsDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMSecurityTimeLimitsDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
