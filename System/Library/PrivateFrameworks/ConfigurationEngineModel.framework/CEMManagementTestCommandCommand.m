...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMManagementTestCommandCommand allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  {
    id v19 = 0;
    v16 = [(CEMPayloadBase *)self loadStringFromDictionary:v6 withKey:@"ReturnStatus" isRequired:0 defaultValue:@"Executed" error:&v19];
    id v14 = v19;
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  [(CEMPayloadBase *)self serializeStringIntoDictionary:v4 withKey:@"ReturnStatus" withValue:self->_payloadReturnStatus isRequired:0 defaultValue:@"Executed"];
  id v5 = (void *)[v4 copy];
