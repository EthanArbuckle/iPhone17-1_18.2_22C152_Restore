@interface CEMDeviceClearRestrictionsPasswordCommand
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.command.device.restrictions.clearpassword";
}
...
+ (id)buildWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setCommandType:@"com.apple.command.device.restrictions.clearpassword"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMDeviceClearRestrictionsPasswordCommand allowedPayloadKeys];
  [v7 minusSet:v8];
