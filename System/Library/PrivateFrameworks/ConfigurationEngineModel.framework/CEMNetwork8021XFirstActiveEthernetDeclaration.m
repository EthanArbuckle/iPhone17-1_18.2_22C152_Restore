@interface CEMNetwork8021XFirstActiveEthernetDeclaration
...
@implementation CEMNetwork8021XFirstActiveEthernetDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.network.802.1X.firstactiveethernet";
}
...
+ (id)buildWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setDeclarationType:@"com.apple.configuration.network.802.1X.firstactiveethernet"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v9 = +[CEMNetwork8021XFirstActiveEthernetDeclaration allowedPayloadKeys];
  [v8 minusSet:v9];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMNetwork8021XFirstActiveEthernetDeclaration;
