@interface CEMSecuritySettingsDeclaration_Status
...
@implementation CEMSecuritySettingsDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMSecuritySettingsDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
