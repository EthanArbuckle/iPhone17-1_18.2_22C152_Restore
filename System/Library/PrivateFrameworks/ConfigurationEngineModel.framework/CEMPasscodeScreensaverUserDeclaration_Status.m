@interface CEMPasscodeScreensaverUserDeclaration_Status
...
@implementation CEMPasscodeScreensaverUserDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMPasscodeScreensaverUserDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
