@interface CEMCredentialUserNameAndPasswordDeclaration_Status
...
@implementation CEMCredentialUserNameAndPasswordDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMCredentialUserNameAndPasswordDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
