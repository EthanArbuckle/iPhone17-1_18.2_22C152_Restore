...
+ (NSSet)allowedReplyKeys;
+ (id)buildRequiredOnlyWithEcho:(id)a3;
+ (id)buildWithEcho:(id)a3;
- (BOOL)loadPayload:(id)a3 error:(id *)a4;
- (NSString)replyEcho;
- (id)serializePayload;
- (void)setReplyEcho:(id)a3;
@end

@implementation CEMManagementTestMessageMessage_Reply
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMManagementTestMessageMessage_Reply allowedReplyKeys];
  [v9 minusSet:v10];
...
- (id)serializePayload
{
  ...
  [(CEMPayloadBase *)self serializeStringIntoDictionary:v3 withKey:@"Echo" withValue:self->_replyEcho isRequired:1 defaultValue:0];
  v4 = (void *)[v3 copy];
