@interface CEMApplicationListInstalledApplicationsCommand
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.command.application.list";
}
...
+ (id)buildWithIdentifier:(id)a3 withBundleIdentifiers:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setCommandType:@"com.apple.command.application.list"];
  if (v5)
  {
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setCommandType:@"com.apple.command.application.list"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMApplicationListInstalledApplicationsCommand allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  id v17 = 0;
  v13 = [(CEMPayloadBase *)self loadArrayFromDictionary:v7 withKey:@"BundleIdentifiers" validator:&__block_literal_global_6 isRequired:0 defaultValue:0 error:&v17];
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  [(CEMPayloadBase *)self serializeArrayIntoDictionary:v4 withKey:@"BundleIdentifiers" withValue:self->_payloadBundleIdentifiers itemSerializer:&__block_literal_global_19 isRequired:0 defaultValue:0];
  id v5 = (void *)[v4 copy];
