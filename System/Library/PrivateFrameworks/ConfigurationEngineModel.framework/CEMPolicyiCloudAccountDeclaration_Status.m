@interface CEMPolicyiCloudAccountDeclaration_Status
...
@implementation CEMPolicyiCloudAccountDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMPolicyiCloudAccountDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
