@interface CEMSystemDictionaryDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.system.dictionary";
}
...
+ (id)buildWithIdentifier:(id)a3 withParentalControl:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setDeclarationType:@"com.apple.configuration.system.dictionary"];
  if (v5)
  {
  ...
  [v7 setPayloadParentalControl:v6];
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMSystemDictionaryDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  id v17 = 0;
  v13 = [(CEMPayloadBase *)self loadBooleanFromDictionary:v7 withKey:@"parentalControl" isRequired:1 defaultValue:0 error:&v17];
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  [(CEMPayloadBase *)self serializeBooleanIntoDictionary:v4 withKey:@"parentalControl" withValue:self->_payloadParentalControl isRequired:1 defaultValue:0];
  id v5 = (void *)[v4 copy];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v5 = [(NSNumber *)self->_payloadParentalControl copy];
  id v6 = (void *)v4[9];
  v4[9] = v5;
