...
@implementation CEMAssetBaseReference
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  id v10 = +[CEMAssetBaseReference allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  if (!v14)
  {
    ...
    if (!v14)
    {
      ...
      if (!v14)
      {
        ...
        {
          id v25 = 0;
          v22 = [(CEMPayloadBase *)self loadArrayFromDictionary:v6 withKey:@"CertificatePinningIdentifiers" validator:&__block_literal_global_9 isRequired:0 defaultValue:0 error:&v25];
          id v14 = v25;
...
uint64_t __43__CEMAssetBaseReference_loadPayload_error___block_invoke(uint64_t a1, void *a2)
{
  id v2 = a2;
  objc_opt_class();
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  [(CEMPayloadBase *)self serializeArrayIntoDictionary:v4 withKey:@"CertificatePinningIdentifiers" withValue:self->_payloadCertificatePinningIdentifiers itemSerializer:&__block_literal_global_56 isRequired:0 defaultValue:0];
  v5 = (void *)[v4 copy];

  return v5;
}

id __60__CEMAssetBaseReference_serializePayloadWithAssetProviders___block_invoke(uint64_t a1, void *a2)
{
  id v2 = a2;
...
{
  v16.receiver = self;
  v16.super_class = (Class)CEMAssetBaseReference;
