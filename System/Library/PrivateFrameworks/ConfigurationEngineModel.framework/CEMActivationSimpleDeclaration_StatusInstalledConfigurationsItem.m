...
@implementation CEMActivationSimpleDeclaration_StatusInstalledConfigurationsItem
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMActivationSimpleDeclaration_StatusInstalledConfigurationsItem allowedStatusKeys];
  [v9 minusSet:v10];
...
{
  v10.receiver = self;
  v10.super_class = (Class)CEMActivationSimpleDeclaration_StatusInstalledConfigurationsItem;
