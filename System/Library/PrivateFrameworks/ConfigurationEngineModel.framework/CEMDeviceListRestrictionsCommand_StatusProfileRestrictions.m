...
@implementation CEMDeviceListRestrictionsCommand_StatusProfileRestrictions
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        [(CEMPayloadBase *)self serializeDictionaryIntoDictionary:v3 withKey:v9 withValue:v10 dictSerializer:&__block_literal_global_257 isRequired:1 defaultValue:0];
      }
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMDeviceListRestrictionsCommand_StatusProfileRestrictions;
