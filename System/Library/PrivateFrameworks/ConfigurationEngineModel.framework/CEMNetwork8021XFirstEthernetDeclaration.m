@interface CEMNetwork8021XFirstEthernetDeclaration
...
@implementation CEMNetwork8021XFirstEthernetDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.network.802.1X.firstethernet";
}
...
+ (id)buildWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setDeclarationType:@"com.apple.configuration.network.802.1X.firstethernet"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v9 = +[CEMNetwork8021XFirstEthernetDeclaration allowedPayloadKeys];
  [v8 minusSet:v9];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMNetwork8021XFirstEthernetDeclaration;
