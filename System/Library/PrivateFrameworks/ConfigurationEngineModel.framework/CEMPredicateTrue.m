...
@implementation CEMPredicateTrue
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.predicate.true";
}
...
{
  v2 = objc_opt_new();
  [v2 setPayloadType:@"com.apple.predicate.true"];
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMPredicateTrue allowedPayloadKeys];
  [v9 minusSet:v10];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMPredicateTrue;
