...
@implementation CEMPredicateAny
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.predicate.any";
}
...
+ (id)buildWithPredicates:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setPayloadType:@"com.apple.predicate.any"];
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMPredicateAny allowedPayloadKeys];
  [v9 minusSet:v10];
...
{
  v10.receiver = self;
  v10.super_class = (Class)CEMPredicateAny;
