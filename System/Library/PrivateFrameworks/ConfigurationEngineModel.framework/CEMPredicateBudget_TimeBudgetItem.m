...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMPredicateBudget_TimeBudgetItem allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  {
    id v19 = 0;
    v16 = [(CEMPayloadBase *)self loadArrayFromDictionary:v6 withKey:@"Days" validator:&__block_literal_global_205 isRequired:0 defaultValue:0 error:&v19];
    id v14 = v19;
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  [(CEMPayloadBase *)self serializeArrayIntoDictionary:v4 withKey:@"Days" withValue:self->_payloadDays itemSerializer:&__block_literal_global_207 isRequired:0 defaultValue:0];
  id v5 = (void *)[v4 copy];
