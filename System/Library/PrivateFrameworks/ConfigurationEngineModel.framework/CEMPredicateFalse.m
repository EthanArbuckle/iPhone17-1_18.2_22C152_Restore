...
@implementation CEMPredicateFalse
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.predicate.false";
}
...
{
  v2 = objc_opt_new();
  [v2 setPayloadType:@"com.apple.predicate.false"];
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMPredicateFalse allowedPayloadKeys];
  [v9 minusSet:v10];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMPredicateFalse;
  v4 = [(CEMPredicateBase *)&v8 copyWithZone:a3];
