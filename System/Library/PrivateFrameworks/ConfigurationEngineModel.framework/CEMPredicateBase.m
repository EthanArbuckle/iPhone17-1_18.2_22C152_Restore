...
+ (id)predicateForPayload:(id)a3 error:(id *)a4;
- (BOOL)evaluateWithOptions:(id)a3 error:(id *)a4;
- (NSString)payloadType;
- (id)copyWithZone:(_NSZone *)a3;
- (void)setPayloadType:(id)a3;
@end

@implementation CEMPredicateBase
...
LABEL_12:
  ...
  if (a4)
  {
    ...
    v12 = [NSString stringWithFormat:@"Could not match predicate type: %@", v9];
    v19[0] = v12;
...
- (BOOL)evaluateWithOptions:(id)a3 error:(id *)a4
{
  ...
  if (a4)
  {
    ...
    v9[0] = @"Could not evaluate predicate - need sub-class implementation";
    uint64_t v6 = [NSDictionary dictionaryWithObjects:v9 forKeys:&v8 count:1];
    *a4 = [v5 errorWithDomain:@"error" code:1 userInfo:v6];
  }
  return 0;
}
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMPredicateBase;
