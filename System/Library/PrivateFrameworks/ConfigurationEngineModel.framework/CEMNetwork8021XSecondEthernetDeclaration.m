@interface CEMNetwork8021XSecondEthernetDeclaration
...
@implementation CEMNetwork8021XSecondEthernetDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.network.802.1X.secondethernet";
}
...
+ (id)buildWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setDeclarationType:@"com.apple.configuration.network.802.1X.secondethernet"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v9 = +[CEMNetwork8021XSecondEthernetDeclaration allowedPayloadKeys];
  [v8 minusSet:v9];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMNetwork8021XSecondEthernetDeclaration;
