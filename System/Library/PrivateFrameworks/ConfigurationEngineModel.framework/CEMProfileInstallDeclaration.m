@interface CEMProfileInstallDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.profile.install";
}
...
+ (id)buildWithIdentifier:(id)a3 withProfile:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setDeclarationType:@"com.apple.configuration.profile.install"];
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMProfileInstallDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
