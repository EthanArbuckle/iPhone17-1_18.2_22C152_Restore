@interface CEMSecurityInformationCommand
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.command.security.information";
}
...
+ (id)buildWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setCommandType:@"com.apple.command.security.information"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMSecurityInformationCommand allowedPayloadKeys];
  [v7 minusSet:v8];
