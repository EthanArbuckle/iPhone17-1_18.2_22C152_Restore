...
+ (id)buildWithIdentifier:(id)a3 withMode:(id)a4;
+ (id)profileType;
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.policy.icloud.account";
}
...
+ (id)buildWithIdentifier:(id)a3 withMode:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setDeclarationType:@"com.apple.configuration.policy.icloud.account"];
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMPolicyiCloudAccountDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  id v17 = 0;
  v13 = [(CEMPayloadBase *)self loadStringFromDictionary:v7 withKey:@"Mode" isRequired:1 defaultValue:0 error:&v17];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMPolicyiCloudAccountDeclaration;
