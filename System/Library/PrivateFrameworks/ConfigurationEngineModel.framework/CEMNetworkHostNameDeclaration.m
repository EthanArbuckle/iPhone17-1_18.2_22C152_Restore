@interface CEMNetworkHostNameDeclaration
+ (NSSet)allowedPayloadKeys;
+ (NSString)registeredClassName;
+ (NSString)registeredIdentifier;
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 withName:(id)a4;
+ (id)buildWithIdentifier:(id)a3 withName:(id)a4;
+ (id)profileType;
...
@implementation CEMNetworkHostNameDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.network.hostname";
}
...
+ (id)buildWithIdentifier:(id)a3 withName:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setDeclarationType:@"com.apple.configuration.network.hostname"];
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMNetworkHostNameDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  id v17 = 0;
  v13 = [(CEMPayloadBase *)self loadStringFromDictionary:v7 withKey:@"Name" isRequired:1 defaultValue:0 error:&v17];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMNetworkHostNameDeclaration;
