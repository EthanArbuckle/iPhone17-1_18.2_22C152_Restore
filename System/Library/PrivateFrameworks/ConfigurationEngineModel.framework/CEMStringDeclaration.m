@interface CEMStringDeclaration
+ (NSSet)allowedPayloadKeys;
+ (NSString)registeredClassName;
+ (NSString)registeredIdentifier;
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 withDescriptor:(id)a4 withData:(id)a5;
+ (id)buildWithIdentifier:(id)a3 withDescriptor:(id)a4 withData:(id)a5;
...
@implementation CEMStringDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.asset.string";
}
...
+ (id)buildWithIdentifier:(id)a3 withDescriptor:(id)a4 withData:(id)a5
{
  ...
  id v9 = a4;
  v10 = objc_opt_new();
  [v10 setDeclarationType:@"com.apple.asset.string"];
  if (v7)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMStringDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  {
    id v19 = 0;
    v16 = [(CEMPayloadBase *)self loadStringFromDictionary:v6 withKey:@"Data" isRequired:1 defaultValue:0 error:&v19];
    id v14 = v19;
    payloadData = self->_payloadData;
    self->_payloadData = v16;
  }
  if (a4 && v14) {
    *a4 = v14;
  }
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v10[1] = 3221225472;
  v10[2] = __59__CEMStringDeclaration_serializePayloadWithAssetProviders___block_invoke;
  v10[3] = &unk_2642C87E8;
  id v11 = v4;
  id v7 = v4;
  ...
  [(CEMPayloadBase *)self serializeStringIntoDictionary:v5 withKey:@"Data" withValue:self->_payloadData isRequired:1 defaultValue:0];
  id v8 = (void *)[v5 copy];

  return v8;
}

uint64_t __59__CEMStringDeclaration_serializePayloadWithAssetProviders___block_invoke(uint64_t a1, void *a2)
{
