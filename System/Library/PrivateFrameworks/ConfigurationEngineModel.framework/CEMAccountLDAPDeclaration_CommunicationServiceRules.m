...
@implementation CEMAccountLDAPDeclaration_CommunicationServiceRules
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMAccountLDAPDeclaration_CommunicationServiceRules allowedPayloadKeys];
  [v9 minusSet:v10];
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v10[1] = 3221225472;
  v10[2] = __90__CEMAccountLDAPDeclaration_CommunicationServiceRules_serializePayloadWithAssetProviders___block_invoke;
  v10[3] = &unk_2642C87E8;
  id v11 = v4;
  id v7 = v4;
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMAccountLDAPDeclaration_CommunicationServiceRules;
  id v4 = [(CEMPayloadBase *)&v8 copyWithZone:a3];
  uint64_t v5 = [(CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers *)self->_payloadDefaultServiceHandlers copy];
  v6 = (void *)v4[2];
  v4[2] = v5;
