@interface CEMSystemNotificationsDeclaration_Status
...
@implementation CEMSystemNotificationsDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMSystemNotificationsDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
