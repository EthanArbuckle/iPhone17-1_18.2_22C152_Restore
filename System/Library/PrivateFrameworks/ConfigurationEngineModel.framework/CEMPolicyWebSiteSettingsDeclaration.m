@interface CEMPolicyWebSiteSettingsDeclaration
...
@implementation CEMPolicyWebSiteSettingsDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.configuration.policy.website.settings";
}
...
+ (id)buildWithIdentifier:(id)a3 withDefaultBehavior:(id)a4
{
  ...
  v6 = (__CFString *)a4;
  v7 = objc_opt_new();
  [v7 setDeclarationType:@"com.apple.configuration.policy.website.settings"];
  if (v5)
  {
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setDeclarationType:@"com.apple.configuration.policy.website.settings"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMPolicyWebSiteSettingsDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMPolicyWebSiteSettingsDeclaration;
