@interface CEMPasscodeScreensaverDeclaration_Status
...
@implementation CEMPasscodeScreensaverDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMPasscodeScreensaverDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
