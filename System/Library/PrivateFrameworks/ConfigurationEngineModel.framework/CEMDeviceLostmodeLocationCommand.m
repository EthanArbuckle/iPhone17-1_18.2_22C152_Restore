@interface CEMDeviceLostmodeLocationCommand
...
@implementation CEMDeviceLostmodeLocationCommand
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.command.device.lostmode.location";
}
...
+ (id)buildWithIdentifier:(id)a3
{
  id v3 = a3;
  v4 = objc_opt_new();
  [v4 setCommandType:@"com.apple.command.device.lostmode.location"];
  if (v3)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMDeviceLostmodeLocationCommand allowedPayloadKeys];
  [v7 minusSet:v8];
...
{
  v4.receiver = self;
  v4.super_class = (Class)CEMDeviceLostmodeLocationCommand;
