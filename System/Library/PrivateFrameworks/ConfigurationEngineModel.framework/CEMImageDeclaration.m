...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.asset.image";
}
...
+ (id)buildWithIdentifier:(id)a3 withDescriptor:(id)a4 withReference:(id)a5
{
  ...
  id v9 = a4;
  v10 = objc_opt_new();
  [v10 setDeclarationType:@"com.apple.asset.image"];
  if (v7)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMImageDeclaration allowedPayloadKeys];
  [v9 minusSet:v10];
...
- (id)serializePayloadWithAssetProviders:(id)a3
{
  ...
  v17[1] = 3221225472;
  v17[2] = __58__CEMImageDeclaration_serializePayloadWithAssetProviders___block_invoke;
  v17[3] = &unk_2642C87E8;
  id v7 = v4;
  id v18 = v7;
  ...
  id v14 = __58__CEMImageDeclaration_serializePayloadWithAssetProviders___block_invoke_2;
  v15 = &unk_2642C87E8;
  id v16 = v7;
  id v9 = v7;
...
uint64_t __58__CEMImageDeclaration_serializePayloadWithAssetProviders___block_invoke(uint64_t a1, void *a2)
{
  return [a2 serializePayloadWithAssetProviders:*(void *)(a1 + 32)];
}

uint64_t __58__CEMImageDeclaration_serializePayloadWithAssetProviders___block_invoke_2(uint64_t a1, void *a2)
{
  return [a2 serializePayloadWithAssetProviders:*(void *)(a1 + 32)];
}
...
{
  v10.receiver = self;
  v10.super_class = (Class)CEMImageDeclaration;
