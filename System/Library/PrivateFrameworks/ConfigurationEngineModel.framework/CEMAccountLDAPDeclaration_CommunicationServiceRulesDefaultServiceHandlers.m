...
@implementation CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers allowedPayloadKeys];
  [v9 minusSet:v10];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMAccountLDAPDeclaration_CommunicationServiceRulesDefaultServiceHandlers;
