...
@implementation CEMActivationSimpleDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMActivationSimpleDeclaration_Status allowedStatusKeys];
  [v9 minusSet:v10];
...
- (id)serializePayload
{
  ...
  [(CEMPayloadBase *)self serializeArrayIntoDictionary:v3 withKey:@"InstalledConfigurations" withValue:self->_statusInstalledConfigurations itemSerializer:&__block_literal_global_110 isRequired:0 defaultValue:0];
  v4 = (void *)[v3 copy];
