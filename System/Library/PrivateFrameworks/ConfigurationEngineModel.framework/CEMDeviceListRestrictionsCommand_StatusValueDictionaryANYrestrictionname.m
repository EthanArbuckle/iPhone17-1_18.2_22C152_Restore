...
@implementation CEMDeviceListRestrictionsCommand_StatusValueDictionaryANYrestrictionname
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMDeviceListRestrictionsCommand_StatusValueDictionaryANYrestrictionname allowedStatusKeys];
  [v9 minusSet:v10];
  ...
  {
    id v18 = 0;
    v15 = [(CEMPayloadBase *)self loadIntegerFromDictionary:v6 withKey:@"value" isRequired:1 defaultValue:0 error:&v18];
    id v12 = v18;
...
- (id)serializePayload
{
  ...
  [(CEMPayloadBase *)self serializeIntegerIntoDictionary:v3 withKey:@"value" withValue:self->_statusValue isRequired:1 defaultValue:0];
  v4 = (void *)[v3 copy];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMDeviceListRestrictionsCommand_StatusValueDictionaryANYrestrictionname;
