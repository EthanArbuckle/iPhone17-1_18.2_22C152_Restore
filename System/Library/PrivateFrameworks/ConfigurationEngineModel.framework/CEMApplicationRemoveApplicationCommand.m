@interface CEMApplicationRemoveApplicationCommand
+ (NSSet)allowedPayloadKeys;
+ (NSString)registeredClassName;
+ (NSString)registeredIdentifier;
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 withBundleIdentifier:(id)a4;
+ (id)buildWithIdentifier:(id)a3 withBundleIdentifier:(id)a4;
...
@implementation CEMApplicationRemoveApplicationCommand
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.command.application.remove";
}
...
+ (id)buildWithIdentifier:(id)a3 withBundleIdentifier:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setCommandType:@"com.apple.command.application.remove"];
  if (v5)
  {
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMApplicationRemoveApplicationCommand allowedPayloadKeys];
  [v9 minusSet:v10];
  ...
  id v17 = 0;
  v13 = [(CEMPayloadBase *)self loadStringFromDictionary:v7 withKey:@"BundleIdentifier" isRequired:1 defaultValue:0 error:&v17];
...
{
  v8.receiver = self;
  v8.super_class = (Class)CEMApplicationRemoveApplicationCommand;
