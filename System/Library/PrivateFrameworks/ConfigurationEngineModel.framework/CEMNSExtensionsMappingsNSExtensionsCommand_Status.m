...
@implementation CEMNSExtensionsMappingsNSExtensionsCommand_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMNSExtensionsMappingsNSExtensionsCommand_Status allowedStatusKeys];
  [v9 minusSet:v10];
...
- (id)serializePayload
{
  ...
  [(CEMPayloadBase *)self serializeArrayIntoDictionary:v3 withKey:@"Extensions" withValue:self->_statusExtensions itemSerializer:&__block_literal_global_26 isRequired:1 defaultValue:0];
  v4 = (void *)[v3 copy];
