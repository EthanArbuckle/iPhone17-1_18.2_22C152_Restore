@interface CEMSystemAirPlaySettingsDeclaration_Status
...
@implementation CEMSystemAirPlaySettingsDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMSystemAirPlaySettingsDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
