@interface CEMPolicyWebSiteSettingsDeclaration_Status
...
@implementation CEMPolicyWebSiteSettingsDeclaration_Status
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v8 = +[CEMPolicyWebSiteSettingsDeclaration_Status allowedStatusKeys];
  [v7 minusSet:v8];
