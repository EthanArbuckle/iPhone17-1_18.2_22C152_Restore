...
+ (NSSet)allowedStatusKeys
{
  ...
  v6[0] = @"GlobalRestrictions";
  v6[1] = @"ProfileRestrictions";
...
+ (id)buildWithGlobalRestrictions:(id)a3 withProfileRestrictions:(id)a4
{
  ...
  id v6 = a3;
  v7 = objc_opt_new();
  [v7 setStatusGlobalRestrictions:v6];

  [v7 setStatusProfileRestrictions:v5];
...
- (BOOL)loadPayload:(id)a3 error:(id *)a4
{
  ...
  v10 = +[CEMDeviceListRestrictionsCommand_Status allowedStatusKeys];
  [v9 minusSet:v10];
  ...
  {
    id v21 = 0;
    v15 = [(CEMPayloadBase *)self loadDictionaryFromDictionary:v6 withKey:@"GlobalRestrictions" classType:objc_opt_class() isRequired:1 defaultValue:0 error:&v21];
    id v12 = v21;
    ...
    {
      id v20 = 0;
      v17 = [(CEMPayloadBase *)self loadDictionaryFromDictionary:v6 withKey:@"ProfileRestrictions" classType:objc_opt_class() isRequired:1 defaultValue:0 error:&v20];
      id v12 = v20;
...
- (id)serializePayload
{
  ...
  [(CEMPayloadBase *)self serializeDictionaryIntoDictionary:v3 withKey:@"GlobalRestrictions" withValue:self->_statusGlobalRestrictions dictSerializer:&__block_literal_global_13 isRequired:1 defaultValue:0];
  [(CEMPayloadBase *)self serializeDictionaryIntoDictionary:v3 withKey:@"ProfileRestrictions" withValue:self->_statusProfileRestrictions dictSerializer:&__block_literal_global_99 isRequired:1 defaultValue:0];
  v4 = (void *)[v3 copy];
