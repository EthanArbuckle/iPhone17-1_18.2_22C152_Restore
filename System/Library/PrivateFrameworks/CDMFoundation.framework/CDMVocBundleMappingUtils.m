    ...
    if (([v3 isEqualToString:@"com.apple.tv"] & 1) == 0)
    {
      ...
      if (([v3 isEqualToString:@"com.apple.mobilemail"] & 1) == 0)
      {
        ...
        if (([v3 isEqualToString:@"com.apple.mobilesafari"] & 1) == 0)
        {
          ...
          {
            if (([v3 isEqualToString:@"com.apple.siri.clock"] & 1) != 0
              || ([v3 isEqualToString:@"com.apple.siri.timer"] & 1) != 0)
            {
            ...
            {
              v4 = @"com.apple.mobiletimer";
              if (([v3 isEqualToString:@"com.apple.siri.alarms"] & 1) == 0
                && ![v3 isEqualToString:@"com.apple.siri.stopwatch"])
              {
                v4 = 0;
              }
            }
