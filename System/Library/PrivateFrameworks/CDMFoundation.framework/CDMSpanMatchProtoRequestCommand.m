...
- (CDMSpanMatchProtoRequestCommand)initWithRequests:(id)a3 selfMetadata:(id)a4
{
  ...
  id v8 = a3;
  id v9 = [v6 array];
  id v10 = [(CDMSpanMatchProtoRequestCommand *)self initWithRequests:v8 asrHypothesis:v9 selfMetadata:v7];
...
- (CDMSpanMatchProtoRequestCommand)initWithRequests:(id)a3 asrHypothesis:(id)a4
{
  return [(CDMSpanMatchProtoRequestCommand *)self initWithRequests:a3 asrHypothesis:a4 selfMetadata:0];
}
...
- (CDMSpanMatchProtoRequestCommand)initWithRequests:(id)a3
{
  ...
  id v5 = a3;
  v6 = [v4 array];
  id v7 = [(CDMSpanMatchProtoRequestCommand *)self initWithRequests:v5 asrHypothesis:v6 selfMetadata:0];
...
- (CDMSpanMatchProtoRequestCommand)initWithRequest:(id)a3
{
  ...
  id v5 = [(CDMSpanMatchProtoRequestCommand *)self initWithRequests:v4];
