...
- (DAMoveAction)initWithCoder:(id)a3
{
  ...
  if (([v5 allowsKeyedCoding] & 1) == 0)
  {
    ...
    [v11 handleFailureInMethod:a2 object:self file:@"DAAction.m" lineNumber:140 description:@"Who does non-keyed coding nowadays?"];
  }
  v12.receiver = self;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (([v5 allowsKeyedCoding] & 1) == 0)
  {
    ...
    [v9 handleFailureInMethod:a2 object:self file:@"DAAction.m" lineNumber:151 description:@"Who does non-keyed coding nowadays?"];
  }
  v10.receiver = self;
