...
- (id)passwordForAccountWithPersistentUUID:(id)a3 expectedAccessibility:(int)a4 shouldSetAccessibility:(BOOL)a5 passwordExpected:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v11, v13))
  {
    *(_DWORD *)buf = 138412290;
    id v38 = v10;
    _os_log_impl(&dword_1BA384000, v11, v13, "Loading password for %@", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v18, v21))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v39 = 1024;
        OSStatus v40 = v17;
        _os_log_impl(&dword_1BA384000, v19, v21, "Could not find a password in the keychain for %@, error %d", buf, 0x12u);
      }
      v22 = 0;
      v23 = 0;
    }
    else
    {
      ...
      if (v26 != v8 && v7)
      {
        ...
        os_log_type_t v28 = *(unsigned char *)(MEMORY[0x1E4F5E9A0] + 6);
        if (os_log_type_enabled(v27, v28))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v39 = 1024;
          OSStatus v40 = v8;
          _os_log_impl(&dword_1BA384000, v27, v28, "Securing ur sekretz: moving credential for account %@ to accessibility %d", buf, 0x12u);
        }
        ...
        if (v31)
        {
          ...
          os_log_type_t v33 = *(unsigned char *)(MEMORY[0x1E4F5E9A0] + 3);
          if (os_log_type_enabled(v32, v33))
          {
            *(_DWORD *)buf = 67109120;
            LODWORD(v38) = v31;
            _os_log_impl(&dword_1BA384000, v32, v33, "Couldn't change password accessibility, error %d", buf, 8u);
          }
        }
        if (Mutable) {
          CFRelease(Mutable);
...
- (void)removePersistentCredentials
{
  v2 = [MEMORY[0x1E4F18D90] sharedCredentialStorage];
  id v3 = [v2 allCredentials];
    ...
    *(void *)&long long v10 = 138412290;
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_msgSend(v5, "isProxy", v17, (void)v18) & 1) == 0 && objc_msgSend(v15, "persistence") == 1)
        {
          ...
          if (os_log_type_enabled(v16, v13))
          {
            *(_DWORD *)buf = v17;
            v23 = v15;
            _os_log_impl(&dword_1BA384000, v16, v13, "Removing credential %@", buf, 0xCu);
          }

          [*(id *)(a1 + 32) removeCredential:v15 forProtectionSpace:v5];
        }
        ++v14;
      }
      while (v11 != v14);
  ...
  *(void *)&v30[5] = *MEMORY[0x1E4F143B8];
  ...
  if ([v10 length])
  {
    ...
    if (v18 == -25299)
    {
      ...
      long long v21 = (const void *)*MEMORY[0x1E4F3B558];
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v24, v25))
      {
        ...
        *(void *)((char *)&v30[1] + 2) = v12;
        _os_log_impl(&dword_1BA384000, v24, v25, "Error %d, Can't update password for account %@", buf, 0x12u);
      }
    }
    else
    {
...
- (BOOL)removePasswordForAccount:(id)a3 withPersistentUUID:(id)a4
{
  *(void *)&v18[5] = *MEMORY[0x1E4F143B8];
  ...
  uint64_t v8 = MEMORY[0x1E4F5E9A0];
  os_log_type_t v9 = *(unsigned char *)(MEMORY[0x1E4F5E9A0] + 6);
  if (os_log_type_enabled(v7, v9))
  {
    int v17 = 138412290;
    *(void *)OSStatus v18 = v5;
    _os_log_impl(&dword_1BA384000, v7, v9, "Removing password for account with UUID %@", (uint8_t *)&v17, 0xCu);
  }
  ...
  os_log_type_t v15 = DALoggingwithCategory();
  os_log_type_t v16 = *(unsigned char *)(v8 + 3);
  if (os_log_type_enabled(v15, v16))
  {
    ...
    *(void *)((char *)&v18[1] + 2) = v5;
    _os_log_impl(&dword_1BA384000, v15, v16, "Error %d, Couldn't delete password from keychain for account %@", (uint8_t *)&v17, 0x12u);
  }
...
- (void)migratePasswordForAccount:(id)a3
{
    ...
    if (v10)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          BOOL v13 = [MEMORY[0x1E4F1CB10] URLWithString:*(void *)(*((void *)&v40 + 1) + 8 * i)];
          if (!v5)
          {
            uint64_t v14 = +[DAKeychain sharedKeychain];
            id v5 = [v14 guessPasswordForURL:v13];
          }
          os_log_type_t v15 = +[DAKeychain sharedKeychain];
  ...
  if (v5)
  {
    os_log_type_t v16 = (void *)[objc_alloc(MEMORY[0x1E4F179C0]) initWithPassword:v5];
    ...
    long long v19 = DALoggingwithCategory();
    ...
    if (os_log_type_enabled(v19, v20))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v46 = 2112;
      v47 = v25;
      _os_log_impl(&dword_1BA384000, v19, v20, "During Migration, password present. Setting _backingAccountInfo.authenticated = YES for Account identifier %@ and username %@", buf, 0x16u);
...
- (BOOL)saveKeychainInformationsForURL:(id)a3 andPassword:(id)a4 withAccessibility:(int)a5
{
  ...
  if (os_log_type_enabled(v10, v12))
  {
    ...
    *(void *)&uint8_t buf[4] = v8;
    _os_log_impl(&dword_1BA384000, v10, v12, "Saving password for %@", buf, 0xCu);
  }

  BOOL v13 = [v8 user];
  uint64_t v14 = [v8 host];
  os_log_type_t v15 = [v8 scheme];
  if (v9
    && ([v9 isEqualToString:&stru_1F13DB4B0] & 1) == 0
    && v13
    && ([v13 isEqualToString:&stru_1F13DB4B0] & 1) == 0
    && v14
    && ([v14 isEqualToString:&stru_1F13DB4B0] & 1) == 0
    && v15
    && ![v15 isEqualToString:&stru_1F13DB4B0])
  {
...
LABEL_40:
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_1BA384000, v39, v12, "Setting password for account", buf, 2u);
        }
        ...
        *(void *)buf = 0;
        ...
        if (v40 == -25299)
        {
          ...
          if (v41)
          {
            ...
            if (os_log_type_enabled(v46, valueb))
            {
              *(_DWORD *)v62 = 67109120;
              OSStatus v63 = v41;
              _os_log_impl(&dword_1BA384000, v46, valueb, "Couldn't set password, error %d", v62, 8u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v47, v48))
          {
            *(_DWORD *)v62 = 67109120;
            OSStatus v63 = v41;
            _os_log_impl(&dword_1BA384000, v47, v48, "Couldn't add password, error %d", v62, 8u);
          }
...
LABEL_70:
        ...
        if (os_log_type_enabled(v49, v50))
        {
          ...
          *(_WORD *)&buf[8] = 2112;
          *(void *)&buf[10] = v30;
          _os_log_impl(&dword_1BA384000, v49, v50, "Error %d while trying to add a password: %@", buf, 0x12u);
        }
...
LABEL_68:
  ...
  if (os_log_type_enabled(v16, v17))
  {
    ...
    log = v16;
    if (v9 && ![v9 isEqualToString:&stru_1F13DB4B0]) {
      dispatch_semaphore_t v18 = &stru_1F13DB4B0;
    }
    value = v8;
    long long v19 = @"Login ";
    os_log_type_t v20 = v15;
    id v21 = v9;
    if (v13 && ![v13 isEqualToString:&stru_1F13DB4B0]) {
      long long v19 = &stru_1F13DB4B0;
    }
    v22 = v13;
    BOOL v23 = @"Host ";
    if (v14)
    {
      v24 = v14;
      if (![v14 isEqualToString:&stru_1F13DB4B0]) {
        BOOL v23 = &stru_1F13DB4B0;
      }
    }
    else
    {
    ...
    uint64_t v26 = @"Scheme ";
    if (v20 && ![v20 isEqualToString:&stru_1F13DB4B0]) {
      uint64_t v26 = &stru_1F13DB4B0;
    }
    ...
    *(void *)&buf[14] = v19;
    ...
    _os_log_impl(&dword_1BA384000, log, v17, "Refusing to save password in keychain because one or more of the necessary fields are null: %@%@%@%@", buf, 0x2Au);
    BOOL v25 = 0;
    uint64_t v14 = v24;
    BOOL v13 = v22;
    id v9 = v21;
...
- (id)loadKeychainInformationsForURL:(id)a3
{
  ...
  uint64_t v5 = MEMORY[0x1E4F5E9A0];
  os_log_type_t v6 = *(unsigned char *)(MEMORY[0x1E4F5E9A0] + 7);
  if (os_log_type_enabled(v4, v6))
  {
    *(_DWORD *)buf = 138412290;
    OSStatus v31 = v3;
    _os_log_impl(&dword_1BA384000, v4, v6, "Loading password for %@", buf, 0xCu);
  }
  ...
  if (!v7
    || ([v7 isEqualToString:&stru_1F13DB4B0] & 1) != 0
    || !v8
    || ([v8 isEqualToString:&stru_1F13DB4B0] & 1) != 0
    || !v9
    || [v9 isEqualToString:&stru_1F13DB4B0])
  {
    uint64_t v10 = DALoggingwithCategory();
    ...
    if (os_log_type_enabled(v10, v11))
    {
      ...
      if (v7 && ![v7 isEqualToString:&stru_1F13DB4B0]) {
        os_log_type_t v12 = &stru_1F13DB4B0;
      }
      BOOL v13 = @"Host ";
      if (v8 && ![v8 isEqualToString:&stru_1F13DB4B0]) {
        BOOL v13 = &stru_1F13DB4B0;
      }
      uint64_t v14 = @"Scheme ";
      if (v9 && ![v9 isEqualToString:&stru_1F13DB4B0]) {
        uint64_t v14 = &stru_1F13DB4B0;
      }
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v34 = 2112;
      v35 = v14;
      _os_log_impl(&dword_1BA384000, v10, v11, "Refusing to retrieve password from keychain because one or more of the necessary fields are null: %@%@%@", buf, 0x20u);
    }
  ...
  else
  {
    if (![v9 isEqualToString:@"http"])
    {
      if ([v9 isEqualToString:@"https"]) {
        long long v19 = (const void *)*MEMORY[0x1E4F3B7F8];
      }
      else {
        long long v19 = 0;
      }
...
LABEL_34:
  ...
  if (SecItemCopyMatching(Mutable, &result))
  {
    ...
    if (os_log_type_enabled(v26, v27))
    {
      *(_DWORD *)buf = 138412290;
      OSStatus v31 = v3;
      _os_log_impl(&dword_1BA384000, v26, v27, "Could not find a password in the keychain for %@", buf, 0xCu);
    }
  ...
  else
  {
    ...
    os_log_type_t v15 = (void *)[v28 initWithData:result encoding:4];
  }
  if (result)
  {
    CFRelease(result);
...
- (void)removeKeychainInformationsForURL:(id)a3
{
  ...
  if (os_log_type_enabled(v4, v6))
  {
    int v28 = 138412290;
    *(void *)v29 = v3;
    _os_log_impl(&dword_1BA384000, v4, v6, "Removing password for %@", (uint8_t *)&v28, 0xCu);
  }
    ...
    || [v9 isEqualToString:&stru_1F13DB4B0])
  {
    ...
    if (os_log_type_enabled(v10, v11))
    {
      ...
      *(void *)&v29[10] = v13;
      __int16 v30 = 2112;
      OSStatus v31 = v14;
      _os_log_impl(&dword_1BA384000, v10, v11, "Refusing to delete password from keychain because one or more of the necessary fields are null: %@%@%@", (uint8_t *)&v28, 0x20u);
    }
  ...
  if ([v9 isEqualToString:@"ftp"])
  {
    os_log_type_t v16 = (const void **)MEMORY[0x1E4F3B7D0];
  }
  else
  {
    if (![v9 isEqualToString:@"http"])
    ...
    os_log_type_t v16 = (const void **)MEMORY[0x1E4F3B7E8];
  }
...
LABEL_31:
  ...
  if (v24)
  {
    ...
    if (os_log_type_enabled(v26, v27))
    {
      ...
      *(_WORD *)&v29[4] = 2112;
      *(void *)&v29[6] = v3;
      _os_log_impl(&dword_1BA384000, v26, v27, "error %d: Could not delete password for %@", (uint8_t *)&v28, 0x12u);
    }
  }
  if (Mutable) {
    CFRelease(Mutable);
...
- (id)guessPasswordForURL:(id)a3
{
  ...
  else
  {
    ...
    os_log_type_t v15 = [v4 path];
    os_log_type_t v16 = objc_msgSend(v12, "da_URLWithScheme:host:port:uri:", v13, v14, 0, v15);
