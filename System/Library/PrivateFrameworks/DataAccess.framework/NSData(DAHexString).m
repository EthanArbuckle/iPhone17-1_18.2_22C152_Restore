...
- (id)da_hexString
{
  ...
  v4 = malloc_type_malloc(((9 * v3) >> 2) & 0x1FFFFFFFFFFFFFFFLL, 0x14102341uLL);
  if (v3 < 5)
  {
    uint64_t v5 = 0;
    v7 = v4;
...
- (id)da_uppercaseHexStringWithoutSpaces
{
  ...
  objc_msgSend(v3, "replaceOccurrencesOfString:withString:options:range:", @" ", &stru_1F13DB4B0, 0, 0, objc_msgSend(v3, "length"));
  return v3;
}
