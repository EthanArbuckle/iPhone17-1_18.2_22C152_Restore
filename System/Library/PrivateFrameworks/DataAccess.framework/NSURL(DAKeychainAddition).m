...
- (id)URLWithUsername:()DAKeychainAddition withPassword:
{
  v6 = a3;
  uint64_t v7 = a4;
  if (v6 && ![(__CFString *)v6 isEqualToString:&stru_1F13DB4B0])
  {
    if (v7)
    {
      v11 = [a1 scheme];
      ...
      {
        v16 = (__CFString *)CFURLCreateStringByAddingPercentEscapes(0, v6, &stru_1F13DB4B0, @"?@/|:", 0x8000100u);
        v17 = (__CFString *)CFURLCreateStringByAddingPercentEscapes(0, v7, &stru_1F13DB4B0, @"?@/|:", 0x8000100u);
...
- (id)URLWithUsername:()DAKeychainAddition
{
  v4 = a3;
  v5 = v4;
  if (v4 && ![(__CFString *)v4 isEqualToString:&stru_1F13DB4B0])
  {
    ...
    if ([v10 hasPrefix:v8])
    {
      v11 = (__CFString *)CFURLCreateStringByAddingPercentEscapes(0, v5, &stru_1F13DB4B0, @"?@/|:", 0x8000100u);
