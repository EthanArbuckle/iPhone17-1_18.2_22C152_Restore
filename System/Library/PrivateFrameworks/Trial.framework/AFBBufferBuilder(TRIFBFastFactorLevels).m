...
- (id)trifbCreateFastFactorLevelsUsingBlock:()TRIFBFastFactorLevels
{
  ...
  if (!v5)
  {
    ...
    [v29 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 4683, @"Invalid parameter not satisfying: %@", @"block" object file lineNumber description];
  }
  ...
  {
    v30.receiver = v7;
    v30.super_class = (Class)TRIFBFastFactorLevelsBuilder;
    v9 = (TRIFBFastFactorLevelsBuilder *)objc_msgSendSuper2(&v30, sel_init);
    v7 = v9;
    if (v9)
    {
    ...
    if (v13)
    {
      ...
      if (v18 >= 5 && v17[2])
      {
        if (v18 >= 9 && v17[4])
        {
          ...
          [v26 handleFailureInMethod:sel__finish, v7, @"TRIFBFastFactorLevels_generated.mm", 4610, @"%@", @"Failed to set required field \"namespaceName\" on a table of type: TRIFBFastFactorLevelsBuilder" object file lineNumber description];
        ...
        else
        {
          ...
          [v24 handleFailureInMethod:sel__finish, v7, @"TRIFBFastFactorLevels_generated.mm", 4599, @"%@", @"Failed to set required field \"source\" on a table of type: TRIFBFastFactorLevelsBuilder" object file lineNumber description];
      ...
      else
      {
        ...
        [v20 handleFailureInMethod:sel__finish, v7, @"TRIFBFastFactorLevels_generated.mm", 4588, @"%@", @"Failed to set required field \"levels\" on a table of type: TRIFBFastFactorLevelsBuilder" object file lineNumber description];
...
- (id)trifbFinishedBufferWithRootFastFactorLevelsOfs:()TRIFBFastFactorLevels error:
{
  ...
  if (!v7)
  {
    ...
    [v19 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 4705, @"Invalid parameter not satisfying: %@", @"ofs" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  id v8 = [a1 firstError];
  ...
  else
  {
    ...
    id v21 = 0;
    int v12 = [a1 trifbFinishBufferWithRootFastFactorLevelsOfs:v7 error:&v21];
    id v13 = v21;
    if (v12)
    {
      id v20 = v13;
...
- (uint64_t)trifbFinishBufferWithRootFastFactorLevelsOfs:()TRIFBFastFactorLevels error:
{
  ...
  if (!v7)
  {
    ...
    [v22 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 4739, @"Invalid parameter not satisfying: %@", @"ofs" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  id v8 = [a1 firstError];
