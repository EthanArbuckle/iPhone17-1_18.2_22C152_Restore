...
- (id)trifbCreateFactorMetadataKeyValueUsingBlock:()TRIFBFactorMetadataKeyValue
{
  ...
  if (!v5)
  {
    ...
    [v27 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 2857, @"Invalid parameter not satisfying: %@", @"block" object file lineNumber description];
  }
  ...
  {
    v28.receiver = v7;
    v28.super_class = (Class)TRIFBFactorMetadataKeyValueBuilder;
    v9 = (TRIFBFactorMetadataKeyValueBuilder *)objc_msgSendSuper2(&v28, sel_init);
    v7 = v9;
    if (v9)
    {
  ...
  if (v7)
  {
    ...
    if (v13)
    {
      ...
      if (v18 >= 5 && v17[2])
      {
        ...
        [v24 handleFailureInMethod:sel__finish, v7, @"TRIFBFastFactorLevels_generated.mm", 2814, @"%@", @"Failed to set required field \"val\" on a table of type: TRIFBFactorMetadataKeyValueBuilder" object file lineNumber description];
      ...
      else
      {
        ...
        [v20 handleFailureInMethod:sel__finish, v7, @"TRIFBFastFactorLevels_generated.mm", 2803, @"%@", @"Failed to set required field \"key\" on a table of type: TRIFBFactorMetadataKeyValueBuilder" object file lineNumber description];
...
- (id)trifbCreateSortedVectorOfFactorMetadataKeyValueWithOffsets:()TRIFBFactorMetadataKeyValue
{
  ...
  if (!v5)
  {
    ...
    [v31 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 2866, @"Invalid parameter not satisfying: %@", @"offsets" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  v6 = [a1 firstError];
  ...
  else
  {
    ...
    if (v22 == v21) {
      id v25 = (char *)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<FactorMetadataKeyValue>,std::allocator<apple::aiml::flatbuffers2::Offset<FactorMetadataKeyValue>>>(std::vector<apple::aiml::flatbuffers2::Offset<FactorMetadataKeyValue>> &)::t;
    }
    else {
      id v25 = (char *)v34[6];
    }
...
- (id)trifbFinishedBufferWithRootFactorMetadataKeyValueOfs:()TRIFBFactorMetadataKeyValue error:
{
  ...
  if (!v7)
  {
    ...
    [v19 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 2883, @"Invalid parameter not satisfying: %@", @"ofs" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  ...
  else
  {
    ...
    id v21 = 0;
    int v12 = [a1 trifbFinishBufferWithRootFactorMetadataKeyValueOfs:v7 error:&v21];
    id v13 = v21;
    if (v12)
    {
      id v20 = v13;
...
- (uint64_t)trifbFinishBufferWithRootFactorMetadataKeyValueOfs:()TRIFBFactorMetadataKeyValue error:
{
  ...
  if (!v7)
  {
    ...
    [v22 handleFailureInMethod:a2, a1, @"TRIFBFastFactorLevels_generated.mm", 2917, @"Invalid parameter not satisfying: %@", @"ofs" object file lineNumber description];
  }
  [a1 throwIfFinalizedWithSelector:a2];
  unint64_t v8 = [a1 firstError];
