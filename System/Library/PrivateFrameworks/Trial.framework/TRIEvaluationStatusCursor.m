@interface TRIEvaluationStatusCursor
+ (BOOL)supportsSecureCoding;
- (BOOL)isEqual:(id)a3;
- (NSDate)date;
- (TRIEvaluationStatusCursor)initWithCoder:(id)a3;
- (TRIEvaluationStatusCursor)initWithSecondsFromEpoch:(double)a3;
- (unint64_t)hash;
- (void)encodeWithCoder:(id)a3;
@end

@implementation TRIEvaluationStatusCursor

- (TRIEvaluationStatusCursor)initWithSecondsFromEpoch:(double)a3
{
  v5.receiver = self;
  v5.super_class = (Class)TRIEvaluationStatusCursor;
  result = [(TRIEvaluationStatusCursor *)&v5 init];
  if (result) {
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      if ([v6 hasLowerBoundExclusive])
      {
        ...
        self = -[TRIEvaluationStatusCursor initWithSecondsFromEpoch:](self, "initWithSecondsFromEpoch:");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (!v7)
  {
    ...
    [v8 handleFailureInMethod:a2, self, @"TRIEvaluationStatusProvider.m", 88, @"Invalid parameter not satisfying: %@", @"data" object file lineNumber description];
  }
