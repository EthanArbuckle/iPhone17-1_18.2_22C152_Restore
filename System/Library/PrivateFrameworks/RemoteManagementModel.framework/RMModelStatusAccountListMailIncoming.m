...
+ (id)buildWithIdentifier:(id)a3 removed:(id)a4 declarationIdentifier:(id)a5 visibleName:(id)a6 hostname:(id)a7 port:(id)a8 username:(id)a9 isMailEnabled:(id)a10 areNotesEnabled:(id)a11;
+ (id)statusItemType;
+ (id)supportedOS;
- (BOOL)isArrayValue;
...
+ (id)buildWithIdentifier:(id)a3 removed:(id)a4 declarationIdentifier:(id)a5 visibleName:(id)a6 hostname:(id)a7 port:(id)a8 username:(id)a9 isMailEnabled:(id)a10 areNotesEnabled:(id)a11
{
  ...
  [v25 setStatusIsMailEnabled:v17];
...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_2708C2AA8;
  v15 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF160];
  v19[0] = v15;
  v14 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF178];
  v19[1] = v14;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:2];
  v21[0] = v13;
  v20[1] = &unk_2708C2AF0;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF190];
  v18[0] = v2;
  id v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF1A8];
  v18[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v18 count:2];
  v21[1] = v4;
  v20[2] = &unk_2708C2AC0;
  v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF1C0];
  v17[0] = v5;
  v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF1D8];
  v17[1] = v6;
  v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v17 count:2];
  v21[2] = v7;
  v20[3] = &unk_2708C2B08;
  v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF1F0];
  v16[0] = v8;
  v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF208];
  v16[1] = v9;
...
{
  v4 = objc_opt_new();
  v5 = [(RMModelStatusAccountListMailIncoming *)self statusIdentifier];
  [(RMModelPayloadBase *)self serializeStringIntoDictionary:v4 usingKey:@"identifier" value:v5 isRequired:1 defaultValue:0];

  v6 = [(RMModelStatusAccountListMailIncoming *)self statusRemoved];
  ...
  id v7 = [(RMModelStatusAccountListMailIncoming *)self statusDeclarationIdentifier];
...
{
  v24.receiver = self;
  v24.super_class = (Class)RMModelStatusAccountListMailIncoming;
