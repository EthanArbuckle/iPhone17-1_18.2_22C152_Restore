...
{
  id v5 = objc_opt_new();
  id v6 = [(RMModelAccountMailDeclaration_SMIME *)self payloadSigning];
  ...
  v7 = [(RMModelAccountMailDeclaration_SMIME *)self payloadEncryption];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v5 = [(RMModelAccountMailDeclaration_SMIMESigning *)self->_payloadSigning copy];
  id v6 = (void *)v4[2];
  v4[2] = v5;

  uint64_t v7 = [(RMModelAccountMailDeclaration_SMIMEEncryption *)self->_payloadEncryption copy];
  id v8 = (void *)v4[3];
  v4[3] = v7;
