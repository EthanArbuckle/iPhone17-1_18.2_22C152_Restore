...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.asset.credential.acme";
}
...
+ (id)supportedOS
{
  ...
  v28[0] = &unk_2708C19E0;
  v21 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD300];
  v27[0] = v21;
  v20 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD318];
  v27[1] = v20;
  v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:2];
  v29[0] = v19;
  v28[1] = &unk_2708C19F8;
  v18 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD330];
  v26[0] = v18;
  v17 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD348];
  v26[1] = v17;
  v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v26 count:2];
  v29[1] = v16;
  v28[2] = &unk_2708C1A10;
  v15 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD360];
  v25[0] = v15;
  v14 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD378];
  v25[1] = v14;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
  v29[2] = v13;
  v28[3] = &unk_2708C1A28;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD390];
  v24[0] = v2;
  v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD3A8];
  v24[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
  v29[3] = v4;
  v28[4] = &unk_2708C1A40;
  id v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD3C0];
  v23[0] = v5;
  id v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD3D8];
  v23[1] = v6;
  v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
  v29[4] = v7;
  v28[5] = &unk_2708C1A58;
  v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD3F0];
  v22[0] = v8;
  id v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD408];
  v22[1] = v9;
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  id v12 = +[RMModelAssetCredentialACMEDeclaration allowedPayloadKeys];
  [v11 minusSet:v12];
...
{
  id v5 = objc_opt_new();
  id v6 = [(RMModelAssetCredentialACMEDeclaration *)self payloadReference];
  ...
  id v8 = [(RMModelAssetCredentialACMEDeclaration *)self payloadAccessible];
