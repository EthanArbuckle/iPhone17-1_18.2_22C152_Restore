...
{
  v4 = objc_opt_new();
  id v5 = [(RMModelSoftwareUpdateSettingsDeclaration_BetaRequireProgram *)self payloadDescription];
  [(RMModelPayloadBase *)self serializeStringIntoDictionary:v4 usingKey:@"Description" value:v5 isRequired:1 defaultValue:0];

  id v6 = [(RMModelSoftwareUpdateSettingsDeclaration_BetaRequireProgram *)self payloadToken];
...
- (void)combineWithOther:(id)a3
{
  ...
  id v10 = [(RMModelSoftwareUpdateSettingsDeclaration_BetaRequireProgram *)self payloadToken];
  v8 = [v4 payloadToken];
