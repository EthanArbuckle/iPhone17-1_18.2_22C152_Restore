...
- (NSString)payloadAssignment;
- (id)copyWithZone:(_NSZone *)a3;
- (id)serializeWithType:(signed __int16)a3;
- (void)setPayloadAssignment:(id)a3;
@end
...
{
  v8.receiver = self;
  v8.super_class = (Class)RMModelAppManagedDeclaration_InstallBehaviorLicense;
  v4 = [(RMModelPayloadBase *)&v8 copyWithZone:a3];
  uint64_t v5 = [(NSString *)self->_payloadAssignment copy];
  v6 = (void *)v4[2];
  v4[2] = v5;
...
- (NSString)payloadAssignment
{
  return self->_payloadAssignment;
}
