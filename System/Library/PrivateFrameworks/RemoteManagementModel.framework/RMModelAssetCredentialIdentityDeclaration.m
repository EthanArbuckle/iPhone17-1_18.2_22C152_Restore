@interface RMModelAssetCredentialIdentityDeclaration
...
@implementation RMModelAssetCredentialIdentityDeclaration
...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.asset.credential.identity";
}
...
+ (id)buildWithIdentifier:(id)a3 reference:(id)a4 authentication:(id)a5 accessible:(id)a6
{
  ...
  id v12 = a4;
  v13 = objc_opt_new();
  [v13 setDeclarationType:@"com.apple.asset.credential.identity"];
  if (v9)
  {
...
+ (id)buildRequiredOnlyWithIdentifier:(id)a3 reference:(id)a4
{
  ...
  id v6 = a4;
  v7 = objc_opt_new();
  [v7 setDeclarationType:@"com.apple.asset.credential.identity"];
  if (v5)
  {
...
+ (id)supportedOS
{
  ...
  v28[0] = &unk_2708C1B00;
  v21 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD540];
  v27[0] = v21;
  v20 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD558];
  v27[1] = v20;
  v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:2];
  v29[0] = v19;
  v28[1] = &unk_2708C1B18;
  v18 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD570];
  v26[0] = v18;
  v17 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD588];
  v26[1] = v17;
  v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v26 count:2];
  v29[1] = v16;
  v28[2] = &unk_2708C1B30;
  v15 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD5A0];
  v25[0] = v15;
  v14 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD5B8];
  v25[1] = v14;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
  v29[2] = v13;
  v28[3] = &unk_2708C1B48;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD5D0];
  v24[0] = v2;
  v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD5E8];
  v24[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
  v29[3] = v4;
  v28[4] = &unk_2708C1B60;
  id v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD600];
  v23[0] = v5;
  id v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD618];
  v23[1] = v6;
  v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
  v29[4] = v7;
  v28[5] = &unk_2708C1B78;
  v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD630];
  v22[0] = v8;
  id v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD648];
  v22[1] = v9;
...
- (BOOL)loadPayloadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  id v12 = +[RMModelAssetCredentialIdentityDeclaration allowedPayloadKeys];
  [v11 minusSet:v12];
...
{
  id v5 = objc_opt_new();
  id v6 = [(RMModelAssetCredentialIdentityDeclaration *)self payloadReference];
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
  v13[2] = __70__RMModelAssetCredentialIdentityDeclaration_serializePayloadWithType___block_invoke;
  ...
  v7 = [(RMModelAssetCredentialIdentityDeclaration *)self payloadAuthentication];
  v11[0] = MEMORY[0x263EF8330];
  v11[1] = 3221225472;
  v11[2] = __70__RMModelAssetCredentialIdentityDeclaration_serializePayloadWithType___block_invoke_2;
  ...
  id v8 = [(RMModelAssetCredentialIdentityDeclaration *)self payloadAccessible];
...
uint64_t __70__RMModelAssetCredentialIdentityDeclaration_serializePayloadWithType___block_invoke(uint64_t a1, void *a2)
{
  return [a2 serializeWithType:*(__int16 *)(a1 + 32)];
}

uint64_t __70__RMModelAssetCredentialIdentityDeclaration_serializePayloadWithType___block_invoke_2(uint64_t a1, void *a2)
{
  return [a2 serializeWithType:*(__int16 *)(a1 + 32)];
}
...
{
  v12.receiver = self;
  v12.super_class = (Class)RMModelAssetCredentialIdentityDeclaration;
