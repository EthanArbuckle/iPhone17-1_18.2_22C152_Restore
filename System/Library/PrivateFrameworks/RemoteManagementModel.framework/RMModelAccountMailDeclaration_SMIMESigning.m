...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  id v11 = +[RMModelAccountMailDeclaration_SMIMESigning allowedPayloadKeys];
  [v10 minusSet:v11];
...
- (id)serializeWithType:(signed __int16)a3
{
  ...
  id v7 = [(RMModelAccountMailDeclaration_SMIMESigning *)self payloadUserOverrideable];
  ...
  id v9 = [(RMModelAccountMailDeclaration_SMIMESigning *)self payloadIdentityUserOverrideable];
