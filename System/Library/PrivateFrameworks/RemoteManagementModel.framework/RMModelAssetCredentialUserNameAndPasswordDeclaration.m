...
+ (NSString)registeredIdentifier
{
  return (NSString *)@"com.apple.asset.credential.userpassword";
}
...
+ (id)supportedOS
{
  ...
  v28[0] = &unk_2708C1C20;
  v21 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD780];
  v27[0] = v21;
  v20 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD798];
  v27[1] = v20;
  v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:2];
  v29[0] = v19;
  v28[1] = &unk_2708C1C38;
  v18 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD7B0];
  v26[0] = v18;
  v17 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD7C8];
  v26[1] = v17;
  v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v26 count:2];
  v29[1] = v16;
  v28[2] = &unk_2708C1C50;
  v15 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD7E0];
  v25[0] = v15;
  v14 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD7F8];
  v25[1] = v14;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
  v29[2] = v13;
  v28[3] = &unk_2708C1C68;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD810];
  v24[0] = v2;
  v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD828];
  v24[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
  v29[3] = v4;
  v28[4] = &unk_2708C1C80;
  id v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD840];
  v23[0] = v5;
  id v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD858];
  v23[1] = v6;
  id v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
  v29[4] = v7;
  v28[5] = &unk_2708C1C98;
  id v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD870];
  v22[0] = v8;
  id v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BD888];
  v22[1] = v9;
...
{
  id v5 = objc_opt_new();
  id v6 = [(RMModelAssetCredentialUserNameAndPasswordDeclaration *)self payloadReference];
  ...
  id v7 = [(RMModelAssetCredentialUserNameAndPasswordDeclaration *)self payloadAuthentication];
