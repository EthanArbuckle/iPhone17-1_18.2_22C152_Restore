...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_2708C2B20;
  id v15 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF220];
  v19[0] = v15;
  v14 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF238];
  v19[1] = v14;
  v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:2];
  v21[0] = v13;
  v20[1] = &unk_2708C2B68;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF250];
  v18[0] = v2;
  id v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF268];
  v18[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v18 count:2];
  v21[1] = v4;
  v20[2] = &unk_2708C2B38;
  v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF280];
  v17[0] = v5;
  v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF298];
  v17[1] = v6;
  v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v17 count:2];
  v21[2] = v7;
  v20[3] = &unk_2708C2B80;
  v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF2B0];
  v16[0] = v8;
  v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BF2C8];
  v16[1] = v9;
...
- (id)serializePayloadWithType:(signed __int16)a3
{
  ...
  id v7 = [(RMModelStatusAccountListMailOutgoing *)self statusDeclarationIdentifier];
