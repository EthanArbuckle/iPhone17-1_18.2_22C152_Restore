...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  id v11 = +[RMModelAccountExchangeDeclaration_SMIMEEncryption allowedPayloadKeys];
  [v10 minusSet:v11];
...
{
  v4 = objc_opt_new();
  v5 = [(RMModelAccountExchangeDeclaration_SMIMEEncryption *)self payloadEnabled];
  [(RMModelPayloadBase *)self serializeBooleanIntoDictionary:v4 usingKey:@"Enabled" value:v5 isRequired:1 defaultValue:0];

  v6 = [(RMModelAccountExchangeDeclaration_SMIMEEncryption *)self payloadIdentityAssetReference];
  ...
  id v7 = [(RMModelAccountExchangeDeclaration_SMIMEEncryption *)self payloadUserOverrideable];
  ...
  v9 = [(RMModelAccountExchangeDeclaration_SMIMEEncryption *)self payloadIdentityUserOverrideable];
  ...
  v10 = [(RMModelAccountExchangeDeclaration_SMIMEEncryption *)self payloadPerMessageSwitchEnabled];
