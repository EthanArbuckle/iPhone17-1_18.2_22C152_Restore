...
+ (id)supportedOS
{
  ...
  v16[0] = &unk_2708C3960;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708C0B88];
  v15[0] = v2;
  v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708C0BA0];
  v15[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v15 count:2];
  v17[0] = v4;
  v16[1] = &unk_2708C3978;
  v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708C0BB8];
  v14[0] = v5;
  v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708C0BD0];
  v14[1] = v6;
  v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v14 count:2];
  v17[1] = v7;
  v16[2] = &unk_2708C39A8;
  v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708C0BE8];
  v13[0] = v8;
  v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708C0C00];
  v13[1] = v9;
