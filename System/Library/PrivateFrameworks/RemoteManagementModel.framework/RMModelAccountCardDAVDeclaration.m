...
+ (id)assetTypes
{
  return (id)[MEMORY[0x263EFFA08] setWithArray:&unk_2708BC940];
}

- (id)assetReferences
{
  if (assetReferences_onceToken_0 != -1) {
    dispatch_once(&assetReferences_onceToken_0, &__block_literal_global_0);
  }
  uint64_t v3 = assetReferences_assetPaths_0;
...
void __51__RMModelAccountCardDAVDeclaration_assetReferences__block_invoke()
{
  ...
  v0 = [[RMModelConfigurationSchemaAssetReference alloc] initWithAssetTypes:&unk_2708BC958 keyPath:@"$.payloadAuthenticationCredentialsAssetReference"];
  v3[0] = v0;
  uint64_t v1 = [MEMORY[0x263EFF8C0] arrayWithObjects:v3 count:1];
  v2 = (void *)assetReferences_assetPaths_0;
...
+ (id)supportedOS
{
  ...
  v20[0] = &unk_2708C1560;
  id v15 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BC970];
  v19[0] = v15;
  id v14 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BC988];
  v19[1] = v14;
  id v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:2];
  v21[0] = v13;
  v20[1] = &unk_2708C15A8;
  v2 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BC9A0];
  v18[0] = v2;
  uint64_t v3 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BC9B8];
  v18[1] = v3;
  v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v18 count:2];
  v21[1] = v4;
  v20[2] = &unk_2708C1578;
  id v5 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BC9D0];
  v17[0] = v5;
  id v6 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BC9E8];
  v17[1] = v6;
  v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v17 count:2];
  v21[2] = v7;
  v20[3] = &unk_2708C15C0;
  v8 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BCA00];
  v16[0] = v8;
  v9 = [MEMORY[0x263EFFA08] setWithArray:&unk_2708BCA18];
  v16[1] = v9;
...
{
  v16.receiver = self;
  v16.super_class = (Class)RMModelAccountCardDAVDeclaration;
