...
- (void)_oobEnsureStarted
{
  if (!self->super._skCnx)
  {
    ...
    [(SKSetupBase *)self _connectionStartWithSKConnection:v3 clientMode:0 completeOnFailure:0 completion:&__block_literal_global_24];
  }
}
...
LABEL_4:
  ...
  else
  {
    ...
    [(SKSetupBase *)self _connectionStartWithSKConnection:v5 clientMode:0 completeOnFailure:0 completion:&__block_literal_global_1104];
  }
LABEL_8:
}
...
- (void)_bleServerEnsureStarted
{
  ...
  if (!self->_bleServer)
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __56__SKSetupFieldDiagnosticsServer__bleServerEnsureStarted__block_invoke;
    v8[3] = &unk_264548FF8;
    v8[4] = v4;
    v8[5] = self;
    ...
    v7[1] = 3221225472;
    v7[2] = __56__SKSetupFieldDiagnosticsServer__bleServerEnsureStarted__block_invoke_2;
    v7[3] = &unk_2645496B0;
    v7[4] = v4;
    v7[5] = self;
...
- (void)_bleAdvertiserEnsureStarted
{
  ...
  if (!self->_bleAdvertiser)
  {
    ...
    v7[0] = MEMORY[0x263EF8330];
    v7[1] = 3221225472;
    v7[2] = __60__SKSetupFieldDiagnosticsServer__bleAdvertiserEnsureStarted__block_invoke;
    v7[3] = &unk_2645496B0;
    v7[4] = v4;
    v7[5] = self;
    objc_msgSend(v4, "activateWithCompletion:", v7, v6);
...
- (void)_prepareSteps
{
  ...
  uint64_t v4 = objc_alloc_init(SKStepWiFiSetupServerCW);
...
void __46__SKSetupFieldDiagnosticsServer__prepareSteps__block_invoke(uint64_t a1, void *a2)
{
  id v3 = *(void **)(a1 + 32);
  id v4 = a2;
  int v5 = [[SKEvent alloc] initWithEventType:20 error:v4];
...
- (void)_invalidate
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKSetupFieldDiagnosticsServer;
...
{
  v6.receiver = self;
  v6.super_class = (Class)SKSetupFieldDiagnosticsServer;
  int v2 = [(SKSetupBase *)&v6 initWithLogCategory:&gLogCategory_SKSetupFieldDiagnosticsServer];
  objc_super v3 = v2;
  if (v2) {
    id v4 = v2;
  }
