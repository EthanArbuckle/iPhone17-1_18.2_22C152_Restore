...
- (void)_oobEnsureStarted
{
  if (!self->super._skCnx)
  {
    ...
    [(SKSetupBase *)self _connectionStartWithSKConnection:v3 clientMode:0 completeOnFailure:0 completion:&__block_literal_global_22];
  }
}
...
- (void)_bleServerEnsureStarted
{
  ...
  if (!self->_bleServer)
  {
    ...
    v8[1] = 3221225472;
    v8[2] = __48__SKSetupMacSetupServer__bleServerEnsureStarted__block_invoke;
    v8[3] = &unk_264548FF8;
    v8[4] = v4;
    v8[5] = self;
    ...
    v7[1] = 3221225472;
    v7[2] = __48__SKSetupMacSetupServer__bleServerEnsureStarted__block_invoke_2;
    v7[3] = &unk_2645496B0;
    v7[4] = v4;
    v7[5] = self;
...
- (void)_bleAdvertiserEnsureStarted
{
  ...
  if (!self->_bleAdvertiser)
  {
    ...
    v7[0] = MEMORY[0x263EF8330];
    v7[1] = 3221225472;
    v7[2] = __52__SKSetupMacSetupServer__bleAdvertiserEnsureStarted__block_invoke;
    v7[3] = &unk_2645496B0;
    v7[4] = v4;
    v7[5] = self;
    objc_msgSend(v4, "activateWithCompletion:", v7, v6);
...
- (void)_invalidate
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKSetupMacSetupServer;
...
{
  v6.receiver = self;
  v6.super_class = (Class)SKSetupMacSetupServer;
  int v2 = [(SKSetupBase *)&v6 initWithLogCategory:&gLogCategory_SKSetupMacSetupServer];
  objc_super v3 = v2;
  if (v2) {
    uint64_t v4 = v2;
  }
