...
- (id)templateForLayoutMode:(int64_t)a3
{
  ...
  v12 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:11.0];
  ...
  if (v6)
  {
    v16 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:18.0];
  ...
  {
    v18 = [MEMORY[0x1E4FB08E0] systemFontOfSize:28.0];
  ...
  v22 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:18.0];
  ...
  v26 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:18.0];
  ...
  v29 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:18.0];
...
- (id)templateForHeaderBucket
{
  ...
  double v3 = [v2 defaultFieldTemplate];
  double v4 = [MEMORY[0x1E4FB08E0] systemFontOfSize:20.0];
  [v3 setValueFont:v4];
