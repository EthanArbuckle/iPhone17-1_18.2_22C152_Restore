...
- (void).cxx_destruct
{
  ...
  sub_19F482DB0((uint64_t)self + OBJC_IVAR____TtC9PassKitUI36ProvisioningAppleBalanceHeroFlowItem_delegate);
...
- (void)appleBalanceExplanationViewControllerDidSelectContinue:(id)a3
{
  ...
  if (MEMORY[0x1A6224F80]((char *)self + OBJC_IVAR____TtC9PassKitUI36ProvisioningAppleBalanceHeroFlowItem_delegate, a2))
  {
    uint64_t v6 = *((void *)v5 + 1);
    uint64_t ObjectType = swift_getObjectType();
    id v8 = a3;
    v9 = self;
    sub_19FBE1190((uint64_t)v9, (uint64_t)&off_1EF1A9260, ObjectType, v6);
