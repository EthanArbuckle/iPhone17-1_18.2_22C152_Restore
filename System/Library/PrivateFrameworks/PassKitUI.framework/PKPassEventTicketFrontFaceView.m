...
- (id)templateForLayoutMode:(int64_t)a3
{
  ...
  v90.size.width = v11;
  v90.size.height = v13;
  BOOL IsEmpty = CGRectIsEmpty(v90);
  ...
  if (v15)
  {
    ...
    v30 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:11.0];
    ...
    v35 = [MEMORY[0x1E4FB08E0] systemFontOfSize:20.0];
    ...
    v40 = [MEMORY[0x1E4FB08E0] systemFontOfSize:16.0];
    ...
    v44 = [MEMORY[0x1E4FB08E0] systemFontOfSize:14.0];
    ...
    v49 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:10.0];
    [v48 setLabelFont:v49];

    v50 = [(PKPassBucketTemplate *)v47 defaultFieldTemplate];
    v51 = (void *)MEMORY[0x1E4FB08E0];
  }
  else
  {
    ...
    v58 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:11.0];
    ...
    v63 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:66.0];
    [v62 setValueFont:v63];

    v64 = [(PKPassBucketTemplate *)v60 defaultFieldTemplate];
    v65 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:18.0];
    ...
    v73 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:10.0];
    [v72 setLabelFont:v73];

    v74 = [(PKPassBucketTemplate *)v71 defaultFieldTemplate];
    v75 = [MEMORY[0x1E4FB08E0] systemFontOfSize:20.0];
    ...
    v80 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:10.0];
    [v79 setLabelFont:v80];

    v81 = [(PKPassBucketTemplate *)v78 defaultFieldTemplate];
    v82 = [MEMORY[0x1E4FB08E0] systemFontOfSize:20.0];
    ...
    v85 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:10.0];
