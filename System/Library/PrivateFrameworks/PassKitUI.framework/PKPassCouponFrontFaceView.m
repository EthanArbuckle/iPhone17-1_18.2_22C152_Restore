...
- (id)templateForLayoutMode:(int64_t)a3
{
  ...
  v9 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:11.0];
  [v8 setLabelFont:v9];
  ...
  v14 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:66.0];
  [v13 setValueFont:v14];

  v15 = [(PKPassBucketTemplate *)v11 defaultFieldTemplate];
  v16 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:18.0];
  ...
  v20 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:18.0];
  ...
  v28 = [MEMORY[0x1E4FB08E0] _lightSystemFontOfSize:26.0];
  [v27 setValueFont:v28];

  v29 = [(PKPassBucketTemplate *)v26 defaultFieldTemplate];
  [v29 setVerticalPadding:-4.0];
