...
- (void)viewDidLoad
{
  ...
  [(PKPeerPaymentMessagesContentRecipientRestrictedOutsideContactsViewController *)&v9 viewDidLoad];
...
- (void)reloadContent
{
  ...
  v2 = [v4 label];
  v3 = PKLocalizedPeerPaymentLexingtonString(&cfstr_PeerPaymentMes_30.isa);
  [v2 setText:v3];
}
