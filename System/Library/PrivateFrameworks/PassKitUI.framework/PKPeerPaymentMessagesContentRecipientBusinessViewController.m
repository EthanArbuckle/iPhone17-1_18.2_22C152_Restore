...
{
  v12.receiver = self;
  v12.super_class = (Class)PKPeerPaymentMessagesContentRecipientBusinessViewController;
  [(PKPeerPaymentMessagesContentRecipientBusinessViewController *)&v12 viewDidLoad];
  ...
  v10 = [v9 label];
  v11 = PKLocalizedPeerPaymentString(&cfstr_PeerPaymentMes_33.isa);
  [v10 setText:v11];
}
