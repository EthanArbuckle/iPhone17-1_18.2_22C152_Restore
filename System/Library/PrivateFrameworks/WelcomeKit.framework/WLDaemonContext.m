...
{
  id v3 = a3;
  id v4 = objc_alloc_init((Class)WLContext);
  v65 = [v3 application];
  v87[0] = v65;
  v64 = [v4 application];
  v87[1] = v64;
  ...
  v88[16] = v11;
  v32 = +[NSArray arrayWithObjects:v88 count:17];
  ...
  long long v67 = 0u;
  id v12 = v32;
  id v13 = [v12 countByEnumeratingWithState:&v66 objects:v70 count:16];
  if (v13)
  {
    id v14 = v13;
    ...
    do
    {
      ...
      id v14 = [v12 countByEnumeratingWithState:&v66 objects:v70 count:16];
    }
    while (v14);
  }
...
+ (void)convertMKImportContext:(id)a3 toWLImportContext:(id)a4
{
  id v7 = a4;
  id v5 = a3;
  objc_msgSend(v7, "setImportCount:", objc_msgSend(v5, "importCount"));
  objc_msgSend(v7, "setImportErrorCount:", objc_msgSend(v5, "importErrorCount"));
  id v6 = [v5 size];
