...
- (ASCAppDistributionOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      else
      {
        ...
        if (v31) {
          -[ASCAppDistributionOffer initWithCoder:](v31, v32, v33, v34, v35, v36, v37, v38);
        }
        v14 = 0;
      }
    }
    else
    {
      ...
      if (v23) {
        -[ASCAppDistributionOffer initWithCoder:](v23, v24, v25, v26, v27, v28, v29, v30);
      }
      v14 = 0;
    }
  }
  else
  {
    ...
    if (v15) {
      -[ASCAppDistributionOffer initWithCoder:](v15, v16, v17, v18, v19, v20, v21, v22);
    }
    v14 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(ASCAppDistributionOffer *)self ageRating];
...
- (ASCAppDistributionOffer)offerWithMetrics:(id)a3
{
  ...
  uint64_t v8 = [(ASCAppDistributionOffer *)self subtitles];
  ...
  v13 = (void *)[v5 initWithID:v6 titles:v7 subtitles:v8 flags:v9 ageRating:v10 metrics:v4 appVersionId:v11 distributorId:v12];
...
- (unint64_t)hash
{
  ...
  uint64_t v8 = [(ASCAppDistributionOffer *)self metrics];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(ASCAppDistributionOffer *)self id];
    uint64_t v9 = [v7 id];
    v10 = (void *)v9;
    if (v8 && v9)
    {
...
LABEL_13:
            ...
            int64_t v18 = [(ASCAppDistributionOffer *)self flags];
            if (v18 == [v7 flags])
            {
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription([(ASCAppDistributionOffer *)self flags]);
