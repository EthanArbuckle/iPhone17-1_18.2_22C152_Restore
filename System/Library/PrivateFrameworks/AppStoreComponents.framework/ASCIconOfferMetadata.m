...
- (ASCIconOfferMetadata)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (v18) {
        -[ASCIconOfferMetadata initWithCoder:](v18, v19, v20, v21, v22, v23, v24, v25);
      }
      uint64_t v9 = 0;
    }
  }
  else
  {
    ...
    if (v10) {
      -[ASCIconOfferMetadata initWithCoder:](v10, v11, v12, v13, v14, v15, v16, v17);
    }
    uint64_t v9 = 0;
  }
...
- (id)imageNameForSize:(id)a3
{
  id v4 = NSString;
  id v5 = a3;
  unint64_t v6 = [(ASCIconOfferMetadata *)self baseImageName];
  int v7 = [v5 isEqualToString:0x1F1E04438];

  v8 = @"Medium";
  if (!v7) {
    v8 = &stru_1F1E020F8;
  }
  uint64_t v9 = [v4 stringWithFormat:@"%@%@%@", v6, v8, &stru_1F1E020F8];
