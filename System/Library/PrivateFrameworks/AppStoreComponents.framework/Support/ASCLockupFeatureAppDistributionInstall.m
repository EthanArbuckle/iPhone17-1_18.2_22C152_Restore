...
- (ASCLockupFeatureAppDistributionInstall)initWithCoder:(id)a3
{
  ...
  id v14 = [v3 decodeBoolForKey:@"isDistributor"];
...
LABEL_18:
                ...
                {
                  v21 = (void *)v19;
                  unsigned int v22 = [v27 isEqual:v19];
                  v20 = v21;
                  if (v22)
                  {
LABEL_21:
                    v23 = v20;
                    unsigned __int8 v24 = [(ASCLockupFeatureAppDistributionInstall *)self isDistributor];
                    unsigned __int8 v25 = [(ASCLockupFeatureAppDistributionInstall *)v8 isDistributor];
                    v20 = v23;
                    char v7 = v24 ^ v25 ^ 1;
LABEL_31:
