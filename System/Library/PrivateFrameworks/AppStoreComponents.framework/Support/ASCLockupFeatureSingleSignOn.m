...
- (ASCLockupFeatureSingleSignOn)initWithCoder:(id)a3
{
  id v4 = [a3 decodeBoolForKey:@"requiresSSOEntitlement"];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (v8)
    {
      unsigned int v9 = [(ASCLockupFeatureSingleSignOn *)self requiresSSOEntitlement];
      unsigned int v7 = v9 ^ [(ASCLockupFeatureSingleSignOn *)v8 requiresSSOEntitlement] ^ 1;
    }
    else
    {
      LOBYTE(v7) = 0;
