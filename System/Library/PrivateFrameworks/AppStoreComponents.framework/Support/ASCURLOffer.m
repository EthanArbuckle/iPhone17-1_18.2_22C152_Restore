...
- (ASCURLOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (v7)
      {
        ...
        if (v10)
        {
          ...
          else
          {
            ...
            if (v45) {
              sub_10013F54C(v45, v46, v47, v48, v49, v50, v51, v52);
            }
            v12 = 0;
          }
        }
        else
        {
          ...
          if (v37) {
            sub_10013F510(v37, v38, v39, v40, v41, v42, v43, v44);
          }
          v12 = 0;
        }
      }
      else
      {
        ...
        if (v29) {
          sub_10013F4D4(v29, v30, v31, v32, v33, v34, v35, v36);
        }
        v12 = 0;
      }
    }
    else
    {
      ...
      if (v21) {
        sub_10013F498(v21, v22, v23, v24, v25, v26, v27, v28);
      }
      v12 = 0;
    }
  }
  else
  {
    ...
    if (v13) {
      sub_10013F45C(v13, v14, v15, v16, v17, v18, v19, v20);
    }
    v12 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v8 = [(ASCURLOffer *)self metrics];
...
- (ASCURLOffer)offerWithMetrics:(id)a3
{
  ...
  id v8 = [(ASCURLOffer *)self subtitles];
...
LABEL_27:
                  ...
                  if (v25 && v26)
                  {
                    ...
                    unsigned int v29 = [v42 isEqual:v26];
                    uint64_t v27 = v28;
                    if (v29)
                    {
LABEL_30:
                      ...
                      if (v30 && v31)
                      {
                        ...
                        unsigned int v34 = [v40 isEqual:v31];
                        uint64_t v32 = v33;
                        if (v34)
                        {
LABEL_33:
                          uint64_t v35 = v32;
                          unsigned __int8 v36 = [(ASCURLOffer *)self isSensitive];
                          unsigned __int8 v37 = [v7 isSensitive];
                          uint64_t v32 = v35;
                          char v17 = v36 ^ v37 ^ 1;
LABEL_41:
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription((__int16)[(ASCURLOffer *)self flags]);
  [(ASCDescriber *)v3 addObject:v7 withName:@"flags"];

  id v8 = [(ASCURLOffer *)self ageRating];
