...
- (ASCOfferAlertOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (v7)
      {
        ...
        if (v9)
        {
          ...
          if ([v4 containsValueForKey:@"isCancelable"]) {
            unsigned __int8 v53 = [v4 decodeBoolForKey:@"isCancelable"];
          }
          else {
            unsigned __int8 v53 = 1;
          }
          v52 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"checkRestrictionsForContentRating"];
          unsigned __int8 v43 = [v4 decodeBoolForKey:@"shouldCheckForAvailableDiskSpace"];
          v44 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"remoteControllerRequirement"];
          unsigned __int8 v45 = [v4 decodeBoolForKey:@"shouldIncludeActiveAccountInFooterMessage"];
          unsigned __int8 v46 = [v4 decodeBoolForKey:@"shouldPromptForConfirmation"];
          v47 = sub_10001CDBC(v4, @"completionOffer");
          BYTE1(v51) = v46;
          LOBYTE(v51) = v45;
          LOBYTE(v50) = v43;
          LOBYTE(v49) = v53;
        ...
        else
        {
          ...
          if (v35) {
            sub_10013EB60(v35, v36, v37, v38, v39, v40, v41, v42);
          }
          v18 = 0;
        }
      }
      else
      {
        ...
        if (v27) {
          sub_10013EB24(v27, v28, v29, v30, v31, v32, v33, v34);
        }
        v18 = 0;
      }
    }
    else
    {
      ...
      if (v19) {
        sub_10013EAE8(v19, v20, v21, v22, v23, v24, v25, v26);
      }
      v18 = 0;
    }
  }
  else
  {
    ...
    if (v10) {
      sub_10013EAAC(v10, v11, v12, v13, v14, v15, v16, v17);
    }
    v18 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v8 = [(ASCOfferAlertOffer *)self ageRating];
...
- (ASCOfferAlertOffer)offerWithMetrics:(id)a3
{
  ...
  unsigned __int8 v6 = [(ASCOfferAlertOffer *)self isCancelable];
  v7 = [(ASCOfferAlertOffer *)self checkRestrictionsForContentRating];
  unsigned __int8 v8 = [(ASCOfferAlertOffer *)self shouldCheckForAvailableDiskSpace];
  v9 = [(ASCOfferAlertOffer *)self remoteControllerRequirement];
  unsigned __int8 v10 = [(ASCOfferAlertOffer *)self shouldIncludeActiveAccountInFooterMessage];
  unsigned __int8 v11 = [(ASCOfferAlertOffer *)self shouldPromptForConfirmation];
  uint64_t v12 = [(ASCOfferAlertOffer *)self completionOffer];
  BYTE1(v16) = v11;
  LOBYTE(v16) = v10;
  LOBYTE(v15) = v8;
  LOBYTE(v14) = v6;
  id v24 = objc_msgSend(v23, "initWithID:titles:subtitles:flags:ageRating:metrics:alertTitle:alertMessage:alertFooterMessage:isCancelable:checkRestrictionsForContentRating:shouldCheckForAvailableDiskSpace:remoteControllerRequirement:shouldIncludeActiveAccountInFooterMessage:shouldPromptForConfirmation:completionOffer:", v22, v21, v20, v19, v18, v25, v17, v4, v5, v14, v7, v15, v9, v16, v12);
...
- (unint64_t)hash
{
  ...
  unsigned __int8 v6 = [(ASCOfferAlertOffer *)self subtitles];
  ...
  unsigned __int8 v8 = [(ASCOfferAlertOffer *)self metrics];
  [(ASCHasher *)v3 combineObject:v8];

  v9 = [(ASCOfferAlertOffer *)self alertTitle];
  [(ASCHasher *)v3 combineObject:v9];

  unsigned __int8 v10 = [(ASCOfferAlertOffer *)self alertMessage];
  [(ASCHasher *)v3 combineObject:v10];

  unsigned __int8 v11 = [(ASCOfferAlertOffer *)self alertFooterMessage];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    unsigned __int8 v8 = [(ASCOfferAlertOffer *)self id];
    uint64_t v9 = [v7 id];
    ...
    if (v8 && v9)
    {
      ...
      {
LABEL_10:
        unsigned __int8 v11 = [(ASCOfferAlertOffer *)self titles];
...
LABEL_13:
            ...
            id v18 = [(ASCOfferAlertOffer *)self flags];
            if (v18 == [v7 flags])
            {
...
LABEL_30:
                      ...
                      {
                        BOOL v35 = (void *)v33;
                        unsigned int v36 = [v68 isEqual:v33];
                        uint64_t v34 = v35;
                        if (v36)
                        {
LABEL_33:
                          ...
                          if (v37 && v38)
                          {
                            ...
                            unsigned int v41 = [v66 isEqual:v38];
                            uint64_t v39 = v40;
                            if (v41)
                            {
LABEL_36:
...
LABEL_69:
                              ...
                              unsigned int v44 = [(ASCOfferAlertOffer *)self isCancelable];
...
LABEL_68:
                              ...
                              unsigned int v72 = [(ASCOfferAlertOffer *)self shouldCheckForAvailableDiskSpace];
                              ...
                              {
                                unsigned __int8 v53 = (void *)v49;
                                if (v51 != (void *)v49) {
                                  goto LABEL_66;
                                }
                              }
                              unsigned int v57 = [(ASCOfferAlertOffer *)self shouldIncludeActiveAccountInFooterMessage];
                              if (v57 == [v7 shouldIncludeActiveAccountInFooterMessage])
                              {
                                unsigned int v58 = [(ASCOfferAlertOffer *)self shouldPromptForConfirmation];
                                if (v58 == [v7 shouldPromptForConfirmation])
                                {
                                  ...
                                  v59 = id v56 = v55;
                                  if (v55 && v59) {
                                    unsigned __int8 v17 = [v55 isEqual:v59];
                                  }
                                  else {
                                    unsigned __int8 v17 = v55 == v59;
                                  }
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription((__int16)[(ASCOfferAlertOffer *)self flags]);
  [(ASCDescriber *)v3 addObject:v7 withName:@"flags"];

  unsigned __int8 v8 = [(ASCOfferAlertOffer *)self ageRating];
  ...
  unsigned __int8 v10 = [(ASCOfferAlertOffer *)self alertTitle];
  [(ASCDescriber *)v3 addObject:v10 withName:@"alertTitle"];

  unsigned __int8 v11 = [(ASCOfferAlertOffer *)self alertMessage];
