...
- (ASCAlertOffer)initWithID:(id)a3 titles:(id)a4 subtitles:(id)a5 flags:(int64_t)a6 ageRating:(id)a7 metrics:(id)a8 alertTitle:(id)a9 alertMessage:(id)a10 alertButtonOffer:(id)a11 alertButtonTitle:(id)a12
{
  ...
  if (v25)
  {
    uint64_t v26 = objc_msgSend(v44, "copy", v43);
    id = v25->_id;
    ...
    uint64_t v38 = [v23 copyWithZone:0];
...
- (ASCAlertOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      else
      {
        ...
        if (v30) {
          -[ASCAlertOffer initWithCoder:](v30, v31, v32, v33, v34, v35, v36, v37);
        }
        v13 = 0;
      }
    }
    else
    {
      ...
      if (v22) {
        -[ASCAlertOffer initWithCoder:](v22, v23, v24, v25, v26, v27, v28, v29);
      }
      v13 = 0;
    }
  }
  else
  {
    ...
    if (v14) {
      -[ASCAlertOffer initWithCoder:](v14, v15, v16, v17, v18, v19, v20, v21);
    }
    v13 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(ASCAlertOffer *)self ageRating];
...
- (ASCAlertOffer)offerWithMetrics:(id)a3
{
  ...
  id v13 = (void *)[v16 initWithID:v15 titles:v5 subtitles:v6 flags:v7 ageRating:v8 metrics:v4 alertTitle:v9 alertMessage:v10 alertButtonOffer:v11 alertButtonTitle:v12];
...
- (unint64_t)hash
{
  ...
  uint64_t v8 = [(ASCAlertOffer *)self metrics];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(ASCAlertOffer *)self id];
    uint64_t v9 = [v7 id];
    v10 = (void *)v9;
    if (v8 && v9)
    {
...
LABEL_13:
            ...
            int64_t v18 = [(ASCAlertOffer *)self flags];
            if (v18 == [v7 flags])
            {
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription([(ASCAlertOffer *)self flags]);
