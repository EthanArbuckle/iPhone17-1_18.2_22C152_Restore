...
- (ASCAppOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
        ...
        if (v10)
        {
          ...
          if (v11)
          {
            ...
            if (v102)
            {
              ...
              uint64_t v97 = objc_msgSend(v12, "initWithObjects:", v13, objc_opt_class(), 0);
              ...
              if (v99)
              {
                ...
                if (v96)
                {
                  ...
                  if (v14)
                  {
                    ...
                    v94 = objc_msgSend(v93, "initWithObjects:", v15, objc_opt_class(), 0);
                  ...
                  {
                    BOOL v84 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
                    if (v84) {
                ...
                {
                  BOOL v76 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
                  if (v76) {
              ...
              {
                BOOL v68 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
                if (v68) {
      ...
      else
      {
        ...
        if (v36) {
          -[ASCAppOffer initWithCoder:](v36, v37, v38, v39, v40, v41, v42, v43);
        }
        v18 = 0;
      }
    }
    else
    {
      ...
      if (v28) {
        -[ASCAppOffer initWithCoder:](v28, v29, v30, v31, v32, v33, v34, v35);
      }
      v18 = 0;
    }
  }
  else
  {
    ...
    if (v20) {
      -[ASCAppOffer initWithCoder:](v20, v21, v22, v23, v24, v25, v26, v27);
    }
    v18 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(ASCAppOffer *)self ageRating];
...
- (ASCAppOffer)offerWithMetrics:(id)a3
{
  ...
  uint64_t v8 = [(ASCAppOffer *)self preflightPackageURL];
  ...
  id v17 = (id)[v16 initWithID:v20 titles:v19 subtitles:v4 flags:v15 ageRating:v5 metrics:v18 baseBuyParams:v14 metricsBuyParams:v6 additionalHeaders:v7 preflightPackageURL:v8 bundleID:v9 itemName:v10 vendorName:v11 capabilities:v12];
...
- (unint64_t)hash
{
  ...
  uint64_t v8 = [(ASCAppOffer *)self metrics];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(ASCAppOffer *)self id];
    uint64_t v9 = [v7 id];
    v10 = (void *)v9;
    if (v8 && v9)
    {
...
LABEL_13:
            ...
            int64_t v18 = [(ASCAppOffer *)self flags];
            if (v18 == [v7 flags])
            {
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription([(ASCAppOffer *)self flags]);
  ...
  char v17 = [(ASCAppOffer *)self capabilities];
  [(ASCDescriber *)v3 addObject:v17 withName:@"capabilities"];

  int64_t v18 = [(ASCDescriber *)v3 finalizeDescription];
