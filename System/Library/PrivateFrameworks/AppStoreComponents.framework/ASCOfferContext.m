...
- (ASCOfferContext)initWithFlags:(int64_t)a3 presentingSceneIdentifier:(id)a4 presentingSceneBundleIdentifier:(id)a5 externalDeepLinkURL:(id)a6 paymentViewServiceListener:(id)a7
{
  ...
  if (v16)
  {
    ...
    v17->_presentingSceneIdentifier = (NSString *)v18;

    uint64_t v20 = [v13 copy];
    presentingSceneBundleIdentifier = v17->_presentingSceneBundleIdentifier;
    v17->_presentingSceneBundleIdentifier = (NSString *)v20;

    uint64_t v22 = [v14 copy];
    externalDeepLinkURL = v17->_externalDeepLinkURL;
    v17->_externalDeepLinkURL = (NSURL *)v22;
...
{
  id v4 = a3;
  uint64_t v5 = [v4 decodeIntegerForKey:@"flags"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v5 = [(ASCOfferContext *)self presentingSceneIdentifier];
...
- (id)offerContextByAddingFlags:(int64_t)a3
{
  int64_t v4 = [(ASCOfferContext *)self flags] | a3;
  ...
  v10 = (void *)[v5 initWithFlags:v4 presentingSceneIdentifier:v6 presentingSceneBundleIdentifier:v7 externalDeepLinkURL:v8 paymentViewServiceListener:v9];
...
- (ASCOfferContext)offerContextWithPresentingSceneIdentifier:(id)a3 presentingSceneBundleIdentifier:(id)a4 externalDeepLinkURL:(id)a5
{
  ...
  id v14 = (void *)[v11 initWithFlags:v12 presentingSceneIdentifier:v10 presentingSceneBundleIdentifier:v9 externalDeepLinkURL:v8 paymentViewServiceListener:v13];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    int v8 = [(ASCOfferContext *)self supportsDSIDLessInstall];
    if (v8 == [v7 supportsDSIDLessInstall])
    {
      int v9 = [(ASCOfferContext *)self shouldInstallParentApp];
...
LABEL_14:
            ...
            if (v15 && v16)
            {
              ...
              {
LABEL_17:
                uint64_t v18 = [(ASCOfferContext *)self externalDeepLinkURL];
                ...
                int v21 = [(ASCOfferContext *)self universalLinkRequired];
                if (v21 == [v7 universalLinkRequired])
                {
                  uint64_t v22 = [(ASCOfferContext *)self paymentViewServiceListener];
                  uint64_t v23 = [v7 paymentViewServiceListener];
                  v24 = (void *)v23;
                  objc_super v25 = v22;
                  if (v22 && v23) {
                    char v10 = [v22 isEqual:v23];
                  }
                  else {
                    char v10 = v22 == (void *)v23;
                  }
...
- (id)description
{
  ...
  int v8 = [(ASCDescriber *)v3 finalizeDescription];
