...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    ...
    {
LABEL_10:
      uint64_t v11 = [(ASCTrailers *)self mediaPlatform];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1C2B8D000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not decode ASCTrailers because videos was missing", v0, 2u);
}

- (void)initWithCoder:.cold.2()
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1C2B8D000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not decode ASCTrailers because mediaPlatform was missing", v0, 2u);
}
