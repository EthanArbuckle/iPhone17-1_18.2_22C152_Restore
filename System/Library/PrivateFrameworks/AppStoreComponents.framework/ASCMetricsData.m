...
- (ASCMetricsData)initWithCoder:(id)a3
{
  ...
  uint64_t v6 = [v4 decodeBoolForKey:@"shouldFlush"];
  ...
  if (v7)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (v30) {
          -[ASCMetricsData initWithCoder:](v30, v31, v32, v33, v34, v35, v36, v37);
        }
        id v13 = 0;
      }
    }
    else
    {
      ...
      if (v22) {
        -[ASCMetricsData initWithCoder:](v22, v23, v24, v25, v26, v27, v28, v29);
      }
      id v13 = 0;
    }
  }
  else
  {
    ...
    if (v14) {
      -[ASCMetricsData initWithCoder:](v14, v15, v16, v17, v18, v19, v20, v21);
    }
    id v13 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v6 = [(ASCMetricsData *)self fields];
...
- (unint64_t)hash
{
  ...
  uint64_t v6 = [(ASCMetricsData *)self includingFields];
...
LABEL_32:
    ...
    int v12 = [(ASCMetricsData *)self shouldFlush];
...
LABEL_21:
          ...
          uint64_t v23 = v19;
          if (v19 && v20) {
            char v11 = [v19 isEqual:v20];
          }
          else {
            char v11 = v19 == (void *)v20;
          }
...
- (id)metricsDataByMergingFields:(id)a3 uniquingFieldsWithBlock:(id)a4
{
  ...
  char v11 = [(ASCMetricsData *)self topic];
