  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        if (v12)
        {
          v13 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", objc_msgSend(v11, "primaryTag"));
          [v4 addObject:v13];
        ...
        {
          [(ASCSignpostPredicate *)buf initWithSpans:&v23];
        }
      }
...
- (ASCSignpostPredicate)init
{
  ...
  id v4 = [(ASCSignpostPredicate *)self initWithTags:v3 dateRanges:MEMORY[0x1E4F1CBF0]];
...
- (ASCSignpostPredicate)initWithCoder:(id)a3
{
  ...
  uint64_t v8 = [v4 decodeObjectOfClasses:v7 forKey:@"tags"];
  if (v8)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(ASCSignpostPredicate *)self tags];
    uint64_t v9 = [v7 tags];
    ...
    {
LABEL_10:
      uint64_t v11 = [(ASCSignpostPredicate *)self dateRanges];
...
- (id)predicateByAddingTag:(unint64_t)a3
{
  ...
  uint64_t v10 = (void *)[v8 initWithTags:v7 dateRanges:v9];
...
- (id)predicateByAddingDateRange:(id)a3
{
  ...
  uint64_t v9 = (void *)[v7 initWithTags:v8 dateRanges:v6];
...
- (void)initWithSpans:(void *)a3 .cold.1(uint8_t *buf, uint64_t a2, void *a3)
{
  ...
  *a3 = a2;
  _os_log_error_impl(&dword_1C2B8D000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Discarding span without valid range range %@", buf, 0xCu);
}

- (void)initWithCoder:.cold.1()
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1C2B8D000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not decode ASCSignpostPredicate because tags was missing", v0, 2u);
}

- (void)initWithCoder:.cold.2()
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_1C2B8D000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Could not decode ASCSignpostPredicate because dateRanges was missing", v0, 2u);
}
