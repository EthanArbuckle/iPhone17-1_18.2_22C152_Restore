...
- (ASCStatefulOffer)initWithID:(id)a3 titles:(id)a4 subtitles:(id)a5 flags:(int64_t)a6 ageRating:(id)a7 metrics:(id)a8 defaultOffer:(id)a9 buyOffer:(id)a10 openOffer:(id)a11
{
  ...
  if (v23)
  {
    uint64_t v24 = objc_msgSend(v17, "copy", v37, v38);
    id = v23->_id;
    ...
    uint64_t v30 = [v20 copyWithZone:0];
...
- (ASCStatefulOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (v7)
      {
        ...
        if (v10)
        {
          ...
          if (v11)
          {
            ...
            uint64_t v13 = ASCOfferDecodeForKey(v4, @"openOffer");
            uint64_t v14 = v8;
            v15 = v9;
            v16 = (void *)v13;
      ...
      else
      {
        ...
        if (v34) {
          -[ASCStatefulOffer initWithCoder:](v34, v35, v36, v37, v38, v39, v40, v41);
        }
        id v17 = 0;
      }
    }
    else
    {
      ...
      if (v26) {
        -[ASCStatefulOffer initWithCoder:](v26, v27, v28, v29, v30, v31, v32, v33);
      }
      id v17 = 0;
    }
  }
  else
  {
    ...
    if (v18) {
      -[ASCStatefulOffer initWithCoder:](v18, v19, v20, v21, v22, v23, v24, v25);
    }
    id v17 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(ASCStatefulOffer *)self ageRating];
...
- (ASCStatefulOffer)offerWithMetrics:(id)a3
{
  ...
  uint64_t v8 = [(ASCStatefulOffer *)self subtitles];
  ...
  uint64_t v14 = (void *)[v5 initWithID:v6 titles:v7 subtitles:v8 flags:v9 ageRating:v10 metrics:v4 defaultOffer:v11 buyOffer:v12 openOffer:v13];
...
- (unint64_t)hash
{
  ...
  uint64_t v8 = [(ASCStatefulOffer *)self metrics];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(ASCStatefulOffer *)self id];
    uint64_t v9 = [v7 id];
    v10 = (void *)v9;
    if (v8 && v9)
    {
...
LABEL_10:
        ...
        if (v11 && v12)
        {
          ...
          {
LABEL_13:
            uint64_t v14 = [(ASCStatefulOffer *)self subtitles];
            ...
            int64_t v18 = [(ASCStatefulOffer *)self flags];
            if (v18 == [v7 flags])
            {
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription([(ASCStatefulOffer *)self flags]);
