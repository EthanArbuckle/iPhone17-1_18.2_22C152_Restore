...
- (ASCContingentOffer)initWithID:(id)a3 titles:(id)a4 subtitles:(id)a5 flags:(int64_t)a6 ageRating:(id)a7 metrics:(id)a8 organicOffer:(id)a9 streamlinedOffer:(id)a10 offerID:(id)a11 iapItemID:(id)a12 iapItemName:(id)a13 iapProductName:(id)a14 offerType:(int64_t)a15
{
  ...
  if (v29)
  {
    ...
    uint64_t v38 = [v22 copyWithZone:0];
    organicOffer = v29->_organicOffer;
    v29->_organicOffer = (ASCOffer *)v38;

    uint64_t v40 = [v23 copyWithZone:0];
...
- (ASCContingentOffer)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (v7)
      {
        ...
        if (v10)
        {
          uint64_t v11 = ASCOfferDecodeForKey(v4, @"organicOffer");
          v12 = (void *)v11;
          if (v11)
          {
            v99 = (void *)v11;
            v97 = v9;
            v98 = ASCOfferDecodeForKey(v4, @"streamlinedOffer");
            ...
            if (v13)
            {
              ...
              if (v14)
              {
                ...
                if (v96)
                {
                  ...
                  {
                    uint64_t v94 = v15;
                    uint64_t v95 = [v4 decodeIntegerForKey:@"offerType"];
                    v16 = self;
                    v17 = (void *)v15;
                    v9 = v97;
                  ...
                  {
                    BOOL v85 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
                    v9 = v97;
                    if (v85) {
                ...
                {
                  BOOL v77 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
                  if (v77) {
              ...
              {
                BOOL v69 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
                if (v69) {
            ...
            {
              BOOL v61 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR);
              if (v61) {
      ...
      else
      {
        ...
        if (v37) {
          -[ASCContingentOffer initWithCoder:](v37, v38, v39, v40, v41, v42, v43, v44);
        }
        id v20 = 0;
      }
    }
    else
    {
      ...
      if (v29) {
        -[ASCContingentOffer initWithCoder:](v29, v30, v31, v32, v33, v34, v35, v36);
      }
      id v20 = 0;
    }
  }
  else
  {
    ...
    if (v21) {
      -[ASCContingentOffer initWithCoder:](v21, v22, v23, v24, v25, v26, v27, v28);
    }
    id v20 = 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v8 = [(ASCContingentOffer *)self metrics];
...
- (ASCContingentOffer)offerWithMetrics:(id)a3
{
  ...
  uint64_t v8 = [(ASCContingentOffer *)self offerID];
  ...
  id v15 = (id)objc_msgSend(v4, "initWithID:titles:subtitles:flags:ageRating:metrics:organicOffer:streamlinedOffer:offerID:iapItemID:iapItemName:iapProductName:offerType:", v5, v17, v16, v14, v6, v18, v13, v7, v8, v9, v10, v11, -[ASCContingentOffer offerType](self, "offerType"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(ASCContingentOffer *)self id];
    uint64_t v9 = [v7 id];
    v10 = (void *)v9;
    if (v8 && v9)
    {
...
LABEL_13:
            ...
            int64_t v18 = [(ASCContingentOffer *)self flags];
            if (v18 == [v7 flags])
            {
...
LABEL_45:
                                          ...
                                          if (v48 && v49)
                                          {
                                            ...
                                            {
LABEL_48:
                                              int64_t v51 = [(ASCContingentOffer *)self offerType];
...
- (NSString)description
{
  ...
  id v7 = ASCOfferFlagsGetDescription([(ASCContingentOffer *)self flags]);
  [(ASCDescriber *)v3 addObject:v7 withName:@"flags"];

  uint64_t v8 = [(ASCContingentOffer *)self ageRating];
