...
{
  v22.receiver = self;
  v22.super_class = (Class)SFImagesCardSection;
  ...
  unint64_t v20 = v19 ^ [(SFImagesCardSection *)self borderless];
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFImagesCardSection *)a3;
  if (self == v5)
  {
    LOBYTE(v11) = 1;
  }
  else
  {
    ...
    {
      v71.receiver = self;
      v71.super_class = (Class)SFImagesCardSection;
...
LABEL_28:
            ...
            if ((v28 == 0) != (v29 != 0))
            {
              ...
              if ((v51 == 0) != (v32 != 0))
              {
                ...
                if (!v41
                  || ([(SFImagesCardSection *)self images],
                      v42 = objc_claimAutoreleasedReturnValue(),
                      [(SFImagesCardSection *)v6 images],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      v45 = v42,
                      objc_msgSend(v42, "isEqual:")))
                {
                  BOOL v43 = [(SFImagesCardSection *)self borderless];
                  BOOL v11 = v43 ^ [(SFImagesCardSection *)v6 borderless] ^ 1;
                  if (!v41) {
                    goto LABEL_68;
                  }
                }
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFImagesCardSection;
  ...
  BOOL v11 = [(SFImagesCardSection *)self type];
  ...
  uint64_t v15 = [(SFImagesCardSection *)self images];
  v16 = (void *)[v15 copy];
  [v4 setImages:v16];

  objc_msgSend(v4, "setBorderless:", -[SFImagesCardSection borderless](self, "borderless"));
  return v4;
}
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBImagesCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBImagesCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBImagesCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFImagesCardSection;
...
- (SFImagesCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v14 = [(SFCardSection *)v8 images];
...
- (SFImagesCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v42.receiver = self;
  v42.super_class = (Class)SFImagesCardSection;
  ...
  if (v5)
  {
    ...
    unint64_t v20 = [v4 backgroundColor];
    ...
    long long v34 = 0u;
    long long v35 = 0u;
    BOOL v26 = objc_msgSend(v4, "images", 0);
    ...
    if (v27)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v28; ++j)
        {
          ...
          int v31 = [[SFImage alloc] initWithProtobuf:*(void *)(*((void *)&v34 + 1) + 8 * j)];
          if (v31) {
            [v25 addObject:v31];
          }
        }
