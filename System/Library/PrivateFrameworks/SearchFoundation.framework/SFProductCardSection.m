@interface SFProductCardSection
...
- (NSString)type;
- (SFProductCardSection)initWithCoder:(id)a3;
- (SFProductCardSection)initWithProtobuf:(id)a3;
...
@implementation SFProductCardSection
...
- (SFProductCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v32.receiver = self;
  v32.super_class = (Class)SFProductCardSection;
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[SFPunchout alloc] initWithProtobuf:*(void *)(*((void *)&v28 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
    ...
    {
      v19 = [v4 type];
      [(SFProductCardSection *)v5 setType:v19];
    }
    ...
    {
      v25 = [v4 productJSON];
      [(SFProductCardSection *)v5 setProductJSON:v25];
    }
    v26 = v5;
  }
  return v5;
...
{
  v21.receiver = self;
  v21.super_class = (Class)SFProductCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFProductCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFProductCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = (Class)SFProductCardSection;
...
LABEL_47:
            ...
            long long v28 = [(SFProductCardSection *)self type];
            long long v29 = [(SFProductCardSection *)v6 type];
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              uint64_t v51 = [(SFProductCardSection *)self type];
              v52 = v28;
              if (v51)
              {
                long long v30 = [(SFProductCardSection *)self type];
                v49 = [(SFProductCardSection *)v6 type];
                v50 = v30;
                if (!objc_msgSend(v30, "isEqual:"))
                {
                  char v11 = 0;
                  long long v31 = (void *)v51;
                  v22 = v56;
                  goto LABEL_66;
                }
              }
              ...
              {
                uint64_t v34 = [(SFCardSection *)self backgroundColor];
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                  ...
                  {
                    v38 = [(SFProductCardSection *)self productJSON];
                    v39 = [(SFProductCardSection *)v6 productJSON];
                    v40 = v39;
                    if ((v38 == 0) == (v39 != 0))
                    {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFProductCardSection *)self productJSON];
                      if (v41)
                      {
                        v42 = (void *)v41;
                        v43 = [(SFProductCardSection *)self productJSON];
                        v44 = [(SFProductCardSection *)v6 productJSON];
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFProductCardSection;
  ...
  char v11 = [(SFProductCardSection *)self type];
  ...
  uint64_t v15 = [(SFProductCardSection *)self productJSON];
  v16 = (void *)[v15 copy];
  [v4 setProductJSON:v16];
...
- (NSData)jsonData
{
  v2 = [[_SFPBProductCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBProductCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBProductCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBProductCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFProductCardSection;
...
- (SFProductCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFProductCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 productJSON];
    [(SFProductCardSection *)v5 setProductJSON:v14];
    ...
    long long v28 = [(SFCardSection *)v8 trailingSwipeButtonItems];
    [(SFCardSection *)v5 setTrailingSwipeButtonItems:v28];

    long long v29 = [(SFCardSection *)v8 punchoutOptions];
    ...
    long long v31 = [(SFCardSection *)v8 punchoutPickerDismissText];
    ...
    uint64_t v34 = [(SFCardSection *)v8 emphasisSubjectId];
