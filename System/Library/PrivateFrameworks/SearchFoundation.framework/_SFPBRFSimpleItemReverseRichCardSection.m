...
- (_SFPBRFSimpleItemReverseRichCardSection)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v30.receiver = self;
  v30.super_class = (Class)_SFPBRFSimpleItemReverseRichCardSection;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_text_1)
  {
    id v4 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  ...
  if (self->_text_2)
  {
    uint64_t v7 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  ...
  if (self->_text_4)
  {
    uint64_t v18 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  ...
  uint64_t v12 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  if (v12)
  {
    uint64_t v13 = (void *)v12;
    uint64_t v14 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  ...
  uint64_t v5 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text_3s];
  unint64_t v6 = objc_msgSend(v4, "text_3s");
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_26;
  }
  uint64_t v17 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text_3s];
  if (v17)
  {
    uint64_t v18 = (void *)v17;
    uint64_t v19 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text_3s];
  ...
  uint64_t v22 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  if (v22)
  {
    v23 = (void *)v22;
  ...
  uint64_t v5 = [(_SFPBRFSimpleItemReverseRichCardSection *)self thumbnail];
  unint64_t v6 = [v4 thumbnail];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v27 = [(_SFPBRFSimpleItemReverseRichCardSection *)self thumbnail];
    if (!v27)
    {
...
LABEL_30:
    ...
    long long v29 = [(_SFPBRFSimpleItemReverseRichCardSection *)self thumbnail];
    uint64_t v30 = [v4 thumbnail];
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v6 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text];
  if (v6) {
    PBDataWriterWriteSubmessage();
  }

  uint64_t v7 = [(_SFPBRFSimpleItemReverseRichCardSection *)self text_3s];
  long long v14 = 0u;
  long long v15 = 0u;
  long long v16 = 0u;
  long long v17 = 0u;
  ...
  uint64_t v13 = [(_SFPBRFSimpleItemReverseRichCardSection *)self thumbnail];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFSimpleItemReverseRichCardSectionReadFrom(self, (uint64_t)a3);
}
