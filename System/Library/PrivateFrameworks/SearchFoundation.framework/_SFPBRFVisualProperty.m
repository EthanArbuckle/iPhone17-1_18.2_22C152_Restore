...
- (_SFPBRFVisualProperty)initWithFacade:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[_SFPBRFVisualElement alloc] initWithFacade:*(void *)(*((void *)&v16 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
    ...
    if (objc_msgSend(v4, "hasIs_safe_for_logging")) {
      -[_SFPBRFVisualProperty setIs_safe_for_logging:](v5, "setIs_safe_for_logging:", objc_msgSend(v4, "is_safe_for_logging"));
    }
    v14 = v5;
  }
  return v5;
...
- (_SFPBRFVisualProperty)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v22.receiver = self;
  v22.super_class = (Class)_SFPBRFVisualProperty;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[_SFPBRFVisualElement initWithDictionary:](v13, "initWithDictionary:", v12, (void)v18);
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBRFVisualProperty is_safe_for_logging](self, "is_safe_for_logging"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBRFVisualProperty *)self visual_elements];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(_SFPBRFVisualProperty *)self visual_elements];
      uint64_t v11 = objc_msgSend(v4, "visual_elements");
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFVisualPropertyReadFrom(self, (uint64_t)a3);
}
