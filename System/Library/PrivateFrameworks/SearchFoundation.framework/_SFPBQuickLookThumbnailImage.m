...
- (_SFPBQuickLookThumbnailImage)initWithDictionary:(id)a3
{
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)_SFPBQuickLookThumbnailImage;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBQuickLookThumbnailImage *)self coreSpotlightIdentifier];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  unint64_t v3 = [(_SFPBURL *)self->_filePath hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_SFPBQuickLookThumbnailImage *)self filePath];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v12 = [(_SFPBQuickLookThumbnailImage *)self coreSpotlightIdentifier];
  if (v12)
  {
    v13 = (void *)v12;
    objc_super v14 = [(_SFPBQuickLookThumbnailImage *)self coreSpotlightIdentifier];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(_SFPBQuickLookThumbnailImage *)self fileProviderIdentifier];
    if (!v17)
    {
...
{
  id v7 = a3;
  id v4 = [(_SFPBQuickLookThumbnailImage *)self filePath];
  if (v4) {
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBQuickLookThumbnailImageReadFrom(self, (uint64_t)a3);
}
