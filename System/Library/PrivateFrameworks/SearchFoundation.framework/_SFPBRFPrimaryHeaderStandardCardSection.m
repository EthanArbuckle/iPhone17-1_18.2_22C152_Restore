...
- (_SFPBRFPrimaryHeaderStandardCardSection)initWithFacade:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ([v4 hasAddTint]) {
      -[_SFPBRFPrimaryHeaderStandardCardSection setAddTint:](v5, "setAddTint:", [v4 addTint]);
    }
    v18 = v5;
  }
...
- (NSData)jsonData
{
  v2 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_addTint)
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBRFPrimaryHeaderStandardCardSection addTint](self, "addTint"));
    [v3 setObject:v4 forKeyedSubscript:@"addTint"];
  }
  if (self->_text_1)
  {
    v5 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  ...
  if (self->_text_2)
  {
    v8 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  ...
  if (self->_text_3)
  {
    v11 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  uint64_t v6 = [v4 text];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v7 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v7)
  {
    v8 = (void *)v7;
    v9 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
    v10 = [v4 text];
  ...
  uint64_t v12 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v12)
  {
    v13 = (void *)v12;
    v14 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
    if (!v17)
    {
...
LABEL_20:
    ...
    v18 = (void *)v17;
    v19 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
    v20 = [v4 text];
...
{
  id v7 = a3;
  id v4 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v4) {
  ...
  uint64_t v6 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v6) {
    PBDataWriterWriteSubmessage();
  }
