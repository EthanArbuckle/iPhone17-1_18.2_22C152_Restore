...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBRequestUserReportCommand *)self userReportRequest];
...
- (unint64_t)hash
{
  return [(_SFPBUserReportRequest *)self->_userReportRequest hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBRequestUserReportCommand *)self userReportRequest];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBRequestUserReportCommand *)self userReportRequest];
