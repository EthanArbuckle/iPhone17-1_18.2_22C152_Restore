...
- (_SFPBTimeZone)initWithNSTimeZone:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)_SFPBTimeZone;
...
- (_SFPBTimeZone)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBTimeZone;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_identifier)
  {
    id v4 = [(_SFPBTimeZone *)self identifier];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBTimeZone *)self identifier];
      if (!v8)
      {
...
LABEL_10:
      ...
      objc_super v10 = [(_SFPBTimeZone *)self identifier];
      v11 = [v4 identifier];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBTimeZoneReadFrom(self, (uint64_t)a3);
}
