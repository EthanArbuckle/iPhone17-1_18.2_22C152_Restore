...
- (unint64_t)hash
{
  ...
  v22 = [(SFAppLinkCardSection *)self appLinks];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ([(SFAppLinkCardSection *)v4 isMemberOfClass:objc_opt_class()])
    {
      v67.receiver = self;
...
LABEL_24:
                    ...
                    {
                      v37 = [(SFAppLinkCardSection *)self appLinks];
                      v36 = [(SFAppLinkCardSection *)v5 appLinks];
                      if ((v37 == 0) == (v36 != 0))
                      {
                      ...
                      {
                        v35 = [(SFAppLinkCardSection *)self appLinks];
                        if (v35)
                        {
                          v34 = [(SFAppLinkCardSection *)self appLinks];
                          v33 = [(SFAppLinkCardSection *)v5 appLinks];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v19 = [(SFAppLinkCardSection *)self appLinks];
  v20 = (void *)[v19 copy];
  [v4 setAppLinks:v20];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBAppLinkCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBAppLinkCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBAppLinkCardSection *)v2 dictionaryRepresentation];
...
- (SFAppLinkCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v16 = [(SFCardSection *)v8 appLinks];
    [(SFAppLinkCardSection *)v5 setAppLinks:v16];
    ...
    if (v31)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v32; ++j)
        {
          ...
          v35 = [[SFAppLink alloc] initWithProtobuf:*(void *)(*((void *)&v38 + 1) + 8 * j)];
          if (v35) {
            [v29 addObject:v35];
          }
        }
