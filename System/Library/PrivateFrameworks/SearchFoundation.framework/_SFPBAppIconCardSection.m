...
- (_SFPBAppIconCardSection)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v40.receiver = self;
  v40.super_class = (Class)_SFPBAppIconCardSection;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBAppIconCardSection *)self applicationBundleIdentifier];
    v5 = (void *)[v4 copy];
  ...
  {
    uint64_t v9 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBAppIconCardSection canBeHidden](self, "canBeHidden"));
    [v3 setObject:v9 forKeyedSubscript:@"canBeHidden"];
  }
  if (self->_hasBottomPadding)
  {
    uint64_t v10 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBAppIconCardSection hasBottomPadding](self, "hasBottomPadding"));
    [v3 setObject:v10 forKeyedSubscript:@"hasBottomPadding"];
  }
  if (self->_hasTopPadding)
  {
    uint64_t v11 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBAppIconCardSection hasTopPadding](self, "hasTopPadding"));
  ...
  if ([(NSArray *)self->_punchoutOptions count])
  {
    ...
    uint64_t v14 = [(NSArray *)v13 countByEnumeratingWithState:&v31 objects:v35 count:16];
    if (v14)
    {
      uint64_t v15 = v14;
      ...
      do
      {
        ...
        uint64_t v15 = [(NSArray *)v13 countByEnumeratingWithState:&v31 objects:v35 count:16];
      }
      while (v15);
    }
  ...
  {
    uint64_t v24 = [(_SFPBAppIconCardSection *)self separatorStyle];
    if (v24 >= 6)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self punchoutOptions];
  uint64_t v6 = [v4 punchoutOptions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v7 = [(_SFPBAppIconCardSection *)self punchoutOptions];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    NSUInteger v9 = [(_SFPBAppIconCardSection *)self punchoutOptions];
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self punchoutPickerTitle];
  uint64_t v6 = [v4 punchoutPickerTitle];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v12 = [(_SFPBAppIconCardSection *)self punchoutPickerTitle];
  if (v12)
  {
    v13 = (void *)v12;
    uint64_t v14 = [(_SFPBAppIconCardSection *)self punchoutPickerTitle];
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self punchoutPickerDismissText];
  uint64_t v6 = [v4 punchoutPickerDismissText];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v17 = [(_SFPBAppIconCardSection *)self punchoutPickerDismissText];
  if (v17)
  {
    v18 = (void *)v17;
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self type];
  uint64_t v6 = [v4 type];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v25 = [(_SFPBAppIconCardSection *)self type];
  if (v25)
  {
    v26 = (void *)v25;
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self backgroundColor];
  uint64_t v6 = [v4 backgroundColor];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v31 = [(_SFPBAppIconCardSection *)self backgroundColor];
  if (v31)
  {
    long long v32 = (void *)v31;
    long long v33 = [(_SFPBAppIconCardSection *)self backgroundColor];
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self title];
  uint64_t v6 = [v4 title];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v36 = [(_SFPBAppIconCardSection *)self title];
  if (v36)
  {
    long long v37 = (void *)v36;
    long long v38 = [(_SFPBAppIconCardSection *)self title];
  ...
  NSUInteger v5 = [(_SFPBAppIconCardSection *)self applicationBundleIdentifier];
...
LABEL_40:
  ...
  uint64_t v41 = [(_SFPBAppIconCardSection *)self applicationBundleIdentifier];
  if (!v41)
  {
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v10 = [(_SFPBAppIconCardSection *)self punchoutPickerTitle];
  if (v10) {
    PBDataWriterWriteStringField();
  }

  int v11 = [(_SFPBAppIconCardSection *)self punchoutPickerDismissText];
  if (v11) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v12 = [(_SFPBAppIconCardSection *)self type];
  if (v12) {
    PBDataWriterWriteStringField();
  }
  ...
  v13 = [(_SFPBAppIconCardSection *)self backgroundColor];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }

  uint64_t v14 = [(_SFPBAppIconCardSection *)self title];
  if (v14) {
    PBDataWriterWriteStringField();
  }

  uint64_t v15 = [(_SFPBAppIconCardSection *)self applicationBundleIdentifier];
  if (v15) {
    PBDataWriterWriteStringField();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBAppIconCardSectionReadFrom(self, (uint64_t)a3);
}
