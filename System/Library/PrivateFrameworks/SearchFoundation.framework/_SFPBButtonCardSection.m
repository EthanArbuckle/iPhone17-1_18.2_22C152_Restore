...
- (_SFPBButtonCardSection)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v40.receiver = self;
  v40.super_class = (Class)_SFPBButtonCardSection;
  v5 = [(_SFPBButtonCardSection *)&v40 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBButtonCardSection *)self backgroundColor];
  ...
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBButtonCardSection canBeHidden](self, "canBeHidden"));
    [v3 setObject:v7 forKeyedSubscript:@"canBeHidden"];
  }
  if (self->_hasBottomPadding)
  {
    uint64_t v8 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBButtonCardSection hasBottomPadding](self, "hasBottomPadding"));
    [v3 setObject:v8 forKeyedSubscript:@"hasBottomPadding"];
  }
  if (self->_hasTopPadding)
  {
    uint64_t v9 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBButtonCardSection hasTopPadding](self, "hasTopPadding"));
  ...
  if ([(NSArray *)self->_punchoutOptions count])
  {
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        uint64_t v13 = [(NSArray *)v11 countByEnumeratingWithState:&v33 objects:v37 count:16];
      }
      while (v13);
    }
  ...
  {
    uint64_t v22 = [(_SFPBButtonCardSection *)self separatorStyle];
    if (v22 >= 6)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self punchoutOptions];
  uint64_t v6 = [v4 punchoutOptions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v7 = [(_SFPBButtonCardSection *)self punchoutOptions];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    NSUInteger v9 = [(_SFPBButtonCardSection *)self punchoutOptions];
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self punchoutPickerTitle];
  uint64_t v6 = [v4 punchoutPickerTitle];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v12 = [(_SFPBButtonCardSection *)self punchoutPickerTitle];
  if (v12)
  {
    uint64_t v13 = (void *)v12;
    uint64_t v14 = [(_SFPBButtonCardSection *)self punchoutPickerTitle];
    v15 = [v4 punchoutPickerTitle];
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self punchoutPickerDismissText];
  uint64_t v6 = [v4 punchoutPickerDismissText];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v17 = [(_SFPBButtonCardSection *)self punchoutPickerDismissText];
  if (v17)
  {
    v18 = (void *)v17;
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self type];
  uint64_t v6 = [v4 type];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v25 = [(_SFPBButtonCardSection *)self type];
  if (v25)
  {
    v26 = (void *)v25;
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self backgroundColor];
  uint64_t v6 = [v4 backgroundColor];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v31 = [(_SFPBButtonCardSection *)self backgroundColor];
  if (v31)
  {
    v32 = (void *)v31;
    long long v33 = [(_SFPBButtonCardSection *)self backgroundColor];
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self title];
  uint64_t v6 = [v4 title];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v36 = [(_SFPBButtonCardSection *)self title];
  if (v36)
  {
    long long v37 = (void *)v36;
    uint64_t v38 = [(_SFPBButtonCardSection *)self title];
  ...
  NSUInteger v5 = [(_SFPBButtonCardSection *)self thumbnail];
...
LABEL_40:
  ...
  uint64_t v41 = [(_SFPBButtonCardSection *)self thumbnail];
  if (!v41)
  {
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v10 = [(_SFPBButtonCardSection *)self punchoutPickerTitle];
  if (v10) {
    PBDataWriterWriteStringField();
  }

  int v11 = [(_SFPBButtonCardSection *)self punchoutPickerDismissText];
  if (v11) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v12 = [(_SFPBButtonCardSection *)self type];
  if (v12) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v13 = [(_SFPBButtonCardSection *)self backgroundColor];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }

  uint64_t v14 = [(_SFPBButtonCardSection *)self title];
  if (v14) {
    PBDataWriterWriteSubmessage();
  }

  v15 = [(_SFPBButtonCardSection *)self thumbnail];
  if (v15) {
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBButtonCardSectionReadFrom(self, (uint64_t)a3);
}
