@interface SFStockChartCardSection
...
- (SFStockChartCardSection)initWithCoder:(id)a3;
- (SFStockChartCardSection)initWithProtobuf:(id)a3;
...
@implementation SFStockChartCardSection
...
{
  v23.receiver = self;
  v23.super_class = (Class)SFStockChartCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFStockChartCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFStockChartCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
      v78.super_class = (Class)SFStockChartCardSection;
...
LABEL_27:
            ...
            v31 = [(SFStockChartCardSection *)self type];
            v32 = [(SFStockChartCardSection *)v6 type];
            if ((v31 == 0) != (v32 != 0))
            {
              id v63 = v32;
              v76 = v31;
              v33 = [(SFStockChartCardSection *)self type];
              if (v33)
              {
                v62 = [(SFStockChartCardSection *)self type];
                v60 = [(SFStockChartCardSection *)v6 type];
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                v41 = [(SFStockChartCardSection *)self thirdPartyContentURL];
                v42 = [(SFStockChartCardSection *)v6 thirdPartyContentURL];
                v43 = v42;
                if ((v41 == 0) == (v42 != 0))
                {
...
LABEL_65:
                ...
                v53 = [(SFStockChartCardSection *)self thirdPartyContentURL];
                if (!v53
                  || ([(SFStockChartCardSection *)self thirdPartyContentURL],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFStockChartCardSection *)v6 thirdPartyContentURL],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFStockChartCardSection *)self chartData];
                  v45 = [(SFStockChartCardSection *)v6 chartData];
                  v46 = v45;
                  if ((v50 == 0) == (v45 != 0))
                  {
                  ...
                  {
                    v49 = [(SFStockChartCardSection *)self chartData];
                    if (v49)
                    {
                      v48 = [(SFStockChartCardSection *)self chartData];
                      v47 = [(SFStockChartCardSection *)v6 chartData];
...
{
  v20.receiver = self;
  v20.super_class = (Class)SFStockChartCardSection;
  ...
  char v11 = [(SFStockChartCardSection *)self type];
  ...
  uint64_t v15 = [(SFStockChartCardSection *)self thirdPartyContentURL];
  v16 = (void *)[v15 copy];
  [v4 setThirdPartyContentURL:v16];

  uint64_t v17 = [(SFStockChartCardSection *)self chartData];
  v18 = (void *)[v17 copy];
  [v4 setChartData:v18];
...
- (NSData)jsonData
{
  v2 = [[_SFPBStockChartCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBStockChartCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBStockChartCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBStockChartCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFStockChartCardSection;
...
- (SFStockChartCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFStockChartCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 thirdPartyContentURL];
    [(SFStockChartCardSection *)v5 setThirdPartyContentURL:v14];

    uint64_t v15 = [(SFCardSection *)v8 chartData];
    [(SFStockChartCardSection *)v5 setChartData:v15];
...
- (SFStockChartCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v35.receiver = self;
  v35.super_class = (Class)SFStockChartCardSection;
  uint64_t v5 = [(SFCardSection *)&v35 init];
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[SFPunchout alloc] initWithProtobuf:*(void *)(*((void *)&v31 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
    ...
    if (v18)
    {
      ...
      [(SFStockChartCardSection *)v5 setType:v19];
    }
    ...
    if (v20)
    {
      unint64_t v21 = [SFColor alloc];
      v22 = [v4 backgroundColor];
      objc_super v23 = [(SFColor *)v21 initWithProtobuf:v22];
    ...
    if (v24)
    {
      v25 = [v4 thirdPartyContentURL];
      int v26 = _SFPBURLHandwrittenTranslator(v25);
      [(SFStockChartCardSection *)v5 setThirdPartyContentURL:v26];
    }
    v27 = [v4 chartData];

    if (v27)
    {
      BOOL v28 = [v4 chartData];
      [(SFStockChartCardSection *)v5 setChartData:v28];
    }
    BOOL v29 = v5;
  }
  return v5;
