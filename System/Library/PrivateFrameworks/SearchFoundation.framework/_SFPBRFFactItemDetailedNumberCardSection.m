...
- (_SFPBRFFactItemDetailedNumberCardSection)initWithDictionary:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)_SFPBRFFactItemDetailedNumberCardSection;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_number)
  {
    id v4 = [(_SFPBRFFactItemDetailedNumberCardSection *)self number];
  ...
  if (self->_text_1)
  {
    uint64_t v7 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
...
- (unint64_t)hash
{
  ...
  unint64_t v6 = v4 ^ v5 ^ [(_SFPBRFTextProperty *)self->_text_3 hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(_SFPBRFFactItemDetailedNumberCardSection *)self number];
  unint64_t v6 = [v4 number];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_31;
  }
  uint64_t v7 = [(_SFPBRFFactItemDetailedNumberCardSection *)self number];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  unint64_t v5 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
  unint64_t v6 = [v4 text];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_31;
  }
  uint64_t v12 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
  if (v12)
  {
    v13 = (void *)v12;
  ...
  uint64_t v17 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
  if (v17)
  {
    v18 = (void *)v17;
  ...
  uint64_t v22 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
  if (v22)
  {
    v23 = (void *)v22;
  ...
  unint64_t v5 = [(_SFPBRFFactItemDetailedNumberCardSection *)self thumbnail];
  unint64_t v6 = [v4 thumbnail];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_31;
  }
  uint64_t v27 = [(_SFPBRFFactItemDetailedNumberCardSection *)self thumbnail];
  if (v27)
  {
    v28 = (void *)v27;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v32 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
    if (!v32)
    {
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v6 = [(_SFPBRFFactItemDetailedNumberCardSection *)self text];
  if (v6) {
    PBDataWriterWriteSubmessage();
  }
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFFactItemDetailedNumberCardSectionReadFrom(self, (uint64_t)a3);
}
