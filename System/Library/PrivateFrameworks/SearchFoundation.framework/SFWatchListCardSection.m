@interface SFWatchListCardSection
+ (BOOL)supportsSecureCoding;
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (NSDictionary)dictionaryRepresentation;
- (NSString)type;
- (SFWatchListCardSection)initWithCoder:(id)a3;
- (SFWatchListCardSection)initWithProtobuf:(id)a3;
...
@implementation SFWatchListCardSection
...
{
  v21.receiver = self;
  v21.super_class = (Class)SFWatchListCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFWatchListCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFWatchListCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = (Class)SFWatchListCardSection;
...
LABEL_47:
            ...
            v28 = [(SFWatchListCardSection *)self type];
            v29 = [(SFWatchListCardSection *)v6 type];
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              uint64_t v51 = [(SFWatchListCardSection *)self type];
              v52 = v28;
              if (v51)
              {
                v30 = [(SFWatchListCardSection *)self type];
                v49 = [(SFWatchListCardSection *)v6 type];
                v50 = v30;
              ...
              if (v33 == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                  ...
                  {
                    v38 = [(SFWatchListCardSection *)self watchListItem];
                    v39 = [(SFWatchListCardSection *)v6 watchListItem];
                    v40 = v39;
                    if ((v38 == 0) == (v39 != 0))
                    {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFWatchListCardSection *)self watchListItem];
                      if (v41)
                      {
                        v42 = (void *)v41;
                        v43 = [(SFWatchListCardSection *)self watchListItem];
                        v44 = [(SFWatchListCardSection *)v6 watchListItem];
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFWatchListCardSection;
  ...
  char v11 = [(SFWatchListCardSection *)self type];
  ...
  uint64_t v15 = [(SFWatchListCardSection *)self watchListItem];
  v16 = (void *)[v15 copy];
  [v4 setWatchListItem:v16];
...
- (NSData)jsonData
{
  v2 = [[_SFPBWatchListCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBWatchListCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWatchListCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBWatchListCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFWatchListCardSection;
...
- (SFWatchListCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFWatchListCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 watchListItem];
    [(SFWatchListCardSection *)v5 setWatchListItem:v14];
...
- (SFWatchListCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v34.receiver = self;
  v34.super_class = (Class)SFWatchListCardSection;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      [(SFWatchListCardSection *)v5 setType:v19];
    }
    ...
    BOOL v24 = [v4 watchListItem];

    if (v24)
    {
      BOOL v25 = [SFWatchListItem alloc];
      BOOL v26 = [v4 watchListItem];
      v27 = [(SFWatchListItem *)v25 initWithProtobuf:v26];
      [(SFWatchListCardSection *)v5 setWatchListItem:v27];
    }
    v28 = v5;
  }
  return v5;
