...
{
  v21.receiver = self;
  v21.super_class = (Class)SFActivityIndicatorCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFActivityIndicatorCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  else
  {
    ...
    {
      v70.receiver = self;
      v70.super_class = (Class)SFActivityIndicatorCardSection;
...
LABEL_47:
            ...
            {
              v53 = v29;
              uint64_t v51 = [(SFActivityIndicatorCardSection *)self type];
              v52 = v28;
              if (v51)
              {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFActivityIndicatorCardSection *)self text];
                      if (v41)
                      {
                        v42 = (void *)v41;
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFActivityIndicatorCardSection;
  ...
  char v11 = [(SFActivityIndicatorCardSection *)self type];
  ...
  uint64_t v15 = [(SFActivityIndicatorCardSection *)self text];
  v16 = (void *)[v15 copy];
  [v4 setText:v16];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBActivityIndicatorCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBActivityIndicatorCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBActivityIndicatorCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFActivityIndicatorCardSection;
...
- (SFActivityIndicatorCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v32.receiver = self;
  v32.super_class = (Class)SFActivityIndicatorCardSection;
