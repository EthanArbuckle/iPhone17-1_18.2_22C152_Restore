...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBTextColumn *)v2 jsonData];
...
{
  v2 = [[_SFPBTextColumn alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBTextColumn *)v2 dictionaryRepresentation];
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[SFTextColumnSection alloc] initWithProtobuf:*(void *)(*((void *)&v16 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
