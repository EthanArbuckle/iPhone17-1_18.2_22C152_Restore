...
- (void)setThirdPartyContentURL:(id)a3;
- (void)setType:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_thirdPartyContentURL, 0);
...
- (_SFPBURL)thirdPartyContentURL
{
  return self->_thirdPartyContentURL;
}
...
- (_SFPBStockChartCardSection)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v40.receiver = self;
  v40.super_class = (Class)_SFPBStockChartCardSection;
  v5 = [(_SFPBStockChartCardSection *)&v40 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBStockChartCardSection *)self backgroundColor];
  ...
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBStockChartCardSection canBeHidden](self, "canBeHidden"));
    [v3 setObject:v7 forKeyedSubscript:@"canBeHidden"];
  }
  if (self->_chartData)
  {
    uint64_t v8 = [(_SFPBStockChartCardSection *)self chartData];
  ...
  {
    uint64_t v11 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBStockChartCardSection hasBottomPadding](self, "hasBottomPadding"));
    [v3 setObject:v11 forKeyedSubscript:@"hasBottomPadding"];
  }
  if (self->_hasTopPadding)
  {
    uint64_t v12 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBStockChartCardSection hasTopPadding](self, "hasTopPadding"));
  ...
  if ([(NSArray *)self->_punchoutOptions count])
  {
    ...
    uint64_t v15 = [(NSArray *)v14 countByEnumeratingWithState:&v33 objects:v37 count:16];
    if (v15)
    {
      uint64_t v16 = v15;
      ...
      do
      {
        for (uint64_t i = 0; i != v16; ++i)
        {
          ...
          v19 = [*(id *)(*((void *)&v33 + 1) + 8 * i) dictionaryRepresentation];
          if (v19)
          {
            [v13 addObject:v19];
          }
        ...
        uint64_t v16 = [(NSArray *)v14 countByEnumeratingWithState:&v33 objects:v37 count:16];
      }
      while (v16);
    }
  ...
  {
    uint64_t v25 = [(_SFPBStockChartCardSection *)self separatorStyle];
    if (v25 >= 6)
    {
...
- (unint64_t)hash
{
  ...
  unint64_t v11 = v10 ^ [(_SFPBURL *)self->_thirdPartyContentURL hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self punchoutOptions];
  uint64_t v6 = [v4 punchoutOptions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v7 = [(_SFPBStockChartCardSection *)self punchoutOptions];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    NSUInteger v9 = [(_SFPBStockChartCardSection *)self punchoutOptions];
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self punchoutPickerTitle];
  uint64_t v6 = [v4 punchoutPickerTitle];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v12 = [(_SFPBStockChartCardSection *)self punchoutPickerTitle];
  if (v12)
  {
    v13 = (void *)v12;
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self punchoutPickerDismissText];
  uint64_t v6 = [v4 punchoutPickerDismissText];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v17 = [(_SFPBStockChartCardSection *)self punchoutPickerDismissText];
  if (v17)
  {
    v18 = (void *)v17;
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self type];
  uint64_t v6 = [v4 type];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v25 = [(_SFPBStockChartCardSection *)self type];
  if (v25)
  {
    v26 = (void *)v25;
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self backgroundColor];
  uint64_t v6 = [v4 backgroundColor];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v31 = [(_SFPBStockChartCardSection *)self backgroundColor];
  if (v31)
  {
    long long v32 = (void *)v31;
    long long v33 = [(_SFPBStockChartCardSection *)self backgroundColor];
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self thirdPartyContentURL];
  uint64_t v6 = [v4 thirdPartyContentURL];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_40;
  }
  uint64_t v36 = [(_SFPBStockChartCardSection *)self thirdPartyContentURL];
  if (v36)
  {
    long long v37 = (void *)v36;
    uint64_t v38 = [(_SFPBStockChartCardSection *)self thirdPartyContentURL];
    long long v39 = [v4 thirdPartyContentURL];
  ...
  NSUInteger v5 = [(_SFPBStockChartCardSection *)self chartData];
  uint64_t v6 = [v4 chartData];
  if ((v5 == 0) == (v6 != 0))
  {
LABEL_40:
  ...
  uint64_t v41 = [(_SFPBStockChartCardSection *)self chartData];
  if (!v41)
  {
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v10 = [(_SFPBStockChartCardSection *)self punchoutPickerTitle];
  if (v10) {
    PBDataWriterWriteStringField();
  }

  int v11 = [(_SFPBStockChartCardSection *)self punchoutPickerDismissText];
  if (v11) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v12 = [(_SFPBStockChartCardSection *)self type];
  if (v12) {
    PBDataWriterWriteStringField();
  }
  ...
  v13 = [(_SFPBStockChartCardSection *)self backgroundColor];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }

  v14 = [(_SFPBStockChartCardSection *)self thirdPartyContentURL];
  if (v14) {
    PBDataWriterWriteSubmessage();
  }

  uint64_t v15 = [(_SFPBStockChartCardSection *)self chartData];
  if (v15) {
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBStockChartCardSectionReadFrom(self, (uint64_t)a3);
}

- (void)setChartData:(id)a3
{
  self->_chartData = (NSData *)[a3 copy];
  MEMORY[0x1F41817F8]();
}
