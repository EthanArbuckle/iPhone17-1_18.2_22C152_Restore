...
- (RFSummaryItemTextCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v36.receiver = self;
  v36.super_class = (Class)RFSummaryItemTextCardSection;
...
{
  v15.receiver = self;
  v15.super_class = (Class)RFSummaryItemTextCardSection;
  unint64_t v3 = [(SFCardSection *)&v15 hash];
  id v4 = [(RFSummaryItemTextCardSection *)self text];
  uint64_t v5 = [v4 hash];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (RFSummaryItemTextCardSection *)a3;
  if (self == v4)
  {
    char v10 = 1;
  }
  else
  {
    ...
    {
      v50.receiver = self;
      v50.super_class = (Class)RFSummaryItemTextCardSection;
      if ([(SFCardSection *)&v50 isEqual:v4])
      {
        uint64_t v5 = v4;
        v6 = [(RFSummaryItemTextCardSection *)self text];
        uint64_t v7 = [(RFSummaryItemTextCardSection *)v5 text];
        if ((v6 == 0) == (v7 != 0))
        {
          char v10 = 0;
LABEL_51:
        ...
        if (v8)
        {
          uint64_t v9 = [(RFSummaryItemTextCardSection *)self text];
        ...
        uint64_t v11 = [(RFSummaryItemTextCardSection *)v5 text];
        if ((v49 == 0) != (v11 != 0))
        {
          uint64_t v12 = [(RFSummaryItemTextCardSection *)self text];
          if (v12)
          {
          ...
          objc_super v15 = [(RFSummaryItemTextCardSection *)self text];
          v16 = [(RFSummaryItemTextCardSection *)v5 text];
          if ((v15 == 0) != (v16 != 0))
          {
            v42 = v15;
            v43 = v16;
            uint64_t v17 = [(RFSummaryItemTextCardSection *)self text];
            if (v17)
            {
              uint64_t v18 = [(RFSummaryItemTextCardSection *)self text];
            ...
            if ((v21 == 0) != (v22 != 0))
            {
              ...
              if (v37)
              {
                ...
                long long v35 = [(RFSummaryItemTextCardSection *)v5 text];
                objc_super v36 = v23;
...
LABEL_43:
              ...
              else
              {
                long long v32 = v25;
                long long v34 = v24;
                uint64_t v26 = [(RFSummaryItemTextCardSection *)self text];
                v20 = v45;
                v27 = (void *)v37;
                if (v26)
                {
...
{
  v16.receiver = self;
  v16.super_class = (Class)RFSummaryItemTextCardSection;
  id v4 = [(SFCardSection *)&v16 copyWithZone:a3];
  uint64_t v5 = [(RFSummaryItemTextCardSection *)self text];
  v6 = (void *)[v5 copy];
  objc_msgSend(v4, "setText_2:", v6);

  uint64_t v7 = [(RFSummaryItemTextCardSection *)self text];
  v8 = (void *)[v7 copy];
  ...
  uint64_t v11 = [(RFSummaryItemTextCardSection *)self text];
  uint64_t v12 = (void *)[v11 copy];
  objc_msgSend(v4, "setText_4:", v12);

  unint64_t v13 = [(RFSummaryItemTextCardSection *)self text];
  v14 = (void *)[v13 copy];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFSummaryItemTextCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSummaryItemTextCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFSummaryItemTextCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)RFSummaryItemTextCardSection;
...
- (RFSummaryItemTextCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    unint64_t v13 = [(SFCardSection *)v8 text];
