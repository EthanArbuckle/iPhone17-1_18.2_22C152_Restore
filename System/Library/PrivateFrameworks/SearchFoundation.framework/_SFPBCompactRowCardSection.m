...
- (_SFPBCompactRowCardSection)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v45.receiver = self;
  v45.super_class = (Class)_SFPBCompactRowCardSection;
  ...
  if (v5)
  {
    ...
    v37 = v18;
    long long v40 = v6;
    v21 = objc_msgSend(v4, "objectForKeyedSubscript:", @"type", v20);
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v22 = (void *)[v21 copy];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBCompactRowCardSection *)self backgroundColor];
  ...
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBCompactRowCardSection canBeHidden](self, "canBeHidden"));
    [v3 setObject:v7 forKeyedSubscript:@"canBeHidden"];
  }
  if (self->_hasBottomPadding)
  {
    uint64_t v8 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBCompactRowCardSection hasBottomPadding](self, "hasBottomPadding"));
    [v3 setObject:v8 forKeyedSubscript:@"hasBottomPadding"];
  }
  if (self->_hasTopPadding)
  {
    uint64_t v9 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBCompactRowCardSection hasTopPadding](self, "hasTopPadding"));
    [v3 setObject:v9 forKeyedSubscript:@"hasTopPadding"];
  }
  if (self->_image)
  {
    uint64_t v10 = [(_SFPBCompactRowCardSection *)self image];
  ...
  {
    v13 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBCompactRowCardSection isSubtitleDetatched](self, "isSubtitleDetatched"));
  ...
  if ([(NSArray *)self->_punchoutOptions count])
  {
    ...
    uint64_t v16 = [(NSArray *)v15 countByEnumeratingWithState:&v37 objects:v41 count:16];
    if (v16)
    {
      uint64_t v17 = v16;
      ...
      do
      {
        for (uint64_t i = 0; i != v17; ++i)
        {
          ...
          v20 = [*(id *)(*((void *)&v37 + 1) + 8 * i) dictionaryRepresentation];
          if (v20)
          {
            [v14 addObject:v20];
          }
        ...
        uint64_t v17 = [(NSArray *)v15 countByEnumeratingWithState:&v37 objects:v41 count:16];
      }
      while (v17);
    }
  ...
  {
    uint64_t v26 = [(_SFPBCompactRowCardSection *)self separatorStyle];
    if (v26 >= 6)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self punchoutOptions];
  uint64_t v6 = [v4 punchoutOptions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v7 = [(_SFPBCompactRowCardSection *)self punchoutOptions];
  if (v7)
  {
    uint64_t v8 = (void *)v7;
    unint64_t v9 = [(_SFPBCompactRowCardSection *)self punchoutOptions];
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self punchoutPickerTitle];
  uint64_t v6 = [v4 punchoutPickerTitle];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v12 = [(_SFPBCompactRowCardSection *)self punchoutPickerTitle];
  if (v12)
  {
    v13 = (void *)v12;
    NSUInteger v14 = [(_SFPBCompactRowCardSection *)self punchoutPickerTitle];
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self punchoutPickerDismissText];
  uint64_t v6 = [v4 punchoutPickerDismissText];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v17 = [(_SFPBCompactRowCardSection *)self punchoutPickerDismissText];
  if (v17)
  {
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self type];
  uint64_t v6 = [v4 type];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v25 = [(_SFPBCompactRowCardSection *)self type];
  if (v25)
  {
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self backgroundColor];
  uint64_t v6 = [v4 backgroundColor];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v31 = [(_SFPBCompactRowCardSection *)self backgroundColor];
  if (v31)
  {
    v32 = (void *)v31;
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self title];
  uint64_t v6 = [v4 title];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v36 = [(_SFPBCompactRowCardSection *)self title];
  if (v36)
  {
    long long v37 = (void *)v36;
    long long v38 = [(_SFPBCompactRowCardSection *)self title];
  ...
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self subtitle];
  uint64_t v6 = [v4 subtitle];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_46;
  }
  uint64_t v41 = [(_SFPBCompactRowCardSection *)self subtitle];
  if (v41)
  {
    uint64_t v42 = (void *)v41;
    long long v43 = [(_SFPBCompactRowCardSection *)self subtitle];
  ...
  int isSubtitleDetatched = self->_isSubtitleDetatched;
  if (isSubtitleDetatched != [v4 isSubtitleDetatched]) {
    goto LABEL_47;
  }
  uint64_t v5 = [(_SFPBCompactRowCardSection *)self image];
...
LABEL_46:
  ...
  uint64_t v47 = [(_SFPBCompactRowCardSection *)self image];
  if (!v47)
  {
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v10 = [(_SFPBCompactRowCardSection *)self punchoutPickerTitle];
  if (v10) {
    PBDataWriterWriteStringField();
  }

  int v11 = [(_SFPBCompactRowCardSection *)self punchoutPickerDismissText];
  if (v11) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v12 = [(_SFPBCompactRowCardSection *)self type];
  if (v12) {
    PBDataWriterWriteStringField();
  }
  ...
  v13 = [(_SFPBCompactRowCardSection *)self backgroundColor];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }

  NSUInteger v14 = [(_SFPBCompactRowCardSection *)self title];
  if (v14) {
    PBDataWriterWriteSubmessage();
  }

  uint64_t v15 = [(_SFPBCompactRowCardSection *)self subtitle];
  if (v15) {
    PBDataWriterWriteSubmessage();
  }
  ...
  int v16 = [(_SFPBCompactRowCardSection *)self image];
  if (v16) {
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBCompactRowCardSectionReadFrom(self, (uint64_t)a3);
}
...
- (void)setIsSubtitleDetatched:(BOOL)a3
{
  self->_int isSubtitleDetatched = a3;
}
