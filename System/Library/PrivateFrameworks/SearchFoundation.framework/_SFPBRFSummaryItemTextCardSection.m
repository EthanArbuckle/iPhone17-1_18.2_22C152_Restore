...
- (NSArray)text_3s;
- (NSData)jsonData;
- (_SFPBRFSummaryItemTextCardSection)initWithDictionary:(id)a3;
- (_SFPBRFSummaryItemTextCardSection)initWithFacade:(id)a3;
- (_SFPBRFSummaryItemTextCardSection)initWithJSON:(id)a3;
...
- (_SFPBRFSummaryItemTextCardSection)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v30.receiver = self;
  v30.super_class = (Class)_SFPBRFSummaryItemTextCardSection;
  v5 = [(_SFPBRFSummaryItemTextCardSection *)&v30 init];
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"text2"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(_SFPBRFSummaryItemTextCardSection *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_text_1)
  {
    id v4 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  if (self->_text_2)
  {
    uint64_t v7 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  if ([(NSArray *)self->_text_3s count])
  {
    ...
    uint64_t v12 = [(NSArray *)v11 countByEnumeratingWithState:&v25 objects:v29 count:16];
    if (v12)
    {
      uint64_t v13 = v12;
      ...
      do
      {
        for (uint64_t i = 0; i != v13; ++i)
        {
          ...
          uint64_t v16 = objc_msgSend(*(id *)(*((void *)&v25 + 1) + 8 * i), "dictionaryRepresentation", (void)v25);
          if (v16)
          {
            [v10 addObject:v16];
          }
        ...
        uint64_t v13 = [(NSArray *)v11 countByEnumeratingWithState:&v25 objects:v29 count:16];
      }
      while (v13);
    }
  ...
  if (self->_text_4)
  {
    uint64_t v18 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  if (self->_text_5)
  {
    v21 = [(_SFPBRFSummaryItemTextCardSection *)self text];
...
- (unint64_t)hash
{
  unint64_t v3 = [(_SFPBRFTextProperty *)self->_text_2 hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  {
    v8 = (void *)v7;
    v9 = [(_SFPBRFSummaryItemTextCardSection *)self text];
    v10 = [v4 text];
  ...
  uint64_t v12 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v12)
  {
    uint64_t v13 = (void *)v12;
    uint64_t v14 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  uint64_t v5 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  unint64_t v6 = objc_msgSend(v4, "text_3s");
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_26;
  }
  uint64_t v17 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  if (v17)
  {
    uint64_t v18 = (void *)v17;
    uint64_t v19 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  ...
  uint64_t v22 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v22)
  {
    v23 = (void *)v22;
    v24 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v27 = [(_SFPBRFSummaryItemTextCardSection *)self text];
    if (!v27)
    {
...
LABEL_30:
    ...
    long long v29 = [(_SFPBRFSummaryItemTextCardSection *)self text];
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v6 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v6) {
    PBDataWriterWriteSubmessage();
  }

  uint64_t v7 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  long long v14 = 0u;
  long long v15 = 0u;
  long long v16 = 0u;
  long long v17 = 0u;
  ...
  uint64_t v13 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFSummaryItemTextCardSectionReadFrom(self, (uint64_t)a3);
}
