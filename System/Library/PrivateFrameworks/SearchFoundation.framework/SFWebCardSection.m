...
- (NSString)htmlString;
- (NSString)type;
- (SFWebCardSection)initWithCoder:(id)a3;
- (SFWebCardSection)initWithProtobuf:(id)a3;
...
@implementation SFWebCardSection
...
- (SFWebCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v32.receiver = self;
  v32.super_class = (Class)SFWebCardSection;
  ...
  if (v5)
  {
    ...
    {
      v19 = [v4 type];
      [(SFWebCardSection *)v5 setType:v19];
    }
    ...
    {
      v25 = [v4 htmlString];
      [(SFWebCardSection *)v5 setHtmlString:v25];
    }
    v26 = v5;
  }
  return v5;
...
{
  v21.receiver = self;
  v21.super_class = (Class)SFWebCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFWebCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFWebCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = (Class)SFWebCardSection;
...
LABEL_47:
            ...
            long long v28 = [(SFWebCardSection *)self type];
            long long v29 = [(SFWebCardSection *)v6 type];
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              uint64_t v51 = [(SFWebCardSection *)self type];
              v52 = v28;
              if (v51)
              {
                long long v30 = [(SFWebCardSection *)self type];
                v49 = [(SFWebCardSection *)v6 type];
                v50 = v30;
              ...
              if (v33 == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                  ...
                  {
                    v38 = [(SFWebCardSection *)self htmlString];
                    v39 = [(SFWebCardSection *)v6 htmlString];
                    v40 = v39;
                    if ((v38 == 0) == (v39 != 0))
                    {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFWebCardSection *)self htmlString];
                      if (v41)
                      {
                        v42 = (void *)v41;
                        v43 = [(SFWebCardSection *)self htmlString];
                        v44 = [(SFWebCardSection *)v6 htmlString];
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFWebCardSection;
  ...
  char v11 = [(SFWebCardSection *)self type];
  ...
  uint64_t v15 = [(SFWebCardSection *)self htmlString];
  v16 = (void *)[v15 copy];
  [v4 setHtmlString:v16];
...
- (NSData)jsonData
{
  v2 = [[_SFPBWebCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBWebCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWebCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBWebCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFWebCardSection;
...
- (SFWebCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFWebCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 htmlString];
    [(SFWebCardSection *)v5 setHtmlString:v14];
