...
- (_SFPBExecuteToolCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBExecuteToolCommand;
  v5 = [(_SFPBExecuteToolCommand *)&v10 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBExecuteToolCommand *)self toolIdentifier];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSString *)self->_toolIdentifier hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBExecuteToolCommand *)self toolIdentifier];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBExecuteToolCommand *)self toolIdentifier];
      v11 = [v4 toolIdentifier];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBExecuteToolCommandReadFrom(self, (uint64_t)a3);
}

- (void)setToolIdentifier:(id)a3
{
  self->_toolIdentifier = (NSString *)[a3 copy];
  MEMORY[0x1F41817F8]();
}
