...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBDomainSubscriptionRequestItem *)self sportsSubscriptionRequestItem];
...
- (unint64_t)hash
{
  return [(_SFPBSportsSubscriptionRequestItem *)self->_sportsSubscriptionRequestItem hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBDomainSubscriptionRequestItem *)self sportsSubscriptionRequestItem];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBDomainSubscriptionRequestItem *)self sportsSubscriptionRequestItem];
...
- (_SFPBSportsSubscriptionRequestItem)sportsSubscriptionRequestItem
{
  if (self->_whichValue == 1) {
    v2 = self->_sportsSubscriptionRequestItem;
  }
  else {
    v2 = 0;
  }
