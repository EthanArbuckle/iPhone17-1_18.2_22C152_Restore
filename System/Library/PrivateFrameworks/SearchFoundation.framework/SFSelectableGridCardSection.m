...
- (void)setInitialSelectedIndex:(id)a3;
- (void)setType:(id)a3;
@end
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_initialSelectedIndex, 0);
...
{
  v23.receiver = self;
  v23.super_class = (Class)SFSelectableGridCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFSelectableGridCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  else
  {
    ...
    {
      v78.receiver = self;
      v78.super_class = (Class)SFSelectableGridCardSection;
...
LABEL_65:
                ...
                if (!v53
                  || ([(SFSelectableGridCardSection *)self entries],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFSelectableGridCardSection *)v6 entries],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFSelectableGridCardSection *)self initialSelectedIndex];
...
{
  v20.receiver = self;
  v20.super_class = (Class)SFSelectableGridCardSection;
  ...
  char v11 = [(SFSelectableGridCardSection *)self type];
  ...
  uint64_t v15 = [(SFSelectableGridCardSection *)self entries];
  v16 = (void *)[v15 copy];
  [v4 setEntries:v16];

  uint64_t v17 = [(SFSelectableGridCardSection *)self initialSelectedIndex];
  v18 = (void *)[v17 copy];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBSelectableGridCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBSelectableGridCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBSelectableGridCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFSelectableGridCardSection;
...
- (SFSelectableGridCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    uint64_t v14 = [(SFCardSection *)v8 entries];
    [(SFSelectableGridCardSection *)v5 setEntries:v14];

    uint64_t v15 = [(SFCardSection *)v8 initialSelectedIndex];
...
- (SFSelectableGridCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v43.receiver = self;
  v43.super_class = (Class)SFSelectableGridCardSection;
  uint64_t v5 = [(SFCardSection *)&v43 init];
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[SFPunchout alloc] initWithProtobuf:*(void *)(*((void *)&v39 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
    ...
    long long v35 = 0u;
    long long v36 = 0u;
    int v26 = objc_msgSend(v4, "entries", 0);
    ...
    if (v27)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v28; ++j)
        {
          ...
          v31 = [[SFTitleSubtitleTuple alloc] initWithProtobuf:*(void *)(*((void *)&v35 + 1) + 8 * j)];
          if (v31) {
            [v25 addObject:v31];
          }
        }
    ...
    {
      v32 = objc_msgSend(NSNumber, "numberWithInt:", objc_msgSend(v4, "initialSelectedIndex"));
