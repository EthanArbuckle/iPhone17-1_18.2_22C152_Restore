@interface SFMediaPlayerCardSection
...
- (NSString)title;
- (NSString)type;
- (SFMediaPlayerCardSection)initWithCoder:(id)a3;
- (SFMediaPlayerCardSection)initWithProtobuf:(id)a3;
...
@implementation SFMediaPlayerCardSection
...
{
  v25.receiver = self;
  v25.super_class = (Class)SFMediaPlayerCardSection;
...
- (BOOL)isEqual:(id)a3
{
  v4 = (SFMediaPlayerCardSection *)a3;
  if (self == v4)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFMediaPlayerCardSection *)v4 isMemberOfClass:objc_opt_class()])
    {
      v67.receiver = self;
      v67.super_class = (Class)SFMediaPlayerCardSection;
...
LABEL_40:
        ...
        if (v22 == [(SFCardSection *)v5 canBeHidden])
        {
          ...
          if (v23 == [(SFCardSection *)v5 hasTopPadding])
          {
            ...
            {
              objc_super v25 = [(SFMediaPlayerCardSection *)self type];
              v26 = [(SFMediaPlayerCardSection *)v5 type];
              if ((v25 == 0) != (v26 != 0))
              {
                v55 = v26;
                v56 = v25;
                [(SFMediaPlayerCardSection *)self type];
                v57 = uint64_t v14 = v64;
                if (v57)
                {
                  v54 = [(SFMediaPlayerCardSection *)self type];
                  v53 = [(SFMediaPlayerCardSection *)v5 type];
                ...
                if (v27 == [(SFCardSection *)v5 separatorStyle])
                {
                  ...
                  if ((v52 == 0) != (v28 != 0))
                  {
                    ...
                    v49 = [(SFMediaPlayerCardSection *)self title];
                    v48 = [(SFMediaPlayerCardSection *)v5 title];
                    if ((v49 == 0) == (v48 != 0))
                    {
...
LABEL_57:
                    ...
                    v45 = [(SFMediaPlayerCardSection *)self title];
                    if (v45)
                    {
                      v31 = [(SFMediaPlayerCardSection *)self title];
                      v41 = [(SFMediaPlayerCardSection *)v5 title];
                      v42 = v31;
...
LABEL_24:
                    ...
                    v44 = [(SFMediaPlayerCardSection *)self subtitle];
                    v43 = [(SFMediaPlayerCardSection *)v5 subtitle];
                    if ((v44 == 0) == (v43 != 0))
                    {
                    ...
                    v40 = [(SFMediaPlayerCardSection *)self subtitle];
                    if (!v40
                      || ([(SFMediaPlayerCardSection *)self subtitle],
                          v32 = objc_claimAutoreleasedReturnValue(),
                          [(SFMediaPlayerCardSection *)v5 subtitle],
                          v38 = objc_claimAutoreleasedReturnValue(),
                          v39 = v32,
                          objc_msgSend(v32, "isEqual:")))
                    {
                      v37 = [(SFMediaPlayerCardSection *)self mediaItems];
                      v36 = [(SFMediaPlayerCardSection *)v5 mediaItems];
                      if ((v37 == 0) == (v36 != 0))
                      {
                      ...
                      {
                        v35 = [(SFMediaPlayerCardSection *)self mediaItems];
                        if (v35)
                        {
                          v34 = [(SFMediaPlayerCardSection *)self mediaItems];
                          v33 = [(SFMediaPlayerCardSection *)v5 mediaItems];
...
{
  v22.receiver = self;
  v22.super_class = (Class)SFMediaPlayerCardSection;
  ...
  char v11 = [(SFMediaPlayerCardSection *)self type];
  ...
  uint64_t v15 = [(SFMediaPlayerCardSection *)self title];
  v16 = (void *)[v15 copy];
  [v4 setTitle:v16];

  uint64_t v17 = [(SFMediaPlayerCardSection *)self subtitle];
  uint64_t v18 = (void *)[v17 copy];
  [v4 setSubtitle:v18];

  uint64_t v19 = [(SFMediaPlayerCardSection *)self mediaItems];
  v20 = (void *)[v19 copy];
  [v4 setMediaItems:v20];
...
- (NSData)jsonData
{
  v2 = [[_SFPBMediaPlayerCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBMediaPlayerCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMediaPlayerCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBMediaPlayerCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFMediaPlayerCardSection;
...
- (SFMediaPlayerCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFMediaPlayerCardSection *)v5 setType:v12];
    ...
    [(SFMediaPlayerCardSection *)v5 setTitle:v14];

    uint64_t v15 = [(SFCardSection *)v8 subtitle];
    [(SFMediaPlayerCardSection *)v5 setSubtitle:v15];

    v16 = [(SFCardSection *)v8 mediaItems];
    [(SFMediaPlayerCardSection *)v5 setMediaItems:v16];
...
- (SFMediaPlayerCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v46.receiver = self;
  v46.super_class = (Class)SFMediaPlayerCardSection;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      [(SFMediaPlayerCardSection *)v5 setType:v19];
    }
    ...
    if (v24)
    {
      ...
      [(SFMediaPlayerCardSection *)v5 setTitle:v25];
    }
    v26 = [v4 subtitle];
    ...
    {
      int v27 = [v4 subtitle];
      [(SFMediaPlayerCardSection *)v5 setSubtitle:v27];
    }
    v28 = [v4 mediaItems];
    if (v28) {
    ...
    [(SFMediaPlayerCardSection *)v5 setMediaItems:v29];
    v36 = v5;
  }
  return v5;
}
