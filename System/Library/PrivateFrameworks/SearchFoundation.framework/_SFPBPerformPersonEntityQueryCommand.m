...
- (_SFPBPerformPersonEntityQueryCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBPerformPersonEntityQueryCommand;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_person)
  {
    id v4 = [(_SFPBPerformPersonEntityQueryCommand *)self person];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBPerformPersonEntityQueryCommand *)self person];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBPerformPersonEntityQueryCommand *)self person];
      v11 = [v4 person];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBPerformPersonEntityQueryCommandReadFrom(self, (uint64_t)a3);
}
