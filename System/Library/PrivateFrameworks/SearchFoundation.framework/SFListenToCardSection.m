@interface SFListenToCardSection
...
- (SFListenToCardSection)initWithCoder:(id)a3;
- (SFListenToCardSection)initWithProtobuf:(id)a3;
...
@implementation SFListenToCardSection
...
{
  v23.receiver = self;
  v23.super_class = (Class)SFListenToCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFListenToCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFListenToCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
      v78.super_class = (Class)SFListenToCardSection;
...
LABEL_27:
            ...
            v31 = [(SFListenToCardSection *)self type];
            v32 = [(SFListenToCardSection *)v6 type];
            if ((v31 == 0) != (v32 != 0))
            {
              id v63 = v32;
              v76 = v31;
              v33 = [(SFListenToCardSection *)self type];
              if (v33)
              {
                v62 = [(SFListenToCardSection *)self type];
                v60 = [(SFListenToCardSection *)v6 type];
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                v41 = [(SFListenToCardSection *)self mediaMetadata];
                v42 = [(SFListenToCardSection *)v6 mediaMetadata];
                v43 = v42;
                if ((v41 == 0) == (v42 != 0))
                {
...
LABEL_65:
                ...
                v53 = [(SFListenToCardSection *)self mediaMetadata];
                if (!v53
                  || ([(SFListenToCardSection *)self mediaMetadata],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFListenToCardSection *)v6 mediaMetadata],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFListenToCardSection *)self fallbackCardSection];
                  v45 = [(SFListenToCardSection *)v6 fallbackCardSection];
                  v46 = v45;
                  if ((v50 == 0) == (v45 != 0))
                  {
                  ...
                  {
                    v49 = [(SFListenToCardSection *)self fallbackCardSection];
                    if (v49)
                    {
                      v48 = [(SFListenToCardSection *)self fallbackCardSection];
                      v47 = [(SFListenToCardSection *)v6 fallbackCardSection];
...
{
  v20.receiver = self;
  v20.super_class = (Class)SFListenToCardSection;
  ...
  char v11 = [(SFListenToCardSection *)self type];
  ...
  uint64_t v15 = [(SFListenToCardSection *)self mediaMetadata];
  v16 = (void *)[v15 copy];
  [v4 setMediaMetadata:v16];

  uint64_t v17 = [(SFListenToCardSection *)self fallbackCardSection];
  v18 = (void *)[v17 copy];
  [v4 setFallbackCardSection:v18];
...
- (NSData)jsonData
{
  v2 = [[_SFPBListenToCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBListenToCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBListenToCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBListenToCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFListenToCardSection;
...
- (SFListenToCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFListenToCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 mediaMetadata];
    [(SFListenToCardSection *)v5 setMediaMetadata:v14];

    uint64_t v15 = [(SFCardSection *)v8 fallbackCardSection];
    [(SFListenToCardSection *)v5 setFallbackCardSection:v15];
...
- (SFListenToCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v38.receiver = self;
  v38.super_class = (Class)SFListenToCardSection;
  uint64_t v5 = [(SFCardSection *)&v38 init];
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[SFPunchout alloc] initWithProtobuf:*(void *)(*((void *)&v34 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
    ...
    if (v18)
    {
      ...
      [(SFListenToCardSection *)v5 setType:v19];
    }
    ...
    if (v24)
    {
      v25 = [SFMediaMetadata alloc];
      int v26 = [v4 mediaMetadata];
      v27 = [(SFMediaMetadata *)v25 initWithProtobuf:v26];
      [(SFListenToCardSection *)v5 setMediaMetadata:v27];
    }
    BOOL v28 = [v4 fallbackCardSection];

    if (v28)
    {
      BOOL v29 = [SFCardSection alloc];
      BOOL v30 = [v4 fallbackCardSection];
      v31 = [(SFCardSection *)v29 initWithProtobuf:v30];
      [(SFListenToCardSection *)v5 setFallbackCardSection:v31];
    }
    v32 = v5;
  }
  return v5;
