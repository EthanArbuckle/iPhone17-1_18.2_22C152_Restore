...
- (_SFPBLocationTypeInfo)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBLocationTypeInfo;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_address)
  {
    id v4 = [(_SFPBLocationTypeInfo *)self address];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBLocationTypeInfo *)self address];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBLocationTypeInfo *)self address];
      v11 = [v4 address];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBLocationTypeInfoReadFrom(self, (uint64_t)a3);
}
