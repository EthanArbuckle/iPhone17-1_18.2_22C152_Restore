...
- (_SFPBInvokeSiriCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBInvokeSiriCommand;
  v5 = [(_SFPBInvokeSiriCommand *)&v10 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBInvokeSiriCommand *)self utteranceText];
    v5 = (void *)[v4 copy];
    [v3 setObject:v5 forKeyedSubscript:@"utteranceText"];
  }
  return v3;
}
...
- (unint64_t)hash
{
  return [(NSString *)self->_utteranceText hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBInvokeSiriCommand *)self utteranceText];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBInvokeSiriCommand *)self utteranceText];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBInvokeSiriCommandReadFrom(self, (uint64_t)a3);
}
