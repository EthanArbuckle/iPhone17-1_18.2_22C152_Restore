...
- (_SFPBRFReferenceFootnoteCardSection)initWithDictionary:(id)a3
{
  id v4 = a3;
  v17.receiver = self;
  v17.super_class = (Class)_SFPBRFReferenceFootnoteCardSection;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_addTint)
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBRFReferenceFootnoteCardSection addTint](self, "addTint"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  unint64_t v6 = [v4 text];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_21;
  }
  uint64_t v7 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v12 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  if (v12)
  {
    v13 = (void *)v12;
    v14 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  ...
  uint64_t v17 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  if (v17)
  {
    v18 = (void *)v17;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v22 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
    if (!v22)
    {

LABEL_25:
      int addTint = self->_addTint;
      BOOL v27 = addTint == [v4 addTint];
      goto LABEL_23;
    }
    v23 = (void *)v22;
...
{
  id v8 = a3;
  id v4 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  if (v4) {
  ...
  unint64_t v6 = [(_SFPBRFReferenceFootnoteCardSection *)self text];
  if (v6) {
    PBDataWriterWriteSubmessage();
  }
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFReferenceFootnoteCardSectionReadFrom(self, (uint64_t)a3);
}
