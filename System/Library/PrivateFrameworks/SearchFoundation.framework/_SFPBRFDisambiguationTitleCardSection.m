...
- (id)dictionaryRepresentation
{
  ...
  if (self->_text_1)
  {
    id v4 = [(_SFPBRFDisambiguationTitleCardSection *)self text];
  ...
  if (self->_thumbnail)
  {
    uint64_t v7 = [(_SFPBRFDisambiguationTitleCardSection *)self thumbnail];
...
- (unint64_t)hash
{
  ...
  return [(_SFPBRFVisualProperty *)self->_thumbnail hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_SFPBRFDisambiguationTitleCardSection *)self text];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_SFPBRFDisambiguationTitleCardSection *)self thumbnail];
    if (!v12)
    {
