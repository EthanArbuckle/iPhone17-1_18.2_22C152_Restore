...
- (unint64_t)hash
{
  ...
  unint64_t v12 = v11 ^ [(RFReferenceFootnoteCardSection *)self addTint] ^ v3;
  ...
  else
  {
    if ([(RFReferenceFootnoteCardSection *)v4 isMemberOfClass:objc_opt_class()])
    {
      ...
      if ([(SFCardSection *)&v42 isEqual:v4])
      {
        uint64_t v5 = v4;
        v6 = [(RFReferenceFootnoteCardSection *)self text];
        uint64_t v7 = [(RFReferenceFootnoteCardSection *)v5 text];
        if ((v6 == 0) == (v7 != 0))
        {
          LOBYTE(v10) = 0;
LABEL_38:
        ...
        if (v8)
        {
          uint64_t v9 = [(RFReferenceFootnoteCardSection *)self text];
        ...
        uint64_t v11 = [(RFReferenceFootnoteCardSection *)v5 text];
        if ((v41 == 0) != (v11 != 0))
        {
          uint64_t v12 = [(RFReferenceFootnoteCardSection *)self text];
          if (v12)
          {
            v13 = (void *)v12;
            objc_super v14 = [(RFReferenceFootnoteCardSection *)self text];
          ...
          if ((v15 == 0) != (v16 != 0))
          {
            ...
            if (!v31
              || ([(RFReferenceFootnoteCardSection *)self text],
                  ...
                  [v25 isEqual:v24]))
            {
              BOOL v27 = [(RFReferenceFootnoteCardSection *)self addTint];
              BOOL v10 = v27 ^ [(RFReferenceFootnoteCardSection *)v5 addTint] ^ 1;
              if (!v31) {
                goto LABEL_42;
              }
            }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v5 = [(RFReferenceFootnoteCardSection *)self text];
  v6 = (void *)[v5 copy];
  objc_msgSend(v4, "setText_1:", v6);

  uint64_t v7 = [(RFReferenceFootnoteCardSection *)self text];
  v8 = (void *)[v7 copy];
  ...
  uint64_t v11 = [(RFReferenceFootnoteCardSection *)self text];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFReferenceFootnoteCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFReferenceFootnoteCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFReferenceFootnoteCardSection *)v2 dictionaryRepresentation];
