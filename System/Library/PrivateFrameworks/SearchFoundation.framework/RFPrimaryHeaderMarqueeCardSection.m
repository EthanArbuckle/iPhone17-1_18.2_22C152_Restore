...
- (RFPrimaryHeaderMarqueeCardSection)initWithCoder:(id)a3;
- (RFPrimaryHeaderMarqueeCardSection)initWithProtobuf:(id)a3;
...
{
  v12.receiver = self;
  v12.super_class = (Class)RFPrimaryHeaderMarqueeCardSection;
  unint64_t v3 = [(SFCardSection *)&v12 hash];
  v4 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
  uint64_t v5 = [v4 hash];
  v6 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
  uint64_t v7 = v5 ^ [v6 hash];
  v8 = [(RFPrimaryHeaderMarqueeCardSection *)self thumbnail];
  uint64_t v9 = v7 ^ [v8 hash];
  unint64_t v10 = v9 ^ [(RFPrimaryHeaderMarqueeCardSection *)self addTint] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (RFPrimaryHeaderMarqueeCardSection *)a3;
  if (self == v5)
  {
    LOBYTE(v11) = 1;
  }
  ...
  {
    if ([(RFPrimaryHeaderMarqueeCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v33.receiver = self;
      v33.super_class = (Class)RFPrimaryHeaderMarqueeCardSection;
      if ([(SFCardSection *)&v33 isEqual:v5])
      {
        v6 = v5;
        uint64_t v7 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
        v8 = [(RFPrimaryHeaderMarqueeCardSection *)v6 text];
        if ((v7 == 0) == (v8 != 0))
        {
          LOBYTE(v11) = 0;
LABEL_33:
        ...
        uint64_t v9 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
        if (v9)
        {
          unint64_t v10 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
          unint64_t v3 = [(RFPrimaryHeaderMarqueeCardSection *)v6 text];
          if (![v10 isEqual:v3])
          {
            LOBYTE(v11) = 0;
            goto LABEL_31;
        ...
        objc_super v12 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
        v13 = [(RFPrimaryHeaderMarqueeCardSection *)v6 text];
        v14 = v13;
        if ((v12 == 0) == (v13 != 0))
        {
        ...
        v15 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
        if (v15)
        {
          v26 = v12;
          v16 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
          v29 = [(RFPrimaryHeaderMarqueeCardSection *)v6 text];
          v30 = v16;
        ...
        v17 = [(RFPrimaryHeaderMarqueeCardSection *)self thumbnail];
        v18 = [(RFPrimaryHeaderMarqueeCardSection *)v6 thumbnail];
        if ((v17 == 0) == (v18 != 0))
        {
        ...
        if (!v27
          || ([(RFPrimaryHeaderMarqueeCardSection *)self thumbnail],
              ...
              [(RFPrimaryHeaderMarqueeCardSection *)v6 thumbnail],
              v22 = objc_claimAutoreleasedReturnValue(),
              v23 = v19,
              objc_msgSend(v19, "isEqual:")))
        {
          unint64_t v3 = v28;
          BOOL v20 = [(RFPrimaryHeaderMarqueeCardSection *)self addTint];
          BOOL v11 = v20 ^ [(RFPrimaryHeaderMarqueeCardSection *)v6 addTint] ^ 1;
          if (!v27) {
            goto LABEL_27;
          }
        }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v5 = [(RFPrimaryHeaderMarqueeCardSection *)self text];
  v6 = (void *)[v5 copy];
  ...
  uint64_t v9 = [(RFPrimaryHeaderMarqueeCardSection *)self thumbnail];
  unint64_t v10 = (void *)[v9 copy];
  [v4 setThumbnail:v10];

  objc_msgSend(v4, "setAddTint:", -[RFPrimaryHeaderMarqueeCardSection addTint](self, "addTint"));
  return v4;
}
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFPrimaryHeaderMarqueeCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFPrimaryHeaderMarqueeCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFPrimaryHeaderMarqueeCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)RFPrimaryHeaderMarqueeCardSection;
...
- (RFPrimaryHeaderMarqueeCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(RFPrimaryHeaderMarqueeCardSection *)v5 setText_2:v10];

    BOOL v11 = [(SFCardSection *)v8 thumbnail];
    [(RFPrimaryHeaderMarqueeCardSection *)v5 setThumbnail:v11];
...
- (RFPrimaryHeaderMarqueeCardSection)initWithProtobuf:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)RFPrimaryHeaderMarqueeCardSection;
  ...
  if (v5)
  {
    ...
    if ([v4 addTint]) {
      -[RFPrimaryHeaderMarqueeCardSection setAddTint:](v5, "setAddTint:", [v4 addTint]);
    }
    v18 = v5;
  }
