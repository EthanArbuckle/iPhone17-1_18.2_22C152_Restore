...
- (SFWorldMapCardSection)initWithCoder:(id)a3;
- (SFWorldMapCardSection)initWithProtobuf:(id)a3;
...
- (SFWorldMapCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v36.receiver = self;
  v36.super_class = (Class)SFWorldMapCardSection;
  ...
  if (v5)
  {
    ...
    {
      v19 = [v4 type];
      [(SFWorldMapCardSection *)v5 setType:v19];
    }
    ...
    if (v28)
    {
      ...
      [(SFWorldMapCardSection *)v5 setHighlightedTimeZoneName:v29];
    }
    v30 = v5;
  }
  return v5;
...
{
  v23.receiver = self;
  v23.super_class = (Class)SFWorldMapCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFWorldMapCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFWorldMapCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
      v78.super_class = (Class)SFWorldMapCardSection;
...
LABEL_27:
            ...
            v31 = [(SFWorldMapCardSection *)self type];
            long long v32 = [(SFWorldMapCardSection *)v6 type];
            if ((v31 == 0) != (v32 != 0))
            {
              id v63 = v32;
              v76 = v31;
              long long v33 = [(SFWorldMapCardSection *)self type];
              if (v33)
              {
                v62 = [(SFWorldMapCardSection *)self type];
                v60 = [(SFWorldMapCardSection *)v6 type];
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                v41 = [(SFWorldMapCardSection *)self pinLocation];
                v42 = [(SFWorldMapCardSection *)v6 pinLocation];
                v43 = v42;
                if ((v41 == 0) == (v42 != 0))
                {
...
LABEL_65:
                ...
                v53 = [(SFWorldMapCardSection *)self pinLocation];
                if (!v53
                  || ([(SFWorldMapCardSection *)self pinLocation],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFWorldMapCardSection *)v6 pinLocation],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFWorldMapCardSection *)self highlightedTimeZoneName];
                  v45 = [(SFWorldMapCardSection *)v6 highlightedTimeZoneName];
                  v46 = v45;
                  if ((v50 == 0) == (v45 != 0))
                  {
                  ...
                  {
                    v49 = [(SFWorldMapCardSection *)self highlightedTimeZoneName];
                    if (v49)
                    {
                      v48 = [(SFWorldMapCardSection *)self highlightedTimeZoneName];
                      v47 = [(SFWorldMapCardSection *)v6 highlightedTimeZoneName];
...
{
  v20.receiver = self;
  v20.super_class = (Class)SFWorldMapCardSection;
  ...
  char v11 = [(SFWorldMapCardSection *)self type];
  ...
  uint64_t v15 = [(SFWorldMapCardSection *)self pinLocation];
  v16 = (void *)[v15 copy];
  [v4 setPinLocation:v16];

  uint64_t v17 = [(SFWorldMapCardSection *)self highlightedTimeZoneName];
  v18 = (void *)[v17 copy];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBWorldMapCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWorldMapCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBWorldMapCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFWorldMapCardSection;
...
- (SFWorldMapCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFWorldMapCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 pinLocation];
    [(SFWorldMapCardSection *)v5 setPinLocation:v14];

    uint64_t v15 = [(SFCardSection *)v8 highlightedTimeZoneName];
    [(SFWorldMapCardSection *)v5 setHighlightedTimeZoneName:v15];
