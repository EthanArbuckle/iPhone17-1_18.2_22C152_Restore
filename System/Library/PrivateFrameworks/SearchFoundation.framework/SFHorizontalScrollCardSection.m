...
- (unint64_t)hash
{
  ...
  unint64_t v20 = v19 ^ [(SFHorizontalScrollCardSection *)self numberOfRows];
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFHorizontalScrollCardSection *)a3;
  if (self == v5)
  {
    BOOL v11 = 1;
  }
...
LABEL_28:
            ...
            if ((v28 == 0) != (v29 != 0))
            {
              ...
              if ((v51 == 0) != (v32 != 0))
              {
                ...
                if (!v41
                  || ([(SFHorizontalScrollCardSection *)self cardSections],
                      v42 = objc_claimAutoreleasedReturnValue(),
                      [(SFHorizontalScrollCardSection *)v6 cardSections],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      v45 = v42,
                      objc_msgSend(v42, "isEqual:")))
                {
                  unint64_t v43 = [(SFHorizontalScrollCardSection *)self numberOfRows];
                  BOOL v11 = v43 == [(SFHorizontalScrollCardSection *)v6 numberOfRows];
                  if (!v41) {
                    goto LABEL_68;
                  }
                }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  BOOL v11 = [(SFHorizontalScrollCardSection *)self type];
  ...
  uint64_t v15 = [(SFHorizontalScrollCardSection *)self cardSections];
  v16 = (void *)[v15 copy];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBHorizontalScrollCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBHorizontalScrollCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBHorizontalScrollCardSection *)v2 dictionaryRepresentation];
    ...
    if (v27)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v28; ++j)
        {
          ...
          int v31 = [[SFCardSection alloc] initWithProtobuf:*(void *)(*((void *)&v34 + 1) + 8 * j)];
          if (v31) {
            [v25 addObject:v31];
          }
        }
