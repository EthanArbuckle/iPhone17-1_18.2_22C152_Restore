...
- (_SFPBShowSFCardCommand)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"card"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(_SFPBShowSFCardCommand *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_card)
  {
    id v4 = [(_SFPBShowSFCardCommand *)self card];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"card"];
    }
    else
    {
      v6 = [MEMORY[0x1E4F1CA98] null];
      [v3 setObject:v6 forKeyedSubscript:@"card"];
    }
  }
  return v3;
}
...
- (unint64_t)hash
{
  return [(_SFPBCard *)self->_card hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_SFPBShowSFCardCommand *)self card];
    v6 = [v4 card];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBShowSFCardCommand *)self card];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBShowSFCardCommand *)self card];
      v11 = [v4 card];
