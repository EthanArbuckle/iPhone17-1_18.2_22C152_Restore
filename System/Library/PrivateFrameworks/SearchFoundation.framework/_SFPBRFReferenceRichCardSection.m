...
- (_SFPBRFReferenceRichCardSection)initWithDictionary:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)_SFPBRFReferenceRichCardSection;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_addTint)
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBRFReferenceRichCardSection addTint](self, "addTint"));
...
- (BOOL)isEqual:(id)a3
{
  ...
  unint64_t v5 = [(_SFPBRFReferenceRichCardSection *)self text];
  uint64_t v6 = [v4 text];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_16;
  }
  uint64_t v7 = [(_SFPBRFReferenceRichCardSection *)self text];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v12 = [(_SFPBRFReferenceRichCardSection *)self text];
  if (v12)
  {
    v13 = (void *)v12;
  ...
  unint64_t v5 = [(_SFPBRFReferenceRichCardSection *)self thumbnail];
  uint64_t v6 = [v4 thumbnail];
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(_SFPBRFReferenceRichCardSection *)self thumbnail];
    if (!v17)
    {
...
{
  id v7 = a3;
  id v4 = [(_SFPBRFReferenceRichCardSection *)self text];
  if (v4) {
  ...
  uint64_t v6 = [(_SFPBRFReferenceRichCardSection *)self thumbnail];
  if (v6) {
    PBDataWriterWriteSubmessage();
  }
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFReferenceRichCardSectionReadFrom(self, (uint64_t)a3);
}
