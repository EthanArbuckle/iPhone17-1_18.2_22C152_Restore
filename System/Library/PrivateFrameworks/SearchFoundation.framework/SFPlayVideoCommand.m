...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(SFPlayVideoCommand *)v4 isMemberOfClass:objc_opt_class()] {
         && (v13.receiver = self,
  }
             ...
             [(SFCommand *)&v13 isEqual:v4]))
  {
    ...
    objc_super v7 = [(SFPlayVideoCommand *)v5 url];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(SFPlayVideoCommand *)self url];
  v6 = (void *)[v5 copy];
  [v4 setUrl:v6];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBPlayVideoCommand *)v2 jsonData];
...
{
  v2 = [[_SFPBPlayVideoCommand alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBPlayVideoCommand *)v2 dictionaryRepresentation];
...
{
  id v4 = a3;
  unint64_t v5 = [(SFPlayVideoCommand *)self init];
...
- (SFPlayVideoCommand)initWithProtobuf:(id)a3
{
  ...
  unint64_t v5 = [(SFPlayVideoCommand *)&v11 init];
  if (v5)
  {
    v6 = [v4 url];
    ...
    if (v6)
    {
      ...
      objc_super v8 = _SFPBURLHandwrittenTranslator(v7);
