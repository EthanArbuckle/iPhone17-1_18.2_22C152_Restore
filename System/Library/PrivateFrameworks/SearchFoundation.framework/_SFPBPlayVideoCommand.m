...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (_SFPBPlayVideoCommand)initWithDictionary:(id)a3;
- (_SFPBPlayVideoCommand)initWithFacade:(id)a3;
- (_SFPBPlayVideoCommand)initWithJSON:(id)a3;
- (_SFPBURL)url;
...
- (_SFPBPlayVideoCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBPlayVideoCommand;
...
- (NSData)jsonData
{
  v2 = [(_SFPBPlayVideoCommand *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_url)
  {
    id v4 = [(_SFPBPlayVideoCommand *)self url];
...
- (unint64_t)hash
{
  return [(_SFPBURL *)self->_url hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBPlayVideoCommand *)self url];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBPlayVideoCommand *)self url];
      v11 = [v4 url];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBPlayVideoCommandReadFrom(self, (uint64_t)a3);
}
