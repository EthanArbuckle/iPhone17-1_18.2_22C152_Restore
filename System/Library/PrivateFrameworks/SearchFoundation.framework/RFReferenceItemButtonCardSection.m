...
- (RFReferenceItemButtonCardSection)initWithProtobuf:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)RFReferenceItemButtonCardSection;
...
{
  v7.receiver = self;
  v7.super_class = (Class)RFReferenceItemButtonCardSection;
  unint64_t v3 = [(SFCardSection *)&v7 hash];
  id v4 = [(RFReferenceItemButtonCardSection *)self button];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (RFReferenceItemButtonCardSection *)a3;
  if (self == v4)
  {
    char v11 = 1;
  }
  else if ([(RFReferenceItemButtonCardSection *)v4 isMemberOfClass:objc_opt_class()] {
         && (v13.receiver = self,
  }
             v13.super_class = (Class)RFReferenceItemButtonCardSection,
             [(SFCardSection *)&v13 isEqual:v4]))
  {
    unint64_t v5 = v4;
    v6 = [(RFReferenceItemButtonCardSection *)self button];
    objc_super v7 = [(RFReferenceItemButtonCardSection *)v5 button];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
...
{
  v8.receiver = self;
  v8.super_class = (Class)RFReferenceItemButtonCardSection;
  id v4 = [(SFCardSection *)&v8 copyWithZone:a3];
  unint64_t v5 = [(RFReferenceItemButtonCardSection *)self button];
  v6 = (void *)[v5 copy];
  objc_msgSend(v4, "setButton_1:", v6);
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFReferenceItemButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFReferenceItemButtonCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFReferenceItemButtonCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)RFReferenceItemButtonCardSection;
