    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[_SFPBRFImageSource alloc] initWithFacade:*(void *)(*((void *)&v16 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
...
- (_SFPBRFImageElement)initWithDictionary:(id)a3
{
  ...
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)_SFPBRFImageElement;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = -[_SFPBRFImageSource initWithDictionary:](v13, "initWithDictionary:", v12, (void)v17);
...
- (unint64_t)hash
{
  return [(NSArray *)self->_sources hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    uint64_t v6 = [v4 sources];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBRFImageElement *)self sources];
      if (!v8)
      {
...
LABEL_10:
      ...
      uint64_t v9 = (void *)v8;
      uint64_t v10 = [(_SFPBRFImageElement *)self sources];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBRFImageElementReadFrom(self, (uint64_t)a3);
}

- (id)sourcesAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_sources objectAtIndexedSubscript:a3];
}
