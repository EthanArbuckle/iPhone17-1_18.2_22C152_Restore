...
- (SFFindMyCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      [(SFFindMyCardSection *)v5 setPerson:v9];
    }
    v10 = v5;
  }
...
- (unint64_t)hash
{
  ...
  id v4 = [(SFFindMyCardSection *)self person];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (SFFindMyCardSection *)a3;
  if (self == v4)
  {
    char v11 = 1;
  }
  else if ([(SFFindMyCardSection *)v4 isMemberOfClass:objc_opt_class()] {
         && (v13.receiver = self,
  }
  ...
  {
    unint64_t v5 = v4;
    v6 = [(SFFindMyCardSection *)self person];
    objc_super v7 = [(SFFindMyCardSection *)v5 person];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
    ...
    {
      v8 = [(SFFindMyCardSection *)self person];
      if (v8)
      {
        v9 = [(SFFindMyCardSection *)self person];
        v10 = [(SFFindMyCardSection *)v5 person];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(SFFindMyCardSection *)self person];
  v6 = (void *)[v5 copy];
  [v4 setPerson:v6];
...
- (NSData)jsonData
{
  v2 = [[_SFPBFindMyCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBFindMyCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBFindMyCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBFindMyCardSection *)v2 dictionaryRepresentation];
