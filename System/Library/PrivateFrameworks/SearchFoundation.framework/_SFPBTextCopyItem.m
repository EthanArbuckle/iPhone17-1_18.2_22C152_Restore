...
- (_SFPBTextCopyItem)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBTextCopyItem;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBTextCopyItem *)self copyableString];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSString *)self->_copyableString hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBTextCopyItem *)self copyableString];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBTextCopyItem *)self copyableString];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBTextCopyItemReadFrom(self, (uint64_t)a3);
}

- (void)setCopyableString:(id)a3
{
  self->_copyableString = (NSString *)[a3 copy];
  MEMORY[0x1F41817F8]();
}
