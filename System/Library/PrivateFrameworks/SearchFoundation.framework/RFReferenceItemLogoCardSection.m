@interface RFReferenceItemLogoCardSection
+ (BOOL)supportsSecureCoding;
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (NSDictionary)dictionaryRepresentation;
- (RFReferenceItemLogoCardSection)initWithCoder:(id)a3;
- (RFReferenceItemLogoCardSection)initWithProtobuf:(id)a3;
...
@implementation RFReferenceItemLogoCardSection

- (RFReferenceItemLogoCardSection)initWithProtobuf:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)RFReferenceItemLogoCardSection;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      [(RFReferenceItemLogoCardSection *)v5 setThumbnail:v9];
    }
    v10 = v5;
  }
...
{
  v7.receiver = self;
  v7.super_class = (Class)RFReferenceItemLogoCardSection;
  unint64_t v3 = [(SFCardSection *)&v7 hash];
  id v4 = [(RFReferenceItemLogoCardSection *)self thumbnail];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (RFReferenceItemLogoCardSection *)a3;
  if (self == v4)
  {
    char v11 = 1;
  }
  else if ([(RFReferenceItemLogoCardSection *)v4 isMemberOfClass:objc_opt_class()] {
         && (v13.receiver = self,
  }
             v13.super_class = (Class)RFReferenceItemLogoCardSection,
             [(SFCardSection *)&v13 isEqual:v4]))
  {
    unint64_t v5 = v4;
    v6 = [(RFReferenceItemLogoCardSection *)self thumbnail];
    objc_super v7 = [(RFReferenceItemLogoCardSection *)v5 thumbnail];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
    ...
    {
      v8 = [(RFReferenceItemLogoCardSection *)self thumbnail];
      if (v8)
      {
        v9 = [(RFReferenceItemLogoCardSection *)self thumbnail];
        v10 = [(RFReferenceItemLogoCardSection *)v5 thumbnail];
...
{
  v8.receiver = self;
  v8.super_class = (Class)RFReferenceItemLogoCardSection;
  id v4 = [(SFCardSection *)&v8 copyWithZone:a3];
  unint64_t v5 = [(RFReferenceItemLogoCardSection *)self thumbnail];
  v6 = (void *)[v5 copy];
  [v4 setThumbnail:v6];
...
- (NSData)jsonData
{
  v2 = [[_SFPBRFReferenceItemLogoCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFReferenceItemLogoCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFReferenceItemLogoCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFReferenceItemLogoCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)RFReferenceItemLogoCardSection;
