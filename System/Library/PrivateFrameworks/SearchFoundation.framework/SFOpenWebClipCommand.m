...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(SFOpenWebClipCommand *)v4 isMemberOfClass:objc_opt_class()] {
         && (v13.receiver = self,
  }
             ...
             [(SFCommand *)&v13 isEqual:v4]))
  {
    ...
    objc_super v7 = [(SFOpenWebClipCommand *)v5 clipIdentifier];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(SFOpenWebClipCommand *)self clipIdentifier];
  v6 = (void *)[v5 copy];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBOpenWebClipCommand *)v2 jsonData];
...
{
  v2 = [[_SFPBOpenWebClipCommand alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBOpenWebClipCommand *)v2 dictionaryRepresentation];
...
{
  id v4 = a3;
  unint64_t v5 = [(SFOpenWebClipCommand *)self init];
...
- (SFOpenWebClipCommand)initWithProtobuf:(id)a3
{
  ...
  unint64_t v5 = [(SFOpenWebClipCommand *)&v10 init];
  if (v5)
  {
