@interface SFCombinedCardSection
...
- (NSString)type;
- (SFCombinedCardSection)initWithCoder:(id)a3;
- (SFCombinedCardSection)initWithProtobuf:(id)a3;
...
@implementation SFCombinedCardSection
...
{
  v21.receiver = self;
  v21.super_class = (Class)SFCombinedCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFCombinedCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFCombinedCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = (Class)SFCombinedCardSection;
...
LABEL_47:
            ...
            v28 = [(SFCombinedCardSection *)self type];
            v29 = [(SFCombinedCardSection *)v6 type];
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              uint64_t v51 = [(SFCombinedCardSection *)self type];
              v52 = v28;
              if (v51)
              {
                v30 = [(SFCombinedCardSection *)self type];
                v49 = [(SFCombinedCardSection *)v6 type];
                v50 = v30;
              ...
              if (v33 == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                  ...
                  {
                    v38 = [(SFCombinedCardSection *)self cardSections];
                    v39 = [(SFCombinedCardSection *)v6 cardSections];
                    v40 = v39;
                    if ((v38 == 0) == (v39 != 0))
                    {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFCombinedCardSection *)self cardSections];
                      if (v41)
                      {
                        v42 = (void *)v41;
                        v43 = [(SFCombinedCardSection *)self cardSections];
                        v44 = [(SFCombinedCardSection *)v6 cardSections];
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFCombinedCardSection;
  ...
  char v11 = [(SFCombinedCardSection *)self type];
  ...
  uint64_t v15 = [(SFCombinedCardSection *)self cardSections];
  v16 = (void *)[v15 copy];
...
- (NSData)jsonData
{
  v2 = [[_SFPBCombinedCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBCombinedCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBCombinedCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBCombinedCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFCombinedCardSection;
...
- (SFCombinedCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFCombinedCardSection *)v5 setType:v12];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    v13 = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:v13];

    uint64_t v14 = [(SFCardSection *)v8 cardSections];
    [(SFCombinedCardSection *)v5 setCardSections:v14];
...
- (SFCombinedCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v42.receiver = self;
  v42.super_class = (Class)SFCombinedCardSection;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      [(SFCombinedCardSection *)v5 setType:v19];
    }
    ...
    long long v34 = 0u;
    long long v35 = 0u;
    BOOL v26 = objc_msgSend(v4, "cardSections", 0);
    ...
    [(SFCombinedCardSection *)v5 setCardSections:v25];
    v32 = v5;
  }
  return v5;
}
