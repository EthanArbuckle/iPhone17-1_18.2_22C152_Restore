@interface SFMapsDetailedRowCardSection
...
- (NSString)pinText;
- (NSString)type;
- (SFDetailedRowCardSection)internalDetailedRowCardSection;
- (SFMapsDetailedRowCardSection)initWithCoder:(id)a3;
- (SFMapsDetailedRowCardSection)initWithProtobuf:(id)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (unint64_t)hash;
- (void)encodeWithCoder:(id)a3;
- (void)setInternalDetailedRowCardSection:(id)a3;
- (void)setMapsData:(id)a3;
- (void)setPinText:(id)a3;
- (void)setType:(id)a3;
@end

@implementation SFMapsDetailedRowCardSection

- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_internalDetailedRowCardSection, 0);
...
- (SFDetailedRowCardSection)internalDetailedRowCardSection
{
  return self->_internalDetailedRowCardSection;
}
...
{
  v23.receiver = self;
  v23.super_class = (Class)SFMapsDetailedRowCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFMapsDetailedRowCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFMapsDetailedRowCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
      v78.super_class = (Class)SFMapsDetailedRowCardSection;
...
LABEL_27:
            ...
            v31 = [(SFMapsDetailedRowCardSection *)self type];
            v32 = [(SFMapsDetailedRowCardSection *)v6 type];
            if ((v31 == 0) != (v32 != 0))
            {
              id v63 = v32;
              v76 = v31;
              v33 = [(SFMapsDetailedRowCardSection *)self type];
              if (v33)
              {
                v62 = [(SFMapsDetailedRowCardSection *)self type];
                v60 = [(SFMapsDetailedRowCardSection *)v6 type];
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                v41 = [(SFMapsDetailedRowCardSection *)self mapsData];
                v42 = [(SFMapsDetailedRowCardSection *)v6 mapsData];
                v43 = v42;
                if ((v41 == 0) == (v42 != 0))
                {
...
LABEL_65:
                ...
                v53 = [(SFMapsDetailedRowCardSection *)self mapsData];
                if (!v53
                  || ([(SFMapsDetailedRowCardSection *)self mapsData],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFMapsDetailedRowCardSection *)v6 mapsData],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFMapsDetailedRowCardSection *)self pinText];
                  v45 = [(SFMapsDetailedRowCardSection *)v6 pinText];
                  v46 = v45;
                  if ((v50 == 0) == (v45 != 0))
                  {
                  ...
                  {
                    v49 = [(SFMapsDetailedRowCardSection *)self pinText];
                    if (v49)
                    {
                      v48 = [(SFMapsDetailedRowCardSection *)self pinText];
                      v47 = [(SFMapsDetailedRowCardSection *)v6 pinText];
...
{
  v20.receiver = self;
  v20.super_class = (Class)SFMapsDetailedRowCardSection;
  ...
  char v11 = [(SFMapsDetailedRowCardSection *)self type];
  ...
  uint64_t v15 = [(SFMapsDetailedRowCardSection *)self mapsData];
  v16 = (void *)[v15 copy];
  [v4 setMapsData:v16];

  uint64_t v17 = [(SFMapsDetailedRowCardSection *)self pinText];
  v18 = (void *)[v17 copy];
  [v4 setPinText:v18];
...
- (NSData)jsonData
{
  v2 = [[_SFPBMapsDetailedRowCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBMapsDetailedRowCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMapsDetailedRowCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBMapsDetailedRowCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFMapsDetailedRowCardSection;
...
- (SFMapsDetailedRowCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFMapsDetailedRowCardSection *)v5 setType:v12];
    ...
    [(SFMapsDetailedRowCardSection *)v5 setMapsData:v14];

    uint64_t v15 = [(SFCardSection *)v8 pinText];
    [(SFMapsDetailedRowCardSection *)v5 setPinText:v15];
...
- (SFMapsDetailedRowCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v34.receiver = self;
  v34.super_class = (Class)SFMapsDetailedRowCardSection;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      [(SFMapsDetailedRowCardSection *)v5 setType:v19];
    }
    ...
    {
      v25 = [v4 mapsData];
      [(SFMapsDetailedRowCardSection *)v5 setMapsData:v25];
    }
    int v26 = [v4 pinText];
    ...
    {
      v27 = [v4 pinText];
      [(SFMapsDetailedRowCardSection *)v5 setPinText:v27];
    }
    BOOL v28 = v5;
  }
  return v5;
