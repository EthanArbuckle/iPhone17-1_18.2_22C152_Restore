...
- (BOOL)isEqual:(id)a3
{
  id v4 = (SFViewEmailCommand *)a3;
  if (self == v4)
  {
    char v8 = 1;
  }
  else if ([(SFViewEmailCommand *)v4 isMemberOfClass:objc_opt_class()] {
         && (v10.receiver = self,
  }
  ...
  {
    objc_super v5 = v4;
    BOOL v6 = [(SFViewEmailCommand *)self placeHolderProperty];
    BOOL v7 = [(SFViewEmailCommand *)v5 placeHolderProperty];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBViewEmailCommand *)v2 jsonData];
...
{
  v2 = [[_SFPBViewEmailCommand alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBViewEmailCommand *)v2 dictionaryRepresentation];
...
{
  id v4 = a3;
  objc_super v5 = [(SFViewEmailCommand *)self init];
