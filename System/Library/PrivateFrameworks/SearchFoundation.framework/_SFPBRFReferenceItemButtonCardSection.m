...
- (id)dictionaryRepresentation
{
  ...
  if (self->_button_1)
  {
    id v4 = [(_SFPBRFReferenceItemButtonCardSection *)self button];
...
- (unint64_t)hash
{
  return [(_SFPBButtonItem *)self->_button_1 hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBRFReferenceItemButtonCardSection *)self button];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBRFReferenceItemButtonCardSection *)self button];
      v11 = [v4 button];
