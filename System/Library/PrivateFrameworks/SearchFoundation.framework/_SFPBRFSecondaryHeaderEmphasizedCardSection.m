...
- (id)dictionaryRepresentation
{
  ...
  if (self->_text_1)
  {
    id v4 = [(_SFPBRFSecondaryHeaderEmphasizedCardSection *)self text];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBRFSecondaryHeaderEmphasizedCardSection *)self text];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBRFSecondaryHeaderEmphasizedCardSection *)self text];
      v11 = [v4 text];
