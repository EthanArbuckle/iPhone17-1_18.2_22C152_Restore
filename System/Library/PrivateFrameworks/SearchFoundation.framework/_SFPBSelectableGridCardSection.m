    ...
    if (v27)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v28; ++j)
        {
          ...
          v31 = [[_SFPBTitleSubtitleTuple alloc] initWithFacade:*(void *)(*((void *)&v36 + 1) + 8 * j)];
          if (v31) {
            [v25 addObject:v31];
          }
        }
...
- (_SFPBSelectableGridCardSection)initWithDictionary:(id)a3
{
  ...
  v5 = [(_SFPBSelectableGridCardSection *)&v55 init];
  if (v5)
  {
    ...
    uint64_t v28 = [v4 objectForKeyedSubscript:@"entries"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      long long v39 = v20;
    ...
    long long v36 = [v4 objectForKeyedSubscript:@"initialSelectedIndex"];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBSelectableGridCardSection *)self backgroundColor];
  ...
  {
    uint64_t v7 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBSelectableGridCardSection canBeHidden](self, "canBeHidden"));
    ...
    if (v10)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          v14 = [*(id *)(*((void *)&v40 + 1) + 8 * i) dictionaryRepresentation];
          if (v14)
          {
            [v8 addObject:v14];
          }
  ...
  {
    v16 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBSelectableGridCardSection hasBottomPadding](self, "hasBottomPadding"));
    [v3 setObject:v16 forKeyedSubscript:@"hasBottomPadding"];
  }
  if (self->_hasTopPadding)
  {
    v17 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBSelectableGridCardSection hasTopPadding](self, "hasTopPadding"));
    [v3 setObject:v17 forKeyedSubscript:@"hasTopPadding"];
  }
  if (self->_initialSelectedIndex)
  {
    v18 = objc_msgSend(NSNumber, "numberWithInt:", -[_SFPBSelectableGridCardSection initialSelectedIndex](self, "initialSelectedIndex"));
  ...
  {
    uint64_t v27 = [(_SFPBSelectableGridCardSection *)self punchoutPickerDismissText];
    uint64_t v28 = (void *)[v27 copy];
    [v3 setObject:v28 forKeyedSubscript:@"punchoutPickerDismissText"];
  }
  if (self->_punchoutPickerTitle)
  {
    id v29 = [(_SFPBSelectableGridCardSection *)self punchoutPickerTitle];
    uint64_t v30 = (void *)[v29 copy];
    [v3 setObject:v30 forKeyedSubscript:@"punchoutPickerTitle"];
  }
  if (self->_separatorStyle)
  {
    uint64_t v31 = [(_SFPBSelectableGridCardSection *)self separatorStyle];
    if (v31 >= 6)
    {
...
- (unint64_t)hash
{
  ...
  return v3 ^ v12 ^ v4 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10 ^ [(NSArray *)self->_entries hash] ^ (2654435761
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v5 = [(_SFPBSelectableGridCardSection *)self punchoutOptions];
  uint64_t v6 = [v4 punchoutOptions];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_35;
  }
  uint64_t v7 = [(_SFPBSelectableGridCardSection *)self punchoutOptions];
  if (v7)
  {
    NSUInteger v8 = (void *)v7;
    uint64_t v9 = [(_SFPBSelectableGridCardSection *)self punchoutOptions];
  ...
  uint64_t v5 = [(_SFPBSelectableGridCardSection *)self punchoutPickerTitle];
  uint64_t v6 = [v4 punchoutPickerTitle];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_35;
  }
  uint64_t v12 = [(_SFPBSelectableGridCardSection *)self punchoutPickerTitle];
  if (v12)
  {
  ...
  uint64_t v5 = [(_SFPBSelectableGridCardSection *)self punchoutPickerDismissText];
  uint64_t v6 = [v4 punchoutPickerDismissText];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_35;
  }
  uint64_t v17 = [(_SFPBSelectableGridCardSection *)self punchoutPickerDismissText];
  if (v17)
  {
    v18 = (void *)v17;
  ...
  uint64_t v5 = [(_SFPBSelectableGridCardSection *)self type];
  uint64_t v6 = [v4 type];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_35;
  }
  uint64_t v25 = [(_SFPBSelectableGridCardSection *)self type];
  if (v25)
  {
    uint64_t v26 = (void *)v25;
    uint64_t v27 = [(_SFPBSelectableGridCardSection *)self type];
  ...
  uint64_t v5 = [(_SFPBSelectableGridCardSection *)self backgroundColor];
  uint64_t v6 = [v4 backgroundColor];
  if ((v5 == 0) == (v6 != 0)) {
    goto LABEL_35;
  }
  uint64_t v31 = [(_SFPBSelectableGridCardSection *)self backgroundColor];
  if (v31)
  {
  ...
  uint64_t v5 = [(_SFPBSelectableGridCardSection *)self entries];
...
LABEL_35:
  ...
  uint64_t v36 = [(_SFPBSelectableGridCardSection *)self entries];
  if (!v36)
  {

LABEL_39:
    int initialSelectedIndex = self->_initialSelectedIndex;
    BOOL v41 = initialSelectedIndex == [v4 initialSelectedIndex];
    goto LABEL_37;
  }
  long long v37 = (void *)v36;
  long long v38 = [(_SFPBSelectableGridCardSection *)self entries];
  long long v39 = [v4 entries];
...
- (void)writeTo:(id)a3
{
  ...
  unint64_t v10 = [(_SFPBSelectableGridCardSection *)self punchoutPickerTitle];
  if (v10) {
    PBDataWriterWriteStringField();
  }

  int v11 = [(_SFPBSelectableGridCardSection *)self punchoutPickerDismissText];
  if (v11) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v12 = [(_SFPBSelectableGridCardSection *)self type];
  if (v12) {
    PBDataWriterWriteStringField();
  }
  ...
  uint64_t v13 = [(_SFPBSelectableGridCardSection *)self backgroundColor];
  if (v13) {
    PBDataWriterWriteSubmessage();
  }

  v14 = [(_SFPBSelectableGridCardSection *)self entries];
  long long v19 = 0u;
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
...
- (void)setInitialSelectedIndex:(int)a3
{
  self->_int initialSelectedIndex = a3;
}

- (id)entriesAtIndex:(unint64_t)a3
{
  return [(NSArray *)self->_entries objectAtIndexedSubscript:a3];
}
