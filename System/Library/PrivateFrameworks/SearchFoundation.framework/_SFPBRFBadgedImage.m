...
- (id)dictionaryRepresentation
{
  ...
  if (self->_badge)
  {
    id v4 = [(_SFPBRFBadgedImage *)self badge];
  ...
  if (self->_image)
  {
    uint64_t v7 = [(_SFPBRFBadgedImage *)self image];
...
- (unint64_t)hash
{
  unint64_t v3 = [(_SFPBRFImageSource *)self->_image hash];
  return [(_SFPBRFImageSource *)self->_badge hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_SFPBRFBadgedImage *)self badge];
    if (!v12)
    {
...
{
  id v6 = a3;
  id v4 = [(_SFPBRFBadgedImage *)self image];
  if (v4) {
