...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBIndexedUserActivityCommand *)self applicationBundleIdentifier];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  NSUInteger v3 = [(NSString *)self->_userActivityRequiredString hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_SFPBIndexedUserActivityCommand *)self userActivityRequiredString];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v12 = [(_SFPBIndexedUserActivityCommand *)self applicationBundleIdentifier];
    if (!v12)
    {
...
{
  id v6 = a3;
  id v4 = [(_SFPBIndexedUserActivityCommand *)self userActivityRequiredString];
  if (v4) {
...
- (void)setUserActivityRequiredString:(id)a3
{
  self->_userActivityRequiredString = (NSString *)[a3 copy];
  MEMORY[0x1F41817F8]();
}
