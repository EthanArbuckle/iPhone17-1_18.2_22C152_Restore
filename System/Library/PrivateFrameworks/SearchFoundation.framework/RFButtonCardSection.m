...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(RFButtonCardSection *)v4 isMemberOfClass:objc_opt_class()] {
         && (v13.receiver = self,
  }
             ...
             [(SFCardSection *)&v13 isEqual:v4]))
  {
    ...
    objc_super v7 = [(RFButtonCardSection *)v5 button];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(RFButtonCardSection *)self button];
  v6 = (void *)[v5 copy];
  [v4 setButton:v6];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFButtonCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFButtonCardSection *)v2 dictionaryRepresentation];
...
- (RFButtonCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      objc_super v7 = [SFButtonItem alloc];
      objc_super v8 = [v4 button];
