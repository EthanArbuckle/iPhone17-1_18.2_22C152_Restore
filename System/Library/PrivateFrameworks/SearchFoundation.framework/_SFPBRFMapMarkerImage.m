...
- (id)dictionaryRepresentation
{
  ...
  if (self->_coordinate)
  {
    id v4 = [(_SFPBRFMapMarkerImage *)self coordinate];
  ...
  {
    uint64_t v7 = [(_SFPBRFMapMarkerImage *)self systemImage];
    v8 = (void *)[v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  uint64_t v7 = [(_SFPBRFMapMarkerImage *)self coordinate];
  if (v7)
  {
    v8 = (void *)v7;
  ...
  uint64_t v12 = [(_SFPBRFMapMarkerImage *)self title];
  if (v12)
  {
    v13 = (void *)v12;
    objc_super v14 = [(_SFPBRFMapMarkerImage *)self title];
    v15 = [v4 title];
  ...
  if ((v5 == 0) != (v6 != 0))
  {
    uint64_t v17 = [(_SFPBRFMapMarkerImage *)self systemImage];
    if (!v17)
    {
...
- (void)setSystemImage:(id)a3
{
  self->_systemImage = (NSString *)[a3 copy];
  MEMORY[0x1F41817F8]();
}
