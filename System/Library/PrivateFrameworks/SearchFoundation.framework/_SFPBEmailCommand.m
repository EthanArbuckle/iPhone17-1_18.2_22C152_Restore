...
- (_SFPBEmailCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBEmailCommand;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_email)
  {
    id v4 = [(_SFPBEmailCommand *)self email];
    v5 = (void *)[v4 copy];
...
- (unint64_t)hash
{
  return [(NSString *)self->_email hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBEmailCommand *)self email];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBEmailCommand *)self email];
      v11 = [v4 email];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBEmailCommandReadFrom(self, (uint64_t)a3);
}
