...
- (SFButtonCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v38.receiver = self;
  v38.super_class = (Class)SFButtonCardSection;
  v5 = [(SFCardSection *)&v38 init];
  if (v5)
  {
...
{
  v23.receiver = self;
  v23.super_class = (Class)SFButtonCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFButtonCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  else
  {
    ...
    {
      v78.receiver = self;
      v78.super_class = (Class)SFButtonCardSection;
...
LABEL_27:
            ...
            if ((v31 == 0) != (v32 != 0))
            {
              ...
              long long v36 = [(SFCardSection *)v6 backgroundColor];
              if ((v35 == 0) != (v36 != 0))
              {
                v59 = v36;
                v57 = v9;
                ...
                v56 = v13;
                long long v37 = v12;
                objc_super v38 = [(SFCardSection *)self backgroundColor];
                if (v38)
                {
...
LABEL_65:
                ...
                if (!v53
                  || ([(SFButtonCardSection *)self title],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFButtonCardSection *)v6 title],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFButtonCardSection *)self thumbnail];
...
{
  v20.receiver = self;
  v20.super_class = (Class)SFButtonCardSection;
  ...
  char v11 = [(SFButtonCardSection *)self type];
  ...
  uint64_t v15 = [(SFButtonCardSection *)self title];
  v16 = (void *)[v15 copy];
  [v4 setTitle:v16];

  uint64_t v17 = [(SFButtonCardSection *)self thumbnail];
  v18 = (void *)[v17 copy];
  [v4 setThumbnail:v18];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBButtonCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBButtonCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFButtonCardSection;
...
- (SFButtonCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    long long v36 = [(SFCardSection *)v8 secondaryCommand];
