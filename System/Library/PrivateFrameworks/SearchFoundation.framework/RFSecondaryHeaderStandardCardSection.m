@interface RFSecondaryHeaderStandardCardSection
+ (BOOL)supportsSecureCoding;
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (NSDictionary)dictionaryRepresentation;
- (RFSecondaryHeaderStandardCardSection)initWithCoder:(id)a3;
- (RFSecondaryHeaderStandardCardSection)initWithProtobuf:(id)a3;
...
@implementation RFSecondaryHeaderStandardCardSection
...
{
  v7.receiver = self;
  v7.super_class = (Class)RFSecondaryHeaderStandardCardSection;
  unint64_t v3 = [(SFCardSection *)&v7 hash];
  v4 = [(RFSecondaryHeaderStandardCardSection *)self text];
...
- (BOOL)isEqual:(id)a3
{
  v4 = (RFSecondaryHeaderStandardCardSection *)a3;
  if (self == v4)
  {
    char v11 = 1;
  }
  else if ([(RFSecondaryHeaderStandardCardSection *)v4 isMemberOfClass:objc_opt_class()]&& (v13.receiver = self, v13.super_class = (Class)RFSecondaryHeaderStandardCardSection, [(SFCardSection *)&v13 isEqual:v4]))
  {
    unint64_t v5 = v4;
    v6 = [(RFSecondaryHeaderStandardCardSection *)self text];
    objc_super v7 = [(RFSecondaryHeaderStandardCardSection *)v5 text];
    if ((v6 == 0) == (v7 != 0))
    {
      char v11 = 0;
    }
    ...
    {
      v8 = [(RFSecondaryHeaderStandardCardSection *)self text];
      if (v8)
      {
        v9 = [(RFSecondaryHeaderStandardCardSection *)self text];
        v10 = [(RFSecondaryHeaderStandardCardSection *)v5 text];
...
{
  v8.receiver = self;
  v8.super_class = (Class)RFSecondaryHeaderStandardCardSection;
  id v4 = [(SFCardSection *)&v8 copyWithZone:a3];
  unint64_t v5 = [(RFSecondaryHeaderStandardCardSection *)self text];
  v6 = (void *)[v5 copy];
...
- (NSData)jsonData
{
  v2 = [[_SFPBRFSecondaryHeaderStandardCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFSecondaryHeaderStandardCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSecondaryHeaderStandardCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFSecondaryHeaderStandardCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)RFSecondaryHeaderStandardCardSection;
...
- (RFSecondaryHeaderStandardCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(RFSecondaryHeaderStandardCardSection *)v5 setText_1:v9];
...
- (RFSecondaryHeaderStandardCardSection)initWithProtobuf:(id)a3
{
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)RFSecondaryHeaderStandardCardSection;
