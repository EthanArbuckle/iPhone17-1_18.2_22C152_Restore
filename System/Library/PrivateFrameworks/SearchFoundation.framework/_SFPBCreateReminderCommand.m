...
- (_SFPBCreateReminderCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBCreateReminderCommand;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_reminder)
  {
    id v4 = [(_SFPBCreateReminderCommand *)self reminder];
...
- (unint64_t)hash
{
  return [(_SFPBReminder *)self->_reminder hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBCreateReminderCommand *)self reminder];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBCreateReminderCommand *)self reminder];
      v11 = [v4 reminder];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBCreateReminderCommandReadFrom(self, (uint64_t)a3);
}
