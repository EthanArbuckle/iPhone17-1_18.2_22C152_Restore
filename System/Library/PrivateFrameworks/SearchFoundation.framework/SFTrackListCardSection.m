...
{
  v25.receiver = self;
  v25.super_class = (Class)SFTrackListCardSection;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v67.receiver = self;
      v67.super_class = (Class)SFTrackListCardSection;
...
LABEL_24:
                    ...
                    {
                      v37 = [(SFTrackListCardSection *)self tracks];
                      v36 = [(SFTrackListCardSection *)v5 tracks];
                      if ((v37 == 0) == (v36 != 0))
                      {
...
{
  v22.receiver = self;
  v22.super_class = (Class)SFTrackListCardSection;
  ...
  uint64_t v19 = [(SFTrackListCardSection *)self tracks];
  v20 = (void *)[v19 copy];
  [v4 setTracks:v20];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBTrackListCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBTrackListCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBTrackListCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFTrackListCardSection;
...
- (SFTrackListCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v46.receiver = self;
  v46.super_class = (Class)SFTrackListCardSection;
    ...
    if (v31)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v32; ++j)
        {
          ...
          v35 = [[SFTrack alloc] initWithProtobuf:*(void *)(*((void *)&v38 + 1) + 8 * j)];
          if (v35) {
            [v29 addObject:v35];
          }
        }
