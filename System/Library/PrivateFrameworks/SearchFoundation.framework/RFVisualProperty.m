    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          v13 = [[RFVisualElement alloc] initWithProtobuf:*(void *)(*((void *)&v16 + 1) + 8 * i)];
          if (v13) {
            [v7 addObject:v13];
          }
        }
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [v3 hash];
  unint64_t v5 = v4 ^ [(RFVisualProperty *)self is_safe_for_logging];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    if ([(RFVisualProperty *)v6 isMemberOfClass:objc_opt_class()])
    {
      ...
      uint64_t v9 = [(RFVisualProperty *)v7 visual_elements];
      if ((v8 == 0) == (v9 != 0))
      {
        LOBYTE(v11) = 0;
LABEL_13:
      ...
      uint64_t v10 = [(RFVisualProperty *)self visual_elements];
      if (!v10
        || ([(RFVisualProperty *)self visual_elements],
            v3 = objc_claimAutoreleasedReturnValue(),
            [(RFVisualProperty *)v7 visual_elements],
            uint64_t v4 = objc_claimAutoreleasedReturnValue(),
            [v3 isEqual:v4]))
      {
        BOOL v12 = [(RFVisualProperty *)self is_safe_for_logging];
        BOOL v11 = v12 ^ [(RFVisualProperty *)v7 is_safe_for_logging] ^ 1;
        if (!v10)
        {
LABEL_12:
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(RFVisualProperty *)self visual_elements];
  v6 = (void *)[v5 copy];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  unint64_t v5 = [(_SFPBRFVisualProperty *)v6 data];
...
- (RFVisualProperty)initWithCoder:(id)a3
{
  ...
  id v7 = [(RFVisualProperty *)self initWithProtobuf:v6];
