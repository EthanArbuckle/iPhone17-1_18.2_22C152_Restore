...
- (_SFPBExpandInlineCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)_SFPBExpandInlineCommand;
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(NSNumber, "numberWithBool:", -[_SFPBExpandInlineCommand placeHolderProperty](self, "placeHolderProperty"));
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBExpandInlineCommandReadFrom(self, (uint64_t)a3);
}
