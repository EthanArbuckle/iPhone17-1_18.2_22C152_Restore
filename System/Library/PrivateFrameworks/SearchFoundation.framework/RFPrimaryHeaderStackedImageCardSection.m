...
- (unint64_t)hash
{
  ...
  v4 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
  uint64_t v5 = [v4 hash];
  v6 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
  uint64_t v7 = v5 ^ [v6 hash];
  v8 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (RFPrimaryHeaderStackedImageCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(RFPrimaryHeaderStackedImageCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v32.receiver = self;
      ...
      {
        v6 = v5;
        uint64_t v7 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
        v8 = [(RFPrimaryHeaderStackedImageCardSection *)v6 text];
        if ((v7 == 0) == (v8 != 0))
        {
          char v11 = 0;
LABEL_31:
        ...
        unint64_t v9 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
        if (v9)
        {
          unint64_t v3 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
          v10 = [(RFPrimaryHeaderStackedImageCardSection *)v6 text];
          if (![v3 isEqual:v10])
          {
            char v11 = 0;
            goto LABEL_29;
        ...
        v12 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
        v13 = [(RFPrimaryHeaderStackedImageCardSection *)v6 text];
        v14 = v13;
        if ((v12 == 0) == (v13 != 0))
        {
        ...
        v15 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
        if (v15)
        {
          v25 = v12;
          v16 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
          v27 = [(RFPrimaryHeaderStackedImageCardSection *)v6 text];
          v28 = v16;
        ...
        v17 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
        v18 = [(RFPrimaryHeaderStackedImageCardSection *)v6 images];
        if ((v17 == 0) == (v18 != 0))
        {
        ...
        else
        {
          v24 = v17;
          v26 = v18;
          uint64_t v19 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
          v15 = v29;
          if (v19)
          {
            v23 = (void *)v19;
            v22 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
            v20 = [(RFPrimaryHeaderStackedImageCardSection *)v6 images];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v5 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
  v6 = (void *)[v5 copy];
  ...
  unint64_t v9 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
  v10 = (void *)[v9 copy];
  [v4 setImages:v10];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFPrimaryHeaderStackedImageCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFPrimaryHeaderStackedImageCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFPrimaryHeaderStackedImageCardSection *)v2 dictionaryRepresentation];
...
- (RFPrimaryHeaderStackedImageCardSection)initWithCoder:(id)a3
{
  ...
  {
    unint64_t v9 = [(SFCardSection *)v8 text];
    [(RFPrimaryHeaderStackedImageCardSection *)v5 setText_1:v9];

    v10 = [(SFCardSection *)v8 text];
    [(RFPrimaryHeaderStackedImageCardSection *)v5 setText_2:v10];

    char v11 = [(SFCardSection *)v8 images];
    [(RFPrimaryHeaderStackedImageCardSection *)v5 setImages:v11];
    ...
    if (v17)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v18; ++i)
        {
          ...
          v21 = [[RFVisualProperty alloc] initWithProtobuf:*(void *)(*((void *)&v24 + 1) + 8 * i)];
          if (v21) {
            [v15 addObject:v21];
          }
        }
