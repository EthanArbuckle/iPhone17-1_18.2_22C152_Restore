...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBCommandReference *)self referenceIdentifier];
    v5 = (void *)[v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBCommandReference *)self referenceIdentifier];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBCommandReference *)self referenceIdentifier];
