...
- (NSString)type;
- (SFRichText)text;
- (SFSectionHeaderCardSection)initWithCoder:(id)a3;
- (SFSectionHeaderCardSection)initWithProtobuf:(id)a3;
...
- (SFSectionHeaderCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v34.receiver = self;
  v34.super_class = (Class)SFSectionHeaderCardSection;
  ...
  if (v5)
  {
    ...
    {
      v19 = [v4 type];
      [(SFSectionHeaderCardSection *)v5 setType:v19];
    }
...
{
  v21.receiver = self;
  v21.super_class = (Class)SFSectionHeaderCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFSectionHeaderCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFSectionHeaderCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = (Class)SFSectionHeaderCardSection;
...
LABEL_47:
            ...
            v28 = [(SFSectionHeaderCardSection *)self type];
            v29 = [(SFSectionHeaderCardSection *)v6 type];
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              uint64_t v51 = [(SFSectionHeaderCardSection *)self type];
              v52 = v28;
              if (v51)
              {
                long long v30 = [(SFSectionHeaderCardSection *)self type];
                v49 = [(SFSectionHeaderCardSection *)v6 type];
                v50 = v30;
              ...
              {
                objc_super v34 = [(SFCardSection *)self backgroundColor];
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                  ...
                  {
                    v38 = [(SFSectionHeaderCardSection *)self text];
                    v39 = [(SFSectionHeaderCardSection *)v6 text];
                    v40 = v39;
                    if ((v38 == 0) == (v39 != 0))
                    {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFSectionHeaderCardSection *)self text];
                      if (v41)
                      {
                        v42 = (void *)v41;
                        v43 = [(SFSectionHeaderCardSection *)self text];
                        v44 = [(SFSectionHeaderCardSection *)v6 text];
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFSectionHeaderCardSection;
  ...
  char v11 = [(SFSectionHeaderCardSection *)self type];
  ...
  uint64_t v15 = [(SFSectionHeaderCardSection *)self text];
  v16 = (void *)[v15 copy];
  [v4 setText:v16];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBSectionHeaderCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBSectionHeaderCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBSectionHeaderCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFSectionHeaderCardSection;
...
- (SFSectionHeaderCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFSectionHeaderCardSection *)v5 setType:v12];
    ...
    [(SFSectionHeaderCardSection *)v5 setText:v14];
