...
- (NSString)type;
- (SFGridCardSection)initWithCoder:(id)a3;
- (SFGridCardSection)initWithProtobuf:(id)a3;
...
{
  v21.receiver = self;
  v21.super_class = (Class)SFGridCardSection;
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFGridCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFGridCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v70.receiver = self;
      v70.super_class = (Class)SFGridCardSection;
...
LABEL_47:
            ...
            v28 = [(SFGridCardSection *)self type];
            v29 = [(SFGridCardSection *)v6 type];
            if ((v28 == 0) != (v29 != 0))
            {
              v53 = v29;
              uint64_t v51 = [(SFGridCardSection *)self type];
              v52 = v28;
              if (v51)
              {
                v30 = [(SFGridCardSection *)self type];
                v49 = [(SFGridCardSection *)v6 type];
                v50 = v30;
              ...
              if (v33 == [(SFCardSection *)v6 separatorStyle])
              {
                ...
                if ((v34 == 0) != (v35 != 0))
                {
                  ...
                  {
                    v38 = [(SFGridCardSection *)self cardSections];
                    v39 = [(SFGridCardSection *)v6 cardSections];
                    v40 = v39;
                    if ((v38 == 0) == (v39 != 0))
                    {
...
LABEL_66:
                    ...
                    {
                      uint64_t v41 = [(SFGridCardSection *)self cardSections];
                      if (v41)
                      {
                        v42 = (void *)v41;
                        v43 = [(SFGridCardSection *)self cardSections];
                        v44 = [(SFGridCardSection *)v6 cardSections];
...
{
  v18.receiver = self;
  v18.super_class = (Class)SFGridCardSection;
  ...
  char v11 = [(SFGridCardSection *)self type];
  ...
  uint64_t v15 = [(SFGridCardSection *)self cardSections];
  v16 = (void *)[v15 copy];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBGridCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBGridCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBGridCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)SFGridCardSection;
...
- (SFGridCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFGridCardSection *)v5 setType:v12];
    ...
    [(SFGridCardSection *)v5 setCardSections:v14];
...
- (SFGridCardSection)initWithProtobuf:(id)a3
{
  ...
  id v4 = a3;
  v42.receiver = self;
  v42.super_class = (Class)SFGridCardSection;
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      [(SFGridCardSection *)v5 setType:v19];
    }
