@interface SFAppIconCardSection
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (SFAppIconCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(SFAppIconCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            v31 = [(SFAppIconCardSection *)self type];
            v32 = [(SFAppIconCardSection *)v6 type];
            if ((v31 == 0) != (v32 != 0))
            {
              id v63 = v32;
              v76 = v31;
              v33 = [(SFAppIconCardSection *)self type];
              if (v33)
              {
                v62 = [(SFAppIconCardSection *)self type];
                v60 = [(SFAppIconCardSection *)v6 type];
              ...
              if ((v35 == 0) != (v36 != 0))
              {
                ...
                v41 = [(SFAppIconCardSection *)self title];
                v42 = [(SFAppIconCardSection *)v6 title];
                v43 = v42;
                if ((v41 == 0) == (v42 != 0))
                {
...
LABEL_65:
                ...
                v53 = [(SFAppIconCardSection *)self title];
                if (!v53
                  || ([(SFAppIconCardSection *)self title],
                      v44 = objc_claimAutoreleasedReturnValue(),
                      [(SFAppIconCardSection *)v6 title],
                      v51 = objc_claimAutoreleasedReturnValue(),
                      v52 = v44,
                      objc_msgSend(v44, "isEqual:")))
                {
                  v50 = [(SFAppIconCardSection *)self applicationBundleIdentifier];
                  v45 = [(SFAppIconCardSection *)v6 applicationBundleIdentifier];
                  v46 = v45;
                  if ((v50 == 0) == (v45 != 0))
                  {
                  ...
                  {
                    v49 = [(SFAppIconCardSection *)self applicationBundleIdentifier];
                    if (v49)
                    {
                      v48 = [(SFAppIconCardSection *)self applicationBundleIdentifier];
                      v47 = [(SFAppIconCardSection *)v6 applicationBundleIdentifier];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  char v11 = [(SFAppIconCardSection *)self type];
  ...
  uint64_t v15 = [(SFAppIconCardSection *)self title];
  v16 = (void *)[v15 copy];
  [v4 setTitle:v16];

  uint64_t v17 = [(SFAppIconCardSection *)self applicationBundleIdentifier];
  v18 = (void *)[v17 copy];
  [v4 setApplicationBundleIdentifier:v18];
...
- (NSData)jsonData
{
  v2 = [[_SFPBAppIconCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBAppIconCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBAppIconCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBAppIconCardSection *)v2 dictionaryRepresentation];
...
- (SFAppIconCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFAppIconCardSection *)v5 setType:v12];
    ...
    [(SFAppIconCardSection *)v5 setTitle:v14];

    uint64_t v15 = [(SFCardSection *)v8 applicationBundleIdentifier];
    [(SFAppIconCardSection *)v5 setApplicationBundleIdentifier:v15];
...
- (SFAppIconCardSection)initWithProtobuf:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v18)
    {
      ...
      [(SFAppIconCardSection *)v5 setType:v19];
    }
    ...
    {
      v25 = [v4 title];
      [(SFAppIconCardSection *)v5 setTitle:v25];
    }
    int v26 = [v4 applicationBundleIdentifier];

    if (v26)
    {
      v27 = [v4 applicationBundleIdentifier];
      [(SFAppIconCardSection *)v5 setApplicationBundleIdentifier:v27];
    }
    BOOL v28 = v5;
  }
  return v5;
