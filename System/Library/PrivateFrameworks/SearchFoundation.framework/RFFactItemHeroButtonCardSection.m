...
- (RFFactItemHeroButtonCardSection)initWithCoder:(id)a3;
- (RFFactItemHeroButtonCardSection)initWithProtobuf:(id)a3;
...
{
  v11.receiver = self;
  v11.super_class = (Class)RFFactItemHeroButtonCardSection;
  unint64_t v3 = [(SFCardSection *)&v11 hash];
  v4 = [(RFFactItemHeroButtonCardSection *)self number];
  uint64_t v5 = [v4 hash];
  v6 = [(RFFactItemHeroButtonCardSection *)self text];
  uint64_t v7 = v5 ^ [v6 hash];
  v8 = [(RFFactItemHeroButtonCardSection *)self button];
...
- (BOOL)isEqual:(id)a3
{
  uint64_t v5 = (RFFactItemHeroButtonCardSection *)a3;
  if (self == v5)
  {
    char v11 = 1;
  }
  ...
  {
    if ([(RFFactItemHeroButtonCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      v32.receiver = self;
      v32.super_class = (Class)RFFactItemHeroButtonCardSection;
      if ([(SFCardSection *)&v32 isEqual:v5])
      {
        v6 = v5;
        uint64_t v7 = [(RFFactItemHeroButtonCardSection *)self number];
        v8 = [(RFFactItemHeroButtonCardSection *)v6 number];
        if ((v7 == 0) == (v8 != 0))
        {
          char v11 = 0;
LABEL_31:
        ...
        unint64_t v9 = [(RFFactItemHeroButtonCardSection *)self number];
        if (v9)
        {
          unint64_t v3 = [(RFFactItemHeroButtonCardSection *)self number];
          v10 = [(RFFactItemHeroButtonCardSection *)v6 number];
          if (![v3 isEqual:v10])
          {
            char v11 = 0;
            goto LABEL_29;
        ...
        v12 = [(RFFactItemHeroButtonCardSection *)self text];
        v13 = [(RFFactItemHeroButtonCardSection *)v6 text];
        v14 = v13;
        if ((v12 == 0) == (v13 != 0))
        {
        ...
        v15 = [(RFFactItemHeroButtonCardSection *)self text];
        if (v15)
        {
          v25 = v12;
          v16 = [(RFFactItemHeroButtonCardSection *)self text];
          v27 = [(RFFactItemHeroButtonCardSection *)v6 text];
          v28 = v16;
        ...
        v17 = [(RFFactItemHeroButtonCardSection *)self button];
        v18 = [(RFFactItemHeroButtonCardSection *)v6 button];
        if ((v17 == 0) == (v18 != 0))
        {
        ...
        else
        {
          v24 = v17;
          v26 = v18;
          uint64_t v19 = [(RFFactItemHeroButtonCardSection *)self button];
          v15 = v29;
          if (v19)
          {
            v23 = (void *)v19;
            v22 = [(RFFactItemHeroButtonCardSection *)self button];
            v20 = [(RFFactItemHeroButtonCardSection *)v6 button];
...
{
  v12.receiver = self;
  v12.super_class = (Class)RFFactItemHeroButtonCardSection;
  id v4 = [(SFCardSection *)&v12 copyWithZone:a3];
  uint64_t v5 = [(RFFactItemHeroButtonCardSection *)self number];
  v6 = (void *)[v5 copy];
  [v4 setNumber:v6];

  uint64_t v7 = [(RFFactItemHeroButtonCardSection *)self text];
  v8 = (void *)[v7 copy];
  objc_msgSend(v4, "setText_1:", v8);

  unint64_t v9 = [(RFFactItemHeroButtonCardSection *)self button];
  v10 = (void *)[v9 copy];
  [v4 setButton:v10];
...
- (NSData)jsonData
{
  ...
  unint64_t v3 = [(_SFPBRFFactItemHeroButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFFactItemHeroButtonCardSection alloc] initWithFacade:self];
  unint64_t v3 = [(_SFPBRFFactItemHeroButtonCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = (Class)RFFactItemHeroButtonCardSection;
...
- (RFFactItemHeroButtonCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(RFFactItemHeroButtonCardSection *)v5 setText_1:v10];

    char v11 = [(SFCardSection *)v8 button];
    [(RFFactItemHeroButtonCardSection *)v5 setButton:v11];
...
- (RFFactItemHeroButtonCardSection)initWithProtobuf:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)RFFactItemHeroButtonCardSection;
