...
- (BOOL)readFrom:(id)a3;
- (NSData)jsonData;
- (_SFPBAddToPhotosLibraryCommand)initWithDictionary:(id)a3;
- (_SFPBAddToPhotosLibraryCommand)initWithFacade:(id)a3;
- (_SFPBAddToPhotosLibraryCommand)initWithJSON:(id)a3;
- (_SFPBImage)image;
...
- (_SFPBAddToPhotosLibraryCommand)initWithDictionary:(id)a3
{
  id v4 = a3;
  v10.receiver = self;
  v10.super_class = (Class)_SFPBAddToPhotosLibraryCommand;
...
- (NSData)jsonData
{
  v2 = [(_SFPBAddToPhotosLibraryCommand *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_image)
  {
    id v4 = [(_SFPBAddToPhotosLibraryCommand *)self image];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_SFPBAddToPhotosLibraryCommand *)self image];
    v6 = [v4 image];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBAddToPhotosLibraryCommand *)self image];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBAddToPhotosLibraryCommand *)self image];
      v11 = [v4 image];
...
- (BOOL)readFrom:(id)a3
{
  return _SFPBAddToPhotosLibraryCommandReadFrom(self, (uint64_t)a3);
}
