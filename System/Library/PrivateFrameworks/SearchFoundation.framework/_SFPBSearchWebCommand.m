...
- (NSData)jsonData
{
  v2 = [(_SFPBSearchWebCommand *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [(_SFPBSearchWebCommand *)self searchString];
    v5 = (void *)[v4 copy];
    [v3 setObject:v5 forKeyedSubscript:@"searchString"];
  }
  return v3;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_SFPBSearchWebCommand *)self searchString];
    v6 = [v4 searchString];
    uint64_t v7 = v6;
    if ((v5 == 0) != (v6 != 0))
    {
      uint64_t v8 = [(_SFPBSearchWebCommand *)self searchString];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = (void *)v8;
      objc_super v10 = [(_SFPBSearchWebCommand *)self searchString];
      v11 = [v4 searchString];
