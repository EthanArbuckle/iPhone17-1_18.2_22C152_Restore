  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v23 = v11;
      _os_log_impl(&dword_1DCC71000, v12, OS_LOG_TYPE_DEFAULT, "Failed to unarchive handshake response payload: %@", buf, 0xCu);
    }
  }
...
- (id)responsePayload
{
  ...
  objc_super v5 = [(SASProximityHandshakeAction *)self handshake];
  id v15 = 0;
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        id v19 = v10;
        _os_log_impl(&dword_1DCC71000, v12, OS_LOG_TYPE_DEFAULT, "Failed to archive handshake response payload: %@", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v19 = v7;
      _os_log_impl(&dword_1DCC71000, v8, OS_LOG_TYPE_DEFAULT, "Failed to archive handshake: %@", buf, 0xCu);
    }
    v9 = 0;
    id v10 = v7;
  }
