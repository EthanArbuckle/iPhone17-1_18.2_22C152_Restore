...
- (id)fullDescription
{
  ...
  uint64_t v5 = objc_msgSend(NSString, "stringWithFormat:", @"\n\n%-20s | %-60s | %-20s\n", "Description", "Result", "Time (ms)");
  ...
  id v22 = v4;
  id v13 = v4;
  long long v14 = (void (**)(void, void))MEMORY[0x223CA3340](v21);
...
{
  id v3 = [&stru_26D523DE8 stringByPaddingToLength:a3 withString:a2 startingAtIndex:0];
...
id __28__AHTLoader_fullDescription__block_invoke_2(uint64_t a1, uint64_t a2)
{
  ...
  uint64_t v5 = objc_msgSend(NSString, "stringWithFormat:", @"AHTBootload%sResult", a2);
  ...
  uint64_t v10 = objc_msgSend(NSString, "stringWithFormat:", @"AHTBootload%sTimeMs", a2);
  int v11 = [v9 objectForKeyedSubscript:v10];

  uint64_t v12 = [v11 unsignedIntValue];
  if (v11)
  {
    objc_msgSend(NSString, "stringWithFormat:", @"%u", v12);
  ...
  uint64_t v17 = v13;
  v18 = objc_msgSend(v14, "stringWithFormat:", @"%-20s | %-60s | %-20s", a2, v16, -[__CFString UTF8String](v17, "UTF8String"));
...
+ (BOOL)errorFromAfuKextResult:(int)a3 error:(id *)a4
{
  ...
  if (a3 && a4)
  {
    ...
    {
      objc_msgSend(NSString, "stringWithFormat:", @"Unknown FWDownloadStatus: 0x%08X", *(void *)&a3);
...
- (BOOL)overrideFDR:(id)a3 fdrClass:(id)a4 fdrSubclass:(id)a5 error:(id *)a6
{
  ...
  BOOL v16 = objc_msgSend(objc_alloc(MEMORY[0x263EFF990]), "initWithCapacity:", objc_msgSend(v10, "length") + objc_msgSend(v15, "length"));
  [v16 appendData:v15];
  [v16 appendData:v10];
  id v17 = v16;
  input[0] = [v17 bytes];
  input[1] = [v17 length];
  input[2] = [v15 length];
  long long v21 = xmmword_222A00740;
  if ([(AHTLoader *)self open:a6]) {
