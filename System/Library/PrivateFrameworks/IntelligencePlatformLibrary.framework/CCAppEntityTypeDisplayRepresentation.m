...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:47352 stringValue:self->_name];
    v7[2](v7, v5);
  }
  if (self->_synonyms)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:47353 repeatedStringValue:self->_synonyms];
    v7[2](v7, v6);
  }
}
...
LABEL_29:
    ...
    uint64_t v23 = CCPBReaderReadStringNoCopy();
    name = (void *)v23;
    if (v8)
    {
      if (!v23)
...
LABEL_24:
    ...
    objc_msgSend(v8, "addObject:", name, v32);
    goto LABEL_24;
  }
  id v8 = 0;
LABEL_34:
  v9 = 0;
LABEL_35:
  v25 = (NSArray *)objc_msgSend(v8, "copy", v32);
