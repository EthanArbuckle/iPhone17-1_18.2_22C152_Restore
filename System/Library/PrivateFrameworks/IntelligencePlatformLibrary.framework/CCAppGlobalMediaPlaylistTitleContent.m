@interface CCAppGlobalMediaPlaylistTitleContent
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCAppGlobalMediaPlaylistTitleContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCAppGlobalMediaPlaylistTitleContent)initWithVocabularyStrings:(id)a3 error:(id *)a4;
- (NSArray)vocabularyStrings;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
@end

@implementation CCAppGlobalMediaPlaylistTitleContent
...
- (CCAppGlobalMediaPlaylistTitleContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaPlaylistTitleContent alloc] initWithVocabularyStrings:v9 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCAppGlobalMediaPlaylistTitleContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  if (self->_vocabularyStrings)
  {
    ...
    id v7 = a3;
    id v8 = (id)[[v6 alloc] initWithFieldType:34312 repeatedStringValue:self->_vocabularyStrings];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  ...
  if (a3 == 34307) {
    return @"AppGlobalMediaPlaylistTitle";
  }
  else {
    return v3;
  }
