...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_firstName)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:27131 stringValue:self->_firstName];
    v7[2](v7, v5);
  }
  if (self->_lastName)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:27132 stringValue:self->_lastName];
    v7[2](v7, v6);
  }
}
...
- (NSString)lastName
{
  v2 = (void *)[(NSString *)self->_lastName copy];
  return (NSString *)v2;
}

- (NSString)firstName
{
  v2 = (void *)[(NSString *)self->_firstName copy];
  return (NSString *)v2;
}
