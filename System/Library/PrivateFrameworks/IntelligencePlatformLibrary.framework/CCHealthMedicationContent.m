@interface CCHealthMedicationContent
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCHealthMedicationContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCHealthMedicationContent)initWithName:(id)a3 nickname:(id)a4 error:(id *)a5;
- (NSString)name;
- (NSString)nickname;
- (id)jsonDictionary;
...
@implementation CCHealthMedicationContent
...
- (CCHealthMedicationContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [v6 objectForKeyedSubscript:@"nickname"];
    v11 = [[CCHealthMedicationContent alloc] initWithName:v9 nickname:v10 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    v4 = [(CCHealthMedicationContent *)self name];
    [v3 setObject:v4 forKeyedSubscript:@"name"];
  }
  if (self->_nickname)
  {
    v5 = [(CCHealthMedicationContent *)self nickname];
    [v3 setObject:v5 forKeyedSubscript:@"nickname"];
  }
  id v6 = (void *)[v3 copy];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:12999 stringValue:self->_name];
    v7[2](v7, v5);
  }
  if (self->_nickname)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:13000 stringValue:self->_nickname];
    v7[2](v7, v6);
  }
}
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((a3 - 12996) > 4) {
    ...
    return *(&off_26539C2B8 + (unsigned __int16)(a3 - 12996));
  }
}
