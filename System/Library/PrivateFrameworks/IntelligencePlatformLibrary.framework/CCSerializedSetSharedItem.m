@interface CCSerializedSetSharedItem
...
- (CCSerializedSetSharedItem)initWithContent:(id)a3 sharedIdentifier:(id)a4 error:(id *)a5;
- (CCSerializedSetSharedItem)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (NSData)content;
- (id)jsonDictionary;
- (int64_t)sharedIdentifier;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
- (void)setHasSharedIdentifier:(BOOL)a3;
@end

@implementation CCSerializedSetSharedItem
...
- (void)setHasSharedIdentifier:(BOOL)a3
{
  self->_hasSharedIdentifier = a3;
}

- (BOOL)hasSharedIdentifier
{
  return self->_hasSharedIdentifier;
}

- (int64_t)sharedIdentifier
{
  return self->_sharedIdentifier;
}
...
- (CCSerializedSetSharedItem)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  {
    v9 = [v6 objectForKeyedSubscript:@"content"];
    objc_opt_class();
    ...
    if (v10)
    {
      ...
      v13 = [v6 objectForKeyedSubscript:@"sharedIdentifier"];
      v14 = [[CCSerializedSetSharedItem alloc] initWithContent:v12 sharedIdentifier:v13 error:a4];
...
- (id)jsonDictionary
{
  ...
  if (self->_content)
  {
    v4 = [(CCSerializedSetSharedItem *)self content];
    v5 = [v4 base64EncodedStringWithOptions:0];
    [v3 setObject:v5 forKeyedSubscript:@"content"];
  }
  if (self->_hasSharedIdentifier)
  {
    id v6 = objc_msgSend(NSNumber, "numberWithLongLong:", -[CCSerializedSetSharedItem sharedIdentifier](self, "sharedIdentifier"));
    [v3 setObject:v6 forKeyedSubscript:@"sharedIdentifier"];
  }
  v7 = (void *)[v3 copy];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_content)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:(unsigned __int16)*MEMORY[0x263F316D0] bytesValue:self->_content];
    v8[2](v8, v6);
  }
  if (self->_hasSharedIdentifier)
  {
    v7 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:*v5 int64Value:self->_sharedIdentifier];
    v8[2](v8, v7);
  }
}
...
- (NSData)content
{
  v2 = (void *)[(NSData *)self->_content copy];
  return (NSData *)v2;
}
...
LABEL_33:
      id v11 = 0;
      self->_sharedIdentifier = v23;
      self->_hasSharedIdentifier = 1;
    }
