...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  if (self->_sourceItemIdentifier)
  {
    ...
    id v7 = a3;
    id v8 = (id)[[v6 alloc] initWithFieldType:40576 stringValue:self->_sourceItemIdentifier];
...
LABEL_18:
    if ((v15 >> 3) == 1)
    {
      ...
      self->_sourceItemIdentifier = v21;
LABEL_23:
    ...
    if ((CCPBReaderSkipValueWithTag() & 1) == 0)
    {
      ...
      sourceItemIdentifier = NSStringFromClass(v23);
