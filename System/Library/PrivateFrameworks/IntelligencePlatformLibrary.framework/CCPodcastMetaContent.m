@interface CCPodcastMetaContent
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCPodcastMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCPodcastMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4;
- (NSString)sourceItemIdentifier;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
@end

@implementation CCPodcastMetaContent
...
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4
{
  ...
  v8 = (int *)MEMORY[0x263F317C0];
  id v9 = (int *)MEMORY[0x263F317B8];
...
- (CCPodcastMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    id v9 = [v6 objectForKeyedSubscript:@"sourceItemIdentifier"];
    v10 = [[CCPodcastMetaContent alloc] initWithSourceItemIdentifier:v9 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCPodcastMetaContent *)self sourceItemIdentifier];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  if (self->_sourceItemIdentifier)
  {
    ...
    id v7 = a3;
    id v8 = (id)[[v6 alloc] initWithFieldType:42187 stringValue:self->_sourceItemIdentifier];
