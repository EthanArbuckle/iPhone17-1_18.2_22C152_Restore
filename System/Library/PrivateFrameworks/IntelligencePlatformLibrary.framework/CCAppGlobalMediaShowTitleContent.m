@interface CCAppGlobalMediaShowTitleContent
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCAppGlobalMediaShowTitleContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCAppGlobalMediaShowTitleContent)initWithVocabularyStrings:(id)a3 error:(id *)a4;
- (NSArray)vocabularyStrings;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
@end

@implementation CCAppGlobalMediaShowTitleContent
...
- (CCAppGlobalMediaShowTitleContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaShowTitleContent alloc] initWithVocabularyStrings:v9 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCAppGlobalMediaShowTitleContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  if (self->_vocabularyStrings)
  {
    ...
    id v7 = a3;
    id v8 = (id)[[v6 alloc] initWithFieldType:36064 repeatedStringValue:self->_vocabularyStrings];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  ...
  if (a3 == 36059) {
    return @"AppGlobalMediaShowTitle";
  }
  else {
    return v3;
  }
