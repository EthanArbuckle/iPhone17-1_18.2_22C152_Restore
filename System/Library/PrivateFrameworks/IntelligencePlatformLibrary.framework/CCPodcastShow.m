...
LABEL_8:
  v15 = objc_msgSend(v10, "immutableData", v18);
...
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4
{
  ...
  v10 = 0;
  int v11 = (int *)MEMORY[0x263F317B0];
  do
  {
    if (*(void *)&v6[*v9] || v10 != 0) {
      break;
...
- (CCPodcastShow)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    int v11 = [[CCPodcastShow alloc] initWithName:v9 author:v10 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  if (self->_author)
  {
    id v5 = [(CCPodcastShow *)self author];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    id v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:42189 stringValue:self->_name];
    v7[2](v7, v5);
  }
  if (self->_author)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:42190 stringValue:self->_author];
    v7[2](v7, v6);
  }
}
...
- (NSString)author
{
  v2 = (void *)[(NSString *)self->_author copy];
  return (NSString *)v2;
}
