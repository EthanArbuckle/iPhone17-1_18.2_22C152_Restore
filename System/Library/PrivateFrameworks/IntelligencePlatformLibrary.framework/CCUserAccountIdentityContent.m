...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_userName)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:61512 stringValue:self->_userName];
    v7[2](v7, v5);
  }
  if (self->_givenName)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:61513 stringValue:self->_givenName];
    v7[2](v7, v6);
  }
}
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((unsigned __int16)(a3 + 4027) > 4u) {
    ...
    return *(&off_26539CBB8 + (unsigned __int16)(a3 + 4027));
  }
}
