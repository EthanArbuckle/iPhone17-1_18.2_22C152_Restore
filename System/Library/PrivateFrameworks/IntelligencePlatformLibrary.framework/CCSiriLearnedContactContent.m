...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_suggestedContactId, 0);
  objc_storeStrong((id *)&self->_userPhrasedName, 0);
}
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_userPhrasedName)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:53604 stringValue:self->_userPhrasedName];
    v7[2](v7, v5);
  }
  if (self->_suggestedContactId)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:53605 stringValue:self->_suggestedContactId];
    v7[2](v7, v6);
  }
}
...
- (NSString)suggestedContactId
{
  v2 = (void *)[(NSString *)self->_suggestedContactId copy];
  return (NSString *)v2;
}

- (NSString)userPhrasedName
{
  v2 = (void *)[(NSString *)self->_userPhrasedName copy];
  return (NSString *)v2;
}
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((unsigned __int16)(a3 + 11935) > 4u) {
    return 0;
  }
  else {
    return *(&off_26539CB40 + (unsigned __int16)(a3 + 11935));
  }
}
