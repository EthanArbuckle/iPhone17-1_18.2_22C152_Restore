...
- (id)jsonDictionary
{
  ...
  if (self->_url)
  {
    v5 = [(CCContactURLAddress *)self url];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19767 stringValue:self->_label];
    v7[2](v7, v5);
  }
  if (self->_url)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19777 stringValue:self->_url];
    v7[2](v7, v6);
  }
}
...
- (NSString)url
{
  v2 = (void *)[(NSString *)self->_url copy];
  return (NSString *)v2;
}
