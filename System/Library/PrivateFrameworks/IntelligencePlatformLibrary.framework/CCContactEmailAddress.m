@interface CCContactEmailAddress
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCContactEmailAddress)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCContactEmailAddress)initWithLabel:(id)a3 email:(id)a4 error:(id *)a5;
- (NSString)email;
- (NSString)label;
- (id)jsonDictionary;
...
@implementation CCContactEmailAddress
...
- (CCContactEmailAddress)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [v6 objectForKeyedSubscript:@"email"];
    v11 = [[CCContactEmailAddress alloc] initWithLabel:v9 email:v10 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    v4 = [(CCContactEmailAddress *)self label];
    [v3 setObject:v4 forKeyedSubscript:@"label"];
  }
  if (self->_email)
  {
    v5 = [(CCContactEmailAddress *)self email];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19765 stringValue:self->_label];
    v7[2](v7, v5);
  }
  if (self->_email)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19776 stringValue:self->_email];
    v7[2](v7, v6);
  }
}
...
- (NSString)email
{
  v2 = (void *)[(NSString *)self->_email copy];
  return (NSString *)v2;
}
