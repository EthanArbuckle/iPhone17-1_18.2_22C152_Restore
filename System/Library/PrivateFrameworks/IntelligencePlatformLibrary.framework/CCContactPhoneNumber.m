@interface CCContactPhoneNumber
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCContactPhoneNumber)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCContactPhoneNumber)initWithLabel:(id)a3 stringValue:(id)a4 error:(id *)a5;
- (NSString)label;
...
@implementation CCContactPhoneNumber
...
- (CCContactPhoneNumber)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v11 = [[CCContactPhoneNumber alloc] initWithLabel:v9 stringValue:v10 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    v4 = [(CCContactPhoneNumber *)self label];
    [v3 setObject:v4 forKeyedSubscript:@"label"];
  }
  if (self->_stringValue)
  {
    v5 = [(CCContactPhoneNumber *)self stringValue];
    [v3 setObject:v5 forKeyedSubscript:@"stringValue"];
  }
  id v6 = (void *)[v3 copy];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19747 stringValue:self->_label];
    v7[2](v7, v5);
  }
  if (self->_stringValue)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19748 stringValue:self->_stringValue];
    v7[2](v7, v6);
  }
}
...
- (NSString)stringValue
{
  v2 = (void *)[(NSString *)self->_stringValue copy];
  return (NSString *)v2;
}
