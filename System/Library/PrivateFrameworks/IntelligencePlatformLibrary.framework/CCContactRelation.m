@interface CCContactRelation
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCContactRelation)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCContactRelation)initWithLabel:(id)a3 name:(id)a4 error:(id *)a5;
- (NSString)label;
- (NSString)name;
- (id)jsonDictionary;
...
@implementation CCContactRelation
...
- (CCContactRelation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v11 = [[CCContactRelation alloc] initWithLabel:v9 name:v10 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  if (self->_label)
  {
    v4 = [(CCContactRelation *)self label];
    [v3 setObject:v4 forKeyedSubscript:@"label"];
  }
  if (self->_name)
  {
    v5 = [(CCContactRelation *)self name];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_label)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19758 stringValue:self->_label];
    v7[2](v7, v5);
  }
  if (self->_name)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:19759 stringValue:self->_name];
    v7[2](v7, v6);
  }
}
