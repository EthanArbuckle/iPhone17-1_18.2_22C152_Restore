@interface CCAppGlobalMediaMusicArtistNameContent
+ (Class)contentMessageClass;
+ (Class)metaContentMessageClass;
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3;
+ (unsigned)itemType;
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCAppGlobalMediaMusicArtistNameContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCAppGlobalMediaMusicArtistNameContent)initWithVocabularyStrings:(id)a3 error:(id *)a4;
- (NSArray)vocabularyStrings;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
@end

@implementation CCAppGlobalMediaMusicArtistNameContent
...
- (CCAppGlobalMediaMusicArtistNameContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaMusicArtistNameContent alloc] initWithVocabularyStrings:v9 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCAppGlobalMediaMusicArtistNameContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  if (self->_vocabularyStrings)
  {
    ...
    id v7 = a3;
    id v8 = (id)[[v6 alloc] initWithFieldType:3620 repeatedStringValue:self->_vocabularyStrings];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  ...
  if (a3 == 3615) {
    return @"AppGlobalMediaMusicArtistName";
  }
  else {
    return v3;
  }
