...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_title)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:54388 stringValue:self->_title];
    v7[2](v7, v5);
  }
  if (self->_locationName)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:54389 stringValue:self->_locationName];
    v7[2](v7, v6);
  }
}
...
- (NSString)locationName
{
  v2 = (void *)[(NSString *)self->_locationName copy];
  return (NSString *)v2;
}
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)a3
{
  if ((unsigned __int16)(a3 + 11151) > 4u) {
    return 0;
  }
  else {
    return *(&off_26539BEC8 + (unsigned __int16)(a3 + 11151));
  }
}
