...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_assistantHomeKitIdentifier, 0);
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_sourceItemIdentifier)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:7699 stringValue:self->_sourceItemIdentifier];
    v7[2](v7, v5);
  }
  if (self->_assistantHomeKitIdentifier)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:7700 stringValue:self->_assistantHomeKitIdentifier];
    v7[2](v7, v6);
  }
}
...
- (NSString)assistantHomeKitIdentifier
{
  v2 = (void *)[(NSString *)self->_assistantHomeKitIdentifier copy];
  return (NSString *)v2;
}
