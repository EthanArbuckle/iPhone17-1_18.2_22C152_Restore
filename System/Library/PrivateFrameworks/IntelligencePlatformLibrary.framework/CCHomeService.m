...
- (CCHomeService)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v13 = [[CCHomeService alloc] initWithName:v9 deviceType:v12 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    v4 = [(CCHomeService *)self name];
    [v3 setObject:v4 forKeyedSubscript:@"name"];
  }
  v5 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[CCHomeService deviceType](self, "deviceType"));
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  ...
  if (self->_name)
  {
    v5 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:7706 stringValue:self->_name];
    v7[2](v7, v5);
  }
  id v6 = (void *)[objc_alloc(MEMORY[0x263F31708]) initWithFieldType:7707 enumValue:self->_deviceType];
  v7[2](v7, v6);
}
