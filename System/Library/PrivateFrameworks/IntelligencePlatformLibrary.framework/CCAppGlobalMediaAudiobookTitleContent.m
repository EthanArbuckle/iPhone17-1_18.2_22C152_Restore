...
- (CCAppGlobalMediaAudiobookTitleContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCAppGlobalMediaAudiobookTitleContent alloc] initWithVocabularyStrings:v9 error:a4];
  }
  else
  {
    CCSetError();
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCAppGlobalMediaAudiobookTitleContent *)self vocabularyStrings];
...
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4
{
  if (self->_vocabularyStrings)
  {
    ...
    id v7 = a3;
    id v8 = (id)[[v6 alloc] initWithFieldType:8199 repeatedStringValue:self->_vocabularyStrings];
