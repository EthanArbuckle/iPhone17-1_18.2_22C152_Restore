...
- (TextPreviewViewController)initWithPreviewText:(id)a3 footerTitle:(id)a4 footerSubtitle:(id)a5
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)TextPreviewViewController;
...
{
  id v4 = a3;
  v5 = (UITextView *)objc_alloc_init((Class)UITextView);
  ...
  id v9 = [(UITextView *)self->_textView linkTextAttributes];
  ...
  [v10 setValue:&off_100008368 forKey:NSUnderlineStyleAttributeName];
  v12 = +[NSDictionary dictionaryWithDictionary:v10];
  [(UITextView *)self->_textView setLinkTextAttributes:v12];

  id v24 = objc_alloc_init((Class)UIViewController);
  v13 = [v24 view];
...
- (CGSize)preferredContentSize
{
  ...
  -[UITextView sizeThatFits:](self->_textView, "sizeThatFits:", Width + -80.0, 1.79769313e308);
  double v17 = v16 + 40.0;
  if (v16 + 40.0 > 312.0) {
    double v17 = 312.0;
  }
