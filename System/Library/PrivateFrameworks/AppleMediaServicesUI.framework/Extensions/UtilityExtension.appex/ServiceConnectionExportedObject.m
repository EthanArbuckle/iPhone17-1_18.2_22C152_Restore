...
- (void)bootstrapWithAccount:(id)a3 bagData:(id)a4 clientInfo:(id)a5 mediaClientData:(id)a6 metricsContextData:(id)a7 url:(id)a8 completion:(id)a9
{
  ...
  id v22 = a8;
  swift_retain();
  uint64_t v23 = sub_100045650();
  unint64_t v25 = v24;

  uint64_t v26 = sub_100045650();
  v28 = v27;

  uint64_t v29 = sub_100045650();
  unint64_t v31 = v30;

  sub_1000455E0();
  _Block_copy(v18);
  id v32 = v34;
  sub_10003E6DC(v35, v23, v25, (uint64_t)v34, v26, v28, v29, v31, (uint64_t)v17, (uint64_t)v33, v18);
  _Block_release(v18);
  sub_1000282F4(v29, v31);
  sub_1000282F4(v26, (unint64_t)v28);
  sub_1000282F4(v23, v25);
...
- (void)performWithRequestData:(id)a3 completion:(id)a4
{
  ...
  id v7 = a3;
  swift_retain();
  uint64_t v8 = sub_100045650();
  unint64_t v10 = v9;

  _Block_copy(v6);
  sub_1000405FC(v8, v10, (uint64_t)self, (void (**)(void, void, void))v6);
  _Block_release(v6);
  sub_1000282F4(v8, v10);
  swift_release();
}
...
- (void)updateWithAccount:(id)a3 completion:(id)a4
{
  ...
  id v7 = a3;
  swift_retain();
  sub_1000419A0(a3, (uint64_t)self, (void (**)(void, void))v6);
  _Block_release(v6);
