...
{
  v3.receiver = self;
  v3.super_class = (Class)AMSUIDashboardMessageAppearance;
...
- (AMSUIDashboardMessageAppearance)initWithDictionary:(id)a3
{
  id v4 = a3;
  v33.receiver = self;
  v33.super_class = (Class)AMSUIDashboardMessageAppearance;
  v5 = [(AMSUIAppearance *)&v33 initWithDictionary:v4];
  if (v5)
  {
    ...
    uint64_t v22 = +[AMSUIAppearance _separatorColorWithDictionary:v4];
    separatorColor = v5->_separatorColor;
    v5->_separatorColor = (UIColor *)v22;

    uint64_t v24 = +[AMSUIAppearance _titleFontWithDictionary:v4];
    titleFont = v5->_titleFont;
    v5->_titleFont = (UIFont *)v24;

    uint64_t v26 = +[AMSUIAppearance _titleTextColorWithDictionary:v4];
    titleTextColor = v5->_titleTextColor;
    v5->_titleTextColor = (UIColor *)v26;

    uint64_t v28 = +[AMSUIAppearance _messageFontWithDictionary:v4];
    messageFont = v5->_messageFont;
    v5->_messageFont = (UIFont *)v28;

    uint64_t v30 = +[AMSUIAppearance _messageTextColorWithDictionary:v4];
