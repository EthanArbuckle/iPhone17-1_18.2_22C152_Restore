...
{
  v7.receiver = self;
  v7.super_class = (Class)ICQUIPaddedSpecifierWithCenterSubtitleCell;
  v4 = [(ICQUIPaddedSpecifierWithCenterSubtitleCell *)&v7 initWithStyle:a3 reuseIdentifier:a4];
  v5 = v4;
  if (v4)
  {
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)ICQUIPaddedSpecifierWithCenterSubtitleCell;
  ...
  double v7 = [(ICQUIPaddedSpecifierWithCenterSubtitleCell *)self headerImageView];
