...
{
  if (options_once_9 != -1) {
    dispatch_once(&options_once_9, &__block_literal_global_16);
  }
  v2 = (void *)options_sOptions_9;
  return v2;
}

void __27__ADOptOutResponse_options__block_invoke()
{
  v0 = (void *)options_sOptions_9;
  options_sOptions_9 = (uint64_t)&unk_1F27155A0;
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ADOptOutResponse;
...
- (BOOL)readFrom:(id)a3
{
  return ADOptOutResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
