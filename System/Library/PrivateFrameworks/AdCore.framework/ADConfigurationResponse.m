...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_theConfigurations, "count"));
    long long v17 = 0u;
    long long v18 = 0u;
    long long v19 = 0u;
    long long v20 = 0u;
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    if (bannerProxyType)
    {
      ...
      {
        objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_bannerProxyType);
...
- (void)addTheConfiguration:(id)a3
{
  ...
  if (!theConfigurations)
  {
    ...
    uint64_t v7 = self->_theConfigurations;
...
- (unint64_t)theConfigurationsCount
{
  return [(NSMutableArray *)self->_theConfigurations count];
}

- (id)theConfigurationAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_theConfigurations objectAtIndex:a3];
}
...
- (id)description
{
  ...
  int v4 = [(ADConfigurationResponse *)&v8 description];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(ADConfigurationResponse *)self theConfigurationsCount])
  {
    ...
    unint64_t v4 = [(ADConfigurationResponse *)self theConfigurationsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(ADConfigurationResponse *)self theConfigurationAtIndex:i];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v21 = 0u;
  long long v22 = 0u;
  uint64_t v6 = self->_theConfigurations;
  ...
  uint64_t v12 = [(NSString *)self->_resourceProxyURL copyWithZone:a3];
  long long v13 = *(void **)(v5 + 40);
  *(void *)(v5 + 40) = v12;

  uint64_t v14 = [(NSString *)self->_resourceConnectProxyURL copyWithZone:a3];
  ...
  *(void *)(v5 + 32) = v14;
  ...
  uint64_t v16 = -[NSString copyWithZone:](self->_configVersion, "copyWithZone:", a3, (void)v19);
...
LABEL_15:
  ...
  if ((unint64_t)configVersion | *((void *)v4 + 2)) {
    char v9 = -[NSString isEqual:](configVersion, "isEqual:");
  }
  else {
    char v9 = 1;
  }
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSMutableArray *)self->_theConfigurations hash];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        -[ADConfigurationResponse addTheConfiguration:](self, "addTheConfiguration:", *(void *)(*((void *)&v10 + 1) + 8 * i), (void)v10);
      }
