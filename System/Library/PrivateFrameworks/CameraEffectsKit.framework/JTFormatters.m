...
+ (id)dateFormatter
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"FormattersDateFormatterKeyForCurrentThread"];
  if (!v4)
  {
...
+ (id)dateFormatterLongStyle
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"FormattersDateFormatterLongStyleKeyForCurrentThread"];
  if (!v4)
  {
    id v4 = objc_alloc_init(MEMORY[0x263F08790]);
    v5 = [MEMORY[0x263EFF960] currentLocale];
...
+ (id)dateFormatterMonthDay
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"FormattersDateFormatterMonthDayKeyForCurrentThread"];
  if (!v4)
  {
    id v4 = objc_alloc_init(MEMORY[0x263F08790]);
    v5 = [MEMORY[0x263EFF960] currentLocale];
...
+ (id)dateFormatterDayOfWeekMonthDayYear
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"FormattersDateFormatterDayOfWeekMonthDayYearKeyForCurrentThread"];
  if (!v4)
  {
    id v4 = objc_alloc_init(MEMORY[0x263F08790]);
    v5 = [MEMORY[0x263EFF960] currentLocale];
...
+ (id)dateFormatterDebugDate
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"FormattersDateFormatterDebugDateForCurrentThread"];
  if (!v4)
  {
    id v4 = objc_alloc_init(MEMORY[0x263F08790]);
...
+ (id)dateComponentsFormatterHourMinSec
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"DateComponentsFormatterHourMinSecKeyForCurrentThread"];
  if (!v4)
  {
    id v4 = objc_opt_new();
    [v4 setUnitsStyle:0];
...
+ (id)dateComponentsFormatterMinSec
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"kDateComponentsFormatterMinSecKeyForCurrentThread"];
  if (!v4)
  {
    id v4 = objc_opt_new();
    [v4 setUnitsStyle:0];
