...
{
  v4.receiver = self;
  v4.super_class = (Class)FxParameterPushButton;
...
- (void)dealloc
{
  FxDebugAssert(self->_pushButtonPriv != 0, &cfstr_Pushbuttonpriv.isa, v2, v3, v4, v5, v6, v7, (char)v9.receiver);
  free(self->_pushButtonPriv);
  v9.receiver = self;
  v9.super_class = (Class)FxParameterPushButton;
