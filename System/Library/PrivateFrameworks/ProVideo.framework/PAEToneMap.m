...
{
  v4.receiver = self;
  v4.super_class = (Class)PAEToneMap;
...
- (id)properties
{
  if (-[PAEToneMap properties]::once != -1) {
    dispatch_once(&-[PAEToneMap properties]::once, &__block_literal_global_21);
  }
  return (id)-[PAEToneMap properties]::sPropertiesDict;
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)PAEToneMap;
  ...
  if (v3)
  {
    ...
    objc_msgSend(v3, "addFloatSliderWithName:parmId:defaultValue:parameterMin:parameterMax:sliderMin:sliderMax:delta:parmFlags:", objc_msgSend(v4, "localizedStringForKey:value:table:", @"PAE_TM::Gamma", 0, 0), 1, 0, 0.699999988, 0.0, 2.0, 0.0, 2.0, 0.1);
    objc_msgSend(v3, "addFloatSliderWithName:parmId:defaultValue:parameterMin:parameterMax:sliderMin:sliderMax:delta:parmFlags:", objc_msgSend(v4, "localizedStringForKey:value:table:", @"PAE_TM::Max", 0, 0), 2, 0, 12.0, 0.0, 100.0, 0.0, 12.0, 0.1);
  }
  return v3 != 0;
}
