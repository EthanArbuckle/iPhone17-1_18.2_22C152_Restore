...
- (void)getRotationAtTime:(id *)a3 curveX:(double *)a4 curveY:(double *)a5 curveZ:(double *)a6;
- (void)getRotationAtTime:(id *)a3 x:(double *)a4 y:(double *)a5 z:(double *)a6;
- (void)ozChannel;
...
- (void)setRotationAtTime:(id *)a3 curveX:(double)a4 curveY:(double)a5 curveZ:(double)a6 options:(unsigned int)a7;
@end

@implementation CHChannelRotation3D
...
- (void)getRotationAtTime:(id *)a3 x:(double *)a4 y:(double *)a5 z:(double *)a6
{
  ...
  uint64_t v15 = 0;
  uint64_t v16 = 0;
  (*(void (**)(CMTime *__return_ptr, void *, $3CC8671D27C23BF42ADDB32F2B5E48AE *))(*(void *)v11 + 336))(&v13, v11, a3);
  OZChannelRotation3D::getValueAsEulerAngles((uint64_t)v11, &v13, &v14, 0.0);
  uint64_t v12 = v15;
  *(void *)a4 = v14;
  *(void *)a5 = v12;
  *(void *)a6 = v16;
...
- (void)setRotationAtTime:(id *)a3 curveX:(double)a4 curveY:(double)a5 curveZ:(double)a6 options:(unsigned int)a7
{
  ...
  *(unsigned char *)(OZCoreGlobals::getInstance(Instance) + 8) = v7 & 1;
  ...
  v19 = (OZCoreGlobals *)(*(uint64_t (**)(double))(v17[38] + 712))(a6);
...
- (void)setDefaultCurveX:(double)a3 curveY:(double)a4 curveZ:(double)a5
{
  ...
  uint64_t v18 = (OZChannel *)(v9 + 55);
  int v19 = (*(uint64_t (**)(void *))(v9[55] + 512))(v9 + 55);
  uint64_t v20 = v9[55];
  if (v19) {
    int v21 = (*(uint64_t (**)(void *))(v20 + 832))(v9 + 55) == 0;
  }
  else {
    int v21 = (*(uint64_t (**)(void *, uint64_t))(v20 + 496))(v9 + 55, 1) ^ 1;
  }
...
LABEL_4:
  ...
  {
    uint64_t v10 = 0;
    (*(void (**)(void, uint64_t *))(**(void **)(v9[69] + 8) + 264))(*(void *)(v9[69] + 8), &v10);
    *(void *)a5 = v10;
  }
}
...
LABEL_4:
  ...
  {
    uint64_t v10 = 0;
    (*(void (**)(void, uint64_t *))(**(void **)(v9[69] + 8) + 256))(*(void *)(v9[69] + 8), &v10);
    *(void *)a5 = v10;
  }
}
