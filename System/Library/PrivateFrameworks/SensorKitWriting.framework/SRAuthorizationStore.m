            ...
            else
            {
              ...
              if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_FAULT))
              {
                *(_DWORD *)buf = 138543362;
                uint64_t v38 = v19;
                _os_log_fault_impl(&dword_25C11B000, v27, OS_LOG_TYPE_FAULT, "No sensor description found for %{public}@", buf, 0xCu);
              }
            }
          }
...
+ (id)sharedAuthorizationStoreForSensors:(id)a3
{
  ...
  block[3] = &unk_2654AD240;
  block[4] = a3;
  if (qword_26A595F90 != -1) {
    dispatch_once(&qword_26A595F90, block);
  }
...
LABEL_36:
      _os_log_impl(&dword_25C11B000, v7, OS_LOG_TYPE_INFO, v9, (uint8_t *)buf, 2u);
      return;
    }
    if (v8)
    {
      LOWORD(buf[0]) = 0;
      _os_log_impl(&dword_25C11B000, v7, OS_LOG_TYPE_INFO, "Registering for TCC updates", (uint8_t *)buf, 2u);
    }
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)uint64_t v38 = 67240192;
        uint32_t v39 = v11;
        _os_log_fault_impl(&dword_25C11B000, v12, OS_LOG_TYPE_FAULT, "Failed to register for TCC notifications.  Got status %{public}d", v38, 8u);
      }
  ...
  else
  {
    ...
    {
      LOWORD(buf[0]) = 0;
      _os_log_impl(&dword_25C11B000, v7, OS_LOG_TYPE_INFO, "Unregistering for TCC updates", (uint8_t *)buf, 2u);
...
- (void)updateAuthorizations
{
  ...
  state.opaque[0] = 0;
  state.opaque[1] = 0;
  id v2 = _os_activity_create(&dword_25C11B000, "Retrieving fresh authorizations from TCC", MEMORY[0x263EF8420], OS_ACTIVITY_FLAG_DEFAULT);
  os_activity_scope_enter(v2, &state);
  SEL v3 = SRLogAuthorizationStore;
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_INFO))
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_25C11B000, v3, OS_LOG_TYPE_INFO, "Retrieving fresh authorizations from TCC", buf, 2u);
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        context = (void *)MEMORY[0x26117EE90]();
        ...
        if (v10)
        {
          ...
          if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)v152 = 138543362;
            uint64_t v153 = v8;
            _os_log_impl(&dword_25C11B000, v11, OS_LOG_TYPE_INFO, "Could not retrieve authorization information for TCC service %{public}@", v152, 0xCu);
          }
        }
        ...
        if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)v152 = 138543874;
          ...
          __int16 v156 = 2114;
          id v157 = v103;
          _os_log_impl(&dword_25C11B000, v13, OS_LOG_TYPE_DEFAULT, "Authorized Bundle Ids for %{public}@, overridden %{public, BOOL}d, %{public}@", v152, 0x1Cu);
          long long v13 = SRLogAuthorizationStore;
        }
        if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)v152 = 138543874;
          ...
          __int16 v156 = 2114;
          id v157 = v100;
          _os_log_impl(&dword_25C11B000, v13, OS_LOG_TYPE_DEFAULT, "Deauthorized Bundle Ids for %{public}@, overridden %{public, BOOL}d, %{public}@", v152, 0x1Cu);
        }
          ...
          do
          {
            ...
            if (!v49)
            {
              ...
              *(void *)&v158[4] = v48;
              ...
              uint32_t v61 = 12;
LABEL_106:
              _os_log_error_impl(&dword_25C11B000, v59, OS_LOG_TYPE_ERROR, v60, v158, v61);
              goto LABEL_103;
            }
    ...
    do
    {
      ...
      do
      {
        ...
        if (v77 && os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&v149[4] = v72;
          _os_log_impl(&dword_25C11B000, v76, OS_LOG_TYPE_INFO, "Could not retrieve authorization information for TCC service %{public}@", v149, 0xCu);
          v76 = SRLogAuthorizationStore;
        }
        if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v149[12] = 2114;
          *(void *)&v149[14] = v73;
          _os_log_impl(&dword_25C11B000, v76, OS_LOG_TYPE_DEFAULT, "Authorized Bundle Ids for %{public}@, %{public}@", v149, 0x16u);
          v76 = SRLogAuthorizationStore;
        }
        if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v149[12] = 2114;
          *(void *)&v149[14] = v75;
          _os_log_impl(&dword_25C11B000, v76, OS_LOG_TYPE_DEFAULT, "Deauthorized Bundle Ids for %{public}@, %{public}@", v149, 0x16u);
        }
          ...
          if ([v14 count])
          {
            ...
            if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = v39;
              ...
              __int16 v70 = 2114;
              id v71 = v14;
              _os_log_impl(&dword_25C11B000, v34, OS_LOG_TYPE_DEFAULT, "Authorization Changed for bundle id %{public}@ for sensors %{public}@", buf, 0x16u);
            }
          }
    ...
    *(void *)&long long v6 = 138412546;
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v11 = (void *)MEMORY[0x26117EE90]();
        ...
        if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = v14;
          ...
          __int16 v22 = 2112;
          uint64_t v23 = v12;
          _os_log_impl(&dword_25C11B000, v13, OS_LOG_TYPE_DEFAULT, "reset reader authorization for bundle %@ service %@", buf, 0x16u);
        }
...
- (void)resetAllAuthorizations
{
  ...
  long long v17 = &unk_2654AD3E8;
  long long v18 = v3;
  __46__SRAuthorizationStore_resetAllAuthorizations__block_invoke((uint64_t)v15, [(SRAuthorizationStore *)self readerAuthorizationBundleIdValues], (uint64_t)&__block_literal_global_3);
  ...
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    id v21 = v3;
    _os_log_impl(&dword_25C11B000, v5, OS_LOG_TYPE_DEFAULT, "reset authorization for services %@", buf, 0xCu);
  }
  long long v13 = 0u;
  long long v14 = 0u;
  long long v11 = 0u;
        ...
        if (v9)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              long long v14 = (void *)MEMORY[0x26117EE90]();
...
- (void)resetAuthorizationForService:(id)a3 bundleId:(id)a4
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationStore, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2114;
    id v11 = a4;
    _os_log_impl(&dword_25C11B000, v7, OS_LOG_TYPE_DEFAULT, "Reset authorization for service %@ and bundle id: %{public}@", (uint8_t *)&v8, 0x16u);
  }
    ...
    if (v11)
    {
      if ([a3 isEqualToString:@"com.apple.private.SensorKit._compositeBundle"])
      {
        ...
        if (v11)
        {
          ...
          _os_log_fault_impl(&dword_25C11B000, v12, OS_LOG_TYPE_FAULT, "Setting authorization for %{public}@ is not allowed", (uint8_t *)&v15, 0xCu);
          LOBYTE(v11) = 0;
        }
      }
      else
