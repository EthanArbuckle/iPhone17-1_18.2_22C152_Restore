...
+ (SRAuthorizationClient)sharedInstance
{
  ...
  if (!_MergedGlobals_0)
  {
    if (qword_26A595F78 != -1) {
      dispatch_once(&qword_26A595F78, &__block_literal_global_1);
    }
    return (SRAuthorizationClient *)qword_26A595F70;
  }
  return result;
}
...
SRAuthorizationClient *__39__SRAuthorizationClient_sharedInstance__block_invoke()
{
  ...
  qword_26A595F70 = (uint64_t)result;
  return result;
}
...
- (SRAuthorizationClient)initWithConnection:(id)a3
{
  ...
  if (v4)
  {
    ...
    -[NSXPCConnection setRemoteObjectInterface:](v5->_connection, "setRemoteObjectInterface:", [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_27098D4B0]);
    -[NSXPCConnection setExportedInterface:](v5->_connection, "setExportedInterface:", [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_27098B2F8]);
    ...
    {
      LOWORD(handler[0]) = 0;
      _os_log_debug_impl(&dword_25C11B000, v15, OS_LOG_TYPE_DEBUG, "Registering for prerequisites notification", (uint8_t *)handler, 2u);
    }
    ...
    if (v18 || *p_registrationToken == -1)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 67240448;
        ...
        __int16 v31 = 1026;
        int v32 = v20;
        _os_log_error_impl(&dword_25C11B000, v19, OS_LOG_TYPE_ERROR, "Failed to register for prerequisites notification status %{public}d, registration token %{public}d", buf, 0xEu);
      }
    }
...
- (void)dealloc
{
  ...
  if (self)
  {
    ...
    if (registrationToken != -1)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_debug_impl(&dword_25C11B000, v4, OS_LOG_TYPE_DEBUG, "Unregistering for prerequisites notification", buf, 2u);
        int registrationToken = self->_registrationToken;
      }
      if (notify_cancel(registrationToken))
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 67240192;
          int v12 = v9;
          _os_log_error_impl(&dword_25C11B000, v5, OS_LOG_TYPE_ERROR, "Failed to cancel notification status %{public}d", buf, 8u);
        }
      }
...
- (void)updateInitialAuthorizationStateIfNeeded
{
  if (result)
  {
    ...
    if (result)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_25C11B000, v2, OS_LOG_TYPE_INFO, "Retrieving initial authorization state", buf, 2u);
      }
...
- (uint64_t)syncProxy
{
  ...
  if (!v3)
  {
      ...
      && [(id)v10[5] code] == 4097)
    {
      ...
      {
        *(_WORD *)SEL v7 = 0;
        _os_log_impl(&dword_25C11B000, v5, OS_LOG_TYPE_DEFAULT, "Connection was interrupted, retrying...", v7, 2u);
      }
...
uint64_t __64__SRAuthorizationClient_updateInitialAuthorizationStateIfNeeded__block_invoke(uint64_t a1, void *a2, void *a3, void *a4, uint64_t a5)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 134217984;
    ...
    _os_log_impl(&dword_25C11B000, v21, OS_LOG_TYPE_INFO, "Retrieved initial authorization state. prerequisites: %ld", buf, 0xCu);
  }
  long long v63 = 0u;
  long long v64 = 0u;
  long long v61 = 0u;
      ...
      for (uint64_t i = 0; i != v24; ++i)
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543619;
          ...
          __int16 v69 = 2113;
          uint64_t v70 = v31;
          _os_log_impl(&dword_25C11B000, v28, OS_LOG_TYPE_INFO, "%{public}@ authorized: %{private}@", buf, 0x16u);
        }
      }
      uint64_t v24 = [a2 countByEnumeratingWithState:&v61 objects:v71 count:16];
    }
      ...
      for (uint64_t j = 0; j != v32; ++j)
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543619;
          ...
          __int16 v69 = 2113;
          uint64_t v70 = v39;
          _os_log_impl(&dword_25C11B000, v36, OS_LOG_TYPE_INFO, "%{public}@ denied: %{private}@", buf, 0x16u);
        }
      }
      uint64_t v32 = [a3 countByEnumeratingWithState:&v57 objects:v66 count:16];
    }
      ...
      for (uint64_t k = 0; k != v40; ++k)
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543619;
          ...
          __int16 v69 = 2113;
          uint64_t v70 = v47;
          _os_log_impl(&dword_25C11B000, v44, OS_LOG_TYPE_INFO, "%{public}@ last modified times: %{private}@", buf, 0x16u);
        }
      }
      uint64_t v40 = [a4 countByEnumeratingWithState:&v53 objects:v65 count:16];
    }
...
void __56__SRAuthorizationClient_registerForPrerequisitesUpdated__block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)v2 = 0;
    _os_log_debug_impl(&dword_25C11B000, v1, OS_LOG_TYPE_DEBUG, "Received notification of prerequisite change", v2, 2u);
  }
}
...
id __34__SRAuthorizationClient_syncProxy__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_ERROR))
  {
    int v6 = 138543362;
    uint64_t v7 = a2;
    _os_log_error_impl(&dword_25C11B000, v4, OS_LOG_TYPE_ERROR, "Failed to get sync proxy to daemon, error %{public}@", (uint8_t *)&v6, 0xCu);
  }
  id result = a2;
...
void __34__SRAuthorizationClient_syncProxy__block_invoke_33(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_ERROR))
  {
    int v4 = 138543362;
    uint64_t v5 = a2;
    _os_log_error_impl(&dword_25C11B000, v3, OS_LOG_TYPE_ERROR, "Failed to get sync proxy to daemon, error %{public}@", (uint8_t *)&v4, 0xCu);
  }
}
        ...
        [(SRAuthorizationClient *)self initialAuthNeeded]))
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)long long v18 = 0;
      _os_log_impl(&dword_25C11B000, v15, OS_LOG_TYPE_DEFAULT, "Authorization state has not yet been sent from the daemon.", v18, 2u);
    }
    objc_sync_exit(listeners);
  }
  else
...
- (void)authorizedServicesDidChange:(id)a3 deniedServices:(id)a4 prerequisites:(int64_t)a5 lastModifiedTimes:(id)a6 bundleIdentifier:(id)a7
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogAuthorizationClient, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138544387;
    ...
    __int16 v45 = 2113;
    id v46 = a6;
    _os_log_impl(&dword_25C11B000, v13, OS_LOG_TYPE_DEFAULT, "Daemon authorization update for bundle: %{public}@, prerequisites: %{public}ld, authorized: %{public}@, denied: %{public}@, last modified times: %{private}@", buf, 0x34u);
  }
  if (self)
  {
    listeners = self->_listeners;
        ...
        objc_msgSend((id)objc_msgSend(v18, "objectForKeyedSubscript:", a7), "isEqualToSet:", a4)))
  {
    if (self)
    {
        ...
        && objc_msgSend(objc_getProperty(self, v17, 56, 1), "integerValue") == a5)
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_25C11B000, v19, OS_LOG_TYPE_DEFAULT, "Ignoring duplicate daemon authorization update", buf, 2u);
        }
        objc_sync_exit(listeners);
        return;
      }
