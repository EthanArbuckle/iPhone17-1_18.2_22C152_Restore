...
+ (id)clientInterface
{
  v2 = (void *)[MEMORY[0x263F08D80] interfaceWithProtocol:&unk_2709897E8];
...
+ (id)remoteInterface
{
  v2 = (void *)[MEMORY[0x263F08D80] interfaceWithProtocol:&unk_27098D1F0];
  v3 = (void *)MEMORY[0x263EFFA08];
  uint64_t v4 = objc_opt_class();
  uint64_t v5 = objc_opt_class();
  uint64_t v6 = objc_opt_class();
...
+ (id)connectionToDaemon
{
  v2 = (void *)[objc_alloc(MEMORY[0x263F08D68]) initWithMachServiceName:@"com.apple.SensorKit.writer" options:4096];
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138543362;
          id v23 = a3;
          _os_log_fault_impl(&dword_25C11B000, v15, OS_LOG_TYPE_FAULT, "Failed to find a sensor description for service: %{public}@", buf, 0xCu);
        }
      }
...
- (id)chooseAuthStore
{
  ...
  if (v3)
  {
    ...
    uint64_t v6 = (void *)MEMORY[0x26117EE90]();
    long long v19 = 0u;
    long long v20 = 0u;
    long long v21 = 0u;
    long long v22 = 0u;
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          id v14 = (void *)MEMORY[0x26117EE90]();
...
- (void)daemonNotificationDaemonDidStart:(id)a3
{
  if ([(SRSensorWriter *)self connectionDidInvalidate])
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_25C11B000, v4, OS_LOG_TYPE_DEFAULT, "Daemon has restarted after being invalidated. Re-establishing connection", buf, 2u);
    }
  ...
  if ([(SRSensorWriter *)self retryGetMonitoring])
  {
    ...
    {
      *(_WORD *)uint64_t v6 = 0;
      _os_log_impl(&dword_25C11B000, v5, OS_LOG_TYPE_INFO, "Trying to get monitoring flag after daemon restart", v6, 2u);
    }
...
void __51__SRSensorWriter_daemonNotificationDaemonDidStart___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      int v4 = 138543362;
      uint64_t v5 = a2;
      _os_log_error_impl(&dword_25C11B000, v3, OS_LOG_TYPE_ERROR, "Failed to connect to daemon because %{public}@", (uint8_t *)&v4, 0xCu);
    }
  }
}
...
- (void)daemonNotificationDaemonDidChangeTimeSignificantly:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_25C11B000, v4, OS_LOG_TYPE_DEFAULT, "Daemon has synced time. Requesting a new segment and time info", buf, 2u);
  }
  ...
  else
  {
    ...
    {
      *(_WORD *)uint64_t v6 = 0;
      _os_log_impl(&dword_25C11B000, v5, OS_LOG_TYPE_DEFAULT, "Writer is not authorized so not asking for a new segment", v6, 2u);
    }
  }
}
...
- (void)daemonNotificationDaemonDidResetDatastore:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_25C11B000, v4, OS_LOG_TYPE_DEFAULT, "Daemon has reset our datastore. Requesting a new segment", buf, 2u);
  }
  if ([(SRSensorWriter *)self authorized])
  {
    [(SRSensorWriter *)self requestNewSegment];
...
- (void)setupConnection
{
  ...
  v4[1] = 3221225472;
  v4[2] = __33__SRSensorWriter_setupConnection__block_invoke_62;
  v4[3] = &unk_2654AD128;
...
uint64_t __33__SRSensorWriter_setupConnection__block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)int v4 = 0;
    _os_log_impl(&dword_25C11B000, v2, OS_LOG_TYPE_DEFAULT, "Connection to daemon interrupted", v4, 2u);
  }
  return [objc_loadWeak((id *)(a1 + 32)) setConnectionDidInterrupt:1];
}

uint64_t __33__SRSensorWriter_setupConnection__block_invoke_62(uint64_t a1)
{
  v2 = SRLogWriter;
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
  {
    *(_WORD *)id v5 = 0;
    _os_log_impl(&dword_25C11B000, v2, OS_LOG_TYPE_DEFAULT, "Connection to daemon invalidated", v5, 2u);
  }
...
- (void)checkForMonitoring
{
  ...
  [(SRSensorWriter *)self registerWithDaemonForWritingIfNeededWithReply:&__block_literal_global_64];
}
...
uint64_t __64__SRSensorWriter_registerWithDaemonForWritingIfNeededWithReply___block_invoke(uint64_t a1)
{
  ...
  {
    *(_WORD *)int v4 = 0;
    _os_log_error_impl(&dword_25C11B000, v2, OS_LOG_TYPE_ERROR, "Failed to connect with daemon", v4, 2u);
  }
...
- (void)daemonForcedResetDatastoreFiles:(id)a3
{
  ...
  if ([a3 objectForKeyedSubscript:0x270986688])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_25C11B000, v5, OS_LOG_TYPE_DEFAULT, "[%{public}@] Daemon is resetting the writer datastore, asking for a new segment", (uint8_t *)&v7, 0xCu);
    }
    [(SRSensorWriter *)self requestNewSegment];
  }
}
...
- (SRDatastore)datastore
{
  ...
  self->_datastore = 0;
  id v5 = [(NSDictionary *)v4 objectForKeyedSubscript:0x270986688];
  id v6 = [(NSDictionary *)v4 objectForKeyedSubscript:0x2709866A8];
  id v7 = [(NSDictionary *)v4 objectForKeyedSubscript:0x2709866C8];
  id v8 = [(NSDictionary *)v4 objectForKeyedSubscript:0x2709866E8];
  ...
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v29 = 2114;
    v30 = v8;
    _os_log_impl(&dword_25C11B000, v9, OS_LOG_TYPE_DEFAULT, "[%{public}@] Creating a new datastore with samples: %{public}@, metadata: %{public}@, configuration: %{public}@, defaults: %{public}@", buf, 0x34u);
  }
  if ([(NSDictionary *)v4 objectForKeyedSubscript:0x270986688])
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138412290;
        ...
        _os_log_impl(&dword_25C11B000, v12, OS_LOG_TYPE_INFO, "Carrying over previous metadata: %@", buf, 0xCu);
      }
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138412290;
        ...
        _os_log_impl(&dword_25C11B000, v14, OS_LOG_TYPE_INFO, "Carrying over previous configuration: %@", buf, 0xCu);
      }
      long long v20 = 0;
      if (![(SRSensorWriter *)self _setSensorConfiguration:[(SRSensorWriter *)self lastConfiguration] continuousTimestamp:[(SRSensorWriter *)self lastConfigurationContinuousTime] error:&v20])
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138543362;
          long long v22 = v20;
          _os_log_error_impl(&dword_25C11B000, v16, OS_LOG_TYPE_ERROR, "Error carrying over previous configuration because %{public}@", buf, 0xCu);
        }
      }
    }
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_debug_impl(&dword_25C11B000, v19, OS_LOG_TYPE_DEBUG, "No sample file received so clearing the datastore", buf, 2u);
  }
  return 0;
}
...
LABEL_22:
  ...
  if (!a3)
  {
    *double v10 = +[SRError errorWithCode:12290];
    ...
    v28 = (uint8_t *)&v33;
LABEL_28:
    _os_log_impl(&dword_25C11B000, v25, OS_LOG_TYPE_DEFAULT, v27, v28, 2u);
    return 0;
  }
  if (!a4)
  {
  ...
  if ([(SRSensorWriter *)self requestNewSegmentInFlight])
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      ...
      _os_log_impl(&dword_25C11B000, v3, OS_LOG_TYPE_INFO, "[%{public}@] Request for a new segment is already inflight", buf, 0xCu);
    }
  }
  else
  {
...
void __35__SRSensorWriter_requestNewSegment__block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543362;
      uint64_t v12 = a2;
      _os_log_error_impl(&dword_25C11B000, v3, OS_LOG_TYPE_ERROR, "Error registering with daemon because %{public}@", buf, 0xCu);
    }
  }
  else
  {
    ...
    v9[1] = 3221225472;
    v9[2] = __35__SRSensorWriter_requestNewSegment__block_invoke_70;
    v9[3] = &unk_2654AD178;
    objc_copyWeak(&v10, v4);
    id v6 = (void *)[v5 remoteObjectProxyWithErrorHandler:v9];
    v7[0] = MEMORY[0x263EF8330];
    v7[1] = 3221225472;
    v7[2] = __35__SRSensorWriter_requestNewSegment__block_invoke_71;
    v7[3] = &unk_2654AD1A0;
    objc_copyWeak(&v8, v4);
...
uint64_t __35__SRSensorWriter_requestNewSegment__block_invoke_70(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
  {
    int v6 = 138543362;
    uint64_t v7 = a2;
    _os_log_error_impl(&dword_25C11B000, v4, OS_LOG_TYPE_ERROR, "Unable to get proxy object to request a new segment because %{public}@", (uint8_t *)&v6, 0xCu);
  }
  return [objc_loadWeak((id *)(a1 + 32)) setRequestNewSegmentInFlight:0];
}

uint64_t __35__SRSensorWriter_requestNewSegment__block_invoke_71(uint64_t a1, void *a2)
{
  uint64_t v10 = *MEMORY[0x263EF8340];
  id Weak = objc_loadWeak((id *)(a1 + 32));
  [Weak setRequestNewSegmentInFlight:0];
  uint64_t v4 = [a2 objectForKeyedSubscript:0x270986708];
  if (v4)
  {
    uint64_t v5 = v4;
    int v6 = SRLogWriter;
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      int v8 = 138543362;
      uint64_t v9 = v5;
      _os_log_error_impl(&dword_25C11B000, v6, OS_LOG_TYPE_ERROR, "Error requesting new segment %{public}@", (uint8_t *)&v8, 0xCu);
    }
  }
...
- (void)setMetadata:(id)a3 continuousTimestamp:(unint64_t)a4 datastore:(id)a5
{
  ...
  if (a5 && (writeMetadataBytesForFrameStore(*((void *)a5 + 6), v16, v17, &v20, v18) & 1) != 0)
  {
  ...
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 138543362;
    ...
    uint32_t v14 = 12;
LABEL_9:
    _os_log_error_impl(&dword_25C11B000, v13, OS_LOG_TYPE_ERROR, v12, buf, v14);
  }
}
...
LABEL_12:
  ...
  if (!v9)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2114;
    uint64_t v25 = v19;
    _os_log_error_impl(&dword_25C11B000, v18, OS_LOG_TYPE_ERROR, "Error trying to archive metadata %{public}@ %{public}@", buf, 0x16u);
    goto LABEL_16;
  }
...
LABEL_16:
  ...
  int v15 = writeMetadataBytesForFrameStore((uint64_t)v11->_configuration, v12, v13, v8, v14);
  if (v15)
  {
...
- (void)didReceiveUpdateToConfigurationRequests
{
  if ([(SRSensorWriterDelegate *)self->_delegate conformsToProtocol:&unk_27098D2B0])
  {
  ...
  if (v5 == v3)
  {
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      _os_log_impl(&dword_25C11B000, v6, OS_LOG_TYPE_INFO, "[%@] monitoring is already %{public, BOOL}d. Ignoring update", buf, 0x12u);
    }
  }
  else
  {
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v20 = 1026;
      LODWORD(v21) = v3;
      _os_log_impl(&dword_25C11B000, v6, OS_LOG_TYPE_DEFAULT, "[%@] monitoring requested to set to %{public, BOOL}d", buf, 0x12u);
    }
    if (v3)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v22 = 1026;
          int v23 = 0;
          _os_log_impl(&dword_25C11B000, v14, OS_LOG_TYPE_DEFAULT, "[%{public}@] does not have explicit writer authorization (status: %{public}ld). Setting monitoring to %{public, BOOL}d", buf, 0x1Cu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v20 = 1026;
        LODWORD(v21) = v12;
        _os_log_impl(&dword_25C11B000, v10, OS_LOG_TYPE_DEFAULT, "[%@] monitoring set to %{public, BOOL}d", buf, 0x12u);
      }
...
void __32__SRSensorWriter_setMonitoring___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v14 = 2114;
      uint64_t v15 = a2;
      _os_log_error_impl(&dword_25C11B000, v7, OS_LOG_TYPE_ERROR, "[%@] Error registering with daemon because %{public}@. Setting monitoring to false", buf, 0x16u);
    }
    [v6 setMonitoring:0];
  ...
  else
  {
    ...
    v10[1] = 3221225472;
    v10[2] = __32__SRSensorWriter_setMonitoring___block_invoke_129;
    v10[3] = &unk_2654AD1C8;
...
void __32__SRSensorWriter_setMonitoring___block_invoke_129(uint64_t a1, void *a2)
{
  uint64_t v16 = *MEMORY[0x263EF8340];
  id Weak = (unsigned __int8 *)objc_loadWeak((id *)(a1 + 40));
  uint64_t v5 = [a2 objectForKeyedSubscript:0x270986708];
  if (v5)
  {
    uint64_t v6 = v5;
    uint64_t v7 = SRLogWriter;
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2114;
      uint64_t v15 = v6;
      _os_log_error_impl(&dword_25C11B000, v7, OS_LOG_TYPE_ERROR, "[%@] Error requesting file handle %{public}@. Setting monitoring to false", (uint8_t *)&v12, 0x16u);
    }
  ...
  else
  {
    ...
    if (Weak)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
      {
        ...
        _os_log_impl(&dword_25C11B000, v8, OS_LOG_TYPE_DEFAULT, "[%@] monitoring set to %{public, BOOL}d", (uint8_t *)&v12, 0x12u);
      }
    ...
    else
    {
      ...
      {
        LOWORD(v12) = 0;
        _os_log_error_impl(&dword_25C11B000, v10, OS_LOG_TYPE_ERROR, "Writer instance is nil so not setting the monitoring flag", (uint8_t *)&v12, 2u);
      }
    }
  }
}
...
- (void)setDelegate:(id)a3
{
  ...
  if ([(SRSensorWriter *)self _writerAuthorizationStatus]
    && [a3 conformsToProtocol:&unk_27098D378]
      ...
      else
      {
        ...
        if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          ...
          _os_log_fault_impl(&dword_25C11B000, v10, OS_LOG_TYPE_FAULT, "Failed to find authorization service for %{public}@. Unable to request authorization", buf, 0xCu);
        }
...
uint64_t __60__SRSensorWriter__requestWriterAuthorizationWithCompletion___block_invoke(uint64_t a1, int a2)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
  {
    v6[0] = 67240192;
    v6[1] = a2;
    _os_log_impl(&dword_25C11B000, v4, OS_LOG_TYPE_DEFAULT, "TCC has returned from prompt with status: %{public, BOOL}d", (uint8_t *)v6, 8u);
  }
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16))();
}
...
- (void)startUpdatingAuthorizations
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_FAULT))
    {
      *(_DWORD *)buf = 67240192;
      uint32_t v12 = v4;
      _os_log_fault_impl(&dword_25C11B000, v5, OS_LOG_TYPE_FAULT, "Failed to register for TCC notifications. Got status %{public}d", buf, 8u);
    }
  }
  uint64_t v6 = [(SRSensorWriter *)self writerAuthorizationUpdateQueue];
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
  block[2] = __45__SRSensorWriter_startUpdatingAuthorizations__block_invoke_139;
  block[3] = &unk_2654AD240;
  block[4] = self;
...
uint64_t __45__SRSensorWriter_startUpdatingAuthorizations__block_invoke_139(uint64_t a1)
{
...
- (void)updateWriterAuthorizationStatus
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v24 = 2050;
    uint64_t v25 = v7;
    _os_log_impl(&dword_25C11B000, v9, OS_LOG_TYPE_DEFAULT, "[%{public}@] Got writer authorization status update. Current: %{public}ld, TCC: %{public}ld, Data Collection: %{public, BOOL}d, New: %{public}ld", buf, 0x30u);
  }
  if (v8 != v7)
  {
    ...
    if ([(SRSensorWriterDelegate *)v11 conformsToProtocol:&unk_27098D378])
    {
      if (objc_opt_respondsToSelector()) {
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        _os_log_error_impl(&dword_25C11B000, v12, OS_LOG_TYPE_ERROR, "[%@] Got a writer authorization change notification but the delegate (%{public}p) does not conform to SRSensorWriterAuthorizationDelegate", buf, 0x16u);
      }
    }
  }
}
...
uint64_t __49__SRSensorWriter_updateWriterAuthorizationStatus__block_invoke(uint64_t result, uint64_t a2)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      int v5 = 138543362;
      uint64_t v6 = a2;
      _os_log_error_impl(&dword_25C11B000, v4, OS_LOG_TYPE_ERROR, "Failed to connect with daemon because %{public}@", (uint8_t *)&v5, 0xCu);
    }
  ...
  *(void *)&void v12[5] = *MEMORY[0x263EF8340];
  ...
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)((char *)&v12[1] + 2) = sensorIdentifier;
    _os_log_impl(&dword_25C11B000, v6, OS_LOG_TYPE_INFO, "Authorization set to %{public, BOOL}d for %@", (uint8_t *)&v11, 0x12u);
  }
  if (!v5 && [(SRSensorWriter *)self authorized])
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)uint32_t v12 = v10;
      _os_log_impl(&dword_25C11B000, v9, OS_LOG_TYPE_DEFAULT, "Writer is authorized for %{public}@ connecting to daemon to determine monitoring state", (uint8_t *)&v11, 0xCu);
    }
...
- (void)flushDatabase
{
  ...
  if (datastore)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_25C11B000, v4, OS_LOG_TYPE_DEFAULT, "[%{public}@] Flushing datastore to disk", (uint8_t *)&v6, 0xCu);
      datastore = self->_datastore;
    }
  }
...
- (void)authorizedServicesDidChange:(id)a3 deniedServices:(id)a4 dataCollectionEnabled:(BOOL)a5 onboardingCompleted:(BOOL)a6 lastModifiedTimes:(id)a7 forBundleIdentifier:(id)a8
{
  ...
  if (v14)
  {
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v25 = 2114;
      id v26 = a4;
      _os_log_impl(&dword_25C11B000, v15, OS_LOG_TYPE_DEFAULT, "[%{public}@] Got authorization client update: data collection: %{public, BOOL}d, onboarding: %{public, BOOL}d, authorized: %{public}@, denied: %{public}@", (uint8_t *)&v17, 0x2Cu);
    }
    uint64_t v16 = 0;
    if (v10 && v9)
    {
  ...
  else if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_FAULT))
  {
    ...
    _os_log_fault_impl(&dword_25C11B000, v15, OS_LOG_TYPE_FAULT, "Shouldn't be getting an auth update for %{public}@", (uint8_t *)&v17, 0xCu);
  }
}
...
void __47__SRSensorWriter_bundleEligibility_completion___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543362;
      uint64_t v14 = a2;
      _os_log_error_impl(&dword_25C11B000, v4, OS_LOG_TYPE_ERROR, "Error registering with daemon because %{public}@", buf, 0xCu);
    }
  ...
  else
  {
    ...
    v12[0] = MEMORY[0x263EF8330];
    v12[1] = 3221225472;
    v12[2] = __47__SRSensorWriter_bundleEligibility_completion___block_invoke_140;
    v12[3] = &unk_2654AD150;
    v12[4] = *(void *)(a1 + 40);
    ...
    v10[0] = MEMORY[0x263EF8330];
    v10[1] = 3221225472;
    v10[2] = __47__SRSensorWriter_bundleEligibility_completion___block_invoke_141;
    v10[3] = &unk_2654AD268;
...
uint64_t __47__SRSensorWriter_bundleEligibility_completion___block_invoke_140(uint64_t a1, uint64_t a2)
{
  uint64_t v8 = *MEMORY[0x263EF8340];
  uint64_t v4 = SRLogWriter;
  if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
  {
    int v6 = 138543362;
    uint64_t v7 = a2;
    _os_log_error_impl(&dword_25C11B000, v4, OS_LOG_TYPE_ERROR, "Unable to get proxy object to request eligibility because %{public}@", (uint8_t *)&v6, 0xCu);
  }
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16))();
}

uint64_t __47__SRSensorWriter_bundleEligibility_completion___block_invoke_141(uint64_t a1, unsigned int a2, uint64_t a3)
{
  ...
  if (a3)
  {
    if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_ERROR))
    {
      int v10 = 138543362;
      uint64_t v11 = a3;
      _os_log_error_impl(&dword_25C11B000, v6, OS_LOG_TYPE_ERROR, "Error fetching eligibility %{public}@", (uint8_t *)&v10, 0xCu);
    }
  }
  else if (os_log_type_enabled((os_log_t)SRLogWriter, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2114;
    uint64_t v13 = v7;
    _os_log_impl(&dword_25C11B000, v6, OS_LOG_TYPE_INFO, "Bundle identifier %{public}@ %{public}@ for writing", (uint8_t *)&v10, 0x16u);
  }
