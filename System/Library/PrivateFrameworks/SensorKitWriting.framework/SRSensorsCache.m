      ...
      while (1)
      {
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled((os_log_t)SRLogSensorsCache, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v36 = 2114;
            v37 = v6;
            _os_log_impl(&dword_25C11B000, v18, OS_LOG_TYPE_INFO, "Cached description for %{public}@, %{public}@", buf, 0x16u);
          }
          if (v6) {
            goto LABEL_27;
          }
        ...
        }
        {
          ...
          if (os_log_type_enabled((os_log_t)SRLogSensorsCache, OS_LOG_TYPE_INFO))
          {
            *(_DWORD *)buf = v25;
            uint64_t v35 = v15;
            _os_log_impl(&dword_25C11B000, v19, OS_LOG_TYPE_INFO, "%{public}@ not found", buf, 0xCu);
          }
        }
        else
        {
          ...
          if (os_log_type_enabled((os_log_t)SRLogSensorsCache, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v36 = 2114;
            v37 = v32;
            _os_log_error_impl(&dword_25C11B000, v20, OS_LOG_TYPE_ERROR, "Failed to parse %{public}@ because %{public}@", buf, 0x16u);
          }
        }
        if (v10 == ++v12)
        {
...
LABEL_24:
      ...
      if (os_log_type_enabled((os_log_t)SRLogSensorsCache, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v36 = 2114;
        v37 = v24;
        _os_log_error_impl(&dword_25C11B000, v21, OS_LOG_TYPE_ERROR, "Failed to find description for %{public}@ in %{public}@", buf, 0x16u);
      }
    }
    v6 = 0;
LABEL_27:
...
+ (uint64_t)defaultCache
{
  ...
  {
    self;
    if (qword_26A595F50 != -1) {
      dispatch_once(&qword_26A595F50, &__block_literal_global_0);
    }
    return qword_26A595F48;
  }
  return result;
}
...
SRSensorsCache *__29__SRSensorsCache_sharedCache__block_invoke()
{
  ...
  qword_26A595F48 = (uint64_t)result;
  return result;
}
    ...
    if (!v6)
    {
      ...
      if (os_log_type_enabled((os_log_t)SRLogSensorsCache, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)buf = 138543362;
        uint64_t v20 = v16;
        _os_log_fault_impl(&dword_25C11B000, v7, OS_LOG_TYPE_FAULT, "Failed to locate the /System/Library directory because %{public}@", buf, 0xCu);
      }
      uint64_t v6 = [NSURL fileURLWithPath:@"/System/Library"];
    }
    uint64_t v5 = objc_msgSend(NSURL, "fileURLWithPath:isDirectory:relativeToURL:", objc_msgSend(NSString, "pathWithComponents:", &unk_270988BE8), 1, v6);
  }
