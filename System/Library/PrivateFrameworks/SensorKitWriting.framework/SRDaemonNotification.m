...
uint64_t __53__SRDaemonNotification_registerForDaemonNotification__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogDaemonNotification, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v6 = 138543362;
    uint64_t v7 = v5;
    _os_log_debug_impl(&dword_25C11B000, v2, OS_LOG_TYPE_DEBUG, "Got a notification for %{public}@ to re-connect to the daemon", (uint8_t *)&v6, 0xCu);
    if (Weak) {
      goto LABEL_3;
    }
LABEL_8:
...
uint64_t __53__SRDaemonNotification_registerForDaemonNotification__block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)SRLogDaemonNotification, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_debug_impl(&dword_25C11B000, v2, OS_LOG_TYPE_DEBUG, "Got a notification for %{public}@", (uint8_t *)&v5, 0xCu);
    if (Weak) {
      goto LABEL_3;
    }
  }
