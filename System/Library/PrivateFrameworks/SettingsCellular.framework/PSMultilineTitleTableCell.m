...
- (PSMultilineTitleTableCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  v4 = [(PSMultilineTitleTableCell *)&v77 initWithStyle:a3 reuseIdentifier:a4];
  v5 = v4;
  if (v4)
  {
    ...
    uint64_t v21 = [v17 constraintEqualToAnchor:v20];
    ...
    if ((([(PSMultilineTitleTableCell *)v5 _shouldReverseLayoutDirection] ^ 1 | IsAccessibilityCategory) & 1) == 0)
    {
...
- (void)layoutSubviews
{
  ...
  int v5 = [v3 containsView:v4];

  if (v5)
  {
    uint64_t v6 = [(PSMultilineTitleTableCell *)self accessoryType];
  ...
  BOOL IsAccessibilityCategory = UIContentSizeCategoryIsAccessibilityCategory(v26);
