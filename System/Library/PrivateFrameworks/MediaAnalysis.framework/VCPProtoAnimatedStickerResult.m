@interface VCPProtoAnimatedStickerResult
...
@implementation VCPProtoAnimatedStickerResult

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoAnimatedStickerResult;
  v4 = [(VCPProtoAnimatedStickerResult *)&v8 description];
  v5 = [(VCPProtoAnimatedStickerResult *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&double v4 = self->_stickerScore;
  v7 = [NSNumber numberWithFloat:v4];
  [v3 setObject:v7 forKey:@"stickerScore"];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoAnimatedStickerResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (unint64_t)hash
{
  ...
  float stickerScore = self->_stickerScore;
  float v5 = -stickerScore;
  if (stickerScore >= 0.0) {
    float v5 = self->_stickerScore;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoAnimatedStickerResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  self->_float stickerScore = *((float *)v4 + 2);
}
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          uint64_t v6 = objc_alloc_init(VCPProtoAnimatedStickerResult);
          CMTimeRange v9 = v10;
          id v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoAnimatedStickerResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoAnimatedStickerResult setStickerScore:](v6, "setStickerScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoAnimatedStickerResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  id v7 = NSNumber;
  [(VCPProtoAnimatedStickerResult *)self stickerScore];
