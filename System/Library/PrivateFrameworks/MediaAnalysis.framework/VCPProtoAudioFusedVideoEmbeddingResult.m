...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  if ((v14.start.flags & 1) != 0
    ...
    && v4)
  {
    v6 = objc_alloc_init(VCPProtoAudioFusedVideoEmbeddingResult);
    CMTimeRange v12 = v14;
    v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v12];
    [(VCPProtoAudioFusedVideoEmbeddingResult *)v6 setTimeRange:v7];

    v8 = [v5 objectForKeyedSubscript:@"embeddings"];
    if (v8)
    {
      [(VCPProtoAudioFusedVideoEmbeddingResult *)v6 setEmbeddingBlob:v8];
      v9 = [v5 objectForKeyedSubscript:@"embeddingVersion"];
      if (v9)
      {
        [(VCPProtoAudioFusedVideoEmbeddingResult *)v6 setHasVersion:1];
        [(VCPProtoAudioFusedVideoEmbeddingResult *)v6 setVersion:[v9 unsignedIntValue]];
      }
      v10 = v6;
    }
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1BBEDA000, v9, OS_LOG_TYPE_ERROR, "[VCPProtoAudioFusedVideoEmbeddingResult] embeddingValue is missing", buf, 2u);
      }
      v10 = 0;
    }
...
LABEL_20:
  ...
  VCPLogInstance();
  v6 = (VCPProtoAudioFusedVideoEmbeddingResult *)objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(&v6->super.super, OS_LOG_TYPE_ERROR))
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1BBEDA000, &v6->super.super, OS_LOG_TYPE_ERROR, "[VCPProtoAudioFusedVideoEmbeddingResult] timerange is invalid or attribute is missing", buf, 2u);
  }
  v10 = 0;
LABEL_21:
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoAudioFusedVideoEmbeddingResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  {
    v9 = objc_msgSend(NSNumber, "numberWithUnsignedInt:", -[VCPProtoAudioFusedVideoEmbeddingResult version](self, "version"));
...
- (id)description
{
  ...
  uint64_t v4 = [(VCPProtoAudioFusedVideoEmbeddingResult *)&v8 description];
  CFDictionaryRef v5 = [(VCPProtoAudioFusedVideoEmbeddingResult *)self dictionaryRepresentation];
