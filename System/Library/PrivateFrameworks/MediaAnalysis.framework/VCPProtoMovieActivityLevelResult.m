@interface VCPProtoMovieActivityLevelResult
...
@implementation VCPProtoMovieActivityLevelResult
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          v6 = objc_alloc_init(VCPProtoMovieActivityLevelResult);
          CMTimeRange v9 = v10;
          v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoMovieActivityLevelResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoMovieActivityLevelResult setActivityScore:](v6, "setActivityScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoMovieActivityLevelResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  v7 = NSNumber;
  [(VCPProtoMovieActivityLevelResult *)self activityScore];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieActivityLevelResult;
  uint64_t v4 = [(VCPProtoMovieActivityLevelResult *)&v8 description];
  CFDictionaryRef v5 = [(VCPProtoMovieActivityLevelResult *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&double v4 = self->_activityScore;
  v7 = [NSNumber numberWithFloat:v4];
  [v3 setObject:v7 forKey:@"activityScore"];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieActivityLevelResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(float *)(v5 + 8) = self->_activityScore;
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  BOOL v6 = [v4 isMemberOfClass:objc_opt_class()]
    ...
    && self->_activityScore == *((float *)v4 + 2);
...
- (unint64_t)hash
{
  ...
  float v5 = -activityScore;
  if (activityScore >= 0.0) {
    float v5 = self->_activityScore;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoMovieActivityLevelResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  self->_float activityScore = *((float *)v4 + 2);
}
