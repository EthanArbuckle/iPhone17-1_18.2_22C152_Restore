@interface MADServiceTextProcessingTask
...
- (MADServiceTextProcessingTask)initWithRequests:(id)a3 asset:(id)a4 cancelBlock:(id)a5 completionHandler:(id)a6
{
  ...
  if (v16)
  {
    ...
    dispatch_queue_t v21 = dispatch_queue_create("MADServiceTextProcessingTask", 0);
...
void __85__MADServiceTextProcessingTask_initWithRequests_asset_cancelBlock_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  id v5 = a3;
  id v6 = [a2 objectForKeyedSubscript:@"Payloads"];
...
- (BOOL)run:(id *)a3
{
  ...
  if (v6 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
  {
    ...
    *(_DWORD *)buf = 138412290;
    v68 = signpostPayload;
    _os_signpost_emit_with_name_impl(&dword_1BBEDA000, v8, OS_SIGNPOST_INTERVAL_BEGIN, v6, "MADServiceTextProcessingTask_Run", "%@", buf, 0xCu);
  }
...
LABEL_42:
  ...
  else
  {
    ...
    if (v30)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v31; ++j)
        {
          ...
          id v35 = objc_alloc_init(MEMORY[0x1E4F746A0]);
          v36 = [v34 results];
          [v35 setResults:v36];
    ...
    if (v53 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v38))
    {
      ...
      *(_DWORD *)buf = 138412290;
      v68 = v40;
      _os_signpost_emit_with_name_impl(&dword_1BBEDA000, v39, OS_SIGNPOST_INTERVAL_END, spid, "MADServiceTextProcessingTask_Run", "%@", buf, 0xCu);
    }
...
void __36__MADServiceTextProcessingTask_run___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    p_info = MADHEICSAlphaSequenceTranscoder.info;
    os_signpost_id_t v6 = &OBJC_IVAR___MADServiceTextProcessingTask__requests;
    do
    {
      for (uint64_t i = 0; i != v3; ++i)
      {
        ...
        v9 = [p_info + 31 subtaskForRequest:v8 asset:*(void *)(*(void *)(a1 + 32) + v6[1])];
        if (v9)
        {
