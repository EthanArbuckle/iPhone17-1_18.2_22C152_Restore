...
- (void)setHighlightScore:(float)a3;
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieHighlightScoreResult;
  v4 = [(VCPProtoMovieHighlightScoreResult *)&v8 description];
  v5 = [(VCPProtoMovieHighlightScoreResult *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&double v4 = self->_highlightScore;
  v7 = [NSNumber numberWithFloat:v4];
  [v3 setObject:v7 forKey:@"highlightScore"];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieHighlightScoreResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(float *)(v5 + 8) = self->_highlightScore;
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  BOOL v6 = [v4 isMemberOfClass:objc_opt_class()]
    ...
    && self->_highlightScore == *((float *)v4 + 2);
...
- (unint64_t)hash
{
  ...
  float highlightScore = self->_highlightScore;
  float v5 = -highlightScore;
  if (highlightScore >= 0.0) {
    float v5 = self->_highlightScore;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoMovieHighlightScoreResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  self->_float highlightScore = *((float *)v4 + 2);
}
...
- (float)highlightScore
{
  return self->_highlightScore;
}

- (void)setHighlightScore:(float)a3
{
  self->_float highlightScore = a3;
}
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          uint64_t v6 = objc_alloc_init(VCPProtoMovieHighlightScoreResult);
          CMTimeRange v9 = v10;
          id v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoMovieHighlightScoreResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoMovieHighlightScoreResult setHighlightScore:](v6, "setHighlightScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoMovieHighlightScoreResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
