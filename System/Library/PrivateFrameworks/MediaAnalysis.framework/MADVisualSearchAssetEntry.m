...
- (MADVisualSearchAssetEntry)initWithAsset:(id)a3 previousStatus:(unint64_t)a4 previousAttempts:(unint64_t)a5 andLastAttemptDate:(id)a6 analysisTypes:(unint64_t)a7;
- (NSData)result;
...
- (MADVisualSearchAssetEntry)initWithAsset:(id)a3 previousStatus:(unint64_t)a4 previousAttempts:(unint64_t)a5 andLastAttemptDate:(id)a6 analysisTypes:(unint64_t)a7
{
  ...
  id v14 = a6;
  v20.receiver = self;
  v20.super_class = (Class)MADVisualSearchAssetEntry;
