    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          [(VCPProtoMovieCheeringResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoMovieCheeringResult setConfidence:](v6, "setConfidence:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoMovieCheeringResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieCheeringResult;
  uint64_t v4 = [(VCPProtoMovieCheeringResult *)&v8 description];
  CFDictionaryRef v5 = [(VCPProtoMovieCheeringResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieCheeringResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoMovieCheeringResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
