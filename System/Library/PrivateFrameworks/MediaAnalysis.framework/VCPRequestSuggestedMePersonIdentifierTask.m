...
- (VCPRequestSuggestedMePersonIdentifierTask)initWithContext:(id)a3 andPhotoLibraryURL:(id)a4 andProgressHandler:(id)a5 andReply:(id)a6
{
  ...
  id v12 = a6;
  v18.receiver = self;
  v18.super_class = (Class)VCPRequestSuggestedMePersonIdentifierTask;
...
+ (id)taskWithContext:(id)a3 andPhotoLibraryURL:(id)a4 andProgressHandler:(id)a5 andReply:(id)a6
{
  ...
  id v11 = a5;
  id v12 = a6;
  id v13 = [objc_alloc((Class)objc_opt_class()) initWithContext:v9 andPhotoLibraryURL:v10 andProgressHandler:v11 andReply:v12];
...
- (void)dealloc
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)VCPRequestSuggestedMePersonIdentifierTask;
  [(VCPRequestSuggestedMePersonIdentifierTask *)&v10 dealloc];
}
...
- (int)run
{
  ...
  if (v4)
  {
    ...
    [v6 requestSuggestedMePersonIdentifierWithContext:self->_context reply:self->_reply];
