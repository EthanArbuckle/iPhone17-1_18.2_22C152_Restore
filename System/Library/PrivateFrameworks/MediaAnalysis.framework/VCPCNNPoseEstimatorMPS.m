...
- (VCPCNNPoseEstimatorMPS)init
{
  ...
  v6 = [(VCPCNNPoseEstimatorMPS *)&v33 init];
  if (!v6) {
    goto LABEL_23;
  }
...
LABEL_16:
  ...
  else
  {
    ...
    {
      v28 = +[VCPCNNFullConnectionBlock fcBlockWithNumNeurons:5 NeuronType:0];
      ...
      else
      {
        ...
        v26 = [MEMORY[0x1E4F1CB10] URLWithString:@"cnn_pose.dat" relativeToURL:v27];
        v24 = v6->_model;
...
- (int)computePoseScore:(float *)a3
{
  int v5 = [(VCPCNNData *)self->_input normalization];
  if (!v5)
  {
    ...
    if (!v5)
    {
      ...
      if (!v5)
      {
        ...
        memcpy(a3, (const void *)[v12 data], 4 * v8);
