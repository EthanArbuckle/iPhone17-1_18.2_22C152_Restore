...
- (VCPRequestReclusterFacesTask)initWithPhotoLibraryURL:(id)a3 andProgressHandler:(id)a4 andReply:(id)a5
{
  ...
  id v9 = a5;
  v15.receiver = self;
  v15.super_class = (Class)VCPRequestReclusterFacesTask;
...
- (void)dealloc
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)VCPRequestReclusterFacesTask;
...
- (int)run
{
  ...
  if (v4)
  {
    ...
    v12[3] = &unk_100219D98;
    v12[4] = self;
    [v6 reclusterFacesWithContext:&__NSDictionary0__struct reply:reply extendTimeout:&stru_10021E948 cancel:v12];
    int v8 = 0;
  }
  else
  {
    id v9 = (void (**)(id, void, void *))self->_reply;
