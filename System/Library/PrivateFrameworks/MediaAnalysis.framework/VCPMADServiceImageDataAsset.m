...
- (CGSize)resolution
{
  ...
  {
    id v13 = CGImageSourceCreateWithData((CFDataRef)self->_imageData, 0);
...
- (int)loadPixelBuffer:(__CVBuffer *)a3 orientation:(unsigned int *)a4
{
  ...
  if (!value)
  {
    ...
    {
      id v13 = [(VCPMADServiceImageAsset *)self signpostPayload];
      *(_DWORD *)v20 = 138412290;
      *(void *)&v20[4] = v13;
      _os_signpost_emit_with_name_impl(&dword_1BBEDA000, v12, OS_SIGNPOST_INTERVAL_BEGIN, v10, "VCPMADServiceImageDataAsset_Decode", "%@", v20, 0xCu);
    }
    id v14 = +[VCPImageManager sharedImageManager];
    *(void *)v20 = [v14 pixelBufferWithFormat:875704422 andMaxDimension:0 fromData:self->_imageData withUniformTypeIdentifier:self->_uniformTypeIdentifier flushCache:1 orientation:&self->_orientation];
    ...
    if (v10 - 1 < 0xFFFFFFFFFFFFFFFELL && os_signpost_enabled(v15))
    {
      ...
      *(_DWORD *)v20 = 138412290;
      *(void *)&v20[4] = v17;
      _os_signpost_emit_with_name_impl(&dword_1BBEDA000, v16, OS_SIGNPOST_INTERVAL_END, v10, "VCPMADServiceImageDataAsset_Decode", "%@", v20, 0xCu);
    }
