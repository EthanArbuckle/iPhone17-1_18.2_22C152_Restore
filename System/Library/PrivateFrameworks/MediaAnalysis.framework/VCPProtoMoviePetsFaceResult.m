@interface VCPProtoMoviePetsFaceResult
...
@implementation VCPProtoMoviePetsFaceResult

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMoviePetsFaceResult;
  v4 = [(VCPProtoMoviePetsFaceResult *)&v8 description];
  v5 = [(VCPProtoMoviePetsFaceResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMoviePetsFaceResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[VCPProtoMoviePetsFaceResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v9;
LABEL_7:
  bounds = self->_bounds;
  ...
  else
  {
    ...
    -[VCPProtoMoviePetsFaceResult setBounds:](self, "setBounds:");
  }
  id v4 = v9;
LABEL_13:
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v5 = [v4 objectForKeyedSubscript:@"petsBounds"];
  ...
  if (v14.start.flags)
  {
    ...
    if ((v14.duration.flags & 1) != 0 && !v14.duration.epoch)
    {
      ...
      {
        uint64_t v8 = objc_alloc_init(VCPProtoMoviePetsFaceResult);
        CMTimeRange v13 = v14;
        unint64_t v10 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v13];
        [(VCPProtoMoviePetsFaceResult *)v8 setTimeRange:v10];

        NSRect v16 = NSRectFromString(v5);
        unint64_t v11 = +[VCPProtoBounds boundsWithCGRect:](VCPProtoBounds, "boundsWithCGRect:", v16.origin.x, v16.origin.y, v16.size.width, v16.size.height);
        [(VCPProtoMoviePetsFaceResult *)v8 setBounds:v11];

        [v7 floatValue];
        -[VCPProtoMoviePetsFaceResult setConfidence:](v8, "setConfidence:");
      }
    }
  }
  else
...
- (id)exportToLegacyDictionary
{
  ...
  id v3 = [(VCPProtoMoviePetsFaceResult *)self timeRange];
  id v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  v15[0] = @"petsBounds";
  float v7 = [(VCPProtoMoviePetsFaceResult *)self bounds];
  [v7 rectValue];
  uint64_t v8 = NSStringFromRect(v18);
  v16[0] = v8;
  v15[1] = @"petsConfidence";
  id v9 = NSNumber;
  [(VCPProtoMoviePetsFaceResult *)self confidence];
  unint64_t v10 = objc_msgSend(v9, "numberWithFloat:");
  v16[1] = v10;
