@interface VCPProtoLivePhotoRecommendationResult
...
@implementation VCPProtoLivePhotoRecommendationResult
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          v6 = objc_alloc_init(VCPProtoLivePhotoRecommendationResult);
          CMTimeRange v9 = v10;
          v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoLivePhotoRecommendationResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoLivePhotoRecommendationResult setQualityScore:](v6, "setQualityScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoLivePhotoRecommendationResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  v7 = NSNumber;
  [(VCPProtoLivePhotoRecommendationResult *)self qualityScore];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoLivePhotoRecommendationResult;
  uint64_t v4 = [(VCPProtoLivePhotoRecommendationResult *)&v8 description];
  CFDictionaryRef v5 = [(VCPProtoLivePhotoRecommendationResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoLivePhotoRecommendationResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoLivePhotoRecommendationResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  self->_float qualityScore = *((float *)v4 + 2);
}
