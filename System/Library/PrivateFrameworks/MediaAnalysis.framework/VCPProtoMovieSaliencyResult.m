...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieSaliencyResult;
  v4 = [(VCPProtoMovieSaliencyResult *)&v8 description];
  v5 = [(VCPProtoMovieSaliencyResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieSaliencyResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[VCPProtoMovieSaliencyResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v9;
LABEL_7:
  bounds = self->_bounds;
  ...
  else
  {
    ...
    -[VCPProtoMovieSaliencyResult setBounds:](self, "setBounds:");
  }
  id v4 = v9;
LABEL_13:
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v5 = [v4 objectForKeyedSubscript:@"saliencyBounds"];
  uint64_t v6 = [v4 objectForKeyedSubscript:@"saliencyConfidence"];
  float v7 = (void *)v6;
  if (v14.start.flags)
  {
    uint64_t v8 = 0;
    if ((v14.duration.flags & 1) != 0 && !v14.duration.epoch)
    {
      ...
      {
        uint64_t v8 = objc_alloc_init(VCPProtoMovieSaliencyResult);
        CMTimeRange v13 = v14;
        unint64_t v10 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v13];
        [(VCPProtoMovieSaliencyResult *)v8 setTimeRange:v10];
        ...
        [(VCPProtoMovieSaliencyResult *)v8 setBounds:v11];

        [v7 floatValue];
        -[VCPProtoMovieSaliencyResult setConfidence:](v8, "setConfidence:");
      }
    }
  }
  else
...
- (id)exportToLegacyDictionary
{
  ...
  id v3 = [(VCPProtoMovieSaliencyResult *)self timeRange];
  id v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  float v7 = [(VCPProtoMovieSaliencyResult *)self bounds];
  [v7 rectValue];
