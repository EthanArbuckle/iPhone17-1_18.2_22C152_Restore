@interface VCPProtoImagePetsFaceResult
...
@implementation VCPProtoImagePetsFaceResult

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoImagePetsFaceResult;
  v4 = [(VCPProtoImagePetsFaceResult *)&v8 description];
  v5 = [(VCPProtoImagePetsFaceResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoImagePetsFaceResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    float v7 = v4;
    -[VCPProtoImagePetsFaceResult setBounds:](self, "setBounds:");
  }
  float v4 = v7;
LABEL_7:
}
...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  {
    unint64_t v8 = objc_alloc_init(VCPProtoImagePetsFaceResult);
    [v4 floatValue];
    -[VCPProtoImagePetsFaceResult setConfidence:](v8, "setConfidence:");
    ...
    [(VCPProtoImagePetsFaceResult *)v8 setBounds:v9];
  }
  return v8;
}
...
- (id)exportToLegacyDictionary
{
  ...
  id v3 = NSNumber;
  [(VCPProtoImagePetsFaceResult *)self confidence];
  float v4 = objc_msgSend(v3, "numberWithFloat:");
  v11[0] = v4;
  v10[1] = @"petsBounds";
  uint64_t v5 = [(VCPProtoImagePetsFaceResult *)self bounds];
  [v5 rectValue];
