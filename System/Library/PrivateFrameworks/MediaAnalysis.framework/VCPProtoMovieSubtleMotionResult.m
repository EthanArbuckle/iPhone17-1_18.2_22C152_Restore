...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieSubtleMotionResult;
  v4 = [(VCPProtoMovieSubtleMotionResult *)&v8 description];
  v5 = [(VCPProtoMovieSubtleMotionResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieSubtleMotionResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoMovieSubtleMotionResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          uint64_t v6 = objc_alloc_init(VCPProtoMovieSubtleMotionResult);
          CMTimeRange v9 = v10;
          id v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoMovieSubtleMotionResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoMovieSubtleMotionResult setActionScore:](v6, "setActionScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoMovieSubtleMotionResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
