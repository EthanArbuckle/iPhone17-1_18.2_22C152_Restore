...
- (void)setInterestScore:(float)a3;
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieInterestingnessResult;
...
- (id)dictionaryRepresentation
{
  ...
  *(float *)&double v4 = self->_interestScore;
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieInterestingnessResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(float *)(v5 + 8) = self->_interestScore;
  return (id)v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  BOOL v6 = [v4 isMemberOfClass:objc_opt_class()]
    ...
    && self->_interestScore == *((float *)v4 + 2);
...
- (unint64_t)hash
{
  ...
  float interestScore = self->_interestScore;
  float v5 = -interestScore;
  if (interestScore >= 0.0) {
    float v5 = self->_interestScore;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoMovieInterestingnessResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  self->_float interestScore = *((float *)v4 + 2);
}
...
- (float)interestScore
{
  return self->_interestScore;
}

- (void)setInterestScore:(float)a3
{
  self->_float interestScore = a3;
}
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          uint64_t v6 = objc_alloc_init(VCPProtoMovieInterestingnessResult);
          CMTimeRange v9 = v10;
          id v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoMovieInterestingnessResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoMovieInterestingnessResult setInterestScore:](v6, "setInterestScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoMovieInterestingnessResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
