...
+ (id)resultFromLegacyDictionary:(id)a3
{
  ...
  uint64_t v6 = [v5 objectForKeyedSubscript:@"featureVector"];
  v7 = (void *)v6;
  v8 = 0;
  if ((v12.flags & 1) != 0 && v6)
  {
...
- (id)exportToLegacyDictionary
{
  ...
  v14[0] = @"start";
  id v3 = [(VCPProtoMovieFeatureResult *)self timestamp];
  ...
  v15[0] = v5;
  v14[1] = @"attributes";
  CMTime v12 = @"featureVector";
  uint64_t v6 = [(VCPProtoMovieFeatureResult *)self featureBlob];
  v13 = v6;
...
- (id)description
{
  ...
  CFDictionaryRef v4 = [(VCPProtoMovieFeatureResult *)&v8 description];
  CFDictionaryRef v5 = [(VCPProtoMovieFeatureResult *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (timestamp)
  {
    CFDictionaryRef v5 = [(VCPProtoTime *)timestamp dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v8 = [(NSData *)self->_featureBlob copyWithZone:a3];
  v9 = (void *)v5[1];
  v5[1] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[VCPProtoTime isEqual:](timestamp, "isEqual:")))
  {
    ...
    if ((unint64_t)featureBlob | v4[1]) {
      char v7 = -[NSData isEqual:](featureBlob, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSData *)self->_featureBlob hash] ^ v3;
}
