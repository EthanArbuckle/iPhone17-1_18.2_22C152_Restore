...
+ (id)sharedTask
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10014296C;
  block[3] = &unk_100219838;
  block[4] = a1;
  if (qword_1002527D0 != -1) {
    dispatch_once(&qword_1002527D0, block);
  }
  v2 = (void *)qword_1002527C8;
  return v2;
}

+ (id)identifier
{
  return @"com.apple.mediaanalysisd.moments.deferred";
}

+ (int64_t)taskGracePeriod
{
  if (qword_1002527D8 != -1) {
    dispatch_once(&qword_1002527D8, &stru_10021E988);
  }
  if ((int)MediaAnalysisLogLevel() >= 7)
  {
    ...
    if (os_log_type_enabled(v2, v3))
    {
      ...
      __int16 v8 = 2048;
      uint64_t v9 = 3600;
      _os_log_impl((void *)&_mh_execute_header, v2, v3, "[%@] grace period %lld seconds", (uint8_t *)&v6, 0x16u);
    }
  }
  return 3600;
}
...
+ (int64_t)taskPriority
{
  if (qword_1002527E8 != -1) {
    dispatch_once(&qword_1002527E8, &stru_10021E9A8);
  }
  if ((int)MediaAnalysisLogLevel() >= 7)
  {
    v2 = VCPLogInstance();
    ...
    if (os_log_type_enabled(v2, v3))
    {
      ...
      v7 = v4;
      __int16 v8 = 1024;
      int v9 = byte_1002527E0;
      _os_log_impl((void *)&_mh_execute_header, v2, v3, "[%@] priority: %d", (uint8_t *)&v6, 0x12u);
    }
  }
  return byte_1002527E0;
}
...
- (void)submitTask:(id *)a3
{
  ...
  __int16 v8 = +[BGSystemTaskScheduler sharedScheduler];
  int v9 = [v8 taskRequestForIdentifier:v5];
  ...
  else
  {
    ...
    objc_msgSend(v13, "setPriority:", objc_msgSend((id)objc_opt_class(), "taskPriority"));
    [v13 setScheduleAfter:10.0];
    objc_msgSend(v13, "setTrySchedulingBefore:", (double)((uint64_t)objc_msgSend((id)objc_opt_class(), "taskGracePeriod") + 10));
