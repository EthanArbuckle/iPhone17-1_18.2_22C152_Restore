...
- (BOOL)run:(id *)a3;
- (MADSpotlightImageProcessingTask)initWithCancelBlock:(id)a3 progressHandler:(id)a4 andCompletionHandler:(id)a5;
- (int)_processAssets;
...
- (MADSpotlightImageProcessingTask)initWithCancelBlock:(id)a3 progressHandler:(id)a4 andCompletionHandler:(id)a5
{
  ...
  id v27 = v10;
  v25.receiver = self;
  v25.super_class = (Class)MADSpotlightImageProcessingTask;
  v11 = [(MADSpotlightImageProcessingTask *)&v25 initWithCompletionHandler:v26];
  if (v11)
  {
    ...
    dispatch_queue_t v16 = dispatch_queue_create("MADSpotlightImageProcessingTask.publish", 0);
    publishQueue = v11->_publishQueue;
    v11->_publishQueue = (OS_dispatch_queue *)v16;

    [(MADSpotlightImageProcessingTask *)v11 setCancelBlock:v8];
    id v24 = 0;
    id v18 = +[MADManagedSpotlightEntry countForMediaType:1 error:&v24];
    id v19 = v24;
...
- (int)_processAssets
{
  unsigned int v3 = [(MADSpotlightImageProcessingTask *)self isCanceled];
  ...
  if (v3)
  {
    if (v4 >= 3)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl((void *)&_mh_execute_header, v6, v7, "[Spotlight|Image] Analysis canceled", buf, 2u);
      }
    }
    return -128;
  }
  else
  {
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl((void *)&_mh_execute_header, v8, v9, "[Spotlight|Image] Analyze all image/keyframe assets", buf, 2u);
      }
    }
    v28 = v30;
    *(void *)&long long v5 = 67109120;
    ...
    while (1)
    {
      ...
      if ((int)MediaAnalysisLogLevel() >= 5)
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl((void *)&_mh_execute_header, v12, v9, "[Spotlight|Image] Fetching asset", buf, 2u);
        }
      }
      id v37 = 0;
      v13 = +[MADManagedSpotlightEntry fetchEntriesWithMediaType:fetchLimit:error:](MADManagedSpotlightEntry, "fetchEntriesWithMediaType:fetchLimit:error:", 1, 100, &v37, v27, v28);
      id v14 = v37;
      if ((int)MediaAnalysisLogLevel() >= 5)
      {
        v15 = VCPLogInstance();
        if (os_log_type_enabled(v15, v9))
        {
          ...
          *(_DWORD *)&uint8_t buf[4] = v16;
          _os_log_impl((void *)&_mh_execute_header, v15, v9, "[Spotlight|Image] Fetched %d asset", buf, 8u);
        }
      }
      if (![v13 count]) {
        break;
      }
      id v17 = [(MADSpotlightImageProcessingTask *)self cancelBlock];
      id v18 = +[MADSpotlightImageAssetBatch batchWithCancelBlock:v17];
      ...
      *(void *)buf = 0;
      ...
      id v24 = v18;
      id v31 = v24;
      [v23 runBlock:v29 withTaskID:17];
...
- (BOOL)run:(id *)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, v8, OS_SIGNPOST_INTERVAL_BEGIN, v6, "MADSpotlightImageProcessingTask", (const char *)&unk_1001F3BD3, buf, 2u);
  }
  ...
  if ((int)MediaAnalysisLogLevel() >= 5)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v9, v10, "[Spotlight|Image] Processing image/keyframe assets", buf, 2u);
    }
  }
  int publishError = [(MADSpotlightImageProcessingTask *)self _processAssets];
  dispatch_group_wait((dispatch_group_t)self->_publishGroup, 0xFFFFFFFFFFFFFFFFLL);
  if (!publishError) {
  ...
  if ((int)MediaAnalysisLogLevel() >= 5)
  {
    ...
    if (os_log_type_enabled(v12, v13))
    {
      *(_DWORD *)buf = 67109120;
      ...
      _os_log_impl((void *)&_mh_execute_header, v12, v13, "[Spotlight|Image] Error: %d", buf, 8u);
    }
  }
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl((void *)&_mh_execute_header, v15, OS_SIGNPOST_INTERVAL_END, v6, "MADSpotlightImageProcessingTask", (const char *)&unk_1001F3BD3, buf, 2u);
  }

  if (!publishError)
  {
    id v17 = [(MADSpotlightImageProcessingTask *)self completionHandler];
    v17[2](v17, 0, 0);
LABEL_23:
  ...
  if (a3)
  {
    ...
    id v17 = +[NSString stringWithFormat:@"[Spotlight|Image] Processing %s", v16];
    v23 = v17;
