@interface VCPProtoMovieMusicResult
...
@implementation VCPProtoMovieMusicResult

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoMovieMusicResult;
  v4 = [(VCPProtoMovieMusicResult *)&v8 description];
  v5 = [(VCPProtoMovieMusicResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoMovieMusicResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoMovieMusicResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          uint64_t v6 = objc_alloc_init(VCPProtoMovieMusicResult);
          CMTimeRange v9 = v10;
          id v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoMovieMusicResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoMovieMusicResult setConfidence:](v6, "setConfidence:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoMovieMusicResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  id v7 = NSNumber;
  [(VCPProtoMovieMusicResult *)self confidence];
