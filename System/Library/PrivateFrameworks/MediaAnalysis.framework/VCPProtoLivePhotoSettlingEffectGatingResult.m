@interface VCPProtoLivePhotoSettlingEffectGatingResult
...
@implementation VCPProtoLivePhotoSettlingEffectGatingResult
  ...
  if (v10.start.flags)
  {
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          v6 = objc_alloc_init(VCPProtoLivePhotoSettlingEffectGatingResult);
          CMTimeRange v9 = v10;
          v7 = +[VCPProtoTimeRange timeRangeWithCMTimeRange:&v9];
          [(VCPProtoLivePhotoSettlingEffectGatingResult *)v6 setTimeRange:v7];

          [v5 floatValue];
          -[VCPProtoLivePhotoSettlingEffectGatingResult setScore:](v6, "setScore:");
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  CFDictionaryRef v3 = [(VCPProtoLivePhotoSettlingEffectGatingResult *)self timeRange];
  uint64_t v4 = v3;
  if (v3) {
    [v3 timeRangeValue];
  }
  ...
  v7 = NSNumber;
  [(VCPProtoLivePhotoSettlingEffectGatingResult *)self score];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)VCPProtoLivePhotoSettlingEffectGatingResult;
  uint64_t v4 = [(VCPProtoLivePhotoSettlingEffectGatingResult *)&v8 description];
  CFDictionaryRef v5 = [(VCPProtoLivePhotoSettlingEffectGatingResult *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return VCPProtoLivePhotoSettlingEffectGatingResultReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    id v7 = v4;
    -[VCPProtoLivePhotoSettlingEffectGatingResult setTimeRange:](self, "setTimeRange:");
  }
  id v4 = v7;
LABEL_7:
