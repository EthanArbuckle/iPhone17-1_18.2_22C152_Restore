...
+ (uint64_t)performBlockAtIdle:()NPHIdleTime
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315138;
    ...
    _os_log_impl(&dword_235444000, v5, OS_LOG_TYPE_DEFAULT, "%s", buf, 0xCu);
  }
...
+ (void)NPHRequestIdleTimeNotification
{
  ...
  if (os_log_type_enabled(v0, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_235444000, v0, OS_LOG_TYPE_DEFAULT, "%s", (uint8_t *)&v3, 0xCu);
  }
...
+ (void)_NPHIdleTimeNotification:()NPHIdleTime
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_235444000, v2, OS_LOG_TYPE_DEFAULT, "%s sIdleBlocks.count:%lu", (uint8_t *)&v8, 0x16u);
  }
  ...
  if (v3)
  {
    ...
    if (v5 * -1000.0 > 100.0)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        ...
        _os_log_impl(&dword_235444000, v7, OS_LOG_TYPE_DEFAULT, "******* %s BLOCKING MAIN THREAD: %f", (uint8_t *)&v8, 0x16u);
      }
    }
