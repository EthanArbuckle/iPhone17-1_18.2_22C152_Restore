...
- (WPScanRequest)init
{
  ...
  if (v2)
  {
    ...
    *(_OWORD *)&v2->_scanningRates.screenOnInterval = v4;
    ...
    v2->_rssiThreshold = (NSNumber *)&unk_26C53DFC8;
    ...
    *(_WORD *)&v3->_activeScanning = 0;
    ...
    v3->_clientType = 27;
    v3->_updateTime = 0.0;
    *(_OWORD *)&v3->_nearbyScanMode = xmmword_2144DEB90;
...
- (id)description
{
  ...
  uint64_t v13 = [(WPScanRequest *)self useCaseList];
  uint64_t v14 = [(WPScanRequest *)self convertUseCaseToString:v13];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v4)
  {
    ...
    BOOL v10 = [(WPScanRequest *)self useCaseList];
...
- (WPScanRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v28 count:2];
