  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      v45 = v42;
      _os_log_impl(&dword_21FBF2000, v6, OS_LOG_TYPE_DEFAULT, "Components: %@", buf, 0xCu);
    }
...
- (int64_t)synchronouslycopyAuthStatus
{
  ...
  uint64_t v15 = 0;
  v3 = dispatch_queue_create("com.apple.corerepair.authsyncqueue", MEMORY[0x263EF83A8]);
...
- (BOOL)_checkForComponentFailureInDefaults:(id)a3
{
  ...
  if (!v4)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl(&dword_21FBF2000, v5, OS_LOG_TYPE_DEFAULT, "Reading system health from file", buf, 2u);
    }
    ...
    uint64_t v19 = objc_msgSend_dictionaryWithContentsOfFile_(NSDictionary, v17, (uint64_t)v14, v18);
    uint64_t v13 = v19;
    if (!v19
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v30 = v3;
      _os_log_impl(&dword_21FBF2000, v27, OS_LOG_TYPE_DEFAULT, "Found failed component: %@", buf, 0xCu);
    }
...
LABEL_16:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_21FBF2000, v5, OS_LOG_TYPE_DEFAULT, "Reading system health from defaults", buf, 2u);
  }
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412290;
      id v30 = v3;
      _os_log_impl(&dword_21FBF2000, v14, OS_LOG_TYPE_DEFAULT, "Found failed component: %@", buf, 0xCu);
    }
    goto LABEL_14;
  }
LABEL_17:
  ...
  else
  {
    if (v6)
    {
      *(_WORD *)uint64_t v24 = 0;
      _os_log_impl(&dword_21FBF2000, v5, OS_LOG_TYPE_DEFAULT, "Reading system health from file", v24, 2u);
    }
    ...
    uint64_t v18 = objc_msgSend_dictionaryWithContentsOfFile_(NSDictionary, v16, (uint64_t)v10, v17);
    uint64_t v21 = v18;
    if (v18)
    {
...
- (id)findUnsealedData
{
  if (qword_267EF81D8 != -1) {
    dispatch_once(&qword_267EF81D8, &unk_26D157828);
  }
  uint64_t v2 = (void *)qword_267EF81D0;
  return v2;
}
