...
- (int64_t)copyComponentStatus
{
  if (objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, a2, @"NBCl", v2))
  {
...
LABEL_15:
        ...
        {
          *(_WORD *)v48 = 0;
          _os_log_impl(&dword_21FBF2000, v46, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", v48, 2u);
        }
      }
    }
    else
