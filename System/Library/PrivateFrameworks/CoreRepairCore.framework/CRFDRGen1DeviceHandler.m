@interface CRFDRGen1DeviceHandler
...
- (id)getMakeDataClassesAndInstancesWithPartSPC:(id)a3 fdrRemote:(__AMFDR *)a4 makePropertiesDict:(id *)a5 fdrError:(id *)a6
{
  ...
  if (objc_msgSend_containsObject_(v8, v16, @"IPHONE COMP FACEID", v17)
    && (long long v80 = 0u,
        ...
        long long v78 = 0u,
        long long v79 = 0u,
        (uint64_t v53 = objc_msgSend_countByEnumeratingWithState_objects_count_(&unk_26D1635A8, v52, (uint64_t)&v78, (uint64_t)v82, 16)) != 0))
  {
    uint64_t v56 = v53;
    ...
    while (2)
    {
      ...
      {
        if (*(void *)v79 != v57) {
          objc_enumerationMutation(&unk_26D1635A8);
        }
      ...
      uint64_t v56 = objc_msgSend_countByEnumeratingWithState_objects_count_(&unk_26D1635A8, v54, (uint64_t)&v78, (uint64_t)v82, 16);
      v65 = 0;
      if (v56) {
        continue;
      }
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        {
          id v34 = 0;
          int v18 = objc_msgSend__addDataClassAndInstanceToMutableDictionary_dataClass_withError_(self, v16, (uint64_t)v31, @"bcrt", &v34);
          id v19 = v34;
          uint64_t v20 = v19;
          if (!v18 || v19)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR)) {
              sub_21FC60F58((uint64_t)v20, v22, v23, v24, v25, v26, v27, v28);
            }
...
- (id)spcInPartSPC:(id)a3 withDataClass:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  if (!objc_msgSend_isEqual_(@"bcrt", v7, (uint64_t)v6, v8)
    || (uint64_t v11 = @"IPHONE COMP BATTERY",
        (objc_msgSend_containsObject_(v5, v9, @"IPHONE COMP BATTERY", v10) & 1) == 0))
  {
    if (objc_msgSend_containsObject_(&unk_26D1635A8, v9, (uint64_t)v6, v10))
    {
