...
LABEL_22:
      ...
      {
        *(_WORD *)v50 = 0;
        _os_log_impl(&dword_21FBF2000, v48, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", v50, 2u);
      }
    }
LABEL_18:
...
- (BOOL)_isLegacyMesaInInvalidState
{
  ...
  if (!objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, a2, @"FSCl", v2))return 0; {
  uint64_t v19 = @"QueryPath";
  }
  v20[0] = @"QueryPath_Straight";
  uint64_t v4 = objc_msgSend_dictionaryWithObjects_forKeys_count_(NSDictionary, v3, (uint64_t)v20, (uint64_t)&v19, 1);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      int v17 = 138543362;
      v18 = v5;
      _os_log_impl(&dword_21FBF2000, v16, OS_LOG_TYPE_DEFAULT, "Invalid Mesa: %{public}@", (uint8_t *)&v17, 0xCu);
    }
