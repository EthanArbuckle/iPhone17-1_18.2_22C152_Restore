...
- (int64_t)copyComponentStatus
{
  ...
  v2 = self;
  objc_sync_enter(v2);
  if ((objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, v3, @"CmCl", v4) & 1) == 0)
  {
    v5 = 0;
    v6 = 0;
...
LABEL_27:
    ...
    v89 = objc_msgSend_spcResults_(CRPreflightUtils, v32, (uint64_t)v21, v33);
    ...
    if (v40)
    {
      ...
      if (isEqualToSet)
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_21FBF2000, v56, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
        }
    ...
    if (v60)
    {
        ...
        && (objc_msgSend_containsObject_(v90, v75, @"IPHONE COMP CAMERA", v76) & 1) == 0)
      {
        ...
        if ((v87 & 1) == 0)
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_impl(&dword_21FBF2000, v88, OS_LOG_TYPE_DEFAULT, "Camera component passed preflight with no pass SPC", buf, 2u);
          }
...
LABEL_23:
          ...
          if (os_log_type_enabled(v79, OS_LOG_TYPE_DEFAULT))
          {
            *(_DWORD *)buf = 138412290;
            v94 = v5;
            _os_log_impl(&dword_21FBF2000, v79, OS_LOG_TYPE_DEFAULT, "FDR Validation status:%@", buf, 0xCu);
          }
...
- (id)getCmClValidationStatus
{
  uint64_t isFDRDataClassSupported = objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, a2, @"CmCl", v2);
  if (isFDRDataClassSupported)
  {
    io_registry_entry_t v5 = sub_21FC054EC(isFDRDataClassSupported, v4);
    if (v5)
    {
      CFProperty = (void *)IORegistryEntryCreateCFProperty(v5, @"CmClValidationStatus", (CFAllocatorRef)*MEMORY[0x263EFFB08], 0);
      goto LABEL_8;
    }
    objc_super v7 = handleForCategory(0);
