...
LABEL_14:
      ...
      v36 = objc_msgSend_spcResults_(CRPreflightUtils, v34, (uint64_t)v21, v35);
...
LABEL_23:
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_impl(&dword_21FBF2000, v83, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
          }
...
LABEL_47:
      v125 = handleForCategory(0);
      v33 = v135;
      if (os_log_type_enabled(v125, OS_LOG_TYPE_DEFAULT))
      {
        *(_WORD *)v136 = 0;
        _os_log_impl(&dword_21FBF2000, v125, OS_LOG_TYPE_DEFAULT, "FaceID component passed preflight with no pass SPC", v136, 2u);
      }
