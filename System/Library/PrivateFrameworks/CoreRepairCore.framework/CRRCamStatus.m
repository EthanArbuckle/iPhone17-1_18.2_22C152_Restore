...
- (int64_t)getIORegComponentStatus
{
  io_registry_entry_t v2 = sub_21FC054EC((uint64_t)self, a2);
  if (v2)
  {
    io_registry_entry_t v3 = v2;
    CFAllocatorRef v4 = (const __CFAllocator *)*MEMORY[0x263EFFB08];
    CFProperty = (void *)IORegistryEntryCreateCFProperty(v2, @"BackTeleCameraExpected", (CFAllocatorRef)*MEMORY[0x263EFFB08], 0);
