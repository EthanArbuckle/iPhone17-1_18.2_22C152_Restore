...
- (int64_t)copyComponentStatus
{
  v2 = self;
  objc_sync_enter(v2);
  if (objc_msgSend_isFDRPropertySupported_(CRFDRBaseDeviceHandler, v3, @"RCSn", v4))
  {
...
LABEL_15:
      ...
      {
        *(_WORD *)v46 = 0;
        _os_log_impl(&dword_21FBF2000, v44, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", v46, 2u);
      }
    }
    goto LABEL_14;
  }
