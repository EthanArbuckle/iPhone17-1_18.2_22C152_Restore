...
+ (BOOL)isVeridianFWUpdateRequired
{
  ...
  {
    v10 = objc_msgSend_sharedDataAccessor(MEMORY[0x263F53618], v7, v8, v9);
    id v33 = 0;
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v37 = 1024;
        BOOL v38 = updated != 0;
        _os_log_impl(&dword_21FBF2000, v17, OS_LOG_TYPE_DEFAULT, "isVeridianUpdateRequired :%@:%d", buf, 0x12u);
      }
      id v13 = 0;
    }
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR)) {
        sub_21FC5E42C((uint64_t)v13, v17, v18, v19, v20, v21, v22, v23);
      }
      v24 = 0;
      BOOL v25 = 1;
    }
...
+ (BOOL)isVeridianFWUpdateRequiredLite
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR)) {
      sub_21FC5E498((uint64_t)v3, (uint64_t)v8, v20);
    }
    goto LABEL_12;
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v34 = v9;
    _os_log_impl(&dword_21FBF2000, v10, OS_LOG_TYPE_DEFAULT, "completeFWPath :%@", buf, 0xCu);
  }
  ...
  if (!v9)
  {
    uint64_t v20 = handleForCategory(0);
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR)) {
      sub_21FC5E520(v20, v23, v24, v25, v26, v27, v28, v29);
    }
LABEL_12:
    v17 = 0;
    uint64_t v9 = 0;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v35 = 1024;
    BOOL v36 = v21;
    _os_log_impl(&dword_21FBF2000, v20, OS_LOG_TYPE_DEFAULT, "isVeridianUpdateRequired :%@:%d", buf, 0x12u);
  }
LABEL_13:
...
+ (id)getDataPayload:(id)a3 instance:(id)a4
{
  return (id)MEMORY[0x270F9A6D0](CRFDRUtils, sel_getDataPayload_instance_, a3, a4);
}

+ (id)getDataPayloadForDataClass:(id)a3
{
  return (id)MEMORY[0x270F9A6D0](CRFDRUtils, sel_getDataPayload_instance_, a3, 0);
}
...
+ (id)getSsrBootIntentWithError:(id *)a3
{
  ...
  id v41 = 0;
  uint64_t v4 = objc_msgSend_readNVRAMValueForKey_error_(CRNVRAMController, a2, @"diagnostic-boot-intent", (uint64_t)&v41);
  id v5 = v41;
...
LABEL_8:
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v43 = v4;
    _os_log_impl(&dword_21FBF2000, v7, OS_LOG_TYPE_DEFAULT, "readNVRAMValueForKey value: %@", buf, 0xCu);
  }
  ...
  {
    id v40 = 0;
    v11 = objc_msgSend_JSONObjectWithData_options_error_(MEMORY[0x263F08900], v16, (uint64_t)v4, 0, &v40);
    id v5 = v40;
    if (!v11)
    {
      uint64_t v7 = handleForCategory(0);
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
        sub_21FC5E61C((uint64_t)v5, v7, v34, v35, v36, v37, v38, v39);
      }
      goto LABEL_7;
    }
    ...
    if (v9)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        if (objc_msgSend_isEqual_(v9, v19, @"self-service-repair", v20))
        {
          ...
          v10 = objc_msgSend_decryptWiFiCredDictFromCredentialsData_(CRWiFiCredentials, v27, (uint64_t)v7, v28);
          if (v10)
          {
            objc_opt_class();
            if (objc_opt_isKindOfClass()) {
