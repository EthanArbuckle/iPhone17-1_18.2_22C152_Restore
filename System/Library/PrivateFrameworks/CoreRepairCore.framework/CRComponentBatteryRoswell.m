@interface CRComponentBatteryRoswell
+ (id)sharedSingleton;
...
+ (id)sharedSingleton
{
  ...
  block[1] = 3221225472;
  block[2] = sub_21FC1D534;
  block[3] = &unk_26452A940;
  block[4] = a1;
  if (qword_26AC13400 != -1) {
    dispatch_once(&qword_26AC13400, block);
  }
  v2 = (void *)qword_26AC13438;
  return v2;
}
...
LABEL_13:
  ...
  *((unsigned char *)v54 + 24) = 1;
  ...
  v33 = objc_msgSend_initWithComponentType_identifier_signedResponse_keyIndex_properties_(v31, v32, @"bcrt", (uint64_t)self->identifierBase64, v30, 0, 0);
  v34 = 0;
LABEL_14:
...
- (void)signbatteryRoswellWith:(id)a3 withReply:(id)a4
{
  ...
  uint64_t v26 = sub_21FC1D978;
  int v27 = sub_21FC1D988;
