...
- (int64_t)copyComponentStatus
{
  int isFDRDataClassSupported = objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, a2, @"tcrt", v2);
  int v7 = objc_msgSend_isFDRDataClassSupported_(CRFDRBaseDeviceHandler, v5, @"dCfg", v6);
...
LABEL_18:
  ...
  v40 = objc_msgSend_spcResults_(CRPreflightUtils, v38, (uint64_t)v25, v39);
...
LABEL_27:
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_21FBF2000, v84, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
      }
...
LABEL_52:
    v127 = handleForCategory(0);
    if (os_log_type_enabled(v127, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)v142 = 0;
      _os_log_impl(&dword_21FBF2000, v127, OS_LOG_TYPE_DEFAULT, "Display component passed preflight with no pass SPC", v142, 2u);
    }
