...
- (double)score
{
  ...
  if (v1)
  {
    ...
    id v11 = 0;
    v4 = [MEMORY[0x1E4F28D90] JSONObjectWithData:v3 options:0 error:&v11];
    id v5 = v11;
    if (v4)
    {
...
- (void)score
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_1A431F000, a2, OS_LOG_TYPE_ERROR, "Failed to get seq2seq score, normCost is not of string class type: %@", (uint8_t *)&v2, 0xCu);
}
