@interface WFCarPlayConnectionTriggerConfigurationViewController
- (WFCarPlayConnectionTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4;
- (id)customSections;
...
@implementation WFCarPlayConnectionTriggerConfigurationViewController
...
{
  id v5 = a4;
  -[WFCarPlayConnectionTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
  id v7 = (id)objc_claimAutoreleasedReturnValue();
  [(WFTriggerConfigurationViewController *)self didSelectRowAtIndexPath:v5 withSectionInfo:v7];

  BOOL v6 = [(WFTriggerConfigurationViewController *)self tableView];
  [v6 reloadData];
}

- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  v4 = [(WFCarPlayConnectionTriggerConfigurationViewController *)self infoForSection:a4];
  ...
  {
    id v7 = [v4 objectForKeyedSubscript:@"sectionTitle"];
  }
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  v8 = -[WFCarPlayConnectionTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v6 section]);
  ...
  else
  {
    ...
    objc_msgSend(v34, "setLeftViewSelected:", objc_msgSend(v23, "onConnect"));

    v24 = [(WFTriggerConfigurationViewController *)self trigger];
    objc_msgSend(v34, "setRightViewSelected:", objc_msgSend(v24, "onDisconnect"));
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  id v5 = [(WFCarPlayConnectionTriggerConfigurationViewController *)self infoForSection:a4];
...
{
  v5.receiver = self;
  v5.super_class = (Class)WFCarPlayConnectionTriggerConfigurationViewController;
  [(WFCarPlayConnectionTriggerConfigurationViewController *)&v5 viewWillAppear:a3];
...
- (WFCarPlayConnectionTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, self, @"WFCarPlayConnectionTriggerConfigurationViewController.m", 30, @"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFCarPlayConnectionTrigger class]]" object file lineNumber description];
  }
  v13.receiver = self;
  v13.super_class = (Class)WFCarPlayConnectionTriggerConfigurationViewController;
