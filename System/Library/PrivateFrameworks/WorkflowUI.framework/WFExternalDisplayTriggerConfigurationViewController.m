...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  int64_t v4 = [(WFExternalDisplayTriggerConfigurationViewController *)self infoForSection:a4];
...
{
  id v5 = a4;
  BOOL v6 = -[WFExternalDisplayTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  id v5 = [(WFExternalDisplayTriggerConfigurationViewController *)self infoForSection:a4];
...
- (WFExternalDisplayTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, self, @"WFExternalDisplayTriggerConfigurationViewController.m", 31, @"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFExternalDisplayTrigger class]]" object file lineNumber description];
  }
  v13.receiver = self;
  v13.super_class = (Class)WFExternalDisplayTriggerConfigurationViewController;
