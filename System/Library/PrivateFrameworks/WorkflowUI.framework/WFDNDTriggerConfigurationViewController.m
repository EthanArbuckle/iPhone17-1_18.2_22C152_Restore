@interface WFDNDTriggerConfigurationViewController
- (WFDNDTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4;
- (id)customSections;
...
@implementation WFDNDTriggerConfigurationViewController
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  v4 = [(WFDNDTriggerConfigurationViewController *)self infoForSection:a4];
...
{
  id v5 = a4;
  -[WFDNDTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  v8 = -[WFDNDTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v6 section]);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  id v5 = [(WFDNDTriggerConfigurationViewController *)self infoForSection:a4];
...
{
  v5.receiver = self;
  v5.super_class = (Class)WFDNDTriggerConfigurationViewController;
  [(WFDNDTriggerConfigurationViewController *)&v5 viewWillAppear:a3];
...
- (WFDNDTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, self, @"WFDNDTriggerConfigurationViewController.m", 31, @"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFDNDTrigger class]]" object file lineNumber description];
  }
  v13.receiver = self;
  v13.super_class = (Class)WFDNDTriggerConfigurationViewController;
