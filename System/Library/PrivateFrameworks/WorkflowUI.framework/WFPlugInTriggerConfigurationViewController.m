@interface WFPlugInTriggerConfigurationViewController
- (WFPlugInTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4;
- (id)customSections;
...
@implementation WFPlugInTriggerConfigurationViewController
...
{
  id v5 = a4;
  -[WFPlugInTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  int64_t v4 = [(WFPlugInTriggerConfigurationViewController *)self infoForSection:a4];
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  id v5 = [(WFPlugInTriggerConfigurationViewController *)self infoForSection:a4];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  v8 = -[WFPlugInTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v6 section]);
...
- (WFPlugInTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, self, @"WFPlugInTriggerConfigurationViewController.m", 31, @"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFPlugInTrigger class]]" object file lineNumber description];
  }
  v13.receiver = self;
  v13.super_class = (Class)WFPlugInTriggerConfigurationViewController;
