@interface WFLowPowerModeTriggerConfigurationViewController
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  v4 = [(WFLowPowerModeTriggerConfigurationViewController *)self infoForSection:a4];
...
{
  id v5 = a4;
  -[WFLowPowerModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  v8 = -[WFLowPowerModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v6 section]);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  id v5 = [(WFLowPowerModeTriggerConfigurationViewController *)self infoForSection:a4];
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  [(WFLowPowerModeTriggerConfigurationViewController *)&v5 viewWillAppear:a3];
...
- (WFLowPowerModeTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, self, @"WFLowPowerModeTriggerConfigurationViewController.m", 31, @"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFLowPowerModeTrigger class]]" object file lineNumber description];
  }
  v13.receiver = self;
