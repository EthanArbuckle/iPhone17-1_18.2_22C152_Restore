...
- (model_period_10pctInput)initWithIn:(id)a3;
...
- (model_period_10pctInput)initWithIn:(id)a3
{
  return [(model_period_10pctInput *)self initWithIn:a3 lstm_1_h_in:0 lstm_1_c_in:0];
}
...
- (model_period_10pctInput)initWithIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5
{
  ...
  id v11 = a5;
  v15.receiver = self;
  v15.super_class = (Class)model_period_10pctInput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_26E28F938];
}
...
LABEL_11:
  ...
  if ([v4 isEqualToString:@"lstm_1_h_in"])
  {
    ...
    if (v6)
    {
      ...
      uint64_t v9 = [(model_period_10pctInput *)self lstm_1_h_in];
LABEL_9:
      id v10 = (void *)v9;
  ...
  if ([v4 isEqualToString:@"lstm_1_c_in"])
  {
    ...
    {
      v8 = (void *)MEMORY[0x263F00D50];
      uint64_t v9 = [(model_period_10pctInput *)self lstm_1_c_in];
      goto LABEL_9;
    }
LABEL_10:
    v7 = 0;
