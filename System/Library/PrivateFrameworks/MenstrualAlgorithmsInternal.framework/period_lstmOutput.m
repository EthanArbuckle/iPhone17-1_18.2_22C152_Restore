...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_26E28F920];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"out"])
  {
    ...
    uint64_t v6 = [(period_lstmOutput *)self out];
LABEL_7:
    v7 = (void *)v6;
  ...
  {
    v5 = (void *)MEMORY[0x263F00D50];
    uint64_t v6 = [(period_lstmOutput *)self lstm_1_h_out];
    goto LABEL_7;
  }
  if ([v4 isEqualToString:@"lstm_1_c_out"])
  {
    v5 = (void *)MEMORY[0x263F00D50];
    uint64_t v6 = [(period_lstmOutput *)self lstm_1_c_out];
    goto LABEL_7;
  }
  v8 = 0;
LABEL_8:
