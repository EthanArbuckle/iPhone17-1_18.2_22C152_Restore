...
- (model_period_10pctOutput)initWithOut:(id)a3 lstm_1_h_out:(id)a4 lstm_1_c_out:(id)a5
{
  ...
  id v11 = a5;
  v15.receiver = self;
  v15.super_class = (Class)model_period_10pctOutput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_26E28F950];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"out"])
  {
    ...
    uint64_t v6 = [(model_period_10pctOutput *)self out];
LABEL_7:
    v7 = (void *)v6;
  ...
  {
    v5 = (void *)MEMORY[0x263F00D50];
    uint64_t v6 = [(model_period_10pctOutput *)self lstm_1_h_out];
    goto LABEL_7;
  }
  if ([v4 isEqualToString:@"lstm_1_c_out"])
  {
    v5 = (void *)MEMORY[0x263F00D50];
    uint64_t v6 = [(model_period_10pctOutput *)self lstm_1_c_out];
    goto LABEL_7;
  }
  v8 = 0;
LABEL_8:
