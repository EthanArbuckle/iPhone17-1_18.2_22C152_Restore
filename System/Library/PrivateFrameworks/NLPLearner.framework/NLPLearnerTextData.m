...
+ (void)initialize
{
  ...
  {
    sLog = (uint64_t)os_log_create("com.apple.NLP", "NLPLearnerTextData");
    MEMORY[0x270F9A758]();
  }
}
...
+ (id)dataForTask:(int64_t)a3 andLocale:(id)a4
{
  ...
  {
    id v6 = (void *)[objc_alloc(*off_264BEE9E8[a3 - 1]) initWithLocale:v5];
  }
...
+ (id)dataForPFL:(int64_t)a3 andLocale:(id)a4
{
  ...
  {
    id v6 = (void *)[objc_alloc(*off_264BEEA20[a3 - 1]) initWithLocale:v5];
  }
...
- (BOOL)loadFromCoreDuet:(id)a3 limitSamplesTo:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG)) {
    -[NLPLearnerTextData loadFromCoreDuet:limitSamplesTo:](buf, [v18 count], v6);
  }
...
- (unint64_t)numSamples
{
  return [(NSMutableArray *)self->_sentences count];
}
...
- (BOOL)loadFromCoreDuet:(id)a3 limitSamplesTo:(unint64_t)a4 withLocale:(id)a5 andLMStreamTokenizationBlock:(id)a6
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
    -[NLPLearnerTextData loadFromCoreDuet:limitSamplesTo:](buf, [v23 count], v11);
  }
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0_0(&dword_234530000, v0, v1, "NLPLearnerTask %ld is not supported", v2, v3, v4, v5, v6);
}
...
- (void)loadFromCoreDuet:(os_log_t)log limitSamplesTo:.cold.1(uint8_t *buf, uint64_t a2, os_log_t log)
{
  ...
  *(void *)(buf + 4) = a2;
  _os_log_debug_impl(&dword_234530000, log, OS_LOG_TYPE_DEBUG, "Processing %ld events extracted from CoreDuet", buf, 0xCu);
}

- (void)addResource:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0_0(&dword_234530000, v0, v1, "Unexpected call to addResource with '%@'", v2, v3, v4, v5, v6);
}
