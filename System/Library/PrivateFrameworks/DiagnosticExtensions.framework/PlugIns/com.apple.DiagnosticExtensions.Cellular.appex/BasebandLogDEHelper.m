...
LABEL_108:
  ...
  *(_OWORD *)v116 = v7;
  *(_OWORD *)&v116[16] = v7;
  sub_100004BE0((uint64_t)v116, "CommCenter-.*ips.*", 0);
...
LABEL_36:
  ...
  *(_OWORD *)&v109.__r_.__value_.__r.__words[1] = *(_OWORD *)&v116[8];
  ...
  BOOL v30 = sub_100003E0C((const char *)&__dst, (uint64_t)&v109, (uint64_t)&__s, 0);
  v31 = v112;
...
LABEL_43:
  ...
  sub_100019D68(__s, *((const void ***)&__s + 1), (uint64_t)&v120, v33, 1);
  uint64_t v34 = __s;
...
LABEL_150:
        ...
        if (v120.st_dev || xpc_get_type((xpc_object_t)__dst) != (xpc_type_t)&_xpc_type_dictionary)
        {
          ...
          {
            sub_1000224C4(v116, (uint64_t)&v120);
...
LABEL_32:
  ...
  if (v69)
  {
    ...
    {
      sub_1000224C4(buf, (uint64_t)&v69);
...
LABEL_41:
  ...
  if (os_log_type_enabled((os_log_t)v20, OS_LOG_TYPE_DEFAULT))
  {
    if (v19 > 7u) {
      ...
      unint64_t v21 = (&off_100031150)[v19];
    }
  ...
  if ([v22 airplaneMode])
  {
    ...
    if (os_log_type_enabled((os_log_t)v23, OS_LOG_TYPE_DEFAULT))
    {
      if (v19 > 7u) {
        ...
        long long v24 = (&off_100031150)[v19];
      }
      *(_DWORD *)buf = 136315138;
      *(void *)&buf[4] = v24;
...
LABEL_82:
  ...
  {
    sub_1000224C4(__dst, (uint64_t)buf);
...
LABEL_37:
    ...
    {
      sub_1000224C4(v76, (uint64_t)&v72);
...
- (id)dumpTelephonyLogs:(id)a3 :(BOOL)a4 :(id)a5
{
  ...
  if (&self->fGroupUpdate != (group *)__p)
  {
    if (*((char *)&self->fGroupUpdate.gr_gid + 7) < 0)
    {
      ...
      sub_100004A98((void **)&self->fGroupUpdate.gr_name, v13, v14);
    }
    else if ((HIBYTE(__p[2]) & 0x80) != 0)
    {
      sub_1000049D0(&self->fGroupUpdate.gr_name, __p[0], (size_t)__p[1]);
    }
    else
    {
  ...
  {
    operator delete(__p[0]);
    sub_100029684((void *)buf.__r_.__value_.__l.__size_);
...
LABEL_61:
  if (objc_msgSend(v68, "length", v67)) {
    sub_10001BBB0(__p, (char *)[v68 UTF8String]);
  }
LABEL_63:
  if (SHIBYTE(__p[2]) >= 0) {
...
- (id)dumpLogWithBasebandReset:(id)a3 :(id)a4
{
  ...
  if (&self->fGroupUpdate != (group *)__p)
  {
    if (*((char *)&self->fGroupUpdate.gr_gid + 7) < 0)
    {
      ...
      sub_100004A98((void **)&self->fGroupUpdate.gr_name, v7, v8);
    }
    else if ((HIBYTE(__p[2]) & 0x80) != 0)
    {
      sub_1000049D0(&self->fGroupUpdate.gr_name, __p[0], (size_t)__p[1]);
  ...
  sub_100029684((void *)v63.__r_.__value_.__l.__size_);
...
LABEL_43:
  if (objc_msgSend(v58, "length", v57)) {
    sub_10001BBB0(__p, (char *)[v58 UTF8String]);
  }
LABEL_45:
  if (SHIBYTE(__p[2]) >= 0) {
    size_t v31 = __p;
...
LABEL_36:
  ...
  if (v46 || xpc_get_type(v19) != (xpc_type_t)&_xpc_type_dictionary)
  {
    ...
    {
      sub_1000224C4(&v43, (uint64_t)&v46);
...
LABEL_17:
  ...
  *(_OWORD *)long long __p = v9;
  ...
  else
  {
    ...
    {
      sub_1000224C4(v27, (uint64_t)__p);
...
LABEL_19:
  ...
  *(_OWORD *)long long v21 = v11;
  ...
  if (LODWORD(v21[0]))
  {
    ...
    {
      sub_1000224C4(__p, (uint64_t)v21);
...
LABEL_17:
  ...
  *(_OWORD *)char v19 = v9;
  ...
  if (LODWORD(v19[0]))
  {
    ...
    if (os_log_type_enabled((os_log_t)v10, OS_LOG_TYPE_ERROR))
    {
      sub_1000224C4(__p, (uint64_t)v19);
