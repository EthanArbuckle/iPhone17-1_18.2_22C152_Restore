...
- (uint64_t)_hasManagedRestrictions
{
  if (([a1 _isUninstalledOnMDMRemoval] & 1) != 0
    || ([a1 _isExcludedFromBackup] & 1) != 0
    || ([a1 _isExcludedFromCloudSync] & 1) != 0)
  {
    return 1;
  }
...
- (BOOL)_isExcludedFromBackup
{
  ...
  v1 = [MEMORY[0x263F53C50] sharedConnection];
  BOOL v2 = [v1 effectiveBoolValueForSetting:*MEMORY[0x263F538A0]] == 2;
...
- (BOOL)_isExcludedFromCloudSync
{
  ...
  v1 = [MEMORY[0x263F53C50] sharedConnection];
  BOOL v2 = [v1 effectiveBoolValueForSetting:*MEMORY[0x263F538A8]] == 2;
...
- (BOOL)_isUnableToExportToUnmanaged
{
  ...
  v1 = [MEMORY[0x263F53C50] sharedConnection];
  BOOL v2 = [v1 effectiveBoolValueForSetting:*MEMORY[0x263F539C8]] == 2;
