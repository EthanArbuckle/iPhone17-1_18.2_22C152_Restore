@interface SharedChannelProvisionOffGridPayloadResponse
...
@implementation SharedChannelProvisionOffGridPayloadResponse
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SharedChannelProvisionOffGridPayloadResponse;
  int v4 = [(SharedChannelProvisionOffGridPayloadResponse *)&v8 description];
  v5 = [(SharedChannelProvisionOffGridPayloadResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return SharedChannelProvisionOffGridPayloadResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
