...
- (void)setPublishPayloadContent:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (BOOL)hasPublishPayloadContent
{
  return self->_publishPayloadContent != 0;
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SharedChannelPublishPayload;
  v4 = [(SharedChannelPublishPayload *)&v8 description];
  v5 = [(SharedChannelPublishPayload *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (publishPayloadContent) {
    [v3 setObject:publishPayloadContent forKey:@"publish_payload_content"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return SharedChannelPublishPayloadReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    id v5 = v4;
    objc_msgSend(v4, "setPublishPayloadContent:");
    id v4 = v5;
  }
  if (*(unsigned char *)&self->_has)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSData *)self->_publishPayloadContent copyWithZone:a3];
  v7 = *(void **)(v5 + 16);
  *(void *)(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  publishPayloadContent = self->_publishPayloadContent;
  if ((unint64_t)publishPayloadContent | *((void *)v4 + 2))
  {
    if (!-[NSData isEqual:](publishPayloadContent, "isEqual:")) {
      goto LABEL_8;
    }
  }
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSData *)self->_publishPayloadContent hash];
  if (*(unsigned char *)&self->_has) {
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[SharedChannelPublishPayload setPublishPayloadContent:](self, "setPublishPayloadContent:");
    unint64_t v4 = v5;
  }
  if (v4[3])
  {
...
- (NSData)publishPayloadContent
{
  return self->_publishPayloadContent;
}
