...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)ChannelActivityPollingResponse;
  id v4 = [(ChannelActivityPollingResponse *)&v8 description];
  v5 = [(ChannelActivityPollingResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return ChannelActivityPollingResponseReadFrom(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(ChannelActivityPollingResponse *)self participantPayloadsCount])
  {
    ...
    unint64_t v6 = [(ChannelActivityPollingResponse *)self participantPayloadsCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(ChannelActivityPollingResponse *)self participantPayloadAtIndex:i];
...
LABEL_15:
  ...
  *((unsigned char *)v11 + 56) |= 0x20u;
  if ((*(unsigned char *)&self->_has & 8) != 0)
  {
LABEL_16:
    v11[9] = self->_retryIntervalSeconds;
    *((unsigned char *)v11 + 56) |= 8u;
  }
LABEL_17:
}
...
LABEL_20:
    *(_DWORD *)(v6 + 44) = self->_totalResponseMessages;
  ...
  *(_DWORD *)(v6 + 32) = self->_responseMessageIndex;
...
LABEL_16:
  ...
  {
LABEL_17:
    *(_DWORD *)(v6 + 36) = self->_retryIntervalSeconds;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x10) != 0)
  {
    if ((*((unsigned char *)v4 + 56) & 0x10) == 0 || self->_status != *((_DWORD *)v4 + 10)) {
      goto LABEL_37;
    }
  }
  ...
  if (has)
  {
    if ((*((unsigned char *)v4 + 56) & 1) == 0 || self->_serverTimestampSeconds != *((void *)v4 + 1)) {
      goto LABEL_37;
    }
  }
  ...
  if ((has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 56) & 2) == 0 || self->_version != *((void *)v4 + 2)) {
      goto LABEL_37;
    }
  }
  ...
  participantPayloads = self->_participantPayloads;
  if ((unint64_t)participantPayloads | *((void *)v4 + 3))
  {
...
LABEL_23:
  if ((has & 4) != 0)
  {
    if ((*((unsigned char *)v4 + 56) & 4) == 0 || self->_responseMessageIndex != *((_DWORD *)v4 + 8)) {
      goto LABEL_37;
    }
  }
  ...
  if ((has & 0x20) != 0)
  {
    if ((*((unsigned char *)v4 + 56) & 0x20) == 0 || self->_totalResponseMessages != *((_DWORD *)v4 + 11)) {
      goto LABEL_37;
    }
  }
  ...
  BOOL v8 = (*((unsigned char *)v4 + 56) & 8) == 0;
  if ((has & 8) != 0)
  {
    if ((*((unsigned char *)v4 + 56) & 8) == 0 || self->_retryIntervalSeconds != *((_DWORD *)v4 + 9)) {
      goto LABEL_37;
    }
    BOOL v8 = 1;
  }
...
LABEL_12:
  uint64_t v10 = 2654435761 * self->_retryIntervalSeconds;
  return v4 ^ v3 ^ v5 ^ v6 ^ v7 ^ v8 ^ v9 ^ v10;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v4[14] & 0x10) != 0)
  {
    self->_uint64_t status = v4[10];
    *(unsigned char *)&self->_has |= 0x10u;
  }
  if (*((void *)v4 + 6)) {
    -[ChannelActivityPollingResponse setUuid:](self, "setUuid:");
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        -[ChannelActivityPollingResponse addParticipantPayload:](self, "addParticipantPayload:", *(void *)(*((void *)&v13 + 1) + 8 * i), (void)v13);
      }
...
LABEL_22:
    self->_totalResponseMessages = *((_DWORD *)v5 + 11);
    *(unsigned char *)&self->_has |= 0x20u;
    if ((*((unsigned char *)v5 + 56) & 8) == 0) {
      goto LABEL_20;
    }
    goto LABEL_19;
  }
  self->_responseMessageIndex = *((_DWORD *)v5 + 8);
  *(unsigned char *)&self->_has |= 4u;
  char v12 = *((unsigned char *)v5 + 56);
  if ((v12 & 0x20) != 0) {
    goto LABEL_22;
...
LABEL_18:
  ...
  {
LABEL_19:
    self->_retryIntervalSeconds = *((_DWORD *)v5 + 9);
    *(unsigned char *)&self->_has |= 8u;
  }
LABEL_20:
}
