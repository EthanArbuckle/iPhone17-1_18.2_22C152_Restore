...
- (id)description
{
  ...
  if (self)
  {
    ...
    uint64_t v6 = self->_untrustedIdentifier;
    v7 = self->_untrustedOrganization;
    uint64_t v8 = self->_untrustedIssuerIdentifier;
  ...
  +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"<%@; BOOL trusted = %@; untrustedIdentifier = %@; untrustedOrganization = %@; untrustedIssuerIdentifier = %@; untrustedIssuerOrganization = %@>",
    v4,
    v5,
    v6,
    v7,
    v8,
  uint64_t v10 = untrustedIssuerOrganization);
