@interface ZhuGeBasebandConnectionArmory
+ (__CTServerConnection)getCTServerConnection;
+ (id)getCoreTelephonyClient;
@end

@implementation ZhuGeBasebandConnectionArmory
...
+ (id)getCoreTelephonyClient
{
  ...
  {
    ZhuGeLog(1040, "/Library/Caches/com.apple.xbs/Sources/ZhuGe_Service/ZhuGeCommon/ZhuGeBaseband.m", "+[ZhuGeBasebandConnectionArmory getCoreTelephonyClient]", 101, @"Failed to weak link core telephony client framework!", v2, v3, v4, v9);
    id v7 = 0;
  }
  return v7;
}

uint64_t __55__ZhuGeBasebandConnectionArmory_getCoreTelephonyClient__block_invoke()
{
...
uint64_t __54__ZhuGeBasebandConnectionArmory_getCTServerConnection__block_invoke()
{
