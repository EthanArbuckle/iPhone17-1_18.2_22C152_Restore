...
{
  uint64_t v5 = 4 * a3;
  v6 = [&stru_270DCA1F8 stringByPaddingToLength:4 * a3 withString:@" " startingAtIndex:0];
  v7 = [&stru_270DCA1F8 stringByPaddingToLength:(4 * a3) | 2 withString:@" " startingAtIndex:0];
  v8 = [&stru_270DCA1F8 stringByPaddingToLength:v5 + 4 withString:@" " startingAtIndex:0];
  v9 = [a1 domain];
