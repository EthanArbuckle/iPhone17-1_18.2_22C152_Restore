...
- (HKMHMostPrevalentDomainsQuery)initWithDayIndexRange:(id)a3 gregorianCalendar:(id)a4 predicate:(id)a5 resultsHandler:(id)a6;
- (NSCalendar)gregorianCalendar;
- (void)client_deliverMostPrevalentDomains:(id)a3 queryUUID:(id)a4;
...
- (HKMHMostPrevalentDomainsQuery)initWithDayIndexRange:(id)a3 gregorianCalendar:(id)a4 predicate:(id)a5 resultsHandler:(id)a6
{
  ...
  v21.receiver = self;
  v21.super_class = (Class)HKMHMostPrevalentDomainsQuery;
...
void __78__HKMHMostPrevalentDomainsQuery_client_deliverMostPrevalentDomains_queryUUID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x263F09938], OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    ...
    id v4 = v13;
    _os_log_impl(&dword_255F13000, v3, OS_LOG_TYPE_DEFAULT, "[%{public}@] Received MostPrevalentDomains", buf, 0xCu);
  }
  ...
  if (v5)
  {
    ...
    v9[1] = 3221225472;
    v9[2] = __78__HKMHMostPrevalentDomainsQuery_client_deliverMostPrevalentDomains_queryUUID___block_invoke_277;
    v9[3] = &unk_2653EF1B0;
    v9[4] = v7;
    id v11 = v5;
    id v10 = *(id *)(a1 + 48);
...
uint64_t __78__HKMHMostPrevalentDomainsQuery_client_deliverMostPrevalentDomains_queryUUID___block_invoke_277(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x263F09938], OS_LOG_TYPE_DEFAULT))
  {
    ...
    id v4 = v7;
    _os_log_impl(&dword_255F13000, v3, OS_LOG_TYPE_DEFAULT, "[%{public}@] Delivering MostPrevalentDomains", (uint8_t *)&v6, 0xCu);
  }
...
{
  v5.receiver = self;
  v5.super_class = (Class)HKMHMostPrevalentDomainsQuery;
  id v4 = a3;
...
+ (void)configureClientInterface:(id)a3
{
  id v4 = a3;
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___HKMHMostPrevalentDomainsQuery;
  objc_msgSendSuper2(&v6, sel_configureClientInterface_, v4);
  id v5 = (id)objc_msgSend(v4, "hk_setArrayOfClass:forSelector:argumentIndex:ofReply:", objc_opt_class(), sel_client_deliverMostPrevalentDomains_queryUUID_, 0, 0);
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)HKMHMostPrevalentDomainsQuery;
