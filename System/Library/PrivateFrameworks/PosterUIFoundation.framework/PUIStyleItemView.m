...
- (PUIStyleItemView)initWithStyleCoordinator:(id)a3
{
  ...
  id v5 = a3;
  v51.receiver = self;
  v51.super_class = (Class)PUIStyleItemView;
  ...
  v10 = -[PUIStyleSelectableItemView initWithFrame:](&v51, sel_initWithFrame_, *MEMORY[0x263F001A8], v7, v8, v9);
  v11 = v10;
  if (v10)
  {
    objc_storeStrong((id *)&v10->_styleCoordinator, a3);
    v12 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x263F1CB60]), "initWithFrame:", v6, v7, v8, v9);
    [(UIView *)v12 setClipsToBounds:1];
    v13 = [(UIView *)v12 layer];
    [v13 setCornerRadius:17.0];

    v14 = [(UIView *)v12 layer];
    id v15 = [MEMORY[0x263F1C550] colorWithWhite:0.0 alpha:0.1];
    ...
    v52[7] = v28;
    v29 = [MEMORY[0x263EFF8C0] arrayWithObjects:v52 count:8];
