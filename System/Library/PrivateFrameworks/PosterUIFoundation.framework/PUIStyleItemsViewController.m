...
- (PUIStyleSelectableItemView)selectedStyleItemView;
- (PUIStyleUICoordinator)selectedStyleCoordinator;
- (PUIStyleUICoordinator)uiKitColorPickerStyleCoordinator;
...
- (void)setSelectedStyleCoordinator:(id)a3;
- (void)setSelectedStyleItemView:(id)a3;
...
- (PUIStyleItemsViewController)initWithDataSource:(id)a3 configuration:(id)a4
{
  ...
  id v8 = a4;
  v34.receiver = self;
  v34.super_class = (Class)PUIStyleItemsViewController;
  ...
  char v12 = __64__PUIStyleItemsViewController_initWithDataSource_configuration___block_invoke((uint64_t)v11, v11);
  ...
  char v33 = v12;
  id v31 = v13;
  id v32 = &__block_literal_global_20;
  ...
  if (v14)
  {
    ...
    if ([v16 allowsVariation])
    {
      ...
      {
        [v13 variation];
        -[PUIStyleUICoordinator setVariation:](v15, "setVariation:");
      }
    }
    else
    {
  ...
  if ([v8 colorWellDisplayMode])
  {
    ...
    uint64_t v19 = -[PUIColorWellView initWithFrame:](v18, "initWithFrame:", *MEMORY[0x263F001A8], *(double *)(MEMORY[0x263F001A8] + 8), *(double *)(MEMORY[0x263F001A8] + 16), *(double *)(MEMORY[0x263F001A8] + 24));
    ...
    if (v23)
    {
      ...
      uint64_t v26 = +[PUIStyleUICoordinator coordinatorForColorWellView:v10->_colorWellView vibrant:v25];
      uiKitColorPickerStyleCoordinator = v10->_uiKitColorPickerStyleCoordinator;
      v10->_uiKitColorPickerStyleCoordinator = (PUIStyleUICoordinator *)v26;
...
{
  v3.receiver = self;
  v3.super_class = (Class)PUIStyleItemsViewController;
...
- (void)_setupItemViews
{
  objc_super v3 = [(PUIStyleItemsViewController *)self selectedStyleCoordinator];
  id v16 = [v3 style];

  uint64_t v4 = [(PUIStyleItemsDataSource *)self->_dataSource numberOfCoordinators];
  ...
  if (v4 >= 1)
  {
    ...
    do
    {
      v6 = -[PUIStyleItemsDataSource coordinatorForIndex:](self->_dataSource, "coordinatorForIndex:", v5, v16);
      id v7 = [[PUIStyleItemView alloc] initWithStyleCoordinator:v6];
      id v8 = (void *)[objc_alloc(MEMORY[0x263F1CA70]) initWithTarget:self action:sel_didTapContentStyleItem_];
  ...
  id v13 = [MEMORY[0x263EFF980] arrayWithArray:v18];
...
{
  id v8 = [a3 view];
  uint64_t v4 = [v8 styleCoordinator];
  ...
  uint64_t v5 = [(PUIStyleItemsViewController *)self dataSource];
  ...
  else
  {
    ...
    id v7 = [(PUIStyleItemsViewController *)self selectedStyleItemView];
    [v7 setSelected:0];
...
- (void)layoutWithItemViews:(id)a3
{
  ...
  if (v6)
  {
    ...
    for (uint64_t i = 0; i != v6; ++i)
    {
      ...
      id v13 = (void *)[objc_alloc(MEMORY[0x263F1C9B8]) initWithArrangedSubviews:v10];
      [v13 setAxis:0];
  ...
  v43 = v7;
  v14 = (UIStackView *)[objc_alloc(MEMORY[0x263F1C9B8]) initWithArrangedSubviews:v7];
  ...
  uint64_t v19 = [(PUIStyleItemsViewController *)self view];
  [v19 addSubview:v16];
  ...
  objc_super v34 = [(PUIStyleItemsViewController *)self view];
  v35 = [v34 topAnchor];
  v36 = [v33 constraintEqualToAnchor:v35];
  v45[3] = v36;
  v37 = [MEMORY[0x263EFF8C0] arrayWithObjects:v45 count:4];

  [MEMORY[0x263F08938] activateConstraints:v37];
  [(PUIStyleItemsViewController *)self _updateLayoutForCurrentSize];
}
...
- (void)_updateLayoutForCurrentSize
{
  ...
  id v3 = [(PUIStyleItemsViewController *)self view];
  [v3 bounds];
  double v5 = v4;
  ...
  if (v6 != self->_interitemSpacing)
  {
    ...
    id v13 = [(PUIStyleItemsViewController *)self delegate];
  ...
  if (v5 != self->_configuredViewWidth)
  {
    ...
    [v14 constant];
    double v16 = v15;
    id v17 = [(PUIStyleItemsViewController *)self stackViewTrailingConstraint];
    [v17 constant];
    double v19 = v16 - v18;
...
- (double)estimatedHeight
{
  unint64_t v3 = [(PUIStyleItemsDataSource *)self->_dataSource numberOfCoordinators];
  if ([(PUIStyleConfiguration *)self->_configuration colorWellDisplayMode] == 1) {
    int64_t v4 = v3 + 1;
  }
  else {
...
{
  id v4 = a3;
  id v5 = [(PUIStyleItemsViewController *)self delegate];
...
- (void)setSelectedStyle:(id)a3 fromUIKitPicker:(BOOL)a4
{
  ...
  if (v6)
  {
    ...
    else
    {
      ...
      v15[3] = &unk_265471958;
      double v16 = (PUIStyleSelectableItemView *)v6;
      uint64_t v10 = [(PUIStyleItemsDataSource *)dataSource firstCoordinatorPassingTest:v15];
      unint64_t v11 = [(PUIStyleItemsDataSource *)self->_dataSource indexForCoordinator:v10];
      ...
      else
      {
        ...
        objc_storeStrong((id *)&self->_selectedStyleCoordinator, v10);
        [(PUIStyleSelectableItemView *)self->_selectedStyleItemView setSelected:0];
        id v13 = self->_selectedStyleItemView;
...
- (void)colorWellDidUpdateColor:(id)a3
{
  ...
  id v10 = [(PUIStyleItemsViewController *)self colorWellView];
  id v5 = [(PUIStyleItemsViewController *)self colorWell];
  [v5 invalidateIntrinsicContentSize];

  [v10 setNeedsLayout];
  id v6 = [(PUIStyleConfiguration *)self->_configuration stylePalette];
  BOOL v7 = [v6 context] == 2;

  uint64_t v8 = +[PUIStyleUICoordinator coordinatorForColorWellView:self->_colorWellView vibrant:v7];
  uiKitColorPickerStyleCoordinator = self->_uiKitColorPickerStyleCoordinator;
  self->_uiKitColorPickerStyleCoordinator = v8;

  objc_storeStrong((id *)&self->_selectedStyleCoordinator, self->_uiKitColorPickerStyleCoordinator);
...
- (PUIStyleItemsViewControllerDelegate)delegate
{
  ...
  return (PUIStyleItemsViewControllerDelegate *)WeakRetained;
}
...
- (PUIStyleUICoordinator)selectedStyleCoordinator
{
  return self->_selectedStyleCoordinator;
}
...
- (PUIStyleSelectableItemView)selectedStyleItemView
{
  return self->_selectedStyleItemView;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_selectedStyleItemView, 0);
  objc_storeStrong((id *)&self->_selectedStyleCoordinator, 0);
