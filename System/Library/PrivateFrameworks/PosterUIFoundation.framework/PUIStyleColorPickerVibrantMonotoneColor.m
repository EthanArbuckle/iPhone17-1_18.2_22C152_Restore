...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithColor:(id)a3 displayColors:(id)a4
{
  return [(PUIStyleColorPickerVibrantMonotoneColor *)self initWithColor:a3 displayColors:a4 localizedName:0];
}
...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithColor:(id)a3 displayColors:(id)a4 localizedName:(id)a5
{
  ...
  v12 = [(PUIStyleColorPickerVibrantMonotoneColor *)&v19 init];
  v13 = v12;
  if (v12)
  {
    objc_storeStrong((id *)&v12->_color, a3);
    objc_storeStrong((id *)&v13->_displayColors, a4);
    uint64_t v14 = [(NSDictionary *)v13->_displayColors objectForKeyedSubscript:&unk_27081B3E0];
...
- (NSString)localizedName
{
  ...
  {
    v3 = [(PUIStyleColor *)self->_activeDisplayColor localizedName];
  }
  return v3;
}
...
- (void)setContentsLuminance:(double)a3
{
  uint64_t v4 = PUIStyleBackgroundTypeForLuminance(a3);
...
- (PUIStyleColor)leftSliderColor
{
  return (PUIStyleColor *)[(PUIStyleColorPickerVibrantMonotoneColor *)self displayColorWithVariation:-1.0];
}
...
- (PUIStyleColorPickerVibrantMonotoneColor)colorWithVariation:(double)a3
{
  ...
  return (PUIStyleColorPickerVibrantMonotoneColor *)v3;
}

- (id)displayColorWithVariation:(double)a3
{
  [(id)objc_opt_class() luminanceForPosterColor:self->_activeDisplayColor withAppliedVariation:a3];
  id v4 = -[PUIStyleColor copyWithLuminance:](self->_activeDisplayColor, "copyWithLuminance:");
  return v4;
}
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (PUIStyleColorPickerVibrantMonotoneColor *)a3;
  if (self == v4)
  {
    char v17 = 1;
  }
  else
  {
    ...
    {
      double v7 = v4;
      v8 = [(PUIStyleColorPickerVibrantMonotoneColor *)self color];
      id v9 = [(PUIStyleColorPickerVibrantMonotoneColor *)v7 color];
      int v10 = BSEqualObjects();

      if (!v10) {
        goto LABEL_6;
      }
      id v11 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
      v12 = [(PUIStyleColorPickerVibrantMonotoneColor *)v7 displayColors];
      int v13 = BSEqualObjects();

      if (!v13) {
        goto LABEL_6;
      }
      [(PUIStyleColorPickerVibrantMonotoneColor *)self initialVariation];
      double v15 = v14;
      [(PUIStyleColorPickerVibrantMonotoneColor *)v7 initialVariation];
      if (v15 == v16)
      {
        objc_super v19 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
        v20 = [(PUIStyleColorPickerVibrantMonotoneColor *)v7 localizedName];
...
- (unint64_t)hash
{
  ...
  id v4 = [(PUIStyleColorPickerVibrantMonotoneColor *)self color];
  id v5 = (id)[v3 appendObject:v4];

  double v6 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  ...
  {
    id v9 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
...
- (NSString)description
{
  ...
  id v9 = __54__PUIStyleColorPickerVibrantMonotoneColor_description__block_invoke;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v5 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  [v7 encodeObject:v5 forKey:@"displayColors"];

  if (self->_localizedName)
  {
    double v6 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithCoder:(id)a3
{
  ...
  id v10 = [(PUIStyleColorPickerVibrantMonotoneColor *)self initWithColor:v6 displayColors:v8 localizedName:v9];
  return v10;
}
...
- (void)encodeWithBSXPCCoder:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [(PUIStyleColorPickerVibrantMonotoneColor *)self color];
  [v4 encodeObject:v5 forKey:@"color"];

  double v6 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  uint64_t v7 = (void *)MEMORY[0x263EFF980];
  uint64_t v8 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  ...
  if (self->_localizedName)
  {
    v18 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithBSXPCCoder:(id)a3
{
  ...
  unint64_t v11 = [NSDictionary dictionaryWithObjects:v10 forKeys:v8];
  uint64_t v12 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"localizedName"];

  uint64_t v13 = [(PUIStyleColorPickerVibrantMonotoneColor *)self initWithColor:v6 displayColors:v11 localizedName:v12];
  return v13;
}
...
- (void)appendDescriptionToFormatter:(id)a3
{
  ...
  uint64_t v8 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
