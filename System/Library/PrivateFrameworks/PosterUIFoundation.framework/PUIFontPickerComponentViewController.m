...
- (PUIFontPickerItem)selectedItem;
- (PUIStyleFontPickerButton)selectedCellView;
...
+ (id)defaultFontIdentifiersForRole:(id)a3 titleString:(id)a4
{
  ...
  if ([a3 isEqual:*MEMORY[0x263F5F458]])
  {
    ...
    v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v14 count:4];
    if ([v5 length])
    {
      uint64_t v7 = [getPRIncomingCallFontsProviderClass() timeFontIdentifiersForText:v5 availableFonts:v6];
    }
    else
    {
      uint64_t v7 = [v6 copy];
...
+ (id)defaultItemsForRole:(id)a3 text:(id)a4
{
  ...
  id v5 = objc_msgSend(v4, "bs_map:", &__block_literal_global_18);
...
- (PUIFontPickerComponentViewController)initWithItems:(id)a3 selectedItem:(id)a4 role:(id)a5 titleString:(id)a6
{
  ...
  id v13 = a6;
  v21.receiver = self;
  v21.super_class = (Class)PUIFontPickerComponentViewController;
...
- (id)contentStringNumberFormatter
{
  if (contentStringNumberFormatter___once != -1) {
    dispatch_once(&contentStringNumberFormatter___once, &__block_literal_global_8);
  }
...
- (id)contentStringForFont:(id)a3 locale:(id)a4
{
  ...
  int v10 = [v9 isEqualToString:*MEMORY[0x263F5F458]];

  if (v10)
  {
    id v11 = (void *)[getPRIncomingCallFontsProviderClass() sampleStringForFont:v8 displayingText:self->_titleString];
    id v13 = v12;
  ...
  {
    id v13 = [(PUIFontPickerComponentViewController *)self contentStringNumberFormatter];
    id v11 = [v13 stringFromNumber:&unk_27081B380];
    v14 = v8;
  }
  ...
  if (PUINumberingSystemTypeRequiresLanguageTagging(v22))
  {
    ...
    [v18 setObject:v23 forKeyedSubscript:*MEMORY[0x263F081E8]];
  }
  v24 = (void *)[objc_alloc(MEMORY[0x263F086A0]) initWithString:v11 attributes:v18];
...
- (void)loadView
{
  ...
  uint64_t v4 = [(PUIFontPickerComponentViewController *)self configureFontPickerViewIfNecessary];
  id v5 = objc_alloc_init(PUIStyleFontWeightSlider);
  ...
  BOOL v8 = [(PUIFontPickerComponentViewController *)self _shouldShowWeightSlider];
  double v9 = 0.0;
  if (v8) {
    double v9 = 1.0;
  }
  ...
  *(float *)&double v11 = v11;
  ...
  v41 = v14;
  uint64_t v15 = (void *)[objc_alloc(MEMORY[0x263F1C9B8]) initWithArrangedSubviews:v14];
  [v15 setAxis:1];
  [v15 setAlignment:3];
  [v15 setSpacing:16.0];
  ...
  v44[5] = v21;
  [MEMORY[0x263EFF8C0] arrayWithObjects:v44 count:6];
  v23 = v22 = (void *)v4;
...
- (id)configureFontPickerViewIfNecessary
{
  ...
  id v3 = [(PUIFontPickerComponentViewController *)self items];
  ...
  if (v4 > 1)
  {
    ...
    long long v52 = 0u;
    long long v53 = 0u;
    id v6 = [(PUIFontPickerComponentViewController *)self items];
    ...
    if (v7)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v7; ++i)
        {
          ...
          id v13 = [(PUIFontPickerComponentViewController *)self locale];
          ...
          uint64_t v18 = [(PUIFontPickerComponentViewController *)self role];
          id v19 = objc_alloc_init(+[PUIStyleFontPickerButton fontPickerButtonClassForRole:v18]);

          [v19 configureWithAttributedString:v14];
          objc_initWeak(&from, v19);
          v20 = (void *)MEMORY[0x263F1C3C0];
          ...
          {
            [v19 setSelected:1];
            [(PUIFontPickerComponentViewController *)self setSelectedCellView:v19];
          }
    ...
    [(PUIFontPickerComponentViewController *)self setCellViews:v45];
    v22 = [MEMORY[0x263EFF980] array];
    [v22 addObjectsFromArray:v45];
    v23 = (void *)[objc_alloc(MEMORY[0x263F1C9B8]) initWithArrangedSubviews:v22];
    [v23 setAxis:0];
    [v23 setAlignment:1];
    [v23 setSpacing:20.0];
    ...
    v57[4] = v30;
    v31 = [MEMORY[0x263EFF8C0] arrayWithObjects:v57 count:5];
...
void __74__PUIFontPickerComponentViewController_configureFontPickerViewIfNecessary__block_invoke(id *a1)
{
  ...
  if (v3 == v4)
  {
    ...
    unint64_t v8 = objc_msgSend(v7, "pui_variantWeightRange");
    unint64_t v10 = v9;
    double v11 = [a1[4] font];
    [v11 weight];
...
- (BOOL)_shouldShowWeightSlider
{
  id v3 = [(PUIFontPickerComponentViewController *)self delegate];
  char v4 = objc_opt_respondsToSelector();

  if ((v4 & 1) == 0) {
    return 0;
  }
  float v5 = [(PUIFontPickerComponentViewController *)self delegate];
...
- (void)_updateWeightSliderVisibility
{
  BOOL v3 = [(PUIFontPickerComponentViewController *)self _shouldShowWeightSlider];
  ...
  v11[4] = self;
  BOOL v12 = v3;
  char v4 = (void (**)(void))MEMORY[0x25A2F6090](v11);
  ...
  v9[4] = self;
  BOOL v10 = v3;
  float v5 = (void *)MEMORY[0x25A2F6090](v9);
  if (v3)
  {
    v4[2](v4);
    [MEMORY[0x263F1CB60] animateWithDuration:0 delay:v5 options:0 animations:0.15 completion:0.3];
  }
  else
  {
...
uint64_t __69__PUIFontPickerComponentViewController__updateWeightSliderVisibility__block_invoke_3(uint64_t a1)
{
...
- (void)updateLayoutForCurrentSize
{
  ...
  BOOL v3 = [(PUIFontPickerComponentViewController *)self isUsingSmallerSizing];
  id v4 = (void *)MEMORY[0x263F08938];
  id v5 = [(PUIFontPickerComponentViewController *)self widthCellConstraints];
  [v4 deactivateConstraints:v5];

  char v6 = (void *)MEMORY[0x263F08938];
  float v7 = [(PUIFontPickerComponentViewController *)self heightCellConstraints];
  ...
  long long v46 = 0u;
  long long v47 = 0u;
  unint64_t v9 = [(PUIFontPickerComponentViewController *)self cellViews];
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        double v16 = [(PUIFontPickerComponentViewController *)self locale];
        double v17 = [(PUIFontPickerComponentViewController *)self contentStringForFont:v15 locale:v16];
...
{
  v8.receiver = self;
  v8.super_class = (Class)PUIFontPickerComponentViewController;
  [(PUIFontPickerComponentViewController *)&v8 viewDidLayoutSubviews];
  BOOL v3 = [(PUIFontPickerComponentViewController *)self view];
  [v3 bounds];
  double v5 = v4;
...
LABEL_5:
  ...
  float v7 = [MEMORY[0x263F1C5C0] currentDevice];
...
- (void)setLocale:(id)a3
{
  ...
  if (self->_locale != v5)
  {
    ...
    long long v15 = 0u;
    long long v16 = 0u;
    BOOL v6 = [(PUIFontPickerComponentViewController *)self cellViews];
    ...
    if (v7)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v8; ++i)
        {
          ...
          double v13 = [(PUIFontPickerComponentViewController *)self locale];
          v14 = [(PUIFontPickerComponentViewController *)self contentStringForFont:v12 locale:v13];
...
- (void)filterFontViewsByLocale
{
  ...
  if (![(NSString *)self->_role isEqualToString:*MEMORY[0x263F5F458]])
  {
    long long v22 = 0u;
    long long v23 = 0u;
    long long v20 = 0u;
    long long v21 = 0u;
    id obj = [(PUIFontPickerComponentViewController *)self cellViews];
    ...
    if (v3)
    {
      ...
      uint64_t v6 = *MEMORY[0x263F1D1D8];
      do
      {
        for (uint64_t i = 0; i != v4; ++i)
        {
          ...
          uint64_t v10 = [(PUIFontPickerComponentViewController *)self locale];
          uint64_t v11 = [(PUIFontPickerComponentViewController *)self contentStringForFont:v9 locale:v10];
...
- (double)estimatedHeight
{
  if (([(PUIFontPickerComponentViewController *)self isViewLoaded] & 1) == 0
  ...
  double largestItemHeight = self->_largestItemHeight;
  if ([(PUIFontPickerComponentViewController *)self isViewLoaded]
    && [(PUIFontPickerComponentViewController *)self _shouldShowWeightSlider])
  {
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (PUIFontPickerComponentViewControllerDelegate *)WeakRetained;
}
