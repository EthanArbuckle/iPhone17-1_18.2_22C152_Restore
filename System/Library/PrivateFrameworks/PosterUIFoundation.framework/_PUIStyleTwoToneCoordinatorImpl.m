...
- (id)itemView
{
  ...
  if (!itemView)
  {
    ...
    uint64_t v5 = [(_PUIStyleTwoToneCoordinatorImpl *)self effectiveColor2];
    double v6 = (void *)v5;
    if (v5) {
      id v7 = (void *)v5;
    }
    ...
    v9 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x263F1CB60]), "initWithFrame:", 0.0, 0.0, 50.0, 50.0);
    [(UIView *)v9 setClipsToBounds:1];
    v10 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x263F1CB60]), "initWithFrame:", 0.0, 0.0, 25.0, 50.0);
    [(UIView *)v10 setBackgroundColor:v4];
    [(UIView *)v10 setAutoresizingMask:22];
    [(UIView *)v9 addSubview:v10];
    v11 = (UIView *)objc_msgSend(objc_alloc(MEMORY[0x263F1CB60]), "initWithFrame:", 25.0, 0.0, 25.0, 50.0);
