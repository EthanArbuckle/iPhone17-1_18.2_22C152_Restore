...
+ (void)performMigrationsIfNeededForStorage:(id)a3 version:(unint64_t)a4
{
  ...
  {
    v7 = v5;
    unint64_t v6 = [(id)objc_opt_class() version];
    if (a4 <= 2 && v6 > a4) {
      [v7 removeAllObjects];
    }
  }
...
{
  id v5 = a3;
  unint64_t v6 = [[PUIStyleColor alloc] initWithColor:v5 preferredStyle:0];

  double v7 = a4 * -0.25;
  v8 = [(PUIStyleColor *)v6 hslValues];
  [v8 luminance];
  double v10 = v9;
  ...
  id v12 = [(PUIStyleColor *)v6 copyWithLuminance:v11];
...
- (PUIStyleColorVariationStore)initWithVariationStorage:(id)a3 version:(unint64_t)a4
{
  ...
  double v7 = [(PUIStyleColorVariationStore *)&v14 init];
  if (v7)
  {
...
- (PUIStyleColorVariationStore)init
{
  ...
  return [(PUIStyleColorVariationStore *)self initWithVariationStorage:0 version:v3];
}
...
void __105__PUIStyleColorVariationStore_baseColorForVariedColor_forContextIdentifier_variation_forDataLayerPicker___block_invoke(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
  id v7 = a2;
  [a3 doubleValue];
  double v9 = v8;
  if (*(unsigned char *)(a1 + 64))
  {
    ...
    v16 = [[PUIStyleColor alloc] initWithColor:v10];
  }
  else
  {
    v16 = [(id)objc_opt_class() posterColorForColor:*(void *)(a1 + 32) withAppliedVariation:-v8];
  }
  id v11 = [(PUIStyleColor *)v16 identifier];
  int v12 = [v7 isEqualToString:v11];

  if (v12)
  {
    uint64_t v13 = [(PUIStyleColor *)v16 color];
