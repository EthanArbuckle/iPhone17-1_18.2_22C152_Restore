...
- (SKUIOnboardingInstructionsView)instructionsView
{
  ...
  if (!instructionsView)
  {
    objc_super v4 = [SKUIOnboardingInstructionsView alloc];
    [(SKUIPhysicalCirclesView *)self->_circlesView bounds];
    id v5 = -[SKUIOnboardingInstructionsView initWithFrame:](v4, "initWithFrame:");
  ...
  else
  {
    ...
    if ([v9 count])
    {
      ...
      *(float *)&double v14 = v17 + v16 * 0.5;
      ...
      -[SKUIPhysicalCirclesView convertPoint:fromView:](circlesView, "convertPoint:fromView:", v20, v15, v18);
      double v22 = v21;
      double v24 = v23;
      ...
      v33[3] = &unk_1E64223D0;
      v34 = v12;
      -[SKUIPhysicalCirclesView removeCirclesInIndexSet:byAnimatingToPoint:delay:completionBlock:](v25, "removeCirclesInIndexSet:byAnimatingToPoint:delay:completionBlock:", v8, v33, v22, v24, 0.25);
    }
    dispatch_group_enter(v12);
...
- (void)setAffiliationItems:(id)a3
{
  ...
  if (affiliationItems != v4)
  {
    ...
    if (v4)
    {
      uint64_t v4 = (NSMutableArray *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithArray:v4 copyItems:1];
      affiliationItems = self->_affiliationItems;
    }
...
- (void)setFooterView:(id)a3 animated:(BOOL)a4
{
  ...
  if (footerView != v6)
  {
    ...
    if (*p_footerView)
    {
      id v9 = [(SKUIOnboardingAffiliationCirclesViewController *)self view];
...
- (void)setImage:(id)a3 forAffiliationItem:(id)a4
{
  ...
  {
    id v8 = [(SKUIPhysicalCirclesView *)self->_circlesView circleViewAtIndex:v7];
    ...
    if (v12)
    {
      if (!images)
      {
        id v10 = (NSMapTable *)[objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:0 capacity:0];
        v11 = self->_images;
        self->_images = v10;
...
- (void)setUserAffinityCount:(int64_t)a3 forAffiliationItemAtIndex:(int64_t)a4 animated:(BOOL)a5 completionBlock:(id)a6
{
  ...
  if (a5)
  {
    double v18 = +[SKUISimpleAnimationFactory backOutTimingFunction];
...
- (void)viewDidLayoutSubviews
{
  BOOL v3 = [(SKUIOnboardingAffiliationCirclesViewController *)self view];
  [v3 bounds];
  double v5 = v4;
  double v7 = v6;
...
{
  BOOL v3 = a3;
  objc_super v5 = [(SKUIOnboardingAffiliationCirclesViewController *)self transitionCoordinator];
...
- (id)circlesView:(id)a3 circleForIndex:(int64_t)a4
{
  ...
  double v11 = -[SKUIOnboardingCircleView initWithFrame:]([SKUIOnboardingCircleView alloc], "initWithFrame:", 0.0, 0.0, v9, v10);
  ...
  float v16 = [(SKUIOnboardingCircleView *)v11 titleLabel];
  double v17 = [v7 title];
  [v16 setText:v17];
...
void __95__SKUIOnboardingAffiliationCirclesViewController_circleView_didBeginLongPressForCircleAtIndex___block_invoke(uint64_t a1)
{
  ...
  {
    id WeakRetained = objc_alloc_init(MEMORY[0x1E4F28EE0]);
    [WeakRetained setNumberStyle:1];
    uint64_t v2 = *(void **)(*(void *)(a1 + 32) + 992);
    if (v2) {
      [v2 localizedStringForKey:@"REMOVE_ITEM_%@" inTable:@"Onboarding"];
    }
    else {
    BOOL v3 = +[SKUIClientContext localizedStringForKey:@"REMOVE_ITEM_%@" inBundles:0 inTable:@"Onboarding"];
    }
    double v4 = NSString;
...
- (void)circleView:(id)a3 didEndLongPressForCircleAtIndex:(int64_t)a4
{
  ...
  objc_super v5 = [(SKUIOnboardingAffiliationCirclesViewController *)self view];
  [v5 setNeedsLayout];
...
- (void)circleView:(id)a3 didTapCircleAtIndex:(int64_t)a4
{
  id v9 = [(SKUIOnboardingAffiliationCirclesViewController *)self delegate];
...
- (CGSize)_circleSizeForAffinityCount:(int64_t)a3
{
  double v4 = [(SKUIOnboardingAffiliationCirclesViewController *)self traitCollection];
...
- (void)_completeDeletionForCircleAtIndex:(int64_t)a3
{
  ...
  [(SKUIOnboardingInstructionsView *)self->_instructionsView popLabelState];
  uint64_t v5 = [(SKUIOnboardingAffiliationCirclesViewController *)self view];
  [v5 setNeedsLayout];

  [(SKUIOnboardingAffiliationCirclesViewController *)self _cancelDeletionTimer];
  double v6 = [(SKUIOnboardingAffiliationCirclesViewController *)self delegate];
...
- (void)_reloadRepellors
{
  ...
  if (footerView)
  {
    ...
    if (v12 > 0.00000011920929)
    {
      ...
      float v16 = [(SKUIOnboardingAffiliationCirclesViewController *)self bottomLayoutGuide];
      [v16 length];
      double v18 = Height - v17 + 90.0;

      id v19 = -[SKUIPhysicalCirclesView addRepellorWithCenter:radius:bufferSize:](self->_circlesView, "addRepellorWithCenter:radius:bufferSize:", v14, v18, ceil(v13 * 0.600000024), 20.0);
    }
  }
  v39.origin.x = v4;
  v39.origin.y = v6;
  ...
  objc_super v20 = [(SKUIOnboardingInstructionsView *)self->_instructionsView explanationLabel];
  [v20 frame];
  CGFloat v22 = v21;
  CGFloat v24 = v23;
  CGFloat v26 = v25;
  ...
  *(float *)&CGFloat Width = v35 * v35 - Width * 0.5 * (Width * 0.5);
  ...
  id v34 = -[SKUIPhysicalCirclesView addRepellorWithCenter:radius:bufferSize:](self->_circlesView, "addRepellorWithCenter:radius:bufferSize:", floor(CGRectGetWidth(v42) * 0.5), v33, v35, 20.0);
}

- (void)_sendAffilationItemsDidChange
{
  id v3 = [(SKUIOnboardingAffiliationCirclesViewController *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
- (double)_topLayoutMargin
{
  uint64_t v2 = [(SKUIOnboardingAffiliationCirclesViewController *)self navigationController];
  double v3 = 13.0;
  if (v2)
  {
    CGFloat v4 = +[SKUINavigationControllerAssistant existingAssistantForNavigationController:v2];
    if (v4)
    {
      double v5 = v4;
...
- (SKUIOnboardingAffiliationCirclesDelegate)delegate
{
  ...
  return (SKUIOnboardingAffiliationCirclesDelegate *)WeakRetained;
}
