...
- (id)_initSKUITracklistColumnData
{
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3) {
        [(SKUITracklistColumnData *)v3 _initSKUITracklistColumnData];
      }
    }
  }
  v12.receiver = self;
  v12.super_class = (Class)SKUITracklistColumnData;
  id result = [(SKUITracklistColumnData *)&v12 init];
  if (result)
  {
    *((void *)result + 4) = 0x402E000000000000;
    *((_OWORD *)result + 1) = xmmword_1C1CCB3C0;
  }
  return result;
}
...
{
  id v4 = a3;
  uint64_t v5 = [(SKUITracklistColumnData *)self _initSKUITracklistColumnData];
  if (v5)
  {
    ...
    id v23 = 0;
    uint64_t v7 = [v4 flattenedChildren];
...
{
  id v16 = a2;
  uint64_t v3 = SKUITrackListColumnIdentifierForViewElement(v16);
  uint64_t v4 = v3;
...
void __63__SKUITracklistColumnData_enumerateColumnsForTrack_usingBlock___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5 < *(void *)(a1 + 56))
  {
    while (1)
    {
      ...
      uint64_t v9 = SKUITrackListColumnIdentifierForViewElement(v6);
...
- (id)viewElementsForTrack:(id)a3 columnIndex:(int64_t)a4
{
  ...
  id v13 = __Block_byref_object_copy__19;
...
void __60__SKUITracklistColumnData_viewElementsForTrack_columnIndex___block_invoke(uint64_t a1, uint64_t a2, void *a3, uint64_t a4, unsigned char *a5)
{
  if (*(void *)(a1 + 40) == a4)
  {
    uint64_t v7 = [a3 copy];
