...
- (SKUIHorizontalLockupView)initWithFrame:(CGRect)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8) {
        -[SKUIHorizontalLockupView initWithFrame:](v8, v9, v10, v11, v12, v13, v14, v15);
      }
    }
  }
  v20.receiver = self;
  v20.super_class = (Class)SKUIHorizontalLockupView;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SKUIHorizontalLockupView;
...
- (id)preferredBackgroundColor
{
  ...
  if (!v5)
  {
    ...
    {
      v5 = [MEMORY[0x1E4FB1618] colorWithWhite:0.109803922 alpha:0.72];
    }
    else
    {
      v5 = 0;
...
+ (double)maximumPerspectiveHeightForSize:(CGSize)a3
{
  +[SKUIStackedImageView maximumPerspectiveHeightForSize:](SKUIStackedImageView, "maximumPerspectiveHeightForSize:", a3.width, a3.height);
  return result;
}
...
uint64_t __46__SKUIHorizontalLockupView_setVanishingPoint___block_invoke(uint64_t a1, void *a2)
{
...
uint64_t __70__SKUIHorizontalLockupView_updateForChangedDistanceFromVanishingPoint__block_invoke(uint64_t a1, void *a2)
{
...
- (void)hidePreviewProgressAnimated:(BOOL)a3
{
  ...
  if (previewState)
  {
    ...
    if (previewState == 2)
    {
      uint64_t v9 = [(SKUIHorizontalLockupView *)self _previewFrontView];
      if (a3)
      {
        uint64_t v10 = [(SKUIHorizontalLockupView *)self _addFlipContainerViewWithFrontView:v6 backView:v9];
        [v9 setHidden:0];
...
- (void)showPreviewProgressWithStatus:(id)a3 animated:(BOOL)a4
{
  ...
  else
  {
    ...
    if (v9)
    {
      uint64_t v10 = [(SKUIHorizontalLockupView *)self _previewProgressIndicator];
      uint64_t v11 = v10;
      if (v4)
      {
        id v12 = [(SKUIHorizontalLockupView *)self _addFlipContainerViewWithFrontView:v9 backView:v10];
...
uint64_t __67__SKUIHorizontalLockupView_showPreviewProgressWithStatus_animated___block_invoke(uint64_t a1)
{
...
- (void)togglePreviewPlaybackAnimated:(BOOL)a3
{
  id v4 = [(SKUIHorizontalLockupView *)self _previewMediaURL];
  if (v4)
  {
    id v12 = v4;
    ...
    else
    {
      ...
      uint64_t v10 = [(SKUIViewElement *)self->_lockupElement firstChildForElementType:90];
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v10) {
        +[SKUIHorizontalLockupView requestLayoutForViewElement:width:context:](v10, v11, v12, v13, v14, v15, v16, v17);
      }
    }
  }
  char v18 = [[SKUIHorizontalLockupLayout alloc] initWithLockup:v8 context:v9];
  uint64_t v31 = 0;
  v32 = &v31;
  ...
  -[SKUIHorizontalLockupLayout sizeColumnsToFitWidth:context:](v18, "sizeColumnsToFitWidth:context:", v20, a4, v23, v24, v25, v26);
  id v21 = (void *)v32[5];
  if (v21)
  {
    v22 = [v21 childViewElements];
    [(id)v32[5] size];
    objc_msgSend(a1, "_requestLayoutForViewElements:width:context:", v22, v20);
  }
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9) {
        +[SKUIHorizontalLockupView sizeThatFitsWidth:viewElement:context:](v9, v10, v11, v12, v13, v14, v15, v16);
      }
    }
  }
  uint64_t v28 = 0;
  ...
  double v32 = a3;
  uint64_t v33 = 0;
  uint64_t v17 = [[SKUIHorizontalLockupLayout alloc] initWithLockup:v7 context:v8];
  [(SKUIHorizontalLockupLayout *)v17 sizeColumnsToFitWidth:v8 context:a3];
  uint64_t v24 = 0;
  v25 = (double *)&v24;
  uint64_t v26 = 0x2020000000;
  uint64_t v27 = 0;
  char v18 = [(SKUIHorizontalLockupLayout *)v17 columns];
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  uint64_t v16 = [[SKUIHorizontalLockupLayout alloc] initWithLockup:v9 context:v10];
  layout = self->_layout;
  self->_layout = v16;
  ...
  if ([v9 lockupViewType] == 7 || objc_msgSend(v9, "lockupViewType") == 6)
  {
    ...
    {
      char v18 = (UIView *)objc_alloc_init(MEMORY[0x1E4FB1EB0]);
    ...
    double v20 = [v9 style];
    double v21 = [v20 ikBackgroundColor];
    ...
    if (!v22)
    {
      ...
      {
        double v22 = [MEMORY[0x1E4FB1618] colorWithWhite:0.109803922 alpha:0.72];
      }
      else
      {
        double v22 = 0;
  ...
  else
  {
    ...
    double v22 = self->_metadataBackgroundView;
  ...
  if ([(NSMutableArray *)self->_tappableViews count]
    || [(SKUILockupViewElement *)self->_lockupElement isSelectable])
  {
    tapGestureRecognizer = self->_tapGestureRecognizer;
    if (!tapGestureRecognizer)
    {
      v25 = (UITapGestureRecognizer *)[objc_alloc(MEMORY[0x1E4FB1D38]) initWithTarget:self action:sel__tapGestureAction_];
      uint64_t v26 = self->_tapGestureRecognizer;
  ...
  uint64_t v28 = *MEMORY[0x1E4FB8920];
  [v27 removeObserver:self name:*MEMORY[0x1E4FB8920] object:0];
  id v29 = [(SKUIHorizontalLockupView *)self _previewMediaURL];
  if (v29
  ...
  uint64_t v33 = +[SKUIMediaPlayerInterface sharedInstance];
  ...
  if (v34)
  {
    ...
    if (v35)
    {
      id v36 = +[SKUIMediaPlayerInterface sharedInstance];
      ...
      {
        BOOL v40 = [(SKUIPlayButtonControl *)self->_playButton isIndeterminate];
          ...
          if (v14 > 28)
          {
            switch(v14)
            {
              ...
              case '2':
                goto LABEL_32;
              case '3':
                double v32 = [*(id *)(a1 + 32) addImageDeckViewWithElement:v13 width:*(void *)(a1 + 40) context:*(double *)(a1 + 64)];
                goto LABEL_78;
              default:
                if (v14 != 29)
                {
...
LABEL_63:
                ...
                v35 = [v13 ancestorElementMatchingPredicate:&__block_literal_global_42];
                unint64_t v38 = v69;
                if (!v35)
                {
...
LABEL_32:
                id v28 = v13;
                id v29 = [*(id *)(a1 + 32) addButtonWithElement:v28 width:*(void *)(a1 + 40) context:v10];
                objc_opt_class();
                if (objc_opt_isKindOfClass()) {
                  objc_storeStrong((id *)(*(void *)(a1 + 48) + 536), v29);
                }
                [v29 addTarget:0 action:sel_skuiadvertising_advertSelectionEventShouldBeForwarded_ forControlEvents:64];
...
LABEL_17:
                double v20 = [*(id *)(a1 + 32) addButtonWithElement:v13 width:*(void *)(a1 + 40) context:v10];
                ...
                [v20 addTarget:0 action:sel_skuiadvertising_advertSelectionEventShouldBeForwarded_ forControlEvents:64];
                LODWORD(v21) = -1.0;
                [v20 setCharge:v21];
        ...
        if (v14 > 134)
        {
          ...
          switch(v14)
          {
            ...
            default:
              ...
              double v32 = [*(id *)(a1 + 32) addImageGridViewWithElement:v13 width:*(void *)(a1 + 40) context:*(double *)(a1 + 64)];
              break;
          }
LABEL_78:
          id v45 = v32;
...
LABEL_79:
        ...
        if (v14 <= 79)
        {
          if (v14 == 62)
          {
            double v32 = [*(id *)(a1 + 32) addHorizontalListWithElement:v13 width:*(void *)(a1 + 40) context:v10];
            goto LABEL_78;
          }
          id v17 = 0;
          char v18 = 0;
...
LABEL_99:
        if (v18)
        {
          ...
          if (v51)
          {
            ...
            if (!v52)
            {
              uint64_t v53 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:517 capacity:1];
        ...
        if (v16)
        {
          ...
          if (v56)
          {
            ...
            if (!v57)
            {
              uint64_t v58 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:5 valueOptions:0 capacity:1];
        ...
        if (v22)
        {
          ...
          if (!v61)
          {
            uint64_t v62 = [objc_alloc(MEMORY[0x1E4F28D30]) initWithOptions:517 capacity:1];
...
uint64_t __64__SKUIHorizontalLockupView_reloadWithViewElement_width_context___block_invoke_3(uint64_t a1, void *a2)
{
...
{
  v62.receiver = self;
  v62.super_class = (Class)SKUIHorizontalLockupView;
  [(SKUIHorizontalLockupView *)&v62 layoutSubviews];
  if (([(SKUIGradientView *)self->_offerConfirmationGradientView isDescendantOfView:self] & 1) == 0)
  {
    ...
    double v8 = v7;
    uint64_t v10 = v9;
    uint64_t v11 = [(SKUILockupViewElement *)self->_lockupElement style];
    uint64_t v12 = [v11 elementPosition];

    if (!v12) {
      uint64_t v12 = 2 * ([(SKUILockupViewElement *)self->_lockupElement lockupViewType] == 6);
    }
    uint64_t v34 = v12;
    uint64_t v33 = [(SKUIHorizontalLockupView *)self _previewFrontView];
    uint64_t v13 = [(SKUIHorizontalLockupLayout *)self->_layout columns];
    ...
    *(double *)&v61[3] = v17;
    ...
    long long v50 = v18;
    BOOL v19 = [(SKUIHorizontalLockupLayout *)self->_layout columns];
    v47[0] = MEMORY[0x1E4F143A8];
    v47[1] = 3221225472;
    v47[2] = __42__SKUIHorizontalLockupView_layoutSubviews__block_invoke;
    v47[3] = &unk_1E6426EC0;
    v47[9] = v4;
    v47[10] = v6;
    *(double *)&v47[11] = v8;
    ...
    if (v56[3] != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      [(SKUIHorizontalLockupView *)self _sizeViewsForColumn:v21 toFitWidth:v52[3]];
      uint64_t v23 = v22;
    ...
    v46[2] = 0x2020000000;
    *(double *)&v46[3] = left;
    long long v25 = [(SKUIHorizontalLockupLayout *)self->_layout columns];
    v35[0] = MEMORY[0x1E4F143A8];
    v35[1] = 3221225472;
    v35[2] = __42__SKUIHorizontalLockupView_layoutSubviews__block_invoke_2;
    v35[3] = &unk_1E6426F10;
    uint64_t v40 = v15;
    uint64_t v41 = v34;
    v35[4] = self;
...
LABEL_11:
  ...
  v33[1] = 3221225472;
  v33[2] = __42__SKUIHorizontalLockupView_layoutSubviews__block_invoke_3;
  v33[3] = &unk_1E6426EE8;
...
void __42__SKUIHorizontalLockupView_layoutSubviews__block_invoke_3(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  switch(*(void *)(a1 + 88))
  {
    ...
    case 1:
    case 2:
      uint64_t v14 = [v78 style];
      uint64_t v15 = [v14 elementPosition];

      if (v15 == 7 || v15 == 1)
      {
        uint64_t v16 = [v78 style];
        [v16 elementPadding];
        double v18 = v17;
      }
      else
    ...
    case 3:
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        [v24 frame];
        double v7 = v7 + CGRectGetWidth(v81) + 5.0;
        [v24 frame];
        CGFloat v25 = CGRectGetWidth(v82) + 5.0;
        v83.origin.double x = v7;
        v83.origin.double y = v9;
        v83.size.double width = v11;
        v83.size.double height = v13;
        double v26 = v25 + CGRectGetWidth(v83);
...
LABEL_19:
      ...
      {
LABEL_20:
        [*(id *)(*(void *)(a1 + 32) + 496) topPaddingForViewElement:v78];
        int v33 = 0;
...
LABEL_32:
        ...
        *(double *)(*(void *)(*(void *)(a1 + 80) + 8) + 24) = v43 - CGRectGetHeight(v84);
      }
LABEL_33:
      long long v44 = [v78 style];
      ...
      {
        double v49 = [v78 style];
        [v49 elementPadding];
        double v51 = v50;

        CGFloat v52 = CGRectGetMaxY(*(CGRect *)(a1 + 112)) - *(double *)(*(void *)(a1 + 32) + 464);
        v85.origin.double x = v7;
        v85.origin.double y = v9;
        v85.size.double width = v11;
        v85.size.double height = v13;
        double v53 = v52 - CGRectGetHeight(v85) - v51;
LABEL_45:
...
LABEL_47:
      ...
      {
        v86.origin.double x = v7;
        v86.origin.double y = v48;
        v86.size.double width = v11;
        v86.size.double height = v13;
        float v57 = CGRectGetHeight(v86) * 0.5;
        double v48 = (float)-floorf(v57);
        uint64_t v58 = [v78 style];
        [v58 elementPadding];
        double v60 = v59;
        ...
        float v62 = v60 + CGRectGetWidth(v87);
        double v7 = v61 - floorf(v62);
      }
      SKUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v7, v48, v11, v13, *(CGFloat *)(a1 + 112), *(CGFloat *)(a1 + 120), *(CGFloat *)(a1 + 128), *(CGFloat *)(a1 + 136));
      objc_msgSend(v5, "setFrame:");
      if (*(void *)(a1 + 88) != 3 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
      {
        v88.origin.double x = v7;
        v88.origin.double y = v48;
        v88.size.double width = v11;
        v88.size.double height = v13;
        double MaxY = CGRectGetMaxY(v88);
        [*(id *)(*(void *)(a1 + 32) + 496) bottomPaddingForViewElement:v78];
        *(double *)(*(void *)(*(void *)(a1 + 80) + 8) + 24) = MaxY + v64;
      }
      if (objc_opt_respondsToSelector())
      {
        v89.origin.double x = v7;
        v89.origin.double y = v48;
        v89.size.double width = v11;
        v89.size.double height = v13;
        double v65 = -CGRectGetMinY(v89);
        v90.origin.double x = v7;
        v90.origin.double y = v48;
        v90.size.double width = v11;
        v90.size.double height = v13;
        CGFloat Width = CGRectGetWidth(v90);
        double v67 = 0.0;
        if (Width < 44.0)
        {
          v91.origin.double x = v7;
          v91.origin.double y = v48;
          v91.size.double width = v11;
          v91.size.double height = v13;
          double v67 = (CGRectGetWidth(v91) + -44.0) * 0.5;
        }
...
LABEL_57:
      if (v5 == *(void **)(a1 + 48))
      {
        ...
        if (v69)
        {
          ...
          CGFloat v75 = v74;
          UIRoundToViewScale();
          v76 = *(void **)(*(void *)(a1 + 32) + 544);
          SKUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v75, v77, v71, v73, *(CGFloat *)(a1 + 112), *(CGFloat *)(a1 + 120), *(CGFloat *)(a1 + 128), *(CGFloat *)(a1 + 136));
    ...
    case 6:
      ...
      SKUIRectByApplyingStoreUserInterfaceLayoutDirectionInRect(v32[4], v32[5], v32[6], v32[7], *(CGFloat *)(a1 + 112), *(CGFloat *)(a1 + 120), *(CGFloat *)(a1 + 128), *(CGFloat *)(a1 + 136));
      objc_msgSend(v5, "setFrame:");
      goto LABEL_57;
    default:
      goto LABEL_19;
...
- (void)setSemanticContentAttribute:(int64_t)a3
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)SKUIHorizontalLockupView;
  -[SKUIHorizontalLockupView setSemanticContentAttribute:](&v14, sel_setSemanticContentAttribute_);
  long long v12 = 0u;
  long long v13 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
  id v5 = [(SKUIHorizontalLockupView *)self subviews];
...
- (void)setBackgroundColor:(id)a3
{
  ...
  if ([(SKUILockupViewElement *)self->_lockupElement lockupViewType] == 5 || self->_useClearBackground)
  {
    ...
    v10.receiver = self;
    v10.super_class = (Class)SKUIHorizontalLockupView;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  long long v12 = &unk_1C1D0F257;
  CGFloat width = a3.width;
  uint64_t v14 = 0;
  uint64_t v3 = [(SKUIHorizontalLockupLayout *)self->_layout columns];
...
{
  id v4 = a3;
  -[SKUIHorizontalLockupView _animateButton:](self, "_animateButton:");
  if ([(SKUIHorizontalLockupView *)self updateLayoutOnButtonConfirmation]) {
    ...
    -[SKUIHorizontalLockupView _layoutConfirmationGradientRelativeToItemOfferView:alpha:](self, "_layoutConfirmationGradientRelativeToItemOfferView:alpha:", v4, (double)[v4 isShowingConfirmation]);
  }
}
...
- (void)mediaPlayer:(id)a3 itemStateChanged:(id)a4
{
  ...
  if (playButton)
  {
    double v9 = [(SKUIPlayButton *)playButton playItemIdentifier];
    BOOL v10 = +[SKUIMediaPlayerInterface identifierMatches:v9 item:v7];
...
LABEL_7:
    ...
    if ([(SKUIPlayButtonControl *)self->_playButton isIndeterminate]
      || [(SKUIPlayButtonControl *)self->_playButton showingProgress])
    {
      v13[0] = MEMORY[0x1E4F143A8];
      v13[1] = 3221225472;
...
uint64_t __57__SKUIHorizontalLockupView_mediaPlayer_itemStateChanged___block_invoke_3(uint64_t a1)
{
...
BOOL __65__SKUIHorizontalLockupView_gestureRecognizer_shouldReceiveTouch___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  [a2 frame];
...
- (void)_buttonAction:(id)a3
{
  ...
  id v4 = (SKUIPlayButton *)a3;
  uint64_t v5 = [(SKUIHorizontalLockupView *)self _viewElementForView:v4];
  id v6 = (void *)v5;
  if (self->_playButton == v4)
  {
    [(SKUIHorizontalLockupView *)self _handlePlayButtonTap:v4 element:v5];
  }
  else if (v5)
  {
    CGRect v7 = SKUICollectionViewCellForView(self);
    double v8 = SKUICollectionViewForView(v7);
    ...
    else
    {
      ...
      {
        uint64_t v10 = v4;
        BOOL v11 = (void *)MEMORY[0x1E4F1CA60];
        v19[0] = @"toggled";
        long long v12 = objc_msgSend(NSNumber, "numberWithBool:", -[SKUIPlayButton isToggled](v10, "isToggled"));
        v20[0] = v12;
        v20[1] = v6;
        v19[1] = @"target";
        v19[2] = @"count";
        double v13 = objc_msgSend(NSNumber, "numberWithInteger:", -[SKUIPlayButton count](v10, "count"));
        v20[2] = v13;
        uint64_t v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v20 forKeys:v19 count:3];
        CGRect v15 = [v11 dictionaryWithDictionary:v14];

        uint64_t v16 = [(SKUIPlayButton *)v10 toggleItemIdentifier];

        if (v16)
        {
          char v17 = [(SKUIPlayButton *)v10 toggleItemIdentifier];
...
- (void)_tapGestureAction:(id)a3
{
  ...
  uint64_t v14 = __Block_byref_object_copy__40;
  tappableViews = self->_tappableViews;
  CGRect v15 = __Block_byref_object_dispose__40;
  id v16 = 0;
  ...
  if (v12[5])
  {
    double v8 = -[SKUIHorizontalLockupView _viewElementForView:](self, "_viewElementForView:");
...
void __46__SKUIHorizontalLockupView__tapGestureAction___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v19 = a2;
  [v19 frame];
  double v8 = v7;
...
- (void)_animateButton:(id)a3
{
  ...
  *((void *)&v25 + 1) = v8;
  ...
  v10[1].size.double height = v12;
  id v13 = [(SKUIHorizontalLockupView *)self _viewElementForView:v4];
  double v14 = [(SKUIHorizontalLockupLayout *)self->_layout columns];
  v16[0] = MEMORY[0x1E4F143A8];
  v16[1] = 3221225472;
...
void __43__SKUIHorizontalLockupView__animateButton___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v9 = a2;
...
+ (id)_attributedStringForButton:(id)a3 context:(id)a4
{
  ...
  int v7 = +[SKUIHorizontalLockupLayout fontForButtonViewElement:v5 context:v6];
  ...
  CGFloat v11 = SKUIViewElementPlainColorWithStyle(v9, v10);
  ...
  }
  {
    ...
    CGFloat v11 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:dbl_1C1CCBD20[v12]];
  }
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v7) {
        +[SKUIHorizontalLockupView _attributedStringForLabel:context:](v7, v8, v9, v10, v11, v12, v13, v14);
      }
    }
  }
  id v15 = +[SKUIHorizontalLockupLayout fontForLabelViewElement:v5 context:v6];
  double v16 = [v5 style];
  id v17 = [v6 tintColor];
  double v18 = SKUIViewElementPlainColorWithStyle(v16, v17);

  if (!v18)
  {
    CGFloat v19 = [v6 aggregateValueForKey:@"SKUIPreviewOverlayBackgroundStyleKey"];
    uint64_t v20 = v19;
    if (v19) {
      BOOL v21 = [v19 integerValue] == 0;
    }
    else {
      BOOL v21 = 1;
    }
    unint64_t v22 = [v5 labelViewStyle];
    if (v22 > 5)
    {
      double v18 = 0;
LABEL_23:
...
LABEL_13:
        double v24 = 0.0;
LABEL_19:
        uint64_t v25 = [MEMORY[0x1E4FB1618] colorWithWhite:v24 alpha:v23];
LABEL_22:
        double v18 = (void *)v25;
        goto LABEL_23;
      }
...
LABEL_24:
  double v26 = [v5 text];
  double v27 = [v5 style];
  double v28 = [v26 attributedStringWithDefaultFont:v15 foregroundColor:v18 style:v27];
...
+ (id)_attributedStringForOrdinal:(id)a3 context:(id)a4
{
  ...
  BOOL v7 = +[SKUIHorizontalLockupLayout fontForOrdinalViewElement:v5 context:v6];
  uint64_t v8 = [v5 style];
  uint64_t v9 = [v6 tintColor];

  uint64_t v10 = SKUIViewElementPlainColorWithStyle(v8, v9);
  ...
  uint64_t v12 = [v11 attributedStringWithDefaultFont:v7 foregroundColor:v10];
...
- (void)_handlePlayButtonTap:(id)a3 element:(id)a4
{
  id v11 = a3;
  id v5 = a4;
  id v6 = +[SKUIMediaPlayerInterface sharedInstance];
  BOOL v7 = [v11 playItemIdentifier];
  int v8 = [v6 isItemWithIdentifierActive:v7];

  if (v8)
  {
    uint64_t v9 = [v11 playItemIdentifier];
    [v6 togglePlayStateForItemWithIdentifier:v9];
  }
  else if (v5)
  {
    uint64_t v10 = [v11 playItemIdentifier];
...
+ (void)_requestLayoutForViewElements:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      BOOL v10 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_DEBUG);
      if (v10) {
        +[SKUIHorizontalLockupView _requestLayoutForViewElements:width:context:](v10, v11, v12, v13, v14, v15, v16, v17);
      }
    }
  }
  ...
  if (v20)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v21; ++i)
      {
        ...
        double v24 = *(void **)(*((void *)&v32 + 1) + 8 * i);
        uint64_t v25 = [v24 elementType];
        if (v25 > 79)
        {
          switch(v25)
          {
            case 135:
              double v26 = SKUIStarRatingViewElementView;
              goto LABEL_36;
            case 136:
            case 137:
            case 139:
            ...
            case 138:
              id v28 = v24;
              uint64_t v29 = [v9 maxWidthForElement:v28 withDefaultWidth:(uint64_t)a4];
              if ([a1 _usesEditorialLayoutForLabelViewElement:v28])
              {
                double v30 = [v9 editorialLayoutForLabelElement:v28 width:(double)v29];
                [v30 enqueueLayoutRequests];
              }
              else
              {
                double v30 = [a1 _attributedStringForLabel:v28 context:v9];
            ...
            case 141:
              goto LABEL_28;
            case 144:
              double v26 = SKUITomatoRatingView;
              goto LABEL_36;
            default:
              if (v25 == 80)
              {
                double v27 = [a1 _attributedStringForOrdinal:v24 context:v9];
                [v18 requestLayoutForOrdinal:v24 attributedString:v27 width:(uint64_t)a4];
                goto LABEL_38;
              }
              if (v25 != 154) {
                continue;
              }
              double v26 = SKUIImageGridView;
              break;
          }
          goto LABEL_36;
        }
        if (v25 <= 48)
        {
          ...
          if (v25 != 12)
          {
            ...
            double v26 = SKUISectionHeaderView;
            goto LABEL_36;
          }
LABEL_28:
          double v27 = [a1 _attributedStringForButton:v24 context:v9];
...
LABEL_38:
        ...
        else
        {
          if (v25 > 61)
          {
            if (v25 == 62)
            {
              double v26 = SKUIHorizontalListView;
            }
            else
            {
              if (v25 != 77) {
...
+ (BOOL)_usesEditorialLayoutForLabelViewElement:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v4) {
        +[SKUIHorizontalLockupView _usesEditorialLayoutForLabelViewElement:](v4, v5, v6, v7, v8, v9, v10, v11);
      }
    }
  }
  ...
  {
    uint64_t v13 = [v3 moreButtonTitle];
    BOOL v12 = [v13 length] != 0;
  }
  return v12;
}
...
- (void)_addConfirmationGradientForView:(id)a3
{
  ...
  double v24 = __Block_byref_object_copy__40;
  uint64_t v25 = __Block_byref_object_dispose__40;
  id v26 = 0;
  uint64_t v6 = [(SKUIHorizontalLockupView *)self _columnForView:v4];
  uint64_t v7 = [v6 childViewElements];
  v18[0] = MEMORY[0x1E4F143A8];
  v18[1] = 3221225472;
  v18[2] = __60__SKUIHorizontalLockupView__addConfirmationGradientForView___block_invoke;
  v18[3] = &unk_1E64262E0;
  v18[4] = self;
  uint64_t v20 = &v21;
  id v8 = v5;
  ...
  uint64_t v9 = [(SKUIHorizontalLockupView *)self gradientColor];
  if (!v9)
  {
    uint64_t v9 = [(UIView *)self skui_apparentBackgroundColor];
    if (!v9)
    {
  ...
  {
    uint64_t v11 = [SKUIGradientView alloc];
    BOOL v12 = -[SKUIGradientView initWithFrame:](v11, "initWithFrame:", *MEMORY[0x1E4F1DB28], *(double *)(MEMORY[0x1E4F1DB28] + 8), *(double *)(MEMORY[0x1E4F1DB28] + 16), *(double *)(MEMORY[0x1E4F1DB28] + 24));
    uint64_t v13 = self->_offerConfirmationGradientView;
    self->_offerConfirmationGradientView = v12;

    uint64_t v14 = [(SKUIGradientView *)self->_offerConfirmationGradientView layer];
    id v15 = [v9 colorWithAlphaComponent:0.0];
    v27[0] = [v15 CGColor];
    id v16 = v9;
    v27[1] = [v16 CGColor];
    v27[2] = [v16 CGColor];
    uint64_t v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v27 count:3];
    [v14 setColors:v17];
...
- (id)_addFlipContainerViewWithFrontView:(id)a3 backView:(id)a4
{
  ...
  double v9 = v8;
  double v11 = v10;
  BOOL v12 = [[SKUIInlineFlipContainerView alloc] initWithFrontView:v7 backView:v6];
...
- (id)_columnForView:(id)a3
{
  ...
  double v16 = __Block_byref_object_copy__40;
  double v17 = __Block_byref_object_dispose__40;
  id v18 = 0;
  uint64_t v5 = [(SKUIHorizontalLockupView *)self _viewElementForView:v4];
  id v6 = [(SKUIHorizontalLockupLayout *)self->_layout columns];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
...
void __43__SKUIHorizontalLockupView__columnForView___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v9 = a2;
...
{
  id v8 = a3;
  id v4 = SKUICollectionViewCellForView(self);
  float v5 = SKUICollectionViewForView(v4);
...
- (void)_layoutConfirmationGradientRelativeToItemOfferView:(id)a3 alpha:(double)a4
{
  ...
  if (self->_offerConfirmationGradientView)
  {
    ...
    double v11 = v10;
    BOOL v12 = [(SKUIGradientView *)self->_offerConfirmationGradientView superview];
    [v12 bounds];
    double v14 = v13;

    double v15 = v9 + 30.0;
    [(SKUIGradientView *)self->_offerConfirmationGradientView setAlpha:a4];
    -[SKUIGradientView setFrame:](self->_offerConfirmationGradientView, "setFrame:", v7 + -30.0, v11, v15, v14);
    double v16 = [(SKUIGradientView *)self->_offerConfirmationGradientView layer];
    double v17 = objc_msgSend(NSNumber, "numberWithDouble:", 30.0 / v15, &unk_1F1D61D30);
    v19[1] = v17;
    v19[2] = &unk_1F1D61D48;
...
void *__58__SKUIHorizontalLockupView__performDefaultActionForImage___block_invoke_2(uint64_t a1)
{
  ...
  if (result == *(void **)(*(void *)(a1 + 40) + 504))
  {
    ...
    return (void *)MEMORY[0x1F41817F8](v3, v4);
  }
  return result;
}
...
- (id)_previewFrontView
{
  id v3 = [(SKUIViewElement *)self->_lockupElement firstChildForElementType:90];
...
- (id)_previewMediaURL
{
  uint64_t v2 = [(SKUIViewElement *)self->_lockupElement firstChildForElementType:90];
...
- (id)_previewProgressIndicator
{
  ...
  {
    id v3 = -[SKUIPreviewProgressIndicator initWithFrame:]([SKUIPreviewProgressIndicator alloc], "initWithFrame:", 0.0, 0.0, 29.0, 29.0);
    previewProgressIndicator = self->_previewProgressIndicator;
  ...
  double v7 = [(SKUIViewElement *)self->_lockupElement firstChildForElementType:90];
  id v8 = self->_previewProgressIndicator;
  uint64_t v9 = [v7 style];
  id v10 = SKUIViewElementPlainColorWithStyle(v9, 0);
...
- (void)_resolvePreviewStateAfterTransitionForFlipView:(id)a3
{
  ...
  if (previewState == 3)
  {
    ...
    uint64_t v23 = [(SKUIHorizontalLockupView *)self _previewFrontView];
  ...
  else if (previewState == 1)
  {
    ...
    -[SKUIHorizontalLockupView convertRect:fromView:](self, "convertRect:fromView:", v14, v7, v9, v11, v13);
    double v16 = v15;
    double v18 = v17;
    double v20 = v19;
    double v22 = v21;
...
- (void)_resizeMetadataRelativeToItemOfferView:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(SKUIHorizontalLockupView *)self _columnForView:v4];
  long long v35 = 0u;
  long long v36 = 0u;
  long long v37 = 0u;
  long long v38 = 0u;
...
void __59__SKUIHorizontalLockupView__sizeViewsForColumn_toFitWidth___block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  uint64_t v7 = *(void *)(MEMORY[0x1E4F1DB28] + 8);
...
- (BOOL)_usesBackgroundWithAlpha
{
  ...
  double v5 = 0.0;
  uint64_t v6 = 0;
  uint64_t v2 = [(SKUIHorizontalLockupView *)self backgroundColor];
