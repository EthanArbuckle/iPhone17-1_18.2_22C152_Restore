...
- (void)run
{
  ...
  v4 = [(SKUIReportAConcernOperation *)self metadata];
  id v5 = [v4 reportConcernURL];

  v6 = (void *)[objc_alloc(MEMORY[0x1E4FA8268]) initWithURL:v5];
  [v6 setAllowedRetryCount:0];
  [v6 setCachePolicy:1];
  v7 = [(SKUIReportAConcernOperation *)self _httpBody];
  [v6 setHTTPBody:v7];
  ...
  id v14 = 0;
  int v9 = [(SKUIReportAConcernOperation *)self runSubOperation:v3 returningError:&v14];
  id v10 = v14;
  BOOL v11 = 0;
  if (v9)
  {
    ...
    [(SKUIReportAConcernOperation *)self setResponseDictionary:v12];
  }
...
- (id)_httpBody
{
  v2 = [(SKUIReportAConcernOperation *)self metadata];
  ...
  id v10 = [MEMORY[0x1E4FB8800] sharedInstance];
  BOOL v11 = [v10 guid];
