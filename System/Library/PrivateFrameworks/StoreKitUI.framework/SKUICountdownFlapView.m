...
- (SKUICountdownFlapView)initWithPosition:(int64_t)a3 flapTopColor:(id)a4 flapBottomColor:(id)a5
{
  ...
  v32.receiver = self;
  v32.super_class = (Class)SKUICountdownFlapView;
  ...
  if (v11)
  {
    ...
    uint64_t v13 = [(SKUICountdownFlapView *)v12 _newLabel];
    ...
    uint64_t v17 = [(SKUICountdownFlapView *)v12 _newLabel];
    ...
    uint64_t v21 = [(SKUICountdownFlapView *)v12 _newLabel];
    ...
    uint64_t v26 = [(SKUICountdownFlapView *)v12 _newLabel];
...
LABEL_7:
  ...
  *(float *)&double v27 = v25 * v27;
  ...
  v29 = [MEMORY[0x1E4FB1BA8] mainScreen];
  [v29 scale];
  ...
  *(float *)&double v48 = v46 * v48;
  ...
  v54 = [MEMORY[0x1E4FB1BA8] mainScreen];
  [v54 scale];
  *(float *)&double v55 = v53 * v55;
  ...
  v61 = [MEMORY[0x1E4FB1BA8] mainScreen];
  [v61 scale];
  *(float *)&double v62 = v60 * v62;
  ...
  v68 = [MEMORY[0x1E4FB1BA8] mainScreen];
  [v68 scale];
  *(float *)&double v69 = v67 * v69;
  double v70 = roundf(*(float *)&v69);
  v71 = [MEMORY[0x1E4FB1BA8] mainScreen];
  [v71 scale];
...
- (void)setFrame:(CGRect)a3
{
  ...
  v25.receiver = self;
  v25.super_class = (Class)SKUICountdownFlapView;
  -[SKUICountdownFlapView setFrame:](&v25, sel_setFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  double factor = self->_factor;
  int64_t position = self->_position;
  switch(position)
  {
...
LABEL_4:
  ...
  if (width / 14.0 != factor && width / 14.0 != 0.0)
  {
    ...
    id v8 = [(SKUICountdownFlapView *)self _newBackgroundImageForTop:1];
    [(UIImageView *)backgroundViewTransitionTop setImage:v8];

    backgroundViewTransitionBot = self->_backgroundViewTransitionBot;
    id v10 = [(SKUICountdownFlapView *)self _newBackgroundImageForTop:0];
    [(UIImageView *)backgroundViewTransitionBot setImage:v10];

    id v11 = [(SKUICountdownFlapView *)self _newBackgroundImageForTop:0xFFFFFFFFLL];
    [(SKUICountdownFlapView *)self setImage:v11];

    float v12 = self->_factor * 24.0;
    float v13 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:roundf(v12)];
    long long v21 = 0u;
    long long v22 = 0u;
    long long v23 = 0u;
    long long v24 = 0u;
    ...
    double v16 = objc_msgSend(MEMORY[0x1E4F1C978], "arrayWithObjects:count:", v26, 4, 0);
...
- (void)setString:(id)a3
{
  ...
  if (([v5 isEqualToString:string] & 1) == 0)
  {
    ...
    {
      float v14 = (void *)MEMORY[0x1E4F29238];
      [(SKUICountdownFlapView *)self _transformForAngle:1 isTop:(float)((float)i / 10.0) * 3.14159265 * 0.5];
...
- (void)setTextColor:(id)a3
{
  ...
  if (self->_textColor != v5)
  {
    ...
    {
      float v12 = [MEMORY[0x1E4FB1618] whiteColor];
    ...
    {
      float v14 = [MEMORY[0x1E4FB1618] whiteColor];
...
- (void)animationDidStop:(id)a3 finished:(BOOL)a4
{
  ...
  if (v7 == v5)
  {
    ...
    for (uint64_t i = 0; i != 11; ++i)
    {
      ...
      [(SKUICountdownFlapView *)self _transformForAngle:0 isTop:(float)(1.0 - (float)((float)i / 10.0)) * 3.14159265 * 0.5];
    ...
    id v15 = objc_alloc_init(MEMORY[0x1E4F39BD8]);
...
- (id)_newBackgroundImageForTop:(int)a3
{
  ...
  {
    double factor = self->_factor;
    long long v24 = [MEMORY[0x1E4FB1BA8] mainScreen];
    [v24 scale];
    *(float *)&double v25 = factor * v25;
    double v26 = roundf(*(float *)&v25);
    double v27 = [MEMORY[0x1E4FB1BA8] mainScreen];
    [v27 scale];
  ...
  else
  {
    if (!a3)
    {
      ...
      *(float *)&double v18 = v16 * v18;
      ...
      double v20 = [MEMORY[0x1E4FB1BA8] mainScreen];
      [v20 scale];
...
LABEL_7:
  ...
  *(_OWORD *)locations = xmmword_1C1CCB440;
  ...
  if (!flapTopColor)
  {
    double v46 = [MEMORY[0x1E4FB1618] blackColor];
  }
  ...
  if (!flapBottomColor)
  {
    double v49 = [MEMORY[0x1E4FB1618] colorWithWhite:0.4 alpha:1.0];
  }
  ...
  v55[0] = v47;
  v55[1] = v50;
  CFArrayRef v51 = CFArrayCreate(0, v55, 2, MEMORY[0x1E4F1D510]);
...
- (CATransform3D)_transformForAngle:(SEL)a3 isTop:(double)a4
{
  ...
  double v25 = (long long *)MEMORY[0x1E4F39B10];
  double v26 = v20 * 0.25;
  double v27 = v12 * 0.5;
