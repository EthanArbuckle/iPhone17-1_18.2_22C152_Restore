@interface SKUIMediaSocialSaveProfilePhotoOperation
- (SKUIMediaSocialSaveProfilePhotoOperation)initWithClientContext:(id)a3;
...
@implementation SKUIMediaSocialSaveProfilePhotoOperation
...
- (SKUIMediaSocialSaveProfilePhotoOperation)initWithClientContext:(id)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)SKUIMediaSocialSaveProfilePhotoOperation;
...
- (void)main
{
  ...
  v23 = __Block_byref_object_copy__105;
  v24 = __Block_byref_object_dispose__105;
  id v25 = 0;
  id obj = 0;
  v3 = [(SKUIMediaSocialSaveProfilePhotoOperation *)self _requestWithError:&obj];
  objc_storeStrong(&v25, obj);
  if (v3)
  {
    id v4 = [(SSVComplexOperation *)self newLoadURLOperationWithRequest:v3];
    id v5 = [MEMORY[0x1E4FA8388] consumer];
    ...
    v12[1] = 3221225472;
    v12[2] = __48__SKUIMediaSocialSaveProfilePhotoOperation_main__block_invoke;
    v12[3] = &unk_1E6425980;
    v12[4] = &v13;
    v12[5] = &v20;
    ...
    else
    {
      ...
      if ([v7 statusCode] < 200 || objc_msgSend(v7, "statusCode") > 299)
      {
        ...
        uint64_t v8 = [MEMORY[0x1E4F28C58] errorWithDomain:@"SKUIErrorDomain" code:0 userInfo:0];
        }
        v9 = (void *)v21[5];
        v21[5] = v8;
      ...
      {
        id v6 = [(SKUIMediaSocialSaveProfilePhotoOperation *)self _photoUploadWithResponseDictionary:v14[5]];
      }
    }
  ...
  uint64_t v10 = [(SKUIMediaSocialSaveProfilePhotoOperation *)self outputBlock];
...
void __48__SKUIMediaSocialSaveProfilePhotoOperation_main__block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v10 = a2;
  id v5 = a3;
  objc_opt_class();
...
- (id)_photoUploadWithResponseDictionary:(id)a3
{
  ...
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    id v4 = [[SKUIMediaSocialPhotoUpload alloc] initWithUploadDictionary:v3];
  }
  else {
    id v4 = 0;
  }
...
- (id)_requestWithError:(id *)a3
{
  id v5 = [(SKUIClientContext *)self->_clientContext URLBag];
  ...
  if (objc_opt_isKindOfClass())
  {
    if (self->_photo)
    {
      ...
      id v8 = (void *)[objc_alloc(MEMORY[0x1E4F18D50]) initWithURL:v7];
    ...
    if (a3)
    {
      uint64_t v13 = (void *)[objc_alloc(MEMORY[0x1E4F28C58]) initWithDomain:@"SKUIErrorDomain" code:4 userInfo:0];
      goto LABEL_8;
    }
  }
  else if (a3)
...
- (void)initWithClientContext:.cold.1()
{
  ...
  int v0 = 136446210;
  v1 = "-[SKUIMediaSocialSaveProfilePhotoOperation initWithClientContext:]";
}
