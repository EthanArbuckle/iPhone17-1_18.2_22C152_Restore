...
- (SKUIViewElement)cellTemplateViewElement
{
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3) {
        [(SKUIDynamicShelfMenuBarViewElement *)v3 cellTemplateViewElement];
      }
    }
  }
...
void __61__SKUIDynamicShelfMenuBarViewElement_cellTemplateViewElement__block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  *a3 = 1;
}
...
- (id)applyUpdatesWithElement:(id)a3
{
  uint64_t v4 = (SKUIDynamicShelfMenuBarViewElement *)a3;
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v5) {
        -[SKUIDynamicShelfMenuBarViewElement applyUpdatesWithElement:](v5, v6, v7, v8, v9, v10, v11, v12);
      }
    }
  }
  v18.receiver = self;
  v18.super_class = (Class)SKUIDynamicShelfMenuBarViewElement;
...
- (BOOL)isDynamicContainer
{
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v2) {
        [(SKUIDynamicShelfMenuBarViewElement *)v2 isDynamicContainer];
      }
    }
  }
  return 1;
...
- (void)setShelfItemViewElementValidator:(id)a3
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      BOOL v5 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_FAULT);
      if (v5) {
        -[SKUIDynamicShelfMenuBarViewElement setShelfItemViewElementValidator:](v5, v6, v7, v8, v9, v10, v11, v12);
      }
    }
  }
  v14.receiver = self;
  v14.super_class = (Class)SKUIDynamicShelfMenuBarViewElement;
