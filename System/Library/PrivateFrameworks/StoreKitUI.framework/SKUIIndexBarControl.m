...
{
  v6.receiver = self;
  v6.super_class = (Class)SKUIIndexBarControl;
...
- (SKUIIndexBarControl)initWithFrame:(CGRect)a3
{
  v6.receiver = self;
  v6.super_class = (Class)SKUIIndexBarControl;
  v3 = -[SKUIIndexBarControl initWithFrame:](&v6, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3) {
    _SKUIIndexBarControlInitialization(v3);
  }
...
- (void)drawRect:(CGRect)a3
{
  ...
  v4 = [(SKUIIndexBarControl *)self _displayEntries];
...
- (void)setBounds:(CGRect)a3
{
  ...
  double v11 = v10;
  v15.receiver = self;
  v15.super_class = (Class)SKUIIndexBarControl;
  -[SKUIIndexBarControl setBounds:](&v15, sel_setBounds_, x, y, width, height);
  [(SKUIIndexBarControl *)self bounds];
  if (v9 != v13 || v11 != v12) {
...
- (void)setFrame:(CGRect)a3
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)SKUIIndexBarControl;
  -[SKUIIndexBarControl setFrame:](&v15, sel_setFrame_, x, y, width, height);
  [(SKUIIndexBarControl *)self frame];
  if (v9 != v13 || v11 != v12) {
    [(SKUIIndexBarControl *)self _invalidateForChangedLayoutProperties];
  }
...
- (void)tintColorDidChange
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)SKUIIndexBarControl;
...
{
  v10.receiver = self;
  v10.super_class = (Class)SKUIIndexBarControl;
  id v4 = a3;
  [(SKUIIndexBarControl *)&v10 traitCollectionDidChange:v4];
  uint64_t v5 = [(SKUIIndexBarControl *)self traitCollection];
  [v5 displayScale];
  double v7 = v6;
  [v4 displayScale];
  double v9 = v8;
...
{
  v9.receiver = self;
  v9.super_class = (Class)SKUIIndexBarControl;
  id v6 = a4;
  id v7 = a3;
  [(SKUIIndexBarControl *)&v9 beginTrackingWithTouch:v7 withEvent:v6];
  -[SKUIIndexBarControl _sendSelectionForTouch:withEvent:](self, "_sendSelectionForTouch:withEvent:", v7, v6, v9.receiver, v9.super_class);
...
{
  v5.receiver = self;
  v5.super_class = (Class)SKUIIndexBarControl;
...
- (id)_allEntries
{
  ...
  char v9 = __Block_byref_object_dispose__46;
  id v10 = 0;
...
- (id)_allRequiredEntries
{
  ...
  uint64_t v6 = &v5;
  uint64_t v7 = 0x3032000000;
  id v8 = __Block_byref_object_copy__46;
  char v9 = __Block_byref_object_dispose__46;
  id v10 = 0;
  v4[0] = MEMORY[0x1E4F143A8];
  v4[1] = 3221225472;
...
- (void)_enumerateEntryIndexPathsUsingBlock:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v5 = [(SKUIIndexBarControl *)self _numberOfSections];
    ...
    if (v5 >= 1)
    {
      ...
      do
      {
        uint64_t v8 = [(SKUIIndexBarControl *)self _numberOfEntriesInSection:v7];
        int v9 = v13;
        if (v8 >= 1 && !v13)
        {
          uint64_t v10 = v8;
          ...
          do
          {
            uint64_t v12 = [MEMORY[0x1E4F28D58] indexPathForItem:v11 - 1 inSection:v7];
            v4[2](v4, v12, &v13);
...
- (int64_t)_numberOfEntriesInSection:(int64_t)a3
{
    ...
    || (uint64_t v7 = NSMapGet(sectionIndexToNumberOfEntriesMapTable, (const void *)(a3 + 1))) == 0)
  {
    ...
    {
      uint64_t v10 = (NSMapTable *)objc_msgSend(objc_alloc(MEMORY[0x1E4F28E10]), "initWithKeyOptions:valueOptions:capacity:", 1282, 0, -[SKUIIndexBarControl _numberOfSections](self, "_numberOfSections"));
...
- (id)_combinedEntry
{
  if (!self->_hasValidCombinedEntry)
  {
    ...
    {
      id v3 = +[SKUIIndexBarEntry systemCombinedEntry];
      id WeakRetained = self->_combinedEntry;
      self->_combinedEntrdouble y = v3;
    }

    if (self->_combinedEntry) {
      -[SKUIIndexBarControl _configureNewEntry:](self, "_configureNewEntry:");
    }
...
{
  id v6 = a3;
  uint64_t v4 = [(SKUIIndexBarControl *)self tintColor];
  [v6 setTintColor:v4];

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    uint64_t v5 = [(SKUIIndexBarControl *)self defaultTextAttributes];
...
- (id)_displayEntries
{
  ...
  else
  {
    ...
    if ([v45 count])
    {
      ...
      [(SKUIIndexBarControl *)v50 _sizeForEntries:v45];
      double v23 = v22;
      ...
      else
      {
        ...
        v55[1] = 3221225472;
        v55[2] = __38__SKUIIndexBarControl__displayEntries__block_invoke;
        v55[3] = &unk_1E6427370;
        v57 = &v60;
        v58 = v59;
        id v44 = v24;
        ...
        long long v25 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:0];
        if (v61[3])
        {
          unint64_t v26 = 1;
          uint64_t v46 = 2;
              ...
              do
              {
                ...
                for (uint64_t i = 0; i != v49; ++i)
                {
                  ...
                  else
                  {
                    ...
                    do
                    {
                      uint64_t v34 = [(SKUIIndexBarControl *)v50 _combinedEntry];
                      if (v34) {
                        [v25 addObject:v34];
                      }
                    ...
                    {
LABEL_20:
                      CGRect v36 = [(SKUIIndexBarControl *)v50 _combinedEntry];
                      if (v36) {
                        [v25 addObject:v36];
                      }
                    }
            ...
            [(SKUIIndexBarControl *)v50 _sizeForEntries:v25];
            double v38 = v37;
        ...
        {
          id v40 = [(SKUIIndexBarControl *)v50 _displayEntriesThatFitInViewForGroupedEntries];
        }
        id v41 = *location;
        id *location = v40;
...
- (id)_displayEntriesThatFitInViewForGroupedEntries
{
  id v3 = [(SKUIIndexBarControl *)self _allRequiredEntries];
  ...
  if (v4 >= 2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        double v21 = [(SKUIIndexBarControl *)self _combinedEntry];
        if (v21 && v18 < v19) {
          [v5 addObject:v21];
        }
...
{
  id v4 = a3;
  id v5 = [(NSMapTable *)self->_indexPathToEntryMapTable objectForKey:v4];
  if (!v5)
  {
    id WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource);
    id v5 = [WeakRetained indexBarControl:self entryAtIndexPath:v4];

    [(SKUIIndexBarControl *)self _configureNewEntry:v5];
    indexPathToEntryMapTable = self->_indexPathToEntryMapTable;
    if (!indexPathToEntryMapTable)
    {
      double v8 = (NSMapTable *)[objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:0 capacity:1];
      double v9 = self->_indexPathToEntryMapTable;
...
- (void)_sendSelectionForTouch:(id)a3 withEvent:(id)a4
{
  ...
  CGFloat v15 = v14;
  CGFloat v17 = v16;
  int64_t v18 = [(SKUIIndexBarControl *)self _totalEntryCount];
...
LABEL_11:
  ...
  double v38 = __Block_byref_object_copy__46;
  ...
  if (v28 < v18)
  {
    ...
    v33[1] = 3221225472;
    v33[2] = __56__SKUIIndexBarControl__sendSelectionForTouch_withEvent___block_invoke;
    v33[3] = &unk_1E6427398;
    v33[5] = &v35;
    v33[6] = v28;
    v33[4] = v34;
    [(SKUIIndexBarControl *)self _enumerateEntryIndexPathsUsingBlock:v33];
...
void __56__SKUIIndexBarControl__sendSelectionForTouch_withEvent___block_invoke(void *a1, void *a2, unsigned char *a3)
{
  id v6 = a2;
...
- (CGSize)_sizeForEntryAtIndexPath:(id)a3
{
  id v3 = [(SKUIIndexBarControl *)self _entryAtIndexPath:a3];
  [v3 size];
  double v5 = v4;
  double v7 = v6;
...
uint64_t __39__SKUIIndexBarControl__totalEntryCount__block_invoke(uint64_t result)
{
  return result;
}
...
- (CGRect)_visibleBounds
{
  double v3 = [(SKUIIndexBarControl *)self _displayEntries];
  [(SKUIIndexBarControl *)self bounds];
  CGFloat v5 = v4;
  CGFloat v7 = v6;
  CGFloat v9 = v8;
  ...
  *((CGFloat *)&v34 + 1) = v14;
  ...
  uint64_t v15 = [(SKUIIndexBarControl *)self traitCollection];
  [v15 displayScale];
...
- (SKUIIndexBarControlDataSource)dataSource
{
  ...
  return (SKUIIndexBarControlDataSource *)WeakRetained;
}
...
- (SKUIIndexBarControlDelegate)delegate
{
  ...
  return (SKUIIndexBarControlDelegate *)WeakRetained;
}
