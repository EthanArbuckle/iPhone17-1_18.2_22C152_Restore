...
- (void)validateDonation:(id)a3 withCompletionBlock:(id)a4
{
  ...
  [(SKUIGiftValidator *)self _validateWithBodyDictionary:v7 completionBlock:v6];
}
...
- (void)_finishValidationWithResponse:(id)a3 error:(id)a4 attemptNumber:(int64_t)a5 block:(id)a6
{
  ...
  if (self->_validationCount == a5)
  {
    ...
    if (v11)
    {
      objc_super v13 = [[SKUIGiftValidationResponse alloc] initWithValidationDictionary:v14];
      v11[2](v11, v13, v10);
    }
  }
}
...
- (void)_validateWithBodyDictionary:(id)a3 completionBlock:(id)a4
{
  ...
  id v24 = 0;
  v8 = [MEMORY[0x1E4F28D90] dataWithJSONObject:v6 options:0 error:&v24];
  id v9 = v24;
  if (v8)
  {
    id v10 = (void *)(self->_validationCount + 1);
    self->_validationCount = (int64_t)v10;
    v11 = (void *)[objc_alloc(MEMORY[0x1E4F18D50]) initWithURL:self->_validationURL];
    [v11 setHTTPBody:v8];
    [v11 setHTTPMethod:@"POST"];
    [v11 setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
    v12 = (SSVLoadURLOperation *)[objc_alloc(MEMORY[0x1E4FA8338]) initWithURLRequest:v11];
    validationOperation = self->_validationOperation;
    ...
    v19 = [(SKUIGiftValidator *)self operationQueue];
