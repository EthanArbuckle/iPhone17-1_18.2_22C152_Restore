...
- (SKUIInteractiveSegmentedControl)initWithFrame:(CGRect)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUIInteractiveSegmentedControl;
  result = -[SKUIInteractiveSegmentedControl initWithFrame:](&v9, sel_initWithFrame_, x, y, width, height);
  if (result) {
...
- (void)dealloc
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SKUIInteractiveSegmentedControl *)self _unregisterForObservationOfSegment:*(void *)(*((void *)&v9 + 1) + 8 * v7++)];
      }
      while (v5 != v7);
  ...
  v8.receiver = self;
  v8.super_class = (Class)SKUIInteractiveSegmentedControl;
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  id v7 = a4;
  v29.receiver = self;
  v29.super_class = (Class)SKUIInteractiveSegmentedControl;
  -[SKUIInteractiveSegmentedControl hitTest:withEvent:](&v29, sel_hitTest_withEvent_, v7, x, y);
  objc_super v8 = (SKUIInteractiveSegmentedControl *)objc_claimAutoreleasedReturnValue();
...
- (void)layoutSubviews
{
  ...
  v59.receiver = self;
  v59.super_class = (Class)SKUIInteractiveSegmentedControl;
  [(SKUIInteractiveSegmentedControl *)&v59 layoutSubviews];
  [(SKUIInteractiveSegmentedControl *)self bounds];
  CGFloat v4 = v3;
  CGFloat v6 = v5;
  CGFloat v8 = v7;
  CGFloat v10 = v9;
  long long v11 = [(SKUIInteractiveSegmentedControl *)self traitCollection];
  [v11 displayScale];
  double v13 = v12;
  ...
  v47[1] = 3221225472;
  v47[2] = __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke;
  v47[3] = &unk_1E6426C60;
  *(double *)&v47[7] = v17;
  *(CGFloat *)&v47[8] = v4;
  *(CGFloat *)&v47[9] = v6;
  ...
  *(double *)&v47[12] = v18;
  ...
  v33[1] = 3221225472;
  v33[2] = __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke_2;
  v33[3] = &unk_1E6426C88;
  double v39 = v17;
  CGFloat v40 = v4;
  CGFloat v41 = v6;
...
void __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke(uint64_t a1, void *a2)
{
...
void __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke_2(uint64_t a1, void *a2)
{
  id v29 = a2;
  ...
  SKUIRectByApplyingUserInterfaceLayoutDirectionInRect(v6, 0.0, v8, Height, *(CGFloat *)(a1 + 88), *(CGFloat *)(a1 + 96), *(CGFloat *)(a1 + 104), *(CGFloat *)(a1 + 112));
  ...
  *(CGFloat *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = Width
  ...
  if ((unint64_t)(v3 - 1) <= 1)
  {
    ...
    if (v23)
    {
      ...
      SKUIRectByApplyingUserInterfaceLayoutDirectionInRect(v20, 0.0, v21, v22, *(CGFloat *)(a1 + 88), *(CGFloat *)(a1 + 96), *(CGFloat *)(a1 + 104), *(CGFloat *)(a1 + 112));
    ...
    else
    {
      ...
      if (!v25)
      {
        uint64_t v26 = [objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:1];
...
- (void)setSegments:(id)a3
{
  ...
  {
    int64_t v6 = [(SKUIInteractiveSegmentedControl *)self selectedSegmentIndexForSelectionProgress:self->_selectionProgress];
    ...
    else
    {
      ...
      [(SKUIInteractiveSegmentedControl *)self relativeSelectionProgressForSelectionProgress:v8 segmentIndex:self->_selectionProgress];
      double v7 = v9;
    }
    ...
    if (v15)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v16; ++i)
        {
          ...
          {
            [(SKUIInteractiveSegmentedControl *)self _registerForObservationOfSegment:v19];
            [(SKUIInteractiveSegmentedControl *)self addSubview:v19];
          }
        }
    ...
    if (v21)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v22; ++j)
        {
          ...
          -[SKUIInteractiveSegmentedControl _unregisterForObservationOfSegment:](self, "_unregisterForObservationOfSegment:", v25, v34);
    ...
    v35[1] = 3221225472;
    v35[2] = __47__SKUIInteractiveSegmentedControl_setSegments___block_invoke;
    v35[3] = &__block_descriptor_40_e53_v32__0__UIControl_SKUIInteractiveSegmenting__8Q16_B24l;
    v35[4] = v26;
    ...
    if (v34)
    {
      ...
      if (v29)
      {
        ...
        {
          [(SKUIInteractiveSegmentedControl *)self selectionProgressForRelativeSectionProgress:v31 segmentIndex:v7];
          double v30 = v32;
        }
      }
      BOOL v33 = -[SKUIInteractiveSegmentedControl _setSelectionProgress:](self, "_setSelectionProgress:", v30, v34);
      [(SKUIInteractiveSegmentedControl *)self _applySelectionProgressToSegments];
      if (v33) {
        [(SKUIInteractiveSegmentedControl *)self _notifyClientsOfSelectionProgressChange];
      }
    }
    [(SKUIInteractiveSegmentedControl *)self setNeedsLayout];
  }
...
uint64_t __47__SKUIInteractiveSegmentedControl_setSegments___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
...
- (void)_segmentControlTouchUpInsideAction:(id)a3
{
  ...
  if (segments)
  {
    ...
    if (segments != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      uint64_t segments = -[SKUIInteractiveSegmentedControl _setSelectionProgress:](self, "_setSelectionProgress:");
      id v4 = v6;
      if (segments)
      {
        uint64_t segments = [(SKUIInteractiveSegmentedControl *)self _notifyClientsOfSelectionProgressChange];
        id v4 = v6;
      }
    }
  }

  MEMORY[0x1F41817F8](segments, v4);
}
...
- (void)_applySelectionProgressToSegments
{
  ...
  v3[1] = 3221225472;
  v3[2] = __68__SKUIInteractiveSegmentedControl__applySelectionProgressToSegments__block_invoke;
  v3[3] = &unk_1E6426CD0;
  v3[4] = self;
  [(NSArray *)segments enumerateObjectsUsingBlock:v3];
}

void __68__SKUIInteractiveSegmentedControl__applySelectionProgressToSegments__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  id v4 = *(double **)(a1 + 32);
  double v5 = v4[61];
  id v6 = a2;
...
- (id)_createDividerViewWithFrame:(CGRect)a3
{
  ...
  double y = a3.origin.y;
  double x = a3.origin.x;
  id dividerCreationBlock = (void (**)(id, SKUIInteractiveSegmentedControl *, __n128, __n128, __n128, __n128))self->_dividerCreationBlock;
  ...
  {
    double v9 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", x, y, width, height);
...
- (void)initWithFrame:.cold.1()
{
  ...
  int v0 = 136446210;
  v1 = "-[SKUIInteractiveSegmentedControl initWithFrame:]";
}
