...
- (SKUIScrollingSegmentedController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  if (v8)
  {
    ...
    *(void *)&v8->_scrollingTabAppearanceStatus.isBouncingOffTheEdge = 0;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v9 + 1) + 8 * v7++) removeObserver:self forKeyPath:@"navigationItem.title" context:_SKUIScrollingSegmentTitleValueObservationContext];
      }
      while (v5 != v7);
...
- (void)viewDidLoad
{
  ...
  id v18 = objc_alloc_init(MEMORY[0x1E4FB15C0]);
  ...
  [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:0x1F1C91328];
...
{
  uint64_t v4 = -[SKUIStandardInteractiveDividerView initWithFrame:]([SKUIStandardInteractiveDividerView alloc], "initWithFrame:", a1, a2, a3, a4);
...
- (void)viewDidLayoutSubviews
{
  ...
  else
  {
    ...
    double v21 = [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView collectionViewLayout];
    id v22 = objc_alloc_init((Class)[(id)objc_opt_class() invalidationContextClass]);

    [v22 setInvalidateFlowLayoutDelegateMetrics:1];
    double v23 = [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView collectionViewLayout];
  ...
  if (v18)
  {
    ...
    uint64_t v30 = [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView contentOffset];
...
- (id)contentScrollView
{
  if (!self->_proxyScrollView && [(SKUIScrollingSegmentedController *)self isViewLoaded])
  {
    ...
    double v6 = [(SKUIScrollingSegmentedController *)self view];
...
{
  id v4 = a3;
  double v5 = [v4 decodeObjectForKey:@"_SKUIScrollingSegmentedControllerStateRestorationKeySelectedViewController"];
  if (v5)
  {
    double v6 = [(SKUIScrollingSegmentedController *)self viewControllers];
    if ([v6 count])
    {
...
{
  id v4 = a3;
  unint64_t v5 = [(SKUIScrollingSegmentedController *)self focusedViewControllerIndex];
  double v6 = [(SKUIScrollingSegmentedController *)self viewControllers];
  uint64_t v7 = v6;
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if ((void *)_SKUIScrollingSegmentTitleValueObservationContext == a6)
  {
    ...
    if (viewControllers)
    {
      ...
      {
        uint64_t v16 = v15;
        uint64_t v17 = [(SKUIInteractiveSegmentedControl *)self->_titlesSegmentedControl segments];
        ...
        {
          double v19 = [(SKUIScrollingSegmentedController *)self view];
          [v19 setNeedsLayout];
        }
      }
    }
...
- (void)scrollViewDidChangeContentInset:(id)a3
{
  ...
  id v4 = (SKUIProxyScrollView *)a3;
  unint64_t v5 = v4;
  if (self->_proxyScrollView == v4)
  {
    uint64_t v6 = [(SKUIProxyScrollView *)v4 window];
    ...
    if (v6)
    {
      ...
      if (!v12 || self->_proxyScrollViewContentInsetAdjustment.bottom != v9)
      {
        ...
        double v19 = v18;
        double v21 = v20;
        id v22 = [(SKUIScrollingSegmentedController *)self viewControllers];
        long long v28 = 0u;
        long long v29 = 0u;
        long long v30 = 0u;
        long long v31 = 0u;
...
- (void)scrollingSegmentedControllerCollectionViewDidLayoutSubviews:(id)a3
{
  ...
  {
    [(SKUIScrollingSegmentedController *)self _updateTitlesSelectionProgress];
    id v4 = [(SKUIScrollingSegmentedController *)self _indexPathOfFocusedItemAllowingLayoutIfNeeded:0];
    unint64_t v5 = v4;
    if (v4)
    {
      double v7 = v4;
...
- (UIScrollView)scrollingTabNestedPagingScrollView
{
  id v3 = (id)[(SKUIScrollingSegmentedController *)self view];
  contentCollectionView = self->_contentCollectionView;
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  {
    id v7 = a4;
    id v4 = [a3 dequeueReusableCellWithReuseIdentifier:0x1F1C91328 forIndexPath:v7];
    viewControllers = self->_viewControllers;
    uint64_t v9 = [v7 item];
...
- (void)collectionView:(id)a3 didEndDisplayingCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  {
    id v9 = v7;
    id v8 = [(SKUIScrollingSegmentedController *)self delegate];
    if (objc_opt_respondsToSelector()) {
...
- (void)setMaximumContentWidth:(double)a3
{
  ...
  if (vabdd_f64(self->_maximumContentWidth, a3) > 0.00000011920929)
  {
    ...
    long long v12 = 0u;
    long long v13 = 0u;
    BOOL v4 = [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView visibleCells];
...
- (void)setSegmentedControlContentEdgeInsets:(UIEdgeInsets)a3
{
  ...
  double left = a3.left;
  double top = a3.top;
  id v7 = [(SKUIScrollingSegmentedController *)self navigationBarTitleView];
...
- (void)setSegmentedControlHeight:(double)a3
{
  id v4 = [(SKUIScrollingSegmentedController *)self navigationBarTitleView];
...
- (void)selectViewControllerAtIndex:(unint64_t)a3 animated:(BOOL)a4
{
  if (a3 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if ([(NSArray *)self->_viewControllers count] > a3)
    {
      ...
      {
        id v7 = [(SKUIScrollingSegmentedController *)self view];
        [v7 layoutIfNeeded];
      }
      ...
      id v25 = [(SKUIScrollingSegmentedControllerCollectionView *)contentCollectionView layoutAttributesForItemAtIndexPath:v9];
      ...
      -[SKUIScrollingSegmentedControllerCollectionView setContentOffset:animated:](self->_contentCollectionView, "setContentOffset:animated:", v4, CGRectGetMinX(v27) - v23, v24 - v21);
    }
  }
}
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        double v20 = [(SKUIScrollingSegmentedControllerCollectionView *)v9 indexPathForCell:*(void *)(*((void *)&v27 + 1) + 8 * i)];
        if (v20)
        {
          double v21 = [(SKUIScrollingSegmentedControllerCollectionView *)v9 layoutAttributesForItemAtIndexPath:v20];
          [v21 frame];
...
- (void)_reloadTitleSegments
{
  ...
  BOOL v3 = [(SKUIInteractiveSegmentedControl *)self->_titlesSegmentedControl segments];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (v12)
        {
          uint64_t v13 = (SKUIStandardInteractiveSegment *)v12;
          [v4 removeObjectAtIndex:0];
        }
        else
        {
          uint64_t v13 = objc_alloc_init(SKUIStandardInteractiveSegment);
        }
        [(SKUIScrollingSegmentedController *)self _configureSegment:v13 forViewController:v11];
        if (!v8) {
          double v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSArray count](self->_viewControllers, "count"));
        }
        [v8 addObject:v13];
      }
  ...
  [(SKUIScrollingSegmentedController *)self _updateTitlesSelectionProgress];
  double v14 = [(SKUIScrollingSegmentedController *)self navigationBarTitleView];
  [v14 sizeToFit];
}
...
- (void)_scrollToTitlesSelectionProgress:(double)a3 animated:(BOOL)a4
{
  ...
  [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView contentOffset];
  double rect_16 = v16;
  long long v17 = [(SKUIInteractiveSegmentedControl *)self->_titlesSegmentedControl segments];
  ...
  double v21 = [MEMORY[0x1E4FB1438] sharedApplication];
  ...
  -[SKUIScrollingSegmentedControllerCollectionView setContentOffset:animated:](contentCollectionView, "setContentOffset:animated:", v4, v20, v13 + rect_16 - v13);
}
...
- (void)_setViewControllers:(id)a3 viewUpdatesHandler:(id)a4
{
  ...
  if (viewControllers != v6 && ![(NSArray *)viewControllers isEqualToArray:v6])
  {
    ...
    v58 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(v9, "count"));
    long long v72 = 0u;
    long long v73 = 0u;
    long long v74 = 0u;
    long long v75 = 0u;
    ...
    id v25 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSArray count](self->_viewControllers, "count"));
    long long v68 = 0u;
    long long v69 = 0u;
    long long v70 = 0u;
    long long v71 = 0u;
    ...
    if (v27)
    {
      ...
      p_info = SKUIMenuViewElement.info;
      id v59 = v12;
      do
      {
        for (uint64_t j = 0; j != v28; ++j)
        {
          ...
          {
            [v25 addObject:v32];
            if ([v32 conformsToProtocol:&unk_1F1D796F8])
            {
              uint64_t v33 = [(SKUIViewController *)self clientContext];
              [v32 setClientContext:v33];
            }
            [(SKUIScrollingSegmentedController *)self addChildViewController:v32];
            CGRect v34 = (void *)[objc_alloc((Class)(p_info + 466)) initWithViewController:v32];
            ...
            if (!viewControllerToItemContext)
            {
              ...
              CGRect v38 = v26;
              CGRect v39 = v25;
              id v40 = objc_alloc(MEMORY[0x1E4F28E10]);
              ...
              uint64_t v29 = v37;
              uint64_t v28 = v36;
              p_info = (__objc2_class_ro **)(SKUIMenuViewElement + 32);
    ...
    if (v51)
    {
      ...
      do
      {
        for (uint64_t m = 0; m != v52; ++m)
        {
          ...
          if ([v55 conformsToProtocol:&unk_1F1D796F8]) {
...
- (void)_updateScrollViewContentOffsetsToTargetContentOffsets
{
  if ([(SKUIScrollingSegmentedController *)self isViewLoaded])
  {
    BOOL v3 = [(SKUIScrollingSegmentedController *)self view];
    [v3 bounds];
    ...
    {
      contentCollectionView = self->_contentCollectionView;
      -[SKUIScrollingSegmentedControllerCollectionView setContentOffset:](contentCollectionView, "setContentOffset:");
    }
  }
}
...
- (void)_updateTitlesSelectionProgress
{
  ...
  [(SKUIScrollingSegmentedControllerCollectionView *)self->_contentCollectionView contentOffset];
  double v9 = (v7 + v8) / v5;
  double v10 = [(SKUIInteractiveSegmentedControl *)self->_titlesSegmentedControl segments];
...
- (void)_updateTitleValueObservation
{
  ...
  double v3 = [(SKUIScrollingSegmentedController *)self viewControllers];
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        if (([(NSMutableArray *)self->_titleObservingViewControllers containsObject:v9] & 1) == 0)
        {
          ...
          {
            double v11 = (NSMutableArray *)objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(obj, "count"));
  ...
  if (v14)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v15; ++j)
      {
        ...
        [*(id *)(*((void *)&v20 + 1) + 8 * j) removeObserver:self forKeyPath:@"navigationItem.title" context:_SKUIScrollingSegmentTitleValueObservationContext];
      }
...
LABEL_9:
  if (self->_viewBackgroundIsWhite != wantsWhiteBackgroundBeyondRightEdgeWhenBouncing)
  {
    ...
    double v9 = [(SKUIScrollingSegmentedController *)self view];
...
- (SKUIScrollingSegmentedControllerDelegate)delegate
{
  ...
  return (SKUIScrollingSegmentedControllerDelegate *)WeakRetained;
}
