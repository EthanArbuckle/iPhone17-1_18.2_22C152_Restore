...
LABEL_43:
              if (v16)
              {
                ...
                if (v23)
                {
                  ...
                  if (!v24)
                  {
                    uint64_t v25 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:517 valueOptions:0 capacity:1];
...
LABEL_17:
              ...
              break;
            case 62:
              uint64_t v20 = SKUIHorizontalListView;
LABEL_19:
        ...
        else
        {
          ...
          {
            case 135:
              uint64_t v20 = SKUIStarRatingViewElementView;
              goto LABEL_19;
            case 138:
            ...
            case 141:
              goto LABEL_15;
            case 144:
              uint64_t v20 = SKUITomatoRatingView;
              goto LABEL_19;
            default:
              continue;
          }
...
{
  v22.receiver = self;
  v22.super_class = (Class)SKUIVerticalInfoListCollectionViewCell;
  [(SKUICollectionViewCell *)&v22 layoutSubviews];
  id v3 = [(SKUIVerticalInfoListCollectionViewCell *)self contentView];
  [v3 bounds];
  CGFloat v5 = v4;
  CGFloat v7 = v6;
  CGFloat v9 = v8;
  ...
  *(double *)&v21[4] = v15;
  v21[5] = v13;
  BOOL v19 = [(SKUIViewReuseCollectionViewCell *)self allExistingViews];
...
- (void)_buttonAction:(id)a3
{
  ...
  {
    id v8 = v4;
    id v5 = SKUICollectionViewForView(self);
...
+ (id)_attributedStringForButton:(id)a3 context:(id)a4
{
  ...
  if (!v11)
  {
    double v11 = SKUIFontPreferredFontForTextStyle(5);
  }
  CGFloat v12 = [v6 tintColor];
  double v13 = SKUIViewElementPlainColorWithStyle(v10, v12);

  if (!v13)
  {
    double v13 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.8];
  }
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  if (!v8)
  {
    id v8 = SKUIFontPreferredFontForTextStyle(5);
  }
  id v9 = [v6 tintColor];
  ...
  if (!v10)
  {
    ...
    double v10 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:dbl_1C1CCC050[v11]];
  }
  CGFloat v12 = [v5 text];
