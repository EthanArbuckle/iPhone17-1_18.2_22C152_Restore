...
- (void)recycleReusableViews:(id)a3
{
  ...
  if (v5)
  {
    ...
    long long v8 = (_OWORD *)MEMORY[0x1E4F1DAB8];
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        if ([v10 conformsToProtocol:&unk_1F1E1CF38]) {
          [v10 viewWasRecycled];
        }
      }
...
- (void)registerClass:(Class)a3 forViewWithReuseIdentifier:(id)a4
{
  ...
  if (!reuseClasses)
  {
    long long v8 = (NSMutableDictionary *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:1];
...
- (Class)viewClassWithReuseIdentifier:(id)a3
{
  ...
  uint64_t v5 = (void *)[(id)_SKUIViewReusePoolGetCommonReuseClasses_commonReuseClasses objectForKeyedSubscript:v4];
  if (!v5) {
