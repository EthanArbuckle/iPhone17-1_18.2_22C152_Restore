...
- (SKUICategory)initWithCategoryDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v16 = +[SKUIArtworkProvidingFactory artworkProviderForStoreResponse:v15];
