...
- (SKUIGallerySwooshPageSection)initWithPageComponent:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUIGallerySwooshPageSection;
  ...
  if (v5)
  {
    ...
    v5->_componentArtworkRequests = (NSMapTable *)v6;
  }
  return v5;
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUIGallerySwooshPageSection;
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SKUIGallerySwooshPageSection _addImpressionForIndex:toSession:](self, "_addImpressionForIndex:toSession:", [*(id *)(*((void *)&v13 + 1) + 8 * v12++) item], v5);
      }
      while (v10 != v12);
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  uint64_t v6 = [(SKUIGallerySwooshPageSection *)self _swooshViewController];
  v7 = [v6 view];
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  v19 = [(SKUIGallerySwooshPageSection *)self _swooshViewController];
  ...
  if (v6 >= 1)
  {
    ...
    do
    {
      ...
      if (!v11)
      {
        ...
        id v13 = [(SKUIGallerySwooshPageSection *)self _newArtworkRequestWithArtwork:v12];
        long long v14 = v13;
        if (v13)
        {
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  double v11 = [(SKUIGallerySwooshPageSection *)self _swooshViewController];
  ...
  if (v13)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v14; ++i)
      {
        ...
        {
          id v20 = [(SKUIGallerySwooshPageSection *)self _swooshViewController];
...
- (void)swoosh:(id)a3 didChangePlaybackState:(int64_t)a4 forItemAtIndex:(int64_t)a5
{
  ...
  if ([v9 canRecordEventWithType:*MEMORY[0x1E4FA8888]])
  {
    id v10 = objc_alloc_init(MEMORY[0x1E4FA8240]);
    double v11 = SKUIMetricsMediaEventTypeForPlaybackState(a4);
    ...
    uint64_t v18 = [(SKUIStorePageSection *)self pageComponent];
    ...
    if (v19 && v20)
    {
      v23[0] = v20;
      v23[1] = v19;
      id v22 = [MEMORY[0x1E4F1C978] arrayWithObjects:v23 count:2];
...
- (void)swoosh:(id)a3 didSelectCellAtIndex:(int64_t)a4
{
  ...
  uint64_t v9 = [(SKUIStorePageSection *)self clickEventWithMedia:v8 elementName:*MEMORY[0x1E4FA88E0] index:a4];
  if (v9)
  {
...
LABEL_4:
    ...
    id v16 = [(SKUIGallerySwooshPageSection *)self _newArtworkRequestWithArtwork:v15];
    v17 = v16;
    if (v16)
    {
      componentArtworkRequests = self->_componentArtworkRequests;
...
- (id)_newArtworkRequestWithArtwork:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v7 = +[SKUISizeToFitImageDataConsumer consumerWithConstraintSize:](SKUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", (double)[v4 width], (double)objc_msgSend(v4, "height"));
...
- (id)_swooshViewController
{
  ...
  if (!swooshViewController)
  {
    ...
    id v6 = [SKUIGallerySwooshViewController alloc];
    id v7 = [(SKUIStorePageSection *)self pageComponent];
    uint64_t v8 = [(SKUIGallerySwooshViewController *)v6 initWithGallerySwoosh:v7];
