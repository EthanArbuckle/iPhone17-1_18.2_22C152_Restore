...
- (SKUIEditorialLinkLayout)initWithLayoutRequest:(id)a3
{
  ...
  v43.receiver = self;
  v43.super_class = (Class)SKUIEditorialLinkLayout;
...
uint64_t __49__SKUIEditorialLinkLayout_initWithLayoutRequest___block_invoke(uint64_t result)
{
  return result;
}
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SKUIEditorialLinkLayout;
...
- (CGSize)sizeForLinkAtIndex:(int64_t)a3
{
  if (!self->_sizes || [(NSArray *)self->_links count] <= a3) {
    objc_msgSend(MEMORY[0x1E4F1CA00], "raise:format:", *MEMORY[0x1E4F1C3C8], @"Invalid index: %ld", a3);
  }
