...
- (SKUIProductPageDetailsViewController)initWithProductPage:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SKUIProductPageDetailsViewController;
...
- (void)dealloc
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUIProductPageDetailsViewController;
...
{
  v4.receiver = self;
  v4.super_class = (Class)SKUIProductPageDetailsViewController;
...
- (void)setClientContext:(id)a3
{
  double v5 = (SKUIClientContext *)a3;
  ...
  if (self->_clientContext != v5)
  {
    ...
    if (*p_clientContext) {
      [(SKUIClientContext *)*p_clientContext localizedStringForKey:@"PRODUCT_PAGE_DETAILS_TAB" inTable:@"ProductPage"];
    }
    else {
    double v7 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_DETAILS_TAB" inBundles:0 inTable:@"ProductPage"];
    }
    ...
    if ([(NSMutableArray *)self->_sections count])
    {
      if ([(NSMutableArray *)self->_sections count])
      {
        ...
        do
        {
          ...
          if (isKindOfClass)
          {
            double v7 = [SKUIProductPageTableLinksSection alloc];
            uint64_t v8 = [(SKUIProductPage *)self->_productPage item];
            objc_super v9 = [(SKUIProductPageTableLinksSection *)v7 initWithItem:v8 clientContext:self->_clientContext askPermission:self->_askPermission];

            long long v10 = [(SKUIProductPage *)self->_productPage uber];
      ...
      long long v12 = [MEMORY[0x1E4F1CA48] arrayWithArray:self->_sections];
      sections = self->_sections;
      self->_sections = v12;

      id v14 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
...
- (void)loadView
{
  ...
  if (![(NSMutableArray *)self->_sections count])
  {
    ...
    long long v11 = [(SKUIProductPage *)self->_productPage item];
    long long v12 = [(SKUIProductPageDetailsViewController *)self _storeNotesSection];
    v67 = v11;
    if (v12)
    {
      ...
      uint64_t v15 = [(SKUIProductPageDetailsViewController *)self _textLayoutRequestWithText:v14 widthOffset:0.0];
      [v5 addObject:v15];
  ...
  v53 = [v3 view];
  id v54 = objc_alloc(MEMORY[0x1E4FB1EB0]);
  [v53 frame];
...
- (SKUIProductPageHeaderViewController)headerViewController
{
  return [(SKUIProductPageTableViewController *)self->_tableViewController headerViewController];
}

- (void)setHeaderViewController:(id)a3
{
  id v4 = a3;
  id v5 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
...
- (void)setDelegate:(id)a3
{
  ...
  id v6 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
...
- (void)screenshotsWillBeginDragging:(id)a3
{
  ...
  {
    id v6 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
    id v4 = [(SKUIProductPageDetailsViewController *)self _screenshotsSection];
    id v5 = [v4 headerView];
...
- (id)tableViewForTableViewSection:(id)a3
{
  return [(SKUIProductPageTableViewController *)self->_tableViewController tableView];
}

- (void)_expandSection:(id)a3
{
  id v4 = a3;
  uint64_t v5 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
  id v6 = [v5 tableView];
...
uint64_t __55__SKUIProductPageDetailsViewController__expandSection___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v13 = a2;
  ...
  if (v7)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if ([v13 numberOfRowsInSection] >= 1)
      {
        ...
        do
        {
          long long v11 = [MEMORY[0x1E4F28D58] indexPathForRow:v10 inSection:a3];
          [v9 addObject:v11];
...
- (void)_addTapRecognizerForView:(id)a3 action:(SEL)a4
{
  ...
  id v8 = [(SKUIProductPageTableViewController *)self->_tableViewController tableView];
...
- (id)_bundledAppsSection
{
  ...
  if ([v3 itemKind] == 17)
  {
    ...
    if (v7)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v8; ++i)
        {
          ...
          id v13 = [SKUILockupComponent alloc];
          id v14 = v13;
          if (v12)
          {
            long long v30 = v36;
            uint64_t v31 = v37;
            uint64_t v15 = [(SKUILockupComponent *)v13 initWithItem:v12 style:&v30];
          }
          else
          {
            ...
            long long v30 = v36;
            uint64_t v31 = v37;
            uint64_t v15 = [(SKUILockupComponent *)v14 initWithItemIdentifier:v16 style:&v30];
          }
          v17 = (void *)v15;
          if (v15) {
            [v5 addObject:v15];
    ...
    else
    {
      ...
      v23 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_BUNDLED_APPS_%@" inBundles:0 inTable:@"ProductPage"];
      }
      v24 = NSString;
      ...
      BOOL v22 = [[SKUIProductPageTableSwooshSection alloc] initWithLockups:v5 title:v27];
...
- (void)_configureSwooshSection:(id)a3
{
  id v4 = a3;
  id v5 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
  id v6 = [(SKUIProductPageDetailsViewController *)self clientContext];
  [v4 setClientContext:v6];

  uint64_t v7 = [(SKUIProductPageDetailsViewController *)self _resourceLoader];
  ...
  if (!v9)
  {
    uint64_t v9 = objc_alloc_init(SKUIColorScheme);
    id v10 = [v5 tableView];
  ...
  uint64_t v15 = __64__SKUIProductPageDetailsViewController__configureSwooshSection___block_invoke;
  uint64_t v16 = &unk_1E6427320;
...
- (id)_copyrightSection
{
  ...
  if (!copyrightSection)
  {
    ...
    if ([v5 length])
    {
      char v6 = objc_alloc_init(SKUIProductPageCopyrightView);
      ...
      -[SKUIProductPageCopyrightView sizeThatFits:](v6, "sizeThatFits:");
      -[SKUIProductPageCopyrightView setFrame:](v6, "setFrame:", v10, v12, v14, v15);
      uint64_t v16 = objc_alloc_init(SKUIProductPageTableHeaderOnlySection);
...
- (id)_descriptionSection
{
  ...
  if (!descriptionSection)
  {
    ...
    if (v5)
    {
      char v6 = [[SKUIProductPageTableTextBoxSection alloc] initWithClientContext:self->_clientContext];
      ...
      double v10 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_DESCRIPTION_TITLE" inBundles:0 inTable:@"ProductPage"];
      }
      [(SKUIProductPageTableTextBoxSection *)v8 setTitle:v10];

      double v11 = self->_descriptionSection;
      double v12 = [(SKUIProductPage *)self->_productPage uber];
...
- (id)_featuresSection
{
  ...
  if (v4)
  {
    id v7 = objc_alloc_init(SKUIProductPageFeaturesView);
    ...
    double v12 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_SUPPORTS_TITLE" inBundles:0 inTable:@"ProductPage"];
    }
    ...
    -[SKUIProductPageFeaturesView sizeThatFits:](v7, "sizeThatFits:");
    -[SKUIProductPageFeaturesView setFrame:](v7, "setFrame:", v14, v16, v18, v19);
    double v11 = objc_alloc_init(SKUIProductPageTableHeaderOnlySection);
...
{
  BOOL v3 = [(SKUIProductPage *)self->_productPage item];
  uint64_t v4 = [(SKUIProductPage *)self->_productPage productInformation];
  if (!v4)
  {
    if (v3)
    {
      id v5 = [[SKUIProductPageInformationViewController alloc] initWithItem:v3 clientContext:self->_clientContext];
      if (v5) {
        goto LABEL_6;
      }
    }
...
LABEL_8:
  ...
  id v5 = [[SKUIProductPageInformationViewController alloc] initWithProductInformation:v4 clientContext:self->_clientContext];
  if (!v5) {
    goto LABEL_8;
  }
LABEL_6:
  uint64_t v6 = [(SKUIProductPageDetailsViewController *)self operationQueue];
  [(SKUIProductPageInformationViewController *)v5 setOperationQueue:v6];

  id v7 = [(SKUIProductPageInformationViewController *)v5 view];
  id v8 = [(SKUIProductPage *)self->_productPage uber];
  double v9 = [v8 colorScheme];
  [v7 setColorScheme:v9];

  double v10 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
  [v10 addChildViewController:v5];

  double v11 = [(SKUIProductPageInformationViewController *)v5 view];
  [v11 frame];
  double v13 = v12;
  double v15 = v14;
  ...
  id v20 = objc_alloc_init(SKUIProductPageTableHeaderOnlySection);
...
- (id)_parentBundlesSection
{
  ...
  long long v26 = 0uLL;
  uint64_t v27 = 0;
  if (objc_msgSend(v4, "count", SKUILockupStyleDefault((uint64_t)&v26)) == 1
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        double v12 = [SKUILockupComponent alloc];
        uint64_t v13 = [v11 longLongValue];
        long long v20 = v26;
        uint64_t v21 = v27;
        double v14 = [(SKUILockupComponent *)v12 initWithItemIdentifier:v13 style:&v20];
        [v5 addObject:v14];
      }
  ...
  double v16 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_PARENT_BUNDLE_TITLE" inBundles:0 inTable:@"ProductPage"];
  }
  if ([v5 count] == 1)
  {
    double v17 = [[SKUIProductPageTableLockupsSection alloc] initWithLockups:v5 title:v16];
    [(SKUITableViewSection *)v17 setDelegate:self];
    double v18 = [(SKUIProductPageDetailsViewController *)self _resourceLoader];
  ...
  {
    double v17 = [[SKUIProductPageTableSwooshSection alloc] initWithLockups:v5 title:v16];
...
- (id)_resourceLoader
{
  ...
  if (!resourceLoader)
  {
    uint64_t v4 = [SKUIResourceLoader alloc];
    id v5 = [(SKUIProductPageDetailsViewController *)self clientContext];
...
- (id)_screenshotsSection
{
  ...
  {
    uint64_t v4 = [(SKUIProductPage *)self->_productPage item];
    id v5 = [v4 screenshots];
    id v6 = [v4 videos];
    if ([v5 count] || objc_msgSend(v6, "count"))
    {
      uint64_t v7 = [SKUIScreenshotsViewController alloc];
      uint64_t v8 = [(SKUIProductPageDetailsViewController *)self clientContext];
      uint64_t v9 = [(SKUIScreenshotsViewController *)v7 initWithTrailers:v6 screenshots:v5 clientContext:v8];

      [(SKUIScreenshotsViewController *)v9 setDelegate:self];
      double v10 = [(SKUIProductPageDetailsViewController *)self operationQueue];
      [(SKUIScreenshotsViewController *)v9 setOperationQueue:v10];

      double v11 = [(SKUIProductPageDetailsViewController *)self _tableViewController];
      [v11 addChildViewController:v9];

      double v12 = [(SKUIScreenshotsViewController *)v9 view];
      [v12 setAutoresizingMask:2];
      uint64_t v13 = objc_alloc_init(SKUIProductPageTableHeaderOnlySection);
...
- (id)_storeNotesSection
{
  ...
  if (!storeNotesSection)
  {
    ...
    if (v6)
    {
      uint64_t v7 = [[SKUIProductPageTableTextBoxSection alloc] initWithClientContext:self->_clientContext];
      ...
      double v11 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_STORE_NOTES_TITLE" inBundles:0 inTable:@"ProductPage"];
      }
      [(SKUIProductPageTableTextBoxSection *)v9 setTitle:v11];

      double v12 = self->_storeNotesSection;
      uint64_t v13 = [(SKUIProductPage *)self->_productPage uber];
...
- (id)_tableViewController
{
  ...
  {
    uint64_t v4 = objc_alloc_init(SKUIProductPageTableViewController);
    ...
    uint64_t v9 = [(SKUIProductPage *)self->_productPage uber];
...
{
  id v6 = a3;
  uint64_t v7 = objc_alloc_init(SKUITextLayoutRequest);
...
- (id)_whatsNewSection
{
  ...
  if (!whatsNewSection)
  {
    ...
    if (v5)
    {
      id v6 = [[SKUIProductPageTableTextBoxSection alloc] initWithClientContext:self->_clientContext];
      ...
      double v10 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_WHATS_NEW_TITLE" inBundles:0 inTable:@"ProductPage"];
      }
      [(SKUIProductPageTableTextBoxSection *)v8 setTitle:v10];
