...
- (void)setButtonText:(id)a3
{
  if (self->_buttonText != a3)
  {
    ...
    self->_buttonText = v4;
    MEMORY[0x1F41817F8](v4, buttonText);
  }
}
...
- (void)setConfirmationText:(id)a3
{
  if (self->_confirmationText != a3)
  {
    ...
    MEMORY[0x1F41817F8](v4, confirmationText);
  }
}
...
- (void)setStoreIdentifier:(id)a3
{
  ...
  {
    v4 = (SKUIStoreIdentifier *)[a3 copy];
    storeIdentifier = self->_storeIdentifier;
    self->_storeIdentifier = v4;
    MEMORY[0x1F41817F8](v4, storeIdentifier);
  }
}
...
- (void)setVariantIdentifier:(id)a3
{
  if (self->_variantIdentifier != a3)
  {
    ...
    MEMORY[0x1F41817F8](v4, variantIdentifier);
  }
}
...
- (BOOL)canPersonalizeUsingItemState:(id)a3
{
  ...
  if (!storeIdentifier
    || ([v5 storeIdentifier],
        ...
        BOOL v11 = [(SKUIStoreIdentifier *)storeIdentifier isEqual:v10],
        v10,
        v11))
  {
    v12 = [v5 variantIdentifier];
    uint64_t v13 = [(SKUIBuyButtonDescriptor *)self variantIdentifier];
    v14 = (void *)v13;
    char v15 = 1;
    if (v12 && v13) {
