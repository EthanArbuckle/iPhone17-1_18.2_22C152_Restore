...
- (SKUIReportAConcernDetailsDataSource)initWithTableView:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SKUIReportAConcernDetailsDataSource;
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  id v5 = objc_msgSend(a3, "dequeueReusableCellWithIdentifier:", @"SKUIConcernDetailsCell", a4);
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  v4 = [(SKUIReportAConcernDetailsDataSource *)self selectedReason];
