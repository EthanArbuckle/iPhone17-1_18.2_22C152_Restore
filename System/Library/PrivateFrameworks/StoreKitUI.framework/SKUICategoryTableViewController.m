...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUICategoryTableViewController;
  [(SKUICategoryTableViewController *)&v3 dealloc];
}

- (void)setArtworkLoader:(id)a3
{
  v5 = (SKUICategoryArtworkLoader *)a3;
  ...
  if (artworkLoader != v5)
  {
    ...
    artworkLoader = (SKUICategoryArtworkLoader *)[(SKUICategoryArtworkLoader *)self->_artworkLoader addObserver:self];
    v5 = v7;
  }

  MEMORY[0x1F41817F8](artworkLoader, v5);
}
...
- (void)setCategory:(id)a3
{
  ...
  if (self->_category != v5)
  {
    ...
    long long v17 = 0u;
    long long v18 = 0u;
    v7 = [(SKUICategory *)*p_category children];
...
LABEL_12:
    ...
    {
      v13 = [(SKUICategoryTableViewController *)self tableView];
      [v13 reloadData];
    }
    v14 = [(SKUICategory *)*p_category name];
    [(SKUICategoryTableViewController *)self setTitle:v14];
  }
}
...
- (void)setNumberOfHiddenRows:(int64_t)a3
{
  if (self->_numberOfHiddenRows != a3)
  {
    ...
    id v3 = [(SKUICategoryTableViewController *)self tableView];
    [v3 reloadData];
  }
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  if (v5)
  {
    ...
    v7 = +[SKUIClientContext localizedStringForKey:@"CATEGORY_SHEET_CANCEL_BUTTON" inBundles:0];
    }
    uint64_t v8 = (void *)[objc_alloc(MEMORY[0x1E4FB14A8]) initWithTitle:v7 style:2 target:self action:sel__doneButtonAction_];
    uint64_t v9 = [(SKUICategoryTableViewController *)self navigationItem];
    [v9 setRightBarButtonItem:v8];
  }
  uint64_t v10 = [(SKUICategoryTableViewController *)self tableView];
  ...
  v13.receiver = self;
  v13.super_class = (Class)SKUICategoryTableViewController;
...
- (void)categoryArtworkLoader:(id)a3 didLoadImage:(id)a4 forCategory:(id)a5
{
  ...
  id v7 = a4;
  id v8 = a5;
  uint64_t v9 = [(SKUICategoryTableViewController *)self tableView];
  ...
  if (v12)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        -[SKUICategoryTableViewController _categoryAtIndexPath:](self, "_categoryAtIndexPath:", v16, (void)v21);
        id v17 = (id)objc_claimAutoreleasedReturnValue();
        if (v17 == v8)
        {
          long long v18 = [(SKUICategoryTableViewController *)self tableView];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  id v8 = [(SKUICategoryTableViewController *)self _categoryAtIndexPath:v6];
  uint64_t v9 = [v7 textLabel];
  if ([v6 section]) {
    [(SKUICategory *)v8 name];
  }
  else {
  uint64_t v10 = [(SKUICategory *)v8 parentLabel];
  }
  [v9 setText:v10];

  if ([v6 section] == 1)
  {
    id v11 = [(SKUICategory *)v8 children];
  ...
  uint64_t v14 = [(SKUICategory *)v8 URL];
...
LABEL_14:
  ...
  long long v15 = [MEMORY[0x1E4FB16C8] currentDevice];
...
LABEL_17:
  ...
  uint64_t v20 = [(SKUICategory *)v8 artworkProvider];
  ...
  long long v22 = [(SKUICategoryArtworkLoader *)artworkLoader cachedImageForCategory:v8];
  if (!v22)
  {
    [(SKUICategoryArtworkLoader *)self->_artworkLoader loadImageForCategory:v8 reason:1];
    long long v22 = [(SKUICategoryArtworkLoader *)self->_artworkLoader placeholderImage];
  }
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if ([v13 section] == 1
    && ([v5 children],
        ...
        v7))
  {
    [(SKUICategoryTableViewController *)self _recordClickEventForIndexPath:v13 category:v5 actionType:*MEMORY[0x1E4FA8870]];
    int64_t v8 = objc_alloc_init(SKUICategoryTableViewController);
    ...
    -[SKUICategoryTableViewController setPreferredContentSize:](v8, "setPreferredContentSize:");
    int64_t v9 = [(SKUICategoryTableViewController *)self _metricsLocationsToPushIndexPath:v13];
    ...
    uint64_t v10 = [(SKUICategoryTableViewController *)self navigationController];
    [v10 pushViewController:v8 animated:1];
  }
  else
  {
    [(SKUICategoryTableViewController *)self _recordClickEventForIndexPath:v13 category:v5 actionType:*MEMORY[0x1E4FA8868]];
    id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
    ...
    int64_t v8 = (SKUICategoryTableViewController *)objc_loadWeakRetained((id *)&self->_delegate);
...
- (void)tableView:(id)a3 willDisplayCell:(id)a4 forRowAtIndexPath:(id)a5
{
  ...
  id v8 = [MEMORY[0x1E4FB1618] colorWithWhite:0.756 alpha:1.0];
...
- (id)_categoryAtIndexPath:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v7 = [(SKUICategory *)category children];
    uint64_t v8 = [v4 row];
    int64_t numberOfHiddenRows = self->_numberOfHiddenRows;
...
- (id)_metricsLocationsToPushIndexPath:(id)a3
{
  id v4 = (objc_class *)MEMORY[0x1E4FA8228];
  id v5 = a3;
  id v6 = objc_alloc_init(v4);
  int64_t v7 = [(SKUICategoryTableViewController *)self _metricsLocationPostionForIndexPath:v5];

  [v6 setLocationPosition:v7];
  [v6 setLocationType:*MEMORY[0x1E4FA88E8]];
  ...
  {
    int64_t v9 = [MEMORY[0x1E4F1CA48] arrayWithObject:v6];
  }
...
- (void)_recordClickEventForIndexPath:(id)a3 category:(id)a4 actionType:(id)a5
{
  ...
  double v17 = [(SKUICategoryTableViewController *)self clientContext];
...
void __85__SKUICategoryTableViewController__recordClickEventForIndexPath_category_actionType___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ([v3 canRecordEventWithType:*MEMORY[0x1E4FA8878]])
  {
    ...
    uint64_t v6 = *MEMORY[0x1E4FA88F0];
    [v4 setTargetType:*MEMORY[0x1E4FA88F0]];
...
- (SKUICategoryTableViewControllerDelegate)delegate
{
  ...
  return (SKUICategoryTableViewControllerDelegate *)WeakRetained;
}
