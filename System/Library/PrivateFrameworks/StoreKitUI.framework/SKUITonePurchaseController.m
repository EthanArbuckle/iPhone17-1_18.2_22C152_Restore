...
- (SKUITonePurchaseController)initWithItem:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUITonePurchaseController;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUITonePurchaseController;
...
- (void)showPurchaseFlowWithCompletionBlock:(id)a3
{
  ...
  v10 = [MEMORY[0x1E4FB1418] alertControllerWithTitle:0 message:0 preferredStyle:1];
  clientContext = self->_clientContext;
  if (clientContext) {
    [(SKUIClientContext *)clientContext localizedStringForKey:@"BUY_TONE_ALERT_TITLE" inTable:@"Tones"];
  }
  else {
  v12 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_ALERT_TITLE" inBundles:0 inTable:@"Tones"];
  }
  [v10 setTitle:v12];
  ...
  if (v14)
  {
    ...
    v16 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_BODY_FORMAT" inBundles:0 inTable:@"Tones"];
    }
    v17 = NSString;
  ...
  if (MGGetBoolAnswer())
  {
    ...
    v22 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_SET_AS_DEFAULT_RINGTONE" inBundles:0 inTable:v21];
    }

    v23 = (void *)MEMORY[0x1E4FB1410];
    v47[0] = MEMORY[0x1E4F143A8];
    v47[1] = 3221225472;
    v47[2] = __66__SKUITonePurchaseController_showPurchaseFlowWithCompletionBlock___block_invoke;
    v47[3] = &unk_1E6423678;
  ...
  v27 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_SET_AS_DEFAULT_TEXT_TONE" inBundles:0 inTable:v26];
  }

  v28 = (void *)MEMORY[0x1E4FB1410];
  v45[0] = MEMORY[0x1E4F143A8];
  v45[1] = 3221225472;
  v45[2] = __66__SKUITonePurchaseController_showPurchaseFlowWithCompletionBlock___block_invoke_2;
  v45[3] = &unk_1E6423678;
  ...
  v32 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_ASSIGN_TO_CONTACT" inBundles:0 inTable:v31];
  }
  v33 = v4;
  ...
  v43[1] = 3221225472;
  v43[2] = __66__SKUITonePurchaseController_showPurchaseFlowWithCompletionBlock___block_invoke_3;
  v43[3] = &unk_1E6423678;
  ...
  v37 = v31;
  if (v36) {
    [(SKUIClientContext *)v36 localizedStringForKey:@"BUY_TONE_DONE" inTable:v37];
  }
  else {
  v38 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_DONE" inBundles:0 inTable:v37];
  }

  v39 = (void *)MEMORY[0x1E4FB1410];
  v41[0] = MEMORY[0x1E4F143A8];
  v41[1] = 3221225472;
  v41[2] = __66__SKUITonePurchaseController_showPurchaseFlowWithCompletionBlock___block_invoke_4;
  v41[3] = &unk_1E6423678;
...
{
  id v3 = objc_alloc_init(MEMORY[0x1E4FA82F0]);
...
- (void)_finishContactPicker:(id)a3 withContact:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_alloc_init(MEMORY[0x1E4FA82F0]);
  if (v7)
  {
  ...
  if (MGGetBoolAnswer())
  {
    v11 = [MEMORY[0x1E4FB1418] alertControllerWithTitle:0 message:0 preferredStyle:1];
    objc_initWeak(location, self);
    ...
    uint64_t v14 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_SET_AS_RINGTONE" inBundles:0 inTable:v13];
    }

    v15 = (void *)MEMORY[0x1E4FB1410];
    v32[0] = MEMORY[0x1E4F143A8];
    v32[1] = 3221225472;
    v32[2] = __63__SKUITonePurchaseController__finishContactPicker_withContact___block_invoke;
    v32[3] = &unk_1E6425648;
    id v16 = v8;
    id v33 = v16;
    ...
    v19 = v13;
    if (v18) {
      [(SKUIClientContext *)v18 localizedStringForKey:@"BUY_TONE_SET_AS_TEXT_TONE", v19, &v34 inTable];
    }
    else {
    v20 = +[SKUIClientContext localizedStringForKey:@"BUY_TONE_SET_AS_TEXT_TONE", 0, v19, &v34 inBundles inTable];
    }

    v21 = (void *)MEMORY[0x1E4FB1410];
    v29[0] = MEMORY[0x1E4F143A8];
    v29[1] = 3221225472;
    v29[2] = __63__SKUITonePurchaseController__finishContactPicker_withContact___block_invoke_2;
    v29[3] = &unk_1E6425648;
    id v30 = v16;
    ...
    if (v24)
    {
      ...
      v27[1] = 3221225472;
      v27[2] = __63__SKUITonePurchaseController__finishContactPicker_withContact___block_invoke_3;
      v27[3] = &unk_1E6425670;
      v27[4] = self;
      id v28 = v11;
  ...
  {
    [v8 setAssigneeToneStyle:*MEMORY[0x1E4FA86B8]];
...
{
  [*(id *)(a1 + 32) setAssigneeToneStyle:*MEMORY[0x1E4FA86B0]];
...
{
  [*(id *)(a1 + 32) setAssigneeToneStyle:*MEMORY[0x1E4FA86B8]];
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  [WeakRetained _finishWithTonePurchase:*(void *)(a1 + 32)];
}

uint64_t __63__SKUITonePurchaseController__finishContactPicker_withContact___block_invoke_3(uint64_t a1)
{
...
{
  id v8 = a3;
  id v4 = [(SKUITonePurchaseController *)self parentViewController];
...
- (void)_showContactPicker
{
  ...
  id v4 = (objc_class *)SKUIWeakLinkedClassForString(&cfstr_Cncontactpicke.isa, v3);
  if (v4)
  {
