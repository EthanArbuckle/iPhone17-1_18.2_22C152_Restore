...
- (SKUIRedeemCameraLandingView)initWithClientContext:(id)a3
{
  ...
  v5 = [(SKUIRedeemCameraLandingView *)&v51 init];
  if (v5)
  {
    ...
    v15 = v5->_headerLabel;
    v16 = [MEMORY[0x1E4FB08E0] boldSystemFontOfSize:17.0];
    ...
    BOOL v20 = +[SKUIRedeemViewControllerLegacy redeemRequiresNationalId:v4];
...
LABEL_19:
        ...
        v31 = +[SKUIClientContext localizedStringForKey:v30 inBundles:0 inTable:@"Redeem"];
        }
        ...
        v38 = v5->_bodyLabel;
        v39 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.600000024];
        ...
        uint64_t v42 = [MEMORY[0x1E4FB14D0] buttonWithType:1];
        button = v5->_button;
        ...
        v45 = +[SKUIClientContext localizedStringForKey:@"CAMERA_REDEEM_USE_CAMERA_BUTTON" inBundles:0 inTable:@"Redeem"];
        }
        ...
        [(SKUIRedeemCameraLandingView *)v5 setBackgroundColor:v48];
    ...
    v26 = +[SKUIClientContext localizedStringForKey:v25 inBundles:0 inTable:@"Redeem"];
    }
