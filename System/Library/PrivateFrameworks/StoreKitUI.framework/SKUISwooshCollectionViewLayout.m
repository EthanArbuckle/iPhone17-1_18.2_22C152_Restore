...
- (SKUISwooshCollectionViewLayout)init
{
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3) {
        [(SKUISwooshCollectionViewLayout *)v3 init];
      }
    }
  }
  v14.receiver = self;
...
- (id)layoutAttributesForElementsInRect:(CGRect)a3
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)SKUISwooshCollectionViewLayout;
  uint64_t v4 = -[UICollectionViewFlowLayout layoutAttributesForElementsInRect:](&v14, sel_layoutAttributesForElementsInRect_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
...
- (CGPoint)targetContentOffsetForProposedContentOffset:(CGPoint)a3 withScrollingVelocity:(CGPoint)a4
{
  ...
  {
    long long v10 = [(SKUISwooshCollectionViewLayout *)self collectionView];
