...
- (SKUIGiftTextTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4;
- (UITextView)textView;
...
- (SKUIGiftTextTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  v20.receiver = self;
  v20.super_class = (Class)SKUIGiftTextTableViewCell;
  v7 = [(SKUIGiftTextTableViewCell *)&v20 initWithStyle:a3 reuseIdentifier:v6];
  v8 = v7;
  if (v7)
  {
    v9 = [(SKUIGiftTextTableViewCell *)v7 contentView];
    ...
    v13 = [MEMORY[0x1E4FB1618] tableSeparatorColor];
    [(UIView *)v12 setBackgroundColor:v13];

    [v9 addSubview:v8->_bottomBorderView];
    ...
    v8->_leftToRight = [v18 userInterfaceLayoutDirection] == 0;
  }
  return v8;
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUIGiftTextTableViewCell;
...
{
  id v15 = a3;
  id v4 = [(SKUIGiftTextTableViewCell *)self label];
  if (v4 != v15 && ([v15 isEqualToString:v4] & 1) == 0)
  {
    ...
    if (v15)
    {
      ...
      v14 = [(SKUIGiftTextTableViewCell *)self contentView];
...
{
  id v15 = a3;
  id v4 = [(SKUIGiftTextTableViewCell *)self placeholder];
  if (v4 != v15 && ([v15 isEqualToString:v4] & 1) == 0)
  {
...
- (void)setTextView:(id)a3
{
  ...
  if (v5)
  {
    ...
    v9 = [(SKUIGiftTextTableViewCell *)self contentView];

    if (v8 != v9)
    {
      v10 = [(SKUIGiftTextTableViewCell *)self contentView];
...
- (void)layoutSubviews
{
  ...
  v56.receiver = self;
  v56.super_class = (Class)SKUIGiftTextTableViewCell;
  [(SKUIGiftTextTableViewCell *)&v56 layoutSubviews];
  objc_super v3 = [(SKUIGiftTextTableViewCell *)self contentView];
  [v3 bounds];
  double v5 = v4;
  double v7 = v6;
  double v9 = v8;
  ...
  double v13 = v12;
  double v15 = v14;
  BOOL v16 = [(SKUIGiftTextTableViewCell *)self leftToRight];
  label = self->_label;
  double v55 = v11;
  double v52 = v7;
  if (v16)
  ...
  else
  {
    CGFloat v23 = 12.0;
    double v22 = 15.0;
    +[SKUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SKUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", 15.0, 12.0, v13, v15, v5, v7, v9, v11);
  }
  ...
  BOOL v29 = [(SKUIGiftTextTableViewCell *)self leftToRight];
  placeholderLabel = self->_placeholderLabel;
  double v31 = 12.0;
  if (!v29)
  {
    +[SKUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SKUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", v26, 12.0, v28, v25, v5, v52, v27);
    double v26 = v32;
    double v28 = v33;
    double v25 = v34;
  }
  ...
  v46 = objc_msgSend(MEMORY[0x1E4FB14C0], "bezierPathWithRect:", v39, v41, v43, v45);
