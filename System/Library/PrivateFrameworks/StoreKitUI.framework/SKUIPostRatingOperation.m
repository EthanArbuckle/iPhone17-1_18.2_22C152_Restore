...
- (void)run
{
  ...
  id v7 = objc_alloc_init(MEMORY[0x1E4FB8858]);
  id v8 = (void *)[objc_alloc(MEMORY[0x1E4FA8268]) initWithURL:v6];
  ...
  id v17 = 0;
  int v10 = [(SKUIPostRatingOperation *)self runSubOperation:v7 returningError:&v17];
  id v11 = v17;
  if (v10)
  {
    v12 = [v9 output];
  ...
  [(SKUIPostRatingOperation *)self setError:v11];
  [(SKUIPostRatingOperation *)self setSuccess:v14];
}
