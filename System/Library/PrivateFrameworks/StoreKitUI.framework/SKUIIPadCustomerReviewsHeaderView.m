...
- (SKUIIPadCustomerReviewsHeaderView)initWithClientContext:(id)a3
{
  ...
  if (v6)
  {
    ...
    v13 = +[SKUIClientContext localizedStringForKey:@"REVIEWS_HEADER_BUTTON_APP_SUPPORT" inBundles:0 inTable:@"ProductPage"];
    }
    ...
    v21 = +[SKUIClientContext localizedStringForKey:@"REVIEWS_HEADER_BUTTON_WRITE_A_REVIEW_IPAD" inBundles:0 inTable:@"ProductPage"];
    }
    ...
    v32 = +[SKUIClientContext localizedStringForKey:@"REVIEWS_HEADER_TITLE" inBundles:0 inTable:@"ProductPage"];
    }
    ...
    {
      v37 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.2];
...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != v5)
  {
    ...
    uint64_t v8 = [(SKUIColorScheme *)*p_colorScheme secondaryTextColor];
    if (v8)
    {
    ...
    v12 = SKUIColorWithAlpha(v11, 0.6);
    if (v12)
    {
...
- (void)_sortButtonAction:(id)a3
{
  if (!self->_sortPopoverController)
  {
    ...
    double v5 = (UIPopoverController *)[objc_alloc(MEMORY[0x1E4FB1AF8]) initWithContentViewController:v17];
...
- (void)_reloadSortButton
{
  if ([(NSArray *)self->_sortTitles count])
  {
    ...
    if (!self->_sortLabel)
    {
      double v11 = (UILabel *)objc_alloc_init(MEMORY[0x1E4FB1930]);
      sortLabel = self->_sortLabel;
      self->_sortLabel = v11;

      double v13 = self->_sortLabel;
      double v14 = [(SKUIIPadCustomerReviewsHeaderView *)self backgroundColor];
      [(UILabel *)v13 setBackgroundColor:v14];

      double v15 = self->_sortLabel;
      double v16 = [MEMORY[0x1E4FB08E0] systemFontOfSize:17.0];
      [(UILabel *)v15 setFont:v16];

      v17 = self->_sortLabel;
      v18 = [(SKUIColorScheme *)self->_colorScheme primaryTextColor];
      double v19 = SKUIColorWithAlpha(v18, 0.6);
      if (v19)
      {
      ...
      v25 = +[SKUIClientContext localizedStringForKey:@"REVIEWS_HEADER_SORT_BY" inBundles:0 inTable:@"ProductPage"];
      }
