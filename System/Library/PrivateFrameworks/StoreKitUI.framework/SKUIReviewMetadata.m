@interface SKUIReviewMetadata
- (NSString)body;
- (NSString)nickname;
- (NSString)title;
- (NSURL)submitURL;
- (SKUIReviewMetadata)initWithReviewDictionary:(id)a3;
- (float)rating;
...
@implementation SKUIReviewMetadata
...
- (SKUIReviewMetadata)initWithReviewDictionary:(id)a3
{
  ...
  v31.receiver = self;
  v31.super_class = (Class)SKUIReviewMetadata;
  v5 = [(SKUIReviewMetadata *)&v31 init];
  if (v5)
  {
...
LABEL_9:
    ...
    if (objc_opt_isKindOfClass())
    {
      uint64_t v13 = [objc_alloc(MEMORY[0x1E4F1CB10]) initWithString:v12];
