...
- (void)dealloc
{
  ...
  id v5 = [(SKUIProductPageHeaderView *)self->_headerView shareButton];
...
- (SKUIProductPageHeaderFloatingView)floatingView
{
  ...
  if (!floatingView)
  {
    ...
    id v5 = [[SKUIProductPageHeaderFloatingView alloc] initWithSectionTitles:v4 isPad:SKUIUserInterfaceIdiom(self->_clientContext) == 1];
    ...
    objc_super v10 = [(SKUIProductPageHeaderFloatingView *)self->_floatingView sectionControl];
...
- (UIImage)iconImage
{
  ...
  {
    id v5 = [(SKUIProductPageHeaderViewController *)self _activeItem];
    v6 = v5;
      ...
      if (v9)
      {
        ...
        while (2)
        {
          for (uint64_t i = 0; i != v10; ++i)
          {
            ...
            id v14 = objc_alloc(MEMORY[0x1E4FA8338]);
            v15 = [v13 URL];
...
- (void)reloadData
{
  ...
  if (!self->_personalizationState)
  {
    if ([v3 itemKind] == 17)
    {
      id v5 = [[SKUIPersonalizeOfferOperation alloc] initWithItemIdentifier:self->_itemIdentifier clientContext:self->_clientContext];
  ...
  {
    objc_super v7 = [(SKUIProductPageHeaderViewController *)self _artworkContext];
    id v8 = [(SKUIProductPage *)self->_productPage item];
    if (v8)
    {
    ...
    v20 = (SSVLoadURLOperation *)[objc_alloc(MEMORY[0x1E4FA8338]) initWithURL:v9];
...
- (int64_t)selectedSectionIndex
{
  return [(SKUIProductPageHeaderFloatingView *)self->_floatingView selectedSectionIndex];
}
...
- (void)setAskPermission:(BOOL)a3
{
  if (self->_askPermission != a3)
  {
    ...
    id v4 = [(SKUIProductPageHeaderView *)self->_headerView artistButton];
...
- (void)setProductPage:(id)a3
{
  id v5 = (SKUIProductPage *)a3;
  p_productPage = &self->_productPage;
  if (self->_productPage != v5)
  {
    v47 = v5;
    objc_storeStrong((id *)&self->_productPage, a3);
    id v7 = [(SKUIProductPage *)*p_productPage item];
    if (v7 && self->_wantsActivityViewController)
    {
      id v8 = [(SKUIProductPageHeaderView *)self->_headerView shareButton];
      [(SKUIProductPageHeaderViewController *)self _showActivityViewControllerFromView:v8];
    }
    uint64_t v9 = [(SKUIProductPage *)*p_productPage uber];
    artworkContext = self->_artworkContext;
    id v11 = [v9 colorScheme];
    [(SKUIItemArtworkContext *)artworkContext setColorScheme:v11];

    floatingView = self->_floatingView;
    double v13 = [v9 colorScheme];
    [(SKUIProductPageHeaderFloatingView *)floatingView setColorScheme:v13];

    headerView = self->_headerView;
    double v15 = [(SKUIProductPage *)*p_productPage uber];
    ...
    else
    {
      ...
      [(SKUIProductPageHeaderView *)headerView setBackgroundColor:v18];
    }
    double v19 = self->_headerView;
    v20 = [v9 colorScheme];
    [(SKUIProductPageHeaderView *)v19 setColorScheme:v20];

    v21 = self->_headerView;
    v22 = [v7 contentRating];
    [(SKUIProductPageHeaderView *)v21 setContentRating:v22];
    ...
    if ([v7 hasInAppPurchases])
    {
      ...
      v25 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_IN_APPS_HEADER" inBundles:0 inTable:@"ProductPage"];
      }
      [(SKUIProductPageHeaderView *)v23 setInAppPurchasesString:v25];
    }
    else
    {
      [(SKUIProductPageHeaderView *)v23 setInAppPurchasesString:0];
    }
    -[SKUIProductPageHeaderView setNumberOfUserRatings:](self->_headerView, "setNumberOfUserRatings:", [v7 numberOfUserRatings]);
    v26 = self->_headerView;
    [v7 userRating];
    [(SKUIProductPageHeaderView *)v26 setUserRating:(float)(v27 / 5.0)];
    ...
    if ([v28 count])
    {
      ...
      {
        long long v30 = [(SKUIProductPageHeaderViewController *)self _contentRatingResourceLoader];
      ...
      [(SKUIProductPageHeaderView *)v32 setSecondaryContentRating:v33];
    }
    ...
    if (v38)
    {
      ...
      [v42 scale];
      double v44 = v41 / v43;
      uint64_t v45 = SKUIUserInterfaceIdiom(self->_clientContext);
      double v46 = -60.0;
      if (v45 != 1) {
        double v46 = -30.0;
      }
      [(SKUIProductPageHeaderView *)v39 setHeaderImageHeight:v44 + v46];
...
- (void)setSelectedSectionIndex:(int64_t)a3
{
  id v4 = [(SKUIProductPageHeaderViewController *)self floatingView];
...
- (void)didRotateFromInterfaceOrientation:(int64_t)a3
{
  ...
  {
    id v4 = [(SKUIProductPageHeaderView *)self->_headerView shareButton];
...
- (void)loadView
{
  id v56 = [(SKUIProductPage *)self->_productPage uber];
  headerView = self->_headerView;
  if (!headerView)
  {
    id v4 = [(SKUIProductPageHeaderViewController *)self _activeItem];
    id v5 = [(SKUIProductPage *)self->_productPage item];
    double v6 = [[SKUIProductPageHeaderView alloc] initWithClientContext:self->_clientContext];
    ...
    double v13 = [(SKUIProductPageHeaderViewController *)self _ageBandString];
    [(SKUIProductPageHeaderView *)v12 setAgeBandString:v13];

    id v14 = self->_headerView;
    objc_super v15 = [(SKUIProductPageHeaderViewController *)self iconImage];
    ...
    if ([v5 hasInAppPurchases])
    {
      ...
      v24 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_IN_APPS_HEADER" inBundles:0 inTable:@"ProductPage"];
      }
    ...
    [v4 userRating];
    [(SKUIProductPageHeaderView *)v25 setUserRating:(float)(v26 / 5.0)];
    ...
    if ([v27 count])
    {
      ...
      if (!contentRatingArtworkLoader)
      {
        id v29 = [(SKUIProductPageHeaderViewController *)self _contentRatingResourceLoader];
    ...
    double v35 = [MEMORY[0x1E4FB1BA8] mainScreen];
    [v35 scale];
    ...
    if (v37)
    {
      ...
      [v37 size];
      double v40 = v39;
      double v41 = [MEMORY[0x1E4FB1BA8] mainScreen];
      [v41 scale];
      double v43 = v40 / v42;
      uint64_t v44 = SKUIUserInterfaceIdiom(self->_clientContext);
      double v45 = -60.0;
      if (v44 != 1) {
        double v45 = -30.0;
      }
    ...
    [(SKUIProductPageHeaderViewController *)self _reloadItemStateAnimated:0];
    double v46 = [(SKUIProductPageHeaderView *)self->_headerView itemOfferButton];
...
- (void)_artistButtonAction:(id)a3
{
  ...
  if (productPage)
  {
    objc_super v5 = [(SKUIProductPage *)productPage item];
...
- (void)_itemOfferButtonAction:(id)a3
{
  ...
  id v9 = [(SKUIProductPageHeaderViewController *)self _activeItem];
  id v10 = v9;
...
LABEL_19:
  ...
  BOOL v15 = SKUIItemStateCenterUseAppstoredPurchases(v10);
...
void __62__SKUIProductPageHeaderViewController__itemOfferButtonAction___block_invoke_2(uint64_t a1)
{
  ...
  if ([WeakRetained isEqualToString:*MEMORY[0x1E4FA8680]])
  {
    uint64_t v3 = [v4 code];
...
- (void)_sectionControlAction:(id)a3
{
  ...
  int64_t v4 = [(SKUIProductPageHeaderFloatingView *)self->_floatingView selectedSectionIndex];
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  char v6 = objc_opt_respondsToSelector();
  ...
  if (v6)
  {
    ...
    if ([v8 canRecordEventWithType:*MEMORY[0x1E4FA8878]])
    {
      id v9 = objc_alloc_init(MEMORY[0x1E4FA8200]);
      id v10 = [(SKUIProductPageHeaderViewController *)self _segmentedControlTitles];
      double v11 = [v10 objectAtIndex:v4];
      [v9 setActionDetails:v11];

      [v9 setActionType:*MEMORY[0x1E4FA8870]];
      uint64_t v12 = *MEMORY[0x1E4FA88E8];
      ...
      v19[0] = v14;
      v19[1] = v13;
      BOOL v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:v19 count:2];
...
- (id)_ageBandString
{
  uint64_t v3 = [(SKUIProductPageHeaderViewController *)self _activeItem];
  ...
  else
  {
    ...
    if (v4)
    {
      ...
      long long v14 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_HEADER_AGE_BAND" inBundles:0 inTable:@"ProductPage"];
      }
    ...
    else
    {
      ...
      long long v14 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_HEADER_AGE_MAX" inBundles:0 inTable:@"ProductPage"];
      }
...
- (id)_artworkContext
{
  ...
  if (!artworkContext)
  {
    uint64_t v4 = objc_alloc_init(SKUIItemArtworkContext);
    ...
    id v8 = +[SKUIStyledImageDataConsumer appIconConsumerWithSize:](SKUIStyledImageDataConsumer, "appIconConsumerWithSize:", v7, v7);
    ...
    long long v11 = +[SKUIStyledImageDataConsumer productImageConsumerWithSize:](SKUIStyledImageDataConsumer, "productImageConsumerWithSize:", v10, v10);
    ...
    long long v14 = +[SKUIProductImageDataConsumer consumerWithSize:](SKUIProductImageDataConsumer, "consumerWithSize:", v13, v13);
    [(SKUIItemArtworkContext *)v12 setGeneralConsumer:v14];

    BOOL v15 = self->_artworkContext;
    uint64_t v16 = [(SKUIProductPage *)self->_productPage uber];
...
- (id)_contentRatingResourceLoader
{
  uint64_t v3 = [SKUIResourceLoader alloc];
  uint64_t v4 = [(SKUIProductPageHeaderViewController *)self clientContext];
  uint64_t v5 = [(SKUIResourceLoader *)v3 initWithClientContext:v4];

  uint64_t v6 = [[SKUIContentRatingArtworkResourceLoader alloc] initWithArtworkLoader:v5];
  double v7 = +[SKUIStyledImageDataConsumer appIconConsumerWithSize:](SKUIStyledImageDataConsumer, "appIconConsumerWithSize:", 11.0, 11.0);
...
- (void)_disableItemOfferButtonWithTitle:(id)a3 animated:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  double v7 = [[SKUIItemOffer alloc] initWithButtonText:v6];
...
- (void)_loadUberImageIfAvailable
{
  ...
  {
    uint64_t v3 = [(SKUIProductPage *)self->_productPage uber];
    ...
    if (v9)
    {
      double v10 = (SSVLoadURLOperation *)[objc_alloc(MEMORY[0x1E4FA8338]) initWithURL:v9];
      ...
      double v13 = [(SKUIProductPage *)self->_productPage uber];
      if (v13)
      {
        long long v14 = [(SKUIProductPage *)self->_productPage uber];
        ...
        {
          char v17 = [MEMORY[0x1E4FB1618] whiteColor];
      ...
      uint64_t v22 = __64__SKUIProductPageHeaderViewController__loadUberImageIfAvailable__block_invoke;
      v23 = &unk_1E6424128;
      objc_copyWeak(&v24, &location);
      [(SSVLoadURLOperation *)v18 setOutputBlock:&v20];
      double v19 = [(SKUIProductPageHeaderViewController *)self operationQueue];
...
- (void)_reloadItemStateAnimated:(BOOL)a3
{
  ...
  id v7 = item;
  id v8 = +[SKUIItemStateCenter defaultCenter];
  id v9 = objc_msgSend(v8, "stateForItemWithIdentifier:", -[SKUIItem itemIdentifier](v7, "itemIdentifier"));
  if ([(SKUIItem *)v7 itemKind] == 17)
  {
    if (v5 && v4->_personalizationState == 2)
    {
      ...
      v57 = v4;
      v51 = v5;
      id v10 = [(SKUIItem *)v5 childItemIdentifiers];
      ...
      {
        float v27 = [(SKUIItem *)v53 primaryItemOffer];
        [(SKUIProductPageHeaderView *)headerView setItemOffer:v27];
      }
      id v9 = v52;
      if (v14 > 0 || ([v52 state] & 1) != 0)
      {
        ...
        uint64_t v30 = 1;
LABEL_36:
        [(SKUIProductPageHeaderViewController *)v29 _showSynthesizedItemStateWithFlag:v30 animated:v50];
        id v5 = v51;
        id v7 = v53;
LABEL_37:
      ...
      if (v16 >= 1 && v16 + v15 == v49)
      {
        ...
        id v32 = +[SKUIClientContext localizedStringForKey:@"APP_BUNDLE_DOWNLOADING" inBundles:0 inTable:@"ProductPage"];
        }
        id v5 = v51;
        id v7 = v53;
        BOOL v33 = v50;
        ...
        double v35 = v32;
LABEL_51:
        [(SKUIProductPageHeaderViewController *)v34 _disableItemOfferButtonWithTitle:v35 animated:v33];
      ...
      if (v15 >= 1 && v15 == v49)
      {
        ...
        if (v31) {
          [(SKUIClientContext *)v31 localizedStringForKey:@"APP_BUNDLE_INSTALLED" inTable:@"ProductPage"];
        }
        else {
        id v32 = +[SKUIClientContext localizedStringForKey:@"APP_BUNDLE_INSTALLED" inBundles:0 inTable:@"ProductPage"];
        }
        id v5 = v51;
        id v7 = v53;
        double v34 = v57;
      ...
      if (v36) {
        [(SKUIClientContext *)v36 localizedStringForKey:@"PRODUCT_PAGE_COMPLETE_MY_BUNDLE_ORIGINAL_OFFER" inTable:@"ProductPage"];
      }
      else {
      double v37 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_COMPLETE_MY_BUNDLE_ORIGINAL_OFFER" inBundles:0 inTable:@"ProductPage"];
      }
      id v7 = v53;
      if (v57->_personalizedOffer)
      {
        v54 = v57->_headerView;
        v38 = NSString;
        double v39 = [(SKUIItem *)v7 primaryItemOffer];
        double v40 = [v39 buttonText];
        double v41 = [v38 stringWithValidatedFormat:v37, @"%@", 0, v40 validFormatSpecifiers error];
        [(SKUIProductPageHeaderView *)v54 setItemOfferExplanationText:v41];

        double v42 = v57->_headerView;
        double v43 = v57->_clientContext;
        id v5 = v51;
        if (v43) {
          [(SKUIClientContext *)v43 localizedStringForKey:@"PRODUCT_PAGE_COMPLETE_MY_BUNDLE_TITLE" inTable:@"ProductPage"];
        }
        else {
        uint64_t v44 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_COMPLETE_MY_BUNDLE_TITLE" inBundles:0 inTable:@"ProductPage"];
        }
        BOOL v47 = v50;
        [(SKUIProductPageHeaderView *)v42 setItemOfferExplanationTitle:v44];
      }
      else
      {
        id v5 = v51;
        uint64_t v44 = [(SKUIItem *)v51 regularPriceString];
        if (!v44)
        {
          [(SKUIProductPageHeaderView *)v57->_headerView setItemOfferExplanationText:0];
          [(SKUIProductPageHeaderView *)v57->_headerView setItemOfferExplanationTitle:0];
          BOOL v47 = v50;
LABEL_65:

          [(SKUIProductPageHeaderViewController *)v57 _setItemState:v9 animated:v47];
          goto LABEL_37;
        }
        v55 = v57->_headerView;
        double v45 = [NSString stringWithValidatedFormat:v37, @"%@", 0, v44 validFormatSpecifiers error];
        [(SKUIProductPageHeaderView *)v55 setItemOfferExplanationText:v45];

        id v56 = v57->_headerView;
        double v46 = v57->_clientContext;
        if (v46) {
          [(SKUIClientContext *)v46 localizedStringForKey:@"PRODUCT_PAGE_BUNDLE_OFFER_TITLE" inTable:@"ProductPage"];
        }
        else {
        v48 = +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_BUNDLE_OFFER_TITLE" inBundles:0 inTable:@"ProductPage"];
        }
        BOOL v47 = v50;
        [(SKUIProductPageHeaderView *)v56 setItemOfferExplanationTitle:v48];
      }
      id v9 = v52;
      goto LABEL_65;
    }
  ...
  else
  {
    ...
    uint64_t v22 = [(SKUIItem *)v7 primaryItemOffer];
    [(SKUIProductPageHeaderView *)v21 setItemOffer:v22];
  ...
  [(SKUIProductPageHeaderViewController *)v23 _setItemState:v24 animated:v3];
LABEL_24:
  v25 = [(SKUIProductPageHeaderView *)v4->_headerView itemOfferButton];
...
- (id)_segmentedControlTitles
{
  ...
  if (v6)
  {
    [(SKUIClientContext *)v6 localizedStringForKey:@"PRODUCT_PAGE_REVIEWS_TAB", @"ProductPage", v14[0] inTable];
  }
  else
  {
    id v7 = 0;
    +[SKUIClientContext localizedStringForKey:@"PRODUCT_PAGE_REVIEWS_TAB", 0, @"ProductPage", v14[0] inBundles inTable];
  id v8 = };
...
- (void)_setItemState:(id)a3 animated:(BOOL)a4
{
  ...
  headerView = self->_headerView;
  id v8 = a3;
  id v7 = [(SKUIProductPageHeaderView *)headerView itemOfferButton];
  [v7 setEnabled:1];
...
- (void)_showActivityViewControllerFromView:(id)a3
{
  ...
  {
    char v5 = [SKUIProductPageActivityViewController alloc];
    id v6 = [(SKUIProductPage *)self->_productPage item];
    id v7 = [(SKUIProductPageActivityViewController *)v5 initWithProductPageItem:v6 clientContext:self->_clientContext];

    objc_initWeak(&location, self);
    uint64_t v21 = MEMORY[0x1E4F143A8];
    uint64_t v22 = 3221225472;
    v23 = __75__SKUIProductPageHeaderViewController__showActivityViewControllerFromView___block_invoke;
    id v24 = &unk_1E6427660;
...
{
  BOOL v4 = a4;
  id v10 = objc_alloc_init(SKUIItemState);
  id v7 = NSNumber;
  id v8 = [(SKUIProductPageHeaderViewController *)self _activeItem];
...
- (SKUIProductPageHeaderViewDelegate)delegate
{
  ...
  return (SKUIProductPageHeaderViewDelegate *)WeakRetained;
}
