...
- (SKUIPersonalizeOfferOperation)initWithItemIdentifier:(int64_t)a3 clientContext:(id)a4
{
  ...
  if (v8)
  {
    ...
    v9->_itemID = a3;
    dispatch_queue_t v10 = dispatch_queue_create("com.apple.StoreKitUI.SKUIPersonalizeOfferOperation", 0);
...
- (id)outputBlock
{
  ...
  dispatch_queue_t v10 = __Block_byref_object_dispose__67;
  id v11 = 0;
...
- (void)main
{
  ...
  id v8 = [(SKUIClientContext *)self->_clientContext valueForConfigurationKey:@"sfsuffix"];
  [v6 setStoreFrontSuffix:v8];

  [v6 setTimeoutInterval:&unk_1F1D62168];
  ...
  [v6 main];
  uint64_t v10 = [(SKUIPersonalizeOfferOperation *)self outputBlock];
  id v11 = (void *)v10;
  if (v10) {
    ...
    if (v10)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          objc_super v15 = [SKUIItemOffer alloc];
