...
- (id)_initWithNavigationController:(id)a3 clientContext:(id)a4
{
  ...
  v18.receiver = self;
  v18.super_class = (Class)SKUINavigationControllerAssistant;
  ...
  if (v7)
  {
    ...
    if (!v8->_paletteBackgroundView)
    {
      ...
      uint64_t v14 = objc_msgSend(v13, "paletteForEdge:size:", 2, *MEMORY[0x1E4F1DB30], *(double *)(MEMORY[0x1E4F1DB30] + 8));
...
+ (id)assistantForNavigationController:(id)a3 clientContext:(id)a4
{
  ...
  if (!v8)
  {
    id v8 = [[SKUINavigationControllerAssistant alloc] _initWithNavigationController:v5 clientContext:v6];
    objc_setAssociatedObject(v5, "com.apple.StoreKitUI.SKUINavigationControllerAssistant", v8, (void *)1);
  }
...
+ (id)existingAssistantForNavigationController:(id)a3
{
  ...
  id v5 = objc_getAssociatedObject(v3, "com.apple.StoreKitUI.SKUINavigationControllerAssistant");
...
- (void)setHidesShadow:(BOOL)a3
{
  if (self->_hidesShadow != a3)
  {
    ...
    uint64_t v4 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
    id v5 = v4;
    if (v3) {
...
{
  BOOL v3 = a3;
  id v5 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
  char v6 = objc_opt_respondsToSelector();

  if (v6)
  {
    id v7 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
...
- (void)willShowViewController:(id)a3 animated:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  id v7 = [(SKUINavigationControllerAssistant *)self childPaletteView];
  if ([v6 conformsToProtocol:&unk_1F1DEEBA0])
  {
...
LABEL_6:
  ...
  id v13 = [(SKUINavigationControllerAssistant *)self navigationController];
...
- (_UINavigationControllerPalette)paletteBackgroundView
{
  ...
  {
    uint64_t v3 = [(SKUINavigationControllerAssistant *)self navigationController];
...
{
  id v11 = a3;
  BOOL v4 = [(SKUINavigationControllerAssistant *)self statusOverlayProvider];
  objc_opt_class();
  ...
  if (isKindOfClass)
  {
    ...
    id v9 = [(SKUINavigationControllerAssistant *)self navigationController];
    uint64_t IsVisible = SKUIViewControllerIsVisible(v9);
...
- (void)_hideChildPaletteView:(id)a3 animated:(BOOL)a4
{
  ...
  uint64_t v14 = [(SKUINavigationControllerAssistant *)self statusOverlayViewController];
  v15 = [v14 view];
  ...
  {
    objc_msgSend(v15, "setFrame:", *MEMORY[0x1E4F1DAD8], *(double *)(MEMORY[0x1E4F1DAD8] + 8), v17, v19);
    v24 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
    objc_msgSend(v24, "setFrame:isAnimating:", objc_msgSend(MEMORY[0x1E4FB1EB0], "_isInAnimationBlockWithAnimationsEnabled"), v9, v11, v13, v20);

    v25 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
    objc_msgSend(v25, "setPinningBarShadowIsHidden:", objc_msgSend(MEMORY[0x1E4FB1EB0], "_isInAnimationBlockWithAnimationsEnabled"));
...
- (void)_hideOverlayView:(id)a3 animated:(BOOL)a4
{
  ...
  uint64_t v14 = [(SKUINavigationControllerAssistant *)self childPaletteView];
  ...
  if (a4)
  {
    double v18 = [(SKUINavigationControllerAssistant *)self childPaletteView];
    ...
    if (v18)
    {
      ...
      uint64_t v22 = [(SKUINavigationControllerAssistant *)self childPaletteView];
  ...
  else
  {
    ...
    id v27 = [(SKUINavigationControllerAssistant *)self childPaletteView];
...
- (void)_setStatusOverlayProvider:(id)a3 animated:(BOOL)a4
{
  ...
  {
    double v16 = v7;
    double v8 = [(SKUINavigationControllerAssistant *)self statusOverlayViewController];
    double v9 = [v8 view];
    ...
    if (objc_opt_respondsToSelector())
    {
      double v13 = [(SKUIStatusOverlayProvider *)self->_statusOverlayProvider overlayViewControllerWithBackgroundStyle:v12 != 1];
...
- (void)_showOverlayView:(id)a3 previousOverlayView:(id)a4 animated:(BOOL)a5
{
  ...
  *((void *)&v67 + 1) = v13;
  *((_OWORD *)v63 + 2) = *MEMORY[0x1E4F1DAD8];
  uint64_t v14 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
  [v14 bounds];
  v63[6] = v15;

  double v16 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
  [v16 frame];
  double v18 = v17;
  double v20 = v19;
  double v22 = v21;
  ...
  id v24 = [(SKUINavigationControllerAssistant *)self childPaletteView];
  ...
  [v8 layoutIfNeeded];
  double v34 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
  [v34 addSubview:v8];

  double v35 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
  double v36 = [(SKUINavigationControllerAssistant *)self childPaletteView];
  [v35 setPinningBarShadowIsHidden:v36 != 0];

  [v9 removeFromSuperview];
  if (a5)
  {
    double v37 = [(SKUINavigationControllerAssistant *)self childPaletteView];
    ...
    if (v37)
    {
      ...
      double v39 = [MEMORY[0x1E4FB1618] clearColor];
  ...
  {
    id v48 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
...
- (void)_transitionToPaletteView:(id)a3 animated:(BOOL)a4 operation:(int64_t)a5
{
  BOOL v6 = a4;
  id v8 = a3;
  id v9 = [(SKUINavigationControllerAssistant *)self childPaletteView];

  uint64_t v10 = [(SKUINavigationControllerAssistant *)self childPaletteView];
  uint64_t v11 = v10;
  if (v9 != v8)
  {
    [(SKUINavigationControllerAssistant *)self setChildPaletteView:v8];
    uint64_t v12 = [(SKUINavigationControllerAssistant *)self childPaletteView];

    if (v12)
    {
      uint64_t v13 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
      [v13 bounds];
      CGFloat v15 = v14;
      CGFloat v17 = v16;
      double v19 = v18;
      ...
      long long v79 = 0u;
      long long v80 = 0u;
      double v22 = [(SKUINavigationControllerAssistant *)self childPaletteView];
      [v22 frame];
      ...
      *((void *)&v80 + 1) = v26;
      ...
      v27[4] = MaxX;
LABEL_12:
      CGFloat v29 = [(SKUINavigationControllerAssistant *)self childPaletteView];
      [v29 setAutoresizingMask:2];

      double v30 = [(SKUINavigationControllerAssistant *)self childPaletteView];
      objc_msgSend(v30, "setFrame:", v76[4], v76[5], v76[6], v76[7]);

      CGFloat v31 = [(SKUINavigationControllerAssistant *)self childPaletteView];
      [v31 layoutIfNeeded];

      double v32 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
      double v33 = [(SKUINavigationControllerAssistant *)self childPaletteView];
      [v32 addSubview:v33];
      ...
      double v45 = [(SKUINavigationControllerAssistant *)self statusOverlayViewController];
...
LABEL_17:
      ...
      *((_OWORD *)v76 + 2) = *MEMORY[0x1E4F1DAD8];
      id v48 = [(SKUINavigationControllerAssistant *)self childPaletteView];
      ...
      objc_msgSend(v49, "setFrame:isAnimating:", objc_msgSend(MEMORY[0x1E4FB1EB0], "_isInAnimationBlockWithAnimationsEnabled"), v37, v39, v41, MaxY);

      [v11 removeFromSuperview];
      id v50 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
      [v50 setHidden:0];

      id v51 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
      [v51 setAlpha:1.0];
...
LABEL_18:
  ...
  if (v11)
  {
    uint64_t v11 = [(SKUINavigationControllerAssistant *)self paletteBackgroundView];
...
{
  *(_OWORD *)(*(void *)(*(void *)(a1 + 56) + 8) + 32) = *MEMORY[0x1E4F1DAD8];
  ...
  objc_msgSend(v10, "setFrame:isAnimating:", objc_msgSend(MEMORY[0x1E4FB1EB0], "_isInAnimationBlockWithAnimationsEnabled"), *(double *)(a1 + 104), *(double *)(a1 + 112), *(double *)(a1 + 120), *(double *)(a1 + 128));
}
...
- (void)_initWithNavigationController:clientContext:.cold.1()
{
  ...
  int v0 = 136446210;
  uint64_t v1 = "-[SKUINavigationControllerAssistant _initWithNavigationController:clientContext:]";
}
...
+ (void)assistantForNavigationController:clientContext:.cold.1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  int v0 = 136446210;
  uint64_t v1 = "+[SKUINavigationControllerAssistant assistantForNavigationController:clientContext:]";
}
...
+ (void)existingAssistantForNavigationController:.cold.1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  int v0 = 136446210;
  uint64_t v1 = "+[SKUINavigationControllerAssistant existingAssistantForNavigationController:]";
}
