...
- (SKUINavigationBarButtonsController)initWithNavigationBarViewElement:(id)a3;
...
@implementation SKUINavigationBarButtonsController
...
- (SKUINavigationBarButtonsController)initWithNavigationBarViewElement:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUINavigationBarButtonsController;
  v6 = [(SKUINavigationBarButtonsController *)&v9 init];
  v7 = v6;
  if (v6) {
...
- (void)dealloc
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUINavigationBarButtonsController;
  [(SKUINavigationBarSectionController *)&v9 dealloc];
}
...
- (id)addButtonItemWithButtonViewElement:(id)a3
{
  ...
  {
    uint64_t v6 = objc_alloc_init(SKUIItemOfferButton);
    [(SKUIItemOfferButton *)v6 addTarget:self action:sel__cancelConfirmationAction_ forControlEvents:0x10000];
    [(SKUIItemOfferButton *)v6 addTarget:self action:sel__itemOfferAction_ forControlEvents:0x20000];
    [(SKUIItemOfferButton *)v6 addTarget:self action:sel__showConfirmationAction_ forControlEvents:0x40000];
    uint64_t v7 = [MEMORY[0x1E4FB1618] clearColor];
    [(SKUIItemOfferButton *)v6 setBackgroundColor:v7];

    [(SKUIItemOfferButton *)v6 setDelegate:self];
    [(SKUINavigationBarButtonsController *)self _updateItemOfferButton:v6 withButtonViewElement:v4];
    [v5 setCustomView:v6];
  }
  else
  {
    ...
    [v5 setTarget:self];
    [(SKUINavigationBarButtonsController *)self _updateButtonItem:v5 withButtonViewElement:v4];
  }
  buttonItemElements = self->_buttonItemElements;
  if (!buttonItemElements)
  {
    objc_super v9 = (NSMapTable *)[objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:512 valueOptions:512 capacity:0];
  ...
  long long v11 = [(SKUINavigationBarSectionController *)self viewLayoutContext];
  ...
  if (v12)
  {
    ...
    {
      v14 = (NSMapTable *)[objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:517 valueOptions:512 capacity:1];
...
- (void)reloadAfterDocumentUpdateWithNavigationItem:(id)a3
{
  ...
  v36[1] = 3221225472;
  v36[2] = __82__SKUINavigationBarButtonsController_reloadAfterDocumentUpdateWithNavigationItem___block_invoke;
  v36[3] = &unk_1E64243A8;
  id v10 = v7;
  id v37 = v10;
  id v11 = v8;
  id v38 = v11;
  [(SKUIViewElement *)navigationBarElement enumerateChildrenUsingBlock:v36];
  uint64_t v12 = 0;
  v26 = (void *)v6;
  v27 = (void *)v5;
  v40[0] = v5;
...
LABEL_4:
      ...
      while (1)
      {
        ...
        if (v21)
        {
          ...
          [(SKUINavigationBarButtonsController *)self _reloadButtonItem:v20 withButtonViewElement:v23];
  ...
  while ((v29 & 1) != 0);
  v31.receiver = self;
  v31.super_class = (Class)SKUINavigationBarButtonsController;
  [(SKUINavigationBarSectionController *)&v31 reloadAfterDocumentUpdateWithNavigationItem:v28];
}
...
{
  id v8 = a2;
  uint64_t IsButton = SKUIIKViewElementTypeIsButton([v8 elementType]);
  id v4 = v8;
  if (IsButton)
  {
...
LABEL_7:
  ...
  return MEMORY[0x1F41817F8](IsButton, v4);
}
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  id v6 = a3;
  id v22 = a4;
  uint64_t v7 = [(SKUINavigationBarSectionController *)self viewLayoutContext];
  uint64_t v21 = v6;
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        {
          [v13 setImage:v22];
          uint64_t v17 = [(SKUINavigationBarSectionController *)self context];
...
- (id)_imageForImageViewElement:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v7 = SKUIImageWithResourceName(v5);
  }
  else
  {
    uint64_t v8 = [(SKUINavigationBarSectionController *)self viewLayoutContext];
...
- (UIEdgeInsets)_imageInsetsForImageViewElement:(id)a3
{
  ...
  double v12 = v7;
  double v13 = v8;
  if (v10 == *(double *)(MEMORY[0x1E4FB2848] + 8)
    && v6 == *MEMORY[0x1E4FB2848]
    && v8 == *(double *)(MEMORY[0x1E4FB2848] + 24)
    && v7 == *(double *)(MEMORY[0x1E4FB2848] + 16))
  {
    ...
    if (v18)
    {
      uint64_t v19 = [(SKUINavigationBarSectionController *)self context];
      uint64_t v20 = [v19 clientContext];
      uint64_t v21 = SKUIUserInterfaceIdiom(v20);
...
- (void)_reloadButtonItem:(id)a3 withButtonViewElement:(id)a4
{
  ...
  if ([v6 updateType])
  {
    if ([v6 buttonViewType] == 2)
    {
      ...
      [(SKUINavigationBarButtonsController *)self _updateItemOfferButton:v7 withButtonViewElement:v6];
    }
    else
    {
      [(SKUINavigationBarButtonsController *)self _updateButtonItem:v8 withButtonViewElement:v6];
    }
  }
}
...
- (void)_updateButtonItem:(id)a3 withButtonViewElement:(id)a4
{
  ...
  if (v7)
  {
    ...
    double v9 = [(SKUINavigationBarButtonsController *)self _imageForImageViewElement:v7];
    [v12 setImage:v9];

    [(SKUINavigationBarButtonsController *)self _imageInsetsForImageViewElement:v7];
...
- (void)initWithNavigationBarViewElement:.cold.1()
{
  ...
  int v0 = 136446210;
  v1 = "-[SKUINavigationBarButtonsController initWithNavigationBarViewElement:]";
}
