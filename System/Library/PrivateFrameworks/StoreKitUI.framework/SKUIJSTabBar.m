...
- (SKUIJSTabBarItem)selectedTab
{
  ...
  id v4 = [(SKUIJSTabBar *)self _selectedTabBarItemForIndex:v8[3]];
...
- (void)_reloadTabBarItemsWithPreludeMainThreadWork:(id)a3
{
  ...
  id v15 = [SKUIJSTabBarItem alloc];
  long long v16 = [(SKUIJSTabBarItem *)v15 initWithAppContext:v10 navigationController:v28[5] tabBarItem:v14 owner:self];
...
void __60__SKUIJSTabBar__reloadTabBarItemsWithPreludeMainThreadWork___block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (!v5)
  {
    if ([v7 conformsToProtocol:&unk_1F1E3B9E8])
    {
  ...
  v12 = [[SKUIJSTabBarItem alloc] initWithAppContext:*(void *)(a1 + 40) navigationController:v5 tabBarItem:v13 owner:*(void *)(a1 + 32)];
