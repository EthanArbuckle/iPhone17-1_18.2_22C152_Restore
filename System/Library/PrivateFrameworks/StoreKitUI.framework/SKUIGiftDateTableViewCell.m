...
- (SKUIGiftDateTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v7)
  {
    ...
    v11 = [MEMORY[0x1E4FB1618] tableSeparatorColor];
    [(UIView *)v10 setBackgroundColor:v11];

    v12 = [(SKUIGiftDateTableViewCell *)v7 contentView];
    [v12 addSubview:v7->_bottomBorderView];

    v13 = (UIDatePicker *)objc_alloc_init(MEMORY[0x1E4FB16B0]);
    ...
    uint64_t v17 = *MEMORY[0x1E4FB27D8];
    [(UIDatePicker *)v7->_datePicker setMaximumContentSizeCategory:*MEMORY[0x1E4FB27D8]];
    ...
    v22 = [MEMORY[0x1E4FB1618] tableSeparatorColor];
...
- (void)setChecked:(BOOL)a3
{
  ...
  if (!checkmarkView)
  {
    ...
    id v6 = [MEMORY[0x1E4FB1818] imageNamed:@"GiftCheckmark" inBundle:v5];
    v7 = [(SKUIGiftDateTableViewCell *)self tintColor];
    v8 = [v6 _flatImageWithColor:v7];

    v9 = (UIImageView *)[objc_alloc(MEMORY[0x1E4FB1838]) initWithImage:v8 highlightedImage:0];
...
LABEL_6:
  ...
  v12 = [(SKUIGiftDateTableViewCell *)self _labelColor];
...
{
  id v10 = a3;
  id v4 = [(SKUIGiftDateTableViewCell *)self date];
  id v5 = v10;
  id v6 = v4;
  if (v4 != v10)
  {
...
{
  id v10 = a3;
  id v4 = [(SKUIGiftDateTableViewCell *)self label];
  if (v4 != v10 && ([v4 isEqualToString:v10] & 1) == 0)
  {
    ...
    if (v10)
    {
      if (!labelLabel)
      {
        id v6 = [(SKUIGiftDateTableViewCell *)self _newLabel];
  ...
  if (v4 != v16 && ([v4 isEqualToString:v16] & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!placeholderLabel)
      {
        ...
        v13 = [MEMORY[0x1E4FB1618] _placeholderTextColor];
...
- (void)layoutSubviews
{
  ...
  [(SKUIGiftDateTableViewCell *)&v68 layoutSubviews];
  ...
  if (checkmarkView)
  {
    ...
    BOOL v19 = [(SKUIGiftDateTableViewCell *)self leftToRight];
  ...
  if (labelLabel)
  {
    ...
    BOOL v32 = [(SKUIGiftDateTableViewCell *)self leftToRight];
  ...
  if (datePicker)
  {
    ...
    BOOL v47 = [(SKUIGiftDateTableViewCell *)self leftToRight];
...
LABEL_21:
  ...
  if (placeholderLabel)
  {
    ...
    *(float *)&double v54 = (v9 - v56) * 0.5;
    ...
    BOOL v58 = [(SKUIGiftDateTableViewCell *)self leftToRight];
    ...
    double v62 = v55;
LABEL_20:
    +[SKUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SKUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", v60, v61, v62, v43, v66, v67, v7, v9, *(void *)&v66, *(void *)&v67);
    v49 = v48;
    goto LABEL_21;
  }
LABEL_22:
  v63 = objc_msgSend(MEMORY[0x1E4FB1BA8], "mainScreen", *(void *)&v66, *(void *)&v67);
  [v63 scale];
  double v65 = 1.0 / v64;
...
- (id)_labelColor
{
  ...
  v2 = [MEMORY[0x1E4FB1618] _labelColor];
  }
...
{
  id v4 = a3;
  id v5 = [(SKUIGiftDateTableViewCell *)self giftConfiguration];
...
LABEL_6:
  ...
  uint64_t v9 = +[SKUIClientContext localizedStringForKey:v10 inBundles:0 inTable:@"Gifting"];
LABEL_10:
  v11 = (void *)v9;
...
- (id)_newLabel
{
  ...
  id v5 = [MEMORY[0x1E4FB08E0] systemFontOfSize:18.0];
  [v3 setFont:v5];

  double v6 = [(SKUIGiftDateTableViewCell *)self _labelColor];
  [v3 setTextColor:v6];
...
- (SKUIGiftDateTableViewCellDelegate)delegate
{
  ...
  return (SKUIGiftDateTableViewCellDelegate *)WeakRetained;
}
...
- (void)initWithStyle:reuseIdentifier:.cold.1()
{
  ...
  int v0 = 136446210;
  id v1 = "-[SKUIGiftDateTableViewCell initWithStyle:reuseIdentifier:]";
}
