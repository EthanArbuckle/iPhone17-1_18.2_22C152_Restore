...
- (SKUIFocusedTouchGestureRecognizer)initWithFocusedView:(id)a3 touchAllowance:(UIEdgeInsets)a4;
...
LABEL_5:
  v15.receiver = self;
  v15.super_class = (Class)SKUIFocusedTouchGestureRecognizer;
  v11 = [(SKUIFocusedTouchGestureRecognizer *)&v15 initWithTarget:0 action:0];
  v12 = v11;
  if (v11)
  {
    objc_storeStrong((id *)&v11->_focusedView, a3);
    v12->_touchAllowance.CGFloat top = top;
    v12->_touchAllowance.CGFloat left = left;
    v12->_touchAllowance.CGFloat bottom = bottom;
    v12->_touchAllowance.CGFloat right = right;
  }
  self = v12;
  v13 = self;
LABEL_10:
...
- (void)reset
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)SKUIFocusedTouchGestureRecognizer;
    ...
    if (v25)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v26; ++j)
        {
          ...
          [(SKUIFocusedTouchGestureRecognizer *)self ignoreTouch:*(void *)(*((void *)&v34 + 1) + 8 * j) forEvent:v32];
        }
...
LABEL_27:
    ...
    {
      v30 = (NSMutableSet *)[objc_alloc(MEMORY[0x1E4F1CA80]) initWithSet:v6];
