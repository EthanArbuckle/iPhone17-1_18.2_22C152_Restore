...
{
  v6.receiver = self;
  v6.super_class = (Class)_SKUIItemBrowseCellContentView;
  v3 = -[_SKUIItemBrowseCellContentView initWithFrame:](&v6, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
...
- (void)drawRect:(CGRect)a3
{
  ...
  {
    id v8 = [(SKUICellImageView *)self->_userRatingImageView image];
