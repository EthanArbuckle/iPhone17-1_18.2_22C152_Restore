...
- (SKUIRedeemPreflightOperation)initWithClientContext:(id)a3 redeemCode:(id)a4 forcesAuthentication:(BOOL)a5;
...
- (id)_initSKUIRedeemPreflightOperation
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUIRedeemPreflightOperation;
  v3 = [(SKUIRedeemPreflightOperation *)&v9 init];
  if (v3)
  {
    dispatch_queue_t v4 = dispatch_queue_create("com.apple.StoreKitUI.SKUIRedeemPreflightOperation", 0);
...
- (SKUIRedeemPreflightOperation)initWithClientContext:(id)a3 redeemCode:(id)a4 forcesAuthentication:(BOOL)a5
{
  id v9 = a3;
  id v10 = a4;
  v11 = [(SKUIRedeemPreflightOperation *)self _initSKUIRedeemPreflightOperation];
  v12 = (SKUIRedeemPreflightOperation *)v11;
  if (v11)
  {
...
uint64_t __55__SKUIRedeemPreflightOperation_loadsRedeemCodeMetadata__block_invoke(uint64_t result)
{
...
- (id)outputBlock
{
  ...
  char v9 = __Block_byref_object_copy__50;
...
- (SKUIRedeemConfiguration)redeemConfiguration
{
  ...
  return (SKUIRedeemConfiguration *)v3;
}

void __51__SKUIRedeemPreflightOperation_redeemConfiguration__block_invoke(uint64_t a1)
{
}
...
uint64_t __59__SKUIRedeemPreflightOperation_setLoadsRedeemCodeMetadata___block_invoke(uint64_t result)
{
...
void __55__SKUIRedeemPreflightOperation_setRedeemConfiguration___block_invoke(uint64_t a1)
{
}

- (void)main
{
  uint64_t v3 = objc_alloc_init(SKUIRedeemPreflightResult);
  ...
  if ([(SKUIRedeemPreflightOperation *)self forcesAuthentication])
  {
    ...
    uint64_t v5 = [(SKUIRedeemPreflightOperation *)self _authenticationContext];
    id v6 = [v5 requiredUniqueIdentifier];

    if (([v4 canPerformExtendedBiometricActionsForAccountIdentifier:v6] & 1) == 0)
    {
      dispatch_semaphore_t v7 = dispatch_semaphore_create(0);
      id v8 = objc_alloc(MEMORY[0x1E4FA8128]);
      char v9 = [(SKUIRedeemPreflightOperation *)self _authenticationContext];
      id v10 = (void *)[v8 initWithAuthenticationContext:v9];

      id v11 = [(SKUIRedeemPreflightOperation *)self redeemViewController];
  ...
  {
    uint64_t v13 = objc_alloc_init(SKUIReloadConfigurationOperation);
  ...
  if (![(SKUIRedeemPreflightResult *)v3 resultType]
    && [(SKUIRedeemPreflightOperation *)self loadsRedeemCodeMetadata]
    && self->_redeemCode)
  {
    v14 = [(SKUIRedeemPreflightResult *)v3 clientContext];
    v15 = [(SKUIRedeemPreflightOperation *)self _redeemCodeMetadataWithClientContext:v14];

    [(SKUIRedeemPreflightResult *)v3 setCodeMetadata:v15];
  }
  v16 = [(SKUIRedeemPreflightOperation *)self redeemConfiguration];
  if (v16 && ![(SKUIRedeemPreflightResult *)v3 resultType])
  {
    v17 = [SKUIRedeemConfiguration alloc];
    v18 = [v16 operationQueue];
    uint64_t v19 = [v16 category];
    v20 = [(SKUIRedeemPreflightResult *)v3 clientContext];
    v21 = [(SKUIRedeemConfiguration *)v17 initWithOperationQueue:v18 category:v19 clientContext:v20];
  ...
  uint64_t v25 = [(SKUIRedeemPreflightOperation *)self outputBlock];
  v26 = (void *)v25;
  if (v25) {
    (*(void (**)(uint64_t, SKUIRedeemPreflightResult *))(v25 + 16))(v25, v3);
  }
}
...
void __36__SKUIRedeemPreflightOperation_main__block_invoke_2(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v6)
  {
    uint64_t v5 = [[SKUIClientContext alloc] initWithConfigurationDictionary:v6];
...
- (id)_authenticationContext
{
  ...
  if (v3)
  {
    id v4 = (void *)[objc_alloc(MEMORY[0x1E4FA8260]) initWithAccount:v3];
    [v4 setPromptStyle:1];
    [v4 setShouldCreateNewSession:1];
  }
  else
  {
    id v4 = [MEMORY[0x1E4FA8260] contextForSignIn];
  }
...
- (id)_redeemCodeMetadataWithClientContext:(id)a3
{
  ...
  id v6 = [v4 URLBag];
  uint64_t v7 = *MEMORY[0x1E4FA8988];
  ...
  if (v24[5])
  {
    ...
    id v10 = [MEMORY[0x1E4FA8100] defaultStore];
    id v11 = [v10 activeAccount];

    v12 = (void *)[objc_alloc(MEMORY[0x1E4FA8130]) initWithAccount:v11];
    [v9 setAuthenticationContext:v12];
    id v13 = objc_alloc(MEMORY[0x1E4FA8310]);
    v14 = (void *)[v13 initWithURL:v24[5]];
    [v9 setRequestProperties:v14];
    id v15 = objc_alloc_init(MEMORY[0x1E4FB8850]);
    [v9 setDataProvider:v15];
    [v9 main];
    id v16 = objc_alloc(MEMORY[0x1E4FA8358]);
    v17 = [v15 output];
...
intptr_t __69__SKUIRedeemPreflightOperation__redeemCodeMetadataWithClientContext___block_invoke(void *a1, void *a2)
{
  if (a2)
  {
    ...
    id v9 = (void *)[v8 initWithName:*MEMORY[0x1E4FA8980] value:*(void *)(a1[4] + 280)];
    [v7 addObject:v9];
    [v5 setQueryItems:v7];
    uint64_t v10 = [v5 URL];
