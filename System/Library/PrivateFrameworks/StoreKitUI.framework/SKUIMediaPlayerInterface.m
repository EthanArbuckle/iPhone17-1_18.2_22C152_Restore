...
- (SKUIMediaPlayerInterface)init
{
  ...
  if (v3)
  {
    uint64_t v4 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:0 capacity:0];
    players = v3->_players;
    v3->_players = (NSMapTable *)v4;

    dispatch_queue_t v6 = dispatch_queue_create("com.apple.StoreKitUI.SKUIMediaPlayerInterface", 0);
    accessQueue = v3->_accessQueue;
    v3->_accessQueue = (OS_dispatch_queue *)v6;

    dispatch_queue_t v8 = dispatch_queue_create("com.apple.StoreKitUI.SKUIMediaPlayerInterface.dispatch", 0);
    dispatchQueue = v3->_dispatchQueue;
    v3->_dispatchQueue = (OS_dispatch_queue *)v8;

    dispatch_queue_t v10 = dispatch_queue_create("com.apple.StoreKitUI.SKUIMediaPlayerInterface.observers", 0);
    observerQueue = v3->_observerQueue;
    v3->_observerQueue = (OS_dispatch_queue *)v10;

    v12 = [MEMORY[0x1E4F28EB8] defaultCenter];
    v13 = (void *)SKUIMediaPlayerFramework();
    id v14 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemChangedNotification", v13);
    [v12 addObserver:v3 selector:sel__playerItemDidChangeNotification_ name:v14 object:0];
    v15 = (void *)SKUIMediaPlayerFramework();
    id v16 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemWillChangeNotification", v15);
    [v12 addObserver:v3 selector:sel__playerItemWillChangeNotification_ name:v16 object:0];
    v17 = (void *)SKUIMediaPlayerFramework();
    id v18 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemReadyToPlayNotification", v17);
    [v12 addObserver:v3 selector:sel__playerItemReady_ name:v18 object:0];
    v19 = (void *)SKUIMediaPlayerFramework();
    id v20 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerRateDidChangeNotification", v19);
    [v12 addObserver:v3 selector:sel__playerRateDidChangeNotification_ name:v20 object:0];
    v21 = (void *)SKUIMediaPlayerFramework();
    id v22 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerBufferingStateChangedNotification", v21);
    [v12 addObserver:v3 selector:sel__bufferingStateChangedNotification_ name:v22 object:0];
    v23 = (void *)SKUIMediaPlayerFramework();
    objc_msgSend(v12, "addObserver:selector:name:object:", v3, sel__playbackErrorNotification_, *(void *)SKUIWeakLinkedSymbolForString("MPAVControllerPlaybackErrorNotification", v23), 0);
  }
  return v3;
}
...
- (void)dealloc
{
  ...
  uint64_t v4 = (void *)SKUIMediaPlayerFramework();
  id v5 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemChangedNotification", v4);
  [v3 removeObserver:self name:v5 object:0];
  dispatch_queue_t v6 = (void *)SKUIMediaPlayerFramework();
  id v7 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemWillChangeNotification", v6);
  [v3 removeObserver:self name:v7 object:0];
  dispatch_queue_t v8 = (void *)SKUIMediaPlayerFramework();
  id v9 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemReadyToPlayNotification", v8);
  [v3 removeObserver:self name:v9 object:0];
  dispatch_queue_t v10 = (void *)SKUIMediaPlayerFramework();
  id v11 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerRateDidChangeNotification", v10);
  [v3 removeObserver:self name:v11 object:0];
  v12 = (void *)SKUIMediaPlayerFramework();
  id v13 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerBufferingStateChangedNotification", v12);
  [v3 removeObserver:self name:v13 object:0];
  id v14 = (void *)SKUIMediaPlayerFramework();
  objc_msgSend(v3, "removeObserver:name:object:", self, *(void *)SKUIWeakLinkedSymbolForString("MPAVControllerPlaybackErrorNotification", v14), 0);
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        dispatch_queue_t v10 = -[NSMapTable objectForKey:](self->_players, "objectForKey:", *(void *)(*((void *)&v16 + 1) + 8 * i), (void)v16);
        id v11 = [v10 playerItem];
        v12 = [v10 player];
        id v13 = [v12 currentItem];

        if (v13
          && +[SKUIMediaPlayerInterface identifierMatches:v4 item:v11])
        {
...
+ (BOOL)identifierMatches:(id)a3 item:(id)a4
{
  ...
  if (v7)
  {
    dispatch_queue_t v10 = [v8 storeID];
    if (v10)
    {
      id v4 = [v9 storeID];
...
- (BOOL)identifierIsOnDeck:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (onDeckItem)
    {
      uint64_t v6 = [(SKUIMediaPlayerItemStatus *)onDeckItem itemIdentifier];
...
- (void)notifyWillChangeToItemWithItemIdentifer:(id)a3
{
  ...
  if (v6)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        dispatch_queue_t v10 = -[NSMapTable objectForKey:](self->_players, "objectForKey:", *(void *)(*((void *)&v18 + 1) + 8 * v9), (void)v18);
        char v11 = [v10 currentItem];
        v12 = [v10 playerItem];
        if (v12
          && +[SKUIMediaPlayerInterface identifierMatches:v4 item:v12])
        {
  ...
  BOOL v14 = [(SKUIMediaPlayerItemStatus *)onDeckItem itemIdentifier];
...
LABEL_16:
    long long v16 = (SKUIMediaPlayerItemStatus *)objc_opt_new();
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        dispatch_queue_t v10 = -[NSMapTable objectForKey:](self->_players, "objectForKey:", *(void *)(*((void *)&v15 + 1) + 8 * i), (void)v15);
...
- (void)togglePlayStateForItemWithIdentifier:(id)a3
{
  id v3 = [(SKUIMediaPlayerInterface *)self playerForItemWithIdentifier:a3];
  if (v3)
  {
    id v8 = v3;
    id v4 = [v3 player];
...
{
  id v4 = a3;
  int v5 = (void *)SKUIMediaPlayerFramework();
  id v6 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerNewStateParameter", v5);
  uint64_t v7 = [v4 userInfo];
  id v8 = [v7 objectForKey:v6];

  uint64_t v9 = [v8 unsignedIntegerValue];
  id v10 = [(SKUIMediaPlayerInterface *)self _playerForNotification:v4];
...
{
  id v4 = a3;
  id v7 = [(SKUIMediaPlayerInterface *)self _playerForNotification:v4];
  uint64_t v5 = [(SKUIMediaPlayerInterface *)self _itemFromNotification:v4];
...
- (void)_playerItemDidChangeNotification:(id)a3
{
  id v6 = [(SKUIMediaPlayerInterface *)self _playerForNotification:a3];
  id v4 = [v6 player];
...
{
  id v4 = a3;
  id v9 = [(SKUIMediaPlayerInterface *)self _playerForNotification:v4];
  uint64_t v5 = [(SKUIMediaPlayerInterface *)self _itemFromNotification:v4];
...
- (void)_playerRateDidChangeNotification:(id)a3
{
  id v17 = [(SKUIMediaPlayerInterface *)self _playerForNotification:a3];
  id v4 = [v17 player];
  uint64_t v5 = [v4 currentItem];
...
- (id)_itemFromNotification:(id)a3
{
  ...
  id v5 = *(id *)SKUIWeakLinkedSymbolForString("MPAVControllerItemParameter", v4);
  uint64_t v6 = [v3 userInfo];

  id v7 = [v6 objectForKey:v5];

  uint64_t v8 = SKUIMediaPlayerFramework();
...
- (id)_playerForNotification:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (!v7)
    {
      id v7 = objc_alloc_init(SKUIMediaPlayer);
...
- (void)_createPeriodicTimeObserverIfNeeded:(id)a3
{
  ...
  if (v6 > 0.00000011921)
  {
    ...
    if (!v8)
    {
      ...
      uint64_t v12 = __64__SKUIMediaPlayerInterface__createPeriodicTimeObserverIfNeeded___block_invoke;
      uint64_t v13 = &unk_1E6429578;
...
- (void)_itemDidChange:(id)a3 incomingItem:(id)a4
{
  ...
  if ((id)v7 != v6)
  {
    ...
    uint64_t v9 = SKUIMediaPlayerFramework();
...
LABEL_26:
      ...
      long long v22 = objc_alloc_init(SKUIMediaPlayerItemStatus);
      long long v27 = v12;
      if (v14)
      {
...
- (void)_registerForNotificationsForCurrentItem:(id)a3
{
  if (a3)
  {
    ...
    objc_msgSend(v7, "addObserver:selector:name:object:", self, sel__currentItemDurationAvailableNotification_, *(void *)SKUIWeakLinkedSymbolForString("MPAVItemDurationAvailableNotification", v6), v5);
  }
}
...
- (void)_unregisterForNotificationsForCurrentItem:(id)a3
{
  if (a3)
  {
    ...
    id v7 = [v4 defaultCenter];
    id v6 = (void *)SKUIMediaPlayerFramework();
    objc_msgSend(v7, "removeObserver:name:object:", self, *(void *)SKUIWeakLinkedSymbolForString("MPAVItemDurationAvailableNotification", v6), v5);
  }
}
...
- (void)_updateTimeValuesUsingItemTime:(BOOL)a3 player:(id)a4 item:(id)a5
{
  ...
  if (v17 <= 2.22044605e-16)
  {
    ...
    if ([v9 isAssetLoaded])
    {
      ...
      long long v22 = (void *)SKUICoreMediaFramework();
      long long v23 = (double (*)(long long *))SKUIWeakLinkedSymbolForString("CMTimeGetSeconds", v22);
      if (!v23) {
        goto LABEL_13;
      }
      long long v27 = v25;
...
- (void)init
{
  ...
  int v0 = 136446210;
  id v1 = "-[SKUIMediaPlayerInterface init]";
}
