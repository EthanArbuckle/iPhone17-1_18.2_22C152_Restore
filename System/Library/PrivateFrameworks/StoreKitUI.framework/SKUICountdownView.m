...
- (SKUICountdownView)initWithCountdown:(id)a3 clientContext:(id)a4;
...
- (SKUICountdownView)initWithCountdown:(id)a3 clientContext:(id)a4
{
  ...
  v33.receiver = self;
  v33.super_class = (Class)SKUICountdownView;
  v9 = [(SKUICountdownView *)&v33 init];
  v10 = v9;
  if (v9)
  {
    ...
    v16 = [(SKUICountdown *)v10->_countdown numberFormat];
    if (v16)
    {
    ...
    else
    {
      ...
      v17 = +[SKUIClientContext localizedStringForKey:@"COUNTDOWN_NUMBER_FORMAT" inBundles:0];
      }
    ...
    if (([*p_countdown isLoaded] & 1) == 0)
    {
      ...
      if (v18)
      {
        ...
        id v19 = objc_alloc(MEMORY[0x1E4FA8338]);
        v20 = [*p_countdown URL];
        ...
        v29 = __53__SKUICountdownView_initWithCountdown_clientContext___block_invoke;
        v30 = &unk_1E6424020;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUICountdownView;
  ...
  if (v4 != v12)
  {
    ...
    if (v12)
    {
      if (!imageView)
      {
        ...
        v9 = self->_imageView;
        id v10 = [(SKUICountdownView *)self backgroundColor];
    ...
    uint64_t v5 = [(SKUICountdownView *)self setNeedsLayout];
  }
...
- (void)start
{
  if ([(SKUICountdown *)self->_countdown isLoaded])
  {
    ...
    {
      uint64_t v4 = [(SKUICountdown *)self->_countdown rate];
    ...
    if (!timerTarget)
    {
      ...
      id v6 = objc_alloc_init(SKUICountdownViewTimerTarget);
    ...
    objc_msgSend(MEMORY[0x1E4F1CB00], "timerWithTimeInterval:target:selector:userInfo:repeats:", timerTarget, sel_action, 0, 1, v3, v12, v13, v14, v15);
    v9 = (NSTimer *)objc_claimAutoreleasedReturnValue();
    timer = self->_timer;
    self->_timer = v9;

    id v11 = [MEMORY[0x1E4F1CAC0] mainRunLoop];
    [v11 addTimer:self->_timer forMode:*MEMORY[0x1E4F1C4B0]];
  }
}
...
{
  v5.receiver = self;
  v5.super_class = (Class)SKUICountdownView;
  -[SKUICountdownView setFrame:](&v5, sel_setFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
...
- (void)layoutSubviews
{
  ...
  v181.receiver = self;
  v181.super_class = (Class)SKUICountdownView;
  ...
  if (self->_imageView)
  {
    -[SKUICountdownView sendSubviewToBack:](self, "sendSubviewToBack:");
    -[UIImageView setFrame:](self->_imageView, "setFrame:", v4, v6, v8, v10);
  }
  if ([(SKUICountdown *)self->_countdown isLoaded])
  {
    id v11 = [(SKUICountdown *)self->_countdown artworkProvider];

    if (v11)
    {
      uint64_t v12 = [(SKUICountdown *)self->_countdown artworkProvider];
    ...
    int64_t v18 = [(SKUICountdown *)self->_countdown type];
    ...
    if (v18)
    {
      ...
      BOOL v20 = [(SKUICountdown *)self->_countdown isFlapped];
      ...
      if (v20)
      {
        ...
        v157 = [MEMORY[0x1E4F1C978] arrayWithObjects:v187 count:4];
...
LABEL_116:
      ...
      v183[3] = v58;
      v59 = [MEMORY[0x1E4F1C978] arrayWithObjects:v183 count:4];
      if (!v57) {
      ...
      v182[3] = v67;
      v68 = [MEMORY[0x1E4F1C978] arrayWithObjects:v182 count:4];
      if (dateLabelSecond)
      {
        if (dateLabelMinute) {
          goto LABEL_68;
...
- (id)_newDateLabel
{
  ...
  double v4 = [(SKUICountdown *)self->_countdown fontColor];
  [v3 setTextColor:v4];
...
- (id)_newFlapLabelWithPosition:(int64_t)a3
{
  double v5 = [(SKUICountdown *)self->_countdown flapTopColor];
  double v6 = [(SKUICountdown *)self->_countdown flapBottomColor];
  double v7 = [[SKUICountdownFlapView alloc] initWithPosition:a3 flapTopColor:v5 flapBottomColor:v6];
  double v8 = [MEMORY[0x1E4FB1618] clearColor];
  [(SKUICountdownFlapView *)v7 setBackgroundColor:v8];

  double v9 = [(SKUICountdown *)self->_countdown fontColor];
  [(SKUICountdownFlapView *)v7 setTextColor:v9];
...
{
  id v3 = objc_alloc_init(MEMORY[0x1E4FB1930]);
  double v4 = [(SKUICountdown *)self->_countdown flapTopColor];
  if (v4)
  {
    [v3 setTextColor:v4];
  }
...
- (void)_reload
{
  if ([(SKUICountdown *)self->_countdown isLoaded])
  {
    int64_t v3 = [(SKUICountdown *)self->_countdown type];
    countdowuint64_t n = self->_countdown;
    if (v3)
    {
      if ([(SKUICountdown *)countdown type] == 1)
      {
        ...
        [(SKUICountdownView *)v5 _reloadDateDescriptions:v6];
      }
    }
...
- (void)_reloadNumber
{
  if (!self->_numberLabel)
  {
    ...
    uint64_t v6 = [(SKUICountdown *)self->_countdown fontColor];
    if (v6)
    {
  ...
  id v11 = objc_msgSend(NSNumber, "numberWithLongLong:", -[SKUICountdownView _currentValue](self, "_currentValue"));
...
- (void)_reloadNumberFlapped
{
  ...
  if (!self->_numberFlapLabels)
  {
    ...
    [v7 removeObject:&stru_1F1C879E8];
    ...
    if (v10)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          id v15 = [(SKUICountdownView *)self _newNumberSeparatorLabel];
          [v15 setText:v14];
          [v15 sizeToFit];
          [(SKUICountdownView *)self addSubview:v15];
    ...
    double v16 = [MEMORY[0x1E4F28B88] characterSetWithCharactersInString:@"#"];
        ...
        for (uint64_t j = 0; j != v23; ++j)
        {
          ...
          if ([v26 length])
          {
            ...
            do
            {
              ...
              id v30 = [(SKUICountdownView *)self _newFlapLabelWithPosition:v29];
  ...
  uint64_t v31 = objc_msgSend(NSString, "stringWithFormat:", @"%lld", -[SKUICountdownView _currentValue](self, "_currentValue"));
...
- (void)_reloadDateDescriptions:(BOOL)a3
{
  ...
  uint64_t v38 = 0;
  uint64_t v39 = 0;
  [(SKUICountdownView *)self _currentRemainingDays:(char *)&v40 + 8 hours:&v40 minutes:&v39 seconds:&v38];
  char v5 = !v3;
  dateDescriptionLabelDay = self->_dateDescriptionLabelDay;
  if (*((void *)&v40 + 1)) {
    BOOL v7 = 1;
  ...
  if (v7)
  {
    ...
    double v8 = [(SKUICountdownView *)self _newDateDescriptionLabel];
    ...
    uint64_t v13 = +[SKUIClientContext localizedStringForKey:@"COUNTDOWN_DAYS" inBundles:0];
    }
...
LABEL_14:
  ...
  if (v14)
  {
    ...
    double v16 = [(SKUICountdownView *)self _newDateDescriptionLabel];
    ...
    if (v19) {
      [(SKUIClientContext *)v19 localizedStringForKey:@"COUNTDOWN_HOURS"];
    }
    else {
    id v21 = +[SKUIClientContext localizedStringForKey:@"COUNTDOWN_HOURS" inBundles:0];
    }
...
LABEL_26:
  ...
  if (v22)
  {
    ...
    uint64_t v24 = [(SKUICountdownView *)self _newDateDescriptionLabel];
    ...
    if (v27) {
      [(SKUIClientContext *)v27 localizedStringForKey:@"COUNTDOWN_MINUTES"];
    }
    else {
    uint64_t v29 = +[SKUIClientContext localizedStringForKey:@"COUNTDOWN_MINUTES" inBundles:0];
    }
...
LABEL_38:
  ...
  if (v30)
  {
    ...
    uint64_t v32 = [(SKUICountdownView *)self _newDateDescriptionLabel];
    ...
    if (v35) {
      [(SKUIClientContext *)v35 localizedStringForKey:@"COUNTDOWN_SECONDS"];
    }
    else {
    v37 = +[SKUIClientContext localizedStringForKey:@"COUNTDOWN_SECONDS" inBundles:0];
    }
...
- (void)_reloadTime
{
  ...
  uint64_t v27 = 0;
  uint64_t v28 = 0;
  [(SKUICountdownView *)self _currentRemainingDays:(char *)&v29 + 8 hours:&v29 minutes:&v28 seconds:&v27];
  ...
  if (*((void *)&v29 + 1))
  {
    if (!dateLabelDay)
    {
      char v5 = [(SKUICountdownView *)self _newDateLabel];
  ...
  else
  {
    if (!dateLabelHour)
    {
      uint64_t v11 = [(SKUICountdownView *)self _newDateLabel];
  ...
  if (v29 != 0 || v28)
  {
    if (!dateLabelMinute)
    {
      int64_t v18 = [(SKUICountdownView *)self _newDateLabel];
  ...
  if (v29 != 0 || v28 || v27)
  {
    if (!dateLabelSecond)
    {
      uint64_t v24 = [(SKUICountdownView *)self _newDateLabel];
...
- (void)_reloadTimeFlapped
{
  ...
  if (!dateFlapLabels)
  {
    ...
    do
    {
      ...
      id v8 = [(SKUICountdownView *)self _newFlapLabelWithPosition:0];
      [(SKUICountdownView *)self addSubview:v8];
      [v7 addObject:v8];

      id v9 = [(SKUICountdownView *)self _newFlapLabelWithPosition:2];
...
- (void)_reloadFontSizes
{
  ...
  if (v28)
  {
    ...
    do
    {
      for (uint64_t n = 0; n != v29; ++n)
      {
        ...
        uint64_t v34 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:roundf(v33)];
        [v32 setFont:v34];
  ...
  if (!dateLabelMinute)
  {
    long long v40 = [MEMORY[0x1E4F1CA98] null];
  }
  v113[2] = v40;
  dateLabelSecond = self->_dateLabelSecond;
  ...
  v113[3] = v42;
  uint64_t v43 = [MEMORY[0x1E4F1C978] arrayWithObjects:v113 count:4];
  if (dateLabelSecond)
  {
    if (dateLabelMinute) {
      goto LABEL_48;
...
LABEL_50:
  ...
  if (v44)
  {
    ...
    do
    {
      for (iuint64_t i = 0; ii != v45; ++ii)
      {
        ...
        long long v49 = [MEMORY[0x1E4F1CA98] null];

        if (v48 != v49)
        {
          long long v50 = [v48 text];
          float v51 = self->_factor * 28.0;
          long long v52 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:roundf(v51)];
          [v48 setFont:v52];
  ...
  if (!dateDescriptionLabelHour)
  {
    v56 = objc_msgSend(MEMORY[0x1E4F1CA98], "null", v54);
  }
  v111[1] = v56;
  dateDescriptionLabelMinute = self->_dateDescriptionLabelMinute;
  ...
  v111[3] = v60;
  uint64_t v61 = objc_msgSend(MEMORY[0x1E4F1C978], "arrayWithObjects:count:", v111, 4, objb);
  if (dateDescriptionLabelSecond)
  {
    if (dateDescriptionLabelMinute) {
      goto LABEL_69;
...
LABEL_70:
    ...
    do
    {
      for (juint64_t j = 0; jj != v64; ++jj)
      {
        ...
        if (v67 != v68)
        {
          ...
          unint64_t v70 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:roundf(v69)];
          [v67 setFont:v70];
  ...
  v73 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:roundf(v72)];
...
- (int64_t)_currentValue
{
  double v3 = (double)[(SKUICountdown *)self->_countdown initialValue];
  uint64_t v4 = [(SKUICountdown *)self->_countdown startDate];
  [v4 timeIntervalSinceNow];
  double v6 = v5;
  double v7 = (double)[(SKUICountdown *)self->_countdown rate];
  int64_t v8 = [(SKUICountdown *)self->_countdown initialValue];
  int64_t v9 = [(SKUICountdown *)self->_countdown finalValue];
  double v10 = -1.0;
  if (v8 < v9) {
    double v10 = 1.0;
  }
...
- (void)_currentRemainingDays:(int64_t *)a3 hours:(int64_t *)a4 minutes:(int64_t *)a5 seconds:(int64_t *)a6
{
  double v10 = [(SKUICountdown *)self->_countdown endDate];
...
- (void)_setCountdownWithResponse:(id)a3 error:(id)a4
{
  ...
  {
    [(SKUICountdown *)self->_countdown updateWithDictionary:v5];
