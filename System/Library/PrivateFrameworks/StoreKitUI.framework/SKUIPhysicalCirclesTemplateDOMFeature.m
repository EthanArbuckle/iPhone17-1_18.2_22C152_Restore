...
+ (id)makeFeatureJSObjectForFeature:(id)a3
{
  ...
  id v5 = [v3 appContext];
  uint64_t v6 = [(SKUIJSPhysicalCirclesTemplate *)v4 initWithAppContext:v5 DOMFeature:v3];
...
{
  id v8 = a3;
  id v4 = [(SKUIPhysicalCirclesTemplateDOMFeature *)self delegate];
...
- (SKUIPhysicalCirclesTemplateDelegate)delegate
{
  ...
  return (SKUIPhysicalCirclesTemplateDelegate *)WeakRetained;
}
