...
- (SKUICardViewElementCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)SKUICardViewElementCollectionViewCell;
  v8 = -[SKUIViewReuseCollectionViewCell initWithFrame:](&v12, sel_initWithFrame_, x, y, width, height);
  if (v8)
  {
    uint64_t v9 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:0 capacity:0];
    viewElements = v8->_viewElements;
    v8->_viewElements = (NSMapTable *)v9;
  }
  return v8;
}
...
void __90__SKUICardViewElementCollectionViewCell_artworkBoundingSizeWithViewElement_width_context___block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  id v10 = a2;
  ...
  if (v5 != 152)
  {
    if (v5 == 62)
    {
      +[SKUIHorizontalListView preferredSizeForViewElement:v10 context:*(void *)(a1 + 32)];
...
- (void)setArtworkBoundingSize:(id)a3
{
  ...
  if ((id)artworkBoundingSize != v4)
  {
    ...
    {
      double v6 = (SKUISizeValue *)[v8 copy];
      double v7 = self->_artworkBoundingSize;
      self->_uint64_t artworkBoundingSize = v6;

      uint64_t artworkBoundingSize = [(SKUICardViewElementCollectionViewCell *)self setNeedsLayout];
      id v4 = v8;
    }
  }

  MEMORY[0x1F41817F8](artworkBoundingSize, v4);
}
...
- (UIView)adCardBackgroundView
{
  ...
  if (!adCardBackgroundView)
  {
    ...
    id v11 = [MEMORY[0x1E4FB1618] colorWithHue:0.57292 saturation:0.06531 brightness:0.96078 alpha:1.0];
...
- (CALayer)compactAdCardHairlineLayer
{
  ...
  if (!compactAdCardHairlineLayer)
  {
    ...
    id v6 = [MEMORY[0x1E4FB1618] colorWithHue:0.57292 saturation:0.06531 brightness:0.96078 alpha:1.0];
...
void __88__SKUICardViewElementCollectionViewCell_prefetchResourcesForViewElement_reason_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 == 49)
  {
    if (*(unsigned char *)(a1 + 56))
    {
      ...
      objc_msgSend(v8, "setLayerShadowOffset:", *MEMORY[0x1E4F1DB30], *(double *)(MEMORY[0x1E4F1DB30] + 8));
  ...
  {
    char v4 = +[SKUIHorizontalLockupView prefetchResourcesForViewElement:v13 reason:*(void *)(a1 + 48) context:*(void *)(a1 + 32)];
    if (*(unsigned char *)(a1 + 56))
    {
      ...
      if (v5)
      {
        ...
        objc_msgSend(v7, "setLayerShadowOffset:", *MEMORY[0x1E4F1DB30], *(double *)(MEMORY[0x1E4F1DB30] + 8));
      }
    }
  }
  else
...
void __77__SKUICardViewElementCollectionViewCell_preferredSizeForViewElement_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3 <= 65)
  {
    ...
    else
    {
      ...
      +[SKUIHorizontalListView preferredSizeForViewElement:v12 context:*(void *)(a1 + 32)];
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v7 = a5;
  id v8 = a3;
  uint64_t v9 = +[SKUICardLayout layoutWithCardViewElement:v8 context:v7];
...
LABEL_25:
  ...
  if (v3 <= 130)
  {
    ...
    else
    {
      ...
      id v7 = SKUIHorizontalLockupView;
    }
    goto LABEL_25;
  }
  if (v3 == 131)
  {
    id v7 = SKUIStackListCollectionViewCell;
    goto LABEL_25;
  }
  BOOL v4 = v3 == 138;
  double v5 = v8;
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  double v54 = a3;
  uint64_t v55 = 0;
  uint64_t v9 = +[SKUICardLayout layoutWithCardViewElement:v7 context:v8];
  [v9 horizontalContentInset];
  double v11 = v10;
  uint64_t v45 = 0;
  v46 = (double *)&v45;
  ...
  v48 = &unk_1C1D0F257;
  long long v49 = *MEMORY[0x1E4F1DB30];
  long long v29 = v49;
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  uint64_t v11 = +[SKUICardLayout layoutWithCardViewElement:v9 context:v10];
  layout = self->_layout;
  self->_layout = v11;
  ...
  int64_t v14 = [(SKUICardLayout *)self->_layout layoutStyle];
  ...
  if (v14 == 1)
  {
    ...
    {
      BOOL v17 = (UIView *)objc_alloc_init(MEMORY[0x1E4FB1EB0]);
      ...
      double v20 = [(SKUICardViewElementCollectionViewCell *)self contentView];
  ...
  int v22 = [v9 isAdCard];
  double v23 = [(SKUICardViewElementCollectionViewCell *)self adCardBackgroundView];
  double v24 = v23;
  if (v22)
  {
    [v23 setHidden:0];

    double v25 = [(SKUICardViewElementCollectionViewCell *)self compactAdCardHairlineLayer];
    double v26 = v25;
    uint64_t v27 = 0;
  }
  else
  ...
  backgroundViewWithParalladouble x = self->_backgroundViewWithParallax;
  self->_backgroundViewWithParalladouble x = 0;
  ...
  uint64_t v55 = __77__SKUICardViewElementCollectionViewCell_reloadWithViewElement_width_context___block_invoke;
  v56 = &unk_1E64267F0;
  id v32 = v9;
  id v57 = v32;
  double v61 = v29;
  ...
  BOOL v62 = v16;
  v60 = &v63;
  [(SKUIViewReuseCollectionViewCell *)self modifyUsingBlock:&v53];
  ...
  if (self->_isActivityCard)
  {
    ...
    uint64_t v35 = SKUIUserInterfaceIdiom(v34);

    if (v35 == 1)
    {
      double v36 = [(SKUICardViewElement *)self->_cardElement style];
      ...
      if (v37)
      {
        ...
        double v44 = v43;
        double v46 = v45;
        uint64_t v47 = (void *)MEMORY[0x1E4FB14C0];
        ...
        v51 = [(SKUICardViewElementCollectionViewCell *)self layer];
        [v51 setMasksToBounds:1];

        uint64_t v52 = [(SKUICardViewElementCollectionViewCell *)self layer];
        [v52 setMask:v38];
      }
    }
  }
        ...
        if (v10 > 61)
        {
          if (v10 <= 137)
          {
            if (v10 == 62)
            {
              ...
              {
                +[SKUIHorizontalListView preferredSizeForViewElement:v9 context:*(void *)(a1 + 40)];
                if (v23 != v6 || v22 != v7) {
...
LABEL_68:
        ...
        else
        {
          ...
          if (v10 == 7)
          {
            ...
            BOOL v17 = [[SKUIBackgroundImageWrapperForHorizontalLockup alloc] initWithImage:v16];
            ...
            *(void *)(v18 + 832) = v17;
            ...
            id v13 = v16;
            if ([v13 conformsToProtocol:&unk_1F1DA49A8]) {
...
LABEL_45:
        ...
        if (v12)
        {
          ...
          if (!v32)
          {
            uint64_t v33 = [objc_alloc(MEMORY[0x1E4F28D30]) initWithOptions:517 capacity:1];
...
- (BOOL)updateWithItemState:(id)a3 context:(id)a4 animated:(BOOL)a5
{
  ...
  uint64_t v25 = 0x2020000000;
  char v26 = 0;
  uint64_t v10 = [(SKUIViewElement *)self->_cardElement flattenedChildren];
  uint64_t v11 = [(SKUIViewReuseCollectionViewCell *)self allExistingViews];
...
void __78__SKUICardViewElementCollectionViewCell_updateWithItemState_context_animated___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
...
{
  id v4 = a3;
  uint64_t v5 = [(SKUIViewElement *)self->_cardElement flattenedChildren];
  double v6 = [(SKUIViewReuseCollectionViewCell *)self allExistingViews];
  uint64_t v15 = 0;
  BOOL v16 = &v15;
  uint64_t v17 = 0x3032000000;
  id v18 = __Block_byref_object_copy__34;
  id v19 = __Block_byref_object_dispose__34;
  id v20 = 0;
...
void __66__SKUICardViewElementCollectionViewCell_viewForElementIdentifier___block_invoke(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  uint64_t v7 = [a2 elementType];
  if (v7 == 66 || v7 == 62)
  {
...
- (void)applyLayoutAttributes:(id)a3
{
  ...
  {
    id v4 = [(SKUICardViewElementCollectionViewCell *)self adCardBackgroundView];
    char v5 = [v4 isHidden];
    ...
    if ((v5 & 1) == 0)
    {
      ...
      uint64_t v8 = [(SKUICardViewElementCollectionViewCell *)self layer];
...
- (void)layoutSubviews
{
  ...
  BOOL v3 = [(SKUICardViewElementCollectionViewCell *)self backgroundColor];
  id v4 = [(SKUIViewElement *)self->_cardElement firstChildForElementType:7];

  int64_t v94 = [(SKUICardViewElement *)self->_cardElement cardType];
  v95 = v4;
  if (v4)
  {
  ...
  objc_super v6 = [(SKUICardViewElementCollectionViewCell *)self contentView];
  [v6 bounds];
  double v8 = v7;
  double v10 = v9;
  double v12 = v11;
  ...
  {
    unint64_t v24 = SKUIColorSchemeStyleForColor(v3);
    if (v24 <= 3)
    {
      uint64_t v25 = SKUIColorByAdjustingBrightness(v3, flt_1C1CCBAF0[v24]);
  ...
  id v123 = 0;
  long long v28 = [(SKUIViewReuseCollectionViewCell *)self allExistingViews];
  ...
  *(double *)&v121[3] = v18;
  ...
  v111[2] = 0x2020000000;
  char v112 = 0;
  long long v30 = [(SKUICardViewElementCollectionViewCell *)self adCardBackgroundView];
  [v30 removeFromSuperview];

  long long v31 = [(SKUICardViewElementCollectionViewCell *)self compactAdCardHairlineLayer];
  ...
  if ([(SKUICardViewElement *)self->_cardElement isAdCard])
  {
    long long v34 = [(SKUICardViewElementCollectionViewCell *)self traitCollection];
    ...
    if (v35 == 1) {
      ...
      double v40 = [(SKUICardViewElementCollectionViewCell *)self layer];
      [v40 setBackgroundColor:v39];

      double v41 = [(SKUICardViewElementCollectionViewCell *)self contentView];
      double v42 = [v41 layer];
      uint64_t v43 = [(SKUICardViewElementCollectionViewCell *)self compactAdCardHairlineLayer];
      [v42 addSublayer:v43];

      double v44 = [(SKUICardViewElementCollectionViewCell *)self contentView];
      double v45 = [v44 layer];
      [v45 frame];
      double Width = CGRectGetWidth(v125);
      long long v47 = [MEMORY[0x1E4FB1BA8] mainScreen];
      [v47 scale];
      double v49 = v48;

      long long v50 = [(SKUICardViewElementCollectionViewCell *)self contentView];
      v51 = [v50 layer];
      [v51 frame];
      double MaxY = CGRectGetMaxY(v126);
      v127.origin.double x = *(CGFloat *)MEMORY[0x1E4F1DB28];
      v127.origin.double y = *(CGFloat *)(MEMORY[0x1E4F1DB28] + 8);
      CGFloat v53 = 1.0 / v49;
      v127.size.double width = Width;
      v127.size.double height = v53;
      double Height = CGRectGetHeight(v127);

      id v55 = [(SKUICardViewElementCollectionViewCell *)self compactAdCardHairlineLayer];
      ...
      double v61 = [(SKUICardViewElementCollectionViewCell *)self adCardBackgroundView];
      [v60 addSubview:v61];

      BOOL v62 = [(SKUICardViewElementCollectionViewCell *)self contentView];
      uint64_t v63 = [(SKUICardViewElementCollectionViewCell *)self adCardBackgroundView];
      [v62 sendSubviewToBack:v63];

      v128.origin.double x = v32;
      v128.origin.double y = v18;
      v128.size.double width = v20 + v27 * -2.0;
  ...
  if (v95 && v116[5] && v94 != 2)
  {
    ...
    v131.size.double width = v33;
    v131.size.double height = v22;
...
{
  id v51 = a2;
  objc_super v6 = (double *)MEMORY[0x1E4F1DB28];
  ...
  double v17 = [v8 style];
  unint64_t v18 = SKUIViewElementAlignmentForStyle(v17);
...
LABEL_29:
  ...
  *(CGFloat *)(*(void *)(*(void *)(a1 + 88) + 8) + 24) = CGRectGetMaxY(v59);
  ...
  {
    uint64_t v37 = [MEMORY[0x1E4FB1618] clearColor];
...
- (BOOL)canPerformAction:(SEL)a3 withSender:(id)a4
{
  ...
  else
  {
    v9.receiver = self;
    v9.super_class = (Class)SKUICardViewElementCollectionViewCell;
    BOOL v7 = [(SKUICardViewElementCollectionViewCell *)&v9 canPerformAction:a3 withSender:v6];
  }
...
- (NSString)lineItem
{
  if ([(SKUICardViewElement *)self->_cardElement isAdCard])
  {
    id v3 = [(SKUICardViewElement *)self->_cardElement attributes];
...
+ (double)_defaultWidthForLockupWithContext:(id)a3
{
  ...
  uint64_t v7 = SKUIUserInterfaceIdiom(v6);
  if (v7 == 1)
  {
    BOOL v8 = v5 < 500.0;
    objc_super v9 = (double *)&unk_1C1CCBAE0;
    return v9[v8];
  }
  if (v5 > 500.0) {
    return 284.0;
  ...
  {
    BOOL v8 = v5 > 320.0;
    objc_super v9 = (double *)&unk_1C1CCBAD0;
    return v9[v8];
  }
  return 364.0;
}
...
{
  id v7 = a3;
  double v4 = SKUICollectionViewForView(self);
