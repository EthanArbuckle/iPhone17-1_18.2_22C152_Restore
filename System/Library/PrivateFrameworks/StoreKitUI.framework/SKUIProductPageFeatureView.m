...
- (void)setSubtitle:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [(SKUIProductPageFeatureView *)self subtitle];
  v6 = v5;
  if (v5 != v4 && ([v5 isEqualToString:v4] & 1) == 0)
  {
    ...
    if (v7)
    {
      ...
      if (!v22)
      {
        v23 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.6];
      }
      v28[1] = v23;
      ...
      v26 = (void *)[objc_alloc(MEMORY[0x1E4F28B18]) initWithString:v4 attributes:v24];
...
{
  id v18 = a3;
  id v4 = [(SKUIProductPageFeatureView *)self title];
