...
- (SKUIReviewList)initWithReviewListDictionary:(id)a3
{
  ...
  v25.receiver = self;
  v25.super_class = (Class)SKUIReviewList;
...
- (NSURL)writeReviewURL
{
  ...
  if (objc_opt_isKindOfClass())
  {
    float v3 = [MEMORY[0x1E4F1CB10] URLWithString:v2];
  }
  else
  {
    float v3 = 0;
        ...
        if (v11)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              uint64_t v17 = -[SKUIReview initWithCacheRepresentation:](v16, "initWithCacheRepresentation:", v15, (void)v21);
              if (v17) {
                [v9 addObject:v17];
              }
