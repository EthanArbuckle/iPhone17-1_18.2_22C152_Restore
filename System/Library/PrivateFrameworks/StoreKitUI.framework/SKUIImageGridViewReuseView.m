...
@implementation SKUIImageGridViewReuseView
...
- (SKUIImageGridViewReuseView)init
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SKUIImageGridViewReuseView;
  v3 = [(SKUIImageGridViewReuseView *)&v7 init];
  if (v3)
  {
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  v11[1] = 3221225472;
  v11[2] = __77__SKUIImageGridViewReuseView_prefetchResourcesForViewElement_reason_context___block_invoke;
  v11[3] = &unk_1E64234D0;
  id v9 = v8;
  v13 = &v15;
  int64_t v14 = a4;
...
uint64_t __77__SKUIImageGridViewReuseView_prefetchResourcesForViewElement_reason_context___block_invoke(uint64_t a1, uint64_t a2)
{
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  v48[1] = 3221225472;
  v48[2] = __66__SKUIImageGridViewReuseView_preferredSizeForViewElement_context___block_invoke;
  v48[3] = &unk_1E6422498;
  v48[4] = &v49;
...
void __66__SKUIImageGridViewReuseView_preferredSizeForViewElement_context___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v9[1] = 3221225472;
  v9[2] = __72__SKUIImageGridViewReuseView_requestLayoutForViewElement_width_context___block_invoke;
  v9[3] = &unk_1E6425F10;
  double v11 = a4;
  id v10 = v7;
  id v8 = v7;
...
void __72__SKUIImageGridViewReuseView_requestLayoutForViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
  if ([v3 elementType] == 49) {
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  +[SKUIImageGridViewReuseView preferredSizeForViewElement:context:](SKUIImageGridViewReuseView, "preferredSizeForViewElement:context:", a4, a5, a3);
  result.height = v6;
  result.width = v5;
  return result;
}
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  uint64_t v16 = __66__SKUIImageGridViewReuseView_reloadWithViewElement_width_context___block_invoke;
  uint64_t v17 = &unk_1E6425F38;
  id v18 = v8;
  id v19 = v9;
  double v20 = self;
  id v21 = v10;
  ...
  -[SKUIImageGridViewReuseView setImageViews:](self, "setImageViews:", v11, v14, v15, v16, v17);
}

void __66__SKUIImageGridViewReuseView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
  v9[0] = MEMORY[0x1E4F143A8];
  v9[1] = 3221225472;
  v9[2] = __66__SKUIImageGridViewReuseView_reloadWithViewElement_width_context___block_invoke_2;
  v9[3] = &unk_1E6424EF0;
  id v10 = v3;
...
uint64_t __66__SKUIImageGridViewReuseView_reloadWithViewElement_width_context___block_invoke_2(uint64_t a1, void *a2)
{
  id v11 = a2;
...
- (id)viewForElementIdentifier:(id)a3
{
  ...
  BOOL v19 = __Block_byref_object_dispose__28;
  id v20 = 0;
  id v5 = [(SKUIViewReuseView *)self allExistingViews];
  uint64_t v6 = [(SKUIViewElement *)self->_imageGridViewElement flattenedChildren];
  v11[0] = MEMORY[0x1E4F143A8];
  v11[1] = 3221225472;
  v11[2] = __55__SKUIImageGridViewReuseView_viewForElementIdentifier___block_invoke;
  v11[3] = &unk_1E64251F0;
  id v7 = v4;
  id v12 = v7;
  id v8 = v5;
...
void __55__SKUIImageGridViewReuseView_viewForElementIdentifier___block_invoke(uint64_t a1, void *a2, unint64_t a3, unsigned char *a4)
{
  id v7 = [a2 itmlID];
...
- (void)init
{
  ...
  int v0 = 136446210;
  v1 = "-[SKUIImageGridViewReuseView init]";
}
