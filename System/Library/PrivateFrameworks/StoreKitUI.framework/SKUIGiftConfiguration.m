...
void __62__SKUIGiftConfiguration_loadConfigurationWithCompletionBlock___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    long long v13 = __62__SKUIGiftConfiguration_loadConfigurationWithCompletionBlock___block_invoke_2;
...
- (void)_finishLoadWithResponse:(id)a3 error:(id)a4 block:(id)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
      ...
      if (v12)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              id v16 = [[SKUIGiftCharity alloc] initWithCharityDictionary:v15];
              [v10 addObject:v16];
            }
            ++v14;
          }
    ...
    if (objc_opt_isKindOfClass())
    {
      v42 = (NSURL *)[objc_alloc(MEMORY[0x1E4F1CB10]) initWithString:v41];
    ...
    if (objc_opt_isKindOfClass())
    {
      v44 = (NSURL *)[objc_alloc(MEMORY[0x1E4F1CB10]) initWithString:v78];
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0
      && (v61 = (void *)[objc_alloc(MEMORY[0x1E4F1CB10]) initWithString:v60]) != 0)
    {
      objc_initWeak(&location, self);
      v62 = (void *)[objc_alloc(MEMORY[0x1E4FA8338]) initWithURL:v61];
  ...
  if (v3)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v3; ++i)
      {
        ...
        if (v10)
        {
          id v11 = (void *)[objc_alloc(MEMORY[0x1E4FA8338]) initWithURL:v7];
