...
- (SKUIAddToWishlistOperation)initWithItem:(id)a3 reason:(int64_t)a4;
- (void)main;
@end
...
- (SKUIAddToWishlistOperation)initWithItem:(id)a3 reason:(int64_t)a4
{
  ...
  v19.receiver = self;
  v19.super_class = (Class)SKUIAddToWishlistOperation;
  ...
  if (v7)
  {
    ...
    if (v9)
    {
      uint64_t v10 = [MEMORY[0x1E4F1CB10] copyDictionaryForQueryString:v9 unescapedValues:1];
...
- (void)main
{
  ...
  v8 = (void *)[objc_alloc(MEMORY[0x1E4FA8130]) initWithAccount:v7];
  [(SSURLConnectionRequest *)v5 setAuthenticationContext:v8];
  uint64_t v32 = 0;
  v33 = &v32;
  uint64_t v34 = 0x3032000000;
  v35 = __Block_byref_object_copy__93;
  v36 = __Block_byref_object_dispose__93;
  id v37 = 0;
  dispatch_semaphore_t v9 = dispatch_semaphore_create(0);
  v29[0] = MEMORY[0x1E4F143A8];
  v29[1] = 3221225472;
  v29[2] = __34__SKUIAddToWishlistOperation_main__block_invoke;
  v29[3] = &unk_1E642A138;
  v31 = &v32;
  uint64_t v10 = v9;
  v30 = v10;
  [(SKUIURLConnectionRequest *)v5 startWithConnectionResponseBlock:v29];
