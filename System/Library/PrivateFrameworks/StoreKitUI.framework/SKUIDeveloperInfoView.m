...
- (SKUIDeveloperInfoView)initWithDeveloperInfo:(id)a3 clientContext:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v14)
    {
      ...
      v15 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_TRADE_NAME" inBundles:0 inTable:@"ProductPage"];
      }
      v53[0] = v15;
      v53[1] = v14;
      v16 = [MEMORY[0x1E4F1C978] arrayWithObjects:v53 count:2];
      [v13 addObject:v16];
    }
    ...
    if (v17)
    {
      ...
      v18 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_TRADE_REP" inBundles:0 inTable:@"ProductPage"];
      }
      v52[0] = v18;
      v52[1] = v17;
    ...
    if (v20)
    {
      ...
      v21 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_ADDRESS" inBundles:0 inTable:@"ProductPage"];
      }
      v51[0] = v21;
      v51[1] = v20;
      v22 = [MEMORY[0x1E4F1C978] arrayWithObjects:v51 count:2];
      [v13 addObject:v22];
    }
    v23 = [v7 phoneNumber];
    ...
    if (v23)
    {
      ...
      v24 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_PHONE" inBundles:0 inTable:@"ProductPage"];
      }
      v50[0] = v24;
      v50[1] = v23;
      v25 = [MEMORY[0x1E4F1C978] arrayWithObjects:v50 count:2];
      [v13 addObject:v25];
    }
    v26 = [v7 emailAddress];
    ...
    if (v26)
    {
      ...
      v27 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_EMAIL" inBundles:0 inTable:@"ProductPage"];
      }
      v49[0] = v27;
      v49[1] = v26;
      v28 = [MEMORY[0x1E4F1C978] arrayWithObjects:v49 count:2];
      [v13 addObject:v28];
    }
    if ([v13 count])
    {
      ...
      uint64_t v35 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v12, 0.0, 0.0, v34);
      infoSeparatorView = v10->_infoSeparatorView;
      v10->_infoSeparatorView = (UIView *)v35;

      v37 = v10->_infoSeparatorView;
      v38 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.2];
      [(UIView *)v37 setBackgroundColor:v38];

      [(SKUIDeveloperInfoView *)v10 addSubview:v10->_infoSeparatorView];
    }
    ...
    if (v41)
    {
      ...
      v42 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_ECOMMERCE_REGISTRATION_ID" inBundles:0 inTable:@"ProductPage"];
      }
    ...
    if (v44)
    {
      ...
      v45 = +[SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_BUSINESS_REGISTRATION_ID" inBundles:0 inTable:@"ProductPage"];
      }
...
- (void)layoutSubviews
{
  ...
  [(SKUIDeveloperInfoView *)self bounds];
  double v4 = v3;
  double v6 = v5;
  [(SKUIProductInformationView *)self->_infoView frame];
  double v8 = v7;
