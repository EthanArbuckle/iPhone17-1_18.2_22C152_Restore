...
- (SKUIScalingFlipView)initWithFrontView:(id)a3 backView:(id)a4
{
  ...
  v13 = -[SKUIScalingFlipView initWithFrame:](self, "initWithFrame:");
  v14 = v13;
  if (v13)
  {
    ...
    [(SKUIScalingFlipView *)v14 addSubview:*p_backView];
    [(SKUIScalingFlipView *)v14 addSubview:v14->_frontView];
    frontView = v14->_frontView;
    [(SKUIScalingFlipView *)v14 center];
    ...
    v27 = [MEMORY[0x1E4F39BC0] filterWithType:*MEMORY[0x1E4F3A2A8]];
    ...
    v29 = [(SKUIScalingFlipView *)v14 layer];
...
- (void)performFlipWithCompletionBlock:(id)a3
{
  ...
  id v8 = [(SKUIScalingFlipView *)self _frontLayerAnimation];
  [v7 addAnimation:v8 forKey:@"flipAnimation"];

  CGFloat v9 = [(UIView *)self->_backView layer];
  CGFloat v10 = [(SKUIScalingFlipView *)self _backLayerAnimation];
  [v9 addAnimation:v10 forKey:@"flipAnimation"];

  CGFloat v11 = [MEMORY[0x1E4F39B38] animation];
  ...
  CGFloat v18 = [(SKUIScalingFlipView *)self _timingFunction];
  [v11 setTimingFunction:v18];

  CGFloat v19 = [(SKUIScalingFlipView *)self layer];
  [v19 addAnimation:v11 forKey:@"multiplyAndPositionAnimation"];
}

- (void)animationDidStop:(id)a3 finished:(BOOL)a4
{
  v5 = [(SKUIScalingFlipView *)self layer];
  ...
  -[SKUIScalingFlipView setFrame:](self, "setFrame:", self->_toFrame.origin.x, self->_toFrame.origin.y, self->_toFrame.size.width, self->_toFrame.size.height);
  ...
  id completionBlock = (void (**)(id, SKUIScalingFlipView *))self->_completionBlock;
  if (completionBlock) {
...
- (id)_backLayerAnimation
{
  ...
  double v8 = dbl_1C1CCC1D0[(direction & 0xFFFFFFFFFFFFFFFDLL) == 0];
  ...
  *(_OWORD *)&v40.m31 = *(_OWORD *)(MEMORY[0x1E4F39B10] + 64);
  ...
  v40.CGFloat m33 = *(CGFloat *)(MEMORY[0x1E4F39B10] + 80);
  CGFloat m33 = v40.m33;
  ...
  *(_OWORD *)&v40.m13 = *(_OWORD *)&v41.m13;
  ...
  double v16 = [MEMORY[0x1E4F39BD8] animationWithKeyPath:@"transform"];
  ...
  *(_OWORD *)&v41.m41 = v52;
  *(_OWORD *)&v41.m43 = v53;
  CATransform3D v24 = [MEMORY[0x1E4F29238] valueWithCATransform3D:&v41];
  v60[0] = v24;
  *(_OWORD *)&v41.m21 = v48;
  *(_OWORD *)&v41.m23 = v49;
  *(_OWORD *)&v41.m31 = v50;
  ...
  *(_OWORD *)&v41.m41 = v44;
  *(_OWORD *)&v41.m43 = v45;
  double v25 = [MEMORY[0x1E4F29238] valueWithCATransform3D:&v41];
  v60[1] = v25;
  ...
  *(_OWORD *)&v41.m41 = v42;
  *(_OWORD *)&v41.m43 = v43;
  double v26 = [MEMORY[0x1E4F29238] valueWithCATransform3D:&v41];
  v60[2] = v26;
  v27 = [MEMORY[0x1E4F1C978] arrayWithObjects:v60 count:3];
  [v16 setValues:v27];
...
- (id)_frontLayerAnimation
{
  ...
  double v8 = dbl_1C1CCC1E0[(direction & 0xFFFFFFFFFFFFFFFDLL) == 0];
  CGFloat v9 = 1.0 / ((width + height) * 0.5 * 3.0);
  ...
  *(_OWORD *)&v38.m31 = *(_OWORD *)(MEMORY[0x1E4F39B10] + 64);
  ...
  v38.CGFloat m33 = *(CGFloat *)(MEMORY[0x1E4F39B10] + 80);
  CGFloat m33 = v38.m33;
  ...
  *(_OWORD *)&v38.m43 = v32;
  ...
  long long v40 = *(_OWORD *)&v39.m41;
  long long v41 = *(_OWORD *)&v39.m43;
  CGFloat v15 = [MEMORY[0x1E4F39BD8] animationWithKeyPath:@"transform"];
  ...
  *(_OWORD *)&v39.m41 = v31;
  *(_OWORD *)&v39.m43 = v32;
  double v23 = [MEMORY[0x1E4F29238] valueWithCATransform3D:&v39];
  v56[0] = v23;
  *(_OWORD *)&v39.m21 = v52;
  *(_OWORD *)&v39.m23 = v53;
  *(_OWORD *)&v39.m31 = v54;
  ...
  *(_OWORD *)&v39.m41 = v48;
  *(_OWORD *)&v39.m43 = v49;
  CATransform3D v24 = [MEMORY[0x1E4F29238] valueWithCATransform3D:&v39];
  v56[1] = v24;
  *(_OWORD *)&v39.m21 = v44;
  *(_OWORD *)&v39.m23 = v45;
  *(_OWORD *)&v39.m31 = v46;
  ...
  *(_OWORD *)&v39.m41 = v40;
  *(_OWORD *)&v39.m43 = v41;
  double v25 = [MEMORY[0x1E4F29238] valueWithCATransform3D:&v39];
  v56[2] = v25;
  double v26 = [MEMORY[0x1E4F1C978] arrayWithObjects:v56 count:3];
  [v15 setValues:v26];
  ...
  float v29 = [(SKUIScalingFlipView *)self _timingFunction];
...
- (id)_inputColorAnimation
{
  v2 = [MEMORY[0x1E4F39BD8] animationWithKeyPath:@"filters.multiply.inputColor"];
  v3 = [MEMORY[0x1E4FB1618] colorWithWhite:1.0 alpha:1.0];
  v4 = [MEMORY[0x1E4FB1618] colorWithWhite:0.330000013 alpha:1.0];
...
- (id)_positionAnimation
{
  ...
  *(float *)&double v7 = v6 + v9 - v6;
  ...
  CGFloat v11 = [MEMORY[0x1E4F39B48] animationWithKeyPath:@"position"];
  long long v12 = objc_msgSend(MEMORY[0x1E4F29238], "valueWithCGPoint:", v8, v10);
  [v11 setToValue:v12];
...
- (void)initWithFrontView:backView:.cold.1()
{
  ...
  int v0 = 136446210;
  v1 = "-[SKUIScalingFlipView initWithFrontView:backView:]";
}
