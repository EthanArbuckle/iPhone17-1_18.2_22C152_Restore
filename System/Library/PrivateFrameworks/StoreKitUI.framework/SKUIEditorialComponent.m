...
- (NSAttributedString)bodyAttributedText
{
  ...
  if (v2)
  {
    ...
    uint64_t v8 = SKUIViewElementAlignmentForStyle(v4);
    if (v8) {
      uint64_t v9 = SKUIViewElementNSTextAlignmentForIKElementAlignment(v8);
    }
    else {
      uint64_t v9 = 0;
    }
...
void __44__SKUIEditorialComponent_bodyAttributedText__block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  objc_msgSend(*(id *)(a1 + 32), "addAttribute:value:range:", *MEMORY[0x1E4FB0738], v7, a3, a4);
}
...
- (void)_setTitleText:(id)a3
{
  if (self->_titleText != a3)
  {
    ...
    self->_titleText = v4;
    MEMORY[0x1F41817F8](v4, titleText);
  }
}
