...
{
  v6.receiver = self;
  v6.super_class = (Class)SKUIComposeTextFieldListView;
  result = -[SKUIComposeTextFieldListView initWithFrame:](&v6, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (result) {
    result->_style = a4;
  }
  return result;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SKUIComposeTextFieldListView;
...
- (void)reloadData
{
  ...
  -[SKUIComposeTextFieldListView setFrame:](self, "setFrame:", v21, v23, v25, v26);
...
- (SKUIComposeTextFieldListViewDelegate)delegate
{
  ...
  return (SKUIComposeTextFieldListViewDelegate *)WeakRetained;
}
