...
- (SKUINavigationBarController)initWithNavigationBarViewElement:(id)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)SKUINavigationBarController;
  ...
  if (v6)
  {
    ...
    [v9 addObserver:v6 selector:sel__viewElementEventNotification_ name:0x1F1C8C848 object:0];
  }
  return v6;
}
...
- (void)dealloc
{
  ...
  [v3 removeObserver:self name:0x1F1C8C848 object:0];
  ...
  v5.receiver = self;
  v5.super_class = (Class)SKUINavigationBarController;
...
- (void)attachToNavigationItem:(id)a3
{
  ...
  if (!v55[5])
  {
    uint64_t v11 = [(SKUINavigationBarController *)self fallbackTitleView];
    v12 = (void *)v55[5];
    v55[5] = v11;
  }
  ...
  if (v67[5])
  {
    ...
    uint64_t v19 = [(SKUINavigationBarSegmentsController *)v18 view];
    v20 = (void *)v55[5];
    v55[5] = v19;
  }
  if (!v55[5] && [v37 count])
  {
    ...
    uint64_t v22 = [(SKUINavigationBarMenusController *)v21 view];
    v23 = (void *)v55[5];
    v55[5] = v22;
  }
  ...
  SKUINavigationBarController_SetTitleView(v4, (void *)v55[5]);
  uint64_t v31 = v73[5];
  if (!v31) {
    uint64_t v31 = v61[5];
  }
...
uint64_t __54__SKUINavigationBarController_attachToNavigationItem___block_invoke(uint64_t a1, void *a2)
{
  id v21 = a2;
...
- (UIView)navigationPaletteView
{
  ...
  {
    id v4 = [(SKUINavigationBarViewElement *)self->_viewElement navigationPalettes];
    ...
    if (v5)
    {
      ...
      if (v7)
      {
        uint64_t v8 = [(SKUINavigationBarController *)self _navigationBarContext];
        uint64_t v9 = [[SKUINavigationPaletteController alloc] initWithPaletteViewElement:v5];
  ...
  return (UIView *)[(SKUINavigationPaletteController *)paletteController view];
}
...
- (void)setReusableSearchBarControllers:(id)a3
{
  if (self->_reusableSearchBarControllers != a3)
  {
    ...
    MEMORY[0x1F41817F8](v4, reusableSearchBarControllers);
  }
}
...
- (id)titleViewWithViewElement:(id)a3
{
  ...
  if (SKUIUserInterfaceIdiom(self->_clientContext) == 1)
  {
    ...
    [v9 bounds];
    BOOL v11 = v10 > SKUICompactThreshold();
  ...
  {
    id v12 = [(SKUINavigationBarController *)self _addSearchBarControllerWithViewElement:v5];
    ...
    if (v16)
    {
      ...
      id v25 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v21, v22, v20, v24);
      [v25 addSubview:v13];
    }
    else
    {
  ...
  else
  {
    ...
    uint64_t v26 = [(SKUINavigationBarController *)self _buttonWithElement:self->_titleButtonViewElement width:v7];
...
- (void)updateNavigationItem:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(SKUINavigationBarViewElement *)self->_viewElement updateType];
  switch(v5)
  {
    case 1:
      long long v52 = 0u;
      ...
      if (self->_titleButtonViewElement)
      {
        ...
        if (SKUIUserInterfaceIdiom(self->_clientContext) == 1)
        {
          ...
          [v21 bounds];
          BOOL v23 = v22 > SKUICompactThreshold();

          if (v23 && v19 > 314.0) {
            double v19 = 314.0;
          }
        }
        double v24 = [(SKUINavigationBarController *)self _buttonWithElement:self->_titleButtonViewElement width:v19];
        ...
        SKUINavigationBarController_SetTitleView(v4, v30);
      }
    ...
    case 4:
      ...
      double v36 = [(SKUINavigationBarController *)self parentViewController];
      ...
      if (isKindOfClass)
      {
        long long v39 = [(SKUINavigationBarController *)self parentViewController];
      ...
      break;
    case 3:
      double v6 = [(SKUIViewElement *)self->_viewElement firstChildForElementType:106];
      uint64_t v7 = [(SKUIViewElement *)self->_viewElement firstChildForElementType:75];
      uint64_t v8 = [(SKUIViewElement *)self->_viewElement firstChildForElementType:138];
...
LABEL_44:
      ...
      uint64_t v9 = [(SKUIViewElement *)self->_viewElement flattenedChildren];
...
LABEL_52:
        ...
        paletteController = (SKUINavigationPaletteController *)objc_msgSend(objc_alloc(MEMORY[0x1E4F1C978]), "initWithObjects:", self->_paletteController, 0);
...
- (id)viewForElementIdentifier:(id)a3
{
  ...
  paletteController = self->_paletteController;
  if (!paletteController
    || ([(SKUINavigationPaletteController *)paletteController viewForElementIdentifier:v4],
...
- (void)_viewElementEventNotification:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(SKUINavigationBarController *)self navigationPaletteView];
...
- (id)_addSearchBarControllerWithViewElement:(id)a3
{
  ...
  if (![(NSMutableArray *)self->_reusableSearchBarControllers count]
    || ([(NSMutableArray *)self->_reusableSearchBarControllers firstObject],
        uint64_t v5 = (SKUISearchBarController *)objc_claimAutoreleasedReturnValue(),
        [(SKUISearchBarController *)v5 setSearchBarViewElement:v4],
        [(NSMutableArray *)self->_reusableSearchBarControllers removeObjectAtIndex:0],
        !v5))
  {
    uint64_t v5 = [[SKUISearchBarController alloc] initWithSearchBarViewElement:v4];
  }
  ...
  if (SKUIUserInterfaceIdiom(self->_clientContext) == 1)
  {
    ...
    {
      BOOL v10 = [(SKUIClientContext *)self->_clientContext shouldForceTransientSearchControllerBahavior];
...
LABEL_10:
  ...
  {
    long long v12 = (NSMapTable *)[objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:512 valueOptions:512 capacity:0];
...
- (id)_attributedStringForButton:(id)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = [(SKUINavigationBarController *)self _attributedStringForButtonText:v5 type:v6 style:v7];
  }
  else
  {
    double v9 = [v4 style];
    uint64_t v8 = [(SKUINavigationBarController *)self _attributedStringForButtonText:v5 type:v6 style:v9];
  }
...
- (id)_attributedStringForButtonText:(id)a3 type:(int64_t)a4 style:(id)a5
{
  id v8 = a5;
  id v9 = a3;
  BOOL v10 = SKUIViewElementFontWithStyle(v8);
  if (!v10)
  {
    if (a4) {
      uint64_t v11 = 5;
    ...
    BOOL v10 = SKUIFontPreferredFontForTextStyle(v11);
  }
  long long v12 = [(SKUINavigationBarViewElement *)self->_viewElement tintColor];
  uint64_t v13 = SKUIViewElementPlainColorWithStyle(v8, v12);
...
- (id)_barButtonItemWithButtonViewElement:(id)a3
{
  ...
  {
    uint64_t v6 = [[SKUINavigationBarButtonsController alloc] initWithNavigationBarViewElement:self->_viewElement];
    double v7 = self->_buttonsController;
    self->_buttonsController = v6;

    double v8 = self->_buttonsController;
    double v9 = [(SKUINavigationBarController *)self _navigationBarContext];
    [(SKUINavigationBarSectionController *)v8 setContext:v9];

    buttonsController = self->_buttonsController;
  }
  BOOL v10 = [(SKUINavigationBarButtonsController *)buttonsController addButtonItemWithButtonViewElement:v4];
...
- (id)_barButtonItemWithSearchBarViewElement:(id)a3
{
  ...
  double v7 = [(SKUINavigationBarController *)self _addSearchBarControllerWithViewElement:v5];
...
- (id)_barButtonItemWithViewElement:(id)a3
{
  ...
  {
    uint64_t v6 = [(SKUINavigationBarController *)self _barButtonItemWithButtonViewElement:v4];
LABEL_5:
    double v7 = (void *)v6;
    goto LABEL_7;
  }
  if (v5 == 106)
  {
    uint64_t v6 = [(SKUINavigationBarController *)self _barButtonItemWithSearchBarViewElement:v4];
    goto LABEL_5;
  }
  double v7 = 0;
LABEL_7:
...
- (id)_buttonWithElement:(id)a3 width:(double)a4
{
  ...
  if (v7 == 9)
  {
    double v9 = objc_alloc_init(SKUIStyledButton);
    [(SKUIStyledButton *)v9 setAlpha:1.0];
    [(SKUIStyledButton *)v9 setBorderStyle:0];
    uint64_t v18 = 1;
    [(SKUIStyledButton *)v9 setButtonType:1];
    uint64_t v19 = [(SKUINavigationBarController *)self _attributedStringForButton:v6];
    double v20 = [[SKUIAttributedStringLayoutRequest alloc] initWithAttributedString:v19];
    [(SKUIAttributedStringLayoutRequest *)v20 setWidth:a4];
    double v21 = [[SKUIAttributedStringLayout alloc] initWithLayoutRequest:v20];
    [(SKUIStyledButton *)v9 setTitleLayout:v21];
    if (![(SKUIStyledButton *)v9 isUsingItemOfferAppearance]) {
      uint64_t v18 = [v6 isEnabled];
    }
    [(SKUIStyledButton *)v9 setEnabled:v18];
    double v22 = [v6 style];
    BOOL v23 = SKUIViewElementPlainColorWithStyle(v22, 0);

    [(SKUIStyledButton *)v9 setTintColor:v23];
    goto LABEL_29;
  }
  uint64_t v8 = v7;
  if (v7 != 6)
  {
    if (v7 == 5)
    {
      double v9 = objc_alloc_init(SKUIStyledImageButton);
      BOOL v10 = [(SKUIStyledButton *)v9 imageView];
      double v11 = [v6 buttonImage];
      double v12 = [(SKUINavigationBarController *)self _resourceImageForImageElement:v11];
      [v10 setImage:v12];
      [v12 size];
      ...
      long long v17 = SKUIViewElementPlainColorWithStyle(v16, 0);
    ...
    double v20 = [[SKUIAttributedStringLayoutRequest alloc] initWithAttributedString:v19];
    [(SKUIAttributedStringLayoutRequest *)v20 setWidth:a4];
    uint64_t v43 = [[SKUIAttributedStringLayout alloc] initWithLayoutRequest:v20];
    ...
    uint64_t v45 = [SKUIButtonBorderStyle alloc];
    uint64_t v46 = [v6 style];
    id v47 = [(SKUIButtonBorderStyle *)v45 initWithElementStyle:v46];
...
LABEL_29:
  ...
  [(SKUIStyledButton *)v9 setButtonType:v27];
  double v28 = [(SKUINavigationBarController *)self _attributedStringForButton:v6];
  double v29 = [[SKUIAttributedStringLayoutRequest alloc] initWithAttributedString:v28];
  [(SKUIAttributedStringLayoutRequest *)v29 setWidth:a4];
  id v30 = [[SKUIAttributedStringLayout alloc] initWithLayoutRequest:v29];
  [(SKUIStyledButton *)v9 setTitleLayout:v30];
  uint64_t v31 = [v6 isEnabled];
  [(SKUIStyledButton *)v9 setEnabled:v31];
  double v32 = 0.4;
  if (v31) {
    double v32 = 1.0;
  }
  [(SKUIStyledButton *)v9 setAlpha:v32];
  double v33 = [(SKUIStyledButton *)v9 imageView];
  double v34 = [v6 buttonImage];
  double v35 = [(SKUINavigationBarController *)self _resourceImageForImageElement:v34];
  [v33 setImage:v35];
  [v35 size];
  objc_msgSend(v33, "setImageSize:");
  char v56 = 0;
  double v36 = [v34 style];
  double v37 = SKUIViewElementMarginForStyle(v36, &v56);
  double v39 = v38;
  double v41 = v40;
  ...
  if (v56)
  {
    ...
    [(SKUIStyledButton *)v9 setImageTextPaddingInterior:v42];
    [(SKUIStyledButton *)v9 setImageYAdjustment:v37];
  }
...
- (void)_fullyReloadSections:(id)a3 withNavigationItem:(id)a4
{
  ...
  double v13 = [(SKUINavigationBarController *)self _navigationBarContext];
...
- (id)_navigationBarContext
{
  ...
  {
    id v4 = objc_alloc_init(SKUINavigationBarContext);
    ...
    double v12 = [[SKUIResourceLoader alloc] initWithClientContext:self->_clientContext];
    [(SKUINavigationBarContext *)self->_navigationBarContext setResourceLoader:v12];
    double v13 = objc_alloc_init(SKUILayoutCache);
...
- (id)_resourceImageForImageElement:(id)a3
{
  ...
  if (v4)
  {
    id v6 = SKUIImageWithResourceName(v4);
    id v7 = [v3 style];
...
- (void)_titleButtonAction:(id)a3
{
  ...
  [v4 postNotificationName:0x1F1C8C848 object:self];
...
- (SKUINavigationBarControllerDelegate)delegate
{
  ...
  return (SKUINavigationBarControllerDelegate *)WeakRetained;
}
