...
- (SKUIBrickGridPageSection)initWithPageComponent:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(void *)&v5->_baseHeight = qword_1C1CCC7A0[v7 == 1];
    v5->_columnWidth = v8;
    ...
    uint64_t v14 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:517 valueOptions:0 capacity:0];
...
- (void)addImpressionsForIndexPath:(id)a3 toSession:(id)a4
{
  id v13 = a4;
  id v6 = a3;
  uint64_t v7 = [(SKUIStorePageSection *)self pageComponent];
...
- (id)cellForIndexPath:(id)a3
{
  ...
  uint64_t v7 = [v6 dequeueReusableCellWithReuseIdentifier:0x1F1C9AD68 forIndexPath:v4];
  double v8 = [(SKUIStorePageSection *)self backgroundColorForIndexPath:v4];
  ...
  if (v9 < [v13 count])
  {
    ...
    objc_super v17 = [v5 resourceLoader];
...
LABEL_5:
    ...
    if (!placeholderImage)
    {
      ...
      v22 = v28 = v16;
      v23 = [MEMORY[0x1E4FB1618] colorWithWhite:0.8 alpha:1.0];
...
- (id)clickEventWithLink:(id)a3 elementName:(id)a4 index:(int64_t)a5
{
  ...
  uint64_t v7 = -[SKUIStorePageSection clickEventWithLink:elementName:index:](&v13, sel_clickEventWithLink_elementName_index_, a3, a4);
  if (v7)
  {
    double v8 = [(SKUIStorePageSection *)self context];
    int64_t v9 = [v8 collectionView];

    double v10 = objc_msgSend(MEMORY[0x1E4F28D58], "indexPathForItem:inSection:", a5, -[SKUIStorePageSection sectionIndex](self, "sectionIndex"));
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  if (!v7)
  {
    ...
    double v10 = [v9 link];
    double v11 = [(SKUIBrickGridPageSection *)self clickEventWithLink:v10 elementName:*MEMORY[0x1E4FA88C8] index:v6];
    if (v11)
    {
...
- (void)willAppearInContext:(id)a3
{
  ...
  [v6 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x1F1C9AD68];
  ...
  if (v15)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v16; ++i)
      {
        ...
        uint64_t v19 = [(SKUIBrickGridPageSection *)self _editorialLayoutForBrick:*(void *)(*((void *)&v21 + 1) + 8 * i)];
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  int64_t v16 = [(SKUIStorePageSection *)self sectionIndex];
    ...
    do
    {
      for (uint64_t i = 0; i != v19; ++i)
      {
        ...
        if ([v22 section] == v16)
        {
          ...
          -[SKUIBrickGridPageSection _contentInsetsForColumnIndex:rowWidth:](self, "_contentInsetsForColumnIndex:rowWidth:", [v22 item] % self->_numberOfColumns, v9);
...
void __56__SKUIBrickGridPageSection_artworkRequest_didLoadImage___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
  id v11 = [*(id *)(*(void *)(a1 + 32) + 88) objectForKey:a2];
  if ([v11 unsignedIntegerValue] == *(void *)(a1 + 48))
  {
    uint64_t v7 = objc_msgSend(MEMORY[0x1E4F28D58], "indexPathForItem:inSection:", a3, objc_msgSend(*(id *)(a1 + 32), "sectionIndex"));
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if ([v8 count])
  {
    id v11 = [(SKUIStorePageSection *)self pageComponent];
    double v12 = [v11 _updateWithInvalidItemIdentifiers:v8];
    if ([v12 count])
    {
      id v13 = objc_alloc_init(MEMORY[0x1E4F1CA48]);
      int64_t v14 = [(SKUIStorePageSection *)self sectionIndex];
      uint64_t v18 = MEMORY[0x1E4F143A8];
      uint64_t v19 = 3221225472;
      uint64_t v20 = __82__SKUIBrickGridPageSection_missingItemLoader_didLoadItems_invalidItemIdentifiers___block_invoke;
      long long v21 = &unk_1E642A248;
      id v22 = v13;
      int64_t v23 = v14;
      id v15 = v13;
      [v12 enumerateIndexesUsingBlock:&v18];
      int64_t v16 = [(SKUIStorePageSection *)self context];
...
- (id)_editorialLayoutForBrick:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (v6)
    {
      ...
      uint64_t v5 = [(SKUIEditorialLayout *)v7 initWithEditorial:v6 layoutCache:v9];
...
- (void)_enumerateVisibleBricksUsingBlock:(id)a3
{
  ...
  int64_t v9 = [(SKUIStorePageSection *)self sectionIndex];
...
- (void)_loadArtworkForBrick:(id)a3 artworkLoader:(id)a4 reason:(int64_t)a5
{
  ...
  if (v10)
  {
    id v11 = objc_alloc_init(SKUIArtworkRequest);
    id v12 = +[SKUIStyledImageDataConsumer brickConsumerWithBrickSize:](SKUIStyledImageDataConsumer, "brickConsumerWithBrickSize:", self->_columnWidth, self->_baseHeight);
    ...
    id v14 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[SKUIResourceRequest requestIdentifier](v11, "requestIdentifier"));
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    id v7 = [(SKUIBrickGridPageSection *)self _missingItemLoader];
