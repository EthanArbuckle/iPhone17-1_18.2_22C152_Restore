...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)SKUICollectionViewLayoutAttributes;
  v5 = [(UICollectionViewLayoutAttributes *)&v7 copyWithZone:a3];
  objc_storeStrong(v5 + 44, self->_backgroundColor);
  v5[45] = self->_position;
  v5[46] = *(id *)&self->_zoomingImageAlpha;
  v5[49] = *(id *)&self->_zoomingImageLambda;
  v5[47] = *(id *)&self->_zoomingImageWidth;
  v5[48] = *(id *)&self->_zoomingImageImposedAlphaOfOtherViews;
  return v5;
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v8.receiver = self;
      v8.super_class = (Class)SKUICollectionViewLayoutAttributes;
