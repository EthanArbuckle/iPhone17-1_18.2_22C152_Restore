...
- (id)_initSKUIViewElementLayoutContext
{
  ...
  if (v3)
  {
    uint64_t v4 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:517 valueOptions:0 capacity:0];
    ...
    uint64_t v8 = [MEMORY[0x1E4FB1618] colorWithWhite:0.85 alpha:1.0];
    placeholderColor = v3->_placeholderColor;
    v3->_placeholderColor = (UIColor *)v8;

    uint64_t v10 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:0 capacity:0];
...
- (SKUIViewElementLayoutContext)initWithStorePageSectionContext:(id)a3
{
  return [(SKUIViewElementLayoutContext *)self initWithStorePageSectionContext:a3 previousLayoutContext:0];
}
...
- (SKUIViewElementLayoutContext)initWithStorePageSectionContext:(id)a3 previousLayoutContext:(id)a4
{
  id v6 = a3;
  v7 = a4;
  uint64_t v8 = [(SKUIViewElementLayoutContext *)self _initSKUIViewElementLayoutContext];
  if (v8)
  {
    v9 = [v6 resourceLoader];
    if (v9)
    {
      uint64_t v10 = [v7 resourceLoader];
    ...
    {
      objc_super v18 = [SKUIViewElementTextLayoutCache alloc];
      v19 = [v6 textLayoutCache];
      uint64_t v20 = [(SKUIViewElementTextLayoutCache *)v18 initWithLayoutCache:v19];
...
- (NSCache)placeholderImageCache
{
  return [(SKUIClientContext *)self->_clientContext placeholderImageCache];
}

+ (double)itemWidthForElement:(id)a3 withDefaultWidth:(double)a4 fitWidth:(double)a5
{
  uint64_t v8 = [a3 style];
  v9 = [v8 itemWidth];
...
- (SKUIBadgeTextAttachmentLoader)badgeImageLoader
{
  ...
  if (!badgeImageLoader)
  {
    objc_super v4 = [[SKUIBadgeTextAttachmentLoader alloc] initWithResourceLoader:self->_resourceLoader];
...
- (MPUBorderDrawingCache)borderDrawingCache
{
  ...
  {
    uint64_t v4 = SKUIMPUFoundationFramework();
    v5 = (MPUBorderDrawingCache *)objc_alloc_init((Class)SKUIWeakLinkedClassForString(&cfstr_Mpuborderdrawi.isa, v4));
...
- (id)editorialLayoutForLabelElement:(id)a3 width:(double)a4
{
  ...
  if (!v7)
  {
    uint64_t v8 = [[SKUIEditorialComponent alloc] initWithViewElement:v6];
    double v9 = [SKUIEditorialLayout alloc];
    double v10 = [(SKUIViewElementTextLayoutCache *)self->_labelLayoutCache layoutCache];
    double v7 = [(SKUIEditorialLayout *)v9 initWithEditorial:v8 layoutCache:v10];
...
- (void)expandEditorialForLabelElement:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      double v7 = (NSHashTable *)[objc_alloc(MEMORY[0x1E4F28D30]) initWithOptions:512 capacity:1];
      uint64_t v8 = self->_expandedEditorialLayouts;
...
- (BOOL)loadImageForArtwork:(id)a3 dataConsumer:(id)a4 reason:(int64_t)a5
{
  ...
  uint64_t v9 = [a3 URL];
  if (v9) {
    BOOL v10 = [(SKUIViewElementLayoutContext *)self _loadImageForURL:v9 cacheKey:v9 dataConsumer:v8 reason:a5];
  }
  else {
    BOOL v10 = 0;
  }
...
- (BOOL)loadImageForBadgeElement:(id)a3 reason:(int64_t)a4
{
  ...
  if (v9)
  {
    BOOL v10 = [(SKUIViewElementLayoutContext *)self loadTemplatedImageForBadgeElement:v6 reason:a4];
  }
  else if (v7)
  {
    double v11 = +[SSVURLDataConsumer consumer];
    BOOL v10 = [(SKUIViewElementLayoutContext *)self _loadImageForURL:v7 cacheKey:v7 dataConsumer:v11 reason:a4];
  }
  else
  {
    BOOL v10 = 0;
...
- (BOOL)loadTemplatedImageForBadgeElement:(id)a3 reason:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    if (v10)
    {
      ...
      {
        uint64_t v12 = [(SKUIViewElementLayoutContext *)self tintColor];
    ...
    BOOL v14 = [(SKUIViewElementLayoutContext *)self _loadImageForURL:v7 cacheKey:v7 dataConsumer:v13 reason:a4];
  }
  else
  {
    BOOL v14 = 0;
...
{
  id v6 = a3;
  uint64_t v7 = [(SKUIViewElementLayoutContext *)self dataConsumerForImageElement:v6];
...
- (BOOL)loadImageForImageElement:(id)a3 reason:(int64_t)a4 dataConsumer:(id)a5
{
  ...
  if (v10)
  {
    ...
    BOOL v13 = [(SKUIViewElementLayoutContext *)self _loadImageForURL:v11 cacheKey:v12 dataConsumer:v9 reason:a4];
  }
  else
  {
    BOOL v13 = 0;
...
- (id)dataConsumerForImageElement:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      uint64_t v9 = [(SKUIViewElementLayoutContext *)self tintColor];
  ...
  {
    uint64_t v7 = [[SKUIStyledImageDataConsumer alloc] initWithViewElement:v4];
...
- (id)placeholderImageForImageElement:(id)a3 dataConsumer:(id)a4
{
  ...
  uint64_t v14 = SKUIImageTreatmentForString(v13);
  ...
  objc_super v18 = -[SKUIPlaceholderImageKey initWithSize:imageTreatment:placeholderBackgroundColor:]([SKUIPlaceholderImageKey alloc], "initWithSize:imageTreatment:placeholderBackgroundColor:", v14, v16, v9, v11);
...
- (id)placeholderImageForSize:(CGSize)a3
{
  ...
  id v6 = -[SKUIPlaceholderImageKey initWithSize:imageTreatment:placeholderBackgroundColor:]([SKUIPlaceholderImageKey alloc], "initWithSize:imageTreatment:placeholderBackgroundColor:", 0, 0, a3.width, a3.height);
  double v7 = [(SKUIViewElementLayoutContext *)self placeholderImageCache];
  int64_t v8 = [v7 objectForKey:v6];

  if (!v8)
  {
    double v9 = objc_alloc_init(SKUIStyledImageDataConsumer);
    -[SKUIStyledImageDataConsumer setImageSize:](v9, "setImageSize:", width, height);
    [(SKUIStyledImageDataConsumer *)v9 setImageTreatment:0];
    int64_t v8 = [(SKUIStyledImageDataConsumer *)v9 imageForColor:self->_placeholderColor];
    if (v8)
    {
      double v10 = [(SKUIViewElementLayoutContext *)self placeholderImageCache];
...
- (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4
{
  ...
  if (v7 <= 61)
  {
    switch(v7)
    {
      ...
      case '/':
        goto LABEL_19;
      case '0':
        double v9 = SKUISectionHeaderView;
        goto LABEL_17;
      case '1':
        char v11 = [(SKUIViewElementLayoutContext *)self loadImageForImageElement:v6 reason:a4];
        goto LABEL_18;
      case '2':
        uint64_t v10 = [v6 buttonImage];
        goto LABEL_13;
      case '3':
        double v9 = SKUIImageDeckView;
        goto LABEL_17;
      default:
        if (v7 != 8) {
          goto LABEL_19;
        }
        char v11 = [(SKUIViewElementLayoutContext *)self loadImageForBadgeElement:v6 reason:a4];
        break;
    }
    goto LABEL_18;
  }
  ...
  {
    case 62:
      double v9 = SKUIHorizontalListView;
LABEL_17:
...
LABEL_18:
      ...
      break;
    case 77:
      double v9 = SKUIOfferView;
      goto LABEL_17;
    case 152:
      uint64_t v10 = [v6 thumbnailImage];
LABEL_13:
      uint64_t v12 = (void *)v10;
      BOOL v8 = [(SKUIViewElementLayoutContext *)self loadImageForImageElement:v10 reason:a4];
...
- (id)requestIdentifierForArtwork:(id)a3
{
  id v4 = [(SKUIViewElementLayoutContext *)self imageResourceCacheKeyForArtwork:a3];
  uint64_t v5 = [(SKUIViewElementLayoutContext *)self requestIdentifierForResourceCacheKey:v4];
...
- (id)requestIdentifierForResourceCacheKey:(id)a3
{
  if (a3)
  {
    id v4 = -[SKUIResourceLoader requestIdentifierForCacheKey:](self->_resourceLoader, "requestIdentifierForCacheKey:");
  }
  else
  {
    id v4 = 0;
...
- (id)requestIdentifierForViewElement:(id)a3
{
  id v4 = [(SKUIViewElementLayoutContext *)self imageResourceCacheKeyForViewElement:a3];
  uint64_t v5 = [(SKUIViewElementLayoutContext *)self requestIdentifierForResourceCacheKey:v4];
...
- (void)setLargeScreenElementPaddingFromContext:(id)a3
{
  ...
  *(_OWORD *)&self->_largeScreenElementPadding.top = *MEMORY[0x1E4FB2848];
  *(_OWORD *)&self->_largeScreenElementPadding.bottom = v4;
  ...
  if ((v7 & 1) == 0)
  {
    ...
    {
      *(_OWORD *)&self->_largeScreenElementPadding.top = xmmword_1C1CCBFF0;
      *(_OWORD *)&self->_largeScreenElementPadding.bottom = xmmword_1C1CCC000;
    }
  }
}
...
- (CGSize)sizeForBadgeElement:(id)a3
{
  ...
  if (v5 == *MEMORY[0x1E4F1DB30] && v4 == *(double *)(MEMORY[0x1E4F1DB30] + 8))
  {
    ...
    CGFloat v10 = v9;
    if (v9 && (SKUIImageWithResourceName(v9), (double v11 = objc_claimAutoreleasedReturnValue()) != 0)
...
- (CGSize)sizeForItemOfferButton:(id)a3
{
  ...
  if (v7)
  {
    ...
    if ([v10 state])
    {
      ...
      if ((v16 & 1) == 0)
      {
        uint64_t v17 = +[SKUIItemOfferButton localizedTitleForItemState:v10 clientContext:self->_clientContext];
  ...
  if (v6)
  {
    objc_super v18 = [(NSMutableDictionary *)self->_itemOfferButtonSizes objectForKey:v6];
    if (v18)
    {
      v19 = v18;
  ...
  else if ([v4 buttonViewType] == 3)
  {
    ...
    if (!sizeForItemOfferButton__sDownloadButtonSize)
    {
      ...
      -[SKUIItemOfferButton sizeThatFits:](self->_itemOfferButton, "sizeThatFits:", *(double *)(MEMORY[0x1E4F1DB10] + 16), *(double *)(MEMORY[0x1E4F1DB10] + 24));
      uint64_t v24 = -[SKUISizeValue initWithSize:](v23, "initWithSize:");
  ...
  if (v9 <= 76)
  {
    if (v9 > 39)
    {
      switch(v9)
      {
        ...
        case '/':
          goto LABEL_68;
        case '0':
          CGFloat v10 = SKUISectionHeaderView;
          goto LABEL_49;
        case '1':
        ...
        case '2':
          ...
          goto LABEL_52;
        case '3':
          CGFloat v10 = SKUIImageDeckView;
          goto LABEL_49;
        default:
          if (v9 == 62)
          {
            CGFloat v10 = SKUIHorizontalListView;
            goto LABEL_49;
          }
          if (v9 != 69) {
            goto LABEL_68;
          ...
          id v20 = [v6 titleItem];
          [(SKUIViewElementTextLayoutCache *)self->_labelLayoutCache sizeForViewElement:v20 width:a4];
          break;
      }
      goto LABEL_54;
    }
    if (v9 <= 12)
    {
      if (v9 == 8)
      {
        ...
        if ([v20 badgeType] == 1)
        {
          v33 = [(SKUIViewElementTextLayoutCache *)self->_labelLayoutCache layoutForWidth:(uint64_t)a4 viewElement:v20];
          if (v33)
          {
            +[SKUIAttributedStringView sizeWithLayout:v33 treatment:1];
            double v8 = v34;
            double v7 = v35;
          }
        ...
        [(SKUIViewElementLayoutContext *)self sizeForBadgeElement:v20];
LABEL_54:
        double v8 = v21;
        double v7 = v22;
LABEL_67:
      ...
      if (v9 == 12)
      {
        ...
        switch([v6 buttonViewType])
        {
          ...
          case 11:
          case 13:
            double v13 = [SKUIButtonBorderStyle alloc];
            double v14 = [v6 style];
            double v15 = [(SKUIButtonBorderStyle *)v13 initWithElementStyle:v14];
          ...
          case 6:
            ...
            v49 = [v6 style];
            double v15 = [(SKUIButtonBorderStyle *)v48 initWithElementStyle:v49];

            +[SKUIStyledButton sizeForTextSize:buttonType:borderStyle:](SKUIStyledButton, "sizeForTextSize:buttonType:borderStyle:", +[SKUIStyledButton buttonTypeForElement:v6], v15, v8, v7);
            double v51 = v50;
            double v53 = v52;
            v54 = [v6 style];
            [v54 elementPadding];
...
LABEL_72:
    ...
    if (v9 != 13)
    {
      if (v9 == 32)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          double v15 = (SKUIButtonBorderStyle *)v6;
          if ([(SKUIButtonBorderStyle *)v15 dividerType] == 3)
          {
            double v23 = [(SKUIButtonBorderStyle *)v15 style];
...
LABEL_50:
  ...
  if (v9 > 134)
  {
    ...
    {
      case 135:
        CGFloat v10 = SKUIStarRatingViewElementView;
        goto LABEL_49;
      case 136:
      case 137:
      case 139:
      ...
      case 141:
        ...
        {
          uint64_t v29 = v28;
          double v30 = +[SKUIItemStateCenter defaultCenter];
...
LABEL_60:
        if (+[SKUIStyledButton usesItemOfferAppearanceForButtonType:1 itemState:v31])
        {
          [(SKUIViewElementLayoutContext *)self sizeForItemOfferButton:v20];
        }
        else
        {
          ...
          [(SKUIViewElementTextLayoutCache *)self->_labelLayoutCache sizeForButton:v20 width:a4];
...
LABEL_66:
        ...
        goto LABEL_67;
      case 144:
        CGFloat v10 = SKUITomatoRatingView;
        goto LABEL_49;
      default:
        if (v9 == 152)
        {
...
LABEL_52:
          id v20 = (id)v32;
          [(SKUIViewElementLayoutContext *)self _sizeForImageElement:v32 applyTransform:1];
          goto LABEL_54;
        }
        if (v9 != 154) {
          goto LABEL_68;
        }
        CGFloat v10 = SKUIImageGridView;
        break;
    }
    goto LABEL_49;
  }
...
LABEL_49:
  ...
  if (v9 == 131)
  {
    CGFloat v10 = SKUIStackListCollectionViewCell;
    goto LABEL_49;
  }
LABEL_68:
...
- (id)textPropertiesForViewElement:(id)a3 width:(double)a4
{
  ...
  if (v7 == 138)
  {
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        double v12 = [[SKUIViewTextProperties alloc] initWithTextLayout:v11 isExpanded:[(SKUIViewElementLayoutContext *)self isEditorialLayoutExpanded:v10]];
LABEL_10:
        double v8 = v12;
LABEL_12:
    ...
    {
      double v11 = [(SKUIViewElementTextLayoutCache *)self->_labelLayoutCache layoutForWidth:(uint64_t)a4 viewElement:v6];
      if (v11)
      {
        double v12 = [[SKUIViewTextProperties alloc] initWithStringLayout:v11];
        goto LABEL_10;
      }
    }
    double v8 = 0;
  ...
  if (v7 == 135)
  {
    double v8 = +[SKUIStarRatingViewElementView textPropertiesForViewElement:v6 width:self context:a4];
  }
  else
  {
    double v8 = 0;
...
LABEL_9:
  uint64_t v7 = [(SKUIResourceLoader *)self->_resourceLoader requestIdentifierForCacheKey:v6];
...
+ (double)_calculateValueFromString:(id)a3 withDefault:(double)a4 coefficent:(double)a5
{
  ...
  if ([v7 length])
  {
    ...
    CGFloat v10 = (void *)[objc_alloc(MEMORY[0x1E4F28FE8]) initWithString:v9];
    double v14 = 0.0;
    a4 = 0.0;
...
- (BOOL)_loadImageForURL:(id)a3 cacheKey:(id)a4 dataConsumer:(id)a5 reason:(int64_t)a6
{
  ...
  id v11 = a4;
  id v12 = a5;
  double v13 = [(SKUIResourceLoader *)self->_resourceLoader requestIdentifierForCacheKey:v11];
  double v14 = v13;
  if (v13
    && -[SKUIResourceLoader trySetReason:forRequestWithIdentifier:](self->_resourceLoader, "trySetReason:forRequestWithIdentifier:", a6, [v13 unsignedIntegerValue]))
  {
  ...
  {
    double v16 = objc_alloc_init(SKUIArtworkRequest);
    [(SKUIResourceRequest *)v16 setCacheKey:v11];
    [(SKUIArtworkRequest *)v16 setDataConsumer:v12];
    [(SKUIArtworkRequest *)v16 setURL:v10];
    double v17 = objc_msgSend(objc_alloc(NSNumber), "initWithUnsignedInteger:", -[SKUIResourceRequest requestIdentifier](v16, "requestIdentifier"));
    [(NSMutableSet *)self->_observedArtworkRequestIDs addObject:v17];
    BOOL v15 = [(SKUIResourceLoader *)self->_resourceLoader loadResourceWithRequest:v16 reason:a6];
  }
  return v15;
}
...
- (CGSize)_sizeForImageElement:(id)a3 applyTransform:(BOOL)a4
{
  ...
  if (v7 == *MEMORY[0x1E4F1DB30] && v6 == *(double *)(MEMORY[0x1E4F1DB30] + 8))
  {
    ...
    if (v11)
    {
      double v13 = SKUIImageWithResourceName(v11);
      if (v13)
      {
        double v14 = v13;
        [v13 size];
