@interface SKUISizingEntityValueProvider
...
@implementation SKUISizingEntityValueProvider
...
- (id)initForViewElement:(id)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)SKUISizingEntityValueProvider;
  v5 = [(SKUISizingEntityValueProvider *)&v11 init];
  if (v5)
  {
    ...
    v9[1] = 3221225472;
    v9[2] = __52__SKUISizingEntityValueProvider_initForViewElement___block_invoke;
    v9[3] = &unk_1E6423570;
    v10 = v5;
...
uint64_t __52__SKUISizingEntityValueProvider_initForViewElement___block_invoke(uint64_t a1, uint64_t a2)
{
...
- (void)initForViewElement:.cold.1()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  int v0 = 136446210;
  v1 = "-[SKUISizingEntityValueProvider initForViewElement:]";
}
