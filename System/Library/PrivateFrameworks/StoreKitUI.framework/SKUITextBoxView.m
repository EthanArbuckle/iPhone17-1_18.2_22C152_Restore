...
- (SKUITextBoxView)initWithFrame:(CGRect)a3
{
  ...
  if (v8)
  {
    ...
    *(_OWORD *)&v8->_contentInsets.top = xmmword_1C1CCB5B0;
    *(_OWORD *)&v8->_contentInsets.bottom = xmmword_1C1CCB3C0;
...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != v5)
  {
    ...
    objc_super v11 = [(SKUIColorScheme *)*p_colorScheme secondaryTextColor];
    if (v11)
    {
    ...
    {
      v12 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.5];
    ...
    {
      v18 = [(SKUITextBoxView *)self tintColor];
      [(UILabel *)moreButtonLabel setTextColor:v18];
    }
    v19 = self->_moreButtonLabel;
    v20 = [(SKUIColorScheme *)*p_colorScheme secondaryTextColor];
    if (v20)
    {
...
{
  id v6 = a3;
  id v4 = [(SKUITextBoxView *)self moreButtonTitle];
  ...
  if (v4 != v16 && ([v4 isEqualToString:v16] & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!ratingLabel)
      {
        ...
        {
          v15 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.8];
  ...
  if (v4 != v16 && ([v4 isEqualToString:v16] & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!subtitleLabel)
      {
        ...
        objc_super v11 = [MEMORY[0x1E4FB08E0] systemFontOfSize:12.0];
        [(UILabel *)v10 setFont:v11];
        ...
        {
          v15 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.5];
          [(UILabel *)v12 setTextColor:v15];
        }
...
- (void)setTextFrameWithText:(id)a3
{
  ...
  if (self->_underlyingText != v4)
  {
    ...
    id v4 = (NSString *)[(SKUITextBoxView *)self setNeedsDisplay];
    v5 = v9;
  }
  ...
  if (v4 != v19 && ([v4 isEqualToString:v19] & 1) == 0)
  {
    if (v19)
    {
      ...
      if (!titleLabel)
      {
        ...
        v9 = self->_titleLabel;
        v10 = [(SKUITextBoxView *)self backgroundColor];
        ...
        id v16 = [(SKUIColorScheme *)self->_colorScheme secondaryTextColor];
        if (v16)
        {
...
- (void)drawRect:(CGRect)a3
{
  ...
  if (titleTextFrame)
  {
    ...
    length = v87;
    id v16 = (CGPoint *)&v87[-2 * MEMORY[0x1F4188790]()];
    v98.location = 0;
    v98.length = Count;
    ...
    *(_OWORD *)&v96.tCGFloat x = v13[2];
    ...
    id v19 = [(SKUIColorScheme *)self->_colorScheme secondaryTextColor];
    v20 = v19;
    if (v19)
    {
      [v19 set];
  ...
  *(_OWORD *)&v96.tCGFloat x = v13[2];
  ...
  {
    v38 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.8];
    [v38 set];
  }
  ratingImageView = self->_ratingImageView;
  CGFloat v93 = v7;
...
LABEL_57:
    ...
    {
      v61 = +[SKUITextLayout newAttributedStringWithText:@"…"];
    ...
    v64 = [(SKUITextBoxView *)self _moreButtonLabel];
    [v64 frame];
    double v66 = v65;
    double v68 = v67;
...
LABEL_52:
        ...
        if (v64)
        {
          ...
          v82 = [MEMORY[0x1E4FB1BA8] mainScreen];
          [v82 scale];
          BOOL v84 = v83 == 1.0;
          float v85 = 3.5;
          if (v84) {
...
- (void)layoutSubviews
{
  ...
  v13 = (CGFloat *)MEMORY[0x1E4F1DB28];
  ...
  CFIndex v23 = self->_subtitleLabel;
  ...
  if (v15 <= 0.0) {
    double v25 = v6 - left - self->_contentInsets.right;
  }
  else {
    double v25 = v22 + -5.0 - left;
  }
  ...
  if (v9)
  {
    if (v11)
    {
      double v27 = [MEMORY[0x1E4FB16C8] currentDevice];
  ...
  if (ratingImageView)
  {
    ...
    if (v38)
    {
      CGFloat v40 = self->_contentInsets.left;
      float v41 = (v39 - v37) * 0.5;
      double v42 = v29 + floorf(v41) + 2.0;
  ...
  if (v43)
  {
    if (self->_ratingImageView)
    {
      ...
      double v44 = CGRectGetMaxX(v58) + 5.0;
      double v43 = self->_ratingLabel;
    }
    else
    {
      double v44 = self->_contentInsets.left;
    }
    float v45 = (v39 - v32) * 0.5;
...
LABEL_43:
  ...
  CFArrayRef Lines = CTFrameGetLines(v46);
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (self->_titleLabel)
  {
    double v8 = objc_msgSend(MEMORY[0x1E4FB16C8], "currentDevice", a3.width, a3.height);
...
- (id)_moreButtonLabel
{
  ...
  if (!moreButtonLabel)
  {
    ...
    double v7 = [MEMORY[0x1E4FB08E0] systemFontOfSize:12.0];
    [(UILabel *)v6 setFont:v7];

    [(UILabel *)self->_moreButtonLabel setHidden:self->_truncationStyle == 1];
    double v8 = self->_moreButtonLabel;
    double v9 = [(SKUIColorScheme *)self->_colorScheme secondaryTextColor];
    if (v9)
    {
    ...
    double v12 = [(SKUIColorScheme *)self->_colorScheme secondaryTextColor];
    if (v12)
    {
...
- (__CTFrame)_textFrame
{
  ...
  if (!result)
  {
    if (self->_underlyingText)
    {
      ...
      id v5 = +[SKUITextLayout newAttributedStringWithText:self->_underlyingText];
...
- (CGSize)_textSizeToFitSize:(CGSize)a3
{
  if (self->_underlyingText)
  {
    ...
    id v5 = +[SKUITextLayout newAttributedStringWithText:](SKUITextLayout, "newAttributedStringWithText:");
    objc_super v6 = CTFramesetterCreateWithAttributedString(v5);
    v24.location = 0;
    v24.length = 0;
