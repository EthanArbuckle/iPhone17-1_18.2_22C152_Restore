...
- (SKUIGiftComposeViewController)initWithGift:(id)a3 configuration:(id)a4
{
  ...
  if (v8)
  {
    ...
    v12 = +[SKUIClientContext localizedStringForKey:@"GIFTING_FLOW_TITLE" inBundles:0 inTable:@"Gifting"];
    }
    ...
    [v17 addObserver:v8 selector:sel__keyboardChangeNotification_ name:*MEMORY[0x1E4FB2BC0] object:0];
    [v17 addObserver:v8 selector:sel__keyboardChangeNotification_ name:*MEMORY[0x1E4FB2BC8] object:0];
    ...
    [v17 addObserver:v8 selector:sel__textFieldChangeNotification_ name:*MEMORY[0x1E4FB3018] object:0];
    [v17 addObserver:v8 selector:sel__textFieldChangeNotification_ name:*MEMORY[0x1E4FB3020] object:0];
    [v17 addObserver:v8 selector:sel__textViewChangeNotification_ name:*MEMORY[0x1E4FB30A0] object:0];
    [v17 addObserver:v8 selector:sel__textViewDidEndEditingNotification_ name:*MEMORY[0x1E4FB30A8] object:0];
  }
  else
  {
    v11 = v6;
...
- (void)dealloc
{
  ...
  [v3 removeObserver:self name:*MEMORY[0x1E4FB3020] object:0];
  [v3 removeObserver:self name:*MEMORY[0x1E4FB30A0] object:0];
  [v3 removeObserver:self name:*MEMORY[0x1E4FB30A8] object:0];
  ...
  id v6 = [(SKUIGiftAmountSection *)self->_amountSection amountControl];
...
- (void)loadView
{
  ...
  if (!tableView)
  {
    v4 = [MEMORY[0x1E4FB1618] _systemBackgroundColor];
    ...
    v10 = (UITableView *)objc_alloc_init(MEMORY[0x1E4FB1D00]);
    v11 = self->_tableView;
    self->_tableView = v10;
  ...
  v16 = +[SKUIClientContext localizedStringForKey:@"GIFTING_BACK_BUTTON" inBundles:0 inTable:@"Gifting"];
  }
  [v15 setBackButtonTitle:v16];

  [v15 setHidesBackButton:1];
  id v17 = objc_alloc_init(MEMORY[0x1E4FB14A8]);
  ...
  v18 = +[SKUIClientContext localizedStringForKey:@"GIFTING_CANCEL_BUTTON" inBundles:0 inTable:@"Gifting"];
  }
  [v17 setTitle:v18];

  [v15 setLeftBarButtonItem:v17];
  v19 = (UIBarButtonItem *)objc_alloc_init(MEMORY[0x1E4FB14A8]);
  ...
  v22 = +[SKUIClientContext localizedStringForKey:@"GIFTING_NEXT_BUTTON" inBundles:0 inTable:@"Gifting"];
  }
    ...
    do
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if ([(UITableView *)self->_tableView numberOfRowsInSection:v7])
        {
          ...
          {
            tableView = self->_tableView;
            v12 = [MEMORY[0x1E4F28D58] indexPathForRow:v10 inSection:v7];
...
{
  id v5 = a4;
  id v6 = [(SKUIGiftStepViewController *)self gift];
...
- (void)tableView:(id)a3 giftRecipientCell:(id)a4 didUpdateSearchController:(id)a5
{
  ...
  if ([v7 numberOfResults])
  {
    ...
    if (v9 == 1)
    {
      ...
      {
        id v10 = objc_alloc(MEMORY[0x1E4FB1AF8]);
    ...
    else if (!self->_searchResultsView)
    {
      ...
      v37 = [MEMORY[0x1E4FB18E0] activeKeyboard];
      [v37 frame];
      double v39 = v38;
      double v41 = v40;
      double v43 = v42;
...
- (void)tableView:(id)a3 giftRecipientCell:(id)a4 presentContactPicker:(id)a5
{
  ...
  if (v9)
  {
    ...
    {
      id v10 = (UIPopoverController *)[objc_alloc(MEMORY[0x1E4FB1AF8]) initWithContentViewController:v7];
      peoplePickerPopover = self->_peoplePickerPopover;
...
{
  id v5 = a4;
  uint64_t v6 = [(SKUIGiftStepViewController *)self gift];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if (v5 == [(SKUITableViewSection *)self->_addressingSection sectionIndex]
    && [v6 row] == 2)
  {
...
- (void)_amountControlAction:(id)a3
{
  ...
  id v4 = [(SKUIGiftAmountSection *)self->_amountSection selectedAmountString];
...
{
  id v6 = a3;
  id v4 = [(SKUIGiftComposeViewController *)self view];
...
{
  id v4 = [a3 userInfo];
  id v35 = [v4 objectForKey:*MEMORY[0x1E4FB2BD8]];
  ...
  if (v35)
  {
    ...
    double v15 = [(SKUIGiftComposeViewController *)self view];
  ...
  if (v5)
  {
    ...
    if (v21)
    {
      ...
      if (v23 == [(SKUITableViewSection *)self->_addressingSection sectionIndex])
      {
        ...
        double v25 = [(SKUIGiftStepViewController *)self gift];
...
- (void)_textFieldChangeNotification:(id)a3
{
  id v27 = a3;
  id v4 = [v27 object];
  int v5 = [(SKUIGiftComposeViewController *)self view];
  ...
  if (v6)
  {
    ...
    if (v21)
    {
      ...
      if (v23 == [(SKUITableViewSection *)self->_addressingSection sectionIndex])
      {
        ...
        double v26 = [v27 name];
        -[SKUIGiftComposeViewController _validateGiftThrottled:](self, "_validateGiftThrottled:", [v26 isEqualToString:*MEMORY[0x1E4FB3018]]);
      }
    }
  }
}
...
{
  id v9 = [a3 object];
  id v4 = [(SKUIGiftAddressingSection *)self->_addressingSection messagingTextView];

  int v5 = v9;
  if (v9 == v4)
  {
    int v6 = [v9 text];
    double v7 = [(SKUIGiftStepViewController *)self gift];
    if ([v6 length]) {
      double v8 = v6;
    }
    else {
...
- (void)_finishValidationWithResponse:(id)a3 error:(id)a4
{
  ...
  int v6 = [(SKUIGiftStepViewController *)self gift];
  double v7 = [(SKUIGiftValidationResponse *)self->_lastValidationResponse totalGiftAmountString];
...
- (id)_headerView
{
  ...
  if (v4)
  {
    int v5 = [(SKUIGiftComposeViewController *)self _itemView];
  }
  else
  {
    int v6 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
    id v7 = objc_alloc(MEMORY[0x1E4FB1838]);
    id v8 = [MEMORY[0x1E4FB1818] imageNamed:@"GiftCardGraphic" inBundle:v6];
...
- (id)_itemImage
{
  ...
  if (!v3)
  {
    id v4 = [(SKUIGiftItemView *)self->_itemView artworkContext];
    int v5 = [(SKUIGiftStepViewController *)self gift];
    int v6 = [v5 item];
...
- (id)_itemView
{
  ...
  if (!v6)
  {
    ...
    id v8 = [(SKUIGiftStepViewController *)self giftConfiguration];
    id v9 = [v8 clientContext];
    double v10 = [(SKUIGiftItemView *)v7 initWithStyle:0 item:v4 clientContext:v9];
    ...
    double v17 = [(SKUIGiftComposeViewController *)self _itemImage];
...
- (void)_pushThemePickerOrShowInvalidAlert
{
  ...
  {
    id v15 = [(SKUIGiftStepViewController *)self gift];
    BOOL v3 = [SKUIGiftThemePickerViewController alloc];
    id v4 = [(SKUIGiftStepViewController *)self giftConfiguration];
    int v5 = [(SKUIGiftThemePickerViewController *)v3 initWithGift:v15 configuration:v4];

    BOOL v6 = [(SKUIGiftStepViewController *)self operationQueue];
    [(SKUIGiftStepViewController *)v5 setOperationQueue:v6];

    id v7 = [(SKUIGiftComposeViewController *)self navigationController];
  ...
  else
  {
    ...
    double v10 = +[SKUIClientContext localizedStringForKey:@"GIFTING_INVALID_GIFT" inBundles:0 inTable:@"Gifting"];
    }
    double v11 = [(SKUIGiftValidationResponse *)self->_lastValidationResponse errorString];
    ...
    double v13 = +[SKUIClientContext localizedStringForKey:@"GIFTING_OK_BUTTON" inBundles:0 inTable:@"Gifting"];
    }
...
- (void)_reloadSections
{
  id v24 = [(SKUIGiftStepViewController *)self gift];
  BOOL v3 = [(SKUIGiftStepViewController *)self giftConfiguration];
  ...
  {
    id v7 = [[SKUIGiftAddressingSection alloc] initWithGiftConfiguration:v3];
  ...
  if (!v9)
  {
    ...
    if (!amountSection)
    {
      double v11 = [(SKUIGiftTableViewSection *)[SKUIGiftAmountSection alloc] initWithGiftConfiguration:v3];
      double v12 = self->_amountSection;
      self->_amountSection = v11;

      double v13 = [(SKUIGiftAmountSection *)self->_amountSection amountControl];
  ...
  if (!sendDateSection)
  {
    id v15 = [(SKUIGiftTableViewSection *)[SKUIGiftSendDateSection alloc] initWithGiftConfiguration:v3];
  ...
  if (!termsSection)
  {
    double v22 = [(SKUIGiftTableViewSection *)[SKUIGiftTermsAndConditionsSection alloc] initWithGiftConfiguration:v3];
...
- (void)_validateGift
{
  ...
  if (!self->_validator)
  {
    int v5 = [(SKUIGiftStepViewController *)self giftConfiguration];
    id v6 = [SKUIGiftValidator alloc];
    id v7 = [v5 giftValidationURL];
    id v8 = [v5 clientContext];
    id v9 = [(SKUIGiftValidator *)v6 initWithValidationURL:v7 clientContext:v8];
    validator = self->_validator;
    self->_validator = v9;

    double v11 = self->_validator;
    double v12 = [(SKUIGiftStepViewController *)self operationQueue];
    [(SKUIGiftValidator *)v11 setOperationQueue:v12];
  }
  objc_initWeak(&location, self);
  double v13 = self->_validator;
  double v14 = [(SKUIGiftStepViewController *)self gift];
...
- (void)_validateGiftThrottled:(BOOL)a3
{
  ...
  id v11 = [(SKUIGiftComposeViewController *)self nextButton];
  [v11 setEnabled:v10];
  ...
  if (v10)
  {
    if (a3)
    {
      ...
      {
        id v16 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, MEMORY[0x1E4F14428]);
