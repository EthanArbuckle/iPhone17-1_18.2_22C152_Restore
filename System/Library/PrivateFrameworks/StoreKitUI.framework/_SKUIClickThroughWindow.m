...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  if (v8)
  {
    ...
    -[_SKUIClickThroughWindow convertPoint:toView:](self, "convertPoint:toView:", v9, x, y);
    double v11 = v10;
    double v13 = v12;
...
{
  v9.receiver = self;
  v9.super_class = (Class)_SKUIClickThroughWindow;
  -[_SKUIClickThroughWindow hitTest:withEvent:](&v9, sel_hitTest_withEvent_, a4, a3.x, a3.y);
  v5 = (_SKUIClickThroughWindow *)objc_claimAutoreleasedReturnValue();
  v6 = v5;
  if (v5 == self) {
    id v7 = 0;
  }
