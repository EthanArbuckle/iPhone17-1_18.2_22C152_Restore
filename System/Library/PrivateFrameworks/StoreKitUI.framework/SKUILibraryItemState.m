...
- (SKUILibraryItemState)initWithApplication:(id)a3;
...
- (SKUILibraryItemState)initWithApplication:(id)a3
{
  ...
  v17.receiver = self;
  v17.super_class = (Class)SKUILibraryItemState;
  v5 = [(SKUILibraryItemState *)&v17 init];
  v6 = v5;
  if (v5)
  {
    v5->_availability = 2;
    uint64_t v7 = [v4 valueForProperty:*MEMORY[0x1E4FA8928]];
    bundleIdentifier = v6->_bundleIdentifier;
    v6->_bundleIdentifier = (NSString *)v7;

    uint64_t v9 = [v4 valueForProperty:*MEMORY[0x1E4FA8930]];
    bundleVersion = v6->_bundleVersion;
    v6->_bundleVersion = (NSString *)v9;

    uint64_t v11 = [v4 valueForProperty:*MEMORY[0x1E4FA8940]];
    ...
    uint64_t v14 = [v4 valueForProperty:*MEMORY[0x1E4FA8950]];
...
- (id)newJavaScriptRepresentation
{
  ...
  if (self->_highDefinition) {
    [v4 setObject:MEMORY[0x1E4F1CC38] forKey:@"isHD"];
  }
  if (self->_preview) {
    [v4 setObject:MEMORY[0x1E4F1CC38] forKey:@"preview"];
  }
  if (self->_rental) {
    [v4 setObject:MEMORY[0x1E4F1CC38] forKey:@"rental"];
  }
