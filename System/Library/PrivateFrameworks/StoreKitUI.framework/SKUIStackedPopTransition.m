...
- (void)animateTransition:(id)a3
{
  ...
  v20 = (void *)[objc_alloc(MEMORY[0x1E4FB1838]) initWithImage:v19];
  ...
  v26 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.3];
  ...
  v38 = (void *)[objc_alloc(MEMORY[0x1E4FB1838]) initWithImage:v36];
  [v38 frame];
  double v40 = v39;
  double v42 = v41;
  ...
  [v9 addSubview:v38];
  v84 = v37;
  v44 = (void *)[objc_alloc(MEMORY[0x1E4FB1838]) initWithImage:v37];
  [v44 frame];
  double v46 = v45;
  double v48 = v47;
  v120.origin.x = v11;
  ...
  v82 = v44;
  [v9 addSubview:v44];
  v49 = objc_alloc_init(SKUIStackedBar);
  [(SKUIStackedBar *)v49 setSplitViewStyle:[(SKUIStackedBar *)self->_fromBar splitViewStyle]];
  [(SKUIStackedBar *)v49 setHidesStatusBar:1];
  v50 = [(SKUIStackedBar *)self->_fromBar items];
  -[SKUIStackedBar setAlwaysShowsBackButton:](v49, "setAlwaysShowsBackButton:", (unint64_t)[v50 count] > 1);

  v51 = [(SKUIStackedBar *)self->_fromBar items];
  v52 = [v51 lastObject];
  v119[0] = v52;
  v53 = [MEMORY[0x1E4F1C978] arrayWithObjects:v119 count:1];
  v54 = SKUINavigationItemsShallowCopy(v53);
  [(SKUIStackedBar *)v49 setItems:v54];

  [(SKUIStackedBar *)v49 sizeToFit];
  [v9 addSubview:v49];
  [(SKUIStackedBar *)v49 frame];
  double v56 = v55;
  -[SKUIStackedBar setFrame:](v49, "setFrame:", v11, v34 - v55, v28);
  v85 = v36;
  v57 = (void *)[objc_alloc(MEMORY[0x1E4FB1838]) initWithImage:v36];
  objc_msgSend(v57, "setFrame:", v11, v43, v40, v42);
  [v57 setAlpha:0.0];
  [v9 addSubview:v57];
  v58 = objc_alloc_init(SKUIStackedBar);
  [(SKUIStackedBar *)v58 setSplitViewStyle:[(SKUIStackedBar *)self->_toBar splitViewStyle]];
  v59 = [(SKUIStackedBar *)self->_toBar items];
  v60 = SKUINavigationItemsShallowCopy(v59);
  [(SKUIStackedBar *)v58 setItems:v60];

  [(SKUIStackedBar *)v58 setLastItemExpanded:0];
  if ([(SKUIStackedBar *)self->_toBar splitViewStyle]) {
    [(SKUIStackedBar *)v58 setZeroHeightWhenFirstChildExpanded:1];
  }
  [(SKUIStackedBar *)v58 frame];
  -[SKUIStackedBar sizeThatFits:](v58, "sizeThatFits:", *(double *)(MEMORY[0x1E4F1DB10] + 16), *(double *)(MEMORY[0x1E4F1DB10] + 24));
  [(SKUIStackedBar *)self->_fromBar frame];
  [(SKUIStackedBar *)v58 setFrame:v11];
  [v9 addSubview:v58];
  [v97 removeFromSuperview];
  [(SKUIStackedBar *)v58 setLastItemExpanded:1 animated:1];
  id v61 = SKUIStackedBarSpringAnimationForExpandCollapse(v49, v11, rect + split - v56 + -1.0);
  id v62 = SKUIStackedBarSpringAnimationForExpandCollapse(v96, v11, rect + split);
  id v63 = SKUIStackedBarSpringAnimationForExpandCollapse(v25, v11, rect + split);
  id v64 = SKUIStackedBarSpringAnimationForExpandCollapse(v79, v11, rect);
  id v65 = SKUIStackedBarSpringAnimationForExpandCollapse(v57, v11, rect);
  id v66 = SKUIStackedBarSpringAnimationForExpandCollapse(v82, v11, MaxY);
  v67 = (void *)MEMORY[0x1E4FB1EB0];
  v113[0] = MEMORY[0x1E4F143A8];
  v113[1] = 3221225472;
  v113[2] = __46__SKUIStackedPopTransition_animateTransition___block_invoke;
  v113[3] = &unk_1E6421FF8;
  id v68 = v57;
  id v114 = v68;
  id v69 = v25;
  id v115 = v69;
  [v67 animateWithDuration:v113 animations:0.2];
  [(SKUIStackedPopTransition *)self transitionDuration:v89];
