...
- (SKUISearchItem)initWithLookupDictionary:(id)a3;
...
- (SKUISearchItem)initWithLookupDictionary:(id)a3
{
  ...
  v41.receiver = self;
  v41.super_class = (Class)SKUISearchItem;
  v5 = [(SKUIItem *)&v41 initWithLookupDictionary:v4];
  if (v5)
  {
    id v6 = objc_alloc_init(MEMORY[0x1E4F1CA48]);
    v7 = SKUIItemScreenshotsForDictionary(v4);
    long long v37 = 0u;
    long long v38 = 0u;
    long long v39 = 0u;
    long long v40 = 0u;
        ...
        if (v21)
        {
          ...
          do
          {
            for (uint64_t j = 0; j != v22; ++j)
            {
              ...
              if (objc_opt_isKindOfClass())
              {
                v28 = [[SKUIItem alloc] initWithLookupDictionary:v27];
                if (v28) {
...
- (void)initWithLookupDictionary:.cold.1()
{
  ...
  int v0 = 136446210;
  v1 = "-[SKUISearchItem initWithLookupDictionary:]";
}
