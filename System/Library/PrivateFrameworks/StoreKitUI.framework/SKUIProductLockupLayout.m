...
- (SKUIProductLockupLayout)initWithLockup:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v85.receiver = self;
  v85.super_class = (Class)SKUIProductLockupLayout;
  v57 = [(SKUIProductLockupLayout *)&v85 init];
  if (v57)
  {
    char v62 = [v56 containsElementGroups];
    objc_storeStrong((id *)&v57->_layoutContext, a5);
    v8 = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E4F1CA48]);
    p_bottomLeftViewElements = (void **)&v57->_bottomLeftViewElements;
    bottomLeftViewElements = v57->_bottomLeftViewElements;
    v57->_bottomLeftViewElements = v8;

    v11 = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E4F1CA48]);
    bottomRightViewElements = v57->_bottomRightViewElements;
    p_bottomRightViewElements = (id *)&v57->_bottomRightViewElements;
    v57->_bottomRightViewElements = v11;

    v13 = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E4F1CA48]);
    middleLeftViewElements = v57->_middleLeftViewElements;
    p_middleLeftViewElements = (id *)&v57->_middleLeftViewElements;
    v57->_middleLeftViewElements = v13;

    v15 = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E4F1CA48]);
    p_topLeftViewElements = (id *)&v57->_topLeftViewElements;
    topLeftViewElements = v57->_topLeftViewElements;
    v57->_topLeftViewElements = v15;

    v18 = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E4F1CA48]);
    topRightViewElements = v57->_topRightViewElements;
    p_topRightViewElements = (id *)&v57->_topRightViewElements;
    v57->_topRightViewElements = v18;
    ...
    v84 = v57->_bottomRightViewElements;
    uint64_t v73 = 0;
    v74 = (id *)&v73;
    uint64_t v75 = 0x3032000000;
    v76 = __Block_byref_object_copy__63;
    v77 = __Block_byref_object_dispose__63;
    v78 = v57->_middleLeftViewElements;
    if (a4 < 512.0)
    {
      objc_storeStrong(v80 + 5, v57->_bottomRightViewElements);
      v20 = *p_bottomLeftViewElements;
      v21 = v74;
    }
    else
    {
      v57->_bottomLeftLayoutStyle = 2;
      v20 = v57->_bottomLeftViewElements;
      v21 = v80;
    }
    v22 = v21 + 5;
    id v23 = v20;
    ...
    *v22 = v23;
    ...
    v67[1] = 3221225472;
    v67[2] = __56__SKUIProductLockupLayout_initWithLockup_width_context___block_invoke;
    v67[3] = &unk_1E6428458;
    v26 = v57;
    BOOL v72 = a4 < 512.0;
    v68 = v26;
    ...
    id v27 = v25;
    id v69 = v27;
    [v56 enumerateChildrenUsingBlock:v67];
    v28 = (SKUIViewElement *)*p_topLeftViewElements;
    long long v63 = 0u;
    long long v64 = 0u;
    long long v65 = 0u;
    long long v66 = 0u;
    ...
    if (v30)
    {
      ...
      while (1)
      {
        ...
        while (2)
        {
          ...
          v36 = (id *)&v57->_bottomLeftViewElements;
          switch(v35)
          {
            case 2:
            case 6:
              v36 = (id *)&v57->_topLeftViewElements;
              goto LABEL_19;
            case 3:
            case 8:
              goto LABEL_19;
            case 4:
              v36 = (id *)&v57->_middleLeftViewElements;
              goto LABEL_19;
            case 7:
              v36 = (id *)&v57->_topRightViewElements;
              goto LABEL_19;
            case 9:
              v36 = (id *)&v57->_bottomRightViewElements;
LABEL_19:
              id v37 = *v36;
              if (!v37) {
                goto LABEL_21;
...
LABEL_21:
              ...
              if (v39 > 108)
              {
                if (v39 <= 134)
                {
                  v42 = (void **)&v57->_bottomRightViewElements;
                  if (v39 != 109)
                  {
                    if (v39 != 127) {
                      goto LABEL_56;
              ...
              else
              {
                if (v39 > 48)
                {
                  ...
                  else
                  {
                    ...
                    {
LABEL_59:
                      if (v58->_productImageElement) {
                        goto LABEL_55;
                      }
                      v46 = v33;
                      productImageElement = v58->_productImageElement;
                      v58->_productImageElement = v46;
                      goto LABEL_63;
                    }
                    if (v39 != 50) {
                      goto LABEL_56;
...
LABEL_52:
                  if ((v62 & 1) == 0)
                  {
                    v45 = (SKUIViewElement *)v74[5];

                    v28 = v45;
                  }
LABEL_54:
                  [(SKUIViewElement *)v28 addObject:v33];
                  goto LABEL_55;
                }
                if (v39 > 12)
                {
...
LABEL_56:
              ...
              uint64_t v49 = [v29 countByEnumeratingWithState:&v63 objects:v86 count:16];
              uint64_t v30 = v49;
              if (!v49) {
                goto LABEL_65;
              }
...
- (void)enumerateViewElementsForWidth:(double)a3 usingBlock:(id)a4
{
  ...
  v6 = (void (**)(id, SKUIViewElement *, uint64_t, uint64_t))a4;
  uint64_t v25 = 0;
  v26 = &v25;
...
uint64_t __68__SKUIProductLockupLayout_enumerateViewElementsForWidth_usingBlock___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, unsigned char *a4)
{
...
- (SKUIProductLockupLayoutSizing)layoutWidthsForWidth:(SEL)a3
{
  ...
  -[SKUIProductLockupLayout _sizeForVerticalViewElements:width:](self, "_sizeForVerticalViewElements:width:", self->_bottomRightViewElements);
  double v9 = v8;
  ...
  uint64_t result = (SKUIProductLockupLayoutSizing *)[(SKUIProductLockupLayout *)self hasBottomRightElementWithRightAlignment];
  if (result)
  {
    if (v15 >= v14) {
      double v17 = v15;
...
- (BOOL)hasBottomRightElementWithRightAlignment
{
  ...
  BOOL v3 = [v2 indexOfObjectPassingTest:&__block_literal_global_38] != 0x7FFFFFFFFFFFFFFFLL;
...
- (double)metadataWidthForWidth:(double)a3
{
  ...
  {
    -[SKUIViewElementLayoutContext sizeForViewElement:width:](self->_layoutContext, "sizeForViewElement:width:", a3);
    return v3 - (v4 + 13.0);
  }
  return v3;
}
...
- (SKUIProductLockupLayoutSizing)sizingToFitWidth:(SEL)a3
{
    ...
    if (v22)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v23; ++i)
        {
          ...
          -[SKUIProductLockupLayout _sizeForViewElement:width:](self, "_sizeForViewElement:width:", *(void *)(*((void *)&v31 + 1) + 8 * i), v7, (void)v31);
          if (v25 < v27) {
            double v25 = v27;
          }
  ...
  {
    uint64_t result = (SKUIProductLockupLayoutSizing *)[(SKUIProductLockupLayout *)self _sizeForVerticalViewElements:self->_bottomLeftViewElements width:v7];
...
- (double)topPaddingForViewElement:(id)a3
{
  ...
  if (v5 == 8)
  {
    ...
    {
      double v6 = [v4 style];
      double v7 = SKUIViewElementFontWithStyle(v6);
      ...
      {
        CGFloat v10 = SKUIFontForTextStyle(2);
        [v10 _bodyLeading];
        double v9 = v11;
      }
...
uint64_t __52__SKUIProductLockupLayout_topPaddingForViewElement___block_invoke(uint64_t a1, uint64_t a2, unsigned char *a3)
{
  ...
  switch(a3)
  {
    ...
    case 3:
      if (self->_productImageElement)
      {
        ...
        self = [MEMORY[0x1E4F1C978] arrayWithObjects:v5 count:1];
      }
      else
      {
        self = 0;
...
{
  id v5 = a3;
  uint64_t v6 = [[SKUISegmentedControlViewElementController alloc] initWithViewElement:v5];

  [(SKUISegmentedControlViewElementController *)v6 setDesiredSegmentWidth:40.0];
  double v7 = [(SKUISegmentedControlViewElementController *)v6 segmentedControlView];
