...
+ (BOOL)shouldCollectPageRenderData
{
  ...
  v4 = [MEMORY[0x1E4FA8258] sharedInstance];
...
+ (id)_sampleWindowStartTime
{
  v2 = (void *)CFPreferencesCopyAppValue(@"SKUIMetricsPageRenderEventSampleWindowStartTime", (CFStringRef)*MEMORY[0x1E4FA89F8]);
...
- (void)appendSamplingPropertiesFromClientContext:(id)a3
{
  double v4 = [a3 existingBagValueForKey:*MEMORY[0x1E4FA88F8]];
  double v5 = v4;
  if (!v4)
  {
...
- (void)appendPropertiesToBody:(id)a3
{
  ...
  {
    double v5 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_domChanges, "count"));
    long long v24 = 0u;
    long long v25 = 0u;
    long long v26 = 0u;
    long long v27 = 0u;
  ...
  {
    double v12 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_requests, "count"));
    long long v20 = 0u;
    long long v21 = 0u;
    long long v22 = 0u;
    long long v23 = 0u;
...
- (NSString)description
{
  ...
  double v5 = [(SKUIMetricsPageRenderEvent *)self clientCorrelationKey];
  [v3 appendFormat:@"\nclientCorrelationKey = %@", v5];

  double v6 = [(SKUIMetricsPageRenderEvent *)self launchCorrelationKey];
  ...
  BOOL v13 = [(SKUIMetricsPageRenderEvent *)self platformResponseWasCached];
  uint64_t v14 = @"NO";
  if (v13) {
    uint64_t v14 = @"YES";
  }
  ...
  BOOL v40 = [(SKUIMetricsPageRenderEvent *)v47 xpSamplingForced];
  v41 = @"NO";
  if (v40) {
    v41 = @"YES";
  }
...
- (void)populateObjectInspector:(id)a3
{
  ...
  *(double *)&aBlock[4] = v6;
  ...
  uint64_t v9 = (void *)MEMORY[0x1E4F28C10];
  uint64_t v10 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSince1970:v6];
  ...
  uint64_t v23 = [(SKUIMetricsPageRenderEvent *)self domChanges];
  ...
  uint64_t v26 = [(SKUIMetricsPageRenderEvent *)self requests];
  ...
  id v40 = v24;
  v41 = v25;
  id v42 = &__block_literal_global_209;
  id v27 = v24;
  uint64_t v28 = v25;
