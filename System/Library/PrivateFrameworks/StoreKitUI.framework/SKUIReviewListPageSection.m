...
- (id)cellForIndexPath:(id)a3
{
  ...
  v8 = [v7 viewElement];
  objc_super v9 = [v8 items];
  v10 = [v9 objectAtIndex:v5];

  v11 = [v6 collectionView];
  v12 = [v11 dequeueReusableCellWithReuseIdentifier:0x1F1C929E8 forIndexPath:v4];

  [v12 setSeparatorStyle:5];
  uint64_t v13 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.2];
...
void __46__SKUIReviewListPageSection_cellForIndexPath___block_invoke_2(uint64_t a1)
{
  ...
  objc_super v9 = __Block_byref_object_copy__60;
  v10 = __Block_byref_object_dispose__60;
  id v11 = 0;
  v2 = *(void **)(a1 + 32);
  v5[0] = MEMORY[0x1E4F143A8];
  v5[1] = 3221225472;
  void v5[2] = __46__SKUIReviewListPageSection_cellForIndexPath___block_invoke_6;
  v5[3] = &unk_1E64260A8;
  v5[6] = *(void *)(a1 + 64);
  v5[4] = *(void *)(a1 + 40);
  v5[5] = &v6;
...
void __46__SKUIReviewListPageSection_cellForIndexPath___block_invoke_6(uint64_t a1, void *a2, unsigned char *a3)
{
  id v8 = a2;
...
- (void)registerContextActionsForCell:(id)a3 indexPath:(id)a4 viewController:(id)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v15)
    {
      double v16 = [(SKUIReviewListPageSection *)self _contextActionRegistrationKeyWithCell:v8 indexPath:v9];
      ...
      id v18 = [(SKUIReviewListPageSection *)self contextActionsRegistration];
...
SKUIContextActionsConfiguration *__84__SKUIReviewListPageSection_registerContextActionsForCell_indexPath_viewController___block_invoke(uint64_t a1)
{
  ...
  id v4 = [(SKUIContextActionsConfiguration *)v2 initWithDialogTemplate:v3];
...
{
  id v12 = a5;
  id v8 = [(SKUIReviewListPageSection *)self _contextActionRegistrationKeyWithCell:a3 indexPath:a4];
  unint64_t v9 = [(SKUIReviewListPageSection *)self contextActionsRegistration];
  id v10 = [v9 objectForKeyedSubscript:v8];

  if (v10)
  {
    [v12 unregisterForPreviewing:v10];
    uint64_t v11 = [(SKUIReviewListPageSection *)self contextActionsRegistration];
...
- (void)reloadCellWithIndexPath:(id)a3 reason:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    unint64_t v9 = [(SKUIStorePageSection *)self pageComponent];
...
- (void)willAppearInContext:(id)a3
{
  ...
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x1F1C929E8];
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        +[SKUIReviewCollectionViewCell requestLayoutForViewElement:width:context:](SKUIReviewCollectionViewCell, "requestLayoutForViewElement:width:context:", *(void *)(*((void *)&v15 + 1) + 8 * v14++), self->_cellLayoutContext, v12, (void)v15);
      }
      while (v11 != v14);
