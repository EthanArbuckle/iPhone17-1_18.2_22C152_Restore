@interface SKUIGiftAmountControl
...
- (SKUIGiftAmountControl)initWithGiftConfiguration:(id)a3
{
  ...
  v6 = [(SKUIGiftAmountControl *)&v52 init];
  v7 = v6;
  if (v6)
  {
    ...
    if (v11 >= 1)
    {
      ...
      do
      {
        ...
        -[SKUIGiftAmountButton setTag:](v19, "setTag:", [v20 integerValue]);

        v21 = [v9 objectAtIndex:v16];
        [(SKUIGiftAmountButton *)v19 setTitle:v21 forState:0];

        [(SKUIGiftAmountButton *)v19 sizeToFit];
        [(SKUIGiftAmountControl *)v7 addSubview:v19];
    ...
    id v31 = [MEMORY[0x1E4FB1618] separatorColor];
    ...
    [(SKUIGiftAmountControl *)v7 addSubview:v7->_customAmountBackgroundView];
    v34 = (UITextField *)objc_alloc_init(MEMORY[0x1E4FB1D70]);
    ...
    v37 = [MEMORY[0x1E4FB08E0] systemFontOfSize:18.0];
    ...
    if (v40) {
      objc_msgSend(v40, "localizedStringForKey:inTable:", @"GIFTING_AMOUNT_OTHER", @"Gifting", v30);
    }
    else {
    v42 = +[SKUIClientContext localizedStringForKey:@"GIFTING_AMOUNT_OTHER", 0, @"Gifting", v30 inBundles inTable];
    }
    ...
    v48 = [MEMORY[0x1E4FB1618] placeholderTextColor];
    ...
    [(SKUIGiftAmountControl *)v7 addSubview:v7->_customAmountField];
    v49 = [MEMORY[0x1E4F28EB8] defaultCenter];
    [v49 addObserver:v7 selector:sel__textFieldDidBeginEditing_ name:*MEMORY[0x1E4FB3010] object:v7->_customAmountField];
    [v49 addObserver:v7 selector:sel__textFieldDidChange_ name:*MEMORY[0x1E4FB3018] object:v7->_customAmountField];
    [v49 addObserver:v7 selector:sel__textFieldDidEndEditing_ name:*MEMORY[0x1E4FB3020] object:v7->_customAmountField];
  }
  return v7;
}
...
- (void)dealloc
{
  ...
  [(SKUIGiftAmountControl *)&v9 dealloc];
}
...
- (NSString)selectedAmountString
{
  ...
  {
    v2 = -[SKUIGiftAmountControl viewWithTag:](self, "viewWithTag:");
    v3 = [v2 currentTitle];
  }
  else
  {
...
{
  id v5 = a3;
  uint64_t v6 = [(SKUIGiftAmountControl *)self firstResponder];
  [v6 resignFirstResponder];

  [(SKUIGiftAmountControl *)self _updateButtonsWithTouch:v5];
  return 1;
}
...
- (void)endTrackingWithTouch:(id)a3 withEvent:(id)a4
{
  ...
  [(SKUIGiftAmountControl *)self _reloadSelectedButton];
  if (self->_selectedAmount)
  {
    ...
    id v6 = [MEMORY[0x1E4FB1618] separatorColor];
    objc_msgSend(v5, "setBorderColor:", objc_msgSend(v6, "CGColor"));
  }

  [(SKUIGiftAmountControl *)self sendActionsForControlEvents:4096];
}
...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  uint64_t v7 = (SKUIGiftAmountControl *)objc_claimAutoreleasedReturnValue();
  if (v7)
  {
...
- (void)layoutSubviews
{
  ...
  {
    [(SKUIGiftAmountControl *)self _layoutForPad];
  }
  else
  {
    [(SKUIGiftAmountControl *)self _layoutForPhone];
  }
}

- (void)_layoutForPad
{
  [(SKUIGiftAmountControl *)self bounds];
  double v4 = v3;
  double v6 = v5;
  double v8 = v7;
  double v10 = v9;
  uint64_t v11 = [(SKUIGiftAmountControl *)self effectiveUserInterfaceLayoutDirection];
  ...
  if (v11) {
    +[SKUICGRectHelpers rect:withFlippedOriginXRelativeTo:](SKUICGRectHelpers, "rect:withFlippedOriginXRelativeTo:", v16 + 5.0, v26, v13 + -10.0);
  }
  ...
  if (v28 >= 1)
  {
    ...
    v31[2] = __38__SKUIGiftAmountControl__layoutForPad__block_invoke;
    v31[3] = &unk_1E6424D70;
    v31[4] = v33;
    *(double *)&v31[5] = v4;
    *(double *)&v31[6] = v6;
...
void __38__SKUIGiftAmountControl__layoutForPad__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  {
    CGFloat v14 = v10;
    +[SKUICGRectHelpers rect:*(double *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) withFlippedOriginXRelativeTo:v11];
  }
...
void __40__SKUIGiftAmountControl__layoutForPhone__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  {
    CGFloat v11 = v8;
    +[SKUICGRectHelpers rect:*(double *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) withFlippedOriginXRelativeTo:0.0];
  }
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = (Class)SKUIGiftAmountControl;
  [(SKUIGiftAmountControl *)&v10 setBackgroundColor:v4];
}
...
- (BOOL)textField:(id)a3 shouldChangeCharactersInRange:(_NSRange)a4 replacementString:(id)a5
{
  ...
  if ([v12 length])
  {
    ...
    if (v14)
    {
      int64_t v16 = [(SKUIGiftConfiguration *)self->_giftConfiguration currencySymbolPosition];
      if (v16 == 1)
      {
        [v9 _setPrefix:0];
        double v18 = [(SKUIGiftConfiguration *)self->_giftConfiguration currencySymbol];
        double v19 = [v9 textColor];
        [v9 _setSuffix:v18 withColor:v19];
      }
      else if (!v16)
      {
        double v17 = [(SKUIGiftConfiguration *)self->_giftConfiguration currencySymbol];
        [v9 _setPrefix:v17];
...
- (void)_textFieldDidBeginEditing:(id)a3
{
  id v4 = [(SKUIGiftAmountControl *)self tintColor];
...
- (void)_dynamicUserInterfaceTraitDidChange
{
  ...
  [(SKUIGiftAmountControl *)&v8 _dynamicUserInterfaceTraitDidChange];
