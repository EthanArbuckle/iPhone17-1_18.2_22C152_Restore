...
- (void)_performActionForDialog:(id)a3 buttonIndex:(int64_t)a4
{
  ...
  if ([v6 count] > (unint64_t)a4)
  {
    ...
    if (v8 == 9)
    {
      [MEMORY[0x1E4FA8170] retryAllRestoreDownloads];
    }
    else if (v8 == 3)
    {
      id v9 = [v7 parameter];
      id v10 = objc_alloc_init(MEMORY[0x1E4FA8270]);
      [v10 setBuyParameters:v9];
      id v11 = objc_alloc(MEMORY[0x1E4FA8278]);
      v15[0] = v10;
...
{
  id v3 = a2;
  uint64_t v4 = +[SKUIItemStateCenter defaultCenter];
  [v4 evaluatePurchaseResponseForRentals:v3];

  id v9 = (id)objc_msgSend(objc_alloc(MEMORY[0x1E4F1C9E8]), "initWithObjectsAndKeys:", v3, @"SKUIStoreDialogControllerPurchaseNotificationKeyPurchaseResponse", 0);
  id v5 = [MEMORY[0x1E4F28EB8] defaultCenter];
  [v5 postNotificationName:@"SKUIStoreDialogControllerPurchaseRequestDidSucceedNotification" object:*(void *)(a1 + 32) userInfo:v9];

  id v6 = objc_alloc(MEMORY[0x1E4F1C9E8]);
  uint64_t v7 = objc_msgSend(v6, "initWithObjectsAndKeys:", v3, *MEMORY[0x1E4FB8948], 0);

  int v8 = [MEMORY[0x1E4F28EB8] defaultCenter];
  [v8 postNotificationName:*MEMORY[0x1E4FB8950] object:*(void *)(a1 + 32) userInfo:v7];
}
