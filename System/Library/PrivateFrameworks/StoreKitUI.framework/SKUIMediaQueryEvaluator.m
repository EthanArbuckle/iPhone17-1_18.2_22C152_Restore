...
- (SKUIMediaQueryEvaluator)init
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)SKUIMediaQueryEvaluator;
  ...
  if (v3)
  {
    ...
    v3->_cachedFeatureResults = (NSMapTable *)v4;
...
- (void)dealloc
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  uint64_t v4 = self->_observedNotificationNames;
...
- (BOOL)evaluateMediaQuery:(id)a3
{
  ...
  if ([v9 count])
  {
    if ([v10 count])
    {
      long long v13 = [(SKUIMediaQueryEvaluator *)v11 _delegateValuesForKeys:v10];
    }
    else
    {
      long long v13 = 0;
...
void __57__SKUIMediaQueryEvaluator__featureDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  {
    dispatch_source_t v2 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, *(dispatch_queue_t *)(a1 + 40));
...
- (SKUIMediaQueryDelegate)delegate
{
  ...
  return (SKUIMediaQueryDelegate *)WeakRetained;
}
