...
void __86__SKUIEditorialCardCollectionViewCell_prefetchResourcesForViewElement_reason_context___block_invoke(void *a1, void *a2)
{
  ...
  {
    BOOL v3 = +[SKUIVerticalLockupView prefetchResourcesForViewElement:v6 reason:a1[6] context:a1[4]];
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v7 = a5;
  id v8 = a3;
  double v9 = [[SKUIEditorialCardLayout alloc] initWithCard:v8 width:v7 context:a4];

  double v10 = [(SKUIEditorialCardLayout *)v9 primaryLockup];
  if (v10)
  {
    [(SKUIEditorialCardLayout *)v9 primaryLockupSize];
    +[SKUIVerticalLockupView requestLayoutForViewElement:width:context:](SKUIVerticalLockupView, "requestLayoutForViewElement:width:context:", v10, v7);
  }
  [(SKUIEditorialCardLayout *)v9 secondaryLockupWidth];
  uint64_t v12 = v11;
  double v13 = [(SKUIEditorialCardLayout *)v9 allLockups];
...
uint64_t __81__SKUIEditorialCardCollectionViewCell_requestLayoutForViewElement_width_context___block_invoke(uint64_t result, uint64_t a2)
{
  if (*(void *)(result + 32) != a2) {
    return +[SKUIVerticalLockupView requestLayoutForViewElement:a2 width:*(void *)(result + 40) context:*(double *)(result + 48)];
  }
  return result;
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  double v30 = a3;
  uint64_t v31 = 0;
  double v9 = [[SKUIEditorialCardLayout alloc] initWithCard:v7 width:v8 context:a3];
  double v10 = [(SKUIEditorialCardLayout *)v9 primaryLockup];
  if (v10)
  {
    [(SKUIEditorialCardLayout *)v9 primaryLockupSize];
  ...
  [(SKUIEditorialCardLayout *)v9 secondaryLockupWidth];
  uint64_t v13 = v12;
  id v14 = [(SKUIEditorialCardLayout *)v9 allLockups];
...
uint64_t __77__SKUIEditorialCardCollectionViewCell_sizeThatFitsWidth_viewElement_context___block_invoke(uint64_t result, uint64_t a2)
{
  ...
  {
    uint64_t v2 = result;
    CGSize result = +[SKUIVerticalLockupView sizeThatFitsWidth:a2 viewElement:*(void *)(v2 + 40) context:*(double *)(v2 + 56)];
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  double v10 = [[SKUIEditorialCardLayout alloc] initWithCard:v8 width:v9 context:a4];
  uint64_t v26 = 0;
  v27 = &v26;
  uint64_t v28 = 0x3032000000;
  v29 = __Block_byref_object_copy__51;
  double v30 = __Block_byref_object_dispose__51;
  id v31 = 0;
  ...
  self->_primaryLockupSize.double width = v12;
  self->_primaryLockupSize.double height = v13;
  uint64_t v18 = MEMORY[0x1E4F143A8];
  uint64_t v19 = 3221225472;
  double v20 = __75__SKUIEditorialCardCollectionViewCell_reloadWithViewElement_width_context___block_invoke;
  v21 = &unk_1E6427A78;
  id v14 = v10;
  id v22 = v14;
  id v15 = v9;
...
- (void)layoutSubviews
{
  ...
  {
    uint64_t v5 = v3;
    uint64_t v6 = [(SKUIEditorialCardCollectionViewCell *)self contentView];
    [v6 bounds];
    double v8 = v7;
    double v10 = v9;
    double v12 = v11;
    ...
    if (v28)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v37 = *(SKUIVerticalLockupView **)(*((void *)&v45 + 1) + 8 * v36);
          CGFloat width = v34;
          CGFloat height = v32;
