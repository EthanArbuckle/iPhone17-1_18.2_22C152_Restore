...
- (SKUIAdornedImageViewReuseView)init
{
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v3) {
        [(SKUIAdornedImageViewReuseView *)v3 init];
      }
    }
  }
  v15.receiver = self;
  v15.super_class = (Class)SKUIAdornedImageViewReuseView;
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v9) {
        +[SKUIAdornedImageViewReuseView prefetchResourcesForViewElement:reason:context:](v9, v10, v11, v12, v13, v14, v15, v16);
      }
    }
  }
  uint64_t v24 = 0;
...
+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      ...
      if (v8) {
        +[SKUIAdornedImageViewReuseView preferredSizeForViewElement:context:](v8, v9, v10, v11, v12, v13, v14, v15);
      }
    }
  }
...
+ (void)requestLayoutForViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  uint64_t v11 = [v8 labelLayoutCache];
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  if (os_variant_has_internal_content())
  {
    if (_os_feature_enabled_impl())
    {
      BOOL v9 = os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_FAULT);
      if (v9) {
        +[SKUIAdornedImageViewReuseView sizeThatFitsWidth:viewElement:context:](v9, v10, v11, v12, v13, v14, v15, v16);
      }
    }
  }
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  uint64_t v14 = +[SKUIMediaPlayerInterface sharedInstance];
  [v14 removeObserver:self];

  uint64_t v15 = self->_playButton;
  if (v15)
  {
    uint64_t v16 = [(SKUIPlayButton *)v15 playItemIdentifier];

    if (v16)
    {
      double v17 = +[SKUIMediaPlayerInterface sharedInstance];
      double v18 = [(SKUIPlayButton *)self->_playButton playItemIdentifier];
      double v19 = [v17 playerForItemWithIdentifier:v18];

      double v20 = [(SKUIPlayButton *)self->_playButton playItemIdentifier];
      if ([v17 identifierIsOnDeck:v20])
      {
        BOOL v21 = [(SKUIPlayButtonControl *)self->_playButton isIndeterminate];

        if (!v21)
        {
          [(SKUIPlayButtonControl *)self->_playButton beginIndeterminateAnimation];
          double v22 = self->_playButton;
          BOOL v23 = 0;
          goto LABEL_16;
        }
      }
...
LABEL_17:
      ...
      uint64_t v26 = self->_playButton;
      char v27 = [v19 playerItem];
...
void __69__SKUIAdornedImageViewReuseView_reloadWithViewElement_width_context___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    char v31 = 0;
    SKUIViewElementMarginForStyle(v4, &v31);
    double v15 = v13 + v14;
    if (!v31) {
      double v15 = 16.0;
    }
...
LABEL_29:
        uint64_t v26 = [*(id *)(a1 + 48) imageResourceCacheKeyForViewElement:v3];
        if (v26)
        {
          char v27 = *(void **)(*(void *)(a1 + 56) + 424);
          if (!v27)
          {
            uint64_t v28 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:517 valueOptions:0 capacity:1];
    ...
    double v20 = [*(id *)(a1 + 40) addImageViewWithElement:v3 context:*(void *)(a1 + 48)];
...
{
  id v4 = a3;
  uint64_t v5 = [(SKUIViewElement *)self->_imageViewElement flattenedChildren];
  unint64_t v6 = [(SKUIViewReuseView *)self allExistingViews];
  uint64_t v15 = 0;
  double v16 = &v15;
  uint64_t v17 = 0x3032000000;
  id v18 = __Block_byref_object_copy__54;
  BOOL v19 = __Block_byref_object_dispose__54;
  id v20 = 0;
...
void __58__SKUIAdornedImageViewReuseView_viewForElementIdentifier___block_invoke(uint64_t a1, void *a2, unint64_t a3, unsigned char *a4)
{
  id v11 = [a2 itmlID];
...
- (CGRect)frameForView:(id)a3
{
  ...
  char v38 = 0;
  double v8 = SKUIViewElementMarginForStyle(v7, &v38);
  if (v38) {
    double v12 = v11;
  }
  else {
...
- (void)layoutSubviews
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)SKUIAdornedImageViewReuseView;
...
- (void)_buttonAction:(id)a3
{
  ...
  {
    id v9 = +[SKUIMediaPlayerInterface sharedInstance];
    uint64_t v5 = [(SKUIPlayButton *)self->_playButton playItemIdentifier];
    int v6 = [v9 isItemWithIdentifierActive:v5];

    if (v6)
    {
      unint64_t v7 = [(SKUIPlayButton *)self->_playButton playItemIdentifier];
    ...
    else
    {
      ...
      if (v7)
      {
        ...
        {
          [v7 dispatchEvent:0x1F1C94B88 eventAttribute:0x1F1C94BA8 canBubble:1 isCancelable:0 extraInfo:0 completionBlock:0];
        }
        else
        {
          double v8 = [(SKUIPlayButton *)self->_playButton playItemIdentifier];
...
- (void)mediaPlayer:(id)a3 itemStateChanged:(id)a4
{
  ...
  if (playButton)
  {
    id v9 = [(SKUIPlayButton *)playButton playItemIdentifier];
...
uint64_t __62__SKUIAdornedImageViewReuseView_mediaPlayer_itemStateChanged___block_invoke_3(uint64_t a1)
{
...
+ (id)_attributedStringForButtonText:(id)a3 type:(int64_t)a4 style:(id)a5 context:(id)a6
{
  ...
  id v10 = a5;
  id v11 = a6;
  long long v12 = SKUIViewElementFontWithStyle(v10);
  if (!v12)
  {
    if (a4) {
      uint64_t v13 = 5;
    ...
    long long v12 = SKUIFontPreferredFontForTextStyle(v13);
  }
  id v14 = [v11 tintColor];
  uint64_t v15 = SKUIViewElementPlainColorWithStyle(v10, v14);
...
+ (id)_attributedStringForLabel:(id)a3 context:(id)a4
{
  ...
  if (!v8)
  {
    double v8 = SKUIFontPreferredFontForTextStyle(5);
  }
  id v9 = [v6 tintColor];
