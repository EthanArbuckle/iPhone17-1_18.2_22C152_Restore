...
- (SKUIBadgeTextAttachmentLoader)initWithResourceLoader:(id)a3
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)SKUIBadgeTextAttachmentLoader;
  v6 = [(SKUIBadgeTextAttachmentLoader *)&v13 init];
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_resourceLoader, a3);
    uint64_t v8 = [objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:517 valueOptions:0 capacity:0];
...
- (BOOL)loadImageForBadge:(id)a3 layout:(id)a4 reason:(int64_t)a5
{
  ...
  if (v10 && ([v8 image], v11 = objc_claimAutoreleasedReturnValue(), v11, !v11))
  {
    ...
    if (p_isa
      && [(SKUIResourceLoader *)self->_resourceLoader trySetReason:a5 forRequestWithIdentifier:p_isa[1]])
    {
      BOOL v12 = 0;
    }
    else
    {
      ...
      BOOL v12 = [(SKUIResourceLoader *)self->_resourceLoader loadResourceWithRequest:v14 reason:a5];
