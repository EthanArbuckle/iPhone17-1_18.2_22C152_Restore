...
@implementation SKUIImageGridView
...
- (void)setColumnCount:(int64_t)a3
{
  if (self->_columnCount != a3)
  {
    ...
    [(SKUIImageGridView *)self setNeedsLayout];
  }
}
    ...
    if (v12)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v13; ++j)
        {
          ...
          -[SKUIImageGridView addSubview:](self, "addSubview:", *(void *)(*((void *)&v16 + 1) + 8 * j), (void)v16);
        }
...
+ (BOOL)prefetchResourcesForViewElement:(id)a3 reason:(int64_t)a4 context:(id)a5
{
  return +[SKUIImageGridViewReuseView prefetchResourcesForViewElement:a3 reason:a4 context:a5];
}

+ (CGSize)preferredSizeForViewElement:(id)a3 context:(id)a4
{
  +[SKUIImageGridViewReuseView preferredSizeForViewElement:a3 context:a4];
  result.height = v5;
  result.width = v4;
  return result;
}
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  +[SKUIImageGridViewReuseView sizeThatFitsWidth:a4 viewElement:a5 context:a3];
  result.height = v6;
  result.width = v5;
  return result;
}
...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  if (!reuseView)
  {
    v10 = objc_alloc_init(SKUIImageGridViewReuseView);
    id v11 = self->_reuseView;
    self->_reuseView = v10;

    reuseView = self->_reuseView;
  }
  [(SKUIImageGridViewReuseView *)reuseView reloadWithViewElement:v13 width:v8 context:a4];
  -[SKUIImageGridView setColumnCount:](self, "setColumnCount:", [v13 columnCount]);
  [v13 contentInset];
  -[SKUIImageGridView setContentInset:](self, "setContentInset:");
  uint64_t v12 = [(SKUIImageGridViewReuseView *)self->_reuseView imageViews];
  [(SKUIImageGridView *)self setImageViews:v12];

  [v13 size];
  -[SKUIImageGridView setSize:](self, "setSize:");
}

- (BOOL)setImage:(id)a3 forArtworkRequest:(id)a4 context:(id)a5
{
  return [(SKUIImageGridViewReuseView *)self->_reuseView setImage:a3 forArtworkRequest:a4 context:a5];
}

- (BOOL)updateWithItemState:(id)a3 context:(id)a4 animated:(BOOL)a5
{
  return [(SKUIImageGridViewReuseView *)self->_reuseView updateWithItemState:a3 context:a4 animated:a5];
}

- (id)viewForElementIdentifier:(id)a3
{
  return [(SKUIImageGridViewReuseView *)self->_reuseView viewForElementIdentifier:a3];
}

- (CGSize)sizeThatFits:(CGSize)a3
{
  uint64_t v36 = *MEMORY[0x1E4F143B8];
  uint64_t v4 = [(SKUIImageGridView *)self columnCount];
  if (v4 <= 1) {
    size_t v5 = 1;
  }
  else {
  ...
  double v6 = [(SKUIImageGridView *)self imageViews];
  unint64_t v7 = [v6 count] / v5;

  id v8 = [(SKUIImageGridView *)self imageViews];
  ...
  long long v32 = 0u;
  v30 = self;
  id v13 = [(SKUIImageGridView *)self imageViews];
...
- (void)layoutSubviews
{
  ...
  v69.receiver = self;
  v69.super_class = (Class)SKUIImageGridView;
  [(SKUIImageGridView *)&v69 layoutSubviews];
  uint64_t v3 = [(SKUIImageGridView *)self columnCount];
  if (v3 <= 1) {
    size_t v4 = 1;
  }
  else {
  ...
  size_t v5 = [(SKUIImageGridView *)self imageViews];
  unint64_t v6 = [v5 count] / v4;

  v60 = self;
  unint64_t v7 = [(SKUIImageGridView *)self imageViews];
  ...
  long long v65 = 0u;
  long long v66 = 0u;
  uint64_t v12 = [(SKUIImageGridView *)v60 imageViews];
  ...
  [(SKUIImageGridView *)v60 contentInset];
  double v32 = v26 - v31;
  [(SKUIImageGridView *)v60 contentInset];
  double v34 = v32 - v33;
  [(SKUIImageGridView *)v60 contentInset];
  ...
  long long v63 = 0u;
  long long v64 = 0u;
  v49 = [(SKUIImageGridView *)v60 imageViews];
