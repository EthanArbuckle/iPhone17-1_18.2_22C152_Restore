...
- (SKUIJSTabBarItem)initWithAppContext:(id)a3 navigationController:(id)a4 tabBarItem:(id)a5 owner:(id)a6
{
  ...
  if (v13)
  {
    ...
    if (v11)
    {
      uint64_t v15 = [objc_alloc(MEMORY[0x1E4F6F0D8]) initWithAppContext:v10 navigationController:v11];
      navigationDocument = v13->_navigationDocument;
      v13->_navigationDocument = (IKJSNavigationDocument *)v15;

      v17 = [v10 jsContext];
      v18 = (void *)MEMORY[0x1E4F30928];
      v19 = [MEMORY[0x1E4F30938] valueWithObject:v13->_navigationDocument inContext:v17];
...
- (NSString)badgeValue
{
  ...
  objc_super v8 = __Block_byref_object_copy__86;
...
- (NSString)identifier
{
  return [(SKUITabBarItem *)self->_tabBarItem tabIdentifier];
}
...
- (NSString)rootURL
{
  uint64_t v2 = [(SKUITabBarItem *)self->_tabBarItem rootURL];
...
- (NSString)title
{
  id v2 = [(SKUITabBarItem *)self->_tabBarItem underlyingTabBarItem];
