...
- (SKUILocalizedStringTable)initWithBundle:(id)a3 localeName:(id)a4 tableName:(id)a5
{
  ...
  v12 = [(SKUILocalizedStringTable *)&v38 init];
  v13 = v12;
  if (v12)
  {
...
LABEL_32:
        ...
        {
          v20 = (void *)[objc_alloc(MEMORY[0x1E4F1CA20]) initWithLocaleIdentifier:v16];
          id v10 = [v20 objectForKey:*MEMORY[0x1E4F1C438]];

          v19 = [v9 pathForResource:v11 ofType:@"strings" inDirectory:0 forLocalization:v10];
          if (!v19)
          {
            uint64_t v21 = [(SKUILocalizedStringTable *)v13 _legacyLanguageNameForLanguageCode:v10];
            if (!v21
              || (v22 = (void *)v21,
...
LABEL_25:
        ...
        v30 = (void *)[objc_alloc(MEMORY[0x1E4F1C9B8]) initWithContentsOfFile:v19];
        v31 = [MEMORY[0x1E4F28F98] propertyListWithData:v30 options:0 format:0 error:0];
        objc_opt_class();
