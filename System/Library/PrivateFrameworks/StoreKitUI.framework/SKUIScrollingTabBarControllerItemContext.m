...
- (SKUIScrollingTabBarControllerItemContext)init
{
  return [(SKUIScrollingTabBarControllerItemContext *)self initWithViewController:0];
}
...
- (void)updateNestedPagingScrollViewContentOffset:(CGPoint)a3
{
  ...
  if (self->_adjustingNestedPagingScrollViewContentOffset)
  {
    id v7 = [(SKUIScrollingTabBarControllerItemContext *)self nestedPagingScrollView];
...
- (id)viewControllerInNestedPagingScrollViewAtPageIndex:(unint64_t)a3
{
  id v4 = [(SKUIScrollingTabBarControllerItemContext *)self _nestedPagedScrollingConformingViewControllerForcingViewLoading:0];
...
- (id)_appearanceStatusObserver
{
  BOOL v3 = [(SKUIScrollingTabBarControllerItemContext *)self viewControllerIsNavigationController];
  ...
  if (v3)
  {
    ...
    LODWORD(v6) = [v7 conformsToProtocol:&unk_1F1DBDC08];
    if (v6) {
      v8 = v7;
    }
    else {
  ...
  else if ([(UIViewController *)viewController conformsToProtocol:&unk_1F1DBDC08])
  {
...
LABEL_9:
  ...
  BOOL v7 = [(SKUIScrollingTabBarControllerItemContext *)self viewControllerIsNavigationController];
  v8 = self->_viewController;
  if (!v7)
  {
    if ([(UIViewController *)v8 conformsToProtocol:&unk_1F1DBDCD0])
    {
...
LABEL_13:
  ...
  if (![v11 conformsToProtocol:&unk_1F1DBDCD0]) {
    goto LABEL_13;
  }
  double v13 = v11;
LABEL_14:
...
- (void)_prepareViewControllerForDisplayWithViewFrame:(CGRect)a3 updateContentOffset:(BOOL)a4 contentOffset:(CGPoint)a5
{
  if (!self->_readyForDisplay)
  {
    ...
    double v13 = [(SKUIScrollingTabBarControllerItemContext *)self _nestedPagedScrollingConformingViewControllerForcingViewLoading:1];
    id v19 = v13;
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        [v14 addObserver:self forKeyPath:@"contentOffset" options:0 context:_SKUIScrollingTabNestedPagingScrollViewContentOffsetObservingContext];
        [v14 addObserver:self forKeyPath:@"contentSize" options:0 context:_SKUIScrollingTabNestedPagingScrollViewContentSizeObservingContext];
    ...
    if ([(UIViewController *)self->_viewController conformsToProtocol:&unk_1F1E20968])[(UIViewController *)self->_viewController setNavigationStackObserver:self]; {
...
- (void)_prepareViewControllerForTearDown
{
  if (self->_readyForDisplay)
  {
    ...
    if (v6)
    {
      [(UIScrollView *)v6 removeObserver:self forKeyPath:@"contentSize" context:_SKUIScrollingTabNestedPagingScrollViewContentSizeObservingContext];
      [(UIScrollView *)v6 removeObserver:self forKeyPath:@"contentOffset" context:_SKUIScrollingTabNestedPagingScrollViewContentOffsetObservingContext];
    ...
    if ([(UIViewController *)self->_viewController conformsToProtocol:&unk_1F1E20968])[(UIViewController *)self->_viewController setNavigationStackObserver:0]; {
...
- (void)_updateAppliedContentInsetsAdjustment
{
  ...
  int v12 = [(UIViewController *)self->_viewController conformsToProtocol:&unk_1F1E20848];
  int v13 = v12;
...
- (SKUIScrollingTabBarControllerItemContextDelegate)delegate
{
  ...
  return (SKUIScrollingTabBarControllerItemContextDelegate *)WeakRetained;
}
