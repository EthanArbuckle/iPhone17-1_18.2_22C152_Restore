...
- (void)loadView
{
  ...
  v42 = -[SKUIScrollForwardingView initWithFrame:](v3, "initWithFrame:", *MEMORY[0x1E4F1DB28], v5, v6, v7);
  ...
  long long v9 = (void *)[objc_alloc(MEMORY[0x1E4FB1FE0]) initWithPrivateStyle:10060];
  [v9 setAutoresizingMask:18];
  [(SKUIScrollForwardingView *)v42 bounds];
  objc_msgSend(v9, "setFrame:");
  [(SKUIScrollForwardingView *)v42 addSubview:v9];
  long long v10 = objc_alloc_init(SKUIItemGridCollectionViewLayout);
  long long v11 = [MEMORY[0x1E4FB1618] clearColor];
  ...
  objc_super v18 = -[SKUIGiftThemeCollectionView initWithFrame:collectionViewLayout:]([SKUIGiftThemeCollectionView alloc], "initWithFrame:collectionViewLayout:", v10, v4, v5, v6, v7);
  ...
  v28 = (UIPageControl *)objc_alloc_init(MEMORY[0x1E4FB1A40]);
  ...
  v33 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.3];
  ...
  id v36 = objc_alloc_init(MEMORY[0x1E4FB14A8]);
  ...
  v38 = +[SKUIClientContext localizedStringForKey:@"SCREENSHOTS_BUTTON_DONE" inBundles:0];
  }
  [v36 setTitle:v38];
  ...
  if (!v39)
  {
    ...
    v41 = +[SKUIClientContext localizedStringForKey:@"SCREENSHOTS_TITLE" inBundles:0];
    }
...
- (void)reloadData
{
  ...
  if (v6 >= 1)
  {
    ...
    do
    {
      ...
      v30 = (void *)[objc_alloc(MEMORY[0x1E4FA8338]) initWithURL:v10];
      [v30 setDataConsumer:v12];
      [v30 setITunesStoreRequest:0];
      objc_initWeak(&location, self);
      v34[0] = MEMORY[0x1E4F143A8];
      v34[1] = 3221225472;
      v35[0] = __47__SKUIIPhoneSlideshowViewController_reloadData__block_invoke;
      v35[1] = &unk_1E6424178;
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  collectionView = self->_collectionView;
  id v6 = a4;
  double v7 = [(SKUIGiftThemeCollectionView *)collectionView dequeueReusableCellWithReuseIdentifier:@"a" forIndexPath:v6];
  objc_msgSend(v7, "setImageSize:", *MEMORY[0x1E4F1DB30], *(double *)(MEMORY[0x1E4F1DB30] + 8));
  uint64_t v8 = [v6 row];

  id v9 = [(SKUIIPhoneSlideshowViewController *)self _imageAtIndex:v8];
  [v7 setImage:v9];
...
- (void)_doneAction:(id)a3
{
  id v4 = [(SKUIIPhoneSlideshowViewController *)self delegate];
...
- (id)_imageAtIndex:(int64_t)a3
{
  ...
  if (v5 == v6)
  {
    uint64_t v7 = [(SKUIIPhoneSlideshowViewController *)self _placeholderImageAtIndex:a3];
...
- (id)_placeholderImageAtIndex:(int64_t)a3
{
  ...
  if (v8)
  {
    ...
    double v20 = __62__SKUIIPhoneSlideshowViewController__placeholderImageAtIndex___block_invoke;
    double v21 = &unk_1E6429398;
    id v22 = v6;
    id v23 = v8;
    double v24 = self;
    v25[1] = (id)a3;
  ...
  if (!v13)
  {
    double v14 = [MEMORY[0x1E4FB1618] colorWithWhite:0.8 alpha:1.0];
...
- (void)_setImage:(id)a3 atIndex:(int64_t)a4
{
  if (a3)
  {
    ...
    id v10 = [(SKUIGiftThemeCollectionView *)collectionView cellForItemAtIndexPath:v9];
...
- (void)_reloadPageControl
{
  ...
  pageControl = self->_pageControl;
  unint64_t v4 = SKUIPageForCollectionView(self->_collectionView);
...
- (void)_reloadSize
{
  uint64_t v3 = [(SKUIIPhoneSlideshowViewController *)self view];
  [v3 frame];
  double v5 = v4 + -54.0;

  id v6 = [(SKUIIPhoneSlideshowViewController *)self view];
  [v6 frame];
  double v8 = v7 + -64.0;

  id v9 = [(SKUIGiftThemeCollectionView *)self->_collectionView collectionViewLayout];
  objc_msgSend(v9, "setItemSize:", v5, v8);

  -[SKUIGiftThemeCollectionView setFrame:](self->_collectionView, "setFrame:", 27.0, 32.0, v5, v8);
  int64_t indexToScrollToOnLoadView = self->_indexToScrollToOnLoadView;
  collectionView = self->_collectionView;
  long long v12 = [MEMORY[0x1E4FB1BA8] mainScreen];
  [v12 bounds];
  double v14 = v13 + -54.0;
  if (indexToScrollToOnLoadView == 0x7FFFFFFFFFFFFFFFLL)
  {
