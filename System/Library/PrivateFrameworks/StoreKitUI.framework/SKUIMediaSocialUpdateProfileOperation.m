...
- (SKUIMediaSocialUpdateProfileOperation)initWithClientContext:(id)a3
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)SKUIMediaSocialUpdateProfileOperation;
...
- (void)main
{
  ...
  id v4 = [(SKUIClientContext *)self->_clientContext newLoadStoreURLOperationWithURLRequest:v3];
  ...
  if (v7)
  {
    ...
    {
      uint64_t v11 = [MEMORY[0x1E4F28C58] errorWithDomain:@"SKUIErrorDomain" code:5 userInfo:0];
      id v12 = (void *)v27[5];
      v27[5] = v11;
    }
  }
...
LABEL_13:
    if (!v27[5])
    {
      ...
      uint64_t v14 = [MEMORY[0x1E4F28C58] errorWithDomain:@"SKUIErrorDomain" code:0 userInfo:0];
      }
      v15 = (void *)v27[5];
      v27[5] = v14;
    }
  ...
  BOOL v10 = v9 != 0;
LABEL_19:
  uint64_t v16 = [(SKUIMediaSocialUpdateProfileOperation *)self outputBlock];
  v17 = (void *)v16;
  if (v16) {
...
- (id)_requestWithError:(id *)a3
{
  ...
  uint64_t v6 = [v5 valueForKey:*MEMORY[0x1E4FA89B0] error:a3];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v8)
    {
      id v9 = objc_alloc(MEMORY[0x1E4F18D50]);
...
- (id)_requestBodyWithError:(id *)a3
{
  if (self->_entityType && self->_identifier && (parameters = self->_parameters) != 0)
  {
    ...
    id v7 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1C9E8]), "initWithObjectsAndKeys:", self->_entityType, @"type", self->_identifier, @"id", 0);
    [v6 setObject:v7 forKey:@"owner"];
    v8 = [MEMORY[0x1E4F28D90] dataWithJSONObject:v6 options:0 error:a3];
  }
  else
  {
    v8 = 0;
    if (a3) {
      *a3 = (id)[objc_alloc(MEMORY[0x1E4F28C58]) initWithDomain:@"SKUIErrorDomain" code:4 userInfo:0];
    }
  }
