...
- (id)popImageViewForItemAtIndex:(int64_t)a3
{
  ...
  if (v7)
  {
    ...
    {
      v22 = (NSMutableIndexSet *)objc_alloc_init(MEMORY[0x1E4F28E60]);
...
void __45__SKUIBrickSwooshViewController_unhideImages__block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  objc_super v3 = [MEMORY[0x1E4F28D58] indexPathForRow:a2 inSection:0];
...
- (void)loadView
{
  if (!self->_swooshView)
  {
    objc_super v3 = objc_alloc_init(SKUISwooshView);
  ...
  if (!collectionView)
  {
    ...
    v20 = (UICollectionView *)objc_msgSend(objc_alloc(MEMORY[0x1E4FB1568]), "initWithFrame:collectionViewLayout:", v19, 0.0, 0.0, 0.0, cellHeight);
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  ...
  long long v10 = [(SKUISwooshViewController *)self colorScheme];
  [v8 setColoringWithColorScheme:v10];

  long long v11 = [(SKUISwooshViewController *)self delegate];
...
{
  id v6 = a4;
  uint64_t v5 = [(SKUISwooshViewController *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
- ($1AB5FA073B851C12C2339EC22442E995)_brickSwooshMetrics
{
  ...
  else
  {
    ...
    if (v9 <= 375.0)
    {
      ...
      double v6 = dbl_1C1CCB9C0[v12 > 320.0];
      double v5 = 78.0;
      if (v12 > 320.0) {
        double v5 = 100.0;
      }
