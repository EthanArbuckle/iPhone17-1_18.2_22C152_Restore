...
- (SKUIRedeemITunesPassLockup)initWithITunesPassConfiguration:(id)a3 clientContext:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v21)
    {
      uint64_t v22 = [objc_alloc(MEMORY[0x1E4FB1838]) initWithImage:v21];
...
- (void)setHighlighted:(BOOL)a3
{
  ...
  descriptionLabel = self->_descriptionLabel;
  double v5 = [(SKUIRedeemITunesPassLockup *)self _attributedDescriptionString];
...
- (id)_attributedDescriptionString
{
  uint64_t v3 = [(SKUIITunesPassConfiguration *)self->_configuration lockupDescription];
  double v24 = [(SKUIITunesPassConfiguration *)self->_configuration lockupLearnMoreLinkTitle];
  clientContext = self->_clientContext;
  if (clientContext) {
    [(SKUIClientContext *)clientContext localizedStringForKey:@"ITUNES_PASS_EXPLANATION_LEARN_MORE_FORMAT" inTable:@"Redeem"];
  }
  else {
  CGFloat v23 = +[SKUIClientContext localizedStringForKey:@"ITUNES_PASS_EXPLANATION_LEARN_MORE_FORMAT" inBundles:0 inTable:@"Redeem"];
  }
  CGFloat v5 = [NSString stringWithValidatedFormat:v23, @"%@%@", 0, v3, v24 validFormatSpecifiers error];
  double v6 = (void *)[objc_alloc(MEMORY[0x1E4F28E48]) initWithString:v5];
  double v7 = [MEMORY[0x1E4FB08E0] systemFontOfSize:11.0];
  ...
  objc_msgSend(v6, "addAttribute:value:range:", *MEMORY[0x1E4FB0738], v9, 0, objc_msgSend(v5, "length"));
  double v22 = (void *)v3;
  uint64_t v10 = [v5 rangeOfString:v3];
  uint64_t v12 = v11;
  uint64_t v13 = *MEMORY[0x1E4FB06F8];
  objc_msgSend(v6, "addAttribute:value:range:", *MEMORY[0x1E4FB06F8], v7, v10, v11);
  uint64_t v14 = *MEMORY[0x1E4FB0700];
  double v15 = [MEMORY[0x1E4FB1618] colorWithWhite:0.0 alpha:0.600000024];
  ...
  double v19 = [(SKUIRedeemITunesPassLockup *)self tintColor];
