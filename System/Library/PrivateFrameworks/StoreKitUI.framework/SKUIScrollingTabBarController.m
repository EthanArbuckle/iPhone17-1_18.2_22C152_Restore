...
- (SKUIScrollingTabBarController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  if (v8)
  {
    ...
    v8->_scrollEnabled = [(id)objc_opt_class() areScrollingTabsAllowed];
  }
...
- (unint64_t)supportedInterfaceOrientations
{
  ...
  else
  {
    ...
    id v4 = [(SKUIViewController *)&v7 supportedInterfaceOrientations];
  }
...
- (void)viewDidLoad
{
  ...
  [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:0x1F1C91328];
...
- (void)viewDidLayoutSubviews
{
  ...
  if (proxyScrollView)
  {
    id v13 = [(SKUIProxyScrollView *)proxyScrollView superview];
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  double v4 = [(SKUIScrollingTabBarController *)self transitionCoordinator];
  double v5 = v4;
  if (v4)
  {
    v6[4] = self;
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  id v7 = a4;
  objc_super v8 = [(SKUIScrollingTabBarController *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
- (id)contentScrollView
{
  if (!self->_proxyScrollView && [(SKUIScrollingTabBarController *)self isViewLoaded])
  {
    ...
    double v6 = [(SKUIScrollingTabBarController *)self view];
...
- (void)scrollingTabBarControllerItemContextRequestsContentOffsetUpdate:(id)a3
{
  ...
  if (!self->_referenceCountForIgnoringContentOffsetUpdateRequests)
  {
    ...
    if ([v5 isViewLoaded])
    {
      ...
      if (v7)
      {
        BOOL v8 = [(SKUIScrollingTabBarController *)self _parentCellForViewController:v5];
        if (v8)
        {
          ...
          double v13 = v12;
          [v8 frame];
          -[SKUIScrollingTabBarContentCollectionView setContentOffset:](self->_contentCollectionView, "setContentOffset:", v11 + CGRectGetMinX(v16), v13);
        }
      }
    }
...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  double v6 = (SKUIScrollingTabBarContentCollectionView *)a3;
  id v7 = a4;
  BOOL v8 = v7;
  if (self->_contentCollectionView == v6)
  {
    ...
    {
      double v13 = (void *)v12;
      id v14 = [(SKUIScrollingTabBarContentCollectionView *)v6 layoutAttributesForItemAtIndexPath:v8];
      objc_super v15 = (void *)MEMORY[0x1E4FB1EB0];
    ...
    {
      id v9 = [(SKUIScrollingTabBarContentCollectionView *)v6 dequeueReusableCellWithReuseIdentifier:0x1F1C91328 forIndexPath:v8];
...
- (void)collectionView:(id)a3 willDisplayCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  double v21 = __83__SKUIScrollingTabBarController_collectionView_willDisplayCell_forItemAtIndexPath___block_invoke;
  uint64_t v22 = &unk_1E6421FF8;
  id v23 = self;
  id v16 = v7;
  id v24 = v16;
  [v15 performWithoutAnimation:&v19];
  id v17 = [(SKUIScrollingTabBarController *)self delegate];
  if (objc_opt_respondsToSelector())
  {
...
- (void)collectionView:(id)a3 didEndDisplayingCell:(id)a4 forItemAtIndexPath:(id)a5
{
  ...
  id v7 = [(SKUIScrollingTabBarController *)self delegate];
  if (objc_opt_respondsToSelector()) {
...
{
  id v4 = a3;
  double v5 = [v4 decodeObjectForKey:@"_SKUIScrollingTabStateRestorationSelectedViewController"];
  if (v5)
  {
    double v6 = [(SKUIScrollingTabBarController *)self allViewControllers];
...
{
  id v4 = a3;
  double v5 = [(SKUIScrollingTabBarController *)self selectedViewController];
  if (v5)
  {
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  objc_super v7 = [(SKUIScrollingTabBarController *)self traitCollection];
  [v7 displayScale];
  ...
  if (v9 > 0.00000011920929)
  {
    ...
    {
      double v10 = [(SKUIScrollingTabBarController *)self view];
      [v10 setNeedsLayout];
    }
  }
}
...
- (unint64_t)selectedIndex
{
  ...
  id v4 = [(SKUIScrollingTabBarController *)self viewControllers];
  double v5 = [(SKUIScrollingTabBarController *)self selectedViewController];
    ...
    || self->_additionalTabBarButtonsContainerPositionOffset.vertical != v5)
  {
    ...
    if ([(SKUIScrollingTabBarController *)self isViewLoaded])
    {
      ...
      else
      {
        ...
        *(_DWORD *)double v13 = 0;
        *(UIOffset *)&v14[7] = v12;
        *(_OWORD *)&v13[7] = *MEMORY[0x1E4FB2E10];
        char v8 = 1;
    ...
    || self->_additionalTabBarPalettePositionOffset.vertical != v5)
  {
    ...
    if ([(SKUIScrollingTabBarController *)self isViewLoaded])
    {
      ...
      else
      {
        ...
        *(_DWORD *)&v13[3] = 0;
        *(_DWORD *)double v13 = 0;
        *(_OWORD *)&v14[7] = *MEMORY[0x1E4FB2E10];
        *(UIOffset *)&v13[7] = v12;
        char v8 = 0;
        *(_OWORD *)double v9 = *(_OWORD *)v14;
...
{
  id v4 = a3;
  double v5 = [(SKUIScrollingTabBarController *)self viewControllers];
...
- (void)setTransientViewController:(id)a3 animated:(BOOL)a4
{
  ...
  if (transientViewController != v6)
  {
    ...
    if (v9)
    {
      ...
      uint64_t v28 = 0;
      [(SKUIScrollingTabBarControllerItemContext *)transientViewControllerItemContext applyNewContentInsetDescriptor:&v26];
    ...
    if (*p_transientViewController)
    {
      ...
      if ([(SKUIScrollingTabBarController *)self isViewLoaded])
      {
        id v14 = [(SKUIScrollingTabBarController *)self view];
    ...
    if (v9)
    {
      ...
      {
LABEL_15:
        double v17 = [[SKUIScrollingTabBarControllerItemContext alloc] initWithViewController:*p_transientViewController];
        ...
        v24[1] = v27;
        uint64_t v25 = v28;
        [(SKUIScrollingTabBarControllerItemContext *)v23 applyNewContentInsetDescriptor:v24];
        goto LABEL_18;
      }
    }
    else if (!v16)
    ...
    [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView setHidden:v16 != 0];
    [(SKUIScrollingTabBarController *)self _updateForHorizontalLayoutChange];
    [(SKUIScrollingTabBarController *)self _updateHidesBarsOnSwipeAvailability];
    if (*p_transientViewController) {
      goto LABEL_15;
...
- (CGRect)tabBarButtonsContainerFrame
{
  if ([(SKUIScrollingTabBarController *)self isViewLoaded])
  {
    BOOL v3 = [(SKUIScrollingTabBarController *)self view];
    ...
    UIOffset v12 = [(SKUICrossFadingTabBar *)self->_tabBar traitCollection];
    [v12 displayScale];
    double v14 = v13;
...
- (id)tabBarPaletteWithHeight:(double)a3
{
  ...
  if (!tabBarPalette)
  {
    ...
    double v8 = [(SKUIScrollingTabBarController *)self view];
    [v8 bounds];
    double Width = CGRectGetWidth(v16);

    double v10 = -[SKUIScrollingTabBarPalette initWithFrame:]([SKUIScrollingTabBarPalette alloc], "initWithFrame:", v6, v7, Width, a3);
    double v11 = self->_tabBarPalette;
    self->_tabBarPalette = v10;

    double v12 = [(SKUIScrollingTabBarPalette *)self->_tabBarPalette _backgroundView];
    double v13 = [(SKUIScrollingTabBarController *)self _tabBarBackdropGroupName];
...
{
  BOOL v6 = a4;
  double v8 = (SKUIScrollingTabBarPalette *)a3;
  id v9 = a5;
  if (v8 && self->_tabBarPalette == v8)
  {
    ...
    if (v6)
    {
      ...
      double v17 = __73__SKUIScrollingTabBarController_attachTabBarPalette_animated_completion___block_invoke_4;
      double v18 = &unk_1E6422510;
      double v19 = self;
      id v20 = v13;
    ...
    double v14 = objc_msgSend(MEMORY[0x1E4F28EB8], "defaultCenter", v15, v16, v17, v18, v19);
...
{
  BOOL v6 = a4;
  CGRect v8 = (SKUIScrollingTabBarPalette *)a3;
  id v9 = a5;
  double v10 = v9;
  if (v8 && self->_tabBarPalette == v8)
  {
...
- (void)didUpdateAdditionalTabBarComponentsPositionOffsets
{
  ...
  if (additionalPositionOffsetsAtomicUpdateRequestCount)
  {
    ...
    if (!v3)
    {
      ...
      [(SKUIScrollingTabBarController *)self _updateAdditionalPositionOffsetsWithUpdateRecord:v7];
      p_additionalPositionOffsetsUpdateRecord->didUpdateAdditionalTabBarButtonsContainerPositionOffset = 0;
      UIOffset v6 = (UIOffset)*MEMORY[0x1E4FB2E10];
      p_additionalPositionOffsetsUpdateRecord->oldAdditionalTabBarButtonsContainerPositionOffset = (UIOffset)*MEMORY[0x1E4FB2E10];
...
void __91__SKUIScrollingTabBarController_updateTabBarComponentPositionOffsetsWithPresentationValues__block_invoke(uint64_t a1)
{
  ...
  id v27 = (void *)SKUIMPUFoundationFramework();
  uint64_t v28 = (unsigned int (*)(uint64_t, double, double))SKUIWeakLinkedSymbolForString("MPUSizeEqualToSize", v27);
    ...
    && (((uint64_t (*)(uint64_t, double, double))v28)([v4 bounds], v24, v26) & 1) != 0)
  {
    ...
    double v29 = *MEMORY[0x1E4FB2E10];
    double v30 = *(double *)(MEMORY[0x1E4FB2E10] + 8);
    objc_msgSend(*(id *)(a1 + 32), "setAdditionalTabBarButtonsContainerPositionOffset:", *MEMORY[0x1E4FB2E10], v30);
...
- (void)hideBarWithTransition:(int)a3
{
  if (!self->_tabBarExplicitlyHidden)
  {
    ...
    [(SKUIScrollingTabBarController *)self _updateHidesBarsOnSwipeAvailability];
    long long v5 = [(SKUIScrollingTabBarController *)self view];
    [v5 layoutIfNeeded];

    [(UIView *)self->_tabBarContainerView bounds];
    double v10 = *MEMORY[0x1E4FB2E10];
    double v11 = *(double *)(MEMORY[0x1E4FB2E10] + 8);
    double v12 = 0.0;
    switch((int)v3)
    {
      case 1:
...
LABEL_7:
      ...
      default:
        ...
        if ([(UIViewController *)self->_topLevelFocusedViewController conformsToProtocol:&unk_1F1E20848])
        {
...
uint64_t __55__SKUIScrollingTabBarController_hideBarWithTransition___block_invoke(uint64_t a1)
{
  *(_OWORD *)(*(void *)(a1 + 32) + 1264) = *(_OWORD *)(a1 + 40);
  uint64_t v2 = *(void *)(a1 + 32);
  if (*(double *)(v2 + 1264) != *MEMORY[0x1E4FB2E10]
    || *(double *)(v2 + 1272) != *(double *)(MEMORY[0x1E4FB2E10] + 8))
  {
  ...
  uint64_t result = [*(id *)(v2 + 1304) conformsToProtocol:&unk_1F1E20848];
  if (result)
  {
...
- (void)showBarWithTransition:(int)a3
{
  if (self->_tabBarExplicitlyHidden)
  {
    ...
    [(UIView *)self->_tabBarContainerView bounds];
    double v10 = (UIOffset *)MEMORY[0x1E4FB2E10];
    double v11 = *MEMORY[0x1E4FB2E10];
    double v12 = *(double *)(MEMORY[0x1E4FB2E10] + 8);
    double v13 = 0.0;
    switch((int)v3)
    {
      case 1:
...
uint64_t __55__SKUIScrollingTabBarController_showBarWithTransition___block_invoke(uint64_t a1)
{
  ...
  *(_OWORD *)(*(void *)(a1 + 32) + 1264) = *MEMORY[0x1E4FB2E10];
  [*(id *)(a1 + 32) _updateLayoutOfTabBar];
  [*(id *)(*(void *)(a1 + 32) + 1256) setAlpha:1.0];
  uint64_t result = [*(id *)(*(void *)(a1 + 32) + 1304) conformsToProtocol:&unk_1F1E20848];
  if (result)
  {
...
- (void)_tabBarButtonTapped:(id)a3
{
  ...
  CGAffineTransform v4 = [(SKUICrossFadingTabBar *)self->_tabBar tabBarButtons];
...
- (void)_invalidateContentCollectionViewLayoutForUpdatedContentSizeWithHorizontalLayoutContext:(id *)a3 indexOfViewControllerWithUpdatedContentSize:(unint64_t)a4
{
  uint64_t v7 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView collectionViewLayout];
  ...
  {
    double v10 = [MEMORY[0x1E4F28D58] indexPathForItem:a4 inSection:0];
  ...
  double v19 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView collectionViewLayout];
...
- (void)_animatePaletteWithSetup:(id)a3 animations:(id)a4 completion:(id)a5
{
  ...
  {
    [(SKUIScrollingTabBarPalette *)self->_tabBarPalette bounds];
    double v16 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", v14, v13 + -5.0, v15, v12 + 5.0);
    [v16 setClipsToBounds:1];
    [v16 addSubview:self->_tabBarPalette];
    double v17 = [(SKUIScrollingTabBarPalette *)self->_tabBarPalette layer];
  ...
  uint64_t v18 = SKUIMPUFoundationFramework();
  id v19 = SKUIWeakLinkedClassForString(&cfstr_Mpuspringanima.isa, v18);
  v21[0] = MEMORY[0x1E4F143A8];
  v21[1] = 3221225472;
...
void __80__SKUIScrollingTabBarController__animatePaletteWithSetup_animations_completion___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  if (!*(void *)(v2 + 1048))
  {
    ...
    id v8 = [v5 valueForKey:@"SKUIScrollingTabBarPaletteClippingView"];

    uint64_t v6 = [*(id *)(*(void *)(a1 + 32) + 1296) layer];
    [v6 setValue:0 forKey:@"SKUIScrollingTabBarPaletteClippingView"];
...
- (void)_popVisibleNavigationStacksToRootWithHorizontalLayoutContext:(id *)a3
{
  ...
  if (a3->var0 != a3->var1)
  {
    id v3 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView visibleCells];
    long long v9 = 0u;
    long long v10 = 0u;
    long long v11 = 0u;
    long long v12 = 0u;
    ...
    if (v4)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if ([v8 conformsToProtocol:&unk_1F1E20968]) {
...
- (UIOffset)_roundedOffsetFromOffset:(UIOffset)a3
{
  ...
  if ([(SKUIScrollingTabBarController *)self isViewLoaded])
  {
    uint64_t v6 = [(SKUIScrollingTabBarController *)self view];
    UIRoundToViewScale();
...
- (void)_setFocusedViewController:(id)a3 showBarsIfNeeded:(BOOL)a4 animated:(BOOL)a5 notifyDelegate:(BOOL)a6
{
  ...
  if (v10)
  {
    long long v11 = [(SKUIScrollingTabBarController *)self _deepestFocusedViewControllerWithTopLevelFocusedViewController:v10];
  }
  else
  {
    long long v11 = 0;
  ...
  if (focusedViewController != v11)
  {
    if (self->_canHideBarsOnSwipe
      && [(UIViewController *)focusedViewController conformsToProtocol:&unk_1F1D7DBD0])
    {
    ...
    if (v18) {
      [(UIScrollView *)v18 addObserver:self forKeyPath:@"contentSize" options:0 context:_SKUIScrollingTabFocusedContentScrollViewContentSizeObservationContext];
    }
    if (self->_canHideBarsOnSwipe
      && [(UIViewController *)*p_focusedViewController conformsToProtocol:&unk_1F1D7DBD0])
    {
    ...
    if (topLevelFocusedViewController != v20)
    {
      ...
      if (v6)
      {
        id v19 = [(SKUIScrollingTabBarController *)self delegate];
        if (objc_opt_respondsToSelector()) {
...
- (void)_selectTabAtIndex:(unint64_t)a3 shouldFallbackToPoppingToTabRootContent:(BOOL)a4
{
  BOOL v4 = a4;
  contentCollectionView = self->_contentCollectionView;
  double v8 = [MEMORY[0x1E4F28D58] indexPathForItem:a3 inSection:0];
  id v37 = [(SKUIScrollingTabBarContentCollectionView *)contentCollectionView layoutAttributesForItemAtIndexPath:v8];
  ...
  uint64_t v18 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView collectionViewLayout];
...
LABEL_13:
  ...
  if ([(UIViewController *)self->_topLevelFocusedViewController conformsToProtocol:&unk_1F1E20968])
  {
    id v27 = self->_topLevelFocusedViewController;
    if (([(UIViewController *)v27 isShowingNavigationStackRootContent] & 1) == 0)
    {
      uint64_t v28 = [(SKUIScrollingTabBarController *)self delegate];
      if (objc_opt_respondsToSelector())
      {
        double v29 = [(SKUIScrollingTabBarController *)self delegate];
...
- (void)_setViewControllers:(id)a3 collectionViewsUpdateHandler:(id)a4 forFinalTearDown:(BOOL)a5
{
  ...
  unint64_t v62 = [(SKUIScrollingTabBarController *)self selectedIndex];
  ...
  ++self->_referenceCountForIgnoringContentOffsetUpdateRequests;
  v70 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(v11, "count"));
  long long v85 = 0u;
  long long v86 = 0u;
  long long v87 = 0u;
  long long v88 = 0u;
  ...
  if (v15)
  {
    ...
    uint64_t v18 = (_OWORD *)MEMORY[0x1E4FB2848];
    do
    {
      for (uint64_t i = 0; i != v16; ++i)
      {
        ...
        if (![(NSArray *)self->_viewControllers containsObject:v20])
        {
          ...
          double v24 = [(SKUIScrollingTabBarController *)self _parentCellForViewController:v20];
  ...
  double v25 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:v68];
  long long v79 = 0u;
  long long v80 = 0u;
  long long v81 = 0u;
  long long v82 = 0u;
  ...
  if (v27)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v28; ++j)
      {
        ...
        {
          [v25 addObject:v31];
          if ([v31 conformsToProtocol:&unk_1F1D796F8])
          {
          ...
          double v33 = [[SKUIScrollingTabBarControllerItemContext alloc] initWithViewController:v31];
          [(SKUIScrollingTabBarControllerItemContext *)v33 setDelegate:self];
          viewControllerToItemContext = self->_viewControllerToItemContext;
          if (!viewControllerToItemContext)
          {
            double v35 = (NSMapTable *)[objc_alloc(MEMORY[0x1E4F28E10]) initWithKeyOptions:0 valueOptions:0 capacity:v68];
  ...
  if (v43)
  {
    ...
    do
    {
      for (uint64_t m = 0; m != v44; ++m)
      {
        ...
        if ([v47 conformsToProtocol:&unk_1F1D796F8]) {
  ...
  if (v53 < [(NSArray *)self->_viewControllers count]
    && v53 != [(SKUIScrollingTabBarController *)self selectedIndex])
  {
    v54 = self;
    unint64_t v55 = v53;
LABEL_69:
...
- (void)_updateAdditionalPositionOffsetsWithUpdateRecord:(id *)a3
{
  if (!self->_tabBarExplicitlyHidden)
  {
    ...
    if ([(SKUIScrollingTabBarPalette *)self->_tabBarPalette isAttached])
    {
      ...
      tabBarPalette = self->_tabBarPalette;
      -[SKUIScrollingTabBarPalette setCenter:](tabBarPalette, "setCenter:", v12, v13);
    }
  }
}
...
- (void)_updateFocusedViewControllerInsetsForVerticalLayoutChange
{
  id v3 = [(SKUIScrollingTabBarController *)self view];
...
- (void)_updateForHorizontalLayoutChange
{
  ...
  CGFloat v9 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView collectionViewLayout];
  ...
  long long v23 = [v11 sortedArrayUsingComparator:&__block_literal_global_165];
...
- (void)_updateHidesBarsOnSwipeAvailability
{
  ...
  else
  {
    ...
    double v8 = v7;
    uint64_t v9 = [(SKUIScrollingTabBarController *)self view];
    [v9 bounds];
  ...
  if (self->_canHideBarsOnSwipe != v4)
  {
    ...
    if ([(UIViewController *)self->_focusedViewController conformsToProtocol:&unk_1F1D7DBD0])
    {
      if (self->_canHideBarsOnSwipe) {
        uint64_t v5 = self;
      }
...
- (void)_updateHorizontalScrollingAvailability
{
  ...
  {
    if ([(UIViewController *)self->_topLevelFocusedViewController conformsToProtocol:&unk_1F1E20968])uint64_t v3 = [(UIViewController *)self->_topLevelFocusedViewController isShowingNavigationStackRootContent]; {
    else
    }
      uint64_t v3 = 1;
  }
...
- (void)_updateLayoutOfCollectionViewCell:(id)a3
{
  ...
  {
    double v35 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView layer];
    char v36 = [v35 needsLayout];

    if ((v36 & 1) == 0)
    {
      long long v37 = [v46 navigationBar];
      if ([v37 conformsToProtocol:&unk_1F1DEFAD8])
      {
        id v38 = v37;
        [v38 positionOffset];
        double v39 = v19;
...
- (void)_updateLayoutOfTabBar
{
  if ([(SKUIScrollingTabBarController *)self isViewLoaded])
  {
    id v36 = [(SKUIScrollingTabBarController *)self view];
    [v36 bounds];
    double v4 = v3;
    CGFloat v6 = v5;
    double v8 = v7;
    CGFloat v10 = v9;
    BOOL v11 = [(SKUIScrollingTabBarPalette *)self->_tabBarPalette isAttached];
    double v12 = 0.0;
    if (v11)
    {
    ...
    -[SKUICrossFadingTabBar setFrame:](self->_tabBar, "setFrame:", v27, v32 - CGRectGetHeight(v41), v29, 49.0);
  }
}
...
- (void)_updateLayoutOfVisibleCollectionViewCells
{
  ...
  double v3 = [(SKUIScrollingTabBarContentCollectionView *)self->_contentCollectionView visibleCells];
  long long v8 = 0u;
  long long v9 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SKUIScrollingTabBarController *)self _updateLayoutOfCollectionViewCell:*(void *)(*((void *)&v8 + 1) + 8 * v7++)];
      }
      while (v5 != v7);
...
- (void)_updateNavigationBarsForVerticalLayoutChange
{
  ...
  if (v4)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        if ([v13 conformsToProtocol:&unk_1F1DEFAD8])
        {
          id v14 = v13;
          [v14 positionOffset];
          double v16 = v15;
  ...
  CGFloat v20 = [MEMORY[0x1E4FB1438] sharedApplication];
...
- (void)_updateScrollViewContentOffsetsToTargetContentOffsets
{
  if ([(SKUIScrollingTabBarController *)self isViewLoaded])
  {
    double v3 = [(SKUIScrollingTabBarController *)self view];
    [v3 bounds];
    ...
    {
      contentCollectionView = self->_contentCollectionView;
      -[SKUIScrollingTabBarContentCollectionView setContentOffset:](contentCollectionView, "setContentOffset:");
    }
  }
}
...
- (void)_updateTabBarBackgroundsAndHairlines
{
  if ([(SKUIScrollingTabBarPalette *)self->_tabBarPalette tabBarBackgroundExtendsBehindPalette])
  {
    if ([(SKUIScrollingTabBarPalette *)self->_tabBarPalette isAttached])
    {
      ...
      {
        uint64_t v4 = [SKUIScrollingTabBarBackgroundView alloc];
        [(UIView *)self->_tabBarContainerView bounds];
        double v5 = -[SKUIScrollingTabBarBackgroundView initWithFrame:](v4, "initWithFrame:");
        tabBarExtendedBackgroundView = self->_tabBarExtendedBackgroundView;
        ...
        double v8 = [(SKUIScrollingTabBarController *)self _tabBarBackdropGroupName];
  ...
  id v10 = [(SKUICrossFadingTabBar *)self->_tabBar backgroundView];
  [v10 setHidden:v3];
  [v10 setUsesOpaqueColorForTopHairline:v3 ^ 1];
  double v9 = [(SKUIScrollingTabBarPalette *)self->_tabBarPalette _backgroundView];
...
- (void)_updateTabBarButtons
{
  ...
  uint64_t v3 = [(SKUICrossFadingTabBar *)self->_tabBar tabBarButtons];
  long long v24 = 0u;
  long long v25 = 0u;
  long long v26 = 0u;
  long long v27 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v9; ++j)
      {
        ...
        id v14 = objc_alloc_init(SKUICrossFadingTabBarButton);
...
- ($6FC496E8309A5FF7C7AA8B90E862B691)_viewControllerContentScrollViewContentInsetDescriptor
{
  ...
  *(_OWORD *)&retstr->var0.bottouint64_t m = v5;
  ...
  UIOffset result = ($6FC496E8309A5FF7C7AA8B90E862B691 *)[(SKUIScrollingTabBarPalette *)self->_tabBarPalette isAttached];
  if (result)
  {
    uint64_t v7 = [(SKUIScrollingTabBarController *)self view];
    ...
    UIOffset result = ($6FC496E8309A5FF7C7AA8B90E862B691 *)[(SKUIScrollingTabBarPalette *)self->_tabBarPalette paletteHeight];
