...
{
  v13.receiver = self;
  v13.super_class = (Class)_SKUICounterTimeFieldView;
  v3 = -[_SKUICounterTimeFieldView initWithFrame:](&v13, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v6 = v3->_labelLabel;
    v7 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:14.0];
    ...
    v10 = v3->_valueLabel;
    v11 = [MEMORY[0x1E4FB08E0] fontWithName:@"HelveticaNeue-CondensedBold" size:28.0];
...
- (void)setBackgroundColor:(id)a3
{
  ...
  v6.receiver = self;
  v6.super_class = (Class)_SKUICounterTimeFieldView;
