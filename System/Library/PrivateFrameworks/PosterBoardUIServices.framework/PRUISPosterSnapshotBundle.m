...
- (PRUISPosterSnapshotBundle)initWithURL:(id)a3
{
  v4 = (objc_class *)MEMORY[0x263F5F5A8];
  id v5 = a3;
...
+ (id)snapshotBundleAtURL:(id)a3 error:(id *)a4
{
  id v5 = [MEMORY[0x263F5F5A8] snapshotBundleAtURL:a3 error:a4];
  if (v5) {
...
- (NSArray)snapshotLevelSets
{
  ...
  v3 = objc_msgSend(v2, "bs_mapNoNulls:", &__block_literal_global_4);
...
PRUISPosterLevelSet *__46__PRUISPosterSnapshotBundle_snapshotLevelSets__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v5 = [(PRUISPosterLevelSet *)v3 initWithLevels:v4];
...
- (id)snapshotForLevelSet:(id)a3
{
  ...
  v4 = (objc_class *)MEMORY[0x263F5F590];
  id v5 = a3;
  id v6 = [v4 alloc];
  v7 = [v5 levels];
...
{
  id v4 = a3;
  id v5 = (void *)[objc_alloc((Class)a1) initWithUnderlyingSnapshotBundle:v4];
...
- (PUIColorStatistics)colorStatistics
{
  return (PUIColorStatistics *)[(PUIPosterSnapshotBundle *)self->_underlyingSnapshotBundle colorStatistics];
}

- (PRPosterSnapshotBundle)prPosterSnapshotBundle
{
  double v2 = (void *)MEMORY[0x263F5F510];
  double v3 = [(PRUISPosterSnapshotBundle *)self underlyingSnapshotBundle];
  id v4 = [v2 snapshotBundleWithPUIPosterSnapshotBundle:v3];
