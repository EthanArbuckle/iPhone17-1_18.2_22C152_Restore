uint64_t variable initialization expression of SiriCoreMetricsPlugin.logger()
{
  return Logger.init(subsystem:category:)();
}

uint64_t variable initialization expression of SiriCoreMetricsPlugin.processor()
{
  return 0;
}
...
uint64_t SiriCoreMetricsPlugin.perform(_:)(void *a1)
{
  ...
  uint64_t v10 = SiriCoreMetrics.init(bookmarkLocation:conversationType:)();
  if (!v2)
  {
    v14[1] = v10;
    __swift_instantiateConcreteTypeFromMangledName(&demangling cache variable for type metadata for LighthouseRuntimeProcessor<SiriCoreMetrics>);
    swift_allocObject();
    id v11 = a1;
    uint64_t v12 = LighthouseRuntimeProcessor.init(task:plugin:enforceDiagnosticCheck:)();
    if (v12)
    {
      *(void *)(v3 + OBJC_IVAR___SiriCoreMetricsPlugin_processor) = v12;
      swift_retain();
      swift_release();
...
Swift::Void __swiftcall SiriCoreMetricsPlugin.stop()()
{
  ...
  if (*(void *)(v1 + OBJC_IVAR___SiriCoreMetricsPlugin_processor))
  {
    swift_retain();
...
id SiriCoreMetricsPlugin.init()()
{
  ...
  *(void *)&v1[OBJC_IVAR___SiriCoreMetricsPlugin_processor] = 0;

  v3.receiver = v1;
  v3.super_class = (Class)type metadata accessor for SiriCoreMetricsPlugin();
...
{
  v2.receiver = v0;
  v2.super_class = (Class)type metadata accessor for SiriCoreMetricsPlugin();
  return objc_msgSendSuper2(&v2, "dealloc");
}

uint64_t type metadata accessor for SiriCoreMetricsPlugin()
{
  uint64_t result = type metadata singleton initialization cache for SiriCoreMetricsPlugin;
...
uint64_t ObjC metadata update function for SiriCoreMetricsPlugin()
{
  return type metadata accessor for SiriCoreMetricsPlugin();
}

uint64_t type metadata completion function for SiriCoreMetricsPlugin()
{
...
uint64_t SiriCoreMetrics.init(bookmarkLocation:conversationType:)()
{
  return SiriCoreMetrics.init(bookmarkLocation:conversationType:)();
}
