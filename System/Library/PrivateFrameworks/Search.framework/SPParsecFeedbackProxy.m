...
- (void)suggestionsDidBecomeVisible:(id)a3
{
  ...
  v8 = sub_100062A60("suggestionsDidBecomeVisible", v7);
...
- (void)didAppendLateSections:(id)a3
{
  ...
  xpc_object_t v7 = xpc_BOOL_create(self->_listener != 0);
  v8 = sub_100062A60("didAppendLateSections", v7);
  analytics_send_event();
}
...
- (SPParsecDatastore)datastore
{
  ...
  return (SPParsecDatastore *)WeakRetained;
}
