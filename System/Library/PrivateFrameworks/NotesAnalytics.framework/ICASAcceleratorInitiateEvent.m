@interface ICASAcceleratorInitiateEvent
...
@implementation ICASAcceleratorInitiateEvent

+ (NSString)eventName
{
  return (NSString *)@"AcceleratorInitiateEvent";
}
