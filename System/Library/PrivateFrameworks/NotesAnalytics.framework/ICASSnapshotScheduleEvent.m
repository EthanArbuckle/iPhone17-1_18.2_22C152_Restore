@interface ICASSnapshotScheduleEvent
...
@implementation ICASSnapshotScheduleEvent

+ (NSString)eventName
{
  return (NSString *)@"SnapshotScheduleEvent";
}
