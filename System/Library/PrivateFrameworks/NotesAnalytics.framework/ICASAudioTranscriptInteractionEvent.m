@interface ICASAudioTranscriptInteractionEvent
...
@implementation ICASAudioTranscriptInteractionEvent

+ (NSString)eventName
{
  return (NSString *)@"AudioTranscriptInteractionEvent";
}
