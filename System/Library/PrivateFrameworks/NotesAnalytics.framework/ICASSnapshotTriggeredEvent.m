@interface ICASSnapshotTriggeredEvent
...
@implementation ICASSnapshotTriggeredEvent

+ (NSString)eventName
{
  return (NSString *)@"SnapshotTriggeredEvent";
}
