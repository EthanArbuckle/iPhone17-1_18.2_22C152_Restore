@interface ICASWindowSceneResizeEvent
...
@implementation ICASWindowSceneResizeEvent

+ (NSString)eventName
{
  return (NSString *)@"WindowSceneResizeEvent";
}
