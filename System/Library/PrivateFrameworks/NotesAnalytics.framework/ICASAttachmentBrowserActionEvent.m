@interface ICASAttachmentBrowserActionEvent
...
@implementation ICASAttachmentBrowserActionEvent

+ (NSString)eventName
{
  return (NSString *)@"AttachmentBrowserActionEvent";
}
