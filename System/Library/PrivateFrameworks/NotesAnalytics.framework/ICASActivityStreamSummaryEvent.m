@interface ICASActivityStreamSummaryEvent
...
@implementation ICASActivityStreamSummaryEvent

+ (NSString)eventName
{
  return (NSString *)@"ActivityStreamSummaryEvent";
}
