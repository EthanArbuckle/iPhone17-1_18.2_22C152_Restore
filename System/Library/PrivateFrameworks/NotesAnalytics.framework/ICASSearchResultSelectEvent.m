@interface ICASSearchResultSelectEvent
...
@implementation ICASSearchResultSelectEvent

+ (NSString)eventName
{
  return (NSString *)@"SearchResultSelectEvent";
}
