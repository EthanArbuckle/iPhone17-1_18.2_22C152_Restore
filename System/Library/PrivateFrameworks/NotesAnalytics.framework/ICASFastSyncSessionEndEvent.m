...
+ (NSString)eventName
{
  return (NSString *)@"FastSyncSessionEndEvent";
}
...
+ (int64_t)timestampGranularity
{
  ...
  int64_t v3 = [v2 initWithName:@"day"];
