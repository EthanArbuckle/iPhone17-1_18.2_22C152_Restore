@interface ICASSnapshotCompletionEvent
...
@implementation ICASSnapshotCompletionEvent

+ (NSString)eventName
{
  return (NSString *)@"SnapshotCompletionEvent";
}
