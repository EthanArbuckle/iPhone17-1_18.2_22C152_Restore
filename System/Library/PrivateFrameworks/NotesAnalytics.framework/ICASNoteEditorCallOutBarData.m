...
+ (NSString)dataName;
- (ICASNoteEditorCallOutBarButtonType)noteEditorCallOutBarButtonType;
...
- (ICASNoteEditorCallOutBarData)initWithNoteEditorCallOutBarButtonType:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ICASNoteEditorCallOutBarData;
  v6 = [(ICASNoteEditorCallOutBarData *)&v9 init];
  v7 = v6;
  if (v6) {
    objc_storeStrong((id *)&v6->_noteEditorCallOutBarButtonType, a3);
  }
...
+ (NSString)dataName
{
  return (NSString *)@"NoteEditorCallOutBarData";
}
...
- (id)toDict
{
  ...
  if (v3)
  {
    uint64_t v4 = [(ICASNoteEditorCallOutBarData *)self noteEditorCallOutBarButtonType];
  }
  else
  {
