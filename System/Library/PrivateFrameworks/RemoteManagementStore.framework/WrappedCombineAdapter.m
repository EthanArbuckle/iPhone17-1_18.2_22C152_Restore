...
- (void)beginProcessingConfigurationsForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  objc_super v9 = [(WrappedCombineAdapter *)self wrappedAdapter];
  v10 = v9;
  if (v8)
  {
...
- (void)endProcessingConfigurations:(BOOL)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  char v11 = [(WrappedCombineAdapter *)self wrappedAdapter];
  v12 = v11;
  if (v10)
  {
  ...
  else
  {
    ...
    if (v13)
    {
      id v14 = [(WrappedCombineAdapter *)self wrappedAdapter];
      id v16 = 0;
...
- (void)applyCombinedConfiguration:(id)a3 declarationKeys:(id)a4 scope:(int64_t)a5 completionHandler:(id)a6
{
  ...
  char v13 = [(WrappedCombineAdapter *)self wrappedAdapter];
  char v14 = objc_opt_respondsToSelector();

  id v15 = [(WrappedCombineAdapter *)self wrappedAdapter];
  char v16 = v15;
  if (v14)
  {
