...
- (RMConfigurationMultipleAdapter)wrappedAdapter;
...
- (WrappedMultipleAdapter)initWithAdapter:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)WrappedMultipleAdapter;
...
- (void)beginProcessingConfigurationsForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  objc_super v9 = [(WrappedMultipleAdapter *)self wrappedAdapter];
  v10 = v9;
  if (v8)
  {
...
- (void)endProcessingConfigurations:(BOOL)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  char v11 = [(WrappedMultipleAdapter *)self wrappedAdapter];
  v12 = v11;
  if (v10)
  {
  ...
  else
  {
    ...
    if (v13)
    {
      id v14 = [(WrappedMultipleAdapter *)self wrappedAdapter];
      id v16 = 0;
...
- (void)allDeclarationKeysForScope:(int64_t)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    {
      id v19 = 0;
      id v14 = [v12 allDeclarationKeysForScope:a3 error:&v19];
      id v15 = v19;
...
- (void)applyConfiguration:(id)a3 replaceKey:(id)a4 scope:(int64_t)a5 completionHandler:(id)a6
{
  ...
  char v13 = [(WrappedMultipleAdapter *)self wrappedAdapter];
  char v14 = objc_opt_respondsToSelector();

  id v15 = [(WrappedMultipleAdapter *)self wrappedAdapter];
  char v16 = v15;
  if (v14)
  {
...
- (void)removeDeclarationKey:(id)a3 scope:(int64_t)a4 completionHandler:(id)a5
{
  ...
  id v10 = [(WrappedMultipleAdapter *)self wrappedAdapter];
  char v11 = objc_opt_respondsToSelector();
