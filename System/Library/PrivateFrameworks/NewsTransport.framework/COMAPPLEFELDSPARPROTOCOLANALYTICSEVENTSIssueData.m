...
- (id)description
{
  ...
  id v4 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *)&v8 description];
  v5 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((unsigned char *)v4 + 32) = self->_isBundlePaid;
  ...
  if ([(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *)self topicIdsCount])
  {
    [v10 clearTopicIds];
    unint64_t v6 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *)self topicIdsCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *)self topicIdsAtIndex:i];
        [v10 addTopicIds:v9];
      }
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData addTopicIds:](self, "addTopicIds:", *(void *)(*((void *)&v11 + 1) + 8 * i), (void)v11);
      }
