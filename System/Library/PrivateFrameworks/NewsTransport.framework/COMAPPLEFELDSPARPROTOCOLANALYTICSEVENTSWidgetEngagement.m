...
{
  id v3 = a3;
  if ([v3 isEqualToString:@"UNKNOWN_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 0;
  }
  else if ([v3 isEqualToString:@"ARTICLE_VIEW_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 1;
  }
  else if ([v3 isEqualToString:@"VIDEO_PLAY_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 2;
  }
  else if ([v3 isEqualToString:@"NO_STORIES_READ_MORE_BUTTON_TAP_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 3;
  }
  else if ([v3 isEqualToString:@"HEADER_TAP_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 4;
  }
  else if ([v3 isEqualToString:@"WEB_EMBED_TAP_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 5;
  }
  else if ([v3 isEqualToString:@"DISCOVER_MORE_ENGAGEMENT_TYPE"])
  {
    int v4 = 6;
  }
  else if ([v3 isEqualToString:@"VIDEO_CALL_TO_ACTION_ENGAGEMENT_TYPE"])
  {
    int v4 = 7;
  }
  else if ([v3 isEqualToString:@"WIDGET_BACKGROUND_ENGAGEMENT_TYPE"])
  {
    int v4 = 8;
  }
  else if ([v3 isEqualToString:@"SECTION_NAME_ENGAGEMENT_TYPE"])
  {
    int v4 = 9;
  }
  else if ([v3 isEqualToString:@"WHOLE_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 10;
  }
  else if ([v3 isEqualToString:@"BANNER_WIDGET_ENGAGEMENT_TYPE"])
  {
    int v4 = 11;
  }
  else
...
- (id)description
{
  ...
  int v4 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *)&v8 description];
  v5 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((*(_WORD *)&self->_has & 0x80) != 0)
  {
    uint64_t widgetEngagementType = self->_widgetEngagementType;
    if (widgetEngagementType >= 0xC)
    {
      objc_msgSend(NSString, "stringWithFormat:", @"(unknown: %i)", self->_widgetEngagementType);
      v5 = (__CFString *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      v5 = off_26444C488[widgetEngagementType];
    }
    [v3 setObject:v5 forKey:@"widget_engagement_type"];
  }
  ...
  if ((has & 0x200) != 0)
  {
    v16 = [NSNumber numberWithInt:self->_widgetSectionDisplayRank];
    [v3 setObject:v16 forKey:@"widget_section_display_rank"];
...
LABEL_14:
  ...
  v17 = [NSNumber numberWithInt:self->_widgetArticleRankInSection];
  [v3 setObject:v17 forKey:@"widget_article_rank_in_section"];
...
LABEL_26:
  v18 = [NSNumber numberWithInt:self->_widgetArticleRank];
  [v3 setObject:v18 forKey:@"widget_article_rank"];

  if ((*(_WORD *)&self->_has & 2) != 0)
  {
LABEL_16:
    v10 = [NSNumber numberWithInt:self->_widgetArticleCount];
    [v3 setObject:v10 forKey:@"widget_article_count"];
  }
LABEL_17:
  otherVisibleSections = self->_otherVisibleSections;
  if (otherVisibleSections) {
  ...
  if ((v13 & 0x800) != 0)
  {
    ...
    {
      v15 = off_26444C4E8[widgetVideoPresentationReason];
    }
    [v3 setObject:v15 forKey:@"widget_video_presentation_reason"];

    __int16 v13 = (__int16)self->_has;
  }
  if ((v13 & 4) != 0)
  {
    v19 = [NSNumber numberWithInt:self->_widgetArticleCountInSection];
    [v3 setObject:v19 forKey:@"widget_article_count_in_section"];
  }
  ...
  if ((*(_WORD *)&self->_has & 0x20) != 0)
  {
    ...
    {
      v22 = off_26444C500[widgetContentType];
    }
    [v3 setObject:v22 forKey:@"widget_content_type"];
  }
  ...
  if (v26)
  {
    v27 = [NSNumber numberWithLongLong:self->_contentFetchDate];
    [v3 setObject:v27 forKey:@"content_fetch_date"];
  ...
  if ((v26 & 0x40) != 0)
  {
    ...
    {
      v29 = off_26444C518[widgetDisplayMode];
    }
    [v3 setObject:v29 forKey:@"widget_display_mode"];
  }
  ...
  if ((v31 & 0x100) != 0)
  {
    ...
    {
      v33 = off_26444C558[widgetExposureStackLocation];
    }
    [v3 setObject:v33 forKey:@"widget_exposure_stack_location"];
  ...
  if ((v31 & 0x400) != 0)
  {
    ...
    {
      v35 = off_26444C588[widgetType];
    }
    [v3 setObject:v35 forKey:@"widget_type"];
  }
...
LABEL_14:
  if ([(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *)self otherVisibleSectionsCount])
  {
    [v14 clearOtherVisibleSections];
    unint64_t v6 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *)self otherVisibleSectionsCount];
    if (v6)
    {
      unint64_t v7 = v6;
      for (uint64_t i = 0; i != v7; ++i)
      {
        uint64_t v9 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *)self otherVisibleSectionsAtIndex:i];
        [v14 addOtherVisibleSections:v9];
      }
    }
  }
  if (self->_articleViewingSessionId) {
  ...
  if (v12)
  {
    *((void *)v11 + 1) = self->_contentFetchDate;
    *((_WORD *)v11 + 90) |= 1u;
    __int16 v12 = (__int16)self->_has;
  }
  if ((v12 & 0x40) != 0)
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v4[45] & 0x80) != 0)
  {
    self->_uint64_t widgetEngagementType = v4[32];
    *(_WORD *)&self->_has |= 0x80u;
  }
  if (*((void *)v4 + 2)) {
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        -[COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement addOtherVisibleSections:](self, "addOtherVisibleSections:", *(void *)(*((void *)&v15 + 1) + 8 * i), (void)v15);
      }
