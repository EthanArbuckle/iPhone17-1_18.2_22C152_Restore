...
- (id)description
{
  ...
  int v4 = [(NTPBWebAccessScreenView *)&v8 description];
  v5 = [(NTPBWebAccessScreenView *)self dictionaryRepresentation];
...
LABEL_7:
  ...
  {
    objc_super v8 = off_26444B720[paidSubscriptionConversionPointType];
  }
...
LABEL_11:
  ...
  if ((v15 & 2) != 0)
  {
    ...
    {
      v22 = off_26444B7D0[parentFeedType];
    }
    [v3 setObject:v22 forKey:@"parent_feed_type"];
...
LABEL_25:
  ...
  v23 = [NSNumber numberWithBool:self->_subscriptionOnlyArticlePreview];
  [v3 setObject:v23 forKey:@"subscription_only_article_preview"];
...
LABEL_27:
  ...
  if ((*(unsigned char *)&self->_has & 0x10) != 0)
  {
    v19 = [NSNumber numberWithInt:self->_webAccessScreenPresentationReason];
    [v3 setObject:v19 forKey:@"web_access_screen_presentation_reason"];
  }
...
LABEL_7:
  ...
  *(unsigned char *)(v6 + 97) = self->_subscriptionOnlyArticlePreview;
  *(unsigned char *)(v6 + 100) |= 0x40u;
  if ((*(unsigned char *)&self->_has & 0x20) != 0)
  {
LABEL_8:
    *(unsigned char *)(v6 + 96) = self->_arrivedFromAd;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*(unsigned char *)&self->_has & 8) != 0)
  {
    if ((*((unsigned char *)v4 + 100) & 8) == 0 || self->_userAction != *((_DWORD *)v4 + 22)) {
      goto LABEL_59;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 4) != 0)
  {
    if ((*((unsigned char *)v4 + 100) & 4) == 0 || self->_resultType != *((_DWORD *)v4 + 14)) {
      goto LABEL_59;
    }
  }
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 100) & 1) == 0 || self->_paidSubscriptionConversionPointType != *((_DWORD *)v4 + 12)) {
      goto LABEL_59;
    }
  }
  ...
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 100) & 2) == 0 || self->_parentFeedType != *((_DWORD *)v4 + 13)) {
      goto LABEL_59;
    }
  }
...
LABEL_50:
  iadQtoken = self->_iadQtoken;
  if ((unint64_t)iadQtoken | *((void *)v4 + 5) && !-[NSString isEqual:](iadQtoken, "isEqual:")) {
    goto LABEL_59;
  }
  subscriptionPurchaseSessionId = self->_subscriptionPurchaseSessionId;
  if ((unint64_t)subscriptionPurchaseSessionId | *((void *)v4 + 10))
  {
  ...
  if ((*(unsigned char *)&self->_has & 0x10) != 0)
  {
    if ((*((unsigned char *)v4 + 100) & 0x10) == 0 || self->_webAccessScreenPresentationReason != *((_DWORD *)v4 + 23)) {
      goto LABEL_59;
    }
    BOOL v13 = 1;
  }
  ...
  {
    BOOL v13 = (*((unsigned char *)v4 + 100) & 0x10) == 0;
  }
LABEL_60:
...
LABEL_6:
  ...
  uint64_t v18 = 2654435761 * self->_userAction;
  if ((*(unsigned char *)&self->_has & 4) == 0) {
    goto LABEL_6;
  }
LABEL_3:
  uint64_t v17 = 2654435761 * self->_resultType;
  if (*(unsigned char *)&self->_has)
  {
LABEL_4:
    uint64_t v16 = 2654435761 * self->_paidSubscriptionConversionPointType;
    goto LABEL_8;
  }
LABEL_7:
  uint64_t v16 = 0;
LABEL_8:
  ...
  NSUInteger v14 = [(NSString *)self->_errorCode hash];
  NSUInteger v13 = [(NSString *)self->_sourceChannelId hash];
  NSUInteger v3 = [(NSString *)self->_sectionId hash];
  NSUInteger v4 = [(NSString *)self->_articleId hash];
  uint64_t v5 = [(NSData *)self->_articleViewingSessionId hash];
  if ((*(unsigned char *)&self->_has & 2) == 0)
  {
    uint64_t v6 = 0;
    if ((*(unsigned char *)&self->_has & 0x40) != 0) {
...
LABEL_13:
  ...
  uint64_t v6 = 2654435761 * self->_parentFeedType;
  if ((*(unsigned char *)&self->_has & 0x40) == 0) {
    goto LABEL_13;
  }
LABEL_10:
  uint64_t v7 = 2654435761 * self->_subscriptionOnlyArticlePreview;
  if ((*(unsigned char *)&self->_has & 0x20) != 0)
  {
LABEL_11:
    uint64_t v8 = 2654435761 * self->_arrivedFromAd;
    goto LABEL_15;
  }
LABEL_14:
  uint64_t v8 = 0;
LABEL_15:
  NSUInteger v9 = [(NSString *)self->_iadQtoken hash];
  uint64_t v10 = [(NSData *)self->_subscriptionPurchaseSessionId hash];
  if ((*(unsigned char *)&self->_has & 0x10) != 0) {
    uint64_t v11 = 2654435761 * self->_webAccessScreenPresentationReason;
  }
  else {
    uint64_t v11 = 0;
  }
...
LABEL_19:
  ...
  self->_subscriptionOnlyArticlePreview = *((unsigned char *)v4 + 97);
  *(unsigned char *)&self->_has |= 0x40u;
  if ((*((unsigned char *)v4 + 100) & 0x20) != 0)
  {
LABEL_20:
    self->_arrivedFromAd = *((unsigned char *)v4 + 96);
    *(unsigned char *)&self->_has |= 0x20u;
  }
LABEL_21:
  if (*((void *)v4 + 5))
