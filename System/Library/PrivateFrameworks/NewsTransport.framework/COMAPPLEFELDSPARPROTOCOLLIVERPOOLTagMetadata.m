...
@implementation COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
  v4 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata *)&v8 description];
  v5 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata *)self dictionaryRepresentation];
...
LABEL_6:
  ...
  {
    objc_super v8 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo *)contentAndRelevanceInfo dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadataReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  ...
  v4[7] = LODWORD(self->_subscriptionRate);
...
LABEL_13:
  v4[6] = LODWORD(self->_quality);
  *((unsigned char *)v4 + 32) |= 4u;
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
LABEL_5:
    v4[5] = self->_ontologyLevel;
...
LABEL_6:
  ...
  {
    id v6 = v4;
    objc_msgSend(v4, "setContentAndRelevanceInfo:");
    id v4 = v6;
  }
}
...
LABEL_6:
  id v8 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo *)self->_contentAndRelevanceInfo copyWithZone:a3];
  v9 = (void *)v6[1];
  v6[1] = v8;
...
LABEL_24:
  ...
  if ((unint64_t)contentAndRelevanceInfo | *((void *)v4 + 1)) {
    char v6 = -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo isEqual:](contentAndRelevanceInfo, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (unint64_t)hash
{
  ...
  return v9 ^ v4 ^ v14 ^ v19 ^ [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLContentAndRelevanceInfo *)self->_contentAndRelevanceInfo hash];
}
...
LABEL_6:
  ...
  {
    -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata setContentAndRelevanceInfo:](self, "setContentAndRelevanceInfo:");
  }
