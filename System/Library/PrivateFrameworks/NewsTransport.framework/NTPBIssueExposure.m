...
- (id)description
{
  ...
  id v4 = [(NTPBIssueExposure *)&v8 description];
  v5 = [(NTPBIssueExposure *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (channelData)
  {
    v9 = [(NTPBChannelData *)channelData dictionaryRepresentation];
  ...
  if ((has & 0x2000) != 0)
  {
    ...
    {
      v13 = off_26444AD70[parentFeedType];
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 136) = v8;
  ...
  id v10 = [(NTPBChannelData *)self->_channelData copyWithZone:a3];
  v11 = *(void **)(v5 + 96);
  *(void *)(v5 + 96) = v10;

  uint64_t v12 = [(NSString *)self->_sourceChannelId copyWithZone:a3];
  long long v13 = *(void **)(v5 + 168);
  *(void *)(v5 + 168) = v12;
...
- (unint64_t)hash
{
  unint64_t v75 = [(NTPBIssueData *)self->_issueData hash];
  unint64_t v74 = [(NTPBIssueExposureData *)self->_issueExposureData hash];
  unint64_t v73 = [(NTPBChannelData *)self->_channelData hash];
  ...
  if (v14)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v15; ++i)
      {
        ...
        -[NTPBIssueExposure addFractionalCohortMembership:](self, "addFractionalCohortMembership:", *(void *)(*((void *)&v19 + 1) + 8 * i), (void)v19);
      }
