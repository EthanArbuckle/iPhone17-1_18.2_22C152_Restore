...
@implementation NTPBBundleIDMappingBundleID
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBBundleIDMappingBundleID;
  id v4 = [(NTPBBundleIDMappingBundleID *)&v8 description];
  v5 = [(NTPBBundleIDMappingBundleID *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NTPBBundleIDMappingBundleIDReadFrom(self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    ...
    && ((channelTags = self->_channelTags, !((unint64_t)channelTags | v4[2]))
...
- (void)mergeFrom:(id)a3
{
  ...
  id v4 = a3;
  if (*((void *)v4 + 1)) {
    -[NTPBBundleIDMappingBundleID setBundleId:](self, "setBundleId:");
  }
  long long v30 = 0u;
  long long v31 = 0u;
  long long v28 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        [(NTPBBundleIDMappingBundleID *)self addTopicTags:*(void *)(*((void *)&v28 + 1) + 8 * i)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v12; ++j)
      {
        ...
        [(NTPBBundleIDMappingBundleID *)self addChannelTags:*(void *)(*((void *)&v24 + 1) + 8 * j)];
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (uint64_t k = 0; k != v17; ++k)
      {
        ...
        -[NTPBBundleIDMappingBundleID addSectionTags:](self, "addSectionTags:", *(void *)(*((void *)&v20 + 1) + 8 * k), (void)v20);
      }
