...
- (id)description
{
  ...
  id v4 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration *)&v8 description];
  v5 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  id v9 = v4;
  if ([(COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration *)self tagsExpirationListsCount])
  {
    [v9 clearTagsExpirationLists];
    unint64_t v5 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration *)self tagsExpirationListsCount];
    if (v5)
    {
      unint64_t v6 = v5;
      for (uint64_t i = 0; i != v6; ++i)
      {
        uint64_t v8 = [(COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration *)self tagsExpirationListAtIndex:i];
        [v9 addTagsExpirationList:v8];
      }
    }
  }
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration addTagsExpirationList:](self, "addTagsExpirationList:", *(void *)(*((void *)&v11 + 1) + 8 * v10++), (void)v11);
      }
      while (v8 != v10);
