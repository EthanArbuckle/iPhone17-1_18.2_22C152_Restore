...
@implementation NTPBTocToggleTap
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBTocToggleTap;
  v4 = [(NTPBTocToggleTap *)&v8 description];
  v5 = [(NTPBTocToggleTap *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NTPBTocToggleTapReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NTPBTocToggleTap setTocExposureId:](self, "setTocExposureId:");
  }
}
