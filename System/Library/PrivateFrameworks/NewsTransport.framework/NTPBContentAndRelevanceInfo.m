...
@implementation NTPBContentAndRelevanceInfo
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBContentAndRelevanceInfo;
  v4 = [(NTPBContentAndRelevanceInfo *)&v8 description];
  v5 = [(NTPBContentAndRelevanceInfo *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [NSNumber numberWithInt:self->_contentRating];
    [v3 setObject:v5 forKey:@"content_rating"];

    char has = (char)self->_has;
  }
  if ((has & 2) != 0)
  {
    v6 = [NSNumber numberWithInt:self->_relevanceRating];
    [v3 setObject:v6 forKey:@"relevance_rating"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return NTPBContentAndRelevanceInfoReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    self->_contentRating = *((_DWORD *)v4 + 2);
    *(unsigned char *)&self->_has |= 1u;
    char v5 = *((unsigned char *)v4 + 16);
  }
  if ((v5 & 2) != 0)
  {
    self->_relevanceRating = *((_DWORD *)v4 + 3);
    *(unsigned char *)&self->_has |= 2u;
  }
}
