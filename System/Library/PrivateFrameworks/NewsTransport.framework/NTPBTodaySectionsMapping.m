...
@implementation NTPBTodaySectionsMapping
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBTodaySectionsMapping;
  id v4 = [(NTPBTodaySectionsMapping *)&v8 description];
  v5 = [(NTPBTodaySectionsMapping *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_identifiers, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    ...
    [v3 setObject:v4 forKey:@"identifiers"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return NTPBTodaySectionsMappingReadFrom(self, (uint64_t)a3);
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NTPBTodaySectionsMapping addIdentifiers:](self, "addIdentifiers:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
