...
@implementation NTPBPurchaseOffersItem
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBPurchaseOffersItem;
  int v4 = [(NTPBPurchaseOffersItem *)&v8 description];
  v5 = [(NTPBPurchaseOffersItem *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NTPBPurchaseOffersItemReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    uint64_t v5 = v4;
    -[NTPBPurchaseOffersItem setPurchaseId:](self, "setPurchaseId:");
    uint64_t v4 = v5;
  }
  if (v4[5])
  {
