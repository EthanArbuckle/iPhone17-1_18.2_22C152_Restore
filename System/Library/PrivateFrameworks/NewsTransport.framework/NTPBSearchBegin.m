...
@implementation NTPBSearchBegin
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBSearchBegin;
  int v4 = [(NTPBSearchBegin *)&v8 description];
  v5 = [(NTPBSearchBegin *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    {
      v5 = off_26444C5A8[searchLocation];
    }
    [v3 setObject:v5 forKey:@"search_location"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return NTPBSearchBeginReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(_DWORD *)(v5 + 32) = self->_searchLocation;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 36) & 1) == 0 || self->_searchLocation != *((_DWORD *)v4 + 8)) {
      goto LABEL_13;
    }
  }
...
{
  if (*(unsigned char *)&self->_has) {
    uint64_t v3 = 2654435761 * self->_searchLocation;
  }
  else {
    uint64_t v3 = 0;
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[9])
  {
    self->_uint64_t searchLocation = v4[8];
    *(unsigned char *)&self->_has |= 1u;
  }
  NSUInteger v5 = v4;
  if (*((void *)v4 + 1))
  {
    -[NTPBSearchBegin setCampaignId:](self, "setCampaignId:");
    NSUInteger v4 = v5;
  }
  if (*((void *)v4 + 2))
  {
    -[NTPBSearchBegin setCampaignType:](self, "setCampaignType:");
    NSUInteger v4 = v5;
  }
  if (*((void *)v4 + 3))
  {
    -[NTPBSearchBegin setCreativeId:](self, "setCreativeId:");
    NSUInteger v4 = v5;
  }
}
