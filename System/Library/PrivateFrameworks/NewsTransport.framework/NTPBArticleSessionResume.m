...
@implementation NTPBArticleSessionResume
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBArticleSessionResume;
  int v4 = [(NTPBArticleSessionResume *)&v8 description];
  v5 = [(NTPBArticleSessionResume *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v9 = [NSNumber numberWithLongLong:self->_publisherArticleVersion];
    [v4 setObject:v9 forKey:@"publisher_article_version"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return NTPBArticleSessionResumeReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 40) = v8;
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(void *)(v5 + 8) = self->_publisherArticleVersion;
    *(unsigned char *)(v5 + 48) |= 1u;
  }
  uint64_t v10 = [(NSData *)self->_articleViewingSessionId copyWithZone:a3];
  v11 = *(void **)(v5 + 32);
  *(void *)(v5 + 32) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 48) & 2) == 0 || self->_articleType != *((_DWORD *)v4 + 6)) {
      goto LABEL_19;
    }
  }
...
LABEL_19:
  ...
  if (has)
  {
    if ((*((unsigned char *)v4 + 48) & 1) == 0 || self->_publisherArticleVersion != *((void *)v4 + 1)) {
      goto LABEL_19;
    }
  }
  ...
  if ((unint64_t)articleViewingSessionId | *((void *)v4 + 4)) {
    char v9 = -[NSData isEqual:](articleViewingSessionId, "isEqual:");
  }
  else {
    char v9 = 1;
  }
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has) {
    uint64_t v6 = 2654435761 * self->_publisherArticleVersion;
  }
  else {
    uint64_t v6 = 0;
  }
  return v4 ^ v3 ^ v5 ^ v6 ^ [(NSData *)self->_articleViewingSessionId hash];
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 2))
  {
    -[NTPBArticleSessionResume setArticleId:](self, "setArticleId:");
    id v4 = v5;
  }
  ...
  if (*((void *)v4 + 5))
  {
    -[NTPBArticleSessionResume setSourceChannelId:](self, "setSourceChannelId:");
    id v4 = v5;
  }
  if (*((unsigned char *)v4 + 48))
  {
    self->_publisherArticleVersion = *((void *)v4 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
  if (*((void *)v4 + 4))
  {
    -[NTPBArticleSessionResume setArticleViewingSessionId:](self, "setArticleViewingSessionId:");
    id v4 = v5;
  }
}
