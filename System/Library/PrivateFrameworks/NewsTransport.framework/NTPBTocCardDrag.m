...
@implementation NTPBTocCardDrag
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NTPBTocCardDrag;
  v4 = [(NTPBTocCardDrag *)&v8 description];
  v5 = [(NTPBTocCardDrag *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NTPBTocCardDragReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NTPBTocCardDrag setTocExposureId:](self, "setTocExposureId:");
  }
}
