...
@implementation COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData;
  v4 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData *)&v8 description];
  v5 = [(COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelDataReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  if (*(unsigned char *)&self->_has)
  {
    *((unsigned char *)a3 + 8) = self->_isBundleChannel;
