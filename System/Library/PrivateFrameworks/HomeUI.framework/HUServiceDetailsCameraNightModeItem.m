@interface HUServiceDetailsCameraNightModeItem
...
- (id)_subclass_updateWithOptions:(id)a3
{
  ...
  id v4 = a3;
  if ([(HUServiceDetailsCameraNightModeItem *)self _canReadWriteNightVisionControl])
  {
    v5 = [(HUServiceDetailsCameraNightModeItem *)self settingsReaderWriter];
...
- (BOOL)_canReadWriteNightVisionControl
{
  ...
  if (v5)
  {
    v6 = [v5 profile];
    v7 = [v6 userSettings];
    unint64_t v8 = ((unint64_t)[v7 supportedFeatures] >> 3) & 1;
  }
  else
  {
    LOBYTE(v8) = 0;
...
- (id)characteristicForSettings:(id)a3
{
  return (id)[a3 nightVisionModeEnabledCharacteristic];
}

- (id)itemTitleLocalizationKey
{
  return @"HUCameraNightModeSwitchTitle";
}

- (id)itemTitle
{
  v2 = [(HUServiceDetailsCameraNightModeItem *)self itemTitleLocalizationKey];
