...
- (double)tableView:(id)a3 heightForFooterInSection:(int64_t)a4
{
  ...
  if (![v8 isEqualToString:@"HUCameraSmartDetectionSettingsOnOffSectionIdentifier"]|| (-[HUItemTableViewController itemManager](self, "itemManager"), v9 = objc_claimAutoreleasedReturnValue(), uint64_t v10 = objc_msgSend(v9, "sectionIndexForDisplayedSectionIdentifier:", @"HUCameraSmartDetectionSettingsMotionDetectionSectionIdentifier"), v9, v11 = 10.0, v10 == 0x7FFFFFFFFFFFFFFFLL))
  {
    v14.receiver = self;
