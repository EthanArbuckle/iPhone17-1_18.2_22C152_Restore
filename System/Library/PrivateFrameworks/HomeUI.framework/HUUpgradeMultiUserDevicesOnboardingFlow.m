...
void __76__HUUpgradeMultiUserDevicesOnboardingFlow_initWithUpgradeRequirements_home___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if ([*(id *)(a1 + 32) BOOLValue])
  {
    ...
    id v7 = [(HUUpgradeMultiUserDevicesViewController *)v4 initWithUpgradeRequirements:v5 home:v6];
...
- (NSString)description
{
  return (NSString *)@"Upgrade Multi User Devices";
}
...
- (id)processUserInput:(id)a3
{
  ...
  id v8 = [(HUUpgradeMultiUserDevicesOnboardingFlow *)self onboardingFuture];
  [v8 finishWithNoResult];
