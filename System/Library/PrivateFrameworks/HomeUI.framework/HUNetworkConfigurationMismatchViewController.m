...
- (HUNetworkConfigurationMismatchViewController)initWithItemManager:(id)a3 tableViewStyle:(int64_t)a4
{
  ...
  objc_msgSend(v6, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"HUNetworkConfigurationMismatchViewController.m", 27, @"%s is unavailable; use %@ instead",
    "-[HUNetworkConfigurationMismatchViewController initWithItemManager:tableViewStyle:]",
    v7);
...
- (HUNetworkConfigurationMismatchViewController)initWithProfiles:(id)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)HUNetworkConfigurationMismatchViewController;
...
- (Class)cellClassForItem:(id)a3 indexPath:(id)a4
{
  ...
  else
  {
    ...
    [v10 handleFailureInMethod:a2, self, @"HUNetworkConfigurationMismatchViewController.m", 43, @"Couldn't find a cell class for item: %@", v6 object file lineNumber description];
...
- (void)setupCell:(id)a3 forItem:(id)a4 indexPath:(id)a5
{
  id v8 = a3;
  v11.receiver = self;
  v11.super_class = (Class)HUNetworkConfigurationMismatchViewController;
  id v9 = a4;
...
- (void)updateCell:(id)a3 forItem:(id)a4 indexPath:(id)a5 animated:(BOOL)a6
{
  ...
  id v11 = a4;
  v23.receiver = self;
  v23.super_class = (Class)HUNetworkConfigurationMismatchViewController;
...
- (BOOL)tableView:(id)a3 shouldHighlightRowAtIndexPath:(id)a4
{
  ...
  {
    v14.receiver = self;
    v14.super_class = (Class)HUNetworkConfigurationMismatchViewController;
...
{
  v7.receiver = self;
  v7.super_class = (Class)HUNetworkConfigurationMismatchViewController;
  id v5 = a4;
  id v6 = a3;
