...
- (id)collectionLayoutSectionForSectionWithIdentifier:(id)a3 layoutEnvironment:(id)a4
{
  ...
  v9 = self;
  v10 = sub_1BE3F6164(v6, v8, (uint64_t)a4);
...
- (BOOL)shouldShowHeaderForSection:(id)a3
{
  ...
  uint64_t v6 = &v5[OBJC_IVAR___HUAccessoryRepresentableItemModuleContext_sectionGroupingType];
  swift_beginAccess();
  uint64_t v7 = *(void *)v6;
...
- (BOOL)shouldShowFooterForSection:(id)a3
{
  ...
  uint64_t v6 = &v5[OBJC_IVAR___HUAccessoryRepresentableItemModuleContext_showFooter];
  swift_beginAccess();
  LOBYTE(v6) = *v6;
