...
- (id)platterWithView:(id)a3
{
  v3 = (objc_class *)MEMORY[0x1E4F16708];
  id v4 = a3;
...
- (void)viewDidLoad
{
  ...
  id v4 = [(HUCameraPlayerFooterViewController *)self liveButton];
  [v3 addSubview:v4];

  id v5 = [(HUCameraPlayerFooterViewController *)self nearbyAccessoryButton];
...
- (UIButton)nearbyAccessoryButton
{
  ...
  if (!nearbyAccessoryButton)
  {
    ...
    id v5 = self->_nearbyAccessoryButton;
...
- (UIButton)liveButton
{
  ...
  if (!liveButton)
  {
    objc_msgSend(MEMORY[0x1E4F427E0], "hu_clipScrubberLiveButtonWithMaximimumLineHeight:", 0.0);
    id v4 = (UIButton *)objc_claimAutoreleasedReturnValue();
