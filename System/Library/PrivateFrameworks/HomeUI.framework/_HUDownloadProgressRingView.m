...
- (_HUDownloadProgressRingView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    id v7 = [(_HUDownloadProgressRingView *)v4 tintColor];
...
- (void)tintColorDidChange
{
  ...
  [(_HUDownloadProgressRingView *)&v6 tintColorDidChange];
  objc_super v3 = [(_HUDownloadProgressRingView *)self tintColor];
...
{
  self->_progress = a3;
  id v4 = [(_HUDownloadProgressRingView *)self layer];
...
- (void)_updateShapePath
{
  ...
  [v11 displayScale];
  double v13 = HUGetSafeScaleForValue(v12);

  id v27 = [(_HUDownloadProgressRingView *)self layer];
  [v27 lineWidth];
  CGFloat v15 = v14 * 0.5;
