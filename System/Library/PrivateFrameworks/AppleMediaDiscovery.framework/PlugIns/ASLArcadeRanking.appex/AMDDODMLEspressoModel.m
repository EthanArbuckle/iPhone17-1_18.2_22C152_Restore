...
- (AMDDODMLEspressoModel)initWithModelMetadata:(id)a3 withAttachmentProcessor:(id)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  *((void *)v58 + 5) = v12;
  ...
  id v14 = [v58 createBufferDictionary:*((void *)v58 + 2)];
  v15 = (void *)*((void *)v58 + 3);
  *((void *)v58 + 3) = v14;

  id v47 = v58;
  id v48 = [location[0] outputNames];
  id v16 = objc_msgSend(v47, "createBufferDictionary:");
  v17 = (void *)*((void *)v58 + 4);
  *((void *)v58 + 4) = v16;

  id v18 = [v58 createBufferDictionary:*((void *)v58 + 5)];
  v19 = (void *)*((void *)v58 + 6);
  *((void *)v58 + 6) = v18;
  ...
  *((void *)v58 + 65) = v40;
  ...
  if ([v58 _buildPlan:v55 errorDomain:v54])
  {
    if ([v58 _bindBuffers:v55 errorDomain:v54])
    {
      ...
      {
        id v45 = [location[0] initializationFunctionName];
        [v45 UTF8String];
        ...
        if (v46 || espresso_plan_execute_sync())
        {
          ...
          id v43 = [v42 initWithDomain:v54 code:77 userInfo:0];
          id *v55 = v43;
          v59 = 0;
          goto LABEL_15;
        }
  ...
  if (v29->_ctx)
  {
    ...
    if (v29->_plan)
    {
      ...
      if (v8)
      {
        ...
        id v10 = [v9 initWithDomain:location code:67 userInfo:0];
        id *v27 = v10;
        int64_t v30 = 0;
        int v25 = 1;
      }
      else
      {
        ...
        NSUInteger v21 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v31 count:16];
        if (v21)
        {
          ...
          while (1)
          {
            ...
            {
              uint64_t v18 = 0;
              NSUInteger v19 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v31 count:16];
              if (!v19) {
                goto LABEL_15;
              }
            }
          ...
          id v12 = [v11 initWithDomain:location code:70 userInfo:0];
          id *v27 = v12;
          int64_t v30 = 0;
          int v25 = 1;
        }
...
LABEL_15:
        ...
        if (!v25)
        {
          if (espresso_plan_build())
          {
            ...
            id v14 = [v13 initWithDomain:location code:71 userInfo:0];
            id *v27 = v14;
            int64_t v30 = 0;
          }
          else
    ...
    else
    {
      ...
      id v7 = [v6 initWithDomain:location code:69 userInfo:0];
      id *v27 = v7;
      int64_t v30 = 0;
      int v25 = 1;
    }
  ...
  else
  {
    ...
    id v5 = [v4 initWithDomain:location code:68 userInfo:0];
    id *v27 = v5;
    int64_t v30 = 0;
    int v25 = 1;
  }
...
- (int64_t)_bindBuffers:(id *)a3 errorDomain:(id)a4
{
  ...
  NSUInteger v37 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v59 count:16];
  if (v37)
  {
    ...
    while (1)
    {
      ...
      if (v4)
      {
        ...
        id v6 = [v5 initWithDomain:location code:72 userInfo:0];
        *objc_super v53 = v6;
        int64_t v56 = 0;
        int v47 = 1;
      }
      ...
      {
        uint64_t v34 = 0;
        NSUInteger v35 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v59 count:16];
        if (!v35) {
          goto LABEL_11;
        }
      }
...
LABEL_11:
  ...
  if (!v47)
  {
    ...
    NSUInteger v31 = [(NSDictionary *)v30 countByEnumeratingWithState:v45 objects:v58 count:16];
    if (v31)
    {
      ...
      while (1)
      {
        ...
        if (v7)
        {
          ...
          id v9 = [v8 initWithDomain:location code:73 userInfo:0];
          *objc_super v53 = v9;
          int64_t v56 = 0;
          int v47 = 1;
        }
        ...
        {
          uint64_t v28 = 0;
          NSUInteger v29 = [(NSDictionary *)v30 countByEnumeratingWithState:v45 objects:v58 count:16];
          if (!v29) {
            goto LABEL_23;
          }
        }
...
LABEL_23:
    ...
    if (!v47)
    {
      ...
      {
        id v11 = objc_alloc((Class)NSError);
        id v12 = [v11 initWithDomain:location code:75 userInfo:0];
        *objc_super v53 = v12;
        int64_t v56 = 0;
        int v47 = 1;
        goto LABEL_45;
      ...
      if (v13)
      {
        ...
        id v15 = [v14 initWithDomain:location code:76 userInfo:0];
        *objc_super v53 = v15;
        int64_t v56 = 0;
        int v47 = 1;
        goto LABEL_45;
      ...
      *(_DWORD *)v55->_bufLR.data = v16;
      ...
      NSUInteger v25 = [(NSDictionary *)v24 countByEnumeratingWithState:v39 objects:v57 count:16];
      if (v25)
      {
...
LABEL_38:
          ...
          id v18 = [v17 initWithDomain:location code:74 userInfo:0];
          *objc_super v53 = v18;
          int64_t v56 = 0;
          int v47 = 1;
LABEL_39:
          ...
          {
            uint64_t v22 = 0;
            NSUInteger v23 = [(NSDictionary *)v24 countByEnumeratingWithState:v39 objects:v57 count:16];
            if (!v23) {
              break;
            }
          }
...
- (id)_flattenedWeightsBeforeTraining
{
  id v15 = self;
  v14[1] = (id)a2;
  v14[0] = objc_alloc_init((Class)NSMutableData);
  memset(__b, 0, sizeof(__b));
...
- (id)trainOnData:(id)a3 numLocalIterations:(int64_t)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  if (v6)
  {
    ...
    id v8 = [v7 initWithDomain:v71 code:75 userInfo:0];
    id *v72 = v8;
    id v76 = 0;
    int v69 = 1;
  }
  else
  {
    ...
    id v67 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:");
    id v66 = [objc_alloc((Class)NSMutableDictionary) initWithCapacity:0];
    for (int64_t i = 0; i < v73; ++i)
    {
      id v64 = [location[0] bindDataToInputsDirectly:v75->_inputNameBufferMap batchSize:v75->_batchSize error:v72 errorDomain:v71];
      if (v64)
      {
        uint64_t v63 = 0;
        ...
        if (v9)
        {
          ...
          id v11 = [v10 initWithDomain:v71 code:79 userInfo:0];
          id *v72 = v11;
          id v76 = 0;
          int v69 = 1;
        }
        else
        {
          ...
          float v61 = **v33;
          id v34 = v67;
          NSUInteger v35 = +[NSNumber numberWithFloat:COERCE_DOUBLE((unint64_t)LODWORD(v61))];
          objc_msgSend(v34, "addObject:");

          NSLog(@"Loss: %.4f", v61);
          memset(__b, 0, sizeof(__b));
          id v36 = v75->_metricNames;
          id v37 = [(NSArray *)v36 countByEnumeratingWithState:__b objects:v86 count:16];
          if (v37)
          {
            ...
            while (1)
            {
              ...
              int v57 = 0;
              int v57 = **v27;
              id v56 = [v66 valueForKey:v60];
              if (!v56)
              {
                id v13 = [objc_alloc((Class)NSMutableArray) initWithCapacity:0];
                id v14 = v56;
                id v56 = v13;
              ...
              id v24 = v56;
              LODWORD(v12) = v57;
              NSUInteger v25 = +[NSNumber numberWithFloat:v12];
              ...
              {
                uint64_t v30 = 0;
                id v31 = [(NSArray *)v36 countByEnumeratingWithState:__b objects:v86 count:16];
                if (!v31) {
                  break;
                }
              }
          ...
          if (!i && (id)[(NSNumber *)v75->_initializeManually longValue] == (id)1) {
    ...
    id v23 = [(NSArray *)v22 countByEnumeratingWithState:v53 objects:v85 count:16];
    if (v23)
    {
      ...
      while (1)
      {
        ...
        {
          uint64_t v20 = 0;
          id v21 = [(NSArray *)v22 countByEnumeratingWithState:v53 objects:v85 count:16];
          if (!v21) {
            break;
          }
        }
    ...
    {
      v43[0] = +[NSMutableDictionary dictionary];
...
- (int64_t)initializeManually:(id *)a3 errorDomain:(id)a4
{
  ...
  if (v112->_attachmentProcessor)
  {
    ...
    if (v107)
    {
      ...
      id v65 = [(NSArray *)obj countByEnumeratingWithState:__b objects:v124 count:16];
      if (v65)
      {
        ...
        while (1)
        {
          ...
          if (v59)
          {
            ...
            {
              id v58 = [v103 longValue];
              id v10 = [v102 longValue];
              v106 += (void)v58 * (void)v10;
              ...
              if (v99)
              {
                ...
                {
                  id v13 = objc_alloc((Class)NSError);
                  id v14 = [v13 initWithDomain:location code:119 userInfo:0];
                  id *v110 = v14;
                  int64_t v113 = 0;
                  int v108 = 1;
                }
              ...
              {
                id v11 = objc_alloc((Class)NSError);
                id v12 = [v11 initWithDomain:location code:118 userInfo:0];
                id *v110 = v12;
                int64_t v113 = 0;
                int v108 = 1;
              }
            ...
            {
              id v8 = objc_alloc((Class)NSError);
              id v9 = [v8 initWithDomain:location code:117 userInfo:0];
              id *v110 = v9;
              int64_t v113 = 0;
              int v108 = 1;
            }
          ...
          {
            uint64_t v62 = 0;
            id v63 = [(NSArray *)obj countByEnumeratingWithState:__b objects:v124 count:16];
            if (!v63) {
              break;
            }
          }
...
LABEL_27:
      ...
      if (!v108)
      {
        unint64_t v15 = (unint64_t)[v107 length];
        if (v15 / 4 == v106)
        {
          uint64_t v95 = 0;
          memset(v93, 0, sizeof(v93));
          int v55 = v112->_weightNames;
          id v56 = [(NSArray *)v55 countByEnumeratingWithState:v93 objects:v123 count:16];
          if (v56)
          {
            ...
            while (1)
            {
              ...
              if (v50)
              {
                ...
                if (v92 && v91 && v90 && v89)
                {
                  ...
                  if (v88)
                  {
                    ...
                    id v48 = v88;
                    id v49 = [v48 countByEnumeratingWithState:v85 objects:v122 count:16];
                    if (v49)
                    {
                      ...
                      while (1)
                      {
                        ...
                        {
                          uint64_t v46 = 0;
                          id v47 = [v48 countByEnumeratingWithState:v85 objects:v122 count:16];
                          if (!v47) {
                            break;
                          }
                        }
                    ...
                    else
                    {
                      ...
                      id v25 = [v24 initWithDomain:location code:121 userInfo:0];
                      id *v110 = v25;
                      int64_t v113 = 0;
                      int v108 = 1;
                    }
                  ...
                  else
                  {
                    ...
                    id v21 = [v20 initWithDomain:location code:118 userInfo:0];
                    id *v110 = v21;
                    int64_t v113 = 0;
                    int v108 = 1;
                  }
                ...
                else
                {
                  ...
                  id v19 = [v18 initWithDomain:location code:117 userInfo:0];
                  id *v110 = v19;
                  int64_t v113 = 0;
                  int v108 = 1;
                }
              ...
              {
                uint64_t v53 = 0;
                id v54 = [(NSArray *)v55 countByEnumeratingWithState:v93 objects:v123 count:16];
                if (!v54) {
                  break;
                }
              }
...
LABEL_74:
        ...
        else
        {
          ...
          id v17 = [v16 initWithDomain:location code:120 userInfo:0];
          id *v110 = v17;
          int64_t v113 = 0;
          int v108 = 1;
        }
    ...
    {
      id v6 = objc_alloc((Class)NSError);
      id v7 = [v6 initWithDomain:location code:116 userInfo:0];
      id *v110 = v7;
      int64_t v113 = 0;
      int v108 = 1;
    }
  ...
  {
    id v4 = objc_alloc((Class)NSError);
    id v5 = [v4 initWithDomain:location code:116 userInfo:0];
    id *v110 = v5;
    int64_t v113 = 0;
    int v108 = 1;
  }
...
- (id)finishInitializeManually:(id *)a3 errorDomain:(id)a4
{
  ...
  NSUInteger v16 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v27 count:16];
  if (v16)
  {
    ...
    while (1)
    {
      ...
      {
        id v7 = objc_alloc((Class)NSError);
        id v8 = [v7 initWithDomain:location code:74 userInfo:0];
        id *v23 = v8;
        id v26 = 0;
        int v18 = 1;
      }
      ...
      {
        uint64_t v13 = 0;
        NSUInteger v14 = [(NSDictionary *)obj countByEnumeratingWithState:__b objects:v27 count:16];
        if (!v14) {
          goto LABEL_13;
        }
      }
    ...
    id v5 = objc_alloc((Class)NSError);
    id v6 = [v5 initWithDomain:location code:74 userInfo:0];
    id *v23 = v6;
    id v26 = 0;
    int v18 = 1;
  }
...
LABEL_14:
  ...
  if (!v18)
  {
    id v26 = +[NSNumber numberWithLong:1];
    int v18 = 1;
  }
  objc_storeStrong(&location, 0);
  id v9 = v26;
...
- (id)getNewDeltasContainer:(id)a3 withError:(id *)a4 errorDomain:(id)a5
{
  ...
  uint64_t v52 = 0;
  memset(__b, 0, sizeof(__b));
  id v28 = v57->_weightNames;
  id v29 = [(NSArray *)v28 countByEnumeratingWithState:__b objects:v67 count:16];
  if (v29)
  {
    ...
    while (1)
    {
      ...
      if (v21)
      {
        ...
        if (v49 && v48 && v47 && v46)
        {
          ...
          if (v44)
          {
            ...
            {
              uint64_t v20 = i;
              if (v20 >= (uint64_t)[v48 longValue]) {
                break;
              }
              id v18 = v44;
              uint64_t v19 = +[NSNumber numberWithLong:i];
              id v42 = objc_msgSend(v18, "objectForKey:");
              ...
              if (v42)
              {
                ...
                {
                  uint64_t v17 = j;
                  if (v17 >= (uint64_t)[v49 longValue]) {
                    break;
                  }
                  uint64_t v40 = 0;
                  uint64_t v15 = v52;
                  id v16 = [v42 longValue];
                  id v9 = [v49 longValue];
                  uint64_t v40 = v15 + 4 * (void)v16 * (void)v9 + 4 * j;
                  int v39 = 0;
                  uint64_t v64 = v40;
                  uint64_t v63 = 4;
                  uint64_t v65 = v40;
            ...
            id v13 = [v49 longValue];
            id v10 = [v47 longValue];
            v52 += 4 * (void)v13 * (void)v10;
            int v45 = 0;
          }
          else
          {
            id v7 = objc_alloc((Class)NSError);
            id v8 = [v7 initWithDomain:v54 code:124 userInfo:0];
            id *v55 = v8;
            id v58 = 0;
            int v45 = 1;
          }
        ...
        {
          id v5 = objc_alloc((Class)NSError);
          id v6 = [v5 initWithDomain:v54 code:123 userInfo:0];
          id *v55 = v6;
          id v58 = 0;
          int v45 = 1;
        }
      ...
      {
        uint64_t v24 = 0;
        id v25 = [(NSArray *)v28 countByEnumeratingWithState:__b objects:v67 count:16];
        if (!v25) {
          break;
        }
      }
