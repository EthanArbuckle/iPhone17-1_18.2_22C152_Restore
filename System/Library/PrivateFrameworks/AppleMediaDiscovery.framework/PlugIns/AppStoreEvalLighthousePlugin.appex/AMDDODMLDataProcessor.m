...
LABEL_30:
      ...
      if (([v86 isEqual:NAKey] & 1) == 0)
      {
        ...
        {
          [v104 addObject:&off_10002DED0];
        }
        else if ([v86 isEqual:orKey])
        {
          [v104 addObject:&off_10002DEE8];
        }
        [v105 addObject:v86];
        [v106 addObject:&off_10002DEE8];
        goto LABEL_67;
      }
      ...
      if ([v82 isEqual:HasLengthEqualTo])
      {
        ...
        if (v49 == (id)(int)[v81 intValue]) {
          objc_storeStrong(&v80, &off_10002DED0);
        }
        else {
          objc_storeStrong(&v80, &off_10002DEE8);
        }
LABEL_50:
        if ([v104 count])
        {
...
LABEL_15:
    if (v34
      ...
      && v31
      && v30
      && (([v31 isEqual:&off_10002DEE8] & 1) != 0
       || ([v31 isEqual:&off_10002DED0] & 1) != 0))
    {
...
LABEL_31:
    if (v112 && v111)
    {
      ...
      if (v103)
      {
        ...
        id v95 = [v98 sortedArrayUsingComparator:&__block_literal_global];
...
- (id)strideCopyArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v23) {
    objc_storeStrong(&v23, &off_10002DEE8);
  }
  if (v25 && v24 && v26 && v27)
  {
...
- (id)strideCopyAndSplitArray:(id)a3 error:(id *)a4 errorDomain:(id)a5
{
  ...
  if (!v60) {
    objc_storeStrong(&v60, &off_10002DEE8);
  }
