...
- (id)callAMDClient:(id)a3 error:(id *)a4
{
  ...
  id v25 = objc_alloc_init(AMDClient);

  objc_super v4 = [AMDClientRequestEvent alloc];
  id v24 = [(AMDClientRequestEvent *)v4 initWithFeatureName:v28 withAccountDSID:0 andAccountStoreFrontId:0 inDomain:v27 withCustomDescriptor:0 andSchemaVersion:v26];
  id v23 = 0;
  for (int i = 0; i < 3; ++i)
  {
    ...
    if (v23)
    {
      id v21 = (id)[v23 objectForKey:@"status"];
      char v20 = 1;
      char v15 = [v21 isEqual:@"OK"];
    }
    if (v20) {
  ...
  if (v23)
  {
    id v18 = (id)[v23 objectForKey:@"status"];
    if ([v18 isEqual:@"OK"])
    {
      id v17 = (id)[v23 objectForKey:@"data"];
      if (v17)
      {
        id v31 = v17;
      }
