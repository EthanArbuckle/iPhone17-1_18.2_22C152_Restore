...
- (NSString)language;
- (NSString)version;
- (OPTTSTextToSpeechResource)initWithFlatbuffData:(id)a3;
- (OPTTSTextToSpeechResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResource *)a4;
...
- (Offset<siri::speech::schema_fb::TextToSpeechResource>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(OPTTSTextToSpeechResource *)self language];
  char v6 = v5;
  if (!v5) {
  ...
  uint64_t v10 = [(OPTTSTextToSpeechResource *)self version];
  uint64_t v11 = v10;
  if (!v10) {
...
- (OPTTSTextToSpeechResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResource *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)OPTTSTextToSpeechResource;
  uint64_t v10 = [(OPTTSTextToSpeechResource *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (OPTTSTextToSpeechResource)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResource *)a4
{
  return [(OPTTSTextToSpeechResource *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechResource *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (OPTTSTextToSpeechResource)initWithFlatbuffData:(id)a3
{
  return [(OPTTSTextToSpeechResource *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)vs_voiceResource
{
  v11[1] = *MEMORY[0x263EF8340];
  id v3 = objc_alloc_init(MEMORY[0x263F84ED0]);
  uint64_t v4 = [(OPTTSTextToSpeechResource *)self language];
  ...
  size_t v8 = [(OPTTSTextToSpeechResource *)self version];
