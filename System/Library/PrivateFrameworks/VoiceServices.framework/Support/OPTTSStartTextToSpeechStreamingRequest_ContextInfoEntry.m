...
- (OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry;
  uint64_t v10 = [(OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
