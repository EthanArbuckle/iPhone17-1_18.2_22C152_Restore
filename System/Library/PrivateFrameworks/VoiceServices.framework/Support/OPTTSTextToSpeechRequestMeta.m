...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestMeta>)addObjectToBuffer:(void *)a3
{
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  flatbuffers::FlatBufferBuilder::AddOffset<flatbuffers::String>((flatbuffers::FlatBufferBuilder *)a3, 6, v8);
  return (Offset<siri::speech::schema_fb::TextToSpeechRequestMeta>)flatbuffers::FlatBufferBuilder::EndTable((flatbuffers::FlatBufferBuilder *)a3, v10);
}
...
- (OPTTSTextToSpeechRequestMeta)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestMeta *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)OPTTSTextToSpeechRequestMeta;
  int v10 = [(OPTTSTextToSpeechRequestMeta *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
