...
- (Offset<siri::speech::schema_fb::StartTextToSpeechStreamingRequest>)addObjectToBuffer:(void *)a3
{
  ...
  unsigned int v81 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v10, v11);
  ...
  unsigned int v80 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v14, v15);
  ...
  unsigned int v77 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v18, v19);
  ...
  unsigned int v76 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v22, v23);
  ...
  unsigned int v75 = flatbuffers::FlatBufferBuilder::CreateString((flatbuffers::FlatBufferBuilder *)a3, v26, v27);

  int v74 = [(OPTTSStartTextToSpeechStreamingRequest *)self audio_type];
  HIDWORD(v73) = [(OPTTSStartTextToSpeechStreamingRequest *)self enable_word_timing_info];
  ...
  uint64_t v39 = [v38 countByEnumeratingWithState:&v84 objects:v88 count:16];
  v78 = self;
  if (v39)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v39; ++i)
      {
        ...
        int v43 = objc_msgSend(*(id *)(*((void *)&v84 + 1) + 8 * i), "addObjectToBuffer:", v34, v73);
        int v44 = v43;
        if (v41 >= v37)
        {
          ...
          if (v47) {
            unint64_t v47 = (unint64_t)std::__allocate_at_least[abi:ne180100]<std::allocator<flatbuffers::Offset<siri::speech::schema_fb::TextToSpeechRequest_::ContextInfoEntry>>>(v47);
          }
          else {
            uint64_t v48 = 0;
          }
  ...
  unsigned int v58 = flatbuffers::FlatBufferBuilder::EndVector((flatbuffers::FlatBufferBuilder *)a3, v54);
  int v59 = [(OPTTSStartTextToSpeechStreamingRequest *)v78 preferred_voice_type];
  v60 = [(OPTTSStartTextToSpeechStreamingRequest *)v78 meta_info];
  unsigned int v61 = [v60 addObjectToBuffer:a3];

  v62 = [(OPTTSStartTextToSpeechStreamingRequest *)v78 context];
  unsigned int v63 = [v62 addObjectToBuffer:a3];

  v64 = [(OPTTSStartTextToSpeechStreamingRequest *)v78 experiment];
  unsigned int v65 = [v64 addObjectToBuffer:a3];

  v66 = [(OPTTSStartTextToSpeechStreamingRequest *)v78 feature_flags];
  unsigned int v79 = [v66 addObjectToBuffer:a3];

  flatbuffers::FlatBufferBuilder::NotNested((uint64_t)a3);
  *((unsigned char *)a3 + 70) = 1;
  int v67 = *((_DWORD *)a3 + 8);
  int v68 = *((_DWORD *)a3 + 12);
  int v69 = *((_DWORD *)a3 + 10);
  ...
  if (v58)
  {
    int v70 = flatbuffers::FlatBufferBuilder::ReferTo((flatbuffers::FlatBufferBuilder *)a3, v58);
    ...
    if (*(unsigned __int16 *)v5->var0 >= 0x17u)
    {
      ...
      if (v6)
      {
        ...
        if (v9)
        {
          ...
          do
          {
            __int16 v12 = [[OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry alloc] initWithFlatbuffData:self->_data root:&v10[*(unsigned int *)v10->var0] verify:0];
            [v3 addObject:v12];
...
- (OPTTSStartTextToSpeechStreamingRequest)initWithFlatbuffData:(id)a3 root:(const StartTextToSpeechStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(OPTTSStartTextToSpeechStreamingRequest *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
