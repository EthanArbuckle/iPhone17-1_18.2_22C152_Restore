...
- (Offset<siri::speech::schema_fb::BeginTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  int v26 = [(OPTTSBeginTextToSpeechStreamingResponse *)self audio_type];
  v27 = [(OPTTSBeginTextToSpeechStreamingResponse *)self decoder_description];
  unsigned int v28 = [v27 addObjectToBuffer:a3];

  v29 = [(OPTTSBeginTextToSpeechStreamingResponse *)self playback_description];
  LODWORD(v23) = [v29 addObjectToBuffer:a3];

  v30 = [(OPTTSBeginTextToSpeechStreamingResponse *)self meta_info];
...
- (OPTTSBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  uint64_t v10 = [(OPTTSBeginTextToSpeechStreamingResponse *)&v30 init];
  uint64_t v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
