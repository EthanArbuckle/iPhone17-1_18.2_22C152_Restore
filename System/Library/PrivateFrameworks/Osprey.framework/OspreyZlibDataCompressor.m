...
- (OspreyZlibDataCompressor)init
{
  return [(OspreyZlibDataCompressor *)self initWithOptions:15];
}
...
- (OspreyZlibDataCompressor)initWithOptions:(int64_t)a3
{
  ...
  if (!v4
    || (v4->_deflateStream.zalloc = 0,
        ...
        int v6 = deflateInit2_(&v4->_deflateStream, 9, 8, v3, 8, 0, "1.2.12", 112),
        v7 = 0,
        !v6))
  {
    v7 = v5;
...
- (id)compressedDataForData:(id)a3 error:(id *)a4
{
  ...
  if (v6 && dispatch_data_get_size(v6))
  {
    ...
    if (*((_DWORD *)v16 + 6) >= 2u)
    {
      ...
      if (a4)
      {
        *a4 = [MEMORY[0x1E4F28C58] errorWithDomain:@"OspreyCompressionErrorDomain" code:*((int *)v16 + 6) userInfo:0];
      }
    }
    id v11 = (id)v20[5];
...
uint64_t __56__OspreyZlibDataCompressor_compressedDataForData_error___block_invoke(void *a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  ...
  *(_DWORD *)(a1[4] + 16) = a5;
  ...
  while (1)
  {
    ...
    *(_DWORD *)(*(void *)(a1[5] + 8) + 24) = deflate((z_streamp)(a1[4] + 8), 4);
