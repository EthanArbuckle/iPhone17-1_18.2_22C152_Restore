...
+ (id)successWithResolvedIntentRelativeTemperatureChange:(int64_t)a3
{
  ...
  id v4 = static IntentRelativeTemperatureChangeResolutionResult.success(with:)(a3);
...
{
  swift_getObjCClassMetadata();
  id v4 = static IntentRelativeTemperatureChangeResolutionResult.confirmationRequired(with:)(a3);
