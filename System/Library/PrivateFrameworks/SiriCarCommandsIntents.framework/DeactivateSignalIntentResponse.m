...
- (int64_t)code
{
  v2 = (int64_t *)((char *)self + OBJC_IVAR___DeactivateSignalIntentResponse_code);
  swift_beginAccess();
  return *v2;
}
...
- (void)setCode:(int64_t)a3
{
  v4 = (int64_t *)((char *)self + OBJC_IVAR___DeactivateSignalIntentResponse_code);
  swift_beginAccess();
  int64_t *v4 = a3;
}
...
- (DeactivateSignalIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  v8 = (int64_t *)((char *)v7 + OBJC_IVAR___DeactivateSignalIntentResponse_code);
  swift_beginAccess();
  int64_t *v8 = a3;
  v9 = v7;
...
- (DeactivateSignalIntentResponse)init
{
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___DeactivateSignalIntentResponse_code) = 0;
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for DeactivateSignalIntentResponse();
...
- (DeactivateSignalIntentResponse)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR___DeactivateSignalIntentResponse_code) = 0;
  ...
  return [(DeactivateSignalIntentResponse *)&v5 initWithCoder:a3];
}
