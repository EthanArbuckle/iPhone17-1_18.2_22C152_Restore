...
LABEL_29:
      _os_log_impl(&dword_228A19000, v4, OS_LOG_TYPE_DEFAULT, v5, (uint8_t *)&v12, 0xCu);
      goto LABEL_30;
    }
    goto LABEL_30;
  }
  if ([v3 navigationStackIsPopping]
    && (([v3 deviceIsPad] & 1) != 0 || objc_msgSend(v3, "navigationBarHasContent")))
  {
    v4 = *MEMORY[0x263F28348];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F28348], OS_LOG_TYPE_DEFAULT))
    {
...
LABEL_30:
  ...
  if ([v3 navigationStackSize] < 2)
  {
    ...
    int v9 = [v3 contextMenuIsPresented];
    v4 = *MEMORY[0x263F28348];
    ...
    if (v10)
    {
      int v12 = 136315138;
      v13 = "-[SRCompactViewControllerContentTester hasContentForState:]";
      _os_log_impl(&dword_228A19000, v4, OS_LOG_TYPE_DEFAULT, "%s #compact:Returning NO because point is outside Siri content", (uint8_t *)&v12, 0xCu);
    }
    char v8 = 0;
  }
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F28348], OS_LOG_TYPE_DEFAULT))
    {
      ...
      v13 = "-[SRCompactViewControllerContentTester hasContentForState:]";
      __int16 v14 = 1024;
      int v15 = [v3 multiLevelViewHasContent];
      _os_log_impl(&dword_228A19000, v7, OS_LOG_TYPE_DEFAULT, "%s #compact:Returning %d because pointis in multi level card", (uint8_t *)&v12, 0x12u);
    }
    char v8 = [v3 multiLevelViewHasContent];
  }
LABEL_31:
