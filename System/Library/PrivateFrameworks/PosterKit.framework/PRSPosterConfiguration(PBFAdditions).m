...
- (id)pr_loadConfiguredPropertiesWithError:()PBFAdditions
{
  v5 = objc_msgSend(a1, "pui_modelObjectCache");
...
- (id)pr_loadHomeScreenConfigurationWithError:()PBFAdditions
{
  v4 = objc_msgSend(a1, "pui_modelObjectCache");
...
- (id)pr_loadColorVariationsWithError:()PBFAdditions
{
  ...
  {
    v9 = [a1 _path];
    id v8 = +[PRPosterPathUtilities loadColorVariationsConfigurationForPath:v9 error:a3];
  }
  return v8;
}
...
- (BOOL)pr_storeAmbientWidgetLayout:()PBFAdditions error:
{
  ...
  {
    v10 = [a1 _path];
    BOOL v11 = +[PRPosterPathUtilities storeAmbientWidgetLayoutToPath:v10 posterAmbientWidgetLayout:v7 error:a4];
  }
  else
  {
    v10 = [a1 _path];
    BOOL v11 = +[PRPosterPathUtilities removeAmbientWidgetLayout:v10 error:a4];
  }
  BOOL v12 = v11;
...
{
  id v9 = 0;
  v3 = objc_msgSend(a1, "pr_loadHomeScreenConfigurationWithError:", &v9);
  id v4 = v9;
  if (v4)
  {
    v5 = PRLogCommon();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      -[PRSPosterConfiguration(PBFAdditions) pr_suggestedTintColor](a2);
    }
  }
  id v6 = [v3 customizationConfiguration];
...
- (void)pr_suggestedTintColor
{
  ...
  OUTLINED_FUNCTION_0_1(&dword_18C1C4000, v2, v3, "%{public}@ error fetching home screen configuration: %{public}@", v4, v5, v6, v7, v8);
}
