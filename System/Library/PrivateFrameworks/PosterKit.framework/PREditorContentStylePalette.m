...
+ (id)_standardPaletteColors
{
  ...
  v16 = [MEMORY[0x1E4FB1618] colorNamed:@"lightBlue" inBundle:v2 compatibleWithTraitCollection:0];
  v17[0] = v16;
  v15 = [MEMORY[0x1E4FB1618] colorNamed:@"darkBlue" inBundle:v2 compatibleWithTraitCollection:0];
  v17[1] = v15;
  v14 = [MEMORY[0x1E4FB1618] colorNamed:@"plum" inBundle:v2 compatibleWithTraitCollection:0];
  v17[2] = v14;
  v13 = [MEMORY[0x1E4FB1618] colorNamed:@"magenta" inBundle:v2 compatibleWithTraitCollection:0];
  v17[3] = v13;
  ...
  v17[11] = v10;
  v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:v17 count:12];
...
+ (id)_condensedPaletteColors
{
  ...
  v2 = [MEMORY[0x1E4F28B50] bundleForClass:objc_opt_class()];
  v13 = [MEMORY[0x1E4FB1618] colorNamed:@"lightBlue" inBundle:v2 compatibleWithTraitCollection:0];
  v14[0] = v13;
  ...
  v10 = [MEMORY[0x1E4FB1618] colorNamed:@"green" inBundle:v2 compatibleWithTraitCollection:0];
  v14[8] = v10;
  v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:v14 count:9];
...
+ (id)_incomingCallRainbowTextStyle
{
  ...
  v2 = [MEMORY[0x1E4FB1618] colorWithRed:0.250980392 green:0.878431373 blue:0.815686275 alpha:1.0];
  v3 = objc_msgSend(MEMORY[0x1E4FB1618], "colorWithRed:green:blue:alpha:", 0.250980392, 0.878431373, 0.815686275, 1.0, v2);
  v12[1] = v3;
  v4 = [MEMORY[0x1E4FB1618] colorWithRed:0.564705882 green:0.835294118 blue:0.294117647 alpha:1.0];
  v12[2] = v4;
  v5 = [MEMORY[0x1E4FB1618] colorWithRed:1.0 green:0.8 blue:0.0 alpha:1.0];
  v12[3] = v5;
  v6 = [MEMORY[0x1E4FB1618] colorWithRed:1.0 green:0.68627451 blue:0.0 alpha:1.0];
  v12[4] = v6;
  v7 = [MEMORY[0x1E4FB1618] colorWithRed:1.0 green:0.470588235 blue:0.156862745 alpha:1.0];
  v12[5] = v7;
  v8 = [MEMORY[0x1E4FB1618] colorWithRed:1.0 green:0.282352941 blue:0.294117647 alpha:1.0];
  v12[6] = v8;
  v9 = [MEMORY[0x1E4F1C978] arrayWithObjects:v12 count:7];

  v10 = -[PRPosterContentGradientStyle initWithColors:gradientType:locations:startPoint:endPoint:]([PRPosterContentGradientStyle alloc], "initWithColors:gradientType:locations:startPoint:endPoint:", v9, 0, &unk_1ED9EF040, 0.0, 0.5, 1.0, 0.5);
  return v10;
}
...
+ (id)defaultPaletteForContext:(unint64_t)a3 role:(id)a4
{
  ...
  if (a3 == 2)
  {
    ...
    if (_os_feature_enabled_impl()) {
      int v12 = [v6 isEqualToString:@"PRPosterRoleIncomingCall"];
    }
    else {
      int v12 = 0;
    }
    ...
    if (v16) {
      int v16 = [v6 isEqualToString:@"PRPosterRoleLockScreen"];
    }
    if ((v12 | v16) == 1)
    {
    ...
    v14 = objc_msgSend(v8, "bs_map:", &__block_literal_global_28);
  ...
  v19 = (void *)[objc_alloc((Class)a1) initWithContentStyles:v15 context:a3 role:v6 localizedName:0 defaultPalette:1];
  return v19;
}
...
PRPosterContentDiscreteColorsStyle *__61__PREditorContentStylePalette_defaultPaletteForContext_role___block_invoke(uint64_t a1, void *a2)
{
  ...
  v5 = [(PRPosterContentDiscreteColorsStyle *)v3 initWithVibrantColors:v4 variation:0.0];
  return v5;
}
...
- (PREditorContentStylePalette)initWithContentStyles:(id)a3 localizedName:(id)a4
{
  return [(PREditorContentStylePalette *)self initWithContentStyles:a3 context:0 role:0 localizedName:a4 defaultPalette:0];
}
...
- (PREditorContentStylePalette)initWithContentStyles:(id)a3 context:(unint64_t)a4 role:(id)a5 localizedName:(id)a6 defaultPalette:(BOOL)a7
{
  ...
  int v16 = [(PREditorContentStylePalette *)&v20 init];
  if (v16)
  {
  ...
  else
  {
    ...
    if (isKindOfClass)
    {
      ...
      if (v10)
      {
        ...
        int v12 = [(PREditorContentStylePalette *)v7 styles];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  int v10 = [(PREditorContentStylePalette *)self styles];
  ...
  id v12 = [(PREditorContentStylePalette *)self localizedName];
  [v4 encodeObject:v12 forKey:@"localizedName"];

  char v13 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[PREditorContentStylePalette context](self, "context"));
...
- (PREditorContentStylePalette)initWithCoder:(id)a3
{
  ...
  else
  {
    ...
    int v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v16 count:6];
...
- (void)encodeWithBSXPCCoder:(id)a3
{
  ...
  objc_super v20 = [(PREditorContentStylePalette *)self localizedName];
  [v4 encodeObject:v20 forKey:@"localizedName"];

  v21 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[PREditorContentStylePalette context](self, "context"));
...
- (PREditorContentStylePalette)initWithBSXPCCoder:(id)a3
{
  ...
  else
  {
    ...
    v31 = [MEMORY[0x1E4F1C978] arrayWithObjects:v37 count:5];
    if (v12)
    {
      uint64_t v13 = v12;
      ...
      {
        unint64_t v15 = v7;
        long long v16 = objc_msgSend(*(id *)(v7 + 24), "stringWithFormat:", @"style%ld", i);
        long long v32 = 0u;
        long long v33 = 0u;
        long long v34 = 0u;
        long long v35 = 0u;
...
LABEL_15:
    ...
    uint64_t v9 = v28;
    self = [(PREditorContentStylePalette *)v29 initWithContentStyles:v26 context:0 role:v28 localizedName:v25 defaultPalette:0];
...
{
  id v4 = a3;
  unint64_t v5 = [(PREditorContentStylePalette *)self context];
  if (v5 > 2) {
    uint64_t v6 = 0;
  }
  else {
    uint64_t v6 = off_1E54DC0A0[v5];
  }
  [v4 appendString:v6 withName:@"context"];
  unint64_t v7 = [(PREditorContentStylePalette *)self role];
  [v4 appendString:v7 withName:@"role"];

  uint64_t v8 = [(PREditorContentStylePalette *)self styles];
  id v9 = (id)[v4 appendObject:v8 withName:@"styles"];

  id v10 = [(PREditorContentStylePalette *)self localizedName];
