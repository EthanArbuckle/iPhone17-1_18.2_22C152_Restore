...
- (PRFontWeightSlider)init
{
  ...
  v2 = [(PRFontWeightSlider *)&v17 init];
  if (v2)
  {
    v3 = [MEMORY[0x1E4FB1618] clearColor];
    [(PRFontWeightSlider *)v2 setMinimumTrackTintColor:v3];

    v4 = [MEMORY[0x1E4FB1618] clearColor];
    [(PRFontWeightSlider *)v2 setMaximumTrackTintColor:v4];

    uint64_t v5 = [objc_alloc(MEMORY[0x1E4FB1618]) initWithDynamicProvider:&__block_literal_global_40];
    contentBackgroundColor = v2->_contentBackgroundColor;
    v2->_contentBackgroundColor = (UIColor *)v5;

    v7 = [[_PRFontWeightSliderTrackView alloc] initWithTrackBackgroundColor:v2->_contentBackgroundColor];
    trackView = v2->_trackView;
    v2->_trackView = v7;

    [(PRFontWeightSlider *)v2 addSubview:v2->_trackView];
    [(PRFontWeightSlider *)v2 sendSubviewToBack:v2->_trackView];
    ...
    uint64_t v11 = [(PRFontWeightSlider *)v2 registerForTraitChanges:v10 withHandler:v14];
...
id __26__PRFontWeightSlider_init__block_invoke(uint64_t a1, void *a2)
{
  ...
  v4 = [MEMORY[0x1E4FB1E20] traitCollectionWithUserInterfaceStyle:v2];
...
- (void)dealloc
{
  [(PRFontWeightSlider *)self unregisterForTraitChanges:self->_userInterfaceStyleTraitChangeRegistration];
  v3.receiver = self;
  v3.super_class = (Class)PRFontWeightSlider;
  [(PRFontWeightSlider *)&v3 dealloc];
}
...
- (void)layoutSubviews
{
  ...
  [(PRFontWeightSlider *)&v49 layoutSubviews];
  ...
  [(PRFontWeightSlider *)self bounds];
...
- (id)_createCustomThumbView
{
  ...
  if (!thumbView)
  {
    ...
    double v11 = [MEMORY[0x1E4F39BE8] layer];
    ...
    CGFloat v15 = [MEMORY[0x1E4F39BE8] layer];
    thumbContentLayer = self->_thumbContentLayer;
    ...
    CGFloat v25 = (CAShapeLayer *)objc_alloc_init(MEMORY[0x1E4F39C88]);
    thumbClippingLayer = self->_thumbClippingLayer;
