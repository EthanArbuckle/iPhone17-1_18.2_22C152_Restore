...
- (_PRContentStyleGradientView)initWithFrame:(CGRect)a3
{
  ...
  v13.receiver = self;
  v13.super_class = (Class)_PRContentStyleGradientView;
  v3 = -[_PRContentStyleGradientView initWithFrame:](&v13, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
    ...
    [v9 setValue:&unk_1ED9EEE00 forKey:@"inputRadius"];
...
{
  v4.receiver = self;
  v4.super_class = (Class)_PRContentStyleGradientView;
