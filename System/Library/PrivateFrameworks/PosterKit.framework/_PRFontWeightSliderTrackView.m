@interface _PRFontWeightSliderTrackView
- (UIColor)trackBackgroundColor;
- (_PRFontWeightSliderTrackView)initWithTrackBackgroundColor:(id)a3;
- (void)drawRect:(CGRect)a3;
@end

@implementation _PRFontWeightSliderTrackView

- (_PRFontWeightSliderTrackView)initWithTrackBackgroundColor:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)_PRFontWeightSliderTrackView;
  v6 = -[_PRFontWeightSliderTrackView initWithFrame:](&v9, sel_initWithFrame_, *MEMORY[0x1E4F1DB28], *(double *)(MEMORY[0x1E4F1DB28] + 8), *(double *)(MEMORY[0x1E4F1DB28] + 16), *(double *)(MEMORY[0x1E4F1DB28] + 24));
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_trackBackgroundColor, a3);
    [(_PRFontWeightSliderTrackView *)v7 setOpaque:0];
    [(_PRFontWeightSliderTrackView *)v7 setContentMode:3];
  }
...
- (void)drawRect:(CGRect)a3
{
  ...
  v29.receiver = self;
  v29.super_class = (Class)_PRFontWeightSliderTrackView;
  -[_PRFontWeightSliderTrackView drawRect:](&v29, sel_drawRect_);
  v8 = (id *)MEMORY[0x1E4FB2608];
  uint64_t v9 = [(id)*MEMORY[0x1E4FB2608] userInterfaceLayoutDirection];
  CGFloat v10 = x;
  CGFloat v11 = y;
  CGFloat v12 = width;
  CGFloat v13 = height;
  ...
  id v21 = objc_alloc_init(MEMORY[0x1E4FB14C0]);
  ...
  v23 = [(_PRFontWeightSliderTrackView *)self trackBackgroundColor];
  [v23 setFill];
