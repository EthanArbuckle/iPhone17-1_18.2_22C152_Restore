@interface CLPPassCollectionResponse
- (BOOL)hasMsg;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation CLPPassCollectionResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPPassCollectionResponse;
  v4 = [(CLPPassCollectionResponse *)&v8 description];
  v5 = [(CLPPassCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPPassCollectionResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 1)) {
    -[CLPPassCollectionResponse setMsg:](self, "setMsg:");
  }
}
