@interface CLPAppCollectionResponse
- (BOOL)hasMsg;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation CLPAppCollectionResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPAppCollectionResponse;
  v4 = [(CLPAppCollectionResponse *)&v8 description];
  v5 = [(CLPAppCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPAppCollectionResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 1)) {
    -[CLPAppCollectionResponse setMsg:](self, "setMsg:");
  }
}
