...
- (void)addPassLocation:(id)a3
{
  ...
  [(NSMutableArray *)passLocations addObject:v4];
}

- (unint64_t)passLocationsCount
{
  return [(NSMutableArray *)self->_passLocations count];
}

- (id)passLocationAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_passLocations objectAtIndex:a3];
}
...
- (id)description
{
  ...
  id v4 = [(CLPPassCollectionRequest *)&v8 description];
  v5 = [(CLPPassCollectionRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_passLocations count])
  {
    v6 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_passLocations, "count"));
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
    long long v18 = 0u;
    ...
    [v3 setObject:v6 forKey:@"passLocation"];
  }
...
- (void)writeTo:(id)a3
{
  ...
  id v4 = a3;
  if (!self->_meta) {
    -[CLPPassCollectionRequest writeTo:]();
  }
  v5 = v4;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(CLPPassCollectionRequest *)self passLocationsCount])
  {
    [v8 clearPassLocations];
    unint64_t v4 = [(CLPPassCollectionRequest *)self passLocationsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(CLPPassCollectionRequest *)self passLocationAtIndex:i];
        [v8 addPassLocation:v7];
      }
    }
  }
  if (self->_signature) {
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [(NSMutableArray *)self->_passLocations hash] ^ v3;
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        -[CLPPassCollectionRequest addPassLocation:](self, "addPassLocation:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
