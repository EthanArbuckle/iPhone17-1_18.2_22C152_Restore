@interface CLPLOGENTRYVISIONSimdFloatM
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (float)values;
...
- (void)dealloc
{
  ...
  [(CLPLOGENTRYVISIONSimdFloatM *)&v3 dealloc];
}
...
- (id)description
{
  ...
  v4 = [(CLPLOGENTRYVISIONSimdFloatM *)&v8 description];
  v5 = [(CLPLOGENTRYVISIONSimdFloatM *)self dictionaryRepresentation];
...
{
  id v7 = a3;
  if ([(CLPLOGENTRYVISIONSimdFloatM *)self valuesCount])
  {
    [v7 clearValues];
    unint64_t v4 = [(CLPLOGENTRYVISIONSimdFloatM *)self valuesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        [(CLPLOGENTRYVISIONSimdFloatM *)self valuesAtIndex:i];
