...
@implementation CLPLOGENTRYVISIONLSLLocationCoordinate
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPLOGENTRYVISIONLSLLocationCoordinate;
  v4 = [(CLPLOGENTRYVISIONLSLLocationCoordinate *)&v8 description];
  v5 = [(CLPLOGENTRYVISIONLSLLocationCoordinate *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPLOGENTRYVISIONLSLLocationCoordinateReadFrom((uint64_t)self, (uint64_t)a3);
}
