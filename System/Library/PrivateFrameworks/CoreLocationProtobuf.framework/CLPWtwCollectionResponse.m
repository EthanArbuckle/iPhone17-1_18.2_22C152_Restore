@interface CLPWtwCollectionResponse
- (BOOL)hasMsg;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation CLPWtwCollectionResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPWtwCollectionResponse;
  v4 = [(CLPWtwCollectionResponse *)&v8 description];
  v5 = [(CLPWtwCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPWtwCollectionResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 1)) {
    -[CLPWtwCollectionResponse setMsg:](self, "setMsg:");
  }
}
