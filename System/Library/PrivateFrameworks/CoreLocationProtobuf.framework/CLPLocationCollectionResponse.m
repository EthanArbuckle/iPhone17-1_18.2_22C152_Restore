...
@implementation CLPLocationCollectionResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPLocationCollectionResponse;
  v4 = [(CLPLocationCollectionResponse *)&v8 description];
  v5 = [(CLPLocationCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPLocationCollectionResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 1)) {
    -[CLPLocationCollectionResponse setMsg:](self, "setMsg:");
  }
}
