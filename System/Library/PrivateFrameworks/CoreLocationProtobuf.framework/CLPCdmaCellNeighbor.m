...
- (id)description
{
  ...
  v4 = [(CLPCdmaCellNeighbor *)&v8 description];
  v5 = [(CLPCdmaCellNeighbor *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 8) != 0)
  {
    v7 = [NSNumber numberWithInt:self->_pnoffset];
    [v3 setObject:v7 forKey:@"pnoffset"];
...
LABEL_3:
  ...
  objc_super v8 = [NSNumber numberWithInt:self->_pilotPhase];
  [v3 setObject:v8 forKey:@"pilotPhase"];
...
LABEL_12:
  v9 = [NSNumber numberWithInt:self->_ecn0];
  [v3 setObject:v9 forKey:@"ecn0"];
...
LABEL_13:
  v10 = [NSNumber numberWithInt:self->_rscp];
  [v3 setObject:v10 forKey:@"rscp"];

  if (*(unsigned char *)&self->_has)
  {
LABEL_6:
    v5 = [NSNumber numberWithInt:self->_channel];
    [v3 setObject:v5 forKey:@"channel"];
  }
LABEL_7:
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 8) == 0 || self->_pnoffset != *((_DWORD *)v4 + 5)) {
      goto LABEL_26;
    }
  }
...
LABEL_26:
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 4) == 0 || self->_pilotPhase != *((_DWORD *)v4 + 4)) {
      goto LABEL_26;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 2) == 0 || self->_ecn0 != *((_DWORD *)v4 + 3)) {
      goto LABEL_26;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 28) & 0x10) == 0 || self->_rscp != *((_DWORD *)v4 + 6)) {
      goto LABEL_26;
    }
  }
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 28) & 1) == 0 || self->_channel != *((_DWORD *)v4 + 2)) {
      goto LABEL_26;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  if ((*(unsigned char *)&self->_has & 8) != 0)
  {
    uint64_t v2 = 2654435761 * self->_pnoffset;
    if ((*(unsigned char *)&self->_has & 4) != 0)
    {
LABEL_3:
      uint64_t v3 = 2654435761 * self->_pilotPhase;
      if ((*(unsigned char *)&self->_has & 2) != 0) {
        goto LABEL_4;
      }
      goto LABEL_9;
  ...
  {
LABEL_4:
    uint64_t v4 = 2654435761 * self->_ecn0;
    if ((*(unsigned char *)&self->_has & 0x10) != 0) {
      goto LABEL_5;
    }
LABEL_10:
...
LABEL_5:
  uint64_t v5 = 2654435761 * self->_rscp;
  if ((*(unsigned char *)&self->_has & 1) == 0) {
    goto LABEL_11;
  }
LABEL_6:
  uint64_t v6 = 2654435761 * self->_channel;
  return v3 ^ v2 ^ v4 ^ v5 ^ v6;
}
