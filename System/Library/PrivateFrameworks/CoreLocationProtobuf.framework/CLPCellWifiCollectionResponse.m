@interface CLPCellWifiCollectionResponse
- (BOOL)hasMsg;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation CLPCellWifiCollectionResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPCellWifiCollectionResponse;
  v4 = [(CLPCellWifiCollectionResponse *)&v8 description];
  v5 = [(CLPCellWifiCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPCellWifiCollectionResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 1)) {
    -[CLPCellWifiCollectionResponse setMsg:](self, "setMsg:");
  }
}
