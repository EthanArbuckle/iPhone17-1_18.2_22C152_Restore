@interface CLPPoiCollectionResponse
- (BOOL)hasMsg;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation CLPPoiCollectionResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)CLPPoiCollectionResponse;
  v4 = [(CLPPoiCollectionResponse *)&v8 description];
  v5 = [(CLPPoiCollectionResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return CLPPoiCollectionResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)a3 + 1)) {
    -[CLPPoiCollectionResponse setMsg:](self, "setMsg:");
  }
}
