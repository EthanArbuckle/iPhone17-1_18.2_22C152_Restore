...
- (void)setFooterAction:(id)a3
{
  ...
  if ((BSEqualObjects() & 1) == 0)
  {
    ...
    [(UILabel *)footerLabel setText:v7];
  }
}
...
- (void)_setContinuousCornerRadius:(double)a3
{
  ...
  id v10 = [(UIView *)self->_highlightView layer];
...
- (void)_visualStylingProvider:(id)a3 didChangeForCategory:(int64_t)a4 outgoingProvider:(id)a5
{
  ...
  if (a4 == 2)
  {
    ...
    uint64_t v14 = &__block_literal_global_0;
    id v10 = self;
    uint64_t v11 = 1;
    id v12 = v15;
    id v13 = v8;
...
- (void)_updateTextAttributesForFooterLabel
{
  ...
  if (footerLabel)
  {
    id v3 = [(id)objc_opt_class() _preferredFont:1 textStyle:*MEMORY[0x263F835F0] weight:0 additionalTraits:*MEMORY[0x263F81838]];
...
- (void)_configureFooterLabelIfNecessary
{
  if (!self->_footerLabel)
  {
    ...
    [(_FCUIActivityControlMenuFooterView *)self _updateTextAttributesForFooterLabel];
    double v5 = self->_footerLabel;
    double v6 = [(NSMutableDictionary *)self->_categoriesToVisualStylingProviders objectForKey:&unk_26D1C03B0];
...
- (void)_configureHightlightViewIfNecessary
{
  if (!self->_highlightView)
  {
    ...
    double v6 = [(_FCUIActivityControlMenuFooterView *)self layer];
    [v6 setMasksToBounds:1];

    double v7 = self->_highlightView;
    id v8 = [(NSMutableDictionary *)self->_categoriesToVisualStylingProviders objectForKey:&unk_26D1C03C8];
