...
- (_HPSUIBetaEnrollmentViewController)initWithHomeID:(id)a3
{
  ...
  sub_232E5ACB8();
  return (_HPSUIBetaEnrollmentViewController *)BetaEnrollmentViewController.init(withHomeID:)((uint64_t)v5);
}
...
- (_HPSUIBetaEnrollmentViewController)initWithHomeID:(id)a3 homeKitIdentifiers:(id)a4
{
  ...
  return (_HPSUIBetaEnrollmentViewController *)BetaEnrollmentViewController.init(withHomeID:homeKitIdentifiers:)((uint64_t)v6, v7);
}
...
- (void)willMoveToParentViewController:(id)a3
{
  id v5 = a3;
  v6 = self;
  BetaEnrollmentViewController.willMove(toParent:)((UIViewController_optional *)a3);
}
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  id v4 = v9.receiver;
  [(_HPSUIBetaEnrollmentViewController *)&v9 viewWillAppear:v3];
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  id v4 = v8.receiver;
  [(_HPSUIBetaEnrollmentViewController *)&v8 viewWillDisappear:v3];
...
- (_HPSUIBetaEnrollmentViewController)init
{
  result = (_HPSUIBetaEnrollmentViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  v2 = (char *)self + OBJC_IVAR____HPSUIBetaEnrollmentViewController_homeID;
  uint64_t v3 = sub_232E5ACC8();
...
+ (void)shouldShowBetaEnrollmentButtonForHomeID:(id)a3 withCompletion:(id)a4
{
  ...
  *(void *)(v10 + 16) = v9;
  ...
  _s22HomePlatformSettingsUI28BetaEnrollmentViewControllerC010shouldShoweF6Button03forA2ID14withCompletiony10Foundation4UUIDV_ySb_So7NSErrorCSgtYbctFZ_0((uint64_t)v8, (uint64_t (*)(void, void))sub_232E5AA54, v10);
  swift_release();
...
+ (void)shouldShowBetaEnrollmentButtonForHomeID:(id)a3 homeKitIdentifiers:(id)a4 withCompletion:(id)a5
{
  ...
  *(void *)(v11 + 16) = v10;
  swift_getObjCClassMetadata();
  _s22HomePlatformSettingsUI28BetaEnrollmentViewControllerC010shouldShoweF6Button03forA2ID14withCompletiony10Foundation4UUIDV_ySb_So7NSErrorCSgtYbctFZ_0((uint64_t)v9, (uint64_t (*)(void, void))sub_232E5A7A4, v11);
  swift_release();
