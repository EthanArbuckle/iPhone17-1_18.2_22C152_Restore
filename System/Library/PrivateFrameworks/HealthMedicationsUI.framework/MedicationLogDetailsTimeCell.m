@interface MedicationLogDetailsTimeCell
...
- (_TtC19HealthMedicationsUI28MedicationLogDetailsTimeCell)initWithFrame:(CGRect)a3
{
  return (_TtC19HealthMedicationsUI28MedicationLogDetailsTimeCell *)sub_1C2014564(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC19HealthMedicationsUI28MedicationLogDetailsTimeCell)initWithCoder:(id)a3
{
  ...
  *((void *)v4 + 4) = 0;
  ...
  result = (_TtC19HealthMedicationsUI28MedicationLogDetailsTimeCell *)sub_1C214B910();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_1C2015FB4((uint64_t)self + OBJC_IVAR____TtC19HealthMedicationsUI28MedicationLogDetailsTimeCell_item, (unint64_t *)&qword_1EBF0C300, (void (*)(uint64_t))sub_1C1F1CB5C);
}
