...
@implementation WiFiAnalyticsAWDWiFiDPSBTSnapshot
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)WiFiAnalyticsAWDWiFiDPSBTSnapshot;
  v4 = [(WiFiAnalyticsAWDWiFiDPSBTSnapshot *)&v8 description];
  v5 = [(WiFiAnalyticsAWDWiFiDPSBTSnapshot *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return WiFiAnalyticsAWDWiFiDPSBTSnapshotReadFrom((uint64_t)self, (uint64_t)a3);
}
