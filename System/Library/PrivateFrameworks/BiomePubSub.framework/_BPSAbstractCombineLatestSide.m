...
{
  id v4 = a3;
  id v5 = [(_BPSAbstractCombineLatestSide *)self combiner];
...
- (int64_t)receiveInput:(id)a3
{
  id v4 = self;
  id v5 = a3;
  v6 = [(_BPSAbstractCombineLatestSide *)v4 combiner];
  int64_t v7 = objc_msgSend(v6, "receiveInput:atIndex:", v5, -[_BPSAbstractCombineLatestSide index](v4, "index"));
...
- (void)receiveCompletion:(id)a3
{
  v6 = self;
  id v4 = a3;
  id v5 = [(_BPSAbstractCombineLatestSide *)v6 combiner];
