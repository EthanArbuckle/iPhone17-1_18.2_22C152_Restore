...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  [(CRDictionary *)self encodeWithCRCoder:v6 dictionary:*(void *)(v4 + 40)];
}
...
void __45__CRDictionary_encodeWithCRCoder_dictionary___block_invoke(uint64_t a1, void *a2, void *a3, uint64_t a4, void *a5)
{
  ...
  id v8 = a3;
  id v9 = a5;
  if (v8 && [v8 conformsToProtocol:&unk_1F1386330])
  {
    *(_DWORD *)(a4 + 32) |= 2u;
...
- (void)encodeWithCRCoder:(id)a3 dictionary:(void *)a4 elementValueCoder:(id)a5
{
  ...
  long long v30 = 0u;
  v26 = self;
  id obj = [(CRDictionary *)self contents];
  uint64_t v10 = [obj countByEnumeratingWithState:&v27 objects:v31 count:16];
  if (v10)
  {
    uint64_t v25 = *(void *)v28;
    v23 = (google::protobuf::internal::RepeatedPtrFieldBase *)((char *)a4 + 40);
    do
    {
...
- (CRDictionary)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 6)
  {
    id v6 = [(CRDictionary *)self initWithCRCoder:v4 dictionary:*(void *)(v5 + 40)];
  }
  else
  {
    v7 = [v4 document];
    id v6 = [(CRDictionary *)self initWithDocument:v7];
  }
  id v8 = v6;
...
- (CRDictionary)initWithCRCoder:(id)a3 dictionary:(const void *)a4
{
  return [(CRDictionary *)self initWithCRCoder:a3 dictionary:a4 elementValueDecoder:&__block_literal_global_88];
}

- (CRDictionary)initWithCRCoder:(id)a3 dictionary:(const void *)a4 elementValueDecoder:(id)a5
{
  id v8 = a3;
  id v9 = (void (**)(id, void, id *, id))a5;
  uint64_t v10 = [v8 document];
  uint64_t v11 = [(CRDictionary *)self initWithDocument:v10];

  if (v11)
  {
    uint64_t v12 = [MEMORY[0x1E4F1CA48] arrayWithCapacity:*((int *)a4 + 12)];
    if (*((_DWORD *)a4 + 12))
    {
      for (uint64_t i = (uint64_t *)*((void *)a4 + 5); i != (uint64_t *)(*((void *)a4 + 5) + 8 * *((int *)a4 + 12)); ++i)
      {
        uint64_t v14 = *i;
        id v28 = 0;
        uint64_t v15 = v9[2](v9, v14, &v28, v8);
        id v16 = v28;
        v17 = v16;
        ...
        uint64_t v22 = [[CRDictionaryElement alloc] initWithValue:v15 timestamp:v18];
        [v12 addObject:v17];
        [v12 addObject:v22];
...
void __63__CRDictionary_initWithCRCoder_dictionary_elementValueDecoder___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    {
      uint64_t v5 = [*(id *)(a1 + 40) contents];
      id v6 = [*(id *)(a1 + 32) objectAtIndexedSubscript:i + 1];
      v7 = [*(id *)(a1 + 32) objectAtIndexedSubscript:i];
...
- (unint64_t)count
{
  uint64_t v2 = [(CRDictionary *)self contents];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  id v8 = [(CRDictionary *)self contents];
...
LABEL_3:
    ...
    while (1)
    {
      ...
      unint64_t v9 = [(CRDictionary *)self contents];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    uint64_t v5 = [(CRDictionary *)self contents];
...
- (void)setObject:(id)a3 forKey:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(CRDictionary *)self contents];
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(&v10->super, OS_LOG_TYPE_DEBUG)) {
      -[CRDictionary setObject:forKey:](&v10->super);
    }
  }
  else
  {
    uint64_t v10 = [[CRDictionaryElement alloc] initWithValue:v6];
    uint64_t v11 = [(CRDictionary *)self document];
    uint64_t v12 = [v11 replicaClock];

    int v13 = [(CRDictionaryElement *)v10 timestamp];
    long long v14 = +[CRReplica unserialisedIdentifier];
    [v13 setClock:v12 + 1 forUUID:v14];

    long long v15 = [(CRDictionary *)self contents];
    [v15 setObject:v10 forKey:v7];

    long long v16 = [(CRDictionary *)self document];
    [v16 setDocumentFor:v7];

    long long v17 = [(CRDictionary *)self document];
...
- (id)objectForKeyedSubscript:(id)a3
{
  unint64_t v3 = [(CRDictionary *)self objectForKey:a3];
...
{
  id v6 = a3;
  id v4 = [(CRDictionary *)self contents];
  [v4 removeObjectForKey:v6];

  uint64_t v5 = [(CRDictionary *)self document];
  -[CRDictionary setRemoveClock:](self, "setRemoveClock:", [v5 replicaClock] + 1);
}

- (void)removeAllObjects
{
  id v3 = [(CRDictionary *)self contents];
  [v3 removeAllObjects];

  id v4 = [(CRDictionary *)self document];
...
- (void)realizeLocalChangesIn:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v12 = +[CRReplica unserialisedIdentifier];
        uint64_t v13 = [v11 clockForUUID:v12];

        if (v13 >= 1)
        {
          long long v14 = [v10 timestamp];
          long long v15 = +[CRReplica unserialisedIdentifier];
          [v14 removeUUID:v15];
  ...
  if ([(CRDictionary *)self removeClock] >= 1)
  {
    ...
    int64_t v21 = [(CRDictionary *)self removeClock];
    if (v20 <= v21) {
      int64_t v22 = v21;
    }
    else {
  ...
  if (v16)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v20 = [(CRDictionary *)self contents];
  ...
  if (v21)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        long long v25 = [(CRDictionary *)self contents];
        ...
        if (v27)
        {
          ...
          long long v30 = [(CRDictionary *)self document];
          v31 = [v30 version];
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v10 = [(CRDictionary *)self contents];
        uint64_t v11 = [v10 objectForKey:v9];

        uint64_t v12 = [v11 value];
        uint64_t v13 = [v4 localObject:v12];
...
- (id)deltaSince:(id)a3 in:(id)a4
{
  ...
  id v25 = a3;
  id v23 = a4;
  uint64_t v22 = [[CRDictionary alloc] initWithDocument:v23];
  long long v28 = 0u;
  long long v29 = 0u;
  long long v26 = 0u;
  long long v27 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        [v13 minusVectorTimestamp:v25];
        long long v14 = [v11 value];
        BOOL v15 = [v14 deltaSince:v25 in:v23];

        long long v16 = objc_alloc_init(CRDictionaryElement);
        long long v17 = v15;
        if (!v15)
        {
          id v4 = [v11 value];
          uint64_t v5 = [v4 tombstone];
          long long v17 = v5;
        }
        ...
        long long v18 = [(CRDictionary *)v22 contents];
    ...
    if (v7)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v7; ++i)
        {
          ...
          uint64_t v11 = [(CRDictionary *)self contents];
...
{
  *(_WORD *)v1 = 0;
  _os_log_debug_impl(&dword_1B9AA2000, log, OS_LOG_TYPE_DEBUG, "Setting value for an existing key has no effect in a CRDictionary.", v1, 2u);
}
