...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  [(CRTombstoneOrderedSet *)self encodeWithCRCoder:v6 orderedSet:*(void *)(v4 + 40)];
}

- (void)encodeWithCRCoder:(id)a3 orderedSet:(void *)a4
{
  id v10 = a3;
  id v6 = [(CRTombstoneOrderedSet *)self ordering];
  *((_DWORD *)a4 + 8) |= 1u;
...
- (CRTombstoneOrderedSet)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 16)
  {
    id v6 = [(CRTombstoneOrderedSet *)self initWithCRCoder:v4 orderedSet:*(void *)(v5 + 40)];
  }
  else
  {
    uint64_t v7 = [v4 document];
    id v6 = [(CRTombstoneOrderedSet *)self initWithDocument:v7];
  }
  return v6;
}
...
{
  id v4 = a3;
  uint64_t v5 = [[CRArray alloc] initWithDocument:v4];
  id v6 = [[CRSet alloc] initWithDocument:v4];
  uint64_t v7 = [(CRTombstoneOrderedSet *)self initWithOrdering:v5 elements:v6 document:v4];
...
- (id)generateNSOrderedIdentifierSetWithIndexMapping:(id)a3
{
  ...
  id v6 = [(CRTombstoneOrderedSet *)self elements];
  uint64_t v7 = [(CRTombstoneOrderedSet *)self ordering];
  id v8 = [v7 contents];

  id v9 = [(CRTombstoneOrderedSet *)self ordering];
  id v10 = [v9 array];
...
- (id)objectAtIndex:(unint64_t)a3
{
  uint64_t v5 = [(CRTombstoneOrderedSet *)self cachedIdentifierSet];
  id v6 = [v5 objectAtIndex:a3];

  uint64_t v7 = [(CRTombstoneOrderedSet *)self objectForIdentifier:v6];
...
{
  id v4 = a3;
  uint64_t v5 = [(CRTombstoneOrderedSet *)self ordering];
  id v6 = [v5 contents];
...
{
  id v4 = a3;
  uint64_t v5 = [(CRTombstoneOrderedSet *)self cachedIndexMapping];
  id v6 = [v5 objectForKey:v4];

  if (v6 && [v6 count])
  {
    uint64_t v7 = [v6 firstIndex];
    id v8 = [(CRTombstoneOrderedSet *)self ordering];
    id v9 = [v8 array];
    id v10 = [v9 objectAtIndexedSubscript:v7];

    id v11 = [(CRTombstoneOrderedSet *)self cachedIdentifierSet];
...
{
  id v6 = a3;
  id v7 = [(CRTombstoneOrderedSet *)self identifierForObjectInCachedSet:v6];
  if (!v7)
  {
    unint64_t v8 = [(CRTombstoneOrderedSet *)self count];
    if (v8 <= a4)
    {
      if (v8 != a4)
      {
        id v22 = os_log_create("com.apple.coreCRDT", "CRTombstoneOrderedSet");
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR)) {
          -[CRTombstoneOrderedSet insertObject:atIndex:](a4, v22);
        }

        id v24 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3A8] reason:@"CRTombstoneOrderedSet: inserting element at invalid index" userInfo:0];
        objc_exception_throw(v24);
      }
      id v16 = [(CRTombstoneOrderedSet *)self ordering];
    ...
    {
      id v9 = [(CRTombstoneOrderedSet *)self objectAtIndexedSubscript:a4];
      id v10 = [(CRTombstoneOrderedSet *)self cachedIndexMapping];
      id v11 = [v10 objectForKey:v9];

      uint64_t v12 = [v11 firstIndex];
      id v13 = [(CRTombstoneOrderedSet *)self ordering];
    ...
    id v19 = [(CRTombstoneOrderedSet *)self elements];
    [v19 addObject:v7];
    ...
    {
      id v21 = [(CRTombstoneOrderedSet *)self delegate];
...
- (void)undoablyRemoveObjectIdentifiersFromElements:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(CRTombstoneOrderedSet *)self elements];
  long long v14 = 0u;
  long long v15 = 0u;
  long long v16 = 0u;
  long long v17 = 0u;
  ...
  if ([(CRTombstoneOrderedSet *)self wantsUndoCommands])
  {
    id v11 = [(CRTombstoneOrderedSet *)self delegate];
...
- (void)removeObjectAtIndex:(unint64_t)a3
{
  uint64_t v5 = -[CRTombstoneOrderedSet objectAtIndexedSubscript:](self, "objectAtIndexedSubscript:");
  id v6 = [(CRTombstoneOrderedSet *)self cachedIndexMapping];
  uint64_t v7 = [v6 objectForKey:v5];

  uint64_t v8 = [(CRTombstoneOrderedSet *)self cachedIdentifierSet];
  ...
  [v10 addObject:v9];
  id v11 = [(CRTombstoneOrderedSet *)self elements];
  [v11 removeObject:v9];
  ...
  if ([(CRTombstoneOrderedSet *)self wantsUndoCommands])
  {
    long long v14 = [(CRTombstoneOrderedSet *)self delegate];
...
- (void)moveObjectFromIndex:(unint64_t)a3 toIndex:(unint64_t)a4 mutableSafe:(BOOL)a5
{
  ...
  if ([(CRTombstoneOrderedSet *)self count] < a4)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR)) {
      -[CRTombstoneOrderedSet moveObjectFromIndex:toIndex:mutableSafe:](a4, v31);
    }

    id v32 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3A8] reason:@"CRTombstoneOrderedSet: moving element to an invalid index" userInfo:0];
    objc_exception_throw(v32);
  }
  if (a3 != a4 || !v5)
  {
    v34 = [(CRTombstoneOrderedSet *)self objectAtIndexedSubscript:a4];
    uint64_t v9 = [(CRTombstoneOrderedSet *)self objectAtIndexedSubscript:a3];
    id v10 = [(CRTombstoneOrderedSet *)self cachedIndexMapping];
    id v11 = [v10 objectForKey:v9];

    id v12 = [(CRTombstoneOrderedSet *)self cachedIdentifierSet];
    id v13 = [v12 objectAtIndexedSubscript:a3];

    long long v14 = [MEMORY[0x1E4F1CA80] set];
    long long v15 = [(CRTombstoneOrderedSet *)self ordering];
    id v16 = [v15 array];
    ...
    if (!v5)
    {
      id v21 = [(CRTombstoneOrderedSet *)self ordering];
      id v22 = [v21 contents];
    ...
    if (a3 != a4)
    {
      id v24 = [(CRTombstoneOrderedSet *)self cachedIndexMapping];
...
- (void)_removeObjectsFromOrderingAtIndices:(id)a3
{
  ...
  if ([v4 count])
  {
    BOOL v5 = [(CRTombstoneOrderedSet *)self ordering];
    id v6 = [v5 array];
...
- (void)moveClock
{
  id v3 = [(CRTombstoneOrderedSet *)self ordering];
  [v3 setMoveClock:1];

  if ([(CRTombstoneOrderedSet *)self wantsUndoCommands])
  {
    id v4 = [(CRTombstoneOrderedSet *)self delegate];
    [v4 addUndoCommandsForObject:self block:&__block_literal_global_50];
  }
}
...
{
  id v4 = a3;
  BOOL v5 = [(CRTombstoneOrderedSet *)self cachedIdentifierSet];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    uint64_t v6 = [(CRTombstoneOrderedSet *)self ordering];
    id v7 = [v5 ordering];
    if ([v6 isEqual:v7])
    {
      uint64_t v8 = [(CRTombstoneOrderedSet *)self elements];
...
- (unint64_t)hash
{
  id v3 = [(CRTombstoneOrderedSet *)self ordering];
  uint64_t v4 = [v3 hash];
  id v5 = [(CRTombstoneOrderedSet *)self elements];
...
- (void)mergeWith:(id)a3
{
  ...
  {
    uint64_t v9 = os_log_create("com.apple.coreCRDT", "CRTombstoneOrderedSet");
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      -[CRTombstoneOrderedSet mergeWith:]((uint64_t)v4, v9);
    }

    char v10 = NSString;
    id v11 = (objc_class *)objc_opt_class();
    id v12 = NSStringFromClass(v11);
    id v13 = [v10 stringWithFormat:@"CRTombstoneOrderedSet cannot merge with object of type %@.", v12];

    objc_exception_throw(v13);
  }
  id v14 = v4;
  id v5 = [(CRTombstoneOrderedSet *)self ordering];
  unint64_t v6 = [v14 ordering];
  [v5 mergeWith:v6];

  id v7 = [(CRTombstoneOrderedSet *)self elements];
...
- (id)deltaSince:(id)a3 in:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  uint64_t v8 = [(CRTombstoneOrderedSet *)self ordering];
  uint64_t v9 = [v8 deltaSince:v7 in:v6];

  char v10 = [(CRTombstoneOrderedSet *)self elements];
  id v11 = [v10 deltaSince:v7 in:v6];

  id v12 = [[CRTombstoneOrderedSet alloc] initWithOrdering:v9 elements:v11 document:v6];
...
- (id)tombstone
{
  ...
  id v7 = [CRTombstoneOrderedSet alloc];
  uint64_t v8 = [(CRTombstoneOrderedSet *)self document];
  uint64_t v9 = [(CRTombstoneOrderedSet *)v7 initWithOrdering:v4 elements:v6 document:v8];
...
{
  id v5 = a4;
  id v6 = [(CRTombstoneOrderedSet *)self delegate];
...
- (BOOL)wantsUndoCommands
{
  uint64_t v2 = [(CRTombstoneOrderedSet *)self delegate];
...
- (void)insertObject:(uint64_t)a1 atIndex:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 134217984;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_1B9AA2000, a2, OS_LOG_TYPE_ERROR, "Inserting element at invalid index %lu", (uint8_t *)&v2, 0xCu);
}
...
- (void)moveObjectFromIndex:(uint64_t)a1 toIndex:(NSObject *)a2 mutableSafe:.cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 134217984;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_1B9AA2000, a2, OS_LOG_TYPE_ERROR, "Moving element at invalid index %lu", (uint8_t *)&v2, 0xCu);
}
...
- (void)mergeWith:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v5 = 138543362;
  id v6 = v4;
  _os_log_error_impl(&dword_1B9AA2000, a2, OS_LOG_TYPE_ERROR, "CRTombstoneOrderedSet cannot merge with object of type %{public}@.", (uint8_t *)&v5, 0xCu);
}
