...
- (CRTimestamp)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 7)
  {
    self = [(CRTimestamp *)self initWithProtobufTimestamp:*(void *)(v5 + 40) decoder:v4];
    v6 = self;
  }
  else
  {
...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  [(CRTimestamp *)self encodeIntoProtobufTimestamp:*(void *)(v4 + 40) coder:v6];
}
...
{
  id v10 = a4;
  id v6 = [(CRTimestamp *)self replica];
  ...
  int64_t v9 = [(CRTimestamp *)self counter];
  *((_DWORD *)a3 + 8) |= 2u;
  *((void *)a3 + 6) = v9;
}
...
- (CRTimestamp)initWithReplica:(id)a3 andCounter:(int64_t)a4
{
  id v7 = a3;
  v11.receiver = self;
  v11.super_class = (Class)CRTimestamp;
  uint64_t v8 = [(CRTimestamp *)&v11 init];
  int64_t v9 = v8;
  if (v8)
  {
...
{
  id v4 = a3;
  id v5 = [(CRTimestamp *)self replica];
  uint64_t v6 = objc_msgSend(v5, "CR_compare:", v4);

  id v7 = [CRTimestamp alloc];
  if (v6 == -1) {
    int64_t v8 = [(CRTimestamp *)self counter];
  }
  else {
    int64_t v8 = [(CRTimestamp *)self counter] + 1;
  }
  int64_t v9 = [(CRTimestamp *)v7 initWithReplica:v4 andCounter:v8];
...
- (id)nextTimestamp
{
  ...
  id v4 = [(CRTimestamp *)self replica];
  id v5 = [(CRTimestamp *)v3 initWithReplica:v4 andCounter:[(CRTimestamp *)self counter] + 1];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = a3;
  objc_opt_class();
  BOOL v5 = (objc_opt_isKindOfClass() & 1) != 0 && [(CRTimestamp *)self isEqualToTimestamp:v4];
...
{
  id v4 = a3;
  int64_t v5 = [(CRTimestamp *)self counter];
  if (v5 == [v4 counter])
  {
    uint64_t v6 = [(CRTimestamp *)self replica];
    id v7 = [v4 replica];
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [v3 hash];
  unint64_t v5 = [(CRTimestamp *)self counter] ^ v4;
...
- (int64_t)compare:(id)a3
{
  ...
  {
    uint64_t v9 = [(CRTimestamp *)self counter];
    if (v9 > [v4 counter]) {
      int64_t v8 = 1;
    }
    else {
...
- (NSString)description
{
  ...
  int64_t v6 = [(CRTimestamp *)self counter];
  id v7 = [(CRTimestamp *)self replica];
...
{
  v3 = NSString;
  int64_t v4 = [(CRTimestamp *)self counter];
  int64_t v5 = [(CRTimestamp *)self replica];
