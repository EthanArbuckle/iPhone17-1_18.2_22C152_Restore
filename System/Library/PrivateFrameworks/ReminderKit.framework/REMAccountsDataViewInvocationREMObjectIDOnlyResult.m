...
{
  id v4 = a3;
  id v5 = [(REMAccountsDataViewInvocationREMObjectIDOnlyResult *)self accountIDs];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      v7 = (void *)v6;
      v8 = [(REMAccountsDataViewInvocationREMObjectIDOnlyResult *)self accountIDs];
      objc_super v9 = [v4 accountIDs];
