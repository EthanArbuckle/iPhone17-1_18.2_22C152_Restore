...
{
  id v4 = a3;
  id v5 = [(REMTemplateSectionsDataViewInvocation_fetchTemplateSectionsInTemplate *)self templateObjectID];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      v7 = (void *)v6;
      v8 = [(REMTemplateSectionsDataViewInvocation_fetchTemplateSectionsInTemplate *)self templateObjectID];
