...
- (CRSet)init
{
  return [(CRSet *)self initWithDocument:0];
}
...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  [v7 encodeWithCRCoder:v8 dictionary:v6 elementValueCoder:&__block_literal_global_45];
}
...
{
  id v7 = a3;
  uint64_t v6 = [(CRSet *)self dictionary];
...
- (void)encodeWithCRCoder:(id)a3 set:(void *)a4 elementValueCoder:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  uint64_t v10 = [(CRSet *)self dictionary];
...
uint64_t __49__CRSet_encodeWithCRCoder_set_elementValueCoder___block_invoke(uint64_t a1)
{
...
- (CRSet)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 4)
  {
    uint64_t v6 = [(CRSet *)self initWithCRCoder:v4 set:*(void *)(v5 + 40)];
  }
  else
  {
    id v7 = [v4 document];
    uint64_t v6 = [(CRSet *)self initWithDocument:v7];
  }
  return v6;
}
...
- (CRSet)initWithCRCoder:(id)a3 set:(const void *)a4
{
  id v6 = a3;
  id v7 = [v6 document];
  id v8 = [(CRSet *)self initWithDocument:v7];

  if (v8)
  {
    id v9 = [[CRDictionary alloc] initWithCRCoder:v6 dictionary:a4 elementValueDecoder:&__block_literal_global_64];
...
- (CRSet)initWithCRCoder:(id)a3 set:(const void *)a4 elementValueDecoder:(id)a5
{
  ...
  id v9 = a5;
  id v10 = [v8 document];
  id v11 = [(CRSet *)self initWithDocument:v10];
  ...
  if (v11)
  {
    ...
    v15[3] = &unk_1E61DE3F0;
    id v16 = v9;
    id v13 = [(CRDictionary *)v12 initWithCRCoder:v8 dictionary:a4 elementValueDecoder:v15];
...
{
  id v4 = a3;
  uint64_t v5 = [(CRSet *)self dictionary];
...
- (NSArray)allObjects
{
  ...
  unint64_t v3 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", -[CRSet count](self, "count"));
  long long v11 = 0u;
  long long v12 = 0u;
  long long v9 = 0u;
  long long v10 = 0u;
  id v4 = [(CRSet *)self dictionary];
...
- (void)addObject:(id)a3
{
  ...
  long long v10 = 0u;
  long long v11 = 0u;
  uint64_t v6 = [(CRSet *)self observers];
...
- (id)deltaSince:(id)a3 in:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(CRSet *)self dictionary];
  uint64_t v9 = [v8 deltaSince:v6 in:v7];

  if (v9)
  {
    long long v10 = [[CRSet alloc] initWithDocument:v7];
