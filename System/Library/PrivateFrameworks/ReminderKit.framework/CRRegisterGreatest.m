...
- (void)setContents:(id)a3
{
  ...
  int64_t v6 = [(CRRegisterGreatest *)self compare:v5 with:v4];

  if (v6 == -1)
  {
    v7.receiver = self;
    v7.super_class = (Class)CRRegisterGreatest;
    [(CRRegisterLatest *)&v7 setContents:v4];
  }
}
...
- (void)mergeWith:(id)a3
{
  ...
  [(CRRegisterGreatest *)self mergeWithRegisterGreatest:v5];
}
...
- (void)mergeWithRegisterGreatest:(id)a3
{
  ...
  id v5 = [v9 contents];
  int64_t v6 = [(CRRegisterGreatest *)self compare:v4 with:v5];

  if (v6 == -1)
  {
    objc_super v7 = [v9 contents];
    [(CRRegisterLatest *)self _setContents:v7];
