...
{
  id v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[REMListsDataViewInvocation_fetchDefaultList debug_useInMemoryPreferredDefaultListStorage](self, "debug_useInMemoryPreferredDefaultListStorage"), @"debug_useInMemoryPreferredDefaultListStorage");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    BOOL v6 = [(REMListsDataViewInvocation_fetchDefaultList *)self debug_useInMemoryPreferredDefaultListStorage];
...
- (unint64_t)hash
{
  ...
  return (unint64_t)v3
       + [(REMListsDataViewInvocation_fetchDefaultList *)self debug_useInMemoryPreferredDefaultListStorage];
}
