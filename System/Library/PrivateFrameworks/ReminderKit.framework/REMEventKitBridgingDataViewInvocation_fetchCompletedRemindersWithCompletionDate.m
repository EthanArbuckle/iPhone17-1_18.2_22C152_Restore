...
- (REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate)initWithCoder:(id)a3
{
  ...
  id v11 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self initWithListIDs:v8 startDate:v9 endDate:v10];
  return v11;
}
...
{
  id v4 = a3;
  id v5 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self listIDs];
  [v4 encodeObject:v5 forKey:@"listIDs"];

  uint64_t v6 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self startDate];
  [v4 encodeObject:v6 forKey:@"startDate"];

  id v7 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self endDate];
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v11 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self startDate];
...
LABEL_8:
  ...
  {
    v20 = (void *)v19;
    v21 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self endDate];
    v22 = [v4 endDate];
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [v3 hash];
  id v5 = [(REMEventKitBridgingDataViewInvocation_fetchCompletedRemindersWithCompletionDate *)self startDate];
