...
{
  v5.receiver = self;
  v5.super_class = (Class)TTCRVectorTimestamp;
...
{
  id v4 = a3;
  objc_super v5 = [(TTCRVectorTimestamp *)self crTimestamp];
...
{
  id v6 = a4;
  id v7 = [(TTCRVectorTimestamp *)self crTimestamp];
...
{
  id v8 = a5;
  id v9 = [(TTCRVectorTimestamp *)self crTimestamp];
