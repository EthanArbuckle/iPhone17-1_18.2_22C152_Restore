...
- (BOOL)isEqual:(id)a3;
- (REMListsDataViewInvocation_fetchListsInAccount)initWithCoder:(id)a3;
- (REMListsDataViewInvocation_fetchListsInAccount)initWithParentAccountObjectID:(id)a3;
...
- (REMListsDataViewInvocation_fetchListsInAccount)initWithParentAccountObjectID:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)REMListsDataViewInvocation_fetchListsInAccount;
...
{
  id v4 = a3;
  id v5 = [(REMListsDataViewInvocation_fetchListsInAccount *)self accountObjectID];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      v7 = (void *)v6;
      v8 = [(REMListsDataViewInvocation_fetchListsInAccount *)self accountObjectID];
...
- (unint64_t)hash
{
  v2 = [(REMListsDataViewInvocation_fetchListsInAccount *)self accountObjectID];
