...
- (REMRemindersDataViewInvocation_fetchRemindersCountByListID)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    self = [(REMRemindersDataViewInvocation_fetchRemindersCountByListID *)self initWithListID:v5];
    v6 = self;
  }
  else
  {
...
{
  id v4 = a3;
  id v5 = [(REMRemindersDataViewInvocation_fetchRemindersCountByListID *)self listID];
...
- (unint64_t)hash
{
  v2 = [(REMRemindersDataViewInvocation_fetchRemindersCountByListID *)self listID];
