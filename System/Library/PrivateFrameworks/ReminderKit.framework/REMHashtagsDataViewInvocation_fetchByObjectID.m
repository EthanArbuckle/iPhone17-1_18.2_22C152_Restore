...
- (BOOL)isEqual:(id)a3;
- (NSArray)objectIDs;
- (REMHashtagsDataViewInvocation_fetchByObjectID)initWithCoder:(id)a3;
- (REMHashtagsDataViewInvocation_fetchByObjectID)initWithObjectIDs:(id)a3;
- (unint64_t)hash;
...
- (REMHashtagsDataViewInvocation_fetchByObjectID)initWithObjectIDs:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)REMHashtagsDataViewInvocation_fetchByObjectID;
...
{
  id v5 = a3;
  v4 = [(REMHashtagsDataViewInvocation_fetchByObjectID *)self objectIDs];
  [v5 encodeObject:v4 forKey:@"objectIDs"];

  objc_msgSend(v5, "encodeBool:forKey:", -[REMHashtagsDataViewInvocation_fetchByObjectID allowConcealedObjects](self, "allowConcealedObjects"), @"allowConcealedObjects");
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  id v5 = [(REMHashtagsDataViewInvocation_fetchByObjectID *)self objectIDs];
  ...
  v7 = (void *)v6;
  v8 = [(REMHashtagsDataViewInvocation_fetchByObjectID *)self objectIDs];
  ...
  {
LABEL_6:
    BOOL v12 = [(REMHashtagsDataViewInvocation_fetchByObjectID *)self allowConcealedObjects];
...
- (unint64_t)hash
{
  v2 = [(REMHashtagsDataViewInvocation_fetchByObjectID *)self objectIDs];
