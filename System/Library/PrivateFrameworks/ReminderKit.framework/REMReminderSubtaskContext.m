...
- (BOOL)hasSubtasksWithError:(id *)a3
{
  id v5 = [REMRemindersDataView alloc];
  v6 = [(REMReminderSubtaskContext *)self reminder];
  v7 = [v6 store];
  v8 = [(REMRemindersDataView *)v5 initWithStore:v7];

  objc_super v9 = [(REMReminderSubtaskContext *)self reminder];
  v10 = [v9 objectID];
...
- (int64_t)fetchSubtasksMasksWithError:(id *)a3
{
  ...
  objc_super v9 = [(REMReminderSubtaskContext *)self reminder];
  v10 = [v9 objectID];
  int64_t v11 = [(REMRemindersDataView *)v8 fetchSubtasksMasksWithParentReminderID:v10 includingConcealed:0 error:a3];
...
- (int64_t)fetchSubtasksMasksIncludingConcealedWithError:(id *)a3
{
  ...
  objc_super v9 = [(REMReminderSubtaskContext *)self reminder];
  v10 = [v9 objectID];
  int64_t v11 = [(REMRemindersDataView *)v8 fetchSubtasksMasksWithParentReminderID:v10 includingConcealed:1 error:a3];
...
- (id)fetchRemindersWithError:(id *)a3
{
  id v5 = +[REMReminderFetchOptions defaultFetchOptions];
...
- (id)fetchRemindersWithFetchOptions:(id)a3 error:(id *)a4
{
  ...
  objc_super v9 = [v8 store];
  v10 = [(REMRemindersDataView *)v7 initWithStore:v9];

  int64_t v11 = [(REMReminderSubtaskContext *)self reminder];
...
{
  id v5 = [REMRemindersDataView alloc];
  id v6 = [(REMReminderSubtaskContext *)self reminder];
  v7 = [v6 store];
  v8 = [(REMRemindersDataView *)v5 initWithStore:v7];

  objc_super v9 = [(REMReminderSubtaskContext *)self reminder];
  v10 = +[REMReminderFetchOptions defaultFetchOptions];
  int64_t v11 = [(REMRemindersDataView *)v8 fetchSubtasksOfParentReminder:v9 subtaskFetchOption:2 reminderFetchOptions:v10 error:a3];
...
{
  id v5 = +[REMReminderFetchOptions defaultFetchOptions];
  id v6 = [(REMReminderSubtaskContext *)self fetchRemindersForMovingWithFetchOptions:v5 error:a3];
...
- (id)fetchObjectIDsOfCompletedSubtasksWithError:(id *)a3
{
  ...
  objc_super v9 = [(REMReminderSubtaskContext *)self reminder];
  v10 = [v9 objectID];
  int64_t v11 = [(REMRemindersDataView *)v8 fetchObjectIDsOfRemindersWithParentReminderID:v10 includeIncomplete:0 includeCompleted:1 isUnsupported:0 error:a3];
...
- (id)fetchObjectIDsOfUnsupportedSubtasksWithError:(id *)a3
{
  ...
  objc_super v9 = [(REMReminderSubtaskContext *)self reminder];
  v10 = [v9 objectID];
  int64_t v11 = [(REMRemindersDataView *)v8 fetchObjectIDsOfRemindersWithParentReminderID:v10 includeIncomplete:1 includeCompleted:1 isUnsupported:1 error:a3];
