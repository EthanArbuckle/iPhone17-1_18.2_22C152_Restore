...
- (void)encodeWithCRCoder:(id)a3
{
  ...
  [(CRRegisterLatest *)self encodeIntoProtobufRegisterLatest:*(void *)(v4 + 40) coder:v6];
}
...
- (CRRegisterLatest)initWithCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 1)
  {
    id v6 = [(CRRegisterLatest *)self initWithProtobufRegisterLatest:*(void *)(v5 + 40) decoder:v4];
  }
  else
  {
    id v7 = [v4 document];
    id v6 = [(CRRegisterLatest *)self initWithContents:0 document:v7];
  }
  return v6;
}
...
{
  id v13 = a4;
  id v6 = [(CRRegisterLatest *)self timestamp];
  *((_DWORD *)a3 + 8) |= 1u;
  ...
  int v8 = [(CRRegisterLatest *)self contents];

  if (v8)
  {
    id v9 = [(CRRegisterLatest *)self contents];
    int v10 = [v9 conformsToProtocol:&unk_1F1386330];

    if (v10)
    {
      uint64_t v11 = [(CRRegisterLatest *)self contents];
      *((_DWORD *)a3 + 8) |= 2u;
...
- (void)setContents:(id)a3
{
  ...
  if (self->_contents != v16)
  {
    ...
    uint64_t v5 = [(CRRegisterLatest *)self timestamp];
    id v6 = [v5 replica];
    uint64_t v7 = +[CRReplica unserialisedIdentifier];

    if (v6 != v7)
    {
      int v8 = [(CRRegister *)self document];
      uint64_t v9 = [v8 replicaClock];

      int v10 = [(CRRegisterLatest *)self timestamp];
      uint64_t v11 = [v10 counter];

      if (v9 > v11) {
        uint64_t v11 = v9;
      }
      uint64_t v12 = [CRTimestamp alloc];
      id v13 = +[CRReplica unserialisedIdentifier];
      objc_super v14 = [(CRTimestamp *)v12 initWithReplica:v13 andCounter:v11 + 1];
      [(CRRegisterLatest *)self setTimestamp:v14];
    }
    v15 = [(CRRegister *)self document];
...
- (BOOL)isEqualContents:(id)a3
{
  ...
  {
    uint64_t v5 = [(CRRegisterLatest *)self contents];
    id v6 = [v4 contents];
    if ([v5 isEqual:v6])
    {
      uint64_t v7 = [(CRRegisterLatest *)self timestamp];
      int v8 = [v4 timestamp];
...
{
  id v15 = a3;
  id v4 = [(CRRegisterLatest *)self timestamp];
  uint64_t v5 = [v4 replica];
  id v6 = +[CRReplica unserialisedIdentifier];
  ...
  if (v5 == v6)
  {
    ...
    if ([v7 counter])
    {
      int v8 = [(CRRegisterLatest *)self timestamp];
    ...
    int v10 = [CRTimestamp alloc];
    uint64_t v11 = [v15 replica];
    uint64_t v12 = [(CRTimestamp *)v10 initWithReplica:v11 andCounter:v9];
...
- (void)mergeWith:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      id v4 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3A8], @"Invalid CRRegisterLatest merge, classes must be equal for merge.", 0 reason userInfo];
...
- (void)setDocument:(id)a3
{
  ...
  id v5 = [(CRRegisterLatest *)self contents];
...
- (id)deltaSince:(id)a3 in:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  objc_super v8 = [(CRRegisterLatest *)self timestamp];
  id v9 = [v8 replica];
  int v10 = [v6 timestampForReplica:v9];
  uint64_t v11 = [(CRRegisterLatest *)self timestamp];
  ...
  {
    uint64_t v14 = [(CRRegisterLatest *)self contents];
    id v15 = [v14 deltaSince:v6 in:v7];

    if (v15)
    {
      v16 = [CRRegisterLatest alloc];
      v17 = [(CRRegisterLatest *)self timestamp];
      uint64_t v13 = [(CRRegisterLatest *)v16 initWithContents:v15 timestamp:v17 document:v7];
...
- (void)walkGraph:(id)a3
{
  ...
  id v4 = [(CRRegisterLatest *)self contents];
  v5[2](v5, v4);
}
...
- (id)description
{
  ...
  objc_super v8 = [(CRRegisterLatest *)self contents];
