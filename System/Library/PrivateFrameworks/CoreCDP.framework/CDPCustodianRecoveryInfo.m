...
- (CDPCustodianRecoveryInfo)initWithCoder:(id)a3;
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)a3 wrappingKey:(id)a4 custodianUUID:(id)a5;
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)a3 wrappingKey:(id)a4 custodianUUID:(id)a5 recordBuildVersion:(id)a6;
- (NSData)wrappedRKC;
- (NSData)wrappingKey;
...
@implementation CDPCustodianRecoveryInfo
...
{
  id v4 = a3;
  v5 = [(CDPCustodianRecoveryInfo *)self init];
  if (v5)
  {
...
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)a3 wrappingKey:(id)a4 custodianUUID:(id)a5
{
  return [(CDPCustodianRecoveryInfo *)self initWithWrappedRKC:a3 wrappingKey:a4 custodianUUID:a5 recordBuildVersion:0];
}
...
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)a3 wrappingKey:(id)a4 custodianUUID:(id)a5 recordBuildVersion:(id)a6
{
  ...
  id v14 = a6;
  v18.receiver = self;
  v18.super_class = (Class)CDPCustodianRecoveryInfo;
  v15 = [(CDPCustodianRecoveryInfo *)&v18 init];
  v16 = v15;
  if (v15)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = [+[CDPCustodianRecoveryInfo allocWithZone:a3] init];
