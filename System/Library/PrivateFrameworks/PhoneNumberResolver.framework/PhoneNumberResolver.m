void sub_23974CE34(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  uint64_t v8;
  va_list va;
  uint64_t v10;
...
void sub_23974DB88(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  _Block_object_dispose(va, 8);
...
void sub_239751E5C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
Class __getGEOCountryConfigurationClass_block_invoke(uint64_t a1)
{
  ...
  if (!GeoServicesLibraryCore_frameworkLibrary)
  {
    ...
    v4[5] = v4;
    long long v5 = xmmword_264D9F5D8;
    uint64_t v6 = 0;
...
void __getGEOCountryConfigurationClass_block_invoke_cold_1()
{
  v0 = (void *)abort_report_np();
  __87__PNRPhoneNumberResolver_resolveFullyQualifiedPhoneNumber_inCountry_logId_resultBlock___block_invoke_76_cold_1(v0, v1);
}
...
uint64_t CFBurstTrieCursorAdvanceForBytes()
{
  return MEMORY[0x270EE4668]();
}

uint64_t CFBurstTrieCursorGetPayload()
{
  return MEMORY[0x270EE4670]();
}
