...
- (FTTextToSpeechRequestContext)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRequestContext *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRequestContext *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechRequestContext)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestContext *)a4
{
  return [(FTTextToSpeechRequestContext *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechRequestContext)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestContext *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTTextToSpeechRequestContext *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (id)context_info_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"context_info"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTTextToSpeechRequestContext_ContextInfoEntry alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTTextToSpeechRequestContext_ContextInfoEntry alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestContext>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(FTTextToSpeechRequestContext *)self context_info];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v38, [v5 count]);
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        int v10 = [*(id *)(*((void *)&v34 + 1) + 8 * i) addObjectToBuffer:a3];
        int v11 = v10;
        std::vector<int>::pointer end = v38.__end_;
        if (v38.__end_ >= v38.__end_cap_.__value_)
        {
          std::vector<int>::pointer begin = v38.__begin_;
          int64_t v15 = v38.__end_ - v38.__begin_;
          unint64_t v16 = v15 + 1;
          if ((unint64_t)(v15 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v17 = (char *)v38.__end_cap_.__value_ - (char *)v38.__begin_;
          ...
          if (v18)
          {
            uint64_t v19 = (char *)std::__allocate_at_least[abi:ne180100]<std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>((uint64_t)&v38.__end_cap_, v18);
            std::vector<int>::pointer begin = v38.__begin_;
            std::vector<int>::pointer end = v38.__end_;
          }
          else
  ...
  if (v38.__end_ == v38.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TextToSpeechRequestContext_::ContextInfoEntry>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TextToSpeechRequestContext_::ContextInfoEntry>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TextToSpeechRequestContext_::ContextInfoEntry>> const&)::t;
  }
  else {
    std::vector<int>::pointer v22 = v38.__begin_;
  }
  int v23 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v22, v38.__end_ - v38.__begin_);
  uint64_t v24 = [(FTTextToSpeechRequestContext *)v33 dialog_identifier];
  char v25 = v24;
  if (!v24) {
    uint64_t v24 = &stru_270C008E8;
  }
  objc_super v26 = (const char *)[(__CFString *)v24 UTF8String];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 6, (int)v26);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechRequestContext *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
