...
- (FTMutablePostItnHammerResponse)init;
- (NSArray)tokens;
- (NSString)language;
- (NSString)return_str;
- (NSString)session_id;
...
@implementation FTMutablePostItnHammerResponse

- (FTMutablePostItnHammerResponse)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutablePostItnHammerResponse;
  v2 = [(FTMutablePostItnHammerResponse *)&v6 init];
  if (v2)
  {
