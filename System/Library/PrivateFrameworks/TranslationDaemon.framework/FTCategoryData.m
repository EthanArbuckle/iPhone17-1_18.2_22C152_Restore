@interface FTCategoryData
- (FTCategoryData)initWithFlatbuffData:(id)a3;
- (FTCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4;
- (FTCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4 verify:(BOOL)a5;
- (NSArray)category_data;
- (NSString)category_name;
- (Offset<siri::speech::schema_fb::CategoryData>)addObjectToBuffer:(void *)a3;
- (id)category_data_objectAtIndex:(unint64_t)a3;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
- (unint64_t)category_data_count;
- (void)category_data_enumerateObjectsUsingBlock:(id)a3;
@end

@implementation FTCategoryData

- (FTCategoryData)initWithFlatbuffData:(id)a3
{
  return [(FTCategoryData *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTCategoryData *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4
{
  return [(FTCategoryData *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTCategoryData;
  v10 = [(FTCategoryData *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::CategoryData *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::CategoryData::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)category_data
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"category_data"];
  if (!v3)
  {
    uint64_t v4 = [MEMORY[0x263EFF980] array];
    v6[0] = MEMORY[0x263EF8330];
    v6[1] = 3221225472;
    v6[2] = __31__FTCategoryData_category_data__block_invoke;
    v6[3] = &unk_265548F68;
    id v3 = v4;
    id v7 = v3;
    [(FTCategoryData *)self category_data_enumerateObjectsUsingBlock:v6];
    [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"category_data"];
  }
  return (NSArray *)v3;
}

uint64_t __31__FTCategoryData_category_data__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)category_data_objectAtIndex:(unint64_t)a3
{
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"category_data"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 7u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTUserDataEntity alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)category_data_enumerateObjectsUsingBlock:(id)a3
{
  uint64_t v4 = (void (**)(id, FTUserDataEntity *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"category_data"];
  v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 7u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTUserDataEntity alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::CategoryData>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTCategoryData *)self category_name];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v9 = [(FTCategoryData *)self category_data];
  ...
  long long v34 = 0u;
  long long v35 = 0u;
  v10 = [(FTCategoryData *)self category_data];
  int v33 = (int)v7;
  ...
  if (v38.__end_ == v38.__begin_) {
    std::vector<int>::pointer v26 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::UserDataEntity>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::UserDataEntity>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::UserDataEntity>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTCategoryData *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__30__FTCategoryData_flatbuffData__block_invoke(uint64_t a1)
{
