...
- (id)performLanguageDetectionWithDelegate:(id)a3 requestBuilder:(id)a4 completion:(id)a5
{
  ...
  v14 = -[FTLanguageDetectionStreamingContext initWithGRPCStreamingCallContext:](v13, "initWithGRPCStreamingCallContext:", v12, v16, v17, v18, v19);
...
{
  id v5 = a2;
  id v3 = [[FTLanguageDetectionStreamingResponse alloc] initAndVerifyWithFlatbuffData:v5];
  if (v3)
  {
    if (objc_opt_respondsToSelector()) {
      [*(id *)(a1 + 32) streamDidReceiveLanguageDetectionStreamingResponse:v3];
    }
  }
  else if (objc_opt_respondsToSelector())
  {
    v4 = [MEMORY[0x263F087E8] errorWithDomain:@"Flatbuffers" code:100 userInfo:MEMORY[0x263EFFA78]];
    [*(id *)(a1 + 32) streamFailVerifyLanguageDetectionStreamingResponse:v4];
  }
}

uint64_t __79__FTSlsService_performLanguageDetectionWithDelegate_requestBuilder_completion___block_invoke_2(uint64_t a1)
{
