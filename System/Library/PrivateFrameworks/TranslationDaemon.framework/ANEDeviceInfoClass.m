...
Class __get_ANEDeviceInfoClass_block_invoke(uint64_t a1)
{
  ...
  if (!AppleNeuralEngineLibraryCore_frameworkLibrary)
  {
    ...
    v4[5] = v4;
    long long v5 = xmmword_2655461F0;
    uint64_t v6 = 0;
...
LABEL_7:
    v2 = (void *)__get_ANEDeviceInfoClass_block_invoke_cold_1();
LABEL_8:
    free(v2);
  }
...
uint64_t __get_ANEDeviceInfoClass_block_invoke_cold_1()
{
  uint64_t v0 = abort_report_np();
  return -[_LTDAssetConfigurationModel currentSpeechTranslationAssetType](v0);
}
