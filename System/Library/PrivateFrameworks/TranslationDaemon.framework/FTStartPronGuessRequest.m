...
- (FTStartPronGuessRequest)initWithFlatbuffData:(id)a3
{
  return [(FTStartPronGuessRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTStartPronGuessRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTStartPronGuessRequest)initWithFlatbuffData:(id)a3 root:(const StartPronGuessRequest *)a4
{
  return [(FTStartPronGuessRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTStartPronGuessRequest)initWithFlatbuffData:(id)a3 root:(const StartPronGuessRequest *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTStartPronGuessRequest *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::StartPronGuessRequest>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTStartPronGuessRequest *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTStartPronGuessRequest *)self session_id];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  v15 = [(FTStartPronGuessRequest *)self orthography];
  v16 = v15;
  if (!v15) {
    v15 = &stru_270C008E8;
  }
  ...
  v20 = [(FTStartPronGuessRequest *)self language];
  v21 = v20;
  if (!v20) {
    v20 = &stru_270C008E8;
  }
  ...
  int v24 = [(FTStartPronGuessRequest *)self codec];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTStartPronGuessRequest *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
