...
- (FTPostItnHammerRequest)initWithFlatbuffData:(id)a3
{
  return [(FTPostItnHammerRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTPostItnHammerRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTPostItnHammerRequest)initWithFlatbuffData:(id)a3 root:(const PostItnHammerRequest *)a4
{
  return [(FTPostItnHammerRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTPostItnHammerRequest)initWithFlatbuffData:(id)a3 root:(const PostItnHammerRequest *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTPostItnHammerRequest *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 0xDu)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTRecognitionToken alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)tokens_enumerateObjectsUsingBlock:(id)a3
{
  uint64_t v4 = (void (**)(id, FTRecognitionToken *, uint64_t, unsigned __int8 *))a3;
    ...
    if (*(unsigned __int16 *)v8->var0 >= 0xDu)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTRecognitionToken alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::PostItnHammerRequest>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTPostItnHammerRequest *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTPostItnHammerRequest *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  uint64_t v15 = [(FTPostItnHammerRequest *)self language];
  uint64_t v16 = v15;
  if (!v15) {
  ...
  unsigned __int8 v20 = [(FTPostItnHammerRequest *)self post_itn_string];
  v21 = v20;
  if (!v20) {
    unsigned __int8 v20 = &stru_270C008E8;
  }
  ...
  uint64_t v24 = [(FTPostItnHammerRequest *)self tokens];
  ...
  long long v52 = 0u;
  long long v53 = 0u;
  char v25 = [(FTPostItnHammerRequest *)self tokens];
  int v48 = (int)v22;
  int v49 = v19;
  int v50 = v14;
  int v51 = String;
  ...
  if (v26)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v26; ++i)
      {
        ...
        int v29 = [*(id *)(*((void *)&v52 + 1) + 8 * i) addObjectToBuffer:a3];
        int v30 = v29;
        std::vector<int>::pointer end = v56.__end_;
        if (v56.__end_ >= v56.__end_cap_.__value_)
        {
          std::vector<int>::pointer begin = v56.__begin_;
          int64_t v34 = v56.__end_ - v56.__begin_;
          unint64_t v35 = v34 + 1;
          if ((unint64_t)(v34 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v36 = (char *)v56.__end_cap_.__value_ - (char *)v56.__begin_;
  ...
  if (v56.__end_ == v56.__begin_) {
    std::vector<int>::pointer v41 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>> const&)::t;
  }
  else {
    std::vector<int>::pointer v41 = v56.__begin_;
  }
  int v42 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v41, v56.__end_ - v56.__begin_);
  *((unsigned char *)a3 + 70) = 1;
  int v43 = *((_DWORD *)a3 + 8);
  int v44 = *((_DWORD *)a3 + 12);
  int v45 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 4, v51);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 8, v49);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 12, v42);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTPostItnHammerRequest *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
