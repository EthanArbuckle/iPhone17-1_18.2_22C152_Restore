...
- (FTSpeechTranslationStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTSpeechTranslationStreamingResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationStreamingResponse *)a4
{
  return [(FTSpeechTranslationStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTSpeechTranslationStreamingResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTSpeechTranslationStreamingResponse *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (FLTBFBufferAccessor)content
{
  switch([(FTSpeechTranslationStreamingResponse *)self content_type])
  {
    case 1:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationPartialRecognitionResponse];
      break;
    case 2:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationFinalRecognitionResponse];
      break;
    case 3:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTAudioLimitExceeded];
      break;
    case 4:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationMtResponse];
      break;
    case 5:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationTextToSpeechResponse];
      break;
    case 6:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTFinalBlazarResponse];
      break;
    case 7:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTRecognitionProgress];
      break;
    case 8:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTRecognitionCandidate];
      break;
    case 9:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTRequestStatsResponse];
      break;
    case 10:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTServerEndpointFeatures];
      break;
    case 11:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTClientSetupInfo];
      break;
    case 12:
      v3 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationServerEndpointFeatures];
      break;
    default:
      v3 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::SpeechTranslationStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTSpeechTranslationStreamingResponse *)self content_type];
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 1)
  {
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 2)
  {
    v8 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationFinalRecognitionResponse];
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 3)
  {
    v10 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTAudioLimitExceeded];
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 4)
  {
    v12 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationMtResponse];
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 5)
  {
    unint64_t v14 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationTextToSpeechResponse];
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 6)
  {
    v16 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTFinalBlazarResponse];
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 7)
  {
    uint64_t v18 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTRecognitionProgress];
    int v37 = [v18 addObjectToBuffer:a3];
  }
  else
  {
    int v37 = 0;
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 8)
  {
    uint64_t v19 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTRecognitionCandidate];
    int v36 = [v19 addObjectToBuffer:a3];
  }
  else
  {
    int v36 = 0;
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 9)
  {
    v20 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTRequestStatsResponse];
    int v35 = [v20 addObjectToBuffer:a3];
  }
  else
  {
    int v35 = 0;
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 10)
  {
    uint64_t v21 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTServerEndpointFeatures];
    int v34 = [v21 addObjectToBuffer:a3];
  }
  else
  {
    int v34 = 0;
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 11)
  {
    v22 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTClientSetupInfo];
    int v23 = [v22 addObjectToBuffer:a3];
  ...
  if ([(FTSpeechTranslationStreamingResponse *)self content_type] == 12)
  {
    uint64_t v25 = [(FTSpeechTranslationStreamingResponse *)self contentAsFTSpeechTranslationServerEndpointFeatures];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTSpeechTranslationStreamingResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
