...
- (id)performRecognitionWithDelegate:(id)a3 requestBuilder:(id)a4 completion:(id)a5
{
  ...
  v14 = -[FTRecognitionStreamingContext initWithGRPCStreamingCallContext:](v13, "initWithGRPCStreamingCallContext:", v12, v16, v17, v18, v19);
...
{
  id v5 = a2;
  id v3 = [[FTRecognitionStreamingResponse alloc] initAndVerifyWithFlatbuffData:v5];
  if (v3)
  {
    if (objc_opt_respondsToSelector()) {
      [*(id *)(a1 + 32) streamDidReceiveRecognitionStreamingResponse:v3];
    }
  }
  else if (objc_opt_respondsToSelector())
  {
    v4 = [MEMORY[0x263F087E8] errorWithDomain:@"Flatbuffers" code:100 userInfo:MEMORY[0x263EFFA78]];
    [*(id *)(a1 + 32) streamFailVerifyRecognitionStreamingResponse:v4];
  }
}
...
void __61__FTAsrService_performErrorBlamer_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTErrorBlamerResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
...
void __53__FTAsrService_performItn_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTItnResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
...
void __67__FTAsrService_performTextNormalization_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTTextNormalizationResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
...
void __63__FTAsrService_performPostItnHammer_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTPostItnHammerResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
...
void __63__FTAsrService_performKeywordFinder_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTKeywordFinderResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
...
void __70__FTAsrService_performCorrectionsValidator_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTCorrectionsValidatorResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
...
void __67__FTAsrService_performGraphemeToPhoneme_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTGraphemeToPhonemeResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
