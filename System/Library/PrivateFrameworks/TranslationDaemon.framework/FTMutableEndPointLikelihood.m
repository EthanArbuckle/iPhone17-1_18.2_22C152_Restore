...
- (FTMutableEndPointLikelihood)init;
- (NSString)return_str;
- (NSString)session_id;
- (NSString)speech_id;
...
@implementation FTMutableEndPointLikelihood

- (FTMutableEndPointLikelihood)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableEndPointLikelihood;
  v2 = [(FTMutableEndPointLikelihood *)&v6 init];
  if (v2)
  {
