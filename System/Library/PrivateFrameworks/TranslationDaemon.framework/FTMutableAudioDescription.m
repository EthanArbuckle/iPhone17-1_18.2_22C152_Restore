...
- (FTMutableAudioDescription)init;
- (double)sample_rate;
...
@implementation FTMutableAudioDescription

- (FTMutableAudioDescription)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableAudioDescription;
  v2 = [(FTMutableAudioDescription *)&v6 init];
  if (v2)
  {
