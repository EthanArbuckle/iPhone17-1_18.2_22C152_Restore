...
- (FTRecognitionPhraseTokensAlternatives)initWithFlatbuffData:(id)a3
{
  return [(FTRecognitionPhraseTokensAlternatives *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRecognitionPhraseTokensAlternatives *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRecognitionPhraseTokensAlternatives)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokensAlternatives *)a4
{
  return [(FTRecognitionPhraseTokensAlternatives *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRecognitionPhraseTokensAlternatives)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokensAlternatives *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTRecognitionPhraseTokensAlternatives *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (NSArray)tok_phrases
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"tok_phrases"];
  if (!v3)
  {
...
- (id)tok_phrases_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"tok_phrases"];
  v6 = v5;
  if (v5)
  {
...
- (void)tok_phrases_enumerateObjectsUsingBlock:(id)a3
{
  ...
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"tok_phrases"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::RecognitionPhraseTokensAlternatives>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTRecognitionPhraseTokensAlternatives *)self tok_phrases];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        int v10 = [*(id *)(*((void *)&v31 + 1) + 8 * i) addObjectToBuffer:a3];
        int v11 = v10;
        std::vector<int>::pointer end = v35.__end_;
        if (v35.__end_ >= v35.__end_cap_.__value_)
        {
          std::vector<int>::pointer begin = v35.__begin_;
          int64_t v15 = v35.__end_ - v35.__begin_;
          unint64_t v16 = v15 + 1;
          if ((unint64_t)(v15 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v17 = (char *)v35.__end_cap_.__value_ - (char *)v35.__begin_;
          ...
          if (v18)
          {
            uint64_t v19 = (char *)std::__allocate_at_least[abi:ne180100]<std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>((uint64_t)&v35.__end_cap_, v18);
            std::vector<int>::pointer begin = v35.__begin_;
            std::vector<int>::pointer end = v35.__end_;
          }
          else
  ...
  if (v35.__end_ == v35.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>> const&)::t;
  }
  else {
    std::vector<int>::pointer v22 = v35.__begin_;
  }
  int v23 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v22, v35.__end_ - v35.__begin_);
  int v24 = [(FTRecognitionPhraseTokensAlternatives *)v30 has_unsuggested_alternatives];
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 6, v24, 0);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRecognitionPhraseTokensAlternatives *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
