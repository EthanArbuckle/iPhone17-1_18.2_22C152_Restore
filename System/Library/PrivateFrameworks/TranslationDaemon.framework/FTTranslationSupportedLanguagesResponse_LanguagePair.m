@interface FTTranslationSupportedLanguagesResponse_LanguagePair
...
- (FTTranslationSupportedLanguagesResponse_LanguagePair)initWithFlatbuffData:(id)a3
{
  return [(FTTranslationSupportedLanguagesResponse_LanguagePair *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTranslationSupportedLanguagesResponse_LanguagePair *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTranslationSupportedLanguagesResponse_LanguagePair)initWithFlatbuffData:(id)a3 root:(const LanguagePair *)a4
{
  return [(FTTranslationSupportedLanguagesResponse_LanguagePair *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTranslationSupportedLanguagesResponse_LanguagePair)initWithFlatbuffData:(id)a3 root:(const LanguagePair *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTTranslationSupportedLanguagesResponse_LanguagePair *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::TranslationSupportedLanguagesResponse_::LanguagePair>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTTranslationSupportedLanguagesResponse_LanguagePair *)self source_locale];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTTranslationSupportedLanguagesResponse_LanguagePair *)self target_locale];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTranslationSupportedLanguagesResponse_LanguagePair *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
