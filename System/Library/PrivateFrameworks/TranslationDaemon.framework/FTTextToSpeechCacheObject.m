...
- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4;
- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4 verify:(BOOL)a5;
...
- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechCacheObject *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechCacheObject *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4
{
  return [(FTTextToSpeechCacheObject *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechCacheObject)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheObject *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechCacheObject;
  v10 = [(FTTextToSpeechCacheObject *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const TextToSpeechCacheObject *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::TextToSpeechCacheObject *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::TextToSpeechCacheObject::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (void)audio:(id)a3
{
  ...
  id v10 = v4;
  (*((void (**)(id, const TextToSpeechCacheObject *, void))v4 + 2))(v4, v9 + 4, *(unsigned int *)root[v7 + v8].var0);
}
...
uint64_t __45__FTTextToSpeechCacheObject_word_timing_info__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::TextToSpeechCacheObject>)addObjectToBuffer:(void *)a3
{
  ...
  v34[1] = 3221225472;
  v34[2] = __47__FTTextToSpeechCacheObject_addObjectToBuffer___block_invoke;
  v34[3] = &unk_265548F40;
  v34[4] = &v35;
  v34[5] = a3;
  [(FTTextToSpeechCacheObject *)self audio:v34];
  memset(&v33, 0, sizeof(v33));
  unint64_t v5 = [(FTTextToSpeechCacheObject *)self word_timing_info];
  ...
  long long v29 = 0u;
  long long v30 = 0u;
  uint64_t v6 = [(FTTextToSpeechCacheObject *)self word_timing_info];
  uint64_t v7 = [v6 countByEnumeratingWithState:&v29 objects:v42 count:16];
  if (v7)
  {
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::WordTimingInfo>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::WordTimingInfo>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::WordTimingInfo>> const&)::t;
  }
  else {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 4, *((_DWORD *)v36 + 12));
  ...
  v27.var0 = apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v24 - (unsigned __int16)v25 + v26);
  if (v33.__begin_)
  {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechCacheObject *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
