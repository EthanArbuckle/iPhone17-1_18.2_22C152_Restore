...
- (FTWebTranslationInfo)initWithFlatbuffData:(id)a3;
- (FTWebTranslationInfo)initWithFlatbuffData:(id)a3 root:(const WebTranslationInfo *)a4;
...
- (FTWebTranslationInfo)initWithFlatbuffData:(id)a3
{
  return [(FTWebTranslationInfo *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTWebTranslationInfo *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTWebTranslationInfo)initWithFlatbuffData:(id)a3 root:(const WebTranslationInfo *)a4
{
  return [(FTWebTranslationInfo *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTWebTranslationInfo)initWithFlatbuffData:(id)a3 root:(const WebTranslationInfo *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTWebTranslationInfo;
  v10 = [(FTWebTranslationInfo *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const WebTranslationInfo *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::WebTranslationInfo *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::WebTranslationInfo::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
uint64_t __29__FTWebTranslationInfo_spans__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::WebTranslationInfo>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTWebTranslationInfo *)self text];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v9 = [(FTWebTranslationInfo *)self spans];
  ...
  if (v38.__end_ == v38.__begin_) {
    std::vector<int>::pointer v26 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTWebTranslationInfo *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
