@interface FTTextToSpeechRequest_ContextInfoEntry
- (FTTextToSpeechRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4;
- (FTTextToSpeechRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4 verify:(BOOL)a5;
- (NSString)key;
- (NSString)value;
...
@implementation FTTextToSpeechRequest_ContextInfoEntry

- (FTTextToSpeechRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRequest_ContextInfoEntry *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRequest_ContextInfoEntry *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4
{
  return [(FTTextToSpeechRequest_ContextInfoEntry *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechRequest_ContextInfoEntry;
  v10 = [(FTTextToSpeechRequest_ContextInfoEntry *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequest_::ContextInfoEntry>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTTextToSpeechRequest_ContextInfoEntry *)self key];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTTextToSpeechRequest_ContextInfoEntry *)self value];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechRequest_ContextInfoEntry *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
