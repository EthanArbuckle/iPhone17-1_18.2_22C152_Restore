...
- (FTTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4;
...
- (FTTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRouterStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRouterStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4
{
  return [(FTTextToSpeechRouterStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTTextToSpeechRouterStreamingStreamingResponse;
  v10 = [(FTTextToSpeechRouterStreamingStreamingResponse *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (FLTBFBufferAccessor)content
{
  int64_t v3 = [(FTTextToSpeechRouterStreamingStreamingResponse *)self content_type];
  switch(v3)
  {
    case 3:
      uint64_t v4 = [(FTTextToSpeechRouterStreamingStreamingResponse *)self contentAsFTFinalTextToSpeechStreamingResponse];
      break;
    case 2:
      uint64_t v4 = [(FTTextToSpeechRouterStreamingStreamingResponse *)self contentAsFTPartialTextToSpeechStreamingResponse];
      break;
    case 1:
      uint64_t v4 = [(FTTextToSpeechRouterStreamingStreamingResponse *)self contentAsFTBeginTextToSpeechStreamingResponse];
      break;
    default:
      uint64_t v4 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTTextToSpeechRouterStreamingStreamingResponse *)self content_type];
  if ([(FTTextToSpeechRouterStreamingStreamingResponse *)self content_type] == 1)
  {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v15- (unsigned __int16)v14+ (unsigned __int16)v13);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechRouterStreamingStreamingResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
