...
- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3;
- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4;
...
- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3
{
  return [(FTPostItnHammerResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTPostItnHammerResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4
{
  return [(FTPostItnHammerResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTPostItnHammerResponse)initWithFlatbuffData:(id)a3 root:(const PostItnHammerResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTPostItnHammerResponse;
  v10 = [(FTPostItnHammerResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const PostItnHammerResponse *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::PostItnHammerResponse *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::PostItnHammerResponse::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
uint64_t __33__FTPostItnHammerResponse_tokens__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::PostItnHammerResponse>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTPostItnHammerResponse *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v15 = [(FTPostItnHammerResponse *)self language];
  uint64_t v16 = v15;
  if (!v15) {
  ...
  int v20 = [(FTPostItnHammerResponse *)self return_code];
  ...
  char v25 = [(FTPostItnHammerResponse *)self tokens];
  ...
  long long v54 = 0u;
  long long v55 = 0u;
  objc_super v26 = [(FTPostItnHammerResponse *)self tokens];
  int v50 = v19;
  int v51 = v20;
  int v52 = v14;
  int v53 = String;
  ...
  if (v58.__end_ == v58.__begin_) {
    std::vector<int>::pointer v42 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTPostItnHammerResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
