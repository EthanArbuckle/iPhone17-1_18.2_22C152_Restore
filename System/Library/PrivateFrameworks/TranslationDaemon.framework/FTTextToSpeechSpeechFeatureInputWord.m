...
- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4;
...
- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechSpeechFeatureInputWord *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechSpeechFeatureInputWord *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4
{
  return [(FTTextToSpeechSpeechFeatureInputWord *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechSpeechFeatureInputWord)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWord *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechSpeechFeatureInputWord;
  v10 = [(FTTextToSpeechSpeechFeatureInputWord *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const TextToSpeechSpeechFeatureInputWord *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
...
uint64_t __48__FTTextToSpeechSpeechFeatureInputWord_phonemes__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTextToSpeechSpeechFeatureInputWord *)self word];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v9 = [(FTTextToSpeechSpeechFeatureInputWord *)self phonemes];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechSpeechFeatureInputWord *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
