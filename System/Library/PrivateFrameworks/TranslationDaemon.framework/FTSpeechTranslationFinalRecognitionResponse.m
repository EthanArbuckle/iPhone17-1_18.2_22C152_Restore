...
- (FTSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationFinalRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationFinalRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationFinalRecognitionResponse *)a4
{
  return [(FTSpeechTranslationFinalRecognitionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTSpeechTranslationFinalRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationFinalRecognitionResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTSpeechTranslationFinalRecognitionResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTSpeechTranslationFinalRecognitionResponse *)self conversation_id];
  v6 = v5;
  if (!v5) {
  ...
  int v15 = [(FTSpeechTranslationFinalRecognitionResponse *)self return_code];
  ...
  objc_super v26 = [(FTSpeechTranslationFinalRecognitionResponse *)self recognition_text];
  v27 = v26;
  if (!v26) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 16, v31);
  return (Offset<siri::speech::schema_fb::SpeechTranslationFinalRecognitionResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v32);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTSpeechTranslationFinalRecognitionResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
