...
- (FTNormalizedTokenVariant)initWithFlatbuffData:(id)a3;
- (FTNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4;
...
- (FTNormalizedTokenVariant)initWithFlatbuffData:(id)a3
{
  return [(FTNormalizedTokenVariant *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTNormalizedTokenVariant *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4
{
  return [(FTNormalizedTokenVariant *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTNormalizedTokenVariant)initWithFlatbuffData:(id)a3 root:(const NormalizedTokenVariant *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTNormalizedTokenVariant;
  v10 = [(FTNormalizedTokenVariant *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const NormalizedTokenVariant *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
...
- (NSArray)normalized_tokens
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"normalized_tokens"];
  if (!v3)
  {
...
uint64_t __45__FTNormalizedTokenVariant_normalized_tokens__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)normalized_tokens_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"normalized_tokens"];
  v6 = v5;
  if (v5)
  {
...
- (void)normalized_tokens_enumerateObjectsUsingBlock:(id)a3
{
  ...
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"normalized_tokens"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::NormalizedTokenVariant>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTNormalizedTokenVariant *)self normalized_tokens];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTNormalizedTokenVariant *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
