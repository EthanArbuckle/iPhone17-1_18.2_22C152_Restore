...
- (id)_ttsVoiceStringWithLocale:()OspreyRequest
{
  ...
  uint64_t v1 = _LTPreferredVoiceTypeForLocale(v0);
...
- (FTMutableSpeechTranslationStreamingRequest)_ospreySpeechTranslationRequestWithHybridEndpointer:()OspreyRequest
{
  ...
  [(FTMutableStartSpeechRequest *)v28 setKeyboard_identifier:&stru_270C008E8];
  [(FTMutableStartSpeechRequest *)v28 setInput_origin:&stru_270C008E8];
...
- (id)sequoiaClientHeaderValue
{
  ...
  uint32_t v3 = arc4random_uniform(0xAu);
  id v4 = [a1 appIdentifier];
  v5 = [a1 clientIdentifier];
  if (v4 && v3)
  {
    uint64_t v6 = [a1 redactIfNeeded:v4];

    id v4 = (void *)v6;
  }
  if (v5 && v3)
  {
    uint64_t v7 = [a1 redactIfNeeded:v5];
  ...
  v14 = [NSString stringWithString:v2];
...
- (void)_ospreySpeechTranslationRequestWithHybridEndpointer:()OspreyRequest .cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_0_10(&dword_2600DC000, v3, v4, "Disambiguation: Creating FTMutableTranslationRequest as part of online speech translation request (with ASR input), setting option enable_disambiguation_alternatives: %{BOOL}i", v5, v6, v7, v8, v9);
}
...
- (void)_ospreySpeechTranslationRequestWithHybridEndpointer:()OspreyRequest .cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_1_9();
  OUTLINED_FUNCTION_1_8();
  OUTLINED_FUNCTION_0_10(&dword_2600DC000, v3, v4, "Disambiguation: Creating online speech translation request (with ASR input), setting option enable_disambiguation_alternatives: %{BOOL}i", v5, v6, v7, v8, v9);
}
...
- (void)_ospreyTextToSpeechTranslationRequestWithText:()OspreyRequest .cold.1(void *a1)
{
  ...
  OUTLINED_FUNCTION_1_9();
  OUTLINED_FUNCTION_1_8();
  OUTLINED_FUNCTION_0_10(&dword_2600DC000, v3, v4, "Disambiguation: Creating online FTMutableTranslationRequest as part of text-based speech translation request, setting  option enable_disambiguation_alternatives: %{BOOL}i", v5, v6, v7, v8, v9);
}
...
- (void)_ospreyTextToSpeechTranslationRequestWithText:()OspreyRequest .cold.2(void *a1)
{
  ...
  OUTLINED_FUNCTION_1_9();
  OUTLINED_FUNCTION_1_8();
  OUTLINED_FUNCTION_0_10(&dword_2600DC000, v3, v4, "Disambiguation: Creating online speech translation request text-based input, setting option for enable_disambiguation_alternatives: %{BOOL}i", v5, v6, v7, v8, v9);
}
