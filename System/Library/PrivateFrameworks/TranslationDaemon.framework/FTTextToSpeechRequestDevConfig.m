...
- (FTTextToSpeechRequestDevConfig)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechRequestDevConfig)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestDevConfig *)a4;
...
- (FTTextToSpeechRequestDevConfig)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRequestDevConfig *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechRequestDevConfig *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechRequestDevConfig)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestDevConfig *)a4
{
  return [(FTTextToSpeechRequestDevConfig *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechRequestDevConfig)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRequestDevConfig *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechRequestDevConfig;
  v10 = [(FTTextToSpeechRequestDevConfig *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!siri::speech::schema_fb::TextToSpeechRequestDevConfig::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestDevConfig>)addObjectToBuffer:(void *)a3
{
  int v5 = [(FTTextToSpeechRequestDevConfig *)self return_log];
  ...
  int v15 = [(FTTextToSpeechRequestDevConfig *)self return_server_info];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechRequestDevConfig *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
