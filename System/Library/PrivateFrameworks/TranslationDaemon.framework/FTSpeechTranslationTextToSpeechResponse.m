...
- (FTSpeechTranslationTextToSpeechResponse)initWithFlatbuffData:(id)a3;
- (FTSpeechTranslationTextToSpeechResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationTextToSpeechResponse *)a4;
...
- (FTSpeechTranslationTextToSpeechResponse)initWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationTextToSpeechResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationTextToSpeechResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTSpeechTranslationTextToSpeechResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationTextToSpeechResponse *)a4
{
  return [(FTSpeechTranslationTextToSpeechResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTSpeechTranslationTextToSpeechResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationTextToSpeechResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTSpeechTranslationTextToSpeechResponse;
  v10 = [(FTSpeechTranslationTextToSpeechResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const SpeechTranslationTextToSpeechResponse *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::SpeechTranslationTextToSpeechResponse *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::SpeechTranslationTextToSpeechResponse::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22))LABEL_14:v20 = 0; {
  else
  }
LABEL_13:
    v20 = v10;
...
- (FTTextToSpeechResponse)text_to_speech_response
{
  uint64_t v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"text_to_speech_response"];
  if (!v3)
  {
...
- (Offset<siri::speech::schema_fb::SpeechTranslationTextToSpeechResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTSpeechTranslationTextToSpeechResponse *)self conversation_id];
  v6 = v5;
  if (!v5) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::SpeechTranslationTextToSpeechResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v21);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTSpeechTranslationTextToSpeechResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__55__FTSpeechTranslationTextToSpeechResponse_flatbuffData__block_invoke(uint64_t a1)
{
