...
- (FTMutableAsrPostItnHammerMessage)init;
...
- (void)setSession_messageAsFTPostItnHammerRequest:(id)a3;
- (void)setSession_messageAsFTPostItnHammerResponse:(id)a3;
- (void)setSession_message_type:(int64_t)a3;
@end

@implementation FTMutableAsrPostItnHammerMessage

- (FTMutableAsrPostItnHammerMessage)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableAsrPostItnHammerMessage;
  v2 = [(FTMutableAsrPostItnHammerMessage *)&v6 init];
  if (v2)
  {
...
- (FTPostItnHammerRequest)session_messageAsFTPostItnHammerRequest
{
  if ([(FTMutableAsrPostItnHammerMessage *)self session_message_type] == 1)
  {
  ...
  return (FTPostItnHammerRequest *)v3;
}

- (void)setSession_messageAsFTPostItnHammerRequest:(id)a3
{
  id v5 = a3;
  [(FTMutableAsrPostItnHammerMessage *)self setSession_message_type:1];
  id v4 = (void *)[v5 copy];
...
- (FTPostItnHammerResponse)session_messageAsFTPostItnHammerResponse
{
  if ([(FTMutableAsrPostItnHammerMessage *)self session_message_type] == 2)
  {
    int64_t v3 = [(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"session_message"];
  }
  else
  ...
  return (FTPostItnHammerResponse *)v3;
}

- (void)setSession_messageAsFTPostItnHammerResponse:(id)a3
{
  id v5 = a3;
  [(FTMutableAsrPostItnHammerMessage *)self setSession_message_type:2];
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"session_message"];
}
...
{
  id v5 = a3;
  -[FTMutableAsrPostItnHammerMessage setSession_message_type:](self, "setSession_message_type:", objc_msgSend((id)objc_opt_class(), "session_message_typeForObject:", v5));
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"session_message"];
}
