...
- (FTRecognitionChoice)initWithFlatbuffData:(id)a3
{
  return [(FTRecognitionChoice *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRecognitionChoice *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRecognitionChoice)initWithFlatbuffData:(id)a3 root:(const RecognitionChoice *)a4
{
  return [(FTRecognitionChoice *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRecognitionChoice)initWithFlatbuffData:(id)a3 root:(const RecognitionChoice *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTRecognitionChoice *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (NSArray)alternative_index
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"alternative_index"];
  if (!v3)
  {
...
- (id)alternative_index_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"alternative_index"];
  v6 = v5;
  if (v5)
  {
...
- (void)alternative_index_enumerateObjectsUsingBlock:(id)a3
{
  ...
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"alternative_index"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::RecognitionChoice>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTRecognitionChoice *)self alternative_index];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        int v10 = [*(id *)(*((void *)&v31 + 1) + 8 * i) intValue];
        int v11 = v10;
  ...
  int v23 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<int>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v22, v35.__end_ - v35.__begin_);
  int v24 = [(FTRecognitionChoice *)v30 confidence];
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>(a3, 6, v24, 0);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRecognitionChoice *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
