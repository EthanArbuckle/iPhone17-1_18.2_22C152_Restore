...
- (void)setSession_messageAsFTTranslationRequest:(id)a3;
- (void)setSession_messageAsFTTranslationResponse:(id)a3;
...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableMtTranslationMessage;
...
- (FTTranslationRequest)session_messageAsFTTranslationRequest
{
  ...
  return (FTTranslationRequest *)v3;
}
...
- (FTTranslationResponse)session_messageAsFTTranslationResponse
{
  ...
  return (FTTranslationResponse *)v3;
}
...
{
  id v5 = a3;
  -[FTMutableMtTranslationMessage setSession_message_type:](self, "setSession_message_type:", objc_msgSend((id)objc_opt_class(), "session_message_typeForObject:", v5));
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"session_message"];
}
