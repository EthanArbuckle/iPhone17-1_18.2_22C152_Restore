...
- (FTRecognitionSausage)initWithFlatbuffData:(id)a3;
- (FTRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4;
- (FTRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4 verify:(BOOL)a5;
- (NSArray)positional_tok_phrase_alt;
- (Offset<siri::speech::schema_fb::RecognitionSausage>)addObjectToBuffer:(void *)a3;
- (id)flatbuffData;
...
- (FTRecognitionSausage)initWithFlatbuffData:(id)a3
{
  return [(FTRecognitionSausage *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRecognitionSausage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4
{
  return [(FTRecognitionSausage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRecognitionSausage)initWithFlatbuffData:(id)a3 root:(const RecognitionSausage *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTRecognitionSausage;
  v10 = [(FTRecognitionSausage *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const RecognitionSausage *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
...
uint64_t __49__FTRecognitionSausage_positional_tok_phrase_alt__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::RecognitionSausage>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTRecognitionSausage *)self positional_tok_phrase_alt];
  ...
  long long v29 = 0u;
  long long v30 = 0u;
  v6 = [(FTRecognitionSausage *)self positional_tok_phrase_alt];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRecognitionSausage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
