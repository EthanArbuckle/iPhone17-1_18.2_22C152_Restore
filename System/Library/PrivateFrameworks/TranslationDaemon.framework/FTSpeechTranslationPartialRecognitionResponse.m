...
- (FTSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationPartialRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationPartialRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationPartialRecognitionResponse *)a4
{
  return [(FTSpeechTranslationPartialRecognitionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTSpeechTranslationPartialRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationPartialRecognitionResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTSpeechTranslationPartialRecognitionResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::SpeechTranslationPartialRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTSpeechTranslationPartialRecognitionResponse *)self conversation_id];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTSpeechTranslationPartialRecognitionResponse *)self request_id];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  int v15 = [(FTSpeechTranslationPartialRecognitionResponse *)self return_code];
  v16 = [(FTSpeechTranslationPartialRecognitionResponse *)self return_str];
  uint64_t v17 = v16;
  if (!v16) {
    v16 = &stru_270C008E8;
  }
  ...
  v21 = [(FTSpeechTranslationPartialRecognitionResponse *)self source_locale];
  v22 = v21;
  if (!v21) {
    v21 = &stru_270C008E8;
  }
  ...
  objc_super v26 = [(FTSpeechTranslationPartialRecognitionResponse *)self recognition_text];
  v27 = v26;
  if (!v26) {
  ...
  int v30 = [(FTSpeechTranslationPartialRecognitionResponse *)self confidence];
  int v31 = [(FTSpeechTranslationPartialRecognitionResponse *)self is_stable_result];
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 14, (int)v28);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>(a3, 16, v30, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 18, v31, 0);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTSpeechTranslationPartialRecognitionResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
