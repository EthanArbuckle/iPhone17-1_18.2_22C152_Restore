...
- (FTTextToSpeechSpeechFeatureInputWave)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechSpeechFeatureInputWave *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechSpeechFeatureInputWave *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechSpeechFeatureInputWave)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWave *)a4
{
  return [(FTTextToSpeechSpeechFeatureInputWave *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechSpeechFeatureInputWave)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputWave *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTTextToSpeechSpeechFeatureInputWave *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
{
  id v4 = self;
  int v5 = [(FTTextToSpeechSpeechFeatureInputWave *)self sample_rate];
  uint64_t v10 = 0;
  v11 = &v10;
  ...
  v9[4] = &v10;
  v9[5] = a3;
  [(FTTextToSpeechSpeechFeatureInputWave *)v4 pcm_data:v9];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechSpeechFeatureInputWave *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
