...
- (FTPartialTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(FTPartialTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTPartialTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTPartialTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PartialTextToSpeechStreamingResponse *)a4
{
  return [(FTPartialTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTPartialTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PartialTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTPartialTextToSpeechStreamingResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::PartialTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTPartialTextToSpeechStreamingResponse *)self speech_id];
  uint64_t v6 = v5;
  if (!v5) {
  ...
  id v10 = [(FTPartialTextToSpeechStreamingResponse *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
  ...
  int v53 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v12, v13);

  int v14 = [(FTPartialTextToSpeechStreamingResponse *)self error_code];
  uint64_t v15 = [(FTPartialTextToSpeechStreamingResponse *)self error_str];
  uint64_t v16 = v15;
  if (!v15) {
  ...
  int v52 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v17, v18);

  uint64_t v19 = [(FTPartialTextToSpeechStreamingResponse *)self stream_id];
  unsigned __int8 v20 = v19;
  if (!v19) {
    uint64_t v19 = &stru_270C008E8;
  }
  v21 = (const char *)[(__CFString *)v19 UTF8String];
  size_t v22 = strlen(v21);
  int v49 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v21, v22);

  int v48 = [(FTPartialTextToSpeechStreamingResponse *)self current_pkt_number];
  uint64_t v60 = 0;
  v61 = &v60;
  ...
  v59[4] = &v60;
  v59[5] = a3;
  [(FTPartialTextToSpeechStreamingResponse *)self audio:v59];
  memset(&v58, 0, sizeof(v58));
  long long v23 = [(FTPartialTextToSpeechStreamingResponse *)self word_timing_info];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v58, [v23 count]);

  long long v56 = 0u;
  long long v57 = 0u;
  long long v54 = 0u;
  long long v55 = 0u;
  uint64_t v24 = [(FTPartialTextToSpeechStreamingResponse *)self word_timing_info];
  int v50 = String;
  v51 = self;
  ...
  if (v25)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v25; ++i)
      {
        ...
        int v28 = [*(id *)(*((void *)&v54 + 1) + 8 * i) addObjectToBuffer:a3];
        int v29 = v28;
        std::vector<int>::pointer end = v58.__end_;
        if (v58.__end_ >= v58.__end_cap_.__value_)
        {
          std::vector<int>::pointer begin = v58.__begin_;
          int64_t v33 = v58.__end_ - v58.__begin_;
          unint64_t v34 = v33 + 1;
          if ((unint64_t)(v33 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v35 = (char *)v58.__end_cap_.__value_ - (char *)v58.__begin_;
  ...
  if (v58.__end_ == v58.__begin_) {
    ...
    std::vector<int>::pointer v40 = v58.__begin_;
  }
  int v41 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v40, v58.__end_ - v58.__begin_);
  v42 = [(FTPartialTextToSpeechStreamingResponse *)v51 feature];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 4, v50);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>(a3, 8, v14, 0);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>(a3, 14, v48, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 16, *((_DWORD *)v61 + 12));
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 18, v41);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 20, v43);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTPartialTextToSpeechStreamingResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
