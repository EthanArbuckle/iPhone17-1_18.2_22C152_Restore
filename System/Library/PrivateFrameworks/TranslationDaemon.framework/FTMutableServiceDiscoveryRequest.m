...
- (FTMutableServiceDiscoveryRequest)init;
- (NSString)app_id;
- (NSString)session_id;
- (NSString)zk_path;
...
@implementation FTMutableServiceDiscoveryRequest

- (FTMutableServiceDiscoveryRequest)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableServiceDiscoveryRequest;
  v2 = [(FTMutableServiceDiscoveryRequest *)&v6 init];
  if (v2)
  {
