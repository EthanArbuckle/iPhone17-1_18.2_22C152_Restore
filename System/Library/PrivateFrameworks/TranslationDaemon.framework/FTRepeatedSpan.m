@interface FTRepeatedSpan
- (FTRepeatedSpan)initWithFlatbuffData:(id)a3;
- (FTRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4;
- (FTRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4 verify:(BOOL)a5;
- (NSArray)span;
- (Offset<siri::speech::schema_fb::RepeatedSpan>)addObjectToBuffer:(void *)a3;
- (id)flatbuffData;
...
@implementation FTRepeatedSpan

- (FTRepeatedSpan)initWithFlatbuffData:(id)a3
{
  return [(FTRepeatedSpan *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRepeatedSpan *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4
{
  return [(FTRepeatedSpan *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRepeatedSpan)initWithFlatbuffData:(id)a3 root:(const RepeatedSpan *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTRepeatedSpan;
  v10 = [(FTRepeatedSpan *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::RepeatedSpan *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::RepeatedSpan::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)span
{
  ...
  if (!v3)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __22__FTRepeatedSpan_span__block_invoke;
    v6[3] = &unk_265548F68;
    id v3 = v4;
    id v7 = v3;
    [(FTRepeatedSpan *)self span_enumerateObjectsUsingBlock:v6];
    [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"span"];
  }
  return (NSArray *)v3;
}

uint64_t __22__FTRepeatedSpan_span__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)span_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"span"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::RepeatedSpan>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTRepeatedSpan *)self span];
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::Span>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRepeatedSpan *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__30__FTRepeatedSpan_flatbuffData__block_invoke(uint64_t a1)
{
