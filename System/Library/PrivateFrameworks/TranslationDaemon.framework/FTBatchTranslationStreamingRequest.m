...
- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3;
- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4;
...
- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3
{
  return [(FTBatchTranslationStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTBatchTranslationStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4
{
  return [(FTBatchTranslationStreamingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTBatchTranslationStreamingRequest)initWithFlatbuffData:(id)a3 root:(const BatchTranslationStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTBatchTranslationStreamingRequest;
  v10 = [(FTBatchTranslationStreamingRequest *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::BatchTranslationStreamingRequest *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::BatchTranslationStreamingRequest::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (FLTBFBufferAccessor)content
{
  switch([(FTBatchTranslationStreamingRequest *)self content_type])
  {
    case 1:
      v3 = [(FTBatchTranslationStreamingRequest *)self contentAsFTBatchTranslationRequest];
      break;
    case 2:
      v3 = [(FTBatchTranslationStreamingRequest *)self contentAsFTBatchTranslationFeedbackRequest];
      break;
    case 3:
      v3 = [(FTBatchTranslationStreamingRequest *)self contentAsFTBatchTranslationLoggingRequest];
      break;
    case 4:
      v3 = [(FTBatchTranslationStreamingRequest *)self contentAsFTTranslationSupportedLanguagesRequest];
      break;
    default:
      v3 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::BatchTranslationStreamingRequest>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTBatchTranslationStreamingRequest *)self content_type];
  if ([(FTBatchTranslationStreamingRequest *)self content_type] == 1)
  {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::BatchTranslationStreamingRequest>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v17- (unsigned __int16)v16+ (unsigned __int16)v15);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTBatchTranslationStreamingRequest *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
