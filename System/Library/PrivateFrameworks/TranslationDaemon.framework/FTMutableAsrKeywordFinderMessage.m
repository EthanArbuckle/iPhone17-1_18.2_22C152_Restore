...
- (void)setSession_messageAsFTKeywordFinderRequest:(id)a3;
- (void)setSession_messageAsFTKeywordFinderResponse:(id)a3;
...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableAsrKeywordFinderMessage;
...
- (FTKeywordFinderRequest)session_messageAsFTKeywordFinderRequest
{
  ...
  return (FTKeywordFinderRequest *)v3;
}
...
- (FTKeywordFinderResponse)session_messageAsFTKeywordFinderResponse
{
  ...
  return (FTKeywordFinderResponse *)v3;
}
...
{
  id v5 = a3;
  -[FTMutableAsrKeywordFinderMessage setSession_message_type:](self, "setSession_message_type:", objc_msgSend((id)objc_opt_class(), "session_message_typeForObject:", v5));
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"session_message"];
}
