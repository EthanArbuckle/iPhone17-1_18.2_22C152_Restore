...
- (FTCreateLanguageProfileResponse)initWithFlatbuffData:(id)a3
{
  return [(FTCreateLanguageProfileResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTCreateLanguageProfileResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTCreateLanguageProfileResponse)initWithFlatbuffData:(id)a3 root:(const CreateLanguageProfileResponse *)a4
{
  return [(FTCreateLanguageProfileResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTCreateLanguageProfileResponse)initWithFlatbuffData:(id)a3 root:(const CreateLanguageProfileResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTCreateLanguageProfileResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::CreateLanguageProfileResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTCreateLanguageProfileResponse *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  int v15 = [(FTCreateLanguageProfileResponse *)self error_code];
  ...
  int v22 = [(FTCreateLanguageProfileResponse *)self incomplete_profile];
  int v23 = [(FTCreateLanguageProfileResponse *)self recreate_apg_prons];
  *((unsigned char *)a3 + 70) = 1;
  int v24 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 14, v22, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 16, v23, 0);
  return (Offset<siri::speech::schema_fb::CreateLanguageProfileResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v24);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTCreateLanguageProfileResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
