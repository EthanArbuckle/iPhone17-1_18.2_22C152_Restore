...
- (FTMutableCreateLanguageProfileRequest)init;
...
@implementation FTMutableCreateLanguageProfileRequest

- (FTMutableCreateLanguageProfileRequest)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableCreateLanguageProfileRequest;
  v2 = [(FTMutableCreateLanguageProfileRequest *)&v6 init];
  if (v2)
  {
