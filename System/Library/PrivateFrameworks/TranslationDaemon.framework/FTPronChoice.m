...
- (FTPronChoice)initWithFlatbuffData:(id)a3;
- (FTPronChoice)initWithFlatbuffData:(id)a3 root:(const PronChoice *)a4;
- (FTPronChoice)initWithFlatbuffData:(id)a3 root:(const PronChoice *)a4 verify:(BOOL)a5;
...
- (FTPronChoice)initWithFlatbuffData:(id)a3
{
  return [(FTPronChoice *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTPronChoice *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTPronChoice)initWithFlatbuffData:(id)a3 root:(const PronChoice *)a4
{
  return [(FTPronChoice *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTPronChoice)initWithFlatbuffData:(id)a3 root:(const PronChoice *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTPronChoice;
  v10 = [(FTPronChoice *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::PronChoice>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTPronChoice *)self pron_sequence];
  v6 = v5;
  if (!v5) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::PronChoice>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v11);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTPronChoice *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
