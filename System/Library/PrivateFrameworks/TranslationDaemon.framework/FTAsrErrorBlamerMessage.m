...
- (FTAsrErrorBlamerMessage)initWithFlatbuffData:(id)a3;
- (FTAsrErrorBlamerMessage)initWithFlatbuffData:(id)a3 root:(const AsrErrorBlamerMessage *)a4;
...
- (FTAsrErrorBlamerMessage)initWithFlatbuffData:(id)a3
{
  return [(FTAsrErrorBlamerMessage *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTAsrErrorBlamerMessage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTAsrErrorBlamerMessage)initWithFlatbuffData:(id)a3 root:(const AsrErrorBlamerMessage *)a4
{
  return [(FTAsrErrorBlamerMessage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTAsrErrorBlamerMessage)initWithFlatbuffData:(id)a3 root:(const AsrErrorBlamerMessage *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTAsrErrorBlamerMessage;
  v10 = [(FTAsrErrorBlamerMessage *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const AsrErrorBlamerMessage *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::AsrErrorBlamerMessage *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::AsrErrorBlamerMessage::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (FTErrorBlamerRequest)session_messageAsFTErrorBlamerRequest
{
  if ([(FTAsrErrorBlamerMessage *)self session_message_type] == 1)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTErrorBlamerRequest alloc];
      root = self->_root;
...
- (FTErrorBlamerResponse)session_messageAsFTErrorBlamerResponse
{
  if ([(FTAsrErrorBlamerMessage *)self session_message_type] == 2)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTErrorBlamerResponse alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (uint64_t v7 = *(unsigned __int16 *)v6[6].var0) != 0) {
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
...
- (FLTBFBufferAccessor)session_message
{
  int64_t v3 = [(FTAsrErrorBlamerMessage *)self session_message_type];
  if (v3 == 2)
  {
    uint64_t v4 = [(FTAsrErrorBlamerMessage *)self session_messageAsFTErrorBlamerResponse];
  }
  else if (v3 == 1)
  {
    uint64_t v4 = [(FTAsrErrorBlamerMessage *)self session_messageAsFTErrorBlamerRequest];
  }
  else
  {
    uint64_t v4 = 0;
...
- (Offset<siri::speech::qss_fb::AsrErrorBlamerMessage>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTAsrErrorBlamerMessage *)self session_message_type];
  if ([(FTAsrErrorBlamerMessage *)self session_message_type] == 1)
  {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::AsrErrorBlamerMessage>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v13- (unsigned __int16)v12+ (unsigned __int16)v11);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTAsrErrorBlamerMessage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
