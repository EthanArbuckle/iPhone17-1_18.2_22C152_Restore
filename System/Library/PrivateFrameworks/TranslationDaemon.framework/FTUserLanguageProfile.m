...
- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3;
- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4;
...
- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3
{
  return [(FTUserLanguageProfile *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTUserLanguageProfile *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4
{
  return [(FTUserLanguageProfile *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTUserLanguageProfile)initWithFlatbuffData:(id)a3 root:(const UserLanguageProfile *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTUserLanguageProfile;
  v10 = [(FTUserLanguageProfile *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const UserLanguageProfile *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::UserLanguageProfile *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::UserLanguageProfile::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (void)profile_blob:(id)a3
{
  ...
  id v10 = v4;
  (*((void (**)(id, const UserLanguageProfile *, void))v4 + 2))(v4, v9 + 4, *(unsigned int *)root[v7 + v8].var0);
}
...
- (Offset<siri::speech::schema_fb::UserLanguageProfile>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(FTUserLanguageProfile *)self profile_blob_version];
  uint64_t v6 = v5;
  if (!v5) {
  ...
  id v10 = [(FTUserLanguageProfile *)self profile_checksum];
  v11 = v10;
  if (!v10) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 4, *((_DWORD *)v21 + 12));
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTUserLanguageProfile *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
