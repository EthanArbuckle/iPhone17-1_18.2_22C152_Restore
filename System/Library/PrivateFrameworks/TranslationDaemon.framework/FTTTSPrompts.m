...
- (FTTTSPrompts)initWithFlatbuffData:(id)a3
{
  return [(FTTTSPrompts *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTTSPrompts *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTTSPrompts)initWithFlatbuffData:(id)a3 root:(const TTSPrompts *)a4
{
  return [(FTTTSPrompts *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (id)prompts_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"prompts"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::TTSPrompts>)addObjectToBuffer:(void *)a3
{
  ...
  id v4 = [(FTTTSPrompts *)self prompts];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v43, [v4 count]);

  long long v41 = 0u;
  long long v42 = 0u;
  long long v39 = 0u;
  long long v40 = 0u;
  uint64_t v5 = [(FTTTSPrompts *)self prompts];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        uint64_t v9 = (const char *)[*(id *)(*((void *)&v39 + 1) + 8 * i) UTF8String];
        ...
        if (v43.__end_ >= v43.__end_cap_.__value_)
        {
          ...
          int64_t v16 = v43.__end_ - v43.__begin_;
          unint64_t v17 = v16 + 1;
          if ((unint64_t)(v16 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v18 = (char *)v43.__end_cap_.__value_ - (char *)v43.__begin_;
  ...
  if (v43.__end_ == v43.__begin_) {
    ...
    std::vector<int>::pointer v23 = v43.__begin_;
  }
  int v24 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v23, v43.__end_ - v43.__begin_);
  uint64_t v32 = 0;
  v33 = &v32;
  ...
  v31[4] = &v32;
  v31[5] = a3;
  [(FTTTSPrompts *)self prompts_v2:v31];
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 6, *((_DWORD *)v33 + 12));
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTTSPrompts *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
