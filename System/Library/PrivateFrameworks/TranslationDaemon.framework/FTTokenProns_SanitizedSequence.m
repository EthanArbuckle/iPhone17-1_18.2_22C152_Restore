...
- (FTTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3;
- (FTTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4;
...
- (FTTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3
{
  return [(FTTokenProns_SanitizedSequence *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTokenProns_SanitizedSequence *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4
{
  return [(FTTokenProns_SanitizedSequence *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTokenProns_SanitizedSequence)initWithFlatbuffData:(id)a3 root:(const SanitizedSequence *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTokenProns_SanitizedSequence;
  v10 = [(FTTokenProns_SanitizedSequence *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const SanitizedSequence *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::TokenProns_::SanitizedSequence *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::TokenProns_::SanitizedSequence::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)sanitized_tokens
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"sanitized_tokens"];
  if (!v3)
  {
...
- (id)sanitized_tokens_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"sanitized_tokens"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTSanitizedPronToken alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)sanitized_tokens_enumerateObjectsUsingBlock:(id)a3
{
  v4 = (void (**)(id, FTSanitizedPronToken *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"sanitized_tokens"];
  v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTSanitizedPronToken alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::TokenProns_::SanitizedSequence>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTokenProns_SanitizedSequence *)self sanitized_tokens];
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::SanitizedPronToken>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::SanitizedPronToken>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::SanitizedPronToken>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTokenProns_SanitizedSequence *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
