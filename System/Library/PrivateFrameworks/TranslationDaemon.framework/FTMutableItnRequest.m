...
@implementation FTMutableItnRequest

- (FTMutableItnRequest)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableItnRequest;
  v2 = [(FTMutableItnRequest *)&v6 init];
  if (v2)
  {
...
- (NSArray)words_list
{
  return (NSArray *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"words_list"];
}
