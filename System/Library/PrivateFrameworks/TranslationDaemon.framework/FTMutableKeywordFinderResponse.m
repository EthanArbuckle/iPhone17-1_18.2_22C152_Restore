...
- (FTMutableKeywordFinderResponse)init
{
  ...
  v2 = [(FTMutableKeywordFinderResponse *)&v6 init];
  if (v2)
  {
...
- (FTRecognitionSausage)corrected_sausage
{
  return (FTRecognitionSausage *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"corrected_sausage"];
}
