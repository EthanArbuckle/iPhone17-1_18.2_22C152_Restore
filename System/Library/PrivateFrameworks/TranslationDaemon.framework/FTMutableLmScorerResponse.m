...
- (FTMutableLmScorerResponse)init;
- (NSArray)tokens;
- (NSString)return_str;
- (double)ppl;
- (id)copyWithZone:(_NSZone *)a3;
- (int)return_code;
- (void)setPpl:(double)a3;
- (void)setReturn_code:(int)a3;
- (void)setReturn_str:(id)a3;
- (void)setTokens:(id)a3;
@end

@implementation FTMutableLmScorerResponse

- (FTMutableLmScorerResponse)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableLmScorerResponse;
  v2 = [(FTMutableLmScorerResponse *)&v6 init];
  if (v2)
  {
