...
- (FTTextToSpeechCacheContainerStreamingV2)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechCacheContainerStreamingV2 *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechCacheContainerStreamingV2 *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechCacheContainerStreamingV2)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheContainerStreamingV2 *)a4
{
  return [(FTTextToSpeechCacheContainerStreamingV2 *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechCacheContainerStreamingV2)initWithFlatbuffData:(id)a3 root:(const TextToSpeechCacheContainerStreamingV2 *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTTextToSpeechCacheContainerStreamingV2 *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (FTStartTextToSpeechStreamingRequest)cached_request
{
  uint64_t v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"cached_request"];
  if (!v3)
  {
    ...
    uint64_t v3 = [(FTStartTextToSpeechStreamingRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (FTBeginTextToSpeechStreamingResponse)cached_begin_response
{
  uint64_t v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"cached_begin_response"];
  if (!v3)
  {
    ...
    uint64_t v3 = [(FTBeginTextToSpeechStreamingResponse *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (NSArray)cached_partial_response
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"cached_partial_response"];
  if (!v3)
  {
...
- (id)cached_partial_response_objectAtIndex:(unint64_t)a3
{
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"cached_partial_response"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 0xBu)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTPartialTextToSpeechStreamingResponse alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)cached_partial_response_enumerateObjectsUsingBlock:(id)a3
{
  uint64_t v4 = (void (**)(id, FTPartialTextToSpeechStreamingResponse *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"cached_partial_response"];
  v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 0xBu)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTPartialTextToSpeechStreamingResponse alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (FTFinalTextToSpeechStreamingResponse)cached_final_response
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"cached_final_response"];
  if (!v3)
  {
    ...
    id v3 = [(FTFinalTextToSpeechStreamingResponse *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (Offset<siri::speech::schema_fb::TextToSpeechCacheContainerStreamingV2>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTextToSpeechCacheContainerStreamingV2 *)self original_session_id];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v9 = [(FTTextToSpeechCacheContainerStreamingV2 *)self cached_request];
  int v10 = [v9 addObjectToBuffer:a3];

  uint64_t v11 = [(FTTextToSpeechCacheContainerStreamingV2 *)self cached_begin_response];
  LODWORD(v9) = [v11 addObjectToBuffer:a3];

  memset(&v46, 0, sizeof(v46));
  uint64_t v12 = [(FTTextToSpeechCacheContainerStreamingV2 *)self cached_partial_response];
  int v38 = (int)v9;
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v46, [v12 count]);

  long long v44 = 0u;
  long long v45 = 0u;
  long long v42 = 0u;
  long long v43 = 0u;
  uint64_t v13 = [(FTTextToSpeechCacheContainerStreamingV2 *)self cached_partial_response];
  int v39 = v10;
  int v40 = (int)v7;
  v41 = self;
    ...
    do
    {
      for (uint64_t i = 0; i != v14; ++i)
      {
        ...
        if (v46.__end_ >= v46.__end_cap_.__value_)
        {
          ...
          int64_t v22 = v46.__end_ - v46.__begin_;
          unint64_t v23 = v22 + 1;
          if ((unint64_t)(v22 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v24 = (char *)v46.__end_cap_.__value_ - (char *)v46.__begin_;
          ...
          if (v25)
          {
            objc_super v26 = (char *)std::__allocate_at_least[abi:ne180100]<std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>((uint64_t)&v46.__end_cap_, v25);
            std::vector<int>::pointer begin = v46.__begin_;
            std::vector<int>::pointer end = v46.__end_;
          }
          else
  ...
  if (v46.__end_ == v46.__begin_) {
    std::vector<int>::pointer v29 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::PartialTextToSpeechStreamingResponse>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::PartialTextToSpeechStreamingResponse>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::PartialTextToSpeechStreamingResponse>> const&)::t;
  }
  else {
    std::vector<int>::pointer v29 = v46.__begin_;
  }
  int v30 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v29, v46.__end_ - v46.__begin_);
  v31 = [(FTTextToSpeechCacheContainerStreamingV2 *)v41 cached_final_response];
  int v32 = [v31 addObjectToBuffer:a3];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 10, v30);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 12, v32);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechCacheContainerStreamingV2 *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
