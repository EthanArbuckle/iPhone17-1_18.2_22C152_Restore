...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutablePartialTextToSpeechStreamingResponse;
...
- (void)audio:(id)a3
{
  ...
  id v4 = [(FTMutablePartialTextToSpeechStreamingResponse *)self audio];
  uint64_t v5 = [v4 bytes];
  objc_super v6 = [(FTMutablePartialTextToSpeechStreamingResponse *)self audio];
