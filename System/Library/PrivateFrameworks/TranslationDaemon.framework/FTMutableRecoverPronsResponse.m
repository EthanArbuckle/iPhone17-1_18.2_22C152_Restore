...
@implementation FTMutableRecoverPronsResponse

- (FTMutableRecoverPronsResponse)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableRecoverPronsResponse;
  v2 = [(FTMutableRecoverPronsResponse *)&v6 init];
  if (v2)
  {
...
- (NSArray)recovery_return_codes
{
  return (NSArray *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"recovery_return_codes"];
}
...
- (NSArray)voc_tokens
{
  return (NSArray *)[(NSMutableDictionary *)self->super._storage objectForKeyedSubscript:@"voc_tokens"];
}
