...
- (FTRecognitionToken)initWithFlatbuffData:(id)a3
{
  return [(FTRecognitionToken *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRecognitionToken *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRecognitionToken)initWithFlatbuffData:(id)a3 root:(const RecognitionToken *)a4
{
  return [(FTRecognitionToken *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRecognitionToken)initWithFlatbuffData:(id)a3 root:(const RecognitionToken *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTRecognitionToken *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::RecognitionToken>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTRecognitionToken *)self token_text];
  v6 = v5;
  if (!v5) {
  ...
  int v10 = [(FTRecognitionToken *)self start_milli_seconds];
  int v11 = [(FTRecognitionToken *)self end_milli_seconds];
  int v12 = [(FTRecognitionToken *)self silence_start_milli_seconds];
  int v13 = [(FTRecognitionToken *)self confidence];
  int v25 = [(FTRecognitionToken *)self add_space_after];
  uint64_t v14 = [(FTRecognitionToken *)self phone_seq];
  v15 = v14;
  if (!v14) {
  ...
  int v18 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v16, v17);
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 14, v25, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 16, v18);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 18, (int)v21);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRecognitionToken *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
