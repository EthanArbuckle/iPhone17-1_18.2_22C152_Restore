...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableTextToSpeechSpeechFeatureInputWave;
...
- (void)pcm_data:(id)a3
{
  ...
  id v4 = [(FTMutableTextToSpeechSpeechFeatureInputWave *)self pcm_data];
  uint64_t v5 = [v4 bytes];
  objc_super v6 = [(FTMutableTextToSpeechSpeechFeatureInputWave *)self pcm_data];
