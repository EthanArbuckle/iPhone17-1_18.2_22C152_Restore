...
- (void)setSession_messageAsFTItnRequest:(id)a3;
- (void)setSession_messageAsFTItnResponse:(id)a3;
...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableAsrItnMessage;
...
{
  id v5 = a3;
  -[FTMutableAsrItnMessage setSession_message_type:](self, "setSession_message_type:", objc_msgSend((id)objc_opt_class(), "session_message_typeForObject:", v5));
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"session_message"];
}
