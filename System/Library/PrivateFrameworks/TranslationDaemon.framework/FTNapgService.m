...
- (void)performCreateLanguageProfile:(id)a3 requestBuilder:(id)a4 completion:(id)a5;
@end
...
- (void)performCreateLanguageProfile:(id)a3 requestBuilder:(id)a4 completion:(id)a5
{
  ...
  id v11 = v9;
  id v13 = v11;
  [(OspreyChannel *)self unaryRequestWithMethodName:@"/siri.speech.qss_fb.Napg/CreateLanguageProfile" requestData:v10 requestBuilder:v8 responseHandler:v12];
}
...
void __72__FTNapgService_performCreateLanguageProfile_requestBuilder_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v6 = [[FTCreateLanguageProfileResponse alloc] initAndVerifyWithFlatbuffData:v8];
    if (v6)
    {
      (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
    }
