...
- (FTPartialSpeechRecognitionResponse)initWithFlatbuffData:(id)a3
{
  return [(FTPartialSpeechRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTPartialSpeechRecognitionResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTPartialSpeechRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const PartialSpeechRecognitionResponse *)a4
{
  return [(FTPartialSpeechRecognitionResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTPartialSpeechRecognitionResponse)initWithFlatbuffData:(id)a3 root:(const PartialSpeechRecognitionResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTPartialSpeechRecognitionResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::PartialSpeechRecognitionResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTPartialSpeechRecognitionResponse *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  int v15 = [(FTPartialSpeechRecognitionResponse *)self return_code];
  ...
  int v40 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v18, v19);
  int v41 = v14;
  int v42 = v15;
  int v20 = String;
  ...
  int v26 = [(FTPartialSpeechRecognitionResponse *)self is_stable_result];
  int v27 = [(FTPartialSpeechRecognitionResponse *)self audio_duration_ms];
  int v28 = [(FTPartialSpeechRecognitionResponse *)self confidence];
  ...
  int v33 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v31, v32);
  ...
  *((unsigned char *)a3 + 70) = 1;
  int v38 = *((_DWORD *)a3 + 8) - *((_DWORD *)a3 + 12) + *((_DWORD *)a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>(a3, 8, v42, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 10, v40);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 20, v33);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 22, (int)v36);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTPartialSpeechRecognitionResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
