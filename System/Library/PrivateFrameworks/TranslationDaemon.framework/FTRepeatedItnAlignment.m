...
- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3;
- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4;
...
- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3
{
  return [(FTRepeatedItnAlignment *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRepeatedItnAlignment *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4
{
  return [(FTRepeatedItnAlignment *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTRepeatedItnAlignment;
  v10 = [(FTRepeatedItnAlignment *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const RepeatedItnAlignment *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::RepeatedItnAlignment *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::RepeatedItnAlignment::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)itn_alignment
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"itn_alignment"];
  if (!v3)
  {
...
uint64_t __39__FTRepeatedItnAlignment_itn_alignment__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)itn_alignment_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"itn_alignment"];
  v6 = v5;
  if (v5)
  {
...
- (void)itn_alignment_enumerateObjectsUsingBlock:(id)a3
{
  ...
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"itn_alignment"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTRepeatedItnAlignment *)self itn_alignment];
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::ItnAlignment>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::ItnAlignment>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::ItnAlignment>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRepeatedItnAlignment *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
