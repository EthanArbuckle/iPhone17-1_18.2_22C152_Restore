...
- (FTLanguageDetectionPrediction)initWithFlatbuffData:(id)a3;
- (FTLanguageDetectionPrediction)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionPrediction *)a4;
...
- (FTLanguageDetectionPrediction)initWithFlatbuffData:(id)a3
{
  return [(FTLanguageDetectionPrediction *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTLanguageDetectionPrediction *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTLanguageDetectionPrediction)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionPrediction *)a4
{
  return [(FTLanguageDetectionPrediction *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTLanguageDetectionPrediction)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionPrediction *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTLanguageDetectionPrediction;
  v10 = [(FTLanguageDetectionPrediction *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const LanguageDetectionPrediction *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::LanguageDetectionPrediction *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::LanguageDetectionPrediction::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (Offset<siri::speech::schema_fb::LanguageDetectionPrediction>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTLanguageDetectionPrediction *)self locale];
  v6 = v5;
  if (!v5) {
  ...
  float v12 = v11;
  int v13 = [(FTLanguageDetectionPrediction *)self is_low_confidence];
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::LanguageDetectionPrediction>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v14);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTLanguageDetectionPrediction *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
