...
- (void)setContentAsFTBeginTextToSpeechStreamingResponse:(id)a3;
- (void)setContentAsFTFinalTextToSpeechStreamingResponse:(id)a3;
- (void)setContentAsFTPartialTextToSpeechStreamingResponse:(id)a3;
- (void)setContentAsFTQssAckResponse:(id)a3;
...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableTextToSpeechStreamingStreamingResponse;
...
{
  id v5 = a3;
  -[FTMutableTextToSpeechStreamingStreamingResponse setContent_type:](self, "setContent_type:", objc_msgSend((id)objc_opt_class(), "content_typeForObject:", v5));
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"content"];
}
