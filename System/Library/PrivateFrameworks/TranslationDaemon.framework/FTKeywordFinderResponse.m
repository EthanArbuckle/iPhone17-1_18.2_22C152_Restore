...
- (FTKeywordFinderResponse)initWithFlatbuffData:(id)a3
{
  return [(FTKeywordFinderResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTKeywordFinderResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTKeywordFinderResponse)initWithFlatbuffData:(id)a3 root:(const KeywordFinderResponse *)a4
{
  return [(FTKeywordFinderResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTKeywordFinderResponse)initWithFlatbuffData:(id)a3 root:(const KeywordFinderResponse *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTKeywordFinderResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (FTRecognitionSausage)corrected_sausage
{
  uint64_t v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"corrected_sausage"];
  if (!v3)
  {
...
- (NSArray)n_best_list
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"n_best_list"];
  if (!v3)
  {
...
- (id)n_best_list_objectAtIndex:(unint64_t)a3
{
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"n_best_list"];
  v6 = v5;
  if (v5)
  {
...
- (void)n_best_list_enumerateObjectsUsingBlock:(id)a3
{
  uint64_t v4 = (void (**)(id, FTRecognitionChoice *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"n_best_list"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::KeywordFinderResponse>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTKeywordFinderResponse *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTKeywordFinderResponse *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  uint64_t v15 = [(FTKeywordFinderResponse *)self language];
  uint64_t v16 = v15;
  if (!v15) {
  ...
  int v20 = [(FTKeywordFinderResponse *)self return_code];
  v21 = [(FTKeywordFinderResponse *)self return_str];
  v22 = v21;
  if (!v21) {
    v21 = &stru_270C008E8;
  }
  ...
  objc_super v26 = [(FTKeywordFinderResponse *)self corrected_sausage];
  int v51 = [v26 addObjectToBuffer:a3];

  memset(&v60, 0, sizeof(v60));
  v27 = [(FTKeywordFinderResponse *)self n_best_list];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v60, [v27 count]);
  ...
  int v54 = v14;
  int v55 = String;
  uint64_t v29 = [v28 countByEnumeratingWithState:&v56 objects:v61 count:16];
  if (v29)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v29; ++i)
      {
        ...
        int v32 = [*(id *)(*((void *)&v56 + 1) + 8 * i) addObjectToBuffer:a3];
        int v33 = v32;
        std::vector<int>::pointer end = v60.__end_;
        if (v60.__end_ >= v60.__end_cap_.__value_)
        {
          std::vector<int>::pointer begin = v60.__begin_;
          int64_t v37 = v60.__end_ - v60.__begin_;
          unint64_t v38 = v37 + 1;
          if ((unint64_t)(v37 + 1) >> 62) {
            std::vector<unsigned short>::__throw_length_error[abi:ne180100]();
          }
          int64_t v39 = (char *)v60.__end_cap_.__value_ - (char *)v60.__begin_;
  ...
  if (v60.__end_ == v60.__begin_) {
    std::vector<int>::pointer v44 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionChoice>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionChoice>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionChoice>> const&)::t;
  }
  else {
    std::vector<int>::pointer v44 = v60.__begin_;
  }
  int v45 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (uint64_t)v44, v60.__end_ - v60.__begin_);
  *((unsigned char *)a3 + 70) = 1;
  int v46 = *((_DWORD *)a3 + 8);
  int v47 = *((_DWORD *)a3 + 12);
  int v48 = *((_DWORD *)a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 4, v55);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 8, v52);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned int>(a3, 10, v53, 0);
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTKeywordFinderResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
