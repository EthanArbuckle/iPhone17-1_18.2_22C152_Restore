...
- (FTMutableLanguageDetectionResponse)init;
- (NSArray)predictions;
...
@implementation FTMutableLanguageDetectionResponse

- (FTMutableLanguageDetectionResponse)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableLanguageDetectionResponse;
  v2 = [(FTMutableLanguageDetectionResponse *)&v6 init];
  if (v2)
  {
