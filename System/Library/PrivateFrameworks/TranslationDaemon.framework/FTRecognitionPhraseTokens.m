@interface FTRecognitionPhraseTokens
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3;
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4;
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4 verify:(BOOL)a5;
- (NSArray)tokens;
...
@implementation FTRecognitionPhraseTokens

- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3
{
  return [(FTRecognitionPhraseTokens *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTRecognitionPhraseTokens *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4
{
  return [(FTRecognitionPhraseTokens *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTRecognitionPhraseTokens)initWithFlatbuffData:(id)a3 root:(const RecognitionPhraseTokens *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTRecognitionPhraseTokens;
  v10 = [(FTRecognitionPhraseTokens *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const RecognitionPhraseTokens *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::RecognitionPhraseTokens *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::RecognitionPhraseTokens::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)tokens
{
  ...
  if (!v3)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __35__FTRecognitionPhraseTokens_tokens__block_invoke;
    v6[3] = &unk_265548F68;
    id v3 = v4;
    id v7 = v3;
    [(FTRecognitionPhraseTokens *)self tokens_enumerateObjectsUsingBlock:v6];
    [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"tokens"];
  }
  return (NSArray *)v3;
}

uint64_t __35__FTRecognitionPhraseTokens_tokens__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)tokens_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"tokens"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::RecognitionPhraseTokens>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTRecognitionPhraseTokens *)self tokens];
  ...
  long long v29 = 0u;
  long long v30 = 0u;
  v6 = [(FTRecognitionPhraseTokens *)self tokens];
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTRecognitionPhraseTokens *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__41__FTRecognitionPhraseTokens_flatbuffData__block_invoke(uint64_t a1)
{
