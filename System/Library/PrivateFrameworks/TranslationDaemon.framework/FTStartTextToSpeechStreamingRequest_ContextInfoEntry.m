...
- (FTStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3;
- (FTStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4;
- (FTStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4 verify:(BOOL)a5;
- (NSString)key;
- (NSString)value;
...
- (FTStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3
{
  return [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4
{
  return [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTStartTextToSpeechStreamingRequest_ContextInfoEntry;
  v10 = [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::StartTextToSpeechStreamingRequest_::ContextInfoEntry>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)self key];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)self value];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTStartTextToSpeechStreamingRequest_ContextInfoEntry *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
