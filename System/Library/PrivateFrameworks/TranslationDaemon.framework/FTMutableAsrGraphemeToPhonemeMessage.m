...
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableAsrGraphemeToPhonemeMessage;
...
- (FTGraphemeToPhonemeRequest)session_messageAsFTGraphemeToPhonemeRequest
{
  ...
  return (FTGraphemeToPhonemeRequest *)v3;
}
...
- (FTGraphemeToPhonemeResponse)session_messageAsFTGraphemeToPhonemeResponse
{
  ...
  return (FTGraphemeToPhonemeResponse *)v3;
}
...
{
  id v5 = a3;
  -[FTMutableAsrGraphemeToPhonemeMessage setSession_message_type:](self, "setSession_message_type:", objc_msgSend((id)objc_opt_class(), "session_message_typeForObject:", v5));
  id v4 = (void *)[v5 copy];
  [(NSMutableDictionary *)self->super._storage setObject:v4 forKeyedSubscript:@"session_message"];
}
