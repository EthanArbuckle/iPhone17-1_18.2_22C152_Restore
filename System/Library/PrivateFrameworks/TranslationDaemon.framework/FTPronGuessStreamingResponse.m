...
- (FTPronGuessStreamingResponse)initWithFlatbuffData:(id)a3;
- (FTPronGuessStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingResponse *)a4;
...
- (FTPronGuessStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(FTPronGuessStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTPronGuessStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTPronGuessStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingResponse *)a4
{
  return [(FTPronGuessStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTPronGuessStreamingResponse)initWithFlatbuffData:(id)a3 root:(const PronGuessStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTPronGuessStreamingResponse;
  v10 = [(FTPronGuessStreamingResponse *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::PronGuessStreamingResponse *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::PronGuessStreamingResponse::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (Offset<siri::speech::qss_fb::PronGuessStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTPronGuessStreamingResponse *)self content_type];
  if ([(FTPronGuessStreamingResponse *)self content_type] == 1)
  {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::PronGuessStreamingResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v11- (unsigned __int16)v9+ (unsigned __int16)v10);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTPronGuessStreamingResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
