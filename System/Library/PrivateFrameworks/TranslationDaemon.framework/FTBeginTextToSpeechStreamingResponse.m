...
- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3;
- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4;
...
- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(FTBeginTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTBeginTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4
{
  return [(FTBeginTextToSpeechStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTBeginTextToSpeechStreamingResponse)initWithFlatbuffData:(id)a3 root:(const BeginTextToSpeechStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTBeginTextToSpeechStreamingResponse;
  v10 = [(FTBeginTextToSpeechStreamingResponse *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!siri::speech::schema_fb::BeginTextToSpeechStreamingResponse::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22))LABEL_14:v20 = 0; {
  else
  }
LABEL_13:
    v20 = v10;
...
- (FTTextToSpeechMeta)meta_info
{
  ...
  if (!v3)
  {
    uint64_t v4 = [FTTextToSpeechMeta alloc];
    root = self->_root;
    v6 = &root[-*(int *)root->var0];
    ...
    uint64_t v3 = [(FTTextToSpeechMeta *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (Offset<siri::speech::schema_fb::BeginTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTBeginTextToSpeechStreamingResponse *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  int v15 = [(FTBeginTextToSpeechStreamingResponse *)self error_code];
  ...
  int v36 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateString((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v18, v19);
  int v37 = v14;
  int v20 = String;
  ...
  int v26 = [(FTBeginTextToSpeechStreamingResponse *)self audio_type];
  v27 = [(FTBeginTextToSpeechStreamingResponse *)self decoder_description];
  int v28 = [v27 addObjectToBuffer:a3];
  ...
  int v31 = [v30 addObjectToBuffer:a3];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 4, v20);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 10, v36);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 16, v28);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 18, (int)v23);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 20, v31);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<float>(a3, 22, v33, 0.0);
  return (Offset<siri::speech::schema_fb::BeginTextToSpeechStreamingResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v34);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTBeginTextToSpeechStreamingResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
