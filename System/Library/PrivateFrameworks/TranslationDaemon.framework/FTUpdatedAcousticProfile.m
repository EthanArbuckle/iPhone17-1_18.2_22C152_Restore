...
- (FTUpdatedAcousticProfile)initWithFlatbuffData:(id)a3;
- (FTUpdatedAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UpdatedAcousticProfile *)a4;
- (FTUpdatedAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UpdatedAcousticProfile *)a4 verify:(BOOL)a5;
...
- (FTUpdatedAcousticProfile)initWithFlatbuffData:(id)a3
{
  return [(FTUpdatedAcousticProfile *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTUpdatedAcousticProfile *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTUpdatedAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UpdatedAcousticProfile *)a4
{
  return [(FTUpdatedAcousticProfile *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTUpdatedAcousticProfile)initWithFlatbuffData:(id)a3 root:(const UpdatedAcousticProfile *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTUpdatedAcousticProfile;
  v10 = [(FTUpdatedAcousticProfile *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const UpdatedAcousticProfile *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::UpdatedAcousticProfile *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::UpdatedAcousticProfile::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (FTUserAcousticProfile)updated_acoustic_profile
{
  uint64_t v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"updated_acoustic_profile"];
  if (!v3)
  {
...
- (Offset<siri::speech::schema_fb::UpdatedAcousticProfile>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTUpdatedAcousticProfile *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTUpdatedAcousticProfile *)self session_id];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  int v15 = [(FTUpdatedAcousticProfile *)self return_code];
  v16 = [(FTUpdatedAcousticProfile *)self return_str];
  uint64_t v17 = v16;
  if (!v16) {
    v16 = &stru_270C008E8;
  }
  ...
  v20 = [(FTUpdatedAcousticProfile *)self updated_acoustic_profile];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 10, (int)v18);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 12, v21);
  return (Offset<siri::speech::schema_fb::UpdatedAcousticProfile>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v22);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTUpdatedAcousticProfile *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
