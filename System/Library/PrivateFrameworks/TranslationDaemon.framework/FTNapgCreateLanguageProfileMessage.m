@interface FTNapgCreateLanguageProfileMessage
...
- (FTNapgCreateLanguageProfileMessage)initWithFlatbuffData:(id)a3
{
  return [(FTNapgCreateLanguageProfileMessage *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTNapgCreateLanguageProfileMessage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTNapgCreateLanguageProfileMessage)initWithFlatbuffData:(id)a3 root:(const NapgCreateLanguageProfileMessage *)a4
{
  return [(FTNapgCreateLanguageProfileMessage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTNapgCreateLanguageProfileMessage)initWithFlatbuffData:(id)a3 root:(const NapgCreateLanguageProfileMessage *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTNapgCreateLanguageProfileMessage *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (FTCreateLanguageProfileRequest)session_messageAsFTCreateLanguageProfileRequest
{
  if ([(FTNapgCreateLanguageProfileMessage *)self session_message_type] == 1)
  {
    v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"session_message"];
    if (!v3)
    {
      uint64_t v4 = [FTCreateLanguageProfileRequest alloc];
      root = self->_root;
      ...
      v3 = [(FTCreateLanguageProfileRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (FTCreateLanguageProfileResponse)session_messageAsFTCreateLanguageProfileResponse
{
  if ([(FTNapgCreateLanguageProfileMessage *)self session_message_type] == 2)
  {
    v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"session_message"];
    if (!v3)
    {
      uint64_t v4 = [FTCreateLanguageProfileResponse alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (uint64_t v7 = *(unsigned __int16 *)v6[6].var0) != 0) {
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
      ...
      v3 = [(FTCreateLanguageProfileResponse *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
      [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"session_message"];
    }
  }
  else
...
- (FLTBFBufferAccessor)session_message
{
  int64_t v3 = [(FTNapgCreateLanguageProfileMessage *)self session_message_type];
  if (v3 == 2)
  {
    uint64_t v4 = [(FTNapgCreateLanguageProfileMessage *)self session_messageAsFTCreateLanguageProfileResponse];
  }
  else if (v3 == 1)
  {
    uint64_t v4 = [(FTNapgCreateLanguageProfileMessage *)self session_messageAsFTCreateLanguageProfileRequest];
  }
  else
  {
    uint64_t v4 = 0;
...
- (Offset<siri::speech::qss_fb::NapgCreateLanguageProfileMessage>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTNapgCreateLanguageProfileMessage *)self session_message_type];
  if ([(FTNapgCreateLanguageProfileMessage *)self session_message_type] == 1)
  {
    v6 = [(FTNapgCreateLanguageProfileMessage *)self session_messageAsFTCreateLanguageProfileRequest];
  ...
  if ([(FTNapgCreateLanguageProfileMessage *)self session_message_type] == 2)
  {
    v8 = [(FTNapgCreateLanguageProfileMessage *)self session_messageAsFTCreateLanguageProfileResponse];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTNapgCreateLanguageProfileMessage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
