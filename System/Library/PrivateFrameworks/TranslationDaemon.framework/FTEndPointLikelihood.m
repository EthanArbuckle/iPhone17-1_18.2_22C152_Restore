...
- (FTEndPointLikelihood)initWithFlatbuffData:(id)a3;
- (FTEndPointLikelihood)initWithFlatbuffData:(id)a3 root:(const EndPointLikelihood *)a4;
...
- (FTEndPointLikelihood)initWithFlatbuffData:(id)a3
{
  return [(FTEndPointLikelihood *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTEndPointLikelihood *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTEndPointLikelihood)initWithFlatbuffData:(id)a3 root:(const EndPointLikelihood *)a4
{
  return [(FTEndPointLikelihood *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTEndPointLikelihood)initWithFlatbuffData:(id)a3 root:(const EndPointLikelihood *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTEndPointLikelihood;
  v10 = [(FTEndPointLikelihood *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const EndPointLikelihood *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::EndPointLikelihood *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::EndPointLikelihood::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (Offset<siri::speech::schema_fb::EndPointLikelihood>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTEndPointLikelihood *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  int v15 = [(FTEndPointLikelihood *)self return_code];
  ...
  int v20 = [(FTEndPointLikelihood *)self end_point_likelihood];
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::EndPointLikelihood>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v21);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTEndPointLikelihood *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__36__FTEndPointLikelihood_flatbuffData__block_invoke(uint64_t a1)
{
