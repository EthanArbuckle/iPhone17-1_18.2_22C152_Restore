...
- (FTTtsTextToSpeechStreamingMessage)initWithFlatbuffData:(id)a3;
- (FTTtsTextToSpeechStreamingMessage)initWithFlatbuffData:(id)a3 root:(const TtsTextToSpeechStreamingMessage *)a4;
...
- (FTTtsTextToSpeechStreamingMessage)initWithFlatbuffData:(id)a3
{
  return [(FTTtsTextToSpeechStreamingMessage *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTtsTextToSpeechStreamingMessage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTtsTextToSpeechStreamingMessage)initWithFlatbuffData:(id)a3 root:(const TtsTextToSpeechStreamingMessage *)a4
{
  return [(FTTtsTextToSpeechStreamingMessage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTtsTextToSpeechStreamingMessage)initWithFlatbuffData:(id)a3 root:(const TtsTextToSpeechStreamingMessage *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTTtsTextToSpeechStreamingMessage;
  v10 = [(FTTtsTextToSpeechStreamingMessage *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (!a4)
    {
      ...
      a4 = (const TtsTextToSpeechStreamingMessage *)v13 + *v13;
    }
    v11->_root = a4;
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::TtsTextToSpeechStreamingMessage *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::TtsTextToSpeechStreamingMessage::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (FLTBFBufferAccessor)session_message
{
  switch([(FTTtsTextToSpeechStreamingMessage *)self session_message_type])
  {
    case 1:
      v3 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTStartTextToSpeechStreamingRequest];
      break;
    case 2:
      v3 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTQssAckResponse];
      break;
    case 3:
      v3 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTBeginTextToSpeechStreamingResponse];
      break;
    case 4:
      v3 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTPartialTextToSpeechStreamingResponse];
      break;
    case 5:
      v3 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTFinalTextToSpeechStreamingResponse];
      break;
    default:
      v3 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::TtsTextToSpeechStreamingMessage>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTTtsTextToSpeechStreamingMessage *)self session_message_type];
  if ([(FTTtsTextToSpeechStreamingMessage *)self session_message_type] == 1)
  {
  ...
  if ([(FTTtsTextToSpeechStreamingMessage *)self session_message_type] == 3)
  {
    v10 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTBeginTextToSpeechStreamingResponse];
  ...
  if ([(FTTtsTextToSpeechStreamingMessage *)self session_message_type] == 4)
  {
    v13 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTPartialTextToSpeechStreamingResponse];
  ...
  if ([(FTTtsTextToSpeechStreamingMessage *)self session_message_type] == 5)
  {
    v16 = [(FTTtsTextToSpeechStreamingMessage *)self session_messageAsFTFinalTextToSpeechStreamingResponse];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::TtsTextToSpeechStreamingMessage>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v23- (unsigned __int16)v21+ (unsigned __int16)v22);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTtsTextToSpeechStreamingMessage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
