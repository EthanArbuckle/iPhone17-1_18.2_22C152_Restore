...
- (FTTTSPhonemeSequence)initWithFlatbuffData:(id)a3
{
  return [(FTTTSPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTTSPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTTSPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSPhonemeSequence *)a4
{
  return [(FTTTSPhonemeSequence *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTTSPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSPhonemeSequence *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTTTSPhonemeSequence *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (NSArray)word_phonemes
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"word_phonemes"];
  if (!v3)
  {
...
- (id)word_phonemes_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"word_phonemes"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTTTSWordPhonemes alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)word_phonemes_enumerateObjectsUsingBlock:(id)a3
{
  ...
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"word_phonemes"];
  v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTTTSWordPhonemes alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::TTSPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTTSPhonemeSequence *)self word_phonemes];
  ...
  long long v29 = 0u;
  long long v30 = 0u;
  v6 = [(FTTTSPhonemeSequence *)self word_phonemes];
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TTSWordPhonemes>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TTSWordPhonemes>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::TTSWordPhonemes>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTTSPhonemeSequence *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
