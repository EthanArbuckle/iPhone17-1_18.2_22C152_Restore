...
- (FTBlazarBatchTranslationMessage)initWithFlatbuffData:(id)a3
{
  return [(FTBlazarBatchTranslationMessage *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTBlazarBatchTranslationMessage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTBlazarBatchTranslationMessage)initWithFlatbuffData:(id)a3 root:(const BlazarBatchTranslationMessage *)a4
{
  return [(FTBlazarBatchTranslationMessage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTBlazarBatchTranslationMessage)initWithFlatbuffData:(id)a3 root:(const BlazarBatchTranslationMessage *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTBlazarBatchTranslationMessage *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (FTBatchTranslationRequest)session_messageAsFTBatchTranslationRequest
{
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 1)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTBatchTranslationRequest alloc];
      root = self->_root;
...
- (FTBatchTranslationFeedbackRequest)session_messageAsFTBatchTranslationFeedbackRequest
{
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 2)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTBatchTranslationFeedbackRequest alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (uint64_t v7 = *(unsigned __int16 *)v6[6].var0) != 0) {
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
...
- (FTBatchTranslationLoggingRequest)session_messageAsFTBatchTranslationLoggingRequest
{
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 3)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTBatchTranslationLoggingRequest alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (uint64_t v7 = *(unsigned __int16 *)v6[6].var0) != 0) {
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
...
- (FTTranslationSupportedLanguagesRequest)session_messageAsFTTranslationSupportedLanguagesRequest
{
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 4)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTTranslationSupportedLanguagesRequest alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (uint64_t v7 = *(unsigned __int16 *)v6[6].var0) != 0) {
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
...
- (FLTBFBufferAccessor)session_message
{
  switch([(FTBlazarBatchTranslationMessage *)self session_message_type])
  {
    case 1:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationRequest];
      break;
    case 2:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationFeedbackRequest];
      break;
    case 3:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationLoggingRequest];
      break;
    case 4:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTTranslationSupportedLanguagesRequest];
      break;
    case 5:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationResponse];
      break;
    case 6:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTFinalBlazarResponse];
      break;
    case 7:
      v3 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTTranslationSupportedLanguagesResponse];
      break;
    default:
      v3 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::BlazarBatchTranslationMessage>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTBlazarBatchTranslationMessage *)self session_message_type];
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 1)
  {
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 2)
  {
    v8 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationFeedbackRequest];
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 3)
  {
    v10 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationLoggingRequest];
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 4)
  {
    v12 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTTranslationSupportedLanguagesRequest];
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 5)
  {
    unint64_t v14 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTBatchTranslationResponse];
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 6)
  {
    v16 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTFinalBlazarResponse];
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 7)
  {
    uint64_t v18 = [(FTBlazarBatchTranslationMessage *)self session_messageAsFTTranslationSupportedLanguagesResponse];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 6) {
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 6, v26);
  }
  if ([(FTBlazarBatchTranslationMessage *)self session_message_type] == 7) {
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 6, v21);
  }
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTBlazarBatchTranslationMessage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
