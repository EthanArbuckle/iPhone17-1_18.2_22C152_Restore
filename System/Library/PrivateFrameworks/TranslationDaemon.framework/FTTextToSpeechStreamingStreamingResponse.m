...
- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechStreamingStreamingResponse *)a4;
- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechStreamingStreamingResponse *)a4 verify:(BOOL)a5;
...
- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechStreamingStreamingResponse *)a4
{
  return [(FTTextToSpeechStreamingStreamingResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTTextToSpeechStreamingStreamingResponse;
  v10 = [(FTTextToSpeechStreamingStreamingResponse *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (FTQssAckResponse)contentAsFTQssAckResponse
{
  if ([(FTTextToSpeechStreamingStreamingResponse *)self content_type] == 1)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTQssAckResponse alloc];
      root = self->_root;
...
- (FLTBFBufferAccessor)content
{
  switch([(FTTextToSpeechStreamingStreamingResponse *)self content_type])
  {
    case 1:
      v3 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTQssAckResponse];
      break;
    case 2:
      v3 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTBeginTextToSpeechStreamingResponse];
      break;
    case 3:
      v3 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTPartialTextToSpeechStreamingResponse];
      break;
    case 4:
      v3 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTFinalTextToSpeechStreamingResponse];
      break;
    default:
      v3 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTTextToSpeechStreamingStreamingResponse *)self content_type];
  if ([(FTTextToSpeechStreamingStreamingResponse *)self content_type] == 1)
  {
    v6 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTQssAckResponse];
  ...
  if ([(FTTextToSpeechStreamingStreamingResponse *)self content_type] == 2)
  {
    v8 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTBeginTextToSpeechStreamingResponse];
  ...
  if ([(FTTextToSpeechStreamingStreamingResponse *)self content_type] == 3)
  {
    v10 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTPartialTextToSpeechStreamingResponse];
  ...
  if ([(FTTextToSpeechStreamingStreamingResponse *)self content_type] == 4)
  {
    v12 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTFinalTextToSpeechStreamingResponse];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v17- (unsigned __int16)v16+ (unsigned __int16)v15);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechStreamingStreamingResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
