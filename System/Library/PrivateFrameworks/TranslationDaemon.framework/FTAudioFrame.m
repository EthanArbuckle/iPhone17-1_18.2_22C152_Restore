...
- (FTAudioFrame)initWithFlatbuffData:(id)a3;
- (FTAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4;
...
- (FTAudioFrame)initWithFlatbuffData:(id)a3
{
  return [(FTAudioFrame *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTAudioFrame *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4
{
  return [(FTAudioFrame *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTAudioFrame)initWithFlatbuffData:(id)a3 root:(const AudioFrame *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTAudioFrame;
  v10 = [(FTAudioFrame *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::AudioFrame *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::AudioFrame::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTAudioFrame *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
