...
- (FTTtsTextToSpeechSpeechFeatureMessage)initWithFlatbuffData:(id)a3
{
  return [(FTTtsTextToSpeechSpeechFeatureMessage *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTtsTextToSpeechSpeechFeatureMessage *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTtsTextToSpeechSpeechFeatureMessage)initWithFlatbuffData:(id)a3 root:(const TtsTextToSpeechSpeechFeatureMessage *)a4
{
  return [(FTTtsTextToSpeechSpeechFeatureMessage *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTtsTextToSpeechSpeechFeatureMessage)initWithFlatbuffData:(id)a3 root:(const TtsTextToSpeechSpeechFeatureMessage *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTTtsTextToSpeechSpeechFeatureMessage *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
...
- (FTTextToSpeechSpeechFeatureRequest)session_messageAsFTTextToSpeechSpeechFeatureRequest
{
  if ([(FTTtsTextToSpeechSpeechFeatureMessage *)self session_message_type] == 1)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTTextToSpeechSpeechFeatureRequest alloc];
      root = self->_root;
      ...
      v3 = [(FTTextToSpeechSpeechFeatureRequest *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (FTTextToSpeechSpeechFeatureResponse)session_messageAsFTTextToSpeechSpeechFeatureResponse
{
  if ([(FTTtsTextToSpeechSpeechFeatureMessage *)self session_message_type] == 2)
  {
    ...
    if (!v3)
    {
      uint64_t v4 = [FTTextToSpeechSpeechFeatureResponse alloc];
      root = self->_root;
      v6 = &root[-*(int *)root->var0];
      if (*(unsigned __int16 *)v6->var0 >= 7u && (uint64_t v7 = *(unsigned __int16 *)v6[6].var0) != 0) {
        v8 = &root[v7 + *(unsigned int *)root[v7].var0];
      ...
      v3 = [(FTTextToSpeechSpeechFeatureResponse *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
      [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"session_message"];
    }
  }
  else
...
- (FLTBFBufferAccessor)session_message
{
  int64_t v3 = [(FTTtsTextToSpeechSpeechFeatureMessage *)self session_message_type];
  if (v3 == 2)
  {
    uint64_t v4 = [(FTTtsTextToSpeechSpeechFeatureMessage *)self session_messageAsFTTextToSpeechSpeechFeatureResponse];
  }
  else if (v3 == 1)
  {
    uint64_t v4 = [(FTTtsTextToSpeechSpeechFeatureMessage *)self session_messageAsFTTextToSpeechSpeechFeatureRequest];
  }
  else
  {
    uint64_t v4 = 0;
...
- (Offset<siri::speech::qss_fb::TtsTextToSpeechSpeechFeatureMessage>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTTtsTextToSpeechSpeechFeatureMessage *)self session_message_type];
  if ([(FTTtsTextToSpeechSpeechFeatureMessage *)self session_message_type] == 1)
  {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTtsTextToSpeechSpeechFeatureMessage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
