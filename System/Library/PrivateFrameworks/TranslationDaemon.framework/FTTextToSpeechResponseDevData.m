...
- (FTTextToSpeechResponseDevData)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechResponseDevData)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResponseDevData *)a4;
...
- (FTTextToSpeechResponseDevData)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechResponseDevData *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechResponseDevData *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechResponseDevData)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResponseDevData *)a4
{
  return [(FTTextToSpeechResponseDevData *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechResponseDevData)initWithFlatbuffData:(id)a3 root:(const TextToSpeechResponseDevData *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechResponseDevData;
  v10 = [(FTTextToSpeechResponseDevData *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const TextToSpeechResponseDevData *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::TextToSpeechResponseDevData *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::TextToSpeechResponseDevData::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (FTQSSVersionInfo)server_info
{
  ...
  if (!v3)
  {
    uint64_t v4 = [FTQSSVersionInfo alloc];
    root = self->_root;
    ...
    uint64_t v3 = [(FTQSSVersionInfo *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (Offset<siri::speech::schema_fb::TextToSpeechResponseDevData>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTTextToSpeechResponseDevData *)self log];
  v6 = v5;
  if (!v5) {
  ...
  int v12 = [(FTTextToSpeechResponseDevData *)self has_click];
  unint64_t v13 = [(FTTextToSpeechResponseDevData *)self worker_process_type];
  uint64_t v14 = v13;
  if (!v13) {
  ...
  int v18 = [(FTTextToSpeechResponseDevData *)self engine_error_code];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 14, (int)v21);
  return (Offset<siri::speech::schema_fb::TextToSpeechResponseDevData>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v23);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechResponseDevData *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
