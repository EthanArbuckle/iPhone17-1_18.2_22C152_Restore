...
- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3;
- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionStreamingRequest *)a4;
- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionStreamingRequest *)a4 verify:(BOOL)a5;
...
- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3
{
  return [(FTLanguageDetectionStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTLanguageDetectionStreamingRequest *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionStreamingRequest *)a4
{
  return [(FTLanguageDetectionStreamingRequest *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTLanguageDetectionStreamingRequest)initWithFlatbuffData:(id)a3 root:(const LanguageDetectionStreamingRequest *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v30.receiver = self;
  v30.super_class = (Class)FTLanguageDetectionStreamingRequest;
  v10 = [(FTLanguageDetectionStreamingRequest *)&v30 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length]) {
    ...
    if (v5)
    {
      ...
      uint64_t v28 = 0;
      LOBYTE(v29) = 1;
      root = (siri::speech::qss_fb::LanguageDetectionStreamingRequest *)v11->_root;
      if (root)
      {
        if (!siri::speech::qss_fb::LanguageDetectionStreamingRequest::Verify(root, (apple::aiml::flatbuffers2::Verifier *)&v25))
        {
LABEL_15:
          v23 = 0;
          goto LABEL_16;
...
- (FLTBFBufferAccessor)content
{
  int64_t v3 = [(FTLanguageDetectionStreamingRequest *)self content_type];
  switch(v3)
  {
    case 3:
      uint64_t v4 = [(FTLanguageDetectionStreamingRequest *)self contentAsFTFinishAudio];
      break;
    case 2:
      uint64_t v4 = [(FTLanguageDetectionStreamingRequest *)self contentAsFTAudioPacket];
      break;
    case 1:
      uint64_t v4 = [(FTLanguageDetectionStreamingRequest *)self contentAsFTStartLanguageDetectionRequest];
      break;
    default:
      uint64_t v4 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::LanguageDetectionStreamingRequest>)addObjectToBuffer:(void *)a3
{
  unsigned __int8 v5 = [(FTLanguageDetectionStreamingRequest *)self content_type];
  if ([(FTLanguageDetectionStreamingRequest *)self content_type] == 1)
  {
    v6 = [(FTLanguageDetectionStreamingRequest *)self contentAsFTStartLanguageDetectionRequest];
  ...
  if ([(FTLanguageDetectionStreamingRequest *)self content_type] == 2)
  {
    v8 = [(FTLanguageDetectionStreamingRequest *)self contentAsFTAudioPacket];
  ...
  if ([(FTLanguageDetectionStreamingRequest *)self content_type] == 3)
  {
    v10 = [(FTLanguageDetectionStreamingRequest *)self contentAsFTFinishAudio];
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::qss_fb::LanguageDetectionStreamingRequest>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, (unsigned __int16)v15- (unsigned __int16)v14+ (unsigned __int16)v13);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTLanguageDetectionStreamingRequest *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
