...
- (FTSpeechTranslationMtResponse_TranslationPhrase)initWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationMtResponse_TranslationPhrase *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationMtResponse_TranslationPhrase *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTSpeechTranslationMtResponse_TranslationPhrase)initWithFlatbuffData:(id)a3 root:(const TranslationPhrase *)a4
{
  return [(FTSpeechTranslationMtResponse_TranslationPhrase *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTSpeechTranslationMtResponse_TranslationPhrase)initWithFlatbuffData:(id)a3 root:(const TranslationPhrase *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTSpeechTranslationMtResponse_TranslationPhrase *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (FTTranslationPhraseMetaInfo)meta_info_data
{
  uint64_t v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"meta_info_data"];
  if (!v3)
  {
    ...
    uint64_t v3 = [(FTTranslationPhraseMetaInfo *)v4 initWithFlatbuffData:self->_data root:v8 verify:0];
...
- (Offset<siri::speech::schema_fb::SpeechTranslationMtResponse_::TranslationPhrase>)addObjectToBuffer:(void *)a3
{
  ...
  float v6 = v5;
  uint64_t v7 = [(FTSpeechTranslationMtResponse_TranslationPhrase *)self translation_phrase];
  v8 = v7;
  if (!v7) {
    uint64_t v7 = &stru_270C008E8;
  }
  id v9 = (const char *)[(__CFString *)v7 UTF8String];
  ...
  uint64_t v17 = [(FTSpeechTranslationMtResponse_TranslationPhrase *)self meta_info_data];
  int v18 = [v17 addObjectToBuffer:a3];

  int v19 = [(FTSpeechTranslationMtResponse_TranslationPhrase *)self contains_masked_profanity];
  *((unsigned char *)a3 + 70) = 1;
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 10, (int)v14, 0);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, 12, v18);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(a3, 14, v19, 0);
  return (Offset<siri::speech::schema_fb::SpeechTranslationMtResponse_::TranslationPhrase>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v20);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTSpeechTranslationMtResponse_TranslationPhrase *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
