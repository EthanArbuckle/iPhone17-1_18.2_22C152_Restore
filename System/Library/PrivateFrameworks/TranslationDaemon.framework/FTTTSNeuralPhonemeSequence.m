@interface FTTTSNeuralPhonemeSequence
- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3;
- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4;
- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4 verify:(BOOL)a5;
- (NSArray)phonemes;
...
@implementation FTTTSNeuralPhonemeSequence

- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3
{
  return [(FTTTSNeuralPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTTSNeuralPhonemeSequence *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4
{
  return [(FTTTSNeuralPhonemeSequence *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)a3 root:(const TTSNeuralPhonemeSequence *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTTSNeuralPhonemeSequence;
  v10 = [(FTTTSNeuralPhonemeSequence *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (NSArray)phonemes
{
  ...
  if (!v3)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __38__FTTTSNeuralPhonemeSequence_phonemes__block_invoke;
    v6[3] = &unk_265548F68;
    id v3 = v4;
    id v7 = v3;
    [(FTTTSNeuralPhonemeSequence *)self phonemes_enumerateObjectsUsingBlock:v6];
    [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"phonemes"];
  }
  return (NSArray *)v3;
}

uint64_t __38__FTTTSNeuralPhonemeSequence_phonemes__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::TTSNeuralPhonemeSequence>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTTSNeuralPhonemeSequence *)self phonemes];
  ...
  long long v31 = 0u;
  long long v32 = 0u;
  v6 = [(FTTTSNeuralPhonemeSequence *)self phonemes];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTTSNeuralPhonemeSequence *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__42__FTTTSNeuralPhonemeSequence_flatbuffData__block_invoke(uint64_t a1)
{
