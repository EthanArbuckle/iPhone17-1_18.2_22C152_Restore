...
- (FTUpdateAudioInfo)initWithFlatbuffData:(id)a3;
- (FTUpdateAudioInfo)initWithFlatbuffData:(id)a3 root:(const UpdateAudioInfo *)a4;
...
- (FTUpdateAudioInfo)initWithFlatbuffData:(id)a3
{
  return [(FTUpdateAudioInfo *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTUpdateAudioInfo *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTUpdateAudioInfo)initWithFlatbuffData:(id)a3 root:(const UpdateAudioInfo *)a4
{
  return [(FTUpdateAudioInfo *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTUpdateAudioInfo)initWithFlatbuffData:(id)a3 root:(const UpdateAudioInfo *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTUpdateAudioInfo;
  v10 = [(FTUpdateAudioInfo *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const UpdateAudioInfo *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
...
- (Offset<siri::speech::schema_fb::UpdateAudioInfo>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTUpdateAudioInfo *)self product_id];
  v6 = v5;
  if (!v5) {
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::UpdateAudioInfo>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v14);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTUpdateAudioInfo *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__33__FTUpdateAudioInfo_flatbuffData__block_invoke(uint64_t a1)
{
