...
- (FTItnResponse)initWithFlatbuffData:(id)a3
{
  return [(FTItnResponse *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTItnResponse *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTItnResponse)initWithFlatbuffData:(id)a3 root:(const ItnResponse *)a4
{
  return [(FTItnResponse *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (NSArray)formatted_words_list
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"formatted_words_list"];
  if (!v3)
  {
    ...
    id v3 = v4;
    id v7 = v3;
    [(FTItnResponse *)self formatted_words_list_enumerateObjectsUsingBlock:v6];
...
- (id)formatted_words_list_objectAtIndex:(unint64_t)a3
{
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"formatted_words_list"];
  v6 = v5;
  if (v5)
  {
...
- (void)formatted_words_list_enumerateObjectsUsingBlock:(id)a3
{
  ...
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"formatted_words_list"];
  v6 = v5;
  if (v5)
  {
...
- (Offset<siri::speech::schema_fb::ItnResponse>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTItnResponse *)self speech_id];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTItnResponse *)self session_id];
  uint64_t v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  uint64_t v15 = [(FTItnResponse *)self language];
  uint64_t v16 = v15;
  if (!v15) {
  ...
  int v20 = [(FTItnResponse *)self return_code];
  v21 = [(FTItnResponse *)self return_str];
  v22 = v21;
  if (!v21) {
    v21 = &stru_270C008E8;
  }
  ...
  char v25 = [(FTItnResponse *)self formatted_words_list];
  ...
  long long v54 = 0u;
  long long v55 = 0u;
  objc_super v26 = [(FTItnResponse *)self formatted_words_list];
  int v50 = v19;
  int v51 = v20;
  int v52 = v14;
  int v53 = String;
  ...
  if (v58.__end_ == v58.__begin_) {
    std::vector<int>::pointer v42 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionPhraseTokens>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTItnResponse *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
