...
- (FTLanguageDetected)initWithFlatbuffData:(id)a3;
- (FTLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4;
- (FTLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4 verify:(BOOL)a5;
- (NSArray)predictions;
...
- (FTLanguageDetected)initWithFlatbuffData:(id)a3
{
  return [(FTLanguageDetected *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTLanguageDetected *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4
{
  return [(FTLanguageDetected *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTLanguageDetected)initWithFlatbuffData:(id)a3 root:(const LanguageDetected *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTLanguageDetected;
  v10 = [(FTLanguageDetected *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const LanguageDetected *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::LanguageDetected *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::LanguageDetected::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
uint64_t __33__FTLanguageDetected_predictions__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::LanguageDetected>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTLanguageDetected *)self detected_locale];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v9 = [(FTLanguageDetected *)self predictions];
  ...
  long long v34 = 0u;
  long long v35 = 0u;
  v10 = [(FTLanguageDetected *)self predictions];
  int v33 = (int)v7;
  ...
  if (v38.__end_ == v38.__begin_) {
    std::vector<int>::pointer v26 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageDetectionPrediction>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageDetectionPrediction>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::LanguageDetectionPrediction>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTLanguageDetected *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
