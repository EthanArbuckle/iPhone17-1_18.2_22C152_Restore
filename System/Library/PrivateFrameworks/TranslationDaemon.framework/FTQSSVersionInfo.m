...
- (FTQSSVersionInfo)initWithFlatbuffData:(id)a3;
- (FTQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4;
- (FTQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4 verify:(BOOL)a5;
...
- (FTQSSVersionInfo)initWithFlatbuffData:(id)a3
{
  return [(FTQSSVersionInfo *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTQSSVersionInfo *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4
{
  return [(FTQSSVersionInfo *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTQSSVersionInfo)initWithFlatbuffData:(id)a3 root:(const QSSVersionInfo *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTQSSVersionInfo;
  v10 = [(FTQSSVersionInfo *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const QSSVersionInfo *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::QSSVersionInfo *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::QSSVersionInfo::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (Offset<siri::speech::schema_fb::QSSVersionInfo>)addObjectToBuffer:(void *)a3
{
  uint64_t v5 = [(FTQSSVersionInfo *)self qss_version_server];
  v6 = v5;
  if (!v5) {
  ...
  v10 = [(FTQSSVersionInfo *)self qss_version_brane];
  v11 = v10;
  if (!v10) {
    v10 = &stru_270C008E8;
  }
  ...
  v15 = [(FTQSSVersionInfo *)self qss_version_serverkit];
  v16 = v15;
  if (!v15) {
    v15 = &stru_270C008E8;
  }
  ...
  v20 = [(FTQSSVersionInfo *)self qss_version_siritts];
  v21 = v20;
  if (!v20) {
    v20 = &stru_270C008E8;
  }
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<siri::speech::schema_fb::QSSVersionInfo>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v24);
}
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTQSSVersionInfo *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
