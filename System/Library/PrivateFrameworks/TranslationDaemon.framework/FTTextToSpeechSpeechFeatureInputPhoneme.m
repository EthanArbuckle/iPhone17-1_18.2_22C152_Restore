...
- (FTTextToSpeechSpeechFeatureInputPhoneme)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechSpeechFeatureInputPhoneme)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputPhoneme *)a4;
- (FTTextToSpeechSpeechFeatureInputPhoneme)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputPhoneme *)a4 verify:(BOOL)a5;
- (NSArray)phonemes;
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputPhoneme>)addObjectToBuffer:(void *)a3;
- (id)flatbuffData;
...
- (FTTextToSpeechSpeechFeatureInputPhoneme)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechSpeechFeatureInputPhoneme *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechSpeechFeatureInputPhoneme *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechSpeechFeatureInputPhoneme)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputPhoneme *)a4
{
  return [(FTTextToSpeechSpeechFeatureInputPhoneme *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechSpeechFeatureInputPhoneme)initWithFlatbuffData:(id)a3 root:(const TextToSpeechSpeechFeatureInputPhoneme *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechSpeechFeatureInputPhoneme;
  v10 = [(FTTextToSpeechSpeechFeatureInputPhoneme *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const TextToSpeechSpeechFeatureInputPhoneme *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
...
uint64_t __51__FTTextToSpeechSpeechFeatureInputPhoneme_phonemes__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputPhoneme>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTextToSpeechSpeechFeatureInputPhoneme *)self phonemes];
  ...
  long long v31 = 0u;
  long long v32 = 0u;
  v6 = [(FTTextToSpeechSpeechFeatureInputPhoneme *)self phonemes];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechSpeechFeatureInputPhoneme *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
