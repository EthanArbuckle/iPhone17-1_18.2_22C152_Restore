...
- (FTMutableTextNormalizationResponse)init;
- (NSArray)tokens;
- (NSString)error_str;
- (NSString)session_id;
- (NSString)speech_id;
...
@implementation FTMutableTextNormalizationResponse

- (FTMutableTextNormalizationResponse)init
{
  v6.receiver = self;
  v6.super_class = (Class)FTMutableTextNormalizationResponse;
  v2 = [(FTMutableTextNormalizationResponse *)&v6 init];
  if (v2)
  {
