@interface FTTextToSpeechUserProfile
- (FTTextToSpeechUserProfile)initWithFlatbuffData:(id)a3;
- (FTTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4;
- (FTTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4 verify:(BOOL)a5;
- (NSArray)resources;
...
@implementation FTTextToSpeechUserProfile

- (FTTextToSpeechUserProfile)initWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechUserProfile *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTTextToSpeechUserProfile *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4
{
  return [(FTTextToSpeechUserProfile *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTTextToSpeechUserProfile)initWithFlatbuffData:(id)a3 root:(const TextToSpeechUserProfile *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTTextToSpeechUserProfile;
  v10 = [(FTTextToSpeechUserProfile *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::TextToSpeechUserProfile *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::TextToSpeechUserProfile::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)resources
{
  ...
  if (!v3)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __38__FTTextToSpeechUserProfile_resources__block_invoke;
    v6[3] = &unk_265548F68;
    id v3 = v4;
    id v7 = v3;
    [(FTTextToSpeechUserProfile *)self resources_enumerateObjectsUsingBlock:v6];
    [(NSMutableDictionary *)self->_storage setObject:v3 forKeyedSubscript:@"resources"];
  }
  return (NSArray *)v3;
}

uint64_t __38__FTTextToSpeechUserProfile_resources__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)resources_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"resources"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTTextToSpeechVoiceResource alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)resources_enumerateObjectsUsingBlock:(id)a3
{
  v4 = (void (**)(id, FTTextToSpeechVoiceResource *, uint64_t, unsigned __int8 *))a3;
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTTextToSpeechVoiceResource alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::TextToSpeechUserProfile>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTTextToSpeechUserProfile *)self resources];
  ...
  long long v29 = 0u;
  long long v30 = 0u;
  v6 = [(FTTextToSpeechUserProfile *)self resources];
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTTextToSpeechUserProfile *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}

apple::aiml::flatbuffers2::DetachedBuffer *__41__FTTextToSpeechUserProfile_flatbuffData__block_invoke(uint64_t a1)
{
