...
- (FTSpeechTranslationInfo)initWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationInfo *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTSpeechTranslationInfo *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTSpeechTranslationInfo)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationInfo *)a4
{
  return [(FTSpeechTranslationInfo *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTSpeechTranslationInfo)initWithFlatbuffData:(id)a3 root:(const SpeechTranslationInfo *)a4 verify:(BOOL)a5
{
  ...
  v10 = [(FTSpeechTranslationInfo *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
...
- (Offset<siri::speech::schema_fb::SpeechTranslationInfo>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTSpeechTranslationInfo *)self raw_sausage];
  int v6 = [v5 addObjectToBuffer:a3];

  memset(&v36, 0, sizeof(v36));
  id v7 = [(FTSpeechTranslationInfo *)self raw_nbest_choices];
  ...
  long long v32 = 0u;
  long long v33 = 0u;
  uint64_t v8 = [(FTSpeechTranslationInfo *)self raw_nbest_choices];
  int v31 = v6;
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTSpeechTranslationInfo *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
