...
- (FTNormalizedToken)initWithFlatbuffData:(id)a3;
- (FTNormalizedToken)initWithFlatbuffData:(id)a3 root:(const NormalizedToken *)a4;
...
- (FTNormalizedToken)initWithFlatbuffData:(id)a3
{
  return [(FTNormalizedToken *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTNormalizedToken *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTNormalizedToken)initWithFlatbuffData:(id)a3 root:(const NormalizedToken *)a4
{
  return [(FTNormalizedToken *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTNormalizedToken)initWithFlatbuffData:(id)a3 root:(const NormalizedToken *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTNormalizedToken;
  v10 = [(FTNormalizedToken *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const NormalizedToken *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::NormalizedToken *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::NormalizedToken::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)nbest_variants
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"nbest_variants"];
  if (!v3)
  {
...
uint64_t __35__FTNormalizedToken_nbest_variants__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)nbest_variants_objectAtIndex:(unint64_t)a3
{
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"nbest_variants"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 7u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTNormalizedTokenVariant alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)nbest_variants_enumerateObjectsUsingBlock:(id)a3
{
  uint64_t v4 = (void (**)(id, FTNormalizedTokenVariant *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"nbest_variants"];
  v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 7u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTNormalizedTokenVariant alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::NormalizedToken>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTNormalizedToken *)self original_token];
  v6 = v5;
  if (!v5) {
  ...
  uint64_t v9 = [(FTNormalizedToken *)self nbest_variants];
  ...
  if (v38.__end_ == v38.__begin_) {
    std::vector<int>::pointer v26 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::NormalizedTokenVariant>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::NormalizedTokenVariant>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::NormalizedTokenVariant>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTNormalizedToken *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
