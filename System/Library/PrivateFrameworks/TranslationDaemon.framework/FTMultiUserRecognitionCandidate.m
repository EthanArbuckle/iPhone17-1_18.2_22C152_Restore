...
- (FTMultiUserRecognitionCandidate)initWithFlatbuffData:(id)a3;
- (FTMultiUserRecognitionCandidate)initWithFlatbuffData:(id)a3 root:(const MultiUserRecognitionCandidate *)a4;
- (FTMultiUserRecognitionCandidate)initWithFlatbuffData:(id)a3 root:(const MultiUserRecognitionCandidate *)a4 verify:(BOOL)a5;
- (NSArray)recognition_candidate;
- (Offset<siri::speech::schema_fb::MultiUserRecognitionCandidate>)addObjectToBuffer:(void *)a3;
- (id)flatbuffData;
- (id)initAndVerifyWithFlatbuffData:(id)a3;
- (id)recognition_candidate_objectAtIndex:(unint64_t)a3;
- (unint64_t)recognition_candidate_count;
- (void)recognition_candidate_enumerateObjectsUsingBlock:(id)a3;
@end
...
- (FTMultiUserRecognitionCandidate)initWithFlatbuffData:(id)a3
{
  return [(FTMultiUserRecognitionCandidate *)self initWithFlatbuffData:a3 root:0 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FTMultiUserRecognitionCandidate *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FTMultiUserRecognitionCandidate)initWithFlatbuffData:(id)a3 root:(const MultiUserRecognitionCandidate *)a4
{
  return [(FTMultiUserRecognitionCandidate *)self initWithFlatbuffData:a3 root:a4 verify:0];
}
...
- (FTMultiUserRecognitionCandidate)initWithFlatbuffData:(id)a3 root:(const MultiUserRecognitionCandidate *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FTMultiUserRecognitionCandidate;
  v10 = [(FTMultiUserRecognitionCandidate *)&v26 init];
  if (!v10) {
    goto LABEL_13;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const MultiUserRecognitionCandidate *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_13;
  ...
  uint64_t v24 = 0;
  char v25 = 1;
  v19 = (siri::speech::schema_fb::MultiUserRecognitionCandidate *)v10->_root;
  if (!v19) {
    goto LABEL_13;
  }
  if (!siri::speech::schema_fb::MultiUserRecognitionCandidate::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_14:
  }
    v20 = 0;
  else {
...
- (NSArray)recognition_candidate
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"recognition_candidate"];
  if (!v3)
  {
...
uint64_t __56__FTMultiUserRecognitionCandidate_recognition_candidate__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (id)recognition_candidate_objectAtIndex:(unint64_t)a3
{
  BOOL v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"recognition_candidate"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FTRecognitionCandidate alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(unsigned int *)(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
  v8 = 0;
...
- (void)recognition_candidate_enumerateObjectsUsingBlock:(id)a3
{
  v4 = (void (**)(id, FTRecognitionCandidate *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"recognition_candidate"];
  v6 = v5;
  if (v5)
  {
    ...
    if (*(unsigned __int16 *)v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v17 = [[FTRecognitionCandidate alloc] initWithFlatbuffData:self->_data root:v13 + v14 + *(unsigned int *)(v13 + 4 * v15) verify:0];
            v4[2](v4, v17, v15, &v20);
            int v18 = v20;
...
- (Offset<siri::speech::schema_fb::MultiUserRecognitionCandidate>)addObjectToBuffer:(void *)a3
{
  ...
  unint64_t v5 = [(FTMultiUserRecognitionCandidate *)self recognition_candidate];
  ...
  long long v29 = 0u;
  long long v30 = 0u;
  v6 = [(FTMultiUserRecognitionCandidate *)self recognition_candidate];
  ...
  if (v33.__end_ == v33.__begin_) {
    std::vector<int>::pointer v22 = (std::vector<int>::pointer)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionCandidate>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionCandidate>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionCandidate>> const&)::t;
  }
  else {
...
- (id)flatbuffData
{
  ...
  __int16 v10 = 256;
  uint64_t v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish((apple::aiml::flatbuffers2::FlatBufferBuilder *)&v3, [(FTMultiUserRecognitionCandidate *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
