...
- (SBWindowCommitSwitcherModifier)initWithTransitionID:(id)a3 fromAppLayout:(id)a4 layoutRole:(int64_t)a5;
...
- (SBWindowCommitSwitcherModifier)initWithTransitionID:(id)a3 fromAppLayout:(id)a4 layoutRole:(int64_t)a5
{
  id v9 = a4;
  v20.receiver = self;
  v20.super_class = (Class)SBWindowCommitSwitcherModifier;
...
{
  v15.receiver = self;
  v15.super_class = (Class)SBWindowCommitSwitcherModifier;
  ...
  v8 = [(SBWindowCommitSwitcherModifier *)self appLayouts];
...
LABEL_8:
    ...
    v14[1] = 3221225472;
    v14[2] = __53__SBWindowCommitSwitcherModifier_transitionWillBegin__block_invoke;
    v14[3] = &unk_1E6AF4A70;
    v14[4] = self;
    v14[5] = v11;
...
id __53__SBWindowCommitSwitcherModifier_transitionWillBegin__block_invoke(uint64_t a1)
{
  ...
  v17.super_class = (Class)SBWindowCommitSwitcherModifier;
  ...
  *id v3 = v4;
  ...
  uint64_t v10 = v9 + 25;
  v16.receiver = v9;
  v16.super_class = (Class)SBWindowCommitSwitcherModifier;
...
{
  id v4 = a3;
  if ([(SBWindowCommitSwitcherModifier *)self isChamoisWindowingUIEnabled]
  ...
  {
    v9.receiver = self;
    v9.super_class = (Class)SBWindowCommitSwitcherModifier;
    uint64_t v6 = [(SBWindowCommitSwitcherModifier *)&v9 appLayoutContainingAppLayout:v4];
  }
  uint64_t v7 = v6;
...
- (id)adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip:(id)a3
{
  ...
  if ([(SBWindowCommitSwitcherModifier *)self isChamoisWindowingUIEnabled]
    ...
    && ([(SBWindowCommitSwitcherModifier *)self appLayoutOnStage],
        ...
        v7))
  {
    ...
    v22 = __Block_byref_object_dispose__68;
    id v23 = 0;
    v17.receiver = self;
    v17.super_class = (Class)SBWindowCommitSwitcherModifier;
    uint64_t v8 = [(SBWindowCommitSwitcherModifier *)&v17 appLayouts];
    v16[0] = MEMORY[0x1E4F143A8];
    v16[1] = 3221225472;
    v16[2] = __107__SBWindowCommitSwitcherModifier_adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip___block_invoke;
    v16[3] = &unk_1E6AF4B60;
    v16[4] = self;
    ...
    v12[1] = 3221225472;
    v12[2] = __107__SBWindowCommitSwitcherModifier_adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip___block_invoke_2;
    v12[3] = &unk_1E6AF6380;
    uint64_t v15 = &v18;
    id v13 = v4;
    uint64_t v14 = self;
  ...
  {
    v11.receiver = self;
    v11.super_class = (Class)SBWindowCommitSwitcherModifier;
    id v5 = [(SBWindowCommitSwitcherModifier *)&v11 adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip:v4];
  }
...
void __107__SBWindowCommitSwitcherModifier_adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip___block_invoke_2(uint64_t a1)
{
  ...
  v6.super_class = (Class)SBWindowCommitSwitcherModifier;
...
{
  v7.receiver = self;
  v7.super_class = (Class)SBWindowCommitSwitcherModifier;
  uint64_t v4 = [(SBWindowCommitSwitcherModifier *)&v7 appLayoutsToEnsureExistForMainTransitionEvent:a3];
...
{
  v12.receiver = self;
  v12.super_class = (Class)SBWindowCommitSwitcherModifier;
  ...
  {
    uint64_t v8 = [(SBWindowCommitSwitcherModifier *)self entityRemovalSettings];
...
- (double)dimmingAlphaForLayoutRole:(int64_t)a3 inAppLayout:(id)a4
{
  ...
  {
    objc_super v7 = [(SBWindowCommitSwitcherModifier *)self medusaSettings];
  ...
  else
  {
    v12.receiver = self;
    v12.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v12 dimmingAlphaForLayoutRole:a3 inAppLayout:v6];
    double v9 = v10;
  }
...
- (CGRect)frameForIndex:(unint64_t)a3
{
  id v5 = [(SBWindowCommitSwitcherModifier *)self appLayouts];
  ...
  if (v6 == self->_centerWindowAppLayout)
  {
    ...
    if ([(SBTransitionSwitcherModifier *)self isUpdatingLayout])
    {
      ...
      objc_super v16 = [(SBWindowCommitSwitcherModifier *)self entityRemovalSettings];
      objc_super v17 = [v16 dosidoDeclineIntentAnimationSettings];
      [v17 fromViewSlideOutHeightOffsetMultiplier];
      double v19 = v15 * v18;
  ...
  {
    v24.receiver = self;
    v24.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v24 frameForIndex:a3];
    CGFloat x = v7;
    double y = v9;
    CGFloat width = v11;
    CGFloat height = v13;
...
- (CGRect)frameForLayoutRole:(int64_t)a3 inAppLayout:(id)a4 withBounds:(CGRect)a5
{
        ...
        v15))
  {
    ...
    SBRectWithSize();
    -[SBWindowCommitSwitcherModifier frameForLayoutRole:inAppLayout:withBounds:](&v35, sel_frameForLayoutRole_inAppLayout_withBounds_, layoutRole, fromAppLayout, v18, v19, v20, v21, v34.receiver, v34.super_class, self, SBWindowCommitSwitcherModifier);
  }
  else
  {
    -[SBWindowCommitSwitcherModifier frameForLayoutRole:inAppLayout:withBounds:](&v34, sel_frameForLayoutRole_inAppLayout_withBounds_, a3, v12, x, y, width, height, self, SBWindowCommitSwitcherModifier, v35.receiver, v35.super_class);
  }
  double v26 = v22;
  double v27 = v23;
  double v28 = v24;
...
- (CGPoint)anchorPointForIndex:(unint64_t)a3
{
  ...
  {
    v13.receiver = self;
    v13.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v13 anchorPointForIndex:a3];
    double v8 = v7;
    double v10 = v9;
  }
...
- (double)opacityForLayoutRole:(int64_t)a3 inAppLayout:(id)a4 atIndex:(unint64_t)a5
{
    ...
    || (double v9 = 1.0, ![(SBTransitionSwitcherModifier *)self isUpdatingLayout]))
  {
    ...
    else
    {
      v12.receiver = self;
      v12.super_class = (Class)SBWindowCommitSwitcherModifier;
      [(SBWindowCommitSwitcherModifier *)&v12 opacityForLayoutRole:a3 inAppLayout:v8 atIndex:a5];
      double v9 = v10;
    }
  }
...
- (double)titleAndIconOpacityForIndex:(unint64_t)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v10 titleAndIconOpacityForIndex:a3];
    double v7 = v8;
  }
...
- (UIRectCornerRadii)cornerRadiiForIndex:(unint64_t)a3
{
  ...
  {
    v19.receiver = self;
    v19.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v19 cornerRadiiForIndex:a3];
    double topLeft = v11;
...
- (double)scaleForIndex:(unint64_t)a3
{
  ...
  {
    double v7 = [(SBWindowCommitSwitcherModifier *)self entityRemovalSettings];
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v13 scaleForIndex:a3];
    double v10 = v11;
  }
...
- (id)topMostLayoutElements
{
  v9.receiver = self;
  v9.super_class = (Class)SBWindowCommitSwitcherModifier;
  uint64_t v3 = [(SBWindowCommitSwitcherModifier *)&v9 topMostLayoutElements];
...
- (id)visibleAppLayouts
{
  v6.receiver = self;
  v6.super_class = (Class)SBWindowCommitSwitcherModifier;
  uint64_t v3 = [(SBWindowCommitSwitcherModifier *)&v6 visibleAppLayouts];
  uint64_t v4 = (void *)[v3 mutableCopy];
...
- (double)perspectiveAngleForAppLayout:(id)a3
{
  ...
  {
    v8.receiver = self;
    v8.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v8 perspectiveAngleForAppLayout:v4];
    double v5 = v6;
  }
...
- (SBSwitcherWallpaperGradientAttributes)wallpaperGradientAttributesForIndex:(unint64_t)a3
{
  double v5 = [(SBWindowCommitSwitcherModifier *)self appLayouts];
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = (Class)SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v13 wallpaperGradientAttributesForIndex:a3];
  }
  double v9 = Empty;
  double v10 = v8;
