...
+ (id)sb_legacy_roundCornerPadDisplayEdgeInfo
{
  ...
  v1 = (void *)sb_legacy_roundCornerPadDisplayEdgeInfo_sRoundCornerPadDisplayEdgeInfo;
  return v1;
}
...
+ (id)sb_legacy_homeButtonDeviceDisplayEdgeInfo
{
  ...
  v1 = (void *)sb_legacy_homeButtonDeviceDisplayEdgeInfo_sHomeButtonDeviceDisplayEdgeInfo;
  return v1;
}
