...
void ___SBXXSetShowsOverridesForRecording_block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned char *)(a1 + 52))
  {
    ...
    v11 = ___SBXXSetShowsOverridesForRecording_block_invoke_102;
    v12 = &unk_1E6AF5290;
    id v13 = *(id *)(a1 + 32);
    id v14 = *(id *)(a1 + 40);
    ...
    +[SBDaemonHandler addRequest:forKey:forDaemonPid:](SBDaemonHandler, "addRequest:forKey:forDaemonPid:", v2, *(void *)(a1 + 32), *(unsigned int *)(a1 + 48), v9, v10, v11, v12);
  }
  else
  {
    ...
    +[SBDaemonHandler removeRequestForKey:*(void *)(a1 + 32) forDaemonPid:*(unsigned int *)(a1 + 48)];
  }
}
...
void ___SBXXSetShowsOverridesForRecording_block_invoke_102(uint64_t a1)
{
  uint64_t v10 = *MEMORY[0x1E4F143B8];
  v2 = SBLogStatusBarish();
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
