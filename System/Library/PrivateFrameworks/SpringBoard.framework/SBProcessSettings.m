...
- (NSString)description
{
  return (NSString *)[(SBProcessSettings *)self descriptionWithMultilinePrefix:0];
}
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  objc_super v3 = [(SBProcessSettings *)self descriptionBuilderWithMultilinePrefix:a3];
  v4 = [v3 build];
