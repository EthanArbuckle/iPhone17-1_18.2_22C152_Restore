...
{
  v4.receiver = self;
  v4.super_class = (Class)SBPIPRotationGestureRecognizer;
...
- (void)touchesMoved:(id)a3 withEvent:(id)a4
{
  ...
  {
    uint64_t v7 = [(SBPIPRotationGestureRecognizer *)self state];
    ...
    long long v15 = [(SBPIPRotationGestureRecognizer *)self delegate];
    objc_super v16 = v15;
