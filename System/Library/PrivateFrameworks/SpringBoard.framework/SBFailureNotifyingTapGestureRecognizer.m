...
{
  v4.receiver = self;
  v4.super_class = (Class)SBFailureNotifyingTapGestureRecognizer;
  v2 = [(SBFailureNotifyingTapGestureRecognizer *)&v4 delegate];
  return (SBFailureNotifyingTapGestureRecognizerDelegate *)v2;
}
...
- (void)setState:(int64_t)a3
{
  uint64_t v5 = [(SBFailureNotifyingTapGestureRecognizer *)self state];
  if (a3 == 5 && v5 != 5)
  {
