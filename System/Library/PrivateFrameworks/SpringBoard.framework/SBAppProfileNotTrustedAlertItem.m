...
- (void)configure:(BOOL)a3 requirePasscodeForActions:(BOOL)a4
{
  ...
  v7 = [v6 localizedStringForKey:@"APP_PROFILE_NOT_TRUSTED_TITLE" value:&stru_1F3084718 table:@"SpringBoard"];
  [v5 setTitle:v7];
  ...
  v12 = [MEMORY[0x1E4F42948] modelSpecificLocalizedStringKeyForKey:@"APP_PROFILE_NOT_TRUSTED_BODY"];
  ...
  v16 = [v15 localizedStringForKey:@"APP_PROFILE_NOT_TRUSTED_CANCEL" value:&stru_1F3084718 table:@"SpringBoard"];
