  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (v12)
        {
          v13 = [MEMORY[0x1E4FAFFB0] resolutionPolicyInfoIsolation];
...
- (SBTraitsRoleResolvesOrientationInIsolationPolicySpecifier)initWithComponentOrder:(id)a3
{
  ...
  if (v3)
  {
    uint64_t v5 = [(SBTraitsRoleResolvesOrientationInIsolationPolicySpecifier *)v3 targetRole];
...
- (NSString)targetRole
{
  ...
  [v4 handleFailureInMethod:a2, self, @"SBTraitsOrientationStageComponents.m", 541, @"This class[%@] shouldn't be directly used, pick a subclass.", v6 object file lineNumber description];
