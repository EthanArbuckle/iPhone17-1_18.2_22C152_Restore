...
void __38___SBFocusAnimator_animateTransition___block_invoke(uint64_t a1)
{
  ...
  *(float *)&double v8 = preferred;
  objc_msgSend(v2, "sb_modifyAnimationsWithPreferredFrameRateRange:updateReason:animations:", 1703937, v9, v6, v7, v8);
}
...
uint64_t __38___SBFocusAnimator_animateTransition___block_invoke_3(uint64_t a1, uint64_t a2)
{
