...
- (void)noteActiveDisplayUpdated
{
  ...
  [(_SBContinuitySessionStateMachineStateUpdatingActiveDisplay *)self _reevaluateStateForReason:@"updated active display"];
}
...
- (void)_evaluateClientExternallyBlockedReasons
{
  ...
  if (!WeakRetained)
  {
    ...
    [v9 handleFailureInMethod:a2 object:self file:@"_SBContinuitySessionStateMachineStateUpdatingActiveDisplay.m" lineNumber:110 description:@"Must have _SBContinuitySessionStateMachineExternallyBlockedReasonsProvider"];
  }
  ...
  if (self->_isCurrentState && [v5 count])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_1D85BA000, v7, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because client blocked reasons are unexpected: %{public}@", (uint8_t *)&v10, 0xCu);
    }
...
- (void)_evaluateSystemEvents
{
  if (self->_isCurrentState)
  {
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUIBlocked])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v3, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because UI blocked ", v15, 2u);
      }
...
LABEL_14:
    ...
    if (![(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUILocked])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v8, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because UI unlocked", v15, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isInCall])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v7, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because in call", v15, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isSOSActive])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v10, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because SOS active", v15, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isLockScreenSearchPresented])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v11, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because lock screen search presented", v15, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUsingSecureApp])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v12, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because using secure app", v15, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isAirplayMirroring])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v13, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because airplay mirroring", v15, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUserInitiatedRemoteTransientOverlayPresented])
    {
      ...
      {
        *(_WORD *)v15 = 0;
        _os_log_impl(&dword_1D85BA000, v14, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid because user-initiated remote transient overlay is presented", v15, 2u);
      }
...
- (void)_evaluateLockState
{
  if (self->_isCurrentState)
  {
    ...
    if (v3 == 2)
    {
      ...
      {
        *(_WORD *)int v10 = 0;
        _os_log_impl(&dword_1D85BA000, v8, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid keybag has been unexpectedly unlocked", v10, 2u);
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_1D85BA000, v4, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .invalid keybag has been unexpectedly locked", buf, 2u);
      }
...
- (void)_reevaluateStateForReason:(id)a3
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      int v13 = 138543362;
      id v14 = v4;
      _os_log_impl(&dword_1D85BA000, v5, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] Re-evaluating state for reason: %{public}@", (uint8_t *)&v13, 0xCu);
    }
    ...
    if (v8)
    {
      if (v10)
      {
        ...
        int v13 = 138543362;
        id v14 = v11;
        _os_log_impl(&dword_1D85BA000, v9, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] still blocked by %{public}@", (uint8_t *)&v13, 0xCu);
      }
    ...
    else
    {
      ...
      {
        LOWORD(v13) = 0;
        _os_log_impl(&dword_1D85BA000, v9, OS_LOG_TYPE_DEFAULT, "[State.UpdatingActiveDisplay] --> moving to .launching", (uint8_t *)&v13, 2u);
      }
