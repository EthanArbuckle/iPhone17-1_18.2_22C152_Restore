    ...
    *(_OWORD *)host_info64_out = 0u;
    ...
    else
    {
      ...
      else
      {
        ...
        v14 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:_filebackedBytes + _freeBytes];
        [(id)_sumMemoryAtEachPriority setObject:v14 forKeyedSubscript:&unk_1F400BF68];

        v11 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:_wiredBytes];
        [(id)_sumMemoryAtEachPriority setObject:v11 forKeyedSubscript:&unk_1F400BF80];
      }
    }
...
- (void)addProcessFootprint:(unint64_t)a3 withPriority:(int)a4
{
  id v11 = [MEMORY[0x1E4F28ED0] numberWithInt:*(void *)&a4];
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        v18 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:v13];
...
- (id)systemMemoryStatsDictionary
{
  ...
  v11[0] = @"wired_down";
  v2 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_wiredBytes >> 10];
  v12[0] = v2;
  v11[1] = @"file_backed";
  host_t v3 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_filebackedBytes >> 10];
  v12[1] = v3;
  v11[2] = @"free";
  uint64_t v4 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_freeBytes >> 10];
  v12[2] = v4;
  v11[3] = @"occupied_by_compressor";
  id v5 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_occupiedByCompressorBytes >> 10];
  v12[3] = v5;
  v11[4] = @"stored_in_compressor";
  id v6 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_storedInCompressorBytes >> 10];
  v12[4] = v6;
  v11[5] = @"speculative";
  id v7 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_speculativeBytes >> 10];
  v12[5] = v7;
  v11[6] = @"anonymous";
  uint64_t v8 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(unint64_t)_anonymousBytes >> 10];
  v12[6] = v8;
