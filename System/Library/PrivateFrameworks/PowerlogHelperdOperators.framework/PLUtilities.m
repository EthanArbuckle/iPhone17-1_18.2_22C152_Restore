...
+ (BOOL)moveItemAtPath:(id)a3 toPath:(id)a4 withName:(id)a5 error:(id *)a6
{
  ...
  v13 = [MEMORY[0x1E4F1CB10] fileURLWithPath:v8];
  int v14 = OSAMoveFileForSubmissions();

  if (v14)
  {
    v15 = [v8 lastPathComponent];
    v16 = [@"/var/mobile/Library/Logs/CrashReporter/" stringByAppendingPathComponent:v15];
...
+ (BOOL)PLCopyItemsFromPath:(id)a3 toPath:(id)a4
{
  ...
  {
    v12 = [MEMORY[0x1E4F1CB10] fileURLWithPath:v5 isDirectory:1];
    v13 = [MEMORY[0x1E4F1CB10] fileURLWithPath:v6 isDirectory:1];
...
+ (BOOL)createAndChownDirectory:(id)a3
{
  ...
  else
  {
    ...
    id v9 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
    id v10 = [v9 lastPathComponent];
    char v11 = [NSString stringWithUTF8String:"+[PLUtilities createAndChownDirectory:]"];
    [v8 logMessage:v7 fromFile:v10 fromFunction:v11 fromLineNumber:208];
...
+ (void)setPermissionsForFile:(id)a3 toValue:(unsigned __int16)a4
{
  ...
  id v7 = [MEMORY[0x1E4F28ED0] numberWithUnsignedShort:v4];
  v18[0] = v7;
...
+ (BOOL)compressWithSource:(id)a3 withDestination:(id)a4 withLevel:(int)a5
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v7;
    _os_log_impl(&dword_1E4220000, v8, OS_LOG_TYPE_DEFAULT, "compressWithSource: source file = %@, destination file = %@", (uint8_t *)&v22, 0x16u);
  }
...
LABEL_18:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v12;
    _os_log_impl(&dword_1E4220000, v21, OS_LOG_TYPE_DEFAULT, "compressWithSource: successfully decompressed %@ to %@", (uint8_t *)&v22, 0x16u);
  }
...
+ (BOOL)decompressWithSource:(id)a3 withDestination:(id)a4 withRemoveSrc:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v33 = 2112;
    id v34 = v8;
    _os_log_impl(&dword_1E4220000, v14, OS_LOG_TYPE_DEFAULT, "decompressWithSource: source file = %@, destination file = %@", buf, 0x16u);
  }
...
LABEL_24:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v33 = 2112;
    id v34 = v18;
    _os_log_impl(&dword_1E4220000, v28, OS_LOG_TYPE_DEFAULT, "decompressWithSource: successfully decompressed %@ to %@", buf, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v13 = 1024;
      int v14 = v8;
      _os_log_impl(&dword_1E4220000, v7, OS_LOG_TYPE_DEFAULT, "Num files at %@ = %d", buf, 0x12u);
    }
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 138412290;
        v40 = v22;
        _os_log_impl(&dword_1E4220000, v23, OS_LOG_TYPE_INFO, "Removing files: %@", buf, 0xCu);
      }
            ...
            if (v8 && ([v8 containsObject:v25] & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138412546;
                ...
                __int16 v39 = 2112;
                v40 = v27;
                _os_log_debug_impl(&dword_1E4220000, v26, OS_LOG_TYPE_DEBUG, "Skipping %@ for marking as purgeable -- file is of type '%@' & doesn't not match given extension filter.", buf, 0x16u);
              }
            }
  ...
  if (v8)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138413058;
      ...
      __int16 v23 = 2080;
      __int16 v24 = v13;
      _os_log_error_impl(&dword_1E4220000, v10, OS_LOG_TYPE_ERROR, "Failed to mark %@ purgeable - flags 0x%llx returned %d (%s)", buf, 0x26u);
    }
LABEL_7:
    BOOL v14 = 0;
    goto LABEL_11;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v19 = 2048;
    unint64_t v20 = a4;
    _os_log_impl(&dword_1E4220000, v10, OS_LOG_TYPE_DEFAULT, "Marked %@ purgeable with urgency: %llu", buf, 0x16u);
  }
  BOOL v14 = 1;
LABEL_11:
...
+ (id)workQueueForClass:(Class)a3
{
  id v3 = NSStringFromClass(a3);
  uint64_t v4 = +[PLUtilities workQueueForKey:v3];
...
+ (id)workQueueForKey:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (!v5)
    {
      ...
      int v7 = dispatch_queue_attr_make_with_qos_class(v6, (dispatch_qos_class_t)workQueueForKey__qos, 0);
...
+ (void)dispatchSyncIfNotCallerQueue:(id)a3 withBlock:(id)a4
{
  ...
  int v7 = dispatch_queue_get_label((dispatch_queue_t)a3);
  if (!strcmp(label, v7))
  {
    v5[2](v5);
  }
...
+ (void)postNotificationName:(id)a3 object:(id)a4 userInfo:(id)a5
{
  ...
  BOOL v10 = postNotificationName_object_userInfo__notificationQueue;
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
+ (id)dateFromTimeval:(timeval)a3
{
  double v3 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSince1970:(double)a3.tv_usec / 1000000.0 + (double)a3.tv_sec];
  double v4 = [v3 convertFromSystemToMonotonic];
...
+ (id)deviceBootUUID
{
  ...
  size_t v25 = 37;
  int v2 = sysctlbyname("kern.bootsessionuuid", v26, &v25, 0, 0);
  if (v2)
  {
    if (v2 == -1) {
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      if (deviceBootUUID_classDebugEnabled)
      {
        ...
        uint64_t v6 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
        id v7 = [v6 lastPathComponent];
        id v8 = [NSString stringWithUTF8String:"+[PLUtilities deviceBootUUID]"];
        [v5 logMessage:v4 fromFile:v7 fromFunction:v8 fromLineNumber:821];
...
LABEL_17:
  ...
  else
  {
    ...
    id v12 = [NSString stringWithUTF8String:v26];
    BOOL v10 = (void *)[v11 initWithUUIDString:v12];
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      __int16 v21 = __29__PLUtilities_deviceBootUUID__block_invoke_117;
      int v22 = &__block_descriptor_40_e5_v8__0lu32l8;
      uint64_t v23 = v13;
      if (deviceBootUUID_defaultOnce_115 != -1) {
        dispatch_once(&deviceBootUUID_defaultOnce_115, &v19);
      }
      if (deviceBootUUID_classDebugEnabled_116)
      {
        size_t v4 = [NSString stringWithFormat:@"system boot session uuid: %@", v10, v19, v20, v21, v22, v23];
        BOOL v14 = (void *)MEMORY[0x1E4F929B8];
        id v15 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
        id v16 = [v15 lastPathComponent];
        id v17 = [NSString stringWithUTF8String:"+[PLUtilities deviceBootUUID]"];
        [v14 logMessage:v4 fromFile:v16 fromFunction:v17 fromLineNumber:826];
...
uint64_t __29__PLUtilities_deviceBootUUID__block_invoke_117(uint64_t a1)
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
...
{
  id v4 = +[PLUtilities deviceBootUUID];
  if (!v4)
  {
    deviceRebooted___deviceRebooted = 0;
    goto LABEL_9;
  }
  uint64_t v0 = [MEMORY[0x1E4F929C0] objectForKey:@"BootSessionUUID"];
  if (v0)
  {
  ...
  int v2 = (void *)MEMORY[0x1E4F929C0];
...
+ (double)getLastSystemTimeOffset
{
  int v2 = [MEMORY[0x1E4F92A60] entryKeyForType:*MEMORY[0x1E4F92D30] andName:*MEMORY[0x1E4F92D90]];
  uint64_t v3 = [MEMORY[0x1E4F92AD0] sharedCore];
  id v4 = [v3 storage];
  id v5 = [v4 lastEntryForKey:v2];

  uint64_t v6 = [v5 objectForKeyedSubscript:*MEMORY[0x1E4F92D98]];
  [v6 doubleValue];
  double v8 = v7;
...
+ (id)getFirstBatteryTimestamp
{
  int v2 = [MEMORY[0x1E4F92AD0] sharedCore];
  uint64_t v3 = [v2 storage];
  id v4 = [v3 firstEntryForKey:@"PLBatteryAgent_EventBackward_Battery"];
...
+ (void)getCurrentMonotonicAndMachAbsTime:(id *)a3 machAbsTime:(unint64_t *)a4 machContTime:(unint64_t *)a5
{
  ...
  uint64_t v29 = 0;
  uint64_t v30 = 0;
  double v8 = (unsigned int *)[a1 getMachTimebase];
  if (mach_get_times())
  {
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      {
        uint64_t v10 = [NSString stringWithFormat:@"mach_get_times() call failed."];
        uint64_t v11 = (void *)MEMORY[0x1E4F929B8];
        uint64_t v12 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
        uint64_t v13 = [v12 lastPathComponent];
        uint64_t v14 = [NSString stringWithUTF8String:"+[PLUtilities getCurrentMonotonicAndMachAbsTime:machAbsTime:machContTime:]"];
        [v11 logMessage:v10 fromFile:v13 fromFunction:v14 fromLineNumber:899];
  ...
  {
    uint64_t v16 = +[PLUtilities dateFromTimeval:](PLUtilities, "dateFromTimeval:", v31, ((int)v32 / 1000));
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      if (getCurrentMonotonicAndMachAbsTime_machAbsTime_machContTime__classDebugEnabled)
      {
        ...
        uint64_t v20 = [v18 stringWithFormat:@"Converted monotonic time: %@, reference monotonic time: %@.", v16, v19];

        __int16 v21 = (void *)MEMORY[0x1E4F929B8];
        int v22 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
        uint64_t v23 = [v22 lastPathComponent];
        __int16 v24 = [NSString stringWithUTF8String:"+[PLUtilities getCurrentMonotonicAndMachAbsTime:machAbsTime:machContTime:]"];
        [v21 logMessage:v20 fromFile:v23 fromFunction:v24 fromLineNumber:888];

        size_t v25 = PLLogCommon();
...
uint64_t __74__PLUtilities_getCurrentMonotonicAndMachAbsTime_machAbsTime_machContTime___block_invoke_136(uint64_t a1)
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
...
+ (unint64_t)getCurrMachAbsTimeInSecs
{
  ...
  id v4 = (unsigned int *)[a1 getMachTimebase];
...
void __37__PLUtilities_exitWithReason_action___block_invoke(uint64_t a1)
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    id v3 = (void *)MEMORY[0x1E4F929B8];
    uint64_t v4 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
    uint64_t v5 = [v4 lastPathComponent];
    char v6 = [NSString stringWithUTF8String:"+[PLUtilities exitWithReason:action:]_block_invoke"];
    [v3 logMessage:v2 fromFile:v5 fromFunction:v6 fromLineNumber:979];

    signed __int16 v7 = PLLogCommon();
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 138412290;
      char v28 = v2;
      _os_log_debug_impl(&dword_1E4220000, v7, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
    }
  }
  ...
  else
  {
    ...
    char v11 = [v10 storage];
    char v9 = [v11 storageLocked];
  }
  int v12 = *(__int16 *)(a1 + 32);
  if (v12 > 99 || (v9 & 1) != 0)
  {
    if (v12 >= 1001)
    {
      uint64_t v16 = +[PLUtilities containerPath];
      uint64_t v17 = [v16 stringByAppendingString:@"/Library/BatteryLife/Quarantine/"];
      +[PLUtilities createAndChownDirectory:v17];

      id v18 = +[PLUtilities containerPath];
      uint64_t v19 = [v18 stringByAppendingString:@"/Library/PerfPowerTelemetry/Quarantine/"];
      +[PLUtilities createAndChownDirectory:v19];

      uint64_t v20 = @"%@CorruptPowerlog_%f%@";
      __int16 v21 = @"PLExitReasonCorrupt";
      int v22 = @"com.apple.power.error.corruptDB";
      switch(*(_WORD *)(a1 + 32))
      {
        case 0x3E9:
          goto LABEL_24;
        case 0x3EA:
          __int16 v8 = 0;
          uint64_t v20 = @"%@SubmissionTimeoutPowerlog_%f%@";
          __int16 v21 = @"PLExitReasonSubmissionTimeout";
          int v22 = @"com.apple.power.error.SubmissionTimeoutDB";
          goto LABEL_24;
        case 0x3EB:
          uint64_t v20 = @"%@ArchiveTimeoutPowerlog_%f%@";
          __int16 v21 = @"PLExitReasonArchiveTimeout";
          int v22 = @"com.apple.power.error.ArchiveTimeoutDB";
          goto LABEL_24;
        case 0x3EC:
          uint64_t v20 = @"%@ArchiveMaxAttemptsPowerlog_%f%@";
          __int16 v21 = @"PLExitReasonArchiveMaxAttempts";
          int v22 = @"com.apple.power.error.ArchiveMaxAttemptsDB";
          goto LABEL_24;
        case 0x3ED:
          uint64_t v20 = @"%@TooLargePowerlog_%f%@";
          __int16 v21 = @"PLExitReasonTooLarge";
          int v22 = @"com.apple.power.error.tooLargeDB";
          goto LABEL_24;
        case 0x3EE:
          uint64_t v20 = @"%@MonotonicTimePowerlog_%f%@";
          __int16 v8 = 6;
          __int16 v21 = @"PLExitReasonMonotonicTime";
          int v22 = @"com.apple.power.error.monotonicTimeDB";
          goto LABEL_24;
        case 0x3EF:
          uint64_t v20 = @"%@SQLVersionMismatchPowerlog_%f%@";
          __int16 v21 = @"PLExitReasonSQLVersionMismatch";
          int v22 = @"com.apple.power.error.SQLVersionMismatchDB";
          goto LABEL_24;
        case 0x3F0:
          uint64_t v20 = @"%@NewFileRequiredPowerlog_%f%@";
          __int16 v21 = @"PLExitReasonNewFileRequired";
          int v22 = @"com.apple.power.error.NewFileRequiredDB";
          goto LABEL_24;
        case 0x3F1:
          uint64_t v20 = @"%@KernelTimePowerlog_%f%@";
          __int16 v8 = 6;
          __int16 v21 = @"kPLExitReasonDescKernelTime";
          int v22 = @"com.apple.power.error.kernelTimeDB";
LABEL_24:
          MEMORY[0x1E4E7E330](v22, 1);
          AnalyticsSendEventLazy();
          break;
        default:
          __int16 v21 = 0;
      ...
      [MEMORY[0x1E4F929C0] setObject:0 forKey:@"PLUUID" saveToDisk:1];
LABEL_28:
      if (!+[PLUtilities isPowerlogHelperd])
      {
        uint64_t v23 = (void *)MEMORY[0x1E4F929C0];
        __int16 v24 = [MEMORY[0x1E4F28ED0] numberWithShort:*(__int16 *)(a1 + 32)];
        [v23 setObject:v24 forKey:@"PLExitReasonKey" saveToDisk:1];
      }
      int v25 = *(__int16 *)(a1 + 32);
      if (v25 >= 1001)
      {
        id v26 = PLLogCommon();
        if (os_log_type_enabled(v26, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v29 = 1024;
          int v30 = v8;
          _os_log_fault_impl(&dword_1E4220000, v26, OS_LOG_TYPE_FAULT, "Exiting due to %{public}@ action=%d", buf, 0x12u);
        }
  ...
  {
    char v13 = [MEMORY[0x1E4F92AD0] sharedCore];
    uint64_t v14 = [v13 storage];
    int v15 = objc_msgSend(NSString, "stringWithFormat:", @"ExitReason=%i", *(__int16 *)(a1 + 32));
...
+ (void)quarantineToPath:(id)a3 action:(signed __int16)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 67109120;
    BOOL v55 = v4;
    _os_log_impl(&dword_1E4220000, v10, OS_LOG_TYPE_DEFAULT, "quarantine action: %hd", buf, 8u);
  }

  if (v4 == 6 || v4 == 1)
  {
    char v11 = NSString;
    int v12 = +[PLUtilities containerPath];
    ...
    int v15 = [MEMORY[0x1E4F92AB0] sharedSQLStorage];
  ...
  if ((v4 | 4) == 6)
  {
    ...
    __int16 v21 = [MEMORY[0x1E4F92AB0] sharedSQLStorage];
  ...
  if (v4 == 6 || v4 == 3)
  {
    ...
    int v25 = [v24 stringByAppendingString:@"/Library/PerfPowerTelemetry/Quarantine/"];
    uint64_t v26 = objc_msgSend(v23, "stringWithFormat:", v5, v25, v8, @".CESQL");

    uint64_t v27 = [MEMORY[0x1E4F92AB0] sharedSQLStorage];
    char v28 = [v27 CESQLConnection];
  ...
  if ((v4 | 2) == 6)
  {
    ...
    int v30 = +[PLUtilities containerPath];
    uint64_t v31 = [v30 stringByAppendingString:@"/Library/PerfPowerTelemetry/Quarantine/"];
    uint64_t v32 = objc_msgSend(v29, "stringWithFormat:", v5, v31, v8, @".XCSQL");

    long long v33 = [MEMORY[0x1E4F92AB0] sharedSQLStorage];
  ...
  if ((unsigned __int16)(v4 - 5) <= 1u)
  {
    ...
    __int16 v39 = [MEMORY[0x1E4F92AB0] sharedSQLStorage];
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 67109120;
    BOOL v55 = v41;
    _os_log_impl(&dword_1E4220000, v42, OS_LOG_TYPE_DEFAULT, "should quarantine: %d", buf, 8u);
  }
  ...
  if ([MEMORY[0x1E4F929C0] fullMode] && (v4 == 6 || v4 == 1))
  {
    v44 = NSString;
...
+ (BOOL)allowQueryFromPeer:(id)a3
{
  ...
  if (v9)
  {
    ...
    char v11 = +[PLUtilities processNameForPid:pid];
    int v12 = +[PLUtilities bundleIDFromPid:pid];
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&token[30] = CodeSignStatus;
      _os_log_impl(&dword_1E4220000, v13, OS_LOG_TYPE_INFO, "query from pid:%d procName:%@ bundleID:%@ csStatus:%d", token, 0x22u);
    }
  }
  if ((CodeSignStatus & 0xC000001) == 0x4000001)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&token[4] = CodeSignStatus;
      ...
      uint32_t v17 = 8;
LABEL_15:
      _os_log_impl(&dword_1E4220000, v16, OS_LOG_TYPE_INFO, v15, token, v17);
      goto LABEL_16;
    }
    goto LABEL_16;
  }
  if (!v7 || ![MEMORY[0x1E4F92A38] internalBuild])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)token = 67109120;
      *(_DWORD *)&token[4] = CodeSignStatus;
      _os_log_impl(&dword_1E4220000, v19, OS_LOG_TYPE_INFO, "query denied %d", token, 8u);
    }
...
+ (id)getPerfStatsForProcess:(id)a3
{
  ...
  int v12 = [v8 stringWithFormat:@"SELECT LaunchdName AS BundleID, SUM(cpu_time) AS cpu_seconds, SUM(cpu_instructions) AS cpu_instructions, SUM(cpu_cycles) AS cpu_cycles FROM %@ where LaunchdName = '%@' AND timestamp >= %f and timestamp < %f", @"PLCoalitionAgent_EventInterval_CoalitionInterval", v4, v10, v11];
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    int v25 = v12;
    _os_log_impl(&dword_1E4220000, v13, OS_LOG_TYPE_DEFAULT, "[Perf Stats Query] %@", buf, 0xCu);
  }

  uint64_t v14 = [MEMORY[0x1E4F92A40] sharedSQLiteConnection];
  ...
  if ([v15 count]
    && ([v15 firstObject],
        ...
        !v18))
  {
    __int16 v21 = PLLogCommon();
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      uint64_t v22 = [v15 firstObject];
      *(_DWORD *)buf = 138412290;
      int v25 = v22;
      _os_log_impl(&dword_1E4220000, v21, OS_LOG_TYPE_DEFAULT, "Report perf stats to CA for %@", buf, 0xCu);
    }
...
+ (id)getIdentifierFromEntry:(id)a3
{
  ...
  if ([v4 isEqualToString:&stru_1F3FCA098])
  {
    id v5 = [v3 objectForKeyedSubscript:@"LaunchdName"];
    char v6 = +[PLUtilities launchdNameToProcessName:v5];
    uint64_t v7 = v6;
    if (v6)
    {
      id v8 = v6;
...
void __40__PLUtilities_launchdNameToProcessName___block_invoke()
{
  ...
  launchdNameToProcessName__launchdNameToProcessNameDict = (uint64_t)&unk_1F400EB60;
}

+ (id)binaryPathForPid:(int)a3
{
  uint64_t v7 = *MEMORY[0x1E4F143B8];
  uint64_t v3 = objc_msgSend([NSString alloc], "initWithBytes:length:encoding:", buffer, proc_pidpath(a3, buffer, 0x1000u), 4);
...
+ (id)bundleIDFromProcessName:(id)a3
{
  ...
  if (v3 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [v3 length])
  {
    ...
    else
    {
      ...
      id v7 = v3;
      id v16 = v7;
      id v8 = (void (**)(void, void, void))MEMORY[0x1E4E7F1C0](v15);
      id v9 = ((void (**)(void, __CFString *, void))v8)[2](v8, @"PLProcessMonitorAgent_EventForward_ProcessID", *MEMORY[0x1E4F92CC8]);
      uint64_t v10 = v9;
      if (v9
        && (uint64_t v11 = *MEMORY[0x1E4F92C38],
            [v9 objectForKeyedSubscript:*MEMORY[0x1E4F92C38]],
            int v12 = objc_claimAutoreleasedReturnValue(),
            v12,
            v12))
      {
        char v13 = [v10 objectForKeyedSubscript:v11];
      }
      else
      {
        uint64_t v14 = ((void (**)(void, __CFString *, __CFString *))v8)[2](v8, @"PLApplicationAgent_EventNone_AllApps", @"AppExecutable");

        char v13 = [v14 objectForKeyedSubscript:@"AppBundleId"];
        uint64_t v10 = v14;
      }
      [(id)bundleIDFromProcessName__processNameToBundleID setObject:v13 forKeyedSubscript:v7];
...
id __39__PLUtilities_bundleIDFromProcessName___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  id v5 = (objc_class *)MEMORY[0x1E4F92A90];
  id v6 = a3;
  id v7 = a2;
  id v8 = (void *)[[v5 alloc] initWithKey:v6 withValue:*(void *)(a1 + 32) withComparisonOperation:0];

  id v9 = [MEMORY[0x1E4F92AD0] sharedCore];
  uint64_t v10 = [v9 storage];
  v14[0] = v8;
  uint64_t v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:v14 count:1];
  int v12 = [v10 lastEntryForKey:v7 withComparisons:v11 isSingleton:1];
      ...
      if (v16 >= 1)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v22 = 1024;
          int v23 = v11;
          _os_log_debug_impl(&dword_1E4220000, v18, OS_LOG_TYPE_DEBUG, "checking %@ (%d)", buf, 0x12u);
        }
...
+ (BOOL)isDaemonOrAppleXPCService:(int)a3
{
  ...
  unint64_t v5 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithInt:");
  id v13 = 0;
...
void __42__PLUtilities_shouldLogPreUnlockTelemetry__block_invoke()
{
  if (+[PLUtilities PreUnlockTelemetryEnabled])
  {
    id v0 = [MEMORY[0x1E4F92AD0] sharedCore];
    id v1 = [v0 storage];
...
+ (BOOL)gasGaugeEnabled
{
  if ([MEMORY[0x1E4F929C0] isDevBoard]) {
    return 0;
  }
  else {
    return [MEMORY[0x1E4F92A38] isiPod] ^ 1;
  }
}
...
void __25__PLUtilities_hasBattery__block_invoke()
{
  ...
  if (os_log_type_enabled(v0, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_1E4220000, v0, OS_LOG_TYPE_DEFAULT, "Battery detected: %d", (uint8_t *)v1, 8u);
  }
}
...
{
  id v0 = [MEMORY[0x1E4F929C0] objectForKey:@"BUI_DEMO_MODE" forApplicationID:@"com.apple.powerlogd" synchronize:1];
...
+ (BOOL)isALSCurveHigherThanDefault
{
  return [MEMORY[0x1E4F92A10] alsCurveHigherThanDefault];
}
...
{
  if ([MEMORY[0x1E4F929C0] objectExistsForKey:@"PLSalt"]) {
    [MEMORY[0x1E4F929C0] objectForKey:@"PLSalt" synchronize:1];
  }
  else {
...
+ (id)hashBundleID:(id)a3
{
  ...
  if (!saltBundleID)
  {
    if ([MEMORY[0x1E4F929C0] objectExistsForKey:@"PLSaltBundleID"]) {
      [MEMORY[0x1E4F929C0] objectForKey:@"PLSaltBundleID" synchronize:1];
    }
    else {
...
+ (id)generateAndUpdateSaltValue:(id)a3
{
  ...
  [MEMORY[0x1E4F929C0] setObject:v6 forKey:v4 saveToDisk:1];
...
+ (id)getAllowblocklist
{
  return (id)MEMORY[0x1F4145E30](a1, a2);
}

+ (id)getSessionsAllowlist
{
  return (id)MEMORY[0x1F4145E48](a1, a2);
}

+ (BOOL)shouldLogForEntryKey:(id)a3
{
  id v3 = a3;
  if (([MEMORY[0x1E4F92AC0] PPSEnabled:v3] & 1) != 0
  ...
  {
    uint64_t v5 = +[PLUtilities getAllowblocklist];
    CC_LONG v6 = v5;
    if (v5)
    {
...
+ (signed)logModeForEntryKey:(id)a3 withKey:(id)a4 andValue:(id)a5
{
  id v6 = a3;
  id v7 = a4;
  if ([MEMORY[0x1E4F92AC0] PPSEnabled:v6])
  {
    signed __int16 v8 = 0;
  }
  else
  {
    uint64_t v9 = +[PLUtilities modeForEntryKey:v6 withKeyName:v7];
    if (!v9)
    {
      uint64_t v10 = +[PLUtilities modeForEntryKey:v6 withKeyName:@"__Allow_Dynamic__"];
      uint64_t v11 = v10;
      if (v10)
      {
        if ([v10 BOOLValue]) {
    ...
    signed __int16 v8 = +[PLUtilities canLogMode:fullMode:](PLUtilities, "canLogMode:fullMode:", v9, [MEMORY[0x1E4F929C0] fullMode]);
  }
  return v8;
}
...
+ (id)modeForEntryKey:(id)a3 withKeyName:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (v9)
    {
      ...
      uint64_t v9 = [v10 objectForKeyedSubscript:v6];
    }
  }
  else
  {
...
+ (id)deviceBootArgs
{
  if (deviceBootArgs_onceToken != -1) {
    dispatch_once(&deviceBootArgs_onceToken, &__block_literal_global_526);
  }
...
void __29__PLUtilities_deviceBootArgs__block_invoke()
{
  ...
  free(v1);
  id v5 = (void *)deviceBootArgs_bootArgs;
...
+ (id)allSubClassesForClass:(Class)a3
{
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    id v5 = (void *)MEMORY[0x1E4F929B8];
    id v6 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
    id v7 = [v6 lastPathComponent];
    signed __int16 v8 = [NSString stringWithUTF8String:"+[PLUtilities allSubClassesForClass:]"];
    [v5 logMessage:v4 fromFile:v7 fromFunction:v8 fromLineNumber:2004];
  ...
  uint64_t v11 = objc_copyClassList(&outCount);
  if (outCount)
  {
...
+ (id)JSONSanitizeDictionary:(id)a3
{
  ...
  if (([MEMORY[0x1E4F28D90] isValidJSONObject:v3] & 1) == 0)
  {
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      double v8 = [NSString stringWithUTF8String:"+[PLUtilities JSONSanitizeDictionary:]"];
      [v5 logMessage:v4 fromFile:v7 fromFunction:v8 fromLineNumber:2055];
    ...
    v14[1] = 3221225472;
    void v14[2] = __38__PLUtilities_JSONSanitizeDictionary___block_invoke;
    v14[3] = &unk_1E6E48248;
    id v11 = v10;
    id v15 = v11;
...
void __38__PLUtilities_JSONSanitizeDictionary___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (([v6 isNil] & 1) == 0)
  {
    ...
    {
      double v9 = [NSString stringWithFormat:@"JSON: unable to serialize key=%@ value=%@", v5, v6];
      uint64_t v10 = (void *)MEMORY[0x1E4F929B8];
      id v11 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Utilities/PLUtilities.m"];
      id v12 = [v11 lastPathComponent];
      id v13 = [NSString stringWithUTF8String:"+[PLUtilities JSONSanitizeDictionary:]_block_invoke"];
      [v10 logMessage:v9 fromFile:v12 fromFunction:v13 fromLineNumber:2066];
...
+ (BOOL)isValidString:(id)a3
{
  ...
  if (v3 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    int v4 = [v3 isEqualToString:&stru_1F3FCA098] ^ 1;
  }
  else {
    LOBYTE(v4) = 0;
  }
...
+ (process_memory_limit_info)getProcessMemoryLimit:(int)a3
{
  ...
  if (v14 != v21 && os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 67109632;
    ...
    __int16 v26 = 1024;
    int v27 = v21;
    _os_log_impl(&dword_1E4220000, MEMORY[0x1E4F14500], OS_LOG_TYPE_DEFAULT, "memory limits do not match for pid %i (get_prio_list=%i, get_memlimit_props=%i)", buf, 0x14u);
  }
...
+ (id)cleanLaunchdApplicationMacOS:(id)a3
{
  ...
  {
    BOOL v4 = &stru_1F3FCA098;
  }
  else
  {
    uint64_t v5 = &stru_1F3FCA098;
    unint64_t v6 = 1;
    do
    {
...
+ (id)powerlogDefaultForKey:(id)a3
{
  return (id)[MEMORY[0x1E4F929C0] objectForKey:a3 forApplicationID:@"com.apple.powerlogd" synchronize:1];
}
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (objc_msgSend(v10, "rangeOfString:", @"-", (void)v14) != 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          int v12 = [v10 stringByReplacingOccurrencesOfString:@"-" withString:@"_"];
...
+ (id)removeFirstPartyBundleIDPrefix:(id)a3
{
  return (id)[a3 stringByReplacingOccurrencesOfString:@"com.apple." withString:&stru_1F3FCA098];
}
...
+ (double)scaledPowerBasedOnPoint:(double)a3 withPowerModel:(id)a4
{
  ...
  id v5 = a4;
  double v6 = 0.0;
  if (([MEMORY[0x1E4F92A38] isHomePod] & 1) == 0 && a3 > 0.0 && v5 != 0)
  {
...
LABEL_8:
      ...
      while (1)
      {
        ...
        long long v17 = *(void **)(*((void *)&v33 + 1) + 8 * v15);
...
+ (id)powerModelForOperatorName:(id)a3
{
  ...
  {
    BOOL v4 = (void *)MEMORY[0x1E4F1CC08];
  }
  else
  {
    id v5 = getPowermodels();
    BOOL v4 = [v5 objectForKeyedSubscript:v3];
  }
  return v4;
}
...
+ (id)torchTypeString
{
  if (([MEMORY[0x1E4F92A38] isHomePod] & 1) == 0 && torchTypeString_onceToken != -1) {
...
{
  unsigned int v0 = [MEMORY[0x1E4F92A38] kPLTorchClassOfDevice] - 1007002;
  if (v0 > 2) {
    id v1 = @"N41";
  }
  else {
    id v1 = off_1E6E483C0[v0];
  }
  uint64_t v2 = (void *)torchTypeString__torchTypeString;
...
+ (id)MavRevStringQuery
{
  ...
  uint64_t v2 = (void *)MavRevStringQuery_plMavRevString;
  return v2;
}

void __32__PLUtilities_MavRevStringQuery__block_invoke()
{
  unsigned int v0 = [MEMORY[0x1E4F92A38] kPLBasebandClassOfDevice] - 1003001;
  if (v0 > 0x10) {
    id v1 = 0;
  }
  else {
    id v1 = off_1E6E483D8[v0];
  }
  uint64_t v2 = (void *)MavRevStringQuery_plMavRevString;
...
+ (void)PLCopyItemsFromPath:toPath:.cold.1()
{
  ...
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Could not retrieve source files from %@ with error %@");
}
...
void __42__PLUtilities_PLCopyItemsFromPath_toPath___block_invoke_cold_1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v9 = 2112;
  uint64_t v10 = a2;
  _os_log_error_impl(&dword_1E4220000, log, OS_LOG_TYPE_ERROR, "Error copying files from source path %@ to destination path %@ with error: %@", (uint8_t *)&v5, 0x20u);
}

+ (void)setPermissionsForFile:toValue:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "Successfully set permissions for file %@", v2, v3, v4, v5, v6);
}

+ (void)setPermissionsForFile:toValue:.cold.2()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Cannot set permissions for file %@, error = %@");
}

+ (void)compressWithSource:withDestination:withLevel:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_3(&dword_1E4220000, v0, v1, "compressWithSource: Cannot read %@ for compression\n", v2, v3, v4, v5, v6);
}

+ (void)compressWithSource:withDestination:withLevel:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_3(&dword_1E4220000, v0, v1, "compressWithSource: Cannot write to %@ for compression\n", v2, v3, v4, v5, v6);
}

+ (void)compressWithSource:withDestination:withLevel:.cold.3()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "compressWithSource: Cannot compress file at %@ to %@\n");
}

+ (void)compressWithSource:withDestination:withLevel:.cold.4()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "compressWithSource: attempting to compress source stream to destination stream...", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_3(&dword_1E4220000, v0, v1, "decompressWithSource: Cannot read %@ for decompression\n", v2, v3, v4, v5, v6);
}

+ (void)decompressWithSource:withDestination:withRemoveSrc:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_3(&dword_1E4220000, v0, v1, "decompressWithSource: Cannot write to %@ for decompression\n", v2, v3, v4, v5, v6);
}

+ (void)decompressWithSource:withDestination:withRemoveSrc:.cold.3()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_3(&dword_1E4220000, v0, v1, "decompressWithSource: error when removing failed output file '%@'", v2, v3, v4, v5, v6);
}

+ (void)decompressWithSource:withDestination:withRemoveSrc:.cold.4()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "decompressWithSource: Cannot decompress from %@ to %@\n");
}

+ (void)decompressWithSource:withDestination:withRemoveSrc:.cold.5()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "decompressWithSource: attempting to decompress source stream to destination stream...", v2, v3, v4, v5, v6);
}

+ (void)decompressWithSource:withDestination:withRemoveSrc:.cold.6()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "decompressWithSource: invalid source file, %@ with extension %@");
}
...
+ (void)reportZlibResultToCA:forEvent:.cold.1()
{
  ...
  OUTLINED_FUNCTION_8_1(&dword_1E4220000, v0, (uint64_t)v0, "%@ ERROR = %d", v1);
}

+ (void)numFilesAtPath:.cold.1()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Failed to get num files at path: %@ error: %@");
}

+ (void)remove:oldestFilesFromDirectory:containingFileNameSubstring:.cold.1()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "No file name substring provided, assuming all files in directory are candidate files", v2, v3, v4, v5, v6);
}
...
+ (void)remove:(uint64_t)a3 oldestFilesFromDirectory:(os_log_t)log containingFileNameSubstring:.cold.2(uint64_t a1, uint8_t *buf, uint64_t a3, os_log_t log)
{
  ...
  *((_WORD *)buf + 6) = 2112;
  *(void *)(buf + 14) = a1;
  _os_log_debug_impl(&dword_1E4220000, log, OS_LOG_TYPE_DEBUG, "Found %lu files with %@ in the name", buf, 0x16u);
}

+ (void)remove:oldestFilesFromDirectory:containingFileNameSubstring:.cold.3()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Failed to get contents of directory %@ with error: %@");
}

void __75__PLUtilities_remove_oldestFilesFromDirectory_containingFileNameSubstring___block_invoke_82_cold_1()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_5(&dword_1E4220000, v0, v1, "Assuming %@ and %@ have the same creation date");
}

void __75__PLUtilities_remove_oldestFilesFromDirectory_containingFileNameSubstring___block_invoke_82_cold_2()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Failed to get creation date of file %@ with error: %@");
}

void __75__PLUtilities_remove_oldestFilesFromDirectory_containingFileNameSubstring___block_invoke_86_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Failed to remove %@ with error: %@");
}

+ (void)markFilesInDirectoryAsPurgeable:ofType:withUrgency:.cold.1()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_9(&dword_1E4220000, v0, v1, "Failed to mark files in directory %@ purgeable -- error when retrieving contents of directory: '%@'");
}

+ (void)markFilesInDirectoryAsPurgeable:ofType:withUrgency:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_3_3(&dword_1E4220000, v0, v1, "Failed to mark files in directory %@ purgeable -- path is not directory", v2, v3, v4, v5, v6);
}
...
+ (void)markFileAsPurgeable:(uint64_t)a1 withUrgency:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  __int16 v8 = 2080;
  __int16 v9 = v5;
  _os_log_error_impl(&dword_1E4220000, a2, OS_LOG_TYPE_ERROR, "Failed to mark %@ purgeable - can't open error: %s", (uint8_t *)&v6, 0x16u);
}
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "Quarantine dst: %@", v2, v3, v4, v5, v6);
}
...
void __39__PLUtilities_quarantineToPath_action___block_invoke_cold_2(void *a1, NSObject *a2)
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "Quarantine src: %@", v4, 0xCu);
}

+ (void)allowQueryFromPeer:.cold.1()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4_0(&dword_1E4220000, v0, v1, "failure creating sec task from token", v2, v3, v4, v5, v6);
}

+ (void)getPerfStatsForProcess:.cold.1()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4_0(&dword_1E4220000, v0, v1, "[Perf Stats Query] Coalitions does not have aggregated data", v2, v3, v4, v5, v6);
}

+ (void)getPerfStatsForProcess:.cold.2()
{
  OUTLINED_FUNCTION_2_0();
  OUTLINED_FUNCTION_5(&dword_1E4220000, v0, v1, "[Perf Stats Query] QueryStartDate=%@, QueryEndDate=%@");
}
...
+ (void)pidForProcessName:(NSObject *)a1 .cold.1(NSObject *a1)
{
  ...
  v3[0] = 67109120;
  v3[1] = v2;
  _os_log_error_impl(&dword_1E4220000, a1, OS_LOG_TYPE_ERROR, "failed to read pids %d", (uint8_t *)v3, 8u);
}

+ (void)pidForProcessName:.cold.2()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4_0(&dword_1E4220000, v0, v1, "failed to allocat buffer", v2, v3, v4, v5, v6);
}
...
+ (void)pidForProcessName:.cold.3()
{
  uint64_t v2 = *MEMORY[0x1E4F143B8];
  OUTLINED_FUNCTION_10_2();
  _os_log_debug_impl(&dword_1E4220000, v0, OS_LOG_TYPE_DEBUG, "found %@ (%d)", v1, 0x12u);
}

+ (void)pidForProcessName:.cold.4()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "searching for procName %@", v2, v3, v4, v5, v6);
}
...
+ (void)maxProcessCount
{
  ...
  __int16 v6 = 1024;
  int v7 = v2;
  OUTLINED_FUNCTION_8_1(&dword_1E4220000, a1, v3, "failed to query %s: %d", (uint8_t *)&v4);
}
...
+ (void)isDaemonOrAppleXPCService:(char)a1 .cold.1(char a1, uint64_t a2)
{
  ...
  __int16 v11 = 2112;
  uint64_t v12 = v5;
  _os_log_debug_impl(&dword_1E4220000, MEMORY[0x1E4F14500], OS_LOG_TYPE_DEBUG, "Pid:%i isDaemonAppleXPCService:%{BOOL}i\t\tBundle:%@\t\t\tBinary:%@", (uint8_t *)v6, 0x22u);
}
...
+ (void)isDaemonOrAppleXPCService:(uint64_t)a3 .cold.2(uint64_t a1, int a2, uint64_t a3)
{
  ...
  __int16 v4 = 2112;
  uint64_t v5 = a1;
  OUTLINED_FUNCTION_8_1(&dword_1E4220000, MEMORY[0x1E4F14500], a3, "Error to identify (pid%i) isDaemonOrAppleXPCService %@", (uint8_t *)v3);
}

+ (void)isImproveFitnessPlusEnabled
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4_0(&dword_1E4220000, v0, v1, "Fitness plus libraries not found", v2, v3, v4, v5, v6);
}

void __29__PLUtilities_deviceBootArgs__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4_0(&dword_1E4220000, v0, v1, "unable to retrieve sysctl", v2, v3, v4, v5, v6);
}

void __29__PLUtilities_deviceBootArgs__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4_0(&dword_1E4220000, v0, v1, "unable to retrieve the size of sysctl", v2, v3, v4, v5, v6);
}
...
+ (void)getJetamPriority:.cold.1()
{
  ...
  OUTLINED_FUNCTION_8_1(&dword_1E4220000, MEMORY[0x1E4F14500], v0, "Error with MEMORYSTATUS_CMD_GET_PRIORITY_LIST. Size %d and sizeof(entry) %lu", v1);
}
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, MEMORY[0x1E4F14500], v0, "cleanLaunchdName: Unknown launchd service name: %@", v1, v2, v3, v4, v5);
}
...
{
  OUTLINED_FUNCTION_0(&dword_1E4220000, a1, a3, "hardwareModel: returning %@", a5, a6, a7, a8, 2u);
}

void __28__PLUtilities_hardwareModel__block_invoke_cold_2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "hardwareModel: HWModelStr = %@", v2, v3, v4, v5, v6);
}
...
void __29__PLUtilities_devBoardDevice__block_invoke_cold_1(os_log_t log)
{
  ...
  _os_log_debug_impl(&dword_1E4220000, log, OS_LOG_TYPE_DEBUG, "devBoardDevice: returning %d", (uint8_t *)v1, 8u);
}
...
void __36__PLUtilities_getHardwarePerfLevels__block_invoke_cold_1(int a1, NSObject *a2)
{
  ...
  v2[0] = 67109120;
  v2[1] = a1;
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "getHardwarePerfLevels failed, sysctlbyname retval = %d", (uint8_t *)v2, 8u);
}
