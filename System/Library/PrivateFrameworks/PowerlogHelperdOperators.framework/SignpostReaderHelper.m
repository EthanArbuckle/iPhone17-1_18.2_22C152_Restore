...
- (id)generateSignpostSubmissionWithTagConfig:(id)a3 withAllowlist:(id)a4 withStartDate:(id)a5 withEndDate:(id)a6 includeSPFile:(BOOL)a7
{
  ...
  if (a3 && a4 && a5 && a6)
  {
    ...
    v19 = [MEMORY[0x1E4F28ED0] numberWithBool:v10];
...
- (id)generateRapidMSSWithStartDate:(id)a3 endDate:(id)a4 atPath:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v20 = 2112;
      v21 = v11;
      _os_log_error_impl(&dword_1E4220000, v14, OS_LOG_TYPE_ERROR, "Invalid arguments: startDate=%@ endDate=%@ path=%@", (uint8_t *)&v16, 0x20u);
    }
...
- (id)processSignpostWithConfig:(id)a3 withServiceType:(int)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&buf[4] = a4;
    LOWORD(v32) = 2112;
    *(void *)((char *)&v32 + 2) = v6;
    _os_log_impl(&dword_1E4220000, v7, OS_LOG_TYPE_INFO, "processSignpost for service type (%d) with config %@", buf, 0x12u);
  }
  ...
  *((void *)&v32 + 1) = 0x3032000000;
  ...
  switch(a4)
  {
    ...
    default:
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)v25 = 67109120;
        LODWORD(v26) = a4;
        _os_log_impl(&dword_1E4220000, v10, OS_LOG_TYPE_INFO, "Unknown service type specified: %d", v25, 8u);
      }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v25 = 138412290;
    uint64_t v26 = v12;
    _os_log_impl(&dword_1E4220000, v11, OS_LOG_TYPE_INFO, "The successful reply happened: %@", v25, 0xCu);
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)v25 = 134218498;
    ...
    __int16 v29 = 2112;
    v30 = v13;
    _os_log_impl(&dword_1E4220000, v16, OS_LOG_TYPE_INFO, "Time for signpost reading to run: %f, %@, %@", v25, 0x20u);
  }
...
- (id)createXPCConnection
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1E4220000, v3, OS_LOG_TYPE_INFO, "PL establishing a connection", buf, 2u);
  }
  ...
  id v6 = [MEMORY[0x1E4F29280] interfaceWithProtocol:&unk_1F40458B0];
  ...
  {
    *(_WORD *)id v10 = 0;
    _os_log_impl(&dword_1E4220000, v7, OS_LOG_TYPE_INFO, "spinning up xpc svc", v10, 2u);
  }

  id v8 = [(NSXPCConnection *)self->_connectionToServer synchronousRemoteObjectProxyWithErrorHandler:&__block_literal_global_59];
  return v8;
}
...
- (void)generateRapidSignpostSummaryWithStartDate:endDate:.cold.1()
{
  ...
  __int16 v3 = 2112;
  uint64_t v4 = v0;
  _os_log_error_impl(&dword_1E4220000, v1, OS_LOG_TYPE_ERROR, "Invalid arguments: startDate=%@ endDate=%@", v2, 0x16u);
}

void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "submitSignpostDataWithConfig: %@", v2, v3, v4, v5, v6);
}

void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_35_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "summarizeSignpostMetrics: %@", v2, v3, v4, v5, v6);
}

void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_36_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "aggregateSignpostData : %@", v2, v3, v4, v5, v6);
}

void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_37_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "readRawSignpostData : %@", v2, v3, v4, v5, v6);
}

void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_38_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "generateMSSReportForRAPID : %@", v2, v3, v4, v5, v6);
}

void __66__SignpostReaderHelper_processSignpostWithConfig_withServiceType___block_invoke_39_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "generateMSSReportForTasking : %@", v2, v3, v4, v5, v6);
}

void __43__SignpostReaderHelper_createXPCConnection__block_invoke_cold_1(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&dword_1E4220000, log, OS_LOG_TYPE_ERROR, "Connection was interrupted.", v1, 2u);
}

void __43__SignpostReaderHelper_createXPCConnection__block_invoke_53_cold_1(os_log_t log)
{
  *(_WORD *)uint64_t v1 = 0;
  _os_log_error_impl(&dword_1E4220000, log, OS_LOG_TYPE_ERROR, "Invalid connection handler is happening.", v1, 2u);
}
...
void __43__SignpostReaderHelper_createXPCConnection__block_invoke_56_cold_1(void *a1, NSObject *a2)
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_1E4220000, a2, OS_LOG_TYPE_ERROR, "Connection error happened %@", v4, 0xCu);
}
