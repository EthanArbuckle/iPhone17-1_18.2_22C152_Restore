...
- (void)stopMonitoring
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    {
      v6 = [NSString stringWithFormat:@"Stopped monitoring paths %@", &unk_1F4013DC8, block, v13, v14, v15, v16];
...
void __33__PLFSEventAgent_startMonitoring__block_invoke(uint64_t a1)
{
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    {
      v3 = [NSString stringWithFormat:@"StartMonitoring paths: %@", &unk_1F4013DE0];
  ...
  if ([*(id *)(a1 + 32) stream])
  {
    ...
    if (!FSEventStreamStart((FSEventStreamRef)[*(id *)(a1 + 32) stream]))
    {
      if ([MEMORY[0x1E4F929C0] debugEnabled])
      {
        ...
        v18[4] = v11;
        if (PLSubmissionAnalyticsStateSuccess_block_invoke_defaultOnce_43 != -1) {
          dispatch_once(&PLSubmissionAnalyticsStateSuccess_block_invoke_defaultOnce_43, v18);
        }
        if (PLSubmissionAnalyticsStateSuccess_block_invoke_classDebugEnabled_44)
        {
...
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
  PLSubmissionAnalyticsStateSuccess_block_invoke_classDebugEnabled_44 = result;
  return result;
}
...
- (void)registerforFSEventNotification
{
  ...
  v3 = FSEventStreamCreate((CFAllocatorRef)*MEMORY[0x1E4F1CF80], (FSEventStreamCallback)fsEventsHandler, &context, (CFArrayRef)&unk_1F4013DF8, 0xFFFFFFFFFFFFFFFFLL, 1.0, 0x11u);
  self->_stream = v3;
  if (v3)
  {
...
- (void)initOperatorDependancies
{
  ...
  uint64_t v5 = (void *)[v3 initWithWorkQueue:v4 withRegistration:&unk_1F4011298 withBlock:&__block_literal_global_24];
...
id __42__PLFSEventAgent_initOperatorDependancies__block_invoke(uint64_t a1, int a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    v19 = v9;
    _os_log_impl(&dword_1E4220000, v14, OS_LOG_TYPE_DEFAULT, "%@", buf, 0xCu);
  }
...
- (void)logLogFileName:(id)a3 withName:(id)a4
{
  ...
  if (v6 && v7)
  {
    ...
    v19 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D38] andName:@"LogFile"];
