...
- (void)initOperatorDependancies
{
  ...
  v36[3] = &unk_1E6E47740;
  void v36[4] = self;
  v4 = (void *)[v3 initWithOperator:self withRegistration:&unk_1F400F380 withBlock:v36];
  ...
  v35[3] = &unk_1E6E47740;
  v35[4] = self;
  v6 = (void *)[v5 initWithOperator:self withRegistration:&unk_1F400F3A8 withBlock:v35];
  ...
  v34[3] = &unk_1E6E47740;
  v34[4] = self;
  v8 = (void *)[v7 initWithOperator:self withRegistration:&unk_1F400F3D0 withBlock:v34];
  ...
  v33[3] = &unk_1E6E47740;
  v33[4] = self;
  v10 = (void *)[v9 initWithOperator:self withRegistration:&unk_1F400F3F8 withBlock:v33];
  ...
  v32[3] = &unk_1E6E47740;
  v32[4] = self;
  v12 = (void *)[v11 initWithOperator:self withRegistration:&unk_1F400F420 withBlock:v32];
  ...
  v30[3] = &unk_1E6E47740;
  void v30[4] = self;
  v21 = (void *)[v20 initWithOperator:self withRegistration:&unk_1F400F448 withBlock:v30];
  ...
  v29[3] = &unk_1E6E47740;
  v29[4] = self;
  v25 = (void *)[v24 initWithOperator:self withRegistration:&unk_1F400F470 withBlock:v29];
  ...
  v28[3] = &unk_1E6E47740;
  void v28[4] = self;
  v27 = (void *)[v26 initWithOperator:self withRegistration:&unk_1F400F498 withBlock:v28];
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  v19 = objc_msgSend(v17, "numberWithInt:", +[PLUtilities roundToSigFig:withSigFig:](PLUtilities, "roundToSigFig:withSigFig:", objc_msgSend(v18, "intValue"), 2));
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_179(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    {
      v8 = [NSString stringWithFormat:@"PLPushAgent:: sentPushListener with payload=%@", v6, block, v30, v31, v32, v33];
  ...
  if ([MEMORY[0x1E4F929C0] fullMode])
  {
    ...
    double v22 = [v20 objectForKeyedSubscript:@"Size"];
    v23 = objc_msgSend(v21, "numberWithInt:", +[PLUtilities roundToSigFig:withSigFig:](PLUtilities, "roundToSigFig:withSigFig:", objc_msgSend(v22, "intValue"), 2));
    [v20 setObject:v23 forKeyedSubscript:@"Size"];

    unint64_t v18 = 0x1E4F28000uLL;
    [*(id *)(a1 + 32) logEntry:v20];
  }
  id v24 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D20] andName:@"SentPushes"];
  v25 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v24 withRawData:v14];
  id v26 = *(void **)(v18 + 3792);
  v27 = [v25 objectForKeyedSubscript:@"Size"];
  v28 = objc_msgSend(v26, "numberWithInt:", +[PLUtilities roundToSigFig:withSigFig:](PLUtilities, "roundToSigFig:withSigFig:", objc_msgSend(v27, "intValue"), 2));
  [v25 setObject:v28 forKeyedSubscript:@"Size"];

  [v25 setObject:&unk_1F400CA18 forKeyedSubscript:@"Count"];
  [*(id *)(a1 + 32) logEntry:v25];
}
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_194(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __39__PLPushAgent_initOperatorDependancies__block_invoke_194_cold_1();
  }
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_202(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  uint64_t v7 = PLLogCommon();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __39__PLPushAgent_initOperatorDependancies__block_invoke_202_cold_1();
  }
  ...
  [v15 setObject:&unk_1F400CA18 forKeyedSubscript:@"Count"];
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_210(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    {
      v8 = [NSString stringWithFormat:@"PLPushAgent:: sentKeepAliveListener with payload=%@", v6, block, v24, v25, v26, v27];
      id v9 = (void *)MEMORY[0x1E4F929B8];
      v10 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Agents/Software/PLPushAgent.m"];
      id v11 = [v10 lastPathComponent];
      int v12 = [NSString stringWithUTF8String:"-[PLPushAgent initOperatorDependancies]_block_invoke"];
  ...
  v16 = [v6 objectForKeyedSubscript:@"LinkQuality"];
  [v15 setObject:v16 forKeyedSubscript:@"LinkQuality"];

  uint64_t v17 = objc_opt_class();
  unint64_t v18 = [v6 objectForKeyedSubscript:@"ConnectionType"];
  ...
  if (v21 == 1)
  {
    double v22 = [MEMORY[0x1E4F28ED0] numberWithInteger:500];
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_2_225(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __39__PLPushAgent_initOperatorDependancies__block_invoke_2_225_cold_1();
  }
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_236(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  uint64_t v7 = PLLogPush();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __39__PLPushAgent_initOperatorDependancies__block_invoke_236_cold_1();
  }
...
void __39__PLPushAgent_initOperatorDependancies__block_invoke_244(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  uint64_t v7 = PLLogPush();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __39__PLPushAgent_initOperatorDependancies__block_invoke_244_cold_1();
  }
...
LABEL_15:
        ...
        uint64_t v17 = PLLogPush();
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG)) {
          -[PLPushAgent accountReceivedPushWithEntry:](v16, v17);
        }

        if (v16)
        {
          unint64_t v18 = PLLogPush();
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v33 = 2112;
            v34 = v19;
            _os_log_impl(&dword_1E4220000, v18, OS_LOG_TYPE_INFO, "Waking push with entry=%@, entry.entryDate=%@", buf, 0x16u);
          }
          id v20 = [MEMORY[0x1E4F92900] sharedInstance];
          uint64_t v21 = [v3 entryDate];
          double v22 = [v3 entryDate];
...
- (void)sendEnergyIssueSignatureNotification:(id)a3 withThreshold:(double)a4
{
  ...
  if (v7)
  {
    ...
    uint64_t v9 = [v7 signatureWithDomain:@"Energy" type:@"Push" subType:@"PushStorm" subtypeContext:&stru_1F3FCA098 detectedProcess:v6 triggerThresholdValues:v8];
...
LABEL_16:
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v18[4] = v13;
    if (kPLPushAgentInterruptionSuppression_block_invoke_3_defaultOnce_352 != -1) {
      dispatch_once(&kPLPushAgentInterruptionSuppression_block_invoke_3_defaultOnce_352, v18);
    }
    if (kPLPushAgentInterruptionSuppression_block_invoke_3_classDebugEnabled_353)
    {
      ...
      uint64_t v17 = [NSString stringWithUTF8String:"-[PLPushAgent sendEnergyIssueSignatureNotification:withThreshold:]_block_invoke_2"];
...
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
  kPLPushAgentInterruptionSuppression_block_invoke_3_classDebugEnabled_353 = result;
  return result;
}
...
- (void)checkPushUsage:(id)a3 withPLEntry:(id)a4
{
  ...
  if (self->_detectionStartTime)
  {
    ...
    if (v9 <= 86400.0)
    {
      ...
      if (v11)
      {
        int v12 = (void *)MEMORY[0x1E4F28ED0];
      ...
      {
        [(NSMutableDictionary *)self->_pushUsageDict setObject:&unk_1F400CA18 forKeyedSubscript:v10];
      }
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    if (checkPushUsage_withPLEntry__classDebugEnabled)
    {
      ...
      double v22 = [NSString stringWithUTF8String:"-[PLPushAgent checkPushUsage:withPLEntry:]"];
...
- (void)handleMessageEvent:(id)a3 isSentEvent:(BOOL)a4
{
  ...
  id v7 = PLLogPush();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    -[PLPushAgent handleMessageEvent:isSentEvent:](v4, (uint64_t)v6, v7);
  }
  ...
  double v9 = v8;
  v10 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D48] andName:v9];
  ...
  {
    uint64_t v17 = (void *)MEMORY[0x1E4F28ED0];
    uint64_t v18 = [v6 objectForKeyedSubscript:@"Target"];
    v19 = +[PLUtilities hashString:v18];
    uint64_t v20 = objc_msgSend(v17, "numberWithUnsignedInteger:", objc_msgSend(v19, "hash"));
    [v11 setObject:v20 forKeyedSubscript:@"Target"];

    id v21 = (void *)MEMORY[0x1E4F28ED0];
    double v22 = [v6 objectForKeyedSubscript:@"Source"];
    v23 = +[PLUtilities hashString:v22];
    uint64_t v24 = objc_msgSend(v21, "numberWithUnsignedInteger:", objc_msgSend(v23, "hash"));
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "PLPushAgent:: receivedPushListener with payload=%@", v2, v3, v4, v5, v6);
}

void __39__PLPushAgent_initOperatorDependancies__block_invoke_194_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "SuppressedPushes payload: %@", v2, v3, v4, v5, v6);
}

void __39__PLPushAgent_initOperatorDependancies__block_invoke_202_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "PLPushAgent:: apsdConnectedListener with payload=%@", v2, v3, v4, v5, v6);
}

void __39__PLPushAgent_initOperatorDependancies__block_invoke_2_225_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "PLPushAgent:: receivedKeepAliveListener with payload: %@", v2, v3, v4, v5, v6);
}

void __39__PLPushAgent_initOperatorDependancies__block_invoke_236_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "iMessageSent payload: %@", v2, v3, v4, v5, v6);
}

void __39__PLPushAgent_initOperatorDependancies__block_invoke_244_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "iMessageReceived payload: %@", v2, v3, v4, v5, v6);
}
...
- (void)accountReceivedPushWithEntry:(char)a1 .cold.1(char a1, NSObject *a2)
{
  ...
  v2[0] = 67109120;
  v2[1] = a1 & 1;
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "didWake = %d", (uint8_t *)v2, 8u);
}

- (void)accountReceivedPushWithEntry:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "accounting entry %@", v2, v3, v4, v5, v6);
}

- (void)convertMessageProtocol:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "Other Message Protocol logged: %@", v2, v3, v4, v5, v6);
}

- (void)handleMessageEvent:(NSObject *)a3 isSentEvent:.cold.1(char a1, uint64_t a2, NSObject *a3)
{
  uint64_t v9 = *MEMORY[0x1E4F143B8];
  uint64_t v5 = [MEMORY[0x1E4F28ED0] numberWithBool:a1 & 1];
  OUTLINED_FUNCTION_1();
  __int16 v7 = 2112;
  uint64_t v8 = a2;
  _os_log_debug_impl(&dword_1E4220000, a3, OS_LOG_TYPE_DEBUG, "Received messages update, isSentEvent: %@, payload: %@", v6, 0x16u);
}
