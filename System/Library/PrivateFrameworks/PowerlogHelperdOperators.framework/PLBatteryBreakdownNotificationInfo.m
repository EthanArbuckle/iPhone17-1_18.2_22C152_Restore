...
+ (double)representativeDisplayPower
{
  if (representativeDisplayPower_onceToken != -1) {
    dispatch_once(&representativeDisplayPower_onceToken, &__block_literal_global_27);
  }
  return *(double *)&representativeDisplayPower_representativeDisplayPower;
}
...
void __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke()
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG)) {
    __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_2((uint64_t)v4, v5);
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG)) {
    __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_1((uint64_t)v15, v16);
  }
  ...
  *(double *)&representativeDisplayPower_representativeDisplayPower = v13 + v23;
}
...
void __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "dynamicDisplayPower: running query %@", (uint8_t *)&v2, 0xCu);
}
...
void __64__PLBatteryBreakdownNotificationInfo_representativeDisplayPower__block_invoke_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "displayPower: running query %@", (uint8_t *)&v2, 0xCu);
}
