...
+ (void)addAppVersion:(id)a3 withVersion:(id)a4
{
  ...
  if (addAppVersion_withVersion__onceToken != -1) {
    dispatch_once(&addAppVersion_withVersion__onceToken, &__block_literal_global_91);
  }
  if (v7 && v5)
  {
    id v6 = (id)_appVersions;
    objc_sync_enter(v6);
    [(id)_appVersions setObject:v5 forKey:v7];
    objc_sync_exit(v6);
  }
}
...
+ (void)removeAppVersion:(id)a3 forVersion:(id)a4
{
  ...
  if (v5 && v9 && _appVersions)
  {
    id v6 = (id)_appVersions;
    objc_sync_enter(v6);
    id v7 = [(id)_appVersions objectForKeyedSubscript:v9];
    int v8 = [v7 isEqualToString:v5];

    if (v8) {
      [(id)_appVersions removeObjectForKey:v9];
    }
    objc_sync_exit(v6);
  }
}
...
+ (id)appVersionForBundle:(id)a3
{
  ...
  if (_appVersions)
  {
    id v4 = (id)_appVersions;
    objc_sync_enter(v4);
    id v5 = [(id)_appVersions objectForKeyedSubscript:v3];
    objc_sync_exit(v4);
  }
  else
  {
...
+ (id)entryEventForwardDefinitions
{
  ...
  v15[0] = @"Application";
  v14 = [a1 entryEventForwardDefinitionApplication];
  v16[0] = v14;
  ...
  v10 = [a1 entryEventForwardDefinitionAmbientModeLifetimeCounter];
  v16[8] = v10;
  v15[9] = @"MotionToWake";
  v11 = [a1 entryEventForwardDefinitionMotionToWake];
  v16[9] = v11;
...
+ (id)entryEventForwardDefinitionApplication
{
  ...
  v23[1] = v13;
  void v23[2] = &unk_1F40131C8;
  v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v23 forKeys:v22 count:3];
...
+ (id)entryEventNoneAllApps
{
  ...
  v47[4] = @"AppBundleId";
  v43 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v47 forKeys:v46 count:5];
  v49[0] = v43;
  ...
  v39 = objc_msgSend(v40, "commonTypeDict_StringFormat_withAppName");
  v45[1] = v39;
  ...
  v33 = objc_msgSend(v34, "commonTypeDict_StringFormat_withProcessName");
  v45[4] = v33;
  v44[5] = @"AppVendorID";
  ...
  v48[2] = *MEMORY[0x1E4F92C90];
  v49[1] = v12;
  v49[2] = &unk_1F40131E0;
  v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v49 forKeys:v48 count:3];
...
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "Logging all Installed Applications' BundleID/DistributorID to CA", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "Not invoking initOperatorDependancies for powerlogHelperd", v2, v3, v4, v5, v6);
}
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3(uint64_t a1)
{
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    if (kPLApplicationAgentEventPointNameControlCenterUpdates_block_invoke_classDebugEnabled)
    {
      ...
      uint64_t v5 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Agents/Software/PLApplicationAgent.m"];
      uint8_t v6 = [v5 lastPathComponent];
      id v7 = [NSString stringWithUTF8String:"-[PLApplicationAgent initOperatorDependancies]_block_invoke_3"];
...
uint64_t __46__PLApplicationAgent_initOperatorDependancies__block_invoke_389(uint64_t a1)
{
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    if (kPLApplicationAgentEventPointNameControlCenterUpdates_block_invoke_2_classDebugEnabled)
    {
      ...
      uint64_t v5 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Agents/Software/PLApplicationAgent.m"];
      uint8_t v6 = [v5 lastPathComponent];
      id v7 = [NSString stringWithUTF8String:"-[PLApplicationAgent initOperatorDependancies]_block_invoke"];
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_401(uint64_t a1, void *a2)
{
  ...
  id v7 = [v4 objectForKey:*MEMORY[0x1E4F4E230]];
  uint64_t v8 = [v4 objectForKey:*MEMORY[0x1E4F4E248]];
  id v9 = [v4 objectForKey:*MEMORY[0x1E4F4E268]];
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_2_403(uint64_t a1)
{
    ...
    && (int)[*(id *)(a1 + 40) intValue] >= 4)
  {
    ...
    id v9 = [v7 lastEntryForKey:v5 withComparisons:v8 isSingleton:1];
...
LABEL_27:
      ...
      v23[1] = 3221225472;
      void v23[2] = __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3_412;
      void v23[3] = &unk_1E6E481B0;
      v24 = v9;
      id v25 = v10;
      v26 = v18;
  ...
  if ([*(id *)(a1 + 40) intValue] == 2)
  {
    ...
    *(_OWORD *)buffer = 0u;
    ...
    if (!proc_pid_rusage(*(_DWORD *)(a1 + 64), 4, buffer))
    {
      ...
      id v13 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:*((void *)&v32 + 1)];
      id v14 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(void)v43];
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_4_414(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (v9 != v11 || v13 != v15)
  {
    ...
    id v19 = [v7 state];
    char v20 = [v19 assertions];
    id v21 = +[PLApplicationAgent getReasons:v20];
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      *(_DWORD *)buf = 67109890;
      ...
      __int16 v41 = 2112;
      long long v42 = v21;
      _os_log_debug_impl(&dword_1E4220000, v22, OS_LOG_TYPE_DEBUG, "pid: %d, name: %@, state: %d, reasons: %@", buf, 0x22u);
    }

    v23 = [MEMORY[0x1E4F28ED0] numberWithUnsignedInt:v11];
    id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  ...
  if ([*(id *)(a1 + 40) intValue] == 3)
  {
    ...
    *(_OWORD *)buffer = 0u;
    ...
    if (!proc_pid_rusage(*(_DWORD *)(a1 + 64), 4, buffer))
    {
      id v11 = objc_loadWeakRetained(v2);
      uint64_t v12 = *(void *)(a1 + 32);
      int v13 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:*((void *)&v32 + 1)];
      id v14 = [MEMORY[0x1E4F28ED0] numberWithUnsignedLongLong:(void)v43];
      [v11 logEventBackwardApplicationMemoryWithBundleId:v12 withSuspendedMemory:v13 withPeakMemory:v14];
    }
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_3_419(uint64_t a1, void *a2)
{
  ...
  id v4 = a2;
  uint64_t v5 = [v3 predicateMatchingProcessTypeApplication];
  v9[0] = v5;
  ...
  [v7 setValues:25];
  [v7 setEndowmentNamespaces:&unk_1F4013240];
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_445(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_445_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_451(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_451_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_456(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_456_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_463(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_463_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_473(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_473_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_480(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_480_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_487(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_487_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_492(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_492_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_497(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_497_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_505(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_505_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_513(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_513_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_518(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_518_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_523(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  id v7 = PLLogApplication();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    __46__PLApplicationAgent_initOperatorDependancies__block_invoke_523_cold_1();
  }
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_524(uint64_t a1, void *a2)
{
  ...
  uint64_t v3 = (void *)MEMORY[0x1E4F96430];
  id v4 = a2;
  uint64_t v5 = [v3 predicateMatchingLaunchServicesProcesses];
  v8[0] = v5;
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_2_525(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  {
    id v19 = objc_opt_new();
    char v20 = [MEMORY[0x1E4F28ED0] numberWithInt:v11];
    ...
    v23 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithUnsignedInt:", objc_msgSend(v9, "domain"));
    [v19 setObject:v23 forKeyedSubscript:@"Reason"];

    v24 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithUnsignedLongLong:", objc_msgSend(v9, "code"));
    ...
    if ([MEMORY[0x1E4F929C0] debugEnabled])
    {
      ...
      v35[4] = v26;
      if (kPLApplicationAgentEventPointNameControlCenterUpdates_block_invoke_3_defaultOnce_533 != -1) {
        dispatch_once(&kPLApplicationAgentEventPointNameControlCenterUpdates_block_invoke_3_defaultOnce_533, v35);
      }
      if (kPLApplicationAgentEventPointNameControlCenterUpdates_block_invoke_3_classDebugEnabled_534)
      {
        id v34 = v6;
...
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
  kPLApplicationAgentEventPointNameControlCenterUpdates_block_invoke_3_classDebugEnabled_534 = result;
  return result;
}
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_548(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    {
      uint64_t v8 = [NSString stringWithFormat:@"PLApplicationAgent:: appDockingListener with payload=%@", v6, block, v15, v16, v17, v18];
...
void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_560(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    {
      uint64_t v8 = [NSString stringWithFormat:@"PLApplicationAgent:: appPrewarmListener with payload=%@", v6, block, v15, v16, v17, v18];
      int v9 = (void *)MEMORY[0x1E4F929B8];
      uint64_t v10 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/PerfPowerServices_Operators/Operators/Agents/Software/PLApplicationAgent.m"];
      uint64_t v11 = [v10 lastPathComponent];
      uint64_t v12 = [NSString stringWithUTF8String:"-[PLApplicationAgent initOperatorDependancies]_block_invoke"];
...
- (BOOL)isApplication:(int)a3
{
  ...
  uint64_t v4 = [MEMORY[0x1E4F28ED0] numberWithInt:*(void *)&a3];
  id v10 = 0;
...
LABEL_15:
          ...
          {
            *(_WORD *)id v17 = 0;
            _os_log_impl(&dword_1E4220000, v15, OS_LOG_TYPE_DEFAULT, "AppDeletion : Cleanup pending", v17, 2u);
          }

          BOOL v14 = 1;
          goto LABEL_18;
        }
        uint64_t v12 = [v10 objectForKeyedSubscript:@"AppName"];
...
- (void)refreshAllAppsAndPlugins
{
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    if (refreshAllAppsAndPlugins_defaultOnce != -1) {
      dispatch_once(&refreshAllAppsAndPlugins_defaultOnce, v38);
    }
  ...
  uint64_t v12 = +[PLOperator entryKeyForType:v10 andName:@"AllPlugins"];
  ...
  if ([MEMORY[0x1E4F929C0] debugEnabled])
  {
    ...
    v35[3] = &__block_descriptor_40_e5_v8__0lu32l8;
    v35[4] = v26;
    if (refreshAllAppsAndPlugins_defaultOnce_591 != -1) {
      dispatch_once(&refreshAllAppsAndPlugins_defaultOnce_591, v35);
    }
    if (refreshAllAppsAndPlugins_classDebugEnabled_592)
    {
...
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
  refreshAllAppsAndPlugins_classDebugEnabled_592 = result;
  return result;
}
...
- (void)logEventBackwardApplicationMemoryWithBundleId:(id)a3 withSuspendedMemory:(id)a4 withPeakMemory:(id)a5
{
  ...
  if (v12 && [v12 length])
  {
    uint64_t v10 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D28] andName:@"ApplicationMemory"];
...
- (void)logEventBackwardWidgetStats:(id)a3
{
  ...
  id v8 = [MEMORY[0x1E4F1C9C8] dateWithTimeIntervalSince1970:v7];
...
- (void)createWidgetStatsAccountingEvents:(id)a3
{
  ...
  v14[1] = 3221225472;
  void v14[2] = __56__PLApplicationAgent_createWidgetStatsAccountingEvents___block_invoke;
  void v14[3] = &unk_1E6E48808;
  v14[4] = &v15;
  [v3 enumerateObjectsUsingBlock:v14];
  if (*(double *)(v16[0] + 24) > 0.0)
  {
    ...
    v11[1] = 3221225472;
    void v11[2] = __56__PLApplicationAgent_createWidgetStatsAccountingEvents___block_invoke_603;
    v11[3] = &unk_1E6E48830;
    id v13 = &v15;
    id v6 = v4;
    id v12 = v6;
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
      [(PLApplicationAgent *)(uint64_t)v16 createWidgetStatsAccountingEvents:v7];
    }
...
void __56__PLApplicationAgent_createWidgetStatsAccountingEvents___block_invoke_603(uint64_t a1, void *a2)
{
  ...
  if (v7)
  {
    id v8 = [*(id *)(a1 + 32) objectForKeyedSubscript:v15];
...
- (void)logEventBackwardControlCenterStats:(id)a3
{
  ...
  uint64_t v17 = MEMORY[0x1E4F143A8];
  uint64_t v18 = 3221225472;
  long long v19 = __57__PLApplicationAgent_logEventBackwardControlCenterStats___block_invoke;
  long long v20 = &unk_1E6E487E0;
  id v13 = v11;
  id v21 = v13;
  id v14 = v9;
...
- (void)logEventForwardApplicationDidUninstall:(id)a3 withAppName:(id)a4
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v10];
...
- (void)logEventForwardAmbientModeLifetimeCounter:(id)a3
{
  ...
  id v10 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithInt:", +[PLUtilities roundToSigFig:withSigFig:](PLUtilities, "roundToSigFig:withSigFig:", v9, 2));
  [v7 setObject:v10 forKeyedSubscript:@"LifetimePresentationCounter"];

  double v11 = PLLogApplication();
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
    [(PLApplicationAgent *)v7 logEventForwardAmbientModeLifetimeCounter:v11];
  }
...
- (void)logEventPointApplicationForDisplayID:(id)a3
{
  ...
  uint64_t v5 = [MEMORY[0x1E4F28ED0] numberWithInt:SBSGetApplicationState()];
...
- (void)logEventPointApplicationForDisplayID:(id)a3 withPid:(int)a4 withState:(id)a5 withReasons:(id)a6
{
  ...
  id v11 = a5;
  id v12 = a6;
  id v13 = (void *)MEMORY[0x1E4E7EF70]();
  uint64_t v14 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D30] andName:@"Application"];
  ...
  else
  {
    ...
    if (v12)
    {
      ...
      if (v18)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v19; ++i)
          {
            ...
            if ([(PLOperator *)self isDebugEnabledForKey:@"Aggregate"])
            {
              uint64_t v26 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v55];
              [v26 setObject:v25 forKeyedSubscript:@"Reason"];
              [v26 setObject:&unk_1F400C688 forKeyedSubscript:@"Count"];
      ...
      if ([(PLOperator *)self isDebugEnabledForKey:@"Aggregate"])
      {
        id v27 = [MEMORY[0x1E4F1C9C8] monotonicDate];
        ...
        id v33 = [NSString stringWithFormat:@"results=%@\naggregatedResults=%@", v31, v32];
        id v34 = (void *)MEMORY[0x1E4F929B8];
        ...
        id v37 = [NSString stringWithUTF8String:"-[PLApplicationAgent logEventPointApplicationForDisplayID:withPid:withState:withReasons:]"];
    ...
    long long v39 = [MEMORY[0x1E4F28ED0] numberWithInt:v8];
...
- (void)logEventPointSuggestedWidgetReload:(id)a3
{
  ...
  id v11 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D48] andName:@"SuggestedWidgetReload"];
  id v12 = [MEMORY[0x1E4F1CA48] array];
  uint64_t v17 = MEMORY[0x1E4F143A8];
  uint64_t v18 = 3221225472;
  uint64_t v19 = __57__PLApplicationAgent_logEventPointSuggestedWidgetReload___block_invoke;
  uint64_t v20 = &unk_1E6E487E0;
  id v13 = v11;
  id v21 = v13;
  id v14 = v9;
  id v22 = v14;
...
- (void)logEventPointWidgetUpdates:(id)a3
{
  ...
  id v11 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D48] andName:@"WidgetUpdates"];
  id v12 = [MEMORY[0x1E4F1CA48] array];
...
void __49__PLApplicationAgent_logEventPointWidgetUpdates___block_invoke(uint64_t a1, void *a2)
{
  ...
  [v7 setObject:&unk_1F400C688 forKeyedSubscript:@"Count"];
...
- (void)logEventPointControlCenterUpdates:(id)a3
{
  ...
  id v11 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D48] andName:@"ControlCenterUpdates"];
  id v12 = [MEMORY[0x1E4F1CA48] array];
  uint64_t v17 = MEMORY[0x1E4F143A8];
  uint64_t v18 = 3221225472;
  id v19 = __56__PLApplicationAgent_logEventPointControlCenterUpdates___block_invoke;
  id v20 = &unk_1E6E487E0;
  id v13 = v11;
  id v21 = v13;
  id v14 = v9;
  id v22 = v14;
...
- (void)displayIdentifiersDidChange
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        [v3 addObject:v10];
        id v11 = [(PLApplicationAgent *)self currentDisplayIdentifiers];
  ...
  int v16 = [MEMORY[0x1E4F1CA80] setWithSet:v3];
  [v15 minusSet:v3];
...
LABEL_10:
          ...
          [v6 setObject:&unk_1F400C6A0 forKeyedSubscript:@"PluginDeletedDate"];
          goto LABEL_12;
        }
      }
      id v11 = [v4 extensionPointRecord];
...
- (void)logInstalledAppWithRecord:(id)a3 withBundleID:(id)a4 shouldMaskTimestamp:(BOOL)a5
{
  ...
  if ((v12 & 1) == 0)
  {
    ...
    uint64_t v14 = [v13 countByEnumeratingWithState:&v104 objects:v108 count:16];
    if (v14)
    {
      uint64_t v15 = v14;
      ...
      do
      {
        ...
        uint64_t v15 = [v13 countByEnumeratingWithState:&v104 objects:v108 count:16];
      }
      while (v15);
    }
    ...
    id v24 = v88;
    id v25 = [v23 lastEntryForKey:v22 withSubEntryKey:v88];
    ...
    if (v25)
    {
      ...
      long long v39 = [v25 objectForKeyedSubscript:@"AppDeletedDate"];
      [v39 doubleValue];
      double v41 = v40;
      ...
      if (v41 == 0.0)
      {
        ...
        if (v49 == 0.0)
        {
          ...
          id v92 = v8;
          id v93 = v88;
          [(PLOperator *)self updateEntry:v54 withBlock:v89];
        }
        else
        {
          ...
          v94[1] = 3221225472;
          v94[2] = __81__PLApplicationAgent_logInstalledAppWithRecord_withBundleID_shouldMaskTimestamp___block_invoke_641;
          v94[3] = &unk_1E6E488A8;
          long long v43 = &v95;
          id v51 = v25;
          id v95 = v51;
          ...
          id v97 = v8;
          id v98 = v88;
          [(PLOperator *)self updateEntry:v51 withBlock:v94];
        }
      }
      else
      {
        ...
        uint64_t v46 = &v102;
        id v102 = v8;
        [(PLOperator *)self updateEntry:v44 withBlock:v99];
      }
    ...
    else
    {
      ...
      v55 = (void *)[objc_alloc(MEMORY[0x1E4F929D0]) initWithEntryKey:v22 withDate:v28];
      [v55 setObject:v24 forKeyedSubscript:@"AppBundleId"];
      long long v60 = [v8 iTunesMetadata];
      long long v61 = [v60 distributorInfo];
      v62 = [v61 distributorID];
      [v55 setObject:v62 forKeyedSubscript:@"AppDistributorID"];

      uint64_t v63 = PLLogApplication();
      if (os_log_type_enabled(v63, OS_LOG_TYPE_DEBUG)) {
        -[PLApplicationAgent logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:](v8, (uint64_t)v88, v63);
      }
      ...
      v70 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithBool:", -[PLApplicationAgent isAppClipWithBundleID:](self, "isAppClipWithBundleID:", v88));
      [v55 setObject:v70 forKeyedSubscript:@"AppIsClip"];

      [v55 setObject:&unk_1F400C6A0 forKeyedSubscript:@"AppDeletedDate"];
      v71 = &unk_1F400C6D0;
      ...
      if (v73) {
        [v55 setObject:&unk_1F400C6B8 forKeyedSubscript:@"AppType"];
      }
      [v55 setObject:&unk_1F400C6A0 forKeyedSubscript:@"AppUpdatedDate"];
      if (+[PLUtilities isAppAnalyticsEnabled])
      {
        ...
        v84 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithBool:", objc_msgSend(v8, "isBeta"));
        [v55 setObject:v84 forKeyedSubscript:@"AppIsBeta"];

        v85 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithInt:", objc_msgSend(v8, "developerType") == 3);
      ...
      +[PLApplicationAgent addAppVersion:v88 withVersion:v87];
    }
  }
}
...
void __81__PLApplicationAgent_logInstalledAppWithRecord_withBundleID_shouldMaskTimestamp___block_invoke(uint64_t a1)
{
  ...
  [*(id *)(a1 + 32) setObject:&unk_1F400C6A0 forKeyedSubscript:@"AppDeletedDate"];
...
- (void)logInstalledPlugin:(id)a3
{
  ...
  if (v4 && (v7 & 1) == 0)
  {
    ...
    if (v9 && [v9 length])
    {
      ...
      long long v45 = __Block_byref_object_copy__8;
      ...
      if (v12)
      {
        ...
        if (v15 == 0.0)
        {
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            v38[3] = &__block_descriptor_40_e5_v8__0lu32l8;
            v38[4] = v31;
            if (logInstalledPlugin__defaultOnce_652 != -1) {
              dispatch_once(&logInstalledPlugin__defaultOnce_652, v38);
            }
            if (logInstalledPlugin__classDebugEnabled_653)
            {
        ...
        else
        {
          if ([MEMORY[0x1E4F929C0] debugEnabled])
          {
            ...
            block[3] = &__block_descriptor_40_e5_v8__0lu32l8;
            void block[4] = v16;
            if (logInstalledPlugin__defaultOnce_645 != -1) {
              dispatch_once(&logInstalledPlugin__defaultOnce_645, block);
            }
            if (logInstalledPlugin__classDebugEnabled_646)
            {
...
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
  logInstalledPlugin__classDebugEnabled_646 = result;
  return result;
}
...
void __41__PLApplicationAgent_logInstalledPlugin___block_invoke_651(uint64_t a1)
{
  ...
  [*(id *)(*(void *)(*(void *)(a1 + 32) + 8) + 40) setObject:&unk_1F400C6A0 forKeyedSubscript:@"PluginDeletedDate"];
}

uint64_t __41__PLApplicationAgent_logInstalledPlugin___block_invoke_2(uint64_t a1)
{
  uint64_t result = [MEMORY[0x1E4F929C0] isClassDebugEnabled:*(void *)(a1 + 32)];
  logInstalledPlugin__classDebugEnabled_653 = result;
  return result;
}
...
- (void)logUninstalledApp:(id)a3
{
  ...
  v32[1] = 3221225472;
  void v32[2] = __40__PLApplicationAgent_logUninstalledApp___block_invoke;
  v32[3] = &unk_1E6E488D0;
  v32[4] = &v33;
  v32[5] = v39;
  [(PLOperator *)self updateEntry:v6 withBlock:v32];
  char v7 = +[PLOperator entryKeyForType:v3 andName:@"AllPlugins"];
  id v8 = (void *)[objc_alloc(MEMORY[0x1E4F92A90]) initWithKey:@"PluginParentApp" withValue:v19 withComparisonOperation:0];
  ...
  if (v13)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        long long v26 = __Block_byref_object_dispose__8;
        id v27 = v16;
        uint64_t v17 = v23[5];
        v21[0] = MEMORY[0x1E4F143A8];
        v21[1] = 3221225472;
        void v21[2] = __40__PLApplicationAgent_logUninstalledApp___block_invoke_2;
        v21[3] = &unk_1E6E488D0;
        void v21[4] = &v22;
        void v21[5] = v39;
...
- (void)logUninstalledAppVersion:(id)a3
{
  ...
  void v20[3] = __Block_byref_object_copy__8;
  void v20[4] = __Block_byref_object_dispose__8;
...
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "logAllApps was called", v2, v3, v4, v5, v6);
}
...
- (void)logAllPlugins
{
  ...
  long long v10 = 0u;
  long long v11 = 0u;
  uint64_t v3 = +[PLApplicationAgent installedPlugins];
...
+ (id)installedPlugins
{
  ...
  uint64_t v2 = (void *)MEMORY[0x1E4E7EF70](a1, a2);
...
- (id)trimConditionsForEntryKey:(id)a3 forTrimDate:(id)a4
{
  ...
  double v15 = [(id)objc_opt_class() entryKeyForType:v12 andName:@"AllPlugins"];
...
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "AppDeletion : Activity is scheduled.", v2, v3, v4, v5, v6);
}

+ (BOOL)isVisible:(id)a3
{
  uint64_t v3 = [a3 endowmentNamespaces];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        long long v11 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithUnsignedLongLong:", objc_msgSend(v10, "reason", (void)v16));
        ...
        else
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138412546;
            ...
            __int16 v25 = 2112;
            id v26 = v14;
            _os_log_error_impl(&dword_1E4220000, v15, OS_LOG_TYPE_ERROR, "could not refresh application record for %@: %@", buf, 0x16u);
          }
        }
        ++v9;
      }
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (objc_msgSend(v10, "isPlaceholder", v15))
        {
          id v11 = PLLogCommon();
          if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
            [(PLApplicationAgent *)&v16 applicationsDidInstall:v11];
          }
        }
        else
        {
          ...
          if (v12)
          {
            if (v14)
            {
              *(_DWORD *)buf = v15;
              uint64_t v23 = v11;
              _os_log_debug_impl(&dword_1E4220000, v13, OS_LOG_TYPE_DEBUG, "applicationsDidInstall: Update %@\n", buf, 0xCu);
            }
          ...
          else
          {
            if (v14)
            {
              *(_DWORD *)buf = v15;
              uint64_t v23 = v11;
              _os_log_debug_impl(&dword_1E4220000, v13, OS_LOG_TYPE_DEBUG, "applicationsDidInstall: Install %@", buf, 0xCu);
            }
          }
...
- (void)applicationsDidUninstall:(id)a3
{
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (objc_msgSend(v10, "isPlaceholder", v16))
        {
          id v11 = PLLogCommon();
          if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG)) {
            [(PLApplicationAgent *)&v17 applicationsDidUninstall:v11];
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v16;
            ...
            __int16 v25 = 2112;
            id v26 = v11;
            _os_log_debug_impl(&dword_1E4220000, v13, OS_LOG_TYPE_DEBUG, "AppDeletion : Application Name %@ and bundle ID %@", buf, 0x16u);
          }
  ...
  if ([v4 count])
  {
    ...
    id v15 = +[PLUtilities generateAndUpdateSaltValue:@"PLSaltBundleID"];
  }
}
...
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "Application metadata being sent to CA", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_445_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "WidgetStats payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_451_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "WidgetUpdates payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_456_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "SuggestedWidgetReload payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_463_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "PosterUpdates payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_473_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "System Aperture payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_480_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AmbientMode payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_487_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "LiveActivityUpdates payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_492_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "LiveActivityStats payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_497_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AmbientModeActiveFace payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_505_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AmbientModeLifetimePresentationCounter payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_513_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AmbientModeMotionToWake payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_518_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "ControlCenterUpdates payload: %@", v2, v3, v4, v5, v6);
}

void __46__PLApplicationAgent_initOperatorDependancies__block_invoke_523_cold_1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "ControlCenterStats payload: %@", v2, v3, v4, v5, v6);
}
...
- (void)isApplication:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1();
  _os_log_error_impl(&dword_1E4220000, MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR, "Error to identify isApplication %@", v0, 0xCu);
}

- (void)createWidgetStatsAccountingEvents:(os_log_t)log .cold.1(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a2;
  _os_log_debug_impl(&dword_1E4220000, log, OS_LOG_TYPE_DEBUG, "WidgetStats Accounting: totalFramesRendered=%f, identifierToWeight=%@", (uint8_t *)&v4, 0x16u);
}

- (void)createWidgetStatsAccountingEvents:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "WidgetStats Accounting: entries=%@", v2, v3, v4, v5, v6);
}

- (void)logEventForwardAmbientModeLifetimeCounter:(NSObject *)a3 .cold.1(void *a1, int a2, NSObject *a3)
{
  uint64_t v9 = *MEMORY[0x1E4F143B8];
  uint64_t v5 = [a1 objectForKeyedSubscript:@"LifetimePresentationCounter"];
  v6[0] = 67109378;
  v6[1] = a2;
  __int16 v7 = 2112;
  uint64_t v8 = v5;
  _os_log_debug_impl(&dword_1E4220000, a3, OS_LOG_TYPE_DEBUG, "AmbientModeLifetimePresentationCounter value from payload: %d, value after rounding: %@", (uint8_t *)v6, 0x12u);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "log new AppVersions entry %@\n", v2, v3, v4, v5, v6);
}
...
- (void)logInstalledAppWithRecord:(void *)a1 withBundleID:(uint64_t)a2 shouldMaskTimestamp:(NSObject *)a3 .cold.2(void *a1, uint64_t a2, NSObject *a3)
{
  ...
  uint64_t v5 = [a1 iTunesMetadata];
  uint8_t v6 = [v5 distributorInfo];
  __int16 v7 = [v6 distributorID];
  OUTLINED_FUNCTION_1();
  __int16 v9 = 2112;
  uint64_t v10 = a2;
  _os_log_debug_impl(&dword_1E4220000, a3, OS_LOG_TYPE_DEBUG, "AllApps logging DistributorID: %@ for BundleID: %@", v8, 0x16u);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.3()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AllApps lastRow Timestamp: %@", v2, v3, v4, v5, v6);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.4()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "AllApps table is empty, using fuzzed timestamp", v2, v3, v4, v5, v6);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.5()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "AllApps masking Timestamp", v2, v3, v4, v5, v6);
}
...
- (void)logInstalledAppWithRecord:(char)a1 withBundleID:(NSObject *)a2 shouldMaskTimestamp:.cold.6(char a1, NSObject *a2)
{
  ...
  v2[0] = 67109120;
  v2[1] = a1 & 1;
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "AllApps shouldMaskTimestamp: %d", (uint8_t *)v2, 8u);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.7()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AllApps logInstalledAppWithRecord bundleID doesnt exist for %@", v2, v3, v4, v5, v6);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.8()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "AllApps entry %@ was deleted and reinstalled", v2, v3, v4, v5, v6);
}

- (void)logInstalledAppWithRecord:withBundleID:shouldMaskTimestamp:.cold.9()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_1E4220000, v0, v1, "%@ was updated, modify version", v2, v3, v4, v5, v6);
}

- (void)buildAppVersionDictionary:.cold.1()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "AllApps Building app verion dictionary from the db", v2, v3, v4, v5, v6);
}

- (void)applicationsDidInstall:(os_log_t)log .cold.1(uint8_t *buf, unsigned char *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
  _os_log_debug_impl(&dword_1E4220000, log, OS_LOG_TYPE_DEBUG, "app Record is placeHolder", buf, 2u);
}

- (void)applicationsDidUninstall:.cold.1()
{
  OUTLINED_FUNCTION_6();
  OUTLINED_FUNCTION_4(&dword_1E4220000, v0, v1, "AppResume : Updating salt value", v2, v3, v4, v5, v6);
}

- (void)applicationsDidUninstall:(os_log_t)log .cold.2(uint8_t *buf, unsigned char *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
  _os_log_debug_impl(&dword_1E4220000, log, OS_LOG_TYPE_DEBUG, "app Proxy is placeHolder", buf, 2u);
}
