...
+ (void)populateDODForEntry:(id)a3 withRawData:(id)a4
{
  ...
  if ([v6 count])
  {
    ...
    do
    {
      ...
      v9 = objc_msgSend(NSString, "stringWithFormat:", @"DOD%d", v7);
...
+ (void)populateQmaxForEntry:(id)a3 withRawData:(id)a4
{
  ...
  if (v5 && a4)
  {
    ...
    unint64_t v7 = [v6 objectForKeyedSubscript:@"Qmax"];
...
+ (void)populatewRaForEntry:(id)a3 withRawData:(id)a4
{
  id v5 = a3;
  id v6 = [a4 objectForKeyedSubscript:@"BatteryData"];
  id v7 = [v6 objectForKeyedSubscript:@"WeightedRa"];
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
        +[PLEventBackwardBatteryEntry populatewRaForEntry:withRawData:]((uint64_t)v7, v9);
      }
    }
  }
}
...
- (id)levelWithRawData:(id)a3
{
  ...
  id v5 = [(PLEntry *)self objectForKeyedSubscript:@"CurrentCapacity"];
  [v5 doubleValue];
  double v7 = v6 * 100.0;
  v8 = [(PLEntry *)self objectForKeyedSubscript:@"MaxCapacity"];
  [v8 doubleValue];
  id v10 = [v4 numberWithDouble:v7 / v9];
...
{
  v4 = (void *)MEMORY[0x1E4F28ED0];
  id v5 = [(PLEntry *)self objectForKeyedSubscript:@"AppleRawCurrentCapacity"];
  [v5 doubleValue];
  double v7 = v6 * 100.0;
...
{
  v4 = (void *)MEMORY[0x1E4F28ED0];
  id v5 = [(PLEntry *)self objectForKeyedSubscript:@"AbsoluteCapacity"];
  [v5 doubleValue];
  double v7 = v6 * 100.0;
...
- (void)populateTLCCounterWithRawData:(id)a3
{
  ...
  {
    id v6 = v4;
    id v5 = [v4 objectForKeyedSubscript:@"TimeChargingThermallyLimited"];
...
- (void)populateAdapterPowerTierWithRawData:(id)a3
{
  ...
  {
    id v6 = v4;
    id v5 = [v4 objectForKeyedSubscript:@"AdapterPowerTier"];
...
{
  id v4 = a3;
  id v5 = +[PLEventBackwardBatteryEntry entryKey];
  v15.receiver = self;
  v15.super_class = (Class)PLEventBackwardBatteryEntry;
  id v6 = [(PLEntry *)&v15 initWithEntryKey:v5 withRawData:v4];
  ...
  if (v6)
  {
    ...
    [v8 doubleValue];
    id v10 = [v7 numberWithDouble:v9 / 100.0];
    [(PLEntry *)v6 setObject:v10 forKeyedSubscript:@"Temperature"];

    id v11 = [(PLEventBackwardBatteryEntry *)v6 levelWithRawData:v4];
...
+ (void)populatewRaForEntry:(uint64_t)a1 withRawData:(NSObject *)a2 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v3 = [(id)objc_opt_class() className];
  int v4 = 138412290;
  id v5 = v3;
  _os_log_error_impl(&dword_1E4220000, a2, OS_LOG_TYPE_ERROR, "unknown wRa format: %@", (uint8_t *)&v4, 0xCu);
}
