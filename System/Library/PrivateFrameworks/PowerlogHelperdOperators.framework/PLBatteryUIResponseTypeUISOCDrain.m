...
- (void)configure:(id)a3
{
  ...
  id v23 = +[PLOperator entryKeyForType:*MEMORY[0x1E4F92D20] andName:@"UILevel"];
...
- (void)run
{
  ...
  int v2 = 138412290;
  uint64_t v3 = a1;
  _os_log_debug_impl(&dword_1E4220000, a2, OS_LOG_TYPE_DEBUG, "Start of current bucket: %@", (uint8_t *)&v2, 0xCu);
}
