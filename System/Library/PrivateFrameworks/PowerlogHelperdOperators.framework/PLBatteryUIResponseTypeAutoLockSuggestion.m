...
- (id)dependencies
{
  return &unk_1F40144E8;
}

- (void)configure:(id)a3
{
  objc_msgSend(MEMORY[0x1E4F74230], "sharedConnection", a3);
  id v5 = (id)objc_claimAutoreleasedReturnValue();
  v4 = [v5 effectiveValueForSetting:*MEMORY[0x1E4F73F60]];
...
{
  *(_WORD *)v1 = 0;
  _os_log_debug_impl(&dword_1E4220000, log, OS_LOG_TYPE_DEBUG, "Auto Lock Suggestion: Auto Lock is already enabled.", v1, 2u);
}
...
- (id)result
{
  ...
  if ([(PLBatteryUIResponseTypeAutoLockSuggestion *)self suggest])
  {
    ...
    [(PLBatteryUIResponseTypeAutoLockSuggestion *)self energyPercent];
...
id __51__PLBatteryUIResponseTypeAutoLockSuggestion_result__block_invoke(uint64_t a1)
{
  return *(id *)(a1 + 32);
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_autoLockTime, 0);
