...
- (SBEscrowOperationStartEvent)initWithRequest:(id)a3 type:(unint64_t)a4
{
  ...
  id v8 = [(SBEscrowOperationStartEvent *)self initWithRequest:v6 type:a4 context:v7];
...
- (id)endEventWithResults:(id)a3 error:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = objc_alloc_init(ESADefaultOperationLoggingContext);
  id v9 = [(SBEscrowOperationStartEvent *)self endEventWithResults:v7 error:v6 context:v8];
