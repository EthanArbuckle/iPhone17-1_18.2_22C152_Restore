...
- (RWIProtocolDOMAudioMediaStats)audio
{
  ...
  objc_super v3 = [(RWIProtocolJSONObject *)&v14 objectForKey:@"audio"];
  if (v3)
  {
...
- (RWIProtocolDOMVideoMediaStats)video
{
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolDOMMediaStats;
  objc_super v3 = [(RWIProtocolJSONObject *)&v14 objectForKey:@"video"];
  if (v3)
  {
...
- (RWIProtocolDOMViewportSize)viewport
{
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolDOMMediaStats;
  objc_super v3 = [(RWIProtocolJSONObject *)&v14 objectForKey:@"viewport"];
  if (v3)
  {
...
- (RWIProtocolDOMVideoPlaybackQuality)quality
{
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolDOMMediaStats;
  objc_super v3 = [(RWIProtocolJSONObject *)&v14 objectForKey:@"quality"];
  if (v3)
  {
...
{
  v4.receiver = self;
  v4.super_class = (Class)RWIProtocolDOMMediaStats;
