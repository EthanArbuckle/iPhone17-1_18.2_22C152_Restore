...
LABEL_8:
  ...
  while (i == 9);
  objc_super v6 = (&Inspector::fromProtocolString<RWIProtocolNetworkInitiatorType>(WTF::String const&)::mappings)[i + 2];
  v7 = (_DWORD *)v10;
  uint64_t v10 = 0;
  if (v7)
  {
...
- (RWIProtocolConsoleStackTrace)stackTrace
{
  ...
  if (v3)
  {
    unint64_t v4 = [RWIProtocolConsoleStackTrace alloc];
    v11.receiver = self;
...
{
  v4.receiver = self;
  v4.super_class = (Class)RWIProtocolNetworkInitiator;
