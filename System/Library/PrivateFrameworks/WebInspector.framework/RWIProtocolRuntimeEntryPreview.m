...
- (RWIProtocolRuntimeEntryPreview)initWithValue:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)RWIProtocolRuntimeEntryPreview;
...
{
  v3.receiver = self;
  v3.super_class = (Class)RWIProtocolRuntimeEntryPreview;
...
{
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolRuntimeEntryPreview;
  objc_super v3 = [(RWIProtocolJSONObject *)&v14 objectForKey:@"key"];
  if (v3)
  {
    id v4 = [RWIProtocolRuntimeObjectPreview alloc];
    v11.receiver = self;
    v11.super_class = (Class)RWIProtocolRuntimeEntryPreview;
