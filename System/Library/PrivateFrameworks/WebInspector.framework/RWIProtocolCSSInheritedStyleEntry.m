...
- (RWIProtocolCSSInheritedStyleEntry)initWithMatchedCSSRules:(id)a3
{
  ...
  {
    if (!v16) {
      [MEMORY[0x263EFF940] raise:*MEMORY[0x263EFF4A0], @"required property '%@' cannot be nil", @"matchedCSSRules" format];
    }
    long long v19 = 0u;
    long long v20 = 0u;
    long long v17 = 0u;
    ...
    [(RWIProtocolCSSInheritedStyleEntry *)v4 setMatchedCSSRules:v5];
    v14 = v4;
  }
...
- (RWIProtocolCSSStyle)inlineStyle
{
  ...
  objc_super v3 = [(RWIProtocolJSONObject *)&v14 objectForKey:@"inlineStyle"];
  if (v3)
  {
    v4 = [RWIProtocolCSSStyle alloc];
    v11.receiver = self;
    v11.super_class = (Class)RWIProtocolCSSInheritedStyleEntry;
    id v5 = [(RWIProtocolJSONObject *)&v11 objectForKey:@"inlineStyle"];
    [v5 toJSONObject];
    uint64_t v6 = v12;
    ++*v12;
    v13 = v6;
...
- (void)setMatchedCSSRules:(id)a3
{
  ...
  v14.receiver = self;
  v14.super_class = (Class)RWIProtocolCSSInheritedStyleEntry;
  [(RWIProtocolJSONObject *)&v14 setJSONArray:&v15 forKey:@"matchedCSSRules"];
  v12 = v15;
  v15 = 0;
  if (v12)
  {
...
- (NSArray)matchedCSSRules
{
  ...
  [(RWIProtocolJSONObject *)&v5 JSONArrayForKey:@"matchedCSSRules"];
  v2 = Inspector::toObjCArray<RWIProtocolCSSRuleMatch>(&v6);
  id v3 = v6;
  uint64_t v6 = 0;
  if (v3)
  {
