...
uint64_t __69__VTVoiceTriggerEnabledPolicyWatch__addVoiceTriggerEnabledConditions__block_invoke_14()
{
  ...
  if ((v1 & 1) == 0)
  {
    ...
    {
      *(_WORD *)v4 = 0;
      _os_log_impl(&dword_21844F000, v2, OS_LOG_TYPE_DEFAULT, "VoiceTrigger cannot be turned on since Siri assertion is disabled", v4, 2u);
    }
  }
  return v1;
}
...
uint64_t __69__VTVoiceTriggerEnabledPolicyWatch__addVoiceTriggerEnabledConditions__block_invoke_8()
{
  ...
  if ((v1 & 1) == 0)
  {
    ...
    {
      *(_WORD *)v4 = 0;
      _os_log_impl(&dword_21844F000, v2, OS_LOG_TYPE_DEFAULT, "VoiceTrigger cannot be turned on since SpringBoard is not started", v4, 2u);
    }
  }
  return v1;
}
...
- (void)_subscribeEventMonitors
{
  ...
  id v7 = +[VTFirstUnlockMonitor sharedInstance];
