@interface _FEFocusEnvironmentPreferenceCacheNode
- (BOOL)isResolved;
- (NSArray)childNodes;
- (_FEFocusEnvironment)environment;
- (_FEFocusEnvironment)resolvedEnvironment;
- (_FEFocusEnvironmentPreferenceCacheNode)initWithEnvironment:(id)a3;
- (id)debugDescription;
- (id)description;
...
@implementation _FEFocusEnvironmentPreferenceCacheNode

- (_FEFocusEnvironmentPreferenceCacheNode)initWithEnvironment:(id)a3
{
  id v5 = a3;
  v11.receiver = self;
  v11.super_class = (Class)_FEFocusEnvironmentPreferenceCacheNode;
  v6 = [(_FEFocusEnvironmentPreferenceCacheNode *)&v11 init];
  v7 = v6;
  if (v6)
  {
    objc_storeStrong((id *)&v6->_environment, a3);
    uint64_t v8 = [MEMORY[0x263F088B0] hashTableWithOptions:514];
...
- (void)_reevaluateResolution
{
  ...
  {
    uint64_t v3 = [(_FEFocusEnvironmentPreferenceCacheNode *)self childNodes];
    if (v3
      && (v4 = (void *)v3,
          [(_FEFocusEnvironmentPreferenceCacheNode *)self childNodes],
          ...
          v6))
    {
      ...
      long long v15 = 0u;
      long long v16 = 0u;
      v7 = [(_FEFocusEnvironmentPreferenceCacheNode *)self childNodes];
      ...
      if (v8)
      {
        ...
        while (2)
        {
          for (uint64_t i = 0; i != v9; ++i)
          {
            ...
            if (![v12 isResolved])
            {
              [(_FEFocusEnvironmentPreferenceCacheNode *)self _unresolve];
              goto LABEL_20;
            }
...
LABEL_19:
      ...
      [(_FEFocusEnvironmentPreferenceCacheNode *)self _resolve:v14 explicitly:0];
      v7 = v14;
LABEL_20:
    }
    else
...
- (void)setChildNodes:(id)a3
{
  ...
  long long v23 = 0u;
  long long v24 = 0u;
  id v5 = [(_FEFocusEnvironmentPreferenceCacheNode *)self childNodes];
  ...
  [(_FEFocusEnvironmentPreferenceCacheNode *)self _reevaluateResolution];
}
...
- (id)description
{
  uint64_t v3 = (void *)[objc_alloc(MEMORY[0x263F29C40]) initWithObject:self];
