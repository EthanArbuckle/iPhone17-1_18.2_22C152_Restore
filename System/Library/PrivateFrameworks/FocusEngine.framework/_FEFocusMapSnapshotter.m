@interface _FEFocusMapSnapshotter
...
- (_FEFocusMapSnapshotter)init
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"_FEFocusMapSnapshotter.m" lineNumber:38 description:@"-init is not a valid initializer for this class."];
...
LABEL_8:
    ...
    [v22 handleFailureInMethod:a2, self, @"_FEFocusMapSnapshotter.m", 45, @"Invalid parameter not satisfying: %@", @"rootContainer" object file lineNumber description];
  ...
  [v21 handleFailureInMethod:a2, self, @"_FEFocusMapSnapshotter.m", 44, @"Invalid parameter not satisfying: %@", @"focusSystem" object file lineNumber description];
...
LABEL_9:
  ...
  [v23 handleFailureInMethod:a2, self, @"_FEFocusMapSnapshotter.m", 46, @"Invalid parameter not satisfying: %@", @"coordinateSpace" object file lineNumber description];

LABEL_4:
  v24.receiver = self;
  v24.super_class = (Class)_FEFocusMapSnapshotter;
  v17 = [(_FEFocusMapSnapshotter *)&v24 init];
  v18 = v17;
  if (v17)
  {
    ...
    v18->_snapshotFrame.origin = (CGPoint)*MEMORY[0x263F001A0];
...
- (id)_searchAreaForContainerSearchRect:(CGRect)a3
{
  ...
  if (v20)
  {
    +[_FEFocusRegionEvaluator frameForRegion:v20 inCoordinateSpace:WeakRetained];
    CGFloat v22 = v21;
    CGFloat v24 = v23;
    CGFloat v26 = v25;
    CGFloat v28 = v27;
  ...
  v33 = _FEFocusItemSafeCast(v32);
  double v34 = _FEFocusItemFrameInCoordinateSpace(v33, WeakRetained);
  CGFloat v36 = v35;
  CGFloat v38 = v37;
  CGFloat v40 = v39;
  ...
  if (!CGRectIsNull(v47) && (_FERectSmartIntersectsRect(v34, v36, v38, v40, x, y, width, height) & 1) == 0)
  {
...
- (id)captureSnapshot
{
  ...
  CGFloat v13 = -[_FEFocusMapRect initWithFrame:coordinateSpace:]([_FEFocusMapRect alloc], "initWithFrame:coordinateSpace:", v4, x, y, width, height);
  CGFloat v14 = -[_FEFocusMapSnapshotter _searchAreaForContainerSearchRect:](self, "_searchAreaForContainerSearchRect:", x, y, width, height);
  id v15 = [[_FEFocusMapSnapshot alloc] _initWithSnapshotter:self mapArea:v13 searchArea:v14];
