@interface _FEFocusRegionSearchContextState
+ (id)stateWithRegionContainer:(id)a3 focusSystem:(id)a4 clippingRect:(CGRect)a5;
- (CGRect)clippingRect;
- (_FEFocusRegionContainer)regionContainer;
- (_FEFocusRegionSearchContextState)initWithRegionContainer:(id)a3 focusSystem:(id)a4 clippingRect:(CGRect)a5;
- (_FEFocusSystem)regionContainerFocusSystem;
@end

@implementation _FEFocusRegionSearchContextState
...
- (_FEFocusRegionSearchContextState)initWithRegionContainer:(id)a3 focusSystem:(id)a4 clippingRect:(CGRect)a5
{
  ...
  id v13 = a4;
  v17.receiver = self;
  v17.super_class = (Class)_FEFocusRegionSearchContextState;
  v14 = [(_FEFocusRegionSearchContextState *)&v17 init];
  v15 = v14;
  if (v14)
  {
