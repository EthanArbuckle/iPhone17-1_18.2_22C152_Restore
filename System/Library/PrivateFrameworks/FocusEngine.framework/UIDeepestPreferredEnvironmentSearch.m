  ...
  if (([v5 isPreferredByItself] & 1) == 0)
  {
    ...
    if (v41)
    {
      ...
      if (v27)
      {
        ...
        v34 = +[_FEDebugLogMessage messageWithStyle:2 string:v33];
        [v18 addMessage:v34];
      ...
      else
      {
        ...
        v37 = +[_FEDebugLogMessage messageWithStyle:2 string:v36];
        [v18 addMessage:v37];
