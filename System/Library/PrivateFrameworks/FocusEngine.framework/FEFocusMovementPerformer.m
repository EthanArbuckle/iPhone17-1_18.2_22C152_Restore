@interface FEFocusMovementPerformer
@end
...
void __98___FEFocusMovementPerformer__findFocusCandidateBySearchingLinearFocusMovementSequencesForRequest___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  {
    v6 = [v5 _focusLinearMovementSequence];
...
void __98___FEFocusMovementPerformer__findFocusCandidateBySearchingLinearFocusMovementSequencesForRequest___block_invoke_2(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v6 = a2;
...
LABEL_8:
    ...
    if (v15)
    {
      id v18 = [[_FEFocusUpdateContext alloc] _initWithFocusMovementRequest:*(void *)(a1 + 48) nextFocusedItem:v15];
...
void __63___FEFocusMovementPerformer__isMovementValidForFocusSequences___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (objc_opt_respondsToSelector())
  {
    id v6 = [v5 _focusLinearMovementSequence];
...
void __63___FEFocusMovementPerformer__isMovementValidForFocusSequences___block_invoke_2(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  id v11 = a2;
  id v6 = [v11 items];
