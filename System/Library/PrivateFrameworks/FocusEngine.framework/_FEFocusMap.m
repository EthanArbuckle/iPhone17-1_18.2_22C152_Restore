...
- (_FEFocusMap)init
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"_FEFocusMap.m" lineNumber:90 description:@"-init is not a valid initializer for this class."];
...
- (_FEFocusMap)initWithFocusSystem:(id)a3 rootEnvironment:(id)a4
{
  ...
  if (!v7)
  {
    ...
    [v12 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 96, @"Invalid parameter not satisfying: %@", @"focusSystem" object file lineNumber description];
...
LABEL_5:
    ...
    [v13 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 97, @"Invalid parameter not satisfying: %@", @"rootEnvironment" object file lineNumber description];
...
LABEL_3:
  v10 = [(_FEFocusMap *)self initWithFocusSystem:v7 rootEnvironment:v9 coordinateSpace:0 searchInfo:0 ignoresRootContainerClippingRect:0];
...
- (_FEFocusMap)initWithFocusSystem:(id)a3 rootEnvironment:(id)a4 coordinateSpace:(id)a5 searchInfo:(id)a6 ignoresRootContainerClippingRect:(BOOL)a7
{
  ...
  id v12 = a4;
  id v13 = a3;
  v14 = [v12 _focusItemContainer];
  if (!v14)
  {
    v18 = [MEMORY[0x263F08690] currentHandler];
    [v18 handleFailureInMethod:a2 object:self file:@"_FEFocusMap.m" lineNumber:104 description:@"The environment does not provide an item container."];
  }
  _FEFocusRegionContainerFromEnvironmentAndContainer((uint64_t)v12, (uint64_t)v14);
  id v15 = (id)objc_claimAutoreleasedReturnValue();
  v16 = [(_FEFocusMap *)self initWithFocusSystem:v13 rootContainer:v15 coordinateSpace:v11 searchInfo:0 ignoresRootContainerClippingRect:0];
...
- (_FEFocusMap)initWithFocusSystem:(id)a3 rootContainer:(id)a4 coordinateSpace:(id)a5 searchInfo:(id)a6 ignoresRootContainerClippingRect:(BOOL)a7
{
  ...
  else
  {
    ...
    [v23 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 118, @"Invalid parameter not satisfying: %@", @"focusSystem" object file lineNumber description];
  ...
  [v24 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 119, @"Invalid parameter not satisfying: %@", @"rootContainer" object file lineNumber description];

LABEL_3:
  v26.receiver = self;
  v26.super_class = (Class)_FEFocusMap;
  v17 = [(_FEFocusMap *)&v26 init];
  v18 = v17;
  if (v17)
  {
    ...
    if (!v15)
    {
      ...
      if (!v15)
      {
        ...
        [v25 handleFailureInMethod:a2, v18, @"_FEFocusMap.m", 127, @"Invalid parameter not satisfying: %@", @"coordinateSpace" object file lineNumber description];
    ...
    v18->_minimumSearchArea.origin = (CGPoint)*MEMORY[0x263F001A8];
    ...
    {
      v20 = +[_FEFocusSearchInfo defaultInfo];
    }
...
- (id)_defaultMapSnapshotter
{
  ...
  id v7 = [(_FEFocusMap *)self searchInfo];
  CGRect v8 = [(_FEFocusMapSnapshotter *)v3 initWithFocusSystem:WeakRetained rootContainer:v5 coordinateSpace:v6 searchInfo:v7 ignoresRootContainerClippingRect:self->_ignoresRootContainerClippingRect];
...
- (id)_allFocusableItemsInEnvironment:(id)a3
{
  ...
  if (v4)
  {
    id v5 = [(_FEFocusMap *)self _defaultMapSnapshotter];
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          if (v13)
          {
            id v14 = [(_FEFocusMap *)self searchInfo];
...
- (id)_inferredDefaultFocusItemInEnvironment:(id)a3
{
  ...
  id v4 = a3;
  [(_FEFocusMap *)self _beginTrackingDefaultItemSearchInfoIfNecessary];
  v69 = v4;
  if (v4)
  {
    v70 = self;
    v64 = [(_FEFocusMap *)self _defaultMapSnapshotter];
    [v64 setFocusedRegion:0];
    id v5 = [v64 captureSnapshot];
    id v6 = [(_FEFocusMap *)self _defaultItemSearchContext];
    [v6 addSnapshot:v5];

    v68 = [MEMORY[0x263F088B0] hashTableWithOptions:517];
    v66 = objc_opt_new();
    v67 = [MEMORY[0x263F08968] weakToWeakObjectsMapTable];
    id v65 = objc_alloc_init(MEMORY[0x263F08760]);
    long long v83 = 0u;
    long long v84 = 0u;
    long long v85 = 0u;
    long long v86 = 0u;
...
LABEL_4:
      ...
      while (1)
      {
        ...
        if (v12)
        {
          id v13 = [(_FEFocusMap *)v70 searchInfo];
      ...
      || ([v68 anyObject], (v17 = objc_claimAutoreleasedReturnValue()) == 0))
    {
      ...
      else
      {
        ...
        v38 = +[_FEFocusMovementInfo _movementWithHeading:v34 isInitial:1];
        ...
        if (v41)
        {
          ...
          do
          {
            for (uint64_t i = 0; i != v41; ++i)
            {
              ...
              if (v47)
              {
                double v48 = _FEFocusMapDistanceToRegionBoundary((uint64_t)v46, objc_msgSend(v46, "_effectiveFocusableBoundariesForHeading:", objc_msgSend(v38, "heading")), v38, objc_msgSend(v46, "_preferredDistanceComparisonType"), 1, v5, MaxX, v42, 1.0, 1.0);
                double v49 = v48;
                if (v48 <= v44)
                {
                  if (v48 < v44) {
        ...
        if (((v17 != 0) & (v52 >> 4)) != 0)
        {
          ...
          v54 = [(_FEFocusMap *)v70 coordinateSpace];
          uint64_t v55 = [(_FEFocusGroupMap *)v53 initWithItems:v68 coordinateSpace:v54];
          focusGroupMap = v70->_focusGroupMap;
          v70->_focusGroupMap = (_FEFocusGroupMap *)v55;

          v57 = [(_FEFocusGroupMap *)v70->_focusGroupMap focusGroupForItem:v17];
          v58 = [v57 primaryItem];
          v59 = v58;
          if (v58)
          {
...
LABEL_44:
    v61 = [(_FEFocusMap *)v70 _defaultItemSearchContext];
...
- (id)_nextFocusedItemForFocusMovementRequest:(id)a3
{
  ...
  if (!v5)
  {
    unsigned int v52 = [MEMORY[0x263F08690] currentHandler];
    [v52 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 325, @"Invalid parameter not satisfying: %@", @"request" object file lineNumber description];
  }
  ...
  if (v6 != WeakRetained)
  {
    ...
    [v53 handleFailureInMethod:a2 object:self file:@"_FEFocusMap.m" lineNumber:326 description:@"Submitted a focus movement request to a focus map with a mismatched focus system."];
  }
  [(_FEFocusMap *)self _beginTrackingFocusMovementSearchInfoIfNecessary];
  ...
  if (v11)
  {
    ...
    id v13 = [(_FEFocusMap *)self _nextFocusedItemForFocusMovementRequest:v5 startingFromRegion:v12];
  }
  else
  {
    ...
    if (!CGRectIsNull(v55))
    {
      ...
      {
        double v23 = [_FEFocusRegion alloc];
        CGFloat v24 = [(_FEFocusMap *)self coordinateSpace];
        double v25 = -[_FEFocusRegion initWithFrame:coordinateSpace:](v23, "initWithFrame:coordinateSpace:", v24, v16, v18, v20, v22);

        id v13 = [(_FEFocusMap *)self _nextFocusedItemForFocusMovementRequest:v5 startingFromRegion:v25];
    ...
    {
      CGFloat v26 = [(_FEFocusMap *)self coordinateSpace];
      [v26 bounds];
      double v28 = v27;
      double v30 = v29;
      double v32 = v31;
    ...
    {
      [(_FEFocusMap *)self minimumSearchArea];
      double v28 = v35;
      double v30 = v36;
      double v32 = v37;
      double v34 = v38;
    }
    id v12 = [(_FEFocusMap *)self _defaultMapSnapshotter];
    ...
    uint64_t v43 = [(_FEFocusMap *)self _focusMovementSearchContext];
    [v43 addSnapshot:v42];
    ...
    double v48 = [(_FEFocusMap *)self coordinateSpace];
    double v49 = -[_FEFocusRegion initWithFrame:coordinateSpace:](v47, "initWithFrame:coordinateSpace:", v48, v44, v46, 1.0, 1.0);

    id v50 = [v42 regions];
    id v13 = [(_FEFocusMap *)self _nextFocusedItemForFocusMovementRequest:v5 startingFromRegion:v49 inRegions:v50 withSnapshot:v42];
  }
LABEL_17:
...
- (id)_nextFocusedItemForFocusMovementRequest:(id)a3 startingFromRegion:(id)a4
{
  ...
  uint64_t v10 = [(_FEFocusMap *)self coordinateSpace];
  +[_FEFocusRegionEvaluator frameForRegion:v7 inCoordinateSpace:v10];
  CGFloat v12 = v11;
  CGFloat v14 = v13;
  CGFloat v16 = v15;
  CGFloat v18 = v17;
  ...
  if (self->_minimumSearchAreaIsEmpty)
  {
    double v19 = [(_FEFocusMap *)self coordinateSpace];
    [v19 bounds];
    CGFloat v21 = v20;
    CGFloat v23 = v22;
    CGFloat v25 = v24;
  ...
  {
    long long v72 = [(_FEFocusMap *)self _defaultMapSnapshotter];
    ...
    id v76 = [(_FEFocusMap *)self _focusMovementSearchContext];
    [v76 addSnapshot:v75];

    id v77 = [v75 regions];
    v70 = [(_FEFocusMap *)self _nextFocusedItemForFocusMovementRequest:v6 startingFromRegion:v7 inRegions:v77 withSnapshot:v75];
  }
  else
  {
LABEL_48:
...
- (id)_nextFocusedItemForFocusMovementRequest:(id)a3 inRegions:(id)a4 withSnapshot:(id)a5
{
  ...
  double v13 = [(_FEFocusMap *)self _nextFocusedItemForFocusMovementRequest:v10 startingFromRegion:v12 inRegions:v9 withSnapshot:v8];
...
- (id)_nextFocusedItemForFocusMovementRequest:(id)a3 startingFromRegion:(id)a4 inRegions:(id)a5 withSnapshot:(id)a6
{
  ...
  if (v15) {
    [(_FEFocusMap *)self _nextFocusedItemForLinearFocusMovementRequest:v13 startingFromRegion:v12 inRegions:v11 withSnapshot:v10];
  }
  else {
  CGFloat v16 = [(_FEFocusMap *)self _nextFocusedItemForNonLinearFocusMovementRequest:v13 startingFromRegion:v12 inRegions:v11 withSnapshot:v10];
  }
...
- (id)_nextFocusedItemForNonLinearFocusMovementRequest:(id)a3 startingFromRegion:(id)a4 inRegions:(id)a5 withSnapshot:(id)a6
{
  ...
  uint64_t v180 = [v13 heading];
  uint64_t v14 = [v13 _groupFilter];
  int v15 = (CGFloat *)MEMORY[0x263F001A0];
  v140 = v11;
  if (v11)
  {
  ...
  {
    CGFloat v24 = *MEMORY[0x263F001A0];
    CGFloat v25 = *(double *)(MEMORY[0x263F001A0] + 8);
    CGFloat v26 = *(double *)(MEMORY[0x263F001A0] + 16);
    CGFloat v27 = *(double *)(MEMORY[0x263F001A0] + 24);
    CGFloat v23 = v27;
    CGFloat v21 = v26;
    CGFloat v19 = v25;
    CGFloat v17 = *MEMORY[0x263F001A0];
  }
  ...
  {
    double v31 = [v12 coordinateSpace];
    CGFloat v32 = v29;
    [v29 _focusCastingFrameForHeading:v180 inCoordinateSpace:v31];
    CGFloat v24 = v33;
    CGFloat v25 = v34;
    CGFloat v26 = v35;
    CGFloat v27 = v36;
  ...
  {
    CGFloat v32 = v29;
    double v37 = [WeakRetained _focusCastingController];

    if (!v37) {
      goto LABEL_10;
    }
    double v31 = [WeakRetained _focusCastingController];
    double v38 = [v12 coordinateSpace];
    [v31 castingFrameForFocusedItem:v29 heading:v180 inCoordinateSpace:v38];
    CGFloat v24 = v39;
    CGFloat v25 = v40;
    CGFloat v26 = v41;
    CGFloat v27 = v42;
...
LABEL_10:
  if (v32 && v14 == 1)
  {
    double v43 = [_UIDynamicFocusGroupMap alloc];
    CGFloat v44 = [(_FEFocusMap *)v30 coordinateSpace];
    CGFloat v45 = [(_UIDynamicFocusGroupMap *)v43 initWithCoordinateSpace:v44];

    v142 = v45;
    CGFloat v46 = [(_UIDynamicFocusGroupMap *)v45 focusGroupIdentifierForItem:v32];
  }
  else
  {
    if (v14 == 2) {
      [MEMORY[0x263EFF940] raise:*MEMORY[0x263EFF498] format:@"Primary item focus group filtering is not available for non linear focus movement."];
    }
    CGFloat v46 = 0;
    v142 = 0;
  }
  v203.origin.double x = v24;
  v203.origin.double y = v25;
  v203.size.double width = v26;
  v203.size.double height = v27;
  v207.origin.double y = v176;
  v207.origin.double x = v178;
  v207.size.double height = v172;
  v207.size.double width = v174;
  if (!CGRectEqualToRect(v203, v207))
  {
    CGFloat v23 = v27;
    CGFloat v21 = v26;
    CGFloat v19 = v25;
  ...
  if (!v180
    || ![v141 count]
    || (v204.origin.x = v17, v204.origin.y = v19, v204.size.width = v21, v204.size.double height = v23, CGRectIsEmpty(v204)))
  {
    double v47 = 0;
    goto LABEL_22;
  }
  ...
  obuint64_t j = v141;
  v179 = v12;
  uint64_t v148 = [obj countByEnumeratingWithState:&v189 objects:v199 count:16];
  id v159 = v51;
  if (!v148)
  {
    char v143 = 0;
    double v162 = 1.79769313e308;
    goto LABEL_134;
  }
  char v143 = 0;
  ...
  do
  {
    ...
    do
    {
      ...
      uint64_t v151 = v54;
      double v56 = *(void **)(*((void *)&v189 + 1) + 8 * v54);
      uint64_t v57 = [v56 _effectiveFocusableBoundariesForHeading:v180];
      uint64_t v173 = [v56 _effectiveBoundariesBlockingFocusMovementRequest:v150];
      uint64_t v168 = [v56 _preferredDistanceComparisonType];
      v170 = v56;
      [v56 _focusPriority];
      float v163 = v58;
      long long v185 = 0u;
      ...
      long long v187 = 0u;
      long long v188 = 0u;
      uint64_t v175 = [&unk_2700D5F50 countByEnumeratingWithState:&v185 objects:v198 count:16];
      if (v175)
      {
        char v165 = 0;
        uint64_t v171 = *(void *)v186;
        uint64_t v167 = v57;
        while (2)
        {
          uint64_t v59 = 0;
LABEL_33:
          if (*(void *)v186 != v171) {
            objc_enumerationMutation(&unk_2700D5F50);
          }
          double v60 = *(void **)(*((void *)&v185 + 1) + 8 * v59);
          uint64_t v61 = [v60 unsignedIntegerValue];
          uint64_t v62 = v61 & v57;
          uint64_t v63 = v61 & v173;
          if (!(v61 & v57 | v61 & v173)) {
            goto LABEL_95;
          }
          unsigned int v64 = v61;
          double v65 = _FEFocusMapDistanceToRegionBoundary((uint64_t)v170, v61, v13, 1, v50, v12, v17, v19, v21, v23);
          double v169 = v65;
          if (!v168) {
            double v65 = _FEFocusMapDistanceToRegionBoundary((uint64_t)v170, v64, v13, 0, v50, v12, v17, v19, v21, v23);
          }
          int v66 = [v170 _ignoresSpeedBumpEdges];
          if (v65 < 0.0)
          {
            uint64_t v57 = v167;
            goto LABEL_95;
          ...
          [v12 snapshotFrameForRegion:v170];
          BOOL v166 = _UIRectIntersectsRectAlongFocusHeading(v180, v68, v69, v70, v71, v17, v19, v21, v23);
          long long v181 = 0u;
          long long v182 = 0u;
          long long v183 = 0u;
          long long v184 = 0u;
          id v72 = v51;
          uint64_t v73 = [v72 countByEnumeratingWithState:&v181 objects:v197 count:16];
          if (v73)
          {
            ...
            while (2)
            {
              for (uint64_t i = 0; i != v73; ++i)
              {
                ...
                id v76 = [v177 objectForKey:*(void *)(*((void *)&v181 + 1) + 8 * i)];
                [v12 snapshotFrameForRegion:v76];
                BOOL v81 = _UIRectIntersectsRectAlongFocusHeading(v180, v77, v78, v79, v80, v17, v19, v21, v23);
...
LABEL_54:
          double v82 = v65;
          double v83 = vabdd_f64(v162, v65);
          double v84 = vabdd_f64(v53, v169);
          double v85 = vabds_f32(v52, v163);
          BOOL v86 = v83 >= 0.0001 || v82 < v162;
          double v164 = v82;
          int v87 = v82 < v162 || !v86;
...
LABEL_95:
            if (++v59 == v175)
            {
              uint64_t v105 = [&unk_2700D5F50 countByEnumeratingWithState:&v185 objects:v198 count:16];
              uint64_t v175 = v105;
              if (!v105)
              {
LABEL_121:
        ...
        uint64_t v91 = v84 < 0.0001;
        double v53 = v88;
        if (v169 < v88) {
          uint64_t v91 = 2;
        }
        int v92 = v163 > v89 || v86;
        if (v83 >= 0.0001) {
          uint64_t v93 = 1;
        }
        else {
        ...
        if (v96)
        {
          ...
          uint64_t v97 = [&unk_2700D5F50 indexOfObject:v60];
        }
        else
        {
LABEL_101:
          uint64_t v98 = [&unk_2700D5F50 indexOfObject:v60];
          uint64_t v97 = v98;
          if (v95 == 1)
          {
            CGRect v99 = v170;
            ...
            if (v98 == v152)
            {
              ...
              uint64_t v95 = 1;
LABEL_105:
              CGRect v100 = [v179 _cachedNextFocusedItemForRegion:v99 withFocusMovementRequest:v150 inMap:v149];
              if (v100)
              {
                CGRect v101 = [(_FEFocusMap *)v149 searchInfo];
                int IsFocusableInFocusSystemWithSearchInfo = _FEFocusItemIsFocusableInFocusSystemWithSearchInfo(v100, WeakRetained, v101);

                if (IsFocusableInFocusSystemWithSearchInfo)
                {
                  if (v144)
                  {
                    CGRect v103 = [(_UIDynamicFocusGroupMap *)v142 focusGroupIdentifierForItem:v100];
                    int v104 = [v144 isEqual:v103];
                  ...
                  [v72 addObject:v100];
                  [v177 setObject:v170 forKey:v100];
                  char v165 = 1;
                  float v52 = v163;
                  double v162 = v164;
                  uint64_t v50 = v160;
...
LABEL_128:
    ...
    while (v151 + 1 != v148);
    uint64_t v106 = [obj countByEnumeratingWithState:&v189 objects:v199 count:16];
    uint64_t v148 = v106;
  }
  while (v106);
LABEL_134:
  ...
  {
    double v47 = [v51 lastObject];
  }
  else
  {
    v107 = [v150 focusedItemInfo];
    v108 = [v107 focusedRegion];
    if (v108 != v140) {
      goto LABEL_140;
    }
    double v47 = [v107 item];
    if (!v47 || fabs(v162) >= 0.0001 || ([v51 containsObject:v47] & 1) == 0)
    {

LABEL_140:
      double v47 = [WeakRetained _previousFocusedItem];
      if (([v51 containsObject:v47] & 1) == 0)
      {
...
LABEL_145:
        [v150 movementInfo];
        v110 = v109 = v51;
        char v111 = [v110 heading];

        id v112 = objc_loadWeakRetained((id *)&v149->_coordinateSpace);
        id v113 = v109;
        id v114 = v112;
        v115 = v114;
        if ((v111 & 3) != 0)
        {
          ...
          long long v195 = 0u;
          long long v196 = 0u;
          uint64_t v117 = [v113 countByEnumeratingWithState:&v193 objects:v200 count:16];
          if (v117)
          {
            uint64_t v118 = v117;
            double v47 = 0;
            uint64_t v119 = *(void *)v194;
            double v120 = 2.22507386e-308;
            do
            {
              for (uint64_t j = 0; j != v118; ++j)
              {
                ...
                v122 = *(void **)(*((void *)&v193 + 1) + 8 * j);
                v205.origin.double x = _FEFocusItemFrameInCoordinateSpace(v122, v116);
                double MaxX = CGRectGetMaxX(v205);
                if (MaxX >= v120)
                {
                  double v124 = MaxX;
                  id v125 = v122;
              ...
              uint64_t v118 = [v113 countByEnumeratingWithState:&v193 objects:v200 count:16];
            }
            while (v118);
            goto LABEL_168;
          }
LABEL_167:
        ...
        if ((v111 & 0xC) != 0)
        {
          ...
          long long v195 = 0u;
          long long v196 = 0u;
          uint64_t v126 = [v113 countByEnumeratingWithState:&v193 objects:v200 count:16];
          if (!v126) {
            goto LABEL_167;
          }
          uint64_t v127 = v126;
          double v47 = 0;
          uint64_t v128 = *(void *)v194;
          ...
          do
          {
            for (uint64_t k = 0; k != v127; ++k)
            {
              ...
              v131 = *(void **)(*((void *)&v193 + 1) + 8 * k);
              v206.origin.double x = _FEFocusItemFrameInCoordinateSpace(v131, v116);
              double MinY = CGRectGetMinY(v206);
              if (MinY <= v129)
              {
                double v133 = MinY;
                id v134 = v131;
            ...
            uint64_t v127 = [v113 countByEnumeratingWithState:&v193 objects:v200 count:16];
          }
          while (v127);
LABEL_168:
  ...
  v135 = [(_FEFocusMap *)v30 _focusMovementSearchContext];
  [v177 objectForKey:v47];
  v137 = v136 = v30;
  [v135 addDestinationRegion:v137];

  v138 = [(_FEFocusMap *)v136 _focusMovementSearchContext];
  [v138 setDidFindFocusBlockingBoundary:(v47 == 0) & v143];
...
- (id)_nextFocusedItemForLinearFocusMovementRequest:(id)a3 startingFromRegion:(id)a4 inRegions:(id)a5 withSnapshot:(id)a6
{
  ...
  if (v15)
  {
    ...
    CGFloat v70 = v14;
    id v66 = v11;
    id v72 = [MEMORY[0x263F08968] weakToWeakObjectsMapTable];
    uint64_t v73 = [MEMORY[0x263F088B0] hashTableWithOptions:517];
    ...
    double v28 = [[_FEFocusMovementRequest alloc] initWithFocusSystem:WeakRetained];
    double v29 = [v10 movementInfo];
    double v30 = +[_FEFocusRegionMovementInfo _movementWithHeading:linearHeading:originatingHeading:isInitial:inputType:](_FEFocusRegionMovementInfo, "_movementWithHeading:linearHeading:originatingHeading:isInitial:inputType:", v27, v27, v15, 1, [v29 _inputType]);
    [(_FEFocusMovementRequest *)v28 setMovementInfo:v30];

    double v31 = [v10 focusedItemInfo];
    CGFloat v78 = v28;
    [(_FEFocusMovementRequest *)v28 setFocusedItemInfo:v31];

    CGFloat v71 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
    long long v82 = 0u;
    long long v83 = 0u;
    long long v84 = 0u;
    long long v85 = 0u;
...
LABEL_46:
      ...
      id v80 = WeakRetained;
      BOOL v81 = self;
      id v51 = objc_msgSend(v50, "bs_filter:", v79);

      id v10 = v67;
      float v52 = [v67 movementInfo];
      uint64_t v53 = [v52 _groupFilter];

      uint64_t v54 = [(_FEFocusMap *)self _linearlySortedFocusItemsForItems:v51 groupFilter:v53 itemStandInMap:v71];
      uint64_t v14 = v70;
      int v15 = _FEFocusGetNextItemFromList(v77, v54, v68, [v70 _isLooping]);
      uint64_t v55 = [v72 objectForKey:v15];
      double v56 = [(_FEFocusMap *)self _focusMovementSearchContext];
      ...
      uint64_t v59 = [(_FEFocusMap *)self _defaultItemSearchContext];
      [v59 setLinearSortedFocusItems:v54];

      double v60 = [(_FEFocusMap *)self _focusMovementSearchContext];
      [v60 setLinearSortedFocusItems:v54];

      focusGroupMap = self->_focusGroupMap;
      uint64_t v62 = [(_FEFocusMap *)self _defaultItemSearchContext];
      [v62 setFocusGroupMap:focusGroupMap];

      uint64_t v63 = self->_focusGroupMap;
      unsigned int v64 = [(_FEFocusMap *)self _focusMovementSearchContext];
...
LABEL_30:
      ...
      [(_FEFocusMap *)self searchInfo];
      v44 = id v43 = v13;
      char IsFocusableInFocusSystemWithSearchInfo = _FEFocusItemIsFocusableInFocusSystemWithSearchInfo(v41, WeakRetained, v44);
...
- (id)_allDefaultFocusableRegionsInContainer:(id)a3 intersectingRegion:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = [(_FEFocusMap *)self coordinateSpace];
  +[_FEFocusRegionEvaluator frameForRegion:v7 inCoordinateSpace:v8];
  double v10 = v9;
  double v12 = v11;
  double v14 = v13;
  double v16 = v15;
  ...
  {
    double v18 = [(_FEFocusMap *)self _defaultMapSnapshotter];
    [v18 setRegionsContainer:v6];
    objc_msgSend(v18, "setSnapshotFrame:", v10, v12, v14, v16);
    double v17 = [(_FEFocusMap *)self _findAllDefaultFocusableRegionsWithSnapshotter:v18];
  }
  else
  {
...
- (id)_closestFocusableItemToPoint:(CGPoint)a3 inRect:(CGRect)a4 excludingItems:(id)a5 distanceMeasuringUnitPoint:(CGPoint)a6
{
  ...
  {
    double v15 = [(_FEFocusMap *)self _defaultMapSnapshotter];
...
- (id)_findAllDefaultFocusableRegionsWithSnapshotter:(id)a3
{
  ...
  id v5 = [(_FEFocusMap *)self _defaultItemSearchContext];
  [v5 addSnapshot:v4];

  id v6 = [(_FEFocusMap *)self _focusMovementSearchContext];
  [v6 addSnapshot:v4];
  ...
  if (v9)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        if (v14)
        {
          double v15 = [(_FEFocusMap *)self searchInfo];
          int IsFocusableInFocusSystemWithSearchInfo = _FEFocusItemIsFocusableInFocusSystemWithSearchInfo(v14, WeakRetained, v15);
...
- (id)_linearlySortedFocusItemsForItems:(id)a3 groupFilter:(int64_t)a4 itemStandInMap:(id)a5
{
  ...
  if (a4 == 1)
  {
    double v15 = [(_FEFocusMap *)self focusSystem];
    double v16 = [v15 focusedItem];

    if (v16)
    {
      id v17 = [v8 arrayByAddingObject:v16];
      double v18 = [_FEFocusGroupMap alloc];
      id v19 = [(_FEFocusMap *)self coordinateSpace];
      long long v20 = [(_FEFocusGroupMap *)v18 initWithItems:v17 standInItemsMap:v9 coordinateSpace:v19];
      focusGroupMap = self->_focusGroupMap;
      self->_focusGroupMap = v20;

      long long v22 = [(_FEFocusGroupMap *)self->_focusGroupMap focusGroupForItem:v16];
      long long v23 = (void *)MEMORY[0x263F08A98];
      uint64_t v30 = MEMORY[0x263EF8330];
      uint64_t v31 = 3221225472;
      id v32 = __76___FEFocusMap__linearlySortedFocusItemsForItems_groupFilter_itemStandInMap___block_invoke;
      double v33 = &unk_265328670;
      double v34 = self;
      id v35 = v22;
      id v24 = v22;
  ...
  {
    uint64_t v10 = [_FEFocusGroupMap alloc];
    uint64_t v11 = [(_FEFocusMap *)self coordinateSpace];
    double v12 = [(_FEFocusGroupMap *)v10 initWithItems:v8 standInItemsMap:v9 coordinateSpace:v11];
    id v13 = self->_focusGroupMap;
    self->_focusGroupMap = v12;

    id v14 = [(_FEFocusGroupMap *)self->_focusGroupMap focusItems];
    goto LABEL_8;
  }
  uint64_t v27 = [v8 sortedArrayUsingComparator:&__block_literal_global_6];
...
- (BOOL)verifyFocusabilityForItem:(id)a3
{
  ...
  id v4 = a3;
  id v5 = +[_FEFocusItemInfo infoWithItem:v4];
  ...
  if (v7)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        double v12 = [(_FEFocusMap *)self focusSystem];
  ...
  id v14 = [(_FEFocusMap *)self _defaultMapSnapshotter];
...
- (void)_beginTrackingSearches
{
  if (self->_trackingSearchInfo)
  {
    ...
    [v4 handleFailureInMethod:a2 object:self file:@"_FEFocusMap.m" lineNumber:1149 description:@"Attempted to begin tracking focus map searches  without finishing previous tracking."];
  }
...
- (id)_stopTrackingSearches
{
  if (self->_trackingSearchInfo)
  {
    *(_WORD *)&self->_trackingSearchInfo = 0;
    v3 = [(_FEFocusMap *)self _defaultItemSearchContext];
    id v4 = v3;
    if (v3)
    {
      id v5 = v3;
    ...
    {
      id v5 = [(_FEFocusMap *)self _focusMovementSearchContext];
    }
    id v6 = v5;
...
- (void)diagnoseFocusabilityForItem:(id)a3 report:(id)a4
{
  ...
  {
    double v41 = [MEMORY[0x263F08690] currentHandler];
    [v41 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 1198, @"Invalid parameter not satisfying: %@", @"item" object file lineNumber description];

    if (v9) {
      goto LABEL_3;
    }
  }
  double v42 = [MEMORY[0x263F08690] currentHandler];
  [v42 handleFailureInMethod:a2, self, @"_FEFocusMap.m", 1199, @"Invalid parameter not satisfying: %@", @"report" object file lineNumber description];

LABEL_3:
  if ([v7 _canBecomeFocused])
  {
    uint64_t v10 = [(_FEFocusMap *)self _defaultMapSnapshotter];
...
LABEL_18:
      ...
      if (v23)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            {
              uint64_t v51 = v26;
              long long v29 = +[_FEDebugIssue issueWithDescription:@"The item is being visually occluded by the following items:"];
              long long v52 = 0u;
              long long v53 = 0u;
              long long v54 = 0u;
              long long v55 = 0u;
                ...
                do
                {
                  for (uint64_t j = 0; j != v32; ++j)
                  {
                    ...
                    if (v35)
                    {
                      ...
                      double v40 = +[_FEDebugIssue issueWithDescription:v39];

                      [v40 setPrefix:&stru_2700CBC00];
                      [v29 addIssue:v40];
                    }
                  }
    ...
    {
      id v22 = +[_FEDebugIssue issueWithDescription:@"This item is not visible onscreen."];
      [v9 addIssue:v22];
    }
  }
  else
  {
    id v21 = +[_FEDebugIssue issueWithDescription:@"This item returns NO from -_canBecomeFocused."];
    [v9 addIssue:v21];
  }
}
