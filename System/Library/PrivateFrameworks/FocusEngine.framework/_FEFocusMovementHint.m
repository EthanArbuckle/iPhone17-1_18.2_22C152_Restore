@interface _FEFocusMovementHint
...
- (_FEFocusMovementHint)initWithMovementDirection:(CGVector)a3 itemSize:(CGSize)a4
{
  ...
  result = [(_FEFocusMovementHint *)&v18 init];
  if (result)
  {
    ...
    {
      float64x2_t v17 = (float64x2_t)xmmword_24F427660;
    }
    else
    {
      if (height <= width) {
      ...
      float64x2_t v12 = vmulq_n_f64((float64x2_t)xmmword_24F427670, fmin(v11, 1.0));
      ...
      *(void *)&_Q1.f64[0] = *(_OWORD *)&vaddq_f64(v12, _Q1);
      ...
      float64x2_t v17 = vminnmq_f64((float64x2_t)vbslq_s8((int8x16_t)vcgtq_f64((float64x2_t)xmmword_24F427680, _Q1), (int8x16_t)xmmword_24F427680, (int8x16_t)_Q1), (float64x2_t)xmmword_24F427690);
    }
...
- (CATransform3D)perspectiveTransform
{
  ...
  *(_OWORD *)&retstr->m31 = *(_OWORD *)(MEMORY[0x263F15740] + 64);
...
- (CATransform3D)interactionTransform
{
  long long v5 = (long long *)MEMORY[0x263F15740];
  long long v41 = *(_OWORD *)(MEMORY[0x263F15740] + 64);
  long long v42 = *(_OWORD *)(MEMORY[0x263F15740] + 80);
  ...
  *(_OWORD *)&retstr->m23 = v36;
  [(_FEFocusMovementHint *)self rotation];
  CGFloat v7 = v6;
  CGFloat v9 = v8;
  [(_FEFocusMovementHint *)self translation];
  CGFloat v11 = v10;
  CGFloat v13 = v12;
  *(_OWORD *)&v44.m31 = v41;
  *(_OWORD *)&v44.m33 = v42;
  ...
  *(_OWORD *)&retstr->m23 = v33;
  CGVector result = [(_FEFocusMovementHint *)self perspectiveTransform];
  retstr->m34 = v43;
  return result;
}
