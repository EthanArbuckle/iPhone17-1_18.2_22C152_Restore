...
+ (id)databaseQueueWithURL:(id)a3 flags:(int)a4
{
  uint64_t v4 = *(void *)&a4;
  id v6 = [a3 path];
  v7 = [a1 databaseQueueWithPath:v6 flags:v4];
...
- (_bmFMDatabaseQueue)initWithPath:(id)a3 flags:(int)a4 vfs:(id)a5
{
  ...
  if (v11)
  {
    uint64_t v12 = objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "databaseClass"), "databaseWithPath:", v9);
    v13 = (void *)*((void *)v11 + 2);
    *((void *)v11 + 2) = v12;

    if (![*((id *)v11 + 2) openWithFlags:v6 vfs:v10])
    {
      NSLog(&cfstr_CouldNotCreate.isa, v9);
      v19 = 0;
      goto LABEL_6;
    }
    objc_storeStrong((id *)v11 + 4, a3);
    id v14 = (id) [[NSString alloc] initWithFormat:@"fmdb.%@", v11];
...
- (_bmFMDatabaseQueue)initWithURL:(id)a3 flags:(int)a4
{
  uint64_t v4 = *(void *)&a4;
  uint64_t v6 = [a3 path];
  v7 = [(_bmFMDatabaseQueue *)self initWithPath:v6 flags:v4 vfs:0];
...
LABEL_5:
  ...
  {
    NSLog(&cfstr_Bmfmdatabasequ.isa, self->_path);
    v7 = self->_db;
    self->_db = 0;
...
- (void)inDatabase:(id)a3
{
  ...
  v9[1] = 3221225472;
  v9[2] = __33___bmFMDatabaseQueue_inDatabase___block_invoke;
  v9[3] = &unk_1E617A3D8;
  v9[4] = self;
  id v10 = v4;
  id v8 = v4;
...
- (id)inSavePoint:(id)a3
{
  ...
  dispatch_queue_t v15 = __Block_byref_object_copy__0;
