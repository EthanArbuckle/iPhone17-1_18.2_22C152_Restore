...
- (void)textStorage:(id)a3 willProcessEditing:(unint64_t)a4 range:(_NSRange)a5 changeInLength:(int64_t)a6
{
  id v6 = *(Class *)((char *)&self->super.isa + OBJC_IVAR___JULanguageAwareTextStorage_originalTextStorageDelegate);
  if (v6)
  {
    NSUInteger length = a5.length;
    NSUInteger location = a5.location;
    if (objc_msgSend(*(id *)((char *)&self->super.isa+ OBJC_IVAR___JULanguageAwareTextStorage_originalTextStorageDelegate), sel_respondsToSelector_, sel_textStorage_willProcessEditing_range_changeInLength_))
    {
...
- (void)textStorage:(id)a3 didProcessEditing:(unint64_t)a4 range:(_NSRange)a5 changeInLength:(int64_t)a6
{
  ...
  id v11 = a3;
  v12 = self;
  sub_1B080AA6C(v11, a4, location, length, a6);
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa + OBJC_IVAR___JULanguageAwareTextStorage_languageAwareString);
}
