...
- (void)setupSubviews
{
  ...
  v5 = objc_msgSend(MEMORY[0x1E4FB1818], "hk_disclosureChevronImage");
  ...
  v14 = [MEMORY[0x1E4FB1618] tertiaryLabelColor];
  ...
  id v31 = objc_alloc_init(MEMORY[0x1E4FB1838]);
...
{
  id v4 = a3;
  id v5 = [(WDMedicalRecordStandaloneImageCell *)self titleLabel];
  [v5 setText:v4];
}
...
{
  id v4 = a3;
  id v5 = [(WDMedicalRecordStandaloneImageCell *)self detailLabel];
  [v5 setText:v4];
}
...
{
  id v4 = a3;
  id v5 = [(WDMedicalRecordStandaloneImageCell *)self titleImageView];
  [v5 setImage:v4];
}
