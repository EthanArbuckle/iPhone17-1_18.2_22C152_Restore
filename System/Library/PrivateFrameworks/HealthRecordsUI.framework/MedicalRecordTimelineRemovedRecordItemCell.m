...
- (_TtC15HealthRecordsUI42MedicalRecordTimelineRemovedRecordItemCell)initWithFrame:(CGRect)a3
{
  return (_TtC15HealthRecordsUI42MedicalRecordTimelineRemovedRecordItemCell *)sub_1C24CF3C0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC15HealthRecordsUI42MedicalRecordTimelineRemovedRecordItemCell)initWithCoder:(id)a3
{
  return (_TtC15HealthRecordsUI42MedicalRecordTimelineRemovedRecordItemCell *)sub_1C24CF65C(a3);
}
