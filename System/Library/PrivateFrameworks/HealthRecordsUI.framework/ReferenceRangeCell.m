...
- (_TtC15HealthRecordsUI18ReferenceRangeCell)initWithFrame:(CGRect)a3
{
  return (_TtC15HealthRecordsUI18ReferenceRangeCell *)sub_1C2314B28(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC15HealthRecordsUI18ReferenceRangeCell)initWithCoder:(id)a3
{
  ...
  *((void *)v4 + 4) = 0;
  ...
  result = (_TtC15HealthRecordsUI18ReferenceRangeCell *)sub_1C25505F0();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = (char *)self + OBJC_IVAR____TtC15HealthRecordsUI18ReferenceRangeCell_item;
