...
+ (NSString)defaultReuseIdentifier
{
  return (NSString *)@"HRWDSpinnerTableViewCellIdentifier";
}
...
- (void)setupSubviews
{
  ...
  objc_super v7 = [(HRWDSpinnerTableViewCell *)self contentContainerView];
  ...
  id v10 = [(HRWDSpinnerTableViewCell *)self spinner];
  [v10 startAnimating];
}
...
- (void)setupConstraints
{
  ...
  v4 = [v3 heightAnchor];
  id v48 = [v4 constraintGreaterThanOrEqualToConstant:*MEMORY[0x1E4FB2F30]];
...
{
  id v4 = a3;
  double v5 = [(HRWDSpinnerTableViewCell *)self waitingReasonLabel];
  ...
  if (!v5)
  {
    ...
    id v10 = [(HRWDSpinnerTableViewCell *)self waitingReasonLabel];
    ...
    id v48 = [(HRWDSpinnerTableViewCell *)self contentContainerView];
    v49 = [v48 trailingAnchor];
    v50 = [v47 constraintEqualToAnchor:v49];
    [v50 setActive:1];
  }
  id v51 = [(HRWDSpinnerTableViewCell *)self waitingReasonLabel];
  [v51 setText:v4];
}
