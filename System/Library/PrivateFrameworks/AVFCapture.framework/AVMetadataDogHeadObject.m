...
+ (id)dogHeadObjectWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5
{
  v5 = (void *)[objc_alloc((Class)objc_opt_class()) initWithFigEmbeddedCaptureDeviceObjectDictionary:a3 input:a4 timeStamp:a5 type:@"dogHead"];
...
- (AVMetadataDogHeadObject)initWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5 type:(id)a6
{
  ...
  *(_OWORD *)&v25.value = *MEMORY[0x1E4F1F9F8];
  ...
  v23.receiver = self;
  v23.super_class = (Class)AVMetadataDogHeadObject;
...
- (id)initDerivedMetadataObjectFromMetadataObject:(id)a3 withTransform:(CGAffineTransform *)a4 isVideoMirrored:(BOOL)a5 rollAdjustment:(double)a6
{
  ...
  if (AVMetadataObjectAdjustBaseClassProperties((uint64_t)v20, &v21, v11, v12, v13, v14))
  {
    ...
    v17.receiver = self;
    v17.super_class = (Class)AVMetadataDogHeadObject;
    return [(AVMetadataObject *)&v17 initWithType:@"dogHead", v19, v18, 0, a3, v16, *(_OWORD *)&v21.origin, *(_OWORD *)&v21.size time duration bounds optionalInfoDict originalMetadataObject sourceCaptureInput];
  }
  else
  {
