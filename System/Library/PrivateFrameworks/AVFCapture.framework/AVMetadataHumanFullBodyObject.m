...
+ (AVMetadataHumanFullBodyObject)humanFullBodyObjectWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5
{
  ...
  return (AVMetadataHumanFullBodyObject *)v5;
}

- (AVMetadataHumanFullBodyObject)initWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5
{
  v6.receiver = self;
  v6.super_class = (Class)AVMetadataHumanFullBodyObject;
...
- (AVMetadataHumanFullBodyObject)initWithBodyID:(int64_t)a3 time:(id *)a4 duration:(id *)a5 bounds:(CGRect)a6
{
  ...
  return -[AVMetadataHumanFullBodyObject initWithBodyID:time:duration:bounds:optionalInfoDict:originalMetadataObject:sourceCaptureInput:](self, "initWithBodyID:time:duration:bounds:optionalInfoDict:originalMetadataObject:sourceCaptureInput:", a3, &v8, &v7, 0, 0, 0, a6.origin.x, a6.origin.y, a6.size.width, a6.size.height);
}

- (AVMetadataHumanFullBodyObject)initWithBodyID:(int64_t)a3 time:(id *)a4 duration:(id *)a5 bounds:(CGRect)a6 optionalInfoDict:(id)a7 originalMetadataObject:(id)a8 sourceCaptureInput:(id)a9
{
  v12.receiver = self;
  v12.super_class = (Class)AVMetadataHumanFullBodyObject;
  $3CC8671D27C23BF42ADDB32F2B5E48AE v11 = *a4;
  $3CC8671D27C23BF42ADDB32F2B5E48AE v10 = *a5;
  return [(AVMetadataBodyObject *)&v12 initWithType:@"humanFullBody", a3, &v11, &v10, a7, a8, a6.origin.x, a6.origin.y, a6.size.width, a6.size.height, a9 bodyID time duration bounds optionalInfoDict originalMetadataObject sourceCaptureInput];
}
...
- (id)initDerivedMetadataObjectFromMetadataObject:(id)a3 withTransform:(CGAffineTransform *)a4 isVideoMirrored:(BOOL)a5 rollAdjustment:(double)a6
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)AVMetadataHumanFullBodyObject;
