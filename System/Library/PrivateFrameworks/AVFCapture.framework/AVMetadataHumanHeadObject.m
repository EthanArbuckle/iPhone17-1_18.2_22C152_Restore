...
+ (id)humanHeadObjectWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5
{
  v5 = (void *)[objc_alloc((Class)objc_opt_class()) initWithFigEmbeddedCaptureDeviceObjectDictionary:a3 input:a4 timeStamp:a5 type:@"humanHead"];
...
- (id)initDerivedMetadataObjectFromMetadataObject:(id)a3 withTransform:(CGAffineTransform *)a4 isVideoMirrored:(BOOL)a5 rollAdjustment:(double)a6
{
  ...
  if (AVMetadataObjectAdjustBaseClassProperties((uint64_t)v20, &v21, v11, v12, v13, v14))
  {
    ...
    return [(AVMetadataObject *)&v17 initWithType:@"humanHead", v19, v18, 0, a3, v16, *(_OWORD *)&v21.origin, *(_OWORD *)&v21.size time duration bounds optionalInfoDict originalMetadataObject sourceCaptureInput];
  }
  else
  {
