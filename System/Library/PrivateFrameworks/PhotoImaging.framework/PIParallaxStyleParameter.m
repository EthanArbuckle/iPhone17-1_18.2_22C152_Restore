...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    v6 = [(PIParallaxStyleParameter *)self type];
    v7 = [v5 type];
    int v8 = [v6 isEqualToString:v7];

    if (v8) {
      BOOL v9 = [(PIParallaxStyleParameter *)self isEqualToParallaxStyleParameter:v5];
    }
    else {
      BOOL v9 = 0;
    }
...
- (id)evaluateWithContext:(id)a3 error:(id *)a4
{
  ...
  while (1)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F7A748], OS_LOG_TYPE_ERROR))
    {
      ...
      uint64_t v12 = [v8 stringWithFormat:@"This is an abstract method! Subclass '%@' should provide concrete implementation", v11];
      *(_DWORD *)buf = 138543362;
      __int16 v26 = v12;
...
LABEL_7:
        ...
        if (os_log_type_enabled(*v6, OS_LOG_TYPE_ERROR))
        {
          ...
          os_log_t v18 = [v17 componentsJoinedByString:@"\n"];
          *(_DWORD *)buf = 138543362;
          __int16 v26 = v18;
...
LABEL_13:
    ...
    if (os_log_type_enabled(*v6, OS_LOG_TYPE_ERROR))
    {
      ...
      id v5 = [v23 componentsJoinedByString:@"\n"];
      *(_DWORD *)buf = 138543618;
