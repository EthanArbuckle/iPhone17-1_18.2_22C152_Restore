...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v4)
  {
    uint64_t v5 = [(PIPosterInactiveFrameLayoutRequest *)self segmentationItem];
    v6 = (void *)v4[19];
    v4[19] = v5;

    uint64_t v7 = [(PIPosterInactiveFrameLayoutRequest *)self layout];
    v8 = (void *)v4[20];
    v4[20] = v7;
  }
  return v4;
...
- (PIPosterInactiveFrameLayoutRequest)initWithSegmentationItem:(id)a3
{
  ...
  if (!v4)
  {
    objc_super v10 = NUAssertLogger_22987();
