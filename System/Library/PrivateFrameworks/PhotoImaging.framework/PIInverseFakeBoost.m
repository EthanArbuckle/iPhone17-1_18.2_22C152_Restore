...
void __31__PIInverseFakeBoost_kernelFB3__block_invoke()
{
  ...
  if (!kernelFB3_kernel_92)
  {
    ...
    {
      v3 = [NSString stringWithFormat:@"inverse boost kernel is nil"];
      int v15 = 138543362;
      v16 = v3;
...
+ (id)kernelFB0
{
  if (kernelFB0_onceToken_86 != -1) {
    dispatch_once(&kernelFB0_onceToken_86, &__block_literal_global_88_12917);
  }
  v2 = (void *)kernelFB0_kernel_85;
  return v2;
}
