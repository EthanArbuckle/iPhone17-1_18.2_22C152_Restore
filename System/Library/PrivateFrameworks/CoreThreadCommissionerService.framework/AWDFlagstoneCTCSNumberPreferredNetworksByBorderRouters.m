...
- (BOOL)readFrom:(id)a3
{
  return sub_100004BA4((uint64_t)self, (uint64_t)a3);
}
...
- (unint64_t)hash
{
  ...
  {
    uint64_t v5 = 2654435761 * self->_numberOfPreferredNwByThirdPartyBorderRouters;
...
LABEL_6:
  uint64_t v6 = 2654435761 * self->_numberOfPreferredNwByAppleBorderRouters;
  return v4 ^ v3 ^ v5 ^ v6;
}
