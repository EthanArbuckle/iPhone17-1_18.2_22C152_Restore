...
+ (id)computedUniqueIdentifierForNetwork:(id)a3 keychainAccessGroup:(id)a4
{
  ...
  id v6 = a3;
  CC_SHA256_Init(&v18);
  CC_SHA256_Update(&v18, &unk_100068DF8, 0x10u);
  id v7 = v5;
...
+ (id)computedUniqueIdentifierForBorderAgent:(id)a3 network:(id)a4 keychainAccessGroup:(id)a5
{
  ...
  id v9 = a3;
  CC_SHA256_Init(&v24);
  CC_SHA256_Update(&v24, &unk_100068DF8, 0x10u);
  id v10 = v7;
      ...
      if (v33)
      {
        ...
        if (([v35 isEqual:v15] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR)) {
            sub_10001C884(v18, (uint64_t)v35, v38);
          }
        }
LABEL_66:
        long long v26 = v40;
