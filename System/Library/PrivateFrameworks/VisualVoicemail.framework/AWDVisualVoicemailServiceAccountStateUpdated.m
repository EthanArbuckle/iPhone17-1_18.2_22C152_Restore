...
- (void)setHasServiceState:(BOOL)a3;
...
{
  v7.receiver = self;
  v7.super_class = (Class)AWDVisualVoicemailServiceAccountStateUpdated;
  char v3 = [(AWDVisualVoicemailServiceAccountStateUpdated *)&v7 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100027A64((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (has)
  {
    *((void *)result + 1) = self->_serviceState;
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 1) == 0 || self->_serviceState != *((void *)v4 + 1)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
LABEL_3:
  unint64_t v3 = 2654435761u * self->_serviceState;
  return v3 ^ v2;
}
