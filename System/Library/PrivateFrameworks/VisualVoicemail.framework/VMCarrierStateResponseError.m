...
+ (id)errorWithDomain:(id)a3 code:(int64_t)a4 userInfo:(id)a5
{
  ...
  v13.receiver = a1;
  v13.super_class = (Class)&OBJC_METACLASS___VMCarrierStateResponseError;
...
{
  v5.receiver = self;
  v5.super_class = (Class)VMCarrierStateResponseError;
  return [(VMCarrierStateResponseError *)&v5 initWithDomain:off_1000E0770 code:a3 userInfo:a4];
}
...
- (VMCarrierStateResponseError)initWithDomain:(id)a3 code:(int64_t)a4 userInfo:(id)a5
{
  ...
  id v9 = [(VMCarrierStateResponseError *)self initWithCode:a4 userInfo:v8];
