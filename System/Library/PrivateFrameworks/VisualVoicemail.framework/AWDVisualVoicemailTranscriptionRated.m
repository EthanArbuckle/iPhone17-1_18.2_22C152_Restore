...
{
  v7.receiver = self;
  v7.super_class = (Class)AWDVisualVoicemailTranscriptionRated;
  char v3 = [(AWDVisualVoicemailTranscriptionRated *)&v7 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100018BA4((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((unsigned char *)result + 16) = self->_accurate;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_accurate;
  return v3 ^ v2;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_accurate = *((unsigned char *)v4 + 16);
    *(unsigned char *)&self->_has |= 2u;
  }
}
