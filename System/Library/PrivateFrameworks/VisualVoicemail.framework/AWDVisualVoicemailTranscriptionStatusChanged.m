...
{
  v7.receiver = self;
  v7.super_class = (Class)AWDVisualVoicemailTranscriptionStatusChanged;
  char v3 = [(AWDVisualVoicemailTranscriptionStatusChanged *)&v7 description];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100007BAC((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  ...
  *((void *)result + 2) = self->_status;
  *((unsigned char *)result + 32) |= 2u;
  if ((*(unsigned char *)&self->_has & 1) == 0) {
    return result;
  }
LABEL_4:
  *((void *)result + 1) = self->_failureReason;
...
LABEL_16:
  ...
  {
    if ((*((unsigned char *)v4 + 32) & 2) == 0 || self->_status != *((void *)v4 + 2)) {
      goto LABEL_16;
    }
  }
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 32) & 1) == 0 || self->_failureReason != *((void *)v4 + 1)) {
      goto LABEL_16;
    }
    BOOL v5 = 1;
  }
...
LABEL_3:
  unint64_t v3 = 2654435761u * self->_status;
  if ((*(unsigned char *)&self->_has & 1) == 0) {
    goto LABEL_7;
  }
LABEL_4:
  unint64_t v4 = 2654435761u * self->_failureReason;
  return v3 ^ v2 ^ v4;
}
...
LABEL_3:
  ...
  self->_status = *((void *)v4 + 2);
  *(unsigned char *)&self->_has |= 2u;
  if (*((unsigned char *)v4 + 32))
  {
LABEL_4:
    self->_failureReason = *((void *)v4 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
LABEL_5:
}
