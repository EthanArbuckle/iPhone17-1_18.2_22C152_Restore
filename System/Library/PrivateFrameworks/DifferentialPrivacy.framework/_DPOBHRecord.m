...
- (_DPOBHRecord)initWithCoder:(id)a3
{
  ...
  id v11 = [(_DPOBHRecord *)self initWithKey:v5 creationDate:v10 submitted:0 objectId:v8];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = [NSNumber numberWithDouble:self->_creationDate];
...
- (id)description
{
  v3 = (void *)[&stru_1F3681BE0 mutableCopy];
  ...
  objc_msgSend(v3, "appendFormat:", @"creationDate=%.16g ; ", *(void *)&self->_creationDate);
  if (self->_submitted) {
    double v8 = @"YES";
  }
  else {
  ...
  objc_msgSend(v3, "appendFormat:", @"reportVersion=%lld ; ", self->_reportVersion);
  objectId = self->_objectId;
  if (!objectId) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  double v7 = v6;
  BOOL v8 = [(_DPOBHRecord *)self submitted];
  id v9 = [(_DPOBHRecord *)self objectId];
...
- (BOOL)isEqualToOBHRecord:(id)a3
{
  ...
  int64_t v13 = [(_DPOBHRecord *)self reportVersion];
  uint64_t v14 = [v4 reportVersion];
  v15 = [(_DPOBHRecord *)self objectId];

  if (v15)
  {
    objc_super v16 = [(_DPOBHRecord *)self objectId];
    v17 = [v4 objectId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (self == v4) {
    ...
    BOOL v6 = v4
      ...
      && [(_DPOBHRecord *)self isEqualToOBHRecord:v5];
...
- (unint64_t)hash
{
  ...
  uint64_t v7 = v4 ^ [(_DPOBHRecord *)self submitted];
  int64_t v8 = v7 ^ [(_DPOBHRecord *)self reportVersion];
  double v9 = [(_DPOBHRecord *)self objectId];
...
+ (id)createRecordFromManagedObject:(id)a3
{
  ...
  uint64_t v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v33 count:1];
  double v5 = [v3 entity];
...
- (BOOL)copyToManagedObject:(id)a3
{
  ...
  {
    id v6 = v4;
    uint64_t v7 = [(_DPOBHRecord *)self key];
    [v6 setKey:v7];
    ...
    id v8 = [(_DPOBHRecord *)self objectId];
