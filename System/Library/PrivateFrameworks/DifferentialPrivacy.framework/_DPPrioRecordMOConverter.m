@interface _DPPrioRecordMOConverter
...
@implementation _DPPrioRecordMOConverter

- (id)createRecordFromManagedObject:(id)a3
{
  return +[_DPPrioRecord createRecordFromManagedObject:a3];
}
...
- (id)insertRecord:(id)a3 inManagedObjectContext:(id)a4
{
  ...
  [(_DPPrioRecordMOConverter *)self copyRecord:v8 intoManagedObject:v10];
  return v10;
}
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        {
          v15 = -[_DPPrioRecordMOConverter insertRecord:inManagedObjectContext:](self, "insertRecord:inManagedObjectContext:", v14, v7, (void)v17);
          [v8 addObject:v15];
        }
      }
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          ...
          if (v15)
          {
            [(_DPPrioRecordMOConverter *)self copyRecord:v13 intoManagedObject:v15];
            [v7 addObject:v15];
          }
        }
      }
