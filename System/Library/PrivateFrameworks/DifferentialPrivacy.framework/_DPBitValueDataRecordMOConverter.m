...
- (id)createRecordFromManagedObject:(id)a3
{
  return +[_DPBitValueRecord createRecordFromManagedObject:a3];
}
...
- (id)insertRecord:(id)a3 inManagedObjectContext:(id)a4
{
  ...
  [(_DPBitValueDataRecordMOConverter *)self copyRecord:v8 intoManagedObject:v10];
  return v10;
}
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        {
          v15 = -[_DPBitValueDataRecordMOConverter insertRecord:inManagedObjectContext:](self, "insertRecord:inManagedObjectContext:", v14, v7, (void)v17);
          [v8 addObject:v15];
        }
      }
