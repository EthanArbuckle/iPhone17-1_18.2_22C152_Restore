...
- (id)createRecordFromManagedObject:(id)a3
{
  return +[_DPOBHRecord createRecordFromManagedObject:a3];
}
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        {
          v15 = -[_DPOBHRecordMOConverter insertRecord:inManagedObjectContext:](self, "insertRecord:inManagedObjectContext:", v14, v7, (void)v17);
          [v8 addObject:v15];
        }
      }
