...
- (BOOL)finalizeFileWithAccessTime:(timeval)a3 modTime:(timeval)a4 mode:(unsigned __int16)a5 error:(id *)a6
{
  ...
  if (os_signpost_enabled(v11))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    _os_signpost_emit_with_name_impl(&dword_1DD5BF000, v11, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "ASYNC_ENQUEUE", "Enqueueing async operation for %@ size %lld", buf, 0x16u);
  }
...
- (void)executeAsyncOperation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    char v14 = v3;
    _os_log_debug_impl(&dword_1DD5BF000, v5, OS_LOG_TYPE_DEBUG, "Writing %@ asynchronously", buf, 0xCu);
  }
  ...
  if (os_signpost_enabled(v6))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v15 = 2048;
    int64_t v16 = v4;
    _os_signpost_emit_with_name_impl(&dword_1DD5BF000, v6, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "ASYNC_WRITE", "Start async operation for %@ size %lld", buf, 0x16u);
  }

  id v12 = 0;
  BOOL v7 = [(AsyncStreamingFileWriter *)self _executeWithError:&v12];
  id v8 = v12;
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412546;
      ...
      _os_log_error_impl(&dword_1DD5BF000, v9, OS_LOG_TYPE_ERROR, "Async operation for %@ failed: %@", buf, 0x16u);
    }
  ...
  if (os_signpost_enabled(v11))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v15 = 2048;
    int64_t v16 = v4;
    _os_signpost_emit_with_name_impl(&dword_1DD5BF000, v11, OS_SIGNPOST_INTERVAL_END, 0xEEEEB0B5B2B2EEEELL, "ASYNC_WRITE", "End async operation for %@ size %lld", buf, 0x16u);
  }
}

- (BOOL)_executeWithError:(id *)a3
{
  char v5 = [(AsyncStreamingFileWriter *)self executeFileOperationFlags];
  if (v5)
  {
...
LABEL_16:
    if ((v5 & 8) == 0
      || (uint64_t v11 = [(AsyncStreamingFileWriter *)self accessTime],
          uint64_t v13 = v12,
          uint64_t v14 = [(AsyncStreamingFileWriter *)self modTime],
          v19.receiver = self,
          v19.super_class = (Class)AsyncStreamingFileWriter,
          BOOL v16 = -[StreamingFileWriter finalizeFileWithAccessTime:modTime:mode:error:](&v19, sel_finalizeFileWithAccessTime_modTime_mode_error_, v11, v13, v14, v15, [(AsyncStreamingFileWriter *)self mode], a3)))
    {
      if ((v5 & 0x10) != 0)
      {
        v18.receiver = self;
...
- (void)setIncompleteExtractionAttribute
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_FAULT))
  {
    ...
    int v5 = 138412290;
    uint64_t v6 = v4;
    _os_log_fault_impl(&dword_1DD5BF000, v3, OS_LOG_TYPE_FAULT, "Setting incomplete extraction attribute not available on this async file operation for %@", (uint8_t *)&v5, 0xCu);
  }
}
...
- (BOOL)setCurrentOffset:(int64_t)a3 error:(id *)a4
{
  ...
  {
    uint64_t v11 = [(StreamingFileWriter *)self path];
    *(_DWORD *)buf = 138412290;
    uint64_t v13 = v11;
    _os_log_error_impl(&dword_1DD5BF000, v6, OS_LOG_TYPE_ERROR, "Setting current output offset not available on async file operation for %@", buf, 0xCu);
  }
  uint64_t v7 = [(StreamingFileWriter *)self path];
  uint64_t v9 = _CreateError((uint64_t)"-[AsyncStreamingFileWriter setCurrentOffset:error:]", 415, @"SZExtractorErrorDomain", 1, 0, 0, @"Setting current output offset not available on async file operation for %@", v8, (uint64_t)v7);
...
- (int64_t)currentOffsetWithError:(id *)a3
{
  ...
  if ([(StreamingFileWriter *)self currentOutputFD] < 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412290;
      uint64_t v13 = v10;
      _os_log_error_impl(&dword_1DD5BF000, v6, OS_LOG_TYPE_ERROR, "Getting current output offset not available on async file operation for %@", buf, 0xCu);
    }
    uint64_t v7 = [(StreamingFileWriter *)self path];
    uint64_t v9 = _CreateError((uint64_t)"-[AsyncStreamingFileWriter currentOffsetWithError:]", 406, @"SZExtractorErrorDomain", 1, 0, 0, @"Getting current output offset not available on async file operation for %@", v8, (uint64_t)v7);
...
- (int64_t)readIntoBuffer:(void *)a3 length:(unint64_t)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138412290;
    uint64_t v14 = v12;
    _os_log_error_impl(&dword_1DD5BF000, v7, OS_LOG_TYPE_ERROR, "Read not available on async file operation for %@", buf, 0xCu);
  }
  uint64_t v8 = [(StreamingFileWriter *)self path];
  v10 = _CreateError((uint64_t)"-[AsyncStreamingFileWriter readIntoBuffer:length:error:]", 391, @"SZExtractorErrorDomain", 1, 0, 0, @"Read not available on async file operation for %@", v9, (uint64_t)v8);
...
- (id)_initForWritingToPath:(id)a3 withOpenFlags:(int)a4 mode:(unsigned __int16)a5 quarantineInfo:(void *)a6 performCachedWrites:(BOOL)a7 expectedSize:(int64_t)a8 asyncTrackingGroup:(id)a9 errorDelegate:(id)a10 reservation:(id)a11 error:(id *)a12
{
  ...
  if (v21)
  {
    ...
    *((unsigned char *)v22 + 32) = v13;
    ...
    v22[10] = (id)17;
    uint64_t v23 = [MEMORY[0x1E4F1CA58] dataWithCapacity:v20];
    id v24 = v22[9];
    v22[9] = (id)v23;
  }
  return v22;
