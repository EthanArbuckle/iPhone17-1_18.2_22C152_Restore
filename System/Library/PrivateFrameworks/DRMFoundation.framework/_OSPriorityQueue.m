...
- (id)description
{
  ...
  v9 = [v4 stringWithFormat:@"<_OSPriority Queue: Count=%@, High=%@, Low=%@, Items=%@>", v5, highestPriority, lowestPriority, v8];
