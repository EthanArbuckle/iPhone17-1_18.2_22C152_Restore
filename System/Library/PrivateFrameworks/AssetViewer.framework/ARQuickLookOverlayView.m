...
- (id)hitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  id v7 = v13.receiver;
  id v8 = a4;
  id v9 = -[ARQuickLookOverlayView hitTest:withEvent:](&v13, sel_hitTest_withEvent_, v8, x, y);
  if (!v9)
  {
...
- (_TtC11AssetViewer22ARQuickLookOverlayView)initWithCoder:(id)a3
{
  ...
  return [(ARQuickLookOverlayView *)&v5 initWithCoder:a3];
}
