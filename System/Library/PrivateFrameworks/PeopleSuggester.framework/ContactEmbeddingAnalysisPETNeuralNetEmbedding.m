...
- (float)embeddingsAtIndex:(unint64_t)a3
{
  ...
  unint64_t count = self->_embeddings.count;
  if (count <= a3)
  {
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v7 clearEmbeddings];
    unint64_t v4 = [(ContactEmbeddingAnalysisPETNeuralNetEmbedding *)self embeddingsCount];
    if (v4)
    {
      unint64_t v5 = v4;
...
- (unint64_t)hash
{
  return MEMORY[0x1F4147340](&self->_embeddings, a2);
}

- (void)mergeFrom:(id)a3
{
  id v7 = a3;
  uint64_t v4 = [v7 embeddingsCount];
  if (v4)
  {
    uint64_t v5 = v4;
    for (uint64_t i = 0; i != v5; ++i)
