...
- (_PSFeatureDictionary)_ps_dictionaryByAddingEntryForObject:(void *)a3 withKey:
{
  ...
  if (a1)
  {
    id v7 = [(_PSFeatureDictionary *)a1 objectForKeyedSubscript:v6];

    if (v7 == v5)
    {
      v9 = (_PSFeatureDictionary *)[(_PSFeatureDictionary *)a1 copy];
    }
    else
    {
      if ([(_PSFeatureDictionary *)a1 count])
      {
        ...
        if (objc_opt_isKindOfClass()) {
          v8 = (_PSFeatureDictionary *)[(_PSFeatureDictionary *)a1 mutableCopy];
        }
        else {
