...
LABEL_3:
  ...
  objc_super v8 = [NSNumber numberWithBool:self->_wasImputed];
  [v3 setObject:v8 forKey:@"wasImputed"];

  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
LABEL_4:
    v5 = [NSNumber numberWithBool:self->_defaultValue];
...
LABEL_3:
  ...
  *((unsigned char *)v4 + 17) = self->_wasImputed;
  *((unsigned char *)v4 + 20) |= 4u;
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
LABEL_4:
    *((unsigned char *)v4 + 16) = self->_defaultValue;
...
LABEL_3:
  ...
  *((unsigned char *)result + 17) = self->_wasImputed;
  *((unsigned char *)result + 20) |= 4u;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
    return result;
  }
LABEL_4:
  *((unsigned char *)result + 16) = self->_defaultValue;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 20) & 1) == 0 || self->_value != *((double *)v4 + 1)) {
      goto LABEL_17;
    }
  }
...
- (unint64_t)hash
{
  ...
  if ((has & 4) != 0)
  {
    uint64_t v9 = 2654435761 * self->_wasImputed;
    if ((has & 2) != 0) {
      goto LABEL_11;
    }
LABEL_13:
...
LABEL_11:
  uint64_t v10 = 2654435761 * self->_defaultValue;
  return v9 ^ v4 ^ v10;
}
...
LABEL_3:
  ...
  self->_wasImputed = *((unsigned char *)v4 + 17);
  *(unsigned char *)&self->_has |= 4u;
  if ((*((unsigned char *)v4 + 20) & 2) != 0)
  {
LABEL_4:
    self->_defaultValue = *((unsigned char *)v4 + 16);
    *(unsigned char *)&self->_has |= 2u;
  }
LABEL_5:
}
