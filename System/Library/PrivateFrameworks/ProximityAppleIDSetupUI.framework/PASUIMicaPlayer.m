...
LABEL_6:
  ...
  v10 = v9;
  objc_msgSend(v9, "setGeometryFlipped:", +[PASUIMicaPlayer BOOLFromDictionary:key:defaultValue:](PASUIMicaPlayer, "BOOLFromDictionary:key:defaultValue:", v8, @"geometryFlipped", 0) ^ 1);
...
- (PASUIMicaPlayer)initWithPath:(id)a3 retinaScale:(double)a4 rootLayer:(id)a5 publishedObjects:(id)a6
{
  ...
  id v12 = a6;
  v17.receiver = self;
  v17.super_class = (Class)PASUIMicaPlayer;
  ...
  if (v13)
  {
    ...
    [v11 duration];
    -[PASUIMicaPlayer setDocumentDuration:](v14, "setDocumentDuration:");
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)PASUIMicaPlayer;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v9 = [(PASUIMicaPlayer *)self publishedObjects];
  uint64_t v10 = [(PASUIMicaPlayer *)self rootLayer];
  uint64_t v11 = +[PASUIMicaPlayer updatePublishedObjects:v9 toReferenceLayersInTree:v8 ratherThanLayersInTree:v10];
...
- (id)publishedLayerWithKey:(id)a3 required:(BOOL)a4
{
  v4 = [(PASUIMicaPlayer *)self publishedObjectWithKey:a3 required:a4];
  if (v4)
  {
    objc_opt_class();
...
- (void)setPlaybackTime:(double)a3
{
  BOOL v5 = [(PASUIMicaPlayer *)self isPlaying];
  double v6 = 0.0;
  if (v5)
  {
...
- (void)notifyDelegateDidStartPlaying
{
  ...
  if (WeakRetained)
  {
    ...
    if (v7)
    {
      ...
      [v8 PASUIMicaPlayerDidStartPlaying:self];
    }
  }
}
...
- (void)notifyDelegateDidStopPlaying
{
  ...
  if (WeakRetained)
  {
    ...
    {
      id v8 = objc_loadWeakRetained((id *)p_delegate);
      [v8 PASUIMicaPlayerDidStopPlaying:self];
    }
  }
}
...
- (BOOL)isTimerNeeded
{
  if ([(PASUIMicaPlayer *)self isPlaying])
  {
    ...
    if (v3 == INFINITY)
    {
      id v5 = [(PASUIMicaPlayer *)self delegate];
      if (v5)
      {
        char v6 = [(PASUIMicaPlayer *)self delegate];
...
{
  id WeakRetained = objc_loadWeakRetained((id *)&self->_delegate);
  return (PASUIMicaPlayerDelegate *)WeakRetained;
}
