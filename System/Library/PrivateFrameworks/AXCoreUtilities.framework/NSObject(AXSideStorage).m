...
LABEL_8:
        ...
        case 2:
          ...
          if ((objc_opt_isKindOfClass() & 1) == 0) {
            _AXAssert(0, (uint64_t)"/Library/Caches/com.apple.xbs/Sources/AccessibilityLibraries/Source/AXCoreUtilities/source/Swizzling/AXSideStorage_Implementation.m", (void *)0x6F, (uint64_t)"-[NSObject(AXSideStorage) _accessibilitySetValue:forKey:storageMode:]", @"value is not a wrapper class: %@", v14, v15, v16, (uint64_t)v11);
          }
          goto LABEL_8;
      }
    }
...
LABEL_16:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR)) {
    -[NSObject(AXSideStorage) _accessibilitySetValue:forKey:storageMode:]((uint64_t)v8, (uint64_t)a1, v17);
  }
...
- (id)_accessibilityValueForKey:()AXSideStorage
{
  ...
  if (v4)
  {
    ...
    id v6 = (id)v14[5];
    objc_sync_enter(v6);
    id v7 = [(id)v14[5] objectForKey:v4];
    objc_sync_exit(v6);
  ...
  {
    id v9 = AXLogValidations();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR)) {
      -[NSObject(AXSideStorage) _accessibilityValueForKey:]((uint64_t)a1, v9);
    }
...
- (id)_axDictionaryQueue
{
  if (_axDictionaryQueue_onceToken_0 != -1) {
    dispatch_once(&_axDictionaryQueue_onceToken_0, &__block_literal_global_17);
  }
  v0 = (void *)_axDictionaryQueue__sDictionaryQueue_0;
  return v0;
}
