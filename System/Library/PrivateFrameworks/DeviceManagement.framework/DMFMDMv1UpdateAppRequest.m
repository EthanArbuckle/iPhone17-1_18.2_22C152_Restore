...
- (DMFMDMv1UpdateAppRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v53 = objc_msgSend(v59, "setWithObjects:", v58, v57, v45, v46, v47, v48, v49, v50, v51, v52, objc_opt_class(), 0);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = [(DMFMDMv1UpdateAppRequest *)self originator];
  [v4 encodeObject:v5 forKey:@"originator"];

  v6 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithUnsignedInteger:", -[DMFMDMv1UpdateAppRequest managementOptions](self, "managementOptions"));
  [v4 encodeObject:v6 forKey:@"managementOptions"];

  uint64_t v7 = [(DMFMDMv1UpdateAppRequest *)self VPNUUIDString];
  ...
  uint64_t v11 = [(DMFMDMv1UpdateAppRequest *)self relayUUIDString];
  ...
  uint64_t v14 = [(DMFMDMv1UpdateAppRequest *)self removable];
  ...
  uint64_t v17 = [(DMFMDMv1UpdateAppRequest *)self allowUserToLock];
