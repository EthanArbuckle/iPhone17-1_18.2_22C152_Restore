...
- (DMFSetBluetoothEnabledRequest)initWithCoder:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)DMFSetBluetoothEnabledRequest;
...
{
  v6.receiver = self;
  v6.super_class = (Class)DMFSetBluetoothEnabledRequest;
  id v4 = a3;
  [(CATTaskRequest *)&v6 encodeWithCoder:v4];
  v5 = objc_msgSend(NSNumber, "numberWithBool:", -[DMFSetBluetoothEnabledRequest enabled](self, "enabled", v6.receiver, v6.super_class));
