...
- (DMFAssignUserRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v39 = [v4 decodeObjectOfClasses:v38 forKey:@"enrolledGroupIdentifiers"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v10 = [(DMFAssignUserRequest *)self imageURL];
  ...
  uint64_t v13 = [(DMFAssignUserRequest *)self passcodeType];
