...
- (DMFCategoryPolicyMonitor)initWithPolicyChangeHandler:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)DMFCategoryPolicyMonitor;
  v5 = [(DMFCategoryPolicyMonitor *)&v16 init];
  if (v5)
  {
    ...
    if (v4)
    {
      ...
      v10 = [(DMFPolicyRegistration *)v8 initWithIdentifier:@"dmf.policy.monitor.category" policyTypes:v9 callback:v4];
...
+ (NSSet)policyTypes
{
  if (policyTypes_onceToken_0 != -1) {
    dispatch_once(&policyTypes_onceToken_0, &__block_literal_global_1);
  }
  v2 = (void *)policyTypes_types_0;
  return (NSSet *)v2;
}
...
void __56__DMFCategoryPolicyMonitor_initWithPolicyChangeHandler___block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v11 = 2114;
  uint64_t v12 = a2;
  _os_log_error_impl(&dword_1BE0E2000, a3, OS_LOG_TYPE_ERROR, "Failed to register category policy monitor with identifier %{public}@ for types %{public}@ with error: %{public}@", (uint8_t *)&v7, 0x20u);
}
