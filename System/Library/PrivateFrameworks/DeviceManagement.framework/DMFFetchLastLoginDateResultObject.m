...
- (DMFFetchLastLoginDateResultObject)initWithDatesByAppleID:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)DMFFetchLastLoginDateResultObject;
...
- (DMFFetchLastLoginDateResultObject)initWithCoder:(id)a3
{
  id v4 = a3;
  v21.receiver = self;
  v21.super_class = (Class)DMFFetchLastLoginDateResultObject;
...
{
  v6.receiver = self;
  v6.super_class = (Class)DMFFetchLastLoginDateResultObject;
  id v4 = a3;
  [(CATTaskResultObject *)&v6 encodeWithCoder:v4];
  v5 = [(DMFFetchLastLoginDateResultObject *)self lastLoginDatesByAppleID];
