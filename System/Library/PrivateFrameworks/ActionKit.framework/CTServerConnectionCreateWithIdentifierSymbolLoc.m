...
void *__get_CTServerConnectionCreateWithIdentifierSymbolLoc_block_invoke_48743(uint64_t a1)
{
  v2 = CoreTelephonyLibrary_48700();
  result = dlsym(v2, "_CTServerConnectionCreateWithIdentifier");
  *(void *)(*(void *)(*(void *)(a1 + 32) + 8) + 24) = result;
  get_CTServerConnectionCreateWithIdentifierSymbolLoc_ptr_48742 = *(_UNKNOWN **)(*(void *)(*(void *)(a1 + 32) + 8)
                                                                               + 24);
  return result;
}
