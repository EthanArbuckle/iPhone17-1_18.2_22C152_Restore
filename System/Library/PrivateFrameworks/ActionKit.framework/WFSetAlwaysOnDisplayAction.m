...
- (void)finishRunningWithError:(id)a3
{
  id v4 = a3;
  if (v4
    || ([(WFSetAlwaysOnDisplayAction *)self runningDelegate],
  ...
  {
    v8.receiver = self;
    v8.super_class = (Class)WFSetAlwaysOnDisplayAction;
  ...
  else
  {
    ...
    v7[1] = 3221225472;
    v7[2] = __53__WFSetAlwaysOnDisplayAction_finishRunningWithError___block_invoke;
    v7[3] = &unk_264E58490;
    v7[4] = self;
    +[WFAlwaysOnDisplaySettingsClient getBookmarkForCurrentStateWithCompletionHandler:v7];
  }
}
...
void __53__WFSetAlwaysOnDisplayAction_finishRunningWithError___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5)
  {
    ...
    objc_msgSendSuper2(&v9, sel_finishRunningWithError_, 0, *(void *)(a1 + 32), WFSetAlwaysOnDisplayAction, v10.receiver, v10.super_class);
  }
  else
  {
    objc_msgSendSuper2(&v10, sel_finishRunningWithError_, a3, v9.receiver, v9.super_class, *(void *)(a1 + 32), WFSetAlwaysOnDisplayAction);
  }
}
