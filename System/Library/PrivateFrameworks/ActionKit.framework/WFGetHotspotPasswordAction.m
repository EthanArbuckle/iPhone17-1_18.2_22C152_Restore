@interface WFGetHotspotPasswordAction
...
- (void)runWithInput:(WFContentCollection *)a3 completionHandler:(id)a4
{
  ...
  v8 = a3;
  v9 = self;
  sub_23C413EEC((uint64_t)&unk_268BA7558, (uint64_t)v7);
}
...
- (WFGetHotspotPasswordAction)initWithIdentifier:(id)a3 definition:(id)a4 serializedParameters:(id)a5
{
  ...
  id v10 = a4;
  return (WFGetHotspotPasswordAction *)sub_23C3F2834(v7, v9, a4, (uint64_t)a5);
}

- (WFGetHotspotPasswordAction)init
{
  return (WFGetHotspotPasswordAction *)sub_23C3F2B00();
}
