@interface WFSetAppearanceAction
...
- (void)finishRunningWithError:(id)a3
{
  id v4 = a3;
  if (v4
    || ([(WFSetAppearanceAction *)self runningDelegate],
  ...
  else
  {
    ...
    v7[3] = &unk_264E58490;
    v7[4] = self;
    +[WFAppearanceSettingsClient getBookmarkForCurrentStateWithCompletionHandler:v7];
  }
}
...
void __48__WFSetAppearanceAction_finishRunningWithError___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5)
  {
    ...
    objc_msgSendSuper2(&v9, sel_finishRunningWithError_, 0, *(void *)(a1 + 32), WFSetAppearanceAction, v10.receiver, v10.super_class);
  }
  else
  {
    objc_msgSendSuper2(&v10, sel_finishRunningWithError_, a3, v9.receiver, v9.super_class, *(void *)(a1 + 32), WFSetAppearanceAction);
  }
}
...
- (void)resolveSlot:(id)a3 withProcessedValue:(id)a4 parameter:(id)a5 input:(id)a6 completion:(id)a7
{
  ...
  if (![v17 isEqualToString:@"style"]) {
    goto LABEL_6;
  }
  v18 = [(WFSetAppearanceAction *)self runningDelegate];
  char v19 = objc_opt_respondsToSelector();

  if ((v19 & 1) == 0) {
    goto LABEL_6;
  }
  v20 = [(WFSetAppearanceAction *)self runningDelegate];
  ...
  if (v21)
  {
    ...
    if (v22)
    {
      +[WFAppearanceSettingsClient getReversalStateWithBookmark:v22 completionHandler:v16];
    }
    else
    {
