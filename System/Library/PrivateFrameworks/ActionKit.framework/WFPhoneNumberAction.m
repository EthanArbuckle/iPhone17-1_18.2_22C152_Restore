...
- (void)runAsynchronouslyWithInput:(id)a3
{
  v4 = [(WFPhoneNumberAction *)self parameterValueForKey:@"WFPhoneNumber" ofClass:objc_opt_class()];
  ...
  {
    [(WFPhoneNumberAction *)self finishRunningWithError:0];
  }
}
