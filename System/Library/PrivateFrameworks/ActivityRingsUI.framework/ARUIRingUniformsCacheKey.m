...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v5 = v4;
    unint64_t v6 = [(ARUIRingUniformsCacheKey *)self hashValue];
...
+ (id)keyForRing:(id)a3 context:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  uint64_t v7 = [[ARUIRingUniformsCacheKey alloc] initWithRing:v6 context:v5];
...
- (ARUIRingUniformsCacheKey)initWithRing:(id)a3 context:(id)a4
{
  ...
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)ARUIRingUniformsCacheKey;
  BOOL v8 = [(ARUIRingUniformsCacheKey *)&v11 init];
  if (v8)
  {
