...
- (id)description
{
  ...
  objc_msgSend(v3, "appendFormat:", @"LinkTests in last Hour: %lu\n", -[NSArray count](self->_lastHrLinkTests, "count"));
    ...
    if (v4)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v5; ++i)
        {
          ...
          objc_super v9 = [v8 objectForKeyedSubscript:@"initiatingReason"];
...
- (BOOL)isEqualToLinkTests:(id)a3
{
  ...
  id v4 = a3;
  NSUInteger v5 = [(NSArray *)self->_lastHrLinkTests count];
  uint64_t v6 = [v4 lastHrLinkTests];
  ...
  if (v5 == v7)
  {
    ...
    long long v27 = 0u;
    long long v28 = 0u;
    obuint64_t j = [v4 lastHrLinkTests];
    ...
    if (v8)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v9; ++i)
        {
          ...
          long long v25 = 0u;
          long long v26 = 0u;
          long long v13 = self->_lastHrLinkTests;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v4 == self) {
    ...
    BOOL v6 = v4
      ...
      && [(W5SummaryLinkTests *)self isEqualToLinkTests:v5];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_lastHrLinkTests hash];
}

- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = [+[W5SummaryLinkTests allocWithZone:a3] init];
...
- (W5SummaryLinkTests)initWithCoder:(id)a3
{
  ...
  NSUInteger v5 = [(W5SummaryLinkTests *)&v16 init];
  if (v5)
  {
    ...
    uint64_t v12 = [v4 decodeObjectOfClasses:v11 forKey:@"_lastHrLinkTests"];
