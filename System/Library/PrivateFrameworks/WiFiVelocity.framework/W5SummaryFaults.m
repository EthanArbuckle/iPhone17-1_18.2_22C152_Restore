...
- (BOOL)isEqual:(id)a3;
- (BOOL)isEqualToFaults:(id)a3;
- (NSArray)lastHrFaults;
- (W5SummaryFaults)initWithCoder:(id)a3;
- (W5SummaryFaults)initWithSummaryFaults:(id)a3;
...
- (W5SummaryFaults)initWithSummaryFaults:(id)a3
{
  ...
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)W5SummaryFaults;
  v5 = [(W5SummaryFaults *)&v9 init];
  if (v5)
  {
    v6 = (NSArray *)v4;
  ...
  else
  {
    ...
    {
      int v10 = 136315906;
      v11 = "-[W5SummaryFaults initWithSummaryFaults:]";
      __int16 v12 = 2080;
      v13 = "W5SummaryFaults.m";
      __int16 v14 = 1024;
      int v15 = 31;
      __int16 v16 = 2080;
      v17 = "-[W5SummaryFaults initWithSummaryFaults:]";
...
- (id)description
{
  ...
  objc_msgSend(v3, "appendFormat:", @"Faults in last Hour: %lu\n", -[NSArray count](self->_lastHrFaults, "count"));
    ...
    if (v4)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v5; ++i)
        {
          ...
          objc_super v9 = [v8 objectForKeyedSubscript:@"type"];
          [v3 appendFormat:@"Fault: %@\n", v9];

          int v10 = [v8 objectForKeyedSubscript:@"date"];
...
- (BOOL)isEqualToFaults:(id)a3
{
  ...
  id v4 = a3;
  NSUInteger v5 = [(NSArray *)self->_lastHrFaults count];
  uint64_t v6 = [v4 lastHrFaults];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v4 == self) {
    ...
    BOOL v6 = v4
      ...
      && [(W5SummaryFaults *)self isEqualToFaults:v5];
...
- (unint64_t)hash
{
  return [(NSArray *)self->_lastHrFaults hash];
}

- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = [+[W5SummaryFaults allocWithZone:a3] init];
...
- (W5SummaryFaults)initWithCoder:(id)a3
{
  id v4 = a3;
  v16.receiver = self;
  v16.super_class = (Class)W5SummaryFaults;
  NSUInteger v5 = [(W5SummaryFaults *)&v16 init];
  if (v5)
  {
    ...
    uint64_t v12 = [v4 decodeObjectOfClasses:v11 forKey:@"_lastHrFaults"];
    uint64_t v13 = [v12 copy];
    lastHrFaults = v5->_lastHrFaults;
    v5->_lastHrFaults = (NSArray *)v13;
  }
  return v5;
}
