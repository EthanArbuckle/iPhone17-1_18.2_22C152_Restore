...
- (SCKOperationThrottler)initWithDelegate:(id)a3 updateQueue:(id)a4
{
  ...
  id v7 = a4;
  v30.receiver = self;
  v30.super_class = (Class)SCKOperationThrottler;
  dispatch_queue_t v8 = [(SCKOperationThrottler *)&v30 init];
  v9 = v8;
  if (v8)
  {
    if (v6)
    {
      ...
      dispatch_source_t v11 = dispatch_source_create(MEMORY[0x263EF83B8], 0, 0, v7);
      ...
      handler[2] = __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke;
      handler[3] = &unk_26467DC10;
      v14 = v10;
      v22 = v14;
      ...
      v18[1] = 3221225472;
      v18[2] = __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_5;
      v18[3] = &unk_26467DA60;
      v19 = v15;
      v20 = v14;
      v16 = v14;
...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    v4[1] = 3221225472;
    v4[2] = __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_2;
    v4[3] = &unk_26467DBE8;
    objc_copyWeak(&v6, (id *)(a1 + 56));
    objc_copyWeak(&v7, (id *)(a1 + 64));
    id v5 = *(id *)(a1 + 40);
    id v3 = objc_loadWeakRetained((id *)(a1 + 48));
    __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_2((id *)v4, v3);
...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_2(id *a1, void *a2)
{
  id v3 = a2;
  ...
  if (WeakRetained)
  {
    ...
    v6[1] = 3221225472;
    v6[2] = __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_3;
    v6[3] = &unk_26467DBC0;
    id v7 = v3;
    objc_copyWeak(&v9, a1 + 6);
    id v8 = a1[4];
    id v5 = objc_loadWeakRetained(a1 + 5);
    __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_3((uint64_t)v6, v5);

    objc_destroyWeak(&v9);
  }
}

void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_3(uint64_t a1, void *a2)
{
  id v3 = a2;
  ...
  else if (objc_opt_respondsToSelector())
  {
    ...
    v7[1] = 3221225472;
    v7[2] = __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_4;
    v7[3] = &unk_26467DA60;
    id v8 = WeakRetained;
    id v5 = *(void **)(a1 + 32);
    id v9 = *(id *)(a1 + 40);
...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_4(uint64_t a1)
{
...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_5(uint64_t a1)
{
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
  block[2] = __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_6;
...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_6(uint64_t a1)
{
}
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)SCKOperationThrottler;
