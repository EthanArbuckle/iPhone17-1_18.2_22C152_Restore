...
- (void)handleAuthenticateRequest:(id)a3 withReply:(id)a4
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_21E616000, v7, OS_LOG_TYPE_DEFAULT, "[UIHostServiceProxy]: use out-of-process authenticate", buf, 2u);
  }
...
- (void)handleDialogRequest:(id)a3 withReply:(id)a4
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_21E616000, v7, OS_LOG_TYPE_DEFAULT, "[UIHostServiceProxy]: use out-of-process dialog", buf, 2u);
  }
...
- (void)handleEngagementRequest:(id)a3 withReply:(id)a4
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_21E616000, v5, OS_LOG_TYPE_DEFAULT, "[UIHostServiceProxy]: Engagement request not supported for non-UI", buf, 2u);
  }
