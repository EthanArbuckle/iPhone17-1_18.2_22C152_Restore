...
- (PCSUserRegistry)initWithBackup:(id)a3
{
  ...
  if (v6)
  {
    ...
    v9 = +[CKContainer containerIDForContainerIdentifier:off_100040D48];
...
- (id)defaultCKConfiguration
{
  if (qword_100040E18 != -1) {
    dispatch_once(&qword_100040E18, &stru_100038B58);
  }
  v2 = (void *)qword_100040E10;
  return v2;
}
...
- (void)registerCloudKitNotifications
{
  ...
  block[3] = &unk_100038BD0;
  block[4] = self;
  objc_copyWeak(&v5, &location);
  if (qword_100040E28 != -1) {
    dispatch_once(&qword_100040E28, block);
  }
...
- (id)syncUserRegistry
{
  ...
  if (v3)
  {
    ...
    *((void *)&v16 + 1) = &v16;
    ...
    id v18 = sub_100005330;
    os_log_t v19 = sub_100005340;
    id v20 = 0;
    unsigned __int8 v5 = [(PCSUserRegistry *)self queue];
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100007548;
    block[3] = &unk_100038B18;
    block[4] = self;
    void block[5] = &v16;
    dispatch_sync(v5, block);
...
- (id)createPendingSyncOperation:(id)a3
{
  ...
  id v28 = sub_100005330;
  unsigned __int8 v29 = sub_100005340;
  id v30 = 0;
  if (!v4)
  {
...
- (void)saveRecord:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      id v10 = &stru_100039C58;
    }
    id v12 = [(PCSUserRegistry *)self queue];
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100009238;
    block[3] = &unk_100038DD8;
    block[4] = self;
    id v15 = v4;
    id v16 = v7;
    uint64_t v17 = v10;
...
- (id)getServerChangeToken:(id)a3
{
  ...
  if (v5)
  {
    ...
    *((void *)&buf + 1) = &buf;
    ...
    id v24 = sub_100005330;
    uint64_t v25 = sub_100005340;
    id v26 = 0;
    id v7 = [(PCSUserRegistry *)self queue];
    id v14 = _NSConcreteStackBlock;
    uint64_t v15 = 3221225472;
    id v16 = sub_1000097CC;
    uint64_t v17 = &unk_100038E28;
    p_long long buf = &buf;
    id v18 = self;
    id v8 = v4;
    id v19 = v8;
    ...
    if (*(void *)(*((void *)&buf + 1) + 40))
    {
      ...
      id v10 = objc_msgSend(v9, "initForReadingFromData:error:", *(void *)(*((void *)&buf + 1) + 40), 0, v14, v15, v16, v17, v18);
...
- (void)cacheUserRegistryStats
{
  ...
  id v11 = sub_100005330;
  id v12 = sub_100005340;
  id v13 = 0;
...
LABEL_28:
    ...
    if ([v21 isEqualToString:CKErrorDomain])
    {
      ...
      if (v22 == (id)2)
      {
        ...
        long long v35 = 0u;
        long long v36 = 0u;
        uint64_t v25 = objc_msgSend(v24, "allValues", 0);
      ...
      if (v11)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            id v14 = objc_msgSend(*(id *)(*((void *)&v36 + 1) + 8 * (void)v13), "domain", v29);
...
- (id)createZone:(id)a3 withName:(id)a4
{
  ...
  double v23 = sub_10000A818;
  double v24 = &unk_100038E50;
...
- (id)queryEscrowName:(id)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v15 = sub_100005330;
    id v16 = sub_100005340;
    id v17 = 0;
    id v5 = [(PCSUserRegistry *)self queue];
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10000B188;
...
- (id)pushMobileBackupRecordsToCloudKit:(id)a3 removeObjects:(id)a4
{
  ...
  {
    id v21 = v20 - 100;
    uint64_t v22 = objc_msgSend(v19, "subarrayWithRange:", 100, v20 - 100);
...
- (id)keyRecordIdentity:(_PCSIdentityData *)a3 device:(id)a4 version:(id)a5
{
  ...
  id v8 = [a4 recordID];
  id v9 = [v8 recordName];
  id v10 = sub_10000BE44((uint64_t)a3, v9, v7);
...
- (id)mobileBackupKeyRecordIdentity:(_PCSIdentityData *)a3 version:(id)a4
{
  return sub_10000BE44((uint64_t)a3, @"MobileBackup", a4);
}
      ...
      for (i = 0; i != v7; i = (char *)i + 1)
      {
        ...
        if (!v12 || ([v12 longValue] & 1) == 0)
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            objc_msgSend(v16, "setFlags:", objc_msgSend(v13, "longValue"));
            [v22 addObject:v16];
...
- (id)loadMobileBackupKeysFromDB
{
  ...
  double v23 = sub_100005330;
  long long v24 = sub_100005340;
  id v25 = 0;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        id v9 = objc_msgSend((id)v21[5], "objectForKeyedSubscript:", *(void *)(*((void *)&v15 + 1) + 8 * i), (void)v15);
        id v10 = sub_10000B1F4(v9);
        [v3 addObject:v10];
      }
      id v6 = [v5 countByEnumeratingWithState:&v15 objects:v28 count:16];
    }
...
- (id)queryMobileBackupKeysFromCloudKit:(id *)a3
{
  ...
  long long v38 = sub_100005330;
  long long v39 = sub_100005340;
  id v40 = 0;
  dispatch_semaphore_t v5 = dispatch_semaphore_create(0);
  uint64_t v29 = 0;
  long long v30 = &v29;
  uint64_t v31 = 0x3032000000;
  id v32 = sub_100005330;
  id v33 = sub_100005340;
  id v34 = 0;
  id v6 = [(PCSUserRegistry *)self oslog];
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
  ...
  id v21 = _NSConcreteStackBlock;
  uint64_t v22 = 3221225472;
  id v23 = sub_10000D9D0;
  long long v24 = &unk_100038F90;
  id v25 = self;
  long long v27 = &v29;
  long long v28 = &v35;
  id v12 = v5;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; i = (char *)i + 1)
      {
        ...
        uint64_t v10 = objc_msgSend(*(id *)(*((void *)&v14 + 1) + 8 * i), "recordID", (void)v14);
...
- (id)userDBBackupRecordIDsWithError:(id *)a3
{
  if (-[PCSUserRegistry ensureUserRegistryDbLoaded:](self, "ensureUserRegistryDbLoaded:"))
  {
    ...
    *((void *)&buf + 1) = &buf;
    uint64_t v14 = 0x3032000000;
    long long v15 = sub_100005330;
    long long v16 = sub_100005340;
    id v17 = 0;
    id v5 = [(PCSUserRegistry *)self queue];
    v12[0] = _NSConcreteStackBlock;
    v12[1] = 3221225472;
