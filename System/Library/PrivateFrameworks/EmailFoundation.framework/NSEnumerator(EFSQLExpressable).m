...
@implementation NSEnumerator(EFSQLExpressable)
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_respondsToSelector() & 1) == 0)
        {
          ...
          [v20 handleFailureInFunction:v19, @"EFSQLExpressable.m", 104, @"Objects in the %@ must conform to protocol EFSQLValueExpressable", @"enumerator" file lineNumber description];
        }
        if (v16 != v15) {
          [v9 appendString:v10];
        }
    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_respondsToSelector() & 1) == 0)
        {
          ...
          [v16 handleFailureInFunction:v15, @"EFSQLExpressable.m", 104, @"Objects in the %@ must conform to protocol EFSQLValueExpressable", @"enumerator" file lineNumber description];
        }
        if (v12 != v11) {
          [v6 appendString:@", "];
        }
