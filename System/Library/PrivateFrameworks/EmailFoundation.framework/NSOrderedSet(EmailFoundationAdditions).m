...
- (id)ef_subarrayWithRange:()EmailFoundationAdditions
{
  ...
  if (a4 > 0xC80000)
  {
    ...
    v15 = [NSString stringWithUTF8String:"-[NSOrderedSet(EmailFoundationAdditions) ef_subarrayWithRange:]"];
    objc_msgSend(v14, "handleFailureInFunction:file:lineNumber:description:", v15, @"EFNSOrderedSetAdditions.m", 88, @"Temporary buffer too large or with a negative count (%zu).", a4);
  }
  if (a4 <= 1) {
    size_t v7 = 1;
  }
  ...
  v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v9 count:a4];
  free(v11);
  return v12;
}
...
- (id)ef_compactMap:()EmailFoundationAdditions
{
  ...
  if (!v5)
  {
    ...
    [v13 handleFailureInMethod:a2, a1, @"EFNSOrderedSetAdditions.m", 28, @"Invalid parameter not satisfying: %@", @"transform" object file lineNumber description];
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        v11 = v5[2](v5, *(void *)(*((void *)&v14 + 1) + 8 * i));
        if (v11) {
          [v6 addObject:v11];
        }
      }
...
- (id)ef_flatMap:()EmailFoundationAdditions
{
  ...
  if (!v5)
  {
    ...
    [v13 handleFailureInMethod:a2, a1, @"EFNSOrderedSetAdditions.m", 41, @"Invalid parameter not satisfying: %@", @"transform" object file lineNumber description];
  }
  v6 = [MEMORY[0x1E4F1CA70] orderedSet];
  long long v16 = 0u;
  long long v17 = 0u;
...
- (id)ef_filter:()EmailFoundationAdditions
{
  ...
  {
    long long v13 = [MEMORY[0x1E4F28B00] currentHandler];
    [v13 handleFailureInMethod:a2, a1, @"EFNSOrderedSetAdditions.m", 54, @"Invalid parameter not satisfying: %@", @"test" object file lineNumber description];
  }
  v6 = [MEMORY[0x1E4F1CA70] orderedSet];
  long long v16 = 0u;
  long long v17 = 0u;
...
- (id)ef_prefix:()EmailFoundationAdditions
{
  ...
  {
    uint64_t v5 = objc_msgSend(a1, "ef_subsetWithRange:", 0, a3);
  }
  return v5;
}
...
- (id)ef_suffix:()EmailFoundationAdditions
{
  ...
  {
    uint64_t v5 = objc_msgSend(a1, "ef_subsetWithRange:", objc_msgSend(a1, "count") - a3, a3);
  }
  return v5;
}
...
- (id)ef_subsetWithRange:()EmailFoundationAdditions
{
  ...
  if (a4 > 0xC80000)
  {
    ...
    long long v15 = [NSString stringWithUTF8String:"-[NSOrderedSet(EmailFoundationAdditions) ef_subsetWithRange:]"];
    objc_msgSend(v14, "handleFailureInFunction:file:lineNumber:description:", v15, @"EFNSOrderedSetAdditions.m", 82, @"Temporary buffer too large or with a negative count (%zu).", a4);
  }
  if (a4 <= 1) {
    size_t v7 = 1;
  }
  ...
  if (a4 > 0x100)
  {
    uint64_t v9 = (char *)malloc_type_calloc(v7, 8uLL, 0x80040B8603338uLL);
    uint64_t v11 = v9;
  }
  else
  {
  ...
  objc_msgSend(a1, "getObjects:range:", v9, a3, a4);
  long long v12 = (void *)[objc_alloc(MEMORY[0x1E4F1CAA0]) initWithObjects:v9 count:a4];
  free(v11);
  return v12;
}
...
- (id)ef_objectBeforeObject:()EmailFoundationAdditions
{
  ...
  {
    uint64_t v6 = [a1 objectAtIndex:v5 - 1];
  }
...
{
  id v4 = a3;
  unint64_t v5 = [a1 indexOfObject:v4];
