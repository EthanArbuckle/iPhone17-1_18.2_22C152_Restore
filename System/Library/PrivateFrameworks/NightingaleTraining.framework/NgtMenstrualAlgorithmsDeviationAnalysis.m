...
- (NgtMenstrualAlgorithmsDeviation)infrequentBleeding;
- (NgtMenstrualAlgorithmsDeviation)irregularBleeding;
- (NgtMenstrualAlgorithmsDeviation)prolongedBleeding;
- (NgtMenstrualAlgorithmsDeviation)spotting;
...
- (NgtMenstrualAlgorithmsDeviationAnalysis)initWithCoder:(id)a3
{
  id v4 = a3;
  v24.receiver = self;
  v24.super_class = (Class)NgtMenstrualAlgorithmsDeviationAnalysis;
  ...
  if (v5)
  {
    ...
    v5->_irregularBleeding = (NgtMenstrualAlgorithmsDeviation *)v8;
    ...
    v5->_infrequentBleeding = (NgtMenstrualAlgorithmsDeviation *)v12;
