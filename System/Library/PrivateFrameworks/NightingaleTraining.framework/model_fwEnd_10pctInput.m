@interface model_fwEnd_10pctInput
- (MLMultiArray)in_;
...
- (model_fwEnd_10pctInput)initWithIn:(id)a3
{
  return [(model_fwEnd_10pctInput *)self initWithIn:a3 lstm_1_h_in:0 lstm_1_c_in:0];
}
...
- (model_fwEnd_10pctInput)initWithIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5
{
  ...
  v12 = [(model_fwEnd_10pctInput *)&v15 init];
  v13 = v12;
  if (v12)
  {
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_27069BD68];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"in"])
  {
    ...
    v6 = [(model_fwEnd_10pctInput *)self in];
...
LABEL_11:
  ...
  {
    v6 = [(model_fwEnd_10pctInput *)self lstm_1_h_in];
    if (v6)
    {
      v8 = (void *)MEMORY[0x263F00D50];
      uint64_t v9 = [(model_fwEnd_10pctInput *)self lstm_1_h_in];
LABEL_9:
      id v10 = (void *)v9;
  ...
  {
    v6 = [(model_fwEnd_10pctInput *)self lstm_1_c_in];
    if (v6)
    {
      v8 = (void *)MEMORY[0x263F00D50];
      uint64_t v9 = [(model_fwEnd_10pctInput *)self lstm_1_c_in];
      goto LABEL_9;
    }
LABEL_10:
    v7 = 0;
