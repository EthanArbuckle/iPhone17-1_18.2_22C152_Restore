@interface NgtMenstrualAlgorithmsDeviationInput
...
- (NgtMenstrualAlgorithmsDeviationInput)initWithCoder:(id)a3;
...
@implementation NgtMenstrualAlgorithmsDeviationInput
...
{
  id v4 = a3;
  v5 = [(NgtMenstrualAlgorithmsDeviationInput *)self init];
  if (v5)
  {
