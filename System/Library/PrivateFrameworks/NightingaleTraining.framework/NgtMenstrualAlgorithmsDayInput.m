...
- (NgtMenstrualAlgorithmsHeartRateStatistics)sedentaryHeartRateStatistics;
- (NgtMenstrualAlgorithmsHeartRateStatistics)sleepHeartRateStatistics;
- (NgtMenstrualAlgorithmsWristTemperature)wristTemperature;
- (unsigned)flow;
- (unsigned)julianDay;
...
- (NgtMenstrualAlgorithmsDayInput)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_sedentaryHeartRateStatistics = (NgtMenstrualAlgorithmsHeartRateStatistics *)v12;
    ...
    v5->_sleepHeartRateStatistics = (NgtMenstrualAlgorithmsHeartRateStatistics *)v16;
    ...
    v5->_wristTemperature = (NgtMenstrualAlgorithmsWristTemperature *)v20;
