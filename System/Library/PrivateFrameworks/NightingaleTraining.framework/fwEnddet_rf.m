...
- (fwEnddet_rf)initWithMLModel:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)fwEnddet_rf;
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(fwEnddet_rf *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(fwEnddet_rf *)self model];
...
{
  id v6 = a3;
  id v7 = [[fwEnddet_rfInput alloc] initWithInput:v6];

  id v8 = [(fwEnddet_rf *)self predictionFromFeatures:v7 error:a4];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_257C1A000, MEMORY[0x263EF8438], OS_LOG_TYPE_ERROR, "Could not load fwEnddet_rf.mlmodelc in the bundle resource", v0, 2u);
}
