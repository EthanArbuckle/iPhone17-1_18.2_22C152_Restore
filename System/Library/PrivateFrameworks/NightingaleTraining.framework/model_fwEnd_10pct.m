...
- (model_fwEnd_10pct)initWithMLModel:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)model_fwEnd_10pct;
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(model_fwEnd_10pct *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(model_fwEnd_10pct *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(model_fwEnd_10pct *)self model];
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(model_fwEnd_10pct *)self model];
...
- (id)predictionFromIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5 error:(id *)a6
{
  ...
  id v14 = [(model_fwEnd_10pct *)self predictionFromFeatures:v13 error:a6];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_257C1A000, MEMORY[0x263EF8438], OS_LOG_TYPE_ERROR, "Could not load model_fwEnd_10pct.mlmodelc in the bundle resource", v0, 2u);
}
