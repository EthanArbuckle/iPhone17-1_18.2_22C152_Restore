...
- (NSSet)featureNames;
- (fwEnddet_lstmInput)initWithIn:(id)a3;
- (fwEnddet_lstmInput)initWithIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5;
...
- (fwEnddet_lstmInput)initWithIn:(id)a3
{
  return [(fwEnddet_lstmInput *)self initWithIn:a3 lstm_1_h_in:0 lstm_1_c_in:0];
}
...
- (fwEnddet_lstmInput)initWithIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5
{
  ...
  id v11 = a5;
  v15.receiver = self;
  v15.super_class = (Class)fwEnddet_lstmInput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_27069BCF0];
}
...
LABEL_11:
  ...
  {
    v6 = [(fwEnddet_lstmInput *)self lstm_1_h_in];
    if (v6)
    {
      v8 = (void *)MEMORY[0x263F00D50];
      uint64_t v9 = [(fwEnddet_lstmInput *)self lstm_1_h_in];
LABEL_9:
      id v10 = (void *)v9;
  ...
  {
    v6 = [(fwEnddet_lstmInput *)self lstm_1_c_in];
    if (v6)
    {
      v8 = (void *)MEMORY[0x263F00D50];
      uint64_t v9 = [(fwEnddet_lstmInput *)self lstm_1_c_in];
      goto LABEL_9;
    }
LABEL_10:
    v7 = 0;
