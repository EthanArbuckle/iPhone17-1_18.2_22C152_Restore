...
- (fwEnddet_lstm)initWithMLModel:(id)a3
{
  id v5 = a3;
  v10.receiver = self;
  v10.super_class = (Class)fwEnddet_lstm;
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(fwEnddet_lstm *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(fwEnddet_lstm *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(fwEnddet_lstm *)self model];
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(fwEnddet_lstm *)self model];
...
- (id)predictionFromIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5 error:(id *)a6
{
  ...
  id v14 = [(fwEnddet_lstm *)self predictionFromFeatures:v13 error:a6];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_257C1A000, MEMORY[0x263EF8438], OS_LOG_TYPE_ERROR, "Could not load fwEnddet_lstm.mlmodelc in the bundle resource", v0, 2u);
}
