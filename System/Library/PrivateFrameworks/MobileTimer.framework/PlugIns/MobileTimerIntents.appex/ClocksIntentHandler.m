...
- (void)provideCitiesOptionsForClocks:(id)a3 searchTerm:(id)a4 withCompletion:(id)a5
{
  ...
  if ([v7 length])
  {
    ...
    v12[3] = &unk_1000041F0;
    id v13 = v8;
    [(ClocksIntentHandler *)self getCitiesMatchingSearch:v7 completionHandler:v12];
  }
  else
  {
    id v9 = objc_alloc((Class)INObjectCollection);
    v10 = [(ClocksIntentHandler *)self allClocks];
...
- (id)allClocks
{
  ...
  v4 = [v3 allCities];
  v5 = [(ClocksIntentHandler *)self clocksFromCities:v4];
...
- (id)defaultCitiesForClocks:(id)a3
{
  ...
  id v5 = [v4 citiesMatchingIdentifiers:&off_1000043B0];
...
- (void)getCitiesMatchingSearch:(id)a3 completionHandler:(id)a4
{
  ...
  id v7 = [(ClocksIntentHandler *)self allClocks];
  if ([v11 length])
  {
...
- (id)userConfiguredClocks
{
  ...
  id v4 = [v3 cities];
  id v5 = [(ClocksIntentHandler *)self clocksFromCities:v4];
...
- (void)handleClocks:(id)a3 completion:(id)a4
{
  ...
  id v33 = [objc_alloc((Class)ClocksIntentResponse) initWithCode:4 userActivity:0];
  [v33 setClocks:v38];
  v34[2](v34, v33);
}
