...
{
  v82.receiver = self;
  v82.super_class = (Class)MTNotificationView;
  ...
  if (v2)
  {
    ...
    id v10 = [v9 countByEnumeratingWithState:&v78 objects:v84 count:16];
    if (v10)
    {
      id v11 = v10;
      ...
      do
      {
        ...
        id v11 = [v9 countByEnumeratingWithState:&v78 objects:v84 count:16];
      }
      while (v11);
    }

    v16 = +[UIFont systemFontOfSize:88.0 weight:UIFontWeightThin];
    v17 = objc_msgSend(v16, "mtui_fontByAddingTimeFontAttributes");
