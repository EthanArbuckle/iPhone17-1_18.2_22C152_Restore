...
- (id)description
{
  ...
  v4 = [(MTPBAlarm *)&v8 description];
  v5 = [(MTPBAlarm *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    v7 = v4;
    alarmProperties = (MTPBAlarmProperties *)-[MTPBAlarm setAlarmProperties:](self, "setAlarmProperties:");
  }
  v4 = v7;
LABEL_7:
