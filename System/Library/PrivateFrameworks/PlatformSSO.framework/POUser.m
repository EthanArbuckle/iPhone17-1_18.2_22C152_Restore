...
- (NSString)loginUserName
{
  ...
  v4[3] = &unk_264BBF138;
  v4[4] = self;
  v2 = __23__POUser_loginUserName__block_invoke((uint64_t)v4);
...
- (NSString)generatedUUID
{
  ...
  v4[3] = &unk_264BBF138;
  v4[4] = self;
  v2 = __23__POUser_generatedUUID__block_invoke((uint64_t)v4);
...
- (NSString)uniqueIdpIdentifier
{
  ...
  v4[3] = &unk_264BBF138;
  v4[4] = self;
  v2 = __29__POUser_uniqueIdpIdentifier__block_invoke((uint64_t)v4);
...
- (NSString)uid
{
  ...
  v4[3] = &unk_264BBF138;
  v4[4] = self;
  v2 = __13__POUser_uid__block_invoke((uint64_t)v4);
...
- (NSString)altSecurityIdentity
{
  ...
  v4[3] = &unk_264BBF138;
  v4[4] = self;
  v2 = __29__POUser_altSecurityIdentity__block_invoke((uint64_t)v4);
...
{
  id v4 = a3;
  id v6 = [(_POJWTBodyBase *)self dataRepresentation];
