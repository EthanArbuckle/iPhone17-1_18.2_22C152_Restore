...
- (void)setMetricsByDay:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, metricsByDay);
}
...
- (void)setLastDailyHeartbeat:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, lastDailyHeartbeat);
}
...
- (void)setMetricsByWeek:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, metricsByWeek);
}
...
- (void)setLastWeeklyHeartbeat:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, lastWeeklyHeartbeat);
}
...
- (void)setMetricsByMonth:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, metricsByMonth);
}
...
- (void)setLastMonthlyHeartbeat:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, lastMonthlyHeartbeat);
}
