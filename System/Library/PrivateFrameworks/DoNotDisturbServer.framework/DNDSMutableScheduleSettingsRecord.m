...
- (void)setLastUpdatedTimestamp:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, lastUpdatedTimestamp);
}
...
- (void)setScheduleEnabledSetting:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, scheduleEnabledSetting);
}
...
- (void)setTimePeriodStartTimeHour:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, timePeriodStartTimeHour);
}
...
- (void)setTimePeriodStartTimeMinute:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, timePeriodStartTimeMinute);
}
...
- (void)setTimePeriodEndTimeHour:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, timePeriodEndTimeHour);
}
...
- (void)setTimePeriodEndTimeMinute:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, timePeriodEndTimeMinute);
}
...
- (void)setTimePeriodWeekdays:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, timePeriodWeekdays);
}
...
- (void)setBedtimeBehaviorEnabledSetting:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, bedtimeBehaviorEnabledSetting);
}
