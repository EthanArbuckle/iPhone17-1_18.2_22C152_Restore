...
- (void)setAllowedApplications:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, allowedApplications);
}
...
- (void)setDeniedApplications:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, deniedApplications);
}
...
- (void)setAllowedWebApplications:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, allowedWebApplications);
}
...
- (void)setDeniedWebApplications:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, deniedWebApplications);
}
