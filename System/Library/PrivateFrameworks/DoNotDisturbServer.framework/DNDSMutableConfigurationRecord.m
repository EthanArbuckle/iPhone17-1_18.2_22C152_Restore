...
- (void)setApplicationConfigurationType:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, applicationConfigurationType);
}
...
- (void)setSenderConfigurationType:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, senderConfigurationType);
}
...
- (void)setSuppressionType:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, suppressionType);
}
...
- (void)setSuppressionMode:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, suppressionMode);
}
...
- (void)setMinimumBreakthroughUrgency:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, minimumBreakthroughUrgency);
}
...
- (void)setHideApplicationBadges:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, hideApplicationBadges);
}
...
- (void)setAllowIntelligentManagement:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, allowIntelligentManagement);
}
...
- (void)setCompatibilityVersion:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, compatibilityVersion);
}
