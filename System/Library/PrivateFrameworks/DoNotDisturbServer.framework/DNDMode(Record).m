...
+ (id)modeForRecord:()Record
{
  ...
  id v6 = objc_alloc(MEMORY[0x1E4F5F718]);
  uint64_t v7 = [v3 symbolDescriptorTintStyle];
  v8 = [v3 symbolDescriptorTintColorNames];
  v9 = [v3 symbolDescriptorImageName];
  v5 = (void *)[v6 initWithTintStyle:v7 tintColorNames:v8 imageName:v9];

LABEL_6:
  id v10 = objc_alloc(MEMORY[0x1E4F5F5F8]);
  v11 = [v3 name];
  v12 = [v3 modeIdentifier];
  v13 = [v3 symbolImageName];
  v14 = [v3 tintColorName];
  uint64_t v15 = [v3 semanticType];
  uint64_t v16 = [v3 visibility];
  v17 = [v3 identifier];
  v18 = (void *)[v10 initWithName:v11 modeIdentifier:v12 symbolImageName:v13 tintColorName:v14 symbolDescriptor:v5 semanticType:v15 visibility:v16 identifier:v17];
...
- (DNDSMutableModeRecord)makeRecord
{
  ...
  id v6 = [a1 _tintColorName];
  [(DNDSMutableModeRecord *)v2 setTintColorName:v6];

  uint64_t v7 = [a1 symbolDescriptor];
