...
- (void)setAllowedContactTypes:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, allowedContactTypes);
}
...
- (void)setDeniedContactTypes:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, deniedContactTypes);
}
...
- (void)setAllowedContactGroups:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, allowedContactGroups);
}
...
- (void)setDeniedContactGroups:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, deniedContactGroups);
}
...
- (void)setAllowedContacts:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, allowedContacts);
}
...
- (void)setDeniedContacts:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v4, deniedContacts);
}
