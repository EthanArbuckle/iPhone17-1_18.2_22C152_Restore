...
- (void)_registerForNotification
{
  ...
  CFStringRef v4 = (const __CFString *)*MEMORY[0x263F85B00];
...
void __77__CSVoiceTriggerUserSelectedPhrase_vtPhraseTypeDidChangeNotificationReceived__block_invoke(uint64_t a1)
{
  ...
  if (v4 != v6)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F37FA8], OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v18 = 1024;
      int v19 = v6;
      _os_log_impl(&dword_21C8A5000, v7, OS_LOG_TYPE_DEFAULT, "%s User multi-phrase selection change from %d -> %d", (uint8_t *)&v14, 0x18u);
    }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x263F37FA8], OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 136315394;
      ...
      __int16 v10 = 2112;
      id v11 = v5;
      _os_log_error_impl(&dword_21C8A5000, v6, OS_LOG_TYPE_ERROR, "%s Error fetching the user selected phrase type %@", buf, 0x16u);
    }
  }
...
- (void)dealloc
{
  ...
  DarwinNotifyCenter = CFNotificationCenterGetDarwinNotifyCenter();
  CFNotificationCenterRemoveObserver(DarwinNotifyCenter, self, (CFNotificationName)*MEMORY[0x263F85B00], 0);
  v5.receiver = self;
...
- (CSVoiceTriggerUserSelectedPhrase)initWithEndpointId:(id)a3 vtPreferences:(id)a4
{
  ...
  if (v9)
  {
    ...
    {
      id v11 = [MEMORY[0x263F85AF0] sharedPreferences];
    }
    vtPrefrences = v10->_vtPrefrences;
    v10->_vtPrefrences = v11;

    uint64_t v13 = [MEMORY[0x263F380D0] getSerialQueue:@"com.apple.com.CSUserSelectedVTPhraseMonitor" qualityOfService:33];
    queue = v10->_queue;
