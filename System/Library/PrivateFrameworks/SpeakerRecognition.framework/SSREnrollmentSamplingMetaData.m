...
LABEL_11:
    _os_log_error_impl(&dword_21C8A5000, v11, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v14, 0xCu);
    goto LABEL_12;
  }
...
LABEL_5:
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x263F38100], OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 136315650;
    ...
    __int16 v19 = 2112;
    id v20 = v8;
    _os_log_error_impl(&dword_21C8A5000, v12, OS_LOG_TYPE_ERROR, "%s initializing samplingMetaData with nil inputs: %@, %@", buf, 0x20u);
  }
  v11 = 0;
LABEL_9:
