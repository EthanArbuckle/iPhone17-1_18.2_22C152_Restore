...
{
  id v4 = a3;
  id v5 = [(CKRecord *)self encryptedValuesByKey];
  v6 = [v5 objectForKey:@"value"];

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    id v7 = +[NSKeyedUnarchiver unarchivedObjectOfClasses:v4 fromData:v6 error:0];
  }
  else
  {
    id v7 = v6;
...
- (id)_ad_dataOfClass:(Class)a3
{
  ...
  id v5 = [(CKRecord *)self _ad_dataOfClasses:v4];
