...
- (id)buildDictionaryRepresentation
{
  ...
  v7 = [MEMORY[0x1E4F28ED0] numberWithDouble:self->_expirationDuration];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v8 encodeObject:v6 forKey:@"AFAssertionContext::timestamp"];

  [v8 encodeObject:self->_reason forKey:@"AFAssertionContext::reason"];
  [v8 encodeObject:self->_effectiveDate forKey:@"AFAssertionContext::effectiveDate"];
  id v7 = [MEMORY[0x1E4F28ED0] numberWithDouble:self->_expirationDuration];
  [v8 encodeObject:v7 forKey:@"AFAssertionContext::expirationDuration"];

  [v8 encodeObject:self->_userInfo forKey:@"AFAssertionContext::userInfo"];
}

- (AFAssertionContext)initWithCoder:(id)a3
{
  id v3 = a3;
  id v4 = [v3 decodeObjectOfClass:objc_opt_class() forKey:@"AFAssertionContext::timestamp"];
  uint64_t v26 = [v4 unsignedLongLongValue];

  v25 = [v3 decodeObjectOfClass:objc_opt_class() forKey:@"AFAssertionContext::reason"];
  v24 = [v3 decodeObjectOfClass:objc_opt_class() forKey:@"AFAssertionContext::effectiveDate"];
  ...
  double v17 = objc_msgSend(v23, "setWithObjects:", v22, v21, v8, v9, v10, v11, v12, v13, v14, v15, v16, objc_opt_class(), 0);
  v18 = [v3 decodeObjectOfClasses:v17 forKey:@"AFAssertionContext::userInfo"];

  id v19 = [(AFAssertionContext *)self initWithTimestamp:v26 reason:v25 effectiveDate:v24 expirationDuration:v18 userInfo:v7];
  return v19;
}

- (BOOL)isEqual:(id)a3
{
  id v4 = (AFAssertionContext *)a3;
  if (self == v4)
  {
    BOOL v9 = 1;
  }
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v5 = v4;
      unint64_t timestamp = self->_timestamp;
      if (timestamp == [(AFAssertionContext *)v5 timestamp]
        && (double expirationDuration = self->_expirationDuration,
            [(AFAssertionContext *)v5 expirationDuration],
            expirationDuration == v8))
      {
        uint64_t v11 = [(AFAssertionContext *)v5 reason];
        reason = self->_reason;
        if (reason == v11 || [(NSString *)reason isEqual:v11])
        {
          uint64_t v13 = [(AFAssertionContext *)v5 effectiveDate];
          effectiveDate = self->_effectiveDate;
          if (effectiveDate == v13 || [(NSDate *)effectiveDate isEqual:v13])
          {
            uint64_t v15 = [(AFAssertionContext *)v5 userInfo];
            userInfo = self->_userInfo;
...
- (unint64_t)hash
{
  ...
  double v7 = [MEMORY[0x1E4F28ED0] numberWithDouble:self->_expirationDuration];
  uint64_t v8 = [v7 hash];
...
- (id)_descriptionWithIndent:(unint64_t)a3
{
  ...
  NSUInteger v5 = [(AFAssertionContext *)&v8 description];
...
- (NSString)description
{
  return (NSString *)[(AFAssertionContext *)self _descriptionWithIndent:0];
}
...
- (AFAssertionContext)initWithTimestamp:(unint64_t)a3 reason:(id)a4 effectiveDate:(id)a5 expirationDuration:(double)a6 userInfo:(id)a7
{
  ...
  id v16 = v13;
  id v17 = v12;
  v18 = [(AFAssertionContext *)self initWithBuilder:v20];
...
- (AFAssertionContext)init
{
  return [(AFAssertionContext *)self initWithBuilder:0];
}
...
- (AFAssertionContext)initWithBuilder:(id)a3
{
  ...
  NSUInteger v5 = [(AFAssertionContext *)&v19 init];
  uint64_t v6 = v5;
  if (v4 && v5)
  {
    double v7 = [[_AFAssertionContextMutation alloc] initWithBase:0];
    v4[2](v4, v7);
    if ([(_AFAssertionContextMutation *)v7 isDirty])
    {
      v6->_unint64_t timestamp = [(_AFAssertionContextMutation *)v7 getTimestamp];
      objc_super v8 = [(_AFAssertionContextMutation *)v7 getReason];
      uint64_t v9 = [v8 copy];
      reason = v6->_reason;
      v6->_reason = (NSString *)v9;

      uint64_t v11 = [(_AFAssertionContextMutation *)v7 getEffectiveDate];
      ...
      id v15 = [(_AFAssertionContextMutation *)v7 getUserInfo];
...
- (id)mutatedCopyWithMutator:(id)a3
{
  ...
  if (v4)
  {
    NSUInteger v5 = [[_AFAssertionContextMutation alloc] initWithBase:self];
    v4[2](v4, v5);
    if ([(_AFAssertionContextMutation *)v5 isDirty])
    {
      uint64_t v6 = objc_alloc_init(AFAssertionContext);
      v6->_unint64_t timestamp = [(_AFAssertionContextMutation *)v5 getTimestamp];
      double v7 = [(_AFAssertionContextMutation *)v5 getReason];
      uint64_t v8 = [v7 copy];
      reason = v6->_reason;
      v6->_reason = (NSString *)v8;

      uint64_t v10 = [(_AFAssertionContextMutation *)v5 getEffectiveDate];
      ...
      double v14 = [(_AFAssertionContextMutation *)v5 getUserInfo];
    ...
    {
      uint64_t v6 = (AFAssertionContext *)[(AFAssertionContext *)self copy];
    }
  }
  else
  {
