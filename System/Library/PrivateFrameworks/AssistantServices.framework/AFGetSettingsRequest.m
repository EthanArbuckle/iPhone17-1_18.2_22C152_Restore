...
- (AFGetSettingsRequest)initWithCoder:(id)a3;
- (NSArray)settings;
- (id)createResponse;
...
- (AFGetSettingsRequest)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v12.receiver = self;
  v12.super_class = (Class)AFGetSettingsRequest;
...
{
  v5.receiver = self;
  v5.super_class = (Class)AFGetSettingsRequest;
  id v4 = a3;
...
- (id)createResponse
{
  id v2 = [(AFSiriResponse *)[AFGetSettingsResponse alloc] _initWithRequest:self];
  return v2;
}
