...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[_ADPBDeviceStringKeyValuePair setKey:](self, "setKey:");
    v4 = v5;
  }
  if (v4[2])
  {
    -[_ADPBDeviceStringKeyValuePair setValue:](self, "setValue:");
    v4 = v5;
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return sub_10034FA94((uint64_t)self, (uint64_t)a3);
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)_ADPBDeviceStringKeyValuePair;
  NSUInteger v3 = [(_ADPBDeviceStringKeyValuePair *)&v7 description];
  id v4 = [(_ADPBDeviceStringKeyValuePair *)self dictionaryRepresentation];
