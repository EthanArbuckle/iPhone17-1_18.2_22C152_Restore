...
{
  v7.receiver = self;
  v7.super_class = (Class)_ADPBLocationGetPeerLocationRequest;
  id v3 = [(_ADPBLocationGetPeerLocationRequest *)&v7 description];
  int v4 = [(_ADPBLocationGetPeerLocationRequest *)self dictionaryRepresentation];
