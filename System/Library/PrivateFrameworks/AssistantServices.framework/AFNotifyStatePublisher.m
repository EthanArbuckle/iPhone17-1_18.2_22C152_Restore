...
- (void)_unregister
{
  ...
  if (registrationToken != -1)
  {
    ...
    if (os_log_type_enabled((os_log_t)AFSiriLogContextUtility, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v8 = 2080;
      v9 = name;
      _os_log_impl(&dword_19CF1D000, v4, OS_LOG_TYPE_INFO, "%s Registration token of %s is invalidated.", (uint8_t *)&v6, 0x16u);
    }
  }
}
    ...
    if (v3)
    {
      ...
      if (os_log_type_enabled((os_log_t)AFSiriLogContextUtility, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v15 = 1024;
        int v16 = v4;
        _os_log_error_impl(&dword_19CF1D000, v5, OS_LOG_TYPE_ERROR, "%s Failed to get registration token of %s (status = %u).", buf, 0x1Cu);
      }
    }
    else
    {
      ...
      __int16 v8 = AFSiriLogContextUtility;
      if (os_log_type_enabled((os_log_t)AFSiriLogContextUtility, OS_LOG_TYPE_INFO))
      {
        v9 = self->_name;
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v15 = 1024;
        int v16 = v7;
        _os_log_impl(&dword_19CF1D000, v8, OS_LOG_TYPE_INFO, "%s Registration token of %s is %d.", buf, 0x1Cu);
      }
    }
  }
}
...
LABEL_7:
  ...
  __int16 v8 = AFSiriLogContextUtility;
  BOOL v9 = os_log_type_enabled((os_log_t)AFSiriLogContextUtility, OS_LOG_TYPE_ERROR);
  if (v9)
  {
    name = self->_name;
    *(_DWORD *)buf = 136315906;
    ...
    __int16 v19 = 1024;
    uint32_t v20 = state;
    _os_log_error_impl(&dword_19CF1D000, v8, OS_LOG_TYPE_ERROR, "%s Failed to get state of %s with token %d (status = %u).", buf, 0x22u);
    LOBYTE(v9) = 0;
  }
  return v9;
}
...
- (BOOL)_setState:(unint64_t)a3 withToken:(int)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled((os_log_t)AFSiriLogContextUtility, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 1024;
      uint32_t v20 = v7;
      _os_log_error_impl(&dword_19CF1D000, v8, OS_LOG_TYPE_ERROR, "%s Failed to set state to %llu of %s with token %d (status = %u).", (uint8_t *)&v11, 0x2Cu);
    }
  }
  return v7 == 0;
}
...
{
  if (self->_registrationToken != -1
    && -[AFNotifyStatePublisher _setState:withToken:](self, "_setState:withToken:", a3))
  {
    name = self->_name;
    notify_post(name);
  }
...
- (AFNotifyStatePublisher)initWithName:(id)a3 queue:(id)a4
{
  ...
  id v8 = [(AFNotifyStatePublisher *)&v17 init];
  BOOL v9 = v8;
  if (v8)
  {
    objc_storeStrong((id *)&v8->_queue, a4);
    size_t v10 = [v6 maximumLengthOfBytesUsingEncoding:4] + 1;
    int v11 = (char *)malloc_type_malloc(v10, 0xD0E670E2uLL);
    v9->_name = v11;
    if (([v6 getCString:v11 maxLength:v10 encoding:4] & 1) == 0)
    {
      ...
      if (os_log_type_enabled((os_log_t)AFSiriLogContextUtility, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        __int16 v19 = "-[AFNotifyStatePublisher initWithName:queue:]";
        __int16 v20 = 2112;
        id v21 = v6;
        _os_log_error_impl(&dword_19CF1D000, v12, OS_LOG_TYPE_ERROR, "%s Unable to get C string of name from %@.", buf, 0x16u);
      }
    }
...
- (void)dealloc
{
  [(AFNotifyStatePublisher *)self _unregister];
  name = self->_name;
  if (name)
  {
    free(name);
  ...
  [(AFNotifyStatePublisher *)&v4 dealloc];
}
