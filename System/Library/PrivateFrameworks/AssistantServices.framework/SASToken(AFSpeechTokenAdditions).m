...
- (AFSpeechToken)af_speechToken
{
  ...
  -[AFSpeechToken setConfidenceScore:](v2, "setConfidenceScore:", (int)[v5 intValue]);

  v6 = [a1 startTime];
  -[AFSpeechToken setStartTime:](v2, "setStartTime:", (double)(int)[v6 intValue] * 0.001);

  v7 = [a1 silenceStartTime];
  -[AFSpeechToken setSilenceStartTime:](v2, "setSilenceStartTime:", (double)(int)[v7 intValue] * 0.001);

  v8 = [a1 endTime];
  -[AFSpeechToken setEndTime:](v2, "setEndTime:", (double)(int)[v8 intValue] * 0.001);
