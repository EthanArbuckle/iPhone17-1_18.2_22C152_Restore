...
- (AFQueueDelegate)delegate
{
  ...
  return (AFQueueDelegate *)WeakRetained;
}
...
- (id)dequeueObject
{
  if (self->_count && (v3 = self->_head) != 0)
  {
    ...
    id v7 = [(AFLinkedListItem *)self->_head nextItem];
    head = self->_head;
    self->_head = v7;

    [(AFLinkedListItem *)v6 removeFromList];
    --self->_count;
  }
  else
  {
...
- (void)enqueueObjects:(id)a3
{
  ...
  do
  {
    ...
    do
    {
      ...
      v14 = [[AFLinkedListItem alloc] initWithObject:*(void *)(*((void *)&v20 + 1) + 8 * v12)];
      id v7 = v14;
      if (v6)
      {
        if (!v13) {
...
LABEL_7:
  ...
  {
    uint64_t v8 = v7;
    id v7 = [(AFLinkedListItem *)v7 nextItem];
...
- (id)frontObject
{
  return [(AFLinkedListItem *)self->_head object];
}
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  ...
  uint64_t v12 = (AFLinkedListItem *)(id)a3->var0;
  if (!var0) {
