...
- (AFUpdateMessageRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"UpdateMessageRequestMessage"];
    message = v5->_message;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeObject:forKey:", self->_message, @"UpdateMessageRequestMessage", v5.receiver, v5.super_class);
}

- (id)createResponseWithMessageIdentifier:(id)a3
{
  id v4 = a3;
  id v5 = [[AFObjectUpdatedSiriResponse alloc] _initWithRequest:self objectIdentifier:v4];
