...
- (id)valueFromString:(id)a3
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  id v4 = (id)valueFromString__timeFormatters;
...
- (id)stringFromValue:(id)a3
{
  ...
  else
  {
    if (v4)
    {
      id v7 = +[POXSDateFormatterFactory newTimeFormatterWithTimeZoneStyle:1];
      [v7 setTimeZone:v4];
      goto LABEL_7;
    }
    uint64_t v6 = 0;
  }
  id v7 = +[POXSDateFormatterFactory newTimeFormatterWithTimeZoneStyle:v6];
LABEL_7:
  v8 = [v7 calendar];
