@interface POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly
...
@implementation POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly
...
- (_TtC15PlatformSSOCore44POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly)init
{
  ...
  *(Class *)((char *)&self->super.super.isa
           + OBJC_IVAR____TtC15PlatformSSOCore44POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly_encryptionAlgorithm) = (Class)&unk_2707DBB98;
  id v6 = &unk_2707DBB98;
  sub_259E99E68();
  return (_TtC15PlatformSSOCore44POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly *)POCryptoKitHPKE.init(cipherSuite:)((uint64_t)v5);
}
...
LABEL_9:
  POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly.decodeAndDecryptJWT(_:privateKey:otherInfo:psk:psk_id:authPublicKey:)(v17, v18, v32, v16, (uint64_t)a6, v24, v25, v27, a8);
...
LABEL_11:
  POCryptoKitHPKE_Curve25519_SHA256_ChachaPoly.encodeAndEncryptJWT(_:publicKey:otherInfo:psk:psk_id:authPrivateKey:auth_kid:)(v17, v38, v37, v16, v36, v24, v25, v27, a8, v28, v39);
