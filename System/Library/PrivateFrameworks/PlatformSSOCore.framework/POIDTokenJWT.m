...
{
  v9.receiver = self;
  v9.super_class = (Class)POIDTokenJWT;
...
- (id)mutableCopy
{
  uint64_t v3 = objc_alloc_init(POMutableIDTokenJWT);
  id v4 = [(POIDTokenJWT *)self decodedBody];
...
- (POIDTokenJWTBody)decodedBody
{
  return (POIDTokenJWTBody *)objc_getProperty(self, a2, 80, 1);
}
