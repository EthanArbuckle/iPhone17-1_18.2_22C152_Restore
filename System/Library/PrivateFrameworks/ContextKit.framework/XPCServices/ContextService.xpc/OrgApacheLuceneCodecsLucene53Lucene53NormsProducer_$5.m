...
- (int64_t)getWithInt:(int)a3
{
  ...
  return (int64_t)[(OrgApacheLuceneStoreRandomAccessInput *)v3 readLongWithLong:8 * a3];
}

- (OrgApacheLuceneCodecsLucene53Lucene53NormsProducer_$5)initWithOrgApacheLuceneStoreRandomAccessInput:(id)a3
{
  JreStrongAssign((id *)&self->val$slice_, a3);
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneCodecsLucene53Lucene53NormsProducer__5;
