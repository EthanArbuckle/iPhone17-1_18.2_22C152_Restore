...
- (int64_t)getWithLong:(int64_t)a3
{
  ...
  int64_t v3 = self->val$mult_;
  int64_t v4 = self->val$min_;
  return v4 + (void)[(OrgApacheLuceneUtilLongValues *)self->val$quotientReader_ getWithLong:a3] * v3;
}
...
- (OrgApacheLuceneCodecsLucene50Lucene50DocValuesProducer_$3)initWithLong:(int64_t)a3 withLong:(int64_t)a4 withOrgApacheLuceneUtilLongValues:(id)a5
{
  self->val$min_ = a3;
  self->val$mult_ = a4;
  JreStrongAssign((id *)&self->val$quotientReader_, a5);
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneCodecsLucene50Lucene50DocValuesProducer__3;
