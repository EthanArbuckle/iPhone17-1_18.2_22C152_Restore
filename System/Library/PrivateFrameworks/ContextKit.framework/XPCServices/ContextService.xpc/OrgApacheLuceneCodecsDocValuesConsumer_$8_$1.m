...
- (BOOL)hasNext
{
  if (self->nextIsSet_) {
    ...
    return -[OrgApacheLuceneCodecsDocValuesConsumer_$8_$1 setNext]_0((uint64_t)self);
  }
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneCodecsDocValuesConsumer__8__1;
