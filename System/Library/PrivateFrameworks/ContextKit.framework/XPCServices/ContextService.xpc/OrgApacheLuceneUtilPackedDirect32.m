...
- (OrgApacheLuceneUtilPackedDirect32)initWithInt:(int)a3;
- (OrgApacheLuceneUtilPackedDirect32)initWithInt:(int)a3 withOrgApacheLuceneStoreDataInput:(id)a4 withInt:(int)a5;
...
- (int64_t)getWithInt:(int)a3
{
  ...
  return *((unsigned int *)&values->super.size_ + a3 + 1);
}
...
- (int64_t)ramBytesUsed
{
  ...
  return OrgApacheLuceneUtilRamUsageEstimator_sizeOfWithIntArray_((uint64_t)self->values_) + v4;
}
...
- (int)getWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withInt:(int)a6
{
  ...
  if (v10 + (int)v8 > (int)v8)
  {
    ...
    do
    {
      ...
      *((void *)a4 + (int)v6 + 2) = *((unsigned int *)&values->super.size_ + ++v8);
      uint64_t v6 = (v6 + 1);
    }
    while (v11 != v8);
  }
...
- (int)setWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withInt:(int)a6
{
  ...
  if (v10 + (int)v8 > (int)v8)
  {
    ...
    do
    {
      ...
      *(&values->super.size_ + ++v8) = *((void *)a4 + v12 + 2);
      a5 = v12 + 1;
    }
    while (v11 != v8);
  }
...
- (void)fillWithInt:(int)a3 withInt:(int)a4 withLong:(int64_t)a5
{
  JavaUtilArrays_fillWithIntArray_withInt_withInt_withInt_((uint64_t)self->values_, *(uint64_t *)&a3, *(uint64_t *)&a4, a5, a5, v5, v6, v7);
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilPackedDirect32;
  [(OrgApacheLuceneUtilPackedDirect32 *)&v3 dealloc];
}
