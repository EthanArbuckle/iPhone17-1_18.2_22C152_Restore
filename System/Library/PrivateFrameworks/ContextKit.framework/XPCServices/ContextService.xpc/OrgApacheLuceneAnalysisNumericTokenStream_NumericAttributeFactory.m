...
- (id)createAttributeInstanceWithIOSClass:(id)a3
{
  if ([(id)OrgApacheLuceneAnalysisTokenattributesCharTermAttribute_class_() isAssignableFrom:a3])
  {
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneAnalysisNumericTokenStream_NumericAttributeFactory;
