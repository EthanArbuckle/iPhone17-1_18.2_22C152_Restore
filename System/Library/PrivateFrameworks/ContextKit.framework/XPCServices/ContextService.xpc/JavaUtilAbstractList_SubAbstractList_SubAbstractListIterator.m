...
- (BOOL)hasNext
{
  ...
  return (int)[(JavaUtilListIterator *)iterator nextIndex] < self->end_;
}
...
- (BOOL)hasPrevious
{
  ...
  return (int)[(JavaUtilListIterator *)iterator previousIndex] >= self->start_;
}
...
- (id)next
{
  ...
  if ((int)[(JavaUtilListIterator *)iterator nextIndex] >= self->end_)
  {
...
- (id)previous
{
  ...
  if ((int)[(JavaUtilListIterator *)iterator previousIndex] < self->start_)
  {
    v6 = new_JavaUtilNoSuchElementException_init();
    objc_exception_throw(v6);
  }
...
- (int)previousIndex
{
  ...
  unsigned int v4 = [(JavaUtilListIterator *)iterator previousIndex];
  int start = self->start_;
  BOOL v6 = __OFSUB__(v4, start);
  int v7 = v4 - start;
  if (v7 < 0 != v6) {
    return -1;
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)JavaUtilAbstractList_SubAbstractList_SubAbstractListIterator;
  [(JavaUtilAbstractList_SubAbstractList_SubAbstractListIterator *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_100475570;
}
