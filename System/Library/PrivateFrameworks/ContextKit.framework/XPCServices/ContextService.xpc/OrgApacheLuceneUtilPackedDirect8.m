...
- (OrgApacheLuceneUtilPackedDirect8)initWithInt:(int)a3;
- (OrgApacheLuceneUtilPackedDirect8)initWithInt:(int)a3 withOrgApacheLuceneStoreDataInput:(id)a4 withInt:(int)a5;
...
- (int64_t)getWithInt:(int)a3
{
  ...
  return *((unsigned __int8 *)&values->super.size_ + a3 + 4);
}
...
- (void)setWithInt:(int)a3 withLong:(int64_t)a4
{
  ...
  *((unsigned char *)&values->super.size_ + a3 + 4) = a4;
}
...
- (int64_t)ramBytesUsed
{
  ...
  return OrgApacheLuceneUtilRamUsageEstimator_sizeOfWithByteArray_((uint64_t)self->values_) + v4;
}
...
- (int)getWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withInt:(int)a6
{
  ...
  if (v10 + (int)v8 > (int)v8)
  {
    ...
    do
    {
      ...
      *((void *)a4 + (int)v6 + 2) = *((unsigned __int8 *)&values->super.size_ + v8++ + 4);
      uint64_t v6 = (v6 + 1);
    }
    while (v11 != v8);
  }
...
- (int)setWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withInt:(int)a6
{
  ...
  if (v10 + (int)v8 > (int)v8)
  {
    ...
    do
    {
      ...
      *((unsigned char *)&values->super.size_ + v8++ + 4) = *((void *)a4 + v12 + 2);
      a5 = v12 + 1;
    }
    while (v11 != v8);
  }
...
- (void)fillWithInt:(int)a3 withInt:(int)a4 withLong:(int64_t)a5
{
  JavaUtilArrays_fillWithByteArray_withInt_withInt_withByte_((uint64_t)self->values_, *(uint64_t *)&a3, *(uint64_t *)&a4, (char)a5, a5, v5, v6, v7);
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilPackedDirect8;
