...
- (OrgApacheLuceneCodecsLucene53Lucene53Codec)init;
- (OrgApacheLuceneCodecsLucene53Lucene53Codec)initWithOrgApacheLuceneCodecsLucene50Lucene50StoredFieldsFormat_ModeEnum:(id)a3;
- (id)compoundFormat;
- (id)docValuesFormat;
- (id)fieldInfosFormat;
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneCodecsLucene53Lucene53Codec;
