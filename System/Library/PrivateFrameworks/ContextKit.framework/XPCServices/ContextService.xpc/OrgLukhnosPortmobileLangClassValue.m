...
- (OrgLukhnosPortmobileLangClassValue)init
{
  ...
  JreStrongAssignAndConsume((id *)&self->cache_, v3);
  return self;
}
...
- (id)getWithIOSClass:(id)a3
{
  ...
  if (-[JavaUtilMap containsKeyWithId:](cache, "containsKeyWithId:"))
  {
    v6 = self->cache_;
  ...
  {
    id v8 = [(OrgLukhnosPortmobileLangClassValue *)self computeValueWithIOSClass:a3];
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgLukhnosPortmobileLangClassValue;
