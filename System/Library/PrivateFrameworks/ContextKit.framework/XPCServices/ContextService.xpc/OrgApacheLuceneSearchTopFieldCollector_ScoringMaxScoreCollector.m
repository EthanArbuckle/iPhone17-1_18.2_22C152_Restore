...
LABEL_12:
  ...
  int v10 = v7[3];
  v11 = [OrgApacheLuceneSearchTopFieldCollector_ScoringMaxScoreCollector__1 alloc];
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneSearchTopFieldCollector_ScoringMaxScoreCollector;
