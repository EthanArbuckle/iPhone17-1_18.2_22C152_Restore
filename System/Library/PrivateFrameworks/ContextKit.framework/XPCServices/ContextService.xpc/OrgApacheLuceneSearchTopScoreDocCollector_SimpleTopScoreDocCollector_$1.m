...
LABEL_9:
  ...
  p_pqTop = (id *)&v8->super.pqTop_;
  id v11 = [(OrgApacheLuceneUtilPriorityQueue *)pq updateTop];
  JreStrongAssign(p_pqTop, v11);
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneSearchTopScoreDocCollector_SimpleTopScoreDocCollector__1;
