...
+ (id)newArrayWithLength:(unint64_t)a3
{
  return sub_10024AC18(a3);
}

+ (IOSDoubleArray)arrayWithLength:(unint64_t)a3
{
  v3 = sub_10024AC18(a3);
  return (IOSDoubleArray *)v3;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  return +[IOSDoubleArray newArrayWithDoubles:self->buffer_ count:self->super.size_];
}

- (id)descriptionOfElementAtIndex:(int)a3
{
  return +[NSString stringWithFormat:@"%g", *(void *)&self->buffer_[a3]];
}
