...
+ (const)__metadata;
- (JavaUtilTreeMap_BoundedMap_BoundedEntrySet_$1)initWithJavaUtilTreeMap_BoundedMap_BoundedEntrySet:(id)a3 withJavaUtilTreeMap_Node:(id)a4;
- (id)next;
- (void)dealloc;
@end
...
{
  v3.receiver = self;
  v3.super_class = (Class)JavaUtilTreeMap_BoundedMap_BoundedEntrySet__1;
  [(JavaUtilTreeMap_BoundedMap_BoundedIterator *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_1004381F0;
}
