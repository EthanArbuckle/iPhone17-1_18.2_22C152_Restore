...
- (int64_t)getWithLong:(int64_t)a3
{
  ...
  return ([(OrgApacheLuceneStoreRandomAccessInput *)in readByteWithLong:(unint64_t)a3 >> 2] >> (~(2 * a3) & 6)) & 3;
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader2;
