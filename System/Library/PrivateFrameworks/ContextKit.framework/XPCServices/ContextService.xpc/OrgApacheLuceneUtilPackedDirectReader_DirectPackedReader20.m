...
- (int64_t)getWithLong:(int64_t)a3
{
  ...
  return ([(OrgApacheLuceneStoreRandomAccessInput *)in readIntWithLong:((unint64_t)(5 * a3) >> 1) & 0x1FFFFFFFFFFFFFFFLL] >> 8 >> (~(4 * a3) & 4)) & 0xFFFFF;
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader20;
