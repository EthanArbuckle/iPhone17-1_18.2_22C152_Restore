...
+ (const)__metadata;
+ (id)asIntBufferWithJavaNioByteBuffer:(id)a3;
- (BOOL)isDirect;
- (BOOL)isReadOnly;
- (BOOL)protectedHasArray;
- (JavaNioByteBufferAsIntBuffer)initWithJavaNioByteBuffer:(id)a3;
- (id)asReadOnlyBuffer;
- (id)compact;
- (id)duplicate;
...
+ (id)asIntBufferWithJavaNioByteBuffer:(id)a3
{
  return JavaNioByteBufferAsIntBuffer_asIntBufferWithJavaNioByteBuffer_(a3);
}
...
- (id)getWithIntArray:(id)a3 withInt:(int)a4 withInt:(int)a5
{
  ...
  [(JavaNioByteBuffer *)v10 getWithIntArray:a3 withInt:v8 withInt:v7];
...
- (id)putWithInt:(int)a3
{
  ...
  self->super.super.position_ = position + 1;
  [(JavaNioByteBuffer *)byteBuffer putIntWithInt:(4 * position) withInt:*(void *)&a3];
  return self;
}
...
- (id)putWithInt:(int)a3 withInt:(int)a4
{
  ...
  [(JavaNioByteBuffer *)byteBuffer putIntWithInt:(4 * a3) withInt:v4];
  return self;
}
...
- (id)putWithIntArray:(id)a3 withInt:(int)a4 withInt:(int)a5
{
  ...
  [(JavaNioByteBuffer *)v10 putWithIntArray:a3 withInt:v8 withInt:v7];
  self->super.super.position_ += v7;
  return self;
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)JavaNioByteBufferAsIntBuffer;
  [(JavaNioByteBufferAsIntBuffer *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_1003F47B0;
}
