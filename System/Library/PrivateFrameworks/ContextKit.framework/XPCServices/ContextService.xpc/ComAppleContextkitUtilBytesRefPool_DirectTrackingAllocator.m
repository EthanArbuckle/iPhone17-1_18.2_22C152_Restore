...
- (ComAppleContextkitUtilBytesRefPool_DirectTrackingAllocator)initWithOrgApacheLuceneUtilCounter:(id)a3
{
  ...
  JreStrongAssign((id *)&self->bytesUsed_, a3);
  return self;
}
...
- (ComAppleContextkitUtilBytesRefPool_DirectTrackingAllocator)initWithInt:(int)a3 withOrgApacheLuceneUtilCounter:(id)a4
{
  ...
  JreStrongAssign((id *)&self->bytesUsed_, a4);
  return self;
}
...
- (id)getByteBlock
{
  ...
  v5.receiver = self;
  v5.super_class = (Class)ComAppleContextkitUtilBytesRefPool_DirectTrackingAllocator;
...
LABEL_7:
  ...
  uint64_t v8 = (int)v8;
  do
    IOSObjectArray_Set((uint64_t)a3, v8++, 0);
  while (a5 != v8);
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)ComAppleContextkitUtilBytesRefPool_DirectTrackingAllocator;
