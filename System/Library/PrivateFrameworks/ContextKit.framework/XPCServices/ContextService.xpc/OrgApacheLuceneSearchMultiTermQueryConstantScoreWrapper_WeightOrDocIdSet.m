...
- (OrgApacheLuceneSearchMultiTermQueryConstantScoreWrapper_WeightOrDocIdSet)initWithOrgApacheLuceneSearchWeight:(id)a3;
- (void)dealloc;
@end
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneSearchMultiTermQueryConstantScoreWrapper_WeightOrDocIdSet;
