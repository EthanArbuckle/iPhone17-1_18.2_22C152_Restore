...
- (id)getDocValuesFormatForFieldWithNSString:(id)a3
{
  return [(OrgApacheLuceneCodecsLucene53Lucene53Codec *)self->this$0_ getDocValuesFormatForFieldWithNSString:a3];
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneCodecsLucene53Lucene53Codec__2;
