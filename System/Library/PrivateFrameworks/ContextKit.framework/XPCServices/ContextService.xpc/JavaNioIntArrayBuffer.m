...
+ (const)__metadata;
+ (id)copy__WithJavaNioIntArrayBuffer:(id)a3 withInt:(int)a4 withBoolean:(BOOL)a5;
- (BOOL)isDirect;
- (BOOL)isReadOnly;
- (BOOL)protectedHasArray;
- (JavaNioIntArrayBuffer)initWithInt:(int)a3 withIntArray:(id)a4 withInt:(int)a5 withBoolean:(BOOL)a6;
- (JavaNioIntArrayBuffer)initWithIntArray:(id)a3;
- (id)asReadOnlyBuffer;
- (id)compact;
- (id)duplicate;
...
- (JavaNioIntArrayBuffer)initWithIntArray:(id)a3
{
  JavaNioIntArrayBuffer_initWithIntArray_((uint64_t)self, (unsigned int *)a3, (uint64_t)a3, v3, v4, v5, v6, v7);
  return self;
}

- (JavaNioIntArrayBuffer)initWithInt:(int)a3 withIntArray:(id)a4 withInt:(int)a5 withBoolean:(BOOL)a6
{
  JavaNioIntBuffer_initWithInt_withLong_((uint64_t)self, *(uint64_t *)&a3, 0, (uint64_t)a4, *(uint64_t *)&a5, a6, v6, v7);
...
+ (id)copy__WithJavaNioIntArrayBuffer:(id)a3 withInt:(int)a4 withBoolean:(BOOL)a5
{
  return sub_10023B028((uint64_t)a3, a4, a5);
}

- (id)asReadOnlyBuffer
{
  return sub_10023B028((uint64_t)self, self->super.super.mark_, 1);
}
...
- (id)duplicate
{
  return sub_10023B028((uint64_t)self, self->super.super.mark_, self->isReadOnly_);
}

- (id)slice
{
  v2 = sub_10023B250([(JavaNioBuffer *)self remaining], self->backingArray_, self->super.super.position_ + self->arrayOffset_, self->isReadOnly_);
  return v2;
}
...
- (int)getWithInt:(int)a3
{
  ...
  return *(&backingArray->super.size_ + (int)v7 + 1);
}
...
- (id)putWithInt:(int)a3 withInt:(int)a4
{
  ...
  *(&backingArray->super.size_ + (int)v9 + 1) = a4;
  return self;
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)JavaNioIntArrayBuffer;
  [(JavaNioIntArrayBuffer *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_10045AB28;
}
