...
- (int64_t)getWithLong:(int64_t)a3
{
  ...
  return (unint64_t)[(OrgApacheLuceneStoreRandomAccessInput *)in readLongWithLong:5 * a3] >> 24;
}

- (void)dealloc
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader40;
