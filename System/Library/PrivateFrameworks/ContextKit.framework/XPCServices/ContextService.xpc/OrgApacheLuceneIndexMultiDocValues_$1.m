...
- (OrgApacheLuceneIndexMultiDocValues_$1)initWithIntArray:(id)a3 withOrgApacheLuceneIndexNumericDocValuesArray:(id)a4;
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneIndexMultiDocValues__1;
