...
- (OrgApacheLuceneUtilPackedPacked16ThreeBlocks)initWithInt:(int)a3;
- (OrgApacheLuceneUtilPackedPacked16ThreeBlocks)initWithInt:(int)a3 withOrgApacheLuceneStoreDataInput:(id)a4 withInt:(int)a5;
- (id)description;
...
- (int64_t)getWithInt:(int)a3
{
  ...
  v6 = blocks;
  uint64_t v7 = *((unsigned __int16 *)&blocks->super.size_ + v4 + 2);
  int v8 = v4 + 1;
  if (v4 + 1 < 0 || v8 >= (int)size) {
    IOSArray_throwOutOfBoundsWithMsg(size, v8);
  }
  uint64_t v9 = *((unsigned __int16 *)&blocks->super.size_ + v4 + 3);
  uint64_t v10 = (v4 + 2);
  if ((int)v10 < 0 || (int)v10 >= (int)size) {
    IOSArray_throwOutOfBoundsWithMsg(size, v10);
  }
  return (v7 << 32) | (v9 << 16) | *((unsigned __int16 *)&v6->super.size_ + (int)v10 + 2);
}
...
- (int)getWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withInt:(int)a6
{
  ...
  for (i = 3 * (v10 + a3); (int)v11 < i; uint64_t v6 = (v6 + 1))
  {
    ...
    uint64_t v16 = *((unsigned __int16 *)&self->blocks_->super.size_ + v15 + 2);
    int v17 = v11 + 2;
    ...
    *((void *)a4 + (int)v6 + 2) = ((unint64_t)*((unsigned __int16 *)&blocks->super.size_ + (int)v11 + 2) << 32) | (v16 << 16) | *((unsigned __int16 *)&blocks->super.size_ + v17 + 2);
    uint64_t v11 = (v11 + 3);
  }
  return v10;
}
...
- (void)setWithInt:(int)a3 withLong:(int64_t)a4
{
  ...
  *((_WORD *)&blocks->super.size_ + v6 + 2) = WORD2(a4);
  int v8 = self->blocks_;
  ...
  *((_WORD *)&v8->super.size_ + v10 + 2) = WORD1(a4);
  ...
  *((_WORD *)&v11->super.size_ + v13 + 2) = a4;
}
...
- (int)setWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withInt:(int)a6
{
  ...
  if (v10 + (int)v6 > (int)v6)
  {
    ...
    do
    {
      ...
      *((_WORD *)&blocks->super.size_ + (int)v12 + 2) = WORD2(v15);
      int v17 = v12 + 1;
      ...
      *((_WORD *)&v18->super.size_ + v17 + 2) = WORD1(v15);
      int v20 = v12 + 2;
      v21 = self->blocks_;
      ...
      *((_WORD *)&v21->super.size_ + v20 + 2) = v15;
      ++v6;
      uint64_t v12 = (v12 + 3);
    }
    while (v11 != v6);
...
- (void)fillWithInt:(int)a3 withInt:(int)a4 withLong:(int64_t)a5
{
  for (uint64_t i = (3 * a3); (int)i < 3 * a4; uint64_t i = (i + 3))
  {
    ...
    *((_WORD *)&blocks->super.size_ + (int)i + 2) = WORD2(a5);
    ...
    *((_WORD *)&v9->super.size_ + v10 + 2) = WORD1(a5);
...
- (int64_t)ramBytesUsed
{
  ...
  return OrgApacheLuceneUtilRamUsageEstimator_sizeOfWithShortArray_((uint64_t)self->blocks_) + v4;
}

- (id)description
{
  id v3 = objc_msgSend(-[OrgApacheLuceneUtilPackedPacked16ThreeBlocks getClass](self, "getClass"), "getSimpleName");
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilPackedPacked16ThreeBlocks;
