@interface OrgApacheLuceneUtilAttributeImpl_$1
- (OrgApacheLuceneUtilAttributeImpl_$1)initWithJavaLangStringBuilder:(id)a3 withBoolean:(BOOL)a4;
- (void)dealloc;
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneUtilAttributeImpl__1;
  [(OrgApacheLuceneUtilAttributeImpl_$1 *)&v3 dealloc];
}
