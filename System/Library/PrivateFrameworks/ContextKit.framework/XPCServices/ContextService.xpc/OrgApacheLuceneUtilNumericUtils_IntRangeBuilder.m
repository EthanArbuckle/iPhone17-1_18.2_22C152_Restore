...
- (void)addRangeWithInt:(int)a3 withInt:(int)a4 withInt:(int)a5;
...
- (void)addRangeWithInt:(int)a3 withInt:(int)a4 withInt:(int)a5
{
  ...
  OrgApacheLuceneUtilNumericUtils_intToPrefixCodedBytesWithInt_withInt_withOrgApacheLuceneUtilBytesRefBuilder_(a3, v5, v9, v11, v12, v13, v14, v15);
  OrgApacheLuceneUtilNumericUtils_intToPrefixCodedBytesWithInt_withInt_withOrgApacheLuceneUtilBytesRefBuilder_(a4, v5, v10, v16, v17, v18, v19, v20);
