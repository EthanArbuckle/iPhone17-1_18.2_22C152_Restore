...
+ (const)__metadata;
+ (id)copy__WithJavaNioLongArrayBuffer:(id)a3 withInt:(int)a4 withBoolean:(BOOL)a5;
- (BOOL)isDirect;
- (BOOL)isReadOnly;
- (BOOL)protectedHasArray;
- (JavaNioLongArrayBuffer)initWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withBoolean:(BOOL)a6;
- (JavaNioLongArrayBuffer)initWithLongArray:(id)a3;
- (id)asReadOnlyBuffer;
- (id)compact;
- (id)duplicate;
...
- (JavaNioLongArrayBuffer)initWithLongArray:(id)a3
{
  JavaNioLongArrayBuffer_initWithLongArray_((uint64_t)self, (unsigned int *)a3, (uint64_t)a3, v3, v4, v5, v6, v7);
  return self;
}

- (JavaNioLongArrayBuffer)initWithInt:(int)a3 withLongArray:(id)a4 withInt:(int)a5 withBoolean:(BOOL)a6
{
  JavaNioLongBuffer_initWithInt_withLong_((uint64_t)self, *(uint64_t *)&a3, 0, (uint64_t)a4, *(uint64_t *)&a5, a6, v6, v7);
...
+ (id)copy__WithJavaNioLongArrayBuffer:(id)a3 withInt:(int)a4 withBoolean:(BOOL)a5
{
  return sub_1001791F8((uint64_t)a3, a4, a5);
}

- (id)asReadOnlyBuffer
{
  return sub_1001791F8((uint64_t)self, self->super.super.mark_, 1);
}
...
- (id)duplicate
{
  return sub_1001791F8((uint64_t)self, self->super.super.mark_, self->isReadOnly_);
}

- (id)slice
{
  v2 = sub_100179420([(JavaNioBuffer *)self remaining], self->backingArray_, self->super.super.position_ + self->arrayOffset_, self->isReadOnly_);
  return v2;
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)JavaNioLongArrayBuffer;
  [(JavaNioLongArrayBuffer *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_100404D60;
}
