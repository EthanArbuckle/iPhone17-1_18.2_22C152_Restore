...
- (void)free
{
  if (self->super.address_)
  {
    ...
    [(id)LibcoreIoLibcore_os_ munmapWithLong:self->super.address_ withLong:self->super.size_];
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)JavaNioMemoryBlock_MemoryMappedBlock;
  [(JavaNioMemoryBlock_MemoryMappedBlock *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_1004236C8;
}
