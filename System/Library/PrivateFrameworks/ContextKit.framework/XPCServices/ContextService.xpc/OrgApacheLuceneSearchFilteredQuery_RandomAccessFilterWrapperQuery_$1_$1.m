...
- (BOOL)matches
{
  ...
  if (!approximation
    || (id v4 = [(OrgApacheLuceneSearchDocIdSetIterator *)approximation docID], (v5 = self->val$bits_) == 0))
  {
...
{
  v3.receiver = self;
  v3.super_class = (Class)OrgApacheLuceneSearchFilteredQuery_RandomAccessFilterWrapperQuery__1__1;
