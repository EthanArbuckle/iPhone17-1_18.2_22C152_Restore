...
- (JavaUtilAbstractMap_SimpleImmutableEntry)initWithJavaUtilMap_Entry:(id)a3;
...
{
  v3.receiver = self;
  v3.super_class = (Class)JavaUtilAbstractMap_SimpleImmutableEntry;
  [(JavaUtilAbstractMap_SimpleImmutableEntry *)&v3 dealloc];
}

+ (const)__metadata
{
  return (const J2ObjcClassInfo *)&unk_10040C540;
}
