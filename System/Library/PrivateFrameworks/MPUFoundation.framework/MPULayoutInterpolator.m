...
- (id)description
{
  ...
  if (v10 != v11)
  {
    ...
    do
    {
      double v13 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)v10);
...
- (void)addValue:(double)a3 forReferenceMetric:(double)a4 secondaryReferenceMetric:(double)a5
{
  ...
  if (end != begin)
  {
    ...
    do
    {
      ...
      double v12 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(v11);
      double v13 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)v24);
      if (v12 >= v13) {
        v10 >>= 1;
      }
      else {
  ...
  if (self->_entriesContainers.__end_ == end
    || (double v14 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)end),
        double v15 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)v24),
  ...
  else
  {
    ...
    objc_msgSend(MEMORY[0x263EFF940], "raise:format:", *MEMORY[0x263EFF4A0], @"%s", v16);
  }
  if (SHIBYTE(v23) < 0) {
    operator delete((void *)__p);
  }
...
- (double)valueForReferenceMetric:(double)a3
{
  [(MPULayoutInterpolator *)self valueForReferenceMetric:a3 secondaryReferenceMetric:-1.13427449e38];
  return result;
}
...
- (double)valueForReferenceMetric:(double)a3 secondaryReferenceMetric:(double)a4
{
  ...
  if (end == begin)
  {
    long long v19 = (void *)MEMORY[0x263EFF940];
    ...
    [v19 raise:*MEMORY[0x263EFF4A0], @"Can't call -[%@ %@] before calling -[%@ %@] at least once.", v13, v21, v23, v24 format];
  ...
  if (self->_hasEntryWithSpecificSecondaryReferenceMetric && MPUFloatEqualToFloat(a4, -1.13427449e38))
  {
    ...
    [v11 raise:*MEMORY[0x263EFF4A0], @"Can't call -[%@ valueForReferenceMetric:] without a valid secondary reference metric. Please use -[%@ %@] with a valid last argument.", v13, v15, v16 format];
...
LABEL_10:
  ...
  if (v8 != 32)
  {
    ...
    if (v27)
    {
      ...
      do
      {
        v29 = (MPU::LayoutInterpolator::EntriesContainer *)((char *)v26 + 32 * (v28 >> 1));
        double v30 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(v29);
        double v31 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)__p);
        if (v30 >= v31) {
          v28 >>= 1;
        }
        else {
      ...
      {
        double v32 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)v26);
        double v33 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)__p);
        if (MPUFloatEqualToFloat(v32, v33))
        {
          double v34 = MPU::LayoutInterpolator::EntriesContainer::valueForSecondaryReferenceMetric((double **)v26, a4);
        }
        else if (v26 == self->_entriesContainers.__begin_)
        {
          [(MPULayoutInterpolator *)self _interpolatedValueForPrimaryReferenceMetric:v26 secondaryReferenceMetric:(char *)v26 + 32 betweenFirstEntriesContainer:a3 andSecondEntriesContainer:a4];
        }
        else
        {
          [(MPULayoutInterpolator *)self _interpolatedValueForPrimaryReferenceMetric:(char *)v26 - 32 secondaryReferenceMetric:v26 betweenFirstEntriesContainer:a3 andSecondEntriesContainer:a4];
        }
LABEL_25:
        double v25 = v34;
        if (__p[0])
    ...
    [(MPULayoutInterpolator *)self _interpolatedValueForPrimaryReferenceMetric:(char *)v26 - 64 secondaryReferenceMetric:(char *)v26 - 32 betweenFirstEntriesContainer:a3 andSecondEntriesContainer:a4];
    goto LABEL_25;
  }
...
- (double)_interpolatedValueForPrimaryReferenceMetric:(double)a3 secondaryReferenceMetric:(double)a4 betweenFirstEntriesContainer:(void *)a5 andSecondEntriesContainer:(void *)a6
{
  uint64_t v11 = MPU::LayoutInterpolator::EntriesContainer::entriesCount((MPU::LayoutInterpolator::EntriesContainer *)a5);
  uint64_t v12 = MPU::LayoutInterpolator::EntriesContainer::entriesCount((MPU::LayoutInterpolator::EntriesContainer *)a6);
  if (v11 == 1 && v12 == 1)
  {
    ...
    double v14 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)a5);
    ...
    double v16 = MPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric((MPU::LayoutInterpolator::EntriesContainer *)a6);
    double v17 = MPULayoutLinearRelationMake(v14, v13, v16, v15);
    double v19 = MPULayoutLinearRelationEvaluate(v17, v18, a3);
    if (*(double *)&__p != 0.0)
    {
      v60 = __p;
      operator delete(__p);
  ...
  else
  {
    ...
    do
    {
      ...
      if (0xAAAAAAAAAAAAAAABLL * ((v53 - (unsigned char *)__src) >> 3) >= 3)
      {
        ...
        double v45 = 0.0;
        double v43 = 0.0;
        BOOL v37 = MPU::Point3D::resolveEquationOfPlaneDefinedByFirstThreePointsInVector((double **)&__src, &v45, &v44, &v43, *(double *)&v21, v22, *(double *)&v23, v24, v25, v26, v27, v28);
        char v36 = v37;
        if (v37)
        {
          uint64_t v23 = __p;
...
- (vector<MPU::Point3D,)_sortedPointsFor3DInterpolationFromEntriesContainer:(MPULayoutInterpolator *)self usingQueriedPoint:(SEL)a3 fallbackSecondaryReferenceMetric:(void *)a4
{
  ...
  Point3D result = (vector<MPU::Point3D, std::allocator<MPU::Point3D>> *)__p;
  if (__p)
  {
          ...
          if (v6 || !v5)
          {
            switch(v14)
            {
              ...
              case 2uLL:
                ...
                break;
              case 3uLL:
                std::__sort3[abi:ne180100]<std::_ClassicAlgPolicy,[(MPULayoutInterpolator *)(long long *)v12 _sortPointsFor3DInterpolation:(double *)(a2 - 24) usingQueriedPoint:a3];
                break;
              case 4uLL:
                std::__sort4[abi:ne180100]<std::_ClassicAlgPolicy,-[MPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_4 &,MPU::Point3D *>(v12, v12 + 24, v12 + 48, a2 - 24, a3);
                break;
              case 5uLL:
                std::__sort5_maybe_branchless[abi:ne180100]<std::_ClassicAlgPolicy,-[MPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_4 &,MPU::Point3D *,0>((__n128 *)v12, (__n128 *)(v12 + 24), (__n128 *)(v12 + 48), (__n128 *)(v12 + 72), (__n128 *)(a2 - 24), a3);
                break;
              default:
                JUMPOUT(0);
            }
...
LABEL_74:
          ...
          if ((unint64_t)v13 >= 0xC01)
          {
            ...
            std::__sort3[abi:ne180100]<std::_ClassicAlgPolicy,[(MPULayoutInterpolator *)(long long *)(a1 + 24) _sortPointsFor3DInterpolation:(double *)(a2 - 48) usingQueriedPoint:a3];
            double v19 = (double *)(a1 + 24 + 8 * v17);
            std::__sort3[abi:ne180100]<std::_ClassicAlgPolicy,[(MPULayoutInterpolator *)(long long *)(a1 + 48) _sortPointsFor3DInterpolation:(double *)(a2 - 72) usingQueriedPoint:a3];
            std::__sort3[abi:ne180100]<std::_ClassicAlgPolicy,[(MPULayoutInterpolator *)(long long *)v18 _sortPointsFor3DInterpolation:v19 usingQueriedPoint:a3];
          ...
          {
            std::__sort3[abi:ne180100]<std::_ClassicAlgPolicy,[(MPULayoutInterpolator *)(long long *)(a1 + 24 * (v14 >> 1)) _sortPointsFor3DInterpolation:(double *)(a2 - 24) usingQueriedPoint:a3];
          }
          --a4;
...
LABEL_31:
        std::__introsort<std::_ClassicAlgPolicy,-[MPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_4 &,MPU::Point3D *,false>(a1, v12 - 24, a3, a4, a5 & 1);
        a5 = 0;
      }
      BOOL v45 = std::__insertion_sort_incomplete[abi:ne180100]<std::_ClassicAlgPolicy,-[MPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_4 &,MPU::Point3D *>(a1, v12 - 24, a3);
      if (std::__insertion_sort_incomplete[abi:ne180100]<std::_ClassicAlgPolicy,-[MPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_4 &,MPU::Point3D *>(v12, a2, a3))
      {
        break;
      }
      if (!v45) {
