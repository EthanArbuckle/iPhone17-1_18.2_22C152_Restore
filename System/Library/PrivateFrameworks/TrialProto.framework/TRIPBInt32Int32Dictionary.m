@interface TRIPBInt32Int32Dictionary
- (BOOL)getInt32:(int *)a3 forKey:(int)a4;
- (BOOL)isEqual:(id)a3;
- (TRIPBInt32Int32Dictionary)init;
- (TRIPBInt32Int32Dictionary)initWithCapacity:(unint64_t)a3;
- (TRIPBInt32Int32Dictionary)initWithDictionary:(id)a3;
- (TRIPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5;
...
@implementation TRIPBInt32Int32Dictionary

- (TRIPBInt32Int32Dictionary)init
{
  return [(TRIPBInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}

- (TRIPBInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TRIPBInt32Int32Dictionary;
  v8 = [(TRIPBInt32Int32Dictionary *)&v14 init];
  if (v8)
  {
...
- (TRIPBInt32Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 3406, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt32Int32Dictionary;
  [(TRIPBInt32Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBInt32Int32Dictionary allocWithZone:a3];
  return [(TRIPBInt32Int32Dictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[1] = 3221225472;
  v3[2] = __52__TRIPBInt32Int32Dictionary_enumerateForTextFormat___block_invoke;
  v3[3] = &unk_1E576C198;
  v3[4] = a3;
  [(TRIPBInt32Int32Dictionary *)self enumerateKeysAndInt32sUsingBlock:v3];
}

uint64_t __52__TRIPBInt32Int32Dictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
