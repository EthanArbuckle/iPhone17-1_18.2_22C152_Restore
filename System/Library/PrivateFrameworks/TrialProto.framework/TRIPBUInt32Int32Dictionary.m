...
- (BOOL)isEqual:(id)a3;
- (TRIPBUInt32Int32Dictionary)init;
- (TRIPBUInt32Int32Dictionary)initWithCapacity:(unint64_t)a3;
- (TRIPBUInt32Int32Dictionary)initWithDictionary:(id)a3;
- (TRIPBUInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5;
...
@implementation TRIPBUInt32Int32Dictionary

- (TRIPBUInt32Int32Dictionary)init
{
  return [(TRIPBUInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}

- (TRIPBUInt32Int32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const unsigned int *)a4 count:(unint64_t)a5
{
  v14.receiver = self;
  v14.super_class = (Class)TRIPBUInt32Int32Dictionary;
  v8 = [(TRIPBUInt32Int32Dictionary *)&v14 init];
  if (v8)
  {
...
- (TRIPBUInt32Int32Dictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBUInt32Int32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 1658, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt32Int32Dictionary;
  [(TRIPBUInt32Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBUInt32Int32Dictionary allocWithZone:a3];
  return [(TRIPBUInt32Int32Dictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[1] = 3221225472;
  v3[2] = __53__TRIPBUInt32Int32Dictionary_enumerateForTextFormat___block_invoke;
  v3[3] = &unk_1E576C058;
  v3[4] = a3;
  [(TRIPBUInt32Int32Dictionary *)self enumerateKeysAndInt32sUsingBlock:v3];
}

uint64_t __53__TRIPBUInt32Int32Dictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
