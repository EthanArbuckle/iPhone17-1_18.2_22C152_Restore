...
- (BOOL)isEqual:(id)a3;
- (TRIPBInt64FloatDictionary)init;
- (TRIPBInt64FloatDictionary)initWithCapacity:(unint64_t)a3;
- (TRIPBInt64FloatDictionary)initWithDictionary:(id)a3;
- (TRIPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5;
...
@implementation TRIPBInt64FloatDictionary

- (TRIPBInt64FloatDictionary)init
{
  return [(TRIPBInt64FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}

- (TRIPBInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)TRIPBInt64FloatDictionary;
  v8 = [(TRIPBInt64FloatDictionary *)&v15 init];
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          uint64_t v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v12, [NSNumber numberWithLongLong:v13]);
          --a5;
        }
        while (a5);
      }
...
- (TRIPBInt64FloatDictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBInt64FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 7634, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt64FloatDictionary;
  [(TRIPBInt64FloatDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBInt64FloatDictionary allocWithZone:a3];
  return [(TRIPBInt64FloatDictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[1] = 3221225472;
  v3[2] = __52__TRIPBInt64FloatDictionary_enumerateForTextFormat___block_invoke;
  v3[3] = &unk_1E576C4B8;
  v3[4] = a3;
  [(TRIPBInt64FloatDictionary *)self enumerateKeysAndFloatsUsingBlock:v3];
}

uint64_t __52__TRIPBInt64FloatDictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, float a3)
{
