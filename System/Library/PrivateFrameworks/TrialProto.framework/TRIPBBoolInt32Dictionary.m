...
- (TRIPBBoolInt32Dictionary)init
{
  return [(TRIPBBoolInt32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
}
...
- (TRIPBBoolInt32Dictionary)initWithInt32s:(const int *)a3 forKeys:(const BOOL *)a4 count:(unint64_t)a5
{
  ...
  result = [(TRIPBBoolInt32Dictionary *)&v12 init];
  if (a5 && result)
  {
    do
    {
...
- (TRIPBBoolInt32Dictionary)initWithDictionary:(id)a3
{
  result = [(TRIPBBoolInt32Dictionary *)self initWithInt32s:0 forKeys:0 count:0];
  if (a3 && result)
  {
    uint64_t v5 = 0;
    char v6 = 1;
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 10289, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }
  v3.receiver = self;
  v3.super_class = (Class)TRIPBBoolInt32Dictionary;
  [(TRIPBBoolInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBBoolInt32Dictionary allocWithZone:a3];
  return [(TRIPBBoolInt32Dictionary *)v4 initWithDictionary:self];
}
...
{
  if (self->_valueSet[0]) {
    (*((void (**)(id, __CFString *, uint64_t))a3 + 2))(a3, @"false", objc_msgSend(NSString, "stringWithFormat:", @"%d", self->_values[0]));
  }
  if (self->_valueSet[1])
  {
    uint64_t v5 = objc_msgSend(NSString, "stringWithFormat:", @"%d", self->_values[1]);
