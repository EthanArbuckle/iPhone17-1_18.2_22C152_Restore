@interface TRIPBInt64DoubleDictionary
...
- (TRIPBInt64DoubleDictionary)init
{
  return [(TRIPBInt64DoubleDictionary *)self initWithDoubles:0 forKeys:0 count:0];
}
...
- (TRIPBInt64DoubleDictionary)initWithDoubles:(const double *)a3 forKeys:(const int64_t *)a4 count:(unint64_t)a5
{
  ...
  v8 = [(TRIPBInt64DoubleDictionary *)&v14 init];
  if (v8)
  {
...
- (TRIPBInt64DoubleDictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBInt64DoubleDictionary *)self initWithDoubles:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 7817, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt64DoubleDictionary;
  [(TRIPBInt64DoubleDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBInt64DoubleDictionary allocWithZone:a3];
  return [(TRIPBInt64DoubleDictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E576C4E0;
  v3[4] = a3;
  [(TRIPBInt64DoubleDictionary *)self enumerateKeysAndDoublesUsingBlock:v3];
}
