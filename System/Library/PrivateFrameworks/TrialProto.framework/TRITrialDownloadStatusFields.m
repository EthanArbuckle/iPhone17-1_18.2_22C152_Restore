...
- (int)StringAsStatus:(id)a3
{
  ...
  else if ([v3 isEqualToString:@"NO_OP"])
  {
    int v4 = 2;
  }
...
- (id)description
{
  ...
  int v4 = [(TRITrialDownloadStatusFields *)&v8 description];
  v5 = [(TRITrialDownloadStatusFields *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    self->_uint64_t status = *((_DWORD *)a3 + 2);
    *(unsigned char *)&self->_has |= 1u;
  }
}
