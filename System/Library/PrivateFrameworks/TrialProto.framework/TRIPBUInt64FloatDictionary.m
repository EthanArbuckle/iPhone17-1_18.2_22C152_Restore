...
- (BOOL)isEqual:(id)a3;
- (TRIPBUInt64FloatDictionary)init;
- (TRIPBUInt64FloatDictionary)initWithCapacity:(unint64_t)a3;
- (TRIPBUInt64FloatDictionary)initWithDictionary:(id)a3;
- (TRIPBUInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5;
...
@implementation TRIPBUInt64FloatDictionary

- (TRIPBUInt64FloatDictionary)init
{
  return [(TRIPBUInt64FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}

- (TRIPBUInt64FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const unint64_t *)a4 count:(unint64_t)a5
{
  v15.receiver = self;
  v15.super_class = (Class)TRIPBUInt64FloatDictionary;
  v8 = [(TRIPBUInt64FloatDictionary *)&v15 init];
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          uint64_t v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v12, [NSNumber numberWithUnsignedLongLong:v13]);
          --a5;
        }
        while (a5);
      }
...
- (TRIPBUInt64FloatDictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBUInt64FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 5886, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt64FloatDictionary;
  [(TRIPBUInt64FloatDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBUInt64FloatDictionary allocWithZone:a3];
  return [(TRIPBUInt64FloatDictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[1] = 3221225472;
  v3[2] = __53__TRIPBUInt64FloatDictionary_enumerateForTextFormat___block_invoke;
  v3[3] = &unk_1E576C378;
  v3[4] = a3;
  [(TRIPBUInt64FloatDictionary *)self enumerateKeysAndFloatsUsingBlock:v3];
}

uint64_t __53__TRIPBUInt64FloatDictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, float a3)
{
  uint64_t v4 = *(void *)(a1 + 32);
  uint64_t v5 = objc_msgSend(NSString, "stringWithFormat:", @"%llu", a2);
  uint64_t v6 = objc_msgSend(NSString, "stringWithFormat:", @"%.*g", 6, a3);
