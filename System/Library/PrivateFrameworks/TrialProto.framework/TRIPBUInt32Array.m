...
+ (TRIPBUInt32Array)arrayWithCapacity:(unint64_t)a3;
+ (TRIPBUInt32Array)arrayWithValue:(unsigned int)a3;
+ (TRIPBUInt32Array)arrayWithValueArray:(id)a3;
+ (id)array;
- (BOOL)isEqual:(id)a3;
- (TRIPBUInt32Array)init;
- (TRIPBUInt32Array)initWithCapacity:(unint64_t)a3;
- (TRIPBUInt32Array)initWithValueArray:(id)a3;
- (TRIPBUInt32Array)initWithValues:(const unsigned int *)a3 count:(unint64_t)a4;
...
@implementation TRIPBUInt32Array
...
{
  unsigned int v4 = a3;
  return (TRIPBUInt32Array *)(id)[objc_alloc((Class)a1) initWithValues:&v4 count:1];
}

+ (TRIPBUInt32Array)arrayWithValueArray:(id)a3
{
  v3 = (void *)[objc_alloc((Class)a1) initWithValueArray:a3];
  return (TRIPBUInt32Array *)v3;
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt32Array;
  return [(TRIPBUInt32Array *)&v3 init];
}

- (TRIPBUInt32Array)initWithValueArray:(id)a3
{
  return [(TRIPBUInt32Array *)self initWithValues:*((void *)a3 + 2) count:*((void *)a3 + 3)];
}

- (TRIPBUInt32Array)initWithValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  v6 = [(TRIPBUInt32Array *)self init];
  v7 = v6;
  if (v6 && a3 && a4)
  {
...
- (TRIPBUInt32Array)initWithCapacity:(unint64_t)a3
{
  unsigned int v4 = [(TRIPBUInt32Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (a3 && v4) {
    [(TRIPBUInt32Array *)v4 internalResizeToCapacity:a3];
  }
  return v5;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  unsigned int v4 = +[TRIPBUInt32Array allocWithZone:a3];
  values = self->_values;
  unint64_t count = self->_count;
  return [(TRIPBUInt32Array *)v4 initWithValues:values count:count];
}

- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBArray.m", 621, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }
  free(self->_values);
  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt32Array;
  [(TRIPBUInt32Array *)&v3 dealloc];
}
...
{
  unsigned int v3 = a3;
  [(TRIPBUInt32Array *)self addValues:&v3 count:1];
}
...
- (void)addValues:(const unsigned int *)a3 count:(unint64_t)a4
{
  if (a3 && a4)
  {
    ...
    if (count + a4 > self->_capacity) {
      [(TRIPBUInt32Array *)self internalResizeToCapacity:(v8 & 0xFFFFFFFFFFFFFFF0) + 16];
    }
...
- (void)removeValueAtIndex:(unint64_t)a3
{
  ...
  {
    [(TRIPBUInt32Array *)self internalResizeToCapacity:(v6 & 0xFFFFFFFFFFFFFFF0) + 16];
  }
}
...
- (void)removeAll
{
  ...
  if (self->_capacity >= 0x21) {
    [(TRIPBUInt32Array *)self internalResizeToCapacity:16];
  }
}
