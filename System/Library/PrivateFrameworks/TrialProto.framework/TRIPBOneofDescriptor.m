...
- (NSArray)fields;
- (NSString)name;
- (TRIPBOneofDescriptor)initWithName:(const char *)a3 fields:(id)a4;
- (id)fieldWithName:(id)a3;
- (id)fieldWithNumber:(unsigned int)a3;
- (void)dealloc;
@end

@implementation TRIPBOneofDescriptor

- (TRIPBOneofDescriptor)initWithName:(const char *)a3 fields:(id)a4
{
  uint64_t v21 = *MEMORY[0x1E4F143B8];
  v19.receiver = self;
  v19.super_class = (Class)TRIPBOneofDescriptor;
  v6 = [(TRIPBOneofDescriptor *)&v19 init];
  v7 = v6;
  if (v6)
  {
    v6->name_ = a3;
    ...
    long long v17 = 0u;
    long long v18 = 0u;
    uint64_t v8 = [a4 countByEnumeratingWithState:&v15 objects:v20 count:16];
    if (v8)
    {
      uint64_t v9 = v8;
      ...
      do
      {
        ...
        uint64_t v9 = [a4 countByEnumeratingWithState:&v15 objects:v20 count:16];
      }
      while (v9);
    }
    SEL v12 = SelFromStrings(0, (char *)a3, "OneOfCase", 0);
    if (v12) {
      v13 = v12;
    }
    else {
...
{
  v3.receiver = self;
  v3.super_class = (Class)TRIPBOneofDescriptor;
  [(TRIPBOneofDescriptor *)&v3 dealloc];
}

- (NSString)name
{
  return (NSString *)[NSString stringWithUTF8String:self->name_];
}
