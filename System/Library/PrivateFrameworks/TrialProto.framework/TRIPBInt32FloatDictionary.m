@interface TRIPBInt32FloatDictionary
...
- (TRIPBInt32FloatDictionary)init
{
  return [(TRIPBInt32FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
}
...
- (TRIPBInt32FloatDictionary)initWithFloats:(const float *)a3 forKeys:(const int *)a4 count:(unint64_t)a5
{
  ...
  v8 = [(TRIPBInt32FloatDictionary *)&v15 init];
  if (v8)
  {
    ...
    if (a4)
    {
      if (a3 && a5)
      {
        do
        {
          ...
          unsigned int v13 = *a4++;
          -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v12, [NSNumber numberWithInt:v13]);
          --a5;
        }
        while (a5);
      }
...
- (TRIPBInt32FloatDictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBInt32FloatDictionary *)self initWithFloats:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 4138, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBInt32FloatDictionary;
  [(TRIPBInt32FloatDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBInt32FloatDictionary allocWithZone:a3];
  return [(TRIPBInt32FloatDictionary *)v4 initWithDictionary:self];
}
...
- (void)setTRIPBGenericValue:(id *)a3 forTRIPBGenericValueKey:(id *)a4
{
  ...
  uint64_t v8 = [NSNumber numberWithInt:a4->var3];
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E576C238;
  v3[4] = a3;
  [(TRIPBInt32FloatDictionary *)self enumerateKeysAndFloatsUsingBlock:v3];
}
