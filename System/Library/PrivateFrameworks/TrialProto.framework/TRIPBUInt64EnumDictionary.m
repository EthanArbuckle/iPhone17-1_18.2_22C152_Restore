...
- (BOOL)isEqual:(id)a3;
- (TRIPBUInt64EnumDictionary)init;
- (TRIPBUInt64EnumDictionary)initWithDictionary:(id)a3;
- (TRIPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3;
- (TRIPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 capacity:(unint64_t)a4;
- (TRIPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unint64_t *)a5 count:(unint64_t)a6;
...
@implementation TRIPBUInt64EnumDictionary

- (TRIPBUInt64EnumDictionary)init
{
  return [(TRIPBUInt64EnumDictionary *)self initWithValidationFunction:0 rawValues:0 forKeys:0 count:0];
}

- (TRIPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3
{
  return [(TRIPBUInt64EnumDictionary *)self initWithValidationFunction:a3 rawValues:0 forKeys:0 count:0];
}

- (TRIPBUInt64EnumDictionary)initWithValidationFunction:(void *)a3 rawValues:(const int *)a4 forKeys:(const unint64_t *)a5 count:(unint64_t)a6
{
  v18.receiver = self;
  v18.super_class = (Class)TRIPBUInt64EnumDictionary;
  v10 = [(TRIPBUInt64EnumDictionary *)&v18 init];
  if (v10)
  {
    ...
    if (a5 && a4 && a6)
    {
      do
      {
        ...
        uint64_t v16 = *a5++;
        -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v15, [NSNumber numberWithUnsignedLongLong:v16]);
        --a6;
      }
      while (a6);
    }
...
- (TRIPBUInt64EnumDictionary)initWithDictionary:(id)a3
{
  v4 = -[TRIPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", [a3 validationFunc], 0, 0, 0);
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 6265, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBUInt64EnumDictionary;
  [(TRIPBUInt64EnumDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBUInt64EnumDictionary allocWithZone:a3];
  return [(TRIPBUInt64EnumDictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateKeysAndRawValuesUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, [v6 unsignedLongLongValue], objc_msgSend((id)-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "intValue"), &v7);
  }
  while (!v7);
}
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        uint64_t v13 = ComputeDictUInt64FieldSize([v10 unsignedLongLongValue], 1, v7);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      uint64_t v16 = [v13 unsignedLongLongValue];
      uint64_t v17 = [v15 intValue];
      int v18 = ComputeDictUInt64FieldSize(v16, 1, v8);
      objc_msgSend(a3, "writeInt32NoTag:", ComputeDictEnumFieldSize(v17, v7) + v18);
      WriteDictUInt64Field(a3, v16, 1, v8);
...
- (id)serializedDataForUnknownValue:(int)a3 forKey:(id *)a4 keyDataType:(unsigned __int8)a5
{
  unsigned int v5 = a5;
  uint64_t v7 = *(void *)&a3;
  uint64_t v8 = ComputeDictUInt64FieldSize(a4->var2, 1, a5);
  uint64_t v9 = 2;
  uint64_t v10 = 3;
  uint64_t v11 = 4;
  uint64_t v12 = 5;
  ...
  WriteDictUInt64Field(v14, a4->var2, 1, v5);
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[1] = 3221225472;
  v3[2] = __52__TRIPBUInt64EnumDictionary_enumerateForTextFormat___block_invoke;
  v3[3] = &unk_1E576C2D8;
  v3[4] = a3;
  [(TRIPBUInt64EnumDictionary *)self enumerateKeysAndRawValuesUsingBlock:v3];
}

uint64_t __52__TRIPBUInt64EnumDictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
- (BOOL)getEnum:(int *)a3 forKey:(unint64_t)a4
{
  uint64_t v6 = (void *)-[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", [NSNumber numberWithUnsignedLongLong:a4]);
  uint64_t v7 = v6;
  if (a3 && v6)
  {
    int v8 = [v6 intValue];
...
- (BOOL)getRawValue:(int *)a3 forKey:(unint64_t)a4
{
  uint64_t v5 = (void *)-[NSMutableDictionary objectForKey:](self->_dictionary, "objectForKey:", [NSNumber numberWithUnsignedLongLong:a4]);
  uint64_t v6 = v5;
  if (a3 && v5) {
    *a3 = [v5 intValue];
  }
...
- (void)enumerateKeysAndEnumsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*((void (**)(id, uint64_t, uint64_t, char *))a3 + 2))(a3, [v8 unsignedLongLongValue], v9, &v10);
  }
  while (!v10);
}
...
- (void)setRawValue:(int)a3 forKey:(unint64_t)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v7, [NSNumber numberWithUnsignedLongLong:a4]);
  autocreator = self->_autocreator;
  if (autocreator)
  {
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
...
- (void)setEnum:(int)a3 forKey:(unint64_t)a4
{
  ...
  if ((((uint64_t (*)(void, SEL))self->_validationFunc)(*(void *)&a3, a2) & 1) == 0) {
    objc_msgSend(MEMORY[0x1E4F1CA00], "raise:format:", *MEMORY[0x1E4F1C3C8], @"TRIPBUInt64EnumDictionary: Attempt to set an unknown enum value (%d)", v5);
  }
  dictionary = self->_dictionary;
  uint64_t v8 = [NSNumber numberWithInt:v5];
  -[NSMutableDictionary setObject:forKey:](dictionary, "setObject:forKey:", v8, [NSNumber numberWithUnsignedLongLong:a4]);
  autocreator = self->_autocreator;
  if (autocreator)
  {
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
