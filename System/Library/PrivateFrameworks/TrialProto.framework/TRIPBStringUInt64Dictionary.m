...
- (TRIPBStringUInt64Dictionary)init
{
  return [(TRIPBStringUInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
}
...
- (TRIPBStringUInt64Dictionary)initWithUInt64s:(const unint64_t *)a3 forKeys:(id *)a4 count:(unint64_t)a5
{
  ...
  v8 = [(TRIPBStringUInt64Dictionary *)&v15 init];
  if (v8)
  {
...
- (TRIPBStringUInt64Dictionary)initWithDictionary:(id)a3
{
  v4 = [(TRIPBStringUInt64Dictionary *)self initWithUInt64s:0 forKeys:0 count:0];
  v5 = v4;
  if (a3 && v4) {
...
- (void)dealloc
{
  if (self->_autocreator) {
    objc_msgSend((id)objc_msgSend(MEMORY[0x1E4F28B00], "currentHandler"), "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"TRIPBDictionary.m", 8853, @"%@: Autocreator must be cleared before release, autocreator: %@", objc_opt_class(), self->_autocreator);
  }

  v3.receiver = self;
  v3.super_class = (Class)TRIPBStringUInt64Dictionary;
  [(TRIPBStringUInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[TRIPBStringUInt64Dictionary allocWithZone:a3];
  return [(TRIPBStringUInt64Dictionary *)v4 initWithDictionary:self];
}
...
- (void)enumerateForTextFormat:(id)a3
{
  ...
  v3[3] = &unk_1E576C580;
  v3[4] = a3;
  [(TRIPBStringUInt64Dictionary *)self enumerateKeysAndUInt64sUsingBlock:v3];
}

uint64_t __54__TRIPBStringUInt64Dictionary_enumerateForTextFormat___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  uint64_t v4 = *(void *)(a1 + 32);
  uint64_t v5 = objc_msgSend(NSString, "stringWithFormat:", @"%llu", a3);
...
- (void)setUInt64:(unint64_t)a3 forKey:(id)a4
{
  ...
  -[NSMutableDictionary setObject:forKey:](self->_dictionary, "setObject:forKey:", [NSNumber numberWithUnsignedLongLong:a3], a4);
  autocreator = self->_autocreator;
  if (autocreator)
  {
    TRIPBAutocreatedDictionaryModified(autocreator, (uint64_t)self);
