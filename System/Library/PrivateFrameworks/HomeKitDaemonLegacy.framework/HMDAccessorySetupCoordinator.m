...
- (NSUUID)messageTargetUUID
{
  return (NSUUID *)[MEMORY[0x1E4F2E630] UUID];
}

- (id)logIdentifier
{
  v2 = [MEMORY[0x1E4F2E630] UUID];
  v3 = [v2 UUIDString];
...
- (void)_handleStagedPairingServer:(id)a3 error:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v99 = 2112;
    v100 = v20;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Handling staged pairing identifier %@ and error %@ for request UUID: %@", buf, 0x2Au);
  }
  v85 = v15;
  if (!v15
        ...
        v21))
  {
    ...
    if (v22)
    {
      ...
      v27 = (void **)MEMORY[0x1E4F6A050];
      if (v26)
      {
        HMFGetLogIdentifier();
        v28 = v83 = v23;
        v29 = (__CFString *)*MEMORY[0x1E4F6A068];
        id v30 = v12;
        v31 = v11;
        v32 = *v27;
        v33 = [v10 productID];
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v101 = 2112;
        v102 = v33;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\"", buf, 0x34u);
      ...
      v34 = [MEMORY[0x1E4F6A2A0] sharedInstance];
      id v35 = objc_alloc(MEMORY[0x1E4F6A2B0]);
      v36 = [v10 productID];
      if (v36)
      {
        uint64_t v91 = *MEMORY[0x1E4F6A050];
        v25 = [v10 productID];
        v92 = v25;
        v37 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v92 forKeys:&v91 count:1];
      }
      else
      {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v97 = 2112;
        v98 = v56;
        _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_INFO, "%{public}@Successfully staged CHIP accessory server with identifier %@ in multiple steps for request UUID: %@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v97 = 2112;
      v98 = v59;
      _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage CHIP accessory pairing for request UUID %@: %@", buf, 0x20u);
    }
    ...
    if (!v65)
    {
      if (v69)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v97 = 2112;
        v98 = v80;
        _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_INFO, "%{public}@Queueing staging error %@ for request UUID: %@", buf, 0x20u);
      }
      if (v59)
      {
        [v12 setError:v59];
      ...
      {
        v82 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
        [v12 setError:v82];
      }
      v15 = v85;
      goto LABEL_40;
    ...
    if (v69)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v97 = 2112;
      v98 = v59;
      _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_INFO, "%{public}@Responding for request UUID %@ with error: %@", buf, 0x20u);
    }
    ...
    v74 = v73;
    if (v73 == (void *)*MEMORY[0x1E4F2D140])
    {
...
LABEL_40:
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v95 = 2112;
    v96 = v42;
    _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received staged pairing identifier for request UUID: %@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
  {
    ...
    v47 = (__CFString *)*MEMORY[0x1E4F6A070];
    *(_DWORD *)buf = 138543874;
    v94 = v46;
    __int16 v95 = 2114;
    v96 = v47;
    ...
    _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\"", buf, 0x20u);
  }
  else
  {
    v47 = (__CFString *)*MEMORY[0x1E4F6A070];
  ...
  v75 = [MEMORY[0x1E4F6A2A0] sharedInstance];
  id v76 = objc_alloc(MEMORY[0x1E4F6A2B0]);
  v77 = (void *)[v76 initWithTag:v47 data:MEMORY[0x1E4F1CC08]];
    ...
    if (v7)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v60 = 2112;
        v61 = v14;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Passing back pairing UUID %@ for staged pairing identifier: %@", buf, 0x20u);
      }
      v15 = [a1[5] pendingRequestMessage];
      v66[0] = *MEMORY[0x1E4F2C6A8];
      v16 = [a1[5] UUID];
      uint64_t v17 = *MEMORY[0x1E4F2C660];
      id v18 = a1[7];
      v67[0] = v16;
      v67[1] = v18;
      uint64_t v19 = *MEMORY[0x1E4F2C678];
      v66[1] = v17;
      v66[2] = v19;
      v20 = [v7 uuid];
      v67[2] = v20;
      unint64_t v21 = 0x1E4F1C000uLL;
      v22 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v67 forKeys:v66 count:3];
      ...
      v25 = HMFGetOSLogHandle();
      BOOL v26 = os_log_type_enabled(v25, OS_LOG_TYPE_INFO);
      v27 = (uint64_t *)MEMORY[0x1E4F6A018];
      if (v26)
      {
        HMFGetLogIdentifier();
        v28 = v51 = v23;
        v29 = (void *)*MEMORY[0x1E4F6A010];
        id v30 = v27;
        v31 = v5;
        v32 = v7;
        id v33 = v6;
      ...
      v44 = [MEMORY[0x1E4F6A2A0] sharedInstance];
      id v46 = objc_alloc(MEMORY[0x1E4F6A2B0]);
      v47 = [a1[8] softwareVersionString];
      if (v47)
      {
        uint64_t v54 = *MEMORY[0x1E4F6A018];
        v25 = [a1[8] softwareVersionString];
        v55 = v25;
        v48 = [*(id *)(v21 + 2536) dictionaryWithObjects:&v55 forKeys:&v54 count:1];
      }
      else
      {
        v48 = (void *)MEMORY[0x1E4F1CC08];
      }
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v60 = 2112;
        v61 = v5;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not find system commissioner pairing for newly staged server with identifier %@ in all pairings: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v58 = 2112;
      id v59 = v6;
      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@System commissioner failed to fetch pairings: %@", buf, 0x16u);
    }
    v40 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:0 reason:0 suggestion:0 underlyingError:v6];
...
- (void)_handleStagedPairingProgressState:(int64_t)a3 forRequest:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v29 = 2112;
    id v30 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling progress state (%ld) for request UUID: %@", buf, 0x20u);
  }
  if ((unint64_t)(a3 - 1) > 0x25) {
    uint64_t v13 = 15;
  }
  else {
    uint64_t v13 = qword_1D54D3988[a3 - 1];
  }
  v14 = [NSNumber numberWithInteger:v13];
  v15 = objc_msgSend(v6, "UUID", *MEMORY[0x1E4F2C6A8]);
  v23[1] = *MEMORY[0x1E4F2C688];
  v24[0] = v15;
  v24[1] = v14;
  v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v24 forKeys:v23 count:2];

  uint64_t v17 = [MEMORY[0x1E4F654B0] entitledMessageWithName:*MEMORY[0x1E4F2C6F0] messagePayload:v16];
...
- (void)_handleStagedPairingReadyToCancel:(id)a3 forRequest:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    int64_t v28 = v13;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Handling ready to cancel for request UUID: %@", (uint8_t *)&v25, 0x16u);
  }
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      int v25 = 138543362;
      BOOL v26 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to a pending Cancel message", (uint8_t *)&v25, 0xCu);
    }
    ...
    if (v20)
    {
      ...
      v22 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (void)_handleStagedPairingThreadNetworkScanResults:(id)a3 completionHandler:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v54 = 2112;
    v55 = v19;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling Thread scan results %@ for request UUID: %@", buf, 0x20u);
  }
...
LABEL_6:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v52 = 2112;
      id v53 = v26;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received Thread scan results for request UUID: %@", buf, 0x16u);
    }
    uint64_t v27 = v11[2](v11, 0);
    int64_t v28 = (void *)MEMORY[0x1D9452090](v27);
    uint64_t v29 = v23;
    id v30 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      uint64_t v31 = HMFGetLogIdentifier();
      v32 = (void *)*MEMORY[0x1E4F6A070];
      *(_DWORD *)buf = 138543874;
      v51 = v31;
      __int16 v52 = 2114;
      id v53 = v32;
      ...
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\"", buf, 0x20u);
    }
    else
    {
      v32 = (void *)*MEMORY[0x1E4F6A070];
    ...
    id v33 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v34 = objc_alloc(MEMORY[0x1E4F6A2B0]);
    id v35 = (void *)[v34 initWithTag:v32 data:MEMORY[0x1E4F1CC08]];
  ...
  if (v10)
  {
    id v37 = objc_msgSend(v12, "UUID", *MEMORY[0x1E4F2C6A8]);
    v49[0] = v37;
    v48[1] = *MEMORY[0x1E4F2C6B8];
    v38 = encodeRootObject();
    v49[1] = v38;
    id v33 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v49 forKeys:v48 count:2];
  }
  else
  {
    id v33 = (void *)MEMORY[0x1E4F1CC08];
  }
  ...
  v41 = (void *)MEMORY[0x1D9452090]([v12 setPendingRequestMessage:0]);
  v42 = v16;
  id v43 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
  {
    v44 = HMFGetLogIdentifier();
    v45 = (void *)*MEMORY[0x1E4F6A090];
    *(_DWORD *)buf = 138543874;
    v51 = v44;
    __int16 v52 = 2114;
    id v53 = v45;
    ...
    _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\"", buf, 0x20u);
  }
  else
  {
    v45 = (void *)*MEMORY[0x1E4F6A090];
  ...
  id v46 = objc_alloc(MEMORY[0x1E4F6A2B0]);
  v36 = (void *)[v46 initWithTag:v45 data:MEMORY[0x1E4F1CC08]];
...
- (void)_handleStagedPairingWiFiNetworkScanResults:(id)a3 completionHandler:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v41 = 2112;
    v42 = v19;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling WiFi scan results %@ for request UUID: %@", buf, 0x20u);
  }
  v20 = [v12 selectWiFiNetworkHandler];
  if (v20)
  {
  ...
  else
  {
    ...
    if (!v21)
    {
      if (v10)
      {
        v35[0] = *MEMORY[0x1E4F2C6A8];
        uint64_t v27 = [v12 UUID];
        v36[0] = v27;
        v35[1] = *MEMORY[0x1E4F2C6C8];
      ...
      {
        uint64_t v27 = objc_msgSend(v12, "UUID", *MEMORY[0x1E4F2C6A8]);
        id v34 = v27;
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2112;
    id v40 = v26;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received WiFi scan results for request UUID: %@", buf, 0x16u);
  }
  v11[2](v11, 0);
LABEL_9:
}
...
- (void)_handleStagedPairingDeviceCredential:(id)a3 completionHandler:(id)a4 forRequest:(id)a5 activity:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v40 = 2112;
    __int16 v41 = v19;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling device credential %@ for request UUID: %@", buf, 0x20u);
  }
  v20 = objc_msgSend(v12, "UUID", *MEMORY[0x1E4F2C6A8]);
  v35[0] = v20;
  v34[1] = *MEMORY[0x1E4F2C670];
  unint64_t v21 = encodeRootObject();
  v35[1] = v21;
  v22 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v35 forKeys:v34 count:2];
  ...
  if (v23)
  {
    ...
    int v25 = (void *)MEMORY[0x1D9452090]([v12 setPendingRequestMessage:0]);
    BOOL v26 = v16;
    uint64_t v27 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      int64_t v28 = HMFGetLogIdentifier();
      uint64_t v29 = (void *)*MEMORY[0x1E4F6A040];
      *(_DWORD *)buf = 138543874;
      id v37 = v28;
      __int16 v38 = 2114;
      id v39 = v29;
      ...
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\"", buf, 0x20u);
    }
    else
    {
      uint64_t v29 = (void *)*MEMORY[0x1E4F6A040];
    ...
    id v30 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v31 = objc_alloc(MEMORY[0x1E4F6A2B0]);
    v32 = (void *)[v31 initWithTag:v29 data:MEMORY[0x1E4F1CC08]];
...
- (id)_setupPayloadWithCHIPSetupPayload:(id)a3 setupPayloadURL:(id)a4
{
  ...
  v8 = v7;
  id v9 = objc_alloc(MEMORY[0x1E4F2E9B0]);
  id v10 = [v6 setupCode];
  id v11 = [v10 stringValue];
  id v12 = (void *)[v9 initWithSetupCode:v11 communicationProtocol:2];

  id v13 = (void *)[objc_alloc(MEMORY[0x1E4F2E6A0]) initWithCHIPSetupPayload:v6];
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    __int16 v38 = v12;
    _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Created CHIP setup accessory payload: %@", buf, 0x16u);
  }
...
- (id)_createCHIPSetupAccessoryPayloadWithSetupPayloadDecimalStringRepresentation:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from decimal string representation: %@", (uint8_t *)&v17, 0x16u);
    }
    if (a4)
    {
...
- (void)handleCancelStagedCHIPAccessoryPairingMessage:(id)a3
{
  ...
  id v6 = [v4 stringForKey:*MEMORY[0x1E4F2C660]];
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Discarding staged accessory server with identifier: %@", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v14;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory pairing identifier in message payload: %@", buf, 0x16u);
    }
...
void __78__HMDAccessorySetupCoordinator_handleCancelStagedCHIPAccessoryPairingMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to discard staged accessory server: %@", (uint8_t *)&v10, 0x16u);
    }
    v8 = *(void **)(a1 + 40);
...
- (void)handleCreateCHIPSetupPayloadMessage:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v8)
    {
      ...
      char v10 = [v9 isEqualToString:*MEMORY[0x1E4F2D1C8]];
              ...
              (v14 & 1) == 0))
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v59 = v18;
            _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting metrics collection for 3rd party pairing via locker", buf, 0xCu);
          }
          ...
          id v24 = (uint64_t *)MEMORY[0x1E4F6A028];
          if (v23)
          {
            HMFGetLogIdentifier();
            v25 = id v53 = v20;
            BOOL v26 = (void *)*MEMORY[0x1E4F6A068];
            uint64_t v27 = *v24;
            ...
            *(_DWORD *)buf = 138544386;
            ...
            __int16 v66 = 2112;
            v67 = v28;
            _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\"", buf, 0x34u);
          ...
          {
            uint64_t v29 = (void *)*MEMORY[0x1E4F6A068];
          }

          __int16 v40 = [MEMORY[0x1E4F6A2A0] sharedInstance];
          id v41 = objc_alloc(MEMORY[0x1E4F6A2B0]);
          uint64_t v42 = [(HMDAccessorySetupCoordinator *)v21 currentBundleIdentifier];
          if (v42)
          {
            uint64_t v56 = *MEMORY[0x1E4F6A028];
          ...
          {
            uint64_t v43 = (void *)MEMORY[0x1E4F1CC08];
          }
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v60 = 2112;
        v61 = v8;
        _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_INFO, "%{public}@Opening pairing window with PIN on CHIP accessory server: %@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v60 = 2112;
        v61 = v6;
        _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory server with identifier: %@", buf, 0x16u);
      }
      uint64_t v39 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v60 = 2112;
      v61 = v34;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory pairing identifier in message payload: %@", buf, 0x16u);
    }
    v8 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
void __68__HMDAccessorySetupCoordinator_handleCreateCHIPSetupPayloadMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    uint64_t v13 = *MEMORY[0x1E4F2C690];
    id v14 = v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to open pairing window with PIN: %@", buf, 0x16u);
    }
...
- (void)handleCancelStagingMessage:(id)a3
{
  ...
  id v6 = [v4 uuidForKey:*MEMORY[0x1E4F2C6A8]];
  id v7 = (void *)MEMORY[0x1D9452090]();
  v8 = self;
  id v9 = HMFGetOSLogHandle();
  char v10 = v9;
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v39 = 2112;
      __int16 v40 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling cancel staging message with staging request UUID: %@", (uint8_t *)&v37, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v39 = 2112;
          __int16 v40 = v19;
          _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to cancel staging message with success in presence of queued pairing error: %@", (uint8_t *)&v37, 0x16u);
        }
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            __int16 v39 = 2112;
            __int16 v40 = v6;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Staging request UUID: %@ is not ready to cancel yet", (uint8_t *)&v37, 0x16u);
          }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v39 = 2112;
        __int16 v40 = v6;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for cancel staging message with staging request UUID: %@", (uint8_t *)&v37, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v39 = 2112;
      __int16 v40 = v22;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in cancel staging message payload: %@", (uint8_t *)&v37, 0x16u);
    }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling select wifi network message for request UUID: %@", buf, 0x16u);
    }
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        v47 = v6;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for select wifi network message with staging request UUID: %@", buf, 0x16u);
      }
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        v47 = v21;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Responding to select wifi network message with queued pairing error: %@", buf, 0x16u);
      }
...
LABEL_25:
    ...
    _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, v41, buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v46 = 2112;
    v47 = v28;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in select-wifi-network message payload: %@", buf, 0x16u);
  }
...
- (void)handleSelectThreadNetworkAssociationMessage:(id)a3
{
  ...
  if (v6)
  {
    uint64_t v7 = *MEMORY[0x1E4F2C6B0];
    uint64_t v43 = objc_opt_class();
    v8 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v43 count:1];
    id v9 = [v4 unarchivedObjectForKey:v7 ofClasses:v8];
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling select Thread network message for request UUID: %@", buf, 0x16u);
    }
    id v14 = [(HMDAccessorySetupCoordinator *)v11 stagingRequestsByUUID];
    v15 = [v14 objectForKeyedSubscript:v6];
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        v47 = v6;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for select Thread network message with staging request UUID: %@", buf, 0x16u);
      }
      uint64_t v33 = (void *)MEMORY[0x1E4F28C58];
      uint64_t v34 = 2;
      goto LABEL_23;
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        v47 = v21;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Responding to select Thread network message with queued pairing error: %@", buf, 0x16u);
      }
      uint64_t v22 = [v15 error];
      [v4 respondWithError:v22];
...
LABEL_25:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v46 = 2112;
    v47 = v28;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in select-thread-network message payload: %@", buf, 0x16u);
  }
  id v9 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
  [v4 respondWithError:v9];
LABEL_26:
...
- (void)handleRejectDeviceCredentialMessage:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v45 = 2112;
      __int16 v46 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling reject device credential message with staging request UUID: %@", (uint8_t *)&v43, 0x16u);
    }
    __int16 v12 = [(HMDAccessorySetupCoordinator *)v8 stagingRequestsByUUID];
    uint64_t v13 = [v12 objectForKeyedSubscript:v6];
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v45 = 2112;
          __int16 v46 = v19;
          _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to reject device credential message with queued pairing error: %@", (uint8_t *)&v43, 0x16u);
        }
...
LABEL_22:
        ...
        uint64_t v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
...
LABEL_21:
          _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, v35, (uint8_t *)&v43, 0x16u);
      ...
      int v37 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v45 = 2112;
        __int16 v46 = v6;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for reject device credential message with staging request UUID: %@", (uint8_t *)&v43, 0x16u);
      }
      int64_t v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v45 = 2112;
      __int16 v46 = v23;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in reject device credential message payload: %@", (uint8_t *)&v43, 0x16u);
    }
    uint64_t v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    [v4 respondWithError:v13];
  }
...
- (void)handleConfirmDeviceCredentialMessage:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v42 = 2112;
      int v43 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling confirm device credential message with staging request UUID: %@", (uint8_t *)&v40, 0x16u);
    }
    __int16 v12 = [(HMDAccessorySetupCoordinator *)v8 stagingRequestsByUUID];
    uint64_t v13 = [v12 objectForKeyedSubscript:v6];
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v42 = 2112;
          int v43 = v19;
          _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to confirm device credential message with queued pairing error: %@", (uint8_t *)&v40, 0x16u);
        }
        __int16 v20 = [v13 error];
        [v4 respondWithError:v20];
...
LABEL_9:
      ...
      if (!v29)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v42 = 2112;
          int v43 = v6;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@No pending confirm device credential completion handler exists for staging request UUID: %@", (uint8_t *)&v40, 0x16u);
        }
        uint64_t v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
        [v4 respondWithError:v21];
        goto LABEL_9;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v42 = 2112;
        int v43 = v6;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for confirm device credential message with staging request UUID: %@", (uint8_t *)&v40, 0x16u);
      }
      int64_t v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
      [v4 respondWithError:v28];
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v42 = 2112;
      int v43 = v23;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in confirm device credential message payload: %@", (uint8_t *)&v40, 0x16u);
    }
    uint64_t v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    [v4 respondWithError:v13];
  }
...
- (void)handleStageCHIPAccessoryPairingInStepsMessage:(id)a3
{
  ...
  uint64_t v7 = *MEMORY[0x1E4F2C680];
  v145[0] = objc_opt_class();
  v8 = [MEMORY[0x1E4F1C978] arrayWithObjects:v145 count:1];
  id v9 = [v4 unarchivedObjectForKey:v7 ofClasses:v8];

  if (v9)
  {
    char v85 = [v4 BOOLForKey:*MEMORY[0x1E4F2C6A0]];
    ...
    int v25 = (void **)MEMORY[0x1E4F6A068];
    BOOL v26 = (uint64_t *)MEMORY[0x1E4F6A038];
    unint64_t v27 = 0x1E4F28000uLL;
    int64_t v28 = (uint64_t *)MEMORY[0x1E4F6A030];
    if (v24)
    {
      ...
      uint64_t v89 = *v28;
      uint64_t v30 = *MEMORY[0x1E4F6A058];
      uint64_t v31 = *MEMORY[0x1E4F6A028];
      v83 = [(HMDAccessorySetupCoordinator *)v22 currentBundleIdentifier];
      uint64_t v32 = *MEMORY[0x1E4F6A060];
      ...
      *(_DWORD *)buf = 138546434;
      ...
      __int16 v143 = 2112;
      v144 = v33;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x84u);
    ...
    {
      uint64_t v90 = *MEMORY[0x1E4F6A060];
      uint64_t v95 = *MEMORY[0x1E4F6A058];
      uint64_t v93 = *MEMORY[0x1E4F6A028];
      uint64_t v34 = v98;
    }
    ...
    int v37 = *v25;
    uint64_t v38 = *v26;
    uint64_t v39 = objc_msgSend(*(id *)(v27 + 3792), "numberWithInteger:", objc_msgSend(v9, "communicationProtocol"));
    v102 = v9;
    uint64_t v40 = *MEMORY[0x1E4F6A030];
    [(HMDAccessorySetupCoordinator *)v22 currentBundleIdentifier];
    v41 = id v87 = v22;
    __int16 v42 = objc_msgSend(*(id *)(v27 + 3792), "numberWithBool:", objc_msgSend(v102, "requiresMatterCustomCommissioningFlow"));
    id v18 = v99;
    uint64_t v79 = v38;
    ...
    if (v46)
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138545410;
        ...
        __int16 v135 = 2112;
        v136 = v55;
        _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x5Cu);

        uint64_t v48 = v84;
      }
      else
      {
        uint64_t v91 = *MEMORY[0x1E4F6A098];
        uint64_t v88 = *MEMORY[0x1E4F6A088];
        uint64_t v54 = *MEMORY[0x1E4F6A048];
      }

      __int16 v60 = [MEMORY[0x1E4F6A2A0] sharedInstance];
      id v61 = objc_alloc(MEMORY[0x1E4F6A2B0]);
      ...
      BOOL v69 = [MEMORY[0x1E4F1CA48] array];
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v123 = 2112;
        v124 = v76;
        _os_log_impl(&dword_1D49D5000, v74, OS_LOG_TYPE_INFO, "%{public}@Handling stage CHIP accessory pairing in steps message with setup payload: %@, request UUID: %@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v121 = 2112;
        v122 = v102;
        _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory setup payload on setup accessory payload: %@", buf, 0x16u);

        id v9 = v102;
      }

      uint64_t v47 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v121 = 2112;
      v122 = v17;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Could not find setup accessory payload in message payload: %@", buf, 0x16u);
...
- (void)handleCreateCHIPSetupAccessoryPayloadMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v32 = 2112;
    uint64_t v33 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling create CHIP setup accessory payload message payload: %@", buf, 0x16u);
  }
  id v11 = [v4 URLForKey:*MEMORY[0x1E4F2C698]];
  uint64_t v12 = [v4 stringForKey:*MEMORY[0x1E4F2C668]];
  id v13 = (void *)v12;
  if (v11)
  {
    uint64_t v27 = 0;
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        uint64_t v33 = v25;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Could not find any setup information in message payload: %@", buf, 0x16u);
      }
...
LABEL_12:
  ...
  uint64_t v28 = *MEMORY[0x1E4F2C680];
  id v18 = (void *)[v16 copy];
  uint64_t v19 = encodeRootObjectForIncomingXPCMessage(v18, 0);
  uint64_t v29 = v19;
  __int16 v20 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v29 forKeys:&v28 count:1];
...
- (void)stopMetricsForThirdPartyPairingWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Stop metrics for 3rd party pairing, error:%@", (uint8_t *)&v22, 0x16u);
  }
  ...
  if (v10)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        id v16 = (void *)*MEMORY[0x1E4F6A080];
        int v22 = 138543874;
        BOOL v23 = v15;
        __int16 v24 = 2114;
        id v25 = v16;
        __int16 v26 = 2112;
        uint64_t v27 = @"Stop";
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\"", (uint8_t *)&v22, 0x20u);
      }
      else
      {
        id v16 = (void *)*MEMORY[0x1E4F6A080];
      ...
      id v11 = [MEMORY[0x1E4F6A2A0] sharedInstance];
      id v17 = objc_alloc(MEMORY[0x1E4F6A2B0]);
      id v18 = (void *)[v17 initWithTag:v16 data:MEMORY[0x1E4F1CC08]];
...
- (void)startMetricsForThirdPartyPairing
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v23 = 138543362;
    __int16 v24 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Start metrics for 3rd party pairing", (uint8_t *)&v23, 0xCu);
  }
  ...
  uint64_t v12 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"CHIP Third Party Pairing"];
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    uint64_t v17 = *MEMORY[0x1E4F6A078];
    int v23 = 138543874;
    __int16 v24 = v16;
    __int16 v25 = 2114;
    uint64_t v26 = v17;
    __int16 v27 = 2112;
    uint64_t v28 = @"Start";
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\"", (uint8_t *)&v23, 0x20u);
  }
  else
  {
    uint64_t v17 = *MEMORY[0x1E4F6A078];
  ...
  id v18 = [MEMORY[0x1E4F6A2A0] sharedInstance];
  id v19 = objc_alloc(MEMORY[0x1E4F6A2B0]);
  __int16 v20 = (void *)[v19 initWithTag:v17 data:MEMORY[0x1E4F1CC08]];
...
- (id)createSetupAccessoryPayloadWithCHIPSetupPayload:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v7;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload %@", (uint8_t *)&v17, 0x16u);
    }
    if (a4)
    {
      [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
...
- (id)createCHIPSetupAccessoryPayloadWithSetupPayloadURL:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      int v22 = v10;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload URL string: %@", (uint8_t *)&v19, 0x16u);
    }
    if (a4)
    {
      [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
...
- (void)configure
{
  ...
  uint64_t v5 = *MEMORY[0x1E4F2C650];
  v39[0] = v3;
  id v6 = [MEMORY[0x1E4F1C978] arrayWithObjects:v39 count:1];
  ...
  uint64_t v8 = *MEMORY[0x1E4F2C6E8];
  uint64_t v38 = v3;
  ...
  uint64_t v11 = *MEMORY[0x1E4F2C648];
  int v37 = v3;
  uint64_t v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v37 count:1];
  ...
  uint64_t v14 = *MEMORY[0x1E4F2C6D0];
  id v36 = v3;
  ...
  uint64_t v17 = *MEMORY[0x1E4F2C6D8];
  id v35 = v3;
  id v18 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v35 count:1];
  ...
  uint64_t v20 = *MEMORY[0x1E4F2C6E0];
  uint64_t v34 = v3;
  __int16 v21 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v34 count:1];
  ...
  uint64_t v23 = *MEMORY[0x1E4F2C640];
  uint64_t v33 = v3;
  __int16 v24 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v33 count:1];
  ...
  uint64_t v26 = *MEMORY[0x1E4F2C658];
  __int16 v32 = v3;
  ...
  uint64_t v29 = *MEMORY[0x1E4F2C638];
  uint64_t v31 = v3;
  uint64_t v30 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v31 count:1];
...
LABEL_11:
  ...
  if (v16)
  {
    ...
    v17->_id urlStringCHIPAccessorySetupPayloadFactory = &__block_literal_global_148557;
    ...
    v17->_id decimalStringRepresentationCHIPAccessorySetupPayloadFactory = &__block_literal_global_67_148558;

    id payloadCHIPAccessorySetupPayloadFactory = v17->_payloadCHIPAccessorySetupPayloadFactory;
    v17->_id payloadCHIPAccessorySetupPayloadFactory = &__block_literal_global_70_148559;
  }
  return v17;
}
...
{
  v2 = (objc_class *)MEMORY[0x1E4F6A0C8];
  id v3 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t75 != -1) {
    dispatch_once(&logCategory__hmf_once_t75, &__block_literal_global_182_148578);
  }
  v2 = (void *)logCategory__hmf_once_v76;
  return v2;
}

uint64_t __43__HMDAccessorySetupCoordinator_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v76;
  logCategory__hmf_once_id v76 = v0;
