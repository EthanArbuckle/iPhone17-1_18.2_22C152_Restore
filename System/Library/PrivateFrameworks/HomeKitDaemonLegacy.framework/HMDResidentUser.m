...
LABEL_14:
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, v17, buf, 0x16u);
      }
    }
    else
    {
    ...
    if (!v19)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v29 = v24;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Missing expected userID", buf, 0xCu);
      }
        ...
        else
        {
          ...
          if (v29 == 2)
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v39 = v33;
              _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Disabling", buf, 0xCu);
            }
  ...
  if (v4)
  {
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        id v23 = v4;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating the device: %@", (uint8_t *)&v20, 0x16u);
      }
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        id v23 = v4;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating the device: %@", (uint8_t *)&v20, 0x16u);
      }
...
- (void)configureWithHome:(id)a3
{
    ...
    && [(HMDResidentUser *)self configurationState] == 2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v11 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Disabling as we are blocked", buf, 0xCu);
    }
