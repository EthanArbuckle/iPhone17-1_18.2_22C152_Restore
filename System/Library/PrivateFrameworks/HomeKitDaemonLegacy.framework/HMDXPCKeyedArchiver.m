...
- (id)initForWritingWithMessage:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [objc_alloc(MEMORY[0x1E4F28DB0]) initRequiringSecureCoding:1];
    archiver = v5->_archiver;
    v5->_archiver = (NSKeyedArchiver *)v6;

    objc_setAssociatedObject(v5->_archiver, @"kXPCTransportTypeAssociationKey", MEMORY[0x1E4F1CC38], (void *)0x301);
    if (v4) {
...
- (void)_configure
{
  ...
  objc_super v4 = [(HMDXPCKeyedArchiver *)self archiver];
  ...
  objc_super v9 = [(HMDXPCKeyedArchiver *)self archiver];
  ...
  [v40 setClassName:@"HMAsset" forClass:objc_opt_class()];

  v41 = [(HMDXPCKeyedArchiver *)self archiver];
  [v41 setClassName:@"_HMAccessoryProfile" forClass:objc_opt_class()];

  v42 = [(HMDXPCKeyedArchiver *)self archiver];
  [v42 setClassName:@"_HMCameraProfile" forClass:objc_opt_class()];

  v43 = [(HMDXPCKeyedArchiver *)self archiver];
  [v43 setClassName:@"_HMLightProfile" forClass:objc_opt_class()];

  v44 = [(HMDXPCKeyedArchiver *)self archiver];
  [v44 setClassName:@"HMMediaPlaybackAction" forClass:objc_opt_class()];
  ...
  [v47 setClassName:@"_HMMediaProfile" forClass:objc_opt_class()];

  v48 = [(HMDXPCKeyedArchiver *)self archiver];
  [v48 setClassName:@"HMMediaSession" forClass:objc_opt_class()];

  v49 = [(HMDXPCKeyedArchiver *)self archiver];
  [v49 setClassName:@"_HMSiriEndpointProfile" forClass:objc_opt_class()];

  v50 = [(HMDXPCKeyedArchiver *)self archiver];
  [v50 setClassName:@"HMSiriEndpointProfileAssistant" forClass:objc_opt_class()];

  v51 = [(HMDXPCKeyedArchiver *)self archiver];
  [v51 setClassName:@"_HMDoorbellChimeProfile" forClass:objc_opt_class()];

  v52 = [(HMDXPCKeyedArchiver *)self archiver];
  [v52 setClassName:@"_HMAccessorySetting" forClass:objc_opt_class()];

  v53 = [(HMDXPCKeyedArchiver *)self archiver];
  [v53 setClassName:@"_HMAccessorySettingGroup" forClass:objc_opt_class()];

  v54 = [(HMDXPCKeyedArchiver *)self archiver];
  [v54 setClassName:@"HMSoftwareUpdate" forClass:objc_opt_class()];

  v55 = [(HMDXPCKeyedArchiver *)self archiver];
  [v55 setClassName:@"HMRemoteLoginHandler" forClass:objc_opt_class()];

  v56 = [(HMDXPCKeyedArchiver *)self archiver];
  [v56 setClassName:@"HMRemoteLoginAnisetteDataProvider" forClass:objc_opt_class()];
  ...
  [v59 setClassName:@"HMMediaSystem" forClass:objc_opt_class()];

  v60 = [(HMDXPCKeyedArchiver *)self archiver];
  [v60 setClassName:@"HMMediaSystemComponent" forClass:objc_opt_class()];

  v61 = [(HMDXPCKeyedArchiver *)self archiver];
  [v61 setClassName:@"HMBulletinBoardNotification" forClass:objc_opt_class()];

  v62 = [(HMDXPCKeyedArchiver *)self archiver];
  [v62 setClassName:@"HMSetting" forClass:objc_opt_class()];

  v63 = [(HMDXPCKeyedArchiver *)self archiver];
  [v63 setClassName:@"HMSettingGroup" forClass:objc_opt_class()];

  v64 = [(HMDXPCKeyedArchiver *)self archiver];
  [v64 setClassName:@"HMShortcutAction" forClass:objc_opt_class()];

  v65 = [(HMDXPCKeyedArchiver *)self archiver];
  [v65 setClassName:@"HMAccessoryNetworkAccessViolation" forClass:objc_opt_class()];

  v66 = [(HMDXPCKeyedArchiver *)self archiver];
  [v66 setClassName:@"HMAccessoryAllowedHost" forClass:objc_opt_class()];

  v67 = [(HMDXPCKeyedArchiver *)self archiver];
  [v67 setClassName:@"HMAccessoryNetworkProtectionGroup" forClass:objc_opt_class()];

  v68 = [(HMDXPCKeyedArchiver *)self archiver];
  [v68 setClassName:@"HMLightProfileNaturalLightingAction" forClass:objc_opt_class()];

  v69 = [(HMDXPCKeyedArchiver *)self archiver];
  [v69 setClassName:@"HMMediaDestinationController" forClass:objc_opt_class()];

  v70 = [(HMDXPCKeyedArchiver *)self archiver];
  [v70 setClassName:@"HMTriggerPolicy" forClass:objc_opt_class()];

  v71 = [(HMDXPCKeyedArchiver *)self archiver];
  [v71 setClassName:@"HMTriggerDeletePolicy" forClass:objc_opt_class()];

  v72 = [(HMDXPCKeyedArchiver *)self archiver];
  [v72 setClassName:@"HMTriggerDeleteAfterExecutionPolicy" forClass:objc_opt_class()];

  id v73 = [(HMDXPCKeyedArchiver *)self archiver];
  [v73 setClassName:@"_HMAccessoryProfile" forClass:objc_opt_class()];
}
