...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling expired staged aggregate data: %@", (uint8_t *)&v12, 0x16u);
  }
...
- (void)saveGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving group: %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  else
  {
    ...
    v11 = [(HMDMediaGroupsAggregateData *)v12 initWithDestinations:MEMORY[0x1E4F1CBF0] destinationControllersData:MEMORY[0x1E4F1CBF0]];
  }
  v13 = v11;
...
- (void)saveDestinations:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving destinations: %@", (uint8_t *)&v17, 0x16u);
  }
  v9 = [(HMDMediaGroupsStageManager *)v6 savedAggregateData];
  v10 = v9;
  if (v9)
...
- (void)saveDestinationControllerData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving destination controller data: %@", (uint8_t *)&v17, 0x16u);
  }
  v9 = [(HMDMediaGroupsStageManager *)v6 savedAggregateData];
  v10 = v9;
  if (v9)
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v15 = 2112;
        uint64_t v16 = v4;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to decode identifier: %@", (uint8_t *)&v13, 0x16u);
      }
      char v7 = 0;
    }
  }
    ...
    if (v4)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v15 = 2112;
          uint64_t v16 = v4;
          _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to saved aggregate data due to unable to decode data: %@", (uint8_t *)&v13, 0x16u);
        }
      }
    }
    else
...
- (void)saveIdentifier
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    __int16 v14 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Saving identifier: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)saveAggregateData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Saving aggregate data: %@", (uint8_t *)&v11, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v26 = 2112;
      id v27 = v9;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination from component: %@ accessory: %@", buf, 0x20u);
    }
    id v14 = 0;
  }
...
- (void)saveDataForLegacyMediaSystem:(id)a3
{
  ...
  if (v5 && v6)
  {
    ...
    if (v15 && v30)
    {
      id v16 = objc_alloc(MEMORY[0x1E4F2E930]);
      [v4 uuid];
      ...
      v32[1] = v5;
      v32[2] = v31;
      uint64_t v21 = [MEMORY[0x1E4F1C978] arrayWithObjects:v32 count:3];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v39 = 2112;
        id v40 = v4;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage data due to missing home identifier: %@ name: %@ for media system: %@", buf, 0x2Au);
      }
      __int16 v19 = (void *)v27;
      v18 = (void *)v28;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2112;
      id v36 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage data due to missing destinations for media system: %@", buf, 0x16u);
    }
  }
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v27 = 2112;
        id v28 = v4;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed stage associated group data due to no home for current accessory: %@", buf, 0x16u);
      }
    }
  }
}
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v26 = 2112;
          __int16 v27 = v9;
          _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage associated data due to no root destination identifier from media system: %@", buf, 0x16u);
        }
        goto LABEL_17;
      }
      id v11 = (id)v10;
...
LABEL_17:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v30 = 2112;
    id v31 = v4;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage associated data due to no destination: %@ home: %@ for the current HomePod accessory: %@", buf, 0x2Au);
  }
LABEL_18:
}
...
- (void)saveAssociatedGroupDataForLegacyCurrentAccessory:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to save associated group data due to unknown category for current accessory: %@", (uint8_t *)&v9, 0x16u);
    }
  }
}
...
- (void)commitAggregateData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Committing aggregate data: %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)notifyOfUpdatedAggregateData
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Notifying of updated aggregate data: %@", (uint8_t *)&v14, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      uint64_t v15 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of updated aggregate data due to no delegate", (uint8_t *)&v14, 0xCu);
    }
  }
}
...
- (id)transformedGroups
{
  ...
  if (v7)
  {
    addOrReplaceElements(v7, v4, &__block_literal_global_15_48547);
...
- (id)transformedDestinationControllersData
{
  ...
  if (v5)
  {
    uint64_t v9 = addOrReplaceElements(v5, v8, &__block_literal_global_11_48552);
...
- (id)transformedDestinations
{
  ...
  if (v7)
  {
    addOrReplaceElements(v7, v4, &__block_literal_global_48556);
    id v8 = (id)objc_claimAutoreleasedReturnValue();
  }
  else
  {
...
- (void)refreshManager
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Refresh resulted in no change to aggregate data: %@", (uint8_t *)&v15, 0x16u);
    }
  }
  else
  {
...
- (void)unstageNullDestinationForCurrentDestinationController
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Unstage null destination for current destination controller", (uint8_t *)&v7, 0xCu);
  }
...
- (void)stageNullDestinationForCurrentDestinationControllerIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Stage null destination for current destination controller identifier: %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)configure
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      __int16 v13 = 2112;
      int v14 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring with staged aggregate data: %@", (uint8_t *)&v11, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      int v11 = 138543362;
      id v12 = v10;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring without staged data", (uint8_t *)&v11, 0xCu);
    }
  }
}
...
- (HMDMediaGroupsStageManager)initWithIdentifier:(id)a3 userDefaults:(id)a4
{
  ...
  if (v8)
  {
    ...
    int v11 = [(HMDMediaGroupsAggregateData *)v10 initWithDestinations:MEMORY[0x1E4F1CBF0] destinationControllersData:MEMORY[0x1E4F1CBF0]];
    v20.receiver = self;
    ...
    if (v12)
    {
      ...
      uint64_t v14 = [objc_alloc(MEMORY[0x1E4F65560]) initWithValue:0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_48573 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_48573, &__block_literal_global_25_48574);
  }
  v2 = (void *)logCategory__hmf_once_v25_48575;
  return v2;
}
...
uint64_t __41__HMDMediaGroupsStageManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v25_48575;
  logCategory__hmf_once_v25_48575 = v0;
