...
- (id)hmd_retryAfterCKError
{
  ...
  if (objc_msgSend(a1, "hmd_isCKError") & 1) != 0 || (objc_msgSend(a1, "hmd_isUnderlyingCKError"))
  {
    ...
    id v10 = [a1 userInfo];
    uint64_t v11 = objc_msgSend(v10, "hmf_numberForKey:", *MEMORY[0x1E4F19C60]);
  }
  else
  {
    v12 = [a1 userInfo];
...
- (id)hmd_convertedCKError
{
  ...
  else
  {
    ...
    v4 = [v3 objectForKey:*MEMORY[0x1E4F28A50]];
...
- (id)hmd_hmErrorFromCKError
{
  ...
  uint64_t v3 = 78;
LABEL_9:
  id v4 = [MEMORY[0x1E4F28C58] hmErrorWithCode:v3 description:0 reason:0 suggestion:0 underlyingError:a1];
LABEL_10:
  return v4;
}
...
- (id)hmd_actualCKErrorFromCKErrorPartialFailure:()HomeKitCKError
{
  ...
  uint64_t v6 = [v5 objectForKey:*MEMORY[0x1E4F19CD8]];
