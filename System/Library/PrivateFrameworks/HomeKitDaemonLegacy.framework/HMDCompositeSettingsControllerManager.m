...
- (void)languagesDidChangeForHome:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling languages changed for homeUUID: %@", buf, 0x16u);
  }
  if (v6) {
...
- (void)_updateLanguageEventIfNeededWithHome:(void *)a3 uuid:
{
  ...
  if (a1)
  {
    ...
    if (v12 == 3 && v10)
    {
      ...
      if ([v20 count])
      {
        v46 = MEMORY[0x1D94507C0](v5, v7, @"root.siri.availableLanguages");
        ...
        {
          id v47 = 0;
          v22 = [MEMORY[0x1E4F2E858] decodeSettingFromEvent:v21 error:&v47];
          id v23 = v47;
          if (v23)
          {
            v44 = v22;
        ...
        v31 = (void *)[objc_alloc(MEMORY[0x1E4F2E880]) initWithKeyPath:@"root.siri.availableLanguages" readOnly:1 languageValues:v20];
        v32 = v31;
        if (!v22 || ([v31 isEqual:v22] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v52 = 2112;
            id v53 = v32;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_DEBUG, "%{public}@Updating language event for topic %@, with Value: %@", buf, 0x20u);
          }
          long long v15 = v43;
          v37 = (void *)[objc_alloc(MEMORY[0x1E4F2E858]) initWithSetting:v32 eventSource:v43 eventTimestamp:v14];
          v38 = [v9 eventForwarder];
          [v38 forwardEvent:v37 topic:v46 completion:&__block_literal_global_123];

          v39 = HMImmutableSettingChangeEventTopicFromComponentsLegacy();
          v40 = [v9 eventForwarder];
          [v40 forwardEvent:v37 topic:v39 completion:&__block_literal_global_125_151367];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v30;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Not checking for need to post language events because this device is not the primary resident.", buf, 0xCu);
      }
    }
  }
}
...
- (void)didUpdateCurrentRunState:(int64_t)a3 updatedState:(int64_t)a4 forHome:(id)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v34 = 2112;
    id v35 = v8;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@CurrentState: %ld, UpdatedState: %ld, Home:%@", buf, 0x2Au);
  }
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Home not found %@", buf, 0x16u);
    }
  }
  if (v10) {
  ...
  block[1] = 3221225472;
  block[2] = __87__HMDCompositeSettingsControllerManager_didUpdateCurrentRunState_updatedState_forHome___block_invoke_148;
...
void __87__HMDCompositeSettingsControllerManager_didUpdateCurrentRunState_updatedState_forHome___block_invoke_148(uint64_t a1)
{
...
LABEL_6:
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v74 = 2112;
          id v75 = v3;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@creating controller for state %ld, home: %@", buf, 0x20u);
        }
        id v21 = v3;
          ...
          if (v56)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                int64_t v31 = [MEMORY[0x1E4F1CA60] dictionary];
        ...
        id v47 = [v21 accessories];
        v48 = objc_msgSend(v47, "na_filter:", &__block_literal_global_156);
...
- (void)_postSettingUpdatesIfDifferentWithHome:(void *)a3 uuid:(void *)a4 settings:(void *)a5 metadata:
{
  ...
  if (a1)
  {
    ...
    [MEMORY[0x1E4F1C9C8] timeIntervalSinceReferenceDate];
    double v15 = v14;
    id v50 = [v13 eventSourceForCompositeSettingsController];
    id v51 = v13;
    uint64_t v56 = [v13 eventStoreReadHandle];
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      id v70 = v56;
      __int16 v71 = 2048;
      uint64_t v72 = [v10 count];
      __int16 v73 = 2048;
      uint64_t v74 = v17;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Posting updates with eventStoreHandle:%@, for settings count:%lu, with run state:%ld", buf, 0x2Au);
    }
    if (v17 == 3 && v56)
    {
      id v53 = v19;
      ...
      if (v57)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v57; ++i)
          {
            ...
            id v60 = [obj objectForKeyedSubscript:v23];
            id v24 = MEMORY[0x1D94507C0](v9, v59, v23);
            id v25 = [v56 lastEventForTopic:v24];
            if (v25)
            {
              id v61 = 0;
              uint64_t v26 = [MEMORY[0x1E4F2E858] decodeSettingFromEvent:v25 error:&v61];
              id v27 = v61;
              if (v27)
              {
                ...
                if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Error reading stored setting for topic %@, error: %@", buf, 0x20u);
                }
                id v9 = v52;
              }
            }
            ...
            __int16 v32 = [HMDCompositeSettingOperationResult alloc];
            id v33 = [v55 objectForKeyedSubscript:v23];
            uint64_t v34 = [(HMDCompositeSettingOperationResult *)v32 initWithKeyPath:v23 setting:v60 metadata:v33 error:0];
            uint64_t v35 = +[HMDCompositeSettingsControllerManager immutableSettingFromFetchReturn:v34];

            if (v26 && [v26 isEqual:v35])
            {
              ...
              if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v71 = 2112;
                uint64_t v72 = v23;
                _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Skip sending event for accessory %@ setting %@ as it matches stored", buf, 0x20u);
              }
              id v9 = v52;
            }
            else
            {
              v40 = (void *)[objc_alloc(MEMORY[0x1E4F2E858]) initWithSetting:v35 eventSource:v50 eventTimestamp:v15];
              v41 = [v51 eventForwarder];
              [v41 forwardEvent:v40 topic:v24 completion:&__block_literal_global_118_151392];

              v42 = HMImmutableSettingChangeEventTopicFromComponentsLegacy();
              BOOL v43 = [v51 eventForwarder];
              [v43 forwardEvent:v40 topic:v42 completion:&__block_literal_global_120_151393];
            }
          }
          uint64_t v57 = [obj countByEnumeratingWithState:&v62 objects:v66 count:16];
        }
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v69 = 2112;
        id v70 = v48;
        _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Diff from persistent store?: %@, skipping all updates", buf, 0x16u);
      }
...
uint64_t __87__HMDCompositeSettingsControllerManager__actualScanHomeAndCreateControllers_isPrimary___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[18] = 2096;
    *(void *)&buf[20] = &v26;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating controller for: %{uuid_t}.16P", buf, 0x1Cu);
  }
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      *(void *)&buf[24] = v10;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@controller for uuid:%@, homeUUID:%@ already exists", buf, 0x20u);
    }
  }
  else
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v7;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Ignoring siri endpoint setting update as we are not the primary resident for home:%@ accessory:%@", buf, 0x20u);
    }
  }
}
...
- (void)_manageCharacteristicsBackedSettingsChangeForHomeUUID:(void *)a3 accessoryUUID:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      id v55 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@managing characteristic backed settings for home:%@, accessory:%@", buf, 0x20u);
    }
    ...
    if (!v14)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Nil siriEndpointBridge", buf, 0xCu);
      }
      goto LABEL_27;
    }
      ...
      && ![(HMDCompositeBoolSetting *)v32 BOOLValue])
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v48;
        _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@Setting Siri enabled to NO", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v44;
        _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_INFO, "%{public}@Not transforming allowHeySiri and tapToAccess settings", buf, 0xCu);
...
void __134__HMDCompositeSettingsControllerManager__processCharacteristicBackedSettingsChangeForHomeUUID_accessoryUUID_allowHeySiri_tapToAccess___block_invoke(id *a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v8;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Siri enabled setting update returned result:%@, home:%@ accessory:%@", (uint8_t *)&v14, 0x2Au);
  }
...
- (void)_publishCharacteristicBackedSettingsChangeForHomeUUID:(void *)a3 accessoryUUID:(void *)a4 allowHeySiri:(void *)a5 tapToAccess:
{
  ...
  if (a1)
  {
    ...
    if (v15)
    {
      ...
      __int16 v16 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v51 count:1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v54 = 2112;
          id v55 = v18;
          _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch SiriEnabled setting operation result:%@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v56 = 2112;
        id v57 = v10;
        _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_ERROR, "%{public}@No controller for home:%@ accessory:%@", buf, 0x20u);
      }
    }
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v7;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Ignoring composite setting controller configuration update as we are not the primary resident for home:%@ accessory:%@", buf, 0x20u);
    }
  }
}
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke(id *a1)
{
  ...
  if (v3 != 3)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v89 = v49;
      _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_INFO, "%{public}@Device is not a primary resident", buf, 0xCu);
    }
    id v6 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:14];
  ...
  if (!v6 || ([v6 configured] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v89 = v54;
      _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Controller is not created or not configured", buf, 0xCu);
    }
    id v50 = (void (*)(void))*((void *)a1[8] + 2);
LABEL_12:
    v50();
  ...
  id v7 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:7];
  id v8 = [HMDCompositeSettingsKeyPathValueItem alloc];
  p_cache = &OBJC_METACLASS___HMDCameraSnapshotReceiver.cache;
  ...
  if (v33)
  {
    ...
    id v37 = [v36 outputVoiceLanguageCode];
    ...
    p_cache = (void **)(&OBJC_METACLASS___HMDCameraSnapshotReceiver + 16);
  }
  else
  {
    id v45 = [MEMORY[0x1E4F2E600] defaultLanguageValue];
    id v55 = [HMDCompositeSettingLanguageValue alloc];
    id v35 = [v45 inputLanguageCode];
    v44 = [v45 outputVoiceLanguageCode];
    id v37 = [v45 outputVoiceGenderCode];
    v38 = [v45 voiceName];
  ...
  uint64_t v58 = objc_msgSend(objc_alloc((Class)(p_cache + 93)), "initWithValue:", objc_msgSend(a1[7], "allowHeySiri"));
  ...
  if (v64)
  {
    long long v65 = (void *)MEMORY[0x1D9452090]();
    id v66 = a1[4];
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v90 = 2112;
      id v91 = v64;
      _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_ERROR, "%{public}@Error while checking certification status error:%@", buf, 0x16u);
    }
  }
  id v70 = a1[5];
  id v69 = a1[6];
  ...
  v78[1] = 3221225472;
  v78[2] = __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_135;
  v78[3] = &unk_1E6A13AB0;
  uint64_t v86 = v63;
  v78[4] = v71;
  id v85 = a1[8];
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_135(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2112;
      id v36 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Applying onboarding selections to controller failed with error: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    v27[1] = 3221225472;
    v27[2] = __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_137;
    v27[3] = &unk_1E6A13A88;
    id v26 = *(void **)(a1 + 88);
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_137(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  else
  {
    ...
    v27[0] = MEMORY[0x1E4F143A8];
    v27[1] = 3221225472;
    v27[2] = __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_138;
    v27[3] = &unk_1E6A13A60;
...
void __102__HMDCompositeSettingsControllerManager__applyOnboardingSelections_accessoryUUID_homeUUID_completion___block_invoke_138(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Applying onboarding selections to controller failed with error: %@", (uint8_t *)&v22, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      int v22 = 138543362;
      uint64_t v23 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Applying onboarding selections to controller successful", (uint8_t *)&v22, 0xCu);
    }
          ...
          if (v9)
          {
            if (v70)
            {
              if (v11)
              {
                ...
                {
                  id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1 description:@"Not a primary resident" reason:0 suggestion:0];
                  ...
                  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_WORD *)&buf[12] = 2112;
                    *(void *)&buf[14] = v17;
                    _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
                ...
                if (!v17)
                {
                  ...
                  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_WORD *)&buf[22] = 2112;
                    id v73 = v7;
                    _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Unconfigured controller for uuid:%@, home:%@", buf, 0x20u);
                  }
                  id v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
...
LABEL_25:
                ...
                if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_WORD *)&v74[10] = 2112;
                  *(void *)&v74[12] = v68;
                  _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Characteristic backed keyPath update for home:%@, accessory:%@, keyPath:%@, value:%@", buf, 0x34u);
                }
                id v24 = v68;
                objc_opt_class();
                ...
                if (!v25)
                {
                  ...
                  if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_WORD *)&buf[12] = 2112;
                    *(void *)&buf[14] = v44;
                    _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@Invalid BOOL value:%@", buf, 0x16u);
                  }
                  v48 = [HMDCompositeSettingOperationResult alloc];
                  id v49 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43 userInfo:0];
                ...
                if ([v24 BOOLValue])
                {
                  if (v19)
                  {
                    id v62 = (void *)[objc_alloc(MEMORY[0x1E4F2EA98]) initWithBoolValue:1];
                    *(void *)buf = MEMORY[0x1E4F143A8];
                    *(void *)&buf[8] = 3221225472;
...
LABEL_43:
                  ...
                  __int16 v54 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27 userInfo:0];
                ...
                else
                {
                  if (v19)
                  {
                    id v31 = (void (**)(id, HMDCompositeSettingOperationResult *, id, id))objc_msgSend(objc_alloc(MEMORY[0x1E4F2EA98]), "initWithBoolValue:", objc_msgSend(v24, "BOOLValue"));
                    *(void *)buf = MEMORY[0x1E4F143A8];
                    *(void *)&buf[8] = 3221225472;
                  ...
                  id v59 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27 userInfo:0];
                ...
                *(void *)&uint8_t buf[4] = v61;
                _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_ERROR, "%{public}@No Siri endpoint bridge", buf, 0xCu);
...
- (id)dataSourceIsCurrentDevicePrimaryResidentForHomeUUID:(void *)a1
{
  ...
  if (v4)
  {
    ...
    id v7 = [MEMORY[0x1E4F65408] BOOLeanWithBool:v6];
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      id v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine current device is primary resident due to no data source", (uint8_t *)&v13, 0xCu);
    }
    id v7 = 0;
  }
...
void __130__HMDCompositeSettingsControllerManager_localFetchSettingsForUUID_homeUUID_withKeyPaths_callerVersion_callerPrivilege_completion___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (v11 && ([v11 BOOLValue] & 1) != 0)
    {
      ...
      if (v16)
      {
        objc_msgSend(v56, "na_filter:", &__block_literal_global_151466);
        id v54 = (id)objc_claimAutoreleasedReturnValue();
        if ([v54 count])
        {
          v64[0] = @"root.siri.siriEnabled";
          id v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v64 count:1];
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          ...
          LOWORD(v61) = 2112;
          *(void *)((char *)&v61 + 2) = v7;
          _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Siri is enabled:%@ for owner:%@, home:%@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          id v60 = v7;
          _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unconfigured controller for uuid:%@, home:%@", buf, 0x20u);
        }
        id v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
        *(void *)buf = MEMORY[0x1E4F143A8];
        *(void *)&buf[8] = 3221225472;
    ...
    {
      id v19 = v9;
      id v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1 description:@"Not a primary resident" reason:0 suggestion:0];
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        ...
        LOWORD(v61) = 2112;
        *(void *)((char *)&v61 + 2) = v7;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Error: %@, owner:%@, home:%@", buf, 0x2Au);
      }
      *(void *)buf = MEMORY[0x1E4F143A8];
      *(void *)&buf[8] = 3221225472;
...
HMDCompositeSettingOperationResult *__120__HMDCompositeSettingsControllerManager__localFetchSettingsForUUID_homeUUID_withKeyPaths_callerVersion_callerPrivilege___block_invoke_87(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    id v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:74];
    ...
    if ((unint64_t)(v11 - 4) <= 0xFFFFFFFFFFFFFFFDLL)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v55 = 2112;
        id v56 = v8;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Current state is not resident or primary resident for owner:%@, home:%@", buf, 0x20u);
      }
      goto LABEL_23;
    }
    if (!v8)
...
LABEL_26:
  ...
  if (v11 == 3)
  {
    if (self)
    {
      id v30 = [&unk_1F2DC6F58 arrayByAddingObjectsFromArray:&unk_1F2DC6F70];
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v59 = 2112;
      id v60 = v30;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Created setting controller %@ for owner:%@ home:%@ blocklist: %@", buf, 0x34u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v55 = 2112;
      id v56 = v8;
      _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@Current state is not primary resident for owner:%@, home:%@ so skipping controller creation", buf, 0x20u);
    }
  }
...
LABEL_8:
    ...
    SEL v25 = [MEMORY[0x1E4F28EB8] defaultCenter];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t35_151524 != -1) {
    dispatch_once(&logCategory__hmf_once_t35_151524, &__block_literal_global_142_151525);
  }
  id v2 = (void *)logCategory__hmf_once_v36_151526;
  return v2;
}

uint64_t __52__HMDCompositeSettingsControllerManager_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v36_151526;
  logCategory__hmf_once_v36_151526 = v0;
...
+ (id)immutableSettingFromFetchReturn:(id)a3
{
  ...
  if ((isKindOfClass & 1) == 0)
  {
    ...
    if (v14)
    {
      id v16 = objc_alloc(MEMORY[0x1E4F2E860]);
      id v17 = [v3 keyPath];
    ...
    else
    {
      ...
      if (v20)
      {
        ...
        id v40 = objc_alloc(MEMORY[0x1E4F2E688]);
        id v18 = [v3 keyPath];
      ...
      else
      {
        ...
        id v44 = v17;
        id v43 = objc_alloc(MEMORY[0x1E4F2E878]);
        uint64_t v32 = [v3 keyPath];
        id v39 = objc_alloc(MEMORY[0x1E4F2EAA8]);
...
LABEL_28:
  ...
  id v10 = objc_alloc(MEMORY[0x1E4F2E680]);
  id v11 = [v3 keyPath];
  ...
  if (v22)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v52 = 2112;
      id v53 = v19;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Update using current accessory keyPath: %{public}@, value: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v50 = 2112;
        id v51 = v19;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due to no composite setting value conversion for setting value: %@", buf, 0x16u);
      ...
      id v38 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
...
void __210__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveUpdateRequestMessage_withHomeUUID_accessoryUUID_keyPath_value_callerVersion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Update %{public}@ result: %@", (uint8_t *)&v10, 0x20u);
  }
  id v9 = *(void **)(a1 + 48);
  if (v3) {
...
void __210__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveUpdateRequestMessage_withHomeUUID_accessoryUUID_keyPath_value_callerVersion___block_invoke_11(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v10)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v10;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Update completed with error: %@", (uint8_t *)&v17, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      id v18 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Update complete", (uint8_t *)&v17, 0xCu);
    }
...
- (void)accessorySettingsLocalMessageHandler:(id)a3 didReceiveFetchRequestMessage:(id)a4 withHomeUUID:(id)a5 accessoryUUID:(id)a6 keyPaths:(id)a7 callerVersion:(id)a8 callerPrivilege:(unint64_t)a9 siriAvailableLanguagesSetting:(id)a10
{
  ...
  if (v23)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v43 = 2114;
      id v44 = v19;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch using current accessory %{public}@", buf, 0x16u);
  ...
  {
    uint64_t v30 = objc_msgSend(v19, "na_filter:", &__block_literal_global_184093);
...
void __250__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveFetchRequestMessage_withHomeUUID_accessoryUUID_keyPaths_callerVersion_callerPrivilege_siriAvailableLanguagesSetting___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched settings %@, error: %@", (uint8_t *)&v15, 0x20u);
  }
  id v11 = objc_alloc_init(MEMORY[0x1E4F2E950]);
  id v12 = (void *)[objc_alloc(MEMORY[0x1E4F2E610]) initWithSettings:v5 failureInformation:v11];
...
void __250__HMDCompositeSettingsControllerManager_AccessorySettingsLocalMessageHandlerDelegate__accessorySettingsLocalMessageHandler_didReceiveFetchRequestMessage_withHomeUUID_accessoryUUID_keyPaths_callerVersion_callerPrivilege_siriAvailableLanguagesSetting___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  id v36 = a3;
  id v34 = a4;
  id v8 = objc_alloc_init(MEMORY[0x1E4F2E950]);
  ...
  if (v19)
  {
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      uint32_t v29 = 42;
LABEL_18:
      _os_log_impl(&dword_1D49D5000, v27, v28, v26, buf, v29);
    }
  }
  ...
  id v31 = (void *)[objc_alloc(MEMORY[0x1E4F2E610]) initWithSettings:v9 failureInformation:v8];
  id v32 = *(void **)(a1 + 56);
