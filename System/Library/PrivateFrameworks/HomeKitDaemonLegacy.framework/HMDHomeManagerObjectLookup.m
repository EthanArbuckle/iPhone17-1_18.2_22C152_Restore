...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_46866 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_46866, &__block_literal_global_46867);
  }
  v2 = (void *)logCategory__hmf_once_v1_46868;
  return v2;
}
...
uint64_t __41__HMDHomeManagerObjectLookup_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_46868;
  logCategory__hmf_once_v1_46868 = v0;
