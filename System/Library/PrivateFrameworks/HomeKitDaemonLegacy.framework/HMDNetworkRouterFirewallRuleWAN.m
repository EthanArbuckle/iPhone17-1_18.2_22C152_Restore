...
LABEL_36:
  ...
  if (v15 >= 2)
  {
    if (v15 == 2)
    {
      ...
      v20 = objc_msgSend(v18, "na_map:", &__block_literal_global_216_141911);
...
- (id)attributeDescriptions
{
  ...
  v26[5] = v16;
  int v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v26 count:6];
...
LABEL_15:
  ...
  if (!v11)
  {
    unsigned int v15 = (void *)MEMORY[0x1D9452090]();
    id v16 = a1;
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      id v35 = v6;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid '%@' value: %@", buf, 0x20u);
    }
    if (a4)
    {
      [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
...
LABEL_11:
            _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, v15, buf, 0xCu);
...
LABEL_24:
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, v16, buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v37 = 2112;
        id v38 = v28;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Invalid address value: %@", buf, 0x16u);
...
LABEL_10:
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        int v20 = 138543362;
        v21 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@IP address range must have matching address family", (uint8_t *)&v20, 0xCu);
      }
    }
    BOOL v14 = 0;
    goto LABEL_10;
...
LABEL_10:
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v27, 0x20u);
...
LABEL_20:
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, v23, (uint8_t *)&v27, 0x20u);
    }
  }
...
+ (BOOL)__decodeAddresses:(id)a3 subject:(id *)a4
{
  ...
  if (![v6 count])
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v59 = v34;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an empty address array", buf, 0xCu);
    }
    BOOL v35 = 0;
    goto LABEL_47;
  }
  id v7 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v6, "count"));
  v50 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v6, "count"));
  long long v54 = 0u;
  long long v55 = 0u;
  long long v56 = 0u;
  long long v57 = 0u;
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v60 = 2112;
          id v61 = v12;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a non-string address: %@", buf, 0x16u);
        }
        goto LABEL_44;
      }
      ...
      if (!v16)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v60 = 2112;
          id v61 = v14;
          _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid address: %@", buf, 0x16u);
        }
      ...
      if ([v10 containsObject:v15])
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v60 = 2112;
          id v61 = v15;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a duplicate address: %@", buf, 0x16u);
  ...
  if (HIDWORD(v52) & v49 & 1) != 0 || (v52 & HIDWORD(v49))
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v60 = 2112;
      id v61 = v8;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a mix of wildcard and non-wildcard addresses: %@", buf, 0x16u);
    }
    goto LABEL_45;
  }
LABEL_40:
...
+ (BOOL)__decodeHostnames:(id)a3 subject:(id *)a4
{
  ...
  {
    id v102 = v6;
    uint64_t v9 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v102 count:1];
  }
  if (![v9 count])
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      ...
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an empty hostname array", buf, 0xCu);
    }
    BOOL v38 = 0;
    goto LABEL_57;
  }
  ...
  if (!v20)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v113 = 2112;
      id v114 = v65;
      _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a non-string hostname: %@", buf, 0x16u);
    }
    goto LABEL_55;
  }
  v88 = v18;
  ...
  if (![v21 length] || (unint64_t)objc_msgSend(v21, "length") >= 0xFE)
  {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v103 = 138543874;
      ...
      __int16 v107 = 2048;
      uint64_t v108 = v60;
      _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its length is out of bounds: %lu", v103, 0x20u);
...
LABEL_61:
  ...
  if ((unint64_t)[v22 count] > 1)
  {
    if (validateHostNameForWANFirewallRule_onceTokenRegex != -1) {
      dispatch_once(&validateHostNameForWANFirewallRule_onceTokenRegex, &__block_literal_global_147246);
    }
    long long v99 = 0u;
    long long v100 = 0u;
    long long v97 = 0u;
      ...
      if (objc_msgSend((id)validateHostNameForWANFirewallRule_componentRegex, "numberOfMatchesInString:options:range:", v27, 0, 0, v28) != 1)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v103 = 138543874;
          ...
          uint32_t v50 = 32;
LABEL_49:
          _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_INFO, v48, v103, v50);
        }
        goto LABEL_50;
      }
      if (v24 == ++v26)
        ...
        if (v30)
        {
          ...
          if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            __int16 v105 = 2112;
            id v106 = v21;
            _os_log_impl(&dword_1D49D5000, v73, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its second-to-last component contains a wildcard", v103, 0x16u);
          }
          a1 = v91;
          uint64_t v9 = v92;
          goto LABEL_51;
        ...
        if ([v31 isEqualToString:@"local"])
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            __int16 v105 = 2112;
            id v106 = v21;
            _os_log_impl(&dword_1D49D5000, v77, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component is 'local'", v103, 0x16u);
          }
          a1 = v91;
          uint64_t v9 = v92;
          goto LABEL_76;
        ...
        if ([v31 containsString:@"*"])
        {
          ...
          if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            __int16 v105 = 2112;
            id v106 = v21;
            _os_log_impl(&dword_1D49D5000, v77, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component contains a wildcard", v103, 0x16u);
...
LABEL_76:
        ...
        id v32 = [MEMORY[0x1E4F28B88] characterSetWithCharactersInString:@"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"];
        if ([v31 rangeOfCharacterFromSet:v32] == 0x7FFFFFFFFFFFFFFFLL)
        {
          ...
          if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v103 = 138543618;
            ...
            __int16 v105 = 2112;
            id v106 = v21;
            _os_log_impl(&dword_1D49D5000, v82, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because its last component does not contain letters", v103, 0x16u);
        ...
        if ([v89 containsObject:v21])
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v113 = 2112;
            id v114 = v21;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains a duplicate hostname: %@", buf, 0x16u);
...
LABEL_50:
  ...
  if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v103 = 138543874;
    ...
    __int16 v107 = 2048;
    uint64_t v108 = 2;
    _os_log_impl(&dword_1D49D5000, v69, OS_LOG_TYPE_INFO, "%{public}@Hostname '%@' is invalid because it does not contain at least %lu components", v103, 0x20u);
  }
LABEL_51:
...
LABEL_52:
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v113 = 2112;
    id v114 = v21;
    _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_ERROR, "%{public}@WAN rule contains an invalid hostname: %@", buf, 0x16u);
  }
...
LABEL_10:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v8;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@WAN rule contains an unkown type value %@: %@", buf, 0x20u);
    }
    if (a5)
    {
      uint64_t v13 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1070];
      goto LABEL_8;
    }
LABEL_16:
    BOOL v14 = 0;
...
+ (HMFNetAddress)ipAddressAny
{
  if (ipAddressAny_onceToken != -1) {
    dispatch_once(&ipAddressAny_onceToken, &__block_literal_global_168_142092);
  }
...
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F654B8]) initWithHostname:@"*"];
  uint64_t v1 = ipAddressAny_address;
...
+ (HMFNetAddress)ipAddressAnyIPv6
{
  if (ipAddressAnyIPv6_onceToken != -1) {
    dispatch_once(&ipAddressAnyIPv6_onceToken, &__block_literal_global_165_142095);
  }
...
{
  v2[0] = xmmword_1D54D40C8;
  *(_OWORD *)((char *)v2 + 12) = *(long long *)((char *)&xmmword_1D54D40C8 + 12);
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F654B8]) initWithSocketAddress:v2];
  uint64_t v1 = (void *)ipAddressAnyIPv6_address;
...
+ (HMFNetAddress)ipAddressAnyIPv4
{
  if (ipAddressAnyIPv4_onceToken != -1) {
    dispatch_once(&ipAddressAnyIPv4_onceToken, &__block_literal_global_162_142097);
  }
...
void __51__HMDNetworkRouterFirewallRuleWAN_ipAddressAnyIPv4__block_invoke()
{
  ...
  long long v2 = xmmword_1D54D3760;
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F654B8]) initWithSocketAddress:&v2];
  uint64_t v1 = (void *)ipAddressAnyIPv4_address;
