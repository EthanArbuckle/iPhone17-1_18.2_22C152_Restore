...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HMDCameraRecordingAudioBitRateMode *)self type];
...
{
  v5.receiver = self;
  v5.super_class = (Class)HMDCameraRecordingAudioBitRateMode;
...
{
  v6.receiver = self;
  v6.super_class = (Class)HMDCameraRecordingAudioBitRateMode;
...
- (void)description:(id)a3 indent:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  HMDCameraRecordingAudioBitRateModeTypeAsString([(HMDCameraRecordingAudioBitRateMode *)self type]);
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HMDCameraRecordingAudioBitRateMode *)a3;
  if (self == v4)
  {
    BOOL v6 = 1;
  }
  else
  {
    ...
    {
      int64_t v5 = [(HMDCameraRecordingAudioBitRateMode *)self type];
      BOOL v6 = v5 == [(HMDCameraRecordingAudioBitRateMode *)v4 type];
    }
    else
    {
      BOOL v6 = 0;
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  int64_t v5 = [(HMDCameraRecordingAudioBitRateMode *)self type];
  objc_msgSend(NSString, "stringWithFormat:", @"%s_%s", "HMDCameraRecordingAudioBitRateMode", "type");
...
- (HMDCameraRecordingAudioBitRateMode)initWithCoder:(id)a3
{
  id v4 = a3;
  v8.receiver = self;
  v8.super_class = (Class)HMDCameraRecordingAudioBitRateMode;
  int64_t v5 = [(HMDCameraRecordingAudioBitRateMode *)&v8 init];
  if (v5)
  {
    id v6 = objc_msgSend(NSString, "stringWithFormat:", @"%s_%s", "HMDCameraRecordingAudioBitRateMode", "type");
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        v12 = -[HMDCameraRecordingAudioBitRateMode initWithBitRateMode:](v11, "initWithBitRateMode:", objc_msgSend(v10, "integerValue", (void)v14));
        [v4 addObject:v12];
      }
