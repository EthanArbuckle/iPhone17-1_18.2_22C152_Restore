...
LABEL_7:
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v105 = 2112;
    v106 = v13;
    _os_log_impl(&dword_1D49D5000, v3, OS_LOG_TYPE_INFO, "%{public}@Updating storage node ID from %@ to %@", (uint8_t *)&v101, 0x20u);
  }
...
LABEL_8:
  ...
  if (v16)
  {
    ...
    if (([v3 isEqualToNumber:&unk_1F2DC7828] & 1) == 0) {
      goto LABEL_18;
    }
  }
...
LABEL_19:
  ...
  if ((v20 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v25;
      _os_log_impl(&dword_1D49D5000, v3, OS_LOG_TYPE_INFO, "%{public}@Updating storage vendor ID from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
...
LABEL_31:
  ...
  if ((v30 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v36;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating storage product ID from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
...
LABEL_32:
  ...
  if ([v37 containsObject:@"chipAttributeDatabase"])
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v46;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating storage attribute database from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
...
LABEL_38:
  ...
  if ([v47 containsObject:@"chipPairingsData"])
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v56;
      _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Updating storage pairings from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
    v47 = [v5 chipPairings];
...
LABEL_44:
  ...
  if ([v57 containsObject:@"chipWEDSupport"])
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v67;
      _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating storage WED support from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
...
LABEL_50:
  ...
  if ([v68 containsObject:@"chipExtendedMACAddress"])
  {
    ...
    if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v77;
      _os_log_impl(&dword_1D49D5000, v74, OS_LOG_TYPE_INFO, "%{public}@Updating storage eMAC Address from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
...
LABEL_56:
  ...
  if ([v78 containsObject:@"matterSoftwareVersionNumber"])
  {
    ...
    if (os_log_type_enabled(v84, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v105 = 2112;
      v106 = v87;
      _os_log_impl(&dword_1D49D5000, v84, OS_LOG_TYPE_INFO, "%{public}@Updating accessory software version number from %@ to %@", (uint8_t *)&v101, 0x20u);
    }
...
LABEL_62:
  ...
  if (v89)
  {
    ...
    if (v90)
    {
      ...
      if (([v89 isEqualToNumber:&unk_1F2DC7828] & 1) == 0)
      {
...
LABEL_72:
    ...
    if ((v93 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v105 = 2112;
        v106 = v99;
        _os_log_impl(&dword_1D49D5000, v96, OS_LOG_TYPE_INFO, "%{public}@Updating matter accessory supported link layer types from %@ to %@", (uint8_t *)&v101, 0x20u);
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10 != -1) {
    dispatch_once(&logCategory__hmf_once_t10, &__block_literal_global_21296);
  }
