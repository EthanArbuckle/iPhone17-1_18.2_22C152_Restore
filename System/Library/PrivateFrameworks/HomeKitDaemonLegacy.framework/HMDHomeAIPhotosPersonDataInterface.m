...
- (void)handleUpdatedSettings:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Updated settings could not be converted into HMIExternalPersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
    }
  }
}
...
void __66__HMDHomeAIPhotosPersonDataInterface_fetchSettingsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Fetched settings could not be converted into HMIExternalPersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
    }
...
- (HMDHomeAIPhotosPersonDataInterface)initWithPersonManagerUUID:(id)a3 homeUUID:(id)a4 workQueue:(id)a5
{
  id v8 = (objc_class *)MEMORY[0x1E4F697E0];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_52136 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_52136, &__block_literal_global_52137);
  }
  v2 = (void *)logCategory__hmf_once_v1_52138;
  return v2;
}
...
uint64_t __49__HMDHomeAIPhotosPersonDataInterface_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_52138;
  logCategory__hmf_once_v1_52138 = v0;
