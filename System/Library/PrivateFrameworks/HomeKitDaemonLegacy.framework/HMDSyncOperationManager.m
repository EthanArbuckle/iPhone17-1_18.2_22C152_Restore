...
void __47__HMDSyncOperationManager_resetCloudPushTimer___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v21 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Resetting cloud upload timer", buf, 0xCu);
  }
...
void __49__HMDSyncOperationManager_killCloudPushAndResume__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    v13 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Dropping current cloud push queue", (uint8_t *)&v12, 0xCu);
  }
  ...
  if ([*(id *)(a1 + 32) pauseCloudPushLevel] <= 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Forcing refetch", (uint8_t *)&v12, 0xCu);
    }
...
void __42__HMDSyncOperationManager_resumeCloudPush__block_invoke(uint64_t a1)
{
  ...
  if (v2 < 1)
  {
    if (v6)
    {
      ...
      int v10 = 138543362;
      uint64_t v11 = v9;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Resuming cloud push queue", (uint8_t *)&v10, 0xCu);
    }
    [*(id *)(a1 + 32) _handleNextOperation];
  }
  else
  {
    if (v6)
    {
      ...
      __int16 v12 = 2048;
      uint64_t v13 = v8;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Cloud push queue is still paused because push level is %tu", (uint8_t *)&v10, 0x16u);
    }
  }
}
...
void __41__HMDSyncOperationManager_pauseCloudPush__block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = (void *)MEMORY[0x1D9452090](objc_msgSend(*(id *)(a1 + 32), "setPauseCloudPushLevel:", objc_msgSend(*(id *)(a1 + 32), "pauseCloudPushLevel") + 1));
  id v3 = *(id *)(a1 + 32);
  id v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v9 = 2048;
    uint64_t v10 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Pausing cloud push queue, level is %tu", (uint8_t *)&v7, 0x16u);
  }
}
...
uint64_t __33__HMDSyncOperationManager_resume__block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) setPauseQueue:0]);
  id v3 = *(id *)(a1 + 32);
  id v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Resuming sync manager queue", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _handleNextOperation];
}
...
void __32__HMDSyncOperationManager_pause__block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) setPauseQueue:1]);
  id v3 = *(id *)(a1 + 32);
  id v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    int v7 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Pausing sync manager queue", (uint8_t *)&v6, 0xCu);
  }
}
      ...
      for (uint64_t i = 0; i != v3; ++i)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v20 = 2114;
          uint64_t v21 = v6;
          _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Cancelling sync operation %{public}@", buf, 0x16u);
        }
...
void __54__HMDSyncOperationManager__handleCancelledOperations___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2114;
    uint64_t v22 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Sync operation %{public}@ cancelled", buf, 0x16u);
  }
  long long v16 = 0u;
  long long v17 = 0u;
  long long v14 = 0u;
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2114;
      long long v32 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Starting sync operation %{public}@", buf, 0x16u);
    }
    logger = v6->_logger;
    if (os_signpost_enabled(logger))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v31 = 2112;
      long long v32 = v12;
      _os_signpost_emit_with_name_impl(&dword_1D49D5000, v10, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SyncOperation", "zone=%{signpost.description:attribute}@ identifier=%{signpost.description:attribute}@ ", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2114;
      long long v32 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting for sync operation %{public}@ to complete", buf, 0x16u);
    }
...
uint64_t __47__HMDSyncOperationManager__handleNextOperation__block_invoke_176(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    long long v14 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Sync operation %@ completed", (uint8_t *)&v11, 0x16u);
  }
  ...
  {
    LOWORD(v11) = 0;
    _os_signpost_emit_with_name_impl(&dword_1D49D5000, v8, OS_SIGNPOST_INTERVAL_END, v9, "SyncOperation", "", (uint8_t *)&v11, 2u);
  }
  ...
  if (!v4)
  {
    ...
    if ([(HMDSyncOperationManager *)self pauseQueue])
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v41 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Cannot dequeue operation because sync manager queue is paused", buf, 0xCu);
      }
      long long v10 = 0;
LABEL_30:
...
LABEL_25:
          _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEBUG, v31, buf, 0xCu);
...
LABEL_28:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2114;
      v43 = v10;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Dequeued operation to process %{public}@", buf, 0x16u);
    }
    goto LABEL_30;
  }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v42 = 2112;
    v43 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Already executing operation %@", buf, 0x16u);
  }
  long long v10 = 0;
LABEL_31:
  return v10;
...
void __43__HMDSyncOperationManager_cancelOperations__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v36 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Cancelling all unprocessed sync operation", buf, 0xCu);
  }
  ...
  __int16 v21 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) setCloudPushDelayTimer:0]);
  id v22 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v36 = v24;
    _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Cancelling all sync operations, resuming cloud push queue", buf, 0xCu);
  }
...
uint64_t __67__HMDSyncOperationManager_addOperationRespectingOptions_withDelay___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v140 = 2112;
    v141 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Will attempt to add operation %@", buf, 0x16u);
  }
  if ([*(id *)(a1 + 40) operationType] == 1 || objc_msgSend(*(id *)(a1 + 40), "operationType") == 2)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v140 = 2114;
        v141 = v16;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Current push delay is: %{public}@", buf, 0x16u);
      }
    }
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v139 = v22;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Scheduling legacy push at maximum time interval, maybe in a sync loop", buf, 0xCu);
      }
    ...
    if (!v24)
    {
      char v38 = (void *)MEMORY[0x1D9452090]();
      id v39 = *(id *)(a1 + 32);
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v140 = 2114;
        v141 = v42;
        _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Staging cloud push operation %{public}@", buf, 0x16u);
      }
...
LABEL_22:
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v140 = 2114;
      v141 = v36;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Adding cloud push operation %{public}@", buf, 0x16u);
    }
  ...
  if ([*(id *)(a1 + 40) operationType] == 3)
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v140 = 2114;
      v141 = v47;
      _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_INFO, "%{public}@Adding cloud verify account operation %{public}@", buf, 0x16u);
    }
      ...
      if (v26)
      {
        if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v140 = 2114;
          v141 = v82;
          _os_log_impl(&dword_1D49D5000, v80, OS_LOG_TYPE_INFO, "%{public}@Adding cloud zone push operation %{public}@", buf, 0x16u);
        }
        if ([*(id *)(a1 + 32) addCloudZonePushOperation:*(void *)(a1 + 40) delay:*(double *)(a1 + 48)])
        {
          ...
          if (os_log_type_enabled(v85, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v140 = 2114;
            v141 = v87;
            _os_log_impl(&dword_1D49D5000, v85, OS_LOG_TYPE_ERROR, "%{public}@Scheduling zone %{public}@ push at maximum time interval, maybe in a sync loop", buf, 0x16u);
          }
          [*(id *)(a1 + 32) _reportPossibleSyncLoop];
        }
        goto LABEL_37;
...
LABEL_90:
        _os_log_impl(&dword_1D49D5000, v80, OS_LOG_TYPE_ERROR, v101, buf, 0x16u);
      ...
      if (v26)
      {
        if (os_log_type_enabled(v91, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v140 = 2114;
          v141 = v93;
          _os_log_impl(&dword_1D49D5000, v80, OS_LOG_TYPE_INFO, "%{public}@Adding cloud zone fetch operation %{public}@", buf, 0x16u);
        }
    ...
    if ([v90 operationType] == 7)
    {
      ...
      if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v140 = 2112;
        v141 = v98;
        _os_log_impl(&dword_1D49D5000, v96, OS_LOG_TYPE_INFO, "%{public}@Adding cloud cancel pause operation %@", buf, 0x16u);
      }
    ...
    if ([*(id *)(a1 + 40) operationType] == 8)
    {
      ...
      if (os_log_type_enabled(v104, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v140 = 2114;
        v141 = v106;
        _os_log_impl(&dword_1D49D5000, v104, OS_LOG_TYPE_INFO, "%{public}@Adding cloud query database operation %{public}@", buf, 0x16u);
      }
      if (([*(id *)(a1 + 32) addCloudQueryDatabaseOperationIfNonePresent:*(void *)(a1 + 40)] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v109, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v140 = 2114;
          v141 = v111;
          _os_log_impl(&dword_1D49D5000, v109, OS_LOG_TYPE_INFO, "%{public}@Already have a query operation scheduled, dropping operation %{public}@", buf, 0x16u);
        }
        [*(id *)(a1 + 32) _dropWithoutAlreadyScheduledOperation:*(void *)(a1 + 40)];
      }
      ...
      if (os_log_type_enabled(v114, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v140 = 2114;
        v141 = v116;
        _os_log_impl(&dword_1D49D5000, v114, OS_LOG_TYPE_INFO, "%{public}@Dropping post fetch because new query was added: %{public}@", buf, 0x16u);
    ...
    else
    {
      ...
      if (v118 == 9)
      {
        if (os_log_type_enabled(v119, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v140 = 2114;
          v141 = v121;
          _os_log_impl(&dword_1D49D5000, v114, OS_LOG_TYPE_INFO, "%{public}@Adding cloud post fetch operation %{public}@", buf, 0x16u);
        }
        if (([*(id *)(a1 + 32) addCloudPostFetchOperationIfNonePresent:*(void *)(a1 + 40)] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v124, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v140 = 2114;
            v141 = v126;
            _os_log_impl(&dword_1D49D5000, v124, OS_LOG_TYPE_INFO, "%{public}@Already have a post fetch operation scheduled, dropping operation %{public}@", buf, 0x16u);
          }
          [*(id *)(a1 + 32) _dropWithoutAlreadyScheduledOperation:*(void *)(a1 + 40)];
        }
        return [*(id *)(a1 + 32) _handleNextOperation];
      ...
      if (os_log_type_enabled(v119, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v140 = 2114;
        v141 = v127;
        _os_log_impl(&dword_1D49D5000, v114, OS_LOG_TYPE_ERROR, "%{public}@Unknown sync operation type, dropping %{public}@", buf, 0x16u);
        goto LABEL_101;
      }
    }
...
LABEL_54:
    ...
    if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v140 = 2114;
      v141 = v74;
      _os_log_impl(&dword_1D49D5000, v72, OS_LOG_TYPE_INFO, "%{public}@Adding cloud fetch operation %{public}@", buf, 0x16u);
    }
...
LABEL_49:
  ...
  *(_DWORD *)buf = 138543618;
  ...
  uint32_t v54 = 22;
LABEL_35:
  _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, v52, buf, v54);
...
- (void)_dropWithoutAlreadyScheduledOperation:(id)a3
{
  uint64_t v15 = *MEMORY[0x1E4F143B8];
  id v3 = a3;
  id v4 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23 description:@"Operation was dropped before it could run" reason:@"HMDSyncOperationManager dropped the operation" suggestion:0];
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
...
- (void)addOperation:(id)a3 withDelay:(double)a4
{
  ...
  if (a4 > 0.0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding operation delay, respect this delay: %@", (uint8_t *)&v14, 0x16u);
    }
...
- (void)_reportPossibleSyncLoop
{
    ...
    && ![(HMDSyncOperationManager *)self wasSyncLoopDialogDisplayed])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138543362;
      long long v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Presenting dialog about possible sync loop", (uint8_t *)&v11, 0xCu);
    }
...
- (HMDSyncOperationManager)initWithClientQueue:(id)a3 dataSource:(id)a4
{
  return [(HMDSyncOperationManager *)self initWithClientQueue:a3 dataSource:a4 timerFactory:&__block_literal_global_131_95806];
}

id __58__HMDSyncOperationManager_initWithClientQueue_dataSource___block_invoke(double a1)
{
  v1 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:1 options:a1];
  return v1;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t53_95810 != -1) {
    dispatch_once(&logCategory__hmf_once_t53_95810, &__block_literal_global_149_95811);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v54_95812;
  return v2;
}
...
uint64_t __38__HMDSyncOperationManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v54_95812;
  logCategory__hmf_once_v54_95812 = v0;
