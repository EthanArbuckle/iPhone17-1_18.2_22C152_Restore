...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_3390 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_3390, &__block_literal_global_3391);
  }
  v2 = (void *)logCategory__hmf_once_v2_3392;
  return v2;
}

uint64_t __47__HMDMicroLocationLogEventObserver_logCategory__block_invoke()
{
  logCategory__hmf_once_v2_3392 = HMFCreateOSLogHandle();
  ...
  if (a1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        int v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Event ineligible for donation because data source is nil", (uint8_t *)&v17, 0xCu);
      }
      a1 = 0;
    }
  }
