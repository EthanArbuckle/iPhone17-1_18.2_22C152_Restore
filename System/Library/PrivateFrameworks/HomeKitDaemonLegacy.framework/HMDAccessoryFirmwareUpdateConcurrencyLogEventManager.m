...
- (void)stopWithCategory:(unint64_t)a3 accessory:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v10 != a3)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v42 = 2112;
        v43 = v23;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping with mismatched categories current: %@, at start: %@", (uint8_t *)&v38, 0x20u);
      }
    }
    p_lock = &self->_lock;
    os_unfair_lock_lock_with_options();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v42 = 2112;
        v43 = v6;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Stopping category %@ when current activity is 0 for accessory %@", (uint8_t *)&v38, 0x20u);
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v42 = 2112;
      v43 = v6;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping %@ when nothing is in progress for accessory %@", (uint8_t *)&v38, 0x20u);
    }
  }
}
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (a3 - 1 > 6) {
        ...
        uint64_t v14 = off_1E6A0D758[a3 - 1];
      }
      ...
      __int16 v37 = 2112;
      id v38 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Starting %@ while %@ is in progress for accessory %@", (uint8_t *)&v31, 0x2Au);
    }
...
- (HMDAccessoryFirmwareUpdateConcurrencyLogEventManager)initWithCountersManager:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v8 = [objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:7];
    currentActivity = v7->_currentActivity;
    v7->_currentActivity = (NSMutableArray *)v8;

    uint64_t v10 = [objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:7];
    ...
    {
      [(NSMutableArray *)v7->_currentActivity setObject:&unk_1F2DC8140 atIndexedSubscript:i];
      [(NSMutableArray *)v7->_peakActivity setObject:&unk_1F2DC8140 atIndexedSubscript:i];
    }
  }
