...
- (id)dataSourceHubAccessories
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source hub accessories due to no data source", (uint8_t *)&v11, 0xCu);
    }
    v5 = 0;
  }
...
- (id)dataSourceSiriEndpointOnboardingManager
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source Siri Endpoint Onboarding Manager due to no data source", (uint8_t *)&v11, 0xCu);
    }
    v5 = 0;
  }
...
- (id)deleteHistoryForAccessoryUUID:(id)a3 onHubAccessory:(id)a4
{
  v5 = (objc_class *)MEMORY[0x1E4F7A0D8];
  id v6 = a4;
  id v7 = a3;
...
- (id)deleteHistoryForAccessoryUUID:(id)a3 onHubAccessories:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    id v32 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Deleting siri history for accessory UUID: %@ on hub accessories: %@", buf, 0x20u);
  }
  ...
  v16 = [MEMORY[0x1E4F7A0D8] chainFutures:v15];
...
void __87__HMDSiriEndpointProfileMessageHandler_deleteHistoryForAccessoryUUID_onHubAccessories___block_invoke_4(uint64_t a1)
{
  ...
  {
    id v2 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:18];
...
- (void)handleSiriEndpointDeleteSiriHistoryRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v40 = 2112;
    id v41 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handle siri endpoint delete siri history request message: %@", buf, 0x16u);
  }
  id v9 = [v4 messagePayload];
  if (v9)
  {
    v10 = (void *)[objc_alloc(MEMORY[0x1E4F2EAF8]) initWithPayload:v9];
    if (v10)
    {
      ...
      {
        id v13 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v42 = 2112;
          v43 = v13;
          _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to get hub accessories to handle delete siri history request message: %@ error: %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v42 = 2112;
        v43 = v11;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode message payload from delete siri history message payload: %@ error: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v42 = 2112;
      v43 = v10;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from delete siri history message: %@ error: %@", buf, 0x20u);
    }
...
void __90__HMDSiriEndpointProfileMessageHandler_handleSiriEndpointDeleteSiriHistoryRequestMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Delete siri history failed for accessory uuid: %@ using hub accessories: %@ error: %@", (uint8_t *)&v10, 0x2Au);
  }
...
void __90__HMDSiriEndpointProfileMessageHandler_handleSiriEndpointDeleteSiriHistoryRequestMessage___block_invoke_6(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    uint64_t v12 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Delete siri history succeeded for accessory uuid: %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)handleSiriEndpointApplyOnboardingSelectionsRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v31 = 2112;
    id v32 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling siri endpoint apply onboarding selections request message: %@", buf, 0x16u);
  }
  int v9 = [v4 messagePayload];
  if (v9)
  {
    int v10 = (void *)[objc_alloc(MEMORY[0x1E4F2EAE8]) initWithPayload:v9];
    if (v10)
    {
      __int16 v11 = [(HMDSiriEndpointProfileMessageHandler *)v6 dataSourceSiriEndpointOnboardingManager];
      if (v11)
      {
        uint64_t v12 = objc_msgSend(MEMORY[0x1E4F29128], "hmf_zeroUUID");
      ...
      {
        uint64_t v15 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:3];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v31 = 2112;
        id v32 = v9;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode onboarding message payload: %@", buf, 0x16u);
      }
      __int16 v11 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:3];
      [v4 respondWithError:v11];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v4;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get onboarding message payload on message: %@", buf, 0x16u);
    }
    int v10 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:8];
    [v4 respondWithError:v10];
  }
}
...
void __98__HMDSiriEndpointProfileMessageHandler_handleSiriEndpointApplyOnboardingSelectionsRequestMessage___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      __int16 v18 = 2112;
      id v19 = v5;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply onboarding selections failed with error: %@", (uint8_t *)&v16, 0x16u);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      __int16 v18 = 2112;
      id v19 = v12;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply result received from onboarding manager: %@", (uint8_t *)&v16, 0x16u);
    }
    uint64_t v13 = (void *)[objc_alloc(MEMORY[0x1E4F2EAF0]) initWithOnboardingResult:a3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14 != -1) {
    dispatch_once(&logCategory__hmf_once_t14, &__block_literal_global_21062);
  }
