...
- (void)__handleFirmwareVersionUpdate:(id)a3
{
  ...
  if (v8)
  {
    v9 = (void *)[objc_alloc(MEMORY[0x1E4F65558]) initWithVersionString:v8];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Update fetched firmware version not available for accessory %@", (uint8_t *)&v14, 0x16u);
    }
  }
}
...
- (void)_updateStagedFirmwareVersion:(id)a3
{
  ...
  id v5 = a3;
  if (v5) {
    v6 = (void *)[objc_alloc(MEMORY[0x1E4F65558]) initWithVersionString:v5];
  }
  else {
    v6 = 0;
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    v22 = v6;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@StagedFirmwareVersion changed from %@ to %@", (uint8_t *)&v17, 0x20u);
  }
...
- (void)__handleFirmwareUpdateReadinessUpdate:(id)a3
{
  ...
  id v18 = 0;
  BOOL v9 = [MEMORY[0x1E4F5BD40] parsedFromData:v8 error:&v18];
  id v10 = v18;
  if (v10)
  {
    v11 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v27 = 2112;
      id v28 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse firmware update readiness (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
    }
  }
  else
  {
...
- (void)__handleFirmwareUpdateStatusUpdate:(id)a3
{
  ...
  id v28 = 0;
  BOOL v9 = [MEMORY[0x1E4F5BD48] parsedFromData:v8 error:&v28];
  id v10 = v28;
  if (v10)
  {
    v11 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v37 = 2112;
      id v38 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse firmware update status (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
...
LABEL_14:
      _os_log_impl(&dword_1D49D5000, v20, v21, v19, buf, 0xCu);
      goto LABEL_15;
    }
  }
  else
...
- (void)_handleCharacteristicChanges:(id)a3
{
  ...
  if (v8)
  {
    ...
    uint64_t v34 = *MEMORY[0x1E4F2CEF0];
    uint64_t v33 = *MEMORY[0x1E4F5B898];
      ...
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        if (v21)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = v31;
            v40 = v25;
            _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Firmware Update Profile _handleCharacteristicChanges: characteristic update for HMCharacteristicTypeFirmwareVersion", buf, 0xCu);
        ...
        else
        {
          ...
          if (v27)
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = v31;
              v40 = v30;
              _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEBUG, "%{public}@Firmware Update Profile _handleCharacteristicChanges: characteristic update for HAPCharacteristicUUID_MatterFirmwareRevisionNumber", buf, 0xCu);
...
uint64_t __64__HMDAccessoryFirmwareUpdateProfile_handleAccessoryIsReachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is now reachable", (uint8_t *)&v7, 0xCu);
  }
...
void __71__HMDAccessoryFirmwareUpdateProfile_handleCharacteristicValuesChanged___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v27 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Already handled updated accessory firmware version", buf, 0xCu);
    }
  }
  else
  {
...
- (void)_registerForNotifications
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v10 = 138543362;
      id v11 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Not registering for notifications as accessory is nil", (uint8_t *)&v10, 0xCu);
    }
  }
}
...
- (void)_updateAccessoryFirmwareVersion:(id)a3
{
  ...
  if (v8)
  {
    if ([v6 supportsCHIP])
    {
      ...
      uint64_t v29 = v9;
      int v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v29 count:1];
    ...
    else
    {
      ...
      id v26 = v9;
      int v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v26 count:1];
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v4;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory version=%@ is different than fetched version=%@", (uint8_t *)&v20, 0x20u);
    }
  ...
  if ([(HMDAccessoryFirmwareUpdateProfile *)self updateNotReadyReasons] == a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2114;
      uint64_t v15 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Update Not Ready Reasons not changed: %{public}@", buf, 0x16u);
    }
  }
  else
  {
  ...
  if ([(HMDAccessoryFirmwareUpdateProfile *)self stagingNotReadyReasons] == a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2114;
      uint64_t v15 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Staging Not Ready Reasons not changed: %{public}@", buf, 0x16u);
    }
  }
  else
  {
  ...
  if (v5 == a3)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      long long v23 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@State not changed: %@", buf, 0x16u);
    }
  }
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v24 = 2112;
      id v25 = v14;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating firmware update state from %@ to %@", buf, 0x20u);
    }
...
- (void)readAndProcessCharacteristics:(id)a3 withCompletion:(id)a4
{
  ...
  else
  {
    ...
    uint64_t v15 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(v6, "count"));
    long long v32 = 0u;
    long long v33 = 0u;
    long long v30 = 0u;
    long long v31 = 0u;
  ...
  if (WeakRetained)
  {
    ...
    if (v5)
    {
      ...
      *(void *)&v49[16] = 0x3032000000;
      v50 = __Block_byref_object_copy__155262;
      v51 = __Block_byref_object_dispose__155263;
      uint64_t v32 = a1;
...
- (HMDAccessoryFirmwareUpdateProfile)updateProfileWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v29 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating accessory firmware update profile", buf, 0xCu);
  }
  uint64_t v10 = [(HMDAccessoryFirmwareUpdateProfile *)v7 characteristics];
  id v11 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA80]), "initWithCapacity:", objc_msgSend(v10, "count") + 1);
  long long v23 = 0u;
  long long v24 = 0u;
  long long v25 = 0u;
  long long v26 = 0u;
...
- (id)characteristics
{
  int v3 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"00000235-0000-1000-8000-0026BB765291", @"00000234-0000-1000-8000-0026BB765291", 0);
...
- (id)matterFirmwareVersionCharacteristic
{
  ...
  if ([v2 supportsCHIP])
  {
    int v3 = [v2 findCharacteristicType:*MEMORY[0x1E4F5B898] forServiceType:*MEMORY[0x1E4F2DDB8]];
  }
  else
  {
    int v3 = 0;
...
{
  v2 = [(HMDAccessoryFirmwareUpdateProfile *)self accessory];
  int v3 = [v2 findCharacteristicType:*MEMORY[0x1E4F2CEF0] forServiceType:*MEMORY[0x1E4F2DDB8]];
...
- (void)_enableCharacteristicsNotifications:(BOOL)a3
{
  ...
  if (v3)
  {
    ...
    [(HMDAccessoryFirmwareUpdateProfile *)self readAndProcessCharacteristics:v13 withCompletion:&__block_literal_global_49];
  }
}
...
uint64_t __60__HMDAccessoryFirmwareUpdateProfile_monitorCharacteristics___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Monitoring characteristics set to %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)configure
{
  ...
  if ([v5 isReachable])
  {
    ...
    BOOL v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v10 count:3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_155295 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_155295, &__block_literal_global_155296);
  }
  v2 = (void *)logCategory__hmf_once_v2_155297;
  return v2;
}

uint64_t __48__HMDAccessoryFirmwareUpdateProfile_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v2_155297;
  logCategory__hmf_once_v2_155297 = v0;
