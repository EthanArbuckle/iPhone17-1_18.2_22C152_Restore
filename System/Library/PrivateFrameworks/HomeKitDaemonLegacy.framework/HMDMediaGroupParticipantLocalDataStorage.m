...
- (void)updateBackupGroupData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    v29 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Update backup groups: count(%@)", (uint8_t *)&v26, 0x16u);
  }
  logger = v6->_logger;
  if (os_signpost_enabled(logger))
  {
    LOWORD(v26) = 0;
    _os_signpost_emit_with_name_impl(&dword_1D49D5000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "MediaGroupsParticipantUpdateBackupGroup", "", (uint8_t *)&v26, 2u);
  }
  ...
  v17 = [MEMORY[0x1E4F1CAD0] setWithArray:v4];
...
LABEL_11:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    v29 = v23;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Skipping backup groups update due to no change to values: count(%@)", (uint8_t *)&v26, 0x16u);
  }
LABEL_12:
}
...
- (void)updateDestinationSupportOptions:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destination support options: %@", (uint8_t *)&v19, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      v22 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination support options: %@ due to no destination data", (uint8_t *)&v19, 0x16u);
    }
  }
}
...
- (void)updateAudioGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating audio group identifier: %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to update audio group identifier: %@ due to no destination data", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)updateMediaDestination:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating media destination: %@", (uint8_t *)&v18, 0x16u);
  }
  logger = v6->_logger;
  if (os_signpost_enabled(logger))
  {
    LOWORD(v18) = 0;
    _os_signpost_emit_with_name_impl(&dword_1D49D5000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "MediaGroupsParticipantUpdateDestination", "", (uint8_t *)&v18, 2u);
  }
  v10 = [(HMDMediaGroupParticipantLocalDataStorage *)v6 participantData];
  v11 = [v10 destination];
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v4;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping destination update due to no changed in value: %@", (uint8_t *)&v18, 0x16u);
    }
  }
  else
  {
...
- (void)updateDestinationControllerAvailableDestinationIdentifiers:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destination controller available destination identifiers: %@", (uint8_t *)&v17, 0x16u);
  }
  v9 = [(HMDMediaGroupParticipantLocalDataStorage *)v6 participantData];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination controller available destination identifiers: %@ due to no controller data", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)updateDestinationControllerSupportedOptions:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destination controller supported options: %@", (uint8_t *)&v19, 0x16u);
  }
  v10 = [(HMDMediaGroupParticipantLocalDataStorage *)v6 participantData];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination controller supported options: %@ due to no controller data", (uint8_t *)&v19, 0x16u);
    }
  }
}
...
- (void)notifyDidChangeDestinationIdentifier:(id)a3 forDestinationControllerIdentifier:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of updated destination identifier due to missing delegate", (uint8_t *)&v14, 0xCu);
    }
  }
}
...
- (void)updateDestinationControllerDestinationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating destinaiton controller destination identifier: %@", (uint8_t *)&v18, 0x16u);
  }
  v9 = [(HMDMediaGroupParticipantLocalDataStorage *)v6 participantData];
  v10 = [v9 destinationControllerData];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v4;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination controller destination identifier: %@ due to no controller data", (uint8_t *)&v18, 0x16u);
    }
  }
}
...
- (void)updateDestinationControllerData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating DestinationControllerData: %@", (uint8_t *)&v18, 0x16u);
  }
  logger = v6->_logger;
  if (os_signpost_enabled(logger))
  {
    LOWORD(v18) = 0;
    _os_signpost_emit_with_name_impl(&dword_1D49D5000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "MediaGroupsParticipantUpdateDestinationController", "", (uint8_t *)&v18, 2u);
  }
  v10 = [(HMDMediaGroupParticipantLocalDataStorage *)v6 participantData];
  v11 = [v10 destinationControllerData];
  int v12 = HMFEqualObjects();
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v4;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping update destination controller due to no change to value: %@", (uint8_t *)&v18, 0x16u);
    }
  }
  else
  {
...
- (void)updateParticipantData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating participant data: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (id)topicName
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      int v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic name due to no data source", (uint8_t *)&v11, 0xCu);
    }
    v5 = 0;
  }
...
- (void)publishCachedObject
{
    ...
    else
    {
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v21;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to publish data due to no topic name or event source", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping publish due to no data", buf, 0xCu);
    }
  }
}
...
void __63__HMDMediaGroupParticipantLocalDataStorage_publishCachedObject__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Forwarding event completed with error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
  ...
  if ([(HMDMediaGroupParticipantLocalDataStorage *)self hasDataToPublishInParticipantData:v3])
  {
    ...
    if (v5)
    {
      if (v9)
      {
        ...
        __int16 v14 = 2112;
        uint64_t v15 = v4;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Skipping publish due to last cached event participant data: %@", (uint8_t *)&v12, 0x16u);
      }
    }
    else
    {
      if (v9)
      {
        ...
        int v12 = 138543362;
        id v13 = v11;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Publishing cached object due to mismatching last cached event data", (uint8_t *)&v12, 0xCu);
      }
...
- (void)migrateWithExpectedDestinationControllerSupportOptions:(unint64_t)a3
{
  ...
  if (v5)
  {
    if ([v5 supportedOptions] != a3)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v19 = 2112;
        __int16 v20 = v11;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Migrating expected destination controller support options: %@", (uint8_t *)&v17, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempted to migrate with expected support options: %@ without a destination controller", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (id)migratedParticipantData:(id)a3 withDestinationSupportOptions:(unint64_t)a4
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      __int16 v25 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Attempted to migrate expected destination support options: %@ without a destination", (uint8_t *)&v22, 0x16u);
    }
    goto LABEL_9;
  }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    __int16 v25 = v13;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Migrating supported options to: %@", (uint8_t *)&v22, 0x16u);
  }
...
- (id)createDefaultParticipantData
{
  ...
  id v3 = [(HMDMediaGroupsParticipantData *)v2 initWithDestination:0 destinationControllerData:0 backedUpGroups:MEMORY[0x1E4F1CBF0]];
  return v3;
}
...
- (id)lastCachedEventParticipantData
{
    ...
    if (v5)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v24 = 2112;
          __int16 v25 = v5;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode last cached event participant data: %@ from event: %@", (uint8_t *)&v20, 0x20u);
        }
      }
    }
    else
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v20 = 138543362;
      uint64_t v21 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last cached event participant data due to missing topic name", (uint8_t *)&v20, 0xCu);
    }
    int v8 = 0;
  }
...
- (id)protoParticipantData
{
  ...
  if (v3)
  {
    id v4 = (void *)[objc_alloc(MEMORY[0x1E4F2E908]) initWithData:v3];
    if (v4) {
      goto LABEL_5;
    }
    _HMFPreconditionFailure();
...
- (void)configureWithHome:(id)a3 messageDispatcher:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    __int16 v14 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring media groups participant local storage", (uint8_t *)&v13, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t39_173416 != -1) {
    dispatch_once(&logCategory__hmf_once_t39_173416, &__block_literal_global_173417);
  }
  v2 = (void *)logCategory__hmf_once_v40_173418;
  return v2;
}
...
uint64_t __55__HMDMediaGroupParticipantLocalDataStorage_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v40_173418;
  logCategory__hmf_once_v40_173418 = v0;
