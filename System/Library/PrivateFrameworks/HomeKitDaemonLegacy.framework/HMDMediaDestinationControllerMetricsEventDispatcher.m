...
- (id)dataSourceIsTriggeredOnControllerDevice
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get is triggered on controller device due to no data source", (uint8_t *)&v11, 0xCu);
    }
    v5 = @"NotSet";
  }
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        int v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination type due to no data source", (uint8_t *)&v13, 0xCu);
      }
    }
...
- (id)dataSourceCurrentDestinationType
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current destination type due to no data source", (uint8_t *)&v13, 0xCu);
    }
    HMMediaDestinationTypeAsString();
    v7 = (__CFString *)objc_claimAutoreleasedReturnValue();
  }
...
- (id)dataSourceCurrentUser
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      int v13 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to get current user from data source: %@", (uint8_t *)&v10, 0x16u);
    }
  }
...
- (void)submitDailySetDestinationEvent
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v20 = 138543362;
    v21 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Submitting daily set destination event", (uint8_t *)&v20, 0xCu);
  }
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      uint32_t v19 = 12;
LABEL_10:
      _os_log_impl(&dword_1D49D5000, v17, v18, v16, (uint8_t *)&v20, v19);
    }
LABEL_11:
...
- (void)submitStagedDestinationIdentifierCommittedEventWithCommittedDestinationIdentifier:(id)a3
{
    ...
    && ([(HMDMediaDestinationControllerStagedDestinationIdentifierCommittedEvent *)v5 stagedDestinationIdentifier], v7 = objc_claimAutoreleasedReturnValue(), char v8 = HMFEqualObjects(), v7, (v8 & 1) != 0))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@submitting staged destination identifier committed event with committed destination identifier: %@", (uint8_t *)&v19, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      int v20 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping staged destination identifier committed event due to out-dated information", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
- (void)startStagedDestinationIdentifierCommittedEventWithStagedDestinationIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Tracking staged destination identifier: %@", (uint8_t *)&v13, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12 != -1) {
    dispatch_once(&logCategory__hmf_once_t12, &__block_literal_global_42568);
  }
...
uint64_t __66__HMDMediaDestinationControllerMetricsEventDispatcher_logCategory__block_invoke()
{
  ...
  logCategory__hmf_once_int v13 = v0;
