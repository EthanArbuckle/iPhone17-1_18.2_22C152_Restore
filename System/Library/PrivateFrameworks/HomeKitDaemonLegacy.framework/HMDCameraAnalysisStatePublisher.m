...
- (void)stateManager:(id)a3 didReceiveLocalUpdate:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received local analysis state update: %@", buf, 0x16u);
  }
...
- (void)_handleRemoteAnalysisStateUpdate:(id)a3
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v8;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling remote state update: %@", (uint8_t *)&v17, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v16;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Received nil analysis state update from message with identifier: %@", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)_publishAnalysisStateUpdate
{
  ...
  if (v4)
  {
    ...
    id v21 = 0;
    v5 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:&v21];
    id v6 = v21;
    if (v5)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v28 = 2112;
        id v29 = v6;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize %@: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invoking _publishAnalysisStateUpdate with nil stateUpdate!", buf, 0xCu);
    }
  }
}
...
void __62__HMDCameraAnalysisStatePublisher__publishAnalysisStateUpdate__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (([v4 isCurrentDevice] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending state update to %@", (uint8_t *)&v17, 0x16u);
    }
...
- (HMDCameraAnalysisStatePublisher)initWithHome:(id)a3
{
  id v4 = (objc_class *)MEMORY[0x1E4F697C0];
  id v5 = a3;
  id v6 = [v4 alloc];
  id v7 = [v5 uuid];
  v8 = (void *)[v6 initWithHomeUUID:v7];

  char v9 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:8 options:16.0];
  id v10 = [v5 workQueue];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_31948 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_31948, &__block_literal_global_31949);
  }
  v2 = (void *)logCategory__hmf_once_v7_31950;
  return v2;
}
...
uint64_t __46__HMDCameraAnalysisStatePublisher_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v7_31950;
  logCategory__hmf_once_v7_31950 = v0;
