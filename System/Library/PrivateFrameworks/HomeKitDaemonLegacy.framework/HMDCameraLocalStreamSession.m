...
- (void)updateState:(int64_t)a3
{
  ...
  v5 = (void *)MEMORY[0x1D9452090]([(HMDCameraLocalStreamSession *)self setStreamState:[(HMDCameraLocalStreamSession *)self streamState] | a3]);
  BOOL v6 = self;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_163782 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_163782, &__block_literal_global_163783);
  }
  v2 = (void *)logCategory__hmf_once_v2_163784;
  return v2;
}
...
uint64_t __42__HMDCameraLocalStreamSession_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_163784;
  logCategory__hmf_once_v2_163784 = v0;
