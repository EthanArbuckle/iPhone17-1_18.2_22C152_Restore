...
+ (id)identifierForKey:(id)a3
{
  ...
  id v3 = a3;
  CC_SHA256_Init(&v8);
  id v4 = objc_msgSend(MEMORY[0x1E4F1CA58], "dataWithBytes:length:", "key-identifier", 14, *(_OWORD *)v8.count, *(_OWORD *)&v8.hash[2], *(_OWORD *)&v8.hash[6], *(_OWORD *)&v8.wbuf[2], *(_OWORD *)&v8.wbuf[6], *(_OWORD *)&v8.wbuf[10], *(void *)&v8.wbuf[14]);
  [v4 appendData:v3];

  id v5 = v4;
  CC_SHA256_Update(&v8, (const void *)[v5 bytes], objc_msgSend(v5, "length"));
  CC_SHA256_Final(md, &v8);
  id v6 = [MEMORY[0x1E4F1C9B8] dataWithBytes:md length:8];
...
+ (id)createWithExternalRepresentation:(id)a3
{
  ...
  {
    CC_SHA256_CTX v8 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nfc reader key external representation length %lu", (uint8_t *)&v12, 0x16u);
    }
    id v7 = 0;
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v21 = 2112;
        CFErrorRef v22 = v9;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to copy nfc reader key external representation: %@", buf, 0x16u);
      }
      uint64_t v10 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      CFErrorRef v22 = v7;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to create nfc reader key: %@", buf, 0x16u);
    }
    uint64_t v10 = 0;
  }
...
- (id)createKeychainItemForHome:(id)a3
{
  ...
  if (v5)
  {
    id v6 = objc_alloc_init(MEMORY[0x1E4F5BDA0]);
    ...
    [v6 setSyncable:1];
    [v6 setType:&unk_1F2DC8878];
    CFErrorRef v7 = (void *)MEMORY[0x1E4F5BE48];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      v24 = v15;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keychain item for home: %@ from: %@, external representation is nil", (uint8_t *)&v19, 0x20u);
    }
    id v6 = 0;
  }
...
+ (id)createWithKeychainItem:(id)a3
{
  ...
  if (v6)
  {
    ...
    char v8 = [v7 isEqualToNumber:&unk_1F2DC8878];
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      id v20 = v4;
      __int16 v21 = 2112;
      id v22 = (__CFString *)&unk_1F2DC8878;
...
LABEL_8:
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v17, 0x20u);
    }
  }
