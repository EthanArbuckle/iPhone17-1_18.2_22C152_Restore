      ...
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v52 = 2114;
          v53 = v31;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to find leader identifier: %{public}@", buf, 0x16u);
      ...
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v52 = 2114;
          v53 = v14;
          _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Unable to find leader identifier: %{public}@", buf, 0x16u);
...
LABEL_18:
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, v22, buf, 0x16u);
...
LABEL_25:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 2114;
    v53 = v9;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unable to find responder identifier: %{public}@", buf, 0x16u);
  }
  v27 = 0;
LABEL_26:
...
+ (id)meshInformationWithMeshController:(id)a3 home:(id)a4
{
  ...
  v7 = [v6 residentDeviceManager];
  v8 = [v7 residentDevices];
  v9 = objc_msgSend(v8, "na_firstObjectPassingTest:", &__block_literal_global_24011);
  if (v9)
  {
    if ([v5 isLeader])
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)((char *)&buf + 4) = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to find responder, not creating mesh information", (uint8_t *)&buf, 0xCu);
    }
    uint64_t v15 = 0;
  }
