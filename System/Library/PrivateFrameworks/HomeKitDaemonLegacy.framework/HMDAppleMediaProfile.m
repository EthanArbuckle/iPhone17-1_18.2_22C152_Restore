...
- (void)didFinishLoadingRequestForController:(id)a3
{
  ...
  if (v4)
  {
    ...
    v8 = [v4 uuid];
    v9 = [v8 UUIDString];
    [v7 setObject:v9 forKeyedSubscript:*MEMORY[0x1E4F2DA18]];

    [v7 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:@"force-notify"];
    unint64_t v10 = [v6 state];
    if (v10 > 6) {
      uint64_t v11 = 3;
    }
    else {
      uint64_t v11 = qword_1D54D4490[v10];
    }
    v12 = [NSNumber numberWithInteger:v11];
    [v7 setObject:v12 forKeyedSubscript:*MEMORY[0x1E4F2D9B8]];
    ...
    [v7 setObject:v17 forKeyedSubscript:*MEMORY[0x1E4F2DA10]];
    ...
    [v7 setObject:v22 forKeyedSubscript:*MEMORY[0x1E4F2D9E0]];

    v23 = [v6 tracklist];
    v24 = [v23 uniqueIdentifier];
    [v7 setObject:v24 forKeyedSubscript:*MEMORY[0x1E4F2D9A0]];

    v25 = [v4 state];
    v26 = [v25 volume];
    [v7 setObject:v26 forKeyedSubscript:*MEMORY[0x1E4F2DA20]];
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138545154;
      ...
      __int16 v59 = 2112;
      v60 = v7;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@didFinishLoadingRequestForController called for mediaSession:%@ pb:%tu s:%tu r:%tu v:%@ m:%@ userInfo:%@", buf, 0x52u);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Media profile is part of a media system - passing on handling the audio control  update notification for session", buf, 0xCu);
    }
  }
  else
  {
...
- (void)_handleSetValue:(id)a3 withRequestProperty:(id)a4 withCompletionHandler:(id)a5
{
  ...
  if (v13)
  {
    ...
    if (([(__CFString *)v12 isDeviceReachable] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v58 = 2112;
        __int16 v59 = v12;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Attempting to send message: %@ to unreachable accessory: %@", buf, 0x20u);
      }
    }
    ...
    if (v21)
    {
      ...
      __int16 v51 = v9;
      uint64_t v52 = v21;
      v22 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v52 forKeys:&v51 count:1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v58 = 2112;
          __int16 v59 = v49;
          _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Sending remote message to device (%@) for set value execution with request property %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v56 = 2112;
        __int16 v57 = v19;
        _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@The value %@ passed in is either nil or non NSNumber", buf, 0x16u);
      }
      v22 = +[HMDMediaPropertyRequest requestWithProperty:v9 mediaProfile:v36];
      v32 = v9;
      v39 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      __int16 v57 = v12;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@The device of Media Accessory %@ is not found", buf, 0x16u);
    }
...
- (BOOL)_updateRefreshPlayback:(id)a3
{
  ...
  if (![(HMDMediaProfile *)&v29 _updateRefreshPlayback:v4])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@No local session for mediaProfile - attempting to redispatch the command to resident/device", buf, 0xCu);
    }
    id v28 = 0;
    ...
    if (v9)
    {
      ...
      [v4 arrayForKey:*MEMORY[0x1E4F2D9C8]];
      long long v26 = 0u;
      long long v27 = 0u;
      long long v24 = 0u;
      long long v25 = 0u;
      ...
      if (v12)
      {
        ...
        uint64_t v14 = *MEMORY[0x1E4F2D9B8];
        do
        {
          uint64_t v15 = 0;
          do
...
void __47__HMDAppleMediaProfile__updateRefreshPlayback___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    v6 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
...
- (BOOL)_updatePlayback:(id)a3
{
  ...
  if (![(HMDMediaProfile *)&v23 _updatePlayback:v4])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v26 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@No local session for mediaProfile - attempting to redispatch the command to resident/device", buf, 0xCu);
    }
    uint64_t v10 = *MEMORY[0x1E4F2D9B8];
    id v11 = [v4 numberForKey:*MEMORY[0x1E4F2D9B8]];
    if (v11)
    {
      id v22 = 0;
...
- (void)setMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v6;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting media system %@ on profile %@", (uint8_t *)&v10, 0x20u);
  }
  os_unfair_lock_lock_with_options();
...
- (HMDAppleMediaProfile)initWithAccessory:(id)a3 uniqueIdentifier:(id)a4 services:(id)a5 workQueue:(id)a6
{
  ...
  if (v11 && [v10 isCurrentAccessory])
  {
    ...
    uint64_t v15 = [MEMORY[0x1E4F76EA0] deviceActivePlayerPath];
