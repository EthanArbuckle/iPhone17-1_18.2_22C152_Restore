...
void __57__HMDAuthServer_sendActivationConfirmation_uuid_context___block_invoke_3(uint64_t a1)
{
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v6;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Activation confirmation with server failed with error: %@", (uint8_t *)&v15, 0x16u);
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        int v15 = 138543362;
        id v16 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Delegate does not implement didFinishActivation:context:", (uint8_t *)&v15, 0xCu);
      }
      id v13 = *(void **)(a1 + 40);
      uint64_t v12 = *(void *)(a1 + 48);
      id v14 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:-1 userInfo:0];
...
LABEL_14:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        uint32_t v14 = 12;
LABEL_12:
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v19, v14);
      }
    }

    id v16 = *(void **)(a1 + 40);
    uint64_t v17 = *(void *)(a1 + 56);
    id v18 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:-1 userInfo:0];
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Activation with server failed with error: %@", (uint8_t *)&v19, 0x16u);
  }
...
void __75__HMDAuthServer_sendPPIDInfoRequest_model_token_authFeatures_uuid_context___block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)MEMORY[0x1D9452090](inited);
  id v5 = *v2;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v57 = 2112;
    v58 = v13;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Requesting metadata for locale: %@, Model: %@, Language Code: %@, Country Code: %@ Identifier: %@, swAuthFeatures: %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v46 = v21;
    _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Checking token for HomeKit", buf, 0xCu);
  }
  uint64_t v17 = 1;
  if ((*(void *)(a1 + 80) & 2) != 0)
  {
LABEL_12:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v46 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Checking token for AirPlayAudio", buf, 0xCu);
    }
    v17 |= 2uLL;
  }
LABEL_15:
  if ([MEMORY[0x1E4F73380] isTokenValidForFeatures:v17 token:*(void *)(a1 + 40)])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v47 = 2112;
      v48 = v34;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Token validation failed for auth features: %@", buf, 0x16u);
    }
    v35 = *(void **)(a1 + 32);
    uint64_t v36 = *(void *)(a1 + 56);
    v37 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:-1 userInfo:0];
...
void __48__HMDAuthServer_getPPIDInfo_model_cert_context___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    __int16 v34 = 2112;
    v35 = v12;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Requesting Cert metadata for locale: %@, Model: %@, Language Code: %@, Country Code: %@ Identifier: %@", buf, 0x3Eu);
  }
  ...
  id v15 = [MEMORY[0x1E4F73370] sharedManager];
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v9 > 3) {
      ...
      id v10 = off_1E6A0CA30[v9];
    }
    int v28 = 138543618;
    uint64_t v29 = v8;
    __int16 v30 = 2112;
    id v31 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Retry timer expired for operation: %@", (uint8_t *)&v28, 0x16u);
  }
        ...
        if (v12 != 1)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            if (v26 > 3) {
              ...
              uint64_t v27 = off_1E6A0CA30[v26];
            }
            int v28 = 138543618;
            uint64_t v29 = v25;
            __int16 v30 = 2112;
            id v31 = v27;
            _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Invalid retry operation: %@", (uint8_t *)&v28, 0x16u);
          }
...
- (void)saveRetryOperation:(unint64_t)a3 token:(id)a4 authFeatures:(unint64_t)a5 uuid:(id)a6 context:(id)a7 locale:(id)a8 model:(id)a9
{
  ...
  {
    id v20 = objc_alloc(MEMORY[0x1E4F65580]);
...
- (void)_handleResponseMetadata:(id)a3 ppid:(id)a4 locale:(id)a5 context:(id)a6 error:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v57 = 2112;
    id v58 = v14;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Received metadata: %@ for PPID: %@, locale: %@", buf, 0x2Au);
  }
  uint64_t v36 = v13;
  v39 = v14;
...
void __67__HMDAuthServer__handleResponseMetadata_ppid_locale_context_error___block_invoke(uint64_t a1)
{
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v6;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Failed to get PPID Info from server with error: %@", buf, 0x16u);
    }
  ...
  {
    [*(id *)(a1 + 40) resetRetryOperation];
    id v7 = (void *)[objc_alloc(MEMORY[0x1E4F5BC08]) initWithName:*(void *)(a1 + 48) manufacturer:*(void *)(a1 + 56) modelName:*(void *)(a1 + 64) category:*(void *)(a1 + 72) certificationStatus:*(void *)(a1 + 80) denylisted:*(void *)(a1 + 88) ppid:*(void *)(a1 + 96)];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v17 = v12;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Delegate does not implement handlePPIDInfoResponse:context:", buf, 0xCu);
      }
      id v13 = *(void **)(a1 + 40);
      uint64_t v14 = *(void *)(a1 + 104);
      id v15 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:-1 userInfo:0];
...
- (void)retryOrReportFailure:(id)a3 context:(id)a4
{
  ...
  if (![v8 isEqual:*MEMORY[0x1E4F73368]])
  {
...
LABEL_10:
    uint64_t v18 = 55;
LABEL_11:
    uint64_t v19 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:v18 userInfo:0];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    int v20 = 138543362;
    id v21 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Network unavailable", (uint8_t *)&v20, 0xCu);
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v20 = 138543362;
    id v21 = v17;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Waiting to retry", (uint8_t *)&v20, 0xCu);
  }
LABEL_12:
}
...
- (void)_reportFailureWithContext:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    int v17 = 138543362;
    uint64_t v18 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failing activation", (uint8_t *)&v17, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      uint64_t v18 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Delegate does not implement didFinishActivation:context:", (uint8_t *)&v17, 0xCu);
    }
  }
}
...
LABEL_11:
  ...
  if (([v4 conformsToProtocol:&unk_1F2E99200] & 1) == 0)
  {
    uint64_t v14 = (void *)MEMORY[0x1D9452090]();
    id v12 = self;
    id v15 = HMFGetOSLogHandle();
  ...
  if (v6)
  {
    ...
    uint64_t v10 = [MEMORY[0x1E4F73380] sharedManager];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t21_69381 != -1) {
    dispatch_once(&logCategory__hmf_once_t21_69381, &__block_literal_global_69382);
  }
  v2 = (void *)logCategory__hmf_once_v22_69383;
  return v2;
}
...
uint64_t __28__HMDAuthServer_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v22_69383;
  logCategory__hmf_once_v22_69383 = v0;
