...
- (NSDictionary)deviceCapabilitiesAndEnablementsDimensions
{
  ...
  if (!deviceCapabilitiesAndEnablementsDimensions)
  {
    ...
    [v5 setObject:MEMORY[0x1E4F1CC28] forKeyedSubscript:@"isHH2Enabled"];
    [v5 setObject:&unk_1F2DC73F0 forKeyedSubscript:@"isHH2Enabled_INT"];
...
- (void)addDimensionsForAccessoryIdentifier:(id)a3 toEventDictionary:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2114;
      id v17 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Accessory with identifier %{public}@ doesn't exist", (uint8_t *)&v14, 0x16u);
    }
  }
}
...
{
  id v4 = a3;
  id v22 = [(HMDCoreAnalyticsLogEventObserverDelegate *)self dataSource];
  ...
  v13 = NSNumber;
  int v14 = [v22 deviceStateProvider];
  ...
  id v17 = [v22 deviceStateProvider];
