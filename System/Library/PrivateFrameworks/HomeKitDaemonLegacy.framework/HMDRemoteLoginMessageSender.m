...
- (void)sendRemoteMessageWithName:(id)a3 payload:(id)a4 responseHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v33 = v25;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Remote device to send the message is nil", buf, 0xCu);
  }
  if (v10)
  {
    v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_99995 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_99995, &__block_literal_global_99996);
  }
  v2 = (void *)logCategory__hmf_once_v1_99997;
  return v2;
}
...
uint64_t __42__HMDRemoteLoginMessageSender_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_99997;
  logCategory__hmf_once_v1_99997 = v0;
