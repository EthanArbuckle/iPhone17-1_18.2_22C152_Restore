...
- (HMDMediaAccessoryAdvertisement)initWithOutputDevice:(id)a3
{
  ...
  if (+[HMDMediaAccessoryAdvertisement canAirPortExpressSupportMediaAccessory:v8])
  {
    ...
    v10 = (void *)[v9 initWithUUIDString:*MEMORY[0x1E4F2C188]];
    v11 = [MEMORY[0x1E4F2E520] categoryWithIdentifier:v10];
  }
  else
  {
    v11 = [MEMORY[0x1E4F2E520] categoryForProductClass:HMFProductClassFromString()];
  }
