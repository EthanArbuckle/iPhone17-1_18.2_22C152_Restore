      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v42 = 2048;
          uint64_t v43 = v34;
          _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Either file timestamp %@ or file data %tu is missing", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v40 = 2112;
        id v41 = v12;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Decoded object: %@ is not of type dictionary", buf, 0x16u);
      }
      BOOL v21 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      id v41 = v11;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive allowed IDS session options from relay data: %@", buf, 0x16u);
    }
    BOOL v21 = 0;
  }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 2112;
      id v22 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data from file at path: %@ error: %@", buf, 0x20u);
    }
    id v12 = 0;
  }
  else
...
LABEL_67:
      _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, v46, buf, 0x16u);
    }
LABEL_68:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v76, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v147 = 2112;
          double v148 = v22;
          _os_log_impl(&dword_1D49D5000, v76, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image for file path %@", buf, 0x16u);
        }
        id v52 = 0;
        v18 = v138;
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v147 = 2112;
        double v148 = v22;
        _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image source for file path %@", buf, 0x16u);
      }
      id v52 = 0;
    }
...
LABEL_40:
      ...
      if (![v78 unsignedIntegerValue])
      {
        ...
        if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v147 = 2112;
          double v148 = v91;
          _os_log_impl(&dword_1D49D5000, v94, OS_LOG_TYPE_INFO, "%{public}@Failed to save the file %@", buf, 0x16u);
        }
    ...
    if (os_log_type_enabled(v85, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      _os_log_impl(&dword_1D49D5000, v85, OS_LOG_TYPE_INFO, "%{public}@Initialized the snapshot file path %@, timestamp %@, aspect ratio %@", buf, 0x2Au);
    }
      ...
      *(double *)&size_t v28 = COERCE_DOUBLE(CGImageGetWidth(v26));
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v151 = 2048;
        size_t v152 = Height;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Image at %@ is of width %lu, height %lu", buf, 0x2Au);
      }
      ...
      if (Height == v38 && v28 == v35 || v28 == v38 && Height == v35)
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v147 = 2112;
          double v148 = v22;
          _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Given data matches the expected resolution for file path %@", buf, 0x16u);
        }
        uint64_t v23 = v139;
      ...
      else
      {
        ...
        if (ColorSpace)
        {
          ...
          if (v104)
          {
            ...
            if (v106)
            {
              v107 = (__CFData *)objc_alloc_init(MEMORY[0x1E4F1CA58]);
              v108 = CGImageDestinationCreateWithData(v107, (CFStringRef)*MEMORY[0x1E4F22610], 1uLL, 0);
              id v16 = v132;
              cf = v106;
              if (v108)
              {
                ...
                if (v110)
                {
                  ...
                  if (os_log_type_enabled(v111, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    __int16 v151 = 2048;
                    size_t v152 = v115;
                    _os_log_impl(&dword_1D49D5000, v112, OS_LOG_TYPE_INFO, "%{public}@Returning JPEG image of width: %lf, height: %lf, %tu bytes", buf, 0x2Au);
                  }
                  v116 = v130;
                  __int16 v42 = v130;
                }
                else
                {
                  ...
                  if (os_log_type_enabled(v111, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543362;
                    v146 = v128;
                    _os_log_impl(&dword_1D49D5000, v112, OS_LOG_TYPE_ERROR, "%{public}@Failing to finalize destination", buf, 0xCu);
                  }
                  __int16 v42 = 0;
                  v116 = v130;
                }
              ...
              else
              {
                ...
                if (os_log_type_enabled(v126, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v147 = 2112;
                  double v148 = v22;
                  _os_log_impl(&dword_1D49D5000, v126, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image destination for file path %@", buf, 0x16u);
                }
...
LABEL_62:
        ...
        if (os_log_type_enabled(v118, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v147 = 2112;
          double v148 = v22;
          _os_log_impl(&dword_1D49D5000, v118, OS_LOG_TYPE_ERROR, "%{public}@Failed to create resized image for file path %@", buf, 0x16u);
        }
        __int16 v42 = 0;
        v18 = v137;
        uint64_t v23 = v139;
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v147 = 2112;
      double v148 = v22;
      _os_log_impl(&dword_1D49D5000, v61, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image for file path %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v147 = 2112;
      double v148 = v22;
      _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image source for file path %@", buf, 0x16u);
...
LABEL_32:
  ...
  if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v146 = v74;
    _os_log_impl(&dword_1D49D5000, v66, OS_LOG_TYPE_INFO, "%{public}@Could not resize image, returning back the original", buf, 0xCu);
...
LABEL_63:
  ...
  if (os_log_type_enabled(v123, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v147 = 2112;
    double v148 = v22;
    _os_log_impl(&dword_1D49D5000, v123, OS_LOG_TYPE_INFO, "%{public}@Resizing file data for file path %@ resulted in 0 length data", buf, 0x16u);
  }
...
- (void)clearSlot
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing snapshot slot for snapshot %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)fillSlot
{
  ...
  if (![(HMDSnapshotFile *)self isFilled])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      uint64_t v13 = v4;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Filling snapshot slot for snapshot %@", (uint8_t *)&v10, 0x16u);
    }
    BOOL v7 = +[HMDSnapshotCATransactionHandler sharedHandler];
    BOOL v8 = [(HMDSnapshotFile *)v4 slotIdentifier];
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v32 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating HMDSnapshotFile", buf, 0xCu);
  }
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v33 = 2112;
          uint64_t v34 = v19;
          _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Deleting snapshot file at %@", buf, 0x16u);
        }
        ...
        if ((v22 & 1) == 0)
        {
          CFDataRef v24 = (void *)MEMORY[0x1D9452090]();
          v25 = v16;
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v35 = 2112;
            id v36 = v23;
            _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to delete snapshot file at %@: %@", buf, 0x20u);
          }
        }
      }
    }
...
- (id)copyFileAtPath:(id)a3 snapshotTimestamp:(id)a4
{
  ...
  if ((v7 & 1) == 0)
  {
    int v10 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1035];
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_74768 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_74768, &__block_literal_global_74769);
  }
  v2 = (void *)logCategory__hmf_once_v1_74770;
  return v2;
}

uint64_t __30__HMDSnapshotFile_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v1_74770;
  logCategory__hmf_once_v1_74770 = v0;
