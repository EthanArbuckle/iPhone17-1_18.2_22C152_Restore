...
+ (id)derivedMediaDestinationIdentifierForGroupIdentifier:(id)a3
{
  ...
  int v6 = (void *)MEMORY[0x1E4F29128];
  v7 = [v4 UUIDString];
...
LABEL_9:
  ...
  id v12 = objc_alloc(MEMORY[0x1E4F2E8C8]);
  v13 = [v8 identifier];
...
- (id)roomForAllDestinationParentIdentifiers:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get room for all destination parent identifiers: %@ data source: %@", (uint8_t *)&v19, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get room for all destination parent identifiers: %@ to no data source", (uint8_t *)&v19, 0x16u);
    }
    id v8 = 0;
  }
...
- (id)nameForMediaSystemData:(id)a3 room:(id)a4
{
  ...
  if (v8)
  {
    id v10 = [MEMORY[0x1E4F2E930] roomNameSentinel];
    char v11 = [v9 isEqual:v10];

    char v12 = v7;
    if ((v11 & 1) == 0)
    {
      id v13 = (void *)MEMORY[0x1D9452090](v7);
      unint64_t v14 = self;
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        int v18 = 138543362;
        int v19 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine default group name", (uint8_t *)&v18, 0xCu);
      }
      char v12 = v6;
    }
    id v9 = [v12 name];
...
- (id)aggregateDataWithDestinations:(id)a3 controllers:(id)a4 groups:(id)a5
{
  ...
  id v30 = a4;
  id v9 = a5;
  v36 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v9, "count"));
      ...
      do
      {
        ...
        if (v16)
        {
          ...
          if ([(id)objc_opt_class() isValidLeftDestination:v17 rightDestination:v18])
          {
            ...
            v41[1] = v20;
            __int16 v21 = [MEMORY[0x1E4F1C978] arrayWithObjects:v41 count:2];
