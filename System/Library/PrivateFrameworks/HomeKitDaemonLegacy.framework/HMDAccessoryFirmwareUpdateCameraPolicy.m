...
LABEL_13:
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, v10, (uint8_t *)&v20, 0xCu);
    ...
    {
      v6 = (void *)MEMORY[0x1D9452090]([(HMDAccessoryFirmwareUpdateCameraPolicy *)self _checkStreamingStatus]);
      v16 = self;
      v8 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
    ...
    v6 = (void *)MEMORY[0x1D9452090](v18);
    v19 = self;
    v8 = HMFGetOSLogHandle();
    BOOL v13 = 1;
    if (!os_log_type_enabled(v8, OS_LOG_TYPE_INFO)) {
...
LABEL_18:
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, v15, (uint8_t *)&v20, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v36 = 2112;
            id v37 = v10;
            _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid value type: %@", buf, 0x16u);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v36 = 2112;
    id v37 = v28;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", buf, 0x16u);
  }
...
- (void)_checkStreamingStatus
{
  ...
  uint64_t v5 = [v4 findCharacteristicsByType:*MEMORY[0x1E4F5B918] forServiceType:*MEMORY[0x1E4F2DDE8]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot find the stream status characteristic from any of the stream services", (uint8_t *)location, 0xCu);
    }
  }
}
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v45 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response for read of stream status", buf, 0xCu);
      }
      id v31 = v5;

      v35 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(*(id *)(a1 + 32), "count"));
      long long v39 = 0u;
      long long v40 = 0u;
      long long v41 = 0u;
      long long v42 = 0u;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v46 = 2112;
                v47 = v25;
                _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Read failed for %@", buf, 0x16u);
    ...
    else
    {
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v48 = 2112;
        id v49 = v5;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Read of characteristics %@ failed with error %@", buf, 0x20u);
      }
      id v6 = 0;
    }
  }
...
uint64_t __63__HMDAccessoryFirmwareUpdateCameraPolicy_handleSettingsChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Settings changed, updating policy status", (uint8_t *)&v7, 0xCu);
  }
...
- (void)_handleStreamStatusCharacteristicChanges
{
  ...
  id v4 = [(HMDAccessoryFirmwareUpdatePolicy *)self accessory];
  id v5 = [v4 findCharacteristicsByType:*MEMORY[0x1E4F5B918] forServiceType:*MEMORY[0x1E4F2DDE8]];
...
void __76__HMDAccessoryFirmwareUpdateCameraPolicy_handleCharacteristicValuesChanged___block_invoke(uint64_t a1)
{
  ...
  if ([v3 count])
  {
    ...
    if (v5)
    {
      ...
      uint64_t v8 = *MEMORY[0x1E4F5B918];
      do
      {
        uint64_t v9 = 0;
        do
...
uint64_t __82__HMDAccessoryFirmwareUpdateCameraPolicy_handleAccessoryUnconfiguredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is unconfigured, disabling stream status monitoring...", (uint8_t *)&v10, 0xCu);
  }
...
uint64_t __80__HMDAccessoryFirmwareUpdateCameraPolicy_handleAccessoryConfiguredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is configured, enabling stream status monitoring...", (uint8_t *)&v10, 0xCu);
  }
  id v6 = [MEMORY[0x1E4F28EB8] defaultCenter];
  uint64_t v7 = *(void **)(a1 + 32);
  uint64_t v8 = [v7 accessory];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_19566 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_19566, &__block_literal_global_19567);
  }
  v2 = (void *)logCategory__hmf_once_v1_19568;
  return v2;
}
...
uint64_t __53__HMDAccessoryFirmwareUpdateCameraPolicy_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_19568;
  logCategory__hmf_once_v1_19568 = v0;
