  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        int v13 = 138543362;
        v14 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification device was removed from account", (uint8_t *)&v13, 0xCu);
      }
      v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17 description:0 reason:@"Device was removed from account." suggestion:0];
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        uint64_t v15 = v12;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification account was removed from registry", (uint8_t *)&v14, 0xCu);
      }
      int v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17 description:0 reason:@"Account was removed from registry." suggestion:0];
      ...
      if (v11)
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            int v20 = 138543362;
            v21 = v18;
            _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Received notification peer identity was removed", (uint8_t *)&v20, 0xCu);
          }
          v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17 description:0 reason:@"Identity was removed." suggestion:0];
...
void __70__HMDSecureRemoteStream_handleSecureMessage_fromDevice_fromTransport___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    id v6 = *(void **)(a1 + 40);
    int v7 = [MEMORY[0x1E4F1CAD0] setWithObject:@"kIDSMessageSourceIDKey"];
    id v8 = [v6 secureDescriptionWithBlacklistKeys:v7];
    *(_DWORD *)buf = 138543618;
    v29 = v5;
    __int16 v30 = 2112;
    v31 = v8;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Received encrypted secure message: %@", buf, 0x16u);
  }
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      v31 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Unable to map productClass for device %@", buf, 0x16u);
    }
    id v16 = @"Unknown";
  }
  ...
  v27[3] = v23;
  v24 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v27 forKeys:v26 count:4];
...
void __96__HMDSecureRemoteStream_handleCompletedMessage_options_responsePayload_error_completionHandler___block_invoke(uint64_t a1)
{
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v36 = 2112;
        id v37 = v6;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize error with error: %@", buf, 0x16u);
      }
      id v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 description:@"Generic error." reason:@"Failed to deserialize remote error." suggestion:0 underlyingError:v6];
    }
  }
  else
  {
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v46 = 2114;
    uint64_t v47 = v20;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received response %{public}@ to secure message: %{public}@ and identifier %{public}@, with transport error: %{public}@, error: %{public}@, options: %{public}@", buf, 0x48u);
  }
  id v21 = [MEMORY[0x1E4F653F0] currentActivity];
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v32;
    _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@The session is now idle", buf, 0xCu);
  }
  [*(id *)(a1 + 40) setIdle:1];
}
...
void __55__HMDSecureRemoteStream_sendMessage_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v42 = 2112;
    id v43 = v14;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Sending message: %@", buf, 0x16u);
  }
  [*(id *)(a1 + 40) setIdle:0];
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v17;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Message serialization failed: %@", buf, 0x16u);
    }
  }
  ...
  v25 = [v2 name];
  v39[2] = v25;
  id v26 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v39 forKeys:v38 count:3];

  objc_initWeak((id *)buf, *(id *)(a1 + 40));
  id v27 = objc_alloc(MEMORY[0x1E4F653F0]);
  id v28 = MEMORY[0x1D94505D0](*(void *)(a1 + 40), *(void *)(a1 + 56));
...
- (void)_closeWithError:(id)a3
{
  ...
  if ([v4 conformsToProtocol:&unk_1F2E2A2D8]) {
    id v5 = v4;
  }
  else {
    id v5 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&location[4] = v27;
      __int16 v49 = 2112;
      id v50 = v10;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot open stream, failed to get local pairing identity with error: %@", location, 0x16u);
    }
    if (v6 && v7)
    {
      block[0] = MEMORY[0x1E4F143A8];
...
{
  id v2 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48 description:@"Not supported" reason:@"Cannot send messages without a valid pairing identity" suggestion:0 underlyingError:*(void *)(a1 + 32)];
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that remote session has stopped due to error: %@", (uint8_t *)&v9, 0x16u);
    }
      ...
      if ((v8 & 1) == 0)
      {
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            int v25 = 138543362;
            id v26 = v16;
            _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Swapping out the local pairing identifier for legacy remote sessions", (uint8_t *)&v25, 0xCu);
          }
          id v17 = objc_alloc(MEMORY[0x1E4F65508]);
      ...
      if (v13 && v11 != v13)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v78 = 2112;
          v79 = v13;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Peer device resolved from the registry -- tracked: %@, resolved: %@", buf, 0x20u);
...
LABEL_10:
        ...
        if (v32)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v75 = v36;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Successfully authenticated peer identity", buf, 0xCu);
          }
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v76 = 2112;
          id v77 = v50;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to authenticate peer identity for device: %@", buf, 0x16u);
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v80 = 2112;
          v81 = v69;
          _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@The provided pairing identity, %@, for peer, %@, is not registered to account: %@", buf, 0x2Au);
        ...
        if (a3)
        {
          [MEMORY[0x1E4F28C58] hmErrorWithCode:55];
          id v30 = 0;
...
LABEL_16:
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v75 = v29;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping account authentication check as the peer account is not authenticated", buf, 0xCu);
        }
LABEL_25:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v76 = 2112;
            id v77 = v63;
            _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDSecureSession] Unable to get the 'userID' from destination '%@'", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v78 = 2112;
        v79 = v44;
        _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find identity, %@, for peer: %@", buf, 0x20u);
      }
      if (a3)
      {
        [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:2 userInfo:0];
        id v30 = 0;
        *a3 = (id)objc_claimAutoreleasedReturnValue();
      }
      else
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_356(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v72 = 2112;
        long long v73 = v23;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Received request to setup reverse secure connection: %@", buf, 0x16u);
    ...
    else
    {
      ...
      id v42 = (void *)MEMORY[0x1D9452090]([v13 setSecure:1]);
      id v43 = WeakRetained;
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
      {
        ...
        [v13 messagePayload];
        id v46 = v55 = v9;
        [MEMORY[0x1E4F1CAD0] setWithObject:@"kIDSMessageSourceIDKey"];
        v48 = id v47 = v14;
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v74 = 2112;
        v75 = v49;
        _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Received decrypted secure message, %@, with payload: %@", buf, 0x20u);
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_3_366(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    char v8 = [MEMORY[0x1E4F1CA60] dictionaryWithDictionary:v5];
    ...
    if (v10)
    {
      [v8 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:@"supportsSharedIdentities"];
    ...
    id v14 = (void *)MEMORY[0x1D9452090](v12);
    id v15 = WeakRetained;
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v48 = 2112;
      id v49 = v6;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending encrypted secure message %@ to %@ with options:\n%@", (uint8_t *)&v42, 0x2Au);
    }
    ...
    char v32 = v31;
    id v33 = objc_msgSend(v6, "hmf_numberForKey:", @"kRemoteMessageRestrictionKey");
    uint64_t v34 = v33;
    if (!v33 || (uint64_t v35 = [v33 unsignedIntegerValue], v35 == -1)) {
      uint64_t v36 = 19;
    }
    else {
      uint64_t v36 = v35 | 0x10;
    }
    id v37 = [[HMDRemoteMessage alloc] initWithName:v32 destination:v23 payload:v8 type:3 timeout:0 secure:v36 restriction:v27];
    __int16 v38 = objc_msgSend(v6, "hmf_stringForKey:", @"kRemoteMessageAttributedMessageNameKey");

    [(HMDRemoteMessage *)v37 setAttributedMessageName:v38];
    id v39 = [v15 delegate];
    if ([v39 conformsToProtocol:&unk_1F2E2A2D8]) {
      __int16 v40 = v39;
    }
    else {
      __int16 v40 = 0;
    ...
    if (v41) {
      [v41 secureRemoteStream:v15 receivedRequestToSendMessage:v37];
    }
  }
}
...
void __73__HMDSecureRemoteStream__configureWithCompletionQueue_completionHandler___block_invoke_361(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v34 = 2114;
    id v35 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to decrypted secure message: %{public}@, payload %@ with error: %{public}@", buf, 0x2Au);
  }
  if (v5)
  {
    double v26 = @"kIDSMessageResponseErrorDataKey";
    uint64_t v13 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v5 requiringSecureCoding:1 error:0];
    double v27 = v13;
...
uint64_t __65__HMDSecureRemoteStream_startAndInvokeOnQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting secure session in %@ mode", (uint8_t *)&v9, 0x16u);
  }
...
- (void)setIdle:(BOOL)a3
{
  ...
  if (idle != v3)
  {
    ...
    if ([v6 conformsToProtocol:&unk_1F2E2A2D8]) {
      id v7 = v6;
    }
    else {
      id v7 = 0;
...
- (HMDSecureRemoteStream)initWithCurrentDevice:(id)a3 peerDevice:(id)a4 clientMode:(BOOL)a5 sessionID:(id)a6 accountRegistry:(id)a7
{
  ...
  if (v17)
  {
    ...
    double v26 = [MEMORY[0x1E4F28EB8] defaultCenter];
...
uint64_t __36__HMDSecureRemoteStream_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v99;
