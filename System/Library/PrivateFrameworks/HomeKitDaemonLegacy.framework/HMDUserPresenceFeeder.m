...
void __49__HMDUserPresenceFeeder_notifyDidLeaveHomeRegion__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Did leave home region", (uint8_t *)&v8, 0xCu);
  }
...
void __49__HMDUserPresenceFeeder_notifyDidEnterHomeRegion__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Did enter home region", (uint8_t *)&v8, 0xCu);
  }
  v6 = [MEMORY[0x1E4F28EB8] defaultCenter];
  v7 = [*(id *)(a1 + 32) home];
...
uint64_t __43__HMDUserPresenceFeeder_notifyDidLeaveHome__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Did leave home", (uint8_t *)&v9, 0xCu);
  }
  v6 = [MEMORY[0x1E4F28EB8] defaultCenter];
  v7 = [*(id *)(a1 + 32) home];
...
uint64_t __44__HMDUserPresenceFeeder_notifyDidArriveHome__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Did arrive home", (uint8_t *)&v9, 0xCu);
  }
  v6 = [MEMORY[0x1E4F28EB8] defaultCenter];
  v7 = [*(id *)(a1 + 32) home];
...
- (void)didEndFeedSession:(id)a3
{
  ...
  if (v5 == v4)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ is complete", (uint8_t *)&v24, 0x16u);
    }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v23;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Updating last sent feed to %@", (uint8_t *)&v24, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@%@ is not tracked", (uint8_t *)&v24, 0x16u);
    }
  }
}
...
- (void)_updatePresenceComputeStatus:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      v32 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Presence compute status is not changing from %@", (uint8_t *)&v29, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v4;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Presence compute status is changing from %@ to %@", (uint8_t *)&v29, 0x20u);
    }
    v23 = [v4 number];
    [(HMDHomeModel *)v17 setPresenceComputeStatus:v23];

    int v24 = [MEMORY[0x1E4F65480] messageWithName:@"kPresenceComputeStatusUpdate" messagePayload:0];
    v25 = [v5 backingStore];
  ...
  if (!v21)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v106 = 2112;
      id v107 = 0;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Primary resident device %@ is not set, not notifying", buf, 0x16u);
    ...
    int v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:91];
    v12 = v30;
    goto LABEL_10;
  }
    ...
    if (v23)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v105 = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Device Lost. Not sending presence feed", buf, 0xCu);
      }
      int v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
      v12 = v24;
      v14 = v96;
LABEL_10:
      v13 = v101;
    ...
    if (v49)
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v106 = 2112;
        id v107 = v55;
        _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@There is currently %@ active", buf, 0x16u);
        ...
        if (v92)
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v106 = 2112;
            id v107 = v64;
            _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_INFO, "%{public}@Current feed session %@ already contains same auth and region status, ignoring", buf, 0x16u);
      ...
      if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v110 = 2112;
        v111 = v21;
        _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_INFO, "%{public}@Current feed session is different than newer one. [presenceAuth = %@], [presenceRegion : %@], [resident: %@]", buf, 0x2Au);
      ...
      if (v72)
      {
        ...
        if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v108 = 2112;
          v109 = v70;
          _os_log_impl(&dword_1D49D5000, logb, OS_LOG_TYPE_INFO, "%{public}@Last feed %@ is same as the new feed %@", buf, 0x20u);
...
LABEL_35:
    ...
    if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v108 = 2112;
      v109 = v96;
      _os_log_impl(&dword_1D49D5000, v87, OS_LOG_TYPE_INFO, "%{public}@Created new feed session %@ with new computed status : %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v106 = 2112;
    id v107 = v43;
    _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_INFO, "%{public}@Primary resident device %@ is not capable of presence status, not notifying", buf, 0x16u);
  ...
  int v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:92];
  v12 = log;
LABEL_36:
    ...
    switch([v15 value])
    {
      case 0:
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v93 = v19;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@FMF Device status is unknown, cannot send report", buf, 0xCu);
        }
        uint64_t v20 = (void *)v16;
        goto LABEL_33;
      case 1:
        __int16 v26 = [MEMORY[0x1E4F2EBC8] computeWithValue:3];
        v25 = 0;
        if (v9) {
          goto LABEL_46;
        }
      ...
      case 2:
        if ([v13 value] == 1)
        {
          id v27 = +[HMDLocation sharedManager];
          uint64_t v28 = [v27 locationAuthorized];
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v94 = 2112;
            id v95 = v33;
            _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Current Location Authorization : %@", buf, 0x16u);

            int v29 = v88;
            uint64_t v28 = (uint64_t)contexta;
          }

          if (v28 == 1)
          {
            __int16 v26 = [MEMORY[0x1E4F2EBC8] computeWithValue:4];
            v25 = +[HMDUserPresenceRegion regionWithValue:[(HMDUserPresenceFeeder *)v30 presenceRegionStatus]];
            goto LABEL_40;
          }
          if (!v28)
          {
            uint64_t v34 = MEMORY[0x1D9452090]();
            uint64_t v35 = v30;
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v93 = v37;
              _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Looks like we are still waiting for location authorization status from Core Location. Till we determine that let's not send the presence update.", buf, 0xCu);
            }
            goto LABEL_32;
          }
          v56 = (void *)MEMORY[0x1E4F2EBC8];
          uint64_t v57 = 2;
        }
        else
        {
          ...
          if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v93 = v55;
            _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_INFO, "%{public}@We do not have presence authorization for this user.", buf, 0xCu);
          }
          v56 = (void *)MEMORY[0x1E4F2EBC8];
          uint64_t v57 = 1;
        }
        __int16 v26 = objc_msgSend(v56, "computeWithValue:", v57, v88);
        v25 = 0;
LABEL_40:
        ...
        if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v94 = 2112;
          id v95 = v26;
          _os_log_impl(&dword_1D49D5000, v64, OS_LOG_TYPE_INFO, "%{public}@This is the FMF device. Presence compute status : %@", buf, 0x16u);
...
LABEL_43:
        ...
        if (os_log_type_enabled(v80, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v93 = v87;
          _os_log_impl(&dword_1D49D5000, v80, OS_LOG_TYPE_INFO, "%{public}@Presence region status is still unknown, bailing out as a later update will be sent", buf, 0xCu);
      ...
      case 3:
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v93 = v44;
          _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@There is an FMF device, but this device is not the FMF device", buf, 0xCu);
        ...
        if (!v9)
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v93 = v61;
            _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@There is an FMF device, but this device is not the FMF device. Presence-auth is authorized, the FMF device will send the message.", buf, 0xCu);
...
LABEL_33:
        ...
        if ([v13 value] == 1)
        {
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v93 = v51;
            _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@Presence-auth is changing to authorized", buf, 0xCu);
        ...
        {
          __int16 v26 = [MEMORY[0x1E4F2EBC8] computeWithValue:1];
        }
        v25 = 0;
LABEL_46:
        v70 = -[HMDUserPresenceFeeder _sendPresenceAuthStatusForUser:presenceAuthStatus:presenceRegionStatus:presenceComputeStatus:reason:](self, "_sendPresenceAuthStatusForUser:presenceAuthStatus:presenceRegionStatus:presenceComputeStatus:reason:", v12, v13, v25, v26, v14, v88);
        if (v26) {
          [(HMDUserPresenceFeeder *)self _updatePresenceComputeStatus:v26];
        }
        ...
        if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v98 = 2112;
          v99 = v70;
          _os_log_impl(&dword_1D49D5000, v73, OS_LOG_TYPE_INFO, "%{public}@Sending status update of presence for user: %@, auth: %@ resulted in %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v94 = 2112;
      id v95 = v13;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Presence authorization is %@, upgrading it to Authorized and will retry again", buf, 0x16u);
    }
    [(HMDUserPresenceFeeder *)v22 _upgradePresenceAuth];
LABEL_34:
    BOOL v62 = 0;
  }
...
- (void)_sendPresenceUpdateToResidentForUser:(id)a3 presenceAuthStatus:(id)a4 authChanging:(BOOL)a5 reason:(id)a6 fmfStatus:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    int v29 = v21;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Presence update to resident ended in success: %@", (uint8_t *)&v26, 0x16u);
  }
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      int v26 = 138543362;
      id v27 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Resetting current feed session as the presence update to resident did not go through", (uint8_t *)&v26, 0xCu);
    }
...
- (void)_sendPresenceUpdateToResidentForUser:(id)a3 presenceAuthStatus:(id)a4 authChanging:(BOOL)a5 reason:(id)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    id v32 = v11;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Status update of presence for user: %@, auth: %@", buf, 0x20u);
  }
  if (v10)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v28 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Cannot send the presence update as the user is nil", buf, 0xCu);
    }
  }
}
...
uint64_t __101__HMDUserPresenceFeeder__sendPresenceUpdateToResidentForUser_presenceAuthStatus_authChanging_reason___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@FMF Device Status is %@", (uint8_t *)&v8, 0x16u);
  }
...
uint64_t __40__HMDUserPresenceFeeder_residentChanged__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Trying to send report after resident changed", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __44__HMDUserPresenceFeeder_presenceAuthChanged__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Trying to send report after presence auth changed", (uint8_t *)&v7, 0xCu);
  }
...
- (void)presenceAuthStatusChangedForUser:(id)a3 presenceAuthStatus:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  int v8 = [(HMDHomePresenceBase *)self workQueue];
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
{
  id v4 = [a3 userInfo];
  id v5 = objc_msgSend(v4, "hmf_stringForKey:", @"HMD.BGTM.NK");
...
uint64_t __54__HMDUserPresenceFeeder_handleTimerFiredNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Timer fired with ID: %@", (uint8_t *)&v8, 0x16u);
  }
...
- (void)_startRefreshTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    id v25 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting the refresh timer with ID: %@", buf, 0x16u);
  }
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v26 = 2112;
      id v27 = v16;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to start timer %@ with error %@", buf, 0x20u);
    }
  }
}
...
- (void)setPresenceRegionStatus:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    v19 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating presence status from %@ to %@", (uint8_t *)&v14, 0x20u);
  }
...
- (void)_upgradePresenceAuth
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v16 = 138543362;
    v17 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Updating presence authorization by writing HMUserPresenceAuthorizationStatusAuthorized to database", (uint8_t *)&v16, 0xCu);
  }
  int v7 = [(HMDHomePresenceBase *)v4 home];
  int v8 = [HMDHomeModel alloc];
  id v9 = [v7 uuid];
  __int16 v10 = [v7 homeManager];
  uint64_t v11 = [v10 uuid];
  uint64_t v12 = [(HMDBackingStoreModelObject *)v8 initWithObjectChangeType:2 uuid:v9 parentUUID:v11];

  [(HMDHomeModel *)v12 setPresenceAuthorizationStatus:&unk_1F2DC7A50];
  id v13 = [v7 backingStore];
  int v14 = +[HMDBackingStoreTransactionOptions defaultXPCOptions];
  char v15 = [v13 transaction:@"UpgradePresenceAuth" options:v14];
...
uint64_t __58__HMDUserPresenceFeeder_handleHomeDataLoadedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Received home data loaded notification, sending presence report", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __42__HMDUserPresenceFeeder_homeDataProcessed__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Home data has been processed, trying to send presence report", (uint8_t *)&v7, 0xCu);
  }
...
void __53__HMDUserPresenceFeeder_fmfStatusUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Received FMF status update notification with %@", (uint8_t *)&v8, 0x16u);
  }
...
- (void)fetchCKAccountStatusAndSendPresenceReport
{
  ...
  if ([(HMDUserPresenceFeeder *)self isAccountStatusFetchInProgress])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v12 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@CK Account fetch status already in progress. Not calling it again.", buf, 0xCu);
    }
  }
  else
  {
...
void __66__HMDUserPresenceFeeder_fetchCKAccountStatusAndSendPresenceReport__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    id v27 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@CK accountStatus completed with %@, %@", (uint8_t *)&v22, 0x20u);
  }
  if (v8)
  {
    ...
    if (v5)
    {
      uint64_t v13 = (void *)MEMORY[0x1D9452090](v12);
      id v14 = v8;
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v5;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@CK accountStatus failed with error: %@", (uint8_t *)&v22, 0x16u);
      }
    }
    else if ([v8 ckAccountStatus] != a2)
    {
      v17 = (void *)MEMORY[0x1D9452090]([v8 setCkAccountStatus:a2]);
      id v18 = v8;
      v19 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v21;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Updating the CK account status to %@. Sending the presence report", (uint8_t *)&v22, 0x16u);
      }
...
- (void)_registerForMessages
{
  ...
  [v4 addObserver:self selector:sel_accountAvailabilityChanged_ name:*MEMORY[0x1E4F19BE0] object:0];
...
- (void)configure:(id)a3 messageDispatcher:(id)a4
{
  ...
  [(HMDHomePresenceBase *)&v11 configure:a3 messageDispatcher:a4];
  id v5 = NSString;
  objc_super v6 = [(HMDHomePresenceBase *)self presenceMonitorMessageTargetUUID];
  int v7 = [v6 UUIDString];
  id v8 = [v5 stringWithFormat:@"presence.feeder/%@", v7];
  timerID = self->_timerID;
  self->_timerID = v8;

  id v10 = [MEMORY[0x1E4F28EB8] defaultCenter];
  [v10 addObserver:self selector:sel_handleResidentDeviceConfirmed_ name:@"HMDResidentDeviceConfirmedStateChangedNotification" object:0];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t45 != -1) {
    dispatch_once(&logCategory__hmf_once_t45, &__block_literal_global_34539);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v46;
  return v2;
}
...
uint64_t __36__HMDUserPresenceFeeder_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v46;
  logCategory__hmf_once_id v46 = v0;
