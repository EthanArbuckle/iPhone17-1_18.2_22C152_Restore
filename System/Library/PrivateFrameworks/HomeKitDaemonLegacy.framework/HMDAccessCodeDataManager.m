...
- (void)timerDidFire:(id)a3
{
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@dataCleanUpTimer fired", (uint8_t *)&v14, 0xCu);
    }
          ...
          if (v12)
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v35 = 2112;
              v36 = v9;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating accessory: %@, with removed access code: %@", buf, 0x20u);
          ...
          else
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v33 = 2112;
              v34 = v22;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for fetch response with accessory UUID: %@", buf, 0x16u);
          ...
          if (v12)
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v35 = 2112;
              v36 = v9;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating accessory: %@, with updated access code: %@", buf, 0x20u);
          ...
          else
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v33 = 2112;
              v34 = v22;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for accessory access code with accessory UUID: %@", buf, 0x16u);
          ...
          if (v12)
          {
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v35 = 2112;
              v36 = v9;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating accessory: %@, with new access code: %@", buf, 0x20u);
...
- (void)updateCacheWithFetchResponses:(id)a3
{
  ...
  v8[1] = 3221225472;
  v8[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2_72;
  v8[3] = &unk_1E6A12748;
  v8[4] = self;
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    v15[1] = 3221225472;
    v15[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_68;
    v15[3] = &unk_1E6A12720;
    id v16 = v6;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for fetch response with accessory UUID: %@", buf, 0x16u);
    }
    v8 = 0;
  }
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    v15[0] = MEMORY[0x1E4F143A8];
    v15[1] = 3221225472;
    v15[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_71;
    v15[3] = &unk_1E6A12720;
    id v16 = v6;
    v8 = objc_msgSend(v7, "na_filter:", v15);
  }
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2_72(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    v16[1] = 3221225472;
    v16[2] = __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_73;
    v16[3] = &unk_1E6A12790;
    id v17 = v3;
    id v18 = v6;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      v22 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for fetch response with accessory UUID: %@", buf, 0x16u);
    }
    v9 = 0;
  }
...
id __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_73(uint64_t a1, void *a2)
{
  id v3 = a2;
  id v4 = [*(id *)(a1 + 32) accessoryAccessCodeValues];
  uint64_t v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_77_140699);
...
uint64_t __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_2_74(uint64_t a1, void *a2)
{
  return [a2 uniqueIdentifier];
}

uint64_t __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_71(uint64_t a1, void *a2)
{
  v2 = *(void **)(a1 + 32);
  id v3 = a2;
...
uint64_t __58__HMDAccessCodeDataManager_updateCacheWithFetchResponses___block_invoke_68(uint64_t a1, void *a2)
{
  v2 = *(void **)(a1 + 32);
  id v3 = a2;
  id v4 = [v2 accessCodeCache];
...
- (id)cachedAccessCodeForIdentifier:(id)a3 accessoryUUID:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v7;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to find hap accessory for cached access code with accessory UUID: %@", (uint8_t *)&v18, 0x16u);
    }
    v12 = 0;
  }
...
- (NSArray)cachedAccessCodes
{
  ...
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_66_140705);
...
- (void)handleRemovedHMDRemovedUserAccessCodeModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v35 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling removed HMDHomeAccessCodeModel", buf, 0xCu);
  }
  v12 = [(HMDAccessCodeDataManager *)v9 context];
  int v13 = [v12 home];
  ...
  if (v13)
  {
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v36 = 2112;
        v37 = v13;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@HMDRemovedUserAccessCodeModel was removed. Removing from HMDHome: %@", buf, 0x16u);
      }
    ...
    else
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v35 = v32;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Did not find an access code for this model on the home, so we have nothing to remove.", buf, 0xCu);
      }
      [v7 respondWithSuccess];
      int v14 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v35 = v31;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Not handling updated HomeAccessCodeModel because home reference was nil", buf, 0xCu);
    }
    int v14 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:11];
...
- (void)handleUpdatedHMDRemovedUserAccessCodeModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v58 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling updated HMDHomeAccessCodeModel", buf, 0xCu);
  }
  v12 = [(HMDAccessCodeDataManager *)v9 context];
  int v13 = [v12 home];
...
LABEL_15:
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, v41, buf, 0xCu);
    }
LABEL_16:

    v15 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:11];
    ...
    if ((v23 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v59 = 2112;
        v60 = v13;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@HMDRemovedUserAccessCodeModel was updated on HMDHome: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      v60 = v13;
      _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@New HMDRemovedUserAccessCodeModel was added. Updating values on HMDHome: %@", buf, 0x16u);
    }
...
- (void)handleRemovedHomeAccessCodeModel:(id)a3 message:(id)a4
{
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v35 = 2112;
        __int16 v36 = v13;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@HMDHomeAccessCodeModel was removed. Removing value with label on HMDHome: %@", buf, 0x16u);
      }
      ...
      [v7 respondWithSuccess];
      uint64_t v22 = [(HMDAccessCodeDataManager *)v16 delegate];
      char v23 = (void *)MEMORY[0x1E4F2E800];
      id v24 = [v6 label];
      uint64_t v25 = [v23 homeAccessCodeValueWithStringValue:v14 label:v24];
      v32 = v25;
      v26 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v32 count:1];
      [v22 accessCodeDataManager:v16 didRemoveHomeAccessCodes:v26 removedByUserUUID:0];
    }
    else
    {
      if (v18)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v30;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Not handling updated HomeAccessCodeModel because home reference was nil", buf, 0xCu);
    }
    int v14 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:11];
    [v7 respondWithError:v14];
  }
...
- (void)handleRemovedUserAccessCodeModel:(id)a3 forUser:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel was removed. Removing value on HMDUser: %@", buf, 0x16u);
  }
  v15 = [v9 accessCode];
  [v9 setAccessCode:0];
  ...
  __int16 v19 = (void *)MEMORY[0x1E4F2E800];
  __int16 v20 = [v9 uuid];
...
- (void)handleUpdatedHomeAccessCodeModel:(id)a3 message:(id)a4
{
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v60 = v42;
      v43 = "%{public}@Not handling updated HomeAccessCodeModel because home reference was nil";
      goto LABEL_16;
    }
LABEL_17:

    id v17 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:11];
        ...
        !v16))
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v60 = v42;
      v43 = "%{public}@Home access code model has a nil property but should not";
LABEL_16:
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, v43, buf, 0xCu);
    ...
    if ((v25 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v61 = 2112;
        v62 = v13;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@HMDHomeAccessCodeModel label was updated on HMDHome: %@", buf, 0x16u);
      }
      ...
      __int16 v33 = [v7 transactionResult];
      [v33 markChanged];

      v34 = (void *)MEMORY[0x1E4F2E800];
      __int16 v35 = [v6 value];
      __int16 v36 = [v6 label];
      uint64_t v37 = [v34 homeAccessCodeValueWithStringValue:v35 label:v36];
      v57 = v37;
      uint64_t v38 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v57 count:1];
      [v17 accessCodeDataManager:v27 didUpdateHomeAccessCodes:v38 changedByUserUUID:0];
    }
    [v7 respondWithSuccess];
  }
  else
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v61 = 2112;
      v62 = v13;
      _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@New HMDHomeAccessCodeModel was added. Setting label for value on HMDHome: %@", buf, 0x16u);
    }
    v48 = [v6 label];
    v49 = [v13 labelsByAccessCode];
    v50 = [v6 value];
    ...
    [v7 respondWithSuccess];
    v52 = (void *)MEMORY[0x1E4F2E800];
    v53 = [v6 value];
    v54 = [v6 label];
    v55 = [v52 homeAccessCodeValueWithStringValue:v53 label:v54];
    v58 = v55;
    v56 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v58 count:1];
    [v17 accessCodeDataManager:v45 didAddHomeAccessCodes:v56 addedByUserUUID:0];
  }
LABEL_18:
}
...
- (void)handleUpdatedUserAccessCodeModel:(id)a3 forUser:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v59 = 2112;
    v60 = v15;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel was updated. Updating value on HMDUser: %@ changedByUserUUID: %@", buf, 0x20u);
  }
      ...
      if (v21)
      {
        if (v25)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v59 = 2112;
          v60 = v27;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel value was updated on HMDUser: %@ changedByUserUUID: %@", buf, 0x20u);
        }
        id v28 = [v8 value];
        ...
        [v10 respondWithSuccess];
        v31 = (void *)MEMORY[0x1E4F2E800];
        v32 = [v8 value];
        __int16 v33 = [v9 uuid];
        v34 = [v31 homeAccessCodeValueWithStringValue:v32 userUUID:v33];
        v53 = v34;
        __int16 v35 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v53 count:1];
      ...
      else
      {
        if (v25)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v59 = 2112;
          v60 = v47;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@HMDUserAccessCodeModel value was removed on HMDUser: %@ removedByUserUUID: %@", buf, 0x20u);
        }
        v48 = [v8 value];
        ...
        [v10 respondWithSuccess];
        v51 = (void *)MEMORY[0x1E4F2E800];
        v32 = [v8 value];
        __int16 v33 = [v9 uuid];
        v34 = [v51 homeAccessCodeValueWithStringValue:v32 userUUID:v33];
        v52 = v34;
        __int16 v35 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v52 count:1];
        __int16 v36 = [v8 changedByUserUUID];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v59 = 2112;
        v60 = v41;
        _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@New HMDUserAccessCodeModel was added. Setting value on HMDUser: %@ changedByUserUUID: %@", buf, 0x20u);
      }
      v42 = [v8 value];
      ...
      [v10 respondWithSuccess];
      v45 = (void *)MEMORY[0x1E4F2E800];
      v32 = [v8 value];
      __int16 v33 = [v9 uuid];
      v34 = [v45 homeAccessCodeValueWithStringValue:v32 userUUID:v33];
      v54 = v34;
      __int16 v35 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v54 count:1];
      __int16 v36 = [v8 changedByUserUUID];
...
- (id)removeHMDRemovedUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v36 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDRemovedUserAccessCodeModel", buf, 0xCu);
  }
  ...
  if (v13)
  {
    ...
    id v17 = v14;
    [v16 run:&v29];
    BOOL v18 = (void *)MEMORY[0x1E4F7A0F0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v36 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove HMDRemovedUserAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
    }
...
void __64__HMDAccessCodeDataManager_removeHMDRemovedUserAccessCodeModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to run transaction to update model with error: %@", (uint8_t *)&v12, 0x16u);
    }
    id v9 = *(void **)(a1 + 40);
    id v10 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      int v13 = v11;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Successfully updated model", (uint8_t *)&v12, 0xCu);
    }
...
- (id)addOrUpdateHMDRemovedUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v36 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding or updating HMDRemovedUserAccessCodeModel", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeDataManager *)v8 context];
  int v12 = [v11 home];
  int v13 = [v12 backingStore];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v36 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot add or update HMDRemovedUserAccessCodeModel, because self.context.home.backingStore is nil", buf, 0xCu);
    }
    __int16 v27 = (void *)MEMORY[0x1E4F7A0D8];
    uint64_t v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    uint64_t v22 = [v27 futureWithError:v16];
  }
...
- (id)removeHMDRemovedUserAccessCodeWithCode:(id)a3 removedUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v7;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing HMDRemovedUserAccessCode with HMRemovedUserInfo: %@", (uint8_t *)&v27, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      id v28 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not removing HMDRemovedUserAccessCode because home reference was nil", (uint8_t *)&v27, 0xCu);
    }
    id v24 = (void *)MEMORY[0x1E4F7A0D8];
    BOOL v18 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
...
- (id)saveRemovedUserAccessCode:(id)a3 withRemovedUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v7;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Saving removed user access code with removed user info: %@", (uint8_t *)&v27, 0x16u);
  }
  __int16 v14 = [(HMDAccessCodeDataManager *)v11 context];
  id v15 = [v14 home];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      id v28 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not saving removed user access code because home reference was nil", (uint8_t *)&v27, 0xCu);
    }
    id v24 = (void *)MEMORY[0x1E4F7A0D8];
    BOOL v18 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    uint64_t v19 = [v24 futureWithError:v18];
...
- (id)removeHomeAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v36 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDHomeAccessCodeModel", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeDataManager *)v8 context];
  int v12 = [v11 home];
  int v13 = [v12 backingStore];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v36 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove HMDHomeAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
    }
    int v27 = (void *)MEMORY[0x1E4F7A0D8];
    uint64_t v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    uint64_t v22 = [v27 futureWithError:v16];
  }
...
- (id)addOrUpdateHomeAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v36 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding or updating HMDHomeAccessCodeModel", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeDataManager *)v8 context];
  int v12 = [v11 home];
  int v13 = [v12 backingStore];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v36 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot add or update HMDHomeAccessCodeModel, because self.context.home.backingStore is nil", buf, 0xCu);
    }
    int v27 = (void *)MEMORY[0x1E4F7A0D8];
    uint64_t v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    uint64_t v22 = [v27 futureWithError:v16];
...
- (id)removeUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v38 = 2112;
    v39 = v11;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDUserAccessCodeModel, removedByUserUUID: %@", buf, 0x16u);
  }
  ...
  if (v14)
  {
    ...
    [v4 setObjectChangeType:2];
    [v17 add:v4];
    uint64_t v30 = MEMORY[0x1E4F143A8];
    uint64_t v31 = 3221225472;
    v32 = __54__HMDAccessCodeDataManager_removeUserAccessCodeModel___block_invoke;
    __int16 v33 = &unk_1E6A196E0;
    id v34 = v8;
    id v35 = v15;
    id v18 = v15;
    [v17 run:&v30];
    uint64_t v19 = (void *)MEMORY[0x1E4F7A0F0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v37 = v27;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove HMDUserAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
    }
...
void __54__HMDAccessCodeDataManager_removeUserAccessCodeModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to run transaction to update model, error: %@", (uint8_t *)&v12, 0x16u);
    }
    id v9 = *(void **)(a1 + 40);
    id v10 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    [v9 finishWithError:v10];
...
- (id)addOrUpdateUserAccessCodeModel:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v36 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding or updating HMDUserAccessCodeModel", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeDataManager *)v8 context];
  int v12 = [v11 home];
  int v13 = [v12 backingStore];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v36 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot add or update HMDUserAccessCodeModel because self.context.home.backingStore is nil", buf, 0xCu);
    }
    int v27 = (void *)MEMORY[0x1E4F7A0D8];
    uint64_t v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    uint64_t v22 = [v27 futureWithError:v16];
...
- (NSSet)accessCodeValuesWithRemovedUserInfo
{
  ...
  if (v4)
  {
    ...
    id v7 = [v6 allKeys];
    id v8 = objc_msgSend(v7, "na_map:", &__block_literal_global_42_140787);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      uint64_t v16 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code values with removed user info because home reference was nil", (uint8_t *)&v15, 0xCu);
    }
...
{
  v2 = (objc_class *)MEMORY[0x1E4F2E4F0];
  id v3 = a2;
...
- (NSSet)accessCodeValuesWithUserLabel
{
  ...
  if (v4)
  {
    id v5 = (void *)MEMORY[0x1E4F1CAD0];
    id v6 = [v4 users];
    id v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_39_140792);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      int v15 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch user access code values with simple labels because home reference was nil", (uint8_t *)&v14, 0xCu);
    }
    id v8 = [MEMORY[0x1E4F1CAD0] setWithArray:MEMORY[0x1E4F1CBF0]];
  }
...
id __57__HMDAccessCodeDataManager_accessCodeValuesWithUserLabel__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    id v4 = objc_alloc(MEMORY[0x1E4F2E4F0]);
    id v5 = [v2 accessCode];
...
- (id)userUUIDForAccessCode:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v18 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code with simple label because home reference was nil", buf, 0xCu);
    }
    id v9 = 0;
  }
...
- (id)simpleLabelForAccessCode:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      int v15 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code with simple label because home reference was nil", (uint8_t *)&v14, 0xCu);
    }
    id v8 = 0;
  }
...
- (NSSet)accessCodeValuesWithSimpleLabel
{
  ...
  if (v4)
  {
    ...
    id v7 = [v6 allKeys];
    id v8 = objc_msgSend(v7, "na_map:", &__block_literal_global_36_140798);
    id v9 = [v5 setWithArray:v8];
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      uint64_t v16 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot find access code values with simple label because home reference was nil", (uint8_t *)&v15, 0xCu);
    }
    id v9 = [MEMORY[0x1E4F1CAD0] set];
  }
...
{
  id v2 = (objc_class *)MEMORY[0x1E4F2E4F0];
  id v3 = a2;
  id v4 = (void *)[[v2 alloc] initWithStringValue:v3];
...
- (id)_removeHMDRemovedUserAccessCodeWithAccessCode:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    int v28 = 138543362;
    uint64_t v29 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing HMDRemovedUserAccessCode with specified value", (uint8_t *)&v28, 0xCu);
  }
  id v11 = [(HMDAccessCodeDataManager *)v8 context];
  int v12 = [v11 home];
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      int v28 = 138543362;
      uint64_t v29 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not Removing HMDRemovedUserAccessCode because home reference was nil", (uint8_t *)&v28, 0xCu);
    }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    int v28 = 138543362;
    uint64_t v29 = v26;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Did not find HMDRemovedUserAccessCode with the specified value", (uint8_t *)&v28, 0xCu);
  }
  uint64_t v17 = [MEMORY[0x1E4F7A0D8] futureWithNoResult];
LABEL_13:
...
- (void)_cleanUpOldRemovedUserData
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v18 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Cleaning up old removedUserInfo", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v18 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Not cleaning up old removed user data because home reference was nil", buf, 0xCu);
    }
  }
}
...
- (id)_removeSimpleLabelAccessCodeValue:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      int v23 = 138543362;
      id v24 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Not removing access code value because home reference was nil", (uint8_t *)&v23, 0xCu);
    }
    id v21 = (void *)MEMORY[0x1E4F7A0D8];
    double v11 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
...
- (id)_setSimpleLabel:(id)a3 forAccessCodeValue:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v27 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Not setting simple label for access code value because home reference was nil", buf, 0xCu);
    }
    uint64_t v22 = (void *)MEMORY[0x1E4F7A0D8];
    int v15 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    uint64_t v17 = [v22 futureWithError:v15];
...
- (void)_messageUser:(id)a3 thatTheirAccessCodeWasChangedWithType:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v29 = 2048;
    unint64_t v30 = a4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Messaging user that their access code was changed. user: %@, changeType: %lu", buf, 0x20u);
  }
...
- (id)_removeUserAccessCodeValue:(id)a3 removedByUserUUID:(id)a4
{
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      [(HMDUserAccessCodeModel *)v16 setValue:0];
      [(HMDUserAccessCodeModel *)v16 setChangedByUserUUID:v7];
      uint64_t v17 = [(HMDAccessCodeDataManager *)self removeUserAccessCodeModel:v16];
      id v18 = [v17 addSuccessBlock:&__block_literal_global_27_140817];
    }
    else
    {
      id v24 = (void *)MEMORY[0x1D9452090]();
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        int v31 = 138543362;
        v32 = v27;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Not removing access code value because couldn't find any user with that access code.", (uint8_t *)&v31, 0xCu);
      }
      uint64_t v28 = (void *)MEMORY[0x1E4F7A0D8];
      __int16 v29 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
      id v18 = [v28 futureWithError:v29];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v31 = 138543362;
      v32 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Not removing access code value because home reference was nil", (uint8_t *)&v31, 0xCu);
    }
...
- (id)_setUserWithUUID:(id)a3 forAccessCodeValue:(id)a4 changedByUserUUID:(id)a5
{
  ...
  if (v14)
  {
    ...
    v36[1] = 3221225472;
    v36[2] = __82__HMDAccessCodeDataManager__setUserWithUUID_forAccessCodeValue_changedByUserUUID___block_invoke;
    v36[3] = &unk_1E6A12608;
    id v16 = v8;
    id v37 = v16;
    uint64_t v17 = objc_msgSend(v15, "na_firstObjectPassingTest:", v36);
    ...
    if (v17)
    {
      ...
      __int16 v20 = [(HMDAccessCodeDataManager *)self addOrUpdateUserAccessCodeModel:v18];
      v34[0] = MEMORY[0x1E4F143A8];
      v34[1] = 3221225472;
      v34[2] = __82__HMDAccessCodeDataManager__setUserWithUUID_forAccessCodeValue_changedByUserUUID___block_invoke_23;
      v34[3] = &unk_1E6A19730;
      v34[4] = self;
      id v35 = v9;
      id v21 = [v20 addSuccessBlock:v34];
    }
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v40 = 2112;
        id v41 = v16;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Not setting user UUID: %@, for access code value because we could not find a user with that UUID.", buf, 0x16u);
      }
      v32 = (void *)MEMORY[0x1E4F7A0D8];
      id v18 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
      id v21 = [v32 futureWithError:v18];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      id v41 = v8;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Not setting user UUID: %@, for access code value because home reference was nil", buf, 0x16u);
    }
    v26 = (void *)MEMORY[0x1E4F7A0D8];
    __int16 v27 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
...
void __82__HMDAccessCodeDataManager__setUserWithUUID_forAccessCodeValue_changedByUserUUID___block_invoke_23(uint64_t a1)
{
  v1 = *(void **)(a1 + 32);
  id v2 = [*(id *)(a1 + 40) stringValue];
  [v1 removeHMDRemovedUserAccessCodeWithAccessCode:v2];
...
- (id)removeAllHomeAccessCodes
{
  ...
  id v13 = [MEMORY[0x1E4F7A0D8] chainFutures:v5];
...
- (id)updateUserInformation:(id)a3 forHomeAccessCodeWithOldValue:(id)a4 newAccessCodeValue:(id)a5
{
  ...
  else
  {
    ...
    {
      long long v15 = (void *)MEMORY[0x1E4F7A0D8];
      int v14 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:3];
...
- (id)removeHomeAccessCodeWithValue:(id)a3 removedByUserUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v32 = 2112;
    id v33 = v7;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing home access code, removedByUserUUID: %@", (uint8_t *)&v30, 0x16u);
  }
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      int v30 = 138543362;
      int v31 = v27;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Did not find home access code", (uint8_t *)&v30, 0xCu);
    }
    uint64_t v28 = (void *)MEMORY[0x1E4F7A0D8];
...
- (id)setUserInformation:(id)a3 forHomeAccessCodeWithValue:(id)a4 changedByUserUUID:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v30 = 2112;
    id v31 = v8;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Setting user information: %@, for access code value", (uint8_t *)&v28, 0x16u);
  }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v30 = 2112;
        id v31 = v8;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Not setting user information for access code value because empty user information was provided: %@", (uint8_t *)&v28, 0x16u);
      }
      id v25 = (void *)MEMORY[0x1E4F7A0D8];
      int v18 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
...
- (NSArray)homeAccessCodeValuesWithRemovedUserInfo
{
  ...
  if (v4)
  {
    ...
    {
      id v6 = [v4 removedUserInfoByAccessCode];
      id v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_16_140829);
...
LABEL_8:
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v14, 0xCu);
    }
  }
...
{
  return [MEMORY[0x1E4F2E800] homeAccessCodeValueWithStringValue:a2 removedUserInfo:a3];
}
...
- (NSArray)homeAccessCodeValuesWithUserLabels
{
  ...
  if (v4)
  {
    ...
    id v6 = objc_msgSend(v5, "na_map:", &__block_literal_global_13_140833);
  }
  else
  {
    id v7 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v12 = 138543362;
      id v13 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch user access code values with simple labels because home reference was nil", (uint8_t *)&v12, 0xCu);
    }
...
id __62__HMDAccessCodeDataManager_homeAccessCodeValuesWithUserLabels__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    id v4 = objc_alloc(MEMORY[0x1E4F2E4E8]);
    uint64_t v5 = [v2 uuid];
    id v6 = (void *)[v4 initWithSimpleLabel:0 labelIdentifier:0 userUUID:v5 removedUserInfo:0];

    id v7 = objc_alloc(MEMORY[0x1E4F2E4F0]);
    id v8 = [v2 accessCode];
    id v9 = (void *)[v7 initWithStringValue:v8];

    id v3 = (void *)[objc_alloc(MEMORY[0x1E4F2E800]) initWithAccessCodeValue:v9 userInformationValue:v6];
  }
...
- (NSArray)homeAccessCodeValuesWithSimpleLabels
{
  ...
  if (v4)
  {
    ...
    {
      id v6 = [v4 labelsByAccessCode];
      id v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_7_140838);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch home access code values with simple labels because home reference was nil", (uint8_t *)&v13, 0xCu);
    }
  }
  id v7 = (void *)MEMORY[0x1E4F1CBF0];
LABEL_8:
...
{
  id v4 = (objc_class *)MEMORY[0x1E4F2E4E8];
  id v5 = a3;
  id v6 = a2;
  id v7 = (void *)[[v4 alloc] initWithSimpleLabel:v5 labelIdentifier:0 userUUID:0 removedUserInfo:0];

  id v8 = (void *)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:v6];
  id v9 = (void *)[objc_alloc(MEMORY[0x1E4F2E800]) initWithAccessCodeValue:v8 userInformationValue:v7];
...
- (HMDAccessCodeDataManager)initWithContext:(id)a3 delegate:(id)a4
{
  ...
  if (v9)
  {
    ...
    v10->_id dataCleanUpTimerFactory = &__block_literal_global_140843;
  }
  return v10;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t87_140856 != -1) {
    dispatch_once(&logCategory__hmf_once_t87_140856, &__block_literal_global_80_140857);
  }
  id v2 = (void *)logCategory__hmf_once_v88_140858;
  return v2;
}
...
uint64_t __39__HMDAccessCodeDataManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v88_140858;
  logCategory__hmf_once_v88_140858 = v0;
