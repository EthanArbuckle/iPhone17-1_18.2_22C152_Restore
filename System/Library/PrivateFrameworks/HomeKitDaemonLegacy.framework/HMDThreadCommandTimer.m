...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Executing deferred thread command %@ now with id(%lu)", (uint8_t *)&v17, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2048;
      uint64_t v22 = [(HMDThreadCommandTimer *)v8 commandCount];
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Execution block not found for thread command %@ with id(%lu)", (uint8_t *)&v17, 0x20u);
    }
  }
...
- (void)abort
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Not executing deferred thread command %@ with id(%lu). Sending nil completion", (uint8_t *)&v13, 0x20u);
    }
...
- (void)startWithBlock:(id)a3 completion:(id)a4 commandType:(int64_t)a5
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Not executing deferred thread command %@ with id(%lu). Sending nil completion", (uint8_t *)&v28, 0x20u);
    }
  ...
  v20 = (void *)MEMORY[0x1D9452090]([(HMDThreadCommandTimer *)self setCommandType:a5]);
  __int16 v21 = self;
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v34 = 2048;
    uint64_t v35 = v26;
    _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Scheduling deferred thread command %@ to execute after %@ secs with id(%lu)", (uint8_t *)&v28, 0x2Au);
  }
...
- (HMDThreadCommandTimer)initWithTimer:(id)a3
{
  ...
  id v9 = [(HMDThreadCommandTimer *)self initWithQueue:v8 delayInSecs:&unk_1F2DC80B0];
...
- (HMDThreadCommandTimer)initWithQueue:(id)a3 delayInSecs:(id)a4
{
  ...
  if (v9)
  {
    uint64_t v10 = objc_msgSend(objc_alloc(MEMORY[0x1E4F65580]), "initWithTimeInterval:options:", 0, (double)objc_msgSend(v8, "integerValue"));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_77402 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_77402, &__block_literal_global_77403);
  }
  v2 = (void *)logCategory__hmf_once_v6_77404;
  return v2;
}
...
uint64_t __36__HMDThreadCommandTimer_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v6_77404;
  logCategory__hmf_once_v6_77404 = v0;
