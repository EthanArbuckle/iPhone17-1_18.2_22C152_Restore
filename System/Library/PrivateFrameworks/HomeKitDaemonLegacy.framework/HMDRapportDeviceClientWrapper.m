  ...
  if (([(NSMutableArray *)requestQueue hmf_isEmpty] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v34 = 2112;
      id v35 = v4;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Completing %lu queued request(s) to device: %@, with error: %@", buf, 0x2Au);
    }
    long long v25 = 0u;
    long long v26 = 0u;
    long long v23 = 0u;
...
- (void)_queueRequestID:(id)a3 request:(id)a4 options:(id)a5 responseHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v36 = 2112;
    v37 = v20;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Queuing request to device: %@", buf, 0x16u);
  }
...
- (void)sendRequestID:(id)a3 request:(id)a4 options:(id)a5 responseHandler:(id)a6
{
  ...
  if (self && (unint64_t activateState = self->_activateState, activateState >= 2))
  {
    if (activateState == 3)
    {
      ...
      v16 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:3203];
    ...
    else
    {
      if (activateState != 2)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
        {
          ...
          int v24 = 138543362;
          id v25 = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: State is not activated.", (uint8_t *)&v24, 0xCu);
        }
...
- (void)invalidate
{
  if (self)
  {
    ...
    id v4 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:3203];
  ...
  else
  {
    ...
    v8 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:3203];
...
- (void)activateWithCompletion:(id)a3
{
    ...
    if (self->_activateState)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Activate called more than once.", buf, 0xCu);
      }
      ...
      if (self->_activateState)
      {
        id v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1 description:@"Unexpected error." reason:@"Activate called more than once." suggestion:0];
        v4[2](v4, v12);
        goto LABEL_11;
      }
    }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    int v24 = v11;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Activating client for destination: %@", buf, 0x16u);
  }
  if (self) {
...
void __56__HMDRapportDeviceClientWrapper_activateWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    v5 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:3203 underlyingError:v3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_168878 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_168878, &__block_literal_global_168879);
  }
  v2 = (void *)logCategory__hmf_once_v6_168880;
  return v2;
}
...
uint64_t __44__HMDRapportDeviceClientWrapper_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v6_168880;
  logCategory__hmf_once_v6_168880 = v0;
