...
- (void)streamReceiver:(id)a3 didReceiveFileWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Image receive has completed with error: %@", (uint8_t *)&v13, 0x16u);
  }
  [(HMDCameraSnapshotRemoteStreamReceiver *)v10 _callDidSaveImageDelegateWithError:v7];
  [(HMDCameraSnapshotReceiver *)v10 _sendConfirmationToResident:&__block_literal_global_42_148686];
}
...
- (void)_callDidSaveImageDelegateWithError:(id)a3
{
  ...
  id v4 = a3;
  v5 = [MEMORY[0x1E4F653F0] currentActivity];
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v24 = 2112;
    v25 = v11;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that download of image %@ has completed with error %@ for session %@", buf, 0x2Au);
  }
...
- (void)_getSnapshot:(unint64_t)a3
{
  ...
  id v17 = (id)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"Snapshot Stream Receiver"];
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v15 = 2112;
        id v16 = v5;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Take snapshot relayed to resident has ended in error %@", (uint8_t *)&v13, 0x16u);
      }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteStreamReceiver", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_148738 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_148738, &__block_literal_global_148739);
  }
  v2 = (void *)logCategory__hmf_once_v2_148740;
  return v2;
}
...
uint64_t __52__HMDCameraSnapshotRemoteStreamReceiver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_148740;
  logCategory__hmf_once_v2_148740 = v0;
