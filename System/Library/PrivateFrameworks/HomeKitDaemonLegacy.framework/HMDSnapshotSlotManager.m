...
void __51__HMDSnapshotSlotManager_handleProcessStateChange___block_invoke(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    v3 = [v2 userInfo];
    v4 = [v3 objectForKeyedSubscript:@"processInfo"];
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_WORD *)&v26[22] = 2112;
        v27 = v14;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Received notification that process info state changed for process %@: %@", v26, 0x20u);
      }
      if (v7)
      {
        id v15 = v9[3];
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v26[22] = 2112;
            v27 = v16;
            _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Removing snapshot file associated with non-foreground app %@: %@", v26, 0x20u);
          }
        ...
        if (v7 == 4)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v26[12] = 2112;
            *(void *)&v26[14] = v6;
            _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Clearing any of the filled snapshot slots for terminated process: %@", v26, 0x16u);
          }
          v25 = [v22[2] objectForKey:v6];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_164896 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_164896, &__block_literal_global_164897);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_164898;
  return v2;
}
...
- (id)encodedMostRecentSnapshotForMessage:(id)a3
{
  ...
  if (!isMostRecentSnapshotValid(v7))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      id v32 = v7;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Not encoding invalid most recent snapshot for message %@: %@", (uint8_t *)&v27, 0x20u);
    }
    goto LABEL_14;
  }
...
LABEL_14:
  ...
  if (v12)
  {
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      id v32 = v7;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Associating process info %@ with most recent snapshot file: %@", (uint8_t *)&v27, 0x20u);
    }
    if (self) {
  ...
  else
  {
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v4;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot encode most recent snapshot for message without process info: %@", (uint8_t *)&v27, 0x16u);
    }
    v19 = 0;
  }
...
void __88__HMDSnapshotSlotManager_createSlotForSnapshotFile_requestMessages_shouldNotifyClients___block_invoke(uint64_t a1)
{
  ...
  id v4 = &OBJC_IVAR___HMDCameraClipSignificantEventBulletin__home;
  if (v2)
  {
    uint64_t v5 = v2;
      ...
      do
      {
        ...
        if (v10)
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v54 = v16;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Associating process info %@ with snapshot file: %@", buf, 0x20u);
          }
        ...
        else
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(void *)&buf[14] = v8;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot associate snapshot file for message without process info: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v26;
    _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Current snapshot-application map: %@", buf, 0x16u);
  }
  ...
  if (v27)
  {
    ...
    if (!isMostRecentSnapshotValid(v30))
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v30;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Not updating most recent snapshot with invalid snaphot: %@", buf, 0x16u);
      }
      goto LABEL_36;
    }
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v30;
      _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Updating most recent snapshot to %@", buf, 0x16u);
    }
...
void __72__HMDSnapshotSlotManager__updateMostRecentSnapshot_shouldNotifyClients___block_invoke(uint64_t a1)
{
  ...
  id v2 = objc_alloc(MEMORY[0x1E4F65488]);
  long long v3 = [*(id *)(a1 + 40) uniqueIdentifier];
  id v4 = (void *)[v2 initWithTarget:v3];

  id v5 = objc_alloc(MEMORY[0x1E4F654B0]);
  uint64_t v6 = (void *)[v5 initWithName:*MEMORY[0x1E4F2CD18] destination:v4 payload:v10];
...
- (void)handleReleaseSnapshot:(id)a3
{
  ...
  dispatch_assert_queue_V2(workQueue);
  uint64_t v6 = [v4 numberForKey:*MEMORY[0x1E4F2E028]];
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v48 = 2112;
      uint64_t v49 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Releasing snapshot file with slot identifier: %@", buf, 0x16u);
    }
    long long v43 = 0u;
    long long v44 = 0u;
    long long v41 = 0u;
    long long v42 = 0u;
    id v12 = &OBJC_IVAR___HMDCameraClipSignificantEventBulletin__home;
    v38 = v4;
    if (self) {
    ...
    if (v15)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          uint64_t v20 = v12;
          if (self) {
            v21 = *(Class *)((char *)&v8->super.super.isa + v12[71]);
          }
          else {
            v21 = 0;
          }
          ...
          if (v25)
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Releasing snapshot file: %@", buf, 0x16u);
            }
            id v4 = v38;
            __int16 v31 = obj;
            if (self) {
              v36 = *(Class *)((char *)&v33->super.super.isa + v20[71]);
            }
            else {
              v36 = 0;
            }
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find snapshot file to release with slot identifier: %@", buf, 0x16u);
    }
    __int16 v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    id v4 = v38;
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot find slot identifier in release snapshot message payload: %@", buf, 0x16u);
    }
    __int16 v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
  }
...
- (void)handleFillSnapshotSlot:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Filling snapshot with slot identifier %@", (uint8_t *)&v27, 0x16u);
  }
  v11 = [v4 proxyConnection];
  ...
  if (v12)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v6;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot fill snapshot with slot identifier %@ because it no longer exist", (uint8_t *)&v27, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v4;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot fill snapshot for message without process info: %@", (uint8_t *)&v27, 0x16u);
    }
...
void __54__HMDSnapshotSlotManager_backboardServicesRelaunched___block_invoke(uint64_t a1)
{
  ...
  id v11 = (id)[*(id *)(a1 + 32) createSlotForSnapshotFile:v12 requestMessages:MEMORY[0x1E4F1CBF0] shouldNotifyClients:1];
}
  ...
  if (v4)
  {
          ...
          if ([v14 containsObject:v3])
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v32 = 2112;
              uint64_t v33 = v11;
              _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Cannot clear snapshot slot identifier %@ because is still in use by %@", buf, 0x20u);
            }
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v4;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Clearing snapshot slot for snapshot %@", buf, 0x16u);
    }
    [v4 clearSlot];
  }
LABEL_22:
...
- (void)registerForMessages
{
  ...
  if (v2)
  {
    ...
    v64 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v5, "count"));
    long long v71 = 0u;
    long long v72 = 0u;
    long long v73 = 0u;
    long long v74 = 0u;
    ...
    if (v7)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          id v13 = objc_msgSend(*(id *)(v10 + 2504), "hmd_dateFromSnapshotFileName:", v12);
          ...
          else
          {
            uint64_t v16 = v9;
            unint64_t v17 = v10;
            long long v18 = (void *)MEMORY[0x1D9452090](v14);
            long long v19 = v2;
            long long v20 = v2;
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v81 = 2112;
              v82 = v12;
              _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring snapshot file with date in the future: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v81 = 2112;
      v82 = v64;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Built the snapshot file dictionary: %@", buf, 0x16u);
    }
    long long v27 = [v64 allValues];
    int v28 = [v27 sortedArrayUsingSelector:sel_compare_];

    __int16 v29 = [v28 lastObject];
    ...
    if (v30)
    {
            ...
            if (([v36 isEqualToString:v30] & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)v75 = 138543618;
                ...
                __int16 v77 = 2112;
                v78 = v39;
                _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Removing obsolete snapshot at path: %@", v75, 0x16u);
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v75 = 138543618;
        ...
        __int16 v77 = 2112;
        v78 = v49;
        _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Found the most recent snapshot %@", v75, 0x16u);
      }
    }
    else
    {
    ...
    if (v49)
    {
      v54 = (void *)MEMORY[0x1D9452090]((id)[v24 createSlotForSnapshotFile:v49 requestMessages:MEMORY[0x1E4F1CBF0] shouldNotifyClients:0]);
      id v55 = v24;
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v83 = 138543618;
        ...
        __int16 v85 = 2112;
        id v86 = Property;
        _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_INFO, "%{public}@Created the most recent snapshot %@", v83, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v83 = 138543362;
        v84 = v61;
        _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_INFO, "%{public}@No recent snapshot found", v83, 0xCu);
      }
    }
  }
  else
...
uint64_t __37__HMDSnapshotSlotManager_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v1_164898;
  logCategory__hmf_once_v1_164898 = v0;
