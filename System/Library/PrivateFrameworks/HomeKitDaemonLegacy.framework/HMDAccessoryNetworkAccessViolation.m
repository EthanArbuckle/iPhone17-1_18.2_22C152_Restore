...
- (void)encodeWithCoder:(id)a3
{
    ...
    || objc_msgSend(v6, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    [v6 encodeObject:v4 forKey:*MEMORY[0x1E4F2C448]];

    v5 = [(HMDAccessoryNetworkAccessViolation *)self lastResetDate];
    [v6 encodeObject:v5 forKey:*MEMORY[0x1E4F2C450]];
  }
}
...
{
  id v4 = a3;
  v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2C448]];
  id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2C450]];
...
+ (id)noViolation
{
  if (noViolation_onceToken != -1) {
    dispatch_once(&noViolation_onceToken, &__block_literal_global_69969);
  }
...
uint64_t __49__HMDAccessoryNetworkAccessViolation_noViolation__block_invoke()
{
  ...
  uint64_t v1 = noViolation_noViolation;
