...
- (id)counterGroupForName:(id)a3
{
  double v4 = +[HMDEventCounterGroupNameSpecifier specifierWithGroupName:a3];
...
- (id)counterGroupForSpecifier:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      id v39 = [v37 exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:v38 userInfo:0];
    ...
    if (self->_bridgedCountersManager)
    {
      ...
      if (v8 == objc_opt_class())
      {
        ...
        v23 = [v21 groupName];
        v14 = [(HMMCountersManager *)bridgedCountersManager counterGroupForName:v23];
        ...
        id v47 = v21;
        v17 = _Block_copy(v46);
        v5 = [[HMDEventCounterGroupBridge alloc] initWithContext:self bridgedCounterGroup:v14 dateProvider:self->_bridgedDateProvider statisticsGroupBlock:v17];
        v24 = &v47;
      }
      else
      {
        if (v8 == objc_opt_class())
        {
          ...
          v27 = [v25 groupName];
          v14 = [(HMMCountersManager *)v26 counterGroupForName:v27];
        ...
        else if (v8 == objc_opt_class())
        {
          ...
          v32 = [v30 homeUUID];
          v33 = [v30 groupName];
          v14 = [(HMMCountersManager *)v31 counterGroupForHomeUUID:v32 groupName:v33];
        ...
        else
        {
          if (v8 != objc_opt_class())
          {
            ...
            id v42 = [v40 exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:v41 userInfo:0];
          ...
          v12 = [v9 homeUUID];
          v13 = [v9 groupName];
          v14 = [(HMMCountersManager *)v10 counterGroupForAccessoryUUID:v11 homeUUID:v12 groupName:v13];

          v15 = aBlock;
          aBlock[0] = MEMORY[0x1E4F143A8];
          aBlock[1] = 3221225472;
          aBlock[2] = __52__HMDEventCountersManager_counterGroupForSpecifier___block_invoke_4;
          aBlock[3] = &unk_1E6A15220;
          aBlock[4] = self;
          id v16 = v9;
          aBlock[5] = v16;
    ...
    {
      v5 = [[HMDEventCounterGroup alloc] initWithContext:self serializedEventCounters:0 uptimeProvider:self->_uptimeProvider];
    }
...
+ (NSSet)allowedSpecifierClasses
{
  if (allowedSpecifierClasses__hmf_once_t2 != -1) {
    dispatch_once(&allowedSpecifierClasses__hmf_once_t2, &__block_literal_global_165845);
  }
...
- (id)unarchiveEventCounters
{
  ...
  id v4 = [(HMDEventCountersManager *)self counterStorage];
  v5 = [v4 unarchive];
  ...
  v10 = (void *)MEMORY[0x1D9452090](v6, v7, v8, v9);
  v11 = self;
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Final restored event counters: %@", buf, 0x16u);
  }
...
void __32__HMDEventCountersManager__save__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    id v4 = [v3 bridgedCountersManager];
    [v4 save];
  }
  else
  {
    id v4 = [v3 counterStorage];
...
- (void)resetAllEventCounters
{
  ...
  os_unfair_lock_lock_with_options();
  self->_pendingSave = 1;
  id v4 = [(NSMutableDictionary *)self->_counterGroups allValues];
  os_unfair_lock_unlock(p_lock);
  long long v11 = 0u;
  long long v12 = 0u;
  long long v9 = 0u;
...
- (id)fetchAllEventCounters
{
  p_lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  id v4 = [(HMDEventCountersManager *)self _fetchAllEventCounters];
  if ([v4 count]) {
    id v5 = v4;
  }
  else {
...
- (HMDEventCountersManager)initWithEventCountersStorage:(id)a3 bridgedCountersManager:(id)a4 bridgedDateProvider:(id)a5
{
  ...
  id v16 = [MEMORY[0x1E4F6A2B8] sharedInstance];
