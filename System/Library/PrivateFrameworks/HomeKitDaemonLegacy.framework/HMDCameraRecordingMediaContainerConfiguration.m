...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BDE8] wrappertlv:1 name:@"kMediaContainerConfigurationContainerType"];
  id v4 = [MEMORY[0x1E4F5BD28] wrappertlv:2 name:@"MediaContainerConfigurationContainerParameters"];
  v16[0] = v3;
  v16[1] = v4;
