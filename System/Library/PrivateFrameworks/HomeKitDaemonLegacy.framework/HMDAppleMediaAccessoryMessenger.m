...
- (void)routeSiriEndpointDeleteSiriHistoryMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing siri endpoint delete siri history message: %@", buf, 0x16u);
  }
...
- (void)sendDeleteSiriHistoryRequestForAccessoryWithUUID:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending delete siri history request message for accessory uuid: %@", buf, 0x16u);
  }
  v12 = (void *)[objc_alloc(MEMORY[0x1E4F2EAF8]) initWithAccessoryUUID:v6];
  ...
  v17 = [MEMORY[0x1E4F2EAF8] messageName];
  v18 = [v12 payloadCopy];
...
void __102__HMDAppleMediaAccessoryMessenger_sendDeleteSiriHistoryRequestForAccessoryWithUUID_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Delete siri history message responded with error: %@", (uint8_t *)&v11, 0x16u);
    }
  }
...
- (void)registerForMessagesWithHome:(id)a3
{
  ...
  __int16 v13 = [MEMORY[0x1E4F2EAF8] messageName];
  v15[0] = v9;
  v15[1] = v10;
  v15[2] = v11;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_59728 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_59728, &__block_literal_global_59729);
  }
  v2 = (void *)logCategory__hmf_once_v5_59730;
  return v2;
}
...
uint64_t __46__HMDAppleMediaAccessoryMessenger_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_59730;
  logCategory__hmf_once_v5_59730 = v0;
