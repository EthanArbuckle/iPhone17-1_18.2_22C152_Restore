...
- (void)main
{
  ...
  {
    id v4 = objc_alloc(MEMORY[0x1E4F65420]);
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Querying residents to see if we're in the primary mesh", buf, 0xCu);
    }
    if (v8) {
...
void __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  v9 = (void *)[objc_alloc(MEMORY[0x1E4F654B0]) initWithName:@"mesh.meshInformationRequest" destination:v8 payload:0];
  [v9 setTimeout:15.0];
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v33 = 2114;
    id v34 = v22;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Querying resident %{public}@ with message %{public}@", buf, 0x20u);
...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_56(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained && v5)
  {
    uint64_t v7 = objc_msgSend(v3, "na_map:", &__block_literal_global_60_23957);
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Got results: %@", (uint8_t *)&v15, 0x16u);
    }
    [v10 finish];
  }
  else
...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_2(id *a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v21 = 2112;
        id v22 = v3;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to parse message payload for resident %{public}@: %@", (uint8_t *)&v17, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2114;
      v20 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@nil result for resident: %{public}@", (uint8_t *)&v17, 0x16u);
    }
  }
...
uint64_t __50__HMDPrimaryElectionFindPrimaryMeshOperation_main__block_invoke_52(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Got error result for resident %{public}@: %@", (uint8_t *)&v10, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_24029 != -1) {
    dispatch_once(&logCategory__hmf_once_t14_24029, &__block_literal_global_64);
  }
  id v2 = (void *)logCategory__hmf_once_v15_24030;
  return v2;
}
...
uint64_t __57__HMDPrimaryElectionFindPrimaryMeshOperation_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v15_24030;
  logCategory__hmf_once_v15_24030 = v0;
