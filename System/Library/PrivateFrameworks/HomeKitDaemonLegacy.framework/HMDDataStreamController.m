...
- (void)_readRequiredTransportCharacteristicsIfNeededWithCompletion:(id)a3
{
  ...
  v6 = [(HMDDataStreamController *)self transferManagementService];
  v7 = [v6 findCharacteristicWithType:*MEMORY[0x1E4F2D048]];
  ...
  if (v10)
  {
    v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    v4[2](v4, v11);
  }
  else
  {
    ...
    else
    {
      ...
      v17 = +[HMDCharacteristicRequest requestWithCharacteristic:v9];
      ...
      if ([v15 count])
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v20 = [(HMDDataStreamController *)v18 accessory];
          v21 = [v20 identifier];
          *(_DWORD *)buf = 138543618;
          v31 = v25;
          __int16 v32 = 2112;
          v33 = v21;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Reading required transport characteristic for data stream controller %@", buf, 0x16u);
        }
        objc_initWeak((id *)buf, v18);
        v22 = [(HMDDataStreamController *)v18 accessory];
        v23 = [(HMDDataStreamController *)v18 workQueue];
      ...
      {
        v24 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
        v4[2](v4, v24);
      }
    }
  }
...
void __51__HMDDataStreamController_handleAccessoryConnected__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to read the required transport characteristics for: %@ with error: %@", (uint8_t *)&v11, 0x20u);
    }
  }
  else
  {
...
- (BOOL)_isDataStreamConfigurationValid
{
  ...
  v5 = [v4 findCharacteristicWithType:*MEMORY[0x1E4F2D048]];
  id v6 = [v5 value];
  ...
  if (v6)
  {
    ...
    v9 = (void *)[v7 initWithVersionString:v8];
    ...
    if (v9)
    {
      ...
      if (v10 == 1)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
        {
          ...
          id v16 = [(HMDDataStreamController *)v12 accessory];
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v123 = 2112;
          v124 = v20;
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@HDS has version '%@' (%@/%@)", buf, 0x2Au);
        ...
        if (v21)
        {
          ...
          v22 = (void *)MEMORY[0x1E4F5BD20];
          v23 = [v21 value];
          id v115 = 0;
          v24 = [v22 parsedFromData:v23 error:&v115];
          id v25 = v115;
          ...
          if (v26)
          {
            ...
            if (os_log_type_enabled(v84, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v121 = 2112;
              v122 = v91;
              _os_log_impl(&dword_1D49D5000, v84, OS_LOG_TYPE_INFO, "%{public}@Failed to parse HDS supported configuration (%@/%@)", buf, 0x20u);
                        ...
                        else
                        {
                          ...
                          if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
                          {
                            ...
                            *(_DWORD *)buf = 138543362;
                            v118 = v44;
                            _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory with HDS service advertises HDS-over-HAP but provides no MTU; ignoring.",
                              buf,
                              0xCu);
                          }
                        }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v121 = 2112;
            v122 = v81;
            _os_log_impl(&dword_1D49D5000, v75, OS_LOG_TYPE_INFO, "%{public}@No HDS supported configuration (%@/%@)", buf, 0x20u);
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v123 = 2112;
        v124 = v72;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@HDS version '%@' is not supported (%@/%@)", buf, 0x2Au);
    ...
    {
      uint64_t v56 = MEMORY[0x1D9452090]();
      v57 = self;
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v123 = 2112;
        v124 = v65;
        _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_INFO, "%{public}@HDS version '%@' was not parsable (%@/%@)", buf, 0x2Au);
...
LABEL_50:
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v121 = 2112;
    v122 = v55;
    _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@No HDS version found (%@/%@)", buf, 0x20u);
...
- (void)_handleAccessoryConnected
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    uint64_t v10 = [(HMDDataStreamController *)v7 accessory];
    ...
    __int16 v22 = 2112;
    v23 = v13;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory with HDS service is connected: %@. Configured: %@ Accepts Bulk Send: %@", (uint8_t *)&v16, 0x2Au);
  }
  if (v4 && v5)
  {
    v14 = [MEMORY[0x1E4F28EB8] defaultCenter];
    __int16 v15 = [(HMDDataStreamController *)v7 accessory];
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = [(HMDDataStreamController *)v8 defaultDataStream];
      int v12 = [v11 isActive];
      __int16 v13 = @"inactive";
      if (v12) {
        __int16 v13 = @"active";
      }
      int v17 = 138543618;
      ...
      __int16 v19 = 2112;
      __int16 v20 = v13;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Idle timer fired and data stream is %@", (uint8_t *)&v17, 0x16u);
    }
    ...
    if ((v15 & 1) == 0)
    {
      int v16 = [(HMDDataStreamController *)v8 defaultDataStream];
      [v16 close];
    }
...
- (void)_stopIdleTimer
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      int v11 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping idle timer", (uint8_t *)&v10, 0xCu);
    }
...
- (void)_startIdleTimer
{
  ...
  id v4 = (void *)MEMORY[0x1D9452090]([(HMDDataStreamController *)self _stopIdleTimer]);
  BOOL v5 = self;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v19 = 138543362;
    __int16 v20 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting idle timer", (uint8_t *)&v19, 0xCu);
  }
  uint64_t v8 = [MEMORY[0x1E4F65530] sharedPreferences];
  ...
  v14 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:1 options:v13];
  [(HMDDataStreamController *)v5 setIdleTimer:v14];

  char v15 = [(HMDDataStreamController *)v5 idleTimer];
  [v15 setDelegate:v5];

  int v16 = [(HMDDataStreamController *)v5 workQueue];
  int v17 = [(HMDDataStreamController *)v5 idleTimer];
  [v17 setDelegateQueue:v16];

  __int16 v18 = [(HMDDataStreamController *)v5 idleTimer];
  [v18 resume];
}
...
{
  id v2 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F64ED0] code:2 userInfo:&unk_1F2DCA820];
...
- (void)openBulkSendSessionForFileType:(id)a3 reason:(id)a4 metadata:(id)a5 queue:(id)a6 callback:(id)a7
{
  ...
  id v14 = a5;
  id v15 = a6;
  int v16 = (void (**)(id, void, void *))a7;
  int v17 = +[HMDDataStreamBulkSendProtocol protocolName];
  __int16 v18 = [(HMDDataStreamController *)self _getActiveProtocolWithName:v17];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v29 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@HMDDataStreamBulkSendProtocol not registered; cannot start bulk send session",
        buf,
        0xCu);
    ...
    BOOL v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    v16[2](v16, 0, v26);
  }
}
...
- (void)dataStreamDidUpdateActiveStatus:(id)a3
{
  ...
  BOOL v5 = [(HMDDataStreamController *)self defaultDataStream];
  int v6 = [v5 isActive];
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v9 = 138543362;
    int v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@DataStream opened", (uint8_t *)&v9, 0xCu);
  }
...
- (void)dataStreamDidClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v9 = 138543362;
    int v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@DataStream closed", (uint8_t *)&v9, 0xCu);
  }
...
- (void)dataStream:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@DataStream failed with error (%@)!", (uint8_t *)&v12, 0x16u);
  }
...
- (void)_resetDefaultDataStream
{
  ...
  id v3 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54];
...
- (void)_createBulkStreamProtocol
{
  ...
  id v4 = [(HMDDataStreamController *)self workQueue];
  BOOL v5 = [(HMDDataStreamController *)self accessory];
  ...
  uint64_t v8 = +[HMDDataStreamBulkSendProtocol protocolName];
...
- (void)_cancelStreamTransportWithError:(id)a3
{
  uint64_t v21 = *MEMORY[0x1E4F143B8];
  id v4 = a3;
  BOOL v5 = [(HMDDataStreamController *)self setupInProgress];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      __int16 v20 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Canceling DataStream setup", (uint8_t *)&v19, 0xCu);
    }
  ...
  else
  {
    ...
    if (v11)
    {
      if (v15)
      {
        ...
        int v19 = 138543362;
        __int16 v20 = v16;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Canceling active DataStream", (uint8_t *)&v19, 0xCu);
      }
    ...
    else
    {
      if (v15)
      {
        ...
        int v19 = 138543362;
        __int16 v20 = v18;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Dropping cancel-stream; appears to already be canceled",
          (uint8_t *)&v19,
          0xCu);
      }
    }
...
- (void)dataStreamSetupOperation:(id)a3 didFailWithError:(id)a4
{
  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      __int16 v14 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Canceling DataStream setup (which is in progress)", (uint8_t *)&v13, 0xCu);
    }
...
- (void)dataStreamSetupOperation:(id)a3 didSucceedWithTransport:(id)a4 sessionEncryption:(id)a5
{
  ...
  if (v11 == v8)
  {
    ...
    __int16 v18 = [(HMDDataStreamController *)self logIdentifier];
    int v19 = ((void (**)(void, id, id, void *, void *))v16)[2](v16, v9, v10, v17, v18);

    [(HMDDataStreamController *)self setDefaultDataStream:v19];
    __int16 v20 = [(HMDDataStreamController *)self defaultDataStream];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      __int16 v22 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Setup operation succeeded however is no longer the current one; ignoring its result.",
        (uint8_t *)&v21,
        0xCu);
    }
  }
...
- (void)dataStreamInitializationSetupOperation:(id)a3 didCompleteSupportReadWithStatus:(BOOL)a4
{
  ...
  if (v7 == v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138543362;
        int v19 = v15;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Canceling DataStream initialization setup (which is in progress)", (uint8_t *)&v18, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      int v19 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Setup init operation succeeded however is no longer the current one; ignoring its result.",
        (uint8_t *)&v18,
        0xCu);
    }
  }
    ...
    else
    {
      if (![(HMDDataStreamController *)self supportsDataStreamOverHAP] && !v8)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          int v22 = 138543362;
          uint64_t v23 = v20;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; not supported",
            (uint8_t *)&v22,
            0xCu);
        }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v22 = 138543362;
    uint64_t v23 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Initiating stream setup while already in progress; ignoring this extra call.",
      (uint8_t *)&v22,
      0xCu);
  }
}
...
- (BOOL)setupRequiresCharacteristicReads
{
  ...
  if (![(HMDDataStreamController *)self _isDataStreamConfigurationValid])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v8 = 138543362;
      id v9 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Current data stream configuration is not valid", (uint8_t *)&v8, 0xCu);
    }
  }
...
- (void)_createStreamSocketWithStreamProtocol:(id)a3 applicationProtocolName:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Creating stream socket for application protocol %@", (uint8_t *)&v18, 0x16u);
  }
...
- (void)_failPendingSocketRequestsWithError:(id)a3
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  BOOL v5 = [(HMDDataStreamController *)self pendingSocketRequests];
...
- (void)_processPendingSocketRequests
{
  ...
  if ((v4 & 1) == 0)
  {
    BOOL v5 = [(HMDDataStreamController *)self _getStreamProtocol];
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
    long long v18 = 0u;
...
void __78__HMDDataStreamController_openStreamSocketWithApplicationProtocol_completion___block_invoke(uint64_t a1)
{
        ...
        v3))
  {
    ...
    BOOL v5 = [[HMDPendingSocketRequest alloc] initWithApplicationProtocolName:*(void *)(a1 + 40) completion:*(void *)(a1 + 48)];
    [v4 addObject:v5];
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v15 = v10;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Waiting for DataStream setup before processing stream socket request", buf, 0xCu);
      }
    }
    else
    {
...
- (void)sendTargetControlWhoAmIWithIdentifier:(unsigned int)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      int v14 = 138543362;
      long long v15 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Data Stream sending target-control whoami message", (uint8_t *)&v14, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      int v14 = 138543362;
      long long v15 = v13;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Data Stream not running; dropping target-control whoami message",
        (uint8_t *)&v14,
        0xCu);
    }
  }
    ...
    if (v17)
    {
      ...
      if (v19)
      {
        if (v23)
        {
          ...
          *(void *)&v28[4] = v24;
          id v25 = "%{public}@Removed pending bulk-send listener registration (waiting for stream setup)";
LABEL_20:
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, v25, v28, 0xCu);
        }
      }
      else if (v23)
      {
        ...
        *(_DWORD *)v28 = 138543362;
        *(void *)&v28[4] = v24;
        id v25 = "%{public}@Removed bulk-send listener trivially (stream setting up, but this was not part of it)";
        goto LABEL_20;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v28 = 138543362;
        *(void *)&v28[4] = v24;
        id v25 = "%{public}@Removed bulk-send listener trivially (nothing had started)";
        goto LABEL_20;
      }
    }
...
LABEL_22:
  ...
  if (v11)
  {
    if (v15)
    {
      ...
      *(_DWORD *)v28 = 138543362;
      *(void *)&v28[4] = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Removed bulk-send listener on this stream", v28, 0xCu);
    }
  ...
  if (v15)
  {
    ...
    *(_DWORD *)v28 = 138543362;
    *(void *)&v28[4] = v26;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Removed bulk-send listener on this stream (but there was no protocol!?)", v28, 0xCu);
  }
  BOOL v27 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1064];
  ...
  if (v9)
  {
    ...
    if (v14)
    {
      if (v18)
      {
        ...
        __int16 v31 = 2112;
        id v32 = v7;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Adding bulk-send listener on this stream for file-type '%@'", (uint8_t *)&v29, 0x16u);
      }
    ...
    else
    {
      if (v18)
      {
        ...
        __int16 v31 = 2112;
        id v32 = v7;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Cancelling bulk-send listener registration for file-type '%@' due to no such protocol on this stream", (uint8_t *)&v29, 0x16u);
      }
      BOOL v27 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1064];
  ...
  else
  {
    ...
    if (v20)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v31 = 2112;
        id v32 = v7;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Add pending bulk-send listener registration for file-type '%@' (waiting for stream setup)", (uint8_t *)&v29, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v31 = 2112;
        id v32 = v7;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Canceling bulk-send listener registration for file-type '%@' due to no active data stream", (uint8_t *)&v29, 0x16u);
      }
      id v12 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1063];
...
- (void)_handleAccessoryDisconnected
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v4;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory with HDS service is no longer connected: %@. Removing any transports that were active", (uint8_t *)&v8, 0x16u);
  }
  v4->_supportsDataStreamOverTCP = 0;
  id v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
...
void __55__HMDDataStreamController_handleAccessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      long long v17 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unconfigured accessory: %@ did not match self.accessory :%@", (uint8_t *)&v12, 0x20u);
    }
  }
}
...
- (HMDDataStreamController)initWithAccessory:(id)a3 service:(id)a4 workQueue:(id)a5
{
  return [(HMDDataStreamController *)self initWithAccessory:a3 service:a4 workQueue:a5 dataStreamFactory:&__block_literal_global_48000];
}
