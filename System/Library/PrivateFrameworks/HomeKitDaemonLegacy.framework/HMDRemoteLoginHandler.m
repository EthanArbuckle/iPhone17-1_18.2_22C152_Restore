...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Unstaging logged in account: %@", (uint8_t *)&v12, 0x16u);
  }
...
void __69__HMDRemoteLoginHandler_handleAccountUsernameUpdatedOnCurrentDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    id v7 = [MEMORY[0x1E4F65538] defaultFormatter];
    v8 = [v7 privateStringForObjectValue:v2];
    int v19 = 138543618;
    v20 = v6;
    __int16 v21 = 2112;
    v22 = v8;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEBUG, "%{public}@loggedInAccount On Update:%@", (uint8_t *)&v19, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if ((v14 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v19 = 138543362;
        v20 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating account on username change", (uint8_t *)&v19, 0xCu);
      }
...
- (void)_registerForUsernameUpdates
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Register for username updates", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_updateLoggedInAccount:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    int v19 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating logged in account to: %@, supportsMessagedHomePodSettings: %@", (uint8_t *)&v14, 0x20u);
  }
  ...
  {
    v13 = [MEMORY[0x1E4F65480] entitledMessageWithName:@"kRemoteLoginAccountUpdatedNotificationKey" messagePayload:0];
...
- (void)_postUpdatedAccountInfo:(id)a3
{
  ...
  {
    v5 = (void *)MEMORY[0x1D9452090]([(HMDRemoteLoginHandler *)self setLoggedInAccount:v4]);
    id v6 = self;
    id v7 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Posting event to update logged in account: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to post account: %@ due to unsupported account target", buf, 0x16u);
    }
  }
}
  ...
  if (v6 || v4 == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v38 = 2112;
      v39 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to post event to update logged in account: %@ due to missing topic: %@ event forwarder: %@ event source: %@", buf, 0x34u);
    }
  }
  else
  {
    ...
    if (v14 && [v14 isEqual:v13])
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        v33 = v15;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Skip posting event to update logged in account as it matches account info from last event: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        v35 = v13;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Forwarding account info event with topic: %@ for accountInfo: %@", buf, 0x20u);
      }
      id v24 = objc_alloc(MEMORY[0x1E4F69F48]);
      [MEMORY[0x1E4F1C9C8] timeIntervalSinceReferenceDate];
      v25 = objc_msgSend(v24, "initWithSource:cachePolicy:combineType:timestamp:", v5, 2, 2);
      id v26 = objc_alloc(MEMORY[0x1E4F69F38]);
      v27 = [v13 protoData];
      v28 = (void *)[v26 initWithEventData:v27 metadata:v25];

      v29[0] = MEMORY[0x1E4F143A8];
      v29[1] = 3221225472;
      v29[2] = __49__HMDRemoteLoginHandler__postUpdatedAccountInfo___block_invoke_57;
      v29[3] = &unk_1E6A197F0;
      v29[4] = *(void *)(a1 + 32);
...
void __49__HMDRemoteLoginHandler__postUpdatedAccountInfo___block_invoke_57(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to forward account info event with error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (void)_postAccountInfoFromAccountStore
{
  ...
  if (v3)
  {
      ...
      && [v4 isCurrentAccessory])
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v17 = 2112;
        __int16 v18 = v6;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Posting account store account: %@", (uint8_t *)&v15, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      __int16 v16 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to post account info from account store due to missing accessory", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (id)eventTopicForAccountInfo
{
  ...
  if (v4 && v6)
  {
    id v7 = [MEMORY[0x1E4F2E580] topicFromSuffixID:*MEMORY[0x1E4F2C368] homeUUID:v6 accessoryUUID:v4];
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      __int16 v18 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get account info event topic due to missing accessory uuid: %@ home uuid: %@", (uint8_t *)&v13, 0x20u);
    }
    id v7 = 0;
  }
...
- (id)accountInfoForAccount:(id)a3
{
  id v3 = (objc_class *)MEMORY[0x1E4F2E588];
  id v4 = a3;
  id v5 = [v3 alloc];
  BOOL v6 = [v4 username];
...
- (id)accountInfoFromLastEvent
{
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      ...
      if (v6)
      {
        id v7 = objc_alloc(MEMORY[0x1E4F2E588]);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            int v24 = 138543362;
            v25 = v22;
            _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last account info event account due invalid stored event data", (uint8_t *)&v24, 0xCu);
          }
        }
      }
      else
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        int v24 = 138543362;
        v25 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last account info event account due to no event store read handle", (uint8_t *)&v24, 0xCu);
      }
      id v9 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v24 = 138543362;
      v25 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last account info event account due to no topic", (uint8_t *)&v24, 0xCu);
    }
    id v9 = 0;
  }
...
- (void)updateFrameworkWithReason:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v4;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to update home graph without a home manager for reason: %@", (uint8_t *)&v13, 0x16u);
    }
  }
}
...
- (void)stageLoggedInAccount:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Staging logged in account: %@", (uint8_t *)&v10, 0x16u);
  }
...
- (void)_handleUpdateLoggedInAccountMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v42 = 2112;
    v43 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update logged in account message: %@", (uint8_t *)&v40, 0x16u);
  }
  int v10 = [v4 dataForKey:@"kRemoteLoginAccount"];
  if (v10)
  {
    id v11 = [MEMORY[0x1E4F28DC0] deserializeObjectWithData:v10 allowedClass:objc_opt_class() frameworkClasses:MEMORY[0x1E4F1CBF0]];
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v42 = 2112;
        v43 = v11;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Updated account matches the currently logged in account: %@", (uint8_t *)&v40, 0x16u);
      }
...
LABEL_10:
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
        {
          ...
          int v40 = 138543362;
          v41 = v27;
          _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to update account, existing account present", (uint8_t *)&v40, 0xCu);
        }
        ...
        v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48 description:@"Not supported." reason:@"Existing account present." suggestion:0];
...
LABEL_25:
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v42 = 2112;
    v43 = v35;
    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Missing serialized account in message payload: %@", (uint8_t *)&v40, 0x16u);
  }
...
- (void)_sendAccountUpdateNotification:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending account update notification: %@", buf, 0x16u);
    }
    int v17 = @"kRemoteLoginAccount";
  ...
  id v11 = [(HMDRemoteLoginHandler *)self initiator];
...
{
  id v5 = [MEMORY[0x1E4F65480] entitledMessageWithName:@"kRemoteLoginAccountUpdatedNotificationKey" messagePayload:*(void *)(a1 + 32)];
  v2 = [*(id *)(a1 + 40) initiator];
  id v3 = [v2 msgDispatcher];
  id v4 = [*(id *)(a1 + 40) uuid];
...
- (void)_handleRemoteLoginAccount:(id)a3 message:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  int v8 = [v6 loggedInAccount];
  if (v8)
  {
    id v38 = 0;
    id v9 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v8 error:&v38];
    id v10 = v38;
    if (!v9)
    {
      id v11 = v8;
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v41 = 2112;
        id v42 = v10;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive logged in account from logged in account data: %@", buf, 0x16u);
  ...
  int v17 = [(HMDRemoteLoginHandler *)self loggedInAccount];
  __int16 v18 = objc_msgSend(v17, "aa_altDSID");
  uint64_t v19 = objc_msgSend(v9, "aa_altDSID");
  if (HMFEqualObjects())
  {
    ...
    if (v36)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v43 = 2112;
        uint64_t v44 = v9;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Not updating logged in account from %@ to %@, as they are equal", buf, 0x20u);
      }
      goto LABEL_17;
    }
  }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    uint64_t v44 = v9;
    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating logged in account from %@ to %@", buf, 0x20u);
  }
...
- (void)registerForMessages
{
  ...
  uint64_t v4 = *MEMORY[0x1E4F2DCF8];
...
- (void)configureWithWorkQueue:(id)a3 messageDispatcher:(id)a4 eventStoreReadHandle:(id)a5 eventForwarder:(id)a6
{
  ...
  id v15 = [(HMDRemoteLoginHandler *)self receiver];
...
- (HMDRemoteLoginHandler)initWithUUID:(id)a3 accessory:(id)a4 loggedInAccount:(id)a5 accountStore:(id)a6 targetSupportsAccounts:(BOOL)a7
{
  ...
  if (v17)
  {
    ...
    uint64_t v19 = [objc_alloc(MEMORY[0x1E4F65560]) initWithValue:0];
    ...
    __int16 v21 = [[HMDRemoteLoginInitiator alloc] initWithUUID:v13 accessory:v14 remoteLoginHandler:v18];
    initiator = v18->_initiator;
    v18->_initiator = v21;

    id v23 = [(HMDRemoteLoginBase *)[HMDRemoteLoginReceiver alloc] initWithUUID:v13 accessory:v14 remoteLoginHandler:v18];
...
- (HMDRemoteLoginHandler)initWithAccessory:(id)a3 loggedInAccountData:(id)a4
{
  ...
  {
    id v20 = 0;
    id v8 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v7 error:&v20];
    id v9 = v20;
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v24 = 2112;
        id v25 = v9;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive logged in account from logged in account data: %@", buf, 0x16u);
      }
    }
  }
  else
  ...
  id v15 = [v6 uuid];
  __int16 v21 = @"HMDRemoteLoginHandler";
...
+ (id)remoteMessages
{
  ...
  uint64_t v2 = *MEMORY[0x1E4F2ED00];
  v9[6] = *MEMORY[0x1E4F2ECF8];
  v9[7] = v2;
  uint64_t v3 = *MEMORY[0x1E4F2ED10];
  v9[8] = *MEMORY[0x1E4F2ED08];
  v9[9] = v3;
  uint64_t v4 = *MEMORY[0x1E4F2ECD0];
  v9[10] = *MEMORY[0x1E4F2ECC8];
  v9[11] = v4;
  uint64_t v5 = *MEMORY[0x1E4F2ECE0];
  v9[12] = *MEMORY[0x1E4F2ECD8];
  v9[13] = v5;
  uint64_t v6 = *MEMORY[0x1E4F2ECF0];
  v9[14] = *MEMORY[0x1E4F2ECE8];
  v9[15] = v6;
  id v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v9 count:16];
  return v7;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_190760 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_190760, &__block_literal_global_190761);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v2_190762;
  return v2;
}
...
uint64_t __36__HMDRemoteLoginHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_190762;
  logCategory__hmf_once_v2_190762 = v0;
