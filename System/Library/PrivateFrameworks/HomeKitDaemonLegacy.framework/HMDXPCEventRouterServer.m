...
void __61__HMDXPCEventRouterServer_handleConnectionActiveStateChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@[HMDXPCEventRouterSever] Received notification that connection active state changed: %@", (uint8_t *)&v13, 0x16u);
  }
  if (v4)
  {
    v9 = *(void **)(a1 + 40);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_7564 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_7564, &__block_literal_global_7565);
  }
  v2 = (void *)logCategory__hmf_once_v1_7566;
  return v2;
}
...
{
  v2 = NSString;
  id v3 = [(HMDXPCEventRouterServer *)self persistentConnectionServer];
  id v4 = [v3 dumpStateDescription];
...
{
  id v5 = a4;
  int v6 = [(HMDXPCEventRouterServer *)self dataSource];
...
- (id)server:(id)a3 upstreamTopicsForTopic:(id)a4
{
  id v4 = +[HMDHomeEventsGenerated upstreamClientTopicForTopic:a4];
  id v5 = objc_msgSend(MEMORY[0x1E4F1CAD0], "na_setWithSafeObject:", v4);
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v35 = 2112;
      id v36 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Sending cached events: %ld to connection: %@", buf, 0x20u);
    }
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v35 = 2112;
      id v36 = v7;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Sending cached events: %@ to connection: %@", buf, 0x20u);
    }
    v19 = objc_msgSend(v6, "na_map:", &__block_literal_global_43);
    id v20 = objc_alloc_init(MEMORY[0x1E4F2EBE0]);
    v21 = (void *)[v19 mutableCopy];
    [v20 setCachedEvents:v21];

    v22 = objc_msgSend(v20, "data", *MEMORY[0x1E4F2E490]);
    v30 = v22;
    v23 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v30 forKeys:&v29 count:1];

    v24 = (void *)MEMORY[0x1E4F65480];
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Could not obtain xpc connection from %@", buf, 0x16u);
    }
  }
}
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v35 = 2112;
      id v36 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Sending events: %ld to connection: %@", buf, 0x20u);
    }
    __int16 v15 = (void *)MEMORY[0x1D9452090]();
    id v16 = v11;
    uint64_t v17 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v35 = 2112;
      id v36 = v7;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Sending events: %@ to connection: %@", buf, 0x20u);
    }
...
- (void)_handleChangeRegistrationsRequest:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v33;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@No transport on message.", buf, 0xCu);
    }
    uint64_t v34 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Did not find transport" reason:@"Need xpc connection" suggestion:0];
    goto LABEL_24;
  }
  if (([v4 isEntitledForSPIAccess] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v38;
      _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Not entitled.", buf, 0xCu);
    }
...
LABEL_24:
  ...
  if (v9)
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v15;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Found xpc connection in message", buf, 0xCu);
      }
      id v16 = [v4 dataForKey:*MEMORY[0x1E4F2E498]];
      if (v16)
      {
        uint64_t v17 = (void *)[objc_alloc(MEMORY[0x1E4F2EBD8]) initWithData:v16];
        ...
        uint64_t v25 = objc_msgSend(v24, "na_map:", &__block_literal_global_29_7541);
        v26 = (void *)v25;
        if (v25) {
          v27 = (void *)v25;
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v52 = v48;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@No message payload present.", buf, 0xCu);
        }
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        id v54 = v9;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Connection is not active %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v42;
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Transport is not XPC connection.", buf, 0xCu);
    }
    v43 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Transport is not XPC" reason:@"Need xpc connection" suggestion:0];
...
void __61__HMDXPCEventRouterServer__handleChangeRegistrationsRequest___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v8 = objc_msgSend(v5, "na_map:", &__block_literal_global_32);
    id v9 = objc_alloc_init(MEMORY[0x1E4F2EBE0]);
    char v10 = (void *)[v8 mutableCopy];
    [v9 setCachedEvents:v10];

    uint64_t v13 = *MEMORY[0x1E4F2E490];
    v11 = [v9 data];
    v14[0] = v11;
...
{
  v1 = (void *)[objc_alloc(MEMORY[0x1E4F69F78]) initWithQueue:a1[4] provider:a1[5] registrationEventRouter:a1[6] storeReadHandle:a1[7] logCategory:"XPCEventRouter.Server"];
  return v1;
}

uint64_t __38__HMDXPCEventRouterServer_logCategory__block_invoke()
{
  logCategory__hmf_once_v1_7566 = HMFCreateOSLogHandle();
