...
- (BOOL)isVideoInitData:(id)a3 combinableWithVideoInitData:(id)a4
{
  return [MEMORY[0x1E4F69888] isInitializationSegment:a3 combinableWithInitializationSegment:a4];
}
...
{
  uint64_t v6 = 0;
  v4 = [MEMORY[0x1E4F69840] analyzerWithConfiguration:a3 identifier:a4 error:&v6];
  return v4;
}
