...
- (void)updateNetworkMismatchInfoWithCompletionHandler:(id)a3
{
  uint64_t v5 = __swift_instantiateConcreteTypeFromMangledName(&qword_1EBD99988);
  ...
  *(void *)(v9 + 24) = self;
  ...
  v12[5] = v11;
  v13 = self;
  sub_1D4A5EFA8((uint64_t)v7, (uint64_t)&unk_1EA70F700, (uint64_t)v12);
  swift_release();
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not obtain accessory from WiFi network info change notification: %@", buf, 0x16u);
    }
  }
}
...
- (void)_rpDeviceLostHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Lost RPCompanionLinkDevice: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)_rpDeviceChangedHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@RPCompanionLinkDevice %@ changed", (uint8_t *)&v25, 0x16u);
  }
  uint64_t v10 = [(HMDSymptomManager *)v7 networkReachableRPCompanionLinkDevices];
  v11 = [v4 idsDeviceIdentifier];
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v4;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@RPCompanionLinkDevice %@ changed", (uint8_t *)&v25, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      v30 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find RPCompanionLinkDevice %@ in the network reachable RPCompanionLinkDevices: %@", (uint8_t *)&v25, 0x20u);
    }
...
- (void)_rpDeviceFoundHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Found new RPCompanionLinkDevice: %@)", (uint8_t *)&v13, 0x16u);
  }
  uint64_t v10 = [(HMDSymptomManager *)v7 networkReachableRPCompanionLinkDevices];
  v11 = [v4 idsDeviceIdentifier];
...
- (void)_sfDeviceLostHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Lost SFDevice: %@", (uint8_t *)&v17, 0x16u);
  }
...
- (void)_sfDeviceChangedHandler:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v4;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@SFDevice %@ changed", (uint8_t *)&v20, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v4;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Did not find SFDevice %@ in the nearby SFDevices, so treating it as a found device", (uint8_t *)&v20, 0x16u);
    }
...
- (void)_sfDeviceFoundHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Found new SFDevice: %@", (uint8_t *)&v18, 0x16u);
  }
  uint64_t v10 = [(HMDSymptomManager *)v7 nearbySFDevices];
  v11 = [v4 idsIdentifier];
  [v10 setObject:v4 forKey:v11];
  ...
  if (v39)
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v81 = 2112;
      v82 = v43;
      _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@ is not reachable over local network: %@", buf, 0x20u);
...
LABEL_38:
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v83 = 2112;
          v84 = v57;
          _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_INFO, "%{public}@Mismatched WiFi SSID, current: %@ accessory(%@): %@", buf, 0x2Au);
        ...
        if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v79 = 2112;
          id v80 = v62;
          _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_INFO, "%{public}@Creating WiFi network mismatch symptom for nearby IDS identifier that is not network reachable: %@", buf, 0x16u);
        }
        uint64_t v14 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:11];
        [v9 addObject:v14];
        goto LABEL_7;
      }
      v67 = v44;
      ...
      if (!v47)
      {
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v79 = 2112;
          id v80 = v5;
          _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ WiFi info is nil", buf, 0x16u);
        }
      }
      goto LABEL_8;
    }
  ...
  if (v69)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v79 = 2112;
      id v80 = v29;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Creating captive lease renewal symptom, WiFi SSID: %@", buf, 0x16u);

      uint64_t v24 = v73;
    }

    int v17 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:19];
    [v9 addObject:v17];
    goto LABEL_16;
  }
LABEL_17:
  ...
  if ((v32 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v81 = 2112;
      v82 = v9;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Updating symptoms for accessory with IDS identifier %@: %@", buf, 0x20u);
    }
    [v8 setSymptoms:v9];
  ...
  if (v6)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        __int16 v15 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Peforming network mismatch fetch as accessory is in list", (uint8_t *)&v14, 0xCu);
      }
      [(HMDSymptomManager *)v11 updateNetworkMismatchInfoWithCompletionHandler:&__block_literal_global_138_110417];
    }
  }
}
...
- (void)_initiateFixForAccessory:(id)a3 completion:(id)a4
{
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      char v15 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:11];
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v34 = 1024;
        int v35 = v16;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Asking SFClient to repair device %@ with flags %d", (uint8_t *)&v30, 0x1Cu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v32 = 2112;
        id v33 = v6;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Sharing has not discovered SFDevice for %@, not initiating fix process.", (uint8_t *)&v30, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v32 = 2112;
      id v33 = v6;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@The accessory (%@) does not have idsIdentifier, not initiating fix process.", (uint8_t *)&v30, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v13 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Device doesn't support retrieving problem flags.", buf, 0xCu);
    }
  }
...
void __54__HMDSymptomManager__registerForCurrentDeviceSymptoms__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v5;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Setting current device problem flags on start %llu, error: %@", (uint8_t *)&v10, 0x20u);
  }
...
void __54__HMDSymptomManager__registerForCurrentDeviceSymptoms__block_invoke_131(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v14 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Current device problem flags changed", buf, 0xCu);
  }
  if (objc_opt_respondsToSelector())
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Device doesn't support retrieving problem flags.", buf, 0xCu);
    }
  }
}
...
void __54__HMDSymptomManager__registerForCurrentDeviceSymptoms__block_invoke_132(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v5;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Setting current device problem flags to %llu, error: %@", (uint8_t *)&v10, 0x20u);
  }
  [*(id *)(a1 + 32) setCurrentDeviceProblemFlags:a2];
}
...
- (void)_stop
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    long long v11 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopping SFDeviceDiscovery and RPCompanionLinkClient in HMDSymptomManager.", (uint8_t *)&v10, 0xCu);
  }
...
- (void)_startCompanionLinkClient
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v22 = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting RPCompanionLinkClient in HMDSymptomManager", buf, 0xCu);
  }
...
void __46__HMDSymptomManager__startCompanionLinkClient__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Found RPCompanionLinkDevice: %@", (uint8_t *)&v11, 0x16u);
  }
...
void __46__HMDSymptomManager__startCompanionLinkClient__block_invoke_124(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@RPCompanionLinkDevice %@ changed", (uint8_t *)&v11, 0x16u);
  }
  int v10 = [v3 idsDeviceIdentifier];
...
void __46__HMDSymptomManager__startCompanionLinkClient__block_invoke_126(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Lost RPCompanionLinkDevice: %@", (uint8_t *)&v11, 0x16u);
  }
  int v10 = [v3 idsDeviceIdentifier];
...
- (void)_startDeviceDiscovery
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Starting SFDeviceDiscovery in HMDSymptomManager", buf, 0xCu);
  }
...
uint64_t __63__HMDSymptomManager_stopDiscoveringSymptomsRequiringNearbyInfo__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for symptoms requiring nearby info", (uint8_t *)&v9, 0xCu);
  }
  [*(id *)(a1 + 32) setDeviceDiscoveryFlags:0x10000];
  [*(id *)(a1 + 32) setNearbyAccessoryUUIDsNotOnCurrentNetwork:MEMORY[0x1E4F1CBF0]];
  id v6 = *(void **)(a1 + 32);
...
uint64_t __64__HMDSymptomManager_startDiscoveringSymptomsRequiringNearbyInfo__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v13 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting discovery for symptoms requiring nearby info", buf, 0xCu);
  }
...
void __64__HMDSymptomManager_startDiscoveringSymptomsRequiringNearbyInfo__block_invoke_120(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v9 = 2112;
    id v10 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Updated network mismatch accessories to %@", (uint8_t *)&v7, 0x16u);
  }
}
...
void __41__HMDSymptomManager_deregisterAccessory___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Deregistering accessory: %@", (uint8_t *)&v12, 0x16u);
    }
    ...
    if (v3)
    {
      ...
      if (!v5)
      {
        if (v9)
        {
          ...
          __int16 v36 = 2112;
          v37 = v3;
          _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering accessory (%@) for idsIdentifier %@", (uint8_t *)&v32, 0x20u);
        }
...
LABEL_11:
        _os_log_impl(&dword_1D49D5000, v13, v14, v12, (uint8_t *)&v32, 0x16u);
      }
    }
    else
    {
...
LABEL_21:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v32 = 138543362;
    id v33 = v18;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@This device doesn't support registering accessories", (uint8_t *)&v32, 0xCu);
  }
}
...
- (HMDSymptomManager)initWithQueue:(id)a3 dataSource:(id)a4 supportsRegistering:(BOOL)a5 supportsCurrentDeviceSymptoms:(BOOL)a6 deviceDiscovery:(id)a7 companionLinkClient:(id)a8 wifiManager:(id)a9 notificationCenter:(id)a10 sharingClientFactory:(id)a11
{
  ...
  if (v20)
  {
    ...
    v21->_nearbyAccessoryUUIDsNotOnCurrentNetwork = (NSArray *)MEMORY[0x1E4F1CBF0];
    ...
    [(NSNotificationCenter *)v21->_notificationCenter addObserver:v21 selector:sel_handleCurrentNetworkDidChangeNotification_ name:*MEMORY[0x1E4F653E8] object:0];
  }
  if (v13) {
...
- (HMDSymptomManager)initWithDataSource:(id)a3
{
  ...
  uint64_t v11 = [MEMORY[0x1E4F65598] sharedManager];
  id v12 = [MEMORY[0x1E4F28EB8] defaultCenter];
  BOOL v13 = [(HMDSymptomManager *)self initWithQueue:v8 dataSource:v4 supportsRegistering:+[HMDDeviceCapabilities supportsSymptomsHandler] supportsCurrentDeviceSymptoms:0 deviceDiscovery:v9 companionLinkClient:v10 wifiManager:v11 notificationCenter:v12 sharingClientFactory:&__block_literal_global_110490];
...
{
  id v0 = objc_alloc_init(MEMORY[0x1E4F9F688]);
  return v0;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t44_110499 != -1) {
    dispatch_once(&logCategory__hmf_once_t44_110499, &__block_literal_global_142_110500);
  }
  v2 = (void *)logCategory__hmf_once_v45_110501;
  return v2;
}
...
uint64_t __32__HMDSymptomManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v45_110501;
  logCategory__hmf_once_v45_110501 = v0;
...
+ (id)_symptomsForProblemFlags:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v33 = 2048;
    unint64_t v34 = a3;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Parsing problem flags %llu to HMSymptoms", (uint8_t *)&v31, 0x16u);
  }
  BOOL v9 = [MEMORY[0x1E4F1CA80] set];
  if ((a3 & 2) != 0)
  {
    uint64_t v15 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:1];
    [v9 addObject:v15];
...
LABEL_5:
  ...
  id v16 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:2];
  [v9 addObject:v16];
...
LABEL_29:
  long long v17 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:3];
  [v9 addObject:v17];
...
LABEL_30:
  id v18 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:4];
  [v9 addObject:v18];
...
LABEL_31:
  id v19 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:5];
  [v9 addObject:v19];
...
LABEL_32:
  long long v20 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:6];
  [v9 addObject:v20];
...
LABEL_33:
  uint64_t v21 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:7];
  [v9 addObject:v21];
...
LABEL_34:
  uint64_t v22 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:8];
  [v9 addObject:v22];
...
LABEL_35:
  uint64_t v23 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:9];
  [v9 addObject:v23];
...
LABEL_36:
  uint64_t v24 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:10];
  [v9 addObject:v24];
...
LABEL_37:
  uint64_t v25 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:13];
  [v9 addObject:v25];
...
LABEL_38:
  uint64_t v26 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:14];
  [v9 addObject:v26];
...
LABEL_39:
  __int16 v27 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:16];
  [v9 addObject:v27];
...
LABEL_40:
  uint64_t v28 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:17];
  [v9 addObject:v28];
...
LABEL_42:
    uint64_t v30 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:20];
    [v9 addObject:v30];
...
LABEL_41:
  __int16 v29 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:18];
  [v9 addObject:v29];
...
LABEL_19:
  ...
  {
LABEL_20:
    id v10 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:21];
    [v9 addObject:v10];
  }
LABEL_21:
  ...
  if ((a3 & 0x20) != 0 && v11)
  {
    id v12 = (void *)[objc_alloc(MEMORY[0x1E4F2EB68]) initWithType:1000];
    [v9 addObject:v12];
  }
