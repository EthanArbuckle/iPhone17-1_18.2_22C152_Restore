...
uint64_t __34__HMDLocationEvent_didExitRegion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Received a exit callback from HMDLocation for the region callback: [%@]", (uint8_t *)&v8, 0x16u);
  }
...
uint64_t __35__HMDLocationEvent_didEnterRegion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Received a enter callback from HMDLocation for the region callback : [%@]", (uint8_t *)&v8, 0x16u);
  }
  return [*(id *)(a1 + 32) locationEventOccured];
}
...
- (void)informLocationEventOccuranceToResident
{
  ...
  v17 = [v6 remoteAccessDeviceForHome:v4];
  v7 = [HMDRemoteDeviceMessageDestination alloc];
  int v8 = [(HMDEvent *)self uuid];
  v9 = [(HMDRemoteDeviceMessageDestination *)v7 initWithTarget:v8 device:v17];

  __int16 v10 = +[HMDRemoteMessage secureMessageWithName:@"kLocationEventOccuredRequestKey" qualityOfService:17 destination:v9 messagePayload:MEMORY[0x1E4F1CC08]];
  ...
  id v12 = v11;
  id v19 = v12;
  v13 = (void *)MEMORY[0x1D9452090]([v10 setResponseHandler:v18]);
  v14 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2114;
    id v25 = v12;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending message with identifier %{public}@ to inform location event to resident", buf, 0x16u);
  }
...
void __58__HMDLocationEvent_informLocationEventOccuranceToResident__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Message with identifier %@ to inform location event has been sent", (uint8_t *)&v13, 0x16u);
  }
}
...
- (void)_handleLocationEventOccured:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received remote message that location event has occurred, with current activation type %@", (uint8_t *)&v17, 0x16u);
  }
...
- (void)locationEventOccured
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    __int16 v24 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Received a callback that location event has occurred, current activation state: %@", (uint8_t *)&v21, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      v22 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Device Lost. Not informing that location event has occurred", (uint8_t *)&v21, 0xCu);
    }
  }
  else
  {
...
- (BOOL)_activate:(unint64_t)a3 completionHandler:(id)a4
{
  ...
  {
    v16[0] = v8;
    __int16 v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v16 count:1];
  }
  else
  {
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Handling transaction updated", buf, 0xCu);
  }
  id v15 = v9;
  objc_opt_class();
  ...
  if (v17)
  {
    ...
    else
    {
      ...
      {
        int v21 = (void *)MEMORY[0x1E4F28DC0];
        ...
        if (!v24)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v44 = 2112;
            id v45 = v25;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive region from event model: %@", buf, 0x16u);
          }
        ...
        if ((v27 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v46 = 2112;
            v47 = v32;
            _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Updating region %@ to new region %@", buf, 0x20u);
...
- (CLRegion)uniqueRegion
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@unique region %@", buf, 0x16u);
  }
  id v8 = NSString;
  ...
  if (v11)
  {
    ...
    if (!v22)
    {
      __int16 v24 = (void *)MEMORY[0x1D9452090](v23);
      id v25 = v4;
...
LABEL_21:
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, v28, buf, 0x16u);
  ...
  if (isKindOfClass)
  {
    ...
    if (v30
      && (v31 = (void *)v30,
          ...
          v32))
    {
      id v33 = objc_alloc(MEMORY[0x1E4F1E5A0]);
    ...
    else
    {
      ...
      id v45 = objc_alloc(MEMORY[0x1E4F1E5A0]);
      v34 = [v15 proximityUUID];
      if (!v44)
      {
...
LABEL_18:
        ...
        if (!v22)
        {
          __int16 v24 = (void *)MEMORY[0x1D9452090](v46);
          id v25 = v4;
          uint64_t v26 = HMFGetOSLogHandle();
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
...
LABEL_23:
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v52 = 2112;
    v53 = v43;
    _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Cannot create unique region for region of unsupported class %@: %@", buf, 0x20u);
  }
  uint64_t v22 = 0;
LABEL_24:
...
- (id)dumpState
{
  ...
  [v4 setObject:v11 forKeyedSubscript:*MEMORY[0x1E4F64E28]];
  return v4;
}
...
- (void)_handleRetrieveLocationEventForEventTrigger:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      double v18 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Client does not have authorization to location", (uint8_t *)&v17, 0xCu);
    }
    [v4 respondWithPayload:0];
  }
}
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  if ([v4 isAuthorizedForLocationAccess])
  {
    ...
    id v35 = 0;
    uint64_t v6 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v5 error:&v35];
    id v7 = v35;
    if (v6)
    {
      if (HMIsValidRegion())
...
LABEL_15:
      ...
      char v27 = (void *)MEMORY[0x1D9452090]();
      v28 = self;
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v37 = v30;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle update request as provided region is not valid", buf, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        id v39 = v7;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive region from region data: %@", buf, 0x16u);
      }
      id v25 = (void *)MEMORY[0x1E4F28C58];
      uint64_t v26 = 20;
    }
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v37 = v20;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle update request as the client is not authorized for location services", buf, 0xCu);
  }
  id v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:85];
...
- (void)checkFMFStatus:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Checking the ownership with fmfStatus %@", (uint8_t *)&v10, 0x16u);
  }
...
- (BOOL)doesThisTargetCurrentUser
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      double v18 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Not taking the ownership since this trigger belongs to user %@, this device's user %@", (uint8_t *)&v13, 0x20u);
    }
  }
...
- (void)_registerForMessages
{
  ...
  v17[0] = v6;
  v17[1] = v4;
  char v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v17 count:2];
  ...
  v16[0] = v9;
  v16[1] = v4;
  __int16 v10 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  void v16[2] = v10;
  ...
  int v13 = +[HMDFMFHandler sharedHandler];
...
- (HMDLocationEvent)initWithModel:(id)a3 home:(id)a4
{
  ...
  id v7 = a4;
  v21.receiver = self;
  v21.super_class = (Class)HMDLocationEvent;
  int v8 = [(HMDEvent *)&v21 initWithModel:v6 home:v7];
  if (v8)
  {
    ...
    id v20 = 0;
    uint64_t v12 = [v9 unarchivedObjectOfClass:v10 fromData:v11 error:&v20];
    id v13 = v20;
    region = v8->_region;
    ...
    if (!v8->_region)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v24 = 2112;
        id v25 = v13;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive region from object model's region: %@", buf, 0x16u);
      }
    }
  }
  return v8;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_12893 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_12893, &__block_literal_global_12894);
  }
  v2 = (void *)logCategory__hmf_once_v2_12895;
  return v2;
}

uint64_t __31__HMDLocationEvent_logCategory__block_invoke()
{
  logCategory__hmf_once_v2_12895 = HMFCreateOSLogHandle();
