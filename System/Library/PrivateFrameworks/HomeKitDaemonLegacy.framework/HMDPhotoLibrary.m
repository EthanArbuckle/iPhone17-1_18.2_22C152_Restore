...
void __41__HMDPhotoLibrary_photoLibraryDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v25 = 138543362;
    v26 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Photo Library did change", (uint8_t *)&v25, 0xCu);
  }
  id v6 = [*(id *)(a1 + 40) changedLocalIdentifiersForEntityClass:objc_opt_class()];
  uint64_t v7 = *MEMORY[0x1E4F39728];
  id v8 = [v6 objectForKeyedSubscript:*MEMORY[0x1E4F39728]];
  if (v8)
  {
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v29 = 2112;
    v30 = v13;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEBUG, "%{public}@anyPersonWasAdded: %@, changeDetails: %@", (uint8_t *)&v25, 0x20u);
  }
  if (v13) {
    int v19 = 1;
  }
  ...
  if (v19 == 1)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      int v25 = 138543362;
      v26 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Found changes for photo library persons", (uint8_t *)&v25, 0xCu);
    }
...
- (PHPhotoLibrary)photoLibrary
{
  ...
  if (!photoLibrary)
  {
    v5 = [MEMORY[0x1E4F39228] sharedPhotoLibrary];
...
- (id)faceCropFromFaceCropData:(id)a3
{
  return (id)[MEMORY[0x1E4F697E8] faceCropFromPhotosFaceCropImageData:a3];
}
...
- (unint64_t)numberOfFaceCropsForPersonWithUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      v9 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"isInVIPModel == YES"];
      [v8 setPredicate:v9];

      int v10 = [MEMORY[0x1E4F39050] fetchFacesForPerson:v7 options:v8];
      v11 = [v10 objects];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v4;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Did not find person with UUID: %@, returning 0", (uint8_t *)&v22, 0x16u);
      }
      unint64_t v12 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v22 = 138543362;
      v23 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@suggestedPersonsFetchResult is nil, returning 0", (uint8_t *)&v22, 0xCu);
    }
    unint64_t v12 = 0;
  }
...
- (id)fetchFaceCropDataByUUIDForPersonUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      int v22 = v9;
      int v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v22 count:1];
      [v8 setSortDescriptors:v10];

      v11 = [MEMORY[0x1E4F39060] fetchTransientTrainingFaceCropsForPerson:v7 options:v8];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        id v26 = v4;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Did not find person with UUID: %@, returning empty dictionary", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v24 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@suggestedPersonsFetchResult is nil, returning nil", buf, 0xCu);
    }
    unint64_t v12 = 0;
  }
...
- (NSSet)persons
{
  ...
  if (v4)
  {
    ...
    v9 = objc_msgSend(v8, "na_map:", &__block_literal_global_35165);
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@suggestedPersonsFetchResult is nil, returning nil", (uint8_t *)&v15, 0xCu);
    }
    v9 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_35176 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_35176, &__block_literal_global_252);
  }
  v2 = (void *)logCategory__hmf_once_v9_35177;
  return v2;
}
...
uint64_t __30__HMDPhotoLibrary_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v9_35177;
  logCategory__hmf_once_v9_35177 = v0;
