...
- (void)start
{
  ...
  if (!v4)
  {
    ...
    v7 = [v11 workQueue];
    id v8 = [(HMDAccessoryRetrievalCompletionTuple *)self timer];
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      uint64_t v12 = [(HMDAccessoryRetrievalCompletionTuple *)v9 accessory];
      ...
      __int16 v28 = 2112;
      v29 = v20;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory retrieval timed out for accessory %@/%@", (uint8_t *)&v24, 0x20u);
    }
    v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:100];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      int v24 = 138543362;
      v25 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Accessory retrieval lost reference to home", (uint8_t *)&v24, 0xCu);
    }
  }
}
