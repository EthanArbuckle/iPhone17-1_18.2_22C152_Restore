...
LABEL_10:
  ...
  if (v16)
  {
    v32[0] = *MEMORY[0x1E4F2CA78];
    v30 = [v12 contextSPIUniqueIdentifier];
    v29 = [v30 UUIDString];
    v33[0] = v29;
    v32[1] = *MEMORY[0x1E4F2CA98];
    ...
    v22 = v21 = v15;
    v33[3] = v22;
    v28 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v33 forKeys:v32 count:4];
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v45 = 2112;
      v46 = v8;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Accessory reference was nil on camera: %@", buf, 0x16u);
    }
    goto LABEL_13;
  }
  if (a3 > 3 || (HMDLocalizedStringForKey(off_1E6A18C70[a3]), (uint64_t v10 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    id v13 = (void *)MEMORY[0x1D9452090]();
    id v14 = a1;
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v45 = 2048;
      v46 = (__CFString *)a3;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unknown accessMode %lu, not posting notification", buf, 0x16u);
    }
LABEL_13:
    v20 = 0;
    goto LABEL_14;
...
LABEL_24:
  ...
  if (!v27)
  {
    objc_super v30 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v49 = 2112;
      v50 = v28;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
