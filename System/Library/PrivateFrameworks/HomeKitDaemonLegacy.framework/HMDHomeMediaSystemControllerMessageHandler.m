...
- (void)_legacyHandleUpdateMediaSystem:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 uuidForKey:*MEMORY[0x1E4F2ED80]];
    v7 = [v4 stringForKey:*MEMORY[0x1E4F2ED58]];
    v8 = [v4 stringForKey:*MEMORY[0x1E4F2ED28]];
    v37 = [v4 arrayForKey:*MEMORY[0x1E4F2ED50]];
    if (v6)
    {
      ...
      if (v11)
      {
        ...
        id v40 = 0;
        id v41 = 0;
        char v12 = [MEMORY[0x1E4F2E928] decodeComponentData:v37 leftComponentUUID:&v43 leftAccessoryUUID:&v42 rightComponentUUID:&v41 rightAccessoryUUID:&v40];
        id v13 = v43;
        id v14 = v42;
        id v15 = v41;
        id v16 = v40;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v46 = 2112;
            v47 = v37;
            _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not decode components %@", buf, 0x16u);
          }
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        v47 = v7;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Name already exists %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        v47 = 0;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Message is missing mediaSystemUUID %@", buf, 0x16u);
      }
      v10 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
    }
...
void __77__HMDHomeMediaSystemControllerMessageHandler__legacyHandleUpdateMediaSystem___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (v5)
    {
      uint64_t v9 = *MEMORY[0x1E4F2ED30];
      v10[0] = v5;
    ...
    {
      v8 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
...
- (void)locallyUpdateMediaSystemUsingRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v63 = 2112;
    v64 = v11;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Locally update media system using request message: %@(%@) payload: %@", buf, 0x2Au);
  }
  id v12 = objc_alloc(MEMORY[0x1E4F2E928]);
  ...
  if (v14 && v15)
  {
    ...
    if (v19)
    {
      ...
      if (!v20)
      {
        ...
        {
          v32 = [MEMORY[0x1E4F2E930] roomNameSentinel];
          [v21 setName:v32];
        }
        ...
        v55[1] = v42;
        v51 = [MEMORY[0x1E4F1C978] arrayWithObjects:v55 count:2];

        id v43 = [MEMORY[0x1E4F7A0D8] chainFutures:v51];
        v44 = [v14 leftAccessoryUUID];
        v54[0] = v44;
        v45 = [v14 rightAccessoryUUID];
        v54[1] = v45;
        __int16 v46 = [MEMORY[0x1E4F1C978] arrayWithObjects:v54 count:2];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v59 = 2112;
        v60 = v18;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to update media system due to missing media system group: %@", buf, 0x16u);
      }
...
LABEL_18:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v61 = 2112;
    v62 = v16;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to update media system due to missing dependencies payload: %@ aggregator: %@", buf, 0x20u);
  }
  v18 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
...
- (void)routeUpdateMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Routing update media system message: %@(%@)", (uint8_t *)&v15, 0x20u);
  }
    ...
    || ([(id)isFeatureHomeTheaterQFAEnabledForTests BOOLValue] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      id v16 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Home theater QFA is not enabled using legacy flows", (uint8_t *)&v15, 0xCu);
    }
...
{
  id v8 = a3;
  id v4 = [v8 uuidForKey:*MEMORY[0x1E4F2ED80]];
  id v5 = [v8 stringForKey:*MEMORY[0x1E4F2ED28]];
...
- (void)locallyRemoveMediaSystemUsingRemoveRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v42 = 2112;
    id v43 = v11;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Locallying remove media system using request message: %@(%@) payload: %@", (uint8_t *)&v36, 0x2Au);
  }
  id v12 = [v4 messagePayload];
  id v13 = objc_msgSend(v12, "hmf_UUIDForKey:", *MEMORY[0x1E4F2ED80]);
  ...
  if (v13)
  {
    ...
    if (v14)
    {
      ...
      __int16 v17 = [v16 mediaSystemData];
      v18 = v17;
      if (v17)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v38 = 2112;
          id v39 = v16;
          _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Failed to remove media system due to missing media system group: %@", (uint8_t *)&v36, 0x16u);
        }
        __int16 v19 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:2];
        [v4 respondWithError:v19];
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        int v36 = 138543362;
        v37 = v31;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove media system due to no aggregator", (uint8_t *)&v36, 0xCu);
      }
      id v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v42 = 2112;
      id v43 = v27;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove media system due to invalid payload in request message: %@(%@) payload: %@", (uint8_t *)&v36, 0x2Au);
    }
    int v15 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:8];
...
- (void)routeRemoveMediaSystem:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      int v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Home theater QFA is not enabled using legacy flows", (uint8_t *)&v9, 0xCu);
    }
...
- (void)_legacyHandleAddMediaSystemWithPreProcessedMessage:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 uuidForKey:*MEMORY[0x1E4F2ED80]];
  id v6 = [v4 stringForKey:*MEMORY[0x1E4F2ED58]];
  v7 = [v4 arrayForKey:*MEMORY[0x1E4F2ED50]];
  uint64_t v8 = [v4 stringForKey:*MEMORY[0x1E4F2ED28]];
  int v9 = (void *)v8;
  if (v5) {
    BOOL v10 = v8 == 0;
  }
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v48 = 2112;
      v49 = v9;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Message is missing required information uuid: %@, builderID: %@", buf, 0x20u);
    }
    id v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
    goto LABEL_19;
  }
  int v15 = [(HMDHomeMediaSystemControllerMessageHandler *)self home];
  ...
  if (!v17)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Name already exists %@", buf, 0x16u);
    }
LABEL_19:
    [v4 respondWithError:v16];
    goto LABEL_24;
  ...
  id v41 = 0;
  int v36 = v7;
  char v18 = [MEMORY[0x1E4F2E928] decodeComponentData:v7 leftComponentUUID:&v43 leftAccessoryUUID:&v42 rightComponentUUID:&v41 rightAccessoryUUID:&v40];
  id v37 = v43;
  id v19 = v42;
  id v20 = v41;
  id v21 = v40;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      v47 = v36;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not decode components %@", buf, 0x16u);
    }
...
- (void)_legacyHandleAddMediaSystem:(id)a3
{
  uint64_t v4 = [(HMDHomeMediaSystemControllerMessageHandler *)self preProcessMediaSystemMessage:a3];
  uint64_t v5 = v4;
  if (v4)
  {
    uint64_t v6 = v4;
    uint64_t v4 = [(HMDHomeMediaSystemControllerMessageHandler *)self _legacyHandleAddMediaSystemWithPreProcessedMessage:v4];
    uint64_t v5 = v6;
  }
...
- (id)homeUUID
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      int v15 = v3;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to get home uuid from home: %@", (uint8_t *)&v12, 0x16u);
    }
  }
...
- (id)mediaGroupsAggregator
{
  uint64_t v16 = *MEMORY[0x1E4F143B8];
  id v3 = [(HMDHomeMediaSystemControllerMessageHandler *)self home];
  uint64_t v4 = [v3 mediaGroupsAggregator];
  uint64_t v5 = v4;
  if (v4)
  {
    id v6 = v4;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      int v15 = v3;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media groups aggregator from home: %@", (uint8_t *)&v12, 0x16u);
    }
  }
...
- (id)messageRouter
{
  uint64_t v16 = *MEMORY[0x1E4F143B8];
  id v3 = [(HMDHomeMediaSystemControllerMessageHandler *)self home];
  uint64_t v4 = [v3 primaryResidentMessageRouter];
  uint64_t v5 = v4;
  if (v4)
  {
    id v6 = v4;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      int v15 = v3;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get primary message router in home: %@", (uint8_t *)&v12, 0x16u);
    }
  }
...
- (void)queueOnboardingForUnconfiguredParticipantWithAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Queueing onboarding participant accessory uuid: %@ associated group identifier: %@", (uint8_t *)&v18, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v7;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to queue participant accessory uuid: %@ associated group identifier: %@ due to no onboarding manager", (uint8_t *)&v18, 0x20u);
    }
  }
}
...
- (id)updateParticipantWithDestinationManager:(id)a3 associatedGroupIdentifier:(id)a4
{
  id v6 = (objc_class *)MEMORY[0x1E4F7A0D8];
  id v7 = a4;
  id v8 = a3;
...
void __112__HMDHomeMediaSystemControllerMessageHandler_updateParticipantWithDestinationManager_associatedGroupIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Request to update audio groups completed with error: %@", (uint8_t *)&v8, 0x16u);
    }
...
- (id)updateParticipantWithAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  else
  {
    ...
    __int16 v10 = [MEMORY[0x1E4F7A0D8] futureWithNoResult];
  }
...
- (void)updateParticipantWithDestinationIdentifier:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v8;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to update participant with destination identifier: %@ due to no destination manager found in home: %@", (uint8_t *)&v15, 0x20u);
    }
  }
}
...
- (id)mediaSystemNameFromRoomWithAccessoryUUIDs:(id)a3
{
  ...
  id v13 = objc_msgSend(MEMORY[0x1E4F2E930], "defaultGroupName", (void)v16);
LABEL_13:
...
- (id)stagingMediaSystemDataFromData:(id)a3 accessoryUUIDs:(id)a4
{
  ...
  uint64_t v8 = [v7 name];
  uint64_t v9 = [MEMORY[0x1E4F2E930] roomNameSentinel];
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Update media system participants completed with error: %@", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Update media system participants completed", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v22;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create update media system response due to no home", buf, 0xCu);
      }
      id v23 = *(void **)(a1 + 40);
      __int16 v14 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
- (id)validateConfiguredName:(id)a3
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v30 = 138543362;
      v31 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get name to validate", (uint8_t *)&v30, 0xCu);
    }
  ...
  if (![v4 length] || (unint64_t v6 = objc_msgSend(v5, "length"), v6 > HMMaxLengthForNaming()))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v32 = 2112;
      id v33 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get valid name due length of name: %@", (uint8_t *)&v30, 0x16u);
    }
    id v11 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v12 = 3;
LABEL_10:
  ...
  if (v19)
  {
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v34 = 2112;
        id v35 = v17;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to get valid name: %@ error: %@", (uint8_t *)&v30, 0x20u);
      }
      id v25 = v17;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      int v30 = 138543362;
      v31 = v29;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to get home during name validation", (uint8_t *)&v30, 0xCu);
    }
    id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
  }
  ...
  if (!v8 || !v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v41 = 2112;
      id v42 = v5;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Preferred associated group will be derived without influence from missing left destination: %@ right destination: %@ in home: %@", buf, 0x2Au);
  ...
  if (v9 && v13 && ([v9 isEqual:v13] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v39 = 2112;
      id v40 = v12;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Not setting a preferred group identifier due to miss matching groups on left destination: %@ right destination: %@", buf, 0x20u);
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v37 = 2112;
        id v38 = v19;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting preferred associated group identifier: %@", buf, 0x16u);
...
- (void)locallyAddMediaSystemUsingRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v62 = 2112;
    __int16 v63 = v11;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Locally add media system using request message: %@(%@) payload: %@", buf, 0x2Au);
  }
  id v12 = objc_alloc(MEMORY[0x1E4F2E928]);
  id v13 = [v4 messagePayload];
  ...
  if (!v14 || !v15 || !v16)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v62 = 2112;
      __int16 v63 = v15;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to add media system due to missing dependencies payload: %@ aggregator: %@ homeUUID: %@", buf, 0x2Au);
    }
    uint64_t v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
    goto LABEL_12;
  }
...
LABEL_12:
  ...
  {
    id v21 = [MEMORY[0x1E4F2E930] roomNameSentinel];
  }
  v52 = v21;
  ...
  id v29 = objc_alloc(MEMORY[0x1E4F2E930]);
  int v30 = [v14 uuid];
  ...
  v55[1] = v35;
  uint64_t v36 = [MEMORY[0x1E4F1C978] arrayWithObjects:v55 count:2];
  id v17 = v51;
  ...
  v54[1] = v40;
  v49 = [MEMORY[0x1E4F1C978] arrayWithObjects:v54 count:2];

  __int16 v41 = [MEMORY[0x1E4F7A0D8] chainFutures:v49];
  id v42 = [v14 leftAccessoryUUID];
  v53[0] = v42;
  uint64_t v43 = [v14 rightAccessoryUUID];
  v53[1] = v43;
  uint64_t v44 = [MEMORY[0x1E4F1C978] arrayWithObjects:v53 count:2];
  v45 = [(HMDHomeMediaSystemControllerMessageHandler *)v6 updateMediaSystemCompletionBlockWithMessage:v4 data:v50 accessoryUUIDs:v44];
...
- (void)_logRemoveMediaSystemMetricsUsingMessage:(id)a3
{
  ...
  if (v5 && v6)
  {
    id v8 = [v6 objectForKeyedSubscript:*MEMORY[0x1E4F2ED80]];
    objc_opt_class();
    ...
    if (v11)
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v11;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Received %@ message for media system UUID: %@", (uint8_t *)&v24, 0x20u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v4;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Message %@ payload does not contain valid media system UUID", (uint8_t *)&v24, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v28 = 2112;
      id v29 = v7;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@home: %@ or payload: %@ is nil", (uint8_t *)&v24, 0x20u);
    }
  }
}
...
- (void)_logAddMediaSystemMetricsUsingMessage:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [(HMDHomeMediaSystemControllerMessageHandler *)self home];
  id v6 = objc_alloc(MEMORY[0x1E4F2E928]);
  ...
  if (v5 && v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      id v31 = v8;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Received %@ message for media system builder payload %@", buf, 0x20u);
    }
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v16;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Found associated setup session identifier %@ during media system grouping", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      id v31 = v8;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home: %@ or media system builder payload: %@ is nil", buf, 0x20u);
    }
  }
}
...
- (void)routeAddMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Routing add media system message: %@(%@)", (uint8_t *)&v15, 0x20u);
  }
  if (isFeatureHomeTheaterQFAEnabledForTests
    && ([(id)isFeatureHomeTheaterQFAEnabledForTests BOOLValue] & 1) != 0)
  {
...
LABEL_6:
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&location[4] = v21;
      __int16 v27 = 2112;
      __int16 v28 = v7;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Resident device does not support media system: %@", location, 0x16u);
    }
    uint64_t v17 = 92;
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&location[4] = v16;
      __int16 v27 = 2112;
      __int16 v28 = v7;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Resident device isn't available or reachable: %@", location, 0x16u);
    }
    uint64_t v17 = 91;
  }

  uint64_t v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:v17];
  [v4 respondWithError:v18];
...
void __75__HMDHomeMediaSystemControllerMessageHandler_preProcessMediaSystemMessage___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (WeakRetained && !v5 && [a1[5] isSharedAdmin])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Relaying the message %@", (uint8_t *)&v17, 0x16u);
    }
  ...
  if (v15)
  {
    uint64_t v16 = [a1[4] responseHandler];
...
- (void)_registerForMessages
{
  ...
  [v8 registerForMessage:*MEMORY[0x1E4F2EC60] receiver:self policies:v7 selector:sel_routeAddMediaSystem_];
  [v8 registerForMessage:*MEMORY[0x1E4F2ED98] receiver:self policies:v7 selector:sel_routeRemoveMediaSystem_];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t47 != -1) {
    dispatch_once(&logCategory__hmf_once_t47, &__block_literal_global_38225);
  }
  v2 = (void *)logCategory__hmf_once_v48;
  return v2;
}
...
uint64_t __57__HMDHomeMediaSystemControllerMessageHandler_logCategory__block_invoke()
{
  ...
  logCategory__hmf_once___int16 v48 = v0;
