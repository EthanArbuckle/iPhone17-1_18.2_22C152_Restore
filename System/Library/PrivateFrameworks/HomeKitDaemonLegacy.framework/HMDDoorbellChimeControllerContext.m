...
- (NSUUID)currentAccessoryUUID
{
  ...
  v3 = [v2 home];
  v4 = [v3 accessories];
  v5 = objc_msgSend(v4, "na_firstObjectPassingTest:", &__block_literal_global_146_96723);
  v6 = [v5 uuid];
...
- (id)fetchDoorbellDelay
{
  return (id)[MEMORY[0x1E4F7A0D8] futureWithResult:&unk_1F2DC82F0];
}
...
LABEL_7:
  ...
  if (v10)
  {
    ...
    uint64_t v20 = *MEMORY[0x1E4F2DE20];
    v14 = [MEMORY[0x1E4F1CAD0] setWithObject:*MEMORY[0x1E4F2CF08]];
    v21[0] = v14;
