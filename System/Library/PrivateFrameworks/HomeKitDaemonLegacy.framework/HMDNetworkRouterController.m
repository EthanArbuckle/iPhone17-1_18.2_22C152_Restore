  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Handling connected accessory failed. No hapAccessory found.", buf, 0xCu);
    }
  }
}
...
void __65__HMDNetworkRouterController__handleNetworkAccessViolationUpdate__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      uint64_t v46 = a1;
      id v44 = v6;
      uint64_t v9 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v5, "count"));
      long long v53 = 0u;
      long long v54 = 0u;
      long long v55 = 0u;
      long long v56 = 0u;
              ...
              else
              {
                ...
                if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v61 = 2112;
                  v62 = v25;
                  _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@No network access violation info for accessory %@ with client identifier %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v6;
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch access violations: %@", buf, 0x16u);
    }
  }
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v34 = 2112;
        id v35 = v12;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Characteristic not found for operation %@", buf, 0x16u);
      }
      v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v38 = 2112;
      id v39 = v12;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize TLV: %@ with error: %@ for operation %@", buf, 0x2Au);
    }
    v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
void __103__HMDNetworkRouterController__writeTLVWithValueInResponse_characteristicType_operationName_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v11;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@%@ with write value %@ failed with error %@", (uint8_t *)&v23, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v22;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Invalid response from %@ with write value %@", (uint8_t *)&v23, 0x20u);
    }
    uint64_t v12 = *(void *)(a1 + 56);
    uint64_t v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
  }
...
- (void)_writeValueIfDifferent:(id)a3 characteristicType:(id)a4 operationName:(id)a5 completion:(id)a6
{
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v35 = 2112;
        id v36 = v10;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Omitting %@ write with value %@, cached value matches", buf, 0x20u);
      }
      v13[2](v13, 0);
    }
    else
  ...
  else
  {
    ...
    uint64_t v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
void __97__HMDNetworkRouterController__writeValueIfDifferent_characteristicType_operationName_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v11;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@%@ with write value %@ failed with error %@", (uint8_t *)&v21, 0x2Au);
    }
    uint64_t v12 = *(void *)(a1 + 56);
    uint64_t v13 = [v3 error];
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      uint64_t v26 = v20;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid response from %@ with write value %@", (uint8_t *)&v21, 0x20u);
    }
    uint64_t v12 = *(void *)(a1 + 56);
    uint64_t v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
  }
...
- (void)_writeClientConfigurationControlRequest:(id)a3 operationName:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    id v27 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Writing client configuration request %@ for %@", buf, 0x20u);
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v51 = 2112;
      id v52 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@%@ operation failed with error %@", buf, 0x20u);
    }
    (*(void (**)(void))(*(void *)(a1 + 56) + 16))();
  }
  else
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v53 = 2112;
        long long v54 = v13;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse response to %@ request: %@ with error: %@", buf, 0x2Au);
      }
      (*(void (**)(void))(*(void *)(a1 + 56) + 16))();
    }
    else
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v42 = v27;
          long long v54 = v27;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@%@ operation status %@%@", buf, 0x2Au);
          if (v45) {
        }
          }
        ...
        {
          uint64_t v40 = [MEMORY[0x1E4F28C58] hmErrorWithCode:qword_1D54D4070[v38 - 1]];
        }
        if (v39 && !v40)
        {
          uint64_t v40 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v51 = 2112;
          id v52 = v33;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Invalid response from %@ with write value %@", buf, 0x20u);
        }
        uint64_t v34 = *(void *)(a1 + 56);
        __int16 v35 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
...
- (void)resetAccessViolationForClientIdentifier:(id)a3 completion:(id)a4
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v7];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v28 = 2112;
        id v29 = v8;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse response to %@ request %@: %@", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      id v25 = v5;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch access violation list TLV: %@", buf, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
  }
}
...
- (void)removeClientConfigurationWithClientIdentifier:(id)a3 completion:(id)a4
{
  ...
  uint64_t v9 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v7];
...
void __64__HMDNetworkRouterController_addClientConfiguration_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    uint64_t v9 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        int v18 = 138543362;
        id v19 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Router returned multiple client status results but only one was expected", (uint8_t *)&v18, 0xCu);
      }
...
- (void)getClientStatusWithIdentifiers:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Writing client status request %@ for %@", buf, 0x20u);
  }
...
{
  if (a3) {
    uint64_t v4 = &unk_1F2DC8BC0;
  }
  else {
    uint64_t v4 = &unk_1F2DC8BD8;
  }
...
- (NSString)wiFiSSID
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@SSID unavailable", (uint8_t *)&v11, 0xCu);
    }
    id v5 = 0;
  }
...
- (void)configure
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v13 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Not configuring network router controller as accessory is nil", buf, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_127824 != -1) {
    dispatch_once(&logCategory__hmf_once_t28_127824, &__block_literal_global_127825);
  }
  id v2 = (void *)logCategory__hmf_once_v29_127826;
  return v2;
}
...
uint64_t __41__HMDNetworkRouterController_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v29_127826;
  logCategory__hmf_once_v29_127826 = v0;
