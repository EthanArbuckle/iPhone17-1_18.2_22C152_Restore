...
- (id)initWithAsset:()Asset
{
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v77 = 2112;
          id v78 = v14;
          _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Unarchiving the non-streamable asset: %@", buf, 0x16u);
        }
        v15 = [v4 fileManager];
        v16 = [v4 bundleURL];
        v17 = [v4 bundleURL];
        ...
        if ((v18 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v79 = 2112;
            id v80 = v19;
            _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive contents of asset: %@ with error: %@", buf, 0x20u);
          }
      ...
      v31 = [v4 bundleURL];
      id v72 = v19;
      v32 = [v30 contentsOfDirectoryAtURL:v31 includingPropertiesForKeys:MEMORY[0x1E4F1CBF0] options:4 error:&v72];
      id v33 = v72;
      ...
      if (![v32 count])
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v77 = 2112;
          id v78 = v33;
          _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_ERROR, "%{public}@No release notes found. Error: %@", buf, 0x16u);
        }
        id v29 = 0;
        goto LABEL_46;
      }
      v34 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"self.lastPathComponent MATCHES %@", @"(^[a-z]{2}(-|_)[A-Za-z0-9]+).txt"];
      ...
      if (![v35 count])
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v76 = v48;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@No valid release notes found.", buf, 0xCu);
        }
        id v29 = 0;
        goto LABEL_45;
      }
      ...
      v40 = [MEMORY[0x1E4F1CA20] currentLocale];
      ...
      v63 = (void *)v39;
      if (v42
        || (objc_msgSend(v35, "na_firstObjectPassingTest:", &__block_literal_global_119405),
            (v42 = objc_claimAutoreleasedReturnValue()) != 0))
      {
        v49 = [v4 testDocumentData];

        id v50 = objc_alloc(MEMORY[0x1E4F2EA18]);
        if (v49)
        {
...
LABEL_46:
      ...
      if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v79 = 2112;
        id v80 = v33;
        _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_ERROR, "%{public}@Unable to load release note document, %@, with error: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v77 = 2112;
      id v78 = v28;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@No asset in path: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v76 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@The asset url is required", buf, 0xCu);
LABEL_15:
    }
  }
