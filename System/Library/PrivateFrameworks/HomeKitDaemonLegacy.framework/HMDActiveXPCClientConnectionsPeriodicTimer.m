...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of timer firing", (uint8_t *)&v12, 0xCu);
    }
...
- (void)_updateTimer
{
  ...
  int v5 = objc_msgSend(v4, "na_any:", &__block_literal_global_85634);
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      int v14 = 138543362;
      v15 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Starting timer", (uint8_t *)&v14, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      int v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Suspending timer", (uint8_t *)&v14, 0xCu);
    }
...
- (HMDActiveXPCClientConnectionsPeriodicTimer)initWithTimeInterval:(double)a3 logIdentifier:(id)a4 workQueue:(id)a5
{
  v8 = (objc_class *)MEMORY[0x1E4F65580];
  id v9 = a5;
  id v10 = a4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_85659 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_85659, &__block_literal_global_14_85660);
  }
  v2 = (void *)logCategory__hmf_once_v3_85661;
  return v2;
}
...
uint64_t __57__HMDActiveXPCClientConnectionsPeriodicTimer_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_85661;
  logCategory__hmf_once_v3_85661 = v0;
