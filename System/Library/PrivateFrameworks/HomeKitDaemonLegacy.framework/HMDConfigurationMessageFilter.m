...
+ (int64_t)filterMessage:(id)a3 withPolicies:(id)a4 error:(id *)a5
{
  ...
  v11 = [MEMORY[0x1E4F65548] productInfo];
...
LABEL_13:
  ...
  {
LABEL_7:
    v11 = objc_msgSend(v8, "hmf_objectPassingTest:", &__block_literal_global_71289);
    if ([v11 operationTypes])
    {
      if (a5)
      {
        *a5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48 description:@"Operation not supported" reason:@"Configuration changes not supported" suggestion:0];
      }
      int64_t v15 = -1;
    }
    else
