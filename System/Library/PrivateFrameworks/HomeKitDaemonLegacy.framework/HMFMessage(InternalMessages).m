...
+ (id)internalMessageWithName:()InternalMessages destination:messagePayload:
{
  v0 = objc_msgSend(MEMORY[0x1E4F654B0], "internalMessageWithName:destination:messagePayload:");
  v1 = (void *)[v0 copy];
...
+ (id)internalMessageWithName:()InternalMessages messagePayload:responseHandler:
{
  v0 = objc_msgSend(MEMORY[0x1E4F654B0], "internalMessageWithName:messagePayload:responseHandler:");
  v1 = (void *)[v0 copy];
...
+ (id)internalMessageWithName:()InternalMessages messagePayload:
{
  v0 = objc_msgSend(MEMORY[0x1E4F654B0], "internalMessageWithName:messagePayload:");
  v1 = (void *)[v0 copy];
