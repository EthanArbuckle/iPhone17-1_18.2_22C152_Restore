...
- (HMDCameraSnapshotSessionID)initWithAccessory:(id)a3 message:(id)a4
{
  ...
  if (v8)
  {
    ...
    unsigned int v14 = [v7 BOOLForKey:*MEMORY[0x1E4F2CD10]];
    char v15 = v14;
    if (v9) {
      uint64_t v16 = 1;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v7;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Snapshot session ID is not present in message: %@", buf, 0x16u);
    }
    v24 = 0;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  BOOL v13 = [(HMDCameraSnapshotSessionID *)self streamingTier];
  LOBYTE(v16) = v11;
  unsigned int v14 = [(HMDCameraSnapshotSessionID *)v4 initWithSessionID:v5 hostProcessBundleIdentifier:v6 isSPIClient:v7 deviceSectionName:v8 description:v9 snapshotReason:v10 snapshotRequestForBulletin:v16 snapshotCharacteristicEventUUID:v12 streamingTier:v13];
