...
- (HMDBackingStoreCacheFetchModelObjectResult)initWithRecord:(id)a3 data:(id)a4 encoding:(unint64_t)a5 error:(id *)a6
{
  ...
  if (v10 && v11)
  {
    ...
    uint64_t v14 = [objc_alloc(MEMORY[0x1E4F1A2D8]) initWithCoder:v13];
    record = v12->_record;
    ...
    if (*a6)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v28 = 2112;
        id v29 = v22;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@unable to decode cached object %@", buf, 0x16u);
      }
    }
    else if (v12->_object)
    {
