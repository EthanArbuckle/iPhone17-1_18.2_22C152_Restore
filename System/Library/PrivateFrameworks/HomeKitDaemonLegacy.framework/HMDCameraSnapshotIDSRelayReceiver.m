...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2114;
    id v22 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Session %{public}@ has ended with reason: %{public}u and error: %{public}@", (uint8_t *)&v15, 0x26u);
  }
...
LABEL_21:
      _os_log_impl(&dword_1D49D5000, v54, v55, v53, buf, 0x16u);
    }
LABEL_22:
  ...
  unsigned int v20 = (void *)MEMORY[0x1E4F28DC0];
        ...
        if (v30)
        {
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v85 = 2112;
            id v86 = v14;
            _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@ from %@", buf, 0x20u);
          }
          ...
          if (v38)
          {
            ...
            uint64_t v79 = *MEMORY[0x1E4F6AA88];
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v82 = v47;
            _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Accepted invitation", buf, 0xCu);
          }
        ...
        else
        {
          if (os_log_type_enabled(v33, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v83 = 2112;
            id v84 = v71;
            _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring invitation for camera session ID: %@", buf, 0x16u);
          }
        }
        id v26 = v72;
      }
      else
      {
        ...
        if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v83 = 2112;
          id v84 = v23;
          _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_ERROR, "%{public}@Could not find camera session ID in payload: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        id v86 = v64;
        id v65 = v64;
        _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unarchived payload was not an NSDictionary: %@ (%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v83 = 2112;
      id v84 = v76;
      _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive payload from context data: %@", buf, 0x16u);
    }
  }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v12 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSRelayReceiver", buf, 0xCu);
  }
...
- (void)_handleDataFromSocket:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      int v40 = 138543362;
      v41 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Socket source is already nil, rejecting the data from socket", (uint8_t *)&v40, 0xCu);
LABEL_20:
    }
LABEL_21:
  ...
  if (![(HMDCameraSnapshotIDSRelayReceiver *)self expectedByteCount])
  {
    ...
    if (v18 > 7)
    {
      ...
      unsigned int v20 = (void *)MEMORY[0x1D9452090]();
      __int16 v21 = self;
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting expected byte count to %llu", (uint8_t *)&v40, 0x16u);
      }
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Only received %lu bytes that represent the expected byte count so far; will wait for more",
        (uint8_t *)&v40,
        0x16u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v44 = 2112;
    v45 = v31;
    _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Updating received byte count from %@ to %@", (uint8_t *)&v40, 0x20u);
  }
  ...
  if (v32 == [(HMDCameraSnapshotIDSRelayReceiver *)v27 expectedByteCount])
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      int v40 = 138543362;
      v41 = v36;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@All the bytes have been received, file transfer is complete", (uint8_t *)&v40, 0xCu);
    }
...
- (void)_startDataReceive
{
  ...
  dispatch_source_t v7 = dispatch_source_create(MEMORY[0x1E4F14478], v5, 0, v6);
...
void __54__HMDCameraSnapshotIDSRelayReceiver__startDataReceive__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2048;
    ssize_t v17 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Received data of length %ld", buf, 0x16u);
  }
  if (v3)
  {
    if (v3 < 1)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v15 = v12;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Recv from socket returned error, aborting the file receive", buf, 0xCu);
      }
      unint64_t v8 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1032];
      [v10 _didReceiveData:0 error:v8];
    }
    else
    {
      unint64_t v8 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v13 length:v3];
...
- (HMDCameraSnapshotIDSRelayReceiver)initWithSessionID:(id)a3 logIdentifier:(id)a4 machOUUID:(id)a5 workQueue:(id)a6 sessionInviterDeviceVerifier:(id)a7 delegate:(id)a8
{
  ...
  if (v18)
  {
    ...
    uint64_t v28 = [MEMORY[0x1E4F1CA58] data];
    relayData = v18->_relayData;
    v18->_relayData = (NSMutableData *)v28;

    id v15 = v23;
    id v16 = v33;
    uint64_t v30 = [MEMORY[0x1E4F1CA58] data];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_172527 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_172527, &__block_literal_global_172528);
  }
  v2 = (void *)logCategory__hmf_once_v1_172529;
  return v2;
}
...
uint64_t __48__HMDCameraSnapshotIDSRelayReceiver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_172529;
  logCategory__hmf_once_v1_172529 = v0;
