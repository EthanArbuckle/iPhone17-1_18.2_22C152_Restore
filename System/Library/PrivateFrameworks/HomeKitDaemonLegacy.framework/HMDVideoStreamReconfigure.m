...
LABEL_4:
      if (downgradeDebouceTimer == v4)
      {
        ...
        if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
        {
          ...
          int v23 = 138543362;
          v24 = v9;
          _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Downgrade debouce timer has fired, calling network has deteriorated", (uint8_t *)&v23, 0xCu);
        }
        ...
        if (self)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            int v23 = 138543362;
            v24 = v13;
            _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamReconfigureDidNetworkDeteriorate", (uint8_t *)&v23, 0xCu);
          }
...
LABEL_20:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    int v23 = 138543362;
    v24 = v18;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Upgrade debouce timer has fired, calling network has improved", (uint8_t *)&v23, 0xCu);
  }
  ...
  if (self)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      int v23 = 138543362;
      v24 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamReconfigureDidNetworkImprove", (uint8_t *)&v23, 0xCu);
    }
  ...
  if (self)
  {
    ...
    if (self->_reconfigurationMode)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        int v10 = 138543362;
        v11 = v9;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Not processing the downlink quality change yet, since the stream is in reconfiguration mode", (uint8_t *)&v10, 0xCu);
      }
    }
    else
    {
...
- (void)_processDownlinkQuality
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Downlink quality changed with %@", buf, 0x16u);
  }
  v80 = objc_msgSend(v2, "hmf_numberForKey:", *MEMORY[0x1E4F479F8]);
  v7 = objc_msgSend(v2, "hmf_numberForKey:", *MEMORY[0x1E4F479F0]);
  int v8 = objc_msgSend(v2, "hmf_BOOLForKey:", *MEMORY[0x1E4F479E0]);
  int v9 = objc_msgSend(v2, "hmf_BOOLForKey:", *MEMORY[0x1E4F479E8]);
  if (*((void *)v4 + 4) && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v82 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Upgrade debounce timer is set, but not operating at maximum anymore, resetting the timer", buf, 0xCu);
    }
  ...
  if ((v14 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v82 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Downgrade debounce timer is set, but not operating at minimum anymore, resetting the timer", buf, 0xCu);
    }
    ...
    if (v19)
    {
      ...
      if (v20)
      {
        if (v24)
        {
          ...
          *(_DWORD *)buf = 138543362;
          v82 = v25;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Downgrade debounce timer is already scheduled", buf, 0xCu);
        }
        v26 = v21;
LABEL_28:
        goto LABEL_53;
      ...
      if (v24)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Starting downgrade debouce timer with interval %llu seconds", buf, 0x16u);
      }
      id v42 = objc_alloc(MEMORY[0x1E4F65580]);
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v82 = v36;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Downgrade debounce timer is set, but optimal and operating bitrates arent matching, resetting the timer", buf, 0xCu);
    }
    uint64_t v37 = 40;
    goto LABEL_37;
  }
    ...
    if (v27)
    {
      if (v28)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v82 = v32;
          _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Upgrade debounce timer is already scheduled", buf, 0xCu);
        }
        v26 = (void *)v29;
        goto LABEL_28;
      }
      ...
      if ((unint64_t)[*((id *)v4 + 3) count] >= 4)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v87 = 2112;
          v88 = v53;
          _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_INFO, "%{public}@reconfigure_1: %@, reconfigure_2: %@, reconfigure_3: %@", buf, 0x2Au);
              ...
              v62 < 120.0))
        {
          ...
          if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_1D49D5000, v72, OS_LOG_TYPE_INFO, "%{public}@Downgrade-Upgrade-Downgrade has happened within %lf seconds", buf, 0x16u);
          ...
          if (os_log_type_enabled(v76, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_1D49D5000, v76, OS_LOG_TYPE_INFO, "%{public}@A Flip flop has been detected, so upgrade is going to be backed off by %lf seconds", buf, 0x16u);
          }
          double v47 = 120.0;
        }
        else
      ...
      if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v64, OS_LOG_TYPE_INFO, "%{public}@Starting upgrade debouce timer with interval %lf seconds", buf, 0x16u);
      }
      v66 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:v47];
...
LABEL_52:
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v82 = v40;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Upgrade debounce timer is set, but optimal and operating bitrates arent matching, resetting the timer", buf, 0xCu);
    }
    uint64_t v37 = 32;
LABEL_37:
...
- (void)updateReconfigurationMode:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating reconfiguration mode from %@ to %@", (uint8_t *)&v15, 0x20u);
  }
  if (v4)
  {
    ...
    if (v6->_downlinkQualityInfo)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        int v15 = 138543362;
        v16 = v14;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Downlink quality info is present, processing it", (uint8_t *)&v15, 0xCu);
      }
...
- (HMDVideoStreamReconfigure)initWithSessionID:(id)a3 workQueue:(id)a4 delegate:(id)a5
{
  ...
  if (v12)
  {
    ...
    uint64_t v14 = [MEMORY[0x1E4F1CA48] arrayWithCapacity:10];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_11202 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_11202, &__block_literal_global_11203);
  }
  id v2 = (void *)logCategory__hmf_once_v1_11204;
  return v2;
}

uint64_t __40__HMDVideoStreamReconfigure_logCategory__block_invoke()
{
  logCategory__hmf_once_v1_11204 = HMFCreateOSLogHandle();
