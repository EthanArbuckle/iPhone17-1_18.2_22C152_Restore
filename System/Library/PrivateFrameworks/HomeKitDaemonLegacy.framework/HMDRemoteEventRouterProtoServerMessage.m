...
LABEL_23:
  ...
  if (multiHopFetchEventsResponse)
  {
    ...
    multiHopFetchEventsResponse = (HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)-[HMDRemoteEventRouterProtoMultiHopFetchEventsResponse mergeFrom:](multiHopFetchEventsResponse, "mergeFrom:");
  }
  else
  {
    if (!v13) {
    ...
    multiHopFetchEventsResponse = (HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)-[HMDRemoteEventRouterProtoServerMessage setMultiHopFetchEventsResponse:](self, "setMultiHopFetchEventsResponse:");
  }
  v5 = v14;
LABEL_29:
  MEMORY[0x1F41817F8](multiHopFetchEventsResponse, v5);
}
