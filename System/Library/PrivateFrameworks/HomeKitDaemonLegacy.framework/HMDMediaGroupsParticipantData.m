...
- (HMDMediaGroupsParticipantData)initWithProtoBufferData:(id)a3
{
  uint64_t v4 = (objc_class *)MEMORY[0x1E4F2E908];
  id v5 = a3;
  ...
  {
    id v11 = objc_alloc(MEMORY[0x1E4F2E8D8]);
  ...
  {
    v16 = [(HMDMediaGroupsParticipantData *)self initWithDestination:v10 destinationControllerData:v14 backedUpGroups:MEMORY[0x1E4F1CBF0]];
  }
...
- (id)encodeToProtoBufferData
{
  id v3 = objc_alloc_init(MEMORY[0x1E4F2E908]);
  uint64_t v4 = [(HMDMediaGroupsParticipantData *)self destination];

  if (v4)
  {
    id v5 = objc_alloc(MEMORY[0x1E4F2E8E8]);
  ...
  if (v9)
  {
    id v10 = objc_alloc(MEMORY[0x1E4F2E8F8]);
...
- (HMDMediaGroupsParticipantData)initWithDestination:(id)a3 destinationControllerData:(id)a4 backedUpGroups:(id)a5
{
  ...
  {
    v16 = (HMDNetworkRouterFirewallRuleAccessoryIdentifier *)_HMFPreconditionFailure();
