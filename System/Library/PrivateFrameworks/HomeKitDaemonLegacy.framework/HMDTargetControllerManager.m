...
- (void)_configureTargetAccessories:(id)a3 reason:(id)a4 targetAccessories:(id)a5 responseHandler:(id)a6
{
  ...
  v15 = [v14 findCharacteristicType:*MEMORY[0x1E4F2D000] forServiceType:*MEMORY[0x1E4F2DEE8]];
  if (v15)
  {
  ...
  {
    v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
...
- (void)_handleConfigureTargets:(id)a3 responseHandler:(id)a4
{
  ...
  v9 = [v8 home];
  id v10 = [v8 findCharacteristicType:*MEMORY[0x1E4F2D000] forServiceType:*MEMORY[0x1E4F2DEE8]];
  if (v10)
  {
    id v11 = (void *)*MEMORY[0x1E4F2C560];
    id v12 = [v6 objectForKey:*MEMORY[0x1E4F2C560]];
    ...
    v17 = (void *)*MEMORY[0x1E4F2C410];
    v18 = [v6 objectForKey:*MEMORY[0x1E4F2C410]];
...
LABEL_44:
    ...
    v22 = (void *)*MEMORY[0x1E4F2C0F8];
    v23 = [v6 objectForKey:*MEMORY[0x1E4F2C0F8]];
    ...
    if (v23)
    {
      ...
      if (v9)
      {
        ...
        v104[0] = v25;
        id v20 = [MEMORY[0x1E4F1C978] arrayWithObjects:v104 count:1];
        v103 = v73;
        v32 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v103 count:1];
        id v89 = 0;
...
LABEL_29:
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v99 = 2112;
        v100 = v70;
        _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@Attempting to configure targets for a controller %@/%@ that is not configured with a home", buf, 0x20u);
      ...
      if (v7)
      {
        v50 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
        v7[2](v7, v50, 0);
      }
      goto LABEL_54;
    }
    v34 = (void *)*MEMORY[0x1E4F2C530];
    v35 = [v6 objectForKey:*MEMORY[0x1E4F2C530]];
      ...
      if (!v9)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          v59 = (void *)v102;
          _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_ERROR, "%{public}@Attempting to remove target %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
        ...
        if (v7)
        {
          v60 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
          v7[2](v7, v60, 0);
        }
LABEL_54:
        id v20 = 0;
...
LABEL_21:
        ...
        v93 = v62;
        id v20 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v93 count:1];
        id v92 = v51;
        v52 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v92 count:1];
        id v84 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      id v19 = (void *)v33;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempting to lookup target %@/%@ for a controller %@/%@ that is not configured with a home", buf, 0x34u);
...
void __44__HMDTargetControllerManager_updateTargets___block_invoke(uint64_t a1)
{
  ...
  v63 = [*(id *)(a1 + 32) controller];
  v2 = [v63 home];
  uint64_t v3 = [*(id *)(v1 + 32) targetUUIDs];
  id v4 = [MEMORY[0x1E4F1CA80] setWithArray:*(void *)(v1 + 40)];
  v64 = (void *)v3;
  ...
  v65 = v2;
  uint64_t v66 = v1;
  uint64_t v73 = [obj countByEnumeratingWithState:&v79 objects:v92 count:16];
  if (v73)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v73; ++i)
      {
        ...
        id v8 = *(void **)(*((void *)&v79 + 1) + 8 * i);
        uint64_t v9 = (void *)[objc_alloc(*(Class *)(v6 + 296)) initWithUUIDString:v8];
        if (v9)
        {
          id v10 = [v2 accessoryWithUUID:v9];
          if (v10)
          {
            char v11 = [HMDTargetConfiguration alloc];
            id v12 = [*(id *)(v1 + 32) buttonConfiguration];
            id v69 = v10;
            long long v13 = [(HMDTargetConfiguration *)v11 initWithAccessory:v10 buttonConfiguration:v12];
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v90 = 2112;
              v91 = v20;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@(Update) Adding target accessory %@/%@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v88 = 2112;
              id v89 = v8;
              _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Cannot look up target accessory from UUID %@ to add", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v88 = 2112;
            id v89 = v8;
            _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Incorrectly formatted target UUID %@ to add", buf, 0x16u);
          }
        }
      }
      uint64_t v73 = [obj countByEnumeratingWithState:&v79 objects:v92 count:16];
  ...
  v31 = [MEMORY[0x1E4F1CA80] setWithArray:v64];
  __int16 v32 = [MEMORY[0x1E4F1CAD0] setWithArray:*(void *)(v1 + 40)];
  [v31 minusSet:v32];
  ...
  long long v76 = 0u;
  id v70 = v31;
  uint64_t v74 = [v70 countByEnumeratingWithState:&v75 objects:v84 count:16];
  if (v74)
  {
    ...
    while (2)
    {
      for (uint64_t j = 0; j != v74; ++j)
      {
        ...
        uint64_t v35 = [objc_alloc(*(Class *)(v6 + 296)) initWithUUIDString:v34];
        if (v35)
        {
          v36 = (void *)v35;
          uint64_t v37 = [v2 accessoryWithUUID:v35];
          if (v37)
          {
            v38 = (void *)v37;
            [*(id *)(v1 + 32) targetConfigurationMatchingAccessory:v37];
            v40 = uint64_t v39 = v1;
            ...
            if (!v40)
            {
              if (v44)
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v90 = 2112;
                v91 = v62;
                _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Attempt to remove a target %@/%@ that cannot be looked up in target controller manager", buf, 0x20u);
            ...
            if (v44)
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v90 = 2112;
              v91 = v48;
              _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@(Update) Removing target accessory %@/%@", buf, 0x20u);
            ...
            v49 = *(void **)(v66 + 32);
            v83 = v40;
            v50 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v83 count:1];
            [v49 _removeTargets:v50];
          }
          else
          {
            ...
            if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v88 = 2112;
              id v89 = v34;
              _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_INFO, "%{public}@Cannot look up target accessory from UUID %@ to remove", buf, 0x16u);
            }
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v88 = 2112;
            id v89 = v34;
            _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Incorrectly formatted target UUID %@ to remove", buf, 0x16u);
          }
        }
        uint64_t v1 = v66;
      }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v28 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Preference set to auto-configure existing targets when new target controller is added - configuring them...", buf, 0xCu);
    }
    ...
    if (v13)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v14; ++i)
        {
          ...
          {
            uint64_t v18 = [[HMDTargetConfiguration alloc] initWithAccessory:v17 buttonConfiguration:0];
            [v10 addObject:v18];
          }
        }
    ...
    id v19 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) _addTargets:v10]);
    id v20 = *(id *)(a1 + 32);
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      __int16 v30 = v10;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Saving targetUUIDs after auto-configuration of targets - %@", buf, 0x16u);
    }
...
- (void)__characteristicEventsReceived:(id)a3
{
  ...
  int v4 = objc_msgSend(v26, "hmf_arrayForKey:", *MEMORY[0x1E4F5B7D0]);
  uint64_t v27 = self;
  ...
  if (v7)
  {
    ...
    uint64_t v30 = *MEMORY[0x1E4F2DEE0];
    uint64_t v28 = *MEMORY[0x1E4F2CE50];
    __int16 v29 = v5;
    do
    {
      uint64_t v10 = 0;
...
- (void)_registerForActiveIdentifierNotifications
{
  ...
  [v2 addObserver:self selector:sel___characteristicEventsReceived_ name:*MEMORY[0x1E4F5B7C8] object:0];
  ...
  *(_OWORD *)id location = 0u;
  ...
  if (v6)
  {
    ...
    uint64_t v9 = *MEMORY[0x1E4F2CE50];
    do
    {
  ...
  if ([v15 count])
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v47 = 2112;
      v48 = v15;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Registering for notification on active selection characteristics: %@", buf, 0x16u);
    }
    [v33 enableNotification:1 forCharacteristics:v15 message:0 clientIdentifier:@"com.apple.HomeKitDaemon.targetControl"];
    uint64_t v20 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v15, "count"));
    long long v38 = 0u;
    long long v39 = 0u;
    long long v36 = 0u;
    long long v37 = 0u;
    ...
    uint64_t v27 = (void *)MEMORY[0x1D9452090](inited);
    uint64_t v28 = v17;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v46 = v30;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Refreshing the active selections on the controller", buf, 0xCu);
    }
...
- (void)_handleActiveIdentifierReadResponses:(id)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v24 = *MEMORY[0x1E4F2DEE0];
    uint64_t v21 = *MEMORY[0x1E4F2CE50];
    uint64_t v22 = self;
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Unable to look up target for identifier %@ while reading activeIdentifier characteristic %@/%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v29 = 2112;
      id v30 = v7;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Received a non-number (%@) for activeIdentifier characteristic %@", buf, 0x20u);
    }
  }
}
  ...
  if ([v14 count])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v48 = 2112;
      uint64_t v49 = v24;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@%@ for notifications from event characteristics on controller service %@/%@", buf, 0x2Au);
    ...
    {
      uint64_t v25 = [*(id *)(v15 + 32) findCharacteristicWithType:*MEMORY[0x1E4F2CE48]];
      if (v25)
      {
        if (*(unsigned char *)(v15 + 48)) {
          uint64_t v26 = &unk_1F2DC7E58;
        }
        else {
          uint64_t v26 = 0;
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v46 = 2112;
          __int16 v47 = v35;
          _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Unable to look up active characteirstic in controller %@ service %@ for active selection acknowledgement", buf, 0x20u);
        }
      }
    }
  }
...
- (void)_resetTargets
{
  ...
  uint64_t v4 = [v3 findCharacteristicType:*MEMORY[0x1E4F2D000] forServiceType:*MEMORY[0x1E4F2DEE8]];
  if (v4)
  {
    id v17 = 0;
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v20 = 2112;
        id v21 = v6;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for resetting targets - error %@", buf, 0x16u);
      }
    }
    else
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v19 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for resetting targets", buf, 0xCu);
    }
  }
}
...
LABEL_6:
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v10, 0xCu);
    }
  }
  else if (v7)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v13 = 2048;
      uint64_t v14 = 4;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Encoding for reset target - operation %lu", buf, 0x16u);
    }
    id v5 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v15);
  }
  TLV8BufferFree();
  if (a3 && !v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v20 = 2112;
        long long v21 = v13;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Attempt to remove a target %@/%@ that cannot be looked up in target controller manager", buf, 0x20u);
      }
    }
  }
}
...
- (void)_removeTargets:(id)a3
{
  ...
  {
    id v5 = [(HMDTargetControllerManager *)self controller];
    id v6 = [v5 findCharacteristicType:*MEMORY[0x1E4F2D000] forServiceType:*MEMORY[0x1E4F2DEE8]];
    if (v6)
    {
      id v49 = 0;
      ...
      if (v40)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v57 = 2112;
          id v58 = v40;
          _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for removing targets %@ - error %@", buf, 0x20u);
        }
        char v11 = (void *)v39;
      }
      else
      {
        uint64_t v36 = v6;
        long long v37 = v5;
        long long v16 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v4, "count"));
        long long v45 = 0u;
        long long v46 = 0u;
        long long v47 = 0u;
        long long v48 = 0u;
              ...
              else
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v55 = 2112;
                  id v56 = v22;
                  _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Target being removed %@ does not have a UUID", buf, 0x16u);
        ...
        id v51 = v16;
        long long v33 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v51 forKeys:&v50 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v55 = 2112;
        id v56 = v4;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for removing targets %@", buf, 0x16u);
      }
    }
  }
}
...
void __45__HMDTargetControllerManager__removeTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for removing targets %@", (uint8_t *)&v18, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      long long v23 = v12;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully removed targets %@ - response %@", (uint8_t *)&v18, 0x20u);
    }
  }
}
...
- (id)_dataForRemoveTargets:(id)a3 outError:(id *)a4
{
  ...
  else
  {
        ...
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v36 = 2048;
            uint64_t v37 = v26;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Encoding for remove target - operation %lu  identifier %lu", buf, 0x20u);
          }
          char v12 = 1;
        }
    ...
    objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v60);
    ...
    {
      uint64_t v22 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v39);
LABEL_18:
      id v6 = v24;
      a4 = v25;
...
void __69__HMDTargetControllerManager_addTargetAccessory_buttonConfiguration___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v29 = 2112;
    long long v30 = v15;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding target accessory %@/%@ with button configuration %@ - target configuration %@", buf, 0x34u);
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v69 = 2112;
          id v70 = v4;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for adding targets %@", buf, 0x16u);
        }
      }
      else
      {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v69 = 2112;
                  id v70 = v29;
                  _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Target being added %@ does not have a UUID", buf, 0x16u);
        ...
        long long v64 = v23;
        long long v40 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v64 forKeys:&v63 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v69 = 2112;
        id v70 = v4;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for adding targets %@", buf, 0x16u);
      }
    }
  }
}
...
void __42__HMDTargetControllerManager__addTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for adding targets %@ - error %@", (uint8_t *)&v19, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      uint64_t v26 = v12;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully added targets %@ configuredTargets %@ - response %@", (uint8_t *)&v19, 0x2Au);
    }
  }
}
...
LABEL_9:
            ...
            else
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138544386;
                ...
                _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Adding TLVs for add target operation - identifier %lu  name %s  category %lu  buttonConfiguration: %@", buf, 0x34u);
              }
              int v21 = 0;
            }
          }
    ...
    objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v69[0]);
    ...
    {
      uint64_t v31 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v48);
LABEL_27:
      id v6 = v38;
      a4 = v39;
...
- (void)_updateName:(id)a3 buttonConfiguration:(id)a4 target:(id)a5
{
  ...
  if (v10)
  {
    if (v8 || [v9 count])
    {
      ...
      id v12 = [v11 findCharacteristicType:*MEMORY[0x1E4F2D000] forServiceType:*MEMORY[0x1E4F2DEE8]];
      if (v12)
      {
        id v51 = 0;
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(void *)((char *)&buf[2] + 12) = v20;
            _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to serialize request for updating %@/%@ with name %@  buttonConfiguration %@", (uint8_t *)buf, 0x34u);
        ...
        else if ([v13 length])
        {
          ...
          {
            objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", buf[0]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)((char *)&buf[2] + 12) = v32;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Failed to look up target list characteristic for updating %@/%@ with name %@  buttonConfiguration %@", (uint8_t *)buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)((char *)buf + 14) = v8;
      WORD3(buf[1]) = 2112;
      *((void *)&buf[1] + 1) = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Request to update name %@  buttonConfiguration %@ for a nil target", (uint8_t *)buf, 0x20u);
    }
  }
}
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v35 = 2112;
      __int16 v36 = v11;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for updating %@/%@ with name %@  buttonConfiguration %@", buf, 0x34u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      __int16 v37 = 2112;
      id v38 = v15;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Successfully updated %@/%@ with name %@  buttonConfiguration %@ - response %@", buf, 0x3Eu);
    }
  }
}
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v16; ++i)
        {
          ...
          if (v22)
          {
            ...
            id v50 = v10;
            uint64_t v24 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v50 count:1];
            id v13 = v36;
            ...
            {
              __int16 v29 = (void *)MEMORY[0x1D9452090](v28);
              id v30 = v35;
              ...
              if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                __int16 v48 = 2112;
                id v49 = v33;
                _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Encoding for update target - identifier %lu  updatedName %@  buttonConfiguration: %@", buf, 0x2Au);

                id v13 = v36;
              }

              id v23 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v51[0]);
            }
            TLV8BufferFree();
            if (a6 && !v23)
            {
              *a6 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
            }
            goto LABEL_29;
          }
        }
        ...
        if (v10)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v22 = 2112;
            id v23 = v7;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Updated the button configuration for target %@", buf, 0x16u);
          }
          goto LABEL_13;
        }
      }
...
- (void)_auditTargets:(id)a3
{
  ...
  id v47 = [MEMORY[0x1E4F1CAD0] setWithArray:v4];
  id v7 = (void *)MEMORY[0x1D9452090]();
  id v8 = self;
  id v9 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v69 = 2112;
    id v70 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Read targets %@, Configured targets %@", buf, 0x20u);
  }
  __int16 v46 = v6;
      ...
      for (uint64_t j = 0; j != v24; ++j)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v67 = 2112;
          id v68 = v27;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Target %@ not present in controller's target list - adding...", buf, 0x16u);
        }
      }
      ...
      for (uint64_t k = 0; k != v36; ++k)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v67 = 2112;
          id v68 = v39;
          _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Target %@ present in controller's target list - removing...", buf, 0x16u);
        }
      }
...
- (void)_listTargetsWithCompletionHandler:(id)a3
{
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        id v26 = v8;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Unable to generate serialized data for listing targets - error %@", buf, 0x16u);
      }
      if (v4) {
        v4[2](v4, v8, 0);
      }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v16;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@No Target List characteristic to audit configured target accessories - skipping", buf, 0xCu);
  }
  if (v4)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v13 = 2048;
      uint64_t v14 = 1;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Encoding for list target - operation %lu", buf, 0x16u);
    }
    BOOL v5 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v15);
  }
  TLV8BufferFree();
  if (a3 && !v5)
  {
...
- (void)_refreshConfigurationWithCompletion:(id)a3
{
  ...
  v26[1] = v26;
  v26[2] = 0x3032000000;
  v26[3] = __Block_byref_object_copy__53116;
  v26[4] = __Block_byref_object_dispose__53117;
  id v27 = 0;
  ...
  v21[1] = v21;
  v21[2] = 0x3032000000;
  v21[3] = __Block_byref_object_copy__53116;
  v21[4] = __Block_byref_object_dispose__53117;
  id v22 = 0;
  v19[0] = 0;
  v19[1] = v19;
  v19[2] = 0x3032000000;
  v19[3] = __Block_byref_object_copy__53116;
  v19[4] = __Block_byref_object_dispose__53117;
  id v20 = 0;
...
uint64_t __66__HMDTargetControllerManager__refreshConfigurationWithCompletion___block_invoke_3(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    long long v19 = v9;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Notifying supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", (uint8_t *)&v12, 0x2Au);
  }
...
- (void)_readSupportedConfigurationWithCompletion:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [(HMDTargetControllerManager *)self controller];
  uint64_t v6 = [v5 findCharacteristicType:*MEMORY[0x1E4F2CFD0] forServiceType:*MEMORY[0x1E4F2DEE8]];
  if (v6)
  {
...
LABEL_7:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(id *)((char *)location + 4) = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@No Supported target Configuration characteristic to refresh the configuration for the controller", (uint8_t *)location, 0xCu);
  }
  if (v4)
  {
  ...
  if (WeakRetained)
  {
    if ([v3 count])
    {
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Error %@ response for reading characteristic %@", buf, 0x20u);
        }
      ...
      else
      {
        ...
        int v27 = [v26 isEqualToString:*MEMORY[0x1E4F2CFD0]];
          ...
          if (v31)
          {
            ...
            if (v31 == -6727)
            {
              ...
              if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                long long v60 = v36;
                _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@No data to parse for supported configuration", buf, 0xCu);
              }
            ...
            else
            {
              ...
              {
                HMFGetLogIdentifier();
                long long v52 = v58 = v49;
                *(_DWORD *)buf = 138543618;
                long long v60 = v52;
                __int16 v61 = 2048;
                unint64_t v62 = v32;
                _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_INFO, "%{public}@Parsing supported configuration data failed with error %lu", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v65 = 2112;
              long long v66 = v48;
              _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Refreshed supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", buf, 0x2Au);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v63 = 2112;
            uint64_t v64 = (uint64_t)v7;
            _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_INFO, "%{public}@Got unexpected response - attempting to read %@, got %@", buf, 0x20u);
          }
          id v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:74];
        }
...
LABEL_40:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v60 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@No responses refreshing controller configuration", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v60 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for reading supported target configuration characteristic", buf, 0xCu);
    }
    uint64_t v19 = *(void *)(a1 + 40);
    if (v19)
    {
...
- (id)__refreshedConfiguration:(id)a3
{
  ...
  {
    __int16 v13 = (void *)MEMORY[0x1E4F1CC08];
  }
  ...
  while (2)
  {
    ...
    switch(v24)
    {
      ...
      case 3:
        ...
        uint64_t v14 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:");
        id v19 = 0;
...
void __49__HMDTargetControllerManager___accessoryRemoved___block_invoke(uint64_t a1)
{
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v71 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller has been removed from the home - invalidating...", buf, 0xCu);
    }
    [*(id *)(a1 + 40) invalidate];
  }
            ...
            if (v32)
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessory %@/%@ has been removed", buf, 0x20u);
              }
              id v47 = *(void **)(a1 + 40);
              id v68 = v29;
              id v48 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v68 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        uint64_t v79 = v56;
        uint64_t v21 = 0;
        _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process accessory %@/%@ removal for a controller %@/%@ that is not configured with a home", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Removed accessory %@/%@ does not support target control - ignoring", buf, 0x20u);
    }
  }
}
...
void __53__HMDTargetControllerManager___accessoryNameUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of an accessory %@/%@ has been updated", buf, 0x20u);
  }
            ...
            if (v25)
            {
              ...
              if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of target accessory %@ has been updated to %@", buf, 0x20u);
              ...
              if ((v37 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  __int16 v74 = 2112;
                  uint64_t v75 = v43;
                  _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Updating the name of target accessory %@/%@ to %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process accessory name update with a controller %@/%@ that is not configured with a home", buf, 0x20u);
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v30 = 2112;
    int v31 = v11;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Connected to accessory %@/%@", buf, 0x20u);
  }
  id v12 = v4;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v27 = v22;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Connected to controller - refreshing the supported target configuration and auditing the list of targets", buf, 0xCu);
      }
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke_59(uint64_t a1, void *a2)
{
  ...
  if (v3 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to refresh the supported target configuration - error %@", (uint8_t *)&v10, 0x16u);
    }
  }
}
...
void __54__HMDTargetControllerManager___accessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    __int16 v28 = v11;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Disconnected from accessory %@/%@", (uint8_t *)&v23, 0x20u);
  }
  id v12 = v4;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        int v23 = 138543362;
        uint64_t v24 = v22;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Disconnected from controller - marking configuation as stale", (uint8_t *)&v23, 0xCu);
      }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v21;
            ...
            __int16 v32 = 2112;
            long long v33 = v18;
            _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Target %@/%@ does not have a UUID", buf, 0x20u);
          }
        }
      }
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    uint64_t v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating target controller manager", (uint8_t *)&v8, 0xCu);
  }
...
- (HMDTargetControllerManager)initWithTargetControllerAccessory:(id)a3 targets:(id)a4
{
  ...
  v68->_buttonConfiguration = (NSArray *)MEMORY[0x1E4F1CBF0];
...
LABEL_14:
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v84 = 2048;
          unint64_t v85 = v29;
          _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Unable to look up the target with UUID %@ - adding with identifier %lu", buf, 0x20u);
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v86 = 2112;
        long long v87 = v43;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Attempting to initialize target with UUID %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
...
LABEL_21:
  ...
  uint64_t v79 = v21;
  id v45 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v79 forKeys:&v78 count:1];
  unint64_t v18 = 0x1E4F28000uLL;
  __int16 v46 = [MEMORY[0x1E4F28EB8] defaultCenter];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_53165 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_53165, &__block_literal_global_53166);
  }
  id v2 = (void *)logCategory__hmf_once_v7_53167;
  return v2;
}
...
uint64_t __41__HMDTargetControllerManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v7_53167;
  logCategory__hmf_once_v7_53167 = v0;
