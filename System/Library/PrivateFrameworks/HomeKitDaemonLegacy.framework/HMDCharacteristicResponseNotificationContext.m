...
+ (id)notificationUpdateMessagePayloadForHome:(id)a3 notificationEnabled:(BOOL)a4 characteristics:(id)a5 characteristicsErrorsMap:(id)a6
{
  ...
  if (v57)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v57; ++i)
      {
        ...
        v12 = objc_msgSend(v11, "service", v50);
        v13 = [v12 instanceID];
        v14 = [v12 accessory];
        v15 = [v14 uuid];
        v16 = [v15 UUIDString];
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v68 = 2112;
            v69 = v11;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Missing required service (%@) properties for characteristic %@ - dropping the notification", buf, 0x20u);
          }
        }
        else
        {
          ...
          if (v34)
          {
            v35 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v34 requiringSecureCoding:1 error:0];
            v36 = v33;
            v37 = v35;
  ...
  if ([v9 count])
  {
    ...
    v47 = [v46 UUIDString];
    v63[1] = v47;
    v48 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v63 forKeys:v62 count:2];
  }
  else
  {
...
- (HMDCharacteristicResponseNotificationContext)initWithRequestIdentifier:(id)a3 responses:(id)a4 pendingMultiPartResponses:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    uint64_t v89 = *MEMORY[0x1E4F2D140];
    ...
    while (1)
    {
      ...
      do
      {
        ...
        BOOL v17 = *(void **)(*((void *)&v106 + 1) + 8 * v16);
        ...
        if (!v23 && v21 != 0)
        {
          ...
          if (v33
            ...
            && ([MEMORY[0x1E4F28C58] errorWithDomain:v89 code:4 userInfo:0],
                (id v33 = (id)objc_claimAutoreleasedReturnValue()) != 0))
          {
            v34 = v30;
            id v105 = 0;
            v35 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v33 requiringSecureCoding:1 error:&v105];
            id v36 = v105;
            if (v35)
            {
              v119 = @"kCharacteristicErrorDataKey";
              v120 = v35;
              v37 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v120 forKeys:&v119 count:1];
            ...
            else
            {
              ...
              if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v117 = 2112;
                id v118 = v36;
                _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize error %@: %@", buf, 0x20u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v117 = 2112;
                  id v118 = v43;
                  _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_INFO, "%{public}@Updating notification context response to last known characteristic value %@ -> %@", buf, 0x20u);
...
LABEL_46:
            ...
            id v112 = v33;
            long long v58 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v112 forKeys:&v111 count:1];
            v38 = (void *)[v58 mutableCopy];

            long long v59 = [v19 lastKnownValueUpdateTime];
            [v38 setObject:v59 forKeyedSubscript:@"kCharacteristicValueUpdateTime"];

            long long v60 = [v19 notificationContext];
...
- (id)attributeDescriptions
{
  ...
  id v19 = [(HMDCharacteristicResponseNotificationContext *)self requestIdentifier];
  ...
  id v7 = (void *)[v5 initWithName:@"Has Pending Multi Part Responses" value:v6];
  v20[1] = v7;
  id v8 = objc_alloc(MEMORY[0x1E4F653F8]);
  id v9 = [(HMDCharacteristicResponseNotificationContext *)self changedCharacteristics];
  ...
  uint64_t v13 = (void *)[v11 initWithName:@"Previously Nil Changed Characteristics" value:v12];
  v20[3] = v13;
  id v14 = objc_alloc(MEMORY[0x1E4F653F8]);
  uint64_t v15 = [(HMDCharacteristicResponseNotificationContext *)self notificationPayloadByAccessoryUUID];
  uint64_t v16 = (void *)[v14 initWithName:@"Notification Payload" value:v15];
  v20[4] = v16;
  BOOL v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v20 count:5];
...
- (id)notificationWithHome:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v7 = [(HMDCharacteristicResponseNotificationContext *)self notificationPayloadByAccessoryUUID];
    ...
    id v9 = objc_msgSend(NSNumber, "numberWithBool:", -[HMDCharacteristicResponseNotificationContext hasPendingMultiPartResponses](self, "hasPendingMultiPartResponses"));
    [v6 setObject:v9 forKeyedSubscript:@"kMultiPartResponseKey"];

    v10 = (void *)[objc_alloc(MEMORY[0x1E4F28EA0]) initWithName:@"HMDAccessoryCharacteristicsResponseReceivedNotification" object:v4 userInfo:v6];
  }
  else
  {
    v10 = 0;
...
+ (id)updateMultipleCharacteristicReadWriteResponsePayload:(id)a3 withUnhandledRequests:(id)a4
{
  ...
  if ([v6 count])
  {
    id v7 = objc_msgSend(v5, "hmf_dictionaryForKey:", @"kModifiedCharacteristicsForAccessoryKey");
    id v8 = (void *)[v7 mutableCopy];

    if (v8)
    {
      id v9 = (void *)MEMORY[0x1D9452090]();
      v10 = (void *)MEMORY[0x1E4F28DB0];
