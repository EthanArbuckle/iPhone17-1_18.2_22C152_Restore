...
LABEL_14:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      v26 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unknown destination %@ for resolve destination operation, using system media destination", buf, 0x16u);
    }
    v6 = v16;
LABEL_13:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    v26 = v11;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Using custom media application destination for bundle identifier %@", buf, 0x16u);
  }
  id v12 = objc_alloc(MEMORY[0x1E4F76E68]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v31 = 2112;
        v32 = v18;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to resolve hashed media profiles given %@ hashedRouteIDs, resolved to %@", buf, 0x20u);
      }
      v19 = NSString;
      v20 = NSNumber;
      ...
      v26 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2950 description:v8 underlyingError:0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_99756 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_99756, &__block_literal_global_99757);
  }
  v2 = (void *)logCategory__hmf_once_v4_99758;
  return v2;
}
...
uint64_t __48__HMDMPCResolveDestinationOperation_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v4_99758;
  logCategory__hmf_once_v4_99758 = v0;
