...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BDE8] wrappertlv:2 name:@"kSessionControl__Command"];
  id v4 = [MEMORY[0x1E4F5BE78] wrappertlv:1 name:@"kSessionControl__SessionIdentifier"];
  v11[0] = v3;
  v11[1] = v4;
  id v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v11 count:2];
