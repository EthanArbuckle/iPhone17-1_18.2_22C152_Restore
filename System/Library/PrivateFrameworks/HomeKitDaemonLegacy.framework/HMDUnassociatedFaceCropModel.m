...
+ (id)unassociatedFaceCropsBetweenDatesQueryWithIsAscending:(BOOL)a3
{
  ...
  if (unassociatedFaceCropsBetweenDatesQueryWithIsAscending__onceToken != -1) {
    dispatch_once(&unassociatedFaceCropsBetweenDatesQueryWithIsAscending__onceToken, &__block_literal_global_23_40145);
  }
...
void __86__HMDUnassociatedFaceCropModel_unassociatedFaceCropsBetweenDatesQueryWithIsAscending___block_invoke()
{
  ...
  v14[0] = @"dateAfter";
  v1 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateCreated"];
  v14[1] = @"dateBefore";
  v15[0] = v1;
  v2 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateCreated"];
  v15[1] = v2;
  BOOL v3 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v15 forKeys:v14 count:2];
  uint64_t v4 = [v0 queryWithSQLPredicate:@"dateCreated >= :dateAfter AND dateCreated < :dateBefore ORDER BY dateCreated ASC" sequenceArgumentName:@"dateAfter" indexedProperties:&unk_1F2DC6AD8 arguments:v3];
  ...
  v6 = (void *)MEMORY[0x1E4F69EA8];
  v12[0] = @"dateAfter";
  v7 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateCreated"];
  v12[1] = @"dateBefore";
  v13[0] = v7;
  v8 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateCreated"];
  v13[1] = v8;
  v9 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v13 forKeys:v12 count:2];
  uint64_t v10 = [v6 queryWithSQLPredicate:@"dateCreated > :dateAfter AND dateCreated <= :dateBefore ORDER BY dateCreated DESC" sequenceArgumentName:@"dateBefore" indexedProperties:&unk_1F2DC6AF0 arguments:v9];
...
+ (NSUUID)sentinelParentUUID
{
  if (sentinelParentUUID_onceToken_40168 != -1) {
    dispatch_once(&sentinelParentUUID_onceToken_40168, &__block_literal_global_17_40169);
  }
  v2 = (void *)sentinelParentUUID_sentinelParentUUID_40170;
  return (NSUUID *)v2;
}

uint64_t __50__HMDUnassociatedFaceCropModel_sentinelParentUUID__block_invoke()
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"58F70219-F689-486A-B16D-8143BD41ABDF"];
  uint64_t v1 = sentinelParentUUID_sentinelParentUUID_40170;
  sentinelParentUUID_sentinelParentUUID_40170 = v0;
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_40180 != -1) {
    dispatch_once(&hmbProperties_onceToken_40180, &__block_literal_global_40181);
  }
  v2 = (void *)hmbProperties_properties_40182;
  return v2;
}
...
void __45__HMDUnassociatedFaceCropModel_hmbProperties__block_invoke()
{
  ...
  v11[0] = v0;
  v10[1] = @"dateCreated";
  uint64_t v1 = (void *)MEMORY[0x1E4F69E98];
  uint64_t v2 = objc_opt_class();
  BOOL v3 = [MEMORY[0x1E4F69EA0] queryableField];
  v9 = v3;
  ...
  v8 = (void *)hmbProperties_properties_40182;
  hmbProperties_properties_40182 = v7;
}

- (void)setFaceBoundingBox:(CGRect)a3
{
  uint64_t v18 = *MEMORY[0x1E4F143B8];
  uint64_t v4 = objc_msgSend(MEMORY[0x1E4F29238], "valueWithRect:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  id v11 = 0;
...
- (CGRect)faceBoundingBox
{
  ...
  {
    id v22 = 0;
    uint64_t v4 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v3 error:&v22];
    id v5 = v22;
    if (v4)
    {
      [v4 rectValue];
...
- (id)createFaceCrop
{
  ...
  if (v3 && v4)
  {
    id v6 = objc_alloc(MEMORY[0x1E4F2E7C8]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v10;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot create face crop from model: %@", (uint8_t *)&v14, 0x16u);
    }
    double v8 = 0;
  }
