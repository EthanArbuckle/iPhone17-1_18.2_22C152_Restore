...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_191281 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_191281, &__block_literal_global_191282);
  }
  v2 = (void *)logCategory__hmf_once_v1_191283;
  return v2;
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Completion handler is nil", buf, 0xCu);
    }
  }
}
...
LABEL_4:
    ...
    {
      v15 = [*(id *)(a1 + 40) supportedResolutions];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v61 = v28;
          _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Need to gather supported video resolutions by the camera", buf, 0xCu);
        }
        v29 = *(void **)(a1 + 40);
        v47 = *(void **)(a1 + 56);
        id v48 = *(id *)(a1 + 32);
        if (v29)
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v61 = v32;
            _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Getting Supported Configuration", buf, 0xCu);
          }
          ...
          if (v49)
          {
            ...
            if (v36)
            {
              ...
              uint64_t v38 = *MEMORY[0x1E4F5BA68];
              uint64_t v39 = *MEMORY[0x1E4F5B930];
              do
              {
          ...
          {
            v51 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v62 = 2112;
        v63 = v14;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@There is already a request in progress so piggy backing on that: %@", buf, 0x16u);
      }
    }
    return;
  }
...
LABEL_3:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v61 = v22;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Most recent snapshot is still valid", buf, 0xCu);
  }
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v20;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Accessory is no longer available, cannot handle snapshot request", buf, 0xCu);
      }
      v21 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
...
LABEL_61:
    ...
    if (v8)
    {
      ...
      if ((unint64_t)(v9 - 1) < 0xA)
      {
        ...
        {
          v14 = HMFGetLogIdentifier();
          v15 = HMDVideoResolutionTypeAsString(v9);
          *(_DWORD *)buf = 138543618;
          *(void *)&uint8_t buf[4] = v14;
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v15;
          _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Overriding the resolution requested to %@", buf, 0x16u);
        }
        id v16 = [[HMDVideoResolution alloc] initWithResolution:v9];
LABEL_37:

        id obja = (id)[v88 snapshotReason];
        id v48 = (void *)MEMORY[0x1E4F1CA60];
        id v49 = v87;
        v92 = v16;
        v50 = [v48 dictionary];
        [v50 setObject:*MEMORY[0x1E4F5BB70] forKeyedSubscript:*MEMORY[0x1E4F5BB90]];
        v51 = [(HMDVideoResolution *)v92 imageWidth];
        [v50 setObject:v51 forKeyedSubscript:*MEMORY[0x1E4F5BB80]];

        v52 = [(HMDVideoResolution *)v92 imageHeight];

        [v50 setObject:v52 forKeyedSubscript:*MEMORY[0x1E4F5BB78]];
        id v53 = v50;
        id v54 = v49;
        v55 = [v54 bridge];
        ...
        if (v55)
        {
          ...
          if (v56)
          {
            [v53 setObject:v56 forKeyedSubscript:*MEMORY[0x1E4F5B7C0]];
          }
          else
          {
            ...
            if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
            {
              ...
              *(void *)&uint8_t buf[4] = v60;
              _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the HAP instance id (aid) for bridged accessory.", buf, 0xCu);
            }
          }
        }
        long long v107 = 0u;
        ...
        if (v62)
        {
          ...
          uint64_t v64 = *MEMORY[0x1E4F2DDE0];
LABEL_46:
          uint64_t v65 = 0;
          while (1)
          {
          ...
          v71 = [v66 findCharacteristicWithType:*MEMORY[0x1E4F2CEE8]];
          BOOL v70 = v71 == 0;
          ...
          [v53 setObject:v77 forKeyedSubscript:*MEMORY[0x1E4F5BB88]];
        }
        else
        {
LABEL_52:
...
LABEL_54:
          ...
          if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&v99[18] = 1024;
            *(_DWORD *)&v99[20] = v69;
            _os_log_impl(&dword_1D49D5000, v75, OS_LOG_TYPE_INFO, "%{public}@Either event snapshot active characteristic (%d) or periodic snapshot active characteristic (%d) is not present", v99, 0x18u);
          }
        }
        ...
        *(void *)&buf[16] = 0x3032000000;
        v103 = __Block_byref_object_copy__191226;
        v104 = __Block_byref_object_dispose__191227;
        id v105 = (id)[objc_alloc(MEMORY[0x1E4F654E0]) initWithName:@"com.apple.homed.snapshot-request"];
        v79 = (void *)MEMORY[0x1D9452090]([v88 markMilestoneFor:@"SentSnapshotRequestToAccessory"]);
        v80 = v86;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&v106[12] = 2112;
          *(void *)&v106[14] = v78;
          _os_log_impl(&dword_1D49D5000, v81, OS_LOG_TYPE_INFO, "%{public}@Sending snapshot request to accessory with options: %@", v106, 0x16u);
        }
        id v83 = v80[2];
      ...
      if (v13)
      {
        ...
        *(_WORD *)&buf[12] = 2048;
        *(void *)&buf[14] = v9;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Not overriding the resolution requested to %tu", buf, 0x16u);
      }
    }
    unint64_t v84 = a3;
    if (a3 > 4)
    ...
    {
      uint64_t v23 = +[HMDVideoResolution arrayWithResolutions:](HMDVideoResolution, "arrayWithResolutions:", qword_1E6A198E0[a3], a3, v85, a1, v7);
    }
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v103 = v27;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Resolutions in order of preference: %@ for tier: %@", buf, 0x20u);
    }
    long long v107 = 0u;
    long long v108 = 0u;
    memset(v106, 0, sizeof(v106));
...
LABEL_24:
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)((char *)v101 + 2) = v42;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Found preferred resolution: %@ in supported resolutions: %@ for tier: %@", v99, 0x2Au);
      }
    }
    else
    {
...
LABEL_34:
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)((char *)v101 + 2) = v47;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Didn't find preferred resolution in supported resolutions: %@ for tier: %@. Defaulting to resolution: %@", v99, 0x2Au);
      }
    }
  ...
  if (a1)
  {
    ...
    if (v9)
    {
      if ([v9 length])
      {
        ...
        v15 = -[HMDSnapshotRequestHandler _saveSnapshotFile:]((id *)a1, v14);
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v46 = v19;
            _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to save snapshot file", buf, 0xCu);

            id v16 = v37;
          }

          uint64_t v20 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1038];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v47 = 2112;
          id v48 = v11;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Accessory sent 0 length data for snapshot request of resolution %@", buf, 0x16u);
        }
        v21 = v11;

        uint64_t v30 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1037];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v49 = 2112;
        id v50 = v10;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Accessory failed to send data for snapshot request of resolution %@: %@", buf, 0x20u);
      }
      v21 = v11;
...
- (void)timerDidFire:(id)a3
{
  ...
  if (mostRecentSnapshotInvalidationTimer == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      id v11 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Snapshot invalidation timer has fired, resetting the most recent snapshot", (uint8_t *)&v10, 0xCu);
    }
    if (self)
    {
...
- (void)streamSnapshotHandler:(id)a3 didGetLastSnapshot:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received last snapshot", (uint8_t *)&v13, 0xCu);
  }
...
- (HMDSnapshotFile)_saveSnapshotFile:(id *)a1
{
  if (a1)
  {
    ...
    if (v7)
    {
      ...
      uint64_t v8 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:2.0];
      id v9 = a1[6];
      a1[6] = (id)v8;
...
- (void)streamSnapshotHandler:(id)a3 didGetNewSnapshot:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received new snapshot", (uint8_t *)&v13, 0xCu);
  }
  if (v7) {
    id v12 = -[HMDSnapshotRequestHandler _saveSnapshotFile:]((id *)&v9->super.super.isa, v7);
  }
...
void __77__HMDSnapshotRequestHandler__getSupportedVideoResolutions_streamingTierType___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v77 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response for supported configurations", buf, 0xCu);
  }
  id v9 = *(void **)(a1 + 32);
  ...
  if (v6)
  {
    ...
    if (v14)
    {
      ...
      uint64_t v17 = *MEMORY[0x1E4F5B930];
      uint64_t v53 = *(void *)v63;
      id v54 = v13;
      uint64_t v52 = *MEMORY[0x1E4F5B930];
      do
      {
        uint64_t v18 = 0;
        uint64_t v56 = v15;
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v78 = 2112;
      v79 = v47;
      _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_INFO, "%{public}@Supported resolutions are: %@", buf, 0x16u);
    }
    id v48 = (id *)v44;
    id v12 = v49;
...
uint64_t __40__HMDSnapshotRequestHandler_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v1_191283;
  logCategory__hmf_once_v1_191283 = v0;
