...
- (void)handleExitContextForHomed:(id)a3 firstLaunchAfterBoot:(BOOL)a4
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Last exit context: first launch after reboot", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138545154;
      ...
      __int16 v61 = 2112;
      uint64_t v62 = v19;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Last exit context: type = %ld, timestamp = %{public}@,%{public}@ domain = %d, code = %ld, flag = %{public}@, error = %@", buf, 0x4Eu);
    }
  }
  ...
  if ([v7 isJetsam])
  {
    ...
    v27 = [v7 error];
    v28 = [v27 userInfo];
    v29 = [v28 objectForKeyedSubscript:*MEMORY[0x1E4F28588]];
  ...
  if ([v7 isCrash])
  {
    ...
    v38 = [v7 error];
    v39 = [v38 userInfo];
    v40 = [v39 objectForKeyedSubscript:*MEMORY[0x1E4F28588]];
...
- (HMDLogEventProcessLaunchAnalyzer)initWithProcessLaunchInfoTimer:(id)a3 dataSource:(id)a4 preferencesDebugManager:(id)a5 lastExitContextBlock:(id)a6
{
  ...
  if (v15)
  {
    ...
    v25 = [MEMORY[0x1E4F1C978] arrayWithObjects:v34 count:6];
...
- (HMDLogEventProcessLaunchAnalyzer)initWithProcessLaunchInfoTimer:(id)a3 dataSource:(id)a4 preferencesDebugManager:(id)a5
{
  return [(HMDLogEventProcessLaunchAnalyzer *)self initWithProcessLaunchInfoTimer:a3 dataSource:a4 preferencesDebugManager:a5 lastExitContextBlock:&__block_literal_global_129887];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_129895 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_129895, &__block_literal_global_85_129896);
  }
  id v2 = (void *)logCategory__hmf_once_v8_129897;
  return v2;
}
...
uint64_t __47__HMDLogEventProcessLaunchAnalyzer_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v8_129897;
  logCategory__hmf_once_v8_129897 = v0;
