...
+ (void)findChangedSettingsWithRootGroup:(id)a3 currentGroups:(id)a4 currentSettings:(id)a5 completion:(id)a6
{
  ...
  id v61 = v14;
  v56 = v10;
  v15 = objc_msgSend(MEMORY[0x1E4F28E10], "strongToWeakObjectsMapTable", context);
  v16 = [MEMORY[0x1E4F28E10] strongToWeakObjectsMapTable];
  ...
  if (objc_msgSend(v7, "na_any:", v25))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v29 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple groups collison", buf, 0xCu);
    }
