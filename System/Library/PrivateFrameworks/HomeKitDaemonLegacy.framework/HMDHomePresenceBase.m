...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_100318 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_100318, &__block_literal_global_100319);
  }
  v2 = (void *)logCategory__hmf_once_v1_100320;
  return v2;
}
...
uint64_t __34__HMDHomePresenceBase_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_100320;
  logCategory__hmf_once_v1_100320 = v0;
...
- (void)_initialize:(id)a3
{
  ...
  MEMORY[0x1F41817F8](v19, notificationRegistration);
}
