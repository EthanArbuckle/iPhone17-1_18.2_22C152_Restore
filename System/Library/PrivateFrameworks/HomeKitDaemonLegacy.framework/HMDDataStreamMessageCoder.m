...
LABEL_5:
  ...
  if ((unint64_t)(v8 + 4) >= 0x100000)
  {
    if (a5)
    {
      [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1052];
      id v9 = 0;
  ...
  v11[2] = BYTE1(v8);
  void v11[3] = v8;
  id v9 = objc_msgSend(MEMORY[0x1E4F1CA58], "dataWithCapacity:");
...
LABEL_5:
  ...
  v18[2] = BYTE1(v12);
  v18[3] = v12;
  v15 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v18 length:4];
  v16 = [v9 encrypt:v11 additionalAuthenticatedData:v15];

  v14 = [MEMORY[0x1E4F1CA58] dataWithCapacity:v13];
...
+ (id)_encodeOPACKHeader:(id)a3 payload:(id)a4 error:(id *)a5
{
  id v7 = a4;
  int v18 = 0;
  uint64_t v8 = (void *)MEMORY[0x1D9450EF0](a3, 0, &v18);
  if (v18) {
    BOOL v9 = 1;
  }
  else {
  ...
  if (!v9)
  {
    uint64_t v11 = MEMORY[0x1D9450EF0](v7, 0, &v18);
    ...
    else
    {
      ...
      {
        char v17 = v13;
        dispatch_data_t v10 = [MEMORY[0x1E4F1CA58] dataWithCapacity:v13 + v14 + 1];
      ...
      if (a5)
      {
        v15 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1052];
LABEL_15:
...
+ (BOOL)_unpackUnencryptedOPACKFrame:(id)a3 receivedHeader:(id *)a4 receivedPayload:(id *)a5 error:(id *)a6
{
  ...
  {
    [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1050];
    BOOL v10 = 0;
    *a6 = (id)objc_claimAutoreleasedReturnValue();
  }
  else
