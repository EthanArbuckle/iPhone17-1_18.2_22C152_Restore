...
- (BOOL)evaluate
{
        ...
        if (([*(id *)(*((void *)&v17 + 1) + 8 * v7) status] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v22 = v16;
            _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to NO", buf, 0xCu);
          }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v22 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", buf, 0xCu);
  }
  return 1;
}
...
void __70__HMDAccessoryFirmwareUpdateAggregatePolicy_handlePolicyStatusChange___block_invoke(uint64_t a1)
{
  ...
  v2 = [*(id *)(a1 + 32) object];
  if ([v2 conformsToProtocol:&unk_1F2E06700]) {
    v3 = v2;
  }
  else {
    v3 = 0;
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 1024;
      int v16 = v8;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received updated status from sub policy - %d", (uint8_t *)&v13, 0x12u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_101836 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_101836, &__block_literal_global_88_101837);
  }
  v2 = (void *)logCategory__hmf_once_v5_101838;
  return v2;
}
...
uint64_t __56__HMDAccessoryFirmwareUpdateAggregatePolicy_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_101838;
  logCategory__hmf_once_v5_101838 = v0;
