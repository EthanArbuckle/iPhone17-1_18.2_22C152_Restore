    ...
    if (v16)
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        v39 = v22;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@The select configuration control reply errored out: %@", buf, 0x16u);
      }
      v23 = *(void **)(v31 + 32);
      v24 = [MEMORY[0x1E4F28C58] hmErrorWithCode:59];
    ...
    else
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v37 = v30;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Successfully set the selected recording configuration", buf, 0xCu);
      }
...
LABEL_15:
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@The select configuration control reply does not contain a response", buf, 0xCu);
    }
    v29 = *(void **)(v31 + 32);
    id v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:59];
...
LABEL_7:
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v15, 0xCu);
    }
  }
  else
  {
...
- (id)_isRecordingActiveValueInResponses:(id)a3
{
  ...
  id v6 = [(HMDCameraRecordingSettingsControl *)self _numberValueForCharacteristicOfType:*MEMORY[0x1E4F2CE48] inResponses:v4];
  id v7 = v6;
  if (v6)
  {
    id v8 = v6;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      int v15 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Response missing recording active", (uint8_t *)&v14, 0xCu);
    }
  }
...
- (void)_handleSupportedConfigurationCharacteristicsReadResponses:(id)a3
{
  ...
  if ([v6 BOOLValue])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v49 = 2112;
      v50 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating supported recording configuration to: %@", (uint8_t *)&v47, 0x16u);
    }
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v49 = 2112;
      v50 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating supported video configuration to: %@", (uint8_t *)&v47, 0x16u);
    }
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v49 = 2112;
      v50 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating supported audio configuration to: %@", (uint8_t *)&v47, 0x16u);
    }
    ...
    if (v25 && v26 && v27)
    {
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v49 = 2112;
        v50 = v25;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Setting selected general configuration: %@", (uint8_t *)&v47, 0x16u);
      }
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v49 = 2112;
        v50 = v26;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Setting selected video configuration: %@", (uint8_t *)&v47, 0x16u);
      }
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v49 = 2112;
        v50 = v27;
        _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Setting selected audio configuration: %@", (uint8_t *)&v47, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        int v47 = 138543362;
        v48 = v46;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Skipping selected configuration write because of invalid selected config", (uint8_t *)&v47, 0xCu);
      }
      uint64_t v41 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v49 = 2112;
      v50 = v6;
      _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Recording active is disabled: %@", (uint8_t *)&v47, 0x16u);
    }
    [(HMDCameraRecordingSettingsControl *)v43 setCurrentSelectedConfiguration:0];
    long long v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v51 = 2112;
            id v52 = v13;
            _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Recording service does not have required characteristic type: %@", buf, 0x16u);
          }
          [(HMDCameraRecordingSettingsControl *)v36 setCurrentSelectedConfiguration:0];
          v39 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    ...
    if ((v19 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v51 = 2112;
        id v52 = v24;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating selected general configuration: %@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v51 = 2112;
        id v52 = v29;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Updating selected video configuration: %@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v51 = 2112;
        id v52 = v34;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Updating selected audio configuration: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v51 = 2112;
      id v52 = v6;
      _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Recording active is disabled: %@", buf, 0x16u);
    }
    [(HMDCameraRecordingSettingsControl *)v41 setCurrentSelectedConfiguration:0];
    v44 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v42 = 2112;
        v43 = v27;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Reading from accessory because can use cached characteristic values is %@, recording active characteristic value is %@, and selected configuration characteristic value is %@", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      uint64_t v41 = v19;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Mandatory recording active characteristic (%@) or selected configuration characteristic (%@) was not found on recording service", buf, 0x20u);
    }
...
void __65__HMDCameraRecordingSettingsControl__readCameraRecordingSettings__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = 2112;
        uint64_t v37 = v4;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Read is recording active: %@", (uint8_t *)&v34, 0x16u);
      }
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = 2112;
        uint64_t v37 = v15;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Read selected general configuration: %@", (uint8_t *)&v34, 0x16u);
      }
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = 2112;
        uint64_t v37 = v20;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Read selected video configuration: %@", (uint8_t *)&v34, 0x16u);
      }
      id v21 = (void *)MEMORY[0x1D9452090]();
      id v22 = *(id *)(a1 + 32);
      long long v23 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = 2112;
        uint64_t v37 = v25;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Read selected audio configuration: %@", (uint8_t *)&v34, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        int v34 = 138543362;
        long long v35 = v31;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to read selected camera recording configuration", (uint8_t *)&v34, 0xCu);
      }
      long long v32 = *(void **)(a1 + 32);
      long long v33 = [MEMORY[0x1E4F28C58] hmErrorWithCode:101];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      int v34 = 138543362;
      long long v35 = v29;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to read is recording active", (uint8_t *)&v34, 0xCu);
    }
    v30 = *(void **)(a1 + 32);
    uint64_t v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:101];
...
- (void)_updateSelectedRecordingConfiguration:(id)a3
{
  ...
  id v6 = (void *)MEMORY[0x1D9452090]([(HMDCameraRecordingSettingsControl *)self setCurrentSelectedConfiguration:v4]);
  id v7 = self;
  id v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    id v12 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate to notify that recording settings are configured", (uint8_t *)&v11, 0xCu);
  }
...
- (void)_writeCameraRecordingSettings
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v11 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuring camera recording settings on primary resident", buf, 0xCu);
    }
...
- (void)reconfigureCameraRecordingSettingsWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Reconfiguring camera recording settings: %@", (uint8_t *)&v10, 0x16u);
  }
...
- (void)configureCameraRecordingSettingsWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      int v15 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Deferring new configure request to be invoked when in-progress configure finishes", (uint8_t *)&v14, 0xCu);
    }
  }
}
...
- (void)configureCameraRecordingSettings
{
  ...
  [(HMDCameraRecordingSettingsControl *)self configureCameraRecordingSettingsWithCompletion:&__block_literal_global_128630];
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating recording settings control and disabling characteristic notifications with client identifier: %@", buf, 0x16u);
  }
...
- (void)enableCharacteristicNotifications
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Enabling notification for characteristics: %@", (uint8_t *)&v12, 0x16u);
  }
...
- (id)_recordingAudioConfiguration
{
  ...
  v60 = (void *)v4;
  p_vtable = &OBJC_METACLASS___HMDCoordinationLocalElectionMeshController.vtable;
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v88 = 2112;
    v89 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Preferred audio parameters: %@", buf, 0x16u);
  ...
  if (v63)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v16 = [p_vtable + 492 audioCodecForCodecConfiguration:v19];

        uint64_t v66 = v17;
        if (v16)
        {
          uint64_t v20 = [p_vtable + 492 audioBitRateForCodecConfiguration:v19];
...
LABEL_19:
                    ...
                    uint64_t v15 = v61;
                    v82 = v61;
                    v53 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v82 count:1];
                    v81 = v51;
                    v54 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v81 count:1];
                    v55 = [v35 bitRate];
                    v56 = [(HMDCameraRecordingAudioCodecParameters *)v52 initWithChannelCount:&unk_1F2DC8D70 bitRateModes:v53 audioSampleRates:v54 maxAudioBitRate:v55];
...
LABEL_27:
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v88 = 2112;
              v89 = v58;
              _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Skipping audio codec configuration %@ preferred audio configuration is not supported", buf, 0x16u);
            }
            uint64_t v15 = v61;
            uint64_t v16 = v62;
            p_vtable = (void **)(&OBJC_METACLASS___HMDCoordinationLocalElectionMeshController + 24);
          }
          else
          {
            v43 = v19;
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v88 = 2112;
              v89 = v43;
              _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Skipping audio codec configuration %@ bit rate mode is not supported", buf, 0x16u);
            }
            uint64_t v15 = 0;
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v88 = 2112;
            v89 = v40;
            _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Skipping audio codec configuration %@ codec type is not supported", buf, 0x16u);
          }
        }
  ...
  if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v87 = v49;
    _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_ERROR, "%{public}@Failed to select audio configuration", buf, 0xCu);
  }
  v50 = 0;
LABEL_44:
...
{
  v2 = [(HMDCameraRecordingSettingsControl *)self recordingService];
  id v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2CE48]];
...
- (id)_recordingVideoConfiguration
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v45;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Video parameters in order of preference: %@", buf, 0x16u);
  }
  *(void *)buf = 0;
  *(void *)&buf[8] = buf;
  *(void *)&buf[16] = 0x3032000000;
  uint64_t v64 = __Block_byref_object_copy__128651;
  v65 = __Block_byref_object_dispose__128652;
  id v66 = 0;
  long long v51 = 0u;
  long long v52 = 0u;
  long long v53 = 0u;
        ...
        if (v15)
        {
          ...
          if (v16)
          {
            ...
            if (v17)
            {
              ...
              uint64_t v57 = v16;
              uint64_t v29 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v57 count:1];
              v56 = v49;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)v58 = 138543618;
              ...
              __int16 v60 = 2112;
              v61 = v14;
              _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Skipping video codec configuration %@, H264 profile is not supported", v58, 0x16u);
            }
            int v11 = 0;
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v58 = 138543618;
            ...
            __int16 v60 = 2112;
            v61 = v14;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Skipping video codec configuration %@, codec type is not supported", v58, 0x16u);
          }
        }
      }
      uint64_t v9 = [obj countByEnumeratingWithState:&v51 objects:v62 count:16];
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)v58 = 138543618;
    ...
    __int16 v60 = 2112;
    v61 = v42;
    _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to select video configuration from supported video configuration: %@", v58, 0x16u);
  }
  uint64_t v17 = 0;
  uint64_t v37 = 0;
LABEL_28:
...
- (id)_preferredAudioConfigurationOverride
{
  ...
  if (v5 && v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v22 = 138543362;
      uint64_t v23 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Overriden audio configuration", (uint8_t *)&v22, 0xCu);
    }
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v5;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Bit rate: %@kbps", (uint8_t *)&v22, 0x16u);
    }
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v7;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Sample rate: %@kHz", (uint8_t *)&v22, 0x16u);
    }
...
- (id)_preferredVideoConfigurationOverride
{
  ...
  if (v5 && v7 && v9 && v11 && v13 && v15)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v55 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Overriden video configuration", buf, 0xCu);
    }
    id v21 = (void *)MEMORY[0x1D9452090]();
    int v22 = v18;
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      uint64_t v57 = v7;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Frame rate: %@fps", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      uint64_t v57 = v51;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Key frame interval: %@ms", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      uint64_t v57 = v9;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Image width: %@px", buf, 0x16u);
    }
    long long v33 = (void *)MEMORY[0x1D9452090]();
    uint64_t v34 = v30;
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      uint64_t v57 = v11;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Image height: %@px", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      uint64_t v57 = v13;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Video bit rate: %@kbps", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      uint64_t v57 = v45;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@H264 Level is: %@", buf, 0x16u);
    }
    ...
    long long v52 = v7;
    long long v53 = v13;
    __int16 v49 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v53 forKeys:&v52 count:1];
    uint64_t v5 = v51;
...
- (id)_recordingGeneralConfiguration
{
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v78 = v49;
      _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_ERROR, "%{public}@Supported prebuffer length is nil", buf, 0xCu);
    }
    v50 = 0;
    goto LABEL_40;
  }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v83 = 2112;
    v84 = v9;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Selecting prebuffer length of %@ because preferred length is %@ and supported length is %@", buf, 0x2Au);
  }
  id v65 = v11;
  id v66 = v9;
  id v67 = v7;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v79 = 2112;
    id v80 = v22;
    _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Selecting event trigger options of %@", buf, 0x16u);
  }
  uint64_t v63 = v17;
...
LABEL_36:
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v78 = v61;
      _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_ERROR, "%{public}@Failed to select general configuration", buf, 0xCu);
    }
    v50 = 0;
    goto LABEL_39;
  }
  ...
  while (1)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v79 = 2112;
      id v80 = v33;
      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Skipping container configuration: %@ unsupported container format", buf, 0x16u);
    }
LABEL_28:
    if (v29 == ++v31)
    {
  ...
  if ([v70 compare:v41] == 1)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v81 = 2112;
      id v82 = v70;
      _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Skipping container configuration: %@, requested fragment length is %@", buf, 0x20u);
  ...
  long long v75 = v54;
  __int16 v56 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v75 count:1];
  uint64_t v57 = v65;
...
void __90__HMDCameraRecordingSettingsControl_handleHomePersonManagerSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) isPrimaryResident])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v6;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@", (uint8_t *)&v9, 0x16u);
    }
    id v7 = *(void **)(a1 + 32);
    id v8 = [*(id *)(a1 + 40) name];
  ...
  if (objc_msgSend(v3, "na_any:", v11))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling %@", buf, 0x16u);
    }
    int v9 = *(void **)(a1 + 40);
...
uint64_t __74__HMDCameraRecordingSettingsControl_handleAccessoryConnectedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    __int16 v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@", (uint8_t *)&v8, 0x16u);
  }
...
uint64_t __77__HMDCameraRecordingSettingsControl_handleAccessoryDisconnectedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    __int16 v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@ by resetting current selected configuration", (uint8_t *)&v8, 0x16u);
  }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v28 = 138543362;
    uint64_t v29 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting camera recording settings control", (uint8_t *)&v28, 0xCu);
  }
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v28 = 138543362;
      uint64_t v29 = v27;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Not starting camera recording settings control because accessory reference is nil", (uint8_t *)&v28, 0xCu);
    }
    goto LABEL_12;
  }
  ...
  uint64_t v15 = [MEMORY[0x1E4F65530] sharedPreferences];
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v30 = 2112;
      uint64_t v31 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Using recording configuration overrides: %@", (uint8_t *)&v28, 0x16u);
    }
LABEL_12:
  }
}
...
- (NSArray)videoConfigurationsByPreferenceOrder
{
  ...
  v40[2] = &unk_1F2DC8C50;
  v41[2] = &unk_1F2DC8C68;
  id v4 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v41 forKeys:v40 count:3];
  v38[0] = &unk_1F2DC8C08;
  v38[1] = &unk_1F2DC8C38;
  v39[0] = &unk_1F2DC8C80;
  v39[1] = &unk_1F2DC8C98;
  v38[2] = &unk_1F2DC8C50;
  v39[2] = &unk_1F2DC8CB0;
  uint64_t v5 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v39 forKeys:v38 count:3];
  id v6 = v4;
  ...
  if (v10)
  {
    ...
    v36[2] = &unk_1F2DC8C50;
    v37[2] = &unk_1F2DC8CE0;
    uint64_t v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v37 forKeys:v36 count:3];
    ...
    v35[1] = &unk_1F2DC8CE0;
    v34[2] = &unk_1F2DC8C50;
    void v35[2] = &unk_1F2DC8CF8;
    uint64_t v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v35 forKeys:v34 count:3];
  }
  uint64_t v31 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:8 bitRateByFrameRate:v5 keyFrameInterval:&unk_1F2DC8C80 h264Level:3];
  __int16 v30 = (void *)v5;
  uint64_t v15 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:17 bitRateByFrameRate:v5 keyFrameInterval:&unk_1F2DC8C80 h264Level:3];
  int v28 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:7 bitRateByFrameRate:v12 keyFrameInterval:&unk_1F2DC8C80 h264Level:2];
  uint64_t v25 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:6 bitRateByFrameRate:v11 keyFrameInterval:&unk_1F2DC8C80 h264Level:0];
  uint64_t v27 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:3 bitRateByFrameRate:v6 keyFrameInterval:&unk_1F2DC8C80 h264Level:1];
  uint64_t v26 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:2 bitRateByFrameRate:v6 keyFrameInterval:&unk_1F2DC8C80 h264Level:0];
  uint64_t v16 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:10 bitRateByFrameRate:v12 keyFrameInterval:&unk_1F2DC8C80 h264Level:2];
  uint64_t v29 = (void *)v11;
  uint64_t v17 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:9 bitRateByFrameRate:v11 keyFrameInterval:&unk_1F2DC8C80 h264Level:0];
  int v18 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:11 bitRateByFrameRate:v12 keyFrameInterval:&unk_1F2DC8C80 h264Level:2];
  id v19 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:12 bitRateByFrameRate:v12 keyFrameInterval:&unk_1F2DC8C80 h264Level:2];
  long long v33 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:13 bitRateByFrameRate:v12 keyFrameInterval:&unk_1F2DC8C80 h264Level:2];
  uint64_t v32 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:14 bitRateByFrameRate:v12 keyFrameInterval:&unk_1F2DC8C80 h264Level:2];
  uint64_t v20 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:15 bitRateByFrameRate:v6 keyFrameInterval:&unk_1F2DC8C80 h264Level:1];
  id v21 = [[HMDCameraRecordingPreferredVideoConfiguration alloc] initWithResolution:16 bitRateByFrameRate:v6 keyFrameInterval:&unk_1F2DC8C80 h264Level:0];
...
- (HMDCameraRecordingSettingsControl)initWithWorkQueue:(id)a3 accessory:(id)a4 recordingManagementService:(id)a5
{
  int v8 = (void *)MEMORY[0x1E4F28EB8];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t78_128781 != -1) {
    dispatch_once(&logCategory__hmf_once_t78_128781, &__block_literal_global_196);
  }
  v2 = (void *)logCategory__hmf_once_v79_128782;
  return v2;
}
...
uint64_t __48__HMDCameraRecordingSettingsControl_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v79_128782;
  logCategory__hmf_once_v79_128782 = v0;
...
void __73__HMDCameraRecordingSettingsControl_audioConfigurationsByPreferenceOrder__block_invoke(uint64_t a1)
{
  ...
  v2 = [[HMDCameraRecordingPreferredAudioConfiguration alloc] initWithSampleRate:3 bitRate:&unk_1F2DC8D10];
  id v3 = [[HMDCameraRecordingPreferredAudioConfiguration alloc] initWithSampleRate:1 bitRate:&unk_1F2DC8D28];
  id v4 = [[HMDCameraRecordingPreferredAudioConfiguration alloc] initWithSampleRate:2 bitRate:&unk_1F2DC8D40];
  id v5 = [[HMDCameraRecordingPreferredAudioConfiguration alloc] initWithSampleRate:4 bitRate:&unk_1F2DC8D10];
  uint64_t v6 = [[HMDCameraRecordingPreferredAudioConfiguration alloc] initWithSampleRate:5 bitRate:&unk_1F2DC8D10];
  v17[0] = v2;
  v17[1] = v5;
  v17[2] = v6;
  v17[3] = v4;
  v17[4] = v3;
  uint64_t v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v17 count:5];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Preferred audio configuration order: %@", (uint8_t *)&v13, 0x16u);
  }
}
