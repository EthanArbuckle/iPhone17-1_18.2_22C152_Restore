...
- (HMDNaturalLightingContext)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        int v16 = 138543362;
        v17 = v14;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode time zone", (uint8_t *)&v16, 0xCu);
      }
      v8 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      v17 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode curve", (uint8_t *)&v16, 0xCu);
    }
    v8 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_180349 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_180349, &__block_literal_global_180350);
  }
  v2 = (void *)logCategory__hmf_once_v4_180351;
  return v2;
}
...
uint64_t __40__HMDNaturalLightingContext_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v4_180351;
  logCategory__hmf_once_v4_180351 = v0;
