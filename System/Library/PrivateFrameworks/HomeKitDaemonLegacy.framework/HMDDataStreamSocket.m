...
- (void)writeData:(id)a3 completion:(id)a4
{
  ...
  {
    id v7 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1061];
    v6[2](v6, v7);
  }
  else
  {
...
- (BOOL)writeData:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    if (a4)
    {
      *a4 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1061];
    }
  }
  else
  {
...
void __39__HMDDataStreamSocket_setTrafficClass___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2048;
    uint64_t v14 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Traffic class changed from %lu -> %lu, notifying protocol", (uint8_t *)&v9, 0x20u);
  }
