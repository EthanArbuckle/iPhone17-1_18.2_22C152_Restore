...
- (NSUUID)messageTargetUUID
{
  return (NSUUID *)[MEMORY[0x1E4F2E638] UUID];
}
...
void __69__HMDAccessorySetupManager_remoteAlertHandle_didInvalidateWithError___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (v7)
    {
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v13;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Alert handle %@ did invalidate: %@", (uint8_t *)&v17, 0x20u);
    }
    ...
    {
      v15 = *(void **)(a1 + 40);
      v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
  ...
  else
  {
    if (v7)
    {
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v10;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Received alert handle did invalidate for unexpected handle %@: %@", (uint8_t *)&v17, 0x20u);
    }
  }
}
...
void __59__HMDAccessorySetupManager_remoteAlertHandleDidDeactivate___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v11;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Alert handle %@ did deactivate. This can happen when screen is turned off by user", (uint8_t *)&v16, 0x16u);
    }
    ...
    if (v12)
    {
      ...
      id v14 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Received alert handle did deactivate for unexpected handle %@", (uint8_t *)&v16, 0x16u);
    }
  }
}
...
- (void)handleNFCProxSetupNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling %@", buf, 0x16u);
  }
  uint64_t v9 = [v4 userInfo];
  uint64_t v10 = [v9 objectForKeyedSubscript:*MEMORY[0x1E4F5BA10]];
  ...
  if (v12)
  {
    uint64_t v13 = [MEMORY[0x1E4F2E630] setupPayloadURLFromSetupPayloadURLString:v12];
    if (v13)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v27 = 2112;
        id v28 = v12;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert URL string to URL: %@", buf, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Prox setup notification did not have expected URL string", buf, 0xCu);
    }
  }
}
...
- (void)_handleFailAccessorySetupMessage:(id)a3
{
  ...
  id v6 = [v4 errorForKey:*MEMORY[0x1E4F2C710]];
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Failing accessory setup with setupError: %@", (uint8_t *)&v15, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v13;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find setup error in message payload: %@", (uint8_t *)&v15, 0x16u);
    }
...
- (void)_handleFinishAccessorySetupMessage:(id)a3
{
  ...
  uint64_t v6 = *MEMORY[0x1E4F2C708];
  v17[0] = objc_opt_class();
  BOOL v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v17 count:1];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    __int16 v16 = v8;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Finishing accessory setup with accessorySetupCompletedInfo: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)_handleResumeAccessorySetupMessage:(id)a3
{
  ...
  uint64_t v6 = [v4 dictionaryForKey:*MEMORY[0x1E4F2C728]];
  if (v6)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find resume accessory setup user info in message payload: %@", buf, 0x16u);
    }
    BOOL v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
...
- (void)_handlePerformAccessorySetupMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v28 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Performing accessory setup", buf, 0xCu);
  }
  uint64_t v10 = *MEMORY[0x1E4F2C718];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v29 = 2112;
        id v30 = v4;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not find proxy connection for message: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Could not find request in message payload: %@", buf, 0x16u);
    }
...
void __64__HMDAccessorySetupManager__handlePerformAccessorySetupMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    uint64_t v13 = *MEMORY[0x1E4F2C720];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform accessory setup: %@", buf, 0x16u);
    }
...
- (id)_accessorySetupResultFromCompletedInfo:(id)a3 clientIdentifierSalt:(id)a4
{
  ...
  __int16 v15 = (void *)[objc_alloc(MEMORY[0x1E4F2E648]) initWithHomeUniqueIdentifier:v11 accessoryUniqueIdentifiers:v14];
  return v15;
}
...
id __88__HMDAccessorySetupManager__accessorySetupResultFromCompletedInfo_clientIdentifierSalt___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v6 = objc_msgSend(MEMORY[0x1E4F29128], "hm_deriveUUIDFromBaseUUID:identifierSalt:", v5, *(void *)(a1 + 32));
...
- (void)_finishAccessorySetupWithSetupCompletedInfo:(id)a3 setupError:(id)a4
{
  ...
  if (v9)
  {
    id v10 = (void *)MEMORY[0x1D9452090]([(HMDAccessorySetupManager *)self setPendingAccessorySetupCompletionHandler:0]);
    uint64_t v11 = self;
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Invalidating remote alert: %@", (uint8_t *)&v21, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      int v21 = 138543362;
      uint64_t v22 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot finish accessory setup because no pending completion handler exists", (uint8_t *)&v21, 0xCu);
    }
  }
}
...
- (void)_launchHUISWithSetupAccessoryDescription:(id)a3 deviceSetupRequest:(id)a4 resumeSetupUserInfo:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v68 = 2112;
    id v69 = v12;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService with setupAccessoryDescription: %@ deviceSetupRequest: %@ resumeSetupUserInfo: %@", (uint8_t *)&v62, 0x2Au);
  }
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      int v62 = 138543362;
      v63 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot launch HomeUIService because it is already active", (uint8_t *)&v62, 0xCu);
    }
    __int16 v27 = (void *)v23;
LABEL_10:
    id v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:15];
    v13[2](v13, 0, v28);
    goto LABEL_31;
  }
  mach_absolute_time();
  ...
  if (v22)
  {
    ...
    double v33 = v30 - v32;
    v34 = (void *)MEMORY[0x1D9452090](v31);
    v35 = v16;
    ...
    if (v33 < 2.0)
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v68 = 2048;
        id v69 = v39;
        _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Not launching HomeUIService because a valid launch was attempted within the last %f seconds. Current time: %f, activationStartTime: %f", (uint8_t *)&v62, 0x2Au);
      }
      __int16 v27 = v34;
      goto LABEL_10;
    }
    if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v70 = 2112;
      v71 = v43;
      _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_INFO, "%{public}@Alert is valid but not active and it has been more than %f seconds. Current time: %f, activationStartTime: %f. Invalidating remote alert: %@", (uint8_t *)&v62, 0x34u);
    }
  ...
  v49 = [v48 createRemoteAlertHandleWithServiceName:*MEMORY[0x1E4F2D748] viewControllerClassName:@"HSProximityCardHostViewController" userInfo:v28];
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Activating remote alert: %@", (uint8_t *)&v62, 0x16u);
  }
  ...
  if (v10)
  {
    v58 = (void *)MEMORY[0x1D9452090](v57);
    v59 = v52;
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v64 = 2112;
      uint64_t v65 = (uint64_t)v10;
      _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_INFO, "%{public}@Updating pending setup accessory description to %@", (uint8_t *)&v62, 0x16u);
    }
...
- (id)_setupRequestBlockingPairedAccessoriesForHome:(id)a3
{
              ...
              for (uint64_t i = 0; i != v19; ++i)
              {
                ...
                if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v55 = 2112;
                  v56 = v27;
                  _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Adding Matter operational identity to device setup request blocking paired accessories: %@", buf, 0x16u);
                }
                id v28 = objc_alloc(MEMORY[0x1E4F311A0]);
  ...
  v34 = (void *)[objc_alloc(MEMORY[0x1E4F31198]) initWithEcosystemName:&stru_1F2C9F1A8 homeNames:v36 blockedDevicePairings:v44];
  return v34;
}
  ...
  if (v13)
  {
    ...
    if (v15)
    {
        ...
        if (!v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v111 = 2112;
            v112 = v92;
            _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find home with unique identifier %@ for client identifier salt: %@", buf, 0x20u);
      ...
      if (v31)
      {
          ...
          && ([v9 isEntitledToProvideMatterSetupPayload] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v108 = v56;
            _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_ERROR, "%{public}@Client provided a matter setup payload but is not entitled to do so", buf, 0xCu);

            id v14 = v55;
          }

          v95 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
        ...
        if (!v34 || v35)
        {
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v109 = 2112;
            id v110 = v35;
            _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed to create Setup Payload from input matter payload with error %@", buf, 0x16u);
          }
          long long v51 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
          v10[2](v10, 0, v51);
        ...
        id v36 = objc_alloc(MEMORY[0x1E4F2EAD0]);
        __int16 v16 = v91;
        v37 = [v91 uuid];
        uint64_t v38 = v36;
        uint64_t v39 = v93;
      ...
      else
      {
        ...
        if (v41)
        {
            ...
            && ([v9 isEntitledToProvideAccessorySetupPayload] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v82, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v108 = v84;
              _os_log_impl(&dword_1D49D5000, v82, OS_LOG_TYPE_ERROR, "%{public}@Client provided an accessory setup payload but is not entitled to do so", buf, 0xCu);

              id v14 = v83;
            }

            v96 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
            ((void (*)(void (**)(id, void, void *), void))v10[2])(v10, 0);
            int v21 = v16;
            id v13 = v92;
          ...
          id v94 = objc_alloc(MEMORY[0x1E4F2EAD0]);
        ...
        {
          id v57 = objc_alloc(MEMORY[0x1E4F2EAD0]);
        ...
        if (!v60)
        {
          ...
          if (os_log_type_enabled(v78, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v111 = 2112;
            v112 = v92;
            _os_log_impl(&dword_1D49D5000, v78, OS_LOG_TYPE_ERROR, "%{public}@Could not find room with unique identifier %@ for client identifier salt: %@", buf, 0x20u);

            id v14 = v90;
          }

          v75 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
          v10[2](v10, 0, v75);
          int v21 = v91;
          v58 = v87;
          goto LABEL_44;
      ...
      if (v63)
      {
        ...
        if (v65 > HMMaxLengthForNaming())
        {
          ...
          if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v108 = v69;
            _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_ERROR, "%{public}@Suggested accessory name is longer than the maximum allowed length", buf, 0xCu);
          }
          __int16 v70 = [MEMORY[0x1E4F28C58] hmErrorWithCode:46];
          v10[2](v10, 0, v70);
          goto LABEL_43;
        }
...
LABEL_46:
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v108 = v30;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@home manager is no longer available", buf, 0xCu);

      id v14 = v29;
    }

    v98 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    ((void (*)(void (**)(id, void, void *), void))v10[2])(v10, 0);
  }
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v109 = 2112;
      id v110 = v14;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot determine client identifier salt for accessory setup client: %@", buf, 0x16u);
    }
    __int16 v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    v10[2](v10, 0, v15);
  }
LABEL_48:
}
...
void __80__HMDAccessorySetupManager__launchHUISWithRequest_connection_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v9 = (void *)MEMORY[0x1D9452090](v7);
    id v10 = *(id *)(a1 + 40);
    uint64_t v11 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform accessory setup: %@", (uint8_t *)&v13, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 56) + 16))();
  }
}
...
- (void)_launchHUISWithNFCProxSetupURL:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v29 = 2112;
    id v30 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService with NFC prox setup URL: %@", buf, 0x16u);
  }
  id v26 = 0;
  ...
  if (v10)
  {
    id v12 = objc_alloc(MEMORY[0x1E4F2EAD0]);
    int v13 = [MEMORY[0x1E4F28B50] mainBundle];
    id v14 = [v13 bundleIdentifier];
    __int16 v15 = (void *)[v12 initWithSetupAccessoryPayload:v10 appID:v14 homeUUID:0 ownershipToken:0];

    id v16 = (void *)MEMORY[0x1D9452090]([v15 setEntitledForHomeKitSPI:1]);
    uint64_t v17 = v7;
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v15;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService with NFC prox setup accessory description: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v31 = 2112;
      id v32 = v11;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate HMSetupAccessoryPayload with url %@: %@", buf, 0x20u);
    }
  }
}
...
void __59__HMDAccessorySetupManager__launchHUISWithNFCProxSetupURL___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully set up accessories with NFC prox setup completed info: %@", (uint8_t *)&v14, 0x16u);
    }
  }
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v13;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up accessories with NFC prox: %@", (uint8_t *)&v14, 0x16u);
  }
}
...
- (id)_createSetupAccessoryPayloadWithSetupPayloadURL:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  if ([MEMORY[0x1E4F2E630] isHAPSetupPayloadURL:v6])
  {
    uint64_t v7 = (void *)[objc_alloc(MEMORY[0x1E4F2EAD8]) initWithHAPSetupPayloadURL:v6 error:a4];
  }
  else if ([MEMORY[0x1E4F2E630] isCHIPSetupPayloadURL:v6])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unsupported URL scheme %@ in setupPayloadURL: %@", (uint8_t *)&v15, 0x20u);
    }
    if (a4)
    {
...
void __120__HMDAccessorySetupManager_launchAccessorySetupHostToPerformMatterDeviceSetupWithRequest_clientProxy_completionHandler___block_invoke(id *a1)
{
  ...
  if (!v7)
  {
    id v11 = (id)[objc_alloc(MEMORY[0x1E4F2EAD0]) initWithAppIdentifier:v4 homeUUID:0];
    goto LABEL_9;
  }
    ...
    || ([a1[4] hasMatterSetupPayloadEntitlement] & 1) != 0)
  {
    ...
    if (v10)
    {
      uint64_t v12 = [objc_alloc(MEMORY[0x1E4F2EAD0]) initWithSetupAccessoryPayload:v10 appID:v4 homeUUID:0 ownershipToken:0];
...
LABEL_9:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      id v41 = v11;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create setup accessory payload from input  %@", buf, 0x16u);
    }
    id v26 = (void (**)(id, void *))a1[7];
    __int16 v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
    v26[2](v26, v27);
  }
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v39 = v31;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Client provided a Matter setup payload but is not entitled to do so", buf, 0xCu);
    }
    id v32 = (void (**)(id, id))a1[7];
    id v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
    v32[2](v32, v11);
  }
LABEL_16:
}
...
void __149__HMDAccessorySetupManager_launchAccessorySetupHostToRequestSetupCodeForAccessoryWithUUID_accessoryName_homeUUID_clientConnection_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v26 = 2112;
    uint64_t v27 = v9;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Launching HomeUIService to request setup code for accessoryUUID: %@ accessoryName: %@ homeUUID: %@ clientConnection: %@", buf, 0x34u);
  }
  id v10 = objc_alloc(MEMORY[0x1E4F2EAD0]);
...
- (void)configure
{
  ...
  uint64_t v4 = *MEMORY[0x1E4F2C730];
  ...
  uint64_t v8 = *MEMORY[0x1E4F2C738];
  ...
  uint64_t v12 = *MEMORY[0x1E4F2C700];
  ...
  uint64_t v16 = *MEMORY[0x1E4F2C6F8];
  ...
  [v19 addObserver:self selector:sel_handleNFCProxSetupNotification_ name:*MEMORY[0x1E4F5BA18] object:0];

  [MEMORY[0x1E4F5BDD8] start];
}
...
- (HMDAccessorySetupManager)initWithWorkQueue:(id)a3 homeManager:(id)a4
{
  ...
  id v9 = objc_alloc(MEMORY[0x1E4F65490]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t48 != -1) {
    dispatch_once(&logCategory__hmf_once_t48, &__block_literal_global_5839);
  }
...
{
  logCategory__hmf_once_long long v49 = HMFCreateOSLogHandle();
  return MEMORY[0x1F41817F8]();
}

+ (NSString)accessorySetupHostBundleIdentifier
{
  return (NSString *)(id)*MEMORY[0x1E4F2D748];
}
