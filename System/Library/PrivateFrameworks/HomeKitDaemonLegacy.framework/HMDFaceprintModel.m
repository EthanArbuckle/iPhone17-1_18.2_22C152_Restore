...
- (id)createFaceprint
{
  ...
  if (v3 && v4)
  {
    id v6 = objc_alloc(MEMORY[0x1E4F2E7D0]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      v19 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot create faceprint from model: %@", (uint8_t *)&v16, 0x16u);
    }
    v9 = 0;
  }
...
- (HMDFaceprintModel)initWithFaceprint:(id)a3
{
  ...
  id v11 = objc_alloc(MEMORY[0x1E4F69EB8]);
  v12 = [v4 faceCropUUID];
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_137511 != -1) {
    dispatch_once(&hmbProperties_onceToken_137511, &__block_literal_global_137512);
  }
  v2 = (void *)hmbProperties_properties_137513;
  return v2;
}
...
void __34__HMDFaceprintModel_hmbProperties__block_invoke()
{
  ...
  id v4 = (void *)hmbProperties_properties_137513;
  hmbProperties_properties_137513 = v3;
}
