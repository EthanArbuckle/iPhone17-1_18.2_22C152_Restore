...
- (id)dumpState
{
  ...
  v9 = __Block_byref_object_copy__176719;
  v10 = __Block_byref_object_dispose__176720;
  id v11 = 0;
  queue = self->_queue;
...
void __48__HMDPrimaryElectionCoordinationAddOn_dumpState__block_invoke(uint64_t a1)
{
  ...
  id v11 = objc_msgSend(v10, "na_map:", &__block_literal_global_120_176726);
  v18[2] = v11;
  v17[3] = @"State";
...
- (id)residentDevicesNotFoundInMesh
{
  if (a1)
  {
    ...
    v10 = (void *)[objc_alloc(MEMORY[0x1E4F1CAD0]) initWithArray:v8];
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      if (v20 > 5) {
        ...
        v21 = off_1E6A17510[v20];
      }
      *(_DWORD *)buf = 138543618;
      *(void *)&buf[4] = v19;
      *(_WORD *)&buf[12] = 2114;
      *(void *)&buf[14] = v21;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Debounce expired, current state = %{public}@", buf, 0x16u);
    }
    if ([(HMDLocalElectionMeshController *)v17->_meshController isLeader])
    {
      ...
      {
        case 0uLL:
          v64 = (HMDPrimaryElectionCoordinationAddOn *)[objc_alloc(MEMORY[0x1E4F65420]) initWithQueue:self->_queue];
          ...
          *(void *)&buf[16] = __101__HMDPrimaryElectionCoordinationAddOn__determineIfPrimaryMeshAfterWaitingForPrimaryResidentDiscovery__block_invoke;
          v118 = (HMDPrimaryElectionCoordinationAddOn *)&unk_1E6A17268;
          v119 = v17;
        ...
        case 4uLL:
          ...
          if (v64 && ([(HMDPrimaryElectionCoordinationAddOn *)v64 hmf_isEmpty] & 1) == 0 && v67)
          {
            ...
            if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&buf[22] = 2114;
              v118 = v64;
              _os_log_impl(&dword_1D49D5000, v73, OS_LOG_TYPE_INFO, "%{public}@Broadcasting the current primary %@ to nodes %{public}@", buf, 0x20u);
            }
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      if (v26 > 5) {
        ...
        v27 = off_1E6A17510[v26];
      }
      *(_DWORD *)buf = 138543618;
      *(void *)&buf[4] = v25;
      *(_WORD *)&buf[12] = 2114;
      *(void *)&buf[14] = v27;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Ping timer fired, current state = %{public}@", buf, 0x16u);
    }
    dispatch_assert_queue_V2((dispatch_queue_t)self->_queue);
      ...
      || [(HMDPrimaryElectionCoordinationAddOn *)v23 state] == 4)
    {
      if (![(HMDLocalElectionMeshController *)v23->_meshController isLeader])
      {
        ...
        if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(void *)&buf[4] = v60;
          _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_INFO, "%{public}@Ping timer expired and we haven't heard from the leader. Sending a ping command to the leader", buf, 0xCu);
        }
        ...
        *(void *)&buf[16] = __68__HMDPrimaryElectionCoordinationAddOn__handlePingTimerExpiredAsNode__block_invoke;
        v118 = (HMDPrimaryElectionCoordinationAddOn *)&unk_1E6A196E0;
        v119 = v58;
        v120 = v62;
        v64 = v62;
...
LABEL_98:
      ...
      if (v49)
      {
        if (v53)
        {
          ...
          *(_WORD *)&buf[22] = 2114;
          v118 = v84;
          _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@We are the leader in state: %{public}@. Sending periodic ping notification to followers with primary resident: %{public}@", buf, 0x20u);
        ...
        if (!v88)
        {
          ...
          if (v95)
          {
            ...
            if (os_log_type_enabled(v98, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              *(void *)&buf[4] = v100;
              _os_log_impl(&dword_1D49D5000, v99, OS_LOG_TYPE_INFO, "%{public}@We are the leader. Sending periodic ping request to the primary resident", buf, 0xCu);
            }
            ...
            {
              uint64_t v104 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:20.0];
            }
            v107 = (void *)v104;
          ...
          else
          {
            if (os_log_type_enabled(v98, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&buf[12] = 2114;
              *(void *)&buf[14] = v106;
              _os_log_impl(&dword_1D49D5000, v99, OS_LOG_TYPE_ERROR, "%{public}@Not sending the ping request. Unable to find the mesh node for primary resident %{public}@", buf, 0x16u);
            }
          }
        ...
        uint64_t v89 = MEMORY[0x1D9452090]();
        v90 = v51;
        ...
        if (os_log_type_enabled(v91, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(void *)&buf[4] = v92;
          _os_log_impl(&dword_1D49D5000, v91, OS_LOG_TYPE_INFO, "%{public}@Not sending the ping request. We are the primary resident.", buf, 0xCu);
        }
        v76 = (void *)v89;
      }
      else
      {
        if (v53)
        {
          ...
          *(_DWORD *)buf = 138543362;
          *(void *)&buf[4] = v75;
          _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Not sending the periodic ping request to the primary and notification to the followers. Primary resident is nil.", buf, 0xCu);
        }
        v76 = v50;
      }
LABEL_97:
...
LABEL_45:
    ...
    uint32_t v66 = 12;
LABEL_67:
    _os_log_impl(&dword_1D49D5000, v65, OS_LOG_TYPE_INFO, v40, buf, v66);
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      if (v32 > 5) {
        ...
        v33 = off_1E6A17510[v32];
      }
      *(_DWORD *)buf = 138543618;
      *(void *)&buf[4] = v31;
      *(_WORD *)&buf[12] = 2114;
      *(void *)&buf[14] = v33;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Secondary mesh timer fired, current state = %{public}@", buf, 0x16u);
    }
    ...
    if (v8 == v4)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        if (v45 > 5) {
          ...
          v46 = off_1E6A17510[v45];
        }
        *(_DWORD *)buf = 138543618;
        *(void *)&buf[4] = v44;
        *(_WORD *)&buf[12] = 2114;
        *(void *)&buf[14] = v46;
        _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_ERROR, "%{public}@Timer fired and the primary resident did not respond to ping request from the leader, current state = %{public}@", buf, 0x16u);
      }
      ...
      if (v9 == v4)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          if (v14 > 5) {
            ...
            uint64_t v15 = off_1E6A17510[v14];
          }
          *(_DWORD *)buf = 138543618;
          *(void *)&buf[4] = v13;
          *(_WORD *)&buf[12] = 2114;
          *(void *)&buf[14] = v15;
          _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Active nodes update timer fired, current state = %{public}@", buf, 0x16u);
        }
        dispatch_assert_queue_V2((dispatch_queue_t)self->_queue);
        ...
        if (v64)
        {
          ...
          if (os_log_type_enabled(v80, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_WORD *)&buf[12] = 2114;
            *(void *)&buf[14] = v68;
            _os_log_impl(&dword_1D49D5000, v80, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate of active mesh nodes: %{public}@", buf, 0x16u);
          }
    ...
    if (v2)
    {
      if ([(dispatch_queue_t *)a1 inPessimisticSecondaryMesh] == 1)
      {
        ...
        if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v29 = v6;
          _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Pessimistic secondary mesh state pinging over IDS", buf, 0xCu);
        }
      ...
      if (v7)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v29 = v21;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@We're not online, restarting ping timer", buf, 0xCu);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v29 = v17;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@No current primary resident, doing meta mesh election", buf, 0xCu);
        }
    ...
    if (result)
    {
      ...
      if (result == 2)
      {
        ...
        if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
        {
          ...
          int v6 = 138543362;
          id v7 = v5;
          _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@The ping request to the primary resident failed. Starting an election", (uint8_t *)&v6, 0xCu);
        }
...
- (id)_meshNodesToResidentDevices
{
  ...
  if (a1)
  {
    ...
    v1 = [MEMORY[0x1E4F1CAD0] setWithArray:v6];
  }
  return v1;
}
...
- (void)_startSecondaryMeshTimer
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v24 = 138543362;
      id v25 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting secondary mesh timer", (uint8_t *)&v24, 0xCu);
    }
    unint64_t v14 = [(dispatch_queue_t *)v11 dataSource];
    uint64_t v15 = v14;
    if (v14)
    {
    ...
    {
      uint64_t v16 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:9 options:300.0];
    }
    v19 = (void *)v16;
  ...
  if (!v4)
  {
    if (v8)
    {
      ...
      int v24 = 138543362;
      id v25 = v17;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Resuming secondary mesh timer", (uint8_t *)&v24, 0xCu);
    }
    v18 = v6;
LABEL_16:
  ...
  if (v8)
  {
    ...
    int v24 = 138543362;
    id v25 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Secondary mesh timer is already running", (uint8_t *)&v24, 0xCu);
  }
}
...
- (id)_retrievePrimaryMeshInformationWithContext:(void *)a3 otherResidents:
{
  ...
  id v13 = (void *)MEMORY[0x1E4F65438];
  unint64_t v14 = [(dispatch_queue_t *)a1 findPrimaryMeshOperation];
  uint64_t v15 = [v13 futureForOperation:v14];
  ...
  v21 = [MEMORY[0x1E4F65550] defaultScheduler];
...
LABEL_26:
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v39 = 2112;
        v40 = v9;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Our mesh info: %@", (uint8_t *)&v37, 0x16u);
      }
      unint64_t v14 = [v3 firstObject];
      ...
      if (v15 && !v16)
      {
        ...
        v19 = v11;
        dispatch_queue_t v20 = HMFGetOSLogHandle();
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
        {
          v21 = HMFGetLogIdentifier();
          int v22 = [v9 reachableIPAccessories];
          int v37 = 138543618;
          unint64_t v38 = v21;
          __int16 v39 = 1024;
          LODWORD(v40) = v22;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@The current primary mesh has 0 reachable IP accessories and we have %d, taking over the primary mesh", (uint8_t *)&v37, 0x12u);
        }
        [v19 setState:2];
      ...
      if (v15 || !v17)
      {
        if (v30)
        {
          ...
          int v37 = 138543362;
          unint64_t v38 = v31;
          v33 = "%{public}@The current primary responded and we are not better than it, staying in secondary mesh and res"
                "tarting ping timer";
          v34 = v29;
          uint32_t v35 = 12;
          goto LABEL_23;
      ...
      {
        v31 = HMFGetLogIdentifier();
        int v32 = [v14 reachableIPAccessories];
        int v37 = 138543618;
        unint64_t v38 = v31;
        __int16 v39 = 1024;
        LODWORD(v40) = v32;
        v33 = "%{public}@The current primary has reachable %d IP accessories (we have 0), staying in secondary mesh and r"
              "estarting ping timer";
        v34 = v29;
        uint32_t v35 = 18;
LABEL_23:
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, v33, (uint8_t *)&v37, v35);
      }
      [v28 setState:4];
      -[HMDPrimaryElectionCoordinationAddOn _startSecondaryMeshTimer]((dispatch_queue_t *)v28);
LABEL_25:
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      int v37 = 138543362;
      unint64_t v38 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Primary resident didn't respond, doing meta mesh election", (uint8_t *)&v37, 0xCu);
    }
    [v24 setState:2];
    -[HMDPrimaryElectionCoordinationAddOn _doMetaMeshElection]((dispatch_queue_t *)v24);
  }
LABEL_27:
...
uint64_t __59__HMDPrimaryElectionCoordinationAddOn__pingPrimaryResident__block_invoke_58(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained && (![v3 isHMError] || objc_msgSend(v3, "code") != 23))
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Ping operation completed with error: %@", (uint8_t *)&v10, 0x16u);
    }
    [v6 setState:4];
...
LABEL_10:
  ...
  if (v6 != a2)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      id v13 = (void *)v12;
      uint64_t v14 = off_1E6A17510[a2];
      if (v8 > 5) {
        uint64_t v15 = @"<unknown state>";
      }
      else {
        uint64_t v15 = off_1E6A17510[v8];
      }
      int v17 = 138544130;
      uint64_t v18 = v12;
      __int16 v19 = 2114;
      ...
      __int16 v23 = 2114;
      id v24 = v5;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Expecting state %{public}@, got %{public}@ - action: %{public}@", (uint8_t *)&v17, 0x2Au);
    }
    goto LABEL_10;
  }
  uint64_t v7 = 1;
...
uint64_t __97__HMDPrimaryElectionCoordinationAddOn__retrievePrimaryMeshInformationWithContext_otherResidents___block_invoke(uint64_t a1, void *a2)
{
        ...
        v6 == v7))
  {
    ...
    unint64_t v8 = (void *)MEMORY[0x1D9452090](v18);
    id v9 = WeakRetained;
...
LABEL_5:
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v19, 0xCu);
    }
  }
    ...
    && -[HMDPrimaryElectionCoordinationAddOn _expectState:action:](WeakRetained, 5, @"pinging primary"))
  {
    ...
    if (v8)
    {
      if ([v3 count])
      {
        ...
        int v22 = +[HMDPrimaryElectionMeshInformation meshInformationWithMeshController:v20 home:v21];
...
LABEL_33:
        ...
        char v23 = objc_msgSend(v3, "na_any:", &__block_literal_global_176801);
          ...
          if (v24)
          {
            if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              uint32_t v33 = 18;
LABEL_30:
              _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, v31, buf, v33);
            }
LABEL_31:
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            uint32_t v40 = 18;
LABEL_37:
            _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_DEFAULT, v38, buf, v40);
...
LABEL_38:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        unint64_t v45 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@No other residents responded to us, becoming primary", buf, 0xCu);
      }
      [v17 setState:2];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        unint64_t v45 = v15;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@We're not online, going to secondary state and resuming pinging", buf, 0xCu);
      }
      [v13 setState:4];
...
void __68__HMDPrimaryElectionCoordinationAddOn__handlePingTimerExpiredAsNode__block_invoke(uint64_t a1, void *a2)
{
  ...
  _os_log_impl(&dword_1D49D5000, v10, v11, v9, (uint8_t *)&v29, v12);
...
LABEL_13:
    uint64_t v25 = (void *)MEMORY[0x1D9452090](v15, v16, v17, v18);
    id v26 = *(id *)(a1 + 32);
    id v27 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      int v29 = 138543362;
      int v30 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Not resuming ping timer", (uint8_t *)&v29, 0xCu);
    }
    goto LABEL_16;
  }
  ...
  uint64_t v20 = (void *)MEMORY[0x1D9452090](v15, v16, v17, v18);
  id v21 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    int v29 = 138543362;
    int v30 = v23;
    _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Resuming ping timer", (uint8_t *)&v29, 0xCu);
  }
...
void __72__HMDPrimaryElectionCoordinationAddOn_sendPingRequestToPrimaryResident___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4 == v5)
  {
    ...
    if (v3)
    {
      id v12 = (void *)MEMORY[0x1D9452090](v11);
      id v13 = *(id *)(a1 + 40);
      uint64_t v14 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v18 = 2112;
        id v19 = v3;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Ping request to the primary resident failed with error: %@.", (uint8_t *)&v16, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v3;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Ignoring the error response to the ping request from the primary resident since the response timer has changed. Error: %@", (uint8_t *)&v16, 0x16u);
    }
  }
}
...
- (void)_determineIfPrimaryMesh
{
  ...
  {
    uint64_t v8 = (void *)MEMORY[0x1D9452090]([(dispatch_queue_t *)a1 setState:1]);
    uint64_t v9 = a1;
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v31 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Determining if we're in the primary mesh", buf, 0xCu);
    }
    id v12 = [v9 context];
    if (v12)
    {
...
LABEL_18:
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    if (v6 > 5) {
      ...
      uint64_t v7 = off_1E6A17510[v6];
    }
    *(_DWORD *)buf = 138543618;
    uint64_t v31 = v5;
    __int16 v32 = 2112;
    uint64_t v33 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Not determining if we are in the primary mesh due to current state: %@", buf, 0x16u);
  }
}
  ...
  if (-[HMDPrimaryElectionCoordinationAddOn _expectState:action:](*(void **)(a1 + 32), 1, @"aborting determining primary mesh"))
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v20 = 2114;
        id v21 = v4;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unknown resident %{public}@", (uint8_t *)&v18, 0x16u);
      }
    }
    unint64_t v6 = 0;
LABEL_10:
    ...
    if ([v11 count])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v20 = 2114;
        id v21 = v11;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Found other residents that could be in a primary mesh, checking if they are: %{public}@", (uint8_t *)&v18, 0x16u);
      }
      if (v6) {
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2114;
        id v47 = v5;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Requesting election parameters from candidates: %{public}@", buf, 0x16u);
      }
      long long v41 = 0u;
      long long v42 = 0u;
      long long v39 = 0u;
        ...
        do
        {
          for (uint64_t i = 0; i != v13; ++i)
          {
            ...
            if ([v16 isCurrentDevice])
            {
              ...
              id v19 = [MEMORY[0x1E4F65438] futureWithValue:v17];
              [v7 addObject:v19];
            }
            else
            {
      ...
      id v28 = (void *)MEMORY[0x1E4F65438];
      id v29 = (void *)[v7 copy];
...
uint64_t __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    id v6 = (void *)MEMORY[0x1D9452090]([v4 setResidentDevice:*(void *)(a1 + 32)]);
    id v7 = *(id *)(a1 + 40);
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v5;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Adding election candidate %{public}@: %@", (uint8_t *)&v22, 0x20u);
    }
    v5;
    uint64_t v12 = 1;
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v3;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Candidate %@ responded with invalid payload: %@", (uint8_t *)&v22, 0x20u);
    }
...
uint64_t __98__HMDPrimaryElectionCoordinationAddOn__requestElectionParametersFromCandidates_completionHandler___block_invoke_86(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Candidate %@ responded with error: %@", (uint8_t *)&v13, 0x20u);
  }
  id v9 = v3;
  uint64_t v10 = v9;
  if (v9)
...
{
  objc_msgSend(*(id *)(a1 + 32), "na_filter:", &__block_literal_global_89_176836);
...
- (id)_consensusPrimaryFromResidentCandidates:(uint64_t)a1
{
  if (a1)
  {
    id v2 = (void *)MEMORY[0x1E4F28BD0];
    id v3 = objc_msgSend(a2, "na_map:", &__block_literal_global_77_176980);
  ...
  if (!v9)
  {
    ...
    if (!v16)
    {
      if (v18)
      {
        ...
        int v21 = 138543362;
        int v22 = v19;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@We are not the current primary and it isn't in our mesh", (uint8_t *)&v21, 0xCu);
      }
      uint64_t v13 = 0;
      goto LABEL_13;
    }
...
- (uint64_t)_maybeNotifyDelegateUpdatedPrimary:(void *)a3 currentPrimary:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Selected primary is current primary: %@", (uint8_t *)&v16, 0x16u);
    }
  }
  uint64_t v13 = 0;
LABEL_8:
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v63 = 2114;
      v64 = v18;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Sorted primary candidates: %{public}@", buf, 0x16u);
    }
    ...
    if ((unint64_t)[(__CFString *)v18 count] >= 2)
    {
      ...
      SEL v25 = (void *)MEMORY[0x1D9452090]([v23 compare:v24 currentPrimary:v59 outCriteria:&v60]);
      __int16 v26 = v20;
      id v27 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v63 = 2114;
        v64 = v30;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@The primary resident was chosen because of: %{public}@", buf, 0x16u);
    ...
    if ([v20[1] isLeader])
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v62 = v45;
        _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_DEBUG, "%{public}@Checking for split network", buf, 0xCu);
      }
      ...
      if ([(__CFString *)v46 count])
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v63 = 2114;
          v64 = v46;
          _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_DEFAULT, "%{public}@Expected resident devices not found in mesh, we have a split network: %{public}@", buf, 0x16u);
        }
      }
    }
    id v11 = v18;
  ...
  if (a1)
  {
    ...
    if ([*(id *)(a1 + 8) isProcessing])
    {
      ...
      if (v2)
      {
        if (v6)
        {
          ...
          int v25 = 138543362;
          __int16 v26 = v7;
          _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting ping timer as a leader", (uint8_t *)&v25, 0xCu);
        }
        double v8 = 60.0;
        uint64_t v9 = 5;
      }
      else
      {
        if (v6)
        {
          ...
          int v25 = 138543362;
          __int16 v26 = v15;
          _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting ping timer as a node", (uint8_t *)&v25, 0xCu);
        }
        uint64_t v9 = 0;
      ...
      {
        uint64_t v19 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:v9 options:v8];
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v27 = 2114;
        uint64_t v28 = v14;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Not starting ping timer in state %{public}@", (uint8_t *)&v25, 0x16u);
      }
    }
  }
}
...
- (void)meshControllerDidUpdatesNodes:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v34 = 138543362;
    uint64_t v35 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Mesh nodes updated", (uint8_t *)&v34, 0xCu);
  }
  ...
  {
    uint64_t v16 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:5.0];
  }
  ...
  if (([(HMDPrimaryElectionCoordinationAddOn *)v6 state] & 0xFFFFFFFFFFFFFFFELL) == 4)
  {
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        int v34 = 138543362;
        uint64_t v35 = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Primary resident is in our mesh", (uint8_t *)&v34, 0xCu);
      }
...
LABEL_9:
          _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, v6, v8, 0xCu);
        }
      }
...
- (uint64_t)_currentStateRequiresElection
{
  ...
  if (v3 && (v10 | [(id)a1 electionGotAborted]) != 1)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v41 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@We don't need an election now. No major changes since the last election", buf, 0xCu);
    }
    uint64_t v21 = 0;
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v46 = 2112;
      id v47 = v17;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@We need an election, leader changed: %@, nodes changed: %@, previous election aborted: %@", buf, 0x2Au);
    }
    uint64_t v18 = 4;
...
- (void)_stopSecondaryMeshTimer
{
  ...
  if (a1)
  {
    ...
    if (v2)
    {
      dispatch_queue_t v3 = (void *)MEMORY[0x1D9452090]();
      uint64_t v4 = a1;
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
      {
        ...
        int v8 = 138543362;
        id v9 = v6;
        _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping secondary mesh timer", (uint8_t *)&v8, 0xCu);
      }
...
- (id)_createDebounceTimerWithInterval:(void *)a1
{
  if (a1)
  {
    ...
    {
      uint64_t v5 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:a2];
    }
    double v6 = (void *)v5;
  }
  else
...
- (void)meshControllerDidElectLeader:(id)a3
{
  ...
  if ([v4 isLeader])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (v12 > 5) {
        ...
        id v13 = off_1E6A17510[v12];
      }
      int v25 = 138543618;
      __int16 v26 = v11;
      __int16 v27 = 2114;
      uint64_t v28 = v13;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@We are now the mesh leader in state: %{public}@", (uint8_t *)&v25, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v14;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Other device elected mesh leader: %@", (uint8_t *)&v25, 0x16u);
    }
...
- (void)meshControllerDidStartElection:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    unint64_t v12 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Election started, suspending ping timer", (uint8_t *)&v11, 0xCu);
  }
...
- (void)meshController:(id)a3 didReceivePingFromLeaderWithPrimaryResidentUUID:(id)a4
{
  id v4 = [(HMDPrimaryElectionCoordinationAddOn *)self pingTimer];
  [v4 kick];
}
...
- (void)handleSetPreferredPrimaryDebugRequest:(id)a3
{
  ...
  double v6 = objc_msgSend(v5, "hmf_stringForKey:", @"preferred.primary.identifier");
  ...
  if (v6)
  {
    if (v14)
    {
      ...
      __int16 v45 = 2112;
      __int16 v46 = v16;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received SetPreferredPrimaryDebugRequest with primary: %@ ...isOneTime: %@", (uint8_t *)&v41, 0x20u);
    }
    id v17 = v6;
    uint64_t v18 = (void *)MEMORY[0x1D9452090](@"hmd.preferred.primary.homeutil");
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v46 = v25;
      __int16 v47 = 2112;
      uint64_t v48 = @"hmd.preferred.primary.homeutil";
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Setting preferred primary: %@, isOneTime: %@, applicationKey: %@", (uint8_t *)&v41, 0x2Au);
    ...
    if (v8) {
      __int16 v26 = (const void *)MEMORY[0x1E4F1CC38];
    }
    else {
      __int16 v26 = (const void *)MEMORY[0x1E4F1CC28];
    }
...
LABEL_14:
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v41 = 138543362;
      __int16 v42 = v32;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@SetPreferredPrimary - Triggering resident election", (uint8_t *)&v41, 0xCu);
    }
    if ([v30[1] isLeader])
    {
      uint64_t v33 = [v30 state];
      ...
      if (v33 == 2)
      {
        if (v37)
        {
          ...
          int v41 = 138543362;
          __int16 v42 = v38;
          _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Handling force resident election request: This device is the leader. Starting election.", (uint8_t *)&v41, 0xCu);
        }
      ...
      if (v37)
      {
        ...
        int v41 = 138543362;
        __int16 v42 = v39;
        long long v40 = "%{public}@Handling force resident election request: This device is not in the primary mesh. Discarding message.";
        goto LABEL_25;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v41 = 138543362;
        __int16 v42 = v39;
        long long v40 = "%{public}@Handling force resident election request: This device is not the leader. Discarding message.";
LABEL_25:
        _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_DEFAULT, v40, (uint8_t *)&v41, 0xCu);
      }
    }
  ...
  if (v14)
  {
    ...
    __int16 v43 = 2112;
    id v44 = v28;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received SetPreferredPrimaryDebugRequest with nil primary, requireOneTime: %@", (uint8_t *)&v41, 0x16u);
  }
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        __int16 v19 = 2112;
        uint64_t v20 = v9;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling mesh information request and responding with: %@", (uint8_t *)&v17, 0x16u);
      }
    ...
    else
    {
      if (v13)
      {
        ...
        int v17 = 138543362;
        uint64_t v18 = v16;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling mesh information request and responding with error", (uint8_t *)&v17, 0xCu);
      }
...
- (void)handleCurrentPrimaryNotification:(id)a3
{
  ...
  if (v5)
  {
    double v6 = [v4 messagePayload];
    int v7 = objc_msgSend(v6, "hmf_UUIDForKey:", @"uuid");
    ...
    if (v7)
    {
            ...
            (v11 & 1) == 0))
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          uint64_t v52 = v20;
          __int16 v26 = v25 = v8;
          __int16 v27 = [v26 shortDescription];
          *(_DWORD *)buf = 138543874;
          unint64_t v55 = v23;
          __int16 v56 = 2114;
          v57 = v24;
          __int16 v58 = 2114;
          v59 = v27;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received a current primary update from an unexpected device: Leader: %{public}@, Source: %{public}@", buf, 0x20u);
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v56 = 2114;
            v57 = v7;
            _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to map %{public}@ to known resident", buf, 0x16u);
        ...
        char v35 = [v34 identifier];
        int v36 = [v35 isEqual:v7];

        BOOL v37 = (void *)MEMORY[0x1D9452090]();
        uint64_t v38 = self;
        ...
        if (v36)
        {
          if (v40)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v56 = 2112;
            v57 = v42;
            _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Broadcasted primary is current primary: %@", buf, 0x16u);
        ...
        else
        {
          if (v40)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v56 = 2112;
            v57 = v13;
            _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Received update for current primary: %@", buf, 0x16u);
          ...
          if (v13)
          {
            __int16 v45 = [(HMDPrimaryElectionCoordinationAddOn *)v38 delegate];
            [v45 primaryElectionAddOn:v38 didElectPrimaryResident:v13 confirmed:1 electionLogEvent:0];
          }
        }
        uint64_t v46 = v36 ^ 1u;
        __int16 v47 = [v5 currentResidentDevice];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        unint64_t v55 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Message did not contain a primary resident value", buf, 0xCu);
      }
    }
  }
}
...
- (void)handleCurrentPrimaryRequest:(id)a3
{
  ...
  if (([(HMDLocalElectionMeshController *)self->_meshController isLeader] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v33 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Not responding to current primary request because we're not the leader", buf, 0xCu);
    }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v33 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Not responding to current primary request because we are debouncing an election", buf, 0xCu);
    }
    char v11 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v12 = 15;
LABEL_9:
  ...
  uint64_t v18 = [(HMDPrimaryElectionCoordinationAddOn *)self context];
  ...
  if (v17)
  {
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v36 = 2114;
      BOOL v37 = v25;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Responding to current primary request from: %{public}@ with: %{public}@", buf, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v33 = v29;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not responding to current primary request because our primary resident is nil", buf, 0xCu);
    }
...
- (void)handleDeviceCapabilitiesRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received capabilities request from: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)_selectPrimaryResidentWithReason:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    BOOL v40 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Electing a primary resident", buf, 0xCu);
  }
  if (a3 == 7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      BOOL v40 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Calling _selectPrimaryResidentFromCandidates due to forced primary election from debug/tools", buf, 0xCu);
    }
  }
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      BOOL v40 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Debounce timer active, deferring election", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (v20)
    {
      ...
      int v23 = [(HMDLocalElectionMeshController *)v6->_meshController meshNodes];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        BOOL v40 = v33;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@No current resident device, bailing", buf, 0xCu);
      }
    }
  }
}
...
void __71__HMDPrimaryElectionCoordinationAddOn_selectPrimaryResidentWithReason___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v8 = 138543362;
      uint64_t v9 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Not running primary resident election because this device is not the leader", (uint8_t *)&v8, 0xCu);
    }
  }
}
...
- (void)_findPrimaryMeshWithContext:(id)a3 otherResidents:(id)a4
{
  id v5 = a3;
  dispatch_assert_queue_V2((dispatch_queue_t)self->_queue);
  int v6 = (void *)[objc_alloc(MEMORY[0x1E4F65420]) initWithQueue:self->_queue];
  int v7 = [v5 cloudReady];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  ...
  if (-[HMDPrimaryElectionCoordinationAddOn _expectState:action:](*(void **)(a1 + 32), 1, @"deciding if we're in primary mesh"))
  {
    ...
    if (v4)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          int v14 = 138543362;
          __int16 v15 = v12;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Pinging primary resident", (uint8_t *)&v14, 0xCu);
        }
        [*(id *)(a1 + 32) setState:4];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        __int16 v15 = v8;
        _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@No primary resident after cloud ready, doing a meta mesh election", (uint8_t *)&v14, 0xCu);
      }
      [*(id *)(a1 + 32) setState:2];
  ...
  if (state != a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (state > 5) {
        ...
        id v11 = off_1E6A17510[state];
      }
      if (a3 > 5) {
        uint64_t v12 = @"<unknown state>";
      }
      else {
        uint64_t v12 = off_1E6A17510[a3];
      }
      ...
      *(void *)&v21[14] = v11;
      __int16 v22 = 2114;
      int v23 = v12;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Transitioning state from %{public}@ -> %{public}@", v21, 0x20u);
    }
...
LABEL_21:
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, v19, v21, 0xCu);
      }
    }
...
void __85__HMDPrimaryElectionCoordinationAddOn_primaryResidentChanged_previousResidentDevice___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v24 = 2112;
        int v25 = v10;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling new primary resident: %@", (uint8_t *)&v22, 0x16u);
      }
        ...
        if ([*(id *)(*(void *)(a1 + 40) + 8) isLeader])
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            if (v16 > 5) {
              ...
              uint64_t v17 = off_1E6A17510[v16];
            }
            int v22 = 138543618;
            int v23 = v15;
            __int16 v24 = 2112;
            int v25 = v17;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Received a primary resident change while we are the leader in state: %@.", (uint8_t *)&v22, 0x16u);
          }
  ...
  else if ([v2[1] isLeader] && objc_msgSend(*(id *)(a1 + 40), "state") == 2)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      int v22 = 138543362;
      int v23 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Primary resident was set to nil, calling an election", (uint8_t *)&v22, 0xCu);
    }
...
- (void)performElection
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2048;
      uint64_t v23 = 0;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Rapportd might have died (%lu -> %lu visible devices)", (uint8_t *)&v18, 0x20u);
    }
    ...
    if (v11)
    {
      if (v15)
      {
        ...
        int v18 = 138543362;
        id v19 = v16;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@We are the current primary resident, using the cautious debounce timeout", (uint8_t *)&v18, 0xCu);
      }
    ...
    else
    {
      if (v15)
      {
        ...
        int v18 = 138543362;
        id v19 = v17;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@We are not the current primary, going to pessimistic secondary mesh state", (uint8_t *)&v18, 0xCu);
      }
...
- (void)stop
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2114;
    id v13 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping mesh controller with type: %{public}@", (uint8_t *)&v10, 0x16u);
  }
  id v8 = [(HMDPrimaryElectionCoordinationAddOn *)v4 debounceTimer];
  [v8 suspend];
...
- (void)start
{
  ...
  BOOL v5 = [v4 home];
  id v6 = [v5 uuid];
  id v7 = [v3 stringWithFormat:@"%@.%@", @"com.apple.HomeKit", v6];
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v17 = 2114;
    int v18 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Starting mesh controller with type: %{public}@, name: %{public}@", buf, 0x20u);
  }
...
- (void)registerForMessages
{
  ...
  id v7 = (void *)[v6 copy];
  id v8 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:3 remoteAccessRequired:0];
  v20[0] = v7;
  v20[1] = v8;
  ...
  v19[0] = v7;
  v19[1] = v8;
  int v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v19 count:2];
  ...
  if (isInternalBuild())
  {
    v17[0] = v7;
    v17[1] = v8;
    __int16 v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v17 count:2];
  ...
  v16[0] = v14;
  v16[1] = v8;
  __int16 v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:v16 count:2];
...
- (HMDPrimaryElectionCoordinationAddOn)initWithContext:(id)a3 meshController:(id)a4 dataSource:(id)a5
{
  ...
  *((void *)v11 + 2) = v12;
  ...
  uint64_t v14 = [objc_alloc(MEMORY[0x1E4F65420]) initWithQueue:*((void *)v11 + 2)];
  ...
  *((void *)v11 + 22) = v29;
  ...
  v11[24] = 0;
  *(_OWORD *)(v11 + 152) = xmmword_1D54D3750;
...
+ (id)logCategory
{
  ...
  uint64_t v2 = (void *)logCategory__hmf_once_v120;
  return v2;
}
...
uint64_t __50__HMDPrimaryElectionCoordinationAddOn_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v120;
