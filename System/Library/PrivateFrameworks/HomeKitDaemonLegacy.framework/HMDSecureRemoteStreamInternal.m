...
- (void)_serverCompletePrepareRequest:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v4;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing prepare request, tid %@", (uint8_t *)&v13, 0x16u);
    }
  }
}
...
- (int)_serverHandleCommitRequest:(id)a3 options:(id)a4 responseHandler:(id)a5
{
  ...
  [v10 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:@"processing"];
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Received commit request, utid %@ %@", buf, 0x20u);
  }
  v18 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:*(void *)&v52];
...
LABEL_13:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v73 = 2112;
    double v74 = v52;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Starting commit response timeout of %.03f seconds for transaction: %@", buf, 0x20u);
  }
  dispatch_source_t v26 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)v22->_internalQueue);
  if (v26)
  {
    v27 = v26;
    ...
    dispatch_source_set_cancel_handler(v27, &__block_literal_global_131_182601);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    v68 = v41;
    v42 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", &v68, &v67, 1, v44, context);
    double v43 = [v38 errorWithDomain:*MEMORY[0x1E4F28760] code:v34 userInfo:v42];
    *(_DWORD *)buf = 138543874;
    v70 = v45;
    __int16 v71 = 2112;
    double v72 = v43;
    __int16 v73 = 2112;
    double v74 = *(double *)&v49;
    _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Commit failed: %@ %@", buf, 0x20u);
  }
LABEL_17:
  ...
  if (!*(unsigned char *)(*(void *)(*(void *)(a1 + 72) + 8) + 24))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      uint64_t v29 = v6;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Transaction, %@, timed out, sending cancelled error", buf, 0x16u);
    }
    ...
    uint64_t v10 = objc_msgSend(NSString, "stringWithUTF8String:", DebugGetErrorString(), *MEMORY[0x1E4F28568]);
    v11 = (void *)v10;
    char v12 = @"?";
    if (v10) {
  ...
  if (*(unsigned char *)(*(void *)(*(void *)(a1 + 64) + 8) + 24))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Transaction, %@, has already been completed", buf, 0x16u);
    }
  }
  else
  {
    ...
    v32[0] = v7;
    v32[1] = v15;
    id v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v32 forKeys:v31 count:2];
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v29 = 2112;
      id v30 = v7;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEBUG, "%{public}@sending commit response, utid %@ %@", buf, 0x20u);
...
LABEL_9:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v38 = 2112;
    id v39 = v8;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Received prepare request, utid %@ %@", buf, 0x20u);
  }
  uint64_t v17 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v11];
  logRemoteMessageEvent(v12, v9, v17);

  dispatch_source_t v18 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)v14->_internalQueue);
  if (v18)
  {
    v19 = v18;
    handler[0] = MEMORY[0x1E4F143A8];
    ...
    handler[3] = &unk_1E6A197C8;
    handler[4] = v14;
    id v20 = v11;
    id v33 = v20;
    dispatch_source_set_event_handler(v19, handler);

    dispatch_source_set_cancel_handler(v19, &__block_literal_global_124_182638);
...
void __85__HMDSecureRemoteStreamInternal__serverHandlePrepareRequest_options_responseHandler___block_invoke_3(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Sending prepare response options %@, utid %@", (uint8_t *)&v9, 0x20u);
  }
  (*(void (**)(void))(*(void *)(a1 + 64) + 16))();
}
...
LABEL_25:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v51 = 2112;
    id v52 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Received request, tid %@ %@", buf, 0x20u);
  }
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    else
    {
      id v13 = v13;
      [v13 bytes];
      id v16 = [MEMORY[0x1E4F1CA58] dataWithLength:v15];
      if (v16)
      {
        id v42 = v16;
        [v42 mutableBytes];
        ...
        else
        {
          ...
          while (!v23);
          id v20 = [MEMORY[0x1E4F28F98] propertyListWithData:v42 options:0 format:0 error:0];
          if (v20)
          {
...
LABEL_18:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v46 = v32;
    id v33 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", &v46, &v45, 1, v36);
    uint64_t v34 = v29;
    id v6 = v28;
    id v20 = v39;
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v51 = 2112;
    id v52 = v6;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Request failed: %@, %@", buf, 0x20u);
...
LABEL_29:
    dispatch_time_t v32 = (void *)MEMORY[0x1D9452090]();
    id v33 = *(id *)(a1 + 32);
    uint64_t v34 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
    {
      v35 = HMFGetLogIdentifier();
      double v43 = (void *)MEMORY[0x1E4F28C58];
      ...
      __int16 v51 = v38;
      [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v51 forKeys:&v50 count:1];
      id v44 = v32;
      v40 = id v39 = v8;
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v56 = 2112;
      id v57 = v46;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Response failed: %@, %@", buf, 0x20u);
  ...
  id v12 = 0;
LABEL_9:
  unint64_t v14 = [MEMORY[0x1E4F1CA58] dataWithLength:v13 + 16];
  if (!v14)
  {
  ...
  v58[3] = @"type";
  v59[3] = @"response";
  v22 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v59 forKeys:v58 count:4];
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v56 = 2112;
    id v57 = v22;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Sending response, tid %@ %@", buf, 0x20u);
  }
...
- (id)_encodeBinaryPlist:(void *)a1
{
  ...
  {
    id v11 = 0;
    uint64_t v4 = [MEMORY[0x1E4F28F98] dataWithPropertyList:v3 format:200 options:0 error:&v11];
    id v5 = v11;
    if (!v4)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v14 = 2112;
        id v15 = v5;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode payload as binary PList: %@", buf, 0x16u);
      }
    }
  }
  else
...
LABEL_8:
  ...
  *((void *)&v48 + 1) = _pairingCopyIdentity;
  ...
  if (isKindOfClass)
  {
    ...
    id v22 = 0;
LABEL_20:
    BOOL v23 = (void *)MEMORY[0x1D9452090](isKindOfClass);
    id v24 = self;
    v25 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      id v33 = HMFGetLogIdentifier();
      dispatch_source_t v26 = (void *)MEMORY[0x1E4F28C58];
      id v34 = v7;
      ...
      *(void *)&long long v48 = v36;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Pair-verify failed: %@, %@", buf, 0x20u);
...
LABEL_9:
  ...
  {
    v45[0] = @"data";
    id v15 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v42 length:v41];
    v46[0] = v15;
    v46[1] = @"pv";
    v45[1] = @"op";
    v45[2] = @"sid";
    ...
    v45[4] = @"type";
    v46[4] = @"response";
    uint64_t v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v46 forKeys:v45 count:5];
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v16;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Sending pair-verify response %@", buf, 0x16u);
    }
...
LABEL_14:
        ...
        return;
      default:
        int v9 = (void *)MEMORY[0x1D9452090](self, a2);
        uint64_t v10 = self;
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v22 = 1024;
          int v23 = state;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Bad state: %d", buf, 0x12u);
        }
...
- (int)_clientHandleCommitResponse:(id)a3 options:(id)a4
{
  ...
  [v8 bytes];
  uint64_t v11 = [MEMORY[0x1E4F1CA58] dataWithLength:v10];
  if (!v11)
  {
    id v12 = 0;
    uint64_t v16 = 0;
  ...
  while (!v21);
  __int16 v22 = [MEMORY[0x1E4F28F98] propertyListWithData:v12 options:0 format:0 error:0];
  uint64_t v16 = v22;
  if (!v22)
  {
    uint64_t v17 = 0;
...
LABEL_24:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v34 = 2112;
    v35 = v16;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Received commit response, utid %@ %@", buf, 0x20u);
  }
  id v7 = v29;
  [(HMDSecureRemoteStreamInternal *)v24 _completeUserTransaction:v18 response:v17 options:v29 status:0];
  uint64_t v27 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v18];
...
- (int)_clientSendCommitRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    v53[2] = @"timeout";
    v54[2] = v6;
    id v7 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v54 forKeys:v53 count:3];
    id v8 = -[HMDSecureRemoteStreamInternal _encodeBinaryPlist:](self, v7);
    id v9 = v8;
    if (v8)
    {
      uint64_t v10 = [v8 length];
      uint64_t v11 = [MEMORY[0x1E4F1CA58] dataWithLength:v10 + 16];
      if (v11)
      {
        id v40 = v6;
        id v12 = v11;
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v51 = 2112;
          id v52 = v7;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Sending commit request, utid %@ %@", buf, 0x20u);
        }
        uint64_t v45 = @"edata";
        id v46 = v12;
        __int16 v22 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v46 forKeys:&v45 count:1];
  ...
  dispatch_source_t v26 = (void *)MEMORY[0x1D9452090]();
  uint64_t v27 = self;
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2112;
    long long v50 = v34;
    _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Send commit request failed: %@", buf, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    uint64_t v18 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", &v26, &v25, 1, v20);
    uint64_t v19 = [v23 errorWithDomain:v21 code:(int)v11 userInfo:v18];
    *(_DWORD *)buf = 138543618;
    uint64_t v28 = v22;
    __int16 v29 = 2112;
    id v30 = v19;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Commit response failed: %@", buf, 0x16u);
...
- (int)_clientHandlePrepareResponse:(id)a3 options:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v25 = 138543362;
      dispatch_source_t v26 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Received prepare response", (uint8_t *)&v25, 0xCu);
    }
...
LABEL_17:
  ...
  if (v9)
  {
    ...
    id v12 = [MEMORY[0x1E4F1CA58] dataWithLength:v11 + 16];
    if (v12)
    {
      id v13 = v12;
      [v13 mutableBytes];
      ...
      while (!v18);
      uint64_t v19 = (void *)MEMORY[0x1D9452090](v15);
      uint64_t v20 = self;
      uint64_t v21 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v50 = 2112;
        __int16 v51 = v8;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Sending prepare request, utid %@ %@", buf, 0x20u);
      }
      id v44 = @"edata";
      id v45 = v13;
      int v23 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v45 forKeys:&v44 count:1];
...
LABEL_20:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v48 = 2112;
    __int16 v49 = v34;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Send prepare request failed: %@", buf, 0x16u);
...
LABEL_7:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    dispatch_source_t v26 = v17;
    BOOL v18 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", &v26, &v25, 1, v20);
    uint64_t v19 = [v23 errorWithDomain:v21 code:(int)v11 userInfo:v18];
    *(_DWORD *)buf = 138543618;
    uint64_t v28 = v22;
    __int16 v29 = 2112;
    uint64_t v30 = v19;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Prepare response failed: %@", buf, 0x16u);
...
- (int)_clientPairVerifyExchange:(id)a3
{
  ...
  if (!v6)
  {
    ...
    {
      v29[0] = @"data";
      id v7 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v26 length:v25];
      v29[1] = @"op";
      v30[0] = v7;
      v30[1] = @"pv";
      id v8 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v30 forKeys:v29 count:2];
...
LABEL_10:
  ...
  if (v6)
  {
    ...
    {
      id v13 = HMFGetLogIdentifier();
      uint64_t v22 = MEMORY[0x1E4F28C58];
      ...
      uint64_t v28 = v17;
      objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", &v28, &v27, 1, v22);
      v19 = id v18 = v4;
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v20;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Pair-verify failed: %@", buf, 0x16u);
...
void __59__HMDSecureRemoteStreamInternal__clientPairVerifyExchange___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v31 = 2112;
    long long v32 = v21;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Pair-verify response failed: %@", buf, 0x16u);
      ...
      default:
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v15 = 1024;
          int v16 = state;
          _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Bad state: %d", buf, 0x12u);
        }
...
- (void)_transportReceivedMessage:(id)a3 options:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v41 = 2112;
    id v42 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Transport received message %@", buf, 0x16u);
  }
  if (!v9->_started)
  {
    uint64_t v14 = 0;
  ...
  else if ([v14 isEqual:@"response"])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v43 = 2112;
      id v44 = v6;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Received response, tid %@, %@", buf, 0x20u);
...
LABEL_19:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v38 = v28;
    __int16 v29 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v38 forKeys:&v37 count:1];
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    id v44 = v6;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Transport message error: %@, %@", buf, 0x20u);
  ...
  if (v13)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      if (a6)
      {
        ...
        uint64_t v40 = *MEMORY[0x1E4F28760];
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v60 = 2112;
      id v61 = v26;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Completed request, tid %@, status %@\n%@", buf, 0x2Au);
      if (a6)
      {
      }
      uint64_t v11 = v46;
    ...
    if (v29)
    {
      ...
      if (a6)
      {
        ...
        __int16 v51 = v37;
        __int16 v38 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v51 forKeys:&v50 count:1];
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      id v57 = v10;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Missing, tid %@", buf, 0x16u);
...
- (void)_sendRequest:(id)a3 options:(id)a4 responseHandler:(id)a5
{
  ...
  dispatch_source_t v12 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_internalQueue);
  if (v12)
  {
    id v13 = v12;
    handler[0] = MEMORY[0x1E4F143A8];
    ...
    dispatch_source_set_cancel_handler(v13, &__block_literal_global_80_182711);
    ...
    v47[1] = v19;
    v47[2] = v13;
    uint64_t v20 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v47 forKeys:v46 count:3];

    uint64_t v30 = (void *)v20;
    [(NSMutableDictionary *)self->_transactions setObject:v20 forKey:v14];
    uint64_t v21 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithDictionary:v31];
    [v21 setObject:self->_sessionID forKeyedSubscript:@"sid"];
    [v21 setObject:v14 forKeyedSubscript:@"tid"];
    uint64_t v22 = (void *)MEMORY[0x1D9452090]([v21 setObject:@"request" forKeyedSubscript:@"type"]);
    id v23 = self;
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      uint64_t v45 = v21;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Sending request, tid %@\n%@", buf, 0x20u);
...
- (void)_completeUserTransaction:(id)a3 response:(id)a4 options:(id)a5 status:(int)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v57 = 2112;
    __int16 v58 = v21;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Completed user request, utid %@, status %@\n%@", buf, 0x2Au);
    if (a6)
    {
    }
    uint64_t v12 = v16;
...
LABEL_24:
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v55 = 2112;
      __int16 v56 = v12;
      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Missing, utid %@ for response %@", buf, 0x20u);
    }
    goto LABEL_27;
  }
  uint64_t v23 = v22;
...
void __82__HMDSecureRemoteStreamInternal__completeUserTransaction_response_options_status___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v15[0] = v9;
    id v10 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", v15, &v14, 1, v1 + 16);
...
- (void)_sendUserRequest:(id)a3 options:(id)a4 responseHandler:(id)a5
{
  ...
  if (self->_started)
  {
    ...
    uint64_t v13 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_internalQueue);
    if (v13)
    {
      uint64_t v14 = v13;
      handler[0] = MEMORY[0x1E4F143A8];
      ...
      handler[3] = &unk_1E6A19B30;
      handler[4] = self;
      dispatch_source_set_event_handler(v13, handler);
      dispatch_source_set_cancel_handler(v14, &__block_literal_global_62_182716);
      ...
      v54[4] = @"utid";
      v55[4] = v12;
      uint64_t v21 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v55 forKeys:v54 count:5];
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v52 = 2112;
        id v53 = v8;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Scheduled user request, utid %@\n%@", buf, 0x20u);
      }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    uint64_t v38 = *MEMORY[0x1E4F28760];
    __int16 v41 = v27;
    uint64_t v31 = v26;
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v50 = 2112;
    __int16 v51 = v36;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Send user request failed: %@", buf, 0x16u);
...
LABEL_4:
  ...
  uint64_t v5 = (OS_dispatch_source *)dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, (dispatch_queue_t)self->_internalQueue);
  ...
  if (v7)
  {
    ...
    dispatch_source_set_cancel_handler((dispatch_source_t)self->_idleTimer, &__block_literal_global_60_182720);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v22;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@idle timer failed: %@", buf, 0x16u);
  }
  return -6700;
}
  ...
  if (self->_started)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      if (v5)
      {
        ...
        double v72 = v12;
        uint64_t v4 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v72 forKeys:&v71 count:1];
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v75 = 2112;
      v76 = v13;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Stopping: %@", buf, 0x16u);
      if (v5)
      {
      }
    }
  ...
  if (started)
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_DEBUG))
    {
      ...
      if (v5)
      {
        ...
        v68 = v50;
        int v3 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v68 forKeys:&v67 count:1];
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v75 = 2112;
      v76 = v51;
      _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_DEBUG, "%{public}@Stopped: %@", buf, 0x16u);
      if (v5)
      {
      }
    }
...
- (void)_start
{
  ...
  if (!self->_started)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v45 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Starting", buf, 0xCu);
    }
  ...
  if (state == 11 || state == 1)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v45 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Start failed, attempt to restart session", buf, 0xCu);
    }
...
LABEL_25:
  ...
  {
    id v36 = (NSMutableArray *)objc_alloc_init(MEMORY[0x1E4F1CA48]);
    userTransactions = self->_userTransactions;
  ...
  if (!v14)
  {
    if (!started)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v45 = v41;
        _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_DEBUG, "%{public}@Started", buf, 0xCu);
      }
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    uint64_t v20 = *MEMORY[0x1E4F28760];
    uint64_t v21 = objc_msgSend(NSString, "stringWithUTF8String:", DebugGetErrorString(), *MEMORY[0x1E4F28568]);
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v46 = 2112;
    id v47 = v25;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Start failed: %@", buf, 0x16u);
  }
...
LABEL_6:
  ...
  if (initWithType_commitTimeout_clientIdleTimeout_serverIdleTimeout_sendInternalTimeout_sendUserTimeout___hmf_once_t0 != -1) {
    dispatch_once(&initWithType_commitTimeout_clientIdleTimeout_serverIdleTimeout_sendInternalTimeout_sendUserTimeout___hmf_once_t0, &__block_literal_global_182736);
  }
  ...
  objc_storeStrong((id *)&v15->_userQueue, MEMORY[0x1E4F14428]);
...
uint64_t __132__HMDSecureRemoteStreamInternal_initWithType_commitTimeout_clientIdleTimeout_serverIdleTimeout_sendInternalTimeout_sendUserTimeout___block_invoke()
{
  ...
  uint64_t v1 = initWithType_commitTimeout_clientIdleTimeout_serverIdleTimeout_sendInternalTimeout_sendUserTimeout___hmf_once_v1;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t49_182749 != -1) {
    dispatch_once(&logCategory__hmf_once_t49_182749, &__block_literal_global_133_182750);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v50_182751;
  return v2;
}
...
uint64_t __44__HMDSecureRemoteStreamInternal_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v50_182751;
  logCategory__hmf_once_v50_182751 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}
