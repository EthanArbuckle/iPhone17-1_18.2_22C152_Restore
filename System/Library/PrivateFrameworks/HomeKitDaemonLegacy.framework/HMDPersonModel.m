...
+ (NSUUID)sentinelParentUUID
{
  if (sentinelParentUUID_onceToken_102666 != -1) {
    dispatch_once(&sentinelParentUUID_onceToken_102666, &__block_literal_global_10);
  }
  v2 = (void *)sentinelParentUUID_sentinelParentUUID_102667;
  return (NSUUID *)v2;
}

uint64_t __36__HMDPersonModel_sentinelParentUUID__block_invoke()
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"0F42F4A3-0819-4FE2-AF6C-498767A95771"];
  uint64_t v1 = sentinelParentUUID_sentinelParentUUID_102667;
  sentinelParentUUID_sentinelParentUUID_102667 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}

+ (id)hmbProperties
{
  if (hmbProperties_onceToken_102672 != -1) {
    dispatch_once(&hmbProperties_onceToken_102672, &__block_literal_global_102673);
  }
  v2 = (void *)hmbProperties_properties_102674;
  return v2;
}
...
void __31__HMDPersonModel_hmbProperties__block_invoke()
{
  ...
  uint64_t v0 = [MEMORY[0x1E4F69EE8] fieldWithClass:objc_opt_class()];
  ...
  v5 = (void *)hmbProperties_properties_102674;
  hmbProperties_properties_102674 = v4;
}

- (id)createPerson
{
  id v3 = objc_alloc(MEMORY[0x1E4F2E988]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2112;
      id v15 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to encode person links: %@", buf, 0x16u);
    }
  }
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v20 = 2112;
        id v21 = v9;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode person links: %@", buf, 0x16u);
      }
