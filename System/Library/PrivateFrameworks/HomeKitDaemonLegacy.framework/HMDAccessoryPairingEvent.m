      ...
      if (v40 <= 0.0)
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v79 = 2112;
          v80 = v53;
          _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_INFO, "%{public}@Submitting placeholder metric values since same accessory request UUID %@ being paired multiple times before CA event submission", buf, 0x16u);
        }
    ...
    if (v59 != v61)
    {
      ...
      if (os_log_type_enabled(v64, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v81 = 2112;
        v82 = v67;
        _os_log_impl(&dword_1D49D5000, v64, OS_LOG_TYPE_ERROR, "%{public}@Unexpected step and error in submitting pairing log event %@ %@", buf, 0x20u);
      }
    }
    ...
    if (v70)
    {
      ...
      if (os_log_type_enabled(v73, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v79 = 2112;
        v80 = v75;
        _os_log_impl(&dword_1D49D5000, v73, OS_LOG_TYPE_ERROR, "%{public}@Unexpected error contains underlying error %@", buf, 0x16u);
      }
    }
  }
}
...
- (void)_setBtLoad
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Pairing BT Load: %d AudioTsk: %d NonAudioTsk: %d", (uint8_t *)&v12, 0x1Eu);
  }
}
...
- (void)updateEventPropertiesWithPairedAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v6 = [(HMDAccessoryPairingEvent *)self accessoryManufacturer];

    if (!v6)
    {
      id v7 = [v13 manufacturer];
      [(HMDAccessoryPairingEvent *)self setAccessoryManufacturer:v7];
    }
    ...
    uint64_t v10 = [(HMDAccessoryPairingEvent *)self accessoryCategory];
    ...
    id v4 = (id)[(HMDAccessoryPairingEvent *)self _updateThreadPropertiesWithPairedAccessory:v13];
    id v5 = v13;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_71219 != -1) {
    dispatch_once(&logCategory__hmf_once_t13_71219, &__block_literal_global_71220);
  }
  v2 = (void *)logCategory__hmf_once_v14_71221;
  return v2;
}
...
uint64_t __39__HMDAccessoryPairingEvent_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v14_71221;
  logCategory__hmf_once_v14_71221 = v0;
