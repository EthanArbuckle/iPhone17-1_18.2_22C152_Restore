...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  if (v8 == v6)
  {
    ...
    if ((v16 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v25 = 2112;
        id v26 = v13;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Handling expired audio group identifier value: %@", (uint8_t *)&v23, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unknown stage value: %@ did expire value: %@", (uint8_t *)&v23, 0x20u);
    }
  }
}
...
- (void)triggerStageValueDidExpireValueForAudioDestinationIdentifier
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Triggering did expire value for audio destination identifier", (uint8_t *)&v9, 0xCu);
  }
...
- (void)notifyDelegateDidUpdateStagedValues
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      int v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of updated staged values due to no delegate", (uint8_t *)&v9, 0xCu);
    }
  }
}
...
- (void)mediaDestinationMessageHandler:(id)a3 didReceiveUpdateAudioGroupIdentifierRequestMessage:(id)a4 audioGroupIdentifier:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v25 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling did receive update audio group identifier request message", buf, 0xCu);
  }
...
- (void)mediaDestinationMessageHandler:(id)a3 didReceiveUpdateSupportedOptionsRequestMessage:(id)a4 supportOptions:(unint64_t)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling did receive update supported options request message", buf, 0xCu);
  }
...
- (id)messageHandler:(id)a3 deviceForOutgoingMessage:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      id v17 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get device due to no target accessory", (uint8_t *)&v16, 0xCu);
    }
    id v10 = 0;
  }
...
- (id)messageHandler:(id)a3 shouldRelayIncomingMessage:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      id v17 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine relay preference due to no target accessory", (uint8_t *)&v16, 0xCu);
    }
    id v10 = 0;
  }
...
- (void)mediaDestinationBackingStoreHandler:(id)a3 didUpdateDestination:(id)a4
{
  ...
  if (os_signpost_enabled((os_log_t)v8))
  {
    ...
    if (v9)
    {
      int v19 = 138412290;
      uint64_t v20 = v9;
      _os_signpost_emit_with_name_impl(&dword_1D49D5000, (os_log_t)v8, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "HMDMediaDestinationManagerCommitAudioGroupIdentifier", "audioGroupIdentifier=%{signpost.description:attribute}@ ", (uint8_t *)&v19, 0xCu);
    }
    else
    {
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v7;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling did update destination: %@", (uint8_t *)&v19, 0x16u);
  }
...
- (void)migrateWithHome:(id)a3 cloudZone:(id)a4 migrationQueue:(id)a5 completion:(id)a6
{
  ...
  id v12 = a4;
  id v13 = a3;
  id v14 = [(HMDMediaDestinationManager *)self backingStoreHandler];
...
- (id)legacyUpdateAudioGroupIdentifier:(id)a3
{
  ...
  id v11 = [(HMDMediaDestinationManager *)self backingStoreHandler];
...
void __63__HMDMediaDestinationManager_legacyUpdateAudioGroupIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Update audio group identifier completed with error: %@", (uint8_t *)&v10, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      id v11 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Update audio group identifier completed", (uint8_t *)&v10, 0xCu);
    }
...
- (id)updateAudioGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    id v27 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating audio group identifier: %@", (uint8_t *)&v24, 0x16u);
  }
    ...
    && ([(id)isFeatureHomeTheaterQFAEnabledForTests BOOLValue] & 1) != 0)
  {
    ...
    if (v9)
    {
      ...
      id v11 = [(HMDMediaDestinationManager *)v6 stagedAudioGroupIdentifier];
      [v11 commitValue:v4];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v4;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to update local storgage with audio group identifier: %@ due to no local storage found", (uint8_t *)&v24, 0x16u);
      }
      __int16 v21 = (void *)MEMORY[0x1E4F7A0D8];
      id v22 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
...
void __59__HMDMediaDestinationManager_legacyUpdateSupportedOptions___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Update supported options completed with error: %@", (uint8_t *)&v10, 0x16u);
    }
    [*(id *)(a1 + 40) finishWithError:v3];
  }
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      id v11 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Update supported options completed", (uint8_t *)&v10, 0xCu);
    }
    [*(id *)(a1 + 40) finishWithNoResult];
  }
}
...
- (id)updateSupportedOptions:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    uint64_t v28 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating supported options: %@", (uint8_t *)&v25, 0x16u);
  }
  if (isFeatureHomeTheaterQFAEnabledForTests
    && ([(id)isFeatureHomeTheaterQFAEnabledForTests BOOLValue] & 1) != 0)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v27 = 2112;
        uint64_t v28 = v21;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to update supported options: %@ due to no local storage found", (uint8_t *)&v25, 0x16u);
      }
      id v22 = (void *)MEMORY[0x1E4F7A0D8];
      uint64_t v23 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      int v25 = 138543362;
      __int16 v26 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Home Theater QFA is not enabled", (uint8_t *)&v25, 0xCu);
    }
...
- (id)dataSourceRootDestinationManager
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v10 = 138543362;
      id v11 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine root destination due to no data source", (uint8_t *)&v10, 0xCu);
    }
  }
...
- (id)dataSourceTargetAccessory
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v3;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to get associated accessory from data source: %@", (uint8_t *)&v12, 0x16u);
    }
  }
...
- (id)mediaGroupParticipantLocalDataStorage
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      int v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get local data storage due to no data source", (uint8_t *)&v11, 0xCu);
    }
    id v5 = 0;
  }
...
- (void)stageAudioGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Staging audio group identifier: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)configureWithHome:(id)a3 currentAccessory:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Configuring destination manager: %@ destination: %@", (uint8_t *)&v12, 0x20u);
  }
...
LABEL_9:
  ...
  if (v21)
  {
    ...
    id v26 = objc_alloc(MEMORY[0x1E4F65560]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_77219 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_77219, &__block_literal_global_77220);
  }
  v2 = (void *)logCategory__hmf_once_v25_77221;
  return v2;
}
...
uint64_t __41__HMDMediaDestinationManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v25_77221;
  logCategory__hmf_once_v25_77221 = v0;
