...
- (void)checkNetworkChange
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v38 = 2112;
    v39 = v13;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Network Change Detected.  New Network SSID %@ Local MAC %@, BSSID %@, gatewayIP %@,  gatewayMac %@", (uint8_t *)&v28, 0x3Eu);
  }
...
- (id)_keyOfLargestCountInHistogram:(id)a3
{
  ...
  int v10 = __Block_byref_object_copy__190480;
  v11 = __Block_byref_object_dispose__190481;
  id v12 = 0;
...
- (void)stop
{
  ...
  if (self->_started)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      id v11 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping", (uint8_t *)&v10, 0xCu);
    }
    ...
    [v9 removeObserver:v4 name:*MEMORY[0x1E4F653E8] object:0];
...
- (void)start
{
  ...
  if (!self->_started)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      v15 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v14, 0xCu);
    }
    uint64_t v7 = *MEMORY[0x1E4F653E8];
    id v8 = [MEMORY[0x1E4F28EA0] notificationWithName:*MEMORY[0x1E4F653E8] object:0];
...
- (HMDNetworkObserver)initWithLogEventDispatcher:(id)a3 countersManager:(id)a4 dailyScheduler:(id)a5 currentHomeDataSource:(id)a6 dateProvider:(id)a7 wifiManager:(id)a8 notificationCenter:(id)a9 changeDebounceTimer:(id)a10 tickBlock:(id)a11
{
  ...
  if (v23)
  {
    ...
    *(_OWORD *)&v24->_numReadWrites = 0u;
    ...
    char v27 = (NSMutableDictionary *)objc_alloc_init(MEMORY[0x1E4F1CA60]);
...
- (HMDNetworkObserver)initWithLogEventDispatcher:(id)a3 countersManager:(id)a4 dailyScheduler:(id)a5 currentHomeDataSource:(id)a6 dateProvider:(id)a7
{
  uint64_t v12 = (void *)MEMORY[0x1E4F65598];
  id v13 = a7;
  id v14 = a6;
  id v15 = a5;
  id v16 = a4;
  ...
  id v20 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:1.0];
  id v21 = [(HMDNetworkObserver *)self initWithLogEventDispatcher:v17 countersManager:v16 dailyScheduler:v15 currentHomeDataSource:v14 dateProvider:v13 wifiManager:v18 notificationCenter:v19 changeDebounceTimer:v20 tickBlock:&__block_literal_global_42_190495];
...
+ (id)supportedEventClasses
{
  if (supportedEventClasses_onceToken_190500 != -1) {
    dispatch_once(&supportedEventClasses_onceToken_190500, &__block_literal_global_190501);
  }
  v2 = (void *)supportedEventClasses_supportedEventClasses_190502;
  return v2;
}
...
void __43__HMDNetworkObserver_supportedEventClasses__block_invoke()
{
  ...
  v1 = (void *)supportedEventClasses_supportedEventClasses_190502;
  supportedEventClasses_supportedEventClasses_190502 = v0;
}
