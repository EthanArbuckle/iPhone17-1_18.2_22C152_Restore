...
void __75__HMDRemoteLoginInitiator_didCompleteAuthentication_error_loggedInAccount___block_invoke(uint64_t a1)
{
  ...
  if (v5 == v6)
  {
    if (v10)
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v15;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ has completed with error %@", (uint8_t *)&v16, 0x20u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Received completion from unknown remote authentication with error %@", (uint8_t *)&v16, 0x16u);
    }
  }
}
...
- (void)_callCompletion:(id)a3 loggedInAccount:(id)a4 authSession:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v8;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Login session %@ has ended with error %@", (uint8_t *)&v25, 0x20u);
  }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v9;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating the logged in account from %@ to %@", (uint8_t *)&v25, 0x20u);
    }
...
- (void)_handleSignoutResponse:(id)a3 error:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received proxy device response %@ and error %@", (uint8_t *)&v19, 0x20u);
  }
  if (v9)
  {
    id v15 = v9;
...
- (void)_handleRemoteLoginSignout:(id)a3
{
  ...
  id v8 = [(HMDRemoteLoginBase *)self remoteLoginHandler];
  id v9 = [v8 loggedInAccount];
  [(HMDRemoteLoginSignoutRequest *)v7 setAccount:v9];

  id v10 = [(HMDRemoteLoginSignoutRequest *)v7 messageName];
  __int16 v20 = v10;
  ...
  id v13 = [(HMDRemoteLoginInitiator *)self remoteMessageSender];
  uint64_t v14 = [(HMDRemoteLoginSignoutRequest *)v7 messageName];
  ...
  id v15 = v4;
  id v17 = v15;
  [v13 sendRemoteMessageWithName:v14 payload:v12 responseHandler:v16];
...
- (void)_proxyLoginWithSessionID:(id)a3 authResults:(id)a4 remoteDevice:(id)a5 completion:(id)a6
{
  ...
  int v16 = [(HMDRemoteLoginInitiator *)self remoteMessageSender];
  ...
  id v18 = [[HMDRemoteLoginInitiatorAuthenticationSession alloc] initWithSessionID:v10 remoteAuthentication:v17 completion:v13];
  int v19 = (void *)MEMORY[0x1D9452090]([(HMDRemoteLoginInitiator *)self setLoginSession:v18]);
  __int16 v20 = self;
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    id v27 = v10;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Created the proxy login with Session ID: %@", (uint8_t *)&v24, 0x16u);
  }
...
- (void)_handleRemoteLoginProxyAuthentication:(id)a3
{
  ...
  id v9 = [MEMORY[0x1E4F1C978] arrayWithObjects:v30 count:2];
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v12;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive authentication results from results data: %@", buf, 0x16u);
    }
  }
  id v17 = v11;
  objc_opt_class();
  ...
  if (!v9)
  {
    ...
    if (v17)
    {
        ...
        if (v29)
        {
          if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v43 = 2112;
            id v44 = v29;
            _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Received proxy device response with device: %@", buf, 0x16u);
          }
          v39 = @"kRemoteLoginProxiedDevice";
          v35 = encodeRootObject();
          v40 = v35;
          int v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v40 forKeys:&v39 count:1];
        ...
        else
        {
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v42 = v36;
            _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with no device", buf, 0xCu);
          }
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v43 = 2112;
        id v44 = 0;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with response error: %@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v42 = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with invalid payload", buf, 0xCu);
      }
      uint64_t v24 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:8];
    }
    id v15 = (id)v24;
    int v16 = 0;
LABEL_22:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v43 = 2112;
    id v44 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Received proxy device response with error %@", buf, 0x16u);
  }
  id v15 = v9;
  int v16 = 0;
LABEL_23:
...
- (void)_companionLoginWithSessionID:(id)a3 account:(id)a4 remoteDevice:(id)a5 completion:(id)a6
{
  ...
  id v18 = [[HMDRemoteLoginInitiatorAuthenticationSession alloc] initWithSessionID:v10 remoteAuthentication:v17 completion:v13];
  id v19 = (void *)MEMORY[0x1D9452090]([(HMDRemoteLoginInitiator *)self setLoginSession:v18]);
  __int16 v20 = self;
  __int16 v21 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    id v27 = v10;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Created the companion login with Session ID: %@", (uint8_t *)&v24, 0x16u);
  }
  __int16 v23 = [(HMDRemoteLoginInitiatorAuthenticationSession *)v18 remoteAuthentication];
  [v23 authenticate];
}
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v8;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive account from account data: %@", buf, 0x16u);
    }
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_31556 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_31556, &__block_literal_global_31557);
  }
  v2 = (void *)logCategory__hmf_once_v1_31558;
  return v2;
}
...
uint64_t __38__HMDRemoteLoginInitiator_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_31558;
  logCategory__hmf_once_v1_31558 = v0;
