...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_84790 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_84790, &__block_literal_global_84791);
  }
  v2 = (void *)logCategory__hmf_once_v1_84792;
  return v2;
}
...
uint64_t __31__HMDMessageFilter_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_84792;
  logCategory__hmf_once_v1_84792 = v0;
