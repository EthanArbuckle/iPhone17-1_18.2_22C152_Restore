  ...
  if (!self->super.submitted)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v18 = 2112;
      v19 = v10;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Submitting shared user response latency log event %@ error:%@", buf, 0x20u);
    }
    v13.receiver = v4;
...
- (void)cancel
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@cancel", buf, 0xCu);
  }
  v9.receiver = v4;
...
- (void)markAddUserToHomeEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v24 = 138543362;
    v25 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAddUserToHomeEnd", (uint8_t *)&v24, 0xCu);
  }
...
- (void)markAddUserToHomeBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAddUserToHomeBegin", (uint8_t *)&v11, 0xCu);
  }
...
- (void)markJoiningReverseShareEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v17 = 138543362;
    uint64_t v18 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markJoiningReverseShareEnd", (uint8_t *)&v17, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markJoiningReverseShareBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markJoiningReverseShareBegin", (uint8_t *)&v11, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (void)markAuthenticateUserEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v17 = 138543362;
    uint64_t v18 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAuthenticateUserEnd", (uint8_t *)&v17, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markAuthenticateUserBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markAuthenticateUserBegin", (uint8_t *)&v11, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (HMDSharedUserInviteOwnerResponseLogEventBuilder)initWithHome:(id)a3 sessionIdentifier:(id)a4 invitationType:(unint64_t)a5
{
  ...
  id v12 = v8;
  id v13 = v10;
  id v14 = &__block_literal_global_178667;
  id v15 = &__block_literal_global_4_178668;
  if (self)
  {
    ...
    if (v18)
    {
      ...
      id v21 = [(HMDSharedUserInviteLogEventBuilder *)&v24 initWithLogEvent:v18 homeManager:v19 sessionIdentifier:v12 invitationType:a5 logEventSubmitter:v13 wifiManager:v20 currentUpTicksBlock:&__block_literal_global_178667 submissionTimerFactory:&__block_literal_global_4_178668];
...
{
  v0 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:8 options:300.0];
  return v0;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_178679 != -1) {
    dispatch_once(&logCategory__hmf_once_t14_178679, &__block_literal_global_14_178680);
  }
  v2 = (void *)logCategory__hmf_once_v15_178681;
  return v2;
}
...
uint64_t __62__HMDSharedUserInviteOwnerResponseLogEventBuilder_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v15_178681;
  logCategory__hmf_once_v15_178681 = v0;
