...
{
  id v4 = a3;
  unint64_t v5 = (void *)MEMORY[0x1E4F6A268];
  ...
  if (v7 != 0 && v7 < 0xFFFFFFFFFFFFFFC1)
  {
    if (v7 - 1 > 0x3E)
    {
      if (v7 + 127 <= 0x3F)
      {
        ...
        v11 = [MEMORY[0x1E4F6A268] startOfDateByAddingDayCount:63 toDate:v4];
...
- (HMDTimeBasedFlagDaily)initWithContext:(id)a3 dateProvider:(id)a4
{
  ...
  if (initWithContext_dateProvider__onceToken != -1) {
    dispatch_once(&initWithContext_dateProvider__onceToken, &__block_literal_global_173662);
  }
  v13.receiver = self;
