...
void __62__HMDCameraMetricsStreamLogEvent__milestonesSortedByTimestamp__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    ...
    objc_msgSend(*(id *)(a1 + 32), "insertObject:atIndex:", v8, objc_msgSend(*(id *)(a1 + 32), "indexOfObject:inSortedRange:options:usingComparator:", v8, 0, objc_msgSend(*(id *)(a1 + 32), "count"), 1024, &__block_literal_global_113256));
  }
}
