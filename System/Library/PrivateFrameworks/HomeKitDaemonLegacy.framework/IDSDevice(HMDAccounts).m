...
LABEL_11:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    int v22 = 138543362;
    v23 = v20;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create device identifier", (uint8_t *)&v22, 0xCu);
  }
...
- (id)hmd_productInfo
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v28 = 2112;
    id v29 = v8;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Could not determine product platform from product name '%@' for device: %@", buf, 0x20u);
  }
  if (!v6)
  {
LABEL_7:
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v28 = 2112;
      id v29 = v13;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Could not determine product class from model identifier '%@' for device: %@", buf, 0x20u);
    }
  }
LABEL_10:
  id v17 = objc_alloc(MEMORY[0x1E4F65548]);
  id v18 = (void *)MEMORY[0x1E4F65558];
  [a1 operatingSystemVersion];
