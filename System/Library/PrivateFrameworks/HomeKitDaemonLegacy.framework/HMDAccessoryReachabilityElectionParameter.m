  ...
  if (v4)
  {
    ...
    if ([v6 count] != 1)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v34 = 2112;
        id v35 = v5;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unexpected representation, invalid keys: %@", (uint8_t *)&v32, 0x16u);
      }
      goto LABEL_23;
    }
    v7 = [v6 firstObject];
    ...
    if (v9)
    {
      ...
      if (v10)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            __int16 v34 = 2112;
            id v35 = v31;
            _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Invalid reachability: %@", (uint8_t *)&v32, 0x16u);
          }
          v16 = 0;
        }
      ...
      __int16 v34 = 2112;
      id v35 = v9;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid identifier: %@", (uint8_t *)&v32, 0x16u);
    }
    else
    {
      v20 = (void *)MEMORY[0x1D9452090]();
...
LABEL_24:
      ...
      __int16 v34 = 2112;
      id v35 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid key type: %@", (uint8_t *)&v32, 0x16u);
    }
    goto LABEL_22;
  }
  v16 = 0;
