...
- (NSArray)meshNodes
{
  ...
  uint64_t v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_22_127377);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Could not find the destination node to send the ping request", buf, 0xCu);
    }
  }
}
...
- (void)_setupMessageRegistrations
{
  ...
  [(COMeshController *)self registerHandler:&__block_literal_global_127450 forCommandClass:objc_opt_class()];
...
void __72__HMDCoordinationLocalElectionMeshController__setupMessageRegistrations__block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding to ping request", (uint8_t *)&v13, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_127477 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_127477, &__block_literal_global_59_127478);
  }
  id v2 = (void *)logCategory__hmf_once_v4_127479;
  return v2;
}
...
uint64_t __57__HMDCoordinationLocalElectionMeshController_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v4_127479;
  logCategory__hmf_once_v4_127479 = v0;
