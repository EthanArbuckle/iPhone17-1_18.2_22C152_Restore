      ...
      if (v18)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&location[4] = v23;
          ...
          __int16 v35 = 2112;
          uint64_t v36 = v18;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit non-atomic transaction %lu: %@", location, 0x20u);
        }
        id v5 = (id)v18;
      }
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(void *)&location[4] = v24;
          __int16 v33 = 2048;
          v34 = v13;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully committed non-atomic transaction %lu to log", location, 0x16u);
        }
      }
    }
  }
  ...
  if (!v3)
  {
    ...
    if (v6)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        uint32_t v20 = 32;
LABEL_10:
        _os_log_impl(&dword_1D49D5000, v18, v19, v17, (uint8_t *)&v22, v20);
      }
    }
...
{
  id v4 = a3;
  id v5 = [(HMDBackingStoreLogAddTransactionOperation *)self initWithAtomicSaveEnabled:!isWatch() transaction:v4];
