...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_38596 != -1) {
    dispatch_once(&hmbProperties_onceToken_38596, &__block_literal_global_38597);
  }
  v2 = (void *)hmbProperties__properties_38598;
  return v2;
}
...
void __32__HMDSettingModel_hmbProperties__block_invoke()
{
  ...
  v11[3] = v3;
  v10[4] = @"stringValue";
  id v4 = [MEMORY[0x1E4F69E98] fieldWithClass:objc_opt_class()];
  v11[4] = v4;
  v10[5] = @"dataValue";
  v5 = [MEMORY[0x1E4F69E98] fieldWithClass:objc_opt_class()];
  v11[5] = v5;
  v10[6] = @"selectionIdentifier";
  BOOL v6 = [MEMORY[0x1E4F69E98] fieldWithClass:objc_opt_class()];
  v11[6] = v6;
  ...
  v9 = (void *)hmbProperties__properties_38598;
  hmbProperties__properties_38598 = v8;
}
