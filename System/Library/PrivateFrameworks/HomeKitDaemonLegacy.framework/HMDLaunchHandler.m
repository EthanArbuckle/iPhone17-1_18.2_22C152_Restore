...
+ (HMDLaunchHandler)sharedHandler
{
  ...
  block[4] = a1;
  if (sharedHandler_onceToken_129149 != -1) {
    dispatch_once(&sharedHandler_onceToken_129149, block);
  }
  v2 = (void *)sharedHandler_sharedHandler_129150;
  return (HMDLaunchHandler *)v2;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t9_129142 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_129142, &__block_literal_global_8_129143);
  }
  v2 = (void *)logCategory__hmf_once_v10_129144;
  return v2;
}
...
void __51__HMDLaunchHandler_registerRelaunchClientWithUUID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Registering client for relaunch: %@", (uint8_t *)&v14, 0x16u);
  }
  ...
  if ((v9 & 1) == 0)
  {
    ...
    v11 = [*(id *)(a1 + 40) UUIDString];
    [v10 addObject:v11];

    [*(id *)(a1 + 32) _updateOrRemoveRelaunchPlist];
    v12 = [*(id *)(a1 + 32) registeredRelaunchClients];
...
- (void)_setJetsamPriorityElevated:(BOOL)a3
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 1024;
      int v22 = v8;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to set jetsam priority elevated to %@: %d", (uint8_t *)&v17, 0x1Cu);
    }
  }
  else if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    v20 = v16;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully set jetsam priority elevated to %@", (uint8_t *)&v17, 0x16u);
  }
}
...
- (void)_updateOrRemoveRelaunchPlist
{
  ...
  id v4 = [(HMDLaunchHandler *)self registeredRelaunchClients];
...
LABEL_15:
  ...
  v7 = [v6 allObjects];
  v42 = v7;
  id v8 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v42 forKeys:&v41 count:1];

  char v9 = [(HMDLaunchHandler *)self fileManager];
  ...
  if (v11)
  {
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      uint64_t v18 = [(HMDLaunchHandler *)v14 relaunchPlistFileURL];
      *(_DWORD *)buf = 138543618;
      v44 = v17;
      __int16 v45 = 2112;
      v46 = v18;
...
void __53__HMDLaunchHandler_deregisterRelaunchClientWithUUID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Deregistering client for relaunch: %@", (uint8_t *)&v14, 0x16u);
  }
  v7 = [*(id *)(a1 + 32) registeredRelaunchClients];
  id v8 = [*(id *)(a1 + 40) UUIDString];
...
void __68__HMDLaunchHandler_removePersistentRelaunchRegistrationsIfNecessary__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v8 = 138543362;
    int v9 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Removing persistent relaunch registrations if necessary", (uint8_t *)&v8, 0xCu);
  }
...
- (HMDLaunchHandler)init
{
  ...
  uint64_t v7 = [(HMDLaunchHandler *)self initWithRelaunchPlistFileURL:v5 fileManager:v6 jetsamPriorityHandler:&__block_literal_global_129133];
...
uint64_t __31__HMDLaunchHandler_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v10_129144;
  logCategory__hmf_once_v10_129144 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}

uint64_t __33__HMDLaunchHandler_sharedHandler__block_invoke(uint64_t a1)
{
  sharedHandler_sharedHandler_129150 = (uint64_t)objc_alloc_init(*(Class *)(a1 + 32));
