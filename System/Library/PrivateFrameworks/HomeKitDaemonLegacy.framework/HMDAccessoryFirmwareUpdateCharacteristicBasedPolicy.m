...
- (void)_startDebounceTimer
{
  v3 = objc_msgSend(objc_alloc(MEMORY[0x1E4F65580]), "initWithTimeInterval:options:", 1, (double)-[HMDAccessoryFirmwareUpdateCharacteristicBasedPolicy debounceDuration](self, "debounceDuration"));
...
void __89__HMDAccessoryFirmwareUpdateCharacteristicBasedPolicy_handleCharacteristicValuesChanged___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v18 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Received characteristic values changed notification", buf, 0xCu);
  }
...
- (BOOL)evaluate
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", (uint8_t *)&v11, 0x16u);
  }
  return v4;
}
...
- (void)dealloc
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      ...
      __int16 v13 = v6;
      char v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v13 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v15 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Accessory has been removed - bail out from dealloc", buf, 0xCu);
    }
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_86020 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_86020, &__block_literal_global_86021);
  }
  v2 = (void *)logCategory__hmf_once_v1_86022;
  return v2;
}
...
uint64_t __66__HMDAccessoryFirmwareUpdateCharacteristicBasedPolicy_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_86022;
  logCategory__hmf_once_v1_86022 = v0;
