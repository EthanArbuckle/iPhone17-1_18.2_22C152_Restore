...
- (void)refreshNetworkInformation
{
  ...
  enumerate_block[3] = &unk_1E6A0C998;
  ...
  {
    v5 = (void *)[objc_alloc(MEMORY[0x1E4F1C9B8]) initWithBytes:v9 length:20];
    [(HMDCharacteristicReadWriteNetworkInformation *)self setCachedIpv4Signature:v5];
  }
  if (nw_path_get_ipv6_network_signature())
  {
    v6 = (void *)[objc_alloc(MEMORY[0x1E4F1C9B8]) initWithBytes:v8 length:20];
...
- (void)_refreshBluetoothInformation
{
  id v3 = [MEMORY[0x1E4F5BC60] getInstance];
...
- (void)_refreshWifiInformation
{
  ...
  id v14 = objc_alloc_init(MEMORY[0x1E4F5E318]);
  [v14 activate];
