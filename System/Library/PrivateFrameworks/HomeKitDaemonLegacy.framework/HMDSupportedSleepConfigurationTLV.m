...
LABEL_23:
      ...
      v23 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v33);
      id v8 = 0;
      goto LABEL_31;
    }
    uint64_t v11 = v10;
...
LABEL_10:
    ...
    if (v29 == 1)
    {
      char v13 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytesNoCopy:length:freeWhenDone:");
      id v25 = v10;
      uint64_t v14 = [MEMORY[0x1E4F5BE68] parsedFromData:v13 error:&v25];
      id v15 = v25;
