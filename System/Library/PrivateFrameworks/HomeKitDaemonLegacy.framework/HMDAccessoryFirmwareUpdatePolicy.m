...
- (void)notify:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending notification with policy status %@", buf, 0x16u);
  }
...
- (BOOL)evaluate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", (uint8_t *)&v8, 0xCu);
  }
  return 1;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_101809 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_101809, &__block_literal_global_101810);
  }
  v2 = (void *)logCategory__hmf_once_v1_101811;
  return v2;
}
...
uint64_t __47__HMDAccessoryFirmwareUpdatePolicy_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_101811;
  logCategory__hmf_once_v1_101811 = v0;
