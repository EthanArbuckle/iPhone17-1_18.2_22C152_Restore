...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_96945 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_96945, &__block_literal_global_96946);
  }
  v2 = (void *)logCategory__hmf_once_v5_96947;
  return v2;
}
...
uint64_t __34__HMDDeviceController_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_96947;
  logCategory__hmf_once_v5_96947 = v0;
...
+ (id)placeholderDeviceControllerWithIdentifier:(id)a3
{
  if (a3)
  {
    ...
    uint64_t v5 = [(HMDDevice *)v4 initWithIdentifier:v3 handles:MEMORY[0x1E4F1CBF0] name:0 productInfo:0 version:0 capabilities:0];
