...
- (void)persistState:(id)a3
{
  ...
  id v14 = 0;
  v6 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:&v14];
  id v7 = v14;
  if (v6)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      id v18 = v7;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to persist primary resident reachability state, encoding failed: %@", buf, 0x16u);
    }
  }
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v18 = 2112;
        id v19 = v8;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode primary resident reachability state: %@", buf, 0x16u);
      }
    }
  }
  else
...
- (void)handlePrimaryResidentUpdated:(id)a3 reason:(id)a4
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v32 = 2112;
      v33 = v9;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping primary resident update for reason: %@, because resident device identifier found in peristed state: %@", (uint8_t *)&v28, 0x20u);
    }
  }
  else if (v6)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v32 = 2112;
      v33 = v19;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Persisting primary resident reachability state for reason %@:%@", (uint8_t *)&v28, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v30 = 2112;
      id v31 = v7;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted reachability state for reason: %@ because primary resident is nil", (uint8_t *)&v28, 0x16u);
    }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Not handling home removed notification because current device is a resident", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v15;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Received notification home removed: %@", buf, 0x16u);
    }
...
uint64_t __82__HMDHomePrimaryResidentInitialReachabilityManager_handleHomeRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted reachability state because home was removed", (uint8_t *)&v7, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      id v17 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Not handling resident enabled state change, because it is not for current device: %@", buf, 0x16u);
    }
  }
}
...
uint64_t __103__HMDHomePrimaryResidentInitialReachabilityManager_handleResidentDeviceEnabledStateChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted reachability state because current device became resident", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) clearPersistedState];
}
...
- (void)handleResidentDeviceManagerUpdateResidentNotification:(id)a3
{
  ...
  id v6 = [v4 object];
  if ([v6 conformsToProtocol:&unk_1F2E475B8]) {
    int v7 = v6;
  }
  else {
    int v7 = 0;
  ...
  if ([v8 isCurrentDeviceAvailableResident])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v35 = 138543362;
      v36 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Not handling resident update notification because current device is a resident", (uint8_t *)&v35, 0xCu);
    }
  }
  else
  {
    ...
    if (v18)
    {
      ...
      if (v23)
      {
        if (v27)
        {
          ...
          __int16 v39 = 2112;
          v40 = v21;
          _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Not handling resident update notification because peristed state: %@ is equal to state: %@", (uint8_t *)&v35, 0x20u);
        }
      }
      else
      {
        if (v27)
        {
          ...
          __int16 v37 = 2112;
          v38 = v21;
          _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Persisting primary resident reachability state: %@", (uint8_t *)&v35, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v37 = 2112;
        v38 = v16;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Not handling resident update notification because it is for non-primary resident device: %@", (uint8_t *)&v35, 0x16u);
      }
    }
  }
}
...
- (void)handlePrimaryResidentUpdateNotification:(id)a3
{
  ...
  if ([v8 isCurrentDeviceAvailableResident])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      char v18 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Not handling primary resident updated notification because current device is a resident", (uint8_t *)&v17, 0xCu);
    }
  }
  else
  {
  ...
  if ([v13 isCurrentDeviceAvailableResident])
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        int v20 = 138543362;
        v21 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Clearing persisted state since current device this device is enabled as a resident", (uint8_t *)&v20, 0xCu);
      }
...
- (NSNumber)initialReachability
{
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v23 = 2112;
        v24 = v4;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Returning reachability as nil, primary resident UUID: %@ not found in persisted state: %@", (uint8_t *)&v19, 0x20u);
      }
      uint64_t v9 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      int v20 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Returning reachability as nil, no persisted state", (uint8_t *)&v19, 0xCu);
    }
    uint64_t v9 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_153462 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_153462, &__block_literal_global_153463);
  }
  v2 = (void *)logCategory__hmf_once_v5_153464;
  return v2;
}
...
uint64_t __63__HMDHomePrimaryResidentInitialReachabilityManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_153464;
  logCategory__hmf_once_v5_153464 = v0;
