...
- (id)createHap2AccessoryBrowserWithStorage:(id)a3
{
  v4 = (objc_class *)MEMORY[0x1E4F5BC30];
  id v5 = a3;
...
- (id)createCHIPAccessoryBrowser
{
  id v3 = objc_alloc(MEMORY[0x1E4F6A0C0]);
  queue = self->_queue;
...
- (id)createBtleAccessoryBrowser
{
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F5BC28]) initWithQueue:self->_queue];
  return v2;
}

- (id)createIpAccessoryBrowser
{
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F5BC38]) initWithQueue:self->_queue];
  return v2;
}
