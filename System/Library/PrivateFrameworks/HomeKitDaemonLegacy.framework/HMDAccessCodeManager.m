...
uint64_t __70__HMDAccessCodeManager_handleHomeDidEnableCharacteristicNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling home did enable characteristic notification", (uint8_t *)&v7, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t109 != -1) {
    dispatch_once(&logCategory__hmf_once_t109, &__block_literal_global_395);
  }
  v2 = (void *)logCategory__hmf_once_v110;
  return v2;
}
...
- (void)accessCodeDataManager:(id)a3 didRemoveAccessoryAccessCodes:(id)a4
{
  ...
  uint64_t v8 = *MEMORY[0x1E4F2BFF8];
  uint64_t v11 = *MEMORY[0x1E4F2C070];
  uint64_t v9 = encodeRootObjectForIncomingXPCMessage(v5, 0);
...
- (void)accessCodeDataManager:(id)a3 didUpdateAccessoryAccessCodes:(id)a4
{
  ...
  uint64_t v8 = *MEMORY[0x1E4F2C008];
  uint64_t v11 = *MEMORY[0x1E4F2C070];
  uint64_t v9 = encodeRootObjectForIncomingXPCMessage(v5, 0);
...
- (void)accessCodeDataManager:(id)a3 didAddAccessoryAccessCodes:(id)a4
{
  ...
  uint64_t v8 = *MEMORY[0x1E4F2BFE8];
  uint64_t v11 = *MEMORY[0x1E4F2C070];
  uint64_t v9 = encodeRootObjectForIncomingXPCMessage(v5, 0);
...
- (void)accessCodeDataManager:(id)a3 didRemoveHomeAccessCodes:(id)a4 removedByUserUUID:(id)a5
{
  id v7 = a4;
  id v8 = a5;
  uint64_t v9 = [(HMDAccessCodeManager *)self context];
  v10 = [v9 workQueue];
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
void __89__HMDAccessCodeManager_accessCodeDataManager_didRemoveHomeAccessCodes_removedByUserUUID___block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = *MEMORY[0x1E4F2C000];
  uint64_t v24 = *MEMORY[0x1E4F2C088];
  id v3 = *(void **)(a1 + 32);
  v4 = encodeRootObjectForIncomingXPCMessage(*(void **)(a1 + 40), 0);
  v25[0] = v4;
  id v5 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v25 forKeys:&v24 count:1];
    ...
    && [*(id *)(a1 + 32) hasCurrentUserAccessCodeChangedWithChangedAccessCodes:*(void *)(a1 + 40) home:v7])
  {
          ...
          (v10 & 1) == 0))
    {
      ...
      v17 = [v16 bulletinBoard];
      [v17 insertAccessCodeRemovedBulletinForHome:v7];
    }
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v15;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Not creating access code removed bulletin because it was removed by current user: %@", (uint8_t *)&v20, 0x16u);
      }
    }
    v18 = [*(id *)(a1 + 32) context];
    v19 = [v18 walletKeyManager];
    [v19 handleAccessCodeChanged];
  }
...
{
  v25[1] = *MEMORY[0x1E4F143B8];
  uint64_t v2 = *MEMORY[0x1E4F2C010];
  uint64_t v24 = *MEMORY[0x1E4F2C088];
  id v3 = *(void **)(a1 + 32);
  v4 = encodeRootObjectForIncomingXPCMessage(*(void **)(a1 + 40), 0);
  v25[0] = v4;
    ...
    && [*(id *)(a1 + 32) hasCurrentUserAccessCodeChangedWithChangedAccessCodes:*(void *)(a1 + 40) home:v7])
  {
          ...
          (v10 & 1) == 0))
    {
      v16 = [*(id *)(a1 + 32) context];
      v17 = [v16 bulletinBoard];
      [v17 insertAccessCodeChangedBulletinForHome:v7];
    }
    else
    {
      id v11 = (void *)MEMORY[0x1D9452090]();
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v15;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Not creating access code changed bulletin because it was changed by current user: %@", (uint8_t *)&v20, 0x16u);
      }
    }
    v18 = [*(id *)(a1 + 32) context];
    v19 = [v18 walletKeyManager];
...
{
  v25[1] = *MEMORY[0x1E4F143B8];
  uint64_t v2 = *MEMORY[0x1E4F2BFF0];
  uint64_t v24 = *MEMORY[0x1E4F2C088];
  id v3 = *(void **)(a1 + 32);
  v4 = encodeRootObjectForIncomingXPCMessage(*(void **)(a1 + 40), 0);
  v25[0] = v4;
    ...
    && [*(id *)(a1 + 32) hasCurrentUserAccessCodeChangedWithChangedAccessCodes:*(void *)(a1 + 40) home:v7])
  {
          ...
          (v10 & 1) == 0))
    {
      v16 = [*(id *)(a1 + 32) context];
      v17 = [v16 bulletinBoard];
      [v17 insertAccessCodeAddedBulletinForHome:v7];
    }
    else
    {
      id v11 = (void *)MEMORY[0x1D9452090]();
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v15;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Not creating access code added bulletin because it was added by current user: %@", (uint8_t *)&v20, 0x16u);
      }
    }
    v18 = [*(id *)(a1 + 32) context];
    v19 = [v18 walletKeyManager];
...
- (id)_waitUntilDataHasSyncedToResidentForAccessoryUUIDs:(id)a3
{
  ...
  id v17 = v4;
  id v13 = v4;
  id v14 = [v5 futureWithRetries:v7 timeInterval:v12 workQueue:v16 block:v10];
...
id __75__HMDAccessCodeManager__waitUntilDataHasSyncedToResidentForAccessoryUUIDs___block_invoke(uint64_t a1)
{
  ...
  __int16 v22 = __75__HMDAccessCodeManager__waitUntilDataHasSyncedToResidentForAccessoryUUIDs___block_invoke_2;
  uint64_t v23 = &unk_1E6A17DF0;
  uint64_t v24 = *(void *)(a1 + 32);
  id v10 = v2;
  id v25 = v10;
  id v11 = (void *)MEMORY[0x1D9452090]([v9 setResponseHandler:&v20]);
  id v12 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    uint64_t v29 = v15;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Pinging resident to confirm data has synced for accessories: %@", buf, 0x16u);
  }
...
void __75__HMDAccessCodeManager__waitUntilDataHasSyncedToResidentForAccessoryUUIDs___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to confirm resident has data with error: %@", (uint8_t *)&v13, 0x16u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      int v13 = 138543362;
      id v14 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Resident confirmed that data has synced", (uint8_t *)&v13, 0xCu);
    }
...
- (void)_updateAccessoryAccessCodeCache
{
  ...
  int v6 = (void *)MEMORY[0x1E4F654B0];
  uint64_t v7 = *MEMORY[0x1E4F2C020];
  uint64_t v13 = *MEMORY[0x1E4F2C078];
  id v8 = [(HMDAccessCodeManager *)self context];
...
- (void)_generateNewAccessCodeWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v16 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Generating new access code", buf, 0xCu);
  }
...
void __61__HMDAccessCodeManager__generateNewAccessCodeWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5 && v6)
  {
    id v8 = objc_msgSend(v5, "na_map:", &__block_literal_global_382);
    double v9 = objc_msgSend(v7, "na_flatMap:", &__block_literal_global_385);
    uint64_t v10 = [*(id *)(a1 + 32) dataManager];
    id v11 = [v10 homeAccessCodeValues];
    id v12 = objc_msgSend(v11, "na_map:", &__block_literal_global_391);
    ...
    if (v14)
    {
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v33 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Successfully generated new access code", buf, 0xCu);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v33 = v27;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate new access code", buf, 0xCu);
      }
      uint64_t v28 = *(void *)(a1 + 40);
      uint64_t v29 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v38 = 2112;
      v39 = v25;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to read constraints: %@, and access codes: %@, from accessories with UUIDs: %@", buf, 0x2Au);
    }
...
id __61__HMDAccessCodeManager__generateNewAccessCodeWithCompletion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  uint64_t v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_388);
...
uint64_t __61__HMDAccessCodeManager__generateNewAccessCodeWithCompletion___block_invoke_379(uint64_t a1, void *a2)
{
...
- (id)_addNewAccessCode:(id)a3 forUserWithUUID:(id)a4 toAccessoriesWithUUIDs:(id)a5 withRetries:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v31 = 2112;
    id v32 = v12;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Adding new access code to accessories with UUIDs: %@", buf, 0x16u);
  }
...
{
  uint64_t v3 = (objc_class *)MEMORY[0x1E4F2E4B8];
  id v4 = a2;
...
{
  id v3 = (objc_class *)MEMORY[0x1E4F2E4E0];
  id v4 = a2;
...
- (id)_resetAccessCodesForHomeAccessCode:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Resetting access codes for home access code: %@", buf, 0x16u);
  }
...
- (id)_createNewAccessCodeForUserWithUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating new access code for user with UUID: %@", buf, 0x16u);
  }
  id v9 = objc_alloc_init(MEMORY[0x1E4F7A0D8]);
...
void __60__HMDAccessCodeManager__createNewAccessCodeForUserWithUUID___block_invoke(id *a1, void *a2, uint64_t a3, uint64_t a4)
{
  ...
  if (v6)
  {
    id v7 = (void *)[objc_alloc(MEMORY[0x1E4F2E4E8]) initWithSimpleLabel:0 labelIdentifier:0 userUUID:a1[5] removedUserInfo:0];
...
- (void)_notifySubscribersOfMessageWithName:(id)a3 payload:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v36 = 2112;
    id v37 = v26;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribers of message with name: %@", buf, 0x20u);
  }
  long long v29 = 0u;
  long long v30 = 0u;
  long long v27 = 0u;
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v19 = [MEMORY[0x1E4F654B0] entitledMessageWithName:v26 messagePayload:v25];
...
- (void)_generateNewUserAccessCodeForMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v31 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Generating new user access code for message.", buf, 0xCu);
  }
  ...
  uint64_t v15 = [v13 stringForKey:*MEMORY[0x1E4F2C098]];
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v31 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@User already has an access code, so doing nothing.", buf, 0xCu);
    }
    id v24 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2600];
...
void __61__HMDAccessCodeManager__generateNewUserAccessCodeForMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    id v7 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 40) _updateCacheWithModificationResponses:v5]);
    id v8 = *(id *)(a1 + 40);
    id v9 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to message with modification responses: %@", buf, 0x16u);
    }
    id v11 = *(void **)(a1 + 32);
    uint64_t v14 = *MEMORY[0x1E4F2C048];
...
- (void)_resetAccessoryAccessCodesForMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v25 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Resetting access code for message", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeManager *)v8 context];
  id v12 = [v11 remoteMessageForwarder];
  id v13 = [v12 messageForForwardedMessage:v4];

  uint64_t v14 = *MEMORY[0x1E4F2C080];
...
- (id)_removeAccessCode:(id)a3 forUserBeingRemoved:(id)a4
{
  ...
  id v10 = (void *)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:v6];
...
void __62__HMDAccessCodeManager__removeAccessCode_forUserBeingRemoved___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v5 || objc_msgSend((id)objc_msgSend(*(id *)(a1 + 32), "utilities"), "anyModificationFailed:", v5))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      id v20 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@At least one modification response failed, so saving removedUserAccessCode", (uint8_t *)&v19, 0xCu);
    }
    id v11 = objc_alloc(MEMORY[0x1E4F2EA58]);
...
{
  id v6 = (id)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:*(void *)(a1 + 32)];
...
- (id)_removeAccessCode:(id)a3 forUser:(id)a4 removedByUserUUID:(id)a5
{
  ...
  id v13 = (void *)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:v8];
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v9;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Did not find any current or former user with UUID: %@", (uint8_t *)&v26, 0x16u);
      }
...
- (void)_setAccessCodeForUserForMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v66 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Setting access code for user for message.", buf, 0xCu);
  }
  id v10 = [v54 proxyConnection];
  id v11 = [v10 clientIdentifier];
  int v12 = [v11 isEqualToString:*MEMORY[0x1E4F2D748]];
  ...
  uint64_t v17 = [v16 stringForKey:*MEMORY[0x1E4F2C050]];
  id v18 = objc_alloc(MEMORY[0x1E4F29128]);
  uint64_t v19 = [v16 stringForKey:*MEMORY[0x1E4F2C098]];
        ...
        (v27 & 1) != 0))
  {
    ...
    {
      v52 = v13;
      __int16 v28 = &byte_1D54D2FA0[96];
      if (v17)
      {
        id v29 = (void *)v25;
        uint64_t v30 = (void *)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:v17];
        __int16 v31 = (void *)[objc_alloc(MEMORY[0x1E4F2E4E8]) initWithSimpleLabel:0 labelIdentifier:0 userUUID:v20 removedUserInfo:0];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v40;
        _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@A nil access code was passed but the user has no access code, so responding with success", buf, 0xCu);
      }
      uint64_t v63 = *MEMORY[0x1E4F2C048];
      __int16 v36 = encodeRootObjectForIncomingXPCMessage(MEMORY[0x1E4F1CBF0], 0);
      v64 = v36;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v69 = 2112;
      v70 = v20;
      _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Dropping request: The user: %@ does not have permission to change the access code for the user: %@", buf, 0x20u);

      id v13 = v46;
      uint64_t v17 = v51;
    }
    v48 = [MEMORY[0x1E4F28C58] hmErrorWithCode:53];
    [v16 respondWithError:v48];

    __int16 v36 = [MEMORY[0x1E4F28C58] hmErrorWithCode:53];
...
{
  uint64_t v2 = [MEMORY[0x1E4F7A0D8] futureWithResult:MEMORY[0x1E4F1CBF0]];
  if (*(void *)(a1 + 32))
  {
    uint64_t v3 = [*(id *)(a1 + 40) accessoryReaderWriter];
    id v4 = (void *)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:*(void *)(a1 + 32)];
  ...
  v12[1] = 3221225472;
  void v12[2] = __56__HMDAccessCodeManager__setAccessCodeForUserForMessage___block_invoke_2;
  v12[3] = &unk_1E6A0E0D8;
  v12[4] = *(void *)(a1 + 40);
  id v13 = *(id *)(a1 + 56);
  id v14 = *(id *)(a1 + 48);
  id v7 = v6;
  id v15 = v7;
  id v8 = (id)[v2 addCompletionBlock:v12];
  id v9 = v15;
  id v10 = v7;
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding to message with modification responses: %@", buf, 0x16u);
    }
    id v12 = a1[5];
    uint64_t v21 = *MEMORY[0x1E4F2C048];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v16;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Responding to message with error: %@", buf, 0x16u);
    }
...
void __56__HMDAccessCodeManager__setAccessCodeForUserForMessage___block_invoke_2(uint64_t a1)
{
  ...
  id v6 = [v2 UUIDsOfAccessoriesSupportingAccessCodes];

  uint64_t v3 = [*(id *)(a1 + 32) _addNewAccessCode:*(void *)(a1 + 40) forUserWithUUID:*(void *)(a1 + 48) toAccessoriesWithUUIDs:v6 withRetries:1];
  id v4 = [*(id *)(a1 + 56) completionHandlerAdapter];
  id v5 = (id)[v3 addCompletionBlock:v4];
}
...
void __97__HMDAccessCodeManager__removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure_forUserUUID___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v28 = v12;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@At least one modification failed, so we will not remove the home access code.", buf, 0xCu);
      }
    ...
    else
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v28 = v17;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory access code removals succeeded, so now removing the home access code.", buf, 0xCu);
      }
      id v18 = [*(id *)(a1 + 32) dataManager];
      id v19 = [v18 removeHomeAccessCodeWithValue:*(void *)(a1 + 48) removedByUserUUID:0];
      v24[0] = MEMORY[0x1E4F143A8];
      v24[1] = 3221225472;
      v24[2] = __97__HMDAccessCodeManager__removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure_forUserUUID___block_invoke_368;
      v24[3] = &unk_1E6A19730;
      id v25 = *(id *)(a1 + 40);
      id v26 = v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v28 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to remove accessory access codes", buf, 0xCu);
    }
    [*(id *)(a1 + 40) finishWithError:v6];
  }
}

uint64_t __97__HMDAccessCodeManager__removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure_forUserUUID___block_invoke_368(uint64_t a1)
{
...
- (void)_removeSimpleLabelAccessCodeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v36 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing simple label access code for message.", buf, 0xCu);
  }
  BOOL v11 = [(HMDAccessCodeManager *)v8 context];
  id v12 = [v11 remoteMessageForwarder];
  id v13 = [v12 messageForForwardedMessage:v4];

  id v14 = [v13 stringForKey:*MEMORY[0x1E4F2C050]];
  id v15 = (void *)[objc_alloc(MEMORY[0x1E4F2E4F0]) initWithStringValue:v14];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v36 = v27;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@A home access code with the specified value does not exist, so we have nothing to do.", buf, 0xCu);
    }
    uint64_t v33 = *MEMORY[0x1E4F2C048];
    id v23 = encodeRootObjectForIncomingXPCMessage(MEMORY[0x1E4F1CBF0], 0);
    __int16 v34 = v23;
    __int16 v28 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v34 forKeys:&v33 count:1];
...
void __60__HMDAccessCodeManager__removeSimpleLabelAccessCodeMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v5 = *MEMORY[0x1E4F2C048];
...
- (id)_updateModificationRequestsWithUserOrGuestNames:(id)a3
{
  ...
  v5[3] = &unk_1E6A056A0;
  v5[4] = self;
  uint64_t v3 = objc_msgSend(a3, "na_map:", v5);
  return v3;
}
...
LABEL_17:
    ...
    id v17 = [v16 simpleLabelForAccessCode:v13];
    [v9 setGuestName:v17];

    char v18 = [*(id *)(a1 + 32) dataManager];
    id v19 = [v18 userUUIDForAccessCode:v13];
    [v9 setUserUUID:v19];
...
LABEL_16:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    int v27 = 138543362;
    __int16 v28 = v25;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received modification request of unknown type", (uint8_t *)&v27, 0xCu);
  }
  id v26 = v9;
LABEL_18:
...
- (void)_submitAccessCodeModificationRequestsForMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v40 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting AccessCodeModificationRequests for message.", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeManager *)v8 context];
  id v12 = [v11 remoteMessageForwarder];
  id v13 = [v12 messageForForwardedMessage:v4];

  uint64_t v14 = *MEMORY[0x1E4F2C040];
  v43[0] = objc_opt_class();
  v43[1] = objc_opt_class();
  v43[2] = objc_opt_class();
  v43[3] = objc_opt_class();
  id v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:v43 count:4];
  ...
  if (v16 && !objc_msgSend(v16, "hmf_isEmpty"))
  {
      ...
      || ([(objc_class *)[(HMDAccessCodeManager *)v8 utilities] allModificationRequests:v16 areAddingAccessCode:v27] & 1) != 0)
    {
      ...
      uint64_t v29 = [(HMDAccessCodeManager *)v8 accessoryReaderWriter];
      id v30 = [v29 performAccessCodeModificationRequests:v28 withRetries:1];
      ...
      v37[4] = v8;
      id v38 = v13;
      id v31 = (id)[v30 addCompletionBlock:v37];
    }
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = [v22 uuid];
        *(_DWORD *)buf = 138543618;
        uint64_t v40 = v35;
        __int16 v41 = 2112;
        v42 = v36;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Dropping request: The user: %@ is not an admin and attempted to change an access code that does not belong to them", buf, 0x16u);
      }
      __int16 v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:53];
      [v13 respondWithError:v28];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2112;
      v42 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find modification requests in message payload: %@", buf, 0x16u);
    }
...
void __72__HMDAccessCodeManager__submitAccessCodeModificationRequestsForMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    int v7 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) _updateCacheWithModificationResponses:v5]);
    id v8 = *(id *)(a1 + 32);
    id v9 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      id v23 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to client with modification response values: %@", buf, 0x16u);
    }
    id v11 = *(void **)(a1 + 40);
    uint64_t v18 = *MEMORY[0x1E4F2C048];
    id v12 = encodeRootObjectForIncomingXPCMessage(v5, 0);
    id v19 = v12;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      id v23 = v6;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform modification requests with error: %@", buf, 0x16u);
    }
...
- (void)_fetchAccessCodeConstraintsForMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v29 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Fetching access code constraints for message.", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeManager *)v8 context];
  id v12 = [v11 remoteMessageForwarder];
  id v13 = [v12 messageForForwardedMessage:v4];

  uint64_t v14 = *MEMORY[0x1E4F2C078];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find accessory UUIDs in message payload: %@", buf, 0x16u);
    }
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      id v21 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding with constraints: %@", buf, 0x16u);
    }
    id v12 = *(void **)(a1 + 40);
    uint64_t v16 = *MEMORY[0x1E4F2C060];
    id v13 = encodeRootObjectForIncomingXPCMessage(v5, 0);
    id v17 = v13;
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to read access code constraints with error: %@", buf, 0x16u);
    }
    [*(id *)(a1 + 40) respondWithError:v6];
  }
}
...
- (void)_fetchAccessCodesForMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v29 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Fetching access codes for message.", buf, 0xCu);
  }
  id v11 = [(HMDAccessCodeManager *)v8 context];
  id v12 = [v11 remoteMessageForwarder];
  id v13 = [v12 messageForForwardedMessage:v4];
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        id v33 = v10;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Responding to message with fetch responses: %@", buf, 0x16u);
      }
      id v15 = *(void **)(a1 + 40);
      uint64_t v28 = *MEMORY[0x1E4F2C068];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        id v33 = v26;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine which user sent the message: %@", buf, 0x16u);
      }
      id v27 = *(void **)(a1 + 40);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v6;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to read access codes with error: %@", buf, 0x16u);
    }
    [*(id *)(a1 + 40) respondWithError:v6];
  }
}
    ...
    if ([v10 primaryResidentSupportsAccessCodes])
    {
      ...
      if (v12)
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          int v28 = 138543362;
          uint64_t v29 = v16;
          _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Redispatching message to resident.", (uint8_t *)&v28, 0xCu);
        }
        if (v7)
        {
        ...
        {
          id v17 = [(HMDAccessCodeManager *)v14 context];
...
LABEL_16:
    ...
    if ((v21 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        int v28 = 138543362;
        uint64_t v29 = v26;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@There is no resident available, so nothing can be done.", (uint8_t *)&v28, 0xCu);
      }
      id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:91];
...
uint64_t __71__HMDAccessCodeManager_handleHomeDidDisableCharacteristicNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling home did disable characteristic notification", (uint8_t *)&v7, 0xCu);
  }
...
- (void)handleAccessorySupportsAccessCodeDidChangeNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      BOOL v22 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Not handling access code support change for accessory in other home", buf, 0xCu);
    }
  }
}
...
void __58__HMDAccessCodeManager_handleHomeUserRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v33 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Removed user does not have an access code, so nothing to do.", buf, 0xCu);
    }
    goto LABEL_15;
  }
  id v11 = *(void **)(a1 + 40);
  id v12 = [v11 dataManager];
  id v13 = (void *)MEMORY[0x1E4F2E800];
  uint64_t v14 = [v5 accessCode];
  id v15 = [v5 uuid];
  uint64_t v16 = [v13 homeAccessCodeValueWithStringValue:v14 userUUID:v15];
  id v31 = v16;
  id v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v31 count:1];
  ...
  if ((v11 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v34 = 2112;
      id v35 = v30;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Not removing access codes for removed user since isCurrentDevicePrimaryResident: %@", buf, 0x16u);
    }
LABEL_15:
    goto LABEL_16;
  }
...
- (void)handleUserAccessCodeDidChangeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2048;
    uint64_t v18 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling UserAccessCodeDidChangeMessage with changeType: %lu", (uint8_t *)&v15, 0x16u);
  }
  id v11 = [(HMDAccessCodeManager *)v8 context];
  id v12 = [v11 home];
...
- (void)handleConfirmDataHasSyncedToResidentMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling ConfirmDataHasSyncedToResidentMessage", buf, 0xCu);
  }
  uint64_t v11 = *MEMORY[0x1E4F2C078];
  v27[0] = objc_opt_class();
  v27[1] = objc_opt_class();
  id v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v27 count:2];
  ...
  if (v14)
  {
    if (v18)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v13;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Resident has all accessories for UUIDs: %@", buf, 0x16u);
    }
  ...
  else
  {
    if (v18)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v13;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Resident does not have all accessories for UUIDs: %@", buf, 0x16u);
    }
...
- (void)handleGenerateNewUserAccessCodeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v19 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling GenerateNewUserAccessCodeMessage", buf, 0xCu);
  }
  objc_initWeak((id *)buf, v8);
  uint64_t v12 = MEMORY[0x1E4F143A8];
  uint64_t v13 = 3221225472;
  int v14 = __63__HMDAccessCodeManager_handleGenerateNewUserAccessCodeMessage___block_invoke;
  int v15 = &unk_1E6A17958;
...
void __63__HMDAccessCodeManager_handleGenerateNewUserAccessCodeMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  uint64_t v9 = *MEMORY[0x1E4F2C048];
...
- (void)handleResetAccessoryAccessCodesMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling ResetAccessoryAccessCodesMessage: %@", buf, 0x16u);
  }
  objc_initWeak((id *)buf, v8);
  uint64_t v12 = MEMORY[0x1E4F143A8];
  uint64_t v13 = 3221225472;
...
- (void)handleFetchCachedAccessCodesMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling FetchCachedAccessCodesMessage", buf, 0xCu);
  }
  id v11 = (void *)MEMORY[0x1D9452090]();
  uint64_t v12 = v8;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    id v26 = v16;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Responding with cached access codes: %@", buf, 0x16u);
  }
...
- (void)handleFetchHomeAccessCodesMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v22 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling FetchHomeAccessCodesMessage", buf, 0xCu);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    uint64_t v24 = v12;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Responding with home access codes: %@", buf, 0x16u);
  }
  uint64_t v19 = *MEMORY[0x1E4F2C088];
  id v17 = encodeRootObjectForIncomingXPCMessage(v12, 0);
  __int16 v20 = v17;
  BOOL v18 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v20 forKeys:&v19 count:1];
...
- (void)handleFetchAccessCodeConstraintsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v32 = 2112;
    id v33 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling FetchAccessCodeConstraintsMessage: %@", buf, 0x16u);
  }
  v29[0] = objc_opt_class();
  v29[1] = objc_opt_class();
  id v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:v29 count:2];
  uint64_t v12 = [v4 unarchivedObjectForKey:*MEMORY[0x1E4F2C078] ofClasses:v11];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v17;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find accessory UUIDs in message payload: %@", buf, 0x16u);
    }
    BOOL v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
void __64__HMDAccessCodeManager_handleFetchAccessCodeConstraintsMessage___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Data never synced to the resident for accessories: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)handleFetchAccessCodesMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v32 = 2112;
    id v33 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling FetchAccessCodesMessage: %@", buf, 0x16u);
  }
  v29[0] = objc_opt_class();
  v29[1] = objc_opt_class();
  int v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:v29 count:2];
  uint64_t v12 = [v4 unarchivedObjectForKey:*MEMORY[0x1E4F2C078] ofClasses:v11];
...
void __54__HMDAccessCodeManager_handleFetchAccessCodesMessage___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  id v7 = a2;
  id WeakRetained = objc_loadWeakRetained(v5);
  uint64_t v9 = *MEMORY[0x1E4F2C068];
...
- (void)handleRemoveHomeAccessCodeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v26 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling RemoveHomeAccessCodeMessage", buf, 0xCu);
  }
  uint64_t v11 = *MEMORY[0x1E4F2C058];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v26 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find data in payload while attempting to remove home access code", buf, 0xCu);
    }
...
void __58__HMDAccessCodeManager_handleRemoveHomeAccessCodeMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove home access code with error: %@", (uint8_t *)&v11, 0x16u);
    }
    [*(id *)(a1 + 40) respondWithError:v6];
  }
  else
...
- (void)handleSetUserInformationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v29 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling SetUserInformationMessage", buf, 0xCu);
  }
  uint64_t v11 = *MEMORY[0x1E4F2C090];
  v33[0] = objc_opt_class();
  uint64_t v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v33 count:1];
  __int16 v13 = [v4 unarchivedObjectForKey:v11 ofClasses:v12];

  uint64_t v14 = *MEMORY[0x1E4F2C058];
  ...
  if (v13 && v16)
  {
    ...
    v25[1] = 3221225472;
    void v25[2] = __56__HMDAccessCodeManager_handleSetUserInformationMessage___block_invoke;
    v25[3] = &unk_1E6A17908;
    v25[4] = v8;
    id v26 = v13;
    id v27 = v4;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v13;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not find data in payload while attempting to set userInfo: %@", buf, 0x16u);
    }
...
void __56__HMDAccessCodeManager_handleSetUserInformationMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to set userInfo: %@, with error: %@", (uint8_t *)&v12, 0x20u);
    }
...
- (void)handleRemoveSimpleLabelAccessCodeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling RemoveSimpleLabelAccessCodeMessage: %@", buf, 0x16u);
  }
  objc_initWeak((id *)buf, v8);
  uint64_t v12 = MEMORY[0x1E4F143A8];
  uint64_t v13 = 3221225472;
  __int16 v14 = __65__HMDAccessCodeManager_handleRemoveSimpleLabelAccessCodeMessage___block_invoke;
  uint64_t v15 = &unk_1E6A17958;
  objc_copyWeak(&v17, (id *)buf);
  id v11 = v4;
  id v16 = v11;
...
- (void)handleSetAccessCodeForUserMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling SetAccessCodeForUserMessage: %@", buf, 0x16u);
  }
  objc_initWeak((id *)buf, v8);
  uint64_t v12 = MEMORY[0x1E4F143A8];
  uint64_t v13 = 3221225472;
...
- (void)handleSubmitAccessCodeModificationRequestsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling SubmitAccessCodeModificationRequestsMessage: %@", buf, 0x16u);
  }
  objc_initWeak((id *)buf, v8);
  uint64_t v12 = MEMORY[0x1E4F143A8];
  uint64_t v13 = 3221225472;
...
- (void)handleUnsubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    int v26 = 138543362;
    id v27 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling client unsubscribe message", (uint8_t *)&v26, 0xCu);
  }
  id v11 = [v4 transport];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      int v26 = 138543362;
      id v27 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding with no payload after removing client from subscribed clients", (uint8_t *)&v26, 0xCu);
    }
    [v4 respondWithSuccess];
  }
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v30 = 2112;
      id v31 = v24;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Subscribing transport was not of expected class %@: %@", (uint8_t *)&v26, 0x20u);
    }
...
- (void)handleSubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    int v26 = 138543362;
    id v27 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling client subscribe message", (uint8_t *)&v26, 0xCu);
  }
  id v11 = [v4 transport];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      int v26 = 138543362;
      id v27 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding with no payload after adding client to subscribed clients", (uint8_t *)&v26, 0xCu);
    }
    [v4 respondWithSuccess];
  }
  else
  ...
  if (v14)
  {
    if (v18)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v32 = 2112;
      id v33 = v9;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Found cached access code for identifier: %@, accessory UUID: %@", buf, 0x20u);
    }
  ...
  else
  {
    if (v18)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v32 = 2112;
      id v33 = v9;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Fetching access code for identifier: %@, accessory UUID: %@", buf, 0x20u);
    }
    ...
    v25[0] = MEMORY[0x1E4F143A8];
    v25[1] = 3221225472;
    void v25[2] = __78__HMDAccessCodeManager_fetchAccessCodeForIdentifier_accessoryUUID_completion___block_invoke;
    v25[3] = &unk_1E6A05678;
    v25[4] = v16;
    id v26 = v8;
    id v27 = v10;
...
void __78__HMDAccessCodeManager_fetchAccessCodeForIdentifier_accessoryUUID_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Fetched access code for access code identifier: %@", (uint8_t *)&v17, 0x16u);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      __int16 v21 = 2112;
      id v22 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to fetch access code for access code identifier: %@ with error: %@", (uint8_t *)&v17, 0x20u);
    }
...
- (void)configureWithMessageDispatcher:(id)a3
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v74 = 2112;
    v75 = v9;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Configuring HMDAccessCodeManager with UUID: %@, for home: %@", buf, 0x20u);
  }
  uint64_t v16 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
  uint64_t v17 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  uint64_t v18 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v9 userPrivilege:0 remoteAccessRequired:0];
  __int16 v19 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v9 userPrivilege:4 remoteAccessRequired:0];
  v69[0] = v16;
  v69[1] = v18;
  v64 = (void *)v18;
  uint64_t v20 = [MEMORY[0x1E4F1C978] arrayWithObjects:v69 count:2];
  v68[0] = v16;
  v68[1] = v17;
  uint64_t v63 = (void *)v17;
  v68[2] = v18;
  __int16 v21 = [MEMORY[0x1E4F1C978] arrayWithObjects:v68 count:3];
  id v22 = [(HMDAccessCodeManager *)v11 context];
  uint64_t v23 = [v22 messageDispatcher];
  [v23 registerForMessage:*MEMORY[0x1E4F2C0D0] receiver:v11 policies:v20 selector:sel_handleSubscribeMessage_];

  id v24 = [(HMDAccessCodeManager *)v11 context];
  id v25 = [v24 messageDispatcher];
  [v25 registerForMessage:*MEMORY[0x1E4F2C0D8] receiver:v11 policies:v20 selector:sel_handleUnsubscribeMessage_];

  id v26 = [(HMDAccessCodeManager *)v11 context];
  id v27 = [v26 messageDispatcher];
  [v27 registerForMessage:*MEMORY[0x1E4F2C020] receiver:v11 policies:v21 selector:sel_handleFetchAccessCodesMessage_];

  __int16 v28 = [(HMDAccessCodeManager *)v11 context];
  uint64_t v29 = [v28 messageDispatcher];
  [v29 registerForMessage:*MEMORY[0x1E4F2C018] receiver:v11 policies:v21 selector:sel_handleFetchAccessCodeConstraintsMessage_];

  __int16 v30 = [(HMDAccessCodeManager *)v11 context];
  id v31 = [v30 messageDispatcher];
  [v31 registerForMessage:*MEMORY[0x1E4F2C030] receiver:v11 policies:v20 selector:sel_handleFetchHomeAccessCodesMessage_];

  __int16 v32 = [(HMDAccessCodeManager *)v11 context];
  id v33 = [v32 messageDispatcher];
  [v33 registerForMessage:*MEMORY[0x1E4F2C028] receiver:v11 policies:v20 selector:sel_handleFetchCachedAccessCodesMessage_];

  uint64_t v34 = [(HMDAccessCodeManager *)v11 context];
  id v35 = [v34 messageDispatcher];
  [v35 registerForMessage:*MEMORY[0x1E4F2C0B0] receiver:v11 policies:v21 selector:sel_handleResetAccessoryAccessCodesMessage_];

  uint64_t v36 = [(HMDAccessCodeManager *)v11 context];
  uint64_t v37 = [v36 messageDispatcher];
  [v37 registerForMessage:*MEMORY[0x1E4F2C0B8] receiver:v11 policies:v21 selector:sel_handleSetAccessCodeForUserMessage_];

  id v38 = [(HMDAccessCodeManager *)v11 context];
  v39 = [v38 messageDispatcher];
  [v39 registerForMessage:*MEMORY[0x1E4F2C0C8] receiver:v11 policies:v21 selector:sel_handleSubmitAccessCodeModificationRequestsMessage_];

  uint64_t v40 = [(HMDAccessCodeManager *)v11 context];
  __int16 v41 = [v40 messageDispatcher];
  ...
  v67[0] = v16;
  v67[1] = v19;
  v44 = [MEMORY[0x1E4F1C978] arrayWithObjects:v67 count:2];
  v66[0] = v16;
  v66[1] = v17;
  v66[2] = v19;
  ...
  [v47 registerForMessage:*MEMORY[0x1E4F2C0C0] receiver:v11 policies:v44 selector:sel_handleSetUserInformationMessage_];

  v48 = [(HMDAccessCodeManager *)v11 context];
  id v49 = [v48 administratorHandler];
  [v49 registerForMessage:*MEMORY[0x1E4F2C0A0] receiver:v11 policies:v44 selector:sel_handleRemoveHomeAccessCodeMessage_];

  uint64_t v50 = [(HMDAccessCodeManager *)v11 context];
  uint64_t v51 = [v50 messageDispatcher];
  [v51 registerForMessage:*MEMORY[0x1E4F2C038] receiver:v11 policies:v45 selector:sel_handleGenerateNewUserAccessCodeMessage_];

  v52 = [(HMDAccessCodeManager *)v11 context];
  v53 = [v52 messageDispatcher];
  [v53 registerForMessage:*MEMORY[0x1E4F2C0A8] receiver:v11 policies:v45 selector:sel_handleRemoveSimpleLabelAccessCodeMessage_];
...
{
  logCategory__hmf_once_v110 = HMFCreateOSLogHandle();
