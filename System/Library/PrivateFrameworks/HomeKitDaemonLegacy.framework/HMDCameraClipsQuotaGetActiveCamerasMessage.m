...
@implementation HMDCameraClipsQuotaGetActiveCamerasMessage
...
- (BOOL)readFrom:(id)a3
{
  char v4 = (int *)MEMORY[0x1E4F940E8];
...
- (NSString)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HMDCameraClipsQuotaGetActiveCamerasMessage;
  char v4 = [(HMDCameraClipsQuotaGetActiveCamerasMessage *)&v8 description];
  v5 = [(HMDCameraClipsQuotaGetActiveCamerasMessage *)self dictionaryRepresentation];
