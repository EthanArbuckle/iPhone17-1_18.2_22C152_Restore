  ...
  if (v3 != -1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 1024;
      unsigned int v17 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting features: %u", buf, 0x12u);
    }
  }
  accessoryIdentifier = self->_accessoryIdentifier;
  [MEMORY[0x1E4F1C978] arrayWithObjects:&accessoryIdentifier count:1];
      ...
      if (![(__CFArray *)a2 count])
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v38 = 2112;
          v39 = a4;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find accessory with error: %@", buf, 0x16u);
        }
        v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:0 reason:0 suggestion:0 underlyingError:a4];
...
LABEL_23:
    ...
    v33 = a4;
    v34 = v9;
    id v12 = [MEMORY[0x1E4F1CA48] arrayWithCapacity:Count];
    CFIndex v13 = 0;
    p_superclass = &OBJC_METACLASS___HMDBulletinBoardCameraNotificationAssociation.superclass;
    v15 = &OBJC_IVAR___HMDLocationTuple__reachableBTLEAccessoryCount;
    CFIndex v35 = v11;
    do
    {
      __int16 v16 = objc_msgSend(objc_alloc((Class)(p_superclass + 414)), "initWithOutputDevice:", CFArrayGetValueAtIndex(a2, v13));
      unsigned int v17 = v16;
      if (v16)
      {
        uint64_t v18 = *(void **)&v8[v15[365]];
        ...
        if (v18)
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v38 = 2112;
            v39 = v17;
            _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Found output device: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to create reconnaissance session with nil identifier", buf, 0xCu);
    }
    CFIndex v13 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_44518 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_44518, &__block_literal_global_14_44519);
  }
  v2 = (void *)logCategory__hmf_once_v10_44520;
  return v2;
}
...
uint64_t __47__HMDMediaAccessoryBrowseOperation_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v10_44520;
  logCategory__hmf_once_v10_44520 = v0;
...
+ (double)defaultTimeout
{
  if (defaultTimeout_onceToken != -1) {
    dispatch_once(&defaultTimeout_onceToken, &__block_literal_global_44525);
  }
...
{
  uint64_t v0 = [MEMORY[0x1E4F65530] sharedPreferences];
  uint64_t v1 = [v0 preferenceForKey:@"mediaAccessoryResolutionTimeout"];
