...
- (void)encodeWithCoder:(id)a3
{
  ...
  shortcutData = self->_shortcutData;
  if (shortcutData) {
    [v4 encodeObject:shortcutData forKey:*MEMORY[0x1E4F2E470]];
  }
}
...
- (HMDShortcutAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    objc_super v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2E470]];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v23 = 2112;
        id v24 = v14;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to process model update with error: %@", buf, 0x16u);
      }
    }
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v24 = 2112;
      if (v9) {
        id v18 = &stru_1F2C9F1A8;
      }
      uint64_t v25 = v16;
      __int16 v26 = 2112;
      v27 = v18;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] %@ requires device to be unlock", buf, 0x20u);
    }
  }
  else
  {
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2112;
      id v15 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Does this shortcut action contain any unsecuring actions: [%@]", buf, 0x16u);
    }
  }
  else
  {
  ...
  if (a1 && WorkflowKitLibraryCore())
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Shortcuts framework is available on this OS", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        uint32_t v26 = 32;
LABEL_13:
        _os_log_impl(&dword_1D49D5000, v24, v25, v23, buf, v26);
      }
    }
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      id v37 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Going to deserialize shortcut dictionary [%@]", buf, 0x16u);
    }
    ...
    id v32 = v16;
    id v33 = v9;
    char v17 = (void *)MEMORY[0x1D9452090](objc_msgSend(v10, "hmf_enumerateWithAutoreleasePoolUsingBlock:", v30));
    uint64_t v18 = v12;
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      id v37 = v15;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Found actionSets from shortcut dictionary : %@", buf, 0x16u);
    }
    uint32_t v26 = (void *)MEMORY[0x1D9452090](v21, v22, v23, v24, v25);
    v27 = v18;
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      id v37 = v16;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Found characteristics from shortcut dictionary : %@", buf, 0x16u);
    }
  }
}
...
- (void)unpackActionsAndActionSets:(void *)a3 actionSets:(void *)a4 characteristicWriteTuples:(void *)a5 homeUUID:
{
  ...
  if (a1)
  {
    uint64_t v11 = *MEMORY[0x1E4F2C910];
    id v12 = objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x1E4F2C910]);
    if ([v12 isEqualToString:*MEMORY[0x1E4F2C918]])
    {
      id v13 = objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x1E4F2C920]);
      char v14 = [v13 isEqualToString:*MEMORY[0x1E4F2C928]];

      if (v14)
      {
        uint64_t v15 = objc_msgSend(v9, "hmf_dataForKey:", *MEMORY[0x1E4F2C908]);
        if (!v15)
        {
          v154 = 0;
          v155 = (void *)MEMORY[0x1D9452090]();
          id v156 = a1;
          ...
          if (os_log_type_enabled(v157, OS_LOG_TYPE_ERROR))
          {
            ...
            *(void *)&uint8_t buf[4] = v158;
            _os_log_impl(&dword_1D49D5000, v157, OS_LOG_TYPE_ERROR, "%{public}@Did not find any serialized homekit data in this shortcut dictionary", buf, 0xCu);
          }
          goto LABEL_159;
        }
        v201 = (void *)v15;
        id v16 = (void *)[objc_alloc(MEMORY[0x1E4F2E9E0]) initWithData:v15];
        v202 = v16;
        if (!v16)
        {
          v159 = (void *)MEMORY[0x1D9452090]();
          id v160 = a1;
          ...
          if (os_log_type_enabled(v161, OS_LOG_TYPE_ERROR))
          {
            ...
            *(void *)&uint8_t buf[4] = v162;
            _os_log_impl(&dword_1D49D5000, v161, OS_LOG_TYPE_ERROR, "%{public}@Could not initialize PB actionSet data", buf, 0xCu);
          }
          v154 = v201;
          goto LABEL_158;
        }
        char v17 = (void *)MEMORY[0x1E4F29128];
        uint64_t v18 = v16;
        v19 = [v16 uuid];
        ...
        if (v20)
        {
          if ([v18 hasHomeUUID])
          {
            uint64_t v21 = (void *)MEMORY[0x1E4F29128];
                ...
                while (1)
                {
                  ...
                  do
                  {
                    ...
                    if ([v32 hasUniqueIdentifier])
                    {
                      ...
                      {
                        id v33 = (void *)MEMORY[0x1E4F29128];
                        ...
                        if (!v35)
                        {
                          ...
                          if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
                          {
                            ...
                            *(void *)&uint8_t buf[4] = v73;
                            _os_log_impl(&dword_1D49D5000, v72, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode characteristic uniqueIdentifier", buf, 0xCu);
                          }
                          id v63 = 0;
                          goto LABEL_111;
                        }
                        ...
                        if ([v36 hasUniqueIdentifier])
                        {
                          if ([v36 hasAccessoryReference])
                          {
                            ...
                            if ([v37 hasUniqueIdentifier])
                            {
                              ...
                              {
                                v198 = v36;
                                uint64_t v38 = (void *)MEMORY[0x1E4F29128];
                                          ...
                                          if (!v54)
                                          {
                                            ...
                                            if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
                                            {
                                              ...
                                              *(void *)&uint8_t buf[4] = v58;
                                              _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode service uniqueIdentifier", buf, 0xCu);
                                            }
                                            id v51 = v179;
                                          }
                                          long long v221 = 0u;
...
LABEL_95:
                                            ...
                                            if (os_log_type_enabled(v124, OS_LOG_TYPE_INFO))
                                            {
                                              ...
                                              *(_DWORD *)v224 = 138543618;
                                              ...
                                              __int16 v226 = 2112;
                                              v227 = v35;
                                              _os_log_impl(&dword_1D49D5000, v124, OS_LOG_TYPE_INFO, "%{public}@Unable to find the characteristic with uniqueIdentifier: %@", v224, 0x16u);
...
LABEL_96:
                                            ...
                                            if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
                                            {
                                              ...
                                              *(_DWORD *)v228 = 138543618;
                                              ...
                                              __int16 v230 = 2112;
                                              v231 = v189;
                                              _os_log_impl(&dword_1D49D5000, v120, OS_LOG_TYPE_INFO, "%{public}@Unable to find the service with uniqueIdentifier : %@", v228, 0x16u);
                                        ...
                                        else
                                        {
                                          ...
                                          if (os_log_type_enabled(v106, OS_LOG_TYPE_ERROR))
                                          {
                                            ...
                                            *(_WORD *)&buf[12] = 2112;
                                            *(void *)&buf[14] = v197;
                                            _os_log_impl(&dword_1D49D5000, v106, OS_LOG_TYPE_ERROR, "%{public}@Can't find accessory %@", buf, 0x16u);
                                          }
                                          id v63 = 0;
                                          v40 = v197;
                                          __int16 v36 = v198;
                                      ...
                                      else
                                      {
                                        ...
                                        if (os_log_type_enabled(v109, OS_LOG_TYPE_ERROR))
                                        {
                                          ...
                                          *(void *)&buf[14] = v184;
                                          ...
                                          __int16 v235 = 2112;
                                          v236 = v112;
                                          _os_log_impl(&dword_1D49D5000, v109, OS_LOG_TYPE_ERROR, "%{public}@Trying to dereference characteristic reference from different home [Looking for :%@] against [spiIdenfitifer : %@], [UUID : %@]", buf, 0x2Au);
                                    ...
                                    else
                                    {
                                      ...
                                      if (os_log_type_enabled(v102, OS_LOG_TYPE_ERROR))
                                      {
                                        ...
                                        *(void *)&uint8_t buf[4] = v103;
                                        _os_log_impl(&dword_1D49D5000, v102, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode Home uniqueIdentifier", buf, 0xCu);
                                      }
                                      id v63 = 0;
                                      v40 = v197;
                                      __int16 v36 = v198;
                                  ...
                                  else
                                  {
                                    ...
                                    if (os_log_type_enabled(v98, OS_LOG_TYPE_ERROR))
                                    {
                                      ...
                                      *(void *)&uint8_t buf[4] = v99;
                                      _os_log_impl(&dword_1D49D5000, v98, OS_LOG_TYPE_ERROR, "%{public}@Characteristic write action's HomeReference does not have uniqueIdentifier set", buf, 0xCu);
                                    }
                                    id v63 = 0;
                                    v40 = v197;
                                    __int16 v36 = v198;
                                ...
                                else
                                {
                                  ...
                                  if (os_log_type_enabled(v94, OS_LOG_TYPE_ERROR))
                                  {
                                    ...
                                    *(void *)&uint8_t buf[4] = v95;
                                    _os_log_impl(&dword_1D49D5000, v94, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode accessory uniqueIdentifier", buf, 0xCu);
                                  }
                                  id v63 = 0;
                                  v40 = 0;
                                  __int16 v36 = v198;
...
LABEL_68:
                                _os_log_impl(&dword_1D49D5000, v90, OS_LOG_TYPE_ERROR, v91, buf, 0xCu);
...
LABEL_62:
                            _os_log_impl(&dword_1D49D5000, v81, OS_LOG_TYPE_ERROR, v82, buf, 0xCu);
...
LABEL_53:
                        _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_ERROR, v69, buf, 0xCu);
                      }
                    }
...
LABEL_112:
                    ...
                    v126 = (void *)MEMORY[0x1E4F28DC0];
                    v127 = [MEMORY[0x1E4F2E778] allowedTargetValueClassesForShortcuts];
                    ...
                    if (v130)
                    {
                      ...
                      if (os_log_type_enabled(v133, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(void *)&buf[14] = v130;
                        ...
                        __int16 v237 = 2112;
                        id v238 = v204;
                        _os_log_impl(&dword_1D49D5000, v133, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive allowed target value from target value data (%@) for characteristic: %@ in action set: %@ home: %@", buf, 0x34u);
                      }
                    }
                      ...
                      else
                      {
                        ...
                        if (os_log_type_enabled(v145, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *(void *)&uint8_t buf[4] = v146;
                          _os_log_impl(&dword_1D49D5000, v145, OS_LOG_TYPE_INFO, "%{public}@Did not find the target value belonging to the write action", buf, 0xCu);
                        }
                      }
                      uint64_t v27 = v207;
                      goto LABEL_130;
...
LABEL_123:
                    ...
                    if (os_log_type_enabled(v141, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(void *)&uint8_t buf[4] = v142;
                      _os_log_impl(&dword_1D49D5000, v141, OS_LOG_TYPE_INFO, "%{public}@Did not find the accessory/characteristic belonging to the write action", buf, 0xCu);
                    }
LABEL_130:
...
LABEL_132:
              ...
              if (os_log_type_enabled(v175, OS_LOG_TYPE_ERROR))
              {
                ...
                *(void *)&buf[14] = v204;
                __int16 v233 = 2112;
                id v234 = v192;
                _os_log_impl(&dword_1D49D5000, v175, OS_LOG_TYPE_ERROR, "%{public}@Cannot deserialize actionSet for different home. expected home :%@, found home :%@", buf, 0x20u);
              }
LABEL_155:
              v154 = v201;
              v168 = v192;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v171, OS_LOG_TYPE_ERROR))
              {
                ...
                *(void *)&uint8_t buf[4] = v172;
                _os_log_impl(&dword_1D49D5000, v171, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode Home UUID", buf, 0xCu);
              }
              v154 = v201;
            }
...
LABEL_147:
            _os_log_impl(&dword_1D49D5000, v165, OS_LOG_TYPE_ERROR, v167, buf, 0xCu);
          }
        }
...
LABEL_159:
    ...
    if (os_log_type_enabled(v149, OS_LOG_TYPE_ERROR))
    {
      ...
      v153 = objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x1E4F2C920]);
      *(_DWORD *)buf = 138543874;
      ...
      *(void *)&buf[14] = v152;
      __int16 v233 = 2112;
      id v234 = v153;
      _os_log_impl(&dword_1D49D5000, v149, OS_LOG_TYPE_ERROR, "%{public}@Protobuf version mismatch : ProtoKey: %@, ProtoVersion: %@", buf, 0x20u);
...
uint64_t __58__HMDShortcutAction_doesActionSetContainUnsecuringAction___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v3;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@ActionSet %@ unsecure the home : %@", (uint8_t *)&v11, 0x20u);
  }
  ...
  if (![v4 isEqual:v3])
  {
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v30 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Could not find actionSet based on actionSet.uuid. Now searching using spiClientIdentifier", buf, 0xCu);
      }
      ...
      if (!v15)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v31 = 2112;
          id v32 = v21;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find actionSet [%@]", buf, 0x16u);
        }
        uint64_t v13 = 0;
        id v15 = v28;
        goto LABEL_13;
...
LABEL_4:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v35 = 2112;
    __int16 v36 = v12;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Skipping actionSet to avoid cycle. [Checking ActionSet : %@] against [ActionSetUUID: %@] [ActionSet SPI Identifier: %@]", buf, 0x2Au);
  }
  uint64_t v13 = 0;
LABEL_14:
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Does this shortcut action contain any secure class accessories: [%@]", buf, 0x16u);
    }
  }
  else
  {
...
uint64_t __62__HMDShortcutAction_doesActionSetContainSecureCharacteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v3;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@ActionSet %@ contain secure class accessory : %@", (uint8_t *)&v11, 0x20u);
  }
...
- (void)executeWithSource:(unint64_t)a3 clientName:(id)a4 completionHandler:(id)a5
{
  ...
  if (WorkflowKitLibraryCore() && self->_controller)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Executing shortcut action : %{public}@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v24 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@The shortcut action is unavailable to execute", buf, 0xCu);
    }
    if (v8)
    {
      v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
...
void __68__HMDShortcutAction_executeWithSource_clientName_completionHandler___block_invoke(uint64_t a1, void *a2, int a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2114;
      id v26 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to execute shortcut action %{public}@ with error: %{public}@", (uint8_t *)&v21, 0x20u);
    }
    uint64_t v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1 description:0 reason:0 suggestion:0 underlyingError:v5];
LABEL_9:
  ...
  if (a3)
  {
    if (v14)
    {
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v16;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@shortcut action execution was cancelled : %@", (uint8_t *)&v21, 0x16u);
    }
  ...
  if (v14)
  {
    ...
    __int16 v23 = 2112;
    uint64_t v24 = v20;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Shortcut action successfully executed : %@", (uint8_t *)&v21, 0x16u);
  }
  uint64_t v17 = 0;
LABEL_10:
...
- (id)stateDump
{
  ...
  id v6 = objc_msgSend(v4, "na_map:", &__block_literal_global_1675);
  v11.receiver = self;
...
- (id)dictionaryRepresentation
{
  ...
  if (shortcutData)
  {
    uint64_t v10 = *MEMORY[0x1E4F2E470];
    v11[0] = shortcutData;
...
{
  logCategory__hmf_once_uint64_t v54 = HMFCreateOSLogHandle();
...
+ (id)actionWithDictionaryRepresentation:(id)a3 home:(id)a4 actionSet:(id)a5
{
  ...
  {
    uint64_t v12 = objc_msgSend(v8, "hmf_dataForKey:", *MEMORY[0x1E4F2E470]);
    if (v12)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v8;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized shortcut: %@", (uint8_t *)&v25, 0x16u);
      }
      __int16 v15 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v11;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", (uint8_t *)&v25, 0x16u);
    }
    __int16 v15 = 0;
  }
