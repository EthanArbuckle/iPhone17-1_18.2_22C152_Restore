...
- (HMDBackingStoreOperation)initWithResultBlock:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_id operationFinishBlock = &__block_literal_global_131825;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_131832 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_131832, &__block_literal_global_5_131833);
  }
  v2 = (void *)logCategory__hmf_once_v1_131834;
  return v2;
}
...
uint64_t __39__HMDBackingStoreOperation_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_131834;
  logCategory__hmf_once_v1_131834 = v0;
