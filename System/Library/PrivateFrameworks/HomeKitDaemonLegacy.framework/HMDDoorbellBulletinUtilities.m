...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_47117 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_47117, &__block_literal_global_45);
  }
  v2 = (void *)logCategory__hmf_once_v10_47118;
  return v2;
}
...
uint64_t __43__HMDDoorbellBulletinUtilities_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v10_47118;
  logCategory__hmf_once_v10_47118 = v0;
...
{
  id v3 = a3;
  v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_40_47136);
  v5 = objc_msgSend(v3, "na_map:", &__block_literal_global_42);
...
- (id)faceClassificationsNearDateOfDoorbellPress:(id)a3 forCameraProfile:(id)a4
{
  ...
  v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_37_47139);
...
- (id)significantEventsRelevantToDoorbellPress:(id)a3 forCameraProfile:(id)a4
{
  ...
  if (v8)
  {
    ...
    v10 = objc_msgSend(v9, "na_map:", &__block_literal_global_35_47144);
    if (objc_msgSend(v10, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v11;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@The following significant events were found for the clip containing the doorbell press: %@", (uint8_t *)&v25, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v9;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@The following significant events were found within the time window: %@", (uint8_t *)&v25, 0x16u);
      }
      id v11 = v9;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      int v25 = 138543362;
      v26 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Clip Manager is nil, returning empty set for significant events relevant to doorbell press", (uint8_t *)&v25, 0xCu);
    }
...
- (id)_significantEventsWithinTimeWindowOfDoorbellPress:(id)a3 forCameraProfile:(id)a4
{
  ...
  if (v8)
  {
    uint64_t v9 = [MEMORY[0x1E4F1C9C8] dateWithTimeInterval:v6 sinceDate:-30.0];
    v10 = [MEMORY[0x1E4F1C9C8] dateWithTimeInterval:v6 sinceDate:30.0];
    v23 = (void *)v9;
    id v11 = (void *)[objc_alloc(MEMORY[0x1E4F28C18]) initWithStartDate:v9 endDate:v10];
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v32 = 2112;
      id v33 = v6;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Found recent significant events: %@ for camera profile: %@, with date interval: %@, dateOfDoorbellPress: %@", buf, 0x34u);
    }
    v17 = [MEMORY[0x1E4F1CAD0] setWithArray:v12];
  }
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v25 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Clip Manager is nil, returning empty set for significant events in time window", buf, 0xCu);
    }
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v25 = 2112;
      id v26 = v11;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    }
...
- (id)_localizedDoorbellMessageForSignificantEvents:(id)a3 forAudioAccessory:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v48 = 2112;
    v49 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Determining localized camera doorbell message from significant events: %@", buf, 0x16u);
  }
  id v11 = [(__CFString *)v6 na_map:&__block_literal_global_47162];
  v12 = [(__CFString *)v6 na_filter:&__block_literal_global_3_47163];
  v13 = [v11 allObjects];
  v14 = objc_msgSend(v13, "na_map:", &__block_literal_global_6_47164);
    ...
    if (!v34)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v52 = 2112;
        id v53 = v35;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
      }
      v36 = v30;
    }
    v17 = v36;
