...
- (void)_handleSelectedStreamConfigurationWriteResponses:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    int v27 = 138543362;
    v28 = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received response for selected stream configuration write", (uint8_t *)&v27, 0xCu);
  }
  v13 = [v6 firstObject];
  v14 = v13;
  if (v13)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v29 = 2114;
      v30 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to write selected stream configuration: the write reply ended in error response: %{public}@", (uint8_t *)&v27, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      v28 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to write selected stream configuration: the write reply did not contain any responses", (uint8_t *)&v27, 0xCu);
    }
...
- (void)_writeSelectedStreamConfigurationData:(id)a3 completion:(id)a4
{
  ...
  if (v9)
  {
    ...
    v11 = [v10 findCharacteristicWithType:*MEMORY[0x1E4F5B900]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to write selected stream configuration: accessory reference is nil", buf, 0xCu);
    }
    v11 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
...
- (void)_handleSetupEndPointReadResponses:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v49 = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received response for setup endpoint read", buf, 0xCu);
  }
  long long v46 = 0u;
  long long v47 = 0u;
  long long v44 = 0u;
  ...
  if (v14)
  {
    ...
    uint64_t v17 = *MEMORY[0x1E4F5B908];
    do
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v50 = 2112;
          v51 = v43;
          _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to read setup endpoint: could not initialize setup endpoint from TLV data: %@", buf, 0x16u);
        }
        v39 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1042];
        v40[2](v40, 0, v39);
      }
      goto LABEL_27;
    }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v49 = v34;
    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to read setup endpoint: the reply does not contain the expected response", buf, 0xCu);
  }
  __int16 v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
  v7[2](v7, 0, v29);
  v28 = obj;
LABEL_27:
}
...
- (void)_handleSetupEndPointWriteResponses:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response for setup endpoint write", buf, 0xCu);
  }
  v36 = v9;
  ...
  if (v13)
  {
    ...
    uint64_t v16 = *MEMORY[0x1E4F5B908];
LABEL_5:
    uint64_t v17 = 0;
    while (1)
    {
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        long long v45 = v30;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to write setup endpoint: %@", buf, 0x16u);
      }
...
LABEL_17:
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v35;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to write setup endpoint: the reply does not contain the expected response", buf, 0xCu);
    }
    id v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
...
- (void)_handleReadSupportedConfigurationsResponses:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v84 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response for supported configurations read", buf, 0xCu);
  }
  long long v81 = 0u;
  long long v82 = 0u;
  long long v79 = 0u;
...
LABEL_29:
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v84 = v46;
      _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: Supported configurations read response did not include supported video stream configuration", buf, 0xCu);
    }
    id v37 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
    v42 = v71;
  ...
  uint64_t v76 = *MEMORY[0x1E4F5B930];
  uint64_t v73 = *MEMORY[0x1E4F5B920];
  uint64_t v72 = *MEMORY[0x1E4F5B928];
  id obj = v12;
  do
  {
  ...
  if (!v37)
  {
    ...
    if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v85 = 2112;
      v86 = v77;
      _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: Could not initialize video stream configuration from TLV data: %@", buf, 0x16u);
    }
    uint64_t v51 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1040];
    goto LABEL_38;
  }
  if (!v74)
  {
    ...
    if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v84 = v55;
      _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: Supported configurations read response did not include supported audio stream configuration", buf, 0xCu);
    }
    uint64_t v51 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
LABEL_38:
  ...
  if (!v39)
  {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v85 = 2112;
      v86 = v74;
      _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: Could not initialize audio stream configuration from TLV data: %@", buf, 0x16u);
    }
    uint64_t v60 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1040];
    goto LABEL_45;
  }
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v84 = v64;
      _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: Supported configurations read response did not include supported RTP configuration", buf, 0xCu);
    }
    uint64_t v60 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
LABEL_45:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v85 = 2112;
      v86 = v15;
      _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: Could not initialize RTP configuration from TLV data: %@", buf, 0x16u);
    }
    v69 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1040];
    v42 = v71;
...
- (void)writeReselectedStreamConfiguration:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Writing reselected stream configuration %@", (uint8_t *)&v14, 0x16u);
  }
...
- (void)writeSelectedStreamConfiguration:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Writing selected stream configuration: %@", (uint8_t *)&v14, 0x16u);
  }
  uint64_t v13 = [v6 tlvData];
  [(HMDCameraLocalStreamAccessoryCommunicator *)v10 _writeSelectedStreamConfigurationData:v13 completion:v7];
}
...
- (void)readSetupEndPointWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Reading setup endpoint", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    id v12 = [v11 findCharacteristicWithType:*MEMORY[0x1E4F5B908]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v24 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to read setup endpoint: accessory reference is nil", buf, 0xCu);
    }
    id v12 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
...
- (void)writeSetupEndPoint:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Writing setup endpoint: %@", buf, 0x16u);
  }
  ...
  if (v13)
  {
    ...
    uint64_t v15 = [v14 findCharacteristicWithType:*MEMORY[0x1E4F5B908]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to write setup endpoint: accessory reference is nil", buf, 0xCu);
    }
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
...
- (void)readSupportedConfigurationsWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v30 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Reading supported configurations", buf, 0xCu);
  }
  v10 = [(HMDCameraLocalStreamAccessoryCommunicator *)v7 accessory];
  if (v10)
  {
    v11 = [(HMDCameraLocalStreamAccessoryCommunicator *)v7 streamManagementService];
    id v12 = [v11 findCharacteristicWithType:*MEMORY[0x1E4F5B930]];

    uint64_t v13 = [(HMDCameraLocalStreamAccessoryCommunicator *)v7 streamManagementService];
    int v14 = [v13 findCharacteristicWithType:*MEMORY[0x1E4F5B920]];

    uint64_t v15 = [(HMDCameraLocalStreamAccessoryCommunicator *)v7 streamManagementService];
    __int16 v16 = [v15 findCharacteristicWithType:*MEMORY[0x1E4F5B928]];
    ...
    v28[2] = v19;
    id v20 = [MEMORY[0x1E4F1C978] arrayWithObjects:v28 count:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v30 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to read supported configurations: accessory reference is nil", buf, 0xCu);
    }
    id v12 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t27_149499 != -1) {
    dispatch_once(&logCategory__hmf_once_t27_149499, &__block_literal_global_149500);
  }
  v2 = (void *)logCategory__hmf_once_v28_149501;
  return v2;
}
...
uint64_t __56__HMDCameraLocalStreamAccessoryCommunicator_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v28_149501;
  logCategory__hmf_once_v28_149501 = v0;
