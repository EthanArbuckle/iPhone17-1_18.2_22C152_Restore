...
- (BOOL)areCurrentResidentCapabilitiesPresentAndDifferent:(id)a3
{
  ...
  v6 = (void *)[objc_alloc(MEMORY[0x1E4F2EA60]) initWithProtoData:v4];
...
- (id)_lastCachedResidentCapabilities
{
  if (a1)
  {
    v2 = (void *)MEMORY[0x1E4F2E580];
    uint64_t v3 = *MEMORY[0x1E4F2C398];
    ...
    if (v9)
    {
      id v10 = objc_alloc(MEMORY[0x1E4F2EA60]);
      v11 = [v9 encodedData];
...
- (BOOL)areCurrentAccessoryCapabilitiesPresentAndDifferent:(id)a3
{
  ...
  v6 = (void *)[objc_alloc(MEMORY[0x1E4F2E518]) initWithProtoData:v4];
...
- (id)_lastCachedAccessoryCapabilities
{
  ...
  {
    v2 = (void *)MEMORY[0x1E4F2E580];
    uint64_t v3 = *MEMORY[0x1E4F2C360];
    id v4 = -[HMDCapabilitiesController homeUUID]((char *)a1);
    v5 = -[HMDCapabilitiesController accessoryUUID]((char *)a1);
    v6 = [v2 topicFromSuffixID:v3 homeUUID:v4 accessoryUUID:v5];
    ...
    if (v9)
    {
      id v10 = objc_alloc(MEMORY[0x1E4F2E518]);
      v11 = [v9 encodedData];
      v12 = (void *)[v10 initWithProtoData:v11];
    }
    else
...
void __55__HMDCapabilitiesController_didRemoveCurrentAccessory___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v8 = 138543362;
      v9 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Reset accessory on removal", (uint8_t *)&v8, 0xCu);
    }
...
void __63__HMDCapabilitiesController_currentAccessoryDidBecomeAvailable__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v35 = 138543362;
    v36 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Current accessory available", (uint8_t *)&v35, 0xCu);
  }
      ...
      if (v9)
      {
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            ...
            int v35 = 138543362;
            v36 = v20;
            _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Current accessory became available and is different", (uint8_t *)&v35, 0xCu);
          }
  ...
  if (a1)
  {
    ...
    if (WeakRetained)
    {
      ...
      if (v5)
      {
        ...
        if (v7)
        {
          int v8 = (void *)MEMORY[0x1E4F2E580];
          uint64_t v9 = *MEMORY[0x1E4F2C360];
          ...
          if (v14)
          {
            if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v30 = 2112;
              id v31 = v3;
              _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Accessory capabilities are the same not posting: %@", buf, 0x16u);
            }
          }
          else
          {
            if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v30 = 2112;
              id v31 = v3;
              _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Posting event as current accessory capabilities are different: %@", buf, 0x16u);
            }
            id v21 = objc_alloc(MEMORY[0x1E4F69F38]);
  ...
  if (a1)
  {
    ...
    if (WeakRetained)
    {
      ...
      if (v5)
      {
        ...
        {
          int v8 = (void *)MEMORY[0x1E4F2E580];
          uint64_t v9 = *MEMORY[0x1E4F2C398];
          uint64_t v10 = -[HMDCapabilitiesController homeUUID]((char *)a1);
          v11 = -[HMDCapabilitiesController accessoryUUID]((char *)a1);
          v12 = [v8 topicFromSuffixID:v9 homeUUID:v10 accessoryUUID:v11];
            ...
            if (v3)
            {
              ...
              if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v31 = 2112;
                id v32 = v3;
                _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Resident capabilities are the same not posting: %@", buf, 0x16u);
              }
            }
          }
          else
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v31 = 2112;
              id v32 = v3;
              _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Posting event as current resident capabilities are different: %@", buf, 0x16u);
            }
            id v22 = objc_alloc(MEMORY[0x1E4F69F38]);
...
- (id)_metadataForEvent
{
  id v2 = objc_alloc(MEMORY[0x1E4F69F48]);
...
void __75__HMDCapabilitiesController__postCurrentResidentCapabilitiesEventIfNeeded___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Posted event for current resident capabilities error: %@", (uint8_t *)&v8, 0x16u);
  }
}
...
void __76__HMDCapabilitiesController__postCurrentAccessoryCapabilitiesEventIfNeeded___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Posted event for current accessory capabilities error: %@", (uint8_t *)&v8, 0x16u);
  }
}
...
- (void)updateCurrentAccessoryCapabilities
{
  ...
  if (self && (id WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource)) != 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Finished loading current capabilities", buf, 0xCu);
    }
    queue = v14->_queue;
    block[0] = MEMORY[0x1E4F143A8];
    block[1] = 3221225472;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Nil dataSource", buf, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_130154 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_130154, &__block_literal_global_130155);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_130156;
  return v2;
}
...
uint64_t __40__HMDCapabilitiesController_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_130156;
  logCategory__hmf_once_v1_130156 = v0;
