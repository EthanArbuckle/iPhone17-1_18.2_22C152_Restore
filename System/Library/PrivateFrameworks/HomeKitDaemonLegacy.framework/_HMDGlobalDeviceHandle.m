  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      v20 = @"HM.token";
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Missing required object for key '%@'", buf, 0x16u);
    }
    v11 = 0;
  }
...
- (id)destination
{
  ...
  v5 = [v4 URI];
  v6 = [v5 prefixedURI];
  objc_super v7 = (void *)MEMORY[0x1D9450AC0](v3, v6);
...
- (id)privateDescription
{
  v3 = [MEMORY[0x1E4F65538] defaultFormatter];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        id v35 = v10;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to parse destination, %@, with error: %@", buf, 0x20u);
      }
      v17 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Missing destination parameter", buf, 0xCu);
    }
    v17 = 0;
  }
...
- (_HMDGlobalDeviceHandle)initWithPushToken:(id)a3 accountHandle:(id)a4
{
  ...
  if (v6)
  {
    ...
    v11 = (void *)MEMORY[0x1D9450AC0](v6, v10);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      __int16 v19 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Missing push token parameter", (uint8_t *)&v18, 0xCu);
    }
    v13 = 0;
  }
