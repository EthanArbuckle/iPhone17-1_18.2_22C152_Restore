...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_23292 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_23292, &__block_literal_global_23293);
  }
  v2 = (void *)logCategory__hmf_once_v3_23294;
  return v2;
}
...
uint64_t __51__HMDCameraIDSDeviceConnectionReceiver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_23294;
  logCategory__hmf_once_v3_23294 = v0;
