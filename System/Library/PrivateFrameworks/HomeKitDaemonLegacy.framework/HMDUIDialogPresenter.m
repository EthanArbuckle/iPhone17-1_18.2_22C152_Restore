...
- (BOOL)_presentDialogWithInfo:(id)a3 options:(unint64_t)a4 targetResponse:(unint64_t)a5 textField:(id *)a6 withContext:(id)a7 selectedByPeerDevice:(BOOL *)a8 timeout:(double)a9
{
  id v16 = a7;
  SInt32 error = -1;
  v17 = CFUserNotificationCreate((CFAllocatorRef)*MEMORY[0x1E4F1CF80], a9, a4, &error, (CFDictionaryRef)a3);
  if (error
  ...
  else
  {
    if (a6)
    {
      CFUserNotificationGetResponseValue(v17, (CFStringRef)*MEMORY[0x1E4F1DA28], 0);
      ...
      if (!v5)
      {
        ...
        if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          id v44 = v6;
LABEL_13:
          _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
...
LABEL_15:
    ...
    uint64_t v18 = *MEMORY[0x1E4F1D9A8];
    ...
    v36[2] = v17;
    v36[3] = v16;
    uint64_t v20 = *MEMORY[0x1E4FA7340];
    v35[4] = *MEMORY[0x1E4F1D9B8];
    v35[5] = v20;
    v36[4] = MEMORY[0x1E4F1CC38];
    v36[5] = MEMORY[0x1E4F1CC38];
    __int16 v21 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v36 forKeys:v35 count:6];
...
void __89__HMDUIDialogPresenter_confirmReportAccessory_context_completionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  v25[0] = *MEMORY[0x1E4F1D990];
  v25[1] = v14;
  v26[0] = v10;
  v26[1] = v11;
  uint64_t v15 = *MEMORY[0x1E4F1D9D0];
  v25[2] = *MEMORY[0x1E4F1DA10];
  v25[3] = v15;
  v26[2] = v12;
  v26[3] = v13;
  id v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v26 forKeys:v25 count:4];
...
- (void)_displayUpgradeNeededWithContext:(id)a3 queue:(id)a4 completionHandler:(id)a5
{
  ...
  uint64_t v14 = *MEMORY[0x1E4F1D9A8];
  v19[0] = *MEMORY[0x1E4F1D990];
  v19[1] = v14;
  v20[0] = v11;
  v20[1] = v12;
  void v19[2] = *MEMORY[0x1E4F1D9E0];
  v20[2] = v13;
...
- (void)_displayiCloudSwitchWithContext:(id)a3 queue:(id)a4 completionHandler:(id)a5
{
  ...
  v22[0] = *MEMORY[0x1E4F1D990];
  v22[1] = v15;
  v23[0] = v11;
  v23[1] = v12;
  uint64_t v16 = *MEMORY[0x1E4F1D9D0];
  v22[2] = *MEMORY[0x1E4F1D9E0];
  v22[3] = v16;
  v23[2] = v14;
  v23[3] = v13;
  char v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v23 forKeys:v22 count:4];
...
- (void)_displayKeychainSyncForHome:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  if (!v17)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v45 = 2112;
      id v46 = v18;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    }
  ...
  uint64_t v26 = *MEMORY[0x1E4F1D9A8];
  v37[0] = *MEMORY[0x1E4F1D990];
  v37[1] = v26;
  v38[0] = v14;
  v38[1] = v23;
  uint64_t v27 = *MEMORY[0x1E4F1D9D0];
  v37[2] = *MEMORY[0x1E4F1D9E0];
  v37[3] = v27;
  v38[2] = v25;
  v38[3] = v24;
  id v28 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v38 forKeys:v37 count:4];
...
- (void)_requestUserPermissionForLegacyWACAccessory:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  v39[2] = *MEMORY[0x1E4F1D9D0];
  v39[3] = v28;
  v40[2] = v25;
  v40[3] = v26;
  BOOL v29 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v40 forKeys:v39 count:4];
...
- (void)_showUserDialogForIncompatibleAccessory:(id)a3 name:(id)a4 category:(id)a5 withContext:(id)a6 queue:(id)a7 completionHandler:(id)a8
{
  ...
  v22[2] = *MEMORY[0x1E4F1D9E0];
  v23[2] = v16;
  id v18 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v23 forKeys:v22 count:3];
...
- (void)_requestUserPermissionForRemovalOfSpecificWiFiCredentialedAccessory:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v41 = 2112;
      id v42 = v17;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
  ...
  v44[0] = v22;
  v43[1] = *MEMORY[0x1E4F1D9A8];
  id v23 = HMDLocalizedStringForKey(@"ACCESSORY_WITH_SPECIFIC_WIFI_CREDENTIAL_REMOVAL_CONFIRM_DETAIL");
  v44[1] = v23;
  v43[2] = *MEMORY[0x1E4F1D9D0];
  id v24 = HMDLocalizedStringForKey(@"CANCEL");
  v44[2] = v24;
  v43[3] = *MEMORY[0x1E4F1D9E0];
  id v25 = HMDLocalizedStringForKey(@"REMOVE");
  v43[4] = *MEMORY[0x1E4FA7300];
  v44[3] = v25;
  v44[4] = &unk_1F2DC7B70;
  uint64_t v26 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v44 forKeys:v43 count:5];
...
- (void)_requestUserPermissionForRemovalOfRouter:(id)a3 accessoriesRequiringManualReconfiguration:(id)a4 withContext:(id)a5 queue:(id)a6 completionHandler:(id)a7
{
  ...
  uint64_t v45 = *MEMORY[0x1E4F1D990];
  v70[0] = *MEMORY[0x1E4F1D990];
  id v14 = localizedWiFiStringKey();
  id v15 = HMDLocalizedStringForKey(v14);
  v71[0] = v15;
  uint64_t v16 = *MEMORY[0x1E4F1D9A8];
  v70[1] = *MEMORY[0x1E4F1D9A8];
  id v17 = localizedWiFiStringKey();
  id v18 = HMDLocalizedStringForKey(v17);
  v71[1] = v18;
  uint64_t v50 = *MEMORY[0x1E4F1D9D0];
  v70[2] = *MEMORY[0x1E4F1D9D0];
  id v19 = HMDLocalizedStringForKey(@"CANCEL");
  v71[2] = v19;
  uint64_t v49 = *MEMORY[0x1E4F1D9E0];
  v70[3] = *MEMORY[0x1E4F1D9E0];
  if (v13) {
    id v20 = @"CONTINUE";
  }
  else {
  ...
  if (v13) {
    id v21 = &unk_1F2DC7B88;
  }
  else {
    id v21 = &unk_1F2DC7B70;
  }
  id v22 = HMDLocalizedStringForKey(v20);
  uint64_t v48 = *MEMORY[0x1E4FA7300];
  v70[4] = *MEMORY[0x1E4FA7300];
  v71[3] = v22;
  v71[4] = v21;
  uint64_t v23 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v71 forKeys:v70 count:5];
...
LABEL_17:
  ...
  {
    id v44 = v24;
    uint64_t v29 = [MEMORY[0x1E4F28DF8] localizedStringByJoiningStrings:v53];
    v68[0] = v45;
    ...
    if (!v33)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v66 = 2112;
        id v67 = v34;
        _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    ...
    v69[3] = v41;
    v69[4] = &unk_1F2DC7B70;
    id v42 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v69 forKeys:v68 count:5];
...
- (void)_requestUserPermissionForDeletionOfHomeWithName:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v51 = 2112;
      id v52 = v14;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    }
  ...
  if (!v22)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v51 = 2112;
      id v52 = v23;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    }
  ...
  uint64_t v30 = *MEMORY[0x1E4F1D9D0];
  v43[0] = *MEMORY[0x1E4F1D990];
  v43[1] = v30;
  v44[0] = v19;
  v44[1] = v28;
  uint64_t v31 = *MEMORY[0x1E4F1D9E0];
  v43[2] = *MEMORY[0x1E4FA72B8];
  v43[3] = v31;
  v44[2] = &unk_1F2DC7B70;
  v44[3] = v29;
  id v32 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v44 forKeys:v43 count:4];
...
- (void)_requestUserPermissionWithAccessoryPPIDInfo:(id)a3 name:(id)a4 category:(id)a5 withContext:(id)a6 queue:(id)a7 completionHandler:(id)a8
{
  ...
  if ([v14 isDenylisted])
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Accessory is Blacklisted - Rejecting", buf, 0xCu);
    }
    block[0] = MEMORY[0x1E4F143A8];
    block[1] = 3221225472;
  ...
  else
  {
    ...
    if (!v29)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v76 = 2112;
        id v77 = v30;
        _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
        ...
        if (!v42)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v76 = 2112;
            id v77 = v43;
            _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    ...
    uint64_t v51 = *MEMORY[0x1E4F1D9A8];
    v68[0] = *MEMORY[0x1E4F1D990];
    v68[1] = v51;
    v69[0] = v23;
    v69[1] = v25;
    uint64_t v52 = *MEMORY[0x1E4F1D9E0];
    v68[2] = *MEMORY[0x1E4F1D9D0];
    v68[3] = v52;
    v69[2] = v49;
    v69[3] = v50;
    uint64_t v53 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v69 forKeys:v68 count:4];
    id v17 = v57;
...
- (void)_requestUserPermissionForBridgeAccessory:(id)a3 withContext:(id)a4 queue:(id)a5 completionHandler:(id)a6
{
  ...
  v24[0] = v12;
  v24[1] = v13;
  uint64_t v17 = *MEMORY[0x1E4F1D9E0];
  v23[2] = *MEMORY[0x1E4F1D9D0];
  v23[3] = v17;
  v24[2] = v14;
  v24[3] = v15;
  id v18 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v24 forKeys:v23 count:4];
...
+ (id)sharedUIDialogPresenter
{
  if (sharedUIDialogPresenter_onceToken != -1) {
    dispatch_once(&sharedUIDialogPresenter_onceToken, &__block_literal_global_40716);
  }
...
uint64_t __47__HMDUIDialogPresenter_sharedUIDialogPresenter__block_invoke()
{
  ...
  uint64_t v1 = sharedUIDialogPresenter_singleton;
