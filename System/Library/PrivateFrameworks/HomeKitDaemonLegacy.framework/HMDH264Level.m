...
- (void)description:(id)a3 indent:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  HMDH264LevelTypeAsString([(HMDH264Level *)self h264Level]);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      unint64_t v5 = [(HMDH264Level *)self h264Level];
      BOOL v6 = v5 == [(HMDH264Level *)v4 h264Level];
    }
    else
    {
      BOOL v6 = 0;
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  unint64_t v5 = [(HMDH264Level *)self h264Level];
  objc_msgSend(NSString, "stringWithFormat:", @"%s_%s", "HMDH264Level", "h264Level");
...
- (HMDH264Level)initWithCoder:(id)a3
{
  ...
  unint64_t v5 = [(HMDH264Level *)&v8 init];
  if (v5)
  {
    id v6 = objc_msgSend(NSString, "stringWithFormat:", @"%s_%s", "HMDH264Level", "h264Level");
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        v12 = -[HMDH264Level initWithH264Level:](v11, "initWithH264Level:", objc_msgSend(v10, "unsignedIntegerValue", (void)v14));
        [v4 addObject:v12];
      }
