...
- (void)downloadLogWithController:(id)a3 nodeId:(id)a4 type:(int64_t)a5 timeout:(double)a6 completion:(id)a7
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v47 = 2112;
    v48 = v21;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Download log via controller %@, nodeId %@, logType %@, timeout %@", (uint8_t *)&v39, 0x34u);
  }
  id v22 = v12;
  objc_opt_class();
  ...
  if (v24)
  {
    v25 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v24];
    if (v25
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v41 = 2112;
        id v42 = v25;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using invalid home UUID: %@", (uint8_t *)&v39, 0x16u);
      }
      v27 = (void (**)(void, void, void))_Block_copy(v14);
      if (v27)
      {
        v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
  {
    ...
    id v44 = v37;
    id v38 = v37;
    _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@Download log called with controller of unexpected class: %@ (%@)", (uint8_t *)&v39, 0x20u);
  }
  v25 = _Block_copy(v14);
  if (v25)
  {
    v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
...
- (void)readAttributeCacheWithController:(id)a3 nodeId:(unint64_t)a4 endpointId:(id)a5 clusterId:(id)a6 attributeId:(id)a7 completion:(id)a8
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v29 = 2048;
    unint64_t v30 = a4;
    _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not reading attribute cache with controller: %@, nodeID: 0x%llx: Unsupported", (uint8_t *)&v25, 0x20u);
  }
...
- (void)subscribeWithController:(id)a3 nodeId:(unint64_t)a4 minInterval:(id)a5 maxInterval:(id)a6 params:(id)a7 shouldCache:(BOOL)a8 completion:(id)a9
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v29 = 2048;
    unint64_t v30 = a4;
    _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not subscribing with controller: %@, nodeID: 0x%llx: Unsupported", (uint8_t *)&v25, 0x20u);
  }
  id v24 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
  v18[2](v18, v24);
}
...
- (void)stopReportsWithController:(id)a3 nodeId:(unint64_t)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v19 = 2048;
    unint64_t v20 = a4;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Stop reports with controller %@, nodeId 0x%llx", (uint8_t *)&v15, 0x20u);
  }
  v9[2](v9);
}
...
- (void)subscribeAttributeWithController:(id)a3 nodeId:(unint64_t)a4 endpointId:(id)a5 clusterId:(id)a6 attributeId:(id)a7 minInterval:(id)a8 maxInterval:(id)a9 params:(id)a10 establishedHandler:(id)a11
{
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138545410;
    ...
    __int16 v52 = 2112;
    id v53 = v21;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Subscribing attribute via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, attributeId %@ minInterval %@, maxInterval %@, params %@", buf, 0x5Cu);
  }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v37 = v30;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Subscribing attribute is not supported yet", buf, 0xCu);
  }
  uint64_t v31 = [(HMDCHIPXPCClientConnection *)v28 remoteObjectProxy];
  v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
...
- (void)invokeCommandWithController:(id)a3 nodeId:(unint64_t)a4 endpointId:(id)a5 clusterId:(id)a6 commandId:(id)a7 fields:(id)a8 timedInvokeTimeout:(id)a9 completion:(id)a10
{
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    __int16 v80 = 2112;
    id v81 = v64;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Invoking command via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, commandId %@, fields %@, timedInvokeTimeout %@", buf, 0x52u);
  }
  if ([(HMDCHIPXPCClientConnection *)v25 allowsOperation])
  {
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        id v45 = v44;
        _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@CHIP invoke command called with controller of unexpected class: %@ (%@)", buf, 0x20u);
    ...
    uint64_t v31 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v30];
    if (v31)
    {
      if (v19 && v65 && v20 && v21)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v68 = 2112;
            id v69 = v31;
            _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using unknown home UUID: %@", buf, 0x16u);
          }
          v57 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
          v22[2](v22, 0, v57);
      ...
      __int16 v46 = (void *)MEMORY[0x1D9452090]();
      id v47 = v25;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        uint32_t v52 = 22;
LABEL_26:
        _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, v50, buf, v52);

        id v19 = v63;
      }
    }

    id v33 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
    v22[2](v22, 0, v33);
LABEL_35:
...
LABEL_36:
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v67 = v39;
    _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Invoke-command operation by backgrounded client not allowed", buf, 0xCu);
  }
  id v30 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
  v22[2](v22, 0, v30);
LABEL_37:
}
...
- (void)writeAttributeWithController:(id)a3 nodeId:(unint64_t)a4 endpointId:(id)a5 clusterId:(id)a6 attributeId:(id)a7 value:(id)a8 timedWriteTimeout:(id)a9 completion:(id)a10
{
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    __int16 v75 = 2112;
    id v76 = v59;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Writing attribute via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, attributeId %@, value %@, timedWriteTimeout %@", buf, 0x52u);
  }
  if ([(HMDCHIPXPCClientConnection *)v25 allowsOperation])
  {
    id v28 = v16;
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        id v43 = v42;
        _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@CHIP write attribute called with controller of unexpected class: %@ (%@)", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v63 = 2112;
            id v64 = v31;
            _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using unknown home UUID: %@", buf, 0x16u);
          }
          v55 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
          v22[2](v22, 0, v55);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        uint32_t v50 = 22;
LABEL_25:
        _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, v48, buf, v50);
...
LABEL_28:
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v62 = v37;
    _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_ERROR, "%{public}@Write operation by backgrounded client not allowed", buf, 0xCu);
  }
  id v30 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
  v22[2](v22, 0, v30);
LABEL_29:
...
- (void)readAttributeWithController:(id)a3 nodeId:(unint64_t)a4 endpointId:(id)a5 clusterId:(id)a6 attributeId:(id)a7 params:(id)a8 completion:(id)a9
{
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v73 = 2112;
    id v74 = v22;
    _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Reading attribute via controller %@, nodeId 0x%llx, endpointId %@, clusterId %@, attributeId %@, params %@", buf, 0x48u);
  }
  if ([(HMDCHIPXPCClientConnection *)v26 allowsOperation])
  {
    ...
    if (v31)
    {
      v32 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v31];
      if (v32)
      {
        v57 = v21;
        id v33 = v18;
        ...
        else
        {
          ...
          v56 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
          v23[2](v23, 0, v56);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v63 = 2112;
          id v64 = v31;
          _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@CHIP Read attribute called with invalid home UUID string: %@", buf, 0x16u);

          id v47 = v59;
        }

        uint64_t v35 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
        v23[2](v23, 0, v35);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        id v46 = v45;
        _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_ERROR, "%{public}@CHIP Read attribute called with controller of unexpected class: %@ (%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v62 = v40;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Read operation by backgrounded client not allowed", buf, 0xCu);
    }
    id v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
    v23[2](v23, 0, v31);
  }
}
...
- (void)getAnyDeviceControllerWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint32_t v52 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Retrieving any shared remote controller", buf, 0xCu);
  }
  long long v49 = 0u;
  long long v50 = 0u;
  long long v47 = 0u;
...
LABEL_18:
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        uint64_t v54 = v15;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Retrieved shared remote controller: %@", buf, 0x16u);
      }
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        uint64_t v54 = v14;
        _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_INFO, "%{public}@Retrieved shared remote controller with no paired CHIP accessory: %@", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint32_t v52 = v34;
    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve any remote controller", buf, 0xCu);
  }
...
- (BOOL)allowsOperation
{
  ...
  if (v4)
  {
    if (v8)
    {
      ...
      int v13 = 138543362;
      id v14 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Client foregrounded", (uint8_t *)&v13, 0xCu);
    }
    return 1;
  }
  else
  {
    if (v8)
    {
      ...
      __int16 v15 = 2112;
      uint64_t v16 = v12;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Client is not foregrounded: entitlement %@", (uint8_t *)&v13, 0x16u);
    }
...
- (void)_getDeviceControllerWithFabricId:(unint64_t)a3 accessories:(id)a4 home:(id)a5 remainingHomes:(id)a6 completion:(id)a7
{
  ...
  while (1)
  {
    while ([v12 count])
    {
      ...
      if ([v16 supportsCHIP])
      {
        ...
        uint64_t v25 = [MEMORY[0x1E4F654B0] messageWithName:*MEMORY[0x1E4F2C3C0] destination:v24 payload:0];
  ...
  id v20 = v12;
LABEL_11:
  __int16 v27 = (void *)MEMORY[0x1D9452090](v21);
  id v28 = self;
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v43 = 2048;
    unint64_t v44 = a3;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve remote controller with fabric Id %llu", buf, 0x16u);
  }
...
void __106__HMDCHIPXPCClientConnection__getDeviceControllerWithFabricId_accessories_home_remainingHomes_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  BOOL v8 = [MEMORY[0x1E4F1C978] arrayWithObjects:v54 count:2];
        ...
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v49 = 2112;
            long long v50 = v24;
            _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Fetched CHIP pairing with fabric Id: %@", buf, 0x16u);
          ...
          __int16 v27 = [*(id *)(v13 + 3792) numberWithUnsignedLongLong:*(void *)(a1 + 72)];
          ...
          if (v28)
          {
            ...
            if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v51 = 2112;
              uint32_t v52 = v34;
              _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Retrieved shared remote controller with fabric Id %llu: %@", buf, 0x20u);
            }
    ...
    if ((v9 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v24 = 2112;
        id v25 = v4;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Registering report handler with home with UUID: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      id v25 = v4;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not register report handler using unknown home UUID: %@", buf, 0x16u);
    }
  }
}
...
void __69__HMDCHIPXPCClientConnection__registerReportHandlerWithHomeWithUUID___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v5;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Dispatching report to client using nodeId %tu, reports %@", (uint8_t *)&v13, 0x20u);
  }
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v30 = 2112;
            uint64_t v31 = v19;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Deregistering report handlers from home: %@", buf, 0x16u);
          ...
          id v20 = objc_msgSend(*(id *)(v7 + 3792), "numberWithInt:", -[HMDCHIPXPCClientConnection pid](v13, "pid"));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t44 != -1) {
    dispatch_once(&logCategory__hmf_once_t44, &__block_literal_global_55678);
  }
  v2 = (void *)logCategory__hmf_once_v45;
  return v2;
}

uint64_t __41__HMDCHIPXPCClientConnection_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v45;
  logCategory__hmf_once_long long v45 = v0;
