...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v5 forKey:*MEMORY[0x1E4F2ED48]];
  ...
  [v4 encodeObject:v7 forKey:*MEMORY[0x1E4F2ED40]];
}

- (HMDMediaSystemComponent)initWithCoder:(id)a3
{
  id v4 = a3;
  v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2ED48]];
  v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"accessory"];
  id v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2ED40]];
...
- (id)serialize
{
  ...
  v5 = [v4 UUIDString];
  [v3 setObject:v5 forKeyedSubscript:*MEMORY[0x1E4F2ED48]];
  ...
  v10 = [v9 serialize];
  [v3 setObject:v10 forKeyedSubscript:*MEMORY[0x1E4F2ED40]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_104824 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_104824, &__block_literal_global_104825);
  }
  v2 = (void *)logCategory__hmf_once_v5_104826;
  return v2;
}
...
uint64_t __38__HMDMediaSystemComponent_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_104826;
  logCategory__hmf_once_v5_104826 = v0;
...
+ (id)mediaSystemComponentWithDictionary:(id)a3 home:(id)a4
{
  ...
  id v5 = a3;
  id v6 = a4;
  id v7 = objc_msgSend(v5, "hmf_UUIDForKey:", *MEMORY[0x1E4F2ED48]);
  if (v7)
  {
    v8 = +[HMDMediaSystemComponent accessoryForMediaSystemComponentWithDictionary:v5 home:v6];
    if (v8)
    {
      id v9 = objc_msgSend(v5, "hmf_dictionaryForKey:", *MEMORY[0x1E4F2ED40]);
      id v10 = (void *)[objc_alloc(MEMORY[0x1E4F2E938]) initWithDictionary:v9];
      if (v10)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v24 = 2112;
          id v25 = v5;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Role entry is nil - cannot create mediaSystemComponent with %@", (uint8_t *)&v22, 0x16u);
        }
        id v11 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v6;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@accessory cannot be looked up - cannot create mediaSystemComponent with %@in home %@", (uint8_t *)&v22, 0x20u);
      }
      id v11 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v5;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@mediaComponentUUID is nil - cannot create mediaSystemComponent with %@", (uint8_t *)&v22, 0x16u);
    }
    id v11 = 0;
  }
...
+ (id)accessoryForMediaSystemComponentWithDictionary:(id)a3 home:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@accessoryUUID is nil transaction dictionary - cannot find accessory with %@in home %@", (uint8_t *)&v14, 0x20u);
    }
    id v9 = 0;
  }
