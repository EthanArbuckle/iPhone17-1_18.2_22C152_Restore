...
- (void)sendNextMessageForDeviceIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v4;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending next queued message %@ to device with identifier: %@", (uint8_t *)&v12, 0x20u);
    }
...
- (HMDDevice)remoteAccessDevice
{
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v21 = 2112;
          v22 = v4;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to find remote access device for home %@", (uint8_t *)&v19, 0x16u);
        }
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      v20 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get home to determine remote access device", (uint8_t *)&v19, 0xCu);
    }
    id v7 = 0;
  }
...
- (void)sendMessageWithName:(id)a3 cameraSessionID:(id)a4 payload:(id)a5 target:(id)a6 device:(id)a7 responseQueue:(id)a8 responseHandler:(id)a9
{
  ...
  if (v19)
  {
    ...
    id v25 = v19;
    id v45 = v25;
    v26 = (void *)MEMORY[0x1D9452090]([v22 setResponseHandler:v41]);
    v27 = self;
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v57 = 2112;
      v58 = v32;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Enqueueing camera message for session ID %@ to %@ using %@", buf, 0x2Au);
...
void __123__HMDCameraResidentMessageHandler_sendMessageWithName_cameraSessionID_payload_target_device_responseQueue_responseHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Did not find the resident device to send the message %@ for session %@", (uint8_t *)&v10, 0x20u);
  }
  uint64_t v8 = *(void *)(a1 + 56);
  v9 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1034];
...
void __123__HMDCameraResidentMessageHandler_sendMessageWithName_cameraSessionID_payload_target_device_responseQueue_responseHandler___block_invoke_12(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    uint64_t v26 = v14;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Received response for message with identifier %@. Sending next message", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_77576 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_77576, &__block_literal_global_77577);
  }
  v2 = (void *)logCategory__hmf_once_v10_77578;
  return v2;
}
...
uint64_t __46__HMDCameraResidentMessageHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v10_77578;
  logCategory__hmf_once_v10_77578 = v0;
