...
- (HMDCloudPairedMetadataVersionConfiguration)initWithAccessoryIdentifier:(id)a3 jsonDictionary:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if (v12)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
          {
            ...
            __int16 v35 = 2112;
            id v36 = v7;
            _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", (uint8_t *)&v31, 0x20u);
          }
          v17 = 0;
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v35 = 2112;
          id v36 = v7;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@JSON contains an invalid '%@' value: %@", (uint8_t *)&v31, 0x20u);
        }
        v17 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v35 = 2112;
        id v36 = v7;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON contains no '%@' value: %@", (uint8_t *)&v31, 0x20u);
      }
      v17 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v33 = 2112;
      v34 = v6;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Version configuration must contain firmware version: %@", (uint8_t *)&v31, 0x16u);
    }
    v17 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_134959 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_134959, &__block_literal_global_134960);
  }
  v2 = (void *)logCategory__hmf_once_v1_134961;
  return v2;
}
...
uint64_t __57__HMDCloudPairedMetadataVersionConfiguration_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_134961;
  logCategory__hmf_once_v1_134961 = v0;
