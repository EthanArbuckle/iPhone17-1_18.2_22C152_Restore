...
- (HMDCameraStreamSession)initWithSessionID:(id)a3 streamingTierType:(unint64_t)a4 remoteCapabilities:(id)a5 streamPreference:(id)a6
{
  ...
  if (v14)
  {
    ...
    {
      id v40 = 0;
      v21 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v20 error:&v40];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v44 = 2112;
          v45 = v22;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive remote streaming capabilities from remote capabilities data: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v44 = 2112;
      v45 = v36;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Initialized stream session with capabilities: %@", buf, 0x16u);
    }
  }
  return v15;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_173535 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_173535, &__block_literal_global_173536);
  }
  v2 = (void *)logCategory__hmf_once_v3_173537;
  return v2;
}
...
uint64_t __37__HMDCameraStreamSession_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_173537;
  logCategory__hmf_once_v3_173537 = v0;
