...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set AirPlay Enable] failed to create AirPlay enable write request", (uint8_t *)location, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set AirPlay Enable] accessory not part of profile", (uint8_t *)location, 0xCu);
      }
  ...
  {
    v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
    if (v6) {
...
void __50__HMDHAPMediaProfile_setEnable_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
    uint64_t v32 = v35[5];
    if (v32) {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v4 encodeObject:v6 forKey:*MEMORY[0x1E4F2D958]];
  }
}
...
- (void)_updateCurrentMediaState:(id)a3 volumePercentage:(id)a4 muted:(id)a5 enable:(id)a6 message:(id)a7
{
  ...
  if (v12 || v13 || v14 || v15)
  {
    id v17 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:3];
    v18 = v17;
    if (v12) {
      [v17 setValue:v12 forKey:*MEMORY[0x1E4F2D9B8]];
    }
    if (v13) {
      [v18 setValue:v13 forKey:*MEMORY[0x1E4F2DA20]];
    }
    if (v14) {
      [v18 setValue:v14 forKey:*MEMORY[0x1E4F2D9A8]];
    }
    long long v41 = v18;
    v19 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:1];
    if (v15)
    {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v48 = 2112;
      id v49 = v14;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated current media state %@, volume %@, muted %@", buf, 0x2Au);
    }
    id v28 = objc_alloc(MEMORY[0x1E4F65488]);
    v29 = [(HMDAccessoryProfile *)v25 uniqueIdentifier];
    v30 = (void *)[v28 initWithTarget:v29];

    v31 = (void *)MEMORY[0x1E4F654B0];
    uint64_t v32 = *MEMORY[0x1E4F2D9C0];
  ...
  if (![(HMDMediaProfile *)&v36 _updateAudioControl:v4])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v38 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@No local media session for hapMediaProfile", buf, 0xCu);
    }
    uint64_t v10 = [v4 numberForKey:*MEMORY[0x1E4F2D988]];
    uint64_t v11 = [v4 numberForKey:*MEMORY[0x1E4F2D970]];
    if (v10 | v11)
    {
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          id v40 = v18;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] accessory not part of profile (%@)", buf, 0x16u);
        }
        id v14 = 0;
        BOOL v5 = 0;
        goto LABEL_33;
      ...
      if (v10)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            long long v38 = v23;
            _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] smart speaker volume is not available", buf, 0xCu);
          }
        }
      }
      if (v11)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            long long v38 = v27;
            _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Updating Audio Control] smart speaker muted is not available", buf, 0xCu);
          }
        }
      }
      ...
      {
        v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27];
        [v4 respondWithError:v29];
      }
    }
    else
    {
      id v14 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27];
          ...
          if (v11)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v42 = 2112;
              v43 = v20;
              _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Write value %@ failed with error %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      uint64_t v41 = v26;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid response with write values %@", buf, 0x16u);

      a1 = v24;
    }

    id v27 = *(void **)(a1 + 40);
    objc_super v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v31 = 2112;
              uint64_t v32 = v20;
              _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Current device is primary:%@ and does not support home hub", buf, 0x16u);
  ...
  if (v4)
  {
    ...
    if (v5 && [v5 isCurrentDevice])
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v18 = 2112;
        uint64_t v19 = v13;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Current device was added as a resident device (%@ / %@) notification.", (uint8_t *)&v14, 0x20u);
      }
...
- (void)_disableCharacteristicNotifications
{
  ...
  if ([v3 count])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v3;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Disabling notifications for characteristics :%@", (uint8_t *)&v12, 0x16u);
    }
  ...
  if (v7)
  {
    ...
    if ([v8 count])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v8;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@%@ notifications for characteristics: %@", (uint8_t *)&v18, 0x20u);
      }
...
- (id)_allCharacteristicsToMonitor
{
  BOOL v3 = (void *)[objc_alloc(MEMORY[0x1E4F1CA48]) initWithCapacity:1];
...
void __60__HMDHAPMediaProfile_handleHomeCharacteristicValuesChanged___block_invoke(uint64_t a1)
{
  uint64_t v1 = a1;
  uint64_t v34 = *MEMORY[0x1E4F143B8];
  uint64_t v19 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(*(id *)(a1 + 32), "count"));
  long long v28 = 0u;
  long long v29 = 0u;
  long long v30 = 0u;
  long long v31 = 0u;
...
- (void)_handleCharacteristicChanges:(id)a3
{
  ...
  uint64_t v7 = *MEMORY[0x1E4F2CEB8];
  uint64_t v8 = *MEMORY[0x1E4F2D050];
  uint64_t v33 = *MEMORY[0x1E4F2CF40];
  do
  {
    uint64_t v9 = 0;
    do
    {
      ...
      if (v12)
      {
        ...
        if (v17 > 4) {
          ...
          uint64_t v18 = qword_1D54D42F8[v17];
        }
...
- (void)updateMediaSessionState:(id)a3 usingCharacteristics:(id)a4
{
  ...
  if (v7)
  {
    ...
    uint64_t v10 = *MEMORY[0x1E4F2CEB8];
    uint64_t v11 = *MEMORY[0x1E4F2D050];
    uint64_t v33 = *MEMORY[0x1E4F2CF40];
    do
    {
      uint64_t v12 = 0;
      do
      {
        ...
        if (v15)
        {
          ...
          if ((unint64_t)(v19 - 1) > 4) {
            ...
            uint64_t v20 = qword_1D54D42F8[v19 - 1];
          }
...
{
  id v9 = a3;
  id v6 = objc_msgSend(a4, "na_filter:", &__block_literal_global_165336);
  if ([v6 count])
  {
...
- (id)_mediaSessionStateFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      __int16 v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session state from profile due to no accessory", (uint8_t *)&v13, 0xCu);
    }
    id v6 = 0;
  }
...
- (id)mediaSessionFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v14 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session from profile due to no media session state from profile", buf, 0xCu);
    }
    id v6 = 0;
  }
...
- (BOOL)_updateRefreshPlayback:(id)a3
{
  ...
  if (!-[HMDMediaProfile _updateRefreshPlayback:](&v50, sel__updateRefreshPlayback_))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v53 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@No local media session for hapMediaProfile", buf, 0xCu);
    }
    ...
    if (v36)
    {
      long long v41 = [MEMORY[0x1E4F1CA48] arrayWithCapacity:3];
      ...
      {
        __int16 v14 = (void *)MEMORY[0x1D9452090](0);
        uint64_t v15 = v5;
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v53 = v17;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker airplay enable state is not available", buf, 0xCu);
        }
      }
      objc_msgSend(v38, "arrayForKey:", *MEMORY[0x1E4F2D9C8], v34);
      long long v48 = 0u;
      long long v49 = 0u;
      long long v46 = 0u;
      long long v47 = 0u;
      ...
      if (v18)
      {
        ...
        uint64_t v20 = *MEMORY[0x1E4F2D9B8];
        uint64_t v21 = *MEMORY[0x1E4F2DA20];
        uint64_t v39 = *MEMORY[0x1E4F2D9A8];
        do
        {
            ...
            if ([v23 isEqual:v20])
            {
              ...
              if (!v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v53 = v28;
                  _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker current media state is not available", buf, 0xCu);
                }
LABEL_39:
            ...
            else if ([v23 isEqual:v21])
            {
              ...
              if (!v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v53 = v29;
                  _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker volume is not available", buf, 0xCu);
                }
                goto LABEL_39;
              }
            }
            else
            {
              ...
              if (!v24)
              {
                ...
                if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v53 = v30;
                  _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] smart speaker muted is not available", buf, 0xCu);
                }
                goto LABEL_39;
              }
            }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v54 = 2112;
        v55 = v11;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Playback] accessory not part of profile (%@)", buf, 0x16u);
      }
    }
...
void __45__HMDHAPMediaProfile__updateRefreshPlayback___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ([v3 count])
  {
    ...
    uint64_t v57 = *MEMORY[0x1E4F2CEB8];
    uint64_t v54 = *MEMORY[0x1E4F2D050];
    uint64_t v52 = *MEMORY[0x1E4F2CF40];
    while (1)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (!v12)
        {
          ...
          if (v22)
          {
            ...
            if (v27 > 4) {
              ...
              uint64_t v28 = qword_1D54D42F8[v27];
            }
...
LABEL_34:
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v66 = 2112;
          v67 = v18;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Read failed with error %@", buf, 0x16u);
...
LABEL_43:
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v66 = 2112;
    v67 = v44;
    _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);

    id WeakRetained = v56;
  }

  id v45 = *(void **)(a1 + 40);
  long long v46 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
...
- (BOOL)_updatePlayback:(id)a3
{
  ...
  else
  {
    ...
    uint64_t v10 = [v4 numberForKey:*MEMORY[0x1E4F2D9B8]];
    if (v10)
    {
      ...
      if (v13)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v33 = v24;
            _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Update Playback] failed to create target media state write request", buf, 0xCu);
          }
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v33 = v20;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Update Playback] accessory not part of profile", buf, 0xCu);
        }
        id v13 = 0;
        BOOL v5 = 0;
      }
    ...
    {
      id v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      int v38 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
    }
...
{
  uint64_t v2 = [(HMDHAPMediaProfile *)self _smartSpeakerService];
  id v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2CF40]];
...
{
  uint64_t v2 = [(HMDHAPMediaProfile *)self _smartSpeakerService];
  id v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2D050]];
...
{
  uint64_t v2 = [(HMDHAPMediaProfile *)self _smartSpeakerService];
  id v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2CEB8]];
...
- (id)_smartSpeakerTargetMediaStateWriteRequestWithPlaybackState:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7 > 6) {
      ...
      uint64_t v8 = qword_1D54D42C0[v7];
    }
...
{
  uint64_t v2 = [(HMDHAPMediaProfile *)self _smartSpeakerService];
  id v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2D010]];
...
- (void)registerForNotifications
{
  ...
  {
    float v13 = (void *)MEMORY[0x1D9452090]();
    float v14 = self;
    id v15 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      float v19 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Not registering for notifications as accessory is nil", buf, 0xCu);
    }
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v5;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot create media profile, cannot determine accessory from services %@", buf, 0x16u);
    }
    uint64_t v12 = 0;
  }
