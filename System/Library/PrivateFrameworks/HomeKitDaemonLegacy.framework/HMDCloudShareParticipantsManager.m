...
- (void)handleHomeDataLoadedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling home data loaded notification: %@", buf, 0x16u);
  }
...
- (void)handleHomeUserRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling home user removed notification: %@", buf, 0x16u);
  }
  v9 = [(HMDCloudShareParticipantsManager *)v6 workQueue];
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
- (void)handleHomeUserAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling home user added notification: %@", buf, 0x16u);
  }
  v9 = [(HMDCloudShareParticipantsManager *)v6 workQueue];
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
- (id)_untrustedInvitationContextForUser:(id)a3 shouldGrantWriteAccess:(BOOL)a4
{
  ...
  if (v9)
  {
    if (v9 == 2)
    {
      id v23 = objc_alloc(MEMORY[0x1E4F69F00]);
      v11 = [v6 uuid];
    ...
    else
    {
      ...
      id v10 = objc_alloc(MEMORY[0x1E4F69F00]);
      v11 = [v6 uuid];
      v12 = [v6 accountHandle];
      __int16 v13 = [v12 value];
...
LABEL_11:
    ...
    uint64_t v22 = [MEMORY[0x1E4F7A0D8] futureWithResult:v21];
    goto LABEL_12;
  }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v28 = 2112;
    v29 = v19;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@User's account handle was of unknown type: %@", (uint8_t *)&v26, 0x16u);
  }
  v20 = (void *)MEMORY[0x1E4F7A0D8];
  v21 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
    ...
    && [v8 canUseUntrustedAccountHandlesForParticipantManager:self])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v34 = 2112;
      v35 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Fetching share invitation context using untrusted account handle for user: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v36 = 2112;
      v37 = v20;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Fetching invitation context for user %@ with cloud share ID future: %@", buf, 0x20u);
    }
    v21 = [v6 cloudShareIDFuture];
    uint64_t v22 = (void *)MEMORY[0x1E4F7A0F0];
...
void __89__HMDCloudShareParticipantsManager_fetchInvitationContextForUser_shouldGrantWriteAccess___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch invitation context due to cloud share ID future error: %@", (uint8_t *)&v8, 0x16u);
  }
}
...
id __89__HMDCloudShareParticipantsManager_fetchInvitationContextForUser_shouldGrantWriteAccess___block_invoke_20(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating share invitation context for user %@ using trusted cloud share id: %@", (uint8_t *)&v14, 0x20u);
  }
  id v9 = objc_alloc(MEMORY[0x1E4F69F00]);
  ...
  uint64_t v12 = [MEMORY[0x1E4F7A0D8] futureWithResult:v11];
...
- (id)fetchInvitationToUser:(id)a3 shouldGrantWriteAccess:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v23 = 2112;
    v24 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Fetching invitation to user %@ with write access: %@", buf, 0x20u);
  }
...
void __81__HMDCloudShareParticipantsManager_fetchInvitationToUser_shouldGrantWriteAccess___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch invitation context: %@", (uint8_t *)&v8, 0x16u);
  }
}
    ...
    if (v10 != [v13 hasWriteAccess])
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v34 = 2112;
        id v35 = v6;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating write access from %@ to %@ for user %@", buf, 0x2Au);
...
void __60__HMDCloudShareParticipantsManager__inviteUser_usingDevice___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        __int16 v27 = 2112;
        id v28 = v15;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending invitation %@ to device: %@", (uint8_t *)&v23, 0x20u);
      }
    ...
    else
    {
      if (v13)
      {
        ...
        __int16 v27 = 2112;
        id v28 = v22;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending invitation %@ to user: %@", (uint8_t *)&v23, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v6;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not create invitation to send to user %@: %@", (uint8_t *)&v23, 0x20u);
    }
  }
}
...
- (void)clearParticipants
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v23 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing share participants", buf, 0xCu);
  }
...
- (void)inviteUser:(id)a3 usingDevice:(id)a4
{
        ...
        (v10 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v7;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Not inviting ineligible user %@ using device: %@", (uint8_t *)&v20, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Inviting user %@ using device: %@", (uint8_t *)&v20, 0x20u);
    }
...
LABEL_38:
      _os_log_impl(&dword_1D49D5000, v49, v50, v48, buf, 0xCu);
    }
LABEL_39:
    ...
    && ([v8 areShareModificationsEnabledForManager:self] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v78 = v54;
      _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_DEBUG, "%{public}@Not updating share participants because share modifications are disabled", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v78 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating share participants", buf, 0xCu);
    }
    uint64_t v13 = [(HMDCloudShareParticipantsManager *)v10 cloudZone];
    uint64_t v14 = [v13 participants];

    uint64_t v15 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v14, "count"));
    long long v73 = 0u;
    long long v74 = 0u;
    long long v75 = 0u;
    long long v76 = 0u;
        ...
        for (uint64_t k = 0; k != v60; ++k)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v79 = 2112;
            v80 = v32;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Revoking cloud share for existing cloud share participant: %@", buf, 0x16u);
          }
          v37 = [(HMDCloudShareParticipantsManager *)v34 cloudZone];
          uint64_t v38 = [v37 revokeShareAccessForParticipant:v32];
          v39 = (void *)MEMORY[0x1E4F7A0F0];
...
- (void)configure
{
  ...
  if (v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v18 = 138543362;
        long long v19 = v17;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Not configuring participants manager because home manager reference is nil", (uint8_t *)&v18, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v18 = 138543362;
      long long v19 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Not configuring participants manager because home reference is nil", (uint8_t *)&v18, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_106593 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_106593, &__block_literal_global_106594);
  }
  v2 = (void *)logCategory__hmf_once_v25_106595;
  return v2;
}
...
uint64_t __47__HMDCloudShareParticipantsManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v25_106595;
  logCategory__hmf_once_v25_106595 = v0;
