...
- (void)_callSessionStarted
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling didSetUp delegate", (uint8_t *)&v9, 0xCu);
  }
...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  uint64_t v15 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1030 underlyingError:v9];
...
- (void)session:(id)a3 receivedInvitationCancelFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ was canceled by: %@", (uint8_t *)&v13, 0x20u);
  }
...
- (void)session:(id)a3 receivedInvitationDeclineFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ has been declined by: %@", (uint8_t *)&v13, 0x20u);
  }
  [(HMDCameraIDSSessionInitiator *)v10 _callSessionEndedWithError:0];
}
...
void __58__HMDCameraIDSSessionInitiator_packetRelay_didStop_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    uint64_t v13 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay did stop: %@ error: %@", (uint8_t *)&v8, 0x20u);
  }
}
...
void __59__HMDCameraIDSSessionInitiator_packetRelay_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2114;
    uint64_t v13 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Packet relay did start: %{public}@ error: %{public}@", (uint8_t *)&v8, 0x20u);
  }
}
...
- (void)_startPacketRelayWithVideoSocket:(int)a3 videoNetworkConfig:(id)a4 cameraVideoSSRC:(unsigned int)a5 audioSocket:(int)a6 audioNetworkConfig:(id)a7 cameraAudioSSRC:(unsigned int)a8
{
  ...
  __int16 v17 = (void *)[objc_alloc(MEMORY[0x1E4F654E0]) initWithName:@"com.apple.homed.packet-relay"];
  [(HMDCameraIDSSessionInitiator *)self setPacketRelayTransaction:v17];

  v67 = [(HMDCameraIDSSessionHandler *)self idsSession];
  if (v67)
  {
    id v18 = objc_alloc_init(MEMORY[0x1E4F47948]);
    ...
    uint64_t v64 = [objc_alloc(MEMORY[0x1E4F47950]) initWithIncomingSSRC:v11 acceptPacketType:0];
    v66 = objc_msgSend(MEMORY[0x1E4F47960], "connectionWithSocket:remoteAddress:packetFilter:", v12, v18);
    unsigned int v21 = (void *)MEMORY[0x1D9452090]();
    __int16 v22 = self;
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v73[4] = 2112;
      *(void *)&v73[6] = v14;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Created video relay connection with SSRC %08x and config: %@", buf, 0x1Cu);
    }
    id v25 = objc_alloc_init(MEMORY[0x1E4F47948]);
    v26 = [v15 ipAddress];
    [v25 setIp:v26];
    ...
    v63 = (void *)[objc_alloc(MEMORY[0x1E4F47950]) initWithIncomingSSRC:v8 acceptPacketType:0];
    uint64_t v28 = objc_msgSend(MEMORY[0x1E4F47960], "connectionWithSocket:remoteAddress:packetFilter:", v10, v25);
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v73[4] = 2112;
      *(void *)&v73[6] = v15;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Created audio relay connection with SSRC %08x and config: %@", buf, 0x1Cu);
    }
    v33 = (void *)MEMORY[0x1E4F47960];
    v34 = [v67 destination];
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v72 = 2112;
      *(void *)v73 = v40;
      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Created IDS relay connection with destination: %@", buf, 0x16u);
    ...
    if (v66 && v28 && v35)
    {
      id v41 = objc_alloc(MEMORY[0x1E4F47958]);
      v69[0] = v66;
      v69[1] = v28;
      v42 = [MEMORY[0x1E4F1C978] arrayWithObjects:v69 count:2];
      id v68 = 0;
      ...
      if (v45)
      {
        if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v71 = v50;
          _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay", buf, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v72 = 2112;
          *(void *)v73 = v44;
          _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&v73[10] = v65;
        __int16 v74 = 2112;
        v75 = v35;
        _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to start packet relay with relayConnectionCameraVideo: %@, relayConnectionCameraAudio: %@, relayConnectionIDS: %@", buf, 0x2Au);
      }
      id v44 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1017];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v56;
      _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Cannot start packet relay because no IDS session exists", buf, 0xCu);
    }
    id v18 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1017];
...
- (void)_sendInvitation
{
  ...
  if ([v5 count] && (objc_msgSend(v5, "anyObject"), (uint64_t v6 = objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    [v8 setObject:&unk_1F2DC77E0 forKeyedSubscript:*MEMORY[0x1E4F6AAB8]];
    [v8 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:*MEMORY[0x1E4F6AAB0]];
    uint64_t v9 = [(HMDCameraIDSSessionInitiator *)self localNetworkConfig];
    char v10 = [v9 ipv6];

    if ((v10 & 1) == 0) {
      [v8 setObject:&unk_1F2DC77F8 forKeyedSubscript:*MEMORY[0x1E4F6AAA8]];
    }
    uint64_t v11 = (void *)MEMORY[0x1E4F6ABA0];
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v37 = 2112;
      v38 = v8;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Sending out invitation for IDSSession %@ to device %@ with options: %@", buf, 0x2Au);
    }
    id v23 = [(HMDCameraIDSSessionHandler *)v17 sessionID];
    uint64_t v24 = [v23 sessionID];
    v30 = v24;
    id v25 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v30 forKeys:&v29 count:1];
  ...
  {
    uint64_t v7 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1024];
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the IDS session initiator", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_19216 != -1) {
    dispatch_once(&logCategory__hmf_once_t18_19216, &__block_literal_global_19217);
  }
  v2 = (void *)logCategory__hmf_once_v19_19218;
  return v2;
}
...
uint64_t __43__HMDCameraIDSSessionInitiator_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v19_19218;
  logCategory__hmf_once_v19_19218 = v0;
