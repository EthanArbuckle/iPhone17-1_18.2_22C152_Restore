...
void __64__HMDDataStreamControlProtocol__sendVersionRequestOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send version control message (%@)", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (void)_sendHelloMessageOnDataStream:(id)a3
{
  ...
  v7[3] = &unk_1E6A197F0;
  v7[4] = self;
  [v4 sendRequestForProtocol:@"control" topic:@"hello" identifier:v5 payload:MEMORY[0x1E4F1CC08] completion:v7];
}
...
void __62__HMDDataStreamControlProtocol__sendHelloMessageOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send hello control message (%@)", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (void)dataStream:(id)a3 didReceiveResponse:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if ([(HMDDataStreamControlProtocol *)self isExpectedHelloControlMessage:v11 header:v12])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v29 = 138543362;
      v30 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message reply received", (uint8_t *)&v29, 0xCu);
    }
  ...
  else
  {
    ...
    if (v19)
    {
      if (v23)
      {
        ...
        __int16 v31 = 2112;
        id v32 = v13;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Received Peer Request Version Response %@", (uint8_t *)&v29, 0x16u);
      }
    ...
    else
    {
      if (v23)
      {
        ...
        int v29 = 138543362;
        v30 = v28;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Expected hello reply or Version but got something else", (uint8_t *)&v29, 0xCu);
      }
    }
  }
}
...
- (BOOL)isExpectedHelloControlMessage:(id)a3 header:(id)a4
{
  ...
  if (v10)
  {
    ...
    char v12 = [v11 isEqual:&unk_1F2DC9F40];
  }
  else
  {
LABEL_5:
...
- (void)dataStream:(id)a3 didReceiveRequest:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if ([v11 isEqual:@"hello"])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v29 = 138543362;
      v30 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message received", (uint8_t *)&v29, 0xCu);
    }
    [v10 sendResponseForRequestHeader:v12 payload:MEMORY[0x1E4F1CC08] status:0 completion:&__block_literal_global_187853];
  }
  else
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        int v29 = 138543362;
        v30 = v23;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Version control message received", (uint8_t *)&v29, 0xCu);
      }
      ...
      [v10 sendResponseForRequestHeader:v12 payload:v27 status:0 completion:&__block_literal_global_3_187855];
    }
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v31 = 2112;
        id v32 = v11;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Control Protocol received unexpected request '%@'", (uint8_t *)&v29, 0x16u);
      }
    }
  }
}
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending hello control message", (uint8_t *)&v9, 0xCu);
  }
...
- (HMDDataStreamControlProtocol)initWithLogIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(_WORD *)&v6->_helloMessageResponseReceived = 0;
    ...
    v6->_peerDataStreamProtocolVersion = (NSNumber *)&unk_1F2DCB998;
  }
  return v6;
}
