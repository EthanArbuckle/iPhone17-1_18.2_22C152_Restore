...
- (void)__handleMatterFirmwareUpdateStatusUpdate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v67 = 2112;
    id v68 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update for %@", buf, 0x16u);
  }
  v9 = [v4 value];
  objc_opt_class();
  ...
  id v64 = 0;
  v12 = [MEMORY[0x1E4F5BD78] parsedFromData:v11 error:&v64];
  id v13 = v64;
  if (!v13)
  {
    ...
    if (!v19)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v66 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Missing OTA Provider state in Matter Firmware Update Status TLV", buf, 0xCu);
      goto LABEL_9;
    }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v67 = 2112;
      id v68 = v26;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update state : %@", buf, 0x16u);
    }
    ...
    if (!v27)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v35;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil. Cannot handle matter firmware update status characteristic value change", buf, 0xCu);
      }
      goto LABEL_51;
    }
    ...
    if (!v29)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v39;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Software update object is nil. Cannot update HMDSoftwareUpdate", buf, 0xCu);
...
LABEL_45:
        ...
        else
        {
          v59 = v30;
          v62 = v29;
          v45 = (void *)MEMORY[0x1D9452090](v31);
          v46 = v23;
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v66 = v48;
            _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
...
LABEL_46:
          v60 = v30;
          v63 = v29;
          v50 = (void *)MEMORY[0x1D9452090](v49);
          v51 = v23;
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v66 = v54;
            _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
...
LABEL_51:
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v66 = v42;
        _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_INFO, "%{public}@Not updating software update model states on primary resident", buf, 0xCu);
...
LABEL_43:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v73 = 2112;
    id v74 = v13;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse matter firmware update status (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
...
- (void)__handleMatterFirmwareRevisionNumberUpdate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update for %@", (uint8_t *)&v12, 0x16u);
  }
  v9 = [v4 value];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
...
- (void)_processIdleStateWithCharacteristic:(id)a3
{
  ...
  {
    id v67 = 0;
    v8 = [MEMORY[0x1E4F5BD78] parsedFromData:v7 error:&v67];
    id v9 = v67;
    if (v9)
    {
...
LABEL_10:
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v76 = 2112;
      id v77 = v9;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse matter firmware update status previous value (%@) - characteristic %@ value %@ error %@", buf, 0x34u);
...
LABEL_8:
    ...
    if (!v19)
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v69 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Missing OTA Provider state previous value in Matter Firmware Update Status TLV", buf, 0xCu);
      goto LABEL_8;
    }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v70 = 2112;
      id v71 = v26;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update state previous value : %@", buf, 0x16u);
    }
    if (v21 == 1 || v21 == 6) {
      goto LABEL_10;
    }
    ...
    if (!v27)
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v69 = v43;
        _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil. Cannot process initial state from accessory", buf, 0xCu);
      }
      goto LABEL_46;
    }
    v29 = [v27 home];
      ...
      && [v29 isAutomaticThirdPartyAccessorySoftwareUpdateEnabled])
    {
      ...
      if (!v32)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v69 = v36;
          _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@No active firmware update session, attempting to create one", buf, 0xCu);
        ...
        if (!v32)
        {
          ...
          if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            __int16 v69 = v60;
            _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to register and create a firmware update session", buf, 0xCu);
      ...
      if ([v32 isMatterFirmwareUpdateRetryAllowed])
      {
        ...
        if (!v37)
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            __int16 v69 = v56;
            _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Couldn't get a strong ref to the software update provider delegate", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v69 = v52;
          _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_INFO, "%{public}@Maximum matter firmware update retries reached", buf, 0xCu);
...
LABEL_42:
        _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_INFO, v47, buf, 0xCu);
      }
    }
    uint64_t v31 = v66;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v69 = v18;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Not processing idle state as previous value is nil", buf, 0xCu);
  }
LABEL_14:
}
...
- (id)characteristics
{
  ...
  if (v3)
  {
    ...
    id v5 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"0000026D-0000-1000-8000-0026BB765291", 0);
    uint64_t v6 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", @"0000026E-0000-1000-8000-0026BB765291", 0);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v15 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil", buf, 0xCu);
    }
    id v4 = 0;
  }
...
- (void)readMatterFirmwareUpdateCharacteristics
{
  ...
  [(HMDAccessoryMatterFirmwareUpdateProfile *)self readAndProcessCharacteristics:v3 withCompletion:&__block_literal_global_44_136443];
}
  ...
  if (v8 && [v8 supportsCHIP])
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v24;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@No characteristics to read and process", buf, 0xCu);
      }
      v7[2](v7);
    }
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v37 = 2112;
        id v38 = v6;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Reading characteristics: %@", buf, 0x16u);
      }
      long long v15 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", objc_msgSend(v6, "count"));
      long long v32 = 0u;
      long long v33 = 0u;
      long long v30 = 0u;
      long long v31 = 0u;
  ...
  if (WeakRetained)
  {
    ...
    if (v5)
    {
      ...
      *(void *)&v49[16] = 0x3032000000;
      v50 = __Block_byref_object_copy__136449;
      v51 = __Block_byref_object_dispose__136450;
      uint64_t v32 = a1;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v46 = 2112;
                v47 = v22;
                _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Read failed for %@", buf, 0x16u);
              }
            }
          }
          uint64_t v9 = [obj countByEnumeratingWithState:&v40 objects:v48 count:16];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v49[22] = 2112;
        v50 = v33;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Read of characteristics %@ failed with error %@", v49, 0x20u);
      }
...
uint64_t __88__HMDAccessoryMatterFirmwareUpdateProfile_readAndProcessCharacteristics_withCompletion___block_invoke_41(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    uint64_t v13 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Read succeeded for %@", (uint8_t *)&v10, 0x16u);
  }
...
uint64_t __95__HMDAccessoryMatterFirmwareUpdateProfile_handleDisplayableFirmwareVersionUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Matter firmware version string updated", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __75__HMDAccessoryMatterFirmwareUpdateProfile_handleVIDPIDUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@VID/PID updated", (uint8_t *)&v7, 0xCu);
  }
  return objc_msgSend(*(id *)(a1 + 32), "__handleAccessoryIsReachable");
}
...
void __70__HMDAccessoryMatterFirmwareUpdateProfile_handleAccessoryIsReachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v16 = 138543362;
    uint64_t v17 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory is now reachable", (uint8_t *)&v16, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      uint64_t v17 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory is nil", (uint8_t *)&v16, 0xCu);
    }
  }
}
...
- (void)_registerForNotifications
{
  ...
  if (v3)
  {
    ...
    uint64_t v8 = (void *)MEMORY[0x1D9452090]([(HMDAccessoryMatterFirmwareUpdateProfile *)self _enableCharacteristicsNotifications:1]);
    uint64_t v9 = self;
...
LABEL_6:
      _os_log_impl(&dword_1D49D5000, v13, v14, v12, (uint8_t *)&v16, 0xCu);
    }
  }
  else
  {
...
- (void)setMatterFirmwareRevisionNumber:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (!self->_matterFirmwareRevisionNumber || (objc_msgSend(v5, "isEqualToNumber:") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating Matter firmware revision number from %@ to %@", (uint8_t *)&v19, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      uint64_t v20 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Not setting matter firmware revision number to nil", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_136484 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_136484, &__block_literal_global_136485);
  }
  v2 = (void *)logCategory__hmf_once_v1_136486;
  return v2;
}
...
uint64_t __54__HMDAccessoryMatterFirmwareUpdateProfile_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_136486;
  logCategory__hmf_once_v1_136486 = v0;
