...
- (id)dataSourceAccessoryWithUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory with uuid: %@ due to no data source", (uint8_t *)&v13, 0x16u);
    }
    v7 = 0;
  }
...
- (void)handleSiriEndpointDeleteSiriHistoryMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2112;
    id v40 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling siri endpoint delete siri history message: %@", buf, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (v10)
    {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v43 = 2112;
            v44 = v17;
            _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to get endpoint identifier for accessory: %@ for delete siri history message: %@ error: %@", buf, 0x2Au);
      ...
      {
        __int16 v15 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:2];
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v43 = 2112;
          v44 = v15;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory with uuid: %@ for delete siri history message: %@ error: %@", buf, 0x2Au);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v41 = 2112;
        id v42 = v12;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode message payload from delete siri history message payload: %@ error: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v41 = 2112;
      id v42 = v11;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from delete siri history message: %@ error: %@", buf, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_41717 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_41717, &__block_literal_global_41718);
  }
  v2 = (void *)logCategory__hmf_once_v7_41719;
  return v2;
}
...
uint64_t __56__HMDAppleMediaAccessoryLocalMessageHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v7_41719;
  logCategory__hmf_once_v7_41719 = v0;
