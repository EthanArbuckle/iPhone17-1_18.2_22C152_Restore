...
- (void)_handleInterruptCharacteristicValue:(id)a3
{
  ...
  {
    id v29 = 0;
    v9 = [MEMORY[0x1E4F5BD00] parsedFromData:v8 error:&v29];
    id v10 = v29;
    if (v10 || !v9)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        id v33 = v10;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Interrupt] The interrupt value could not be parsed (error=%@)", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (v17)
      {
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v32 = 1024;
          LODWORD(v33) = v16;
          _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@[Interrupt] The interrupt value contains valid accessory Request To Send (0x%x)", buf, 0x12u);
        }
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 1024;
        LODWORD(v33) = v16;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEBUG, "%{public}@[Interrupt] The interrupt value does not contain any Request To Send (0x%x)", buf, 0x12u);
      }
    }
...
LABEL_19:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v31 = v26;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@[Interrupt] Received interrupt value but it was not of the expected type; IGNORING.",
      buf,
      0xCu);
  }
LABEL_20:
...
LABEL_5:
  ...
  v9 = 0;
LABEL_7:
  id v10 = objc_msgSend(v9, "na_firstObjectPassingTest:", &__block_literal_global_102066);
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v15;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling characteristics value updated notification: %@", (uint8_t *)&v18, 0x16u);
    }
    int v16 = *(void **)(a1 + 40);
    v17 = [v10 value];
...
- (void)_handleReceivedData:(id)a3
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      int v22 = 138543362;
      v23 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@DataStream has encountered irrecoverable framing issue. Closing stream.", (uint8_t *)&v22, 0xCu);
    }
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1052];
...
- (void)_stopTransportForWriteFailureError:(id)a3
{
  id v4 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1061 underlyingError:a3];
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v58 = 2112;
      id v59 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@[Transport] Handling responses: %@", buf, 0x16u);
    }
    v49 = v7;
...
LABEL_6:
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v58 = 2112;
          id v59 = v28;
          _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Write response errored out: %@", buf, 0x16u);
        }
        id v29 = [v22 error];
      ...
      uint64_t v34 = (void *)MEMORY[0x1E4F5BCE8];
      v35 = [v22 value];
      id v50 = 0;
      ...
      if (v37 || !v36)
      {
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v58 = 2112;
          id v59 = v37;
          _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply could not be parsed (error=%@)", buf, 0x16u);
        }
        v45 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
...
LABEL_21:
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v57 = v33;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Write-response contained no response; weird. Erroring out.",
          buf,
          0xCu);
      }
...
LABEL_24:
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v21;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Write-response returned but nothing in progress; stale reply? Ignoring",
        buf,
        0xCu);
    }
  }
  ...
  if (![(HMDDataStreamHAPTransport *)self isWriteInProgress])
  {
    ...
    if ([(HMDDataStreamHAPTransport *)self _isRunning])
    {
      ...
      if (v5)
      {
        ...
        if (v7)
        {
          ...
          if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v27 = v11;
            _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: building next payload failed and should not do that; closing.",
              buf,
              0xCu);
          }
          uint64_t v12 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1052 underlyingError:v7];
        ...
        else if (v6)
        {
          ...
          v25 = v6;
          char v21 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v25 count:1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v27 = v20;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: HAPAccessory is no longer active; closing.",
            buf,
            0xCu);
        }
        id v7 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2100];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: transport already closed.", buf, 0xCu);
      }
      BOOL v5 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1061];
...
- (void)_writeCharacteristicRequests:(id)a3 completion:(id)a4
{
  ...
  uint64_t v9 = [v8 home];
  if ([v9 isResidentFirstAccessoryCommunicationEnabled])
  {
    id v10 = [MEMORY[0x1E4F29128] UUID];
    v12[0] = MEMORY[0x1E4F143A8];
    v12[1] = 3221225472;
    v12[2] = __69__HMDDataStreamHAPTransport__writeCharacteristicRequests_completion___block_invoke;
    v12[3] = &unk_1E6A16950;
    v12[4] = self;
    id v14 = v7;
    id v13 = v6;
    [v9 writeCharacteristicValues:v13 source:7 message:0 identifier:v10 qualityOfService:-1 withCompletionHandler:v12];
  }
  else
  {
    id v11 = [(HMDDataStreamHAPTransport *)self workQueue];
    [v8 writeCharacteristicValues:v6 source:7 queue:v11 completionHandler:v7];
  }
}
...
LABEL_5:
    ...
    id v14 = (void *)[objc_alloc(MEMORY[0x1E4F5BCF0]) initWithPayload:v7 sessionIdentifier:v10 forceClose:v13];
    uint64_t v15 = [v14 serializeWithError:a3];
    id v16 = *a3;
    int v17 = (void *)MEMORY[0x1D9452090]();
    int v18 = self;
    v19 = HMFGetOSLogHandle();
    ...
    if (v16)
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        int v30 = 138543362;
        v31 = v21;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Error: failed to serialize Controller Payload; should not happen!",
          (uint8_t *)&v30,
          0xCu);
      }
      id v22 = 0;
    ...
    else
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Writing: %u bytes (rts=%d)", (uint8_t *)&v30, 0x18u);
      }
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v30 = 138543362;
    v31 = v29;
    _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Writing: nothing to write", (uint8_t *)&v30, 0xCu);
  }
  id v22 = 0;
LABEL_16:
...
LABEL_11:
        ...
        if (v8)
        {
          id v12 = [MEMORY[0x1E4F1CA58] dataWithData:v8];
          id v7 = v12;
          goto LABEL_11;
        }
        id v8 = v11;
...
- (void)_deregisterForMessages
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Error: unable to deregister from event notifications on accessory (its weak pointer went to nil)", buf, 0xCu);
    }
  }
}
...
- (void)_registerForMessages
{
  ...
  uint64_t v5 = [v3 home];
  int v6 = [v5 isResidentFirstAccessoryCommunicationEnabled];

  if (v6)
  {
    id v7 = [MEMORY[0x1E4F28EB8] defaultCenter];
    [v7 addObserver:self selector:sel__handleCharacteristicsValueUpdated_ name:@"HMDAccessoryCharacteristicsChangedNotification" object:v3];
  }
  id v8 = [(HMDDataStreamHAPTransport *)self interruptCharacteristic];
  v11[0] = v8;
  uint64_t v9 = [MEMORY[0x1E4F1C978] arrayWithObjects:v11 count:1];
  uint64_t v10 = [(HMDDataStreamHAPTransport *)self notificationClientIdentifier];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&location[4] = v11;
        __int16 v18 = 2112;
        id v19 = v6;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Transport] Unable to write: Closing after session force close failed; error=%@",
          location,
          0x16u);
      }
...
- (void)_stopWithError:(id)a3
{
  ...
  if (!v5)
  {
    id v5 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1061];
  }
...
- (void)close
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      int v10 = 138543362;
      id v11 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@DataStream transport closing.", (uint8_t *)&v10, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      int v10 = 138543362;
      id v11 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket invoked closed but nothing to clean up.", (uint8_t *)&v10, 0xCu);
    }
  }
}
...
- (void)connect
{
  ...
  if ([(HMDDataStreamHAPTransport *)self _isRunning])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      v27 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-running transport", (uint8_t *)&v26, 0xCu);
    }
  }
  else
  {
    ...
    if (v7)
    {
      ...
      if (v9)
      {
        ...
        if (v10)
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            int v26 = 138543362;
            v27 = v15;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@[Connect] All good; connected!",
              (uint8_t *)&v26,
              0xCu);
          }
        ...
        else
        {
          if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
          {
            ...
            int v26 = 138543362;
            v27 = v24;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Connect] Missing characteristics to create transport for HDS over HAP (Interrupt Characteristic does not exist)", (uint8_t *)&v26, 0xCu);
          }
          v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          int v26 = 138543362;
          v27 = v23;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Connect] Missing characteristics to create transport for HDS over HAP (Transport Characteristic does not exist)", (uint8_t *)&v26, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        int v26 = 138543362;
        v27 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Connect called but accessory is no longer valid", (uint8_t *)&v26, 0xCu);
      }
      uint64_t v9 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1011];
...
- (HMDDataStreamHAPTransport)initWithAccessory:(id)a3 sessionIdentifier:(int64_t)a4 maxControllerTransportMTU:(unint64_t)a5 workQueue:(id)a6 logIdentifier:(id)a7
{
  ...
  if (v15)
  {
    ...
    v25 = NSString;
    int v26 = [MEMORY[0x1E4F29128] UUID];
    v27 = [v26 UUIDString];
