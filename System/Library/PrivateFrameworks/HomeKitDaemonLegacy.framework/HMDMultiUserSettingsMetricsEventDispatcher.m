...
- (void)submitMultiUserSettingsDailyEvent
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      v22 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitting multi user settings daily event", (uint8_t *)&v21, 0xCu);
    }
...
LABEL_14:
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      v24 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@numSharedUsers is %@. Don't submit logs", (uint8_t *)&v21, 0x16u);
    }
    goto LABEL_14;
  }
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    int v21 = 138543362;
    v22 = v15;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@No DataSource is set for submitMultiUserSettingsDailyEvent", (uint8_t *)&v21, 0xCu);
  }
LABEL_15:
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_25108 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_25108, &__block_literal_global_25109);
  }
  v2 = (void *)logCategory__hmf_once_v4_25110;
  return v2;
}

uint64_t __57__HMDMultiUserSettingsMetricsEventDispatcher_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v4_25110;
  logCategory__hmf_once_v4_25110 = v0;
