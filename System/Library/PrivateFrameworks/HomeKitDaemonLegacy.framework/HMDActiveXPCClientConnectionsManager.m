...
void __76__HMDActiveXPCClientConnectionsManager_handleClientConnectionDidDeactivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling client connection did deactivate: %@", (uint8_t *)&v8, 0x16u);
  }
...
void __74__HMDActiveXPCClientConnectionsManager_handleClientConnectionDidActivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling client connection did activate: %@", (uint8_t *)&v8, 0x16u);
  }
  id v7 = [*(id *)(a1 + 32) delegate];
...
- (void)removeClientConnection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing client connection: %@", (uint8_t *)&v12, 0x16u);
  }
...
- (void)addClientConnection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Adding client connection: %@", (uint8_t *)&v12, 0x16u);
  }
  os_unfair_lock_lock_with_options();
  __int16 v10 = [(HMDActiveXPCClientConnectionsManager *)v7 mutableClientConnections];
  [v10 addObject:v4];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_15307 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_15307, &__block_literal_global_15308);
  }
  v2 = (void *)logCategory__hmf_once_v10_15309;
  return v2;
}

uint64_t __51__HMDActiveXPCClientConnectionsManager_logCategory__block_invoke()
{
  logCategory__hmf_once_v10_15309 = HMFCreateOSLogHandle();
