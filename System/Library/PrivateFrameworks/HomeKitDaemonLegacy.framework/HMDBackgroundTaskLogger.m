...
- (void)submitNotFiredLogEventForTask:(id)a3
{
  ...
  if (v8 != 1)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v22 = 2112;
      v23 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Submitting never fired log %@ with identifier %@", (uint8_t *)&v18, 0x20u);
    }
...
- (void)submitLogEventForTask:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v19 = 2112;
    __int16 v20 = v13;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Submitting log %@ with identifier %@", (uint8_t *)&v15, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_155000 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_155000, &__block_literal_global_155001);
  }
  v2 = (void *)logCategory__hmf_once_v3_155002;
  return v2;
}
...
uint64_t __38__HMDBackgroundTaskLogger_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_155002;
  logCategory__hmf_once_v3_155002 = v0;
