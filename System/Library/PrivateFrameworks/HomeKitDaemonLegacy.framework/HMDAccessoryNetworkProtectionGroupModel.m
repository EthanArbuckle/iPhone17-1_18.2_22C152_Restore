...
+ (id)properties
{
  if (properties_onceToken_132724 != -1) {
    dispatch_once(&properties_onceToken_132724, &__block_literal_global_132725);
  }
  v2 = (void *)properties__properties_132726;
  return v2;
}
...
void __53__HMDAccessoryNetworkProtectionGroupModel_properties__block_invoke()
{
  ...
  v5 = (void *)properties__properties_132726;
  properties__properties_132726 = v4;
}

+ (id)modelIDForHome:(id)a3 manufacturer:(id)a4 category:(id)a5
{
  v7 = (objc_class *)MEMORY[0x1E4F1CA58];
  id v8 = a5;
  id v9 = a4;
  id v10 = a3;
  id v11 = objc_alloc_init(v7);
  v12 = [MEMORY[0x1E4F1CA58] dataWithLength:16];
  v13 = [v10 uuid];
  ...
  uint64_t v22 = v15;
  v16 = [MEMORY[0x1E4F1C9B8] dataWithBytes:&v22 length:8];
  [v11 appendData:v16];
...
+ (id)modelNamespace
{
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"3FFD3711-E751-4F46-A74F-4F0B4E877E8F"];
  return v2;
}
