...
- (BOOL)isCloudPhotosEnabledOnAccount
{
  ...
  char v3 = [v2 isEnabledForDataclass:*MEMORY[0x1E4F17570]];
...
- (void)handleAccountStoreDidChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v17 = 138543362;
    v18 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received account change notification", (uint8_t *)&v17, 0xCu);
  }
  ...
  if (v9 != [(HMDCloudPhotosSettingObserver *)v6 isCloudPhotosEnabled])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating cloudPhotosEnabled from %@ to %@", (uint8_t *)&v17, 0x20u);
    }
...
- (void)configure
{
  if ([(HMDCloudPhotosSettingObserver *)self isSupported])
  {
    ...
    [v3 addObserver:self selector:sel_handleAccountStoreDidChangeNotification_ name:*MEMORY[0x1E4F178D8] object:0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_98981 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_98981, &__block_literal_global_7_98982);
  }
  v2 = (void *)logCategory__hmf_once_v3_98983;
  return v2;
}
...
uint64_t __44__HMDCloudPhotosSettingObserver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_98983;
  logCategory__hmf_once_v3_98983 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}

+ (HMDCloudPhotosSettingObserver)sharedInstance
{
  if (sharedInstance_onceToken_98988 != -1) {
    dispatch_once(&sharedInstance_onceToken_98988, &__block_literal_global_98989);
  }
...
uint64_t __47__HMDCloudPhotosSettingObserver_sharedInstance__block_invoke()
{
  ...
  uint64_t v1 = (void *)sharedInstance_cloudPhotoSettingObserver;
