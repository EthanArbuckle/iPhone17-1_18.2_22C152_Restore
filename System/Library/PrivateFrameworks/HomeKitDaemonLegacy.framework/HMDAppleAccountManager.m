...
+ (HMDAppleAccountManager)sharedManager
{
  ...
  block[4] = a1;
  if (sharedManager_onceToken_108073 != -1) {
    dispatch_once(&sharedManager_onceToken_108073, block);
  }
  v2 = (void *)sharedManager_accountManager;
...
- (void)accountChangeObserver:(id)a3 observedDeletedAccount:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification of removed account %@", buf, 0x16u);
  }
  queue = v9->_queue;
...
void __71__HMDAppleAccountManager_accountChangeObserver_observedDeletedAccount___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    uint64_t v12 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Completed handling of removed account %@", (uint8_t *)&v9, 0x16u);
  }
}
...
- (void)service:(id)a3 devicesChanged:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [(HMDAppleAccountManager *)self service];
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Received notification that devices changed on the current account", (uint8_t *)&v15, 0xCu);
    }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Received notification that the current account changed", buf, 0xCu);
    }
    long long v24 = 0u;
    long long v25 = 0u;
    long long v22 = 0u;
    long long v23 = 0u;
    v14 = objc_msgSend(v6, "accounts", 0);
...
- (void)account:(id)a3 aliasesChanged:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v14 = 138543362;
    uint64_t v15 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification that aliases changed", (uint8_t *)&v14, 0xCu);
  }
  uint64_t v12 = [(HMDAppleAccountManager *)v9 accountChangeBackoffTimer];
  [v12 resume];
...
- (void)account:(id)a3 isActiveChanged:(BOOL)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      uint64_t v16 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification that account is active changed", (uint8_t *)&v15, 0xCu);
    }
...
- (NSUUID)messageTargetUUID
{
  return (NSUUID *)[MEMORY[0x1E4F2E780] UUID];
}
...
- (void)_updatePushToken:(id)a3
{
  ...
  if (a3)
  {
    ...
    {
      int v7 = updated;
      updated = (void *)__updateCurrentDevice(self, updated);
      id v6 = v7;
    }
    MEMORY[0x1F41817F8](updated, v6);
  }
}
...
- (void)connection:(id)a3 didReceivePublicToken:(id)a4
{
  ...
  {
    __int16 v11 = HMFGetLogIdentifier();
    uint64_t v12 = [MEMORY[0x1E4F65538] defaultFormatter];
    uint64_t v13 = [v12 privateStringForObjectValue:v7];
    *(_DWORD *)buf = 138543618;
    id v19 = v11;
    __int16 v20 = 2112;
    v21 = v13;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Received push token: %@", buf, 0x16u);
  }
  queue = v9->_queue;
...
uint64_t __59__HMDAppleAccountManager_connection_didReceivePublicToken___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification that the push token changed", (uint8_t *)&v11, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 2048;
      uint64_t v14 = v10;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@We got the push token before the apple account manager is started. Will process this token once it starts up. token length: %lu", (uint8_t *)&v11, 0x16u);
    }
...
- (void)processAccountModelRemove:(id)a3 message:(id)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unexpected object model received", buf, 0xCu);
LABEL_9:
    }
LABEL_10:
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v29;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Account update does not match current account identifier", buf, 0xCu);
    }
  ...
  if ((v16 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v37 = 2112;
      v38 = v25;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Account update does not match current account identifier -- current identifier: %@, received identifier: %@", buf, 0x20u);
...
- (void)processAccountModel:(id)a3 message:(id)a4
{
  ...
  if (v8)
  {
    ...
    if ((v12 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v31;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Account update does not match current account identifier", buf, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v39 = 2112;
        v40 = v27;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Account update does not match current account identifier -- current identifier: %@, received identifier: %@", buf, 0x20u);
  ...
  {
    __int16 v18 = [[HMDAccount alloc] initWithObjectModel:v6];
    if (v18) {
...
{
  id v4 = a3;
  int v5 = [(HMDAppleAccountManager *)self watchManager];
  id v6 = [v5 connectedWatches];
...
{
  id v4 = a3;
  BOOL v5 = ([v4 isCurrentDevice] & 1) != 0
    || [(HMDAppleAccountManager *)self isDeviceLocallyPairedWatch:v4];
...
LABEL_27:
    ...
    _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, v22, (uint8_t *)&v30, 0xCu);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    int v30 = 138543362;
    v31 = v26;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Manager cannot confirm account model process due to nil parameter.", (uint8_t *)&v30, 0xCu);
  }
  BOOL v27 = 0;
LABEL_28:
      ...
      if (isKindOfClass)
      {
        ...
        if ((v18 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v63 = v40;
            _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_DEBUG, "%{public}@Not pushing back account handles while inactive", buf, 0xCu);
          }
          goto LABEL_53;
        }
        if ([v10 source] != 2)
...
LABEL_50:
            _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, v45, buf, 0x16u);
...
LABEL_54:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v63 = v29;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Manager cannot confirm account model process due to nil parameter.", buf, 0xCu);
    }
  }
  BOOL v30 = 0;
LABEL_55:
...
- (BOOL)shouldSyncAccount:(id)a3
{
  ...
  if (v4)
  {
    BOOL v5 = [(HMDAppleAccountManager *)self account];
...
void __60__HMDAppleAccountManager___deviceRemovedFromCurrentAccount___block_invoke(uint64_t a1)
{
  ...
  if (v6)
  {
    BOOL v7 = [*(id *)(a1 + 40) device];

    if (!v7)
    {
      id v8 = *(void **)(a1 + 40);
      __handleUpdatedDevice_107942(v8, 0);
    }
  }
}
...
void __56__HMDAppleAccountManager___deviceAddedToCurrentAccount___block_invoke(uint64_t a1)
{
  ...
  if (v6)
  {
    BOOL v7 = *(void **)(a1 + 40);
    id v8 = [v7 device];
    __handleUpdatedDevice_107942(v7, v8);
  }
}
...
- (void)updateSenderCorrelationIdentifier:(id)a3
{
  ...
  if (v5)
  {
    BOOL v7 = [v5 senderCorrelationIdentifier];
    id v8 = v7;
    if (v7 && [v7 isEqual:v4])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v24 = v12;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@MergeID is the same, not updating", buf, 0xCu);
      }
    }
    else
    {
      id v13 = (void *)MEMORY[0x1D9452090]([v6 setSenderCorrelationIdentifier:v4]);
      uint64_t v14 = self;
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        v26 = v6;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Updated mergeID for currentAccount : %@. Also going to ask IDS about the mergeID.", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v24 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Current account went away, not updating", buf, 0xCu);
    }
  }
}
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      v33 = v11;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Trying to update mergeID on currentAccount: %@", buf, 0x16u);
    }
    long long v12 = [v5 value];
    if ([v12 _appearsToBeEmail])
    {
      uint64_t v13 = MEMORY[0x1D9450AA0](v12);
    }
    else if ([v12 _appearsToBeBusinessID])
    {
      uint64_t v13 = MEMORY[0x1D9450A80](v12);
    }
    else
    {
    ...
    if (v15)
    {
      char v16 = [MEMORY[0x1E4F6AB38] sharedInstance];
      uint64_t v29 = v15;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        __int16 v35 = v5;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot determine destination with handle value: %@, account handle: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      v33 = v3;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Account is missing a handle so cannot update mergeID: %@", buf, 0x16u);
    }
  }
}
...
void __50__HMDAppleAccountManager___updateMergeIDOnAccount__block_invoke_3(uint64_t a1, void *a2, uint64_t a3, unsigned char *a4)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v14;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Found mergeID %@ for destination %@, new attribute %@", (uint8_t *)&v20, 0x2Au);
    }
    *a4 = 1;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      long long v23 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Did not get the mergeID after querying IDS: %@", (uint8_t *)&v20, 0x16u);
    }
  }
}
...
{
  uint64_t v13 = *MEMORY[0x1E4F143B8];
  char v2 = [MEMORY[0x1E4F65570] systemInfo];
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      long long v12 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Received notification that migration completed", (uint8_t *)&v11, 0xCu);
    }
...
{
  id v4 = [a3 userInfo];
  id v5 = [v4 objectForKeyedSubscript:*MEMORY[0x1E4F653D8]];
  ...
  if (v2)
  {
    ...
    if ((v5 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v20 = 2112;
        uint64_t v21 = v10;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Updating name: %@", (uint8_t *)&v18, 0x16u);
      }
...
- (void)__handleRemovedAccountWithCompletion:(id)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v39 = 138543362;
      v40 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification account was removed", (uint8_t *)&v39, 0xCu);
    }
    int v11 = [MEMORY[0x1E4F179C8] defaultStore];
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        int v39 = 138543362;
        v40 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_FAULT, "%{public}@Got primary iCloud account removed notification even though user is still signed in", (uint8_t *)&v39, 0xCu);
      }
      id v17 = (void *)MEMORY[0x1D9452090]();
      int v18 = v14;
      id v19 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        int v39 = 138543362;
        v40 = v20;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Got primary iCloud account removed notification even though user is still signed in", (uint8_t *)&v39, 0xCu);
      }
      uint64_t v21 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2721];
      v4[2](v4, v21);
    }
    else
    {
      ...
      uint64_t v25 = (void *)MEMORY[0x1D9452090](v24);
      __int16 v26 = v7;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v41 = 2112;
        v42 = account;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Current account: %@", (uint8_t *)&v39, 0x16u);
      }
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v39 = 138543362;
        v40 = v35;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Primary apple account is removed & logged out", (uint8_t *)&v39, 0xCu);
      }
      os_unfair_recursive_lock_unlock();
      if (!v31)
      {
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v39 = 138543362;
      v40 = v22;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring account notification", (uint8_t *)&v39, 0xCu);
    }
    long long v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    v4[2](v4, v23);
  }
}
...
- (void)__handleModifiedAccount:(id)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v20 = 138543362;
      uint64_t v21 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification account was modified", (uint8_t *)&v20, 0xCu);
    }
      ...
      if (!v12)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            int v20 = 138543362;
            uint64_t v21 = v18;
            _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create account", (uint8_t *)&v20, 0xCu);
          }
        }
      }
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v20 = 138543362;
      uint64_t v21 = v14;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring account notification", (uint8_t *)&v20, 0xCu);
    }
  }
}
...
void __43__HMDAppleAccountManager___localDataReset___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) isMonitoring])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v16 = 138543362;
      id v17 = v5;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Repushing account transactions", (uint8_t *)&v16, 0xCu);
    }
...
LABEL_14:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        int v16 = 138543362;
        id v17 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to re-create account", (uint8_t *)&v16, 0xCu);
      }
      id v6 = 0;
    }
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      id v17 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot add account after local reset", (uint8_t *)&v16, 0xCu);
    }
    goto LABEL_14;
  }
}
...
void __30__HMDAppleAccountManager_stop__block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) isMonitoring])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v20 = v5;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping", buf, 0xCu);
    }
...
uint64_t __31__HMDAppleAccountManager_start__block_invoke(uint64_t a1)
{
  ...
  if ((result & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)((char *)&buf + 4) = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting", (uint8_t *)&buf, 0xCu);
    }
    ...
    if (v7)
    {
      ...
      *(void *)&long long buf = v10;
      uint64_t v59 = *MEMORY[0x1E4F2C8E0];
      uint64_t v11 = v59;
      long long v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v59 count:1];
      id v13 = +[HMDXPCiCloudSwitchMessagePolicy policyWithBundleIdentifiers:v12];
      *((void *)&buf + 1) = v13;
      long long v14 = [MEMORY[0x1E4F1C978] arrayWithObjects:&buf count:2];
      ...
      uint64_t v57 = v11;
      v58[0] = v15;
      long long v16 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v57 count:1];
      long long v17 = +[HMDXPCiCloudSwitchMessagePolicy policyWithBundleIdentifiers:v16];
      v58[1] = v17;
      uint64_t v18 = [MEMORY[0x1E4F1C978] arrayWithObjects:v58 count:2];
    ...
    uint64_t v31 = [v30 countByEnumeratingWithState:&v52 objects:v56 count:16];
    if (v31)
    {
      uint64_t v32 = v31;
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            LODWORD(buf) = 138543362;
            *(void *)((char *)&buf + 4) = v43;
            _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to create account", (uint8_t *)&buf, 0xCu);
          }
        }
      }
    }
    ...
    if (v44)
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
      {
        ...
        LODWORD(buf) = 138543362;
        *(void *)((char *)&buf + 4) = v48;
        _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@We might have a missed the didReceivePublicToken earlier. Let's set the token first.", (uint8_t *)&buf, 0xCu);
      }
      v49 = *(void **)(a1 + 32);
...
- (void)_registerForRapportNotifications
{
  ...
  if (![(HMDAppleAccountManager *)self isRapportIdentitiesChangedNotificationTokenValid])
  {
    ...
    long long v15 = __58__HMDAppleAccountManager__registerForRapportNotifications__block_invoke;
    long long v16 = &unk_1E6A13E10;
    ...
    if (v4)
    {
      uint64_t v9 = (void *)MEMORY[0x1D9452090](v4, v5, v6, v7);
      uint64_t v10 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)long long buf = 138543874;
        uint64_t v20 = v12;
        __int16 v21 = 2080;
        uint64_t v22 = "com.apple.rapport.identitiesChanged";
        __int16 v23 = 1024;
        int v24 = v8;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to register for %s: %d", buf, 0x1Cu);
      }
    }
    else
    {
...
void __58__HMDAppleAccountManager__registerForRapportNotifications__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v7 = 138543362;
      int v8 = v5;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification that rapport identity changed, update current device", (uint8_t *)&v7, 0xCu);
    }
...
- (HMDAppleAccountManager)initWithIDSService:(id)a3 activityBroadcaster:(id)a4 dataSource:(id)a5
{
  ...
  if (v9)
  {
    ...
    long long v12 = [(HMDAppleAccountManager *)&v44 init];
    if (v12)
    {
      ...
      uint64_t v28 = [objc_alloc(MEMORY[0x1E4F65428]) initWithMinimumTimeInterval:3 maximumTimeInterval:1 exponentialFactor:1.0 options:86400.0];
      ...
      uint64_t v32 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:2 options:15.0];
      devicesChangeBackoffTimer = v12->_devicesChangeBackoffTimer;
      v12->_devicesChangeBackoffTimer = (HMFTimer *)v32;

      uint64_t v34 = +[HMDWatchManager sharedManager];
      watchManager = v12->_watchManager;
      v12->_watchManager = (HMDWatchManager *)v34;

      uint64_t v36 = [(HMDAppleAccountManager *)v12 devicesChangeBackoffTimer];
      [v36 setDelegate:v12];

      __int16 v37 = [(HMDAppleAccountManager *)v12 devicesChangeBackoffTimer];
      [v37 setDelegateQueue:v12->_queue];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v46 = v42;
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Service is required", buf, 0xCu);
    }
    int v39 = 0;
  }
...
- (HMDAppleAccountManager)initWithIDSService:(id)a3 activityBroadcaster:(id)a4
{
  ...
  long long v12 = [[HMDAppleAccountManagerDefaultDataSource alloc] initWithQueue:v11];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t106 != -1) {
    dispatch_once(&logCategory__hmf_once_t106, &__block_literal_global_108068);
  }
  char v2 = (void *)logCategory__hmf_once_v107;
  return v2;
}
...
void __39__HMDAppleAccountManager_sharedManager__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    int v14 = 138543362;
    uint64_t v15 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating an HMDAppleAccountManager", (uint8_t *)&v14, 0xCu);
  }
}
