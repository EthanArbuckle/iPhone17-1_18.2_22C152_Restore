...
- (void)__handleProcessStateChange:(id)a3
{
  ...
  int v9 = [v8 isEqual:*MEMORY[0x1E4F2D748]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t362 != -1) {
    dispatch_once(&logCategory__hmf_once_t362, &__block_literal_global_605);
  }
  v2 = (void *)logCategory__hmf_once_v363;
  return v2;
}
  ...
  if ([v4 linkType] == 2)
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v4;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory discovery already in progress for BLE Accessory with server: %@", (uint8_t *)&v25, 0x16u);
      }
    }
    else
    {
      ...
      int64_t v16 = [(HMDAccessoryBrowser *)self _requiredCharacteristicsTypesToReadFromBTLEServer:v15];
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = objc_msgSend(NSNumber, "numberWithUnsignedChar:", objc_msgSend(v15, "connectReason"));
        int v25 = 138544130;
        v26 = v20;
        __int16 v27 = 2112;
        id v28 = v21;
        ...
        __int16 v31 = 2112;
        v32 = v16;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Adding BLE Accessory server: %@ to the discovering list. Connection Reason: %@. Reading characteristic types: %@", (uint8_t *)&v25, 0x2Au);
      }
    ...
    if ((a4 & 2) != 0)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v35 = 2112;
        id v36 = v10;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Registering BTLE accessory server %@", buf, 0x16u);
      }
    ...
    if ((a4 & 0x10) != 0)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v35 = 2112;
        id v36 = v10;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Registering media accessory %@", buf, 0x16u);
      }
      v19 = [(HMDAccessoryBrowser *)v21 mediaBrowser];
      id v32 = v10;
      v24 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v32 count:1];
      [v19 registerAccessories:v24];
    }
    else
    {
      v18 = [(HMDAccessoryBrowser *)self hap2AccessoryServerBrowser];
      [v18 registerPairedAccessoryWithIdentifier:v10];

      v19 = [(HMDAccessoryBrowser *)self hap2Storage];
      [v19 registerPairedAccessoryWithIdentifier:v10];
    }
    ...
    if (a4)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v35 = 2112;
        id v36 = v10;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Registering IP accessory server %@", buf, 0x16u);
      }
      __int16 v29 = [(HMDAccessoryBrowser *)v26 ipAccessoryServerBrowser];
      [v29 registerPairedAccessoryWithIdentifier:v10];

      v30 = [(HMDAccessoryBrowser *)v26 chipAccessoryServerBrowser];
      [v30 registerPairedAccessoryWithIdentifier:v10];
    }
    __int16 v31 = [[HMDPairedAccessoryInformation alloc] initWithIdentifier:v10 transports:a4 setupHash:v11 delegate:v12];
...
void __33__HMDAccessoryBrowser___activate__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    id v14 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating", (uint8_t *)&v13, 0xCu);
  }
  ...
  else
  {
    if ([v7 areThereAnyPairedBTLEAccessories])
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v13 = 138543362;
        id v14 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@HomeKit App came into foreground - enabling BTLE scanning since there is atleast one paired (potential) BTLE accessory", (uint8_t *)&v13, 0xCu);
      }
      [*(id *)(a1 + 32) btleAccessoryReachabilityProbeTimer:1];
    }
    if (isiOSDevice() || isMac())
    {
      id v12 = [*(id *)(a1 + 32) hap2AccessoryServerBrowser];
...
- (HMMTRAccessoryServerBrowser)chipAccessoryServerBrowser
{
  return (HMMTRAccessoryServerBrowser *)objc_getProperty(self, a2, 80, 1);
}
...
- (void)addPairedAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    int64_t v16 = __42__HMDAccessoryBrowser_addPairedAccessory___block_invoke;
    v17 = &unk_1E6A12CF0;
    id v6 = v4;
    id v18 = v6;
    id v7 = [(NSMutableArray *)pairedAccessories hmf_objectPassingTest:&v14];
    if (v7)
    {
      char v8 = (void *)MEMORY[0x1D9452090]();
      id v9 = self;
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v21 = 2112;
        v22 = v12;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing existing paired accessory instance %@", buf, 0x16u);
...
- (id)beginActiveAssertionWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Taking active assertion with reason: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)__activate
{
  BOOL v3 = [(HMDAccessoryBrowser *)self workQueue];
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didDiscoverAccessories:(id)a4 transaction:(id)a5 error:(id)a6
{
  ...
  uint64_t v15 = [(HMDAccessoryBrowser *)self pairedAccessoryInformationWithIdentifier:v14];
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v13;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ finished discovering accessories [error %@]", (uint8_t *)&v21, 0x2Au);
    }
  ...
  if (v13 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v27 = 2112;
      id v28 = v8;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate %@ that a paired accessory server was added %@", buf, 0x20u);
    }
...
- (BOOL)_shouldAccessoryServerBeTombstoned:(id)a3
{
  ...
  BOOL v6 = [(HMDAccessoryBrowser *)self unpairedAccessoryForServer:v4];
...
- (void)accessoryServerBrowser:(id)a3 didFindAccessoryServer:(id)a4 stateChanged:(BOOL)a5 stateNumber:(id)a6
{
  ...
  long long v16 = +[HMDDeviceCapabilities deviceCapabilities];
  ...
  else
  {
    ...
    if ((v17 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v11;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Ignoring found accessory server %@ that already has pairings", (uint8_t *)&v27, 0x16u);
      }
      [(HMDAccessoryBrowser *)v19 _checkIfPairingWithPairedAccessoryServer:v11 errorCode:11];
      BOOL v22 = [MEMORY[0x1E4F28C58] hmErrorWithCode:53];
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    int v27 = 138543362;
    id v28 = v26;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Found unpaired accessory server and notifying delegates", (uint8_t *)&v27, 0xCu);
  }
...
- (void)accessoryServer:(id)a3 didDiscoverAccessories:(id)a4 transaction:(id)a5 error:(id)a6
{
  ...
  id v12 = a5;
  id v13 = a6;
  char v14 = [(HMDAccessoryBrowser *)self workQueue];
  ...
  if ([v10 linkType] == 2)
  {
    ...
    {
      HMFGetLogIdentifier();
      uint64_t v18 = v54 = v12;
      [v10 identifier];
      id v19 = v50 = v11;
      uint64_t v20 = objc_msgSend(NSNumber, "numberWithBool:", objc_msgSend(v10, "hasPairings"));
      int v21 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v10, "stateNumber"));
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v70 = 2112;
      v71 = v21;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Removing BLE Accessory: %@ that has pairings: %@ with state number: %@", buf, 0x2Au);

      id v11 = v50;
      id v12 = v54;
    }

    BOOL v22 = [(HMDAccessoryBrowser *)v16 discoveringBLEAccessoryServerIdentifiers];
  ...
  if (v24)
  {
    ...
    if (v26)
    {
      ...
      {
        __int16 v29 = [v27 domain];
        if ([v29 isEqualToString:*MEMORY[0x1E4F5B998]])
        {
        ...
        id v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:v31 description:@"Discovery failed." reason:0 suggestion:0 underlyingError:v27];
      }
      id v53 = v13;
      id v42 = v11;
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v68 = 2114;
        id v69 = v27;
        _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed HAP service discovery on accessory server %@ with error: %{public}@", buf, 0x20u);
      }
      v47 = [v25 identifier];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v66 = 2112;
        id v67 = v25;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Completed accessory discovery on accessory server %@", buf, 0x16u);
      }
...
- (id)unpairedAccessoryForServer:(id)a3
{
  ...
  if (v5)
  {
    ...
    BOOL v7 = [(HMDAccessoryBrowser *)self unpairedAccessoryWithServerIdentifier:v6];
  }
  else
  {
    BOOL v7 = 0;
...
- (id)_pairingInformationForUnpairedAccessory:(id)a3
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v6 = [(HMDAccessoryBrowser *)self currentlyPairingAccessories];
...
- (void)_checkIfPairingWithPairedAccessoryServer:(id)a3 errorCode:(int64_t)a4
{
  ...
  long long v26 = 0u;
  long long v27 = 0u;
  uint64_t v8 = [(HMDAccessoryBrowser *)self currentlyPairingAccessories];
...
LABEL_3:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      id v35 = v14;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Paired Accessory server %@ matches accessory pending to be paired %@ - aborting the operation", buf, 0x20u);
    }
    uint64_t v20 = [v6 identifier];
    int v21 = [v14 addAccessoryProgressHandler];
    [(HMDAccessoryBrowser *)v16 updateAlreadyPairingProgressForAccessoryServerIdentifier:v20 progressHandler:v21];

    BOOL v22 = [MEMORY[0x1E4F28C58] hmErrorWithCode:a4];
    id v23 = v6;
    objc_opt_class();
    ...
    {
      id v25 = +[HMDMatterAccessoryPairingEndContext hmdContextWithCancelledError:v22];
    }
...
- (void)_discoverAccessoryServer:(id)a3 linkType:(int64_t)a4 errorHandler:(id)a5
{
  ...
  if (!v8)
  {
    ...
    __int16 v33 = 2112;
    __int16 v34 = v25;
    long long v26 = "%{public}@Unable to discover accessory for link type: %@ due to missing server identifier";
    long long v27 = v19;
    uint32_t v28 = 22;
    goto LABEL_26;
  }
  if (a4 == 1)
  {
    BOOL v22 = [(HMDAccessoryBrowser *)self demoAccessoryServerBrowser];

    if (v22) {
      [(HMDAccessoryBrowser *)self demoAccessoryServerBrowser];
    }
    else {
    id v23 = [(HMDAccessoryBrowser *)self ipAccessoryServerBrowser];
    }
    goto LABEL_21;
  }
  if (a4 == 2)
  {
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v35 = 2112;
        uint64_t v36 = @"BTLE";
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Retrieval already in progress for accessory with server %@/%@", (uint8_t *)&v31, 0x20u);
      }
LABEL_22:
      uint64_t v30 = 0;
      if (!v9) {
    ...
    id v23 = [(HMDAccessoryBrowser *)self btleAccessoryServerBrowser];
LABEL_21:
    long long v29 = v23;
    [v23 discoverAccessoryServerWithIdentifier:v8];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v35 = 2112;
    uint64_t v36 = v25;
    long long v26 = "%{public}@Unable to retrieve server for accessory with identifier %@, due to unknown link type: %@";
    long long v27 = v19;
    uint32_t v28 = 32;
LABEL_26:
    _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, v26, (uint8_t *)&v31, v28);
  }
LABEL_27:
        ...
        v2 == [*(id *)(a1 + 32) hasPairings]))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v15 = 2112;
        uint64_t v16 = v12;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not allowed to discover accessory server: %@", (uint8_t *)&v13, 0x16u);
      }
    }
  }
  else
...
- (id)dumpRegisteredPairedAccessories
{
  ...
  long long v16 = 0u;
  long long v17 = 0u;
  uint64_t v4 = [(HMDAccessoryBrowser *)self pairedAccessories];
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        [v9 transports];
        int v11 = HMAccessoryTransportTypesToString();
  ...
  if (v9)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        int v13 = [*(id *)(*((void *)&v17 + 1) + 8 * i) dumpDescription];
        if (v13) {
          [v6 addObject:v13];
        }
      }
...
- (void)accessoryServerBrowser:(id)a3 didRemoveAccessoryServer:(id)a4 error:(id)a5 matterPairingEndContext:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v25 = 2112;
    long long v26 = v14;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling matter didRemoveAccessoryServer with error %@ mtrContext %@ -> hmdContext %@", (uint8_t *)&v19, 0x2Au);
  }
...
- (void)notifyMTRMetrics:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying mtr metrics", buf, 0xCu);
  }
  long long v15 = @"HMDMatterAccessoryPairingMTRMetricsKey";
  *(void *)buf = v8;
  id v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:buf forKeys:&v15 count:1];
...
- (void)accessoryServer:(id)a3 didStopPairingWithError:(id)a4 matterPairingEndContext:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    __int16 v23 = v11;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling matter didStopPairing with error %@ mtrContext %@ -> hmdContext %@", (uint8_t *)&v16, 0x2Au);
  }
...
void __56__HMDAccessoryBrowser_handleActivationResponse_context___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    uint64_t v19 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Got Token activation response for server: %@, T1: %@", (uint8_t *)&v14, 0x20u);
  }
  id v8 = *(id *)(a1 + 40);
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
...
{
  id v5 = a4;
  uint64_t v6 = [(HMDAccessoryBrowser *)self workQueue];
  ...
  if (v14)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v14; ++i)
      {
        ...
        id v4 = [v3 advertisements];
        long long v15 = 0u;
        long long v16 = 0u;
        long long v17 = 0u;
        long long v18 = 0u;
        id v5 = v4;
        uint64_t v6 = (void *)[v5 countByEnumeratingWithState:&v15 objects:v23 count:16];
        if (v6)
        {
...
- (void)accessoryServer:(id)a3 didUpdateConnectionState:(BOOL)a4 linkLayerType:(int64_t)a5 bookkeeping:(id)a6 withError:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v27 = 2114;
    uint32_t v28 = v19;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory server: %@, updated connection state to %{public}@", buf, 0x20u);
    if (!v10) {
  }
    }
...
- (void)accessoryServer:(id)a3 confirmUUID:(id)a4 token:(id)a5
{
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v8;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@While confirming UUID, cannot find unpaired accessory for server %@", (uint8_t *)&v25, 0x16u);
    }
  }
  ...
  {
    long long v20 = (void *)MEMORY[0x1D9452090]([(HMDAccessoryBrowser *)self accessoryServer:v8 updatePairingProgress:5]);
    long long v21 = self;
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v25 = 138543362;
      id v26 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Wrap up internal setup token authentication", (uint8_t *)&v25, 0xCu);
    }
...
- (void)accessoryServer:(id)a3 authenticateUUID:(id)a4 token:(id)a5
{
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v8;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@While authenticating UUID, cannot find unpaired accessory for server %@", (uint8_t *)&v25, 0x16u);
    }
  }
  long long v17 = [(HMDAccessoryBrowser *)self _pairingInformationForUnpairedAccessory:v12];
  id v18 = v17;
    ...
    && ([v17 setupAuthToken], long long v19 = objc_claimAutoreleasedReturnValue(), v19, v19))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v25 = 138543362;
      id v26 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Emulating auth token activation following internal setup token authentication", (uint8_t *)&v25, 0xCu);
    }
    id v24 = objc_alloc_init(MEMORY[0x1E4F1CA58]);
    LOWORD(v26) = 8270;
    int v25 = 1881788898;
...
- (void)accessoryServer:(id)a3 validateUUID:(id)a4 token:(id)a5 model:(id)a6
{
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      id v50 = v10;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@While validating UUID, cannot find unpaired accessory for server %@", buf, 0x16u);
    }
  }
  ...
  {
    __int16 v34 = [(HMDAccessoryBrowser *)self authServer];
    __int16 v33 = v45;
    __int16 v35 = v46;
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v26;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Authentication using internal setup auth token", buf, 0xCu);
  }
  ...
  if ([v11 isEqualToData:v27])
  {
    ...
    if (v29)
    {
      id v42 = objc_alloc(MEMORY[0x1E4F5BC08]);
      uint64_t v41 = [v10 name];
      v44 = [v10 primaryAccessory];
      v40 = [v44 manufacturer];
      [v10 category];
      uint64_t v30 = v43 = v13;
      int v31 = [MEMORY[0x1E4F29128] UUID];
      __int16 v32 = [v31 UUIDString];
      __int16 v33 = v45;
      __int16 v34 = (void *)[v42 initWithName:v41 manufacturer:v40 modelName:v45 category:v30 certificationStatus:@"CERTIFIED" denylisted:@"NO" ppid:v32];
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v39;
    _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Internal token auth failed", buf, 0xCu);
  }
  __int16 v34 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:-1 userInfo:0];
...
- (void)accessoryServerNeedsOwnershipToken:(id)a3
{
  ...
  uint64_t v6 = [(HMDAccessoryBrowser *)self unpairedAccessoryForServer:v4];
  if (v6)
  {
...
LABEL_4:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v4;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@No unpaired accessory for server %@", (uint8_t *)&v21, 0x16u);
    }
  }
}
...
- (void)accessoryServer:(id)a3 didFinishAuth:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v32 = 2112;
      id v33 = v7;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Auth Finished with error: %@", (uint8_t *)&v30, 0x16u);
    }
    if ([v7 isHAPError])
    {
      ...
      if (v14 > 0x20) {
        ...
        uint64_t v15 = qword_1D54D4320[v14];
      }
    }
    ...
    id v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:v15 description:@"Authentication failed" reason:0 suggestion:0 underlyingError:v7];
  ...
  else
  {
    ...
    if (v19)
    {
      if (v23)
      {
        ...
        int v30 = 138543362;
        int v31 = v24;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Auth finished with success", (uint8_t *)&v30, 0xCu);
      }
    ...
    else
    {
      if (v23)
      {
        ...
        int v30 = 138543362;
        int v31 = v25;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Auth finished with success .. Do regular pair-setup", (uint8_t *)&v30, 0xCu);
      }
...
- (void)accessoryServer:(id)a3 didUpdateName:(id)a4
{
  ...
  if (v8)
  {
    if (v12)
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, Updated Name to %@", (uint8_t *)&v15, 0x20u);
    }
    [v8 setName:v7];
  }
  else
  {
    if (v12)
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, is paired - dropping provided name update to %@", (uint8_t *)&v15, 0x20u);
    }
  }
}
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didUpdateCategory:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ updated category to %@", (uint8_t *)&v15, 0x2Au);
    }
...
- (void)accessoryServerDidUpdateStateNumber:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, Updated State", (uint8_t *)&v9, 0x16u);
  }
}
...
- (void)accessoryServer:(id)a3 didUpdateHasPairings:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 1024;
    BOOL v25 = v4;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory server %@ with new value of hasPairings: %d", (uint8_t *)&v20, 0x1Cu);
  }
  if ([v6 isPaired])
  {
  ...
  else
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v19;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Ignoring pairing update for accessory server %@", (uint8_t *)&v20, 0x16u);
      }
    }
    else if (v4)
    {
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didUpdateHasPairings:(BOOL)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      __int16 v22 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ updated hasPairings to %@", (uint8_t *)&v15, 0x2Au);
    }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v28 = 2112;
      id v29 = v12;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ updated values for characteristics at state number %@", buf, 0x2Au);
...
void __84__HMDAccessoryBrowser_continueAddingAccessoryToHomeAfterUserConfirmation_withError___block_invoke(id *a1)
{
  ...
  if (a1[4])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v27 = v5;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Authentication failed for adding accessory to home", buf, 0xCu);
    }
    ...
    v21[1] = 3221225472;
    v21[2] = __84__HMDAccessoryBrowser_continueAddingAccessoryToHomeAfterUserConfirmation_withError___block_invoke_564;
    void v21[3] = &unk_1E6A143D0;
    id v16 = a1[6];
    v21[4] = a1[5];
    id v22 = v16;
    id v23 = a1[4];
...
uint64_t __84__HMDAccessoryBrowser_continueAddingAccessoryToHomeAfterUserConfirmation_withError___block_invoke_564(uint64_t a1)
{
  ...
  if (v7 && v12 && _os_feature_enabled_impl())
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v18;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Calling progress handler to inform already paired accessory with state: %@", buf, 0x16u);
    }
    v7[2](v7, 47, v18);
  }
}
...
LABEL_4:
      ...
      if ((unint64_t)(a4 - 1) > 0x25) {
        ...
        uint64_t v13 = qword_1D54D3988[a4 - 1];
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v6;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@No unpaired accessory for server %@", buf, 0x16u);
    }
  }
}
...
- (void)_accessoryServer:(id)a3 didStopPairingWithError:(id)a4 matterPairingEndContext:(id)a5
{
  ...
  if ([v8 linkType] == 2)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v71 = 2112;
      id v72 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Removing BLE Accessory: %@ from discovering list", buf, 0x16u);
    }
  ...
  if (v21)
  {
    ...
    {
      id v23 = mapHAPPairingErrorToHMError(v22);
    }
  }
  else
  {
  ...
  id v62 = v12;
  BOOL v25 = [(HMDAccessoryBrowser *)self _pairingInformationForUnpairedAccessory:v24];
  if (!v25)
  {
    __int16 v26 = v23;
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v73 = 2112;
      id v74 = v8;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Error %@ reported for accessory server %@ corresponding to unpaired accessory that is not in list of currently pairing accessories", buf, 0x20u);
    }
    id v23 = v26;
    BOOL v25 = 0;
  }
  ...
  if (!v33)
  {
    if (v37)
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v75 = 2112;
      v76 = v53;
      _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Ignoring didStopPairingWithError:(%@) and starting a pairing interrupted timer for unpaired accessory %@/%@", buf, 0x2Au);
...
LABEL_33:
  ...
  if (v37)
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v73 = 2112;
    id v74 = v22;
    _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Accessory server %@ failed to pair with irrecoverable error: %@", buf, 0x20u);
  }
  v13[2](v13, v22, 0);
...
- (void)_notifyDelegateOfAccessoryServer:(id)a3 didStopPairingWithError:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v6;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server stopped pairing %@", (uint8_t *)&v15, 0x20u);
    }
...
- (void)accessoryServer:(id)a3 didReceiveBadPasswordThrottleAttemptsWithDelay:(int64_t)a4
{
  ...
  if (a4 < 1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Bad password for server %@ - re-prompting for setup code and re-start pairing", (uint8_t *)&v13, 0x16u);
    }
...
- (void)accessoryServer:(id)a3 promptUserForPasswordWithType:(unint64_t)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v35 = 2112;
      uint64_t v36 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Have a pair setup password for server %@ - trying %@", (uint8_t *)&v31, 0x20u);
    }
  ...
  else
  {
    ...
    if (a4 == 2)
    {
      if (v19)
      {
        ...
        __int16 v33 = 2112;
        id v34 = v6;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Need ownership proof token for server %@ but there is no productData to look up the app that can provide it", (uint8_t *)&v31, 0x16u);
      }
      ...
      id v22 = [v8 uuid];
      id v23 = [(HMDAccessoryBrowser *)v17 _progressHandlerForUnpairedAccessory:v22];
...
LABEL_10:
    ...
    else
    {
      if (v19)
      {
        ...
        __int16 v33 = 2112;
        id v34 = v6;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Do not have a pair setup password for server %@ - requesting it", (uint8_t *)&v31, 0x16u);
      }
...
- (void)accessoryServer:(id)a3 requestUserPermission:(int64_t)a4 accessoryInfo:(id)a5 error:(id)a6
{
  ...
  id v23 = [v82 categoryForOther];
  __int16 v24 = [v16 category];

  if (v24)
  {
    BOOL v25 = [v16 category];
  ...
  v84[1] = 3221225472;
  v84[2] = __81__HMDAccessoryBrowser_accessoryServer_requestUserPermission_accessoryInfo_error___block_invoke_550;
  v84[3] = &unk_1E6A13070;
    ...
    case 1:
      if (objc_msgSend(v29, "provideNetworkCredentialsToAccessory", v74, v75, v76))
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v54;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: User already consented to providing network credentials to accessory - skipping prompt", buf, 0xCu);
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v68;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: Defaults write set - skipping auth prompt", buf, 0xCu);
        }
      }
      goto LABEL_37;
    case 2:
      v39 = (void *)MEMORY[0x1D9452090](v33, v34, v35);
      v40 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_DEBUG, "%{public}@Confirming Accessory Info: %@", buf, 0x16u);
      }
      if (objc_msgSend(v31, "isCertified", v74, v75, v76))
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v46;
          _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_INFO, "%{public}@need to confirm PPID", buf, 0xCu);
        }
        if (showAuthDialog)
        {
          v80[2]();
...
LABEL_36:
          ...
          *(_DWORD *)buf = 138543362;
          v112 = v70;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: User already consented to adding unauthenticated accessory to home - skipping auth prompt", buf, 0xCu);
        }
LABEL_37:
...
LABEL_38:
      ...
      goto LABEL_48;
    case 3:
      id v55 = (void *)MEMORY[0x1D9452090](v33, v34, v35);
      uint64_t v56 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v112 = v58;
        _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_INFO, "%{public}@need to confirm accessory info with user", buf, 0xCu);
      }
      if (!showAuthDialog) {
        goto LABEL_30;
      }
    ...
    case 4:
      ...
      __int16 v49 = (void *)MEMORY[0x1D9452090](v33, v34, v35);
      __int16 v71 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v112 = v72;
        _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@Accessory is in-compatible .. cancelling", buf, 0xCu);
      }
LABEL_43:
      ...
      goto LABEL_45;
    case 5:
      id v61 = (void *)MEMORY[0x1D9452090](v33, v34, v35);
      id v62 = val;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v112 = v64;
        _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_INFO, "%{public}@need to confirm accessory information with user", buf, 0xCu);
      }
      if (showAuthDialog)
      {
    ...
    default:
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v113 = 2048;
        int64_t v114 = a4;
        _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: Request user permission - unsupported type %tu - cancelling...", buf, 0x16u);
      }
      goto LABEL_43;
  }
}
    ...
    if (a2)
    {
      ...
      if (v7 == 2)
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v48 = v12;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@User denied adding accessory after PPID conf.", buf, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v48 = v16;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@User canceled pairing, stopping pairing...\n", buf, 0xCu);
        }
        [*(id *)(a1 + 32) stopPairingWithError:0];
        uint64_t v17 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2001];
        uint64_t v45 = *MEMORY[0x1E4F28A50];
        id v46 = v17;
        id v18 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v46 forKeys:&v45 count:1];
        id v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23 userInfo:v18];
        id v20 = v17;
        uint64_t v21 = v20;
        if (*(void *)(a1 + 72) == 4)
        {
          id v22 = [MEMORY[0x1E4F28C58] hmErrorWithCode:93 userInfo:0];
    ...
    else
    {
      ...
      switch(*(void *)(a1 + 72))
      {
        ...
        case 1:
          ...
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, v30, buf, 0xCu);
...
LABEL_39:
          ...
          break;
        case 2:
          id v31 = (void *)MEMORY[0x1D9452090](v15);
          id v32 = v5;
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v48 = v34;
            _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@User confirmed accessory PPID Info .. continuing with auth.", buf, 0xCu);
          }
          [v32 _continueAfterPPIDValidation:1 server:*(void *)(a1 + 32)];
          goto LABEL_39;
        case 3:
          uint64_t v26 = (void *)MEMORY[0x1D9452090](v15);
          id v35 = v5;
          uint64_t v36 = HMFGetOSLogHandle();
          if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v48 = v37;
            _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@User confirmed accessory Info .. continuing pairing", buf, 0xCu);
          }
          goto LABEL_37;
        case 5:
          uint64_t v38 = (void *)MEMORY[0x1D9452090](v15);
          id v39 = v5;
          ...
          if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v48 = v41;
            _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@User confirmed accessory Info .. continuing wac pairing", buf, 0xCu);
          }
...
void __81__HMDAccessoryBrowser_accessoryServer_requestUserPermission_accessoryInfo_error___block_invoke_550(uint64_t a1, int a2)
{
...
- (void)accessoryServer:(id)a3 promtDialog:(id)a4 forNotCertifiedAccessory:(id)a5 completion:(id)a6
{
  ...
  id v16 = (void *)MEMORY[0x1D9452090](v14);
  uint64_t v17 = self;
  id v18 = HMFGetOSLogHandle();
  BOOL v19 = os_log_type_enabled(v18, OS_LOG_TYPE_INFO);
  if (v15)
  {
    if (v19)
    {
      ...
      int v24 = 138543362;
      BOOL v25 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Accessory Browser: Defaults write set - skipping auth prompt", (uint8_t *)&v24, 0xCu);
    }
    if (v13) {
      v13[2](v13, 0);
    }
  ...
  else
  {
    if (v19)
    {
      ...
      int v24 = 138543362;
      BOOL v25 = v21;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Prompting for not certified confirmation", (uint8_t *)&v24, 0xCu);
    }
    id v22 = [v10 name];
    id v23 = [(HMDAccessoryBrowser *)v17 workQueue];
...
- (void)_callProgressOrErrorOut:(id)a3 pairingInfo:(id)a4 accessoryInfo:(id)a5 unpairedAccessory:(id)a6 progress:(int64_t)a7 certStatus:(unint64_t)a8
{
  ...
  if ([v16 isDenylisted])
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v49 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory is blacklisted - Stopping pairing", buf, 0xCu);
    }
    [v14 stopPairingWithError:0];
    id v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:55 userInfo:0];
    int v24 = 0;
    if ([v17 supportsCHIP])
    {
  ...
  {
    int64_t v44 = a7;
    BOOL v25 = [HMDAddAccessoryProgressState alloc];
    ...
    id v30 = v16;
    id v31 = (void *)v29;
    id v32 = (void *)MEMORY[0x1E4F2E520];
    id v46 = v30;
    [v30 category];
    v34 = __int16 v33 = v14;
    ...
    id v23 = [(HMDAddAccessoryProgressState *)v25 initWithUUID:v26 accessoryName:v28 manufacturerName:v31 category:v35 certificationStatus:a8 productData:v36];
...
LABEL_9:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v49 = v43;
        _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_DEFAULT, "%{public}@no progress handler available - implicit auth", buf, 0xCu);
      }
      id v14 = v47;
...
- (id)_getHAPMetadataFromHMMetadata:(id)a3
{
  if (a3)
  {
    id v3 = (objc_class *)MEMORY[0x1E4F5BE70];
    id v4 = a3;
    id v5 = [v3 alloc];
    id v6 = [v4 name];
...
LABEL_3:
      ...
      && [v21 isSharedAdmin])
    {
      ...
      if (v24)
      {
        id v25 = objc_alloc(MEMORY[0x1E4F5BE70]);
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v49 = v36;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Unexpected, shared admin does not have thread operational dataset for home. Falling back to request credentials from primary resident", buf, 0xCu);
      }
    }
...
LABEL_15:
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v50 = 2112;
      uint64_t v51 = v12;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
    }
    id v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
void __115__HMDAccessoryBrowser_accessoryServerBrowser_getThreadNetworkCredentialsForAccessoryWithIdentifier_withCompletion___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      uint64_t v17 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve Thread Network metadata", (uint8_t *)&v16, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      BOOL v19 = v11;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Returning Thread Credentials as %@", (uint8_t *)&v16, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
  }
}
...
- (void)accessoryServerBrowser:(id)a3 getCachedOperationalCertificateDataForFabricID:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    int v15 = 138543362;
    int v16 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@HM_FEATURE_ROAR_SUPPORTED is disabled - Caching not supported", (uint8_t *)&v15, 0xCu);
  }
  v10[2](v10, 0);
}
...
LABEL_3:
    ...
    int v15 = [v14 doesHomeContainResident];
    if (!v15) {
      goto LABEL_14;
    }
...
LABEL_16:
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v4;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
    }
    id v14 = 0;
    char v19 = 0;
  }
...
LABEL_12:
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      __int16 v31 = v6;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
    }
    id v15 = 0;
    char v18 = 0;
  }
...
LABEL_12:
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      long long v47 = v16;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@no home found for home uuid %@", buf, 0x16u);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v25 = 2112;
    id v26 = v15;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@LinkType %@ browseable %@", buf, 0x20u);
  }
  return v7;
}
...
- (void)_notifyDelegateOfReachabilityChangeChange:(BOOL)a3 forBTLEAccessories:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Notifying '%@' that reachability has changed to %@ for BTLE accessories %@", (uint8_t *)&v14, 0x2Au);
    }
...
- (void)accessoryServerBrowser:(id)a3 didFailToDiscoverAccessoryServerWithIdentifier:(id)a4
{
  ...
  if ([v6 linkType] == 2)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Removing BLE Accessory: %@ from discovering list", (uint8_t *)&v31, 0x16u);
    }
    ...
    if ([v6 isEqual:v14])
    {
      ...
      if (v15)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v33 = 2112;
          id v34 = v7;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@IP Browser couldn't find Server with Identifier %@. Giving HAP2 a chance...", (uint8_t *)&v31, 0x16u);
        }
...
LABEL_5:
    ...
    if (v21)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v33 = 2112;
        id v34 = v7;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@HAP2 Browser couldn't find Server with Identifier %@. Maybe it's a CHIP accessory, checking...", (uint8_t *)&v31, 0x16u);
      }
...
LABEL_20:
  ...
  id v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:v30];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v36 = 2112;
        id v37 = v25;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that accessory server discovery failed %@ over %@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v9;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Not notifying of discovery failure for %@ because no paired accessory information exists", buf, 0x16u);
    }
  }
}
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v28 = 2112;
      id v29 = v7;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop discovering accessories for server browser %@ with error %@", buf, 0x20u);
    }
  }
}
...
- (void)accessoryServerBrowser:(id)a3 didStartDiscoveringWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v7;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to start discovering accessories for server browser %@ with error %@", (uint8_t *)&v12, 0x20u);
    }
  }
}
  ...
  if (v19 && (isKindOfClass & 1) != 0)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v69 = 2112;
      id v70 = v56;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Removing unpaired accessory server %@/%@ error %@ context %@", buf, 0x34u);
    ...
    if (!v37)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v65 = 2112;
        uint64_t v66 = v43;
        _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Removing unpaired accessory server %@ (%@)", buf, 0x20u);
...
LABEL_26:
  ...
  if (v30)
  {
    ...
    {
      uint64_t v35 = [MEMORY[0x1E4F28C58] hmErrorWithCode:79];
    }
    id v52 = (void *)v35;
...
LABEL_27:
  ...
  long long v44 = (void *)MEMORY[0x1D9452090]([(HMDAccessoryBrowser *)self accessoryServer:v19 updatePairingProgress:9]);
  long long v45 = self;
  ...
  if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v65 = 2112;
    uint64_t v66 = v50;
    _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Lost the accessory before setup code was scanned - likely unplugged: %@/%@", buf, 0x20u);

    id v13 = v49;
    long long v44 = v60;
  }

  uint64_t v51 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2015];
...
LABEL_7:
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, v18, (uint8_t *)&v28, 0x20u);

      goto LABEL_8;
    }
    goto LABEL_8;
  }
  id v19 = (void *)MEMORY[0x1D9452090]([v7 reconfirm]);
  long long v20 = self;
  id v21 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v32 = 2112;
    id v33 = v24;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting a WAC/Bonjour reconfirm timer for unpaired accessory %@/%@", (uint8_t *)&v28, 0x20u);
  }
  id v25 = objc_alloc(MEMORY[0x1E4F65580]);
...
LABEL_7:
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, v15, (uint8_t *)&v19, 0x20u);
    }
  }
  else
  {
...
- (void)_stopReconfirmTimer:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      long long v20 = v13;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Canceling reconfirm timer for unpaired accessory %@/%@", (uint8_t *)&v15, 0x20u);
    }
  ...
  if (WeakRetained)
  {
    ...
    if ([*(id *)(a1 + 32) supportsCHIP])
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v31 = 2112;
        __int16 v32 = v5;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Indicating addAccessory failure for matter accessory %@(%@) with error %@ context %@", (uint8_t *)&v23, 0x34u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v29 = 2112;
        uint64_t v30 = v17;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Indicating addAccessory failure for accessory %@(%@) with error %@", (uint8_t *)&v23, 0x2Au);
      }
      id v5 = 0;
    }
...
- (void)_notifyDelegateOfRemovedAccessoryServer:(id)a3 error:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that a paired accessory server %@ was removed with error: %@", (uint8_t *)&v15, 0x2Au);
    }
...
- (void)_notifyDelegateOfAccessoryServerNeedingReprovisioning:(id)a3 error:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@'' that a paired accessory server %@ needs reprovisioning with error: %@", (uint8_t *)&v15, 0x2Au);
    }
...
- (void)_notifyDelegateOfWACCompletionForAccessoryServerWithIdentifier:(id)a3 error:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Notifying '%@' on provision complete for accessory: %@ with error: %@", (uint8_t *)&v13, 0x2Au);
    }
...
- (void)accessoryServerBrowser:(id)a3 didFindAccessoryServerForReprovisioning:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v28 = 2112;
    id v29 = v7;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Currently reprovisioning:%@,  Found accessory server: %@ for reprovisioning", (uint8_t *)&v24, 0x20u);
  }
  ...
  if ([v7 isPaired])
  {
    ...
    if (v17)
    {
      id v18 = objc_alloc_init(MEMORY[0x1E4F5BC10]);
...
- (void)_removePairingInformation:(id)a3 error:(id)a4 context:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v38 = 2112;
    id v39 = v9;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Removing current pairing info %@ error %@", buf, 0x20u);
  }
  uint64_t v28 = MEMORY[0x1E4F143A8];
  uint64_t v29 = 3221225472;
  uint64_t v30 = __63__HMDAccessoryBrowser__removePairingInformation_error_context___block_invoke;
  __int16 v31 = &unk_1E6A197C8;
  id v16 = v8;
  id v32 = v16;
  id v17 = v9;
  id v33 = v17;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v35 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@No addAccessory completion handler", buf, 0xCu);
    }
  }
  ...
  __int16 v26 = [(HMDAccessoryBrowser *)v13 _progressHandlerForUnpairedAccessory:v25];

  if (v26)
  {
    __int16 v27 = [(HMDAccessoryBrowser *)v13 currentlyPairingProgressHandlers];
  ...
  if (!v16)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v31 = 2112;
      id v32 = v23;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of value update for :%@, stateNumber: %@, broadcast:%@", buf, 0x2Au);
...
- (void)_resurrectAccessoryServer:(id)a3
{
  ...
  if ([(HMDAccessoryBrowser *)self _isAccessoryServerTombstoned:v4])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Resurrecting paired accessory server '%@'", (uint8_t *)&v12, 0x16u);
    }
...
- (void)_tombstoneAccessoryServer:(id)a3 forceNotify:(BOOL)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2114;
      id v17 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Tombstoning paired accessory server '%{public}@'", (uint8_t *)&v14, 0x16u);
    }
...
- (void)_notifyDelegateOfTombstonedAccessoryServer:(id)a3
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that an accessory server %@ was tombstoned", (uint8_t *)&v13, 0x20u);
    }
...
- (id)_tombstonedAccessoryServerWithServerIdentifier:(id)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  id v5 = [(HMDAccessoryBrowser *)self tombstonedHAPAccessoryServers];
  id v6 = (id)[v5 countByEnumeratingWithState:&v13 objects:v17 count:16];
  if (v6)
  {
    uint64_t v7 = *(void *)v14;
...
void __109__HMDAccessoryBrowser__sendPairingCompletionStatusForServer_error_matterPairingEndContext_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    id v5 = [v3 _pairingInformationForUnpairedAccessory:*(void *)(a1 + 32)];
    char v6 = [v5 addAccessoryCompletionHandler];
    uint64_t v7 = [v5 setAddAccessoryCompletionHandler:0];
    if (!v6)
    {
      id v22 = (void *)MEMORY[0x1D9452090](v7);
      id v23 = v3;
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v52 = 2112;
        uint64_t v53 = v27;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@No addAccessory completion handler for %@ - error %@", buf, 0x20u);
      }
      goto LABEL_27;
    }
    id v8 = *(id *)(a1 + 40);
    ...
    if ((isKindOfClass & 1) != 0 && v8)
    {
      if (v13)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        uint32_t v19 = 32;
LABEL_15:
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, v17, buf, v19);
      }
    }
    else if (v13)
    {
...
LABEL_27:
    ...
    {
      __int16 v36 = [MEMORY[0x1E4F5BE48] systemStore];
      ...
      if (v38)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v52 = 2112;
          uint64_t v53 = v44;
          _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove keychain entry for accessory %@ - error %@", buf, 0x20u);
        }
      }
    }
...
- (void)_updatePairingRetryTimerForAccessory:(id)a3 delay:(int64_t)a4
{
  ...
  if (v8)
  {
    ...
    id v12 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:(double)a4];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v19;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Not starting a pairing retry timer for unpaired accessory %@/%@ - pairing information does not exist", (uint8_t *)&v20, 0x20u);
    }
  }
}
...
- (void)_promptForPairingPasswordForServer:(id)a3 reason:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      ...
      long long v14 = (void *)MEMORY[0x1D9452090](inited);
      uint64_t v15 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        id v47 = v10;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Invoking setupCode provider for accessory %@", buf, 0x16u);
      }
      v38[0] = MEMORY[0x1E4F143A8];
      v38[1] = 3221225472;
      v38[2] = __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_502;
      v38[3] = &unk_1E6A197C8;
      id v18 = v8;
      id v39 = v18;
      id v19 = v30;
      id v40 = v19;
      __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_502((uint64_t)v38);
      v31[0] = MEMORY[0x1E4F143A8];
      v31[1] = 3221225472;
      v31[2] = __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_2_507;
      v31[3] = &unk_1E6A12F08;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        id v47 = v8;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Received request to prompt for pairing password for accessory server %@ but there is no setupCodeProvider", buf, 0x16u);
      }
      uint64_t v28 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2002];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      id v47 = v8;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Received request to prompt for pairing password for accessory server %@ that cannot be mapped to an unpaired accessory", buf, 0x16u);
    }
...
void __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_502(uint64_t a1)
{
  id v2 = [*(id *)(a1 + 32) pairingActivity];
...
void __65__HMDAccessoryBrowser__promptForPairingPasswordForServer_reason___block_invoke_2_507(id *a1, void *a2, void *a3, void *a4)
{
  id v7 = a2;
  id v8 = a3;
  id v9 = a4;
...
- (void)_pairAccessory:(id)a3 configuration:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = v13;
    __int16 v116 = 2112;
    id v117 = v8;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Received request to start pairing accessory %@", buf, 0x16u);
  }
  int64_t v102 = [MEMORY[0x1E4F653F0] currentActivity];
  ...
  if (!v14)
  {
    ...
    if (!v106)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v40;
        __int16 v116 = 2112;
        id v117 = v8;
        _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Could not find a server for unpaired accessory %@", buf, 0x16u);
      }
      v125[0] = *MEMORY[0x1E4F28568];
      long long v41 = [NSString stringWithFormat:@"Failed to start pairing with the accessory %@", v8];
      v126[0] = v41;
      v125[1] = *MEMORY[0x1E4F28588];
      long long v42 = [MEMORY[0x1E4F28B50] mainBundle];
      id v43 = [v42 localizedStringForKey:@"There was no server present for the accessory." value:&stru_1F2C9F1A8 table:0];
      v126[1] = v43;
      id v104 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v126 forKeys:v125 count:2];

      id v19 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:2 userInfo:v104];
    ...
    if (v104 && ([v104 transports] & 0x10) == 0)
    {
      ...
      v123[1] = *MEMORY[0x1E4F28588];
      v124[0] = v21;
      id v22 = NSString;
      id v23 = [MEMORY[0x1E4F28C58] hmStringFromErrorCode:15];
      __int16 v24 = [v22 stringWithFormat:@"%ld (%@) This accessory is already part of a home.", 13, v23];
      v124[1] = v24;
      id v19 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v124 forKeys:v123 count:2];

      id v25 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:15 userInfo:v19];
...
LABEL_48:
    ...
    {
      id v85 = (void *)MEMORY[0x1D9452090]();
      id v86 = v11;
      ...
      if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v88;
        _os_log_impl(&dword_1D49D5000, v87, OS_LOG_TYPE_INFO, "%{public}@HomeHub is not capable to handle Matter Shared Admin Pairing requests", buf, 0xCu);
      }
      id v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:92];
      id v25 = +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:2 error:v19];
...
LABEL_17:
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&uint8_t buf[4] = v48;
          __int16 v116 = 2112;
          id v117 = v8;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ is currently being paired", buf, 0x16u);
        }
        v120[0] = *MEMORY[0x1E4F28568];
        id v49 = [NSString stringWithFormat:@"Failed to start pairing with the accessory %@", v8];
        v120[1] = *MEMORY[0x1E4F28588];
        v121[0] = v49;
        __int16 v50 = NSString;
        uint64_t v51 = [MEMORY[0x1E4F28C58] hmStringFromErrorCode:15];
        __int16 v52 = [v50 stringWithFormat:@"%ld (%@) This accessory is already being added to a home.", 15, v51];
        v121[1] = v52;
        id v25 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v121 forKeys:v120 count:2];

        id v53 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:15 userInfo:v25];
...
LABEL_31:
        id v25 = objc_alloc_init(MEMORY[0x1E4F5BC10]);
        ...
        if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&uint8_t buf[4] = v78;
          ...
          __int16 v118 = 2112;
          v119 = v79;
          _os_log_impl(&dword_1D49D5000, v77, OS_LOG_TYPE_INFO, "%{public}@Starting pairing with accessory %@, request: %@", buf, 0x20u);
        }
        v107[0] = MEMORY[0x1E4F143A8];
        v107[1] = 3221225472;
        v107[2] = __70__HMDAccessoryBrowser__pairAccessory_configuration_completionHandler___block_invoke;
        v107[3] = &unk_1E6A19668;
        id v80 = v102;
        v81 = v67;
        id v82 = v80;
        id v108 = v80;
    ...
    if ([(HMDAccessoryBrowser *)v11 _isHomeHubAvailableWithConfiguration:v103])
    {
      ...
      id v89 = (void *)MEMORY[0x1D9452090]();
      id v90 = v11;
      ...
      if (os_log_type_enabled(v91, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v92;
        _os_log_impl(&dword_1D49D5000, v91, OS_LOG_TYPE_ERROR, "%{public}@Primary resident is not reachable", buf, 0xCu);
      }
      id v19 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2709];
      id v25 = +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:2 error:v19];
    ...
    {
      id v95 = (void *)MEMORY[0x1D9452090]();
      id v96 = v11;
      ...
      if (os_log_type_enabled(v97, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v98;
        _os_log_impl(&dword_1D49D5000, v97, OS_LOG_TYPE_ERROR, "%{public}@HomeHub is not available", buf, 0xCu);
      }
      id v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:91];
      id v25 = +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:2 error:v19];
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = v17;
    __int16 v116 = 2112;
    id v117 = v8;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Pairing accessory %@ failed since reprovisioning is in progress", buf, 0x16u);
  }
  v106 = [MEMORY[0x1E4F28C58] hmErrorWithCode:15];
...
- (void)_pairAccessoryWithDescription:(id)a3 configuration:(id)a4 progressHandler:(id)a5 completionHandler:(id)a6
{
  ...
  v187 = [MEMORY[0x1E4F653F0] currentActivity];
  id v12 = (void *)MEMORY[0x1D9452090]();
  v191 = self;
  int v13 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&buf[14] = v15;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received request to start pairing accessory with description %@", buf, 0x16u);
  }
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 2112;
      *(void *)&buf[14] = v10;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Pairing accessory with description %@ failed since reprovisioning is in progress", buf, 0x16u);
    }
    id v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:15];
      ...
      for (uint64_t i = 0; i != v23; ++i)
      {
        ...
        if ([v10 matchesAccessoryServer:v26])
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v237 = v36;
            _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@A tombstoned accessoryServer %@ matches the accessory with description %@", buf, 0x20u);
          }
          ...
          v193 = [MEMORY[0x1E4F28C58] hmErrorWithCode:13];
  ...
  if ([v10 isPaired])
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&uint8_t buf[4] = v30;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Accessory description indicates that the accessory is already paired - aborting...", buf, 0xCu);
    }
    id v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:11];
    v194 = +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:2 error:v20];
    uint64_t v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:11];
  ...
  if ([(HMDAccessoryBrowser *)v191 _isHomeHubMatterSharedAdminPairingCapableWithConfiguration:v188])
  {
    ...
    if (![(HMDAccessoryBrowser *)v191 _isHomeHubAvailableWithConfiguration:v188])
    {
      ...
      if (os_log_type_enabled(v130, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v131;
        _os_log_impl(&dword_1D49D5000, v130, OS_LOG_TYPE_ERROR, "%{public}@HomeHub is not available", buf, 0xCu);
      }
      id v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:91];
      v193 = +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:2 error:v20];
    ...
    {
      id v88 = (void *)MEMORY[0x1D9452090]();
      id v89 = v191;
      ...
      if (os_log_type_enabled(v90, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v91;
        _os_log_impl(&dword_1D49D5000, v90, OS_LOG_TYPE_ERROR, "%{public}@Primary resident is not reachable", buf, 0xCu);
      }
      id v20 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2709];
      v193 = +[HMDMatterAccessoryPairingEndContext hmdContextWithStep:2 error:v20];
...
LABEL_36:
            ...
            if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
            {
              ...
              *(_WORD *)&buf[22] = 2112;
              v237 = v55;
              _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Matched accessoryServer %@ to pair accessory %@", buf, 0x20u);
            }
            if (([v20 isPaired] & 1) != 0 || objc_msgSend(v20, "hasPairings"))
            {
              ...
              if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
              {
                ...
                *(_WORD *)&buf[22] = 2112;
                v237 = v60;
                _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_INFO, "%{public}@Matched accessoryServer %@ is already paired while attempting to pair accessory %@", buf, 0x20u);
              }
              if (!aBlock)
              {
              ...
              id v62 = [MEMORY[0x1E4F28C58] hmErrorWithCode:13];
              ...
              if (!v62 || ([v62 transports] & 0x10) != 0)
              {
                ...
                if (obja)
                {
                  ...
                  if (os_log_type_enabled(v141, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_WORD *)&unsigned char buf[12] = 2112;
                    *(void *)&buf[14] = v50;
                    _os_log_impl(&dword_1D49D5000, v141, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ is currently being paired", buf, 0x16u);
                  }
                  v234[0] = *MEMORY[0x1E4F28568];
                  v143 = [NSString stringWithFormat:@"Failed to start pairing with the accessory %@", v50];
                  v235[0] = v143;
                  v234[1] = *MEMORY[0x1E4F28588];
                  v144 = NSString;
                  v145 = [MEMORY[0x1E4F28C58] hmStringFromErrorCode:15];
                  v146 = [v144 stringWithFormat:@"%ld (%@) This accessory is already being added to a home.", 15, v145];
                  v235[1] = v146;
                  id v196 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v235 forKeys:v234 count:2];

                  id v127 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:15 userInfo:v196];
                ...
                {
                  id v196 = objc_alloc_init(MEMORY[0x1E4F5BC10]);
...
LABEL_127:
                  ...
                  if (os_log_type_enabled(v171, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_WORD *)&buf[22] = 2112;
                    v237 = v173;
                    _os_log_impl(&dword_1D49D5000, v171, OS_LOG_TYPE_INFO, "%{public}@Starting pairing with accessory %@, needs consent: %@", buf, 0x20u);
                  }
                  v197[0] = MEMORY[0x1E4F143A8];
                  v197[1] = 3221225472;
                  v197[2] = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_481;
                  v197[3] = &unk_1E6A19668;
                  id v174 = v187;
                  id v198 = v174;
                  obja = objb;
                  v199 = obja;
                  id v175 = v183;
                  id v200 = v175;
                  __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_481(v197);
                  [v174 begin];
                  *(void *)buf = v174;
              ...
              else
              {
                ...
                if (os_log_type_enabled(v123, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_WORD *)&buf[22] = 2112;
                  v237 = v125;
                  _os_log_impl(&dword_1D49D5000, v123, OS_LOG_TYPE_INFO, "%{public}@Matched accessoryServer %@ is part of paired accessories while attempting to pair accessory %@", buf, 0x20u);
                }
                obja = [MEMORY[0x1E4F28C58] hmErrorWithCode:13];
...
LABEL_42:
    ...
    id v62 = objc_alloc_init(MEMORY[0x1E4F5BC10]);
    ...
    if (v182)
    {
      ...
      if (!v82)
      {
        ...
        if (os_log_type_enabled(v85, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          v237 = v87;
          _os_log_impl(&dword_1D49D5000, v85, OS_LOG_TYPE_INFO, "%{public}@Accessory with identifier %@ is already paired while attempting to pair %@", buf, 0x20u);
        }
...
LABEL_139:
    ...
    if (v180)
    {
      ...
      if (v95)
      {
        ...
        if (os_log_type_enabled(v98, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          v237 = v100;
          _os_log_impl(&dword_1D49D5000, v98, OS_LOG_TYPE_INFO, "%{public}@Accessory with setupID %@ is already paired while attempting to pair %@", buf, 0x20u);
        }
        ...
        if (os_log_type_enabled(v103, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&unsigned char buf[12] = 2112;
          *(void *)&buf[14] = v95;
          _os_log_impl(&dword_1D49D5000, v103, OS_LOG_TYPE_INFO, "%{public}@Already paired accessory info: %@", buf, 0x16u);
        }
        ...
        v106 = [MEMORY[0x1E4F28C58] hmErrorWithCode:13];
    ...
    *(void *)&buf[16] = 0x3032000000;
    v237 = __Block_byref_object_copy__144943;
    v238 = __Block_byref_object_dispose__144944;
    id v239 = 0;
    dispatch_group_t v110 = dispatch_group_create();
    v208[0] = MEMORY[0x1E4F143A8];
    v208[1] = 3221225472;
    v208[2] = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_472;
    v208[3] = &unk_1E6A12E40;
    long long v111 = v110;
    v209 = v111;
    id v210 = v94;
    id v211 = v182;
...
LABEL_137:
  ...
  if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = v66;
    _os_log_impl(&dword_1D49D5000, v65, OS_LOG_TYPE_INFO, "%{public}@HomeHub is not capable to handle Matter Shared Admin Pairing requests", buf, 0xCu);
  }
  id v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:92];
...
void __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke(uint64_t a1, int a2, void *a3, void *a4, void *a5)
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v50 = 2112;
      uint64_t v51 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Waiting for the prior pending pairing to be removed from the accessory before proceeding with adding accessory %@", buf, 0x16u);
    }
  }
  else if (a2)
  {
    ...
    uint64_t v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:v21];
    ...
    if (*(void *)(a1 + 72))
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v50 = 2112;
        uint64_t v51 = v42;
        _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@Pairing failed because its already associated to home %@", buf, 0x16u);
  ...
  if (!v10)
  {
    ...
    v44[1] = 3221225472;
    v44[2] = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_466;
    v44[3] = &unk_1E6A18708;
    id v45 = *(id *)(a1 + 40);
    id v46 = *(id *)(a1 + 48);
    BOOL v47 = v13;
    id v25 = __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_466(v44);
    if (!v9)
    {
      uint64_t v26 = (void *)MEMORY[0x1D9452090](v25);
      id v27 = *(id *)(a1 + 32);
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v52 = 2112;
        id v53 = v31;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Waiting for discovery of accessory with setupID %@ (%@) to start pairing", buf, 0x20u);
      }
    }
  ...
  if (*(void *)(a1 + 72))
  {
    ...
    if (v23 == (void *)*MEMORY[0x1E4F5B998])
    {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v49 = v36;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@Pairing failed with fatal error", buf, 0xCu);
    }
    (*(void (**)(void))(*(void *)(a1 + 72) + 16))();
LABEL_29:
  }
...
void __101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_472(uint64_t a1, void *a2)
{
...
void *__101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_481(void *result)
{
  v1 = (void *)result[4];
  if (v1)
  {
...
void *__101__HMDAccessoryBrowser__pairAccessoryWithDescription_configuration_progressHandler_completionHandler___block_invoke_466(void *result)
{
  v1 = (void *)result[4];
  if (v1)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      BOOL v47 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@There is no unpaired accessory for %@ - removing with pairingInfo", buf, 0x16u);
    }
    long long v42 = 0u;
    long long v43 = 0u;
    long long v40 = 0u;
...
LABEL_12:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v48 = 2112;
        id v49 = v31;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Accessory description %@ matches accessory pending to be paired %@ - aborting the operation", buf, 0x20u);
  ...
  if ([v8 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v78 = 2112;
      id v79 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Cancel pairing matter accessory with error %@ context %@", buf, 0x20u);
  ...
  if (!v18)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v78 = 2112;
      id v79 = v24;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Cancel pairing with accessory but addAccessoryCompletion is nil %@/%@", buf, 0x20u);
          ...
          if ([v27 isPaired])
          {
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v80 = 2112;
              id v81 = v39;
              _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Cancelling pairing of the accessory that completed pair-setup: %@/%@/%@", buf, 0x2Au);
            ...
            if ([v69 supportsCHIP])
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = v59;
                ...
                __int16 v82 = 2112;
                id v83 = v45;
                _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Calling addAccessoryCompletion for unpaired accessory %@/%@, error %@, context %@", buf, 0x34u);
    ...
    if ([v69 supportsCHIP])
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v82 = 2112;
        id v83 = v53;
        _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_INFO, "%{public}@Calling addAccessoryCompletion explicitly because accessoryServer went away %@/%@, error %@, context %@", buf, 0x34u);
          ...
          if (v13 == [v6 linkType])
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v30 = 2112;
              id v31 = v20;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@WAC accessory %@/%@: continuing pairing after setup code has been provided", buf, 0x20u);
...
- (void)_notifyManagerOfNewAccessory
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v8 = 138543362;
      uint64_t v9 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying Home manager that a new unpaired accessory was discovered", (uint8_t *)&v8, 0xCu);
    }
...
void __54__HMDAccessoryBrowser_handleXPCConnectionInvalidated___block_invoke(uint64_t a1)
{
  ...
  {
    id v6 = *(void **)(a1 + 40);
    id v7 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2503];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      uint64_t v16 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Received connection invalidated notification, but no connection object was found: %@", (uint8_t *)&v13, 0x16u);
    }
  }
}
      ...
      if (!v11)
      {
        if (v15)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v42 = 2112;
          id v43 = v10;
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Received request to stop searching for new accessories for XPC connection: %@", buf, 0x16u);
        }
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          long long v41 = v35;
          _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Received invalid request to stop searching for new accessories with stop reason", buf, 0xCu);
        }
        char v36 = [MEMORY[0x1E4F28C58] hmErrorWithCode:80];
...
LABEL_25:
      ...
      if (v15)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v10;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Received request to start searching for new accessories for XPC connection: %@", buf, 0x16u);
      }
      ...
      if (v19)
      {
        ...
        id v39 = v19;
        uint64_t v21 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v39 forKeys:&v38 count:1];
...
LABEL_26:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v20;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Cannot search for new accessories because client identifier salt could not be determined: %@", buf, 0x16u);
      }
    }
    else
    {
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    long long v41 = v26;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Received invalid message in _handleRequestSearchForNewAccessories", buf, 0xCu);
  }
LABEL_27:
}
    ...
    if (v7 == v8)
    {
      if (v12)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory browser's generation counter matches client's value of %lu", buf, 0x16u);
      }
      __int16 v42 = @"kConfigGenerationCounterKey";
      id v14 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[HMDAccessoryBrowser generationCounter](v10, "generationCounter"));
      v43[0] = v14;
      BOOL v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v43 forKeys:&v42 count:1];
    }
    else
    {
      if (v12)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory browser's generation counter %lu does not match client's value of %lu", buf, 0x20u);
      }
      uint64_t v18 = [(HMDAccessoryBrowser *)v10 unassociatedAccessoriesForClientRequest:v4];
      id v14 = encodeRootObjectForIncomingXPCMessage(v18, v4);
      ...
      v35[1] = v19;
      BOOL v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v35 forKeys:v34 count:2];
    }
...
void __68__HMDAccessoryBrowser__handleCurrentWiFiNetworkChangedNotification___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2112;
    int v13 = v9;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@WiFi network connection changed; Thread preferred network database%@ updated",
      (uint8_t *)&v10,
      0x16u);
  }
}
...
- (void)_cancelCurrentlyPairingAccessories:(int64_t)a3 linkType:(id)a4
{
  ...
  int64_t v48 = a3;
  uint64_t v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:a3];
  unint64_t v8 = (void *)MEMORY[0x1E4F28C58];
  uint64_t v73 = *MEMORY[0x1E4F28A50];
  v74[0] = v7;
  id v56 = (void *)v7;
  id v9 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v74 forKeys:&v73 count:1];
      ...
      for (uint64_t i = 0; i != v55; ++i)
      {
        ...
        if (v15)
        {
          if (-[HMDAccessoryBrowser doesLinkTypeNumber:matchLinkType:]((uint64_t)self, v57, [v15 linkType]))
          {
            ...
            {
              id v20 = HMFGetLogIdentifier();
              [MEMORY[0x1E4F28C58] hmStringFromErrorCode:v48];
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v68 = 2112;
              id v69 = v23;
              _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@%@ - sending addAccessory failure for accessory %@/%@", buf, 0x2Au);
...
LABEL_18:
        ...
        else if (-[HMDAccessoryBrowser doesLinkTypeNumber:matchLinkType:]((uint64_t)self, v57, [v14 linkType]))
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v47;
            ...
            __int16 v66 = 2112;
            uint64_t v67 = v30;
            _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Removing pending pairing for accessory %@/%@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          __int16 v70 = 2112;
          id v71 = v57;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Not canceling pairing for accessory %@/%@ as link type %@ does not match stopped link type %@", buf, 0x34u);
...
LABEL_24:
  ...
  __int16 v46 = v45;
  if (v45) {
    [v45 cancelConfigurationWithCompletionHandler:&__block_literal_global_451_144987];
  }
}
...
- (void)_registerForNotifications
{
  ...
  [v5 addObserver:self selector:sel__handleCurrentWiFiNetworkChangedNotification_ name:*MEMORY[0x1E4F653E8] object:0];
}
...
- (void)_registerForMessages
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v20 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Registering remote account message filter", buf, 0xCu);
  }
  BOOL v7 = [HMDRemoteAccountMessageFilter alloc];
  unint64_t v8 = [(HMDAccessoryBrowser *)v4 messageDestination];
  id v9 = [(HMDRemoteAccountMessageFilter *)v7 initWithTarget:v8];
  ...
  int v13 = [MEMORY[0x1E4F65548] productInfo];
...
- (void)_restartBrowsers
{
          ...
          if (v12)
          {
            if (v16)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v33 = 2112;
              id v34 = v18;
              _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Restarting browser %@", buf, 0x16u);
            }
          ...
          else
          {
            if (v16)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v33 = 2112;
              id v34 = v20;
              _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping Restarting browser %@", buf, 0x16u);
            }
          }
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v32 = v24;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@No accessory browsers yet --- reset request ignored", buf, 0xCu);
    }
  }
}
...
LABEL_7:
        _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, v8, (uint8_t *)&v19, 0xCu);
...
LABEL_16:
          _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v19, 0xCu);
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
        {
          ...
          int v19 = 138543362;
          id v20 = v17;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Start discovering accessories need reprovision", (uint8_t *)&v19, 0xCu);
        }
        ...
        int v19 = 138543362;
        id v20 = v13;
        _os_log_impl(&dword_1D49D5000, &v12->super.super, OS_LOG_TYPE_INFO, "%{public}@Started the stop browsing accessories needing reprovisioning timer", (uint8_t *)&v19, 0xCu);
      }
    }
    else
    {
...
- (void)_startDiscoveringAccessoriesWithLinkType:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v24 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to start discovering accessories because browsing is not allowed", buf, 0xCu);
    }
  }
LABEL_22:
}
  ...
  if ([(HMDAccessoryBrowser *)self areThereAnyPairedAccessories])
  {
    if ([(HMDAccessoryBrowser *)self isBrowsingAllowed])
    {
      ...
      if ([(HMDAccessoryBrowser *)self areThereAnyPairedBTLEAccessories])
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
        {
          ...
          int v22 = 138543362;
          uint64_t v23 = v17;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Have paired BTLE accessories, starting reachability scan", (uint8_t *)&v22, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        int v22 = 138543362;
        uint64_t v23 = v21;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Ignoring request for start discovering paired accessories", (uint8_t *)&v22, 0xCu);
      }
    }
  }
}
      ...
      if (a4 != 2)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v24 = 2112;
          uint64_t v25 = v17;
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve server for identifier %@ for link type: %@", buf, 0x20u);
        }
        goto LABEL_14;
      }
...
- (void)timerDidFire:(id)a3
{
  ...
  while (2)
  {
    for (uint64_t i = 0; i != v9; ++i)
    {
      ...
      if (v14)
      {
        id v34 = [(HMDAccessoryBrowser *)self _unpairedAccessoryMatchingPairingInfo:v12];
        long long v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
...
- (void)_stopReprovisioningTimerHandler
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v18 = 138543362;
    id v19 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Stop reprovisioning timer fired", (uint8_t *)&v18, 0xCu);
  }
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      id v19 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Stopping browsing for WAC servers", (uint8_t *)&v18, 0xCu);
    }
    long long v12 = [(HMDAccessoryBrowser *)self ipAccessoryServerBrowser];
    [v12 stopDiscoveringWACAccessoryServersWithInvalidation:1];
  }
  id v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:8];
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    int v18 = 138543362;
    id v19 = v17;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@[Accessory Browser] Clean up reprovisioning accessory", (uint8_t *)&v18, 0xCu);
  }
  [(HMDAccessoryBrowser *)self setIdentifierOfAccessoryBeingReprovisioned:0];
  ...
  if (isBTLECapableDevice())
  {
    ...
    if (v3)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        int v9 = 138543362;
        uint64_t v10 = v7;
        _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Suspending the BTLE reachability probe timer", (uint8_t *)&v9, 0xCu);
      }
...
- (void)_btleAccessoryReachabilityProbeTimer:(BOOL)a3
{
  ...
  if (isBTLECapableDevice())
  {
    if ([(HMDAccessoryBrowser *)self isBrowsingAllowed])
    {
      ...
      BOOL v14 = [v13 homes];
      id v15 = objc_msgSend(v14, "na_firstObjectPassingTest:", &__block_literal_global_428);
      ...
      if (v15)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          id v34 = v20;
          __int16 v35 = 2048;
          unint64_t v36 = v10 / 0x3B9ACA00;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEBUG, "%{public}@In home: %@ location probing reachability every %llu sec", buf, 0x20u);
        }
      }
      if (isWatch())
      {
      ...
      dispatch_source_set_timer(v22, v12, v10, v21);

      objc_initWeak((id *)buf, self);
      id v23 = [(HMDAccessoryBrowser *)self reachabilityTimerForBTLE];
      handler[0] = MEMORY[0x1E4F143A8];
      handler[1] = 3221225472;
      handler[2] = __60__HMDAccessoryBrowser__btleAccessoryReachabilityProbeTimer___block_invoke_429;
      handler[3] = &unk_1E6A16E40;
      objc_copyWeak(&v30, (id *)buf);
      dispatch_source_set_event_handler(v23, handler);

      __int16 v24 = [(HMDAccessoryBrowser *)self reachabilityTimerForBTLE];
      dispatch_resume(v24);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v32 = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to start BTLE reachability timer", buf, 0xCu);
      }
    }
  }
}

void __60__HMDAccessoryBrowser__btleAccessoryReachabilityProbeTimer___block_invoke_429(uint64_t a1)
{
  uint64_t v16 = *MEMORY[0x1E4F143B8];
  v1 = (id *)(a1 + 32);
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  BOOL v3 = [WeakRetained identifiersOfPairedBTLEAccessories];
  id v4 = [WeakRetained btleAccessoryServerBrowser];
  if (v4)
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v15 = v10;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@BTLE reachability probe timer fired.", buf, 0xCu);
      }
      int64_t v11 = [v8 btleAccessoryServerBrowser];
...
- (void)cancelPairingWithAccessory:(id)a3 error:(id)a4 context:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  int64_t v11 = [(HMDAccessoryBrowser *)self workQueue];
  v15[0] = MEMORY[0x1E4F143A8];
  v15[1] = 3221225472;
...
void __64__HMDAccessoryBrowser_cancelPairingWithAccessory_error_context___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    id v6 = [*(id *)(a1 + 32) currentlyPairingProgressHandlers];
    [v6 removeObject:v5];
  }
}
...
uint64_t __66__HMDAccessoryBrowser_removePairingInformationForAccessoryServer___block_invoke(uint64_t a1)
{
  uint64_t v2 = [*(id *)(a1 + 32) unpairedAccessoryForServer:*(void *)(a1 + 40)];
  uint64_t v3 = v2;
  if (v2)
  {
    uint64_t v5 = v2;
    uint64_t v2 = [*(id *)(a1 + 32) _removePairingInformationForUnpairedAccessory:v2];
    uint64_t v3 = v5;
  }
...
- (id)unpairedHAPAccessoryWithAccessoryDescription:(id)a3
{
  ...
  uint64_t v5 = [(HMDAccessoryBrowser *)self unpairedAccessoryForServer:v4];
...
{
  uint64_t v2 = [*(id *)(a1 + 32) _progressHandlerForUnpairedAccessory:*(void *)(a1 + 40)];
  if (v2)
  {
    uint64_t v3 = [*(id *)(a1 + 32) currentlyPairingProgressHandlers];
    [v3 removeObject:v2];
  }
  uint64_t v5 = [[HMDUnpairedHAPAccessoryProgressHandler alloc] initWithAccessoryUUID:*(void *)(a1 + 40) progressHandler:*(void *)(a1 + 48)];
  ...
  if ([v3 linkType] == 1 && (objc_msgSend(v3, "hasPairings") & 1) == 0)
  {
    if ([v3 isPaired])
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v11 = 2112;
        id v12 = v8;
        _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Accessory server %@ reports it is unpaired, but we have pairings for it", (uint8_t *)&v9, 0x16u);
      }
    }
    else
    {
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@De-registering accessory server %@", buf, 0x16u);
    }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      if (v12 > 2) {
        ...
        uint64_t v13 = off_1E6A0B860[v12];
      }
      id v23 = v13;
      *(_DWORD *)buf = 138543874;
      *(void *)&uint8_t buf[4] = v11;
      ...
      __int16 v103 = 2112;
      id v104 = v7;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Found accessory server (transport %@) for unpaired accessory: %@", buf, 0x20u);
    }
    ...
    if (v91)
    {
      ...
      if (v24 == [v4 linkType])
      {
        ...
        long long v28 = (void *)MEMORY[0x1D9452090](v27);
        long long v29 = v9;
        id v30 = HMFGetOSLogHandle();
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&uint8_t buf[4] = v31;
          __int16 v101 = 2112;
          int64_t v102 = v7;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Restarting the pairing process for unpaired accessory: %@", buf, 0x16u);
        }
        id v32 = [v91 pairingActivity];
        v92[0] = MEMORY[0x1E4F143A8];
        v92[1] = 3221225472;
        v92[2] = __54__HMDAccessoryBrowser__addUnpairedAccessoryForServer___block_invoke_423;
        v92[3] = &unk_1E6A19668;
        id v87 = v32;
        id v93 = v87;
        id v33 = v91;
        ...
        id v83 = v25;
        id v95 = v83;
        __54__HMDAccessoryBrowser__addUnpairedAccessoryForServer___block_invoke_423(v92);
        id v34 = [v33 addAccessoryProgressHandler];
        if (v34) {
          goto LABEL_25;
        }
        __int16 v35 = [(HMDUnassociatedAccessory *)v7 uuid];
        unint64_t v36 = [(HMDAccessoryBrowser *)v29 _progressHandlerForUnpairedAccessory:v35];
        id v34 = [v36 progressHandler];

        if (v34)
        {
LABEL_25:
          uint64_t v37 = [HMDAddAccessoryProgressState alloc];
        ...
        id v43 = v87;
        *(void *)buf = v43;
        long long v44 = [v33 pairingRequest];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&uint8_t buf[4] = v20;
      ...
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Found new unpaired accessory: %@ with transport %@", buf, 0x20u);
    }
    ...
    if (v51)
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v55;
        ...
        __int16 v103 = 2112;
        id v104 = v51;
        _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_INFO, "%{public}@Starting the pairing process for unpaired accessory: %@ matching setup description %@", buf, 0x20u);
      }
...
void *__54__HMDAccessoryBrowser__addUnpairedAccessoryForServer___block_invoke_423(void *result)
{
  v1 = (void *)result[4];
  if (v1)
  {
...
- (void)_handleWACAccessoryFound
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  uint64_t v2 = [(HMDAccessoryBrowser *)self homeManager];
  id v3 = [v2 homes];
...
- (void)unassociatedWACAccessoryDidFinishAssociation:(id)a3 withError:(id)a4
{
  ...
  id v8 = +[HMDUIDialogPresenter sharedUIDialogPresenter];
  id v9 = [(HMDAccessoryBrowser *)self workQueue];
  [v8 dismissPendingDialogWithContext:v6 queue:v9 completionHandler:&__block_literal_global_415];
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v7;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@WAC session for %@ failed with %@", (uint8_t *)&v14, 0x20u);
    }
...
- (void)unassociatedWACAccessoryDidStartAssociation:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Tracking active WAC session: %@", (uint8_t *)&v9, 0x16u);
    }
...
- (void)requestPermissionToAssociateWACAccessory:(id)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v16 = 138543362;
      id v17 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Requesting permission from user to share network credentials with WAC accessory", (uint8_t *)&v16, 0xCu);
    }
...
void __43__HMDAccessoryBrowser_setActiveWACSession___block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = [*(id *)(a1 + 40) wacBrowser];
  id v3 = v2;
  if (v1) {
    [v2 requestBackoff];
  }
...
void __54__HMDAccessoryBrowser_removeUnassociatedWACAccessory___block_invoke(uint64_t a1)
{
  ...
  [v4 dismissPendingDialogWithContext:v2 queue:v3 completionHandler:&__block_literal_global_413];
...
- (void)_associateMediaAccessoryForServer:(id)a3
{
  ...
  if ([v4 compatibilityFeatures])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Found server: %@ supporting HAP+AP2", (uint8_t *)&v16, 0x16u);
    }
    ...
    if (v10 && [v10 isHAPAirPlay2Accessory])
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v20 = 2112;
        long long v21 = v10;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Associating unpaired HAP Accessory: %@ with media Accessory: %@", (uint8_t *)&v16, 0x20u);
      }
...
- (void)_associate:(BOOL)a3 hapAccessoryWithAdvertisement:(id)a4
{
          ...
          if (v25)
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v35 = 2112;
              unint64_t v36 = v10;
              _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Associating Advertisement: %@ with HAPAccessory: %@", buf, 0x20u);
            }
            id v22 = v5;
          }
          else
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v35 = 2112;
              unint64_t v36 = v10;
              _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Disassociating Advertisement: %@ from HAPAccessory: %@", buf, 0x20u);
            }
            id v22 = 0;
          }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v33 = 2112;
    id v34 = v5;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEBUG, "%{public}@No unpaired HAP accessory yet for advertisement: %@", buf, 0x16u);
  }
LABEL_20:
...
void __68__HMDAccessoryBrowser_addUnassociatedMediaAccessory_forDeviceSetup___block_invoke(uint64_t a1)
{
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v7;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@DeviceSetup accessory %@ already has a previous instance %@ - removing it", (uint8_t *)&v15, 0x20u);
    }
    [*(id *)(a1 + 40) _handleRemovedAccessory:*(void *)(a1 + 32)];
  }
    ...
    else
    {
      if (*(unsigned char *)(a1 + 57))
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v17 = 2112;
          uint64_t v18 = v14;
          _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding accessory %@ for deviceSetup", (uint8_t *)&v15, 0x16u);
        }
      }
...
void __59__HMDAccessoryBrowser_handleNewlyPairedAccessory_linkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v22 = 2112;
    char v23 = v13;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Discovering accessory server for newly added accessory: %@/%@", buf, 0x20u);
  }
...
- (void)homeLocationChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    long long v18 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification: %@", buf, 0x16u);
  }
      ...
      if (v38)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v38; ++i)
          {
            ...
            uint64_t v10 = v43;
            id v11 = (void *)MEMORY[0x1D9452090](v9);
            id v12 = *(id *)(a1 + 40);
            id v13 = HMFGetOSLogHandle();
            if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v53 = 2048;
              uint64_t v54 = v43;
              _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Home: %@ Reachable IP accessories: %tu", buf, 0x20u);
            }
            ...
            if (v16 == 2 && v10 == 0)
            {
              ...
              if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v51 = 2112;
                __int16 v52 = v8;
                _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Outside home region for home %@", buf, 0x16u);
              }
...
void __52__HMDAccessoryBrowser_handleConnectionDeactivation___block_invoke(uint64_t a1)
{
  ...
  {
    uint64_t v5 = *(void **)(a1 + 40);
    id v6 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2503];
...
- (void)_reprovisionAccessoryWithIdentifier:(id)a3 wiFiPSK:(id)a4 countryCode:(id)a5 withCompletion:(id)a6
{
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&v42[4] = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unable to reprovision accessory without a IP accessory server browser", v42, 0xCu);
    }
...
LABEL_12:
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, v21, v42, 0xCu);
...
LABEL_15:
  ...
  id v32 = (void *)MEMORY[0x1D9452090]([(HMDAccessoryBrowser *)self setCountrycodeForAccessoryReprovisioning:v12]);
  __int16 v33 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v42[12] = 2112;
    *(void *)&v42[14] = v10;
    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Start searching for accessory: %@ for reprovisioning", v42, 0x16u);
  }
  [v15 startDiscoveringWACAccessoryServerWithIdentifier:v10];
  __int16 v35 = [(HMDAccessoryBrowser *)self stopReprovisioningTimer];
  [v35 resume];

  unint64_t v36 = _Block_copy(v13);
  uint64_t v37 = v36;
  if (v36) {
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long v42 = 138543362;
    *(void *)&v42[4] = v41;
    _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Started the stop reprovisioning timer", v42, 0xCu);
  }
LABEL_17:
}
...
uint64_t __32__HMDAccessoryBrowser_activate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2048;
    uint64_t v14 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating with startDiscovery %ld", (uint8_t *)&v11, 0x16u);
  }
...
void __73__HMDAccessoryBrowser_stopDiscoveringForUnpairedAccessoriesWithLinkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for unpaired accessories with link type: %@", (uint8_t *)&v9, 0x16u);
  }
  BOOL v7 = *(void **)(a1 + 32);
...
void __62__HMDAccessoryBrowser_stopDiscoveringAccessoriesWithLinkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for accessories with link type: %@", (uint8_t *)&v9, 0x16u);
  }
  BOOL v7 = *(void **)(a1 + 32);
  id v8 = [NSNumber numberWithInteger:*(void *)(a1 + 40)];
...
uint64_t __49__HMDAccessoryBrowser_stopDiscoveringAccessories__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Stopping discovery for accessories", (uint8_t *)&v7, 0xCu);
  }
...
void __55__HMDAccessoryBrowser_startDiscoveringMediaAccessories__block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v7 = 138543362;
      id v8 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to start discovering media accessories", (uint8_t *)&v7, 0xCu);
    }
  }
}
...
void __63__HMDAccessoryBrowser_startDiscoveringAccessoriesWithLinkType___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting discovery for accessories with link Type: %@", (uint8_t *)&v9, 0x16u);
  }
  int v7 = *(void **)(a1 + 32);
  id v8 = [NSNumber numberWithInteger:*(void *)(a1 + 40)];
...
uint64_t __50__HMDAccessoryBrowser_startDiscoveringAccessories__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Starting discovery for accessories", (uint8_t *)&v7, 0xCu);
  }
...
void __41__HMDAccessoryBrowser_resetConfiguration__block_invoke(uint64_t a1)
{
  ...
  uint64_t v5 = [*(id *)(a1 + 32) hap2Storage];
  ...
  uint64_t v9 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2500];
                  ...
                  else
                  {
                    ...
                    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      __int16 v50 = 2112;
                      id v51 = v22;
                      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory advertisement data not routed through AccessoryBrowser: %@ - %@", buf, 0x20u);
    ...
    do
    {
      ...
      if (v10)
      {
        ...
        if (v13)
        {
          ...
          id v78 = v8;
          uint64_t v16 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v78 count:1];
...
LABEL_33:
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v74 = 2112;
            id v75 = v14;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unsupported operation - not creating HMDHAPAccessory from advertisement data: %@", buf, 0x16u);
      ...
      if (!v13)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v74 = 2112;
          id v75 = v20;
          _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@Unsupported operation - not  creating HMDHAPUnassociatedAccessory from advertisement data: %@", buf, 0x16u);
      ...
      if (v64)
      {
        ...
        if (v19)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v73 = v24;
            _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Advertisement is for known accessory, updating", buf, 0xCu);
        ...
        else
        {
          ...
          if (v37 && [v13 conformsToProtocol:&unk_1F2EA5B50])
          {
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              uint64_t v73 = v41;
              _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Advertisement supports WAC matching, checking active sessions for match", buf, 0xCu);
            }
            id v42 = v13;
            long long v61 = v39;
            ...
            if (v62)
            {
              ...
              long long v49 = [v48 unassociatedAccessoryFromAdvertisementData:v42];
              ...
              if (v49)
              {
                if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  uint64_t v73 = v57;
                  _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_INFO, "%{public}@Advertisement matches WAC device, performing handoff", buf, 0xCu);
                }
              ...
              else
              {
                if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v76 = 2112;
                  id v77 = v60;
                  _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Could not create accessory from advertisement %@ for matching WAC device %@", buf, 0x20u);
                }
                long long v58 = [(HMDAccessoryBrowser *)v53 getActiveWACSession];
                [v58 cancelConfigurationWithCompletionHandler:&__block_literal_global_402_145065];
              }
...
- (void)_notifyDelegateOfReachabilityChange:(BOOL)a3 forAccessoryWithIdentifier:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      int v21 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying '%@' that accessory with identifier %@ is %@", (uint8_t *)&v14, 0x2Au);
    }
...
void __35__HMDAccessoryBrowser___inactivate__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if (objc_msgSend(*(id *)(*((void *)&v23 + 1) + 8 * i), "isValid", (void)v23))
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v28 = v14;
            _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Not inactivating, there is an active assertion", buf, 0xCu);
          }
          return;
        }
      }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v28 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Inactivating", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v28 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@No HomeKit App in foreground - disabling BTLE scanning", buf, 0xCu);
    }
    id v19 = *(void **)(a1 + 32);
    __int16 v20 = [v19 btleAccessoryServerBrowser];
    [v19 _stopDiscoveryForAccessoryServerBrowser:v20];

    int v21 = [*(id *)(a1 + 32) ipAccessoryServerBrowser];
    [v21 stopDiscoveringWACAccessoryServersWithInvalidation:1];

    if (isiOSDevice() || isMac())
    {
      uint64_t v22 = objc_msgSend(*(id *)(a1 + 32), "hap2AccessoryServerBrowser", (void)v23);
...
- (void)endActiveAssertion:(id)a3
{
  ...
  if (!v6)
  {
    id v12 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Invalid assertion object" userInfo:0];
    goto LABEL_11;
  }
  ...
  if (v7 != self)
  {
    id v12 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:@"Invalid assertion object not created by HMHomeManager instance" userInfo:0];
LABEL_11:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Releasing active assertion : %@", (uint8_t *)&v13, 0x16u);
  }
  [v6 invalidate];
  os_unfair_lock_lock_with_options();
...
- (id)pairedHMDHAPAccessoryWithAccessoryServer:(id)a3
{
  ...
  if (v9)
  {
    ...
    id v11 = [v9 hmdHAPAccessoryWithHAPAccessory:v10];
  }
  else
  {
    id v11 = 0;
  ...
  if (v6)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v17 = 2112;
        id v18 = v6;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@De-registering connection for accessory browsing: %@", (uint8_t *)&v15, 0x16u);
      }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v45 = 2112;
      id v46 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Already have an active accessory browsing request from the connection: %@", buf, 0x16u);
    }
  }
  else
  {
    char v11 = (void *)[objc_alloc(MEMORY[0x1E4F654F8]) initWithObservedObject:v4];
    id v12 = (void *)MEMORY[0x1D9452090]();
    long long v13 = self;
    long long v14 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v45 = 2112;
      id v46 = v4;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Registering connection for accessory browsing: %@", buf, 0x16u);
    }
    ...
    if (v17)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          __int16 v20 = objc_msgSend(*(id *)(*((void *)&v33 + 1) + 8 * v19), "observedObject", v31, v32, (void)v33);
          objc_opt_class();
...
LABEL_17:
    ...
    if ([v5 count] == 1)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v44 = v26;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@First connection interested in accessory(and media) browsing - starting", buf, 0xCu);
      }
    ...
    else if ((v22 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v44 = v30;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@First connection interested in media accessory browsing - starting", buf, 0xCu);
      }
  ...
  if (WeakRetained && v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v15 = 2112;
      id v16 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling de-allocation of connection for accessory browsing: %@", buf, 0x16u);
    }
    BOOL v10 = [v6 workQueue];
    v11[0] = MEMORY[0x1E4F143A8];
    v11[1] = 3221225472;
    v11[2] = __47__HMDAccessoryBrowser___addBrowsingConnection___block_invoke_376;
    v11[3] = &unk_1E6A197C8;
    void v11[4] = v6;
    id v12 = v4;
    dispatch_async(v10, v11);
...
void __47__HMDAccessoryBrowser___addBrowsingConnection___block_invoke_376(uint64_t a1)
{
  uint64_t v1 = *(void **)(a1 + 32);
  uint64_t v2 = *(void *)(a1 + 40);
  id v3 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2504];
  ...
  if (v6)
  {
    ...
    if ([v9 containsObject:v6])
    {
      ...
      if (v11)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            long long v14 = objc_msgSend(*(id *)(*((void *)&v20 + 1) + 8 * v13), "observedObject", (void)v20);
            objc_opt_class();
            unsigned __int8 isKindOfClass = objc_opt_isKindOfClass();
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v25 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@No more clients interested in accessory browsing - stopping", buf, 0xCu);
      }
...
- (void)_sendNewAccessoryData:(id)a3 messageName:(id)a4
{
  ...
  if ([(HMDAccessoryBrowser *)self __isAccessoryBrowsingRequested])
  {
    ...
    id v31 = v27;
    long long v25 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v31 forKeys:&v30 count:1];
    uint64_t v28 = @"kAccessoriesInfoDataKey";
    id v29 = v26;
    BOOL v10 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v29 forKeys:&v28 count:1];
    uint64_t v11 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"BF2B0921-858B-42F5-B2EB-C915FB953E5B"];
    id v12 = (void *)[objc_alloc(MEMORY[0x1E4F65488]) initWithTarget:v11];
    uint64_t v13 = [MEMORY[0x1E4F654B0] messageWithName:v7 destination:v12 payload:v25];
    id v14 = v6;
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      long long v15 = v14;
    ...
    long long v24 = [(HMDAccessoryBrowser *)self messageDispatcher];
...
- (void)_handleRemovedAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Removed accessory: %@", (uint8_t *)&v9, 0x16u);
    }
...
- (void)_handleAddedAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Added accessory: %@", (uint8_t *)&v9, 0x16u);
    }
...
- (id)unassociatedAccessoriesForClientRequest:(id)a3
{
  ...
  uint64_t v18 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v5, "count"));
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
...
- (NSArray)unassociatedAccessories
{
  ...
  int v9 = [(HMDAccessoryBrowser *)self mediaBrowser];
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          ...
          __int16 v19 = 2112;
          id v20 = v10;
          _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown unassociated accessory type: %@ - dropping...", (uint8_t *)&v17, 0x16u);
        }
      }
    }
  }
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v23 = 2112;
            long long v24 = v10;
            _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Removing unassociated accessory: %@", buf, 0x16u);
          }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v18 = 2112;
        id v19 = v9;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown unassociated accessory type: %@ - dropping...", (uint8_t *)&v16, 0x16u);
      }
    }
  }
}
...
LABEL_24:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v38 = v35;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Demo accessory browser not yet started", buf, 0xCu);
      }
      id v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
    }
    else
    {
      id v11 = 0;
  ...
  if ((v5 & 1) != 0
    || ([(HMDAccessoryBrowser *)self demoAccessoryServerBrowser],
        ...
        !v13))
  {
    id v14 = [(HMDAccessoryBrowser *)self demoAccessoryServerBrowser];
    ...
    long long v24 = [(HMDAccessoryBrowser *)self demoAccessoryServerBrowser];
    [v23 addObject:v24];
  }
  if ([v6 count]) {
    char v25 = 1;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v38 = v30;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Request to add test/demo accessories but none found", buf, 0xCu);
    }
...
{
  uint64_t v44 = *MEMORY[0x1E4F143B8];
  objc_storeWeak((id *)(*(void *)(a1 + 32) + 152), *(id *)(a1 + 40));
  ...
  if ([v23 count])
  {
    long long v24 = [*(id *)(a1 + 32) mediaBrowser];
...
- (HMDAccessoryBrowser)initWithMessageDispatcher:(id)a3 injectedSettings:(id)a4
{
  ...
  id v8 = a4;
  v68.receiver = self;
  v68.super_class = (Class)HMDAccessoryBrowser;
  id v9 = [(HMDAccessoryBrowser *)&v68 init];
  if (v9)
  {
    uint64_t v10 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"BF2B0921-858B-42F5-B2EB-C915FB953E5B"];
    uuid = v9->_uuid;
    v9->_uuid = (NSUUID *)v10;
    ...
    long long v24 = [(HMDAccessoryBrowser *)v9 hap2Storage];
    ...
    uint64_t v44 = [MEMORY[0x1E4F28D30] weakObjectsHashTable];
    ...
    uint64_t v48 = [MEMORY[0x1E4F28D30] weakObjectsHashTable];
    ...
    uint64_t v54 = [MEMORY[0x1E4F28D30] weakObjectsHashTable];
    ...
    uint64_t v56 = [MEMORY[0x1E4F28D30] weakObjectsHashTable];
    ...
    uint64_t v60 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:120.0];
    ...
    uint64_t v63 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:60.0];
    ...
    browseableLinkTypes = v9->_browseableLinkTypes;
    v9->_browseableLinkTypes = (NSArray *)&unk_1F2DC6F40;

    [(HMDAccessoryBrowser *)v9 _registerForMessages];
    [(HMDAccessoryBrowser *)v9 _registerForNotifications];
  }
...
uint64_t __34__HMDAccessoryBrowser_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v363;
  logCategory__hmf_once_v363 = v0;
