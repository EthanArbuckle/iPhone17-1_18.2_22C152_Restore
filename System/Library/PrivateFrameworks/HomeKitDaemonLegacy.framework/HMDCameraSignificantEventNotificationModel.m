...
+ (id)significantEventsBetweenDatesQueryWithIsAscending:(BOOL)a3
{
  ...
  if (significantEventsBetweenDatesQueryWithIsAscending__onceToken != -1) {
    dispatch_once(&significantEventsBetweenDatesQueryWithIsAscending__onceToken, &__block_literal_global_43_28001);
  }
...
void __96__HMDCameraSignificantEventNotificationModel_significantEventsBetweenDatesQueryWithIsAscending___block_invoke()
{
  ...
  v14[0] = @"dateAfter";
  v1 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateOfOccurrence"];
  v14[1] = @"dateBefore";
  v15[0] = v1;
  v2 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateOfOccurrence"];
  v15[1] = v2;
  BOOL v3 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v15 forKeys:v14 count:2];
  uint64_t v4 = [v0 queryWithSQLPredicate:@"dateOfOccurrence >= :dateAfter AND dateOfOccurrence < :dateBefore ORDER BY dateOfOccurrence ASC" sequenceArgumentName:@"dateAfter" indexedProperties:&unk_1F2DC6AA8 arguments:v3];
  ...
  v12[0] = @"dateAfter";
  v7 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateOfOccurrence"];
  v12[1] = @"dateBefore";
  v13[0] = v7;
  v8 = [MEMORY[0x1E4F69EB0] argumentWithPropertyName:@"dateOfOccurrence"];
  v13[1] = v8;
  v9 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v13 forKeys:v12 count:2];
  uint64_t v10 = [v6 queryWithSQLPredicate:@"dateOfOccurrence > :dateAfter AND dateOfOccurrence <= :dateBefore ORDER BY dateOfOccurrence DESC" sequenceArgumentName:@"dateBefore" indexedProperties:&unk_1F2DC6AC0 arguments:v9];
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_28028 != -1) {
    dispatch_once(&hmbProperties_onceToken_28028, &__block_literal_global_28029);
  }
  v2 = (void *)hmbProperties__properties_28030;
  return v2;
}
...
void __59__HMDCameraSignificantEventNotificationModel_hmbProperties__block_invoke()
{
  ...
  v24 = [MEMORY[0x1E4F69EA0] queryableField];
  v29 = v24;
  ...
  v20 = [MEMORY[0x1E4F69EA0] externalRecordField:@"r00"];
  v28 = v20;
  v19 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v28 count:1];
  uint64_t v4 = [v2 fieldWithClass:v3 options:v19];
  v31[3] = v4;
  v30[4] = @"heroFrameAsset";
  v5 = (void *)MEMORY[0x1E4F69E98];
  uint64_t v6 = objc_opt_class();
  v7 = [MEMORY[0x1E4F69EA0] externalRecordField:@"a00"];
  v27 = v7;
  v8 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v27 count:1];
  v9 = [v5 fieldWithClass:v6 options:v8];
  v31[4] = v9;
  v30[5] = @"faceCropAsset";
  uint64_t v10 = (void *)MEMORY[0x1E4F69E98];
  uint64_t v11 = objc_opt_class();
  v12 = [MEMORY[0x1E4F69EA0] externalRecordField:@"a01"];
  v26 = v12;
  ...
  v31[7] = v16;
  uint64_t v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v31 forKeys:v30 count:8];
  v18 = (void *)hmbProperties__properties_28030;
  hmbProperties__properties_28030 = v17;
}
...
- (id)createClipSignificantEventWithCameraProfileUUID:(id)a3 faceClassification:(id)a4
{
  ...
  {
    v37 = v8;
    id v13 = objc_alloc(MEMORY[0x1E4F2E700]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      v43 = v35;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cannot create significant event from model: %@", buf, 0x16u);
