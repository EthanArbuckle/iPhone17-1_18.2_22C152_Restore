...
- (HMDCloudPairedMetadata)initWithBaseAccessoryIdentifier:(id)a3 data:(id)a4 allowUnzippedData:(BOOL)a5
{
  ...
  id v9 = a4;
  id v27 = 0;
  v10 = [MEMORY[0x1E4F28D90] JSONObjectWithData:v9 options:0 error:&v27];
  id v11 = v27;
  v12 = v11;
  if (v10) {
    BOOL v13 = v11 == 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v30 = 2112;
        id v31 = v18;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
      }
      long long v17 = 0;
    }
  }
...
LABEL_31:
        ...
        *(void *)&buf[16] = 0x2020000000;
        LOBYTE(v51) = 0;
        v37 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v10, "count", v40));
...
+ (id)__decodeVersionConfigurationWithVersionString:(id)a3 versionConfigurationValue:(id)a4 baseAccessoryIdentifier:(id)a5
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v33 = 2112;
        id v34 = v12;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Version configuration for version '%@' is not a dictionary: %@", (uint8_t *)&v29, 0x20u);
      }
      int v19 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v31 = 2112;
      id v32 = v8;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Version configuration contains an invalid version string: %@", (uint8_t *)&v29, 0x16u);
    }
    int v19 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_125911 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_125911, &__block_literal_global_125912);
  }
  v2 = (void *)logCategory__hmf_once_v1_125913;
  return v2;
}
...
uint64_t __37__HMDCloudPairedMetadata_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_125913;
  logCategory__hmf_once_v1_125913 = v0;
