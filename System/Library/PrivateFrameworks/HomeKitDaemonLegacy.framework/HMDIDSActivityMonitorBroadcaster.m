  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        int v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Data source updated, resuming debounce timer", (uint8_t *)&v12, 0xCu);
      }
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Debounce timer fired, rebuilding observer list", (uint8_t *)&v10, 0xCu);
  }
...
- (void)_refreshBroadcastSubscription
{
  ...
  if (v5)
  {
    ...
    uint64_t v7 = *MEMORY[0x1E4F6A690];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Current Device not yet determined, deferring IDS Activty broadcast", buf, 0xCu);
    }
  }
}
...
void __65__HMDIDSActivityMonitorBroadcaster__refreshBroadcastSubscription__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    v8 = [MEMORY[0x1E4F1CAD0] setWithArray:v11];
  ...
  {
    [v5 stopBroadcastingSubActivity:*MEMORY[0x1E4F6A690]];
...
void __55__HMDIDSActivityMonitorBroadcaster__registerForXPCPoll__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@XPCActivity handler was invoked after monitor was deallocated", buf, 0xCu);
    }
  }
}
...
LABEL_9:
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v12 = 138543362;
      uint64_t v13 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Queue and data source set, starting debounce timer", (uint8_t *)&v12, 0xCu);
    }
    [(HMFTimer *)v9->_debounceTimer resume];
  }
}
...
- (HMDIDSActivityMonitorBroadcaster)initWithActivityMonitor:(id)a3
{
  ...
  id v11 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:v10];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_135796 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_135796, &__block_literal_global_95_135797);
  }
  v2 = (void *)logCategory__hmf_once_v10_135798;
  return v2;
}
...
uint64_t __47__HMDIDSActivityMonitorBroadcaster_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v10_135798;
  logCategory__hmf_once_v10_135798 = v0;
...
+ (id)criteria
{
  ...
  xpc_dictionary_set_BOOL(empty, (const char *)*MEMORY[0x1E4F142B0], 1);
  xpc_dictionary_set_string(empty, (const char *)*MEMORY[0x1E4F142C8], (const char *)*MEMORY[0x1E4F142D0]);
