...
- (void)signPayloadWithBuilder:(id)a3 data:(id)a4 completion:(id)a5
{
  ...
  v18 = (void *)[objc_alloc(MEMORY[0x1E4F1C9B8]) initWithBytes:v28 length:64];
  id v19 = objc_alloc(MEMORY[0x1E4F5C100]);
...
- (void)encodeWithCompletion:(id)a3
{
  ...
  v6 = (void *)[objc_alloc(MEMORY[0x1E4F50E18]) initEC2WithAlgorithm:-7 curveIdentifier:1 x:v21 y:v19 d:0 keyOperations:0 keyIdentifier:0];
  v7 = [MEMORY[0x1E4F1C9B8] dataWithCOSEKey:v6];
  id v8 = [(HMDHomeWalletKeyISOCredential *)self pairingIdentity];
  v9 = +[HMDHome nfcIssuerKeyIdentifierWithPairingIdentity:v8];

  v10 = (void *)[objc_alloc(MEMORY[0x1E4F5C108]) initWithElementIdentifier:@"credential_id" dataValue:v9];
  long long v24 = v10;
  ...
  id v13 = objc_alloc(MEMORY[0x1E4F5C118]);
...
void __54__HMDHomeWalletKeyISOCredential_encodeWithCompletion___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  else
  {
    ...
    [v5 setObject:v8 forKeyedSubscript:*MEMORY[0x1E4F28A50]];
    uint64_t v6 = *(void *)(a1 + 40);
    v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 userInfo:v5];
...
- (HMDHomeWalletKeyISOCredential)initWithHAPPairingIdentity:(id)a3 deviceCredentialKeyExternalRepresentation:(id)a4
{
  ...
  if (v9)
  {
    ...
    uint64_t v11 = [objc_alloc(MEMORY[0x1E4F5C110]) initWithDelegate:v10];
