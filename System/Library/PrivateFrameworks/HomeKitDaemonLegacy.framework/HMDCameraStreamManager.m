...
void __50__HMDCameraStreamManager_remoteVideoServerDidDie___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Video server has died", (uint8_t *)&v6, 0xCu);
  }
}
...
void __63__HMDCameraStreamManager_remoteVideoClientDidReceiveLastFrame___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Last frame has been received", (uint8_t *)&v6, 0xCu);
  }
}
...
void __75__HMDCameraStreamManager_remoteVideoClient_remoteVideoAttributesDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v9 = 2112;
    uint64_t v10 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Remote video attributes did change: %@", (uint8_t *)&v7, 0x16u);
  }
}
...
void __64__HMDCameraStreamManager_remoteVideoClientDidReceiveFirstFrame___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v15 = 138543362;
    v16 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@First frame has been received", (uint8_t *)&v15, 0xCu);
  }
...
- (void)videoStreamDidUpdateConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Video stream's configuration update complete", (uint8_t *)&v10, 0xCu);
  }
...
- (void)videoStreamDidNetworkDeteriorate:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Video stream's network has deteriorated", (uint8_t *)&v10, 0xCu);
  }
...
- (void)videoStreamDidNetworkImprove:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Video stream's network has improved", (uint8_t *)&v10, 0xCu);
  }
...
- (void)videoStream:(id)a3 didStop:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2114;
    id v16 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Video stream session has stopped with error %{public}@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)videoStream:(id)a3 didStart:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    int v38 = 138543362;
    v39 = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Synchronizing video and audio streams", (uint8_t *)&v38, 0xCu);
  }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 2048;
    uint64_t v41 = v22;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Creating AVCRemoteVideoClient with stream token: %lu", (uint8_t *)&v38, 0x16u);
  }
  id v23 = objc_alloc(MEMORY[0x1E4F47980]);
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Updated slot identifier to %@", (uint8_t *)&v38, 0x16u);
  }
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
  {
    ...
    int v38 = 138543362;
    v39 = v37;
    _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Video stream has started, waiting for the first frame to arrive", (uint8_t *)&v38, 0xCu);
  }
...
- (void)_callConfigurationUpdated
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidUpdateConfiguration", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_callNetworkDeteriorated
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidNetworkDeteriorate", (uint8_t *)&v9, 0xCu);
  }
  double v8 = [(HMDCameraStreamManager *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callNetworkImproved
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidNetworkImprove", (uint8_t *)&v9, 0xCu);
  }
  double v8 = [(HMDCameraStreamManager *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStreamStoppedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidStopStream", (uint8_t *)&v11, 0xCu);
  }
...
- (void)_callRelayStarted
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidStartRelay:", (uint8_t *)&v9, 0xCu);
  }
  double v8 = [(HMDCameraStreamManager *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callReceivedFirstFrame
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidReceiveFirstFrame:", (uint8_t *)&v9, 0xCu);
  }
  double v8 = [(HMDCameraStreamManager *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStreamStarted
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamManagerDidStartStream", (uint8_t *)&v9, 0xCu);
  }
  double v8 = [(HMDCameraStreamManager *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)stopStream
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    v14 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopping stream", (uint8_t *)&v13, 0xCu);
  }
...
- (void)updateStreamConfiguration:(id)a3
{
  ...
  v22[3] = v18;
  v19 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v22 forKeys:v21 count:4];
...
- (void)startStreamWithVideoConfig:(id)a3 audioConfig:(id)a4
{
  ...
  if ([v10 conformsToProtocol:&unk_1F2E06298]) {
    uint64_t v11 = v10;
  }
  else {
    uint64_t v11 = 0;
  ...
  if (v12)
  {
    ...
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v80 = v18;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay for remote stream", buf, 0xCu);
    }
  ...
  else
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v80 = v46;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Starting local stream", buf, 0xCu);
    }
    ...
    {
      uint64_t v51 = qword_1D54D3C88[v50];
      uint64_t v52 = qword_1D54D3CC0[v50];
    }
    ...
    v78[6] = v69;
    v28 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v78 forKeys:v77 count:7];
...
LABEL_19:
  ...
  if (v23)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v37 = v31;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio stream interface", buf, 0xCu);
      }
      SEL v26 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video stream interface", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_15917 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_15917, &__block_literal_global_15918);
  }
  v2 = (void *)logCategory__hmf_once_v3_15919;
  return v2;
}

uint64_t __37__HMDCameraStreamManager_logCategory__block_invoke()
{
  logCategory__hmf_once_v3_15919 = HMFCreateOSLogHandle();
