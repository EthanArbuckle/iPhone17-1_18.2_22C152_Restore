...
void __59__HMDUserCloudShareManager_handleXPCConnectionInvalidated___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Received connection invalidated notification, but no connection object was found: %@", (uint8_t *)&v12, 0x16u);
    }
  }
}
...
void __74__HMDUserCloudShareManager_handleRemoteUserClientCloudShareRepairRequest___block_invoke(uint64_t a1)
{
  ...
  v2 = [*(id *)(a1 + 32) uuidForKey:*MEMORY[0x1E4F2E378]];
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Handling share repair message %@.", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v14;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Could not find home for share repair request on remote.", buf, 0xCu);
    }
    uint64_t v15 = *(void **)(a1 + 32);
    v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Home in share repair request not found in remote." reason:@"Home is needed for share repair" suggestion:0];
...
LABEL_7:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v20 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Could not find home for share request on remote.", buf, 0xCu);
  }
  ...
  if (v14)
  {
    ...
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Home in share request not found in remote." reason:@"Home is needed to share" suggestion:0];
  ...
  if (v7)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v17 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Forwarding received client info.", buf, 0xCu);
      }
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        int v29 = 138543362;
        v30 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Found xpc connection in message", (uint8_t *)&v29, 0xCu);
      }
      uint64_t v14 = [v4 arrayForKey:*MEMORY[0x1E4F2E280]];
      if (v14)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v31 = 2112;
          v32 = v26;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Missing container IDs while trying to register from process %@", (uint8_t *)&v29, 0x16u);
        }
        uint64_t v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3 description:@"Container IDs required" reason:@"No containerIDs specified" suggestion:0];
      }
    }
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        int v29 = 138543362;
        v30 = v21;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Transport is not XPC connection.", (uint8_t *)&v29, 0xCu);
      }
      uint64_t v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Transport is not XPC" reason:@"Need xpc connection" suggestion:0];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      int v29 = 138543362;
      v30 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@No transport on message.", (uint8_t *)&v29, 0xCu);
    }
    uint64_t v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Did not find transport" reason:@"Need xpc connection" suggestion:0];
  }
...
uint64_t __68__HMDUserCloudShareManager__handleLocalHomeDataRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Local home data removed, notifying clients", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __67__HMDUserCloudShareManager__handleUserSettingsUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@User settings updated, notifying clients.", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _postMultiUserStatusChangedNotification];
}
...
uint64_t __70__HMDUserCloudShareManager__handleEnableMultiUserChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Enable Multi-User changed, notifying clients.", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _postMultiUserStatusChangedNotification];
}
...
void __50__HMDUserCloudShareManager__handleAccessoryAdded___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v5;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client on adding accessory %@", (uint8_t *)&v10, 0x16u);
    }
...
uint64_t __59__HMDUserCloudShareManager_handleUsersChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client on users changed", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _postMultiUserStatusChangedNotification];
}
...
uint64_t __58__HMDUserCloudShareManager_handleHomeChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client on home change", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _postMultiUserStatusChangedNotification];
}
...
- (id)currentDateForUserCloudShareController:(id)a3
{
  return (id)objc_msgSend(MEMORY[0x1E4F1C9C8], "date", a3);
}

- (id)userCloudShareController:(id)a3 timerWithInterval:(double)a4
{
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:a4];
  return v4;
}
...
- (void)userCloudShareController:(id)a3 wakeClientForRepairWithContainerID:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = [NSString stringWithFormat:@"%s%@", *MEMORY[0x1E4F2E2A0], v7];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v8;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client to repair share %@", buf, 0x16u);
  }
  id v13 = v8;
...
- (void)userCloudShareController:(id)a3 wakeClientWithContainerID:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = [NSString stringWithFormat:@"%s%@", *MEMORY[0x1E4F2E2B0], v7];
  uint64_t v9 = (void *)MEMORY[0x1D9452090]();
  int v10 = self;
  id v11 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v8;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Posting notification to wake client %@", buf, 0x16u);
  }
  id v13 = v8;
  notify_post((const char *)[v13 UTF8String]);
}
...
- (void)userCloudShareController:(id)a3 sendRepairInfo:(id)a4 toConnection:(id)a5 home:(id)a6 containerID:(id)a7
{
  ...
  uint64_t v11 = *MEMORY[0x1E4F2E368];
  v26[0] = a7;
  uint64_t v12 = *MEMORY[0x1E4F2E398];
  v25[0] = v11;
  v25[1] = v12;
  id v13 = a7;
  id v14 = a6;
  ...
  uint64_t v21 = (void *)[v20 initWithUUIDString:*MEMORY[0x1E4F2E2A8]];
  uint64_t v22 = (void *)[v19 initWithTarget:v21];

  v23 = [MEMORY[0x1E4F65480] messageWithName:*MEMORY[0x1E4F2E288] destination:v22 payload:v18];
...
void __98__HMDUserCloudShareManager_userCloudShareController_sendRepairInfo_toConnection_home_containerID___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v8 = 138543362;
      uint64_t v9 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send message to client.", (uint8_t *)&v8, 0xCu);
    }
  }
}
...
- (void)userCloudShareController:(id)a3 sendShareRequestMessageWithConnection:(id)a4 fromUser:(id)a5 toUser:(id)a6 home:(id)a7 shareURL:(id)a8 shareToken:(id)a9 containerID:(id)a10 completion:(id)a11
{
  ...
  if (v17)
  {
    v49[0] = *MEMORY[0x1E4F2E3A8];
    id v20 = a7;
    id v21 = a5;
    id v22 = a4;
    v23 = encodeRootObjectForIncomingXPCMessage(a6, 0);
    v50[0] = v23;
    v49[1] = *MEMORY[0x1E4F2E370];
    v24 = encodeRootObjectForIncomingXPCMessage(v21, 0);

    v50[1] = v24;
    v49[2] = *MEMORY[0x1E4F2E378];
    v25 = encodeRootObjectForIncomingXPCMessage(v20, 0);

    uint64_t v26 = *MEMORY[0x1E4F2E3B8];
    v50[2] = v25;
    v50[3] = v16;
    uint64_t v27 = *MEMORY[0x1E4F2E3B0];
    v49[3] = v26;
    v49[4] = v27;
    v49[5] = *MEMORY[0x1E4F2E368];
    v50[4] = v17;
    v50[5] = v18;
  ...
  {
    v47[0] = *MEMORY[0x1E4F2E3A8];
    id v32 = a7;
    id v33 = a5;
    id v34 = a4;
    v23 = encodeRootObjectForIncomingXPCMessage(a6, 0);
    v48[0] = v23;
    v47[1] = *MEMORY[0x1E4F2E370];
    v24 = encodeRootObjectForIncomingXPCMessage(v33, 0);

    v48[1] = v24;
    v47[2] = *MEMORY[0x1E4F2E378];
    v25 = encodeRootObjectForIncomingXPCMessage(v32, 0);

    uint64_t v35 = *MEMORY[0x1E4F2E3B8];
    v48[2] = v25;
    v48[3] = v16;
    uint64_t v36 = *MEMORY[0x1E4F2E368];
    v47[3] = v35;
    v47[4] = v36;
    v48[4] = v18;
    v28 = (void *)MEMORY[0x1E4F1C9E8];
  ...
  v38 = (void *)MEMORY[0x1E4F65480];
  uint64_t v39 = *MEMORY[0x1E4F2E290];
...
void __155__HMDUserCloudShareManager_userCloudShareController_sendShareRequestMessageWithConnection_fromUser_toUser_home_shareURL_shareToken_containerID_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Got error from client %@.", (uint8_t *)&v19, 0x16u);
    }
LABEL_10:
    id v14 = 0;
    goto LABEL_11;
  }
  uint64_t v12 = [v6 objectForKeyedSubscript:*MEMORY[0x1E4F2E278]];
  ...
  if ((v13 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      id v20 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@No error but client did not accept share, treating as error.", (uint8_t *)&v19, 0xCu);
    }
    id v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3 description:@"Client failed to accept share" reason:@"Did not accept share" suggestion:0];
    goto LABEL_10;
  }
  id v14 = objc_msgSend(v7, "hmf_dataForKey:", *MEMORY[0x1E4F2E270]);
  id v5 = 0;
LABEL_11:
...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v14 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Registering for user share messages.", buf, 0xCu);
  }
  int v8 = [(HMDUserCloudShareManager *)v5 messageDispatcher];
  uint64_t v9 = *MEMORY[0x1E4F2E298];
...
void __59__HMDUserCloudShareManager_configureWithMessageDispatcher___block_invoke(uint64_t a1)
{
  ...
  [v6 addObserver:*(void *)(a1 + 32) selector:sel__handleEnableMultiUserChangedNotification_ name:*MEMORY[0x1E4F2D600] object:0];
...
- (HMDUserCloudShareManager)initWithHomeManager:(id)a3 dependency:(id)a4
{
  ...
  if (v8)
  {
    ...
    uint64_t v15 = [v14 initWithUUIDString:*MEMORY[0x1E4F2E2A8]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t26 != -1) {
    dispatch_once(&logCategory__hmf_once_t26, &__block_literal_global_1886);
  }
