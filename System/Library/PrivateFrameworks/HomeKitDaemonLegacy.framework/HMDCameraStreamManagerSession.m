...
- (BOOL)canStartWithError:(id *)a3
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v18 = 2112;
    v19 = v12;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Stream tracker cannot start stream session: %@", (uint8_t *)&v16, 0x16u);
  }
  if (!a3) {
    return 0;
  }
  id v15 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1018];
  BOOL result = 0;
  *a3 = v15;
  return result;
}
...
LABEL_6:
  ...
  if (a7 > 0.0)
  {
    v17 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:a7];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_6098 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_6098, &__block_literal_global_6099);
  }
  v2 = (void *)logCategory__hmf_once_v2_6100;
  return v2;
}

uint64_t __44__HMDCameraStreamManagerSession_logCategory__block_invoke()
{
  logCategory__hmf_once_v2_6100 = HMFCreateOSLogHandle();
