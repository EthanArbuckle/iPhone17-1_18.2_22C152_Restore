...
+ (id)logCategory
{
  if (logCategory__hmf_once_t209 != -1) {
    dispatch_once(&logCategory__hmf_once_t209, &__block_literal_global_359_156340);
  }
  v2 = (void *)logCategory__hmf_once_v210;
  return v2;
}
...
void __62__HMDHomeWalletKeyAccessoryManager_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  v2 = [MEMORY[0x1E4F65430] internalOnlyInitializer];
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    v18 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Configuring NFC Reader Key because accessory was configured", (uint8_t *)&v15, 0x16u);
  }
  ...
  {
    v9 = [MEMORY[0x1E4F65430] internalOnlyInitializer];
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      v18 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Fetching wallet key color because accessory was configured", (uint8_t *)&v15, 0x16u);
    }
...
- (void)configureNFCReaderKeyForAccessory:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v51 = 2112;
    id v52 = v14;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring NFC reader key for accessory: %@", buf, 0x20u);
  }
  if ([v6 supportsWalletKey])
  {
    ...
    if ((v16 & 1) == 0)
    {
      __int16 v17 = [(HMDHomeWalletKeyAccessoryManager *)v10 home];
      v18 = v17;
      if (v17)
      {
        uint64_t v19 = [v17 currentUser];
        int v20 = [v19 isOwner];
          ...
          if ([(HMDHomeWalletKeyAccessoryConfigureState *)v23 readerKeyConfigured])
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v51 = 2112;
              id v52 = v31;
              _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Accessory is already configured with reader key: %@", buf, 0x20u);
            }
          }
          else if ([(HMDHomeWalletKeyAccessoryConfigureState *)v23 readerKeyConfigureInProgress])
          {
            ...
            if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v51 = 2112;
              id v52 = v42;
              _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Setting should retry on nfc reader key configure failure for accessory: %@", buf, 0x20u);
            }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v51 = 2112;
          id v52 = v6;
          _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Home does not exist when configuring reader key for accessory: %@", buf, 0x20u);
        }
      }
    }
  }
...
- (void)configureNFCReaderKeyForAllAccessoriesWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Configuring NFC reader key for all accessories with reason: %@", buf, 0x20u);
  }
  long long v20 = 0u;
  long long v21 = 0u;
  long long v18 = 0u;
...
- (void)registerForNotificationsWithReason:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
  dispatch_assert_queue_V2(v5);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v30 = 2112;
    id v31 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering for notifications with reason: %@", buf, 0x16u);
  }
  v10 = [(HMDHomeWalletKeyAccessoryManager *)v7 home];
  id v11 = [(HMDHomeWalletKeyAccessoryManager *)v7 notificationCenter];
  ...
  uint64_t v15 = [(HMDHomeWalletKeyAccessoryManager *)v7 notificationCenter];
  [v15 addObserver:v7 selector:sel_handleHomeAddedAccessoryNotification_ name:@"HMDNotificationHomeAddedAccessory" object:v10];

  uint64_t v16 = [(HMDHomeWalletKeyAccessoryManager *)v7 notificationCenter];
  ...
  uint64_t v17 = [v10 accessoriesWithWalletKeySupport];
  ...
  long long v18 = [(HMDHomeWalletKeyAccessoryManager *)v7 delegate];

  if (v18)
  {
    long long v19 = [MEMORY[0x1E4F65430] internalOnlyInitializer];
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Fetching wallet key color after registering for notifications", buf, 0x16u);
    }
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v43 = 2112;
        id v44 = v7;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling pending device credential operations with reason: %@", buf, 0x16u);
      }
      id v27 = v7;

      id v28 = v13;
      uint64_t v16 = [(HMDHomeWalletKeyAccessoryManager *)v13 pendingAccessoryDeviceCredentialKeyOperationByDeviceUUID];
      ...
      if (v31)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v31; ++i)
          {
            ...
            long long v21 = [v18 objectForKeyedSubscript:v20];
            v22 = [v21 user];
            if (v22)
            {
              ...
              id v23 = v21;
              id v35 = v23;
              v24 = objc_msgSend(v29, "na_filter:", v34);
              id v25 = [v23 deviceCredentialKey];
              v26 = [MEMORY[0x1E4F65430] untrackedPlaceholderFlow];
...
- (void)fetchWalletKeyColorWithFlow:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v56 = 2112;
    v57 = v13;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching wallet key color", buf, 0x16u);
  }
  uint64_t v14 = [(HMDHomeWalletKeyAccessoryManager *)v10 dataSource];
  uint64_t v15 = [(HMDHomeWalletKeyAccessoryManager *)v10 walletKeyColorPreferenceKey];
  uint64_t v16 = [v14 numberValueFromNoBackupStoreWithKey:v15];
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      v57 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Skipping fetch, returning wallet key color from persistent store", buf, 0x16u);
    }
    v7[2](v7, v16, 0);
  }
  else
  {
    ...
    id v23 = [v22 accessoriesWithWalletKeySupport];
    int v24 = objc_msgSend(v23, "na_any:", &__block_literal_global_156308);
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v58 = 2112;
      v59 = v32;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching wallet key color for home that does have Matter accessories: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        long long v37 = [v6 UUID];
        *(_DWORD *)buf = 138543618;
        v55 = v36;
        __int16 v56 = 2112;
        v57 = v37;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Redispatching FetchWalletKeyColorMessage to resident because home has matter accessories", buf, 0x16u);
      }
      id v38 = objc_alloc(MEMORY[0x1E4F65488]);
      long long v39 = [(HMDHomeWalletKeyAccessoryManager *)v34 messageTargetUUID];
      v40 = (void *)[v38 initWithTarget:v39];

      id v41 = objc_alloc(MEMORY[0x1E4F65480]);
      uint64_t v42 = *MEMORY[0x1E4F2D268];
      uint64_t v52 = *MEMORY[0x1E4F64F08];
      __int16 v43 = HMFEncodedRootObject();
      uint64_t v53 = v43;
      id v44 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v53 forKeys:&v52 count:1];
      uint64_t v45 = (void *)[v41 initWithName:v42 destination:v40 payload:v44];
      ...
      id v46 = [(HMDHomeWalletKeyAccessoryManager *)v34 messageTargetUUID];
...
void __71__HMDHomeWalletKeyAccessoryManager_registerForNotificationsWithReason___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (v10)
    {
      ...
      __int16 v19 = 2112;
      id v20 = v13;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully fetched wallet key color when registered for notifications %@", (uint8_t *)&v15, 0x20u);
...
LABEL_6:
  ...
  else if (v10)
  {
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Could not fetch wallet key color when registered for notifications %@", (uint8_t *)&v15, 0x20u);
...
- (void)updateHomeWalletKeyAddForAccessoryUUID:(id)a3 keyType:(unint64_t)a4
{
  ...
  {
    BOOL v10 = [(HMDHomeWalletKeyAccessoryManager *)self logEvents];
    [v10 removeObject:v9];
  }
}
...
{
  id v8 = a3;
  id v9 = [(HMDHomeWalletKeyAccessoryManager *)self logEvents];
  BOOL v10 = objc_msgSend(v9, "na_filter:", &__block_literal_global_356_156015);
  ...
  uint64_t v21 = __96__HMDHomeWalletKeyAccessoryManager_startHomeWalletKeyAddForAccessoryUUID_keyType_expectedCount___block_invoke_2;
  v22 = &unk_1E6A148A8;
  id v13 = v8;
  id v23 = v13;
  unint64_t v24 = a4;
  uint64_t v14 = objc_msgSend(v12, "na_firstObjectPassingTest:", &v19);

  if (!v14)
  {
    id v15 = [(HMDHomeWalletKeyAccessoryManager *)self logEvents];
    unint64_t v16 = [HMDHomeKeySetupLockLogEvent alloc];
    __int16 v17 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
    id v18 = [(HMDHomeKeySetupLockLogEvent *)v16 initWithAccessoryUUID:v13 withKeyType:a4 expectedCount:a5 queue:v17];
    [v15 addObject:v18];
  }
}
...
- (id)fetchWalletKeyColorForAccessories_HAP:(id)a3 home:(id)a4 flow:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v38 = 2112;
    id v39 = v8;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching wallet key color for HAP accessories: %@", buf, 0x20u);
  }
  v32[0] = MEMORY[0x1E4F143A8];
  v32[1] = 3221225472;
  ...
  id v16 = v10;
  id v33 = v16;
  __int16 v17 = objc_msgSend(v8, "na_map:", v32);
  ...
  if (v18)
  {
    ...
    uint64_t v21 = [(HMFObject *)v12 description];
    v27[0] = MEMORY[0x1E4F143A8];
    v27[1] = 3221225472;
    v27[2] = __84__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_HAP_home_flow___block_invoke_353;
    v27[3] = &unk_1E6A14860;
...
id __84__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_HAP_home_flow___block_invoke(uint64_t a1, void *a2)
{
  uint64_t v32 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  id v4 = (void *)*MEMORY[0x1E4F2DDB8];
  BOOL v5 = [v3 findServiceWithServiceType:*MEMORY[0x1E4F2DDB8]];
  id v6 = v5;
  if (v5)
  {
    id v7 = [v5 findCharacteristicWithType:@"0000026C-0000-1000-8000-0026BB765291"];
    if (v7)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color options: %@, accessory information service: %@ doesn't support hardware finish characteristic: %@", (uint8_t *)&v22, 0x34u);
      }
      id v8 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      uint64_t v14 = [v3 shortDescription];
      int v22 = 138544130;
      id v23 = v12;
      __int16 v24 = 2112;
      id v25 = v13;
      ...
      __int16 v28 = 2112;
      id v29 = v4;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color options: %@, accessory information service not supported %@", (uint8_t *)&v22, 0x2Au);
    }
    id v8 = 0;
  }
...
void __84__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_HAP_home_flow___block_invoke_353(id *a1, uint64_t a2, void *a3)
{
  id v4 = a3;
...
void __84__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_HAP_home_flow___block_invoke_2(id *a1)
{
    ...
    *(void *)&long long v2 = 138544386;
    ...
    do
    {
      for (uint64_t i = 0; i != v36; ++i)
      {
        ...
        id v6 = v1[5];
        id v37 = 0;
        id v7 = objc_msgSend(v6, "hmd_valueOfCharacteristic:error:", v5, &v37);
        id v8 = v37;
        if (v7)
        {
          id v9 = v7;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = v31;
              ...
              __int16 v50 = 2112;
              uint64_t v51 = v24;
              _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Characteristic value in the read request: %@ is not of type %@:%@", buf, 0x34u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v48 = 2112;
            id v49 = v8;
            _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Characteristic read request failed with error %@:%@", buf, 0x2Au);
          }
        }
      }
      uint64_t v36 = [obj countByEnumeratingWithState:&v38 objects:v52 count:16];
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v43 = v28;
    _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Failed to find wallet key color for HAP accessories", buf, 0xCu);

    v1 = v34;
  }

  id v29 = v1[8];
  __int16 v30 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
...
- (id)fetchWalletKeyColorForAccessories_Matter:(id)a3 home:(id)a4 flow:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v30 = 2112;
    id v31 = v8;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching wallet key color for Matter accessories: %@", buf, 0x20u);
  }
  ...
  id v16 = v10;
  id v25 = v16;
  __int16 v17 = objc_msgSend(v8, "na_map:", v24);
...
id __87__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_Matter_home_flow___block_invoke_3(uint64_t a1, void *a2)
{
  uint64_t v19 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_347);
  BOOL v5 = objc_msgSend(v4, "na_firstObjectPassingTest:", &__block_literal_global_350);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to find wallet key color for Matter accessories", (uint8_t *)&v15, 0x16u);
    }
...
- (void)fetchWalletKeyColorForAccessories:(id)a3 flow:(id)a4 withCompletion:(id)a5
{
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v44 = 2112;
      uint64_t v45 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Skipping fetch, returning wallet key color from persistence store", buf, 0x16u);
    }
    v10[2](v10, v14, 0);
  }
  else
  {
    ...
    if (v20)
    {
      uint64_t v21 = objc_msgSend(v8, "na_filter:", &__block_literal_global_340);
      uint64_t v36 = objc_msgSend(v8, "na_filter:", &__block_literal_global_342);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        uint64_t v45 = v34;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color options, home is nil", buf, 0x16u);
      }
...
void __90__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorForAccessories_flow_withCompletion___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_345);
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched wallet key color: %@", (uint8_t *)&v20, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v20 = 138543362;
      uint64_t v21 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to find color for Matter or HAP accessories", (uint8_t *)&v20, 0xCu);
    }
...
- (id)walletKeyColorWithCharacteristicValue:(id)a3 flow:(id)a4
{
  ...
  id v7 = a4;
  id v33 = 0;
  id v8 = [MEMORY[0x1E4F5BD60] parsedFromData:v6 error:&v33];
  id v9 = v33;
  if (v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        uint32_t v28 = 22;
LABEL_19:
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, v26, buf, v28);
      }
    }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v40 = 2112;
    id v41 = v9;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Unable to get wallet key color, failed to parse hardware finish from encoded tlv data %@:%@", buf, 0x2Au);
  }
  int v20 = 0;
LABEL_22:
...
void __74__HMDHomeWalletKeyAccessoryManager_fetchWalletKeyColorWithAccessory_flow___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      id v10 = HMFGetLogIdentifier();
      id v11 = [a1[5] UUID];
      uint64_t v12 = [a1[6] shortDescription];
      int v13 = 138544130;
      uint64_t v14 = v10;
      __int16 v15 = 2112;
      id v16 = v11;
      ...
      __int16 v19 = 2112;
      int v20 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch wallet key color when accessory connected %@:%@", (uint8_t *)&v13, 0x2Au);
    }
  }
}
...
- (id)writeRequestsWithAccessories:(id)a3 home:(id)a4 deviceCredentialKey:(id)a5 user:(id)a6 flow:(id)a7
{
  ...
  if (v16)
  {
    id v17 = objc_alloc_init(MEMORY[0x1E4F5BDB0]);
    [v17 setKey:v13];
    id v18 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC0]) initWithValue:2];
    [v17 setType:v18];

    v71 = (void *)v16;
    [v17 setIssuerKeyIdentifier:v16];
    __int16 v19 = (void *)[objc_alloc(MEMORY[0x1E4F5BDB8]) initWithValue:1];
    [v17 setState:v19];

    v69 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC8]) initWithValue:2];
    v70 = v17;
    id v85 = 0;
    v68 = (void *)[objc_alloc(MEMORY[0x1E4F5BDA8]) initWithOperationType:v69 issuerKeyRequest:0 issuerKeyResponse:0 deviceCredentialKeyRequest:v17 deviceCredentialKeyResponse:0 readerKeyRequest:0 readerKeyResponse:0];
            ...
            if (v28)
            {
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138544386;
                    ...
                    _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, NFC access service: %@ doesn't support control point characteristic: %@", buf, 0x34u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
                {
                  ...
                  uint64_t v45 = [v24 shortDescription];
                  *(_DWORD *)buf = 138544130;
                  v87 = v43;
                  __int16 v88 = 2112;
                  v89 = v44;
                  ...
                  _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, nfc access service not supported %@", buf, 0x2Au);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544386;
                ...
                __int16 v94 = 2112;
                v95 = v12;
                _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, home: %@ doesn't match current home: %@", buf, 0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v92 = 2112;
        v93 = v67;
        _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key, unable to encode nfc access control %@:%@", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v88 = 2112;
      v89 = v59;
      _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] NFC issuer key identifier for user is nil", buf, 0x16u);
    }
    uint64_t v52 = [MEMORY[0x1E4F1CAD0] set];
  }
...
- (id)configureMatterAccessory:(id)a3 withDeviceCredentialKey:(id)a4 ofType:(int64_t)a5 forUser:(id)a6 flow:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v69 = 2112;
    id v70 = v24;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring Matter accessory with device credential key. accessory: %@, deviceCredentialKey: %@ forUser: %@", buf, 0x34u);
  ...
  uint64_t v51 = v16;
  id v48 = v13;
  id v27 = objc_alloc_init(MEMORY[0x1E4F5BD30]);
  char v28 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC0]) initWithValue:2];
  [v27 setType:v28];

  [v27 setKey:v25];
  id v29 = (void *)[objc_alloc(MEMORY[0x1E4F5BDB8]) initWithValue:1];
  [v27 setState:v29];

  id v30 = objc_alloc_init(MEMORY[0x1E4F5BD70]);
  [v30 setDeviceCredentialKey:v27];
  id v60 = 0;
  uint64_t v31 = [v30 serializeWithError:&v60];
  id v49 = v60;
  if (v31)
  {
    id v26 = v31;
  ...
  else
  {
    ...
    {
      HMFGetLogIdentifier();
      v36 = uint64_t v45 = v34;
      [v14 UUID];
      id v37 = log = v35;
      [v11 shortDescription];
      v38 = uint64_t v46 = v33;
      *(_DWORD *)buf = 138544386;
      v62 = v36;
      __int16 v63 = 2112;
      v64 = v37;
      ...
      __int16 v69 = 2112;
      id v70 = v49;
      _os_log_impl(&dword_1D49D5000, log, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, unable to encode matter credential %@:%@", buf, 0x34u);
    ...
    uint64_t v39 = (void *)MEMORY[0x1E4F7A0D8];
    uint64_t v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    id v29 = [v39 futureWithError:v32];
    id v26 = v25;
  }
  ...
  {
LABEL_10:
    __int16 v40 = [(HMDHomeWalletKeyAccessoryManager *)v16 home];
    [v13 uuid];
    v42 = id v41 = v16;
    __int16 v43 = [v40 findOrAddUserIndexForUserUUID:v42 guestName:0 accessory:v11 flow:v14];
...
uint64_t __105__HMDHomeWalletKeyAccessoryManager_configureMatterAccessory_withDeviceCredentialKey_ofType_forUser_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (v4
    && (id v5 = (void *)v4,
        ...
        int v7 = [v6 isEqualToNumber:&unk_1F2DC9778],
        v6,
        v5,
        v7))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v33 = 2112;
      v34 = v14;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured accessory with device credential key %@, accessory: %@", (uint8_t *)&v27, 0x2Au);
    }
    uint64_t v15 = 1;
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v33 = 2112;
      v34 = v22;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@ with status code: %@", (uint8_t *)&v27, 0x2Au);
    }
    id v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
    uint64_t v24 = v23;
    if (v23)
    {
      id v25 = v23;
...
- (id)performHAPWriteRequestsHH2:(id)a3 home:(id)a4 flow:(id)a5
{
  ...
  else
  {
    ...
    id v16 = (void *)MEMORY[0x1E4F7A0F0];
...
id __73__HMDHomeWalletKeyAccessoryManager_performHAPWriteRequestsHH2_home_flow___block_invoke(id *a1, void *a2)
{
  ...
  if (!WeakRetained)
  {
    ...
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v91 = 2112;
      __int16 v92 = v57;
      _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key object got invalidated", buf, 0x16u);
    }
    id v58 = (void *)MEMORY[0x1E4F7A0D8];
    int64_t v59 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v60 = 23;
    goto LABEL_46;
  }
  long long v87 = 0u;
    ...
    do
    {
      for (uint64_t i = 0; i != v80; ++i)
      {
        ...
        if (v7)
        {
          ...
          {
            id v83 = 0;
            uint64_t v13 = [MEMORY[0x1E4F5BDA8] parsedFromData:v9 error:&v83];
            id v72 = v83;
            v74 = v6;
            if (v13)
            {
              ...
              if (v15 && (![v15 value] || objc_msgSend(v15, "value") == 2))
              {
                ...
                if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  __int16 v95 = 2112;
                  id v96 = v15;
                  _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured with device credential key: %@ with status code: %@", buf, 0x2Au);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  __int16 v95 = 2112;
                  id v96 = v15;
                  _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@ with status code: %@", buf, 0x2Au);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544386;
                ...
                __int16 v97 = 2112;
                id v98 = v72;
                _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure accessory with device credential key: %@, failed to parse response value %@:%@", buf, 0x34u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v95 = 2112;
              id v96 = v9;
              _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, response value: %@ is not of type NSData", buf, 0x2Au);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            __int16 v97 = 2112;
            id v98 = v5;
            _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, unable to parse write response dictionary: %@ with characteristic: %@", buf, 0x34u);
  ...
  if (v65 == [v70[5] count])
  {
    v61 = [MEMORY[0x1E4F7A0D8] futureWithNoResult];
    goto LABEL_48;
  }
  id v58 = (void *)MEMORY[0x1E4F7A0D8];
  int64_t v59 = (void *)MEMORY[0x1E4F28C58];
...
LABEL_46:
  ...
  uint64_t v62 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2008];
LABEL_47:
  __int16 v63 = (void *)v62;
  v61 = [v58 futureWithError:v62];
...
- (void)configureAccessories_HH2:(id)a3 withDeviceCredentialKey:(id)a4 ofType:(int64_t)a5 forDeviceWithUUID:(id)a6 user:(id)a7 flow:(id)a8 completion:(id)a9
{
  ...
  if (!v21)
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v95 = 2112;
      id v96 = v38;
      _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key, home is nil", buf, 0x16u);
    }
  ...
  if (![v15 count])
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
    {
      ...
      uint64_t v45 = [v81 UUID];
      *(_DWORD *)buf = 138543618;
      __int16 v94 = v44;
      __int16 v95 = 2112;
      id v96 = v45;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessories with device credential key, accessories count is 0", buf, 0x16u);
    }
    uint64_t v39 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v40 = 3;
LABEL_13:
  ...
  id v22 = objc_msgSend(v15, "na_filter:", &__block_literal_global_326_156076);
  id v78 = v15;
  id v23 = objc_msgSend(v15, "na_filter:", &__block_literal_global_328_156077);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    __int16 v103 = 2112;
    v104 = v23;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring accessories with device credential key HH2. accessories: %@, deviceCredentialKey: %@, hapAccessories: %@, matterAccessories: %@", buf, 0x3Eu);
  }
  v88[0] = MEMORY[0x1E4F143A8];
  v88[1] = 3221225472;
  v88[2] = __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_329;
  v88[3] = &unk_1E6A14640;
  v88[4] = v25;
  id v29 = v80;
  id v89 = v29;
  ...
  if (a5)
  {
    __int16 v33 = [MEMORY[0x1E4F7A0D8] futureWithNoResult];
  }
  else
  {
    v47 = [(HMDHomeWalletKeyAccessoryManager *)v25 writeRequestsWithAccessories:v22 home:v21 deviceCredentialKey:v29 user:v30 flow:v31];
    ...
    if (v49 != [v22 count])
    {
      ...
      if (os_log_type_enabled(log, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v99 = 2048;
        uint64_t v100 = v56;
        _os_log_impl(&dword_1D49D5000, log, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to create a write request for a subset of the HAP accessories (%lu of the %lu HAP accessories)", buf, 0x2Au);
      ...
      v86[1] = 3221225472;
      v86[2] = __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_331;
      v86[3] = &unk_1E6A14668;
      id v87 = v47;
      id v57 = (id)[v33 flatMap:v86];
    }
  }
  id v58 = [v32 arrayByAddingObject:v33];
  int64_t v59 = [MEMORY[0x1E4F7A0D8] combineAllFutures:v58];
  uint64_t v60 = (void *)MEMORY[0x1E4F7A0F0];
  v61 = [(HMDHomeWalletKeyAccessoryManager *)v25 workQueue];
  uint64_t v62 = [v60 schedulerWithDispatchQueue:v61];
  [v59 reschedule:v62];
  v64 = __int16 v63 = v32;
  v84[0] = MEMORY[0x1E4F143A8];
  v84[1] = 3221225472;
  v84[2] = __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_2_333;
  v84[3] = &unk_1E6A15F70;
  uint64_t v65 = v17;
  id v66 = v17;
  id v67 = v33;
...
uint64_t __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_329(uint64_t a1, uint64_t a2)
{
...
id __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_331(uint64_t a1)
{
  ...
  id v3 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2008];
  }
...
uint64_t __131__HMDHomeWalletKeyAccessoryManager_configureAccessories_HH2_withDeviceCredentialKey_ofType_forDeviceWithUUID_user_flow_completion___block_invoke_2_333(uint64_t a1)
{
...
- (void)configureAccessories_HH1:(id)a3 withDeviceCredentialKey:(id)a4 forDeviceWithUUID:(id)a5 user:(id)a6 flow:(id)a7 completion:(id)a8
{
  ...
  if (v20)
  {
    if ([v14 count])
    {
      id v21 = (void *)MEMORY[0x1D9452090]([(HMDHomeWalletKeyAccessoryManager *)self createAccessoryDeviceCredentialKeyPendingOperationWithAccessories:v14 deviceCredentialKey:v52 user:v51 deviceUUID:v50]);
      id v22 = self;
      id v23 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v68 = 2112;
        id v69 = v52;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring accessories with device credential key HH1 %@:%@", buf, 0x2Au);
      }
      ...
      if ([v26 count])
      {
        ...
        {
          id v48 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2008];
        }
        ...
        __int16 v43 = (void *)MEMORY[0x1E4F7A0F0];
        __int16 v44 = [(HMDHomeWalletKeyAccessoryManager *)v22 workQueue];
        uint64_t v45 = [v43 schedulerWithDispatchQueue:v44];
      ...
      {
        id v38 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v64 = 2112;
        uint64_t v65 = v37;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessories with device credential key, accessories count is 0", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v64 = 2112;
      uint64_t v65 = v32;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key, home is nil", buf, 0x16u);
    }
    id v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    (*((void (**)(id, void *))v16 + 2))(v16, v26);
  }
}
    ...
    if (v11)
    {
      if (v104)
      {
          ...
          do
          {
            for (uint64_t i = 0; i != v103; ++i)
            {
              ...
              if (v16)
              {
                ...
                {
                  id v106 = 0;
                  id v22 = [MEMORY[0x1E4F5BDA8] parsedFromData:v18 error:&v106];
                  id v95 = v106;
                  __int16 v101 = v15;
                  if (v22)
                  {
                    ...
                    if (v24 && (![v24 value] || objc_msgSend(v24, "value") == 2))
                    {
                      ...
                      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        __int16 v118 = 2112;
                        id v119 = v24;
                        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured with device credential key: %@ with status code: %@", buf, 0x2Au);
                    ...
                    else
                    {
                      ...
                      if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        __int16 v118 = 2112;
                        id v119 = v24;
                        _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@ with status code: %@", buf, 0x2Au);
                  ...
                  else
                  {
                    ...
                    if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
                    {
                      ...
                      *(_DWORD *)buf = 138544386;
                      ...
                      __int16 v120 = 2112;
                      id v121 = v95;
                      _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure accessory with device credential key: %@, failed to parse response value %@:%@", buf, 0x34u);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    __int16 v118 = 2112;
                    id v119 = v18;
                    _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, response value: %@ is not of type NSData", buf, 0x2Au);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138544386;
                  ...
                  __int16 v120 = 2112;
                  id v121 = v14;
                  _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key: %@, unable to parse write response dictionary: %@ with characteristic: %@", buf, 0x34u);
        ...
        else
        {
          ...
          if (v91) {
            [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2008];
          }
          else {
          id v84 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
          }
      ...
      if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v116 = 2112;
        id v117 = v5;
        _os_log_impl(&dword_1D49D5000, v77, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key, write response is nil: %@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v116 = 2112;
        id v117 = v71;
        _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Operation cancelled because device credential key was updated for deviceUUID: %@", buf, 0x20u);
      }
      uint64_t v72 = *(void *)(a1 + 80);
      id v73 = (void *)MEMORY[0x1E4F28C58];
      uint64_t v74 = 23;
...
LABEL_49:
  ...
  if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v114 = 2112;
    v115 = v64;
    _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with device credential key object got invalidated", buf, 0x16u);
  }
  ...
  if (v22)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v27;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not adding device credential key because HMDHomeWalletKeyAccessoryManagerDisableAddingDeviceKeys is set", buf, 0x16u);
...
- (void)unregisterForNotificationsWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Unregistering for notifications with reason: %@", (uint8_t *)&v17, 0x16u);
  }
...
- (void)configureAccessoryWithNfcReaderKey:(id)a3 accessory:(id)a4 flow:(id)a5 completion:(id)a6
{
  ...
  __int16 v118 = (__CFString *)a3;
  id v10 = a4;
  id v119 = a5;
  id v117 = (void (**)(id, id))a6;
  char v11 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
  dispatch_assert_queue_V2(v11);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v147 = 2112;
    v148 = v17;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] configureAccessoryWithNfcReaderKey: %@, accessory: %@", buf, 0x2Au);
  }
  uint64_t v18 = [(HMDHomeWalletKeyAccessoryManager *)v13 home];
  __int16 v19 = v18;
  if (!v18)
  {
    ...
    if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v143 = 2112;
      v144 = v61;
      _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure accessory with nfc reader key, home is nil", buf, 0x16u);
    }
    goto LABEL_14;
  }
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v147 = 2112;
    v148 = v118;
    _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring accessory with nfc reader key %@:%@", buf, 0x2Au);
  }
  uint64_t v27 = [v10 home];
  char v28 = [v27 uuid];
  ...
  if ((v30 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v63 = [v119 UUID];
      __int16 v64 = [v10 shortDescription];
      uint64_t v65 = [v10 home];
      *(_DWORD *)buf = 138544386;
      v142 = v62;
      __int16 v143 = 2112;
      v144 = v63;
      ...
      __int16 v149 = 2112;
      v150 = v19;
      _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, its home: %@ doesn't match current home: %@", buf, 0x34u);
    }
LABEL_14:
  ...
  if (v31)
  {
    if (v35)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v143 = 2112;
      v144 = v37;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring NFC reader key for Matter accessory", buf, 0x16u);
    }
    id v38 = (__CFString *)objc_alloc_init(MEMORY[0x1E4F5BE08]);
    uint64_t v39 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC0]) initWithValue:2];
    [(__CFString *)v38 setType:v39];

    uint64_t v40 = [(__CFString *)v118 privateKey];
    [(__CFString *)v38 setKey:v40];

    id v41 = [v10 nfcReaderIdentifier];
    [(__CFString *)v38 setKeyIdentifier:v41];

    uint64_t v42 = [v10 nfcReaderIdentifier];
    [(__CFString *)v38 setReaderIdentifier:v42];

    id v43 = objc_alloc_init(MEMORY[0x1E4F5BD70]);
    [v43 setReaderKey:v38];
    __int16 v44 = [v10 uuid];
    [(HMDHomeWalletKeyAccessoryManager *)v33 startHomeWalletKeyAddForAccessoryUUID:v44 keyType:0 expectedCount:1];

    id v139 = 0;
    context = [v43 serializeWithError:&v139];
    long long v109 = (__CFString *)v139;
    if (context)
    {
      uint64_t v45 = [v10 waitForDoorLockClusterObjectWithFlow:v119];
      v136[0] = MEMORY[0x1E4F143A8];
      v136[1] = 3221225472;
      v136[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke;
      v136[3] = &unk_1E6A145A0;
      id v137 = context;
      id v46 = v119;
      id v138 = v46;
      id v47 = [v45 then:v136];
      v131[0] = MEMORY[0x1E4F143A8];
      v131[1] = 3221225472;
      v131[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_2;
      v131[3] = &unk_1E6A145C8;
      v131[4] = v33;
      id v132 = v46;
      v133 = v118;
      id v134 = v10;
      ...
      v128[1] = 3221225472;
      v128[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_305;
      v128[3] = &unk_1E6A145F0;
      v128[4] = v49;
      id v129 = v132;
      id v54 = v53;
      id v43 = v52;
      ...
      id v10 = v50;
      v130 = v54;
      id v55 = (id)[v47 then:v131 orRecover:v128];

      id v56 = v137;
    }
    else
    {
      id v87 = (void *)MEMORY[0x1D9452090]();
      long long v88 = v33;
      ...
      if (os_log_type_enabled(v89, OS_LOG_TYPE_ERROR))
      {
        ...
        id v90 = [v119 UUID];
        uint64_t v91 = [v10 shortDescription];
        *(_DWORD *)buf = 138544386;
        v142 = v108;
        __int16 v143 = 2112;
        v144 = v90;
        ...
        __int16 v149 = 2112;
        v150 = v109;
        _os_log_impl(&dword_1D49D5000, v89, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, unable to encode matter credential %@:%@", buf, 0x34u);
      }
      id v56 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1002];
      v117[2](v117, v56);
    }
  }
  else
  {
    if (v35)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v143 = 2112;
      v144 = v67;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Configuring NFC reader key for HAP accessory", buf, 0x16u);
    }
    __int16 v68 = [v10 findServiceWithServiceType:@"00000266-0000-1000-8000-0026BB765291"];
    id v38 = v68;
    if (v68)
    {
      contexta = [(__CFString *)v68 findCharacteristicWithType:@"00000264-0000-1000-8000-0026BB765291"];
      if (contexta)
      {
        id v110 = objc_alloc_init(MEMORY[0x1E4F5BDD0]);
        id v69 = [(__CFString *)v118 privateKey];
        [v110 setKey:v69];

        uint64_t v70 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC0]) initWithValue:2];
        [v110 setType:v70];

        uint64_t v71 = [v10 nfcReaderIdentifier];
        [v110 setReaderIdentifier:v71];

        id v107 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC8]) initWithValue:2];
        id v106 = (void *)[objc_alloc(MEMORY[0x1E4F5BDA8]) initWithOperationType:v107 issuerKeyRequest:0 issuerKeyResponse:0 deviceCredentialKeyRequest:0 deviceCredentialKeyResponse:0 readerKeyRequest:v110 readerKeyResponse:0];
        id v127 = 0;
        id v105 = [v106 serializeWithError:&v127];
        id v104 = (__CFString *)v127;
        if (v105)
        {
          uint64_t v72 = +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:contexta value:v105 authorizationData:0 identifier:0 type:0 includeResponseValue:1];
          v140 = v72;
          id v73 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v140 count:1];
          uint64_t v74 = [(HMDHomeWalletKeyAccessoryManager *)v33 dataSource];
          uint64_t v75 = [v74 accessoryWriteMaxRetryCount];
          id v76 = [(HMDHomeWalletKeyAccessoryManager *)v33 dataSource];
          [v76 accessoryWriteRetryInterval];
          uint64_t v103 = -[__CFString performWriteRequests:withRetries:timeInterval:loggingObject:](v19, "performWriteRequests:withRetries:timeInterval:loggingObject:", v73, v75, v33);

          objc_initWeak((id *)buf, v33);
          objc_initWeak(&location, v10);
          id v77 = (void *)MEMORY[0x1E4F7A0F0];
          id v78 = [(HMDHomeWalletKeyAccessoryManager *)v33 workQueue];
          id v79 = [v77 schedulerWithDispatchQueue:v78];
          id v80 = [v103 reschedule:v79];
          v120[0] = MEMORY[0x1E4F143A8];
          v120[1] = 3221225472;
          v120[2] = __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_307;
          v120[3] = &unk_1E6A14578;
          objc_copyWeak(&v124, (id *)buf);
          objc_copyWeak(&v125, &location);
          id v121 = v119;
          uint64_t v123 = v117;
          id v122 = contexta;
          id v81 = (id)[v80 addCompletionBlock:v120];
        ...
        {
          __int16 v97 = (void *)MEMORY[0x1D9452090]();
          id v98 = v33;
          __int16 v99 = HMFGetOSLogHandle();
          if (os_log_type_enabled(v99, OS_LOG_TYPE_ERROR))
          {
            uint64_t v100 = HMFGetLogIdentifier();
            __int16 v101 = [v119 UUID];
            uint64_t v102 = [v10 shortDescription];
            *(_DWORD *)buf = 138544386;
            v142 = v100;
            __int16 v143 = 2112;
            v144 = v101;
            ...
            __int16 v149 = 2112;
            v150 = v104;
            _os_log_impl(&dword_1D49D5000, v99, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, unable to encode nfc access control %@:%@", buf, 0x34u);
          }
          uint64_t v72 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
          v117[2](v117, v72);
        }
      }
      else
      {
        long long v111 = (void *)MEMORY[0x1D9452090]();
        int64_t v92 = v33;
        ...
        if (os_log_type_enabled(v93, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          v148 = v38;
          __int16 v149 = 2112;
          v150 = @"00000264-0000-1000-8000-0026BB765291";
          _os_log_impl(&dword_1D49D5000, v93, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, NFC access service: %@ doesn't support control point characteristic: %@", buf, 0x34u);
        }
        v112 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
        v117[2](v117, v112);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v83, OS_LOG_TYPE_ERROR))
      {
        ...
        long long v85 = [v119 UUID];
        id v86 = [v10 shortDescription];
        *(_DWORD *)buf = 138544130;
        v142 = v84;
        __int16 v143 = 2112;
        v144 = v85;
        ...
        v146 = v86;
        __int16 v147 = 2112;
        v148 = @"00000266-0000-1000-8000-0026BB765291";
        _os_log_impl(&dword_1D49D5000, v83, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, it doesn't support nfc access service %@", buf, 0x2Au);
      }
      contextc = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
      v117[2](v117, contextc);
    }
  }
LABEL_39:
}
...
uint64_t __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_2(uint64_t a1, void *a2)
{
        ...
        v7))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v14;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured accessory with NFC reader key: %@, accessory: %@", (uint8_t *)&v26, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v23;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@ with status code: %@", (uint8_t *)&v26, 0x2Au);
    }
...
uint64_t __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_305(uint64_t a1, void *a2)
{
  uint64_t v21 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  uint64_t v4 = [v3 domain];
  id v5 = v4;
  if (v4 != (void *)*MEMORY[0x1E4F6A0A8])
  {
...
LABEL_7:
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v3;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to configure NFC reader key with error: %@", (uint8_t *)&v15, 0x20u);
    }
    goto LABEL_9;
  }
  int v7 = (void *)MEMORY[0x1D9452090]();
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v11;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Ignoring duplicate error while adding Reader key", (uint8_t *)&v15, 0x16u);
  }
LABEL_9:
...
void __97__HMDHomeWalletKeyAccessoryManager_configureAccessoryWithNfcReaderKey_accessory_flow_completion___block_invoke_307(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      id v83 = 0;
      char v11 = objc_msgSend(v5, "hmd_valueOfCharacteristic:error:", v10, &v83);
      id v12 = v83;
      id v81 = v11;
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          __int16 v92 = 2112;
          id v93 = v53;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, unable to parse write response dictionary: %@ with characteristic: %@", buf, 0x34u);
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v90 = 2112;
          id v91 = v59;
          _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, response value: %@ is not of type NSData", buf, 0x2Au);
        ...
        __int16 v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
      ...
      id v82 = 0;
      __int16 v17 = [MEMORY[0x1E4F5BDA8] parsedFromData:v13 error:&v82];
      id v18 = v82;
      __int16 v19 = v18;
      id v73 = v17;
      if (v17)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v90 = 2112;
          id v91 = v21;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@ with status code: %@", buf, 0x2Au);
        ...
        id v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          __int16 v92 = 2112;
          id v93 = v71;
          _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, failed to parse response value %@:%@", buf, 0x34u);
        ...
        uint64_t v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
LABEL_32:
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v90 = 2112;
      id v91 = v37;
      _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, write response is nil: %@", buf, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v88 = 2112;
      id v89 = v34;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure with reader key: %@, object got invalidated", buf, 0x20u);
    }
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v94 = 2112;
      id v95 = v77;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Removing nfc reader key with identifier from accessory %@:%@", buf, 0x2Au);
    }
    int v22 = [v10 home];
    id v23 = [v22 uuid];
    ...
    if (v25)
    {
      ...
      if (v26)
      {
        ...
        if (context)
        {
          id v71 = objc_alloc_init(MEMORY[0x1E4F5BDD0]);
          [v71 setIdentifier:v77];
          id v70 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC8]) initWithValue:3];
          id v69 = (void *)[objc_alloc(MEMORY[0x1E4F5BDA8]) initWithOperationType:v70 issuerKeyRequest:0 issuerKeyResponse:0 deviceCredentialKeyRequest:0 deviceCredentialKeyResponse:0 readerKeyRequest:v71 readerKeyResponse:0];
          id v86 = 0;
          ...
          if (v68)
          {
            ...
            id v87 = v67;
            uint64_t v28 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v87 count:1];
            id v29 = [(HMDHomeWalletKeyAccessoryManager *)v17 dataSource];
            uint64_t v30 = [v29 accessoryWriteMaxRetryCount];
            int v31 = [(HMDHomeWalletKeyAccessoryManager *)v17 dataSource];
            ...
            objc_initWeak(&location, v10);
            __int16 v32 = (void *)MEMORY[0x1E4F7A0F0];
            uint64_t v33 = [(HMDHomeWalletKeyAccessoryManager *)v17 workQueue];
          ...
          else
          {
            ...
            if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              __int16 v96 = 2112;
              __int16 v97 = v66;
              _os_log_impl(&dword_1D49D5000, v61, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, unable to encode nfc access control %@:%@", buf, 0x34u);
            }
            id v67 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, NFC access service: %@ doesn't support control point characteristic: %@", buf, 0x34u);
          }
          id v73 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
        {
          ...
          id v52 = [v78 UUID];
          uint64_t v53 = [v10 shortDescription];
          *(_DWORD *)buf = 138544130;
          id v89 = v51;
          __int16 v90 = 2112;
          id v91 = v52;
          ...
          _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, it doesn't support nfc access service %@", buf, 0x2Au);
        }
        contextb = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v96 = 2112;
        __int16 v97 = v14;
        _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, its home: %@ doesn't match current home: %@", buf, 0x34u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v90 = 2112;
      id v91 = v41;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from accessory, home is nil", buf, 0x16u);
    }
    uint64_t v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    (*((void (**)(id, __CFString *))v11 + 2))(v11, v27);
  }
      ...
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          __int16 v92 = 2112;
          id v93 = v53;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, unable to parse write response dictionary: %@ with characteristic: %@", buf, 0x34u);
      ...
      if (!v14)
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v90 = 2112;
          id v91 = v59;
          _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, response value: %@ is not of type NSData", buf, 0x2Au);
      ...
      if (v17)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v90 = 2112;
          id v91 = v21;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@ with status code: %@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          __int16 v92 = 2112;
          id v93 = v71;
          _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, failed to parse response value %@:%@", buf, 0x34u);
...
LABEL_32:
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v90 = 2112;
      id v91 = v37;
      _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, write response is nil: %@", buf, 0x2Au);
    }
    uint64_t v44 = *(void *)(a1 + 48);
    id v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    (*(void (**)(uint64_t, id))(v44 + 16))(v44, v12);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v88 = 2112;
      id v89 = v34;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to remove reader key from: %@, object got invalidated", buf, 0x20u);
    }
    uint64_t v35 = *(void *)(a1 + 48);
    id v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    (*(void (**)(uint64_t, id))(v35 + 16))(v35, v12);
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v95 = 2112;
      __int16 v96 = v77;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching accessory is configured with nfc reader key %@:%@", buf, 0x2Au);
    }
    int v22 = [v10 home];
    id v23 = [v22 uuid];
    uint64_t v24 = [(__CFString *)v14 uuid];
    ...
    if (v25)
    {
      ...
      if (v26)
      {
        ...
        {
          id v71 = objc_alloc_init(MEMORY[0x1E4F5BDD0]);
          id v70 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC8]) initWithValue:1];
          id v69 = (void *)[objc_alloc(MEMORY[0x1E4F5BDA8]) initWithOperationType:v70 issuerKeyRequest:0 issuerKeyResponse:0 deviceCredentialKeyRequest:0 deviceCredentialKeyResponse:0 readerKeyRequest:v71 readerKeyResponse:0];
          id v87 = 0;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              __int16 v97 = 2112;
              uint64_t v98 = v66;
              _os_log_impl(&dword_1D49D5000, v61, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, unable to encode nfc access control %@:%@", buf, 0x34u);
            }
            id v67 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, NFC access service: %@ doesn't support control point characteristic: %@", buf, 0x34u);
          }
          id v73 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, it doesn't support nfc access service %@", buf, 0x2Au);
        }
        contextb = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v97 = 2112;
        uint64_t v98 = v14;
        _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, its home: %@ doesn't match current home: %@", buf, 0x34u);
      }
      uint64_t v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v91 = 2112;
      __int16 v92 = v41;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch accessory is configured for wallet key, home is nil", buf, 0x16u);
    }
    uint64_t v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    (*((void (**)(id, void, void, __CFString *))v11 + 2))(v11, 0, 0, v27);
  }
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      if (v11)
      {
        ...
        {
          id v68 = 0;
          id v16 = [MEMORY[0x1E4F5BDA8] parsedFromData:v13 error:&v68];
          id v17 = v68;
          if (v16)
          {
            id v61 = v11;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              __int16 v78 = 2112;
              id v79 = v17;
              _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, failed to parse response value %@:%@", buf, 0x34u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v76 = 2112;
            id v77 = v13;
            _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, response value: %@ is not of type NSData", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          [*(id *)(a1 + 32) UUID];
          id v41 = v62 = v37;
          uint64_t v42 = [v9 shortDescription];
          id v43 = *(void **)(a1 + 40);
          *(_DWORD *)buf = 138544386;
          id v71 = v40;
          __int16 v72 = 2112;
          ...
          __int16 v78 = 2112;
          id v79 = v43;
          _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, unable to parse write response dictionary: %@ with characteristic: %@", buf, 0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v76 = 2112;
        id v77 = v29;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key: %@, write response is nil: %@", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v74 = 2112;
      id v75 = v26;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch is configured with reader key for: %@, object got invalidated", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      id v31 = v6;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring NFC Reader key on non-matter accessory: %@", buf, 0x20u);
    }
    id v20 = (void *)MEMORY[0x1E4F7A0D8];
    id v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:93];
...
void __80__HMDHomeWalletKeyAccessoryManager_configureNFCReaderKeyOnMatterAccessory_flow___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v6;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch or nfc reader key for matter accessory: %@", (uint8_t *)&v17, 0x20u);
    }
...
- (void)fetchOrConfigureNFCReaderKeyForAccessory:(id)a3 flow:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    id v32 = v8;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] fetchOrConfigureNFCReaderKeyForAccessory: %@", buf, 0x20u);
  }
  ...
  id v21 = v10;
  id v22 = v9;
  [v19 fetchOrCreateReaderKeyWithRequiresPrivateKey:1 flow:v22 completion:v23];
}
...
void __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      v17[1] = 3221225472;
      v17[2] = __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke_293;
      v17[3] = &unk_1E6A144D8;
      v17[4] = v11;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&location[4] = v15;
      ...
      __int16 v25 = 2112;
      id v26 = v6;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to fetch or nfc reader key: %@", location, 0x20u);
    }
    (*((void (**)(void))a1[7] + 2))();
  }
}

void __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke_293(id *a1, int a2, void *a3, void *a4)
{
  ...
  if (WeakRetained)
  {
    if (a2)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v42 = 2112;
        id v43 = v19;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Accessory is already configured with nfc reader key %@:%@", buf, 0x2Au);
    ...
    else
    {
      if (v7)
      {
        ...
        v31[1] = 3221225472;
        v31[2] = __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke_294;
        v31[3] = &unk_1E6A16978;
        v31[4] = v28;
        id v35 = a1[7];
        id v32 = a1[6];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v38 = 2112;
      id v39 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure accessory with reader key, accessory object became nil", buf, 0x16u);
    }
    id v26 = (void (**)(id, void *))a1[7];
    uint64_t v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    v26[2](v26, v27);
  }
LABEL_12:
}

void __93__HMDHomeWalletKeyAccessoryManager_fetchOrConfigureNFCReaderKeyForAccessory_flow_completion___block_invoke_294(uint64_t a1, void *a2)
{
  id v4 = a2;
...
void __75__HMDHomeWalletKeyAccessoryManager_configureNFCReaderKeyForAccessory_flow___block_invoke(id *a1, void *a2)
{
  ...
  id v5 = (void *)MEMORY[0x1D9452090]([a1[5] setReaderKeyConfigureInProgress:0]);
  id v6 = a1[4];
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v3;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure accessory with nfc reader key %@:%@", (uint8_t *)&v21, 0x2Au);
    }
    if ([a1[5] shouldRetryReaderKeyConfigureOnFailure])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v25 = 2112;
        id v26 = v17;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Retrying configuring accessory with nfc reader key: %@", (uint8_t *)&v21, 0x20u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v20;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured accessory with nfc reader key: %@", (uint8_t *)&v21, 0x20u);
    }
...
- (void)requestPrimaryResident:(id)a3 toConfigureAccessories:(id)a4 withDeviceCredentialKey:(id)a5 ofType:(int64_t)a6 flow:(id)a7 completion:(id)a8
{
  ...
  id v44 = a5;
  id v16 = a7;
  int v17 = (void (**)(id, void *))a8;
  id v18 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
  dispatch_assert_queue_V2(v18);

  id v19 = objc_msgSend(v15, "na_map:", &__block_literal_global_288);
  if (objc_msgSend(v19, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      uint64_t v50 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Did not send message to configure all accessories with device credential key, accessory uuids is empty", buf, 0x16u);
    }
  ...
  else
  {
    ...
    v56[1] = v28;
    v56[2] = v19;
    uint64_t v29 = *MEMORY[0x1E4F64F08];
    v55[2] = @"HMDHomeConfigureAccessoriesWithDeviceCredentialKeyMessageKeyAccessoryUUIDs";
    v55[3] = v29;
    id v30 = HMFEncodedRootObject();
    v56[3] = v30;
    __int16 v31 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v56 forKeys:v55 count:4];
    ...
    v45[1] = 3221225472;
    v45[2] = __129__HMDHomeWalletKeyAccessoryManager_requestPrimaryResident_toConfigureAccessories_withDeviceCredentialKey_ofType_flow_completion___block_invoke_291;
    v45[3] = &unk_1E6A16B58;
    v45[4] = self;
    id v46 = v17;
    id v33 = (void *)MEMORY[0x1D9452090]([(HMDRemoteMessage *)v32 setResponseHandler:v45]);
    id v34 = self;
    id v35 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v53 = 2112;
      id v54 = v43;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Sending message to configure device credential key: %@ to primary resident: %@", buf, 0x2Au);
...
void __129__HMDHomeWalletKeyAccessoryManager_requestPrimaryResident_toConfigureAccessories_withDeviceCredentialKey_ofType_flow_completion___block_invoke_291(uint64_t a1, void *a2, void *a3)
{
  id v5 = a2;
  id v6 = a3;
  id v7 = [*(id *)(a1 + 32) workQueue];
...
void __129__HMDHomeWalletKeyAccessoryManager_requestPrimaryResident_toConfigureAccessories_withDeviceCredentialKey_ofType_flow_completion___block_invoke_2(uint64_t a1)
{
  ...
  else
  {
    ...
    [v5 setObject:*(void *)(a1 + 40) forKeyedSubscript:*MEMORY[0x1E4F28A50]];
    uint64_t v3 = *(void *)(a1 + 48);
    id v4 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 userInfo:v5];
...
LABEL_17:
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, v22, buf, 0x2Au);
  ...
  if (v24)
  {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v47 = 2112;
            id v48 = v41;
            _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to configure all accessories with device credential key, current device is nil", buf, 0x16u);

            id v37 = v44;
            id v38 = v43;
          }

          id v42 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
          v15[2](v15, v42);
        }
      }
    }
    else
    {
      ...
      if (v29)
      {
        ...
        __int16 v31 = [v30 operationByMergingWithOperation:v28];
  ...
  {
    id v32 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    v15[2](v15, v32);
...
- (NSArray)matterAccessoriesSupportingWalletKey
{
  ...
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_282);
...
void __68__HMDHomeWalletKeyAccessoryManager_handleHomeUserAddedNotification___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) isPrimaryResidentOrSoleOwnerController])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v5;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling added user: %@", (uint8_t *)&v10, 0x16u);
    }
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      int v21 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Not handling wallet key support change for accessory in other home: %@", buf, 0x16u);
    }
  }
}
...
void __68__HMDHomeWalletKeyAccessoryManager_handleWalletKeySupportDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Configuring NFC Reader Key because wallet key support did change on accessory: %@", (uint8_t *)&v9, 0x20u);
  }
  [*(id *)(a1 + 32) configureNFCReaderKeyForAccessory:*(void *)(a1 + 40) flow:v2];
}
    ...
    if (v10)
    {
      ...
      if ([v13 hasAnyAccessoryWithWalletKeySupport])
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          char v25 = v17;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Not handling accessory removed notification, home still has an accessory that supports wallet key", buf, 0xCu);
        }
      }
      else
      {
        id v18 = [v4 userInfo];
        id v19 = objc_msgSend(v18, "hmf_numberForKey:", @"HMDNotificationSourceKey");
        uint64_t v20 = [v19 unsignedIntegerValue];

        if (v20 == 1)
        {
          int v21 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
          v22[0] = MEMORY[0x1E4F143A8];
          v22[1] = 3221225472;
...
void __75__HMDHomeWalletKeyAccessoryManager_handleHomeAccessoryRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    __int16 v11 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Last accessory supporting wallet key was removed.", (uint8_t *)&v8, 0x16u);
  }
...
void __73__HMDHomeWalletKeyAccessoryManager_handleHomeAddedAccessoryNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Configuring NFC Reader Key because new accessory was added: %@", (uint8_t *)&v9, 0x20u);
  }
  [*(id *)(a1 + 32) configureNFCReaderKeyForAccessory:*(void *)(a1 + 40) flow:v2];
  ...
  if (v3 != [*(id *)(a1 + 32) isCurrentDevicePrimaryResident])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      __int16 v31 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Current device primary changed from: (%@->%@)", buf, 0x20u);
    }
    [*(id *)(a1 + 32) setCurrentDevicePrimaryResident:v3];
    id v10 = *(void **)(a1 + 32);
    __int16 v11 = [*(id *)(a1 + 40) name];
    [v10 configureNotificationsWithReason:v11];
  }
  uint64_t v12 = [*(id *)(a1 + 32) pendingPrimaryResidentDeviceCredentialKeyOperation];
  if (v12)
  {
    __int16 v13 = [v2 accessoriesWithWalletKeySupport];
    v24[0] = MEMORY[0x1E4F143A8];
    v24[1] = 3221225472;
    v24[2] = __76__HMDHomeWalletKeyAccessoryManager_handlePrimaryResidentUpdateNotification___block_invoke_268;
    v24[3] = &unk_1E6A14470;
    id v14 = v12;
    id v25 = v14;
    uint64_t v15 = objc_msgSend(v13, "na_filter:", v24);

    id v16 = [*(id *)(a1 + 32) primaryResidentDevice];
    id v17 = [v2 currentUser];
    if (([v17 isOwner] & 1) == 0 && objc_msgSend(v15, "count") && v16)
    {
      ...
      {
        id v19 = *(void **)(a1 + 32);
        uint64_t v20 = [v14 deviceCredentialKey];
        int v21 = [MEMORY[0x1E4F65430] untrackedPlaceholderFlow];
        v22[0] = MEMORY[0x1E4F143A8];
        v22[1] = 3221225472;
...
uint64_t __76__HMDHomeWalletKeyAccessoryManager_handlePrimaryResidentUpdateNotification___block_invoke_268(uint64_t a1, void *a2)
{
  id v2 = *(void **)(a1 + 32);
  id v3 = a2;
  id v4 = [v2 accessoriesUUIDs];
...
- (void)handleAccessoryCharacteristicsChangedNotification:(id)a3
{
  ...
  if ([v7 supportsWalletKey])
  {
    ...
    id v10 = objc_msgSend(v9, "na_firstObjectPassingTest:", &__block_literal_global_264);
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v30 = 2112;
        __int16 v31 = v10;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling value update of hardware finish characteristic: %@", buf, 0x16u);
      }
      int v15 = [v10 value];
      objc_opt_class();
      if (objc_opt_isKindOfClass()) {
      ...
      if (v17)
      {
        uint64_t v18 = [MEMORY[0x1E4F65430] untrackedPlaceholderFlow];
        ...
        if (v19)
        {
          ...
          v26[0] = MEMORY[0x1E4F143A8];
          v26[1] = 3221225472;
          v26[2] = __86__HMDHomeWalletKeyAccessoryManager_handleAccessoryCharacteristicsChangedNotification___block_invoke_267;
          v26[3] = &unk_1E6A197C8;
          v26[4] = v12;
          id v27 = v19;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v32 = 2112;
          uint64_t v33 = v25;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Hardware finish characteristic value: %@ is not of type data: %@", buf, 0x20u);
        }
      }
    }
  }
...
void __86__HMDHomeWalletKeyAccessoryManager_handleAccessoryCharacteristicsChangedNotification___block_invoke_267(uint64_t a1)
{
...
- (id)_addIssuerKeyForUser:(id)a3 toMatterAccessory:(id)a4 flow:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  __int16 v11 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
  dispatch_assert_queue_V2(v11);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v35 = 2112;
    id v36 = v9;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addIssuerKeyForUser: %@, toAccessory: %@", buf, 0x2Au);
  }
  id v17 = [(HMDHomeWalletKeyAccessoryManager *)v13 home];
  uint64_t v18 = [v8 uuid];
  __int16 v19 = [v17 findOrAddUserIndexForUserUUID:v18 guestName:0 accessory:v9 flow:v10];
...
id __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke(id *a1, void *a2)
{
  ...
  if (v4)
  {
    id v5 = [a1[7] waitForDoorLockClusterObjectWithFlow:a1[6]];
    v33[0] = MEMORY[0x1E4F143A8];
    v33[1] = 3221225472;
    v33[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_253;
    v33[3] = &unk_1E6A14380;
    id v34 = v4;
    id v35 = v3;
    char v37 = 1;
    id v36 = a1[6];
    uint64_t v6 = [v5 then:v33];
    uint64_t v7 = [v6 naFuture];
    v30[0] = MEMORY[0x1E4F143A8];
    v30[1] = 3221225472;
    v30[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_2;
    v30[3] = &unk_1E6A143A8;
    v30[4] = a1[4];
    id v31 = a1[7];
    id v32 = a1[6];
    id v8 = [v7 recover:v30];
    v26[0] = MEMORY[0x1E4F143A8];
    v26[1] = 3221225472;
    v26[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_255;
    v26[3] = &unk_1E6A143D0;
    v26[4] = a1[4];
    id v27 = a1[6];
    id v28 = a1[5];
    id v29 = a1[7];
    id v9 = [v8 addFailureBlock:v26];
    v22[0] = MEMORY[0x1E4F143A8];
    v22[1] = 3221225472;
    v22[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_256;
    v22[3] = &unk_1E6A143F8;
    v22[4] = a1[4];
    id v23 = a1[7];
    id v24 = a1[6];
    id v25 = a1[5];
    id v10 = [v9 addSuccessBlock:v22];
    v20[0] = MEMORY[0x1E4F143A8];
    v20[1] = 3221225472;
    v20[2] = __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_257;
    v20[3] = &unk_1E6A14420;
    id v21 = a1[7];
    __int16 v11 = [v10 flatMap:v20];
  }
  else
  {
    os_log_type_t v12 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v42 = 2112;
      id v43 = v17;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not adding issuer key because we don't have one for user: %@", buf, 0x20u);
    }
    uint64_t v18 = (void *)MEMORY[0x1E4F7A0D8];
    id v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
    __int16 v11 = [v18 futureWithError:v5];
  }

  return v11;
}

uint64_t __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_253(uint64_t a1, void *a2)
{
  id v3 = a2;
...
LABEL_7:
    uint64_t v14 = [MEMORY[0x1E4F7A0D8] futureWithError:v3];
    goto LABEL_8;
  }
  uint64_t v6 = [v3 code];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v13;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Ignoring duplicate error while adding Issuer key", (uint8_t *)&v17, 0x16u);
  }
...
void __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_255(uint64_t a1, void *a2)
{
  uint64_t v21 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  id v4 = (void *)MEMORY[0x1D9452090]();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to add issuer key for user: %@, to accessory: %@, with error: %@", (uint8_t *)&v11, 0x34u);
  }
}

void __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_256(id *a1, void *a2)
{
  uint64_t v21 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  id v4 = a1[4];
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v12;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully configured issuer key for user: %@ on accessory: %@", (uint8_t *)&v13, 0x2Au);
  }
}

id __80__HMDHomeWalletKeyAccessoryManager__addIssuerKeyForUser_toMatterAccessory_flow___block_invoke_257(uint64_t a1)
{
...
- (id)addIssuerKeyForUser:(id)a3 toMatterAccessory:(id)a4 flow:(id)a5
{
  ...
  os_log_type_t v12 = [(HMDHomeWalletKeyAccessoryManager *)self workQueue];
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
- (id)addIssuerKeysToMatterTTUAccessoriesForUser:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v30 = 2112;
    id v31 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addIssuerKeysToMatterTTUAccessoriesForUser: %@", buf, 0x20u);
  }
  ...
  __int16 v19 = [MEMORY[0x1E4F7A0F0] globalAsyncScheduler];
  id v20 = [v18 combineAllFutures:v17 ignoringErrors:1 scheduler:v19];
  id v21 = [v20 flatMap:&__block_literal_global_248];
...
{
  id v2 = a2;
  if (objc_msgSend(v2, "na_any:", &__block_literal_global_250_156226))
  {
    id v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_252_156227);
    id v4 = [MEMORY[0x1E4F7A0D8] futureWithResult:v3];
  }
  else
  {
    id v4 = [MEMORY[0x1E4F7A0D8] futureWithResult:MEMORY[0x1E4F1CBF0]];
  }
...
- (id)addIssuerKeysToMatterAccessory:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v34 = 2112;
    id v35 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addIssuerKeysToMatterAccessory: %@", buf, 0x20u);
  }
  ...
  __int16 v19 = (void *)MEMORY[0x1E4F7A0D8];
  id v20 = [MEMORY[0x1E4F7A0F0] globalAsyncScheduler];
...
id __72__HMDHomeWalletKeyAccessoryManager_addIssuerKeysToMatterAccessory_flow___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  int v3 = objc_msgSend(a2, "na_any:", &__block_literal_global_246_156232);
...
- (id)addIssuerKeysToMatterAccessories:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addIssuerKeysToMatterAccessories: %@", buf, 0x20u);
  }
...
- (void)addIssuerKeysToMatterAccessoriesWithFlow:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] addIssuerKeysToMatterAccessories", (uint8_t *)&v20, 0x16u);
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v17;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] No Matter accessories supporting wallet key, so nothing to add Issuer key to.", (uint8_t *)&v20, 0x16u);
    }
  }
  else
  {
...
- (void)_handleAddIssuerKeysToAccessoriesMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] _handleAddIssuerKeysToAccessoriesMessage: %@", buf, 0x20u);
  }
...
void __77__HMDHomeWalletKeyAccessoryManager__handleAddIssuerKeysToAccessoriesMessage___block_invoke(id *a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      __int16 v21 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] No Matter accessories supporting wallet key, so nothing to add Issuer key to.", buf, 0x16u);
    }
  ...
  v16[0] = MEMORY[0x1E4F143A8];
  v16[1] = 3221225472;
  v16[2] = __77__HMDHomeWalletKeyAccessoryManager__handleAddIssuerKeysToAccessoriesMessage___block_invoke_243;
  v16[3] = &unk_1E6A13FD8;
  id v17 = a1[6];
...
uint64_t __77__HMDHomeWalletKeyAccessoryManager__handleAddIssuerKeysToAccessoriesMessage___block_invoke_243(uint64_t a1)
{
...
- (void)handleConfigureAccessoriesWithDeviceCredentialKeyMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling message to configure device credential key %@ with payload: %@", buf, 0x2Au);
  }
  ...
  if (v14)
  {
    ...
    if (v17)
    {
      ...
      if (v18)
      {
        ...
        if (v19)
        {
          ...
          if (v20)
          {
            __int16 v21 = [MEMORY[0x1E4F1CA80] set];
            ...
            id v22 = v21;
            id v69 = v22;
            id v57 = objc_msgSend(v20, "na_map:", v67);
            if ([v22 count])
            {
            ...
            uint64_t v55 = [v19 integerValue];
            id v25 = [v17 device];
            id v26 = [v25 identifier];
            v64[0] = MEMORY[0x1E4F143A8];
            v64[1] = 3221225472;
            v64[2] = __93__HMDHomeWalletKeyAccessoryManager_handleConfigureAccessoriesWithDeviceCredentialKeyMessage___block_invoke_242;
            v64[3] = &unk_1E6A18BA0;
            v64[4] = v8;
            id v65 = v56;
            id v66 = v4;
            [(HMDHomeWalletKeyAccessoryManager *)v8 configureAccessories:v57 withDeviceCredentialKey:v18 ofType:v55 forDeviceWithUUID:v26 user:v14 flow:v65 completion:v64];
          }
          else
          {
            ...
            if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              id v54 = (void *)v53;
              __int16 v74 = 2112;
              id v75 = @"HMDHomeConfigureAccessoriesWithDeviceCredentialKeyMessageKeyAccessoryUUIDs";
              _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to handle configure device credential key message, mising parameter: %@", buf, 0x20u);

              id v50 = v60;
            }

            id v22 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v74 = 2112;
            id v75 = @"HMDHomeConfigureAccessoriesWithDeviceCredentialKeyMessageKeyTapToUnlockType";
            _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to handle configure device credential key message, missing parameter: %@", buf, 0x20u);

            id v45 = v59;
          }

          __int16 v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v63 = v39;
          id v43 = v42 = v6;
          uint64_t v44 = [v42 UUID];
          *(_DWORD *)buf = 138543874;
          id v71 = v43;
          __int16 v72 = 2112;
          uint64_t v73 = (uint64_t)v44;
          __int16 v74 = 2112;
          id v75 = @"HMDHomeConfigureAccessoriesWithDeviceCredentialKeyMessageKeyCredentialKey";
          _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to handle configure device credential key message, missing parameter: %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        uint64_t v36 = [v6 UUID];
        [(__CFString *)v4 destination];
        uint64_t v62 = v6;
        char v37 = (__CFString *)objc_claimAutoreleasedReturnValue();
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v76 = 2112;
        uint64_t v77 = v38;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Message destination is not of expected type %@:%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to handle configure device credential key message, user not found", buf, 0x16u);
    }
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v31 = 2112;
        id v32 = v6;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessory with device credential key, accessory with uuid: %@ not found", (uint8_t *)&v27, 0x20u);
      }
      [a1[6] addObject:v6];
    }
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessory with device credential key, failed to convert accessory uuid: %@ to: %@", (uint8_t *)&v27, 0x2Au);
      }
    }
    id v10 = 0;
LABEL_20:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v33 = 2112;
    uint64_t v34 = objc_opt_class();
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Not configuring accessory with device credential key, unknown type for uuid: %@ expected: %@", (uint8_t *)&v27, 0x2Au);
  }
  id v10 = 0;
LABEL_21:
...
void __93__HMDHomeWalletKeyAccessoryManager_handleConfigureAccessoriesWithDeviceCredentialKeyMessage___block_invoke_242(id *a1, void *a2)
{
  uint64_t v27 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  id v4 = [a1[4] workQueue];
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v25 = 2112;
      id v26 = v3;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to handle configure device credential key message %@:%@", buf, 0x2Au);
    }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v14;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Successfully handled configure device credential key message: %@", buf, 0x20u);
    }
    id v15 = a1[6];
...
- (id)missingWalletKeysForAccessoryUUID:(id)a3 usersByUniqueID:(id)a4 accessoryUsersByUniqueID:(id)a5 flow:(id)a6
{
  ...
  id v13 = a6;
  id v14 = [v10 uuid];
  id v15 = [v12 allValues];
  id v16 = objc_msgSend(v15, "na_firstObjectPassingTest:", &__block_literal_global_227);

  id v17 = [v16 credentials];
  uint64_t v18 = objc_msgSend(v17, "na_firstObjectPassingTest:", &__block_literal_global_230_156253);
  ...
  if (v18)
  {
    ...
    v33[0] = MEMORY[0x1E4F143A8];
    v33[1] = 3221225472;
    v33[2] = __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_2_233;
    v33[3] = &unk_1E6A142B8;
    id v34 = v12;
    uint64_t v35 = self;
    id v36 = v13;
    ...
    id v38 = v11;
    id v20 = v14;
    __int16 v21 = objc_msgSend(v16, "na_map:", v33);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v45 = 2112;
      id v46 = v14;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Reader key is missing on accessory: %@", buf, 0x20u);

      id v24 = v32;
    }

    __int16 v29 = (void *)MEMORY[0x1E4F1CAD0];
    id v20 = [v11 allValues];
    v39[0] = MEMORY[0x1E4F143A8];
    v39[1] = 3221225472;
    v39[2] = __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_231;
    v39[3] = &unk_1E6A14270;
    id v40 = v14;
    id v23 = v14;
    id v30 = objc_msgSend(v20, "na_map:", v39);
    id v22 = [v29 setWithArray:v30];
  }
  return v22;
}

id __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_231(uint64_t a1, void *a2)
{
  id v3 = (objc_class *)MEMORY[0x1E4F2E940];
  id v4 = a2;
  id v5 = [v3 alloc];
...
id __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_2_233(uint64_t a1, void *a2)
{
  uint64_t v42 = *MEMORY[0x1E4F143B8];
  id v3 = a2;
  ...
  if (v5)
  {
    ...
    id v7 = [v6 credentials];
    id v8 = objc_msgSend(v7, "na_map:", &__block_literal_global_237);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v25 = [*(id *)(a1 + 64) objectForKeyedSubscript:v3];
        [v25 uuid];
        v26 = __int16 v33 = v20;
        *(_DWORD *)buf = 138544130;
        uint64_t v35 = v23;
        ...
        __int16 v40 = 2112;
        id v41 = v26;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] User does not have at least 1 RFID credentials on accessory: %@, user: %@", buf, 0x2Au);

        id v20 = v33;
      }

      id v27 = objc_alloc(MEMORY[0x1E4F2E940]);
      uint64_t v28 = *(void *)(a1 + 56);
      __int16 v29 = [*(id *)(a1 + 64) objectForKeyedSubscript:v3];
      id v30 = [v29 uuid];
      id v9 = (void *)[v27 initWithAccessoryUUID:v28 userUUID:v30];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      uint64_t v15 = *(void *)(a1 + 56);
      id v16 = [*(id *)(a1 + 64) objectForKeyedSubscript:v3];
      id v17 = [v16 uuid];
      *(_DWORD *)buf = 138544130;
      uint64_t v35 = v13;
      __int16 v36 = 2112;
      ...
      __int16 v40 = 2112;
      id v41 = v17;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Matter user is missing on accessory: %@, user: %@", buf, 0x2Au);
    }
    id v18 = objc_alloc(MEMORY[0x1E4F2E940]);
    uint64_t v19 = *(void *)(a1 + 56);
    uint64_t v6 = [*(id *)(a1 + 64) objectForKeyedSubscript:v3];
    id v8 = [v6 uuid];
    id v9 = (void *)[v18 initWithAccessoryUUID:v19 userUUID:v8];
  }

  return v9;
}

id __116__HMDHomeWalletKeyAccessoryManager_missingWalletKeysForAccessoryUUID_usersByUniqueID_accessoryUsersByUniqueID_flow___block_invoke_234(uint64_t a1, void *a2)
{
  id v2 = a2;
  id v3 = [v2 credentialType];
  int v4 = [v3 isEqualToNumber:*MEMORY[0x1E4F69F90]];
...
- (id)fetchMissingWalletKeysForAccessory:(id)a3 users:(id)a4 flow:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v44 = 2112;
    id v45 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching missing wallet keys from accessory: %@, users: %@", buf, 0x2Au);
  }
  if (v8)
  {
    id v16 = objc_msgSend(v9, "na_dictionaryWithKeyGenerator:", &__block_literal_global_220_156265);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      id v41 = v28;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Returning empty set for nil accessory", buf, 0x16u);
    }
    __int16 v29 = (void *)MEMORY[0x1E4F7A0D8];
    id v17 = [MEMORY[0x1E4F1CAD0] set];
    id v23 = [v29 futureWithResult:v17];
  }
...
id __82__HMDHomeWalletKeyAccessoryManager_fetchMissingWalletKeysForAccessory_users_flow___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  id v4 = a2;
  id v5 = [v3 allKeys];
  uint64_t v6 = [v5 arrayByAddingObject:*MEMORY[0x1E4F6A0B0]];

  id v7 = [v4 getUsersWithUniqueIDs:v6 flow:*(void *)(a1 + 40)];
...
{
  uint64_t v3 = objc_msgSend(a2, "na_dictionaryWithKeyGenerator:", &__block_literal_global_224_156267);
...
- (id)fetchMissingWalletKeysForUserUUID:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v48 = 2112;
    id v49 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching missing wallet keys for user UUID: %@", buf, 0x20u);
  }
  id v13 = [(HMDHomeWalletKeyAccessoryManager *)v9 home];
  id v14 = [v13 userWithUUID:v6];
  uint64_t v15 = [v13 accessoriesWithWalletKeySupport];
  id v16 = objc_msgSend(v15, "na_filter:", &__block_literal_global_207);
  ...
  if (objc_msgSend(v16, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      uint64_t v47 = v22;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Did not find any Matter accessories supporting TTU", buf, 0x16u);
    ...
    __int16 v25 = [v23 futureWithResult:v24];
  }
  else
  {
    v41[0] = MEMORY[0x1E4F143A8];
    v41[1] = 3221225472;
    void v41[2] = __75__HMDHomeWalletKeyAccessoryManager_fetchMissingWalletKeysForUserUUID_flow___block_invoke_208;
    v41[3] = &unk_1E6A14158;
    v41[4] = v9;
    id v42 = v14;
    id v37 = v13;
    ...
    id v27 = v7;
    id v43 = v27;
    uint64_t v28 = objc_msgSend(v16, "na_map:", v41);
    __int16 v29 = (void *)MEMORY[0x1E4F7A0D8];
    id v30 = [MEMORY[0x1E4F7A0F0] immediateScheduler];
    __int16 v31 = [v29 combineAllFutures:v28 ignoringErrors:1 scheduler:v30];
    [v31 flatMap:&__block_literal_global_213];
    id v32 = v14;
    v34 = id v33 = v7;
    ...
    id v39 = v35;
    id v40 = v6;
    __int16 v25 = [v34 addCompletionBlock:v38];
...
id __75__HMDHomeWalletKeyAccessoryManager_fetchMissingWalletKeysForUserUUID_flow___block_invoke_208(void *a1, void *a2)
{
  ...
  id v7 = objc_msgSend(v3, "fetchMissingWalletKeysForAccessory:users:flow:", v5, v6, a1[6], v9, v10);
...
LABEL_6:
      _os_log_impl(&dword_1D49D5000, v15, v16, v14, (uint8_t *)&v18, 0x2Au);
    }
  }
...
{
  id v2 = objc_msgSend(a2, "na_map:", &__block_literal_global_216_156277);
...
- (id)fetchMissingWalletKeysForAccessoryUUID:(id)a3 forUser:(id)a4 flow:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v39 = 2112;
    id v40 = v8;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Fetching missing wallet keys for accessory UUID: %@", buf, 0x20u);
  }
  ...
  {
    __int16 v20 = [v16 users];
    id v21 = [(HMDHomeWalletKeyAccessoryManager *)v12 fetchMissingWalletKeysForAccessory:v19 users:v20 flow:v10];
    v32[0] = MEMORY[0x1E4F143A8];
    v32[1] = 3221225472;
    ...
    id v33 = v10;
    id v34 = v8;
    __int16 v22 = [v21 addCompletionBlock:v32];
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v39 = 2112;
      id v40 = v28;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not fetching missing wallet keys for accessory that does not support wallet key: %@", buf, 0x20u);

      id v9 = v31;
    }

    __int16 v29 = (void *)MEMORY[0x1E4F7A0D8];
    __int16 v20 = [MEMORY[0x1E4F1CAD0] set];
    __int16 v22 = [v29 futureWithResult:v20];
  }
...
- (id)restoreMissingWalletKeys:(id)a3 onAccessory:(id)a4 flow:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v49 = 2112;
    uint64_t v50 = v16;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Restoring missing wallet keys: %@ on accessory: %@", buf, 0x2Au);
  }
  if ([v9 supportsCHIP])
  {
    id v17 = objc_alloc_init(MEMORY[0x1E4F7A0D8]);
    int v18 = [(HMDHomeWalletKeyAccessoryManager *)v12 configureNFCReaderKeyOnMatterAccessory:v9 flow:v10];
    ...
    id v20 = v8;
    id v42 = v20;
    id v21 = [v18 addFailureBlock:v40];
    v34[0] = MEMORY[0x1E4F143A8];
    v34[1] = 3221225472;
    ...
    id v22 = v19;
    id v39 = v22;
    id v23 = (id)[v21 addSuccessBlock:v34];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v47 = 2112;
      id v48 = v31;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Not restoring wallet key on non-Matter accessory: %@", buf, 0x20u);
    }
    id v32 = (void *)MEMORY[0x1E4F7A0D8];
    int v18 = [MEMORY[0x1E4F1CAD0] set];
    id v25 = [v32 futureWithResult:v18];
  }
...
void __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_2(uint64_t a1)
{
  ...
  v14[0] = MEMORY[0x1E4F143A8];
  v14[1] = 3221225472;
  v14[2] = __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_190;
  v14[3] = &unk_1E6A14070;
...
id __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to find HMDUser with UUID: %@", (uint8_t *)&v14, 0x20u);
    }
  }
...
id __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_190(uint64_t a1, void *a2)
{
  id v3 = a2;
  id v4 = [*(id *)(a1 + 32) _addIssuerKeyForUser:v3 toMatterAccessory:*(void *)(a1 + 40) flow:*(void *)(a1 + 48)];
  id v5 = [v4 flatMap:&__block_literal_global_194];
  v9[0] = MEMORY[0x1E4F143A8];
  v9[1] = 3221225472;
  void v9[2] = __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_3_195;
  v9[3] = &unk_1E6A14048;
  id v10 = v3;
  id v6 = v3;
  id v7 = [v5 recover:v9];
...
void __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_4(uint64_t a1, void *a2)
{
  ...
  if ([v3 count])
  {
    id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_201_156288);
    v12[0] = MEMORY[0x1E4F143A8];
    v12[1] = 3221225472;
    v12[2] = __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_2_202;
    v12[3] = &unk_1E6A140B8;
    id v13 = *(id *)(a1 + 64);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      id v17 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Error while restoring wallet keys: Failed to get results.", buf, 0x16u);
    }
    [*(id *)(a1 + 48) finishWithResult:*(void *)(a1 + 56)];
  }
}

id __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_2_202(uint64_t a1, void *a2)
{
  id v3 = (objc_class *)MEMORY[0x1E4F2E940];
  id v4 = a2;
  id v5 = [v3 alloc];
  id v6 = [*(id *)(a1 + 32) uuid];
  id v7 = (void *)[v5 initWithAccessoryUUID:v6 userUUID:v4];

  return v7;
}

id __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_198(uint64_t a1, void *a2)
{
  id v2 = a2;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
...
id __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_3_195(uint64_t a1)
{
  uint64_t v1 = (void *)MEMORY[0x1E4F7A0D8];
  id v2 = [*(id *)(a1 + 32) uuid];
  id v3 = [v1 futureWithResult:v2];
...
uint64_t __78__HMDHomeWalletKeyAccessoryManager_restoreMissingWalletKeys_onAccessory_flow___block_invoke_2_191()
{
...
- (void)handleRestoreMissingWalletKeysMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v29 = 2112;
    id v30 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Handling RestoreMissingWalletKeysMessage: %@", buf, 0x20u);
  }
  uint64_t v11 = *MEMORY[0x1E4F2D828];
  v24[0] = objc_opt_class();
  v24[1] = objc_opt_class();
  id v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v24 count:2];
  id v13 = [v4 unarchivedObjectForKey:v11 ofClasses:v12];

  int v14 = objc_msgSend(v13, "na_dictionaryByBucketingObjectsUsingKeyGenerator:", &__block_literal_global_184_156297);
  v22[0] = MEMORY[0x1E4F143A8];
  v22[1] = 3221225472;
  ...
  id v23 = v5;
  id v15 = v5;
  __int16 v16 = objc_msgSend(v14, "na_map:", v22);
  ...
  id v21 = v4;
  id v18 = v4;
  id v19 = (id)[v17 addSuccessBlock:v20];
}
...
void __74__HMDHomeWalletKeyAccessoryManager_handleRestoreMissingWalletKeysMessage___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v5 = *(void **)(a1 + 32);
  uint64_t v8 = *MEMORY[0x1E4F2D828];
...
- (void)handleFetchMissingWalletKeysMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v44 = 2112;
    id v45 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] Handling FetchMissingWalletKeysMessage: %@", buf, 0x20u);
  }
  id v11 = [v4 stringForKey:*MEMORY[0x1E4F2D808]];
  id v12 = [v4 stringForKey:*MEMORY[0x1E4F2D830]];
  id v13 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v11];
  uint64_t v14 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v12];
  id v15 = (void *)v14;
  if (v13)
  {
    ...
    id v18 = [(HMDHomeWalletKeyAccessoryManager *)v7 fetchMissingWalletKeysForAccessoryUUID:v13 forUser:v17 flow:v5];
    v38[0] = MEMORY[0x1E4F143A8];
    v38[1] = 3221225472;
  ...
  {
    id v22 = [(HMDHomeWalletKeyAccessoryManager *)v7 fetchMissingWalletKeysForUserUUID:v14 flow:v5];
    v34[0] = MEMORY[0x1E4F143A8];
    v34[1] = 3221225472;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      id v45 = v4;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Did not find either accessoryUUID or userUUID in message: %@", buf, 0x20u);

      uint64_t v26 = v31;
    }

    id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27];
...
void __72__HMDHomeWalletKeyAccessoryManager_handleFetchMissingWalletKeysMessage___block_invoke(uint64_t a1)
{
  ...
  uint64_t v1 = *(void **)(a1 + 32);
  uint64_t v4 = *MEMORY[0x1E4F2D828];
...
- (void)handleFetchWalletKeyColorMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Handling HMHomeFetchWalletKeyColorMessage", buf, 0x16u);
  }
  v12[0] = MEMORY[0x1E4F143A8];
  v12[1] = 3221225472;
...
void __69__HMDHomeWalletKeyAccessoryManager_handleFetchWalletKeyColorMessage___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (a2)
  {
    uint64_t v7 = *MEMORY[0x1E4F2D270];
    v8[0] = a2;
...
- (void)handleWalletKeyRemoved
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    id v11 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling wallet key removed", (uint8_t *)&v10, 0xCu);
  }
...
{
  id v9 = a2;
  id v5 = objc_msgSend(a3, "hmf_numberForKey:", *MEMORY[0x1E4F2D270]);
  if (v5)
  {
    id v6 = [*(id *)(a1 + 32) dataSource];
...
- (void)configureWithHome:(id)a3
{
  ...
  if (v11)
  {
    id v12 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v4 userPrivilege:0 remoteAccessRequired:0];
    ...
    v45[1] = v14;
    v45[2] = v13;
    id v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:v45 count:3];
    ...
    uint64_t v19 = *MEMORY[0x1E4F2D800];
    v43[0] = v12;
    v43[1] = v13;
    ...
    uint64_t v22 = *MEMORY[0x1E4F2D840];
    v42[0] = v12;
    v42[1] = v13;
    long long v23 = [MEMORY[0x1E4F1C978] arrayWithObjects:v42 count:2];
    [v21 registerForMessage:v22 receiver:v6 policies:v23 selector:sel_handleRestoreMissingWalletKeysMessage_];

    long long v24 = [v4 msgDispatcher];
    uint64_t v25 = *MEMORY[0x1E4F2D268];
    v41[0] = v12;
    v41[1] = v13;
    uint64_t v26 = [MEMORY[0x1E4F1C978] arrayWithObjects:v41 count:2];
  ...
  __int16 v29 = [(HMDHomeWalletKeyAccessoryManager *)v6 notificationCenter];
  ...
  uint64_t v31 = [(HMDHomeWalletKeyAccessoryManager *)v6 notificationCenter];
...
- (HMDHomeWalletKeyAccessoryManager)initWithUUID:(id)a3 workQueue:(id)a4 dataSource:(id)a5 notificationCenter:(id)a6
{
  ...
  if (v15)
  {
    ...
    id v21 = (NSMutableSet *)objc_alloc_init(MEMORY[0x1E4F1CA80]);
    logEvents = v16->_logEvents;
    v16->_logEvents = v21;

    [MEMORY[0x1E4F65420] blessWithImplicitContext:v16->_workQueue];
  }
...
uint64_t __47__HMDHomeWalletKeyAccessoryManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v210;
  logCategory__hmf_once_v210 = v0;
...
+ (id)createMatterIssuerKeyDataForUser:(id)a3 withUserIndex:(id)a4 flow:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  id v11 = objc_alloc_init(MEMORY[0x1E4F5BD68]);
  id v12 = (void *)[objc_alloc(MEMORY[0x1E4F5BDC0]) initWithValue:1];
  [v11 setType:v12];
  ...
  id v16 = objc_alloc_init(MEMORY[0x1E4F5BD70]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v37 = 2112;
      id v38 = v18;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to serialize issuer key for user: %@ with user index: %ld with error: %@", buf, 0x34u);
