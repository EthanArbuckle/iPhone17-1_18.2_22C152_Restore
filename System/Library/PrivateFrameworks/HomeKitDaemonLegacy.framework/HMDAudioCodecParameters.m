...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BDE8] wrappertlv:1 name:@"kAudioCodecParameters__AudioChannels"];
  id v4 = [MEMORY[0x1E4F5BC58] wrappertlv:2 name:@"kAudioCodecParameters__Bitrate" objectCreator:&__block_literal_global_399];
  v5 = [MEMORY[0x1E4F5BC58] wrappertlv:3 name:@"kAudioCodecParameters__SampleRate" objectCreator:&__block_literal_global_402];
  id v6 = [MEMORY[0x1E4F5BDE8] wrappertlv:4 name:@"kAudioCodecParameters__RTPPtime"];
  v20[0] = v3;
  v20[1] = v4;
  v20[2] = v5;
