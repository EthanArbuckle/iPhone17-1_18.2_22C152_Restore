...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_119992 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_119992, &__block_literal_global_119993);
  }
  v2 = (void *)logCategory__hmf_once_v1_119994;
  return v2;
}
...
uint64_t __51__HMDAccessoryFirmwareUpdateTimeWindow_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_119994;
  logCategory__hmf_once_v1_119994 = v0;
