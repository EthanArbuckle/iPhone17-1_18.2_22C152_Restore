...
- (id)residentMapForAccessories:(id)a3
{
  ...
  v5 = [v4 allObjects];
  v6 = [v5 sortedArrayUsingComparator:&__block_literal_global_186347];
...
- (void)dispatchMessage:(id)a3 delegateDevice:(id)a4
{
  ...
  uint64_t v9 = [(HMDHAPAccessoryTaskContext *)self workQueue];
...
- (HMDHAPAccessoryTaskContext)initWithIdentifier:(id)a3 operationType:(int64_t)a4 home:(id)a5 sourceType:(unint64_t)a6 requestMessage:(id)a7 name:(id)a8
{
  ...
  if (v19)
  {
    ...
    uint64_t v21 = [objc_alloc(MEMORY[0x1E4F653F0]) initWithName:v18];
