...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HMDCameraRecordingAudioCodec *)self type];
...
- (void)description:(id)a3 indent:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  HMDCameraRecordingAudioCodecTypeAsString([(HMDCameraRecordingAudioCodec *)self type]);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      int64_t v5 = [(HMDCameraRecordingAudioCodec *)self type];
      BOOL v6 = v5 == [(HMDCameraRecordingAudioCodec *)v4 type];
    }
    else
    {
      BOOL v6 = 0;
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  int64_t v5 = [(HMDCameraRecordingAudioCodec *)self type];
  objc_msgSend(NSString, "stringWithFormat:", @"%s_%s", "HMDCameraRecordingAudioCodec", "type");
...
- (HMDCameraRecordingAudioCodec)initWithCoder:(id)a3
{
  ...
  int64_t v5 = [(HMDCameraRecordingAudioCodec *)&v8 init];
  if (v5)
  {
    id v6 = objc_msgSend(NSString, "stringWithFormat:", @"%s_%s", "HMDCameraRecordingAudioCodec", "type");
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        v12 = -[HMDCameraRecordingAudioCodec initWithCodec:](v11, "initWithCodec:", objc_msgSend(v10, "integerValue", (void)v14));
        [v4 addObject:v12];
      }
