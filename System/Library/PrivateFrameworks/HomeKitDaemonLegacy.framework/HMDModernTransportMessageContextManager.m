  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v41 = 2112;
      id v42 = v12;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Completed context %@ for message %@ with error: %@", buf, 0x2Au);
    }
  }
}
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v35 = 2112;
      v36 = v26;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Created context %@ for message %@", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_155441 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_155441, &__block_literal_global_155442);
  }
  id v2 = (void *)logCategory__hmf_once_v3_155443;
  return v2;
}
...
uint64_t __54__HMDModernTransportMessageContextManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_155443;
  logCategory__hmf_once_v3_155443 = v0;
