...
- (id)_inUseStreamControlMessageHandlersForReadResponses:(id)a3
{
  ...
  v13 = (void *)MEMORY[0x1D9452090](v9, v10, v11, v12);
  v14 = self;
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    v24 = v8;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Found inUseStreamControlMessageHandlers: %@", buf, 0x16u);
  }
...
- (id)_availableStreamControlMessageHandlersForReadResponses:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    v24 = v8;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Found availableStreamControlMessageHandlers: %@", buf, 0x16u);
  }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Comparing availableOrInUseStreamsCount: %ld, against minimumRequiredAvailableOrInUseStreams: %ld", buf, 0x20u);
    ...
    if (v12 < v20)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v40 = v24;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@availableOrInUseStreamsCount is less than minimumRequiredAvailableOrInUseStreams, so not starting stream", buf, 0xCu);
      }
      uint64_t v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:14];
...
LABEL_10:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v40 = v36;
          _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@No camera streaming service is available", buf, 0xCu);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2112;
      v42 = v32;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Pending negotiate message for session with identifier: %@ has already been handled", buf, 0x16u);
    }
  }
}
...
- (void)readSetting
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v41 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting proactive read of stream status", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    uint64_t v14 = *MEMORY[0x1E4F5B918];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v31;
            ...
            __int16 v42 = 2112;
            __int16 v43 = v26;
            _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot find the stream status characteristic in the given service %@", buf, 0x16u);
...
void __46__HMDCameraSettingProactiveReader_readSetting__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    uint64_t v9 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Received response for proactive read of stream status", (uint8_t *)&v8, 0xCu);
  }
...
- (void)handleMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    v30 = v11;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling message: %@", (uint8_t *)&v27, 0x16u);
  }
  uint64_t v12 = [v4 name];
  if ([v12 isEqualToString:*MEMORY[0x1E4F2CD50]])
  {
...
LABEL_7:
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      v30 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to pending negotiate message for session with identifier: %@", (uint8_t *)&v27, 0x16u);
    }
    uint64_t v20 = [(HMDCameraSettingProactiveReader *)v16 pendingNegotiateMessage];
    v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    int v27 = 138543362;
    v28 = v25;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Responding to message with error because it cannot be handled", (uint8_t *)&v27, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_88114 != -1) {
    dispatch_once(&logCategory__hmf_once_t16_88114, &__block_literal_global_88115);
  }
  v2 = (void *)logCategory__hmf_once_v17_88116;
  return v2;
}
...
uint64_t __46__HMDCameraSettingProactiveReader_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v17_88116;
  logCategory__hmf_once_v17_88116 = v0;
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      uint64_t v31 = v17;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Found streaming status: %{public}@ for streaming service: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      uint64_t v31 = v23;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received invalid value type: %@ for streaming service: %@ HAPCharacteristicUUID_StreamingStatus characteristic", buf, 0x20u);
    }
    int v8 = 0;
  }
