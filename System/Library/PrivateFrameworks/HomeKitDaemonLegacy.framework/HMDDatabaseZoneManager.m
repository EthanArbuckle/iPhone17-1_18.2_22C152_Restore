    ...
    if (v12 == v5)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v20 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Handling zone removal by tearing down state", buf, 0xCu);
      }
  ...
  if ([v9 isEqualToString:v10])
  {
    ...
    if (v12 == v5)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v20 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Handling zone creation by starting", buf, 0xCu);
      }
      v17 = [(HMDDatabaseZoneManager *)v14 workQueue];
      block[0] = MEMORY[0x1E4F143A8];
      block[1] = 3221225472;
...
- (void)messengerDidReceiveShareAccessRevocation:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    v13 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Synchronizing shared zones due to share revocation", (uint8_t *)&v12, 0xCu);
  }
...
- (void)messenger:(id)a3 didReceiveInvitationData:(id)a4 completion:(id)a5
{
  ...
  int v12 = (void *)MEMORY[0x1E4F28DC0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v35 = 2112;
      id v36 = v15;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive share invitation from invitation data: %@: %@", buf, 0x20u);
    }
...
void __72__HMDDatabaseZoneManager_messenger_didReceiveInvitationData_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully accepted invitation and created shared zone with ID %@", (uint8_t *)&v16, 0x16u);
    }
    [*(id *)(a1 + 32) start];
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v13;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to accept received invitation: %@", (uint8_t *)&v16, 0x16u);
    }
...
- (void)_sendShareInvitation:(id)a3 toUser:(id)a4 device:(id)a5
{
  ...
  id v29 = 0;
  uint64_t v12 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v8 requiringSecureCoding:1 error:&v29];
  id v13 = v29;
  if (v12)
  {
...
LABEL_11:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v34 = 2112;
    id v35 = v13;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize invitation %@: %@", buf, 0x20u);
  }
LABEL_12:
}
...
- (BOOL)_handleFetchZonesResult:(id)a3 configuration:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v70 = 2112;
    v71 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Fetched zones with name %@", buf, 0x16u);
  }
          ...
          for (uint64_t i = 0; i != v24; ++i)
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v70 = 2112;
              v71 = v27;
              _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Unsubscribing externalRecordType: %@", buf, 0x16u);
            }
...
- (BOOL)_fetchSharedZonesWithConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v45 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Fetching shared zones", buf, 0xCu);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        id v47 = v27;
        _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch shared zones: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      id v47 = v33;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@No shared zone exists with zone name %@", buf, 0x16u);
    }
...
- (BOOL)_fetchExistingPrivateZonesWithConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Fetching existing private zones", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v24 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@No existing private zones exist", buf, 0xCu);
    }
...
- (BOOL)_fetchPrivateZonesWithConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Fetching private zones", buf, 0xCu);
  }
  unint64_t v10 = [(HMDDatabaseZoneManager *)v7 database];
  uint64_t v11 = [(HMDDatabaseZoneManager *)v7 zoneName];
  uint64_t v12 = [v4 cloudZoneConfiguration];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v15;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch private zones: %@", buf, 0x16u);
    }
    [(HMDDatabaseZoneManager *)v18 _tearDownState];
    BOOL v16 = 0;
  }
...
- (id)remove
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v24 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Asked to remove zone", buf, 0xCu);
  }
  if ([(HMDDatabaseZoneManager *)v5 state] == 2)
  {
    [(HMDDatabaseZoneManager *)v5 setState:3];
    id v8 = (void *)MEMORY[0x1E4F7A0F0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v24 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove backing store because it is not running", buf, 0xCu);
    }
    id v20 = (void *)MEMORY[0x1E4F7A0D8];
    unint64_t v10 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:5];
...
- (BOOL)startWithConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Starting zone manager with configuration: %@", (uint8_t *)&v18, 0x16u);
  }
  if ([(HMDDatabaseZoneManager *)v7 state])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v20 = 2048;
      uint64_t v21 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Zone manager was asked to start but it isn't idle: %ld", (uint8_t *)&v18, 0x16u);
    }
    BOOL v15 = 0;
  }
  else
...
- (HMDDatabaseZoneManager)initWithDatabase:(id)a3 zoneName:(id)a4 home:(id)a5 shareMessenger:(id)a6 workQueue:(id)a7
{
  ...
  if (v18)
  {
    ...
    v19->_id participantsManagerFactory = &__block_literal_global_61641;
  }
  return v19;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t22 != -1) {
    dispatch_once(&logCategory__hmf_once_t22, &__block_literal_global_29_61649);
  }
