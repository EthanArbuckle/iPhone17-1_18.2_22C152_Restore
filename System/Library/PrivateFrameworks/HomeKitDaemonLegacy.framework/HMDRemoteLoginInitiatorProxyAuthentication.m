...
- (void)_authenticate
{
  ...
  v11 = objc_msgSend(v10, "hmf_stringForKey:", *MEMORY[0x1E4F4EDE8]);
  ...
  v13 = objc_msgSend(v12, "hmf_stringForKey:", *MEMORY[0x1E4F4ED98]);
  [(HMDRemoteLoginProxyAuthenticationRequest *)v5 setAltDSID:v13];

  v14 = (void *)MEMORY[0x1D9452090]([(HMDRemoteLoginAuthenticationRequest *)v5 setTargetedAccountType:0]);
  v15 = self;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v38 = 2112;
    v39 = v20;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Received username %@, pet %@, alt-dsid %@", buf, 0x2Au);
  }
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    v35 = v26;
    _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Received password: %@", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1 != -1) {
    dispatch_once(&logCategory__hmf_once_t1, &__block_literal_global_241);
  }
  v2 = (void *)logCategory__hmf_once_v2;
  return v2;
}

uint64_t __57__HMDRemoteLoginInitiatorProxyAuthentication_logCategory__block_invoke()
{
