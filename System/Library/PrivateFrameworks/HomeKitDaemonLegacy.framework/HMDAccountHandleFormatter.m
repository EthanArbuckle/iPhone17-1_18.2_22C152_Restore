    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v67 = v32;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Phone number is too short to partially redact", buf, 0xCu);
      }
      v33 = 0;
    }
    v36 = (void *)v24;
...
LABEL_23:
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, v21, buf, 0xCu);
    }
  }
...
- (BOOL)getObjectValue:(id *)a3 forString:(id)a4 errorDescription:(id *)a5
{
  ...
  if (([v7 _appearsToBeEmail] & 1) != 0
    || [v7 hasPrefix:@"mailto:"])
  {
    id v8 = objc_alloc(MEMORY[0x1E4F6ABD0]);
    uint64_t v9 = MEMORY[0x1D9450AA0](v7);
LABEL_7:
    id v10 = (void *)v9;
