...
- (void)executeMediaActionWithSessionData:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Running media action locally", (uint8_t *)&v13, 0xCu);
  }
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@[Target Device] Picking resident device override: %@", buf, 0x16u);
      }
      id v15 = v8;
    }
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Available residents: %@", buf, 0x16u);
      }
      id v159 = 0;
      id v160 = 0;
      id v157 = 0;
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v165 = 2048;
        uint64_t v166 = v32;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Number of reachable residents: %lu, number of residents in action: %lu", buf, 0x20u);
      }
      int v33 = objc_msgSend(v147, "na_any:", &__block_literal_global_35_87683);
      char v34 = v33;
      if (v33) {
        char v35 = objc_msgSend(v24, "na_any:", &__block_literal_global_37_87684);
      }
      else {
        char v35 = 0;
      }
      v36 = objc_msgSend(v148, "na_firstObjectPassingTest:", &__block_literal_global_39_87685);
      if (v36)
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a resident and part of action: %@", buf, 0x16u);
        ...
        if (v43)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking non-odeon HomePod in action: %@", buf, 0x16u);
          ...
          if (contexta)
          {
            ...
            if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking non-odeon resident device in action: %@", buf, 0x16u);
            ...
            if (v124)
            {
              ...
              if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking HomePod in action: %@", buf, 0x16u);
              ...
              if (v123)
              {
                ...
                if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking resident device in action: %@", buf, 0x16u);
                ...
                if (v74)
                {
                  ...
                  if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    _os_log_impl(&dword_1D49D5000, v78, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a HomePod and not part of action and is non-odeon: %@", buf, 0x16u);
                  ...
                  if (v127)
                  {
                    ...
                    if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138543618;
                      ...
                      _os_log_impl(&dword_1D49D5000, v86, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any non-odeon HomePod: %@", buf, 0x16u);
                    ...
                    if (v122)
                    {
                      ...
                      if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138543618;
                        ...
                        _os_log_impl(&dword_1D49D5000, v94, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking current device since it is a resident and not part of action and is non-odeon: %@", buf, 0x16u);
                      ...
                      if (v100)
                      {
                        ...
                        if (os_log_type_enabled(v103, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *(_DWORD *)buf = 138543618;
                          ...
                          _os_log_impl(&dword_1D49D5000, v103, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any HomePod resident: %@", buf, 0x16u);
                        }
                        id v15 = v100;
                      }
                      else
                        ...
                        if (v121)
                        {
                          ...
                          if (os_log_type_enabled(v108, OS_LOG_TYPE_INFO))
                          {
                            ...
                            *(_DWORD *)buf = 138543618;
                            ...
                            _os_log_impl(&dword_1D49D5000, v108, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any non-odeon resident: %@", buf, 0x16u);
                          }
                          id v15 = v121;
                        }
                        else
                          ...
                          if (v15)
                          {
                            if (v113)
                            {
                              ...
                              *(_DWORD *)buf = 138543618;
                              ...
                              _os_log_impl(&dword_1D49D5000, v112, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Picking any resident: %@", buf, 0x16u);
                            }
                            id v116 = v15;
                          }
                          else
                          {
                            if (v113)
                            {
                              ...
                              *(_DWORD *)buf = 138543618;
                              ...
                              __int16 v163 = 2048;
                              uint64_t v164 = v118;
                              _os_log_impl(&dword_1D49D5000, v112, OS_LOG_TYPE_INFO, "%{public}@[Target Device] Couldn't find media action resident to route to, out of %lu candidates", buf, 0x16u);
                            }
                          }
                        }
                      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v162 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid data source", buf, 0xCu);
    }
    id v15 = 0;
  }
...
- (void)gatherTargetDevicesForExecutingMediaActionWithProfiles:(id)a3 targetSystemMediaApplication:(BOOL)a4 outResidentDevicesInMediaAction:(id *)a5 outHomePodsInMediaAction:(id *)a6 outResidentDevicesSupportingMediaActions:(id *)a7 outHomePodsSupportingMediaActions:(id *)a8 outNonOdeonHomePodsSupportingMediaActions:(id *)a9 outNonOdeonResidentDevicesSupportingMediaActions:(id *)a10 outNonOdeonResidentDevicesInMediaAction:(id *)a11 outNonOdeonHomePodsInMediaAction:(id *)a12 dataSource:(id)a13
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v84 = 2112;
    v85 = v21;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Available residents: %@", buf, 0x16u);
  }
  ...
  uint64_t v31 = objc_msgSend(v25, "na_map:", &__block_literal_global_33_87705);
  uint64_t v32 = [v30 setWithArray:v31];

  int v33 = (void *)MEMORY[0x1E4F1CAD0];
...
LABEL_11:
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v22;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Forwarding media action for remote device: %@", buf, 0x16u);
    }
    [(HMDMediaActionRouter *)v19 routeSessionDataForExecution:v7 encodePlaybackArchive:1 completion:v9];
  }
  else
  {
    v11 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2955];
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v26 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to route media action for execution, invalid message payload", buf, 0xCu);
    }
    v9[2](v9, v11);
  }
LABEL_12:
...
- (void)sendMediaActionMessageToDevice:(id)a3 sessionData:(id)a4 encodePlaybackArchive:(BOOL)a5 canForwardMessage:(BOOL)a6 completion:(id)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v47 = 2112;
    id v48 = v24;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending media action to < %@ : %@ > canForward: %@", buf, 0x2Au);
...
- (void)sendMediaActionMessageToCompanionWithSessionData:(id)a3 encodePlaybackArchive:(BOOL)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v20 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Running media action on companion", buf, 0xCu);
  }
...
void __106__HMDMediaActionRouter_sendMediaActionMessageToCompanionWithSessionData_encodePlaybackArchive_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unable to execute media action on companion: %@", (uint8_t *)&v8, 0x16u);
    }
  }
...
void __102__HMDMediaActionRouter_sendMediaActionMessageToResident_sessionData_encodePlaybackArchive_completion___block_invoke(uint64_t a1, void *a2)
{
        ...
        (v5 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v12;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Device < %@ : %@ > unreachable, rerouting", (uint8_t *)&v13, 0x20u);
    }
...
- (void)routeSessionDataForExecution:(id)a3 encodePlaybackArchive:(BOOL)a4 completion:(id)a5
{
  ...
  {
    id v13 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2955];
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      uint64_t v19 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to package media action for execution, invalid message payload", (uint8_t *)&v18, 0xCu);
    }
    v9[2](v9, v13);
  }
}
...
- (void)routeMediaActionForExecution:(id)a3 source:(unint64_t)a4 clientName:(id)a5 completion:(id)a6
{
  ...
  id v14 = objc_msgSend(v13, "na_map:", &__block_literal_global_87724);
...
LABEL_19:
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v61 = 2112;
            id v62 = v42;
            _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@For home %@, always using resident %@:%@ to execute Media Action scenes", buf, 0x2Au);
...
LABEL_15:
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v61 = 2112;
        id v62 = v33;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Couldn't find TargetResidentDevice %@ in home %@:%@", buf, 0x2Au);
      }
      id v34 = 0;
      objc_super v5 = v48;
LABEL_22:
