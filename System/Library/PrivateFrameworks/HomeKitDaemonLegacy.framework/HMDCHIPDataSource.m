...
- (void)updateNotificationsEnabled:(BOOL)a3 forHome:(id)a4 keepAliveOnly:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    v12 = [v8 fabric];
    v13 = [v12 fabricID];
    char v14 = [v13 isEqualToNumber:&unk_1F2DC8398];

    if ((v14 & 1) == 0)
    {
      v15 = [(HMDCHIPDataSource *)self chipResidentStateManager];
      v16 = [v8 fabric];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v25 = 2112;
    v26 = v22;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping notifications as fabricID is %@", (uint8_t *)&v23, 0x16u);
  }
LABEL_8:
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_98416 != -1) {
    dispatch_once(&logCategory__hmf_once_t28_98416, &__block_literal_global_140_98417);
  }
  v2 = (void *)logCategory__hmf_once_v29_98418;
  return v2;
}
...
LABEL_29:
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, v31, buf, 0xCu);
    }
LABEL_30:
            ...
            while (2)
            {
              for (uint64_t i = 0; i != v18; ++i)
              {
                ...
                if ([v21 supportsCHIP])
                {
                  ...
                  int v23 = [v21 supportedLinkLayerTypes];
                  char v24 = [v23 unsignedIntValue];

                  __int16 v25 = [v21 supportedLinkLayerTypes];
...
- (void)stopAccessoryFirmwareUpdateWithFabricID:(id)a3 completion:(id)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v37 = v26;
      uint64_t v27 = "%{public}@Home manager reference is nil";
LABEL_20:
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, v27, buf, 0xCu);
    }
LABEL_21:

    uint64_t v10 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
    v7[2](v7, v10);
    goto LABEL_22;
  }
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v37 = v26;
      uint64_t v27 = "%{public}@Fabric ID is nil";
      goto LABEL_20;
    }
    goto LABEL_21;
  }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v38 = 2112;
    id v39 = v6;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
  }
...
void __72__HMDCHIPDataSource_stopAccessoryFirmwareUpdateWithFabricID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread accessory firmware update, error %@", (uint8_t *)&v8, 0x16u);
    }
  }
...
LABEL_20:
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, v32, buf, 0xCu);
    }
LABEL_21:

    int v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
    v12[2](v12, v15);
    goto LABEL_22;
  }
  if (!v11)
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v46 = 2112;
    id v47 = v11;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
  }
  int v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
  uint64_t v12 = v35;
  v35[2](v35, v15);
  id v10 = v36;
LABEL_17:
...
void __104__HMDCHIPDataSource_startAccessoryFirmwareUpdateWithExtendedMACAddress_fabricID_isWedDevice_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread accessory firmware update with emac %@, error %@", (uint8_t *)&v9, 0x20u);
    }
  }
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        if (v18)
        {
          ...
          v28 = (void *)MEMORY[0x1D9452090]([(HMDCHIPDataSource *)self setThreadPairingFabricID:0]);
          v29 = self;
          v30 = HMFGetOSLogHandle();
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v42 = 2112;
            id v43 = v15;
            _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Setting thread start pairing override to NO for home %@", buf, 0x16u);
          }
...
void __65__HMDCHIPDataSource_stopAccessoryPairingWithFabricID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread accessory pairing, error %@", (uint8_t *)&v8, 0x16u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}
...
- (void)overrideLocationCheckForPairingForFabricID:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v5 = (void *)MEMORY[0x1D9452090]([(HMDCHIPDataSource *)self setThreadPairingFabricID:v4]);
    id v6 = self;
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Allowing thread start for pairing with fabricID: %@", (uint8_t *)&v12, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      uint64_t v13 = v11;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Not setting pairing override as fabricID is null.", (uint8_t *)&v12, 0xCu);
    }
  }
}
...
LABEL_21:
    ...
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
    v12[2](v12, v15);
    goto LABEL_22;
  }
  if (!v11)
...
void __97__HMDCHIPDataSource_startAccessoryPairingWithExtendedMACAddress_fabricID_isWedDevice_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread accessory pairing with emac %@, error %@", (uint8_t *)&v9, 0x20u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
}
...
- (int64_t)getUserPreferredThreadNetworkNodeTypeWithError:(id *)a3
{
  ...
  {
    *a3 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    return 0;
  }
}
...
- (int64_t)getThreadNetworkNodeTypeWithFabricID:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      BOOL v33 = v24;
      __int16 v25 = "%{public}@Home manager reference is nil";
LABEL_20:
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, v25, buf, 0xCu);
    }
LABEL_21:
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      BOOL v33 = v24;
      __int16 v25 = "%{public}@fabricID is nil";
      goto LABEL_20;
    }
    goto LABEL_21;
  }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    id v35 = v4;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@No home found with fabricID %@", buf, 0x16u);
  }
  int64_t v20 = 0;
LABEL_17:
  id v6 = v27;
...
- (void)handleThreadNetworkPeripheralDeviceNodeTypeChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      id v14 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Event not of type HMDThreadNetworkPeripheralDeviceNodeTypeEvent", (uint8_t *)&v13, 0xCu);
    }
  }
}
...
- (void)handleThreadNetworkWakeOnConnectionStateChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      uint64_t v16 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Event not of type thread wake on connection state changed", (uint8_t *)&v15, 0xCu);
    }
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@No home associated with network connection state change notification", (uint8_t *)location, 0xCu);
    }
  }
}
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v9;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
    }
    int v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    id v10 = v31;
...
LABEL_18:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v41 = v29;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
    }
    int v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52];
...
void __86__HMDCHIPDataSource_connectToAccessoryWithExtendedMACAddress_withFabricID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to connect to accessory with emac %@, error %@", (uint8_t *)&v9, 0x20u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
}
...
- (void)stopThreadRadioOnDeviceLock
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping Thread network after device lock", buf, 0xCu);
  }
...
- (void)stopThreadRadioForUserPreferredNetwork
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping Thread network for user preferred network", buf, 0xCu);
  }
...
- (void)startThreadRadioForUserPreferredNetwork
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v18 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting Thread network for user preferred network", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v18 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@No thread network metadata store", buf, 0xCu);
      }
    }
  }
}
...
void __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
    ...
    if (!v11 || v12)
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v28 = 2112;
        id v29 = v12;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve operationalDataset for thread network: %@", buf, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v32 = 2112;
        id v33 = v11;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ from network metadata store", buf, 0x2Au);
      }
      [*(id *)(a1 + 32) setGeoAvailable:0];
      uint64_t v19 = *(void **)(a1 + 32);
      v24[0] = MEMORY[0x1E4F143A8];
      v24[1] = 3221225472;
      v24[2] = __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke_170;
      v24[3] = &unk_1E6A196E0;
      v24[4] = v15;
      id v25 = v10;
  ...
  {
    int64_t v20 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v27 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", buf, 0xCu);
    }
  }
}

void __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke_170(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to attach to user preferred thread network %@: %@", (uint8_t *)&v12, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v11;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Attached to thread network %@", (uint8_t *)&v12, 0x16u);
    }
  }
}
...
- (void)startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)((char *)&buf + 4) = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting Thread network for user preferred network with GEO and BR check", (uint8_t *)&buf, 0xCu);
  }
  ...
  if (v49)
  {
    ...
    *((void *)&buf + 1) = &buf;
    ...
    v78 = __Block_byref_object_copy__98230;
    v79 = __Block_byref_object_dispose__98231;
    id v80 = 0;
    ...
    if (v8)
    {
      ...
      id v10 = [v9 sortedArrayUsingComparator:&__block_literal_global_161_98232];
    ...
    {
      int v23 = (void *)MEMORY[0x1D9452090](v7);
      char v24 = v4;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v69 = 138543362;
        id v70 = v26;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil - skipping in-geo && matter check", v69, 0xCu);
      }
    }
    ...
    if (dispatch_group_wait(group, v27))
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v69 = 138543362;
        id v70 = v31;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Timed out while fetching preferred network.", v69, 0xCu);
      }
    }
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v69 = 138543874;
      ...
      __int16 v73 = 2112;
      v74 = v37;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@startThreadRadioForUserPreferredNetwork: isLocationAuthorized = %@. isInGeoForAnyHome = %@", v69, 0x20u);
    }
    if (v48 && !*((unsigned char *)v66 + 24))
    {
      ...
      if (v38)
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v69 = 138543362;
          id v70 = v46;
          _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_INFO, "%{public}@Not in-geo for any home and no accessories in matter locker, not starting thread", v69, 0xCu);
        }
        goto LABEL_39;
      }
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v69 = 138543362;
        id v70 = v42;
        _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_INFO, "%{public}@Not in-geo for any home and no accessories in matter locker, allowing thread start anyways", v69, 0xCu);
      }
    }
    ...
    v51[1] = 3221225472;
    v51[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_166;
    v51[3] = &unk_1E6A0EBD8;
...
LABEL_39:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    LODWORD(buf) = 138543362;
    *(void *)((char *)&buf + 4) = v22;
    _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@No thread network metadata store", (uint8_t *)&buf, 0xCu);
  }
LABEL_40:
}
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_2(uint64_t a1, int a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v5;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@GeoAvailable: %@, error %@", (uint8_t *)&v19, 0x20u);
  }
  if (a2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v17;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Is in Geo for home with fabricID %@ - %@", (uint8_t *)&v19, 0x20u);
    }
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_166(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      if (!v5 || v6)
      {
        ...
        v21[1] = 3221225472;
        v21[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_167;
        v21[3] = &unk_1E6A0EBB0;
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        __int16 v28 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Border router present on network - not starting thread", buf, 0xCu);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        __int16 v28 = v17;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Aborting thread start after border router check - thread was started for a home", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      __int16 v28 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", buf, 0xCu);
    }
  }
LABEL_15:
}

void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_167(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  uint64_t v49 = *MEMORY[0x1E4F143B8];
  id v9 = a2;
  id v10 = a3;
...
LABEL_17:
    ...
    *(_DWORD *)long long buf = 138543362;
    __int16 v42 = v33;
    _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", buf, 0xCu);
LABEL_16:
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      __int16 v42 = v34;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Aborting thread start after getting preferred network - thread was started for a home", buf, 0xCu);
    }
    goto LABEL_16;
  }
  if (!v11 || v12)
  {
    ...
    if (v16)
    {
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543874;
        ...
        __int16 v45 = 2112;
        id v46 = v23;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Using cached AOD from home with fabricID %@ - %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      __int16 v42 = v36;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@No cached AOD available as a fallback, aborting thread start", buf, 0xCu);
    }
    id v35 = v17;
LABEL_18:
    goto LABEL_19;
...
LABEL_9:
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138544130;
    ...
    __int16 v47 = 2112;
    id v48 = v11;
    _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ from network metadata store", buf, 0x2Au);
  }
  [*(id *)(a1 + 40) setGeoAvailable:*(unsigned __int8 *)(*(void *)(*(void *)(a1 + 56) + 8) + 24)];
  __int16 v30 = *(void **)(a1 + 40);
  v39[0] = MEMORY[0x1E4F143A8];
  v39[1] = 3221225472;
  v39[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_168;
  v39[3] = &unk_1E6A196E0;
  v39[4] = v26;
  id v40 = v10;
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_168(uint64_t a1, void *a2)
{
...
- (void)_getPreferredNetworkExistsWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543874;
    ...
    __int16 v25 = 1024;
    int v26 = v20;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Checking if preferred network exists for SSID: %@ error: %d", buf, 0x1Cu);
  }
  ...
  else
  {
    ...
    uint64_t v16 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:2 userInfo:0];
...
void __62__HMDCHIPDataSource__getPreferredNetworkExistsWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v11)
    {
      if (v17)
      {
        ...
        __int16 v31 = 2112;
        id v32 = v11;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ for current network", (uint8_t *)&v25, 0x2Au);
      }
    ...
    else
    {
      if (v17)
      {
        ...
        int v25 = 138543362;
        int v26 = v24;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@No thread network found for current Wifi", (uint8_t *)&v25, 0xCu);
      }
      id v19 = *(void (**)(void))(*(void *)(a1 + 32) + 16);
    }
    v19();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v25 = 138543362;
      int v26 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", (uint8_t *)&v25, 0xCu);
    }
    __int16 v23 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:2 userInfo:0];
...
- (void)handleNetworkStateChange
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    id v12 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Received network state change from Thread network event listener", (uint8_t *)&v11, 0xCu);
  }
...
- (void)handleThreadBTCallStateChange:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    uint64_t v13 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received thread call state change - isInCall = %@", (uint8_t *)&v10, 0x16u);
  }
  if (!a3) {
...
LABEL_23:
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, v24, buf, 0xCu);
    }
LABEL_24:
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = 138543618;
            ...
            __int16 v36 = 2112;
            id v37 = v4;
            _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Calling thread stop for home with fabricID: %@", buf, 0x16u);
          }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v36 = 2112;
    id v37 = v4;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find home with CHIP fabric ID: %@", buf, 0x16u);
  }
  uint64_t v6 = v29;
LABEL_25:
}
          ...
          if (([(HMDCHIPDataSource *)self checkPresenceForHome:v12] & 0xFFFFFFFFFFFFFFFELL) == 2)
          {
            ...
            if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)long long buf = 138543618;
              ...
              __int16 v40 = 2112;
              id v41 = v4;
              _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Not calling thread start for home with fabricID: %@ as user is not home", buf, 0x16u);
            }
...
LABEL_31:
        ...
        __int16 v29 = (void *)MEMORY[0x1D9452090]([(HMDCHIPDataSource *)self registerForLeaveNotifications:v12]);
        long long v30 = self;
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)long long buf = 138543618;
          ...
          __int16 v40 = 2112;
          id v41 = v4;
          _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Calling thread start for home with fabricID: %@", buf, 0x16u);
        }
...
void __50__HMDCHIPDataSource__scheduleThreadNetworkRestart__block_invoke(uint64_t a1)
{
  ...
  if (v2 != [*(id *)(a1 + 32) networkChangedLastUpdatedTime])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Ignoring Wifi network changed as newer request is queued.", (uint8_t *)&v13, 0xCu);
    }
    goto LABEL_12;
  }
  [*(id *)(a1 + 32) _getPreferredNetworkExistsWithCompletion:&__block_literal_global_155];
  ...
  if (!v3)
  {
    if (v7)
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v12;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring WiFi network changed notification when Thread is not up", (uint8_t *)&v13, 0xCu);
    }
LABEL_12:
    return;
  }
  if (v7)
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Restarting Thread network for user preferred network upon WiFi network changed notification", (uint8_t *)&v13, 0xCu);
  }
...
- (void)hasValidGeoOrPreferredNetworkForHome:(id)a3 completion:(id)a4
{
    ...
    if (v8 == 1)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543618;
        ...
        __int16 v30 = 2112;
        id v31 = v6;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Allowing geo as user is at home for: %@", buf, 0x16u);
      }
      v7[2](v7, 1, 0);
    }
    else
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)long long buf = 138543618;
          ...
          __int16 v30 = 2112;
          id v31 = v15;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Fetching preferred network as location is unknown for home: %@", buf, 0x16u);
        }
        v21[0] = MEMORY[0x1E4F143A8];
        v21[1] = 3221225472;
        v21[2] = __69__HMDCHIPDataSource_hasValidGeoOrPreferredNetworkForHome_completion___block_invoke_152;
        v21[3] = &unk_1E6A17D78;
        void v21[4] = v18;
        id v22 = v16;
  ...
  {
    int v13 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:2 userInfo:0];
...
void __69__HMDCHIPDataSource_hasValidGeoOrPreferredNetworkForHome_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(unsigned char *)(a1 + 64) && ([*(id *)(a1 + 32) pnExistsOnCurrentNetwork] & v4) == 1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Allowing geo due to valid preferred network for: %@ and error: %@", (uint8_t *)&v15, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Denying geo due to presence: %@, location authorization: %@, preferred network: %@ for: %@ error: %@", (uint8_t *)&v15, 0x3Eu);
    }
  }
...
void __69__HMDCHIPDataSource_hasValidGeoOrPreferredNetworkForHome_completion___block_invoke_152(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v8 = 138543362;
    id v9 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Done fetching.", (uint8_t *)&v8, 0xCu);
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}
...
- (void)unregisterForArrivalNotifications:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    int v11 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering arrival notifications.", (uint8_t *)&v10, 0xCu);
  }
...
- (void)unprotectedRegisterForArrivalNotifications:(id)a3
{
  ...
  if (v4 && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v16 = 138543362;
      __int16 v17 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering for arrival notifications.", (uint8_t *)&v16, 0xCu);
    }
...
- (void)unregisterForLeaveNotifications:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    int v11 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering leave notifications.", (uint8_t *)&v10, 0xCu);
  }
  id v9 = [(HMDCHIPDataSource *)v6 notificationCenter];
...
- (void)unprotectedRegisterForLeaveNotifications:(id)a3
{
  ...
  if (v4 && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v16 = 138543362;
      __int16 v17 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering for leave notifications.", (uint8_t *)&v16, 0xCu);
    }
...
- (void)handleHomeDidArriveHomeNotification:(id)a3
{
  ...
  int v7 = (void *)MEMORY[0x1D9452090](v6);
  char v8 = self;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    int v16 = v12;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@User arrived home, starting thread network for fabric ID: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)handleHomeDidLeaveHomeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    __int16 v15 = v11;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@User left home, stopping thread network for fabric ID: %@", (uint8_t *)&v12, 0x16u);
  }
...
- (void)handleLocationAuthorizationChangedNotification:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      char v8 = (void *)MEMORY[0x1D9452090]([(HMDCHIPDataSource *)self setLocationAuthorization:v7]);
      id v9 = self;
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v21 = 2112;
        id v22 = v12;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Location Authorization is changing to %@, stopping thread network", (uint8_t *)&v19, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      id v20 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@No location authorization key in the message", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
- (void)browser:(id)a3 didRemoveAccessoryPairingWithNodeID:(id)a4
{
                ...
                if (v20)
                {
                  ...
                  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)long long buf = 138543874;
                    ...
                    __int16 v51 = 2112;
                    id v52 = v29;
                    _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Found accessory to remove from Apple Home with Matter node ID %@: %@", buf, 0x20u);
                  }
                  v37[0] = MEMORY[0x1E4F143A8];
                  v37[1] = 3221225472;
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v49 = 2112;
    id v50 = v6;
    _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@No accessory found in any homes with matter node id %@", buf, 0x16u);
  }
LABEL_24:
}
...
void __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v17 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Defaults write set - skipping auth prompt for bridge accessory", buf, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v17 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Presenting user with auth prompt for bridge accessory", buf, 0xCu);
    }
    ...
    v14[0] = MEMORY[0x1E4F143A8];
    v14[1] = 3221225472;
    v14[2] = __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke_146;
    v14[3] = &unk_1E6A14990;
...
uint64_t __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke_146(uint64_t a1)
{
...
void __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v17 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Defaults write set - skipping auth prompt for unauthenticated accessory", buf, 0xCu);
    }
    (*(void (**)(void))(*(void *)(a1 + 64) + 16))();
  }
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v17 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Presenting user with auth prompt for unauthenticated accessory", buf, 0xCu);
    }
    id v10 = [*(id *)(a1 + 32) dialogPresenter];
    uint64_t v11 = *(void *)(a1 + 40);
    uint64_t v12 = *(void *)(a1 + 48);
    v14[0] = MEMORY[0x1E4F143A8];
    v14[1] = 3221225472;
    v14[2] = __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke_144;
    v14[3] = &unk_1E6A14990;
    uint64_t v13 = *(void *)(a1 + 56);
    id v15 = *(id *)(a1 + 64);
...
uint64_t __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke_144(uint64_t a1)
{
  return (*(uint64_t (**)(void))(*(void *)(a1 + 32) + 16))();
}
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      uint64_t v18 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Vendor metadata refresh timer fired; fetching vendor metadata from cloud",
        (uint8_t *)&v17,
        0xCu);
    }
  ...
  if (v11 == v4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      uint64_t v18 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Attestation data refresh timer fired; fetching attestation data from cloud",
        (uint8_t *)&v17,
        0xCu);
    }
...
- (void)forAllPairedMatterServersFetchVidPid:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      long long v37 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
    }
  }
}
    ...
    if (v8)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v9; ++i)
        {
          ...
          if (v13)
          {
            if (([v13 isEqualToNumber:&unk_1F2DC8398] & 1) == 0)
            {
...
LABEL_17:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      long long v28 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@forAllStorageDataSourcesDo: Home manager reference is nil", buf, 0xCu);
    }
  }
}
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      uint32_t v21 = 22;
LABEL_15:
      _os_log_impl(&dword_1D49D5000, v19, v20, v18, buf, v21);
    }
  }
  else
  {
...
- (id)appleHomeFabricWithUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      long long v27 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
    }
  }
  int v15 = 0;
LABEL_16:
...
- (id)appleHomeFabricWithID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      uint64_t v28 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
    }
  }
  char v16 = 0;
LABEL_16:
...
- (NSNumber)currentFabricID
{
  ...
  {
    id v5 = [v3 homes];
    id v6 = objc_msgSend(v5, "na_filter:", &__block_literal_global_133_98321);

    uint64_t v7 = [v6 sortedArrayUsingComparator:&__block_literal_global_135_98322];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      char v16 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", (uint8_t *)&v15, 0xCu);
    }
    uint64_t v9 = 0;
  }
...
- (NSSet)allTargetFabricUUIDs
{
  ...
  if (v3)
  {
    ...
    uint64_t v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_131_98327);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      int v15 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", (uint8_t *)&v14, 0xCu);
    }
...
- (NSSet)allFabricIDs
{
  ...
  if (v3)
  {
    id v5 = (void *)MEMORY[0x1E4F1CAD0];
    uint64_t v6 = [v3 homes];
    uint64_t v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_128_98331);
    uint64_t v8 = [v5 setWithArray:v7];
  }
  else
  {
...
- (NSSet)allPairedHAPServerIdentifiers
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      long long v35 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
    }
...
- (void)handleHomeRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v18 = 138543362;
    uint64_t v19 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling home removal by notifying CHIP storage", (uint8_t *)&v18, 0xCu);
  }
...
- (void)handleAccessoryCHIPStorageChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      int v18 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Did not find %@ in notification userInfo. Defaulting isLocalChange to %@", (uint8_t *)&v13, 0x20u);
    }
    uint64_t v7 = 1;
  }
...
- (void)handleResidentReachabilityNotification:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 userInfo];
  uint64_t v6 = [v5 objectForKeyedSubscript:@"HMDResidentDeviceManagerHomeUUIDNotificationKey"];
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    long long v22 = v11;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Notifying HomeKitMatter of resident reachability change for Home %@ with fabricID %@", (uint8_t *)&v17, 0x20u);
  }
...
- (void)handlePrimaryResidentUpdatedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    id v12 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying CHIP data sources of updated resident state", (uint8_t *)&v11, 0xCu);
  }
  uint64_t v9 = [(HMDCHIPDataSource *)v6 chipResidentStateManager];
  [v9 handleResidentStateUpdated];

  uint64_t v10 = [(HMDCHIPDataSource *)v6 chipStorage];
...
- (void)handleUpdatedDataWithIsLocalChange:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying CHIP storage of updated home CHIP storage with isLocalChange: %@", (uint8_t *)&v11, 0x16u);
  }
  uint64_t v10 = [(HMDCHIPDataSource *)v6 chipStorage];
  [v10 handleUpdatedDataWithIsLocalChange:v3];
}
...
- (id)homeWithCHIPFabric:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      int v17 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Home manager or fabric reference is nil", buf, 0xCu);
    }
    id v8 = 0;
  }
...
- (id)home
{
  ...
  BOOL v3 = [(HMDCHIPDataSource *)self homeManager];
  BOOL v4 = v3;
  if (v3)
  {
    id v5 = [v3 homes];
    uint64_t v6 = objc_msgSend(v5, "na_filter:", &__block_literal_global_113_98348);

    uint64_t v7 = objc_msgSend(v6, "na_firstObjectPassingTest:", &__block_literal_global_115_98349);
    id v8 = v7;
    if (v7)
    {
      id v9 = v7;
    ...
    else
    {
      ...
      else
      {
        ...
        {
          __int16 v19 = objc_msgSend(v6, "sortedArrayUsingComparator:", &__block_literal_global_118, v22, v23, v24, v25);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      long long v30 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", buf, 0xCu);
    }
    id v9 = 0;
  }
...
LABEL_7:
  ...
  uint64_t v5 = v4;
  uint64_t v6 = [(HMDCHIPDataSource *)self uiDialogPresenter];
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with UI dialog presenter: %@", (uint8_t *)&v12, 0x16u);
  }
...
LABEL_7:
  ...
  uint64_t v5 = v4;
  uint64_t v6 = [(HMDCHIPDataSource *)self attestationDataStore];
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    int v17 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with attestation data store: %@", (uint8_t *)&v14, 0x16u);
  }
  ...
  __int16 v13 = [(HMDCHIPDataSource *)v8 attestationDataRefreshTimer];
  [v13 resume];
}
...
LABEL_7:
  ...
  uint64_t v5 = v4;
  uint64_t v6 = [(HMDCHIPDataSource *)self vendorMetadataStore];
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    uint64_t v18 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with vendor metadata store: %@", (uint8_t *)&v15, 0x16u);
  }
  ...
  __int16 v13 = [(HMDCHIPDataSource *)v8 vendorMetadataRefreshTimer];
  [v13 setDelegate:v8];
...
LABEL_7:
  ...
  uint64_t v5 = v4;
  uint64_t v6 = [(HMDCHIPDataSource *)self chipStorage];
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with storage: %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  __int16 v13 = [(HMDCHIPDataSource *)v8 notificationCenter];
...
- (void)configureWithThreadRadioManager:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v5;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Configuring with thread radio manager: %@", (uint8_t *)&v17, 0x16u);
  }
  [(HMDCHIPDataSource *)v7 setMatterThreadRadioManager:v5];
  [v5 setDelegate:v7];
  uint64_t v10 = [(HMDCHIPDataSource *)v7 notificationCenter];
  ...
  __int16 v13 = [(HMDCHIPDataSource *)v7 notificationCenter];
  ...
  [v14 addObserver:v7 selector:sel_handleCurrentWiFiNetworkChangedNotification_ name:*MEMORY[0x1E4F653E8] object:0];
...
LABEL_9:
  ...
  uint64_t v5 = v4;
  uint64_t v6 = [(HMDCHIPDataSource *)self chipResidentStateManager];
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    __int16 v19 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with resident state manager: %@", (uint8_t *)&v16, 0x16u);
  }
...
- (HMDCHIPDataSource)initWithHomeManager:(id)a3 notificationCenter:(id)a4 vendorMetadataRefreshTimer:(id)a5 attestationDataRefreshTimer:(id)a6 dialogPresenter:(id)a7
{
  ...
  if (v17)
  {
    ...
    [(HMDCHIPDataSource *)v18 _getPreferredNetworkExistsWithCompletion:&__block_literal_global_98407];
  }
...
- (HMDCHIPDataSource)initWithHomeManager:(id)a3
{
  ...
  id v9 = objc_alloc(MEMORY[0x1E4F65580]);
...
uint64_t __32__HMDCHIPDataSource_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v29_98418;
  logCategory__hmf_once_v29_98418 = v0;
