...
- (id)dataSourceDeviceForMessage:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source device due to no data source", (uint8_t *)&v13, 0xCu);
    }
    v7 = 0;
  }
...
LABEL_7:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v17;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Relaying remote message: %@", (uint8_t *)&v31, 0x16u);
    }
  ...
  if (v5 && [v10 isCurrentDevicePrimaryResident])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v15;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Allowing relay for message: %@", (uint8_t *)&v31, 0x16u);
    }
    goto LABEL_7;
  }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v33 = 2112;
    id v34 = v8;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to relay message due to being a remote message: %@", (uint8_t *)&v31, 0x16u);
  }
  v17 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:12];
...
- (void)routeMessage:(id)a3 allowRemoteRelayFromPrimary:(BOOL)a4 localHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v8;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Routing message: %@", (uint8_t *)&v21, 0x16u);
  }
  ...
  {
    v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v16;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source device while routing message error: %@", (uint8_t *)&v21, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_101267 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_101267, &__block_literal_global_101268);
  }
  v2 = (void *)logCategory__hmf_once_v7_101269;
  return v2;
}
...
uint64_t __50__HMDAppleMediaAccessoryMessageRouter_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v7_101269;
  logCategory__hmf_once_v7_101269 = v0;
