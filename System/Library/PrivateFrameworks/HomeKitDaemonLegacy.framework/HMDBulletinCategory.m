...
+ (id)presentationValueForValue:(id)a3 type:(id)a4
{
  ...
  if (([v7 isEqualToString:*MEMORY[0x1E4F5B8E0]] & 1) != 0
    || [v7 isEqualToString:*MEMORY[0x1E4F5B8B0]])
  {
  ...
  if (([v7 isEqualToString:*MEMORY[0x1E4F5B838]] & 1) != 0
    || [v7 isEqualToString:*MEMORY[0x1E4F5B960]])
  {
  ...
  {
    if (([v7 isEqualToString:*MEMORY[0x1E4F5B848]] & 1) == 0
      && ([v7 isEqualToString:*MEMORY[0x1E4F5B888]] & 1) == 0
      && ([v7 isEqualToString:*MEMORY[0x1E4F5B8A0]] & 1) == 0
      && ![v7 isEqualToString:*MEMORY[0x1E4F5B830]])
    {
...
{
  id v3 = a3;
  if (([v3 isEqualToString:*MEMORY[0x1E4F5B8E0]] & 1) != 0
    || ([v3 isEqualToString:*MEMORY[0x1E4F5B8B0]] & 1) != 0
    || (int v4 = [v3 isEqualToString:*MEMORY[0x1E4F5B838]], v5 = v3, v4))
  {
    v5 = (void *)*MEMORY[0x1E4F5B810];
  }
  id v6 = v5;
...
+ (id)_localizedStateForValue:(id)a3 characteristicType:(id)a4
{
  ...
  id v5 = a3;
  id v6 = a4;
  if ([v6 isEqualToString:*MEMORY[0x1E4F5B838]])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@type : %@ value = %@", (uint8_t *)&v19, 0x20u);
    }
...
+ (NSDictionary)targetCurrentCharacteristicTypeMap
{
  if (targetCurrentCharacteristicTypeMap_onceToken != -1) {
    dispatch_once(&targetCurrentCharacteristicTypeMap_onceToken, &__block_literal_global_135_91641);
  }
...
void __57__HMDBulletinCategory_targetCurrentCharacteristicTypeMap__block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F5B810];
  uint64_t v1 = *MEMORY[0x1E4F5B958];
  v7[0] = *MEMORY[0x1E4F5B938];
  v7[1] = v1;
  uint64_t v2 = *MEMORY[0x1E4F5B830];
  v8[0] = v0;
  v8[1] = v2;
  uint64_t v3 = *MEMORY[0x1E4F5B970];
  v7[2] = *MEMORY[0x1E4F5B960];
  v7[3] = v3;
  uint64_t v4 = *MEMORY[0x1E4F5B848];
  v8[2] = *MEMORY[0x1E4F5B838];
  v8[3] = v4;
...
+ (id)bulletinReasonForChangedCharacteristic:(id)a3
{
  ...
  {
    v9 = [v3 type];
    int v10 = [v9 isEqualToString:*MEMORY[0x1E4F5B8A0]];

    if (v10)
    {
      v11 = (id *)MEMORY[0x1E4F2CAD8];
LABEL_7:
      id v15 = *v11;
      goto LABEL_10;
    }
    uint64_t v12 = [v3 type];
    if ([v12 isEqualToString:*MEMORY[0x1E4F5B888]])
    {
      unint64_t v13 = [v4 type];
      int v14 = [v13 isEqualToString:*MEMORY[0x1E4F5BA78]];

      if (v14)
      {
        v11 = (id *)MEMORY[0x1E4F2CAC8];
        goto LABEL_7;
      }
    }
    else
...
+ (BOOL)isSecureServiceType:(id)a3
{
  ...
  id v4 = a3;
  if (v3 != -1) {
    dispatch_once(&isSecureServiceType__onceToken, &__block_literal_global_132_91644);
  }
...
uint64_t __43__HMDBulletinCategory_isSecureServiceType___block_invoke()
{
  uint64_t v0 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F5BA70], *MEMORY[0x1E4F5BA90], *MEMORY[0x1E4F5BAB8], *MEMORY[0x1E4F5BAD0], *MEMORY[0x1E4F5BB58], 0);
  uint64_t v1 = isSecureServiceType__secureServices;
...
+ (id)localizedStateForCharacteristic:(id)a3 doorbellBulletinUtilities:(id)a4
{
  ...
  v9 = [v6 service];
  int v10 = [v6 type];
  int v11 = [v10 isEqualToString:*MEMORY[0x1E4F5B888]];

  if (v11)
  {
    uint64_t v12 = [v9 type];
    int v13 = [v12 isEqualToString:*MEMORY[0x1E4F5BA78]];
  ...
  if (+[HMDBulletinCategory isSensorDetectedCharacteristic:v6])
  {
    ...
    id v17 = [v6 type];
    int v18 = [v17 isEqualToString:*MEMORY[0x1E4F5B8A0]];
  ...
  v32 = [v6 type];
  if ([v32 isEqualToString:*MEMORY[0x1E4F5B7D8]])
  {
    v33 = [v9 type];
...
LABEL_13:
  ...
  v45 = [v9 type];
  uint64_t v46 = *MEMORY[0x1E4F5BB60];
  id v80 = v7;
  v74 = v8;
  if (![v45 isEqualToString:*MEMORY[0x1E4F5BB60]])
  {
    v55 = [v9 type];
    if ([v55 isEqualToString:*MEMORY[0x1E4F5BAF0]])
    {
  ...
  if (!v64)
  {
    ...
    if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v89 = 2112;
      id v90 = v65;
      _os_log_impl(&dword_1D49D5000, v69, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    }
    v66 = v67;
    v63 = v72;
    v59 = v78;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v22 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Could not determine localized string from empty items", buf, 0xCu);
    }
    int v10 = &stru_1F2C9F1A8;
  }
...
+ (id)_sensorMap
{
  if (_sensorMap_onceToken != -1) {
    dispatch_once(&_sensorMap_onceToken, &__block_literal_global_73);
  }
...
void __33__HMDBulletinCategory__sensorMap__block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F5B7F8];
  v5[0] = *MEMORY[0x1E4F5B8A0];
  v5[1] = v0;
  v6[0] = @"BULLETIN_ACTION_SENSOR_MOTION";
  v6[1] = @"BULLETIN_ACTION_SENSOR_CO";
  uint64_t v1 = *MEMORY[0x1E4F5B910];
  v5[2] = *MEMORY[0x1E4F5B7F0];
  v5[3] = v1;
  v6[2] = @"BULLETIN_ACTION_SENSOR_CO2";
  v6[3] = @"BULLETIN_ACTION_SENSOR_SMOKE";
  uint64_t v2 = *MEMORY[0x1E4F5B8B8];
  v5[4] = *MEMORY[0x1E4F5B890];
  v5[5] = v2;
...
+ (id)_secureStateMap
{
  if (_secureStateMap_onceToken != -1) {
    dispatch_once(&_secureStateMap_onceToken, &__block_literal_global_54_91709);
  }
...
void __38__HMDBulletinCategory__secureStateMap__block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F5B838];
  v4[0] = *MEMORY[0x1E4F5B810];
  v4[1] = v0;
  v5[0] = &unk_1F2DC6D48;
  v5[1] = &unk_1F2DC6D60;
  uint64_t v1 = *MEMORY[0x1E4F5B800];
  v4[2] = *MEMORY[0x1E4F5B848];
  v4[3] = v1;
  v5[2] = &unk_1F2DC6D78;
  v5[3] = &unk_1F2DC6D90;
...
+ (id)_enumerationValueLocalizationKeys
{
  if (_enumerationValueLocalizationKeys_onceToken != -1) {
    dispatch_once(&_enumerationValueLocalizationKeys_onceToken, &__block_literal_global_91715);
  }
...
{
  v6[6] = *MEMORY[0x1E4F143B8];
  uint64_t v0 = *MEMORY[0x1E4F5B830];
  v5[0] = *MEMORY[0x1E4F5B810];
  v5[1] = v0;
  v6[0] = &unk_1F2DC6CB8;
  v6[1] = &unk_1F2DC6CD0;
  uint64_t v1 = *MEMORY[0x1E4F5B888];
  v5[2] = *MEMORY[0x1E4F5B848];
  v5[3] = v1;
  v6[2] = &unk_1F2DC6CE8;
  v6[3] = &unk_1F2DC6D00;
  uint64_t v2 = *MEMORY[0x1E4F5B800];
  v5[4] = *MEMORY[0x1E4F5B8A0];
  void v5[5] = v2;
  v6[4] = &unk_1F2DC6D18;
  v6[5] = &unk_1F2DC6D30;
  uint64_t v3 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v6 forKeys:v5 count:6];
