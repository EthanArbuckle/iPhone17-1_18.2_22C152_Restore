...
- (NSString)wakeAddressString
{
    ...
    && [(HMFWoWLANInfo *)self wakePacketType] == 1)
  {
    ...
    if (v3)
    {
      id v4 = objc_alloc(MEMORY[0x1E4F65470]);
...
LABEL_20:
              ...
              while (*(unsigned __int8 *)(v14 + v16) == v20[v16])
              {
                if (++v16 == 6)
                {
                  ...
                  id v17 = objc_alloc(MEMORY[0x1E4F65470]);
                  v18 = [MEMORY[0x1E4F1C9B8] dataWithBytes:v20 length:6];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid wake address", buf, 0xCu);
    }
    int v20 = 0;
  }
...
- (HMFWoWLANInfo)initWithPrimaryIdentifier:(id)a3 wifiIdentifiers:(id)a4
{
  ...
  {
    int64_t v14 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v19 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Invalid inputs for HMFWoWLANInfo.", buf, 0xCu);
    }
    int v12 = 0;
  }
