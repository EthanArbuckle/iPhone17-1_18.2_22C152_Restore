...
- (void)processTransportSetupResponse:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v31 = 2112;
      v32 = v13;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] The setup transfer succeeded; will use session identifier %@",
        (uint8_t *)&v29,
        0x16u);
    }
    v14 = [v4 parameters];
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      int v29 = 138543362;
      v30 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] DataStream configuration valid; starting stream",
        (uint8_t *)&v29,
        0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v29 = 138543362;
      v30 = v28;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply did not contain a session identifier", (uint8_t *)&v29, 0xCu);
    }
    v27 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
...
- (void)startSetup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v27 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating new DataStream using HAP", buf, 0xCu);
  }
  v7 = (void *)[objc_alloc(MEMORY[0x1E4F5BCF8]) initWithValue:0];
  v8 = (void *)[objc_alloc(MEMORY[0x1E4F5BD08]) initWithValue:1];
  v9 = (void *)[objc_alloc(MEMORY[0x1E4F5BD10]) initWithCommand:v7 transportType:v8 controllerKeySalt:0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v11;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; cannot serialize request (%@)",
        buf,
        0x16u);
    }
...
- (void)_readRequiredTransportCharacteristics
{
  ...
  id v4 = [v3 findCharacteristicWithType:*MEMORY[0x1E4F2D048]];
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v31 = 2112;
      v32 = v15;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@HDS characteristic(s) not found configuration/version (%@/%@)", buf, 0x20u);
    }
...
void __71__HMDDataStreamHAPSetupOperation__readRequiredTransportCharacteristics__block_invoke(uint64_t a1)
{
  ...
  if ([v4 conformsToProtocol:&unk_1F2E297E0])
  {
...
uint64_t __71__HMDDataStreamHAPSetupOperation__readRequiredTransportCharacteristics__block_invoke_2(uint64_t a1, uint64_t a2)
{
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 32));
  id v4 = WeakRetained;
  if (WeakRetained)
  {
    ...
    if ([v5 conformsToProtocol:&unk_1F2E297E0])
    {
      v6 = [v8 delegate];
