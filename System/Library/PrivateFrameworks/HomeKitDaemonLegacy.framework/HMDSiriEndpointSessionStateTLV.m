...
LABEL_21:
  ...
  {
LABEL_24:
    v22 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v26);
    id v8 = 0;
    goto LABEL_27;
  }
...
LABEL_20:
    ...
    if (v30 == 2)
    {
      ...
      {
        id v24 = 0;
        uint64_t v17 = [MEMORY[0x1E4F1C9B8] parsedFromData:v13 error:&v24];
        id v15 = v24;
        unint64_t v16 = v9;
        id v9 = (void *)v17;
LABEL_10:
...
- (NSUUID)hubUUID
{
  ...
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDBytes:v8];
  if (!v6)
  {
    id v6 = objc_msgSend(MEMORY[0x1E4F29128], "hmf_zeroUUID");
  }
  return (NSUUID *)v6;
}
