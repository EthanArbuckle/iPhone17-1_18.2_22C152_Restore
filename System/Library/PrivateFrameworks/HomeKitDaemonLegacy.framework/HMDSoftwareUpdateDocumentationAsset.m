...
- (void)extractionEnteredPassThroughMode
{
  ...
  v3 = (void *)MEMORY[0x1D9452090]([(HMDSoftwareUpdateDocumentationAsset *)self setExtractionEnteredPassThrough:1]);
  v4 = self;
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Unarchive in pass through mode", (uint8_t *)&v7, 0xCu);
  }
}
...
- (void)extractionCompleteAtArchivePath:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Completed unarchiving to path: %@", (uint8_t *)&v9, 0x16u);
  }
}
...
- (void)setExtractionProgress:(double)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2048;
    double v12 = a3 * 100.0;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Unarchive progress: %.1f%%", (uint8_t *)&v9, 0x16u);
  }
}
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didFinishDownloadingToURL:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v51 = 2112;
    v52 = v15;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Finished downloading archived asset to: %@", buf, 0x16u);
  }
  v16 = [v9 response];
  objc_opt_class();
  ...
  if (v18 && ([v18 statusCode] > 399 || objc_msgSend(v18, "statusCode") <= 199))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v53 = 2112;
      id v54 = v18;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset to '%@' due to bad response status: %@", buf, 0x20u);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v53 = 2112;
        id v54 = v29;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to move downloaded asset to '%@' with error: %@. Removing existing assets at that path.", buf, 0x20u);
      }
      ...
      if ((v38 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v53 = 2112;
          id v54 = v25;
          _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove existing asset at url '%@' with error: %@.", buf, 0x20u);
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didWriteData:(int64_t)a5 totalBytesWritten:(int64_t)a6 totalBytesExpectedToWrite:(int64_t)a7
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Download progress: %.1f%%", (uint8_t *)&v18, 0x16u);
  }
}
...
- (void)URLSession:(id)a3 task:(id)a4 didCompleteWithError:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset with error: %@", (uint8_t *)&v15, 0x16u);
    }
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v7;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Finishing unarchive", buf, 0xCu);
    }
...
void __54__HMDSoftwareUpdateDocumentationAsset_cancelUnarchive__block_invoke(uint64_t a1)
{
  ...
  BOOL v2 = (void *)MEMORY[0x1D9452090]();
  id v3 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v17 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling unarchive", buf, 0xCu);
  }
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Failed to remove bundle with error: %@", buf, 0x16u);
    }
  }
  [*(id *)(a1 + 32) setState:2];
}
...
void __53__HMDSoftwareUpdateDocumentationAsset_startUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v7;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting unarchive", buf, 0xCu);
    }
    [*(id *)(a1 + 32) setState:3];
    id v8 = (void *)MEMORY[0x1E4FA8A48];
    ...
    if (v13)
    {
      v14 = (void *)MEMORY[0x1E4F1CA10];
      id v15 = [*(id *)(a1 + 32) archiveURL];
      float v16 = [v14 inputStreamWithURL:v15];

      if (v16)
      {
        __int16 v17 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) setArchivedFileStream:v16]);
        id v18 = *(id *)(a1 + 32);
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v44 = 2112;
          v45 = v13;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Starting extraction using options: %@", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v43 = v39;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to create input stream", buf, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        v45 = v35;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Failed to create validation options for unarchiving with digest: %@", buf, 0x16u);
      }
    }
  }
  else
  {
    if (v6)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v43 = v29;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to unarchive, asset is not downloaded", buf, 0xCu);
    }
  }
}
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_finishDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v8 = 138543362;
    char v9 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Finished download", (uint8_t *)&v8, 0xCu);
  }
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_cancelDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v8 = 138543362;
    char v9 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling download", (uint8_t *)&v8, 0xCu);
  }
  id v6 = [*(id *)(a1 + 32) URLSession];
  [v6 invalidateAndCancel];
...
LABEL_16:
      _os_log_impl(&dword_1D49D5000, v7, v8, v6, (uint8_t *)&v33, 0xCu);
...
LABEL_18:
  ...
  if ((v9 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v33 = 138543362;
      v34 = v28;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Not attempting to download documentation now as we are in a backoff", (uint8_t *)&v33, 0xCu);
    }
    goto LABEL_18;
  }
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v33 = 138543362;
    v34 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Starting download", (uint8_t *)&v33, 0xCu);
  }
  [*(id *)(a1 + 32) setState:1];
  ...
  if (!v14)
  {
    id v15 = [MEMORY[0x1E4F290F0] ephemeralSessionConfiguration];
    float v16 = [*(id *)(a1 + 32) URLSessionFactory];
    uint64_t v17 = *(void *)(a1 + 32);
    id v18 = [MEMORY[0x1E4F28F08] mainQueue];
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v35 = 2112;
      v36 = v23;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Resuming task: %@", (uint8_t *)&v33, 0x16u);
    }
    [v23 resume];
  }
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      int v33 = 138543362;
      v34 = v32;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot download software update from nil url", (uint8_t *)&v33, 0xCu);
    }
  }
}
...
- (BOOL)purgeWithError:(id *)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v13 = 138543362;
    v14 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Purging", (uint8_t *)&v13, 0xCu);
  }
...
- (BOOL)saveWithError:(id *)a3
{
  ...
  if (v7)
  {
    char v9 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:self requiringSecureCoding:1 error:a3];
    if (v9)
    {
...
LABEL_16:
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        char v28 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive asset metadata (write)", buf, 0xCu);
      }
      if (a3)
      {
    ...
    {
      double v21 = (void *)MEMORY[0x1D9452090]();
      uint64_t v22 = self;
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        char v28 = v24;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive asset metadata (encode)", buf, 0xCu);
      }
    }
    BOOL v11 = 0;
    goto LABEL_16;
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v29 = 2112;
    id v30 = v8;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create asset directory with error: %@", buf, 0x16u);
  }
  BOOL v11 = 0;
  if (a3) {
    *a3 = v8;
...
- (void)resetDownloadRetryCount
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Resetting download retry count", (uint8_t *)&v9, 0xCu);
  }
}
...
- (void)increaseDownloadRetryCount
{
  ...
  if (v4 >= [&unk_1F2DC6EC8 count]) {
    uint64_t v5 = [&unk_1F2DC6EC8 count] - 1;
  }
  else {
    uint64_t v5 = [(HMDSoftwareUpdateDocumentationAsset *)self downloadRetryCount];
  }
  id v6 = [&unk_1F2DC6EC8 objectAtIndexedSubscript:v5];
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Increased download retry count to: %lu next retry is at: %@", (uint8_t *)&v15, 0x20u);
  }
}
...
- (HMSoftwareUpdateDocumentation)documentation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v21 = 138543362;
    uint64_t v22 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing documentation", (uint8_t *)&v21, 0xCu);
  }
  uint64_t v7 = [(HMDSoftwareUpdateDocumentationAsset *)v4 state];
  id v8 = (void *)MEMORY[0x1D9452090]();
  if (v7 == 4)
  {
    int v9 = (void *)MEMORY[0x1E4F28B50];
    unint64_t v10 = [(HMDSoftwareUpdateDocumentationAsset *)v4 bundleURL];
    uint64_t v11 = [v9 bundleWithURL:v10];

    if (!v11 || (uint64_t v12 = [objc_alloc(MEMORY[0x1E4F2EB38]) initWithBundle:v11]) == 0)
    {
      int v13 = (void *)MEMORY[0x1D9452090]();
      v14 = v4;
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        int v21 = 138543362;
        uint64_t v22 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to find documentation bundle", (uint8_t *)&v21, 0xCu);
      }
      uint64_t v12 = [objc_alloc(MEMORY[0x1E4F2EB38]) initWithAsset:v14];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      uint64_t v22 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Documentation not cached", (uint8_t *)&v21, 0xCu);
    }
    __int16 v17 = 0;
  }
...
- (HMDSoftwareUpdateDocumentationAsset)initWithDocumentationMetadata:(id)a3
{
  unint64_t v4 = (void *)MEMORY[0x1E4F28EB8];
  id v5 = a3;
  unint64_t v6 = [v4 defaultCenter];
  uint64_t v7 = objc_alloc_init(HMDFileManager);
  id v8 = [(HMDSoftwareUpdateDocumentationAsset *)self initWithDocumentationMetadata:v5 dateWithTimeIntervalSinceNowFactory:&__block_literal_global_163_119234 URLSessionFactory:&__block_literal_global_166_119235 extractorFactory:&__block_literal_global_170 notificationCenter:v6 fileManager:v7];
...
{
  unint64_t v4 = (objc_class *)MEMORY[0x1E4FA8A48];
  id v5 = a3;
  id v6 = a2;
...
{
  return [MEMORY[0x1E4F290E0] sessionWithConfiguration:a2 delegate:a3 delegateQueue:a4];
}

uint64_t __69__HMDSoftwareUpdateDocumentationAsset_initWithDocumentationMetadata___block_invoke()
{
  return objc_msgSend(MEMORY[0x1E4F1C9C8], "dateWithTimeIntervalSinceNow:");
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t74_119260 != -1) {
    dispatch_once(&logCategory__hmf_once_t74_119260, &__block_literal_global_191);
  }
  BOOL v2 = (void *)logCategory__hmf_once_v75_119261;
  return v2;
}

uint64_t __50__HMDSoftwareUpdateDocumentationAsset_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v75_119261;
  logCategory__hmf_once_v75_119261 = v0;
...
+ (id)assetWithURL:(id)a3 fileManager:(id)a4
{
  ...
  if (v6)
  {
    ...
    {
      id v36 = 0;
      unint64_t v10 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v9 error:&v36];
      ...
      if (v10)
      {
        ...
        if (v16 != [v10 state])
        {
          ...
          {
            v32 = HMFGetLogIdentifier();
            id v33 = off_1E6A10398[v16];
            *(_DWORD *)buf = 138543618;
            char v38 = v32;
            __int16 v39 = 2112;
            SEL v40 = v33;
            _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Setting state to: %@", buf, 0x16u);
          }
          [v10 setState:v16];
        }
        id v34 = v10;
      ...
      {
        uint64_t v25 = (void *)MEMORY[0x1D9452090](v12);
        id v26 = a1;
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          SEL v40 = v11;
          _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive software update documentation asset from serialized object data: %@", buf, 0x16u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v39 = 2112;
        SEL v40 = v21;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to find metadata at path: %@", buf, 0x16u);
      }
      unint64_t v10 = 0;
    }
  }
...
+ (NSURL)assetDirectoryURL
{
  if (assetDirectoryURL_onceToken != -1) {
    dispatch_once(&assetDirectoryURL_onceToken, &__block_literal_global_148_119269);
  }
...
{
  id v3 = [MEMORY[0x1E4F65410] defaultCache];
  uint64_t v0 = [v3 URL];
