...
- (void)resetOTAProviderStateForHMDHAPAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ Resetting OTA provider state for %@", (uint8_t *)&v23, 0x20u);
  }
  if ([v4 supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v25 = 2112;
        v26 = v22;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", (uint8_t *)&v23, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      v26 = v17;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", (uint8_t *)&v23, 0x16u);
    }
  }
}
...
- (BOOL)canEstablishConnectionForHMDHAPAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ canEstablishConnectionForHMDHAPAccessory", (uint8_t *)&v25, 0x16u);
  }
  if ([v4 supportsCHIP])
  {
    v10 = [(HMDMatterSoftwareUpdateProviderDelegate *)v6 softwareUpdateProvider];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v23;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", (uint8_t *)&v25, 0x16u);
      }
      char v13 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", (uint8_t *)&v25, 0x16u);
    }
    char v13 = 0;
  }
...
- (void)notifyUpdateRequestedForHMDHAPAccessory:(id)a3 isUserTriggered:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v34 = 2112;
    v35 = v12;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ notifyUpdateRequestedForHMDHAPAccessory, isUserTriggered: %@", (uint8_t *)&v30, 0x20u);
  }
  if ([v6 supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v32 = 2112;
        v33 = v29;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", (uint8_t *)&v30, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v32 = 2112;
      v33 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", (uint8_t *)&v30, 0x16u);
    }
  }
}
...
void __103__HMDMatterSoftwareUpdateProviderDelegate_queryImageWithPairing_requestParams_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (v3)
    {
      ...
      char v7 = [v6 containsObject:&unk_1F2DC9088];
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@%@ Version has changed, request accessory to check back in %f secs", buf, 0x20u);
          }
          uint64_t v15 = *(void *)(a1 + 56);
          id v16 = [*(id *)(a1 + 32) _queryImageResponseWithStatus:&unk_1F2DC90A0 delayedActionTime:&unk_1F2DCB8C8];
          ...
          case 2:
            ...
            if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v118 = 2048;
              uint64_t v119 = 0x405E000000000000;
              _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@%@ Software image is busy downloading. Request accessory to check back in %f secs", buf, 0x20u);
            }
            uint64_t v38 = *(void *)(a1 + 56);
            uint64_t v39 = *(void **)(a1 + 32);
            uint64_t v40 = &unk_1F2DC90A0;
            uint64_t v41 = &unk_1F2DCB8C8;
LABEL_23:
            ...
            if (!v37)
            {
              if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@%@ Received nil asset ID even though status is OnLocalStorage, Error:%@", buf, 0x20u);
              }
              if (!v16)
              {
                id v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:11];
              }
LABEL_44:
              uint64_t v76 = *(void *)(a1 + 56);
              char v47 = [*(id *)(a1 + 32) _queryImageResponseWithStatus:&unk_1F2DC9070 delayedActionTime:0];
            ...
            if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_INFO, "%{public}@%@ A software image is available for accessory with asset = %@", buf, 0x20u);
            }
LABEL_28:
            v112 = v37;
            ...
            if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_INFO, "%{public}@Accessory software version: %@. Software update version: %@", buf, 0x20u);
            }
                ...
                if (v78 <= v80)
                {
                  ...
                  if (os_log_type_enabled(v97, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    __int16 v120 = 2112;
                    v121 = v101;
                    _os_log_impl(&dword_1D49D5000, v97, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory software version (%@) is already at latest available version (%@).", buf, 0x2Au);
...
LABEL_54:
                    ...
                    id v109 = objc_alloc(MEMORY[0x1E4F6A100]);
                    char v47 = [v112 localURL];
                    v108 = [v47 path];
                    v90 = [v112 assetVersionNumber];
                    v91 = [v112 assetVersion];
                    [&unk_1F2DC9058 unsignedIntValue];
                    v92 = HMFRandomDataWithLength();
                    v93 = [NSNumber numberWithBool:v89];
                    v94 = (void *)[v109 initWithStatus:&unk_1F2DC9088 delayedActionTime:&unk_1F2DCB8B8 imageURI:v108 softwareVersion:v90 softwareVersionString:v91 updateToken:v92 userConsentNeeded:v93 metadataForRequestor:0];
                  ...
                  if (v82)
                  {
                    if (v86)
                    {
                      ...
                      *(_DWORD *)buf = 138543618;
                      ...
                      __int16 v116 = 2112;
                      v117 = v88;
                      _os_log_impl(&dword_1D49D5000, v85, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented yet but requestor can consent. Delegating consent to requestor", buf, 0x16u);
                    }
                    goto LABEL_54;
                  }
                  if (v86)
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    __int16 v118 = 2048;
                    uint64_t v119 = 0x405E000000000000;
                    _os_log_impl(&dword_1D49D5000, v85, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented to firmware update and requestor cannot consent. Request accessory to check back in %f secs", buf, 0x20u);
                  }
                  uint64_t v102 = *(void *)(a1 + 56);
                  v103 = *(void **)(a1 + 32);
                  v104 = &unk_1F2DC90A0;
...
LABEL_45:
              ...
              if (v70 != 5)
              {
                if (v71)
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v116 = 2112;
                  v117 = v73;
                  _os_log_impl(&dword_1D49D5000, v64, OS_LOG_TYPE_INFO, "%{public}@%@ User consent pending.", buf, 0x16u);
                }
                int v65 = 0;
                goto LABEL_48;
              }
            ...
            _os_log_impl(&dword_1D49D5000, v64, OS_LOG_TYPE_INFO, v68, buf, 0x16u);
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@%@ Transfer protocols not supported in request: %@", buf, 0x20u);
      }
      uint64_t v35 = *(void *)(a1 + 56);
      id v16 = [*(id *)(a1 + 32) _queryImageResponseWithStatus:&unk_1F2DC90B8 delayedActionTime:0];
      uint64_t v36 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:5];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v115 = v26;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", buf, 0xCu);
      }
      uint64_t v27 = *(void *)(a1 + 56);
      id v16 = [*(id *)(a1 + 32) _queryImageResponseWithStatus:&unk_1F2DC9070 delayedActionTime:0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v116 = 2112;
      v117 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot proceed with software update. Accessory not found for pairing : %@", buf, 0x16u);
    }
    uint64_t v22 = *(void *)(a1 + 56);
    BOOL v4 = [*(id *)(a1 + 32) _queryImageResponseWithStatus:&unk_1F2DC9070 delayedActionTime:0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v30 = 2112;
      v31 = v10;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@%@ Firmware version from uarpAccessory (%@) doesn't match accessory version (%@)", buf, 0x2Au);
...
- (id)_queryImageResponseWithStatus:(id)a3 delayedActionTime:(id)a4
{
  id v5 = (objc_class *)MEMORY[0x1E4F6A100];
  id v6 = a4;
  id v7 = a3;
...
void __111__HMDMatterSoftwareUpdateProviderDelegate_notifyCheckFirmwareUpdateSessionWithPairing_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", (uint8_t *)&v19, 0x16u);
    }
    uint64_t v12 = *(void *)(a1 + 48);
    BOOL v4 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:2];
...
LABEL_7:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    int v19 = 138543362;
    uint64_t v20 = v16;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", (uint8_t *)&v19, 0xCu);
  }
...
void __98__HMDMatterSoftwareUpdateProviderDelegate_notifyUpdateWithPairing_params_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v38 = 2112;
      uint64_t v39 = v17;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", (uint8_t *)&v36, 0x16u);
    }
  ...
  if (([v2 supportsCHIP] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v38 = 2112;
      uint64_t v39 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory has updated software image, but Accessory does not support Matter", (uint8_t *)&v36, 0x16u);
    }
    uint64_t v18 = *(void *)(a1 + 56);
    id v19 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v20 = 5;
LABEL_13:
  ...
  int v5 = [v4 isEqualToNumber:&unk_1F2DC90A0];
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v38 = 2112;
      uint64_t v39 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory update timed out", (uint8_t *)&v36, 0x16u);
    }
    id v12 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F64ED0] code:13 userInfo:0];
  }
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v40 = 2112;
      uint64_t v41 = v28;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ Accessory has updated software image. New version: %@", (uint8_t *)&v36, 0x20u);
    }
    id v12 = 0;
  }
...
void __104__HMDMatterSoftwareUpdateProviderDelegate_applyUpdateWithPairing_requestParams_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@%@ Inform accessory to proceed with applying the software image", (uint8_t *)&v15, 0x16u);
    }
    uint64_t v9 = *(void *)(a1 + 48);
    id v10 = (void *)[objc_alloc(MEMORY[0x1E4F6A0F8]) initWithAction:&unk_1F2DC9088 delayedActionTime:&unk_1F2DCB8B8];
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v12;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Accessory should not proceed with applying the software image. Accessory not found for pairing : %@", (uint8_t *)&v15, 0x16u);
    }
    uint64_t v13 = *(void *)(a1 + 48);
    id v10 = (void *)[objc_alloc(MEMORY[0x1E4F6A0F8]) initWithAction:&unk_1F2DC9070 delayedActionTime:&unk_1F2DCB8B8];
...
- (void)configureWithSoftwareUpdateProvider:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      id v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring with matter software update provider", (uint8_t *)&v13, 0xCu);
    }
    [v4 setDelegate:v8];
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", (uint8_t *)&v13, 0x16u);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t34 != -1) {
    dispatch_once(&logCategory__hmf_once_t34, &__block_literal_global_138030);
  }
