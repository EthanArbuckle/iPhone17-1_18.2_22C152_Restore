  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v71 = 2112;
      id v72 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Received event for: %@", buf, 0x16u);
    }
    ...
    v13 = [MEMORY[0x1E4F2E7A0] decodeTopic:v6];
    v14 = [v13 asAccessoryTopic];
    v15 = v14;
    if (v14)
    {
      uint64_t v16 = [v14 accessoryEventTopicSuffixID];
      if (v16 == *MEMORY[0x1E4F2C360])
      {
        id v17 = objc_alloc(MEMORY[0x1E4F2E518]);
        v18 = [v5 encodedData];
...
LABEL_32:
      ...
      if (v28 == *MEMORY[0x1E4F2C398])
      {
        id v29 = objc_alloc(MEMORY[0x1E4F2EA60]);
        v30 = [v5 encodedData];
          ...
          else
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v71 = 2112;
              id v72 = context;
              _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory public pairing identity event: %@ due to invalid data", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v71 = 2112;
            id v72 = v21;
            _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory public pairing identity event: %@ due to no delegate", buf, 0x16u);
          }
        }
...
void __71__HMDPrimaryResidentCapabilitiesAggregator__processEventIfNewer_topic___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  if (v3) {
    v4 = (void *)[objc_alloc(MEMORY[0x1E4F2E518]) initWithProtoData:v3];
  }
  else {
    v4 = 0;
  }
  if (([*(id *)(a1 + 32) isEqual:v4] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updating on receiving different accessory capabilities %@.", (uint8_t *)&v16, 0x16u);
    }
...
void __71__HMDPrimaryResidentCapabilitiesAggregator__processEventIfNewer_topic___block_invoke_22(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  if (v3) {
    v4 = (void *)[objc_alloc(MEMORY[0x1E4F2EA60]) initWithProtoData:v3];
  }
  else {
    v4 = 0;
  }
  if (([*(id *)(a1 + 32) isEqual:v4] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updating on receiving different resident capabilities %@.", (uint8_t *)&v16, 0x16u);
    }
    uint64_t v11 = *(void *)(a1 + 32);
    uint64_t v10 = *(void *)(a1 + 40);
    id v12 = *(void **)(a1 + 48);
...
- (void)processSoftwareVersionEvent:(void *)a3 accessoryTopic:
{
  ...
  if (WeakRetained)
  {
    id v8 = objc_alloc(MEMORY[0x1E4F2E5C0]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v23 = 2112;
        id v24 = v5;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory software version event: %@ due to invalid data", (uint8_t *)&v21, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v5;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to process accessory software version event: %@ due to no delegate", (uint8_t *)&v21, 0x16u);
    }
  }
}
...
void __99__HMDPrimaryResidentCapabilitiesAggregator_handlePrimaryResidentIsCurrentDeviceChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    uint64_t v19 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Primary resident status changed to %@", (uint8_t *)&v16, 0x16u);
  }
  uint64_t v11 = *(void *)(a1 + 32);
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      else
      {
        ...
        if (v13)
        {
          ...
          [v15 unregisterConsumer:v12 completion:&__block_literal_global_19_46089];
        }
      }
    }
  }
      ...
      if (*(unsigned char *)(a1 + 8))
      {
        ...
        if (WeakRetained)
        {
          ...
          if (v39)
          {
            ...
            uint64_t v36 = *MEMORY[0x1E4F2C360];
            uint64_t v35 = *MEMORY[0x1E4F2C398];
            uint64_t v34 = *MEMORY[0x1E4F2C390];
            uint64_t v33 = *MEMORY[0x1E4F2C370];
            uint64_t v32 = *MEMORY[0x1E4F2C3B0];
            do
            {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(void *)&buf[14] = v30;
            _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Subscribing for accessories: %@", buf, 0x16u);
          }
          uint64_t v5 = v29;
          ...
          id v47 = v30;
          id v28 = v38;
          [v27 changeRegistrationsForConsumer:v24 topicFilterAdditions:v28 topicFilterRemovals:MEMORY[0x1E4F1CBF0] completion:v44];
        }
      }
    }
  }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Error subscribing to capabilities for accessories: %@, error: %@", buf, 0x20u);
    }
  }
  else
  {
...
- (id)publicPairingIdentityForAccessory:(id)a3 ifDifferentFrom:(id)a4
{
  ...
  if (self)
  {
    ...
    if (WeakRetained)
    {
      id v9 = [MEMORY[0x1E4F2E580] topicFromSuffixID:*MEMORY[0x1E4F2C390] homeUUID:self->_homeUUID accessoryUUID:v6];
      uint64_t v10 = [WeakRetained eventStoreReadHandle];
      uint64_t v11 = [v10 lastEventForTopic:v9];

      if (v11)
      {
        id v12 = objc_alloc(MEMORY[0x1E4F65508]);
...
- (id)residentCapabilitiesForAccessory:(id)a3 ifDifferentFrom:(id)a4
{
  ...
  {
    id v9 = WeakRetained;
    uint64_t v10 = [MEMORY[0x1E4F2E580] topicFromSuffixID:*MEMORY[0x1E4F2C398] homeUUID:self->_homeUUID accessoryUUID:v6];
    uint64_t v11 = [v9 eventStoreReadHandle];
    id v12 = [v11 lastEventForTopic:v10];

    if (v12)
    {
      long long v13 = (void *)[objc_alloc(MEMORY[0x1E4F2EA60]) initWithProtoData:v7];
      id v14 = objc_alloc(MEMORY[0x1E4F2EA60]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      int v24 = 138543362;
      __int16 v25 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident capabilities due to nil datasource", (uint8_t *)&v24, 0xCu);
    }
    id v9 = 0;
    id v17 = 0;
  }
...
- (id)accessoryCapabilitiesForAccessory:(id)a3 ifDifferentFrom:(id)a4
{
  ...
  {
    id v9 = WeakRetained;
    uint64_t v10 = [MEMORY[0x1E4F2E580] topicFromSuffixID:*MEMORY[0x1E4F2C360] homeUUID:self->_homeUUID accessoryUUID:v6];
    uint64_t v11 = [v9 eventStoreReadHandle];
    id v12 = [v11 lastEventForTopic:v10];

    if (v12)
    {
      long long v13 = (void *)[objc_alloc(MEMORY[0x1E4F2E518]) initWithProtoData:v7];
      id v14 = objc_alloc(MEMORY[0x1E4F2E518]);
      long long v15 = [v12 encodedData];
      char v16 = (void *)[v14 initWithProtoData:v15];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      int v24 = 138543362;
      __int16 v25 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot create accessory capabilities due to nil datasource", (uint8_t *)&v24, 0xCu);
    }
    id v9 = 0;
    id v17 = 0;
  }
  ...
  if (v1)
  {
    ...
    if (WeakRetained)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v21 = 2112;
        v22 = v9;
        _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Starting capabilities aggregator, primary resident: %@", (uint8_t *)&v19, 0x16u);
      }
...
- (HMDPrimaryResidentCapabilitiesAggregator)initWithDataSource:(id)a3 delegate:(id)a4 queue:(id)a5 notificationCenter:(id)a6 homeUUID:(id)a7 accessories:(id)a8
{
  ...
  if (v19)
  {
    ...
    uint64_t v21 = [MEMORY[0x1E4F1CA80] setWithArray:v18];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_46114 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_46114, &__block_literal_global_46115);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_46116;
  return v2;
}
...
uint64_t __55__HMDPrimaryResidentCapabilitiesAggregator_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_46116;
  logCategory__hmf_once_v1_46116 = v0;
