...
- (HMDSetupEndPointWrite)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v21 = [[HMDEndPointAddress alloc] initWithIPAddress:&stru_1F2C9F1A8 isIPv6Address:0 videoRTPPort:&unk_1F2DC73A8 audioRTPPort:&unk_1F2DC73A8];
    address = v5->_address;
    v5->_address = v21;
  }
  return v5;
...
- (BOOL)_parseFromTLVDataOnFailure
{
  ...
  v3 = [MEMORY[0x1E4F5BE78] wrappertlv:1 name:@"kSetupEndPoint__SessionIdentifier"];
  v9[0] = v3;
...
- (BOOL)_parseFromTLVDataImpl
{
  ...
  v3 = [MEMORY[0x1E4F5BE78] wrappertlv:1 name:@"kSetupEndPoint__SessionIdentifier"];
  id v4 = [MEMORY[0x1E4F5BD28] wrappertlv:3 name:@"kSetupEndPoint__ControllerAddress"];
  BOOL v5 = [MEMORY[0x1E4F5BD28] wrappertlv:4 name:@"kSetupEndPoint__SRTPVideoParameters"];
  id v6 = [MEMORY[0x1E4F5BD28] wrappertlv:5 name:@"kSetupEndPoint__SRTPAudioParameters"];
  v32[0] = v3;
  v32[1] = v4;
  v32[2] = v5;
  v32[3] = v6;
  id v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v32 count:4];
