  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v33 = 2112;
      v34 = v15;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Loaded credentials for account %@, %@", buf, 0x20u);
    }
    v16 = [MEMORY[0x1E4F4F010] currentDevice];
    [v16 setLinkType:3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_77992 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_77992, &__block_literal_global_77993);
  }
  v2 = (void *)logCategory__hmf_once_v2_77994;
  return v2;
}
...
uint64_t __61__HMDRemoteLoginInitiatorCompanionAuthentication_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_77994;
  logCategory__hmf_once_v2_77994 = v0;
