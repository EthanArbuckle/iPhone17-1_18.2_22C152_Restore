...
LABEL_7:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    v26 = v18;
    _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Dropping incoming message from unsupported device: %@", buf, 0x16u);
  }
...
LABEL_15:
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v24 = 2112;
      __int16 v25 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message, the device, %@, is not currently connected", (uint8_t *)&v22, 0x16u);
    }
    goto LABEL_15;
  }
  v10 = [v7 device];
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v24 = 2112;
      __int16 v25 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message, the device, %@, is not supported", (uint8_t *)&v22, 0x16u);
    }
  }
  ...
  if (v8)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v23 = 2112;
        __int16 v24 = v10;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Replacing device destination, %@, with device: %@", (uint8_t *)&v19, 0x20u);
      }
...
LABEL_10:
      ...
      uint64_t v15 = [MEMORY[0x1E4F65548] productInfo];
...
LABEL_11:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v21 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@A proxy service is required", buf, 0xCu);
  }
  uint64_t v14 = 0;
LABEL_12:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_175668 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_175668, &__block_literal_global_175669);
  }
  v2 = (void *)logCategory__hmf_once_v4_175670;
  return v2;
}
...
uint64_t __42__HMDIDSProxyMessageTransport_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v4_175670;
  logCategory__hmf_once_v4_175670 = v0;
