  ...
  if ([Property containsObject:v6])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v6;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Removing %@ from retired stream snapshot captures", buf, 0x16u);
    }
    if (self) {
  ...
  if ([v17 containsObject:v6])
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v6;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Removing %@ from stream snapshot captures", buf, 0x16u);
    }
    if (self) {
  ...
  if (self)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotHandler:didGetLastSnapshot", buf, 0xCu);
    }
    long long v38 = 0u;
    long long v39 = 0u;
    long long v36 = 0u;
...
- (void)_callDidGetNewSnapshot:(void *)a1
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v23 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotHandler:didGetNewSnapshot", buf, 0xCu);
    }
    long long v19 = 0u;
    long long v20 = 0u;
    long long v17 = 0u;
...
void __46__HMDCameraStreamSnapshotHandler_getSnapshot___block_invoke(uint64_t a1, const char *a2)
{
  ...
  {
    id v4 = (void *)MEMORY[0x1D9452090](0);
    id v5 = *(id *)(a1 + 32);
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      SEL v10 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@There is no valid snapshot capture object", buf, 0xCu);
    }
        ...
        if (v10 == v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v32 = 2112;
            uint64_t v33 = v9;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Removing %@", buf, 0x16u);
          }
          id v17 = *(id *)(a1 + 32);
          if (v17) {
          ...
          if ([*(id *)(a1 + 40) state] == 2)
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v32 = 2112;
              uint64_t v33 = v9;
              _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Adding %@ to retired-snapshot-captures", buf, 0x16u);
            }
            id v23 = *(id *)(a1 + 32);
            if (v23) {
...
void __58__HMDCameraStreamSnapshotHandler_addVideoStreamInterface___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    v21 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding video stream interface %@", (uint8_t *)&v18, 0x16u);
  }
...
void __60__HMDCameraStreamSnapshotHandler_callStreamSetupInProgress___block_invoke(uint64_t a1, const char *a2)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      SEL v21 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotHandler:didChangeStreamSetupInProgress", buf, 0xCu);
    }
    long long v18 = 0u;
    long long v19 = 0u;
    long long v16 = 0u;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_38469 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_38469, &__block_literal_global_38470);
  }
  v2 = (void *)logCategory__hmf_once_v1_38471;
  return v2;
}
...
uint64_t __45__HMDCameraStreamSnapshotHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_38471;
  logCategory__hmf_once_v1_38471 = v0;
