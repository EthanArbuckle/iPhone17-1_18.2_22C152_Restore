...
LABEL_11:
  ...
  v60[0] = v40;
  v42 = [MEMORY[0x1E4F1C978] arrayWithObjects:v60 count:1];
  ...
  [v46 setObject:v47 forKeyedSubscript:*MEMORY[0x1E4F2E308]];
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v24 = 2112;
      id v25 = v10;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to determined localized string for format key %@ and valid format specifiers %@: %@", buf, 0x2Au);
    }
