...
- (unint64_t)numCriticalSensorAccessories
{
  v3 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE00], *MEMORY[0x1E4F2DDF8], *MEMORY[0x1E4F2DEB8], 0);
...
- (unint64_t)numSecurityClassAccessories
{
  v3 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE18], *MEMORY[0x1E4F2DE38], *MEMORY[0x1E4F2DE88], *MEMORY[0x1E4F2DEB0], *MEMORY[0x1E4F2DF28], 0);
  unint64_t v4 = [(HMDAccessoryCount *)self numHAPAccessoriesWithAnyServiceWithTypes:v3];
