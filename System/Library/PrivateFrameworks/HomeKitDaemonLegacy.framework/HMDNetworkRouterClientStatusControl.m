...
- (void)setClientStatusIdentifierList:(id)a3;
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_clientStatusIdentifierList, 0);
...
- (HMDNetworkRouterClientStatusIdentifierList)clientStatusIdentifierList
{
  return self->_clientStatusIdentifierList;
}
...
- (BOOL)isEqual:(id)a3
{
  v5 = (HMDNetworkRouterClientStatusControl *)a3;
  if (self == v5)
  {
    char v10 = 1;
  }
...
LABEL_12:
  ...
  v12 = [(HMDNetworkRouterClientStatusControl *)self clientStatusIdentifierList];
  id v18 = 0;
...
LABEL_25:
  self = v22;
LABEL_26:
  -[HMDNetworkRouterClientStatusControl setOperation:](self, "setOperation:", v11, v22);
...
- (HMDNetworkRouterClientStatusControl)initWithOperation:(id)a3 clientStatusIdentifierList:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)HMDNetworkRouterClientStatusControl;
  uint64_t v9 = [(HMDNetworkRouterClientStatusControl *)&v12 init];
  int v10 = v9;
  if (v9)
  {
    objc_storeStrong((id *)&v9->_operation, a3);
    objc_storeStrong((id *)&v10->_clientStatusIdentifierList, a4);
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)HMDNetworkRouterClientStatusControl;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDNetworkRouterClientStatusControl);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDNetworkRouterClientStatusControl *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
