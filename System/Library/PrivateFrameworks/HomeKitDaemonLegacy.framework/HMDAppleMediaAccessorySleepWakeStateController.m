...
LABEL_12:
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, v14, buf, 0xCu);
      }
    }
    else if (v12)
    {
  ...
  if (([v4 isRemote] & 1) != 0 || objc_msgSend(v4, "isSecureRemote"))
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay remote fetch sleep wake message twice", buf, 0xCu);
    }
    v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
void __84__HMDAppleMediaAccessorySleepWakeStateController__handleFetchSleepWakeStateMessage___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  {
    uint64_t v7 = *MEMORY[0x1E4F2D150];
...
- (void)fetchSleepWakeStateWithCompletion:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v9;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Fetching sleep wake state with current fetch future: %@", buf, 0x16u);
    }
    if (v9)
    {
    ...
    else
    {
      ...
      v22 = [MEMORY[0x1E4F654B0] messageWithName:*MEMORY[0x1E4F2D158] destination:v21 payload:0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to get current device from AppleMediaAccessorySleepWakeStateControllerDataSource", buf, 0xCu);
    }
    v9 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
  ...
  *(void *)(v9 + 16) = 0;
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v5;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Fetching sleep wake state failed with error: %@", (uint8_t *)&v21, 0x16u);
    }
    [v8 finishWithError:v5];
  }
  else
  {
    v15 = objc_msgSend(v6, "hmf_numberForKey:", *MEMORY[0x1E4F2D150]);
    if (v15)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v23 = 2112;
        id v24 = 0;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Fetching sleep wake state failed, missing sleep wake state key: %@", (uint8_t *)&v21, 0x16u);
      }
      v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
...
- (void)configureWithHome:(id)a3 messageDispatcher:(id)a4 workQueue:(id)a5
{
  ...
  if (self)
  {
    ...
    objc_msgSend(objc_getProperty(self, v17, 40, 1), "registerForMessage:receiver:policies:selector:", *MEMORY[0x1E4F2D158], self, v14, sel__handleFetchSleepWakeStateMessage_);
  }
}
