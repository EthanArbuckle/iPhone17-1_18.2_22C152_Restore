...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BDE8] wrappertlv:1 name:@"kVideoCodecConfiguration__CodecType"];
  id v4 = [MEMORY[0x1E4F5BD28] wrappertlv:2 name:@"kVideoCodecConfiguration__CodecParameters"];
  v5 = [MEMORY[0x1E4F5BC58] wrappertlv:3 name:@"kVideoCodecConfiguration__Attributes" objectCreator:&__block_literal_global_296];
  v27[0] = v3;
  v27[1] = v4;
  v27[2] = v5;
