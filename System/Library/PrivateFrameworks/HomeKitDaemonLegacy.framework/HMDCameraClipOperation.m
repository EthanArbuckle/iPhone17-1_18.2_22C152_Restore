...
- (NSArray)attributeDescriptions
{
  ...
  v23[4] = v18;
  v19 = [MEMORY[0x1E4F1C978] arrayWithObjects:v23 count:5];
...
- (id)updateClipModel:(id)a3
{
  ...
  if (v5)
  {
    id v6 = objc_alloc(MEMORY[0x1E4F69EF0]);
    ...
    v10 = [MEMORY[0x1E4F1CAD0] setWithObject:v4];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      v23 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Aborting save of clip model because no video streaming asset was found: %@", (uint8_t *)&v20, 0x16u);
    }
    v17 = (void *)MEMORY[0x1E4F7A0D8];
    v18 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:15];
...
- (id)fetchClipModel
{
  ...
  if (v5)
  {
    uint64_t v7 = [MEMORY[0x1E4F7A0D8] futureWithResult:v5];
LABEL_7:
    v14 = (void *)v7;
    goto LABEL_8;
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v22 = 2112;
    id v23 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch local clip model with ID %@: %@", buf, 0x20u);
  }
  v13 = (void *)MEMORY[0x1E4F7A0D8];
  if (v6)
  {
    uint64_t v7 = [MEMORY[0x1E4F7A0D8] futureWithError:v6];
    goto LABEL_7;
  }
  v16 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:2];
...
- (void)cancelWithError:(id)a3
{
  ...
  double v5 = (void *)MEMORY[0x1D9452090]([(HMDCameraClipOperation *)self _markEndDateAndSubmitUploadOperationEvent]);
  id v6 = self;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v13 = 2048;
    uint64_t v14 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Operation canceled after %.2fs", buf, 0x16u);
  }
}
...
- (void)finish
{
  ...
  id v3 = (void *)MEMORY[0x1D9452090]([(HMDCameraClipOperation *)self _markEndDateAndSubmitUploadOperationEvent]);
  id v4 = self;
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v11 = 2048;
    uint64_t v12 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Operation finished in %.2fs", buf, 0x16u);
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_32161 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_32161, &__block_literal_global_32162);
  }
  v2 = (void *)logCategory__hmf_once_v5_32163;
  return v2;
}
...
uint64_t __37__HMDCameraClipOperation_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_32163;
  logCategory__hmf_once_v5_32163 = v0;
