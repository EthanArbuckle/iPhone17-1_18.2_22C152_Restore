...
LABEL_7:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v70 = 2112;
    v71 = v14;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating storage fabric ID from %@ to %@", (uint8_t *)&v66, 0x20u);
  }
...
LABEL_8:
  ...
  if ([v17 containsObject:@"chipLastNodeID"])
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v70 = 2112;
      v71 = v26;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating storage last node ID from %@ to %@", (uint8_t *)&v66, 0x20u);
    }
...
LABEL_14:
  ...
  if ([v27 containsObject:@"chipRootCertificate"])
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v70 = 2112;
      v71 = v36;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating storage root certificate from %@ to %@", (uint8_t *)&v66, 0x20u);
    }
...
LABEL_20:
  ...
  if ([v37 containsObject:@"chipOperationalCertificate"])
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v70 = 2112;
      v71 = v46;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating storage operational certificate from %@ to %@", (uint8_t *)&v66, 0x20u);
    }
...
LABEL_26:
  ...
  if ([v47 containsObject:@"chipIntermediateCertificate"])
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v70 = 2112;
      v71 = v56;
      _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Updating storage intermediate certificate from %@ to %@", (uint8_t *)&v66, 0x20u);
    }
...
LABEL_37:
  ...
  if ((v60 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
    {
      ...
      int v66 = 138543362;
      v67 = v64;
      _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating storage key-value store", (uint8_t *)&v66, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_10019 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_10019, &__block_literal_global_10020);
  }
  v2 = (void *)logCategory__hmf_once_v8_10021;
  return v2;
}

uint64_t __33__HMDCHIPHomeStorage_logCategory__block_invoke()
{
  logCategory__hmf_once_v8_10021 = HMFCreateOSLogHandle();
