...
- (id)unarchiveLegacyFlags
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v30;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Legacy flags missing data", buf, 0xCu);
      }
      id v22 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@No legacy event flags found", buf, 0xCu);
    }
    id v22 = 0;
  }
...
- (id)unarchiveFlags
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v23 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Loading legacy flags", buf, 0xCu);
  }
...
LABEL_5:
  ...
  v15 = (void *)MEMORY[0x1D9452090](v10, v11, v12, v13, v14);
  uint64_t v16 = self;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    v25 = v3;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Final restored flags: %@", buf, 0x16u);
  }
  return v3;
}
...
- (id)flagForSpecifier:(id)a3 periodicity:(int64_t)a4
{
  ...
  if (!v9)
  {
    ...
    if ((v11 & 1) == 0)
    {
      ...
      id v16 = [v14 exceptionWithName:*MEMORY[0x1E4F1C3C8] reason:v15 userInfo:0];
...
+ (NSSet)allowedSpecifierClasses
{
  if (allowedSpecifierClasses__hmf_once_t4 != -1) {
    dispatch_once(&allowedSpecifierClasses__hmf_once_t4, &__block_literal_global_61952);
  }
