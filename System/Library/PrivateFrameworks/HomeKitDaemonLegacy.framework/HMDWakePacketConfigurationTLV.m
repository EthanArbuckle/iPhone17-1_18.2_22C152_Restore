...
LABEL_22:
  ...
  v22 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v37);
  id v8 = 0;
LABEL_32:
  TLV8BufferFree();
...
LABEL_24:
  ...
  else
  {
    ...
    while (1)
    {
      ...
      if (!v39)
      {
        uint64_t v25 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F64ED0] code:3 userInfo:0];
      ...
      switch(v40)
      {
        ...
        case 2:
          v14 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytesNoCopy:length:freeWhenDone:");
          id v35 = v9;
          uint64_t v18 = [MEMORY[0x1E4F5BE68] parsedFromData:v14 error:&v35];
          id v16 = v35;
        ...
        case 3:
          ...
          id v33 = 0;
          uint64_t v19 = [MEMORY[0x1E4F1C9B8] parsedFromData:v14 error:&v33];
          id v16 = v33;
          uint64_t v17 = v29;
        ...
        case 5:
          ...
          id v30 = 0;
          uint64_t v21 = [MEMORY[0x1E4F1C9B8] parsedFromData:v14 error:&v30];
          id v16 = v30;
          uint64_t v17 = v28;
          int v28 = (void *)v21;
          break;
