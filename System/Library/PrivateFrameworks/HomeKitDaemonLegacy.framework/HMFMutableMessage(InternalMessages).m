...
+ (id)internalMessageWithName:()InternalMessages destination:messagePayload:
{
  v0 = objc_msgSend(MEMORY[0x1E4F654B0], "messageWithName:destination:payload:");
  [v0 setUserInfoValue:MEMORY[0x1E4F1CC38] forKey:@"internal"];
  return v0;
}

+ (id)internalMessageWithName:()InternalMessages messagePayload:responseHandler:
{
  v0 = objc_msgSend(MEMORY[0x1E4F654B0], "messageWithName:messagePayload:responseHandler:");
  [v0 setUserInfoValue:MEMORY[0x1E4F1CC38] forKey:@"internal"];
  return v0;
}
