...
void __56__HMDHAP2Storage_registerPairedAccessoryWithIdentifier___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F5BD38]) initWithDeviceIDString:*(void *)(a1 + 32)];
  if (v2)
  {
  ...
  {
    hap2LogInitialize();
    v6 = *MEMORY[0x1E4F5BEB8];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5BEB8], OS_LOG_TYPE_DEBUG))
    {
      uint64_t v7 = *(void *)(a1 + 32);
      int v8 = 138412290;
      uint64_t v9 = v7;
      _os_log_debug_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "Ignoring invalid registered device ID: %@", (uint8_t *)&v8, 0xCu);
    }
  }
}
...
void __54__HMDHAP2Storage_removeCacheForIdentifier_completion___block_invoke(void *a1)
{
  ...
  {
    hap2LogInitialize();
    id v6 = *MEMORY[0x1E4F5BEB0];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5BEB0], OS_LOG_TYPE_ERROR))
    {
      uint64_t v8 = a1[5];
      int v9 = 138412290;
      uint64_t v10 = v8;
      _os_log_error_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "Storage: Unable to remove cache for %@", (uint8_t *)&v9, 0xCu);
    }
    uint64_t v7 = a1[6];
...
void __57__HMDHAP2Storage_saveCacheForIdentifier_data_completion___block_invoke(void *a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5BEB0], OS_LOG_TYPE_ERROR))
    {
      ...
      int v9 = 138412290;
      uint64_t v10 = v8;
      _os_log_error_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "Storage: Unable to save cache for %@", (uint8_t *)&v9, 0xCu);
    }
    uint64_t v7 = a1[7];
    id v4 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    id v5 = *(void (**)(void))(v7 + 16);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5BEB0], OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412290;
      uint64_t v12 = v8;
      _os_log_error_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "Storage: Unable to retrieve cache for %@", buf, 0xCu);
    }
...
void __53__HMDHAP2Storage_fetchCacheForIdentifier_completion___block_invoke_16(uint64_t a1, void *a2)
{
  ...
  {
    uint64_t v3 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
  }
...
void __53__HMDHAP2Storage_fetchKeysForIdentifiers_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v7)
  {
    if (!v13)
    {
      id v11 = [MEMORY[0x1E4F28C58] hapErrorWithCode:1];
...
{
  uint64_t v11 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)[objc_alloc(MEMORY[0x1E4F5BD38]) initWithDeviceIDString:*(void *)(a1 + 32)];
  if (v2)
  {
    uint64_t v3 = *(void *)(a1 + 40);
    if (v3) {
    ...
    [v4 removeObject:v2];
    id v5 = *(void **)(a1 + 40);
    id v6 = [MEMORY[0x1E4F1CAD0] setWithObject:v2];
    [v5 _removeKeysForIdentifiers:v6 completion:&__block_literal_global_291];
  }
  else
  {
    hap2LogInitialize();
    id v7 = *MEMORY[0x1E4F5BEB8];
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5BEB8], OS_LOG_TYPE_DEBUG))
    {
      uint64_t v8 = *(void *)(a1 + 32);
      int v9 = 138412290;
      uint64_t v10 = v8;
      _os_log_debug_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "Ignoring invalid deregistered device ID: %@", (uint8_t *)&v9, 0xCu);
    }
  }
}
...
void __58__HMDHAP2Storage_deregisterPairedAccessoryWithIdentifier___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F5BEB8], OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v9 = 2112;
    id v10 = v5;
    _os_log_debug_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEBUG, "remove key id=%@ error=%@", (uint8_t *)&v7, 0x16u);
  }
}
