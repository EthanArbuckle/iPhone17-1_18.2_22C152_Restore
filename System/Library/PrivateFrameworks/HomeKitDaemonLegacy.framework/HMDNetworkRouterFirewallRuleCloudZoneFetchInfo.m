...
- (HMDNetworkRouterFirewallRuleCloudZoneFetchInfo)initWithOptions:(id)a3 changeToken:(id)a4 promise:(id)a5 database:(id)a6 useAnonymousRequests:(BOOL)a7 interestedRecordIDs:(id)a8 mirrorInput:(id)a9
{
  ...
  id v28 = a8;
  id v27 = a9;
  v16 = (objc_class *)MEMORY[0x1E4F653F0];
  id v17 = a6;
  id v18 = a5;
  id v19 = a3;
  id v20 = [v16 alloc];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_140297 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_140297, &__block_literal_global_140298);
  }
  v2 = (void *)logCategory__hmf_once_v1_140299;
  return v2;
}
...
uint64_t __61__HMDNetworkRouterFirewallRuleCloudZoneFetchInfo_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_140299;
  logCategory__hmf_once_v1_140299 = v0;
