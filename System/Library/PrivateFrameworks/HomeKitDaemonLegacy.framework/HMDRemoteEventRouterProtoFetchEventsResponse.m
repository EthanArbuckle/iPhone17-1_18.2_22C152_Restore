  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMDRemoteEventRouterProtoFetchEventsResponse addChangedEvents:](self, "addChangedEvents:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
...
- (void)copyTo:(id)a3
{
  ...
  if ([(HMDRemoteEventRouterProtoFetchEventsResponse *)self changedEventsCount])
  {
    ...
    unint64_t v4 = [(HMDRemoteEventRouterProtoFetchEventsResponse *)self changedEventsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HMDRemoteEventRouterProtoFetchEventsResponse *)self changedEventsAtIndex:i];
...
LABEL_14:
      ...
      if ((v11 >> 3) == 2)
      {
        id v18 = objc_alloc_init(MEMORY[0x1E4F69F80]);
        [(HMDRemoteEventRouterProtoFetchEventsResponse *)self addChangedEvents:v18];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_changedEvents, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    ...
    if (v6)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v7; ++i)
        {
          ...
          unsigned int v10 = objc_msgSend(*(id *)(*((void *)&v12 + 1) + 8 * i), "dictionaryRepresentation", (void)v12);
          [v4 addObject:v10];
        }
...
- (id)description
{
  ...
  id v4 = [(HMDRemoteEventRouterProtoFetchEventsResponse *)&v8 description];
  unint64_t v5 = [(HMDRemoteEventRouterProtoFetchEventsResponse *)self dictionaryRepresentation];
