...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BC58] wrappertlv:1 name:@"kSupportedAudioStreamConfiguration_AudioCodecConfigurations" objectCreator:&__block_literal_global_491];
  id v4 = [MEMORY[0x1E4F5BDE8] wrappertlv:2 name:@"kSupportedAudioStreamConfiguration_ComfortNoise"];
  v30[0] = v3;
  v30[1] = v4;
