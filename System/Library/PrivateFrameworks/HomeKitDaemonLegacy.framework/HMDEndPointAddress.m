...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BE20] wrappertlv:2 name:@"kStreamManagementControlPoint__ControllerAddress__IPAddress"];
  id v4 = [MEMORY[0x1E4F5BDE8] wrappertlv:1 name:@"kStreamManagementControlPoint__ControllerAddress__IPAddressVersion"];
  v5 = [MEMORY[0x1E4F5BDE8] wrappertlv:3 name:@"kStreamManagementControlPoint__ControllerAddress__VideoRTPPort"];
  id v6 = [MEMORY[0x1E4F5BDE8] wrappertlv:4 name:@"kStreamManagementControlPoint__ControllerAddress__AudioRTPPort"];
  v17[0] = v3;
  v17[1] = v4;
  v17[2] = v5;
  v17[3] = v6;
  id v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v17 count:4];
