...
- (BOOL)shouldAutoEnableNotificationForCharacteristic:(id)a3 ofService:(id)a4
{
  ...
  {
    v10 = objc_msgSend((id)shouldAutoEnableNotificationForCharacteristic_ofService__autoEnableNotifications, "hmf_arrayForKey:", v7);
...
- (BOOL)checkTupleExistsInSet:(id)a3 forChrType:(id)a4 svcType:(id)a5
{
  id v7 = (objc_class *)MEMORY[0x1E4F5BD88];
  id v8 = a5;
  id v9 = a4;
  id v10 = a3;
...
- (BOOL)shouldFilterServiceOfType:(id)a3
{
  ...
  {
    id v6 = [(HMDHAPMetadata *)self hmBlacklistedServices];
...
- (BOOL)shouldEnableHomeNotificationForCharacteristicType:(id)a3 serviceType:(id)a4
{
  ...
  id v8 = objc_msgSend((id)shouldEnableHomeNotificationForCharacteristicType_serviceType__homedInternalHomeNotifications, "hmf_arrayForKey:", v7);
      ...
      if (v10)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v27 = 2112;
          v28 = v15;
          _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Current HMDHAPMetadata version %@ schemaVersion %@", buf, 0x20u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v25 = 2112;
          id v26 = v8;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to instantiate the current metadata %@", buf, 0x16u);
        }
        id v6 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v24 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to get plain metadata path", buf, 0xCu);
      }
      id v5 = 0;
      id v6 = 0;
    }
...
+ (id)metadataCache
{
  if (metadataCache_onceToken != -1) {
    dispatch_once(&metadataCache_onceToken, &__block_literal_global_19012);
  }
  v2 = (void *)metadataCache_cache;
  return v2;
}
...
{
  id v4 = a3;
  id v5 = [(HMDHAPMetadata *)self hmBlacklistedCharacteristicsFromApp];
...
{
  id v4 = a3;
  id v5 = [(HMDHAPMetadata *)self hmBlacklistedServicesFromApp];
  char v6 = [v5 containsObject:v4];
...
- (BOOL)shouldFilterChangeNotificationsForCharacteristicType:(id)a3 serviceType:(id)a4
{
  ...
  {
    BOOL v9 = [(HMDHAPMetadata *)self hmBlacklistedServices];
...
- (BOOL)shouldFilterCharacteristicOfType:(id)a3
{
  ...
  {
    id v6 = [(HMDHAPMetadata *)self hmBlacklistedCharacteristics];
    char v5 = [v6 containsObject:v4];
  }
  return v5;
}
...
{
  id v4 = a3;
  char v5 = [(HMDHAPMetadata *)self hmAccessoryCategories];
...
- (id)xpcData:(BOOL)a3
{
  ...
  id v6 = (void *)MEMORY[0x1E4F2E7E8];
  id v7 = [(HMDHAPMetadata *)self version];
  char v8 = [(HMDHAPMetadata *)self hapMetadata];
...
void __60__HMDHAPMetadata_statusHAPCharacteristicTypesForServiceType__block_invoke()
{
  ...
  v38[0] = *MEMORY[0x1E4F5BAD8];
  v36[0] = *MEMORY[0x1E4F5B7E0];
  uint64_t v35 = *MEMORY[0x1E4F5B7E8];
  uint64_t v0 = v35;
  v20 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v35 count:1];
  v37[0] = v20;
  v36[1] = *MEMORY[0x1E4F5B8C8];
  uint64_t v34 = v0;
  v19 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v34 count:1];
  v37[1] = v19;
  v36[2] = *MEMORY[0x1E4F5B8D0];
  uint64_t v33 = v0;
  v18 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v33 count:1];
  v37[2] = v18;
  v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v37 forKeys:v36 count:3];
  v39[0] = v17;
  v38[1] = *MEMORY[0x1E4F5BA98];
  uint64_t v31 = *MEMORY[0x1E4F5B850];
  uint64_t v1 = v31;
  uint64_t v3 = *MEMORY[0x1E4F5B870];
  v30[0] = *MEMORY[0x1E4F5B808];
  uint64_t v2 = v30[0];
  v30[1] = v3;
  uint64_t v4 = *MEMORY[0x1E4F5B7D8];
  v30[2] = *MEMORY[0x1E4F5B818];
  v30[3] = v4;
  v16 = [MEMORY[0x1E4F1C978] arrayWithObjects:v30 count:4];
  v32 = v16;
  char v5 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v32 forKeys:&v31 count:1];
  v39[1] = v5;
  v38[2] = *MEMORY[0x1E4F5BB38];
  uint64_t v28 = v1;
  v27[0] = v2;
  v27[1] = v3;
  v27[2] = *MEMORY[0x1E4F5B820];
  ...
  v39[2] = v7;
  v38[3] = *MEMORY[0x1E4F5BB48];
  uint64_t v25 = *MEMORY[0x1E4F5B880];
  uint64_t v8 = v25;
  uint64_t v9 = *MEMORY[0x1E4F5B8F0];
  v24[0] = v4;
  v24[1] = v9;
  char v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v24 count:2];
  id v26 = v10;
  v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v26 forKeys:&v25 count:1];
  v39[3] = v11;
  v38[4] = *MEMORY[0x1E4F5BAA8];
  uint64_t v22 = v8;
  v21[0] = v4;
  v21[1] = v9;
  v21[2] = *MEMORY[0x1E4F5B8E8];
  ...
  v39[4] = v13;
  uint64_t v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v39 forKeys:v38 count:5];
...
void __69__HMDHAPMetadata_disallowedAssistantCharacteristicTypesByServiceType__block_invoke()
{
  ...
  uint64_t v6 = *MEMORY[0x1E4F2DDF0];
  uint64_t v0 = (void *)MEMORY[0x1E4F1CAD0];
  uint64_t v5 = *MEMORY[0x1E4F2CE48];
...
void __40__HMDHAPMetadata_aliasedHAPServiceTypes__block_invoke()
{
  ...
  uint64_t v2 = *MEMORY[0x1E4F5BB50];
  v3[0] = *MEMORY[0x1E4F5BA80];
...
- (id)aliasedHAPCharacteristicTypes
{
  if (aliasedHAPCharacteristicTypes_onceToken != -1) {
    dispatch_once(&aliasedHAPCharacteristicTypes_onceToken, &__block_literal_global_275_18859);
  }
...
void __47__HMDHAPMetadata_aliasedHAPCharacteristicTypes__block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F5B8C0];
  uint64_t v1 = *MEMORY[0x1E4F5B828];
  v9[0] = *MEMORY[0x1E4F5B7D8];
  v9[1] = v1;
  uint64_t v2 = *MEMORY[0x1E4F5B858];
  v10[0] = v0;
  v10[1] = v2;
  uint64_t v3 = *MEMORY[0x1E4F5B988];
  v9[2] = *MEMORY[0x1E4F5B860];
  v9[3] = v3;
  uint64_t v4 = *MEMORY[0x1E4F5B980];
  v10[2] = v2;
  v10[3] = v4;
  uint64_t v5 = *MEMORY[0x1E4F5B8D0];
  v9[4] = *MEMORY[0x1E4F5B950];
  v9[5] = v5;
  uint64_t v6 = *MEMORY[0x1E4F5B7E0];
  v10[4] = v4;
  v10[5] = v6;
  v9[6] = *MEMORY[0x1E4F5B8C8];
  v10[6] = v6;
  ...
  if (v7)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        id v13 = [(HMDHAPMetadata *)self hapMetadata];
        ...
        if ((v14 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v27 = 2112;
            uint64_t v28 = v11;
            _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Assistant unit %@ unknown", buf, 0x16u);
          }
...
- (BOOL)parseAndSetAssistantCharacteristics:(id)a3
{
  ...
  id v3 = a3;
  v49 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v3, "count"));
  ...
  if (v56)
  {
    ...
    uint64_t v53 = *MEMORY[0x1E4F5BF70];
    uint64_t v51 = *MEMORY[0x1E4F5BF68];
    uint64_t v50 = *MEMORY[0x1E4F5BFC8];
    uint64_t v52 = *MEMORY[0x1E4F5BF28];
    uint64_t v48 = *MEMORY[0x1E4F5BF90];
    uint64_t v47 = *MEMORY[0x1E4F5BFA8];
    uint64_t v46 = *MEMORY[0x1E4F5BF58];
...
LABEL_3:
    ...
    while (1)
    {
      ...
      char v10 = objc_msgSend(v9, "hmf_stringForKey:", v53);
      uint64_t v11 = v10;
      if (v10)
      {
        id v12 = v10;
...
LABEL_16:
            ...
            if (v25)
            {
              id v26 = [[HMDHAPMetadataAssistantCharacteristic alloc] initWithName:v8 readHAPCharacteristic:v12 writeHAPCharacteristic:v13 format:v25];
              buf[0] = 0;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = v45;
                ...
                __int16 v65 = 2112;
                uint64_t v66 = v8;
                _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Assistant characteristic %@ format not specified unknown", buf, 0x16u);
              }
              int v36 = 1;
            }
...
LABEL_27:
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, v22, buf, 0x20u);
      }
LABEL_28:
        ...
        if (!v15)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v32 = 2112;
            uint64_t v33 = v13;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Assistant service %@ not mappable - no such HAP service %@", buf, 0x20u);
          }
  ...
  if (v7)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        id v13 = [v12 characteristicTypeFromUTI:v11];
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v25 = 2112;
            uint64_t v26 = v11;
            _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@characteristicName %@ is not a standard HAP characteristicName", buf, 0x16u);
          }
  ...
  if (v7)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        uint64_t v11 = *(void *)(*((void *)&v19 + 1) + 8 * i);
        uint64_t v12 = [(HMDHAPMetadata *)self hapMetadata];
        id v13 = [v12 serviceTypeFromUTI:v11];
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v25 = 2112;
            uint64_t v26 = v11;
            _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@ServiceName %@ is not a standard HAP serviceName", buf, 0x16u);
          }
...
- (id)parseHMAccessoryFirmwareUpdatePolicyCharacteristics:(id)a3
{
  ...
  if (v47)
  {
    ...
    uint64_t v46 = *MEMORY[0x1E4F5B9C0];
    uint64_t v44 = *MEMORY[0x1E4F5B9B8];
    BOOL v43 = v4;
LABEL_3:
    uint64_t v6 = 0;
    while (1)
    {
      ...
      uint64_t v9 = (void *)v8;
      char v10 = objc_msgSend(v5, "hmf_dictionaryForKey:", v7);
      if (!v10)
      {
        v37 = (void *)MEMORY[0x1D9452090]();
        v38 = self;
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v56 = 2112;
          v57 = v9;
          _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed while parsing characteristic %@", buf, 0x16u);
        }
...
LABEL_34:
      ...
      uint64_t v11 = v10;
      uint64_t v12 = v5;
      id v13 = objc_msgSend(v10, "hmf_arrayForKey:", v46);
      uint64_t v14 = v13;
      if (v13 && [v13 count])
      {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v56 = 2112;
              v57 = v9;
              _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Characteristic configuration failed for characteristic %@", buf, 0x16u);
            }
            int v20 = 1;
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v56 = 2112;
            v57 = v9;
            _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_DEBUG, "%{public}@Format not found for characteristic %@", buf, 0x16u);
          }
          int v20 = 1;
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v56 = 2112;
          v57 = v9;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Values not available for characteristic %@", buf, 0x16u);
        }
        int v20 = 1;
      }
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      v57 = v7;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@Type not found for characteristic name %@", buf, 0x16u);
    }
    goto LABEL_34;
  }
LABEL_27:
...
- (id)parseHMAccessoryFirmwareUpdatePolicyCriteria:(id)a3
{
  ...
  -[HMDAccessoryFirmwareUpdatePolicyCriteria setAnyUserAtHome:](v5, "setAnyUserAtHome:", objc_msgSend(v4, "hmf_BOOLForKey:", *MEMORY[0x1E4F5B9B0]));
  -[HMDAccessoryFirmwareUpdatePolicyCriteria setNoUserAtHome:](v5, "setNoUserAtHome:", objc_msgSend(v4, "hmf_BOOLForKey:", *MEMORY[0x1E4F5B9E0]));
  -[HMDAccessoryFirmwareUpdatePolicyCriteria setCheckForScheduledAutomation:](v5, "setCheckForScheduledAutomation:", objc_msgSend(v4, "hmf_BOOLForKey:", *MEMORY[0x1E4F5B9D0]));
  uint64_t v6 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5B9C8]);
  ...
  if (v6)
  {
    ...
    if (!v8)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        int v27 = 138543362;
        uint64_t v28 = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristics", (uint8_t *)&v27, 0xCu);
      }
      goto LABEL_18;
    }
  }
  uint64_t v9 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5B9F8]);
  char v10 = v9;
  if (!v9)
  {
LABEL_8:
  ...
  uint64_t v11 = objc_msgSend(v9, "hmf_stringForKey:", *MEMORY[0x1E4F5BA00]);
  uint64_t v12 = objc_msgSend(v10, "hmf_stringForKey:", *MEMORY[0x1E4F5B9F0]);
  id v13 = (void *)v12;
  if (v11 && v12)
  {
...
LABEL_16:
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, v21, (uint8_t *)&v27, 0xCu);
  }
LABEL_17:
...
- (id)parseHMAccessoryFirmwareUpdatePolicyServices:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v58)
    {
      ...
      context = (void *)*MEMORY[0x1E4F5B9D8];
      v64 = self;
LABEL_4:
      uint64_t v10 = 0;
      while (1)
      {
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v81 = 2112;
            id v82 = v69;
            _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@Failed while parsing policy configuration for service:%@.", buf, 0x16u);
          }
          id v37 = v61;
          goto LABEL_45;
        }
        id v13 = v12;
        uint64_t v60 = v10;
        uint64_t v14 = objc_msgSend(*(id *)(v7 + 2656), "dictionaryWithCapacity:", objc_msgSend(v12, "count"));
        if ([v13 count])
        {
          long long v72 = 0u;
          long long v73 = 0u;
                ...
                if (!v20)
                {
                  ...
                  if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    __int16 v81 = 2112;
                    id v82 = v69;
                    _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@Category type not found for service:%@.", buf, 0x16u);
                  }
                  id v37 = v16;
                  id v13 = v15;
                  uint64_t v8 = v56;
                  ...
                  else
                  {
                    ...
                    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      __int16 v83 = 2112;
                      v84 = v69;
                      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Service configuration failed for category %@ in service:%@.", buf, 0x20u);
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    __int16 v83 = 2112;
                    v84 = v69;
                    _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Criteria configuration failed for category %@ in service:%@.", buf, 0x20u);
          ...
          if (!v35)
          {
            ...
            if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v83 = 2112;
              v84 = v69;
              _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_ERROR, "%{public}@Service configuration failed for category %@ in service:%@.", buf, 0x20u);
            }
            id v37 = v61;
...
LABEL_46:
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v81 = 2112;
        id v82 = v11;
        _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Service type not found for service:%@.", buf, 0x16u);
      }
      id v37 = v61;
      goto LABEL_46;
    }
...
LABEL_47:
  ...
  {
    id v37 = [MEMORY[0x1E4F1C9E8] dictionary];
  }
...
- (BOOL)policyConfigurationAvailableForAllHAPServices
{
  ...
  char v16 = __Block_byref_object_copy__18888;
  char v17 = __Block_byref_object_dispose__18889;
  id v18 = 0;
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Firmware update policy configuration missing for service:%@", buf, 0x16u);
    }
  }
...
- (void)parseAndSetHMAccessoryFirmwareUpdatePolicies:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v6 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BA08]);
    ...
    id v8 = objc_msgSend(v5, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5B9A0]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      uint64_t v15 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Accessory firmware update policies not defined!", (uint8_t *)&v14, 0xCu);
    }
  }
}
...
- (void)parseAndSetHMCategories:(id)a3
{
  ...
  id v3 = a3;
  uint64_t v26 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v3, "count"));
  long long v29 = 0u;
  long long v30 = 0u;
  long long v31 = 0u;
  long long v32 = 0u;
  ...
  if (v5)
  {
    ...
    uint64_t v27 = *MEMORY[0x1E4F5BF30];
    uint64_t v7 = *MEMORY[0x1E4F5BF98];
    uint64_t v8 = *MEMORY[0x1E4F5BF10];
    do
    {
  ...
  if (![v26 count])
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v34 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@There are no accessory categories in the metadata", buf, 0xCu);
    }
  }
...
- (void)parseAndSetAllowableSecuringWrites:(id)a3
{
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v28;
            ...
            __int16 v36 = 2112;
            uint64_t v37 = v12;
            _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unknown characteristic '%@' while parsing tuple", buf, 0x16u);
          }
          uint64_t v5 = v20;
          self = v19;
          id v6 = v18;
  ...
  if (![v5 count])
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v35 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@There are no allowable securing writes in the metadata", buf, 0xCu);
    }
  }
...
- (id)parseMetadataTupleSetFromPlist:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristic/service tuples: %@", (uint8_t *)&v12, 0x16u);
    }
  }
...
- (BOOL)parseAndSetAssistantMetadataWithAssistantPlist:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF88]);
...
LABEL_11:
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, v15, (uint8_t *)&v17, 0xCu);

    goto LABEL_12;
  }
  id v7 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF00]);
  ...
  uint64_t v9 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BFA0]);
...
{
  id v4 = a3;
  uint64_t v5 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF78]);
  ...
  if (v7)
  {
    BOOL v8 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BEE0]);
    [(HMDHAPMetadata *)self parseAndSetAllowableSecuringWrites:v8];

    uint64_t v9 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BFB8]);
    [(HMDHAPMetadata *)self parseAndSetWakeOnOperationsFilter:v9];

    BOOL v10 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BEF8]);
    [(HMDHAPMetadata *)self parseAndSetHMCategories:v10];

    BOOL v11 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF20]);
    uint64_t v12 = *MEMORY[0x1E4F5BF88];
    uint64_t v13 = objc_msgSend(v11, "hmf_arrayForKey:", *MEMORY[0x1E4F5BF88]);
    __int16 v14 = [(HMDHAPMetadata *)self parseServiceArray:v13];
    [(HMDHAPMetadata *)self setHmBlacklistedServices:v14];

    uint64_t v15 = *MEMORY[0x1E4F5BF00];
    uint64_t v16 = objc_msgSend(v11, "hmf_arrayForKey:", *MEMORY[0x1E4F5BF00]);
    int v17 = [(HMDHAPMetadata *)self parseCharacteristicArray:v16];
    [(HMDHAPMetadata *)self setHmBlacklistedCharacteristics:v17];

    id v18 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF18]);
...
LABEL_21:
    ...
    long long v24 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF50]);
    long long v26 = objc_msgSend(v24, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF48]);
    long long v30 = objc_msgSend(v24, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BEF0]);
    long long v31 = objc_msgSend(v24, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF08]);
    ...
    if (v35)
    {
      ...
      if (v37)
      {
        ...
        __int16 v36 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5B9A8]);
...
- (id)parseAndSetRawPlist:(id)a3
{
  ...
  if (v4)
  {
    BOOL v6 = objc_msgSend(v4, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BED8]);
    if ([(HMDHAPMetadata *)self parseAndSetHMMetadataWithHMPlist:v6])
    {
      id v7 = objc_msgSend(v5, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BEE8]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v21 = 2112;
          uint64_t v22 = v7;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse assistant metadata from plist %@", (uint8_t *)&v19, 0x16u);
        }
        BOOL v8 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1001];
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v21 = 2112;
        uint64_t v22 = v6;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HM metadata from plist %@", (uint8_t *)&v19, 0x16u);
      }
      BOOL v8 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1001];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      id v20 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to set HMDMetadata because rawPlist is nil.", (uint8_t *)&v19, 0xCu);
    }
    BOOL v8 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1001];
  }
...
- (id)mapToAssistantCharacteristicValue:(id)a3 name:(id)a4 getActionType:(BOOL)a5
{
  ...
  if (v11)
  {
    ...
    if (v18)
    {
      ...
      id v20 = [MEMORY[0x1E4F28FE8] scannerWithString:v15];
      uint64_t v24 = 0;
      double v25 = 0.0;
      int v23 = 0;
...
- (id)mapToAssistantCharacteristicName:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (([v5 isEqual:*MEMORY[0x1E4F5B8D0]] & 1) == 0
      && ([v5 isEqual:*MEMORY[0x1E4F5B8C8]] & 1) == 0)
    {
...
void __69__HMDHAPMetadata_mapToAssistantServiceSubtypeName_accessoryCategory___block_invoke()
{
  ...
  v33[0] = *MEMORY[0x1E4F2C190];
  uint64_t v31 = *MEMORY[0x1E4F2DE28];
  uint64_t v0 = v31;
  uint64_t v32 = *MEMORY[0x1E4F97100];
  uint64_t v1 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v32 forKeys:&v31 count:1];
  v34[0] = v1;
  v33[1] = *MEMORY[0x1E4F2C168];
  uint64_t v2 = *MEMORY[0x1E4F970F8];
  uint64_t v3 = *MEMORY[0x1E4F2DF00];
  v28[0] = v0;
  v28[1] = v3;
  uint64_t v4 = *MEMORY[0x1E4F97110];
  v30[0] = v2;
  v30[1] = v4;
  uint64_t v29 = *MEMORY[0x1E4F2DE40];
  uint64_t v5 = v29;
  v30[2] = v4;
  id v6 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v30 forKeys:v28 count:3];
  v34[1] = v6;
  v33[2] = *MEMORY[0x1E4F2C180];
  uint64_t v26 = v0;
  uint64_t v27 = *MEMORY[0x1E4F97140];
  uint64_t v7 = v27;
  uint64_t v8 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v27 forKeys:&v26 count:1];
  v34[2] = v8;
  v33[3] = *MEMORY[0x1E4F2C170];
  uint64_t v24 = v0;
  uint64_t v25 = v7;
  uint64_t v9 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v25 forKeys:&v24 count:1];
  v34[3] = v9;
  v33[4] = *MEMORY[0x1E4F2C1B8];
  uint64_t v22 = v0;
  uint64_t v23 = *MEMORY[0x1E4F97108];
  uint64_t v10 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v23 forKeys:&v22 count:1];
  v34[4] = v10;
  v33[5] = *MEMORY[0x1E4F2C250];
  v20[0] = v3;
  v20[1] = v5;
  v21[0] = v4;
  v21[1] = v4;
  ...
  v34[6] = v12;
  v33[7] = *MEMORY[0x1E4F2C1C0];
  uint64_t v16 = v5;
  uint64_t v17 = *MEMORY[0x1E4F97170];
  long long v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v17 forKeys:&v16 count:1];
  v34[7] = v13;
  uint64_t v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v34 forKeys:v33 count:8];
...
void __51__HMDHAPMetadata_mapToAssistantServiceSubtypeName___block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F97128];
  uint64_t v1 = *MEMORY[0x1E4F2DD90];
  v16[0] = *MEMORY[0x1E4F2DD88];
  v16[1] = v1;
  uint64_t v2 = *MEMORY[0x1E4F97148];
  v17[0] = v0;
  v17[1] = v2;
  uint64_t v3 = *MEMORY[0x1E4F97158];
  uint64_t v4 = *MEMORY[0x1E4F2DDA8];
  v16[2] = *MEMORY[0x1E4F2DD98];
  v16[3] = v4;
  uint64_t v5 = *MEMORY[0x1E4F97168];
  v17[2] = v3;
  v17[3] = v5;
  uint64_t v6 = *MEMORY[0x1E4F97160];
  uint64_t v7 = *MEMORY[0x1E4F5BAB0];
  v16[4] = *MEMORY[0x1E4F5BA80];
  v16[5] = v7;
  uint64_t v8 = *MEMORY[0x1E4F97150];
  v17[4] = v6;
  v17[5] = v8;
  uint64_t v9 = *MEMORY[0x1E4F97118];
  uint64_t v10 = *MEMORY[0x1E4F2DE38];
  v16[6] = *MEMORY[0x1E4F2DE18];
  v16[7] = v10;
  uint64_t v11 = *MEMORY[0x1E4F97120];
  v17[6] = v9;
  v17[7] = v11;
  uint64_t v12 = *MEMORY[0x1E4F2DF30];
  v16[8] = *MEMORY[0x1E4F2DF28];
  v16[9] = v12;
  uint64_t v13 = *MEMORY[0x1E4F97180];
  v17[8] = *MEMORY[0x1E4F97178];
  v17[9] = v13;
...
- (id)serviceSubtypeForValue:(id)a3 forServiceType:(id)a4
{
  ...
  if (v5)
  {
    ...
    if (!v8)
    {
      int v9 = [v6 isEqualToString:*MEMORY[0x1E4F5BB48]];
      uint64_t v10 = (id *)MEMORY[0x1E4F2DD88];
      if (!v9) {
        uint64_t v10 = (id *)MEMORY[0x1E4F2DDA0];
      }
      id v8 = *v10;
    }
  }
...
void __56__HMDHAPMetadata_serviceSubtypeForValue_forServiceType___block_invoke()
{
  ...
  uint64_t v8 = *MEMORY[0x1E4F5BB48];
  uint64_t v0 = *MEMORY[0x1E4F2DD88];
  v6[0] = &unk_1F2DC7780;
  v6[1] = &unk_1F2DC7798;
  uint64_t v1 = *MEMORY[0x1E4F2DD90];
  v7[0] = v0;
  ...
  v6[2] = &unk_1F2DC77B0;
  v6[3] = &unk_1F2DC77C8;
  uint64_t v2 = *MEMORY[0x1E4F2DDA8];
  void v7[2] = *MEMORY[0x1E4F2DD98];
  v7[3] = v2;
  uint64_t v3 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v7 forKeys:v6 count:4];
  v9[0] = v3;
...
- (id)audioAccessoryCategory
{
  ...
  uint64_t v3 = [(HMDHAPMetadataCategory *)v2 initWithIdentifier:&unk_1F2DC7768 uuid:*MEMORY[0x1E4F2C1D0] name:@"homepod" description:@"HomePod"];
  return v3;
}
...
- (id)categoryForOther
{
  ...
  uint64_t v3 = [v2 objectForKeyedSubscript:&unk_1F2DC7750];
...
void __74__HMDHAPMetadata_shouldRefreshValueForCharacteristicWithType_serviceType___block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F2D050];
  v11[0] = *MEMORY[0x1E4F2CEB8];
  v11[1] = v0;
  uint64_t v1 = *MEMORY[0x1E4F2CE80];
  v11[2] = *MEMORY[0x1E4F2CF40];
  v11[3] = v1;
  uint64_t v2 = [MEMORY[0x1E4F1C978] arrayWithObjects:v11 count:4];
  v13[0] = v2;
  v12[1] = @"00000253-0000-1000-8000-0026BB765291";
  uint64_t v3 = *MEMORY[0x1E4F2CE50];
  ...
  uint64_t v5 = *MEMORY[0x1E4F2CF48];
  v9[0] = *MEMORY[0x1E4F2CF00];
  v9[1] = v5;
  void v9[2] = *MEMORY[0x1E4F2CE48];
...
void __83__HMDHAPMetadata_shouldFilterEnableNotificationsForCharacteristicType_serviceType___block_invoke()
{
  ...
  uint64_t v0 = (void *)MEMORY[0x1E4F1CAD0];
  uint64_t v1 = *MEMORY[0x1E4F2DEE8];
  v10[0] = *MEMORY[0x1E4F2DEE0];
  v10[1] = v1;
  ...
  uint64_t v9 = *MEMORY[0x1E4F2CE68];
  id v6 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v9 count:1];
  uint64_t v7 = [v5 setWithArray:v6];
  id v8 = (void *)shouldFilterEnableNotificationsForCharacteristicType_serviceType__characteristicsToFilterEnableNotifications;
...
void __83__HMDHAPMetadata_shouldFilterChangeNotificationsForCharacteristicType_serviceType___block_invoke()
{
  ...
  id v6 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v9 count:1];
  uint64_t v7 = [v5 setWithArray:v6];
  id v8 = (void *)shouldFilterChangeNotificationsForCharacteristicType_serviceType__characteristicsToFilterChangeNotifications;
...
{
  v18[29] = *MEMORY[0x1E4F143B8];
  uint64_t v0 = (void *)MEMORY[0x1E4F1CAD0];
  uint64_t v1 = *MEMORY[0x1E4F5BB30];
  v18[0] = *MEMORY[0x1E4F5BAB0];
  v18[1] = v1;
  uint64_t v2 = *MEMORY[0x1E4F5BA90];
  void v18[2] = *MEMORY[0x1E4F5BB38];
  v18[3] = v2;
  uint64_t v3 = *MEMORY[0x1E4F5BB50];
  v18[4] = *MEMORY[0x1E4F5BA80];
  v18[5] = v3;
  uint64_t v4 = *MEMORY[0x1E4F5BAB8];
  v18[6] = *MEMORY[0x1E4F5BAC0];
  v18[7] = v4;
  uint64_t v5 = *MEMORY[0x1E4F5BB58];
  v18[8] = *MEMORY[0x1E4F5BA70];
  v18[9] = v5;
  uint64_t v6 = *MEMORY[0x1E4F5BAD0];
  v18[10] = *MEMORY[0x1E4F5BB60];
  v18[11] = v6;
  uint64_t v7 = *MEMORY[0x1E4F5BB20];
  v18[12] = *MEMORY[0x1E4F5BAD8];
  v18[13] = v7;
  uint64_t v8 = *MEMORY[0x1E4F5BAE8];
  v18[14] = *MEMORY[0x1E4F5BAE0];
  v18[15] = v8;
  uint64_t v9 = *MEMORY[0x1E4F5BB00];
  v18[16] = *MEMORY[0x1E4F5BAF0];
  v18[17] = v9;
  uint64_t v10 = *MEMORY[0x1E4F5BB18];
  v18[18] = *MEMORY[0x1E4F5BB10];
  v18[19] = v10;
  uint64_t v11 = *MEMORY[0x1E4F5BB08];
  v18[20] = *MEMORY[0x1E4F5BAF8];
  v18[21] = v11;
  uint64_t v12 = *MEMORY[0x1E4F5BA60];
  v18[22] = *MEMORY[0x1E4F5BB28];
  v18[23] = v12;
  uint64_t v13 = *MEMORY[0x1E4F5BAA0];
  v18[24] = *MEMORY[0x1E4F5BA98];
  v18[25] = v13;
  uint64_t v14 = *MEMORY[0x1E4F5BB48];
  v18[26] = *MEMORY[0x1E4F5BAA8];
  v18[27] = v14;
  v18[28] = *MEMORY[0x1E4F5BA88];
  long long v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:v18 count:29];
...
void __80__HMDHAPMetadata_shouldEnableHomeNotificationForCharacteristicType_serviceType___block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F2D050];
  v16[0] = *MEMORY[0x1E4F2CEB8];
  v16[1] = v0;
  v16[2] = *MEMORY[0x1E4F2CF40];
  uint64_t v1 = [MEMORY[0x1E4F1C978] arrayWithObjects:v16 count:3];
  v18[0] = v1;
  v17[1] = @"00000253-0000-1000-8000-0026BB765291";
  uint64_t v2 = *MEMORY[0x1E4F2CE50];
  v15[0] = @"00000254-0000-1000-8000-0026BB765291";
  v15[1] = v2;
  uint64_t v3 = [MEMORY[0x1E4F1C978] arrayWithObjects:v15 count:2];
  v18[1] = v3;
  v17[2] = @"0000026A-0000-1000-8000-0026BB765291";
  uint64_t v4 = *MEMORY[0x1E4F2CE48];
  v14[0] = *MEMORY[0x1E4F2CF48];
  v14[1] = v4;
  uint64_t v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v14 count:2];
  void v18[2] = v5;
  uint64_t v6 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v18 forKeys:v17 count:3];
  uint64_t v7 = (void *)shouldEnableHomeNotificationForCharacteristicType_serviceType__homedInternalHomeNotifications;
  shouldEnableHomeNotificationForCharacteristicType_serviceType__homedInternalHomeNotifications = v6;

  uint64_t v13 = *MEMORY[0x1E4F5BA48];
  uint64_t v8 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v13 count:1];
  uint64_t v9 = (void *)shouldEnableHomeNotificationForCharacteristicType_serviceType__serviceTypesNotAllowingHomeNotifications;
  shouldEnableHomeNotificationForCharacteristicType_serviceType__serviceTypesNotAllowingHomeNotifications = v8;

  uint64_t v12 = *MEMORY[0x1E4F5B8A8];
...
void __74__HMDHAPMetadata_shouldAutoEnableNotificationForCharacteristic_ofService___block_invoke()
{
  ...
  uint64_t v4 = *MEMORY[0x1E4F2DDD0];
  uint64_t v3 = *MEMORY[0x1E4F2CFB8];
...
void __87__HMDHAPMetadata_generateNotificationOnConfigurationForCharacteristicType_serviceType___block_invoke()
{
  v5[1] = *MEMORY[0x1E4F143B8];
  uint64_t v4 = *MEMORY[0x1E4F2CE48];
  uint64_t v3 = *MEMORY[0x1E4F2DEF0];
  uint64_t v0 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v3 count:1];
  v5[0] = v0;
  uint64_t v1 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v5 forKeys:&v4 count:1];
...
void __41__HMDHAPMetadata_isTargetCharacteristic___block_invoke()
{
  ...
  isTargetCharacteristic__targetCharacteristic = (uint64_t)&unk_1F2DC6A48;
}
...
void __48__HMDHAPMetadata_requiresTimedWrite_forService___block_invoke()
{
  ...
  uint64_t v0 = *MEMORY[0x1E4F5B948];
  v4[0] = *MEMORY[0x1E4F5B978];
  v4[1] = v0;
  uint64_t v1 = *MEMORY[0x1E4F5B808];
  void v4[2] = *MEMORY[0x1E4F5B940];
  v4[3] = v1;
  v4[4] = *MEMORY[0x1E4F5B870];
...
- (BOOL)shouldAllowToWakeSuspendedAccessoryForOperation:(int64_t)a3 service:(id)a4 characteristicType:(id)a5 value:(id)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v68 = 2112;
    id v69 = v12;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Checking if operation: '%@' is allowed to wake accessory for service: '%@' characteristic: '%@' with value '%@'", buf, 0x34u);
  }
  ...
  if (v20)
  {
    ...
    if (v21)
    {
      uint64_t v23 = objc_msgSend(v21, "hmf_arrayForKey:", *MEMORY[0x1E4F5BFC0]);
      if ((unint64_t)a3 > 0xA) {
        uint64_t v24 = @"Undefined";
      }
      else {
        uint64_t v24 = off_1E6A0B878[a3];
      }
      uint64_t v26 = v24;
      ...
      if (v27)
      {
        if (a3 == 3)
        {
          long long v28 = objc_msgSend(v22, "hmf_arrayForKey:", *MEMORY[0x1E4F5BFA8]);
          uint64_t v29 = v28;
          if (v28)
          {
            long long v52 = v23;
                  ...
                  if (v12 && [*(id *)(*((void *)&v55 + 1) + 8 * i) isEqual:v12])
                  {
                    ...
                    if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
                    {
                      ...
                      *(_DWORD *)buf = 138544386;
                      ...
                      __int16 v68 = 2112;
                      id v69 = v12;
                      _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_DEBUG, "%{public}@Operation: %@ on service '%@' and characteristic '%@' with value '%@' is allowed to wake accessory", buf, 0x34u);
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v66 = 2112;
              id v67 = v11;
              _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Operation: %@ on service '%@' and characteristic '%@' is not allowed to wake accessory", buf, 0x2Au);
            }
            BOOL v25 = 0;
LABEL_36:
            uint64_t v23 = v52;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v66 = 2112;
              id v67 = v11;
              _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_DEBUG, "%{public}@Operation: %@ on service '%@' and characteristic '%@' is allowed to wake accessory", buf, 0x2Au);
...
LABEL_10:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      uint32_t v21 = 32;
LABEL_12:
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v37, v21);
...
LABEL_13:
    ...
    long long v19 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:3 userInfo:0];
    goto LABEL_14;
  }
  id v23 = (id)*MEMORY[0x1E4F5B8C0];
  uint64_t v24 = [(HMDHAPMetadata *)self hapMetadata];
  if (([v24 isMandatoryCharacteristic:v23 forService:v7] & 1) == 0)
  {

LABEL_24:
    id v27 = (id)*MEMORY[0x1E4F5B800];
    id v28 = (id)*MEMORY[0x1E4F5B810];
    id v29 = (id)*MEMORY[0x1E4F5B838];
...
LABEL_33:
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v41 = 2112;
      id v42 = v6;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Service %@ or service being associated %@ are not compatible", (uint8_t *)&v37, 0x20u);
    }
    long long v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:62];
    goto LABEL_33;
  }
...
- (HMDHAPMetadata)initWithDictionary:(id)a3 hapMetadata:(id)a4 error:(id *)a5
{
  ...
  if (a3 && a4)
  {
    ...
    [v11 setObject:v12 forKeyedSubscript:*MEMORY[0x1E4F5BEC8]];
...
+ (BOOL)isHomedVersionSupported:(id)a3
{
  uint64_t v3 = (objc_class *)MEMORY[0x1E4F65590];
  id v4 = a3;
  id v5 = [v3 alloc];
...
uint64_t __42__HMDHAPMetadata_isHomedVersionSupported___block_invoke()
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F65590]) initWithVersionString:@"4.0"];
  uint64_t v1 = isHomedVersionSupported__requiredVersion;
...
+ (void)prepareMetadata
{
  ...
  [MEMORY[0x1E4F5BD80] setCurrentMetadataHook:&__block_literal_global_159];
  ...
  if (v5 - 881 <= 2)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v51 = 2048;
      unint64_t v52 = v5;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Invalid builtin metadata version %lu", buf, 0x16u);
    }
  }
  id v9 = +[HMDPersistentStore loadPlainMetadataDictionary];
  uint64_t v10 = *MEMORY[0x1E4F5BFB0];
  id v11 = [v9 objectForKeyedSubscript:*MEMORY[0x1E4F5BFB0]];
  ...
  uint64_t v15 = *MEMORY[0x1E4F5BF80];
  uint64_t v16 = [v9 objectForKeyedSubscript:*MEMORY[0x1E4F5BF80]];
  if (!v16) {
    goto LABEL_19;
  }
  ...
  uint64_t v47 = v12;
  id v48 = a1;
  uint64_t v18 = *MEMORY[0x1E4F5BF60];
  uint64_t v19 = [v9 objectForKeyedSubscript:*MEMORY[0x1E4F5BF60]];
  if (!v19)
  {
LABEL_18:
    ...
    if (isInternalBuild() && v5 == 880 && (unint64_t)(v47 - 881) <= 1)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v55 = 2048;
        uint64_t v56 = v47;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Metadata fix - Constructing version 883 metadata from current builtin version %lu, current builtin plist version %lu, archived version %lu", buf, 0x2Au);

        uint64_t v24 = v46;
        a1 = v48;
      }

      [v26 setObject:&unk_1F2DC7738 forKeyedSubscript:v10];
      uint64_t v35 = [v26 objectForKeyedSubscript:v24];
      [v35 setObject:&unk_1F2DC7738 forKeyedSubscript:v10];
...
LABEL_20:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    long long v50 = v38;
    _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_INFO, "%{public}@Cached metadata is not newer than the built-in one, prefer built-in metadata.", buf, 0xCu);
  }
  ...
  if (v40 < v42)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v50 = v45;
      _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Built-in metadata is newer than the cached one, uploading to the cloud when homed is ready with at least one home or the first home being added.", buf, 0xCu);
    }
    _shouldUploadToCloudAfterHomedReady = 1;
  }
...
{
  id v4 = a4;
  if ([v4 isEqualToString:*MEMORY[0x1E4F2DDE0]]) {
    char v5 = 1;
  }
  else {
    char v5 = [v4 isEqualToString:*MEMORY[0x1E4F2DDF0]];
  }
...
+ (BOOL)isOwnerPrivilegeRequiredForWritingCharacteristicType:(id)a3 serviceType:(id)a4
{
  ...
  BOOL v7 = ([v5 isEqualToString:@"00000264-0000-1000-8000-0026BB765291"] & 1) != 0
    ...
    || [v6 isEqualToString:*MEMORY[0x1E4F2DDF0]]
    && ![v5 isEqualToString:*MEMORY[0x1E4F2CF78]];
...
+ (id)legacyV3DataForCloud
{
  return +[HMDHAPMetadata dataFromMetadataDictionaryWithKey:*MEMORY[0x1E4F5BF38]];
}

+ (id)legacyV3DataForIDS
{
  return +[HMDHAPMetadata dataFromMetadataDictionaryWithKey:*MEMORY[0x1E4F5BF40]];
}
...
+ (BOOL)isServiceType:(id)a3 compatibleWithAccessoryCategoryType:(id)a4
{
  ...
  id v7 = a3;
  if (v5 != -1) {
    dispatch_once(&isServiceType_compatibleWithAccessoryCategoryType__onceToken, &__block_literal_global_147_18996);
  }
...
void __68__HMDHAPMetadata_isServiceType_compatibleWithAccessoryCategoryType___block_invoke()
{
  ...
  v33[0] = *MEMORY[0x1E4F2C200];
  uint64_t v32 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DEB0], 0);
  v34[0] = v32;
  v33[1] = *MEMORY[0x1E4F2C1A8];
  uint64_t v31 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE18], 0);
  v34[1] = v31;
  v33[2] = *MEMORY[0x1E4F2C1B0];
  id v30 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE88], 0);
  v34[2] = v30;
  v33[3] = *MEMORY[0x1E4F2C1B8];
  id v29 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE28], *MEMORY[0x1E4F2DF10], 0);
  v34[3] = v29;
  v33[4] = *MEMORY[0x1E4F2C1C8];
  id v28 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE38], 0);
  v34[4] = v28;
  v33[5] = *MEMORY[0x1E4F2C1D8];
  uint64_t v0 = *MEMORY[0x1E4F2DDE8];
  id v27 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DDE8], 0);
  v34[5] = v27;
  v33[6] = *MEMORY[0x1E4F2C258];
  char v26 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", v0, 0);
  v34[6] = v26;
  v33[7] = *MEMORY[0x1E4F2C1E0];
  BOOL v25 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE78], 0);
  v34[7] = v25;
  void v33[8] = *MEMORY[0x1E4F2C1F0];
  uint64_t v24 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DEA8], 0);
  v34[8] = v24;
  v33[9] = *MEMORY[0x1E4F2C1F8];
  uint64_t v23 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DED0], 0);
  v34[9] = v23;
  v33[10] = *MEMORY[0x1E4F2C208];
  uint64_t v22 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DEB8], *MEMORY[0x1E4F2DEF8], *MEMORY[0x1E4F2DDC8], *MEMORY[0x1E4F2DDF8], *MEMORY[0x1E4F2DE00], *MEMORY[0x1E4F2DE08], *MEMORY[0x1E4F2DE50], *MEMORY[0x1E4F2DE68], *MEMORY[0x1E4F2DE70], *MEMORY[0x1E4F2DE98], *MEMORY[0x1E4F2DEA0], 0);
  void v34[10] = v22;
  v33[11] = *MEMORY[0x1E4F2C228];
  objc_super v21 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DED8], 0);
  v34[11] = v21;
  v33[12] = *MEMORY[0x1E4F2C250];
  uint64_t v1 = *MEMORY[0x1E4F2DF00];
  uint64_t v2 = *MEMORY[0x1E4F2DE40];
  id v20 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DF00], *MEMORY[0x1E4F2DE40], 0);
  v34[12] = v20;
  v33[13] = *MEMORY[0x1E4F2C268];
  uint64_t v19 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DF28], 0);
  v34[13] = v19;
  v33[14] = *MEMORY[0x1E4F2C270];
  uint64_t v18 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DF30], 0);
  v34[14] = v18;
  v33[15] = *MEMORY[0x1E4F2C190];
  uint64_t v17 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DDC0], 0);
  v34[15] = v17;
  v33[16] = *MEMORY[0x1E4F2C178];
  id v3 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", v1, v2, 0);
  v34[16] = v3;
  v33[17] = *MEMORY[0x1E4F2C180];
  uint64_t v4 = *MEMORY[0x1E4F2DE48];
  uint64_t v5 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE48], 0);
  v34[17] = v5;
  v33[18] = *MEMORY[0x1E4F2C170];
  id v6 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", v4, 0);
  v34[18] = v6;
  v33[19] = *MEMORY[0x1E4F2C220];
  id v7 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE60], 0);
  v34[19] = v7;
  v33[20] = *MEMORY[0x1E4F2C1C0];
  uint64_t v8 = *MEMORY[0x1E4F2DE30];
  char v9 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DE30], 0);
  v34[20] = v9;
  v33[21] = *MEMORY[0x1E4F2C210];
  uint64_t v10 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", v8, 0);
  v34[21] = v10;
  v33[22] = *MEMORY[0x1E4F2C230];
  uint64_t v11 = *MEMORY[0x1E4F2DEF0];
  uint64_t v12 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", *MEMORY[0x1E4F2DEF0], 0);
  v34[22] = v12;
  v33[23] = *MEMORY[0x1E4F2C240];
  uint64_t v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", v11, 0);
  v34[23] = v13;
  v33[24] = *MEMORY[0x1E4F2C248];
  uint64_t v14 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObjects:", v11, 0);
  v34[24] = v14;
  uint64_t v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v34 forKeys:v33 count:25];
...
+ (void)_logCurrentMetadata
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    uint64_t v13 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Switching to HMDHAPMetadata version %@ schemaVersion %@", (uint8_t *)&v8, 0x20u);
  }
}
...
+ (id)getBuiltinInstance
{
  ...
  int v8 = objc_msgSend(v7, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF60]);

  id v29 = 0;
  char v9 = (void *)[objc_alloc(MEMORY[0x1E4F5BD80]) initWithDictionary:v8 error:&v29];
  id v10 = v29;
  if (v10 || !v9)
  {
    objc_super v21 = (void *)MEMORY[0x1D9452090]();
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v10;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to instantiate builtin HAP metadata %@", buf, 0x16u);
    }
    id v5 = 0;
  }
  else
  {
    ...
    if (!v10 && v5)
    {
      uint64_t v11 = (void *)MEMORY[0x1D9452090]([v3 setObject:v5 forKeyedSubscript:@"builtin"]);
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        uint64_t v35 = v15;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Builtin HAPMetadata version %@ schemaVersion %@", buf, 0x20u);
      }
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        uint64_t v35 = v20;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Builtin HMDHAPMetadata version %@ schemaVersion %@", buf, 0x20u);
      }
      id v5 = v5;
      id v10 = 0;
      id v6 = v5;
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v10;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to instantiate builtin metadata %@", buf, 0x16u);
    }
  }
  id v6 = 0;
LABEL_19:
...
uint64_t __31__HMDHAPMetadata_metadataCache__block_invoke()
{
  ...
  uint64_t v1 = metadataCache_cache;
...
+ (HMDHAPMetadata)metadataWithDictionary:(id)a3 error:(id *)a4
{
  ...
  id v5 = a3;
  id v14 = 0;
  id v6 = (void *)[objc_alloc(MEMORY[0x1E4F5BD80]) initWithDictionary:v5 error:&v14];
  id v7 = v14;
  int v8 = v7;
  if (a4) {
    *a4 = v7;
  ...
  if (v6)
  {
    char v9 = [[HMDHAPMetadata alloc] initWithDictionary:v5 hapMetadata:v6 error:a4];
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v19 = 2112;
      id v20 = v8;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to parse HAP metadata from %@ - error %@", buf, 0x20u);
    }
    char v9 = 0;
  }
...
+ (HMDHAPMetadata)metadataWithPath:(id)a3 error:(id *)a4
{
  ...
  int v8 = [MEMORY[0x1E4F1C9E8] dictionaryWithContentsOfURL:v7 error:a4];
  char v9 = v8;
  if (v8)
  {
    uint64_t v10 = *MEMORY[0x1E4F5BF60];
    uint64_t v11 = objc_msgSend(v8, "hmf_dictionaryForKey:", *MEMORY[0x1E4F5BF60]);
    if (v11)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v20 = 2112;
        uint64_t v21 = v10;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find metadata for key: %@", (uint8_t *)&v18, 0x16u);
      }
      __int16 v12 = 0;
    }
  }
