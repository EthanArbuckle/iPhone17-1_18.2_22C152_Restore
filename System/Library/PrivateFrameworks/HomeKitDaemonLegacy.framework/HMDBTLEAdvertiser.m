...
- (void)timerDidFire:(id)a3
{
  ...
  v13[1] = v13;
  v13[2] = 0x3032000000;
  v13[3] = __Block_byref_object_copy__41866;
  v13[4] = __Block_byref_object_dispose__41867;
  id v4 = a3;
  id v14 = v4;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Wireless Timer: %@ did fire for %@", buf, 0x20u);
  }
...
void __34__HMDBTLEAdvertiser_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v11;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Wireless BTLE Advertisement timeout for %@", (uint8_t *)&v18, 0x16u);
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v20 = 2112;
        uint64_t v21 = v17;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unexpected BTLE Advertisement timer for %@", (uint8_t *)&v18, 0x16u);
      }
    }
  }
}
...
- (void)_advertisementTimeout
{
  ...
  if (v3)
  {
    ...
    BOOL v6 = (void *)MEMORY[0x1D9452090]([(HMDBTLEAdvertiser *)self _clearAdvertiser]);
    id v7 = self;
    id v8 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Wireless - Starting reachable timer for accessory: %@", (uint8_t *)&v18, 0x16u);
    }
    if ([v5 isReachable])
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      __int16 v19 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Wireless LE Timeout - no gleAdvertiser", (uint8_t *)&v18, 0xCu);
    }
  ...
  if (v3 > 5 || ((1 << v3) & 0x29) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      int v18 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Wireless - Ignoring power on request -- Bluetooth not in a state to turn on accessory: %@", buf, 0x16u);
    }
    id v13 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:54 userInfo:0];
...
- (void)_startAdvertising
{
  ...
  if (!v3)
  {
    ...
    if (v5)
    {
      ...
      id v8 = objc_alloc_init(MEMORY[0x1E4F5E0C8]);
      [(HMDBTLEAdvertiser *)self setLeAdvertiser:v8];

      id v9 = objc_alloc(MEMORY[0x1E4F65470]);
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v28 = 2112;
        v29 = v20;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Wireless - Starting BT LE Advertisement for %@", (uint8_t *)&v26, 0x16u);
      }
      uint64_t v21 = [(HMDBTLEAdvertiser *)v16 leAdvertiser];
      [v21 activate];

      id v22 = objc_alloc(MEMORY[0x1E4F65580]);
...
- (void)_cancelOn:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    __int16 v20 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Wireless - Cancelling advertisement timer for %@", (uint8_t *)&v17, 0x16u);
  }
  if (v4)
  {
...
- (void)_completePendingPowerOnRequest:(id)a3
{
  ...
  {
    id v4 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:4 userInfo:0];
  }
  if (v6)
  {
...
- (HMDBTLEAdvertiser)init
{
  ...
  if (v2)
  {
    ...
    id v16 = [MEMORY[0x1E4F65530] sharedPreferences];
...
uint64_t __37__HMDBTLEAdvertiser_sharedAdvertiser__block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = sharedAdvertiser_sharedAdvertiser;
