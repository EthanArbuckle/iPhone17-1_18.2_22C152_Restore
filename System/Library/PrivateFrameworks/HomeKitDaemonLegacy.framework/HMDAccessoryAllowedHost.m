...
- (void)_encodeForSPIEntitledXPCTransportWithCoder:(id)a3
{
  ...
  id v6 = [v5 name];
  [v4 encodeObject:v6 forKey:*MEMORY[0x1E4F2C108]];
...
LABEL_38:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v24 = 2048;
    unint64_t v25 = v9;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@HMDNetworkRouterFirewallRuleWANPurpose value 0x%lx contains flags with no explicit mapping to HMAccessoryAllowedHostPurpose", (uint8_t *)&v22, 0x16u);
  }
LABEL_42:
  v16 = [v7 numberWithUnsignedInteger:v11];
  [v4 encodeObject:v16 forKey:*MEMORY[0x1E4F2C110]];

  v17 = (void *)MEMORY[0x1E4F1CAD0];
  v18 = addressesFromWANRule(v5);
  v19 = [v17 setWithArray:v18];
  [v4 encodeObject:v19 forKey:*MEMORY[0x1E4F2C100]];
  ...
  [v4 encodeBool:v21 forKey:*MEMORY[0x1E4F2C118]];
}
...
+ (id)allowedHostsFromJSONFirewallWANRules:(id)a3
{
  id v3 = objc_msgSend(a3, "na_map:", &__block_literal_global_93671);
  id v4 = v3;
  if (!v3) {
