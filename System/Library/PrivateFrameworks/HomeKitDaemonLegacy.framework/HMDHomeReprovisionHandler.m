  ...
  if (self)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v18 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Disable reprovision browsing timer fired", buf, 0xCu);
    }
    if (v6->_reprovisionBrowsingPending)
    {
      ...
      v10 = (void *)MEMORY[0x1D9452090]([(HMFTimer *)v6->_disableReprovisionBrowsingTimer resume]);
      v11 = v6;
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Resumed disable reprovision browsing timer %p for %f sec", buf, 0x20u);
      }
    }
    else
    {
...
- (void)handleReprovionedAccessory:(id)a3 identifier:(id)a4 error:(id)a5
{
  ...
  if (v11)
  {
    ...
    if (v9)
    {
      __int16 v21 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v9 requiringSecureCoding:1 error:0];
      if (v21) {
    ...
    uint64_t v31 = *MEMORY[0x1E4F2EC48];
...
- (void)handleFoundAccessoryNeedingReprovisioning:(id)a3 error:(id)a4
{
  ...
  if (![v6 accessoryReprovisionState])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      __int16 v19 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to Required", (uint8_t *)&v16, 0x16u);
    }
...
- (void)_reportAccessoryNeedingReprovision:(void *)a3 error:
{
  ...
  if (a1)
  {
    ...
    [v8 setObject:&unk_1F2DC8188 forKeyedSubscript:*MEMORY[0x1E4F2EC50]];
    if (v16)
    {
      v11 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v16 requiringSecureCoding:1 error:0];
      if (v11) {
        [v8 setObject:v11 forKeyedSubscript:@"kPairedAccessoryErrorDataKey"];
      }
    }
    v12 = (void *)MEMORY[0x1E4F654B0];
    uint64_t v13 = *MEMORY[0x1E4F2EC40];
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v85 = 2112;
        v86 = v34;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Missing target accessory UUID from message payload: %@", buf, 0x16u);
      }
    ...
    if (v10)
    {
      if ([v10 reachableTransports])
      {
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v85 = 2112;
          v86 = v47;
          _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Reprovision accessory failed since the accessory: %@ is already in the network", buf, 0x16u);
        }
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v85 = 2112;
          v86 = v52;
          _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to NotRequired", buf, 0x16u);
        }
        ...
        [v19 setObject:&unk_1F2DC8158 forKeyedSubscript:*MEMORY[0x1E4F2EC50]];
        v56 = (void *)MEMORY[0x1E4F654B0];
        uint64_t v57 = *MEMORY[0x1E4F2EC40];
        ...
        if (v60)
        {
          v61 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 description:@"Accessory already in the network" reason:0 suggestion:0 underlyingError:0];
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v85 = 2112;
          v86 = v17;
          _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to InProgress", buf, 0x16u);
        }
        ...
        [v19 setObject:&unk_1F2DC8170 forKeyedSubscript:*MEMORY[0x1E4F2EC50]];
        uint64_t v22 = (void *)MEMORY[0x1E4F654B0];
        uint64_t v23 = *MEMORY[0x1E4F2EC40];
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v85 = 2112;
        v86 = v66;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Reprovision accessory failed since the accessory: %@ is not paired", buf, 0x16u);
      ...
      uint64_t v42 = [MEMORY[0x1E4F28C58] hmErrorWithCode:10 description:@"Accessory not paired" reason:0 suggestion:0 underlyingError:0];
    }
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v85 = 2112;
        v86 = v5;
        _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to find accessory with UUID: %@", buf, 0x16u);
      }
      ...
      uint64_t v42 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    }
...
LABEL_43:
  ...
  if (v28)
  {
    ...
    v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      v34 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Storing reprovison request message identifier for accessory with identifier: %@", buf, 0x16u);
    }
...
void __57__HMDHomeReprovisionHandler__handleReprovisionAccessory___block_invoke_2(uint64_t a1)
{
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v7;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate WiFi credential for accessory %@ with error: %@", (uint8_t *)&v12, 0x20u);
    }
  ...
  if (v5)
  {
    if (v3)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v38 = 2112;
        v39 = v10;
        _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to reprovision accessory with identifier: %@", (uint8_t *)&v36, 0x16u);
      }
      if (v7) {
        id v11 = (void *)v7[7];
      }
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v38 = 2112;
        v39 = v19;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Accessory %@ reprovision state is updated to NotRequired", (uint8_t *)&v36, 0x16u);
      }
      ...
      [v27 setObject:&unk_1F2DC8170 forKeyedSubscript:*MEMORY[0x1E4F2EC50]];
      id v30 = (void *)MEMORY[0x1E4F654B0];
      uint64_t v31 = *MEMORY[0x1E4F2EC40];
...
- (void)_handleRequestSearchForAccessoriesNeedingReprovisioning:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v37 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Received request to start searching for accessories need reprovisioning", buf, 0xCu);
  }
  if (v6 && v6->_reprovisionBrowsingAllowed)
  {
    ...
    if (!v6->_disableReprovisionBrowsingTimer)
    {
      ...
      __int16 v14 = (void *)MEMORY[0x1D9452090]([(HMFTimer *)v6->_disableReprovisionBrowsingTimer resume]);
      uint64_t v15 = v6;
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Started disable reprovision browsing timer %p for %f sec", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Request to start searching for accessories need reprovisioning is deferred", buf, 0xCu);
    }
    if (v6) {
...
- (void)configure:(id)a3 queue:(id)a4 messageDispatcher:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v15;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Configured reprovision handler for home %@", buf, 0x16u);
  }
  if (self)
  {
    ...
    uint64_t v20 = *MEMORY[0x1E4F2EDC8];
    *(void *)buf = v18;
    *(void *)&buf[8] = v17;
    __int16 v21 = (void *)MEMORY[0x1E4F1C978];
    ...
    uint64_t v25 = *MEMORY[0x1E4F2EDC0];
    v31[0] = v18;
    v31[1] = v17;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_84231 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_84231, &__block_literal_global_84232);
  }
  id v2 = (void *)logCategory__hmf_once_v2_84233;
  return v2;
}
...
uint64_t __40__HMDHomeReprovisionHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_84233;
  logCategory__hmf_once_v2_84233 = v0;
