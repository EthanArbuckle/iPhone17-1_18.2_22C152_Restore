...
+ (id)logCategory
{
  if (logCategory__hmf_once_t21_110159 != -1) {
    dispatch_once(&logCategory__hmf_once_t21_110159, &__block_literal_global_46_110160);
  }
  v2 = (void *)logCategory__hmf_once_v22_110161;
  return v2;
}
...
- (void)updateProcessInfoForRBSProcessHandle:(id)a3 usingUpdate:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v51 = 2112;
    id v52 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Received app state change: %@", (uint8_t *)&v49, 0x16u);
  }
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      uint32_t v33 = 22;
LABEL_21:
      _os_log_impl(&dword_1D49D5000, v31, v32, v30, (uint8_t *)&v49, v33);
    }
LABEL_22:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v53 = 2112;
    v54 = v18;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating %@ with new state: %@", (uint8_t *)&v49, 0x20u);
  }
  if ([v12 state] == -1)
  {
    v25 = (void *)MEMORY[0x1D9452090]();
    ...
    && ![v12 isSuspended])
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v51 = 2112;
      id v52 = v12;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@%@ back into foreground", (uint8_t *)&v49, 0x16u);
    }
...
LABEL_31:
  ...
  if ([v12 isTerminated]
    && [v20 isEqual:*MEMORY[0x1E4F2D748]])
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v49 = 138543362;
      v50 = v24;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Handling HomeUIService termination with no delay", (uint8_t *)&v49, 0xCu);
    }
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v51 = 2112;
    id v52 = v20;
    _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Delaying notification of backgrounding, termination or suspension %@", (uint8_t *)&v49, 0x16u);
  }
  ...
  {
    v45 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:5.0];
  ...
  if ([v6 state] != v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v24 = 2112;
      id v25 = v6;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating application state to %{public}@ for process: %@", buf, 0x20u);
    }
    [v6 _updateState:v8];
      ...
      if (v8 == 1)
      {
        ...
        if (v10)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            __int16 v24 = 2112;
            id v25 = v10;
            _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Upgrading app state to foreground for process %@: %@", (uint8_t *)&v20, 0x20u);
          }
          unint64_t v9 = 0;
        }
        else
      ...
      if ([v6 isEntitledForSPIAccess])
      {
          ...
          && [a1 shouldUpgradeFromBackgroundToForegroundForProcessInfo:v6 processState:v7])
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            __int16 v22 = 2112;
            id v23 = v6;
            _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Upgrading app state to foreground as the client has SPI access and is background running: %@", (uint8_t *)&v20, 0x16u);
          }
          unint64_t v9 = 2;
        }
        else if (v9 == -1)
...
+ (unint64_t)applicationStateFromRBSProcessState:(id)a3
{
  ...
  switch([v3 taskState])
  {
    ...
    case 4u:
      ...
      int v6 = [v5 containsObject:*MEMORY[0x1E4F62718]];
...
- (void)removeFromPendingTerminated:(id)a3
{
  ...
  long long v30 = 0u;
  long long v31 = 0u;
  uint64_t v8 = [(HMDProcessMonitor *)self pendingTerminatedApplications];
    ...
    *(void *)&long long v10 = 138543618;
    ...
    do
    {
      for (uint64_t i = 0; i != v29; ++i)
      {
        ...
        v14 = objc_msgSend(v13, "applicationInfo", v27);
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = v27;
            ...
            __int16 v36 = 2112;
            v37 = v6;
            _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Dropping termination notification for %@", buf, 0x16u);
...
- (id)processInfoForPID:(int)a3
{
  ...
  int v6 = -[HMDProcessMonitor _processInfoForPID:]((os_unfair_lock *)self, a3);
...
- (void)_processAppStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Processing change of state for %@", (uint8_t *)&v9, 0x16u);
  }
  if ([v4 isTerminated]) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      __int16 v22 = v5;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Created process info: %@", buf, 0x16u);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v20 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self for RBSProcessMonitorUpdateInfo", buf, 0xCu);
    }
  }
}
...
void __45__HMDProcessMonitor_updateApplicationMonitor__block_invoke_2_24(uint64_t a1)
{
  if (!*(void *)(*(void *)(a1 + 32) + 16))
  {
    if ([*(id *)(a1 + 40) count])
    {
      *(void *)(*(void *)(a1 + 32) + 16) = [MEMORY[0x1E4F96418] monitorWithConfiguration:*(void *)(a1 + 48)];
      MEMORY[0x1F41817F8]();
      return;
    }
    if (!*(void *)(*(void *)(a1 + 32) + 16))
...
- (void)timerDidFire:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(HMDProcessMonitor *)self queue];
  ...
  if (v6 == v4)
  {
    if (v10)
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v26 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Processing pending terminated applications after timer expired", buf, 0xCu);
    }
    long long v22 = 0u;
    long long v23 = 0u;
    long long v20 = 0u;
    long long v21 = 0u;
    id v13 = [(HMDProcessMonitor *)v8 pendingTerminatedApplications];
    ...
    id v18 = [(HMDProcessMonitor *)v8 pendingTerminatedApplications];
    [v18 removeAllObjects];

    id v19 = [(HMDProcessMonitor *)v8 spiClientTerminationDelayTimer];
    [v19 suspend];
  ...
  else
  {
    if (v10)
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v26 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Received an unknown watchdog timer expiry", buf, 0xCu);
    }
  }
}
...
- (void)removeProcess:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing process info: %@", (uint8_t *)&v17, 0x16u);
  }
  [(HMDProcessMonitor *)v6 _removeProcess:v4];
  id v9 = [v4 applicationInfo];
  BOOL v10 = v9;
  if (v9)
  {
    __int16 v11 = [v9 processes];
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        int v17 = 138543362;
        id v18 = v16;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating application monitor because last process info was removed from application info", (uint8_t *)&v17, 0xCu);
      }
...
- (NSArray)foregroundProcesses
{
  ...
  id v3 = objc_msgSend(v2, "na_filter:", &__block_literal_global_110133);
...
- (HMDProcessMonitor)initWithQueue:(id)a3
{
  ...
  id v6 = [(HMDProcessMonitor *)&v13 init];
  id v7 = v6;
  if (v6)
  {
...
uint64_t __32__HMDProcessMonitor_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v22_110161;
  logCategory__hmf_once_v22_110161 = v0;
...
+ (BOOL)shouldUpgradeFromBackgroundToForegroundForProcessInfo:(id)a3 processState:(id)a4
{
  id v5 = a3;
  id v6 = [a4 assertions];
  char v7 = objc_msgSend(v6, "na_any:", &__block_literal_global_43_110168);
  ...
  else
  {
    ...
    char v10 = [v9 isEqualToString:*MEMORY[0x1E4F2DA38]];
      ...
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        if (v9 == 3)
        {
          ...
          if (v12 == 7 || v12 == 10008 || v12 == 9)
          {
            ...
            id v18 = [v8 name];
            __int16 v19 = objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", objc_msgSend(v8, "reason"));
            uint64_t v16 = [v8 explanation];
            id v20 = [v15 stringWithFormat:@"%@(%@):%@", v18, v19, v16];
        ...
        else if (v9 == 2)
        {
          ...
          if (v11)
          {
            int v17 = NSString;
            id v18 = [v8 domain];
            __int16 v19 = [v8 explanation];
            id v20 = [v17 stringWithFormat:@"%@:%@", v18, v19];
LABEL_21:
