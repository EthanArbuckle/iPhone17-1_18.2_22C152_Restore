...
@implementation HMDRemoteEventRouterProtoChangeRegistrationsResponse
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMDRemoteEventRouterProtoChangeRegistrationsResponse addCachedEvents:](self, "addCachedEvents:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
...
{
  id v8 = a3;
  if ([(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)self cachedEventsCount])
  {
    [v8 clearCachedEvents];
    unint64_t v4 = [(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)self cachedEventsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)self cachedEventsAtIndex:i];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_cachedEvents, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HMDRemoteEventRouterProtoChangeRegistrationsResponse;
  id v4 = [(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)&v8 description];
  unint64_t v5 = [(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)self dictionaryRepresentation];
