...
void __36__HMDAirPlayAccessory_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Retrying configuration", buf, 0xCu);
  }
  uint64_t v6 = [*(id *)(a1 + 32) advertisement];
  if (v6)
  {
    v7 = [*(id *)(a1 + 32) configurationRetryTimer];
    [v7 suspend];

    uint64_t v8 = __configurationFromAdvertisement(*(void **)(a1 + 32), v6);
    BOOL v9 = [v8 count] == 0;
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v20;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Accessory no longer out of sync", buf, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v14;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory out of sync, updating configuration", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Missing advertisement, continuing configuration retries", buf, 0xCu);
    }
  }
}
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v13)
  {
    ...
    v44 = __Block_byref_object_copy__88852;
    v45 = __Block_byref_object_dispose__88853;
    id v46 = 0;
      ...
      if ((v22 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          uint64_t v50 = v25;
          v33 = (void *)v25;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Updated pairing identity: %@", buf, 0x16u);
        }
...
- (void)pairingsWithCompletionHandler:(id)a3
{
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      id v26 = v4;
      [v13 configureUsingBlock:&__block_literal_global_88859 options:v14 completionHandler:v24];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        char v29 = v22;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Missing output device", buf, 0xCu);
      }
      v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      char v29 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Only owner can remove users", buf, 0xCu);
    }
...
void __53__HMDAirPlayAccessory_pairingsWithCompletionHandler___block_invoke_2(uint64_t a1, uint64_t a2, void *a3, void *a4, void *a5)
{
  ...
  {
    id v32 = v9;
    os_log_type_t v12 = (void *)MEMORY[0x1E4F1CA48];
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      id v41 = v21;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Successfully requested pairing identities: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v42 = 2112;
      id v43 = v9;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to get peers with error: %@, cancellationReason: %@", buf, 0x20u);
    }
    id v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:@"Communication failure" reason:@"Failed to get configuration." suggestion:0 underlyingError:v10];
    v21 = 0;
  }
...
- (void)removeUserPairingIdentity:(id)a3 isOwner:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v33 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@User is the owner, disassociating from device", buf, 0xCu);
    }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v33 = v24;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Missing output device", buf, 0xCu);
      }
      v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
...
void __75__HMDAirPlayAccessory_removeUserPairingIdentity_isOwner_completionHandler___block_invoke_2(uint64_t a1, uint64_t a2, void *a3, void *a4, void *a5)
{
  ...
  if (v8)
  {
          ...
          if (v17 == v18)
          {
            ...
            if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v42 = 2112;
              id v43 = v28;
              _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to remove user pairing identity: %@", buf, 0x16u);
            }
            id v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:41];
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v41 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully removed peer", buf, 0xCu);
    }
    id v23 = 0;
LABEL_16:
    id v9 = v34;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      id v45 = v9;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to remove peer with error: %@, cancellationReason: %@", buf, 0x20u);
    }
    id v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:@"Communication failure" reason:@"Failed to set configuration." suggestion:0 underlyingError:v10];
  }
...
- (void)removeUser:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Removing user: %@", (uint8_t *)&v18, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to get pairing identity for user: %@", (uint8_t *)&v18, 0x16u);
    }
...
- (void)addUserPairingIdentity:(id)a3 isOwner:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (v11)
  {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&location[4] = v32;
          ...
          __int16 v44 = 2112;
          id v45 = v33;
          _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Failed to create authorized peer for pairing identity: %@ isOwner: %@", location, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&location[4] = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Missing output device", location, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)location = 138543362;
      *(void *)&location[4] = v24;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Only owner can add users identities", location, 0xCu);
    }
    os_log_type_t v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
...
void __72__HMDAirPlayAccessory_addUserPairingIdentity_isOwner_completionHandler___block_invoke_2(uint64_t a1, uint64_t a2, void *a3, void *a4, void *a5)
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v9;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to add peer with error: %@, cancellationReason: %@", (uint8_t *)&v29, 0x20u);
    }
    uint64_t v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:@"Communication failure" reason:@"Failed to set configuration." suggestion:0 underlyingError:v10];
    goto LABEL_12;
  }
  os_log_type_t v12 = [v8 peersInHomeGroup];
  ...
  if ((v13 & 1) == 0)
  {
    if (v17)
    {
      ...
      __int16 v31 = 2112;
      id v32 = v27;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to add peer: %@", (uint8_t *)&v29, 0x16u);
    }
    uint64_t v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
LABEL_12:
  ...
  if (v17)
  {
    ...
    __int16 v31 = 2112;
    id v32 = v19;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully added peer: %@", (uint8_t *)&v29, 0x16u);
  }
  __int16 v20 = 0;
LABEL_13:
...
- (void)addUser:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Adding user: %@", (uint8_t *)&v25, 0x16u);
  }
  ...
  if (v13)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v6;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Failed to get pairing identity for user: %@", (uint8_t *)&v25, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      int v25 = 138543362;
      id v26 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Only owner can add users", (uint8_t *)&v25, 0xCu);
    }
    id v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:17];
    v7[2](v7, v15);
  }
}
...
- (void)disassociatePairingIdentity:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v29 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Starting disassociation", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v29 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Missing output device", buf, 0xCu);
    }
    BOOL v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
...
{
  id v3 = a2;
  [v3 setDevicePassword:&stru_1F2C9F1A8];
...
void __69__HMDAirPlayAccessory_disassociatePairingIdentity_completionHandler___block_invoke_2(uint64_t a1, uint64_t a2, void *a3, void *a4, void *a5)
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v34 = 2112;
      id v35 = v9;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to disassociate with error: %@, cancellationReason: %@", (uint8_t *)&v30, 0x20u);
    }
    uint64_t v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:@"Communication failure" reason:@"Failed to set configuration." suggestion:0 underlyingError:v10];
    goto LABEL_14;
  }
...
LABEL_12:
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, v18, (uint8_t *)&v30, 0xCu);
...
LABEL_14:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v30 = 138543362;
    __int16 v31 = v29;
    _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully disassociated", (uint8_t *)&v30, 0xCu);
  }
  id v24 = 0;
LABEL_15:
...
- (id)backingStoreObjects:(int64_t)a3
{
  ...
  id v10 = [MEMORY[0x1E4F1CA48] arrayWithObject:v9];
  v13.receiver = self;
...
void __45__HMDAirPlayAccessory_handleUpdatedPassword___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Updating password to: %@", buf, 0x16u);
    }
    if (v3)
    {
...
void __57__HMDAirPlayAccessory_handleUpdatedMinimumUserPrivilege___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v7;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Updating minimum user privilege to: %@", buf, 0x16u);
    }
    id v15 = @"privilege";
...
- (void)setReachable:(BOOL)a3
{
  ...
  if (!a3)
  {
    id v4 = (void *)MEMORY[0x1D9452090](self, a2);
    id v5 = self;
    char v6 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v12 = 2112;
      id v13 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Forcing accessory reachability to YES and ignoring real value of %@", buf, 0x16u);
    }
  }
  v9.receiver = self;
...
- (void)_handleUpdatedName:(id)a3
{
  ...
  if (v9 && v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v11;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating name to: %@", buf, 0x16u);
    }
    uint64_t v23 = @"name";
    v24[0] = v11;
...
- (void)handleUpdatedAdvertisement:(id)a3
{
  ...
  [(HMDMediaAccessory *)&v71 handleUpdatedAdvertisement:v4];
  if (!v4)
  {
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v73 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory information", buf, 0xCu);
  }
  __int16 v12 = [v7 outputDevice];
  id v13 = objc_msgSend(v12, "av_OutputDevice");

  if (v13)
  {
    uint64_t v14 = [(HMDAirPlayAccessory *)v9 transactionWithObjectChangeType:2];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      id v15 = v14;
    }
    ...
    BOOL v17 = [v13 modelID];
    if (!v17) {
      goto LABEL_10;
    }
    objc_super v18 = [v13 modelID];
    uint64_t v19 = [(HMDAccessory *)v9 model];
    ...
    if ((v20 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v73 = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Updating model", buf, 0xCu);
      }
      id v26 = [v13 modelID];
      [v16 setModel:v26];
...
LABEL_10:
    ...
    if (v27)
    {
      id v28 = [v13 manufacturer];
      uint64_t v29 = [(HMDAccessory *)v9 manufacturer];
      ...
      if ((v30 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v73 = v34;
          _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating manufacturer", buf, 0xCu);
        }
        id v35 = [v13 manufacturer];
        [v16 setManufacturer:v35];

        int v21 = 1;
      }
    }
    uint64_t v36 = [v13 serialNumber];
    if (v36)
    {
      id v37 = [v13 serialNumber];
      id v38 = [(HMDAccessory *)v9 serialNumber];
      ...
      if ((v39 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v73 = v43;
          _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Updating serial number", buf, 0xCu);
        }
        __int16 v44 = [v13 serialNumber];
        [v16 setSerialNumber:v44];

        int v21 = 1;
      }
    }
    id v45 = [v13 firmwareVersion];

    if (v45)
    {
      uint64_t v46 = [HMDAccessoryVersion alloc];
      v47 = [v13 firmwareVersion];
      v48 = [(HMDAccessoryVersion *)v46 initWithVersionString:v47];

      __int16 v49 = [(HMDAccessory *)v9 firmwareVersion];
...
LABEL_37:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v73 = v54;
          _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_INFO, "%{public}@Updating firmware version", buf, 0xCu);
        }
        v55 = [v13 firmwareVersion];
        [v16 setFirmwareVersion:v55];
      }
    }
    else if (!v21)
    {
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v73 = v59;
      _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_DEFAULT, "%{public}@Updated accessory information", buf, 0xCu);
    }
    v60 = [(HMDAccessory *)v57 home];
    v61 = [v60 backingStore];
    v62 = +[HMDBackingStoreTransactionOptions defaultXPCOptions];
    v63 = [v61 transaction:@"Update Accessory Information" options:v62];
...
LABEL_38:
  ...
  if ([v64 count])
  {
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v73 = v68;
      _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory out of sync, updating configuration", buf, 0xCu);
    }
...
- (void)setAdvertisement:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    objc_super v9 = [(HMDAccessory *)v6 identifier];
    int v10 = 138543618;
    char v11 = v8;
    __int16 v12 = 2112;
    uint32_t v13 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Ignoring setting the advertisement data for AirPlay accessory %@", (uint8_t *)&v10, 0x16u);
  }
}
...
- (id)advertisement
{
  ...
  {
    uint64_t v8 = [(HMDMediaAccessoryBrowseOperation *)v5 outputDevices];
    objc_super v9 = [v8 firstObject];

    id v7 = [[HMDMediaAccessoryAdvertisement alloc] initWithOutputDevice:v9];
  }
...
- (HMDAirPlayAccessory)initWithTransaction:(id)a3 home:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v24 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot initialize an AirPlay accessory without an AirPlay model.", buf, 0xCu);
    }
    id v17 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t81 != -1) {
    dispatch_once(&logCategory__hmf_once_t81, &__block_literal_global_80);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v82;
  return v2;
}
...
uint64_t __34__HMDAirPlayAccessory_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v82;
...
+ (void)initialize
{
  [MEMORY[0x1E4F65530] setDefaultValue:&unk_1F2DCB858 forPreferenceKey:@"airPlayConfigurationRetryMinimum"];
  [MEMORY[0x1E4F65530] setDefaultValue:&unk_1F2DCB868 forPreferenceKey:@"airPlayConfigurationRetryMaximum"];
  uint64_t v2 = (void *)MEMORY[0x1E4F65530];
  [v2 setDefaultValue:&unk_1F2DC81E8 forPreferenceKey:@"airPlayConfigurationRetryFactor"];
}
