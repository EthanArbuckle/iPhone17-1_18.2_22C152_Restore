...
- (void)handleUpdatedSettings:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Home person manager settings changed: %@", buf, 0x16u);
  }
...
- (HMIHomePersonManager)hmiPersonManager
{
  ...
  v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_76544);
  id v4 = [v3 anyObject];
...
- (HMDHomePersonManager)initWithUUID:(id)a3 zoneManager:(id)a4 dataInterfaces:(id)a5 workQueue:(id)a6 home:(id)a7
{
  ...
  id v11 = a7;
  uint64_t v12 = [(HMDPersonManager *)&v14 initWithUUID:a3 zoneManager:a4 dataInterfaces:a5 workQueue:a6];
...
- (HMDHomePersonManager)initWithHome:(id)a3 zoneUUID:(id)a4 workQueue:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  objc_super v10 = (void *)MEMORY[0x1E4F2E830];
  id v11 = a4;
  uint64_t v12 = [v8 uuid];
  uint64_t v13 = [v10 personManagerUUIDFromHomeUUID:v12];

  objc_super v14 = [MEMORY[0x1E4F1CA80] set];
...
LABEL_4:
  ...
  v30 = [(HMDHomePersonManager *)self initWithUUID:v13 zoneManager:v26 dataInterfaces:v14 workQueue:v9 home:v8];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_76566 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_76566, &__block_literal_global_24_76567);
  }
  id v2 = (void *)logCategory__hmf_once_v2_76568;
  return v2;
}
...
uint64_t __35__HMDHomePersonManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_76568;
  logCategory__hmf_once_v2_76568 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}

+ (id)zoneNameForZoneUUID:(id)a3
{
  v3 = (void *)*MEMORY[0x1E4F2D640];
  id v4 = [a3 UUIDString];
