...
- (void)snapshotStreamSender:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x16u);
  }
...
- (void)snapshotStreamSender:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    int v15 = 138543362;
    v16 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back that the image transfer to watch has begun", (uint8_t *)&v15, 0xCu);
  }
  if (v9)
  {
...
- (void)snapshotRelayReceiver:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v12;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back that the image %@ has been saved after relay with error %@", (uint8_t *)&v19, 0x20u);
  }
  if (v12)
  {
...
- (void)snapshotRelayReceiver:(id)a3 didStartGettingImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Received delegate call back for getting image with error %@", (uint8_t *)&v15, 0x16u);
  }
...
- (void)_sendImageSendFailure:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v30 = 2112;
    v31 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending image send failure to %@", buf, 0x16u);
  }
  ...
  if (v4)
  {
    v20 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:0];
    [v16 setObject:v20 forKeyedSubscript:@"kCameraSessionError"];
  }
  __int16 v21 = [MEMORY[0x1E4F654B0] internalMessageWithName:@"kTakeSnapshotSendFailedNotificationKey" messagePayload:v16];
...
void __50__HMDCameraSnapshotRemoteRelayStream_getSnapshot___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Getting the snapshot from local snapshot handler", (uint8_t *)&v7, 0xCu);
  }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteRelayStream", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_72610 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_72610, &__block_literal_global_72611);
  }
  id v2 = (void *)logCategory__hmf_once_v2_72612;
  return v2;
}
...
uint64_t __49__HMDCameraSnapshotRemoteRelayStream_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_72612;
  logCategory__hmf_once_v2_72612 = v0;
