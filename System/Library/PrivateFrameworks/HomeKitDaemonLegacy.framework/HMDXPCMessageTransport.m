...
- (void)sendMessage:(id)a3 completionHandler:(id)a4
{
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v73[16] = 16;
        ...
        __int16 v80 = 2114;
        v81 = v45;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Sent message %{public}@(%{public,uuid_t}.16P) with target %{uuid_t}.16P to %{public}lu/%{public}lu clients with message send policy %{public}@", buf, 0x54u);
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_DEBUG))
      {
        ...
        [MEMORY[0x1E4F1C978] arrayWithObjects:v68 count:14];
        v53 = v60 = v46;
        v54 = [v52 setWithArray:v53];
        v55 = [v51 secureDescriptionWithBlacklistKeys:v54];
        ...
        *(_WORD *)&v73[8] = 2114;
        *(void *)&v73[10] = v10;
        _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_DEBUG, "%{public}@Sent message %{public}@ with payload: %{public}@ (skipped ineligible clients: %{public}@)", buf, 0x2Au);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)&v73[16] = 16;
    ...
    __int16 v76 = 2114;
    v77 = v35;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Not sending message %{public}@(%{public,uuid_t}.16P) with target %{uuid_t}.16P because no clients are eligible for send policy: %{public}@", buf, 0x40u);
  }
  v36 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:@"Failed to send message." reason:@"No eligible clients" suggestion:0];
  v37 = _Block_copy(v7);
  v38 = v37;
  if (v37) {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_67203 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_67203, &__block_literal_global_112_67204);
  }
  v2 = (void *)logCategory__hmf_once_v10_67205;
  return v2;
}
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v54 = 2112;
    id v55 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@New XPC connection requested: %@", buf, 0x16u);
  }
  uint64_t v11 = [(HMDXPCMessageTransport *)v8 clientConnectionFactory];
  uint64_t v12 = [(HMDXPCMessageTransport *)v8 queue];
  uint64_t v13 = ((void (**)(void, id, void *))v11)[2](v11, v6, v12);
  ...
  if ((v16 & v15) != v15)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v56 = 2112;
      v57 = v13;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Rejecting connection missing entitlements %@: %@", buf, 0x20u);
    }
    goto LABEL_16;
  }
  if (v8) {
    long long v18 = v8->_configuration;
  }
  else {
    long long v18 = 0;
  }
  ...
  if (([v13 isAuthorizedForHomeDataAccess] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v54 = 2112;
      id v55 = v28;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Rejecting connection from client with PID %@ because it is not authorized for Home data access", buf, 0x16u);
    }
LABEL_16:
  ...
  long long v20 = appProtectionGuard;
  if (v6) {
    [v6 auditToken];
  }
  else {
  ...
  uint64_t v29 = *MEMORY[0x1E4F2D1C8];
...
LABEL_22:
  ...
  v34 = (void *)MEMORY[0x1D9452090]([v6 setInvalidationHandler:v41]);
  v35 = v8;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v54 = 2112;
    id v55 = v13;
    _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Resuming new XPC connection: %@", buf, 0x16u);
  }
  [v6 resume];
...
+ (HMDXPCMessageTransport)defaultTransport
{
  if (defaultTransport_onceToken != -1) {
    dispatch_once(&defaultTransport_onceToken, &__block_literal_global_67214);
  }
...
void __61__HMDXPCMessageTransport_listener_shouldAcceptNewConnection___block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if (a2)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v11;
      uint64_t v12 = "%{public}@Successfully initiated authentication for app protection for connection: %@";
      uint64_t v13 = v9;
...
LABEL_6:
  ...
  else if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v5;
    uint64_t v12 = "%{public}@Failed to initiate authentication for app protection for connection %@: %@";
    uint64_t v13 = v9;
...
void __61__HMDXPCMessageTransport_listener_shouldAcceptNewConnection___block_invoke_118(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Daemon received interruption for %@", (uint8_t *)&v8, 0x16u);
  }
}
...
void __61__HMDXPCMessageTransport_listener_shouldAcceptNewConnection___block_invoke_119(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Daemon received invalidation for %@", buf, 0x16u);
  }
  if (v5 && v3)
  {
    os_unfair_lock_lock_with_options();
    ...
    {
      uint64_t v13 = [v5 processMonitor];
...
- (NSDictionary)stateDump
{
  ...
  id v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_95);
...
- (void)stop
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v8 = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Stopping XPC message transport", (uint8_t *)&v8, 0xCu);
  }
  if (v4) {
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v14 = 138543362;
    id v15 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting XPC message transport", (uint8_t *)&v14, 0xCu);
  }
  ...
  id v11 = [(HMDXPCMessageTransport *)v4 queue];
  if (v4)
  {
...
- (HMDXPCMessageTransport)initWithConfiguration:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v11 = [HMDProcessMonitor alloc];
    uint64_t v12 = [v5 queue];
    id v13 = [(HMDProcessMonitor *)v11 initWithQueue:v12];

    int v14 = objc_alloc_init(HMDAppProtectionGuard);
    id v15 = [(HMDXPCMessageTransport *)self initWithConfiguration:v5 listener:v10 processMonitor:v13 appProtectionGuard:v14];

    return v15;
  }
  else
  {
    int v17 = (HMDXPCMessageTransport *)_HMFPreconditionFailure();
...
LABEL_11:
    ...
    return (HMDXPCMessageTransport *)__37__HMDXPCMessageTransport_logCategory__block_invoke(v26);
  }
  v27.receiver = self;
  v27.super_class = (Class)HMDXPCMessageTransport;
  id v15 = [(HMDXPCMessageTransport *)&v27 init];
  if (v15)
  {
    ...
    SEL v18 = (NSMutableSet *)objc_alloc_init(MEMORY[0x1E4F1CA80]);
    mutableConnections = v15->_mutableConnections;
    v15->_mutableConnections = v18;

    uint64_t v20 = [MEMORY[0x1E4F29280] interfaceWithProtocol:&unk_1F2E1C8B8];
    exportedInterface = v15->_exportedInterface;
    v15->_exportedInterface = (NSXPCInterface *)v20;

    uint64_t v22 = [MEMORY[0x1E4F29280] interfaceWithProtocol:&unk_1F2F0B200];
    ...
    v15->_id clientConnectionFactory = &__block_literal_global_84;
  }
  return v15;
}
...
uint64_t __37__HMDXPCMessageTransport_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v10_67205;
  logCategory__hmf_once_v10_67205 = v0;
...
+ (HMDXPCMessageTransport)accessorySetupTransport
{
  if (accessorySetupTransport_onceToken != -1) {
    dispatch_once(&accessorySetupTransport_onceToken, &__block_literal_global_16_67210);
  }
...
{
  id v0 = objc_alloc(MEMORY[0x1E4F2E9B8]);
  id v3 = (id)[v0 initWithMachServiceName:*MEMORY[0x1E4F2E478]];
  [v3 setRequiredEntitlements:1];
  [v3 setRequiresHomeDataAccess:0];
  uint64_t v1 = [[HMDXPCMessageTransport alloc] initWithConfiguration:v3];
  v2 = (void *)accessorySetupTransport_accessorySetupTransport;
...
{
  id v0 = objc_alloc(MEMORY[0x1E4F2E9B8]);
  id v3 = (id)[v0 initWithMachServiceName:*MEMORY[0x1E4F2E4A0]];
  [v3 setRequiredEntitlements:1];
