  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (v10)
        {
          v13 = [*(id *)(a1 + 40) homeManagerMessagesGroup];
...
LABEL_6:
    ...
    id v14 = [(HMDLogEventMessageEventsAnalyzer *)self eventCountersManager];
    v15 = [v4 count];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v4;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Unknown XPC message counter type - dropping the LogEvent %@", buf, 0x16u);
  }
LABEL_9:
}
...
- (void)populateAggregationAnalysisLogEvent:(id)a3 forDate:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(HMDLogEventMessageEventsAnalyzer *)self eventCountersManager];
  ...
  id v11 = [v10 counterGroupForName:@"HMDLogEventXPCSentMessagesCountDailyRequestGroup"];
  ...
  int v16 = [v15 counterGroupForName:@"HMDLogEventMessageAnalyzerRemoteMessageSentDailyRequestGroup"];
  ...
  char v17 = [(HMDLogEventMessageEventsAnalyzer *)self residentSyncGroup];
...
- (void)handlePrimaryResidentChangedNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    id v10 = [v9 counterGroupForName:@"HMDLogEventMessageAnalyzerCommon"];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      int v16 = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received update primary resident notification but the primary resident is nil", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
LABEL_10:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          __int16 v28 = 2112;
          id v29 = v14;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Unable to retrieve eventName for remoteMessage - dropping remote message log event with identifier %@", (uint8_t *)&v26, 0x16u);
        }
      }
    ...
    default:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v14;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Invalid transport type - dropping remote message log event with identifier %@", (uint8_t *)&v26, 0x16u);
      }
      break;
  }
}
...
- (void)_handleRemoteMessageLogEvent:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v16 > 3) {
      ...
      uint64_t v17 = off_1E6A194E8[v16];
    }
    v18 = v17;
    [v4 msgQoS];
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v38 = 2114;
    v39 = v19;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@[CA] HMDRemoteMessageLogEvent -- %{public}@message %{public}@ %{public}@ over %{public}@ as %{public}@ (QoS: %{public}@)", buf, 0x48u);
  }
...
- (void)submitRemoteMessageCountersForGroup:(id)a3
{
  ...
  int v9 = [(HMDLogEventMessageEventsAnalyzer *)self eventCountersManager];
  ...
  if (v26)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v26; ++i)
      {
        ...
        uint64_t v17 = objc_msgSend(v10, "hmf_numberForKey:", v13);
        if (v15 && v16)
        {
...
- (void)registerTTRTriggersWithDataSource:(id)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v4 = [(HMDLogEventMessageEventsAnalyzer *)self addTTRThresholdTrigger:@"we detected excessive remote message counts" forEventName:@"HMDLogEventMessageAnalyzerRemoteMessageTransportTypeSecureEventCounter" requestGroup:@"HMDLogEventMessageAnalyzerRemoteMessageReceivedDailyRequestGroup" atThreshold:100000 radarInitiator:v6];
    uint64_t v5 = v6;
  }
...
- (HMDLogEventMessageEventsAnalyzer)initWithDataSource:(id)a3
{
  ...
  uint64_t v5 = [(HMDLogEventMessageEventsAnalyzer *)&v23 init];
  if (v5)
  {
    ...
    v20 = [MEMORY[0x1E4F1C978] arrayWithObjects:v24 count:4];
...
+ (id)managedEventCounterRequestGroups
{
  ...
  id v2 = [MEMORY[0x1E4F1C978] arrayWithObjects:v4 count:17];
  return v2;
}
