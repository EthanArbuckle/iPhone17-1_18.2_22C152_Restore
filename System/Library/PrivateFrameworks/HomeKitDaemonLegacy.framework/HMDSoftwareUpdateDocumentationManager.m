...
- (void)networkMonitorIsReachable:(id)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Network is reachable, starting automatic caching", buf, 0xCu);
  }
  long long v21 = 0u;
  long long v22 = 0u;
  long long v19 = 0u;
        ...
        if ([v13 shouldAutomaticallyCache] && objc_msgSend(v13, "state") <= 3)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v25 = 2112;
            v26 = v13;
            _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting automatic caching for asset: %@", buf, 0x16u);
          }
          [v13 startCaching];
        }
      }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Auditing asset: %@", buf, 0x16u);
    }
    long long v27 = 0u;
    long long v28 = 0u;
    long long v25 = 0u;
          ...
          if (v16)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v32 = 2112;
              id v33 = v4;
              _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Asset still in use: %@", buf, 0x16u);
            }
            goto LABEL_18;
          }
          ++v13;
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v4;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Asset no longer in use, removing: %@", buf, 0x16u);
    }
    [v4 purgeWithError:0];
...
- (void)addAsset:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      uint64_t v5 = objc_msgSend(MEMORY[0x1E4F28D60], "indexSetWithIndex:", -[NSMutableOrderedSet count](self->_assets, "count"));
        ...
        if (v9 == v10)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v23 = 2112;
            uint64_t v24 = v15;
            _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Unregistering metadata: %@", buf, 0x16u);
          }
...
{
  uint64_t v26 = *MEMORY[0x1E4F143B8];
  v2 = (void *)[objc_alloc(MEMORY[0x1E4F654F8]) initWithObservedObject:*(void *)(a1 + 32)];
  ...
  if ((v4 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      long long v25 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering metadata: %@", buf, 0x16u);
    }
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v24 = 2112;
        long long v25 = v11;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Creating new documentation asset: %@", buf, 0x16u);
      }
...
void __58__HMDSoftwareUpdateDocumentationManager_parseCachedAssets__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v52 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing cached assets", buf, 0xCu);
  }
  ...
  if (v8)
  {
    ...
    if (v11)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v13; ++i)
        {
          ...
          id v18 = [p_vtable + 252 assetWithURL:v16 fileManager:v17];
              ...
              if ([v18 state] <= 3)
              {
                ...
                if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v53 = 2112;
                  id v54 = v18;
                  _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Starting automatic caching of asset: %@", buf, 0x16u);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      id v54 = v10;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Found cached assets: %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v52 = v31;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Will purge unregistered assets in 60s", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      id v54 = v9;
      _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to get cached assets with error: %@", buf, 0x16u);
    }
  }
}
...
void __58__HMDSoftwareUpdateDocumentationManager_parseCachedAssets__block_invoke_10(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    uint64_t v21 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Auditing cached assets: %@", buf, 0x16u);
  }
  long long v15 = 0u;
  long long v16 = 0u;
  long long v13 = 0u;
...
- (HMDSoftwareUpdateDocumentationManager)initWithFileManager:(id)a3
{
  ...
  if (v6)
  {
    ...
    long long v16 = (HMFNetMonitor *)objc_alloc_init(MEMORY[0x1E4F654C8]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_132089 != -1) {
    dispatch_once(&logCategory__hmf_once_t15_132089, &__block_literal_global_132090);
  }
  v2 = (void *)logCategory__hmf_once_v16_132091;
  return v2;
}
...
uint64_t __52__HMDSoftwareUpdateDocumentationManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v16_132091;
  logCategory__hmf_once_v16_132091 = v0;
...
+ (HMDSoftwareUpdateDocumentationManager)sharedManager
{
  ...
  void block[4] = a1;
  if (sharedManager_onceToken_132096 != -1) {
    dispatch_once(&sharedManager_onceToken_132096, block);
  }
  v2 = (void *)sharedManager_sharedManager_132097;
...
uint64_t __54__HMDSoftwareUpdateDocumentationManager_sharedManager__block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = sharedManager_sharedManager_132097;
  sharedManager_sharedManager_132097 = (uint64_t)v1;
