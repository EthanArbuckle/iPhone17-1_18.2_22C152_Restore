...
- (id)receiverForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to get receiver for participant accessory UUID: %@ due to no data source", (uint8_t *)&v13, 0x16u);
    }
    v7 = 0;
  }
...
- (id)routerForParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to get router for participant accessory UUID: %@ due to no data source", (uint8_t *)&v13, 0x16u);
    }
    v7 = 0;
  }
...
- (void)removeGroupWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Remove group with identifier: %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)updateGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Update group: %@", (uint8_t *)&v12, 0x16u);
  }
  p_lock = &v6->_lock;
  os_unfair_lock_lock_with_options();
  groups = v6->_groups;
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      if (v12)
      {
        ...
        __int16 v21 = 2112;
        id v22 = v4;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Already added backed up group: %@", (uint8_t *)&v19, 0x16u);
      }
    }
    else if (v12)
    {
      ...
      __int16 v23 = 2112;
      v24 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Dropping backed up group: %@ existing group: %@", (uint8_t *)&v19, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Added backed up group: %@", (uint8_t *)&v19, 0x16u);
    }
  }
}
...
- (void)setParticipantAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Setting participant accessory uuid: %@ associated group identifier: %@", (uint8_t *)&v14, 0x20u);
  }
  os_unfair_lock_lock_with_options();
...
- (void)unsetParticipantAccessoryUUIDsWithAssociatedGroupIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Unsetting participant accessory uuids with associated group identifier: %@", buf, 0x16u);
  }
  os_unfair_lock_lock_with_options();
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v9;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to find associated group with identifier: %@", buf, 0x16u);
    }
  }
LABEL_9:
...
- (id)backupGroupsForParticipantAccessoryUUID:(id)a3
{
  ...
  id v6 = objc_msgSend(v5, "na_map:", &__block_literal_global_82158);
...
- (void)updateGroup:(id)a3 participantAccessoryUUIDs:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v24 = 2112;
    id v25 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating using group: %@ participant accessory uuids: %@", buf, 0x20u);
  }
...
- (void)updateUsingParticipantAccessoryUUID:(id)a3 associatedGroupIdentifier:(id)a4 backedUpGroupData:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    v30 = v15;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating using participant accessory uuid: %@ associated group identifier: %@ backup data count: %@", (uint8_t *)&v23, 0x2Au);
  }
  id v16 = [MEMORY[0x1E4F2E8E0] groupsWithProtoBufferData:v10];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v16;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Failed to decode all encoded groups of count: %@ decoded groups: %@", (uint8_t *)&v23, 0x20u);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_82173 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_82173, &__block_literal_global_11_82174);
  }
  v2 = (void *)logCategory__hmf_once_v25_82175;
  return v2;
}
...
uint64_t __45__HMDMediaGroupsLocalDataStorage_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v25_82175;
  logCategory__hmf_once_v25_82175 = v0;
