...
LABEL_65:
      ...
      v48 = @"HMDCameraRecordingSessionCoordinationLogEvent";
    }
    else
    {
      id v43 = v39;
      ...
      v45 = [v43 error];
      if (+[HMDCameraRecordingSessionLogEvent isRecordingSessionAlreadyInProgressError:v45])
      {

        goto LABEL_65;
      }
      v49 = [v43 error];
      uint64_t v47 = [v49 code];

      v48 = @"HMDCameraRecordingSessionLogEvent";
    }
    if (v47 == 14) {
      uint64_t v5 = 0;
    }
...
- (void)didReceiveEventFromDispatcher:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v18 = [v17 objectForKeyedSubscript:*MEMORY[0x1E4F28A50]];
...
- (HMDLogEventErrorEventsAnalyzer)initWithDataSource:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v15 count:16];
...
+ (NSArray)errorEventsRequestGroupKeys
{
  if (errorEventsRequestGroupKeys_onceToken != -1) {
    dispatch_once(&errorEventsRequestGroupKeys_onceToken, &__block_literal_global_189099);
  }
