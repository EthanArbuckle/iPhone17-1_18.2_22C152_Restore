...
- (void)_serviceExpiredUnreachableDevices
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      v14 = (void *)MEMORY[0x1D9452090](v12);
      v15 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v35 = 2112;
        v36 = v18;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Unreachable Debounce timer did fire for device address %@", buf, 0x16u);
      }
      if (self) {
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v31 = 2112;
      id v32 = v9;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying listeners that device address is %@: %@", buf, 0x20u);
    }
    long long v24 = 0u;
    long long v25 = 0u;
    long long v22 = 0u;
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v28 = v21;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot notify listeners for reachability change with nil address", buf, 0xCu);
    }
  }
}
...
- (void)transport:(id)a3 idsIdentifier:(id)a4 didAppearReachable:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&v24[14] = v14;
    __int16 v25 = 2112;
    id v26 = v9;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Device with idsIdentifier reporting %@: %@ ", v24, 0x20u);
  }
  os_unfair_lock_lock_with_options();
  if (v11) {
...
LABEL_13:
  ...
  objc_msgSend(v17, "setReachability:", MEMORY[0x1E4F1CC38], *(_OWORD *)v24);
  v21 = [v17 address];
  ...
  if (([(NSMutableArray *)self->_devicesWithPendingUnreachability containsObject:v4] & 1) == 0)
  {
          ...
          v8))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v16 = 2112;
        uint64_t v17 = v13;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Device address %@ reported unreachable.  Debouncing reachability", (uint8_t *)&v14, 0x16u);
      }
...
- (void)removeListener:(id)a3 forDeviceAddress:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing listener %p for address: %@", (uint8_t *)&v23, 0x20u);
  }
  p_lock = &v9->_lock;
  os_unfair_lock_lock_with_options();
  if (v9) {
...
- (void)addListener:(id)a3 forDeviceAddress:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v25 = 2112;
    id v26 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Adding listener %p for address: %@", (uint8_t *)&v21, 0x20u);
  }
  p_lock = &v9->_lock;
  os_unfair_lock_lock_with_options();
  if (v9) {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_155599 != -1) {
    dispatch_once(&logCategory__hmf_once_t12_155599, &__block_literal_global_155600);
  }
  v2 = (void *)logCategory__hmf_once_v13_155601;
  return v2;
}
...
uint64_t __59__HMDModernTransportDeviceReachabilityObserver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v13_155601;
  logCategory__hmf_once_v13_155601 = v0;
