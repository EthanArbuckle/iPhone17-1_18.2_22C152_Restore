...
- (id)backingStoreObjects:(int64_t)a3
{
  ...
  v9 = [v8 uuid];
  id v10 = [(HMDBackingStoreModelObject *)v6 initWithObjectChangeType:1 uuid:v7 parentUUID:v9];
...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  else
  {
    ...
    if (v16)
    {
      ...
      v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
- (void)_handleUpdateRoomModel:(id)a3 message:(id)a4
{
  ...
  if (!v12)
  {
    ...
    if (v21 && [v21 length])
    {
      ...
      if (v22)
      {
        ...
        if ((HMFEqualObjects() & 1) == 0)
        {
          v31 = @"kRoomOldNameKey";
          v32 = v23;
          __int16 v25 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v32 forKeys:&v31 count:1];
    ...
    {
      id v26 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:20 userInfo:0];
  ...
  if (!v14)
  {
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v39 = 2112;
      v40 = &unk_1F2DC8710;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot update name for the default room %@, %@, errorCode: %@", buf, 0x2Au);
    }
    __int16 v21 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:29 userInfo:0];
...
LABEL_18:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v19;
    _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Always return success for transaction update during replay and lookup", buf, 0xCu);
  }
...
- (void)_handleRenameRequest:(id)a3
{
  ...
  if ([v5 length] <= v6)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v29 = 2112;
      v30 = v11;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@New name does not conform to the HomeKit naming standard: %@", (uint8_t *)&v27, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      id v28 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", (uint8_t *)&v27, 0xCu);
    }
    v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:46];
  }
...
- (id)dumpState
{
  ...
  v11 = [v10 dumpState];
  [v3 setObject:v11 forKeyedSubscript:*MEMORY[0x1E4F64D80]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_101486 != -1) {
    dispatch_once(&logCategory__hmf_once_t12_101486, &__block_literal_global_101487);
  }
  v2 = (void *)logCategory__hmf_once_v13_101488;
  return v2;
}
...
uint64_t __22__HMDRoom_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v13_101488;
  logCategory__hmf_once_v13_101488 = v0;
...
+ (id)messageBindingsForDispatcher:(id)a3
{
  ...
  id v5 = objc_opt_new();
  v11[2] = v5;
  objc_super v6 = [MEMORY[0x1E4F1C978] arrayWithObjects:v11 count:3];
...
- (NSDictionary)assistantObject
{
  ...
  if (self)
  {
    ...
    if (v4 && v3)
    {
      ...
      if (v6)
      {
        ...
        v52[4] = v11;
        v52[5] = self;
        int v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v52 forKeys:v51 count:6];
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v57 = 2112;
    v58 = v3;
    _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because one of the properties of room is nil: name %@  home %@", buf, 0x20u);
  }
  __int16 v29 = 0;
LABEL_28:
