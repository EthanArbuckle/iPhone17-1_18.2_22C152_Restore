...
LABEL_5:
    ...
    if (v8 && [v7 count])
    {
      ...
      if (v12)
      {
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v35 = 2112;
          v36 = v7;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@[Profile Notifications] %@ notifications for characteristics for %@: %@", (uint8_t *)&v29, 0x2Au);
        }
      ...
      else
      {
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          int v29 = 138543362;
          v30 = v28;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] accessory not part of profile", (uint8_t *)&v29, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v35 = 2112;
        v36 = v9;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] nothing to %@ because characteristic.count (%ld) or client indentifier %@", (uint8_t *)&v29, 0x2Au);
      }
    }
  ...
  v24 = (void *)MEMORY[0x1D9452090](self, a2);
  v25 = self;
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v31 = 2048;
    unint64_t v32 = a4;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] options is not valid: %ld", (uint8_t *)&v29, 0x16u);
  }
}
...
void __51__HMDSiriEndpointProfile_setNotifications_options___block_invoke(uint64_t a1)
{
  ...
  else if ((v2 & 2) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2048;
      uint64_t v13 = v7;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_ERROR, "%{public}@[Notifications] options is not valid: %ld", (uint8_t *)&v10, 0x16u);
    }
    return;
  }
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Light On Use] failed to create siri enable write request", (uint8_t *)location, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Light On Use] accessory not part of profile", (uint8_t *)location, 0xCu);
      }
      v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
      if (v6) {
  ...
  {
    uint64_t v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
    if (v6) {
        ...
        do
        {
          ...
          if (v11)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v48 = 2112;
              v49 = v20;
              _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Write request %@ failed with error %@", buf, 0x20u);
          ...
          else
          {
            ...
            if (v24)
            {
              ...
              v43 = v25;
              v26 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v43 forKeys:&v42 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      v47 = v31;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);
    }
    uint64_t v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
    uint64_t v32 = v35[5];
    if (v32) {
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(location[0]) = 138543362;
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Touch To Use] failed to create siri enable write request", (uint8_t *)location, 0xCu);
        }
        id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
        if (v6) {
          (*((void (**)(id, id))v6 + 2))(v6, v17);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(location[0]) = 138543362;
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Touch To Use] accessory not part of profile", (uint8_t *)location, 0xCu);
      }
      v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
      if (v6) {
        (*((void (**)(id, void *))v6 + 2))(v6, v11);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(location[0]) = 138543362;
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Listening] failed to create siri enable write request", (uint8_t *)location, 0xCu);
        }
        id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
        if (v6) {
          (*((void (**)(id, id))v6 + 2))(v6, v17);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(location[0]) = 138543362;
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Listening] accessory not part of profile", (uint8_t *)location, 0xCu);
      }
      v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
      if (v6) {
        (*((void (**)(id, void *))v6 + 2))(v6, v11);
...
LABEL_12:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(location[0]) = 138543362;
          *(id *)((char *)location + 4) = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@[Set Enable] failed to create siri enable write request", (uint8_t *)location, 0xCu);
        }
        id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
        if (v6) {
          (*((void (**)(id, id))v6 + 2))(v6, v17);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(location[0]) = 138543362;
        *(id *)((char *)location + 4) = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@[Set Enable] accessory not part of profile", (uint8_t *)location, 0xCu);
      }
      v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
      if (v6) {
        (*((void (**)(id, void *))v6 + 2))(v6, v11);
...
- (void)_updateSessionState:(id)a3 settings:(id)a4 message:(id)a5
{
  ...
  id v9 = a4;
  id v109 = a5;
  id v10 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:12];
  v11 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:6];
  v110 = v11;
  if (v8)
  {
    ...
    if (v14 != [(HMDSiriEndpointProfile *)self sessionState])
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v113 = 2112;
        v114 = v19;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating session state: %@", buf, 0x16u);
      }
    ...
    [v10 setValue:v21 forKey:*MEMORY[0x1E4F2E000]];
    ...
    [v10 setValue:v28 forKey:*MEMORY[0x1E4F2DFF8]];
  }
  int v29 = (void *)[objc_alloc(MEMORY[0x1E4F1CA60]) initWithCapacity:5];
  if (v9)
  {
    v30 = [v9 siriEnable];
    ...
    if (v54)
    {
      ...
      [v10 setValue:v56 forKey:*MEMORY[0x1E4F2E020]];
    }
    ...
    if (v57)
    {
      ...
      [v10 setValue:v63 forKey:*MEMORY[0x1E4F2E010]];
    }
    ...
    if (v64)
    {
      ...
      [v10 setValue:v72 forKey:*MEMORY[0x1E4F2DF88]];
    ...
    if (v73)
    {
      ...
      [v10 setValue:v79 forKey:*MEMORY[0x1E4F2DFD0]];
    }
  ...
  if (v89)
  {
    ...
    if (v93)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v113 = 2112;
      v114 = v10;
      _os_log_impl(&dword_1D49D5000, v92, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated profile state: %@", buf, 0x16u);
    }
    id v96 = objc_alloc(MEMORY[0x1E4F65488]);
    v97 = [(HMDAccessoryProfile *)v91 uniqueIdentifier];
    v98 = (void *)[v96 initWithTarget:v97];

    v99 = (void *)MEMORY[0x1E4F654B0];
    uint64_t v100 = *MEMORY[0x1E4F2E018];
    v101 = (void *)[v10 copy];
  ...
  else
  {
    if (v93)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v112 = v106;
      _os_log_impl(&dword_1D49D5000, v92, OS_LOG_TYPE_INFO, "%{public}@No changes, not notifying XPC clients", buf, 0xCu);
    }
  }
  if ([v110 count])
  {
...
- (void)_handleRefreshProfileState:(id)a3 completionHandler:(id)a4
{
  ...
  if (v8)
  {
    ...
    id v10 = [v90 arrayForKey:*MEMORY[0x1E4F2DFE0]];
    v11 = v10;
    if (v10)
    {
      id v12 = v10;
    ...
    {
      uint64_t v18 = *MEMORY[0x1E4F2E008];
      v114[0] = *MEMORY[0x1E4F2DFF0];
      v114[1] = v18;
      id v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v114 count:2];
    }
    long long v19 = v12;
    ...
    if (v89)
    {
      uint64_t v86 = *MEMORY[0x1E4F2DFF0];
      uint64_t v87 = *(void *)v108;
      uint64_t v82 = *MEMORY[0x1E4F2E008];
      do
      {
        uint64_t v20 = 0;
        do
          ...
          if ([v22 isEqual:v86])
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v28;
                _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint session status is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v33;
                _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint version is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v38;
                _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint active identifier is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v43;
                _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint manually disable is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v47;
                _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint multifunction button is not available", buf, 0xCu);
              }
            }
            long long v105 = 0u;
            long long v106 = 0u;
          ...
          else
          {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v61;
                _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri enable is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v66;
                _os_log_impl(&dword_1D49D5000, v65, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri listening is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v71;
                _os_log_impl(&dword_1D49D5000, v70, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri touch is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v75, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v76;
                _os_log_impl(&dword_1D49D5000, v75, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri light on use is not available", buf, 0xCu);
              }
            }
            ...
            else
            {
              ...
              if (os_log_type_enabled(v79, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v116 = v80;
                _os_log_impl(&dword_1D49D5000, v79, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile State] siri endpoint settings siri engine is not available", buf, 0xCu);
              }
              v57 = 0;
            }
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v117 = 2112;
      v118 = v14;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@[Refreshing Profile] accessory not part of profile (%@)", buf, 0x16u);
    }
    id v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:4];
...
void __71__HMDSiriEndpointProfile__handleRefreshProfileState_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ([v3 count])
  {
    ...
    uint64_t v86 = *MEMORY[0x1E4F2D048];
    uint64_t v85 = *MEMORY[0x1E4F2CE50];
    while (1)
    {
          ...
          if (v20)
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v105 = 2112;
              id v106 = v25;
              _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Response Parsed HMDSiriEndpointSessionStateTLV: %@ with error: %@", buf, 0x20u);
...
LABEL_71:
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Read failed with error %@", buf, 0x16u);
        }
        id v6 = (void *)v11;
      }
      uint64_t v90 = [v5 countByEnumeratingWithState:&v96 objects:v107 count:16];
...
LABEL_74:
  ...
  int v75 = (void *)MEMORY[0x1D9452090]();
  id v76 = WeakRetained;
  ...
  if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v103 = 2112;
    uint64_t v104 = v79;
    _os_log_impl(&dword_1D49D5000, v77, OS_LOG_TYPE_ERROR, "%{public}@Invalid response for %@", buf, 0x16u);

    id WeakRetained = v88;
  }

  BOOL v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:50];
...
void __69__HMDSiriEndpointProfile_notifyClientsDidUpdateStagedNeedsOnboarding__block_invoke(uint64_t a1)
{
  ...
  uint64_t v18 = *MEMORY[0x1E4F2DFB0];
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated needsOnboarding: %@", (uint8_t *)&v14, 0x16u);
  }
  id v8 = objc_alloc(MEMORY[0x1E4F65488]);
  id v9 = [*(id *)(a1 + 32) uniqueIdentifier];
  id v10 = (void *)[v8 initWithTarget:v9];

  uint64_t v11 = [MEMORY[0x1E4F654B0] messageWithName:*MEMORY[0x1E4F2E018] destination:v10 payload:v3];
...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unknown stage value: %@ did expire value: %@", (uint8_t *)&v14, 0x20u);
    }
  }
}
...
- (void)handleEnableNotifications:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 numberForKey:*MEMORY[0x1E4F2DFB8]];
  id v6 = [v4 numberForKey:*MEMORY[0x1E4F2DFC8]];
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      int v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] parameters not specific", (uint8_t *)&v13, 0xCu);
    }
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v28 = 2112;
          int v29 = v17;
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling %@/%@", (uint8_t *)&v24, 0x20u);
        }
...
void __58__HMDSiriEndpointProfile_handleDeviceCapabilitiesUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v31 = 2112;
    uint64_t v32 = v14;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling updated resident capabilities: %@ notification: %@", (uint8_t *)&v27, 0x20u);
  }
  uint64_t v15 = [*(id *)(a1 + 40) accessory];
  __int16 v16 = [v15 home];
  id v17 = [v16 residentDeviceManager];
  __int16 v18 = [v17 residentDevices];
  id v19 = objc_msgSend(v18, "na_firstObjectPassingTest:", &__block_literal_global_160);
    ...
    if (v21 == v4 && ([v9 containsObject:@"supportsSiriEndpointSetup"] & 1) != 0)
    {
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v29 = 2112;
          id v30 = v20;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Current device was updated to support Siri Endpoint Settings (%@)", (uint8_t *)&v27, 0x16u);
        }
...
uint64_t __58__HMDSiriEndpointProfile_handleDeviceCapabilitiesUpdated___block_invoke_157(uint64_t a1, void *a2)
{
          ...
          if (v12)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v29 = 2112;
              id v30 = v19;
              _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Current device is primary:%@ and does not support home hub", buf, 0x16u);
...
uint64_t __52__HMDSiriEndpointProfile_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@", (uint8_t *)&v11, 0x16u);
  }
            ...
            while (2)
            {
              for (uint64_t i = 0; i != v14; ++i)
              {
                ...
                if (v21)
                {
                  ...
                  int v27 = [MEMORY[0x1E4F1CA60] dictionaryWithCapacity:1];
...
- (void)_handleCharacteristicChanges:(id)a3
{
  ...
  if (v90)
  {
    ...
    uint64_t v101 = *MEMORY[0x1E4F2D048];
    uint64_t v92 = *MEMORY[0x1E4F2CE50];
    id v102 = v7;
    id v107 = v8;
    while (1)
    {
                      ...
                      if (v33)
                      {
                        ...
                        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          __int16 v135 = 2112;
                          id v136 = v35;
                          _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Parsed HMDSiriEndpointSessionStateTLV: %@ with error: %@", buf, 0x20u);
                        }
                        id v7 = v102;
                        long long v38 = v35;
LABEL_40:
...
- (void)stageNeedsOnboarding:(int64_t)a3 withTimeout:(double)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2048;
    int64_t v16 = a3;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Staging needsOnboarding: %ld", (uint8_t *)&v13, 0x16u);
  }
...
{
  uint64_t v2 = [(HMDSiriEndpointProfile *)self _siriEndpointService];
  uint64_t v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2CE50]];
...
{
  uint64_t v2 = [(HMDSiriEndpointProfile *)self _siriEndpointService];
  uint64_t v3 = [v2 findCharacteristicWithType:*MEMORY[0x1E4F2D048]];
...
- (void)registerForMessages
{
  ...
  [v3 registerForMessage:*MEMORY[0x1E4F2DFE8] receiver:self policies:v8 selector:sel__handleRefreshProfileState_];
  [v3 registerForMessage:*MEMORY[0x1E4F2DFC0] receiver:self policies:v8 selector:sel_handleEnableNotifications_];
...
void __45__HMDSiriEndpointProfile_registerForMessages__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      id v10 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for characteristic notifcations since current device supports home hub", (uint8_t *)&v9, 0xCu);
    }
    [*(id *)(a1 + 32) _setNotifications:1 options:2];
...
- (HMDSiriEndpointProfile)initWithSiriEndpointServices:(id)a3 notificationCenter:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (v15)
    {
      id v46 = v9;
      v15->_sessionState = -1;
      uint64_t v16 = objc_msgSend(MEMORY[0x1E4F29128], "hmf_zeroUUID");
      ...
      v15->_siriEndpointVersion = (NSString *)&stru_1F2C9F1A8;
      ...
      v15->_siriEngineVersion = (NSString *)&stru_1F2C9F1A8;
      ...
      uint64_t v37 = [objc_alloc(MEMORY[0x1E4F65560]) initWithValue:&unk_1F2DC82C0];
  ...
  {
    int v40 = (void *)MEMORY[0x1D9452090]();
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v57 = 2112;
      id v58 = v6;
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Cannot create Siri Endpoint profile, cannot determine accessory from services %@", buf, 0x16u);
    }
    long long v39 = 0;
  }
...
+ (id)namespace
{
  if (namespace_onceToken_95212 != -1) {
    dispatch_once(&namespace_onceToken_95212, &__block_literal_global_95213);
  }
  uint64_t v2 = (void *)namespace_namespace_95214;
  return v2;
}

uint64_t __35__HMDSiriEndpointProfile_namespace__block_invoke()
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"4CF0DBFA-FE71-485F-956B-20002E66B3AA"];
  uint64_t v1 = namespace_namespace_95214;
  namespace_namespace_95214 = v0;
