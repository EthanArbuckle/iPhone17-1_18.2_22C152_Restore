...
+ (id)properties
{
  if (properties_onceToken_21438 != -1) {
    dispatch_once(&properties_onceToken_21438, &__block_literal_global_195);
  }
  v2 = (void *)properties__properties_21439;
  return v2;
}
...
void __34__HMDServiceGroupModel_properties__block_invoke()
{
  ...
  v3 = (void *)properties__properties_21439;
  properties__properties_21439 = v2;
}
