...
- (void)_handleUpdateServicesTransaction:(id)a3
{
  ...
  if (v47)
  {
    ...
    uint64_t v43 = *MEMORY[0x1E4F5BA48];
    do
    {
  ...
  if (v23)
  {
    ...
    do
    {
      for (uint64_t k = 0; k != v23; ++k)
      {
        ...
        if (v27)
        {
          v28 = (void *)MEMORY[0x1D9452090]([(NSMutableDictionary *)v50->_serviceMapping setObject:v27 forKey:v26]);
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v72 = 2112;
            v73 = name;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Add service uuid: %@ to group: %@", buf, 0x20u);
          }
        }
      }
      uint64_t v23 = [v48 countByEnumeratingWithState:&v55 objects:v74 count:16];
  ...
  if (v33)
  {
    ...
    do
    {
      for (uint64_t m = 0; m != v33; ++m)
      {
        ...
        if (v37)
        {
          v38 = (void *)MEMORY[0x1D9452090]([(NSMutableDictionary *)v50->_serviceMapping removeObjectForKey:v36]);
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v72 = 2112;
            v73 = v41;
            _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Remove service uuid: %@ from group: %@", buf, 0x20u);
          }
        }
      }
      uint64_t v33 = [v32 countByEnumeratingWithState:&v51 objects:v67 count:16];
...
- (id)updateServiceGroupWithModel:(id)a3 message:(id)a4
{
  ...
  {
    uint64_t v9 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21];
  }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        id v20 = v26;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", (uint8_t *)&v21, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v42 = 2112;
        uint64_t v43 = v23;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Service %@:%@ does not exist in group %@ in home %@", buf, 0x34u);
...
LABEL_11:
  ...
  int v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
...
- (void)_handleAddServiceRequest:(id)a3
{
  ...
  if (v5 && v6)
  {
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v61 = 2112;
        long long v62 = v24;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Service with UUID %@ does not exist in home %@", buf, 0x20u);
      }
    ...
    id v13 = [v12 type];
    int v14 = [v13 isEqualToString:*MEMORY[0x1E4F5BA48]];
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v61 = 2112;
        long long v62 = v18;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Rejecting attempt to associate acc info service with UUID %@ in home %@", buf, 0x20u);
      }
    ...
    if (v28 >= maximumServicesPerServiceGroup)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v65 = 2112;
        long long v66 = v41;
        _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Can't add service %@:%@ to service group %@ in home %@; already at maximum services for group",
          buf,
          0x34u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v65 = 2112;
        long long v66 = v35;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Service %@:%@ already exists in service group %@ in home %@", buf, 0x34u);
    ...
    __int16 v42 = objc_msgSend(MEMORY[0x1E4F28C58], "hmErrorWithCode:", v36, v49);
    os_unfair_lock_unlock(lock);
    if (v42)
    {
...
- (void)_registerForMessages
{
  ...
  if (v3)
  {
    ...
    uint64_t v6 = *MEMORY[0x1E4F2EC70];
    ...
    uint64_t v16 = *MEMORY[0x1E4F2EDB0];
    ...
    v24[1] = v18;
    __int16 v19 = [MEMORY[0x1E4F1C978] arrayWithObjects:v24 count:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      unint64_t v28 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Not registering for messages as home is nil", buf, 0xCu);
    }
  }
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v17 encodeObject:v5 forKey:*MEMORY[0x1E4F2EE00]];

  uint64_t v6 = [(HMDServiceGroup *)self uuid];
  id v7 = [v6 UUIDString];
  [v17 encodeObject:v7 forKey:*MEMORY[0x1E4F2EE20]];
  ...
  if (v10) {
    ...
    objc_msgSend(v17, "hm_encodeArrayOfConditionalObjects:forKey:", v11, *MEMORY[0x1E4F2EE18]);

    [v17 encodeObject:self->_serviceUUIDs forKey:*MEMORY[0x1E4F2EE10]];
  }
  else {
    id v12 = {;
  }
    objc_msgSend(v17, "hm_encodeArrayOfConditionalObjects:forKey:", v12, *MEMORY[0x1E4F2EE18]);
  }
  os_unfair_lock_unlock(&self->_lock);
  if (v8)
  {
...
- (HMDServiceGroup)initWithCoder:(id)a3
{
  ...
  uint64_t v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2EE00]];
  id v7 = objc_msgSend(v6, "hm_truncatedNameString");

  int v8 = objc_msgSend(v4, "hm_decodeAndCacheUUIDFromStringForKey:", *MEMORY[0x1E4F2EE20]);
  int v9 = [(HMDServiceGroup *)self initWithName:v7 uuid:v8 home:v5 queue:0];
  if (v9)
  {
    int v10 = objc_msgSend(v4, "hm_decodeArrayOfConditionalObjects:forKey:", objc_opt_class(), *MEMORY[0x1E4F2EE18]);
    uint64_t v11 = (void *)MEMORY[0x1E4F1CAD0];
    v47[0] = objc_opt_class();
    v47[1] = objc_opt_class();
    id v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v47 count:2];
    id v13 = [v11 setWithArray:v12];
    v41 = [v4 decodeObjectOfClasses:v13 forKey:*MEMORY[0x1E4F2EE10]];

    int v14 = v10;
    id v15 = &OBJC_IVAR___HMDHome__mediaGroupsAggregateConsumer;
    if ([v10 count])
    {
      v37 = v8;
      __int16 v38 = v7;
...
- (void)removeService:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      int v16 = 138543362;
      uint64_t v17 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Cannot remove nil service from service group", (uint8_t *)&v16, 0xCu);
    }
  }
}
...
void __40__HMDServiceGroup__handleRenameRequest___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  else
  {
    ...
    uint64_t v6 = *MEMORY[0x1E4F2EE08];
    v7[0] = v4;
...
- (id)dumpState
{
  ...
  id v26 = [MEMORY[0x1E4F1CA60] dictionaryWithCapacity:2];
  v2 = NSString;
  ...
  [v26 setObject:v25 forKeyedSubscript:*MEMORY[0x1E4F64EA0]];
  os_unfair_lock_lock_with_options();
  ...
  {
    id v24 = v7;
    uint64_t v29 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v7, "count"));
    long long v32 = 0u;
    long long v33 = 0u;
    long long v30 = 0u;
    long long v31 = 0u;
    ...
    if (v8)
    {
      ...
      long long v10 = (void *)*MEMORY[0x1E4F5BB98];
      do
      {
    ...
    [v26 setObject:v29 forKeyedSubscript:*MEMORY[0x1E4F64E80]];
    id v21 = [(HMDServiceGroup *)self appData];
    id v22 = [v21 dumpState];
    [v26 setObject:v22 forKeyedSubscript:*MEMORY[0x1E4F64D80]];
...
- (HMDServiceGroup)initWithName:(id)a3 uuid:(id)a4 home:(id)a5 queue:(id)a6
{
  ...
  if (v14)
  {
    ...
    uint64_t v19 = objc_msgSend(MEMORY[0x1E4F654F0], "hmf_cachedInstanceForNSUUID:", v17);
    uuid = v14->_uuid;
    v14->_uuid = (NSUUID *)v19;

    id v21 = spiClientIdentifierForUUID(v14->_uuid);
    uint64_t v22 = objc_msgSend(MEMORY[0x1E4F654F0], "hmf_cachedInstanceForNSUUID:", v21);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t33 != -1) {
    dispatch_once(&logCategory__hmf_once_t33, &__block_literal_global_21496);
  }
...
- (NSDictionary)assistantObject
{
  ...
  if (v4 && v3)
  {
    ...
    if (v6)
    {
      ...
      v20[6] = *MEMORY[0x1E4F97020];
      id v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v20 forKeys:v19 count:7];
