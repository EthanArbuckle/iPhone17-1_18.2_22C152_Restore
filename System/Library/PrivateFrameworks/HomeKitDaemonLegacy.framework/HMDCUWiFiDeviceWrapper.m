...
- (void)startConfigurationWithCompletionHandler:(id)a3
{
  ...
  if (self->_wacSession)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)((char *)&buf + 4) = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@WACSession already active for device", (uint8_t *)&buf, 0xCu);
    }
  }
  else
  {
    id v9 = (CUWACSession *)objc_alloc_init(MEMORY[0x1E4F5E210]);
    ...
    *((void *)&buf + 1) = &buf;
    ...
    v22 = __Block_byref_object_copy__91159;
    v23 = __Block_byref_object_dispose__91160;
    id v24 = 0;
    objc_initWeak(&location, self);
    ...
    if (a2 == 200)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        ...
        uint32_t v29 = 12;
LABEL_65:
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, v27, buf, v29);
      }
    }
    else
    {
        ...
        *(void *)(v9 + 40) = v8;
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)long long buf = 138543618;
          ...
          __int16 v36 = 2112;
          v37 = v15;
          _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@WAC setup failed: %@", buf, 0x16u);
        }
...
LABEL_64:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543362;
    ...
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@WAC setup finalized, calling completion", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_91195 != -1) {
    dispatch_once(&logCategory__hmf_once_t18_91195, &__block_literal_global_96);
  }
  v2 = (void *)logCategory__hmf_once_v19_91196;
  return v2;
}
...
uint64_t __37__HMDCUWiFiDeviceWrapper_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v19_91196;
  logCategory__hmf_once_v19_91196 = v0;
