...
- (void)firmwareUpdateResult:(id)a3 vendorSpecificStatus:(unsigned int)a4 error:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@firmwareUpdateResult: No session exists", (uint8_t *)&v16, 0xCu);
    }
  }
}
...
- (BOOL)sendMessageToAccessory:(id)a3 uarpMsg:(id)a4 error:(id *)a5
{
  ...
  else
  {
    if (a5 && !*a5)
    {
      *a5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:0 reason:@"UARP session not found" suggestion:0];
    }
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v19;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: failed for %@ with error %@", (uint8_t *)&v21, 0x20u);
    }
    BOOL v13 = 0;
  }
...
void __81__HMDDefaultUARPControllerDelegate_stagedFirmwareApplicationComplete_withStatus___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@firmware UARP apply request completed with status %@ for accessory %@", (uint8_t *)&v9, 0x20u);
  }
}
...
- (void)firmwareStagingComplete:(id)a3 assetID:(id)a4 withStatus:(unint64_t)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      uint64_t v18 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@firmwareUpdateComplete: No session exists for accessory", (uint8_t *)&v17, 0xCu);
    }
  }
}
...
- (void)firmwareStagingProgress:(id)a3 assetID:(id)a4 bytesSent:(unint64_t)a5 bytesTotal:(unint64_t)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v10;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@firmwareStagingProgress: No session exists for accessory %@", (uint8_t *)&v19, 0x16u);
    }
  }
}
...
- (void)assetAvailablityUpdateForAccessory:(id)a3 assetID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&buf[24] = UARPFirmwareUpdateAvailabilityStatusToString();
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update Available for accessory:%@ status:%s", buf, 0x20u);
  }
    ...
    if (v18)
    {
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          *(void *)&buf[24] = v27;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Available version %@ is equal or older than current accessory version %@", buf, 0x20u);
...
LABEL_24:
    ...
    _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, v29, buf, v31);
    goto LABEL_23;
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&buf[4] = v17;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not supported on this device; ignoring",
      buf,
      0xCu);
  }
LABEL_26:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_30279 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_30279, &__block_literal_global_30280);
  }
  v2 = (void *)logCategory__hmf_once_v1_30281;
  return v2;
}
...
uint64_t __47__HMDDefaultUARPControllerDelegate_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_30281;
  logCategory__hmf_once_v1_30281 = v0;
