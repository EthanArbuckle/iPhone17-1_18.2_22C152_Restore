...
- (void)handleRemovedFaceprintWithUUID:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribers of removed faceprint UUID: %@", buf, 0x16u);
  }
  v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC10]);
  v16 = v13;
  v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v16 forKeys:&v15 count:1];

  [(HMDHomeKitPersonDataInterface *)v10 _notifySubscribersOfMessageWithName:*MEMORY[0x1E4F2DBA0] payload:v14];
}
...
- (void)handleRemovedFaceCropWithUUID:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribers of removed face crop UUID: %@", buf, 0x16u);
  }
  v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC08]);
  v16 = v13;
  v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v16 forKeys:&v15 count:1];
...
- (void)handleRemovedPersonWithUUID:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribers of removed person UUID: %@", buf, 0x16u);
  }
  v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC18]);
  v16 = v13;
  v14 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v16 forKeys:&v15 count:1];
...
- (void)handleUpdatedFaceprint:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Notifying subscribers of updated faceprint: %@", buf, 0x16u);
  }
  v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC28]);
  v14 = encodeRootObject();
  v17 = v14;
  uint64_t v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v17 forKeys:&v16 count:1];

  [(HMDHomeKitPersonDataInterface *)v10 _notifySubscribersOfMessageWithName:*MEMORY[0x1E4F2DBA0] payload:v15];
}
...
- (void)handleUpdatedPersonFaceCrop:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v13;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Notifying subscribers of updated person face crop: %@", buf, 0x16u);
  }
  v14 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC30]);
  uint64_t v15 = encodeRootObject();
  v18 = v15;
  uint64_t v16 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v18 forKeys:&v17 count:1];

  [(HMDHomeKitPersonDataInterface *)v10 _notifySubscribersOfMessageWithName:*MEMORY[0x1E4F2DBA0] payload:v16];
}
...
- (void)handleUpdatedUnassociatedFaceCrop:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribers of updated unassociated face crop: %@", buf, 0x16u);
  }
  v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC40]);
  v14 = encodeRootObject();
  uint64_t v17 = v14;
  uint64_t v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v17 forKeys:&v16 count:1];
...
- (void)handleUpdatedPerson:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    id v21 = v6;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribers of updated person: %@", buf, 0x16u);
  }
  v13 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithObject:", v6, *MEMORY[0x1E4F2DC38]);
  v14 = encodeRootObject();
  uint64_t v17 = v14;
  uint64_t v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v17 forKeys:&v16 count:1];
...
LABEL_7:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v47 = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Configuring HomeKit person data interface", buf, 0xCu);
  }
  ...
  v45[0] = v13;
  v45[1] = v40;
  uint64_t v17 = [MEMORY[0x1E4F1C978] arrayWithObjects:v45 count:2];
  v18 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v18 registerForMessage:*MEMORY[0x1E4F2DC68] receiver:v10 policies:v17 selector:sel_handleSubscribeMessage_];

  __int16 v19 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v19 registerForMessage:*MEMORY[0x1E4F2DC70] receiver:v10 policies:v17 selector:sel_handleUnsubscribeMessage_];

  __int16 v20 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v20 registerForMessage:*MEMORY[0x1E4F2DC48] receiver:v10 policies:v17 selector:sel_handlePerformCloudPullMessage_];

  id v21 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v21 registerForMessage:*MEMORY[0x1E4F2DBC8] receiver:v10 policies:v17 selector:sel_handleFetchPersonsMessage_];

  uint64_t v22 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v22 registerForMessage:*MEMORY[0x1E4F2DBB0] receiver:v10 policies:v17 selector:sel_handleFetchFaceCropsMessage_];

  uint64_t v23 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v23 registerForMessage:*MEMORY[0x1E4F2DBC0] receiver:v10 policies:v17 selector:sel_handleFetchPersonFaceCropsMessage_];

  v24 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v24 registerForMessage:*MEMORY[0x1E4F2DBD0] receiver:v10 policies:v17 selector:sel_handleFetchUnassociatedFaceCropsMessage_];

  v25 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v25 registerForMessage:*MEMORY[0x1E4F2DBB8] receiver:v10 policies:v17 selector:sel_handleFetchFaceprintsMessage_];

  v44[0] = v13;
  v44[1] = v14;
  v44[2] = v38;
  v26 = [MEMORY[0x1E4F1C978] arrayWithObjects:v44 count:3];
  v43[0] = v13;
  v43[1] = v14;
  v43[2] = v15;
  v27 = [MEMORY[0x1E4F1C978] arrayWithObjects:v43 count:3];
  v42[0] = v13;
  v42[1] = v14;
  v42[2] = v16;
  v28 = [MEMORY[0x1E4F1C978] arrayWithObjects:v42 count:3];
  v29 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v29 registerForMessage:*MEMORY[0x1E4F2DB90] receiver:v10 policies:v26 selector:sel_handleAddOrUpdatePersonsMessage_];

  v30 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v30 registerForMessage:*MEMORY[0x1E4F2DB80] receiver:v10 policies:v26 selector:sel_handleAddOrUpdateFaceCropsMessage_];

  v31 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v31 registerForMessage:*MEMORY[0x1E4F2DB88] receiver:v10 policies:v26 selector:sel_handleAddOrUpdateFaceprintsMessage_];

  v32 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v32 registerForMessage:*MEMORY[0x1E4F2DB98] receiver:v10 policies:v27 selector:sel_handleAssociateFaceCropsMessage_];

  v33 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v33 registerForMessage:*MEMORY[0x1E4F2DBA8] receiver:v10 policies:v27 selector:sel_handleDisassociateFaceCropsMessage_];

  v34 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v34 registerForMessage:*MEMORY[0x1E4F2DC60] receiver:v10 policies:v28 selector:sel_handleRemovePersonsMessage_];

  v35 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v35 registerForMessage:*MEMORY[0x1E4F2DC50] receiver:v10 policies:v28 selector:sel_handleRemoveFaceCropsMessage_];

  v36 = [(HMDHomeKitPersonDataInterface *)v10 messageDispatcher];
  [v36 registerForMessage:*MEMORY[0x1E4F2DC58] receiver:v10 policies:v28 selector:sel_handleRemoveFaceprintsMessage_];
...
- (void)handleRemoveFaceprintsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    v26 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling remove face crops message payload: %@", buf, 0x16u);
  }
  v11 = [v4 setForKey:*MEMORY[0x1E4F2DBE8]];
  if (v11)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      v26 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not find faceprints UUIDs in message payload: %@", buf, 0x16u);
    }
...
- (void)handleRemoveFaceCropsMessage:(id)a3
{
  ...
  v11 = [v4 setForKey:*MEMORY[0x1E4F2DBD8]];
  if (v11)
  {
    v12 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      v26 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not find face crop UUIDs in message payload: %@", buf, 0x16u);
    }
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
    [v4 respondWithError:v15];
  }
...
- (void)handleRemovePersonsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    v26 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling remove persons message payload: %@", buf, 0x16u);
  }
  v11 = [v4 setForKey:*MEMORY[0x1E4F2DBF8]];
  if (v11)
  {
    v12 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      v26 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not find person UUIDs in message payload: %@", buf, 0x16u);
    }
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
    [v4 respondWithError:v15];
  }
...
- (void)handleDisassociateFaceCropsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    v26 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling disassociate face crops message payload: %@", buf, 0x16u);
  }
  v11 = [v4 setForKey:*MEMORY[0x1E4F2DBD8]];
  if (v11)
  {
...
- (void)handleAssociateFaceCropsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v40 = 2112;
    v41 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling associate face crops message payload: %@", buf, 0x16u);
  }
  v11 = [v4 setForKey:*MEMORY[0x1E4F2DBD8]];
  if (v11)
  {
    v12 = [v4 setForKey:*MEMORY[0x1E4F2DBF8]];
    v13 = [v12 anyObject];

    if (v13)
    {
      id v14 = [v4 numberForKey:*MEMORY[0x1E4F2DC20]];
      uint64_t v15 = v14;
      if (v14)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v40 = 2112;
          v41 = v35;
          _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Could not find source in message payload: %@", buf, 0x16u);
        }
        __int16 v20 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v40 = 2112;
        v41 = v30;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Could not find person UUID in message payload: %@", buf, 0x16u);
      }
      uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
      [v4 respondWithError:v15];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      v41 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Could not find face crop UUIDs in message payload: %@", buf, 0x16u);
    }
    v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
- (void)handleAddOrUpdateFaceprintsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    v29 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling add/update faceprints message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = *MEMORY[0x1E4F2DBF0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      v29 = v22;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not find faceprints in message payload: %@", buf, 0x16u);
    }
...
- (void)handleAddOrUpdateFaceCropsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    v29 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling add/update face crops message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = *MEMORY[0x1E4F2DBE0];
  v25[0] = objc_opt_class();
  v25[1] = objc_opt_class();
  v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v25 count:2];
  v13 = [v4 unarchivedObjectForKey:v11 ofClasses:v12];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      v29 = v22;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not find face crops in message payload: %@", buf, 0x16u);
    }
    uint64_t v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    [v4 respondWithError:v17];
  }
...
- (void)handleAddOrUpdatePersonsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    v29 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling add/update persons message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = *MEMORY[0x1E4F2DC00];
  v25[0] = objc_opt_class();
  v25[1] = objc_opt_class();
  v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:v25 count:2];
  v13 = [v4 unarchivedObjectForKey:v11 ofClasses:v12];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      v29 = v22;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not find persons in message payload: %@", buf, 0x16u);
    }
    uint64_t v17 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    [v4 respondWithError:v17];
  }
...
- (void)handleFetchFaceprintsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    id v35 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch faceprints message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  if ([v11 isDataAvailable])
  {
    v12 = [v4 setForKey:*MEMORY[0x1E4F2DBD8]];
    if (v12)
    {
      id v13 = [v11 faceprintsForFaceCropsWithUUIDs:v12];
      uint64_t v30 = *MEMORY[0x1E4F2DBF0];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v34 = 2112;
          id v35 = v4;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch server from message: %@", buf, 0x16u);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch faceprints because data is not available", buf, 0xCu);
    }
...
- (void)handleFetchUnassociatedFaceCropsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v30 = 2112;
    id v31 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch unassociated face crops message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  if ([v11 isDataAvailable])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v30 = 2112;
        id v31 = v4;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch server from message: %@", buf, 0x16u);
      }
      uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
      [v4 respondWithError:v15];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v29 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch face crops because data is not available", buf, 0xCu);
    }
...
- (void)handleFetchPersonFaceCropsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    id v35 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch person face crops message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  if ([v11 isDataAvailable])
  {
    ...
    if (v12)
    {
      ...
      uint64_t v30 = *MEMORY[0x1E4F2DBE0];
      id v14 = encodeRootObjectForIncomingXPCMessage(v13, 0);
      id v31 = v14;
      uint64_t v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v31 forKeys:&v30 count:1];
      [v4 respondWithPayload:v15];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch person face crops because data is not available", buf, 0xCu);
    }
    v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)handleFetchFaceCropsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    id v35 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch face crops message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  if ([v11 isDataAvailable])
  {
...
- (void)handleFetchPersonsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    id v35 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch persons message payload: %@", buf, 0x16u);
  }
  uint64_t v11 = [(HMDHomeKitPersonDataInterface *)v7 dataSource];
  if ([v11 isDataAvailable])
  {
    ...
    if (v12)
    {
      ...
      uint64_t v30 = *MEMORY[0x1E4F2DC00];
      id v14 = encodeRootObjectForIncomingXPCMessage(v13, 0);
      id v31 = v14;
      uint64_t v15 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v31 forKeys:&v30 count:1];
      [v4 respondWithPayload:v15];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch persons because data is not available", buf, 0xCu);
    }
    v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)_notifySubscribersOfMessageWithName:(id)a3 payload:(id)a4
{
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribers", buf, 0x16u);
    }
    long long v34 = 0u;
    long long v35 = 0u;
    long long v32 = 0u;
    ...
    if (v19)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          uint64_t v24 = [MEMORY[0x1E4F654B0] entitledMessageWithName:v31 messagePayload:v30];
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v29;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify", buf, 0xCu);
    }
  }
}
...
{
  v3 = (objc_class *)MEMORY[0x1E4F2E720];
  id v4 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t42_133672 != -1) {
    dispatch_once(&logCategory__hmf_once_t42_133672, &__block_literal_global_133673);
  }
  v2 = (void *)logCategory__hmf_once_v43_133674;
  return v2;
}
...
uint64_t __44__HMDHomeKitPersonDataInterface_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v43_133674;
  logCategory__hmf_once_v43_133674 = v0;
