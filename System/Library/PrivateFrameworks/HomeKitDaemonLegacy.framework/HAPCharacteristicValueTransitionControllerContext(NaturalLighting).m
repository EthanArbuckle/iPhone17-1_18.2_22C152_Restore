...
- (HMDNaturalLightingActiveTransitionContext)activeTransitionContext
{
  ...
  if (v2)
  {
    v3 = objc_msgSend(MEMORY[0x1E4F29128], "hmf_UUIDWithBytesAsData:", v2);
    v4 = v3;
    if (v3
      && ([v3 UUIDString],
          ...
          v6))
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v21 = 2112;
          v22 = a1;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Start time missing in the controller context %@", (uint8_t *)&v19, 0x16u);
        }
        v14 = 0;
      }
    }
