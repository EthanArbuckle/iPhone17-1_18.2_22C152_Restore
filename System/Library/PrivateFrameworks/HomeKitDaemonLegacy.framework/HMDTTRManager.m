...
+ (HMMRadarRequestFilter)defaultFilter
{
  ...
  sub_1D5459AC8();
  swift_allocObject();
  uint64_t v3 = sub_1D5459AB8();
  v4 = (void *)sub_1D4A522E0(v2, v3);
  swift_release();
...
- (void)handleResetLastTTRTime:(id)a3
{
  ...
  [v4 radarRequestedForDisplayReason:&stru_1F2C9F1A8];
...
- (void)initiateRadarWithTitle:(id)a3 componentName:(id)a4 componentVersion:(id)a5 componentID:(int64_t)a6 displayReason:(id)a7 attachments:(id)a8 isUserInitiated:(BOOL)a9
{
  ...
  [v23 setDiagnosticExtensionIDs:&unk_1F2DC6A18];
...
void __125__HMDTTRManager_initiateRadarWithTitle_componentName_componentVersion_componentID_displayReason_attachments_isUserInitiated___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error trying to create radar draft: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
void __129__HMDTTRManager_requestRadarWithDisplayReason_radarTitle_componentName_componentVersion_componentID_attachments_waitForResponse___block_invoke(uint64_t a1)
{
  ...
  {
    id v3 = (void *)MEMORY[0x1D9452090]([v2 radarRequestedForDisplayReason:*(void *)(a1 + 40)]);
    id v4 = *(id *)(a1 + 32);
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2114;
      uint64_t v28 = v7;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Requesting radar because %{public}@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Radar request filtered out: %@", buf, 0x16u);
    }
  }
}
...
+ (id)queue
{
  if (queue__hmf_once_t10 != -1) {
    dispatch_once(&queue__hmf_once_t10, &__block_literal_global_35);
  }
...
+ (id)namespaceUUID
{
  if (namespaceUUID__hmf_once_t8 != -1) {
    dispatch_once(&namespaceUUID__hmf_once_t8, &__block_literal_global_16098);
  }
...
{
  namespaceUUID__hmf_once_uint64_t v9 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"B4FFBCEC-B0A2-4660-B1B2-4B484FE76D74"];
...
+ (id)sharedManager
{
  ...
  block[4] = a1;
  if (sharedManager_onceToken_16101 != -1) {
    dispatch_once(&sharedManager_onceToken_16101, block);
  }
...
void __30__HMDTTRManager_sharedManager__block_invoke(uint64_t a1)
{
  ...
  if (isInternalBuild())
  {
    if (TapToRadarKitLibraryCore())
    {
      ...
      v15[0] = v9;
      __int16 v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v15 count:1];
