...
- (id)_nextTimerDateAfterDate:(id)a3 timeZone:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    v28 = v14;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Determining next fire date after date %@ using components: %@ recurrence: %@", (uint8_t *)&v21, 0x2Au);
  }
  v15 = objc_opt_class();
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  uint64_t v6 = objc_msgSend(MEMORY[0x1E4F1C9D8], "hmf_unarchiveFromData:error:", v5, 0);
...
+ (id)_nextRecurrentFireDateAfterDate:(id)a3 recurrences:(id)a4
{
  ...
  [v19 setWeekday:v14];
  int v21 = [MEMORY[0x1E4F1C9A8] currentCalendar];
...
LABEL_28:
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, v40, buf, 0x16u);
        }
      }
      else
      {
...
LABEL_14:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v48 = 2112;
      v49 = v16;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Determined next fire date by assigning fire date components to current date: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v48 = 2112;
    v49 = v27;
    _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Determined next fire date by assigning fire recurrent date components to current date: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_9787 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_9787, &__block_literal_global_9788);
  }
  v2 = (void *)logCategory__hmf_once_v1_9789;
  return v2;
}

uint64_t __31__HMDCalendarEvent_logCategory__block_invoke()
{
  logCategory__hmf_once_v1_9789 = HMFCreateOSLogHandle();
