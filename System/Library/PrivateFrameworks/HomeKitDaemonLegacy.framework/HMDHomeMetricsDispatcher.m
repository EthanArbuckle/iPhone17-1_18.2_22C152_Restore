...
- (void)submitMigrationEventMetricsForModel:(id)a3 reason:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting migration event metric for model: %@ reason: %@", (uint8_t *)&v14, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_7370 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_7370, &__block_literal_global_7371);
  }
  v2 = (void *)logCategory__hmf_once_v2_7372;
  return v2;
}

uint64_t __39__HMDHomeMetricsDispatcher_logCategory__block_invoke()
{
  logCategory__hmf_once_v2_7372 = HMFCreateOSLogHandle();
