...
- (void)scannerDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@WAC Scan Stopped...", buf, 0xCu);
  }
  if ([(HMDWACBrowser *)v6 scanIsActive])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2048;
      uint64_t v19 = 2;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Scan was still flagged as active, restarting after %lu seconds...", buf, 0x16u);
    }
...
- (void)scanner:(id)a3 didError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Error while scanning for WAC devices: %@", (uint8_t *)&v12, 0x16u);
  }
}
...
- (void)scanner:(id)a3 didUpdateDevice:(id)a4
{
  ...
  if (v12)
  {
    dispatch_time_t v13 = (void *)MEMORY[0x1D9452090]();
    __int16 v14 = v8;
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v20[22] = 2112;
      v21 = v9;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating WAC device: %@ -> %@", v20, 0x20u);
    }
    [v12 setWACDevice:v9];
    ...
    if (v18)
    {
      ...
      *(void *)uint64_t v20 = MEMORY[0x1E4F143A8];
...
- (void)clearBackoff
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Backoff cleared", buf, 0xCu);
  }
...
- (void)requestBackoff
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Backoff requested", buf, 0xCu);
  }
  dispatchQueue = v4->_dispatchQueue;
  block[0] = MEMORY[0x1E4F143A8];
  block[1] = 3221225472;
...
uint64_t __44__HMDWACBrowser_startBrowsingForAccessories__block_invoke(uint64_t a1)
{
  ...
  if ((result & 1) == 0)
  {
    v3 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) setScanIsActive:1]);
    id v4 = *(id *)(a1 + 32);
    id v5 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v7 = 138543362;
      id v8 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Activating WAC Scanner...", (uint8_t *)&v7, 0xCu);
    }
    return [*(id *)(*(void *)(a1 + 32) + 16) start];
  }
  return result;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_111152 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_111152, &__block_literal_global_111153);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v10_111154;
  return v2;
}
...
uint64_t __28__HMDWACBrowser_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v10_111154;
  logCategory__hmf_once_v10_111154 = v0;
