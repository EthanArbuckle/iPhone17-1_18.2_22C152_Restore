...
- (id)dumpState
{
  ...
  uint64_t v4 = [v2 dictionaryWithObject:v3 forKey:*MEMORY[0x1E4F64EA0]];
...
- (HMDCharacteristicMetadata)initWithMinimumValue:(id)a3 maximumValue:(id)a4 stepValue:(id)a5 maxLength:(id)a6 validValues:(id)a7 format:(id)a8 units:(id)a9 manufacturerDescription:(id)a10
{
  ...
  if (v21)
  {
    ...
    uint64_t v23 = objc_msgSend(MEMORY[0x1E4F654E8], "hmf_cachedInstanceForString:", v18, v30, v31, v32, v33);
    format = v22->_format;
    v22->_format = (NSString *)v23;

    uint64_t v25 = objc_msgSend(MEMORY[0x1E4F654E8], "hmf_cachedInstanceForString:", v19);
    units = v22->_units;
    v22->_units = (NSString *)v25;

    uint64_t v27 = objc_msgSend(MEMORY[0x1E4F654E8], "hmf_cachedInstanceForString:", v20);
