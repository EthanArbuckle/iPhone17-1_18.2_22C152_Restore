...
- (NSUUID)modelParentIdentifier
{
  if (modelParentIdentifier_onceToken != -1) {
    dispatch_once(&modelParentIdentifier_onceToken, &__block_literal_global_109_57960);
  }
...
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"];
  uint64_t v1 = modelParentIdentifier_homeManagerUUID;
...
LABEL_32:
    ...
    long long v30 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        v44 = v40;
        id v45 = v71;
        _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@Delete request for unknown object (%@) sent to [%@ transactionObjectRemoved:message:]", buf, 0x20u);
    ...
    if (!v30)
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        id v71 = (id)objc_opt_class();
        id v56 = v71;
        _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_ERROR, "%{public}@Delete request for unknown object (%@) sent to [%@ transactionObjectRemoved:message:]", buf, 0x20u);
      }
      v57 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
LABEL_43:
  ...
  if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    id v71 = (id)objc_opt_class();
    id v51 = v71;
    _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved:message:]", buf, 0x20u);
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v8 = [(HMDAccount *)self identifier];
  id v9 = [v8 identifier];
  [v4 encodeObject:v9 forKey:@"HM.identifier"];

  id v12 = [(HMDAccount *)self handles];
  id v10 = [v12 firstObject];
  uint64_t v11 = [v10 remoteDestinationString];
...
- (HMDAccount)initWithCoder:(id)a3
{
  ...
  id v6 = [MEMORY[0x1E4F1C978] arrayWithObjects:v38 count:2];
  ...
  if ([v4 containsValueForKey:@"HM.handles"])
  {
    ...
    id v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:v37 count:2];
    uint64_t v11 = [v9 setWithArray:v10];
    id v12 = [v4 decodeObjectOfClasses:v11 forKey:@"HM.handles"];
  }
  else
  {
    id v13 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HM.destination"];
    id v10 = +[HMDAccountHandle accountHandleForDestination:v13];

    if (v10)
    {
      v36 = v10;
      id v12 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v36 count:1];
    }
    else
    {
  ...
  if (![v4 containsValueForKey:@"HM.identifier2"])
  {
    if ([v12 count])
    {
      long long v15 = [v12 firstObject];
      id v14 = +[HMDAccountIdentifier accountIdentifierForAccountHandle:v15];
...
LABEL_17:
  ...
  id v14 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HM.identifier2"];
  if (!v14)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      int v28 = 138543362;
      id v29 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid HMDAccountIdentifier in archive for HMDAccount", (uint8_t *)&v28, 0xCu);
    }
...
LABEL_11:
  if (v12 && v8)
  {
    id v16 = [(HMDAccount *)self initWithIdentifier:v14 handles:v12 devices:v8];
    id v17 = v16;
    goto LABEL_21;
  }
LABEL_18:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v34 = 2112;
    v35 = v8;
    _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot initialize HMDAccount from decoded identifier: %@ handles: %@ devices:%@ ", (uint8_t *)&v28, 0x2Au);
  }
  id v17 = 0;
LABEL_21:
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v90 = 2112;
        v91 = v9;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Updated handles: %@", buf, 0x16u);
      }
    ...
    if (v26)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v27; ++i)
        {
          ...
          __int16 v30 = *(void **)(*((void *)&v84 + 1) + 8 * i);
          char v31 = (void *)MEMORY[0x1D9452090]();
          __int16 v32 = self;
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v90 = 2112;
            v91 = v30;
            _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@Removed device: %@", buf, 0x16u);
          }
        ...
        for (uint64_t j = 0; j != v37; ++j)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v90 = 2112;
            v91 = v40;
            _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Added device: %@", buf, 0x16u);
          }
          ...
          if (v51)
          {
            ...
            if (os_log_type_enabled(v54, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v92 = 2112;
              v93 = v51;
              _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_DEBUG, "%{public}@Merging existing device: %@ with device: %@", buf, 0x20u);
            }
            if ([v50 mergeObject:v51])
            {
              ...
              if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v90 = 2112;
                v91 = v51;
                _os_log_impl(&dword_1D49D5000, v58, OS_LOG_TYPE_INFO, "%{public}@Updated device: %@", buf, 0x16u);
              }
              char v71 = 1;
            }
          }
      ...
      if (([v60 isEqualToString:v61] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v90 = 2112;
          v91 = v61;
          _os_log_impl(&dword_1D49D5000, v64, OS_LOG_TYPE_INFO, "%{public}@Updating sender correlation identifier to %@", buf, 0x16u);
        }
...
- (void)removeDevice:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v5)
    {
      id v6 = self;
      id v7 = v5;
      id v8 = [(HMDAccount *)v6 manager];
      if ([v8 shouldSyncAccount:v6]
        && [v8 shouldSyncDevice:v7])
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v17 = 2112;
          id v18 = v7;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Deregistering device: %@", (uint8_t *)&v15, 0x16u);
        }
        int v13 = [v8 backingStore];
        id v14 = [v7 modelBackedObjects];
...
- (void)addDevice:(id)a3
{
  ...
  {
    os_unfair_lock_lock_with_options();
    char v5 = __HMDAccountAddDevice(self, v4);
    os_unfair_lock_unlock(&self->_lock);
    if (v5)
    {
      [v4 setAccount:self];
        ...
        && [v8 shouldSyncDevice:v7])
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v17 = 2112;
          id v18 = v7;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering device: %@", (uint8_t *)&v15, 0x16u);
        }
        int v13 = [v8 backingStore];
        id v14 = [v7 modelBackedObjects];
...
- (void)_repairDevicesWithStaleHandle:(id)a3
{
  ...
  id v4 = a3;
  id v40 = [(HMDAccount *)self primaryHandle];
  id v5 = [(HMDAccount *)self devices];
  ...
  id v37 = v4;
  id v46 = v37;
  id v6 = objc_msgSend(v5, "na_filter:", v45);
  ...
  long long v42 = 0u;
  id v7 = v6;
  uint64_t v8 = [v7 countByEnumeratingWithState:&v41 objects:v53 count:16];
  id v39 = v7;
  if (v8)
  {
    uint64_t v9 = v8;
    ...
    do
    {
        ...
        if (v40)
        {
          if (v16)
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v58 = 2112;
            id v59 = v40;
            _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Repairing stale handle for device %@ updating to %@", buf, 0x20u);
        ...
        else
        {
          if (v16)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v56 = 2112;
            v57 = v12;
            _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Removing device from empty account %@", buf, 0x16u);
      ...
      uint64_t v9 = [v7 countByEnumeratingWithState:&v41 objects:v53 count:16];
    }
    while (v9);
  }
  ...
  if (v40)
  {
    ...
    id v22 = v21;
    id v52 = v22;
    id v23 = objc_msgSend(v20, "na_filter:", v51);
    if ([v22 shouldSyncAccount:v19] && objc_msgSend(v23, "count"))
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v56 = 2112;
        v57 = v23;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Updating devices: %@", buf, 0x16u);
      }
      uint64_t v38 = v23;
      ...
      long long v50 = 0u;
      id v29 = v20;
      uint64_t v30 = [v29 countByEnumeratingWithState:&v47 objects:buf count:16];
      if (v30)
      {
        uint64_t v31 = v30;
        ...
        do
        {
          for (uint64_t j = 0; j != v31; ++j)
          {
            ...
            __int16 v34 = [*(id *)(*((void *)&v47 + 1) + 8 * j) modelBackedObjects];
            [v28 addObjectsFromArray:v34];
          }
          uint64_t v31 = [v29 countByEnumeratingWithState:&v47 objects:buf count:16];
        }
        while (v31);
      }
...
- (void)removeHandle:(id)a3
{
  ...
  {
    os_unfair_lock_lock_with_options();
    id v5 = __HMDAccountRemoveHandle(self, v4);
    os_unfair_lock_unlock(&self->_lock);
    if (v5)
    {
      id v6 = self;
      id v7 = v5;
      uint64_t v8 = [(HMDAccount *)v6 manager];
      if ([v8 shouldSyncAccount:v6])
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&v15[4] = v12;
          __int16 v16 = 2112;
          id v17 = v7;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Deregistering account handle: %@", v15, 0x16u);
        }
        long long v13 = [v8 backingStore];
...
- (void)addHandle:(id)a3
{
  ...
  {
    os_unfair_lock_lock_with_options();
    char v5 = __HMDAccountAddHandle(self, v4);
    os_unfair_lock_unlock(&self->_lock);
    if (v5)
    {
      id v6 = self;
      ...
      if ([v8 shouldSyncAccount:v6])
      {
        ...
        {
          char v12 = HMFGetLogIdentifier();
          *(_DWORD *)__int16 v16 = 138543618;
          *(void *)&v16[4] = v12;
          __int16 v17 = 2112;
          id v18 = v7;
          _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering account handle: %@", v16, 0x16u);
        }
        long long v13 = [(HMDAccount *)v10 modelIdentifier];
        [v7 setModelParentIdentifier:v13];

        long long v14 = [v8 backingStore];
        *(void *)__int16 v16 = v7;
        long long v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:v16 count:1];
...
- (void)setHandles:(id)a3
{
  ...
  if (v4)
  {
    char v5 = [MEMORY[0x1E4F1CAD0] setWithArray:v4];
    os_unfair_lock_lock_with_options();
      ...
      if (v7)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v7; ++i)
          {
            ...
            char v11 = objc_msgSend(v10, "modelParentIdentifier", (void)v14);
            BOOL v12 = v11 == 0;
...
- (HMDAccountHandle)primaryHandle
{
    ...
    || ([v3 primaryHandleForAccount:self], (id v4 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    p_locuint64_t k = &self->_lock;
    os_unfair_lock_lock_with_options();
    id v6 = [MEMORY[0x1E4F1CA70] orderedSetWithSet:self->_handles];
    [v6 sortUsingComparator:&__block_literal_global_58019];
    id v4 = [v6 lastObject];
...
uint64_t __27__HMDAccount_primaryHandle__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6 == [v5 isLocal])
  {
    ...
    char v11 = [v9 stringForObjectValue:v5];
...
- (void)setAppleAccountSenderCorrelationIdentifier:(id)a3
{
  ...
  if (self)
  {
    ...
    if (v6)
    {
      ...
      {
        HMFGetLogIdentifier();
        uint64_t v19 = *(_DWORD *)buf = 138543362;
        long long v14 = (void *)v19;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: MergeID cannot be updated on an account with identifier based on MergeID", buf, 0xCu);
      }
      long long v15 = [[HMDAssertionLogEvent alloc] initWithReason:@"MergeID cannot be updated on an account with identifier based on MergeID"];
      long long v16 = +[HMDMetricsManager sharedLogEventSubmitter];
      [v16 submitLogEvent:v15];
    }
    uint64_t v7 = [(HMDAccount *)self identifier];
    uint64_t v8 = [v7 senderCorrelationIdentifier];

    if (!v8 && v17 && (HMFEqualObjects() & 1) == 0)
    {
      uint64_t v9 = (NSString *)[v17 copy];
...
- (NSString)name
{
  ...
  if (!v3
    || ([MEMORY[0x1E4F1B910] stringFromContact:v3 style:0],
...
- (id)attributeDescriptions
{
  ...
  uint64_t v9 = (void *)[v7 initWithName:@"MID" value:v8];
  v18[1] = v9;
  ...
  v18[3] = v15;
  long long v16 = [MEMORY[0x1E4F1C978] arrayWithObjects:v18 count:4];
...
- (void)isOfKnownPersonWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      id v10 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Account is not present in contacts, checking family circle.", (uint8_t *)&v9, 0xCu);
    }
        ...
        if (v9)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v25 = 2112;
            uint64_t v26 = v8;
            _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Found contact: %@ for handle: %@", buf, 0x20u);
          }
...
{
  id v4 = [a3 identifier];
  BOOL v5 = [(HMDAccount *)self initWithIdentifier:v4 handles:MEMORY[0x1E4F1CBF0] devices:MEMORY[0x1E4F1CBF0]];
...
- (HMDAccount)initWithIdentifier:(id)a3 handles:(id)a4 devices:(id)a5
{
  ...
  if (v8)
  {
    ...
    uint64_t v11 = [(HMDAccount *)&v48 init];
    if (v11)
    {
      ...
      if (v26)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v27; ++i)
          {
            ...
            uint64_t v31 = [v30 modelParentIdentifier];

            if (!v31)
            {
              uint64_t v32 = [(HMDAccount *)v11 modelIdentifier];
      ...
      if (v10) {
        [MEMORY[0x1E4F1CA80] setWithArray:v10];
      }
      else {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v52 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Missing account identifier", buf, 0xCu);
    }
    __int16 v23 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t27_58060 != -1) {
    dispatch_once(&logCategory__hmf_once_t27_58060, &__block_literal_global_77_58061);
  }
  v2 = (void *)logCategory__hmf_once_v28_58062;
  return v2;
}
...
uint64_t __25__HMDAccount_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v28_58062;
  logCategory__hmf_once_v28_58062 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}
...
+ (HMDAccount)accountWithHandle:(id)a3
{
  ...
  id v8 = (void *)[v5 initWithIdentifier:v6 handles:v7 devices:MEMORY[0x1E4F1CBF0]];
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        uint64_t v11 = [v10 stringForObjectValue:v9];
...
{
  id v4 = a3;
  id v5 = objc_alloc_init(MEMORY[0x1E4F61858]);
  [v5 setCachePolicy:2];
...
uint64_t __66__HMDAccount_FamilyCircle__isPresentInFamilyCircleWithCompletion___block_invoke_2(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    v16[1] = 3221225472;
    v16[2] = __66__HMDAccount_FamilyCircle__isPresentInFamilyCircleWithCompletion___block_invoke_290;
    v16[3] = &unk_1E6A0C348;
    v16[4] = *(void *)(a1 + 40);
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      long long v20 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Account is in family circle: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      long long v20 = v14;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch family members with error: %@", buf, 0x16u);
    }
    id v9 = *(uint64_t (**)(void))(*(void *)(a1 + 56) + 16);
  }
  return v9();
...
uint64_t __66__HMDAccount_FamilyCircle__isPresentInFamilyCircleWithCompletion___block_invoke_290(uint64_t a1, uint64_t a2)
{
