...
+ (id)localDeviceIDSIdentifier
{
  ...
  else
  {
    ...
    if (!v4)
    {
      uint64_t v5 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v3];
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@localDeviceID: %@", (uint8_t *)&v11, 0x16u);
    }
    id v2 = (id)localDeviceIDSIdentifier_localDeviceID;
  }
  return v2;
