  ...
  if (!self->super.submitted)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v17 = 2112;
      v18 = v9;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Submitting shared user send invite latency log event %@ error:%@", buf, 0x20u);
    }
    v12.receiver = v4;
...
- (void)markSendInviteEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v21 = 138543362;
    v22 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markSendInviteEnd", (uint8_t *)&v21, 0xCu);
  }
...
- (void)markSendInviteBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markSendInviteBegin", (uint8_t *)&v10, 0xCu);
  }
...
- (void)markUserAlreadyAddedToShare
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markUserAlreadyAddedToShare", (uint8_t *)&v12, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markCreateShareEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreateShareEnd", (uint8_t *)&v15, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markCreateShareBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreateShareBegin", (uint8_t *)&v10, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (HMDSharedUserInviteOwnerSendLogEventBuilder)initWithHome:(id)a3 sessionIdentifier:(id)a4 invitationType:(unint64_t)a5
{
  ...
  v11 = [(HMDSharedUserInviteOwnerSendLogEventBuilder *)self initWithHome:v9 sessionIdentifier:v8 invitationType:a5 logEventSubmitter:v10 currentUpTicksBlock:&__block_literal_global_173928 submissionTimerFactory:&__block_literal_global_4_173929];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_173939 != -1) {
    dispatch_once(&logCategory__hmf_once_t16_173939, &__block_literal_global_14_173940);
  }
  v2 = (void *)logCategory__hmf_once_v17_173941;
  return v2;
}
...
uint64_t __58__HMDSharedUserInviteOwnerSendLogEventBuilder_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v17_173941;
  logCategory__hmf_once_v17_173941 = v0;
