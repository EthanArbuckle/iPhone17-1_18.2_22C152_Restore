      ...
      if (v4)
      {
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v33 = 2112;
          id v34 = v5;
          _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
        }
        v9 = *(NSObject **)(a1 + 40);
        if (v9)
        {
...
LABEL_23:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] FairPlay session is not open", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] invalid parameter", buf, 0xCu);
    }
...
{
  id v2 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27 description:@"invalid parameter" reason:0 suggestion:0];
...
{
  id v2 = [MEMORY[0x1E4F28C58] hmErrorWithCode:21 description:@"FairPlay session is not open" reason:0 suggestion:0];
  (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
}
...
{
  id v2 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 description:*(void *)(a1 + 32) reason:0 suggestion:0];
...
void __76__HMDFairPlaySAPSession_signatureForData_completionQueue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v35 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] invalid parameter", buf, 0xCu);
    }
...
LABEL_27:
  ...
  if ([*(id *)(a1 + 48) state] != 2)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v35 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] FairPlay session is not open", buf, 0xCu);
    }
  ...
  id v19 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:");
  free(v33);
  id v20 = *(NSObject **)(a1 + 40);
  if (v20)
  {
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v9;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
    }
    id v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 description:v9 reason:0 suggestion:0];
...
void __90__HMDFairPlaySAPSession__handleServerCertificate_error_completionQueue_completionHandler___block_invoke(id *a1)
{
  ...
  if (v7 || v36 != 1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v39 = 2112;
      id v40 = v9;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
    }
    id v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 description:v9 reason:0 suggestion:0];
    id v16 = a1[5];
    if (!v16) {
      goto LABEL_31;
    }
  ...
  if (!v10)
  {
    id v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"The FairPlay session delegate is missing" reason:0 suggestion:0];
    id v19 = a1[5];
    if (!v19) {
      goto LABEL_31;
    }
...
- (void)_setupSAPSessionWithCompletionQueue:(id)a3 completionHandler:(id)a4
{
  ...
  {
    id v10 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"The FairPlay session delegate is missing" reason:0 suggestion:0];
    if (v6 && v7)
    {
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v4;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@[HMDFairPlaySAPSession] %@", buf, 0x16u);
    }
...
LABEL_18:
  ...
  if (v9)
  {
    ...
    id v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:52 description:v4 reason:0 suggestion:0];
    id v14 = *(NSObject **)(a1 + 40);
    if (v14)
    {
      id v15 = *(void **)(a1 + 48);
...
- (HMDFairPlaySAPSession)initWithDelegate:(id)a3 delegateQueue:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v24 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDFairPlaySAPSession] Invalid parameter", buf, 0xCu);
    }
    uint64_t v17 = 0;
  }
