...
+ (id)optionsForArchiveURL:()HMFDigest digest:fileManager:
{
  ...
  if (v11 < 7 && ((0x79u >> v11) & 1) != 0)
  {
    ...
    if (v20)
    {
      uint64_t v22 = *MEMORY[0x1E4FA8A60];
      v39[0] = v18;
      uint64_t v23 = *MEMORY[0x1E4FA8A70];
      v38[0] = v22;
      v38[1] = v23;
      v35 = [v9 value];
      ...
      v39[1] = v25;
      v38[2] = *MEMORY[0x1E4FA8A68];
      objc_msgSend(NSNumber, "numberWithUnsignedLongLong:", objc_msgSend(v20, "fileSize"));
      v26 = v20;
      id v27 = v18;
      v29 = id v28 = v21;
      v38[3] = *MEMORY[0x1E4FA8A58];
      v39[2] = v29;
      v39[3] = MEMORY[0x1E4F1CC38];
      v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v39 forKeys:v38 count:4];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v21;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Unable to get file size with error: %@", buf, 0x16u);
      }
      v17 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Invalid digest algorithm: %@", buf, 0x16u);
    }
    v17 = 0;
  }
