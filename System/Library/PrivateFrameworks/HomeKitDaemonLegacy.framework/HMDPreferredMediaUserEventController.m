...
- (void)driverDidReload:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    int v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@PrimaryUserInfo fetch is not supported", (uint8_t *)&v9, 0xCu);
  }
}
...
- (void)driver:(id)a3 didUpdatePrimaryUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Received primaryUserInfo updates: %@", (uint8_t *)&v19, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      v20 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot update primaryUserInfo in the accessory because dataSource is nil", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
- (void)driver:(id)a3 didUpdateSettings:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    int v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Only primaryUserInfo settings is supported.", (uint8_t *)&v12, 0xCu);
  }
}
    ...
    if (!v12 || !v13)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v55 = 2112;
        id v56 = v12;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nil value in homeUUID: %@, accessoryUUID: %@", buf, 0x20u);
      }
      goto LABEL_27;
    }
    uint64_t v14 = [MEMORY[0x1E4F2E580] topicFromSuffixID:*MEMORY[0x1E4F2C388] homeUUID:v13 accessoryUUID:v12];
    v15 = [v11 eventStoreReadHandle];
    v16 = [v15 lastEventForTopic:v14];

    if (v16)
    {
      id v17 = objc_alloc(MEMORY[0x1E4F2E598]);
      v18 = [v16 encodedData];
        ...
        if ([v19 isEqual:v4])
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v52 = v23;
            _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Skip sending event update for primaryUserInfo as it matches stored", buf, 0xCu);
...
LABEL_23:
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v55 = 2112;
          id v56 = v4;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Forwarding event with topic: %@ for primaryUserInfo: %@", buf, 0x20u);
        }
        id v40 = objc_alloc(MEMORY[0x1E4F69F48]);
        ...
        id v43 = objc_alloc(MEMORY[0x1E4F69F38]);
        v44 = [v4 protoData];
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        id v54 = v14;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Error reading stored primary user for topic %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v52 = v27;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot post primaryUserInfo update event because dataSource is nil", buf, 0xCu);
  }
LABEL_28:
}
...
void __95__HMDPreferredMediaUserEventController_updatePreferredMediaUserWithPrimaryUserInfo_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Updating preferred media user: %@, type: %@", (uint8_t *)&v9, 0x20u);
  }
