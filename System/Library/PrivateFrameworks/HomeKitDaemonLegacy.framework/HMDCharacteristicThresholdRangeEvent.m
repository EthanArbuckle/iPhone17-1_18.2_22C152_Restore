...
- (BOOL)_evaluateNewValue:(id)a3
{
  ...
  if (v4 && v6)
  {
    ...
    id v9 = +[HMDCharacteristicEventBase compareValueOfCharacteristic:v8 againstValue:v6 operatorType:&unk_1F2DC8848];
    ...
    {
      objc_super v11 = (void *)MEMORY[0x1D9452090]();
      v12 = self;
      v13 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v29 = v14;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@The value hasn't changed from previous value, ignoring", buf, 0xCu);
      }
    }
    BOOL v7 = 0;
  }
LABEL_10:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v40 = 2112;
    v41 = v23;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Evaluated event, should fire (did enter range): %@, previous value: %@, current value: %@, min: %@, max: %@, %@", buf, 0x48u);
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  {
    BOOL v7 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:8];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_107212 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_107212, &__block_literal_global_107213);
  }
  v2 = (void *)logCategory__hmf_once_v1_107214;
  return v2;
}
...
uint64_t __51__HMDCharacteristicThresholdRangeEvent_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_107214;
  logCategory__hmf_once_v1_107214 = v0;
