...
LABEL_18:
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v19, 0x16u);
      }
    }
    else
    {
...
LABEL_19:
  ...
  objc_super v3 = (void *)MEMORY[0x1D9452090]();
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&buf[4] = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Failed to get Primary IP Address", buf, 0xCu);
  }
  BOOL v6 = 0;
LABEL_20:
