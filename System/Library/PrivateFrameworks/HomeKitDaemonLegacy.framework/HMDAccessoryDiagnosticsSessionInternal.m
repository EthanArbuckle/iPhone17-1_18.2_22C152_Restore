...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_42833 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_42833, &__block_literal_global_128_42834);
  }
  v2 = (void *)logCategory__hmf_once_v6_42835;
  return v2;
}
...
uint64_t __53__HMDAccessoryDiagnosticsSessionInternal_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v6_42835;
  logCategory__hmf_once_v6_42835 = v0;
