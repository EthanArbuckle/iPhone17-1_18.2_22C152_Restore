...
- (void)__cloudFetchSchedulerFired:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v17 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Cloud fetch scheduler fired", buf, 0xCu);
  }
...
void __89__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator___cloudFetchSchedulerFired___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched cloud changes with poll timer: %@", (uint8_t *)&v14, 0x16u);
    }
  }
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch cloud changes with poll timer: %@", (uint8_t *)&v14, 0x16u);
  }
...
- (void)__stopCloudFetchScheduler
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Unconditionally stopping cloud fetch scheduler", (uint8_t *)&v9, 0xCu);
  }
    ...
    *((void *)&v23 + 1) = &v23;
    ...
    if (([v6 isRunning] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Starting cloud fetch scheduler", buf, 0xCu);
      }
      [v7 start];
      goto LABEL_15;
    }
...
LABEL_18:
      if ([v7 isRunning])
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v22 = v11;
          _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Stopping cloud fetch scheduler", buf, 0xCu);
        }
        [v7 stop];
      }
    }
LABEL_15:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)((char *)&v23 + 4) = v15;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Not starting cloud fetch scheduler because we should not be running", (uint8_t *)&v23, 0xCu);
  }
}
...
- (BOOL)addOverrides:(id)a3 replace:(BOOL)a4 error:(id *)a5
{
  ...
  uint64_t v24 = __Block_byref_object_copy__118488;
  char v25 = __Block_byref_object_dispose__118489;
  id v26 = 0;
...
void __89__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_addOverrides_replace_error___block_invoke(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v28 = 2112;
      id v29 = v7;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Firmware version specified on %@", (uint8_t *)&v26, 0x16u);
    }
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v7;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Multiple declarations given for the same identifier %@", (uint8_t *)&v26, 0x16u);
      }
...
- (void)_dumpCloudRecordsForProductGroup:(id)a3 productNumber:(id)a4 rawOutput:(BOOL)a5 verifySignatures:(BOOL)a6 completion:(id)a7
{
  ...
  v47[1] = v47;
  v47[2] = 0x3032000000;
  v47[3] = __Block_byref_object_copy__118488;
  v47[4] = __Block_byref_object_dispose__118489;
  id v48 = 0;
  ...
  if (a6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v50 = v33;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@No idea how to validate signatures on another mirror class", buf, 0xCu);
      }
      uint64_t v30 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v32 = 2112;
        v33 = v19;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Found %lu valid public key%s in record %@", buf, 0x2Au);
      }
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@No valid public keys found in record %@", buf, 0x16u);
      }
      uint64_t v23 = *(void *)(a1 + 40);
      id v24 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
    ...
    if ([v10 BOOLValue])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v22 = 2112;
        id v23 = v6;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Cloud fetch is needed for (some of) %@", buf, 0x16u);
      }
      v17[0] = MEMORY[0x1E4F143A8];
      v17[1] = 3221225472;
...
- (id)ruleConfigurationForAccessory:(id)a3 declarations:(id)a4
{
  ...
  if (!v58)
  {
    BOOL v46 = (void *)MEMORY[0x1D9452090]();
    v47 = self;
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v65 = 2112;
      id v66 = v6;
      _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have firmware version on %@", buf, 0x16u);
    }
    ...
    do
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v67 = 2112;
        id v68 = v6;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Rule configuration contains identifier %@ that does not match requested identifier %@", buf, 0x20u);
      }
...
LABEL_23:
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v65 = 2112;
            id v66 = v12;
            _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple rule configurations with the same version for %@", buf, 0x16u);
...
- (void)fetchRulesForAccessories:(id)a3 qualityOfService:(int64_t)a4 ignoreOverrides:(BOOL)a5 completion:(id)a6
{
        ...
        if (!v18)
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v50 = 2112;
            uint64_t v51 = v17;
            _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Firmware version not specified on %@", buf, 0x16u);
          }
  ...
  id v19 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v12, "count"));
  long long v39 = 0u;
  long long v40 = 0u;
  long long v41 = 0u;
  long long v42 = 0u;
  ...
  else
  {
    ...
    if (v8)
    {
      ...
      if ([v8 count])
      {
        id v51 = v9;
        uint64_t v53 = v4;
        uint64_t v10 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v8, "count"));
        long long v64 = 0u;
        long long v65 = 0u;
        long long v66 = 0u;
        long long v67 = 0u;
              ...
              if (v17)
              {
                ...
                if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v71 = 2112;
                  v72 = v16;
                  _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@More than one rule configuration for %@", buf, 0x16u);
                }
              }
        ...
        uint64_t v22 = v56;
        v54 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(*(id *)(v56 + 48), "count"));
        long long v60 = 0u;
        long long v61 = 0u;
        long long v62 = 0u;
        long long v63 = 0u;
                ...
                if (v30)
                {
                  if (v34)
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    __int16 v73 = 2112;
                    v74 = v30;
                    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_DEBUG, "%{public}@Found rule configuration for %@: %@", buf, 0x20u);
                ...
                else
                {
                  if (v34)
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    __int16 v71 = 2112;
                    v72 = v24;
                    _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_DEBUG, "%{public}@No declaration for %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v71 = 2112;
                  v72 = v24;
                  _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_DEBUG, "%{public}@No declarations for %@", buf, 0x16u);
                }
              }
            }
            id obja = (id)[v55 countByEnumeratingWithState:&v60 objects:v75 count:16];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v71 = 2112;
          v72 = v48;
          _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_DEBUG, "%{public}@No declarations for %@", buf, 0x16u);
        }
        uint64_t v49 = *(void *)(v56 + 56);
        __int16 v50 = [MEMORY[0x1E4F1CAD0] set];
...
- (id)fetchPairedMetadataVersionConfigurationsForAccessories:(id)a3 qualityOfService:(int64_t)a4 ignoreOverrides:(BOOL)a5 error:(id *)a6
{
        ...
        if (!v18)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v93 = 2112;
            id v94 = v17;
            _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_ERROR, "%{public}@Firmware version not specified on %@", buf, 0x16u);
          }
          id v12 = obj;
          if (a6)
          {
  ...
  if (v20)
  {
    ...
    {
      v69 = v19;
      uint64_t v22 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v21, "count"));
      long long v81 = 0u;
      long long v82 = 0u;
      long long v83 = 0u;
      long long v84 = 0u;
            ...
            if (v29)
            {
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v93 = 2112;
                id v94 = v28;
                _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@More than one rule configuration for %@", buf, 0x16u);
              }
            }
      ...
      __int16 v71 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(obj, "count"));
      long long v77 = 0u;
      long long v78 = 0u;
      long long v79 = 0u;
      long long v80 = 0u;
              ...
              if (v42)
              {
                if (v46)
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v95 = 2112;
                  id v96 = v42;
                  _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_DEBUG, "%{public}@Found pairedMetadata version configuration for %@: %@", buf, 0x20u);
              ...
              else
              {
                if (v46)
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v93 = 2112;
                  id v94 = v36;
                  _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_DEBUG, "%{public}@No pairedMetadata version configuration for %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v50, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v93 = 2112;
                id v94 = v36;
                _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_DEBUG, "%{public}@No pairedMetadata present for %@", buf, 0x16u);
              }
            }
          }
          id v76 = (id)[v72 countByEnumeratingWithState:&v77 objects:v89 count:16];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v12;
        _os_log_impl(&dword_1D49D5000, v65, OS_LOG_TYPE_INFO, "%{public}@No pairedMetadata present for %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v95 = 2112;
      id v96 = v62;
      _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_INFO, "%{public}@Nil pairedMetadata for %@ with error %@", buf, 0x20u);
    }
    uint64_t v53 = 0;
  }
...
- (id)_fetchPairedMetadataForAccessories:(id)a3 options:(id)a4 ignoreOverrides:(BOOL)a5 error:(id *)a6
{
  ...
  uint64_t v13 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v10, "count"));
  long long v85 = 0u;
  long long v86 = 0u;
  long long v87 = 0u;
  long long v88 = 0u;
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v91 = 2112;
      v92 = v20;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Fetch paired metadata for record failed with error %@", buf, 0x16u);
    }
    uint64_t v25 = 0;
    goto LABEL_60;
  }
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v91 = 2112;
    v92 = v70;
    _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Fetched paired metadata dictionary %@", buf, 0x16u);
  }
  if (a5)
  {
    __int16 v73 = v27;
    id v68 = v11;
    id v75 = (__CFString *)MEMORY[0x1E4F1CC08];
LABEL_27:
    id v72 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", -[__CFString count](v70, "count"));
          ...
          if (v46)
          {
            if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v93 = 2112;
              id v94 = v45;
              _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_INFO, "%{public}@%@ data for %@ parsed successfully", buf, 0x20u);
            }
            v54 = v72;
            id v55 = v46;
            goto LABEL_44;
          ...
          if (v42)
          {
            if (v56)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v91 = 2112;
              v92 = v45;
              _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@Override data for %@ failed to parse successfully, removing", buf, 0x16u);
            }
            v54 = v69;
            id v55 = v41;
LABEL_44:
          ...
          else
          {
            if (v56)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v91 = 2112;
              v92 = v45;
              _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@Cloud data for %@ failed to parse successfully", buf, 0x16u);
            }
          }
        }
        ++v40;
...
LABEL_52:
          ...
          if ((v61 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v91 = 2112;
              v92 = v62;
              _os_log_impl(&dword_1D49D5000, v65, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove invalid override data: %@", buf, 0x16u);
            }
          }
        }
  ...
  if (!v20)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v91 = 2112;
      v92 = v75;
      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Fetched overrides dictionary %@", buf, 0x16u);
    }
    __int16 v73 = v27;
    id v68 = v11;
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v91 = 2112;
    v92 = v20;
    _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Fetch overrides for paired metadata failed with error %@", buf, 0x16u);
  }
  uint64_t v25 = 0;
LABEL_59:
  ...
  if (!v63)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v70 = 2112;
      id v71 = v6;
      _os_log_impl(&dword_1D49D5000, v53, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have firmware version on %@", buf, 0x16u);
    }
    ...
    do
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v72 = 2112;
        id v73 = v6;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Version configuration contains identifier %@ that does not match requested identifier %@", buf, 0x20u);
      }
      ...
      if (v26 == -1)
      {
        if (v9)
        {
          ...
          if (v37 != 1)
          {
            ...
            BOOL v38 = (void *)MEMORY[0x1D9452090]();
            long long v39 = v58;
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v70 = 2112;
              id v71 = v12;
              _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple rule configurations with the same version for %@", buf, 0x16u);
            }
          ...
          if (v29 != -1)
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v70 = 2112;
              id v71 = v12;
              _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Multiple version configurations with the same version for %@", buf, 0x16u);
            }
...
- (id)_fetchNetworkDeclarationsForRecordIDs:(id)a3 options:(id)a4 ignoreOverrides:(BOOL)a5 error:(id *)a6
{
  ...
  v54 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v52, "count", v48));
        ...
        if (v25)
        {
          if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v69 = 2112;
            __int16 v70 = v24;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEBUG, "%{public}@%@ data for %@ parsed successfully", buf, 0x20u);
          }
          long long v33 = v54;
          BOOL v34 = v25;
          goto LABEL_28;
        ...
        if (v21)
        {
          if (v35)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v67 = 2112;
            id v68 = v24;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Override data for %@ failed to parse successfully, removing", buf, 0x16u);
          }
          long long v33 = v51;
          BOOL v34 = v20;
LABEL_28:
        ...
        else
        {
          if (v35)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v67 = 2112;
            id v68 = v24;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cloud data for %@ failed to parse successfully", buf, 0x16u);
          }
        }
      }
      ++v19;
    ...
    if ((v41 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v67 = 2112;
        id v68 = v42;
        _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove invalid override data: %@", buf, 0x16u);
...
- (void)_fetchCloudChangesWithQualityOfService:(int64_t)a3 ignoreLastFetchedAccessories:(BOOL)a4 forceChangeNotifications:(BOOL)a5 requiredRecordIDs:(id)a6 schedulerXpcActivity:(id)a7 completion:(id)a8
{
  ...
  if (v14 && ([v14 isSubsetOfSet:v21] & 1) == 0)
  {
    ...
    id v27 = (void *)MEMORY[0x1D9452090]([v22 minusSet:v21]);
    id v28 = self;
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v43 = 2112;
      id v44 = v22;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Cloud fetch triggered but required records are not watched: %@", buf, 0x16u);
    }
...
void __205__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator__fetchCloudChangesWithQualityOfService_ignoreLastFetchedAccessories_forceChangeNotifications_requiredRecordIDs_schedulerXpcActivity_completion___block_invoke_152(uint64_t a1, char a2, void *a3, void *a4)
{
  ...
  if (a2)
  {
    if ([v7 count])
    {
      id v9 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v7, "count"));
    ...
    if (!*(void *)(a1 + 48))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v26 = v18;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Resetting the cloud fetch scheduler after a successful force fetch", buf, 0xCu);
      }
...
void __165__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_fetchCloudChangesWithQualityOfService_ignoreLastFetchedAccessories_forceChangeNotifications_completion___block_invoke(uint64_t a1)
{
  ...
  id v2 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (void)shutdownWithCompletion:(id)a3
{
  ...
  if ([(HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator *)self isRunning])
  {
    ...
    {
      id v14 = v6;
      if ([v14 conformsToProtocol:&unk_1F2E89400]) {
        uint64_t v15 = v14;
      }
      else {
        uint64_t v15 = 0;
...
void __85__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_shutdownWithCompletion___block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down local zone: %@", (uint8_t *)&v11, 0x16u);
    }
  }
}
...
- (void)__startupWithMirror:(id)a3 completion:(id)a4
{
  ...
  if ([(HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator *)self isRunning])
  {
    ...
    {
      int v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:15];
    }
    id v14 = [(HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator *)self ownerQueue];
    block[0] = MEMORY[0x1E4F143A8];
    block[1] = 3221225472;
...
void __93__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator___startupWithMirror_completion___block_invoke_3(uint64_t a1)
{
  ...
  else
  {
    ...
    {
      uint64_t v4 = *(void *)(a1 + 48);
      id v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (void)__startupWithMirroredLocalZone:(id)a3 completion:(id)a4
{
  ...
  if ([(HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator *)self isRunning])
  {
    ...
    {
      id v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:15];
    }
  ...
  id v12 = [v6 mirror];
  if ([v12 conformsToProtocol:&unk_1F2E891E0]) {
    id v13 = v12;
  }
  else {
    id v13 = 0;
...
- (void)startupWithLocalDatabase:(id)a3 completion:(id)a4
{
  ...
  {
    id v11 = objc_alloc(MEMORY[0x1E4F19ED8]);
    ...
    id v13 = (void *)[objc_alloc(MEMORY[0x1E4F69E40]) initWithContainerID:v10];
    id v14 = (void *)[objc_alloc(MEMORY[0x1E4F69E38]) initWithLocalDatabase:v6 configuration:v13];
    if (v14)
    {
...
+ (id)__createProcessingOptionsWithLabel:(id)a3 qualityOfService:(int64_t)a4
{
  id v5 = [MEMORY[0x1E4F69EF0] optionsWithLabel:a3];
...
void __103__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator___jsonFromPairedMetadata_rawOutput_error___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!*(unsigned char *)(a1 + 48))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v7;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse declaration for %@", (uint8_t *)&v22, 0x16u);
    }
  }
...
+ (id)__jsonStringFromDictionary:(id)a3 rawOutput:(BOOL)a4 error:(id *)a5
{
  ...
  id v6 = [MEMORY[0x1E4F28D90] dataWithJSONObject:a3 options:v5 error:a5];
  if (v6) {
...
LABEL_19:
  ...
  if (!v10)
  {
    ...
    __int16 v24 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v23, "count"));
    long long v30 = 0u;
    long long v31 = 0u;
    long long v32 = 0u;
    long long v33 = 0u;
  ...
  id v19 = (void *)MEMORY[0x1E4F1C9B8];
...
+ (int64_t)ckContainerEnvironment
{
  ...
  char v3 = [MEMORY[0x1E4F65530] sharedPreferences];
...
LABEL_6:
  ...
  if ((unint64_t)(v6 - 1) >= 2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2048;
      int64_t v15 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Unknown container environment value %ld, ignoring", (uint8_t *)&v12, 0x16u);
    }
    goto LABEL_6;
  }
LABEL_7:
...
LABEL_8:
  ...
  if (v6 != 1)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2048;
      uint64_t v16 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Unknown container target value %lu, ignoring", (uint8_t *)&v13, 0x16u);
    }
    goto LABEL_8;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_118721 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_118721, &__block_literal_global_118722);
  }
  id v2 = (void *)logCategory__hmf_once_v1_118723;
  return v2;
}
...
uint64_t __73__HMDNetworkRouterFirewallRuleManagerBackingStoreCoordinator_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_118723;
  logCategory__hmf_once_v1_118723 = v0;
