          ...
          if (v25)
          {
            if (v29)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v55 = 2112;
              v56 = v50;
              _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Received response from: %@", buf, 0x16u);
          ...
          else
          {
            if (v29)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v55 = 2112;
              v56 = v50;
              _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Ignoring response from unsupported device: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v54 = v43;
            _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_INFO, "%{public}@Failed to parse sender account handle", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v57 = 2112;
          v58 = v52;
          _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring message with transaction ID: %@, expected %@", buf, 0x20u);
    ...
    if (v21)
    {
      ...
      if (v10)
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          int v29 = 138543362;
          v30 = v26;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Confirmed resolve sent successfully", (uint8_t *)&v29, 0xCu);
        }
      }
      else
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          __int16 v31 = 2112;
          id v32 = v17;
          _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send message to server with error: %@", (uint8_t *)&v29, 0x16u);
        }
        v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:0 reason:0 suggestion:0 underlyingError:v17];
...
- (void)main
{
  ...
  id v49 = 0;
  id v12 = +[HMDRemoteMessageSerialization dictionaryForMessage:v11 error:&v49];
  id v13 = v49;
  id v14 = v13;
  if (v12)
  {
    v45 = v10;
    id v46 = v13;
    v52[0] = *MEMORY[0x1E4F6AA10];
    id v15 = NSNumber;
    +[HMDAccountHandleResolveOperation timeout];
    id v16 = objc_msgSend(v15, "numberWithDouble:");
    v52[1] = *MEMORY[0x1E4F6A9A0];
    v53[0] = v16;
    v53[1] = MEMORY[0x1E4F1CC38];
    id v17 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v53 forKeys:v52 count:2];
    ...
    char v25 = (void *)MEMORY[0x1D9452090]();
    v26 = v4;
    ...
    if (v23)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v56 = 2112;
        id v57 = v24;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Started resolve with identifier: %@", buf, 0x16u);
      }
      ...
      v36 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v24];
      BOOL v10 = v45;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v56 = 2112;
        id v57 = v44;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to send message with error: %@", buf, 0x16u);
      }
      v34 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54 description:0 reason:0 suggestion:0 underlyingError:v44];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v56 = 2112;
      id v57 = v14;
      _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize message with error: %@", buf, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_51710 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_51710, &__block_literal_global_51711);
  }
  v2 = (void *)logCategory__hmf_once_v5_51712;
  return v2;
}
...
uint64_t __47__HMDAccountHandleResolveOperation_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_51712;
  logCategory__hmf_once_v5_51712 = v0;
