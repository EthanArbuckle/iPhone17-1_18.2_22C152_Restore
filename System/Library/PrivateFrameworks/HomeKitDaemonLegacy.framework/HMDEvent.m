...
- (BOOL)_activate:(unint64_t)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    v22 = v12;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating the activation type from %@ to %@", (uint8_t *)&v17, 0x20u);
  }
...
- (void)_registerForMessages
{
  ...
  v8[1] = v6;
  char v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v8 count:2];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_109931 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_109931, &__block_literal_global_109932);
  }
  v2 = (void *)logCategory__hmf_once_v1_109933;
  return v2;
}
...
uint64_t __23__HMDEvent_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_109933;
  logCategory__hmf_once_v1_109933 = v0;
