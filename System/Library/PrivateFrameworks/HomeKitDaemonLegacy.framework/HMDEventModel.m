...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_109948 != -1) {
    dispatch_once(&properties_onceToken_109948, block);
  }
  v2 = (void *)properties__properties_109949;
  return v2;
}
...
void __27__HMDEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_109949;
  properties__properties_109949 = v3;

  v5 = (void *)properties__properties_109949;
  id v9 = @"endEvent";
