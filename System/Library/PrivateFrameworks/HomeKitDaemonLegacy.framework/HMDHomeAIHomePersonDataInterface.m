...
- (void)handleFaceMisclassificationForFaceCropData:(id)a3 personUUID:(id)a4
{
  ...
  id v9 = objc_alloc(MEMORY[0x1E4F69820]);
  v10 = [MEMORY[0x1E4F29128] UUID];
  v11 = [MEMORY[0x1E4F1C9C8] date];
  v12 = objc_msgSend(v9, "initWithUUID:dataRepresentation:dateCreated:faceBoundingBox:personUUID:", v10, v6, v11, v7, *MEMORY[0x1E4F2D148], *(double *)(MEMORY[0x1E4F2D148] + 8), *(double *)(MEMORY[0x1E4F2D148] + 16), *(double *)(MEMORY[0x1E4F2D148] + 24));
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    v21 = v12;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Notifying HomeAI home person manager of misclassified person for face crop: %@", (uint8_t *)&v18, 0x16u);
  }
...
- (void)handleUpdatedSettings:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Updated settings could not be converted into HMIHomePersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
    }
  }
}
...
void __73__HMDHomeAIHomePersonDataInterface_removeFaceprintsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing faceprints with UUIDs: %@", buf, 0x16u);
  }
...
void __72__HMDHomeAIHomePersonDataInterface_removeFaceCropsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing face crops with UUIDs: %@", buf, 0x16u);
  }
  id v7 = [*(id *)(a1 + 32) dataSource];
...
void __70__HMDHomeAIHomePersonDataInterface_removePersonsWithUUIDs_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Removing persons with UUIDs: %@", buf, 0x16u);
  }
  id v7 = [*(id *)(a1 + 32) dataSource];
...
void __61__HMDHomeAIHomePersonDataInterface_addFaceprints_completion___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding faceprints: %@", buf, 0x16u);
  }
  id v7 = objc_msgSend(a1[5], "na_map:", &__block_literal_global_20_112783);
...
{
  v2 = (objc_class *)MEMORY[0x1E4F2E7D0];
  id v3 = a2;
...
void __60__HMDHomeAIHomePersonDataInterface_addFaceCrops_completion___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding face crops: %@", buf, 0x16u);
  }
  id v7 = objc_msgSend(a1[5], "na_map:", &__block_literal_global_15_112788);
  id v8 = [a1[4] dataSource];
...
{
  v2 = (objc_class *)MEMORY[0x1E4F2E7C8];
  id v3 = a2;
...
void __58__HMDHomeAIHomePersonDataInterface_addPersons_completion___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Adding persons: %@", buf, 0x16u);
  }
  id v7 = objc_msgSend(a1[5], "na_map:", &__block_literal_global_9_112793);
  id v8 = [a1[4] dataSource];
...
{
  v2 = (objc_class *)MEMORY[0x1E4F2E9E8];
  id v3 = a2;
...
void __64__HMDHomeAIHomePersonDataInterface_fetchSettingsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v15 = 138543362;
    id v16 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Fetching settings", (uint8_t *)&v15, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Fetched settings could not be converted into HMIHomePersonManagerSettings: %@", (uint8_t *)&v15, 0x16u);
    }
...
void __80__HMDHomeAIHomePersonDataInterface_fetchAllUnassociatedFaceCropsWithCompletion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v17 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Fetching all unassociated face crops", buf, 0xCu);
  }
  id v6 = [*(id *)(a1 + 32) dataSource];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v17 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch all unassociated face crops because data is not available", buf, 0xCu);
    }
    uint64_t v13 = *(void *)(a1 + 40);
    id v8 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:5];
...
- (HMDHomeAIHomePersonDataInterface)initWithPersonManagerUUID:(id)a3 homeUUID:(id)a4 workQueue:(id)a5
{
  id v8 = (objc_class *)MEMORY[0x1E4F69800];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_112811 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_112811, &__block_literal_global_112812);
  }
  v2 = (void *)logCategory__hmf_once_v1_112813;
  return v2;
}
...
uint64_t __47__HMDHomeAIHomePersonDataInterface_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_112813;
  logCategory__hmf_once_v1_112813 = v0;
