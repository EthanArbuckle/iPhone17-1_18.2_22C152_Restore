...
- (HMDMediaGroupsAggregatorUpdateAssociatedGroupIdentifierPayload)initWithPayload:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to get decode dependencies group identifier: %@ payload: %@ due", (uint8_t *)&v13, 0x20u);
    }
    v8 = 0;
  }
...
- (id)attributeDescriptions
{
  ...
  v13[1] = v10;
  char v11 = [MEMORY[0x1E4F1C978] arrayWithObjects:v13 count:2];
