...
void __59__HMDRemoteEventRouterClient_networkAvailabilityDidChange___block_invoke(uint64_t a1)
{
  ...
  if (v3 != v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138412290;
      v12 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "Network availability changed to %@", (uint8_t *)&v11, 0xCu);
...
- (void)configureIsPrimaryResident:(BOOL)a3 networkAvailable:(BOOL)a4 additionalPolicies:(id)a5
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v15 = 2112;
    v16 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "Configuring isPrimaryResident: %@, networkAvailable: %@", (uint8_t *)&v13, 0x16u);
  }
...
void __106__HMDRemoteEventRouterClient_responseHandlerForMessageIdentifier_serverIdentifier_messageType_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(*(os_log_t *)(v4 + 8), OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v22 = 2112;
      id v23 = v3;
      _os_log_error_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_ERROR, "Failed to send message: %@ error: %@", buf, 0x16u);
    }
    if (*(void *)(a1 + 80) == 1) {
  ...
  else if (os_log_type_enabled(*(os_log_t *)(v4 + 8), OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138412290;
    id v21 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_DEFAULT, "Successfully sent message: %@", buf, 0xCu);
  }
  if ([v3 isHMError] && objc_msgSend(v3, "code") == 3202)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v21 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Event router message rejected by remote due to it being non-primary, kicking primary discovery", buf, 0xCu);
    }
  ...
  if (objc_msgSend(*(id *)(a1 + 56), "hmf_BOOLForKey:", @"isFragmented") && v11)
  {
    ...
    if (!v14 || v12)
    {
      ...
      *(_DWORD *)buf = 138412290;
      id v21 = v18;
      _os_log_error_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "Unable to decode fragment payload with error: %@", buf, 0xCu);
      if (v12)
      {
LABEL_19:
        id v12 = v12;
...
- (void)sendMessageWithPayloadMessage:(id)a3 messageType:(int64_t)a4 destination:(id)a5 serverIdentifier:(id)a6 completion:(id)a7
{
  ...
  __int16 v22 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v30 forKeys:v29 count:2];
...
- (id)sendMessageWithPayloadMessage:(id)a3 client:(id)a4 messageType:(int64_t)a5 completion:(id)a6
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    *(_DWORD *)buf = 138412290;
    __int16 v22 = v15;
    _os_log_error_impl(&dword_1D49D5000, logger, OS_LOG_TYPE_ERROR, "Did not find resident destination for server identifier %@.", buf, 0xCu);
    if (!v10) {
      goto LABEL_7;
    }
    goto LABEL_6;
...
- (void)clientDidDisconnect:(id)a3
{
  ...
  {
    *(_WORD *)id v10 = 0;
    _os_log_impl(&dword_1D49D5000, logger, OS_LOG_TYPE_DEFAULT, "Client disconnected from server", v10, 2u);
  }
...
- (void)clientDidConnect:(id)a3 serverIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 138412290;
    id v15 = v5;
    _os_log_impl(&dword_1D49D5000, logger, OS_LOG_TYPE_DEFAULT, "Client did connect to server %@", buf, 0xCu);
  }
  if (![(HMDRemoteEventRouterClient *)self isConnected])
  {
...
- (void)client:(id)a3 fetchWithFilters:(id)a4 isMultiHop:(BOOL)a5 completion:(id)a6
{
  ...
  uint64_t v19 = objc_msgSend(v12, "na_map:", &__block_literal_global_60_17292);
...
void __76__HMDRemoteEventRouterClient_client_fetchWithFilters_isMultiHop_completion___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v8 && !v9)
  {
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "Did not find fetch response", buf, 2u);
      }
    ...
    if ([(HMDRemoteEventRouterProtoFetchEventsResponse *)v12 changedEventsCount])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "Received %@ events in fetch response of size %@", buf, 0x16u);
      }
      uint64_t v19 = (void *)MEMORY[0x1E4F69F40];
      id v20 = [(HMDRemoteEventRouterProtoFetchEventsResponse *)v12 changedEvents];
      id v21 = [v19 eventsMapFromProtoEvents:v20];
    }
    else
    {
      id v21 = (void *)MEMORY[0x1E4F1CC08];
    }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v39 = 2048;
      uint64_t v40 = v26;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch got topics %ld", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_DEBUG, "%{public}@Fetch got topics %@", buf, 0x16u);
    }
...
void __76__HMDRemoteEventRouterClient_client_sendConnectWithAddedFilters_completion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v8 && !v9)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v22) = 0;
        _os_log_error_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "Did not find connect response", (uint8_t *)&v22, 2u);
      }
    ...
    if ([(HMDRemoteEventRouterProtoConnectResponse *)v12 cachedEventsCount])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v18;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "Received %@ events in connect response of size %@", (uint8_t *)&v22, 0x16u);
      }
      uint64_t v19 = (void *)MEMORY[0x1E4F69F40];
    ...
    if (v7)
    {
      if (!v10)
      {
        ...
        if (os_signpost_enabled(v21))
        {
          int v22 = 138412290;
          id v23 = v7;
          _os_signpost_emit_with_name_impl(&dword_1D49D5000, v21, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientConnected", "serverIdentifier=%{signpost.description:attribute}@ ", (uint8_t *)&v22, 0xCu);
        }
      }
    }
  }
...
void __110__HMDRemoteEventRouterClient_sendChangeRegistrationsMessageWithAddedFilters_removedFilters_client_completion___block_invoke(uint64_t a1, uint64_t a2, void *a3, void *a4)
{
  ...
  if (v6 && !v7)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v19) = 0;
        _os_log_error_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "Did not find change registrations response", (uint8_t *)&v19, 2u);
      }
    ...
    if ([(HMDRemoteEventRouterProtoChangeRegistrationsResponse *)v10 cachedEventsCount])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v21 = 2112;
        int v22 = v16;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "Received %@ events in change registrations response of size %@", (uint8_t *)&v19, 0x16u);
      }
      id v17 = (void *)MEMORY[0x1E4F69F40];
...
- (BOOL)client:(id)a3 isConnectionTerminatingError:(id)a4
{
  id v4 = a4;
  id v5 = [v4 domain];
  int v6 = [v5 isEqualToString:*MEMORY[0x1E4F2D140]];

  if (!v6)
  {
    id v8 = [v4 domain];
    int v9 = [v8 isEqualToString:*MEMORY[0x1E4F64ED0]];

    if (v9
      || ([v4 domain],
          id v10 = objc_claimAutoreleasedReturnValue(),
          int v11 = [v10 isEqualToString:*MEMORY[0x1E4F69F28]],
          v10,
          v11)
      && [v4 code] != 4
      && [v4 code] != 1)
...
- (void)_handleMultiHopFetchResponse:(id)a3 originalMessage:(id)a4
{
  ...
  if (objc_msgSend(v11, "hmf_isEqualToUUID:", v12))
  {
    if ([v6 changedEventsCount])
    {
      ...
      id v14 = (void *)MEMORY[0x1E4F69F40];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      v31 = v11;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Received fetch response from non-primary: %@", buf, 0x16u);
    }
    id v25 = [MEMORY[0x1E4F28C58] hmPrivateErrorWithCode:2037];
...
- (void)_handleUpdatedEventsRequest:(id)a3 originalMessage:(id)a4
{
  ...
  v37[1] = v37;
  v37[2] = 0x3032000000;
  v37[3] = __Block_byref_object_copy__17325;
  v37[4] = __Block_byref_object_dispose__17326;
  id v38 = 0;
    ...
    if (v13 && [v13 count])
    {
      ...
      if (os_log_type_enabled((os_log_t)v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v41 = 2112;
        v42 = v17;
        _os_log_impl(&dword_1D49D5000, (os_log_t)v14, OS_LOG_TYPE_DEFAULT, "Received update events request %@, payloadSize: %@", buf, 0x16u);
      }
      logger = self->_logger;
      if (os_signpost_enabled(logger))
      {
        *(_DWORD *)buf = 138412290;
        uint64_t v40 = v10;
        _os_signpost_emit_with_name_impl(&dword_1D49D5000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientHandleUpdatedEvents", "serverIdentifier=%{signpost.description:attribute}@ ", buf, 0xCu);
      }
    ...
    if (v20 && [v20 count])
    {
      ...
      if (os_log_type_enabled((os_log_t)v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v41 = 2112;
        v42 = v24;
        _os_log_impl(&dword_1D49D5000, (os_log_t)v21, OS_LOG_TYPE_DEFAULT, "Received cached events request %@, payloadSize: %@", buf, 0x16u);
      }
      id v25 = self->_logger;
      if (os_signpost_enabled(v25))
      {
        *(_DWORD *)buf = 138412290;
        uint64_t v40 = v10;
        _os_signpost_emit_with_name_impl(&dword_1D49D5000, v25, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterClientHandleCachedEvents", "serverIdentifier=%{signpost.description:attribute}@ ", buf, 0xCu);
      }
      dispatch_group_enter(v11);
...
- (void)_handleUpdateMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update message: %@", buf, 0x16u);
  }
  ...
  if (!v11)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D49D5000, logger, OS_LOG_TYPE_ERROR, "Did not find message payload.", buf, 2u);
    }
  ...
  if (!v13)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "Unable to decode payload from fragment message.", buf, 2u);
      if (!v14) {
        goto LABEL_23;
      }
    }
  ...
  if ([(HMDRemoteEventRouterProtoServerMessage *)v16 hasMessage])
  {
    switch([(HMDRemoteEventRouterProtoServerMessage *)v16 message])
    {
      ...
      default:
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "Received an unrecognized request type.", buf, 2u);
        }
...
LABEL_30:
    _os_log_error_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, v18, buf, 2u);
  }
LABEL_17:
  id v19 = (void *)MEMORY[0x1E4F28C58];
  uint64_t v20 = 3;
...
- (void)handlePrimaryResidentConfirmedDeviceIdentifierChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    int v13 = 138412290;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, logger, OS_LOG_TYPE_DEFAULT, "Received primary resident change notification %@", (uint8_t *)&v13, 0xCu);
  }
  ...
  if (v8 != [(HMDRemoteEventRouterClient *)self isPrimaryResident])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v13 = 138412290;
      id v14 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", (uint8_t *)&v13, 0xCu);
    }
...
- (void)_registerForMessages:(id)a3
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    int v16 = 138412290;
    id v17 = v13;
    _os_log_impl(&dword_1D49D5000, logger, OS_LOG_TYPE_DEFAULT, "Registering for primary resident change notification %@", (uint8_t *)&v16, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_17365 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_17365, &__block_literal_global_17366);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_17367;
  return v2;
}

uint64_t __41__HMDRemoteEventRouterClient_logCategory__block_invoke()
{
  logCategory__hmf_once_v1_17367 = HMFCreateOSLogHandle();
...
+ (id)routerClientWithQueue:(id)a3 storeReadHandle:(id)a4 storeWriteHandle:(id)a5 retryIntervalProvider:(id)a6 logCategory:(const char *)a7
{
  ...
  int v16 = (void *)[objc_alloc(MEMORY[0x1E4F69F60]) initWithQueue:v14 timerProvider:v15 keepAliveInterval:v11 dormantFetchTimerInterval:v13 retryIntervalProvider:v12 storeReadHandle:a7 storeWriteHandle:420.0 logCategory:28800.0];
