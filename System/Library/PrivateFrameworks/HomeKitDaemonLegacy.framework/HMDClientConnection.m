...
- (void)_handleSiriIntentRequest:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [v4 dataForKey:*MEMORY[0x1E4F2EE60]];
  if (v5)
  {
    id v33 = 0;
    id v6 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v5 error:&v33];
    id v7 = v33;
    if (v6)
    {
      ...
      v11 = [v4 numberForKey:*MEMORY[0x1E4F2EE70]];
      ...
      if (v10)
      {
        if (v15)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          uint64_t v39 = v16;
          v17 = (void *)v16;
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Error - Data sync in progress - Unable to %@ intent [ %@ ] ", buf, 0x20u);
        }
        v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:77];
      ...
      else
      {
        if (v15)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Received to %@ intent: [ %@ ]", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v36 = 2112;
        id v37 = v7;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive control home intent from the message payload data: %@", buf, 0x16u);
      }
      v8 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Error - Did not get the intent", buf, 0xCu);
    }
...
- (void)_handleSiriCommand:(id)a3
{
  ...
  id v6 = NSString;
  id v7 = MEMORY[0x1D94505D0](self, a2);
  v8 = [v6 stringWithFormat:@"%@, %s:%ld", v7, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables_legacy/Sources/homed/Messaging/XPC/HMDClientConnection.m", 160];
  ...
  v11 = [MEMORY[0x1E4F28DC0] deserializeObjectWithData:v48 allowedClass:objc_opt_class() frameworkClasses:&unk_1F2DC6EF8];
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v71 = 2112;
    v72 = v20;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Incoming Siri command(%{public}@) serverValidity %{public}@:\n%@", buf, 0x34u);
  }
...
LABEL_4:
  ...
  id v25 = objc_alloc_init(MEMORY[0x1E4F96680]);
  v26 = v25;
  if (v21)
  {
    [v25 setCommandOutcome:*MEMORY[0x1E4F96ED0]];
    id v27 = [MEMORY[0x1E4F1C978] array];
    [v26 setActionResults:v27];
    v28 = @"Data sync in progress";
  }
  else
  {
    [v25 setCommandOutcome:*MEMORY[0x1E4F96EC0]];
    id v27 = objc_alloc_init(MEMORY[0x1E4F96670]);
    [v27 setOutcome:*MEMORY[0x1E4F96D20]];
    id v62 = v27;
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v69 = 2112;
    v70 = v41;
    _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@%@ - response for Siri command(%@): %@", buf, 0x2Au);
  }
...
void __42__HMDClientConnection__handleSiriCommand___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    id v44 = v6;
    id v45 = v5;
    v9 = (void *)[objc_alloc(MEMORY[0x1E4F96680]) initWithDictionary:v5];
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v58 = 2114;
      id v59 = v16;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Outgoing Response for Siri command(%{public}@): %{public}@", buf, 0x2Au);
    }
    uint64_t v43 = a1;
        ...
        for (uint64_t i = 0; i != v19; ++i)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v54 = 2112;
            id v55 = v22;
            _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@%@", buf, 0x16u);
          }
        }
...
LABEL_18:
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v56 = 2114;
      id v57 = v6;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Error executing Siri command: %{public}@", buf, 0x20u);
    }
    goto LABEL_21;
  }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v53 = v30;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Nil response for Siri command", buf, 0xCu);
  }
  if (v6) {
    goto LABEL_18;
  }
...
- (void)_registerForMessages
{
  ...
  [v6 registerForMessage:*MEMORY[0x1E4F2EE68] receiver:self policies:v5 selector:sel__handleSiriIntentRequest_];
  ...
  [v8 registerForMessage:*MEMORY[0x1E4F2D068] receiver:self policies:v7 selector:sel__handleSiriCommand_];

  v9 = [(HMDClientConnection *)self msgDispatcher];
  [v9 registerForMessage:*MEMORY[0x1E4F2D070] receiver:self policies:v7 selector:sel__handleSiriSyncDataRequest_];

  int v10 = [MEMORY[0x1E4F65548] productInfo];
  uint64_t v11 = [v10 productClass];

  if (v11 == 6)
  {
    v12 = [(HMDClientConnection *)self msgDispatcher];
    uint64_t v13 = *MEMORY[0x1E4F2D060];
    v14 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
    v19[0] = v14;
    uint64_t v18 = *MEMORY[0x1E4F2C8E0];
    BOOL v15 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v18 count:1];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_122612 != -1) {
    dispatch_once(&logCategory__hmf_once_t10_122612, &__block_literal_global_122613);
  }
  v2 = (void *)logCategory__hmf_once_v11_122614;
  return v2;
}
...
uint64_t __34__HMDClientConnection_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v11_122614;
  logCategory__hmf_once_v11_122614 = v0;
