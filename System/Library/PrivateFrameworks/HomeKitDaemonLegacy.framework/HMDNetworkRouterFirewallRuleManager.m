  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v14 = 2048;
      uint64_t v15 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Operation started (%lu operations now pending)", buf, 0x16u);
    }
  ...
  if (v1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
      {
        ...
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Operation count unbalanced", (uint8_t *)&v15, 0xCu);
      }
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v17 = 2048;
      uint64_t v18 = v4;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Operation finished (%lu operations now pending)", (uint8_t *)&v15, 0x16u);
    }
    ...
    if ((v2 & 0xFFFFFFFFFFFFFFFDLL) == 0)
    {
      ...
      if (v6)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&v58[22] = 2048;
          v59 = (void *)v5;
          _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Purged %lu deallocated client(s) (now have %lu)", v58, 0x20u);
        }
        char v14 = 1;
      }
      else
        ...
        else
        {
          ...
          if ([(os_unfair_lock_s *)a1 state] != 2)
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
            {
              ...
              *(void *)&v58[4] = v49;
              _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be running", v58, 0xCu);
            }
          ...
          if ([(os_unfair_lock_s *)a1 operationsInProgressCount])
          {
            ...
            if (os_log_type_enabled(v54, OS_LOG_TYPE_FAULT))
            {
              ...
              *(_DWORD *)v58 = 138543362;
              *(void *)&v58[4] = v55;
              _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have finished all operations", v58, 0xCu);
            }
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v58 = 138543362;
            *(void *)&v58[4] = v30;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_INFO, "%{public}@Shutdown initiated", v58, 0xCu);
          }
          [(os_unfair_lock_s *)v28 setState:3];
          v31 = [(os_unfair_lock_s *)v28 coordinator];
          *(void *)v58 = MEMORY[0x1E4F143A8];
      ...
      else
      {
        ...
        if ([(os_unfair_lock_s *)a1 state])
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)v58 = 138543362;
            *(void *)&v58[4] = v43;
            _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be stopped", v58, 0xCu);
          }
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v58 = 138543362;
          *(void *)&v58[4] = v21;
          _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Startup initiated", v58, 0xCu);
        }
...
void __49__HMDNetworkRouterFirewallRuleManager___shutdown__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v3;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down: %@", (uint8_t *)&v9, 0x16u);
    }
  }
...
void __48__HMDNetworkRouterFirewallRuleManager___startup__block_invoke(uint64_t a1, void *a2)
{
  ...
  __int16 v17 = &unk_1E6A09B08;
  uint64_t v18 = *(void *)(a1 + 32);
  id v7 = v6;
  id v19 = v7;
  uint64_t v8 = (void *)MEMORY[0x1D9452090](objc_msgSend(v5, "hmf_enumerateWithAutoreleasePoolUsingBlock:", &v14));
  id v9 = *(id *)(a1 + 32);
  ...
  if (v3)
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      id v23 = v3;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Startup failed: %@", buf, 0x16u);
    }
  ...
  else
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543362;
      char v21 = v13;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Startup completed successfully", buf, 0xCu);
    }
...
void __48__HMDNetworkRouterFirewallRuleManager___startup__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
    {
      ...
      int v14 = 138543362;
      uint64_t v15 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Completion should not have been called yet", (uint8_t *)&v14, 0xCu);
    }
...
void __57__HMDNetworkRouterFirewallRuleManager_shutdownForClient___block_invoke(uint64_t a1)
{
  ...
  v42 = __Block_byref_object_copy__37887;
  v43 = __Block_byref_object_dispose__37888;
  id v44 = 0;
  uint64_t v35 = 0;
  double v36 = &v35;
  ...
  if (v40[5])
  {
    id v4 = (void *)MEMORY[0x1D9452090](objc_msgSend(v2, "removeObjectAtIndex:", v36[3], v28, v29, v30, v31));
    id v5 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v50 = 2112;
      uint64_t v51 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Removed active client (now have %lu): %@", buf, 0x20u);
    }
    ...
    if (v11)
    {
      if ((v10 & 0xFFFFFFFFFFFFFFFDLL) != 1)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v47 = v24;
          id v25 = (void *)v24;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be starting or stopping", buf, 0xCu);
        }
      ...
      v45 = v13;
      id v14 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v45 count:1];
  ...
  {
    id v16 = (void *)MEMORY[0x1D9452090](v3);
    id v17 = *(id *)(a1 + 32);
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v48 = 2112;
      uint64_t v49 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Ignoring unbalanced shutdown request for client %@", buf, 0x16u);
    }
  }
...
void __67__HMDNetworkRouterFirewallRuleManager_startupForClient_completion___block_invoke(id *a1)
{
  ...
  double v34 = __Block_byref_object_copy__37887;
  uint64_t v35 = __Block_byref_object_dispose__37888;
  id v36 = 0;
  ...
  if (v32[5])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring duplicate startup request for client %@", buf, 0x16u);
    }
    ...
    else
    {
      ...
      v44[0] = v11;
      uint64_t v24 = [MEMORY[0x1E4F1C978] arrayWithObjects:v44 count:1];
  ...
  else
  {
    ...
    id v14 = (void *)MEMORY[0x1D9452090]([v2 addObject:v32[5]]);
    id v15 = a1[4];
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v42 = 2112;
      id v43 = v19;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Added active client (now have %lu): %@", buf, 0x20u);
    }
    if ([a1[4] state] == 2)
    {
      id v20 = a1[4];
...
- (void)dealloc
{
  ...
  if (self->_state)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v11 = v6;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: should be stopped", buf, 0xCu);
    }
...
+ (HMDNetworkRouterFirewallRuleManager)sharedInstance
{
  if (sharedInstance_onceToken != -1) {
    dispatch_once(&sharedInstance_onceToken, &__block_literal_global_21_37943);
  }
...
uint64_t __53__HMDNetworkRouterFirewallRuleManager_sharedInstance__block_invoke()
{
  ...
  uint64_t v1 = sharedInstance_firewallRuleManager;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_37946 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_37946, &__block_literal_global_37947);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_37948;
  return v2;
}
...
uint64_t __50__HMDNetworkRouterFirewallRuleManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_37948;
  logCategory__hmf_once_v1_37948 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}
