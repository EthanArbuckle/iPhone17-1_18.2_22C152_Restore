...
- (id)_diagnosticInfoWithAdditionalKeys:(id)a3
{
  ...
  id v6 = objc_alloc_init(MEMORY[0x1E4F2E548]);
  [v6 setVersion:11];
  ...
  if (v5)
  {
    id v9 = objc_alloc_init(MEMORY[0x1E4F2E530]);
    [v6 setAppleMediaAccessoryDiagnosticInfo:v9];

    id v10 = objc_alloc_init(MEMORY[0x1E4F2E538]);
    [v10 setCloudState:0];
    ...
    v16 = [MEMORY[0x1E4F65570] systemInfo];
    ...
    if ([v4 containsObject:*MEMORY[0x1E4F2D388]])
    {
    ...
    if (v46)
    {
      ...
      id v49 = objc_alloc_init(MEMORY[0x1E4F2E540]);
      v50 = [v46 uuid];
      v51 = [v50 UUIDString];
    ...
    id v91 = objc_alloc_init(MEMORY[0x1E4F2E550]);
    [v91 setIdsState:0];
    if (v90)
    {
      v92 = [v90 UUIDString];
    ...
    {
      id v98 = objc_alloc_init(MEMORY[0x1E4F2E558]);
...
+ (id)diagnosticInfoDescriptionWithData:(id)a3
{
  ...
  id v3 = a3;
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F2E548]) initWithData:v3];
  if (v4)
  {
