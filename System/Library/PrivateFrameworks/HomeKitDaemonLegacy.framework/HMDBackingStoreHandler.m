...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to process removed object: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to process udated changes for object: %@", (uint8_t *)&v16, 0x16u);
  }
  __int16 v15 = [MEMORY[0x1E4F28C58] hmfErrorWithCode:4];
...
- (id)backingStoreObjectsForVersion:(int64_t)a3
{
  ...
  v4 = (void *)MEMORY[0x1D9452090](self, a2, a3);
  v5 = self;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    int v9 = 138543362;
    id v10 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive backinstore objects for shared user", (uint8_t *)&v9, 0xCu);
  }
...
- (void)runTransactionWithModels:(id)a3 options:(id)a4 reason:(id)a5 completion:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v41 = 2112;
    id v42 = v11;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Running transaction with models: %@ options: %@", buf, 0x20u);
  }
  if (v13)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Failed to run transaction due to no completion", buf, 0xCu);
    }
  }
}
...
void __77__HMDBackingStoreHandler_runTransactionWithModels_options_reason_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v3;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Transaction completed with error: %@", (uint8_t *)&v13, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Transaction completed", (uint8_t *)&v13, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_56816 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_56816, &__block_literal_global_56817);
  }
  v2 = (void *)logCategory__hmf_once_v8_56818;
  return v2;
}
...
uint64_t __37__HMDBackingStoreHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v8_56818;
  logCategory__hmf_once_v8_56818 = v0;
