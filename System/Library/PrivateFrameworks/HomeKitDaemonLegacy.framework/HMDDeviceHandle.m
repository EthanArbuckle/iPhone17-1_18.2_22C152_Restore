...
uint64_t __39___HMDDeviceHandle_identifierNamespace__block_invoke()
{
  ...
  uint64_t v1 = identifierNamespace_namespace;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing internal parameter", buf, 0xCu);
    }
    char v9 = 0;
  }
...
LABEL_12:
  ...
  uint64_t v6 = &off_1E6A041E0;
  if (+[_HMDLocalDeviceHandle isValidDestination:v4]
    || (uint64_t v6 = off_1E6A041D8,
