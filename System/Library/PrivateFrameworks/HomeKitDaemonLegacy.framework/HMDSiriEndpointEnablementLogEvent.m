...
- (HMDSiriEndpointEnablementLogEvent)initWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_ERROR, "%{public}@Could not init HMDSiriEndpointEnablementLogEvent with dictionary %@", (uint8_t *)&v15, 0x16u);
    }
    v10 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_192330 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_192330, &__block_literal_global_54_192331);
  }
  v2 = (void *)logCategory__hmf_once_v12_192332;
  return v2;
}
...
uint64_t __48__HMDSiriEndpointEnablementLogEvent_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v12_192332;
  logCategory__hmf_once_v12_192332 = v0;
