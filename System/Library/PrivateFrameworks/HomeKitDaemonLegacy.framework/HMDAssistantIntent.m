...
- (void)_handleActionSetForConfirmation:(id)a3 message:(id)a4
{
  ...
  v10 = [MEMORY[0x1E4F65480] messageWithMessage:v5 messagePayload:v9];
...
void __62__HMDAssistantIntent__handleActionSetForConfirmation_message___block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if ((a2 & 1) == 0)
  {
    ...
    {
LABEL_7:
      uint64_t v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:10];
...
- (id)_getObjectsWithUUID
{
  ...
  if (v9 && [v9 count])
  {
    id v11 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"%K =[d] %@", @"objectSPIIdentifier", v8];
  ...
  if (v7)
  {
    ...
    switch(v12)
    {
      ...
      case 5:
        ...
        if (v18)
        {
          v19 = [v4 numberForKey:*MEMORY[0x1E4F2EE70]];
          if (v19)
          {
            v20 = v19;
...
LABEL_33:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            int v34 = 138543362;
            v35 = v30;
            _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@The actionSet provided by the intent does not exist.", (uint8_t *)&v34, 0xCu);
          }
          v31 = (void *)MEMORY[0x1E4F28C58];
          uint64_t v32 = 2;
        }
...
LABEL_22:
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v36 = 2112;
          v37 = v13;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Intent execution with entityType %@ is not yet supported.", (uint8_t *)&v34, 0x16u);
        }
        v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    int v34 = 138543362;
    v35 = v17;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Error - There is no content in intent to handle.", (uint8_t *)&v34, 0xCu);
  }
  v10 = [MEMORY[0x1E4F28C58] hmErrorWithCode:58];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_108542 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_108542, &__block_literal_global_108543);
  }
  v2 = (void *)logCategory__hmf_once_v4_108544;
  return v2;
}
...
uint64_t __33__HMDAssistantIntent_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v4_108544;
  logCategory__hmf_once_v4_108544 = v0;
