...
- (id)fullDescription
{
  ...
  v4 = [MEMORY[0x1E4F65568] indentation];
...
LABEL_27:
    _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_INFO, v58, buf, 0x16u);
  ...
  if (v25)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v26; ++i)
      {
        ...
        long long v30 = (void *)MEMORY[0x1E4F28F60];
        ...
        if (([v29 compareConstraints:v37] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v78 = 2112;
            v79 = v64;
            _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_INFO, "%{public}@Constraints on settings are not matching: %@", buf, 0x16u);
          }
...
- (void)intersectSettingGroup:(id)a3 groupMetadata:(id)a4 shouldAddMissingItems:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v178 = 1024;
    BOOL v179 = v138;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Group name is %@, intersecting. addMissing: %d", buf, 0x1Cu);
  ...
  if ([(HMDAccessorySettingGroup *)v10 isPrivateToDevice])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v176 = 2112;
      v177 = v18;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Skipping private group %@", buf, 0x16u);
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v175 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Received metadata is nil, not intersecting", buf, 0xCu);
      goto LABEL_90;
    }
LABEL_91:
  ...
  v21 = objc_msgSend(v20, "hmf_objectsPassingTest:", &__block_literal_global_38_145672);
  char v22 = [v19 setWithArray:v21];

  uint64_t v23 = (void *)MEMORY[0x1E4F1CAD0];
  uint64_t v24 = [v7 groups];
  uint64_t v25 = objc_msgSend(v24, "hmf_objectsPassingTest:", &__block_literal_global_40_145673);
  ...
  uint64_t v27 = (void *)MEMORY[0x1E4F1CA60];
  ...
  if (v47)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        BOOL v52 = (void *)MEMORY[0x1E4F28F60];
        v53 = [v51 name];
        ...
        if (!v79)
        {
          ...
          if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v176 = 2112;
            v177 = v77;
            _os_log_impl(&dword_1D49D5000, v82, OS_LOG_TYPE_INFO, "%{public}@Setting %@ does not have metadata, cannot merge", buf, 0x16u);
          ...
          if (!v104)
          {
            ...
            if (os_log_type_enabled(v107, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v176 = 2112;
              v177 = v99;
              _os_log_impl(&dword_1D49D5000, v107, OS_LOG_TYPE_INFO, "%{public}@Failed to merge setting %@, cannot merge", buf, 0x16u);
          ...
          if (!v119)
          {
            ...
            if (os_log_type_enabled(v122, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v176 = 2112;
              v177 = v116;
              _os_log_impl(&dword_1D49D5000, v122, OS_LOG_TYPE_INFO, "%{public}@No subgroup or settings, removing group %@", buf, 0x16u);
            }
...
- (BOOL)dataSourceShouldEncodeSetting:(id)a3 withCoder:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v26 = 2112;
      uint64_t v27 = v16;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@dataSource: %@, shouldEncodeSetting = %@, %@", (uint8_t *)&v20, 0x2Au);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode settings due to no data source", (uint8_t *)&v20, 0xCu);
    }
    char v10 = 0;
  }
...
- (void)_encodeWithCoder:(id)a3
{
  ...
  if ([(HMDAccessorySettingGroup *)self shouldEncodeForCoder:v4])
  {
    ...
    v14 = [MEMORY[0x1E4F1CAD0] setWithArray:v10];
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      v35 = v21;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEBUG, "%{public}@dataSource = %@, subtracted values = %@", buf, 0x20u);
    ...
    [v9 encodeObject:v22 forKey:*MEMORY[0x1E4F2C5B0]];

    uint64_t v23 = [(HMDAccessorySettingGroup *)v16 name];
    [v9 encodeObject:v23 forKey:*MEMORY[0x1E4F2C5B8]];

    [v9 encodeObject:v10 forKey:*MEMORY[0x1E4F2C5C0]];
    [v9 encodeObject:v7 forKey:*MEMORY[0x1E4F2C5A8]];
  }
}
...
- (id)_initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2C5B8]];
  uint64_t v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2C5B0]];
  ...
  if (v8)
  {
    ...
    uint64_t v10 = [v4 decodeObjectOfClasses:v9 forKey:*MEMORY[0x1E4F2C5C0]];
    ...
    {
      uint64_t v13 = v12;
      uint64_t v14 = [MEMORY[0x1E4F1CA80] setWithArray:v12];
      id v15 = v11[2];
      v11[2] = (id)v14;
    ...
    __int16 v22 = [v4 decodeObjectOfClasses:v21 forKey:*MEMORY[0x1E4F2C5A8]];
    ...
    if (v24)
    {
      uint64_t v33 = v12;
      __int16 v34 = v5;
      uint64_t v25 = [MEMORY[0x1E4F1CA80] setWithArray:v24];
      id v26 = v23[3];
      v23[3] = (id)v25;
...
BOOL __43__HMDAccessorySettingGroup__initWithCoder___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unexpected type found while decoding accessory setting", (uint8_t *)&v11, 0xCu);
    }
  }
...
BOOL __43__HMDAccessorySettingGroup__initWithCoder___block_invoke_35(uint64_t a1, void *a2)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unexpected type found while decoding accessory group", (uint8_t *)&v11, 0xCu);
    }
  }
...
- (id)copyReplica
{
  ...
  groups = v7->_groups;
  long long v17 = [MEMORY[0x1E4F1CAD0] setWithArray:v9];
  ...
  long long v26 = [MEMORY[0x1E4F1CAD0] setWithArray:v18];
  ...
  if ((unint64_t)[v4 count] >= 2)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v21 = 2112;
        uint64_t v22 = v12;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpected group name: %@ for group: %@", (uint8_t *)&v17, 0x20u);
      }
      id v5 = 0;
    }
  }
...
+ (id)supportedGroupsClasses
{
  if (supportedGroupsClasses_onceToken != -1) {
    dispatch_once(&supportedGroupsClasses_onceToken, &__block_literal_global_33_145724);
  }
...
+ (id)supportedSettingsClasses
{
  if (supportedSettingsClasses_onceToken != -1) {
    dispatch_once(&supportedSettingsClasses_onceToken, &__block_literal_global_29_145727);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_145729 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_145729, &__block_literal_global_145730);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v12_145731;
  return v2;
}
...
uint64_t __39__HMDAccessorySettingGroup_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v12_145731;
  logCategory__hmf_once_v12_145731 = v0;
