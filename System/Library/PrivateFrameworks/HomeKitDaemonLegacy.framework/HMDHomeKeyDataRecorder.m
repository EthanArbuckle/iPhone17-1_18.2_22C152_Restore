...
+ (id)sharedRecorder
{
  if (sharedRecorder_onceToken != -1) {
    dispatch_once(&sharedRecorder_onceToken, &__block_literal_global_111472);
  }
...
uint64_t __40__HMDHomeKeyDataRecorder_sharedRecorder__block_invoke()
{
  ...
  if (result)
  {
    ...
    uint64_t v2 = sharedRecorder_sharedRecorder;
    sharedRecorder_sharedRecorder = (uint64_t)v1;
