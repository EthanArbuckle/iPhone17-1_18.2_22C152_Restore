...
- (id)attributeDescriptions
{
  ...
  id v5 = [(HMDCharacteristicRequest *)self characteristic];
  id v6 = [v5 service];
  ...
  v39[4] = v24;
  id v26 = [MEMORY[0x1E4F1C978] arrayWithObjects:v39 count:5];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_188710 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_188710, &__block_literal_global_188711);
  }
  v2 = (void *)logCategory__hmf_once_v2_188712;
  return v2;
}
...
uint64_t __39__HMDCharacteristicRequest_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_188712;
  logCategory__hmf_once_v2_188712 = v0;
