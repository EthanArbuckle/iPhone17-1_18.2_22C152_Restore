  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v29 = 2112;
      id v30 = v7;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to store language value: %@ for keypath: %@", buf, 0x20u);
    }
  }
}
...
- (void)setNumberValue:(id)a3 forKeyPath:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to store integer value: %@ for keypath: %@", (uint8_t *)&v15, 0x20u);
    }
  }
}
...
- (void)setBoolValue:(BOOL)a3 forKeyPath:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v6;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to store BOOLean value: %@ for keypath: %@", (uint8_t *)&v18, 0x20u);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_55242 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_55242, &__block_literal_global_55243);
  }
  v2 = (void *)logCategory__hmf_once_v8_55244;
  return v2;
}
...
uint64_t __59__HMDSiriEndpointProfileAccessorySettingFields_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v8_55244;
  logCategory__hmf_once_v8_55244 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}

+ (id)languageValueKeyPaths
{
  return &unk_1F2DC6BE0;
}

+ (id)numberValueKeyPaths
{
  return &unk_1F2DC6BC8;
}

+ (id)BOOLeanValueKeyPaths
{
  return &unk_1F2DC6BB0;
}
