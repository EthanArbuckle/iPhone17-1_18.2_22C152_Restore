...
- (void)manager:(id)a3 didFinishInstallation:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishInstallation", (uint8_t *)&v12, 0xCu);
  }
...
- (void)manager:(id)a3 didFailInstallation:(id)a4 withError:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v16 = 138543362;
    v17 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFailInstallation", (uint8_t *)&v16, 0xCu);
  }
  if (v10)
  {
...
- (void)manager:(id)a3 didFinishDownload:(id)a4 willProceedWithInstallation:(BOOL)a5 waitingForAdmissionControl:(BOOL)a6 denialReasons:(id)a7
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v17 = 138543362;
    uint64_t v18 = v16;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishDownload", (uint8_t *)&v17, 0xCu);
  }
...
- (void)manager:(id)a3 didFinishDownload:(id)a4 willProceedWithInstallation:(BOOL)a5 waitingForAdmissionControl:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v14 = 138543362;
    v15 = v13;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishDownload", (uint8_t *)&v14, 0xCu);
  }
...
- (void)manager:(id)a3 didFinishDownload:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v12 = 138543362;
    v13 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFinishDownload", (uint8_t *)&v12, 0xCu);
  }
  [(HMDSoftwareUpdateEventProvider *)v9 forwardDescriptorEventWithErrorCode:0];
}
...
- (void)manager:(id)a3 didFailDownload:(id)a4 withError:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v16 = 138543362;
    int v17 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didFailDownload", (uint8_t *)&v16, 0xCu);
  }
  if (v10)
  {
    v15 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v10, "code"));
...
- (void)manager:(id)a3 didChangeProgressOnDownload:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager didChangeProgressOnDownload", (uint8_t *)&v13, 0xCu);
  }
  int v12 = [v7 progress];
...
- (void)manager:(id)a3 scanRequestPostponed:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v10;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager scanRequestPostponed with error: %@", (uint8_t *)&v16, 0x16u);
  }
  if (v10)
  {
...
- (void)manager:(id)a3 scanRequestDidLocateUpdate:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v10;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEBUG, "%{public}@SUControllerManager scanRequestDidLocateUpdate with error: %@", (uint8_t *)&v16, 0x16u);
  }
  if (v10)
  {
    uint64_t v15 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v10, "code"));
...
void __64__HMDSoftwareUpdateEventProvider_respondToScanFuturesWithError___block_invoke(uint64_t a1)
{
  ...
  id v10 = &unk_1E6A0F1F0;
  uint64_t v11 = *(void *)(a1 + 40);
  id v12 = v3;
  id v5 = v3;
  objc_msgSend(v4, "na_each:", &v7);

  id v6 = objc_msgSend(MEMORY[0x1E4F1CA48], "array", v7, v8, v9, v10, v11);
...
void __64__HMDSoftwareUpdateEventProvider_respondToScanFuturesWithError___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Responding to scan futures with didFindUpdate: %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)forwardDebouncedProgressEvent
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Forwarding progress event", (uint8_t *)&v13, 0xCu);
    }
    id v12 = [(HMDSoftwareUpdateEventProvider *)v9 context];
    [v12 forwardEvent:v4 withTopicSuffixID:*MEMORY[0x1E4F2C3A8]];
  }
}
...
- (void)forwardProgressEventWithProgress:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v31 = 138543362;
    v32 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Debouncing progress event", (uint8_t *)&v31, 0xCu);
  }
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v31 = 138543362;
      v32 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Progress is nil. Refreshing software update descriptor.", (uint8_t *)&v31, 0xCu);
    }
  ...
  if (v13)
  {
    ...
    if (v15)
    {
      id v16 = objc_alloc(MEMORY[0x1E4F2EB50]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        int v31 = 138543362;
        v32 = v30;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Event source was nil", (uint8_t *)&v31, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      int v31 = 138543362;
      v32 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create HMSoftwareUpdateProgress", (uint8_t *)&v31, 0xCu);
    }
  }
}
...
- (id)descriptorFromControllerStatus:(id)a3 controllerDescriptor:(id)a4 errorCode:(id)a5
{
  ...
  if (!v9)
  {
    ...
    uint64_t v14 = [v13 lastEventForTopicSuffixID:*MEMORY[0x1E4F2C3A0]];

    if (v14)
    {
      uint64_t v15 = [MEMORY[0x1E4F2EB28] descriptorFromEvent:v14];
      if (v15)
      {
        id v12 = v15;

        id v16 = (void *)MEMORY[0x1D9452090](objc_msgSend(v12, "setStatus:", objc_msgSend(v11, "status")));
        int v17 = self;
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v31 = 2112;
          id v32 = v12;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Forwarding previous descriptor: %@", (uint8_t *)&v29, 0x16u);
        }
...
LABEL_13:
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v31 = 2112;
        id v32 = v14;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse descriptor from previous event: %@", (uint8_t *)&v29, 0x16u);
      }
    }
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      int v29 = 138543362;
      v30 = v27;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Current and previous descriptor are both nil", (uint8_t *)&v29, 0xCu);
    }
    id v12 = v11;
    goto LABEL_13;
  }
...
- (void)forwardDescriptorEventWithErrorCode:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v14 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Forwarding descriptor event", buf, 0xCu);
  }
...
void __70__HMDSoftwareUpdateEventProvider_forwardDescriptorEventWithErrorCode___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v38 = 2112;
    id v39 = v9;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Controller status:\n%@\n\nController descriptor:\n%@\nerror: %@", (uint8_t *)&v32, 0x2Au);
  }
  if (v9)
  {
...
LABEL_7:
    ...
    uint32_t v20 = 22;
LABEL_6:
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v32, v20);
  ...
  if (v23)
  {
    id v24 = objc_alloc(MEMORY[0x1E4F2EB30]);
    ...
    [v27 forwardEvent:v26 withTopicSuffixID:*MEMORY[0x1E4F2C3A0]];
  }
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      int v32 = 138543362;
      uint64_t v33 = v31;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Event source was nil", (uint8_t *)&v32, 0xCu);
    }
  }
...
- (void)scanWithOptions:(unint64_t)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2048;
    unint64_t v28 = a3;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Scanning with options: %lu", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_105609 != -1) {
    dispatch_once(&logCategory__hmf_once_t29_105609, &__block_literal_global_105610);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v30_105611;
  return v2;
}

uint64_t __45__HMDSoftwareUpdateEventProvider_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v30_105611;
  logCategory__hmf_once_v30_105611 = v0;
