...
LABEL_29:
    ...
    if (v33)
    {
      id v34 = objc_alloc(MEMORY[0x1E4F6ABA0]);
      v35 = [MEMORY[0x1E4F1CAD0] setWithObject:v33];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v62 = 2112;
        id v63 = v11;
        _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Failed to create session for device, could not create destination: %@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v62 = 2112;
        id v63 = v11;
        _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to create session for device: %@", buf, 0x16u);
      }
      v20 = 0;
    }
  }
