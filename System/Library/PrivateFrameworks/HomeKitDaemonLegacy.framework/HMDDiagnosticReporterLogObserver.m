...
void __66__HMDDiagnosticReporterLogObserver_didReceiveEventFromDispatcher___block_invoke(uint64_t a1)
{
  ...
  {
    v2 = [MEMORY[0x1E4F65540] processInfo];
    ...
    [v8 setObject:v9 forKeyedSubscript:*MEMORY[0x1E4FA8CA8]];

    v10 = [MEMORY[0x1E4F28B50] mainBundle];
    v11 = [v10 objectForInfoDictionaryKey:*MEMORY[0x1E4F1D020]];

    if (v11) {
      [v8 setObject:v11 forKeyedSubscript:@"projectver"];
    }
    if ([*(id *)(a1 + 40) conformsToProtocol:&unk_1F2E0A1F0])
    {
      id v12 = *(id *)(a1 + 40);
      objc_opt_class();
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      v41 = v19;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Submitting event: %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      v41 = v8;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Submitting signature: %@", buf, 0x16u);
    }
    objc_initWeak(&location, *(id *)(a1 + 32));
    v24 = [*(id *)(a1 + 32) reporter];
    v35[0] = MEMORY[0x1E4F143A8];
    v35[1] = 3221225472;
    v35[2] = __66__HMDDiagnosticReporterLogObserver_didReceiveEventFromDispatcher___block_invoke_76;
    v35[3] = &unk_1E6A195E8;
    ...
    if ((v25 & 1) == 0)
    {
      v30 = (void *)MEMORY[0x1D9452090](v26, v27, v28, v29);
      id v31 = *(id *)(a1 + 32);
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v40 = 2112;
        v41 = v34;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to submit event: %@", buf, 0x16u);
      }
    }
...
void __66__HMDDiagnosticReporterLogObserver_didReceiveEventFromDispatcher___block_invoke_76(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v3;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitted event with response: %@", (uint8_t *)&v9, 0x16u);
  }
}
...
- (void)stop
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    int v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping", (uint8_t *)&v8, 0xCu);
  }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v9, 0xCu);
  }
  id v7 = [(HMDDiagnosticReporterLogObserver *)v4 logEventDispatcher];
...
- (HMDDiagnosticReporterLogObserver)initWithLogEventDispatcher:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v15 = [objc_alloc(MEMORY[0x1E4FA8AF0]) initWithQueue:v6->_clientQueue];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_189288 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_189288, &__block_literal_global_79_189289);
  }
  v2 = (void *)logCategory__hmf_once_v9_189290;
  return v2;
}
...
uint64_t __47__HMDDiagnosticReporterLogObserver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v9_189290;
  logCategory__hmf_once_v9_189290 = v0;
...
{
  id v3 = a3;
  if (![v3 conformsToProtocol:&unk_1F2E0A1F0]
...
+ (id)typeForEvent:(id)a3
{
    ...
    || ([v3 diagnosticReportEventType], (id v4 = (__CFString *)objc_claimAutoreleasedReturnValue()) == 0))
  {
    ...
    if (v5 == objc_opt_class())
    {
      id v6 = (id *)MEMORY[0x1E4FA8CE8];
      goto LABEL_8;
    }
    if (v5 != objc_opt_class())
    {
      id v6 = (id *)MEMORY[0x1E4FA8CD8];
LABEL_8:
      id v4 = (__CFString *)*v6;
      goto LABEL_10;
    }
...
+ (id)supportedEventClasses
{
  if (supportedEventClasses_onceToken_189314 != -1) {
    dispatch_once(&supportedEventClasses_onceToken_189314, &__block_literal_global_189315);
  }
  v2 = (void *)supportedEventClasses_supportedEventClasses_189316;
  return v2;
}
...
void __57__HMDDiagnosticReporterLogObserver_supportedEventClasses__block_invoke()
{
  ...
  uint64_t v1 = (void *)supportedEventClasses_supportedEventClasses_189316;
  supportedEventClasses_supportedEventClasses_189316 = v0;
}
