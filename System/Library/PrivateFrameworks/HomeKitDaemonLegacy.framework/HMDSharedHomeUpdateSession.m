  ...
  if (a1)
  {
    if (*(void *)(a1 + 64) < 3uLL)
    {
      ...
      if (v16)
      {
        if (v20)
        {
          ...
          *(_WORD *)&buf[22] = 2112;
          v38 = v16;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Sending sync request session %@ with resident %@", buf, 0x20u);
        }
      ...
      else
      {
        if (v20)
        {
          ...
          *(void *)&buf[4] = v29;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@No valid residents, cannot continue", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        *(void *)&buf[4] = v5;
        _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Retry count has maxed out, cannot continue", buf, 0xCu);
      }
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      BOOL v20 = v5;
      _os_log_impl(&dword_1D49D5000, v3, OS_LOG_TYPE_INFO, "%{public}@Starting the retry timer with %@ seconds", buf, 0x16u);
    }
    uint64_t v6 = [objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:1 options:*((double *)v2 + 9)];
    ...
    *((double *)v2 + 9) = *((double *)v2 + 9) + (double)(unint64_t)(60 * requestHomeDataSyncRetryPeriodInMinutes);
    v11 = (void *)MEMORY[0x1D9452090](v10);
    id v12 = v2;
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      BOOL v20 = v15;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Bumped the next timer's value to %@", buf, 0x16u);
    }
  }
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating the session", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_180007 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_180007, &__block_literal_global_180008);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v2_180009;
  return v2;
}
...
uint64_t __41__HMDSharedHomeUpdateSession_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_180009;
  logCategory__hmf_once_v2_180009 = v0;
