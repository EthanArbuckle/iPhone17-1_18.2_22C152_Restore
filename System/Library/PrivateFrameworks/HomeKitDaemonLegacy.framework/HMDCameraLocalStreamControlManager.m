  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Sending updated configuration", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Reselected config failed to extract", buf, 0xCu);
      }
...
- (void)streamManagerDidStartStream:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Stream manager did start stream", (uint8_t *)&v10, 0xCu);
  }
...
- (void)deviceConnectionSender:(id)a3 didEndSessionWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v12;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Session stopped, stopping the stream", (uint8_t *)&v13, 0xCu);
  }
...
- (void)deviceConnectionSender:(id)a3 didSetUpWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      uint64_t v19 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up IDSDeviceConnection for stream", (uint8_t *)&v18, 0xCu);
    }
    [(HMDCameraLocalStreamControlManager *)v10 _cleanUpStreamSessionWithError:v7];
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      uint64_t v19 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Device connection sender is set up", (uint8_t *)&v18, 0xCu);
    }
...
- (void)sessionInitiator:(id)a3 didSetUpWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      uint64_t v19 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up IDSSession for stream", (uint8_t *)&v18, 0xCu);
    }
    [(HMDCameraLocalStreamControlManager *)v10 _cleanUpStreamSessionWithError:v7];
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      uint64_t v19 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Session initiator is setup", (uint8_t *)&v18, 0xCu);
    }
    [(HMDCameraLocalStreamControlManager *)v15 _startStreamManager];
  }
}
...
- (void)_cleanUpStreamSessionWithError:(id)a3
{
  ...
  if (v6)
  {
    if (v10)
    {
      ...
      int v16 = 138543362;
      int v17 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Cleaning up the stream", (uint8_t *)&v16, 0xCu);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      int v16 = 138543362;
      int v17 = v15;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@No current stream session to clean up", (uint8_t *)&v16, 0xCu);
    }
  }
}
...
LABEL_11:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v26 = v17;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Writing stop stream configuration", buf, 0xCu);
  }
...
- (void)_writeReselectConfig
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v14 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Writing reselect stream configuration", buf, 0xCu);
  }
...
- (void)_writeStartConfig
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v14 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Writing start stream configuration", buf, 0xCu);
  }
  os_log_type_t v11 = [(HMDCameraLocalStreamControlManager *)v8 accessoryCommunicator];
  v12[0] = MEMORY[0x1E4F143A8];
  v12[1] = 3221225472;
...
- (void)stopStreamWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Received request to stop the stream with session ID %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)updateMaximumVideoResolutionQuality:(int64_t)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2048;
    int64_t v25 = a3;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Received request to update maximum video resolution quality: %lu", (uint8_t *)&v22, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v22 = 138543362;
      uint64_t v23 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@No current stream session to reconfigure", (uint8_t *)&v22, 0xCu);
    }
    v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
...
- (void)reconfigureStream:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v38 = 2112;
    id v39 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Received request to reconfigure the stream with session ID %@", buf, 0x16u);
  }
  ...
  if (v11)
  {
    ...
    {
      id v35 = 0;
      __int16 v13 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v12 error:&v35];
      id v14 = v35;
      ...
      if (v13)
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v40 = 2112;
          v41 = v13;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Updating the current picked tier from %@ to %@", buf, 0x20u);
      ...
      else
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v38 = 2112;
          id v39 = v14;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera video tier from video tier data: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v37 = v32;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Missing reconfigured tier data", buf, 0xCu);
      }
  ...
  {
    int64_t v25 = (void *)MEMORY[0x1D9452090]();
    uint64_t v26 = v7;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v37 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to reconfigure", buf, 0xCu);
    }
...
LABEL_9:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        v43 = v33;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Current state: %@, waiting", buf, 0x16u);
      }
LABEL_10:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v37;
      _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not extract a configuration from the given parameters", buf, 0xCu);
    }
...
- (id)_calculateMTU
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      uint64_t v26 = v12;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Reporting stream sender reported MTU %@", (uint8_t *)&v23, 0x16u);
    }
...
- (void)startStreamWithRemoteSettings:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v66 = 2112;
    id v67 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Received request to start stream with remote settings: %@", buf, 0x16u);
  }
  if ([(HMDCameraLocalStreamControlManager *)v7 isSendingStream])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v65 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Using the sync sources from remote settings", buf, 0xCu);
    }
  ...
  else
  {
    ...
    {
LABEL_14:
      uint64_t v44 = (void *)MEMORY[0x1D9452090]([(HMDCameraStreamControlManager *)v7 _reportInternalErrorCode:1045]);
      v45 = v7;
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v65 = v47;
        _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@SSRC is nil, cannot select config parameters", buf, 0xCu);
      }
      goto LABEL_27;
    }
  }
  ...
  if (v33)
  {
    ...
    if (v36 >= v37)
    {
      if (v41)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v65 = v49;
        _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, "%{public}@Remote MTU is provided, and is lower than local MTU", buf, 0xCu);
      }
      v48 = v33;
      goto LABEL_24;
    }
...
LABEL_19:
      _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_INFO, v43, buf, 0xCu);
    }
  }
  else
  {
...
LABEL_24:
  ...
  if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v70 = 2112;
    id v71 = v51;
    _os_log_impl(&dword_1D49D5000, v54, OS_LOG_TYPE_INFO, "%{public}@Remote MTU %@, Local MTU %@, Picked MTU %@", buf, 0x2Au);
  }
...
LABEL_11:
    _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, v24, (uint8_t *)&v28, 0xCu);
...
void __67__HMDCameraLocalStreamControlManager__sendSetupEndPointReadRequest__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v38 = 2112;
        id v39 = v5;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Received setup endpoint read response: %@", (uint8_t *)&v36, 0x16u);
      }
      if ([v5 responseStatus])
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v38 = 2112;
          id v39 = v18;
          _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Accessory setup endpoint read failed: %@", (uint8_t *)&v36, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v38 = 2112;
        id v39 = v6;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to read setup endpoint: %@", (uint8_t *)&v36, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      int v36 = 138543362;
      unint64_t v37 = v22;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Session ended while reading setup endpoint", (uint8_t *)&v36, 0xCu);
    }
  }
}
...
LABEL_15:
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v58 = v53;
        _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_ERROR, "%{public}@Could not select the end point setup parameters", buf, 0xCu);
      }
      v48 = v51;
      uint64_t v49 = 1041;
    }
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v58 = v47;
        _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@Could not find the right match in the supported list", buf, 0xCu);
      }
      v48 = v45;
      uint64_t v49 = 1044;
    }
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v58 = v43;
    _os_log_impl(&dword_1D49D5000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to create stream manager for local stream", buf, 0xCu);
  }
...
void __68__HMDCameraLocalStreamControlManager__sendSetupEndPointWriteRequest__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    if (v3)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v15 = 2112;
        id v16 = v3;
        _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to write setup endpoint: %@", (uint8_t *)&v13, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      id v14 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Session ended while writing setup endpoint", (uint8_t *)&v13, 0xCu);
    }
  }
}
...
- (void)_getSupportedConfigurations
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v11 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Getting Supported Configuration", buf, 0xCu);
  }
...
void __65__HMDCameraLocalStreamControlManager__getSupportedConfigurations__block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (v13)
  {
    ...
    if (v9 && v10 && v11)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v42 = 2112;
        id v43 = v9;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating supportedVideoStreamConfiguration: %@", (uint8_t *)&v40, 0x16u);
      }
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v42 = 2112;
        id v43 = v10;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Updating supportedAudioStreamConfiguration: %@", (uint8_t *)&v40, 0x16u);
      }
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v42 = 2112;
        id v43 = v11;
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Updating supportedRTPConfiguration: %@", (uint8_t *)&v40, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      int v40 = 138543362;
      BOOL v41 = v39;
      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Session ended while getting supported configurations", (uint8_t *)&v40, 0xCu);
    }
  }
}
...
- (void)negotiateStream
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v44 = 138543362;
    v45 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Received a request to negotiate video stream", (uint8_t *)&v44, 0xCu);
  }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v46 = 2112;
      v47 = v29;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Using cached supportedVideoConfiguration: %@", (uint8_t *)&v44, 0x16u);
    }
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v46 = 2112;
      v47 = v36;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Using cached supportedAudioConfiguration: %@", (uint8_t *)&v44, 0x16u);
    }
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v46 = 2112;
      v47 = v43;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@Using cached supportedRTPConfiguration: %@", (uint8_t *)&v44, 0x16u);
    }
...
LABEL_26:
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v55 = 2112;
    id v56 = v52;
    _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Local network config: %@", buf, 0x16u);
  }
  if (v48)
  {
    ...
    else
    {
      if (!isiOSDevice())
      {
        id v42 = [MEMORY[0x1E4F1CA00] exceptionWithName:*MEMORY[0x1E4F1C3B8] reason:@"Cannot relay stream from current device" userInfo:0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t50_108944 != -1) {
    dispatch_once(&logCategory__hmf_once_t50_108944, &__block_literal_global_108945);
  }
  v2 = (void *)logCategory__hmf_once_v51_108946;
  return v2;
}
...
uint64_t __49__HMDCameraLocalStreamControlManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v51_108946;
  logCategory__hmf_once_v51_108946 = v0;
