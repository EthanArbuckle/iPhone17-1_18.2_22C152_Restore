        ...
        else
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v22;
            ...
            __int16 v31 = 2112;
            v32 = v12;
            _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Accessory UUID is nil for media component: %@", buf, 0x16u);
...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_96407 != -1) {
    dispatch_once(&properties_onceToken_96407, block);
  }
  v2 = (void *)properties__properties_96408;
  return v2;
}
...
void __33__HMDMediaSystemModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_96408;
  properties__properties_96408 = v3;

  v5 = (void *)properties__properties_96408;
  v11[0] = @"name";
