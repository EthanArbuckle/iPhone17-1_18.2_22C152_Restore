...
{
  id v10 = 0;
  v2 = [MEMORY[0x1E4F65438] futureWithPromise:&v10];
...
+ (id)combineAllFuturesIgnoringEmptyResults:()HMDUtilities
{
  ...
  v8 = [v7 flatMap:&__block_literal_global_743];
...
+ (id)combineAllFuturesFlatteningArrayResults:()HMDUtilities
{
  ...
  v8 = [v7 flatMap:&__block_literal_global_738];
...
+ (id)futureWithRetryIntervals:()HMDUtilities workQueue:block:
{
  ...
  v12 = v10[2](v10, v8);
  v13 = [MEMORY[0x1E4F7A0F0] schedulerWithDispatchQueue:v9];
...
+ (id)futureWithRetries:()HMDUtilities timeInterval:workQueue:block:
{
  ...
  v13 = v11[2](v11, a4);
  v14 = [MEMORY[0x1E4F7A0F0] schedulerWithDispatchQueue:v10];
