...
- (void)cacheClearUUIDs
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Clearing cached UUIDs", (uint8_t *)&v8, 0xCu);
  }
  cachedEntries = v4->_cachedEntries;
  v4->_cachedEntries = (NSArray *)MEMORY[0x1E4F1CBF0];
...
- (id)cacheCopySigningIdentifierForProcessIdentifier:(id)a3
{
  ...
  else
  {
    ...
    v9 = (void *)v8;
    if (v8 && MEMORY[0x1D9452F20](v8) == MEMORY[0x1E4F145F0])
    {
...
- (id)cacheCopyAppUUIDForSigningIdentifier:(id)a3 executablePath:(id)a4
{
  ...
  id v10 = (void *)v9;
  if (v9 && MEMORY[0x1D9452F20](v9) == MEMORY[0x1E4F14568])
  {
    uint64_t v14 = 0;
    v15 = &v14;
    uint64_t v16 = 0x3032000000;
    v17 = __Block_byref_object_copy__8992;
    v18 = __Block_byref_object_dispose__8993;
    id v19 = objc_alloc_init(MEMORY[0x1E4F1CA48]);
    applier[0] = MEMORY[0x1E4F143A8];
    applier[1] = 3221225472;
    applier[2] = __73__HMDNEHelperClient_cacheCopyAppUUIDForSigningIdentifier_executablePath___block_invoke;
    applier[3] = &unk_1E6A06538;
    applier[4] = &v14;
...
uint64_t __73__HMDNEHelperClient_cacheCopyAppUUIDForSigningIdentifier_executablePath___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  id v4 = a3;
  v5 = v4;
  if (v4 && MEMORY[0x1D9452F20](v4) == MEMORY[0x1E4F14600])
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDBytes:xpc_uuid_get_bytes(v5)];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Local cache hit for %@: %@", buf, 0x20u);
    }
  }
  ...
  if ([(NSArray *)cachedEntries indexOfObjectPassingTest:v17] == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Caching process identifiers for %@: %@", buf, 0x20u);
    }
...
- (HMDNEHelperClient)init
{
  ...
  if (v2)
  {
    ...
    v2->_cachedEntries = (NSArray *)MEMORY[0x1E4F1CBF0];
  }
  return v3;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3 != -1) {
    dispatch_once(&logCategory__hmf_once_t3, &__block_literal_global_9002);
  }
...
{
  logCategory__hmf_once_uint64_t v4 = HMFCreateOSLogHandle();
