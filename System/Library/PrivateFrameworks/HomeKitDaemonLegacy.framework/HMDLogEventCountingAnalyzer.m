...
- (void)incrementPeriodicCountersForEventName:(id)a3
{
  ...
  {
    [(NSMutableDictionary *)self->_currentPeriodCounters setObject:&unk_1F2DC7AC8 forKeyedSubscript:v8];
  }
...
void __105__HMDLogEventCountingAnalyzer_initWithEventCountersManager_dailyScheduler_dateProvider_systemInfo_queue___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v5;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@[Logging Period = %d Minutes] Metric event counts on current device: %@ %@", (uint8_t *)&v11, 0x26u);
  }
}
...
{
  uint64_t v2 = [*(id *)(a1 + 32) dateProvider];
...
- (HMDLogEventCountingAnalyzer)initWithEventCountersManager:(id)a3 dailyScheduler:(id)a4 dateProvider:(id)a5 systemInfo:(id)a6 queue:(id)a7
{
  ...
  v14[3] = &unk_1E6A09A18;
  __int16 v15 = self;
  id v12 = [(HMDLogEventCountingAnalyzer *)v15 initWithEventCountersManager:a3 dailyScheduler:a4 dateProvider:a5 systemInfo:a6 queue:a7 loggingPeriodicitySeconds:900 tickSecondsProviderBlock:&__block_literal_global_37292 periodicCountersLoggingBlock:v14];
