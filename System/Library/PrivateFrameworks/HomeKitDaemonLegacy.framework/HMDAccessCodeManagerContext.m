...
- (id)generateAccessCodeValueFromConstraints:(id)a3 accessoryAccessCodes:(id)a4 homeAccessCodes:(id)a5
{
  return (id)[MEMORY[0x1E4F2E4C8] generateAccessCodeValueFromConstraints:a3 accessoryAccessCodes:a4 homeAccessCodes:a5];
}
...
{
  id v2 = [(HMDAccessCodeManagerContext *)self accessoriesSupportingAccessCodes];
  uint64_t v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_56);
...
- (NSArray)accessoriesSupportingAccessCodes
{
  ...
  uint64_t v3 = [v2 hapAccessories];
  id v4 = objc_msgSend(v3, "na_filter:", &__block_literal_global_2820);
...
- (id)_performMockedReadRequests:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to mock data for write requests: %@", (uint8_t *)&v15, 0x16u);
    }
...
- (id)performReadRequests:(id)a3 withRetries:(int64_t)a4 timeInterval:(double)a5 loggingObject:(id)a6
{
  ...
  if ([(HMDAccessCodeManagerContext *)self isDemoDataMockerEnabled])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      v20 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Demo Data Mocker is enabled, not reading from real accessory.", (uint8_t *)&v19, 0xCu);
    }
...
- (id)performWriteRequests:(id)a3 withRetries:(int64_t)a4 timeInterval:(double)a5 loggingObject:(id)a6
{
  ...
  if ([(HMDAccessCodeManagerContext *)self isDemoDataMockerEnabled])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      v20 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Demo Data Mocker is enabled, not writing to real accessory.", (uint8_t *)&v19, 0xCu);
    }
...
- (double)residentDataSyncVerificationRetryTimeInterval
{
  BOOL v2 = [MEMORY[0x1E4F65530] sharedPreferences];
...
{
  BOOL v2 = [MEMORY[0x1E4F65530] sharedPreferences];
  char v3 = [v2 preferenceForKey:@"HMDAccessCodeManagerAccessoryReadWriteRetryTimeInterval"];
  char v4 = [v3 numberValue];
  double v5 = (double)[v4 integerValue];
...
{
  BOOL v2 = [MEMORY[0x1E4F65530] sharedPreferences];
  char v3 = [v2 preferenceForKey:@"HMDAccessCodeManagerAccessoryReadWriteRetries"];
  char v4 = [v3 numberValue];
  int64_t v5 = [v4 integerValue];
...
LABEL_9:
  ...
  if (v12)
  {
    ...
    [MEMORY[0x1E4F65420] blessWithImplicitContext:v13->_workQueue];
  }
...
{
  logCategory__hmf_once_id v5 = HMFCreateOSLogHandle();
