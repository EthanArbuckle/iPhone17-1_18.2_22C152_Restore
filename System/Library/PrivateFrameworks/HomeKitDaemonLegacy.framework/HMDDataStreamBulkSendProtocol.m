...
LABEL_15:
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, v21, buf, 0x16u);
    ...
    if ([v24 shouldCloseSessionWithTimeoutReason])
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v41 = v28;
        _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Skipping invoking the session start callback since handle response timer hasn't expired", buf, 0xCu);
      }
    }
    else
    {
      v33 = [v24 sessionStartCallback];
      v34 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:8 userInfo:0];
...
LABEL_21:
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = 0;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Could not find expired timer for session with identifier: %@", buf, 0x16u);
    }
  }
}
...
- (void)_openSessionForFileType:(id)a3 reason:(id)a4 metadata:(id)a5 queue:(id)a6 callback:(id)a7
{
  ...
  v53[2] = @"controller";
  v53[3] = v13;
  v19 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v53 forKeys:v52 count:4];
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v50 = 2112;
    id v51 = v14;
    _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Starting bulk session with identifier: %@ and metadata: %@", buf, 0x20u);
  }
  ...
  if (v12)
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v59 = 2112;
      v60 = v7;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Received bulk send open response for session with identifier: %@ error: %@", buf, 0x20u);
    }
    ...
    if ([v12 shouldCloseSessionWithTimeoutReason])
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v57 = 2112;
        v58 = v24;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Session with identifier: %@ has timed out, sending close event to accessory", buf, 0x16u);
      }
      [*(id *)(a1 + 32) _sendCloseMessageWithIdentifier:*(void *)(a1 + 40) reason:6];
      v25 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:8 userInfo:0];
    ...
    else
    {
      ...
      if (v28)
      {
        ...
        if (v30)
        {
          ...
          v47 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:v35 userInfo:0];
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v61 = 2112;
            v62 = v52;
            _os_log_impl(&dword_1D49D5000, v49, OS_LOG_TYPE_ERROR, "%{public}@Received non-success status in header: %@ payload status: %@. Mapped to error: %@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v56 = v39;
          _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Could not find a status in header", buf, 0xCu);
        }
        v33 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F2D140] code:27 userInfo:0];
        (*(void (**)(void))(*(void *)(a1 + 56) + 16))();
      }
    }
  }
  else
  {
    if (v16)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v57 = 2112;
      v58 = v27;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Could not find pending bulk send session context for session identifier: %@", buf, 0x16u);
    }
    [*(id *)(a1 + 32) _sendCloseMessageWithIdentifier:*(void *)(a1 + 40) reason:6];
  }
}
...
- (void)_sendAckMessageWithIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending 'ack' for sid=%@", (uint8_t *)&v11, 0x16u);
    }
    [v5 sendEventForProtocol:@"dataSend" topic:@"ack" payload:v6 completion:&__block_literal_global_46_122954];
  }
}
...
- (void)_sendCloseMessageWithIdentifier:(id)a3 reason:(unsigned __int16)a4
{
  ...
  if (v7)
  {
    ...
    v21[1] = v8;
    id v9 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v21 forKeys:v20 count:2];
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 1024;
      int v19 = v4;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Sending 'close' for sid=%@ with reason %d", (uint8_t *)&v14, 0x1Cu);
    }
    [v7 sendEventForProtocol:@"dataSend" topic:@"close" payload:v9 completion:&__block_literal_global_44_122958];
  }
}
...
LABEL_15:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    int v21 = 138543362;
    id v22 = v20;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Received message with no packets", (uint8_t *)&v21, 0xCu);
  }
LABEL_19:
}
...
- (void)_handleDataMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v19 = 2112;
        id v20 = v7;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Data packet for streamIdentifier=%@ dropped because no session is active", (uint8_t *)&v17, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      __int16 v18 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Data packet dropped because no session identifier was present", (uint8_t *)&v17, 0xCu);
    }
  }
}
...
- (void)_handleCloseMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v15)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v7;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received close packet for stream identifier: %@", (uint8_t *)&v26, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v7;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Close packet for streamIdentifier=%@ dropped because no session is active", (uint8_t *)&v26, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      id v27 = v24;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Close dropped because streamIdentifier was not included", (uint8_t *)&v26, 0xCu);
    }
  }
}
...
- (void)_handleOpenWithRequestHeader:(id)a3 payload:(id)a4
{
  ...
  if (v10 && v13)
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v33 = 2112;
        id v34 = v10;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Received 'open' with type=%@; passing to listener",
          (uint8_t *)&v31,
          0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v33 = 2112;
        id v34 = v10;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Received 'open' for type=%@ but no active listener accepted it", (uint8_t *)&v31, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v35 = 2112;
      id v36 = v13;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Dropping 'open' because it is missing required keys (type=%@, target=%@)", (uint8_t *)&v31, 0x20u);
    }
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 2048;
      uint64_t v22 = v5;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending open response with status %@ (%ld)", buf, 0x20u);
    }
    v16[0] = MEMORY[0x1E4F143A8];
    v16[1] = 3221225472;
    v16[2] = __83__HMDDataStreamBulkSendProtocol__sendOpenResponseWithRequestHeader_payload_status___block_invoke;
    void v16[3] = &unk_1E6A197F0;
    v16[4] = v12;
...
- (id)_createSessionFromCandidate:(id)a3 queue:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v8;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive session with streamIdentifier=%@", (uint8_t *)&v19, 0x16u);
  }
...
- (id)_createSessionCandidateWithRequestHeader:(id)a3 metadata:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive candidate session (header %@)", (uint8_t *)&v14, 0x16u);
  }
  ...
  if ([(HMDDataStreamBulkSendProtocol *)self isConnected])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v20 = 2112;
        id v21 = v11;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@DataSend received unexpected request '%@'", (uint8_t *)&v18, 0x16u);
      }
    }
  }
}
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v23 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@DataStream did open; connected.", buf, 0xCu);
  }
...
- (void)dataStreamDidClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream closed; cleaning up",
      (uint8_t *)&v9,
      0xCu);
  }
...
- (void)dataStreamInitiatedClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream initiated closing...", (uint8_t *)&v9, 0xCu);
  }
}
...
- (void)dataStream:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v7;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@DataStream failed with error; cleaning up. (%@)",
      (uint8_t *)&v12,
      0x16u);
  }
...
- (void)_closeAllSessionsWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Session closed; removing %lu listeners and closing %lu sessions",
      buf,
      0x20u);
  }
  ...
  if (v4)
  {
    ...
    id v41 = v4;
    int v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v41 forKeys:&v40 count:1];
  }
  else
  {
    int v12 = 0;
  }
  uint64_t v13 = [MEMORY[0x1E4F28C58] errorWithDomain:*MEMORY[0x1E4F289A0] code:-1005 userInfo:v12];
...
- (void)_notifyActiveStatusChangedFromPreviousValue:(BOOL)a3
{
  ...
  if ([(HMDDataStreamBulkSendProtocol *)self isActive] != a3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      uint64_t v13 = v8;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@BulkSend protocol changes active to %@", (uint8_t *)&v10, 0x16u);
    }
...
- (void)addListener:(id)a3 fileType:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Rejecting BulkSend registration for file type %@; handler already exists",
        (uint8_t *)&v17,
        0x16u);
    }
...
- (HMDDataStreamBulkSendProtocol)initWithQueue:(id)a3 accessory:(id)a4 logIdentifier:(id)a5
{
  return [(HMDDataStreamBulkSendProtocol *)self initWithQueue:a3 accessory:a4 logIdentifier:a5 bulkSendSessionContextFactory:&__block_literal_global_122997];
}
...
{
  v2 = (objc_class *)MEMORY[0x1E4F65580];
  id v3 = a2;
  id v4 = (void *)[[v2 alloc] initWithTimeInterval:0 options:5.0];
  BOOL v5 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:10.0];
