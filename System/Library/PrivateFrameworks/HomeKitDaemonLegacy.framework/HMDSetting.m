...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    [v4 encodeObject:v5 forKey:*MEMORY[0x1E4F2C5C8]];
    ...
    [v4 encodeObject:v7 forKey:*MEMORY[0x1E4F2C5D8]];

    v8 = [(HMDSetting *)self name];
    [v4 encodeObject:v8 forKey:*MEMORY[0x1E4F2C5D0]];

    v9 = [(HMDSetting *)self constraints];
    [v4 encodeObject:v9 forKey:*MEMORY[0x1E4F2C5A0]];

    v10 = [(HMDSetting *)self value];
    [v4 encodeObject:v10 forKey:*MEMORY[0x1E4F2C610]];

    v11 = [(HMDSetting *)self type];
    [v4 encodeObject:v11 forKey:*MEMORY[0x1E4F2C5F8]];
  }
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      v17 = v15;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Did not encode setting as transport is not XPC.", (uint8_t *)&v16, 0xCu);
    }
  }
}
...
LABEL_61:
          _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, v17, v105, 0x16u);
    ...
    case 5:
      ...
      if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v105 = 138543362;
        v106 = v58;
        _os_log_impl(&dword_1D49D5000, v57, OS_LOG_TYPE_INFO, "%{public}@Value cannot be used for collection.", v105, 0xCu);
      }
      goto LABEL_94;
    default:
      goto LABEL_94;
        ...
        case 3:
          ...
          if (v34)
          {
            if (!v22)
            {
              ...
              if (os_log_type_enabled(v71, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v111 = 2112;
                id v112 = v73;
                _os_log_impl(&dword_1D49D5000, v71, OS_LOG_TYPE_DEFAULT, "%{public}@Value is nil but have step value constraint: %@", buf, 0x16u);
            ...
            if (v40 > 0.00000011920929)
            {
              ...
              {
                contextb = (void *)MEMORY[0x1D9452090](v41);
                v100 = v21;
                ...
                if (os_log_type_enabled(v84, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  __int16 v115 = 2112;
                  id v116 = v26;
                  _os_log_impl(&dword_1D49D5000, v84, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, does not conform to step, %@, from current value: %@", buf, 0x2Au);
...
LABEL_44:
              _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_DEFAULT, v52, buf, 0x16u);
...
LABEL_74:
              _os_log_impl(&dword_1D49D5000, v66, OS_LOG_TYPE_DEFAULT, v68, buf, 0x20u);
...
LABEL_75:
            ...
            if (v88)
            {
              id v75 = [MEMORY[0x1E4F28C58] hmErrorWithCode:44];
              id v22 = 0;
              goto LABEL_91;
            }
            id v22 = 0;
          ...
          if ([v22 compare:v44] == 1)
          {
            ...
            if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v113 = 2112;
              id v114 = v44;
              _os_log_impl(&dword_1D49D5000, v81, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, more than maximum value: %@", buf, 0x20u);
          ...
          if ([v22 compare:v31] == -1)
          {
            ...
            if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v113 = 2112;
              id v114 = v31;
              _os_log_impl(&dword_1D49D5000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, less than minimum value: %@", buf, 0x20u);
        ...
        default:
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v111 = 2112;
            id v112 = v22;
            _os_log_impl(&dword_1D49D5000, v61, OS_LOG_TYPE_ERROR, "%{public}@Did not understand value %@", buf, 0x16u);
...
- (BOOL)updateWithSettingValue:(id)a3
{
  ...
  if (![(HMDSetting *)self isValidValue:v4 error:0])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Received value is not valid %@", (uint8_t *)&v17, 0x16u);
    }
    goto LABEL_9;
  }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating setting %@ in transaction from %@ to %@", (uint8_t *)&v17, 0x2Au);
  }
...
- (HMDSetting)initWithModel:(id)a3
{
  ...
  BOOL v11 = [(HMDSetting *)self initWithIdentifier:v6 parentIdentifier:v7 name:v8 properties:v9 type:v10 value:v5 constraints:MEMORY[0x1E4F1CBF0]];
  return v11;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7 != -1) {
    dispatch_once(&logCategory__hmf_once_t7, &__block_literal_global_183);
  }
...
{
  logCategory__hmf_once_id v8 = HMFCreateOSLogHandle();
  ...
  switch([v4 integerValue])
  {
    ...
    default:
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v19 = 2112;
        id v20 = v4;
        _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine type of setting value for model %@ of type %@.", (uint8_t *)&v15, 0x20u);
      }
      id v6 = 0;
      uint64_t v7 = 0;
LABEL_9:
...
LABEL_11:
      v12 = 0;
LABEL_12:
      v13 = objc_msgSend(objc_alloc(MEMORY[0x1E4F2EAB8]), "initWithType:stringValue:numberValue:dataValue:selectionIdentifier:selectionValue:", objc_msgSend(v4, "integerValue"), v12, v11, v5, v7, v6);
