    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        id v35 = v17;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to write hero frame data to %@ error: %@", buf, 0x20u);
      }
      id v18 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      id v35 = v10;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create hero frame directory at URL %@: %@", buf, 0x20u);
    }
    id v18 = 0;
  }
...
- (void)_insertClipSignificantEventBulletin:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v11;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Inserting bulletin with clip significant events: %@ hero frame URL: %@", (uint8_t *)&v13, 0x20u);
  }
...
- (void)removeEventNotificationsForCameraProfile:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing camera clip bulletins for camera profile: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)removeEventNotificationForClipWithUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Removing bulletin for clip with UUID: %@", (uint8_t *)&v12, 0x16u);
  }
  id v10 = [(HMDCameraClipUserNotificationCenter *)v7 bulletinBoard];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v7;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Fetching hero frame URL to post notification for significant event: %@", buf, 0x16u);
    }
...
void __84__HMDCameraClipUserNotificationCenter_postNotificationForBulletin_significantEvent___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, v13, (uint8_t *)&v20, v15);
...
- (id)bulletinForClipSignificantEvent:(id)a3 cameraProfile:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (v43)
    {
      ...
      if (![v12 count])
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v46 = 2112;
          id v47 = v17;
          _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find any significant events for clip with UUID %@", buf, 0x16u);
        }
        uint64_t v18 = [MEMORY[0x1E4F1CAD0] setWithObject:v6];

        uint64_t v12 = (void *)v18;
      }
      id v19 = [v12 allObjects];
      int v20 = [v19 sortedArrayUsingComparator:&__block_literal_global_167571];
      ...
      LOBYTE(v23) = objc_msgSend(v12, "na_allObjectsPassTest:", &__block_literal_global_4_167572);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        id v47 = v9;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Could not create a bulletin for clip significant event because the home is nil for accessory: %@", buf, 0x16u);
      }
      id v28 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      id v47 = v7;
      _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Could not create a bulletin for clip significant event because the accessory is nil for camera profile: %@", buf, 0x16u);
    }
    id v28 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_167584 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_167584, &__block_literal_global_11_167585);
  }
  v2 = (void *)logCategory__hmf_once_v12_167586;
  return v2;
}
...
uint64_t __50__HMDCameraClipUserNotificationCenter_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v12_167586;
  logCategory__hmf_once_v12_167586 = v0;
