...
- (id)_handleRemoveRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        v14 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v10];
        v15 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE8]) initWithValue:0];
        v16 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF8]) initWithValue:0];
        v17 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE0]) initWithIdentifier:v14 accessCode:v12 flags:v15 statusCode:v16];
        [v23 addObject:v17];
      }
  ...
  v18 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF0]) initWithValue:5];
  v19 = (void *)[objc_alloc(MEMORY[0x1E4F5BBD0]) initWithOperationType:v18 accessCodeControlRequest:0 accessCodeControlResponse:v23];
...
- (id)_handleUpdateRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        v14 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v11];
        v15 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE8]) initWithValue:0];
        v16 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF8]) initWithValue:0];
        v17 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE0]) initWithIdentifier:v14 accessCode:v12 flags:v15 statusCode:v16];
        [v23 addObject:v17];
  ...
  v18 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF0]) initWithValue:4];
  v19 = (void *)[objc_alloc(MEMORY[0x1E4F5BBD0]) initWithOperationType:v18 accessCodeControlRequest:0 accessCodeControlResponse:v23];
...
- (id)_handleAddRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        v16 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v14];
        v17 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE8]) initWithValue:0];
        v18 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF8]) initWithValue:0];
        v19 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE0]) initWithIdentifier:v16 accessCode:v9 flags:v17 statusCode:v18];
        [v25 addObject:v19];
      }
  ...
  v20 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF0]) initWithValue:3];
  v21 = (void *)[objc_alloc(MEMORY[0x1E4F5BBD0]) initWithOperationType:v20 accessCodeControlRequest:0 accessCodeControlResponse:v25];
...
- (id)_handleReadRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        v13 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v10];
        v14 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE8]) initWithValue:0];
        v15 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF8]) initWithValue:0];
        v16 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE0]) initWithIdentifier:v13 accessCode:v12 flags:v14 statusCode:v15];
        [v22 addObject:v16];
      }
  ...
  v17 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF0]) initWithValue:2];
  v18 = (void *)[objc_alloc(MEMORY[0x1E4F5BBD0]) initWithOperationType:v17 accessCodeControlRequest:0 accessCodeControlResponse:v22];
...
- (id)_handleListRequest
{
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        v10 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:v9];
        v11 = (void *)[objc_alloc(MEMORY[0x1E4F5BBE8]) initWithValue:0];
        v12 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF8]) initWithValue:0];
        id v13 = objc_alloc(MEMORY[0x1E4F5BBE0]);
  ...
  v17 = (void *)[objc_alloc(MEMORY[0x1E4F5BBF0]) initWithValue:1];
  v18 = (void *)[objc_alloc(MEMORY[0x1E4F5BBD0]) initWithOperationType:v17 accessCodeControlRequest:0 accessCodeControlResponse:v21];
...
- (id)_controlResponseForWriteRequest:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = (void *)MEMORY[0x1E4F5BBD0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = 0;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);
    }
    self = 0;
  }
...
- (id)_controlResponseForReadRequest:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x1E4F5BBC0]) initWithValue:1];
  id v4 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:&unk_1F2DC9B20];
  uint64_t v5 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:&unk_1F2DC9B38];
  uint64_t v6 = (void *)[objc_alloc(MEMORY[0x1E4F5BE68]) initWithValue:&unk_1F2DC9B50];
  uint64_t v7 = (void *)[objc_alloc(MEMORY[0x1E4F5BBC8]) initWithCharacterSet:v3 minimumValueLength:v4 maximumValueLength:v5 maximumAccessCodes:v6];
        ...
        if (!v8)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v50 = 2112;
            v51 = v7;
            _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control response: %@", buf, 0x16u);
          }
        ...
        if (!v10)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v51 = 2112;
            v52 = v9;
            _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control response: %@", buf, 0x16u);
          }
...
LABEL_14:
        ...
        __int16 v20 = v35 = v11;
        v48 = v20;
        uint64_t v21 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v48 forKeys:&v47 count:1];
        [v14 UUIDString];
        id v22 = v34 = v9;
...
- (HMDAccessCodeDemoDataMocker)init
{
  ...
  if (v2)
  {
    ...
    v9[2] = &unk_1F2DC9B08;
    v10[2] = @"2468";
    id v4 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v10 forKeys:v9 count:3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_157943 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_157943, &__block_literal_global_157944);
  }
  v2 = (void *)logCategory__hmf_once_v4_157945;
  return v2;
}
...
uint64_t __42__HMDAccessCodeDemoDataMocker_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v4_157945;
  logCategory__hmf_once_v4_157945 = v0;
