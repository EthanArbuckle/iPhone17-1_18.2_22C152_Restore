...
{
  id v16 = a3;
  if ([v16 conformsToProtocol:&unk_1F2F0B2C8]) {
    v4 = v16;
  }
  else {
    v4 = 0;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      if ([v16 linkType] == 1)
      {
        ...
        v8 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8308);
        self->_accessoryServerInvalidations += [v8 unsignedIntegerValue];

        v9 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8320);
        self->_sentHTTPRequests += [v9 unsignedIntegerValue];

        v10 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8338);
        self->_receivedHTTPResponses += [v10 unsignedIntegerValue];

        v11 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8350);
...
LABEL_10:
      ...
      if ([v16 linkType] == 2)
      {
        p_lock = &self->_lock;
        os_unfair_lock_lock_with_options();
        v14 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8308);
        self->_btleConnections += [v14 unsignedIntegerValue];

        v15 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8320);
        self->_btleDiscoveries += [v15 unsignedIntegerValue];

        v11 = objc_msgSend(v6, "hmf_numberForKey:", &unk_1F2DC8338);
        uint64_t v12 = [v11 unsignedIntegerValue];
