...
+ (id)valueWithType:()Metadata representation:
{
  ...
  if ((unint64_t)(a3 - 1) < 3)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v6;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid constraint value: %@", (uint8_t *)&v19, 0x16u);
    }
    goto LABEL_14;
  }
  if (a3 != 4)
...
LABEL_14:
  ...
  if (v9)
  {
    id v7 = (id)[objc_alloc(MEMORY[0x1E4F2E5E0]) initWithTitle:v8];
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v8;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid constraint value: %@", (uint8_t *)&v19, 0x16u);
    }
    id v7 = 0;
  }
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          id v11 = objc_msgSend(MEMORY[0x1E4F2E5E8], "constraintWithDictonaryRepresentation:", v10, (void)v14);
          if (v11) {
            [v4 addObject:v11];
          }
        }
