...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_98672 != -1) {
    dispatch_once(&hmbProperties_onceToken_98672, &__block_literal_global_98673);
  }
  v2 = (void *)hmbProperties__properties_98674;
  return v2;
}
...
void __57__HMDCameraRecordingReachabilityEventModel_hmbProperties__block_invoke()
{
  ...
  v3 = (void *)hmbProperties__properties_98674;
  hmbProperties__properties_98674 = v2;
}
...
- (id)createEvent
{
  ...
  if (v3)
  {
    id v4 = objc_alloc(MEMORY[0x1E4F2E730]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot create reachability event from model: %@", (uint8_t *)&v14, 0x16u);
    }
    v7 = 0;
  }
