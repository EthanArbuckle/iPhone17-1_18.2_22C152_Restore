  ...
  else
  {
    if ([v4 count])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@We are trying to serialize %lu HMDSiriEndpointEnablementLogEvent objects, which is impossible", (uint8_t *)&v14, 0x16u);
      }
    }
    uint64_t v8 = 0;
  }
...
- (id)logEventsPopulatedForHomeWithUUID:(id)a3 associatedWithDate:(id)a4
{
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        if (v16)
        {
          ...
          v32 = v22;
          long long v21 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v32 count:1];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v30 = 2112;
    id v31 = v6;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@No home found with UUID %@", buf, 0x16u);
  }
  long long v21 = 0;
LABEL_13:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_192344 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_192344, &__block_literal_global_192345);
  }
  v2 = (void *)logCategory__hmf_once_v7_192346;
  return v2;
}
...
uint64_t __55__HMDSiriEndpointEnablementLogEventFactory_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v7_192346;
  logCategory__hmf_once_v7_192346 = v0;
