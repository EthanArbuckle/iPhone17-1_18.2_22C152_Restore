...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BD28] wrappertlv:1 name:@"kSelectedStreamConfigurationWrite__SessionControl"];
  id v4 = [MEMORY[0x1E4F5BD28] wrappertlv:2 name:@"kSelectedStreamConfigurationWrite__SelectedVideoParameters"];
  v5 = [MEMORY[0x1E4F5BD28] wrappertlv:3 name:@"kSelectedStreamConfigurationWrite__SelectedAudioParameters"];
  v39[0] = v3;
  id v6 = [MEMORY[0x1E4F1C978] arrayWithObjects:v39 count:1];
  v38[0] = v4;
  v38[1] = v5;
  id v7 = [MEMORY[0x1E4F1C978] arrayWithObjects:v38 count:2];
