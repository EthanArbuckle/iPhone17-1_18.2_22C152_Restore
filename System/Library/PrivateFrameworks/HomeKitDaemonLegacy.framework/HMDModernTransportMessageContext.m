        ...
        if (v11)
        {
          ...
          do
          {
            for (uint64_t i = 0; i != v12; ++i)
            {
              ...
              v16 = objc_msgSend(MEMORY[0x1E4F28C58], "hmErrorWithCode:", 8, (void)v19);
...
LABEL_8:
  ...
  v25[6] = v19;
  long long v20 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v25 forKeys:v24 count:7];
...
- (void)completeSendingOverTransport:(id)a3 withError:(id)a4
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
    {
      ...
      int v47 = 138543362;
      v48 = v38;
      _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid transport", (uint8_t *)&v47, 0xCu);
    }
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_FAULT))
    {
      ...
      int v47 = 138543362;
      v48 = v44;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transport has not started", (uint8_t *)&v47, 0xCu);
    }
...
LABEL_8:
    ...
    || self->_didSucceedSending)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v49 = 2114;
      v50 = v34;
      _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_INFO, "%{public}@Message %{public}@ no longer needed, clearing message.", (uint8_t *)&v47, 0x16u);
    }
...
- (void)startSendingOverTransport:(id)a3
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      int v30 = 138543362;
      v31 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Invalid transport", (uint8_t *)&v30, 0xCu);
    }
  ...
  if (([(NSMutableSet *)self->_remainingTransports containsObject:v4] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_FAULT))
    {
      ...
      int v30 = 138543362;
      v31 = v27;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transport already started", (uint8_t *)&v30, 0xCu);
    }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v59 = v48;
          _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Transaction ID should not be nil for a request message", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_87264 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_87264, &__block_literal_global_87265);
  }
  id v2 = (void *)logCategory__hmf_once_v7_87266;
  return v2;
}
...
uint64_t __47__HMDModernTransportMessageContext_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v7_87266;
  logCategory__hmf_once_v7_87266 = v0;
