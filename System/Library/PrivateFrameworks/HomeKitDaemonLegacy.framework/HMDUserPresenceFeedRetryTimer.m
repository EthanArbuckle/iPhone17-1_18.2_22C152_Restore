...
- (void)startWithDelegate:(id)a3 delegateQueue:(id)a4 responseTime:(double)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v33 = 2112;
    v34 = v16;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting the timer after response time %@ and retry time interval %@", (uint8_t *)&v29, 0x20u);
  }
  if ([(HMDUserPresenceFeedRetryTimer *)v11 shouldRetryImmediately:a5])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v33 = 2112;
      v34 = v23;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Response time %@ is more than retry timer %@", (uint8_t *)&v29, 0x20u);
    }
  ...
  {
    [(HMDUserPresenceFeedRetryTimer *)v11 retryTimeInterval];
    v26 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:1 options:v25 - a5];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_7075 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_7075, &__block_literal_global_7076);
  }
  unint64_t v2 = (void *)logCategory__hmf_once_v3_7077;
  return v2;
}

uint64_t __44__HMDUserPresenceFeedRetryTimer_logCategory__block_invoke()
{
  logCategory__hmf_once_v3_7077 = HMFCreateOSLogHandle();
