...
- (NSString)description
{
  v2 = NSString;
  v6.receiver = self;
  v6.super_class = (Class)HMDRemoteLoginProxyDeviceRequest;
...
- (NSDictionary)messagePayload
{
  ...
  v3 = encodeRootObject();
  v4 = [(HMDRemoteLoginProxyDeviceRequest *)self messageName];
  v7 = v4;
  v8[0] = v3;
...
- (NSString)messageName
{
  return (NSString *)@"kHMDRemoteLoginProxyDeviceRequest";
}
...
+ (id)objWithMessage:(id)a3
{
  ...
  objc_super v6 = objc_msgSend(v5, "hmf_dataForKey:", @"kHMDRemoteLoginProxyDeviceRequest");
...
+ (id)objWithDict:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "hmf_dataForKey:", @"kHMDRemoteLoginProxyDeviceRequest");
  id v13 = 0;
