...
- (HMDRemoteEventRouterClientRetryIntervals)init
{
  return [(HMDRemoteEventRouterClientRetryIntervals *)self initWithIntervals:&unk_1F2DC6FD0];
}

+ (id)retryIntervalsForResidentClient
{
  v2 = [[HMDRemoteEventRouterClientRetryIntervals alloc] initWithIntervals:&unk_1F2DC6FE8];
  return v2;
}
