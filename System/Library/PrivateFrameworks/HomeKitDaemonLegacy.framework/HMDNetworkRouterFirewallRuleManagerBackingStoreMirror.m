    ...
    && objc_msgSend(*(id *)(a1 + 48), "__shouldFailCloudRecordFetchError:error:", *(void *)(a1 + 56)))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v6;
      _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch records: %@", buf, 0x16u);
    }
    ...
    if (*(void *)(a1 + 64))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v17 = v12;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Previous fetch completed successfully, now fetching more records from cursor", buf, 0xCu);
      }
      uint64_t v13 = (void *)[objc_alloc(MEMORY[0x1E4F1A2B8]) initWithCursor:*(void *)(a1 + 64)];
...
- (void)__fetchRecordsByQuery:(id)a3
{
  ...
  if (v6)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v33 = 2112;
    v34 = v16;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching records from zone %@", buf, 0x16u);
  }
  else
  {
    ...
    *(_DWORD *)buf = 138543362;
    v32 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching all records", buf, 0xCu);
  }
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      v34 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Only fetching specific fields: %@", buf, 0x16u);
    }
  }
  v26 = [MEMORY[0x1E4F28F60] predicateWithValue:1];
  v27 = (void *)[objc_alloc(MEMORY[0x1E4F1A2A0]) initWithRecordType:@"CD_CloudAccessory" predicate:v26];
  v28 = (void *)[objc_alloc(MEMORY[0x1E4F1A2B8]) initWithQuery:v27];
  v29 = [v4 zoneID];
...
- (void)__fetchRecordByID:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v40 = 2112;
    v41 = v14;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching record: %@", buf, 0x16u);
  }
  id v15 = objc_alloc(MEMORY[0x1E4F1A0A8]);
  v16 = [v4 recordID];
  v37 = v16;
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      v41 = v27;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Only fetching specific fields: %@", buf, 0x16u);
    }
    v28 = [v4 desiredKeys];
...
- (BOOL)__shouldFailCloudRecordFetchError:(id)a3 error:(id)a4
{
  ...
  if ([v7 hmbIsCKZoneDeletedError])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v16;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Zone '%@' does not exist", buf, 0x16u);
    }
LABEL_9:
  ...
  if ([v7 hmbIsCloudKitError])
  {
    if ([v7 code] == 11)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v22;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Record '%@' does not exist", buf, 0x16u);
      }
      goto LABEL_9;
    }
    if ([v7 code] == 2)
    {
      v24 = [v7 userInfo];
      v25 = [v24 objectForKeyedSubscript:*MEMORY[0x1E4F19CD8]];
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v7;
    _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch records: %@", buf, 0x16u);
  }
  BOOL v23 = 1;
LABEL_15:
  ...
  if ([v6 hmbIsCloudKitError] && objc_msgSend(v6, "code") == 11)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      v24 = v13;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Record '%@' does not exist", buf, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v6;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch record %@: %@", buf, 0x20u);
    }
...
- (void)__shutdownWithActivity:(id)a3
{
  ...
  {
    id v6 = (void *)MEMORY[0x1D9452090]([v4 markWithFormat:@"Already shutting down"]);
    id v7 = self;
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v38 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Already shutting down", buf, 0xCu);
    }
  ...
  {
    uint64_t v14 = (void *)MEMORY[0x1D9452090]([v4 markWithFormat:@"Shutting down"]);
    uint64_t v15 = self;
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v38 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Shutting down", buf, 0xCu);
    }
    ...
    uint64_t v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    int v20 = [v18 finishWithError:v19];

    if (v20)
    {
      v21 = (void *)MEMORY[0x1D9452090]([v4 markWithFormat:@"Shut down before startup completed"]);
      v22 = v15;
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v38 = v24;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Shut down before startup completed", buf, 0xCu);
      }
    }
...
uint64_t __91__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_Lifecycle____shutdownWithActivity___block_invoke_4(uint64_t a1)
{
  ...
  if (v2)
  {
    id v3 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 40) markWithFormat:@"Failed to shut down cloud database: %@", v2]);
    id v4 = *(id *)(a1 + 48);
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v15 = 2112;
      uint64_t v16 = v7;
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down cloud database: %@", buf, 0x16u);
    }
  }
  id v8 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 40) markWithFormat:@"Shutdown completed"]);
  id v9 = *(id *)(a1 + 48);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v14 = v11;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Shutdown completed", buf, 0xCu);
  }
...
- (void)__startupWithLocalZone:(id)a3 activity:(id)a4
{
  ...
  if ([(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)self isShuttingDown])
  {
    id v9 = (void *)MEMORY[0x1D9452090]([v7 markWithFormat:@"Already shutting down"]);
    id v10 = self;
    id v11 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v20 = 138543362;
      v21 = v12;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Already shutting down", (uint8_t *)&v20, 0xCu);
    }
    id v13 = [(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)v10 startupPromise];
    uint64_t v14 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    [v13 finishWithError:v14];
  }
  else
  {
    __int16 v15 = (void *)MEMORY[0x1D9452090]([v7 markWithFormat:@"Starting up"]);
    uint64_t v16 = self;
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Starting up", (uint8_t *)&v20, 0xCu);
    }
...
- (id)__loadOrCreateInternalStateModelWithLocalZone:(id)a3 activity:(id)a4
{
  ...
  if (v10)
  {
    id v13 = (void *)MEMORY[0x1D9452090]([v7 markWithFormat:@"Loaded existing internal state model"]);
    uint64_t v14 = self;
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v29 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Loaded existing internal state model", buf, 0xCu);
    }
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v21;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Last synchronized recordIDs: %@", buf, 0x16u);
    }
  }
  else
  {
    uint64_t v22 = (void *)MEMORY[0x1D9452090]([v7 markWithFormat:@"Creating new internal state model because existing one was not found: %@", v11]);
    __int16 v23 = self;
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v12;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Creating new internal state model because existing one was not found: %@", buf, 0x16u);
    }
    id v10 = objc_opt_new();
  }
...
- (void)__retryFetchVerificationCertificatesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Will retry the fetch in %lu seconds", buf, 0x16u);
  }
  [v4 retryIntervalSeconds];
...
void __138__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchVerificationCertificates____retryFetchVerificationCertificatesWithFetchInfo___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v9 = 138543362;
      id v10 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Retrying fetch for verification certificates", (uint8_t *)&v9, 0xCu);
    }
        ...
        [v7 shouldRetry]))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Ignoring non-fatal error: %@", buf, 0x16u);
    }
    BOOL v14 = 1;
  }
  else
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v18;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get any usable public keys from record: %@", (uint8_t *)&v26, 0x16u);
      }
      id v19 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
...
LABEL_14:
  ...
  if (![v8 shouldRetry])
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v28 = 2112;
      id v29 = v25;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Fetch returned no verification certificates record: %@", (uint8_t *)&v26, 0x16u);
    }
    double v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      unint64_t v23 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Mirror has been deallocated", buf, 0xCu);
    }
    id v21 = *(id *)(a1 + 32);
    if (!v21)
    {
      id v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    }
...
+ (id)publicKeysFromCertificateRecord:(id)a3
{
  uint64_t v22 = *MEMORY[0x1E4F143B8];
  id v4 = a3;
  id v16 = [MEMORY[0x1E4F1CA48] arrayWithCapacity:1];
  long long v17 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
  long long v20 = 0u;
...
+ (id)__publicKeyFromCertificateRecord:(id)a3 dataKey:(id)a4 assetKey:(id)a5
{
  ...
  v95[0] = v9;
  v95[1] = v10;
  id v13 = [MEMORY[0x1E4F1C978] arrayWithObjects:v95 count:2];
...
LABEL_5:
        ...
        while (1)
        {
          ...
          CFDataRef v25 = (const __CFData *)[objc_alloc(MEMORY[0x1E4F1C9B8]) initWithBase64EncodedString:*(void *)(*((void *)&v86 + 1) + 8 * v24) options:0];
          if (!v25) {
            break;
          }
          CFDataRef v26 = v25;
          ...
          if (!v27)
          {
            ...
            if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
            {
              ...
              *(void *)&trust[4] = v59;
              __int16 v93 = 2112;
              *(void *)v94 = v84;
              _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_ERROR, "%{public}@Failed to create certificate from data using keys: %@", trust, 0x16u);
            }
LABEL_31:
            uint64_t v42 = v82;
            id v11 = v83;
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&v94[8] = 2112;
          long long v17 = v81;
          *(void *)&v94[10] = v81;
          _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_ERROR, "%{public}@Invalid certificate data in record using keys: %@: %@", trust, 0x20u);
...
LABEL_12:
        ...
        *(void *)trust = 0;
        ...
        if (!*(void *)trust || v30)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&v94[4] = 2112;
            *(void *)&v94[6] = v84;
            _os_log_impl(&dword_1D49D5000, v66, OS_LOG_TYPE_ERROR, "%{public}@Failed to create trust (result %i) from certificate using keys: %@", trust, 0x1Cu);
          }
          __int16 v40 = 0;
          uint64_t v42 = v82;
          id v11 = v83;
          ...
          *(void *)trust = 0;
          ...
          if (!v33 || v34)
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&v94[8] = 2112;
              *(void *)&v94[10] = v77;
              _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Certificate did not pass trust evaluation with keys: %@, error: %@", trust, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(void *)&trust[4] = v38;
              __int16 v93 = 2112;
              *(void *)v94 = v84;
              _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Trusted certificate found in record using keys: %@", trust, 0x16u);

              id v11 = v83;
            }

            uint64_t v39 = (void *)MEMORY[0x1D9451170](v32);
            __int16 v40 = v39;
            if (v39)
            {
              id v41 = v39;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
              {
                ...
                *(void *)&trust[4] = v73;
                __int16 v93 = 2112;
                *(void *)v94 = v84;
                _os_log_impl(&dword_1D49D5000, v71, OS_LOG_TYPE_ERROR, "%{public}@Failed to get public key from trust in record using keys: %@", trust, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&trust[4] = v63;
          _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to create security policy to verify certificates", trust, 0xCu);
        }
        id v20 = 0;
        __int16 v40 = 0;
        uint64_t v42 = v82;
...
LABEL_49:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v94[8] = 2112;
        *(void *)&v94[10] = v17;
        _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_ERROR, "%{public}@No certificates found on record using keys: %@: %@", trust, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v94[8] = 2112;
      *(void *)&v94[10] = v44;
      _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to read data from certificate record using keys: %@: %@", trust, 0x20u);
...
+ (id)__recordKeyCertificatePrefix:(id)a3
{
  ...
  if (__recordKeyCertificatePrefix__onceToken != -1) {
    dispatch_once(&__recordKeyCertificatePrefix__onceToken, &__block_literal_global_23_51183);
  }
...
{
  uint64_t v0 = [MEMORY[0x1E4F28FD8] regularExpressionWithPattern:@"^(CD_certificate(?:\\d+|))(?:$|_ckAsset$)" options:0 error:0];
  uint64_t v1 = __recordKeyCertificatePrefix__prefixRegex;
...
+ (id)__certificatesRecordID
{
  if (__certificatesRecordID_onceToken != -1) {
    dispatch_once(&__certificatesRecordID_onceToken, &__block_literal_global_51188);
  }
...
void __110__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchVerificationCertificates____certificatesRecordID__block_invoke()
{
  ...
  id v3 = (id)[v0 initWithZoneName:@"certificates" ownerName:*MEMORY[0x1E4F19C08]];
  uint64_t v1 = [objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:@"certificates" zoneID:v3];
  uint64_t v2 = (void *)__certificatesRecordID_certificatesRecordID;
...
- (BOOL)__removeOverridesForZoneName:(id)a3 recordName:(id)a4 options:(id)a5 activity:(id)a6 error:(id *)a7
{
  ...
  if (v12 && v13)
  {
    ...
    long long v18 = (void *)[v17 initWithZoneName:v12 ownerName:*MEMORY[0x1E4F19C08]];
    long long v19 = (void *)[objc_alloc(MEMORY[0x1E4F1A2F8]) initWithRecordName:v13 zoneID:v18];
...
- (BOOL)__removeOverridesForZoneName:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  id v14 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Removing overrides for zone '%@'", v10]);
  id v15 = self;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v108 = 2112;
    v109 = v10;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Removing overrides for zone '%@'", buf, 0x16u);
  }
  ...
  if (!v20)
  {
    id v43 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Failed to fetch override models: %@", v21]);
    id v44 = v15;
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v108 = 2112;
      v109 = v21;
      _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch override models: %@", buf, 0x16u);
    }
    char v47 = 0;
    if (a6) {
      *a6 = v21;
  ...
  while (2)
  {
    for (uint64_t i = 0; i != v93; ++i)
    {
      ...
      if (!v29)
      {
        v48 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Failed to fetch externalID for modelID %@: %@", v27, v30]);
        v49 = v96;
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v110 = 2112;
          v111 = v30;
          _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch externalID for modelID %@: %@", buf, 0x20u);
        }
        BOOL v21 = v87;
        goto LABEL_40;
      }
      v99 = v30;
      OSStatus v31 = [MEMORY[0x1E4F1A2F8] recordIDFromExternalID:v29 error:&v99];
      id v32 = v99;

      if (!v31)
      {
        v52 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Failed to convert externalID (%@) to CKRecordID for modelID %@: %@", v29, v27, v32]);
        v53 = v96;
        v54 = v96;
        ...
        if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v112 = 2112;
          id v113 = v32;
          _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert externalID (%@) to CKRecordID for modelID %@: %@", buf, 0x2Au);
        }
        OSStatus v31 = 0;
LABEL_39:
...
LABEL_40:
      ...
      if (v35)
      {
        ...
        char v37 = (void *)MEMORY[0x1D9452090]();
        uint64_t v38 = v96;
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v108 = 2112;
          v109 = v41;
          _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Removing override for %@", buf, 0x16u);
        ...
        if ((v42 & 1) == 0)
        {
          ...
          uint64_t v95 = MEMORY[0x1D9452090]();
          id v58 = v38;
          id v55 = HMFGetOSLogHandle();
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v110 = 2112;
            v111 = (char *)v25;
            _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove model %@: %@", buf, 0x20u);
          }
          id v32 = v25;
          id v12 = v89;
          BOOL v21 = v87;
...
LABEL_41:
  ...
  if (!v25 && v92)
  {
    id v61 = (void *)MEMORY[0x1D9452090](objc_msgSend(v12, "markWithFormat:", @"Committing removal of %lu overrides", v92));
    v62 = v96;
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v108 = 2048;
      v109 = v92;
      _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_DEFAULT, "%{public}@Committing removal of %lu overrides", buf, 0x16u);
    ...
    if (v47)
    {
      v68 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Committed removal of overrides successfully"]);
      v69 = v62;
      ...
      if (os_log_type_enabled(v70, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v107 = v72;
        _os_log_impl(&dword_1D49D5000, v70, OS_LOG_TYPE_INFO, "%{public}@Committed removal of overrides successfully", buf, 0xCu);
    ...
    {
      v78 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Failed to commit: %@", v66]);
      v79 = v62;
      ...
      if (os_log_type_enabled(v80, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v108 = 2112;
        v109 = v67;
        _os_log_impl(&dword_1D49D5000, v80, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
...
LABEL_50:
    ...
    if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v107 = v77;
      _os_log_impl(&dword_1D49D5000, v75, OS_LOG_TYPE_INFO, "%{public}@No matching models found, aborting", buf, 0xCu);
...
- (BOOL)__removeOverridesForRecordIDs:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  id v14 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Removing overrides for recordIDs: %@", v10]);
  id v15 = self;
  id v16 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v69 = 2112;
    id v70 = v10;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Removing overrides for recordIDs: %@", buf, 0x16u);
  }
      ...
      while (2)
      {
        ...
        do
        {
          ...
          if ((v29 & 1) == 0)
          {
            ...
            OSStatus v31 = (void *)MEMORY[0x1D9452090]();
            id v15 = v57;
            id v32 = v57;
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v71 = 2112;
              id v72 = v23;
              _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove model %@: %@", buf, 0x20u);
            }
...
LABEL_32:
    ...
    char v37 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Committing removal of overrides"]);
    uint64_t v38 = v15;
    uint64_t v39 = HMFGetOSLogHandle();
    id v11 = v59;
    if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v41;
      _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Committing removal of overrides", buf, 0xCu);
    ...
    if (v36)
    {
      id v44 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Committed removal of overrides successfully"]);
      v45 = v38;
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v68 = v48;
        _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Committed removal of overrides successfully", buf, 0xCu);
    ...
    {
      v49 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Failed to commit: %@", v42]);
      v50 = v38;
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v69 = 2112;
        id v70 = v43;
        _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
...
- (BOOL)__removeAllOverridesWithOptions:(id)a3 activity:(id)a4 error:(id *)a5
{
  ...
  id v11 = (void *)MEMORY[0x1D9452090]([v9 markWithFormat:@"Removing all overrides"]);
  id v12 = self;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v32 = v14;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Removing all overrides", buf, 0xCu);
  }
  ...
  if (v19)
  {
    uint64_t v21 = (void *)MEMORY[0x1D9452090]([v9 markWithFormat:@"Failed to remove all previous overrides: %@", v19]);
    uint64_t v22 = v12;
    id v23 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      id v34 = v20;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove all previous overrides: %@", buf, 0x16u);
    }
    if (a5) {
      *a5 = v20;
    }
  ...
  {
    uint64_t v25 = (void *)MEMORY[0x1D9452090]([v9 markWithFormat:@"Successfully removed all previous overrides"]);
    CFDataRef v26 = v12;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v32 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@Successfully removed all previous overrides", buf, 0xCu);
    }
  }
...
- (BOOL)__addOverrides:(id)a3 replace:(BOOL)a4 options:(id)a5 activity:(id)a6 error:(id *)a7
{
  ...
  if (v17)
  {
    ...
    id v47 = __Block_byref_object_copy__94059;
    v48 = __Block_byref_object_dispose__94060;
    id v49 = 0;
    ...
    {
      context = (void *)MEMORY[0x1D9452090]([v18 markWithFormat:@"Committing overrides"]);
      uint64_t v21 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v51 = v23;
        _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Committing overrides", buf, 0xCu);
      }
      id v37 = 0;
      ...
      if (v20)
      {
        CFDataRef v26 = (void *)MEMORY[0x1D9452090]([v18 markWithFormat:@"Committed overrides successfully"]);
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v51 = v29;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Committed overrides successfully", buf, 0xCu);
        }
      }
      else
      {
        contexta = (void *)MEMORY[0x1D9452090]([v18 markWithFormat:@"Failed to commit: %@", v24]);
        id v30 = v21;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v52 = 2112;
          v53 = v25;
          _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
        }
        if (a7) {
          *a7 = v25;
        }
...
void __112__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_Records____addOverrides_replace_options_activity_error___block_invoke(uint64_t a1, void *a2, void *a3, unsigned char *a4)
{
      ...
      if ((v17 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v44 = 2112;
          id v45 = v32;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to update model for %@: %@", buf, 0x20u);
  ...
  {
    CFDataRef v26 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Failed to determine externalID: %@", v11]);
    id v27 = *(id *)(a1 + 40);
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalID: %@", buf, 0x16u);
...
- (id)__fetchOverridesForZoneName:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (v10)
  {
    uint64_t v14 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Fetching overrides for zone '%@'", v10]);
    id v15 = self;
    id v16 = HMFGetOSLogHandle();
    if (!os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT)) {
      goto LABEL_7;
  ...
  {
    uint64_t v14 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Fetching all overrides"]);
    uint64_t v21 = self;
    id v16 = HMFGetOSLogHandle();
    if (!os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT)) {
      goto LABEL_7;
...
LABEL_7:
  ...
  if (v24)
  {
      ...
      if (v26)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v28; ++i)
          {
            ...
            {
              id v67 = v34;
              int v35 = [MEMORY[0x1E4F1A2F8] recordIDFromExternalID:v33 error:&v67];
              id v36 = v67;
              ...
              {
                v48 = (void *)MEMORY[0x1D9452090]([v63 markWithFormat:@"Failed to convert externalID (%@) to CKRecordID for modelID %@: %@", v33, v31, v36]);
                id v49 = v27;
                v50 = HMFGetOSLogHandle();
                if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138544130;
                  ...
                  __int16 v80 = 2112;
                  id v81 = v36;
                  _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert externalID (%@) to CKRecordID for modelID %@: %@", buf, 0x2Au);
                }
              }
            ...
            {
              __int16 v44 = (void *)MEMORY[0x1D9452090]([v63 markWithFormat:@"Failed to fetch externalID for modelID %@: %@", v31, v34]);
              id v45 = v27;
              ...
              if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v78 = 2112;
                id v79 = v34;
                _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch externalID for modelID %@: %@", buf, 0x20u);
              }
              id v36 = v34;
            }
          }
    ...
    {
      __int16 v52 = (void *)MEMORY[0x1E4F1CC08];
    }
  }
  else
  {
    v53 = (void *)MEMORY[0x1D9452090]([v12 markWithFormat:@"Failed to fetch override models: %@", v25]);
    uint64_t v54 = self;
    id v55 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v76 = 2112;
      id v77 = v25;
      _os_log_impl(&dword_1D49D5000, v55, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch override models: %@", buf, 0x16u);
    }
    __int16 v52 = 0;
    if (a6) {
      *a6 = v25;
...
- (id)__fetchOverridesForRecordIDs:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  id v38 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v9, "count"));
  long long v45 = 0u;
  long long v46 = 0u;
  long long v47 = 0u;
  long long v48 = 0u;
    ...
    do
    {
      for (uint64_t i = 0; i != v42; ++i)
      {
        ...
        if (v16)
        {
          ...
          uint32_t v20 = (void *)MEMORY[0x1D9452090]();
          uint64_t v21 = self;
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v53 = 2112;
            uint64_t v54 = v24;
            _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Model %@ (%@) found in override zone", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v55 = 2112;
            id v56 = v17;
            _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_DEBUG, "%{public}@No model %@ (%@) found in override zone: %@", buf, 0x2Au);
...
- (BOOL)__removeAllLocalRulesWithOptions:(id)a3 activity:(id)a4 error:(id *)a5
{
  ...
  if ([v11 count])
  {
    id v12 = (void *)MEMORY[0x1D9452090]([v8 markWithFormat:@"Removing cloud zones: %@", v11]);
    uint64_t v13 = self;
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      char v29 = v11;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Removing cloud zones: %@", buf, 0x16u);
    }
  ...
  uint64_t v18 = (void *)MEMORY[0x1D9452090]([v8 markWithFormat:@"Resetting database change token"]);
  id v19 = self;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v27 = v21;
    _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Resetting database change token", buf, 0xCu);
  }
...
- (id)__fetchAllDataForZoneName:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (v46)
  {
    ...
    id v11 = (void *)[v10 initWithZoneName:v46 ownerName:*MEMORY[0x1E4F19C08]];
    id v12 = [MEMORY[0x1E4F1CAD0] setWithObject:v11];

LABEL_12:
    id v25 = (void *)MEMORY[0x1D9452090]([v51 markWithFormat:@"Fetching models from zones: %@", v12]);
    v50 = self;
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v63 = 2112;
      long long v64 = v12;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching models from zones: %@", buf, 0x16u);
    }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v65 = 2112;
              id v66 = v33;
              _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch models for zone %@: %@", buf, 0x20u);
            }
          }
        }
        uint64_t v28 = [obj countByEnumeratingWithState:&v53 objects:v67 count:16];
  ...
  uint64_t v14 = (os_unfair_lock_s *)&v13[*MEMORY[0x1E4F69F18]];
  ...
  if ([v17 count])
  {
    uint64_t v18 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v17, "count"));
    long long v59 = 0u;
    long long v60 = 0u;
    long long v57 = 0u;
    long long v58 = 0u;
  ...
  id obj = v17;
  uint64_t v42 = (void *)MEMORY[0x1D9452090]([v51 markWithFormat:@"No local zones exist"]);
  id v43 = self;
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v62 = v45;
    _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_DEBUG, "%{public}@No local zones exist", buf, 0xCu);
  }
  uint64_t v40 = (void *)MEMORY[0x1E4F1CC08];
LABEL_27:
...
- (id)__fetchAllDataForZoneID:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v134 = 2112;
    v135 = v19;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching all models for zone %@", buf, 0x16u);
    ...
    if (v23)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v136 = 2112;
        id v137 = v27;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Found models in local zone for %@: %@", buf, 0x20u);

        id v15 = v31;
      }

      v114 = v29;
      id v34 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v27, "count"));
      long long v126 = 0u;
      long long v127 = 0u;
      long long v128 = 0u;
      long long v129 = 0u;
        ...
        while (2)
        {
          ...
          do
          {
            ...
            if (!v40)
            {
              ...
              id v81 = (void *)MEMORY[0x1D9452090]();
              id v82 = v37;
              ...
              if (os_log_type_enabled(v83, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                __int16 v138 = 2112;
                id v139 = v41;
                _os_log_impl(&dword_1D49D5000, v83, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch external id for model %@ in %@: %@", buf, 0x2Au);
              }
              id v35 = v41;
              id v10 = v110;
              uint64_t v21 = v117;
            ...
            id v124 = v41;
            uint64_t v42 = [MEMORY[0x1E4F1A2F8] recordIDFromExternalID:v40 error:&v124];
            id v35 = v124;
            ...
            if (!v42)
            {
              ...
              if (os_log_type_enabled(v92, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                __int16 v138 = 2112;
                id v139 = v89;
                _os_log_impl(&dword_1D49D5000, v92, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert external id for model %@ in %@: %@", buf, 0x2Au);
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v134 = 2112;
              v135 = v50;
              _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_DEBUG, "%{public}@Fetched model for %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v136 = 2112;
        id v137 = v70;
        _os_log_impl(&dword_1D49D5000, v69, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch models from local zone for %@: %@", buf, 0x20u);
    ...
    if (v99)
    {
      ...
      if (os_log_type_enabled(v104, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v136 = 2112;
        id v137 = v99;
        _os_log_impl(&dword_1D49D5000, v104, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down local zone for %@: %@", buf, 0x20u);
      }
      id v35 = v100;
      if (!v100) {
        id v35 = v99;
  ...
  if (v56)
  {
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v134 = 2112;
      v135 = v64;
      _os_log_impl(&dword_1D49D5000, v61, OS_LOG_TYPE_DEBUG, "%{public}@Local zone does not exist for %@", buf, 0x16u);

      uint64_t v20 = v62;
    }

    __int16 v65 = (void *)MEMORY[0x1E4F1CC08];
  }
  else
  {
    ...
    if (os_log_type_enabled(v75, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v136 = 2112;
      id v137 = v22;
      _os_log_impl(&dword_1D49D5000, v75, OS_LOG_TYPE_ERROR, "%{public}@Failed to open local zone for %@: %@", buf, 0x20u);
...
- (id)__fetchAllDataForRecordIDs:(id)a3 options:(id)a4 activity:(id)a5 error:(id *)a6
{
  ...
  if (v56)
  {
    ...
    long long v58 = objc_msgSend(MEMORY[0x1E4F1CA60], "dictionaryWithCapacity:", objc_msgSend(v10, "count"));
    long long v66 = 0u;
    long long v67 = 0u;
    long long v68 = 0u;
    long long v69 = 0u;
            ...
            if (v20)
            {
              ...
              if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v74 = 2112;
                v75 = v29;
                _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Model %@ found for record %@", buf, 0x20u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v43, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                __int16 v76 = 2112;
                id v77 = v64;
                _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_DEBUG, "%{public}@No model %@ for record %@ found: %@", buf, 0x2Au);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v74 = 2112;
              v75 = v40;
              _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_DEBUG, "%{public}@No local zone for model %@ for record %@ found", buf, 0x20u);
            }
            self = v62;
          }
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v71 = v52;
      _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_INFO, "%{public}@localZones is nil, can't fetch paired metadata", buf, 0xCu);
    }
    long long v47 = 0;
    id v48 = 0;
  }
        ...
        if (v21)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v59 = 2112;
            uint64_t v60 = v28;
            _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Opened local zone for %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (!v30)
          {
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v61 = 2112;
              id v62 = v22;
              _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to open local zone for %@: %@", buf, 0x20u);
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v59 = 2112;
            uint64_t v60 = v37;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_DEBUG, "%{public}@No local zone for %@, skipping", buf, 0x16u);
...
- (void)__shutdownLocalZones:(id)a3 activity:(id)a4
{
  ...
  if ([v6 count])
  {
    ...
    id v17 = [MEMORY[0x1E4F7A0F0] globalAsyncScheduler];
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v18;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down local zone %@", buf, 0x16u);
    }
  }
}
...
- (id)__openLocalZoneForCloudZoneID:(id)a3 error:(id *)a4
{
  ...
  id v9 = objc_alloc_init(MEMORY[0x1E4F69E70]);
...
- (id)__createCloudZoneIDForZoneID:(id)a3
{
  id v4 = (objc_class *)MEMORY[0x1E4F69E58];
  id v5 = a3;
  id v6 = [v4 alloc];
...
+ (id)__overrideParentModelID
{
  if (__overrideParentModelID_onceToken != -1) {
    dispatch_once(&__overrideParentModelID_onceToken, &__block_literal_global_94181);
  }
...
{
  uint64_t v0 = [objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:@"56e3068a-cb39-4cef-b4a3-78d7cc58e7d5"];
  uint64_t v1 = __overrideParentModelID_overrideParentModelID;
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      uint64_t v60 = v17;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Database change token has not been updated: %@", buf, 0x16u);
    }
  }
  else
  {
    ...
    if (!v18)
    {
      ...
      if (os_log_type_enabled(v52, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v58 = v53;
        _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Should never have a nil change token here", buf, 0xCu);
      }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      uint64_t v60 = v27;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Updating database change token: %@", buf, 0x16u);
    }
    id v28 = [(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)v23 cloudDatabase];
    uint64_t v29 = (os_unfair_lock_s *)&v28[*MEMORY[0x1E4F69F18]];
    os_unfair_lock_lock_with_options();
    ...
    long long v56 = v31;
    id v35 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v56 count:1];
    ...
    if (v36)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v59 = 2112;
        uint64_t v60 = v36;
        _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to update database state model: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v58 = v44;
        _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_INFO, "%{public}@Updated database change token successfully", buf, 0xCu);
      }
    }
  }
...
void __111__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_RemoveDeletedZones____removeDeletedZonesWithFetchInfo___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v5 = objc_alloc(MEMORY[0x1E4F69E58]);
...
- (void)__saveInternalStateWithActivity:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v30 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have internal state", buf, 0xCu);
    }
  ...
  id v7 = (void *)MEMORY[0x1D9452090]([v4 markWithFormat:@"Saving internal state model"]);
  id v8 = self;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v30 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Saving internal state model", buf, 0xCu);
  }
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v33 = 2112;
      id v34 = v14;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to save internal state model %@: %@", buf, 0x20u);
    }
  }
}
...
- (BOOL)_removeOverridesForZoneName:(id)a3 recordName:(id)a4 options:(id)a5 error:(id *)a6
{
  ...
  __int16 v31 = __Block_byref_object_copy__133274;
  id v32 = __Block_byref_object_dispose__133275;
  id v33 = 0;
  uint64_t v14 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"RemoveOverrides"];
...
- (BOOL)removeOverridesForRecordIDs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  long long v26 = __Block_byref_object_copy__133274;
  long long v27 = __Block_byref_object_dispose__133275;
  id v28 = 0;
  id v11 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"RemoveOverridesForRecordIDs"];
  v17[0] = MEMORY[0x1E4F143A8];
  v17[1] = 3221225472;
...
uint64_t __99__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_removeOverridesForRecordIDs_options_error___block_invoke(uint64_t a1)
{
  ...
  {
    uint64_t v8 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (BOOL)addOverrides:(id)a3 replace:(BOOL)a4 options:(id)a5 error:(id *)a6
{
  ...
  uint64_t v30 = __Block_byref_object_copy__133274;
  uint64_t v31 = __Block_byref_object_dispose__133275;
  id v32 = 0;
  id v13 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"AddOverrides"];
...
uint64_t __92__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_addOverrides_replace_options_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    BOOL v26 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Applying overrides for recordIDs: %@", buf, 0x16u);
  }
  ...
  {
    uint64_t v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (id)_fetchOverridesForZoneName:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v35 = __Block_byref_object_copy__133274;
  char v36 = __Block_byref_object_dispose__133275;
  id v37 = 0;
  uint64_t v26 = 0;
  uint64_t v27 = &v26;
  uint64_t v28 = 0x3032000000;
  uint64_t v29 = __Block_byref_object_copy__133274;
  uint64_t v30 = __Block_byref_object_dispose__133275;
  id v31 = 0;
...
- (id)fetchOverridesForRecordIDs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  uint64_t v42 = __Block_byref_object_copy__133274;
  id v43 = __Block_byref_object_dispose__133275;
  id v44 = 0;
  uint64_t v33 = 0;
  uint64_t v34 = &v33;
  uint64_t v35 = 0x3032000000;
  char v36 = __Block_byref_object_copy__133274;
  id v37 = __Block_byref_object_dispose__133275;
  id v38 = 0;
  id v11 = objc_alloc(MEMORY[0x1E4F653F0]);
  id v12 = [v9 label];
  uint64_t v13 = (void *)[v11 initWithName:v12];
  ...
  else
  {
    ...
    id v20 = (void *)MEMORY[0x1D9452090](v17);
    id v21 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v47 = 2112;
      uint64_t v48 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@No overrides fetched with error %@", buf, 0x16u);
    }
  }
...
uint64_t __98__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchOverridesForRecordIDs_options_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching overrides for recordIDs: %@", buf, 0x16u);
  }
  if ([*(id *)(a1 + 48) isRunning])
  {
    id v9 = *(void **)(a1 + 48);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v26 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@No local zone, can't fetch overrides", buf, 0xCu);
    }
    uint64_t v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (BOOL)removeAllLocalRulesWithOptions:(id)a3 error:(id *)a4
{
  ...
  uint64_t v24 = __Block_byref_object_copy__133274;
  __int16 v25 = __Block_byref_object_dispose__133275;
  id v26 = 0;
...
{
  uint64_t v20 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Removing all local rules"]);
  id v3 = *(id *)(a1 + 40);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v19 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Removing all local rules", buf, 0xCu);
  }
  ...
  {
    uint64_t v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (id)_fetchAllDataForZoneName:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  id v28 = &v27;
  uint64_t v29 = 0x3032000000;
  char v30 = __Block_byref_object_copy__133274;
  id v31 = __Block_byref_object_dispose__133275;
  id v32 = 0;
  id v11 = objc_alloc(MEMORY[0x1E4F653F0]);
  id v12 = [v9 label];
  uint64_t v13 = (void *)[v11 initWithName:v12];
...
{
  uint64_t v23 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Fetching records with zone name '%@'", *(void *)(a1 + 40)]);
  id v3 = *(id *)(a1 + 48);
  uint64_t v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching records with zone name '%@'", buf, 0x16u);
  }
  if ([*(id *)(a1 + 48) isRunning])
  {
    uint64_t v7 = *(void **)(a1 + 48);
  ...
  {
    uint64_t v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    uint64_t v16 = *(void *)(*(void *)(a1 + 72) + 8);
    id v14 = *(void **)(v16 + 40);
    *(void *)(v16 + 40) = v15;
  }
...
- (id)fetchAllDataForRecordIDs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  else
  {
    ...
    uint64_t v20 = (void *)MEMORY[0x1D9452090](v17);
    __int16 v21 = self;
    HMFGetOSLogHandle();
    uint64_t v22 = (id)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v47 = 2112;
      uint64_t v48 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Failed to fetch paired metadata dictionary with error %@", buf, 0x16u);
    }
  }
...
uint64_t __96__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchAllDataForRecordIDs_options_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching records for recordIDs: %@", buf, 0x16u);
  }
  if ([*(id *)(a1 + 48) isRunning])
  {
    id v9 = *(void **)(a1 + 48);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v26 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Failed to fetch paired metadata dictionary due to nil local zone", buf, 0xCu);
    }
    uint64_t v21 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    uint64_t v22 = *(void *)(*(void *)(a1 + 72) + 8);
    id v16 = *(void **)(v22 + 40);
...
- (void)fetchCloudRecordIDsForZoneID:(id)a3 options:(id)a4 completion:(id)a5
{
  ...
  id v14 = v8;
  id v12 = v8;
  [(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)self _fetchCloudRecordsForZoneID:v10 recordID:0 options:v9 desiredKeys:MEMORY[0x1E4F1CBF0] completion:v13];
}
...
void __105__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchCloudRecordIDsForZoneID_options_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    id v5 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v3, "count"));
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
...
{
  uint64_t v24 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([a1[4] markWithFormat:@"Scheduling cloud fetch"]);
  id v3 = a1[5];
  uint64_t v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v23 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling cloud fetch", buf, 0xCu);
  }
  id v6 = a1[4];
  id v7 = a1[5];
...
uint64_t __125__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror__fetchCloudRecordsForZoneID_recordID_options_desiredKeys_completion___block_invoke_5(uint64_t a1)
{
  ...
  if (v3)
  {
    uint64_t v4 = (void *)MEMORY[0x1D9452090]([v2 markWithFormat:@"Cloud fetch completed successfully"]);
    id v5 = *(id *)(a1 + 48);
    id v6 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v12 = v7;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Cloud fetch completed successfully", buf, 0xCu);
    }
  }
  else
  {
    uint64_t v4 = (void *)MEMORY[0x1D9452090]([v2 markWithFormat:@"Cloud fetch completed unsuccessfully: %@", *(void *)(a1 + 56)]);
    id v5 = *(id *)(a1 + 48);
    id v6 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v13 = 2112;
      uint64_t v14 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_ERROR, "%{public}@Cloud fetch completed unsuccessfully: %@", buf, 0x16u);
    }
  }
...
{
  uint64_t v24 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Scheduling cloud sync"]);
  id v3 = *(id *)(a1 + 40);
  uint64_t v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v23 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling cloud sync", buf, 0xCu);
  }
  id v6 = *(void **)(a1 + 32);
  id v7 = *(void **)(a1 + 40);
  v16[0] = MEMORY[0x1E4F143A8];
...
void __148__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchCloudChangesForRecordIDs_options_ignoreLastSynchronizedRecords_xpcActivity_completion___block_invoke_184(uint64_t a1, void *a2, void *a3)
{
  ...
  id v5 = a2;
  id v47 = a3;
  id v6 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Beginning cloud sync"]);
  id v7 = v5;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v49 = v9;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Beginning cloud sync", buf, 0xCu);
  }
  if ([*(id *)(a1 + 40) count])
  {
    if (*(unsigned char *)(a1 + 64))
    {
      uint64_t v10 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Ignoring last fetched accessories"]);
      id v11 = v7;
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v49 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring last fetched accessories", buf, 0xCu);
      }
LABEL_15:
      id v27 = [v7 cloudDatabase];
      id v28 = (os_unfair_lock_s *)&v27[*MEMORY[0x1E4F69F18]];
      os_unfair_lock_lock_with_options();
    ...
    if (v21)
    {
      id v23 = (void *)MEMORY[0x1D9452090]([v22 markWithFormat:@"Set of interested accessories has grown since last fetch: %@", v18]);
      id v24 = v7;
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v50 = 2112;
        id v51 = v18;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_INFO, "%{public}@Set of interested accessories has grown since last fetch: %@", buf, 0x16u);
      }

      goto LABEL_15;
    }
    uint64_t v41 = (void *)MEMORY[0x1D9452090]([v22 markWithFormat:@"Set of interested accessories has not grown, skipping fetch"]);
    id v42 = v7;
    id v43 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v49 = v44;
      _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Set of interested accessories has not grown, skipping fetch", buf, 0xCu);
    }
    [v47 finishWithNoResult];
  }
  else
  {
    uint64_t v14 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Not interested in any records, skipping fetch"]);
    id v15 = v7;
    id v16 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v49 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Not interested in any records, skipping fetch", buf, 0xCu);
    }
    [v47 finishWithNoResult];
  }
LABEL_16:
...
void __148__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_fetchCloudChangesForRecordIDs_options_ignoreLastSynchronizedRecords_xpcActivity_completion___block_invoke_4(uint64_t a1)
{
  ...
  if (v2)
  {
    id v7 = (void *)MEMORY[0x1D9452090]([v6 markWithFormat:@"Cloud sync completed successfully: %@", v5]);
    id v8 = *(id *)(a1 + 48);
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Cloud sync completed successfully: %@", buf, 0x16u);
    }
  }
  else
  {
    id v7 = (void *)MEMORY[0x1D9452090]([v6 markWithFormat:@"Cloud sync completed unsuccessfully: %@", *(void *)(a1 + 56)]);
    id v8 = *(id *)(a1 + 48);
    uint64_t v9 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v15 = 2112;
      id v16 = v12;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Cloud sync completed unsuccessfully: %@", buf, 0x16u);
    }
  }
...
- (id)shutdown
{
  ...
  id v14 = __Block_byref_object_copy__133274;
  __int16 v15 = __Block_byref_object_dispose__133275;
  id v16 = 0;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"Shutdown"];
...
{
  uint64_t v15 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Scheduling shutdown"]);
  id v3 = *(id *)(a1 + 40);
  id v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v14 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling shutdown", buf, 0xCu);
  }
  id v6 = *(void **)(a1 + 32);
  id v7 = *(void **)(a1 + 40);
  v11[0] = MEMORY[0x1E4F143A8];
...
- (id)flush
{
  ...
  uint64_t v13 = 0x3032000000;
  id v14 = __Block_byref_object_copy__133274;
  uint64_t v15 = __Block_byref_object_dispose__133275;
  id v16 = 0;
  id v3 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"Flush"];
  v7[0] = MEMORY[0x1E4F143A8];
  v7[1] = 3221225472;
...
{
  uint64_t v15 = *MEMORY[0x1E4F143B8];
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Scheduling flush"]);
  id v3 = *(id *)(a1 + 40);
  id v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v14 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling flush", buf, 0xCu);
  }
  id v6 = *(void **)(a1 + 32);
  id v7 = *(void **)(a1 + 40);
  v11[0] = MEMORY[0x1E4F143A8];
...
void __62__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_flush__block_invoke_168(uint64_t a1, void *a2, void *a3)
{
  ...
  id v5 = a2;
  id v6 = a3;
  id v7 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Flushed"]);
  id v8 = v5;
  uint64_t v9 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v11 = 138543362;
    id v12 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Flushed", (uint8_t *)&v11, 0xCu);
  }
...
- (id)triggerOutputForOutputRow:(unint64_t)a3 options:(id)a4
{
  ...
  id v5 = objc_msgSend(MEMORY[0x1E4F28C58], "hmErrorWithCode:", 58, a4);
...
- (id)destroy
{
  ...
  id v3 = [MEMORY[0x1E4F28C58] hmErrorWithCode:58];
...
{
  id v4 = a3;
  id v5 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"Startup"];
  v8[0] = MEMORY[0x1E4F143A8];
  v8[1] = 3221225472;
...
void __78__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_startUpWithLocalZone___block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 32) markWithFormat:@"Scheduling startup"]);
  id v3 = *(id *)(a1 + 40);
  id v4 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v15 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Scheduling startup", buf, 0xCu);
  }
...
- (id)__asyncFutureWithActivity:(id)a3 ignoreErrors:(BOOL)a4 block:(id)a5
{
  ...
  id v24 = &v23;
  uint64_t v25 = 0x3032000000;
  id v26 = __Block_byref_object_copy__133274;
  id v27 = __Block_byref_object_dispose__133275;
  id v28 = 0;
  v19[0] = MEMORY[0x1E4F143A8];
  v19[1] = 3221225472;
...
id __102__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror___asyncFutureWithActivity_ignoreErrors_block___block_invoke_150(uint64_t a1, void *a2)
{
  ...
  id v5 = v3;
  [v4 performBlock:v8];
  BOOL v6 = [MEMORY[0x1E4F7A0D8] futureWithNoResult];
...
void __102__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror___asyncFutureWithActivity_ignoreErrors_block___block_invoke_2_151(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v9 = 2112;
    uint64_t v10 = v6;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring error from promise: %@", (uint8_t *)&v7, 0x16u);
  }
}
...
void __102__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror___asyncFutureWithActivity_ignoreErrors_block___block_invoke_6(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    {
      id v4 = (void *)MEMORY[0x1D9452090]([*(id *)(a1 + 40) markWithFormat:@"Not running block because we're already shutting down"]);
      id v5 = v3;
      id v6 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v16 = 138543362;
        uint64_t v17 = v7;
        _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Not running block because we're already shutting down", (uint8_t *)&v16, 0xCu);
      }
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        int v16 = 138543362;
        uint64_t v17 = v11;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Not running block because we're already shutting down", (uint8_t *)&v16, 0xCu);
      }
      id v12 = *(void **)(a1 + 32);
      id v13 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
  ...
  {
    id v14 = *(void **)(a1 + 32);
    id v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel)internalState
{
  ...
  if (![(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)self isRunning])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_FAULT))
    {
      ...
      int v12 = 138543362;
      id v13 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Should only get internal state while running", (uint8_t *)&v12, 0xCu);
    }
...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreMirror)initWithLocalDatabase:(id)a3 cloudDatabase:(id)a4 useAnonymousRequests:(BOOL)a5 ownerQueue:(id)a6
{
  ...
  if (v14)
  {
    ...
    uint64_t v16 = [MEMORY[0x1E4F7A0F0] schedulerWithDispatchQueue:v13];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_133408 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_133408, &__block_literal_global_133409);
  }
  id v2 = (void *)logCategory__hmf_once_v5_133410;
  return v2;
}
...
uint64_t __68__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_133410;
  logCategory__hmf_once_v5_133410 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}
...
- (void)__retryFetchDatabaseChangesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Will %s in %lu seconds", buf, 0x20u);
  }
  [v4 retryIntervalSeconds];
  ...
  if ([v6 code] == 21)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v6;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Change token has expired: %@", buf, 0x16u);
    }
...
- (void)__fetchDatabaseChangesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v51 = 2112;
    uint64_t v52 = v14;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Checking for database changes with change token: %@", buf, 0x16u);
  }
  id v15 = objc_alloc(MEMORY[0x1E4F1A038]);
...
void __115__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchDatabaseChanges____fetchDatabaseChangesWithFetchInfo___block_invoke_2_29(uint64_t a1)
{
  ...
  _os_log_impl(&dword_1D49D5000, v15, v16, v14, buf, v17);
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v28 = v25;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Mirror has been deallocated", buf, 0xCu);
    }
    id v26 = *(id *)(a1 + 40);
    if (!v26)
    {
      id v26 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    }
...
uint64_t __115__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchDatabaseChanges____fetchDatabaseChangesWithFetchInfo___block_invoke_2_23(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v12 = 2112;
    id v13 = v8;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Change token was updated: %@", buf, 0x16u);
  }
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v11;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Zone was deleted: %@", buf, 0x16u);
    }
    [v3 markDeleted];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v16;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring deleted zone: %@", buf, 0x16u);
    }
  }
}
        ...
        v5))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      __int16 v29 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Zone has changes: %@", buf, 0x16u);
    }
    if (v3)
    {
      [v3 markChanged];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v27 = v17;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Forcing all zones to drop change tokens and refresh", buf, 0xCu);
      }
      uint64_t v18 = [*(id *)(a1 + 40) zoneInfoMap];
      [v18 enumerateKeysAndObjectsUsingBlock:&__block_literal_global_147396];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      __int16 v29 = v25;
      _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changes from zone: %@", buf, 0x16u);
    }
  }
}
...
- (void)__performCloudZonePullsWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v41 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting to pull from cloud zones", buf, 0xCu);
  }
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2048;
      uint64_t v43 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Waiting for %lu cloud zones to pull", buf, 0x16u);
    }
    uint64_t v25 = (void *)MEMORY[0x1E4F7A0D8];
    id v26 = [MEMORY[0x1E4F7A0F0] globalAsyncScheduler];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v41 = v31;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Not waiting for any cloud zones to pull", buf, 0xCu);
    }
    __int16 v27 = [MEMORY[0x1E4F7A0D8] futureWithResult:MEMORY[0x1E4F1CBF0]];
  }
      ...
      if (v12)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v37 = 2112;
          id v38 = v20;
          _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Fetching changes for zone %@ but ignoring change token", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v37 = 2112;
          id v38 = v25;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Fetching changes for zone %@", buf, 0x16u);
        }
      }
      id v26 = [a1[5] options];
...
void __112__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____performCloudZonePullsWithFetchInfo___block_invoke_4(uint64_t a1)
{
  ...
  uint64_t v8 = __Block_byref_object_copy__179438;
  int8x16_t v9 = __Block_byref_object_dispose__179439;
  id v10 = 0;
  id v3 = *(void **)(a1 + 40);
  v4[0] = MEMORY[0x1E4F143A8];
  v4[1] = 3221225472;
...
- (void)__startUpCloudZonesWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v41 = v10;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting up cloud zones", buf, 0xCu);
  }
  id v11 = (void *)MEMORY[0x1E4F1CA48];
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2048;
      uint64_t v43 = v24;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Waiting for %lu cloud zones to start up", buf, 0x16u);
    }
    uint64_t v25 = (void *)MEMORY[0x1E4F7A0D8];
    id v26 = [MEMORY[0x1E4F7A0F0] globalAsyncScheduler];
    __int16 v27 = [v25 combineAllFutures:v16 ignoringErrors:1 scheduler:v26];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v41 = v31;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Not waiting for any cloud zones to start up", buf, 0xCu);
    }
    __int16 v27 = [MEMORY[0x1E4F7A0D8] futureWithResult:MEMORY[0x1E4F1CBF0]];
  }
  v34[0] = MEMORY[0x1E4F143A8];
...
void __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v7)
  {
    id v8 = objc_alloc_init(MEMORY[0x1E4F69EE0]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v51 = 2112;
        id v52 = v35;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to create mirrored local zone for %@: %@", buf, 0x20u);
      ...
      id v31 = a1[6];
      id v11 = v35;
      __int16 v19 = [MEMORY[0x1E4F7A0D8] futureWithError:v35];
      [v31 addObject:v19];
      id v5 = v34;
    }
  }
...
void __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke_4(uint64_t a1)
{
  ...
  id v7 = __Block_byref_object_copy__179438;
  uint64_t v8 = __Block_byref_object_dispose__179439;
  id v9 = 0;
  uint64_t v2 = *(void **)(a1 + 32);
  v3[0] = MEMORY[0x1E4F143A8];
  v3[1] = 3221225472;
...
id __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke_32(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Zone %@ started up", buf, 0x16u);
  }
...
void __108__HMDNetworkRouterFirewallRuleManagerBackingStoreMirror_FetchZoneChanges____startUpCloudZonesWithFetchInfo___block_invoke_37(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v15 = 2112;
    id v16 = v3;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Zone %@ failed to start up: %@", buf, 0x20u);
  }
}
...
- (BOOL)__createCloudZonesForFetchInfo:(id)a3 error:(id *)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)((char *)&buf + 4) = v14;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Creating cloud zones", (uint8_t *)&buf, 0xCu);
    }
    *(void *)&long long buf = 0;
    *((void *)&buf + 1) = &buf;
    uint64_t v29 = 0x3032000000;
    id v30 = __Block_byref_object_copy__179438;
    id v31 = __Block_byref_object_dispose__179439;
    id v32 = 0;
    __int16 v15 = [(HMDNetworkRouterFirewallRuleManagerBackingStoreMirror *)v12 cloudDatabase];
    id v16 = (os_unfair_lock_s *)&v15[*MEMORY[0x1E4F69F18]];
    os_unfair_lock_lock_with_options();
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543618;
        ...
        __int16 v94 = 2112;
        uint64_t v95 = v24;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Already have a model for zone %@", buf, 0x16u);
        ...
        if (isKindOfClass)
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)long long buf = 138543618;
            ...
            __int16 v94 = 2112;
            uint64_t v95 = v36;
            _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Already have an open HMDNetworkRouterFirewallRuleCloudZone for zone %@", buf, 0x16u);
          }
          [v8 setCloudZone:v26];
        }
        else
        {
          ...
          if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)long long buf = 138543874;
            ...
            __int16 v96 = 2112;
            id v97 = v26;
            _os_log_impl(&dword_1D49D5000, v72, OS_LOG_TYPE_ERROR, "%{public}@Another HMBCloudZone open for %@ that isn't one of ours: %@", buf, 0x20u);

            id v70 = v86;
          }

          uint64_t v75 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543618;
        ...
        __int16 v94 = 2112;
        uint64_t v95 = v48;
        _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Saving new cloud zone model for zone %@", buf, 0x16u);
      }
      id v49 = objc_alloc(MEMORY[0x1E4F69E60]);
      __int16 v50 = [v9 modelID];
      __int16 v51 = [*(id *)(a1 + 48) hmbModelID];
      id v12 = (void *)[v49 initWithModelID:v50 parentModelID:v51];

      [v12 setZoneID:v9];
      [v12 setNeedsZoneCreation:MEMORY[0x1E4F1CC28]];
      id v52 = [*(id *)(a1 + 40) cloudDatabase];
      uint64_t v53 = [v52 stateZone];
      v91 = v12;
      long long v54 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v91 count:1];
      ...
      if (*(void *)(*(void *)(*(void *)(a1 + 56) + 8) + 40))
      {
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)long long buf = 138543874;
          ...
          __int16 v96 = 2112;
          id v97 = v69;
          _os_log_impl(&dword_1D49D5000, v62, OS_LOG_TYPE_ERROR, "%{public}@Failed to save new cloud zone model for zone %@: %@", buf, 0x20u);
...
LABEL_29:
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v94 = 2112;
    uint64_t v95 = v43;
    _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring zone %@ that has no changes", buf, 0x16u);
  }
LABEL_30:
}
