...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_19655 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_19655, &__block_literal_global_19656);
  }
  v2 = (void *)logCategory__hmf_once_v2_19657;
  return v2;
}

- (void)_getSnapshot:(unint64_t)a3
{
  id v10 = (id)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"Take Snapshot Local"];
  v5 = [(HMDCameraSnapshotLocal *)self snapshotRequestHandler];
  v6 = [(HMDCameraSnapshotLocal *)self sessionID];
...
- (void)_handleSnapshotFile:(id)a3 error:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = (void *)MEMORY[0x1D9452090]([(HMDCameraSnapshotLocal *)self setSnapshotFile:v6]);
  v9 = self;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v26 = 2112;
    v27 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that image %@ has been saved with error %@ for session %@", buf, 0x2Au);
  }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating HMDCameraSnapshotLocal", buf, 0xCu);
  }
  v7.receiver = v4;
...
uint64_t __37__HMDCameraSnapshotLocal_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_19657;
  logCategory__hmf_once_v2_19657 = v0;
