...
+ (id)sharedVendorDataManager
{
  if (sharedVendorDataManager_onceToken != -1) {
    dispatch_once(&sharedVendorDataManager_onceToken, &__block_literal_global_126520);
  }
...
- (id)modelCollectionForManufacturer:(id)a3
{
  ...
  if (v4)
  {
    ...
    v9 = [(HMDVendorDataManager *)self collectionsByManufacturer];
...
- (void)timerDidFire:(id)a3
{
  id v4 = [(HMDVendorDataManager *)self workQueue];
...
uint64_t __37__HMDVendorDataManager_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Timer fired after %.0lf sec", (uint8_t *)&v7, 0x16u);
  }
...
- (BOOL)_parseManufacturersList:(id)a3 collectionsByManufacturer:(id *)a4 entriesByProductData:(id *)a5
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v101 = 2112;
    v102 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Parsing manufacturers dictionary: %@", buf, 0x16u);
  }
  v85 = [MEMORY[0x1E4F1CA60] dictionary];
  uint64_t v11 = [MEMORY[0x1E4F1CA60] dictionary];
  v87 = [MEMORY[0x1E4F28B88] whitespaceCharacterSet];
  long long v94 = 0u;
  long long v95 = 0u;
  long long v96 = 0u;
  long long v97 = 0u;
        ...
        if (![(__CFString *)v19 length])
        {
          ...
          if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v101 = 2112;
            v102 = v16;
            _os_log_impl(&dword_1D49D5000, v70, OS_LOG_TYPE_ERROR, "%{public}@Manufacturers dictionary contains invalid key: %@", buf, 0x16u);
          }
                ...
                if (!v33)
                {
                  ...
                  if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    __int16 v103 = 2112;
                    id v104 = v32;
                    _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@Manufacturer %@ contains an invalid model entry for %@", buf, 0x20u);
                  }
LABEL_46:
                  v12 = v75;
                  v24 = v79;
              ...
              if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v103 = 2112;
                id v104 = v29;
                _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@ contains invalid key: %@", buf, 0x20u);
              }
              goto LABEL_46;
            }
LABEL_33:
...
LABEL_47:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v103 = 2112;
              id v104 = v56;
              _os_log_impl(&dword_1D49D5000, v51, OS_LOG_TYPE_ERROR, "%{public}@Manufacturers dictionary contains an invalid %@ value: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v101 = 2112;
            v102 = v19;
            _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@Manufacturers dictionary contains an invalid entry for %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v65, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v101 = 2112;
    v102 = v85;
    _os_log_impl(&dword_1D49D5000, v65, OS_LOG_TYPE_DEBUG, "%{public}@Prepared vendor model entries: %@", buf, 0x16u);
  }
...
- (id)_parseVendorModelEntryForManufacturer:(id)a3 model:(id)a4 dictionary:(id)a5
{
  ...
  if (v11 && !+[HMDAccessory validateProductData:v11])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v38[10] = 2112;
      *(void *)&v38[12] = v15;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@:%@ contains an invalid %@ value: %@", buf, 0x34u);
    }
  ...
  if (v16)
  {
    ...
    *(void *)&buf[16] = 0x3032000000;
    v37 = __Block_byref_object_copy__126343;
    *(void *)v38 = __Block_byref_object_dispose__126344;
    *(void *)&v38[8] = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", objc_msgSend(v17, "count"));
...
LABEL_13:
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v38[10] = 2112;
        *(void *)&v38[12] = v25;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@:%@ contains an invalid %@ value: %@", buf, 0x34u);
      }
      v21 = 0;
    }
  }
...
LABEL_7:
  ...
  if (v17)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v22;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Models dictionary for %@:%@ contains an invalid %@ value: %@", (uint8_t *)&v24, 0x34u);
    }
    v17 = 0;
  }
LABEL_11:
...
- (BOOL)_parseDatabaseFromDictionary:(id)a3 dataVersion:(int64_t *)a4 collectionsByManufacturer:(id *)a5 entriesByProductData:(id *)a6
{
  ...
  double v13 = v12;
  uint64_t v14 = (void *)MEMORY[0x1D9452090](v11);
  v15 = self;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\"", buf, 0x34u);
  }
  v18 = [MEMORY[0x1E4F6A2A0] sharedInstance];
  id v19 = objc_alloc(MEMORY[0x1E4F6A2B0]);
  v135 = @"state";
  v136[0] = @"vendorDataManagerParsingData";
  v20 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v136 forKeys:&v135 count:1];
  v21 = (void *)[v19 initWithTag:@"vendorDataManagerStart" data:v20];
  v22 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
  ...
  if (v24 != 1)
  {
    ...
    uint64_t v39 = (void *)MEMORY[0x1E4F1CC28];
    if (v38)
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      __int16 v129 = 2112;
      v130 = v41;
      _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x5Cu);
    }
    __int16 v32 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v42 = objc_alloc(MEMORY[0x1E4F6A2B0]);
  ...
  if (v26 <= 52)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138545922;
      ...
      __int16 v133 = 2112;
      v134 = &unk_1F2DC8B48;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x70u);
    }
    __int16 v32 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v33 = objc_alloc(MEMORY[0x1E4F6A2B0]);
...
LABEL_22:
  ...
  if (v26 < [(HMDVendorDataManager *)v15 dataVersion])
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138545922;
      ...
      __int16 v133 = 2112;
      v134 = v51;
      _os_log_impl(&dword_1D49D5000, v48, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x70u);
    }
    __int16 v32 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v52 = objc_alloc(MEMORY[0x1E4F6A2B0]);
    id v34 = [NSNumber numberWithLong:v26];
    objc_msgSend(NSNumber, "numberWithLong:", -[HMDVendorDataManager dataVersion](v47, "dataVersion"));
    id v43 = (id)objc_claimAutoreleasedReturnValue();
    uint64_t v94 = MEMORY[0x1E4F1CC28];
    ...
    uint64_t v54 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
  ...
  if (v26 == v55)
  {
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      __int16 v129 = 2112;
      v130 = v61;
      _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x5Cu);
    }
    __int16 v32 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v33 = objc_alloc(MEMORY[0x1E4F6A2B0]);
    id v34 = [NSNumber numberWithLong:v26];
  ...
  if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v115 = 2048;
    v116 = (__CFString *)v26;
    _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing data version %ld", buf, 0x16u);
  }
  ...
  if (!v65)
  {
    ...
    if (os_log_type_enabled(v76, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      __int16 v129 = 2112;
      v130 = v78;
      _os_log_impl(&dword_1D49D5000, v76, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x5Cu);
    }
    id v34 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v79 = objc_alloc(MEMORY[0x1E4F6A2B0]);
    ...
    uint64_t v82 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
  ...
  if (!v104)
  {
    if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544898;
      ...
      __int16 v125 = 2112;
      v126 = (void *)MEMORY[0x1E4F1CC28];
      _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_ERROR, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x48u);
    }
    v84 = [MEMORY[0x1E4F6A2A0] sharedInstance];
    id v85 = objc_alloc(MEMORY[0x1E4F6A2B0]);
    uint64_t v96 = MEMORY[0x1E4F1CC28];
    ...
    v88 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
    ...
    if (os_log_type_enabled(v91, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v115 = 2112;
      v116 = v32;
      _os_log_impl(&dword_1D49D5000, v91, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse manufacturers: %@", buf, 0x16u);
    }
    goto LABEL_22;
  }
  if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545922;
    ...
    v128 = @"success";
    __int16 v129 = 2112;
    v130 = (void *)MEMORY[0x1E4F1CC38];
    __int16 v131 = 2114;
    v132 = @"DataVersion";
    __int16 v133 = 2112;
    v134 = v99;
    _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x70u);
  }
  v110 = [MEMORY[0x1E4F6A2A0] sharedInstance];
  ...
  uint64_t v98 = MEMORY[0x1E4F1CC38];
  ...
  v73 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
...
- (void)_handleDataFromServer:(id)a3
{
  ...
  id v4 = a3;
  id v38 = 0;
  v5 = [MEMORY[0x1E4F28F98] propertyListWithData:v4 options:0 format:0 error:&v38];
  id v6 = v38;
  if (v5)
  {
    id v36 = 0;
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v42 = v14;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully parsed database from server, saving to disk", buf, 0xCu);
      }
      ...
      if ([v16 count])
      {
        ...
        v40 = v25;
        int64_t v26 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v40 forKeys:&v39 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v43 = 2112;
      id v44 = v6;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Error while deserializing plist from server data: %@", buf, 0x16u);
    }
  }
}
...
- (void)_handleServerResponse:(id)a3 withData:(id)a4 error:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      uint32_t v18 = 22;
LABEL_9:
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, v16, (uint8_t *)&v26, v18);
...
LABEL_10:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v28 = 2048;
      uint64_t v29 = v21;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received status code %ld from vendor info request", (uint8_t *)&v26, 0x16u);
    }
  }
...
- (void)_fetchDataFromServer
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v11;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Found a cached vendor info response: %@", buf, 0x16u);
    }
  }
  objc_initWeak(&location, self);
  id v16 = (void *)[objc_alloc(MEMORY[0x1E4F653F0]) initWithName:@"ManufacturerDB.fetch" parent:0 options:1];
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v30 = 2112;
    id v31 = v19;
    _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Resuming task: %@", buf, 0x16u);
  }
  [v19 resume];
...
- (void)_loadDatabaseFromLocalFiles
{
  ...
  v2[3] = &unk_1E6A19B30;
  v2[4] = self;
  [MEMORY[0x1E4F653F0] activityWithName:@"ManufacturerDB.load" parent:0 options:1 block:v2];
}
  ...
  if (([*(id *)(a1 + 32) _loadDatabaseFromFilePath:@"/var/mobile/Library/homed/vendor-database" fileDescription:@"cached"] & 1) == 0)
  {
    ...
    if ((v11 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        int v16 = 138543362;
        id v17 = v15;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to read any local database files", (uint8_t *)&v16, 0xCu);
      }
      [*(id *)(a1 + 32) setDataVersion:0];
      [*(id *)(a1 + 32) setCollectionsByManufacturer:MEMORY[0x1E4F1CC08]];
    }
  }
}
...
- (BOOL)_loadDatabaseFromFileURL:(id)a3 fileDescription:(id)a4
{
  ...
  id v7 = a4;
  id v25 = 0;
  int v8 = [MEMORY[0x1E4F1C9E8] dictionaryWithContentsOfURL:v6 error:&v25];
  id v9 = v25;
  ...
  if (!v8)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      uint32_t v23 = 32;
LABEL_12:
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, v21, buf, v23);
    }
LABEL_13:
    BOOL v19 = 0;
    goto LABEL_14;
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v7;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Read data from %@ plist file on disk", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v7;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Loaded database from %@ plist file on disk", buf, 0x16u);
  }
  BOOL v19 = 1;
LABEL_14:
...
- (id)vendorModelEntryForProductData:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      BOOL v19 = v8;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid product data: %@", (uint8_t *)&v16, 0x16u);
    }
    uint64_t v10 = 0;
  }
...
- (HMDVendorDataManager)initWithDefaults
{
  ...
  double v5 = v4;
  id v6 = (void *)MEMORY[0x1D9452090](v3);
  id v7 = self;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v48 = 2112;
    v49 = @"start";
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\"", buf, 0x34u);
  }
  uint64_t v10 = [MEMORY[0x1E4F6A2A0] sharedInstance];
  id v11 = objc_alloc(MEMORY[0x1E4F6A2B0]);
  uint64_t v54 = @"state";
  v55[0] = @"start";
  double v12 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v55 forKeys:&v54 count:1];
  id v13 = (void *)[v11 initWithTag:@"vendorDataManagerStart" data:v12];
  id v14 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
  ...
  BOOL v19 = [MEMORY[0x1E4F290F0] defaultSessionConfiguration];
  [v19 setHTTPCookieAcceptPolicy:1];
  [v19 setHTTPCookieStorage:0];
  [v19 setHTTPShouldSetCookies:0];
  [v19 setURLCredentialStorage:0];
  uint64_t v20 = [MEMORY[0x1E4F290E0] sessionWithConfiguration:v19];
  ...
  uint64_t v24 = (void *)MEMORY[0x1D9452090]([(HMDVendorDataManager *)v23 _loadDatabaseFromLocalFiles]);
  id v25 = v23;
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v52 = 2112;
    v53 = v30;
    _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@tag=\"%{public}@\" desc=\"%@\" %{public}@=\"%@\" %{public}@=\"%@\"", buf, 0x48u);
  }
  id v31 = [MEMORY[0x1E4F6A2A0] sharedInstance];
  ...
  id v38 = [MEMORY[0x1E4F653F0] currentTagProcessorList];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t39_126507 != -1) {
    dispatch_once(&logCategory__hmf_once_t39_126507, &__block_literal_global_169_126508);
  }
  v2 = (void *)logCategory__hmf_once_v40_126509;
  return v2;
}
...
uint64_t __35__HMDVendorDataManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v40_126509;
  logCategory__hmf_once_v40_126509 = v0;
