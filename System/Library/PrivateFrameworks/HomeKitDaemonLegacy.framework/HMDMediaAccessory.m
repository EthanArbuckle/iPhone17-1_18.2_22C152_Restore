...
- (void)encodeWithCoder:(id)a3
{
  ...
  {
    [v4 encodeBool:1 forKey:*MEMORY[0x1E4F2C7C8]];
  }
}
...
- (id)dumpSimpleState
{
  ...
  uint64_t v6 = objc_msgSend(v4, "hmf_stringForKey:", *MEMORY[0x1E4F64EA0]);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v13)
  {
    ...
    v37 = __Block_byref_object_copy__61282;
    v38 = __Block_byref_object_dispose__61283;
    id v39 = 0;
...
void __68__HMDMediaAccessory_notifyConnectivityChangedWithReachabilityState___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      __int16 v13 = 2112;
      v14 = v9;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying clients of updated media accessory reachability: %@", (uint8_t *)&v11, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      int v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring non-remote reachability change while remote access is enabled", (uint8_t *)&v11, 0xCu);
    }
  }
}
...
- (void)handleUpdatedAdvertisement:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updated with advertisement: %@", (uint8_t *)&v9, 0x16u);
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      id v17 = v5;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid removed advertisement: %@", buf, 0x16u);
    }
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid added advertisement: %@", buf, 0x16u);
    }
  }
}
...
LABEL_13:
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, v22, buf, 0xCu);
    }
LABEL_14:
...
- (NSDictionary)assistantObject
{
  ...
  char v7 = [v6 isEqual:*MEMORY[0x1E4F2C188]];

  if (v7)
  {
    id v8 = (id *)MEMORY[0x1E4F97188];
    goto LABEL_5;
  }
  int v9 = [v5 categoryType];
  char v10 = [v9 isEqual:*MEMORY[0x1E4F2C218]];

  if (v10)
  {
    id v8 = (id *)MEMORY[0x1E4F971B0];
LABEL_5:
    id v11 = *v8;
    id v12 = (id)*MEMORY[0x1E4F970F0];
    uint64_t v13 = v12;
    if (v11) {
      BOOL v14 = v12 == 0;
    }
  ...
  if ([(HMDMediaAccessory *)self isMemberOfClass:objc_opt_class()])
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      uint64_t v27 = v5;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Media accessory with invalid accessory category: %@", buf, 0x16u);
    }
  }
  id v11 = 0;
  uint64_t v13 = 0;
