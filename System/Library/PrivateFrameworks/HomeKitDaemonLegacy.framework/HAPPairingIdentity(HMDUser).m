...
+ (id)hmd_pairingIdentityWithDictionary:()HMDUser
{
  ...
  if (v5) {
    v6 = (void *)[objc_alloc(MEMORY[0x1E4F65510]) initWithPairingKeyData:v5];
  }
  else {
    v6 = 0;
  }
  ...
  if (v7) {
    v8 = (void *)[objc_alloc(MEMORY[0x1E4F65510]) initWithPairingKeyData:v7];
  }
  else {
    v8 = 0;
  }
  v9 = [v3 objectForKeyedSubscript:@"HAP.permissions"];
  v10 = objc_msgSend(objc_alloc(MEMORY[0x1E4F5BE00]), "initWithIdentifier:publicKey:privateKey:permissions:", v4, v8, v6, objc_msgSend(v9, "integerValue"));
