...
- (void)snapshotLocal:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v30 = 2112;
      id v31 = v12;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Snapshot local capture has ended in %@", (uint8_t *)&v28, 0x16u);
    }
  ...
  else
  {
    ...
    if (v18)
    {
      v19 = (void *)MEMORY[0x1D9452090]([(HMDCameraSnapshotRemoteRelaySender *)self _callDidSaveSnapshotFileDelegate:v11]);
      v20 = self;
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v30 = 2112;
        id v31 = v11;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Scheduling the transfer of file %@ through IDS", (uint8_t *)&v28, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        int v28 = 138543362;
        v29 = v27;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode snapshot file to send over IDS", (uint8_t *)&v28, 0xCu);
      }
...
- (void)_callDidSaveSnapshotFileDelegate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    v20 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that snapshot file has been saved for session %@", buf, 0x16u);
  }
...
uint64_t __50__HMDCameraSnapshotRemoteRelaySender_getSnapshot___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v5;
    _os_log_impl(&dword_1D49D5000, v4, OS_LOG_TYPE_INFO, "%{public}@Getting the snapshot from local snapshot handler", (uint8_t *)&v9, 0xCu);
  }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v9 = v6;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteRelaySender", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_153040 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_153040, &__block_literal_global_153041);
  }
  v2 = (void *)logCategory__hmf_once_v2_153042;
  return v2;
}
...
uint64_t __49__HMDCameraSnapshotRemoteRelaySender_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_153042;
  logCategory__hmf_once_v2_153042 = v0;
