...
LABEL_7:
  ...
  if (v5 != 1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unexpected event %@", (uint8_t *)&v12, 0x16u);
    }
    goto LABEL_7;
  }
  uint64_t v6 = 1;
...
- (void)threadNetworkStateChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@threadNetworkStateChange - received event %@, type %ld, value %ld", buf, 0x2Au);
  }
  ...
  else if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      id v23 = v4;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unexpected event %@", buf, 0x16u);
    }
  }
  else
  {
...
- (void)stopListeningForEvents
{
  ...
  id v4 = (void *)MEMORY[0x1D9452090]([(HMDCHIPThreadNetworkEventListener *)self setThreadResidentCommissioner:0]);
  uint64_t v5 = self;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@stopped listening for events", (uint8_t *)&v8, 0xCu);
  }
}
...
- (HMDCHIPThreadNetworkEventListener)initWithThreadResidentCommissioner:(id)a3
{
  ...
  if (v6)
  {
    ...
    int v8 = (void *)MEMORY[0x1D9452090]([(HMDThreadResidentCommissioner *)v7->_threadResidentCommissioner registerForThreadNetworkEvents:v7]);
    v9 = v7;
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      ...
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@started listening for events", buf, 0xCu);
    }
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_45927 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_45927, &__block_literal_global_45928);
  }
  v2 = (void *)logCategory__hmf_once_v6_45929;
  return v2;
}
...
uint64_t __48__HMDCHIPThreadNetworkEventListener_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v6_45929;
  logCategory__hmf_once_v6_45929 = v0;
