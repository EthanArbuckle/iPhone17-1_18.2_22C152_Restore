...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x1E4F5BC58] wrappertlv:1 name:@"kVideoCodecParameters__ProfileID" objectCreator:&__block_literal_global_4882];
  id v4 = [MEMORY[0x1E4F5BC58] wrappertlv:2 name:@"kVideoCodecParameters__Level" objectCreator:&__block_literal_global_112];
  v5 = [MEMORY[0x1E4F5BC58] wrappertlv:3 name:@"kVideoCodecParameters__PacketizationMode" objectCreator:&__block_literal_global_115];
  v15[0] = v3;
  v15[1] = v4;
  v15[2] = v5;
