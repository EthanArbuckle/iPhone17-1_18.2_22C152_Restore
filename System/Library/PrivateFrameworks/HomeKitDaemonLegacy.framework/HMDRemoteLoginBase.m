...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_106011 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_106011, &__block_literal_global_106012);
  }
  v2 = (void *)logCategory__hmf_once_v1_106013;
  return v2;
}

uint64_t __33__HMDRemoteLoginBase_logCategory__block_invoke()
{
  uint64_t v0 = HMFCreateOSLogHandle();
  uint64_t v1 = logCategory__hmf_once_v1_106013;
  logCategory__hmf_once_v1_106013 = v0;
