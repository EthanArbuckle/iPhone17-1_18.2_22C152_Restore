...
- (id)legacyMessageForMessage:(id)a3
{
  ...
  v7 = [(HMDAccessorySettingsMessenger *)self legacyMessageReceiver];
  v8 = [v7 messageTargetUUID];
  v9 = (void *)[v6 initWithTarget:v8];
...
- (void)routeAccessorySettingsUpdateRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing accessory settings update request message: %@", buf, 0x16u);
  }
  v9 = [(HMDAccessorySettingsMessenger *)v6 legacyMessageForMessage:v4];
  ...
  id v13 = v4;
  id v11 = v4;
  [v10 routeMessage:v9 localHandler:v12];
}
...
- (void)routeAccessorySettingsFetchRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v31 = 2112;
    id v32 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing accessory settings fetch request message: %@", buf, 0x16u);
  }
  id v9 = v4;
  ...
  v20 = [(HMDAccessorySettingsMessenger *)v6 legacyMessageForMessage:v11];
  ...
  id v24 = v11;
  id v22 = v11;
  [v21 routeMessage:v20 localHandler:v23];
}
...
- (void)sendUpdateAccessorySettingRequestWithAccessoryUUID:(id)a3 keyPath:(id)a4 settingValue:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v39 = 2112;
    id v40 = v12;
    _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending update request with accessoryUUID: %@ keypath: %@ value: %@", buf, 0x2Au);
  }
  uint64_t v18 = (void *)[objc_alloc(MEMORY[0x1E4F2E620]) initWithAccessoryUUID:v10 keyPath:v11 settingValue:v12];
  ...
  uint64_t v23 = *MEMORY[0x1E4F2C630];
...
void __123__HMDAccessorySettingsMessenger_sendUpdateAccessorySettingRequestWithAccessoryUUID_keyPath_settingValue_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Send update request responded with error: %@", (uint8_t *)&v13, 0x16u);
    }
  }
  else if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    v14 = v12;
    _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Send update request responded", (uint8_t *)&v13, 0xCu);
  }
...
LABEL_4:
  ...
  if (!v9)
  {
    id v32 = (void *)MEMORY[0x1D9452090](v11);
    uint64_t v33 = self;
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v52 = 2112;
      id v53 = 0;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_ERROR, "%{public}@Send fetch request responded with error: %@", buf, 0x16u);
    }
    id v36 = [MEMORY[0x1E4F28C58] hmErrorWithCode:20];
    [v8 setError:v36];

    goto LABEL_3;
  }
  v14 = (void *)[objc_alloc(MEMORY[0x1E4F2E610]) initWithPayload:v9];
  if (v14)
  {
    __int16 v15 = v14;
    v43 = self;
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 2112;
    id v53 = v9;
    _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode fetch request response payload: %@", buf, 0x16u);
  }
...
- (id)fetchLogEventFromMessage:(id)a3
{
  ...
  id v11 = objc_alloc(MEMORY[0x1E4F2E608]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      int v22 = 138543362;
      uint64_t v23 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode fetch request payload for metric generation", (uint8_t *)&v22, 0xCu);
    }
    id v16 = 0;
  }
...
- (void)sendFetchAccessorySettingsRequestWithAccessoryUUID:(id)a3 keyPaths:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v32 = 2112;
    id v33 = v9;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending fetch request with accessoryUUID: %@ keypaths: %@", buf, 0x20u);
  }
  __int16 v15 = (void *)[objc_alloc(MEMORY[0x1E4F2E608]) initWithAccessoryUUID:v8 keyPaths:v9];
  ...
  uint64_t v20 = *MEMORY[0x1E4F2C620];
  v21 = [v15 payloadCopy];
...
void __111__HMDAccessorySettingsMessenger_sendFetchAccessorySettingsRequestWithAccessoryUUID_keyPaths_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    v7 = (void *)[objc_alloc(MEMORY[0x1E4F2E610]) initWithPayload:v6];
    ...
    if (v7)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        int v22 = 138543362;
        id v23 = v12;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Send fetch request responded", (uint8_t *)&v22, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v6;
        _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode fetch request response payload: %@", (uint8_t *)&v22, 0x16u);
      }
      uint64_t v13 = *(void *)(a1 + 48);
      uint64_t v14 = [MEMORY[0x1E4F2E5F0] fetchResultsWithKeyPaths:*(void *)(a1 + 40) failureType:3];
    }
    v21 = (void *)v14;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v5;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Send fetch request responded with error: %@", (uint8_t *)&v22, 0x16u);
    }
    uint64_t v19 = *(void *)(a1 + 48);
    v7 = [MEMORY[0x1E4F2E5F0] fetchResultsWithKeyPaths:*(void *)(a1 + 40) failureType:0];
...
- (void)registerForMessagesWithHome:(id)a3
{
  ...
  __int16 v15 = [(HMDAccessorySettingsMessenger *)self legacyMessageReceiver];
  [v15 registerForMessagesWithHome:v4];
}
...
LABEL_13:
  ...
  v21 = v20;
  v30.receiver = self;
  v30.super_class = (Class)HMDAccessorySettingsMessenger;
  int v22 = [(HMDAccessorySettingsMessenger *)&v30 init];
  id v23 = v22;
  if (v22)
  {
    ...
    objc_storeStrong((id *)&v23->_logEventSubmitter, v28);
    objc_storeStrong((id *)&v23->_legacyMessageReceiver, v29);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_168742 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_168742, &__block_literal_global_168743);
  }
  id v2 = (void *)logCategory__hmf_once_v12_168744;
  return v2;
}
...
uint64_t __44__HMDAccessorySettingsMessenger_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v12_168744;
  logCategory__hmf_once_v12_168744 = v0;
