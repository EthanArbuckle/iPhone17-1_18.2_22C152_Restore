...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    v13 = v5;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying client of did trigger message handler queued message with delegate: %@", (uint8_t *)&v10, 0x16u);
  }
...
{
  id v7 = a3;
  v8 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:2 options:a4];
  v12.receiver = self;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_91822 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_91822, &__block_literal_global_91823);
  }
  id v2 = (void *)logCategory__hmf_once_v2_91824;
  return v2;
}
...
uint64_t __45__HMDMessageHandlerQueuedMessage_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_91824;
  logCategory__hmf_once_v2_91824 = v0;
