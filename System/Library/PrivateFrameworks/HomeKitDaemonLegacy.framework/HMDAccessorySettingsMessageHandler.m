...
- (void)notifyOfUpdatedValue:(id)a3 settingKeyPath:(id)a4
{
  ...
  if ((_os_feature_enabled_impl() & 1) == 0)
  {
    ...
    uint64_t v9 = *MEMORY[0x1E4F2C608];
    v18[0] = *MEMORY[0x1E4F2C618];
    v10 = encodeRootObject();
    v18[1] = *MEMORY[0x1E4F2DF50];
    v19[0] = v10;
    v19[1] = v7;
    ...
    v16 = (void *)[v13 initWithTarget:v15];
...
- (void)relayReplaceConstraints:(id)a3 constraintIdsToRemove:(id)a4 keyPath:(id)a5 destination:(id)a6 completion:(id)a7
{
  ...
  if (v13)
  {
    v15 = [MEMORY[0x1E4F2EBF8] _encodedConstraintsToAdd:v12];
    v27 = objc_msgSend(v29, "na_map:", &__block_literal_global_46_187142);
    v16 = [MEMORY[0x1E4F2EBF8] _replaceConstraintsPayloadWithAdditions:v15 removals:v27 keyPath:v30];
    v17 = +[HMDRemoteMessage secureMessageWithName:*MEMORY[0x1E4F2C5F0] qualityOfService:25 destination:v13 messagePayload:v16];
    ...
    id v32 = v14;
    v18 = (void *)MEMORY[0x1D9452090]([v17 setResponseHandler:v31]);
    v19 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      v38 = v17;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Relaying replace constraints message. %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot send setting message as device is not known", buf, 0xCu);
    }
    v15 = [MEMORY[0x1E4F28C58] hmErrorWithCode:54];
...
- (void)relayUpdateValue:(id)a3 keyPath:(id)a4 destination:(id)a5 completion:(id)a6
{
  ...
  if (v11)
  {
    uint64_t v37 = *MEMORY[0x1E4F2C618];
    id v14 = v10;
    if (!v10)
    {
      id v14 = objc_msgSend(MEMORY[0x1E4F1CA98], "null", v27);
    }
    ...
    if (!v10) {
    v17 = +[HMDRemoteMessage secureMessageWithName:qualityOfService:destination:messagePayload:](HMDRemoteMessage, "secureMessageWithName:qualityOfService:destination:messagePayload:", *MEMORY[0x1E4F2C608], 25, v11, v16, v27);
    }
    objc_initWeak(&location, self);
    ...
    id v30 = v13;
    v18 = (void *)MEMORY[0x1D9452090]([v17 setResponseHandler:v29]);
    v19 = self;
    HMFGetOSLogHandle();
    v20 = (id)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2112;
      v36 = v17;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Relaying update value message. %@", buf, 0x16u);
    }
    v22 = [(HMDAccessorySettingsMessageHandler *)v19 messageDispatcher];
    [v22 sendMessage:v17 completionHandler:0];
  ...
  {
    v23 = (void *)MEMORY[0x1D9452090](v12);
    v24 = self;
    v25 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
    ...
    v16 = objc_msgSend(MEMORY[0x1E4F28C58], "hmErrorWithCode:", 54, v27);
...
void __86__HMDAccessorySettingsMessageHandler_relayUpdateValue_keyPath_destination_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    id v7 = objc_msgSend(*(id *)(a1 + 40), "hmf_numberForKey:", @"cv");
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode response %@ of relayed update value message.", buf, 0x16u);
    }
...
- (void)_handleReplaceConstraintsForKeyPath:(id)a3
{
  ...
  uint64_t v6 = objc_msgSend(v5, "hmf_stringForKey:", *MEMORY[0x1E4F2DF50]);

  if (v6)
  {
    id v7 = [(HMDAccessorySettingsMessageHandler *)self messageController];
    if (![v4 isRemote])
    {
LABEL_7:
      id v26 = 0;
...
LABEL_15:
    ...
    v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:10];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v22;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Missing key path from accessory settings update message: %@", buf, 0x16u);
    }
    id v7 = [MEMORY[0x1E4F28C58] hmErrorWithCode:27];
...
LABEL_13:
      ...
      if (!v12
        || ([v4 destination],
            ...
            !v15))
      {
        id v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:10];
...
- (BOOL)processReplaceConstraintMessage:(id)a3 outConstraintsToAdd:(id *)a4 outConstraintIdsToRemove:(id *)a5
{
  ...
  uint64_t v10 = [v8 arrayForKey:*MEMORY[0x1E4F2C598]];
  if (v10)
  {
    if (objc_msgSend(v10, "hmf_objectsAreKindOfClass:", objc_opt_class()))
    {
      ...
      if (v12)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v13; ++i)
          {
            ...
            BOOL v16 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:*(void *)(*((void *)&v53 + 1) + 8 * i)];
            [v9 addObject:v16];
          }
      ...
      id v17 = [v8 dataForKey:*MEMORY[0x1E4F2C588]];
      if (v17)
      {
        id v18 = (void *)MEMORY[0x1E4F28DC0];
...
LABEL_30:
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v61 = 2112;
          id v62 = v23;
          _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive accessory setting constraint from constraints to add data: %@", buf, 0x16u);
        }
        v48 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v61 = 2112;
          id v62 = v43;
          _os_log_impl(&dword_1D49D5000, v41, OS_LOG_TYPE_INFO, "%{public}@Missing serialized constraints to add in message payload: %@", buf, 0x16u);
        }
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v61 = 2112;
      id v62 = v10;
      _os_log_impl(&dword_1D49D5000, v37, OS_LOG_TYPE_INFO, "%{public}@Invalid constraints classes: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v61 = 2112;
      id v62 = v32;
      _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Missing constraints to remove in message payload: %@", buf, 0x16u);
    }
    id v33 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v34 = 3;
  }
...
- (void)_handleUpdatedConstraints:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 dataForKey:*MEMORY[0x1E4F2C590]];
  if (v5)
  {
    ...
    if (v14)
    {
      ...
      BOOL v16 = objc_msgSend(v15, "hmf_stringForKey:", *MEMORY[0x1E4F2DF50]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v37 = v31;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Missing key path in message payload", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        id v39 = v11;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive accessory setting constraint from constraints data: %@", buf, 0x16u);
      }
      BOOL v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v38 = 2112;
      id v39 = v23;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_INFO, "%{public}@Missing serialized constraints in message payload: %@", buf, 0x16u);
    }
    id v11 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Constraint not found" reason:@"Missing serialized constraint in update message" suggestion:0];
...
- (void)_handleRemoveConstraint:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [MEMORY[0x1E4F28DC0] deserializeObjectWithData:v5 allowedClass:objc_opt_class() frameworkClasses:MEMORY[0x1E4F1CBF0]];
    if (v6)
    {
      id v7 = [v4 messagePayload];
      id v8 = objc_msgSend(v7, "hmf_stringForKey:", *MEMORY[0x1E4F2DF50]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          BOOL v27 = v23;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing key path in message payload", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        BOOL v27 = v19;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Invalid constraint in message payload", buf, 0xCu);
      }
      id v8 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v15;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized constraint in message payload: %@", buf, 0x16u);
    }
    uint64_t v6 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Constraint not found" reason:@"Missing serialized constraint in remove message" suggestion:0];
...
- (void)_handleAddConstraint:(id)a3
{
  ...
  else
  {
    ...
    uint64_t v6 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2 description:@"Constraint not found" reason:@"Missing serialized constraint in add message" suggestion:0];
    [v4 respondWithError:v6];
  }
}
...
- (void)_handleSettingUpdateValueByKeyPath:(id)a3
{
  ...
  if (v6)
  {
    ...
    int v9 = objc_msgSend(v8, "hmf_stringForKey:", *MEMORY[0x1E4F2DF50]);
    ...
    if (v9)
    {
      ...
      v18[1] = 3221225472;
      void v18[2] = __73__HMDAccessorySettingsMessageHandler__handleSettingUpdateValueByKeyPath___block_invoke;
      v18[3] = &unk_1E6A193A8;
      v18[4] = self;
      id v16 = v9;
      id v19 = v16;
...
void __73__HMDAccessorySettingsMessageHandler__handleSettingUpdateValueByKeyPath___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      uint64_t v28 = 0;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Responding to the original update value request for target %@ with value: %@, configNum: %@, error: %@", (uint8_t *)&v19, 0x34u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v30 = 2112;
      uint64_t v31 = 0;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Responding to the original update value request for target %@ with value: %@, configNum: %@, error: %@", buf, 0x34u);
...
- (BOOL)_decodeUpdateValueMessagePayload:(id)a3 outValue:(id *)a4
{
  ...
  id v6 = a3;
  id v7 = objc_msgSend(v6, "hmf_dataForKey:", *MEMORY[0x1E4F2C618]);
  if (v7)
  {
    id v22 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        id v26 = v9;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive accessory setting supported value from value data: %@", buf, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v6;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Missing serialized value from payload: %@", buf, 0x16u);
    }
    BOOL v10 = 0;
  }
...
+ (id)messageBindingsForDispatcher:(id)a3
{
  ...
  v27[4] = v16;
  id v18 = [MEMORY[0x1E4F1C978] arrayWithObjects:v27 count:5];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_187207 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_187207, &__block_literal_global_187208);
  }
  v2 = (void *)logCategory__hmf_once_v1_187209;
  return v2;
}
...
uint64_t __49__HMDAccessorySettingsMessageHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_187209;
  logCategory__hmf_once_v1_187209 = v0;
