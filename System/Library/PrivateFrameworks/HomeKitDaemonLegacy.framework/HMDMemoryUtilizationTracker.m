  ...
  *(_OWORD *)buffer = 0u;
  ...
  if (proc_pid_rusage(v5, 6, buffer))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v18 = 138543362;
      v19 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to retrieve memory foot-print", (uint8_t *)&v18, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Current process memory utilization: %lld, Interval peak memory utilization (Since last timer-based sample): %lld", (uint8_t *)&v18, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_180924 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_180924, &__block_literal_global_180925);
  }
  v2 = (void *)logCategory__hmf_once_v3_180926;
  return v2;
}
...
uint64_t __42__HMDMemoryUtilizationTracker_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v3_180926;
  logCategory__hmf_once_v3_180926 = v0;
