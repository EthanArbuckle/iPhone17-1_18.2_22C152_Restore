  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v8;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to find matching accessory with UUID: %@ in home (%@) to sync settings", buf, 0x20u);
    }
    if (a5)
    {
...
- (id)readValueValueForAccessoryUUID:(id)a3 homeUUID:(id)a4 forKeyPath:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v37 = 2112;
    id v38 = v10;
    _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Writing endpoint settings for accessoryUUID: %@, homeUUID: %@, keyPath: %@", buf, 0x2Au);
  }
  id v29 = 0;
  id v30 = 0;
  ...
  if (!v16)
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    uint32_t v25 = 32;
LABEL_17:
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, v23, buf, v25);
...
LABEL_12:
    uint64_t v27 = (void *)[objc_alloc(MEMORY[0x1E4F2EA98]) initWithBoolValue:v18 == 1];
    goto LABEL_19;
  }
...
- (void)_matchingHomeforUUID:(id)a3 accessoryUUID:(id)a4 home:(id *)a5 accessory:(id *)a6
{
  ...
  if (a5)
  {
    ...
    if (a6)
    {
      ...
      *a5 = v16;
      ...
      v26[1] = 3221225472;
      v26[2] = __88__HMDSiriEndpointSettingsSyncManager__matchingHomeforUUID_accessoryUUID_home_accessory___block_invoke_67;
      v26[3] = &unk_1E6A14470;
      id v27 = v11;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v25;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Nil out hap accessory passed", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v21;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Nil out parameter home passed", buf, 0xCu);
    }
  }
}
...
- (void)writeSettingValue:(id)a3 accessoryUUID:(id)a4 homeUUID:(id)a5 forKeyPath:(id)a6 completionHandler:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v45 = 2112;
    id v46 = v15;
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Writing endpoint settings for accessoryUUID: %@, homeUUID: %@, settingValue: %@, keyPath: %@", buf, 0x34u);
  }
  id v35 = 0;
  id v36 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v41 = 2112;
      id v42 = v13;
      _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unable to find matching accessory with UUID: %@ in home (%@) to sync settings", buf, 0x20u);
    ...
    if (v16)
    {
      v28 = [MEMORY[0x1E4F28C58] hmErrorWithCode:2];
...
- (void)_writeSettingValue:(id)a3 toAccessory:(id)a4 forKeyPath:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v102 = 2112;
    id v103 = v12;
    _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Writing setting value: %@ to siri endpoint accessory: %@ for keypath: %@", buf, 0x2Au);
  }
...
LABEL_70:
  ...
  if ([v12 isEqualToString:@"root.siri.tapToAccess"])
  {
    ...
    if (v28)
    {
      ...
      v88[1] = 3221225472;
      v88[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_61;
      v88[3] = &unk_1E6A19A28;
      v88[4] = v16;
      id v89 = v11;
      id v24 = v28;
  ...
  if ([v12 isEqualToString:@"root.siri.lightWhenUsingSiri"])
  {
    ...
    if (v33)
    {
      ...
      v84[1] = 3221225472;
      v84[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_62;
      v84[3] = &unk_1E6A19A28;
      v84[4] = v16;
      id v85 = v11;
      id v24 = v33;
  ...
  if ([v12 isEqualToString:@"root.siri.soundAlert"])
  {
    ...
    if (v43)
    {
      ...
      v80[1] = 3221225472;
      v80[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_63;
      v80[3] = &unk_1E6A19A28;
      v80[4] = v16;
      id v81 = v11;
      id v24 = v43;
  ...
  if ([v12 isEqualToString:@"root.airPlay.airPlayEnabled"])
  {
    ...
    if (v24)
    {
      ...
      if (v50)
      {
        ...
        v76[1] = 3221225472;
        v76[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_65;
        v76[3] = &unk_1E6A19A28;
        v76[4] = v16;
        id v77 = v11;
        id v78 = v24;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v102 = 2112;
          id v103 = v11;
          _os_log_impl(&dword_1D49D5000, v67, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize airplayEnabledSettingValue (%@) for keypath %@, accessory: %@, as accessory does not have a hapMediaProfile", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v102 = 2112;
        id v103 = v11;
        _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_ERROR, "%{public}@airplayEnabledSettingValue (%@) for keypath %@, accessory: %@, is not of BOOL setting type", buf, 0x2Au);
      ...
      id v50 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
  ...
  if ([v12 isEqualToString:@"root.siri.siriEnabled"])
  {
    ...
    if (v54)
    {
      ...
      v72[1] = 3221225472;
      v72[2] = __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_66;
      v72[3] = &unk_1E6A19A28;
      v72[4] = v16;
      id v73 = v11;
      id v24 = v54;
...
LABEL_66:
    _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, v40, buf, 0x2Au);

LABEL_67:
    if (v13)
    {
      v69 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
...
LABEL_69:
  ...
  if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v102 = 2112;
    id v103 = v11;
    _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_ERROR, "%{public}@Unknown keypath (%@) for homekit backed siri endpoint setting value (%@) accessory: %@", buf, 0x2Au);
  }
  if (v13)
  {
    id v24 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized hey siri enabled on %@ to %@ with success: %@ (%@)", (uint8_t *)&v12, 0x34u);
  }
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_61(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized tap to access on %@ to %@ with success: %@ (%@)", (uint8_t *)&v12, 0x34u);
  }
  uint64_t v11 = *(void *)(a1 + 56);
  if (v11) {
    (*(void (**)(uint64_t, id))(v11 + 16))(v11, v3);
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_62(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized light on use on %@ to %@ with success: %@ (%@)", (uint8_t *)&v12, 0x34u);
  }
  uint64_t v11 = *(void *)(a1 + 56);
  if (v11) {
    (*(void (**)(uint64_t, id))(v11 + 16))(v11, v3);
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_63(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized sound on use on %@ to %@ with success: %@ (%@)", (uint8_t *)&v12, 0x34u);
  }
  uint64_t v11 = *(void *)(a1 + 56);
  if (v11) {
    (*(void (**)(uint64_t, id))(v11 + 16))(v11, v3);
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_65(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized airplayEnabled on %@ to %@ with success: %@ (%@)", (uint8_t *)&v12, 0x34u);
  }
  uint64_t v11 = *(void *)(a1 + 56);
  if (v11) {
    (*(void (**)(uint64_t, id))(v11 + 16))(v11, v3);
...
void __98__HMDSiriEndpointSettingsSyncManager__writeSettingValue_toAccessory_forKeyPath_completionHandler___block_invoke_66(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Synchronized siriEnabled on %@ to %@ with success: %@ (%@)", (uint8_t *)&v12, 0x34u);
  }
  uint64_t v11 = *(void *)(a1 + 56);
  if (v11) {
    (*(void (**)(uint64_t, id))(v11 + 16))(v11, v3);
...
- (void)_writeSetting:(id)a3 toAccessory:(id)a4 forKeyPath:(id)a5
{
  ...
  if (v13)
  {
    __int16 v14 = objc_msgSend(objc_alloc(MEMORY[0x1E4F2EA98]), "initWithBoolValue:", objc_msgSend(v13, "BOOLValue"));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      __int16 v20 = v18;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unexpected setting type received.", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
- (void)_synchronizeSettingsForAccessoryUUID:(id)a3 homeUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v40 = 2112;
    id v41 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Synchronizing homekit backed siri endpoint settings for accessoryUUID: %@, homeUUID: %@", buf, 0x20u);
  }
  ...
  if (v19)
  {
    ...
    if (v20)
    {
      ...
      v30[1] = 3221225472;
      v30[2] = __84__HMDSiriEndpointSettingsSyncManager__synchronizeSettingsForAccessoryUUID_homeUUID___block_invoke_56;
      v30[3] = &unk_1E6A0F528;
      v30[4] = v10;
      id v31 = v19;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v40 = 2112;
        id v41 = v18;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unable to data source settings manager to sync settings for home: %@, accessory: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      id v41 = v18;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unable to find matching accessory with UUID: %@ in home (%@) to sync settings", buf, 0x20u);
    }
  }
}
...
LABEL_14:
        ...
        if (v16)
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          __int16 v68 = 2112;
          v69 = v22;
          _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Error fetching settings value event for keypath %@, uuid: %@, homeUUID: %@ error: %@", buf, 0x34u);
...
LABEL_13:
        ...
        if (!v27)
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          uint32_t v26 = 52;
LABEL_12:
          _os_log_impl(&dword_1D49D5000, v23, v24, v25, buf, v26);
          goto LABEL_13;
        }
        id v28 = [v12 setting];
        objc_opt_class();
        ...
        if (v30)
        {
          id v31 = objc_msgSend(objc_alloc(MEMORY[0x1E4F2EA98]), "initWithBoolValue:", objc_msgSend(v30, "BOOLValue"));
        }
        else
        {
          id v32 = v28;
          ...
          if (v34)
          {
            id v35 = objc_alloc(MEMORY[0x1E4F2EAB0]);
          ...
          else
          {
            ...
            if (v36)
            {
              id v39 = objc_alloc(MEMORY[0x1E4F2EAA0]);
            ...
            else
            {
              ...
              if (v40)
              {
                id v49 = objc_alloc(MEMORY[0x1E4F2EAA8]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v33 = 2112;
          id v34 = v7;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received accessory reachability notification for unmanaged home %@ accessory %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v33 = 2112;
        id v34 = v4;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize settings after receiving endpoint reachable notification with no home for HAP accessory: %@. %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v4;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize settings after receiving endpoint reachable notification with no HAP accessory. %@", buf, 0x16u);
    }
  }
}
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v33 = 2112;
          id v34 = v7;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received HAPMediaProfileAdded notification for unmanaged home %@ accessory %@", buf, 0x20u);
        }
        os_unfair_lock_unlock(p_lock);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v33 = 2112;
        id v34 = v4;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize settings after receiving HAPMediaProfile notification with no home for HAP accessory: %@. %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v4;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize settings after receiving HAPMediaProfile added notification with no HAP accessory. %@", buf, 0x16u);
    }
  }
}
...
- (void)handleCompositeSettingsControllerDidConfigureNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v31 = v8;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Did handle CompositeSettingsControllerDidConfigure notification", buf, 0xCu);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        __int16 v33 = v13;
        _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Home:%@ not managed", buf, 0x16u);
      }
      os_unfair_lock_unlock(p_lock);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      uint64_t v35 = v13;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Nil hapAccessoryUUID:%@ or homeUUID:%@", buf, 0x20u);
    }
  }
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v28 = 2112;
        id v29 = v4;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize settings after receiving endpoint added notification with no home for HAP accessory: %@. %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v4;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unable to synchronize settings after receiving endpoint added notification with no HAP accessory. %@", buf, 0x16u);
    }
  }
}
...
- (void)handleHomeAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Settings sync manager received home added notification: %@", buf, 0x16u);
  }
...
- (void)handleHomeRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Settings sync manager received home removed notification: %@", buf, 0x16u);
  }
  uint64_t v9 = [v4 userInfo];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v4;
      _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@No home found for home removed notification: %@", buf, 0x16u);
    }
  }
}
...
- (void)handlePrimaryResidentUpdateNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    int v15 = v9;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling %@ notification", buf, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (v10)
    {
      ...
      if (v11)
      {
        ...
        {
          id v59 = 0;
          __int16 v13 = [MEMORY[0x1E4F2E858] decodeSettingFromEvent:v6 error:&v59];
          id v50 = v59;
          if (v13)
          {
            ...
            if (v16)
            {
              ...
              if (v23)
              {
                ...
                v55[1] = 3221225472;
                v55[2] = __60__HMDSiriEndpointSettingsSyncManager_didReceiveEvent_topic___block_invoke_50;
                v55[3] = &unk_1E6A14470;
                id v25 = v19;
                id v56 = v25;
                      ...
                      v28))
                {
                  ...
                  if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    __int16 v66 = 2112;
                    id v67 = v7;
                    _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_ERROR, "%{public}@Unable to find matching siri endpoint enabled accessory in home (%@) for settings update event: %@ topic: %@", buf, 0x2Au);
                  }
                }
                else
                {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v64 = 2112;
                  id v65 = v7;
                  _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Received settings update event: %@ topic: %@ for unmanaged home", buf, 0x20u);
                }
                os_unfair_lock_unlock(p_lock);
              }
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v64 = 2112;
              id v65 = v7;
              _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_DEBUG, "%{public}@Did recieve settings value event for an unwatched keypath. Event: %@ Topic: %@", buf, 0x20u);
            }
          }
          else
          {
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v64 = 2112;
              id v65 = v7;
              _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Nil settings value for settings update event: %@ topic: %@", buf, 0x20u);
            }
          }
...
LABEL_34:
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v64 = 2112;
          id v65 = v7;
          _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Nil accessoryUUID for settings update event: %@ topic: %@", buf, 0x20u);
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v64 = 2112;
          id v65 = v7;
          _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Nil homeUUID for settings update event: %@ topic: %@", buf, 0x20u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v64 = 2112;
        id v65 = v7;
        _os_log_impl(&dword_1D49D5000, v32, OS_LOG_TYPE_ERROR, "%{public}@Nil Keypath for settings update event: %@ topic: %@", buf, 0x20u);
      }
    }
  }
LABEL_35:
...
- (void)_updateManagedHomes
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v59 = v7;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Updating homes for siri endpoint settings sync", buf, 0xCu);
  }
  ...
  __int16 v20 = objc_msgSend(v19, "na_map:", &__block_literal_global_44_109179);
  ...
  id v25 = objc_msgSend(v24, "na_map:", &__block_literal_global_47_109181);
  os_unfair_lock_lock_with_options();
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v64 = 2112;
    id v65 = v22;
    _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Updated homes for siri endpoint setting sync by removing: %@ and adding: %@ to existing homes: %@", buf, 0x2Au);
  }
}
...
void __69__HMDSiriEndpointSettingsSyncManager__stopManagingAccessory_forHome___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Unsubscribed endpoint setting sync manager with result: %@", (uint8_t *)&v8, 0x16u);
  }
}
...
void __70__HMDSiriEndpointSettingsSyncManager__beginManagingAccessory_forHome___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v6;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Subscribed endpoint setting sync manager for changed topics (%@) with result: %@ (%@)", (uint8_t *)&v16, 0x2Au);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_109203 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_109203, &__block_literal_global_29_109204);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_109205;
  return v2;
}
...
uint64_t __49__HMDSiriEndpointSettingsSyncManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_109205;
  logCategory__hmf_once_v1_109205 = v0;
...
+ (NSArray)siriEndPointHomeKitBackedKeyPaths
{
  if (siriEndPointHomeKitBackedKeyPaths_onceToken != -1) {
    dispatch_once(&siriEndPointHomeKitBackedKeyPaths_onceToken, &__block_literal_global_109210);
  }
...
void __71__HMDSiriEndpointSettingsSyncManager_siriEndPointHomeKitBackedKeyPaths__block_invoke()
{
  ...
  uint64_t v1 = (void *)siriEndPointHomeKitBackedKeyPaths_siriEndPointHomeKitBackedKeyPaths;
