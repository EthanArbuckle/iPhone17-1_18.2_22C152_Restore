...
- (id)attributeDescriptions
{
  ...
  v22[4] = v17;
  int v18 = [MEMORY[0x1E4F1C978] arrayWithObjects:v22 count:5];
            ...
            else
            {
              ...
              if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v39 = 2112;
                id v40 = v4;
                _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_ERROR, "%{public}@Could not determine isLast (key=%@) from stream data dictionary: %@", buf, 0x20u);
              }
              uint64_t v14 = 0;
            }
          }
          else
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v39 = 2112;
              id v40 = v4;
              _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Could not determine type (key=%@) from stream data dictionary: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v39 = 2112;
            id v40 = v4;
            _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not determine fragment sequence number (key=%@) from stream data dictionary: %@", buf, 0x20u);
          }
          uint64_t v14 = 0;
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v39 = 2112;
          id v40 = v4;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not determine sequence number (key=%@) from stream data dictionary: %@", buf, 0x20u);
        }
        uint64_t v14 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v39 = 2112;
        id v40 = v4;
        _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not determine metadata (key=%@) from stream data dictionary: %@", buf, 0x20u);
      }
      uint64_t v14 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v39 = 2112;
      id v40 = v4;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Could not determine data (key=%@) from stream data dictionary: %@", buf, 0x20u);
    }
    uint64_t v14 = 0;
  }
...
LABEL_10:
  ...
  {
LABEL_11:
    v27 = (HMDHAPAccessory *)_HMFPreconditionFailure();
    return (HMDDataStreamFragmentChunk *)[(HMDHAPAccessory *)v27 isAssignedHubForSiriEndpoint];
  }
  v29.receiver = self;
