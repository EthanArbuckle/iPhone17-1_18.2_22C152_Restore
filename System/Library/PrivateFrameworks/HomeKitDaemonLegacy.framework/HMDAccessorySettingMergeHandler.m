...
+ (id)_mergeValidValueConstraintsFirst:(id)a3 second:(id)a4 shouldAddMissing:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Valid value constraints: this: %lu, second: %lu", (uint8_t *)&v31, 0x20u);
  }
  if (v5)
  {
    v21 = (void *)MEMORY[0x1D9452090]([v12 unionSet:v16]);
    id v22 = v18;
  ...
  {
    v21 = (void *)MEMORY[0x1D9452090]([v12 intersectSet:v16]);
    id v27 = v18;
    v23 = HMFGetOSLogHandle();
    if (!os_log_type_enabled(v23, OS_LOG_TYPE_INFO)) {
      goto LABEL_9;
  ...
  _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, v26, (uint8_t *)&v31, 0x16u);
  ...
  if (!a4 || !a5 || !a6)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot return result in invalid data", buf, 0xCu);
    }
    goto LABEL_28;
  }
  __int16 v35 = v11;
  ...
  if (!*a4 || !*a5 || !*a6)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v47 = 2112;
      id v48 = v33;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_ERROR, "%{public}@Could not find min %@ or max %@ or step %@", buf, 0x2Au);
    }
LABEL_28:
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Cannot extract min, max and step from this setting's constraints %@", buf, 0x16u);
    }
    if (!v5)
    {
      v60 = 0;
...
LABEL_47:
      _os_log_impl(&dword_1D49D5000, v63, OS_LOG_TYPE_ERROR, v65, buf, 0xCu);
    }
LABEL_48:
    ...
    if (!v81)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Taking min constraint from %@", buf, 0x16u);
      }
      id v81 = v22;
      id v18 = v8;
    }
    if (!v80)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v90 = 2112;
        double v91 = *(double *)&v8;
        _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@Taking max constraint from %@", buf, 0x16u);
      }
      id v80 = v23;
      id v18 = v8;
    }
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Taking step constraint from %@", buf, 0x16u);
      }
      id v12 = v79;
    }
  }
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v89 = v39;
    _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_ERROR, "%{public}@Min, max or step is nil", buf, 0xCu);
...
LABEL_28:
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v94 = 2112;
      v95 = v78;
      _os_log_impl(&dword_1D49D5000, v47, OS_LOG_TYPE_INFO, "%{public}@Chosen min: %@, step: %@, max: %@", buf, 0x2Au);
    ...
    {
      id v67 = v41;
      v68 = (void *)MEMORY[0x1D9452090](v51);
      id v69 = v46;
...
LABEL_58:
        _os_log_impl(&dword_1D49D5000, v70, OS_LOG_TYPE_ERROR, v72, buf, 0x16u);
      }
    }
    else
    {
      v54 = [NSNumber numberWithDouble:v53];
      BOOL v55 = compareCharacteristicValue(v76, v54, (void *)1, &unk_1F2DCB9A8);

      id v23 = v74;
      if (v55)
      {
        v56 = (void *)[objc_alloc(MEMORY[0x1E4F2E5E8]) initWithType:1 value:v41];
        v57 = v73;
        [v73 addObject:v56];

        v58 = (void *)[objc_alloc(MEMORY[0x1E4F2E5E8]) initWithType:3 value:v76];
        [v73 addObject:v58];

        id v18 = v8;
        v59 = (void *)[objc_alloc(MEMORY[0x1E4F2E5E8]) initWithType:2 value:v78];
        [v73 addObject:v59];
...
+ (BOOL)_isNumber:(id)a3 betweenStart:(id)a4 andEnd:(id)a5 first:(id)a6
{
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Given value is nil, cannot determine whether within the range", (uint8_t *)&v19, 0xCu);
    }
    goto LABEL_10;
  }
  ...
  if (v19)
  {
    ...
    if (!v20 || !v92 || !v91)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v97 = v40;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Min, max or step is nil", buf, 0xCu);
...
LABEL_80:
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      {
        id v32 = off_1E6A09C90[v31];
      }
      *(_DWORD *)buf = 138543618;
      v97 = v29;
      __int16 v98 = 2112;
      v99 = v32;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Merge strategy is %@", buf, 0x16u);
    ...
    if (v41 == 4)
    {
      ...
      if (v62 && v63)
      {
        if (v65)
        {
          ...
          *(_DWORD *)buf = 138543362;
          v97 = v66;
          _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Current values are within the merged range", buf, 0xCu);
        }
        id v87 = v18;
        ...
        if (v67 != -1)
        {
          if (v71)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v98 = 2112;
            v99 = v90;
            _os_log_impl(&dword_1D49D5000, v70, OS_LOG_TYPE_INFO, "%{public}@Retaining current value %@", buf, 0x16u);
          }
          long long v38 = v90;
          id v18 = v87;
          goto LABEL_80;
        ...
        if (v71)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v98 = 2112;
          v99 = v87;
          _os_log_impl(&dword_1D49D5000, v70, OS_LOG_TYPE_INFO, "%{public}@Choosing second setting's value %@", buf, 0x16u);
        }
        id v18 = v87;
        goto LABEL_71;
      }
...
LABEL_52:
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v98 = 2112;
          v99 = v90;
          _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Only current value %@ is within the merged range", buf, 0x16u);
        }
LABEL_53:
...
LABEL_78:
      ...
      if (!v63)
      {
        if (v65)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v98 = 2112;
          v99 = v92;
          _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Neither of the values are within the merged range, choosing the max %@", buf, 0x16u);
        }
        v75 = v92;
        goto LABEL_78;
      }
      ...
      if (v41 == 1)
      {
        ...
        if (v38)
        {
          if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v98 = 2112;
            v99 = v38;
            _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_INFO, "%{public}@Using the conflict value %@ as a merged value", buf, 0x16u);
        ...
        else
        {
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v97 = v76;
            _os_log_impl(&dword_1D49D5000, v45, OS_LOG_TYPE_ERROR, "%{public}@Cannot find the conflict value", buf, 0xCu);
    ...
    double v50 = (void *)MEMORY[0x1D9452090]();
    id v51 = v22;
    double v52 = HMFGetOSLogHandle();
    ...
    if (v48 && v49)
    {
      ...
      if (v56 == -1)
      {
        if (v60)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v98 = 2112;
          v99 = v90;
          _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_INFO, "%{public}@Retaining current value %@", buf, 0x16u);
        }
        long long v38 = v90;
        id v18 = v55;
        goto LABEL_80;
      ...
      if (v60)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v98 = 2112;
        v99 = v55;
        _os_log_impl(&dword_1D49D5000, v59, OS_LOG_TYPE_INFO, "%{public}@Choosing second setting's value %@", buf, 0x16u);
      }
      id v18 = v55;
      goto LABEL_71;
    }
...
LABEL_63:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v98 = 2112;
        v99 = v18;
        _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Only second setting's value %@ is within the merged range", buf, 0x16u);
      }
LABEL_64:
...
LABEL_79:
    ...
    if (v53)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v98 = 2112;
      v99 = v89;
      _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Neither of the values are within the merged range, choosing the min %@", buf, 0x16u);
    }
    v20 = v89;
    long long v38 = v89;
  }
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v98 = 2112;
      v99 = v12;
      _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@Cannot extract min, max and step from merged constraints %@", buf, 0x16u);
  ...
  if (v15 != [v11 type])
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v199 = 2112;
      id v200 = v30;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Value types are not matching: self %@, second %@", buf, 0x20u);
      ...
      case 3:
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v197 = 2112;
          id v198 = v45;
          _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_INFO, "%{public}@Setting type is %@, keeping the values", buf, 0x16u);
        ...
        if (v46)
        {
          ...
          if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v199 = 2112;
            id v200 = v53;
            _os_log_impl(&dword_1D49D5000, v56, OS_LOG_TYPE_INFO, "%{public}@Comparing the values: self %@, second %@", buf, 0x20u);
          }
          id obj = v53;
          v181 = v50;
          if ((HMFEqualObjects() & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              id v196 = v61;
              _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_INFO, "%{public}@Values are not matching, going to compute the value", buf, 0xCu);
            }
            ...
            if (!v62)
            {
              ...
              if (os_log_type_enabled(v161, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                id v196 = v162;
                _os_log_impl(&dword_1D49D5000, v161, OS_LOG_TYPE_ERROR, "%{public}@Cannot come up with the merged value", buf, 0xCu);
              }
              BOOL v31 = 0;
              id v14 = v170;
              id v13 = v185;
            ...
            if ((v65 & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v199 = 2112;
                id v200 = v63;
                _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_INFO, "%{public}@Updating the value from %@ to %@", buf, 0x20u);
          ...
          BOOL v71 = objc_msgSend(MEMORY[0x1E4F1CAD0], "setWithArray:");
          ...
          else
          {
            ...
            if (os_log_type_enabled(v127, OS_LOG_TYPE_INFO))
            {
              ...
              v128 = [MEMORY[0x1E4F1CAD0] setWithArray:v46];
              v169 = v125;
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v201 = 2112;
              v202 = v133;
              _os_log_impl(&dword_1D49D5000, v127, OS_LOG_TYPE_INFO, "%{public}@Numerical Constraints are not matching (merged: %@) (first: %@), (second: %@) updating the constraints", buf, 0x2Au);
...
LABEL_103:
        ...
        if (os_log_type_enabled(v119, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v196 = v120;
          _os_log_impl(&dword_1D49D5000, v119, OS_LOG_TYPE_ERROR, "%{public}@Merged constraints is invalid, cannot merge this setting", buf, 0xCu);
        }
        BOOL v31 = 0;
        id v13 = v185;
LABEL_104:
      ...
      case 4:
        ...
        if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v197 = 2112;
          id v198 = v76;
          _os_log_impl(&dword_1D49D5000, v79, OS_LOG_TYPE_INFO, "%{public}@Setting type is selection, merged constraints: %@", buf, 0x16u);
        }
...
LABEL_66:
              ...
              if (os_log_type_enabled(v108, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                id v196 = v109;
                _os_log_impl(&dword_1D49D5000, v108, OS_LOG_TYPE_INFO, "%{public}@Did not find first's selection in merged list", buf, 0xCu);
              }
              v164 = v107;
...
LABEL_87:
                ...
                if (os_log_type_enabled(v136, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  id v196 = v137;
                  _os_log_impl(&dword_1D49D5000, v136, OS_LOG_TYPE_INFO, "%{public}@Did not find second's selection in merged list, updating the selected value to nil", buf, 0xCu);
                }
                uint64_t v105 = 0;
              }
LABEL_90:
              ...
              if ((v140 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v143, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v199 = 2112;
                  id v200 = v176;
                  _os_log_impl(&dword_1D49D5000, v143, OS_LOG_TYPE_INFO, "%{public}@Updating the value from %@ to %@", buf, 0x20u);
              ...
              v146 = [MEMORY[0x1E4F1CAD0] setWithArray:obja];
              ...
              if ((v150 & 1) == 0)
              {
                ...
                if (os_log_type_enabled(v154, OS_LOG_TYPE_INFO))
                {
                  ...
                  [MEMORY[0x1E4F1CAD0] setWithArray:obja];
                  v156 = v184 = v152;
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v199 = 2112;
                  id v200 = v158;
                  _os_log_impl(&dword_1D49D5000, v154, OS_LOG_TYPE_INFO, "%{public}@Selection Constraints are not matching (merged: %@) (first: %@), updating the constraints", buf, 0x20u);
        ...
        if (os_log_type_enabled(v123, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v196 = v124;
          _os_log_impl(&dword_1D49D5000, v123, OS_LOG_TYPE_ERROR, "%{public}@There are no elements in the intersection of selection list", buf, 0xCu);
        }
LABEL_99:
        id v13 = v185;
      ...
      case 5:
          ...
          && [v11 isConstraintMergeStrategyReflection])
        {
          ...
          if (os_log_type_enabled(v91, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            __int16 v203 = 2112;
            v204 = v94;
            _os_log_impl(&dword_1D49D5000, v91, OS_LOG_TYPE_DEBUG, "%{public}@merge constraints first: %@, %@, second: %@, %@", buf, 0x34u);
        ...
        else
        {
          ...
          uint64_t v100 = (void *)MEMORY[0x1D9452090]();
          id v101 = v10;
          ...
          if (os_log_type_enabled(v102, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v197 = 2112;
            id v198 = v104;
            _os_log_impl(&dword_1D49D5000, v102, OS_LOG_TYPE_INFO, "%{public}@Updating constraints to %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v199 = 2112;
      id v200 = v39;
      _os_log_impl(&dword_1D49D5000, v34, OS_LOG_TYPE_INFO, "%{public}@Setting names are not matching: self %@, second %@", buf, 0x20u);
