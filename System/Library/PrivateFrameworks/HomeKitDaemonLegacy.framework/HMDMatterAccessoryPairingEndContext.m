...
+ (id)hmmtrContextWithStep:(unint64_t)a3 error:(id)a4
{
  ...
  v8 = [(HMDMatterAccessoryPairingEndContext *)v6 initWithStep:v7 error:v5 sourceErrorDomain:*MEMORY[0x1E4F6A000] isCancelled:0];
...
+ (id)hmContextWithCancelledError:(id)a3
{
  ...
  id v5 = [(HMDMatterAccessoryPairingEndContext *)v4 initWithStep:0 error:v3 sourceErrorDomain:*MEMORY[0x1E4F2D140] isCancelled:1];
...
+ (id)pairingCompletedContext
{
  v2 = [[HMDMatterAccessoryPairingEndContext alloc] initWithStep:&unk_1F2DC7FC0 error:0 sourceErrorDomain:0 isCancelled:0];
  return v2;
}
