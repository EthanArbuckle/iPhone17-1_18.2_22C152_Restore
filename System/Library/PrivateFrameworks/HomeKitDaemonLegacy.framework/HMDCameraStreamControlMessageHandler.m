...
void __65__HMDCameraStreamControlMessageHandler_handleProcessStateChange___block_invoke(uint64_t a1)
{
    ...
    && [*(id *)(a1 + 32) _shouldStopStreamSessionForProcessInfo:*(void *)(a1 + 40)])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Stopping stream because client is no longer in foreground", (uint8_t *)&v12, 0xCu);
    }
    id v10 = *(void **)(a1 + 32);
    v11 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1048];
...
{
  v4 = [a3 userInfo];
  int v5 = [v4 objectForKeyedSubscript:@"connection"];
...
void __80__HMDCameraStreamControlMessageHandler_handleConnectionDeactivatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      int v12 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping stream because client has deactivated", (uint8_t *)&v11, 0xCu);
    }
    v9 = *(void **)(a1 + 32);
    id v10 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1048];
...
void __82__HMDCameraStreamControlMessageHandler_handleCameraSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      uint64_t v13 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Camera profile settings are not initialized, skipping cancelling pending stream requests", (uint8_t *)&v12, 0xCu);
    }
  }
}
...
- (void)_resetStreamSession:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Resetting the current stream session with error: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)_sendStreamStoppedRemoteNotificationWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v31 = 2112;
    v32 = v10;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending stream stopped notification to %@", (uint8_t *)&v29, 0x16u);
  }
  ...
  if (v13)
  {
    ...
    if (v4)
    {
      v18 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:0];
      [v14 setObject:v18 forKeyedSubscript:@"kCameraSessionError"];
    }
    v19 = [MEMORY[0x1E4F654B0] internalMessageWithName:@"kStreamStoppedRemoteNotificationKey" messagePayload:v14];
    ...
    [v13 sendSecureMessage:v20 target:v21 userID:0 destination:v23 responseQueue:v24 responseHandler:&__block_literal_global_69];
  }
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      int v29 = 138543362;
      v30 = v28;
      _os_log_impl(&dword_1D49D5000, v27, OS_LOG_TYPE_INFO, "%{public}@No home manager", (uint8_t *)&v29, 0xCu);
    }
  }
}
...
- (void)_sendStreamStoppedMessageWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v4)
    {
      char v9 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:0];
    ...
    id v16 = [MEMORY[0x1E4F654B0] messageWithName:*MEMORY[0x1E4F2CD58] destination:v15 payload:v7];
    uint64_t v17 = (void *)MEMORY[0x1D9452090]([v16 setTransport:v6]);
    v18 = self;
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      v32 = v6;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Notifying client that stream has stopped using message %@: %@", (uint8_t *)&v27, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      v28 = v26;
      _os_log_impl(&dword_1D49D5000, v25, OS_LOG_TYPE_ERROR, "%{public}@Cannot send stream stopped message because XPC client connection doesn't exist", (uint8_t *)&v27, 0xCu);
    }
  }
}
...
- (void)streamControlManager:(id)a3 didStopStreamWithSessionID:(id)a4 error:(id)a5
{
  ...
  if (v13)
  {
    if (v17)
    {
      ...
      __int16 v41 = 2114;
      id v42 = v10;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Stream did stop with error: %{public}@", (uint8_t *)&v39, 0x16u);
    }
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v41 = 2112;
        id v42 = v25;
        _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_INFO, "%{public}@Responding to the current message: %@", (uint8_t *)&v39, 0x16u);
      }
      if (v10)
      {
      ...
      {
        __int16 v29 = [MEMORY[0x1E4F28C58] hmErrorWithCode:23];
    ...
    if (v32)
    {
      if (v36)
      {
        ...
        int v39 = 138543362;
        v40 = v37;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@This is a stream being relayed elsewhere so sending remote stream stopped message", (uint8_t *)&v39, 0xCu);
      }
    ...
    else
    {
      if (v36)
      {
        ...
        int v39 = 138543362;
        v40 = v38;
        _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@This is a stream being shown locally so sending local stream stopped message", (uint8_t *)&v39, 0xCu);
      }
  ...
  else
  {
    if (v17)
    {
      ...
      __int16 v43 = 2112;
      v44 = v28;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_INFO, "%{public}@Ignoring did stop stream callback for session ID %@ because our session ID is %@", (uint8_t *)&v39, 0x20u);
    }
  }
}
  ...
  if (v6 == v4)
  {
    ...
    if (v10)
    {
      if (v14)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v39 = 2112;
        v40 = v20;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Responding to %@ with identifier %@", buf, 0x20u);
      }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          BOOL v36 = v31;
          _os_log_impl(&dword_1D49D5000, v30, OS_LOG_TYPE_INFO, "%{public}@No response handler set for message", buf, 0xCu);
        }
      }
    ...
    else
    {
      if (v14)
      {
        ...
        *(_DWORD *)buf = 138543362;
        BOOL v36 = v27;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@No pending reconfigure stream request", buf, 0xCu);
      }
    }
  }
}
...
- (void)streamControlManagerDidReceiveFirstFrame:(id)a3
{
  ...
  id v9 = [v8 name];
  char v10 = [v9 isEqualToString:*MEMORY[0x1E4F2CD38]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      v24 = v20;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Received did receive first frame with an unexpected current message: %@", (uint8_t *)&v21, 0x16u);
    }
  }
}
...
- (void)streamControlManagerDidStartStream:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    {
      BOOL v17 = [v16 name];
      char v18 = [v17 isEqualToString:*MEMORY[0x1E4F2CD38]];
...
LABEL_17:
      ...
      if (v20)
      {
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v36 = 2112;
          __int16 v37 = v26;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Handling did start stream callback by responding to remote start stream message: %@", (uint8_t *)&v34, 0x16u);
        }
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v36 = 2112;
        __int16 v37 = v33;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpected current message while handling did start stream callback: %@", (uint8_t *)&v34, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        int v34 = 138543362;
        v35 = v32;
        _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Received did start stream without a current message", (uint8_t *)&v34, 0xCu);
LABEL_15:
      }
    }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v38 = 2112;
    id v39 = v4;
    _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring did start stream because our stream control manager %@ does not match the provided one: %@", (uint8_t *)&v34, 0x20u);
  }
LABEL_18:
}
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      __int16 v43 = v20;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending stream remote setup notification to %@", buf, 0x16u);
    }
    ...
    if (v23)
    {
      ...
      v26 = [v25 sessionID];
      id v39 = v26;
      int v27 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v39 forKeys:&v38 count:1];

      v28 = [MEMORY[0x1E4F654B0] internalMessageWithName:@"kStreamRemoteConnectionSetupNotificationKey" messagePayload:v27];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v41 = v37;
        _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@No home manager", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      id v45 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring did set up remote connection because our stream control manager %@ does not match the provided one: %@", buf, 0x20u);
    }
  }
}
...
- (void)streamControlManager:(id)a3 didNegotiateStreamWithSelectedParameters:(id)a4
{
  ...
  if (v9 == v6)
  {
    ...
    {
      int v20 = [v19 name];
      int v21 = [v20 isEqualToString:*MEMORY[0x1E4F2CD38]];
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          int v37 = 138543362;
          uint64_t v38 = v25;
          _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Handling did negotiate stream callback by starting stream", (uint8_t *)&v37, 0xCu);
        }
      ...
      if (v31)
      {
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v39 = 2112;
          uint64_t v40 = v34;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Handling did negotiate stream callback by responding to remote negotiate stream message: %@", (uint8_t *)&v37, 0x16u);
        }
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v39 = 2112;
        uint64_t v40 = v36;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unexpected current message while handling did negotiate stream callback: %@", (uint8_t *)&v37, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        int v37 = 138543362;
        uint64_t v38 = v29;
        _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Received did negotiate stream without a current message", (uint8_t *)&v37, 0xCu);
LABEL_18:
      }
    }
...
LABEL_20:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v41 = 2112;
    id v42 = v6;
    _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring did negotiate stream because our stream control manager %@ does not match the provided one: %@", (uint8_t *)&v37, 0x20u);
  }
LABEL_21:
}
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      BOOL v14 = v11;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Stream setup timer fired", (uint8_t *)&v13, 0xCu);
    }
    int v12 = [MEMORY[0x1E4F28C58] hmErrorWithCode:8];
...
- (void)_respondToLocalNegotiateStreamMessage:(id)a3
{
  ...
  [v6 setObject:v10 forKeyedSubscript:*MEMORY[0x1E4F2E028]];
  ...
  [v6 setObject:v17 forKeyedSubscript:*MEMORY[0x1E4F2E160]];
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    __int16 v29 = v6;
    _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Responding to message %@ with payload %@", (uint8_t *)&v24, 0x20u);
  }
  ...
  if (v4)
  {
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v15 = 2112;
        id v16 = v4;
        _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating activity attribution with applicationBundleIdentifier: %@", (uint8_t *)&v13, 0x16u);
      }
...
- (void)_handleSetAudioState:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v39 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Missing parameter to set the audio stream state", buf, 0xCu);
    }
    char v18 = (void *)v14;
    goto LABEL_16;
  }
    ...
    if (v8 == 3)
    {
      if ([v4 isAuthorizedForMicrophoneAccess])
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v39 = v24;
          _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Bi-directional audio is not supported on this device for camera streaming.", buf, 0xCu);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Denying incoming message %@ for client pid %ld since the process is not authorized for microphone access", buf, 0x20u);
        }
        uint64_t v25 = (void *)MEMORY[0x1E4F28C58];
        uint64_t v26 = 89;
      }
LABEL_17:
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2048;
      uint64_t v41 = v9;
      _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Invalid audio stream setting: %lu", buf, 0x16u);
    }
    char v18 = (void *)v27;
LABEL_16:
    uint64_t v25 = (void *)MEMORY[0x1E4F28C58];
...
LABEL_3:
  ...
  int v37 = v12;
  int v13 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:&v37 forKeys:&v36 count:1];
...
- (void)setAudioVolume:(id)a3 callback:(id)a4
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v27 = v17;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Changing audio volume setting is not allowed on this device", buf, 0xCu);
    }
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v27 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing parameter to set the audio stream state", buf, 0xCu);
    }
    char v18 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v19 = 3;
LABEL_10:
...
void __64__HMDCameraStreamControlMessageHandler_setAudioVolume_callback___block_invoke(uint64_t a1, char a2)
{
  ...
  {
    id v5 = [MEMORY[0x1E4F28C58] hmErrorWithCode:43];
...
- (void)_handleSetAudioVolume:(id)a3
{
  ...
  {
    id v6 = [v4 numberForKey:*MEMORY[0x1E4F2CD30]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v14 = v10;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Ignoring set audio volume message as it is not entitled for SPI access", buf, 0xCu);
    }
...
- (void)_handleStopMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    int v21 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling stop message with identifier: %@", (uint8_t *)&v18, 0x16u);
  }
...
- (void)_handleUpdateMaximumVideoResolutionQualityMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update video resolution quality message with identifier: %@", buf, 0x16u);
  }
  int v11 = [v4 messagePayload];
  id v12 = objc_msgSend(v11, "hmf_numberForKey:", *MEMORY[0x1E4F2CD68]);
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v30 = v19;
      _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Missing camera video resolution quality", buf, 0xCu);
    }
  ...
  if ((unint64_t)(v13 - 1) >= 5)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2048;
      uint64_t v32 = v13;
      _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_ERROR, "%{public}@Invalid resolution quality enum value received: %ld", buf, 0x16u);
    }
    __int16 v20 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v21 = 3;
LABEL_12:
...
void __90__HMDCameraStreamControlMessageHandler__handleUpdateMaximumVideoResolutionQualityMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v10 = 138543362;
      int v11 = v8;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to update video resolution quality", (uint8_t *)&v10, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      int v11 = v9;
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Successfuly updated video resolution quality", (uint8_t *)&v10, 0xCu);
    }
...
- (void)_handleReconfigureMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    int v18 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling reconfigure message with identifier: %@", (uint8_t *)&v15, 0x16u);
  }
...
- (void)_handleStartMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v10;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling start message with identifier: %@", (uint8_t *)&v19, 0x16u);
  }
...
- (void)_handleRemoteSetupMessage:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      int v24 = v6;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling remote setup message %@ from device: %@", (uint8_t *)&v19, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find remote source device for remote setup message: %@", (uint8_t *)&v19, 0x16u);
    }
    int v18 = [MEMORY[0x1E4F28C58] hmErrorWithCode:-1];
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v143 = 2112;
      id v144 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Handling negotiation message: %@", buf, 0x20u);
    }
    ...
    if ([(HMDCameraStreamControlMessageHandler *)v8 _shouldHandleNegotiateMessage:v4 accessoryReachable:v14])
    {
        ...
        if ((HMIsStreamingAllowedForCameraAccessMode() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v143 = 2112;
            id v144 = v22;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@[%@] Streaming is disallowed for current access mode: %@", buf, 0x20u);
          }
          __int16 v23 = [MEMORY[0x1E4F28C58] hmErrorWithCode:10];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v141 = 2112;
          v142 = v6;
          _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Camera profile settings are not initialized; skipping controller side checks to disallow stream request",
            buf,
            0x16u);
        }
      }
      ...
      {
        id v138 = 0;
        uint64_t v31 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v30 error:&v138];
        id v32 = v138;
        if (!v31)
        {
          v128 = v30;
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v143 = 2112;
            id v144 = v32;
            _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to unarchive camera stream preferences from camera session preference message: %@", buf, 0x20u);
          }
          uint64_t v30 = v128;
          uint64_t v31 = 0;
        }
      ...
      if ((v38 & 1) == 0 && !v41)
      {
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v143 = 2112;
          id v144 = v4;
          _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot find XPC client connection for negotiate stream message received over XPC: %@", buf, 0x20u);
        }
        uint64_t v46 = [MEMORY[0x1E4F28C58] hmErrorWithCode:58];
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v143 = 2112;
        id v144 = v49;
        _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@[%@] Using stream client process info: %@", buf, 0x20u);
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v141 = 2112;
          v142 = v131;
          _os_log_impl(&dword_1D49D5000, v66, OS_LOG_TYPE_INFO, "%{public}@[%@] Creating local stream control manager because accessory is reachable", buf, 0x16u);
        }
...
LABEL_44:
          ...
          else
          {
            ...
            if (os_log_type_enabled(v109, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v143 = 2112;
              id v144 = v110;
              _os_log_impl(&dword_1D49D5000, v109, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot start stream session: %@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v117, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v141 = 2112;
          v142 = v131;
          _os_log_impl(&dword_1D49D5000, v117, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to get the local network address config", buf, 0x16u);
      ...
      else
      {
        ...
        if (v83 == 1)
        {
          ...
          if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v141 = 2112;
            v142 = v131;
            _os_log_impl(&dword_1D49D5000, v87, OS_LOG_TYPE_INFO, "%{public}@[%@] Creating remote stream control manager because accessory is not reachable", buf, 0x16u);
          }
        ...
        if (os_log_type_enabled(v86, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v141 = 2112;
          v142 = v131;
          _os_log_impl(&dword_1D49D5000, v87, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot create stream because accessory is unreachable and there is no reachable remote access device", buf, 0x16u);
        }
        v113 = (void *)MEMORY[0x1E4F28C58];
        uint64_t v114 = 4;
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v141 = 2112;
      v142 = v25;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find session ID in negotiate message payload: %@", buf, 0x16u);
    }
...
LABEL_10:
          _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, v16, (uint8_t *)&v23, 0xCu);
  ...
  if (v6 && v8 && v6 != v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v39 = 2112;
      __int16 v40 = v8;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Rejecting stream control request message %@ from client %@ because stream is owned by other client %@", buf, 0x2Au);
    }
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v37 = 2112;
        char v38 = v26;
        _os_log_impl(&dword_1D49D5000, v21, OS_LOG_TYPE_ERROR, "%{public}@Current message %@ is already being processed, rejecting message %@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v35 = 2112;
        uint64_t v36 = v31;
        _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unknown message type %@", buf, 0x16u);
      }
      uint64_t v14 = (void *)MEMORY[0x1E4F28C58];
      uint64_t v15 = 2;
    }
...
- (void)_stopStreamWithError:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v4;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failing stream session %@: %@", (uint8_t *)&v18, 0x20u);
    }
    ...
    if (v4)
    {
      id v16 = [MEMORY[0x1E4F28DB0] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:0];
      [v12 setObject:v16 forKeyedSubscript:@"kCameraSessionError"];
    }
    __int16 v17 = [MEMORY[0x1E4F65480] messageWithName:*MEMORY[0x1E4F2CD50] messagePayload:v12];
  ...
  if (v9)
  {
    ...
    if (v11 != v9)
    {
      if (v15)
      {
        ...
        __int16 v48 = 2112;
        v49 = v9;
        _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Taking ownership of stream using client connection: %@", (uint8_t *)&v46, 0x16u);
      }
      ...
      if (v18)
      {
        if (([(id)objc_opt_class() _isNegotiateMessage:v18] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
          {
            ...
            __int16 v48 = 2112;
            v49 = v45;
            _os_log_impl(&dword_1D49D5000, v43, OS_LOG_TYPE_ERROR, "%{public}@Cannot take ownership of stream because stream is handling a non-negotiate message: %@", (uint8_t *)&v46, 0x16u);
          }
          __int16 v40 = [MEMORY[0x1E4F28C58] hmErrorWithCode:48];
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v48 = 2112;
          v49 = v24;
          _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Responding to existing negotiate message: %@", (uint8_t *)&v46, 0x16u);
        }
        uint64_t v25 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1049];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v48 = 2112;
          v49 = v38;
          _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Notifying existing stream client that stream has stopped and responding to new stream client message: %@", (uint8_t *)&v46, 0x16u);
        }
        __int16 v39 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1049];
...
LABEL_26:
    ...
    if (v15)
    {
      ...
      int v46 = 138543362;
      v47 = v33;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@Client requested to start a stream while it already owns one", (uint8_t *)&v46, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v48 = 2112;
      v49 = v30;
      _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot find XPC client connection while taking ownership of stream using message: %@", (uint8_t *)&v46, 0x16u);
    }
    uint64_t v31 = (void *)MEMORY[0x1E4F28C58];
    uint64_t v32 = 58;
  }
...
void __47__HMDCameraStreamControlMessageHandler_dealloc__block_invoke(uint64_t a1)
{
  ...
  v1 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1039];
...
- (HMDCameraStreamControlMessageHandler)initWithWorkQueue:(id)a3 streamSnapshotHandler:(id)a4 accessory:(id)a5 streamManagementService:(id)a6 profileUniqueIdentifier:(id)a7 networkMonitor:(id)a8 residentMessageHandler:(id)a9 dataSource:(id)a10
{
  ...
  if (v21)
  {
    ...
    uint64_t v26 = (void *)MEMORY[0x1E4F29128];
    v41[0] = v25;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t43 != -1) {
    dispatch_once(&logCategory__hmf_once_t43, &__block_literal_global_60102);
  }
  id v2 = (void *)logCategory__hmf_once_v44;
  return v2;
}
...
uint64_t __51__HMDCameraStreamControlMessageHandler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v44;
  logCategory__hmf_once_uint64_t v44 = v0;
...
{
  id v3 = [a3 name];
  char v4 = [v3 isEqualToString:*MEMORY[0x1E4F2CD48]];
...
{
  id v3 = [a3 name];
  char v4 = [v3 isEqualToString:*MEMORY[0x1E4F2CD40]];
...
+ (BOOL)_isStopMessage:(id)a3
{
  id v3 = a3;
  char v4 = [v3 name];
  if ([v4 isEqualToString:*MEMORY[0x1E4F2CD50]])
  {
    char v5 = 1;
  }
  else
...
{
  id v3 = [a3 name];
  char v4 = [v3 isEqualToString:*MEMORY[0x1E4F2CD60]];
...
+ (BOOL)_isNegotiateMessage:(id)a3
{
  ...
  {
    objc_super v6 = [v3 name];
    char v5 = [v6 isEqualToString:*MEMORY[0x1E4F2CD38]];
  }
  return v5;
}
