...
LABEL_18:
  ...
  {
    [v7 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:@"allowInterAccessoryConnections"];
  }
  if ([(HMDNetworkRouterFirewallRuleLAN *)self isRequiredForHAPFunctionality]) {
    [v7 setObject:MEMORY[0x1E4F1CC38] forKeyedSubscript:@"requiredForHAPFunctionality"];
  }
  v16 = (void *)[v7 copy];
...
+ (id)createWithJSONDictionary:(id)a3 name:(id)a4 critical:(BOOL)a5 purpose:(unint64_t)a6 allowInterAccessoryConnections:(BOOL)a7 direction:(unsigned __int8)a8 requiredForHAPFunctionality:(BOOL)a9 ruleDictionary:(id)a10 error:(id *)a11
{
  ...
  id v14 = a4;
  id v15 = a10;
  objc_super v16 = (void *)MEMORY[0x1E4F1CA00];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v30 = 2112;
        id v31 = v6;
        _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid '%@' value: %@", buf, 0x20u);
      }
      if (a4)
      {
        [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
...
LABEL_10:
    ...
    objc_super v18 = (void *)MEMORY[0x1D9452090]();
    id v19 = a1;
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v30 = 2112;
      id v31 = v10;
      _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Rule contains an unknown '%@' value %@: %@", buf, 0x2Au);
    }
    if (a6)
    {
      objc_super v16 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1070];
      goto LABEL_8;
    }
LABEL_16:
    BOOL v17 = 0;
  ...
  objc_super v16 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3];
LABEL_8:
  BOOL v17 = 0;
  *a6 = v16;
LABEL_17:
  ...
  if (v12 != 1)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v27 = 2112;
      id v28 = v8;
      _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Rule contains an unknown '%@' value %@: %@", buf, 0x2Au);
    }
    if (a5)
    {
      id v14 = [MEMORY[0x1E4F28C58] hmInternalErrorWithCode:1070];
      goto LABEL_12;
    }
    goto LABEL_13;
  }
