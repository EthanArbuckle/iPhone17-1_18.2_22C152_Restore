...
LABEL_6:
      _os_log_impl(&dword_1D49D5000, v15, v16, v14, (uint8_t *)&v17, 0x20u);
    }
  }
...
- (void)__unregisterActivity
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    v11 = v7;
    _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_INFO, "%{public}@Unregistering activity '%@'", (uint8_t *)&v8, 0x16u);
  }
...
- (void)__runActivity:(id)a3
{
  ...
  if (xpc_activity_should_defer((xpc_activity_t)v4))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      v26 = v5;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' was ready to run but it should be deferred", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (v10)
    {
      v11 = (void *)MEMORY[0x1D9452090]([(HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler *)self __transitionActivity:v4 state:4]);
      uint64_t v12 = self;
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Activity '%@' running", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' was ready to run but delegate has died", buf, 0x16u);
      }
...
void __84__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler___runActivity___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' completion handler called with error: %@", (uint8_t *)&v22, 0x20u);
    }
    [v6 setRunningActivity:0];
    xpc_object_t v10 = xpc_activity_copy_criteria(*(xpc_activity_t *)(a1 + 40));
    v11 = (const char *)*MEMORY[0x1E4F141C8];
    int64_t int64 = xpc_dictionary_get_int64(v10, (const char *)*MEMORY[0x1E4F141C8]);
    if (v3) {
      [v6 retryInterval];
    }
    else {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      uint64_t v27 = (uint64_t)v3;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' completion handler called after scheduler has died with error: %@", (uint8_t *)&v22, 0x20u);
    }
    if (!xpc_activity_set_state(*(xpc_activity_t *)(a1 + 40), 5))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v26 = 2048;
        uint64_t v27 = 5;
        _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' failed to transition to state %ld", (uint8_t *)&v22, 0x20u);
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v31 = 2112;
      v32 = v6;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' resurrected with criteria: %@", buf, 0x20u);
    }
  }
  else
  {
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v31 = 2112;
        v32 = v18;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' applying override criteria: %@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v31 = 2112;
      v32 = v6;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_INFO, "%{public}@Activity '%@' created for the first time with criteria: %@", buf, 0x20u);
    }
    xpc_activity_set_criteria(v4, v6);
  }
  self->_currentInterval = (double)xpc_dictionary_get_int64(v6, (const char *)*MEMORY[0x1E4F141C8]);
}
...
- (void)__registerActivity
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    v18 = v3;
    _os_log_impl(&dword_1D49D5000, v6, OS_LOG_TYPE_INFO, "%{public}@Registering activity '%@'", buf, 0x16u);
  }
  ...
  xpc_object_t v10 = (void *)*MEMORY[0x1E4F14158];
  id v11 = v8;
  id v13 = v11;
...
void __88__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler___registerActivity__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v10;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' handler ran after scheduler has died", (uint8_t *)&v14, 0x16u);
    }
    goto LABEL_11;
  }
  ...
  if (state)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Activity %@ callback with unhandled state: %ld", (uint8_t *)&v14, 0x20u);
    }
LABEL_11:
...
- (id)__initialCriteria
{
  ...
  id v4 = (const char *)*MEMORY[0x1E4F141C8];
  ...
  xpc_dictionary_set_string(v3, (const char *)*MEMORY[0x1E4F14270], (const char *)*MEMORY[0x1E4F14278]);
  xpc_dictionary_set_BOOL(v3, (const char *)*MEMORY[0x1E4F14138], 1);
  xpc_dictionary_set_int64(v3, (const char *)*MEMORY[0x1E4F141A0], *MEMORY[0x1E4F14200]);
...
- (void)dealloc
{
  ...
  if (self->_running)
  {
    xpc_object_t v3 = (void *)MEMORY[0x1D9452090]();
    uint64_t v4 = self;
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_1D49D5000, v5, OS_LOG_TYPE_ERROR, "%{public}@Scheduler dying while activity '%@' was still active", buf, 0x16u);
    }
    objc_msgSend((id)objc_opt_class(), "__unregisterActivity:", v4->_identifier);
  }
  v8.receiver = self;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_114794 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_114794, &__block_literal_global_114795);
  }
  v2 = (void *)logCategory__hmf_once_v1_114796;
  return v2;
}
...
uint64_t __81__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudFetchScheduler_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v1_114796;
  logCategory__hmf_once_v1_114796 = v0;
