...
- (void)_invalidateXpcClient:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_INFO, "%{public}@Found invalidated connection %@ will de-register.", (uint8_t *)&v12, 0x16u);
    }
        ...
        if ([v16 isEqualToString:v6])
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v37 = 2112;
            uint64_t v38 = v14;
            _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Deregistering connection %@ from container %@.", buf, 0x20u);
          ...
          if (v15 && ([v15 isEqual:v38] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v52 = 2112;
              uint64_t v53 = v13;
              _os_log_impl(&dword_1D49D5000, v23, OS_LOG_TYPE_ERROR, "%{public}@Another connection with identifier: %@ is registered for the same container: %@.", buf, 0x20u);
            }
          }
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v52 = 2112;
              uint64_t v53 = v13;
              _os_log_impl(&dword_1D49D5000, v18, OS_LOG_TYPE_INFO, "%{public}@Registering connection identifier: %@ for container: %@.", buf, 0x20u);
            }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v34;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Cannot register a client without a valid connection identifier.", buf, 0xCu);
    }
  }
}
...
- (void)handleShareRepairForRemoteClientRequest:(id)a3 home:(id)a4 completion:(id)a5
{
  ...
  id v12 = [v8 objectForKeyedSubscript:*MEMORY[0x1E4F2E368]];
  objc_opt_class();
  ...
  id v15 = [v8 objectForKeyedSubscript:*MEMORY[0x1E4F2E398]];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    uint64_t v16 = v15;
  }
  ...
  id v36 = 0;
  v18 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClass:objc_opt_class() fromData:v17 error:&v36];
  id v35 = v36;
  if (v14) {
    BOOL v19 = v18 == 0;
  }
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v38 = v23;
      _os_log_impl(&dword_1D49D5000, v22, OS_LOG_TYPE_ERROR, "%{public}@Missing required items in payload", buf, 0xCu);
    }
    v24 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3 description:@"Could not decode payload" reason:@"Unable to find required items in payload" suggestion:0];
    v10[2](v10, v24);
  }
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v41 = 2112;
        id v42 = v14;
        _os_log_impl(&dword_1D49D5000, v31, OS_LOG_TYPE_INFO, "%{public}@Add repair request %@ to pending for %@", buf, 0x20u);
      }
...
- (void)handleShareForRemoteClientRequest:(id)a3 home:(id)a4 completionHandler:(id)a5
{
  ...
  if (v10)
  {
    id v12 = v11;
    v66 = self;
    uint64_t v13 = [v10 objectForKeyedSubscript:*MEMORY[0x1E4F2E378]];
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      id v14 = v13;
    }
    ...
    v64 = v15;
    uint64_t v16 = (void *)[objc_alloc(MEMORY[0x1E4F29128]) initWithUUIDString:v15];
    id v17 = [v12 uuid];
    LODWORD(v15) = [v17 isEqual:v16];

    if (v15)
    {
      v18 = [v10 objectForKeyedSubscript:*MEMORY[0x1E4F2E370]];
      __findUserWithUUID(v18, v12);
      id v19 = (id)objc_claimAutoreleasedReturnValue();

      v20 = [v10 objectForKeyedSubscript:*MEMORY[0x1E4F2E3A8]];
      __findUserWithUUID(v20, v12);
      id v21 = (id)objc_claimAutoreleasedReturnValue();

      v22 = [v10 objectForKeyedSubscript:*MEMORY[0x1E4F2E3B8]];
      objc_opt_class();
      if (objc_opt_isKindOfClass()) {
        v23 = v22;
      }
      ...
      v25 = [v10 objectForKeyedSubscript:*MEMORY[0x1E4F2E3B0]];
      objc_opt_class();
      if (objc_opt_isKindOfClass()) {
        id v26 = v25;
      }
      ...
      uint64_t v28 = [v10 objectForKeyedSubscript:*MEMORY[0x1E4F2E368]];
      objc_opt_class();
      if (objc_opt_isKindOfClass()) {
        uint64_t v29 = v28;
      }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v76 = v41;
          _os_log_impl(&dword_1D49D5000, v40, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode all required items from payload.", buf, 0xCu);
        }
        long long v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3 description:@"Could not decode payload" reason:@"Unable to decode all required items" suggestion:0];
        id v10 = v38;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v76 = v37;
        _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_ERROR, "%{public}@Messaged home had different identifier from payload.", buf, 0xCu);
      }
      long long v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3 description:@"Inconsistent payload home and originating home" reason:@"Messaged home must match home in payload" suggestion:0];
      id v19 = 0;
      id v21 = 0;
      id v24 = 0;
      id v27 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v76 = v34;
      _os_log_impl(&dword_1D49D5000, v33, OS_LOG_TYPE_ERROR, "%{public}@Could not decode Remote ClientRequestPayload.", buf, 0xCu);
    }
    long long v31 = [MEMORY[0x1E4F28C58] hmErrorWithCode:3 description:@"Could not decode payload" reason:@"Need a valid payload" suggestion:0];
    id v19 = 0;
    id v21 = 0;
    id v24 = 0;
    id v27 = 0;
  ...
  if (v31)
  {
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v76 = v51;
      _os_log_impl(&dword_1D49D5000, v50, OS_LOG_TYPE_ERROR, "%{public}@Could not decode payload.", buf, 0xCu);
    }
    __int16 v52 = v68;
  ...
  else
  {
    ...
    if (os_signpost_enabled(logger))
    {
      *(_DWORD *)buf = 138412290;
      v76 = v47;
      _os_signpost_emit_with_name_impl(&dword_1D49D5000, logger, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "MultiUser.Share.Req", "container=%{signpost.description:attribute}@ ", buf, 0xCu);
    }
    aBlock[0] = MEMORY[0x1E4F143A8];
    aBlock[1] = 3221225472;
    aBlock[2] = __88__HMDUserCloudShareController_handleShareForRemoteClientRequest_home_completionHandler___block_invoke;
    aBlock[3] = &unk_1E6A0E100;
    aBlock[4] = self;
...
void __88__HMDUserCloudShareController_handleShareForRemoteClientRequest_home_completionHandler___block_invoke(void *a1, void *a2, void *a3)
{
  ...
  if (v9 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
  {
    int v10 = 138412290;
    id v11 = v6;
    _os_signpost_emit_with_name_impl(&dword_1D49D5000, v8, OS_SIGNPOST_INTERVAL_END, v9, "MultiUser.Share.Req", "error=%{signpost.description:attribute}@ ", (uint8_t *)&v10, 0xCu);
  }
...
- (void)_handleShareForRemoteClientRequest:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v17 = 2112;
      v18 = v12;
      _os_log_impl(&dword_1D49D5000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No process registered to handle container %@", (uint8_t *)&v15, 0x16u);
    }
...
- (void)_sendRepairRequest:(id)a3 toConnection:(id)a4
{
  ...
  os_signpost_id_t v9 = (void *)MEMORY[0x1D9452090]();
  int v10 = self;
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v7;
    _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_INFO, "%{public}@Sending repair request %@ to client %@", (uint8_t *)&v17, 0x20u);
  }
        ...
        if (v17)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v44 = 2112;
            id v45 = v15;
            _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_INFO, "%{public}@Resuming request %@", buf, 0x16u);
          }
          id v22 = v15;
          objc_opt_class();
          if (objc_opt_isKindOfClass()) {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = v32;
              id v43 = v30;
              _os_log_impl(&dword_1D49D5000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not determine request type.", buf, 0xCu);
        ...
        if (v16 < v14)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v27;
            ...
            __int16 v34 = 2112;
            id v35 = v11;
            _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Timing out pending request %@", buf, 0x16u);
          }
          id v21 = v11;
          objc_opt_class();
          if (objc_opt_isKindOfClass()) {
          ...
          if (v23)
          {
            ...
            id v25 = [MEMORY[0x1E4F28C58] hmErrorWithCode:8 description:@"No process received pending request in time" reason:@"No process received share message in required time." suggestion:0];
...
- (void)_addRequestToPending:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Adding request to pending %@", (uint8_t *)&v11, 0x16u);
  }
  ...
  else
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        int v11 = v8;
        _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing timer as there are no more pending requests", buf, 0xCu);
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t27_90332 != -1) {
    dispatch_once(&logCategory__hmf_once_t27_90332, &__block_literal_global_90333);
  }
  v2 = (void *)logCategory__hmf_once_v28_90334;
  return v2;
}
...
uint64_t __42__HMDUserCloudShareController_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v28_90334;
  logCategory__hmf_once_v28_90334 = v0;
...
+ (id)identifierForConnection:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      __int16 v19 = v5;
      _os_log_impl(&dword_1D49D5000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get identifier for connection: %@ process info: %@", (uint8_t *)&v14, 0x20u);
    }
  }
