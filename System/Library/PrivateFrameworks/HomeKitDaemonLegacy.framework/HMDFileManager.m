...
- (id)JSONObjectWithURL:(id)a3 error:(id *)a4
{
  v5 = (objc_class *)MEMORY[0x1E4F1CA10];
  id v6 = a3;
  v7 = (void *)[[v5 alloc] initWithURL:v6];

  if (v7)
  {
    [v7 open];
    v8 = [MEMORY[0x1E4F28D90] JSONObjectWithStream:v7 options:0 error:a4];
  }
  else if (a4)
  {
...
{
  id v7 = a3;
  v8 = (objc_class *)MEMORY[0x1E4F1CAA8];
  id v9 = a4;
  v10 = (void *)[[v8 alloc] initWithURL:v9 append:0];

  if (v10)
  {
    [v10 open];
    BOOL v11 = [MEMORY[0x1E4F28D90] writeJSONObject:v7 toStream:v10 options:1 error:a5] != 0;
  }
  else if (a5)
  {
    [MEMORY[0x1E4F28C58] hmfErrorWithCode:2];
...
- (id)fileHandleForReadingFromURL:(id)a3 error:(id *)a4
{
  return (id)[MEMORY[0x1E4F28CB0] fileHandleForReadingFromURL:a3 error:a4];
}
...
- (BOOL)zipItemAtURL:(id)a3 toURL:(id)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    uint64_t v14 = *MEMORY[0x1E4FA8A80];
    v15[0] = *MEMORY[0x1E4FA8A78];
    id v10 = objc_msgSend(MEMORY[0x1E4F1C9E8], "dictionaryWithObjects:forKeys:count:", v15, &v14, 1, 0, 0, 0, 0, 0, v9, 0, 0, 0, 0, 0, 0, 0);
    id v11 = [v7 path];
...
- (BOOL)unzipItemAtURL:(id)a3 toURL:(id)a4 error:(id *)a5
{
  ...
  id v10 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v24 forKeys:v23 count:3];
...
- (id)dataWithContentsOfURL:(id)a3 options:(unint64_t)a4 error:(id *)a5
{
  return (id)[MEMORY[0x1E4F1C9B8] dataWithContentsOfURL:a3 options:a4 error:a5];
}
