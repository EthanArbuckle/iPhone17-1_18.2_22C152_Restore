...
- (void)timerDidFire:(id)a3
{
  ...
  if (v7 == v4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      v22 = v16;
      _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Minor update timer fired", (uint8_t *)&v21, 0xCu);
    }
    goto LABEL_10;
  }
  ...
  if (v8 == v4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      v22 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Major update timer fired", (uint8_t *)&v21, 0xCu);
    }
  ...
  else
  {
    ...
    if (v9 == v4)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        int v21 = 138543362;
        v22 = v13;
        _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@Photo library persons did change debounce timer fired", (uint8_t *)&v21, 0xCu);
      }
...
- (void)photoLibraryPersonsDidChange
{
  ...
  if (v10 < v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      v26 = v15;
      _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_INFO, "%{public}@Photo library persons did change; handling change immediately since we've been debouncing since %@",
        (uint8_t *)&v23,
        0x16u);
    }
...
LABEL_6:
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      int v23 = 138543362;
      v24 = v20;
      _os_log_impl(&dword_1D49D5000, v19, OS_LOG_TYPE_INFO, "%{public}@Photo library persons did change; resuming debounce timer",
        (uint8_t *)&v23,
        0xCu);
    }
...
- (HMDPhotoLibraryObserver)initWithUUID:(id)a3 workQueue:(id)a4 photoLibrary:(id)a5
{
  double v8 = (objc_class *)MEMORY[0x1E4F65580];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
  v12 = (void *)[[v8 alloc] initWithTimeInterval:4 options:86400.0];
  v13 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:4 options:2592000.0];
  v14 = (void *)[objc_alloc(MEMORY[0x1E4F65580]) initWithTimeInterval:0 options:300.0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_66987 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_66987, &__block_literal_global_66988);
  }
  v2 = (void *)logCategory__hmf_once_v6_66989;
  return v2;
}
...
uint64_t __38__HMDPhotoLibraryObserver_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v6_66989;
  logCategory__hmf_once_v6_66989 = v0;
