...
- (HMDHAPMetadataCategory)initWithIdentifier:(id)a3 uuid:(id)a4 name:(id)a5 description:(id)a6
{
  ...
  if (v15)
  {
    ...
    uint64_t v17 = objc_msgSend(MEMORY[0x1E4F654E8], "hmf_cachedInstanceForString:", v12);
    uuidStr = v16->_uuidStr;
    v16->_uuidStr = (NSString *)v17;

    uint64_t v19 = objc_msgSend(MEMORY[0x1E4F654E8], "hmf_cachedInstanceForString:", v13);
    name = v16->_name;
    v16->_name = (NSString *)v19;

    uint64_t v21 = objc_msgSend(MEMORY[0x1E4F654E8], "hmf_cachedInstanceForString:", v14);
