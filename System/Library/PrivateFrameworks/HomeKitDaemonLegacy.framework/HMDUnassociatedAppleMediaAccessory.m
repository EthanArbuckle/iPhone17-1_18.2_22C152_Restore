...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v7 forKey:*MEMORY[0x1E4F2C760]];
  ...
  [v4 encodeObject:v9 forKey:*MEMORY[0x1E4F2E170]];
  ...
  [v4 encodeInteger:v13 forKey:*MEMORY[0x1E4F2DCF0]];
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    [v4 encodeBool:v17 forKey:*MEMORY[0x1E4F2C2F8]];
  }
}
...
- (HMDUnassociatedAppleMediaAccessory)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2C760]];
    ...
    v14 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x1E4F2E170]];
    ...
    v5->_productColor = [v4 decodeIntegerForKey:*MEMORY[0x1E4F2DCF0]];
...
- (id)dumpDescription
{
  ...
  [v16 setObject:v12 forKey:*MEMORY[0x1E4F64EA0]];
  return v16;
}
...
- (BOOL)canPairGivenCapabilities:(unint64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      uint64_t v15 = v13;
      _os_log_impl(&dword_1D49D5000, v12, OS_LOG_TYPE_INFO, "%{public}@No required capabilities found.", (uint8_t *)&v14, 0xCu);
    }
    return 1;
  }
}
...
- (id)addTransactionForHome:(id)a3
{
  ...
  id v4 = [(HMDUnassociatedMediaAccessory *)&v27 addTransactionForHome:a3];
  objc_opt_class();
  ...
  if (v6)
  {
    ...
    int v13 = [v12 isEqualToString:*MEMORY[0x1E4F2C1D0]];

    int v14 = (void *)MEMORY[0x1E4F2E520];
    ...
    if (v13)
    {
      ...
      {
        [v6 setSupportedStereoPairVersions:&unk_1F2DC7A20];
      }
    }
    ...
    v25 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDUnassociatedAppleMediaAccessory productColor](self, "productColor"));
...
- (HMDUnassociatedAppleMediaAccessory)initWithIdentifier:(id)a3 name:(id)a4 category:(id)a5 requiredPairingCapabilities:(unint64_t)a6 minimumPairingSoftware:(id)a7 productColor:(int64_t)a8 idsIdentifierString:(id)a9 rawAccessoryCapabilities:(id)a10 rawResidentCapabilities:(id)a11 messageDispatcher:(id)a12
{
  ...
  objc_super v18 = [(HMDUnassociatedMediaAccessory *)&v32 initWithIdentifier:v16 name:a4 category:a5 messageDispatcher:a12];
  if (v18)
  {
    id v19 = objc_alloc(MEMORY[0x1E4F29128]);
    v20 = +[HMDUnassociatedAppleMediaAccessory namespace];
    uint64_t v21 = [v16 dataUsingEncoding:4];
    uint64_t v22 = [v19 initWithNamespace:v20 data:v21];
...
- (id)modelForChangeType:(unint64_t)a3 uuid:(id)a4 parentUUID:(id)a5
{
  return +[HMDAppleMediaAccessoryModel appleMediaAccessoryModelWithChangeType:a3 uuid:a4 parentUUID:a5];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_33950 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_33950, &__block_literal_global_18);
  }
  v2 = (void *)logCategory__hmf_once_v9_33951;
  return v2;
}
...
uint64_t __49__HMDUnassociatedAppleMediaAccessory_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v9_33951;
  logCategory__hmf_once_v9_33951 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}

+ (id)namespace
{
  if (namespace_onceToken_33955 != -1) {
    dispatch_once(&namespace_onceToken_33955, &__block_literal_global_33956);
  }
  v2 = (void *)namespace_namespace_33957;
  return v2;
}
...
uint64_t __47__HMDUnassociatedAppleMediaAccessory_namespace__block_invoke()
{
  ...
  uint64_t v1 = namespace_namespace_33957;
  namespace_namespace_33957 = v0;
  return MEMORY[0x1F41817F8](v0, v1);
}
