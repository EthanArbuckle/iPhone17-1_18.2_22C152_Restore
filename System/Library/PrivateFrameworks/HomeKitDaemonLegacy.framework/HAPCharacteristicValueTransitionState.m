...
BOOL __114__HAPCharacteristicValueTransitionState_NaturalLighting__naturalLightingActiveTransitionContextForCharacteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v18 = 0;
    uint64_t v5 = [MEMORY[0x1E4F5BCB8] parsedFromData:v4 error:&v18];
    id v6 = v18;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v23 = 2112;
        id v24 = v6;
        _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode controller context %@:%@", buf, 0x20u);
      }
      BOOL v13 = 0;
    }
  }
...
BOOL __100__HAPCharacteristicValueTransitionState_NaturalLighting__isNaturalLightingEnabledForCharacteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    id v16 = 0;
    uint64_t v5 = [MEMORY[0x1E4F5BCB8] parsedFromData:v4 error:&v16];
    id v6 = v16;
    if (v5)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v21 = 2112;
        id v22 = v6;
        _os_log_impl(&dword_1D49D5000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode controller context %@:%@", buf, 0x20u);
      }
      BOOL v11 = 0;
    }
  }
