...
- (id)intermediateApplyOnboardingSelectionsRequestMessageForMessage:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  id v7 = objc_alloc(MEMORY[0x1E4F2EAE8]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v6;
      _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get accessory UUID for intermediate apply onboarding selections message handler using message: %@", buf, 0x16u);
    }
...
void __104__HMDSiriEndpointProfilesMessenger_intermediateApplyOnboardingSelectionsRequestMessageForMessage_error___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    v8 = (void *)[objc_alloc(MEMORY[0x1E4F2EAF0]) initWithPayload:v6];
    if (v8)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v26 = 2112;
        id v27 = v6;
        _os_log_impl(&dword_1D49D5000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response using apply onboarding intermediate response payload: %@", buf, 0x16u);
      }
    }
  }
  else
  {
    v14 = (void *)MEMORY[0x1D9452090](v7);
    id v15 = a1[5];
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v5;
      _os_log_impl(&dword_1D49D5000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response payload for apply onboarding intermediate response with error: %@", buf, 0x16u);
    }
  }
}
...
- (void)routeSiriEndpointApplyOnboardingSelectionsRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v4;
    _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Routing siri endpoint apply onboarding selections request message: %@", buf, 0x16u);
  }
  id v13 = 0;
...
- (void)registerForMessagesWithHome:(id)a3
{
  ...
  uint64_t v9 = *MEMORY[0x1E4F2DF80];
  v15[0] = v5;
  v15[1] = v6;
  v15[2] = v7;
  ...
  v12 = [MEMORY[0x1E4F2EAF8] messageName];
  v14[0] = v5;
  v14[1] = v6;
  v14[2] = v7;
  id v13 = [MEMORY[0x1E4F1C978] arrayWithObjects:v14 count:3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_22894 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_22894, &__block_literal_global_22895);
  }
  v2 = (void *)logCategory__hmf_once_v5_22896;
  return v2;
}
...
uint64_t __47__HMDSiriEndpointProfilesMessenger_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v5_22896;
  logCategory__hmf_once_v5_22896 = v0;
