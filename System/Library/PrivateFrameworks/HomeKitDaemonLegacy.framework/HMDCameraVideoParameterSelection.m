...
- (void)_generateAllCombinations
{
  ...
  v3 = +[HMDVideoResolution arrayWithResolutions:&unk_1F2DC6E98];
...
- (id)createSelectedVideoParameters
{
  ...
  v34[0] = v4;
  uint64_t v5 = [MEMORY[0x1E4F1C978] arrayWithObjects:v34 count:1];
                  ...
                  for (uint64_t i = 0; i != v25; ++i)
                  {
                    ...
                    if (v35 != 0x7FFFFFFFFFFFFFFFLL)
                    {
                      ...
                      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138543618;
                        ...
                        __int16 v86 = 2112;
                        v87 = v43;
                        _os_log_impl(&dword_1D49D5000, v46, OS_LOG_TYPE_INFO, "%{public}@Selected video parameter combination: %@", buf, 0x16u);
                      }
                      id v12 = v66;
                    ...
                    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138543618;
                      ...
                      __int16 v86 = 2112;
                      v87 = v40;
                      _os_log_impl(&dword_1D49D5000, v38, OS_LOG_TYPE_INFO, "%{public}@Combination does not exist for video resolution: %@", buf, 0x16u);
                    }
                  }
...
LABEL_6:
    ...
    while (1)
    {
      ...
      uint64_t v58 = [*(id *)(v13 + 2632) array];
      long long v97 = 0u;
      long long v98 = 0u;
      long long v99 = 0u;
      long long v100 = 0u;
      ...
      {
        long long v72 = (void *)MEMORY[0x1D9452090]();
        id v14 = v81;
        long long v73 = v81;
        ...
        if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544642;
          ...
          __int16 v119 = 2112;
          v120 = v58;
          _os_log_impl(&dword_1D49D5000, v74, OS_LOG_TYPE_INFO, "%{public}@One of the intersected candidates is empty: candidateProfiles: %@, candidateLevels: %@, candidatePacketModes: %@, candidateVideoResolutions: %@, candidateAttributes: %@", buf, 0x3Eu);
        }
        int v70 = 3;
      }
...
- (void)_setVideoResolutionPreference
{
  ...
  uint64_t v7 = +[HMDVideoResolution arrayWithResolutions:&unk_1F2DC6E20];
  uint64_t v8 = +[HMDVideoResolution arrayWithResolutions:&unk_1F2DC6E38];
  v28 = (void *)v7;
  [v3 addObjectsFromArray:v7];
  v27 = (void *)v8;
  [v4 addObjectsFromArray:v8];
  v9 = +[HMDVideoResolution arrayWithResolutions:&unk_1F2DC6E50];
  v10 = +[HMDVideoResolution arrayWithResolutions:&unk_1F2DC6E68];
  v11 = +[HMDVideoResolution arrayWithResolutions:&unk_1F2DC6E80];
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v32 = 2112;
    v33 = v26;
    _os_log_impl(&dword_1D49D5000, v24, OS_LOG_TYPE_INFO, "%{public}@Setting the video resolution preference order to %@", buf, 0x16u);
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_98654 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_98654, &__block_literal_global_98655);
  }
  v2 = (void *)logCategory__hmf_once_v2_98656;
  return v2;
}
...
uint64_t __47__HMDCameraVideoParameterSelection_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v2_98656;
  logCategory__hmf_once_v2_98656 = v0;
