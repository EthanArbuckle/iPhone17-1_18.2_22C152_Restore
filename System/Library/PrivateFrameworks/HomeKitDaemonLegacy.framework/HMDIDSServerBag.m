...
+ (id)logCategory
{
  if (logCategory__hmf_once_t39 != -1) {
    dispatch_once(&logCategory__hmf_once_t39, &__block_literal_global_29210);
  }
...
- (id)serverBagNumberValueForKey:(void *)a1
{
  v2 = -[HMDIDSServerBag serverBagValueForKey:](a1, a2);
  objc_opt_class();
...
LABEL_6:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_1D49D5000, v14, OS_LOG_TYPE_INFO, "%{public}@serverBagValueForKey %@ returned %@", (uint8_t *)&v17, 0x20u);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v10;
        _os_log_impl(&dword_1D49D5000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating hh2SoftwareReleased from %@ to %@", buf, 0x20u);
    ...
    if (v12 | v13 && v14 != [a1 isHH2ManualMigrationEnabled])
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v20;
        _os_log_impl(&dword_1D49D5000, v17, OS_LOG_TYPE_INFO, "%{public}@Updating hh2ManualMigrationEnabled from %@ to %@", buf, 0x20u);
      }
    ...
    if (v21 | v22 && v23 != [a1 isHH2AutoMigrationEnabled])
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v29;
        _os_log_impl(&dword_1D49D5000, v26, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationEnabled from %@ to %@", buf, 0x20u);
      }
          ...
          (v32 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v30;
        _os_log_impl(&dword_1D49D5000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithoutSharedUserRampDivisor from %@ to %@", buf, 0x20u);
      }
      ...
      if ((v41 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v39;
          _os_log_impl(&dword_1D49D5000, v44, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithoutSharedUserRampRemainder from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v49 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v47;
          _os_log_impl(&dword_1D49D5000, v52, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithSharedUserRampDivisor from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v57 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v55;
          _os_log_impl(&dword_1D49D5000, v60, OS_LOG_TYPE_INFO, "%{public}@Updating hh2AutoMigrationWithSharedUserRampRemainder from %@ to %@", buf, 0x20u);
        }
    ...
    if (v63 && ([v63 isEqualToVersion:v64] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v63;
        _os_log_impl(&dword_1D49D5000, v68, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForSharedUserHH2MigrationByOwnerManual from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v70 && ([v70 isEqualToVersion:v71] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v70;
        _os_log_impl(&dword_1D49D5000, v74, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForSharedUserHH2MigrationByOwnerAuto from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v76 && ([v76 isEqualToVersion:v77] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v76;
        _os_log_impl(&dword_1D49D5000, v81, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerMeDeviceAutoHH2MigrationWithoutSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v83 && ([v83 isEqualToVersion:v84] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v83;
        _os_log_impl(&dword_1D49D5000, v87, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerOtherDevicesAutoHH2MigrationWithoutSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v89 && ([v89 isEqualToVersion:v90] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v93, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v89;
        _os_log_impl(&dword_1D49D5000, v93, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerResidentDevicesAutoHH2MigrationWithoutSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v95 && ([v95 isEqualToVersion:v96] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v100, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v95;
        _os_log_impl(&dword_1D49D5000, v100, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerMeDeviceAutoHH2MigrationWithSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v102 && ([v102 isEqualToVersion:v103] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v106, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v102;
        _os_log_impl(&dword_1D49D5000, v106, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerOtherDevicesAutoHH2MigrationWithSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      }
    ...
    if (v109 && ([v109 isEqualToVersion:v110] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v113, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v109;
        _os_log_impl(&dword_1D49D5000, v113, OS_LOG_TYPE_INFO, "%{public}@Updating minimumHomeKitVersionForOwnerResidentDevicesAutoHH2MigrationWithSharedUsers from %{public}@ to %{public}@", buf, 0x20u);
      }
      ...
      if (v117 != [v116 BOOLValue])
      {
        ...
        if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v123;
          _os_log_impl(&dword_1D49D5000, v120, OS_LOG_TYPE_INFO, "%{public}@Updating hh2SuppressDuplicateUserModelBulletins from %@ to %@", buf, 0x20u);
        }
      ...
      if (v125 != [v124 BOOLValue])
      {
        ...
        if (os_log_type_enabled(v128, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v131;
          _os_log_impl(&dword_1D49D5000, v128, OS_LOG_TYPE_INFO, "%{public}@Updating homeSafetySecurityEnabled from %@ to %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v136, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v139;
        _os_log_impl(&dword_1D49D5000, v136, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitResidentStatusEnabled from %@ to %@", buf, 0x20u);
      }
      ...
      if ((v143 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v146, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v141;
          _os_log_impl(&dword_1D49D5000, v146, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitInitialConnectionTimeoutSeconds from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v151 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v154, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v149;
          _os_log_impl(&dword_1D49D5000, v154, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitConnectionTTSUNoReachablePrimaryTimeoutSeconds from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v159 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v162, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v157;
          _os_log_impl(&dword_1D49D5000, v162, OS_LOG_TYPE_INFO, "%{public}@Updating statusKitUnsubscribeFromChannelDebounceTimeSec from %@ to %@", buf, 0x20u);
        }
          ...
          (v167 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v171, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v165;
        _os_log_impl(&dword_1D49D5000, v171, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredResidentEvaluationDelay from %@ to %@", buf, 0x20u);
      }
      ...
      if ((v176 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v179, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v174;
          _os_log_impl(&dword_1D49D5000, v179, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredResidentsListMaxSize from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v184 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v187, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v182;
          _os_log_impl(&dword_1D49D5000, v187, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionStatusDebounceInterval from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v192 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v195, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v190;
          _os_log_impl(&dword_1D49D5000, v195, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionTakeOverIfPrimaryIsNotViableInterval from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v200 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v203, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v198;
          _os_log_impl(&dword_1D49D5000, v203, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionTakeOverInterval from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v208 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v211, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v206;
          _os_log_impl(&dword_1D49D5000, v211, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionTakeOverOnlyIfCurrentPrimaryIsNotViableJitter from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v216 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v219, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v214;
          _os_log_impl(&dword_1D49D5000, v219, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredListGenerationStartHour from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v224 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v227, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v222;
          _os_log_impl(&dword_1D49D5000, v227, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionPreferredListGenerationEndHour from %@ to %@", buf, 0x20u);
        }
    ...
    if (v230 && ([v230 isEqualToVersion:v231] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v234, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2114;
        v288 = v230;
        _os_log_impl(&dword_1D49D5000, v234, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionMinHomeKitVersion from %{public}@ to %{public}@", buf, 0x20u);
      }
      ...
      if ((v238 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v241, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v236;
          _os_log_impl(&dword_1D49D5000, v241, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionReachabilityNotificationAfterConnectivityDelay from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v246 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v249, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v244;
          _os_log_impl(&dword_1D49D5000, v249, OS_LOG_TYPE_INFO, "%{public}@Updating residentSelectionUserPreferredReachabilityNotificationDelay from %@ to %@", buf, 0x20u);
        }
      ...
      if ((v254 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v257, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v287 = 2112;
          v288 = v252;
          _os_log_impl(&dword_1D49D5000, v257, OS_LOG_TYPE_INFO, "%{public}@Updating residentDeviceManagerBlockPrimaryTakeoverDurationSeconds from %@ to %@", buf, 0x20u);
        }
...
LABEL_191:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v265, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v287 = 2112;
        v288 = v268;
        _os_log_impl(&dword_1D49D5000, v265, OS_LOG_TYPE_INFO, "%{public}@Updating fetchHomeWiFiInfosMessageDisableNumber from %@ to %@", buf, 0x20u);
      }
      uint64_t v260 = objc_msgSend(v264, "setFetchHomeWiFiInfosMessageDisable:", objc_msgSend(v261, "BOOLValue"));
      v269 = v276;
    }
    v271 = (void *)MEMORY[0x1D9452090](v260);
    id v272 = a1;
    ...
    if (os_log_type_enabled(v273, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v284 = v274;
      _os_log_impl(&dword_1D49D5000, v273, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of server bag update", buf, 0xCu);
    }
    v275 = [v272 delegate];
...
- (HMDHomeKitVersion)serverBagHomeKitVersionForKey:(void *)a1
{
  ...
  if (v4) {
    uint64_t v5 = [[HMDHomeKitVersion alloc] initWithVersionString:v4];
  }
  else {
    uint64_t v5 = 0;
  }
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      int v11 = v9;
      _os_log_impl(&dword_1D49D5000, v8, OS_LOG_TYPE_INFO, "%{public}@Server bag refresh timer fired", (uint8_t *)&v10, 0xCu);
    }
...
- (HMDIDSServerBag)initWithIDSServerBag:(id)a3 refreshTimer:(id)a4 keySuffix:(id)a5
{
  ...
  if (v12)
  {
    ...
    v13->_hh2AutoMigrationWithoutSharedUserRampDivisor = (NSNumber *)&unk_1F2DC78E8;

    hh2AutoMigrationWithoutSharedUserRampRemainder = v13->_hh2AutoMigrationWithoutSharedUserRampRemainder;
    v13->_hh2AutoMigrationWithoutSharedUserRampRemainder = (NSNumber *)&unk_1F2DC7900;

    hh2AutoMigrationWithSharedUserRampDivisor = v13->_hh2AutoMigrationWithSharedUserRampDivisor;
    v13->_hh2AutoMigrationWithSharedUserRampDivisor = (NSNumber *)&unk_1F2DC78E8;

    hh2AutoMigrationWithSharedUserRampRemainder = v13->_hh2AutoMigrationWithSharedUserRampRemainder;
    v13->_hh2AutoMigrationWithSharedUserRampRemainder = (NSNumber *)&unk_1F2DC7900;

    v20 = [[HMDHomeKitVersion alloc] initWithVersionString:@"9999"];
    uint64_t v21 = [[HMDHomeKitVersion alloc] initWithVersionString:@"10.4"];
...
- (HMDIDSServerBag)init
{
  ...
  id v3 = [MEMORY[0x1E4F6AB80] sharedInstanceForBagType:0];
  id v4 = [MEMORY[0x1E4F65530] sharedPreferences];
  id v5 = [v4 preferenceForKey:@"idsServerBagMaximumPollInterval"];
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x1E4F65428]) initWithMinimumTimeInterval:2 maximumTimeInterval:12 exponentialFactor:30.0 options:v8];
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v25 = 2048;
    double v26 = v8;
    _os_log_impl(&dword_1D49D5000, v15, OS_LOG_TYPE_INFO, "%{public}@Initializing using key suffix %@ with initial timer interval of %fs and maximum of %fs", (uint8_t *)&v19, 0x2Au);
  }
