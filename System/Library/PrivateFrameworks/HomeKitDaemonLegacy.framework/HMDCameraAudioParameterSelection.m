...
- (void)_generateAllCombinations:(id)a3
{
  ...
  v10 = [(HMDCameraAudioParameterCombination *)v5 initWithCodecGroup:v6 bitrateSetting:v7 sampleRate:v8 maximumBitrate:&unk_1F2DC7498 minimumBitrate:&unk_1F2DC7498 rtcpInterval:&unk_1F2DC74B0 rtpPtime:v9];
  [v33 addObject:v10];
  ...
  v16 = [(HMDCameraAudioParameterCombination *)v11 initWithCodecGroup:v12 bitrateSetting:v13 sampleRate:v14 maximumBitrate:&unk_1F2DC74E0 minimumBitrate:&unk_1F2DC74E0 rtcpInterval:&unk_1F2DC74B0 rtpPtime:v15];
  [v33 addObject:v16];
  ...
  v22 = [(HMDCameraAudioParameterCombination *)v17 initWithCodecGroup:v18 bitrateSetting:v19 sampleRate:v20 maximumBitrate:&unk_1F2DC7498 minimumBitrate:&unk_1F2DC7498 rtcpInterval:&unk_1F2DC74B0 rtpPtime:v21];
  [v33 addObject:v22];
  ...
  v28 = [(HMDCameraAudioParameterCombination *)v23 initWithCodecGroup:v24 bitrateSetting:v25 sampleRate:v26 maximumBitrate:&unk_1F2DC74E0 minimumBitrate:&unk_1F2DC74E0 rtcpInterval:&unk_1F2DC74B0 rtpPtime:v27];
  [v33 addObject:v28];
...
- (id)createSelectedAudioParameters
{
  ...
  id v33 = v9;
  v10 = [MEMORY[0x1E4F1C978] arrayWithObjects:&v33 count:1];
            ...
            for (uint64_t i = 0; i != v19; ++i)
            {
              ...
              if (v25 != 0x7FFFFFFFFFFFFFFFLL)
              {
                ...
                if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v56 = 2112;
                  v57 = v32;
                  _os_log_impl(&dword_1D49D5000, v35, OS_LOG_TYPE_INFO, "%{public}@Using audio parameter combination: %@", buf, 0x16u);
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v56 = 2112;
                v57 = v23;
                _os_log_impl(&dword_1D49D5000, v28, OS_LOG_TYPE_INFO, "%{public}@Could not find audio parameter combination: %@", buf, 0x16u);
    ...
    while (1)
    {
      ...
      if ([v26 count] && objc_msgSend(v34, "count"))
      {
        ...
        if (v36)
        {
          ...
          [(HMDCameraAudioParameterSelection *)v50 setComfortNoiseSupported:MEMORY[0x1E4F1CC28]];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v47;
          ...
          __int16 v60 = 2112;
          v61 = v34;
          _os_log_impl(&dword_1D49D5000, v39, OS_LOG_TYPE_INFO, "%{public}@One of the intersected candidates is empty: candidateBitrateSettings: %@, candidateSampleRates: %@", buf, 0x20u);
        }
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_8420 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_8420, &__block_literal_global_8421);
  }
  v2 = (void *)logCategory__hmf_once_v1_8422;
  return v2;
}

uint64_t __47__HMDCameraAudioParameterSelection_logCategory__block_invoke()
{
  logCategory__hmf_once_v1_8422 = HMFCreateOSLogHandle();
