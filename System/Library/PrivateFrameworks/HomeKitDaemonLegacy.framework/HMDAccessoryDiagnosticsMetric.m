...
- (void)submitMetric:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2114;
      v23 = v13;
      _os_log_impl(&dword_1D49D5000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting AccessoryDiagnosticMetric for accessory: %{public}@/%{public}@ - %{public}@", (uint8_t *)&v16, 0x2Au);
    }
    v14 = [v5 home];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_63725 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_63725, &__block_literal_global_256);
  }
  v2 = (void *)logCategory__hmf_once_v9_63726;
  return v2;
}
...
uint64_t __44__HMDAccessoryDiagnosticsMetric_logCategory__block_invoke()
{
  ...
  uint64_t v1 = logCategory__hmf_once_v9_63726;
  logCategory__hmf_once_v9_63726 = v0;
