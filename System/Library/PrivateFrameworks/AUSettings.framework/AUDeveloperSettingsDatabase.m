...
- (void)updateAccessory:(id)a3 locationType:(unint64_t)a4
{
  ...
  if ([(AUDeveloperSettingsDatabase *)self isValidLocationType:a4])
  {
    ...
    if (os_log_type_enabled(log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v20 = 2112;
      v21 = v14;
      _os_log_impl(&dword_247215000, v12, OS_LOG_TYPE_DEFAULT, "%s: Updating location = %s for accessoryName = %@", (uint8_t *)&v16, 0x20u);
    }
...
- (void)addAccessoryWithSerialNumber:(id)a3 info:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(log, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v7;
      _os_log_impl(&dword_247215000, log, OS_LOG_TYPE_DEFAULT, "%s: Not adding empty serial number with info = %@", (uint8_t *)&v11, 0x16u);
    }
  }
}
...
- (void)setAccessoriesDictionary:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  __int16 v6 = 2112;
  uint64_t v7 = a1;
  _os_log_debug_impl(&dword_247215000, a2, OS_LOG_TYPE_DEBUG, "%s: seting %@:%@", (uint8_t *)&v2, 0x20u);
}
...
- (void)accessoriesDictionary
{
  ...
  v1[0] = 136315394;
  OUTLINED_FUNCTION_0();
  _os_log_error_impl(&dword_247215000, v0, OS_LOG_TYPE_ERROR, "%s: received unknown object = %@", (uint8_t *)v1, 0x16u);
}
...
- (void)seedParticipationDictionary
{
  ...
  v1[0] = 136315394;
  OUTLINED_FUNCTION_0();
  _os_log_debug_impl(&dword_247215000, v0, OS_LOG_TYPE_DEBUG, "%s: dictionary = %@", (uint8_t *)v1, 0x16u);
}
