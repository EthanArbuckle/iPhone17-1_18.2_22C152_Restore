...
- (void)setHiddenInSendMenuByUserPreference:(BOOL)a3
{
  ...
  id v6 = [(CKSettingsiMessageApp *)self _hiddenExtensionBundleIdentifiers];
  int v7 = [v6 containsObject:v5];
  if (v3 && (v7 & 1) == 0)
  {
    uint64_t v8 = [v6 arrayByAddingObject:v5];
...
LABEL_7:
  ...
  if (IMOSLoggingEnabled())
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 1024;
      BOOL v14 = v3;
      _os_log_impl(&dword_2561DD000, v10, OS_LOG_TYPE_INFO, "Extension %@ was already hidden=%{BOOL}d", (uint8_t *)&v11, 0x12u);
    }
  }
LABEL_8:
}
