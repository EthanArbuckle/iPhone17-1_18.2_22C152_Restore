void sub_2216ACE58(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, id location)
{
  id *v14;
...
void sub_2216AD4D4(_Unwind_Exception *a1)
{
  objc_destroyWeak(v2);
...
uint64_t accessoryServer_registerAvailabilityChangedHandlerForServiceEntry(const char *a1, const void *a2, unsigned int a3)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2080;
    v13 = v8;
    _os_log_impl(&dword_2216AB000, v7, OS_LOG_TYPE_DEFAULT, "Register AvailabilityChangedHandler (%d, %s)", (uint8_t *)v11, 0x12u);
  }
  uint64_t result = 0;
  if (a2 && a1 && a3 <= 1)
  {
...
uint64_t _SetupAvailabilityChangedHandlerForServiceEntry(unsigned int a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(void *)&buf[4] = "_SetupAvailabilityChangedHandlerForServiceEntry";
    __int16 v17 = 1024;
    unsigned int v18 = a1;
    _os_log_impl(&dword_2216AB000, v3, OS_LOG_TYPE_DEFAULT, "%s (%d)", buf, 0x12u);
  }
  if (a1 > 1) {
    return 0;
  }
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315650;
    ...
    __int16 v19 = 2080;
    v20 = v6;
    _os_log_impl(&dword_2216AB000, v4, OS_LOG_TYPE_INFO, "%s (%d, %s)", buf, 0x1Cu);
  }
  ...
  if (v7 && *((void *)&_gServerAvailabilityChangedHandler + a1))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&buf[4] = "_SetupAvailabilityChangedHandlerForServiceEntry";
      ...
      __int16 v21 = 1024;
      BOOL v22 = v12 != -1;
      _os_log_impl(&dword_2216AB000, v9, OS_LOG_TYPE_INFO, "%s did not register for notification (%d, %s), token (%d)", buf, 0x22u);
    }
  }
  uint64_t v10 = 0;
LABEL_38:
...
uint64_t accessoryServer_unregisterAvailabilityChangedHandlerForServiceEntry(uint64_t result)
{
  ...
  if (result <= 1)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v9 = 2080;
      uint64_t v10 = v4;
      _os_log_impl(&dword_2216AB000, v3, OS_LOG_TYPE_DEFAULT, "Unregister AvailabilityChangedHandler (%d, %s)", (uint8_t *)v8, 0x12u);
    }
    else
    {
      uint64_t v5 = v1;
    ...
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)state64 = 136315650;
        ...
        __int16 v12 = 2080;
        v13 = v7;
        _os_log_impl(&dword_2216AB000, v6, OS_LOG_TYPE_INFO, "%s cannot get server state (%d, %s)", state64, 0x1Cu);
      }
      uint64_t v4 = 0;
      goto LABEL_9;
    }
...
void __init_logging_modules_block_invoke(uint64_t a1)
{
  ...
  if (*(unsigned char *)(a1 + 48))
  {
    ...
    do
    {
      ...
      if (!v8)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 67109120;
          LODWORD(v13) = v4;
          _os_log_error_impl(&dword_2216AB000, v6, OS_LOG_TYPE_ERROR, "Subsystem missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
          uint64_t v7 = *(void *)(a1 + 32);
          v8 = "<Undefined>";
        }
      }
      ...
      *(void *)(*(void *)(a1 + 40) + 8 * v4) = v10;
      if (v10)
      {
        ...
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 136315394;
          ...
          __int16 v14 = 2080;
          char v15 = v9;
          _os_log_debug_impl(&dword_2216AB000, v6, OS_LOG_TYPE_DEBUG, "Created log object %s: %s", buf, 0x16u);
        }
      }
      else if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315394;
        ...
        __int16 v14 = 2080;
        char v15 = v9;
        _os_log_error_impl(&dword_2216AB000, v6, OS_LOG_TYPE_ERROR, "Failed to create os_log_t object %s: %s!", buf, 0x16u);
      }
      ++v4;
    ...
    while (v4 < v11);
    BOOL v2 = (unsigned char *)(&loc_2216AFFFC + 4);
  }
  else
  {
    LODWORD(v11) = 0;
  ...
  {
    *(_DWORD *)buf = *((void *)v2 + 154);
    LODWORD(v13) = v5;
    _os_log_impl(&dword_2216AB000, &_os_log_internal, OS_LOG_TYPE_INFO, "Created %d log object(s)!", buf, 8u);
...
void accessoryServer_registerAvailabilityChangedHandlerForServiceEntry_cold_1(const char **a1, int a2, os_log_t log)
{
  ...
  __int16 v5 = 2080;
  int v6 = v3;
  _os_log_fault_impl(&dword_2216AB000, log, OS_LOG_TYPE_FAULT, "AccessoryServerAvailabilityChangedHandler already set! (%d, %s)", (uint8_t *)v4, 0x12u);
}
...
void __init_logging_modules_block_invoke_cold_1(uint8_t *buf, int a2, _DWORD *a3)
{
  *(_DWORD *)buf = 67109120;
  *a3 = a2;
  _os_log_error_impl(&dword_2216AB000, &_os_log_internal, OS_LOG_TYPE_ERROR, "Category missing for logging module %d!\n(Check LoggingModuleEntry_t table)", buf, 8u);
}
