...
- (PUIActivityButtonCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  v4 = [(PUIActivityButtonCell *)&v61 initWithStyle:a3 reuseIdentifier:a4];
  v5 = v4;
  if (v4)
  {
    ...
    v21 = (void *)[objc_alloc(MEMORY[0x1E4FB1400]) initWithActivityIndicatorStyle:100];
...
- (void)refreshCellContentsWithSpecifier:(id)a3
{
  ...
  v7 = objc_msgSend(v4, "numberWithInt:", objc_msgSend(v6, "BOOLValue") ^ 1);
  [v5 setObject:v7 forKeyedSubscript:*MEMORY[0x1E4F93130]];
  ...
  if (v8)
  {
    ...
    v15 = [MEMORY[0x1E4FB1618] systemGrayColor];
