...
- (BOOL)performWithError:(id *)a3
{
  ...
  url = self->_url;
  v11[0] = 0;
  BOOL v5 = [(MCMContainerSchemaActionBase *)self fixAndRetryIfPermissionsErrorWithURL:url error:v11 duringBlock:&__block_literal_global_4986];
  id v6 = v11[0];
  v7 = [v6 domain];
...
- (MCMContainerSchemaActionStopBackupExclude)initWithPathArgument:(id)a3 context:(id)a4
{
  ...
  id v6 = a3;
  v11.receiver = self;
  v11.super_class = (Class)MCMContainerSchemaActionStopBackupExclude;
