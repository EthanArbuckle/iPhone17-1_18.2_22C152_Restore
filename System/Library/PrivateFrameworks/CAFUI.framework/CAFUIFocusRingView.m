...
- (CAFUIFocusRingView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    [(CAFUIFocusRingView *)v3 setBackgroundColor:v4];
    ...
    v3->_ringWidth = 2.0;
    [(CAFUIFocusRingView *)v3 setAccessibilityIdentifier:@"CAFUIFocusRingView"];
  }
  return v3;
}
...
- (void)_updateFocusRect
{
  v3 = [(CAFUIFocusRingView *)self focusPath];
  [v3 removeAllPoints];

  [(CAFUIFocusRingView *)self setFocusPath:0];

  [(CAFUIFocusRingView *)self setNeedsDisplay];
}
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  [(CAFUIFocusRingView *)&v4 traitCollectionDidChange:a3];
  [(CAFUIFocusRingView *)self _updateFocusRect];
}
...
- (void)layoutSubviews
{
  ...
  [(CAFUIFocusRingView *)&v3 layoutSubviews];
  [(CAFUIFocusRingView *)self _updateFocusRect];
}
...
- (void)drawRect:(CGRect)a3
{
  ...
  v12 = [(CAFUIFocusRingView *)self focusPath];

  if (!v12)
  {
    v13 = (void *)MEMORY[0x263F824C0];
    [(CAFUIFocusRingView *)self cornerRadius];
    v15 = objc_msgSend(v13, "_bezierPathWithPillRect:cornerRadius:", v8, v9, v10, v11, v14);
    [v15 setLineWidth:self->_ringWidth];
    [(CAFUIFocusRingView *)self setFocusPath:v15];
  }
  v16 = [(CAFUIFocusRingView *)self ringColor];
  [v16 setStroke];

  v17 = [(CAFUIFocusRingView *)self focusPath];
  [v17 stroke];
}
