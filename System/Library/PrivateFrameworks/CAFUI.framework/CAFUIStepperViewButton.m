@interface CAFUIStepperViewButton
...
- (_TtC5CAFUI22CAFUIStepperViewButton)initWithFrame:(CGRect)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.super.isa + OBJC_IVAR____TtC5CAFUI22CAFUIStepperViewButton_hasCellBackground) = 0;
  v8.receiver = self;
...
- (_TtC5CAFUI22CAFUIStepperViewButton)initWithCoder:(id)a3
{
  *((unsigned char *)&self->super.super.super.super.super.isa + OBJC_IVAR____TtC5CAFUI22CAFUIStepperViewButton_hasCellBackground) = 0;
  ...
  return [(CAFUIStepperViewButton *)&v5 initWithCoder:a3];
}
