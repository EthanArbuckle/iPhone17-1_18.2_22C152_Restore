...
{
  id v7 = a3;
  unint64_t v4 = [(ICCRCoder *)self typeIndexForClass:objc_opt_class()];
  int v5 = v4;
...
{
  id v31 = a3;
  id v6 = [(ICCRCoderArchiver *)self encodedObjects];
  id v7 = [MEMORY[0x1E4F29238] valueWithNonretainedObject:v31];
  uint64_t v8 = [v6 indexOfObject:v7];

  if (v8 == 0x7FFFFFFFFFFFFFFFLL)
  {
    int v9 = *(_DWORD *)([(ICCRCoderArchiver *)self currentDocument] + 64);
    if (*((_DWORD *)a4 + 12) != 6)
    {
    ...
    *((_DWORD *)a4 + 10) = v9;
    v10 = [(ICCRCoderArchiver *)self currentDocument];
    int v11 = v10[17];
    uint64_t v12 = v10[16];
    if ((int)v12 >= v11)
    {
    ...
    if (end >= value)
    {
      ...
      if (v22) {
        v23 = (char *)std::__allocate_at_least[abi:ne180100]<std::allocator<TopoSubstring *>>((uint64_t)&self->currentDocObjectEncodingStack.__end_cap_, v22);
      }
      else {
        v23 = 0;
      }
    ...
    self->currentDocObjectEncodingStack.__end_ = v18;
    v29 = [(ICCRCoderArchiver *)self encodedObjects];
    v30 = [MEMORY[0x1E4F29238] valueWithNonretainedObject:v31];
    [v29 addObject:v30];

    [(ICCRCoderArchiver *)self setTypeIndexForCurrentCustomObjectIfNecessary:v31];
    [v31 encodeWithICCRCoder:self];
...
{
  id v6 = a3;
  id v7 = [(ICCRCoderArchiver *)self mutableObjectIDForKey:a4];
  id v8 = v6;
  std::string::basic_string[abi:ne180100](&__str, (void *)[v8 bytes], objc_msgSend(v8, "length"));
  if (*((_DWORD *)v7 + 12) != 5)
  {
...
{
  id v8 = a4;
  id v6 = -[ICCRCoderArchiver mutableObjectIDForKey:](self, "mutableObjectIDForKey:");
  id v7 = (double *)v6;
  if (v6[12] != 3)
  {
...
{
  id v4 = a3;
  int v5 = [(ICCRCoderArchiver *)self uuidSet];
  unint64_t v6 = [v5 indexOfObject:v4];

  if (v6 == 0x7FFFFFFFFFFFFFFFLL)
  {
    id v7 = [(ICCRCoderArchiver *)self uuidSet];
    unint64_t v6 = [v7 count];

    id v8 = [(ICCRCoderArchiver *)self uuidSet];
    [v8 addObject:v4];
  }
  return v6;
}
...
{
  id v4 = a3;
  int v5 = [(ICCRCoderArchiver *)self currentCustomObjectForEncoding];
  int v6 = v5[13];
  uint64_t v7 = v5[12];
  if ((int)v7 >= v6)
  {
  ...
  int v10 = [(ICCRCoderArchiver *)self indexForKey:v4];
...
{
  id v4 = a3;
  int v5 = [(ICCRCoderArchiver *)self keySet];

  if (!v5) {
    [MEMORY[0x1E4F836F8] handleFailedAssertWithCondition:"self.keySet" functionName:"-[ICCRCoderArchiver indexForKey:]" simulateCrash:1 showAlert:0 format:@"keySet should have been allocated"];
  }
  int v6 = [(ICCRCoderArchiver *)self keySet];
  uint64_t v7 = [v6 indexOfObject:v4];

  if (v7 == 0x7FFFFFFFFFFFFFFFLL)
  {
    uint64_t v8 = [(ICCRCoderArchiver *)self keySet];
    LODWORD(v7) = [v8 count];

    uint64_t v9 = [(ICCRCoderArchiver *)self keySet];
    [v9 addObject:v4];
  }
  return v7;
}
