...
{
  v3.receiver = self;
  v3.super_class = (Class)ICTTMergeableStringUndoEditCommand;
...
- (void)dealloc
{
  ...
  if (deleteRanges)
  {
    ...
    MEMORY[0x1C877D640](deleteRanges, 0x20C40960023A9);
  }
  insertStrings = self->_insertStrings;
  if (insertStrings)
  {
    v6 = (void **)self->_insertStrings;
    std::vector<std::pair<TopoIDRange,NSAttributedString * {__strong}>>::__destroy_vector::operator()[abi:ne180100](&v6);
    MEMORY[0x1C877D640](insertStrings, 0x20C40960023A9);
  }
  v5.receiver = self;
  v5.super_class = (Class)ICTTMergeableStringUndoEditCommand;
...
- (void)updateTopoIDRange:(TopoIDRange *)a3 toNewRangeID:(TopoIDRange *)a4
{
  ...
  unsigned int v13 = a4->var0.clock;
...
LABEL_4:
    ...
    else
    {
      do
      {
        id v11 = *v9;
        id v12 = v9[3];
        objc_msgSend(MEMORY[0x1E4F29128], "CR_unserialized");
...
- (void)updateInsertTopoIDRange:(TopoIDRange *)a3 toNewRangeID:(TopoIDRange *)a4
{
  ...
  while (v7 != v8)
  {
    if ([*(id *)v7 isEqual:a3->var0.replicaID])
    {
      unsigned int v9 = *(_DWORD *)(v7 + 8);
      unsigned int clock = a3->var0.clock;
      if (v9 >= clock && (v9 != clock || [*(id *)v7 TTCompare:a3->var0.replicaID] != -1))
      {
        id v11 = a3->var0.replicaID;
        id v12 = (void *)(a3->var1 + a3->var0.clock);
        v14[0] = v11;
        v14[1] = v12;
        ...
        if (!v13)
        {
          objc_storeStrong((id *)v7, a4->var0.replicaID);
          *(_DWORD *)(v7 + 8) = *(_DWORD *)(v7 + 8) + a4->var0.clock - a3->var0.clock;
        }
      }
    }
    v7 += 32;
...
{
  id v4 = a3;
  objc_super v5 = [(ICTTMergeableStringUndoEditCommand *)self deleteRanges];
  uint64_t v6 = *v5;
  uint64_t v7 = v5[1];
  while (v6 != v7)
  {
...
- (NSString)description
{
  ...
  objc_msgSend(v3, "appendFormat:", @"<ICTTMergeableStringUndoEditCommand %p Delete:", self);
  deleteRanges = (uint64_t *)self->_deleteRanges;
