...
- (BOOL)createDestinationInstancesForSourceInstance:(id)a3 entityMapping:(id)a4 manager:(id)a5 error:(id *)a6
{
  ...
  id v12 = a5;
  v22.receiver = self;
  v22.super_class = (Class)ICAttachmentMigrationPolicy;
  BOOL v13 = [(ICCloudSyncingObjectMigrationPolicy *)&v22 createDestinationInstancesForSourceInstance:v10 entityMapping:v11 manager:v12 error:a6];
  if (v13)
  {
    v14 = [v11 name];
    v23[0] = v10;
