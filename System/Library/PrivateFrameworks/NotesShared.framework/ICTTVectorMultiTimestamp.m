...
{
  v10.receiver = self;
  v10.super_class = (Class)ICTTVectorMultiTimestamp;
  ...
  if (v4)
  {
    ...
    if (a3)
    {
      ...
      do
      {
        unint64_t v8 = objc_alloc_init(ICTTVectorTimestamp);
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [+[ICTTVectorMultiTimestamp allocWithZone:a3] initWithCapacity:[(NSArray *)self->_timestamps count]];
...
- (ICTTVectorMultiTimestamp)initWithArchive:(const void *)a3 andCapacity:(unint64_t)a4
{
  id v6 = [(ICTTVectorMultiTimestamp *)self initWithCapacity:a4];
  uint64_t v7 = v6;
  if (!v6)
  {
LABEL_29:
  ...
  if (v8)
  {
    ...
    while (1)
    {
      ...
      os_log_t v18 = (os_log_t)[v16 initWithUUIDBytes:v17];
      uint64_t v19 = *(unsigned int *)(v13 + 56);
      if (v19 != a4)
      {
        v24 = os_log_create("com.apple.notes", "Topotext");
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR)) {
          -[ICTTVectorMultiTimestamp(ICTTVectorTimestampPersistenceAdditions) initWithArchive:andCapacity:](v19, a4, v24);
        }
      ...
      if (v19)
      {
        ...
        do
        {
          ...
          if ((*(unsigned char *)(google::protobuf::internal::RepeatedPtrFieldBase::Get<google::protobuf::RepeatedPtrField<topotext::VectorTimestamp_Clock_ReplicaClock>::TypeHandler>(v21, v20)+ 32) & 2) != 0)uint64_t v23 = *(unsigned int *)(google::protobuf::internal::RepeatedPtrFieldBase::Get<google::protobuf::RepeatedPtrField<topotext::VectorTimestamp_Clock_ReplicaClock>::TypeHandler>(v21, v20)+ 44); {
            ...
            uint64_t v23 = 0;
          [(ICTTVectorMultiTimestamp *)v7 setClock:v22 subclock:v23 forUUID:v18 atIndex:v20++];
        }
        while (a4 != v20);
      }
    ...
    os_log_t v18 = os_log_create("com.apple.notes", "Topotext");
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR)) {
      -[ICTTVectorMultiTimestamp(ICTTVectorTimestampPersistenceAdditions) initWithArchive:andCapacity:](v18);
    }
LABEL_28:
...
- (unint64_t)compareTo:(id)a3
{
  ...
  if (v5)
  {
    ...
    do
    {
      v9 = [(NSArray *)self->_timestamps objectAtIndexedSubscript:v7];
...
- (ICTTVectorMultiTimestamp)initWithTimestamps:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)ICTTVectorMultiTimestamp;
  NSUInteger v5 = [(ICTTVectorMultiTimestamp *)&v9 init];
  if (v5)
  {
    uint64_t v6 = [v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = a3;
  objc_opt_class();
  BOOL v5 = (objc_opt_isKindOfClass() & 1) != 0 && [(ICTTVectorMultiTimestamp *)self compareTo:v4] == 0;
...
- (id)clockElementForUUID:(id)a3 atIndex:(unint64_t)a4
{
  ...
  unint64_t v8 = [v7 clockElementForUUID:v6];
...
- (ICTTVectorMultiTimestamp)initWithData:(id)a3 andCapacity:(unint64_t)a4
{
  ...
  {
    self = [(ICTTVectorMultiTimestamp *)self initWithArchive:v13 andCapacity:a4];
    id v10 = self;
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR)) {
      -[ICTTVectorMultiTimestamp(ICTTVectorTimestampPersistenceAdditions) initWithData:andCapacity:](v11);
    }
...
- (void)saveToArchive:(void *)a3
{
  ...
  long long v28 = 0u;
  long long v29 = 0u;
  obuint64_t j = [(ICTTVectorMultiTimestamp *)self sortedUUIDs];
    ...
    do
    {
      ...
      for (uint64_t i = 0; i != v25; ++i)
      {
        ...
        *(_DWORD *)(v11 + 32) |= 1u;
        ...
        MEMORY[0x1C877D5C0]();
        uint64_t v12 = [(ICTTVectorMultiTimestamp *)self timestamps];
        ...
        if (v13)
        {
          ...
          {
            uint64_t v15 = [(ICTTVectorMultiTimestamp *)self clockElementForUUID:v7 atIndex:j];
            ...
            *(_DWORD *)(v11 + 56) = v17 + 1;
            ...
            if ([v15 clock])
            {
              int v20 = ICTTBoundedCheckedCastNSUIntegerToUInt32([v15 clock]);
              v19[8] |= 1u;
              v19[10] = v20;
            }
            if ([v15 subclock])
            {
              int v21 = ICTTBoundedCheckedCastNSUIntegerToUInt32([v15 subclock]);
              v19[8] |= 2u;
              v19[11] = v21;
            }
          }
...
- (id)serialize
{
  -[ICTTVectorMultiTimestamp saveToArchive:](self, "saveToArchive:", v6, topotext::VectorTimestamp::VectorTimestamp((topotext::VectorTimestamp *)v6));
