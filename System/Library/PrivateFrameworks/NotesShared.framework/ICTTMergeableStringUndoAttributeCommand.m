...
{
  v3.receiver = self;
  v3.super_class = (Class)ICTTMergeableStringUndoAttributeCommand;
...
- (void)dealloc
{
  ...
  if (attributeRanges)
  {
    ...
    MEMORY[0x1C877D640](attributeRanges, 0x20C40960023A9);
  }
  v4.receiver = self;
...
- (BOOL)hasTopoIDsThatCanChange
{
  ...
  {
    v5 = *(void **)(v4 - 32);
    v6 = objc_msgSend(MEMORY[0x1E4F29128], "CR_unserialized");
...
- (NSString)description
{
  ...
  objc_msgSend(v3, "appendFormat:", @"<ICTTMergeableStringUndoAttributeCommand %p ", self);
  attributeRanges = (uint64_t *)self->_attributeRanges;
