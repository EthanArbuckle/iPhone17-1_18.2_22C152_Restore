...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    id v7 = v6;
    id v8 = [(ICTTFont *)self fontName];
    v9 = [v7 fontName];
    if (v8 == v9
      || ([(ICTTFont *)self fontName],
          ...
          [v3 isEqualToString:v4]))
    {
      ...
      if (v12 == v13)
      {
        unsigned int v14 = [(ICTTFont *)self fontHints];
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [v3 hash];
  [(ICTTFont *)self pointSize];
  unint64_t v6 = v4 ^ [(ICTTFont *)self fontHints] ^ (unint64_t)v5;
...
- (id)description
{
  ...
  unint64_t v6 = [(ICTTFont *)self fontName];
  [(ICTTFont *)self pointSize];
  uint64_t v8 = v7;
  ...
  char v10 = [(ICTTFont *)self fontHints];
  double v11 = @" italic";
  if ((v10 & 2) == 0) {
    double v11 = &stru_1F1F2FFF8;
  }
...
- (ICTTFont)initWithData:(id)a3
{
  ...
  {
    self = [(ICTTFont *)self initWithArchive:v11];
    uint64_t v8 = self;
  }
  else
  {
...
- (ICTTFont)initWithArchive:(const void *)a3
{
  ...
  double v12 = [ICTTFont alloc];
  double v13 = v11;
  if ((v5 & 2) == 0) {
    double v13 = 0.0;
  }
  unsigned int v14 = [(ICTTFont *)v12 initWithName:v6 size:*((_DWORD *)a3 + 13) & ((int)(*((_DWORD *)a3 + 8) << 29) >> 31) hints:v13];
...
- (void)saveToArchive:(void *)a3
{
  int v5 = [(ICTTFont *)self fontName];

  if (v5)
  {
    id v6 = [(ICTTFont *)self fontName];
    [v6 UTF8String];
    *((_DWORD *)a3 + 8) |= 1u;
  ...
  if ([(ICTTFont *)self fontHints])
  {
    unsigned int v9 = [(ICTTFont *)self fontHints];
    *((_DWORD *)a3 + 8) |= 4u;
    *((_DWORD *)a3 + 13) = v9;
  }
}
...
- (ICTTFont)initWithCoder:(id)a3
{
  ...
  id v6 = [(ICTTFont *)self initWithData:v5];
