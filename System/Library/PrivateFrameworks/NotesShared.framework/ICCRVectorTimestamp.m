    ...
    if (v8)
    {
      ...
      do
      {
        ...
        if (*(unsigned char *)(*v10 + 32))
        {
          ...
          if ((v15 & 2) != 0)
          {
            [(ICCRVectorTimestampElement *)v13 setClock:*(void *)(v11 + 48)];
            int v15 = *(_DWORD *)(v11 + 32);
          }
          if ((v15 & 4) != 0) {
            [(ICCRVectorTimestampElement *)v14 setSubclock:*(void *)(v11 + 56)];
          }
...
- (ICCRVectorTimestamp)initWithICCRCoder:(id)a3
{
  ...
  if (*(_DWORD *)(v5 + 48) == 8) {
    objc_super v6 = [(ICCRVectorTimestamp *)self initWithProtobufTimestamp:*(void *)(v5 + 40) decoder:v4];
  }
  else {
    objc_super v6 = [(ICCRVectorTimestamp *)self init];
  }
  v7 = v6;
...
- (void)encodeWithICCRCoder:(id)a3
{
  ...
  [(ICCRVectorTimestamp *)self encodeIntoProtobufTimestamp:*(void *)(v4 + 40) coder:v6];
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  uint64_t v4 = [+[ICCRVectorTimestamp allocWithZone:a3] init];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = a3;
  objc_opt_class();
  BOOL v5 = (objc_opt_isKindOfClass() & 1) != 0 && [(ICCRVectorTimestamp *)self compare:v4] == 0;
...
{
  id v4 = a3;
  BOOL v5 = [[ICCRTimestamp alloc] initWithReplica:v4 andCounter:[(ICCRVectorTimestamp *)self clockForUUID:v4]];
...
- (void)setClock:(unint64_t)a3 forUUID:(id)a4
{
  ...
  id v6 = (ICCRVectorTimestampElement *)objc_claimAutoreleasedReturnValue();
  if (!v6) {
    id v6 = objc_alloc_init(ICCRVectorTimestampElement);
  }
...
{
  id v9 = a5;
  uint64_t v8 = objc_alloc_init(ICCRVectorTimestampElement);
...
- (void)maxClock:(unint64_t)a3 forUUID:(id)a4
{
  ...
  unint64_t v7 = [(ICCRVectorTimestampElement *)v6 clock];
  if (v7 <= a3) {
    unint64_t v8 = a3;
  }
  else {
...
- (unint64_t)compare:(id)a3
{
  ...
  id v6 = [(ICCRVectorTimestamp *)self allUUIDs];
  ...
  while (2)
  {
    for (uint64_t i = 0; i != v9; ++i)
    {
      ...
      uint64_t v15 = [(ICCRVectorTimestamp *)self clockElementForUUID:v14];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        int v10 = [(ICCRVectorTimestamp *)self clockElementForUUID:v9];
...
- (id)shortDescription
{
  ...
  if ([(ICCRVectorTimestamp *)self count])
  {
    ...
    long long v12 = 0u;
    long long v13 = 0u;
    id v4 = [(ICCRVectorTimestamp *)self sortedUUIDs];
    ...
    if (v5)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v5; ++i)
        {
          ...
          uint64_t v9 = [(ICCRVectorTimestamp *)self clockElementForUUID:v8];
...
- (NSString)description
{
  ...
  long long v13 = 0u;
  long long v14 = 0u;
  uint64_t v6 = [(ICCRVectorTimestamp *)self sortedUUIDs];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        int v11 = [(ICCRVectorTimestamp *)self clockElementForUUID:v10];
