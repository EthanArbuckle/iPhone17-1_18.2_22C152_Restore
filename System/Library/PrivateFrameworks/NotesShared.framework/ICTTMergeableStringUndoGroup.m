...
{
  v8.receiver = self;
  v8.super_class = (Class)ICTTMergeableStringUndoGroup;
...
- (BOOL)addSeenRange:(TopoIDRange *)a3
{
  id v5 = a3->var0.replicaID;
  uint64_t clock = a3->var0.clock;
  uint64_t var1 = a3->var1;
  objc_super v8 = [(ICTTMergeableStringUndoGroup *)self seen];
  v9 = [v8 objectForKeyedSubscript:v5];

  if (v9)
  {
    if (objc_msgSend(v9, "containsIndexesInRange:", clock, var1))
    {
      BOOL v10 = 0;
    }
    else
    {
      objc_msgSend(v9, "addIndexesInRange:", clock, var1);
      BOOL v10 = 1;
    }
    v11 = v9;
  }
  ...
  {
    v11 = objc_msgSend(objc_alloc(MEMORY[0x1E4F28E60]), "initWithIndexesInRange:", clock, var1);
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        unsigned int v14 = a4->var0.clock;
...
- (void)applyToString:(id)a3
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v5 = [(ICTTMergeableStringUndoGroup *)self commands];
...
- (NSString)description
{
  ...
  id v4 = [(ICTTMergeableStringUndoGroup *)self commands];
  id v5 = [v3 stringWithFormat:@"<ICTTMergeableStringUndoGroup %p %@>", self, v4];
