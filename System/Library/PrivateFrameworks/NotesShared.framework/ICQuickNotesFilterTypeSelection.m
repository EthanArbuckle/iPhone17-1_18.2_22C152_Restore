...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[ICQuickNotesFilterTypeSelection allocWithZone:a3];
...
- (id)filterName
{
  return (id)[MEMORY[0x1E4F83770] localizedFrameworkStringForKey:@"Quick Notes" value:@"Quick Notes" table:0 allowSiri:1];
}
