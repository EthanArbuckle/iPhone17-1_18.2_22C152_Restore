...
- (BOOL)createDestinationInstancesForSourceInstance:(id)a3 entityMapping:(id)a4 manager:(id)a5 error:(id *)a6
{
  ...
  BOOL v13 = [(NSEntityMigrationPolicy *)&v33 createDestinationInstancesForSourceInstance:v10 entityMapping:v11 manager:v12 error:a6];
  if (v13)
  {
    v14 = [v11 name];
    v34[0] = v10;
    ...
    v27 = objc_msgSend(MEMORY[0x1E4F1A2D8], "ic_systemFieldsValueTransformer");
    v28 = v27;
    if (v18)
    {
