...
+ (id)heuristicResultToWorkWithLocation:(id)a3 validStartDate:(id)a4 validEndDate:(id)a5 heuristicDevice:(id)a6
{
  ...
  else
  {
    ...
    v18 = [v17 localizedStringForKey:@"DESTINATION_NAME_WORK" value:&stru_1F2719D20 table:0];
...
+ (id)heuristicResultToWorkWithValidStartDate:(id)a3 validEndDate:(id)a4 heuristicDevice:(id)a5
{
  ...
  else
  {
    ...
    v15 = [v14 localizedStringForKey:@"DESTINATION_NAME_WORK" value:&stru_1F2719D20 table:0];
...
{
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1_5(&dword_1D0F43000, v0, v1, "ATXHeuristicCommuteWorkUtilities: validStartDate %@ is after validEndDate %@. Skipping suggestion");
}
