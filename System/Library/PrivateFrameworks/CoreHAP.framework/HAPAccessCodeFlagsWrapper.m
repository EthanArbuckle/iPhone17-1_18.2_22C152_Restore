...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      unint64_t v6 = [(HAPAccessCodeFlagsWrapper *)self value];
      uint64_t v7 = [(HAPAccessCodeFlagsWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(HAPAccessCodeFlagsWrapper *)self value];
...
- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPAccessCodeFlagsWrapper *)self value];
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPAccessCodeFlagsWrapper);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPAccessCodeFlagsWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
