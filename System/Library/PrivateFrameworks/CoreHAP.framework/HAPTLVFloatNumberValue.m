...
- (id)description
{
  ...
  [v3 floatValue];
  v5 = objc_msgSend(v2, "stringWithFormat:", @"<HAPTLVFloatNumberValue value=%f>", v4);
...
- (id)_serialize
{
  ...
  float v4 = [MEMORY[0x1E4F1C9B8] dataWithBytes:&v6 length:4];
...
{
  id v5 = a3;
  int v6 = objc_alloc_init(HAPTLVFloatNumberValue);
  v7 = v6;
  if (v6)
  {
    id v10 = 0;
