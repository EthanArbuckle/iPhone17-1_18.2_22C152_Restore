...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v13 = [(HAPFirmwareUpdateStatus *)self updateDuration];
        v26 = [(HAPFirmwareUpdateStatus *)v7 updateDuration];
...
LABEL_18:
  ...
  if (v11)
  {
    v12 = [(HAPFirmwareUpdateStatus *)self updateDuration];
    id v27 = 0;
  ...
  uint64_t v15 = [(HAPFirmwareUpdateStatus *)self stagedFirmwareVersion];

  if (v15)
  {
    v16 = [(HAPFirmwareUpdateStatus *)self stagedFirmwareVersion];
    id v26 = 0;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPFirmwareUpdateStatus);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
