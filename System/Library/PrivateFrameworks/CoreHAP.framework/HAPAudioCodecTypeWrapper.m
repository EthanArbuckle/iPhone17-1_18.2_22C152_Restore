...
- (HAPAudioCodecTypeWrapper)initWithValue:(int64_t)a3;
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPAudioCodecTypeWrapper *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      int64_t v6 = [(HAPAudioCodecTypeWrapper *)self value];
      uint64_t v7 = [(HAPAudioCodecTypeWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[HAPAudioCodecTypeWrapper allocWithZone:a3];
  int64_t v5 = [(HAPAudioCodecTypeWrapper *)self value];

  return [(HAPAudioCodecTypeWrapper *)v4 initWithValue:v5];
}

- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPAudioCodecTypeWrapper *)self value];
...
{
  v5.receiver = self;
  v5.super_class = (Class)HAPAudioCodecTypeWrapper;
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPAudioCodecTypeWrapper;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPAudioCodecTypeWrapper);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPAudioCodecTypeWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
