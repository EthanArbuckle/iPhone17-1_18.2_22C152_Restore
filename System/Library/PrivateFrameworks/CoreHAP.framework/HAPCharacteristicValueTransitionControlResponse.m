...
LABEL_10:
  ...
  v15 = [(HAPCharacteristicValueTransitionControlResponse *)self transitionState];
  id v27 = 0;
...
- (HAPCharacteristicValueTransitionControlResponse)initWithValueTransition:(id)a3 transitionState:(id)a4
{
  ...
  id v9 = [(HAPCharacteristicValueTransitionControlResponse *)&v12 init];
  unint64_t v10 = v9;
  if (v9)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPCharacteristicValueTransitionControlResponse);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
