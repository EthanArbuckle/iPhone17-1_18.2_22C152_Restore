...
- (BOOL)isEqual:(id)a3
{
  v6 = (HAPDataStreamHAPAccessoryPayload *)a3;
  if (self == v6)
  {
    char v10 = 1;
  }
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      else
      {
        ...
        v26 = [(HAPDataStreamHAPAccessoryPayload *)v7 forceClose];
...
LABEL_10:
  ...
  uint64_t v15 = [(HAPDataStreamHAPAccessoryPayload *)self forceClose];
  id v25 = 0;
...
LABEL_30:
    ...
    v19 = [(HAPDataStreamHAPAccessoryPayload *)self accessoryRequestToSend];
    id v24 = 0;
...
- (HAPDataStreamHAPAccessoryPayload)initWithPayload:(id)a3 forceClose:(id)a4 accessoryRequestToSend:(id)a5
{
  ...
  uint64_t v12 = [(HAPDataStreamHAPAccessoryPayload *)&v15 init];
  unint64_t v13 = v12;
  if (v12)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPDataStreamHAPAccessoryPayload);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
