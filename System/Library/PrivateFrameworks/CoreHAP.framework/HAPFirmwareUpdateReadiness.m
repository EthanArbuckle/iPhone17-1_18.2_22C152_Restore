...
{
  v3 = NSString;
  v4 = [(HAPFirmwareUpdateReadiness *)self stagingNotReadyReasons];
  v5 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
  v6 = [v3 stringWithFormat:@"<HAPFirmwareUpdateReadiness stagingNotReadyReasons=%@, updateNotReadyReasons=%@>", v4, v5];
...
- (BOOL)isEqual:(id)a3
{
  v5 = (HAPFirmwareUpdateReadiness *)a3;
  if (self == v5)
  {
    char v10 = 1;
  }
...
LABEL_12:
  ...
  v12 = [(HAPFirmwareUpdateReadiness *)self updateNotReadyReasons];
  id v17 = 0;
...
- (HAPFirmwareUpdateReadiness)initWithStagingNotReadyReasons:(id)a3 updateNotReadyReasons:(id)a4
{
  ...
  id v9 = [(HAPFirmwareUpdateReadiness *)&v12 init];
  uint64_t v10 = v9;
  if (v9)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPFirmwareUpdateReadiness);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
