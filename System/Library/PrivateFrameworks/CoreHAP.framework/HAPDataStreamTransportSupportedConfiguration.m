...
{
  v2 = NSString;
  objc_super v3 = [(HAPDataStreamTransportSupportedConfiguration *)self configurations];
  v4 = [v2 stringWithFormat:@"<HAPDataStreamTransportSupportedConfiguration configurations=%@>", v3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      unint64_t v7 = [(HAPDataStreamTransportSupportedConfiguration *)v5 configurations];
      if (v6 == v7)
      {
        char v10 = 1;
      }
...
LABEL_17:
    ...
    id v20 = objc_msgSend(MEMORY[0x1E4F1C9B8], "dataWithBytes:length:", v33);
    id v21 = 0;
  }
LABEL_24:
  TLV8BufferFree();
