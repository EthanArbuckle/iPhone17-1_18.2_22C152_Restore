...
- (HAPTLVUnsignedNumberValue)RGBColorValue;
- (NSString)description;
- (id)copyWithZone:(_NSZone *)a3;
- (id)serializeWithError:(id *)a3;
- (void)setRGBColorValue:(id)a3;
@end
...
LABEL_16:
  self = v20;
LABEL_17:
  -[HAPHardwareFinish setRGBColorValue:](self, "setRGBColorValue:", v9, v20);
  id v10 = 0;
  BOOL v17 = 1;
LABEL_19:
...
- (HAPHardwareFinish)initWithRGBColorValue:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HAPHardwareFinish;
  id v6 = [(HAPHardwareFinish *)&v9 init];
  uint64_t v7 = v6;
  if (v6) {
    objc_storeStrong((id *)&v6->_RGBColorValue, a3);
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPHardwareFinish;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPHardwareFinish);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPHardwareFinish *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
