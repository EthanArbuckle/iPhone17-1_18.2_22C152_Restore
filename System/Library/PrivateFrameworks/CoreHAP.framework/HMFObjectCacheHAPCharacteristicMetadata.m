...
+ (id)hap_cacheInstanceForMetadata:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      id v14 = v25;
      _os_log_impl(&dword_1D4758000, v10, OS_LOG_TYPE_INFO, "%{public}@Object %@ of class %@ mismatches cache class %@:", (uint8_t *)&v18, 0x2Au);
    }
    goto LABEL_15;
  }
  if (([v3 conformsToProtocol:&unk_1F2C83AA8] & 1) == 0)
  {
    v9 = (void *)MEMORY[0x1D944E080]();
    v10 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      id v16 = v23;
      _os_log_impl(&dword_1D4758000, v10, OS_LOG_TYPE_INFO, "%{public}@Object %@ of class %@ does not conform to NSCopying protocol", (uint8_t *)&v18, 0x20u);
    }
LABEL_15:
  ...
  {
    id v8 = (id)[v3 copy];
    [(id)hap_cacheInstanceForMetadata__cachedInstances addObject:v8];
  }
