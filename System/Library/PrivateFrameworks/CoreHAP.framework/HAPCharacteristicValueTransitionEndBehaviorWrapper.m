...
{
  v2 = NSString;
  v3 = HAPCharacteristicValueTransitionEndBehaviorAsString([(HAPCharacteristicValueTransitionEndBehaviorWrapper *)self value]);
  v4 = [v2 stringWithFormat:@"<HAPCharacteristicValueTransitionEndBehaviorWrapper value=%@>", v3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      uint64_t v7 = [(HAPCharacteristicValueTransitionEndBehaviorWrapper *)v5 value];
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if ([v6 length])
  {
    ...
    [(HAPCharacteristicValueTransitionEndBehaviorWrapper *)self setValue:v9];
    BOOL v11 = 1;
  }
  else if (a4)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPCharacteristicValueTransitionEndBehaviorWrapper);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
