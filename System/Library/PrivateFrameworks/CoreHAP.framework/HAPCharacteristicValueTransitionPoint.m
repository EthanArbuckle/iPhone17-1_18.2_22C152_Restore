...
{
  v3 = NSString;
  v4 = [(HAPCharacteristicValueTransitionPoint *)self targetValue];
  v5 = [(HAPCharacteristicValueTransitionPoint *)self targetCompletionDuration];
  v6 = [(HAPCharacteristicValueTransitionPoint *)self startDelayDuration];
  v7 = [v3 stringWithFormat:@"<HAPCharacteristicValueTransitionPoint targetValue=%@, targetCompletionDuration=%@, startDelayDuration=%@>", v4, v5, v6];
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      else
      {
        ...
        v26 = [(HAPCharacteristicValueTransitionPoint *)v7 targetCompletionDuration];
...
LABEL_10:
  ...
  uint64_t v15 = [(HAPCharacteristicValueTransitionPoint *)self targetCompletionDuration];
  id v25 = 0;
...
LABEL_30:
    ...
    v19 = [(HAPCharacteristicValueTransitionPoint *)self startDelayDuration];
    id v24 = 0;
...
- (HAPCharacteristicValueTransitionPoint)initWithTargetValue:(id)a3 targetCompletionDuration:(id)a4 startDelayDuration:(id)a5
{
  ...
  uint64_t v12 = [(HAPCharacteristicValueTransitionPoint *)&v15 init];
  unint64_t v13 = v12;
  if (v12)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPCharacteristicValueTransitionPoint);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
