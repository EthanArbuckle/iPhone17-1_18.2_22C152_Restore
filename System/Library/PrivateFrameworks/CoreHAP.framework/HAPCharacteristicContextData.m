...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPCharacteristicContextData *)a3;
  if (self == v4)
  {
    char v10 = 1;
  }
...
LABEL_16:
  self = v20;
LABEL_17:
  -[HAPCharacteristicContextData setContextIdentifier:](self, "setContextIdentifier:", v9, v20);
  id v10 = 0;
  BOOL v17 = 1;
LABEL_19:
...
- (HAPCharacteristicContextData)initWithContextIdentifier:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)HAPCharacteristicContextData;
  id v6 = [(HAPCharacteristicContextData *)&v9 init];
  uint64_t v7 = v6;
  if (v6) {
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPCharacteristicContextData;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPCharacteristicContextData);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPCharacteristicContextData *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
