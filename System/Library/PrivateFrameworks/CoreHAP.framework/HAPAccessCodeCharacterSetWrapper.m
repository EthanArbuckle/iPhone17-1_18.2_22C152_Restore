...
- (HAPAccessCodeCharacterSetWrapper)initWithValue:(unint64_t)a3;
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPAccessCodeCharacterSetWrapper *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      unint64_t v6 = [(HAPAccessCodeCharacterSetWrapper *)self value];
      uint64_t v7 = [(HAPAccessCodeCharacterSetWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[HAPAccessCodeCharacterSetWrapper allocWithZone:a3];
  unint64_t v5 = [(HAPAccessCodeCharacterSetWrapper *)self value];

  return [(HAPAccessCodeCharacterSetWrapper *)v4 initWithValue:v5];
}

- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPAccessCodeCharacterSetWrapper *)self value];
...
{
  v5.receiver = self;
  v5.super_class = (Class)HAPAccessCodeCharacterSetWrapper;
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPAccessCodeCharacterSetWrapper;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPAccessCodeCharacterSetWrapper);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPAccessCodeCharacterSetWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
