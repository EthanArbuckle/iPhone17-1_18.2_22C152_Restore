...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPAudioCodecBitRateWrapper *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      int64_t v6 = [(HAPAudioCodecBitRateWrapper *)self value];
      uint64_t v7 = [(HAPAudioCodecBitRateWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HAPAudioCodecBitRateWrapper *)self value];
...
- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPAudioCodecBitRateWrapper *)self value];
...
{
  v5.receiver = self;
  v5.super_class = (Class)HAPAudioCodecBitRateWrapper;
...
{
  v3.receiver = self;
  v3.super_class = (Class)HAPAudioCodecBitRateWrapper;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPAudioCodecBitRateWrapper);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPAudioCodecBitRateWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
