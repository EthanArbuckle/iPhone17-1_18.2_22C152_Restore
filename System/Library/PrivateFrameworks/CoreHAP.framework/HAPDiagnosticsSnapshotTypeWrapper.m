...
{
  v2 = NSString;
  v3 = HAPDiagnosticsSnapshotTypeAsString([(HAPDiagnosticsSnapshotTypeWrapper *)self value]);
  v4 = [v2 stringWithFormat:@"<HAPDiagnosticsSnapshotTypeWrapper value=%@>", v3];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      uint64_t v7 = [(HAPDiagnosticsSnapshotTypeWrapper *)v5 value];
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPDiagnosticsSnapshotTypeWrapper);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
