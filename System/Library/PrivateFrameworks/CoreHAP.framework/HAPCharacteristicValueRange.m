...
{
  v3 = NSString;
  v4 = [(HAPCharacteristicValueRange *)self lowerBound];
  v5 = [(HAPCharacteristicValueRange *)self upperBound];
  v6 = [v3 stringWithFormat:@"<HAPCharacteristicValueRange lowerBound=%@, upperBound=%@>", v4, v5];
...
- (BOOL)isEqual:(id)a3
{
  v5 = (HAPCharacteristicValueRange *)a3;
  if (self == v5)
  {
    char v10 = 1;
  }
...
LABEL_10:
  ...
  v15 = [(HAPCharacteristicValueRange *)self upperBound];
  id v27 = 0;
...
LABEL_12:
    ...
    if (v28 == 1)
    {
      ...
      if (!v15)
      {
        uint64_t v24 = 0;
        id v16 = (id *)&v24;
        [MEMORY[0x1E4F1C9B8] parsedFromData:v14 error:&v24];
...
- (HAPCharacteristicValueRange)initWithLowerBound:(id)a3 upperBound:(id)a4
{
  ...
  id v9 = [(HAPCharacteristicValueRange *)&v12 init];
  unint64_t v10 = v9;
  if (v9)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPCharacteristicValueRange);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
