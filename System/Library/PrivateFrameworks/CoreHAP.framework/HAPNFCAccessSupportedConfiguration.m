...
LABEL_12:
  ...
  v12 = [(HAPNFCAccessSupportedConfiguration *)self maximumNumberOfSuspendedDeviceCredentialKeys];
  id v17 = 0;
...
- (HAPNFCAccessSupportedConfiguration)initWithMaximumNumberOfIssuerKeys:(id)a3 maximumNumberOfSuspendedDeviceCredentialKeys:(id)a4
{
  ...
  id v9 = [(HAPNFCAccessSupportedConfiguration *)&v12 init];
  uint64_t v10 = v9;
  if (v9)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPNFCAccessSupportedConfiguration);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPNFCAccessSupportedConfiguration *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
