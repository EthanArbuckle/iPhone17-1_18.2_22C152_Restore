...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPCharacteristicValueTransitionStart *)a3;
  if (self == v4)
  {
    char v10 = 1;
  }
  ...
  if (v8 >= 1)
  {
    ...
    while (1)
    {
      ...
      if (v24 == 1)
      {
        ...
        {
          id v20 = 0;
          id v15 = +[HAPCharacteristicValueTransition parsedFromData:v13 error:&v20];
          id v14 = v20;
          if (!v14) {
            [v9 addObject:v15];
          }
...
{
  id v5 = a3;
  uint64_t v6 = objc_alloc_init(HAPCharacteristicValueTransitionStart);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
