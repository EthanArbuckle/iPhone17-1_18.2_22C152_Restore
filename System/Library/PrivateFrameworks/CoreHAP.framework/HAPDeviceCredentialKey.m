...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v13 = [(HAPDeviceCredentialKey *)self key];
        v26 = [(HAPDeviceCredentialKey *)v7 key];
      ...
      v14 = [(HAPDeviceCredentialKey *)self state];
      uint64_t v15 = [(HAPDeviceCredentialKey *)v7 state];
      if (v14 == (void *)v15)
      {
...
LABEL_4:
    ...
    if (v11)
    {
      v12 = [(HAPDeviceCredentialKey *)self key];
      id v25 = 0;
...
LABEL_13:
    v18 = [(HAPDeviceCredentialKey *)self state];

    if (!v18) {
      goto LABEL_22;
    }
    v19 = [(HAPDeviceCredentialKey *)self state];
    id v24 = 0;
...
LABEL_21:
    ...
    if (v34 == 3)
    {
      ...
      id v28 = v9;
      uint64_t v19 = +[HAPNFCAccessKeyStateWrapper parsedFromData:v15 error:&v28];
      id v17 = v28;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPDeviceCredentialKey);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPDeviceCredentialKey *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
