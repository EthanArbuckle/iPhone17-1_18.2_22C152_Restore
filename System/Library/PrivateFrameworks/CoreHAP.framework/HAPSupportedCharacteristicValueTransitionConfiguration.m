...
{
  v2 = NSString;
  v3 = [(HAPSupportedCharacteristicValueTransitionConfiguration *)self transitions];
  v4 = [v2 stringWithFormat:@"<HAPSupportedCharacteristicValueTransitionConfiguration transitions=%@>", v3];
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPSupportedCharacteristicValueTransitionConfiguration *)a3;
  if (self == v4)
  {
    char v10 = 1;
  }
  ...
  if (v8 >= 1)
  {
    ...
    while (1)
    {
      ...
      if (v24 == 1)
      {
        ...
        {
          id v20 = 0;
          id v15 = +[HAPSupportedCharacteristicValueTransition parsedFromData:v13 error:&v20];
          id v14 = v20;
          if (!v14) {
            [v9 addObject:v15];
          }
...
- (HAPSupportedCharacteristicValueTransitionConfiguration)initWithTransitions:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_transitions = (NSMutableArray *)v6;
  }
  return v5;
}
...
{
  id v5 = a3;
  uint64_t v6 = objc_alloc_init(HAPSupportedCharacteristicValueTransitionConfiguration);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
