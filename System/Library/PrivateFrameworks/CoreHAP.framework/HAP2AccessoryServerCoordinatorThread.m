...
+ (id)new
{
  ...
  v9 = (void *)[objc_alloc((Class)a1) initWithDiscovery:v3 pairingFactory:v4 transportFactory:v5 secureTransportFactory:v6 encodingFactory:v7 controllerFactory:v8];
