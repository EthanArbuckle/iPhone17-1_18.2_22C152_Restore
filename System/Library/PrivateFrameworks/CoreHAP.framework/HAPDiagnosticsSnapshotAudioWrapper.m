...
{
  v2 = NSString;
  v3 = HAPDiagnosticsSnapshotAudioAsString([(HAPDiagnosticsSnapshotAudioWrapper *)self value]);
  v4 = [v2 stringWithFormat:@"<HAPDiagnosticsSnapshotAudioWrapper value=%@>", v3];
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HAPDiagnosticsSnapshotAudioWrapper *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      unint64_t v6 = [(HAPDiagnosticsSnapshotAudioWrapper *)self value];
      uint64_t v7 = [(HAPDiagnosticsSnapshotAudioWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  unint64_t v5 = [(HAPDiagnosticsSnapshotAudioWrapper *)self value];
...
- (id)serializeWithError:(id *)a3
{
  unint64_t v3 = [(HAPDiagnosticsSnapshotAudioWrapper *)self value];
...
LABEL_11:
  ...
  [(HAPDiagnosticsSnapshotAudioWrapper *)self setValue:v11];
  BOOL v12 = 1;
LABEL_15:
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAPDiagnosticsSnapshotAudioWrapper);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAPDiagnosticsSnapshotAudioWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
