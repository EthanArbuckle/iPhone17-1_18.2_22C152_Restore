...
LABEL_17:
      ...
      {
        id v21 = v10;
        uint64_t v13 = HAPTLVParseContiguousTlvs(22, v7, v11, v22, &v21);
        id v14 = v21;

        if (!v14)
        {
          id v20 = 0;
          uint64_t v15 = +[HAP2TLVParamServiceList parsedFromData:v13 error:&v20];
          id v14 = v20;
...
- (HAP2TLVOldServiceList)initWithServiceList:(id)a3
{
  ...
  id v6 = [(HAP2TLVOldServiceList *)&v9 init];
  unint64_t v7 = v6;
  if (v6) {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HAP2TLVOldServiceList);
  unint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HAP2TLVOldServiceList *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
