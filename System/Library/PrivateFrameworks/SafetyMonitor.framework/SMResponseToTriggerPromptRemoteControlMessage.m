        ...
        if (v23)
        {
          ...
          if (v24)
          {
            ...
            if (v26)
            {
              ...
              uint64_t v28 = v25;
              v23 = v60;
              self = [(SMResponseToTriggerPromptRemoteControlMessage *)self initWithDate:v14 messageID:v17 response:v20 sessionID:v60 sourceDeviceType:v28 sourceDeviceID:v26];
              v29 = self;
            }
            else
            {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v64 = 2112;
          v65 = v49;
          _os_log_error_impl(&dword_25B6E0000, v47, OS_LOG_TYPE_ERROR, "#RemoteControl,%@,%@,missing UserTriggerResponse", buf, 0x16u);
...
- (id)outputToDictionary
{
  ...
  v4 = objc_msgSend(NSNumber, "numberWithInteger:", -[SMResponseToTriggerPromptRemoteControlMessage response](self, "response"));
  [v3 setObject:v4 forKey:@"userTriggerResponse"];

  id v5 = objc_msgSend(NSNumber, "numberWithInteger:", -[SMResponseToTriggerPromptRemoteControlMessage sourceDeviceType](self, "sourceDeviceType"));
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeInteger:forKey:", -[SMResponseToTriggerPromptRemoteControlMessage response](self, "response"), @"userTriggerResponse");
  objc_msgSend(v4, "encodeInteger:forKey:", -[SMResponseToTriggerPromptRemoteControlMessage sourceDeviceType](self, "sourceDeviceType"), @"idsDeviceType");
  v6 = [(SMResponseToTriggerPromptRemoteControlMessage *)self sourceDeviceID];
...
LABEL_32:
  ...
  if (v8 == 1)
  {
    ...
    if (v11)
    {
      uint64_t v12 = [v6 decodeIntegerForKey:@"userTriggerResponse"];
