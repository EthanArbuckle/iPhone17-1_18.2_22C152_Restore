...
- (id)initIntoManagedObjectContext:(id)a3
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)BDSBookWidgetInfoMO;
...
+ (id)fetchRequest
{
  return +[NSFetchRequest fetchRequestWithEntityName:@"BDSBookWidgetInfoMO"];
}

- (id)getBookWidgetInfoObject
{
  v3 = [BDSBookWidgetInfo alloc];
  id v4 = [(BDSBookWidgetInfoMO *)self assetID];
  ...
  objc_super v8 = [(BDSBookWidgetInfoMO *)self cloudAssetType];
