...
- (BCCloudDataSource)collectionMemberDataSource;
...
- (void)setCollectionMemberDataSource:(id)a3;
...
- (void)getCollectionMemberChangesSince:(id)a3 completion:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(BCCloudCollectionMemberManager *)self dataManager];
...
{
  id v4 = a3;
  id v5 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (BCCloudCollectionMemberManager)initWithCloudDataSource:(id)a3 cloudKitController:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [[_TtC14bookdatastored21BDSSyncEnginePipeline alloc] initWithRecordType:@"collectionMember" zoneName:@"CollectionZone" delegate:self];
...
- (BCCloudCollectionMemberManager)initWithCloudDataSource:(id)a3 cloudKitController:(id)a4 syncProvider:(id)a5
{
  ...
  id v10 = a5;
  v23.receiver = self;
  v23.super_class = (Class)BCCloudCollectionMemberManager;
  v11 = [(BCCloudCollectionMemberManager *)&v23 init];
  v12 = v11;
  if (v11)
  {
    objc_storeStrong((id *)&v11->_collectionMemberDataSource, a3);
    objc_storeWeak((id *)&v12->_cloudKitController, v9);
    objc_storeStrong((id *)&v12->_syncManager, a5);
    v13 = [BCCloudDataManager alloc];
    v14 = [(BCCloudCollectionMemberManager *)v12 entityName];
    uint64_t v15 = objc_opt_class();
    uint64_t v16 = objc_opt_class();
    v17 = [(BCCloudCollectionMemberManager *)v12 syncManager];
    v18 = [v10 privacyDelegate];
    v19 = [(BCCloudDataManager *)v13 initWithCloudDataSource:v22 entityName:v14 notificationName:@"BCCloudCollectionMemberManagerChanged" immutableClass:v15 mutableClass:v16 syncManager:v17 cloudKitController:v9 privacyDelegate:v18];
...
- (id)mutableCloudDataForRecordID:(id)a3
{
  ...
  id v6 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (void)syncManager:(id)a3 startSyncToCKWithCompletion:(id)a4
{
  ...
  if ([(BCCloudCollectionMemberManager *)self enableCloudSync])
  {
    id v7 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (void)signalSyncToCKForSyncManager:(id)a3
{
  ...
  if ([(BCCloudCollectionMemberManager *)self enableCloudSync])
  {
    id v4 = [(BCCloudCollectionMemberManager *)self cloudKitController];
    id v5 = [v4 transactionManager];
    id v6 = [(BCCloudCollectionMemberManager *)self entityName];
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v12; i = (char *)i + 1)
        {
          ...
          uint64_t v16 = objc_msgSend(v15, "collectionMemberID", (void)v19);
...
- (void)syncProvider:(id)a3 resolveConflictsForRecords:(id)a4 completion:(id)a5
{
  ...
  if ([(BCCloudCollectionMemberManager *)self enableCloudSync])
  {
    id v9 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (id)diagnosticEntityInfos:(BOOL)a3
{
  ...
  id v7 = [(BCCloudCollectionMemberManager *)self entityName];
  id v8 = [(BDSCloudSyncDiagnosticEntityInfo *)v6 initWithName:v7 enabledSync:[(BCCloudCollectionMemberManager *)self enableCloudSync] dirtyCloudDataInfos:v4];
...
- (void)setEnableCloudSync:(BOOL)a3 completion:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v15 = 138412290;
      CFStringRef v16 = v10;
      _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_DEFAULT, "\"\\\"BCCloudCollectionMemberManager #enableCloudSync setEnableCloudSync %@\\\"\"", (uint8_t *)&v15, 0xCu);
    }
  }
  if (self->_enableCloudSync != v4)
  {
    ...
    if (v4)
    {
      if (v6)
      {
        id v11 = [(BCCloudCollectionMemberManager *)self cloudKitController];
        id v12 = [v11 transactionManager];
        id v13 = [(BCCloudCollectionMemberManager *)self entityName];
      ...
      {
        id v11 = [(BCCloudCollectionMemberManager *)self syncManager];
        [v11 signalSyncToCK];
      }
    }
  }
...
- (void)setCollectionMember:(id)a3 completion:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v10 = [(BCCloudCollectionMemberManager *)self dataManager];
  unsigned int v8 = [v7 collectionMemberID];
  id v9 = +[NSPredicate predicateWithFormat:@"collectionMemberID = %@", v8];
...
- (void)setCollectionMembers:(id)a3 completion:(id)a4
{
  ...
  id v9 = +[NSPredicate predicateWithFormat:@"collectionMemberID IN %@", v8];
...
- (void)removeCollectionMemberForCollectionSaltedHashedRecordIDs:(id)a3 completion:(id)a4
{
  ...
  if ([v6 count])
  {
    unsigned int v8 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (void)deleteCollectionMemberForCollectionMemberID:(id)a3 completion:(id)a4
{
  ...
  id v7 = a3;
  id v9 = [(BCCloudCollectionMemberManager *)self dataManager];
  unsigned int v8 = +[NSPredicate predicateWithFormat:@"collectionMemberID = %@", v7];
...
- (void)deleteCollectionMemberForCollectionMemberIDs:(id)a3 completion:(id)a4
{
  ...
  id v7 = a3;
  id v9 = [(BCCloudCollectionMemberManager *)self dataManager];
  unsigned int v8 = +[NSPredicate predicateWithFormat:@"collectionMemberID IN %@", v7];
...
- (void)collectionMemberForCollectionMemberID:(id)a3 completion:(id)a4
{
  ...
  id v7 = a3;
  unsigned int v8 = [(BCCloudCollectionMemberManager *)self dataManager];
  id v9 = +[NSPredicate predicateWithFormat:@"collectionMemberID = %@ AND (deletedFlag == NULL OR deletedFlag == NO)", v7];
...
{
  id v6 = a4;
  id v7 = +[NSPredicate predicateWithFormat:@"collectionMemberID BEGINSWITH[cd] %@ AND (deletedFlag == NULL OR deletedFlag == NO)", a3];
  unsigned int v8 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (void)fetchMaxSortOrderInCollectionID:(id)a3 completion:(id)a4
{
  id v6 = a4;
  id v7 = +[NSPredicate predicateWithFormat:@"collectionMemberID BEGINSWITH[cd] %@ AND (deletedFlag == NULL OR deletedFlag == NO)", a3];
  unsigned int v8 = +[NSSortDescriptor sortDescriptorWithKey:@"sortOrder" ascending:0];
  id v9 = [(BCCloudCollectionMemberManager *)self dataManager];
  v14 = v8;
...
- (void)fetchCollectionMembersInCollectionID:(id)a3 maximumResultCount:(unint64_t)a4 filter:(id)a5 completion:(id)a6
{
  id v10 = a5;
  id v11 = a6;
  id v12 = +[NSPredicate predicateWithFormat:@"collectionMemberID BEGINSWITH[cd] %@ AND (deletedFlag == NULL OR deletedFlag == NO)", a3];
  id v13 = +[NSSortDescriptor sortDescriptorWithKey:@"sortOrder" ascending:0];
  long long v22 = v13;
  v14 = +[NSArray arrayWithObjects:&v22 count:1];

  int v15 = [(BCCloudCollectionMemberManager *)self dataManager];
...
- (BCCloudDataSource)collectionMemberDataSource
{
  return self->_collectionMemberDataSource;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_collectionMemberDataSource, 0);
