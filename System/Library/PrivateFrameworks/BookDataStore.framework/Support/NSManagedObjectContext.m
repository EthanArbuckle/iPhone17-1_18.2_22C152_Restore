...
+ (id)mergePredicate:(id)a3 andPredicate:(id)a4
{
  ...
  if (v5 && v6)
  {
    id v8 = objc_msgSend(objc_alloc((Class)NSArray), "initWithObjects:", v5, v6, 0);
...
LABEL_4:
  ...
  if (v17)
  {
    ...
    id v30 = objc_msgSend(objc_alloc((Class)NSArray), "initWithObjects:", v29, 0);
...
- (id)copyEntityProperty:(id)a3 fromEntityName:(id)a4 withPredicate:(id)a5
{
  ...
  if ([v5 count] == (id)1 || (unint64_t)objc_msgSend(v5, "count") >= 2)
  {
    id v6 = [v5 lastObject];
  }
  else
...
- (id)entity:(id)a3 withPredicate:(id)a4 sortBy:(id)a5 ascending:(BOOL)a6 fetchLimit:(unint64_t)a7 prefetchRelationships:(id)a8
{
  ...
  if (a5)
  {
    ...
    id v19 = objc_msgSend(objc_alloc((Class)NSArray), "initWithObjects:", v18, 0);
  }
  else
  {
    id v19 = 0;
