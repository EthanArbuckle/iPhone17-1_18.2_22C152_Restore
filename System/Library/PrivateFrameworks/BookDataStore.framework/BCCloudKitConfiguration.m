...
+ (id)configuration
{
  ...
  objc_msgSend_setQueueIdentifier_(v2, v3, @"com.apple.iBooks.CloudKitController", v4, v5, v6, v7, v8);
  objc_msgSend_setContainerIdentifier_(v2, v9, @"com.apple.iBooks.cloudData", v10, v11, v12, v13, v14);
  v85[0] = @"AssetZone";
  v85[1] = @"ReadingStatistics";
  v85[2] = @"GlobalMetadata";
  v20 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x263EFF8C0], v15, (uint64_t)v85, 3, v16, v17, v18, v19);
  objc_msgSend_setAppZones_(v2, v21, (uint64_t)v20, v22, v23, v24, v25, v26);

  v84[0] = @"AssetZone";
  v84[1] = @"ReadingHistoryModel";
  v32 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x263EFF8C0], v27, (uint64_t)v84, 2, v28, v29, v30, v31);
  objc_msgSend_setServiceZones_(v2, v33, (uint64_t)v32, v34, v35, v36, v37, v38);

  objc_msgSend_setDbArchiveFolderName_(v2, v39, @"BCCloudKit-iBooks", v40, v41, v42, v43, v44);
  objc_msgSend_setDbArchiveExtension_(v2, v45, @"bcck", v46, v47, v48, v49, v50);
  objc_msgSend_setDbArchiveFilename_(v2, v51, @"BCPrivateDatabase", v52, v53, v54, v55, v56);
  objc_msgSend_setDbSubscriptionID_(v2, v57, @"com.apple.iBooks.BCCloudKitPrivate", v58, v59, v60, v61, v62);
  v70 = objc_msgSend_bdsAppBundleIdentifier(BDSAppBundleIdentifier, v63, v64, v65, v66, v67, v68, v69);
  objc_msgSend_setAppBundleIdentifier_(v2, v71, (uint64_t)v70, v72, v73, v74, v75, v76);

  objc_msgSend_setRequiresDeviceToDeviceEncryption_(v2, v77, 0, v78, v79, v80, v81, v82);
  return v2;
}
