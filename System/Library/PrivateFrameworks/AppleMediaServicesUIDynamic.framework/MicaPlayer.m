...
- (MicaPlayer)initWithData:(id)a3 url:(id)a4 retinaScale:(double)a5
{
  ...
  id v26 = 0;
  v16 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClasses:v15 fromData:v10 error:&v26];
...
+ (id)rootDictForPath:(id)a3
{
  ...
  {
    id v21 = 0;
    v5 = [MEMORY[0x1E4F1C9B8] dataWithContentsOfURL:v4 options:1 error:&v21];
    id v6 = v21;
    if (v6)
    {
    ...
    if (v5)
    {
      ...
      id v20 = v6;
      double v15 = [MEMORY[0x1E4F28DC0] unarchivedObjectOfClasses:v14 fromData:v5 error:&v20];
      id v16 = v20;
