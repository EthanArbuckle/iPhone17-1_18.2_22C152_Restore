...
- (HDNumberParameter)init
{
  return [(HDNumberParameter *)self initWithSummary:&stru_26EAEABB8 required:1];
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(HDNumberParameter *)self summary];
...
- (BOOL)validateValue:(id)a3 error:(id *)a4
{
  ...
  if (a4 && (isKindOfClass & 1) == 0)
  {
    ...
    objc_super v11 = [v8 stringWithFormat:@"Expected Number value, not %@.", v10];
