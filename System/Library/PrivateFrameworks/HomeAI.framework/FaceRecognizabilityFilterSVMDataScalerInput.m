...
- (FaceRecognizabilityFilterSVMDataScalerInput)initWithInput:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)FaceRecognizabilityFilterSVMDataScalerInput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_26D9A9900];
}
...
- (id)featureValueForName:(id)a3
{
  if ([a3 isEqualToString:@"input"])
  {
    ...
    id v5 = [(FaceRecognizabilityFilterSVMDataScalerInput *)self input];
