...
- (FaceRecognizabilityFilterSVMDataScaler)initWithConfiguration:(id)a3 error:(id *)a4;
- (FaceRecognizabilityFilterSVMDataScaler)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (FaceRecognizabilityFilterSVMDataScaler)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (FaceRecognizabilityFilterSVMDataScaler)initWithMLModel:(id)a3;
- (MLModel)model;
...
- (FaceRecognizabilityFilterSVMDataScaler)initWithMLModel:(id)a3
{
  ...
  {
    v10.receiver = self;
    v10.super_class = (Class)FaceRecognizabilityFilterSVMDataScaler;
...
- (FaceRecognizabilityFilterSVMDataScaler)init
{
  ...
  v4 = [(FaceRecognizabilityFilterSVMDataScaler *)self initWithContentsOfURL:v3 error:0];
...
- (FaceRecognizabilityFilterSVMDataScaler)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(FaceRecognizabilityFilterSVMDataScaler *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(FaceRecognizabilityFilterSVMDataScaler *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  id v8 = a4;
  id v9 = a3;
  objc_super v10 = [(FaceRecognizabilityFilterSVMDataScaler *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(FaceRecognizabilityFilterSVMDataScalerOutput *)v12 initWithTransformed_features:v14];
  }
  else
  {
    v15 = 0;
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(FaceRecognizabilityFilterSVMDataScaler *)self model];
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
...
void __83__FaceRecognizabilityFilterSVMDataScaler_predictionFromFeatures_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    id v5 = a3;
    id v6 = [FaceRecognizabilityFilterSVMDataScalerOutput alloc];
    id v7 = [v12 featureValueForName:@"transformed_features"];
    id v8 = [v7 multiArrayValue];
    id v9 = [(FaceRecognizabilityFilterSVMDataScalerOutput *)v6 initWithTransformed_features:v8];
  ...
  else
  {
    ...
    id v11 = *(void (**)(uint64_t, void, FaceRecognizabilityFilterSVMDataScalerOutput *))(v10 + 16);
    id v9 = a3;
    v11(v10, 0, v9);
  }
}
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a3;
  id v11 = [(FaceRecognizabilityFilterSVMDataScaler *)self model];
...
{
  id v6 = a3;
  id v7 = [[FaceRecognizabilityFilterSVMDataScalerInput alloc] initWithInput:v6];

  id v8 = [(FaceRecognizabilityFilterSVMDataScaler *)self predictionFromFeatures:v7 error:a4];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(FaceRecognizabilityFilterSVMDataScalerOutput *)v16 initWithTransformed_features:v18];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_225DC6000, &_os_log_internal, OS_LOG_TYPE_ERROR, "Could not load FaceRecognizabilityFilterSVMDataScaler.mlmodelc in the bundle resource", v0, 2u);
}
