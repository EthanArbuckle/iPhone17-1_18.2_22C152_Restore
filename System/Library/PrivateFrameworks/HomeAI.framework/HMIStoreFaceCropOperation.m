...
- (HMIStoreFaceCropOperation)initWithDataSource:(id)a3 faceCrop:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)HMIStoreFaceCropOperation;
...
void __33__HMIStoreFaceCropOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v3;
      _os_log_impl(&dword_225DC6000, v8, OS_LOG_TYPE_ERROR, "%{public}@Storing face crop:%@ failed with error:%@", (uint8_t *)&v13, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      objc_super v12 = [v6 faceCrop];
      int v13 = 138543618;
      v14 = v11;
      __int16 v15 = 2112;
      v16 = v12;
      _os_log_impl(&dword_225DC6000, v8, OS_LOG_TYPE_INFO, "%{public}@Storing face crop:%@ completed successfully", (uint8_t *)&v13, 0x16u);
    }
    [v6 finish];
  }
}
...
- (HMIFaceCrop)faceCrop
{
  return (HMIFaceCrop *)objc_getProperty(self, a2, 320, 1);
}
