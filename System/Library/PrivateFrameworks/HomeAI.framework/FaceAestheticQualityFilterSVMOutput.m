...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_26D9A9978];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v5 = objc_msgSend(MEMORY[0x263F00D50], "featureValueWithInt64:", -[FaceAestheticQualityFilterSVMOutput classLabel](self, "classLabel"));
  }
  else if ([v4 isEqualToString:@"classProbability"])
  {
    v6 = (void *)MEMORY[0x263F00D50];
    id v7 = [(FaceAestheticQualityFilterSVMOutput *)self classProbability];
