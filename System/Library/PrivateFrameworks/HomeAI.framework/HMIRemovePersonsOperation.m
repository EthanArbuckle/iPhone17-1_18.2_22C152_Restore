...
- (HMIRemovePersonsOperation)initWithDataSource:(id)a3 personUUIDs:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)HMIRemovePersonsOperation;
  v9 = [(HMFOperation *)&v12 initWithTimeout:20.0];
  v10 = v9;
  if (v9)
  {
    objc_storeStrong((id *)&v9->_dataSource, a3);
    objc_storeStrong((id *)&v10->_personUUIDs, a4);
  }
  ...
  if (WeakRetained)
  {
    ...
    if (v3)
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v17 = 2112;
        id v18 = v3;
        _os_log_impl(&dword_225DC6000, v8, OS_LOG_TYPE_ERROR, "%{public}@Error removing persons with UUIDs:%@, error:%@", (uint8_t *)&v13, 0x20u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        objc_super v12 = [v6 personUUIDs];
        int v13 = 138543618;
        v14 = v11;
        __int16 v15 = 2112;
        v16 = v12;
        _os_log_impl(&dword_225DC6000, v8, OS_LOG_TYPE_INFO, "%{public}@Succesfully removed persons %@", (uint8_t *)&v13, 0x16u);
      }
      [v6 finish];
    }
  }
