  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v9)
  {
    ...
    if (os_log_type_enabled(v11, v10))
    {
      ...
      *(void *)&v23[14] = v13;
      ...
      _os_log_impl(&dword_226071000, v11, v10, "NetQuality: %s: Date is %@, responsiveness %.3f, existing view? %s existing date? %@", v23, 0x34u);
    }
  }
...
- (void)_networkQualityOpenURL
{
  ...
  int64_t v4 = [v3 localizedStringForKey:@"kWFLocNetworkQualityKBURL" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
- (void)_openNetworkQualityDetails:(id)a3
{
  ...
  id v6 = [v5 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  id v29 = (id)[v4 initWithTitle:v6 detailText:0 symbolName:0 contentLayout:2];
  ...
  char v8 = [v7 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection1Title" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  id v9 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  os_log_type_t v10 = v9;
  if (v5) {
    id v11 = @"kWFLocNetworkQualityLearnMoreSection1TextCH";
  }
  else {
    id v11 = @"kWFLocNetworkQualityLearnMoreSection1Text";
  }
  v12 = [v9 localizedStringForKey:v11 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  [v29 addSectionWithHeader:v8 content:v12];

  v13 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v14 = [v13 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection2Title" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  uint64_t v15 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  uint64_t v16 = [v15 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection2Text" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  [v29 addSectionWithHeader:v14 content:v16];

  v17 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v18 = [v17 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection3Title" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  uint64_t v19 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  uint64_t v20 = [v19 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection3Text" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  [v29 addSectionWithHeader:v18 content:v20];

  v21 = [MEMORY[0x263F5B900] accessoryButton];
  v22 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v23 = [v22 localizedStringForKey:@"kWFLocNetworkQualityKBURL" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  [v21 setTitle:v23 forState:0];

  [v21 addTarget:self action:sel__networkQualityOpenURL forControlEvents:64];
  __int16 v24 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  uint64_t v25 = [v24 localizedStringForKey:@"kWFLocNetworkQualityLearnMoreSection4Text" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  [v29 addSectionWithHeader:0 content:v25 accessoryButton:v21];

  __int16 v26 = (void *)[objc_alloc(MEMORY[0x263F1C468]) initWithBarButtonSystemItem:0 target:self action:sel_donePressed];
  v27 = [v29 navigationItem];
  [v27 setRightBarButtonItem:v26];

  __int16 v28 = (void *)[objc_alloc(MEMORY[0x263F1C7F8]) initWithRootViewController:v29];
...
- (void)_reloadNetworkQualityCell
{
  ...
  v3 = [(WFDiagnosticsTableViewController *)self sections];
  uint64_t v4 = [v3 indexOfObject:&unk_26D9E20F8];
...
- (void)_updateNetworkQualityFooterText
{
  ...
  {
    objc_super v5 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    id v22 = [v5 localizedStringForKey:@"kWFLocNetworkQualityFooterKnown" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    id v6 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    uint64_t v7 = [v6 localizedStringForKey:@"kWFLocNetworkQualityFooterLink" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    uint64_t v8 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    id v9 = [v8 localizedStringForKey:@"kWFLocNetworkQualityFooterLastChecked" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  ...
  if (![(WFDiagnosticsTableViewController *)self networkQualitySpinning])
  {
    ...
    if ((unint64_t)WFCurrentLogLevel() >= 3 && v3 && os_log_type_enabled(v3, v4))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_impl(&dword_226071000, v3, v4, "NetQuality: %s: User scheduled a run", buf, 0xCu);
    }

    objc_super v5 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    id v6 = [v5 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    uint64_t v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    uint64_t v8 = [v7 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertText" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    id v9 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    os_log_type_t v10 = [v9 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertContinue" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    id v11 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    v12 = [v11 localizedStringForKey:@"kWFLocSettingNetworkQualityAlertCancel" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    v13 = [MEMORY[0x263F1C3F8] alertControllerWithTitle:v6 message:v8 preferredStyle:1];
    v14 = [MEMORY[0x263F1C3F0] actionWithTitle:v12 style:1 handler:&__block_literal_global_9];
    [v13 addAction:v14];
    ...
    v16[3] = &unk_26478FB70;
    v16[4] = self;
    uint64_t v15 = [MEMORY[0x263F1C3F0] actionWithTitle:v10 style:0 handler:v16];
    [v13 addAction:v15];
...
void __54__WFDiagnosticsTableViewController__runNetworkQuality__block_invoke()
{
  ...
  if ((unint64_t)WFCurrentLogLevel() >= 3 && v0 && os_log_type_enabled(v0, v1))
  {
    ...
    _os_log_impl(&dword_226071000, v0, v1, "NetQuality: %s: User canceled test-run", (uint8_t *)&v2, 0xCu);
  }
}
...
uint64_t __54__WFDiagnosticsTableViewController__runNetworkQuality__block_invoke_3(uint64_t a1)
{
  if (!*(unsigned char *)(a1 + 40) && [*(id *)(a1 + 32) networkQualitySpinning])
  {
    ...
    v3 = [v2 localizedStringForKey:@"kWFLocSettingNetworkQualityFailureTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    char v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    objc_super v5 = [v4 localizedStringForKey:@"kWFLocSettingNetworkQualityFailureText" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    id v6 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
    uint64_t v7 = [v6 localizedStringForKey:@"kWFLocSettingNetworkQualityFailureOK" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];

    id v8 = [MEMORY[0x263F1C3F8] alertControllerWithTitle:v3 message:v5 preferredStyle:1];
    id v9 = [MEMORY[0x263F1C3F0] actionWithTitle:v7 style:0 handler:0];
    [v8 addAction:v9];
...
- (void)_fillNetworkQualityCell:(id)a3
{
  ...
  if ([(WFDiagnosticsTableViewController *)self networkQualitySpinning])
  {
    id v26 = (id)[objc_alloc(MEMORY[0x263F1C3D8]) initWithActivityIndicatorStyle:100];
  ...
  if (v7 != 0.0)
  {
    os_log_type_t v10 = [v8 localizedStringForKey:@"kWFLocSettingNetworkQualityRPM" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    ...
    v18 = [v15 localizedStringForKey:v17 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
LABEL_13:
  ...
  id v26 = [v8 localizedStringForKey:@"kWFLocSettingNetworkQualityNoData" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  os_log_type_t v10 = v9;
LABEL_14:

  id v22 = [MEMORY[0x263F1C488] buttonWithType:1];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  ...
  switch(v8)
  {
    case 0:
      ...
      double v13 = [v12 localizedStringForKey:@"kWFLocDiagnosticsDiagnosis" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    ...
    case 1:
      if (![v5 row])
      {
        ...
        v49 = [v48 localizedStringForKey:@"kWFLocDiagnosticsBSSID" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v50 = [v9 textLabel];
        [v50 setText:v49];
      ...
      if ([v5 row] == 1)
      {
        ...
        uint64_t v19 = [v18 localizedStringForKey:@"kWFLocDiagnosticsChannel" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      if ([v5 row] == 2)
      {
        ...
        v67 = [v66 localizedStringForKey:@"kWFLocDiagnosticsSignalStrength" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v68 = [v9 textLabel];
        [v68 setText:v67];
    ...
    case 2:
      if (![v5 row])
      {
        ...
        v52 = [v51 localizedStringForKey:@"kWFLocDiagnosticsSecurity" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v53 = [v9 textLabel];
        [v53 setText:v52];
      ...
      if ([v5 row] == 1)
      {
        ...
        __int16 v24 = [v23 localizedStringForKey:@"kWFLocDiagnosticsCaptive" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        ...
        __int16 v28 = v27;
        if (v24) {
          id v29 = @"kWFLocDiagnosticsIsCaptive";
        }
        else {
          id v29 = @"kWFLocDiagnosticsIsNotCaptive";
        }
        uint64_t v30 = [v27 localizedStringForKey:v29 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      else
      {
        if ([v5 row] == 2)
        {
          ...
          v76 = [v75 localizedStringForKey:@"kWFLocDiagnosticsDeployment" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
          v77 = [v9 textLabel];
          [v77 setText:v76];
        ...
        if ([v5 row] == 3)
        {
          ...
          v100 = [v99 localizedStringForKey:@"kWFLocDiagnosticsMotion" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
          v101 = [v9 textLabel];
          [v101 setText:v100];
    ...
    case 3:
      if (![v5 row])
      {
        ...
        v55 = [v54 localizedStringForKey:@"kWFLocDiagnosticsGateway" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v56 = [v9 textLabel];
        [v56 setText:v55];
...
LABEL_25:
      ...
      if ([v5 row] == 1)
      {
        ...
        v33 = [v32 localizedStringForKey:@"kWFLocDiagnosticsInternet" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v34 = [v9 textLabel];
        [v34 setText:v33];
      ...
      if ([v5 row] == 2)
      {
        ...
        v79 = [v78 localizedStringForKey:@"kWFLocSettingNetworkQualityText" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v80 = [v9 textLabel];
        [v80 setText:v79];
        ...
        if ((unint64_t)WFCurrentLogLevel() >= 3 && v81)
        {
          ...
          if (os_log_type_enabled(v83, v82))
          {
            ...
            *(void *)&v109[14] = v86;
            __int16 v110 = 2080;
            v111 = v88;
            _os_log_impl(&dword_226071000, v83, v82, "NetQuality: %s: Responsiveness is %.1f, execution running? %s", v109, 0x20u);
          }
        }
...
LABEL_57:
    ...
    case 4:
      if (![v5 row])
      {
        ...
        v61 = [v60 localizedStringForKey:@"kWFLocDiagnosticsBeaconPER" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v62 = [v9 textLabel];
        [v62 setText:v61];
      ...
      if ([v5 row] == 1)
      {
        ...
        v43 = [v42 localizedStringForKey:@"kWFLocDiagnosticsTransmitPER" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v44 = [v9 textLabel];
        [v44 setText:v43];
      ...
      v90 = [v89 localizedStringForKey:@"kWFLocDiagnosticsReceivedFrames" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      v91 = [v9 textLabel];
      [v91 setText:v90];
    ...
    case 5:
      if ([v5 row])
      {
        if ([v5 row] == 1)
        {
          ...
          v46 = [v45 localizedStringForKey:@"kWFLocDiagnosticsBluetooth" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
          v47 = [v9 textLabel];
          [v47 setText:v46];
        ...
        else
        {
          ...
          v93 = [v92 localizedStringForKey:@"kWFLocDiagnosticsScan" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
          v94 = [v9 textLabel];
          [v94 setText:v93];
      ...
      else
      {
        ...
        v64 = [v63 localizedStringForKey:@"kWFLocDiagnosticsAWDLMode" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
        v65 = [v9 textLabel];
        [v65 setText:v64];
